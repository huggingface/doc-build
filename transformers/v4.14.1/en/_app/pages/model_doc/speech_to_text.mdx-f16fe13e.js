import{S as ll,i as pl,s as hl,e as a,k as d,w as u,t as n,M as fl,c as r,d as o,m as l,a as i,x as _,h as s,b as c,F as e,g as h,y as g,q as v,o as T,B as x}from"../../chunks/vendor-ab4e3193.js";import{T as zs}from"../../chunks/Tip-b5c6375a.js";import{D as F}from"../../chunks/Docstring-b69c0bd4.js";import{C as En}from"../../chunks/CodeBlock-516df0c5.js";import{I as xe}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function ml(Y){let f,w,m,b,z,k,y,E;return{c(){f=a("p"),w=n(`This class method is simply calling Speech2TextFeatureExtractor\u2019s
`),m=a("code"),b=n("from_pretrained"),z=n(` and Speech2TextTokenizer\u2019s
`),k=a("code"),y=n("from_pretrained"),E=n(`. Please refer to the
docstrings of the methods above for more information.`)},l(C){f=r(C,"P",{});var $=i(f);w=s($,`This class method is simply calling Speech2TextFeatureExtractor\u2019s
`),m=r($,"CODE",{});var M=i(m);b=s(M,"from_pretrained"),M.forEach(o),z=s($,` and Speech2TextTokenizer\u2019s
`),k=r($,"CODE",{});var L=i(k);y=s(L,"from_pretrained"),L.forEach(o),E=s($,`. Please refer to the
docstrings of the methods above for more information.`),$.forEach(o)},m(C,$){h(C,f,$),e(f,w),e(f,m),e(m,b),e(f,z),e(f,k),e(k,y),e(f,E)},d(C){C&&o(f)}}}function ul(Y){let f,w,m,b,z,k,y,E;return{c(){f=a("p"),w=n("This class method is simply calling "),m=a("code"),b=n("save_pretrained"),z=n(` and
`),k=a("code"),y=n("save_pretrained"),E=n(`. Please refer to the
docstrings of the methods above for more information.`)},l(C){f=r(C,"P",{});var $=i(f);w=s($,"This class method is simply calling "),m=r($,"CODE",{});var M=i(m);b=s(M,"save_pretrained"),M.forEach(o),z=s($,` and
`),k=r($,"CODE",{});var L=i(k);y=s(L,"save_pretrained"),L.forEach(o),E=s($,`. Please refer to the
docstrings of the methods above for more information.`),$.forEach(o)},m(C,$){h(C,f,$),e(f,w),e(f,m),e(m,b),e(f,z),e(f,k),e(k,y),e(f,E)},d(C){C&&o(f)}}}function _l(Y){let f,w,m,b,z;return{c(){f=a("p"),w=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a("code"),b=n("Module"),z=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(k){f=r(k,"P",{});var y=i(f);w=s(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=r(y,"CODE",{});var E=i(m);b=s(E,"Module"),E.forEach(o),z=s(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(o)},m(k,y){h(k,f,y),e(f,w),e(f,m),e(m,b),e(f,z)},d(k){k&&o(f)}}}function gl(Y){let f,w,m,b,z;return{c(){f=a("p"),w=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a("code"),b=n("Module"),z=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(k){f=r(k,"P",{});var y=i(f);w=s(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=r(y,"CODE",{});var E=i(m);b=s(E,"Module"),E.forEach(o),z=s(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(o)},m(k,y){h(k,f,y),e(f,w),e(f,m),e(m,b),e(f,z)},d(k){k&&o(f)}}}function vl(Y){let f,w,m,b,z,k,y,E,C,$,M,L,qo,Ue,Es,Po,qs,qn,O,Ps,Be,js,Fs,He,Cs,Ms,Re,As,Ds,Je,Is,Ns,Pn,Q,Ls,Ye,Os,Gs,Xe,Ws,Vs,jn,ce,ke,jo,Ke,Us,Fo,Bs,Fn,be,Hs,Co,Rs,Js,Cn,G,Ys,Rt,Xs,Ks,Jt,Qs,Zs,Yt,ea,ta,Xt,oa,na,Mn,q,sa,Mo,aa,ra,Ao,ia,ca,Do,da,la,Io,pa,ha,No,fa,ma,Qe,ua,_a,Lo,ga,An,Kt,Oo,va,Dn,Ze,In,Qt,et,Go,Ta,xa,A,ka,Wo,ba,ya,Vo,Sa,wa,Uo,$a,za,Bo,Ea,qa,Ho,Pa,ja,Nn,tt,Ln,ye,Fa,ot,Ca,Ma,On,de,Se,Ro,nt,Aa,Jo,Da,Gn,D,st,Ia,le,Na,Zt,La,Oa,at,Ga,Wa,Va,pe,Ua,eo,Ba,Ha,to,Ra,Ja,Ya,Yo,Xa,Ka,rt,Wn,he,we,Xo,it,Qa,Ko,Za,Vn,P,ct,er,Qo,tr,or,dt,nr,oo,sr,ar,rr,$e,lt,ir,Zo,cr,dr,ze,pt,lr,ht,pr,en,hr,fr,mr,Z,ft,ur,no,_r,so,gr,vr,tn,Tr,xr,on,Un,fe,Ee,nn,mt,kr,sn,br,Bn,I,ut,yr,an,Sr,wr,_t,$r,ao,zr,Er,qr,rn,Pr,jr,qe,gt,Fr,cn,Cr,Hn,me,Pe,dn,vt,Mr,ln,Ar,Rn,S,Tt,Dr,pn,Ir,Nr,W,ro,Lr,Or,io,Gr,Wr,co,Vr,Ur,xt,hn,Br,Hr,Rr,lo,Jr,Yr,Xr,je,kt,Kr,X,Qr,bt,fn,Zr,ei,ti,po,oi,ni,yt,mn,si,ai,ri,ii,ee,St,ci,wt,di,ho,li,pi,hi,Fe,fi,te,$t,mi,ue,ui,un,_i,gi,fo,vi,Ti,xi,Ce,ki,Me,zt,bi,Et,yi,mo,Si,wi,$i,Ae,qt,zi,Pt,Ei,uo,qi,Pi,ji,De,jt,Fi,_n,Ci,Jn,_e,Ie,gn,Ft,Mi,vn,Ai,Yn,H,Ct,Di,Mt,Ii,_o,Ni,Li,Oi,At,Gi,Dt,Wi,Vi,Ui,V,It,Bi,ge,Hi,go,Ri,Ji,Tn,Yi,Xi,Ki,Ne,Qi,xn,Zi,ec,Nt,Xn,ve,Le,kn,Lt,tc,bn,oc,Kn,R,Ot,nc,Gt,sc,vo,ac,rc,ic,Wt,cc,Vt,dc,lc,pc,U,Ut,hc,Te,fc,To,mc,uc,yn,_c,gc,vc,Oe,Tc,Sn,xc,kc,Bt,Qn;return k=new xe({}),Ue=new xe({}),Ke=new xe({}),Ze=new En({props:{code:`import torch
...
<p><a href="../glossary#attention-mask">What are attention masks?</a>`,name:"return_attention_mask"}]}}),vt=new xe({}),Tt=new F({props:{name:"class transformers.Speech2TextProcessor",anchor:"transformers.Speech2TextProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/speech_to_text/processing_speech_to_text.py#L24",parametersDescription:[{anchor:"transformers.Speech2TextProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Speech2TextFeatureExtractor</code>) &#x2014;
An instance of <a href="/docs/transformers/v4.14.1/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor">Speech2TextFeatureExtractor</a>. The feature extractor is a required
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/speech_to_text#transformers.Speech2TextConfig"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ut=new F({props:{name:"forward",anchor:"transformers.Speech2TextForConditionalGeneration.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1278",parametersDescription:[{anchor:"transformers.Speech2TextForConditionalGeneration.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a
<code>numpy.ndarray</code>, <em>e.g.</em> via the soundfile library (<code>pip install soundfile</code>). To prepare the array
into <code>input_features</code>, the <a href="/docs/transformers/v4.14.1/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){f=a("meta"),w=d(),m=a("h1"),b=a("a"),z=a("span"),u(k.$$.fragment),y=d(),E=a("span"),C=n("Speech2Text"),$=d(),M=a("h2"),L=a("a"),qo=a("span"),u(Ue.$$.fragment),Es=d(),Po=a("span"),qs=n("Overview"),qn=d(),O=a("p"),Ps=n("The Speech2Text model was proposed in "),Be=a("a"),js=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),Fs=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),He=a("a"),Cs=n("LibriSpeech"),Ms=n(", "),Re=a("a"),As=n("CoVoST 2"),Ds=n(", "),Je=a("a"),Is=n("MuST-C"),Ns=n("."),Pn=d(),Q=a("p"),Ls=n("This model was contributed by "),Ye=a("a"),Os=n("valhalla"),Gs=n(". The original code can be found "),Xe=a("a"),Ws=n("here"),Vs=n("."),jn=d(),ce=a("h2"),ke=a("a"),jo=a("span"),u(Ke.$$.fragment),Us=d(),Fo=a("span"),Bs=n("Inference"),Fn=d(),be=a("p"),Hs=n(`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
`),Co=a("code"),Rs=n("generate()"),Js=n(" method can be used for inference."),Cn=d(),G=a("p"),Ys=n("The "),Rt=a("a"),Xs=n("Speech2TextFeatureExtractor"),Ks=n(` class is responsible for extracting the log-mel filter-bank
...
special tokens using the tokenizer `),en=a("code"),hr=n("prepare_for_model"),fr=n(" method."),mr=d(),Z=a("div"),u(ft.$$.fragment),ur=d(),no=a("p"),_r=n("Create the token type IDs corresponding to the sequences passed. "),so=a("a"),gr=n("What are token type IDs?"),vr=d(),tn=a("p"),Tr=n("Should be overridden in a subclass if the model has a special way of building those."),xr=d(),on=a("div"),Un=d(),fe=a("h2"),Ee=a("a"),nn=a("span"),u(mt.$$.fragment),kr=d(),sn=a("span"),br=n("Speech2TextFeatureExtractor"),Bn=d(),I=a("div"),u(ut.$$.fragment),yr=d(),an=a("p"),Sr=n("Constructs a Speech2Text feature extractor."),wr=d(),_t=a("p"),$r=n("This feature extractor inherits from "),ao=a("a"),zr=n("Speech2TextFeatureExtractor"),Er=n(` which contains most of the
...
`),bt=a("a"),fn=a("strong"),Zr=n("call"),ei=n("()"),ti=n(` and returns its output. If used in the context
...
`),fo=a("a"),vi=n("from_pretrained()"),Ti=n(" class method."),xi=d(),u(Ce.$$.fragment),ki=d(),Me=a("div"),u(zt.$$.fragment),bi=d(),Et=a("p"),yi=n(`This method forwards all its arguments to Speech2TextTokenizer\u2019s
...
Speech2Text.`),Jn=d(),_e=a("h2"),Ie=a("a"),gn=a("span"),u(Ft.$$.fragment),Mi=d(),vn=a("span"),Ai=n("Speech2TextModel"),Yn=d(),H=a("div"),u(Ct.$$.fragment),Di=d(),Mt=a("p"),Ii=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),pc=d(),U=a("div"),u(Ut.$$.fragment),hc=d(),Te=a("p"),fc=n("The "),To=a("a"),mc=n("Speech2TextForConditionalGeneration"),uc=n(" forward method, overrides the "),yn=a("code"),_c=n("__call__"),gc=n(" special method."),vc=d(),u(Oe.$$.fragment),Tc=d(),Sn=a("p"),xc=n("Example:"),kc=d(),u(Bt.$$.fragment),this.h()},l(t){const p=fl('[data-svelte="svelte-1phssyn"]',document.head);f=r(p,"META",{name:!0,content:!0}),p.forEach(o),w=l(t),m=r(t,"H1",{class:!0});var Ht=i(m);b=r(Ht,"A",{id:!0,class:!0,href:!0});var wn=i(b);z=r(wn,"SPAN",{});var $n=i(z);_(k.$$.fragment,$n),$n.forEach(o),wn.forEach(o),y=l(Ht),E=r(Ht,"SPAN",{});var zn=i(E);C=s(zn,"Speech2Text"),zn.forEach(o),Ht.forEach(o),$=l(t),M=r(t,"H2",{class:!0});var Zn=i(M);L=r(Zn,"A",{id:!0,class:!0,href:!0});var $c=i(L);qo=r($c,"SPAN",{});var zc=i(qo);_(Ue.$$.fragment,zc),zc.forEach(o),$c.forEach(o),Es=l(Zn),Po=r(Zn,"SPAN",{});var Ec=i(Po);qs=s(Ec,"Overview"),Ec.forEach(o),Zn.forEach(o),qn=l(t),O=r(t,"P",{});var oe=i(O);Ps=s(oe,"The Speech2Text model was proposed in "),Be=r(oe,"A",{href:!0,rel:!0});var qc=i(Be);js=s(qc,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),qc.forEach(o),Fs=s(oe,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),He=r(oe,"A",{href:!0,rel:!0});var Pc=i(He);Cs=s(Pc,"LibriSpeech"),Pc.forEach(o),Ms=s(oe,", "),Re=r(oe,"A",{href:!0,rel:!0});var jc=i(Re);As=s(jc,"CoVoST 2"),jc.forEach(o),Ds=s(oe,", "),Je=r(oe,"A",{href:!0,rel:!0});var Fc=i(Je);Is=s(Fc,"MuST-C"),Fc.forEach(o),Ns=s(oe,"."),oe.forEach(o),Pn=l(t),Q=r(t,"P",{});var xo=i(Q);Ls=s(xo,"This model was contributed by "),Ye=r(xo,"A",{href:!0,rel:!0});var Cc=i(Ye);Os=s(Cc,"valhalla"),Cc.forEach(o),Gs=s(xo,". The original code can be found "),Xe=r(xo,"A",{href:!0,rel:!0});var Mc=i(Xe);Ws=s(Mc,"here"),Mc.forEach(o),Vs=s(xo,"."),xo.forEach(o),jn=l(t),ce=r(t,"H2",{class:!0});var es=i(ce);ke=r(es,"A",{id:!0,class:!0,href:!0});var Ac=i(ke);jo=r(Ac,"SPAN",{});var Dc=i(jo);_(Ke.$$.fragment,Dc),Dc.forEach(o),Ac.forEach(o),Us=l(es),Fo=r(es,"SPAN",{});var Ic=i(Fo);Bs=s(Ic,"Inference"),Ic.forEach(o),es.forEach(o),Fn=l(t),be=r(t,"P",{});var ts=i(be);Hs=s(ts,`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
`),Co=r(ts,"CODE",{});var Nc=i(Co);Rs=s(Nc,"generate()"),Nc.forEach(o),Js=s(ts," method can be used for inference."),ts.forEach(o),Cn=l(t),G=r(t,"P",{});var ne=i(G);Ys=s(ne,"The "),Rt=r(ne,"A",{href:!0});var Lc=i(Rt);Xs=s(Lc,"Speech2TextFeatureExtractor"),Lc.forEach(o),Ks=s(ne,` class is responsible for extracting the log-mel filter-bank
...
outputs. Read the documentation from `),to=r(bo,"A",{href:!0});var hd=i(to);Ra=s(hd,"PretrainedConfig"),hd.forEach(o),Ja=s(bo," for more information."),bo.forEach(o),Ya=l(se),Yo=r(se,"P",{});var fd=i(Yo);Xa=s(fd,"Example:"),fd.forEach(o),Ka=l(se),_(rt.$$.fragment,se),se.forEach(o),Wn=l(t),he=r(t,"H2",{class:!0});var as=i(he);we=r(as,"A",{id:!0,class:!0,href:!0});var md=i(we);Xo=r(md,"SPAN",{});var ud=i(Xo);_(it.$$.fragment,ud),ud.forEach(o),md.forEach(o),Qa=l(as),Ko=r(as,"SPAN",{});var _d=i(Ko);Za=s(_d,"Speech2TextTokenizer"),_d.forEach(o),as.forEach(o),Vn=l(t),P=r(t,"DIV",{class:!0});var B=i(P);_(ct.$$.fragment,B),er=l(B),Qo=r(B,"P",{});var gd=i(Qo);tr=s(gd,"Construct an Speech2Text tokenizer."),gd.forEach(o),or=l(B),dt=r(B,"P",{});var rs=i(dt);nr=s(rs,"This tokenizer inherits from "),oo=r(rs,"A",{href:!0});var vd=i(oo);sr=s(vd,"PreTrainedTokenizer"),vd.forEach(o),ar=s(rs,` which contains some of the main methods.
...
mean and variance normalization to the extracted features.`),Ed.forEach(o),jr=l(ae),qe=r(ae,"DIV",{class:!0});var hs=i(qe);_(gt.$$.fragment,hs),Fr=l(hs),cn=r(hs,"P",{});var qd=i(cn);Cr=s(qd,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),qd.forEach(o),hs.forEach(o),ae.forEach(o),Hn=l(t),me=r(t,"H2",{class:!0});var fs=i(me);Pe=r(fs,"A",{id:!0,class:!0,href:!0});var Pd=i(Pe);dn=r(Pd,"SPAN",{});var jd=i(dn);_(vt.$$.fragment,jd),jd.forEach(o),Pd.forEach(o),Mr=l(fs),ln=r(fs,"SPAN",{});var Fd=i(ln);Ar=s(Fd,"Speech2TextProcessor"),Fd.forEach(o),fs.forEach(o),Rn=l(t),S=r(t,"DIV",{class:!0});var j=i(S);_(Tt.$$.fragment,j),Dr=l(j),pn=r(j,"P",{});var Cd=i(pn);Ir=s(Cd,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
information.`),K.forEach(o),Xr=l(j),je=r(j,"DIV",{class:!0});var ms=i(je);_(kt.$$.fragment,ms),Kr=l(ms),X=r(ms,"P",{});var Ge=i(X);Qr=s(Ge,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
`),bt=r(Ge,"A",{href:!0});var Sc=i(bt);fn=r(Sc,"STRONG",{});var Ld=i(fn);Zr=s(Ld,"call"),Ld.forEach(o),ei=s(Sc,"()"),Sc.forEach(o),ti=s(Ge,` and returns its output. If used in the context
...
the above two methods for more information.`),Ge.forEach(o),ms.forEach(o),ii=l(j),ee=r(j,"DIV",{class:!0});var So=i(ee);_(St.$$.fragment,So),ci=l(So),wt=r(So,"P",{});var us=i(wt);di=s(us,"Instantiate a "),ho=r(us,"A",{href:!0});var Wd=i(ho);li=s(Wd,"Speech2TextProcessor"),Wd.forEach(o),pi=s(us," from a pretrained Speech2Text processor."),us.forEach(o),hi=l(So),_(Fe.$$.fragment,So),So.forEach(o),fi=l(j),te=r(j,"DIV",{class:!0});var wo=i(te);_($t.$$.fragment,wo),mi=l(wo),ue=r(wo,"P",{});var $o=i(ue);ui=s($o,`Save a Speech2Text feature extractor object and Speech2Text tokenizer object to the directory
`),un=r($o,"CODE",{});var Vd=i(un);_i=s(Vd,"save_directory"),Vd.forEach(o),gi=s($o,`, so that it can be re-loaded using the
`),fo=r($o,"A",{href:!0});var Ud=i(fo);vi=s(Ud,"from_pretrained()"),Ud.forEach(o),Ti=s($o," class method."),$o.forEach(o),xi=l(wo),_(Ce.$$.fragment,wo),wo.forEach(o),ki=l(j),Me=r(j,"DIV",{class:!0});var _s=i(Me);_(zt.$$.fragment,_s),bi=l(_s),Et=r(_s,"P",{});var gs=i(Et);yi=s(gs,`This method forwards all its arguments to Speech2TextTokenizer\u2019s
`),mo=r(gs,"A",{href:!0});var Bd=i(mo);Si=s(Bd,"batch_decode()"),Bd.forEach(o),wi=s(gs,`. Please refer to the docstring of this method for more
...
information.`),Ts.forEach(o),vs.forEach(o),ji=l(j),De=r(j,"DIV",{class:!0});var xs=i(De);_(jt.$$.fragment,xs),Fi=l(xs),_n=r(xs,"P",{});var Rd=i(_n);Ci=s(Rd,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),Rd.forEach(o),xs.forEach(o),j.forEach(o),Jn=l(t),_e=r(t,"H2",{class:!0});var ks=i(_e);Ie=r(ks,"A",{id:!0,class:!0,href:!0});var Jd=i(Ie);gn=r(Jd,"SPAN",{});var Yd=i(gn);_(Ft.$$.fragment,Yd),Yd.forEach(o),Jd.forEach(o),Mi=l(ks),vn=r(ks,"SPAN",{});var Xd=i(vn);Ai=s(Xd,"Speech2TextModel"),Xd.forEach(o),ks.forEach(o),Yn=l(t),H=r(t,"DIV",{class:!0});var We=i(H);_(Ct.$$.fragment,We),Di=l(We),Mt=r(We,"P",{});var bs=i(Mt);Ii=s(bs,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
