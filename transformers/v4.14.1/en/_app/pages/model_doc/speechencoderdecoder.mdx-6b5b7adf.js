import{S as Bd,i as Rd,s as Hd,e as r,k as c,w as M,t as o,M as Ud,c as a,d as n,m as i,a as s,x as $,h as t,b as l,F as e,g as E,y as x,q as C,o as P,B as j}from"../../chunks/vendor-ab4e3193.js";import{T as Jd}from"../../chunks/Tip-b5c6375a.js";import{D as _o}from"../../chunks/Docstring-b69c0bd4.js";import{C as vs}from"../../chunks/CodeBlock-516df0c5.js";import{I as Es}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Gd(vo){let g,N,v,b,J;return{c(){g=r("p"),N=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`),W.forEach(n)},m(D,W){E(D,g,W),e(g,N),e(g,v),e(v,b),e(g,J)},d(D){D&&n(g)}}}function Yd(vo){let g,N,v,b,J,D,W,de,It,Et,T,Ft,Ve,Ot,Nt,Eo,Wt,Vt,Be,Bt,Rt,Re,Ht,Ut,bt,V,Jt,bo,Gt,Yt,Ee,Zt,Kt,wt,B,Qt,He,Xt,en,Ue,on,tn,yt,G,ce,wo,be,nn,yo,rn,Tt,_,we,an,ie,Je,sn,dn,Ge,cn,ln,hn,Y,pn,Ye,fn,mn,Ze,un,gn,_n,To,vn,En,ye,bn,le,Te,wn,ke,yn,Ke,Tn,kn,Sn,he,Se,Dn,Z,Mn,ko,$n,xn,So,Cn,Pn,kt,K,pe,Do,De,jn,Mo,zn,St,f,Me,qn,Q,An,$o,Ln,In,xo,Fn,On,Nn,$e,Wn,xe,Vn,Bn,Rn,Ce,Hn,Pe,Un,Jn,Gn,Co,Yn,Zn,je,Kn,Qe,Qn,Xn,er,ze,or,qe,tr,nr,rr,R,Xe,ar,sr,Po,dr,cr,jo,ir,lr,hr,k,Ae,pr,X,fr,eo,mr,ur,zo,gr,_r,vr,fe,Er,qo,br,wr,Le,yr,h,Ie,Tr,Ao,kr,Sr,ee,Dr,Lo,Mr,$r,Io,xr,Cr,Pr,oe,jr,Fo,zr,qr,Oo,Ar,Lr,Ir,te,A,Fr,No,Or,Nr,Wo,Wr,Vr,Vo,Br,Rr,Hr,L,Ur,Bo,Jr,Gr,oo,Yr,Zr,Ro,Kr,Qr,Xr,w,ea,Ho,oa,ta,Uo,na,ra,Jo,aa,sa,Go,da,ca,Yo,ia,la,ha,I,pa,Zo,fa,ma,Ko,ua,ga,Qo,_a,va,Ea,ne,F,ba,Xo,wa,ya,et,Ta,ka,ot,Sa,Da,Ma,O,$a,tt,xa,Ca,to,Pa,ja,nt,za,qa,Aa,y,La,rt,Ia,Fa,at,Oa,Na,st,Wa,Va,dt,Ba,Ra,ct,Ha,Ua,Ja,re,Ga,it,Ya,Za,lt,Ka,Qa,Xa,ae,es,ht,os,ts,pt,ns,rs,as,se,ft,ss,ds,mt,cs,is,ut,ls,hs,Fe,ps,gt,fs,ms,us,_t,gs,_s,Oe,Dt;return D=new Es({}),be=new Es({}),we=new _o({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
`}}),fe=new Jd({props:{$$slots:{default:[Gd]},$$scope:{ctx:vo}}}),Le=new vs({props:{code:`from transformers import SpeechEncoderDecoderModel, Speech2Text2Processor
...
:meth`),jo=a(We,"EM",{});var ed=s(jo);ir=t(ed,"~transformers.AutoModelForCausalLM.from_pretrained"),ed.forEach(n),lr=t(We," class method for the decoder."),We.forEach(n),hr=i(u),k=a(u,"DIV",{class:!0});var U=s(k);$(Ae.$$.fragment,U),pr=i(U),X=a(U,"P",{});var io=s(X);fr=t(io,"The "),eo=a(io,"A",{href:!0});var od=s(eo);mr=t(od,"SpeechEncoderDecoderModel"),od.forEach(n),ur=t(io," forward method, overrides the "),zo=a(io,"CODE",{});var td=s(zo);gr=t(td,"__call__"),td.forEach(n),_r=t(io," special method."),io.forEach(n),vr=i(U),$(fe.$$.fragment,U),Er=i(U),qo=a(U,"P",{});var nd=s(qo);br=t(nd,"Examples:"),nd.forEach(n),wr=i(U),$(Le.$$.fragment,U),U.forEach(n),yr=i(u),h=a(u,"DIV",{class:!0});var p=s(h);$(Ie.$$.fragment,p),Tr=i(p),Ao=a(p,"P",{});var rd=s(Ao);kr=t(rd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
a user or organization name, like `),Vo=a(me,"CODE",{});var hd=s(Vo);Br=t(hd,"dbmdz/bert-base-german-cased"),hd.forEach(n),Rr=t(me,"."),me.forEach(n),Hr=i(po),L=a(po,"LI",{});var ue=s(L);Ur=t(ue,"A path to a "),Bo=a(ue,"EM",{});var pd=s(Bo);Jr=t(pd,"directory"),pd.forEach(n),Gr=t(ue,` containing model weights saved using
...
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),q.forEach(n),fo.forEach(n),Ja=i(p),re=a(p,"P",{});var mo=s(re);Ga=t(mo,"model"),it=a(mo,"EM",{});var qd=s(it);Ya=t(qd,"args (remaining positional arguments, _optional"),qd.forEach(n),Za=t(mo,`):
