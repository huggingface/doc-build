import{S as Ic,i as yc,s as wc,e as a,k as l,w as v,t as r,M as Pc,c as n,d as t,m as d,a as s,x as T,h as i,b as c,N as xc,F as e,g as h,y as b,q as I,o as y,B as w}from"../../chunks/vendor-ab4e3193.js";import{T as cn}from"../../chunks/Tip-b5c6375a.js";import{D as be}from"../../chunks/Docstring-b69c0bd4.js";import{C as mn}from"../../chunks/CodeBlock-516df0c5.js";import{I as xt}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function kc(ee){let p,P;return{c(){p=a("p"),P=r(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
PIL images.`),u.forEach(t)},m(g,u){h(g,p,u),e(p,P)},d(g){g&&t(p)}}}function Gc(ee){let p,P,g,u,x;return{c(){p=a("p"),P=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=r("Module"),x=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(f){p=n(f,"P",{});var _=s(p);P=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(_,"CODE",{});var L=s(g);u=i(L,"Module"),L.forEach(t),x=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(f,_){h(f,p,_),e(p,P),e(p,g),e(g,u),e(p,x)},d(f){f&&t(p)}}}function Ec(ee){let p,P,g,u,x;return{c(){p=a("p"),P=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=r("Module"),x=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(f){p=n(f,"P",{});var _=s(p);P=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(_,"CODE",{});var L=s(g);u=i(L,"Module"),L.forEach(t),x=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(f,_){h(f,p,_),e(p,P),e(p,g),e(g,u),e(p,x)},d(f){f&&t(p)}}}function $c(ee){let p,P,g,u,x;return{c(){p=a("p"),P=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=r("Module"),x=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(f){p=n(f,"P",{});var _=s(p);P=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(_,"CODE",{});var L=s(g);u=i(L,"Module"),L.forEach(t),x=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(f,_){h(f,p,_),e(p,P),e(p,g),e(g,u),e(p,x)},d(f){f&&t(p)}}}function Fc(ee){let p,P,g,u,x,f,_,L,hn,Ia,ce,Ie,Jt,De,pn,Xt,gn,ya,ye,un,Ne,fn,_n,wa,kt,vn,Pa,Gt,Qt,Tn,xa,we,Tl,ka,Et,bn,Ga,H,In,Le,yn,wn,Se,Pn,xn,Oe,kn,Gn,Ea,$t,En,$a,k,We,$n,Re,Fn,Cn,Mn,He,zn,Ft,jn,qn,An,Be,Dn,Ct,Nn,Ln,Sn,Ve,On,Kt,Wn,Rn,Hn,Ue,Bn,Mt,Vn,Un,Jn,Yt,Xn,Fa,Pe,Zt,G,eo,to,Qn,Kn,oo,ao,Yn,Zn,no,so,es,ts,ro,io,os,as,lo,co,ns,ss,mo,ho,rs,is,E,$,po,ls,ds,go,cs,ms,uo,hs,ps,fo,gs,us,_o,fs,_s,vo,vs,Ts,F,To,bs,Is,bo,ys,ws,Io,Ps,xs,yo,ks,Gs,wo,Es,$s,Po,Fs,Cs,C,xo,Ms,zs,ko,js,qs,Go,As,Ds,Eo,Ns,Ls,$o,Ss,Os,Fo,Ws,Rs,M,Co,Hs,Bs,Mo,Vs,Us,zo,Js,Xs,jo,Qs,Ks,qo,Ys,Zs,Ao,er,tr,z,Do,or,ar,No,nr,sr,Lo,rr,ir,So,lr,dr,Oo,cr,mr,Wo,hr,pr,j,Ro,gr,ur,Ho,fr,_r,Bo,vr,Tr,Vo,br,Ir,Uo,yr,wr,Jo,Pr,Ca,me,xe,Xo,Je,xr,Qo,kr,Ma,q,Xe,Gr,te,Er,zt,$r,Fr,Ko,Cr,Mr,Qe,zr,jr,qr,he,Ar,jt,Dr,Nr,qt,Lr,Sr,Or,Yo,Wr,Rr,Ke,za,pe,ke,Zo,Ye,Hr,ea,Br,ja,R,Ze,Vr,ta,Ur,Jr,et,Xr,oa,Qr,Kr,Yr,oe,tt,Zr,aa,ei,ti,Ge,qa,ge,Ee,na,ot,oi,sa,ai,Aa,A,at,ni,ra,si,ri,nt,ii,At,li,di,ci,st,mi,rt,hi,pi,gi,S,it,ui,ue,fi,Dt,_i,vi,ia,Ti,bi,Ii,$e,yi,la,wi,Pi,lt,Da,fe,Fe,da,dt,xi,ca,ki,Na,D,ct,Gi,ma,Ei,$i,mt,Fi,Nt,Ci,Mi,zi,ht,ji,pt,qi,Ai,Di,O,gt,Ni,_e,Li,Lt,Si,Oi,ha,Wi,Ri,Hi,Ce,Bi,pa,Vi,Ui,ut,La,ve,Me,ga,ft,Ji,ua,Xi,Sa,N,_t,Qi,vt,Ki,St,Yi,Zi,el,Tt,tl,Ot,ol,al,nl,bt,sl,It,rl,il,ll,W,yt,dl,Te,cl,Wt,ml,hl,fa,pl,gl,ul,ze,fl,_a,_l,vl,wt,Oa;return f=new xt({}),De=new xt({}),Je=new xt({}),Xe=new be({props:{name:"class transformers.ImageGPTConfig",anchor:"transformers.ImageGPTConfig",parameters:[{name:"vocab_size",val:" = 513"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 512"},{name:"n_layer",val:" = 24"},{name:"n_head",val:" = 8"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'quick_gelu'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"tie_word_embeddings",val:" = False"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/imagegpt/configuration_imagegpt.py#L30",parametersDescription:[{anchor:"transformers.ImageGPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
Vocabulary size of the GPT-2 model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.14.1/en/model_doc/imagegpt#transformers.ImageGPTModel">ImageGPTModel</a> or
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Ye=new xt({}),Ze=new be({props:{name:"class transformers.ImageGPTFeatureExtractor",anchor:"transformers.ImageGPTFeatureExtractor",parameters:[{name:"clusters",val:""},{name:"do_resize",val:" = True"},{name:"size",val:" = 32"},{name:"resample",val:" = 2"},{name:"do_normalize",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/imagegpt/feature_extraction_imagegpt.py#L46",parametersDescription:[{anchor:"transformers.ImageGPTFeatureExtractor.clusters",description:`<strong>clusters</strong> (<code>np.ndarray</code>) &#x2014;
...
<p><a
  href="/docs/transformers/v4.14.1/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a></p>
`}}),Ge=new cn({props:{warning:!0,$$slots:{default:[kc]},$$scope:{ctx:ee}}}),ot=new xt({}),at=new be({props:{name:"class transformers.ImageGPTModel",anchor:"transformers.ImageGPTModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/imagegpt/modeling_imagegpt.py#L620",parametersDescription:[{anchor:"transformers.ImageGPTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/imagegpt#transformers.ImageGPTConfig">ImageGPTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
weights.`,name:"config"}]}}),it=new be({props:{name:"forward",anchor:"transformers.ImageGPTModel.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/imagegpt/modeling_imagegpt.py#L655",parametersDescription:[{anchor:"transformers.ImageGPTModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, pixel_values_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/imagegpt#transformers.ImageGPTFeatureExtractor">ImageGPTFeatureExtractor</a>. See
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/imagegpt#transformers.ImageGPTConfig"
...
<span class="hljs-meta">... </span>   ax.imshow(img)`}}),ft=new xt({}),_t=new be({props:{name:"class transformers.ImageGPTForImageClassification",anchor:"transformers.ImageGPTForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/imagegpt/modeling_imagegpt.py#L1053",parametersDescription:[{anchor:"transformers.ImageGPTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/imagegpt#transformers.ImageGPTConfig">ImageGPTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),yt=new be({props:{name:"forward",anchor:"transformers.ImageGPTForImageClassification.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/imagegpt/modeling_imagegpt.py#L1065",parametersDescription:[{anchor:"transformers.ImageGPTForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, pixel_values_length)</code>) &#x2014;
<code>pixel_values_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>pixel_values</code> that do not have their past calculated should be
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = feature_extractor(images=image, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("meta"),P=l(),g=a("h1"),u=a("a"),x=a("span"),v(f.$$.fragment),_=l(),L=a("span"),hn=r("ImageGPT"),Ia=l(),ce=a("h2"),Ie=a("a"),Jt=a("span"),v(De.$$.fragment),pn=l(),Xt=a("span"),gn=r("Overview"),ya=l(),ye=a("p"),un=r("The ImageGPT model was proposed in "),Ne=a("a"),fn=r("Generative Pretraining from Pixels"),_n=r(` by Mark
Chen, Alec Radford, Rewon Child, Jeffrey Wu, Heewoo Jun, David Luan, Ilya Sutskever. ImageGPT (iGPT) is a GPT-2-like
model trained to predict the next pixel value, allowing for both unconditional and conditional image generation.`),wa=l(),kt=a("p"),vn=r("The abstract from the paper is the following:"),Pa=l(),Gt=a("p"),Qt=a("em"),Tn=r(`Inspired by progress in unsupervised representation learning for natural language, we examine whether similar models
...
top-1 accuracy on a linear probe of our features.`),xa=l(),we=a("img"),ka=l(),Et=a("small"),bn=r("Summary of the approach. Taken from the [original paper](https://cdn.openai.com/papers/Generative_Pretraining_from_Pixels_V2.pdf)."),Ga=l(),H=a("p"),In=r("This model was contributed by "),Le=a("a"),yn=r("nielsr"),wn=r(", based on "),Se=a("a"),Pn=r("this issue"),xn=r(`. The original code can be found
`),Oe=a("a"),kn=r("here"),Gn=r("."),Ea=l(),$t=a("p"),En=r("Tips:"),$a=l(),k=a("ul"),We=a("li"),$n=r(`Demo notebooks for ImageGPT can be found
...
train an XL variant, which they didn\u2019t release. The differences in size are summarized in the following table:`),Fa=l(),Pe=a("table"),Zt=a("thead"),G=a("tr"),eo=a("th"),to=a("strong"),Qn=r("Model variant"),Kn=l(),oo=a("th"),ao=a("strong"),Yn=r("Depths"),Zn=l(),no=a("th"),so=a("strong"),es=r("Hidden sizes"),ts=l(),ro=a("th"),io=a("strong"),os=r("Decoder hidden size"),as=l(),lo=a("th"),co=a("strong"),ns=r("Params (M)"),ss=l(),mo=a("th"),ho=a("strong"),rs=r("ImageNet-1k Top 1"),is=l(),E=a("tbody"),$=a("tr"),po=a("td"),ls=r("MiT-b0"),ds=l(),go=a("td"),cs=r("[2, 2, 2, 2]"),ms=l(),uo=a("td"),hs=r("[32, 64, 160, 256]"),ps=l(),fo=a("td"),gs=r("256"),us=l(),_o=a("td"),fs=r("3.7"),_s=l(),vo=a("td"),vs=r("70.5"),Ts=l(),F=a("tr"),To=a("td"),bs=r("MiT-b1"),Is=l(),bo=a("td"),ys=r("[2, 2, 2, 2]"),ws=l(),Io=a("td"),Ps=r("[64, 128, 320, 512]"),xs=l(),yo=a("td"),ks=r("256"),Gs=l(),wo=a("td"),Es=r("14.0"),$s=l(),Po=a("td"),Fs=r("78.7"),Cs=l(),C=a("tr"),xo=a("td"),Ms=r("MiT-b2"),zs=l(),ko=a("td"),js=r("[3, 4, 6, 3]"),qs=l(),Go=a("td"),As=r("[64, 128, 320, 512]"),Ds=l(),Eo=a("td"),Ns=r("768"),Ls=l(),$o=a("td"),Ss=r("25.4"),Os=l(),Fo=a("td"),Ws=r("81.6"),Rs=l(),M=a("tr"),Co=a("td"),Hs=r("MiT-b3"),Bs=l(),Mo=a("td"),Vs=r("[3, 4, 18, 3]"),Us=l(),zo=a("td"),Js=r("[64, 128, 320, 512]"),Xs=l(),jo=a("td"),Qs=r("768"),Ks=l(),qo=a("td"),Ys=r("45.2"),Zs=l(),Ao=a("td"),er=r("83.1"),tr=l(),z=a("tr"),Do=a("td"),or=r("MiT-b4"),ar=l(),No=a("td"),nr=r("[3, 8, 27, 3]"),sr=l(),Lo=a("td"),rr=r("[64, 128, 320, 512]"),ir=l(),So=a("td"),lr=r("768"),dr=l(),Oo=a("td"),cr=r("62.6"),mr=l(),Wo=a("td"),hr=r("83.6"),pr=l(),j=a("tr"),Ro=a("td"),gr=r("MiT-b5"),ur=l(),Ho=a("td"),fr=r("[3, 6, 40, 3]"),_r=l(),Bo=a("td"),vr=r("[64, 128, 320, 512]"),Tr=l(),Vo=a("td"),br=r("768"),Ir=l(),Uo=a("td"),yr=r("82.0"),wr=l(),Jo=a("td"),Pr=r("83.8"),Ca=l(),me=a("h2"),xe=a("a"),Xo=a("span"),v(Je.$$.fragment),xr=l(),Qo=a("span"),kr=r("ImageGPTConfig"),Ma=l(),q=a("div"),v(Xe.$$.fragment),Gr=l(),te=a("p"),Er=r("This is the configuration class to store the configuration of a "),zt=a("a"),$r=r("ImageGPTModel"),Fr=r(` or a
...
outputs. Read the documentation from `),qt=a("a"),Lr=r("PretrainedConfig"),Sr=r(" for more information."),Or=l(),Yo=a("p"),Wr=r("Example:"),Rr=l(),v(Ke.$$.fragment),za=l(),pe=a("h2"),ke=a("a"),Zo=a("span"),v(Ye.$$.fragment),Hr=l(),ea=a("span"),Br=r("ImageGPTFeatureExtractor"),ja=l(),R=a("div"),v(Ze.$$.fragment),Vr=l(),ta=a("p"),Ur=r(`Constructs an ImageGPT feature extractor. This feature extractor can be used to resize images to a smaller
...
methods. Users should refer to this superclass for more information regarding those methods.`),Yr=l(),oe=a("div"),v(tt.$$.fragment),Zr=l(),aa=a("p"),ei=r("Main method to prepare for the model one or several image(s)."),ti=l(),v(Ge.$$.fragment),qa=l(),ge=a("h2"),Ee=a("a"),na=a("span"),v(ot.$$.fragment),oi=l(),sa=a("span"),ai=r("ImageGPTModel"),Aa=l(),A=a("div"),v(at.$$.fragment),ni=l(),ra=a("p"),si=r("The bare ImageGPT Model transformer outputting raw hidden-states without any specific head on top."),ri=l(),nt=a("p"),ii=r("This model inherits from "),At=a("a"),li=r("PreTrainedModel"),di=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),ci=l(),st=a("p"),mi=r("This model is also a PyTorch "),rt=a("a"),hi=r("torch.nn.Module"),pi=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),gi=l(),S=a("div"),v(it.$$.fragment),ui=l(),ue=a("p"),fi=r("The "),Dt=a("a"),_i=r("ImageGPTModel"),vi=r(" forward method, overrides the "),ia=a("code"),Ti=r("__call__"),bi=r(" special method."),Ii=l(),v($e.$$.fragment),yi=l(),la=a("p"),wi=r("Examples:"),Pi=l(),v(lt.$$.fragment),Da=l(),fe=a("h2"),Fe=a("a"),da=a("span"),v(dt.$$.fragment),xi=l(),ca=a("span"),ki=r("ImageGPTForCausalImageModeling"),Na=l(),D=a("div"),v(ct.$$.fragment),Gi=l(),ma=a("p"),Ei=r(`The ImageGPT Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),$i=l(),mt=a("p"),Fi=r("This model inherits from "),Nt=a("a"),Ci=r("PreTrainedModel"),Mi=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),zi=l(),ht=a("p"),ji=r("This model is also a PyTorch "),pt=a("a"),qi=r("torch.nn.Module"),Ai=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Di=l(),O=a("div"),v(gt.$$.fragment),Ni=l(),_e=a("p"),Li=r("The "),Lt=a("a"),Si=r("ImageGPTForCausalImageModeling"),Oi=r(" forward method, overrides the "),ha=a("code"),Wi=r("__call__"),Ri=r(" special method."),Hi=l(),v(Ce.$$.fragment),Bi=l(),pa=a("p"),Vi=r("Examples:"),Ui=l(),v(ut.$$.fragment),La=l(),ve=a("h2"),Me=a("a"),ga=a("span"),v(ft.$$.fragment),Ji=l(),ua=a("span"),Xi=r("ImageGPTForImageClassification"),Sa=l(),N=a("div"),v(_t.$$.fragment),Qi=l(),vt=a("p"),Ki=r(`The ImageGPT Model transformer with an image classification head on top (linear layer).
`),St=a("a"),Yi=r("ImageGPTForImageClassification"),Zi=r(` average-pools the hidden states in order to do the
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),nl=l(),bt=a("p"),sl=r("This model is also a PyTorch "),It=a("a"),rl=r("torch.nn.Module"),il=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),ll=l(),W=a("div"),v(yt.$$.fragment),dl=l(),Te=a("p"),cl=r("The "),Wt=a("a"),ml=r("ImageGPTForImageClassification"),hl=r(" forward method, overrides the "),fa=a("code"),pl=r("__call__"),gl=r(" special method."),ul=l(),v(ze.$$.fragment),fl=l(),_a=a("p"),_l=r("Examples:"),vl=l(),v(wt.$$.fragment),this.h()},l(o){const m=Pc('[data-svelte="svelte-1phssyn"]',document.head);p=n(m,"META",{name:!0,content:!0}),m.forEach(t),P=d(o),g=n(o,"H1",{class:!0});var Pt=s(g);u=n(Pt,"A",{id:!0,class:!0,href:!0});var va=s(u);x=n(va,"SPAN",{});var Ta=s(x);T(f.$$.fragment,Ta),Ta.forEach(t),va.forEach(t),_=d(Pt),L=n(Pt,"SPAN",{});var ba=s(L);hn=i(ba,"ImageGPT"),ba.forEach(t),Pt.forEach(t),Ia=d(o),ce=n(o,"H2",{class:!0});var Wa=s(ce);Ie=n(Wa,"A",{id:!0,class:!0,href:!0});var bl=s(Ie);Jt=n(bl,"SPAN",{});var Il=s(Jt);T(De.$$.fragment,Il),Il.forEach(t),bl.forEach(t),pn=d(Wa),Xt=n(Wa,"SPAN",{});var yl=s(Xt);gn=i(yl,"Overview"),yl.forEach(t),Wa.forEach(t),ya=d(o),ye=n(o,"P",{});var Ra=s(ye);un=i(Ra,"The ImageGPT model was proposed in "),Ne=n(Ra,"A",{href:!0,rel:!0});var wl=s(Ne);fn=i(wl,"Generative Pretraining from Pixels"),wl.forEach(t),_n=i(Ra,` by Mark
Chen, Alec Radford, Rewon Child, Jeffrey Wu, Heewoo Jun, David Luan, Ilya Sutskever. ImageGPT (iGPT) is a GPT-2-like
model trained to predict the next pixel value, allowing for both unconditional and conditional image generation.`),Ra.forEach(t),wa=d(o),kt=n(o,"P",{});var Pl=s(kt);vn=i(Pl,"The abstract from the paper is the following:"),Pl.forEach(t),Pa=d(o),Gt=n(o,"P",{});var xl=s(Gt);Qt=n(xl,"EM",{});var kl=s(Qt);Tn=i(kl,`Inspired by progress in unsupervised representation learning for natural language, we examine whether similar models
can learn useful representations for images. We train a sequence Transformer to auto-regressively predict pixels,
without incorporating knowledge of the 2D input structure. Despite training on low-resolution ImageNet without labels,
we find that a GPT-2 scale model learns strong image representations as measured by linear probing, fine-tuning, and
low-data classification. On CIFAR-10, we achieve 96.3% accuracy with a linear probe, outperforming a supervised Wide
ResNet, and 99.0% accuracy with full fine-tuning, matching the top supervised pre-trained models. We are also
competitive with self-supervised benchmarks on ImageNet when substituting pixels for a VQVAE encoding, achieving 69.0%
top-1 accuracy on a linear probe of our features.`),kl.forEach(t),xl.forEach(t),xa=d(o),we=n(o,"IMG",{src:!0,alt:!0,width:!0}),ka=d(o),Et=n(o,"SMALL",{});var Gl=s(Et);bn=i(Gl,"Summary of the approach. Taken from the [original paper](https://cdn.openai.com/papers/Generative_Pretraining_from_Pixels_V2.pdf)."),Gl.forEach(t),Ga=d(o),H=n(o,"P",{});var je=s(H);In=i(je,"This model was contributed by "),Le=n(je,"A",{href:!0,rel:!0});var El=s(Le);yn=i(El,"nielsr"),El.forEach(t),wn=i(je,", based on "),Se=n(je,"A",{href:!0,rel:!0});var $l=s(Se);Pn=i($l,"this issue"),$l.forEach(t),xn=i(je,`. The original code can be found
`),Oe=n(je,"A",{href:!0,rel:!0});var Fl=s(Oe);kn=i(Fl,"here"),Fl.forEach(t),Gn=i(je,"."),je.forEach(t),Ea=d(o),$t=n(o,"P",{});var Cl=s($t);En=i(Cl,"Tips:"),Cl.forEach(t),$a=d(o),k=n(o,"UL",{});var B=s(k);We=n(B,"LI",{});var Ha=s(We);$n=i(Ha,`Demo notebooks for ImageGPT can be found
...
features in the middle of the network are the most performant, and can be used as-is to train a linear model (such as
a sklearn logistic regression model for example). This is also referred to as \u201Clinear probing\u201D. Features can be
easily obtained by first forwarding the image through the model, then specifying `),Kt=n(Ua,"CODE",{});var ql=s(Kt);Wn=i(ql,"output_hidden_states=True"),ql.forEach(t),Rn=i(Ua,`, and
