import{S as Vm,i as Jm,s as Km,e as s,k as d,w as _,t as n,M as Xm,c as a,d as o,m as l,a as i,x as v,h as r,b as c,F as e,g as m,y as b,q as k,o as M,B as w}from"../../chunks/vendor-ab4e3193.js";import{T as He}from"../../chunks/Tip-b5c6375a.js";import{D as P}from"../../chunks/Docstring-b69c0bd4.js";import{C as E}from"../../chunks/CodeBlock-516df0c5.js";import{I as Z}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Ym(z){let p,y,u,T,$;return{c(){p=s("p"),y=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function iu(z){let p,y,u,T,$,g,f,B,Ma,ts,ke,Ue,Dn,mt,wa,Wn,Ta,os,Ge,ya,ut,$a,Ba,ns,Ko,za,rs,Xo,Rn,Fa,ss,Yo,Pa,as,Qe,xa,ft,Ea,qa,is,ee,Ca,gt,ja,Aa,_t,Na,Sa,ds,Zo,La,ls,en,Ia,cs,vt,hs,bt,ps,tn,Oa,ms,kt,us,Mt,fs,on,Da,gs,te,Wa,Hn,Ra,Ha,Un,Ua,Ga,_s,wt,vs,Tt,bs,yt,ks,oe,Qa,$t,Va,Ja,Bt,Ka,Xa,Ms,Me,Ve,Gn,zt,Ya,Qn,Za,ws,C,Ft,ei,we,ti,nn,oi,ni,Pt,ri,si,ai,Te,ii,rn,di,li,sn,ci,hi,pi,Vn,mi,ui,xt,Ts,ye,Je,Jn,Et,fi,Kn,gi,ys,F,qt,_i,Xn,vi,bi,Ct,ki,an,Mi,wi,Ti,jt,yi,At,$i,Bi,zi,Nt,Fi,St,Pi,xi,Ei,q,qi,Yn,Ci,ji,Zn,Ai,Ni,er,Si,Li,tr,Ii,Oi,or,Di,Wi,nr,Ri,Hi,Ui,W,Lt,Gi,$e,Qi,dn,Vi,Ji,rr,Ki,Xi,Yi,Ke,Zi,sr,ed,td,It,$s,Be,Xe,ar,Ot,od,ir,nd,Bs,j,Dt,rd,Wt,sd,dr,ad,id,dd,Rt,ld,ln,cd,hd,pd,Ht,md,Ut,ud,fd,gd,R,Gt,_d,ze,vd,cn,bd,kd,lr,Md,wd,Td,Ye,yd,cr,$d,Bd,Qt,zs,Fe,Ze,hr,Vt,zd,pr,Fd,Fs,A,Jt,Pd,Kt,xd,mr,Ed,qd,Cd,Xt,jd,hn,Ad,Nd,Sd,Yt,Ld,Zt,Id,Od,Dd,H,eo,Wd,Pe,Rd,pn,Hd,Ud,ur,Gd,Qd,Vd,et,Jd,fr,Kd,Xd,to,Ps,xe,tt,gr,oo,Yd,_r,Zd,xs,N,no,el,ro,tl,vr,ol,nl,rl,so,sl,mn,al,il,dl,ao,ll,io,cl,hl,pl,U,lo,ml,Ee,ul,un,fl,gl,br,_l,vl,bl,ot,kl,kr,Ml,wl,co,Es,qe,nt,Mr,ho,Tl,wr,yl,qs,S,po,$l,Ce,Bl,Tr,zl,Fl,yr,Pl,xl,El,mo,ql,fn,Cl,jl,Al,uo,Nl,fo,Sl,Ll,Il,G,go,Ol,je,Dl,gn,Wl,Rl,$r,Hl,Ul,Gl,rt,Ql,Br,Vl,Jl,_o,Cs,Ae,st,zr,vo,Kl,Fr,Xl,js,L,bo,Yl,Pr,Zl,ec,ko,tc,_n,oc,nc,rc,Mo,sc,wo,ac,ic,dc,x,To,lc,Ne,cc,vn,hc,pc,xr,mc,uc,fc,at,gc,Er,_c,vc,yo,bc,qr,kc,Mc,$o,As,Se,it,Cr,Bo,wc,jr,Tc,Ns,I,zo,yc,Ar,$c,Bc,Fo,zc,bn,Fc,Pc,xc,Po,Ec,xo,qc,Cc,jc,Q,Eo,Ac,Le,Nc,kn,Sc,Lc,Nr,Ic,Oc,Dc,dt,Wc,Sr,Rc,Hc,qo,Ss,Ie,lt,Lr,Co,Uc,Ir,Gc,Ls,O,jo,Qc,Or,Vc,Jc,Ao,Kc,Mn,Xc,Yc,Zc,No,eh,So,th,oh,nh,V,Lo,rh,Oe,sh,wn,ah,ih,Dr,dh,lh,ch,ct,hh,Wr,ph,mh,Io,Is,De,ht,Rr,Oo,uh,Hr,fh,Os,D,Do,gh,We,_h,Ur,vh,bh,Gr,kh,Mh,wh,Wo,Th,Tn,yh,$h,Bh,Ro,zh,Ho,Fh,Ph,xh,J,Uo,Eh,Re,qh,yn,Ch,jh,Qr,Ah,Nh,Sh,pt,Lh,Vr,Ih,Oh,Go,Ds;return g=new Z({}),mt=new Z({}),vt=new E({props:{code:",",highlighted:""}}),bt=new E({props:{code:`wget --content-disposition https://api.ngc.nvidia.com/v2/models/nvidia/megatron_bert_345m/versions/v0.1_uncased/zip
...
<a href="/docs/transformers/v4.14.1/en/model_doc/megatron_bert#transformers.MegatronBertModel">MegatronBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MegatronBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/megatron_bert#transformers.MegatronBertConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Co=new Z({}),jo=new P({props:{name:"class transformers.MegatronBertForTokenClassification",anchor:"transformers.MegatronBertForTokenClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1669",parametersDescription:[{anchor:"transformers.MegatronBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/megatron_bert#transformers.MegatronBertConfig">MegatronBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),Lo=new P({props:{name:"forward",anchor:"transformers.MegatronBertForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1684",parametersDescription:[{anchor:"transformers.MegatronBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
`),Un=s("code"),Ua=n("megatron_bert_345m_v0_1_{cased, uncased}.zip"),Ga=n(" and that the commands are run from inside that folder:"),_s=d(),_(wt.$$.fragment),vs=d(),_(Tt.$$.fragment),bs=d(),_(yt.$$.fragment),ks=d(),oe=s("p"),Qa=n("This model was contributed by "),$t=s("a"),Va=n("jdemouth"),Ja=n(". The original code can be found "),Bt=s("a"),Ka=n("here"),Xa=n(`. That repository contains a multi-GPU and multi-node implementation of the
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Dd=d(),H=s("div"),_(eo.$$.fragment),Wd=d(),Pe=s("p"),Rd=n("The "),pn=s("a"),Hd=n("MegatronBertForCausalLM"),Ud=n(" forward method, overrides the "),ur=s("code"),Gd=n("__call__"),Qd=n(" special method."),Vd=d(),_(et.$$.fragment),Jd=d(),fr=s("p"),Kd=n("Example:"),Xd=d(),_(to.$$.fragment),Ps=d(),xe=s("h2"),tt=s("a"),gr=s("span"),_(oo.$$.fragment),Yd=d(),_r=s("span"),Zd=n("MegatronBertForNextSentencePrediction"),xs=d(),N=s("div"),_(no.$$.fragment),el=d(),ro=s("p"),tl=n("MegatronBert Model with a "),vr=s("em"),ol=n("next sentence prediction (classification)"),nl=n(" head on top."),rl=d(),so=s("p"),sl=n("This model inherits from "),mn=s("a"),al=n("PreTrainedModel"),il=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),dl=d(),ao=s("p"),ll=n("This model is also a PyTorch "),io=s("a"),cl=n("torch.nn.Module"),hl=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),pl=d(),U=s("div"),_(lo.$$.fragment),ml=d(),Ee=s("p"),ul=n("The "),un=s("a"),fl=n("MegatronBertForNextSentencePrediction"),gl=n(" forward method, overrides the "),br=s("code"),_l=n("__call__"),vl=n(" special method."),bl=d(),_(ot.$$.fragment),kl=d(),kr=s("p"),Ml=n("Example:"),wl=d(),_(co.$$.fragment),Es=d(),qe=s("h2"),nt=s("a"),Mr=s("span"),_(ho.$$.fragment),Tl=d(),wr=s("span"),yl=n("MegatronBertForPreTraining"),qs=d(),S=s("div"),_(po.$$.fragment),$l=d(),Ce=s("p"),Bl=n("MegatronBert Model with two heads on top as done during the pretraining: a "),Tr=s("em"),zl=n("masked language modeling"),Fl=n(` head and a
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Il=d(),G=s("div"),_(go.$$.fragment),Ol=d(),je=s("p"),Dl=n("The "),gn=s("a"),Wl=n("MegatronBertForPreTraining"),Rl=n(" forward method, overrides the "),$r=s("code"),Hl=n("__call__"),Ul=n(" special method."),Gl=d(),_(rt.$$.fragment),Ql=d(),Br=s("p"),Vl=n("Example:"),Jl=d(),_(_o.$$.fragment),Cs=d(),Ae=s("h2"),st=s("a"),zr=s("span"),_(vo.$$.fragment),Kl=d(),Fr=s("span"),Xl=n("MegatronBertForSequenceClassification"),js=d(),L=s("div"),_(bo.$$.fragment),Yl=d(),Pr=s("p"),Zl=n(`MegatronBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),dc=d(),x=s("div"),_(To.$$.fragment),lc=d(),Ne=s("p"),cc=n("The "),vn=s("a"),hc=n("MegatronBertForSequenceClassification"),pc=n(" forward method, overrides the "),xr=s("code"),mc=n("__call__"),uc=n(" special method."),fc=d(),_(at.$$.fragment),gc=d(),Er=s("p"),_c=n("Example of single-label classification:"),vc=d(),_(yo.$$.fragment),bc=d(),qr=s("p"),kc=n("Example of multi-label classification:"),Mc=d(),_($o.$$.fragment),As=d(),Se=s("h2"),it=s("a"),Cr=s("span"),_(Bo.$$.fragment),wc=d(),jr=s("span"),Tc=n("MegatronBertForMultipleChoice"),Ns=d(),I=s("div"),_(zo.$$.fragment),yc=d(),Ar=s("p"),$c=n(`MegatronBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output
and a softmax) e.g. for RocStories/SWAG tasks.`),Bc=d(),Fo=s("p"),zc=n("This model inherits from "),bn=s("a"),Fc=n("PreTrainedModel"),Pc=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
linear layers on top of the hidden-states output to compute `),Ur=s("em"),vh=n("span start logits"),bh=n(" and "),Gr=s("em"),kh=n("span end logits"),Mh=n(")."),wh=d(),Wo=s("p"),Th=n("This model inherits from "),Tn=s("a"),yh=n("PreTrainedModel"),$h=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
Megatron Language models. In particular, it contains a hybrid model parallel approach using \u201Ctensor parallel\u201D and
\u201Cpipeline parallel\u201D techniques.`),zn.forEach(o),Ms=l(t),Me=a(t,"H2",{class:!0});var Rs=i(Me);Ve=a(Rs,"A",{id:!0,class:!0,href:!0});var np=i(Ve);Gn=a(np,"SPAN",{});var rp=i(Gn);v(zt.$$.fragment,rp),rp.forEach(o),np.forEach(o),Ya=l(Rs),Qn=a(Rs,"SPAN",{});var sp=i(Qn);Za=r(sp,"MegatronBertConfig"),sp.forEach(o),Rs.forEach(o),ws=l(t),C=a(t,"DIV",{class:!0});var ne=i(C);v(Ft.$$.fragment,ne),ei=l(ne),we=a(ne,"P",{});var Fn=i(we);ti=r(Fn,"This is the configuration class to store the configuration of a "),nn=a(Fn,"A",{href:!0});var ap=i(nn);oi=r(ap,"MegatronBertModel"),ap.forEach(o),ni=r(Fn,`. It is
used to instantiate a MEGATRON_BERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the MEGATRON_BERT
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Qs.forEach(o),Ei=l(K),q=a(K,"P",{});var X=i(q);qi=r(X,"To behave as an decoder the model needs to be initialized with the "),Yn=a(X,"CODE",{});var vp=i(Yn);Ci=r(vp,"is_decoder"),vp.forEach(o),ji=r(X,` argument of the configuration
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),sa.forEach(o),pl=l(le),U=a(le,"DIV",{class:!0});var ce=i(U);v(lo.$$.fragment,ce),ml=l(ce),Ee=a(ce,"P",{});var Cn=i(Ee);ul=r(Cn,"The "),un=a(Cn,"A",{href:!0});var Xp=i(un);fl=r(Xp,"MegatronBertForNextSentencePrediction"),Xp.forEach(o),gl=r(Cn," forward method, overrides the "),br=a(Cn,"CODE",{});var Yp=i(br);_l=r(Yp,"__call__"),Yp.forEach(o),vl=r(Cn," special method."),Cn.forEach(o),bl=l(ce),v(ot.$$.fragment,ce),kl=l(ce),kr=a(ce,"P",{});var Zp=i(kr);Ml=r(Zp,"Example:"),Zp.forEach(o),wl=l(ce),v(co.$$.fragment,ce),ce.forEach(o),le.forEach(o),Es=l(t),qe=a(t,"H2",{class:!0});var aa=i(qe);nt=a(aa,"A",{id:!0,class:!0,href:!0});var em=i(nt);Mr=a(em,"SPAN",{});var tm=i(Mr);v(ho.$$.fragment,tm),tm.forEach(o),em.forEach(o),Tl=l(aa),wr=a(aa,"SPAN",{});var om=i(wr);yl=r(om,"MegatronBertForPreTraining"),om.forEach(o),aa.forEach(o),qs=l(t),S=a(t,"DIV",{class:!0});var he=i(S);v(po.$$.fragment,he),$l=l(he),Ce=a(he,"P",{});var jn=i(Ce);Bl=r(jn,"MegatronBert Model with two heads on top as done during the pretraining: a "),Tr=a(jn,"EM",{});var nm=i(Tr);zl=r(nm,"masked language modeling"),nm.forEach(o),Fl=r(jn,` head and a
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),ha.forEach(o),dc=l(me),x=a(me,"DIV",{class:!0});var Y=i(x);v(To.$$.fragment,Y),lc=l(Y),Ne=a(Y,"P",{});var Nn=i(Ne);cc=r(Nn,"The "),vn=a(Nn,"A",{href:!0});var gm=i(vn);hc=r(gm,"MegatronBertForSequenceClassification"),gm.forEach(o),pc=r(Nn," forward method, overrides the "),xr=a(Nn,"CODE",{});var _m=i(xr);mc=r(_m,"__call__"),_m.forEach(o),uc=r(Nn," special method."),Nn.forEach(o),fc=l(Y),v(at.$$.fragment,Y),gc=l(Y),Er=a(Y,"P",{});var vm=i(Er);_c=r(vm,"Example of single-label classification:"),vm.forEach(o),vc=l(Y),v(yo.$$.fragment,Y),bc=l(Y),qr=a(Y,"P",{});var bm=i(qr);kc=r(bm,"Example of multi-label classification:"),bm.forEach(o),Mc=l(Y),v($o.$$.fragment,Y),Y.forEach(o),me.forEach(o),As=l(t),Se=a(t,"H2",{class:!0});var pa=i(Se);it=a(pa,"A",{id:!0,class:!0,href:!0});var km=i(it);Cr=a(km,"SPAN",{});var Mm=i(Cr);v(Bo.$$.fragment,Mm),Mm.forEach(o),km.forEach(o),wc=l(pa),jr=a(pa,"SPAN",{});var wm=i(jr);Tc=r(wm,"MegatronBertForMultipleChoice"),wm.forEach(o),pa.forEach(o),Ns=l(t),I=a(t,"DIV",{class:!0});var ue=i(I);v(zo.$$.fragment,ue),yc=l(ue),Ar=a(ue,"P",{});var Tm=i(Ar);$c=r(Tm,`MegatronBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output
and a softmax) e.g. for RocStories/SWAG tasks.`),Tm.forEach(o),Bc=l(ue),Fo=a(ue,"P",{});var ma=i(Fo);zc=r(ma,"This model inherits from "),bn=a(ma,"A",{href:!0});var ym=i(bn);Fc=r(ym,"PreTrainedModel"),ym.forEach(o),Pc=r(ma,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),ua.forEach(o),jc=l(ue),Q=a(ue,"DIV",{class:!0});var fe=i(Q);v(Eo.$$.fragment,fe),Ac=l(fe),Le=a(fe,"P",{});var Sn=i(Le);Nc=r(Sn,"The "),kn=a(Sn,"A",{href:!0});var Bm=i(kn);Sc=r(Bm,"MegatronBertForMultipleChoice"),Bm.forEach(o),Lc=r(Sn," forward method, overrides the "),Nr=a(Sn,"CODE",{});var zm=i(Nr);Ic=r(zm,"__call__"),zm.forEach(o),Oc=r(Sn," special method."),Sn.forEach(o),Dc=l(fe),v(dt.$$.fragment,fe),Wc=l(fe),Sr=a(fe,"P",{});var Fm=i(Sr);Rc=r(Fm,"Example:"),Fm.forEach(o),Hc=l(fe),v(qo.$$.fragment,fe),fe.forEach(o),ue.forEach(o),Ss=l(t),Ie=a(t,"H2",{class:!0});var fa=i(Ie);lt=a(fa,"A",{id:!0,class:!0,href:!0});var Pm=i(lt);Lr=a(Pm,"SPAN",{});var xm=i(Lr);v(Co.$$.fragment,xm),xm.forEach(o),Pm.forEach(o),Uc=l(fa),Ir=a(fa,"SPAN",{});var Em=i(Ir);Gc=r(Em,"MegatronBertForTokenClassification"),Em.forEach(o),fa.forEach(o),Ls=l(t),O=a(t,"DIV",{class:!0});var ge=i(O);v(jo.$$.fragment,ge),Qc=l(ge),Or=a(ge,"P",{});var qm=i(Or);Vc=r(qm,`MegatronBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
