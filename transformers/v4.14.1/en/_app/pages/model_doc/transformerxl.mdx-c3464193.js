import{S as wf,i as yf,s as Lf,e as n,k as l,w as b,t as r,M as kf,c as s,d as t,m as d,a,x as w,h as i,b as c,F as e,g as h,y,q as L,o as k,B as $}from"../../chunks/vendor-ab4e3193.js";import{T as xt}from"../../chunks/Tip-b5c6375a.js";import{D as de}from"../../chunks/Docstring-b69c0bd4.js";import{C as Rt}from"../../chunks/CodeBlock-516df0c5.js";import{I as Ge}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function $f(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=n("code"),g=r("Module"),v=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function xf(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=n("code"),g=r("Module"),v=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(_,"CODE",{});var E=a(u);g=i(E,"Module"),E.forEach(t),v=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function Xf(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(_,"CODE",{});var E=a(u);g=i(E,"Module"),E.forEach(t),v=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function Mf(V){let m,x,u,g,v,T,_,E,we,Z,X,Y,A,J,ye,D,Le,ue,I,S,ee,ne,F,C,se,U,ge,ae,W,ke,_e,z,$e,B,Q,ce,R,xe,fe,O,Te,q,Xe;return{c(){m=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),v=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=n("li"),we=r("having all inputs as a list, tuple or dict in the first positional arguments."),Z=l(),X=n("p"),Y=r("This second option is useful when using "),A=n("code"),J=r("tf.keras.Model.fit"),ye=r(` method which currently requires having all
...
`),B=n("code"),Q=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),xe=r("model([input_ids, attention_mask, token_type_ids])"),fe=l(),O=n("li"),Te=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=n("code"),Xe=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){m=s(f,"P",{});var M=a(m);x=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),u=d(f),g=s(f,"UL",{});var re=a(g);v=s(re,"LI",{});var ve=a(v);T=i(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),_=d(re),E=s(re,"LI",{});var We=a(E);we=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),re.forEach(t),Z=d(f),X=s(f,"P",{});var N=a(X);Y=i(N,"This second option is useful when using "),A=s(N,"CODE",{});var Ne=a(A);J=i(Ne,"tf.keras.Model.fit"),Ne.forEach(t),ye=i(N,` method which currently requires having all
...
`),B=s(G,"CODE",{});var He=a(B);Q=i(He,"model([input_ids, attention_mask])"),He.forEach(t),ce=i(G," or "),R=s(G,"CODE",{});var H=a(R);xe=i(H,"model([input_ids, attention_mask, token_type_ids])"),H.forEach(t),G.forEach(t),fe=d(P),O=s(P,"LI",{});var te=a(O);Te=i(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=s(te,"CODE",{});var Ve=a(q);Xe=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),te.forEach(t),P.forEach(t)},m(f,M){h(f,m,M),e(m,x),h(f,u,M),h(f,g,M),e(g,v),e(v,T),e(g,_),e(g,E),e(E,we),h(f,Z,M),h(f,X,M),e(X,Y),e(X,A),e(A,J),e(X,ye),e(X,D),e(D,Le),e(X,ue),h(f,I,M),h(f,S,M),e(S,ee),h(f,ne,M),h(f,F,M),e(F,C),e(C,se),e(C,U),e(U,ge),e(C,ae),e(C,W),e(W,ke),e(F,_e),e(F,z),e(z,$e),e(z,B),e(B,Q),e(z,ce),e(z,R),e(R,xe),e(F,fe),e(F,O),e(O,Te),e(O,q),e(q,Xe)},d(f){f&&t(m),f&&t(u),f&&t(g),f&&t(Z),f&&t(X),f&&t(I),f&&t(S),f&&t(ne),f&&t(F)}}}function Ef(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=n("code"),g=r("Module"),v=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(_,"CODE",{});var E=a(u);g=i(E,"Module"),E.forEach(t),v=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function Ff(V){let m,x,u,g,v,T,_,E,we,Z,X,Y,A,J,ye,D,Le,ue,I,S,ee,ne,F,C,se,U,ge,ae,W,ke,_e,z,$e,B,Q,ce,R,xe,fe,O,Te,q,Xe;return{c(){m=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),v=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=n("li"),we=r("having all inputs as a list, tuple or dict in the first positional arguments."),Z=l(),X=n("p"),Y=r("This second option is useful when using "),A=n("code"),J=r("tf.keras.Model.fit"),ye=r(` method which currently requires having all
the tensors in the first argument of the model call function: `),D=n("code"),Le=r("model(inputs)"),ue=r("."),I=l(),S=n("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),ne=l(),F=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),ge=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),ke=r("model(inputs_ids)"),_e=l(),z=n("li"),$e=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),Q=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),xe=r("model([input_ids, attention_mask, token_type_ids])"),fe=l(),O=n("li"),Te=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=n("code"),Xe=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){m=s(f,"P",{});var M=a(m);x=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),u=d(f),g=s(f,"UL",{});var re=a(g);v=s(re,"LI",{});var ve=a(v);T=i(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),_=d(re),E=s(re,"LI",{});var We=a(E);we=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),re.forEach(t),Z=d(f),X=s(f,"P",{});var N=a(X);Y=i(N,"This second option is useful when using "),A=s(N,"CODE",{});var Ne=a(A);J=i(Ne,"tf.keras.Model.fit"),Ne.forEach(t),ye=i(N,` method which currently requires having all
...
the first positional argument :`),he.forEach(t),ne=d(f),F=s(f,"UL",{});var P=a(F);C=s(P,"LI",{});var j=a(C);se=i(j,"a single Tensor with "),U=s(j,"CODE",{});var Be=a(U);ge=i(Be,"input_ids"),Be.forEach(t),ae=i(j," only and nothing else: "),W=s(j,"CODE",{});var Fe=a(W);ke=i(Fe,"model(inputs_ids)"),Fe.forEach(t),j.forEach(t),_e=d(P),z=s(P,"LI",{});var G=a(z);$e=i(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=s(G,"CODE",{});var He=a(B);Q=i(He,"model([input_ids, attention_mask])"),He.forEach(t),ce=i(G," or "),R=s(G,"CODE",{});var H=a(R);xe=i(H,"model([input_ids, attention_mask, token_type_ids])"),H.forEach(t),G.forEach(t),fe=d(P),O=s(P,"LI",{});var te=a(O);Te=i(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=s(te,"CODE",{});var Ve=a(q);Xe=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),te.forEach(t),P.forEach(t)},m(f,M){h(f,m,M),e(m,x),h(f,u,M),h(f,g,M),e(g,v),e(v,T),e(g,_),e(g,E),e(E,we),h(f,Z,M),h(f,X,M),e(X,Y),e(X,A),e(A,J),e(X,ye),e(X,D),e(D,Le),e(X,ue),h(f,I,M),h(f,S,M),e(S,ee),h(f,ne,M),h(f,F,M),e(F,C),e(C,se),e(C,U),e(U,ge),e(C,ae),e(C,W),e(W,ke),e(F,_e),e(F,z),e(z,$e),e(z,B),e(B,Q),e(z,ce),e(z,R),e(R,xe),e(F,fe),e(F,O),e(O,Te),e(O,q),e(q,Xe)},d(f){f&&t(m),f&&t(u),f&&t(g),f&&t(Z),f&&t(X),f&&t(I),f&&t(S),f&&t(ne),f&&t(F)}}}function zf(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=n("code"),g=r("Module"),v=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(_,"CODE",{});var E=a(u);g=i(E,"Module"),E.forEach(t),v=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function Cf(V){let m,x,u,g,v,T,_,E,we,Z,X,Y,A,J,ye,D,Le,ue,I,S,ee,ne,F,C,se,U,ge,ae,W,ke,_e,z,$e,B,Q,ce,R,xe,fe,O,Te,q,Xe;return{c(){m=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),v=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=n("li"),we=r("having all inputs as a list, tuple or dict in the first positional arguments."),Z=l(),X=n("p"),Y=r("This second option is useful when using "),A=n("code"),J=r("tf.keras.Model.fit"),ye=r(` method which currently requires having all
the tensors in the first argument of the model call function: `),D=n("code"),Le=r("model(inputs)"),ue=r("."),I=l(),S=n("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),ne=l(),F=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),ge=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),ke=r("model(inputs_ids)"),_e=l(),z=n("li"),$e=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),Q=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),xe=r("model([input_ids, attention_mask, token_type_ids])"),fe=l(),O=n("li"),Te=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=n("code"),Xe=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){m=s(f,"P",{});var M=a(m);x=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),u=d(f),g=s(f,"UL",{});var re=a(g);v=s(re,"LI",{});var ve=a(v);T=i(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),_=d(re),E=s(re,"LI",{});var We=a(E);we=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),re.forEach(t),Z=d(f),X=s(f,"P",{});var N=a(X);Y=i(N,"This second option is useful when using "),A=s(N,"CODE",{});var Ne=a(A);J=i(Ne,"tf.keras.Model.fit"),Ne.forEach(t),ye=i(N,` method which currently requires having all
...
the first positional argument :`),he.forEach(t),ne=d(f),F=s(f,"UL",{});var P=a(F);C=s(P,"LI",{});var j=a(C);se=i(j,"a single Tensor with "),U=s(j,"CODE",{});var Be=a(U);ge=i(Be,"input_ids"),Be.forEach(t),ae=i(j," only and nothing else: "),W=s(j,"CODE",{});var Fe=a(W);ke=i(Fe,"model(inputs_ids)"),Fe.forEach(t),j.forEach(t),_e=d(P),z=s(P,"LI",{});var G=a(z);$e=i(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=s(G,"CODE",{});var He=a(B);Q=i(He,"model([input_ids, attention_mask])"),He.forEach(t),ce=i(G," or "),R=s(G,"CODE",{});var H=a(R);xe=i(H,"model([input_ids, attention_mask, token_type_ids])"),H.forEach(t),G.forEach(t),fe=d(P),O=s(P,"LI",{});var te=a(O);Te=i(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=s(te,"CODE",{});var Ve=a(q);Xe=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),te.forEach(t),P.forEach(t)},m(f,M){h(f,m,M),e(m,x),h(f,u,M),h(f,g,M),e(g,v),e(v,T),e(g,_),e(g,E),e(E,we),h(f,Z,M),h(f,X,M),e(X,Y),e(X,A),e(A,J),e(X,ye),e(X,D),e(D,Le),e(X,ue),h(f,I,M),h(f,S,M),e(S,ee),h(f,ne,M),h(f,F,M),e(F,C),e(C,se),e(C,U),e(U,ge),e(C,ae),e(C,W),e(W,ke),e(F,_e),e(F,z),e(z,$e),e(z,B),e(B,Q),e(z,ce),e(z,R),e(R,xe),e(F,fe),e(F,O),e(O,Te),e(O,q),e(q,Xe)},d(f){f&&t(m),f&&t(u),f&&t(g),f&&t(Z),f&&t(X),f&&t(I),f&&t(S),f&&t(ne),f&&t(F)}}}function qf(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=n("code"),g=r("Module"),v=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(_,"CODE",{});var E=a(u);g=i(E,"Module"),E.forEach(t),v=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function Pf(V){let m,x,u,g,v,T,_,E,we,Z,X,Y,A,J,ye,D,Le,ue,I,S,ee,ne,F,C,se,U,ge,ae,W,ke,_e,z,$e,B,Q,ce,R,xe,fe,O,Te,q,Xe,f,M,re,ve,We,N,Ne,ie,he,P,j,Be,Fe,G,He,H,te,Ve,Ke,qa,en,Pa,ja,tn,Sa,Oa,Gt,Na,Ha,Aa,rt,Da,on,Ia,Wa,nn,Ba,Va,Ua,Cn,Ra,Ga,Kt,js,it,Xt,qn,Yt,Ka,Pn,Ya,Ss,Ae,Qt,Qa,Zt,Za,Jt,Ja,er,tr,eo,or,sn,nr,sr,ar,jn,Os,lt,Mt,Sn,to,rr,On,ir,Ns,dt,oo,lr,Nn,dr,Hs,ct,no,cr,Hn,fr,As,ft,so,hr,An,pr,Ds,ht,ao,mr,Dn,ur,Is,pt,Et,In,ro,gr,Wn,_r,Ws,Me,io,Tr,Bn,vr,br,lo,wr,an,yr,Lr,kr,co,$r,fo,xr,Xr,Mr,ze,ho,Er,mt,Fr,rn,zr,Cr,Vn,qr,Pr,jr,Ft,Sr,Un,Or,Nr,po,Bs,ut,zt,Rn,mo,Hr,Gn,Ar,Vs,Ee,uo,Dr,Kn,Ir,Wr,go,Br,ln,Vr,Ur,Rr,_o,Gr,To,Kr,Yr,Qr,Ce,vo,Zr,gt,Jr,dn,ei,ti,Yn,oi,ni,si,Ct,ai,Qn,ri,ii,bo,Us,_t,qt,Zn,wo,li,Jn,di,Rs,oe,yo,ci,es,fi,hi,cn,fn,pi,mi,ui,De,gi,ts,_i,Ti,os,vi,bi,ns,wi,yi,ss,Li,ki,$i,Lo,xi,hn,Xi,Mi,Ei,ko,Fi,$o,zi,Ci,qi,le,xo,Pi,Tt,ji,pn,Si,Oi,as,Ni,Hi,Ai,Pt,Di,rs,Ii,Wi,Xo,Bi,is,Vi,Ui,Mo,Gs,vt,jt,ls,Eo,Ri,ds,Gi,Ks,pe,Fo,Ki,cs,Yi,Qi,zo,Zi,mn,Ji,el,tl,Co,ol,qo,nl,sl,al,St,rl,qe,Po,il,bt,ll,un,dl,cl,fs,fl,hl,pl,Ot,ml,hs,ul,gl,jo,Ys,wt,Nt,ps,So,_l,ms,Tl,Qs,me,Oo,vl,us,bl,wl,No,yl,gn,Ll,kl,$l,Ho,xl,Ao,Xl,Ml,El,Ht,Fl,Pe,Do,zl,yt,Cl,_n,ql,Pl,gs,jl,Sl,Ol,At,Nl,_s,Hl,Al,Io,Zs,Lt,Dt,Ts,Wo,Dl,vs,Il,Js,K,Bo,Wl,bs,Bl,Vl,Tn,vn,Ul,Rl,Gl,Ie,Kl,ws,Yl,Ql,ys,Zl,Jl,Ls,ed,td,ks,od,nd,sd,Vo,ad,bn,rd,id,ld,Uo,dd,Ro,cd,fd,hd,It,pd,je,Go,md,kt,ud,wn,gd,_d,$s,Td,vd,bd,Wt,wd,xs,yd,Ld,Ko,ea,$t,Bt,Xs,Yo,kd,Ms,$d,ta,yn,oa,Ln,na;return T=new Ge({}),J=new Ge({}),j=new Ge({}),te=new de({props:{name:"class transformers.TransfoXLConfig",anchor:"transformers.TransfoXLConfig",parameters:[{name:"vocab_size",val:" = 267735"},{name:"cutoffs",val:" = [20000, 40000, 200000]"},{name:"d_model",val:" = 1024"},{name:"d_embed",val:" = 1024"},{name:"n_head",val:" = 16"},{name:"d_head",val:" = 64"},{name:"d_inner",val:" = 4096"},{name:"div_val",val:" = 4"},{name:"pre_lnorm",val:" = False"},{name:"n_layer",val:" = 18"},{name:"mem_len",val:" = 1600"},{name:"clamp_len",val:" = 1000"},{name:"same_length",val:" = True"},{name:"proj_share_all_but_first",val:" = True"},{name:"attn_type",val:" = 0"},{name:"sample_softmax",val:" = -1"},{name:"adaptive",val:" = True"},{name:"dropout",val:" = 0.1"},{name:"dropatt",val:" = 0.0"},{name:"untie_r",val:" = True"},{name:"init",val:" = 'normal'"},{name:"init_range",val:" = 0.01"},{name:"proj_init_std",val:" = 0.01"},{name:"init_std",val:" = 0.02"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"eos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/transfo_xl/configuration_transfo_xl.py#L29",parametersDescription:[{anchor:"transformers.TransfoXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 267735) &#x2014;
Vocabulary size of the BERT model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLModel">TransfoXLModel</a> or
<a href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TFTransfoXLModel">TFTransfoXLModel</a>.`,name:"vocab_size"},{anchor:"transformers.TransfoXLConfig.cutoffs",description:`<strong>cutoffs</strong> (<code>List[int]</code>, <em>optional</em>, defaults to <code>[20000, 40000, 200000]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Yt=new Ge({}),Qt=new de({props:{name:"class transformers.TransfoXLTokenizer",anchor:"transformers.TransfoXLTokenizer",parameters:[{name:"special",val:" = None"},{name:"min_freq",val:" = 0"},{name:"max_size",val:" = None"},{name:"lower_case",val:" = False"},{name:"delimiter",val:" = None"},{name:"vocab_file",val:" = None"},{name:"pretrained_vocab_file",val:": str = None"},{name:"never_split",val:" = None"},{name:"unk_token",val:" = '<unk>'"},{name:"eos_token",val:" = '<eos>'"},{name:"additional_special_tokens",val:" = ['<formula>']"},{name:"language",val:" = 'en'"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/transfo_xl/tokenization_transfo_xl.py#L111",parametersDescription:[{anchor:"transformers.TransfoXLTokenizer.special",description:`<strong>special</strong> (<code>List[str]</code>, <em>optional</em>) &#x2014;
...
weights.`,name:"config"}]}}),ho=new de({props:{name:"forward",anchor:"transformers.TransfoXLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L873",parametersDescription:[{anchor:"transformers.TransfoXLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLConfig"
...
`}}),Ft=new xt({props:{$$slots:{default:[$f]},$$scope:{ctx:V}}}),po=new Rt({props:{code:`from transformers import TransfoXLTokenizer, TransfoXLModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),mo=new Ge({}),uo=new de({props:{name:"class transformers.TransfoXLLMHeadModel",anchor:"transformers.TransfoXLLMHeadModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1011",parametersDescription:[{anchor:"transformers.TransfoXLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),vo=new de({props:{name:"forward",anchor:"transformers.TransfoXLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1055",parametersDescription:[{anchor:"transformers.TransfoXLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],returnDescription:`
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Yo=new Ge({}),{c(){m=n("meta"),x=l(),u=n("h1"),g=n("a"),v=n("span"),b(T.$$.fragment),_=l(),E=n("span"),we=r("Transformer XL"),Z=l(),X=n("h2"),Y=n("a"),A=n("span"),b(J.$$.fragment),ye=l(),D=n("span"),Le=r("Overview"),ue=l(),I=n("p"),S=r("The Transformer-XL model was proposed in "),ee=n("a"),ne=r("Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context"),F=r(` by Zihang Dai, Zhilin Yang, Yiming Yang, Jaime Carbonell, Quoc V. Le, Ruslan
...
coherent, novel text articles with thousands of tokens.`),_e=l(),z=n("p"),$e=r("Tips:"),B=l(),Q=n("ul"),ce=n("li"),R=r(`Transformer-XL uses relative sinusoidal positional embeddings. Padding can be done on the left or on the right. The
...
outputs. Read the documentation from `),nn=n("a"),Ba=r("PretrainedConfig"),Va=r(" for more information."),Ua=l(),Cn=n("p"),Ra=r("Examples:"),Ga=l(),b(Kt.$$.fragment),js=l(),it=n("h2"),Xt=n("a"),qn=n("span"),b(Yt.$$.fragment),Ka=l(),Pn=n("span"),Ya=r("TransfoXLTokenizer"),Ss=l(),Ae=n("div"),b(Qt.$$.fragment),Qa=l(),Zt=n("p"),Za=r("Construct a Transformer-XL tokenizer adapted from Vocab class in "),Jt=n("a"),Ja=r("the original code"),er=r(`. The Transformer-XL tokenizer is a word-level tokenizer (no
...
Users should refer to this superclass for more information regarding those methods.`),ar=l(),jn=n("div"),Os=l(),lt=n("h2"),Mt=n("a"),Sn=n("span"),b(to.$$.fragment),rr=l(),On=n("span"),ir=r("TransfoXL specific outputs"),Ns=l(),dt=n("div"),b(oo.$$.fragment),lr=l(),Nn=n("p"),dr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Hs=l(),ct=n("div"),b(no.$$.fragment),cr=l(),Hn=n("p"),fr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),As=l(),ft=n("div"),b(so.$$.fragment),hr=l(),An=n("p"),pr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ds=l(),ht=n("div"),b(ao.$$.fragment),mr=l(),Dn=n("p"),ur=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Is=l(),pt=n("h2"),Et=n("a"),In=n("span"),b(ro.$$.fragment),gr=l(),Wn=n("span"),_r=r("TransfoXLModel"),Ws=l(),Me=n("div"),b(io.$$.fragment),Tr=l(),Bn=n("p"),vr=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),br=l(),lo=n("p"),wr=r("This model inherits from "),an=n("a"),yr=r("PreTrainedModel"),Lr=r(`. Check the superclass documentation for the generic
...
general usage and behavior.`),Mr=l(),ze=n("div"),b(ho.$$.fragment),Er=l(),mt=n("p"),Fr=r("The "),rn=n("a"),zr=r("TransfoXLModel"),Cr=r(" forward method, overrides the "),Vn=n("code"),qr=r("__call__"),Pr=r(" special method."),jr=l(),b(Ft.$$.fragment),Sr=l(),Un=n("p"),Or=r("Example:"),Nr=l(),b(po.$$.fragment),Bs=l(),ut=n("h2"),zt=n("a"),Rn=n("span"),b(mo.$$.fragment),Hr=l(),Gn=n("span"),Ar=r("TransfoXLLMHeadModel"),Vs=l(),Ee=n("div"),b(uo.$$.fragment),Dr=l(),Kn=n("p"),Ir=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Qr=l(),Ce=n("div"),b(vo.$$.fragment),Zr=l(),gt=n("p"),Jr=r("The "),dn=n("a"),ei=r("TransfoXLLMHeadModel"),ti=r(" forward method, overrides the "),Yn=n("code"),oi=r("__call__"),ni=r(" special method."),si=l(),b(Ct.$$.fragment),ai=l(),Qn=n("p"),ri=r("Example:"),ii=l(),b(bo.$$.fragment),Us=l(),_t=n("h2"),qt=n("a"),Zn=n("span"),b(wo.$$.fragment),li=l(),Jn=n("span"),di=r("TransfoXLForSequenceClassification"),Rs=l(),oe=n("div"),b(yo.$$.fragment),ci=l(),es=n("p"),fi=r("The Transformer-XL Model transformer with a sequence classification head on top (linear layer)."),hi=l(),cn=n("p"),fn=n("a"),pi=r("TransfoXLForSequenceClassification"),mi=r(` uses the last token in order to do the classification, as
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),qi=l(),le=n("div"),b(xo.$$.fragment),Pi=l(),Tt=n("p"),ji=r("The "),pn=n("a"),Si=r("TransfoXLForSequenceClassification"),Oi=r(" forward method, overrides the "),as=n("code"),Ni=r("__call__"),Hi=r(" special method."),Ai=l(),b(Pt.$$.fragment),Di=l(),rs=n("p"),Ii=r("Example of single-label classification:"),Wi=l(),b(Xo.$$.fragment),Bi=l(),is=n("p"),Vi=r("Example of multi-label classification:"),Ui=l(),b(Mo.$$.fragment),Gs=l(),vt=n("h2"),jt=n("a"),ls=n("span"),b(Eo.$$.fragment),Ri=l(),ds=n("span"),Gi=r("TFTransfoXLModel"),Ks=l(),pe=n("div"),b(Fo.$$.fragment),Ki=l(),cs=n("p"),Yi=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Qi=l(),zo=n("p"),Zi=r("This model inherits from "),mn=n("a"),Ji=r("TFPreTrainedModel"),el=r(`. Check the superclass documentation for the
...
and behavior.`),al=l(),b(St.$$.fragment),rl=l(),qe=n("div"),b(Po.$$.fragment),il=l(),bt=n("p"),ll=r("The "),un=n("a"),dl=r("TFTransfoXLModel"),cl=r(" forward method, overrides the "),fs=n("code"),fl=r("__call__"),hl=r(" special method."),pl=l(),b(Ot.$$.fragment),ml=l(),hs=n("p"),ul=r("Example:"),gl=l(),b(jo.$$.fragment),Ys=l(),wt=n("h2"),Nt=n("a"),ps=n("span"),b(So.$$.fragment),_l=l(),ms=n("span"),Tl=r("TFTransfoXLLMHeadModel"),Qs=l(),me=n("div"),b(Oo.$$.fragment),vl=l(),us=n("p"),bl=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),El=l(),b(Ht.$$.fragment),Fl=l(),Pe=n("div"),b(Do.$$.fragment),zl=l(),yt=n("p"),Cl=r("The "),_n=n("a"),ql=r("TFTransfoXLLMHeadModel"),Pl=r(" forward method, overrides the "),gs=n("code"),jl=r("__call__"),Sl=r(" special method."),Ol=l(),b(At.$$.fragment),Nl=l(),_s=n("p"),Hl=r("Example:"),Al=l(),b(Io.$$.fragment),Zs=l(),Lt=n("h2"),Dt=n("a"),Ts=n("span"),b(Wo.$$.fragment),Dl=l(),vs=n("span"),Il=r("TFTransfoXLForSequenceClassification"),Js=l(),K=n("div"),b(Bo.$$.fragment),Wl=l(),bs=n("p"),Bl=r("The Transfo XL Model transformer with a sequence classification head on top (linear layer)."),Vl=l(),Tn=n("p"),vn=n("a"),Ul=r("TFTransfoXLForSequenceClassification"),Rl=r(` uses the last token in order to do the classification,
...
`),ws=n("code"),Yl=r("pad_token_id"),Ql=r(` is defined in the configuration, it finds the last token that is not a padding token in each
row. If no `),ys=n("code"),Zl=r("pad_token_id"),Jl=r(` is defined, it simply takes the last value in each row of the batch. Since it cannot
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),hd=l(),b(It.$$.fragment),pd=l(),je=n("div"),b(Go.$$.fragment),md=l(),kt=n("p"),ud=r("The "),wn=n("a"),gd=r("TFTransfoXLForSequenceClassification"),_d=r(" forward method, overrides the "),$s=n("code"),Td=r("__call__"),vd=r(" special method."),bd=l(),b(Wt.$$.fragment),wd=l(),xs=n("p"),yd=r("Example:"),Ld=l(),b(Ko.$$.fragment),ea=l(),$t=n("h2"),Bt=n("a"),Xs=n("span"),b(Yo.$$.fragment),kd=l(),Ms=n("span"),$d=r("Internal Layers"),ta=l(),yn=n("div"),oa=l(),Ln=n("div"),this.h()},l(o){const p=kf('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(t),x=d(o),u=s(o,"H1",{class:!0});var Qo=a(u);g=s(Qo,"A",{id:!0,class:!0,href:!0});var Es=a(g);v=s(Es,"SPAN",{});var Fs=a(v);w(T.$$.fragment,Fs),Fs.forEach(t),Es.forEach(t),_=d(Qo),E=s(Qo,"SPAN",{});var zs=a(E);we=i(zs,"Transformer XL"),zs.forEach(t),Qo.forEach(t),Z=d(o),X=s(o,"H2",{class:!0});var Zo=a(X);Y=s(Zo,"A",{id:!0,class:!0,href:!0});var Cs=a(Y);A=s(Cs,"SPAN",{});var qs=a(A);w(J.$$.fragment,qs),qs.forEach(t),Cs.forEach(t),ye=d(Zo),D=s(Zo,"SPAN",{});var Ps=a(D);Le=i(Ps,"Overview"),Ps.forEach(t),Zo.forEach(t),ue=d(o),I=s(o,"P",{});var Jo=a(I);S=i(Jo,"The Transformer-XL model was proposed in "),ee=s(Jo,"A",{href:!0,rel:!0});var Md=a(ee);ne=i(Md,"Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context"),Md.forEach(t),F=i(Jo,` by Zihang Dai, Zhilin Yang, Yiming Yang, Jaime Carbonell, Quoc V. Le, Ruslan
Salakhutdinov. It\u2019s a causal (uni-directional) transformer with relative positioning (sinuso\xEFdal) embeddings which can
reuse previously computed hidden-states to attend to longer context (memory). This model also uses adaptive softmax
inputs and outputs (tied).`),Jo.forEach(t),C=d(o),se=s(o,"P",{});var Ed=a(se);U=i(Ed,"The abstract from the paper is the following:"),Ed.forEach(t),ge=d(o),ae=s(o,"P",{});var Fd=a(ae);W=s(Fd,"EM",{});var zd=a(W);ke=i(zd,`Transformers have a potential of learning longer-term dependency, but are limited by a fixed-length context in the
setting of language modeling. We propose a novel neural architecture Transformer-XL that enables learning dependency
beyond a fixed length without disrupting temporal coherence. It consists of a segment-level recurrence mechanism and a
novel positional encoding scheme. Our method not only enables capturing longer-term dependency, but also resolves the
context fragmentation problem. As a result, Transformer-XL learns dependency that is 80% longer than RNNs and 450%
...
bpc/perplexity to 0.99 on enwiki8, 1.08 on text8, 18.3 on WikiText-103, 21.8 on One Billion Word, and 54.5 on Penn
Treebank (without finetuning). When trained only on WikiText-103, Transformer-XL manages to generate reasonably
coherent, novel text articles with thousands of tokens.`),zd.forEach(t),Fd.forEach(t),_e=d(o),z=s(o,"P",{});var Cd=a(z);$e=i(Cd,"Tips:"),Cd.forEach(t),B=d(o),Q=s(o,"UL",{});var sa=a(Q);ce=s(sa,"LI",{});var qd=a(ce);R=i(qd,`Transformer-XL uses relative sinusoidal positional embeddings. Padding can be done on the left or on the right. The
...
Users should refer to this superclass for more information regarding those methods.`),la.forEach(t),ar=d(Ut),jn=s(Ut,"DIV",{class:!0}),a(jn).forEach(t),Ut.forEach(t),Os=d(o),lt=s(o,"H2",{class:!0});var da=a(lt);Mt=s(da,"A",{id:!0,class:!0,href:!0});var Qd=a(Mt);Sn=s(Qd,"SPAN",{});var Zd=a(Sn);w(to.$$.fragment,Zd),Zd.forEach(t),Qd.forEach(t),rr=d(da),On=s(da,"SPAN",{});var Jd=a(On);ir=i(Jd,"TransfoXL specific outputs"),Jd.forEach(t),da.forEach(t),Ns=d(o),dt=s(o,"DIV",{class:!0});var ca=a(dt);w(oo.$$.fragment,ca),lr=d(ca),Nn=s(ca,"P",{});var ec=a(Nn);dr=i(ec,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),ec.forEach(t),ca.forEach(t),Hs=d(o),ct=s(o,"DIV",{class:!0});var fa=a(ct);w(no.$$.fragment,fa),cr=d(fa),Hn=s(fa,"P",{});var tc=a(Hn);fr=i(tc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),tc.forEach(t),fa.forEach(t),As=d(o),ft=s(o,"DIV",{class:!0});var ha=a(ft);w(so.$$.fragment,ha),hr=d(ha),An=s(ha,"P",{});var oc=a(An);pr=i(oc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),oc.forEach(t),ha.forEach(t),Ds=d(o),ht=s(o,"DIV",{class:!0});var pa=a(ht);w(ao.$$.fragment,pa),mr=d(pa),Dn=s(pa,"P",{});var nc=a(Dn);ur=i(nc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),nc.forEach(t),pa.forEach(t),Is=d(o),pt=s(o,"H2",{class:!0});var ma=a(pt);Et=s(ma,"A",{id:!0,class:!0,href:!0});var sc=a(Et);In=s(sc,"SPAN",{});var ac=a(In);w(ro.$$.fragment,ac),ac.forEach(t),sc.forEach(t),gr=d(ma),Wn=s(ma,"SPAN",{});var rc=a(Wn);_r=i(rc,"TransfoXLModel"),rc.forEach(t),ma.forEach(t),Ws=d(o),Me=s(o,"DIV",{class:!0});var Qe=a(Me);w(io.$$.fragment,Qe),Tr=d(Qe),Bn=s(Qe,"P",{});var ic=a(Bn);vr=i(ic,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),ic.forEach(t),br=d(Qe),lo=s(Qe,"P",{});var ua=a(lo);wr=i(ua,"This model inherits from "),an=s(ua,"A",{href:!0});var lc=a(an);yr=i(lc,"PreTrainedModel"),lc.forEach(t),Lr=i(ua,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),ua.forEach(t),kr=d(Qe),co=s(Qe,"P",{});var ga=a(co);$r=i(ga,"This model is also a PyTorch "),fo=s(ga,"A",{href:!0,rel:!0});var dc=a(fo);xr=i(dc,"torch.nn.Module"),dc.forEach(t),Xr=i(ga,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),ga.forEach(t),Mr=d(Qe),ze=s(Qe,"DIV",{class:!0});var Ze=a(ze);w(ho.$$.fragment,Ze),Er=d(Ze),mt=s(Ze,"P",{});var xn=a(mt);Fr=i(xn,"The "),rn=s(xn,"A",{href:!0});var cc=a(rn);zr=i(cc,"TransfoXLModel"),cc.forEach(t),Cr=i(xn," forward method, overrides the "),Vn=s(xn,"CODE",{});var fc=a(Vn);qr=i(fc,"__call__"),fc.forEach(t),Pr=i(xn," special method."),xn.forEach(t),jr=d(Ze),w(Ft.$$.fragment,Ze),Sr=d(Ze),Un=s(Ze,"P",{});var hc=a(Un);Or=i(hc,"Example:"),hc.forEach(t),Nr=d(Ze),w(po.$$.fragment,Ze),Ze.forEach(t),Qe.forEach(t),Bs=d(o),ut=s(o,"H2",{class:!0});var _a=a(ut);zt=s(_a,"A",{id:!0,class:!0,href:!0});var pc=a(zt);Rn=s(pc,"SPAN",{});var mc=a(Rn);w(mo.$$.fragment,mc),mc.forEach(t),pc.forEach(t),Hr=d(_a),Gn=s(_a,"SPAN",{});var uc=a(Gn);Ar=i(uc,"TransfoXLLMHeadModel"),uc.forEach(t),_a.forEach(t),Vs=d(o),Ee=s(o,"DIV",{class:!0});var Je=a(Ee);w(uo.$$.fragment,Je),Dr=d(Je),Kn=s(Je,"P",{});var gc=a(Kn);Ir=i(gc,`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
input embeddings)`),gc.forEach(t),Wr=d(Je),go=s(Je,"P",{});var Ta=a(go);Br=i(Ta,"This model inherits from "),ln=s(Ta,"A",{href:!0});var _c=a(ln);Vr=i(_c,"PreTrainedModel"),_c.forEach(t),Ur=i(Ta,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ta.forEach(t),Rr=d(Je),_o=s(Je,"P",{});var va=a(_o);Gr=i(va,"This model is also a PyTorch "),To=s(va,"A",{href:!0,rel:!0});var Tc=a(To);Kr=i(Tc,"torch.nn.Module"),Tc.forEach(t),Yr=i(va,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),va.forEach(t),Qr=d(Je),Ce=s(Je,"DIV",{class:!0});var et=a(Ce);w(vo.$$.fragment,et),Zr=d(et),gt=s(et,"P",{});var Xn=a(gt);Jr=i(Xn,"The "),dn=s(Xn,"A",{href:!0});var vc=a(dn);ei=i(vc,"TransfoXLLMHeadModel"),vc.forEach(t),ti=i(Xn," forward method, overrides the "),Yn=s(Xn,"CODE",{});var bc=a(Yn);oi=i(bc,"__call__"),bc.forEach(t),ni=i(Xn," special method."),Xn.forEach(t),si=d(et),w(Ct.$$.fragment,et),ai=d(et),Qn=s(et,"P",{});var wc=a(Qn);ri=i(wc,"Example:"),wc.forEach(t),ii=d(et),w(bo.$$.fragment,et),et.forEach(t),Je.forEach(t),Us=d(o),_t=s(o,"H2",{class:!0});var ba=a(_t);qt=s(ba,"A",{id:!0,class:!0,href:!0});var yc=a(qt);Zn=s(yc,"SPAN",{});var Lc=a(Zn);w(wo.$$.fragment,Lc),Lc.forEach(t),yc.forEach(t),li=d(ba),Jn=s(ba,"SPAN",{});var kc=a(Jn);di=i(kc,"TransfoXLForSequenceClassification"),kc.forEach(t),ba.forEach(t),Rs=d(o),oe=s(o,"DIV",{class:!0});var Se=a(oe);w(yo.$$.fragment,Se),ci=d(Se),es=s(Se,"P",{});var $c=a(es);fi=i($c,"The Transformer-XL Model transformer with a sequence classification head on top (linear layer)."),$c.forEach(t),hi=d(Se),cn=s(Se,"P",{});var xd=a(cn);fn=s(xd,"A",{href:!0});var xc=a(fn);pi=i(xc,"TransfoXLForSequenceClassification"),xc.forEach(t),mi=i(xd,` uses the last token in order to do the classification, as
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),ya.forEach(t),qi=d(Se),le=s(Se,"DIV",{class:!0});var Oe=a(le);w(xo.$$.fragment,Oe),Pi=d(Oe),Tt=s(Oe,"P",{});var Mn=a(Tt);ji=i(Mn,"The "),pn=s(Mn,"A",{href:!0});var qc=a(pn);Si=i(qc,"TransfoXLForSequenceClassification"),qc.forEach(t),Oi=i(Mn," forward method, overrides the "),as=s(Mn,"CODE",{});var Pc=a(as);Ni=i(Pc,"__call__"),Pc.forEach(t),Hi=i(Mn," special method."),Mn.forEach(t),Ai=d(Oe),w(Pt.$$.fragment,Oe),Di=d(Oe),rs=s(Oe,"P",{});var jc=a(rs);Ii=i(jc,"Example of single-label classification:"),jc.forEach(t),Wi=d(Oe),w(Xo.$$.fragment,Oe),Bi=d(Oe),is=s(Oe,"P",{});var Sc=a(is);Vi=i(Sc,"Example of multi-label classification:"),Sc.forEach(t),Ui=d(Oe),w(Mo.$$.fragment,Oe),Oe.forEach(t),Se.forEach(t),Gs=d(o),vt=s(o,"H2",{class:!0});var La=a(vt);jt=s(La,"A",{id:!0,class:!0,href:!0});var Oc=a(jt);ls=s(Oc,"SPAN",{});var Nc=a(ls);w(Eo.$$.fragment,Nc),Nc.forEach(t),Oc.forEach(t),Ri=d(La),ds=s(La,"SPAN",{});var Hc=a(ds);Gi=i(Hc,"TFTransfoXLModel"),Hc.forEach(t),La.forEach(t),Ks=d(o),pe=s(o,"DIV",{class:!0});var Ue=a(pe);w(Fo.$$.fragment,Ue),Ki=d(Ue),cs=s(Ue,"P",{});var Ac=a(cs);Yi=i(Ac,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Ac.forEach(t),Qi=d(Ue),zo=s(Ue,"P",{});var ka=a(zo);Zi=i(ka,"This model inherits from "),mn=s(ka,"A",{href:!0});var Dc=a(mn);Ji=i(Dc,"TFPreTrainedModel"),Dc.forEach(t),el=i(ka,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),$a.forEach(t),al=d(Ue),w(St.$$.fragment,Ue),rl=d(Ue),qe=s(Ue,"DIV",{class:!0});var ot=a(qe);w(Po.$$.fragment,ot),il=d(ot),bt=s(ot,"P",{});var En=a(bt);ll=i(En,"The "),un=s(En,"A",{href:!0});var Wc=a(un);dl=i(Wc,"TFTransfoXLModel"),Wc.forEach(t),cl=i(En," forward method, overrides the "),fs=s(En,"CODE",{});var Bc=a(fs);fl=i(Bc,"__call__"),Bc.forEach(t),hl=i(En," special method."),En.forEach(t),pl=d(ot),w(Ot.$$.fragment,ot),ml=d(ot),hs=s(ot,"P",{});var Vc=a(hs);ul=i(Vc,"Example:"),Vc.forEach(t),gl=d(ot),w(jo.$$.fragment,ot),ot.forEach(t),Ue.forEach(t),Ys=d(o),wt=s(o,"H2",{class:!0});var xa=a(wt);Nt=s(xa,"A",{id:!0,class:!0,href:!0});var Uc=a(Nt);ps=s(Uc,"SPAN",{});var Rc=a(ps);w(So.$$.fragment,Rc),Rc.forEach(t),Uc.forEach(t),_l=d(xa),ms=s(xa,"SPAN",{});var Gc=a(ms);Tl=i(Gc,"TFTransfoXLLMHeadModel"),Gc.forEach(t),xa.forEach(t),Qs=d(o),me=s(o,"DIV",{class:!0});var Re=a(me);w(Oo.$$.fragment,Re),vl=d(Re),us=s(Re,"P",{});var Kc=a(us);bl=i(Kc,`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Xa.forEach(t),$l=d(Re),Ho=s(Re,"P",{});var Ma=a(Ho);xl=i(Ma,"This model is also a "),Ao=s(Ma,"A",{href:!0,rel:!0});var Qc=a(Ao);Xl=i(Qc,"tf.keras.Model"),Qc.forEach(t),Ml=i(Ma,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Ma.forEach(t),El=d(Re),w(Ht.$$.fragment,Re),Fl=d(Re),Pe=s(Re,"DIV",{class:!0});var nt=a(Pe);w(Do.$$.fragment,nt),zl=d(nt),yt=s(nt,"P",{});var Fn=a(yt);Cl=i(Fn,"The "),_n=s(Fn,"A",{href:!0});var Zc=a(_n);ql=i(Zc,"TFTransfoXLLMHeadModel"),Zc.forEach(t),Pl=i(Fn," forward method, overrides the "),gs=s(Fn,"CODE",{});var Jc=a(gs);jl=i(Jc,"__call__"),Jc.forEach(t),Sl=i(Fn," special method."),Fn.forEach(t),Ol=d(nt),w(At.$$.fragment,nt),Nl=d(nt),_s=s(nt,"P",{});var ef=a(_s);Hl=i(ef,"Example:"),ef.forEach(t),Al=d(nt),w(Io.$$.fragment,nt),nt.forEach(t),Re.forEach(t),Zs=d(o),Lt=s(o,"H2",{class:!0});var Ea=a(Lt);Dt=s(Ea,"A",{id:!0,class:!0,href:!0});var tf=a(Dt);Ts=s(tf,"SPAN",{});var of=a(Ts);w(Wo.$$.fragment,of),of.forEach(t),tf.forEach(t),Dl=d(Ea),vs=s(Ea,"SPAN",{});var nf=a(vs);Il=i(nf,"TFTransfoXLForSequenceClassification"),nf.forEach(t),Ea.forEach(t),Js=d(o),K=s(o,"DIV",{class:!0});var be=a(K);w(Bo.$$.fragment,be),Wl=d(be),bs=s(be,"P",{});var sf=a(bs);Bl=i(sf,"The Transfo XL Model transformer with a sequence classification head on top (linear layer)."),sf.forEach(t),Vl=d(be),Tn=s(be,"P",{});var Xd=a(Tn);vn=s(Xd,"A",{href:!0});var af=a(vn);Ul=i(af,"TFTransfoXLForSequenceClassification"),af.forEach(t),Rl=i(Xd,` uses the last token in order to do the classification,
...
`),ws=s(st,"CODE",{});var rf=a(ws);Yl=i(rf,"pad_token_id"),rf.forEach(t),Ql=i(st,` is defined in the configuration, it finds the last token that is not a padding token in each
row. If no `),ys=s(st,"CODE",{});var lf=a(ys);Zl=i(lf,"pad_token_id"),lf.forEach(t),Jl=i(st,` is defined, it simply takes the last value in each row of the batch. Since it cannot
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),za.forEach(t),hd=d(be),w(It.$$.fragment,be),pd=d(be),je=s(be,"DIV",{class:!0});var at=a(je);w(Go.$$.fragment,at),md=d(at),kt=s(at,"P",{});var zn=a(kt);ud=i(zn,"The "),wn=s(zn,"A",{href:!0});var pf=a(wn);gd=i(pf,"TFTransfoXLForSequenceClassification"),pf.forEach(t),_d=i(zn," forward method, overrides the "),$s=s(zn,"CODE",{});var mf=a($s);Td=i(mf,"__call__"),mf.forEach(t),vd=i(zn," special method."),zn.forEach(t),bd=d(at),w(Wt.$$.fragment,at),wd=d(at),xs=s(at,"P",{});var uf=a(xs);yd=i(uf,"Example:"),uf.forEach(t),Ld=d(at),w(Ko.$$.fragment,at),at.forEach(t),be.forEach(t),ea=d(o),$t=s(o,"H2",{class:!0});var Ca=a($t);Bt=s(Ca,"A",{id:!0,class:!0,href:!0});var gf=a(Bt);Xs=s(gf,"SPAN",{});var _f=a(Xs);w(Yo.$$.fragment,_f),_f.forEach(t),gf.forEach(t),kd=d(Ca),Ms=s(Ca,"SPAN",{});var Tf=a(Ms);$d=i(Tf,"Internal Layers"),Tf.forEach(t),Ca.forEach(t),ta=d(o),yn=s(o,"DIV",{class:!0});var vf=a(yn);vf.forEach(t),oa=d(o),Ln=s(o,"DIV",{class:!0});var bf=a(Ln);bf.forEach(t),this.h()},h(){c(m,"name","hf:doc:metadata"),c(m,"content",JSON.stringify(jf)),c(g,"id","transformer-xl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#transformer-xl"),c(u,"class","relative group"),c(Y,"id","overview"),c(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Y,"href","#overview"),c(X,"class","relative group"),c(ee,"href","https://arxiv.org/abs/1901.02860"),c(ee,"rel","nofollow"),c(f,"href","https://huggingface.co/thomwolf"),c(f,"rel","nofollow"),c(ve,"href","https://github.com/kimiyoung/transformer-xl"),c(ve,"rel","nofollow"),c(he,"id","transformers.TransfoXLConfig"),c(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(he,"href","#transformers.TransfoXLConfig"),c(ie,"class","relative group"),c(en,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLModel"),c(tn,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TFTransfoXLModel"),c(Gt,"href","https://huggingface.co/transfo-xl-wt103"),c(Gt,"rel","nofollow"),c(on,"href","/docs/transformers/v4.14.1/en/main_classes/configuration#transformers.PretrainedConfig"),c(nn,"href","/docs/transformers/v4.14.1/en/main_classes/configuration#transformers.PretrainedConfig"),c(H,"class","docstring"),c(Xt,"id","transformers.TransfoXLTokenizer"),c(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xt,"href","#transformers.TransfoXLTokenizer"),c(it,"class","relative group"),c(Jt,"href","https://github.com/kimiyoung/transformer-xl"),c(Jt,"rel","nofollow"),c(sn,"href","/docs/transformers/v4.14.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(jn,"class","docstring"),c(Ae,"class","docstring"),c(Mt,"id","transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"),c(lt,"class","relative group"),c(dt,"class","docstring"),c(ct,"class","docstring"),c(ft,"class","docstring"),c(ht,"class","docstring"),c(Et,"id","transformers.TransfoXLModel"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.TransfoXLModel"),c(pt,"class","relative group"),c(an,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),c(fo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(fo,"rel","nofollow"),c(rn,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLModel"),c(ze,"class","docstring"),c(Me,"class","docstring"),c(zt,"id","transformers.TransfoXLLMHeadModel"),c(zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(zt,"href","#transformers.TransfoXLLMHeadModel"),c(ut,"class","relative group"),c(ln,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),c(To,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(To,"rel","nofollow"),c(dn,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLLMHeadModel"),c(Ce,"class","docstring"),c(Ee,"class","docstring"),c(qt,"id","transformers.TransfoXLForSequenceClassification"),c(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qt,"href","#transformers.TransfoXLForSequenceClassification"),c(_t,"class","relative group"),c(fn,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLForSequenceClassification"),c(hn,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),c($o,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c($o,"rel","nofollow"),c(pn,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TransfoXLForSequenceClassification"),c(le,"class","docstring"),c(oe,"class","docstring"),c(jt,"id","transformers.TFTransfoXLModel"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.TFTransfoXLModel"),c(vt,"class","relative group"),c(mn,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.TFPreTrainedModel"),c(qo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(qo,"rel","nofollow"),c(un,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TFTransfoXLModel"),c(qe,"class","docstring"),c(pe,"class","docstring"),c(Nt,"id","transformers.TFTransfoXLLMHeadModel"),c(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nt,"href","#transformers.TFTransfoXLLMHeadModel"),c(wt,"class","relative group"),c(gn,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.TFPreTrainedModel"),c(Ao,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Ao,"rel","nofollow"),c(_n,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TFTransfoXLLMHeadModel"),c(Pe,"class","docstring"),c(me,"class","docstring"),c(Dt,"id","transformers.TFTransfoXLForSequenceClassification"),c(Dt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Dt,"href","#transformers.TFTransfoXLForSequenceClassification"),c(Lt,"class","relative group"),c(vn,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TFTransfoXLForSequenceClassification"),c(bn,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.TFPreTrainedModel"),c(Ro,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Ro,"rel","nofollow"),c(wn,"href","/docs/transformers/v4.14.1/en/model_doc/transformerxl#transformers.TFTransfoXLForSequenceClassification"),c(je,"class","docstring"),c(K,"class","docstring"),c(Bt,"id","transformers.AdaptiveEmbedding"),c(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Bt,"href","#transformers.AdaptiveEmbedding"),c($t,"class","relative group"),c(yn,"class","docstring"),c(Ln,"class","docstring")},m(o,p){e(document.head,m),h(o,x,p),h(o,u,p),e(u,g),e(g,v),y(T,v,null),e(u,_),e(u,E),e(E,we),h(o,Z,p),h(o,X,p),e(X,Y),e(Y,A),y(J,A,null),e(X,ye),e(X,D),e(D,Le),h(o,ue,p),h(o,I,p),e(I,S),e(I,ee),e(ee,ne),e(I,F),h(o,C,p),h(o,se,p),e(se,U),h(o,ge,p),h(o,ae,p),e(ae,W),e(W,ke),h(o,_e,p),h(o,z,p),e(z,$e),h(o,B,p),h(o,Q,p),e(Q,ce),e(ce,R),e(Q,xe),e(Q,fe),e(fe,O),h(o,Te,p),h(o,q,p),e(q,Xe),e(q,f),e(f,M),e(q,re),e(q,ve),e(ve,We),e(q,N),h(o,Ne,p),h(o,ie,p),e(ie,he),e(he,P),y(j,P,null),e(ie,Be),e(ie,Fe),e(Fe,G),h(o,He,p),h(o,H,p),y(te,H,null),e(H,Ve),e(H,Ke),e(Ke,qa),e(Ke,en),e(en,Pa),e(Ke,ja),e(Ke,tn),e(tn,Sa),e(Ke,Oa),e(Ke,Gt),e(Gt,Na),e(Ke,Ha),e(H,Aa),e(H,rt),e(rt,Da),e(rt,on),e(on,Ia),e(rt,Wa),e(rt,nn),e(nn,Ba),e(rt,Va),e(H,Ua),e(H,Cn),e(Cn,Ra),e(H,Ga),y(Kt,H,null),h(o,js,p),h(o,it,p),e(it,Xt),e(Xt,qn),y(Yt,qn,null),e(it,Ka),e(it,Pn),e(Pn,Ya),h(o,Ss,p),h(o,Ae,p),y(Qt,Ae,null),e(Ae,Qa),e(Ae,Zt),e(Zt,Za),e(Zt,Jt),e(Jt,Ja),e(Zt,er),e(Ae,tr),e(Ae,eo),e(eo,or),e(eo,sn),e(sn,nr),e(eo,sr),e(Ae,ar),e(Ae,jn),h(o,Os,p),h(o,lt,p),e(lt,Mt),e(Mt,Sn),y(to,Sn,null),e(lt,rr),e(lt,On),e(On,ir),h(o,Ns,p),h(o,dt,p),y(oo,dt,null),e(dt,lr),e(dt,Nn),e(Nn,dr),h(o,Hs,p),h(o,ct,p),y(no,ct,null),e(ct,cr),e(ct,Hn),e(Hn,fr),h(o,As,p),h(o,ft,p),y(so,ft,null),e(ft,hr),e(ft,An),e(An,pr),h(o,Ds,p),h(o,ht,p),y(ao,ht,null),e(ht,mr),e(ht,Dn),e(Dn,ur),h(o,Is,p),h(o,pt,p),e(pt,Et),e(Et,In),y(ro,In,null),e(pt,gr),e(pt,Wn),e(Wn,_r),h(o,Ws,p),h(o,Me,p),y(io,Me,null),e(Me,Tr),e(Me,Bn),e(Bn,vr),e(Me,br),e(Me,lo),e(lo,wr),e(lo,an),e(an,yr),e(lo,Lr),e(Me,kr),e(Me,co),e(co,$r),e(co,fo),e(fo,xr),e(co,Xr),e(Me,Mr),e(Me,ze),y(ho,ze,null),e(ze,Er),e(ze,mt),e(mt,Fr),e(mt,rn),e(rn,zr),e(mt,Cr),e(mt,Vn),e(Vn,qr),e(mt,Pr),e(ze,jr),y(Ft,ze,null),e(ze,Sr),e(ze,Un),e(Un,Or),e(ze,Nr),y(po,ze,null),h(o,Bs,p),h(o,ut,p),e(ut,zt),e(zt,Rn),y(mo,Rn,null),e(ut,Hr),e(ut,Gn),e(Gn,Ar),h(o,Vs,p),h(o,Ee,p),y(uo,Ee,null),e(Ee,Dr),e(Ee,Kn),e(Kn,Ir),e(Ee,Wr),e(Ee,go),e(go,Br),e(go,ln),e(ln,Vr),e(go,Ur),e(Ee,Rr),e(Ee,_o),e(_o,Gr),e(_o,To),e(To,Kr),e(_o,Yr),e(Ee,Qr),e(Ee,Ce),y(vo,Ce,null),e(Ce,Zr),e(Ce,gt),e(gt,Jr),e(gt,dn),e(dn,ei),e(gt,ti),e(gt,Yn),e(Yn,oi),e(gt,ni),e(Ce,si),y(Ct,Ce,null),e(Ce,ai),e(Ce,Qn),e(Qn,ri),e(Ce,ii),y(bo,Ce,null),h(o,Us,p),h(o,_t,p),e(_t,qt),e(qt,Zn),y(wo,Zn,null),e(_t,li),e(_t,Jn),e(Jn,di),h(o,Rs,p),h(o,oe,p),y(yo,oe,null),e(oe,ci),e(oe,es),e(es,fi),e(oe,hi),e(oe,cn),e(cn,fn),e(fn,pi),e(cn,mi),e(oe,ui),e(oe,De),e(De,gi),e(De,ts),e(ts,_i),e(De,Ti),e(De,os),e(os,vi),e(De,bi),e(De,ns),e(ns,wi),e(De,yi),e(De,ss),e(ss,Li),e(De,ki),e(oe,$i),e(oe,Lo),e(Lo,xi),e(Lo,hn),e(hn,Xi),e(Lo,Mi),e(oe,Ei),e(oe,ko),e(ko,Fi),e(ko,$o),e($o,zi),e(ko,Ci),e(oe,qi),e(oe,le),y(xo,le,null),e(le,Pi),e(le,Tt),e(Tt,ji),e(Tt,pn),e(pn,Si),e(Tt,Oi),e(Tt,as),e(as,Ni),e(Tt,Hi),e(le,Ai),y(Pt,le,null),e(le,Di),e(le,rs),e(rs,Ii),e(le,Wi),y(Xo,le,null),e(le,Bi),e(le,is),e(is,Vi),e(le,Ui),y(Mo,le,null),h(o,Gs,p),h(o,vt,p),e(vt,jt),e(jt,ls),y(Eo,ls,null),e(vt,Ri),e(vt,ds),e(ds,Gi),h(o,Ks,p),h(o,pe,p),y(Fo,pe,null),e(pe,Ki),e(pe,cs),e(cs,Yi),e(pe,Qi),e(pe,zo),e(zo,Zi),e(zo,mn),e(mn,Ji),e(zo,el),e(pe,tl),e(pe,Co),e(Co,ol),e(Co,qo),e(qo,nl),e(Co,sl),e(pe,al),y(St,pe,null),e(pe,rl),e(pe,qe),y(Po,qe,null),e(qe,il),e(qe,bt),e(bt,ll),e(bt,un),e(un,dl),e(bt,cl),e(bt,fs),e(fs,fl),e(bt,hl),e(qe,pl),y(Ot,qe,null),e(qe,ml),e(qe,hs),e(hs,ul),e(qe,gl),y(jo,qe,null),h(o,Ys,p),h(o,wt,p),e(wt,Nt),e(Nt,ps),y(So,ps,null),e(wt,_l),e(wt,ms),e(ms,Tl),h(o,Qs,p),h(o,me,p),y(Oo,me,null),e(me,vl),e(me,us),e(us,bl),e(me,wl),e(me,No),e(No,yl),e(No,gn),e(gn,Ll),e(No,kl),e(me,$l),e(me,Ho),e(Ho,xl),e(Ho,Ao),e(Ao,Xl),e(Ho,Ml),e(me,El),y(Ht,me,null),e(me,Fl),e(me,Pe),y(Do,Pe,null),e(Pe,zl),e(Pe,yt),e(yt,Cl),e(yt,_n),e(_n,ql),e(yt,Pl),e(yt,gs),e(gs,jl),e(yt,Sl),e(Pe,Ol),y(At,Pe,null),e(Pe,Nl),e(Pe,_s),e(_s,Hl),e(Pe,Al),y(Io,Pe,null),h(o,Zs,p),h(o,Lt,p),e(Lt,Dt),e(Dt,Ts),y(Wo,Ts,null),e(Lt,Dl),e(Lt,vs),e(vs,Il),h(o,Js,p),h(o,K,p),y(Bo,K,null),e(K,Wl),e(K,bs),e(bs,Bl),e(K,Vl),e(K,Tn),e(Tn,vn),e(vn,Ul),e(Tn,Rl),e(K,Gl),e(K,Ie),e(Ie,Kl),e(Ie,ws),e(ws,Yl),e(Ie,Ql),e(Ie,ys),e(ys,Zl),e(Ie,Jl),e(Ie,Ls),e(Ls,ed),e(Ie,td),e(Ie,ks),e(ks,od),e(Ie,nd),e(K,sd),e(K,Vo),e(Vo,ad),e(Vo,bn),e(bn,rd),e(Vo,id),e(K,ld),e(K,Uo),e(Uo,dd),e(Uo,Ro),e(Ro,cd),e(Uo,fd),e(K,hd),y(It,K,null),e(K,pd),e(K,je),y(Go,je,null),e(je,md),e(je,kt),e(kt,ud),e(kt,wn),e(wn,gd),e(kt,_d),e(kt,$s),e($s,Td),e(kt,vd),e(je,bd),y(Wt,je,null),e(je,wd),e(je,xs),e(xs,yd),e(je,Ld),y(Ko,je,null),h(o,ea,p),h(o,$t,p),e($t,Bt),e(Bt,Xs),y(Yo,Xs,null),e($t,kd),e($t,Ms),e(Ms,$d),h(o,ta,p),h(o,yn,p),h(o,oa,p),h(o,Ln,p),na=!0},p(o,[p]){const Qo={};p&2&&(Qo.$$scope={dirty:p,ctx:o}),Ft.$set(Qo);const Es={};p&2&&(Es.$$scope={dirty:p,ctx:o}),Ct.$set(Es);const Fs={};p&2&&(Fs.$$scope={dirty:p,ctx:o}),Pt.$set(Fs);const zs={};p&2&&(zs.$$scope={dirty:p,ctx:o}),St.$set(zs);const Zo={};p&2&&(Zo.$$scope={dirty:p,ctx:o}),Ot.$set(Zo);const Cs={};p&2&&(Cs.$$scope={dirty:p,ctx:o}),Ht.$set(Cs);const qs={};p&2&&(qs.$$scope={dirty:p,ctx:o}),At.$set(qs);const Ps={};p&2&&(Ps.$$scope={dirty:p,ctx:o}),It.$set(Ps);const Jo={};p&2&&(Jo.$$scope={dirty:p,ctx:o}),Wt.$set(Jo)},i(o){na||(L(T.$$.fragment,o),L(J.$$.fragment,o),L(j.$$.fragment,o),L(te.$$.fragment,o),L(Kt.$$.fragment,o),L(Yt.$$.fragment,o),L(Qt.$$.fragment,o),L(to.$$.fragment,o),L(oo.$$.fragment,o),L(no.$$.fragment,o),L(so.$$.fragment,o),L(ao.$$.fragment,o),L(ro.$$.fragment,o),L(io.$$.fragment,o),L(ho.$$.fragment,o),L(Ft.$$.fragment,o),L(po.$$.fragment,o),L(mo.$$.fragment,o),L(uo.$$.fragment,o),L(vo.$$.fragment,o),L(Ct.$$.fragment,o),L(bo.$$.fragment,o),L(wo.$$.fragment,o),L(yo.$$.fragment,o),L(xo.$$.fragment,o),L(Pt.$$.fragment,o),L(Xo.$$.fragment,o),L(Mo.$$.fragment,o),L(Eo.$$.fragment,o),L(Fo.$$.fragment,o),L(St.$$.fragment,o),L(Po.$$.fragment,o),L(Ot.$$.fragment,o),L(jo.$$.fragment,o),L(So.$$.fragment,o),L(Oo.$$.fragment,o),L(Ht.$$.fragment,o),L(Do.$$.fragment,o),L(At.$$.fragment,o),L(Io.$$.fragment,o),L(Wo.$$.fragment,o),L(Bo.$$.fragment,o),L(It.$$.fragment,o),L(Go.$$.fragment,o),L(Wt.$$.fragment,o),L(Ko.$$.fragment,o),L(Yo.$$.fragment,o),na=!0)},o(o){k(T.$$.fragment,o),k(J.$$.fragment,o),k(j.$$.fragment,o),k(te.$$.fragment,o),k(Kt.$$.fragment,o),k(Yt.$$.fragment,o),k(Qt.$$.fragment,o),k(to.$$.fragment,o),k(oo.$$.fragment,o),k(no.$$.fragment,o),k(so.$$.fragment,o),k(ao.$$.fragment,o),k(ro.$$.fragment,o),k(io.$$.fragment,o),k(ho.$$.fragment,o),k(Ft.$$.fragment,o),k(po.$$.fragment,o),k(mo.$$.fragment,o),k(uo.$$.fragment,o),k(vo.$$.fragment,o),k(Ct.$$.fragment,o),k(bo.$$.fragment,o),k(wo.$$.fragment,o),k(yo.$$.fragment,o),k(xo.$$.fragment,o),k(Pt.$$.fragment,o),k(Xo.$$.fragment,o),k(Mo.$$.fragment,o),k(Eo.$$.fragment,o),k(Fo.$$.fragment,o),k(St.$$.fragment,o),k(Po.$$.fragment,o),k(Ot.$$.fragment,o),k(jo.$$.fragment,o),k(So.$$.fragment,o),k(Oo.$$.fragment,o),k(Ht.$$.fragment,o),k(Do.$$.fragment,o),k(At.$$.fragment,o),k(Io.$$.fragment,o),k(Wo.$$.fragment,o),k(Bo.$$.fragment,o),k(It.$$.fragment,o),k(Go.$$.fragment,o),k(Wt.$$.fragment,o),k(Ko.$$.fragment,o),k(Yo.$$.fragment,o),na=!1},d(o){t(m),o&&t(x),o&&t(u),$(T),o&&t(Z),o&&t(X),$(J),o&&t(ue),o&&t(I),o&&t(C),o&&t(se),o&&t(ge),o&&t(ae),o&&t(_e),o&&t(z),o&&t(B),o&&t(Q),o&&t(Te),o&&t(q),o&&t(Ne),o&&t(ie),$(j),o&&t(He),o&&t(H),$(te),$(Kt),o&&t(js),o&&t(it),$(Yt),o&&t(Ss),o&&t(Ae),$(Qt),o&&t(Os),o&&t(lt),$(to),o&&t(Ns),o&&t(dt),$(oo),o&&t(Hs),o&&t(ct),$(no),o&&t(As),o&&t(ft),$(so),o&&t(Ds),o&&t(ht),$(ao),o&&t(Is),o&&t(pt),$(ro),o&&t(Ws),o&&t(Me),$(io),$(ho),$(Ft),$(po),o&&t(Bs),o&&t(ut),$(mo),o&&t(Vs),o&&t(Ee),$(uo),$(vo),$(Ct),$(bo),o&&t(Us),o&&t(_t),$(wo),o&&t(Rs),o&&t(oe),$(yo),$(xo),$(Pt),$(Xo),$(Mo),o&&t(Gs),o&&t(vt),$(Eo),o&&t(Ks),o&&t(pe),$(Fo),$(St),$(Po),$(Ot),$(jo),o&&t(Ys),o&&t(wt),$(So),o&&t(Qs),o&&t(me),$(Oo),$(Ht),$(Do),$(At),$(Io),o&&t(Zs),o&&t(Lt),$(Wo),o&&t(Js),o&&t(K),$(Bo),$(It),$(Go),$(Wt),$(Ko),o&&t(ea),o&&t($t),$(Yo),o&&t(ta),o&&t(yn),o&&t(oa),o&&t(Ln)}}}const jf={local:"transformer-xl",sections:[{local:"overview",title:"Overview"},{local:"transformers.TransfoXLConfig",title:"TransfoXLConfig"},{local:"transformers.TransfoXLTokenizer",title:"TransfoXLTokenizer"},{local:"transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput",title:"TransfoXL specific outputs"},{local:"transformers.TransfoXLModel",title:"TransfoXLModel"},{local:"transformers.TransfoXLLMHeadModel",title:"TransfoXLLMHeadModel"},{local:"transformers.TransfoXLForSequenceClassification",title:"TransfoXLForSequenceClassification"},{local:"transformers.TFTransfoXLModel",title:"TFTransfoXLModel"},{local:"transformers.TFTransfoXLLMHeadModel",title:"TFTransfoXLLMHeadModel"},{local:"transformers.TFTransfoXLForSequenceClassification",title:"TFTransfoXLForSequenceClassification"},{local:"transformers.AdaptiveEmbedding",title:"Internal Layers"}],title:"Transformer XL"};function Sf(V,m,x){let{fw:u}=m;return V.$$set=g=>{"fw"in g&&x(0,u=g.fw)},[u]}class Wf extends wf{constructor(m){super();yf(this,m,Sf,Pf,Lf,{fw:0})}}export{Wf as default,jf as metadata};
