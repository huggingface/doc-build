import{S as nv,i as rv,s as av,e as r,k as i,w as v,t as o,M as sv,c as a,d as n,m as l,a as s,x as b,h as t,b as c,F as e,g as m,y as E,q as y,o as k,B as T}from"../../chunks/vendor-ab4e3193.js";import{T as Kf}from"../../chunks/Tip-b5c6375a.js";import{D as Z}from"../../chunks/Docstring-b69c0bd4.js";import{C as zo}from"../../chunks/CodeBlock-516df0c5.js";import{I as Za}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function dv(Te){let h,F,f,j,L;return{c(){h=r("p"),F=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(M){h=a(M,"P",{});var D=s(h);F=t(D,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a(D,"CODE",{});var B=s(f);j=t(B,"Module"),B.forEach(n),L=t(D,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),D.forEach(n)},m(M,D){m(M,h,D),e(h,F),e(h,f),e(f,j),e(h,L)},d(M){M&&n(h)}}}function cv(Te){let h,F,f,j,L,M,D,B,Ss,Ka,Xe,Ls,zt,Os,Ns,Qa,eo,Bs,jo,Us,Ws,Xa,oo,Vs,jt,Rs,Gs,es,he,Hs,$t,Ys,Js,$o,Zs,Ks,os,me,Qs,Mn,Xs,ed,Dn,od,td,ts,Po,ns,fe,nd,qo,rd,ad,Co,sd,dd,rs,we,to,xn,Fo,id,zn,ld,as,C,Ao,cd,no,Pt,pd,hd,qt,md,fd,ud,Me,gd,Ct,_d,vd,Ft,bd,Ed,yd,jn,kd,Td,Io,wd,ro,So,Md,Lo,Dd,At,xd,zd,jd,ao,Oo,$d,De,Pd,$n,qd,Cd,Pn,Fd,Ad,ss,xe,so,qn,No,Id,Cn,Sd,ds,$,Bo,Ld,ze,Od,Fn,Nd,Bd,An,Ud,Wd,Vd,Uo,Rd,Wo,Gd,Hd,Yd,In,Jd,Zd,Vo,Kd,It,Qd,Xd,ei,Ro,oi,Go,ti,ni,ri,ue,St,ai,si,Sn,di,ii,Ln,li,ci,pi,U,Ho,hi,je,mi,Lt,fi,ui,On,gi,_i,vi,io,bi,Nn,Ei,yi,Yo,ki,u,Jo,Ti,Bn,wi,Mi,$e,Di,Un,xi,zi,Wn,ji,$i,Pi,Pe,qi,Vn,Ci,Fi,Rn,Ai,Ii,Si,qe,K,Li,Gn,Oi,Ni,Hn,Bi,Ui,Yn,Wi,Vi,Ri,Q,Gi,Jn,Hi,Yi,Ot,Ji,Zi,Zn,Ki,Qi,Xi,O,el,Kn,ol,tl,Qn,nl,rl,Xn,al,sl,er,dl,il,or,ll,cl,pl,X,hl,tr,ml,fl,nr,ul,gl,rr,_l,vl,bl,Ce,ee,El,ar,yl,kl,sr,Tl,wl,dr,Ml,Dl,xl,oe,zl,ir,jl,$l,Nt,Pl,ql,lr,Cl,Fl,Al,N,Il,cr,Sl,Ll,pr,Ol,Nl,hr,Bl,Ul,mr,Wl,Vl,fr,Rl,Gl,Hl,Fe,Yl,ur,Jl,Zl,gr,Kl,Ql,Xl,Ae,ec,_r,oc,tc,vr,nc,rc,ac,Ie,br,sc,dc,Er,ic,lc,yr,cc,pc,Zo,hc,kr,mc,fc,uc,Tr,gc,_c,Ko,is,Se,lo,wr,Qo,vc,Mr,bc,ls,P,Xo,Ec,Le,yc,Dr,kc,Tc,xr,wc,Mc,Dc,et,xc,ot,zc,jc,$c,zr,Pc,qc,tt,Cc,Bt,Fc,Ac,Ic,nt,Sc,rt,Lc,Oc,Nc,ge,jr,Bc,Uc,$r,Wc,Vc,Pr,Rc,Gc,Hc,W,at,Yc,Oe,Jc,Ut,Zc,Kc,qr,Qc,Xc,ep,co,op,Cr,tp,np,st,rp,g,dt,ap,Fr,sp,dp,Ne,ip,Ar,lp,cp,Ir,pp,hp,mp,Be,te,fp,Sr,up,gp,Lr,_p,vp,Or,bp,Ep,yp,ne,kp,Nr,Tp,wp,Wt,Mp,Dp,Br,xp,zp,jp,G,$p,Ur,Pp,qp,Wr,Cp,Fp,Vr,Ap,Ip,Rr,Sp,Lp,Op,re,Np,Gr,Bp,Up,Hr,Wp,Vp,Yr,Rp,Gp,Hp,Ue,ae,Yp,Jr,Jp,Zp,Zr,Kp,Qp,Kr,Xp,eh,oh,se,th,Qr,nh,rh,Vt,ah,sh,Xr,dh,ih,lh,H,ch,ea,ph,hh,oa,mh,fh,ta,uh,gh,na,_h,vh,bh,We,Eh,ra,yh,kh,aa,Th,wh,Mh,Ve,Dh,sa,xh,zh,da,jh,$h,Ph,Re,ia,qh,Ch,la,Fh,Ah,ca,Ih,Sh,it,Lh,pa,Oh,Nh,Bh,ha,Uh,Wh,lt,cs,Ge,po,ma,ct,Vh,fa,Rh,ps,q,pt,Gh,He,Hh,ua,Yh,Jh,ga,Zh,Kh,Qh,ht,Xh,mt,em,om,tm,_a,nm,rm,ft,am,Rt,sm,dm,im,ut,lm,gt,cm,pm,hm,_e,Gt,mm,fm,va,um,gm,ba,_m,vm,bm,V,_t,Em,Ye,ym,Ht,km,Tm,Ea,wm,Mm,Dm,ho,xm,ya,zm,jm,vt,$m,_,bt,Pm,ka,qm,Cm,Je,Fm,Ta,Am,Im,wa,Sm,Lm,Om,Et,de,Nm,Ma,Bm,Um,Da,Wm,Vm,xa,Rm,Gm,Hm,ie,Ym,za,Jm,Zm,Yt,Km,Qm,ja,Xm,ef,of,le,tf,$a,nf,rf,Pa,af,sf,qa,df,lf,cf,yt,ce,pf,Ca,hf,mf,Fa,ff,uf,Aa,gf,_f,vf,pe,bf,Ia,Ef,yf,Jt,kf,Tf,Sa,wf,Mf,Df,Ze,xf,La,zf,jf,Oa,$f,Pf,qf,Ke,Cf,Na,Ff,Af,Ba,If,Sf,Lf,Qe,Ua,Of,Nf,Wa,Bf,Uf,Va,Wf,Vf,kt,Rf,Ra,Gf,Hf,Yf,Ga,Jf,Zf,Tt,hs;return M=new Za({}),Po=new zo({props:{code:`# a workaround to load from pytorch checkpoint
...
`}}),io=new Kf({props:{$$slots:{default:[dv]},$$scope:{ctx:Te}}}),Yo=new zo({props:{code:`from transformers import EncoderDecoderModel, BertTokenizer
import torch
...
any other models (see the examples for more information).`),es=i(),he=r("p"),Hs=o("An application of this architecture could be to leverage two pretrained "),$t=r("a"),Ys=o("BertModel"),Js=o(` as the encoder
...
Zhou, Wei Li, Peter J. Liu.`),Yd=i(),In=r("p"),Jd=o(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
:meth`),Ln=r("em"),li=o("~transformers.AutoModelForCausalLM.from_pretrained"),ci=o(" class method for the decoder."),pi=i(),U=r("div"),v(Ho.$$.fragment),hi=i(),je=r("p"),mi=o("The "),Lt=r("a"),fi=o("EncoderDecoderModel"),ui=o(" forward method, overrides the "),On=r("code"),gi=o("__call__"),_i=o(" special method."),vi=i(),v(io.$$.fragment),bi=i(),Nn=r("p"),Ei=o("Examples:"),yi=i(),v(Yo.$$.fragment),ki=i(),u=r("div"),v(Jo.$$.fragment),Ti=i(),Bn=r("p"),wi=o(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
a user or organization name, like `),Yn=r("code"),Wi=o("dbmdz/bert-base-german-cased"),Vi=o("."),Ri=i(),Q=r("li"),Gi=o("A path to a "),Jn=r("em"),Hi=o("directory"),Yi=o(` containing model weights saved using
`),Ot=r("a"),Ji=o("save_pretrained()"),Zi=o(", e.g., "),Zn=r("code"),Ki=o("./my_model_directory/"),Qi=o("."),Xi=i(),O=r("li"),el=o("A path or url to a "),Kn=r("em"),ol=o("tensorflow index checkpoint file"),tl=o(" (e.g, "),Qn=r("code"),nl=o("./tf_model/model.ckpt.index"),rl=o(`). In
...
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),Hl=i(),Fe=r("p"),Yl=o("model"),ur=r("em"),Jl=o("args (remaining positional arguments, _optional"),Zl=o(`):
...
:meth`),Pr=r("em"),Rc=o("~transformers.TFAutoModelForCausalLM.from_pretrained"),Gc=o(" class method for the decoder."),Hc=i(),W=r("div"),v(at.$$.fragment),Yc=i(),Oe=r("p"),Jc=o("The "),Ut=r("a"),Zc=o("TFEncoderDecoderModel"),Kc=o(" forward method, overrides the "),qr=r("code"),Qc=o("__call__"),Xc=o(" special method."),ep=i(),v(co.$$.fragment),op=i(),Cr=r("p"),tp=o("Examples:"),np=i(),v(st.$$.fragment),rp=i(),g=r("div"),v(dt.$$.fragment),ap=i(),Fr=r("p"),sp=o(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
`),Vr=r("code"),Ap=o("encoder_from_pt"),Ip=o(" should be set to "),Rr=r("code"),Sp=o("True"),Lp=o("."),Op=i(),re=r("p"),Np=o("decoder"),Gr=r("em"),Bp=o("pretrained_model_name_or_path (:obj: _str"),Up=o(", "),Hr=r("em"),Wp=o("optional"),Vp=o(", defaults to "),Yr=r("em"),Rp=o("None"),Gp=o(`):
Information necessary to initiate the decoder. Can be either:`),Hp=i(),Ue=r("ul"),ae=r("li"),Yp=o("A string, the "),Jr=r("em"),Jp=o("model id"),Zp=o(` of a pretrained model hosted inside a model repo on huggingface.co.
...
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),ua=r("code"),Yh=o("from_pretrained()"),Jh=o(` function and the decoder is loaded via
...
a user or organization name, like `),xa=r("code"),Rm=o("dbmdz/bert-base-german-cased"),Gm=o("."),Hm=i(),ie=r("li"),Ym=o("A path to a "),za=r("em"),Jm=o("directory"),Zm=o(` containing model weights saved using
`),Yt=r("a"),Km=o("save_pretrained()"),Qm=o(", e.g., "),ja=r("code"),Xm=o("./my_model_directory/"),ef=o("."),of=i(),le=r("p"),tf=o("decoder"),$a=r("em"),nf=o("pretrained_model_name_or_path (:obj: _Union[str, os.PathLike]"),rf=o(", "),Pa=r("em"),af=o("optional"),sf=o(", defaults to "),qa=r("em"),df=o("None"),lf=o(`):
...
`),Jt=r("a"),kf=o("save_pretrained()"),Tf=o(", e.g., "),Sa=r("code"),wf=o("./my_model_directory/"),Mf=o("."),Df=i(),Ze=r("p"),xf=o("model"),La=r("em"),zf=o("args (remaining positional arguments, _optional"),jf=o(`):
...
Can be used to update the configuration object (after it being loaded) and initiate the model (e.g.,
`),Ba=r("code"),If=o("output_attentions=True"),Sf=o(")."),Lf=i(),Qe=r("ul"),Ua=r("li"),Of=o("To update the encoder configuration, use the prefix _encoder__ for each configuration parameter."),Nf=i(),Wa=r("li"),Bf=o("To update the decoder configuration, use the prefix _decoder__ for each configuration parameter."),Uf=i(),Va=r("li"),Wf=o("To update the parent model configuration, do not use a prefix for each configuration parameter."),Vf=i(),kt=r("p"),Rf=o("Behaves differently depending on whether a "),Ra=r("code"),Gf=o("config"),Hf=o(" is provided or automatically loaded."),Yf=i(),Ga=r("p"),Jf=o("Example:"),Zf=i(),v(Tt.$$.fragment),this.h()},l(d){const p=sv('[data-svelte="svelte-1phssyn"]',document.head);h=a(p,"META",{name:!0,content:!0}),p.forEach(n),F=l(d),f=a(d,"H1",{class:!0});var wt=s(f);j=a(wt,"A",{id:!0,class:!0,href:!0});var Ha=s(j);L=a(Ha,"SPAN",{});var Ya=s(L);b(M.$$.fragment,Ya),Ya.forEach(n),Ha.forEach(n),D=l(wt),B=a(wt,"SPAN",{});var Qf=s(B);Ss=t(Qf,"Encoder Decoder Models"),Qf.forEach(n),wt.forEach(n),Ka=l(d),Xe=a(d,"P",{});var ms=s(Xe);Ls=t(ms,"The "),zt=a(ms,"A",{href:!0});var Xf=s(zt);Os=t(Xf,"EncoderDecoderModel"),Xf.forEach(n),Ns=t(ms,` can be used to initialize a sequence-to-sequence model with any
...
any other models (see the examples for more information).`),us.forEach(n),es=l(d),he=a(d,"P",{});var Zt=s(he);Hs=t(Zt,"An application of this architecture could be to leverage two pretrained "),$t=a(Zt,"A",{href:!0});var tu=s($t);Ys=t(tu,"BertModel"),tu.forEach(n),Js=t(Zt,` as the encoder
...
were contributed by `),Co=a(Qt,"A",{href:!0,rel:!0});var du=s(Co);sd=t(du,"ydshieh"),du.forEach(n),dd=t(Qt,"."),Qt.forEach(n),rs=l(d),we=a(d,"H2",{class:!0});var gs=s(we);to=a(gs,"A",{id:!0,class:!0,href:!0});var iu=s(to);xn=a(iu,"SPAN",{});var lu=s(xn);b(Fo.$$.fragment,lu),lu.forEach(n),iu.forEach(n),id=l(gs),zn=a(gs,"SPAN",{});var cu=s(zn);ld=t(cu,"EncoderDecoderConfig"),cu.forEach(n),gs.forEach(n),as=l(d),C=a(d,"DIV",{class:!0});var R=s(C);b(Ao.$$.fragment,R),cd=l(R),no=a(R,"P",{});var Ja=s(no);Pt=a(Ja,"A",{href:!0});var pu=s(Pt);pd=t(pu,"EncoderDecoderConfig"),pu.forEach(n),hd=t(Ja,` is the configuration class to store the configuration of a
`),qt=a(Ja,"A",{href:!0});var hu=s(qt);md=t(hu,"EncoderDecoderModel"),hu.forEach(n),fd=t(Ja,`. It is used to instantiate an Encoder Decoder model according to the
specified arguments, defining the encoder and decoder configs.`),Ja.forEach(n),ud=l(R),Me=a(R,"P",{});var Xt=s(Me);gd=t(Xt,"Configuration objects inherit from "),Ct=a(Xt,"A",{href:!0});var mu=s(Ct);_d=t(mu,"PretrainedConfig"),mu.forEach(n),vd=t(Xt,` and can be used to control the model
...
Zhou, Wei Li, Peter J. Liu.`),ys.forEach(n),Yd=l(A),In=a(A,"P",{});var Mu=s(In);Jd=t(Mu,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
:meth`),Ln=a(Mt,"EM",{});var $u=s(Ln);li=t($u,"~transformers.AutoModelForCausalLM.from_pretrained"),$u.forEach(n),ci=t(Mt," class method for the decoder."),Mt.forEach(n),pi=l(A),U=a(A,"DIV",{class:!0});var ve=s(U);b(Ho.$$.fragment,ve),hi=l(ve),je=a(ve,"P",{});var tn=s(je);mi=t(tn,"The "),Lt=a(tn,"A",{href:!0});var Pu=s(Lt);fi=t(Pu,"EncoderDecoderModel"),Pu.forEach(n),ui=t(tn," forward method, overrides the "),On=a(tn,"CODE",{});var qu=s(On);gi=t(qu,"__call__"),qu.forEach(n),_i=t(tn," special method."),tn.forEach(n),vi=l(ve),b(io.$$.fragment,ve),bi=l(ve),Nn=a(ve,"P",{});var Cu=s(Nn);Ei=t(Cu,"Examples:"),Cu.forEach(n),yi=l(ve),b(Yo.$$.fragment,ve),ve.forEach(n),ki=l(A),u=a(A,"DIV",{class:!0});var w=s(u);b(Jo.$$.fragment,w),Ti=l(w),Bn=a(w,"P",{});var Fu=s(Bn);wi=t(Fu,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
a user or organization name, like `),Yn=a(mo,"CODE",{});var Bu=s(Yn);Wi=t(Bu,"dbmdz/bert-base-german-cased"),Bu.forEach(n),Vi=t(mo,"."),mo.forEach(n),Ri=l(an),Q=a(an,"LI",{});var fo=s(Q);Gi=t(fo,"A path to a "),Jn=a(fo,"EM",{});var Uu=s(Jn);Hi=t(Uu,"directory"),Uu.forEach(n),Yi=t(fo,` containing model weights saved using
`),Ot=a(fo,"A",{href:!0});var Wu=s(Ot);Ji=t(Wu,"save_pretrained()"),Wu.forEach(n),Zi=t(fo,", e.g., "),Zn=a(fo,"CODE",{});var Vu=s(Zn);Ki=t(Vu,"./my_model_directory/"),Vu.forEach(n),Qi=t(fo,"."),fo.forEach(n),Xi=l(an),O=a(an,"LI",{});var Y=s(O);el=t(Y,"A path or url to a "),Kn=a(Y,"EM",{});var Ru=s(Kn);ol=t(Ru,"tensorflow index checkpoint file"),Ru.forEach(n),tl=t(Y," (e.g, "),Qn=a(Y,"CODE",{});var Gu=s(Qn);nl=t(Gu,"./tf_model/model.ckpt.index"),Gu.forEach(n),rl=t(Y,`). In
this case, `),Xn=a(Y,"CODE",{});var Hu=s(Xn);al=t(Hu,"from_tf"),Hu.forEach(n),sl=t(Y," should be set to "),er=a(Y,"CODE",{});var Yu=s(er);dl=t(Yu,"True"),Yu.forEach(n),il=t(Y,` and a configuration object should be provided
as `),or=a(Y,"CODE",{});var Ju=s(or);ll=t(Ju,"config"),Ju.forEach(n),cl=t(Y,` argument. This loading path is slower than converting the TensorFlow checkpoint in
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),Y.forEach(n),an.forEach(n),pl=l(w),X=a(w,"P",{});var uo=s(X);hl=t(uo,"decoder"),tr=a(uo,"EM",{});var Zu=s(tr);ml=t(Zu,"pretrained_model_name_or_path (:obj: _str"),Zu.forEach(n),fl=t(uo,", "),nr=a(uo,"EM",{});var Ku=s(nr);ul=t(Ku,"optional"),Ku.forEach(n),gl=t(uo,", defaults to "),rr=a(uo,"EM",{});var Qu=s(rr);_l=t(Qu,"None"),Qu.forEach(n),vl=t(uo,`):
...
`),Nt=a(_o,"A",{href:!0});var ng=s(Nt);Pl=t(ng,"save_pretrained()"),ng.forEach(n),ql=t(_o,", e.g., "),lr=a(_o,"CODE",{});var rg=s(lr);Cl=t(rg,"./my_model_directory/"),rg.forEach(n),Fl=t(_o,"."),_o.forEach(n),Al=l(sn),N=a(sn,"LI",{});var J=s(N);Il=t(J,"A path or url to a "),cr=a(J,"EM",{});var ag=s(cr);Sl=t(ag,"tensorflow index checkpoint file"),ag.forEach(n),Ll=t(J," (e.g, "),pr=a(J,"CODE",{});var sg=s(pr);Ol=t(sg,"./tf_model/model.ckpt.index"),sg.forEach(n),Nl=t(J,`). In
this case, `),hr=a(J,"CODE",{});var dg=s(hr);Bl=t(dg,"from_tf"),dg.forEach(n),Ul=t(J," should be set to "),mr=a(J,"CODE",{});var ig=s(mr);Wl=t(ig,"True"),ig.forEach(n),Vl=t(J,` and a configuration object should be provided
as `),fr=a(J,"CODE",{});var lg=s(fr);Rl=t(lg,"config"),lg.forEach(n),Gl=t(J,` argument. This loading path is slower than converting the TensorFlow checkpoint in
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),J.forEach(n),sn.forEach(n),Hl=l(w),Fe=a(w,"P",{});var dn=s(Fe);Yl=t(dn,"model"),ur=a(dn,"EM",{});var cg=s(ur);Jl=t(cg,"args (remaining positional arguments, _optional"),cg.forEach(n),Zl=t(dn,`):
...
`),Vr=a(Ee,"CODE",{});var Rg=s(Vr);Ap=t(Rg,"encoder_from_pt"),Rg.forEach(n),Ip=t(Ee," should be set to "),Rr=a(Ee,"CODE",{});var Gg=s(Rr);Sp=t(Gg,"True"),Gg.forEach(n),Lp=t(Ee,"."),Ee.forEach(n),fn.forEach(n),Op=l(x),re=a(x,"P",{});var Eo=s(re);Np=t(Eo,"decoder"),Gr=a(Eo,"EM",{});var Hg=s(Gr);Bp=t(Hg,"pretrained_model_name_or_path (:obj: _str"),Hg.forEach(n),Up=t(Eo,", "),Hr=a(Eo,"EM",{});var Yg=s(Hr);Wp=t(Yg,"optional"),Yg.forEach(n),Vp=t(Eo,", defaults to "),Yr=a(Eo,"EM",{});var Jg=s(Yr);Rp=t(Jg,"None"),Jg.forEach(n),Gp=t(Eo,`):
Information necessary to initiate the decoder. Can be either:`),Eo.forEach(n),Hp=l(x),Ue=a(x,"UL",{});var un=s(Ue);ae=a(un,"LI",{});var yo=s(ae);Yp=t(yo,"A string, the "),Jr=a(yo,"EM",{});var Zg=s(Jr);Jp=t(Zg,"model id"),Zg.forEach(n),Zp=t(yo,` of a pretrained model hosted inside a model repo on huggingface.co.
...
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),ua=a(bn,"CODE",{});var v_=s(ua);Yh=t(v_,"from_pretrained()"),v_.forEach(n),Jh=t(bn,` function and the decoder is loaded via
...
a user or organization name, like `),xa=a(To,"CODE",{});var A_=s(xa);Rm=t(A_,"dbmdz/bert-base-german-cased"),A_.forEach(n),Gm=t(To,"."),To.forEach(n),Hm=l(Fs),ie=a(Fs,"LI",{});var wo=s(ie);Ym=t(wo,"A path to a "),za=a(wo,"EM",{});var I_=s(za);Jm=t(I_,"directory"),I_.forEach(n),Zm=t(wo,` containing model weights saved using
`),Yt=a(wo,"A",{href:!0});var S_=s(Yt);Km=t(S_,"save_pretrained()"),S_.forEach(n),Qm=t(wo,", e.g., "),ja=a(wo,"CODE",{});var L_=s(ja);Xm=t(L_,"./my_model_directory/"),L_.forEach(n),ef=t(wo,"."),wo.forEach(n),Fs.forEach(n),of=l(z),le=a(z,"P",{});var Mo=s(le);tf=t(Mo,"decoder"),$a=a(Mo,"EM",{});var O_=s($a);nf=t(O_,"pretrained_model_name_or_path (:obj: _Union[str, os.PathLike]"),O_.forEach(n),rf=t(Mo,", "),Pa=a(Mo,"EM",{});var N_=s(Pa);af=t(N_,"optional"),N_.forEach(n),sf=t(Mo,", defaults to "),qa=a(Mo,"EM",{});var B_=s(qa);df=t(B_,"None"),B_.forEach(n),lf=t(Mo,`):
