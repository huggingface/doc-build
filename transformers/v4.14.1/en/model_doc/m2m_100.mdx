...
The [M2M100Tokenizer](/docs/transformers/v4.14.1/en/model_doc/m2m_100#transformers.M2M100Tokenizer) depends on `sentencepiece` so be sure to install it before running the
...
This is the configuration class to store the configuration of a [M2M100Model](/docs/transformers/v4.14.1/en/model_doc/m2m_100#transformers.M2M100Model). It is used to
...
<docstring><name>class transformers.M2M100Tokenizer</name><anchor>transformers.M2M100Tokenizer</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L64</source><parameters>[{"name": "vocab_file", "val": ""}, {"name": "spm_file", "val": ""}, {"name": "src_lang", "val": " = None"}, {"name": "tgt_lang", "val": " = None"}, {"name": "bos_token", "val": " = '<s>'"}, {"name": "eos_token", "val": " = '</s>'"}, {"name": "sep_token", "val": " = '</s>'"}, {"name": "pad_token", "val": " = '<pad>'"}, {"name": "unk_token", "val": " = '<unk>'"}, {"name": "language_codes", "val": " = 'm2m100'"}, {"name": "sp_model_kwargs", "val": ": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"}, {"name": "num_madeup_words", "val": " = 8"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **vocab_file** (`str`) --
...
- **language_codes** (`str`, _optional_, defaults to `"m2m100"`) --
...
<div class="docstring">
<docstring><name>build\_inputs\_with\_special\_tokens</name><anchor>transformers.M2M100Tokenizer.build_inputs_with_special_tokens</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L254</source><parameters>[{"name": "token_ids_0", "val": ": typing.List[int]"}, {"name": "token_ids_1", "val": ": typing.Optional[typing.List[int]] = None"}]</parameters><paramsdesc>- **token_ids_0** (`List[int]`) --
...
<div class="docstring">
<docstring><name>get\_special\_tokens\_mask</name><anchor>transformers.M2M100Tokenizer.get_special_tokens_mask</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L224</source><parameters>[{"name": "token_ids_0", "val": ": typing.List[int]"}, {"name": "token_ids_1", "val": ": typing.Optional[typing.List[int]] = None"}, {"name": "already_has_special_tokens", "val": ": bool = False"}]</parameters><paramsdesc>- **token_ids_0** (`List[int]`) --
  List of IDs.
- **token_ids_1** (`List[int]`, _optional_) --
...
<docstring><name>class transformers.M2M100Model</name><anchor>transformers.M2M100Model</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L1108</source><parameters>[{"name": "config", "val": ": M2M100Config"}]</parameters><paramsdesc>- **config** ([M2M100Config](/docs/transformers/v4.14.1/en/model_doc/m2m_100#transformers.M2M100Config)) --
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.M2M100Model.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L1135</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "decoder_input_ids", "val": " = None"}, {"name": "decoder_attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "decoder_head_mask", "val": " = None"}, {"name": "cross_attn_head_mask", "val": " = None"}, {"name": "encoder_outputs", "val": " = None"}, {"name": "past_key_values", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "decoder_inputs_embeds", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
  it.

  Indices can be obtained using [M2M100Tokenizer](/docs/transformers/v4.14.1/en/model_doc/m2m_100#transformers.M2M100Tokenizer). See
...
various elements depending on the configuration ([M2M100Config](/docs/transformers/v4.14.1/en/model_doc/m2m_100#transformers.M2M100Config)) and inputs.
...
The [M2M100Model](/docs/transformers/v4.14.1/en/model_doc/m2m_100#transformers.M2M100Model) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.M2M100ForConditionalGeneration</name><anchor>transformers.M2M100ForConditionalGeneration</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L1219</source><parameters>[{"name": "config", "val": ": M2M100Config"}]</parameters><paramsdesc>- **config** ([M2M100Config](/docs/transformers/v4.14.1/en/model_doc/m2m_100#transformers.M2M100Config)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.M2M100ForConditionalGeneration.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L1257</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "decoder_input_ids", "val": " = None"}, {"name": "decoder_attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "decoder_head_mask", "val": " = None"}, {"name": "cross_attn_head_mask", "val": " = None"}, {"name": "encoder_outputs", "val": " = None"}, {"name": "past_key_values", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "decoder_inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
  it.
...
- **encoder_attentions** (`tuple(torch.FloatTensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`.
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [M2M100ForConditionalGeneration](/docs/transformers/v4.14.1/en/model_doc/m2m_100#transformers.M2M100ForConditionalGeneration) forward method, overrides the `__call__` special method.
