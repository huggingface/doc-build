...
- See the [training](/docs/transformers/v4.14.1/en/model_doc/t5#training), [inference](/docs/transformers/v4.14.1/en/model_doc/t5#inference) and [scripts](/docs/transformers/v4.14.1/en/model_doc/t5#scripts) sections below for all details regarding usage.
...
- **T5v1.1**: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
  mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found [here](/docs/transformers/v4.14.1/en/t5v1.1).

- **mT5**: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
  the documentation of mT5 which can be found [here](/docs/transformers/v4.14.1/en/mt5).

- **byT5**: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
  to the documentation of byT5 which can be found [here](/docs/transformers/v4.14.1/en/byt5).
...
One can use [T5ForConditionalGeneration](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5ForConditionalGeneration) (or the Tensorflow/Flax variant), which includes the
...
- Unsupervised denoising training
  ...
  [T5Tokenizer](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5Tokenizer).
...
At inference time, it is recommended to use [generate()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate). This
...
[generate()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate), make sure you start it with the `pad_token_id`.
...
<docstring><name>class transformers.T5Config</name><anchor>transformers.T5Config</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/t5/configuration_t5.py#L38</source><parameters>[{"name": "vocab_size", "val": " = 32128"}, {"name": "d_model", "val": " = 512"}, {"name": "d_kv", "val": " = 64"}, {"name": "d_ff", "val": " = 2048"}, {"name": "num_layers", "val": " = 6"}, {"name": "num_decoder_layers", "val": " = None"}, {"name": "num_heads", "val": " = 8"}, {"name": "relative_attention_num_buckets", "val": " = 32"}, {"name": "dropout_rate", "val": " = 0.1"}, {"name": "layer_norm_epsilon", "val": " = 1e-06"}, {"name": "initializer_factor", "val": " = 1.0"}, {"name": "feed_forward_proj", "val": " = 'relu'"}, {"name": "is_encoder_decoder", "val": " = True"}, {"name": "use_cache", "val": " = True"}, {"name": "pad_token_id", "val": " = 0"}, {"name": "eos_token_id", "val": " = 1"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **vocab_size** (`int`, _optional_, defaults to 32128) --
  ...
  `inputs_ids` passed when calling [T5Model](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5Model) or [TFT5Model](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.TFT5Model).
...
This is the configuration class to store the configuration of a [T5Model](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5Model) or a
[TFT5Model](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.TFT5Model). It is used to instantiate a T5 model according to the specified arguments,
...
<docstring><name>forward</name><anchor>transformers.T5Model.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/t5/modeling_t5.py#L1323</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "decoder_input_ids", "val": " = None"}, {"name": "decoder_attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "decoder_head_mask", "val": " = None"}, {"name": "cross_attn_head_mask", "val": " = None"}, {"name": "encoder_outputs", "val": " = None"}, {"name": "past_key_values", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "decoder_inputs_embeds", "val": " = None"}, {"name": "use_cache", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [T5Tokenizer](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5Tokenizer). See
...
various elements depending on the configuration ([T5Config](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5Config)) and inputs.
...
The [T5Model](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5Model) forward method, overrides the `__call__` special method.
...
<div class="docstring">
<docstring><name>deparallelize</name><anchor>transformers.T5Model.deparallelize</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/t5/modeling_t5.py#L1291</source><parameters>[]</parameters></docstring>
...
- **encoder_attentions** (`tuple(torch.FloatTensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`.
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [T5ForConditionalGeneration](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
<div class="docstring">
<docstring><name>deparallelize</name><anchor>transformers.T5ForConditionalGeneration.deparallelize</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/t5/modeling_t5.py#L1483</source><parameters>[]</parameters></docstring>
...
The [T5EncoderModel](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5EncoderModel) forward method, overrides the `__call__` special method.
...
<div class="docstring">
<docstring><name>deparallelize</name><anchor>transformers.T5EncoderModel.deparallelize</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/t5/modeling_t5.py#L1756</source><parameters>[]</parameters></docstring>
...
elements depending on the configuration ([T5Config](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.T5Config)) and inputs.
...
- **encoder_attentions** (`tuple(tf.Tensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`.
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [TFT5Model](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.TFT5Model) forward method, overrides the `__call__` special method.
...
- **encoder_attentions** (`tuple(tf.Tensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`.
  ...
  Attentions weights of the encoder, after the attention softmax, used to compute the weighted average in the
  self-attention heads.</retdesc></docstring>
The [TFT5ForConditionalGeneration](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.TFT5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **attentions** (`tuple(tf.Tensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `tf.Tensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`.
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [TFT5EncoderModel](/docs/transformers/v4.14.1/en/model_doc/t5#transformers.TFT5EncoderModel) forward method, overrides the `__call__` special method.
