...
- SegFormer consists of a hierarchical Transformer encoder, and a lightweight all-MLP decode head.
  [SegformerModel](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerModel) is the hierarchical Transformer encoder (which in the paper is also referred to
  as Mix Transformer or MiT). [SegformerForSemanticSegmentation](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerForSemanticSegmentation) adds the all-MLP decode head on
  top to perform semantic segmentation of images. In addition, there's
  [SegformerForImageClassification](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerForImageClassification) which can be used to - you guessed it - classify images. The
...
- One can use [SegformerFeatureExtractor](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerFeatureExtractor) to prepare images and corresponding segmentation maps
...
- One additional thing to keep in mind is that one can initialize [SegformerFeatureExtractor](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerFeatureExtractor) with
  `reduce_labels` set to _True_ or _False_. In some datasets (like ADE20k), the 0 index is used in the annotated
  ...
  background class (i.e. it replaces 0 in the annotated maps by 255, which is the _ignore_index_ of the loss function
  used by [SegformerForSemanticSegmentation](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerForSemanticSegmentation)). However, other datasets use the 0 index as
  background class and include this class as part of all labels. In that case, `reduce_labels` should be set to
  _False_, as loss should also be computed for the background class.
...
- **attention_probs_dropout_prob** (`float`, _optional_, defaults to 0.0) --
...
- **decoder_hidden_size** (`int`, _optional_, defaults to 256) --
  The dimension of the all-MLP decode head.
- **reshape_last_stage** (`bool`, _optional_, defaults to `True`) --
...
This is the configuration class to store the configuration of a [SegformerModel](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerModel). It is used
...
- **size** (`int` or `Tuple(int)`, _optional_, defaults to 512) --
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SegformerModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/segformer/modeling_segformer.py#L481</source><parameters>[{"name": "pixel_values", "val": ""}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
  [SegformerFeatureExtractor](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerFeatureExtractor). See
  [transformers.SegformerFeatureExtractor.__call__()](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerFeatureExtractor.__call__) for details.
...
various elements depending on the configuration ([SegformerConfig](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerConfig)) and inputs.
...
The [SegformerModel](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerModel) forward method, overrides the `__call__` special method.
...
- **attentions** (`tuple(torch.FloatTensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`.
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [SegformerForImageClassification](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerForImageClassification) forward method, overrides the `__call__` special method.
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SegformerForSemanticSegmentation.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/segformer/modeling_segformer.py#L704</source><parameters>[{"name": "pixel_values", "val": ""}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
  [SegformerFeatureExtractor](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerFeatureExtractor). See
  [transformers.SegformerFeatureExtractor.__call__()](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerFeatureExtractor.__call__) for details.
...
- **attentions** (`tuple(torch.FloatTensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`.
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [SegformerForSemanticSegmentation](/docs/transformers/v4.14.1/en/model_doc/segformer#transformers.SegformerForSemanticSegmentation) forward method, overrides the `__call__` special method.
