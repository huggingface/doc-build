...
[generate()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) to autoregressively generate text given the input image.

The [ViTFeatureExtractor](/docs/transformers/v4.14.1/en/model_doc/vit#transformers.ViTFeatureExtractor) class is responsible for preprocessing the input image and
[RobertaTokenizer](/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer) decodes the generated target tokens to the target string. The
[TrOCRProcessor](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRProcessor) wraps [ViTFeatureExtractor](/docs/transformers/v4.14.1/en/model_doc/vit#transformers.ViTFeatureExtractor) and [RobertaTokenizer](/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer)
...
This is the configuration class to store the configuration of a [TrOCRForCausalLM](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRForCausalLM). It is used
...
<docstring><name>class transformers.TrOCRProcessor</name><anchor>transformers.TrOCRProcessor</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/trocr/processing_trocr.py#L27</source><parameters>[{"name": "feature_extractor", "val": ""}, {"name": "tokenizer", "val": ""}]</parameters><paramsdesc>- **feature_extractor** ([AutoFeatureExtractor](/docs/transformers/v4.14.1/en/model_doc/auto#transformers.AutoFeatureExtractor)) --
...
- **tokenizer** ([RobertaTokenizer](/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer)) --
  An instance of [RobertaTokenizer](/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer). The tokenizer is a required input.</paramsdesc><paramgroups>0</paramgroups></docstring>

Constructs a TrOCR processor which wraps a vision feature extractor and a TrOCR tokenizer into a single processor.

[TrOCRProcessor](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRProcessor) offers all the functionalities of [AutoFeatureExtractor](/docs/transformers/v4.14.1/en/model_doc/auto#transformers.AutoFeatureExtractor)
and [RobertaTokenizer](/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer). See the [__call__()](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRProcessor.__call__) and
[decode()](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRProcessor.decode) for more information.
...
<div class="docstring">
<docstring><name>\_\_call\_\_</name><anchor>transformers.TrOCRProcessor.__call__</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/trocr/processing_trocr.py#L109</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor's
`__call__()` and returns its output. If used in the context
[as_target_processor()](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRProcessor.as_target_processor) this method forwards all its arguments to
...
Instantiate a [TrOCRProcessor](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRProcessor) from a pretrained TrOCR processor.
...
it can be re-loaded using the [from_pretrained()](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRProcessor.from_pretrained) class method.
...
<div class="docstring">
<docstring><name>batch\_decode</name><anchor>transformers.TrOCRProcessor.batch_decode</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/trocr/processing_trocr.py#L119</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>decode</name><anchor>transformers.TrOCRProcessor.decode</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/trocr/processing_trocr.py#L127</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to TrOCRTokenizer's [decode()](/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode).
Please refer to the docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>as\_target\_processor</name><anchor>transformers.TrOCRProcessor.as_target_processor</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/trocr/processing_trocr.py#L134</source><parameters>[]</parameters></docstring>
...
<docstring><name>class transformers.TrOCRForCausalLM</name><anchor>transformers.TrOCRForCausalLM</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/trocr/modeling_trocr.py#L778</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([TrOCRConfig](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRConfig)) --
...
The TrOCR Decoder with a language modeling head. Can be used as the decoder part of [EncoderDecoderModel](/docs/transformers/v4.14.1/en/model_doc/encoderdecoder#transformers.EncoderDecoderModel) and `VisionEncoderDecoder`.
...
various elements depending on the configuration ([TrOCRConfig](/docs/transformers/v4.14.1/en/model_doc/trocr#transformers.TrOCRConfig)) and inputs.
