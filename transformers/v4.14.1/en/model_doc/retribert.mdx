...
This is the configuration class to store the configuration of a [RetriBertModel](/docs/transformers/v4.14.1/en/model_doc/retribert#transformers.RetriBertModel). It is used
...
`RetroBertTokenizer` is identical to [BertTokenizer](/docs/transformers/v4.14.1/en/model_doc/bert#transformers.BertTokenizer) and runs end-to-end
...
[RetriBertTokenizerFast](/docs/transformers/v4.14.1/en/model_doc/retribert#transformers.RetriBertTokenizerFast) is identical to [BertTokenizerFast](/docs/transformers/v4.14.1/en/model_doc/bert#transformers.BertTokenizerFast) and runs
...
<docstring><name>forward</name><anchor>transformers.RetriBertModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/retribert/modeling_retribert.py#L177</source><parameters>[{"name": "input_ids_query", "val": ""}, {"name": "attention_mask_query", "val": ""}, {"name": "input_ids_doc", "val": ""}, {"name": "attention_mask_doc", "val": ""}, {"name": "checkpoint_batch_size", "val": " = -1"}]</parameters><paramsdesc>- **input_ids_query** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [RetriBertTokenizer](/docs/transformers/v4.14.1/en/model_doc/retribert#transformers.RetriBertTokenizer). See
