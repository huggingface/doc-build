...
- This implementation is the same as [RobertaModel](/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaModel) with the addition of entity embeddings as well
...
- LUKE treats entities as input tokens; therefore, it takes `entity_ids`, `entity_attention_mask`,
  ...
  [LukeTokenizer](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeTokenizer).
- [LukeTokenizer](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeTokenizer) takes `entities` and `entity_spans` (character-based start and end
...
- There are three head models for the former use case:
  ...
  - [LukeForEntityClassification](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeForEntityClassification), for tasks to classify a single entity in an input text such as
  ...
  - [LukeForEntityPairClassification](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeForEntityPairClassification), for tasks to classify the relationship between two entities
  ...
  - [LukeForEntitySpanClassification](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeForEntitySpanClassification), for tasks to classify the sequence of entity spans, such as
    named entity recognition (NER). This model places a linear head on top of the output entity representations. You
    can address NER using this model by inputting all possible entity spans in the text to the model.

  [LukeTokenizer](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeTokenizer) has a `task` argument, which enables you to easily create an input to these
  head models by specifying `task="entity_classification"`, `task="entity_pair_classification"`, or
  `task="entity_span_classification"`. Please refer to the example code of each head models.

  A demo notebook on how to fine-tune [LukeForEntityPairClassification](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeForEntityPairClassification) for relation
...
- **entity_vocab_size** (`int`, _optional_, defaults to 500000) --
  ...
  by the `entity_ids` passed when calling [LukeModel](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeModel).
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  The vocabulary size of the `token_type_ids` passed when calling [LukeModel](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeModel).
...
This is the configuration class to store the configuration of a [LukeModel](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeModel). It is used to
...
This tokenizer inherits from [RobertaTokenizer](/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer) which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods. Compared to
[RobertaTokenizer](/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer), [LukeTokenizer](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeTokenizer) also creates entity sequences, namely
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.LukeModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L914</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "entity_ids", "val": " = None"}, {"name": "entity_attention_mask", "val": " = None"}, {"name": "entity_token_type_ids", "val": " = None"}, {"name": "entity_position_ids", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.

  Indices can be obtained using [LukeTokenizer](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeTokenizer). See
...
- **return_dict** (`bool`, _optional_) --
  Whether or not to return a [ModelOutput](/docs/transformers/v4.14.1/en/main_classes/output#transformers.file_utils.ModelOutput) instead of a plain tuple.</paramsdesc><paramgroups>0</paramgroups><rettype>`BaseLukeModelOutputWithPooling` or `tuple(torch.FloatTensor)`</rettype><retdesc>A `BaseLukeModelOutputWithPooling` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) and inputs.
...
The [LukeModel](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeModel) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.LukeForMaskedLM</name><anchor>transformers.LukeForMaskedLM</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L1126</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) -- Model configuration class with all the parameters of the
  model. Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model
  weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.LukeForMaskedLM.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L1162</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "entity_ids", "val": " = None"}, {"name": "entity_attention_mask", "val": " = None"}, {"name": "entity_token_type_ids", "val": " = None"}, {"name": "entity_position_ids", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "entity_labels", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **entity_labels** (`torch.LongTensor` of shape `(batch_size, entity_length)`, _optional_) --
  Labels for computing the masked language modeling loss. Indices should be in `[-100, 0, ..., config.vocab_size]` (see `input_ids` docstring) Tokens with indices set to `-100` are ignored
  (masked), the loss is only computed for the tokens with labels in `[0, ..., config.vocab_size]`</paramsdesc><paramgroups>0</paramgroups><rettype>`LukeMaskedLMOutput` or `tuple(torch.FloatTensor)`</rettype><retdesc>A `LukeMaskedLMOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) and inputs.

- **loss** (`torch.FloatTensor` of shape `(1,)`, _optional_, returned when `labels` is provided) -- The sum of masked language modeling (MLM) loss and entity prediction loss.
- **mlm_loss** (`torch.FloatTensor` of shape `(1,)`, _optional_, returned when `labels` is provided) -- Masked language modeling (MLM) loss.
- **mep_loss** (`torch.FloatTensor` of shape `(1,)`, _optional_, returned when `labels` is provided) -- Masked entity prediction (MEP) loss.
...
The [LukeForMaskedLM](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeForMaskedLM) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.LukeForEntityClassification</name><anchor>transformers.LukeForEntityClassification</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L1262</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) -- Model configuration class with all the parameters of the
  model. Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model
  weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.LukeForEntityClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L1275</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "entity_ids", "val": " = None"}, {"name": "entity_attention_mask", "val": " = None"}, {"name": "entity_token_type_ids", "val": " = None"}, {"name": "entity_position_ids", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **labels** (`torch.LongTensor` of shape `(batch_size,)` or `(batch_size, num_labels)`, _optional_) --
  ...
  `[0, 1]`, where 0 and 1 indicate false and true, respectively.</paramsdesc><paramgroups>0</paramgroups><rettype>`EntityClassificationOutput` or `tuple(torch.FloatTensor)`</rettype><retdesc>A `EntityClassificationOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) and inputs.
...
The [LukeForEntityClassification](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeForEntityClassification) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.LukeForEntityPairClassification</name><anchor>transformers.LukeForEntityPairClassification</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L1376</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) -- Model configuration class with all the parameters of the
  model. Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model
  weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.LukeForEntityPairClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L1389</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "entity_ids", "val": " = None"}, {"name": "entity_attention_mask", "val": " = None"}, {"name": "entity_token_type_ids", "val": " = None"}, {"name": "entity_position_ids", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **labels** (`torch.LongTensor` of shape `(batch_size,)` or `(batch_size, num_labels)`, _optional_) --
  ...
  in `[0, ..., config.num_labels - 1]`. If the shape is `(batch_size, num_labels)`, the binary
  cross entropy loss is used for the multi-label classification. In this case, labels should only contain
  `[0, 1]`, where 0 and 1 indicate false and true, respectively.</paramsdesc><paramgroups>0</paramgroups><rettype>`EntityPairClassificationOutput` or `tuple(torch.FloatTensor)`</rettype><retdesc>A `EntityPairClassificationOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) and inputs.
...
- **attentions** (`tuple(torch.FloatTensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`. Attentions weights after the attention softmax, used to compute the
  weighted average in the self-attention heads.</retdesc></docstring>
The [LukeForEntityPairClassification](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeForEntityPairClassification) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.LukeForEntitySpanClassification</name><anchor>transformers.LukeForEntitySpanClassification</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L1492</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) -- Model configuration class with all the parameters of the
  model. Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model
  weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.LukeForEntitySpanClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/luke/modeling_luke.py#L1505</source><parameters>[{"name": "input_ids", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "token_type_ids", "val": " = None"}, {"name": "position_ids", "val": " = None"}, {"name": "entity_ids", "val": " = None"}, {"name": "entity_attention_mask", "val": " = None"}, {"name": "entity_token_type_ids", "val": " = None"}, {"name": "entity_position_ids", "val": " = None"}, {"name": "entity_start_positions", "val": " = None"}, {"name": "entity_end_positions", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  Indices of input sequence tokens in the vocabulary.
...
- **labels** (`torch.LongTensor` of shape `(batch_size, entity_length)` or `(batch_size, entity_length, num_labels)`, _optional_) --
  ...
  labels should only contain `[0, 1]`, where 0 and 1 indicate false and true, respectively.</paramsdesc><paramgroups>0</paramgroups><rettype>`EntitySpanClassificationOutput` or `tuple(torch.FloatTensor)`</rettype><retdesc>A `EntitySpanClassificationOutput` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([LukeConfig](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeConfig)) and inputs.
...
- **attentions** (`tuple(torch.FloatTensor)`, _optional_, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`. Attentions weights after the attention softmax, used to compute the
  weighted average in the self-attention heads.</retdesc></docstring>
The [LukeForEntitySpanClassification](/docs/transformers/v4.14.1/en/model_doc/luke#transformers.LukeForEntitySpanClassification) forward method, overrides the `__call__` special method.
