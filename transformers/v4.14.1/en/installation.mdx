...
- local: caching-models
  ...
  - local: offline-mode
    sections:
    - local: fetching-models-and-tokenizers-to-use-offline
      title: Fetching models and tokenizers to use offline
    title: Offline mode
  title: Caching models
- local: do-you-want-to-run-a-transformer-model-on-a-mobile-device
  title: Do you want to run a Transformer model on a mobile device?
title: Installation
---
<script lang="ts">
...
<h2 id="installation-with-pip">Installation with pip</h2>
...
<h2 id="with-conda">With conda</h2>
...
<h2 id="caching-models">Caching models</h2>
...
<h4 id="fetching-models-and-tokenizers-to-use-offline">Fetching models and tokenizers to use offline</h4>
...
<h2 id="do-you-want-to-run-a-transformer-model-on-a-mobile-device">Do you want to run a Transformer model on a mobile device?</h2>
