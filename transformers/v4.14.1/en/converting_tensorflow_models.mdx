...
be imported using `from_pretrained()` (see example in [quicktour](/docs/transformers/v4.14.1/en/quicktour) , [run_glue.py](https://github.com/huggingface/transformers/tree/master/examples/pytorch/text-classification/run_glue.py) ).
