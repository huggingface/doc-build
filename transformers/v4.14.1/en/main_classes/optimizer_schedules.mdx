...
<div class="docstring">
<docstring><name>step</name><anchor>transformers.AdamW.step</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization.py#L313</source><parameters>[{"name": "closure", "val": ": typing.Callable = None"}]</parameters><paramsdesc>- **closure** (`Callable`, _optional_) -- A closure that reevaluates the model and returns the loss.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
When using `lr=None` with [Trainer](/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer) you will most likely need to use `AdafactorSchedule` scheduler as following:
...
<div class="docstring">
<docstring><name>step</name><anchor>transformers.Adafactor.step</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization.py#L512</source><parameters>[{"name": "closure", "val": " = None"}]</parameters><paramsdesc>- **closure** (callable, optional) -- A closure that reevaluates the model
...
<docstring><name>class transformers.AdamWeightDecay</name><anchor>transformers.AdamWeightDecay</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization_tf.py#L152</source><parameters>[{"name": "learning_rate", "val": ": typing.Union[float, keras.optimizer_v2.learning_rate_schedule.LearningRateSchedule] = 0.001"}, {"name": "beta_1", "val": ": float = 0.9"}, {"name": "beta_2", "val": ": float = 0.999"}, {"name": "epsilon", "val": ": float = 1e-07"}, {"name": "amsgrad", "val": ": bool = False"}, {"name": "weight_decay_rate", "val": ": float = 0.0"}, {"name": "include_in_weight_decay", "val": ": typing.Optional[typing.List[str]] = None"}, {"name": "exclude_from_weight_decay", "val": ": typing.Optional[typing.List[str]] = None"}, {"name": "name", "val": ": str = 'AdamWeightDecay'"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **learning_rate** (`Union[float, tf.keras.optimizers.schedules.LearningRateSchedule]`, _optional_, defaults to 1e-3) --
...
- **name** (`str`, _optional_, defaults to 'AdamWeightDecay') --
  ...
  recommended to use `learning_rate` instead.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>from\_config</name><anchor>transformers.AdamWeightDecay.from_config</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization_tf.py#L209</source><parameters>[{"name": "config", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.SchedulerType</name><anchor>transformers.SchedulerType</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/trainer_utils.py#L282</source><parameters>[{"name": "value", "val": ""}, {"name": "names", "val": " = None"}, {"name": "module", "val": " = None"}, {"name": "qualname", "val": " = None"}, {"name": "type", "val": " = None"}, {"name": "start", "val": " = 1"}]</parameters></docstring>
An enumeration.
...
<docstring><name>transformers.get\_constant\_schedule\_with\_warmup</name><anchor>transformers.get_constant_schedule_with_warmup</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization.py#L49</source><parameters>[{"name": "optimizer", "val": ": Optimizer"}, {"name": "num_warmup_steps", "val": ": int"}, {"name": "last_epoch", "val": ": int = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
  The optimizer for which to schedule the learning rate.
- **num_warmup_steps** (`int`) --
...
<img alt="" src="/docs/transformers/v4.14.1/en/imgs/warmup_constant_schedule.png"/>

<div class="docstring">

<docstring><name>transformers.get\_cosine\_schedule\_with\_warmup</name><anchor>transformers.get_cosine_schedule_with_warmup</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization.py#L103</source><parameters>[{"name": "optimizer", "val": ": Optimizer"}, {"name": "num_warmup_steps", "val": ": int"}, {"name": "num_training_steps", "val": ": int"}, {"name": "num_cycles", "val": ": float = 0.5"}, {"name": "last_epoch", "val": ": int = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
  The optimizer for which to schedule the learning rate.
- **num_warmup_steps** (`int`) --
  The number of steps for the warmup phase.
...
<img alt="" src="/docs/transformers/v4.14.1/en/imgs/warmup_cosine_schedule.png"/>

<div class="docstring">

<docstring><name>transformers.get\_cosine\_with\_hard\_restarts\_schedule\_with\_warmup</name><anchor>transformers.get_cosine_with_hard_restarts_schedule_with_warmup</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization.py#L137</source><parameters>[{"name": "optimizer", "val": ": Optimizer"}, {"name": "num_warmup_steps", "val": ": int"}, {"name": "num_training_steps", "val": ": int"}, {"name": "num_cycles", "val": ": int = 1"}, {"name": "last_epoch", "val": ": int = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
  The optimizer for which to schedule the learning rate.
- **num_warmup_steps** (`int`) --
  The number of steps for the warmup phase.
- **num_training_steps** (`int`) --
...
<img alt="" src="/docs/transformers/v4.14.1/en/imgs/warmup_cosine_hard_restarts_schedule.png"/>

<div class="docstring">

<docstring><name>transformers.get\_linear\_schedule\_with\_warmup</name><anchor>transformers.get_linear_schedule_with_warmup</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization.py#L74</source><parameters>[{"name": "optimizer", "val": ""}, {"name": "num_warmup_steps", "val": ""}, {"name": "num_training_steps", "val": ""}, {"name": "last_epoch", "val": " = -1"}]</parameters><paramsdesc>- **optimizer** (`Optimizer`) --
  The optimizer for which to schedule the learning rate.
- **num_warmup_steps** (`int`) --
  The number of steps for the warmup phase.
- **num_training_steps** (`int`) --
...
<docstring><name>class transformers.GradientAccumulator</name><anchor>transformers.GradientAccumulator</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization_tf.py#L282</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>reset</name><anchor>transformers.GradientAccumulator.reset</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/optimization_tf.py#L344</source><parameters>[]</parameters></docstring>
