...
[DataCollatorForLanguageModeling](/docs/transformers/v4.14.1/en/main_classes/data_collator#transformers.DataCollatorForLanguageModeling)) also apply some random data augmentation (like random masking)
on the formed batch.

Examples of use can be found in the [example scripts](/docs/transformers/v4.14.1/en/../examples) or [example notebooks](/docs/transformers/v4.14.1/en/../notebooks).
...
<docstring><name>class transformers.DefaultDataCollator</name><anchor>transformers.DefaultDataCollator</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/data/data_collator.py#L74</source><parameters>[{"name": "return_tensors", "val": ": str = 'pt'"}]</parameters><paramsdesc>- **return_tensors** (`str`) --
...
<docstring><name>class transformers.DataCollatorForSeq2Seq</name><anchor>transformers.DataCollatorForSeq2Seq</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/data/data_collator.py#L513</source><parameters>[{"name": "tokenizer", "val": ": PreTrainedTokenizerBase"}, {"name": "model", "val": ": typing.Optional[typing.Any] = None"}, {"name": "padding", "val": ": typing.Union[bool, str, transformers.file_utils.PaddingStrategy] = True"}, {"name": "max_length", "val": ": typing.Optional[int] = None"}, {"name": "pad_to_multiple_of", "val": ": typing.Optional[int] = None"}, {"name": "label_pad_token_id", "val": ": int = -100"}, {"name": "return_tensors", "val": ": str = 'pt'"}]</parameters><paramsdesc>- **tokenizer** ([PreTrainedTokenizer](/docs/transformers/v4.14.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizer) or [PreTrainedTokenizerFast](/docs/transformers/v4.14.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast)) --
  The tokenizer used for encoding the data.
- **model** ([PreTrainedModel](/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel)) --
...
[PreTrainedTokenizer](/docs/transformers/v4.14.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizer) or a [PreTrainedTokenizerFast](/docs/transformers/v4.14.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast) with the
...
<div class="docstring">
<docstring><name>numpy\_mask\_tokens</name><anchor>transformers.DataCollatorForLanguageModeling.numpy_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/data/data_collator.py#L800</source><parameters>[{"name": "inputs", "val": ": typing.Any"}, {"name": "special_tokens_mask", "val": ": typing.Optional[typing.Any] = None"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>tf\_mask\_tokens</name><anchor>transformers.DataCollatorForLanguageModeling.tf_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/data/data_collator.py#L654</source><parameters>[{"name": "inputs", "val": ": typing.Any"}, {"name": "vocab_size", "val": ""}, {"name": "mask_token_id", "val": ""}, {"name": "special_tokens_mask", "val": ": typing.Optional[typing.Any] = None"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>torch\_mask\_tokens</name><anchor>transformers.DataCollatorForLanguageModeling.torch_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/data/data_collator.py#L743</source><parameters>[{"name": "inputs", "val": ": typing.Any"}, {"name": "special_tokens_mask", "val": ": typing.Optional[typing.Any] = None"}]</parameters></docstring>
...
[BertTokenizer](/docs/transformers/v4.14.1/en/model_doc/bert#transformers.BertTokenizer), specifically that subword tokens are prefixed with _##_. For tokenizers
...
<div class="docstring">
<docstring><name>numpy\_mask\_tokens</name><anchor>transformers.DataCollatorForPermutationLanguageModeling.numpy_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/data/data_collator.py#L1433</source><parameters>[{"name": "inputs", "val": ": typing.Any"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>tf\_mask\_tokens</name><anchor>transformers.DataCollatorForPermutationLanguageModeling.tf_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/data/data_collator.py#L1324</source><parameters>[{"name": "inputs", "val": ": typing.Any"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>torch\_mask\_tokens</name><anchor>transformers.DataCollatorForPermutationLanguageModeling.torch_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/data/data_collator.py#L1226</source><parameters>[{"name": "inputs", "val": ": typing.Any"}]</parameters></docstring>
