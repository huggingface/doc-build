...
- local: naive-model-parallel-vertical-and-pipeline-parallel
  title: Naive Model Parallel (Vertical) and Pipeline Parallel
...
- local: flexflow
  title: FlexFlow
- local: which-strategy-to-use-when
...
<h2 id="parallelism-overview">Parallelism overview</h2>
...
<h2 id="zero-data-parallel">ZeRO Data Parallel</h2>
...
![DeepSpeed-Image-1](/docs/transformers/v4.14.1/en/imgs/parallelism-zero.png)
...
<h2 id="naive-model-parallel-vertical-and-pipeline-parallel">Naive Model Parallel (Vertical) and Pipeline Parallel</h2>
...
![mp-pp](/docs/transformers/v4.14.1/en/imgs/parallelism-gpipe-bubble.png)
...
![interleaved-pipeline-execution](/docs/transformers/v4.14.1/en/imgs/parallelism-sagemaker-interleaved-pipeline.png)
...
![Parallel GEMM](/docs/transformers/v4.14.1/en/imgs/parallelism-tp-parallel_gemm.png)
...
![independent GeLU](/docs/transformers/v4.14.1/en/imgs/parallelism-tp-independent-gelu.png)
...
![parallel shard processing](/docs/transformers/v4.14.1/en/imgs/parallelism-tp-parallel_shard_processing.png)

Parallelizing the multi-headed attention layers is even simpler, since they are already inherently parallel, due to having multiple independent heads!
![parallel self-attention](/docs/transformers/v4.14.1/en/imgs/parallelism-tp-parallel_self_attention.png)
...
![dp-pp-2d](/docs/transformers/v4.14.1/en/imgs/parallelism-zero-dp-pp.png)
...
<h2 id="dppptp">DP+PP+TP</h2>

To get an even more efficient training a 3D parallelism is used where PP is combined with TP and DP. This can be seen in the following diagram.

![dp-pp-tp-3d](/docs/transformers/v4.14.1/en/imgs/parallelism-deepspeed-3d.png)
...
<h2 id="dppptpzero">DP+PP+TP+ZeRO</h2>
...
![flex-flow-soap](/docs/transformers/v4.14.1/en/imgs/parallelism-flexflow.jpeg)
...
<h2 id="which-strategy-to-use-when">Which Strategy To Use When</h2>
