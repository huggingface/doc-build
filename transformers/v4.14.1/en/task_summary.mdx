...
automatically selecting the correct model architecture. Please check the [AutoModel](/docs/transformers/v4.14.1/en/model_doc/auto#transformers.AutoModel) documentation
...
>>> print(f"Answer: '&amp;lcub;result['answer']}', score: &amp;lcub;round(result['score'], 4)}, start: &amp;lcub;result['start']}, end: &amp;lcub;result['end']}")
...
>>> pprint(unmasker(f"HuggingFace is creating a &amp;lcub;unmasker.tokenizer.mask_token} that the community uses to solve NLP tasks."))
[&amp;lcub;'score': 0.1793,
...
In the next section, we show how [generation_utils.GenerationMixin.generate()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) can be used to
...
[PreTrainedModel.generate()](/docs/transformers/v4.14.1/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) to generate text. The default arguments for this method can be
