...
`),pa=l("em"),Ao=r("~/.cache/huggingface/dataset"),Po=r(" by default)."),os=p(),b=l("p"),qo=r("The "),da=l("code"),xo=r("raw_datasets"),zo=r(" object is a dictionary with three keys: "),ma=l("code"),Fo=r('"train"'),Co=r(", "),ha=l("code"),Do=r('"test"'),So=r(" and "),ua=l("code"),Io=r('"unsupervised"'),Mo=r(`
...
`),_a=l("code"),Lo=r('"test"'),Wo=r(" split for validation."),ns=p(),pt=l("p"),Bo=r("To preprocess our data, we will need a tokenizer:"),ls=p(),h(Ee.$$.fragment),is=p(),G=l("p"),Ho=r("As we saw in "),dt=l("a"),Ko=r("preprocessing"),Go=r(`, we can prepare the text inputs for the model with the following command (this is an
example, not a command you can execute):`),fs=p(),h(Te.$$.fragment),ps=p(),mt=l("p"),Uo=r(`This will make all the samples have the maximum length the model can accept (here 512), either by padding or truncating
them.`),ds=p(),U=l("p"),Yo=r(`However, we can instead apply these preprocessing steps to all the splits of our dataset at once by using the
`),wa=l("code"),Jo=r("map"),Ro=r(" method:"),ms=p(),h(je.$$.fragment),hs=p(),Y=l("p"),Xo=r("You can learn more about the map method or the other ways to preprocess the data in the \u{1F917} Datasets "),Ae=l("a"),Zo=r("documentation"),Qo=r("."),us=p(),ht=l("p"),Vo=r("Next we will generate a small subset of the training and validation set, to enable faster training:"),cs=p(),h(Pe.$$.fragment),_s=p(),E=l("p"),en=r("In all the examples below, we will always use "),va=l("code"),tn=r("small_train_dataset"),an=r(" and "),ya=l("code"),sn=r("small_eval_dataset"),rn=r(`. Just replace
them by their `),ba=l("em"),on=r("full"),nn=r(" equivalent to train or evaluate on the full dataset."),ws=p(),ut=l("a"),vs=p(),O=l("h2"),J=l("a"),$a=l("span"),h(qe.$$.fragment),ln=p(),ga=l("span"),fn=r("Fine-tuning in PyTorch with the Trainer API"),ys=p(),h(xe.$$.fragment),bs=p(),R=l("p"),pn=r("Since PyTorch does not provide a training loop, the \u{1F917} Transformers library provides a "),ct=l("a"),dn=r("Trainer"),mn=r(`
...
the `),Ya=l("em"),li=r("how to finetune a model on xxx"),ii=r(")."),this.h()},l(e){const s=Vf('[data-svelte="svelte-1phssyn"]',document.head);x=i(s,"META",{name:!0,content:!0}),s.forEach(t),ot=d(e),g=i(e,"H1",{class:!0});var qr=f(g);P=i(qr,"A",{id:!0,class:!0,href:!0});var pi=f(P);sa=i(pi,"SPAN",{});var di=f(sa);u(_e.$$.fragment,di),di.forEach(t),pi.forEach(t),Vr=d(qr),ra=i(qr,"SPAN",{});var mi=f(ra);eo=o(mi,"Fine-tuning a pretrained model"),mi.forEach(t),qr.forEach(t),Ra=d(e),u(we.$$.fragment,e),Xa=d(e),z=i(e,"P",{});var Rt=f(z);to=o(Rt,`In this tutorial, we will show you how to fine-tune a pretrained model from the Transformers library. In TensorFlow,
...
a model from scratch easily. Then we will show you how to alternatively write the whole training loop in PyTorch.`),Rt.forEach(t),Za=d(e),F=i(e,"P",{});var Xt=f(F);no=o(Xt,`Before we can fine-tune a model, we need a dataset. In this tutorial, we will show you how to fine-tune BERT on the
...
negative. For examples of other tasks, refer to the `),lt=i(Xt,"A",{href:!0});var _i=f(lt);fo=o(_i,"additional-resources"),_i.forEach(t),po=o(Xt," section!"),Xt.forEach(t),Qa=d(e),it=i(e,"A",{id:!0}),f(it).forEach(t),Va=d(e),N=i(e,"H2",{class:!0});var xr=f(N);H=i(xr,"A",{id:!0,class:!0,href:!0});var wi=f(H);na=i(wi,"SPAN",{});var vi=f(na);u(ye.$$.fragment,vi),vi.forEach(t),wi.forEach(t),mo=d(xr),la=i(xr,"SPAN",{});var yi=f(la);ho=o(yi,"Preparing the datasets"),yi.forEach(t),xr.forEach(t),es=d(e),u(be.$$.fragment,e),ts=d(e),k=i(e,"P",{});var pe=f(k);uo=o(pe,"We will use the "),$e=i(pe,"A",{href:!0,rel:!0});var bi=f($e);co=o(bi,"\u{1F917} Datasets"),bi.forEach(t),_o=o(pe,` library to download and preprocess the IMDB
datasets. We will go over this part pretty quickly. Since the focus of this tutorial is on training, you should refer
...
more information.`),pe.forEach(t),as=d(e),K=i(e,"P",{});var zr=f(K);$o=o(zr,"First, we can use the "),ia=i(zr,"CODE",{});var ki=f(ia);go=o(ki,"load_dataset"),ki.forEach(t),ko=o(zr," function to download and cache the dataset:"),zr.forEach(t),ss=d(e),u(ke.$$.fragment,e),rs=d(e),C=i(e,"P",{});var Zt=f(C);Eo=o(Zt,"This works like the "),fa=i(Zt,"CODE",{});var Ei=f(fa);To=o(Ei,"from_pretrained"),Ei.forEach(t),jo=o(Zt,` method we saw for the models and tokenizers (except the cache directory is
`),pa=i(Zt,"EM",{});var Ti=f(pa);Ao=o(Ti,"~/.cache/huggingface/dataset"),Ti.forEach(t),Po=o(Zt," by default)."),Zt.forEach(t),os=d(e),b=i(e,"P",{});var $=f(b);qo=o($,"The "),da=i($,"CODE",{});var ji=f(da);xo=o(ji,"raw_datasets"),ji.forEach(t),zo=o($," object is a dictionary with three keys: "),ma=i($,"CODE",{});var Ai=f(ma);Fo=o(Ai,'"train"'),Ai.forEach(t),Co=o($,", "),ha=i($,"CODE",{});var Pi=f(ha);Do=o(Pi,'"test"'),Pi.forEach(t),So=o($," and "),ua=i($,"CODE",{});var qi=f(ua);Io=o(qi,'"unsupervised"'),qi.forEach(t),Mo=o($,`
...
`),_a=i($,"CODE",{});var zi=f(_a);Lo=o(zi,'"test"'),zi.forEach(t),Wo=o($," split for validation."),$.forEach(t),ns=d(e),pt=i(e,"P",{});var Fi=f(pt);Bo=o(Fi,"To preprocess our data, we will need a tokenizer:"),Fi.forEach(t),ls=d(e),u(Ee.$$.fragment,e),is=d(e),G=i(e,"P",{});var Fr=f(G);Ho=o(Fr,"As we saw in "),dt=i(Fr,"A",{href:!0});var Ci=f(dt);Ko=o(Ci,"preprocessing"),Ci.forEach(t),Go=o(Fr,`, we can prepare the text inputs for the model with the following command (this is an
example, not a command you can execute):`),Fr.forEach(t),fs=d(e),u(Te.$$.fragment,e),ps=d(e),mt=i(e,"P",{});var Di=f(mt);Uo=o(Di,`This will make all the samples have the maximum length the model can accept (here 512), either by padding or truncating
them.`),Di.forEach(t),ds=d(e),U=i(e,"P",{});var Cr=f(U);Yo=o(Cr,`However, we can instead apply these preprocessing steps to all the splits of our dataset at once by using the
`),wa=i(Cr,"CODE",{});var Si=f(wa);Jo=o(Si,"map"),Si.forEach(t),Ro=o(Cr," method:"),Cr.forEach(t),ms=d(e),u(je.$$.fragment,e),hs=d(e),Y=i(e,"P",{});var Dr=f(Y);Xo=o(Dr,"You can learn more about the map method or the other ways to preprocess the data in the \u{1F917} Datasets "),Ae=i(Dr,"A",{href:!0,rel:!0});var Ii=f(Ae);Zo=o(Ii,"documentation"),Ii.forEach(t),Qo=o(Dr,"."),Dr.forEach(t),us=d(e),ht=i(e,"P",{});var Mi=f(ht);Vo=o(Mi,"Next we will generate a small subset of the training and validation set, to enable faster training:"),Mi.forEach(t),cs=d(e),u(Pe.$$.fragment,e),_s=d(e),E=i(e,"P",{});var de=f(E);en=o(de,"In all the examples below, we will always use "),va=i(de,"CODE",{});var Ni=f(va);tn=o(Ni,"small_train_dataset"),Ni.forEach(t),an=o(de," and "),ya=i(de,"CODE",{});var Oi=f(ya);sn=o(Oi,"small_eval_dataset"),Oi.forEach(t),rn=o(de,`. Just replace
them by their `),ba=i(de,"EM",{});var Li=f(ba);on=o(Li,"full"),Li.forEach(t),nn=o(de," equivalent to train or evaluate on the full dataset."),de.forEach(t),ws=d(e),ut=i(e,"A",{id:!0}),f(ut).forEach(t),vs=d(e),O=i(e,"H2",{class:!0});var Sr=f(O);J=i(Sr,"A",{id:!0,class:!0,href:!0});var Wi=f(J);$a=i(Wi,"SPAN",{});var Bi=f($a);u(qe.$$.fragment,Bi),Bi.forEach(t),Wi.forEach(t),ln=d(Sr),ga=i(Sr,"SPAN",{});var Hi=f(ga);fn=o(Hi,"Fine-tuning in PyTorch with the Trainer API"),Hi.forEach(t),Sr.forEach(t),ys=d(e),u(xe.$$.fragment,e),bs=d(e),R=i(e,"P",{});var Ir=f(R);pn=o(Ir,"Since PyTorch does not provide a training loop, the \u{1F917} Transformers library provides a "),ct=i(Ir,"A",{href:!0});var Ki=f(ct);dn=o(Ki,"Trainer"),Ki.forEach(t),mn=o(Ir,`
API that is optimized for \u{1F917} Transformers models, with a wide range of training options and with built-in features like
logging, gradient accumulation, and mixed precision.`),Ir.forEach(t),$s=d(e),_t=i(e,"P",{});var Gi=f(_t);hn=o(Gi,"First, let\u2019s define our model:"),Gi.forEach(t),gs=d(e),u(ze.$$.fragment,e),ks=d(e),wt=i(e,"P",{});var Ui=f(wt);un=o(Ui,`This will issue a warning about some of the pretrained weights not being used and some weights being randomly
initialized. That\u2019s because we are throwing away the pretraining head of the BERT model to replace it with a
classification head which is randomly initialized. We will fine-tune this model on our task, transferring the knowledge
of the pretrained model to it (which is why doing this is called transfer learning).`),Ui.forEach(t),Es=d(e),T=i(e,"P",{});var me=f(T);cn=o(me,"Then, to define our "),vt=i(me,"A",{href:!0});var Yi=f(vt);_n=o(Yi,"Trainer"),Yi.forEach(t),wn=o(me,`, we will need to instantiate a
`),yt=i(me,"A",{href:!0});var Ji=f(yt);vn=o(Ji,"TrainingArguments"),Ji.forEach(t),yn=o(me,`. This class contains all the hyperparameters we can tune for the
`),bt=i(me,"A",{href:!0});var Ri=f(bt);bn=o(Ri,"Trainer"),Ri.forEach(t),$n=o(me,` or the flags to activate the different training options it supports. Let\u2019s begin by
using all the defaults, the only thing we then have to provide is a directory in which the checkpoints will be saved:`),me.forEach(t),Ts=d(e),u(Fe.$$.fragment,e),js=d(e),X=i(e,"P",{});var Mr=f(X);gn=o(Mr,"Then we can instantiate a "),$t=i(Mr,"A",{href:!0});var Xi=f($t);kn=o(Xi,"Trainer"),Xi.forEach(t),En=o(Mr," like this:"),Mr.forEach(t),As=d(e),u(Ce.$$.fragment,e),Ps=d(e),gt=i(e,"P",{});var Zi=f(gt);Tn=o(Zi,"To fine-tune our model, we just need to call"),Zi.forEach(t),qs=d(e),u(De.$$.fragment,e),xs=d(e),Z=i(e,"P",{});var Nr=f(Z);jn=o(Nr,`which will start a training that you can follow with a progress bar, which should take a couple of minutes to complete
(as long as you have access to a GPU). It won\u2019t actually tell you anything useful about how well (or badly) your model
is performing however as by default, there is no evaluation during training, and we didn\u2019t tell the
`),kt=i(Nr,"A",{href:!0});var Qi=f(kt);An=o(Qi,"Trainer"),Qi.forEach(t),Pn=o(Nr," to compute any metrics. Let\u2019s have a look on how to do that now!"),Nr.forEach(t),zs=d(e),j=i(e,"P",{});var he=f(j);qn=o(he,"To have the "),Et=i(he,"A",{href:!0});var Vi=f(Et);xn=o(Vi,"Trainer"),Vi.forEach(t),zn=o(he," compute and report metrics, we need to give it a "),ka=i(he,"CODE",{});var ef=f(ka);Fn=o(ef,"compute_metrics"),ef.forEach(t),Cn=o(he,`
...
(remember that all \u{1F917} Transformers models return the logits) and feed them to `),ja=i(ue,"CODE",{});var rf=f(ja);Wn=o(rf,"compute"),rf.forEach(t),Bn=o(ue," method of this metric."),ue.forEach(t),Cs=d(e),u(Se.$$.fragment,e),Ds=d(e),jt=i(e,"P",{});var of=f(jt);Hn=o(of,`The compute function needs to receive a tuple (with logits and labels) and has to return a dictionary with string keys
(the name of the metric) and float values. It will be called at the end of each evaluation phase on the whole arrays of
predictions/labels.`),of.forEach(t),Ss=d(e),Q=i(e,"P",{});var Or=f(Q);Kn=o(Or,"To check if this works on practice, let\u2019s create a new "),At=i(Or,"A",{href:!0});var nf=f(At);Gn=o(nf,"Trainer"),nf.forEach(t),Un=o(Or," with our fine-tuned model:"),Or.forEach(t),Is=d(e),u(Ie.$$.fragment,e),Ms=d(e),Pt=i(e,"P",{});var lf=f(Pt);Yn=o(lf,"which showed an accuracy of 87.5% in our case."),lf.forEach(t),Ns=d(e),qt=i(e,"P",{});var ff=f(qt);Jn=o(ff,`If you want to fine-tune your model and regularly report the evaluation metrics (for instance at the end of each
epoch), here is how you should define your training arguments:`),ff.forEach(t),Os=d(e),u(Me.$$.fragment,e),Ls=d(e),V=i(e,"P",{});var Lr=f(V);Rn=o(Lr,"See the documentation of "),xt=i(Lr,"A",{href:!0});var pf=f(xt);Xn=o(pf,"TrainingArguments"),pf.forEach(t),Zn=o(Lr," for more options."),Lr.forEach(t),Ws=d(e),zt=i(e,"A",{id:!0}),f(zt).forEach(t),Bs=d(e),L=i(e,"H2",{class:!0});var Wr=f(L);ee=i(Wr,"A",{id:!0,class:!0,href:!0});var df=f(ee);Aa=i(df,"SPAN",{});var mf=f(Aa);u(Ne.$$.fragment,mf),mf.forEach(t),df.forEach(t),Qn=d(Wr),Pa=i(Wr,"SPAN",{});var hf=f(Pa);Vn=o(hf,"Fine-tuning with Keras"),hf.forEach(t),Wr.forEach(t),Hs=d(e),u(Oe.$$.fragment,e),Ks=d(e),Ft=i(e,"P",{});var uf=f(Ft);el=o(uf,"Models can also be trained natively in TensorFlow using the Keras API. First, let\u2019s define our model:"),uf.forEach(t),Gs=d(e),u(Le.$$.fragment,e),Us=d(e),D=i(e,"P",{});var Qt=f(D);tl=o(Qt,"Then we will need to convert our datasets from before in standard "),qa=i(Qt,"CODE",{});var cf=f(qa);al=o(cf,"tf.data.Dataset"),cf.forEach(t),sl=o(Qt,`. Since we have fixed shapes,
...
format:`),Qt.forEach(t),Ys=d(e),u(We.$$.fragment,e),Js=d(e),te=i(e,"P",{});var Br=f(te);nl=o(Br,"Then we convert everything in big tensors and use the "),za=i(Br,"CODE",{});var wf=f(za);ll=o(wf,"tf.data.Dataset.from_tensor_slices"),wf.forEach(t),il=o(Br," method:"),Br.forEach(t),Rs=d(e),u(Be.$$.fragment,e),Xs=d(e),Ct=i(e,"P",{});var vf=f(Ct);fl=o(vf,"With this done, the model can then be compiled and trained as any Keras model:"),vf.forEach(t),Zs=d(e),u(He.$$.fragment,e),Qs=d(e),Dt=i(e,"P",{});var yf=f(Dt);pl=o(yf,`With the tight interoperability between TensorFlow and PyTorch models, you can even save the model and then reload it
as a PyTorch model (or vice-versa):`),yf.forEach(t),Vs=d(e),u(Ke.$$.fragment,e),er=d(e),St=i(e,"A",{id:!0}),f(St).forEach(t),tr=d(e),W=i(e,"H2",{class:!0});var Hr=f(W);ae=i(Hr,"A",{id:!0,class:!0,href:!0});var bf=f(ae);Fa=i(bf,"SPAN",{});var $f=f(Fa);u(Ge.$$.fragment,$f),$f.forEach(t),bf.forEach(t),dl=d(Hr),Ca=i(Hr,"SPAN",{});var gf=f(Ca);ml=o(gf,"Fine-tuning in native PyTorch"),gf.forEach(t),Hr.forEach(t),ar=d(e),u(Ue.$$.fragment,e),sr=d(e),It=i(e,"P",{});var kf=f(It);hl=o(kf,"You might need to restart your notebook at this stage to free some memory, or execute the following code:"),kf.forEach(t),rr=d(e),u(Ye.$$.fragment,e),or=d(e),S=i(e,"P",{});var Vt=f(S);ul=o(Vt,"Let\u2019s now see how to achieve the same results as in "),Mt=i(Vt,"A",{href:!0});var Ef=f(Mt);cl=o(Ef,"trainer section"),Ef.forEach(t),_l=o(Vt,` in PyTorch. First we need to
define the dataloaders, which we will use to iterate over batches. We just need to apply a bit of post-processing to
our `),Da=i(Vt,"CODE",{});var Tf=f(Da);wl=o(Tf,"tokenized_datasets"),Tf.forEach(t),vl=o(Vt," before doing that to:"),Vt.forEach(t),nr=d(e),I=i(e,"UL",{});var ea=f(I);Je=i(ea,"LI",{});var Kr=f(Je);yl=o(Kr,"remove the columns corresponding to values the model does not expect (here the "),Sa=i(Kr,"CODE",{});var jf=f(Sa);bl=o(jf,'"text"'),jf.forEach(t),$l=o(Kr," column)"),Kr.forEach(t),gl=d(ea),q=i(ea,"LI",{});var ce=f(q);kl=o(ce,"rename the column "),Ia=i(ce,"CODE",{});var Af=f(Ia);El=o(Af,'"label"'),Af.forEach(t),Tl=o(ce," to "),Ma=i(ce,"CODE",{});var Pf=f(Ma);jl=o(Pf,'"labels"'),Pf.forEach(t),Al=o(ce," (because the model expect the argument to be named "),Na=i(ce,"CODE",{});var qf=f(Na);Pl=o(qf,"labels"),qf.forEach(t),ql=o(ce,")"),ce.forEach(t),xl=d(ea),Oa=i(ea,"LI",{});var xf=f(Oa);zl=o(xf,"set the format of the datasets so they return PyTorch Tensors instead of lists."),xf.forEach(t),ea.forEach(t),lr=d(e),se=i(e,"P",{});var Gr=f(se);Fl=o(Gr,"Our "),La=i(Gr,"EM",{});var zf=f(La);Cl=o(zf,"tokenized_datasets"),zf.forEach(t),Dl=o(Gr," has one method for each of those steps:"),Gr.forEach(t),ir=d(e),u(Re.$$.fragment,e),fr=d(e),Nt=i(e,"P",{});var Ff=f(Nt);Sl=o(Ff,"Now that this is done, we can easily define our dataloaders:"),Ff.forEach(t),pr=d(e),u(Xe.$$.fragment,e),dr=d(e),Ot=i(e,"P",{});var Cf=f(Ot);Il=o(Cf,"Next, we define our model:"),Cf.forEach(t),mr=d(e),u(Ze.$$.fragment,e),hr=d(e),M=i(e,"P",{});var ta=f(M);Ml=o(ta,`We are almost ready to write our training loop, the only two things are missing are an optimizer and a learning rate
scheduler. The default optimizer used by the `),Lt=i(ta,"A",{href:!0});var Df=f(Lt);Nl=o(Df,"Trainer"),Df.forEach(t),Ol=o(ta," is "),Wt=i(ta,"A",{href:!0});var Sf=f(Wt);Ll=o(Sf,"AdamW"),Sf.forEach(t),Wl=o(ta,":"),ta.forEach(t),ur=d(e),u(Qe.$$.fragment,e),cr=d(e),Bt=i(e,"P",{});var If=f(Bt);Bl=o(If,"Finally, the learning rate scheduler used by default is just a linear decay from the maximum value (5e-5 here) to 0:"),If.forEach(t),_r=d(e),u(Ve.$$.fragment,e),wr=d(e),re=i(e,"P",{});var Ur=f(re);Hl=o(Ur,`One last thing, we will want to use the GPU if we have access to one (otherwise training might take several hours
instead of a couple of minutes). To do this, we define a `),Wa=i(Ur,"CODE",{});var Mf=f(Wa);Kl=o(Mf,"device"),Mf.forEach(t),Gl=o(Ur," we will put our model and our batches on."),Ur.forEach(t),vr=d(e),u(et.$$.fragment,e),yr=d(e),oe=i(e,"P",{});var Yr=f(oe);Ul=o(Yr,`We now are ready to train! To get some sense of when it will be finished, we add a progress bar over our number of
training steps, using the `),Ba=i(Yr,"EM",{});var Nf=f(Ba);Yl=o(Nf,"tqdm"),Nf.forEach(t),Jl=o(Yr," library."),Yr.forEach(t),br=d(e),u(tt.$$.fragment,e),$r=d(e),Ht=i(e,"P",{});var Of=f(Ht);Rl=o(Of,`Note that if you are used to freezing the body of your pretrained model (like in computer vision) the above may seem a
bit strange, as we are directly fine-tuning the whole model without taking any precaution. It actually works better
this way for Transformers model (so this is not an oversight on our side). If you\u2019re not familiar with what \u201Cfreezing
the body\u201D of the model means, forget you read this paragraph.`),Of.forEach(t),gr=d(e),ne=i(e,"P",{});var Jr=f(ne);Xl=o(Jr,"Now to check the results, we need to write the evaluation loop. Like in the "),Kt=i(Jr,"A",{href:!0});var Lf=f(Kt);Zl=o(Lf,"trainer section"),Lf.forEach(t),Ql=o(Jr,` we will
use a metric from the datasets library. Here we accumulate the predictions at each batch before computing the final
result when the loop is finished.`),Jr.forEach(t),kr=d(e),u(at.$$.fragment,e),Er=d(e),Gt=i(e,"A",{id:!0}),f(Gt).forEach(t),Tr=d(e),B=i(e,"H2",{class:!0});var Rr=f(B);le=i(Rr,"A",{id:!0,class:!0,href:!0});var Wf=f(le);Ha=i(Wf,"SPAN",{});var Bf=f(Ha);u(st.$$.fragment,Bf),Bf.forEach(t),Wf.forEach(t),Vl=d(Rr),Ka=i(Rr,"SPAN",{});var Hf=f(Ka);ei=o(Hf,"Additional resources"),Hf.forEach(t),Rr.forEach(t),jr=d(e),Ut=i(e,"P",{});var Kf=f(Ut);ti=o(Kf,"To look at more fine-tuning examples you can refer to:"),Kf.forEach(t),Ar=d(e),ie=i(e,"UL",{});var Xr=f(ie);Ga=i(Xr,"LI",{});var Gf=f(Ga);Yt=i(Gf,"P",{});var fi=f(Yt);rt=i(fi,"A",{href:!0,rel:!0});var Uf=f(rt);ai=o(Uf,"\u{1F917} Transformers Examples"),Uf.forEach(t),si=o(fi,` which includes scripts
to train on all common NLP tasks in PyTorch and TensorFlow.`),fi.forEach(t),Gf.forEach(t),ri=d(Xr),Ua=i(Xr,"LI",{});var Yf=f(Ua);fe=i(Yf,"P",{});var Ja=f(fe);Jt=i(Ja,"A",{href:!0});var Jf=f(Jt);oi=o(Jf,"\u{1F917} Transformers Notebooks"),Jf.forEach(t),ni=o(Ja,` which contains various notebooks and in particular one per task (look for
the `),Ya=i(Ja,"EM",{});var Rf=f(Ya);li=o(Rf,"how to finetune a model on xxx"),Rf.forEach(t),ii=o(Ja,")."),Ja.forEach(t),Yf.forEach(t),Xr.forEach(t),this.h()},h(){m(x,"name","hf:doc:metadata"),m(x,"content",JSON.stringify(sp)),m(P,"id","finetuning-a-pretrained-model"),m(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(P,"href","#finetuning-a-pretrained-model"),m(g,"class","relative group"),m(nt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m(ve,"href","https://www.imdb.com/interfaces/"),m(ve,"rel","nofollow"),m(lt,"href","#additional-resources"),m(it,"id","data-processing"),m(H,"id","preparing-the-datasets"),m(H,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(H,"href","#preparing-the-datasets"),m(N,"class","relative group"),m($e,"href","https://github.com/huggingface/datasets/"),m($e,"rel","nofollow"),m(ge,"href","https://huggingface.co/docs/datasets/"),m(ge,"rel","nofollow"),m(ft,"href","preprocessing"),m(dt,"href","preprocessing"),m(Ae,"href","https://huggingface.co/docs/datasets/"),m(Ae,"rel","nofollow"),m(ut,"id","trainer"),m(J,"id","finetuning-in-pytorch-with-the-trainer-api"),m(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(J,"href","#finetuning-in-pytorch-with-the-trainer-api"),m(O,"class","relative group"),m(ct,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m(vt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m(yt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.TrainingArguments"),m(bt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m($t,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m(kt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m(Et,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m(Tt,"href","/docs/transformers/v4.14.1/en/internal/trainer_utils#transformers.EvalPrediction"),m(At,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m(xt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.TrainingArguments"),m(zt,"id","keras"),m(ee,"id","finetuning-with-keras"),m(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ee,"href","#finetuning-with-keras"),m(L,"class","relative group"),m(St,"id","pytorch_native"),m(ae,"id","finetuning-in-native-pytorch"),m(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ae,"href","#finetuning-in-native-pytorch"),m(W,"class","relative group"),m(Mt,"href","#trainer"),m(Lt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),m(Wt,"href","/docs/transformers/v4.14.1/en/main_classes/optimizer_schedules#transformers.AdamW"),m(Kt,"href","#trainer"),m(Gt,"id","additional-resources"),m(le,"id","additional-resources"),m(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(le,"href","#additional-resources"),m(B,"class","relative group"),m(rt,"href","https://github.com/huggingface/transformers/tree/master/examples"),m(rt,"rel","nofollow"),m(Jt,"href","notebooks")},m(e,s){a(document.head,x),n(e,ot,s),n(e,g,s),a(g,P),a(P,sa),c(_e,sa,null),a(g,Vr),a(g,ra),a(ra,eo),n(e,Ra,s),c(we,e,s),n(e,Xa,s),n(e,z,s),a(z,to),a(z,oa),a(oa,ao),a(z,so),a(z,nt),a(nt,ro),a(z,oo),n(e,Za,s),n(e,F,s),a(F,no),a(F,ve),a(ve,lo),a(F,io),a(F,lt),a(lt,fo),a(F,po),n(e,Qa,s),n(e,it,s),n(e,Va,s),n(e,N,s),a(N,H),a(H,na),c(ye,na,null),a(N,mo),a(N,la),a(la,ho),n(e,es,s),c(be,e,s),n(e,ts,s),n(e,k,s),a(k,uo),a(k,$e),a($e,co),a(k,_o),a(k,ge),a(ge,wo),a(k,vo),a(k,ft),a(ft,yo),a(k,bo),n(e,as,s),n(e,K,s),a(K,$o),a(K,ia),a(ia,go),a(K,ko),n(e,ss,s),c(ke,e,s),n(e,rs,s),n(e,C,s),a(C,Eo),a(C,fa),a(fa,To),a(C,jo),a(C,pa),a(pa,Ao),a(C,Po),n(e,os,s),n(e,b,s),a(b,qo),a(b,da),a(da,xo),a(b,zo),a(b,ma),a(ma,Fo),a(b,Co),a(b,ha),a(ha,Do),a(b,So),a(b,ua),a(ua,Io),a(b,Mo),a(b,ca),a(ca,No),a(b,Oo),a(b,_a),a(_a,Lo),a(b,Wo),n(e,ns,s),n(e,pt,s),a(pt,Bo),n(e,ls,s),c(Ee,e,s),n(e,is,s),n(e,G,s),a(G,Ho),a(G,dt),a(dt,Ko),a(G,Go),n(e,fs,s),c(Te,e,s),n(e,ps,s),n(e,mt,s),a(mt,Uo),n(e,ds,s),n(e,U,s),a(U,Yo),a(U,wa),a(wa,Jo),a(U,Ro),n(e,ms,s),c(je,e,s),n(e,hs,s),n(e,Y,s),a(Y,Xo),a(Y,Ae),a(Ae,Zo),a(Y,Qo),n(e,us,s),n(e,ht,s),a(ht,Vo),n(e,cs,s),c(Pe,e,s),n(e,_s,s),n(e,E,s),a(E,en),a(E,va),a(va,tn),a(E,an),a(E,ya),a(ya,sn),a(E,rn),a(E,ba),a(ba,on),a(E,nn),n(e,ws,s),n(e,ut,s),n(e,vs,s),n(e,O,s),a(O,J),a(J,$a),c(qe,$a,null),a(O,ln),a(O,ga),a(ga,fn),n(e,ys,s),c(xe,e,s),n(e,bs,s),n(e,R,s),a(R,pn),a(R,ct),a(ct,dn),a(R,mn),n(e,$s,s),n(e,_t,s),a(_t,hn),n(e,gs,s),c(ze,e,s),n(e,ks,s),n(e,wt,s),a(wt,un),n(e,Es,s),n(e,T,s),a(T,cn),a(T,vt),a(vt,_n),a(T,wn),a(T,yt),a(yt,vn),a(T,yn),a(T,bt),a(bt,bn),a(T,$n),n(e,Ts,s),c(Fe,e,s),n(e,js,s),n(e,X,s),a(X,gn),a(X,$t),a($t,kn),a(X,En),n(e,As,s),c(Ce,e,s),n(e,Ps,s),n(e,gt,s),a(gt,Tn),n(e,qs,s),c(De,e,s),n(e,xs,s),n(e,Z,s),a(Z,jn),a(Z,kt),a(kt,An),a(Z,Pn),n(e,zs,s),n(e,j,s),a(j,qn),a(j,Et),a(Et,xn),a(j,zn),a(j,ka),a(ka,Fn),a(j,Cn),a(j,Tt),a(Tt,Dn),a(j,Sn),n(e,Fs,s),n(e,A,s),a(A,In),a(A,Ea),a(Ea,Mn),a(A,Nn),a(A,Ta),a(Ta,On),a(A,Ln),a(A,ja),a(ja,Wn),a(A,Bn),n(e,Cs,s),c(Se,e,s),n(e,Ds,s),n(e,jt,s),a(jt,Hn),n(e,Ss,s),n(e,Q,s),a(Q,Kn),a(Q,At),a(At,Gn),a(Q,Un),n(e,Is,s),c(Ie,e,s),n(e,Ms,s),n(e,Pt,s),a(Pt,Yn),n(e,Ns,s),n(e,qt,s),a(qt,Jn),n(e,Os,s),c(Me,e,s),n(e,Ls,s),n(e,V,s),a(V,Rn),a(V,xt),a(xt,Xn),a(V,Zn),n(e,Ws,s),n(e,zt,s),n(e,Bs,s),n(e,L,s),a(L,ee),a(ee,Aa),c(Ne,Aa,null),a(L,Qn),a(L,Pa),a(Pa,Vn),n(e,Hs,s),c(Oe,e,s),n(e,Ks,s),n(e,Ft,s),a(Ft,el),n(e,Gs,s),c(Le,e,s),n(e,Us,s),n(e,D,s),a(D,tl),a(D,qa),a(qa,al),a(D,sl),a(D,xa),a(xa,rl),a(D,ol),n(e,Ys,s),c(We,e,s),n(e,Js,s),n(e,te,s),a(te,nl),a(te,za),a(za,ll),a(te,il),n(e,Rs,s),c(Be,e,s),n(e,Xs,s),n(e,Ct,s),a(Ct,fl),n(e,Zs,s),c(He,e,s),n(e,Qs,s),n(e,Dt,s),a(Dt,pl),n(e,Vs,s),c(Ke,e,s),n(e,er,s),n(e,St,s),n(e,tr,s),n(e,W,s),a(W,ae),a(ae,Fa),c(Ge,Fa,null),a(W,dl),a(W,Ca),a(Ca,ml),n(e,ar,s),c(Ue,e,s),n(e,sr,s),n(e,It,s),a(It,hl),n(e,rr,s),c(Ye,e,s),n(e,or,s),n(e,S,s),a(S,ul),a(S,Mt),a(Mt,cl),a(S,_l),a(S,Da),a(Da,wl),a(S,vl),n(e,nr,s),n(e,I,s),a(I,Je),a(Je,yl),a(Je,Sa),a(Sa,bl),a(Je,$l),a(I,gl),a(I,q),a(q,kl),a(q,Ia),a(Ia,El),a(q,Tl),a(q,Ma),a(Ma,jl),a(q,Al),a(q,Na),a(Na,Pl),a(q,ql),a(I,xl),a(I,Oa),a(Oa,zl),n(e,lr,s),n(e,se,s),a(se,Fl),a(se,La),a(La,Cl),a(se,Dl),n(e,ir,s),c(Re,e,s),n(e,fr,s),n(e,Nt,s),a(Nt,Sl),n(e,pr,s),c(Xe,e,s),n(e,dr,s),n(e,Ot,s),a(Ot,Il),n(e,mr,s),c(Ze,e,s),n(e,hr,s),n(e,M,s),a(M,Ml),a(M,Lt),a(Lt,Nl),a(M,Ol),a(M,Wt),a(Wt,Ll),a(M,Wl),n(e,ur,s),c(Qe,e,s),n(e,cr,s),n(e,Bt,s),a(Bt,Bl),n(e,_r,s),c(Ve,e,s),n(e,wr,s),n(e,re,s),a(re,Hl),a(re,Wa),a(Wa,Kl),a(re,Gl),n(e,vr,s),c(et,e,s),n(e,yr,s),n(e,oe,s),a(oe,Ul),a(oe,Ba),a(Ba,Yl),a(oe,Jl),n(e,br,s),c(tt,e,s),n(e,$r,s),n(e,Ht,s),a(Ht,Rl),n(e,gr,s),n(e,ne,s),a(ne,Xl),a(ne,Kt),a(Kt,Zl),a(ne,Ql),n(e,kr,s),c(at,e,s),n(e,Er,s),n(e,Gt,s),n(e,Tr,s),n(e,B,s),a(B,le),a(le,Ha),c(st,Ha,null),a(B,Vl),a(B,Ka),a(Ka,ei),n(e,jr,s),n(e,Ut,s),a(Ut,ti),n(e,Ar,s),n(e,ie,s),a(ie,Ga),a(Ga,Yt),a(Yt,rt),a(rt,ai),a(Yt,si),a(ie,ri),a(ie,Ua),a(Ua,fe),a(fe,Jt),a(Jt,oi),a(fe,ni),a(fe,Ya),a(Ya,li),a(fe,ii),Pr=!0},p:ep,i(e){Pr||(_(_e.$$.fragment,e),_(we.$$.fragment,e),_(ye.$$.fragment,e),_(be.$$.fragment,e),_(ke.$$.fragment,e),_(Ee.$$.fragment,e),_(Te.$$.fragment,e),_(je.$$.fragment,e),_(Pe.$$.fragment,e),_(qe.$$.fragment,e),_(xe.$$.fragment,e),_(ze.$$.fragment,e),_(Fe.$$.fragment,e),_(Ce.$$.fragment,e),_(De.$$.fragment,e),_(Se.$$.fragment,e),_(Ie.$$.fragment,e),_(Me.$$.fragment,e),_(Ne.$$.fragment,e),_(Oe.$$.fragment,e),_(Le.$$.fragment,e),_(We.$$.fragment,e),_(Be.$$.fragment,e),_(He.$$.fragment,e),_(Ke.$$.fragment,e),_(Ge.$$.fragment,e),_(Ue.$$.fragment,e),_(Ye.$$.fragment,e),_(Re.$$.fragment,e),_(Xe.$$.fragment,e),_(Ze.$$.fragment,e),_(Qe.$$.fragment,e),_(Ve.$$.fragment,e),_(et.$$.fragment,e),_(tt.$$.fragment,e),_(at.$$.fragment,e),_(st.$$.fragment,e),Pr=!0)},o(e){w(_e.$$.fragment,e),w(we.$$.fragment,e),w(ye.$$.fragment,e),w(be.$$.fragment,e),w(ke.$$.fragment,e),w(Ee.$$.fragment,e),w(Te.$$.fragment,e),w(je.$$.fragment,e),w(Pe.$$.fragment,e),w(qe.$$.fragment,e),w(xe.$$.fragment,e),w(ze.$$.fragment,e),w(Fe.$$.fragment,e),w(Ce.$$.fragment,e),w(De.$$.fragment,e),w(Se.$$.fragment,e),w(Ie.$$.fragment,e),w(Me.$$.fragment,e),w(Ne.$$.fragment,e),w(Oe.$$.fragment,e),w(Le.$$.fragment,e),w(We.$$.fragment,e),w(Be.$$.fragment,e),w(He.$$.fragment,e),w(Ke.$$.fragment,e),w(Ge.$$.fragment,e),w(Ue.$$.fragment,e),w(Ye.$$.fragment,e),w(Re.$$.fragment,e),w(Xe.$$.fragment,e),w(Ze.$$.fragment,e),w(Qe.$$.fragment,e),w(Ve.$$.fragment,e),w(et.$$.fragment,e),w(tt.$$.fragment,e),w(at.$$.fragment,e),w(st.$$.fragment,e),Pr=!1},d(e){t(x),e&&t(ot),e&&t(g),v(_e),e&&t(Ra),v(we,e),e&&t(Xa),e&&t(z),e&&t(Za),e&&t(F),e&&t(Qa),e&&t(it),e&&t(Va),e&&t(N),v(ye),e&&t(es),v(be,e),e&&t(ts),e&&t(k),e&&t(as),e&&t(K),e&&t(ss),v(ke,e),e&&t(rs),e&&t(C),e&&t(os),e&&t(b),e&&t(ns),e&&t(pt),e&&t(ls),v(Ee,e),e&&t(is),e&&t(G),e&&t(fs),v(Te,e),e&&t(ps),e&&t(mt),e&&t(ds),e&&t(U),e&&t(ms),v(je,e),e&&t(hs),e&&t(Y),e&&t(us),e&&t(ht),e&&t(cs),v(Pe,e),e&&t(_s),e&&t(E),e&&t(ws),e&&t(ut),e&&t(vs),e&&t(O),v(qe),e&&t(ys),v(xe,e),e&&t(bs),e&&t(R),e&&t($s),e&&t(_t),e&&t(gs),v(ze,e),e&&t(ks),e&&t(wt),e&&t(Es),e&&t(T),e&&t(Ts),v(Fe,e),e&&t(js),e&&t(X),e&&t(As),v(Ce,e),e&&t(Ps),e&&t(gt),e&&t(qs),v(De,e),e&&t(xs),e&&t(Z),e&&t(zs),e&&t(j),e&&t(Fs),e&&t(A),e&&t(Cs),v(Se,e),e&&t(Ds),e&&t(jt),e&&t(Ss),e&&t(Q),e&&t(Is),v(Ie,e),e&&t(Ms),e&&t(Pt),e&&t(Ns),e&&t(qt),e&&t(Os),v(Me,e),e&&t(Ls),e&&t(V),e&&t(Ws),e&&t(zt),e&&t(Bs),e&&t(L),v(Ne),e&&t(Hs),v(Oe,e),e&&t(Ks),e&&t(Ft),e&&t(Gs),v(Le,e),e&&t(Us),e&&t(D),e&&t(Ys),v(We,e),e&&t(Js),e&&t(te),e&&t(Rs),v(Be,e),e&&t(Xs),e&&t(Ct),e&&t(Zs),v(He,e),e&&t(Qs),e&&t(Dt),e&&t(Vs),v(Ke,e),e&&t(er),e&&t(St),e&&t(tr),e&&t(W),v(Ge),e&&t(ar),v(Ue,e),e&&t(sr),e&&t(It),e&&t(rr),v(Ye,e),e&&t(or),e&&t(S),e&&t(nr),e&&t(I),e&&t(lr),e&&t(se),e&&t(ir),v(Re,e),e&&t(fr),e&&t(Nt),e&&t(pr),v(Xe,e),e&&t(dr),e&&t(Ot),e&&t(mr),v(Ze,e),e&&t(hr),e&&t(M),e&&t(ur),v(Qe,e),e&&t(cr),e&&t(Bt),e&&t(_r),v(Ve,e),e&&t(wr),e&&t(re),e&&t(vr),v(et,e),e&&t(yr),e&&t(oe),e&&t(br),v(tt,e),e&&t($r),e&&t(Ht),e&&t(gr),e&&t(ne),e&&t(kr),v(at,e),e&&t(Er),e&&t(Gt),e&&t(Tr),e&&t(B),v(st),e&&t(jr),e&&t(Ut),e&&t(Ar),e&&t(ie)}}}const sp={local:"finetuning-a-pretrained-model",sections:[{local:"preparing-the-datasets",title:"Preparing the datasets"},{local:"finetuning-in-pytorch-with-the-trainer-api",title:"Fine-tuning in PyTorch with the Trainer API"},{local:"finetuning-with-keras",title:"Fine-tuning with Keras"},{local:"finetuning-in-native-pytorch",title:"Fine-tuning in native PyTorch"},{local:"additional-resources",title:"Additional resources"}],title:"Fine-tuning a pretrained model"};function rp(Qr,x,ot){let{fw:g}=x;return Qr.$$set=P=>{"fw"in P&&ot(0,g=P.fw)},[g]}class dp extends Xf{constructor(x){super();Zf(this,x,rp,ap,Qf,{fw:0})}}export{dp as default,sp as metadata};
