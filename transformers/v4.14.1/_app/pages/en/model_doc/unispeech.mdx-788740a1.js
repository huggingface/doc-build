import{S as vi,i as bi,s as wi,e as o,k as c,w as _,t as r,L as yi,c as a,d as n,m as d,a as s,x as v,h as i,b as l,J as e,g as m,y as b,q as w,o as y,B as S}from"../../../chunks/vendor-b1433968.js";import{T as vo}from"../../../chunks/Tip-c3840994.js";import{D as L}from"../../../chunks/Docstring-ff504c58.js";import{C as Tn}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as Te}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function Si(A){let h,U,u,T,k;return{c(){h=o("p"),U=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
instance of <a href="/docs/transformers/v4.14.1/en/model_doc/unispeech#transformers.UniSpeechForCTC">UniSpeechForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.UniSpeechConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Tuple of <code>torch.FloatTensor</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}]}}),We=new Te({}),Oe=new L({props:{name:"class transformers.UniSpeechModel",anchor:"transformers.UniSpeechModel",parameters:[{name:"config",val:": UniSpeechConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/unispeech/modeling_unispeech.py#L1046",parametersDescription:[{anchor:"transformers.UniSpeechModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/unispeech#transformers.UniSpeechConfig">UniSpeechConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
weights.`,name:"config"}]}}),Be=new L({props:{name:"forward",anchor:"transformers.UniSpeechModel.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/unispeech/modeling_unispeech.py#L1110",parametersDescription:[{anchor:"transformers.UniSpeechModel.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/unispeech#transformers.models.unispeech.modeling_unispeech.UniSpeechBaseModelOutput"
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/unispeech#transformers.UniSpeechConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Re=new Te({}),Qe=new L({props:{name:"class transformers.UniSpeechForCTC",anchor:"transformers.UniSpeechForCTC",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/unispeech/modeling_unispeech.py#L1339",parametersDescription:[{anchor:"transformers.UniSpeechForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/unispeech#transformers.UniSpeechConfig">UniSpeechConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),et=new L({props:{name:"forward",anchor:"transformers.UniSpeechForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/unispeech/modeling_unispeech.py#L1365",parametersDescription:[{anchor:"transformers.UniSpeechForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechProcessor</code> should
be used for padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss`}}),nt=new Te({}),ot=new L({props:{name:"class transformers.UniSpeechForSequenceClassification",anchor:"transformers.UniSpeechForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/unispeech/modeling_unispeech.py#L1453",parametersDescription:[{anchor:"transformers.UniSpeechForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/unispeech#transformers.UniSpeechConfig">UniSpeechConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),ct=new L({props:{name:"forward",anchor:"transformers.UniSpeechForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/unispeech/modeling_unispeech.py#L1482",parametersDescription:[{anchor:"transformers.UniSpeechForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechProcessor</code> should
be used for padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss`}}),pt=new Te({}),ht=new L({props:{name:"class transformers.UniSpeechForPreTraining",anchor:"transformers.UniSpeechForPreTraining",parameters:[{name:"config",val:": UniSpeechConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/unispeech/modeling_unispeech.py#L1169",parametersDescription:[{anchor:"transformers.UniSpeechForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/unispeech#transformers.UniSpeechConfig">UniSpeechConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),vt=new L({props:{name:"forward",anchor:"transformers.UniSpeechForPreTraining.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/unispeech/modeling_unispeech.py#L1219",parametersDescription:[{anchor:"transformers.UniSpeechForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechProcessor</code> should
be used for padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See
...
<p><a href="../glossary#attention-mask">What are attention masks?</a>`,name:"attention_mask"}],returnDescription:`
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/unispeech#transformers.models.unispeech.modeling_unispeech.UniSpeechForPreTrainingOutput"
...
decoded using `),kt=o("a"),Eo=r("Wav2Vec2CTCTokenizer"),Mo=r("."),qn=c(),W=o("p"),zo=r("This model was contributed by "),Ce=o("a"),Do=r("patrickvonplaten"),Ao=r(`. The Authors\u2019 code can be
found `),xe=o("a"),Lo=r("here"),Wo=r("."),Fn=c(),Q=o("h2"),me=o("a"),Rt=o("span"),_(qe.$$.fragment),Oo=c(),Qt=o("span"),No=r("UniSpeechConfig"),Pn=c(),C=o("div"),_(Fe.$$.fragment),Vo=c(),X=o("p"),Io=r("This is the configuration class to store the configuration of a "),$t=o("a"),Ho=r("UniSpeechModel"),Ko=r(`. It is used
...
behavior.`),ja=c(),P=o("div"),_(Be.$$.fragment),Ca=c(),ne=o("p"),xa=r("The "),qt=o("a"),qa=r("UniSpeechModel"),Fa=r(" forward method, overrides the "),on=o("code"),Pa=r("__call__"),Ea=r(" special method."),Ma=c(),_(ge.$$.fragment),za=c(),an=o("p"),Da=r("Example:"),Aa=c(),_(Ye.$$.fragment),Ln=c(),oe=o("h2"),_e=o("a"),sn=o("span"),_(Re.$$.fragment),La=c(),rn=o("span"),Wa=r("UniSpeechForCTC"),Wn=c(),q=o("div"),_(Qe.$$.fragment),Oa=c(),ae=o("p"),Na=r("UniSpeech Model with a "),ln=o("em"),Va=r("language modeling"),Ia=r(` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),js=c(),M=o("div"),_(ct.$$.fragment),Cs=c(),ie=o("p"),xs=r("The "),Mt=o("a"),qs=r("UniSpeechForSequenceClassification"),Fs=r(" forward method, overrides the "),un=o("code"),Ps=r("__call__"),Es=r(" special method."),Ms=c(),_(we.$$.fragment),zs=c(),fn=o("p"),Ds=r("Example:"),As=c(),_(dt.$$.fragment),Vn=c(),le=o("h2"),ye=o("a"),gn=o("span"),_(pt.$$.fragment),Ls=c(),_n=o("span"),Ws=r("UniSpeechForPreTraining"),In=c(),F=o("div"),_(ht.$$.fragment),Os=c(),mt=o("p"),Ns=r(`UniSpeech Model with a vector-quantization module and ctc loss for pre-training.
...
decoded using `),kt=a(Qn,"A",{href:!0});var vr=s(kt);Eo=i(vr,"Wav2Vec2CTCTokenizer"),vr.forEach(n),Mo=i(Qn,"."),Qn.forEach(n),Yn.forEach(n),qn=d(t),W=a(t,"P",{});var At=s(W);zo=i(At,"This model was contributed by "),Ce=a(At,"A",{href:!0,rel:!0});var br=s(Ce);Do=i(br,"patrickvonplaten"),br.forEach(n),Ao=i(At,`. The Authors\u2019 code can be
found `),xe=a(At,"A",{href:!0,rel:!0});var wr=s(xe);Lo=i(wr,"here"),wr.forEach(n),Wo=i(At,"."),At.forEach(n),Fn=d(t),Q=a(t,"H2",{class:!0});var Xn=s(Q);me=a(Xn,"A",{id:!0,class:!0,href:!0});var yr=s(me);Rt=a(yr,"SPAN",{});var Sr=s(Rt);v(qe.$$.fragment,Sr),Sr.forEach(n),yr.forEach(n),Oo=d(Xn),Qt=a(Xn,"SPAN",{});var Tr=s(Qt);No=i(Tr,"UniSpeechConfig"),Tr.forEach(n),Xn.forEach(n),Pn=d(t),C=a(t,"DIV",{class:!0});var O=s(C);v(Fe.$$.fragment,O),Vo=d(O),X=a(O,"P",{});var Lt=s(X);Io=i(Lt,"This is the configuration class to store the configuration of a "),$t=a(Lt,"A",{href:!0});var Ur=s($t);Ho=i(Ur,"UniSpeechModel"),Ur.forEach(n),Ko=i(Lt,`. It is used
to instantiate an UniSpeech model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the UniSpeech
`),Pe=a(Lt,"A",{href:!0,rel:!0});var kr=s(Pe);Bo=i(kr,"facebook/unispeech-base-960h"),kr.forEach(n),Yo=i(Lt," architecture."),Lt.forEach(n),Ro=d(O),Z=a(O,"P",{});var Wt=s(Z);Qo=i(Wt,"Configuration objects inherit from "),jt=a(Wt,"A",{href:!0});var $r=s(jt);Xo=i($r,"PretrainedConfig"),$r.forEach(n),Zo=i(Wt,` and can be used to control the model
outputs. Read the documentation from `),Ct=a(Wt,"A",{href:!0});var jr=s(Ct);Jo=i(jr,"PretrainedConfig"),jr.forEach(n),Go=i(Wt," for more information."),Wt.forEach(n),ea=d(O),Xt=a(O,"P",{});var Cr=s(Xt);ta=i(Cr,"Example:"),Cr.forEach(n),na=d(O),v(Ee.$$.fragment,O),O.forEach(n),En=d(t),J=a(t,"H2",{class:!0});var Zn=s(J);ue=a(Zn,"A",{id:!0,class:!0,href:!0});var xr=s(ue);Zt=a(xr,"SPAN",{});var qr=s(Zt);v(Me.$$.fragment,qr),qr.forEach(n),xr.forEach(n),oa=d(Zn),Jt=a(Zn,"SPAN",{});var Fr=s(Jt);aa=i(Fr,"UniSpeech specific outputs"),Fr.forEach(n),Zn.forEach(n),Mn=d(t),G=a(t,"DIV",{class:!0});var Jn=s(G);v(ze.$$.fragment,Jn),sa=d(Jn),De=a(Jn,"P",{});var Gn=s(De);ra=i(Gn,"Output type of "),Gt=a(Gn,"CODE",{});var Pr=s(Gt);ia=i(Pr,"UniSpeechBaseModelOutput"),Pr.forEach(n),la=i(Gn,", with potential hidden states and attentions."),Gn.forEach(n),Jn.forEach(n),zn=d(t),ee=a(t,"DIV",{class:!0});var eo=s(ee);v(Ae.$$.fragment,eo),ca=d(eo),Le=a(eo,"P",{});var to=s(Le);da=i(to,"Output type of "),en=a(to,"CODE",{});var Er=s(en);pa=i(Er,"UniSpeechForPreTrainingOutput"),Er.forEach(n),ha=i(to,", with potential hidden states and attentions."),to.forEach(n),eo.forEach(n),Dn=d(t),te=a(t,"H2",{class:!0});var no=s(te);fe=a(no,"A",{id:!0,class:!0,href:!0});var Mr=s(fe);tn=a(Mr,"SPAN",{});var zr=s(tn);v(We.$$.fragment,zr),zr.forEach(n),Mr.forEach(n),ma=d(no),nn=a(no,"SPAN",{});var Dr=s(nn);ua=i(Dr,"UniSpeechModel"),Dr.forEach(n),no.forEach(n),An=d(t),x=a(t,"DIV",{class:!0});var N=s(x);v(Oe.$$.fragment,N),fa=d(N),Ne=a(N,"P",{});var oo=s(Ne);ga=i(oo,`The bare UniSpeech Model transformer outputting raw hidden-states without any specific head on top.
...
Michael Zeng, Xuedong Huang.`),oo.forEach(n),ba=d(N),Ie=a(N,"P",{});var ao=s(Ie);wa=i(ao,"This model inherits from "),xt=a(ao,"A",{href:!0});var Lr=s(xt);ya=i(Lr,"PreTrainedModel"),Lr.forEach(n),Sa=i(ao,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),ao.forEach(n),Ta=d(N),He=a(N,"P",{});var so=s(He);Ua=i(so,"This model is a PyTorch "),Ke=a(so,"A",{href:!0,rel:!0});var Wr=s(Ke);ka=i(Wr,"torch.nn.Module"),Wr.forEach(n),$a=i(so,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),so.forEach(n),ja=d(N),P=a(N,"DIV",{class:!0});var V=s(P);v(Be.$$.fragment,V),Ca=d(V),ne=a(V,"P",{});var Ot=s(ne);xa=i(Ot,"The "),qt=a(Ot,"A",{href:!0});var Or=s(qt);qa=i(Or,"UniSpeechModel"),Or.forEach(n),Fa=i(Ot," forward method, overrides the "),on=a(Ot,"CODE",{});var Nr=s(on);Pa=i(Nr,"__call__"),Nr.forEach(n),Ea=i(Ot," special method."),Ot.forEach(n),Ma=d(V),v(ge.$$.fragment,V),za=d(V),an=a(V,"P",{});var Vr=s(an);Da=i(Vr,"Example:"),Vr.forEach(n),Aa=d(V),v(Ye.$$.fragment,V),V.forEach(n),N.forEach(n),Ln=d(t),oe=a(t,"H2",{class:!0});var ro=s(oe);_e=a(ro,"A",{id:!0,class:!0,href:!0});var Ir=s(_e);sn=a(Ir,"SPAN",{});var Hr=s(sn);v(Re.$$.fragment,Hr),Hr.forEach(n),Ir.forEach(n),La=d(ro),rn=a(ro,"SPAN",{});var Kr=s(rn);Wa=i(Kr,"UniSpeechForCTC"),Kr.forEach(n),ro.forEach(n),Wn=d(t),q=a(t,"DIV",{class:!0});var I=s(q);v(Qe.$$.fragment,I),Oa=d(I),ae=a(I,"P",{});var Nt=s(ae);Na=i(Nt,"UniSpeech Model with a "),ln=a(Nt,"EM",{});var Br=s(ln);Va=i(Br,"language modeling"),Br.forEach(n),Ia=i(Nt,` head on top for Connectionist Temporal Classification (CTC).
