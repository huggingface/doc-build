...
`),f=n("code"),b=r("Module"),$=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=s(m,"CODE",{});var x=a(f);b=i(x,"Module"),x.forEach(o),$=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,h,m),e(h,y),e(h,f),e(f,b),e(h,$)},d(g){g&&o(h)}}}function Cc(F){let h,y,f,b,$;return{c(){h=n("p"),y=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=n("code"),b=r("Module"),$=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=s(m,"CODE",{});var x=a(f);b=i(x,"Module"),x.forEach(o),$=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,h,m),e(h,y),e(h,f),e(f,b),e(h,$)},d(g){g&&o(h)}}}function qc(F){let h,y,f,b,$;return{c(){h=n("p"),y=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=n("code"),b=r("Module"),$=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=s(m,"CODE",{});var x=a(f);b=i(x,"Module"),x.forEach(o),$=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,h,m),e(h,y),e(h,f),e(f,b),e(h,$)},d(g){g&&o(h)}}}function Ic(F){let h,y,f,b,$;return{c(){h=n("p"),y=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=n("code"),b=r("Module"),$=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=s(m,"CODE",{});var x=a(f);b=i(x,"Module"),x.forEach(o),$=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,h,m),e(h,y),e(h,f),e(f,b),e(h,$)},d(g){g&&o(h)}}}function Lc(F){let h,y,f,b,$;return{c(){h=n("p"),y=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=n("code"),b=r("Module"),$=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=s(m,"CODE",{});var x=a(f);b=i(x,"Module"),x.forEach(o),$=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,h,m),e(h,y),e(h,f),e(f,b),e(h,$)},d(g){g&&o(h)}}}function Sc(F){let h,y,f,b,$;return{c(){h=n("p"),y=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=n("code"),b=r("Module"),$=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(g){h=s(g,"P",{});var m=a(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=s(m,"CODE",{});var x=a(f);b=i(x,"Module"),x.forEach(o),$=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/gptj#transformers.GPTJConfig"
...
`),So=n("code"),da=r("<|extratoken_1|>... <|extratoken_143|>"),ca=r(", so the "),No=n("code"),pa=r("vocab_size"),ha=r(" of tokenizer also becomes 50400."),Xn=d(),ce=n("h3"),je=n("a"),Do=n("span"),_(st.$$.fragment),ua=d(),Bo=n("span"),fa=r("Generation"),Yn=d(),Je=n("p"),ma=r("The "),co=n("a"),ga=r("generate()"),_a=r(` method can be used to generate text using GPT-J
...
`),fo=n("a"),Ja=r("PretrainedConfig"),Ma=r(" for more information."),Fa=d(),Uo=n("p"),za=r("Example:"),Ea=d(),_(ct.$$.fragment),ss=d(),he=n("h2"),Fe=n("a"),Qo=n("span"),_(pt.$$.fragment),Aa=d(),Ho=n("span"),Ca=r("GPTJModel"),as=d(),V=n("div"),_(ht.$$.fragment),qa=d(),ut=n("p"),Ia=r(`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
...
SQuAD (a linear layers on top of the hidden-states output to compute `),fn=n("em"),ti=r("span start logits"),oi=r(" and "),mn=n("em"),ni=r("span end logits"),si=r(")."),ai=d(),zt=n("p"),ri=r("This model is a PyTorch "),Et=n("a"),ii=r("torch.nn.Module"),li=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),di=d(),A=n("div"),_(At.$$.fragment),ci=d(),Pe=n("p"),pi=r("The "),Po=n("a"),hi=r("GPTJForQuestionAnswering"),ui=r(" forward method, overrides the "),gn=n("code"),fi=r("__call__"),mi=r(" special method."),gi=d(),_(Le.$$.fragment),_i=d(),_n=n("p"),Ti=r("Example:"),vi=d(),_(Ct.$$.fragment),hs=d(),ke=n("h2"),Se=n("a"),Tn=n("span"),_(qt.$$.fragment),Pi=d(),vn=n("span"),ki=r("FlaxGPTJModel"),us=d(),G=n("div"),_(It.$$.fragment),wi=d(),Pn=n("p"),bi=r("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),yi=d(),Lt=n("p"),$i=r("This model inherits from "),ko=n("a"),xi=r("FlaxPreTrainedModel"),Gi=r(`. Check the superclass documentation for the
...
embeddings).`),mc.forEach(o),nl=c(S),Vt=s(S,"P",{});var As=a(Vt);sl=i(As,"This model inherits from "),wo=s(As,"A",{href:!0});var gc=a(wo);al=i(gc,"FlaxPreTrainedModel"),gc.forEach(o),rl=i(As,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
