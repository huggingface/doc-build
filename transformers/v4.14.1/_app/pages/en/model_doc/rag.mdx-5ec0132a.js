import{S as eT,i as tT,s as oT,e as r,k as c,w as v,t,L as nT,c as s,d as n,m as l,a,x as b,h as o,b as i,J as e,g as _,y as T,q as w,o as k,B as q}from"../../../chunks/vendor-b1433968.js";import{T as ge}from"../../../chunks/Tip-c3840994.js";import{D as G}from"../../../chunks/Docstring-ff504c58.js";import{C as rn}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as _e}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function rT($){let h,y,u,f,x;return{c(){h=r("p"),y=t(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(g){h=s(g,"P",{});var p=a(h);y=o(p,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(p,"CODE",{});var R=a(u);f=o(R,"Module"),R.forEach(n),x=o(p,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),p.forEach(n)},m(g,p){_(g,h,p),e(h,y),e(h,u),e(u,f),e(h,x)},d(g){g&&n(h)}}}function _T($){let h,y,u,f,x,g,p,R,Zd,La,$e,tt,Rr,Ct,ei,Fr,ti,Ia,sn,oi,Oa,ot,ni,St,ri,si,Wa,an,ai,Ha,dn,zr,di,Ba,nt,ii,Dt,ci,li,Qa,Ee,rt,$r,Lt,hi,Er,pi,Va,de,It,ui,me,cn,mi,gi,Mr,_i,fi,ln,vi,bi,hn,Ti,wi,ki,st,Ot,qi,Wt,yi,pn,xi,Ri,Fi,at,Ht,zi,Bt,$i,un,Ei,Mi,Ua,Me,dt,Gr,Qt,Gi,Ar,Ai,Ka,Vt,it,Ut,ji,jr,Ni,Ya,Ge,ct,Nr,Kt,Pi,Pr,Ci,Ja,Ae,Yt,Si,Cr,Di,Xa,Jt,Xt,Za,je,lt,Sr,Zt,Li,Dr,Ii,ed,X,eo,Oi,Lr,Wi,Hi,Ir,Bi,Qi,to,Vi,ht,oo,Ui,Or,Ki,Yi,pt,no,Ji,Ne,Xi,Wr,Zi,ec,Hr,tc,oc,nc,ut,ro,rc,so,sc,Br,ac,dc,td,Pe,mt,Qr,ao,ic,Vr,cc,od,D,io,lc,Ce,hc,mn,pc,uc,Ur,mc,gc,_c,gt,fc,Kr,vc,bc,ie,Tc,Yr,wc,kc,gn,qc,yc,Jr,xc,Rc,_n,Fc,zc,$c,A,Ec,fn,Mc,Gc,Xr,Ac,jc,Zr,Nc,Pc,es,Cc,Sc,ts,Dc,Lc,vn,Ic,Oc,os,Wc,Hc,bn,Bc,Qc,Tn,Vc,Uc,ns,Kc,Yc,Jc,co,Xc,wn,Zc,el,tl,lo,ol,ho,nl,rl,sl,ee,po,al,Se,dl,kn,il,cl,rs,ll,hl,pl,_t,ul,ss,ml,gl,uo,nd,De,ft,as,mo,_l,ds,fl,rd,E,go,vl,Le,bl,qn,Tl,wl,is,kl,ql,yl,vt,xl,cs,Rl,Fl,ls,zl,$l,ce,El,hs,Ml,Gl,yn,Al,jl,ps,Nl,Pl,xn,Cl,Sl,Dl,j,Ll,Rn,Il,Ol,us,Wl,Hl,ms,Bl,Ql,gs,Vl,Ul,_s,Kl,Yl,Fn,Jl,Xl,fs,Zl,eh,zn,th,oh,$n,nh,rh,vs,sh,ah,dh,_o,ih,En,ch,lh,hh,fo,ph,vo,uh,mh,gh,te,bo,_h,Ie,fh,Mn,vh,bh,bs,Th,wh,kh,bt,qh,Ts,yh,xh,To,Rh,Tt,wo,Fh,ko,zh,Gn,$h,Eh,sd,Oe,wt,ws,qo,Mh,ks,Gh,ad,M,yo,Ah,We,jh,An,Nh,Ph,qs,Ch,Sh,Dh,kt,Lh,ys,Ih,Oh,xs,Wh,Hh,le,Bh,Rs,Qh,Vh,jn,Uh,Kh,Fs,Yh,Jh,Nn,Xh,Zh,ep,N,tp,Pn,op,np,zs,rp,sp,$s,ap,dp,Es,ip,cp,Ms,lp,hp,Cn,pp,up,Gs,mp,gp,Sn,_p,fp,Dn,vp,bp,As,Tp,wp,kp,xo,qp,Ln,yp,xp,Rp,Ro,Fp,Fo,zp,$p,Ep,oe,zo,Mp,He,Gp,In,Ap,jp,js,Np,Pp,Cp,qt,Sp,Ns,Dp,Lp,$o,Ip,yt,Eo,Op,Ps,Wp,dd,Be,xt,Cs,Mo,Hp,Ss,Bp,id,P,Go,Qp,Qe,Vp,On,Up,Kp,Ds,Yp,Jp,Xp,Rt,Zp,Ls,eu,tu,he,ou,Is,nu,ru,Wn,su,au,Os,du,iu,Hn,cu,lu,hu,L,pu,Bn,uu,mu,Ws,gu,_u,Hs,fu,vu,Bs,bu,Tu,Qs,wu,ku,Qn,qu,yu,Vs,xu,Ru,Vn,Fu,zu,Us,$u,Eu,Mu,Ao,Gu,Un,Au,ju,Nu,jo,Pu,No,Cu,Su,Du,Ks,Lu,Iu,ne,Po,Ou,Ve,Wu,Kn,Hu,Bu,Ys,Qu,Vu,Uu,Ft,Ku,Js,Yu,Ju,Co,cd,Ue,zt,Xs,So,Xu,Zs,Zu,ld,F,Do,em,Ke,tm,Yn,om,nm,ea,rm,sm,am,$t,dm,ta,im,cm,oa,lm,hm,pe,pm,na,um,mm,Jn,gm,_m,ra,fm,vm,Xn,bm,Tm,wm,I,km,Zn,qm,ym,sa,xm,Rm,aa,Fm,zm,da,$m,Em,ia,Mm,Gm,er,Am,jm,ca,Nm,Pm,tr,Cm,Sm,la,Dm,Lm,Im,Lo,Om,or,Wm,Hm,Bm,Io,Qm,Oo,Vm,Um,Km,ha,Ym,Jm,re,Wo,Xm,Ye,Zm,nr,eg,tg,pa,og,ng,rg,Et,sg,ua,ag,dg,Ho,ig,Mt,Bo,cg,Qo,lg,rr,hg,pg,hd,Je,Gt,ma,Vo,ug,ga,mg,pd,z,Uo,gg,Xe,_g,sr,fg,vg,_a,bg,Tg,wg,At,kg,fa,qg,yg,va,xg,Rg,ue,Fg,ba,zg,$g,ar,Eg,Mg,Ta,Gg,Ag,dr,jg,Ng,Pg,O,Cg,ir,Sg,Dg,wa,Lg,Ig,ka,Og,Wg,qa,Hg,Bg,ya,Qg,Vg,cr,Ug,Kg,xa,Yg,Jg,lr,Xg,Zg,Ra,e_,t_,o_,Ko,n_,hr,r_,s_,a_,Yo,d_,Jo,i_,c_,l_,Fa,h_,p_,se,Xo,u_,Ze,m_,pr,g_,__,za,f_,v_,b_,jt,T_,$a,w_,k_,Zo,q_,Nt,en,y_,Ea,x_,ud;return g=new _e({}),Ct=new _e({}),Lt=new _e({}),It=new G({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/rag/configuration_rag.py#L84",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
`}}),Ht=new G({props:{name:"to\\_dict",anchor:"transformers.RagConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/rag/configuration_rag.py#L185",returnDescription:`
...
`,returnType:`
<p><code>tf.Tensor</code> of shape <code>(batch_size * num_return_sequences, sequence_length)</code></p>
`}}),{c(){h=r("meta"),y=c(),u=r("h1"),f=r("a"),x=r("span"),v(g.$$.fragment),p=c(),R=r("span"),Zd=t("RAG"),La=c(),$e=r("h2"),tt=r("a"),Rr=r("span"),v(Ct.$$.fragment),ei=c(),Fr=r("span"),ti=t("Overview"),Ia=c(),sn=r("p"),oi=t(`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
...
parametric-only seq2seq baseline.`),Ba=c(),nt=r("p"),ii=t("This model was contributed by "),Dt=r("a"),ci=t("ola13"),li=t("."),Qa=c(),Ee=r("h2"),rt=r("a"),$r=r("span"),v(Lt.$$.fragment),hi=c(),Er=r("span"),pi=t("RagConfig"),Va=c(),de=r("div"),v(It.$$.fragment),ui=c(),me=r("p"),cn=r("a"),mi=t("RagConfig"),gi=t(" stores the configuration of a "),Mr=r("em"),_i=t("RagModel"),fi=t(`. Configuration objects inherit from
...
the generator.`),tu=c(),he=r("p"),ou=t("The question encoder can be any "),Is=r("em"),nu=t("autoencoding"),ru=t(" model, preferably "),Wn=r("a"),su=t("TFDPRQuestionEncoder"),au=t(`, and
the generator can be any `),Os=r("em"),du=t("seq2seq"),iu=t(" model, preferably "),Hn=r("a"),cu=t("TFBartForConditionalGeneration"),lu=t("."),hu=c(),L=r("p"),pu=t("The model can be initialized with a "),Bn=r("a"),uu=t("RagRetriever"),mu=t(` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
...
the generator can be any `),ra=r("em"),fm=t("seq2seq"),vm=t(" model, preferably "),Xn=r("a"),bm=t("TFBartForConditionalGeneration"),Tm=t("."),wm=c(),I=r("p"),km=t("The model can be initialized with a "),Zn=r("a"),qm=t("RagRetriever"),ym=t(` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
...
and `),tr=r("a"),Cm=t("TFBartForConditionalGeneration"),Sm=t(" as the "),la=r("code"),Dm=t("generator"),Lm=t("."),Im=c(),Lo=r("p"),Om=t("This model inherits from "),or=r("a"),Wm=t("TFPreTrainedModel"),Hm=t(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Bm=c(),Io=r("p"),Qm=t("This model is also a Tensorflow "),Oo=r("a"),Vm=t("tf.keras.Model"),Um=t(`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
compatible any `),us=s(B,"EM",{});var If=a(us);Wl=o(If,"autoencoding"),If.forEach(n),Hl=o(B," model as the "),ms=s(B,"CODE",{});var Of=a(ms);Bl=o(Of,"question_encoder"),Of.forEach(n),Ql=o(B," and any "),gs=s(B,"EM",{});var Wf=a(gs);Vl=o(Wf,"seq2seq"),Wf.forEach(n),Ul=o(B,` model with language model head as
...
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Bd.forEach(n),Bm=l(C),Io=s(C,"P",{});var Qd=a(Io);Qm=o(Qd,"This model is also a Tensorflow "),Oo=s(Qd,"A",{href:!0,rel:!0});var wb=a(Oo);Vm=o(wb,"tf.keras.Model"),wb.forEach(n),Um=o(Qd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
