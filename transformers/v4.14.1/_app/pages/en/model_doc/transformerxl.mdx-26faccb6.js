import{S as wf,i as yf,s as Lf,e as n,k as l,w as b,t as r,L as kf,c as s,d as t,m as d,a,x as w,h as i,b as c,J as e,g as h,y,q as L,o as k,B as $}from"../../../chunks/vendor-b1433968.js";import{T as xt}from"../../../chunks/Tip-c3840994.js";import{D as de}from"../../../chunks/Docstring-ff504c58.js";import{C as Rt}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as Ge}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function $f(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
`),q=s(te,"CODE",{});var Ve=a(q);Xe=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),te.forEach(t),P.forEach(t)},m(f,M){h(f,m,M),e(m,x),h(f,u,M),h(f,g,M),e(g,v),e(v,T),e(g,_),e(g,E),e(E,we),h(f,Q,M),h(f,X,M),e(X,Y),e(X,A),e(A,Z),e(X,ye),e(X,D),e(D,Le),e(X,ue),h(f,I,M),h(f,S,M),e(S,ee),h(f,ne,M),h(f,F,M),e(F,C),e(C,se),e(C,U),e(U,ge),e(C,ae),e(C,W),e(W,ke),e(F,_e),e(F,z),e(z,$e),e(z,B),e(B,J),e(z,ce),e(z,R),e(R,xe),e(F,fe),e(F,O),e(O,Te),e(O,q),e(q,Xe)},d(f){f&&t(m),f&&t(u),f&&t(g),f&&t(Q),f&&t(X),f&&t(I),f&&t(S),f&&t(ne),f&&t(F)}}}function Ef(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=n("code"),g=r("Module"),v=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(_,"CODE",{});var E=a(u);g=i(E,"Module"),E.forEach(t),v=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function Ff(V){let m,x,u,g,v,T,_,E,we,Q,X,Y,A,Z,ye,D,Le,ue,I,S,ee,ne,F,C,se,U,ge,ae,W,ke,_e,z,$e,B,J,ce,R,xe,fe,O,Te,q,Xe;return{c(){m=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),v=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=n("li"),we=r("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),X=n("p"),Y=r("This second option is useful when using "),A=n("code"),Z=r("tf.keras.Model.fit"),ye=r(` method which currently requires having all
the tensors in the first argument of the model call function: `),D=n("code"),Le=r("model(inputs)"),ue=r("."),I=l(),S=n("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),ne=l(),F=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),ge=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),ke=r("model(inputs_ids)"),_e=l(),z=n("li"),$e=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),J=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),xe=r("model([input_ids, attention_mask, token_type_ids])"),fe=l(),O=n("li"),Te=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=n("code"),Xe=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){m=s(f,"P",{});var M=a(m);x=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),u=d(f),g=s(f,"UL",{});var re=a(g);v=s(re,"LI",{});var ve=a(v);T=i(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),_=d(re),E=s(re,"LI",{});var We=a(E);we=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),re.forEach(t),Q=d(f),X=s(f,"P",{});var N=a(X);Y=i(N,"This second option is useful when using "),A=s(N,"CODE",{});var Ne=a(A);Z=i(Ne,"tf.keras.Model.fit"),Ne.forEach(t),ye=i(N,` method which currently requires having all
...
the first positional argument :`),he.forEach(t),ne=d(f),F=s(f,"UL",{});var P=a(F);C=s(P,"LI",{});var j=a(C);se=i(j,"a single Tensor with "),U=s(j,"CODE",{});var Be=a(U);ge=i(Be,"input_ids"),Be.forEach(t),ae=i(j," only and nothing else: "),W=s(j,"CODE",{});var Fe=a(W);ke=i(Fe,"model(inputs_ids)"),Fe.forEach(t),j.forEach(t),_e=d(P),z=s(P,"LI",{});var G=a(z);$e=i(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=s(G,"CODE",{});var He=a(B);J=i(He,"model([input_ids, attention_mask])"),He.forEach(t),ce=i(G," or "),R=s(G,"CODE",{});var H=a(R);xe=i(H,"model([input_ids, attention_mask, token_type_ids])"),H.forEach(t),G.forEach(t),fe=d(P),O=s(P,"LI",{});var te=a(O);Te=i(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=s(te,"CODE",{});var Ve=a(q);Xe=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),te.forEach(t),P.forEach(t)},m(f,M){h(f,m,M),e(m,x),h(f,u,M),h(f,g,M),e(g,v),e(v,T),e(g,_),e(g,E),e(E,we),h(f,Q,M),h(f,X,M),e(X,Y),e(X,A),e(A,Z),e(X,ye),e(X,D),e(D,Le),e(X,ue),h(f,I,M),h(f,S,M),e(S,ee),h(f,ne,M),h(f,F,M),e(F,C),e(C,se),e(C,U),e(U,ge),e(C,ae),e(C,W),e(W,ke),e(F,_e),e(F,z),e(z,$e),e(z,B),e(B,J),e(z,ce),e(z,R),e(R,xe),e(F,fe),e(F,O),e(O,Te),e(O,q),e(q,Xe)},d(f){f&&t(m),f&&t(u),f&&t(g),f&&t(Q),f&&t(X),f&&t(I),f&&t(S),f&&t(ne),f&&t(F)}}}function zf(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=n("code"),g=r("Module"),v=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(_,"CODE",{});var E=a(u);g=i(E,"Module"),E.forEach(t),v=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function Cf(V){let m,x,u,g,v,T,_,E,we,Q,X,Y,A,Z,ye,D,Le,ue,I,S,ee,ne,F,C,se,U,ge,ae,W,ke,_e,z,$e,B,J,ce,R,xe,fe,O,Te,q,Xe;return{c(){m=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),v=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=n("li"),we=r("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),X=n("p"),Y=r("This second option is useful when using "),A=n("code"),Z=r("tf.keras.Model.fit"),ye=r(` method which currently requires having all
the tensors in the first argument of the model call function: `),D=n("code"),Le=r("model(inputs)"),ue=r("."),I=l(),S=n("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),ne=l(),F=n("ul"),C=n("li"),se=r("a single Tensor with "),U=n("code"),ge=r("input_ids"),ae=r(" only and nothing else: "),W=n("code"),ke=r("model(inputs_ids)"),_e=l(),z=n("li"),$e=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),J=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),xe=r("model([input_ids, attention_mask, token_type_ids])"),fe=l(),O=n("li"),Te=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=n("code"),Xe=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){m=s(f,"P",{});var M=a(m);x=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),u=d(f),g=s(f,"UL",{});var re=a(g);v=s(re,"LI",{});var ve=a(v);T=i(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),_=d(re),E=s(re,"LI",{});var We=a(E);we=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),re.forEach(t),Q=d(f),X=s(f,"P",{});var N=a(X);Y=i(N,"This second option is useful when using "),A=s(N,"CODE",{});var Ne=a(A);Z=i(Ne,"tf.keras.Model.fit"),Ne.forEach(t),ye=i(N,` method which currently requires having all
...
the first positional argument :`),he.forEach(t),ne=d(f),F=s(f,"UL",{});var P=a(F);C=s(P,"LI",{});var j=a(C);se=i(j,"a single Tensor with "),U=s(j,"CODE",{});var Be=a(U);ge=i(Be,"input_ids"),Be.forEach(t),ae=i(j," only and nothing else: "),W=s(j,"CODE",{});var Fe=a(W);ke=i(Fe,"model(inputs_ids)"),Fe.forEach(t),j.forEach(t),_e=d(P),z=s(P,"LI",{});var G=a(z);$e=i(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=s(G,"CODE",{});var He=a(B);J=i(He,"model([input_ids, attention_mask])"),He.forEach(t),ce=i(G," or "),R=s(G,"CODE",{});var H=a(R);xe=i(H,"model([input_ids, attention_mask, token_type_ids])"),H.forEach(t),G.forEach(t),fe=d(P),O=s(P,"LI",{});var te=a(O);Te=i(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=s(te,"CODE",{});var Ve=a(q);Xe=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),te.forEach(t),P.forEach(t)},m(f,M){h(f,m,M),e(m,x),h(f,u,M),h(f,g,M),e(g,v),e(v,T),e(g,_),e(g,E),e(E,we),h(f,Q,M),h(f,X,M),e(X,Y),e(X,A),e(A,Z),e(X,ye),e(X,D),e(D,Le),e(X,ue),h(f,I,M),h(f,S,M),e(S,ee),h(f,ne,M),h(f,F,M),e(F,C),e(C,se),e(C,U),e(U,ge),e(C,ae),e(C,W),e(W,ke),e(F,_e),e(F,z),e(z,$e),e(z,B),e(B,J),e(z,ce),e(z,R),e(R,xe),e(F,fe),e(F,O),e(O,Te),e(O,q),e(q,Xe)},d(f){f&&t(m),f&&t(u),f&&t(g),f&&t(Q),f&&t(X),f&&t(I),f&&t(S),f&&t(ne),f&&t(F)}}}function qf(V){let m,x,u,g,v;return{c(){m=n("p"),x=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=n("code"),g=r("Module"),v=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){m=s(T,"P",{});var _=a(m);x=i(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=s(_,"CODE",{});var E=a(u);g=i(E,"Module"),E.forEach(t),v=i(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){h(T,m,_),e(m,x),e(m,u),e(u,g),e(m,v)},d(T){T&&t(m)}}}function Pf(V){let m,x,u,g,v,T,_,E,we,Q,X,Y,A,Z,ye,D,Le,ue,I,S,ee,ne,F,C,se,U,ge,ae,W,ke,_e,z,$e,B,J,ce,R,xe,fe,O,Te,q,Xe,f,M,re,ve,We,N,Ne,ie,he,P,j,Be,Fe,G,He,H,te,Ve,Ke,qa,en,Pa,ja,tn,Sa,Oa,Gt,Na,Ha,Aa,rt,Da,on,Ia,Wa,nn,Ba,Va,Ua,Cn,Ra,Ga,Kt,js,it,Xt,qn,Yt,Ka,Pn,Ya,Ss,Ae,Jt,Ja,Qt,Qa,Zt,Za,er,tr,eo,or,sn,nr,sr,ar,jn,Os,lt,Mt,Sn,to,rr,On,ir,Ns,dt,oo,lr,Nn,dr,Hs,ct,no,cr,Hn,fr,As,ft,so,hr,An,pr,Ds,ht,ao,mr,Dn,ur,Is,pt,Et,In,ro,gr,Wn,_r,Ws,Me,io,Tr,Bn,vr,br,lo,wr,an,yr,Lr,kr,co,$r,fo,xr,Xr,Mr,ze,ho,Er,mt,Fr,rn,zr,Cr,Vn,qr,Pr,jr,Ft,Sr,Un,Or,Nr,po,Bs,ut,zt,Rn,mo,Hr,Gn,Ar,Vs,Ee,uo,Dr,Kn,Ir,Wr,go,Br,ln,Vr,Ur,Rr,_o,Gr,To,Kr,Yr,Jr,Ce,vo,Qr,gt,Zr,dn,ei,ti,Yn,oi,ni,si,Ct,ai,Jn,ri,ii,bo,Us,_t,qt,Qn,wo,li,Zn,di,Rs,oe,yo,ci,es,fi,hi,cn,fn,pi,mi,ui,De,gi,ts,_i,Ti,os,vi,bi,ns,wi,yi,ss,Li,ki,$i,Lo,xi,hn,Xi,Mi,Ei,ko,Fi,$o,zi,Ci,qi,le,xo,Pi,Tt,ji,pn,Si,Oi,as,Ni,Hi,Ai,Pt,Di,rs,Ii,Wi,Xo,Bi,is,Vi,Ui,Mo,Gs,vt,jt,ls,Eo,Ri,ds,Gi,Ks,pe,Fo,Ki,cs,Yi,Ji,zo,Qi,mn,Zi,el,tl,Co,ol,qo,nl,sl,al,St,rl,qe,Po,il,bt,ll,un,dl,cl,fs,fl,hl,pl,Ot,ml,hs,ul,gl,jo,Ys,wt,Nt,ps,So,_l,ms,Tl,Js,me,Oo,vl,us,bl,wl,No,yl,gn,Ll,kl,$l,Ho,xl,Ao,Xl,Ml,El,Ht,Fl,Pe,Do,zl,yt,Cl,_n,ql,Pl,gs,jl,Sl,Ol,At,Nl,_s,Hl,Al,Io,Qs,Lt,Dt,Ts,Wo,Dl,vs,Il,Zs,K,Bo,Wl,bs,Bl,Vl,Tn,vn,Ul,Rl,Gl,Ie,Kl,ws,Yl,Jl,ys,Ql,Zl,Ls,ed,td,ks,od,nd,sd,Vo,ad,bn,rd,id,ld,Uo,dd,Ro,cd,fd,hd,It,pd,je,Go,md,kt,ud,wn,gd,_d,$s,Td,vd,bd,Wt,wd,xs,yd,Ld,Ko,ea,$t,Bt,Xs,Yo,kd,Ms,$d,ta,yn,oa,Ln,na;return T=new Ge({}),Z=new Ge({}),j=new Ge({}),te=new de({props:{name:"class transformers.TransfoXLConfig",anchor:"transformers.TransfoXLConfig",parameters:[{name:"vocab_size",val:" = 267735"},{name:"cutoffs",val:" = [20000, 40000, 200000]"},{name:"d_model",val:" = 1024"},{name:"d_embed",val:" = 1024"},{name:"n_head",val:" = 16"},{name:"d_head",val:" = 64"},{name:"d_inner",val:" = 4096"},{name:"div_val",val:" = 4"},{name:"pre_lnorm",val:" = False"},{name:"n_layer",val:" = 18"},{name:"mem_len",val:" = 1600"},{name:"clamp_len",val:" = 1000"},{name:"same_length",val:" = True"},{name:"proj_share_all_but_first",val:" = True"},{name:"attn_type",val:" = 0"},{name:"sample_softmax",val:" = -1"},{name:"adaptive",val:" = True"},{name:"dropout",val:" = 0.1"},{name:"dropatt",val:" = 0.0"},{name:"untie_r",val:" = True"},{name:"init",val:" = 'normal'"},{name:"init_range",val:" = 0.01"},{name:"proj_init_std",val:" = 0.01"},{name:"init_std",val:" = 0.02"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"eos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/transfo_xl/configuration_transfo_xl.py#L29",parametersDescription:[{anchor:"transformers.TransfoXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 267735) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Yo=new Ge({}),{c(){m=n("meta"),x=l(),u=n("h1"),g=n("a"),v=n("span"),b(T.$$.fragment),_=l(),E=n("span"),we=r("Transformer XL"),Q=l(),X=n("h2"),Y=n("a"),A=n("span"),b(Z.$$.fragment),ye=l(),D=n("span"),Le=r("Overview"),ue=l(),I=n("p"),S=r("The Transformer-XL model was proposed in "),ee=n("a"),ne=r("Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context"),F=r(` by Zihang Dai, Zhilin Yang, Yiming Yang, Jaime Carbonell, Quoc V. Le, Ruslan
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),qi=l(),le=n("div"),b(xo.$$.fragment),Pi=l(),Tt=n("p"),ji=r("The "),pn=n("a"),Si=r("TransfoXLForSequenceClassification"),Oi=r(" forward method, overrides the "),as=n("code"),Ni=r("__call__"),Hi=r(" special method."),Ai=l(),b(Pt.$$.fragment),Di=l(),rs=n("p"),Ii=r("Example of single-label classification:"),Wi=l(),b(Xo.$$.fragment),Bi=l(),is=n("p"),Vi=r("Example of multi-label classification:"),Ui=l(),b(Mo.$$.fragment),Gs=l(),vt=n("h2"),jt=n("a"),ls=n("span"),b(Eo.$$.fragment),Ri=l(),ds=n("span"),Gi=r("TFTransfoXLModel"),Ks=l(),pe=n("div"),b(Fo.$$.fragment),Ki=l(),cs=n("p"),Yi=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Ji=l(),zo=n("p"),Qi=r("This model inherits from "),mn=n("a"),Zi=r("TFPreTrainedModel"),el=r(`. Check the superclass documentation for the
...
and behavior.`),al=l(),b(St.$$.fragment),rl=l(),qe=n("div"),b(Po.$$.fragment),il=l(),bt=n("p"),ll=r("The "),un=n("a"),dl=r("TFTransfoXLModel"),cl=r(" forward method, overrides the "),fs=n("code"),fl=r("__call__"),hl=r(" special method."),pl=l(),b(Ot.$$.fragment),ml=l(),hs=n("p"),ul=r("Example:"),gl=l(),b(jo.$$.fragment),Ys=l(),wt=n("h2"),Nt=n("a"),ps=n("span"),b(So.$$.fragment),_l=l(),ms=n("span"),Tl=r("TFTransfoXLLMHeadModel"),Js=l(),me=n("div"),b(Oo.$$.fragment),vl=l(),us=n("p"),bl=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),ga.forEach(t),Mr=d(Je),ze=s(Je,"DIV",{class:!0});var Qe=a(ze);w(ho.$$.fragment,Qe),Er=d(Qe),mt=s(Qe,"P",{});var xn=a(mt);Fr=i(xn,"The "),rn=s(xn,"A",{href:!0});var cc=a(rn);zr=i(cc,"TransfoXLModel"),cc.forEach(t),Cr=i(xn," forward method, overrides the "),Vn=s(xn,"CODE",{});var fc=a(Vn);qr=i(fc,"__call__"),fc.forEach(t),Pr=i(xn," special method."),xn.forEach(t),jr=d(Qe),w(Ft.$$.fragment,Qe),Sr=d(Qe),Un=s(Qe,"P",{});var hc=a(Un);Or=i(hc,"Example:"),hc.forEach(t),Nr=d(Qe),w(po.$$.fragment,Qe),Qe.forEach(t),Je.forEach(t),Bs=d(o),ut=s(o,"H2",{class:!0});var _a=a(ut);zt=s(_a,"A",{id:!0,class:!0,href:!0});var pc=a(zt);Rn=s(pc,"SPAN",{});var mc=a(Rn);w(mo.$$.fragment,mc),mc.forEach(t),pc.forEach(t),Hr=d(_a),Gn=s(_a,"SPAN",{});var uc=a(Gn);Ar=i(uc,"TransfoXLLMHeadModel"),uc.forEach(t),_a.forEach(t),Vs=d(o),Ee=s(o,"DIV",{class:!0});var Ze=a(Ee);w(uo.$$.fragment,Ze),Dr=d(Ze),Kn=s(Ze,"P",{});var gc=a(Kn);Ir=i(gc,`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
