...
processing steps while the latter silently ignores them.`)},l(g){h=i(g,"P",{});var m=r(h);L=s(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=i(m,"CODE",{});var z=r(f);w=s(z,"Module"),z.forEach(t),E=s(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(t)},m(g,m){u(g,h,m),e(h,L),e(h,f),e(f,w),e(h,E)},d(g){g&&t(h)}}}function cp(O){let h,L,f,w,E,g,m,z,Ds,Ro,le,xe,Sn,He,Bs,Nn,Ws,Ho,$e,Os,Ve,Us,Ks,Vo,Jt,Rs,Yo,Qt,Dn,Hs,Jo,Xt,Vs,Qo,R,Bn,Ye,Ys,Gt,Js,Qs,Xs,Wn,q,Gs,On,Zs,ea,Un,ta,na,Kn,oa,sa,Rn,aa,ia,Zt,ra,da,la,Je,H,en,ca,pa,Hn,ha,ua,Vn,fa,ma,Yn,ga,_a,ka,Qe,tn,Jn,ya,va,ba,nn,Qn,Ta,wa,La,U,Xn,Ea,za,ce,qe,on,xa,$a,Xe,qa,Ca,Ma,Ce,sn,Fa,Pa,Ge,ja,Aa,Ia,an,rn,Sa,Na,Da,S,dn,Ba,Wa,Gn,Oa,Ua,Zn,Ka,Ra,eo,Ha,Va,to,Ya,Ja,Qa,pe,Xa,ln,Ga,Za,Ze,ei,ti,ni,et,oi,tt,si,ai,Xo,cn,ii,Go,nt,Zo,V,ri,ot,di,li,st,ci,pi,at,hi,ui,es,he,Me,no,it,fi,oo,mi,ts,C,rt,gi,dt,_i,pn,ki,yi,vi,ue,bi,hn,Ti,wi,un,Li,Ei,zi,so,xi,$i,lt,ns,fe,Fe,ao,ct,qi,io,Ci,os,M,pt,Mi,ro,Fi,Pi,x,ji,fn,Ai,Ii,mn,Si,Ni,gn,Di,Bi,lo,Wi,Oi,co,Ui,Ki,po,Ri,Hi,ho,Vi,Yi,Ji,Pe,ht,Qi,uo,Xi,Gi,fo,ss,me,je,mo,ut,Zi,go,er,as,F,ft,tr,_o,nr,or,mt,sr,_n,ar,ir,rr,gt,dr,_t,lr,cr,pr,N,kt,hr,ge,ur,kn,fr,mr,ko,gr,_r,kr,Ae,yr,yo,vr,br,yt,is,_e,Ie,vo,vt,Tr,bo,wr,rs,P,bt,Lr,To,Er,zr,Tt,xr,yn,$r,qr,Cr,wt,Mr,Lt,Fr,Pr,jr,Q,Et,Ar,ke,Ir,vn,Sr,Nr,wo,Dr,Br,Wr,Se,ds,ye,Ne,Lo,zt,Or,Eo,Ur,ls,j,xt,Kr,zo,Rr,Hr,$t,Vr,bn,Yr,Jr,Qr,qt,Xr,Ct,Gr,Zr,ed,D,Mt,td,ve,nd,Tn,od,sd,xo,ad,id,rd,De,dd,$o,ld,cd,Ft,cs,be,Be,qo,Pt,pd,Co,hd,ps,A,jt,ud,Mo,fd,md,At,gd,wn,_d,kd,yd,It,vd,St,bd,Td,wd,B,Nt,Ld,Te,Ed,Ln,zd,xd,Fo,$d,qd,Cd,We,Md,Po,Fd,Pd,Dt,hs,we,Oe,jo,Bt,jd,Ao,Ad,us,I,Wt,Id,Io,Sd,Nd,Ot,Dd,En,Bd,Wd,Od,Ut,Ud,Kt,Kd,Rd,Hd,W,Rt,Vd,Le,Yd,zn,Jd,Qd,So,Xd,Gd,Zd,Ue,el,No,tl,nl,Ht,fs;return g=new ze({}),He=new ze({}),nt=new In({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
`),Zt=a("a"),ra=o("LukeTokenizer"),da=o("."),la=l(),Je=a("li"),H=a("p"),en=a("a"),ca=o("LukeTokenizer"),pa=o(" takes "),Hn=a("code"),ha=o("entities"),ua=o(" and "),Vn=a("code"),fa=o("entity_spans"),ma=o(` (character-based start and end
...
used by the LUKE model.`),Ji=l(),Pe=a("div"),_(ht.$$.fragment),Qi=l(),uo=a("p"),Xi=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),jr=l(),Q=a("div"),_(Et.$$.fragment),Ar=l(),ke=a("p"),Ir=o("The "),vn=a("a"),Sr=o("LukeForMaskedLM"),Nr=o(" forward method, overrides the "),wo=a("code"),Dr=o("__call__"),Br=o(" special method."),Wr=l(),_(Se.$$.fragment),ds=l(),ye=a("h2"),Ne=a("a"),Lo=a("span"),_(zt.$$.fragment),Or=l(),Eo=a("span"),Ur=o("LukeForEntityClassification"),ls=l(),j=a("div"),_(xt.$$.fragment),Kr=l(),zo=a("p"),Rr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Hr=l(),$t=a("p"),Vr=o("This model inherits from "),bn=a("a"),Yr=o("PreTrainedModel"),Jr=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Qr=l(),qt=a("p"),Xr=o("This model is also a PyTorch "),Ct=a("a"),Gr=o("torch.nn.Module"),Zr=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
extractive and cloze-style question answering, entity typing, and relation classification.`),ms.forEach(t),Vo=c(n),Jt=i(n,"P",{});var cl=r(Jt);Rs=s(cl,"The abstract from the paper is the following:"),cl.forEach(t),Yo=c(n),Qt=i(n,"P",{});var pl=r(Qt);Dn=i(pl,"EM",{});var hl=r(Dn);Hs=s(hl,`Entity representations are useful in natural language tasks involving entities. In this paper, we propose new
pretrained contextualized representations of words and entities based on the bidirectional transformer. The proposed
model treats words and entities in a given text as independent tokens, and outputs contextualized representations of
them. Our model is trained using a new pretraining task based on the masked language model of BERT. The task involves
predicting randomly masked words and entities in a large entity-annotated corpus retrieved from Wikipedia. We also
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),hl.forEach(t),pl.forEach(t),Jo=c(n),Xt=i(n,"P",{});var ul=r(Xt);Vs=s(ul,"Tips:"),ul.forEach(t),Qo=c(n),R=i(n,"UL",{});var Ke=r(R);Bn=i(Ke,"LI",{});var fl=r(Bn);Ye=i(fl,"P",{});var gs=r(Ye);Ys=s(gs,"This implementation is the same as "),Gt=i(gs,"A",{href:!0});var ml=r(Gt);Js=s(ml,"RobertaModel"),ml.forEach(t),Qs=s(gs,` with the addition of entity embeddings as well
...
Wikipedia entities. The brief description when inputting these entities are as follows:`),Ee.forEach(t),ka=c(_s),Qe=i(_s,"UL",{});var ks=r(Qe);tn=i(ks,"LI",{});var ol=r(tn);Jn=i(ol,"EM",{});var zl=r(Jn);ya=s(zl,"Inputting [MASK] entities to compute entity representations"),zl.forEach(t),va=s(ol,`: The [MASK] entity is used to mask entities to be
predicted during pretraining. When LUKE receives the [MASK] entity, it tries to predict the original entity by
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
named entity recognition.`),ol.forEach(t),ba=c(ks),nn=i(ks,"LI",{});var sl=r(nn);Qn=i(sl,"EM",{});var xl=r(Qn);Ta=s(xl,"Inputting Wikipedia entities to compute knowledge-enhanced token representations"),xl.forEach(t),wa=s(sl,`: LUKE learns rich information
(or knowledge) about Wikipedia entities during pretraining and stores the information in its entity embedding. By
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
...
head models by specifying `),Zn=i(J,"CODE",{});var Il=r(Zn);Ka=s(Il,'task="entity_classification"'),Il.forEach(t),Ra=s(J,", "),eo=i(J,"CODE",{});var Sl=r(eo);Ha=s(Sl,'task="entity_pair_classification"'),Sl.forEach(t),Va=s(J,`, or
`),to=i(J,"CODE",{});var Nl=r(to);Ya=s(Nl,'task="entity_span_classification"'),Nl.forEach(t),Ja=s(J,". Please refer to the example code of each head models."),J.forEach(t),Qa=c(X),pe=i(X,"P",{});var $n=r(pe);Xa=s($n,"A demo notebook on how to fine-tune "),ln=i($n,"A",{href:!0});var Dl=r(ln);Ga=s(Dl,"LukeForEntityPairClassification"),Dl.forEach(t),Za=s($n,` for relation
...
used by the LUKE model.`),$.forEach(t),Ji=c(Z),Pe=i(Z,"DIV",{class:!0});var ws=r(Pe);k(ht.$$.fragment,ws),Qi=c(ws),uo=i(ws,"P",{});var cc=r(uo);Xi=s(cc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),qs.forEach(t),jr=c(ne),Q=i(ne,"DIV",{class:!0});var Mn=r(Q);k(Et.$$.fragment,Mn),Ar=c(Mn),ke=i(Mn,"P",{});var Fn=r(ke);Ir=s(Fn,"The "),vn=i(Fn,"A",{href:!0});var zc=r(vn);Sr=s(zc,"LukeForMaskedLM"),zc.forEach(t),Nr=s(Fn," forward method, overrides the "),wo=i(Fn,"CODE",{});var xc=r(wo);Dr=s(xc,"__call__"),xc.forEach(t),Br=s(Fn," special method."),Fn.forEach(t),Wr=c(Mn),k(Se.$$.fragment,Mn),Mn.forEach(t),ne.forEach(t),ds=c(n),ye=i(n,"H2",{class:!0});var Cs=r(ye);Ne=i(Cs,"A",{id:!0,class:!0,href:!0});var $c=r(Ne);Lo=i($c,"SPAN",{});var qc=r(Lo);k(zt.$$.fragment,qc),qc.forEach(t),$c.forEach(t),Or=c(Cs),Eo=i(Cs,"SPAN",{});var Cc=r(Eo);Ur=s(Cc,"LukeForEntityClassification"),Cc.forEach(t),Cs.forEach(t),ls=c(n),j=i(n,"DIV",{class:!0});var oe=r(j);k(xt.$$.fragment,oe),Kr=c(oe),zo=i(oe,"P",{});var Mc=r(zo);Rr=s(Mc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Mc.forEach(t),Hr=c(oe),$t=i(oe,"P",{});var Ms=r($t);Vr=s(Ms,"This model inherits from "),bn=i(Ms,"A",{href:!0});var Fc=r(bn);Yr=s(Fc,"PreTrainedModel"),Fc.forEach(t),Jr=s(Ms,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ms.forEach(t),Qr=c(oe),qt=i(oe,"P",{});var Fs=r(qt);Xr=s(Fs,"This model is also a PyTorch "),Ct=i(Fs,"A",{href:!0,rel:!0});var Pc=r(Ct);Gr=s(Pc,"torch.nn.Module"),Pc.forEach(t),Zr=s(Fs,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
such as named entity recognition.`),Jc.forEach(t),Nd=c(re),Ot=i(re,"P",{});var Ss=r(Ot);Dd=s(Ss,"This model inherits from "),En=i(Ss,"A",{href:!0});var Qc=r(En);Bd=s(Qc,"PreTrainedModel"),Qc.forEach(t),Wd=s(Ss,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
