import{S as oi,i as si,s as ri,e as o,k as d,w as m,t as a,L as ai,c as s,d as n,m as c,a as r,x as g,h as i,b as l,J as e,g as h,y as _,q as k,o as v,B as w}from"../../../chunks/vendor-b1433968.js";import{T as ti}from"../../../chunks/Tip-c3840994.js";import{D as Q}from"../../../chunks/Docstring-ff504c58.js";import{C as ni}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as rt}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function ii(ve){let u,q,f,b,x;return{c(){u=o("p"),q=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=o("code"),b=a("Module"),x=a(` instance afterwards instead of this since the former takes care of running the pre and post
...
`),f=s(T,"CODE",{});var D=r(f);b=i(D,"Module"),D.forEach(n),x=i(T,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),T.forEach(n)},m(y,T){h(y,u,T),e(u,q),e(u,f),e(f,b),e(u,x)},d(y){y&&n(u)}}}function li(ve){let u,q,f,b,x;return{c(){u=o("p"),q=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=o("code"),b=a("Module"),x=a(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(y){u=s(y,"P",{});var T=r(u);q=i(T,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=s(T,"CODE",{});var D=r(f);b=i(D,"Module"),D.forEach(n),x=i(T,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),T.forEach(n)},m(y,T){h(y,u,T),e(u,q),e(u,f),e(f,b),e(u,x)},d(y){y&&n(u)}}}function di(ve){let u,q,f,b,x,y,T,D,eo,_n,V,oe,It,we,to,Ct,no,kn,se,oo,be,so,ro,vn,at,ao,wn,it,io,bn,lt,lo,yn,I,ye,co,dt,po,ho,uo,L,fo,ct,mo,go,pt,_o,ko,Dt,vo,wo,bo,Se,yo,Lt,So,To,qo,A,zo,Nt,$o,Eo,Qt,xo,Ao,Ot,Po,Mo,Wt,Fo,Io,Sn,C,Co,Te,Do,Lo,qe,No,Qo,ze,Oo,Wo,Tn,J,re,jt,$e,jo,Bt,Bo,qn,N,Ee,Uo,K,Ho,ht,Vo,Jo,xe,Ko,Ro,Go,R,Xo,ut,Yo,Zo,ft,es,ts,zn,G,ae,Ut,Ae,ns,Ht,os,$n,S,Pe,ss,Vt,rs,as,Me,is,mt,ls,ds,cs,O,Fe,ps,Jt,hs,us,Ie,gt,fs,Kt,ms,gs,_t,_s,Rt,ks,vs,ie,Ce,ws,De,bs,Gt,ys,Ss,Ts,W,Le,qs,kt,zs,vt,$s,Es,Xt,xs,As,Yt,En,X,le,Zt,Ne,Ps,en,Ms,xn,P,Qe,Fs,Oe,Is,tn,Cs,Ds,Ls,We,Ns,wt,Qs,Os,Ws,j,je,js,nn,Bs,Us,Be,bt,Hs,on,Vs,Js,yt,Ks,sn,Rs,An,Y,de,rn,Ue,Gs,an,Xs,Pn,M,He,Ys,Ve,Zs,Je,er,tr,nr,Ke,or,Re,sr,rr,ar,z,Ge,ir,Z,lr,St,dr,cr,ln,pr,hr,ur,ce,fr,dn,mr,gr,Xe,Mn,ee,pe,cn,Ye,_r,pn,kr,Fn,F,Ze,vr,te,wr,hn,br,yr,un,Sr,Tr,qr,et,zr,tt,$r,Er,xr,$,nt,Ar,ne,Pr,Tt,Mr,Fr,fn,Ir,Cr,Dr,he,Lr,mn,Nr,Qr,ot,In;return y=new rt({}),we=new rt({}),$e=new rt({}),Ee=new Q({props:{name:"class transformers.SplinterConfig",anchor:"transformers.SplinterConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 0"},{name:"question_token_id",val:" = 104"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/splinter/configuration_splinter.py#L32",parametersDescription:[{anchor:"transformers.SplinterConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the Splinter model. Defines the number of different tokens that can be represented by
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.14.1/en/model_doc/splinter#transformers.SplinterModel">SplinterModel</a>.`,name:"vocab_size"},{anchor:"transformers.SplinterConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
value for <code>lowercase</code> (as in the original BERT).`,name:"tokenize_chinese_chars"}]}}),Fe=new Q({props:{name:"build\\_inputs\\_with\\_special\\_tokens",anchor:"transformers.SplinterTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/splinter/tokenization_splinter.py#L218",parametersDescription:[{anchor:"transformers.SplinterTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`}}),Ce=new Q({props:{name:"get\\_special\\_tokens\\_mask",anchor:"transformers.SplinterTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/splinter/tokenization_splinter.py#L250",parametersDescription:[{anchor:"transformers.SplinterTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Le=new Q({props:{name:"create\\_token\\_type\\_ids\\_from\\_sequences",anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/splinter/tokenization_splinter.py#L278",parametersDescription:[{anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:"<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014; The first tokenized sequence.",name:"token_ids_0"},{anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences.token_ids_1",description:"<strong>token_ids_1</strong> (<code>List[int]</code>, <em>optional</em>) &#x2014; The second tokenized sequence.",name:"token_ids_1"}],returnDescription:`
<p>The token type ids.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ne=new rt({}),Qe=new Q({props:{name:"class transformers.SplinterTokenizerFast",anchor:"transformers.SplinterTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"question_token",val:" = '[QUESTION]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/splinter/tokenization_splinter_fast.py#L55",parametersDescription:[{anchor:"transformers.SplinterTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
The prefix for subwords.`,name:"tokenize_chinese_chars"}]}}),je=new Q({props:{name:"build\\_inputs\\_with\\_special\\_tokens",anchor:"transformers.SplinterTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/splinter/tokenization_splinter_fast.py#L153",parametersDescription:[{anchor:"transformers.SplinterTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/splinter#transformers.SplinterConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){u=o("meta"),q=d(),f=o("h1"),b=o("a"),x=o("span"),m(y.$$.fragment),T=d(),D=o("span"),eo=a("Splinter"),_n=d(),V=o("h2"),oe=o("a"),It=o("span"),m(we.$$.fragment),to=d(),Ct=o("span"),no=a("Overview"),kn=d(),se=o("p"),oo=a("The Splinter model was proposed in "),be=o("a"),so=a("Few-Shot Question Answering by Pretraining Span Selection"),ro=a(` by Ori Ram, Yuval Kirstain, Jonathan Berant, Amir Globerson, Omer Levy. Splinter
...
behaviour in the `),dt=o("a"),po=a("SplinterForQuestionAnswering"),ho=a(" class. Therefore:"),uo=d(),L=o("li"),fo=a("Use "),ct=o("a"),mo=a("SplinterTokenizer"),go=a(" (rather than "),pt=o("a"),_o=a("BertTokenizer"),ko=a(`), as it already
...
fine-tuning, as it is shown to yield better results for some cases in the paper.`),Sn=d(),C=o("p"),Co=a("This model was contributed by "),Te=o("a"),Do=a("yuvalkirstain"),Lo=a(" and "),qe=o("a"),No=a("oriram"),Qo=a(". The original code can be found "),ze=o("a"),Oo=a("here"),Wo=a("."),Tn=d(),J=o("h2"),re=o("a"),jt=o("span"),m($e.$$.fragment),jo=d(),Bt=o("span"),Bo=a("SplinterConfig"),qn=d(),N=o("div"),m(Ee.$$.fragment),Uo=d(),K=o("p"),Ho=a("This is the configuration class to store the configuration of a "),ht=o("a"),Vo=a("SplinterModel"),Jo=a(`. It is used to
...
outputs. Read the documentation from `),ft=o("a"),es=a("PretrainedConfig"),ts=a(" for more information."),zn=d(),G=o("h2"),ae=o("a"),Ut=o("span"),m(Ae.$$.fragment),ns=d(),Ht=o("span"),os=a("SplinterTokenizer"),$n=d(),S=o("div"),m(Pe.$$.fragment),ss=d(),Vt=o("p"),rs=a("Construct a Splinter tokenizer. Based on WordPiece."),as=d(),Me=o("p"),is=a("This tokenizer inherits from "),mt=o("a"),ls=a("PreTrainedTokenizer"),ds=a(` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),cs=d(),O=o("div"),m(Fe.$$.fragment),ps=d(),Jt=o("p"),hs=a(`Build model inputs from a pair of sequence for question answering tasks by concatenating and adding special
tokens. A Splinter sequence has the following format:`),us=d(),Ie=o("ul"),gt=o("li"),fs=a("single sequence: "),Kt=o("code"),ms=a("[CLS] X [SEP]"),gs=d(),_t=o("li"),_s=a("pair of sequences for question answering: "),Rt=o("code"),ks=a("[CLS] question_tokens [QUESTION] . [SEP] context_tokens [SEP]"),vs=d(),ie=o("div"),m(Ce.$$.fragment),ws=d(),De=o("p"),bs=a(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Gt=o("code"),ys=a("prepare_for_model"),Ss=a(" method."),Ts=d(),W=o("div"),m(Le.$$.fragment),qs=d(),kt=o("p"),zs=a("Create the token type IDs corresponding to the sequences passed. "),vt=o("a"),$s=a("What are token type IDs?"),Es=d(),Xt=o("p"),xs=a("Should be overridden in a subclass if the model has a special way of building those."),As=d(),Yt=o("div"),En=d(),X=o("h2"),le=o("a"),Zt=o("span"),m(Ne.$$.fragment),Ps=d(),en=o("span"),Ms=a("SplinterTokenizerFast"),xn=d(),P=o("div"),m(Qe.$$.fragment),Fs=d(),Oe=o("p"),Is=a("Construct a \u201Cfast\u201D Splinter tokenizer (backed by HuggingFace\u2019s "),tn=o("em"),Cs=a("tokenizers"),Ds=a(" library). Based on WordPiece."),Ls=d(),We=o("p"),Ns=a("This tokenizer inherits from "),wt=o("a"),Qs=a("PreTrainedTokenizerFast"),Os=a(` which contains most of the main
methods. Users should refer to this superclass for more information regarding those methods.`),Ws=d(),j=o("div"),m(je.$$.fragment),js=d(),nn=o("p"),Bs=a(`Build model inputs from a pair of sequence for question answering tasks by concatenating and adding special
tokens. A Splinter sequence has the following format:`),Us=d(),Be=o("ul"),bt=o("li"),Hs=a("single sequence: "),on=o("code"),Vs=a("[CLS] X [SEP]"),Js=d(),yt=o("li"),Ks=a("pair of sequences for question answering: "),sn=o("code"),Rs=a("[CLS] question_tokens [QUESTION] . [SEP] context_tokens [SEP]"),An=d(),Y=o("h2"),de=o("a"),rn=o("span"),m(Ue.$$.fragment),Gs=d(),an=o("span"),Xs=a("SplinterModel"),Pn=d(),M=o("div"),m(He.$$.fragment),Ys=d(),Ve=o("p"),Zs=a(`The bare Splinter Model transformer outputting raw hidden-states without any specific head on top.
...
Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),ar=d(),z=o("div"),m(Ge.$$.fragment),ir=d(),Z=o("p"),lr=a("The "),St=o("a"),dr=a("SplinterModel"),cr=a(" forward method, overrides the "),ln=o("code"),pr=a("__call__"),hr=a(" special method."),ur=d(),m(ce.$$.fragment),fr=d(),dn=o("p"),mr=a("Example:"),gr=d(),m(Xe.$$.fragment),Mn=d(),ee=o("h2"),pe=o("a"),cn=o("span"),m(Ye.$$.fragment),_r=d(),pn=o("span"),kr=a("SplinterForQuestionAnswering"),Fn=d(),F=o("div"),m(Ze.$$.fragment),vr=d(),te=o("p"),wr=a(`Splinter Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
to question representations which are used to predict the answers. This layer is called QASS, and is the default
behaviour in the `),dt=s(Ln,"A",{href:!0});var ea=r(dt);po=i(ea,"SplinterForQuestionAnswering"),ea.forEach(n),ho=i(Ln," class. Therefore:"),Ln.forEach(n),uo=c(ue),L=s(ue,"LI",{});var fe=r(L);fo=i(fe,"Use "),ct=s(fe,"A",{href:!0});var ta=r(ct);mo=i(ta,"SplinterTokenizer"),ta.forEach(n),go=i(fe," (rather than "),pt=s(fe,"A",{href:!0});var na=r(pt);_o=i(na,"BertTokenizer"),na.forEach(n),ko=i(fe,`), as it already
contains this special token. Also, its default behavior is to use this token when two sequences are given (for
example, in the `),Dt=s(fe,"EM",{});var oa=r(Dt);vo=i(oa,"run_qa.py"),oa.forEach(n),wo=i(fe," script)."),fe.forEach(n),bo=c(ue),Se=s(ue,"LI",{});var Nn=r(Se);yo=i(Nn,"If you plan on using Splinter outside "),Lt=s(Nn,"EM",{});var sa=r(Lt);So=i(sa,"run_qa.py"),sa.forEach(n),To=i(Nn,`, please keep in mind the question token - it might be important for
...
fine-tuning, as it is shown to yield better results for some cases in the paper.`),B.forEach(n),ue.forEach(n),Sn=c(t),C=s(t,"P",{});var me=r(C);Co=i(me,"This model was contributed by "),Te=s(me,"A",{href:!0,rel:!0});var da=r(Te);Do=i(da,"yuvalkirstain"),da.forEach(n),Lo=i(me," and "),qe=s(me,"A",{href:!0,rel:!0});var ca=r(qe);No=i(ca,"oriram"),ca.forEach(n),Qo=i(me,". The original code can be found "),ze=s(me,"A",{href:!0,rel:!0});var pa=r(ze);Oo=i(pa,"here"),pa.forEach(n),Wo=i(me,"."),me.forEach(n),Tn=c(t),J=s(t,"H2",{class:!0});var Qn=r(J);re=s(Qn,"A",{id:!0,class:!0,href:!0});var ha=r(re);jt=s(ha,"SPAN",{});var ua=r(jt);g($e.$$.fragment,ua),ua.forEach(n),ha.forEach(n),jo=c(Qn),Bt=s(Qn,"SPAN",{});var fa=r(Bt);Bo=i(fa,"SplinterConfig"),fa.forEach(n),Qn.forEach(n),qn=c(t),N=s(t,"DIV",{class:!0});var qt=r(N);g(Ee.$$.fragment,qt),Uo=c(qt),K=s(qt,"P",{});var zt=r(K);Ho=i(zt,"This is the configuration class to store the configuration of a "),ht=s(zt,"A",{href:!0});var ma=r(ht);Vo=i(ma,"SplinterModel"),ma.forEach(n),Jo=i(zt,`. It is used to
instantiate an Splinter model according to the specified arguments, defining the model architecture. Instantiating
...
outputs. Read the documentation from `),ft=s($t,"A",{href:!0});var ka=r(ft);es=i(ka,"PretrainedConfig"),ka.forEach(n),ts=i($t," for more information."),$t.forEach(n),qt.forEach(n),zn=c(t),G=s(t,"H2",{class:!0});var On=r(G);ae=s(On,"A",{id:!0,class:!0,href:!0});var va=r(ae);Ut=s(va,"SPAN",{});var wa=r(Ut);g(Ae.$$.fragment,wa),wa.forEach(n),va.forEach(n),ns=c(On),Ht=s(On,"SPAN",{});var ba=r(Ht);os=i(ba,"SplinterTokenizer"),ba.forEach(n),On.forEach(n),$n=c(t),S=s(t,"DIV",{class:!0});var E=r(S);g(Pe.$$.fragment,E),ss=c(E),Vt=s(E,"P",{});var ya=r(Vt);rs=i(ya,"Construct a Splinter tokenizer. Based on WordPiece."),ya.forEach(n),as=c(E),Me=s(E,"P",{});var Wn=r(Me);is=i(Wn,"This tokenizer inherits from "),mt=s(Wn,"A",{href:!0});var Sa=r(mt);ls=i(Sa,"PreTrainedTokenizer"),Sa.forEach(n),ds=i(Wn,` which contains most of the main methods.
