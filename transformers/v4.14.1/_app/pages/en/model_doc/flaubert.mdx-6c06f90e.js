...
general usage and behavior.`),Id=l(),Qe=a("div"),y(tn.$$.fragment),Dd=l(),jt=a("p"),Wd=o("The "),Ys=a("a"),Od=o("FlaubertModel"),Hd=o(" forward method, overrides the "),nr=a("code"),Qd=o("__call__"),Bd=o(" special method."),Rd=l(),y(ho.$$.fragment),Ud=l(),sr=a("p"),Vd=o("Example:"),Yd=l(),y(on.$$.fragment),Pi=l(),Xt=a("h2"),uo=a("a"),ar=a("span"),y(nn.$$.fragment),Jd=l(),rr=a("span"),Kd=o("FlaubertWithLMHeadModel"),ji=l(),ze=a("div"),y(sn.$$.fragment),Gd=l(),ir=a("p"),Zd=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
and behavior.`),vu=l(),y($o.$$.fragment),ku=l(),Je=a("div"),y(ss.$$.fragment),Tu=l(),Jt=a("p"),wu=o("The "),fa=a("a"),yu=o("TFFlaubertModel"),Fu=o(" forward method, overrides the "),Wr=a("code"),Mu=o("__call__"),$u=o(" special method."),xu=l(),y(xo.$$.fragment),Lu=l(),Or=a("p"),Eu=o("Example:"),zu=l(),y(as.$$.fragment),Ui=l(),Kt=a("h2"),Lo=a("a"),Hr=a("span"),y(rs.$$.fragment),Cu=l(),Qr=a("span"),qu=o("TFFlaubertWithLMHeadModel"),Vi=l(),Se=a("div"),y(is.$$.fragment),Pu=l(),Br=a("p"),ju=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Hu=l(),y(Eo.$$.fragment),Qu=l(),Ke=a("div"),y(ps.$$.fragment),Bu=l(),Gt=a("p"),Ru=o("The "),_a=a("a"),Uu=o("TFFlaubertWithLMHeadModel"),Vu=o(" forward method, overrides the "),Rr=a("code"),Yu=o("__call__"),Ju=o(" special method."),Ku=l(),y(zo.$$.fragment),Gu=l(),Ur=a("p"),Zu=o("Example:"),em=l(),y(hs.$$.fragment),Yi=l(),Zt=a("h2"),Co=a("a"),Vr=a("span"),y(us.$$.fragment),tm=l(),Yr=a("span"),om=o("TFFlaubertForSequenceClassification"),Ji=l(),Ne=a("div"),y(ms.$$.fragment),nm=l(),Jr=a("p"),sm=o(`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Sm=l(),y(Xo.$$.fragment),Nm=l(),Ze=a("div"),y(Ms.$$.fragment),Im=l(),oo=a("p"),Dm=o("The "),Ta=a("a"),Wm=o("TFXLMForMultipleChoice"),Om=o(" forward method, overrides the "),oi=a("code"),Hm=o("__call__"),Qm=o(" special method."),Bm=l(),y(Ao.$$.fragment),Rm=l(),ni=a("p"),Um=o("Example:"),Vm=l(),y($s.$$.fragment),Zi=l(),no=a("h2"),So=a("a"),si=a("span"),y(xs.$$.fragment),Ym=l(),ai=a("span"),Jm=o("TFFlaubertForTokenClassification"),el=l(),De=a("div"),y(Ls.$$.fragment),Km=l(),ri=a("p"),Gm=o(`Flaubert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
