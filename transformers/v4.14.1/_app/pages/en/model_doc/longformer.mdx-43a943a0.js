...
the first positional argument :`),be.forEach(t),K=d(m),z=r(m,"UL",{});var A=i(z);q=r(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=r(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=r(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=r(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(G,"CODE",{});var ve=i(U);re=s(ve,"model([input_ids, attention_mask])"),ve.forEach(t),te=s(G," or "),N=r(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),j=r(A,"LI",{});var we=i(j);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(we,"CODE",{});var ke=i(B);oe=s(ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ke.forEach(t),we.forEach(t),A.forEach(t)},m(m,$){h(m,p,$),e(p,F),h(m,g,$),h(m,u,$),e(u,x),e(x,w),e(u,_),e(u,M),e(M,de),h(m,X,$),h(m,E,$),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,ae),h(m,R,$),h(m,P,$),e(P,se),h(m,K,$),h(m,z,$),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,re),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,j),e(j,_e),e(j,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(P),m&&t(K),m&&t(z)}}}function v1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.LongformerConfig"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>answer = <span class="hljs-string">&#x27; &#x27;</span>.join(all_tokens[tf.math.argmax(start_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] : tf.math.argmax(end_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>]+<span class="hljs-number">1</span>])`}}),pa=new ze({}),ga=new S({props:{name:"class transformers.TFLongformerForSequenceClassification",anchor:"transformers.TFLongformerForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2353",parametersDescription:[{anchor:"transformers.TFLongformerForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),gn=new je({props:{$$slots:{default:[u1]},$$scope:{ctx:W}}}),va=new S({props:{name:"call",anchor:"transformers.TFLongformerForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2365",parametersDescription:[{anchor:"transformers.TFLongformerForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> for
details.</p>
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
`}}),un=new je({props:{$$slots:{default:[_1]},$$scope:{ctx:W}}}),ka=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
`}}),vn=new je({props:{$$slots:{default:[v1]},$$scope:{ctx:W}}}),Fa=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ma=new ze({}),Ea=new S({props:{name:"class transformers.TFLongformerForMultipleChoice",anchor:"transformers.TFLongformerForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2469",parametersDescription:[{anchor:"transformers.TFLongformerForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),bn=new je({props:{$$slots:{default:[k1]},$$scope:{ctx:W}}}),Pa=new S({props:{name:"call",anchor:"transformers.TFLongformerForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2489",parametersDescription:[{anchor:"transformers.TFLongformerForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> for
details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/v4.14.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
`),be=a("code"),A=n("</s>"),V=n(")."),Te=l(),le=a("p"),G=n("This model was contributed by "),ve=a("a"),Me=n("beltagy"),we=n(". The Authors\u2019 code can be found "),ke=a("a"),Oh=n("here"),Ah=n("."),sd=l(),jt=a("h2"),Oo=a("a"),Vr=a("span"),v(xn.$$.fragment),Ih=l(),Gr=a("span"),Nh=n("Longformer Self Attention"),ad=l(),ye=a("p"),Sh=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),ti=a("code"),em=n("global_attention_mask"),tm=n(":"),wd=l(),Ao=a("ul"),oi=a("li"),om=n("0: the token attends \u201Clocally\u201D,"),nm=l(),ni=a("li"),sm=n("1: the token attends \u201Cglobally\u201D."),vd=l(),Io=a("p"),am=n("For more information please also refer to "),Na=a("a"),rm=n("forward()"),im=n(" method."),kd=l(),Ve=a("p"),lm=n(`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
...
\u201Clocally\u201D attending tokens.`),Ed=l(),No=a("p"),dm=n("For more information, please refer to the official "),$n=a("a"),cm=n("paper"),hm=n("."),zd=l(),Ot=a("h2"),So=a("a"),si=a("span"),v(Fn.$$.fragment),mm=l(),ai=a("span"),fm=n("Training"),qd=l(),At=a("p"),Sa=a("a"),pm=n("LongformerForMaskedLM"),gm=n(" is trained the exact same way "),Da=a("a"),um=n("RobertaForMaskedLM"),_m=n(` is
trained and should be used as follows:`),Cd=l(),v(Mn.$$.fragment),Pd=l(),It=a("h2"),Do=a("a"),ri=a("span"),v(En.$$.fragment),wm=l(),ii=a("span"),vm=n("LongformerConfig"),jd=l(),Oe=a("div"),v(zn.$$.fragment),km=l(),Nt=a("p"),bm=n("This is the configuration class to store the configuration of a "),Ba=a("a"),Tm=n("LongformerModel"),ym=n(` or a
...
custom CUDA kernel to be memory and compute efficient.`),rp=l(),Ge=a("div"),v(rs.$$.fragment),ip=l(),ro=a("p"),lp=n("The "),Ya=a("a"),dp=n("LongformerModel"),cp=n(" forward method, overrides the "),Oi=a("code"),hp=n("__call__"),mp=n(" special method."),fp=l(),v(Vo.$$.fragment),pp=l(),Ai=a("p"),gp=n("Examples:"),up=l(),v(is.$$.fragment),oc=l(),io=a("h2"),Go=a("a"),Ii=a("span"),v(ls.$$.fragment),_p=l(),Ni=a("span"),wp=n("LongformerForMaskedLM"),nc=l(),We=a("div"),v(ds.$$.fragment),vp=l(),cs=a("p"),kp=n("Longformer Model with a "),Si=a("em"),bp=n("language modeling"),Tp=n(" head on top."),yp=l(),hs=a("p"),Lp=n("This model inherits from "),Za=a("a"),xp=n("PreTrainedModel"),$p=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Fp=l(),ms=a("p"),Mp=n("This model is also a PyTorch "),fs=a("a"),Ep=n("torch.nn.Module"),zp=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),qp=l(),Ke=a("div"),v(ps.$$.fragment),Cp=l(),lo=a("p"),Pp=n("The "),er=a("a"),jp=n("LongformerForMaskedLM"),Op=n(" forward method, overrides the "),Di=a("code"),Ap=n("__call__"),Ip=n(" special method."),Np=l(),v(Ko.$$.fragment),Sp=l(),Bi=a("p"),Dp=n("Examples:"),Bp=l(),v(gs.$$.fragment),sc=l(),co=a("h2"),Jo=a("a"),Wi=a("span"),v(us.$$.fragment),Wp=l(),Qi=a("span"),Qp=n("LongformerForSequenceClassification"),ac=l(),Qe=a("div"),v(_s.$$.fragment),Hp=l(),Hi=a("p"),Rp=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),eg=l(),Ce=a("div"),v(bs.$$.fragment),tg=l(),ho=a("p"),og=n("The "),or=a("a"),ng=n("LongformerForSequenceClassification"),sg=n(" forward method, overrides the "),Ri=a("code"),ag=n("__call__"),rg=n(" special method."),ig=l(),v(Xo.$$.fragment),lg=l(),Ui=a("p"),dg=n("Example of single-label classification:"),cg=l(),v(Ts.$$.fragment),hg=l(),Vi=a("p"),mg=n("Example of multi-label classification:"),fg=l(),v(ys.$$.fragment),rc=l(),mo=a("h2"),Yo=a("a"),Gi=a("span"),v(Ls.$$.fragment),pg=l(),Ki=a("span"),gg=n("LongformerForMultipleChoice"),ic=l(),He=a("div"),v(xs.$$.fragment),ug=l(),Ji=a("p"),_g=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),wg=l(),$s=a("p"),vg=n("This model inherits from "),nr=a("a"),kg=n("PreTrainedModel"),bg=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Tg=l(),Fs=a("p"),yg=n("This model is also a PyTorch "),Ms=a("a"),Lg=n("torch.nn.Module"),xg=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),$g=l(),Je=a("div"),v(Es.$$.fragment),Fg=l(),fo=a("p"),Mg=n("The "),sr=a("a"),Eg=n("LongformerForMultipleChoice"),zg=n(" forward method, overrides the "),Xi=a("code"),qg=n("__call__"),Cg=n(" special method."),Pg=l(),v(Zo.$$.fragment),jg=l(),Yi=a("p"),Og=n("Example:"),Ag=l(),v(zs.$$.fragment),lc=l(),po=a("h2"),en=a("a"),Zi=a("span"),v(qs.$$.fragment),Ig=l(),el=a("span"),Ng=n("LongformerForTokenClassification"),dc=l(),Re=a("div"),v(Cs.$$.fragment),Sg=l(),tl=a("p"),Dg=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Kg=l(),Xe=a("div"),v(As.$$.fragment),Jg=l(),go=a("p"),Xg=n("The "),rr=a("a"),Yg=n("LongformerForTokenClassification"),Zg=n(" forward method, overrides the "),ol=a("code"),eu=n("__call__"),tu=n(" special method."),ou=l(),v(tn.$$.fragment),nu=l(),nl=a("p"),su=n("Example:"),au=l(),v(Is.$$.fragment),cc=l(),uo=a("h2"),on=a("a"),sl=a("span"),v(Ns.$$.fragment),ru=l(),al=a("span"),iu=n("LongformerForQuestionAnswering"),hc=l(),Ue=a("div"),v(Ss.$$.fragment),lu=l(),_o=a("p"),du=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),wu=l(),Bs=a("p"),vu=n("This model is also a PyTorch "),Ws=a("a"),ku=n("torch.nn.Module"),bu=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Tu=l(),Ye=a("div"),v(Qs.$$.fragment),yu=l(),wo=a("p"),Lu=n("The "),lr=a("a"),xu=n("LongformerForQuestionAnswering"),$u=n(" forward method, overrides the "),ll=a("code"),Fu=n("__call__"),Mu=n(" special method."),Eu=l(),v(nn.$$.fragment),zu=l(),dl=a("p"),qu=n("Examples:"),Cu=l(),v(Hs.$$.fragment),mc=l(),vo=a("h2"),sn=a("a"),cl=a("span"),v(Rs.$$.fragment),Pu=l(),hl=a("span"),ju=n("TFLongformerModel"),fc=l(),Ee=a("div"),v(Us.$$.fragment),Ou=l(),ml=a("p"),Au=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Iu=l(),Vs=a("p"),Nu=n("This model inherits from "),dr=a("a"),Su=n("TFPreTrainedModel"),Du=n(`. Check the superclass documentation for the
...
and behavior.`),Ru=l(),v(an.$$.fragment),Uu=l(),ko=a("p"),Vu=n("This class copies code from "),cr=a("a"),Gu=n("TFRobertaModel"),Ku=n(` and overwrites standard self-attention with
longformer self-attention to provide the ability to process long sequences following the self-attention approach
...
dilated attention are more relevant for autoregressive language modeling than finetuning on downstream tasks.
Future release will add support for autoregressive attention, but the support for dilated attention requires a
custom CUDA kernel to be memory and compute efficient.`),o_=l(),_t=a("div"),v(Ys.$$.fragment),n_=l(),bo=a("p"),s_=n("The "),hr=a("a"),a_=n("TFLongformerModel"),r_=n(" forward method, overrides the "),pl=a("code"),i_=n("__call__"),l_=n(" special method."),d_=l(),v(rn.$$.fragment),pc=l(),To=a("h2"),ln=a("a"),gl=a("span"),v(Zs.$$.fragment),c_=l(),ul=a("span"),h_=n("TFLongformerForMaskedLM"),gc=l(),Ae=a("div"),v(ea.$$.fragment),m_=l(),ta=a("p"),f_=n("Longformer Model with a "),_l=a("em"),p_=n("language modeling"),g_=n(" head on top."),u_=l(),oa=a("p"),__=n("This model inherits from "),mr=a("a"),w_=n("TFPreTrainedModel"),v_=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),k_=l(),na=a("p"),b_=n("This model is also a "),sa=a("a"),T_=n("tf.keras.Model"),y_=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),L_=l(),v(dn.$$.fragment),x_=l(),Ze=a("div"),v(aa.$$.fragment),$_=l(),yo=a("p"),F_=n("The "),fr=a("a"),M_=n("TFLongformerForMaskedLM"),E_=n(" forward method, overrides the "),wl=a("code"),z_=n("__call__"),q_=n(" special method."),C_=l(),v(cn.$$.fragment),P_=l(),vl=a("p"),j_=n("Example:"),O_=l(),v(ra.$$.fragment),uc=l(),Lo=a("h2"),hn=a("a"),kl=a("span"),v(ia.$$.fragment),A_=l(),bl=a("span"),I_=n("TFLongformerForQuestionAnswering"),_c=l(),Ie=a("div"),v(la.$$.fragment),N_=l(),xo=a("p"),S_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Y_=l(),v(mn.$$.fragment),Z_=l(),et=a("div"),v(ma.$$.fragment),ew=l(),$o=a("p"),tw=n("The "),gr=a("a"),ow=n("TFLongformerForQuestionAnswering"),nw=n(" forward method, overrides the "),Ll=a("code"),sw=n("__call__"),aw=n(" special method."),rw=l(),v(fn.$$.fragment),iw=l(),xl=a("p"),lw=n("Example:"),dw=l(),v(fa.$$.fragment),wc=l(),Fo=a("h2"),pn=a("a"),$l=a("span"),v(pa.$$.fragment),cw=l(),Fl=a("span"),hw=n("TFLongformerForSequenceClassification"),vc=l(),Ne=a("div"),v(ga.$$.fragment),mw=l(),Ml=a("p"),fw=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),ww=l(),_a=a("p"),vw=n("This model is also a "),wa=a("a"),kw=n("tf.keras.Model"),bw=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Tw=l(),v(gn.$$.fragment),yw=l(),tt=a("div"),v(va.$$.fragment),Lw=l(),Mo=a("p"),xw=n("The "),_r=a("a"),$w=n("TFLongformerForSequenceClassification"),Fw=n(" forward method, overrides the "),El=a("code"),Mw=n("__call__"),Ew=n(" special method."),zw=l(),v(un.$$.fragment),qw=l(),zl=a("p"),Cw=n("Example:"),Pw=l(),v(ka.$$.fragment),kc=l(),Eo=a("h2"),_n=a("a"),ql=a("span"),v(ba.$$.fragment),jw=l(),Cl=a("span"),Ow=n("TFLongformerForTokenClassification"),bc=l(),Se=a("div"),v(Ta.$$.fragment),Aw=l(),Pl=a("p"),Iw=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
token belongs to which segment. Just separate your segments with the separation token `),O=r(Ln,"CODE",{});var Ev=i(O);$e=s(Ev,"tokenizer.sep_token"),Ev.forEach(t),Fe=s(Ln,` (or
`),be=r(Ln,"CODE",{});var zv=i(be);A=s(zv,"</s>"),zv.forEach(t),V=s(Ln,")."),Ln.forEach(t),ed.forEach(t),Te=d(o),le=r(o,"P",{});var Tr=i(le);G=s(Tr,"This model was contributed by "),ve=r(Tr,"A",{href:!0,rel:!0});var qv=i(ve);Me=s(qv,"beltagy"),qv.forEach(t),we=s(Tr,". The Authors\u2019 code can be found "),ke=r(Tr,"A",{href:!0,rel:!0});var Cv=i(ke);Oh=s(Cv,"here"),Cv.forEach(t),Ah=s(Tr,"."),Tr.forEach(t),sd=d(o),jt=r(o,"H2",{class:!0});var xc=i(jt);Oo=r(xc,"A",{id:!0,class:!0,href:!0});var Pv=i(Oo);Vr=r(Pv,"SPAN",{});var jv=i(Vr);k(xn.$$.fragment,jv),jv.forEach(t),Pv.forEach(t),Ih=d(xc),Gr=r(xc,"SPAN",{});var Ov=i(Gr);Nh=s(Ov,"Longformer Self Attention"),Ov.forEach(t),xc.forEach(t),ad=d(o),ye=r(o,"P",{});var Pe=i(ye);Sh=s(Pe,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
size. It is assumed that the number of \u201Cglobally\u201D attending tokens is insignificant as compared to the number of
\u201Clocally\u201D attending tokens.`),wt.forEach(t),Ed=d(o),No=r(o,"P",{});var Mc=i(No);dm=s(Mc,"For more information, please refer to the official "),$n=r(Mc,"A",{href:!0,rel:!0});var Uv=i($n);cm=s(Uv,"paper"),Uv.forEach(t),hm=s(Mc,"."),Mc.forEach(t),zd=d(o),Ot=r(o,"H2",{class:!0});var Ec=i(Ot);So=r(Ec,"A",{id:!0,class:!0,href:!0});var Vv=i(So);si=r(Vv,"SPAN",{});var Gv=i(si);k(Fn.$$.fragment,Gv),Gv.forEach(t),Vv.forEach(t),mm=d(Ec),ai=r(Ec,"SPAN",{});var Kv=i(ai);fm=s(Kv,"Training"),Kv.forEach(t),Ec.forEach(t),qd=d(o),At=r(o,"P",{});var td=i(At);Sa=r(td,"A",{href:!0});var Jv=i(Sa);pm=s(Jv,"LongformerForMaskedLM"),Jv.forEach(t),gm=s(td," is trained the exact same way "),Da=r(td,"A",{href:!0});var Xv=i(Da);um=s(Xv,"RobertaForMaskedLM"),Xv.forEach(t),_m=s(td,` is
trained and should be used as follows:`),td.forEach(t),Cd=d(o),k(Mn.$$.fragment,o),Pd=d(o),It=r(o,"H2",{class:!0});var zc=i(It);Do=r(zc,"A",{id:!0,class:!0,href:!0});var Yv=i(Do);ri=r(Yv,"SPAN",{});var Zv=i(ri);k(En.$$.fragment,Zv),Zv.forEach(t),Yv.forEach(t),wm=d(zc),ii=r(zc,"SPAN",{});var ek=i(ii);vm=s(ek,"LongformerConfig"),ek.forEach(t),zc.forEach(t),jd=d(o),Oe=r(o,"DIV",{class:!0});var it=i(Oe);k(zn.$$.fragment,it),km=d(it),Nt=r(it,"P",{});var xr=i(Nt);bm=s(xr,"This is the configuration class to store the configuration of a "),Ba=r(xr,"A",{href:!0});var tk=i(Ba);Tm=s(tk,"LongformerModel"),tk.forEach(t),ym=s(xr,` or a
...
Matthew E. Peters, and Arman Cohan. Longformer self-attention combines a local (sliding window) and global
attention to extend to long documents without the O(n^2) increase in memory and compute.`),zr.forEach(t),op=d(st),as=r(st,"P",{});var Yc=i(as);np=s(Yc,"The self-attention module "),ji=r(Yc,"CODE",{});var Rk=i(ji);sp=s(Rk,"LongformerSelfAttention"),Rk.forEach(t),ap=s(Yc,` implemented here supports the combination of local and
global attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and
dilated attention are more relevant for autoregressive language modeling than finetuning on downstream tasks.
Future release will add support for autoregressive attention, but the support for dilated attention requires a
custom CUDA kernel to be memory and compute efficient.`),Yc.forEach(t),rp=d(st),Ge=r(st,"DIV",{class:!0});var vt=i(Ge);k(rs.$$.fragment,vt),ip=d(vt),ro=r(vt,"P",{});var qr=i(ro);lp=s(qr,"The "),Ya=r(qr,"A",{href:!0});var Uk=i(Ya);dp=s(Uk,"LongformerModel"),Uk.forEach(t),cp=s(qr," forward method, overrides the "),Oi=r(qr,"CODE",{});var Vk=i(Oi);hp=s(Vk,"__call__"),Vk.forEach(t),mp=s(qr," special method."),qr.forEach(t),fp=d(vt),k(Vo.$$.fragment,vt),pp=d(vt),Ai=r(vt,"P",{});var Gk=i(Ai);gp=s(Gk,"Examples:"),Gk.forEach(t),up=d(vt),k(is.$$.fragment,vt),vt.forEach(t),st.forEach(t),oc=d(o),io=r(o,"H2",{class:!0});var Zc=i(io);Go=r(Zc,"A",{id:!0,class:!0,href:!0});var Kk=i(Go);Ii=r(Kk,"SPAN",{});var Jk=i(Ii);k(ls.$$.fragment,Jk),Jk.forEach(t),Kk.forEach(t),_p=d(Zc),Ni=r(Zc,"SPAN",{});var Xk=i(Ni);wp=s(Xk,"LongformerForMaskedLM"),Xk.forEach(t),Zc.forEach(t),nc=d(o),We=r(o,"DIV",{class:!0});var kt=i(We);k(ds.$$.fragment,kt),vp=d(kt),cs=r(kt,"P",{});var eh=i(cs);kp=s(eh,"Longformer Model with a "),Si=r(eh,"EM",{});var Yk=i(Si);bp=s(Yk,"language modeling"),Yk.forEach(t),Tp=s(eh," head on top."),eh.forEach(t),yp=d(kt),hs=r(kt,"P",{});var th=i(hs);Lp=s(th,"This model inherits from "),Za=r(th,"A",{href:!0});var Zk=i(Za);xp=s(Zk,"PreTrainedModel"),Zk.forEach(t),$p=s(th,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),th.forEach(t),Fp=d(kt),ms=r(kt,"P",{});var oh=i(ms);Mp=s(oh,"This model is also a PyTorch "),fs=r(oh,"A",{href:!0,rel:!0});var eb=i(fs);Ep=s(eb,"torch.nn.Module"),eb.forEach(t),zp=s(oh,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),oh.forEach(t),qp=d(kt),Ke=r(kt,"DIV",{class:!0});var bt=i(Ke);k(ps.$$.fragment,bt),Cp=d(bt),lo=r(bt,"P",{});var Cr=i(lo);Pp=s(Cr,"The "),er=r(Cr,"A",{href:!0});var tb=i(er);jp=s(tb,"LongformerForMaskedLM"),tb.forEach(t),Op=s(Cr," forward method, overrides the "),Di=r(Cr,"CODE",{});var ob=i(Di);Ap=s(ob,"__call__"),ob.forEach(t),Ip=s(Cr," special method."),Cr.forEach(t),Np=d(bt),k(Ko.$$.fragment,bt),Sp=d(bt),Bi=r(bt,"P",{});var nb=i(Bi);Dp=s(nb,"Examples:"),nb.forEach(t),Bp=d(bt),k(gs.$$.fragment,bt),bt.forEach(t),kt.forEach(t),sc=d(o),co=r(o,"H2",{class:!0});var nh=i(co);Jo=r(nh,"A",{id:!0,class:!0,href:!0});var sb=i(Jo);Wi=r(sb,"SPAN",{});var ab=i(Wi);k(us.$$.fragment,ab),ab.forEach(t),sb.forEach(t),Wp=d(nh),Qi=r(nh,"SPAN",{});var rb=i(Qi);Qp=s(rb,"LongformerForSequenceClassification"),rb.forEach(t),nh.forEach(t),ac=d(o),Qe=r(o,"DIV",{class:!0});var Tt=i(Qe);k(_s.$$.fragment,Tt),Hp=d(Tt),Hi=r(Tt,"P",{});var ib=i(Hi);Rp=s(ib,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),hh.forEach(t),Kg=d(xt),Xe=r(xt,"DIV",{class:!0});var $t=i(Xe);k(As.$$.fragment,$t),Jg=d($t),go=r($t,"P",{});var Or=i(go);Xg=s(Or,"The "),rr=r(Or,"A",{href:!0});var Eb=i(rr);Yg=s(Eb,"LongformerForTokenClassification"),Eb.forEach(t),Zg=s(Or," forward method, overrides the "),ol=r(Or,"CODE",{});var zb=i(ol);eu=s(zb,"__call__"),zb.forEach(t),tu=s(Or," special method."),Or.forEach(t),ou=d($t),k(tn.$$.fragment,$t),nu=d($t),nl=r($t,"P",{});var qb=i(nl);su=s(qb,"Example:"),qb.forEach(t),au=d($t),k(Is.$$.fragment,$t),$t.forEach(t),xt.forEach(t),cc=d(o),uo=r(o,"H2",{class:!0});var mh=i(uo);on=r(mh,"A",{id:!0,class:!0,href:!0});var Cb=i(on);sl=r(Cb,"SPAN",{});var Pb=i(sl);k(Ns.$$.fragment,Pb),Pb.forEach(t),Cb.forEach(t),ru=d(mh),al=r(mh,"SPAN",{});var jb=i(al);iu=s(jb,"LongformerForQuestionAnswering"),jb.forEach(t),mh.forEach(t),hc=d(o),Ue=r(o,"DIV",{class:!0});var Ft=i(Ue);k(Ss.$$.fragment,Ft),lu=d(Ft),_o=r(Ft,"P",{});var Ar=i(_o);du=s(Ar,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),fh.forEach(t),wu=d(Ft),Bs=r(Ft,"P",{});var ph=i(Bs);vu=s(ph,"This model is also a PyTorch "),Ws=r(ph,"A",{href:!0,rel:!0});var Nb=i(Ws);ku=s(Nb,"torch.nn.Module"),Nb.forEach(t),bu=s(ph,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),ph.forEach(t),Tu=d(Ft),Ye=r(Ft,"DIV",{class:!0});var Mt=i(Ye);k(Qs.$$.fragment,Mt),yu=d(Mt),wo=r(Mt,"P",{});var Ir=i(wo);Lu=s(Ir,"The "),lr=r(Ir,"A",{href:!0});var Sb=i(lr);xu=s(Sb,"LongformerForQuestionAnswering"),Sb.forEach(t),$u=s(Ir," forward method, overrides the "),ll=r(Ir,"CODE",{});var Db=i(ll);Fu=s(Db,"__call__"),Db.forEach(t),Mu=s(Ir," special method."),Ir.forEach(t),Eu=d(Mt),k(nn.$$.fragment,Mt),zu=d(Mt),dl=r(Mt,"P",{});var Bb=i(dl);qu=s(Bb,"Examples:"),Bb.forEach(t),Cu=d(Mt),k(Hs.$$.fragment,Mt),Mt.forEach(t),Ft.forEach(t),mc=d(o),vo=r(o,"H2",{class:!0});var gh=i(vo);sn=r(gh,"A",{id:!0,class:!0,href:!0});var Wb=i(sn);cl=r(Wb,"SPAN",{});var Qb=i(cl);k(Rs.$$.fragment,Qb),Qb.forEach(t),Wb.forEach(t),Pu=d(gh),hl=r(gh,"SPAN",{});var Hb=i(hl);ju=s(Hb,"TFLongformerModel"),Hb.forEach(t),gh.forEach(t),fc=d(o),Ee=r(o,"DIV",{class:!0});var Be=i(Ee);k(Us.$$.fragment,Be),Ou=d(Be),ml=r(Be,"P",{});var Rb=i(ml);Au=s(Rb,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Rb.forEach(t),Iu=d(Be),Vs=r(Be,"P",{});var uh=i(Vs);Nu=s(uh,"This model inherits from "),dr=r(uh,"A",{href:!0});var Ub=i(dr);Su=s(Ub,"TFPreTrainedModel"),Ub.forEach(t),Du=s(uh,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),_h.forEach(t),Ru=d(Be),k(an.$$.fragment,Be),Uu=d(Be),ko=r(Be,"P",{});var Nr=i(ko);Vu=s(Nr,"This class copies code from "),cr=r(Nr,"A",{href:!0});var Gb=i(cr);Gu=s(Gb,"TFRobertaModel"),Gb.forEach(t),Ku=s(Nr,` and overwrites standard self-attention with
longformer self-attention to provide the ability to process long sequences following the self-attention approach
...
dilated attention are more relevant for autoregressive language modeling than finetuning on downstream tasks.
Future release will add support for autoregressive attention, but the support for dilated attention requires a
custom CUDA kernel to be memory and compute efficient.`),wh.forEach(t),o_=d(Be),_t=r(Be,"DIV",{class:!0});var Sr=i(_t);k(Ys.$$.fragment,Sr),n_=d(Sr),bo=r(Sr,"P",{});var Dr=i(bo);s_=s(Dr,"The "),hr=r(Dr,"A",{href:!0});var Xb=i(hr);a_=s(Xb,"TFLongformerModel"),Xb.forEach(t),r_=s(Dr," forward method, overrides the "),pl=r(Dr,"CODE",{});var Yb=i(pl);i_=s(Yb,"__call__"),Yb.forEach(t),l_=s(Dr," special method."),Dr.forEach(t),d_=d(Sr),k(rn.$$.fragment,Sr),Sr.forEach(t),Be.forEach(t),pc=d(o),To=r(o,"H2",{class:!0});var vh=i(To);ln=r(vh,"A",{id:!0,class:!0,href:!0});var Zb=i(ln);gl=r(Zb,"SPAN",{});var eT=i(gl);k(Zs.$$.fragment,eT),eT.forEach(t),Zb.forEach(t),c_=d(vh),ul=r(vh,"SPAN",{});var tT=i(ul);h_=s(tT,"TFLongformerForMaskedLM"),tT.forEach(t),vh.forEach(t),gc=d(o),Ae=r(o,"DIV",{class:!0});var lt=i(Ae);k(ea.$$.fragment,lt),m_=d(lt),ta=r(lt,"P",{});var kh=i(ta);f_=s(kh,"Longformer Model with a "),_l=r(kh,"EM",{});var oT=i(_l);p_=s(oT,"language modeling"),oT.forEach(t),g_=s(kh," head on top."),kh.forEach(t),u_=d(lt),oa=r(lt,"P",{});var bh=i(oa);__=s(bh,"This model inherits from "),mr=r(bh,"A",{href:!0});var nT=i(mr);w_=s(nT,"TFPreTrainedModel"),nT.forEach(t),v_=s(bh,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),bh.forEach(t),k_=d(lt),na=r(lt,"P",{});var Th=i(na);b_=s(Th,"This model is also a "),sa=r(Th,"A",{href:!0,rel:!0});var sT=i(sa);T_=s(sT,"tf.keras.Model"),sT.forEach(t),y_=s(Th,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Th.forEach(t),L_=d(lt),k(dn.$$.fragment,lt),x_=d(lt),Ze=r(lt,"DIV",{class:!0});var Et=i(Ze);k(aa.$$.fragment,Et),$_=d(Et),yo=r(Et,"P",{});var Br=i(yo);F_=s(Br,"The "),fr=r(Br,"A",{href:!0});var aT=i(fr);M_=s(aT,"TFLongformerForMaskedLM"),aT.forEach(t),E_=s(Br," forward method, overrides the "),wl=r(Br,"CODE",{});var rT=i(wl);z_=s(rT,"__call__"),rT.forEach(t),q_=s(Br," special method."),Br.forEach(t),C_=d(Et),k(cn.$$.fragment,Et),P_=d(Et),vl=r(Et,"P",{});var iT=i(vl);j_=s(iT,"Example:"),iT.forEach(t),O_=d(Et),k(ra.$$.fragment,Et),Et.forEach(t),lt.forEach(t),uc=d(o),Lo=r(o,"H2",{class:!0});var yh=i(Lo);hn=r(yh,"A",{id:!0,class:!0,href:!0});var lT=i(hn);kl=r(lT,"SPAN",{});var dT=i(kl);k(ia.$$.fragment,dT),dT.forEach(t),lT.forEach(t),A_=d(yh),bl=r(yh,"SPAN",{});var cT=i(bl);I_=s(cT,"TFLongformerForQuestionAnswering"),cT.forEach(t),yh.forEach(t),_c=d(o),Ie=r(o,"DIV",{class:!0});var dt=i(Ie);k(la.$$.fragment,dt),N_=d(dt),xo=r(dt,"P",{});var Wr=i(xo);S_=s(Wr,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Fh.forEach(t),ww=d(ct),_a=r(ct,"P",{});var Mh=i(_a);vw=s(Mh,"This model is also a "),wa=r(Mh,"A",{href:!0,rel:!0});var yT=i(wa);kw=s(yT,"tf.keras.Model"),yT.forEach(t),bw=s(Mh,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Mh.forEach(t),Tw=d(ct),k(gn.$$.fragment,ct),yw=d(ct),tt=r(ct,"DIV",{class:!0});var qt=i(tt);k(va.$$.fragment,qt),Lw=d(qt),Mo=r(qt,"P",{});var Hr=i(Mo);xw=s(Hr,"The "),_r=r(Hr,"A",{href:!0});var LT=i(_r);$w=s(LT,"TFLongformerForSequenceClassification"),LT.forEach(t),Fw=s(Hr," forward method, overrides the "),El=r(Hr,"CODE",{});var xT=i(El);Mw=s(xT,"__call__"),xT.forEach(t),Ew=s(Hr," special method."),Hr.forEach(t),zw=d(qt),k(un.$$.fragment,qt),qw=d(qt),zl=r(qt,"P",{});var $T=i(zl);Cw=s($T,"Example:"),$T.forEach(t),Pw=d(qt),k(ka.$$.fragment,qt),qt.forEach(t),ct.forEach(t),kc=d(o),Eo=r(o,"H2",{class:!0});var Eh=i(Eo);_n=r(Eh,"A",{id:!0,class:!0,href:!0});var FT=i(_n);ql=r(FT,"SPAN",{});var MT=i(ql);k(ba.$$.fragment,MT),MT.forEach(t),FT.forEach(t),jw=d(Eh),Cl=r(Eh,"SPAN",{});var ET=i(Cl);Ow=s(ET,"TFLongformerForTokenClassification"),ET.forEach(t),Eh.forEach(t),bc=d(o),Se=r(o,"DIV",{class:!0});var ht=i(Se);k(Ta.$$.fragment,ht),Aw=d(ht),Pl=r(ht,"P",{});var zT=i(Pl);Iw=s(zT,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
