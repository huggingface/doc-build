import{S as Fy,i as By,s as $y,e as n,k as d,w as m,t as r,L as jy,c as a,d as t,m as l,a as s,x as f,h as i,b as c,J as e,g as u,y as _,q as g,o as b,B as v}from"../../../chunks/vendor-b1433968.js";import{T as Ue}from"../../../chunks/Tip-c3840994.js";import{D as $}from"../../../chunks/Docstring-ff504c58.js";import{C as E}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as U}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function qy(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function My(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Py(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Ey(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Cy(M){let p,F,k,x,z,T,y,B,He,ke,j,Ce,le,Qe,ce,pe,Ve,We,G,I,Ae,Y,P,C,Je,ae,se,Xe,W,Ke,Ze,N,ye,he,Re,H,ee,Ye,et,R,tt,ue,Se;return{c(){p=n("p"),F=r("TF 2.0 models accepts two formats as inputs:"),k=d(),x=n("ul"),z=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),He=r("having all inputs as a list, tuple or dict in the first positional arguments."),ke=d(),j=n("p"),Ce=r("This second option is useful when using "),le=n("code"),Qe=r("tf.keras.Model.fit"),ce=r(` method which currently requires having all
...
the first positional argument :`),Y=d(),P=n("ul"),C=n("li"),Je=r("a single Tensor with "),ae=n("code"),se=r("input_ids"),Xe=r(" only and nothing else: "),W=n("code"),Ke=r("model(input_ids)"),Ze=d(),N=n("li"),ye=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),ue=a(De,"CODE",{});var Ot=s(ue);Se=i(Ot,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ot.forEach(t),De.forEach(t),oe.forEach(t)},m(w,q){u(w,p,q),e(p,F),u(w,k,q),u(w,x,q),e(x,z),e(z,T),e(x,y),e(x,B),e(B,He),u(w,ke,q),u(w,j,q),e(j,Ce),e(j,le),e(le,Qe),e(j,ce),e(j,pe),e(pe,Ve),e(j,We),u(w,G,q),u(w,I,q),e(I,Ae),u(w,Y,q),u(w,P,q),e(P,C),e(C,Je),e(C,ae),e(ae,se),e(C,Xe),e(C,W),e(W,Ke),e(P,Ze),e(P,N),e(N,ye),e(N,he),e(he,Re),e(N,H),e(N,ee),e(ee,Ye),e(P,et),e(P,R),e(R,tt),e(R,ue),e(ue,Se)},d(w){w&&t(p),w&&t(k),w&&t(x),w&&t(ke),w&&t(j),w&&t(G),w&&t(I),w&&t(Y),w&&t(P)}}}function Ay(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Sy(M){let p,F,k,x,z,T,y,B,He,ke,j,Ce,le,Qe,ce,pe,Ve,We,G,I,Ae,Y,P,C,Je,ae,se,Xe,W,Ke,Ze,N,ye,he,Re,H,ee,Ye,et,R,tt,ue,Se;return{c(){p=n("p"),F=r("TF 2.0 models accepts two formats as inputs:"),k=d(),x=n("ul"),z=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),He=r("having all inputs as a list, tuple or dict in the first positional arguments."),ke=d(),j=n("p"),Ce=r("This second option is useful when using "),le=n("code"),Qe=r("tf.keras.Model.fit"),ce=r(` method which currently requires having all
the tensors in the first argument of the model call function: `),pe=n("code"),Ve=r("model(inputs)"),We=r("."),G=d(),I=n("p"),Ae=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),Y=d(),P=n("ul"),C=n("li"),Je=r("a single Tensor with "),ae=n("code"),se=r("input_ids"),Xe=r(" only and nothing else: "),W=n("code"),Ke=r("model(input_ids)"),Ze=d(),N=n("li"),ye=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),he=n("code"),Re=r("model([input_ids, attention_mask])"),H=r(" or "),ee=n("code"),Ye=r("model([input_ids, attention_mask, token_type_ids])"),et=d(),R=n("li"),tt=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ue=n("code"),Se=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){p=a(w,"P",{});var q=s(p);F=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),k=l(w),x=a(w,"UL",{});var L=s(x);z=a(L,"LI",{});var At=s(z);T=i(At,"having all inputs as keyword arguments (like PyTorch models), or"),At.forEach(t),y=l(L),B=a(L,"LI",{});var Ie=s(B);He=i(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),L.forEach(t),ke=l(w),j=a(w,"P",{});var te=s(j);Ce=i(te,"This second option is useful when using "),le=a(te,"CODE",{});var St=s(le);Qe=i(St,"tf.keras.Model.fit"),St.forEach(t),ce=i(te,` method which currently requires having all
...
the first positional argument :`),It.forEach(t),Y=l(w),P=a(w,"UL",{});var oe=s(P);C=a(oe,"LI",{});var re=s(C);Je=i(re,"a single Tensor with "),ae=a(re,"CODE",{});var me=s(ae);se=i(me,"input_ids"),me.forEach(t),Xe=i(re," only and nothing else: "),W=a(re,"CODE",{});var Te=s(W);Ke=i(Te,"model(input_ids)"),Te.forEach(t),re.forEach(t),Ze=l(oe),N=a(oe,"LI",{});var ne=s(N);ye=i(ne,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),he=a(ne,"CODE",{});var Oe=s(he);Re=i(Oe,"model([input_ids, attention_mask])"),Oe.forEach(t),H=i(ne," or "),ee=a(ne,"CODE",{});var Nt=s(ee);Ye=i(Nt,"model([input_ids, attention_mask, token_type_ids])"),Nt.forEach(t),ne.forEach(t),et=l(oe),R=a(oe,"LI",{});var De=s(R);tt=i(De,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ue=a(De,"CODE",{});var Ot=s(ue);Se=i(Ot,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ot.forEach(t),De.forEach(t),oe.forEach(t)},m(w,q){u(w,p,q),e(p,F),u(w,k,q),u(w,x,q),e(x,z),e(z,T),e(x,y),e(x,B),e(B,He),u(w,ke,q),u(w,j,q),e(j,Ce),e(j,le),e(le,Qe),e(j,ce),e(j,pe),e(pe,Ve),e(j,We),u(w,G,q),u(w,I,q),e(I,Ae),u(w,Y,q),u(w,P,q),e(P,C),e(C,Je),e(C,ae),e(ae,se),e(C,Xe),e(C,W),e(W,Ke),e(P,Ze),e(P,N),e(N,ye),e(N,he),e(he,Re),e(N,H),e(N,ee),e(ee,Ye),e(P,et),e(P,R),e(R,tt),e(R,ue),e(ue,Se)},d(w){w&&t(p),w&&t(k),w&&t(x),w&&t(ke),w&&t(j),w&&t(G),w&&t(I),w&&t(Y),w&&t(P)}}}function Iy(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Ny(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Oy(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Dy(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Ly(M){let p,F,k,x,z;return{c(){p=n("p"),F=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=n("code"),x=r("Module"),z=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);F=i(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),k=a(y,"CODE",{});var B=s(k);x=i(B,"Module"),B.forEach(t),z=i(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,F),e(p,k),e(k,x),e(p,z)},d(T){T&&t(p)}}}function Gy(M){let p,F,k,x,z,T,y,B,He,ke,j,Ce,le,Qe,ce,pe,Ve,We,G,I,Ae,Y,P,C,Je,ae,se,Xe,W,Ke,Ze,N,ye,he,Re,H,ee,Ye,et,R,tt,ue,Se,w,q,L,At,Ie,te,St,Ne,It,oe,re,me,Te,ne,Oe,Nt,De,Ot,Hd,ct,an,hc,sn,uc,mc,fc,ot,_c,js,gc,bc,Nr,vc,kc,rn,yc,Tc,xc,ko,dn,wc,zc,ln,Fc,Bc,Qd,Dt,yo,Or,cn,$c,Dr,jc,Vd,xe,nt,qc,Lr,Mc,Pc,qs,Ec,Cc,Ms,Ac,Sc,Ic,Lt,Nc,Ps,Oc,Dc,Gr,Lc,Gc,Wc,Gt,Rc,Wr,Uc,Hc,Rr,Qc,Vc,Jc,Es,Cs,Xc,Kc,Zc,Wt,Yc,Ur,ep,tp,Hr,op,np,Jd,Rt,To,Qr,pn,ap,Vr,sp,Xd,pt,rp,Jr,ip,dp,Xr,lp,cp,Kd,hn,Zd,Ut,xo,Kr,un,pp,Zr,hp,Yd,fe,mn,up,Ht,mp,As,fp,_p,fn,gp,bp,vp,Qt,kp,Ss,yp,Tp,Is,xp,wp,zp,Yr,Fp,Bp,_n,el,Vt,wo,ei,gn,$p,ti,jp,tl,at,bn,qp,oi,Mp,Pp,ht,Ns,Ep,Cp,Os,Ap,Sp,Ds,Ip,Np,ol,Jt,zo,ni,vn,Op,ai,Dp,nl,st,kn,Lp,yn,Gp,si,Wp,Rp,Up,ut,Ls,Hp,Qp,Gs,Vp,Jp,Ws,Xp,Kp,al,Xt,Fo,ri,Tn,Zp,ii,Yp,sl,Le,xn,eh,wn,th,Rs,oh,nh,ah,zn,sh,Fn,rh,ih,dh,we,Bn,lh,Kt,ch,Us,ph,hh,di,uh,mh,fh,Bo,_h,li,gh,bh,$n,rl,Zt,$o,ci,jn,vh,pi,kh,il,Ge,qn,yh,Mn,Th,Hs,xh,wh,zh,Pn,Fh,En,Bh,$h,jh,Q,Cn,qh,Yt,Mh,Qs,Ph,Eh,hi,Ch,Ah,Sh,jo,Ih,ui,Nh,Oh,An,Dh,mi,Lh,Gh,Sn,dl,eo,qo,fi,In,Wh,_i,Rh,ll,_e,Nn,Uh,gi,Hh,Qh,On,Vh,Vs,Jh,Xh,Kh,Dn,Zh,Ln,Yh,eu,tu,V,Gn,ou,to,nu,Js,au,su,bi,ru,iu,du,Mo,lu,vi,cu,pu,Wn,hu,ki,uu,mu,Rn,cl,oo,Po,yi,Un,fu,Ti,_u,pl,ge,Hn,gu,no,bu,xi,vu,ku,wi,yu,Tu,xu,Qn,wu,Xs,zu,Fu,Bu,Vn,$u,Jn,ju,qu,Mu,ze,Xn,Pu,ao,Eu,Ks,Cu,Au,zi,Su,Iu,Nu,Eo,Ou,Fi,Du,Lu,Kn,hl,so,Co,Bi,Zn,Gu,$i,Wu,ul,Yn,mt,ea,Ru,ji,Uu,Hu,ta,ml,ro,Ao,qi,oa,Qu,Mi,Vu,fl,be,na,Ju,aa,Xu,Zs,Ku,Zu,Yu,sa,em,ra,tm,om,nm,So,am,Fe,ia,sm,io,rm,Ys,im,dm,Pi,lm,cm,pm,Io,hm,Ei,um,mm,da,_l,lo,No,Ci,la,fm,Ai,_m,gl,ve,ca,gm,pa,bm,er,vm,km,ym,ha,Tm,ua,xm,wm,zm,Oo,Fm,J,ma,Bm,co,$m,tr,jm,qm,Si,Mm,Pm,Em,Do,Cm,Ii,Am,Sm,fa,Im,Ni,Nm,Om,_a,bl,po,Lo,Oi,ga,Dm,Di,Lm,vl,O,ba,Gm,va,Wm,or,Rm,Um,Hm,ka,Qm,ya,Vm,Jm,Xm,Li,Km,Zm,rt,Gi,Ta,Ym,ef,Wi,xa,tf,of,Ri,wa,nf,af,Ui,za,sf,rf,Be,Fa,df,ho,lf,Hi,cf,pf,Qi,hf,uf,mf,Go,ff,Vi,_f,gf,Ba,bf,ft,$a,vf,Ji,kf,yf,ja,Tf,_t,qa,xf,Xi,wf,zf,Ma,kl,uo,Wo,Ki,Pa,Ff,Zi,Bf,yl,D,Ea,$f,Ca,jf,nr,qf,Mf,Pf,Aa,Ef,Sa,Cf,Af,Sf,Yi,If,Nf,it,ed,Ia,Of,Df,td,Na,Lf,Gf,od,Oa,Wf,Rf,nd,Da,Uf,Hf,X,La,Qf,mo,Vf,ad,Jf,Xf,sd,Kf,Zf,Yf,Ro,e_,rd,t_,o_,Ga,n_,id,a_,s_,Wa,r_,gt,Ra,i_,dd,d_,l_,Ua,c_,bt,Ha,p_,ld,h_,u_,Qa,Tl,fo,Uo,cd,Va,m_,pd,f_,xl,A,Ja,__,hd,g_,b_,Xa,v_,ar,k_,y_,T_,Ka,x_,Za,w_,z_,F_,ud,B_,$_,dt,md,Ya,j_,q_,fd,es,M_,P_,_d,ts,E_,C_,gd,os,A_,S_,$e,ns,I_,_o,N_,bd,O_,D_,vd,L_,G_,W_,Ho,R_,kd,U_,H_,as,Q_,vt,ss,V_,yd,J_,X_,rs,K_,kt,is,Z_,Td,Y_,eg,ds,wl,go,Qo,xd,ls,tg,wd,og,zl,S,cs,ng,bo,ag,zd,sg,rg,Fd,ig,dg,lg,ps,cg,sr,pg,hg,ug,hs,mg,us,fg,_g,gg,Bd,bg,vg,lt,$d,ms,kg,yg,jd,fs,Tg,xg,qd,_s,wg,zg,Md,gs,Fg,Bg,je,bs,$g,vo,jg,Pd,qg,Mg,Ed,Pg,Eg,Cg,Vo,Ag,Cd,Sg,Ig,vs,Ng,yt,ks,Og,Ad,Dg,Lg,ys,Gg,Tt,Ts,Wg,Sd,Rg,Ug,xs,Fl;return T=new U({}),Y=new U({}),Oe=new U({}),cn=new U({}),pn=new U({}),hn=new E({props:{code:`from transformers import BartForConditionalGeneration, BartTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),gn=new U({}),bn=new $({props:{name:"class transformers.BartTokenizer",anchor:"transformers.BartTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/tokenization_bart.py#L55"}}),vn=new U({}),kn=new $({props:{name:"class transformers.BartTokenizerFast",anchor:"transformers.BartTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/tokenization_bart_fast.py#L64"}}),Tn=new U({}),xn=new $({props:{name:"class transformers.BartModel",anchor:"transformers.BartModel",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_bart.py#L1125",parametersDescription:[{anchor:"transformers.BartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Bn=new $({props:{name:"forward",anchor:"transformers.BartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_bart.py#L1152",parametersDescription:[{anchor:"transformers.BartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartConfig"
...
`}}),Bo=new Ue({props:{$$slots:{default:[qy]},$$scope:{ctx:M}}}),$n=new E({props:{code:`from transformers import BartTokenizer, BartModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),jn=new U({}),qn=new $({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_bart.py#L1244",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Cn=new $({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_bart.py#L1283",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
...
`}}),jo=new Ue({props:{$$slots:{default:[My]},$$scope:{ctx:M}}}),An=new E({props:{code:`from transformers import BartTokenizer, BartForConditionalGeneration, BartConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predictions).split()`}}),In=new U({}),Nn=new $({props:{name:"class transformers.BartForSequenceClassification",anchor:"transformers.BartForSequenceClassification",parameters:[{name:"config",val:": BartConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_bart.py#L1410",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Gn=new $({props:{name:"forward",anchor:"transformers.BartForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_bart.py#L1423",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),oa=new U({}),na=new $({props:{name:"class transformers.TFBartModel",anchor:"transformers.TFBartModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_tf_bart.py#L1182",parametersDescription:[{anchor:"transformers.TFBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),la=new U({}),ca=new $({props:{name:"class transformers.TFBartForConditionalGeneration",anchor:"transformers.TFBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_tf_bart.py#L1291",parametersDescription:[{anchor:"transformers.TFBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the
model weights.`,name:"config"}]}}),Oo=new Ue({props:{$$slots:{default:[Sy]},$$scope:{ctx:M}}}),ma=new $({props:{name:"call",anchor:"transformers.TFBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_tf_bart.py#L1326",parametersDescription:[{anchor:"transformers.TFBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
`}}),Do=new Ue({props:{$$slots:{default:[Iy]},$$scope:{ctx:M}}}),fa=new E({props:{code:`from transformers import BartTokenizer, TFBartForConditionalGeneration, BartConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&#x27;jax&#x27;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),Ha=new $({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_flax_bart.py#L1337",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>start_scores = outputs.start_logits
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),ks=new $({props:{name:"encode",anchor:"transformers.FlaxBartPreTrainedModel.encode",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bart/modeling_flax_bart.py#L1008",parametersDescription:[{anchor:"transformers.FlaxBartPreTrainedModel.encode.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See
<a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("meta"),F=d(),k=n("h1"),x=n("a"),z=n("span"),m(T.$$.fragment),y=d(),B=n("span"),He=r("BART"),ke=d(),j=n("p"),Ce=n("strong"),le=r("DISCLAIMER:"),Qe=r(" If you see something strange, file a "),ce=n("a"),pe=r("Github Issue"),Ve=r(` and assign
...
`),sn=n("a"),uc=r("examples/pytorch/summarization/"),mc=r("."),fc=d(),ot=n("li"),_c=r("An example of how to train "),js=n("a"),gc=r("BartForConditionalGeneration"),bc=r(" with a Hugging Face "),Nr=n("code"),vc=r("datasets"),kc=r(`
object can be found in this `),rn=n("a"),yc=r("forum discussion"),Tc=r("."),xc=d(),ko=n("li"),dn=n("a"),wc=r("Distilled checkpoints"),zc=r(" are described in this "),ln=n("a"),Fc=r("paper"),Bc=r("."),Qd=d(),Dt=n("h2"),yo=n("a"),Or=n("span"),m(cn.$$.fragment),$c=d(),Dr=n("span"),jc=r("Implementation Notes"),Vd=d(),xe=n("ul"),nt=n("li"),qc=r("Bart doesn\u2019t use "),Lr=n("code"),Mc=r("token_type_ids"),Pc=r(" for sequence classification. Use "),qs=n("a"),Ec=r("BartTokenizer"),Cc=r(` or
...
configuration with the defaults will yield a similar configuration to that of the BART `),fn=n("a"),gp=r("facebook/bart-large"),bp=r(" architecture."),vp=d(),Qt=n("p"),kp=r("Configuration objects inherit from "),Ss=n("a"),yp=r("PretrainedConfig"),Tp=r(` and can be used to control the model
...
layer on top of the hidden-states output to compute `),xi=n("em"),vu=r("span start logits"),ku=r(" and "),wi=n("em"),yu=r("span end logits"),Tu=r(")."),xu=d(),Qn=n("p"),wu=r("This model inherits from "),Xs=n("a"),zu=r("PreTrainedModel"),Fu=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
and behavior.`),nm=d(),m(So.$$.fragment),am=d(),Fe=n("div"),m(ia.$$.fragment),sm=d(),io=n("p"),rm=r("The "),Ys=n("a"),im=r("TFBartModel"),dm=r(" forward method, overrides the "),Pi=n("code"),lm=r("__call__"),cm=r(" special method."),pm=d(),m(Io.$$.fragment),hm=d(),Ei=n("p"),um=r("Example:"),mm=d(),m(da.$$.fragment),_l=d(),lo=n("h2"),No=n("a"),Ci=n("span"),m(la.$$.fragment),fm=d(),Ai=n("span"),_m=r("TFBartForConditionalGeneration"),gl=d(),ve=n("div"),m(ca.$$.fragment),gm=d(),pa=n("p"),bm=r(`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),er=n("a"),vm=r("TFPreTrainedModel"),km=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),ym=d(),ha=n("p"),Tm=r("This model is also a "),ua=n("a"),xm=r("tf.keras.Model"),wm=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
...
tasks.`),b_=d(),Xa=n("p"),v_=r("This model inherits from "),ar=n("a"),k_=r("FlaxPreTrainedModel"),y_=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
...
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),gg=d(),Bd=n("p"),bg=r("Finally, this model supports inherent JAX features such as:"),vg=d(),lt=n("ul"),$d=n("li"),ms=n("a"),kg=r("Just-In-Time (JIT) compilation"),yg=d(),jd=n("li"),fs=n("a"),Tg=r("Automatic Differentiation"),xg=d(),qd=n("li"),_s=n("a"),wg=r("Vectorization"),zg=d(),Md=n("li"),gs=n("a"),Fg=r("Parallelization"),Bg=d(),je=n("div"),m(bs.$$.fragment),$g=d(),vo=n("p"),jg=r("The "),Pd=n("code"),qg=r("FlaxBartPreTrainedModel"),Mg=r(" forward method, overrides the "),Ed=n("code"),Pg=r("__call__"),Eg=r(" special method."),Cg=d(),m(Vo.$$.fragment),Ag=d(),Cd=n("p"),Sg=r("Example:"),Ig=d(),m(vs.$$.fragment),Ng=d(),yt=n("div"),m(ks.$$.fragment),Og=d(),Ad=n("p"),Dg=r("Example:"),Lg=d(),m(ys.$$.fragment),Gg=d(),Tt=n("div"),m(Ts.$$.fragment),Wg=d(),Sd=n("p"),Rg=r("Example:"),Ug=d(),m(xs.$$.fragment),this.h()},l(o){const h=jy('[data-svelte="svelte-1phssyn"]',document.head);p=a(h,"META",{name:!0,content:!0}),h.forEach(t),F=l(o),k=a(o,"H1",{class:!0});var ws=s(k);x=a(ws,"A",{id:!0,class:!0,href:!0});var Id=s(x);z=a(Id,"SPAN",{});var Nd=s(z);f(T.$$.fragment,Nd),Nd.forEach(t),Id.forEach(t),y=l(ws),B=a(ws,"SPAN",{});var Od=s(B);He=i(Od,"BART"),Od.forEach(t),ws.forEach(t),ke=l(o),j=a(o,"P",{});var Jo=s(j);Ce=a(Jo,"STRONG",{});var Dd=s(Ce);le=i(Dd,"DISCLAIMER:"),Dd.forEach(t),Qe=i(Jo," If you see something strange, file a "),ce=a(Jo,"A",{href:!0,rel:!0});var Ld=s(ce);pe=i(Ld,"Github Issue"),Ld.forEach(t),Ve=i(Jo,` and assign
...
`),Rr=a(cr,"CODE",{});var bb=s(Rr);Qc=i(bb,"fairseq.encode"),bb.forEach(t),Vc=i(cr," starts with a space."),cr.forEach(t),Jc=l(xt),Es=a(xt,"LI",{});var Hg=s(Es);Cs=a(Hg,"A",{href:!0});var vb=s(Cs);Xc=i(vb,"generate()"),vb.forEach(t),Kc=i(Hg,` should be used for conditional generation tasks like
...
instantiate a BART model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BART `),fn=a(ur,"A",{href:!0,rel:!0});var Mb=s(fn);gp=i(Mb,"facebook/bart-large"),Mb.forEach(t),bp=i(ur," architecture."),ur.forEach(t),vp=l(wt),Qt=a(wt,"P",{});var mr=s(Qt);kp=i(mr,"Configuration objects inherit from "),Ss=a(mr,"A",{href:!0});var Pb=s(Ss);yp=i(Pb,"PretrainedConfig"),Pb.forEach(t),Tp=i(mr,` and can be used to control the model
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Il.forEach(t),dh=l(Zo),we=a(Zo,"DIV",{class:!0});var zt=s(we);f(Bn.$$.fragment,zt),lh=l(zt),Kt=a(zt,"P",{});var gr=s(Kt);ch=i(gr,"The "),Us=a(gr,"A",{href:!0});var ev=s(Us);ph=i(ev,"BartModel"),ev.forEach(t),hh=i(gr," forward method, overrides the "),di=a(gr,"CODE",{});var tv=s(di);uh=i(tv,"__call__"),tv.forEach(t),mh=i(gr," special method."),gr.forEach(t),fh=l(zt),f(Bo.$$.fragment,zt),_h=l(zt),li=a(zt,"P",{});var ov=s(li);gh=i(ov,"Example:"),ov.forEach(t),bh=l(zt),f($n.$$.fragment,zt),zt.forEach(t),Zo.forEach(t),rl=l(o),Zt=a(o,"H2",{class:!0});var Nl=s(Zt);$o=a(Nl,"A",{id:!0,class:!0,href:!0});var nv=s($o);ci=a(nv,"SPAN",{});var av=s(ci);f(jn.$$.fragment,av),av.forEach(t),nv.forEach(t),vh=l(Nl),pi=a(Nl,"SPAN",{});var sv=s(pi);kh=i(sv,"BartForConditionalGeneration"),sv.forEach(t),Nl.forEach(t),il=l(o),Ge=a(o,"DIV",{class:!0});var Yo=s(Ge);f(qn.$$.fragment,Yo),yh=l(Yo),Mn=a(Yo,"P",{});var Ol=s(Mn);Th=i(Ol,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Hs=a(Ol,"A",{href:!0});var rv=s(Hs);xh=i(rv,"PreTrainedModel"),rv.forEach(t),wh=i(Ol,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ol.forEach(t),zh=l(Yo),Pn=a(Yo,"P",{});var Dl=s(Pn);Fh=i(Dl,"This model is also a PyTorch "),En=a(Dl,"A",{href:!0,rel:!0});var iv=s(En);Bh=i(iv,"torch.nn.Module"),iv.forEach(t),$h=i(Dl,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Dl.forEach(t),jh=l(Yo),Q=a(Yo,"DIV",{class:!0});var qe=s(Q);f(Cn.$$.fragment,qe),qh=l(qe),Yt=a(qe,"P",{});var br=s(Yt);Mh=i(br,"The "),Qs=a(br,"A",{href:!0});var dv=s(Qs);Ph=i(dv,"BartForConditionalGeneration"),dv.forEach(t),Eh=i(br," forward method, overrides the "),hi=a(br,"CODE",{});var lv=s(hi);Ch=i(lv,"__call__"),lv.forEach(t),Ah=i(br," special method."),br.forEach(t),Sh=l(qe),f(jo.$$.fragment,qe),Ih=l(qe),ui=a(qe,"P",{});var cv=s(ui);Nh=i(cv,"Summarization example:"),cv.forEach(t),Oh=l(qe),f(An.$$.fragment,qe),Dh=l(qe),mi=a(qe,"P",{});var pv=s(mi);Lh=i(pv,"Mask filling example:"),pv.forEach(t),Gh=l(qe),f(Sn.$$.fragment,qe),qe.forEach(t),Yo.forEach(t),dl=l(o),eo=a(o,"H2",{class:!0});var Ll=s(eo);qo=a(Ll,"A",{id:!0,class:!0,href:!0});var hv=s(qo);fi=a(hv,"SPAN",{});var uv=s(fi);f(In.$$.fragment,uv),uv.forEach(t),hv.forEach(t),Wh=l(Ll),_i=a(Ll,"SPAN",{});var mv=s(_i);Rh=i(mv,"BartForSequenceClassification"),mv.forEach(t),Ll.forEach(t),ll=l(o),_e=a(o,"DIV",{class:!0});var Ft=s(_e);f(Nn.$$.fragment,Ft),Uh=l(Ft),gi=a(Ft,"P",{});var fv=s(gi);Hh=i(fv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),fv.forEach(t),Qh=l(Ft),On=a(Ft,"P",{});var Gl=s(On);Vh=i(Gl,"This model inherits from "),Vs=a(Gl,"A",{href:!0});var _v=s(Vs);Jh=i(_v,"PreTrainedModel"),_v.forEach(t),Xh=i(Gl,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Gl.forEach(t),Kh=l(Ft),Dn=a(Ft,"P",{});var Wl=s(Dn);Zh=i(Wl,"This model is also a PyTorch "),Ln=a(Wl,"A",{href:!0,rel:!0});var gv=s(Ln);Yh=i(gv,"torch.nn.Module"),gv.forEach(t),eu=i(Wl,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Wl.forEach(t),tu=l(Ft),V=a(Ft,"DIV",{class:!0});var Me=s(V);f(Gn.$$.fragment,Me),ou=l(Me),to=a(Me,"P",{});var vr=s(to);nu=i(vr,"The "),Js=a(vr,"A",{href:!0});var bv=s(Js);au=i(bv,"BartForSequenceClassification"),bv.forEach(t),su=i(vr," forward method, overrides the "),bi=a(vr,"CODE",{});var vv=s(bi);ru=i(vv,"__call__"),vv.forEach(t),iu=i(vr," special method."),vr.forEach(t),du=l(Me),f(Mo.$$.fragment,Me),lu=l(Me),vi=a(Me,"P",{});var kv=s(vi);cu=i(kv,"Example of single-label classification:"),kv.forEach(t),pu=l(Me),f(Wn.$$.fragment,Me),hu=l(Me),ki=a(Me,"P",{});var yv=s(ki);uu=i(yv,"Example of multi-label classification:"),yv.forEach(t),mu=l(Me),f(Rn.$$.fragment,Me),Me.forEach(t),Ft.forEach(t),cl=l(o),oo=a(o,"H2",{class:!0});var Rl=s(oo);Po=a(Rl,"A",{id:!0,class:!0,href:!0});var Tv=s(Po);yi=a(Tv,"SPAN",{});var xv=s(yi);f(Un.$$.fragment,xv),xv.forEach(t),Tv.forEach(t),fu=l(Rl),Ti=a(Rl,"SPAN",{});var wv=s(Ti);_u=i(wv,"BartForQuestionAnswering"),wv.forEach(t),Rl.forEach(t),pl=l(o),ge=a(o,"DIV",{class:!0});var Bt=s(ge);f(Hn.$$.fragment,Bt),gu=l(Bt),no=a(Bt,"P",{});var kr=s(no);bu=i(kr,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),xi=a(kr,"EM",{});var zv=s(xi);vu=i(zv,"span start logits"),zv.forEach(t),ku=i(kr," and "),wi=a(kr,"EM",{});var Fv=s(wi);yu=i(Fv,"span end logits"),Fv.forEach(t),Tu=i(kr,")."),kr.forEach(t),xu=l(Bt),Qn=a(Bt,"P",{});var Ul=s(Qn);wu=i(Ul,"This model inherits from "),Xs=a(Ul,"A",{href:!0});var Bv=s(Xs);zu=i(Bv,"PreTrainedModel"),Bv.forEach(t),Fu=i(Ul,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ul.forEach(t),Bu=l(Bt),Vn=a(Bt,"P",{});var Hl=s(Vn);$u=i(Hl,"This model is also a PyTorch "),Jn=a(Hl,"A",{href:!0,rel:!0});var $v=s(Jn);ju=i($v,"torch.nn.Module"),$v.forEach(t),qu=i(Hl,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Hl.forEach(t),Mu=l(Bt),ze=a(Bt,"DIV",{class:!0});var $t=s(ze);f(Xn.$$.fragment,$t),Pu=l($t),ao=a($t,"P",{});var yr=s(ao);Eu=i(yr,"The "),Ks=a(yr,"A",{href:!0});var jv=s(Ks);Cu=i(jv,"BartForQuestionAnswering"),jv.forEach(t),Au=i(yr," forward method, overrides the "),zi=a(yr,"CODE",{});var qv=s(zi);Su=i(qv,"__call__"),qv.forEach(t),Iu=i(yr," special method."),yr.forEach(t),Nu=l($t),f(Eo.$$.fragment,$t),Ou=l($t),Fi=a($t,"P",{});var Mv=s(Fi);Du=i(Mv,"Example:"),Mv.forEach(t),Lu=l($t),f(Kn.$$.fragment,$t),$t.forEach(t),Bt.forEach(t),hl=l(o),so=a(o,"H2",{class:!0});var Ql=s(so);Co=a(Ql,"A",{id:!0,class:!0,href:!0});var Pv=s(Co);Bi=a(Pv,"SPAN",{});var Ev=s(Bi);f(Zn.$$.fragment,Ev),Ev.forEach(t),Pv.forEach(t),Gu=l(Ql),$i=a(Ql,"SPAN",{});var Cv=s($i);Wu=i(Cv,"BartForCausalLM"),Cv.forEach(t),Ql.forEach(t),ul=l(o),Yn=a(o,"DIV",{class:!0});var Av=s(Yn);mt=a(Av,"DIV",{class:!0});var Tr=s(mt);f(ea.$$.fragment,Tr),Ru=l(Tr),ji=a(Tr,"P",{});var Sv=s(ji);Uu=i(Sv,"Example:"),Sv.forEach(t),Hu=l(Tr),f(ta.$$.fragment,Tr),Tr.forEach(t),Av.forEach(t),ml=l(o),ro=a(o,"H2",{class:!0});var Vl=s(ro);Ao=a(Vl,"A",{id:!0,class:!0,href:!0});var Iv=s(Ao);qi=a(Iv,"SPAN",{});var Nv=s(qi);f(oa.$$.fragment,Nv),Nv.forEach(t),Iv.forEach(t),Qu=l(Vl),Mi=a(Vl,"SPAN",{});var Ov=s(Mi);Vu=i(Ov,"TFBartModel"),Ov.forEach(t),Vl.forEach(t),fl=l(o),be=a(o,"DIV",{class:!0});var jt=s(be);f(na.$$.fragment,jt),Ju=l(jt),aa=a(jt,"P",{});var Jl=s(aa);Xu=i(Jl,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Zs=a(Jl,"A",{href:!0});var Dv=s(Zs);Ku=i(Dv,"TFPreTrainedModel"),Dv.forEach(t),Zu=i(Jl,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Jl.forEach(t),Yu=l(jt),sa=a(jt,"P",{});var Xl=s(sa);em=i(Xl,"This model is also a "),ra=a(Xl,"A",{href:!0,rel:!0});var Lv=s(ra);tm=i(Lv,"tf.keras.Model"),Lv.forEach(t),om=i(Xl,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Xl.forEach(t),nm=l(jt),f(So.$$.fragment,jt),am=l(jt),Fe=a(jt,"DIV",{class:!0});var qt=s(Fe);f(ia.$$.fragment,qt),sm=l(qt),io=a(qt,"P",{});var xr=s(io);rm=i(xr,"The "),Ys=a(xr,"A",{href:!0});var Gv=s(Ys);im=i(Gv,"TFBartModel"),Gv.forEach(t),dm=i(xr," forward method, overrides the "),Pi=a(xr,"CODE",{});var Wv=s(Pi);lm=i(Wv,"__call__"),Wv.forEach(t),cm=i(xr," special method."),xr.forEach(t),pm=l(qt),f(Io.$$.fragment,qt),hm=l(qt),Ei=a(qt,"P",{});var Rv=s(Ei);um=i(Rv,"Example:"),Rv.forEach(t),mm=l(qt),f(da.$$.fragment,qt),qt.forEach(t),jt.forEach(t),_l=l(o),lo=a(o,"H2",{class:!0});var Kl=s(lo);No=a(Kl,"A",{id:!0,class:!0,href:!0});var Uv=s(No);Ci=a(Uv,"SPAN",{});var Hv=s(Ci);f(la.$$.fragment,Hv),Hv.forEach(t),Uv.forEach(t),fm=l(Kl),Ai=a(Kl,"SPAN",{});var Qv=s(Ai);_m=i(Qv,"TFBartForConditionalGeneration"),Qv.forEach(t),Kl.forEach(t),gl=l(o),ve=a(o,"DIV",{class:!0});var Mt=s(ve);f(ca.$$.fragment,Mt),gm=l(Mt),pa=a(Mt,"P",{});var Zl=s(pa);bm=i(Zl,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),er=a(Zl,"A",{href:!0});var Vv=s(er);vm=i(Vv,"TFPreTrainedModel"),Vv.forEach(t),km=i(Zl,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Zl.forEach(t),ym=l(Mt),ha=a(Mt,"P",{});var Yl=s(ha);Tm=i(Yl,"This model is also a "),ua=a(Yl,"A",{href:!0,rel:!0});var Jv=s(ua);xm=i(Jv,"tf.keras.Model"),Jv.forEach(t),wm=i(Yl,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Yl.forEach(t),zm=l(Mt),f(Oo.$$.fragment,Mt),Fm=l(Mt),J=a(Mt,"DIV",{class:!0});var Pe=s(J);f(ma.$$.fragment,Pe),Bm=l(Pe),co=a(Pe,"P",{});var wr=s(co);$m=i(wr,"The "),tr=a(wr,"A",{href:!0});var Xv=s(tr);jm=i(Xv,"TFBartForConditionalGeneration"),Xv.forEach(t),qm=i(wr," forward method, overrides the "),Si=a(wr,"CODE",{});var Kv=s(Si);Mm=i(Kv,"__call__"),Kv.forEach(t),Pm=i(wr," special method."),wr.forEach(t),Em=l(Pe),f(Do.$$.fragment,Pe),Cm=l(Pe),Ii=a(Pe,"P",{});var Zv=s(Ii);Am=i(Zv,"Summarization example:"),Zv.forEach(t),Sm=l(Pe),f(fa.$$.fragment,Pe),Im=l(Pe),Ni=a(Pe,"P",{});var Yv=s(Ni);Nm=i(Yv,"Mask filling example:"),Yv.forEach(t),Om=l(Pe),f(_a.$$.fragment,Pe),Pe.forEach(t),Mt.forEach(t),bl=l(o),po=a(o,"H2",{class:!0});var ec=s(po);Lo=a(ec,"A",{id:!0,class:!0,href:!0});var ek=s(Lo);Oi=a(ek,"SPAN",{});var tk=s(Oi);f(ga.$$.fragment,tk),tk.forEach(t),ek.forEach(t),Dm=l(ec),Di=a(ec,"SPAN",{});var ok=s(Di);Lm=i(ok,"FlaxBartModel"),ok.forEach(t),ec.forEach(t),vl=l(o),O=a(o,"DIV",{class:!0});var ie=s(O);f(ba.$$.fragment,ie),Gm=l(ie),va=a(ie,"P",{});var tc=s(va);Wm=i(tc,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),or=a(tc,"A",{href:!0});var nk=s(or);Rm=i(nk,"FlaxPreTrainedModel"),nk.forEach(t),Um=i(tc,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),tc.forEach(t),Hm=l(ie),ka=a(ie,"P",{});var oc=s(ka);Qm=i(oc,"This model is also a Flax Linen "),ya=a(oc,"A",{href:!0,rel:!0});var ak=s(ya);Vm=i(ak,"flax.nn.Module"),ak.forEach(t),Jm=i(oc,` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),oc.forEach(t),Xm=l(ie),Li=a(ie,"P",{});var sk=s(Li);Km=i(sk,"Finally, this model supports inherent JAX features such as:"),sk.forEach(t),Zm=l(ie),rt=a(ie,"UL",{});var en=s(rt);Gi=a(en,"LI",{});var rk=s(Gi);Ta=a(rk,"A",{href:!0,rel:!0});var ik=s(Ta);Ym=i(ik,"Just-In-Time (JIT) compilation"),ik.forEach(t),rk.forEach(t),ef=l(en),Wi=a(en,"LI",{});var dk=s(Wi);xa=a(dk,"A",{href:!0,rel:!0});var lk=s(xa);tf=i(lk,"Automatic Differentiation"),lk.forEach(t),dk.forEach(t),of=l(en),Ri=a(en,"LI",{});var ck=s(Ri);wa=a(ck,"A",{href:!0,rel:!0});var pk=s(wa);nf=i(pk,"Vectorization"),pk.forEach(t),ck.forEach(t),af=l(en),Ui=a(en,"LI",{});var hk=s(Ui);za=a(hk,"A",{href:!0,rel:!0});var uk=s(za);sf=i(uk,"Parallelization"),uk.forEach(t),hk.forEach(t),en.forEach(t),rf=l(ie),Be=a(ie,"DIV",{class:!0});var Pt=s(Be);f(Fa.$$.fragment,Pt),df=l(Pt),ho=a(Pt,"P",{});var zr=s(ho);lf=i(zr,"The "),Hi=a(zr,"CODE",{});var mk=s(Hi);cf=i(mk,"FlaxBartPreTrainedModel"),mk.forEach(t),pf=i(zr," forward method, overrides the "),Qi=a(zr,"CODE",{});var fk=s(Qi);hf=i(fk,"__call__"),fk.forEach(t),uf=i(zr," special method."),zr.forEach(t),mf=l(Pt),f(Go.$$.fragment,Pt),ff=l(Pt),Vi=a(Pt,"P",{});var _k=s(Vi);_f=i(_k,"Example:"),_k.forEach(t),gf=l(Pt),f(Ba.$$.fragment,Pt),Pt.forEach(t),bf=l(ie),ft=a(ie,"DIV",{class:!0});var Fr=s(ft);f($a.$$.fragment,Fr),vf=l(Fr),Ji=a(Fr,"P",{});var gk=s(Ji);kf=i(gk,"Example:"),gk.forEach(t),yf=l(Fr),f(ja.$$.fragment,Fr),Fr.forEach(t),Tf=l(ie),_t=a(ie,"DIV",{class:!0});var Br=s(_t);f(qa.$$.fragment,Br),xf=l(Br),Xi=a(Br,"P",{});var bk=s(Xi);wf=i(bk,"Example:"),bk.forEach(t),zf=l(Br),f(Ma.$$.fragment,Br),Br.forEach(t),ie.forEach(t),kl=l(o),uo=a(o,"H2",{class:!0});var nc=s(uo);Wo=a(nc,"A",{id:!0,class:!0,href:!0});var vk=s(Wo);Ki=a(vk,"SPAN",{});var kk=s(Ki);f(Pa.$$.fragment,kk),kk.forEach(t),vk.forEach(t),Ff=l(nc),Zi=a(nc,"SPAN",{});var yk=s(Zi);Bf=i(yk,"FlaxBartForConditionalGeneration"),yk.forEach(t),nc.forEach(t),yl=l(o),D=a(o,"DIV",{class:!0});var de=s(D);f(Ea.$$.fragment,de),$f=l(de),Ca=a(de,"P",{});var ac=s(Ca);jf=i(ac,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),nr=a(ac,"A",{href:!0});var Tk=s(nr);qf=i(Tk,"FlaxPreTrainedModel"),Tk.forEach(t),Mf=i(ac,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),ac.forEach(t),Pf=l(de),Aa=a(de,"P",{});var sc=s(Aa);Ef=i(sc,"This model is also a Flax Linen "),Sa=a(sc,"A",{href:!0,rel:!0});var xk=s(Sa);Cf=i(xk,"flax.nn.Module"),xk.forEach(t),Af=i(sc,` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),sc.forEach(t),Sf=l(de),Yi=a(de,"P",{});var wk=s(Yi);If=i(wk,"Finally, this model supports inherent JAX features such as:"),wk.forEach(t),Nf=l(de),it=a(de,"UL",{});var tn=s(it);ed=a(tn,"LI",{});var zk=s(ed);Ia=a(zk,"A",{href:!0,rel:!0});var Fk=s(Ia);Of=i(Fk,"Just-In-Time (JIT) compilation"),Fk.forEach(t),zk.forEach(t),Df=l(tn),td=a(tn,"LI",{});var Bk=s(td);Na=a(Bk,"A",{href:!0,rel:!0});var $k=s(Na);Lf=i($k,"Automatic Differentiation"),$k.forEach(t),Bk.forEach(t),Gf=l(tn),od=a(tn,"LI",{});var jk=s(od);Oa=a(jk,"A",{href:!0,rel:!0});var qk=s(Oa);Wf=i(qk,"Vectorization"),qk.forEach(t),jk.forEach(t),Rf=l(tn),nd=a(tn,"LI",{});var Mk=s(nd);Da=a(Mk,"A",{href:!0,rel:!0});var Pk=s(Da);Uf=i(Pk,"Parallelization"),Pk.forEach(t),Mk.forEach(t),tn.forEach(t),Hf=l(de),X=a(de,"DIV",{class:!0});var Ee=s(X);f(La.$$.fragment,Ee),Qf=l(Ee),mo=a(Ee,"P",{});var $r=s(mo);Vf=i($r,"The "),ad=a($r,"CODE",{});var Ek=s(ad);Jf=i(Ek,"FlaxBartPreTrainedModel"),Ek.forEach(t),Xf=i($r," forward method, overrides the "),sd=a($r,"CODE",{});var Ck=s(sd);Kf=i(Ck,"__call__"),Ck.forEach(t),Zf=i($r," special method."),$r.forEach(t),Yf=l(Ee),f(Ro.$$.fragment,Ee),e_=l(Ee),rd=a(Ee,"P",{});var Ak=s(rd);t_=i(Ak,"Summarization example:"),Ak.forEach(t),o_=l(Ee),f(Ga.$$.fragment,Ee),n_=l(Ee),id=a(Ee,"P",{});var Sk=s(id);a_=i(Sk,"Mask filling example:"),Sk.forEach(t),s_=l(Ee),f(Wa.$$.fragment,Ee),Ee.forEach(t),r_=l(de),gt=a(de,"DIV",{class:!0});var jr=s(gt);f(Ra.$$.fragment,jr),i_=l(jr),dd=a(jr,"P",{});var Ik=s(dd);d_=i(Ik,"Example:"),Ik.forEach(t),l_=l(jr),f(Ua.$$.fragment,jr),jr.forEach(t),c_=l(de),bt=a(de,"DIV",{class:!0});var qr=s(bt);f(Ha.$$.fragment,qr),p_=l(qr),ld=a(qr,"P",{});var Nk=s(ld);h_=i(Nk,"Example:"),Nk.forEach(t),u_=l(qr),f(Qa.$$.fragment,qr),qr.forEach(t),de.forEach(t),Tl=l(o),fo=a(o,"H2",{class:!0});var rc=s(fo);Uo=a(rc,"A",{id:!0,class:!0,href:!0});var Ok=s(Uo);cd=a(Ok,"SPAN",{});var Dk=s(cd);f(Va.$$.fragment,Dk),Dk.forEach(t),Ok.forEach(t),m_=l(rc),pd=a(rc,"SPAN",{});var Lk=s(pd);f_=i(Lk,"FlaxBartForSequenceClassification"),Lk.forEach(t),rc.forEach(t),xl=l(o),A=a(o,"DIV",{class:!0});var K=s(A);f(Ja.$$.fragment,K),__=l(K),hd=a(K,"P",{});var Gk=s(hd);g_=i(Gk,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Gk.forEach(t),b_=l(K),Xa=a(K,"P",{});var ic=s(Xa);v_=i(ic,"This model inherits from "),ar=a(ic,"A",{href:!0});var Wk=s(ar);k_=i(Wk,"FlaxPreTrainedModel"),Wk.forEach(t),y_=i(ic,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),ic.forEach(t),T_=l(K),Ka=a(K,"P",{});var dc=s(Ka);x_=i(dc,"This model is also a Flax Linen "),Za=a(dc,"A",{href:!0,rel:!0});var Rk=s(Za);w_=i(Rk,"flax.nn.Module"),Rk.forEach(t),z_=i(dc,` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),dc.forEach(t),F_=l(K),ud=a(K,"P",{});var Uk=s(ud);B_=i(Uk,"Finally, this model supports inherent JAX features such as:"),Uk.forEach(t),$_=l(K),dt=a(K,"UL",{});var on=s(dt);md=a(on,"LI",{});var Hk=s(md);Ya=a(Hk,"A",{href:!0,rel:!0});var Qk=s(Ya);j_=i(Qk,"Just-In-Time (JIT) compilation"),Qk.forEach(t),Hk.forEach(t),q_=l(on),fd=a(on,"LI",{});var Vk=s(fd);es=a(Vk,"A",{href:!0,rel:!0});var Jk=s(es);M_=i(Jk,"Automatic Differentiation"),Jk.forEach(t),Vk.forEach(t),P_=l(on),_d=a(on,"LI",{});var Xk=s(_d);ts=a(Xk,"A",{href:!0,rel:!0});var Kk=s(ts);E_=i(Kk,"Vectorization"),Kk.forEach(t),Xk.forEach(t),C_=l(on),gd=a(on,"LI",{});var Zk=s(gd);os=a(Zk,"A",{href:!0,rel:!0});var Yk=s(os);A_=i(Yk,"Parallelization"),Yk.forEach(t),Zk.forEach(t),on.forEach(t),S_=l(K),$e=a(K,"DIV",{class:!0});var Et=s($e);f(ns.$$.fragment,Et),I_=l(Et),_o=a(Et,"P",{});var Mr=s(_o);N_=i(Mr,"The "),bd=a(Mr,"CODE",{});var ey=s(bd);O_=i(ey,"FlaxBartPreTrainedModel"),ey.forEach(t),D_=i(Mr," forward method, overrides the "),vd=a(Mr,"CODE",{});var ty=s(vd);L_=i(ty,"__call__"),ty.forEach(t),G_=i(Mr," special method."),Mr.forEach(t),W_=l(Et),f(Ho.$$.fragment,Et),R_=l(Et),kd=a(Et,"P",{});var oy=s(kd);U_=i(oy,"Example:"),oy.forEach(t),H_=l(Et),f(as.$$.fragment,Et),Et.forEach(t),Q_=l(K),vt=a(K,"DIV",{class:!0});var Pr=s(vt);f(ss.$$.fragment,Pr),V_=l(Pr),yd=a(Pr,"P",{});var ny=s(yd);J_=i(ny,"Example:"),ny.forEach(t),X_=l(Pr),f(rs.$$.fragment,Pr),Pr.forEach(t),K_=l(K),kt=a(K,"DIV",{class:!0});var Er=s(kt);f(is.$$.fragment,Er),Z_=l(Er),Td=a(Er,"P",{});var ay=s(Td);Y_=i(ay,"Example:"),ay.forEach(t),eg=l(Er),f(ds.$$.fragment,Er),Er.forEach(t),K.forEach(t),wl=l(o),go=a(o,"H2",{class:!0});var lc=s(go);Qo=a(lc,"A",{id:!0,class:!0,href:!0});var sy=s(Qo);xd=a(sy,"SPAN",{});var ry=s(xd);f(ls.$$.fragment,ry),ry.forEach(t),sy.forEach(t),tg=l(lc),wd=a(lc,"SPAN",{});var iy=s(wd);og=i(iy,"FlaxBartForQuestionAnswering"),iy.forEach(t),lc.forEach(t),zl=l(o),S=a(o,"DIV",{class:!0});var Z=s(S);f(cs.$$.fragment,Z),ng=l(Z),bo=a(Z,"P",{});var Cr=s(bo);ag=i(Cr,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),zd=a(Cr,"EM",{});var dy=s(zd);sg=i(dy,"span start logits"),dy.forEach(t),rg=i(Cr," and "),Fd=a(Cr,"EM",{});var ly=s(Fd);ig=i(ly,"span end logits"),ly.forEach(t),dg=i(Cr,")."),Cr.forEach(t),lg=l(Z),ps=a(Z,"P",{});var cc=s(ps);cg=i(cc,"This model inherits from "),sr=a(cc,"A",{href:!0});var cy=s(sr);pg=i(cy,"FlaxPreTrainedModel"),cy.forEach(t),hg=i(cc,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),cc.forEach(t),ug=l(Z),hs=a(Z,"P",{});var pc=s(hs);mg=i(pc,"This model is also a Flax Linen "),us=a(pc,"A",{href:!0,rel:!0});var py=s(us);fg=i(py,"flax.nn.Module"),py.forEach(t),_g=i(pc,` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),pc.forEach(t),gg=l(Z),Bd=a(Z,"P",{});var hy=s(Bd);bg=i(hy,"Finally, this model supports inherent JAX features such as:"),hy.forEach(t),vg=l(Z),lt=a(Z,"UL",{});var nn=s(lt);$d=a(nn,"LI",{});var uy=s($d);ms=a(uy,"A",{href:!0,rel:!0});var my=s(ms);kg=i(my,"Just-In-Time (JIT) compilation"),my.forEach(t),uy.forEach(t),yg=l(nn),jd=a(nn,"LI",{});var fy=s(jd);fs=a(fy,"A",{href:!0,rel:!0});var _y=s(fs);Tg=i(_y,"Automatic Differentiation"),_y.forEach(t),fy.forEach(t),xg=l(nn),qd=a(nn,"LI",{});var gy=s(qd);_s=a(gy,"A",{href:!0,rel:!0});var by=s(_s);wg=i(by,"Vectorization"),by.forEach(t),gy.forEach(t),zg=l(nn),Md=a(nn,"LI",{});var vy=s(Md);gs=a(vy,"A",{href:!0,rel:!0});var ky=s(gs);Fg=i(ky,"Parallelization"),ky.forEach(t),vy.forEach(t),nn.forEach(t),Bg=l(Z),je=a(Z,"DIV",{class:!0});var Ct=s(je);f(bs.$$.fragment,Ct),$g=l(Ct),vo=a(Ct,"P",{});var Ar=s(vo);jg=i(Ar,"The "),Pd=a(Ar,"CODE",{});var yy=s(Pd);qg=i(yy,"FlaxBartPreTrainedModel"),yy.forEach(t),Mg=i(Ar," forward method, overrides the "),Ed=a(Ar,"CODE",{});var Ty=s(Ed);Pg=i(Ty,"__call__"),Ty.forEach(t),Eg=i(Ar," special method."),Ar.forEach(t),Cg=l(Ct),f(Vo.$$.fragment,Ct),Ag=l(Ct),Cd=a(Ct,"P",{});var xy=s(Cd);Sg=i(xy,"Example:"),xy.forEach(t),Ig=l(Ct),f(vs.$$.fragment,Ct),Ct.forEach(t),Ng=l(Z),yt=a(Z,"DIV",{class:!0});var Sr=s(yt);f(ks.$$.fragment,Sr),Og=l(Sr),Ad=a(Sr,"P",{});var wy=s(Ad);Dg=i(wy,"Example:"),wy.forEach(t),Lg=l(Sr),f(ys.$$.fragment,Sr),Sr.forEach(t),Gg=l(Z),Tt=a(Z,"DIV",{class:!0});var Ir=s(Tt);f(Ts.$$.fragment,Ir),Wg=l(Ir),Sd=a(Ir,"P",{});var zy=s(Sd);Rg=i(zy,"Example:"),zy.forEach(t),Ug=l(Ir),f(xs.$$.fragment,Ir),Ir.forEach(t),Z.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(Wy)),c(x,"id","bart"),c(x,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(x,"href","#bart"),c(k,"class","relative group"),c(ce,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),c(ce,"rel","nofollow"),c(I,"id","overview"),c(I,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(I,"href","#overview"),c(G,"class","relative group"),c(W,"href","https://arxiv.org/abs/1910.13461"),c(W,"rel","nofollow"),c(Ie,"href","https://huggingface.co/sshleifer"),c(Ie,"rel","nofollow"),c(Ne,"href","https://github.com/pytorch/fairseq/tree/master/examples/bart"),c(Ne,"rel","nofollow"),c(Te,"id","examples"),c(Te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Te,"href","#examples"),c(me,"class","relative group"),c(sn,"href","https://github.com/huggingface/transformers/tree/master/examples/pytorch/summarization/README.md"),c(sn,"rel","nofollow"),c(js,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(rn,"href","https://discuss.huggingface.co/t/train-bart-for-conditional-generation-e-g-summarization/1904"),c(rn,"rel","nofollow"),c(dn,"href","https://huggingface.co/models?search=distilbart"),c(dn,"rel","nofollow"),c(ln,"href","https://arxiv.org/abs/2010.13002"),c(ln,"rel","nofollow"),c(yo,"id","implementation-notes"),c(yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(yo,"href","#implementation-notes"),c(Dt,"class","relative group"),c(qs,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartTokenizer"),c(Ms,"href","/docs/transformers/v4.14.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode"),c(Ps,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartModel"),c(Cs,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate"),c(To,"id","mask-filling"),c(To,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(To,"href","#mask-filling"),c(Rt,"class","relative group"),c(xo,"id","transformers.BartConfig"),c(xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xo,"href","#transformers.BartConfig"),c(Ut,"class","relative group"),c(As,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartModel"),c(fn,"href","https://huggingface.co/facebook/bart-large"),c(fn,"rel","nofollow"),c(Ss,"href","/docs/transformers/v4.14.1/en/main_classes/configuration#transformers.PretrainedConfig"),c(Is,"href","/docs/transformers/v4.14.1/en/main_classes/configuration#transformers.PretrainedConfig"),c(fe,"class","docstring"),c(wo,"id","transformers.BartTokenizer"),c(wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(wo,"href","#transformers.BartTokenizer"),c(Vt,"class","relative group"),c(Ns,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartTokenizer"),c(Os,"href","/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer"),c(Ds,"href","/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizer"),c(at,"class","docstring"),c(zo,"id","transformers.BartTokenizerFast"),c(zo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(zo,"href","#transformers.BartTokenizerFast"),c(Jt,"class","relative group"),c(Ls,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartTokenizerFast"),c(Gs,"href","/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizerFast"),c(Ws,"href","/docs/transformers/v4.14.1/en/model_doc/roberta#transformers.RobertaTokenizerFast"),c(st,"class","docstring"),c(Fo,"id","transformers.BartModel"),c(Fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Fo,"href","#transformers.BartModel"),c(Xt,"class","relative group"),c(Rs,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),c(Fn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Fn,"rel","nofollow"),c(Us,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartModel"),c(we,"class","docstring"),c(Le,"class","docstring"),c($o,"id","transformers.BartForConditionalGeneration"),c($o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c($o,"href","#transformers.BartForConditionalGeneration"),c(Zt,"class","relative group"),c(Hs,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),c(En,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(En,"rel","nofollow"),c(Qs,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(Q,"class","docstring"),c(Ge,"class","docstring"),c(qo,"id","transformers.BartForSequenceClassification"),c(qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qo,"href","#transformers.BartForSequenceClassification"),c(eo,"class","relative group"),c(Vs,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),c(Ln,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ln,"rel","nofollow"),c(Js,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartForSequenceClassification"),c(V,"class","docstring"),c(_e,"class","docstring"),c(Po,"id","transformers.BartForQuestionAnswering"),c(Po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Po,"href","#transformers.BartForQuestionAnswering"),c(oo,"class","relative group"),c(Xs,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),c(Jn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Jn,"rel","nofollow"),c(Ks,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.BartForQuestionAnswering"),c(ze,"class","docstring"),c(ge,"class","docstring"),c(Co,"id","transformers.BartForCausalLM"),c(Co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Co,"href","#transformers.BartForCausalLM"),c(so,"class","relative group"),c(mt,"class","docstring"),c(Yn,"class","docstring"),c(Ao,"id","transformers.TFBartModel"),c(Ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ao,"href","#transformers.TFBartModel"),c(ro,"class","relative group"),c(Zs,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.TFPreTrainedModel"),c(ra,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(ra,"rel","nofollow"),c(Ys,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.TFBartModel"),c(Fe,"class","docstring"),c(be,"class","docstring"),c(No,"id","transformers.TFBartForConditionalGeneration"),c(No,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(No,"href","#transformers.TFBartForConditionalGeneration"),c(lo,"class","relative group"),c(er,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.TFPreTrainedModel"),c(ua,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(ua,"rel","nofollow"),c(tr,"href","/docs/transformers/v4.14.1/en/model_doc/bart#transformers.TFBartForConditionalGeneration"),c(J,"class","docstring"),c(ve,"class","docstring"),c(Lo,"id","transformers.FlaxBartModel"),c(Lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Lo,"href","#transformers.FlaxBartModel"),c(po,"class","relative group"),c(or,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(ya,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(ya,"rel","nofollow"),c(Ta,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Ta,"rel","nofollow"),c(xa,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(xa,"rel","nofollow"),c(wa,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(wa,"rel","nofollow"),c(za,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(za,"rel","nofollow"),c(Be,"class","docstring"),c(ft,"class","docstring"),c(_t,"class","docstring"),c(O,"class","docstring"),c(Wo,"id","transformers.FlaxBartForConditionalGeneration"),c(Wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Wo,"href","#transformers.FlaxBartForConditionalGeneration"),c(uo,"class","relative group"),c(nr,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Sa,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Sa,"rel","nofollow"),c(Ia,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Ia,"rel","nofollow"),c(Na,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Na,"rel","nofollow"),c(Oa,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Oa,"rel","nofollow"),c(Da,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Da,"rel","nofollow"),c(X,"class","docstring"),c(gt,"class","docstring"),c(bt,"class","docstring"),c(D,"class","docstring"),c(Uo,"id","transformers.FlaxBartForSequenceClassification"),c(Uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Uo,"href","#transformers.FlaxBartForSequenceClassification"),c(fo,"class","relative group"),c(ar,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Za,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Za,"rel","nofollow"),c(Ya,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Ya,"rel","nofollow"),c(es,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(es,"rel","nofollow"),c(ts,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(ts,"rel","nofollow"),c(os,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(os,"rel","nofollow"),c($e,"class","docstring"),c(vt,"class","docstring"),c(kt,"class","docstring"),c(A,"class","docstring"),c(Qo,"id","transformers.FlaxBartForQuestionAnswering"),c(Qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qo,"href","#transformers.FlaxBartForQuestionAnswering"),c(go,"class","relative group"),c(sr,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(us,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(us,"rel","nofollow"),c(ms,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(ms,"rel","nofollow"),c(fs,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(fs,"rel","nofollow"),c(_s,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(_s,"rel","nofollow"),c(gs,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(gs,"rel","nofollow"),c(je,"class","docstring"),c(yt,"class","docstring"),c(Tt,"class","docstring"),c(S,"class","docstring")},m(o,h){e(document.head,p),u(o,F,h),u(o,k,h),e(k,x),e(x,z),_(T,z,null),e(k,y),e(k,B),e(B,He),u(o,ke,h),u(o,j,h),e(j,Ce),e(Ce,le),e(j,Qe),e(j,ce),e(ce,pe),e(j,Ve),u(o,We,h),u(o,G,h),e(G,I),e(I,Ae),_(Y,Ae,null),e(G,P),e(G,C),e(C,Je),u(o,ae,h),u(o,se,h),e(se,Xe),e(se,W),e(W,Ke),e(se,Ze),u(o,N,h),u(o,ye,h),e(ye,he),u(o,Re,h),u(o,H,h),e(H,ee),e(ee,Ye),e(H,et),e(H,R),e(R,tt),e(H,ue),e(H,Se),e(Se,w),u(o,q,h),u(o,L,h),e(L,At),e(L,Ie),e(Ie,te),e(L,St),e(L,Ne),e(Ne,It),e(L,oe),u(o,re,h),u(o,me,h),e(me,Te),e(Te,ne),_(Oe,ne,null),e(me,Nt),e(me,De),e(De,Ot),u(o,Hd,h),u(o,ct,h),e(ct,an),e(an,hc),e(an,sn),e(sn,uc),e(an,mc),e(ct,fc),e(ct,ot),e(ot,_c),e(ot,js),e(js,gc),e(ot,bc),e(ot,Nr),e(Nr,vc),e(ot,kc),e(ot,rn),e(rn,yc),e(ot,Tc),e(ct,xc),e(ct,ko),e(ko,dn),e(dn,wc),e(ko,zc),e(ko,ln),e(ln,Fc),e(ko,Bc),u(o,Qd,h),u(o,Dt,h),e(Dt,yo),e(yo,Or),_(cn,Or,null),e(Dt,$c),e(Dt,Dr),e(Dr,jc),u(o,Vd,h),u(o,xe,h),e(xe,nt),e(nt,qc),e(nt,Lr),e(Lr,Mc),e(nt,Pc),e(nt,qs),e(qs,Ec),e(nt,Cc),e(nt,Ms),e(Ms,Ac),e(nt,Sc),e(xe,Ic),e(xe,Lt),e(Lt,Nc),e(Lt,Ps),e(Ps,Oc),e(Lt,Dc),e(Lt,Gr),e(Gr,Lc),e(Lt,Gc),e(xe,Wc),e(xe,Gt),e(Gt,Rc),e(Gt,Wr),e(Wr,Uc),e(Gt,Hc),e(Gt,Rr),e(Rr,Qc),e(Gt,Vc),e(xe,Jc),e(xe,Es),e(Es,Cs),e(Cs,Xc),e(Es,Kc),e(xe,Zc),e(xe,Wt),e(Wt,Yc),e(Wt,Ur),e(Ur,ep),e(Wt,tp),e(Wt,Hr),e(Hr,op),e(Wt,np),u(o,Jd,h),u(o,Rt,h),e(Rt,To),e(To,Qr),_(pn,Qr,null),e(Rt,ap),e(Rt,Vr),e(Vr,sp),u(o,Xd,h),u(o,pt,h),e(pt,rp),e(pt,Jr),e(Jr,ip),e(pt,dp),e(pt,Xr),e(Xr,lp),e(pt,cp),u(o,Kd,h),_(hn,o,h),u(o,Zd,h),u(o,Ut,h),e(Ut,xo),e(xo,Kr),_(un,Kr,null),e(Ut,pp),e(Ut,Zr),e(Zr,hp),u(o,Yd,h),u(o,fe,h),_(mn,fe,null),e(fe,up),e(fe,Ht),e(Ht,mp),e(Ht,As),e(As,fp),e(Ht,_p),e(Ht,fn),e(fn,gp),e(Ht,bp),e(fe,vp),e(fe,Qt),e(Qt,kp),e(Qt,Ss),e(Ss,yp),e(Qt,Tp),e(Qt,Is),e(Is,xp),e(Qt,wp),e(fe,zp),e(fe,Yr),e(Yr,Fp),e(fe,Bp),_(_n,fe,null),u(o,el,h),u(o,Vt,h),e(Vt,wo),e(wo,ei),_(gn,ei,null),e(Vt,$p),e(Vt,ti),e(ti,jp),u(o,tl,h),u(o,at,h),_(bn,at,null),e(at,qp),e(at,oi),e(oi,Mp),e(at,Pp),e(at,ht),e(ht,Ns),e(Ns,Ep),e(ht,Cp),e(ht,Os),e(Os,Ap),e(ht,Sp),e(ht,Ds),e(Ds,Ip),e(ht,Np),u(o,ol,h),u(o,Jt,h),e(Jt,zo),e(zo,ni),_(vn,ni,null),e(Jt,Op),e(Jt,ai),e(ai,Dp),u(o,nl,h),u(o,st,h),_(kn,st,null),e(st,Lp),e(st,yn),e(yn,Gp),e(yn,si),e(si,Wp),e(yn,Rp),e(st,Up),e(st,ut),e(ut,Ls),e(Ls,Hp),e(ut,Qp),e(ut,Gs),e(Gs,Vp),e(ut,Jp),e(ut,Ws),e(Ws,Xp),e(ut,Kp),u(o,al,h),u(o,Xt,h),e(Xt,Fo),e(Fo,ri),_(Tn,ri,null),e(Xt,Zp),e(Xt,ii),e(ii,Yp),u(o,sl,h),u(o,Le,h),_(xn,Le,null),e(Le,eh),e(Le,wn),e(wn,th),e(wn,Rs),e(Rs,oh),e(wn,nh),e(Le,ah),e(Le,zn),e(zn,sh),e(zn,Fn),e(Fn,rh),e(zn,ih),e(Le,dh),e(Le,we),_(Bn,we,null),e(we,lh),e(we,Kt),e(Kt,ch),e(Kt,Us),e(Us,ph),e(Kt,hh),e(Kt,di),e(di,uh),e(Kt,mh),e(we,fh),_(Bo,we,null),e(we,_h),e(we,li),e(li,gh),e(we,bh),_($n,we,null),u(o,rl,h),u(o,Zt,h),e(Zt,$o),e($o,ci),_(jn,ci,null),e(Zt,vh),e(Zt,pi),e(pi,kh),u(o,il,h),u(o,Ge,h),_(qn,Ge,null),e(Ge,yh),e(Ge,Mn),e(Mn,Th),e(Mn,Hs),e(Hs,xh),e(Mn,wh),e(Ge,zh),e(Ge,Pn),e(Pn,Fh),e(Pn,En),e(En,Bh),e(Pn,$h),e(Ge,jh),e(Ge,Q),_(Cn,Q,null),e(Q,qh),e(Q,Yt),e(Yt,Mh),e(Yt,Qs),e(Qs,Ph),e(Yt,Eh),e(Yt,hi),e(hi,Ch),e(Yt,Ah),e(Q,Sh),_(jo,Q,null),e(Q,Ih),e(Q,ui),e(ui,Nh),e(Q,Oh),_(An,Q,null),e(Q,Dh),e(Q,mi),e(mi,Lh),e(Q,Gh),_(Sn,Q,null),u(o,dl,h),u(o,eo,h),e(eo,qo),e(qo,fi),_(In,fi,null),e(eo,Wh),e(eo,_i),e(_i,Rh),u(o,ll,h),u(o,_e,h),_(Nn,_e,null),e(_e,Uh),e(_e,gi),e(gi,Hh),e(_e,Qh),e(_e,On),e(On,Vh),e(On,Vs),e(Vs,Jh),e(On,Xh),e(_e,Kh),e(_e,Dn),e(Dn,Zh),e(Dn,Ln),e(Ln,Yh),e(Dn,eu),e(_e,tu),e(_e,V),_(Gn,V,null),e(V,ou),e(V,to),e(to,nu),e(to,Js),e(Js,au),e(to,su),e(to,bi),e(bi,ru),e(to,iu),e(V,du),_(Mo,V,null),e(V,lu),e(V,vi),e(vi,cu),e(V,pu),_(Wn,V,null),e(V,hu),e(V,ki),e(ki,uu),e(V,mu),_(Rn,V,null),u(o,cl,h),u(o,oo,h),e(oo,Po),e(Po,yi),_(Un,yi,null),e(oo,fu),e(oo,Ti),e(Ti,_u),u(o,pl,h),u(o,ge,h),_(Hn,ge,null),e(ge,gu),e(ge,no),e(no,bu),e(no,xi),e(xi,vu),e(no,ku),e(no,wi),e(wi,yu),e(no,Tu),e(ge,xu),e(ge,Qn),e(Qn,wu),e(Qn,Xs),e(Xs,zu),e(Qn,Fu),e(ge,Bu),e(ge,Vn),e(Vn,$u),e(Vn,Jn),e(Jn,ju),e(Vn,qu),e(ge,Mu),e(ge,ze),_(Xn,ze,null),e(ze,Pu),e(ze,ao),e(ao,Eu),e(ao,Ks),e(Ks,Cu),e(ao,Au),e(ao,zi),e(zi,Su),e(ao,Iu),e(ze,Nu),_(Eo,ze,null),e(ze,Ou),e(ze,Fi),e(Fi,Du),e(ze,Lu),_(Kn,ze,null),u(o,hl,h),u(o,so,h),e(so,Co),e(Co,Bi),_(Zn,Bi,null),e(so,Gu),e(so,$i),e($i,Wu),u(o,ul,h),u(o,Yn,h),e(Yn,mt),_(ea,mt,null),e(mt,Ru),e(mt,ji),e(ji,Uu),e(mt,Hu),_(ta,mt,null),u(o,ml,h),u(o,ro,h),e(ro,Ao),e(Ao,qi),_(oa,qi,null),e(ro,Qu),e(ro,Mi),e(Mi,Vu),u(o,fl,h),u(o,be,h),_(na,be,null),e(be,Ju),e(be,aa),e(aa,Xu),e(aa,Zs),e(Zs,Ku),e(aa,Zu),e(be,Yu),e(be,sa),e(sa,em),e(sa,ra),e(ra,tm),e(sa,om),e(be,nm),_(So,be,null),e(be,am),e(be,Fe),_(ia,Fe,null),e(Fe,sm),e(Fe,io),e(io,rm),e(io,Ys),e(Ys,im),e(io,dm),e(io,Pi),e(Pi,lm),e(io,cm),e(Fe,pm),_(Io,Fe,null),e(Fe,hm),e(Fe,Ei),e(Ei,um),e(Fe,mm),_(da,Fe,null),u(o,_l,h),u(o,lo,h),e(lo,No),e(No,Ci),_(la,Ci,null),e(lo,fm),e(lo,Ai),e(Ai,_m),u(o,gl,h),u(o,ve,h),_(ca,ve,null),e(ve,gm),e(ve,pa),e(pa,bm),e(pa,er),e(er,vm),e(pa,km),e(ve,ym),e(ve,ha),e(ha,Tm),e(ha,ua),e(ua,xm),e(ha,wm),e(ve,zm),_(Oo,ve,null),e(ve,Fm),e(ve,J),_(ma,J,null),e(J,Bm),e(J,co),e(co,$m),e(co,tr),e(tr,jm),e(co,qm),e(co,Si),e(Si,Mm),e(co,Pm),e(J,Em),_(Do,J,null),e(J,Cm),e(J,Ii),e(Ii,Am),e(J,Sm),_(fa,J,null),e(J,Im),e(J,Ni),e(Ni,Nm),e(J,Om),_(_a,J,null),u(o,bl,h),u(o,po,h),e(po,Lo),e(Lo,Oi),_(ga,Oi,null),e(po,Dm),e(po,Di),e(Di,Lm),u(o,vl,h),u(o,O,h),_(ba,O,null),e(O,Gm),e(O,va),e(va,Wm),e(va,or),e(or,Rm),e(va,Um),e(O,Hm),e(O,ka),e(ka,Qm),e(ka,ya),e(ya,Vm),e(ka,Jm),e(O,Xm),e(O,Li),e(Li,Km),e(O,Zm),e(O,rt),e(rt,Gi),e(Gi,Ta),e(Ta,Ym),e(rt,ef),e(rt,Wi),e(Wi,xa),e(xa,tf),e(rt,of),e(rt,Ri),e(Ri,wa),e(wa,nf),e(rt,af),e(rt,Ui),e(Ui,za),e(za,sf),e(O,rf),e(O,Be),_(Fa,Be,null),e(Be,df),e(Be,ho),e(ho,lf),e(ho,Hi),e(Hi,cf),e(ho,pf),e(ho,Qi),e(Qi,hf),e(ho,uf),e(Be,mf),_(Go,Be,null),e(Be,ff),e(Be,Vi),e(Vi,_f),e(Be,gf),_(Ba,Be,null),e(O,bf),e(O,ft),_($a,ft,null),e(ft,vf),e(ft,Ji),e(Ji,kf),e(ft,yf),_(ja,ft,null),e(O,Tf),e(O,_t),_(qa,_t,null),e(_t,xf),e(_t,Xi),e(Xi,wf),e(_t,zf),_(Ma,_t,null),u(o,kl,h),u(o,uo,h),e(uo,Wo),e(Wo,Ki),_(Pa,Ki,null),e(uo,Ff),e(uo,Zi),e(Zi,Bf),u(o,yl,h),u(o,D,h),_(Ea,D,null),e(D,$f),e(D,Ca),e(Ca,jf),e(Ca,nr),e(nr,qf),e(Ca,Mf),e(D,Pf),e(D,Aa),e(Aa,Ef),e(Aa,Sa),e(Sa,Cf),e(Aa,Af),e(D,Sf),e(D,Yi),e(Yi,If),e(D,Nf),e(D,it),e(it,ed),e(ed,Ia),e(Ia,Of),e(it,Df),e(it,td),e(td,Na),e(Na,Lf),e(it,Gf),e(it,od),e(od,Oa),e(Oa,Wf),e(it,Rf),e(it,nd),e(nd,Da),e(Da,Uf),e(D,Hf),e(D,X),_(La,X,null),e(X,Qf),e(X,mo),e(mo,Vf),e(mo,ad),e(ad,Jf),e(mo,Xf),e(mo,sd),e(sd,Kf),e(mo,Zf),e(X,Yf),_(Ro,X,null),e(X,e_),e(X,rd),e(rd,t_),e(X,o_),_(Ga,X,null),e(X,n_),e(X,id),e(id,a_),e(X,s_),_(Wa,X,null),e(D,r_),e(D,gt),_(Ra,gt,null),e(gt,i_),e(gt,dd),e(dd,d_),e(gt,l_),_(Ua,gt,null),e(D,c_),e(D,bt),_(Ha,bt,null),e(bt,p_),e(bt,ld),e(ld,h_),e(bt,u_),_(Qa,bt,null),u(o,Tl,h),u(o,fo,h),e(fo,Uo),e(Uo,cd),_(Va,cd,null),e(fo,m_),e(fo,pd),e(pd,f_),u(o,xl,h),u(o,A,h),_(Ja,A,null),e(A,__),e(A,hd),e(hd,g_),e(A,b_),e(A,Xa),e(Xa,v_),e(Xa,ar),e(ar,k_),e(Xa,y_),e(A,T_),e(A,Ka),e(Ka,x_),e(Ka,Za),e(Za,w_),e(Ka,z_),e(A,F_),e(A,ud),e(ud,B_),e(A,$_),e(A,dt),e(dt,md),e(md,Ya),e(Ya,j_),e(dt,q_),e(dt,fd),e(fd,es),e(es,M_),e(dt,P_),e(dt,_d),e(_d,ts),e(ts,E_),e(dt,C_),e(dt,gd),e(gd,os),e(os,A_),e(A,S_),e(A,$e),_(ns,$e,null),e($e,I_),e($e,_o),e(_o,N_),e(_o,bd),e(bd,O_),e(_o,D_),e(_o,vd),e(vd,L_),e(_o,G_),e($e,W_),_(Ho,$e,null),e($e,R_),e($e,kd),e(kd,U_),e($e,H_),_(as,$e,null),e(A,Q_),e(A,vt),_(ss,vt,null),e(vt,V_),e(vt,yd),e(yd,J_),e(vt,X_),_(rs,vt,null),e(A,K_),e(A,kt),_(is,kt,null),e(kt,Z_),e(kt,Td),e(Td,Y_),e(kt,eg),_(ds,kt,null),u(o,wl,h),u(o,go,h),e(go,Qo),e(Qo,xd),_(ls,xd,null),e(go,tg),e(go,wd),e(wd,og),u(o,zl,h),u(o,S,h),_(cs,S,null),e(S,ng),e(S,bo),e(bo,ag),e(bo,zd),e(zd,sg),e(bo,rg),e(bo,Fd),e(Fd,ig),e(bo,dg),e(S,lg),e(S,ps),e(ps,cg),e(ps,sr),e(sr,pg),e(ps,hg),e(S,ug),e(S,hs),e(hs,mg),e(hs,us),e(us,fg),e(hs,_g),e(S,gg),e(S,Bd),e(Bd,bg),e(S,vg),e(S,lt),e(lt,$d),e($d,ms),e(ms,kg),e(lt,yg),e(lt,jd),e(jd,fs),e(fs,Tg),e(lt,xg),e(lt,qd),e(qd,_s),e(_s,wg),e(lt,zg),e(lt,Md),e(Md,gs),e(gs,Fg),e(S,Bg),e(S,je),_(bs,je,null),e(je,$g),e(je,vo),e(vo,jg),e(vo,Pd),e(Pd,qg),e(vo,Mg),e(vo,Ed),e(Ed,Pg),e(vo,Eg),e(je,Cg),_(Vo,je,null),e(je,Ag),e(je,Cd),e(Cd,Sg),e(je,Ig),_(vs,je,null),e(S,Ng),e(S,yt),_(ks,yt,null),e(yt,Og),e(yt,Ad),e(Ad,Dg),e(yt,Lg),_(ys,yt,null),e(S,Gg),e(S,Tt),_(Ts,Tt,null),e(Tt,Wg),e(Tt,Sd),e(Sd,Rg),e(Tt,Ug),_(xs,Tt,null),Fl=!0},p(o,[h]){const ws={};h&2&&(ws.$$scope={dirty:h,ctx:o}),Bo.$set(ws);const Id={};h&2&&(Id.$$scope={dirty:h,ctx:o}),jo.$set(Id);const Nd={};h&2&&(Nd.$$scope={dirty:h,ctx:o}),Mo.$set(Nd);const Od={};h&2&&(Od.$$scope={dirty:h,ctx:o}),Eo.$set(Od);const Jo={};h&2&&(Jo.$$scope={dirty:h,ctx:o}),So.$set(Jo);const Dd={};h&2&&(Dd.$$scope={dirty:h,ctx:o}),Io.$set(Dd);const Ld={};h&2&&(Ld.$$scope={dirty:h,ctx:o}),Oo.$set(Ld);const zs={};h&2&&(zs.$$scope={dirty:h,ctx:o}),Do.$set(zs);const Gd={};h&2&&(Gd.$$scope={dirty:h,ctx:o}),Go.$set(Gd);const Wd={};h&2&&(Wd.$$scope={dirty:h,ctx:o}),Ro.$set(Wd);const Rd={};h&2&&(Rd.$$scope={dirty:h,ctx:o}),Ho.$set(Rd);const Fs={};h&2&&(Fs.$$scope={dirty:h,ctx:o}),Vo.$set(Fs)},i(o){Fl||(g(T.$$.fragment,o),g(Y.$$.fragment,o),g(Oe.$$.fragment,o),g(cn.$$.fragment,o),g(pn.$$.fragment,o),g(hn.$$.fragment,o),g(un.$$.fragment,o),g(mn.$$.fragment,o),g(_n.$$.fragment,o),g(gn.$$.fragment,o),g(bn.$$.fragment,o),g(vn.$$.fragment,o),g(kn.$$.fragment,o),g(Tn.$$.fragment,o),g(xn.$$.fragment,o),g(Bn.$$.fragment,o),g(Bo.$$.fragment,o),g($n.$$.fragment,o),g(jn.$$.fragment,o),g(qn.$$.fragment,o),g(Cn.$$.fragment,o),g(jo.$$.fragment,o),g(An.$$.fragment,o),g(Sn.$$.fragment,o),g(In.$$.fragment,o),g(Nn.$$.fragment,o),g(Gn.$$.fragment,o),g(Mo.$$.fragment,o),g(Wn.$$.fragment,o),g(Rn.$$.fragment,o),g(Un.$$.fragment,o),g(Hn.$$.fragment,o),g(Xn.$$.fragment,o),g(Eo.$$.fragment,o),g(Kn.$$.fragment,o),g(Zn.$$.fragment,o),g(ea.$$.fragment,o),g(ta.$$.fragment,o),g(oa.$$.fragment,o),g(na.$$.fragment,o),g(So.$$.fragment,o),g(ia.$$.fragment,o),g(Io.$$.fragment,o),g(da.$$.fragment,o),g(la.$$.fragment,o),g(ca.$$.fragment,o),g(Oo.$$.fragment,o),g(ma.$$.fragment,o),g(Do.$$.fragment,o),g(fa.$$.fragment,o),g(_a.$$.fragment,o),g(ga.$$.fragment,o),g(ba.$$.fragment,o),g(Fa.$$.fragment,o),g(Go.$$.fragment,o),g(Ba.$$.fragment,o),g($a.$$.fragment,o),g(ja.$$.fragment,o),g(qa.$$.fragment,o),g(Ma.$$.fragment,o),g(Pa.$$.fragment,o),g(Ea.$$.fragment,o),g(La.$$.fragment,o),g(Ro.$$.fragment,o),g(Ga.$$.fragment,o),g(Wa.$$.fragment,o),g(Ra.$$.fragment,o),g(Ua.$$.fragment,o),g(Ha.$$.fragment,o),g(Qa.$$.fragment,o),g(Va.$$.fragment,o),g(Ja.$$.fragment,o),g(ns.$$.fragment,o),g(Ho.$$.fragment,o),g(as.$$.fragment,o),g(ss.$$.fragment,o),g(rs.$$.fragment,o),g(is.$$.fragment,o),g(ds.$$.fragment,o),g(ls.$$.fragment,o),g(cs.$$.fragment,o),g(bs.$$.fragment,o),g(Vo.$$.fragment,o),g(vs.$$.fragment,o),g(ks.$$.fragment,o),g(ys.$$.fragment,o),g(Ts.$$.fragment,o),g(xs.$$.fragment,o),Fl=!0)},o(o){b(T.$$.fragment,o),b(Y.$$.fragment,o),b(Oe.$$.fragment,o),b(cn.$$.fragment,o),b(pn.$$.fragment,o),b(hn.$$.fragment,o),b(un.$$.fragment,o),b(mn.$$.fragment,o),b(_n.$$.fragment,o),b(gn.$$.fragment,o),b(bn.$$.fragment,o),b(vn.$$.fragment,o),b(kn.$$.fragment,o),b(Tn.$$.fragment,o),b(xn.$$.fragment,o),b(Bn.$$.fragment,o),b(Bo.$$.fragment,o),b($n.$$.fragment,o),b(jn.$$.fragment,o),b(qn.$$.fragment,o),b(Cn.$$.fragment,o),b(jo.$$.fragment,o),b(An.$$.fragment,o),b(Sn.$$.fragment,o),b(In.$$.fragment,o),b(Nn.$$.fragment,o),b(Gn.$$.fragment,o),b(Mo.$$.fragment,o),b(Wn.$$.fragment,o),b(Rn.$$.fragment,o),b(Un.$$.fragment,o),b(Hn.$$.fragment,o),b(Xn.$$.fragment,o),b(Eo.$$.fragment,o),b(Kn.$$.fragment,o),b(Zn.$$.fragment,o),b(ea.$$.fragment,o),b(ta.$$.fragment,o),b(oa.$$.fragment,o),b(na.$$.fragment,o),b(So.$$.fragment,o),b(ia.$$.fragment,o),b(Io.$$.fragment,o),b(da.$$.fragment,o),b(la.$$.fragment,o),b(ca.$$.fragment,o),b(Oo.$$.fragment,o),b(ma.$$.fragment,o),b(Do.$$.fragment,o),b(fa.$$.fragment,o),b(_a.$$.fragment,o),b(ga.$$.fragment,o),b(ba.$$.fragment,o),b(Fa.$$.fragment,o),b(Go.$$.fragment,o),b(Ba.$$.fragment,o),b($a.$$.fragment,o),b(ja.$$.fragment,o),b(qa.$$.fragment,o),b(Ma.$$.fragment,o),b(Pa.$$.fragment,o),b(Ea.$$.fragment,o),b(La.$$.fragment,o),b(Ro.$$.fragment,o),b(Ga.$$.fragment,o),b(Wa.$$.fragment,o),b(Ra.$$.fragment,o),b(Ua.$$.fragment,o),b(Ha.$$.fragment,o),b(Qa.$$.fragment,o),b(Va.$$.fragment,o),b(Ja.$$.fragment,o),b(ns.$$.fragment,o),b(Ho.$$.fragment,o),b(as.$$.fragment,o),b(ss.$$.fragment,o),b(rs.$$.fragment,o),b(is.$$.fragment,o),b(ds.$$.fragment,o),b(ls.$$.fragment,o),b(cs.$$.fragment,o),b(bs.$$.fragment,o),b(Vo.$$.fragment,o),b(vs.$$.fragment,o),b(ks.$$.fragment,o),b(ys.$$.fragment,o),b(Ts.$$.fragment,o),b(xs.$$.fragment,o),Fl=!1},d(o){t(p),o&&t(F),o&&t(k),v(T),o&&t(ke),o&&t(j),o&&t(We),o&&t(G),v(Y),o&&t(ae),o&&t(se),o&&t(N),o&&t(ye),o&&t(Re),o&&t(H),o&&t(q),o&&t(L),o&&t(re),o&&t(me),v(Oe),o&&t(Hd),o&&t(ct),o&&t(Qd),o&&t(Dt),v(cn),o&&t(Vd),o&&t(xe),o&&t(Jd),o&&t(Rt),v(pn),o&&t(Xd),o&&t(pt),o&&t(Kd),v(hn,o),o&&t(Zd),o&&t(Ut),v(un),o&&t(Yd),o&&t(fe),v(mn),v(_n),o&&t(el),o&&t(Vt),v(gn),o&&t(tl),o&&t(at),v(bn),o&&t(ol),o&&t(Jt),v(vn),o&&t(nl),o&&t(st),v(kn),o&&t(al),o&&t(Xt),v(Tn),o&&t(sl),o&&t(Le),v(xn),v(Bn),v(Bo),v($n),o&&t(rl),o&&t(Zt),v(jn),o&&t(il),o&&t(Ge),v(qn),v(Cn),v(jo),v(An),v(Sn),o&&t(dl),o&&t(eo),v(In),o&&t(ll),o&&t(_e),v(Nn),v(Gn),v(Mo),v(Wn),v(Rn),o&&t(cl),o&&t(oo),v(Un),o&&t(pl),o&&t(ge),v(Hn),v(Xn),v(Eo),v(Kn),o&&t(hl),o&&t(so),v(Zn),o&&t(ul),o&&t(Yn),v(ea),v(ta),o&&t(ml),o&&t(ro),v(oa),o&&t(fl),o&&t(be),v(na),v(So),v(ia),v(Io),v(da),o&&t(_l),o&&t(lo),v(la),o&&t(gl),o&&t(ve),v(ca),v(Oo),v(ma),v(Do),v(fa),v(_a),o&&t(bl),o&&t(po),v(ga),o&&t(vl),o&&t(O),v(ba),v(Fa),v(Go),v(Ba),v($a),v(ja),v(qa),v(Ma),o&&t(kl),o&&t(uo),v(Pa),o&&t(yl),o&&t(D),v(Ea),v(La),v(Ro),v(Ga),v(Wa),v(Ra),v(Ua),v(Ha),v(Qa),o&&t(Tl),o&&t(fo),v(Va),o&&t(xl),o&&t(A),v(Ja),v(ns),v(Ho),v(as),v(ss),v(rs),v(is),v(ds),o&&t(wl),o&&t(go),v(ls),o&&t(zl),o&&t(S),v(cs),v(bs),v(Vo),v(vs),v(ks),v(ys),v(Ts),v(xs)}}}const Wy={local:"bart",sections:[{local:"overview",sections:[{local:"examples",title:"Examples"}],title:"Overview"},{local:"implementation-notes",title:"Implementation Notes"},{local:"mask-filling",title:"Mask Filling"},{local:"transformers.BartConfig",title:"BartConfig"},{local:"transformers.BartTokenizer",title:"BartTokenizer"},{local:"transformers.BartTokenizerFast",title:"BartTokenizerFast"},{local:"transformers.BartModel",title:"BartModel"},{local:"transformers.BartForConditionalGeneration",title:"BartForConditionalGeneration"},{local:"transformers.BartForSequenceClassification",title:"BartForSequenceClassification"},{local:"transformers.BartForQuestionAnswering",title:"BartForQuestionAnswering"},{local:"transformers.BartForCausalLM",title:"BartForCausalLM"},{local:"transformers.TFBartModel",title:"TFBartModel"},{local:"transformers.TFBartForConditionalGeneration",title:"TFBartForConditionalGeneration"},{local:"transformers.FlaxBartModel",title:"FlaxBartModel"},{local:"transformers.FlaxBartForConditionalGeneration",title:"FlaxBartForConditionalGeneration"},{local:"transformers.FlaxBartForSequenceClassification",title:"FlaxBartForSequenceClassification"},{local:"transformers.FlaxBartForQuestionAnswering",title:"FlaxBartForQuestionAnswering"}],title:"BART"};function Ry(M,p,F){let{fw:k}=p;return M.$$set=x=>{"fw"in x&&F(0,k=x.fw)},[k]}class Ky extends Fy{constructor(p){super();By(this,p,Ry,Gy,$y,{fw:0})}}export{Ky as default,Wy as metadata};
