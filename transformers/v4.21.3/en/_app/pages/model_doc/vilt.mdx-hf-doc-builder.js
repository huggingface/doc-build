import{S as Md,i as Pd,s as jd,e as n,k as m,w as k,t as r,M as zd,c as s,d as o,m as p,a,x as w,h as i,b as c,N as Id,G as e,g as _,y as x,q as T,o as y,B as $,v as Cd,L as zo}from"../../chunks/vendor-hf-doc-builder.js";import{T as Gt}from"../../chunks/Tip-hf-doc-builder.js";import{D as E}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Io}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as H}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as jo}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ad(V){let d,b,g,u,v;return u=new Io({props:{code:`from transformers import ViLTModel, ViLTConfig
...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var h=a(d);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(h,"CODE",{});var F=a(g);u=i(F,"Module"),F.forEach(o),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(l,h){_(l,d,h),e(d,b),e(d,g),e(g,u),e(d,v)},d(l){l&&o(d)}}}function Kd(V){let d,b,g,u,v,l,h,F,Cs,Dn,Z,ve,Co,rt,As,Ao,Ls,Wn,be,qs,it,Ns,Ss,Rn,Jt,Os,Bn,Xt,Lo,Ds,Qn,Zt,Ws,Un,q,lt,Rs,dt,Bs,Qs,Us,R,Hs,qo,Ks,Gs,No,Js,Xs,Yt,Zs,Ys,ea,Y,ta,So,oa,na,eo,sa,aa,ra,Oo,ia,Hn,ke,rl,Kn,we,la,to,da,ca,Gn,K,ma,ct,pa,ha,mt,fa,ua,Jn,ee,xe,Do,pt,ga,Wo,_a,Xn,P,ht,va,te,ba,Ro,ka,wa,ft,xa,Ta,ya,oe,$a,oo,Va,Fa,no,Ea,Ma,Pa,Te,Zn,ne,ye,Bo,ut,ja,Qo,za,Yn,j,gt,Ia,Uo,Ca,Aa,_t,La,so,qa,Na,Sa,G,vt,Oa,Ho,Da,Wa,$e,es,se,Ve,Ko,bt,Ra,Go,Ba,ts,z,kt,Qa,Jo,Ua,Ha,M,ao,Ka,Ga,ro,Ja,Xa,io,Za,Ya,wt,Xo,er,tr,or,Zo,nr,sr,ar,J,xt,rr,ae,ir,Fe,lr,Yo,dr,cr,mr,Ee,pr,en,hr,fr,ur,gr,tn,_r,os,re,Me,on,Tt,vr,nn,br,ns,B,yt,kr,$t,wr,sn,xr,Tr,yr,N,Vt,$r,ie,Vr,lo,Fr,Er,an,Mr,Pr,jr,Pe,zr,je,ss,le,ze,rn,Ft,Ir,ln,Cr,as,I,Et,Ar,dn,Lr,qr,Mt,Nr,cn,Sr,Or,Dr,S,Pt,Wr,de,Rr,co,Br,Qr,mn,Ur,Hr,Kr,Ie,Gr,Ce,rs,ce,Ae,pn,jt,Jr,hn,Xr,is,C,zt,Zr,fn,Yr,ei,It,ti,un,oi,ni,si,O,Ct,ai,me,ri,mo,ii,li,gn,di,ci,mi,Le,pi,qe,ls,pe,Ne,_n,At,hi,vn,fi,ds,Q,Lt,ui,bn,gi,_i,D,qt,vi,he,bi,po,ki,wi,kn,xi,Ti,yi,Se,$i,Oe,cs,fe,De,wn,Nt,Vi,xn,Fi,ms,A,St,Ei,Tn,Mi,Pi,Ot,ji,yn,zi,Ii,Ci,W,Dt,Ai,ue,Li,ho,qi,Ni,$n,Si,Oi,Di,We,Wi,Re,ps,ge,Be,Vn,Wt,Ri,Fn,Bi,hs,L,Rt,Qi,En,Ui,Hi,Bt,Ki,Mn,Gi,Ji,Xi,X,Qt,Zi,_e,Yi,fo,el,tl,Pn,ol,nl,sl,Qe,fs;return l=new H({}),rt=new H({}),pt=new H({}),ht=new E({props:{name:"class transformers.ViltConfig",anchor:"transformers.ViltConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"type_vocab_size",val:" = 2"},{name:"modality_type_vocab_size",val:" = 2"},{name:"max_position_embeddings",val:" = 40"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 384"},{name:"patch_size",val:" = 32"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"max_image_length",val:" = -1"},{name:"tie_word_embeddings",val:" = False"},{name:"num_images",val:" = -1"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViltConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the text part of the model. Defines the number of different tokens that can be
represented by the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.3/en/model_doc/vilt#transformers.ViltModel">ViltModel</a>.`,name:"vocab_size"},{anchor:"transformers.ViltConfig.type_vocab_size",description:`<strong>type_vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 2) &#x2014;
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/v4.21.3/en/model_doc/vilt#transformers.ViltModel">ViltModel</a>. This is used when encoding
...
The vocabulary size of the modalities passed when calling <a href="/docs/transformers/v4.21.3/en/model_doc/vilt#transformers.ViltModel">ViltModel</a>. This is used after concatening the
...
</ul>`,name:"pad_and_return_pixel_mask"},{anchor:"transformers.ViltFeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/v4.21.3/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>, defaults to <code>&apos;np&apos;</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/feature_extraction_vilt.py#L181",returnDescription:`
<p>A <a
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.21.3/en/model_doc/vilt#transformers.ViltFeatureExtractor">ViltFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/v4.21.3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L756",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.3/en/model_doc/vilt#transformers.ViltConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.3/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L893"}}),Pt=new E({props:{name:"forward",anchor:"transformers.ViltForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.21.3/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.21.3/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.3/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
loss is only computed for the tokens with labels in <em>[0, &#x2026;, config.vocab_size]</em>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L909",returnDescription:`
<p>A <a
...
`}}),Ie=new Gt({props:{$$slots:{default:[Sd]},$$scope:{ctx:V}}}),Ce=new jo({props:{anchor:"transformers.ViltForMaskedLM.forward.example",$$slots:{default:[Od]},$$scope:{ctx:V}}}),jt=new H({}),zt=new E({props:{name:"class transformers.ViltForQuestionAnswering",anchor:"transformers.ViltForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.3/en/model_doc/vilt#transformers.ViltConfig">ViltConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.3/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L1065"}}),Ct=new E({props:{name:"forward",anchor:"transformers.ViltForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.21.3/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.21.3/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.3/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
answers are applicable, where 1.0 is the highest score.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L1083",returnDescription:`
<p>A <a
...
`}}),Le=new Gt({props:{$$slots:{default:[Dd]},$$scope:{ctx:V}}}),qe=new jo({props:{anchor:"transformers.ViltForQuestionAnswering.forward.example",$$slots:{default:[Wd]},$$scope:{ctx:V}}}),At=new H({}),Lt=new E({props:{name:"class transformers.ViltForImagesAndTextClassification",anchor:"transformers.ViltForImagesAndTextClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.21.3/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.21.3/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.3/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Whether or not to return a <a href="/docs/transformers/v4.21.3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L1275"}}),qt=new E({props:{name:"forward",anchor:"transformers.ViltForImagesAndTextClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.21.3/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.21.3/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.3/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Binary classification labels.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L1294",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.3/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L1176"}}),Dt=new E({props:{name:"forward",anchor:"transformers.ViltForImageAndTextRetrieval.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.21.3/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.21.3/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.3/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Labels are currently not supported.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L1188",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.3/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.3/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L1415"}}),Qt=new E({props:{name:"forward",anchor:"transformers.ViltForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.21.3/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.21.3/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.3/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/vilt/modeling_vilt.py#L1431",returnDescription:`
<p>A <a
...
for Vision-and-Language Pre-training (VLP).`),Rn=m(),Jt=n("p"),Os=r("The abstract from the paper is the following:"),Bn=m(),Xt=n("p"),Lo=n("em"),Ds=r(`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
...
behavior.`),yr=m(),N=n("div"),k(Vt.$$.fragment),$r=m(),ie=n("p"),Vr=r("The "),lo=n("a"),Fr=r("ViltModel"),Er=r(" forward method, overrides the "),an=n("code"),Mr=r("__call__"),Pr=r(" special method."),jr=m(),k(Pe.$$.fragment),zr=m(),k(je.$$.fragment),ss=m(),le=n("h2"),ze=n("a"),rn=n("span"),k(Ft.$$.fragment),Ir=m(),ln=n("span"),Cr=r("ViltForMaskedLM"),as=m(),I=n("div"),k(Et.$$.fragment),Ar=m(),dn=n("p"),Lr=r("ViLT Model with a language modeling head on top as done during pretraining."),qr=m(),Mt=n("p"),Nr=r("This model is a PyTorch "),cn=n("code"),Sr=r("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),Or=r(`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dr=m(),S=n("div"),k(Pt.$$.fragment),Wr=m(),de=n("p"),Rr=r("The "),co=n("a"),Br=r("ViltForMaskedLM"),Qr=r(" forward method, overrides the "),mn=n("code"),Ur=r("__call__"),Hr=r(" special method."),Kr=m(),k(Ie.$$.fragment),Gr=m(),k(Ce.$$.fragment),rs=m(),ce=n("h2"),Ae=n("a"),pn=n("span"),k(jt.$$.fragment),Jr=m(),hn=n("span"),Xr=r("ViltForQuestionAnswering"),is=m(),C=n("div"),k(zt.$$.fragment),Zr=m(),fn=n("p"),Yr=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),si=m(),O=n("div"),k(Ct.$$.fragment),ai=m(),me=n("p"),ri=r("The "),mo=n("a"),ii=r("ViltForQuestionAnswering"),li=r(" forward method, overrides the "),gn=n("code"),di=r("__call__"),ci=r(" special method."),mi=m(),k(Le.$$.fragment),pi=m(),k(qe.$$.fragment),ls=m(),pe=n("h2"),Ne=n("a"),_n=n("span"),k(At.$$.fragment),hi=m(),vn=n("span"),fi=r("ViltForImagesAndTextClassification"),ds=m(),Q=n("div"),k(Lt.$$.fragment),ui=m(),bn=n("p"),gi=r("Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),_i=m(),D=n("div"),k(qt.$$.fragment),vi=m(),he=n("p"),bi=r("The "),po=n("a"),ki=r("ViltForImagesAndTextClassification"),wi=r(" forward method, overrides the "),kn=n("code"),xi=r("__call__"),Ti=r(" special method."),yi=m(),k(Se.$$.fragment),$i=m(),k(Oe.$$.fragment),cs=m(),fe=n("h2"),De=n("a"),wn=n("span"),k(Nt.$$.fragment),Vi=m(),xn=n("span"),Fi=r("ViltForImageAndTextRetrieval"),ms=m(),A=n("div"),k(St.$$.fragment),Ei=m(),Tn=n("p"),Mi=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ci=m(),W=n("div"),k(Dt.$$.fragment),Ai=m(),ue=n("p"),Li=r("The "),ho=n("a"),qi=r("ViltForImageAndTextRetrieval"),Ni=r(" forward method, overrides the "),$n=n("code"),Si=r("__call__"),Oi=r(" special method."),Di=m(),k(We.$$.fragment),Wi=m(),k(Re.$$.fragment),ps=m(),ge=n("h2"),Be=n("a"),Vn=n("span"),k(Wt.$$.fragment),Ri=m(),Fn=n("span"),Bi=r("ViltForTokenClassification"),hs=m(),L=n("div"),k(Rt.$$.fragment),Qi=m(),En=n("p"),Ui=r(`ViLT Model with a token classification head on top (a linear layer on top of the final hidden-states of the text
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xi=m(),X=n("div"),k(Qt.$$.fragment),Zi=m(),_e=n("p"),Yi=r("The "),fo=n("a"),el=r("ViltForTokenClassification"),tl=r(" forward method, overrides the "),Pn=n("code"),ol=r("__call__"),nl=r(" special method."),sl=m(),k(Qe.$$.fragment),this.h()},l(t){const f=zd('[data-svelte="svelte-1phssyn"]',document.head);d=s(f,"META",{name:!0,content:!0}),f.forEach(o),b=p(t),g=s(t,"H1",{class:!0});var Ut=a(g);u=s(Ut,"A",{id:!0,class:!0,href:!0});var jn=a(u);v=s(jn,"SPAN",{});var zn=a(v);w(l.$$.fragment,zn),zn.forEach(o),jn.forEach(o),h=p(Ut),F=s(Ut,"SPAN",{});var In=a(F);Cs=i(In,"ViLT"),In.forEach(o),Ut.forEach(o),Dn=p(t),Z=s(t,"H2",{class:!0});var Ht=a(Z);ve=s(Ht,"A",{id:!0,class:!0,href:!0});var Cn=a(ve);Co=s(Cn,"SPAN",{});var An=a(Co);w(rt.$$.fragment,An),An.forEach(o),Cn.forEach(o),As=p(Ht),Ao=s(Ht,"SPAN",{});var Ln=a(Ao);Ls=i(Ln,"Overview"),Ln.forEach(o),Ht.forEach(o),Wn=p(t),be=s(t,"P",{});var Kt=a(be);qs=i(Kt,"The ViLT model was proposed in "),it=s(Kt,"A",{href:!0,rel:!0});var qn=a(it);Ns=i(qn,"ViLT: Vision-and-Language Transformer Without Convolution or Region Supervision"),qn.forEach(o),Ss=i(Kt,`
by Wonjae Kim, Bokyung Son, Ildoo Kim. ViLT incorporates text embeddings into a Vision Transformer (ViT), allowing it to have a minimal design
for Vision-and-Language Pre-training (VLP).`),Kt.forEach(o),Rn=p(t),Jt=s(t,"P",{});var Nn=a(Jt);Os=i(Nn,"The abstract from the paper is the following:"),Nn.forEach(o),Bn=p(t),Xt=s(t,"P",{});var Sn=a(Xt);Lo=s(Sn,"EM",{});var On=a(Lo);Ds=i(On,`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
Current approaches to VLP heavily rely on image feature extraction processes, most of which involve region supervision
(e.g., object detection) and the convolutional architecture (e.g., ResNet). Although disregarded in the literature, we
find it problematic in terms of both (1) efficiency/speed, that simply extracting input features requires much more
computation than the multimodal interaction steps; and (2) expressive power, as it is upper bounded to the expressive
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ys.forEach(o),yr=p(xo),N=s(xo,"DIV",{class:!0});var Xe=a(N);w(Vt.$$.fragment,Xe),$r=p(Xe),ie=s(Xe,"P",{});var To=a(ie);Vr=i(To,"The "),lo=s(To,"A",{href:!0});var Hl=a(lo);Fr=i(Hl,"ViltModel"),Hl.forEach(o),Er=i(To," forward method, overrides the "),an=s(To,"CODE",{});var Kl=a(an);Mr=i(Kl,"__call__"),Kl.forEach(o),Pr=i(To," special method."),To.forEach(o),jr=p(Xe),w(Pe.$$.fragment,Xe),zr=p(Xe),w(je.$$.fragment,Xe),Xe.forEach(o),xo.forEach(o),ss=p(t),le=s(t,"H2",{class:!0});var $s=a(le);ze=s($s,"A",{id:!0,class:!0,href:!0});var Gl=a(ze);rn=s(Gl,"SPAN",{});var Jl=a(rn);w(Ft.$$.fragment,Jl),Jl.forEach(o),Gl.forEach(o),Ir=p($s),ln=s($s,"SPAN",{});var Xl=a(ln);Cr=i(Xl,"ViltForMaskedLM"),Xl.forEach(o),$s.forEach(o),as=p(t),I=s(t,"DIV",{class:!0});var Ze=a(I);w(Et.$$.fragment,Ze),Ar=p(Ze),dn=s(Ze,"P",{});var Zl=a(dn);Lr=i(Zl,"ViLT Model with a language modeling head on top as done during pretraining."),Zl.forEach(o),qr=p(Ze),Mt=s(Ze,"P",{});var Vs=a(Mt);Nr=i(Vs,"This model is a PyTorch "),cn=s(Vs,"CODE",{});var Yl=a(cn);Sr=i(Yl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),Yl.forEach(o),Or=i(Vs,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Vs.forEach(o),Dr=p(Ze),S=s(Ze,"DIV",{class:!0});var Ye=a(S);w(Pt.$$.fragment,Ye),Wr=p(Ye),de=s(Ye,"P",{});var yo=a(de);Rr=i(yo,"The "),co=s(yo,"A",{href:!0});var ed=a(co);Br=i(ed,"ViltForMaskedLM"),ed.forEach(o),Qr=i(yo," forward method, overrides the "),mn=s(yo,"CODE",{});var td=a(mn);Ur=i(td,"__call__"),td.forEach(o),Hr=i(yo," special method."),yo.forEach(o),Kr=p(Ye),w(Ie.$$.fragment,Ye),Gr=p(Ye),w(Ce.$$.fragment,Ye),Ye.forEach(o),Ze.forEach(o),rs=p(t),ce=s(t,"H2",{class:!0});var Fs=a(ce);Ae=s(Fs,"A",{id:!0,class:!0,href:!0});var od=a(Ae);pn=s(od,"SPAN",{});var nd=a(pn);w(jt.$$.fragment,nd),nd.forEach(o),od.forEach(o),Jr=p(Fs),hn=s(Fs,"SPAN",{});var sd=a(hn);Xr=i(sd,"ViltForQuestionAnswering"),sd.forEach(o),Fs.forEach(o),is=p(t),C=s(t,"DIV",{class:!0});var et=a(C);w(zt.$$.fragment,et),Zr=p(et),fn=s(et,"P",{});var ad=a(fn);Yr=i(ad,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Es.forEach(o),si=p(et),O=s(et,"DIV",{class:!0});var tt=a(O);w(Ct.$$.fragment,tt),ai=p(tt),me=s(tt,"P",{});var $o=a(me);ri=i($o,"The "),mo=s($o,"A",{href:!0});var id=a(mo);ii=i(id,"ViltForQuestionAnswering"),id.forEach(o),li=i($o," forward method, overrides the "),gn=s($o,"CODE",{});var ld=a(gn);di=i(ld,"__call__"),ld.forEach(o),ci=i($o," special method."),$o.forEach(o),mi=p(tt),w(Le.$$.fragment,tt),pi=p(tt),w(qe.$$.fragment,tt),tt.forEach(o),et.forEach(o),ls=p(t),pe=s(t,"H2",{class:!0});var Ms=a(pe);Ne=s(Ms,"A",{id:!0,class:!0,href:!0});var dd=a(Ne);_n=s(dd,"SPAN",{});var cd=a(_n);w(At.$$.fragment,cd),cd.forEach(o),dd.forEach(o),hi=p(Ms),vn=s(Ms,"SPAN",{});var md=a(vn);fi=i(md,"ViltForImagesAndTextClassification"),md.forEach(o),Ms.forEach(o),ds=p(t),Q=s(t,"DIV",{class:!0});var Vo=a(Q);w(Lt.$$.fragment,Vo),ui=p(Vo),bn=s(Vo,"P",{});var pd=a(bn);gi=i(pd,"Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),pd.forEach(o),_i=p(Vo),D=s(Vo,"DIV",{class:!0});var ot=a(D);w(qt.$$.fragment,ot),vi=p(ot),he=s(ot,"P",{});var Fo=a(he);bi=i(Fo,"The "),po=s(Fo,"A",{href:!0});var hd=a(po);ki=i(hd,"ViltForImagesAndTextClassification"),hd.forEach(o),wi=i(Fo," forward method, overrides the "),kn=s(Fo,"CODE",{});var fd=a(kn);xi=i(fd,"__call__"),fd.forEach(o),Ti=i(Fo," special method."),Fo.forEach(o),yi=p(ot),w(Se.$$.fragment,ot),$i=p(ot),w(Oe.$$.fragment,ot),ot.forEach(o),Vo.forEach(o),cs=p(t),fe=s(t,"H2",{class:!0});var Ps=a(fe);De=s(Ps,"A",{id:!0,class:!0,href:!0});var ud=a(De);wn=s(ud,"SPAN",{});var gd=a(wn);w(Nt.$$.fragment,gd),gd.forEach(o),ud.forEach(o),Vi=p(Ps),xn=s(Ps,"SPAN",{});var _d=a(xn);Fi=i(_d,"ViltForImageAndTextRetrieval"),_d.forEach(o),Ps.forEach(o),ms=p(t),A=s(t,"DIV",{class:!0});var nt=a(A);w(St.$$.fragment,nt),Ei=p(nt),Tn=s(nt,"P",{});var vd=a(Tn);Mi=i(vd,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
