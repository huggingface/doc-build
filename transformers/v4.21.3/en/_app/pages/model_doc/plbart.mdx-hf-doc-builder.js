import{S as Pd,i as Ld,s as $d,e as n,k as u,w as k,t as i,M as qd,c as s,d as o,m,a,x as y,h as d,b as c,G as e,g as _,y as T,q as w,o as P,B as L,v as zd,L as ue}from"../../chunks/vendor-hf-doc-builder.js";import{T as ii}from"../../chunks/Tip-hf-doc-builder.js";import{D as I}from"../../chunks/Docstring-hf-doc-builder.js";import{C as W}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as pe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as he}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Bd($){let l,b,p,f,v;return f=new W({props:{code:`from transformers import PLBartModel, PLBartConfig
...
<span class="hljs-literal">True</span>`}}),{c(){l=n("p"),b=i("Example:"),p=u(),k(f.$$.fragment)},l(r){l=s(r,"P",{});var g=a(l);b=d(g,"Example:"),g.forEach(o),p=m(r),y(f.$$.fragment,r)},m(r,g){_(r,l,g),e(l,b),_(r,p,g),T(f,r,g),v=!0},p:ue,i(r){v||(w(f.$$.fragment,r),v=!0)},o(r){P(f.$$.fragment,r),v=!1},d(r){r&&o(l),r&&o(p),L(f,r)}}}function Dd($){let l,b,p,f,v,r,g,x,ns,rn,D,co,ss,as,Ge,rs,is,Re,ds,ls,dn,K,me,po,He,cs,ho,ps,ln,G,hs,Ue,us,ms,uo,fs,gs,cn,Nt,_s,pn,Ot,mo,bs,hn,R,vs,Ve,ks,ys,Je,Ts,ws,un,Q,fe,fo,Ke,Ps,go,Ls,mn,C,$s,_o,qs,zs,bo,Bs,xs,vo,Cs,Fs,ko,js,Es,fn,ge,Ms,Qe,Ss,As,gn,H,Ns,Ye,yo,Os,Is,Ds,It,Xs,Ws,_n,Dt,To,Gs,bn,Ze,vn,Xt,et,wo,Rs,Hs,Y,Us,Po,Vs,Js,Lo,Ks,Qs,kn,tt,yn,Z,_e,$o,ot,Ys,qo,Zs,Tn,E,nt,ea,ee,ta,Wt,oa,na,st,sa,aa,ra,te,ia,Gt,da,la,Rt,ca,pa,ha,be,wn,oe,ve,zo,at,ua,Bo,ma,Pn,q,rt,fa,xo,ga,_a,X,ba,Ht,va,ka,Ut,ya,Ta,it,wa,Pa,La,dt,$a,Co,qa,za,Ba,ke,xa,ye,lt,Ca,Fo,Fa,ja,A,ct,Ea,pt,Ma,jo,Sa,Aa,Na,ht,ut,Eo,Oa,Ia,Mo,Da,Xa,mt,So,Wa,Ga,Ao,Ra,Ha,No,Ua,Ln,ne,Te,Oo,ft,Va,Io,Ja,$n,M,gt,Ka,_t,Qa,Vt,Ya,Za,er,bt,tr,vt,or,nr,sr,N,kt,ar,se,rr,Jt,ir,dr,Do,lr,cr,pr,we,hr,Pe,qn,ae,Le,Xo,yt,ur,Wo,mr,zn,S,Tt,fr,wt,gr,Kt,_r,br,vr,Pt,kr,Lt,yr,Tr,wr,O,$t,Pr,re,Lr,Qt,$r,qr,Go,zr,Br,xr,$e,Cr,qe,Bn,ie,ze,Ro,qt,Fr,Ho,jr,xn,B,zt,Er,Uo,Mr,Sr,Bt,Ar,Yt,Nr,Or,Ir,xt,Dr,Ct,Xr,Wr,Gr,z,Ft,Rr,de,Hr,Zt,Ur,Vr,Vo,Jr,Kr,Qr,Be,Yr,xe,Zr,Ce,ei,Fe,ti,je,Cn,le,Ee,Jo,jt,oi,Ko,ni,Fn,ce,Et,si,Me,Mt,ai,Se,jn;return r=new pe({}),He=new pe({}),Ke=new pe({}),Ze=new W({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.3/en/model_doc/plbart#transformers.PLBartModel">PLBartModel</a>.`,name:"vocab_size"},{anchor:"transformers.PLBartConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/plbart/tokenization_plbart.py#L324",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.3/en/model_doc/plbart#transformers.PLBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/plbart/modeling_plbart.py#L1277",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/plbart/modeling_plbart.py#L1416",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.21.3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.3/src/transformers/models/plbart/modeling_plbart.py#L1571",returnDescription:`
<p>A <a
...
even with limited annotations.`),hn=u(),R=n("p"),vs=i("This model was contributed by "),Ve=n("a"),ks=i("gchhablani"),ys=i(". The Authors\u2019 code can be found "),Je=n("a"),Ts=i("here"),ws=i("."),un=u(),Q=n("h3"),fe=n("a"),fo=n("span"),k(Ke.$$.fragment),Ps=u(),go=n("span"),Ls=i("Training of PLBart"),mn=u(),C=n("p"),$s=i(`PLBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for code-to-text, text-to-code, code-to-code tasks. As the
...
example shows how to translate Python to English using the `),Lo=n("code"),Ks=i("uclanlp/plbart-python-en_XX"),Qs=i(" model."),kn=u(),k(tt.$$.fragment),yn=u(),Z=n("h2"),_e=n("a"),$o=n("span"),k(ot.$$.fragment),Ys=u(),qo=n("span"),Zs=i("PLBartConfig"),Tn=u(),E=n("div"),k(nt.$$.fragment),ea=u(),ee=n("p"),ta=i("This is the configuration class to store the configuration of a "),Wt=n("a"),oa=i("PLBartModel"),na=i(`. It is used to instantiate an
...
documentation from `),Rt=n("a"),ca=i("PretrainedConfig"),pa=i(" for more information."),ha=u(),k(be.$$.fragment),wn=u(),oe=n("h2"),ve=n("a"),zo=n("span"),k(at.$$.fragment),ua=u(),Bo=n("span"),ma=i("PLBartTokenizer"),Pn=u(),q=n("div"),k(rt.$$.fragment),fa=u(),xo=n("p"),ga=i("Construct an PLBART tokenizer."),_a=u(),X=n("p"),ba=i("Adapted from "),Ht=n("a"),va=i("RobertaTokenizer"),ka=i(" and "),Ut=n("a"),ya=i("XLNetTokenizer"),Ta=i(`. Based on
`),it=n("a"),wa=i("SentencePiece"),Pa=i("."),La=u(),dt=n("p"),$a=i("The tokenization method is "),Co=n("code"),qa=i("<tokens> <eos> <language code>"),za=i(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Ba=u(),k(ke.$$.fragment),xa=u(),ye=n("div"),k(lt.$$.fragment),Ca=u(),Fo=n("p"),Fa=i(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
separator.`),Ln=u(),ne=n("h2"),Te=n("a"),Oo=n("span"),k(ft.$$.fragment),Va=u(),Io=n("span"),Ja=i("PLBartModel"),$n=u(),M=n("div"),k(gt.$$.fragment),Ka=u(),_t=n("p"),Qa=i(`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
documentation from `),Rt=s(ao,"A",{href:!0});var Ai=a(Rt);ca=d(Ai,"PretrainedConfig"),Ai.forEach(o),pa=d(ao," for more information."),ao.forEach(o),ha=m(Ae),y(be.$$.fragment,Ae),Ae.forEach(o),wn=m(t),oe=s(t,"H2",{class:!0});var Nn=a(oe);ve=s(Nn,"A",{id:!0,class:!0,href:!0});var Ni=a(ve);zo=s(Ni,"SPAN",{});var Oi=a(zo);y(at.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),ua=m(Nn),Bo=s(Nn,"SPAN",{});var Ii=a(Bo);ma=d(Ii,"PLBartTokenizer"),Ii.forEach(o),Nn.forEach(o),Pn=m(t),q=s(t,"DIV",{class:!0});var F=a(q);y(rt.$$.fragment,F),fa=m(F),xo=s(F,"P",{});var Di=a(xo);ga=d(Di,"Construct an PLBART tokenizer."),Di.forEach(o),_a=m(F),X=s(F,"P",{});var Ne=a(X);ba=d(Ne,"Adapted from "),Ht=s(Ne,"A",{href:!0});var Xi=a(Ht);va=d(Xi,"RobertaTokenizer"),Xi.forEach(o),ka=d(Ne," and "),Ut=s(Ne,"A",{href:!0});var Wi=a(Ut);ya=d(Wi,"XLNetTokenizer"),Wi.forEach(o),Ta=d(Ne,`. Based on
`),it=s(Ne,"A",{href:!0,rel:!0});var Gi=a(it);wa=d(Gi,"SentencePiece"),Gi.forEach(o),Pa=d(Ne,"."),Ne.forEach(o),La=m(F),dt=s(F,"P",{});var On=a(dt);$a=d(On,"The tokenization method is "),Co=s(On,"CODE",{});var Ri=a(Co);qa=d(Ri,"<tokens> <eos> <language code>"),Ri.forEach(o),za=d(On," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),On.forEach(o),Ba=m(F),y(ke.$$.fragment,F),xa=m(F),ye=s(F,"DIV",{class:!0});var In=a(ye);y(lt.$$.fragment,In),Ca=m(In),Fo=s(In,"P",{});var Hi=a(Fo);Fa=d(Hi,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jn.forEach(o),vr=m(Xe),Pt=s(Xe,"P",{});var Kn=a(Pt);kr=d(Kn,"This model is also a PyTorch "),Lt=s(Kn,"A",{href:!0,rel:!0});var cd=a(Lt);yr=d(cd,"torch.nn.Module"),cd.forEach(o),Tr=d(Kn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
