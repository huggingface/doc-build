...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function by(z){let l,k,m,_,b;return _=new We({props:{code:`import torch
...
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function yy(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, LongformerForMaskedLM
...
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function Ly(z){let l,k,m,_,b;return _=new We({props:{code:`import torch
...
<span class="hljs-number">5.44</span>`}}),{c(){v(l.$$.fragment)},l(m){y(l.$$.fragment,m)},m(m,_){T(l,m,_),k=!0},p:Je,i(m){k||($(l.$$.fragment,m),k=!0)},o(m){L(l.$$.fragment,m),k=!1},d(m){x(l,m)}}}function Fy(z){let l,k,m,_,b;return _=new We({props:{code:`import torch
from transformers import LongformerTokenizer, LongformerForSequenceClassification
...
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function zy(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, LongformerForMultipleChoice
import torch
...
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function Cy(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, LongformerForTokenClassification
import torch
...
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function Py(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, LongformerForQuestionAnswering
import torch
...
the Keras `),B=r("code"),he=n("Functional"),Le=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),ne=c(),C=r("ul"),O=r("li"),_e=n("a single Tensor with "),Q=r("code"),te=n("input_ids"),xe=n(" only and nothing else: "),H=r("code"),Fe=n("model(input_ids)"),Me=c(),j=r("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
format outside of Keras methods like `),G=a(M,"CODE",{});var Ye=i(G);Te=s(Ye,"fit()"),Ye.forEach(t),ge=s(M," and "),W=a(M,"CODE",{});var Ie=i(W);$e=s(Ie,"predict()"),Ie.forEach(t),ue=s(M,`, such as when creating your own layers or models with
the Keras `),B=a(M,"CODE",{});var De=i(B);he=s(De,"Functional"),De.forEach(t),Le=s(M,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),M.forEach(t),ne=h(w),C=a(w,"UL",{});var S=i(C);O=a(S,"LI",{});var K=i(O);_e=s(K,"a single Tensor with "),Q=a(K,"CODE",{});var Se=i(Q);te=s(Se,"input_ids"),Se.forEach(t),xe=s(K," only and nothing else: "),H=a(K,"CODE",{});var Ze=i(H);Fe=s(Ze,"model(input_ids)"),Ze.forEach(t),K.forEach(t),Me=h(S),j=a(S,"LI",{});var V=i(j);Ee=s(V,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),J=a(V,"CODE",{});var Oe=i(J);me=s(Oe,"model([input_ids, attention_mask])"),Oe.forEach(t),ze=s(V," or "),X=a(V,"CODE",{});var He=i(X);we=s(He,"model([input_ids, attention_mask, token_type_ids])"),He.forEach(t),V.forEach(t),se=h(S),I=a(S,"LI",{});var je=i(I);ce=s(je,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Y=a(je,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),je.forEach(t),S.forEach(t),Z=h(w),P=a(w,"P",{});var ae=i(P);Ce=s(ae,`Note that when creating models and layers with
`),N=a(ae,"A",{href:!0,rel:!0});var Re=i(N);re=s(Re,"subclassing"),Re.forEach(t),le=s(ae,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ae.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,m),e(m,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,W),e(W,$e),e(F,ue),e(F,B),e(B,he),e(F,Le),f(w,ne,E),f(w,C,E),e(C,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(C,Me),e(C,j),e(j,Ee),e(j,J),e(J,me),e(j,ze),e(j,X),e(X,we),e(C,se),e(C,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,Ce),e(P,N),e(N,re),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(C),w&&t(Z),w&&t(P)}}}function Ay(z){let l,k,m,_,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function Iy(z){let l,k,m,_,b,d,p,q,ke,pe,A,ie,ee,F,be,U,ve,fe,D,ye,de,G,Te,ge,W,$e,ue,B,he,Le,ne,C,O,_e,Q,te,xe,H,Fe,Me,j,Ee,J,me,ze,X,we,se,I,ce,Y,qe,Z,P,Ce,N,re,le;return{c(){l=r("p"),k=n("TensorFlow models and layers in "),m=r("code"),_=n("transformers"),b=n(" accept two formats as input:"),d=c(),p=r("ul"),q=r("li"),ke=n("having all inputs as keyword arguments (like PyTorch models), or"),pe=c(),A=r("li"),ie=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=c(),F=r("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=r("code"),ve=n("model.fit()"),fe=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=r("code"),ye=n("model.fit()"),de=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),G=r("code"),Te=n("fit()"),ge=n(" and "),W=r("code"),$e=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),B=r("code"),he=n("Functional"),Le=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),Y=a(je,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),je.forEach(t),S.forEach(t),Z=h(w),P=a(w,"P",{});var ae=i(P);Ce=s(ae,`Note that when creating models and layers with
`),N=a(ae,"A",{href:!0,rel:!0});var Re=i(N);re=s(Re,"subclassing"),Re.forEach(t),le=s(ae,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ae.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,m),e(m,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,W),e(W,$e),e(F,ue),e(F,B),e(B,he),e(F,Le),f(w,ne,E),f(w,C,E),e(C,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(C,Me),e(C,j),e(j,Ee),e(j,J),e(J,me),e(j,ze),e(j,X),e(X,we),e(C,se),e(C,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,Ce),e(P,N),e(N,re),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(C),w&&t(Z),w&&t(P)}}}function Dy(z){let l,k,m,_,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function Sy(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMaskedLM
...
<span class="hljs-number">0.44</span>`}}),{c(){v(l.$$.fragment)},l(m){y(l.$$.fragment,m)},m(m,_){T(l,m,_),k=!0},p:Je,i(m){k||($(l.$$.fragment,m),k=!0)},o(m){L(l.$$.fragment,m),k=!1},d(m){x(l,m)}}}function By(z){let l,k,m,_,b,d,p,q,ke,pe,A,ie,ee,F,be,U,ve,fe,D,ye,de,G,Te,ge,W,$e,ue,B,he,Le,ne,C,O,_e,Q,te,xe,H,Fe,Me,j,Ee,J,me,ze,X,we,se,I,ce,Y,qe,Z,P,Ce,N,re,le;return{c(){l=r("p"),k=n("TensorFlow models and layers in "),m=r("code"),_=n("transformers"),b=n(" accept two formats as input:"),d=c(),p=r("ul"),q=r("li"),ke=n("having all inputs as keyword arguments (like PyTorch models), or"),pe=c(),A=r("li"),ie=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=c(),F=r("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=r("code"),ve=n("model.fit()"),fe=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=r("code"),ye=n("model.fit()"),de=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),G=r("code"),Te=n("fit()"),ge=n(" and "),W=r("code"),$e=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),B=r("code"),he=n("Functional"),Le=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),Y=a(je,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),je.forEach(t),S.forEach(t),Z=h(w),P=a(w,"P",{});var ae=i(P);Ce=s(ae,`Note that when creating models and layers with
`),N=a(ae,"A",{href:!0,rel:!0});var Re=i(N);re=s(Re,"subclassing"),Re.forEach(t),le=s(ae,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ae.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,m),e(m,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,W),e(W,$e),e(F,ue),e(F,B),e(B,he),e(F,Le),f(w,ne,E),f(w,C,E),e(C,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(C,Me),e(C,j),e(j,Ee),e(j,J),e(J,me),e(j,ze),e(j,X),e(X,we),e(C,se),e(C,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,Ce),e(P,N),e(N,re),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(C),w&&t(Z),w&&t(P)}}}function Qy(z){let l,k,m,_,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function Uy(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, TFLongformerForQuestionAnswering
import tensorflow as tf
...
<span class="hljs-number">0.96</span>`}}),{c(){v(l.$$.fragment)},l(m){y(l.$$.fragment,m)},m(m,_){T(l,m,_),k=!0},p:Je,i(m){k||($(l.$$.fragment,m),k=!0)},o(m){L(l.$$.fragment,m),k=!1},d(m){x(l,m)}}}function Ry(z){let l,k,m,_,b,d,p,q,ke,pe,A,ie,ee,F,be,U,ve,fe,D,ye,de,G,Te,ge,W,$e,ue,B,he,Le,ne,C,O,_e,Q,te,xe,H,Fe,Me,j,Ee,J,me,ze,X,we,se,I,ce,Y,qe,Z,P,Ce,N,re,le;return{c(){l=r("p"),k=n("TensorFlow models and layers in "),m=r("code"),_=n("transformers"),b=n(" accept two formats as input:"),d=c(),p=r("ul"),q=r("li"),ke=n("having all inputs as keyword arguments (like PyTorch models), or"),pe=c(),A=r("li"),ie=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=c(),F=r("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=r("code"),ve=n("model.fit()"),fe=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=r("code"),ye=n("model.fit()"),de=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),G=r("code"),Te=n("fit()"),ge=n(" and "),W=r("code"),$e=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),B=r("code"),he=n("Functional"),Le=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),Y=a(je,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),je.forEach(t),S.forEach(t),Z=h(w),P=a(w,"P",{});var ae=i(P);Ce=s(ae,`Note that when creating models and layers with
`),N=a(ae,"A",{href:!0,rel:!0});var Re=i(N);re=s(Re,"subclassing"),Re.forEach(t),le=s(ae,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ae.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,m),e(m,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,W),e(W,$e),e(F,ue),e(F,B),e(B,he),e(F,Le),f(w,ne,E),f(w,C,E),e(C,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(C,Me),e(C,j),e(j,Ee),e(j,J),e(J,me),e(j,ze),e(j,X),e(X,we),e(C,se),e(C,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,Ce),e(P,N),e(N,re),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(C),w&&t(Z),w&&t(P)}}}function Ky(z){let l,k,m,_,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function Vy(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.69</span>`}}),{c(){v(l.$$.fragment)},l(m){y(l.$$.fragment,m)},m(m,_){T(l,m,_),k=!0},p:Je,i(m){k||($(l.$$.fragment,m),k=!0)},o(m){L(l.$$.fragment,m),k=!1},d(m){x(l,m)}}}function Jy(z){let l,k,m,_,b,d,p,q,ke,pe,A,ie,ee,F,be,U,ve,fe,D,ye,de,G,Te,ge,W,$e,ue,B,he,Le,ne,C,O,_e,Q,te,xe,H,Fe,Me,j,Ee,J,me,ze,X,we,se,I,ce,Y,qe,Z,P,Ce,N,re,le;return{c(){l=r("p"),k=n("TensorFlow models and layers in "),m=r("code"),_=n("transformers"),b=n(" accept two formats as input:"),d=c(),p=r("ul"),q=r("li"),ke=n("having all inputs as keyword arguments (like PyTorch models), or"),pe=c(),A=r("li"),ie=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=c(),F=r("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=r("code"),ve=n("model.fit()"),fe=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=r("code"),ye=n("model.fit()"),de=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),G=r("code"),Te=n("fit()"),ge=n(" and "),W=r("code"),$e=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),B=r("code"),he=n("Functional"),Le=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),Y=a(je,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),je.forEach(t),S.forEach(t),Z=h(w),P=a(w,"P",{});var ae=i(P);Ce=s(ae,`Note that when creating models and layers with
`),N=a(ae,"A",{href:!0,rel:!0});var Re=i(N);re=s(Re,"subclassing"),Re.forEach(t),le=s(ae,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ae.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,m),e(m,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,W),e(W,$e),e(F,ue),e(F,B),e(B,he),e(F,Le),f(w,ne,E),f(w,C,E),e(C,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(C,Me),e(C,j),e(j,Ee),e(j,J),e(J,me),e(j,ze),e(j,X),e(X,we),e(C,se),e(C,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,Ce),e(P,N),e(N,re),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(C),w&&t(Z),w&&t(P)}}}function Xy(z){let l,k,m,_,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function Yy(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
`),Y=a(je,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),je.forEach(t),S.forEach(t),Z=h(w),P=a(w,"P",{});var ae=i(P);Ce=s(ae,`Note that when creating models and layers with
`),N=a(ae,"A",{href:!0,rel:!0});var Re=i(N);re=s(Re,"subclassing"),Re.forEach(t),le=s(ae,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ae.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,m),e(m,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,W),e(W,$e),e(F,ue),e(F,B),e(B,he),e(F,Le),f(w,ne,E),f(w,C,E),e(C,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(C,Me),e(C,j),e(j,Ee),e(j,J),e(J,me),e(j,ze),e(j,X),e(X,we),e(C,se),e(C,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,Ce),e(P,N),e(N,re),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(C),w&&t(Z),w&&t(P)}}}function tT(z){let l,k,m,_,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(p,"CODE",{});var q=i(m);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,m),e(m,_),e(l,b)},d(d){d&&t(l)}}}function oT(z){let l,k,m,_,b;return _=new We({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMultipleChoice
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),k=n("Example:"),m=c(),v(_.$$.fragment)},l(d){l=a(d,"P",{});var p=i(l);k=s(p,"Example:"),p.forEach(t),m=h(d),y(_.$$.fragment,d)},m(d,p){f(d,l,p),e(l,k),f(d,m,p),T(_,d,p),b=!0},p:Je,i(d){b||($(_.$$.fragment,d),b=!0)},o(d){L(_.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(m),x(_,d)}}}function nT(z){let l,k,m,_,b,d,p,q,ke,pe,A,ie,ee,F,be,U,ve,fe,D,ye,de,G,Te,ge,W,$e,ue,B,he,Le,ne,C,O,_e,Q,te,xe,H,Fe,Me,j,Ee,J,me,ze,X,we,se,I,ce,Y,qe,Z,P,Ce,N,re,le,w,E,Be,oe,Qe,Ne,M,Ue,Ae,Ye='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mfrac><mn>1</mn><mn>2</mn></mfrac><mi>w</mi></mrow><annotation encoding="application/x-tex">\\frac{1}{2} w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1.1901em;vertical-align:-0.345em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.8451em;"><span style="top:-2.655em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">2</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.394em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">1</span></span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.345em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',Ie,De,S='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mfrac><mn>1</mn><mn>2</mn></mfrac><mi>w</mi></mrow><annotation encoding="application/x-tex">\\frac{1}{2} w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1.1901em;vertical-align:-0.345em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.8451em;"><span style="top:-2.655em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">2</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.394em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">1</span></span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.345em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',K,Se,Ze='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>w</mi></mrow><annotation encoding="application/x-tex">w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',V,Oe,He,je,Pe,ae,Re,bi,Xh,Yh,zd,iy='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>w</mi></mrow><annotation encoding="application/x-tex">w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',qd,vi,Zh,em,Cd,At,tm,jd,ly='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>w</mi></mrow><annotation encoding="application/x-tex">w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',Od,yi,om,nm,Pd,It,sm,Ti,rm,am,$i,im,lm,Nd,tn,Li,dm,cm,xi,hm,Ad,on,mm,fa,pm,fm,Id,ut,gm,Dd,dy='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi mathvariant="script">O</mi><mo stretchy="false">(</mo><msub><mi>n</mi><mi>s</mi></msub><mo>\xD7</mo><msub><mi>n</mi><mi>s</mi></msub><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">\\mathcal{O}(n_s \\times n_s)</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathcal" style="margin-right:0.02778em;">O</span><span class="mopen">(</span><span class="mord"><span class="mord mathnormal">n</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">s</span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">\xD7</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord"><span class="mord mathnormal">n</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">s</span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span><span class="mclose">)</span></span></span></span>',Sd,Wd,cy='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi mathvariant="script">O</mi><mo stretchy="false">(</mo><msub><mi>n</mi><mi>s</mi></msub><mo>\xD7</mo><mi>w</mi><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">\\mathcal{O}(n_s \\times w)</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathcal" style="margin-right:0.02778em;">O</span><span class="mopen">(</span><span class="mord"><span class="mord mathnormal">n</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">s</span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">\xD7</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span><span class="mclose">)</span></span></span></span>',Bd,Qd,hy='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>n</mi><mi>s</mi></msub></mrow><annotation encoding="application/x-tex">n_s</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.5806em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal">n</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">s</span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>',Ud,Hd,my='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>w</mi></mrow><annotation encoding="application/x-tex">w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',Rd,Kd,nn,um,ps,_m,wm,Vd,Yt,sn,Fi,fs,km,Mi,bm,Gd,Zt,ga,vm,ym,ua,Tm,$m,Jd,gs,Xd,eo,rn,Ei,us,Lm,zi,xm,Yd,ct,_s,Fm,to,Mm,_a,Em,zm,wa,qm,Cm,jm,oo,Om,ka,Pm,Nm,ws,Am,Im,Dm,no,Sm,ba,Wm,Bm,va,Qm,Um,Hm,an,Zd,so,ln,qi,ks,Rm,Ci,Km,ec,Ot,bs,Vm,ji,Gm,Jm,dn,ya,Xm,Ym,Ta,Zm,ep,tc,ro,cn,Oi,vs,tp,Pi,op,oc,Pt,ys,np,Ts,sp,Ni,rp,ap,ip,hn,$a,lp,dp,La,cp,hp,nc,ao,mn,Ai,$s,mp,Ii,pp,sc,io,Ls,fp,Di,gp,rc,lo,xs,up,Si,_p,ac,co,Fs,wp,Wi,kp,ic,ho,Ms,bp,Bi,vp,lc,mo,Es,yp,Qi,Tp,dc,po,zs,$p,Ui,Lp,cc,fo,qs,xp,Hi,Fp,hc,go,Cs,Mp,Ri,Ep,mc,uo,js,zp,Ki,qp,pc,_o,Os,Cp,Vi,jp,fc,wo,Ps,Op,Gi,Pp,gc,ko,Ns,Np,Ji,Ap,uc,bo,As,Ip,Xi,Dp,_c,vo,Is,Sp,Yi,Wp,wc,yo,pn,Zi,Ds,Bp,el,Qp,kc,et,Ss,Up,tl,Hp,Rp,Ws,Kp,xa,Vp,Gp,Jp,Bs,Xp,Qs,Yp,Zp,ef,To,tf,Fa,of,nf,Us,sf,rf,af,Hs,lf,ol,df,cf,hf,$t,Rs,mf,$o,pf,Ma,ff,gf,nl,uf,_f,wf,fn,kf,gn,bc,Lo,un,sl,Ks,bf,rl,vf,vc,ht,Vs,yf,Gs,Tf,al,$f,Lf,xf,Js,Ff,Ea,Mf,Ef,zf,Xs,qf,Ys,Cf,jf,Of,lt,Zs,Pf,xo,Nf,za,Af,If,il,Df,Sf,Wf,_n,Bf,wn,Qf,ll,Uf,Hf,kn,yc,Fo,bn,dl,er,Rf,cl,Kf,Tc,mt,tr,Vf,hl,Gf,Jf,or,Xf,qa,Yf,Zf,eg,nr,tg,sr,og,ng,sg,tt,rr,rg,Mo,ag,Ca,ig,lg,ml,dg,cg,hg,vn,mg,yn,pg,Tn,fg,$n,gg,Ln,$c,Eo,xn,pl,ar,ug,fl,_g,Lc,pt,ir,wg,gl,kg,bg,lr,vg,ja,yg,Tg,$g,dr,Lg,cr,xg,Fg,Mg,Lt,hr,Eg,zo,zg,Oa,qg,Cg,ul,jg,Og,Pg,Fn,Ng,Mn,xc,qo,En,_l,mr,Ag,wl,Ig,Fc,ft,pr,Dg,kl,Sg,Wg,fr,Bg,Pa,Qg,Ug,Hg,gr,Rg,ur,Kg,Vg,Gg,_t,_r,Jg,Co,Xg,Na,Yg,Zg,bl,eu,tu,ou,zn,nu,qn,su,Cn,Mc,jo,jn,vl,wr,ru,yl,au,Ec,gt,kr,iu,Oo,lu,Tl,du,cu,$l,hu,mu,pu,br,fu,Aa,gu,uu,_u,vr,wu,yr,ku,bu,vu,xt,Tr,yu,Po,Tu,Ia,$u,Lu,Ll,xu,Fu,Mu,On,Eu,Pn,zc,No,Nn,xl,$r,zu,Fl,qu,qc,Ke,Lr,Cu,Ml,ju,Ou,xr,Pu,Da,Nu,Au,Iu,Fr,Du,Mr,Su,Wu,Bu,An,Qu,Ao,Uu,Sa,Hu,Ru,Er,Ku,Vu,Gu,zr,Ju,El,Xu,Yu,Zu,Dt,qr,e_,Io,t_,Wa,o_,n_,zl,s_,r_,a_,In,Cc,Do,Dn,ql,Cr,i_,Cl,l_,jc,nt,jr,d_,Or,c_,jl,h_,m_,p_,Pr,f_,Ba,g_,u_,__,Nr,w_,Ar,k_,b_,v_,Sn,y_,wt,Ir,T_,So,$_,Qa,L_,x_,Ol,F_,M_,E_,Wn,z_,Bn,q_,Qn,Oc,Wo,Un,Pl,Dr,C_,Nl,j_,Pc,st,Sr,O_,Bo,P_,Al,N_,A_,Il,I_,D_,S_,Wr,W_,Ua,B_,Q_,U_,Br,H_,Qr,R_,K_,V_,Hn,G_,kt,Ur,J_,Qo,X_,Ha,Y_,Z_,Dl,ew,tw,ow,Rn,nw,Kn,sw,Vn,Nc,Uo,Gn,Sl,Hr,rw,Wl,aw,Ac,rt,Rr,iw,Bl,lw,dw,Kr,cw,Ra,hw,mw,pw,Vr,fw,Gr,gw,uw,_w,Jn,ww,bt,Jr,kw,Ho,bw,Ka,vw,yw,Ql,Tw,$w,Lw,Xn,xw,Yn,Fw,Zn,Ic,Ro,es,Ul,Xr,Mw,Hl,Ew,Dc,at,Yr,zw,Rl,qw,Cw,Zr,jw,Va,Ow,Pw,Nw,ea,Aw,ta,Iw,Dw,Sw,ts,Ww,vt,oa,Bw,Ko,Qw,Ga,Uw,Hw,Kl,Rw,Kw,Vw,os,Gw,ns,Jw,ss,Sc,Vo,rs,Vl,na,Xw,Gl,Yw,Wc,it,sa,Zw,Jl,ek,tk,ra,ok,Ja,nk,sk,rk,aa,ak,ia,ik,lk,dk,as,ck,Ft,la,hk,Go,mk,Xa,pk,fk,Xl,gk,uk,_k,is,wk,ls,Bc;return d=new Xe({}),F=new Xe({}),E=new Xe({}),fs=new Xe({}),gs=new We({props:{code:`input_ids = tokenizer.encode("This is a sentence from [MASK] training data", return_tensors="pt")
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/v4.22.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.LongformerConfig"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_longformer.py#L1791",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_longformer.py#L1900",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_longformer.py#L2255",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_longformer.py#L2169",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
`}}),zn=new ot({props:{$$slots:{default:[qy]},$$scope:{ctx:z}}}),qn=new Ge({props:{anchor:"transformers.LongformerForTokenClassification.forward.example",$$slots:{default:[Cy]},$$scope:{ctx:z}}}),Cn=new Ge({props:{anchor:"transformers.LongformerForTokenClassification.forward.example-2",$$slots:{default:[jy]},$$scope:{ctx:z}}}),wr=new Xe({}),kr=new R({props:{name:"class transformers.LongformerForQuestionAnswering",anchor:"transformers.LongformerForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_longformer.py#L2028",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_tf_longformer.py#L2057"}}),In=new ot({props:{$$slots:{default:[Ay]},$$scope:{ctx:z}}}),Cr=new Xe({}),jr=new R({props:{name:"class transformers.TFLongformerForMaskedLM",anchor:"transformers.TFLongformerForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLongformerForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_tf_longformer.py#L2125",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
`}}),Wn=new ot({props:{$$slots:{default:[Dy]},$$scope:{ctx:z}}}),Bn=new Ge({props:{anchor:"transformers.TFLongformerForMaskedLM.call.example",$$slots:{default:[Sy]},$$scope:{ctx:z}}}),Qn=new Ge({props:{anchor:"transformers.TFLongformerForMaskedLM.call.example-2",$$slots:{default:[Wy]},$$scope:{ctx:z}}}),Dr=new Xe({}),Sr=new R({props:{name:"class transformers.TFLongformerForQuestionAnswering",anchor:"transformers.TFLongformerForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_tf_longformer.py#L2205"}}),Hn=new ot({props:{$$slots:{default:[By]},$$scope:{ctx:z}}}),Ur=new R({props:{name:"call",anchor:"transformers.TFLongformerForQuestionAnswering.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"global_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"start_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"end_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/v4.22.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.22.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_tf_longformer.py#L2220",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_tf_longformer.py#L2386",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_tf_longformer.py#L2641",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/longformer/modeling_tf_longformer.py#L2510",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
WikiHop and TriviaQA.`),ne=c(),C=r("p"),O=n("Tips:"),_e=c(),Q=r("ul"),te=r("li"),xe=n("Since the Longformer is based on RoBERTa, it doesn\u2019t have "),H=r("code"),Fe=n("token_type_ids"),Me=n(`. You don\u2019t need to indicate which
...
`),me=r("code"),ze=n("</s>"),X=n(")."),we=c(),se=r("p"),I=n("This model was contributed by "),ce=r("a"),Y=n("beltagy"),qe=n(". The Authors\u2019 code can be found "),Z=r("a"),P=n("here"),Ce=n("."),N=c(),re=r("h2"),le=r("a"),w=r("span"),v(E.$$.fragment),Be=c(),oe=r("span"),Qe=n("Longformer Self Attention"),Ne=c(),M=r("p"),Ue=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),Oe=r("code"),He=n("config.attention_window"),je=n(". Note that "),Pe=r("code"),ae=n("config.attention_window"),Re=n(" can be of type "),bi=r("code"),Xh=n("List"),Yh=n(` to define a
different `),zd=new Zo,qd=n(` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),vi=r("code"),Zh=n("BertSelfAttention"),em=n("."),Cd=c(),At=r("p"),tm=n(`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
...
trained and should be used as follows:`),Jd=c(),v(gs.$$.fragment),Xd=c(),eo=r("h2"),rn=r("a"),Ei=r("span"),v(us.$$.fragment),Lm=c(),zi=r("span"),xm=n("LongformerConfig"),Yd=c(),ct=r("div"),v(_s.$$.fragment),Fm=c(),to=r("p"),Mm=n("This is the configuration class to store the configuration of a "),_a=r("a"),Em=n("LongformerModel"),zm=n(" or a "),wa=r("a"),qm=n("TFLongformerModel"),Cm=n(`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),jm=c(),oo=r("p"),Om=n("This is the configuration class to store the configuration of a "),ka=r("a"),Pm=n("LongformerModel"),Nm=n(`. It is used to instantiate an
...
length 4,096.`),Dm=c(),no=r("p"),Sm=n("The "),ba=r("a"),Wm=n("LongformerConfig"),Bm=n(" class directly inherits "),va=r("a"),Qm=n("RobertaConfig"),Um=n(`. It reuses the same defaults. Please check the
parent class for more information.`),Hm=c(),v(an.$$.fragment),Zd=c(),so=r("h2"),ln=r("a"),qi=r("span"),v(ks.$$.fragment),Rm=c(),Ci=r("span"),Km=n("LongformerTokenizer"),ec=c(),Ot=r("div"),v(bs.$$.fragment),Vm=c(),ji=r("p"),Gm=n("Construct a Longformer tokenizer."),Jm=c(),dn=r("p"),ya=r("a"),Xm=n("LongformerTokenizer"),Ym=n(" is identical to "),Ta=r("a"),Zm=n("RobertaTokenizer"),ep=n(`. Refer to the superclass for usage examples and
...
and documentation concerning parameters.`),nc=c(),ao=r("h2"),mn=r("a"),Ai=r("span"),v($s.$$.fragment),mp=c(),Ii=r("span"),pp=n("Longformer specific outputs"),sc=c(),io=r("div"),v(Ls.$$.fragment),fp=c(),Di=r("p"),gp=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),rc=c(),lo=r("div"),v(xs.$$.fragment),up=c(),Si=r("p"),_p=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),ac=c(),co=r("div"),v(Fs.$$.fragment),wp=c(),Wi=r("p"),kp=n("Base class for masked language models outputs."),ic=c(),ho=r("div"),v(Ms.$$.fragment),bp=c(),Bi=r("p"),vp=n("Base class for outputs of question answering Longformer models."),lc=c(),mo=r("div"),v(Es.$$.fragment),yp=c(),Qi=r("p"),Tp=n("Base class for outputs of sentence classification models."),dc=c(),po=r("div"),v(zs.$$.fragment),$p=c(),Ui=r("p"),Lp=n("Base class for outputs of multiple choice Longformer models."),cc=c(),fo=r("div"),v(qs.$$.fragment),xp=c(),Hi=r("p"),Fp=n("Base class for outputs of token classification models."),hc=c(),go=r("div"),v(Cs.$$.fragment),Mp=c(),Ri=r("p"),Ep=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),mc=c(),uo=r("div"),v(js.$$.fragment),zp=c(),Ki=r("p"),qp=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),pc=c(),_o=r("div"),v(Os.$$.fragment),Cp=c(),Vi=r("p"),jp=n("Base class for masked language models outputs."),fc=c(),wo=r("div"),v(Ps.$$.fragment),Op=c(),Gi=r("p"),Pp=n("Base class for outputs of question answering Longformer models."),gc=c(),ko=r("div"),v(Ns.$$.fragment),Np=c(),Ji=r("p"),Ap=n("Base class for outputs of sentence classification models."),uc=c(),bo=r("div"),v(As.$$.fragment),Ip=c(),Xi=r("p"),Dp=n("Base class for outputs of multiple choice models."),_c=c(),vo=r("div"),v(Is.$$.fragment),Sp=c(),Yi=r("p"),Wp=n("Base class for outputs of token classification models."),wc=c(),yo=r("h2"),pn=r("a"),Zi=r("span"),v(Ds.$$.fragment),Bp=c(),el=r("span"),Qp=n("LongformerModel"),kc=c(),et=r("div"),v(Ss.$$.fragment),Up=c(),tl=r("p"),Hp=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Rp=c(),Ws=r("p"),Kp=n("This model inherits from "),xa=r("a"),Vp=n("PreTrainedModel"),Gp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jp=c(),Bs=r("p"),Xp=n("This model is also a PyTorch "),Qs=r("a"),Yp=n("torch.nn.Module"),Zp=n(` subclass.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zf=c(),Xs=r("p"),qf=n("This model is also a PyTorch "),Ys=r("a"),Cf=n("torch.nn.Module"),jf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Of=c(),lt=r("div"),v(Zs.$$.fragment),Pf=c(),xo=r("p"),Nf=n("The "),za=r("a"),Af=n("LongformerForMaskedLM"),If=n(" forward method, overrides the "),il=r("code"),Df=n("__call__"),Sf=n(" special method."),Wf=c(),v(_n.$$.fragment),Bf=c(),v(wn.$$.fragment),Qf=c(),ll=r("p"),Uf=n("Let\u2019s try a very long input."),Hf=c(),v(kn.$$.fragment),yc=c(),Fo=r("h2"),bn=r("a"),dl=r("span"),v(er.$$.fragment),Rf=c(),cl=r("span"),Kf=n("LongformerForSequenceClassification"),Tc=c(),mt=r("div"),v(tr.$$.fragment),Vf=c(),hl=r("p"),Gf=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sg=c(),tt=r("div"),v(rr.$$.fragment),rg=c(),Mo=r("p"),ag=n("The "),Ca=r("a"),ig=n("LongformerForSequenceClassification"),lg=n(" forward method, overrides the "),ml=r("code"),dg=n("__call__"),cg=n(" special method."),hg=c(),v(vn.$$.fragment),mg=c(),v(yn.$$.fragment),pg=c(),v(Tn.$$.fragment),fg=c(),v($n.$$.fragment),gg=c(),v(Ln.$$.fragment),$c=c(),Eo=r("h2"),xn=r("a"),pl=r("span"),v(ar.$$.fragment),ug=c(),fl=r("span"),_g=n("LongformerForMultipleChoice"),Lc=c(),pt=r("div"),v(ir.$$.fragment),wg=c(),gl=r("p"),kg=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),bg=c(),lr=r("p"),vg=n("This model inherits from "),ja=r("a"),yg=n("PreTrainedModel"),Tg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$g=c(),dr=r("p"),Lg=n("This model is also a PyTorch "),cr=r("a"),xg=n("torch.nn.Module"),Fg=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mg=c(),Lt=r("div"),v(hr.$$.fragment),Eg=c(),zo=r("p"),zg=n("The "),Oa=r("a"),qg=n("LongformerForMultipleChoice"),Cg=n(" forward method, overrides the "),ul=r("code"),jg=n("__call__"),Og=n(" special method."),Pg=c(),v(Fn.$$.fragment),Ng=c(),v(Mn.$$.fragment),xc=c(),qo=r("h2"),En=r("a"),_l=r("span"),v(mr.$$.fragment),Ag=c(),wl=r("span"),Ig=n("LongformerForTokenClassification"),Fc=c(),ft=r("div"),v(pr.$$.fragment),Dg=c(),kl=r("p"),Sg=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Wg=c(),fr=r("p"),Bg=n("This model inherits from "),Pa=r("a"),Qg=n("PreTrainedModel"),Ug=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hg=c(),gr=r("p"),Rg=n("This model is also a PyTorch "),ur=r("a"),Kg=n("torch.nn.Module"),Vg=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gg=c(),_t=r("div"),v(_r.$$.fragment),Jg=c(),Co=r("p"),Xg=n("The "),Na=r("a"),Yg=n("LongformerForTokenClassification"),Zg=n(" forward method, overrides the "),bl=r("code"),eu=n("__call__"),tu=n(" special method."),ou=c(),v(zn.$$.fragment),nu=c(),v(qn.$$.fragment),su=c(),v(Cn.$$.fragment),Mc=c(),jo=r("h2"),jn=r("a"),vl=r("span"),v(wr.$$.fragment),ru=c(),yl=r("span"),au=n("LongformerForQuestionAnswering"),Ec=c(),gt=r("div"),v(kr.$$.fragment),iu=c(),Oo=r("p"),lu=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vu=c(),xt=r("div"),v(Tr.$$.fragment),yu=c(),Po=r("p"),Tu=n("The "),Ia=r("a"),$u=n("LongformerForQuestionAnswering"),Lu=n(" forward method, overrides the "),Ll=r("code"),xu=n("__call__"),Fu=n(" special method."),Mu=c(),v(On.$$.fragment),Eu=c(),v(Pn.$$.fragment),zc=c(),No=r("h2"),Nn=r("a"),xl=r("span"),v($r.$$.fragment),zu=c(),Fl=r("span"),qu=n("TFLongformerModel"),qc=c(),Ke=r("div"),v(Lr.$$.fragment),Cu=c(),Ml=r("p"),ju=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Ou=c(),xr=r("p"),Pu=n("This model inherits from "),Da=r("a"),Nu=n("TFPreTrainedModel"),Au=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Iu=c(),Fr=r("p"),Du=n("This model is also a "),Mr=r("a"),Su=n("tf.keras.Model"),Wu=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bu=c(),v(An.$$.fragment),Qu=c(),Ao=r("p"),Uu=n("This class copies code from "),Sa=r("a"),Hu=n("TFRobertaModel"),Ru=n(` and overwrites standard self-attention with longformer
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Zu=c(),Dt=r("div"),v(qr.$$.fragment),e_=c(),Io=r("p"),t_=n("The "),Wa=r("a"),o_=n("TFLongformerModel"),n_=n(" forward method, overrides the "),zl=r("code"),s_=n("__call__"),r_=n(" special method."),a_=c(),v(In.$$.fragment),Cc=c(),Do=r("h2"),Dn=r("a"),ql=r("span"),v(Cr.$$.fragment),i_=c(),Cl=r("span"),l_=n("TFLongformerForMaskedLM"),jc=c(),nt=r("div"),v(jr.$$.fragment),d_=c(),Or=r("p"),c_=n("Longformer Model with a "),jl=r("code"),h_=n("language modeling"),m_=n(" head on top."),p_=c(),Pr=r("p"),f_=n("This model inherits from "),Ba=r("a"),g_=n("TFPreTrainedModel"),u_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),__=c(),Nr=r("p"),w_=n("This model is also a "),Ar=r("a"),k_=n("tf.keras.Model"),b_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),v_=c(),v(Sn.$$.fragment),y_=c(),wt=r("div"),v(Ir.$$.fragment),T_=c(),So=r("p"),$_=n("The "),Qa=r("a"),L_=n("TFLongformerForMaskedLM"),x_=n(" forward method, overrides the "),Ol=r("code"),F_=n("__call__"),M_=n(" special method."),E_=c(),v(Wn.$$.fragment),z_=c(),v(Bn.$$.fragment),q_=c(),v(Qn.$$.fragment),Oc=c(),Wo=r("h2"),Un=r("a"),Pl=r("span"),v(Dr.$$.fragment),C_=c(),Nl=r("span"),j_=n("TFLongformerForQuestionAnswering"),Pc=c(),st=r("div"),v(Sr.$$.fragment),O_=c(),Bo=r("p"),P_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layer on top of the hidden-states output to compute `),Al=r("code"),N_=n("span start logits"),A_=n(" and "),Il=r("code"),I_=n("span end logits"),D_=n(")."),S_=c(),Wr=r("p"),W_=n("This model inherits from "),Ua=r("a"),B_=n("TFPreTrainedModel"),Q_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),U_=c(),Br=r("p"),H_=n("This model is also a "),Qr=r("a"),R_=n("tf.keras.Model"),K_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),V_=c(),v(Hn.$$.fragment),G_=c(),kt=r("div"),v(Ur.$$.fragment),J_=c(),Qo=r("p"),X_=n("The "),Ha=r("a"),Y_=n("TFLongformerForQuestionAnswering"),Z_=n(" forward method, overrides the "),Dl=r("code"),ew=n("__call__"),tw=n(" special method."),ow=c(),v(Rn.$$.fragment),nw=c(),v(Kn.$$.fragment),sw=c(),v(Vn.$$.fragment),Nc=c(),Uo=r("h2"),Gn=r("a"),Sl=r("span"),v(Hr.$$.fragment),rw=c(),Wl=r("span"),aw=n("TFLongformerForSequenceClassification"),Ac=c(),rt=r("div"),v(Rr.$$.fragment),iw=c(),Bl=r("p"),lw=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
for Named-Entity-Recognition (NER) tasks.`),Cw=c(),Zr=r("p"),jw=n("This model inherits from "),Va=r("a"),Ow=n("TFPreTrainedModel"),Pw=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nw=c(),ea=r("p"),Aw=n("This model is also a "),ta=r("a"),Iw=n("tf.keras.Model"),Dw=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sw=c(),v(ts.$$.fragment),Ww=c(),vt=r("div"),v(oa.$$.fragment),Bw=c(),Ko=r("p"),Qw=n("The "),Ga=r("a"),Uw=n("TFLongformerForTokenClassification"),Hw=n(" forward method, overrides the "),Kl=r("code"),Rw=n("__call__"),Kw=n(" special method."),Vw=c(),v(os.$$.fragment),Gw=c(),v(ns.$$.fragment),Jw=c(),v(ss.$$.fragment),Sc=c(),Vo=r("h2"),rs=r("a"),Vl=r("span"),v(na.$$.fragment),Xw=c(),Gl=r("span"),Yw=n("TFLongformerForMultipleChoice"),Wc=c(),it=r("div"),v(sa.$$.fragment),Zw=c(),Jl=r("p"),ek=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
contrast to most prior work, we also pretrain Longformer and finetune it on a variety of downstream tasks. Our
pretrained Longformer consistently outperforms RoBERTa on long document tasks and sets new state-of-the-art results on
WikiHop and TriviaQA.`),id.forEach(t),ad.forEach(t),ne=h(o),C=a(o,"P",{});var ld=i(C);O=s(ld,"Tips:"),ld.forEach(t),_e=h(o),Q=a(o,"UL",{});var dd=i(Q);te=a(dd,"LI",{});var Nt=i(te);xe=s(Nt,"Since the Longformer is based on RoBERTa, it doesn\u2019t have "),H=a(Nt,"CODE",{});var cd=i(H);Fe=s(cd,"token_type_ids"),cd.forEach(t),Me=s(Nt,`. You don\u2019t need to indicate which
token belongs to which segment. Just separate your segments with the separation token `),j=a(Nt,"CODE",{});var hd=i(j);Ee=s(hd,"tokenizer.sep_token"),hd.forEach(t),J=s(Nt,` (or
`),me=a(Nt,"CODE",{});var md=i(me);ze=s(md,"</s>"),md.forEach(t),X=s(Nt,")."),Nt.forEach(t),dd.forEach(t),we=h(o),se=a(o,"P",{});var Jo=i(se);I=s(Jo,"This model was contributed by "),ce=a(Jo,"A",{href:!0,rel:!0});var pd=i(ce);Y=s(pd,"beltagy"),pd.forEach(t),qe=s(Jo,". The Authors\u2019 code can be found "),Z=a(Jo,"A",{href:!0,rel:!0});var fd=i(Z);P=s(fd,"here"),fd.forEach(t),Ce=s(Jo,"."),Jo.forEach(t),N=h(o),re=a(o,"H2",{class:!0});var ma=i(re);le=a(ma,"A",{id:!0,class:!0,href:!0});var gd=i(le);w=a(gd,"SPAN",{});var ud=i(w);y(E.$$.fragment,ud),ud.forEach(t),gd.forEach(t),Be=h(ma),oe=a(ma,"SPAN",{});var _d=i(oe);Qe=s(_d,"Longformer Self Attention"),_d.forEach(t),ma.forEach(t),Ne=h(o),M=a(o,"P",{});var Ve=i(M);Ue=s(Ve,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),Oe=a(Ve,"CODE",{});var wd=i(Oe);He=s(wd,"config.attention_window"),wd.forEach(t),je=s(Ve,". Note that "),Pe=a(Ve,"CODE",{});var kd=i(Pe);ae=s(kd,"config.attention_window"),kd.forEach(t),Re=s(Ve," can be of type "),bi=a(Ve,"CODE",{});var bd=i(bi);Xh=s(bd,"List"),bd.forEach(t),Yh=s(Ve,` to define a
different `),zd=en(Ve),qd=s(Ve,` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),vi=a(Ve,"CODE",{});var vd=i(vi);Zh=s(vd,"BertSelfAttention"),vd.forEach(t),em=s(Ve,"."),Ve.forEach(t),Cd=h(o),At=a(o,"P",{});var Xo=i(At);tm=s(Xo,`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
...
trained and should be used as follows:`),Fd.forEach(t),Jd=h(o),y(gs.$$.fragment,o),Xd=h(o),eo=a(o,"H2",{class:!0});var Rc=i(eo);rn=a(Rc,"A",{id:!0,class:!0,href:!0});var xk=i(rn);Ei=a(xk,"SPAN",{});var Fk=i(Ei);y(us.$$.fragment,Fk),Fk.forEach(t),xk.forEach(t),Lm=h(Rc),zi=a(Rc,"SPAN",{});var Mk=i(zi);xm=s(Mk,"LongformerConfig"),Mk.forEach(t),Rc.forEach(t),Yd=h(o),ct=a(o,"DIV",{class:!0});var Wt=i(ct);y(_s.$$.fragment,Wt),Fm=h(Wt),to=a(Wt,"P",{});var Ya=i(to);Mm=s(Ya,"This is the configuration class to store the configuration of a "),_a=a(Ya,"A",{href:!0});var Ek=i(_a);Em=s(Ek,"LongformerModel"),Ek.forEach(t),zm=s(Ya," or a "),wa=a(Ya,"A",{href:!0});var zk=i(wa);qm=s(zk,"TFLongformerModel"),zk.forEach(t),Cm=s(Ya,`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),Ya.forEach(t),jm=h(Wt),oo=a(Wt,"P",{});var Za=i(oo);Om=s(Za,"This is the configuration class to store the configuration of a "),ka=a(Za,"A",{href:!0});var qk=i(ka);Pm=s(qk,"LongformerModel"),qk.forEach(t),Nm=s(Za,`. It is used to instantiate an
Longformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LongFormer
`),ws=a(Za,"A",{href:!0,rel:!0});var Ck=i(ws);Am=s(Ck,"allenai/longformer-base-4096"),Ck.forEach(t),Im=s(Za,` architecture with a sequence
length 4,096.`),Za.forEach(t),Dm=h(Wt),no=a(Wt,"P",{});var ei=i(no);Sm=s(ei,"The "),ba=a(ei,"A",{href:!0});var jk=i(ba);Wm=s(jk,"LongformerConfig"),jk.forEach(t),Bm=s(ei," class directly inherits "),va=a(ei,"A",{href:!0});var Ok=i(va);Qm=s(Ok,"RobertaConfig"),Ok.forEach(t),Um=s(ei,`. It reuses the same defaults. Please check the
parent class for more information.`),ei.forEach(t),Hm=h(Wt),y(an.$$.fragment,Wt),Wt.forEach(t),Zd=h(o),so=a(o,"H2",{class:!0});var Kc=i(so);ln=a(Kc,"A",{id:!0,class:!0,href:!0});var Pk=i(ln);qi=a(Pk,"SPAN",{});var Nk=i(qi);y(ks.$$.fragment,Nk),Nk.forEach(t),Pk.forEach(t),Rm=h(Kc),Ci=a(Kc,"SPAN",{});var Ak=i(Ci);Km=s(Ak,"LongformerTokenizer"),Ak.forEach(t),Kc.forEach(t),ec=h(o),Ot=a(o,"DIV",{class:!0});var ti=i(Ot);y(bs.$$.fragment,ti),Vm=h(ti),ji=a(ti,"P",{});var Ik=i(ji);Gm=s(Ik,"Construct a Longformer tokenizer."),Ik.forEach(t),Jm=h(ti),dn=a(ti,"P",{});var Md=i(dn);ya=a(Md,"A",{href:!0});var Dk=i(ya);Xm=s(Dk,"LongformerTokenizer"),Dk.forEach(t),Ym=s(Md," is identical to "),Ta=a(Md,"A",{href:!0});var Sk=i(Ta);Zm=s(Sk,"RobertaTokenizer"),Sk.forEach(t),ep=s(Md,`. Refer to the superclass for usage examples and
documentation concerning parameters.`),Md.forEach(t),ti.forEach(t),tc=h(o),ro=a(o,"H2",{class:!0});var Vc=i(ro);cn=a(Vc,"A",{id:!0,class:!0,href:!0});var Wk=i(cn);Oi=a(Wk,"SPAN",{});var Bk=i(Oi);y(vs.$$.fragment,Bk),Bk.forEach(t),Wk.forEach(t),tp=h(Vc),Pi=a(Vc,"SPAN",{});var Qk=i(Pi);op=s(Qk,"LongformerTokenizerFast"),Qk.forEach(t),Vc.forEach(t),oc=h(o),Pt=a(o,"DIV",{class:!0});var oi=i(Pt);y(ys.$$.fragment,oi),np=h(oi),Ts=a(oi,"P",{});var Gc=i(Ts);sp=s(Gc,"Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),Ni=a(Gc,"EM",{});var Uk=i(Ni);rp=s(Uk,"tokenizers"),Uk.forEach(t),ap=s(Gc," library)."),Gc.forEach(t),ip=h(oi),hn=a(oi,"P",{});var Ed=i(hn);$a=a(Ed,"A",{href:!0});var Hk=i($a);lp=s(Hk,"LongformerTokenizerFast"),Hk.forEach(t),dp=s(Ed," is identical to "),La=a(Ed,"A",{href:!0});var Rk=i(La);cp=s(Rk,"RobertaTokenizerFast"),Rk.forEach(t),hp=s(Ed,`. Refer to the superclass for usage examples
and documentation concerning parameters.`),Ed.forEach(t),oi.forEach(t),nc=h(o),ao=a(o,"H2",{class:!0});var Jc=i(ao);mn=a(Jc,"A",{id:!0,class:!0,href:!0});var Kk=i(mn);Ai=a(Kk,"SPAN",{});var Vk=i(Ai);y($s.$$.fragment,Vk),Vk.forEach(t),Kk.forEach(t),mp=h(Jc),Ii=a(Jc,"SPAN",{});var Gk=i(Ii);pp=s(Gk,"Longformer specific outputs"),Gk.forEach(t),Jc.forEach(t),sc=h(o),io=a(o,"DIV",{class:!0});var Xc=i(io);y(Ls.$$.fragment,Xc),fp=h(Xc),Di=a(Xc,"P",{});var Jk=i(Di);gp=s(Jk,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Jk.forEach(t),Xc.forEach(t),rc=h(o),lo=a(o,"DIV",{class:!0});var Yc=i(lo);y(xs.$$.fragment,Yc),up=h(Yc),Si=a(Yc,"P",{});var Xk=i(Si);_p=s(Xk,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Xk.forEach(t),Yc.forEach(t),ac=h(o),co=a(o,"DIV",{class:!0});var Zc=i(co);y(Fs.$$.fragment,Zc),wp=h(Zc),Wi=a(Zc,"P",{});var Yk=i(Wi);kp=s(Yk,"Base class for masked language models outputs."),Yk.forEach(t),Zc.forEach(t),ic=h(o),ho=a(o,"DIV",{class:!0});var eh=i(ho);y(Ms.$$.fragment,eh),bp=h(eh),Bi=a(eh,"P",{});var Zk=i(Bi);vp=s(Zk,"Base class for outputs of question answering Longformer models."),Zk.forEach(t),eh.forEach(t),lc=h(o),mo=a(o,"DIV",{class:!0});var th=i(mo);y(Es.$$.fragment,th),yp=h(th),Qi=a(th,"P",{});var eb=i(Qi);Tp=s(eb,"Base class for outputs of sentence classification models."),eb.forEach(t),th.forEach(t),dc=h(o),po=a(o,"DIV",{class:!0});var oh=i(po);y(zs.$$.fragment,oh),$p=h(oh),Ui=a(oh,"P",{});var tb=i(Ui);Lp=s(tb,"Base class for outputs of multiple choice Longformer models."),tb.forEach(t),oh.forEach(t),cc=h(o),fo=a(o,"DIV",{class:!0});var nh=i(fo);y(qs.$$.fragment,nh),xp=h(nh),Hi=a(nh,"P",{});var ob=i(Hi);Fp=s(ob,"Base class for outputs of token classification models."),ob.forEach(t),nh.forEach(t),hc=h(o),go=a(o,"DIV",{class:!0});var sh=i(go);y(Cs.$$.fragment,sh),Mp=h(sh),Ri=a(sh,"P",{});var nb=i(Ri);Ep=s(nb,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),nb.forEach(t),sh.forEach(t),mc=h(o),uo=a(o,"DIV",{class:!0});var rh=i(uo);y(js.$$.fragment,rh),zp=h(rh),Ki=a(rh,"P",{});var sb=i(Ki);qp=s(sb,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),sb.forEach(t),rh.forEach(t),pc=h(o),_o=a(o,"DIV",{class:!0});var ah=i(_o);y(Os.$$.fragment,ah),Cp=h(ah),Vi=a(ah,"P",{});var rb=i(Vi);jp=s(rb,"Base class for masked language models outputs."),rb.forEach(t),ah.forEach(t),fc=h(o),wo=a(o,"DIV",{class:!0});var ih=i(wo);y(Ps.$$.fragment,ih),Op=h(ih),Gi=a(ih,"P",{});var ab=i(Gi);Pp=s(ab,"Base class for outputs of question answering Longformer models."),ab.forEach(t),ih.forEach(t),gc=h(o),ko=a(o,"DIV",{class:!0});var lh=i(ko);y(Ns.$$.fragment,lh),Np=h(lh),Ji=a(lh,"P",{});var ib=i(Ji);Ap=s(ib,"Base class for outputs of sentence classification models."),ib.forEach(t),lh.forEach(t),uc=h(o),bo=a(o,"DIV",{class:!0});var dh=i(bo);y(As.$$.fragment,dh),Ip=h(dh),Xi=a(dh,"P",{});var lb=i(Xi);Dp=s(lb,"Base class for outputs of multiple choice models."),lb.forEach(t),dh.forEach(t),_c=h(o),vo=a(o,"DIV",{class:!0});var ch=i(vo);y(Is.$$.fragment,ch),Sp=h(ch),Yi=a(ch,"P",{});var db=i(Yi);Wp=s(db,"Base class for outputs of token classification models."),db.forEach(t),ch.forEach(t),wc=h(o),yo=a(o,"H2",{class:!0});var hh=i(yo);pn=a(hh,"A",{id:!0,class:!0,href:!0});var cb=i(pn);Zi=a(cb,"SPAN",{});var hb=i(Zi);y(Ds.$$.fragment,hb),hb.forEach(t),cb.forEach(t),Bp=h(hh),el=a(hh,"SPAN",{});var mb=i(el);Qp=s(mb,"LongformerModel"),mb.forEach(t),hh.forEach(t),kc=h(o),et=a(o,"DIV",{class:!0});var yt=i(et);y(Ss.$$.fragment,yt),Up=h(yt),tl=a(yt,"P",{});var pb=i(tl);Hp=s(pb,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),pb.forEach(t),Rp=h(yt),Ws=a(yt,"P",{});var mh=i(Ws);Kp=s(mh,"This model inherits from "),xa=a(mh,"A",{href:!0});var fb=i(xa);Vp=s(fb,"PreTrainedModel"),fb.forEach(t),Gp=s(mh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mh.forEach(t),Jp=h(yt),Bs=a(yt,"P",{});var ph=i(Bs);Xp=s(ph,"This model is also a PyTorch "),Qs=a(ph,"A",{href:!0,rel:!0});var gb=i(Qs);Yp=s(gb,"torch.nn.Module"),gb.forEach(t),Zp=s(ph,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),fh.forEach(t),hf=h(yt),$t=a(yt,"DIV",{class:!0});var ds=i($t);y(Rs.$$.fragment,ds),mf=h(ds),$o=a(ds,"P",{});var si=i($o);pf=s(si,"The "),Ma=a(si,"A",{href:!0});var kb=i(Ma);ff=s(kb,"LongformerModel"),kb.forEach(t),gf=s(si," forward method, overrides the "),nl=a(si,"CODE",{});var bb=i(nl);uf=s(bb,"__call__"),bb.forEach(t),_f=s(si," special method."),si.forEach(t),wf=h(ds),y(fn.$$.fragment,ds),kf=h(ds),y(gn.$$.fragment,ds),ds.forEach(t),yt.forEach(t),bc=h(o),Lo=a(o,"H2",{class:!0});var gh=i(Lo);un=a(gh,"A",{id:!0,class:!0,href:!0});var vb=i(un);sl=a(vb,"SPAN",{});var yb=i(sl);y(Ks.$$.fragment,yb),yb.forEach(t),vb.forEach(t),bf=h(gh),rl=a(gh,"SPAN",{});var Tb=i(rl);vf=s(Tb,"LongformerForMaskedLM"),Tb.forEach(t),gh.forEach(t),vc=h(o),ht=a(o,"DIV",{class:!0});var Bt=i(ht);y(Vs.$$.fragment,Bt),yf=h(Bt),Gs=a(Bt,"P",{});var uh=i(Gs);Tf=s(uh,"Longformer Model with a "),al=a(uh,"CODE",{});var $b=i(al);$f=s($b,"language modeling"),$b.forEach(t),Lf=s(uh," head on top."),uh.forEach(t),xf=h(Bt),Js=a(Bt,"P",{});var _h=i(Js);Ff=s(_h,"This model inherits from "),Ea=a(_h,"A",{href:!0});var Lb=i(Ea);Mf=s(Lb,"PreTrainedModel"),Lb.forEach(t),Ef=s(_h,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_h.forEach(t),zf=h(Bt),Xs=a(Bt,"P",{});var wh=i(Xs);qf=s(wh,"This model is also a PyTorch "),Ys=a(wh,"A",{href:!0,rel:!0});var xb=i(Ys);Cf=s(xb,"torch.nn.Module"),xb.forEach(t),jf=s(wh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wh.forEach(t),Of=h(Bt),lt=a(Bt,"DIV",{class:!0});var Mt=i(lt);y(Zs.$$.fragment,Mt),Pf=h(Mt),xo=a(Mt,"P",{});var ri=i(xo);Nf=s(ri,"The "),za=a(ri,"A",{href:!0});var Fb=i(za);Af=s(Fb,"LongformerForMaskedLM"),Fb.forEach(t),If=s(ri," forward method, overrides the "),il=a(ri,"CODE",{});var Mb=i(il);Df=s(Mb,"__call__"),Mb.forEach(t),Sf=s(ri," special method."),ri.forEach(t),Wf=h(Mt),y(_n.$$.fragment,Mt),Bf=h(Mt),y(wn.$$.fragment,Mt),Qf=h(Mt),ll=a(Mt,"P",{});var Eb=i(ll);Uf=s(Eb,"Let\u2019s try a very long input."),Eb.forEach(t),Hf=h(Mt),y(kn.$$.fragment,Mt),Mt.forEach(t),Bt.forEach(t),yc=h(o),Fo=a(o,"H2",{class:!0});var kh=i(Fo);bn=a(kh,"A",{id:!0,class:!0,href:!0});var zb=i(bn);dl=a(zb,"SPAN",{});var qb=i(dl);y(er.$$.fragment,qb),qb.forEach(t),zb.forEach(t),Rf=h(kh),cl=a(kh,"SPAN",{});var Cb=i(cl);Kf=s(Cb,"LongformerForSequenceClassification"),Cb.forEach(t),kh.forEach(t),Tc=h(o),mt=a(o,"DIV",{class:!0});var Qt=i(mt);y(tr.$$.fragment,Qt),Vf=h(Qt),hl=a(Qt,"P",{});var jb=i(hl);Gf=s(jb,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),jb.forEach(t),Jf=h(Qt),or=a(Qt,"P",{});var bh=i(or);Xf=s(bh,"This model inherits from "),qa=a(bh,"A",{href:!0});var Ob=i(qa);Yf=s(Ob,"PreTrainedModel"),Ob.forEach(t),Zf=s(bh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vh.forEach(t),sg=h(Qt),tt=a(Qt,"DIV",{class:!0});var Tt=i(tt);y(rr.$$.fragment,Tt),rg=h(Tt),Mo=a(Tt,"P",{});var ai=i(Mo);ag=s(ai,"The "),Ca=a(ai,"A",{href:!0});var Nb=i(Ca);ig=s(Nb,"LongformerForSequenceClassification"),Nb.forEach(t),lg=s(ai," forward method, overrides the "),ml=a(ai,"CODE",{});var Ab=i(ml);dg=s(Ab,"__call__"),Ab.forEach(t),cg=s(ai," special method."),ai.forEach(t),hg=h(Tt),y(vn.$$.fragment,Tt),mg=h(Tt),y(yn.$$.fragment,Tt),pg=h(Tt),y(Tn.$$.fragment,Tt),fg=h(Tt),y($n.$$.fragment,Tt),gg=h(Tt),y(Ln.$$.fragment,Tt),Tt.forEach(t),Qt.forEach(t),$c=h(o),Eo=a(o,"H2",{class:!0});var yh=i(Eo);xn=a(yh,"A",{id:!0,class:!0,href:!0});var Ib=i(xn);pl=a(Ib,"SPAN",{});var Db=i(pl);y(ar.$$.fragment,Db),Db.forEach(t),Ib.forEach(t),ug=h(yh),fl=a(yh,"SPAN",{});var Sb=i(fl);_g=s(Sb,"LongformerForMultipleChoice"),Sb.forEach(t),yh.forEach(t),Lc=h(o),pt=a(o,"DIV",{class:!0});var Ut=i(pt);y(ir.$$.fragment,Ut),wg=h(Ut),gl=a(Ut,"P",{});var Wb=i(gl);kg=s(Wb,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Wb.forEach(t),bg=h(Ut),lr=a(Ut,"P",{});var Th=i(lr);vg=s(Th,"This model inherits from "),ja=a(Th,"A",{href:!0});var Bb=i(ja);yg=s(Bb,"PreTrainedModel"),Bb.forEach(t),Tg=s(Th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fh.forEach(t),Gg=h(Ht),_t=a(Ht,"DIV",{class:!0});var Rt=i(_t);y(_r.$$.fragment,Rt),Jg=h(Rt),Co=a(Rt,"P",{});var li=i(Co);Xg=s(li,"The "),Na=a(li,"A",{href:!0});var Yb=i(Na);Yg=s(Yb,"LongformerForTokenClassification"),Yb.forEach(t),Zg=s(li," forward method, overrides the "),bl=a(li,"CODE",{});var Zb=i(bl);eu=s(Zb,"__call__"),Zb.forEach(t),tu=s(li," special method."),li.forEach(t),ou=h(Rt),y(zn.$$.fragment,Rt),nu=h(Rt),y(qn.$$.fragment,Rt),su=h(Rt),y(Cn.$$.fragment,Rt),Rt.forEach(t),Ht.forEach(t),Mc=h(o),jo=a(o,"H2",{class:!0});var Mh=i(jo);jn=a(Mh,"A",{id:!0,class:!0,href:!0});var ev=i(jn);vl=a(ev,"SPAN",{});var tv=i(vl);y(wr.$$.fragment,tv),tv.forEach(t),ev.forEach(t),ru=h(Mh),yl=a(Mh,"SPAN",{});var ov=i(yl);au=s(ov,"LongformerForQuestionAnswering"),ov.forEach(t),Mh.forEach(t),Ec=h(o),gt=a(o,"DIV",{class:!0});var Kt=i(gt);y(kr.$$.fragment,Kt),iu=h(Kt),Oo=a(Kt,"P",{});var di=i(Oo);lu=s(di,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zh.forEach(t),vu=h(Kt),xt=a(Kt,"DIV",{class:!0});var hs=i(xt);y(Tr.$$.fragment,hs),yu=h(hs),Po=a(hs,"P",{});var ci=i(Po);Tu=s(ci,"The "),Ia=a(ci,"A",{href:!0});var iv=i(Ia);$u=s(iv,"LongformerForQuestionAnswering"),iv.forEach(t),Lu=s(ci," forward method, overrides the "),Ll=a(ci,"CODE",{});var lv=i(Ll);xu=s(lv,"__call__"),lv.forEach(t),Fu=s(ci," special method."),ci.forEach(t),Mu=h(hs),y(On.$$.fragment,hs),Eu=h(hs),y(Pn.$$.fragment,hs),hs.forEach(t),Kt.forEach(t),zc=h(o),No=a(o,"H2",{class:!0});var qh=i(No);Nn=a(qh,"A",{id:!0,class:!0,href:!0});var dv=i(Nn);xl=a(dv,"SPAN",{});var cv=i(xl);y($r.$$.fragment,cv),cv.forEach(t),dv.forEach(t),zu=h(qh),Fl=a(qh,"SPAN",{});var hv=i(Fl);qu=s(hv,"TFLongformerModel"),hv.forEach(t),qh.forEach(t),qc=h(o),Ke=a(o,"DIV",{class:!0});var dt=i(Ke);y(Lr.$$.fragment,dt),Cu=h(dt),Ml=a(dt,"P",{});var mv=i(Ml);ju=s(mv,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),mv.forEach(t),Ou=h(dt),xr=a(dt,"P",{});var Ch=i(xr);Pu=s(Ch,"This model inherits from "),Da=a(Ch,"A",{href:!0});var pv=i(Da);Nu=s(pv,"TFPreTrainedModel"),pv.forEach(t),Au=s(Ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ch.forEach(t),Iu=h(dt),Fr=a(dt,"P",{});var jh=i(Fr);Du=s(jh,"This model is also a "),Mr=a(jh,"A",{href:!0,rel:!0});var fv=i(Mr);Su=s(fv,"tf.keras.Model"),fv.forEach(t),Wu=s(jh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jh.forEach(t),Bu=h(dt),y(An.$$.fragment,dt),Qu=h(dt),Ao=a(dt,"P",{});var hi=i(Ao);Uu=s(hi,"This class copies code from "),Sa=a(hi,"A",{href:!0});var gv=i(Sa);Hu=s(gv,"TFRobertaModel"),gv.forEach(t),Ru=s(hi,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Oh.forEach(t),Zu=h(dt),Dt=a(dt,"DIV",{class:!0});var mi=i(Dt);y(qr.$$.fragment,mi),e_=h(mi),Io=a(mi,"P",{});var pi=i(Io);t_=s(pi,"The "),Wa=a(pi,"A",{href:!0});var wv=i(Wa);o_=s(wv,"TFLongformerModel"),wv.forEach(t),n_=s(pi," forward method, overrides the "),zl=a(pi,"CODE",{});var kv=i(zl);s_=s(kv,"__call__"),kv.forEach(t),r_=s(pi," special method."),pi.forEach(t),a_=h(mi),y(In.$$.fragment,mi),mi.forEach(t),dt.forEach(t),Cc=h(o),Do=a(o,"H2",{class:!0});var Ph=i(Do);Dn=a(Ph,"A",{id:!0,class:!0,href:!0});var bv=i(Dn);ql=a(bv,"SPAN",{});var vv=i(ql);y(Cr.$$.fragment,vv),vv.forEach(t),bv.forEach(t),i_=h(Ph),Cl=a(Ph,"SPAN",{});var yv=i(Cl);l_=s(yv,"TFLongformerForMaskedLM"),yv.forEach(t),Ph.forEach(t),jc=h(o),nt=a(o,"DIV",{class:!0});var Et=i(nt);y(jr.$$.fragment,Et),d_=h(Et),Or=a(Et,"P",{});var Nh=i(Or);c_=s(Nh,"Longformer Model with a "),jl=a(Nh,"CODE",{});var Tv=i(jl);h_=s(Tv,"language modeling"),Tv.forEach(t),m_=s(Nh," head on top."),Nh.forEach(t),p_=h(Et),Pr=a(Et,"P",{});var Ah=i(Pr);f_=s(Ah,"This model inherits from "),Ba=a(Ah,"A",{href:!0});var $v=i(Ba);g_=s($v,"TFPreTrainedModel"),$v.forEach(t),u_=s(Ah,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
