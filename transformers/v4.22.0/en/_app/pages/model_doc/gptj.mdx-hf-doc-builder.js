...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),T=n("Example:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function mf(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function ff(G){let d,T,c,m,v;return m=new ke({props:{code:`from transformers import GPT2Tokenizer, GPTJModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function gf(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function _f(G){let d,T,c,m,v;return m=new ke({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function Tf(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function yf(G){let d,T,c,m,v;return m=new ke({props:{code:`import torch
...
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=a("p"),T=n("Example of single-label classification:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example of single-label classification:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function vf(G){let d,T;return d=new ke({props:{code:'# To train a model on `num_labels` classes, you can pass `num_labels=num_labels` to `.from_pretrained(...)`\nnum_labels = len(model.config.id2label)\nmodel = GPTJForSequenceClassification.from_pretrained("ydshieh/tiny-random-gptj-for-sequence-classification", num_labels=num_labels)\n\nlabels = torch.tensor([1])\nloss = model(**inputs, labels=labels).loss\nround(loss.item(), 2)',highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`</span>
...
<span class="hljs-number">0.76</span>`}}),{c(){w(d.$$.fragment)},l(c){k(d.$$.fragment,c)},m(c,m){b(d,c,m),T=!0},p:Ke,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function wf(G){let d,T,c,m,v;return m=new ke({props:{code:`import torch
from transformers import GPT2Tokenizer, GPTJForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=a("p"),T=n("Example of multi-label classification:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example of multi-label classification:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function kf(G){let d,T;return d=new ke({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){w(d.$$.fragment)},l(c){k(d.$$.fragment,c)},m(c,m){b(d,c,m),T=!0},p:Ke,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function bf(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function $f(G){let d,T,c,m,v;return m=new ke({props:{code:`from transformers import GPT2Tokenizer, GPTJForQuestionAnswering
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.13</span>`}}),{c(){w(d.$$.fragment)},l(c){k(d.$$.fragment,c)},m(c,m){b(d,c,m),T=!0},p:Ke,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Ff(G){let d,T,c,m,v,l,p,E,be,ge,N,oe,Z,j,$e,U,Pe,_e,O,Fe,se,H,je,ae,K,Ge,Te,W,xe,re,ie,M,q,pe,R,ye,he,A,Ee,le,z,Je,B,Me,qe,Q,Ce,ze,I,Ae,V,ve,X,C,ne,L,ue,Le;return{c(){d=a("p"),T=n("TensorFlow models and layers in "),c=a("code"),m=n("transformers"),v=n(" accept two formats as input:"),l=h(),p=a("ul"),E=a("li"),be=n("having all inputs as keyword arguments (like PyTorch models), or"),ge=h(),N=a("li"),oe=n("having all inputs as a list, tuple or dict in the first positional argument."),Z=h(),j=a("p"),$e=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),te.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,x){g(y,d,x),e(d,T),e(d,c),e(c,m),e(d,v),g(y,l,x),g(y,p,x),e(p,E),e(E,be),e(p,ge),e(p,N),e(N,oe),g(y,Z,x),g(y,j,x),e(j,$e),e(j,U),e(U,Pe),e(j,_e),e(j,O),e(O,Fe),e(j,se),e(j,H),e(H,je),e(j,ae),e(j,K),e(K,Ge),e(j,Te),e(j,W),e(W,xe),e(j,re),g(y,ie,x),g(y,M,x),e(M,q),e(q,pe),e(q,R),e(R,ye),e(q,he),e(q,A),e(A,Ee),e(M,le),e(M,z),e(z,Je),e(z,B),e(B,Me),e(z,qe),e(z,Q),e(Q,Ce),e(M,ze),e(M,I),e(I,Ae),e(I,V),e(V,ve),g(y,X,x),g(y,C,x),e(C,ne),e(C,L),e(L,ue),e(C,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(Z),y&&t(j),y&&t(ie),y&&t(M),y&&t(X),y&&t(C)}}}function jf(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function Gf(G){let d,T,c,m,v;return m=new ke({props:{code:`from transformers import GPTJTokenizer, TFGPTJModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function xf(G){let d,T,c,m,v,l,p,E,be,ge,N,oe,Z,j,$e,U,Pe,_e,O,Fe,se,H,je,ae,K,Ge,Te,W,xe,re,ie,M,q,pe,R,ye,he,A,Ee,le,z,Je,B,Me,qe,Q,Ce,ze,I,Ae,V,ve,X,C,ne,L,ue,Le;return{c(){d=a("p"),T=n("TensorFlow models and layers in "),c=a("code"),m=n("transformers"),v=n(" accept two formats as input:"),l=h(),p=a("ul"),E=a("li"),be=n("having all inputs as keyword arguments (like PyTorch models), or"),ge=h(),N=a("li"),oe=n("having all inputs as a list, tuple or dict in the first positional argument."),Z=h(),j=a("p"),$e=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=a("code"),Pe=n("model.fit()"),_e=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),O=a("code"),Fe=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),H=a("code"),je=n("fit()"),ae=n(" and "),K=a("code"),Ge=n("predict()"),Te=n(`, such as when creating your own layers or models with
the Keras `),W=a("code"),xe=n("Functional"),re=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),V=r(ce,"CODE",{});var st=i(V);ve=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),ce.forEach(t),S.forEach(t),X=u(y),C=r(y,"P",{});var te=i(C);ne=s(te,`Note that when creating models and layers with
`),L=r(te,"A",{href:!0,rel:!0});var at=i(L);ue=s(at,"subclassing"),at.forEach(t),Le=s(te,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),te.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,x){g(y,d,x),e(d,T),e(d,c),e(c,m),e(d,v),g(y,l,x),g(y,p,x),e(p,E),e(E,be),e(p,ge),e(p,N),e(N,oe),g(y,Z,x),g(y,j,x),e(j,$e),e(j,U),e(U,Pe),e(j,_e),e(j,O),e(O,Fe),e(j,se),e(j,H),e(H,je),e(j,ae),e(j,K),e(K,Ge),e(j,Te),e(j,W),e(W,xe),e(j,re),g(y,ie,x),g(y,M,x),e(M,q),e(q,pe),e(q,R),e(R,ye),e(q,he),e(q,A),e(A,Ee),e(M,le),e(M,z),e(z,Je),e(z,B),e(B,Me),e(z,qe),e(z,Q),e(Q,Ce),e(M,ze),e(M,I),e(I,Ae),e(I,V),e(V,ve),g(y,X,x),g(y,C,x),e(C,ne),e(C,L),e(L,ue),e(C,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(Z),y&&t(j),y&&t(ie),y&&t(M),y&&t(X),y&&t(C)}}}function Ef(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function Jf(G){let d,T,c,m,v;return m=new ke({props:{code:`from transformers import GPTJTokenizer, TFGPTJForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function Mf(G){let d,T,c,m,v,l,p,E,be,ge,N,oe,Z,j,$e,U,Pe,_e,O,Fe,se,H,je,ae,K,Ge,Te,W,xe,re,ie,M,q,pe,R,ye,he,A,Ee,le,z,Je,B,Me,qe,Q,Ce,ze,I,Ae,V,ve,X,C,ne,L,ue,Le;return{c(){d=a("p"),T=n("TensorFlow models and layers in "),c=a("code"),m=n("transformers"),v=n(" accept two formats as input:"),l=h(),p=a("ul"),E=a("li"),be=n("having all inputs as keyword arguments (like PyTorch models), or"),ge=h(),N=a("li"),oe=n("having all inputs as a list, tuple or dict in the first positional argument."),Z=h(),j=a("p"),$e=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=a("code"),Pe=n("model.fit()"),_e=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),O=a("code"),Fe=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),H=a("code"),je=n("fit()"),ae=n(" and "),K=a("code"),Ge=n("predict()"),Te=n(`, such as when creating your own layers or models with
the Keras `),W=a("code"),xe=n("Functional"),re=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),V=r(ce,"CODE",{});var st=i(V);ve=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),ce.forEach(t),S.forEach(t),X=u(y),C=r(y,"P",{});var te=i(C);ne=s(te,`Note that when creating models and layers with
`),L=r(te,"A",{href:!0,rel:!0});var at=i(L);ue=s(at,"subclassing"),at.forEach(t),Le=s(te,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),te.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,x){g(y,d,x),e(d,T),e(d,c),e(c,m),e(d,v),g(y,l,x),g(y,p,x),e(p,E),e(E,be),e(p,ge),e(p,N),e(N,oe),g(y,Z,x),g(y,j,x),e(j,$e),e(j,U),e(U,Pe),e(j,_e),e(j,O),e(O,Fe),e(j,se),e(j,H),e(H,je),e(j,ae),e(j,K),e(K,Ge),e(j,Te),e(j,W),e(W,xe),e(j,re),g(y,ie,x),g(y,M,x),e(M,q),e(q,pe),e(q,R),e(R,ye),e(q,he),e(q,A),e(A,Ee),e(M,le),e(M,z),e(z,Je),e(z,B),e(B,Me),e(z,qe),e(z,Q),e(Q,Ce),e(M,ze),e(M,I),e(I,Ae),e(I,V),e(V,ve),g(y,X,x),g(y,C,x),e(C,ne),e(C,L),e(L,ue),e(C,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(Z),y&&t(j),y&&t(ie),y&&t(M),y&&t(X),y&&t(C)}}}function qf(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function Cf(G){let d,T,c,m,v;return m=new ke({props:{code:`from transformers import GPTJTokenizer, TFGPTJForSequenceClassification
import tensorflow as tf
...
`}}),{c(){w(d.$$.fragment)},l(c){k(d.$$.fragment,c)},m(c,m){b(d,c,m),T=!0},p:Ke,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(G){let d,T,c,m,v,l,p,E,be,ge,N,oe,Z,j,$e,U,Pe,_e,O,Fe,se,H,je,ae,K,Ge,Te,W,xe,re,ie,M,q,pe,R,ye,he,A,Ee,le,z,Je,B,Me,qe,Q,Ce,ze,I,Ae,V,ve,X,C,ne,L,ue,Le;return{c(){d=a("p"),T=n("TensorFlow models and layers in "),c=a("code"),m=n("transformers"),v=n(" accept two formats as input:"),l=h(),p=a("ul"),E=a("li"),be=n("having all inputs as keyword arguments (like PyTorch models), or"),ge=h(),N=a("li"),oe=n("having all inputs as a list, tuple or dict in the first positional argument."),Z=h(),j=a("p"),$e=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=a("code"),Pe=n("model.fit()"),_e=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),O=a("code"),Fe=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),H=a("code"),je=n("fit()"),ae=n(" and "),K=a("code"),Ge=n("predict()"),Te=n(`, such as when creating your own layers or models with
the Keras `),W=a("code"),xe=n("Functional"),re=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),V=r(ce,"CODE",{});var st=i(V);ve=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),ce.forEach(t),S.forEach(t),X=u(y),C=r(y,"P",{});var te=i(C);ne=s(te,`Note that when creating models and layers with
`),L=r(te,"A",{href:!0,rel:!0});var at=i(L);ue=s(at,"subclassing"),at.forEach(t),Le=s(te,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),te.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,x){g(y,d,x),e(d,T),e(d,c),e(c,m),e(d,v),g(y,l,x),g(y,p,x),e(p,E),e(E,be),e(p,ge),e(p,N),e(N,oe),g(y,Z,x),g(y,j,x),e(j,$e),e(j,U),e(U,Pe),e(j,_e),e(j,O),e(O,Fe),e(j,se),e(j,H),e(H,je),e(j,ae),e(j,K),e(K,Ge),e(j,Te),e(j,W),e(W,xe),e(j,re),g(y,ie,x),g(y,M,x),e(M,q),e(q,pe),e(q,R),e(R,ye),e(q,he),e(q,A),e(A,Ee),e(M,le),e(M,z),e(z,Je),e(z,B),e(B,Me),e(z,qe),e(z,Q),e(Q,Ce),e(M,ze),e(M,I),e(I,Ae),e(I,V),e(V,ve),g(y,X,x),g(y,C,x),e(C,ne),e(C,L),e(L,ue),e(C,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(Z),y&&t(j),y&&t(ie),y&&t(M),y&&t(X),y&&t(C)}}}function Lf(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function If(G){let d,T,c,m,v;return m=new ke({props:{code:`from transformers import GPTJTokenizer, TFGPTJForQuestionAnswering
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predict_answer_tokens = inputs.input_ids[<span class="hljs-number">0</span>, answer_start_index : answer_end_index + <span class="hljs-number">1</span>]
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predict_answer_tokens)
`}}),{c(){d=a("p"),T=n("Example:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function Of(G){let d,T;return d=new ke({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){w(d.$$.fragment)},l(c){k(d.$$.fragment,c)},m(c,m){b(d,c,m),T=!0},p:Ke,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Nf(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function Sf(G){let d,T,c,m,v;return m=new ke({props:{code:`from transformers import GPTJTokenizer, FlaxGPTJModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function Df(G){let d,T,c,m,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);m=s(E,"Module"),E.forEach(t),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){g(l,d,p),e(d,T),e(d,c),e(c,m),e(d,v)},d(l){l&&t(d)}}}function Wf(G){let d,T,c,m,v;return m=new ke({props:{code:`from transformers import GPTJTokenizer, FlaxGPTJForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),w(m.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),c=u(l),k(m.$$.fragment,l)},m(l,p){g(l,d,p),e(d,T),g(l,c,p),b(m,l,p),v=!0},p:Ke,i(l){v||($(m.$$.fragment,l),v=!0)},o(l){P(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(m,l)}}}function Uf(G){let d,T,c,m,v,l,p,E,be,ge,N,oe,Z,j,$e,U,Pe,_e,O,Fe,se,H,je,ae,K,Ge,Te,W,xe,re,ie,M,q,pe,R,ye,he,A,Ee,le,z,Je,B,Me,qe,Q,Ce,ze,I,Ae,V,ve,X,C,ne,L,ue,Le,y,x,Xe,ee,de,Ye,J,Ze,et,Se,tt,ot,S,Y,nt,Re,D,we,De,ce,st,te,at,Hr,ho,Ki,Ms,Ri,Vi,Kr,hn,Rr,qs,Xi,Vr,un,Xr,St,uo,ga,mn,Yi,_a,Zi,Yr,Et,fn,el,mt,tl,Cs,ol,nl,gn,sl,al,zs,rl,il,As,ll,dl,cl,mo,Zr,Dt,fo,Ta,_n,pl,ya,hl,ei,Jt,Tn,ul,yn,ml,vn,fl,gl,_l,vt,wn,Tl,Wt,yl,Ls,vl,wl,va,kl,bl,$l,go,Pl,_o,ti,Ut,To,wa,kn,Fl,ka,jl,oi,ft,bn,Gl,ba,xl,El,$n,Jl,Pn,Ml,ql,Cl,wt,Fn,zl,Bt,Al,Is,Ll,Il,$a,Ol,Nl,Sl,yo,Dl,vo,ni,Qt,wo,Pa,jn,Wl,Fa,Ul,si,We,Gn,Bl,ja,Ql,Hl,Os,Ns,Kl,Rl,Vl,gt,Xl,Ga,Yl,Zl,xa,ed,td,Ea,od,nd,Ja,sd,ad,rd,xn,id,En,ld,dd,cd,Ne,Jn,pd,Ht,hd,Ss,ud,md,Ma,fd,gd,_d,ko,Td,bo,yd,$o,vd,Po,wd,Fo,ai,Kt,jo,qa,Mn,kd,Ca,bd,ri,_t,qn,$d,Rt,Pd,za,Fd,jd,Aa,Gd,xd,Ed,Cn,Jd,zn,Md,qd,Cd,rt,An,zd,Vt,Ad,Ds,Ld,Id,La,Od,Nd,Sd,Go,Dd,xo,Wd,Eo,ii,Xt,Jo,Ia,Ln,Ud,Oa,Bd,li,Ue,In,Qd,Na,Hd,Kd,On,Rd,Ws,Vd,Xd,Yd,Nn,Zd,Sn,ec,tc,oc,Mo,nc,kt,Dn,sc,Yt,ac,Us,rc,ic,Sa,lc,dc,cc,qo,pc,Co,di,Zt,zo,Da,Wn,hc,Wa,uc,ci,Be,Un,mc,Ua,fc,gc,Bn,_c,Bs,Tc,yc,vc,Qn,wc,Hn,kc,bc,$c,Ao,Pc,bt,Kn,Fc,eo,jc,Qs,Gc,xc,Ba,Ec,Jc,Mc,Lo,qc,Io,pi,to,Oo,Qa,Rn,Cc,Ha,zc,hi,me,Vn,Ac,Ka,Lc,Ic,Hs,Ks,Oc,Nc,Sc,Tt,Dc,Ra,Wc,Uc,Va,Bc,Qc,Xa,Hc,Kc,Ya,Rc,Vc,Xc,Xn,Yc,Rs,Zc,ep,tp,Yn,op,Zn,np,sp,ap,No,rp,it,es,ip,oo,lp,Vs,dp,cp,Za,pp,hp,up,So,mp,Do,fp,Wo,ui,no,Uo,er,ts,gp,tr,_p,mi,Qe,os,Tp,so,yp,or,vp,wp,nr,kp,bp,$p,ns,Pp,Xs,Fp,jp,Gp,ss,xp,as,Ep,Jp,Mp,Bo,qp,lt,rs,Cp,ao,zp,Ys,Ap,Lp,sr,Ip,Op,Np,Qo,Sp,Ho,Dp,Ko,fi,ro,Ro,ar,is,Wp,rr,Up,gi,Ie,ls,Bp,ir,Qp,Hp,ds,Kp,Zs,Rp,Vp,Xp,cs,Yp,ps,Zp,eh,th,lr,oh,nh,Mt,dr,hs,sh,ah,cr,us,rh,ih,pr,ms,lh,dh,hr,fs,ch,ph,$t,gs,hh,io,uh,ur,mh,fh,mr,gh,_h,Th,Vo,yh,Xo,_i,lo,Yo,fr,_s,vh,gr,wh,Ti,Oe,Ts,kh,_r,bh,$h,ys,Ph,ea,Fh,jh,Gh,vs,xh,ws,Eh,Jh,Mh,Tr,qh,Ch,qt,yr,ks,zh,Ah,vr,bs,Lh,Ih,wr,$s,Oh,Nh,kr,Ps,Sh,Dh,Pt,Fs,Wh,co,Uh,br,Bh,Qh,$r,Hh,Kh,Rh,Zo,Vh,en,yi;return l=new ut({}),j=new ut({}),X=new ke({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.22.0/en/model_doc/gptj#transformers.GPTJModel">GPTJModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTJConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 2048) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.22.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/gptj/modeling_gptj.py#L537",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.0/en/model_doc/gptj#transformers.GPTJConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/gptj/modeling_gptj.py#L791",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/gptj/modeling_gptj.py#L913",returnDescription:`
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/gptj/modeling_gptj.py#L1040",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/v4.22.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/gptj/modeling_tf_gptj.py#L655",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/gptj/modeling_tf_gptj.py#L759",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/gptj/modeling_tf_gptj.py#L863",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/gptj/modeling_tf_gptj.py#L986",returnDescription:`
<p>A <a
...
model.`),Kr=h(),w(hn.$$.fragment),Rr=h(),qs=a("p"),Xi=n("\u2026or in float16 precision:"),Vr=h(),w(un.$$.fragment),Xr=h(),St=a("h2"),uo=a("a"),ga=a("span"),w(mn.$$.fragment),Yi=h(),_a=a("span"),Zi=n("GPTJConfig"),Yr=h(),Et=a("div"),w(fn.$$.fragment),el=h(),mt=a("p"),tl=n("This is the configuration class to store the configuration of a "),Cs=a("a"),ol=n("GPTJModel"),nl=n(`. It is used to instantiate a GPT-J
...
for more information.`),cl=h(),w(mo.$$.fragment),Zr=h(),Dt=a("h2"),fo=a("a"),Ta=a("span"),w(_n.$$.fragment),pl=h(),ya=a("span"),hl=n("GPTJModel"),ei=h(),Jt=a("div"),w(Tn.$$.fragment),ul=h(),yn=a("p"),ml=n(`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),vn=a("a"),fl=n("torch.nn.Module"),gl=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_l=h(),vt=a("div"),w(wn.$$.fragment),Tl=h(),Wt=a("p"),yl=n("The "),Ls=a("a"),vl=n("GPTJModel"),wl=n(" forward method, overrides the "),va=a("code"),kl=n("__call__"),bl=n(" special method."),$l=h(),w(go.$$.fragment),Pl=h(),w(_o.$$.fragment),ti=h(),Ut=a("h2"),To=a("a"),wa=a("span"),w(kn.$$.fragment),Fl=h(),ka=a("span"),jl=n("GPTJForCausalLM"),oi=h(),ft=a("div"),w(bn.$$.fragment),Gl=h(),ba=a("p"),xl=n("The GPT-J Model transformer with a language modeling head on top."),El=h(),$n=a("p"),Jl=n("This model is a PyTorch "),Pn=a("a"),Ml=n("torch.nn.Module"),ql=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),w(No.$$.fragment),rp=h(),it=a("div"),w(es.$$.fragment),ip=h(),oo=a("p"),lp=n("The "),Vs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Za=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),w(So.$$.fragment),mp=h(),w(Do.$$.fragment),fp=h(),w(Wo.$$.fragment),ui=h(),no=a("h2"),Uo=a("a"),er=a("span"),w(ts.$$.fragment),gp=h(),tr=a("span"),_p=n("TFGPTJForQuestionAnswering"),mi=h(),Qe=a("div"),w(os.$$.fragment),Tp=h(),so=a("p"),yp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mp=h(),w(Bo.$$.fragment),qp=h(),lt=a("div"),w(rs.$$.fragment),Cp=h(),ao=a("p"),zp=n("The "),Ys=a("a"),Ap=n("TFGPTJForQuestionAnswering"),Lp=n(" forward method, overrides the "),sr=a("code"),Ip=n("__call__"),Op=n(" special method."),Np=h(),w(Qo.$$.fragment),Sp=h(),w(Ho.$$.fragment),Dp=h(),w(Ko.$$.fragment),fi=h(),ro=a("h2"),Ro=a("a"),ar=a("span"),w(is.$$.fragment),Wp=h(),rr=a("span"),Up=n("FlaxGPTJModel"),gi=h(),Ie=a("div"),w(ls.$$.fragment),Bp=h(),ir=a("p"),Qp=n("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),Hp=h(),ds=a("p"),Kp=n("This model inherits from "),Zs=a("a"),Rp=n("FlaxPreTrainedModel"),Vp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xp=h(),cs=a("p"),Yp=n(`This model is also a Flax Linen
`),ps=a("a"),Zp=n("flax.nn.Module"),eh=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),th=h(),lr=a("p"),oh=n("Finally, this model supports inherent JAX features such as:"),nh=h(),Mt=a("ul"),dr=a("li"),hs=a("a"),sh=n("Just-In-Time (JIT) compilation"),ah=h(),cr=a("li"),us=a("a"),rh=n("Automatic Differentiation"),ih=h(),pr=a("li"),ms=a("a"),lh=n("Vectorization"),dh=h(),hr=a("li"),fs=a("a"),ch=n("Parallelization"),ph=h(),$t=a("div"),w(gs.$$.fragment),hh=h(),io=a("p"),uh=n("The "),ur=a("code"),mh=n("FlaxGPTJPreTrainedModel"),fh=n(" forward method, overrides the "),mr=a("code"),gh=n("__call__"),_h=n(" special method."),Th=h(),w(Vo.$$.fragment),yh=h(),w(Xo.$$.fragment),_i=h(),lo=a("h2"),Yo=a("a"),fr=a("span"),w(_s.$$.fragment),vh=h(),gr=a("span"),wh=n("FlaxGPTJForCausalLM"),Ti=h(),Oe=a("div"),w(Ts.$$.fragment),kh=h(),_r=a("p"),bh=n("The GPTJ Model transformer with a language modeling head on top."),$h=h(),ys=a("p"),Ph=n("This model inherits from "),ea=a("a"),Fh=n("FlaxPreTrainedModel"),jh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh=h(),vs=a("p"),xh=n(`This model is also a Flax Linen
`),ws=a("a"),Eh=n("flax.nn.Module"),Jh=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mh=h(),Tr=a("p"),qh=n("Finally, this model supports inherent JAX features such as:"),Ch=h(),qt=a("ul"),yr=a("li"),ks=a("a"),zh=n("Just-In-Time (JIT) compilation"),Ah=h(),vr=a("li"),bs=a("a"),Lh=n("Automatic Differentiation"),Ih=h(),wr=a("li"),$s=a("a"),Oh=n("Vectorization"),Nh=h(),kr=a("li"),Ps=a("a"),Sh=n("Parallelization"),Dh=h(),Pt=a("div"),w(Fs.$$.fragment),Wh=h(),co=a("p"),Uh=n("The "),br=a("code"),Bh=n("FlaxGPTJPreTrainedModel"),Qh=n(" forward method, overrides the "),$r=a("code"),Hh=n("__call__"),Kh=n(" special method."),Rh=h(),w(Zo.$$.fragment),Vh=h(),w(en.$$.fragment),this.h()},l(o){const _=pf('[data-svelte="svelte-1phssyn"]',document.head);d=r(_,"META",{name:!0,content:!0}),_.forEach(t),T=u(o),c=r(o,"H1",{class:!0});var js=i(c);m=r(js,"A",{id:!0,class:!0,href:!0});var Pr=i(m);v=r(Pr,"SPAN",{});var Fr=i(v);k(l.$$.fragment,Fr),Fr.forEach(t),Pr.forEach(t),p=u(js),E=r(js,"SPAN",{});var jr=i(E);be=s(jr,"GPT-J"),jr.forEach(t),js.forEach(t),ge=u(o),N=r(o,"H2",{class:!0});var Gs=i(N);oe=r(Gs,"A",{id:!0,class:!0,href:!0});var Gr=i(oe);Z=r(Gr,"SPAN",{});var xr=i(Z);k(j.$$.fragment,xr),xr.forEach(t),Gr.forEach(t),$e=u(Gs),U=r(Gs,"SPAN",{});var Er=i(U);Pe=s(Er,"Overview"),Er.forEach(t),Gs.forEach(t),_e=u(o),O=r(o,"P",{});var po=i(O);Fe=s(po,"The GPT-J model was released in the "),se=r(po,"A",{href:!0,rel:!0});var Jr=i(se);H=s(Jr,"kingoflolz/mesh-transformer-jax"),Jr.forEach(t),je=s(po,` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
...
model.`),vi.forEach(t),Kr=u(o),k(hn.$$.fragment,o),Rr=u(o),qs=r(o,"P",{});var ou=i(qs);Xi=s(ou,"\u2026or in float16 precision:"),ou.forEach(t),Vr=u(o),k(un.$$.fragment,o),Xr=u(o),St=r(o,"H2",{class:!0});var wi=i(St);uo=r(wi,"A",{id:!0,class:!0,href:!0});var nu=i(uo);ga=r(nu,"SPAN",{});var su=i(ga);k(mn.$$.fragment,su),su.forEach(t),nu.forEach(t),Yi=u(wi),_a=r(wi,"SPAN",{});var au=i(_a);Zi=s(au,"GPTJConfig"),au.forEach(t),wi.forEach(t),Yr=u(o),Et=r(o,"DIV",{class:!0});var oa=i(Et);k(fn.$$.fragment,oa),el=u(oa),mt=r(oa,"P",{});var zt=i(mt);tl=s(zt,"This is the configuration class to store the configuration of a "),Cs=r(zt,"A",{href:!0});var ru=i(Cs);ol=s(ru,"GPTJModel"),ru.forEach(t),nl=s(zt,`. It is used to instantiate a GPT-J
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the GPT-J
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ji.forEach(t),cd=u(Ft),Ne=r(Ft,"DIV",{class:!0});var dt=i(Ne);k(Jn.$$.fragment,dt),pd=u(dt),Ht=r(dt,"P",{});var ra=i(Ht);hd=s(ra,"The "),Ss=r(ra,"A",{href:!0});var qu=i(Ss);ud=s(qu,"GPTJForSequenceClassification"),qu.forEach(t),md=s(ra," forward method, overrides the "),Ma=r(ra,"CODE",{});var Cu=i(Ma);fd=s(Cu,"__call__"),Cu.forEach(t),gd=s(ra," special method."),ra.forEach(t),_d=u(dt),k(ko.$$.fragment,dt),Td=u(dt),k(bo.$$.fragment,dt),yd=u(dt),k($o.$$.fragment,dt),vd=u(dt),k(Po.$$.fragment,dt),wd=u(dt),k(Fo.$$.fragment,dt),dt.forEach(t),Ft.forEach(t),ai=u(o),Kt=r(o,"H2",{class:!0});var Gi=i(Kt);jo=r(Gi,"A",{id:!0,class:!0,href:!0});var zu=i(jo);qa=r(zu,"SPAN",{});var Au=i(qa);k(Mn.$$.fragment,Au),Au.forEach(t),zu.forEach(t),kd=u(Gi),Ca=r(Gi,"SPAN",{});var Lu=i(Ca);bd=s(Lu,"GPTJForQuestionAnswering"),Lu.forEach(t),Gi.forEach(t),ri=u(o),_t=r(o,"DIV",{class:!0});var sn=i(_t);k(qn.$$.fragment,sn),$d=u(sn),Rt=r(sn,"P",{});var ia=i(Rt);Pd=s(ia,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ci.forEach(t),vc=u(Gt),Qn=r(Gt,"P",{});var zi=i(Qn);wc=s(zi,"This model is also a "),Hn=r(zi,"A",{href:!0,rel:!0});var om=i(Hn);kc=s(om,"tf.keras.Model"),om.forEach(t),bc=s(zi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
