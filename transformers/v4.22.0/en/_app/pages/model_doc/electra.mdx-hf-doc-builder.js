...
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_tf_electra.py#L805"}}),dr=new Se({}),cr=new W({props:{name:"class transformers.ElectraModel",anchor:"transformers.ElectraModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/v4.22.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_electra.py#L1074",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_electra.py#L1559",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_electra.py#L1188",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_electra.py#L977",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_electra.py#L1463",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_electra.py#L1275",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_electra.py#L1357",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_tf_electra.py#L936",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_tf_electra.py#L1034",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_tf_electra.py#L1164",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_tf_electra.py#L1276",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_tf_electra.py#L1370",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_tf_electra.py#L1487",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_tf_electra.py#L1569",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_flax_electra.py#L923"}}),tl=new W({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/v4.22.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.22.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_flax_electra.py#L772",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_flax_electra.py#L1078"}}),pl=new W({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/v4.22.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_flax_electra.py#L1576"}}),Tl=new W({props:{name:"__call__",anchor:"transformers.FlaxElectraForCausalLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForCausalLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/v4.22.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.0/src/transformers/models/electra/modeling_flax_electra.py#L1012"}}),ql=new W({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/v4.22.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),QE=p(),Hh=a("p"),BE=n("Finally, this model supports inherent JAX features such as:"),VE=p(),fo=a("ul"),Kh=a("li"),_l=a("a"),JE=n("Just-In-Time (JIT) compilation"),GE=p(),Qh=a("li"),vl=a("a"),XE=n("Automatic Differentiation"),YE=p(),Bh=a("li"),kl=a("a"),ZE=n("Vectorization"),e$=p(),Vh=a("li"),yl=a("a"),t$=n("Parallelization"),o$=p(),Zt=a("div"),T(Tl.$$.fragment),n$=p(),Mn=a("p"),s$=n("The "),Jh=a("code"),a$=n("FlaxElectraPreTrainedModel"),r$=n(" forward method, overrides the "),Gh=a("code"),i$=n("__call__"),l$=n(" special method."),d$=p(),T(da.$$.fragment),c$=p(),T(ca.$$.fragment),xf=p(),zn=a("h2"),pa=a("a"),Xh=a("span"),T(bl.$$.fragment),p$=p(),Yh=a("span"),h$=n("FlaxElectraForMaskedLM"),Mf=p(),rt=a("div"),T(wl.$$.fragment),m$=p(),El=a("p"),u$=n("Electra Model with a "),Zh=a("code"),f$=n("language modeling"),g$=n(" head on top."),_$=p(),$l=a("p"),v$=n("This model inherits from "),Tc=a("a"),k$=n("FlaxPreTrainedModel"),y$=n(`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$$=p(),em=a("p"),F$=n("Finally, this model supports inherent JAX features such as:"),x$=p(),go=a("ul"),tm=a("li"),Ml=a("a"),M$=n("Just-In-Time (JIT) compilation"),z$=p(),om=a("li"),zl=a("a"),C$=n("Automatic Differentiation"),j$=p(),nm=a("li"),Cl=a("a"),q$=n("Vectorization"),P$=p(),sm=a("li"),jl=a("a"),A$=n("Parallelization"),O$=p(),eo=a("div"),T(ql.$$.fragment),L$=p(),Cn=a("p"),N$=n("The "),am=a("code"),I$=n("FlaxElectraPreTrainedModel"),D$=n(" forward method, overrides the "),rm=a("code"),S$=n("__call__"),W$=n(" special method."),U$=p(),T(ha.$$.fragment),R$=p(),T(ma.$$.fragment),zf=p(),jn=a("h2"),ua=a("a"),im=a("span"),T(Pl.$$.fragment),H$=p(),lm=a("span"),K$=n("FlaxElectraForSequenceClassification"),Cf=p(),it=a("div"),T(Al.$$.fragment),Q$=p(),dm=a("p"),B$=n(`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),o1=p(),cm=a("p"),n1=n("Finally, this model supports inherent JAX features such as:"),s1=p(),_o=a("ul"),pm=a("li"),Il=a("a"),a1=n("Just-In-Time (JIT) compilation"),r1=p(),hm=a("li"),Dl=a("a"),i1=n("Automatic Differentiation"),l1=p(),mm=a("li"),Sl=a("a"),d1=n("Vectorization"),c1=p(),um=a("li"),Wl=a("a"),p1=n("Parallelization"),h1=p(),to=a("div"),T(Ul.$$.fragment),m1=p(),qn=a("p"),u1=n("The "),fm=a("code"),f1=n("FlaxElectraPreTrainedModel"),g1=n(" forward method, overrides the "),gm=a("code"),_1=n("__call__"),v1=n(" special method."),k1=p(),T(fa.$$.fragment),y1=p(),T(ga.$$.fragment),jf=p(),Pn=a("h2"),_a=a("a"),_m=a("span"),T(Rl.$$.fragment),T1=p(),vm=a("span"),b1=n("FlaxElectraForMultipleChoice"),qf=p(),lt=a("div"),T(Hl.$$.fragment),w1=p(),km=a("p"),E1=n(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),$1=p(),Kl=a("p"),F1=n("This model inherits from "),wc=a("a"),x1=n("FlaxPreTrainedModel"),M1=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),z1=p(),Ql=a("p"),C1=n(`This model is also a Flax Linen
`),Bl=a("a"),j1=n("flax.nn.Module"),q1=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),P1=p(),ym=a("p"),A1=n("Finally, this model supports inherent JAX features such as:"),O1=p(),vo=a("ul"),Tm=a("li"),Vl=a("a"),L1=n("Just-In-Time (JIT) compilation"),N1=p(),bm=a("li"),Jl=a("a"),I1=n("Automatic Differentiation"),D1=p(),wm=a("li"),Gl=a("a"),S1=n("Vectorization"),W1=p(),Em=a("li"),Xl=a("a"),U1=n("Parallelization"),R1=p(),oo=a("div"),T(Yl.$$.fragment),H1=p(),An=a("p"),K1=n("The "),$m=a("code"),Q1=n("FlaxElectraPreTrainedModel"),B1=n(" forward method, overrides the "),Fm=a("code"),V1=n("__call__"),J1=n(" special method."),G1=p(),T(va.$$.fragment),X1=p(),T(ka.$$.fragment),Pf=p(),On=a("h2"),ya=a("a"),xm=a("span"),T(Zl.$$.fragment),Y1=p(),Mm=a("span"),Z1=n("FlaxElectraForTokenClassification"),Af=p(),et=a("div"),T(ed.$$.fragment),e0=p(),zm=a("p"),t0=n("Electra model with a token classification head on top."),o0=p(),Cm=a("p"),n0=n("Both the discriminator and generator may be loaded into this model."),s0=p(),td=a("p"),a0=n("This model inherits from "),Ec=a("a"),r0=n("FlaxPreTrainedModel"),i0=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),l0=p(),od=a("p"),d0=n(`This model is also a Flax Linen
`),nd=a("a"),c0=n("flax.nn.Module"),p0=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),h0=p(),jm=a("p"),m0=n("Finally, this model supports inherent JAX features such as:"),u0=p(),ko=a("ul"),qm=a("li"),sd=a("a"),f0=n("Just-In-Time (JIT) compilation"),g0=p(),Pm=a("li"),ad=a("a"),_0=n("Automatic Differentiation"),v0=p(),Am=a("li"),rd=a("a"),k0=n("Vectorization"),y0=p(),Om=a("li"),id=a("a"),T0=n("Parallelization"),b0=p(),no=a("div"),T(ld.$$.fragment),w0=p(),Ln=a("p"),E0=n("The "),Lm=a("code"),$0=n("FlaxElectraPreTrainedModel"),F0=n(" forward method, overrides the "),Nm=a("code"),x0=n("__call__"),M0=n(" special method."),z0=p(),T(Ta.$$.fragment),C0=p(),T(ba.$$.fragment),Of=p(),Nn=a("h2"),wa=a("a"),Im=a("span"),T(dd.$$.fragment),j0=p(),Dm=a("span"),q0=n("FlaxElectraForQuestionAnswering"),Lf=p(),dt=a("div"),T(cd.$$.fragment),P0=p(),In=a("p"),A0=n(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Sm=a("code"),O0=n("span start logits"),L0=n(" and "),Wm=a("code"),N0=n("span end logits"),I0=n(")."),D0=p(),pd=a("p"),S0=n("This model inherits from "),$c=a("a"),W0=n("FlaxPreTrainedModel"),U0=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),R0=p(),hd=a("p"),H0=n(`This model is also a Flax Linen
`),md=a("a"),K0=n("flax.nn.Module"),Q0=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),B0=p(),Um=a("p"),V0=n("Finally, this model supports inherent JAX features such as:"),J0=p(),yo=a("ul"),Rm=a("li"),ud=a("a"),G0=n("Just-In-Time (JIT) compilation"),X0=p(),Hm=a("li"),fd=a("a"),Y0=n("Automatic Differentiation"),Z0=p(),Km=a("li"),gd=a("a"),eF=n("Vectorization"),tF=p(),Qm=a("li"),_d=a("a"),oF=n("Parallelization"),nF=p(),so=a("div"),T(vd.$$.fragment),sF=p(),Dn=a("p"),aF=n("The "),Bm=a("code"),rF=n("FlaxElectraPreTrainedModel"),iF=n(" forward method, overrides the "),Vm=a("code"),lF=n("__call__"),dF=n(" special method."),cF=p(),T(Ea.$$.fragment),pF=p(),T($a.$$.fragment),this.h()},l(o){const v=uC('[data-svelte="svelte-1phssyn"]',document.head);d=r(v,"META",{name:!0,content:!0}),v.forEach(t),g=h(o),c=r(o,"H1",{class:!0});var kd=i(c);f=r(kd,"A",{id:!0,class:!0,href:!0});var Jm=i(f);k=r(Jm,"SPAN",{});var Gm=i(k);b(l.$$.fragment,Gm),Gm.forEach(t),Jm.forEach(t),m=h(kd),z=r(kd,"SPAN",{});var Xm=i(z);Te=s(Xm,"ELECTRA"),Xm.forEach(t),kd.forEach(t),fe=h(o),S=r(o,"H2",{class:!0});var yd=i(S);ae=r(yd,"A",{id:!0,class:!0,href:!0});var Ym=i(ae);ee=r(Ym,"SPAN",{});var Zm=i(ee);b(M.$$.fragment,Zm),Zm.forEach(t),Ym.forEach(t),be=h(yd),Q=r(yd,"SPAN",{});var eu=i(Q);we=s(eu,"Overview"),eu.forEach(t),yd.forEach(t),ge=h(o),U=r(o,"P",{});var Td=i(U);Ee=s(Td,"The ELECTRA model was proposed in the paper "),re=r(Td,"A",{href:!0,rel:!0});var tu=i(re);B=s(tu,`ELECTRA: Pre-training Text Encoders as Discriminators Rather Than
...
splitting and wordpiece.`),xa.forEach(t),A_=h($o),nr=r($o,"P",{});var Md=i(nr);O_=s(Md,"Refer to superclass "),Dd=r(Md,"A",{href:!0});var Pu=i(Dd);L_=s(Pu,"BertTokenizerFast"),Pu.forEach(t),N_=s(Md," for usage examples and documentation concerning parameters."),Md.forEach(t),$o.forEach(t),Wu=h(o),Wo=r(o,"H2",{class:!0});var zd=i(Wo);Bn=r(zd,"A",{id:!0,class:!0,href:!0});var Au=i(Bn);sp=r(Au,"SPAN",{});var Ou=i(sp);b(sr.$$.fragment,Ou),Ou.forEach(t),Au.forEach(t),I_=h(zd),ap=r(zd,"SPAN",{});var Lu=i(ap);D_=s(Lu,"Electra specific outputs"),Lu.forEach(t),zd.forEach(t),Uu=h(o),Uo=r(o,"DIV",{class:!0});var Cd=i(Uo);b(ar.$$.fragment,Cd),S_=h(Cd),rr=r(Cd,"P",{});var jd=i(rr);W_=s(jd,"Output type of "),Sd=r(jd,"A",{href:!0});var hF=i(Sd);U_=s(hF,"ElectraForPreTraining"),hF.forEach(t),R_=s(jd,"."),jd.forEach(t),Cd.forEach(t),Ru=h(o),Ro=r(o,"DIV",{class:!0});var If=i(Ro);b(ir.$$.fragment,If),H_=h(If),lr=r(If,"P",{});var Df=i(lr);K_=s(Df,"Output type of "),Wd=r(Df,"A",{href:!0});var mF=i(Wd);Q_=s(mF,"TFElectraForPreTraining"),mF.forEach(t),B_=s(Df,"."),Df.forEach(t),If.forEach(t),Hu=h(o),Ho=r(o,"H2",{class:!0});var Sf=i(Ho);Vn=r(Sf,"A",{id:!0,class:!0,href:!0});var uF=i(Vn);rp=r(uF,"SPAN",{});var fF=i(rp);b(dr.$$.fragment,fF),fF.forEach(t),uF.forEach(t),V_=h(Sf),ip=r(Sf,"SPAN",{});var gF=i(ip);J_=s(gF,"ElectraModel"),gF.forEach(t),Sf.forEach(t),Ku=h(o),yt=r(o,"DIV",{class:!0});var Fo=i(yt);b(cr.$$.fragment,Fo),G_=h(Fo),lp=r(Fo,"P",{});var _F=i(lp);X_=s(_F,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),_F.forEach(t),Y_=h(Fo),pr=r(Fo,"P",{});var Wf=i(pr);Z_=s(Wf,"This model inherits from "),Ud=r(Wf,"A",{href:!0});var vF=i(Ud);ev=s(vF,"PreTrainedModel"),vF.forEach(t),tv=s(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),ov=h(Fo),hr=r(Fo,"P",{});var Uf=i(hr);nv=s(Uf,"This model is also a PyTorch "),mr=r(Uf,"A",{href:!0,rel:!0});var kF=i(mr);sv=s(kF,"torch.nn.Module"),kF.forEach(t),av=s(Uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),rv=h(Fo),Ht=r(Fo,"DIV",{class:!0});var Ma=i(Ht);b(ur.$$.fragment,Ma),iv=h(Ma),Ko=r(Ma,"P",{});var Fc=i(Ko);lv=s(Fc,"The "),Rd=r(Fc,"A",{href:!0});var yF=i(Rd);dv=s(yF,"ElectraModel"),yF.forEach(t),cv=s(Fc," forward method, overrides the "),dp=r(Fc,"CODE",{});var TF=i(dp);pv=s(TF,"__call__"),TF.forEach(t),hv=s(Fc," special method."),Fc.forEach(t),mv=h(Ma),b(Jn.$$.fragment,Ma),uv=h(Ma),b(Gn.$$.fragment,Ma),Ma.forEach(t),Fo.forEach(t),Qu=h(o),Qo=r(o,"H2",{class:!0});var Rf=i(Qo);Xn=r(Rf,"A",{id:!0,class:!0,href:!0});var bF=i(Xn);cp=r(bF,"SPAN",{});var wF=i(cp);b(fr.$$.fragment,wF),wF.forEach(t),bF.forEach(t),fv=h(Rf),pp=r(Rf,"SPAN",{});var EF=i(pp);gv=s(EF,"ElectraForPreTraining"),EF.forEach(t),Rf.forEach(t),Bu=h(o),pt=r(o,"DIV",{class:!0});var ao=i(pt);b(gr.$$.fragment,ao),_v=h(ao),hp=r(ao,"P",{});var $F=i(hp);vv=s($F,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),$F.forEach(t),kv=h(ao),mp=r(ao,"P",{});var FF=i(mp);yv=s(FF,"It is recommended to load the discriminator checkpoint into that model."),FF.forEach(t),Tv=h(ao),_r=r(ao,"P",{});var Hf=i(_r);bv=s(Hf,"This model inherits from "),Hd=r(Hf,"A",{href:!0});var xF=i(Hd);wv=s(xF,"PreTrainedModel"),xF.forEach(t),Ev=s(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hf.forEach(t),$v=h(ao),vr=r(ao,"P",{});var Kf=i(vr);Fv=s(Kf,"This model is also a PyTorch "),kr=r(Kf,"A",{href:!0,rel:!0});var MF=i(kr);xv=s(MF,"torch.nn.Module"),MF.forEach(t),Mv=s(Kf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kf.forEach(t),zv=h(ao),Kt=r(ao,"DIV",{class:!0});var za=i(Kt);b(yr.$$.fragment,za),Cv=h(za),Bo=r(za,"P",{});var xc=i(Bo);jv=s(xc,"The "),Kd=r(xc,"A",{href:!0});var zF=i(Kd);qv=s(zF,"ElectraForPreTraining"),zF.forEach(t),Pv=s(xc," forward method, overrides the "),up=r(xc,"CODE",{});var CF=i(up);Av=s(CF,"__call__"),CF.forEach(t),Ov=s(xc," special method."),xc.forEach(t),Lv=h(za),b(Yn.$$.fragment,za),Nv=h(za),b(Zn.$$.fragment,za),za.forEach(t),ao.forEach(t),Vu=h(o),Vo=r(o,"H2",{class:!0});var Qf=i(Vo);es=r(Qf,"A",{id:!0,class:!0,href:!0});var jF=i(es);fp=r(jF,"SPAN",{});var qF=i(fp);b(Tr.$$.fragment,qF),qF.forEach(t),jF.forEach(t),Iv=h(Qf),gp=r(Qf,"SPAN",{});var PF=i(gp);Dv=s(PF,"ElectraForCausalLM"),PF.forEach(t),Qf.forEach(t),Ju=h(o),Tt=r(o,"DIV",{class:!0});var xo=i(Tt);b(br.$$.fragment,xo),Sv=h(xo),wr=r(xo,"P",{});var Bf=i(wr);Wv=s(Bf,"ELECTRA Model with a "),_p=r(Bf,"CODE",{});var AF=i(_p);Uv=s(AF,"language modeling"),AF.forEach(t),Rv=s(Bf," head on top for CLM fine-tuning."),Bf.forEach(t),Hv=h(xo),Er=r(xo,"P",{});var Vf=i(Er);Kv=s(Vf,"This model inherits from "),Qd=r(Vf,"A",{href:!0});var OF=i(Qd);Qv=s(OF,"PreTrainedModel"),OF.forEach(t),Bv=s(Vf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vf.forEach(t),Vv=h(xo),$r=r(xo,"P",{});var Jf=i($r);Jv=s(Jf,"This model is also a PyTorch "),Fr=r(Jf,"A",{href:!0,rel:!0});var LF=i(Fr);Gv=s(LF,"torch.nn.Module"),LF.forEach(t),Xv=s(Jf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jf.forEach(t),Yv=h(xo),Qt=r(xo,"DIV",{class:!0});var Ca=i(Qt);b(xr.$$.fragment,Ca),Zv=h(Ca),Jo=r(Ca,"P",{});var Mc=i(Jo);ek=s(Mc,"The "),Bd=r(Mc,"A",{href:!0});var NF=i(Bd);tk=s(NF,"ElectraForCausalLM"),NF.forEach(t),ok=s(Mc," forward method, overrides the "),vp=r(Mc,"CODE",{});var IF=i(vp);nk=s(IF,"__call__"),IF.forEach(t),sk=s(Mc," special method."),Mc.forEach(t),ak=h(Ca),b(ts.$$.fragment,Ca),rk=h(Ca),b(os.$$.fragment,Ca),Ca.forEach(t),xo.forEach(t),Gu=h(o),Go=r(o,"H2",{class:!0});var Gf=i(Go);ns=r(Gf,"A",{id:!0,class:!0,href:!0});var DF=i(ns);kp=r(DF,"SPAN",{});var SF=i(kp);b(Mr.$$.fragment,SF),SF.forEach(t),DF.forEach(t),ik=h(Gf),yp=r(Gf,"SPAN",{});var WF=i(yp);lk=s(WF,"ElectraForMaskedLM"),WF.forEach(t),Gf.forEach(t),Xu=h(o),ht=r(o,"DIV",{class:!0});var ro=i(ht);b(zr.$$.fragment,ro),dk=h(ro),Tp=r(ro,"P",{});var UF=i(Tp);ck=s(UF,"Electra model with a language modeling head on top."),UF.forEach(t),pk=h(ro),bp=r(ro,"P",{});var RF=i(bp);hk=s(RF,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),RF.forEach(t),mk=h(ro),Cr=r(ro,"P",{});var Xf=i(Cr);uk=s(Xf,"This model inherits from "),Vd=r(Xf,"A",{href:!0});var HF=i(Vd);fk=s(HF,"PreTrainedModel"),HF.forEach(t),gk=s(Xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xf.forEach(t),_k=h(ro),jr=r(ro,"P",{});var Yf=i(jr);vk=s(Yf,"This model is also a PyTorch "),qr=r(Yf,"A",{href:!0,rel:!0});var KF=i(qr);kk=s(KF,"torch.nn.Module"),KF.forEach(t),yk=s(Yf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yf.forEach(t),Tk=h(ro),$t=r(ro,"DIV",{class:!0});var Mo=i($t);b(Pr.$$.fragment,Mo),bk=h(Mo),Xo=r(Mo,"P",{});var zc=i(Xo);wk=s(zc,"The "),Jd=r(zc,"A",{href:!0});var QF=i(Jd);Ek=s(QF,"ElectraForMaskedLM"),QF.forEach(t),$k=s(zc," forward method, overrides the "),wp=r(zc,"CODE",{});var BF=i(wp);Fk=s(BF,"__call__"),BF.forEach(t),xk=s(zc," special method."),zc.forEach(t),Mk=h(Mo),b(ss.$$.fragment,Mo),zk=h(Mo),b(as.$$.fragment,Mo),Ck=h(Mo),b(rs.$$.fragment,Mo),Mo.forEach(t),ro.forEach(t),Yu=h(o),Yo=r(o,"H2",{class:!0});var Zf=i(Yo);is=r(Zf,"A",{id:!0,class:!0,href:!0});var VF=i(is);Ep=r(VF,"SPAN",{});var JF=i(Ep);b(Ar.$$.fragment,JF),JF.forEach(t),VF.forEach(t),jk=h(Zf),$p=r(Zf,"SPAN",{});var GF=i($p);qk=s(GF,"ElectraForSequenceClassification"),GF.forEach(t),Zf.forEach(t),Zu=h(o),bt=r(o,"DIV",{class:!0});var zo=i(bt);b(Or.$$.fragment,zo),Pk=h(zo),Fp=r(zo,"P",{});var XF=i(Fp);Ak=s(XF,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),XF.forEach(t),Ok=h(zo),Lr=r(zo,"P",{});var eg=i(Lr);Lk=s(eg,"This model inherits from "),Gd=r(eg,"A",{href:!0});var YF=i(Gd);Nk=s(YF,"PreTrainedModel"),YF.forEach(t),Ik=s(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eg.forEach(t),Dk=h(zo),Nr=r(zo,"P",{});var tg=i(Nr);Sk=s(tg,"This model is also a PyTorch "),Ir=r(tg,"A",{href:!0,rel:!0});var ZF=i(Ir);Wk=s(ZF,"torch.nn.Module"),ZF.forEach(t),Uk=s(tg,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
