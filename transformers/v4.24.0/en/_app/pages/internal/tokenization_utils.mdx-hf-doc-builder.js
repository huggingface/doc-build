...
PyTorch tensors, you will lose the specific device of your tensors however.`),j.forEach(t)},m(ge,j){P(ge,p,j),e(p,$),e(p,f),e(f,h),e(p,x),e(p,c),e(c,_),e(p,L)},d(ge){ge&&t(p)}}}function sh(q){let p,$,f,h,x;return h=new zs({props:{code:`from transformers import AutoTokenizer
...
tokenizer.push_to_hub(<span class="hljs-string">&quot;huggingface/my-finetuned-bert&quot;</span>)`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ys,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),z(h,c)}}}function ah(q){let p,$;return{c(){p=r("p"),$=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(f){p=s(f,"P",{});var h=a(p);$=n(h,"This API is experimental and may have some slight breaking changes in the next releases."),h.forEach(t)},m(f,h){P(f,p,h),e(p,$)},d(f){f&&t(p)}}}function ih(q){let p,$,f,h,x;return h=new zs({props:{code:`# Let's see how to add a new classification token to GPT-2
...
<span class="hljs-keyword">assert</span> tokenizer.cls_token == <span class="hljs-string">&quot;&lt;CLS&gt;&quot;</span>`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ys,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),z(h,c)}}}function dh(q){let p,$,f,h,x;return h=new zs({props:{code:`# Let's see how to increase the vocabulary of Bert model and tokenizer
...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ys,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),z(h,c)}}}function lh(q){let p,$,f,h,x,c,_,L,ge,j,D,ro,so,ws,xs,ao,$s,Ps,io,Es,qs,lo,Bs,Ls,Dr,co,Ds,Ir,ke,Ie,Oo,at,Is,Wo,Ns,Nr,u,it,As,be,Ss,po,Fs,Cs,mo,Os,Ws,js,jo,Rs,Us,Ro,Ms,Vs,I,Z,Uo,Gs,Hs,Mo,Xs,Ys,Vo,Js,Ks,Qs,S,Go,Zs,ea,Ho,ta,oa,Xo,na,ra,Yo,sa,aa,Jo,ia,da,la,V,Ko,ca,pa,Qo,ma,ha,Zo,ua,fa,en,_a,ga,ka,F,tn,ba,va,on,Ta,ya,nn,za,wa,rn,xa,$a,ho,Pa,Ea,qa,Ne,sn,Ba,La,an,Da,Ia,Na,G,dn,Aa,Sa,ln,Fa,Ca,cn,Oa,Wa,pn,ja,Ra,Ua,H,mn,Ma,Va,hn,Ga,Ha,un,Xa,Ya,fn,Ja,Ka,Qa,Ae,dt,Za,_n,ei,ti,Se,lt,oi,gn,ni,ri,Fe,ct,si,kn,ai,ii,ee,pt,di,bn,li,ci,Ce,pi,te,mt,mi,vn,hi,ui,Tn,fi,_i,Oe,ht,gi,yn,ki,bi,We,ut,vi,ft,Ti,zn,yi,zi,wi,oe,_t,xi,uo,$i,fo,Pi,Ei,wn,qi,Bi,ne,gt,Li,xn,Di,Ii,kt,Ni,$n,Ai,Si,Fi,re,bt,Ci,Pn,Oi,Wi,vt,ji,En,Ri,Ui,Mi,se,Tt,Vi,qn,Gi,Hi,je,Xi,X,yt,Yi,zt,Ji,_o,Ki,Qi,Zi,Re,ed,Ue,td,Me,wt,od,ve,nd,Bn,rd,sd,Ln,ad,id,dd,ae,xt,ld,Dn,cd,pd,ie,In,md,hd,Nn,ud,fd,An,_d,gd,kd,C,$t,bd,Sn,vd,Td,J,yd,Fn,zd,wd,Cn,xd,$d,On,Pd,Ed,qd,Te,Bd,Wn,Ld,Dd,jn,Id,Nd,Ad,Ve,Sd,Ge,Pt,Fd,R,Cd,Rn,Od,Wd,Un,jd,Rd,Mn,Ud,Md,Vn,Vd,Gd,Hd,He,Et,Xd,Gn,Yd,Jd,de,qt,Kd,Bt,Qd,Hn,Zd,el,tl,Xe,ol,le,Lt,nl,Dt,rl,Xn,sl,al,il,Ye,dl,Y,It,ll,Yn,cl,pl,Nt,ml,Jn,hl,ul,fl,At,_l,Kn,gl,kl,bl,ce,St,vl,Qn,Tl,yl,Ft,zl,Zn,wl,xl,$l,Je,Ct,Pl,Ot,El,er,ql,Bl,Ll,Ke,Wt,Dl,tr,Il,Ar,ye,Qe,or,jt,Nl,nr,Al,Sr,A,Rt,Sl,ze,Fl,go,Cl,Ol,ko,Wl,jl,Rl,B,Ut,Ul,rr,Ml,Vl,sr,Gl,Hl,Mt,Xl,bo,Yl,Jl,Kl,Vt,Ql,ar,Zl,ec,tc,Gt,ir,oc,nc,Ht,rc,dr,sc,ac,ic,U,dc,vo,lc,cc,lr,pc,mc,cr,hc,uc,pr,fc,_c,gc,Ze,kc,O,Xt,bc,mr,vc,Tc,hr,yc,zc,Yt,wc,To,xc,$c,Pc,et,Ec,pe,Jt,qc,we,Bc,ur,Lc,Dc,fr,Ic,Nc,Ac,_r,Sc,Fr,xe,tt,gr,Kt,Fc,kr,Cc,Cr,$e,Qt,Oc,Pe,Wc,br,jc,Rc,ot,Uc,vr,Mc,Vc,Gc,Or,Ee,Zt,Hc,Tr,Xc,Wr,qe,eo,Yc,yr,Jc,jr;return c=new vs({}),at=new vs({}),it=new E({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
The maximum length (in number of tokens) for the inputs to the transformer model. When the tokenizer is
loaded with <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained">from_pretrained()</a>, this will be set to the
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L3374",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L2711",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L3407",returnDescription:`
...
<p>**kwargs &#x2014; Passed along to the <code>.tokenize()</code> method.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L2222",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L2615",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
using the <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained">save_pretrained()</a> method, e.g.,
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L3452",returnDescription:`
<p>1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p>A list of integers in the range [0, 1]</p>
`}}),xt=new E({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L1557",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
`}}),$t=new E({props:{name:"pad",anchor:"transformers.PreTrainedTokenizerBase.pad",parameters:[{name:"encoded_inputs",val:": typing.Union[transformers.tokenization_utils_base.BatchEncoding, typing.List[transformers.tokenization_utils_base.BatchEncoding], typing.Dict[str, typing.List[int]], typing.Dict[str, typing.List[typing.List[int]]], typing.List[typing.Dict[str, typing.List[int]]]]"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = True"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"verbose",val:": bool = True"}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.pad.encoded_inputs",description:`<strong>encoded_inputs</strong> (<a href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, list of <a href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <code>Dict[str, List[int]]</code>, <code>Dict[str, List[List[int]]</code> or <code>List[Dict[str, List[int]]]</code>) &#x2014;
Tokenized inputs. Can represent one input (<a href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> or <code>Dict[str, List[int]]</code>) or a batch of
tokenized inputs (list of <a href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <em>Dict[str, List[List[int]]]</em> or <em>List[Dict[str,
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L3027",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/v4.24.0/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Activates and controls truncation. Accepts the following values:</p>
<ul>
<li><code>True</code> or <code>&apos;longest_first&apos;</code>: Truncate to a maximum length specified with the argument <code>max_length</code> or
to the maximum acceptable input length for the model if that argument is not provided. This will
...
</ul>`,name:"truncation"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L3583",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L2184",returnDescription:`
...
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L2202",returnDescription:`
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L3163",returnDescription:`
...
assign the index of the <code>unk_token</code> to them).`,name:"special_tokens_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/tokenization_utils_base.py#L842",returnDescription:`
...
or `),en=r("code"),_a=o("None"),ga=o(" if the model has no maximum input size."),ka=d(),F=r("li"),tn=r("strong"),ba=o("pretrained_init_configuration"),va=o(" ("),on=r("code"),Ta=o("Dict[str, Dict[str, Any]]"),ya=o(`) \u2014 A dictionary with, as keys, the
`),nn=r("code"),za=o("short-cut-names"),wa=o(` of the pretrained models, and as associated values, a dictionary of specific arguments to
...
with the `),ho=r("a"),Pa=o("from_pretrained()"),Ea=o(" method."),qa=d(),Ne=r("li"),sn=r("strong"),Ba=o("model_input_names"),La=o(" ("),an=r("code"),Da=o("List[str]"),Ia=o(") \u2014 A list of inputs expected in the forward pass of the model."),Na=d(),G=r("li"),dn=r("strong"),Aa=o("padding_side"),Sa=o(" ("),ln=r("code"),Fa=o("str"),Ca=o(`) \u2014 The default value for the side on which the model should have padding applied.
...
sequences.`),ti=d(),Se=r("div"),k(lt.$$.fragment),oi=d(),gn=r("p"),ni=o(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),ri=d(),Fe=r("div"),k(ct.$$.fragment),si=d(),kn=r("p"),ai=o("Convert a list of lists of token ids into a list of strings by calling decode."),ii=d(),ee=r("div"),k(pt.$$.fragment),di=d(),bn=r("p"),li=o("Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),ci=d(),k(Ce.$$.fragment),pi=d(),te=r("div"),k(mt.$$.fragment),mi=d(),vn=r("p"),hi=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),ui=d(),Tn=r("p"),fi=o("This implementation does not add special tokens and this method should be overridden in a subclass."),_i=d(),Oe=r("div"),k(ht.$$.fragment),gi=d(),yn=r("p"),ki=o("Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),bi=d(),We=r("div"),k(ut.$$.fragment),vi=d(),ft=r("p"),Ti=o("Converts a sequence of tokens in a single string. The most simple way to do it is "),zn=r("code"),yi=o('" ".join(tokens)'),zi=o(` but we
often want to remove sub-word tokenization artifacts at the same time.`),wi=d(),oe=r("div"),k(_t.$$.fragment),xi=d(),uo=r("p"),$i=o("Create the token type IDs corresponding to the sequences passed. "),fo=r("a"),Pi=o(`What are token type
IDs?`),Ei=d(),wn=r("p"),qi=o("Should be overridden in a subclass if the model has a special way of building those."),Bi=d(),ne=r("div"),k(gt.$$.fragment),Li=d(),xn=r("p"),Di=o(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Ii=d(),kt=r("p"),Ni=o("Similar to doing "),$n=r("code"),Ai=o("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Si=o("."),Fi=d(),re=r("div"),k(bt.$$.fragment),Ci=d(),Pn=r("p"),Oi=o("Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Wi=d(),vt=r("p"),ji=o("Same as doing "),En=r("code"),Ri=o("self.convert_tokens_to_ids(self.tokenize(text))"),Ui=o("."),Mi=d(),se=r("div"),k(Tt.$$.fragment),Vi=d(),qn=r("p"),Gi=o("Tokenize and prepare for the model a sequence or a pair of sequences."),Hi=d(),k(je.$$.fragment),Xi=d(),X=r("div"),k(yt.$$.fragment),Yi=d(),zt=r("p"),Ji=o("Instantiate a "),_o=r("a"),Ki=o("PreTrainedTokenizerBase"),Qi=o(` (or a derived class) from a predefined
tokenizer.`),Zi=d(),k(Re.$$.fragment),ed=d(),k(Ue.$$.fragment),td=d(),Me=r("div"),k(wt.$$.fragment),od=d(),ve=r("p"),nd=o(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
vocab.`),kd=d(),C=r("div"),k($t.$$.fragment),bd=d(),Sn=r("p"),vd=o(`Pad a single encoded input or a batch of encoded inputs up to predefined length or to the max sequence length
in the batch.`),Td=d(),J=r("p"),yd=o("Padding side (left/right) padding token ids are defined at the tokenizer level (with "),Fn=r("code"),zd=o("self.padding_side"),wd=o(`,
...
text followed by a call to the `),jn=r("code"),Id=o("pad"),Nd=o(" method to get a padded encoding."),Ad=d(),k(Ve.$$.fragment),Sd=d(),Ge=r("div"),k(Pt.$$.fragment),Fd=d(),R=r("p"),Cd=o(`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
...
`),Jn=r("code"),hl=o("~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),ul=o(" class method.."),fl=d(),At=r("p"),_l=o(`Warning,None This won\u2019t save modifications you may have applied to the tokenizer after the instantiation (for
instance, modifying `),Kn=r("code"),gl=o("tokenizer.do_lower_case"),kl=o(" after creation)."),bl=d(),ce=r("div"),k(St.$$.fragment),vl=d(),Qn=r("p"),Tl=o("Save only the vocabulary of the tokenizer (vocabulary + added tokens)."),yl=d(),Ft=r("p"),zl=o(`This method won\u2019t save the configuration and special token mappings of the tokenizer. Use
`),Zn=r("code"),wl=o("_save_pretrained()"),xl=o(" to save the whole state of the tokenizer."),$l=d(),Je=r("div"),k(Ct.$$.fragment),Pl=d(),Ot=r("p"),El=o("Converts a string in a sequence of tokens, replacing unknown tokens with the "),er=r("code"),ql=o("unk_token"),Bl=o("."),Ll=d(),Ke=r("div"),k(Wt.$$.fragment),Dl=d(),tr=r("p"),Il=o("Truncates a sequence pair in-place following the strategy."),Ar=d(),ye=r("h2"),Qe=r("a"),or=r("span"),k(jt.$$.fragment),Nl=d(),nr=r("span"),Al=o("SpecialTokensMixin"),Sr=d(),A=r("div"),k(Rt.$$.fragment),Sl=d(),ze=r("p"),Fl=o("A mixin derived by "),go=r("a"),Cl=o("PreTrainedTokenizer"),Ol=o(" and "),ko=r("a"),Wl=o("PreTrainedTokenizerFast"),jl=o(` to handle specific behaviors related to
...
`),fr=r("code"),Ic=o("tokenizer.cls_token"),Nc=o(", etc.) are in the vocabulary."),Ac=d(),_r=r("p"),Sc=o("Add the missing ones to the vocabulary if needed."),Fr=d(),xe=r("h2"),tt=r("a"),gr=r("span"),k(Kt.$$.fragment),Fc=d(),kr=r("span"),Cc=o("Enums and namedtuples"),Cr=d(),$e=r("div"),k(Qt.$$.fragment),Oc=d(),Pe=r("p"),Wc=o("Possible values for the "),br=r("code"),jc=o("truncation"),Rc=o(" argument in "),ot=r("a"),Uc=o("PreTrainedTokenizerBase."),vr=r("strong"),Mc=o("call"),Vc=o("()"),Gc=o(`. Useful for tab-completion in
an IDE.`),Or=d(),Ee=r("div"),k(Zt.$$.fragment),Hc=d(),Tr=r("p"),Xc=o("Character span in the original string."),Wr=d(),qe=r("div"),k(eo.$$.fragment),Yc=d(),yr=r("p"),Jc=o("Token span in an encoded string (list of tokens)."),this.h()},l(i){const w=Qm('[data-svelte="svelte-1phssyn"]',document.head);p=s(w,"META",{name:!0,content:!0}),w.forEach(t),$=l(i),f=s(i,"H1",{class:!0});var to=a(f);h=s(to,"A",{id:!0,class:!0,href:!0});var zr=a(h);x=s(zr,"SPAN",{});var wr=a(x);b(c.$$.fragment,wr),wr.forEach(t),zr.forEach(t),_=l(to),L=s(to,"SPAN",{});var xr=a(L);ge=n(xr,"Utilities for Tokenizers"),xr.forEach(t),to.forEach(t),j=l(i),D=s(i,"P",{});var M=a(D);ro=n(M,`This page lists all the utility functions used by the tokenizers, mainly the class
`),so=s(M,"A",{href:!0});var $r=a(so);ws=n($r,"PreTrainedTokenizerBase"),$r.forEach(t),xs=n(M,` that implements the common methods between
...
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),en=s(Be,"CODE",{});var gp=a(en);_a=n(gp,"None"),gp.forEach(t),ga=n(Be," if the model has no maximum input size."),Be.forEach(t),ka=l(W),F=s(W,"LI",{});var Q=a(F);tn=s(Q,"STRONG",{});var kp=a(tn);ba=n(kp,"pretrained_init_configuration"),kp.forEach(t),va=n(Q," ("),on=s(Q,"CODE",{});var bp=a(on);Ta=n(bp,"Dict[str, Dict[str, Any]]"),bp.forEach(t),ya=n(Q,`) \u2014 A dictionary with, as keys, the
`),nn=s(Q,"CODE",{});var vp=a(nn);za=n(vp,"short-cut-names"),vp.forEach(t),wa=n(Q,` of the pretrained models, and as associated values, a dictionary of specific arguments to
...
sequences.`),Ip.forEach(t),Ur.forEach(t),ti=l(g),Se=s(g,"DIV",{class:!0});var Mr=a(Se);b(lt.$$.fragment,Mr),oi=l(Mr),gn=s(Mr,"P",{});var Np=a(gn);ni=n(Np,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Np.forEach(t),Mr.forEach(t),ri=l(g),Fe=s(g,"DIV",{class:!0});var Vr=a(Fe);b(ct.$$.fragment,Vr),si=l(Vr),kn=s(Vr,"P",{});var Ap=a(kn);ai=n(Ap,"Convert a list of lists of token ids into a list of strings by calling decode."),Ap.forEach(t),Vr.forEach(t),ii=l(g),ee=s(g,"DIV",{class:!0});var zo=a(ee);b(pt.$$.fragment,zo),di=l(zo),bn=s(zo,"P",{});var Sp=a(bn);li=n(Sp,"Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),Sp.forEach(t),ci=l(zo),b(Ce.$$.fragment,zo),zo.forEach(t),pi=l(g),te=s(g,"DIV",{class:!0});var wo=a(te);b(mt.$$.fragment,wo),mi=l(wo),vn=s(wo,"P",{});var Fp=a(vn);hi=n(Fp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),Fp.forEach(t),ui=l(wo),Tn=s(wo,"P",{});var Cp=a(Tn);fi=n(Cp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Cp.forEach(t),wo.forEach(t),_i=l(g),Oe=s(g,"DIV",{class:!0});var Gr=a(Oe);b(ht.$$.fragment,Gr),gi=l(Gr),yn=s(Gr,"P",{});var Op=a(yn);ki=n(Op,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Op.forEach(t),Gr.forEach(t),bi=l(g),We=s(g,"DIV",{class:!0});var Hr=a(We);b(ut.$$.fragment,Hr),vi=l(Hr),ft=s(Hr,"P",{});var Xr=a(ft);Ti=n(Xr,"Converts a sequence of tokens in a single string. The most simple way to do it is "),zn=s(Xr,"CODE",{});var Wp=a(zn);yi=n(Wp,'" ".join(tokens)'),Wp.forEach(t),zi=n(Xr,` but we
often want to remove sub-word tokenization artifacts at the same time.`),Xr.forEach(t),Hr.forEach(t),wi=l(g),oe=s(g,"DIV",{class:!0});var xo=a(oe);b(_t.$$.fragment,xo),xi=l(xo),uo=s(xo,"P",{});var Kc=a(uo);$i=n(Kc,"Create the token type IDs corresponding to the sequences passed. "),fo=s(Kc,"A",{href:!0});var jp=a(fo);Pi=n(jp,`What are token type
IDs?`),jp.forEach(t),Kc.forEach(t),Ei=l(xo),wn=s(xo,"P",{});var Rp=a(wn);qi=n(Rp,"Should be overridden in a subclass if the model has a special way of building those."),Rp.forEach(t),xo.forEach(t),Bi=l(g),ne=s(g,"DIV",{class:!0});var $o=a(ne);b(gt.$$.fragment,$o),Li=l($o),xn=s($o,"P",{});var Up=a(xn);Di=n(Up,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Up.forEach(t),Ii=l($o),kt=s($o,"P",{});var Yr=a(kt);Ni=n(Yr,"Similar to doing "),$n=s(Yr,"CODE",{});var Mp=a($n);Ai=n(Mp,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Mp.forEach(t),Si=n(Yr,"."),Yr.forEach(t),$o.forEach(t),Fi=l(g),re=s(g,"DIV",{class:!0});var Po=a(re);b(bt.$$.fragment,Po),Ci=l(Po),Pn=s(Po,"P",{});var Vp=a(Pn);Oi=n(Vp,"Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Vp.forEach(t),Wi=l(Po),vt=s(Po,"P",{});var Jr=a(vt);ji=n(Jr,"Same as doing "),En=s(Jr,"CODE",{});var Gp=a(En);Ri=n(Gp,"self.convert_tokens_to_ids(self.tokenize(text))"),Gp.forEach(t),Ui=n(Jr,"."),Jr.forEach(t),Po.forEach(t),Mi=l(g),se=s(g,"DIV",{class:!0});var Eo=a(se);b(Tt.$$.fragment,Eo),Vi=l(Eo),qn=s(Eo,"P",{});var Hp=a(qn);Gi=n(Hp,"Tokenize and prepare for the model a sequence or a pair of sequences."),Hp.forEach(t),Hi=l(Eo),b(je.$$.fragment,Eo),Eo.forEach(t),Xi=l(g),X=s(g,"DIV",{class:!0});var nt=a(X);b(yt.$$.fragment,nt),Yi=l(nt),zt=s(nt,"P",{});var Kr=a(zt);Ji=n(Kr,"Instantiate a "),_o=s(Kr,"A",{href:!0});var Xp=a(_o);Ki=n(Xp,"PreTrainedTokenizerBase"),Xp.forEach(t),Qi=n(Kr,` (or a derived class) from a predefined
tokenizer.`),Kr.forEach(t),Zi=l(nt),b(Re.$$.fragment,nt),ed=l(nt),b(Ue.$$.fragment,nt),nt.forEach(t),td=l(g),Me=s(g,"DIV",{class:!0});var Qr=a(Me);b(wt.$$.fragment,Qr),od=l(Qr),ve=s(Qr,"P",{});var qo=a(ve);nd=n(qo,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
vocab.`),no.forEach(t),Bo.forEach(t),kd=l(g),C=s(g,"DIV",{class:!0});var me=a(C);b($t.$$.fragment,me),bd=l(me),Sn=s(me,"P",{});var tm=a(Sn);vd=n(tm,`Pad a single encoded input or a batch of encoded inputs up to predefined length or to the max sequence length
in the batch.`),tm.forEach(t),Td=l(me),J=s(me,"P",{});var rt=a(J);yd=n(rt,"Padding side (left/right) padding token ids are defined at the tokenizer level (with "),Fn=s(rt,"CODE",{});var om=a(Fn);zd=n(om,"self.padding_side"),om.forEach(t),wd=n(rt,`,
...
text followed by a call to the `),jn=s(Lo,"CODE",{});var am=a(jn);Id=n(am,"pad"),am.forEach(t),Nd=n(Lo," method to get a padded encoding."),Lo.forEach(t),Ad=l(me),b(Ve.$$.fragment,me),me.forEach(t),Sd=l(g),Ge=s(g,"DIV",{class:!0});var Zr=a(Ge);b(Pt.$$.fragment,Zr),Fd=l(Zr),R=s(Zr,"P",{});var he=a(R);Cd=n(he,`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
adds special tokens, truncates sequences if overflowing while taking into account the special tokens and
...
`),Jn=s(ns,"CODE",{});var fm=a(Jn);hl=n(fm,"~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),fm.forEach(t),ul=n(ns," class method.."),ns.forEach(t),fl=l(st),At=s(st,"P",{});var rs=a(At);_l=n(rs,`Warning,None This won\u2019t save modifications you may have applied to the tokenizer after the instantiation (for
instance, modifying `),Kn=s(rs,"CODE",{});var _m=a(Kn);gl=n(_m,"tokenizer.do_lower_case"),_m.forEach(t),kl=n(rs," after creation)."),rs.forEach(t),st.forEach(t),bl=l(g),ce=s(g,"DIV",{class:!0});var No=a(ce);b(St.$$.fragment,No),vl=l(No),Qn=s(No,"P",{});var gm=a(Qn);Tl=n(gm,"Save only the vocabulary of the tokenizer (vocabulary + added tokens)."),gm.forEach(t),yl=l(No),Ft=s(No,"P",{});var ss=a(Ft);zl=n(ss,`This method won\u2019t save the configuration and special token mappings of the tokenizer. Use
`),Zn=s(ss,"CODE",{});var km=a(Zn);wl=n(km,"_save_pretrained()"),km.forEach(t),xl=n(ss," to save the whole state of the tokenizer."),ss.forEach(t),No.forEach(t),$l=l(g),Je=s(g,"DIV",{class:!0});var as=a(Je);b(Ct.$$.fragment,as),Pl=l(as),Ot=s(as,"P",{});var is=a(Ot);El=n(is,"Converts a string in a sequence of tokens, replacing unknown tokens with the "),er=s(is,"CODE",{});var bm=a(er);ql=n(bm,"unk_token"),bm.forEach(t),Bl=n(is,"."),is.forEach(t),as.forEach(t),Ll=l(g),Ke=s(g,"DIV",{class:!0});var ds=a(Ke);b(Wt.$$.fragment,ds),Dl=l(ds),tr=s(ds,"P",{});var vm=a(tr);Il=n(vm,"Truncates a sequence pair in-place following the strategy."),vm.forEach(t),ds.forEach(t),g.forEach(t),Ar=l(i),ye=s(i,"H2",{class:!0});var ls=a(ye);Qe=s(ls,"A",{id:!0,class:!0,href:!0});var Tm=a(Qe);or=s(Tm,"SPAN",{});var ym=a(or);b(jt.$$.fragment,ym),ym.forEach(t),Tm.forEach(t),Nl=l(ls),nr=s(ls,"SPAN",{});var zm=a(nr);Al=n(zm,"SpecialTokensMixin"),zm.forEach(t),ls.forEach(t),Sr=l(i),A=s(i,"DIV",{class:!0});var ue=a(A);b(Rt.$$.fragment,ue),Sl=l(ue),ze=s(ue,"P",{});var Ao=a(ze);Fl=n(Ao,"A mixin derived by "),go=s(Ao,"A",{href:!0});var wm=a(go);Cl=n(wm,"PreTrainedTokenizer"),wm.forEach(t),Ol=n(Ao," and "),ko=s(Ao,"A",{href:!0});var xm=a(ko);Wl=n(xm,"PreTrainedTokenizerFast"),xm.forEach(t),jl=n(Ao,` to handle specific behaviors related to
special tokens. In particular, this class hold the attributes which can be used to directly access these special
...
`),pr=s(fe,"CODE",{});var Am=a(pr);fc=n(Am,"'</s>'"),Am.forEach(t),_c=n(fe,")."),fe.forEach(t),gc=l(N),b(Ze.$$.fragment,N),N.forEach(t),kc=l(ue),O=s(ue,"DIV",{class:!0});var _e=a(O);b(Xt.$$.fragment,_e),bc=l(_e),mr=s(_e,"P",{});var Sm=a(mr);vc=n(Sm,`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
it with indices starting from length of the current vocabulary and and will be isolated before the tokenization
algorithm is applied. Added tokens and tokens from the vocabulary of the tokenization algorithm are therefore
not treated in the same way.`),Sm.forEach(t),Tc=l(_e),hr=s(_e,"P",{});var Fm=a(hr);yc=n(Fm,`Note, when adding new tokens to the vocabulary, you should make sure to also resize the token embedding matrix
of the model so that its embedding matrix matches the tokenizer.`),Fm.forEach(t),zc=l(_e),Yt=s(_e,"P",{});var us=a(Yt);wc=n(us,"In order to do that, please use the "),To=s(us,"A",{href:!0});var Cm=a(To);xc=n(Cm,"resize_token_embeddings()"),Cm.forEach(t),$c=n(us," method."),us.forEach(t),Pc=l(_e),b(et.$$.fragment,_e),_e.forEach(t),Ec=l(ue),pe=s(ue,"DIV",{class:!0});var So=a(pe);b(Jt.$$.fragment,So),qc=l(So),we=s(So,"P",{});var Fo=a(we);Bc=n(Fo,"Make sure that all the special tokens attributes of the tokenizer ("),ur=s(Fo,"CODE",{});var Om=a(ur);Lc=n(Om,"tokenizer.mask_token"),Om.forEach(t),Dc=n(Fo,`,
`),fr=s(Fo,"CODE",{});var Wm=a(fr);Ic=n(Wm,"tokenizer.cls_token"),Wm.forEach(t),Nc=n(Fo,", etc.) are in the vocabulary."),Fo.forEach(t),Ac=l(So),_r=s(So,"P",{});var jm=a(_r);Sc=n(jm,"Add the missing ones to the vocabulary if needed."),jm.forEach(t),So.forEach(t),ue.forEach(t),Fr=l(i),xe=s(i,"H2",{class:!0});var fs=a(xe);tt=s(fs,"A",{id:!0,class:!0,href:!0});var Rm=a(tt);gr=s(Rm,"SPAN",{});var Um=a(gr);b(Kt.$$.fragment,Um),Um.forEach(t),Rm.forEach(t),Fc=l(fs),kr=s(fs,"SPAN",{});var Mm=a(kr);Cc=n(Mm,"Enums and namedtuples"),Mm.forEach(t),fs.forEach(t),Cr=l(i),$e=s(i,"DIV",{class:!0});var _s=a($e);b(Qt.$$.fragment,_s),Oc=l(_s),Pe=s(_s,"P",{});var Co=a(Pe);Wc=n(Co,"Possible values for the "),br=s(Co,"CODE",{});var Vm=a(br);jc=n(Vm,"truncation"),Vm.forEach(t),Rc=n(Co," argument in "),ot=s(Co,"A",{href:!0});var gs=a(ot);Uc=n(gs,"PreTrainedTokenizerBase."),vr=s(gs,"STRONG",{});var Gm=a(vr);Mc=n(Gm,"call"),Gm.forEach(t),Vc=n(gs,"()"),gs.forEach(t),Gc=n(Co,`. Useful for tab-completion in
an IDE.`),Co.forEach(t),_s.forEach(t),Or=l(i),Ee=s(i,"DIV",{class:!0});var ks=a(Ee);b(Zt.$$.fragment,ks),Hc=l(ks),Tr=s(ks,"P",{});var Hm=a(Tr);Xc=n(Hm,"Character span in the original string."),Hm.forEach(t),ks.forEach(t),Wr=l(i),qe=s(i,"DIV",{class:!0});var bs=a(qe);b(eo.$$.fragment,bs),Yc=l(bs),yr=s(bs,"P",{});var Xm=a(yr);Jc=n(Xm,"Token span in an encoded string (list of tokens)."),Xm.forEach(t),bs.forEach(t),this.h()},h(){m(p,"name","hf:doc:metadata"),m(p,"content",JSON.stringify(ch)),m(h,"id","utilities-for-tokenizers"),m(h,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(h,"href","#utilities-for-tokenizers"),m(f,"class","relative group"),m(so,"href","/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase"),m(ao,"href","/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(io,"href","/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),m(lo,"href","/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.SpecialTokensMixin"),m(Ie,"id","transformers.PreTrainedTokenizerBase"),m(Ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ie,"href","#transformers.PreTrainedTokenizerBase"),m(ke,"class","relative group"),m(po,"href","/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(mo,"href","/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),m(ho,"href","/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained"),m(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(fo,"href","../glossary#token-type-ids"),m(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(_o,"href","/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase"),m(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(u,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Qe,"id","transformers.SpecialTokensMixin"),m(Qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Qe,"href","#transformers.SpecialTokensMixin"),m(ye,"class","relative group"),m(go,"href","/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(ko,"href","/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),m(bo,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings"),m(vo,"href","/docs/transformers/v4.24.0/en/model_doc/bert#transformers.BertTokenizer"),m(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(To,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings"),m(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(tt,"id","transformers.tokenization_utils_base.TruncationStrategy"),m(tt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(tt,"href","#transformers.tokenization_utils_base.TruncationStrategy"),m(xe,"class","relative group"),m(ot,"href","/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"),m($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,w){e(document.head,p),P(i,$,w),P(i,f,w),e(f,h),e(h,x),v(c,x,null),e(f,_),e(f,L),e(L,ge),P(i,j,w),P(i,D,w),e(D,ro),e(D,so),e(so,ws),e(D,xs),e(D,ao),e(ao,$s),e(D,Ps),e(D,io),e(io,Es),e(D,qs),e(D,lo),e(lo,Bs),e(D,Ls),P(i,Dr,w),P(i,co,w),e(co,Ds),P(i,Ir,w),P(i,ke,w),e(ke,Ie),e(Ie,Oo),v(at,Oo,null),e(ke,Is),e(ke,Wo),e(Wo,Ns),P(i,Nr,w),P(i,u,w),v(it,u,null),e(u,As),e(u,be),e(be,Ss),e(be,po),e(po,Fs),e(be,Cs),e(be,mo),e(mo,Os),e(be,Ws),e(u,js),e(u,jo),e(jo,Rs),e(u,Us),e(u,Ro),e(Ro,Ms),e(u,Vs),e(u,I),e(I,Z),e(Z,Uo),e(Uo,Gs),e(Z,Hs),e(Z,Mo),e(Mo,Xs),e(Z,Ys),e(Z,Vo),e(Vo,Js),e(Z,Ks),e(I,Qs),e(I,S),e(S,Go),e(Go,Zs),e(S,ea),e(S,Ho),e(Ho,ta),e(S,oa),e(S,Xo),e(Xo,na),e(S,ra),e(S,Yo),e(Yo,sa),e(S,aa),e(S,Jo),e(Jo,ia),e(S,da),e(I,la),e(I,V),e(V,Ko),e(Ko,ca),e(V,pa),e(V,Qo),e(Qo,ma),e(V,ha),e(V,Zo),e(Zo,ua),e(V,fa),e(V,en),e(en,_a),e(V,ga),e(I,ka),e(I,F),e(F,tn),e(tn,ba),e(F,va),e(F,on),e(on,Ta),e(F,ya),e(F,nn),e(nn,za),e(F,wa),e(F,rn),e(rn,xa),e(F,$a),e(F,ho),e(ho,Pa),e(F,Ea),e(I,qa),e(I,Ne),e(Ne,sn),e(sn,Ba),e(Ne,La),e(Ne,an),e(an,Da),e(Ne,Ia),e(I,Na),e(I,G),e(G,dn),e(dn,Aa),e(G,Sa),e(G,ln),e(ln,Fa),e(G,Ca),e(G,cn),e(cn,Oa),e(G,Wa),e(G,pn),e(pn,ja),e(G,Ra),e(I,Ua),e(I,H),e(H,mn),e(mn,Ma),e(H,Va),e(H,hn),e(hn,Ga),e(H,Ha),e(H,un),e(un,Xa),e(H,Ya),e(H,fn),e(fn,Ja),e(H,Ka),e(u,Qa),e(u,Ae),v(dt,Ae,null),e(Ae,Za),e(Ae,_n),e(_n,ei),e(u,ti),e(u,Se),v(lt,Se,null),e(Se,oi),e(Se,gn),e(gn,ni),e(u,ri),e(u,Fe),v(ct,Fe,null),e(Fe,si),e(Fe,kn),e(kn,ai),e(u,ii),e(u,ee),v(pt,ee,null),e(ee,di),e(ee,bn),e(bn,li),e(ee,ci),v(Ce,ee,null),e(u,pi),e(u,te),v(mt,te,null),e(te,mi),e(te,vn),e(vn,hi),e(te,ui),e(te,Tn),e(Tn,fi),e(u,_i),e(u,Oe),v(ht,Oe,null),e(Oe,gi),e(Oe,yn),e(yn,ki),e(u,bi),e(u,We),v(ut,We,null),e(We,vi),e(We,ft),e(ft,Ti),e(ft,zn),e(zn,yi),e(ft,zi),e(u,wi),e(u,oe),v(_t,oe,null),e(oe,xi),e(oe,uo),e(uo,$i),e(uo,fo),e(fo,Pi),e(oe,Ei),e(oe,wn),e(wn,qi),e(u,Bi),e(u,ne),v(gt,ne,null),e(ne,Li),e(ne,xn),e(xn,Di),e(ne,Ii),e(ne,kt),e(kt,Ni),e(kt,$n),e($n,Ai),e(kt,Si),e(u,Fi),e(u,re),v(bt,re,null),e(re,Ci),e(re,Pn),e(Pn,Oi),e(re,Wi),e(re,vt),e(vt,ji),e(vt,En),e(En,Ri),e(vt,Ui),e(u,Mi),e(u,se),v(Tt,se,null),e(se,Vi),e(se,qn),e(qn,Gi),e(se,Hi),v(je,se,null),e(u,Xi),e(u,X),v(yt,X,null),e(X,Yi),e(X,zt),e(zt,Ji),e(zt,_o),e(_o,Ki),e(zt,Qi),e(X,Zi),v(Re,X,null),e(X,ed),v(Ue,X,null),e(u,td),e(u,Me),v(wt,Me,null),e(Me,od),e(Me,ve),e(ve,nd),e(ve,Bn),e(Bn,rd),e(ve,sd),e(ve,Ln),e(Ln,ad),e(ve,id),e(u,dd),e(u,ae),v(xt,ae,null),e(ae,ld),e(ae,Dn),e(Dn,cd),e(ae,pd),e(ae,ie),e(ie,In),e(In,md),e(ie,hd),e(ie,Nn),e(Nn,ud),e(ie,fd),e(ie,An),e(An,_d),e(ie,gd),e(u,kd),e(u,C),v($t,C,null),e(C,bd),e(C,Sn),e(Sn,vd),e(C,Td),e(C,J),e(J,yd),e(J,Fn),e(Fn,zd),e(J,wd),e(J,Cn),e(Cn,xd),e(J,$d),e(J,On),e(On,Pd),e(J,Ed),e(C,qd),e(C,Te),e(Te,Bd),e(Te,Wn),e(Wn,Ld),e(Te,Dd),e(Te,jn),e(jn,Id),e(Te,Nd),e(C,Ad),v(Ve,C,null),e(u,Sd),e(u,Ge),v(Pt,Ge,null),e(Ge,Fd),e(Ge,R),e(R,Cd),e(R,Rn),e(Rn,Od),e(R,Wd),e(R,Un),e(Un,jd),e(R,Rd),e(R,Mn),e(Mn,Ud),e(R,Md),e(R,Vn),e(Vn,Vd),e(R,Gd),e(u,Hd),e(u,He),v(Et,He,null),e(He,Xd),e(He,Gn),e(Gn,Yd),e(u,Jd),e(u,de),v(qt,de,null),e(de,Kd),e(de,Bt),e(Bt,Qd),e(Bt,Hn),e(Hn,Zd),e(Bt,el),e(de,tl),v(Xe,de,null),e(u,ol),e(u,le),v(Lt,le,null),e(le,nl),e(le,Dt),e(Dt,rl),e(Dt,Xn),e(Xn,sl),e(Dt,al),e(le,il),v(Ye,le,null),e(u,dl),e(u,Y),v(It,Y,null),e(Y,ll),e(Y,Yn),e(Yn,cl),e(Y,pl),e(Y,Nt),e(Nt,ml),e(Nt,Jn),e(Jn,hl),e(Nt,ul),e(Y,fl),e(Y,At),e(At,_l),e(At,Kn),e(Kn,gl),e(At,kl),e(u,bl),e(u,ce),v(St,ce,null),e(ce,vl),e(ce,Qn),e(Qn,Tl),e(ce,yl),e(ce,Ft),e(Ft,zl),e(Ft,Zn),e(Zn,wl),e(Ft,xl),e(u,$l),e(u,Je),v(Ct,Je,null),e(Je,Pl),e(Je,Ot),e(Ot,El),e(Ot,er),e(er,ql),e(Ot,Bl),e(u,Ll),e(u,Ke),v(Wt,Ke,null),e(Ke,Dl),e(Ke,tr),e(tr,Il),P(i,Ar,w),P(i,ye,w),e(ye,Qe),e(Qe,or),v(jt,or,null),e(ye,Nl),e(ye,nr),e(nr,Al),P(i,Sr,w),P(i,A,w),v(Rt,A,null),e(A,Sl),e(A,ze),e(ze,Fl),e(ze,go),e(go,Cl),e(ze,Ol),e(ze,ko),e(ko,Wl),e(ze,jl),e(A,Rl),e(A,B),v(Ut,B,null),e(B,Ul),e(B,rr),e(rr,Ml),e(B,Vl),e(B,sr),e(sr,Gl),e(B,Hl),e(B,Mt),e(Mt,Xl),e(Mt,bo),e(bo,Yl),e(Mt,Jl),e(B,Kl),e(B,Vt),e(Vt,Ql),e(Vt,ar),e(ar,Zl),e(Vt,ec),e(B,tc),e(B,Gt),e(Gt,ir),e(ir,oc),e(Gt,nc),e(Gt,Ht),e(Ht,rc),e(Ht,dr),e(dr,sc),e(Ht,ac),e(B,ic),e(B,U),e(U,dc),e(U,vo),e(vo,lc),e(U,cc),e(U,lr),e(lr,pc),e(U,mc),e(U,cr),e(cr,hc),e(U,uc),e(U,pr),e(pr,fc),e(U,_c),e(B,gc),v(Ze,B,null),e(A,kc),e(A,O),v(Xt,O,null),e(O,bc),e(O,mr),e(mr,vc),e(O,Tc),e(O,hr),e(hr,yc),e(O,zc),e(O,Yt),e(Yt,wc),e(Yt,To),e(To,xc),e(Yt,$c),e(O,Pc),v(et,O,null),e(A,Ec),e(A,pe),v(Jt,pe,null),e(pe,qc),e(pe,we),e(we,Bc),e(we,ur),e(ur,Lc),e(we,Dc),e(we,fr),e(fr,Ic),e(we,Nc),e(pe,Ac),e(pe,_r),e(_r,Sc),P(i,Fr,w),P(i,xe,w),e(xe,tt),e(tt,gr),v(Kt,gr,null),e(xe,Fc),e(xe,kr),e(kr,Cc),P(i,Cr,w),P(i,$e,w),v(Qt,$e,null),e($e,Oc),e($e,Pe),e(Pe,Wc),e(Pe,br),e(br,jc),e(Pe,Rc),e(Pe,ot),e(ot,Uc),e(ot,vr),e(vr,Mc),e(ot,Vc),e(Pe,Gc),P(i,Or,w),P(i,Ee,w),v(Zt,Ee,null),e(Ee,Hc),e(Ee,Tr),e(Tr,Xc),P(i,Wr,w),P(i,qe,w),v(eo,qe,null),e(qe,Yc),e(qe,yr),e(yr,Jc),jr=!0},p(i,[w]){const to={};w&2&&(to.$$scope={dirty:w,ctx:i}),Ce.$set(to);const zr={};w&2&&(zr.$$scope={dirty:w,ctx:i}),je.$set(zr);const wr={};w&2&&(wr.$$scope={dirty:w,ctx:i}),Re.$set(wr);const xr={};w&2&&(xr.$$scope={dirty:w,ctx:i}),Ue.$set(xr);const M={};w&2&&(M.$$scope={dirty:w,ctx:i}),Ve.$set(M);const $r={};w&2&&($r.$$scope={dirty:w,ctx:i}),Xe.$set($r);const Pr={};w&2&&(Pr.$$scope={dirty:w,ctx:i}),Ye.$set(Pr);const Er={};w&2&&(Er.$$scope={dirty:w,ctx:i}),Ze.$set(Er);const qr={};w&2&&(qr.$$scope={dirty:w,ctx:i}),et.$set(qr)},i(i){jr||(T(c.$$.fragment,i),T(at.$$.fragment,i),T(it.$$.fragment,i),T(dt.$$.fragment,i),T(lt.$$.fragment,i),T(ct.$$.fragment,i),T(pt.$$.fragment,i),T(Ce.$$.fragment,i),T(mt.$$.fragment,i),T(ht.$$.fragment,i),T(ut.$$.fragment,i),T(_t.$$.fragment,i),T(gt.$$.fragment,i),T(bt.$$.fragment,i),T(Tt.$$.fragment,i),T(je.$$.fragment,i),T(yt.$$.fragment,i),T(Re.$$.fragment,i),T(Ue.$$.fragment,i),T(wt.$$.fragment,i),T(xt.$$.fragment,i),T($t.$$.fragment,i),T(Ve.$$.fragment,i),T(Pt.$$.fragment,i),T(Et.$$.fragment,i),T(qt.$$.fragment,i),T(Xe.$$.fragment,i),T(Lt.$$.fragment,i),T(Ye.$$.fragment,i),T(It.$$.fragment,i),T(St.$$.fragment,i),T(Ct.$$.fragment,i),T(Wt.$$.fragment,i),T(jt.$$.fragment,i),T(Rt.$$.fragment,i),T(Ut.$$.fragment,i),T(Ze.$$.fragment,i),T(Xt.$$.fragment,i),T(et.$$.fragment,i),T(Jt.$$.fragment,i),T(Kt.$$.fragment,i),T(Qt.$$.fragment,i),T(Zt.$$.fragment,i),T(eo.$$.fragment,i),jr=!0)},o(i){y(c.$$.fragment,i),y(at.$$.fragment,i),y(it.$$.fragment,i),y(dt.$$.fragment,i),y(lt.$$.fragment,i),y(ct.$$.fragment,i),y(pt.$$.fragment,i),y(Ce.$$.fragment,i),y(mt.$$.fragment,i),y(ht.$$.fragment,i),y(ut.$$.fragment,i),y(_t.$$.fragment,i),y(gt.$$.fragment,i),y(bt.$$.fragment,i),y(Tt.$$.fragment,i),y(je.$$.fragment,i),y(yt.$$.fragment,i),y(Re.$$.fragment,i),y(Ue.$$.fragment,i),y(wt.$$.fragment,i),y(xt.$$.fragment,i),y($t.$$.fragment,i),y(Ve.$$.fragment,i),y(Pt.$$.fragment,i),y(Et.$$.fragment,i),y(qt.$$.fragment,i),y(Xe.$$.fragment,i),y(Lt.$$.fragment,i),y(Ye.$$.fragment,i),y(It.$$.fragment,i),y(St.$$.fragment,i),y(Ct.$$.fragment,i),y(Wt.$$.fragment,i),y(jt.$$.fragment,i),y(Rt.$$.fragment,i),y(Ut.$$.fragment,i),y(Ze.$$.fragment,i),y(Xt.$$.fragment,i),y(et.$$.fragment,i),y(Jt.$$.fragment,i),y(Kt.$$.fragment,i),y(Qt.$$.fragment,i),y(Zt.$$.fragment,i),y(eo.$$.fragment,i),jr=!1},d(i){t(p),i&&t($),i&&t(f),z(c),i&&t(j),i&&t(D),i&&t(Dr),i&&t(co),i&&t(Ir),i&&t(ke),z(at),i&&t(Nr),i&&t(u),z(it),z(dt),z(lt),z(ct),z(pt),z(Ce),z(mt),z(ht),z(ut),z(_t),z(gt),z(bt),z(Tt),z(je),z(yt),z(Re),z(Ue),z(wt),z(xt),z($t),z(Ve),z(Pt),z(Et),z(qt),z(Xe),z(Lt),z(Ye),z(It),z(St),z(Ct),z(Wt),i&&t(Ar),i&&t(ye),z(jt),i&&t(Sr),i&&t(A),z(Rt),z(Ut),z(Ze),z(Xt),z(et),z(Jt),i&&t(Fr),i&&t(xe),z(Kt),i&&t(Cr),i&&t($e),z(Qt),i&&t(Or),i&&t(Ee),z(Zt),i&&t(Wr),i&&t(qe),z(eo)}}}const ch={local:"utilities-for-tokenizers",sections:[{local:"transformers.PreTrainedTokenizerBase",title:"PreTrainedTokenizerBase"},{local:"transformers.SpecialTokensMixin",title:"SpecialTokensMixin"},{local:"transformers.tokenization_utils_base.TruncationStrategy",title:"Enums and namedtuples"}],title:"Utilities for Tokenizers"};function ph(q){return Zm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class kh extends Ym{constructor(p){super();Jm(this,p,ph,lh,Km,{})}}export{kh as default,ch as metadata};
