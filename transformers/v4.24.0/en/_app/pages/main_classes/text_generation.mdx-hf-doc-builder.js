import{S as Km,i as Zm,s as Xm,e as a,k as m,w as v,t,M as Jm,c as r,d as o,m as g,a as i,x as k,h as n,b as h,G as e,g as x,y,q as j,o as L,B as M,v as Qm,L as me}from"../../chunks/vendor-hf-doc-builder.js";import{T as Vm}from"../../chunks/Tip-hf-doc-builder.js";import{D as B}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ge}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as aa}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as pe}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ym(w){let d,f,u,c,_,s,p,W,S,H,A;return{c(){d=a("p"),f=t("Apart from "),u=a("code"),c=t("inputs"),_=t(`, all the arguments below will default to the value of the attribute of the same name as
...
should be prefixed with *decoder</em>*.`,name:"forced_decoder_ids"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_utils.py#L969",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput"
...
<ul>
<li><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
>SampleDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
>BeamSearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
>SampleEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_utils.py#L2085",returnDescription:`
<p><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
...
An instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_utils.py#L2313",returnDescription:`
<p><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
An derived instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_utils.py#L2564",returnDescription:`
...
A derived instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_utils.py#L2873",returnDescription:`
<p><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific keyword arguments will be forwarded to the <code>forward</code> function of the model.
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_utils.py#L1758",returnDescription:`
...
An derived instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_utils.py#L3189",returnDescription:`
<p><a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_utils.py#L3551",returnDescription:`
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/v4.24.0/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"forced_decoder_ids"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_tf_utils.py#L379",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput"
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If the model
is an encoder-decoder model, encoder specific kwargs should not be prefixed and decoder specific kwargs
should be prefixed with *decoder</em>*. Also accepts <code>encoder_outputs</code> to skip encoder part.`,name:"params"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/generation_flax_utils.py#L211",returnDescription:`
<p><a
  href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput"
>ModelOutput</a>.</p>
`}}),kt=new Vm({props:{warning:!0,$$slots:{default:[pg]},$$scope:{ctx:w}}}),yt=new pe({props:{anchor:"transformers.generation_flax_utils.FlaxGenerationMixin.generate.example",$$slots:{default:[mg]},$$scope:{ctx:w}}}),{c(){d=a("meta"),f=m(),u=a("h1"),c=a("a"),_=a("span"),v(s.$$.fragment),p=m(),W=a("span"),S=t("Generation"),H=m(),A=a("p"),D=t("Each framework has a generate method for auto-regressive text generation implemented in their respective "),T=a("code"),Te=t("GenerationMixin"),Ee=t(" class:"),be=m(),xe=a("ul"),Oe=a("li"),ra=t("PyTorch "),pn=a("a"),ia=t("generate()"),la=t(" is implemented in "),mn=a("a"),da=t("GenerationMixin"),ca=t("."),pa=m(),Ge=a("li"),ma=t("TensorFlow "),gn=a("a"),ga=t("generate()"),ua=t(" is implemented in "),un=a("a"),_a=t("TFGenerationMixin"),ha=t("."),fa=m(),Se=a("li"),ba=t("Flax/JAX "),_n=a("a"),xa=t("generate()"),va=t(" is implemented in "),hn=a("a"),ka=t("FlaxGenerationMixin"),ya=t("."),qs=m(),qe=a("h2"),rt=a("a"),Vn=a("span"),v(wt.$$.fragment),ja=m(),Kn=a("span"),La=t("GenerationMixin"),Fs=m(),$=a("div"),v($t.$$.fragment),Ma=m(),Tt=a("p"),wa=t("A class containing all functions for auto-regressive text generation, to be used as a mixin in "),fn=a("a"),$a=t("PreTrainedModel"),Ta=t("."),Ea=m(),Et=a("p"),Oa=t("The class exposes "),bn=a("a"),Ga=t("generate()"),Sa=t(", which can be used for:"),qa=m(),q=a("ul"),R=a("li"),Zn=a("em"),Fa=t("greedy decoding"),Aa=t(" by calling "),xn=a("a"),za=t("greedy_search()"),Pa=t(" if "),Xn=a("code"),Da=t("num_beams=1"),Na=t(` and
`),Jn=a("code"),Ca=t("do_sample=False"),Ia=t("."),Wa=m(),ue=a("li"),Qn=a("em"),Ba=t("contrastive search"),Ha=t(" by calling "),vn=a("a"),Ra=t("contrastive_search()"),Ua=t(" if "),Yn=a("code"),Va=t("penalty_alpha>0"),Ka=t(`
and `),eo=a("code"),Za=t("top_k>1"),Xa=m(),U=a("li"),to=a("em"),Ja=t("multinomial sampling"),Qa=t(" by calling "),kn=a("a"),Ya=t("sample()"),er=t(" if "),no=a("code"),tr=t("num_beams=1"),nr=t(` and
...
`),lo=a("code"),xr=t("num_beams>1"),vr=t(" and "),co=a("code"),kr=t("do_sample=True"),yr=t("."),jr=m(),Z=a("li"),po=a("em"),Lr=t("diverse beam-search decoding"),Mr=t(" by calling "),Ln=a("a"),wr=t("group_beam_search()"),$r=t(`, if
...
if `),_o=a("code"),Pr=t("constraints!=None"),Dr=t(" or "),ho=a("code"),Nr=t("force_words_ids!=None"),Cr=t("."),Ir=m(),O=a("div"),v(Ot.$$.fragment),Wr=m(),fo=a("p"),Br=t(`Generates sequences of token ids for models with a language modeling head. The method supports the following
...
`),vo=a("code"),Jr=t("do_sample=False"),Qr=t("."),Yr=m(),_e=a("li"),ko=a("em"),ei=t("contrastive search"),ti=t(" by calling "),$n=a("a"),ni=t("contrastive_search()"),oi=t(` if
...
`),wo=a("code"),ui=t("do_sample=True"),_i=t("."),hi=m(),Y=a("li"),$o=a("em"),fi=t("beam-search decoding"),bi=t(" by calling "),En=a("a"),xi=t("beam_search()"),vi=t(" if "),To=a("code"),ki=t("num_beams>1"),yi=t(` and
...
`),Do=a("code"),Xi=t("force_words_ids!=None"),Ji=t("."),Qi=m(),v(it.$$.fragment),Yi=m(),Gt=a("p"),el=t("Most of these parameters are explained in more detail in "),St=a("a"),tl=t(`this blog
post`),nl=t("."),ol=m(),No=a("p"),sl=t("Examples:"),al=m(),v(lt.$$.fragment),rl=m(),v(dt.$$.fragment),il=m(),v(ct.$$.fragment),ll=m(),ve=a("div"),v(qt.$$.fragment),dl=m(),Ft=a("p"),cl=t("Generates sequences of token ids for models with a language modeling head using "),Co=a("strong"),pl=t("greedy decoding"),ml=t(` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),gl=m(),v(pt.$$.fragment),ul=m(),ke=a("div"),v(At.$$.fragment),_l=m(),zt=a("p"),hl=t("Generates sequences of token ids for models with a language modeling head using "),Io=a("strong"),fl=t("multinomial sampling"),bl=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),xl=m(),v(mt.$$.fragment),vl=m(),ye=a("div"),v(Pt.$$.fragment),kl=m(),Dt=a("p"),yl=t("Generates sequences of token ids for models with a language modeling head using "),Wo=a("strong"),jl=t("beam search decoding"),Ll=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ml=m(),v(gt.$$.fragment),wl=m(),je=a("div"),v(Nt.$$.fragment),$l=m(),Ct=a("p"),Tl=t("Generates sequences of token ids for models with a language modeling head using "),Bo=a("strong"),El=t(`beam search multinomial
sampling`),Ol=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Gl=m(),v(ut.$$.fragment),Sl=m(),Le=a("div"),v(It.$$.fragment),ql=m(),Wt=a("p"),Fl=t("Generates sequences of token ids for models with a language modeling head using "),Ho=a("strong"),Al=t("contrastive search"),zl=t(` and can
be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Pl=m(),v(_t.$$.fragment),Dl=m(),Me=a("div"),v(Bt.$$.fragment),Nl=m(),Ht=a("p"),Cl=t("Generates sequences of token ids for models with a language modeling head using "),Ro=a("strong"),Il=t(`diverse beam search
decoding`),Wl=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Bl=m(),v(ht.$$.fragment),Hl=m(),we=a("div"),v(Rt.$$.fragment),Rl=m(),Ut=a("p"),Ul=t("Generates sequences of token ids for models with a language modeling head using "),Uo=a("strong"),Vl=t(`constrained beam search
decoding`),Kl=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Zl=m(),v(ft.$$.fragment),As=m(),Fe=a("h2"),bt=a("a"),Vo=a("span"),v(Vt.$$.fragment),Xl=m(),Ko=a("span"),Jl=t("TFGenerationMixin"),zs=m(),he=a("div"),v(Kt.$$.fragment),Ql=m(),Zt=a("p"),Yl=t("A class containing all of the functions supporting generation, to be used as a mixin in "),qn=a("a"),ed=t("TFPreTrainedModel"),td=t("."),nd=m(),z=a("div"),v(Xt.$$.fragment),od=m(),Zo=a("p"),sd=t(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
post`),vd=t("."),kd=m(),v(xt.$$.fragment),Ps=m(),Ae=a("h2"),vt=a("a"),Qo=a("span"),v(tn.$$.fragment),yd=m(),Yo=a("span"),jd=t("FlaxGenerationMixin"),Ds=m(),N=a("div"),v(nn.$$.fragment),Ld=m(),on=a("p"),Md=t(`A class containing all functions for auto-regressive text generation, to be used as a mixin in
...
and `),ps=a("code"),oc=t("do_sample=False"),sc=t("."),ac=m(),P=a("div"),v(an.$$.fragment),rc=m(),ms=a("p"),ic=t(`Generates sequences of token ids for models with a language modeling head. The method supports the following
...
`),_s=a("code"),gc=t("num_beams=1"),uc=t(" and "),hs=a("code"),_c=t("do_sample=False"),hc=t("."),fc=m(),ie=a("li"),fs=a("em"),bc=t("multinomial sampling"),xc=t(" by calling "),bs=a("code"),vc=t("_sample()"),kc=t(" if "),xs=a("code"),yc=t("num_beams=1"),jc=t(`
and `),vs=a("code"),Lc=t("do_sample=True"),Mc=t("."),wc=m(),le=a("li"),ks=a("em"),$c=t("beam-search decoding"),Tc=t(" by calling "),ys=a("code"),Ec=t("~generation_utils.FlaxGenerationMixin._beam_search"),Oc=t(" if "),js=a("code"),Gc=t("num_beams>1"),Sc=t(`
and `),Ls=a("code"),qc=t("do_sample=False"),Fc=t("."),Ac=m(),v(kt.$$.fragment),zc=m(),rn=a("p"),Pc=t("Most of these parameters are explained in more detail in "),ln=a("a"),Dc=t(`this blog
post`),Nc=t("."),Cc=m(),v(yt.$$.fragment),this.h()},l(l){const b=Jm('[data-svelte="svelte-1phssyn"]',document.head);d=r(b,"META",{name:!0,content:!0}),b.forEach(o),f=g(l),u=r(l,"H1",{class:!0});var dn=i(u);c=r(dn,"A",{id:!0,class:!0,href:!0});var Ms=i(c);_=r(Ms,"SPAN",{});var ws=i(_);k(s.$$.fragment,ws),ws.forEach(o),Ms.forEach(o),p=g(dn),W=r(dn,"SPAN",{});var $s=i(W);S=n($s,"Generation"),$s.forEach(o),dn.forEach(o),H=g(l),A=r(l,"P",{});var cn=i(A);D=n(cn,"Each framework has a generate method for auto-regressive text generation implemented in their respective "),T=r(cn,"CODE",{});var Ts=i(T);Te=n(Ts,"GenerationMixin"),Ts.forEach(o),Ee=n(cn," class:"),cn.forEach(o),be=g(l),xe=r(l,"UL",{});var De=i(xe);Oe=r(De,"LI",{});var Ne=i(Oe);ra=n(Ne,"PyTorch "),pn=r(Ne,"A",{href:!0});var Es=i(pn);ia=n(Es,"generate()"),Es.forEach(o),la=n(Ne," is implemented in "),mn=r(Ne,"A",{href:!0});var Os=i(mn);da=n(Os,"GenerationMixin"),Os.forEach(o),ca=n(Ne,"."),Ne.forEach(o),pa=g(De),Ge=r(De,"LI",{});var Ce=i(Ge);ma=n(Ce,"TensorFlow "),gn=r(Ce,"A",{href:!0});var Gs=i(gn);ga=n(Gs,"generate()"),Gs.forEach(o),ua=n(Ce," is implemented in "),un=r(Ce,"A",{href:!0});var Ss=i(un);_a=n(Ss,"TFGenerationMixin"),Ss.forEach(o),ha=n(Ce,"."),Ce.forEach(o),fa=g(De),Se=r(De,"LI",{});var Ie=i(Se);ba=n(Ie,"Flax/JAX "),_n=r(Ie,"A",{href:!0});var Ic=i(_n);xa=n(Ic,"generate()"),Ic.forEach(o),va=n(Ie," is implemented in "),hn=r(Ie,"A",{href:!0});var Wc=i(hn);ka=n(Wc,"FlaxGenerationMixin"),Wc.forEach(o),ya=n(Ie,"."),Ie.forEach(o),De.forEach(o),qs=g(l),qe=r(l,"H2",{class:!0});var Cs=i(qe);rt=r(Cs,"A",{id:!0,class:!0,href:!0});var Bc=i(rt);Vn=r(Bc,"SPAN",{});var Hc=i(Vn);k(wt.$$.fragment,Hc),Hc.forEach(o),Bc.forEach(o),ja=g(Cs),Kn=r(Cs,"SPAN",{});var Rc=i(Kn);La=n(Rc,"GenerationMixin"),Rc.forEach(o),Cs.forEach(o),Fs=g(l),$=r(l,"DIV",{class:!0});var E=i($);k($t.$$.fragment,E),Ma=g(E),Tt=r(E,"P",{});var Is=i(Tt);wa=n(Is,"A class containing all functions for auto-regressive text generation, to be used as a mixin in "),fn=r(Is,"A",{href:!0});var Uc=i(fn);$a=n(Uc,"PreTrainedModel"),Uc.forEach(o),Ta=n(Is,"."),Is.forEach(o),Ea=g(E),Et=r(E,"P",{});var Ws=i(Et);Oa=n(Ws,"The class exposes "),bn=r(Ws,"A",{href:!0});var Vc=i(bn);Ga=n(Vc,"generate()"),Vc.forEach(o),Sa=n(Ws,", which can be used for:"),Ws.forEach(o),qa=g(E),q=r(E,"UL",{});var C=i(q);R=r(C,"LI",{});var We=i(R);Zn=r(We,"EM",{});var Kc=i(Zn);Fa=n(Kc,"greedy decoding"),Kc.forEach(o),Aa=n(We," by calling "),xn=r(We,"A",{href:!0});var Zc=i(xn);za=n(Zc,"greedy_search()"),Zc.forEach(o),Pa=n(We," if "),Xn=r(We,"CODE",{});var Xc=i(Xn);Da=n(Xc,"num_beams=1"),Xc.forEach(o),Na=n(We,` and
`),Jn=r(We,"CODE",{});var Jc=i(Jn);Ca=n(Jc,"do_sample=False"),Jc.forEach(o),Ia=n(We,"."),We.forEach(o),Wa=g(C),ue=r(C,"LI",{});var jt=i(ue);Qn=r(jt,"EM",{});var Qc=i(Qn);Ba=n(Qc,"contrastive search"),Qc.forEach(o),Ha=n(jt," by calling "),vn=r(jt,"A",{href:!0});var Yc=i(vn);Ra=n(Yc,"contrastive_search()"),Yc.forEach(o),Ua=n(jt," if "),Yn=r(jt,"CODE",{});var ep=i(Yn);Va=n(ep,"penalty_alpha>0"),ep.forEach(o),Ka=n(jt,`
and `),eo=r(jt,"CODE",{});var tp=i(eo);Za=n(tp,"top_k>1"),tp.forEach(o),jt.forEach(o),Xa=g(C),U=r(C,"LI",{});var Be=i(U);to=r(Be,"EM",{});var np=i(to);Ja=n(np,"multinomial sampling"),np.forEach(o),Qa=n(Be," by calling "),kn=r(Be,"A",{href:!0});var op=i(kn);Ya=n(op,"sample()"),op.forEach(o),er=n(Be," if "),no=r(Be,"CODE",{});var sp=i(no);tr=n(sp,"num_beams=1"),sp.forEach(o),nr=n(Be,` and
...
if `),_o=r(Ve,"CODE",{});var vp=i(_o);Pr=n(vp,"constraints!=None"),vp.forEach(o),Dr=n(Ve," or "),ho=r(Ve,"CODE",{});var kp=i(ho);Nr=n(kp,"force_words_ids!=None"),kp.forEach(o),Cr=n(Ve,"."),Ve.forEach(o),C.forEach(o),Ir=g(E),O=r(E,"DIV",{class:!0});var G=i(O);k(Ot.$$.fragment,G),Wr=g(G),fo=r(G,"P",{});var yp=i(fo);Br=n(yp,`Generates sequences of token ids for models with a language modeling head. The method supports the following
...
`),vo=r(Ke,"CODE",{});var wp=i(vo);Jr=n(wp,"do_sample=False"),wp.forEach(o),Qr=n(Ke,"."),Ke.forEach(o),Yr=g(I),_e=r(I,"LI",{});var Lt=i(_e);ko=r(Lt,"EM",{});var $p=i(ko);ei=n($p,"contrastive search"),$p.forEach(o),ti=n(Lt," by calling "),$n=r(Lt,"A",{href:!0});var Tp=i($n);ni=n(Tp,"contrastive_search()"),Tp.forEach(o),oi=n(Lt,` if
...
`),Do=r(Ye,"CODE",{});var Xp=i(Do);Xi=n(Xp,"force_words_ids!=None"),Xp.forEach(o),Ji=n(Ye,"."),Ye.forEach(o),I.forEach(o),Qi=g(G),k(it.$$.fragment,G),Yi=g(G),Gt=r(G,"P",{});var Bs=i(Gt);el=n(Bs,"Most of these parameters are explained in more detail in "),St=r(Bs,"A",{href:!0,rel:!0});var Jp=i(St);tl=n(Jp,`this blog
post`),Jp.forEach(o),nl=n(Bs,"."),Bs.forEach(o),ol=g(G),No=r(G,"P",{});var Qp=i(No);sl=n(Qp,"Examples:"),Qp.forEach(o),al=g(G),k(lt.$$.fragment,G),rl=g(G),k(dt.$$.fragment,G),il=g(G),k(ct.$$.fragment,G),G.forEach(o),ll=g(E),ve=r(E,"DIV",{class:!0});var Pn=i(ve);k(qt.$$.fragment,Pn),dl=g(Pn),Ft=r(Pn,"P",{});var Hs=i(Ft);cl=n(Hs,"Generates sequences of token ids for models with a language modeling head using "),Co=r(Hs,"STRONG",{});var Yp=i(Co);pl=n(Yp,"greedy decoding"),Yp.forEach(o),ml=n(Hs,` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Hs.forEach(o),gl=g(Pn),k(pt.$$.fragment,Pn),Pn.forEach(o),ul=g(E),ke=r(E,"DIV",{class:!0});var Dn=i(ke);k(At.$$.fragment,Dn),_l=g(Dn),zt=r(Dn,"P",{});var Rs=i(zt);hl=n(Rs,"Generates sequences of token ids for models with a language modeling head using "),Io=r(Rs,"STRONG",{});var em=i(Io);fl=n(em,"multinomial sampling"),em.forEach(o),bl=n(Rs,` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Rs.forEach(o),xl=g(Dn),k(mt.$$.fragment,Dn),Dn.forEach(o),vl=g(E),ye=r(E,"DIV",{class:!0});var Nn=i(ye);k(Pt.$$.fragment,Nn),kl=g(Nn),Dt=r(Nn,"P",{});var Us=i(Dt);yl=n(Us,"Generates sequences of token ids for models with a language modeling head using "),Wo=r(Us,"STRONG",{});var tm=i(Wo);jl=n(tm,"beam search decoding"),tm.forEach(o),Ll=n(Us,` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Us.forEach(o),Ml=g(Nn),k(gt.$$.fragment,Nn),Nn.forEach(o),wl=g(E),je=r(E,"DIV",{class:!0});var Cn=i(je);k(Nt.$$.fragment,Cn),$l=g(Cn),Ct=r(Cn,"P",{});var Vs=i(Ct);Tl=n(Vs,"Generates sequences of token ids for models with a language modeling head using "),Bo=r(Vs,"STRONG",{});var nm=i(Bo);El=n(nm,`beam search multinomial
sampling`),nm.forEach(o),Ol=n(Vs," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Vs.forEach(o),Gl=g(Cn),k(ut.$$.fragment,Cn),Cn.forEach(o),Sl=g(E),Le=r(E,"DIV",{class:!0});var In=i(Le);k(It.$$.fragment,In),ql=g(In),Wt=r(In,"P",{});var Ks=i(Wt);Fl=n(Ks,"Generates sequences of token ids for models with a language modeling head using "),Ho=r(Ks,"STRONG",{});var om=i(Ho);Al=n(om,"contrastive search"),om.forEach(o),zl=n(Ks,` and can
be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ks.forEach(o),Pl=g(In),k(_t.$$.fragment,In),In.forEach(o),Dl=g(E),Me=r(E,"DIV",{class:!0});var Wn=i(Me);k(Bt.$$.fragment,Wn),Nl=g(Wn),Ht=r(Wn,"P",{});var Zs=i(Ht);Cl=n(Zs,"Generates sequences of token ids for models with a language modeling head using "),Ro=r(Zs,"STRONG",{});var sm=i(Ro);Il=n(sm,`diverse beam search
decoding`),sm.forEach(o),Wl=n(Zs," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Zs.forEach(o),Bl=g(Wn),k(ht.$$.fragment,Wn),Wn.forEach(o),Hl=g(E),we=r(E,"DIV",{class:!0});var Bn=i(we);k(Rt.$$.fragment,Bn),Rl=g(Bn),Ut=r(Bn,"P",{});var Xs=i(Ut);Ul=n(Xs,"Generates sequences of token ids for models with a language modeling head using "),Uo=r(Xs,"STRONG",{});var am=i(Uo);Vl=n(am,`constrained beam search
decoding`),am.forEach(o),Kl=n(Xs," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Xs.forEach(o),Zl=g(Bn),k(ft.$$.fragment,Bn),Bn.forEach(o),E.forEach(o),As=g(l),Fe=r(l,"H2",{class:!0});var Js=i(Fe);bt=r(Js,"A",{id:!0,class:!0,href:!0});var rm=i(bt);Vo=r(rm,"SPAN",{});var im=i(Vo);k(Vt.$$.fragment,im),im.forEach(o),rm.forEach(o),Xl=g(Js),Ko=r(Js,"SPAN",{});var lm=i(Ko);Jl=n(lm,"TFGenerationMixin"),lm.forEach(o),Js.forEach(o),zs=g(l),he=r(l,"DIV",{class:!0});var Hn=i(he);k(Kt.$$.fragment,Hn),Ql=g(Hn),Zt=r(Hn,"P",{});var Qs=i(Zt);Yl=n(Qs,"A class containing all of the functions supporting generation, to be used as a mixin in "),qn=r(Qs,"A",{href:!0});var dm=i(qn);ed=n(dm,"TFPreTrainedModel"),dm.forEach(o),td=n(Qs,"."),Qs.forEach(o),nd=g(Hn),z=r(Hn,"DIV",{class:!0});var de=i(z);k(Xt.$$.fragment,de),od=g(de),Zo=r(de,"P",{});var cm=i(Zo);sd=n(cm,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
post`),_m.forEach(o),vd=n(ea,"."),ea.forEach(o),kd=g(de),k(xt.$$.fragment,de),de.forEach(o),Hn.forEach(o),Ps=g(l),Ae=r(l,"H2",{class:!0});var ta=i(Ae);vt=r(ta,"A",{id:!0,class:!0,href:!0});var hm=i(vt);Qo=r(hm,"SPAN",{});var fm=i(Qo);k(tn.$$.fragment,fm),fm.forEach(o),hm.forEach(o),yd=g(ta),Yo=r(ta,"SPAN",{});var bm=i(Yo);jd=n(bm,"FlaxGenerationMixin"),bm.forEach(o),ta.forEach(o),Ds=g(l),N=r(l,"DIV",{class:!0});var $e=i(N);k(nn.$$.fragment,$e),Ld=g($e),on=r($e,"P",{});var na=i(on);Md=n(na,`A class containing all functions for auto-regressive text generation, to be used as a mixin in
`),An=r(na,"A",{href:!0});var xm=i(An);wd=n(xm,"FlaxPreTrainedModel"),xm.forEach(o),$d=n(na,"."),na.forEach(o),Td=g($e),sn=r($e,"P",{});var oa=i(sn);Ed=n(oa,"The class exposes "),zn=r(oa,"A",{href:!0});var vm=i(zn);Od=n(vm,"generate()"),vm.forEach(o),Gd=n(oa,", which can be used for:"),oa.forEach(o),Sd=g($e),ze=r($e,"UL",{});var Rn=i(ze);oe=r(Rn,"LI",{});var et=i(oe);es=r(et,"EM",{});var km=i(es);qd=n(km,"greedy decoding"),km.forEach(o),Fd=n(et," by calling "),ts=r(et,"CODE",{});var ym=i(ts);Ad=n(ym,"_greedy_search()"),ym.forEach(o),zd=n(et,` if
...
and `),ps=r(nt,"CODE",{});var Sm=i(ps);oc=n(Sm,"do_sample=False"),Sm.forEach(o),sc=n(nt,"."),nt.forEach(o),Rn.forEach(o),ac=g($e),P=r($e,"DIV",{class:!0});var ce=i(P);k(an.$$.fragment,ce),rc=g(ce),ms=r(ce,"P",{});var qm=i(ms);ic=n(qm,`Generates sequences of token ids for models with a language modeling head. The method supports the following
...
`),_s=r(ot,"CODE",{});var zm=i(_s);gc=n(zm,"num_beams=1"),zm.forEach(o),uc=n(ot," and "),hs=r(ot,"CODE",{});var Pm=i(hs);_c=n(Pm,"do_sample=False"),Pm.forEach(o),hc=n(ot,"."),ot.forEach(o),fc=g(Un),ie=r(Un,"LI",{});var st=i(ie);fs=r(st,"EM",{});var Dm=i(fs);bc=n(Dm,"multinomial sampling"),Dm.forEach(o),xc=n(st," by calling "),bs=r(st,"CODE",{});var Nm=i(bs);vc=n(Nm,"_sample()"),Nm.forEach(o),kc=n(st," if "),xs=r(st,"CODE",{});var Cm=i(xs);yc=n(Cm,"num_beams=1"),Cm.forEach(o),jc=n(st,`
and `),vs=r(st,"CODE",{});var Im=i(vs);Lc=n(Im,"do_sample=True"),Im.forEach(o),Mc=n(st,"."),st.forEach(o),wc=g(Un),le=r(Un,"LI",{});var at=i(le);ks=r(at,"EM",{});var Wm=i(ks);$c=n(Wm,"beam-search decoding"),Wm.forEach(o),Tc=n(at," by calling "),ys=r(at,"CODE",{});var Bm=i(ys);Ec=n(Bm,"~generation_utils.FlaxGenerationMixin._beam_search"),Bm.forEach(o),Oc=n(at," if "),js=r(at,"CODE",{});var Hm=i(js);Gc=n(Hm,"num_beams>1"),Hm.forEach(o),Sc=n(at,`
and `),Ls=r(at,"CODE",{});var Rm=i(Ls);qc=n(Rm,"do_sample=False"),Rm.forEach(o),Fc=n(at,"."),at.forEach(o),Un.forEach(o),Ac=g(ce),k(kt.$$.fragment,ce),zc=g(ce),rn=r(ce,"P",{});var sa=i(rn);Pc=n(sa,"Most of these parameters are explained in more detail in "),ln=r(sa,"A",{href:!0,rel:!0});var Um=i(ln);Dc=n(Um,`this blog
post`),Um.forEach(o),Nc=n(sa,"."),sa.forEach(o),Cc=g(ce),k(yt.$$.fragment,ce),ce.forEach(o),$e.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(ug)),h(c,"id","generation"),h(c,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(c,"href","#generation"),h(u,"class","relative group"),h(pn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(mn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin"),h(gn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin.generate"),h(un,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin"),h(_n,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(hn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin"),h(rt,"id","transformers.generation_utils.GenerationMixin"),h(rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(rt,"href","#transformers.generation_utils.GenerationMixin"),h(qe,"class","relative group"),h(fn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),h(bn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(xn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(vn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.contrastive_search"),h(kn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(yn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(jn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(Ln,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(Mn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(wn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h($n,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.contrastive_search"),h(Tn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(En,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(On,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(Gn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(Sn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(St,"href","https://huggingface.co/blog/how-to-generate"),h(St,"rel","nofollow"),h(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(we,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h($,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(bt,"id","transformers.generation_tf_utils.TFGenerationMixin"),h(bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(bt,"href","#transformers.generation_tf_utils.TFGenerationMixin"),h(Fe,"class","relative group"),h(qn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.TFPreTrainedModel"),h(Qt,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),h(Qt,"rel","nofollow"),h(Fn,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(en,"href","https://huggingface.co/blog/how-to-generate"),h(en,"rel","nofollow"),h(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(vt,"id","transformers.generation_flax_utils.FlaxGenerationMixin"),h(vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(vt,"href","#transformers.generation_flax_utils.FlaxGenerationMixin"),h(Ae,"class","relative group"),h(An,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(zn,"href","/docs/transformers/v4.24.0/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(ln,"href","https://huggingface.co/blog/how-to-generate"),h(ln,"rel","nofollow"),h(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(l,b){e(document.head,d),x(l,f,b),x(l,u,b),e(u,c),e(c,_),y(s,_,null),e(u,p),e(u,W),e(W,S),x(l,H,b),x(l,A,b),e(A,D),e(A,T),e(T,Te),e(A,Ee),x(l,be,b),x(l,xe,b),e(xe,Oe),e(Oe,ra),e(Oe,pn),e(pn,ia),e(Oe,la),e(Oe,mn),e(mn,da),e(Oe,ca),e(xe,pa),e(xe,Ge),e(Ge,ma),e(Ge,gn),e(gn,ga),e(Ge,ua),e(Ge,un),e(un,_a),e(Ge,ha),e(xe,fa),e(xe,Se),e(Se,ba),e(Se,_n),e(_n,xa),e(Se,va),e(Se,hn),e(hn,ka),e(Se,ya),x(l,qs,b),x(l,qe,b),e(qe,rt),e(rt,Vn),y(wt,Vn,null),e(qe,ja),e(qe,Kn),e(Kn,La),x(l,Fs,b),x(l,$,b),y($t,$,null),e($,Ma),e($,Tt),e(Tt,wa),e(Tt,fn),e(fn,$a),e(Tt,Ta),e($,Ea),e($,Et),e(Et,Oa),e(Et,bn),e(bn,Ga),e(Et,Sa),e($,qa),e($,q),e(q,R),e(R,Zn),e(Zn,Fa),e(R,Aa),e(R,xn),e(xn,za),e(R,Pa),e(R,Xn),e(Xn,Da),e(R,Na),e(R,Jn),e(Jn,Ca),e(R,Ia),e(q,Wa),e(q,ue),e(ue,Qn),e(Qn,Ba),e(ue,Ha),e(ue,vn),e(vn,Ra),e(ue,Ua),e(ue,Yn),e(Yn,Va),e(ue,Ka),e(ue,eo),e(eo,Za),e(q,Xa),e(q,U),e(U,to),e(to,Ja),e(U,Qa),e(U,kn),e(kn,Ya),e(U,er),e(U,no),e(no,tr),e(U,nr),e(U,oo),e(oo,or),e(U,sr),e(q,ar),e(q,V),e(V,so),e(so,rr),e(V,ir),e(V,yn),e(yn,lr),e(V,dr),e(V,ao),e(ao,cr),e(V,pr),e(V,ro),e(ro,mr),e(V,gr),e(q,ur),e(q,K),e(K,io),e(io,_r),e(K,hr),e(K,jn),e(jn,fr),e(K,br),e(K,lo),e(lo,xr),e(K,vr),e(K,co),e(co,kr),e(K,yr),e(q,jr),e(q,Z),e(Z,po),e(po,Lr),e(Z,Mr),e(Z,Ln),e(Ln,wr),e(Z,$r),e(Z,mo),e(mo,Tr),e(Z,Er),e(Z,go),e(go,Or),e(Z,Gr),e(q,Sr),e(q,X),e(X,uo),e(uo,qr),e(X,Fr),e(X,Mn),e(Mn,Ar),e(X,zr),e(X,_o),e(_o,Pr),e(X,Dr),e(X,ho),e(ho,Nr),e(X,Cr),e($,Ir),e($,O),y(Ot,O,null),e(O,Wr),e(O,fo),e(fo,Br),e(O,Hr),e(O,F),e(F,J),e(J,bo),e(bo,Rr),e(J,Ur),e(J,wn),e(wn,Vr),e(J,Kr),e(J,xo),e(xo,Zr),e(J,Xr),e(J,vo),e(vo,Jr),e(J,Qr),e(F,Yr),e(F,_e),e(_e,ko),e(ko,ei),e(_e,ti),e(_e,$n),e($n,ni),e(_e,oi),e(_e,yo),e(yo,si),e(_e,ai),e(_e,jo),e(jo,ri),e(F,ii),e(F,Q),e(Q,Lo),e(Lo,li),e(Q,di),e(Q,Tn),e(Tn,ci),e(Q,pi),e(Q,Mo),e(Mo,mi),e(Q,gi),e(Q,wo),e(wo,ui),e(Q,_i),e(F,hi),e(F,Y),e(Y,$o),e($o,fi),e(Y,bi),e(Y,En),e(En,xi),e(Y,vi),e(Y,To),e(To,ki),e(Y,yi),e(Y,Eo),e(Eo,ji),e(Y,Li),e(F,Mi),e(F,ee),e(ee,Oo),e(Oo,wi),e(ee,$i),e(ee,On),e(On,Ti),e(ee,Ei),e(ee,Go),e(Go,Oi),e(ee,Gi),e(ee,So),e(So,Si),e(ee,qi),e(F,Fi),e(F,te),e(te,qo),e(qo,Ai),e(te,zi),e(te,Gn),e(Gn,Pi),e(te,Di),e(te,Fo),e(Fo,Ni),e(te,Ci),e(te,Ao),e(Ao,Ii),e(te,Wi),e(F,Bi),e(F,ne),e(ne,zo),e(zo,Hi),e(ne,Ri),e(ne,Sn),e(Sn,Ui),e(ne,Vi),e(ne,Po),e(Po,Ki),e(ne,Zi),e(ne,Do),e(Do,Xi),e(ne,Ji),e(O,Qi),y(it,O,null),e(O,Yi),e(O,Gt),e(Gt,el),e(Gt,St),e(St,tl),e(Gt,nl),e(O,ol),e(O,No),e(No,sl),e(O,al),y(lt,O,null),e(O,rl),y(dt,O,null),e(O,il),y(ct,O,null),e($,ll),e($,ve),y(qt,ve,null),e(ve,dl),e(ve,Ft),e(Ft,cl),e(Ft,Co),e(Co,pl),e(Ft,ml),e(ve,gl),y(pt,ve,null),e($,ul),e($,ke),y(At,ke,null),e(ke,_l),e(ke,zt),e(zt,hl),e(zt,Io),e(Io,fl),e(zt,bl),e(ke,xl),y(mt,ke,null),e($,vl),e($,ye),y(Pt,ye,null),e(ye,kl),e(ye,Dt),e(Dt,yl),e(Dt,Wo),e(Wo,jl),e(Dt,Ll),e(ye,Ml),y(gt,ye,null),e($,wl),e($,je),y(Nt,je,null),e(je,$l),e(je,Ct),e(Ct,Tl),e(Ct,Bo),e(Bo,El),e(Ct,Ol),e(je,Gl),y(ut,je,null),e($,Sl),e($,Le),y(It,Le,null),e(Le,ql),e(Le,Wt),e(Wt,Fl),e(Wt,Ho),e(Ho,Al),e(Wt,zl),e(Le,Pl),y(_t,Le,null),e($,Dl),e($,Me),y(Bt,Me,null),e(Me,Nl),e(Me,Ht),e(Ht,Cl),e(Ht,Ro),e(Ro,Il),e(Ht,Wl),e(Me,Bl),y(ht,Me,null),e($,Hl),e($,we),y(Rt,we,null),e(we,Rl),e(we,Ut),e(Ut,Ul),e(Ut,Uo),e(Uo,Vl),e(Ut,Kl),e(we,Zl),y(ft,we,null),x(l,As,b),x(l,Fe,b),e(Fe,bt),e(bt,Vo),y(Vt,Vo,null),e(Fe,Xl),e(Fe,Ko),e(Ko,Jl),x(l,zs,b),x(l,he,b),y(Kt,he,null),e(he,Ql),e(he,Zt),e(Zt,Yl),e(Zt,qn),e(qn,ed),e(Zt,td),e(he,nd),e(he,z),y(Xt,z,null),e(z,od),e(z,Zo),e(Zo,sd),e(z,ad),e(z,Jt),e(Jt,rd),e(Jt,Qt),e(Qt,id),e(Jt,ld),e(z,dd),e(z,fe),e(fe,cd),e(fe,Xo),e(Xo,pd),e(fe,md),e(fe,Jo),e(Jo,gd),e(fe,ud),e(fe,Fn),e(Fn,_d),e(fe,hd),e(z,fd),e(z,Yt),e(Yt,bd),e(Yt,en),e(en,xd),e(Yt,vd),e(z,kd),y(xt,z,null),x(l,Ps,b),x(l,Ae,b),e(Ae,vt),e(vt,Qo),y(tn,Qo,null),e(Ae,yd),e(Ae,Yo),e(Yo,jd),x(l,Ds,b),x(l,N,b),y(nn,N,null),e(N,Ld),e(N,on),e(on,Md),e(on,An),e(An,wd),e(on,$d),e(N,Td),e(N,sn),e(sn,Ed),e(sn,zn),e(zn,Od),e(sn,Gd),e(N,Sd),e(N,ze),e(ze,oe),e(oe,es),e(es,qd),e(oe,Fd),e(oe,ts),e(ts,Ad),e(oe,zd),e(oe,ns),e(ns,Pd),e(oe,Dd),e(oe,os),e(os,Nd),e(oe,Cd),e(ze,Id),e(ze,se),e(se,ss),e(ss,Wd),e(se,Bd),e(se,as),e(as,Hd),e(se,Rd),e(se,rs),e(rs,Ud),e(se,Vd),e(se,is),e(is,Kd),e(se,Zd),e(ze,Xd),e(ze,ae),e(ae,ls),e(ls,Jd),e(ae,Qd),e(ae,ds),e(ds,Yd),e(ae,ec),e(ae,cs),e(cs,tc),e(ae,nc),e(ae,ps),e(ps,oc),e(ae,sc),e(N,ac),e(N,P),y(an,P,null),e(P,rc),e(P,ms),e(ms,ic),e(P,lc),e(P,Pe),e(Pe,re),e(re,gs),e(gs,dc),e(re,cc),e(re,us),e(us,pc),e(re,mc),e(re,_s),e(_s,gc),e(re,uc),e(re,hs),e(hs,_c),e(re,hc),e(Pe,fc),e(Pe,ie),e(ie,fs),e(fs,bc),e(ie,xc),e(ie,bs),e(bs,vc),e(ie,kc),e(ie,xs),e(xs,yc),e(ie,jc),e(ie,vs),e(vs,Lc),e(ie,Mc),e(Pe,wc),e(Pe,le),e(le,ks),e(ks,$c),e(le,Tc),e(le,ys),e(ys,Ec),e(le,Oc),e(le,js),e(js,Gc),e(le,Sc),e(le,Ls),e(Ls,qc),e(le,Fc),e(P,Ac),y(kt,P,null),e(P,zc),e(P,rn),e(rn,Pc),e(rn,ln),e(ln,Dc),e(rn,Nc),e(P,Cc),y(yt,P,null),Ns=!0},p(l,[b]){const dn={};b&2&&(dn.$$scope={dirty:b,ctx:l}),it.$set(dn);const Ms={};b&2&&(Ms.$$scope={dirty:b,ctx:l}),lt.$set(Ms);const ws={};b&2&&(ws.$$scope={dirty:b,ctx:l}),dt.$set(ws);const $s={};b&2&&($s.$$scope={dirty:b,ctx:l}),ct.$set($s);const cn={};b&2&&(cn.$$scope={dirty:b,ctx:l}),pt.$set(cn);const Ts={};b&2&&(Ts.$$scope={dirty:b,ctx:l}),mt.$set(Ts);const De={};b&2&&(De.$$scope={dirty:b,ctx:l}),gt.$set(De);const Ne={};b&2&&(Ne.$$scope={dirty:b,ctx:l}),ut.$set(Ne);const Es={};b&2&&(Es.$$scope={dirty:b,ctx:l}),_t.$set(Es);const Os={};b&2&&(Os.$$scope={dirty:b,ctx:l}),ht.$set(Os);const Ce={};b&2&&(Ce.$$scope={dirty:b,ctx:l}),ft.$set(Ce);const Gs={};b&2&&(Gs.$$scope={dirty:b,ctx:l}),xt.$set(Gs);const Ss={};b&2&&(Ss.$$scope={dirty:b,ctx:l}),kt.$set(Ss);const Ie={};b&2&&(Ie.$$scope={dirty:b,ctx:l}),yt.$set(Ie)},i(l){Ns||(j(s.$$.fragment,l),j(wt.$$.fragment,l),j($t.$$.fragment,l),j(Ot.$$.fragment,l),j(it.$$.fragment,l),j(lt.$$.fragment,l),j(dt.$$.fragment,l),j(ct.$$.fragment,l),j(qt.$$.fragment,l),j(pt.$$.fragment,l),j(At.$$.fragment,l),j(mt.$$.fragment,l),j(Pt.$$.fragment,l),j(gt.$$.fragment,l),j(Nt.$$.fragment,l),j(ut.$$.fragment,l),j(It.$$.fragment,l),j(_t.$$.fragment,l),j(Bt.$$.fragment,l),j(ht.$$.fragment,l),j(Rt.$$.fragment,l),j(ft.$$.fragment,l),j(Vt.$$.fragment,l),j(Kt.$$.fragment,l),j(Xt.$$.fragment,l),j(xt.$$.fragment,l),j(tn.$$.fragment,l),j(nn.$$.fragment,l),j(an.$$.fragment,l),j(kt.$$.fragment,l),j(yt.$$.fragment,l),Ns=!0)},o(l){L(s.$$.fragment,l),L(wt.$$.fragment,l),L($t.$$.fragment,l),L(Ot.$$.fragment,l),L(it.$$.fragment,l),L(lt.$$.fragment,l),L(dt.$$.fragment,l),L(ct.$$.fragment,l),L(qt.$$.fragment,l),L(pt.$$.fragment,l),L(At.$$.fragment,l),L(mt.$$.fragment,l),L(Pt.$$.fragment,l),L(gt.$$.fragment,l),L(Nt.$$.fragment,l),L(ut.$$.fragment,l),L(It.$$.fragment,l),L(_t.$$.fragment,l),L(Bt.$$.fragment,l),L(ht.$$.fragment,l),L(Rt.$$.fragment,l),L(ft.$$.fragment,l),L(Vt.$$.fragment,l),L(Kt.$$.fragment,l),L(Xt.$$.fragment,l),L(xt.$$.fragment,l),L(tn.$$.fragment,l),L(nn.$$.fragment,l),L(an.$$.fragment,l),L(kt.$$.fragment,l),L(yt.$$.fragment,l),Ns=!1},d(l){o(d),l&&o(f),l&&o(u),M(s),l&&o(H),l&&o(A),l&&o(be),l&&o(xe),l&&o(qs),l&&o(qe),M(wt),l&&o(Fs),l&&o($),M($t),M(Ot),M(it),M(lt),M(dt),M(ct),M(qt),M(pt),M(At),M(mt),M(Pt),M(gt),M(Nt),M(ut),M(It),M(_t),M(Bt),M(ht),M(Rt),M(ft),l&&o(As),l&&o(Fe),M(Vt),l&&o(zs),l&&o(he),M(Kt),M(Xt),M(xt),l&&o(Ps),l&&o(Ae),M(tn),l&&o(Ds),l&&o(N),M(nn),M(an),M(kt),M(yt)}}}const ug={local:"generation",sections:[{local:"transformers.generation_utils.GenerationMixin",title:"GenerationMixin"},{local:"transformers.generation_tf_utils.TFGenerationMixin",title:"TFGenerationMixin"},{local:"transformers.generation_flax_utils.FlaxGenerationMixin",title:"FlaxGenerationMixin"}],title:"Generation"};function _g(w){return Qm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class yg extends Km{constructor(d){super();Zm(this,d,_g,gg,Xm,{})}}export{yg as default,ug as metadata};
