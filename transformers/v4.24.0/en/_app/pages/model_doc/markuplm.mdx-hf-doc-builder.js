...
<span class="hljs-string">&#x27;Niels&#x27;</span>`}}),{c(){m=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){m=r(p,"P",{});var f=i(m);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){u(p,m,f),e(m,T),u(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(m),p&&t(_),y(g,p)}}}function tx(P){let m,T,_,g,x,p,f,G,bc,Jl,Se,ct,Xs,ro,Mc,Gs,wc,Zl,qe,yc,io,xc,Tc,yn,Ec,Lc,ed,xn,qc,td,pt,Tn,lo,$c,Fc,zc,En,co,jc,Cc,od,Ln,Pc,nd,qn,Ks,Dc,sd,$n,Oc,ad,$e,le,Ac,Ys,Ic,Nc,Fn,Sc,Bc,Js,Rc,Wc,Zs,Uc,Hc,Vc,Be,Qc,zn,Xc,Gc,jn,Kc,Yc,Jc,po,Zc,ho,ep,tp,rd,ht,Ib,id,uo,op,Cn,np,ld,Fe,sp,mo,ap,rp,fo,ip,lp,dd,Re,ut,ea,go,dp,ta,cp,cd,J,pp,Pn,hp,up,Dn,mp,fp,On,gp,_p,An,kp,vp,oa,bp,Mp,pd,_o,hd,F,wp,In,yp,xp,Nn,Tp,Ep,Sn,Lp,qp,Bn,$p,Fp,na,zp,jp,sa,Cp,Pp,aa,Dp,Op,ra,Ap,Ip,ia,Np,Sp,la,Bp,Rp,ud,de,Rn,Wp,Up,ko,Hp,Vp,Wn,Qp,Xp,Un,Gp,Kp,md,Hn,Yp,fd,Vn,da,Jp,gd,Qn,Zp,_d,vo,kd,Xn,ca,eh,vd,ze,th,pa,oh,nh,ha,sh,ah,bd,bo,Md,Gn,ua,rh,wd,Z,ih,Mo,lh,dh,ma,ch,ph,fa,hh,uh,ga,mh,fh,_a,gh,_h,yd,wo,xd,Kn,ka,kh,Td,Yn,vh,Ed,yo,Ld,Jn,va,bh,qd,je,Mh,ba,wh,yh,Ma,xh,Th,$d,xo,Fd,We,mt,wa,To,Eh,ya,Lh,zd,ce,Eo,qh,Ue,$h,Zn,Fh,zh,Lo,jh,Ch,Ph,He,Dh,es,Oh,Ah,ts,Ih,Nh,Sh,ft,jd,Ve,gt,xa,qo,Bh,Ta,Rh,Cd,pe,$o,Wh,Ea,Uh,Hh,Fo,Vh,La,Qh,Xh,Gh,Ce,zo,Kh,qa,Yh,Jh,_t,Pd,Qe,kt,$a,jo,Zh,Fa,eu,Dd,K,Co,tu,S,ou,os,nu,su,za,au,ru,ja,iu,lu,Ca,du,cu,Pa,pu,hu,Da,uu,mu,ns,fu,gu,_u,Pe,Po,ku,Oa,vu,bu,Do,ss,Mu,Aa,wu,yu,as,xu,Ia,Tu,Eu,rs,Oo,Lu,vt,Ao,qu,Na,$u,Fu,is,Io,Od,Xe,bt,Sa,No,zu,Ba,ju,Ad,j,So,Cu,Ra,Pu,Du,B,ls,Ou,Au,Wa,Iu,Nu,Ua,Su,Bu,Ha,Ru,Wu,Va,Uu,Hu,Qa,Vu,Qu,ds,Xu,Gu,Ku,Xa,Yu,Ju,R,Bo,Zu,O,em,Ga,tm,om,Ka,nm,sm,Ya,am,rm,Ja,im,lm,Za,dm,cm,cs,pm,hm,er,um,mm,tr,fm,gm,_m,Y,or,Mt,nr,km,vm,sr,bm,Mm,wm,ar,wt,rr,ym,xm,ir,Tm,Em,Lm,lr,W,dr,qm,$m,cr,Fm,zm,pr,jm,Cm,hr,Pm,Dm,ps,Om,Am,ur,Im,Nm,mr,Sm,Bm,Rm,fr,De,gr,Wm,Um,_r,Hm,Vm,kr,Qm,Xm,Gm,vr,yt,br,Km,Ym,Mr,Jm,Zm,ef,wr,xt,yr,tf,of,xr,nf,sf,af,Tr,me,Er,rf,lf,Lr,df,cf,qr,pf,hf,$r,uf,mf,ff,E,gf,Fr,_f,kf,zr,vf,bf,jr,Mf,wf,Cr,yf,xf,Pr,Tf,Ef,Dr,Lf,qf,Or,$f,Ff,Ar,zf,jf,Ir,Cf,Pf,Nr,Df,Of,Sr,Af,If,Br,Nf,Sf,hs,Bf,Rf,Rr,Wf,Uf,Hf,Ge,Tt,Wr,Vf,Qf,Ur,Xf,Gf,Kf,Et,Hr,Yf,Jf,Vr,Zf,eg,tg,Lt,Qr,og,ng,Xr,sg,ag,rg,A,ig,Gr,lg,dg,Kr,cg,pg,Yr,hg,ug,Jr,mg,fg,Zr,gg,_g,us,kg,vg,ei,bg,Mg,ti,wg,yg,xg,C,oi,qt,ni,Tg,Eg,si,Lg,qg,$g,ai,$t,ri,Fg,zg,ii,jg,Cg,Pg,li,U,di,Dg,Og,ci,Ag,Ig,pi,Ng,Sg,hi,Bg,Rg,ms,Wg,Ug,ui,Hg,Vg,mi,Qg,Xg,Gg,fi,Oe,gi,Kg,Yg,_i,Jg,Zg,ki,e_,t_,o_,vi,Ft,bi,n_,s_,Mi,a_,r_,i_,wi,zt,yi,l_,d_,xi,c_,p_,h_,Ti,L,Ei,u_,m_,Li,f_,g_,qi,__,k_,$i,v_,b_,Fi,M_,w_,zi,y_,x_,ji,T_,E_,Ci,L_,q_,Pi,$_,F_,Di,z_,j_,Oi,C_,P_,Ai,D_,O_,fs,A_,I_,Ii,N_,S_,B_,Ni,jt,Si,R_,W_,Bi,U_,H_,V_,Ri,Ct,Wi,Q_,X_,Ui,G_,K_,Y_,Hi,Pt,Vi,J_,Z_,Qi,ek,tk,ok,Ae,Ro,nk,Xi,sk,ak,Wo,gs,rk,Gi,ik,lk,_s,dk,Ki,ck,pk,Dt,Uo,hk,Yi,uk,mk,Ot,Ho,fk,Vo,gk,Ji,_k,kk,vk,At,Qo,bk,Zi,Mk,Id,Ke,It,el,Xo,wk,tl,yk,Nd,te,Go,xk,ol,Tk,Ek,ks,vs,Lk,qk,$k,I,Fk,bs,zk,jk,Ms,Ck,Pk,ws,Dk,Ok,nl,Ak,Ik,sl,Nk,Sk,al,Bk,Rk,rl,Wk,Uk,il,Hk,Vk,Qk,fe,Ko,Xk,oe,Gk,ll,Kk,Yk,Yo,dl,Jk,Zk,ev,cl,tv,ov,pl,nv,sv,hl,av,rv,iv,Jo,lv,ul,dv,cv,pv,ml,hv,Sd,Ye,Nt,fl,Zo,uv,gl,mv,Bd,Ee,en,fv,tn,gv,on,_v,kv,vv,ge,nn,bv,Je,Mv,ys,wv,yv,_l,xv,Tv,Ev,St,Lv,Bt,Rd,Ze,Rt,kl,sn,qv,vl,$v,Wd,he,an,Fv,bl,zv,jv,rn,Cv,ln,Pv,Dv,Ov,_e,dn,Av,et,Iv,xs,Nv,Sv,Ml,Bv,Rv,Wv,Wt,Uv,Ut,Ud,tt,Ht,wl,cn,Hv,yl,Vv,Hd,Le,pn,Qv,ot,Xv,xl,Gv,Kv,hn,Yv,Jv,Zv,ke,un,eb,nt,tb,Ts,ob,nb,Tl,sb,ab,rb,Vt,ib,Qt,Vd,st,Xt,El,mn,lb,Ll,db,Qd,ue,fn,cb,at,pb,ql,hb,ub,$l,mb,fb,gb,gn,_b,_n,kb,vb,bb,ve,kn,Mb,rt,wb,Es,yb,xb,Fl,Tb,Eb,Lb,Gt,qb,Kt,Xd;return p=new xe({}),ro=new xe({}),go=new xe({}),_o=new Te({props:{code:`from transformers import MarkupLMFeatureExtractor, MarkupLMTokenizerFast, MarkupLMProcessor
...
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/v4.24.0/en/model_doc/markuplm#transformers.MarkupLMModel">MarkupLMModel</a>.`,name:"vocab_size"},{anchor:"transformers.MarkupLMConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
The maximum depth in xpath.`,name:"max_depth"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/configuration_markuplm.py#L30"}}),ft=new Vs({props:{anchor:"transformers.MarkupLMConfig.example",$$slots:{default:[Hy]},$$scope:{ctx:P}}}),qo=new xe({}),$o=new z({props:{name:"class transformers.MarkupLMFeatureExtractor",anchor:"transformers.MarkupLMFeatureExtractor",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/feature_extraction_markuplm.py#L33"}}),zo=new z({props:{name:"__call__",anchor:"transformers.MarkupLMFeatureExtractor.__call__",parameters:[{name:"html_strings",val:""}],parametersDescription:[{anchor:"transformers.MarkupLMFeatureExtractor.__call__.html_strings",description:`<strong>html_strings</strong> (<code>str</code>, <code>List[str]</code>) &#x2014;
The HTML string or batch of HTML strings from which to extract nodes and corresponding xpaths.`,name:"html_strings"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/feature_extraction_markuplm.py#L99",returnDescription:`
<p>A <a
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"special"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/tokenization_markuplm.py#L461",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ao=new z({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.MarkupLMTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MarkupLMTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/tokenization_markuplm_fast.py#L878",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/tokenization_markuplm_fast.py#L900",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to use <code>MarkupLMFeatureExtractor</code> to parse HTML strings into nodes and corresponding xpaths.`,name:"parse_html"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/processing_markuplm.py#L25"}}),Ko=new z({props:{name:"__call__",anchor:"transformers.MarkupLMProcessor.__call__",parameters:[{name:"html_strings",val:" = None"},{name:"nodes",val:" = None"},{name:"xpaths",val:" = None"},{name:"node_labels",val:" = None"},{name:"questions",val:" = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/processing_markuplm.py#L48"}}),Zo=new xe({}),en=new z({props:{name:"class transformers.MarkupLMModel",anchor:"transformers.MarkupLMModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.MarkupLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.24.0/en/model_doc/markuplm#transformers.MarkupLMConfig">MarkupLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/modeling_markuplm.py#L800"}}),nn=new z({props:{name:"forward",anchor:"transformers.MarkupLMModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/markuplm#transformers.MarkupLMConfig"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/modeling_markuplm.py#L1205",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/modeling_markuplm.py#L1098",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/markuplm/modeling_markuplm.py#L974",returnDescription:`
<p>A <a
...
tasks. The pre-trained model and code will be publicly available.`),sd=l(),$n=a("p"),Oc=o("Tips:"),ad=l(),$e=a("ul"),le=a("li"),Ac=o("In addition to "),Ys=a("code"),Ic=o("input_ids"),Nc=o(", "),Fn=a("a"),Sc=o("forward()"),Bc=o(" expects 2 additional inputs, namely "),Js=a("code"),Rc=o("xpath_tags_seq"),Wc=o(" and "),Zs=a("code"),Uc=o("xpath_subs_seq"),Hc=o(`.
...
(`),Dn=a("a"),mp=o("MarkupLMFeatureExtractor"),fp=o(") and a tokenizer ("),On=a("a"),gp=o("MarkupLMTokenizer"),_p=o(" or "),An=a("a"),kp=o("MarkupLMTokenizerFast"),vp=o(`). The feature extractor is
...
if you only want to handle one of the two tasks.`),pd=l(),k(_o.$$.fragment),hd=l(),F=a("p"),wp=o("In short, one can provide HTML strings (and possibly additional data) to "),In=a("a"),yp=o("MarkupLMProcessor"),xp=o(`,
...
to token-level `),na=a("code"),zp=o("input_ids"),jp=o(", "),sa=a("code"),Cp=o("attention_mask"),Pp=o(", "),aa=a("code"),Dp=o("token_type_ids"),Op=o(", "),ra=a("code"),Ap=o("xpath_subs_seq"),Ip=o(", "),ia=a("code"),Np=o("xpath_tags_seq"),Sp=o(`.
...
`),Lo=a("a"),jh=o("microsoft/markuplm-base"),Ch=o(" architecture."),Ph=l(),He=a("p"),Dh=o("Configuration objects inherit from "),es=a("a"),Oh=o("BertConfig"),Ah=o(` and can be used to control the model outputs. Read the
documentation from `),ts=a("a"),Ih=o("BertConfig"),Nh=o(" for more information."),Sh=l(),k(ft.$$.fragment),jd=l(),Ve=a("h2"),gt=a("a"),xa=a("span"),k(qo.$$.fragment),Bh=l(),Ta=a("span"),Rh=o("MarkupLMFeatureExtractor"),Cd=l(),pe=a("div"),k($o.$$.fragment),Wh=l(),Ea=a("p"),Uh=o(`Constructs a MarkupLM feature extractor. This can be used to get a list of nodes and corresponding xpaths from HTML
...
Users should refer to this superclass for more information regarding those methods.`),_u=l(),Pe=a("div"),k(Po.$$.fragment),ku=l(),Oa=a("p"),vu=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),bu=l(),Do=a("ul"),ss=a("li"),Mu=o("single sequence: "),Aa=a("code"),wu=o("<s> X </s>"),yu=l(),as=a("li"),xu=o("pair of sequences: "),Ia=a("code"),Tu=o("<s> A </s></s> B </s>"),Eu=l(),rs=a("div"),k(Oo.$$.fragment),Lu=l(),vt=a("div"),k(Ao.$$.fragment),qu=l(),Na=a("p"),$u=o(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),Fu=l(),is=a("div"),k(Io.$$.fragment),Od=l(),Xe=a("h2"),bt=a("a"),Sa=a("span"),k(No.$$.fragment),zu=l(),Ba=a("span"),ju=o("MarkupLMTokenizerFast"),Ad=l(),j=a("div"),k(So.$$.fragment),Cu=l(),Ra=a("p"),Pu=o("Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE)."),Du=l(),B=a("p"),ls=a("a"),Ou=o("MarkupLMTokenizerFast"),Au=o(" can be used to turn HTML strings into to token-level "),Wa=a("code"),Iu=o("input_ids"),Nu=o(", "),Ua=a("code"),Su=o("attention_mask"),Bu=o(`,
...
contains most of the main methods.`),Ku=l(),Xa=a("p"),Yu=o("Users should refer to this superclass for more information regarding those methods."),Ju=l(),R=a("div"),k(Bo.$$.fragment),Zu=l(),O=a("p"),em=o("add_special_tokens ("),Ga=a("code"),tm=o("bool"),om=o(", "),Ka=a("em"),nm=o("optional"),sm=o(", defaults to "),Ya=a("code"),am=o("True"),rm=o(`):
...
lengths).
truncation (`),pr=a("code"),jm=o("bool"),Cm=o(", "),hr=a("code"),Pm=o("str"),Dm=o(" or "),ps=a("a"),Om=o("TruncationStrategy"),Am=o(", "),ur=a("em"),Im=o("optional"),Nm=o(", defaults to "),mr=a("code"),Sm=o("False"),Bm=o(`):
...
acceptable input length for the model if that argument is not provided.`),Pg=l(),li=a("li"),U=a("p"),di=a("code"),Dg=o("False"),Og=o(" or "),ci=a("code"),Ag=o("'do_not_pad'"),Ig=o(` (default): No padding (i.e., can output a batch with sequences of different
lengths).
...
Activates and controls truncation. Accepts the following values:`),Gg=l(),fi=a("li"),Oe=a("p"),gi=a("code"),Kg=o("True"),Yg=o(" or "),_i=a("code"),Jg=o("'longest_first'"),Zg=o(": Truncate to a maximum length specified with the argument "),ki=a("code"),e_=o("max_length"),t_=o(` or
to the maximum acceptable input length for the model if that argument is not provided. This will
truncate token by token, removing a token from the longest sequence in the pair if a pair of
...
make use of token type ids, therefore a list of zeros is returned.`),mk=l(),Ot=a("div"),k(Ho.$$.fragment),fk=l(),Vo=a("p"),gk=o(`Tokenize and prepare for the model a sequence or a pair of sequences. .. warning:: This method is deprecated,
`),Ji=a("code"),_k=o("__call__"),kk=o(" should be used instead."),vk=l(),At=a("div"),k(Qo.$$.fragment),bk=l(),Zi=a("p"),Mk=o(`Given the xpath expression of one particular node (like \u201C/html/body/div/li[1]/div/span[2]\u201D), return a list of
tag IDs and corresponding subscripts, taking into account max depth.`),Id=l(),Ke=a("h2"),It=a("a"),el=a("span"),k(Xo.$$.fragment),wk=l(),tl=a("span"),yk=o("MarkupLMProcessor"),Nd=l(),te=a("div"),k(Go.$$.fragment),xk=l(),ol=a("p"),Tk=o(`Constructs a MarkupLM processor which combines a MarkupLM feature extractor and a MarkupLM tokenizer into a single
processor.`),Ek=l(),ks=a("p"),vs=a("a"),Lk=o("MarkupLMProcessor"),qk=o(" offers all the functionalities you need to prepare data for the model."),$k=l(),I=a("p"),Fk=o("It first uses "),bs=a("a"),zk=o("MarkupLMFeatureExtractor"),jk=o(` to extract nodes and corresponding xpaths from one or more HTML strings.
Next, these are provided to `),Ms=a("a"),Ck=o("MarkupLMTokenizer"),Pk=o(" or "),ws=a("a"),Dk=o("MarkupLMTokenizerFast"),Ok=o(`, which turns them into token-level
`),nl=a("code"),Ak=o("input_ids"),Ik=o(", "),sl=a("code"),Nk=o("attention_mask"),Sk=o(", "),al=a("code"),Bk=o("token_type_ids"),Rk=o(", "),rl=a("code"),Wk=o("xpath_tags_seq"),Uk=o(" and "),il=a("code"),Hk=o("xpath_subs_seq"),Vk=o("."),Qk=l(),fe=a("div"),k(Ko.$$.fragment),Xk=l(),oe=a("p"),Gk=o("This method first forwards the "),ll=a("code"),Kk=o("html_strings"),Yk=o(" argument to "),Yo=a("a"),dl=a("strong"),Jk=o("call"),Zk=o("()"),ev=o(`. Next, it
...
if you only want to handle one of the two tasks.`),be.forEach(t),pd=d(s),v(_o.$$.fragment,s),hd=d(s),F=r(s,"P",{});var D=i(F);wp=n(D,"In short, one can provide HTML strings (and possibly additional data) to "),In=r(D,"A",{href:!0});var pM=i(In);yp=n(pM,"MarkupLMProcessor"),pM.forEach(t),xp=n(D,`,
and it will create the inputs expected by the model. Internally, the processor first uses
...
corresponding node labels in order to train a model. The processor will then convert these into token-level `),ma=r(Me,"CODE",{});var OM=i(ma);ch=n(OM,"labels"),OM.forEach(t),ph=n(Me,`.
By default, it will only label the first wordpiece of a word, and label the remaining wordpieces with -100, which is the
`),fa=r(Me,"CODE",{});var AM=i(fa);hh=n(AM,"ignore_index"),AM.forEach(t),uh=n(Me,` of PyTorch\u2019s CrossEntropyLoss. In case you want all wordpieces of a word to be labeled, you can
initialize the tokenizer with `),ga=r(Me,"CODE",{});var IM=i(ga);mh=n(IM,"only_label_first_subword"),IM.forEach(t),fh=n(Me," set to "),_a=r(Me,"CODE",{});var NM=i(_a);gh=n(NM,"False"),NM.forEach(t),_h=n(Me,"."),Me.forEach(t),yd=d(s),v(wo.$$.fragment,s),xd=d(s),Kn=r(s,"P",{});var SM=i(Kn);ka=r(SM,"STRONG",{});var BM=i(ka);kh=n(BM,"Use case 4: web page question answering (inference), parse_html=True"),BM.forEach(t),SM.forEach(t),Td=d(s),Yn=r(s,"P",{});var RM=i(Yn);vh=n(RM,`For question answering tasks on web pages, you can provide a question to the processor. By default, the
processor will use the feature extractor to get all nodes and xpaths, and create [CLS] question tokens [SEP] word tokens [SEP].`),RM.forEach(t),Ed=d(s),v(yo.$$.fragment,s),Ld=d(s),Jn=r(s,"P",{});var WM=i(Jn);va=r(WM,"STRONG",{});var UM=i(va);bh=n(UM,"Use case 5: web page question answering (inference), parse_html=False"),UM.forEach(t),WM.forEach(t),qd=d(s),je=r(s,"P",{});var zs=i(je);Mh=n(zs,`For question answering tasks (such as WebSRC), you can provide a question to the processor. If you have extracted
...
MarkupLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the MarkupLM
`),Lo=r(js,"A",{href:!0,rel:!0});var YM=i(Lo);jh=n(YM,"microsoft/markuplm-base"),YM.forEach(t),Ch=n(js," architecture."),js.forEach(t),Ph=d(Yt),He=r(Yt,"P",{});var Cs=i(He);Dh=n(Cs,"Configuration objects inherit from "),es=r(Cs,"A",{href:!0});var JM=i(es);Oh=n(JM,"BertConfig"),JM.forEach(t),Ah=n(Cs,` and can be used to control the model outputs. Read the
documentation from `),ts=r(Cs,"A",{href:!0});var ZM=i(ts);Ih=n(ZM,"BertConfig"),ZM.forEach(t),Nh=n(Cs," for more information."),Cs.forEach(t),Sh=d(Yt),v(ft.$$.fragment,Yt),Yt.forEach(t),jd=d(s),Ve=r(s,"H2",{class:!0});var Zd=i(Ve);gt=r(Zd,"A",{id:!0,class:!0,href:!0});var e2=i(gt);xa=r(e2,"SPAN",{});var t2=i(xa);v(qo.$$.fragment,t2),t2.forEach(t),e2.forEach(t),Bh=d(Zd),Ta=r(Zd,"SPAN",{});var o2=i(Ta);Rh=n(o2,"MarkupLMFeatureExtractor"),o2.forEach(t),Zd.forEach(t),Cd=d(s),pe=r(s,"DIV",{class:!0});var Jt=i(pe);v($o.$$.fragment,Jt),Wh=d(Jt),Ea=r(Jt,"P",{});var n2=i(Ea);Uh=n(n2,`Constructs a MarkupLM feature extractor. This can be used to get a list of nodes and corresponding xpaths from HTML
strings.`),n2.forEach(t),Hh=d(Jt),Fo=r(Jt,"P",{});var ec=i(Fo);Vh=n(ec,"This feature extractor inherits from "),La=r(ec,"CODE",{});var s2=i(La);Qh=n(s2,"PreTrainedFeatureExtractor()"),s2.forEach(t),Xh=n(ec,` which contains most
of the main methods. Users should refer to this superclass for more information regarding those methods.`),ec.forEach(t),Gh=d(Jt),Ce=r(Jt,"DIV",{class:!0});var Ps=i(Ce);v(zo.$$.fragment,Ps),Kh=d(Ps),qa=r(Ps,"P",{});var a2=i(qa);Yh=n(a2,"Main method to prepare for the model one or several HTML strings."),a2.forEach(t),Jh=d(Ps),v(_t.$$.fragment,Ps),Ps.forEach(t),Jt.forEach(t),Pd=d(s),Qe=r(s,"H2",{class:!0});var tc=i(Qe);kt=r(tc,"A",{id:!0,class:!0,href:!0});var r2=i(kt);$a=r(r2,"SPAN",{});var i2=i($a);v(jo.$$.fragment,i2),i2.forEach(t),r2.forEach(t),Zh=d(tc),Fa=r(tc,"SPAN",{});var l2=i(Fa);eu=n(l2,"MarkupLMTokenizer"),l2.forEach(t),tc.forEach(t),Dd=d(s),K=r(s,"DIV",{class:!0});var we=i(K);v(Co.$$.fragment,we),tu=d(we),S=r(we,"P",{});var ee=i(S);ou=n(ee,"Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE). "),os=r(ee,"A",{href:!0});var d2=i(os);nu=n(d2,"MarkupLMTokenizer"),d2.forEach(t),su=n(ee,` can be used to
turn HTML strings into to token-level `),za=r(ee,"CODE",{});var c2=i(za);au=n(c2,"input_ids"),c2.forEach(t),ru=n(ee,", "),ja=r(ee,"CODE",{});var p2=i(ja);iu=n(p2,"attention_mask"),p2.forEach(t),lu=n(ee,", "),Ca=r(ee,"CODE",{});var h2=i(Ca);du=n(h2,"token_type_ids"),h2.forEach(t),cu=n(ee,", "),Pa=r(ee,"CODE",{});var u2=i(Pa);pu=n(u2,"xpath_tags_seq"),u2.forEach(t),hu=n(ee,` and
`),Da=r(ee,"CODE",{});var m2=i(Da);uu=n(m2,"xpath_tags_seq"),m2.forEach(t),mu=n(ee,". This tokenizer inherits from "),ns=r(ee,"A",{href:!0});var f2=i(ns);fu=n(f2,"PreTrainedTokenizer"),f2.forEach(t),gu=n(ee,` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),ee.forEach(t),_u=d(we),Pe=r(we,"DIV",{class:!0});var Ds=i(Pe);v(Po.$$.fragment,Ds),ku=d(Ds),Oa=r(Ds,"P",{});var g2=i(Oa);vu=n(g2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),g2.forEach(t),bu=d(Ds),Do=r(Ds,"UL",{});var oc=i(Do);ss=r(oc,"LI",{});var jb=i(ss);Mu=n(jb,"single sequence: "),Aa=r(jb,"CODE",{});var _2=i(Aa);wu=n(_2,"<s> X </s>"),_2.forEach(t),jb.forEach(t),yu=d(oc),as=r(oc,"LI",{});var Cb=i(as);xu=n(Cb,"pair of sequences: "),Ia=r(Cb,"CODE",{});var k2=i(Ia);Tu=n(k2,"<s> A </s></s> B </s>"),k2.forEach(t),Cb.forEach(t),oc.forEach(t),Ds.forEach(t),Eu=d(we),rs=r(we,"DIV",{class:!0});var v2=i(rs);v(Oo.$$.fragment,v2),v2.forEach(t),Lu=d(we),vt=r(we,"DIV",{class:!0});var nc=i(vt);v(Ao.$$.fragment,nc),qu=d(nc),Na=r(nc,"P",{});var b2=i(Na);$u=n(b2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),b2.forEach(t),nc.forEach(t),Fu=d(we),is=r(we,"DIV",{class:!0});var M2=i(is);v(Io.$$.fragment,M2),M2.forEach(t),we.forEach(t),Od=d(s),Xe=r(s,"H2",{class:!0});var sc=i(Xe);bt=r(sc,"A",{id:!0,class:!0,href:!0});var w2=i(bt);Sa=r(w2,"SPAN",{});var y2=i(Sa);v(No.$$.fragment,y2),y2.forEach(t),w2.forEach(t),zu=d(sc),Ba=r(sc,"SPAN",{});var x2=i(Ba);ju=n(x2,"MarkupLMTokenizerFast"),x2.forEach(t),sc.forEach(t),Ad=d(s),j=r(s,"DIV",{class:!0});var H=i(j);v(So.$$.fragment,H),Cu=d(H),Ra=r(H,"P",{});var T2=i(Ra);Pu=n(T2,"Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE)."),T2.forEach(t),Du=d(H),B=r(H,"P",{});var ne=i(B);ls=r(ne,"A",{href:!0});var E2=i(ls);Ou=n(E2,"MarkupLMTokenizerFast"),E2.forEach(t),Au=n(ne," can be used to turn HTML strings into to token-level "),Wa=r(ne,"CODE",{});var L2=i(Wa);Iu=n(L2,"input_ids"),L2.forEach(t),Nu=n(ne,", "),Ua=r(ne,"CODE",{});var q2=i(Ua);Su=n(q2,"attention_mask"),q2.forEach(t),Bu=n(ne,`,
`),Ha=r(ne,"CODE",{});var $2=i(Ha);Ru=n($2,"token_type_ids"),$2.forEach(t),Wu=n(ne,", "),Va=r(ne,"CODE",{});var F2=i(Va);Uu=n(F2,"xpath_tags_seq"),F2.forEach(t),Hu=n(ne," and "),Qa=r(ne,"CODE",{});var z2=i(Qa);Vu=n(z2,"xpath_tags_seq"),z2.forEach(t),Qu=n(ne,". This tokenizer inherits from "),ds=r(ne,"A",{href:!0});var j2=i(ds);Xu=n(j2,"PreTrainedTokenizer"),j2.forEach(t),Gu=n(ne,` which
contains most of the main methods.`),ne.forEach(t),Ku=d(H),Xa=r(H,"P",{});var C2=i(Xa);Yu=n(C2,"Users should refer to this superclass for more information regarding those methods."),C2.forEach(t),Ju=d(H),R=r(H,"DIV",{class:!0});var re=i(R);v(Bo.$$.fragment,re),Zu=d(re),O=r(re,"P",{});var V=i(O);em=n(V,"add_special_tokens ("),Ga=r(V,"CODE",{});var P2=i(Ga);tm=n(P2,"bool"),P2.forEach(t),om=n(V,", "),Ka=r(V,"EM",{});var D2=i(Ka);nm=n(D2,"optional"),D2.forEach(t),sm=n(V,", defaults to "),Ya=r(V,"CODE",{});var O2=i(Ya);am=n(O2,"True"),O2.forEach(t),rm=n(V,`):
Whether or not to encode the sequences with the special tokens relative to their model.
padding (`),Ja=r(V,"CODE",{});var A2=i(Ja);im=n(A2,"bool"),A2.forEach(t),lm=n(V,", "),Za=r(V,"CODE",{});var I2=i(Za);dm=n(I2,"str"),I2.forEach(t),cm=n(V," or "),cs=r(V,"A",{href:!0});var N2=i(cs);pm=n(N2,"PaddingStrategy"),N2.forEach(t),hm=n(V,", "),er=r(V,"EM",{});var S2=i(er);um=n(S2,"optional"),S2.forEach(t),mm=n(V,", defaults to "),tr=r(V,"CODE",{});var B2=i(tr);fm=n(B2,"False"),B2.forEach(t),gm=n(V,`):
Activates and controls padding. Accepts the following values:`),V.forEach(t),_m=d(re),Y=r(re,"UL",{});var ie=i(Y);or=r(ie,"LI",{});var R2=i(or);Mt=r(R2,"P",{});var Il=i(Mt);nr=r(Il,"CODE",{});var W2=i(nr);km=n(W2,"True"),W2.forEach(t),vm=n(Il," or "),sr=r(Il,"CODE",{});var U2=i(sr);bm=n(U2,"'longest'"),U2.forEach(t),Mm=n(Il,`: Pad to the longest sequence in the batch (or no padding if only a single
sequence if provided).`),Il.forEach(t),R2.forEach(t),wm=d(ie),ar=r(ie,"LI",{});var H2=i(ar);wt=r(H2,"P",{});var Nl=i(wt);rr=r(Nl,"CODE",{});var V2=i(rr);ym=n(V2,"'max_length'"),V2.forEach(t),xm=n(Nl,": Pad to a maximum length specified with the argument "),ir=r(Nl,"CODE",{});var Q2=i(ir);Tm=n(Q2,"max_length"),Q2.forEach(t),Em=n(Nl,` or to the maximum
acceptable input length for the model if that argument is not provided.`),Nl.forEach(t),H2.forEach(t),Lm=d(ie),lr=r(ie,"LI",{});var X2=i(lr);W=r(X2,"P",{});var se=i(W);dr=r(se,"CODE",{});var G2=i(dr);qm=n(G2,"False"),G2.forEach(t),$m=n(se," or "),cr=r(se,"CODE",{});var K2=i(cr);Fm=n(K2,"'do_not_pad'"),K2.forEach(t),zm=n(se,` (default): No padding (i.e., can output a batch with sequences of different
lengths).
truncation (`),pr=r(se,"CODE",{});var Y2=i(pr);jm=n(Y2,"bool"),Y2.forEach(t),Cm=n(se,", "),hr=r(se,"CODE",{});var J2=i(hr);Pm=n(J2,"str"),J2.forEach(t),Dm=n(se," or "),ps=r(se,"A",{href:!0});var Z2=i(ps);Om=n(Z2,"TruncationStrategy"),Z2.forEach(t),Am=n(se,", "),ur=r(se,"EM",{});var e1=i(ur);Im=n(e1,"optional"),e1.forEach(t),Nm=n(se,", defaults to "),mr=r(se,"CODE",{});var t1=i(mr);Sm=n(t1,"False"),t1.forEach(t),Bm=n(se,`):
Activates and controls truncation. Accepts the following values:`),se.forEach(t),X2.forEach(t),Rm=d(ie),fr=r(ie,"LI",{});var o1=i(fr);De=r(o1,"P",{});var Mn=i(De);gr=r(Mn,"CODE",{});var n1=i(gr);Wm=n(n1,"True"),n1.forEach(t),Um=n(Mn," or "),_r=r(Mn,"CODE",{});var s1=i(_r);Hm=n(s1,"'longest_first'"),s1.forEach(t),Vm=n(Mn,": Truncate to a maximum length specified with the argument "),kr=r(Mn,"CODE",{});var a1=i(kr);Qm=n(a1,"max_length"),a1.forEach(t),Xm=n(Mn,` or
to the maximum acceptable input length for the model if that argument is not provided. This will
truncate token by token, removing a token from the longest sequence in the pair if a pair of
sequences (or a batch of pairs) is provided.`),Mn.forEach(t),o1.forEach(t),Gm=d(ie),vr=r(ie,"LI",{});var r1=i(vr);yt=r(r1,"P",{});var Sl=i(yt);br=r(Sl,"CODE",{});var i1=i(br);Km=n(i1,"'only_first'"),i1.forEach(t),Ym=n(Sl,": Truncate to a maximum length specified with the argument "),Mr=r(Sl,"CODE",{});var l1=i(Mr);Jm=n(l1,"max_length"),l1.forEach(t),Zm=n(Sl,` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the first sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),Sl.forEach(t),r1.forEach(t),ef=d(ie),wr=r(ie,"LI",{});var d1=i(wr);xt=r(d1,"P",{});var Bl=i(xt);yr=r(Bl,"CODE",{});var c1=i(yr);tf=n(c1,"'only_second'"),c1.forEach(t),of=n(Bl,": Truncate to a maximum length specified with the argument "),xr=r(Bl,"CODE",{});var p1=i(xr);nf=n(p1,"max_length"),p1.forEach(t),sf=n(Bl,` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the second sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),Bl.forEach(t),d1.forEach(t),af=d(ie),Tr=r(ie,"LI",{});var h1=i(Tr);me=r(h1,"P",{});var dt=i(me);Er=r(dt,"CODE",{});var u1=i(Er);rf=n(u1,"False"),u1.forEach(t),lf=n(dt," or "),Lr=r(dt,"CODE",{});var m1=i(Lr);df=n(m1,"'do_not_truncate'"),m1.forEach(t),cf=n(dt,` (default): No truncation (i.e., can output batch with sequence lengths
greater than the model maximum admissible input size).
max_length (`),qr=r(dt,"CODE",{});var f1=i(qr);pf=n(f1,"int"),f1.forEach(t),hf=n(dt,", "),$r=r(dt,"EM",{});var g1=i($r);uf=n(g1,"optional"),g1.forEach(t),mf=n(dt,`):
Controls the maximum length to use by one of the truncation/padding parameters.`),dt.forEach(t),h1.forEach(t),ie.forEach(t),ff=d(re),E=r(re,"P",{});var q=i(E);gf=n(q,"If left unset or set to "),Fr=r(q,"CODE",{});var _1=i(Fr);_f=n(_1,"None"),_1.forEach(t),kf=n(q,`, this will use the predefined model maximum length if a maximum length
is required by one of the truncation/padding parameters. If the model has no specific maximum input
length (like XLNet) truncation/padding to a maximum length will be deactivated.
stride (`),zr=r(q,"CODE",{});var k1=i(zr);vf=n(k1,"int"),k1.forEach(t),bf=n(q,", "),jr=r(q,"EM",{});var v1=i(jr);Mf=n(v1,"optional"),v1.forEach(t),wf=n(q,`, defaults to 0):
If set to a number along with `),Cr=r(q,"CODE",{});var b1=i(Cr);yf=n(b1,"max_length"),b1.forEach(t),xf=n(q,`, the overflowing tokens returned when
`),Pr=r(q,"CODE",{});var M1=i(Pr);Tf=n(M1,"return_overflowing_tokens=True"),M1.forEach(t),Ef=n(q,` will contain some tokens from the end of the truncated sequence
returned to provide some overlap between truncated and overflowing sequences. The value of this
argument defines the number of overlapping tokens.
is_split_into_words (`),Dr=r(q,"CODE",{});var w1=i(Dr);Lf=n(w1,"bool"),w1.forEach(t),qf=n(q,", "),Or=r(q,"EM",{});var y1=i(Or);$f=n(y1,"optional"),y1.forEach(t),Ff=n(q,", defaults to "),Ar=r(q,"CODE",{});var x1=i(Ar);zf=n(x1,"False"),x1.forEach(t),jf=n(q,`):
Whether or not the input is already pre-tokenized (e.g., split into words). If set to `),Ir=r(q,"CODE",{});var T1=i(Ir);Cf=n(T1,"True"),T1.forEach(t),Pf=n(q,`, the
tokenizer assumes the input is already split into words (for instance, by splitting it on whitespace)
which it will tokenize. This is useful for NER or token classification.
pad_to_multiple_of (`),Nr=r(q,"CODE",{});var E1=i(Nr);Df=n(E1,"int"),E1.forEach(t),Of=n(q,", "),Sr=r(q,"EM",{});var L1=i(Sr);Af=n(L1,"optional"),L1.forEach(t),If=n(q,`):
If set will pad the sequence to a multiple of the provided value. This is especially useful to enable
the use of Tensor Cores on NVIDIA hardware with compute capability >= 7.5 (Volta).
return_tensors (`),Br=r(q,"CODE",{});var q1=i(Br);Nf=n(q1,"str"),q1.forEach(t),Sf=n(q," or "),hs=r(q,"A",{href:!0});var $1=i(hs);Bf=n($1,"TensorType"),$1.forEach(t),Rf=n(q,", "),Rr=r(q,"EM",{});var F1=i(Rr);Wf=n(F1,"optional"),F1.forEach(t),Uf=n(q,`):
If set, will return tensors instead of list of python integers. Acceptable values are:`),q.forEach(t),Hf=d(re),Ge=r(re,"UL",{});var Os=i(Ge);Tt=r(Os,"LI",{});var Rl=i(Tt);Wr=r(Rl,"CODE",{});var z1=i(Wr);Vf=n(z1,"'tf'"),z1.forEach(t),Qf=n(Rl,": Return TensorFlow "),Ur=r(Rl,"CODE",{});var j1=i(Ur);Xf=n(j1,"tf.constant"),j1.forEach(t),Gf=n(Rl," objects."),Rl.forEach(t),Kf=d(Os),Et=r(Os,"LI",{});var Wl=i(Et);Hr=r(Wl,"CODE",{});var C1=i(Hr);Yf=n(C1,"'pt'"),C1.forEach(t),Jf=n(Wl,": Return PyTorch "),Vr=r(Wl,"CODE",{});var P1=i(Vr);Zf=n(P1,"torch.Tensor"),P1.forEach(t),eg=n(Wl," objects."),Wl.forEach(t),tg=d(Os),Lt=r(Os,"LI",{});var Ul=i(Lt);Qr=r(Ul,"CODE",{});var D1=i(Qr);og=n(D1,"'np'"),D1.forEach(t),ng=n(Ul,": Return Numpy "),Xr=r(Ul,"CODE",{});var O1=i(Xr);sg=n(O1,"np.ndarray"),O1.forEach(t),ag=n(Ul," objects."),Ul.forEach(t),Os.forEach(t),rg=d(re),A=r(re,"P",{});var Q=i(A);ig=n(Q,"add_special_tokens ("),Gr=r(Q,"CODE",{});var A1=i(Gr);lg=n(A1,"bool"),A1.forEach(t),dg=n(Q,", "),Kr=r(Q,"EM",{});var I1=i(Kr);cg=n(I1,"optional"),I1.forEach(t),pg=n(Q,", defaults to "),Yr=r(Q,"CODE",{});var N1=i(Yr);hg=n(N1,"True"),N1.forEach(t),ug=n(Q,`):
Whether or not to encode the sequences with the special tokens relative to their model.
padding (`),Jr=r(Q,"CODE",{});var S1=i(Jr);mg=n(S1,"bool"),S1.forEach(t),fg=n(Q,", "),Zr=r(Q,"CODE",{});var B1=i(Zr);gg=n(B1,"str"),B1.forEach(t),_g=n(Q," or "),us=r(Q,"A",{href:!0});var R1=i(us);kg=n(R1,"PaddingStrategy"),R1.forEach(t),vg=n(Q,", "),ei=r(Q,"EM",{});var W1=i(ei);bg=n(W1,"optional"),W1.forEach(t),Mg=n(Q,", defaults to "),ti=r(Q,"CODE",{});var U1=i(ti);wg=n(U1,"False"),U1.forEach(t),yg=n(Q,`):
Activates and controls padding. Accepts the following values:`),Q.forEach(t),xg=d(re),C=r(re,"UL",{});var N=i(C);oi=r(N,"LI",{});var H1=i(oi);qt=r(H1,"P",{});var Hl=i(qt);ni=r(Hl,"CODE",{});var V1=i(ni);Tg=n(V1,"True"),V1.forEach(t),Eg=n(Hl," or "),si=r(Hl,"CODE",{});var Q1=i(si);Lg=n(Q1,"'longest'"),Q1.forEach(t),qg=n(Hl,`: Pad to the longest sequence in the batch (or no padding if only a single
sequence if provided).`),Hl.forEach(t),H1.forEach(t),$g=d(N),ai=r(N,"LI",{});var X1=i(ai);$t=r(X1,"P",{});var Vl=i($t);ri=r(Vl,"CODE",{});var G1=i(ri);Fg=n(G1,"'max_length'"),G1.forEach(t),zg=n(Vl,": Pad to a maximum length specified with the argument "),ii=r(Vl,"CODE",{});var K1=i(ii);jg=n(K1,"max_length"),K1.forEach(t),Cg=n(Vl,` or to the maximum
acceptable input length for the model if that argument is not provided.`),Vl.forEach(t),X1.forEach(t),Pg=d(N),li=r(N,"LI",{});var Y1=i(li);U=r(Y1,"P",{});var ae=i(U);di=r(ae,"CODE",{});var J1=i(di);Dg=n(J1,"False"),J1.forEach(t),Og=n(ae," or "),ci=r(ae,"CODE",{});var Z1=i(ci);Ag=n(Z1,"'do_not_pad'"),Z1.forEach(t),Ig=n(ae,` (default): No padding (i.e., can output a batch with sequences of different
lengths).
truncation (`),pi=r(ae,"CODE",{});var ew=i(pi);Ng=n(ew,"bool"),ew.forEach(t),Sg=n(ae,", "),hi=r(ae,"CODE",{});var tw=i(hi);Bg=n(tw,"str"),tw.forEach(t),Rg=n(ae," or "),ms=r(ae,"A",{href:!0});var ow=i(ms);Wg=n(ow,"TruncationStrategy"),ow.forEach(t),Ug=n(ae,", "),ui=r(ae,"EM",{});var nw=i(ui);Hg=n(nw,"optional"),nw.forEach(t),Vg=n(ae,", defaults to "),mi=r(ae,"CODE",{});var sw=i(mi);Qg=n(sw,"False"),sw.forEach(t),Xg=n(ae,`):
Activates and controls truncation. Accepts the following values:`),ae.forEach(t),Y1.forEach(t),Gg=d(N),fi=r(N,"LI",{});var aw=i(fi);Oe=r(aw,"P",{});var wn=i(Oe);gi=r(wn,"CODE",{});var rw=i(gi);Kg=n(rw,"True"),rw.forEach(t),Yg=n(wn," or "),_i=r(wn,"CODE",{});var iw=i(_i);Jg=n(iw,"'longest_first'"),iw.forEach(t),Zg=n(wn,": Truncate to a maximum length specified with the argument "),ki=r(wn,"CODE",{});var lw=i(ki);e_=n(lw,"max_length"),lw.forEach(t),t_=n(wn,` or
to the maximum acceptable input length for the model if that argument is not provided. This will
truncate token by token, removing a token from the longest sequence in the pair if a pair of
sequences (or a batch of pairs) is provided.`),wn.forEach(t),aw.forEach(t),o_=d(N),vi=r(N,"LI",{});var dw=i(vi);Ft=r(dw,"P",{});var Ql=i(Ft);bi=r(Ql,"CODE",{});var cw=i(bi);n_=n(cw,"'only_first'"),cw.forEach(t),s_=n(Ql,": Truncate to a maximum length specified with the argument "),Mi=r(Ql,"CODE",{});var pw=i(Mi);a_=n(pw,"max_length"),pw.forEach(t),r_=n(Ql,` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the first sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),Ql.forEach(t),dw.forEach(t),i_=d(N),wi=r(N,"LI",{});var hw=i(wi);zt=r(hw,"P",{});var Xl=i(zt);yi=r(Xl,"CODE",{});var uw=i(yi);l_=n(uw,"'only_second'"),uw.forEach(t),d_=n(Xl,": Truncate to a maximum length specified with the argument "),xi=r(Xl,"CODE",{});var mw=i(xi);c_=n(mw,"max_length"),mw.forEach(t),p_=n(Xl,` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the second sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),Xl.forEach(t),hw.forEach(t),h_=d(N),Ti=r(N,"LI",{});var fw=i(Ti);L=r(fw,"P",{});var $=i(L);Ei=r($,"CODE",{});var gw=i(Ei);u_=n(gw,"False"),gw.forEach(t),m_=n($," or "),Li=r($,"CODE",{});var _w=i(Li);f_=n(_w,"'do_not_truncate'"),_w.forEach(t),g_=n($,` (default): No truncation (i.e., can output batch with sequence lengths
greater than the model maximum admissible input size).
max_length (`),qi=r($,"CODE",{});var kw=i(qi);__=n(kw,"int"),kw.forEach(t),k_=n($,", "),$i=r($,"EM",{});var vw=i($i);v_=n(vw,"optional"),vw.forEach(t),b_=n($,`):
Controls the maximum length to use by one of the truncation/padding parameters. If left unset or set to
`),Fi=r($,"CODE",{});var bw=i(Fi);M_=n(bw,"None"),bw.forEach(t),w_=n($,`, this will use the predefined model maximum length if a maximum length is required by one of the
truncation/padding parameters. If the model has no specific maximum input length (like XLNet)
truncation/padding to a maximum length will be deactivated.
stride (`),zi=r($,"CODE",{});var Mw=i(zi);y_=n(Mw,"int"),Mw.forEach(t),x_=n($,", "),ji=r($,"EM",{});var ww=i(ji);T_=n(ww,"optional"),ww.forEach(t),E_=n($,`, defaults to 0):
If set to a number along with `),Ci=r($,"CODE",{});var yw=i(Ci);L_=n(yw,"max_length"),yw.forEach(t),q_=n($,`, the overflowing tokens returned when
`),Pi=r($,"CODE",{});var xw=i(Pi);$_=n(xw,"return_overflowing_tokens=True"),xw.forEach(t),F_=n($,` will contain some tokens from the end of the truncated sequence
returned to provide some overlap between truncated and overflowing sequences. The value of this
argument defines the number of overlapping tokens.
pad_to_multiple_of (`),Di=r($,"CODE",{});var Tw=i(Di);z_=n(Tw,"int"),Tw.forEach(t),j_=n($,", "),Oi=r($,"EM",{});var Ew=i(Oi);C_=n(Ew,"optional"),Ew.forEach(t),P_=n($,`):
If set will pad the sequence to a multiple of the provided value. This is especially useful to enable
the use of Tensor Cores on NVIDIA hardware with compute capability >= 7.5 (Volta).
return_tensors (`),Ai=r($,"CODE",{});var Lw=i(Ai);D_=n(Lw,"str"),Lw.forEach(t),O_=n($," or "),fs=r($,"A",{href:!0});var qw=i(fs);A_=n(qw,"TensorType"),qw.forEach(t),I_=n($,", "),Ii=r($,"EM",{});var $w=i(Ii);N_=n($w,"optional"),$w.forEach(t),S_=n($,`):
If set, will return tensors instead of list of python integers. Acceptable values are:`),$.forEach(t),fw.forEach(t),B_=d(N),Ni=r(N,"LI",{});var Fw=i(Ni);jt=r(Fw,"P",{});var Gl=i(jt);Si=r(Gl,"CODE",{});var zw=i(Si);R_=n(zw,"'tf'"),zw.forEach(t),W_=n(Gl,": Return TensorFlow "),Bi=r(Gl,"CODE",{});var jw=i(Bi);U_=n(jw,"tf.constant"),jw.forEach(t),H_=n(Gl," objects."),Gl.forEach(t),Fw.forEach(t),V_=d(N),Ri=r(N,"LI",{});var Cw=i(Ri);Ct=r(Cw,"P",{});var Kl=i(Ct);Wi=r(Kl,"CODE",{});var Pw=i(Wi);Q_=n(Pw,"'pt'"),Pw.forEach(t),X_=n(Kl,": Return PyTorch "),Ui=r(Kl,"CODE",{});var Dw=i(Ui);G_=n(Dw,"torch.Tensor"),Dw.forEach(t),K_=n(Kl," objects."),Kl.forEach(t),Cw.forEach(t),Y_=d(N),Hi=r(N,"LI",{});var Ow=i(Hi);Pt=r(Ow,"P",{});var Yl=i(Pt);Vi=r(Yl,"CODE",{});var Aw=i(Vi);J_=n(Aw,"'np'"),Aw.forEach(t),Z_=n(Yl,": Return Numpy "),Qi=r(Yl,"CODE",{});var Iw=i(Qi);ek=n(Iw,"np.ndarray"),Iw.forEach(t),tk=n(Yl," objects."),Yl.forEach(t),Ow.forEach(t),N.forEach(t),re.forEach(t),ok=d(H),Ae=r(H,"DIV",{class:!0});var As=i(Ae);v(Ro.$$.fragment,As),nk=d(As),Xi=r(As,"P",{});var Nw=i(Xi);sk=n(Nw,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),Nw.forEach(t),ak=d(As),Wo=r(As,"UL",{});var ac=i(Wo);gs=r(ac,"LI",{});var Pb=i(gs);rk=n(Pb,"single sequence: "),Gi=r(Pb,"CODE",{});var Sw=i(Gi);ik=n(Sw,"<s> X </s>"),Sw.forEach(t),Pb.forEach(t),lk=d(ac),_s=r(ac,"LI",{});var Db=i(_s);dk=n(Db,"pair of sequences: "),Ki=r(Db,"CODE",{});var Bw=i(Ki);ck=n(Bw,"<s> A </s></s> B </s>"),Bw.forEach(t),Db.forEach(t),ac.forEach(t),As.forEach(t),pk=d(H),Dt=r(H,"DIV",{class:!0});var rc=i(Dt);v(Uo.$$.fragment,rc),hk=d(rc),Yi=r(rc,"P",{});var Rw=i(Yi);uk=n(Rw,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),Rw.forEach(t),rc.forEach(t),mk=d(H),Ot=r(H,"DIV",{class:!0});var ic=i(Ot);v(Ho.$$.fragment,ic),fk=d(ic),Vo=r(ic,"P",{});var lc=i(Vo);gk=n(lc,`Tokenize and prepare for the model a sequence or a pair of sequences. .. warning:: This method is deprecated,
`),Ji=r(lc,"CODE",{});var Ww=i(Ji);_k=n(Ww,"__call__"),Ww.forEach(t),kk=n(lc," should be used instead."),lc.forEach(t),ic.forEach(t),vk=d(H),At=r(H,"DIV",{class:!0});var dc=i(At);v(Qo.$$.fragment,dc),bk=d(dc),Zi=r(dc,"P",{});var Uw=i(Zi);Mk=n(Uw,`Given the xpath expression of one particular node (like \u201C/html/body/div/li[1]/div/span[2]\u201D), return a list of
tag IDs and corresponding subscripts, taking into account max depth.`),Uw.forEach(t),dc.forEach(t),H.forEach(t),Id=d(s),Ke=r(s,"H2",{class:!0});var cc=i(Ke);It=r(cc,"A",{id:!0,class:!0,href:!0});var Hw=i(It);el=r(Hw,"SPAN",{});var Vw=i(el);v(Xo.$$.fragment,Vw),Vw.forEach(t),Hw.forEach(t),wk=d(cc),tl=r(cc,"SPAN",{});var Qw=i(tl);yk=n(Qw,"MarkupLMProcessor"),Qw.forEach(t),cc.forEach(t),Nd=d(s),te=r(s,"DIV",{class:!0});var Ne=i(te);v(Go.$$.fragment,Ne),xk=d(Ne),ol=r(Ne,"P",{});var Xw=i(ol);Tk=n(Xw,`Constructs a MarkupLM processor which combines a MarkupLM feature extractor and a MarkupLM tokenizer into a single
processor.`),Xw.forEach(t),Ek=d(Ne),ks=r(Ne,"P",{});var Ob=i(ks);vs=r(Ob,"A",{href:!0});var Gw=i(vs);Lk=n(Gw,"MarkupLMProcessor"),Gw.forEach(t),qk=n(Ob," offers all the functionalities you need to prepare data for the model."),Ob.forEach(t),$k=d(Ne),I=r(Ne,"P",{});var X=i(I);Fk=n(X,"It first uses "),bs=r(X,"A",{href:!0});var Kw=i(bs);zk=n(Kw,"MarkupLMFeatureExtractor"),Kw.forEach(t),jk=n(X,` to extract nodes and corresponding xpaths from one or more HTML strings.
Next, these are provided to `),Ms=r(X,"A",{href:!0});var Yw=i(Ms);Ck=n(Yw,"MarkupLMTokenizer"),Yw.forEach(t),Pk=n(X," or "),ws=r(X,"A",{href:!0});var Jw=i(ws);Dk=n(Jw,"MarkupLMTokenizerFast"),Jw.forEach(t),Ok=n(X,`, which turns them into token-level
`),nl=r(X,"CODE",{});var Zw=i(nl);Ak=n(Zw,"input_ids"),Zw.forEach(t),Ik=n(X,", "),sl=r(X,"CODE",{});var ey=i(sl);Nk=n(ey,"attention_mask"),ey.forEach(t),Sk=n(X,", "),al=r(X,"CODE",{});var ty=i(al);Bk=n(ty,"token_type_ids"),ty.forEach(t),Rk=n(X,", "),rl=r(X,"CODE",{});var oy=i(rl);Wk=n(oy,"xpath_tags_seq"),oy.forEach(t),Uk=n(X," and "),il=r(X,"CODE",{});var ny=i(il);Hk=n(ny,"xpath_subs_seq"),ny.forEach(t),Vk=n(X,"."),X.forEach(t),Qk=d(Ne),fe=r(Ne,"DIV",{class:!0});var Zt=i(fe);v(Ko.$$.fragment,Zt),Xk=d(Zt),oe=r(Zt,"P",{});var ye=i(oe);Gk=n(ye,"This method first forwards the "),ll=r(ye,"CODE",{});var sy=i(ll);Kk=n(sy,"html_strings"),sy.forEach(t),Yk=n(ye," argument to "),Yo=r(ye,"A",{href:!0});var Ab=i(Yo);dl=r(Ab,"STRONG",{});var ay=i(dl);Jk=n(ay,"call"),ay.forEach(t),Zk=n(Ab,"()"),Ab.forEach(t),ev=n(ye,`. Next, it
