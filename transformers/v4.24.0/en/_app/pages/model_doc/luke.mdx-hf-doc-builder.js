import{S as bf,i as vf,s as Tf,e as a,k as h,w as b,t as o,M as wf,c as r,d as t,m as u,a as i,x as v,h as s,b as p,G as e,g as k,y as T,q as w,o as L,B as $,v as Lf,L as G}from"../../chunks/vendor-hf-doc-builder.js";import{T as Je}from"../../chunks/Tip-hf-doc-builder.js";import{D as x}from"../../chunks/Docstring-hf-doc-builder.js";import{C as K}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Z}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Y}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function $f(z){let d,_,c,f,y;return f=new K({props:{code:`from transformers import LukeConfig, LukeModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),_=o("Examples:"),c=h(),b(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);_=s(m,"Examples:"),m.forEach(t),c=u(l),v(f.$$.fragment,l)},m(l,m){k(l,d,m),e(d,_),k(l,c,m),T(f,l,m),y=!0},p:G,i(l){y||(w(f.$$.fragment,l),y=!0)},o(l){L(f.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),$(f,l)}}}function zf(z){let d,_,c,f,y;return{c(){d=a("p"),_=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=o("Module"),y=o(`
...
`}}),{c(){d=a("p"),_=o("Example of single-label classification:"),c=h(),b(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);_=s(m,"Example of single-label classification:"),m.forEach(t),c=u(l),v(f.$$.fragment,l)},m(l,m){k(l,d,m),e(d,_),k(l,c,m),T(f,l,m),y=!0},p:G,i(l){y||(w(f.$$.fragment,l),y=!0)},o(l){L(f.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),$(f,l)}}}function Of(z){let d,_;return d=new K({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=a("p"),_=o("Example of multi-label classification:"),c=h(),b(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);_=s(m,"Example of multi-label classification:"),m.forEach(t),c=u(l),v(f.$$.fragment,l)},m(l,m){k(l,d,m),e(d,_),k(l,c,m),T(f,l,m),y=!0},p:G,i(l){y||(w(f.$$.fragment,l),y=!0)},o(l){L(f.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),$(f,l)}}}function Nf(z){let d,_;return d=new K({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),_=o("Example:"),c=h(),b(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);_=s(m,"Example:"),m.forEach(t),c=u(l),v(f.$$.fragment,l)},m(l,m){k(l,d,m),e(d,_),k(l,c,m),T(f,l,m),y=!0},p:G,i(l){y||(w(f.$$.fragment,l),y=!0)},o(l){L(f.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),$(f,l)}}}function Bf(z){let d,_,c,f,y;return{c(){d=a("p"),_=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=o("Module"),y=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);f=s(E,"Module"),E.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){k(l,d,m),e(d,_),e(d,c),e(c,f),e(d,y)},d(l){l&&t(d)}}}function Uf(z){let d,_,c,f,y;return f=new K({props:{code:`from transformers import LukeTokenizer, LukeForTokenClassification
import torch
...
`}}),{c(){d=a("p"),_=o("Example:"),c=h(),b(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);_=s(m,"Example:"),m.forEach(t),c=u(l),v(f.$$.fragment,l)},m(l,m){k(l,d,m),e(d,_),k(l,c,m),T(f,l,m),y=!0},p:G,i(l){y||(w(f.$$.fragment,l),y=!0)},o(l){L(f.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),$(f,l)}}}function Kf(z){let d,_;return d=new K({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){b(d.$$.fragment)},l(c){v(d.$$.fragment,c)},m(c,f){T(d,c,f),_=!0},p:G,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){L(d.$$.fragment,c),_=!1},d(c){$(d,c)}}}function Rf(z){let d,_,c,f,y;return{c(){d=a("p"),_=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=o("Module"),y=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);f=s(E,"Module"),E.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=a("p"),_=o("Example:"),c=h(),b(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);_=s(m,"Example:"),m.forEach(t),c=u(l),v(f.$$.fragment,l)},m(l,m){k(l,d,m),e(d,_),k(l,c,m),T(f,l,m),y=!0},p:G,i(l){y||(w(f.$$.fragment,l),y=!0)},o(l){L(f.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),$(f,l)}}}function Hf(z){let d,_;return d=new K({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){b(d.$$.fragment)},l(c){v(d.$$.fragment,c)},m(c,f){T(d,c,f),_=!0},p:G,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){L(d.$$.fragment,c),_=!1},d(c){$(d,c)}}}function Vf(z){let d,_,c,f,y,l,m,E,li,Ga,Le,Xe,ys,Kt,di,bs,ci,Ja,Ze,pi,Rt,hi,ui,Xa,ko,mi,Za,yo,vs,fi,er,bo,gi,tr,ee,Ts,Qt,_i,vo,ki,yi,bi,ws,j,vi,Ls,Ti,wi,$s,Li,$i,zs,zi,Ei,Es,xi,Fi,To,qi,Ci,ji,Ht,te,wo,Mi,Pi,xs,Ai,Si,Fs,Oi,Ii,qs,Ni,Di,Wi,Vt,Lo,Cs,Bi,Ui,Ki,$o,js,Ri,Qi,Hi,J,Ms,Vi,Yi,$e,et,zo,Gi,Ji,Yt,Xi,Zi,el,tt,Eo,tl,nl,Gt,ol,sl,al,xo,Fo,rl,il,ll,R,qo,dl,cl,Ps,pl,hl,As,ul,ml,Ss,fl,gl,Os,_l,kl,yl,ze,bl,Co,vl,Tl,Jt,wl,Ll,$l,Xt,zl,Zt,El,xl,nr,jo,Fl,or,en,sr,ne,ql,tn,Cl,jl,nn,Ml,Pl,on,Al,Sl,ar,Ee,nt,Is,sn,Ol,Ns,Il,rr,X,an,Nl,xe,Dl,Mo,Wl,Bl,rn,Ul,Kl,Rl,Fe,Ql,Po,Hl,Vl,Ao,Yl,Gl,Jl,ot,ir,qe,st,Ds,ln,Xl,Ws,Zl,lr,M,dn,ed,Bs,td,nd,F,od,So,sd,ad,Oo,rd,id,Io,ld,dd,Us,cd,pd,Ks,hd,ud,Rs,md,fd,Qs,gd,_d,kd,at,cn,yd,Hs,bd,vd,No,pn,dr,Ce,rt,Vs,hn,Td,Ys,wd,cr,P,un,Ld,Gs,$d,zd,mn,Ed,Do,xd,Fd,qd,fn,Cd,gn,jd,Md,Pd,oe,_n,Ad,je,Sd,Wo,Od,Id,Js,Nd,Dd,Wd,it,Bd,lt,pr,Me,dt,Xs,kn,Ud,Zs,Kd,hr,A,yn,Rd,ea,Qd,Hd,bn,Vd,Bo,Yd,Gd,Jd,vn,Xd,Tn,Zd,ec,tc,ce,wn,nc,Pe,oc,Uo,sc,ac,ta,rc,ic,lc,ct,ur,Ae,pt,na,Ln,dc,oa,cc,mr,S,$n,pc,sa,hc,uc,zn,mc,Ko,fc,gc,_c,En,kc,xn,yc,bc,vc,se,Fn,Tc,Se,wc,Ro,Lc,$c,aa,zc,Ec,xc,ht,Fc,ut,fr,Oe,mt,ra,qn,qc,ia,Cc,gr,O,Cn,jc,la,Mc,Pc,jn,Ac,Qo,Sc,Oc,Ic,Mn,Nc,Pn,Dc,Wc,Bc,ae,An,Uc,Ie,Kc,Ho,Rc,Qc,da,Hc,Vc,Yc,ft,Gc,gt,_r,Ne,_t,ca,Sn,Jc,pa,Xc,kr,I,On,Zc,ha,ep,tp,In,np,Vo,op,sp,ap,Nn,rp,Dn,ip,lp,dp,re,Wn,cp,De,pp,Yo,hp,up,ua,mp,fp,gp,kt,_p,yt,yr,We,bt,ma,Bn,kp,fa,yp,br,N,Un,bp,ga,vp,Tp,Kn,wp,Go,Lp,$p,zp,Rn,Ep,Qn,xp,Fp,qp,q,Hn,Cp,Be,jp,Jo,Mp,Pp,_a,Ap,Sp,Op,vt,Ip,Tt,Np,wt,Dp,Lt,Wp,$t,vr,Ue,zt,ka,Vn,Bp,ya,Up,Tr,D,Yn,Kp,ba,Rp,Qp,Gn,Hp,Xo,Vp,Yp,Gp,Jn,Jp,Xn,Xp,Zp,eh,ie,Zn,th,Ke,nh,Zo,oh,sh,va,ah,rh,ih,Et,lh,xt,wr,Re,Ft,Ta,eo,dh,wa,ch,Lr,W,to,ph,no,hh,La,uh,mh,fh,oo,gh,es,_h,kh,yh,so,bh,ao,vh,Th,wh,Q,ro,Lh,Qe,$h,ts,zh,Eh,$a,xh,Fh,qh,qt,Ch,Ct,jh,jt,$r,He,Mt,za,io,Mh,Ea,Ph,zr,B,lo,Ah,Ve,Sh,xa,Oh,Ih,Fa,Nh,Dh,Wh,co,Bh,ns,Uh,Kh,Rh,po,Qh,ho,Hh,Vh,Yh,H,uo,Gh,Ye,Jh,os,Xh,Zh,qa,eu,tu,nu,Pt,ou,At,su,St,Er;return l=new Z({}),Kt=new Z({}),en=new K({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeModel">LukeModel</a>.`,name:"vocab_size"},{anchor:"transformers.LukeConfig.entity_vocab_size",description:`<strong>entity_vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 500000) &#x2014;
Entity vocabulary size of the LUKE model. Defines the number of different entities that can be represented
by the <code>entity_ids</code> passed when calling <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeModel">LukeModel</a>.`,name:"entity_vocab_size"},{anchor:"transformers.LukeConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/tokenization_luke.py#L260",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/v4.24.0/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),pn=new x({props:{name:"save_vocabulary",anchor:"transformers.LukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/tokenization_luke.py#L1379"}}),hn=new Z({}),un=new x({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:": LukeConfig"},{name:"add_pooling_layer",val:": bool = True"}],parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1025"}}),_n=new x({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeConfig"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1282"}}),wn=new x({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"entity_labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1318",returnDescription:`
...
and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1438",returnDescription:`
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1538"}}),An=new x({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>[0, ..., config.num_labels - 1]</code>. If the shape is <code>(batch_size, num_labels)</code>, the binary cross entropy
loss is used for the multi-label classification. In this case, labels should only contain <code>[0, 1]</code>, where 0
and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1551",returnDescription:`
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1656"}}),Wn=new x({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
labels should only contain <code>[0, 1]</code>, where 0 and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1669",returnDescription:`
...
`}}),kt=new Je({props:{$$slots:{default:[Mf]},$$scope:{ctx:z}}}),yt=new Y({props:{anchor:"transformers.LukeForEntitySpanClassification.forward.example",$$slots:{default:[Pf]},$$scope:{ctx:z}}}),Bn=new Z({}),Un=new x({props:{name:"class transformers.LukeForSequenceClassification",anchor:"transformers.LukeForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LukeForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1800"}}),Hn=new x({props:{name:"forward",anchor:"transformers.LukeForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1813",returnDescription:`
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L2128"}}),Zn=new x({props:{name:"forward",anchor:"transformers.LukeForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L2141",returnDescription:`
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1913"}}),ro=new x({props:{name:"forward",anchor:"transformers.LukeForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the multiple choice classification loss. Indices should be in <code>[0, ..., num_choices-1]</code> where <code>num_choices</code> is the size of the second dimension of the input tensors. (See
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L1927",returnDescription:`
...
`}}),qt=new Je({props:{$$slots:{default:[Bf]},$$scope:{ctx:z}}}),Ct=new Y({props:{anchor:"transformers.LukeForTokenClassification.forward.example",$$slots:{default:[Uf]},$$scope:{ctx:z}}}),jt=new Y({props:{anchor:"transformers.LukeForTokenClassification.forward.example-2",$$slots:{default:[Kf]},$$scope:{ctx:z}}}),io=new Z({}),lo=new x({props:{name:"class transformers.LukeForQuestionAnswering",anchor:"transformers.LukeForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LukeForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L2008"}}),uo=new x({props:{name:"forward",anchor:"transformers.LukeForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/luke/modeling_luke.py#L2020",returnDescription:`
...
extractive and cloze-style question answering, entity typing, and relation classification.`),Xa=h(),ko=a("p"),mi=o("The abstract from the paper is the following:"),Za=h(),yo=a("p"),vs=a("em"),fi=o(`Entity representations are useful in natural language tasks involving entities. In this paper, we propose new
...
answering).`),er=h(),bo=a("p"),gi=o("Tips:"),tr=h(),ee=a("ul"),Ts=a("li"),Qt=a("p"),_i=o("This implementation is the same as "),vo=a("a"),ki=o("RobertaModel"),yi=o(` with the addition of entity embeddings as well
as an entity-aware self-attention mechanism, which improves performance on tasks involving reasoning about entities.`),bi=h(),ws=a("li"),j=a("p"),vi=o("LUKE treats entities as input tokens; therefore, it takes "),Ls=a("code"),Ti=o("entity_ids"),wi=o(", "),$s=a("code"),Li=o("entity_attention_mask"),$i=o(`,
...
`),To=a("a"),qi=o("LukeTokenizer"),Ci=o("."),ji=h(),Ht=a("li"),te=a("p"),wo=a("a"),Mi=o("LukeTokenizer"),Pi=o(" takes "),xs=a("code"),Ai=o("entities"),Si=o(" and "),Fs=a("code"),Oi=o("entity_spans"),Ii=o(` (character-based start and end
...
Wikipedia entities. The brief description when inputting these entities are as follows:`),Wi=h(),Vt=a("ul"),Lo=a("li"),Cs=a("em"),Bi=o("Inputting [MASK] entities to compute entity representations"),Ui=o(`: The [MASK] entity is used to mask entities to be
...
`),Os=a("code"),_l=o('task="entity_span_classification"'),kl=o(". Please refer to the example code of each head models."),yl=h(),ze=a("p"),bl=o("A demo notebook on how to fine-tune "),Co=a("a"),vl=o("LukeForEntityPairClassification"),Tl=o(` for relation
classification can be found `),Jt=a("a"),wl=o("here"),Ll=o("."),$l=h(),Xt=a("p"),zl=o(`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
the HuggingFace implementation of LUKE. They can be found `),Zt=a("a"),El=o("here"),xl=o("."),nr=h(),jo=a("p"),Fl=o("Example:"),or=h(),b(en.$$.fragment),sr=h(),ne=a("p"),ql=o("This model was contributed by "),tn=a("a"),Cl=o("ikuyamada"),jl=o(" and "),nn=a("a"),Ml=o("nielsr"),Pl=o(". The original code can be found "),on=a("a"),Al=o("here"),Sl=o("."),ar=h(),Ee=a("h2"),nt=a("a"),Is=a("span"),b(sn.$$.fragment),Ol=h(),Ns=a("span"),Il=o("LukeConfig"),rr=h(),X=a("div"),b(an.$$.fragment),Nl=h(),xe=a("p"),Dl=o("This is the configuration class to store the configuration of a "),Mo=a("a"),Wl=o("LukeModel"),Bl=o(`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LUKE
`),rn=a("a"),Ul=o("studio-ousia/luke-base"),Kl=o(" architecture."),Rl=h(),Fe=a("p"),Ql=o("Configuration objects inherit from "),Po=a("a"),Hl=o("PretrainedConfig"),Vl=o(` and can be used to control the model outputs. Read the
documentation from `),Ao=a("a"),Yl=o("PretrainedConfig"),Gl=o(" for more information."),Jl=h(),b(ot.$$.fragment),ir=h(),qe=a("h2"),st=a("a"),Ds=a("span"),b(ln.$$.fragment),Xl=h(),Ws=a("span"),Zl=o("LukeTokenizer"),lr=h(),M=a("div"),b(dn.$$.fragment),ed=h(),Bs=a("p"),td=o("Construct a LUKE tokenizer."),nd=h(),F=a("p"),od=o("This tokenizer inherits from "),So=a("a"),sd=o("RobertaTokenizer"),ad=o(` which contains most of the main methods. Users should refer to
...
also creates entity sequences, namely `),Us=a("code"),cd=o("entity_ids"),pd=o(", "),Ks=a("code"),hd=o("entity_attention_mask"),ud=o(", "),Rs=a("code"),md=o("entity_token_type_ids"),fd=o(`, and
...
sequences, depending on the task you want to prepare them for.`),vd=h(),No=a("div"),b(pn.$$.fragment),dr=h(),Ce=a("h2"),rt=a("a"),Vs=a("span"),b(hn.$$.fragment),Td=h(),Ys=a("span"),wd=o("LukeModel"),cr=h(),P=a("div"),b(un.$$.fragment),Ld=h(),Gs=a("p"),$d=o("The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),zd=h(),mn=a("p"),Ed=o("This model inherits from "),Do=a("a"),xd=o("PreTrainedModel"),Fd=o(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Pd=h(),oe=a("div"),b(_n.$$.fragment),Ad=h(),je=a("p"),Sd=o("The "),Wo=a("a"),Od=o("LukeModel"),Id=o(" forward method, overrides the "),Js=a("code"),Nd=o("__call__"),Dd=o(" special method."),Wd=h(),b(it.$$.fragment),Bd=h(),b(lt.$$.fragment),pr=h(),Me=a("h2"),dt=a("a"),Xs=a("span"),b(kn.$$.fragment),Ud=h(),Zs=a("span"),Kd=o("LukeForMaskedLM"),hr=h(),A=a("div"),b(yn.$$.fragment),Rd=h(),ea=a("p"),Qd=o(`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),Hd=h(),bn=a("p"),Vd=o("This model inherits from "),Bo=a("a"),Yd=o("PreTrainedModel"),Gd=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jd=h(),vn=a("p"),Xd=o("This model is also a PyTorch "),Tn=a("a"),Zd=o("torch.nn.Module"),ec=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tc=h(),ce=a("div"),b(wn.$$.fragment),nc=h(),Pe=a("p"),oc=o("The "),Uo=a("a"),sc=o("LukeForMaskedLM"),ac=o(" forward method, overrides the "),ta=a("code"),rc=o("__call__"),ic=o(" special method."),lc=h(),b(ct.$$.fragment),ur=h(),Ae=a("h2"),pt=a("a"),na=a("span"),b(Ln.$$.fragment),dc=h(),oa=a("span"),cc=o("LukeForEntityClassification"),mr=h(),S=a("div"),b($n.$$.fragment),pc=h(),sa=a("p"),hc=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bc=h(),ae=a("div"),b(An.$$.fragment),Uc=h(),Ie=a("p"),Kc=o("The "),Ho=a("a"),Rc=o("LukeForEntityPairClassification"),Qc=o(" forward method, overrides the "),da=a("code"),Hc=o("__call__"),Vc=o(" special method."),Yc=h(),b(ft.$$.fragment),Gc=h(),b(gt.$$.fragment),_r=h(),Ne=a("h2"),_t=a("a"),ca=a("span"),b(Sn.$$.fragment),Jc=h(),pa=a("span"),Xc=o("LukeForEntitySpanClassification"),kr=h(),I=a("div"),b(On.$$.fragment),Zc=h(),ha=a("p"),ep=o(`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dp=h(),re=a("div"),b(Wn.$$.fragment),cp=h(),De=a("p"),pp=o("The "),Yo=a("a"),hp=o("LukeForEntitySpanClassification"),up=o(" forward method, overrides the "),ua=a("code"),mp=o("__call__"),fp=o(" special method."),gp=h(),b(kt.$$.fragment),_p=h(),b(yt.$$.fragment),yr=h(),We=a("h2"),bt=a("a"),ma=a("span"),b(Bn.$$.fragment),kp=h(),fa=a("span"),yp=o("LukeForSequenceClassification"),br=h(),N=a("div"),b(Un.$$.fragment),bp=h(),ga=a("p"),vp=o(`The LUKE Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Tp=h(),Kn=a("p"),wp=o("This model inherits from "),Go=a("a"),Lp=o("PreTrainedModel"),$p=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zp=h(),Rn=a("p"),Ep=o("This model is also a PyTorch "),Qn=a("a"),xp=o("torch.nn.Module"),Fp=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qp=h(),q=a("div"),b(Hn.$$.fragment),Cp=h(),Be=a("p"),jp=o("The "),Jo=a("a"),Mp=o("LukeForSequenceClassification"),Pp=o(" forward method, overrides the "),_a=a("code"),Ap=o("__call__"),Sp=o(" special method."),Op=h(),b(vt.$$.fragment),Ip=h(),b(Tt.$$.fragment),Np=h(),b(wt.$$.fragment),Dp=h(),b(Lt.$$.fragment),Wp=h(),b($t.$$.fragment),vr=h(),Ue=a("h2"),zt=a("a"),ka=a("span"),b(Vn.$$.fragment),Bp=h(),ya=a("span"),Up=o("LukeForMultipleChoice"),Tr=h(),D=a("div"),b(Yn.$$.fragment),Kp=h(),ba=a("p"),Rp=o(`The LUKE Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eh=h(),ie=a("div"),b(Zn.$$.fragment),th=h(),Ke=a("p"),nh=o("The "),Zo=a("a"),oh=o("LukeForMultipleChoice"),sh=o(" forward method, overrides the "),va=a("code"),ah=o("__call__"),rh=o(" special method."),ih=h(),b(Et.$$.fragment),lh=h(),b(xt.$$.fragment),wr=h(),Re=a("h2"),Ft=a("a"),Ta=a("span"),b(eo.$$.fragment),dh=h(),wa=a("span"),ch=o("LukeForTokenClassification"),Lr=h(),W=a("div"),b(to.$$.fragment),ph=h(),no=a("p"),hh=o(`The LUKE Model with a token classification head on top (a linear layer on top of the hidden-states output). To
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yh=h(),so=a("p"),bh=o("This model is also a PyTorch "),ao=a("a"),vh=o("torch.nn.Module"),Th=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wh=h(),Q=a("div"),b(ro.$$.fragment),Lh=h(),Qe=a("p"),$h=o("The "),ts=a("a"),zh=o("LukeForTokenClassification"),Eh=o(" forward method, overrides the "),$a=a("code"),xh=o("__call__"),Fh=o(" special method."),qh=h(),b(qt.$$.fragment),Ch=h(),b(Ct.$$.fragment),jh=h(),b(jt.$$.fragment),$r=h(),He=a("h2"),Mt=a("a"),za=a("span"),b(io.$$.fragment),Mh=h(),Ea=a("span"),Ph=o("LukeForQuestionAnswering"),zr=h(),B=a("div"),b(lo.$$.fragment),Ah=h(),Ve=a("p"),Sh=o(`The LUKE Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),xa=a("code"),Oh=o("span start logits"),Ih=o(" and "),Fa=a("code"),Nh=o("span end logits"),Dh=o(")."),Wh=h(),co=a("p"),Bh=o("This model inherits from "),ns=a("a"),Uh=o("PreTrainedModel"),Kh=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rh=h(),po=a("p"),Qh=o("This model is also a PyTorch "),ho=a("a"),Hh=o("torch.nn.Module"),Vh=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yh=h(),H=a("div"),b(uo.$$.fragment),Gh=h(),Ye=a("p"),Jh=o("The "),os=a("a"),Xh=o("LukeForQuestionAnswering"),Zh=o(" forward method, overrides the "),qa=a("code"),eu=o("__call__"),tu=o(" special method."),nu=h(),b(Pt.$$.fragment),ou=h(),b(At.$$.fragment),su=h(),b(St.$$.fragment),this.h()},l(n){const g=wf('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(t),_=u(n),c=r(n,"H1",{class:!0});var mo=i(c);f=r(mo,"A",{id:!0,class:!0,href:!0});var Ca=i(f);y=r(Ca,"SPAN",{});var ja=i(y);v(l.$$.fragment,ja),ja.forEach(t),Ca.forEach(t),m=u(mo),E=r(mo,"SPAN",{});var Ma=i(E);li=s(Ma,"LUKE"),Ma.forEach(t),mo.forEach(t),Ga=u(n),Le=r(n,"H2",{class:!0});var fo=i(Le);Xe=r(fo,"A",{id:!0,class:!0,href:!0});var Pa=i(Xe);ys=r(Pa,"SPAN",{});var Aa=i(ys);v(Kt.$$.fragment,Aa),Aa.forEach(t),Pa.forEach(t),di=u(fo),bs=r(fo,"SPAN",{});var Sa=i(bs);ci=s(Sa,"Overview"),Sa.forEach(t),fo.forEach(t),Ja=u(n),Ze=r(n,"P",{});var go=i(Ze);pi=s(go,"The LUKE model was proposed in "),Rt=r(go,"A",{href:!0,rel:!0});var Oa=i(Rt);hi=s(Oa,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),Oa.forEach(t),ui=s(go,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
extractive and cloze-style question answering, entity typing, and relation classification.`),go.forEach(t),Xa=u(n),ko=r(n,"P",{});var Ia=i(ko);mi=s(Ia,"The abstract from the paper is the following:"),Ia.forEach(t),Za=u(n),yo=r(n,"P",{});var Na=i(yo);vs=r(Na,"EM",{});var Da=i(vs);fi=s(Da,`Entity representations are useful in natural language tasks involving entities. In this paper, we propose new
pretrained contextualized representations of words and entities based on the bidirectional transformer. The proposed
model treats words and entities in a given text as independent tokens, and outputs contextualized representations of
them. Our model is trained using a new pretraining task based on the masked language model of BERT. The task involves
predicting randomly masked words and entities in a large entity-annotated corpus retrieved from Wikipedia. We also
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),Da.forEach(t),Na.forEach(t),er=u(n),bo=r(n,"P",{});var Wa=i(bo);gi=s(Wa,"Tips:"),Wa.forEach(t),tr=u(n),ee=r(n,"UL",{});var le=i(ee);Ts=r(le,"LI",{});var Ba=i(Ts);Qt=r(Ba,"P",{});var _o=i(Qt);_i=s(_o,"This implementation is the same as "),vo=r(_o,"A",{href:!0});var Ua=i(vo);ki=s(Ua,"RobertaModel"),Ua.forEach(t),yi=s(_o,` with the addition of entity embeddings as well
as an entity-aware self-attention mechanism, which improves performance on tasks involving reasoning about entities.`),_o.forEach(t),Ba.forEach(t),bi=u(le),ws=r(le,"LI",{});var Ka=i(ws);j=r(Ka,"P",{});var U=i(j);vi=s(U,"LUKE treats entities as input tokens; therefore, it takes "),Ls=r(U,"CODE",{});var Ra=i(Ls);Ti=s(Ra,"entity_ids"),Ra.forEach(t),wi=s(U,", "),$s=r(U,"CODE",{});var Qa=i($s);Li=s(Qa,"entity_attention_mask"),Qa.forEach(t),$i=s(U,`,
`),zs=r(U,"CODE",{});var Ha=i(zs);zi=s(Ha,"entity_token_type_ids"),Ha.forEach(t),Ei=s(U," and "),Es=r(U,"CODE",{});var lu=i(Es);xi=s(lu,"entity_position_ids"),lu.forEach(t),Fi=s(U,` as extra input. You can obtain those using
`),To=r(U,"A",{href:!0});var du=i(To);qi=s(du,"LukeTokenizer"),du.forEach(t),Ci=s(U,"."),U.forEach(t),Ka.forEach(t),ji=u(le),Ht=r(le,"LI",{});var xr=i(Ht);te=r(xr,"P",{});var Ge=i(te);wo=r(Ge,"A",{href:!0});var cu=i(wo);Mi=s(cu,"LukeTokenizer"),cu.forEach(t),Pi=s(Ge," takes "),xs=r(Ge,"CODE",{});var pu=i(xs);Ai=s(pu,"entities"),pu.forEach(t),Si=s(Ge," and "),Fs=r(Ge,"CODE",{});var hu=i(Fs);Oi=s(hu,"entity_spans"),hu.forEach(t),Ii=s(Ge,` (character-based start and end
...
Wikipedia entities. The brief description when inputting these entities are as follows:`),Ge.forEach(t),Wi=u(xr),Vt=r(xr,"UL",{});var Fr=i(Vt);Lo=r(Fr,"LI",{});var au=i(Lo);Cs=r(au,"EM",{});var mu=i(Cs);Bi=s(mu,"Inputting [MASK] entities to compute entity representations"),mu.forEach(t),Ui=s(au,`: The [MASK] entity is used to mask entities to be
predicted during pretraining. When LUKE receives the [MASK] entity, it tries to predict the original entity by
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
...
model places a linear head on top of the concatenated output representation of the pair of given entities.`),Ya.forEach(t),al=u(ss),xo=r(ss,"LI",{});var iu=i(xo);Fo=r(iu,"A",{href:!0});var vu=i(Fo);rl=s(vu,"LukeForEntitySpanClassification"),vu.forEach(t),il=s(iu,`, for tasks to classify the sequence of entity spans, such as
named entity recognition (NER). This model places a linear head on top of the output entity representations. You
can address NER using this model by inputting all possible entity spans in the text to the model.`),iu.forEach(t),ss.forEach(t),ll=u(pe),R=r(pe,"P",{});var de=i(R);qo=r(de,"A",{href:!0});var Tu=i(qo);dl=s(Tu,"LukeTokenizer"),Tu.forEach(t),cl=s(de," has a "),Ps=r(de,"CODE",{});var wu=i(Ps);pl=s(wu,"task"),wu.forEach(t),hl=s(de,` argument, which enables you to easily create an input to these
...
`),Os=r(de,"CODE",{});var zu=i(Os);_l=s(zu,'task="entity_span_classification"'),zu.forEach(t),kl=s(de,". Please refer to the example code of each head models."),de.forEach(t),yl=u(pe),ze=r(pe,"P",{});var as=i(ze);bl=s(as,"A demo notebook on how to fine-tune "),Co=r(as,"A",{href:!0});var Eu=i(Co);vl=s(Eu,"LukeForEntityPairClassification"),Eu.forEach(t),Tl=s(as,` for relation
classification can be found `),Jt=r(as,"A",{href:!0,rel:!0});var xu=i(Jt);wl=s(xu,"here"),xu.forEach(t),Ll=s(as,"."),as.forEach(t),$l=u(pe),Xt=r(pe,"P",{});var qr=i(Xt);zl=s(qr,`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
the HuggingFace implementation of LUKE. They can be found `),Zt=r(qr,"A",{href:!0,rel:!0});var Fu=i(Zt);El=s(Fu,"here"),Fu.forEach(t),xl=s(qr,"."),qr.forEach(t),pe.forEach(t),le.forEach(t),nr=u(n),jo=r(n,"P",{});var qu=i(jo);Fl=s(qu,"Example:"),qu.forEach(t),or=u(n),v(en.$$.fragment,n),sr=u(n),ne=r(n,"P",{});var Ot=i(ne);ql=s(Ot,"This model was contributed by "),tn=r(Ot,"A",{href:!0,rel:!0});var Cu=i(tn);Cl=s(Cu,"ikuyamada"),Cu.forEach(t),jl=s(Ot," and "),nn=r(Ot,"A",{href:!0,rel:!0});var ju=i(nn);Ml=s(ju,"nielsr"),ju.forEach(t),Pl=s(Ot,". The original code can be found "),on=r(Ot,"A",{href:!0,rel:!0});var Mu=i(on);Al=s(Mu,"here"),Mu.forEach(t),Sl=s(Ot,"."),Ot.forEach(t),ar=u(n),Ee=r(n,"H2",{class:!0});var Cr=i(Ee);nt=r(Cr,"A",{id:!0,class:!0,href:!0});var Pu=i(nt);Is=r(Pu,"SPAN",{});var Au=i(Is);v(sn.$$.fragment,Au),Au.forEach(t),Pu.forEach(t),Ol=u(Cr),Ns=r(Cr,"SPAN",{});var Su=i(Ns);Il=s(Su,"LukeConfig"),Su.forEach(t),Cr.forEach(t),rr=u(n),X=r(n,"DIV",{class:!0});var It=i(X);v(an.$$.fragment,It),Nl=u(It),xe=r(It,"P",{});var rs=i(xe);Dl=s(rs,"This is the configuration class to store the configuration of a "),Mo=r(rs,"A",{href:!0});var Ou=i(Mo);Wl=s(Ou,"LukeModel"),Ou.forEach(t),Bl=s(rs,`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LUKE
`),rn=r(rs,"A",{href:!0,rel:!0});var Iu=i(rn);Ul=s(Iu,"studio-ousia/luke-base"),Iu.forEach(t),Kl=s(rs," architecture."),rs.forEach(t),Rl=u(It),Fe=r(It,"P",{});var is=i(Fe);Ql=s(is,"Configuration objects inherit from "),Po=r(is,"A",{href:!0});var Nu=i(Po);Hl=s(Nu,"PretrainedConfig"),Nu.forEach(t),Vl=s(is,` and can be used to control the model outputs. Read the
documentation from `),Ao=r(is,"A",{href:!0});var Du=i(Ao);Yl=s(Du,"PretrainedConfig"),Du.forEach(t),Gl=s(is," for more information."),is.forEach(t),Jl=u(It),v(ot.$$.fragment,It),It.forEach(t),ir=u(n),qe=r(n,"H2",{class:!0});var jr=i(qe);st=r(jr,"A",{id:!0,class:!0,href:!0});var Wu=i(st);Ds=r(Wu,"SPAN",{});var Bu=i(Ds);v(ln.$$.fragment,Bu),Bu.forEach(t),Wu.forEach(t),Xl=u(jr),Ws=r(jr,"SPAN",{});var Uu=i(Ws);Zl=s(Uu,"LukeTokenizer"),Uu.forEach(t),jr.forEach(t),lr=u(n),M=r(n,"DIV",{class:!0});var he=i(M);v(dn.$$.fragment,he),ed=u(he),Bs=r(he,"P",{});var Ku=i(Bs);td=s(Ku,"Construct a LUKE tokenizer."),Ku.forEach(t),nd=u(he),F=r(he,"P",{});var C=i(F);od=s(C,"This tokenizer inherits from "),So=r(C,"A",{href:!0});var Ru=i(So);sd=s(Ru,"RobertaTokenizer"),Ru.forEach(t),ad=s(C,` which contains most of the main methods. Users should refer to
...
also creates entity sequences, namely `),Us=r(C,"CODE",{});var Vu=i(Us);cd=s(Vu,"entity_ids"),Vu.forEach(t),pd=s(C,", "),Ks=r(C,"CODE",{});var Yu=i(Ks);hd=s(Yu,"entity_attention_mask"),Yu.forEach(t),ud=s(C,", "),Rs=r(C,"CODE",{});var Gu=i(Rs);md=s(Gu,"entity_token_type_ids"),Gu.forEach(t),fd=s(C,`, and
`),Qs=r(C,"CODE",{});var Ju=i(Qs);gd=s(Ju,"entity_position_ids"),Ju.forEach(t),_d=s(C," to be used by the LUKE model."),C.forEach(t),kd=u(he),at=r(he,"DIV",{class:!0});var Mr=i(at);v(cn.$$.fragment,Mr),yd=u(Mr),Hs=r(Mr,"P",{});var Xu=i(Hs);bd=s(Xu,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Xu.forEach(t),Mr.forEach(t),vd=u(he),No=r(he,"DIV",{class:!0});var Zu=i(No);v(pn.$$.fragment,Zu),Zu.forEach(t),he.forEach(t),dr=u(n),Ce=r(n,"H2",{class:!0});var Pr=i(Ce);rt=r(Pr,"A",{id:!0,class:!0,href:!0});var em=i(rt);Vs=r(em,"SPAN",{});var tm=i(Vs);v(hn.$$.fragment,tm),tm.forEach(t),em.forEach(t),Td=u(Pr),Ys=r(Pr,"SPAN",{});var nm=i(Ys);wd=s(nm,"LukeModel"),nm.forEach(t),Pr.forEach(t),cr=u(n),P=r(n,"DIV",{class:!0});var ue=i(P);v(un.$$.fragment,ue),Ld=u(ue),Gs=r(ue,"P",{});var om=i(Gs);$d=s(om,"The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),om.forEach(t),zd=u(ue),mn=r(ue,"P",{});var Ar=i(mn);Ed=s(Ar,"This model inherits from "),Do=r(Ar,"A",{href:!0});var sm=i(Do);xd=s(sm,"PreTrainedModel"),sm.forEach(t),Fd=s(Ar,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sr.forEach(t),Pd=u(ue),oe=r(ue,"DIV",{class:!0});var Nt=i(oe);v(_n.$$.fragment,Nt),Ad=u(Nt),je=r(Nt,"P",{});var ls=i(je);Sd=s(ls,"The "),Wo=r(ls,"A",{href:!0});var rm=i(Wo);Od=s(rm,"LukeModel"),rm.forEach(t),Id=s(ls," forward method, overrides the "),Js=r(ls,"CODE",{});var im=i(Js);Nd=s(im,"__call__"),im.forEach(t),Dd=s(ls," special method."),ls.forEach(t),Wd=u(Nt),v(it.$$.fragment,Nt),Bd=u(Nt),v(lt.$$.fragment,Nt),Nt.forEach(t),ue.forEach(t),pr=u(n),Me=r(n,"H2",{class:!0});var Or=i(Me);dt=r(Or,"A",{id:!0,class:!0,href:!0});var lm=i(dt);Xs=r(lm,"SPAN",{});var dm=i(Xs);v(kn.$$.fragment,dm),dm.forEach(t),lm.forEach(t),Ud=u(Or),Zs=r(Or,"SPAN",{});var cm=i(Zs);Kd=s(cm,"LukeForMaskedLM"),cm.forEach(t),Or.forEach(t),hr=u(n),A=r(n,"DIV",{class:!0});var me=i(A);v(yn.$$.fragment,me),Rd=u(me),ea=r(me,"P",{});var pm=i(ea);Qd=s(pm,`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),pm.forEach(t),Hd=u(me),bn=r(me,"P",{});var Ir=i(bn);Vd=s(Ir,"This model inherits from "),Bo=r(Ir,"A",{href:!0});var hm=i(Bo);Yd=s(hm,"PreTrainedModel"),hm.forEach(t),Gd=s(Ir,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ir.forEach(t),Jd=u(me),vn=r(me,"P",{});var Nr=i(vn);Xd=s(Nr,"This model is also a PyTorch "),Tn=r(Nr,"A",{href:!0,rel:!0});var um=i(Tn);Zd=s(um,"torch.nn.Module"),um.forEach(t),ec=s(Nr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nr.forEach(t),tc=u(me),ce=r(me,"DIV",{class:!0});var ds=i(ce);v(wn.$$.fragment,ds),nc=u(ds),Pe=r(ds,"P",{});var cs=i(Pe);oc=s(cs,"The "),Uo=r(cs,"A",{href:!0});var mm=i(Uo);sc=s(mm,"LukeForMaskedLM"),mm.forEach(t),ac=s(cs," forward method, overrides the "),ta=r(cs,"CODE",{});var fm=i(ta);rc=s(fm,"__call__"),fm.forEach(t),ic=s(cs," special method."),cs.forEach(t),lc=u(ds),v(ct.$$.fragment,ds),ds.forEach(t),me.forEach(t),ur=u(n),Ae=r(n,"H2",{class:!0});var Dr=i(Ae);pt=r(Dr,"A",{id:!0,class:!0,href:!0});var gm=i(pt);na=r(gm,"SPAN",{});var _m=i(na);v(Ln.$$.fragment,_m),_m.forEach(t),gm.forEach(t),dc=u(Dr),oa=r(Dr,"SPAN",{});var km=i(oa);cc=s(km,"LukeForEntityClassification"),km.forEach(t),Dr.forEach(t),mr=u(n),S=r(n,"DIV",{class:!0});var fe=i(S);v($n.$$.fragment,fe),pc=u(fe),sa=r(fe,"P",{});var ym=i(sa);hc=s(ym,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wr.forEach(t),_c=u(fe),En=r(fe,"P",{});var Br=i(En);kc=s(Br,"This model is also a PyTorch "),xn=r(Br,"A",{href:!0,rel:!0});var vm=i(xn);yc=s(vm,"torch.nn.Module"),vm.forEach(t),bc=s(Br,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Br.forEach(t),vc=u(fe),se=r(fe,"DIV",{class:!0});var Dt=i(se);v(Fn.$$.fragment,Dt),Tc=u(Dt),Se=r(Dt,"P",{});var ps=i(Se);wc=s(ps,"The "),Ro=r(ps,"A",{href:!0});var Tm=i(Ro);Lc=s(Tm,"LukeForEntityClassification"),Tm.forEach(t),$c=s(ps," forward method, overrides the "),aa=r(ps,"CODE",{});var wm=i(aa);zc=s(wm,"__call__"),wm.forEach(t),Ec=s(ps," special method."),ps.forEach(t),xc=u(Dt),v(ht.$$.fragment,Dt),Fc=u(Dt),v(ut.$$.fragment,Dt),Dt.forEach(t),fe.forEach(t),fr=u(n),Oe=r(n,"H2",{class:!0});var Ur=i(Oe);mt=r(Ur,"A",{id:!0,class:!0,href:!0});var Lm=i(mt);ra=r(Lm,"SPAN",{});var $m=i(ra);v(qn.$$.fragment,$m),$m.forEach(t),Lm.forEach(t),qc=u(Ur),ia=r(Ur,"SPAN",{});var zm=i(ia);Cc=s(zm,"LukeForEntityPairClassification"),zm.forEach(t),Ur.forEach(t),gr=u(n),O=r(n,"DIV",{class:!0});var ge=i(O);v(Cn.$$.fragment,ge),jc=u(ge),la=r(ge,"P",{});var Em=i(la);Mc=s(Em,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr.forEach(t),Bc=u(ge),ae=r(ge,"DIV",{class:!0});var Wt=i(ae);v(An.$$.fragment,Wt),Uc=u(Wt),Ie=r(Wt,"P",{});var hs=i(Ie);Kc=s(hs,"The "),Ho=r(hs,"A",{href:!0});var qm=i(Ho);Rc=s(qm,"LukeForEntityPairClassification"),qm.forEach(t),Qc=s(hs," forward method, overrides the "),da=r(hs,"CODE",{});var Cm=i(da);Hc=s(Cm,"__call__"),Cm.forEach(t),Vc=s(hs," special method."),hs.forEach(t),Yc=u(Wt),v(ft.$$.fragment,Wt),Gc=u(Wt),v(gt.$$.fragment,Wt),Wt.forEach(t),ge.forEach(t),_r=u(n),Ne=r(n,"H2",{class:!0});var Qr=i(Ne);_t=r(Qr,"A",{id:!0,class:!0,href:!0});var jm=i(_t);ca=r(jm,"SPAN",{});var Mm=i(ca);v(Sn.$$.fragment,Mm),Mm.forEach(t),jm.forEach(t),Jc=u(Qr),pa=r(Qr,"SPAN",{});var Pm=i(pa);Xc=s(Pm,"LukeForEntitySpanClassification"),Pm.forEach(t),Qr.forEach(t),kr=u(n),I=r(n,"DIV",{class:!0});var _e=i(I);v(On.$$.fragment,_e),Zc=u(_e),ha=r(_e,"P",{});var Am=i(ha);ep=s(Am,`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vr.forEach(t),dp=u(_e),re=r(_e,"DIV",{class:!0});var Bt=i(re);v(Wn.$$.fragment,Bt),cp=u(Bt),De=r(Bt,"P",{});var us=i(De);pp=s(us,"The "),Yo=r(us,"A",{href:!0});var Im=i(Yo);hp=s(Im,"LukeForEntitySpanClassification"),Im.forEach(t),up=s(us," forward method, overrides the "),ua=r(us,"CODE",{});var Nm=i(ua);mp=s(Nm,"__call__"),Nm.forEach(t),fp=s(us," special method."),us.forEach(t),gp=u(Bt),v(kt.$$.fragment,Bt),_p=u(Bt),v(yt.$$.fragment,Bt),Bt.forEach(t),_e.forEach(t),yr=u(n),We=r(n,"H2",{class:!0});var Yr=i(We);bt=r(Yr,"A",{id:!0,class:!0,href:!0});var Dm=i(bt);ma=r(Dm,"SPAN",{});var Wm=i(ma);v(Bn.$$.fragment,Wm),Wm.forEach(t),Dm.forEach(t),kp=u(Yr),fa=r(Yr,"SPAN",{});var Bm=i(fa);yp=s(Bm,"LukeForSequenceClassification"),Bm.forEach(t),Yr.forEach(t),br=u(n),N=r(n,"DIV",{class:!0});var ke=i(N);v(Un.$$.fragment,ke),bp=u(ke),ga=r(ke,"P",{});var Um=i(ga);vp=s(Um,`The LUKE Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Um.forEach(t),Tp=u(ke),Kn=r(ke,"P",{});var Gr=i(Kn);wp=s(Gr,"This model inherits from "),Go=r(Gr,"A",{href:!0});var Km=i(Go);Lp=s(Km,"PreTrainedModel"),Km.forEach(t),$p=s(Gr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jr.forEach(t),qp=u(ke),q=r(ke,"DIV",{class:!0});var V=i(q);v(Hn.$$.fragment,V),Cp=u(V),Be=r(V,"P",{});var ms=i(Be);jp=s(ms,"The "),Jo=r(ms,"A",{href:!0});var Qm=i(Jo);Mp=s(Qm,"LukeForSequenceClassification"),Qm.forEach(t),Pp=s(ms," forward method, overrides the "),_a=r(ms,"CODE",{});var Hm=i(_a);Ap=s(Hm,"__call__"),Hm.forEach(t),Sp=s(ms," special method."),ms.forEach(t),Op=u(V),v(vt.$$.fragment,V),Ip=u(V),v(Tt.$$.fragment,V),Np=u(V),v(wt.$$.fragment,V),Dp=u(V),v(Lt.$$.fragment,V),Wp=u(V),v($t.$$.fragment,V),V.forEach(t),ke.forEach(t),vr=u(n),Ue=r(n,"H2",{class:!0});var Xr=i(Ue);zt=r(Xr,"A",{id:!0,class:!0,href:!0});var Vm=i(zt);ka=r(Vm,"SPAN",{});var Ym=i(ka);v(Vn.$$.fragment,Ym),Ym.forEach(t),Vm.forEach(t),Bp=u(Xr),ya=r(Xr,"SPAN",{});var Gm=i(ya);Up=s(Gm,"LukeForMultipleChoice"),Gm.forEach(t),Xr.forEach(t),Tr=u(n),D=r(n,"DIV",{class:!0});var ye=i(D);v(Yn.$$.fragment,ye),Kp=u(ye),ba=r(ye,"P",{});var Jm=i(ba);Rp=s(Jm,`The LUKE Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ei.forEach(t),eh=u(ye),ie=r(ye,"DIV",{class:!0});var Ut=i(ie);v(Zn.$$.fragment,Ut),th=u(Ut),Ke=r(Ut,"P",{});var fs=i(Ke);nh=s(fs,"The "),Zo=r(fs,"A",{href:!0});var ef=i(Zo);oh=s(ef,"LukeForMultipleChoice"),ef.forEach(t),sh=s(fs," forward method, overrides the "),va=r(fs,"CODE",{});var tf=i(va);ah=s(tf,"__call__"),tf.forEach(t),rh=s(fs," special method."),fs.forEach(t),ih=u(Ut),v(Et.$$.fragment,Ut),lh=u(Ut),v(xt.$$.fragment,Ut),Ut.forEach(t),ye.forEach(t),wr=u(n),Re=r(n,"H2",{class:!0});var ti=i(Re);Ft=r(ti,"A",{id:!0,class:!0,href:!0});var nf=i(Ft);Ta=r(nf,"SPAN",{});var of=i(Ta);v(eo.$$.fragment,of),of.forEach(t),nf.forEach(t),dh=u(ti),wa=r(ti,"SPAN",{});var sf=i(wa);ch=s(sf,"LukeForTokenClassification"),sf.forEach(t),ti.forEach(t),Lr=u(n),W=r(n,"DIV",{class:!0});var be=i(W);v(to.$$.fragment,be),ph=u(be),no=r(be,"P",{});var ni=i(no);hh=s(ni,`The LUKE Model with a token classification head on top (a linear layer on top of the hidden-states output). To
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),oi.forEach(t),yh=u(be),so=r(be,"P",{});var si=i(so);bh=s(si,"This model is also a PyTorch "),ao=r(si,"A",{href:!0,rel:!0});var lf=i(ao);vh=s(lf,"torch.nn.Module"),lf.forEach(t),Th=s(si,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),si.forEach(t),wh=u(be),Q=r(be,"DIV",{class:!0});var ve=i(Q);v(ro.$$.fragment,ve),Lh=u(ve),Qe=r(ve,"P",{});var gs=i(Qe);$h=s(gs,"The "),ts=r(gs,"A",{href:!0});var df=i(ts);zh=s(df,"LukeForTokenClassification"),df.forEach(t),Eh=s(gs," forward method, overrides the "),$a=r(gs,"CODE",{});var cf=i($a);xh=s(cf,"__call__"),cf.forEach(t),Fh=s(gs," special method."),gs.forEach(t),qh=u(ve),v(qt.$$.fragment,ve),Ch=u(ve),v(Ct.$$.fragment,ve),jh=u(ve),v(jt.$$.fragment,ve),ve.forEach(t),be.forEach(t),$r=u(n),He=r(n,"H2",{class:!0});var ai=i(He);Mt=r(ai,"A",{id:!0,class:!0,href:!0});var pf=i(Mt);za=r(pf,"SPAN",{});var hf=i(za);v(io.$$.fragment,hf),hf.forEach(t),pf.forEach(t),Mh=u(ai),Ea=r(ai,"SPAN",{});var uf=i(Ea);Ph=s(uf,"LukeForQuestionAnswering"),uf.forEach(t),ai.forEach(t),zr=u(n),B=r(n,"DIV",{class:!0});var Te=i(B);v(lo.$$.fragment,Te),Ah=u(Te),Ve=r(Te,"P",{});var _s=i(Ve);Sh=s(_s,`The LUKE Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),xa=r(_s,"CODE",{});var mf=i(xa);Oh=s(mf,"span start logits"),mf.forEach(t),Ih=s(_s," and "),Fa=r(_s,"CODE",{});var ff=i(Fa);Nh=s(ff,"span end logits"),ff.forEach(t),Dh=s(_s,")."),_s.forEach(t),Wh=u(Te),co=r(Te,"P",{});var ri=i(co);Bh=s(ri,"This model inherits from "),ns=r(ri,"A",{href:!0});var gf=i(ns);Uh=s(gf,"PreTrainedModel"),gf.forEach(t),Kh=s(ri,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ri.forEach(t),Rh=u(Te),po=r(Te,"P",{});var ii=i(po);Qh=s(ii,"This model is also a PyTorch "),ho=r(ii,"A",{href:!0,rel:!0});var _f=i(ho);Hh=s(_f,"torch.nn.Module"),_f.forEach(t),Vh=s(ii,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ii.forEach(t),Yh=u(Te),H=r(Te,"DIV",{class:!0});var we=i(H);v(uo.$$.fragment,we),Gh=u(we),Ye=r(we,"P",{});var ks=i(Ye);Jh=s(ks,"The "),os=r(ks,"A",{href:!0});var kf=i(os);Xh=s(kf,"LukeForQuestionAnswering"),kf.forEach(t),Zh=s(ks," forward method, overrides the "),qa=r(ks,"CODE",{});var yf=i(qa);eu=s(yf,"__call__"),yf.forEach(t),tu=s(ks," special method."),ks.forEach(t),nu=u(we),v(Pt.$$.fragment,we),ou=u(we),v(At.$$.fragment,we),su=u(we),v(St.$$.fragment,we),we.forEach(t),Te.forEach(t),this.h()},h(){p(d,"name","hf:doc:metadata"),p(d,"content",JSON.stringify(Yf)),p(f,"id","luke"),p(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(f,"href","#luke"),p(c,"class","relative group"),p(Xe,"id","overview"),p(Xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Xe,"href","#overview"),p(Le,"class","relative group"),p(Rt,"href","https://arxiv.org/abs/2010.01057"),p(Rt,"rel","nofollow"),p(vo,"href","/docs/transformers/v4.24.0/en/model_doc/roberta#transformers.RobertaModel"),p(To,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer"),p(wo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer"),p(zo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForEntityClassification"),p(Yt,"href","https://www.cs.utexas.edu/~eunsol/html_pages/open_entity.html"),p(Yt,"rel","nofollow"),p(Eo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForEntityPairClassification"),p(Gt,"href","https://nlp.stanford.edu/projects/tacred/"),p(Gt,"rel","nofollow"),p(Fo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForEntitySpanClassification"),p(qo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer"),p(Co,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForEntityPairClassification"),p(Jt,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/LUKE"),p(Jt,"rel","nofollow"),p(Zt,"href","https://github.com/studio-ousia/luke/tree/master/notebooks"),p(Zt,"rel","nofollow"),p(tn,"href","https://huggingface.co/ikuyamada"),p(tn,"rel","nofollow"),p(nn,"href","https://huggingface.co/nielsr"),p(nn,"rel","nofollow"),p(on,"href","https://github.com/studio-ousia/luke"),p(on,"rel","nofollow"),p(nt,"id","transformers.LukeConfig"),p(nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(nt,"href","#transformers.LukeConfig"),p(Ee,"class","relative group"),p(Mo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeModel"),p(rn,"href","https://huggingface.co/studio-ousia/luke-base"),p(rn,"rel","nofollow"),p(Po,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ao,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),p(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(st,"id","transformers.LukeTokenizer"),p(st,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(st,"href","#transformers.LukeTokenizer"),p(qe,"class","relative group"),p(So,"href","/docs/transformers/v4.24.0/en/model_doc/roberta#transformers.RobertaTokenizer"),p(Oo,"href","/docs/transformers/v4.24.0/en/model_doc/roberta#transformers.RobertaTokenizer"),p(Io,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeTokenizer"),p(at,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(No,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(rt,"id","transformers.LukeModel"),p(rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(rt,"href","#transformers.LukeModel"),p(Ce,"class","relative group"),p(Do,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(gn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(gn,"rel","nofollow"),p(Wo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeModel"),p(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(dt,"id","transformers.LukeForMaskedLM"),p(dt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(dt,"href","#transformers.LukeForMaskedLM"),p(Me,"class","relative group"),p(Bo,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(Tn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Tn,"rel","nofollow"),p(Uo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForMaskedLM"),p(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(pt,"id","transformers.LukeForEntityClassification"),p(pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(pt,"href","#transformers.LukeForEntityClassification"),p(Ae,"class","relative group"),p(Ko,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(xn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(xn,"rel","nofollow"),p(Ro,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForEntityClassification"),p(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(mt,"id","transformers.LukeForEntityPairClassification"),p(mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(mt,"href","#transformers.LukeForEntityPairClassification"),p(Oe,"class","relative group"),p(Qo,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(Pn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Pn,"rel","nofollow"),p(Ho,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForEntityPairClassification"),p(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(_t,"id","transformers.LukeForEntitySpanClassification"),p(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(_t,"href","#transformers.LukeForEntitySpanClassification"),p(Ne,"class","relative group"),p(Vo,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(Dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Dn,"rel","nofollow"),p(Yo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForEntitySpanClassification"),p(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(bt,"id","transformers.LukeForSequenceClassification"),p(bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(bt,"href","#transformers.LukeForSequenceClassification"),p(We,"class","relative group"),p(Go,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(Qn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Qn,"rel","nofollow"),p(Jo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForSequenceClassification"),p(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(zt,"id","transformers.LukeForMultipleChoice"),p(zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(zt,"href","#transformers.LukeForMultipleChoice"),p(Ue,"class","relative group"),p(Xo,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(Xn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Xn,"rel","nofollow"),p(Zo,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForMultipleChoice"),p(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ft,"id","transformers.LukeForTokenClassification"),p(Ft,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ft,"href","#transformers.LukeForTokenClassification"),p(Re,"class","relative group"),p(es,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(ao,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(ao,"rel","nofollow"),p(ts,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForTokenClassification"),p(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Mt,"id","transformers.LukeForQuestionAnswering"),p(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Mt,"href","#transformers.LukeForQuestionAnswering"),p(He,"class","relative group"),p(ns,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),p(ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(ho,"rel","nofollow"),p(os,"href","/docs/transformers/v4.24.0/en/model_doc/luke#transformers.LukeForQuestionAnswering"),p(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,g){e(document.head,d),k(n,_,g),k(n,c,g),e(c,f),e(f,y),T(l,y,null),e(c,m),e(c,E),e(E,li),k(n,Ga,g),k(n,Le,g),e(Le,Xe),e(Xe,ys),T(Kt,ys,null),e(Le,di),e(Le,bs),e(bs,ci),k(n,Ja,g),k(n,Ze,g),e(Ze,pi),e(Ze,Rt),e(Rt,hi),e(Ze,ui),k(n,Xa,g),k(n,ko,g),e(ko,mi),k(n,Za,g),k(n,yo,g),e(yo,vs),e(vs,fi),k(n,er,g),k(n,bo,g),e(bo,gi),k(n,tr,g),k(n,ee,g),e(ee,Ts),e(Ts,Qt),e(Qt,_i),e(Qt,vo),e(vo,ki),e(Qt,yi),e(ee,bi),e(ee,ws),e(ws,j),e(j,vi),e(j,Ls),e(Ls,Ti),e(j,wi),e(j,$s),e($s,Li),e(j,$i),e(j,zs),e(zs,zi),e(j,Ei),e(j,Es),e(Es,xi),e(j,Fi),e(j,To),e(To,qi),e(j,Ci),e(ee,ji),e(ee,Ht),e(Ht,te),e(te,wo),e(wo,Mi),e(te,Pi),e(te,xs),e(xs,Ai),e(te,Si),e(te,Fs),e(Fs,Oi),e(te,Ii),e(te,qs),e(qs,Ni),e(te,Di),e(Ht,Wi),e(Ht,Vt),e(Vt,Lo),e(Lo,Cs),e(Cs,Bi),e(Lo,Ui),e(Vt,Ki),e(Vt,$o),e($o,js),e(js,Ri),e($o,Qi),e(ee,Hi),e(ee,J),e(J,Ms),e(Ms,Vi),e(J,Yi),e(J,$e),e($e,et),e(et,zo),e(zo,Gi),e(et,Ji),e(et,Yt),e(Yt,Xi),e(et,Zi),e($e,el),e($e,tt),e(tt,Eo),e(Eo,tl),e(tt,nl),e(tt,Gt),e(Gt,ol),e(tt,sl),e($e,al),e($e,xo),e(xo,Fo),e(Fo,rl),e(xo,il),e(J,ll),e(J,R),e(R,qo),e(qo,dl),e(R,cl),e(R,Ps),e(Ps,pl),e(R,hl),e(R,As),e(As,ul),e(R,ml),e(R,Ss),e(Ss,fl),e(R,gl),e(R,Os),e(Os,_l),e(R,kl),e(J,yl),e(J,ze),e(ze,bl),e(ze,Co),e(Co,vl),e(ze,Tl),e(ze,Jt),e(Jt,wl),e(ze,Ll),e(J,$l),e(J,Xt),e(Xt,zl),e(Xt,Zt),e(Zt,El),e(Xt,xl),k(n,nr,g),k(n,jo,g),e(jo,Fl),k(n,or,g),T(en,n,g),k(n,sr,g),k(n,ne,g),e(ne,ql),e(ne,tn),e(tn,Cl),e(ne,jl),e(ne,nn),e(nn,Ml),e(ne,Pl),e(ne,on),e(on,Al),e(ne,Sl),k(n,ar,g),k(n,Ee,g),e(Ee,nt),e(nt,Is),T(sn,Is,null),e(Ee,Ol),e(Ee,Ns),e(Ns,Il),k(n,rr,g),k(n,X,g),T(an,X,null),e(X,Nl),e(X,xe),e(xe,Dl),e(xe,Mo),e(Mo,Wl),e(xe,Bl),e(xe,rn),e(rn,Ul),e(xe,Kl),e(X,Rl),e(X,Fe),e(Fe,Ql),e(Fe,Po),e(Po,Hl),e(Fe,Vl),e(Fe,Ao),e(Ao,Yl),e(Fe,Gl),e(X,Jl),T(ot,X,null),k(n,ir,g),k(n,qe,g),e(qe,st),e(st,Ds),T(ln,Ds,null),e(qe,Xl),e(qe,Ws),e(Ws,Zl),k(n,lr,g),k(n,M,g),T(dn,M,null),e(M,ed),e(M,Bs),e(Bs,td),e(M,nd),e(M,F),e(F,od),e(F,So),e(So,sd),e(F,ad),e(F,Oo),e(Oo,rd),e(F,id),e(F,Io),e(Io,ld),e(F,dd),e(F,Us),e(Us,cd),e(F,pd),e(F,Ks),e(Ks,hd),e(F,ud),e(F,Rs),e(Rs,md),e(F,fd),e(F,Qs),e(Qs,gd),e(F,_d),e(M,kd),e(M,at),T(cn,at,null),e(at,yd),e(at,Hs),e(Hs,bd),e(M,vd),e(M,No),T(pn,No,null),k(n,dr,g),k(n,Ce,g),e(Ce,rt),e(rt,Vs),T(hn,Vs,null),e(Ce,Td),e(Ce,Ys),e(Ys,wd),k(n,cr,g),k(n,P,g),T(un,P,null),e(P,Ld),e(P,Gs),e(Gs,$d),e(P,zd),e(P,mn),e(mn,Ed),e(mn,Do),e(Do,xd),e(mn,Fd),e(P,qd),e(P,fn),e(fn,Cd),e(fn,gn),e(gn,jd),e(fn,Md),e(P,Pd),e(P,oe),T(_n,oe,null),e(oe,Ad),e(oe,je),e(je,Sd),e(je,Wo),e(Wo,Od),e(je,Id),e(je,Js),e(Js,Nd),e(je,Dd),e(oe,Wd),T(it,oe,null),e(oe,Bd),T(lt,oe,null),k(n,pr,g),k(n,Me,g),e(Me,dt),e(dt,Xs),T(kn,Xs,null),e(Me,Ud),e(Me,Zs),e(Zs,Kd),k(n,hr,g),k(n,A,g),T(yn,A,null),e(A,Rd),e(A,ea),e(ea,Qd),e(A,Hd),e(A,bn),e(bn,Vd),e(bn,Bo),e(Bo,Yd),e(bn,Gd),e(A,Jd),e(A,vn),e(vn,Xd),e(vn,Tn),e(Tn,Zd),e(vn,ec),e(A,tc),e(A,ce),T(wn,ce,null),e(ce,nc),e(ce,Pe),e(Pe,oc),e(Pe,Uo),e(Uo,sc),e(Pe,ac),e(Pe,ta),e(ta,rc),e(Pe,ic),e(ce,lc),T(ct,ce,null),k(n,ur,g),k(n,Ae,g),e(Ae,pt),e(pt,na),T(Ln,na,null),e(Ae,dc),e(Ae,oa),e(oa,cc),k(n,mr,g),k(n,S,g),T($n,S,null),e(S,pc),e(S,sa),e(sa,hc),e(S,uc),e(S,zn),e(zn,mc),e(zn,Ko),e(Ko,fc),e(zn,gc),e(S,_c),e(S,En),e(En,kc),e(En,xn),e(xn,yc),e(En,bc),e(S,vc),e(S,se),T(Fn,se,null),e(se,Tc),e(se,Se),e(Se,wc),e(Se,Ro),e(Ro,Lc),e(Se,$c),e(Se,aa),e(aa,zc),e(Se,Ec),e(se,xc),T(ht,se,null),e(se,Fc),T(ut,se,null),k(n,fr,g),k(n,Oe,g),e(Oe,mt),e(mt,ra),T(qn,ra,null),e(Oe,qc),e(Oe,ia),e(ia,Cc),k(n,gr,g),k(n,O,g),T(Cn,O,null),e(O,jc),e(O,la),e(la,Mc),e(O,Pc),e(O,jn),e(jn,Ac),e(jn,Qo),e(Qo,Sc),e(jn,Oc),e(O,Ic),e(O,Mn),e(Mn,Nc),e(Mn,Pn),e(Pn,Dc),e(Mn,Wc),e(O,Bc),e(O,ae),T(An,ae,null),e(ae,Uc),e(ae,Ie),e(Ie,Kc),e(Ie,Ho),e(Ho,Rc),e(Ie,Qc),e(Ie,da),e(da,Hc),e(Ie,Vc),e(ae,Yc),T(ft,ae,null),e(ae,Gc),T(gt,ae,null),k(n,_r,g),k(n,Ne,g),e(Ne,_t),e(_t,ca),T(Sn,ca,null),e(Ne,Jc),e(Ne,pa),e(pa,Xc),k(n,kr,g),k(n,I,g),T(On,I,null),e(I,Zc),e(I,ha),e(ha,ep),e(I,tp),e(I,In),e(In,np),e(In,Vo),e(Vo,op),e(In,sp),e(I,ap),e(I,Nn),e(Nn,rp),e(Nn,Dn),e(Dn,ip),e(Nn,lp),e(I,dp),e(I,re),T(Wn,re,null),e(re,cp),e(re,De),e(De,pp),e(De,Yo),e(Yo,hp),e(De,up),e(De,ua),e(ua,mp),e(De,fp),e(re,gp),T(kt,re,null),e(re,_p),T(yt,re,null),k(n,yr,g),k(n,We,g),e(We,bt),e(bt,ma),T(Bn,ma,null),e(We,kp),e(We,fa),e(fa,yp),k(n,br,g),k(n,N,g),T(Un,N,null),e(N,bp),e(N,ga),e(ga,vp),e(N,Tp),e(N,Kn),e(Kn,wp),e(Kn,Go),e(Go,Lp),e(Kn,$p),e(N,zp),e(N,Rn),e(Rn,Ep),e(Rn,Qn),e(Qn,xp),e(Rn,Fp),e(N,qp),e(N,q),T(Hn,q,null),e(q,Cp),e(q,Be),e(Be,jp),e(Be,Jo),e(Jo,Mp),e(Be,Pp),e(Be,_a),e(_a,Ap),e(Be,Sp),e(q,Op),T(vt,q,null),e(q,Ip),T(Tt,q,null),e(q,Np),T(wt,q,null),e(q,Dp),T(Lt,q,null),e(q,Wp),T($t,q,null),k(n,vr,g),k(n,Ue,g),e(Ue,zt),e(zt,ka),T(Vn,ka,null),e(Ue,Bp),e(Ue,ya),e(ya,Up),k(n,Tr,g),k(n,D,g),T(Yn,D,null),e(D,Kp),e(D,ba),e(ba,Rp),e(D,Qp),e(D,Gn),e(Gn,Hp),e(Gn,Xo),e(Xo,Vp),e(Gn,Yp),e(D,Gp),e(D,Jn),e(Jn,Jp),e(Jn,Xn),e(Xn,Xp),e(Jn,Zp),e(D,eh),e(D,ie),T(Zn,ie,null),e(ie,th),e(ie,Ke),e(Ke,nh),e(Ke,Zo),e(Zo,oh),e(Ke,sh),e(Ke,va),e(va,ah),e(Ke,rh),e(ie,ih),T(Et,ie,null),e(ie,lh),T(xt,ie,null),k(n,wr,g),k(n,Re,g),e(Re,Ft),e(Ft,Ta),T(eo,Ta,null),e(Re,dh),e(Re,wa),e(wa,ch),k(n,Lr,g),k(n,W,g),T(to,W,null),e(W,ph),e(W,no),e(no,hh),e(no,La),e(La,uh),e(no,mh),e(W,fh),e(W,oo),e(oo,gh),e(oo,es),e(es,_h),e(oo,kh),e(W,yh),e(W,so),e(so,bh),e(so,ao),e(ao,vh),e(so,Th),e(W,wh),e(W,Q),T(ro,Q,null),e(Q,Lh),e(Q,Qe),e(Qe,$h),e(Qe,ts),e(ts,zh),e(Qe,Eh),e(Qe,$a),e($a,xh),e(Qe,Fh),e(Q,qh),T(qt,Q,null),e(Q,Ch),T(Ct,Q,null),e(Q,jh),T(jt,Q,null),k(n,$r,g),k(n,He,g),e(He,Mt),e(Mt,za),T(io,za,null),e(He,Mh),e(He,Ea),e(Ea,Ph),k(n,zr,g),k(n,B,g),T(lo,B,null),e(B,Ah),e(B,Ve),e(Ve,Sh),e(Ve,xa),e(xa,Oh),e(Ve,Ih),e(Ve,Fa),e(Fa,Nh),e(Ve,Dh),e(B,Wh),e(B,co),e(co,Bh),e(co,ns),e(ns,Uh),e(co,Kh),e(B,Rh),e(B,po),e(po,Qh),e(po,ho),e(ho,Hh),e(po,Vh),e(B,Yh),e(B,H),T(uo,H,null),e(H,Gh),e(H,Ye),e(Ye,Jh),e(Ye,os),e(os,Xh),e(Ye,Zh),e(Ye,qa),e(qa,eu),e(Ye,tu),e(H,nu),T(Pt,H,null),e(H,ou),T(At,H,null),e(H,su),T(St,H,null),Er=!0},p(n,[g]){const mo={};g&2&&(mo.$$scope={dirty:g,ctx:n}),ot.$set(mo);const Ca={};g&2&&(Ca.$$scope={dirty:g,ctx:n}),it.$set(Ca);const ja={};g&2&&(ja.$$scope={dirty:g,ctx:n}),lt.$set(ja);const Ma={};g&2&&(Ma.$$scope={dirty:g,ctx:n}),ct.$set(Ma);const fo={};g&2&&(fo.$$scope={dirty:g,ctx:n}),ht.$set(fo);const Pa={};g&2&&(Pa.$$scope={dirty:g,ctx:n}),ut.$set(Pa);const Aa={};g&2&&(Aa.$$scope={dirty:g,ctx:n}),ft.$set(Aa);const Sa={};g&2&&(Sa.$$scope={dirty:g,ctx:n}),gt.$set(Sa);const go={};g&2&&(go.$$scope={dirty:g,ctx:n}),kt.$set(go);const Oa={};g&2&&(Oa.$$scope={dirty:g,ctx:n}),yt.$set(Oa);const Ia={};g&2&&(Ia.$$scope={dirty:g,ctx:n}),vt.$set(Ia);const Na={};g&2&&(Na.$$scope={dirty:g,ctx:n}),Tt.$set(Na);const Da={};g&2&&(Da.$$scope={dirty:g,ctx:n}),wt.$set(Da);const Wa={};g&2&&(Wa.$$scope={dirty:g,ctx:n}),Lt.$set(Wa);const le={};g&2&&(le.$$scope={dirty:g,ctx:n}),$t.$set(le);const Ba={};g&2&&(Ba.$$scope={dirty:g,ctx:n}),Et.$set(Ba);const _o={};g&2&&(_o.$$scope={dirty:g,ctx:n}),xt.$set(_o);const Ua={};g&2&&(Ua.$$scope={dirty:g,ctx:n}),qt.$set(Ua);const Ka={};g&2&&(Ka.$$scope={dirty:g,ctx:n}),Ct.$set(Ka);const U={};g&2&&(U.$$scope={dirty:g,ctx:n}),jt.$set(U);const Ra={};g&2&&(Ra.$$scope={dirty:g,ctx:n}),Pt.$set(Ra);const Qa={};g&2&&(Qa.$$scope={dirty:g,ctx:n}),At.$set(Qa);const Ha={};g&2&&(Ha.$$scope={dirty:g,ctx:n}),St.$set(Ha)},i(n){Er||(w(l.$$.fragment,n),w(Kt.$$.fragment,n),w(en.$$.fragment,n),w(sn.$$.fragment,n),w(an.$$.fragment,n),w(ot.$$.fragment,n),w(ln.$$.fragment,n),w(dn.$$.fragment,n),w(cn.$$.fragment,n),w(pn.$$.fragment,n),w(hn.$$.fragment,n),w(un.$$.fragment,n),w(_n.$$.fragment,n),w(it.$$.fragment,n),w(lt.$$.fragment,n),w(kn.$$.fragment,n),w(yn.$$.fragment,n),w(wn.$$.fragment,n),w(ct.$$.fragment,n),w(Ln.$$.fragment,n),w($n.$$.fragment,n),w(Fn.$$.fragment,n),w(ht.$$.fragment,n),w(ut.$$.fragment,n),w(qn.$$.fragment,n),w(Cn.$$.fragment,n),w(An.$$.fragment,n),w(ft.$$.fragment,n),w(gt.$$.fragment,n),w(Sn.$$.fragment,n),w(On.$$.fragment,n),w(Wn.$$.fragment,n),w(kt.$$.fragment,n),w(yt.$$.fragment,n),w(Bn.$$.fragment,n),w(Un.$$.fragment,n),w(Hn.$$.fragment,n),w(vt.$$.fragment,n),w(Tt.$$.fragment,n),w(wt.$$.fragment,n),w(Lt.$$.fragment,n),w($t.$$.fragment,n),w(Vn.$$.fragment,n),w(Yn.$$.fragment,n),w(Zn.$$.fragment,n),w(Et.$$.fragment,n),w(xt.$$.fragment,n),w(eo.$$.fragment,n),w(to.$$.fragment,n),w(ro.$$.fragment,n),w(qt.$$.fragment,n),w(Ct.$$.fragment,n),w(jt.$$.fragment,n),w(io.$$.fragment,n),w(lo.$$.fragment,n),w(uo.$$.fragment,n),w(Pt.$$.fragment,n),w(At.$$.fragment,n),w(St.$$.fragment,n),Er=!0)},o(n){L(l.$$.fragment,n),L(Kt.$$.fragment,n),L(en.$$.fragment,n),L(sn.$$.fragment,n),L(an.$$.fragment,n),L(ot.$$.fragment,n),L(ln.$$.fragment,n),L(dn.$$.fragment,n),L(cn.$$.fragment,n),L(pn.$$.fragment,n),L(hn.$$.fragment,n),L(un.$$.fragment,n),L(_n.$$.fragment,n),L(it.$$.fragment,n),L(lt.$$.fragment,n),L(kn.$$.fragment,n),L(yn.$$.fragment,n),L(wn.$$.fragment,n),L(ct.$$.fragment,n),L(Ln.$$.fragment,n),L($n.$$.fragment,n),L(Fn.$$.fragment,n),L(ht.$$.fragment,n),L(ut.$$.fragment,n),L(qn.$$.fragment,n),L(Cn.$$.fragment,n),L(An.$$.fragment,n),L(ft.$$.fragment,n),L(gt.$$.fragment,n),L(Sn.$$.fragment,n),L(On.$$.fragment,n),L(Wn.$$.fragment,n),L(kt.$$.fragment,n),L(yt.$$.fragment,n),L(Bn.$$.fragment,n),L(Un.$$.fragment,n),L(Hn.$$.fragment,n),L(vt.$$.fragment,n),L(Tt.$$.fragment,n),L(wt.$$.fragment,n),L(Lt.$$.fragment,n),L($t.$$.fragment,n),L(Vn.$$.fragment,n),L(Yn.$$.fragment,n),L(Zn.$$.fragment,n),L(Et.$$.fragment,n),L(xt.$$.fragment,n),L(eo.$$.fragment,n),L(to.$$.fragment,n),L(ro.$$.fragment,n),L(qt.$$.fragment,n),L(Ct.$$.fragment,n),L(jt.$$.fragment,n),L(io.$$.fragment,n),L(lo.$$.fragment,n),L(uo.$$.fragment,n),L(Pt.$$.fragment,n),L(At.$$.fragment,n),L(St.$$.fragment,n),Er=!1},d(n){t(d),n&&t(_),n&&t(c),$(l),n&&t(Ga),n&&t(Le),$(Kt),n&&t(Ja),n&&t(Ze),n&&t(Xa),n&&t(ko),n&&t(Za),n&&t(yo),n&&t(er),n&&t(bo),n&&t(tr),n&&t(ee),n&&t(nr),n&&t(jo),n&&t(or),$(en,n),n&&t(sr),n&&t(ne),n&&t(ar),n&&t(Ee),$(sn),n&&t(rr),n&&t(X),$(an),$(ot),n&&t(ir),n&&t(qe),$(ln),n&&t(lr),n&&t(M),$(dn),$(cn),$(pn),n&&t(dr),n&&t(Ce),$(hn),n&&t(cr),n&&t(P),$(un),$(_n),$(it),$(lt),n&&t(pr),n&&t(Me),$(kn),n&&t(hr),n&&t(A),$(yn),$(wn),$(ct),n&&t(ur),n&&t(Ae),$(Ln),n&&t(mr),n&&t(S),$($n),$(Fn),$(ht),$(ut),n&&t(fr),n&&t(Oe),$(qn),n&&t(gr),n&&t(O),$(Cn),$(An),$(ft),$(gt),n&&t(_r),n&&t(Ne),$(Sn),n&&t(kr),n&&t(I),$(On),$(Wn),$(kt),$(yt),n&&t(yr),n&&t(We),$(Bn),n&&t(br),n&&t(N),$(Un),$(Hn),$(vt),$(Tt),$(wt),$(Lt),$($t),n&&t(vr),n&&t(Ue),$(Vn),n&&t(Tr),n&&t(D),$(Yn),$(Zn),$(Et),$(xt),n&&t(wr),n&&t(Re),$(eo),n&&t(Lr),n&&t(W),$(to),$(ro),$(qt),$(Ct),$(jt),n&&t($r),n&&t(He),$(io),n&&t(zr),n&&t(B),$(lo),$(uo),$(Pt),$(At),$(St)}}}const Yf={local:"luke",sections:[{local:"overview",title:"Overview"},{local:"transformers.LukeConfig",title:"LukeConfig"},{local:"transformers.LukeTokenizer",title:"LukeTokenizer"},{local:"transformers.LukeModel",title:"LukeModel"},{local:"transformers.LukeForMaskedLM",title:"LukeForMaskedLM"},{local:"transformers.LukeForEntityClassification",title:"LukeForEntityClassification"},{local:"transformers.LukeForEntityPairClassification",title:"LukeForEntityPairClassification"},{local:"transformers.LukeForEntitySpanClassification",title:"LukeForEntitySpanClassification"},{local:"transformers.LukeForSequenceClassification",title:"LukeForSequenceClassification"},{local:"transformers.LukeForMultipleChoice",title:"LukeForMultipleChoice"},{local:"transformers.LukeForTokenClassification",title:"LukeForTokenClassification"},{local:"transformers.LukeForQuestionAnswering",title:"LukeForQuestionAnswering"}],title:"LUKE"};function Gf(z){return Lf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class og extends bf{constructor(d){super();vf(this,d,Gf,Vf,Tf,{})}}export{og as default,Yf as metadata};
