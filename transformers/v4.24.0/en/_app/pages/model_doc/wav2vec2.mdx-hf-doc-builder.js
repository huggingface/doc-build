...
</ul>`,name:"pretrained_model_name_or_path"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L112"}}),ma=new xe({props:{$$slots:{default:[QT]},$$scope:{ctx:W}}}),bn=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2ProcessorWithLM.save_pretrained",parameters:[{name:"save_directory",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L108"}}),wn=new F({props:{name:"batch_decode",anchor:"transformers.Wav2Vec2ProcessorWithLM.batch_decode",parameters:[{name:"logits",val:": ndarray"},{name:"pool",val:": typing.Union[<bound method BaseContext.Pool of <multiprocessing.context.DefaultContext object at 0x7fb83ffe6970>>, NoneType] = None"},{name:"num_processes",val:": typing.Optional[int] = None"},{name:"beam_width",val:": typing.Optional[int] = None"},{name:"beam_prune_logp",val:": typing.Optional[float] = None"},{name:"token_min_logp",val:": typing.Optional[float] = None"},{name:"hotwords",val:": typing.Optional[typing.Iterable[str]] = None"},{name:"hotword_weight",val:": typing.Optional[float] = None"},{name:"alpha",val:": typing.Optional[float] = None"},{name:"beta",val:": typing.Optional[float] = None"},{name:"unk_score_offset",val:": typing.Optional[float] = None"},{name:"lm_score_boundary",val:": typing.Optional[bool] = None"},{name:"output_word_offsets",val:": bool = False"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ProcessorWithLM.batch_decode.logits",description:`<strong>logits</strong> (<code>np.ndarray</code>) &#x2014;
...
using `),U=r(Wi,"A",{href:!0});var Yd=i(U);jt=s(Yd,"Wav2Vec2CTCTokenizer"),Yd.forEach(t),Ce=s(Wi,"."),Wi.forEach(t),xi.forEach(t),st=m(o),ye=r(o,"P",{});var ji=i(ye);qe=s(ji,"This model was contributed by "),Pe=r(ji,"A",{href:!0,rel:!0});var ep=i(Pe);Vt=s(ep,"patrickvonplaten"),ep.forEach(t),he=s(ji,"."),ji.forEach(t),nt=m(o),Y=r(o,"H2",{class:!0});var Vi=i(Y);ke=r(Vi,"A",{id:!0,class:!0,href:!0});var tp=i(ke);ze=r(tp,"SPAN",{});var op=i(ze);y(B.$$.fragment,op),op.forEach(t),tp.forEach(t),Ft=m(Vi),ee=r(Vi,"SPAN",{});var ap=i(ee);Et=s(ap,"Resources"),ap.forEach(t),Vi.forEach(t),rt=m(o),j=r(o,"P",{});var sp=i(j);q=s(sp,"A list of official Hugging Face and community (indicated by \u{1F30E}) resources to help you get started with Wav2Vec2. If you\u2019re interested in submitting a resource to be included here, please feel free to open a Pull Request and we\u2019ll review it! The resource should ideally demonstrate something new instead of duplicating an existing resource."),sp.forEach(t),It=m(o),y(fe.$$.fragment,o),Nt=m(o),Ne=r(o,"UL",{});var Fi=i(Ne);P=r(Fi,"LI",{});var Ei=i(P);to=s(Ei,"A notebook on how to "),Ye=r(Ei,"A",{href:!0,rel:!0});var np=i(Ye);oo=s(np,"leverage a pretrained Wav2Vec2 model for emotion classification"),np.forEach(t),ao=s(Ei,". \u{1F30E}"),Ei.forEach(t),so=m(Fi),H=r(Fi,"LI",{});var Gt=i(H);pe=r(Gt,"A",{href:!0});var rp=i(pe);no=s(rp,"Wav2Vec2ForCTC"),rp.forEach(t),ro=s(Gt," is supported by this "),se=r(Gt,"A",{href:!0,rel:!0});var ip=i(se);io=s(ip,"example script"),ip.forEach(t),lo=s(Gt," and "),Me=r(Gt,"A",{href:!0,rel:!0});var lp=i(Me);co=s(lp,"notebook"),lp.forEach(t),et=s(Gt,"."),Gt.forEach(t),Fi.forEach(t),Bt=m(o),y(ks.$$.fragment,o),cp=m(o),Be=r(o,"UL",{});var Kt=i(Be);Ts=r(Kt,"LI",{});var em=i(Ts);Th=s(em,"A blog post on "),$s=r(em,"A",{href:!0,rel:!0});var Qy=i($s);$h=s(Qy,"boosting Wav2Vec2 with n-grams in \u{1F917} Transformers"),Qy.forEach(t),xh=s(em,"."),em.forEach(t),Wh=m(Kt),xs=r(Kt,"LI",{});var tm=i(xs);jh=s(tm,"A blog post on how to "),Ws=r(tm,"A",{href:!0,rel:!0});var Yy=i(Ws);Vh=s(Yy,"finetune Wav2Vec2 for English ASR with \u{1F917} Transformers"),Yy.forEach(t),Fh=s(tm,"."),tm.forEach(t),Eh=m(Kt),js=r(Kt,"LI",{});var om=i(js);Ch=s(om,"A blog post on "),Vs=r(om,"A",{href:!0,rel:!0});var e0=i(Vs);qh=s(e0,"finetuning XLS-R for Multi-Lingual ASR with \u{1F917} Transformers"),e0.forEach(t),Ph=s(om,"."),om.forEach(t),zh=m(Kt),Fs=r(Kt,"LI",{});var am=i(Fs);Mh=s(am,"A notebook on how to "),Es=r(am,"A",{href:!0,rel:!0});var t0=i(Es);Ah=s(t0,"create YouTube captions from any video by transcribing audio with Wav2Vec2"),t0.forEach(t),Lh=s(am,". \u{1F30E}"),am.forEach(t),Oh=m(Kt),Rt=r(Kt,"LI",{});var Ci=i(Rt);qi=r(Ci,"A",{href:!0});var o0=i(qi);Dh=s(o0,"Wav2Vec2ForCTC"),o0.forEach(t),Sh=s(Ci," is supported by a notebook on "),Cs=r(Ci,"A",{href:!0,rel:!0});var a0=i(Cs);Ih=s(a0,"how to finetune a speech recognition model in English"),a0.forEach(t),Nh=s(Ci,", and "),qs=r(Ci,"A",{href:!0,rel:!0});var s0=i(qs);Bh=s(s0,"how to finetune a speech recognition model in any language"),s0.forEach(t),Rh=s(Ci,"."),Ci.forEach(t),Kt.forEach(t),dp=m(o),Pi=r(o,"P",{});var n0=i(Pi);Uh=s(n0,"\u{1F680} Deploy"),n0.forEach(t),pp=m(o),zi=r(o,"UL",{});var r0=i(zi);Ps=r(r0,"LI",{});var sm=i(Ps);Hh=s(sm,"A blog post on how to deploy Wav2Vec2 for "),zs=r(sm,"A",{href:!0,rel:!0});var i0=i(zs);Xh=s(i0,"Automatic Speech Recogntion with Hugging Face\u2019s Transformers & Amazon SageMaker"),i0.forEach(t),Gh=s(sm,"."),sm.forEach(t),r0.forEach(t),mp=m(o),po=r(o,"H2",{class:!0});var nm=i(po);Ko=r(nm,"A",{id:!0,class:!0,href:!0});var l0=i(Ko);Gl=r(l0,"SPAN",{});var c0=i(Gl);y(Ms.$$.fragment,c0),c0.forEach(t),l0.forEach(t),Kh=m(nm),Kl=r(nm,"SPAN",{});var d0=i(Kl);Jh=s(d0,"Wav2Vec2Config"),d0.forEach(t),nm.forEach(t),hp=m(o),tt=r(o,"DIV",{class:!0});var os=i(tt);y(As.$$.fragment,os),Zh=m(os),mo=r(os,"P",{});var Wl=i(mo);Qh=s(Wl,"This is the configuration class to store the configuration of a "),Mi=r(Wl,"A",{href:!0});var p0=i(Mi);Yh=s(p0,"Wav2Vec2Model"),p0.forEach(t),ef=s(Wl,`. It is used to instantiate an
Wav2Vec2 model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Wav2Vec2
`),Ls=r(Wl,"A",{href:!0,rel:!0});var m0=i(Ls);tf=s(m0,"facebook/wav2vec2-base-960h"),m0.forEach(t),of=s(Wl," architecture."),Wl.forEach(t),af=m(os),ho=r(os,"P",{});var jl=i(ho);sf=s(jl,"Configuration objects inherit from "),Ai=r(jl,"A",{href:!0});var h0=i(Ai);nf=s(h0,"PretrainedConfig"),h0.forEach(t),rf=s(jl,` and can be used to control the model outputs. Read the
documentation from `),Li=r(jl,"A",{href:!0});var f0=i(Li);lf=s(f0,"PretrainedConfig"),f0.forEach(t),cf=s(jl," for more information."),jl.forEach(t),df=m(os),y(Jo.$$.fragment,os),os.forEach(t),fp=m(o),fo=r(o,"H2",{class:!0});var rm=i(fo);Zo=r(rm,"A",{id:!0,class:!0,href:!0});var u0=i(Zo);Jl=r(u0,"SPAN",{});var g0=i(Jl);y(Os.$$.fragment,g0),g0.forEach(t),u0.forEach(t),pf=m(rm),Zl=r(rm,"SPAN",{});var _0=i(Zl);mf=s(_0,"Wav2Vec2CTCTokenizer"),_0.forEach(t),rm.forEach(t),up=m(o),ne=r(o,"DIV",{class:!0});var Xe=i(ne);y(Ds.$$.fragment,Xe),hf=m(Xe),Ql=r(Xe,"P",{});var v0=i(Ql);ff=s(v0,"Constructs a Wav2Vec2CTC tokenizer."),v0.forEach(t),uf=m(Xe),Ss=r(Xe,"P",{});var im=i(Ss);gf=s(im,"This tokenizer inherits from "),Oi=r(im,"A",{href:!0});var b0=i(Oi);_f=s(b0,"PreTrainedTokenizer"),b0.forEach(t),vf=s(im,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),im.forEach(t),bf=m(Xe),Qo=r(Xe,"DIV",{class:!0});var lm=i(Qo);y(Is.$$.fragment,lm),wf=m(lm),Yl=r(lm,"P",{});var w0=i(Yl);yf=s(w0,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),w0.forEach(t),lm.forEach(t),kf=m(Xe),Di=r(Xe,"DIV",{class:!0});var y0=i(Di);y(Ns.$$.fragment,y0),y0.forEach(t),Tf=m(Xe),it=r(Xe,"DIV",{class:!0});var as=i(it);y(Bs.$$.fragment,as),$f=m(as),ec=r(as,"P",{});var k0=i(ec);xf=s(k0,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),k0.forEach(t),Wf=m(as),Rs=r(as,"P",{});var cm=i(Rs);jf=s(cm,"Similar to doing "),tc=r(cm,"CODE",{});var T0=i(tc);Vf=s(T0,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),T0.forEach(t),Ff=s(cm,"."),cm.forEach(t),Ef=m(as),y(Yo.$$.fragment,as),as.forEach(t),Cf=m(Xe),ea=r(Xe,"DIV",{class:!0});var dm=i(ea);y(Us.$$.fragment,dm),qf=m(dm),oc=r(dm,"P",{});var $0=i(oc);Pf=s($0,"Convert a list of lists of token ids into a list of strings by calling decode."),$0.forEach(t),dm.forEach(t),Xe.forEach(t),gp=m(o),uo=r(o,"H2",{class:!0});var pm=i(uo);ta=r(pm,"A",{id:!0,class:!0,href:!0});var x0=i(ta);ac=r(x0,"SPAN",{});var W0=i(ac);y(Hs.$$.fragment,W0),W0.forEach(t),x0.forEach(t),zf=m(pm),sc=r(pm,"SPAN",{});var j0=i(sc);Mf=s(j0,"Wav2Vec2FeatureExtractor"),j0.forEach(t),pm.forEach(t),_p=m(o),ot=r(o,"DIV",{class:!0});var ss=i(ot);y(Xs.$$.fragment,ss),Af=m(ss),nc=r(ss,"P",{});var V0=i(nc);Lf=s(V0,"Constructs a Wav2Vec2 feature extractor."),V0.forEach(t),Of=m(ss),Gs=r(ss,"P",{});var mm=i(Gs);Df=s(mm,"This feature extractor inherits from "),Si=r(mm,"A",{href:!0});var F0=i(Si);Sf=s(F0,"SequenceFeatureExtractor"),F0.forEach(t),If=s(mm,` which contains
most of the main methods. Users should refer to this superclass for more information regarding those methods.`),mm.forEach(t),Nf=m(ss),oa=r(ss,"DIV",{class:!0});var hm=i(oa);y(Ks.$$.fragment,hm),Bf=m(hm),rc=r(hm,"P",{});var E0=i(rc);Rf=s(E0,"Main method to featurize and prepare for the model one or several sequence(s)."),E0.forEach(t),hm.forEach(t),ss.forEach(t),vp=m(o),go=r(o,"H2",{class:!0});var fm=i(go);aa=r(fm,"A",{id:!0,class:!0,href:!0});var C0=i(aa);ic=r(C0,"SPAN",{});var q0=i(ic);y(Js.$$.fragment,q0),q0.forEach(t),C0.forEach(t),Uf=m(fm),lc=r(fm,"SPAN",{});var P0=i(lc);Hf=s(P0,"Wav2Vec2Processor"),P0.forEach(t),fm.forEach(t),bp=m(o),G=r(o,"DIV",{class:!0});var me=i(G);y(Zs.$$.fragment,me),Xf=m(me),cc=r(me,"P",{});var z0=i(cc);Gf=s(z0,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
processor.`),z0.forEach(t),Kf=m(me),Re=r(me,"P",{});var St=i(Re);Ii=r(St,"A",{href:!0});var M0=i(Ii);Jf=s(M0,"Wav2Vec2Processor"),M0.forEach(t),Zf=s(St," offers all the functionalities of "),Ni=r(St,"A",{href:!0});var A0=i(Ni);Qf=s(A0,"Wav2Vec2FeatureExtractor"),A0.forEach(t),Yf=s(St," and "),Bi=r(St,"A",{href:!0});var L0=i(Bi);eu=s(L0,"PreTrainedTokenizer"),L0.forEach(t),tu=s(St,`.
See the docstring of `),Qs=r(St,"A",{href:!0});var Xy=i(Qs);dc=r(Xy,"STRONG",{});var O0=i(dc);ou=s(O0,"call"),O0.forEach(t),au=s(Xy,"()"),Xy.forEach(t),su=s(St," and "),Ri=r(St,"A",{href:!0});var D0=i(Ri);nu=s(D0,"decode()"),D0.forEach(t),ru=s(St," for more information."),St.forEach(t),iu=m(me),sa=r(me,"DIV",{class:!0});var um=i(sa);y(Ys.$$.fragment,um),lu=m(um),Ct=r(um,"P",{});var ns=i(Ct);cu=s(ns,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),en=r(ns,"A",{href:!0});var Gy=i(en);pc=r(Gy,"STRONG",{});var S0=i(pc);du=s(S0,"call"),S0.forEach(t),pu=s(Gy,"()"),Gy.forEach(t),mu=s(ns,` and returns its output. If used in the context
`),mc=r(ns,"CODE",{});var I0=i(mc);hu=s(I0,"as_target_processor()"),I0.forEach(t),fu=s(ns,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),tn=r(ns,"A",{href:!0});var Ky=i(tn);hc=r(Ky,"STRONG",{});var N0=i(hc);uu=s(N0,"call"),N0.forEach(t),gu=s(Ky,"()"),Ky.forEach(t),_u=s(ns,". Please refer to the docstring of the above two methods for more information."),ns.forEach(t),um.forEach(t),vu=m(me),na=r(me,"DIV",{class:!0});var gm=i(na);y(on.$$.fragment,gm),bu=m(gm),qt=r(gm,"P",{});var rs=i(qt);wu=s(rs,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),Ui=r(rs,"A",{href:!0});var B0=i(Ui);yu=s(B0,"pad()"),B0.forEach(t),ku=s(rs,` and returns its output. If used in the context
`),fc=r(rs,"CODE",{});var R0=i(fc);Tu=s(R0,"as_target_processor()"),R0.forEach(t),$u=s(rs,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Hi=r(rs,"A",{href:!0});var U0=i(Hi);xu=s(U0,"pad()"),U0.forEach(t),Wu=s(rs,". Please refer to the docstring of the above two methods for more information."),rs.forEach(t),gm.forEach(t),ju=m(me),Xi=r(me,"DIV",{class:!0});var H0=i(Xi);y(an.$$.fragment,H0),H0.forEach(t),Vu=m(me),Ut=r(me,"DIV",{class:!0});var Vl=i(Ut);y(sn.$$.fragment,Vl),Fu=m(Vl),nn=r(Vl,"P",{});var _m=i(nn);Eu=s(_m,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Gi=r(_m,"A",{href:!0});var X0=i(Gi);Cu=s(X0,"from_pretrained()"),X0.forEach(t),qu=s(_m," method."),_m.forEach(t),Pu=m(Vl),y(ra.$$.fragment,Vl),Vl.forEach(t),zu=m(me),ia=r(me,"DIV",{class:!0});var vm=i(ia);y(rn.$$.fragment,vm),Mu=m(vm),ln=r(vm,"P",{});var bm=i(ln);Au=s(bm,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Ki=r(bm,"A",{href:!0});var G0=i(Ki);Lu=s(G0,"batch_decode()"),G0.forEach(t),Ou=s(bm,`. Please
refer to the docstring of this method for more information.`),bm.forEach(t),vm.forEach(t),Du=m(me),la=r(me,"DIV",{class:!0});var wm=i(la);y(cn.$$.fragment,wm),Su=m(wm),dn=r(wm,"P",{});var ym=i(dn);Iu=s(ym,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Ji=r(ym,"A",{href:!0});var K0=i(Ji);Nu=s(K0,"decode()"),K0.forEach(t),Bu=s(ym,`. Please refer
to the docstring of this method for more information.`),ym.forEach(t),wm.forEach(t),me.forEach(t),wp=m(o),_o=r(o,"H2",{class:!0});var km=i(_o);ca=r(km,"A",{id:!0,class:!0,href:!0});var J0=i(ca);uc=r(J0,"SPAN",{});var Z0=i(uc);y(pn.$$.fragment,Z0),Z0.forEach(t),J0.forEach(t),Ru=m(km),gc=r(km,"SPAN",{});var Q0=i(gc);Uu=s(Q0,"Wav2Vec2ProcessorWithLM"),Q0.forEach(t),km.forEach(t),yp=m(o),te=r(o,"DIV",{class:!0});var $e=i(te);y(mn.$$.fragment,$e),Hu=m($e),_c=r($e,"P",{});var Y0=i(_c);Xu=s(Y0,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor, a Wav2Vec2 CTC tokenizer and a decoder
with language model support into a single processor for language model boosted speech recognition decoding.`),Y0.forEach(t),Gu=m($e),da=r($e,"DIV",{class:!0});var Tm=i(da);y(hn.$$.fragment,Tm),Ku=m(Tm),Pt=r(Tm,"P",{});var is=i(Pt);Ju=s(is,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),fn=r(is,"A",{href:!0});var Jy=i(fn);vc=r(Jy,"STRONG",{});var ek=i(vc);Zu=s(ek,"call"),ek.forEach(t),Qu=s(Jy,"()"),Jy.forEach(t),Yu=s(is,` and returns its output. If used in the context
`),bc=r(is,"CODE",{});var tk=i(bc);eg=s(tk,"as_target_processor()"),tk.forEach(t),tg=s(is,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),un=r(is,"A",{href:!0});var Zy=i(un);wc=r(Zy,"STRONG",{});var ok=i(wc);og=s(ok,"call"),ok.forEach(t),ag=s(Zy,"()"),Zy.forEach(t),sg=s(is,`. Please refer to the docstring of the above two
