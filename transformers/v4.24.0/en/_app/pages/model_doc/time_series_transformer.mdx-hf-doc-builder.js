import{S as Sn,i as xn,s as $n,e as r,k as m,w as b,t as o,M as En,c as n,d as t,m as f,a as i,x as w,h as s,b as h,G as e,g,y,q as k,o as S,B as x,v as qn,L as pr}from"../../chunks/vendor-hf-doc-builder.js";import{T as fr}from"../../chunks/Tip-hf-doc-builder.js";import{D as to}from"../../chunks/Docstring-hf-doc-builder.js";import{C as _r}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as oo}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ur}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Cn(j){let d,v,c,p,T;return{c(){d=r("p"),v=o(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),c=r("a"),p=o("Github Issue"),T=o("."),this.h()},l(l){d=n(l,"P",{});var _=i(d);v=s(_,`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),c=n(_,"A",{href:!0,rel:!0});var M=i(c);p=s(M,"Github Issue"),M.forEach(t),T=s(_,"."),_.forEach(t),this.h()},h(){h(c,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),h(c,"rel","nofollow")},m(l,_){g(l,d,_),e(d,v),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function jn(j){let d,v;return d=new _r({props:{code:`from transformers import TimeSeriesTransformerConfig, TimeSeriesTransformerModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){b(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,p){y(d,c,p),v=!0},p:pr,i(c){v||(k(d.$$.fragment,c),v=!0)},o(c){S(d.$$.fragment,c),v=!1},d(c){x(d,c)}}}function Mn(j){let d,v,c,p,T;return{c(){d=r("p"),v=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=n(l,"P",{});var _=i(d);v=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(_,"CODE",{});var M=i(c);p=s(M,"Module"),M.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){g(l,d,_),e(d,v),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function Fn(j){let d,v,c,p,T;return p=new _r({props:{code:`from huggingface_hub import hf_hub_download
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state`}}),{c(){d=r("p"),v=o("Examples:"),c=m(),b(p.$$.fragment)},l(l){d=n(l,"P",{});var _=i(d);v=s(_,"Examples:"),_.forEach(t),c=f(l),w(p.$$.fragment,l)},m(l,_){g(l,d,_),e(d,v),g(l,c,_),y(p,l,_),T=!0},p:pr,i(l){T||(k(p.$$.fragment,l),T=!0)},o(l){S(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),x(p,l)}}}function Pn(j){let d,v,c,p,T;return{c(){d=r("p"),v=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=n(l,"P",{});var _=i(d);v=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(_,"CODE",{});var M=i(c);p=s(M,"Module"),M.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){g(l,d,_),e(d,v),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function zn(j){let d,v,c,p,T;return p=new _r({props:{code:`from huggingface_hub import hf_hub_download
import torch
...
multivariate targets.`,name:"input_size"},{anchor:"transformers.TimeSeriesTransformerConfig.scaling",description:`<strong>scaling</strong> (<code>bool</code>, <em>optional</em> defaults to <code>True</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/time_series_transformer#transformers.TimeSeriesTransformerConfig"
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/time_series_transformer/modeling_time_series_transformer.py#L1728",returnDescription:`
<p>A <code>transformers.models.time_series_transformer.modeling_time_series_transformer.Seq2SeqTimeSeriesModelOutput</code> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/time_series_transformer#transformers.TimeSeriesTransformerConfig"
...
pairs of (`),pt=r("code"),Qo=o("past_values"),Xo=o(" and "),_t=r("code"),Yo=o("future_values"),Zo=o(") to the model."),es=m(),R=r("li"),ts=o("In addition to the raw ("),gt=r("code"),os=o("past_values"),ss=o(" and "),vt=r("code"),as=o("future_values"),rs=o("), one typically provides additional features to the model. These can be the following:"),L=r("ul"),se=r("li"),Tt=r("code"),ns=o("past_time_features"),is=o(": temporal features which the model will add to "),bt=r("code"),ds=o("past_values"),ls=o(`. These serve as \u201Cpositional encodings\u201D for the Transformer encoder.
...
pairs of (`),pt=n(C,"CODE",{});var qr=i(pt);Qo=s(qr,"past_values"),qr.forEach(t),Xo=s(C," and "),_t=n(C,"CODE",{});var Cr=i(_t);Yo=s(Cr,"future_values"),Cr.forEach(t),Zo=s(C,") to the model."),C.forEach(t),es=f(U),R=n(U,"LI",{});var Re=i(R);ts=s(Re,"In addition to the raw ("),gt=n(Re,"CODE",{});var jr=i(gt);os=s(jr,"past_values"),jr.forEach(t),ss=s(Re," and "),vt=n(Re,"CODE",{});var Mr=i(vt);as=s(Mr,"future_values"),Mr.forEach(t),rs=s(Re,"), one typically provides additional features to the model. These can be the following:"),L=n(Re,"UL",{});var ue=i(L);se=n(ue,"LI",{});var Zt=i(se);Tt=n(Zt,"CODE",{});var Fr=i(Tt);ns=s(Fr,"past_time_features"),Fr.forEach(t),is=s(Zt,": temporal features which the model will add to "),bt=n(Zt,"CODE",{});var Pr=i(bt);ds=s(Pr,"past_values"),Pr.forEach(t),ls=s(Zt,`. These serve as \u201Cpositional encodings\u201D for the Transformer encoder.
Examples are \u201Cday of the month\u201D, \u201Cmonth of the year\u201D, etc. as scalar values (and then stacked together as a vector).
...
which is then fed to the decoder in order to make the next prediction (also called autoregressive generation).`),go.forEach(t),U.forEach(t),lo=f(a),re=n(a,"P",{});var vo=i(re);Ws=s(vo,"This model was contributed by "),Qe=n(vo,"A",{href:!0});var Vr=i(Qe);Us=s(Vr,"kashif"),Vr.forEach(t),Hs=s(vo,"."),vo.forEach(t),co=f(a),V=n(a,"H2",{class:!0});var To=i(V);ne=n(To,"A",{id:!0,class:!0,href:!0});var Jr=i(ne);Pt=n(Jr,"SPAN",{});var Kr=i(Pt);w(ye.$$.fragment,Kr),Kr.forEach(t),Jr.forEach(t),Gs=f(To),zt=n(To,"SPAN",{});var Qr=i(zt);Vs=s(Qr,"TimeSeriesTransformerConfig"),Qr.forEach(t),To.forEach(t),ho=f(a),z=n(a,"DIV",{class:!0});var _e=i(z);w(ke.$$.fragment,_e),Js=f(_e),J=n(_e,"P",{});var rt=i(J);Ks=s(rt,"This is the configuration class to store the configuration of a "),Xe=n(rt,"A",{href:!0});var Xr=i(Xe);Qs=s(Xr,"TimeSeriesTransformerModel"),Xr.forEach(t),Xs=s(rt,`. It is used to
instantiate a Time Series Transformer model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the Time Series
Transformer
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yo.forEach(t),ga=f(ge),N=n(ge,"DIV",{class:!0});var ve=i(N);w(je.$$.fragment,ve),va=f(ve),X=n(ve,"P",{});var it=i(X);Ta=s(it,"The "),tt=n(it,"A",{href:!0});var nn=i(tt);ba=s(nn,"TimeSeriesTransformerModel"),nn.forEach(t),wa=s(it," forward method, overrides the "),At=n(it,"CODE",{});var dn=i(At);ya=s(dn,"__call__"),dn.forEach(t),ka=s(it," special method."),it.forEach(t),Sa=f(ve),w(le.$$.fragment,ve),xa=f(ve),w(ce.$$.fragment,ve),ve.forEach(t),ge.forEach(t),uo=f(a),Y=n(a,"H2",{class:!0});var ko=i(Y);he=n(ko,"A",{id:!0,class:!0,href:!0});var ln=i(he);Nt=n(ln,"SPAN",{});var cn=i(Nt);w(Me.$$.fragment,cn),cn.forEach(t),ln.forEach(t),$a=f(ko),It=n(ko,"SPAN",{});var hn=i(It);Ea=s(hn,"TimeSeriesTransformerForPrediction"),hn.forEach(t),ko.forEach(t),po=f(a),D=n(a,"DIV",{class:!0});var Te=i(D);w(Fe.$$.fragment,Te),qa=f(Te),Pe=n(Te,"P",{});var So=i(Pe);Ca=s(So,`The Time Series Transformer Model with a distribution head on top for time-series forecasting.
