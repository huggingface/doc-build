import{S as Rd,i as Fd,s as zd,e as i,k as g,w as k,t as a,M as Cd,c as l,d as o,m as _,a as d,x as v,h as r,b as m,G as e,g as L,y as M,q as w,o as X,B as $,v as qd,L as O}from"../../chunks/vendor-hf-doc-builder.js";import{T as io}from"../../chunks/Tip-hf-doc-builder.js";import{D as F}from"../../chunks/Docstring-hf-doc-builder.js";import{C as A}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ae}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as P}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ed(T){let s,f,c,p,b;return p=new A({props:{code:`from transformers import XLMRobertaXLConfig, XLMRobertaXLModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(o),c=_(n),v(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),M(p,n,h),b=!0},p:O,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Od(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(o),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(o),c=_(n),v(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),M(p,n,h),b=!0},p:O,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Sd(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(o),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(o),c=_(n),v(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),M(p,n,h),b=!0},p:O,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Id(T){let s,f;return s=new A({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
`}}),{c(){s=i("p"),f=a("Example of single-label classification:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example of single-label classification:"),h.forEach(o),c=_(n),v(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),M(p,n,h),b=!0},p:O,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Bd(T){let s,f;return s=new A({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){s=i("p"),f=a("Example of multi-label classification:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example of multi-label classification:"),h.forEach(o),c=_(n),v(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),M(p,n,h),b=!0},p:O,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Hd(T){let s,f;return s=new A({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(o),c=_(n),v(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),M(p,n,h),b=!0},p:O,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Gd(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(o),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(o),c=_(n),v(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),M(p,n,h),b=!0},p:O,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Kd(T){let s,f;return s=new A({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
...
`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(o),c=_(n),v(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),M(p,n,h),b=!0},p:O,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function ec(T){let s,f;return s=new A({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,p){M(s,c,p),f=!0},p:O,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function tc(T){let s,f,c,p,b,n,h,y,Fs,Yn,re,Re,Ho,bt,zs,Uo,Cs,Zn,Fe,qs,Lt,Es,js,es,lo,Ps,ts,co,Vo,Os,os,po,As,ns,ho,kt,Ss,Go,Ns,Is,ss,Q,Ds,vt,Ws,Bs,Mt,Qs,Hs,wt,Us,Vs,as,ie,ze,Jo,Xt,Gs,Ko,Js,rs,S,$t,Ks,G,Ys,mo,Zs,ea,Yo,ta,oa,Tt,na,sa,aa,le,ra,uo,ia,la,fo,da,ca,pa,Ce,is,de,qe,Zo,yt,ha,en,ma,ls,N,xt,ua,ce,fa,go,ga,_a,Rt,ba,La,ka,te,va,tn,Ma,R,wa,on,Xa,$a,nn,Ta,ya,sn,xa,Ra,an,Fa,za,rn,Ca,qa,ln,Ea,ja,dn,Pa,Oa,Ft,Aa,Sa,H,zt,Na,pe,Ia,_o,Da,Wa,cn,Ba,Qa,Ha,Ee,Ua,je,ds,he,Pe,pn,Ct,Va,hn,Ga,cs,J,qt,Ja,K,Ka,mn,Ya,Za,bo,er,tr,Et,or,nr,sr,U,jt,ar,me,rr,Lo,ir,lr,un,dr,cr,pr,Oe,hr,Ae,ps,ue,Se,fn,Pt,mr,gn,ur,hs,Y,Ot,fr,Z,gr,_n,_r,br,ko,Lr,kr,At,vr,Mr,wr,z,St,Xr,fe,$r,vo,Tr,yr,bn,xr,Rr,Fr,Ne,zr,Ie,Cr,De,ms,ge,We,Ln,Nt,qr,kn,Er,us,I,It,jr,vn,Pr,Or,_e,Ar,Mo,Sr,Nr,Dt,Ir,Dr,Wr,x,Wt,Br,be,Qr,wo,Hr,Ur,Mn,Vr,Gr,Jr,Be,Kr,Qe,Yr,He,Zr,Ue,ei,Ve,fs,Le,Ge,wn,Bt,ti,Xn,oi,gs,D,Qt,ni,$n,si,ai,ke,ri,Xo,ii,li,Ht,di,ci,pi,V,Ut,hi,ve,mi,$o,ui,fi,Tn,gi,_i,bi,Je,Li,Ke,_s,Me,Ye,yn,Vt,ki,xn,vi,bs,W,Gt,Mi,Rn,wi,Xi,we,$i,To,Ti,yi,Jt,xi,Ri,Fi,C,Kt,zi,Xe,Ci,yo,qi,Ei,Fn,ji,Pi,Oi,Ze,Ai,et,Si,tt,Ls,$e,ot,zn,Yt,Ni,Cn,Ii,ks,B,Zt,Di,Te,Wi,qn,Bi,Qi,En,Hi,Ui,Vi,ye,Gi,xo,Ji,Ki,eo,Yi,Zi,el,q,to,tl,xe,ol,Ro,nl,sl,jn,al,rl,il,nt,ll,st,dl,at,vs;return n=new ae({}),bt=new ae({}),Xt=new ae({}),$t=new F({props:{name:"class transformers.XLMRobertaXLConfig",anchor:"transformers.XLMRobertaXLConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 2560"},{name:"num_hidden_layers",val:" = 36"},{name:"num_attention_heads",val:" = 32"},{name:"intermediate_size",val:" = 10240"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 514"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 250880) &#x2014;
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/v4.24.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel">XLMRobertaXLModel</a> or
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L705",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L847"}}),jt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L872",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L997"}}),St=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1025",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1125"}}),Wt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1138",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1234",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1333",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1431"}}),to=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1444",returnDescription:`
<p>A <a
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),wr=g(),z=i("div"),k(St.$$.fragment),Xr=g(),fe=i("p"),$r=a("The "),vo=i("a"),Tr=a("XLMRobertaXLForMaskedLM"),yr=a(" forward method, overrides the "),bn=i("code"),xr=a("__call__"),Rr=a(" special method."),Fr=g(),k(Ne.$$.fragment),zr=g(),k(Ie.$$.fragment),Cr=g(),k(De.$$.fragment),ms=g(),ge=i("h2"),We=i("a"),Ln=i("span"),k(Nt.$$.fragment),qr=g(),kn=i("span"),Er=a("XLMRobertaXLForSequenceClassification"),us=g(),I=i("div"),k(It.$$.fragment),jr=g(),vn=i("p"),Pr=a(`XLM-RoBERTa-xlarge Model transformer with a sequence classification/regression head on top (a linear layer on top
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Fi=g(),C=i("div"),k(Kt.$$.fragment),zi=g(),Xe=i("p"),Ci=a("The "),yo=i("a"),qi=a("XLMRobertaXLForTokenClassification"),Ei=a(" forward method, overrides the "),Fn=i("code"),ji=a("__call__"),Pi=a(" special method."),Oi=g(),k(Ze.$$.fragment),Ai=g(),k(et.$$.fragment),Si=g(),k(tt.$$.fragment),Ls=g(),$e=i("h2"),ot=i("a"),zn=i("span"),k(Yt.$$.fragment),Ni=g(),Cn=i("span"),Ii=a("XLMRobertaXLForQuestionAnswering"),ks=g(),B=i("div"),k(Zt.$$.fragment),Di=g(),Te=i("p"),Wi=a(`XLM-Roberta-xlarge Model with a span classification head on top for extractive question-answering tasks like SQuAD
...
language from the input ids.`),ao.forEach(o),Un.forEach(o),ss=_(t),Q=l(t,"P",{});var ee=d(Q);Ds=r(ee,"This model was contributed by "),vt=l(ee,"A",{href:!0,rel:!0});var Gn=d(vt);Ws=r(Gn,"Soonhwan-Kwon"),Gn.forEach(o),Bs=r(ee," and "),Mt=l(ee,"A",{href:!0,rel:!0});var Jn=d(Mt);Qs=r(Jn,"stefan-it"),Jn.forEach(o),Hs=r(ee,". The original code can be found "),wt=l(ee,"A",{href:!0,rel:!0});var Kn=d(wt);Us=r(Kn,"here"),Kn.forEach(o),Vs=r(ee,"."),ee.forEach(o),as=_(t),ie=l(t,"H2",{class:!0});var Ms=d(ie);ze=l(Ms,"A",{id:!0,class:!0,href:!0});var cl=d(ze);Jo=l(cl,"SPAN",{});var pl=d(Jo);v(Xt.$$.fragment,pl),pl.forEach(o),cl.forEach(o),Gs=_(Ms),Ko=l(Ms,"SPAN",{});var hl=d(Ko);Js=r(hl,"XLMRobertaXLConfig"),hl.forEach(o),Ms.forEach(o),rs=_(t),S=l(t,"DIV",{class:!0});var rt=d(S);v($t.$$.fragment,rt),Ks=_(rt),G=l(rt,"P",{});var it=d(G);Ys=r(it,"This is the configuration class to store the configuration of a "),mo=l(it,"A",{href:!0});var ml=d(mo);Zs=r(ml,"XLMRobertaXLModel"),ml.forEach(o),ea=r(it," or a "),Yo=l(it,"CODE",{});var ul=d(Yo);ta=r(ul,"TFXLMRobertaXLModel"),ul.forEach(o),oa=r(it,`.
It is used to instantiate a XLM_ROBERTA_XL model according to the specified arguments, defining the model
architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of the
...
documentation from `),fo=l(Fo,"A",{href:!0});var _l=d(fo);da=r(_l,"PretrainedConfig"),_l.forEach(o),ca=r(Fo," for more information."),Fo.forEach(o),pa=_(rt),v(Ce.$$.fragment,rt),rt.forEach(o),is=_(t),de=l(t,"H2",{class:!0});var ws=d(de);qe=l(ws,"A",{id:!0,class:!0,href:!0});var bl=d(qe);Zo=l(bl,"SPAN",{});var Ll=d(Zo);v(yt.$$.fragment,Ll),Ll.forEach(o),bl.forEach(o),ha=_(ws),en=l(ws,"SPAN",{});var kl=d(en);ma=r(kl,"XLMRobertaXLModel"),kl.forEach(o),ws.forEach(o),ls=_(t),N=l(t,"DIV",{class:!0});var lt=d(N);v(xt.$$.fragment,lt),ua=_(lt),ce=l(lt,"P",{});var zo=d(ce);fa=r(zo,`The bare XLM-RoBERTa-xlarge Model transformer outputting raw hidden-states without any specific head on top.
...
output and a softmax) e.g. for RocStories/SWAG tasks.`),id.forEach(o),ai=_(ut),ke=l(ut,"P",{});var So=d(ke);ri=r(So,"This model inherits from "),Xo=l(So,"A",{href:!0});var ld=d(Xo);ii=r(ld,"PreTrainedModel"),ld.forEach(o),li=r(So,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
