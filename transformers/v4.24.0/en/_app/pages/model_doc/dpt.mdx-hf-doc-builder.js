...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/dpt/feature_extraction_dpt.py#L138",returnDescription:`
<p>A <a
...
None, predictions will not be resized.`,name:"target_sizes"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/dpt/feature_extraction_dpt.py#L209",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/dpt/modeling_dpt.py#L704",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/dpt#transformers.DPTConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/dpt/modeling_dpt.py#L859"}}),Be=new O({props:{name:"forward",anchor:"transformers.DPTForDepthEstimation.forward",parameters:[{name:"pixel_values",val:""},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.DPTForDepthEstimation.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
Ground truth depth estimation maps for computing the loss.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/dpt/modeling_dpt.py#L874",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.modeling_outputs.DepthEstimatorOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/dpt/modeling_dpt.py#L1019"}}),Ye=new O({props:{name:"forward",anchor:"transformers.DPTForSemanticSegmentation.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.DPTForSemanticSegmentation.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
Ground truth semantic segmentation maps for computing the loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code>, a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/dpt/modeling_dpt.py#L1035",returnDescription:`
<p>A <a
...
behavior.`),kr=h(),I=r("div"),b(Ne.$$.fragment),Fr=h(),K=r("p"),jr=i("The "),it=r("a"),zr=i("DPTModel"),Ir=i(" forward method, overrides the "),jt=r("code"),Sr=i("__call__"),Cr=i(" special method."),Mr=h(),b(ie.$$.fragment),qr=h(),b(le.$$.fragment),ao=h(),G=r("h2"),de=r("a"),zt=r("span"),b(Oe.$$.fragment),Ar=h(),It=r("span"),Lr=i("DPTForDepthEstimation"),no=h(),j=r("div"),b(Ve.$$.fragment),Nr=h(),St=r("p"),Or=i("DPT Model with a depth estimation head on top (consisting of 3 convolutional layers) e.g. for KITTI, NYUv2."),Vr=h(),Re=r("p"),Rr=i("This model is a PyTorch "),We=r("a"),Wr=i("torch.nn.Module"),Br=i(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
should refer to this superclass for more information regarding those methods.`),ho.forEach(o),hr=f(N),L=a(N,"DIV",{class:!0});var ft=s(L);w(Ie.$$.fragment,ft),fr=f(ft),Et=a(ft,"P",{});var La=s(Et);ur=l(La,"Main method to prepare for the model one or several image(s)."),La.forEach(o),gr=f(ft),w(ae.$$.fragment,ft),ft.forEach(o),_r=f(N),ne=a(N,"DIV",{class:!0});var fo=s(ne);w(Se.$$.fragment,fo),vr=f(fo),Ce=a(fo,"P",{});var uo=s(Ce);Tr=l(uo,"Converts the output of "),st=a(uo,"A",{href:!0});var Na=s(st);br=l(Na,"DPTForSemanticSegmentation"),Na.forEach(o),wr=l(uo," into semantic segmentation maps. Only supports PyTorch."),uo.forEach(o),fo.forEach(o),N.forEach(o),oo=f(t),H=a(t,"H2",{class:!0});var go=s(H);se=a(go,"A",{id:!0,class:!0,href:!0});var Oa=s(se);kt=a(Oa,"SPAN",{});var Va=s(kt);w(Me.$$.fragment,Va),Va.forEach(o),Oa.forEach(o),Pr=f(go),Ft=a(go,"SPAN",{});var Ra=s(Ft);$r=l(Ra,"DPTModel"),Ra.forEach(o),go.forEach(o),ro=f(t),M=a(t,"DIV",{class:!0});var ut=s(M);w(qe.$$.fragment,ut),yr=f(ut),Ae=a(ut,"P",{});var _o=s(Ae);Dr=l(_o,`The bare DPT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Le=a(_o,"A",{href:!0,rel:!0});var Wa=s(Le);xr=l(Wa,"torch.nn.Module"),Wa.forEach(o),Er=l(_o,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o.forEach(o),kr=f(ut),I=a(ut,"DIV",{class:!0});var ge=s(I);w(Ne.$$.fragment,ge),Fr=f(ge),K=a(ge,"P",{});var gt=s(K);jr=l(gt,"The "),it=a(gt,"A",{href:!0});var Ba=s(it);zr=l(Ba,"DPTModel"),Ba.forEach(o),Ir=l(gt," forward method, overrides the "),jt=a(gt,"CODE",{});var Ua=s(jt);Sr=l(Ua,"__call__"),Ua.forEach(o),Cr=l(gt," special method."),gt.forEach(o),Mr=f(ge),w(ie.$$.fragment,ge),qr=f(ge),w(le.$$.fragment,ge),ge.forEach(o),ut.forEach(o),ao=f(t),G=a(t,"H2",{class:!0});var vo=s(G);de=a(vo,"A",{id:!0,class:!0,href:!0});var Ha=s(de);zt=a(Ha,"SPAN",{});var Ka=s(zt);w(Oe.$$.fragment,Ka),Ka.forEach(o),Ha.forEach(o),Ar=f(vo),It=a(vo,"SPAN",{});var Ga=s(It);Lr=l(Ga,"DPTForDepthEstimation"),Ga.forEach(o),vo.forEach(o),no=f(t),j=a(t,"DIV",{class:!0});var _e=s(j);w(Ve.$$.fragment,_e),Nr=f(_e),St=a(_e,"P",{});var Ya=s(St);Or=l(Ya,"DPT Model with a depth estimation head on top (consisting of 3 convolutional layers) e.g. for KITTI, NYUv2."),Ya.forEach(o),Vr=f(_e),Re=a(_e,"P",{});var To=s(Re);Rr=l(To,"This model is a PyTorch "),We=a(To,"A",{href:!0,rel:!0});var Ja=s(We);Wr=l(Ja,"torch.nn.Module"),Ja.forEach(o),Br=l(To,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
