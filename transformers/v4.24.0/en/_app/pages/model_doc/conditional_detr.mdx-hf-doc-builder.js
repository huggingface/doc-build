import{S as Fs,i as ks,s as zs,e as n,k as h,w as x,t as s,M as qs,c as a,d as o,m,a as r,x as w,h as i,b as l,N as Ps,G as e,g as _,y as C,q as D,o as y,B as T,v as Os,L as rn}from"../../chunks/vendor-hf-doc-builder.js";import{T as nn}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as sn}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ut}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as an}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function As(E){let c,v,u,p,b;return p=new sn({props:{code:`from transformers import ConditionalDetrConfig, ConditionalDetrModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){c=n("p"),v=s("Examples:"),u=h(),x(p.$$.fragment)},l(d){c=a(d,"P",{});var g=r(c);v=i(g,"Examples:"),g.forEach(o),u=m(d),w(p.$$.fragment,d)},m(d,g){_(d,c,g),e(c,v),_(d,u,g),C(p,d,g),b=!0},p:rn,i(d){b||(D(p.$$.fragment,d),b=!0)},o(d){y(p.$$.fragment,d),b=!1},d(d){d&&o(c),d&&o(u),T(p,d)}}}function Ms(E){let c,v;return{c(){c=n("p"),v=s(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
Detected couch <span class="hljs-keyword">with</span> confidence <span class="hljs-number">0.535</span> at location [<span class="hljs-number">0.52</span>, <span class="hljs-number">1.19</span>, <span class="hljs-number">640.35</span>, <span class="hljs-number">475.1</span>]`}}),{c(){c=n("p"),v=s("Examples:"),u=h(),x(p.$$.fragment)},l(d){c=a(d,"P",{});var g=r(c);v=i(g,"Examples:"),g.forEach(o),u=m(d),w(p.$$.fragment,d)},m(d,g){_(d,c,g),e(c,v),_(d,u,g),C(p,d,g),b=!0},p:rn,i(d){b||(D(p.$$.fragment,d),b=!0)},o(d){y(p.$$.fragment,d),b=!1},d(d){d&&o(c),d&&o(u),T(p,d)}}}function Rs(E){let c,v,u,p,b;return{c(){c=n("p"),v=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),p=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){c=a(d,"P",{});var g=r(c);v=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(g,"CODE",{});var q=r(u);p=i(q,"Module"),q.forEach(o),b=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<p>In case <a href="/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrFeatureExtractor">ConditionalDetrFeatureExtractor</a> was initialized with <code>format = &quot;coco_detection&quot;</code>, the
...
<p>In case <a href="/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrFeatureExtractor">ConditionalDetrFeatureExtractor</a> was initialized with <code>format = &quot;coco_panoptic&quot;</code>, the
...
</ul>`,name:"pad_and_return_pixel_mask"},{anchor:"transformers.ConditionalDetrFeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/v4.24.0/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of NumPy arrays. If set to <code>&apos;pt&apos;</code>, return PyTorch <code>torch.Tensor</code>
objects.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/conditional_detr/feature_extraction_conditional_detr.py#L545",returnDescription:`
<p>A <a
...
If set, will return tensors instead of NumPy arrays. If set to <code>&apos;pt&apos;</code>, return PyTorch <code>torch.Tensor</code>
objects.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/conditional_detr/feature_extraction_conditional_detr.py#L785",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a> with the following fields:</p>
<ul>
...
(height, width) of each image in the batch. If left to None, predictions will not be resized.`,name:"target_sizes"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/conditional_detr/feature_extraction_conditional_detr.py#L873",returnDescription:`
...
format.`,name:"return_coco_annotation"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/conditional_detr/feature_extraction_conditional_detr.py#L978",returnDescription:`
...
batch. If left to None, predictions will not be resized.`,name:"target_sizes"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/conditional_detr/feature_extraction_conditional_detr.py#L928",returnDescription:`
...
resized.`,name:"target_sizes"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/conditional_detr/feature_extraction_conditional_detr.py#L1064",returnDescription:`
<p>A list of dictionaries, one per image, each dictionary containing two keys:</p>
<ul>
<li><strong>segmentation</strong> \u2014 a tensor of shape <code>(height, width)</code> where each pixel represents a <code>segment_id</code> or
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/conditional_detr/modeling_conditional_detr.py#L1498",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrConfig"
...
possible padding). You can use <a
  href="/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrFeatureExtractor.post_process_object_detection"
...
<code>torch.FloatTensor</code> of shape <code>(number of bounding boxes in the image, height, width)</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/conditional_detr/modeling_conditional_detr.py#L1843",returnDescription:`
...
<a
  href="/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrFeatureExtractor.post_process_semantic_segmentation"
>post_process_semantic_segmentation()</a> or
<a
  href="/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrFeatureExtractor.post_process_instance_segmentation"
>post_process_instance_segmentation()</a>
<a
  href="/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrFeatureExtractor.post_process_panoptic_segmentation"
...
`}}),xe=new nn({props:{$$slots:{default:[Rs]},$$scope:{ctx:E}}}),we=new an({props:{anchor:"transformers.ConditionalDetrForSegmentation.forward.example",$$slots:{default:[Us]},$$scope:{ctx:E}}}),{c(){c=n("meta"),v=h(),u=n("h1"),p=n("a"),b=n("span"),x(d.$$.fragment),g=h(),q=n("span"),dn=s("Conditional DETR"),fo=h(),W=n("h2"),ee=n("a"),Nt=n("span"),x($e.$$.fragment),ln=h(),Rt=n("span"),cn=s("Overview"),uo=h(),te=n("p"),hn=s("The Conditional DETR model was proposed in "),Ee=n("a"),mn=s("Conditional DETR for Fast Training Convergence"),pn=s(" by Depu Meng, Xiaokang Chen, Zejia Fan, Gang Zeng, Houqiang Li, Yuhui Yuan, Lei Sun, Jingdong Wang. Conditional DETR presents a conditional cross-attention mechanism for fast DETR training. Conditional DETR converges 6.7\xD7 to 10\xD7 faster than DETR."),go=h(),gt=n("p"),fn=s("The abstract from the paper is the following:"),_o=h(),_t=n("p"),je=n("em"),un=s("The recently-developed DETR approach applies the transformer encoder and decoder architecture to object detection and achieves promising performance. In this paper, we handle the critical issue, slow training convergence, and present a conditional cross-attention mechanism for fast DETR training. Our approach is motivated by that the cross-attention in DETR relies highly on the content embeddings for localizing the four extremities and predicting the box, which increases the need for high-quality content embeddings and thus the training difficulty. Our approach, named conditional DETR, learns a conditional spatial query from the decoder embedding for decoder multi-head cross-attention. The benefit is that through the conditional spatial query, each cross-attention head is able to attend to a band containing a distinct region, e.g., one object extremity or a region inside the object box. This narrows down the spatial range for localizing the distinct regions for object classification and box regression, thus relaxing the dependence on the content embeddings and easing the training. Empirical results show that conditional DETR converges 6.7\xD7 faster for the backbones R50 and R101 and 10\xD7 faster for stronger backbones DC5-R50 and DC5-R101. Code is available at "),Fe=n("a"),gn=s("https://github.com/Atten4Vis/ConditionalDETR"),_n=s("."),bo=h(),oe=n("img"),vo=h(),ne=n("small"),bn=s("Conditional DETR shows much faster convergence compared to the original DETR. Taken from the "),bt=n("a"),vn=s("original paper"),xn=s("."),xo=h(),L=n("p"),wn=s("This model was contributed by "),ke=n("a"),Cn=s("DepuMeng"),Dn=s(". The original code can be found "),ze=n("a"),yn=s("here"),Tn=s("."),wo=h(),H=n("h2"),ae=n("a"),Ut=n("span"),x(qe.$$.fragment),$n=h(),Wt=n("span"),En=s("ConditionalDetrConfig"),Co=h(),O=n("div"),x(Pe.$$.fragment),jn=h(),V=n("p"),Fn=s("This is the configuration class to store the configuration of a "),vt=n("a"),kn=s("ConditionalDetrModel"),zn=s(`. It is used to instantiate
...
`),Oe=n("a"),qn=s("microsoft/conditional-detr-resnet-50"),Pn=s(" architecture."),On=h(),B=n("p"),An=s("Configuration objects inherit from "),xt=n("a"),Mn=s("PretrainedConfig"),In=s(` and can be used to control the model outputs. Read the
documentation from `),wt=n("a"),Ln=s("PretrainedConfig"),Sn=s(" for more information."),Nn=h(),x(re.$$.fragment),Do=h(),G=n("h2"),se=n("a"),Ht=n("span"),x(Ae.$$.fragment),Rn=h(),Vt=n("span"),Un=s("ConditionalDetrFeatureExtractor"),yo=h(),$=n("div"),x(Me.$$.fragment),Wn=h(),Bt=n("p"),Hn=s("Constructs a Conditional DETR feature extractor."),Vn=h(),Ie=n("p"),Bn=s("This feature extractor inherits from "),Ct=n("a"),Gn=s("FeatureExtractionMixin"),Yn=s(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Zn=h(),S=n("div"),x(Le.$$.fragment),Jn=h(),Gt=n("p"),Xn=s(`Main method to prepare for the model one or several image(s) and optional annotations. Images are by default
padded up to the largest image in a batch, and a pixel mask is created that indicates which pixels are
real/which are padding.`),Kn=h(),x(ie.$$.fragment),Qn=h(),de=n("div"),x(Se.$$.fragment),ea=h(),Ne=n("p"),ta=s("Pad images up to the largest image in a batch and create a corresponding "),Yt=n("code"),oa=s("pixel_mask"),na=s("."),aa=h(),le=n("div"),x(Re.$$.fragment),ra=h(),Ue=n("p"),sa=s("Converts the output of "),Dt=n("a"),ia=s("ConditionalDetrForObjectDetection"),da=s(` into the format expected by the COCO api. Only
supports PyTorch.`),la=h(),ce=n("div"),x(We.$$.fragment),ca=h(),He=n("p"),ha=s("Converts the output of "),yt=n("a"),ma=s("ConditionalDetrForSegmentation"),pa=s(` into instance segmentation predictions. Only supports
PyTorch.`),fa=h(),he=n("div"),x(Ve.$$.fragment),ua=h(),Be=n("p"),ga=s("Converts the output of "),Tt=n("a"),_a=s("ConditionalDetrForSegmentation"),ba=s(` into semantic segmentation maps. Only supports
PyTorch.`),va=h(),me=n("div"),x(Ge.$$.fragment),xa=h(),Ye=n("p"),wa=s("Converts the output of "),$t=n("a"),Ca=s("ConditionalDetrForSegmentation"),Da=s(` into image panoptic segmentation predictions. Only
supports PyTorch.`),To=h(),Y=n("h2"),pe=n("a"),Zt=n("span"),x(Ze.$$.fragment),ya=h(),Jt=n("span"),Ta=s("ConditionalDetrModel"),$o=h(),F=n("div"),x(Je.$$.fragment),$a=h(),Xt=n("p"),Ea=s(`The bare Conditional DETR Model (consisting of a backbone and encoder-decoder Transformer) outputting raw
hidden-states without any specific head on top.`),ja=h(),Xe=n("p"),Fa=s("This model inherits from "),Et=n("a"),ka=s("PreTrainedModel"),za=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qa=h(),Ke=n("p"),Pa=s("This model is also a PyTorch "),Qe=n("a"),Oa=s("torch.nn.Module"),Aa=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ma=h(),A=n("div"),x(et.$$.fragment),Ia=h(),Z=n("p"),La=s("The "),jt=n("a"),Sa=s("ConditionalDetrModel"),Na=s(" forward method, overrides the "),Kt=n("code"),Ra=s("__call__"),Ua=s(" special method."),Wa=h(),x(fe.$$.fragment),Ha=h(),x(ue.$$.fragment),Eo=h(),J=n("h2"),ge=n("a"),Qt=n("span"),x(tt.$$.fragment),Va=h(),eo=n("span"),Ba=s("ConditionalDetrForObjectDetection"),jo=h(),k=n("div"),x(ot.$$.fragment),Ga=h(),to=n("p"),Ya=s(`CONDITIONAL_DETR Model (consisting of a backbone and encoder-decoder Transformer) with object detection heads on
top, for tasks such as COCO detection.`),Za=h(),nt=n("p"),Ja=s("This model inherits from "),Ft=n("a"),Xa=s("PreTrainedModel"),Ka=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qa=h(),at=n("p"),er=s("This model is also a PyTorch "),rt=n("a"),tr=s("torch.nn.Module"),or=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nr=h(),M=n("div"),x(st.$$.fragment),ar=h(),X=n("p"),rr=s("The "),kt=n("a"),sr=s("ConditionalDetrForObjectDetection"),ir=s(" forward method, overrides the "),oo=n("code"),dr=s("__call__"),lr=s(" special method."),cr=h(),x(_e.$$.fragment),hr=h(),x(be.$$.fragment),Fo=h(),K=n("h2"),ve=n("a"),no=n("span"),x(it.$$.fragment),mr=h(),ao=n("span"),pr=s("ConditionalDetrForSegmentation"),ko=h(),z=n("div"),x(dt.$$.fragment),fr=h(),ro=n("p"),ur=s(`CONDITIONAL_DETR Model (consisting of a backbone and encoder-decoder Transformer) with a segmentation head on top,
for tasks such as COCO panoptic.`),gr=h(),lt=n("p"),_r=s("This model inherits from "),zt=n("a"),br=s("PreTrainedModel"),vr=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xr=h(),ct=n("p"),wr=s("This model is also a PyTorch "),ht=n("a"),Cr=s("torch.nn.Module"),Dr=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yr=h(),I=n("div"),x(mt.$$.fragment),Tr=h(),Q=n("p"),$r=s("The "),qt=n("a"),Er=s("ConditionalDetrForSegmentation"),jr=s(" forward method, overrides the "),so=n("code"),Fr=s("__call__"),kr=s(" special method."),zr=h(),x(xe.$$.fragment),qr=h(),x(we.$$.fragment),this.h()},l(t){const f=qs('[data-svelte="svelte-1phssyn"]',document.head);c=a(f,"META",{name:!0,content:!0}),f.forEach(o),v=m(t),u=a(t,"H1",{class:!0});var pt=r(u);p=a(pt,"A",{id:!0,class:!0,href:!0});var io=r(p);b=a(io,"SPAN",{});var lo=r(b);w(d.$$.fragment,lo),lo.forEach(o),io.forEach(o),g=m(pt),q=a(pt,"SPAN",{});var co=r(q);dn=i(co,"Conditional DETR"),co.forEach(o),pt.forEach(o),fo=m(t),W=a(t,"H2",{class:!0});var ft=r(W);ee=a(ft,"A",{id:!0,class:!0,href:!0});var ho=r(ee);Nt=a(ho,"SPAN",{});var mo=r(Nt);w($e.$$.fragment,mo),mo.forEach(o),ho.forEach(o),ln=m(ft),Rt=a(ft,"SPAN",{});var po=r(Rt);cn=i(po,"Overview"),po.forEach(o),ft.forEach(o),uo=m(t),te=a(t,"P",{});var qo=r(te);hn=i(qo,"The Conditional DETR model was proposed in "),Ee=a(qo,"A",{href:!0,rel:!0});var Or=r(Ee);mn=i(Or,"Conditional DETR for Fast Training Convergence"),Or.forEach(o),pn=i(qo," by Depu Meng, Xiaokang Chen, Zejia Fan, Gang Zeng, Houqiang Li, Yuhui Yuan, Lei Sun, Jingdong Wang. Conditional DETR presents a conditional cross-attention mechanism for fast DETR training. Conditional DETR converges 6.7\xD7 to 10\xD7 faster than DETR."),qo.forEach(o),go=m(t),gt=a(t,"P",{});var Ar=r(gt);fn=i(Ar,"The abstract from the paper is the following:"),Ar.forEach(o),_o=m(t),_t=a(t,"P",{});var Mr=r(_t);je=a(Mr,"EM",{});var Po=r(je);un=i(Po,"The recently-developed DETR approach applies the transformer encoder and decoder architecture to object detection and achieves promising performance. In this paper, we handle the critical issue, slow training convergence, and present a conditional cross-attention mechanism for fast DETR training. Our approach is motivated by that the cross-attention in DETR relies highly on the content embeddings for localizing the four extremities and predicting the box, which increases the need for high-quality content embeddings and thus the training difficulty. Our approach, named conditional DETR, learns a conditional spatial query from the decoder embedding for decoder multi-head cross-attention. The benefit is that through the conditional spatial query, each cross-attention head is able to attend to a band containing a distinct region, e.g., one object extremity or a region inside the object box. This narrows down the spatial range for localizing the distinct regions for object classification and box regression, thus relaxing the dependence on the content embeddings and easing the training. Empirical results show that conditional DETR converges 6.7\xD7 faster for the backbones R50 and R101 and 10\xD7 faster for stronger backbones DC5-R50 and DC5-R101. Code is available at "),Fe=a(Po,"A",{href:!0,rel:!0});var Ir=r(Fe);gn=i(Ir,"https://github.com/Atten4Vis/ConditionalDETR"),Ir.forEach(o),_n=i(Po,"."),Po.forEach(o),Mr.forEach(o),bo=m(t),oe=a(t,"IMG",{src:!0,alt:!0,width:!0}),vo=m(t),ne=a(t,"SMALL",{});var Oo=r(ne);bn=i(Oo,"Conditional DETR shows much faster convergence compared to the original DETR. Taken from the "),bt=a(Oo,"A",{href:!0});var Lr=r(bt);vn=i(Lr,"original paper"),Lr.forEach(o),xn=i(Oo,"."),Oo.forEach(o),xo=m(t),L=a(t,"P",{});var Pt=r(L);wn=i(Pt,"This model was contributed by "),ke=a(Pt,"A",{href:!0,rel:!0});var Sr=r(ke);Cn=i(Sr,"DepuMeng"),Sr.forEach(o),Dn=i(Pt,". The original code can be found "),ze=a(Pt,"A",{href:!0,rel:!0});var Nr=r(ze);yn=i(Nr,"here"),Nr.forEach(o),Tn=i(Pt,"."),Pt.forEach(o),wo=m(t),H=a(t,"H2",{class:!0});var Ao=r(H);ae=a(Ao,"A",{id:!0,class:!0,href:!0});var Rr=r(ae);Ut=a(Rr,"SPAN",{});var Ur=r(Ut);w(qe.$$.fragment,Ur),Ur.forEach(o),Rr.forEach(o),$n=m(Ao),Wt=a(Ao,"SPAN",{});var Wr=r(Wt);En=i(Wr,"ConditionalDetrConfig"),Wr.forEach(o),Ao.forEach(o),Co=m(t),O=a(t,"DIV",{class:!0});var Ce=r(O);w(Pe.$$.fragment,Ce),jn=m(Ce),V=a(Ce,"P",{});var Ot=r(V);Fn=i(Ot,"This is the configuration class to store the configuration of a "),vt=a(Ot,"A",{href:!0});var Hr=r(vt);kn=i(Hr,"ConditionalDetrModel"),Hr.forEach(o),zn=i(Ot,`. It is used to instantiate
a Conditional DETR model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Conditional DETR
`),Oe=a(Ot,"A",{href:!0,rel:!0});var Vr=r(Oe);qn=i(Vr,"microsoft/conditional-detr-resnet-50"),Vr.forEach(o),Pn=i(Ot," architecture."),Ot.forEach(o),On=m(Ce),B=a(Ce,"P",{});var At=r(B);An=i(At,"Configuration objects inherit from "),xt=a(At,"A",{href:!0});var Br=r(xt);Mn=i(Br,"PretrainedConfig"),Br.forEach(o),In=i(At,` and can be used to control the model outputs. Read the
documentation from `),wt=a(At,"A",{href:!0});var Gr=r(wt);Ln=i(Gr,"PretrainedConfig"),Gr.forEach(o),Sn=i(At," for more information."),At.forEach(o),Nn=m(Ce),w(re.$$.fragment,Ce),Ce.forEach(o),Do=m(t),G=a(t,"H2",{class:!0});var Mo=r(G);se=a(Mo,"A",{id:!0,class:!0,href:!0});var Yr=r(se);Ht=a(Yr,"SPAN",{});var Zr=r(Ht);w(Ae.$$.fragment,Zr),Zr.forEach(o),Yr.forEach(o),Rn=m(Mo),Vt=a(Mo,"SPAN",{});var Jr=r(Vt);Un=i(Jr,"ConditionalDetrFeatureExtractor"),Jr.forEach(o),Mo.forEach(o),yo=m(t),$=a(t,"DIV",{class:!0});var j=r($);w(Me.$$.fragment,j),Wn=m(j),Bt=a(j,"P",{});var Xr=r(Bt);Hn=i(Xr,"Constructs a Conditional DETR feature extractor."),Xr.forEach(o),Vn=m(j),Ie=a(j,"P",{});var Io=r(Ie);Bn=i(Io,"This feature extractor inherits from "),Ct=a(Io,"A",{href:!0});var Kr=r(Ct);Gn=i(Kr,"FeatureExtractionMixin"),Kr.forEach(o),Yn=i(Io,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Io.forEach(o),Zn=m(j),S=a(j,"DIV",{class:!0});var Mt=r(S);w(Le.$$.fragment,Mt),Jn=m(Mt),Gt=a(Mt,"P",{});var Qr=r(Gt);Xn=i(Qr,`Main method to prepare for the model one or several image(s) and optional annotations. Images are by default
padded up to the largest image in a batch, and a pixel mask is created that indicates which pixels are
real/which are padding.`),Qr.forEach(o),Kn=m(Mt),w(ie.$$.fragment,Mt),Mt.forEach(o),Qn=m(j),de=a(j,"DIV",{class:!0});var Lo=r(de);w(Se.$$.fragment,Lo),ea=m(Lo),Ne=a(Lo,"P",{});var So=r(Ne);ta=i(So,"Pad images up to the largest image in a batch and create a corresponding "),Yt=a(So,"CODE",{});var es=r(Yt);oa=i(es,"pixel_mask"),es.forEach(o),na=i(So,"."),So.forEach(o),Lo.forEach(o),aa=m(j),le=a(j,"DIV",{class:!0});var No=r(le);w(Re.$$.fragment,No),ra=m(No),Ue=a(No,"P",{});var Ro=r(Ue);sa=i(Ro,"Converts the output of "),Dt=a(Ro,"A",{href:!0});var ts=r(Dt);ia=i(ts,"ConditionalDetrForObjectDetection"),ts.forEach(o),da=i(Ro,` into the format expected by the COCO api. Only
supports PyTorch.`),Ro.forEach(o),No.forEach(o),la=m(j),ce=a(j,"DIV",{class:!0});var Uo=r(ce);w(We.$$.fragment,Uo),ca=m(Uo),He=a(Uo,"P",{});var Wo=r(He);ha=i(Wo,"Converts the output of "),yt=a(Wo,"A",{href:!0});var os=r(yt);ma=i(os,"ConditionalDetrForSegmentation"),os.forEach(o),pa=i(Wo,` into instance segmentation predictions. Only supports
PyTorch.`),Wo.forEach(o),Uo.forEach(o),fa=m(j),he=a(j,"DIV",{class:!0});var Ho=r(he);w(Ve.$$.fragment,Ho),ua=m(Ho),Be=a(Ho,"P",{});var Vo=r(Be);ga=i(Vo,"Converts the output of "),Tt=a(Vo,"A",{href:!0});var ns=r(Tt);_a=i(ns,"ConditionalDetrForSegmentation"),ns.forEach(o),ba=i(Vo,` into semantic segmentation maps. Only supports
PyTorch.`),Vo.forEach(o),Ho.forEach(o),va=m(j),me=a(j,"DIV",{class:!0});var Bo=r(me);w(Ge.$$.fragment,Bo),xa=m(Bo),Ye=a(Bo,"P",{});var Go=r(Ye);wa=i(Go,"Converts the output of "),$t=a(Go,"A",{href:!0});var as=r($t);Ca=i(as,"ConditionalDetrForSegmentation"),as.forEach(o),Da=i(Go,` into image panoptic segmentation predictions. Only
supports PyTorch.`),Go.forEach(o),Bo.forEach(o),j.forEach(o),To=m(t),Y=a(t,"H2",{class:!0});var Yo=r(Y);pe=a(Yo,"A",{id:!0,class:!0,href:!0});var rs=r(pe);Zt=a(rs,"SPAN",{});var ss=r(Zt);w(Ze.$$.fragment,ss),ss.forEach(o),rs.forEach(o),ya=m(Yo),Jt=a(Yo,"SPAN",{});var is=r(Jt);Ta=i(is,"ConditionalDetrModel"),is.forEach(o),Yo.forEach(o),$o=m(t),F=a(t,"DIV",{class:!0});var N=r(F);w(Je.$$.fragment,N),$a=m(N),Xt=a(N,"P",{});var ds=r(Xt);Ea=i(ds,`The bare Conditional DETR Model (consisting of a backbone and encoder-decoder Transformer) outputting raw
hidden-states without any specific head on top.`),ds.forEach(o),ja=m(N),Xe=a(N,"P",{});var Zo=r(Xe);Fa=i(Zo,"This model inherits from "),Et=a(Zo,"A",{href:!0});var ls=r(Et);ka=i(ls,"PreTrainedModel"),ls.forEach(o),za=i(Zo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zo.forEach(o),qa=m(N),Ke=a(N,"P",{});var Jo=r(Ke);Pa=i(Jo,"This model is also a PyTorch "),Qe=a(Jo,"A",{href:!0,rel:!0});var cs=r(Qe);Oa=i(cs,"torch.nn.Module"),cs.forEach(o),Aa=i(Jo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jo.forEach(o),Ma=m(N),A=a(N,"DIV",{class:!0});var De=r(A);w(et.$$.fragment,De),Ia=m(De),Z=a(De,"P",{});var It=r(Z);La=i(It,"The "),jt=a(It,"A",{href:!0});var hs=r(jt);Sa=i(hs,"ConditionalDetrModel"),hs.forEach(o),Na=i(It," forward method, overrides the "),Kt=a(It,"CODE",{});var ms=r(Kt);Ra=i(ms,"__call__"),ms.forEach(o),Ua=i(It," special method."),It.forEach(o),Wa=m(De),w(fe.$$.fragment,De),Ha=m(De),w(ue.$$.fragment,De),De.forEach(o),N.forEach(o),Eo=m(t),J=a(t,"H2",{class:!0});var Xo=r(J);ge=a(Xo,"A",{id:!0,class:!0,href:!0});var ps=r(ge);Qt=a(ps,"SPAN",{});var fs=r(Qt);w(tt.$$.fragment,fs),fs.forEach(o),ps.forEach(o),Va=m(Xo),eo=a(Xo,"SPAN",{});var us=r(eo);Ba=i(us,"ConditionalDetrForObjectDetection"),us.forEach(o),Xo.forEach(o),jo=m(t),k=a(t,"DIV",{class:!0});var R=r(k);w(ot.$$.fragment,R),Ga=m(R),to=a(R,"P",{});var gs=r(to);Ya=i(gs,`CONDITIONAL_DETR Model (consisting of a backbone and encoder-decoder Transformer) with object detection heads on
top, for tasks such as COCO detection.`),gs.forEach(o),Za=m(R),nt=a(R,"P",{});var Ko=r(nt);Ja=i(Ko,"This model inherits from "),Ft=a(Ko,"A",{href:!0});var _s=r(Ft);Xa=i(_s,"PreTrainedModel"),_s.forEach(o),Ka=i(Ko,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ko.forEach(o),Qa=m(R),at=a(R,"P",{});var Qo=r(at);er=i(Qo,"This model is also a PyTorch "),rt=a(Qo,"A",{href:!0,rel:!0});var bs=r(rt);tr=i(bs,"torch.nn.Module"),bs.forEach(o),or=i(Qo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qo.forEach(o),nr=m(R),M=a(R,"DIV",{class:!0});var ye=r(M);w(st.$$.fragment,ye),ar=m(ye),X=a(ye,"P",{});var Lt=r(X);rr=i(Lt,"The "),kt=a(Lt,"A",{href:!0});var vs=r(kt);sr=i(vs,"ConditionalDetrForObjectDetection"),vs.forEach(o),ir=i(Lt," forward method, overrides the "),oo=a(Lt,"CODE",{});var xs=r(oo);dr=i(xs,"__call__"),xs.forEach(o),lr=i(Lt," special method."),Lt.forEach(o),cr=m(ye),w(_e.$$.fragment,ye),hr=m(ye),w(be.$$.fragment,ye),ye.forEach(o),R.forEach(o),Fo=m(t),K=a(t,"H2",{class:!0});var en=r(K);ve=a(en,"A",{id:!0,class:!0,href:!0});var ws=r(ve);no=a(ws,"SPAN",{});var Cs=r(no);w(it.$$.fragment,Cs),Cs.forEach(o),ws.forEach(o),mr=m(en),ao=a(en,"SPAN",{});var Ds=r(ao);pr=i(Ds,"ConditionalDetrForSegmentation"),Ds.forEach(o),en.forEach(o),ko=m(t),z=a(t,"DIV",{class:!0});var U=r(z);w(dt.$$.fragment,U),fr=m(U),ro=a(U,"P",{});var ys=r(ro);ur=i(ys,`CONDITIONAL_DETR Model (consisting of a backbone and encoder-decoder Transformer) with a segmentation head on top,
for tasks such as COCO panoptic.`),ys.forEach(o),gr=m(U),lt=a(U,"P",{});var tn=r(lt);_r=i(tn,"This model inherits from "),zt=a(tn,"A",{href:!0});var Ts=r(zt);br=i(Ts,"PreTrainedModel"),Ts.forEach(o),vr=i(tn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tn.forEach(o),xr=m(U),ct=a(U,"P",{});var on=r(ct);wr=i(on,"This model is also a PyTorch "),ht=a(on,"A",{href:!0,rel:!0});var $s=r(ht);Cr=i($s,"torch.nn.Module"),$s.forEach(o),Dr=i(on,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),on.forEach(o),yr=m(U),I=a(U,"DIV",{class:!0});var Te=r(I);w(mt.$$.fragment,Te),Tr=m(Te),Q=a(Te,"P",{});var St=r(Q);$r=i(St,"The "),qt=a(St,"A",{href:!0});var Es=r(qt);Er=i(Es,"ConditionalDetrForSegmentation"),Es.forEach(o),jr=i(St," forward method, overrides the "),so=a(St,"CODE",{});var js=r(so);Fr=i(js,"__call__"),js.forEach(o),kr=i(St," special method."),St.forEach(o),zr=m(Te),w(xe.$$.fragment,Te),qr=m(Te),w(we.$$.fragment,Te),Te.forEach(o),U.forEach(o),this.h()},h(){l(c,"name","hf:doc:metadata"),l(c,"content",JSON.stringify(Hs)),l(p,"id","conditional-detr"),l(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(p,"href","#conditional-detr"),l(u,"class","relative group"),l(ee,"id","overview"),l(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ee,"href","#overview"),l(W,"class","relative group"),l(Ee,"href","https://arxiv.org/abs/2108.06152"),l(Ee,"rel","nofollow"),l(Fe,"href","https://github.com/Atten4Vis/ConditionalDETR"),l(Fe,"rel","nofollow"),Ps(oe.src,Pr="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/model_doc/conditional_detr_curve.jpg")||l(oe,"src",Pr),l(oe,"alt","drawing"),l(oe,"width","600"),l(bt,"href","https://arxiv.org/abs/2108.06152"),l(ke,"href","https://huggingface.co/DepuMeng"),l(ke,"rel","nofollow"),l(ze,"href","https://github.com/Atten4Vis/ConditionalDETR"),l(ze,"rel","nofollow"),l(ae,"id","transformers.ConditionalDetrConfig"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.ConditionalDetrConfig"),l(H,"class","relative group"),l(vt,"href","/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrModel"),l(Oe,"href","https://huggingface.co/microsoft/conditional-detr-resnet-50"),l(Oe,"rel","nofollow"),l(xt,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),l(wt,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),l(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(se,"id","transformers.ConditionalDetrFeatureExtractor"),l(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(se,"href","#transformers.ConditionalDetrFeatureExtractor"),l(G,"class","relative group"),l(Ct,"href","/docs/transformers/v4.24.0/en/internal/image_processing_utils#transformers.FeatureExtractionMixin"),l(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Dt,"href","/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForObjectDetection"),l(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(yt,"href","/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation"),l(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Tt,"href","/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation"),l(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l($t,"href","/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation"),l(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l($,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(pe,"id","transformers.ConditionalDetrModel"),l(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(pe,"href","#transformers.ConditionalDetrModel"),l(Y,"class","relative group"),l(Et,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),l(Qe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Qe,"rel","nofollow"),l(jt,"href","/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrModel"),l(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ge,"id","transformers.ConditionalDetrForObjectDetection"),l(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ge,"href","#transformers.ConditionalDetrForObjectDetection"),l(J,"class","relative group"),l(Ft,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),l(rt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(rt,"rel","nofollow"),l(kt,"href","/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForObjectDetection"),l(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(k,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ve,"id","transformers.ConditionalDetrForSegmentation"),l(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ve,"href","#transformers.ConditionalDetrForSegmentation"),l(K,"class","relative group"),l(zt,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),l(ht,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(ht,"rel","nofollow"),l(qt,"href","/docs/transformers/v4.24.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation"),l(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,f){e(document.head,c),_(t,v,f),_(t,u,f),e(u,p),e(p,b),C(d,b,null),e(u,g),e(u,q),e(q,dn),_(t,fo,f),_(t,W,f),e(W,ee),e(ee,Nt),C($e,Nt,null),e(W,ln),e(W,Rt),e(Rt,cn),_(t,uo,f),_(t,te,f),e(te,hn),e(te,Ee),e(Ee,mn),e(te,pn),_(t,go,f),_(t,gt,f),e(gt,fn),_(t,_o,f),_(t,_t,f),e(_t,je),e(je,un),e(je,Fe),e(Fe,gn),e(je,_n),_(t,bo,f),_(t,oe,f),_(t,vo,f),_(t,ne,f),e(ne,bn),e(ne,bt),e(bt,vn),e(ne,xn),_(t,xo,f),_(t,L,f),e(L,wn),e(L,ke),e(ke,Cn),e(L,Dn),e(L,ze),e(ze,yn),e(L,Tn),_(t,wo,f),_(t,H,f),e(H,ae),e(ae,Ut),C(qe,Ut,null),e(H,$n),e(H,Wt),e(Wt,En),_(t,Co,f),_(t,O,f),C(Pe,O,null),e(O,jn),e(O,V),e(V,Fn),e(V,vt),e(vt,kn),e(V,zn),e(V,Oe),e(Oe,qn),e(V,Pn),e(O,On),e(O,B),e(B,An),e(B,xt),e(xt,Mn),e(B,In),e(B,wt),e(wt,Ln),e(B,Sn),e(O,Nn),C(re,O,null),_(t,Do,f),_(t,G,f),e(G,se),e(se,Ht),C(Ae,Ht,null),e(G,Rn),e(G,Vt),e(Vt,Un),_(t,yo,f),_(t,$,f),C(Me,$,null),e($,Wn),e($,Bt),e(Bt,Hn),e($,Vn),e($,Ie),e(Ie,Bn),e(Ie,Ct),e(Ct,Gn),e(Ie,Yn),e($,Zn),e($,S),C(Le,S,null),e(S,Jn),e(S,Gt),e(Gt,Xn),e(S,Kn),C(ie,S,null),e($,Qn),e($,de),C(Se,de,null),e(de,ea),e(de,Ne),e(Ne,ta),e(Ne,Yt),e(Yt,oa),e(Ne,na),e($,aa),e($,le),C(Re,le,null),e(le,ra),e(le,Ue),e(Ue,sa),e(Ue,Dt),e(Dt,ia),e(Ue,da),e($,la),e($,ce),C(We,ce,null),e(ce,ca),e(ce,He),e(He,ha),e(He,yt),e(yt,ma),e(He,pa),e($,fa),e($,he),C(Ve,he,null),e(he,ua),e(he,Be),e(Be,ga),e(Be,Tt),e(Tt,_a),e(Be,ba),e($,va),e($,me),C(Ge,me,null),e(me,xa),e(me,Ye),e(Ye,wa),e(Ye,$t),e($t,Ca),e(Ye,Da),_(t,To,f),_(t,Y,f),e(Y,pe),e(pe,Zt),C(Ze,Zt,null),e(Y,ya),e(Y,Jt),e(Jt,Ta),_(t,$o,f),_(t,F,f),C(Je,F,null),e(F,$a),e(F,Xt),e(Xt,Ea),e(F,ja),e(F,Xe),e(Xe,Fa),e(Xe,Et),e(Et,ka),e(Xe,za),e(F,qa),e(F,Ke),e(Ke,Pa),e(Ke,Qe),e(Qe,Oa),e(Ke,Aa),e(F,Ma),e(F,A),C(et,A,null),e(A,Ia),e(A,Z),e(Z,La),e(Z,jt),e(jt,Sa),e(Z,Na),e(Z,Kt),e(Kt,Ra),e(Z,Ua),e(A,Wa),C(fe,A,null),e(A,Ha),C(ue,A,null),_(t,Eo,f),_(t,J,f),e(J,ge),e(ge,Qt),C(tt,Qt,null),e(J,Va),e(J,eo),e(eo,Ba),_(t,jo,f),_(t,k,f),C(ot,k,null),e(k,Ga),e(k,to),e(to,Ya),e(k,Za),e(k,nt),e(nt,Ja),e(nt,Ft),e(Ft,Xa),e(nt,Ka),e(k,Qa),e(k,at),e(at,er),e(at,rt),e(rt,tr),e(at,or),e(k,nr),e(k,M),C(st,M,null),e(M,ar),e(M,X),e(X,rr),e(X,kt),e(kt,sr),e(X,ir),e(X,oo),e(oo,dr),e(X,lr),e(M,cr),C(_e,M,null),e(M,hr),C(be,M,null),_(t,Fo,f),_(t,K,f),e(K,ve),e(ve,no),C(it,no,null),e(K,mr),e(K,ao),e(ao,pr),_(t,ko,f),_(t,z,f),C(dt,z,null),e(z,fr),e(z,ro),e(ro,ur),e(z,gr),e(z,lt),e(lt,_r),e(lt,zt),e(zt,br),e(lt,vr),e(z,xr),e(z,ct),e(ct,wr),e(ct,ht),e(ht,Cr),e(ct,Dr),e(z,yr),e(z,I),C(mt,I,null),e(I,Tr),e(I,Q),e(Q,$r),e(Q,qt),e(qt,Er),e(Q,jr),e(Q,so),e(so,Fr),e(Q,kr),e(I,zr),C(xe,I,null),e(I,qr),C(we,I,null),zo=!0},p(t,[f]){const pt={};f&2&&(pt.$$scope={dirty:f,ctx:t}),re.$set(pt);const io={};f&2&&(io.$$scope={dirty:f,ctx:t}),ie.$set(io);const lo={};f&2&&(lo.$$scope={dirty:f,ctx:t}),fe.$set(lo);const co={};f&2&&(co.$$scope={dirty:f,ctx:t}),ue.$set(co);const ft={};f&2&&(ft.$$scope={dirty:f,ctx:t}),_e.$set(ft);const ho={};f&2&&(ho.$$scope={dirty:f,ctx:t}),be.$set(ho);const mo={};f&2&&(mo.$$scope={dirty:f,ctx:t}),xe.$set(mo);const po={};f&2&&(po.$$scope={dirty:f,ctx:t}),we.$set(po)},i(t){zo||(D(d.$$.fragment,t),D($e.$$.fragment,t),D(qe.$$.fragment,t),D(Pe.$$.fragment,t),D(re.$$.fragment,t),D(Ae.$$.fragment,t),D(Me.$$.fragment,t),D(Le.$$.fragment,t),D(ie.$$.fragment,t),D(Se.$$.fragment,t),D(Re.$$.fragment,t),D(We.$$.fragment,t),D(Ve.$$.fragment,t),D(Ge.$$.fragment,t),D(Ze.$$.fragment,t),D(Je.$$.fragment,t),D(et.$$.fragment,t),D(fe.$$.fragment,t),D(ue.$$.fragment,t),D(tt.$$.fragment,t),D(ot.$$.fragment,t),D(st.$$.fragment,t),D(_e.$$.fragment,t),D(be.$$.fragment,t),D(it.$$.fragment,t),D(dt.$$.fragment,t),D(mt.$$.fragment,t),D(xe.$$.fragment,t),D(we.$$.fragment,t),zo=!0)},o(t){y(d.$$.fragment,t),y($e.$$.fragment,t),y(qe.$$.fragment,t),y(Pe.$$.fragment,t),y(re.$$.fragment,t),y(Ae.$$.fragment,t),y(Me.$$.fragment,t),y(Le.$$.fragment,t),y(ie.$$.fragment,t),y(Se.$$.fragment,t),y(Re.$$.fragment,t),y(We.$$.fragment,t),y(Ve.$$.fragment,t),y(Ge.$$.fragment,t),y(Ze.$$.fragment,t),y(Je.$$.fragment,t),y(et.$$.fragment,t),y(fe.$$.fragment,t),y(ue.$$.fragment,t),y(tt.$$.fragment,t),y(ot.$$.fragment,t),y(st.$$.fragment,t),y(_e.$$.fragment,t),y(be.$$.fragment,t),y(it.$$.fragment,t),y(dt.$$.fragment,t),y(mt.$$.fragment,t),y(xe.$$.fragment,t),y(we.$$.fragment,t),zo=!1},d(t){o(c),t&&o(v),t&&o(u),T(d),t&&o(fo),t&&o(W),T($e),t&&o(uo),t&&o(te),t&&o(go),t&&o(gt),t&&o(_o),t&&o(_t),t&&o(bo),t&&o(oe),t&&o(vo),t&&o(ne),t&&o(xo),t&&o(L),t&&o(wo),t&&o(H),T(qe),t&&o(Co),t&&o(O),T(Pe),T(re),t&&o(Do),t&&o(G),T(Ae),t&&o(yo),t&&o($),T(Me),T(Le),T(ie),T(Se),T(Re),T(We),T(Ve),T(Ge),t&&o(To),t&&o(Y),T(Ze),t&&o($o),t&&o(F),T(Je),T(et),T(fe),T(ue),t&&o(Eo),t&&o(J),T(tt),t&&o(jo),t&&o(k),T(ot),T(st),T(_e),T(be),t&&o(Fo),t&&o(K),T(it),t&&o(ko),t&&o(z),T(dt),T(mt),T(xe),T(we)}}}const Hs={local:"conditional-detr",sections:[{local:"overview",title:"Overview"},{local:"transformers.ConditionalDetrConfig",title:"ConditionalDetrConfig"},{local:"transformers.ConditionalDetrFeatureExtractor",title:"ConditionalDetrFeatureExtractor"},{local:"transformers.ConditionalDetrModel",title:"ConditionalDetrModel"},{local:"transformers.ConditionalDetrForObjectDetection",title:"ConditionalDetrForObjectDetection"},{local:"transformers.ConditionalDetrForSegmentation",title:"ConditionalDetrForSegmentation"}],title:"Conditional DETR"};function Vs(E){return Os(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ks extends Fs{constructor(c){super();ks(this,c,Vs,Ws,zs,{})}}export{Ks as default,Hs as metadata};
