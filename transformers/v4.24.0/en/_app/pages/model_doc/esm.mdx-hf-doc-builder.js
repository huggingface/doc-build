import{S as ff,i as uf,s as gf,e as a,k as m,w as v,t as n,M as _f,c as r,d as o,m as p,a as i,x as T,h as s,b as h,G as e,g as k,y,q as w,o as $,B as E,v as kf,L as S}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ge}from"../../chunks/Tip-hf-doc-builder.js";import{D as z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as L}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ee}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as P}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function bf(F){let d,_,c,f,b;return f=new L({props:{code:`from transformers import EsmModel, EsmConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){k(l,d,u),e(d,_),e(d,c),e(c,f),e(d,b)},d(l){l&&o(d)}}}function Tf(F){let d,_,c,f,b;return f=new L({props:{code:`from transformers import EsmTokenizer, EsmModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),_=n("Example:"),c=m(),v(f.$$.fragment)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(o),c=p(l),T(f.$$.fragment,l)},m(l,u){k(l,d,u),e(d,_),k(l,c,u),y(f,l,u),b=!0},p:S,i(l){b||(w(f.$$.fragment,l),b=!0)},o(l){$(f.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(c),E(f,l)}}}function yf(F){let d,_,c,f,b;return{c(){d=a("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(u,"CODE",{});var M=i(c);f=s(M,"Module"),M.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){y(d,c,f),_=!0},p:S,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){E(d,c)}}}function Ef(F){let d,_,c,f,b;return{c(){d=a("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(u,"CODE",{});var M=i(c);f=s(M,"Module"),M.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=a("p"),_=n("Example of single-label classification:"),c=m(),v(f.$$.fragment)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Example of single-label classification:"),u.forEach(o),c=p(l),T(f.$$.fragment,l)},m(l,u){k(l,d,u),e(d,_),k(l,c,u),y(f,l,u),b=!0},p:S,i(l){b||(w(f.$$.fragment,l),b=!0)},o(l){$(f.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(c),E(f,l)}}}function Mf(F){let d,_;return d=new L({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){y(d,c,f),_=!0},p:S,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){E(d,c)}}}function zf(F){let d,_,c,f,b;return f=new L({props:{code:`import torch
from transformers import EsmTokenizer, EsmForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=a("p"),_=n("Example of multi-label classification:"),c=m(),v(f.$$.fragment)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Example of multi-label classification:"),u.forEach(o),c=p(l),T(f.$$.fragment,l)},m(l,u){k(l,d,u),e(d,_),k(l,c,u),y(f,l,u),b=!0},p:S,i(l){b||(w(f.$$.fragment,l),b=!0)},o(l){$(f.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(c),E(f,l)}}}function qf(F){let d,_;return d=new L({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
`}}),{c(){d=a("p"),_=n("Example:"),c=m(),v(f.$$.fragment)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(o),c=p(l),T(f.$$.fragment,l)},m(l,u){k(l,d,u),e(d,_),k(l,c,u),y(f,l,u),b=!0},p:S,i(l){b||(w(f.$$.fragment,l),b=!0)},o(l){$(f.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(c),E(f,l)}}}function jf(F){let d,_;return d=new L({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){y(d,c,f),_=!0},p:S,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){E(d,c)}}}function Pf(F){let d,_,c,f,b;return{c(){d=a("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(u,"CODE",{});var M=i(c);f=s(M,"Module"),M.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){y(d,c,f),_=!0},p:S,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){E(d,c)}}}function Of(F){let d,_,c,f,b;return{c(){d=a("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(u,"CODE",{});var M=i(c);f=s(M,"Module"),M.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){y(d,c,f),_=!0},p:S,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){E(d,c)}}}function Rf(F){let d,_,c,f,b;return{c(){d=a("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(u,"CODE",{});var M=i(c);f=s(M,"Module"),M.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_tokens_classes
`}}),{c(){d=a("p"),_=n("Example:"),c=m(),v(f.$$.fragment)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(o),c=p(l),T(f.$$.fragment,l)},m(l,u){k(l,d,u),e(d,_),k(l,c,u),y(f,l,u),b=!0},p:S,i(l){b||(w(f.$$.fragment,l),b=!0)},o(l){$(f.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(c),E(f,l)}}}function Hf(F){let d,_;return d=new L({props:{code:`labels = predicted_token_class_ids
loss = tf.math.reduce_mean(model(**inputs, labels=labels).loss)
round(float(loss), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = tf.math.reduce_mean(model(**inputs, labels=labels).loss)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){y(d,c,f),_=!0},p:S,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){E(d,c)}}}function Kf(F){let d,_,c,f,b,l,u,M,Zr,ja,$e,Je,is,It,Gr,ls,Jr,Pa,Ye,Yr,Ut,Qr,Xr,Sa,Qe,ei,Rt,ti,oi,La,gn,ni,Da,_n,ds,si,Na,kn,ai,Aa,bn,cs,ri,Oa,vn,ii,Ia,Tn,ms,li,Ua,te,di,Wt,ci,mi,Ht,pi,hi,Kt,fi,ui,Ra,re,gi,Bt,_i,ki,Vt,bi,vi,Wa,ie,Ti,Zt,yi,wi,ps,$i,Ei,Ha,Ee,Xe,hs,Gt,Fi,fs,Mi,Ka,D,Jt,zi,Fe,qi,us,xi,Ci,Yt,ji,Pi,Si,Me,Li,yn,Di,Ni,wn,Ai,Oi,Ii,et,Ui,tt,Qt,Ri,Xt,Wi,$n,Hi,Ki,Ba,ze,ot,gs,eo,Bi,_s,Vi,Va,C,to,Zi,ks,Gi,Ji,En,oo,Yi,nt,no,Qi,qe,Xi,bs,el,tl,vs,ol,nl,sl,le,so,al,Fn,rl,Mn,il,ll,Ts,dl,cl,zn,ao,Za,xe,st,ys,ro,ml,ws,pl,Ga,q,io,hl,$s,fl,ul,lo,gl,qn,_l,kl,bl,co,vl,mo,Tl,yl,wl,po,$l,ho,El,Fl,Ml,j,zl,Es,ql,xl,Fs,Cl,jl,Ms,Pl,Sl,zs,Ll,Dl,qs,Nl,Al,xs,Ol,Il,Ul,oe,fo,Rl,Ce,Wl,xn,Hl,Kl,Cs,Bl,Vl,Zl,at,Gl,rt,Ja,je,it,js,uo,Jl,Ps,Yl,Ya,N,go,Ql,_o,Xl,Ss,ed,td,od,ko,nd,Cn,sd,ad,rd,bo,id,vo,ld,dd,cd,K,To,md,Pe,pd,jn,hd,fd,Ls,ud,gd,_d,lt,kd,dt,bd,ct,Qa,Se,mt,Ds,yo,vd,Ns,Td,Xa,A,wo,yd,As,wd,$d,$o,Ed,Pn,Fd,Md,zd,Eo,qd,Fo,xd,Cd,jd,x,Mo,Pd,Le,Sd,Sn,Ld,Dd,Os,Nd,Ad,Od,pt,Id,ht,Ud,ft,Rd,ut,Wd,gt,er,De,_t,Is,zo,Hd,Us,Kd,tr,O,qo,Bd,Rs,Vd,Zd,xo,Gd,Ln,Jd,Yd,Qd,Co,Xd,jo,ec,tc,oc,B,Po,nc,Ne,sc,Dn,ac,rc,Ws,ic,lc,dc,kt,cc,bt,mc,vt,or,Ae,Tt,Hs,So,pc,Ks,hc,nr,I,Lo,fc,Bs,uc,gc,Do,_c,Nn,kc,bc,vc,No,Tc,Ao,yc,wc,$c,V,Oo,Ec,Oe,Fc,An,Mc,zc,Vs,qc,xc,Cc,yt,jc,Zs,Pc,Sc,Gs,Lc,sr,Ie,wt,Js,Io,Dc,Ys,Nc,ar,U,Uo,Ac,Qs,Oc,Ic,Ro,Uc,On,Rc,Wc,Hc,Wo,Kc,Ho,Bc,Vc,Zc,ne,Ko,Gc,Ue,Jc,In,Yc,Qc,Xs,Xc,em,tm,$t,om,Et,rr,Re,Ft,ea,Bo,nm,ta,sm,ir,R,Vo,am,Zo,rm,oa,im,lm,dm,Go,cm,Un,mm,pm,hm,Jo,fm,Yo,um,gm,_m,Z,Qo,km,We,bm,Rn,vm,Tm,na,ym,wm,$m,Mt,Em,zt,Fm,qt,lr,He,xt,sa,Xo,Mm,aa,zm,dr,W,en,qm,ra,xm,Cm,tn,jm,Wn,Pm,Sm,Lm,on,Dm,nn,Nm,Am,Om,G,sn,Im,Ke,Um,Hn,Rm,Wm,ia,Hm,Km,Bm,Ct,Vm,jt,Zm,Pt,cr,Be,St,la,an,Gm,da,Jm,mr,H,rn,Ym,ca,Qm,Xm,ln,ep,Kn,tp,op,np,dn,sp,cn,ap,rp,ip,J,mn,lp,Ve,dp,Bn,cp,mp,ma,pp,hp,fp,Lt,up,Dt,gp,Nt,pr;return l=new ee({}),It=new ee({}),Gt=new ee({}),Jt=new z({props:{name:"class transformers.EsmConfig",anchor:"transformers.EsmConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"mask_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 1026"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"emb_layer_norm_before",val:" = None"},{name:"token_dropout",val:" = False"},{name:"is_folding_model",val:" = False"},{name:"esmfold_config",val:" = None"},{name:"vocab_list",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EsmConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/tokenization_esm.py#L100",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_esm.py#L769",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/esm#transformers.EsmConfig"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_esm.py#L922",returnDescription:`
<p>A <a
...
`}}),lt=new Ge({props:{$$slots:{default:[yf]},$$scope:{ctx:F}}}),dt=new P({props:{anchor:"transformers.EsmForMaskedLM.forward.example",$$slots:{default:[wf]},$$scope:{ctx:F}}}),ct=new P({props:{anchor:"transformers.EsmForMaskedLM.forward.example-2",$$slots:{default:[$f]},$$scope:{ctx:F}}}),yo=new ee({}),wo=new z({props:{name:"class transformers.EsmForSequenceClassification",anchor:"transformers.EsmForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.EsmForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.24.0/en/model_doc/esm#transformers.EsmConfig">EsmConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_esm.py#L1014"}}),Mo=new z({props:{name:"forward",anchor:"transformers.EsmForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.EsmForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.24.0/en/model_doc/esm#transformers.EsmTokenizer">EsmTokenizer</a>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_esm.py#L1027",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_esm.py#L1123",returnDescription:`
<p>A <a
...
used.`,name:"num_recycles"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_esmfold.py#L2080",returnDescription:`
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_tf_esm.py#L920",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_tf_esm.py#L1041",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_tf_esm.py#L1184",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/esm/modeling_tf_esm.py#L1280",returnDescription:`
<p>A <a
...
proteins in practical timescales.`),Oa=m(),vn=a("p"),ii=n("Tips:"),Ia=m(),Tn=a("ul"),ms=a("li"),li=n("ESM models are trained with a masked language modeling (MLM) objective."),Ua=m(),te=a("p"),di=n("The original code can be found "),Wt=a("a"),ci=n("here"),mi=n(` and was
...
`),Vt=a("a"),bi=n("Sylvain"),vi=n(`, with a big thank you to Nikita Smetanin, Roshan Rao and Tom Sercu for their
help throughout the process!`),Wa=m(),ie=a("p"),Ti=n("The HuggingFace port of ESMFold uses portions of the "),Zt=a("a"),yi=n("openfold"),wi=n(` library.
The `),ps=a("code"),$i=n("openfold"),Ei=n(" library is licensed under the Apache License 2.0."),Ha=m(),Ee=a("h2"),Xe=a("a"),hs=a("span"),v(Gt.$$.fragment),Fi=m(),fs=a("span"),Mi=n("EsmConfig"),Ka=m(),D=a("div"),v(Jt.$$.fragment),zi=m(),Fe=a("p"),qi=n("This is the configuration class to store the configuration of a "),us=a("code"),xi=n("ESMModel"),Ci=n(`. It is used to instantiate a ESM model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ESM
`),Yt=a("a"),ji=n("facebook/esm-1b"),Pi=n(" architecture."),Si=m(),Me=a("p"),Li=n("Configuration objects inherit from "),yn=a("a"),Di=n("PretrainedConfig"),Ni=n(` and can be used to control the model outputs. Read the
documentation from `),wn=a("a"),Ai=n("PretrainedConfig"),Oi=n(" for more information."),Ii=m(),v(et.$$.fragment),Ui=m(),tt=a("div"),v(Qt.$$.fragment),Ri=m(),Xt=a("p"),Wi=n("Serializes this instance to a Python dictionary. Override the default "),$n=a("a"),Hi=n("to_dict()"),Ki=n("."),Ba=m(),ze=a("h2"),ot=a("a"),gs=a("span"),v(eo.$$.fragment),Bi=m(),_s=a("span"),Vi=n("EsmTokenizer"),Va=m(),C=a("div"),v(to.$$.fragment),Zi=m(),ks=a("p"),Gi=n("Constructs an ESM tokenizer."),Ji=m(),En=a("div"),v(oo.$$.fragment),Yi=m(),nt=a("div"),v(no.$$.fragment),Qi=m(),qe=a("p"),Xi=n(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),bs=a("code"),el=n("prepare_for_model"),tl=n(" or "),vs=a("code"),ol=n("encode_plus"),nl=n(" methods."),sl=m(),le=a("div"),v(so.$$.fragment),al=m(),Fn=a("p"),rl=n("Create the token type IDs corresponding to the sequences passed. "),Mn=a("a"),il=n(`What are token type
IDs?`),ll=m(),Ts=a("p"),dl=n("Should be overridden in a subclass if the model has a special way of building those."),cl=m(),zn=a("div"),v(ao.$$.fragment),Za=m(),xe=a("h2"),st=a("a"),ys=a("span"),v(ro.$$.fragment),ml=m(),ws=a("span"),pl=n("EsmModel"),Ga=m(),q=a("div"),v(io.$$.fragment),hl=m(),$s=a("p"),fl=n("The bare ESM Model transformer outputting raw hidden-states without any specific head on top."),ul=m(),lo=a("p"),gl=n("This model inherits from "),qn=a("a"),_l=n("PreTrainedModel"),kl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bl=m(),co=a("p"),vl=n("This model is also a PyTorch "),mo=a("a"),Tl=n("torch.nn.Module"),yl=n(` subclass.
...
`),zs=a("code"),Ll=n("add_cross_attention"),Dl=n(" set to "),qs=a("code"),Nl=n("True"),Al=n("; an "),xs=a("code"),Ol=n("encoder_hidden_states"),Il=n(" is then expected as an input to the forward pass."),Ul=m(),oe=a("div"),v(fo.$$.fragment),Rl=m(),Ce=a("p"),Wl=n("The "),xn=a("a"),Hl=n("EsmModel"),Kl=n(" forward method, overrides the "),Cs=a("code"),Bl=n("__call__"),Vl=n(" special method."),Zl=m(),v(at.$$.fragment),Gl=m(),v(rt.$$.fragment),Ja=m(),je=a("h2"),it=a("a"),js=a("span"),v(uo.$$.fragment),Jl=m(),Ps=a("span"),Yl=n("EsmForMaskedLM"),Ya=m(),N=a("div"),v(go.$$.fragment),Ql=m(),_o=a("p"),Xl=n("ESM Model with a "),Ss=a("code"),ed=n("language modeling"),td=n(" head on top."),od=m(),ko=a("p"),nd=n("This model inherits from "),Cn=a("a"),sd=n("PreTrainedModel"),ad=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rd=m(),bo=a("p"),id=n("This model is also a PyTorch "),vo=a("a"),ld=n("torch.nn.Module"),dd=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cd=m(),K=a("div"),v(To.$$.fragment),md=m(),Pe=a("p"),pd=n("The "),jn=a("a"),hd=n("EsmForMaskedLM"),fd=n(" forward method, overrides the "),Ls=a("code"),ud=n("__call__"),gd=n(" special method."),_d=m(),v(lt.$$.fragment),kd=m(),v(dt.$$.fragment),bd=m(),v(ct.$$.fragment),Qa=m(),Se=a("h2"),mt=a("a"),Ds=a("span"),v(yo.$$.fragment),vd=m(),Ns=a("span"),Td=n("EsmForSequenceClassification"),Xa=m(),A=a("div"),v(wo.$$.fragment),yd=m(),As=a("p"),wd=n(`ESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jd=m(),x=a("div"),v(Mo.$$.fragment),Pd=m(),Le=a("p"),Sd=n("The "),Sn=a("a"),Ld=n("EsmForSequenceClassification"),Dd=n(" forward method, overrides the "),Os=a("code"),Nd=n("__call__"),Ad=n(" special method."),Od=m(),v(pt.$$.fragment),Id=m(),v(ht.$$.fragment),Ud=m(),v(ft.$$.fragment),Rd=m(),v(ut.$$.fragment),Wd=m(),v(gt.$$.fragment),er=m(),De=a("h2"),_t=a("a"),Is=a("span"),v(zo.$$.fragment),Hd=m(),Us=a("span"),Kd=n("EsmForTokenClassification"),tr=m(),O=a("div"),v(qo.$$.fragment),Bd=m(),Rs=a("p"),Vd=n(`ESM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oc=m(),B=a("div"),v(Po.$$.fragment),nc=m(),Ne=a("p"),sc=n("The "),Dn=a("a"),ac=n("EsmForTokenClassification"),rc=n(" forward method, overrides the "),Ws=a("code"),ic=n("__call__"),lc=n(" special method."),dc=m(),v(kt.$$.fragment),cc=m(),v(bt.$$.fragment),mc=m(),v(vt.$$.fragment),or=m(),Ae=a("h2"),Tt=a("a"),Hs=a("span"),v(So.$$.fragment),pc=m(),Ks=a("span"),hc=n("EsmForProteinFolding"),nr=m(),I=a("div"),v(Lo.$$.fragment),fc=m(),Bs=a("p"),uc=n(`ESMForProteinFolding is the HuggingFace port of the original ESMFold model. It consists of an ESM-2 \u201Cstem\u201D followed
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vc=m(),No=a("p"),Tc=n("This model is also a PyTorch "),Ao=a("a"),yc=n("torch.nn.Module"),wc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$c=m(),V=a("div"),v(Oo.$$.fragment),Ec=m(),Oe=a("p"),Fc=n("The "),An=a("a"),Mc=n("EsmForProteinFolding"),zc=n(" forward method, overrides the "),Vs=a("code"),qc=n("__call__"),xc=n(" special method."),Cc=m(),v(yt.$$.fragment),jc=m(),Zs=a("p"),Pc=n("Example:"),Sc=m(),Gs=a("p"),Lc=n("TODO Matt"),sr=m(),Ie=a("h2"),wt=a("a"),Js=a("span"),v(Io.$$.fragment),Dc=m(),Ys=a("span"),Nc=n("TFEsmModel"),ar=m(),U=a("div"),v(Uo.$$.fragment),Ac=m(),Qs=a("p"),Oc=n("The bare ESM Model transformer outputting raw hidden-states without any specific head on top."),Ic=m(),Ro=a("p"),Uc=n("This model inherits from "),On=a("a"),Rc=n("TFPreTrainedModel"),Wc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hc=m(),Wo=a("p"),Kc=n("This model is also a Keras "),Ho=a("a"),Bc=n("Model"),Vc=n(` subclass. Use it as a
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),Zc=m(),ne=a("div"),v(Ko.$$.fragment),Gc=m(),Ue=a("p"),Jc=n("The "),In=a("a"),Yc=n("TFEsmModel"),Qc=n(" forward method, overrides the "),Xs=a("code"),Xc=n("__call__"),em=n(" special method."),tm=m(),v($t.$$.fragment),om=m(),v(Et.$$.fragment),rr=m(),Re=a("h2"),Ft=a("a"),ea=a("span"),v(Bo.$$.fragment),nm=m(),ta=a("span"),sm=n("TFEsmForMaskedLM"),ir=m(),R=a("div"),v(Vo.$$.fragment),am=m(),Zo=a("p"),rm=n("ESM Model with a "),oa=a("code"),im=n("language modeling"),lm=n(" head on top."),dm=m(),Go=a("p"),cm=n("This model inherits from "),Un=a("a"),mm=n("TFPreTrainedModel"),pm=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hm=m(),Jo=a("p"),fm=n("This model is also a Keras "),Yo=a("a"),um=n("Model"),gm=n(` subclass. Use it as a
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),_m=m(),Z=a("div"),v(Qo.$$.fragment),km=m(),We=a("p"),bm=n("The "),Rn=a("a"),vm=n("TFEsmForMaskedLM"),Tm=n(" forward method, overrides the "),na=a("code"),ym=n("__call__"),wm=n(" special method."),$m=m(),v(Mt.$$.fragment),Em=m(),v(zt.$$.fragment),Fm=m(),v(qt.$$.fragment),lr=m(),He=a("h2"),xt=a("a"),sa=a("span"),v(Xo.$$.fragment),Mm=m(),aa=a("span"),zm=n("TFEsmForSequenceClassification"),dr=m(),W=a("div"),v(en.$$.fragment),qm=m(),ra=a("p"),xm=n(`ESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),Om=m(),G=a("div"),v(sn.$$.fragment),Im=m(),Ke=a("p"),Um=n("The "),Hn=a("a"),Rm=n("TFEsmForSequenceClassification"),Wm=n(" forward method, overrides the "),ia=a("code"),Hm=n("__call__"),Km=n(" special method."),Bm=m(),v(Ct.$$.fragment),Vm=m(),v(jt.$$.fragment),Zm=m(),v(Pt.$$.fragment),cr=m(),Be=a("h2"),St=a("a"),la=a("span"),v(an.$$.fragment),Gm=m(),da=a("span"),Jm=n("TFEsmForTokenClassification"),mr=m(),H=a("div"),v(rn.$$.fragment),Ym=m(),ca=a("p"),Qm=n(`ESM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),ip=m(),J=a("div"),v(mn.$$.fragment),lp=m(),Ve=a("p"),dp=n("The "),Bn=a("a"),cp=n("TFEsmForTokenClassification"),mp=n(" forward method, overrides the "),ma=a("code"),pp=n("__call__"),hp=n(" special method."),fp=m(),v(Lt.$$.fragment),up=m(),v(Dt.$$.fragment),gp=m(),v(Nt.$$.fragment),this.h()},l(t){const g=_f('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(o),_=p(t),c=r(t,"H1",{class:!0});var pn=i(c);f=r(pn,"A",{id:!0,class:!0,href:!0});var pa=i(f);b=r(pa,"SPAN",{});var ha=i(b);T(l.$$.fragment,ha),ha.forEach(o),pa.forEach(o),u=p(pn),M=r(pn,"SPAN",{});var fa=i(M);Zr=s(fa,"ESM"),fa.forEach(o),pn.forEach(o),ja=p(t),$e=r(t,"H2",{class:!0});var hn=i($e);Je=r(hn,"A",{id:!0,class:!0,href:!0});var ua=i(Je);is=r(ua,"SPAN",{});var ga=i(is);T(It.$$.fragment,ga),ga.forEach(o),ua.forEach(o),Gr=p(hn),ls=r(hn,"SPAN",{});var _a=i(ls);Jr=s(_a,"Overview"),_a.forEach(o),hn.forEach(o),Pa=s(t,`
...
sequence alignment (MSA) step at inference time, which means that ESMFold checkpoints are fully \u201Cstandalone\u201D -
they do not require a database of known protein sequences and structures with associated external query tools
to make predictions, and are much faster as a result.`),un.forEach(o),La=p(t),gn=r(t,"P",{});var va=i(gn);ni=s(va,`The abstract from
\u201CBiological structure and function emerge from scaling unsupervised learning to 250
million protein sequences\u201D is`),va.forEach(o),Da=p(t),_n=r(t,"P",{});var Ta=i(_n);ds=r(Ta,"EM",{});var ya=i(ds);si=s(ya,`In the field of artificial intelligence, a combination of scale in data and model capacity enabled by unsupervised
learning has led to major advances in representation learning and statistical generation. In the life sciences, the
anticipated growth of sequencing promises unprecedented data on natural sequence diversity. Protein language modeling
at the scale of evolution is a logical step toward predictive and generative artificial intelligence for biology. To
this end, we use unsupervised learning to train a deep contextual language model on 86 billion amino acids across 250
...
can be identified by linear projections. Representation learning produces features that generalize across a range of
applications, enabling state-of-the-art supervised prediction of mutational effect and secondary structure and
improving state-of-the-art features for long-range contact prediction.`),ya.forEach(o),Ta.forEach(o),Na=p(t),kn=r(t,"P",{});var wa=i(kn);ai=s(wa,`The abstract from
...
sequences with low perplexity that are well understood by the language model. ESMFold inference is an
order of magnitude faster than AlphaFold2, enabling exploration of the structural space of metagenomic
proteins in practical timescales.`),Ea.forEach(o),$a.forEach(o),Oa=p(t),vn=r(t,"P",{});var Fa=i(vn);ii=s(Fa,"Tips:"),Fa.forEach(o),Ia=p(t),Tn=r(t,"UL",{});var Ma=i(Tn);ms=r(Ma,"LI",{});var za=i(ms);li=s(za,"ESM models are trained with a masked language modeling (MLM) objective."),za.forEach(o),Ma.forEach(o),Ua=p(t),te=r(t,"P",{});var ae=i(te);di=s(ae,"The original code can be found "),Wt=r(ae,"A",{href:!0,rel:!0});var qa=i(Wt);ci=s(qa,"here"),qa.forEach(o),mi=s(ae,` and was
was developed by the Fundamental AI Research team at Meta AI.
...
`),Vt=r(Ze,"A",{href:!0,rel:!0});var bp=i(Vt);bi=s(bp,"Sylvain"),bp.forEach(o),vi=s(Ze,`, with a big thank you to Nikita Smetanin, Roshan Rao and Tom Sercu for their
help throughout the process!`),Ze.forEach(o),Wa=p(t),ie=r(t,"P",{});var Vn=i(ie);Ti=s(Vn,"The HuggingFace port of ESMFold uses portions of the "),Zt=r(Vn,"A",{href:!0,rel:!0});var vp=i(Zt);yi=s(vp,"openfold"),vp.forEach(o),wi=s(Vn,` library.
The `),ps=r(Vn,"CODE",{});var Tp=i(ps);$i=s(Tp,"openfold"),Tp.forEach(o),Ei=s(Vn," library is licensed under the Apache License 2.0."),Vn.forEach(o),Ha=p(t),Ee=r(t,"H2",{class:!0});var hr=i(Ee);Xe=r(hr,"A",{id:!0,class:!0,href:!0});var yp=i(Xe);hs=r(yp,"SPAN",{});var wp=i(hs);T(Gt.$$.fragment,wp),wp.forEach(o),yp.forEach(o),Fi=p(hr),fs=r(hr,"SPAN",{});var $p=i(fs);Mi=s($p,"EsmConfig"),$p.forEach(o),hr.forEach(o),Ka=p(t),D=r(t,"DIV",{class:!0});var de=i(D);T(Jt.$$.fragment,de),zi=p(de),Fe=r(de,"P",{});var Zn=i(Fe);qi=s(Zn,"This is the configuration class to store the configuration of a "),us=r(Zn,"CODE",{});var Ep=i(us);xi=s(Ep,"ESMModel"),Ep.forEach(o),Ci=s(Zn,`. It is used to instantiate a ESM model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ESM
`),Yt=r(Zn,"A",{href:!0,rel:!0});var Fp=i(Yt);ji=s(Fp,"facebook/esm-1b"),Fp.forEach(o),Pi=s(Zn," architecture."),Zn.forEach(o),Si=p(de),Me=r(de,"P",{});var Gn=i(Me);Li=s(Gn,"Configuration objects inherit from "),yn=r(Gn,"A",{href:!0});var Mp=i(yn);Di=s(Mp,"PretrainedConfig"),Mp.forEach(o),Ni=s(Gn,` and can be used to control the model outputs. Read the
documentation from `),wn=r(Gn,"A",{href:!0});var zp=i(wn);Ai=s(zp,"PretrainedConfig"),zp.forEach(o),Oi=s(Gn," for more information."),Gn.forEach(o),Ii=p(de),T(et.$$.fragment,de),Ui=p(de),tt=r(de,"DIV",{class:!0});var fr=i(tt);T(Qt.$$.fragment,fr),Ri=p(fr),Xt=r(fr,"P",{});var ur=i(Xt);Wi=s(ur,"Serializes this instance to a Python dictionary. Override the default "),$n=r(ur,"A",{href:!0});var qp=i($n);Hi=s(qp,"to_dict()"),qp.forEach(o),Ki=s(ur,"."),ur.forEach(o),fr.forEach(o),de.forEach(o),Ba=p(t),ze=r(t,"H2",{class:!0});var gr=i(ze);ot=r(gr,"A",{id:!0,class:!0,href:!0});var xp=i(ot);gs=r(xp,"SPAN",{});var Cp=i(gs);T(eo.$$.fragment,Cp),Cp.forEach(o),xp.forEach(o),Bi=p(gr),_s=r(gr,"SPAN",{});var jp=i(_s);Vi=s(jp,"EsmTokenizer"),jp.forEach(o),gr.forEach(o),Va=p(t),C=r(t,"DIV",{class:!0});var se=i(C);T(to.$$.fragment,se),Zi=p(se),ks=r(se,"P",{});var Pp=i(ks);Gi=s(Pp,"Constructs an ESM tokenizer."),Pp.forEach(o),Ji=p(se),En=r(se,"DIV",{class:!0});var Sp=i(En);T(oo.$$.fragment,Sp),Sp.forEach(o),Yi=p(se),nt=r(se,"DIV",{class:!0});var _r=i(nt);T(no.$$.fragment,_r),Qi=p(_r),qe=r(_r,"P",{});var Jn=i(qe);Xi=s(Jn,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),bs=r(Jn,"CODE",{});var Lp=i(bs);el=s(Lp,"prepare_for_model"),Lp.forEach(o),tl=s(Jn," or "),vs=r(Jn,"CODE",{});var Dp=i(vs);ol=s(Dp,"encode_plus"),Dp.forEach(o),nl=s(Jn," methods."),Jn.forEach(o),_r.forEach(o),sl=p(se),le=r(se,"DIV",{class:!0});var Yn=i(le);T(so.$$.fragment,Yn),al=p(Yn),Fn=r(Yn,"P",{});var _p=i(Fn);rl=s(_p,"Create the token type IDs corresponding to the sequences passed. "),Mn=r(_p,"A",{href:!0});var Np=i(Mn);il=s(Np,`What are token type
IDs?`),Np.forEach(o),_p.forEach(o),ll=p(Yn),Ts=r(Yn,"P",{});var Ap=i(Ts);dl=s(Ap,"Should be overridden in a subclass if the model has a special way of building those."),Ap.forEach(o),Yn.forEach(o),cl=p(se),zn=r(se,"DIV",{class:!0});var Op=i(zn);T(ao.$$.fragment,Op),Op.forEach(o),se.forEach(o),Za=p(t),xe=r(t,"H2",{class:!0});var kr=i(xe);st=r(kr,"A",{id:!0,class:!0,href:!0});var Ip=i(st);ys=r(Ip,"SPAN",{});var Up=i(ys);T(ro.$$.fragment,Up),Up.forEach(o),Ip.forEach(o),ml=p(kr),ws=r(kr,"SPAN",{});var Rp=i(ws);pl=s(Rp,"EsmModel"),Rp.forEach(o),kr.forEach(o),Ga=p(t),q=r(t,"DIV",{class:!0});var Y=i(q);T(io.$$.fragment,Y),hl=p(Y),$s=r(Y,"P",{});var Wp=i($s);fl=s(Wp,"The bare ESM Model transformer outputting raw hidden-states without any specific head on top."),Wp.forEach(o),ul=p(Y),lo=r(Y,"P",{});var br=i(lo);gl=s(br,"This model inherits from "),qn=r(br,"A",{href:!0});var Hp=i(qn);_l=s(Hp,"PreTrainedModel"),Hp.forEach(o),kl=s(br,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),br.forEach(o),bl=p(Y),co=r(Y,"P",{});var vr=i(co);vl=s(vr,"This model is also a PyTorch "),mo=r(vr,"A",{href:!0,rel:!0});var Kp=i(mo);Tl=s(Kp,"torch.nn.Module"),Kp.forEach(o),yl=s(vr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vr.forEach(o),wl=p(Y),po=r(Y,"P",{});var Tr=i(po);$l=s(Tr,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
cross-attention is added between the self-attention layers, following the architecture described in `),ho=r(Tr,"A",{href:!0,rel:!0});var Bp=i(ho);El=s(Bp,`Attention is
all you need`),Bp.forEach(o),Fl=s(Tr,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Tr.forEach(o),Ml=p(Y),j=r(Y,"P",{});var Q=i(j);zl=s(Q,"To behave as an decoder the model needs to be initialized with the "),Es=r(Q,"CODE",{});var Vp=i(Es);ql=s(Vp,"is_decoder"),Vp.forEach(o),xl=s(Q,` argument of the configuration set
...
`),zs=r(Q,"CODE",{});var Jp=i(zs);Ll=s(Jp,"add_cross_attention"),Jp.forEach(o),Dl=s(Q," set to "),qs=r(Q,"CODE",{});var Yp=i(qs);Nl=s(Yp,"True"),Yp.forEach(o),Al=s(Q,"; an "),xs=r(Q,"CODE",{});var Qp=i(xs);Ol=s(Qp,"encoder_hidden_states"),Qp.forEach(o),Il=s(Q," is then expected as an input to the forward pass."),Q.forEach(o),Ul=p(Y),oe=r(Y,"DIV",{class:!0});var At=i(oe);T(fo.$$.fragment,At),Rl=p(At),Ce=r(At,"P",{});var Qn=i(Ce);Wl=s(Qn,"The "),xn=r(Qn,"A",{href:!0});var Xp=i(xn);Hl=s(Xp,"EsmModel"),Xp.forEach(o),Kl=s(Qn," forward method, overrides the "),Cs=r(Qn,"CODE",{});var eh=i(Cs);Bl=s(eh,"__call__"),eh.forEach(o),Vl=s(Qn," special method."),Qn.forEach(o),Zl=p(At),T(at.$$.fragment,At),Gl=p(At),T(rt.$$.fragment,At),At.forEach(o),Y.forEach(o),Ja=p(t),je=r(t,"H2",{class:!0});var yr=i(je);it=r(yr,"A",{id:!0,class:!0,href:!0});var th=i(it);js=r(th,"SPAN",{});var oh=i(js);T(uo.$$.fragment,oh),oh.forEach(o),th.forEach(o),Jl=p(yr),Ps=r(yr,"SPAN",{});var nh=i(Ps);Yl=s(nh,"EsmForMaskedLM"),nh.forEach(o),yr.forEach(o),Ya=p(t),N=r(t,"DIV",{class:!0});var ce=i(N);T(go.$$.fragment,ce),Ql=p(ce),_o=r(ce,"P",{});var wr=i(_o);Xl=s(wr,"ESM Model with a "),Ss=r(wr,"CODE",{});var sh=i(Ss);ed=s(sh,"language modeling"),sh.forEach(o),td=s(wr," head on top."),wr.forEach(o),od=p(ce),ko=r(ce,"P",{});var $r=i(ko);nd=s($r,"This model inherits from "),Cn=r($r,"A",{href:!0});var ah=i(Cn);sd=s(ah,"PreTrainedModel"),ah.forEach(o),ad=s($r,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$r.forEach(o),rd=p(ce),bo=r(ce,"P",{});var Er=i(bo);id=s(Er,"This model is also a PyTorch "),vo=r(Er,"A",{href:!0,rel:!0});var rh=i(vo);ld=s(rh,"torch.nn.Module"),rh.forEach(o),dd=s(Er,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Er.forEach(o),cd=p(ce),K=r(ce,"DIV",{class:!0});var me=i(K);T(To.$$.fragment,me),md=p(me),Pe=r(me,"P",{});var Xn=i(Pe);pd=s(Xn,"The "),jn=r(Xn,"A",{href:!0});var ih=i(jn);hd=s(ih,"EsmForMaskedLM"),ih.forEach(o),fd=s(Xn," forward method, overrides the "),Ls=r(Xn,"CODE",{});var lh=i(Ls);ud=s(lh,"__call__"),lh.forEach(o),gd=s(Xn," special method."),Xn.forEach(o),_d=p(me),T(lt.$$.fragment,me),kd=p(me),T(dt.$$.fragment,me),bd=p(me),T(ct.$$.fragment,me),me.forEach(o),ce.forEach(o),Qa=p(t),Se=r(t,"H2",{class:!0});var Fr=i(Se);mt=r(Fr,"A",{id:!0,class:!0,href:!0});var dh=i(mt);Ds=r(dh,"SPAN",{});var ch=i(Ds);T(yo.$$.fragment,ch),ch.forEach(o),dh.forEach(o),vd=p(Fr),Ns=r(Fr,"SPAN",{});var mh=i(Ns);Td=s(mh,"EsmForSequenceClassification"),mh.forEach(o),Fr.forEach(o),Xa=p(t),A=r(t,"DIV",{class:!0});var pe=i(A);T(wo.$$.fragment,pe),yd=p(pe),As=r(pe,"P",{});var ph=i(As);wd=s(ph,`ESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr.forEach(o),jd=p(pe),x=r(pe,"DIV",{class:!0});var X=i(x);T(Mo.$$.fragment,X),Pd=p(X),Le=r(X,"P",{});var es=i(Le);Sd=s(es,"The "),Sn=r(es,"A",{href:!0});var uh=i(Sn);Ld=s(uh,"EsmForSequenceClassification"),uh.forEach(o),Dd=s(es," forward method, overrides the "),Os=r(es,"CODE",{});var gh=i(Os);Nd=s(gh,"__call__"),gh.forEach(o),Ad=s(es," special method."),es.forEach(o),Od=p(X),T(pt.$$.fragment,X),Id=p(X),T(ht.$$.fragment,X),Ud=p(X),T(ft.$$.fragment,X),Rd=p(X),T(ut.$$.fragment,X),Wd=p(X),T(gt.$$.fragment,X),X.forEach(o),pe.forEach(o),er=p(t),De=r(t,"H2",{class:!0});var qr=i(De);_t=r(qr,"A",{id:!0,class:!0,href:!0});var _h=i(_t);Is=r(_h,"SPAN",{});var kh=i(Is);T(zo.$$.fragment,kh),kh.forEach(o),_h.forEach(o),Hd=p(qr),Us=r(qr,"SPAN",{});var bh=i(Us);Kd=s(bh,"EsmForTokenClassification"),bh.forEach(o),qr.forEach(o),tr=p(t),O=r(t,"DIV",{class:!0});var he=i(O);T(qo.$$.fragment,he),Bd=p(he),Rs=r(he,"P",{});var vh=i(Rs);Vd=s(vh,`ESM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),vh.forEach(o),Zd=p(he),xo=r(he,"P",{});var xr=i(xo);Gd=s(xr,"This model inherits from "),Ln=r(xr,"A",{href:!0});var Th=i(Ln);Jd=s(Th,"PreTrainedModel"),Th.forEach(o),Yd=s(xr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xr.forEach(o),Qd=p(he),Co=r(he,"P",{});var Cr=i(Co);Xd=s(Cr,"This model is also a PyTorch "),jo=r(Cr,"A",{href:!0,rel:!0});var yh=i(jo);ec=s(yh,"torch.nn.Module"),yh.forEach(o),tc=s(Cr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cr.forEach(o),oc=p(he),B=r(he,"DIV",{class:!0});var fe=i(B);T(Po.$$.fragment,fe),nc=p(fe),Ne=r(fe,"P",{});var ts=i(Ne);sc=s(ts,"The "),Dn=r(ts,"A",{href:!0});var wh=i(Dn);ac=s(wh,"EsmForTokenClassification"),wh.forEach(o),rc=s(ts," forward method, overrides the "),Ws=r(ts,"CODE",{});var $h=i(Ws);ic=s($h,"__call__"),$h.forEach(o),lc=s(ts," special method."),ts.forEach(o),dc=p(fe),T(kt.$$.fragment,fe),cc=p(fe),T(bt.$$.fragment,fe),mc=p(fe),T(vt.$$.fragment,fe),fe.forEach(o),he.forEach(o),or=p(t),Ae=r(t,"H2",{class:!0});var jr=i(Ae);Tt=r(jr,"A",{id:!0,class:!0,href:!0});var Eh=i(Tt);Hs=r(Eh,"SPAN",{});var Fh=i(Hs);T(So.$$.fragment,Fh),Fh.forEach(o),Eh.forEach(o),pc=p(jr),Ks=r(jr,"SPAN",{});var Mh=i(Ks);hc=s(Mh,"EsmForProteinFolding"),Mh.forEach(o),jr.forEach(o),nr=p(t),I=r(t,"DIV",{class:!0});var ue=i(I);T(Lo.$$.fragment,ue),fc=p(ue),Bs=r(ue,"P",{});var zh=i(Bs);uc=s(zh,`ESMForProteinFolding is the HuggingFace port of the original ESMFold model. It consists of an ESM-2 \u201Cstem\u201D followed
by a protein folding \u201Chead\u201D, although unlike most other output heads, this \u201Chead\u201D is similar in size and runtime to
the rest of the model combined! It outputs a dictionary containing predicted structural information about the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pr.forEach(o),vc=p(ue),No=r(ue,"P",{});var Sr=i(No);Tc=s(Sr,"This model is also a PyTorch "),Ao=r(Sr,"A",{href:!0,rel:!0});var xh=i(Ao);yc=s(xh,"torch.nn.Module"),xh.forEach(o),wc=s(Sr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sr.forEach(o),$c=p(ue),V=r(ue,"DIV",{class:!0});var ge=i(V);T(Oo.$$.fragment,ge),Ec=p(ge),Oe=r(ge,"P",{});var os=i(Oe);Fc=s(os,"The "),An=r(os,"A",{href:!0});var Ch=i(An);Mc=s(Ch,"EsmForProteinFolding"),Ch.forEach(o),zc=s(os," forward method, overrides the "),Vs=r(os,"CODE",{});var jh=i(Vs);qc=s(jh,"__call__"),jh.forEach(o),xc=s(os," special method."),os.forEach(o),Cc=p(ge),T(yt.$$.fragment,ge),jc=p(ge),Zs=r(ge,"P",{});var Ph=i(Zs);Pc=s(Ph,"Example:"),Ph.forEach(o),Sc=p(ge),Gs=r(ge,"P",{});var Sh=i(Gs);Lc=s(Sh,"TODO Matt"),Sh.forEach(o),ge.forEach(o),ue.forEach(o),sr=p(t),Ie=r(t,"H2",{class:!0});var Lr=i(Ie);wt=r(Lr,"A",{id:!0,class:!0,href:!0});var Lh=i(wt);Js=r(Lh,"SPAN",{});var Dh=i(Js);T(Io.$$.fragment,Dh),Dh.forEach(o),Lh.forEach(o),Dc=p(Lr),Ys=r(Lr,"SPAN",{});var Nh=i(Ys);Nc=s(Nh,"TFEsmModel"),Nh.forEach(o),Lr.forEach(o),ar=p(t),U=r(t,"DIV",{class:!0});var _e=i(U);T(Uo.$$.fragment,_e),Ac=p(_e),Qs=r(_e,"P",{});var Ah=i(Qs);Oc=s(Ah,"The bare ESM Model transformer outputting raw hidden-states without any specific head on top."),Ah.forEach(o),Ic=p(_e),Ro=r(_e,"P",{});var Dr=i(Ro);Uc=s(Dr,"This model inherits from "),On=r(Dr,"A",{href:!0});var Oh=i(On);Rc=s(Oh,"TFPreTrainedModel"),Oh.forEach(o),Wc=s(Dr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),Nr.forEach(o),Zc=p(_e),ne=r(_e,"DIV",{class:!0});var Ot=i(ne);T(Ko.$$.fragment,Ot),Gc=p(Ot),Ue=r(Ot,"P",{});var ns=i(Ue);Jc=s(ns,"The "),In=r(ns,"A",{href:!0});var Uh=i(In);Yc=s(Uh,"TFEsmModel"),Uh.forEach(o),Qc=s(ns," forward method, overrides the "),Xs=r(ns,"CODE",{});var Rh=i(Xs);Xc=s(Rh,"__call__"),Rh.forEach(o),em=s(ns," special method."),ns.forEach(o),tm=p(Ot),T($t.$$.fragment,Ot),om=p(Ot),T(Et.$$.fragment,Ot),Ot.forEach(o),_e.forEach(o),rr=p(t),Re=r(t,"H2",{class:!0});var Ar=i(Re);Ft=r(Ar,"A",{id:!0,class:!0,href:!0});var Wh=i(Ft);ea=r(Wh,"SPAN",{});var Hh=i(ea);T(Bo.$$.fragment,Hh),Hh.forEach(o),Wh.forEach(o),nm=p(Ar),ta=r(Ar,"SPAN",{});var Kh=i(ta);sm=s(Kh,"TFEsmForMaskedLM"),Kh.forEach(o),Ar.forEach(o),ir=p(t),R=r(t,"DIV",{class:!0});var ke=i(R);T(Vo.$$.fragment,ke),am=p(ke),Zo=r(ke,"P",{});var Or=i(Zo);rm=s(Or,"ESM Model with a "),oa=r(Or,"CODE",{});var Bh=i(oa);im=s(Bh,"language modeling"),Bh.forEach(o),lm=s(Or," head on top."),Or.forEach(o),dm=p(ke),Go=r(ke,"P",{});var Ir=i(Go);cm=s(Ir,"This model inherits from "),Un=r(Ir,"A",{href:!0});var Vh=i(Un);mm=s(Vh,"TFPreTrainedModel"),Vh.forEach(o),pm=s(Ir,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),Ur.forEach(o),_m=p(ke),Z=r(ke,"DIV",{class:!0});var be=i(Z);T(Qo.$$.fragment,be),km=p(be),We=r(be,"P",{});var ss=i(We);bm=s(ss,"The "),Rn=r(ss,"A",{href:!0});var Gh=i(Rn);vm=s(Gh,"TFEsmForMaskedLM"),Gh.forEach(o),Tm=s(ss," forward method, overrides the "),na=r(ss,"CODE",{});var Jh=i(na);ym=s(Jh,"__call__"),Jh.forEach(o),wm=s(ss," special method."),ss.forEach(o),$m=p(be),T(Mt.$$.fragment,be),Em=p(be),T(zt.$$.fragment,be),Fm=p(be),T(qt.$$.fragment,be),be.forEach(o),ke.forEach(o),lr=p(t),He=r(t,"H2",{class:!0});var Rr=i(He);xt=r(Rr,"A",{id:!0,class:!0,href:!0});var Yh=i(xt);sa=r(Yh,"SPAN",{});var Qh=i(sa);T(Xo.$$.fragment,Qh),Qh.forEach(o),Yh.forEach(o),Mm=p(Rr),aa=r(Rr,"SPAN",{});var Xh=i(aa);zm=s(Xh,"TFEsmForSequenceClassification"),Xh.forEach(o),Rr.forEach(o),dr=p(t),W=r(t,"DIV",{class:!0});var ve=i(W);T(en.$$.fragment,ve),qm=p(ve),ra=r(ve,"P",{});var ef=i(ra);xm=s(ef,`ESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),ef.forEach(o),Cm=p(ve),tn=r(ve,"P",{});var Wr=i(tn);jm=s(Wr,"This model inherits from "),Wn=r(Wr,"A",{href:!0});var tf=i(Wn);Pm=s(tf,"TFPreTrainedModel"),tf.forEach(o),Sm=s(Wr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wr.forEach(o),Lm=p(ve),on=r(ve,"P",{});var Hr=i(on);Dm=s(Hr,"This model is also a Keras "),nn=r(Hr,"A",{href:!0,rel:!0});var of=i(nn);Nm=s(of,"Model"),of.forEach(o),Am=s(Hr,` subclass. Use it as a
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),Hr.forEach(o),Om=p(ve),G=r(ve,"DIV",{class:!0});var Te=i(G);T(sn.$$.fragment,Te),Im=p(Te),Ke=r(Te,"P",{});var as=i(Ke);Um=s(as,"The "),Hn=r(as,"A",{href:!0});var nf=i(Hn);Rm=s(nf,"TFEsmForSequenceClassification"),nf.forEach(o),Wm=s(as," forward method, overrides the "),ia=r(as,"CODE",{});var sf=i(ia);Hm=s(sf,"__call__"),sf.forEach(o),Km=s(as," special method."),as.forEach(o),Bm=p(Te),T(Ct.$$.fragment,Te),Vm=p(Te),T(jt.$$.fragment,Te),Zm=p(Te),T(Pt.$$.fragment,Te),Te.forEach(o),ve.forEach(o),cr=p(t),Be=r(t,"H2",{class:!0});var Kr=i(Be);St=r(Kr,"A",{id:!0,class:!0,href:!0});var af=i(St);la=r(af,"SPAN",{});var rf=i(la);T(an.$$.fragment,rf),rf.forEach(o),af.forEach(o),Gm=p(Kr),da=r(Kr,"SPAN",{});var lf=i(da);Jm=s(lf,"TFEsmForTokenClassification"),lf.forEach(o),Kr.forEach(o),mr=p(t),H=r(t,"DIV",{class:!0});var ye=i(H);T(rn.$$.fragment,ye),Ym=p(ye),ca=r(ye,"P",{});var df=i(ca);Qm=s(df,`ESM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),df.forEach(o),Xm=p(ye),ln=r(ye,"P",{});var Br=i(ln);ep=s(Br,"This model inherits from "),Kn=r(Br,"A",{href:!0});var cf=i(Kn);tp=s(cf,"TFPreTrainedModel"),cf.forEach(o),op=s(Br,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Br.forEach(o),np=p(ye),dn=r(ye,"P",{});var Vr=i(dn);sp=s(Vr,"This model is also a Keras "),cn=r(Vr,"A",{href:!0,rel:!0});var mf=i(cn);ap=s(mf,"Model"),mf.forEach(o),rp=s(Vr,` subclass. Use it as a
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),Vr.forEach(o),ip=p(ye),J=r(ye,"DIV",{class:!0});var we=i(J);T(mn.$$.fragment,we),lp=p(we),Ve=r(we,"P",{});var rs=i(Ve);dp=s(rs,"The "),Bn=r(rs,"A",{href:!0});var pf=i(Bn);cp=s(pf,"TFEsmForTokenClassification"),pf.forEach(o),mp=s(rs," forward method, overrides the "),ma=r(rs,"CODE",{});var hf=i(ma);pp=s(hf,"__call__"),hf.forEach(o),hp=s(rs," special method."),rs.forEach(o),fp=p(we),T(Lt.$$.fragment,we),up=p(we),T(Dt.$$.fragment,we),gp=p(we),T(Nt.$$.fragment,we),we.forEach(o),ye.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(Bf)),h(f,"id","esm"),h(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(f,"href","#esm"),h(c,"class","relative group"),h(Je,"id","overview"),h(Je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Je,"href","#overview"),h($e,"class","relative group"),h(Ut,"href","https://doi.org/10.1101/2022.07.20.500902"),h(Ut,"rel","nofollow"),h(Rt,"href","https://www.nature.com/articles/s41586-021-03819-2"),h(Rt,"rel","nofollow"),h(Wt,"href","https://github.com/facebookresearch/esm"),h(Wt,"rel","nofollow"),h(Ht,"href","https://huggingface.co/jasonliu"),h(Ht,"rel","nofollow"),h(Kt,"href","https://huggingface.co/Rocketknight1"),h(Kt,"rel","nofollow"),h(Bt,"href","https://huggingface.co/Rocketknight1"),h(Bt,"rel","nofollow"),h(Vt,"href","https://huggingface.co/sgugger"),h(Vt,"rel","nofollow"),h(Zt,"href","https://github.com/aqlaboratory/openfold"),h(Zt,"rel","nofollow"),h(Xe,"id","transformers.EsmConfig"),h(Xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Xe,"href","#transformers.EsmConfig"),h(Ee,"class","relative group"),h(Yt,"href","https://huggingface.co/facebook/esm-1b"),h(Yt,"rel","nofollow"),h(yn,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(wn,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),h($n,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig.to_dict"),h(tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ot,"id","transformers.EsmTokenizer"),h(ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ot,"href","#transformers.EsmTokenizer"),h(ze,"class","relative group"),h(En,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Mn,"href","../glossary#token-type-ids"),h(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(zn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(st,"id","transformers.EsmModel"),h(st,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(st,"href","#transformers.EsmModel"),h(xe,"class","relative group"),h(qn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),h(mo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(mo,"rel","nofollow"),h(ho,"href","https://arxiv.org/abs/1706.03762"),h(ho,"rel","nofollow"),h(xn,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.EsmModel"),h(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(it,"id","transformers.EsmForMaskedLM"),h(it,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(it,"href","#transformers.EsmForMaskedLM"),h(je,"class","relative group"),h(Cn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),h(vo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(vo,"rel","nofollow"),h(jn,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.EsmForMaskedLM"),h(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(mt,"id","transformers.EsmForSequenceClassification"),h(mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(mt,"href","#transformers.EsmForSequenceClassification"),h(Se,"class","relative group"),h(Pn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),h(Fo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Fo,"rel","nofollow"),h(Sn,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.EsmForSequenceClassification"),h(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(_t,"id","transformers.EsmForTokenClassification"),h(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(_t,"href","#transformers.EsmForTokenClassification"),h(De,"class","relative group"),h(Ln,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),h(jo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(jo,"rel","nofollow"),h(Dn,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.EsmForTokenClassification"),h(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Tt,"id","transformers.EsmForProteinFolding"),h(Tt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Tt,"href","#transformers.EsmForProteinFolding"),h(Ae,"class","relative group"),h(Nn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),h(Ao,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Ao,"rel","nofollow"),h(An,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.EsmForProteinFolding"),h(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(wt,"id","transformers.TFEsmModel"),h(wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(wt,"href","#transformers.TFEsmModel"),h(Ie,"class","relative group"),h(On,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.TFPreTrainedModel"),h(Ho,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Ho,"rel","nofollow"),h(In,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.TFEsmModel"),h(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ft,"id","transformers.TFEsmForMaskedLM"),h(Ft,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ft,"href","#transformers.TFEsmForMaskedLM"),h(Re,"class","relative group"),h(Un,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.TFPreTrainedModel"),h(Yo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Yo,"rel","nofollow"),h(Rn,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.TFEsmForMaskedLM"),h(Z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(xt,"id","transformers.TFEsmForSequenceClassification"),h(xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(xt,"href","#transformers.TFEsmForSequenceClassification"),h(He,"class","relative group"),h(Wn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.TFPreTrainedModel"),h(nn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(nn,"rel","nofollow"),h(Hn,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.TFEsmForSequenceClassification"),h(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(St,"id","transformers.TFEsmForTokenClassification"),h(St,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(St,"href","#transformers.TFEsmForTokenClassification"),h(Be,"class","relative group"),h(Kn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.TFPreTrainedModel"),h(cn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(cn,"rel","nofollow"),h(Bn,"href","/docs/transformers/v4.24.0/en/model_doc/esm#transformers.TFEsmForTokenClassification"),h(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,g){e(document.head,d),k(t,_,g),k(t,c,g),e(c,f),e(f,b),y(l,b,null),e(c,u),e(c,M),e(M,Zr),k(t,ja,g),k(t,$e,g),e($e,Je),e(Je,is),y(It,is,null),e($e,Gr),e($e,ls),e(ls,Jr),k(t,Pa,g),k(t,Ye,g),e(Ye,Yr),e(Ye,Ut),e(Ut,Qr),e(Ye,Xr),k(t,Sa,g),k(t,Qe,g),e(Qe,ei),e(Qe,Rt),e(Rt,ti),e(Qe,oi),k(t,La,g),k(t,gn,g),e(gn,ni),k(t,Da,g),k(t,_n,g),e(_n,ds),e(ds,si),k(t,Na,g),k(t,kn,g),e(kn,ai),k(t,Aa,g),k(t,bn,g),e(bn,cs),e(cs,ri),k(t,Oa,g),k(t,vn,g),e(vn,ii),k(t,Ia,g),k(t,Tn,g),e(Tn,ms),e(ms,li),k(t,Ua,g),k(t,te,g),e(te,di),e(te,Wt),e(Wt,ci),e(te,mi),e(te,Ht),e(Ht,pi),e(te,hi),e(te,Kt),e(Kt,fi),e(te,ui),k(t,Ra,g),k(t,re,g),e(re,gi),e(re,Bt),e(Bt,_i),e(re,ki),e(re,Vt),e(Vt,bi),e(re,vi),k(t,Wa,g),k(t,ie,g),e(ie,Ti),e(ie,Zt),e(Zt,yi),e(ie,wi),e(ie,ps),e(ps,$i),e(ie,Ei),k(t,Ha,g),k(t,Ee,g),e(Ee,Xe),e(Xe,hs),y(Gt,hs,null),e(Ee,Fi),e(Ee,fs),e(fs,Mi),k(t,Ka,g),k(t,D,g),y(Jt,D,null),e(D,zi),e(D,Fe),e(Fe,qi),e(Fe,us),e(us,xi),e(Fe,Ci),e(Fe,Yt),e(Yt,ji),e(Fe,Pi),e(D,Si),e(D,Me),e(Me,Li),e(Me,yn),e(yn,Di),e(Me,Ni),e(Me,wn),e(wn,Ai),e(Me,Oi),e(D,Ii),y(et,D,null),e(D,Ui),e(D,tt),y(Qt,tt,null),e(tt,Ri),e(tt,Xt),e(Xt,Wi),e(Xt,$n),e($n,Hi),e(Xt,Ki),k(t,Ba,g),k(t,ze,g),e(ze,ot),e(ot,gs),y(eo,gs,null),e(ze,Bi),e(ze,_s),e(_s,Vi),k(t,Va,g),k(t,C,g),y(to,C,null),e(C,Zi),e(C,ks),e(ks,Gi),e(C,Ji),e(C,En),y(oo,En,null),e(C,Yi),e(C,nt),y(no,nt,null),e(nt,Qi),e(nt,qe),e(qe,Xi),e(qe,bs),e(bs,el),e(qe,tl),e(qe,vs),e(vs,ol),e(qe,nl),e(C,sl),e(C,le),y(so,le,null),e(le,al),e(le,Fn),e(Fn,rl),e(Fn,Mn),e(Mn,il),e(le,ll),e(le,Ts),e(Ts,dl),e(C,cl),e(C,zn),y(ao,zn,null),k(t,Za,g),k(t,xe,g),e(xe,st),e(st,ys),y(ro,ys,null),e(xe,ml),e(xe,ws),e(ws,pl),k(t,Ga,g),k(t,q,g),y(io,q,null),e(q,hl),e(q,$s),e($s,fl),e(q,ul),e(q,lo),e(lo,gl),e(lo,qn),e(qn,_l),e(lo,kl),e(q,bl),e(q,co),e(co,vl),e(co,mo),e(mo,Tl),e(co,yl),e(q,wl),e(q,po),e(po,$l),e(po,ho),e(ho,El),e(po,Fl),e(q,Ml),e(q,j),e(j,zl),e(j,Es),e(Es,ql),e(j,xl),e(j,Fs),e(Fs,Cl),e(j,jl),e(j,Ms),e(Ms,Pl),e(j,Sl),e(j,zs),e(zs,Ll),e(j,Dl),e(j,qs),e(qs,Nl),e(j,Al),e(j,xs),e(xs,Ol),e(j,Il),e(q,Ul),e(q,oe),y(fo,oe,null),e(oe,Rl),e(oe,Ce),e(Ce,Wl),e(Ce,xn),e(xn,Hl),e(Ce,Kl),e(Ce,Cs),e(Cs,Bl),e(Ce,Vl),e(oe,Zl),y(at,oe,null),e(oe,Gl),y(rt,oe,null),k(t,Ja,g),k(t,je,g),e(je,it),e(it,js),y(uo,js,null),e(je,Jl),e(je,Ps),e(Ps,Yl),k(t,Ya,g),k(t,N,g),y(go,N,null),e(N,Ql),e(N,_o),e(_o,Xl),e(_o,Ss),e(Ss,ed),e(_o,td),e(N,od),e(N,ko),e(ko,nd),e(ko,Cn),e(Cn,sd),e(ko,ad),e(N,rd),e(N,bo),e(bo,id),e(bo,vo),e(vo,ld),e(bo,dd),e(N,cd),e(N,K),y(To,K,null),e(K,md),e(K,Pe),e(Pe,pd),e(Pe,jn),e(jn,hd),e(Pe,fd),e(Pe,Ls),e(Ls,ud),e(Pe,gd),e(K,_d),y(lt,K,null),e(K,kd),y(dt,K,null),e(K,bd),y(ct,K,null),k(t,Qa,g),k(t,Se,g),e(Se,mt),e(mt,Ds),y(yo,Ds,null),e(Se,vd),e(Se,Ns),e(Ns,Td),k(t,Xa,g),k(t,A,g),y(wo,A,null),e(A,yd),e(A,As),e(As,wd),e(A,$d),e(A,$o),e($o,Ed),e($o,Pn),e(Pn,Fd),e($o,Md),e(A,zd),e(A,Eo),e(Eo,qd),e(Eo,Fo),e(Fo,xd),e(Eo,Cd),e(A,jd),e(A,x),y(Mo,x,null),e(x,Pd),e(x,Le),e(Le,Sd),e(Le,Sn),e(Sn,Ld),e(Le,Dd),e(Le,Os),e(Os,Nd),e(Le,Ad),e(x,Od),y(pt,x,null),e(x,Id),y(ht,x,null),e(x,Ud),y(ft,x,null),e(x,Rd),y(ut,x,null),e(x,Wd),y(gt,x,null),k(t,er,g),k(t,De,g),e(De,_t),e(_t,Is),y(zo,Is,null),e(De,Hd),e(De,Us),e(Us,Kd),k(t,tr,g),k(t,O,g),y(qo,O,null),e(O,Bd),e(O,Rs),e(Rs,Vd),e(O,Zd),e(O,xo),e(xo,Gd),e(xo,Ln),e(Ln,Jd),e(xo,Yd),e(O,Qd),e(O,Co),e(Co,Xd),e(Co,jo),e(jo,ec),e(Co,tc),e(O,oc),e(O,B),y(Po,B,null),e(B,nc),e(B,Ne),e(Ne,sc),e(Ne,Dn),e(Dn,ac),e(Ne,rc),e(Ne,Ws),e(Ws,ic),e(Ne,lc),e(B,dc),y(kt,B,null),e(B,cc),y(bt,B,null),e(B,mc),y(vt,B,null),k(t,or,g),k(t,Ae,g),e(Ae,Tt),e(Tt,Hs),y(So,Hs,null),e(Ae,pc),e(Ae,Ks),e(Ks,hc),k(t,nr,g),k(t,I,g),y(Lo,I,null),e(I,fc),e(I,Bs),e(Bs,uc),e(I,gc),e(I,Do),e(Do,_c),e(Do,Nn),e(Nn,kc),e(Do,bc),e(I,vc),e(I,No),e(No,Tc),e(No,Ao),e(Ao,yc),e(No,wc),e(I,$c),e(I,V),y(Oo,V,null),e(V,Ec),e(V,Oe),e(Oe,Fc),e(Oe,An),e(An,Mc),e(Oe,zc),e(Oe,Vs),e(Vs,qc),e(Oe,xc),e(V,Cc),y(yt,V,null),e(V,jc),e(V,Zs),e(Zs,Pc),e(V,Sc),e(V,Gs),e(Gs,Lc),k(t,sr,g),k(t,Ie,g),e(Ie,wt),e(wt,Js),y(Io,Js,null),e(Ie,Dc),e(Ie,Ys),e(Ys,Nc),k(t,ar,g),k(t,U,g),y(Uo,U,null),e(U,Ac),e(U,Qs),e(Qs,Oc),e(U,Ic),e(U,Ro),e(Ro,Uc),e(Ro,On),e(On,Rc),e(Ro,Wc),e(U,Hc),e(U,Wo),e(Wo,Kc),e(Wo,Ho),e(Ho,Bc),e(Wo,Vc),e(U,Zc),e(U,ne),y(Ko,ne,null),e(ne,Gc),e(ne,Ue),e(Ue,Jc),e(Ue,In),e(In,Yc),e(Ue,Qc),e(Ue,Xs),e(Xs,Xc),e(Ue,em),e(ne,tm),y($t,ne,null),e(ne,om),y(Et,ne,null),k(t,rr,g),k(t,Re,g),e(Re,Ft),e(Ft,ea),y(Bo,ea,null),e(Re,nm),e(Re,ta),e(ta,sm),k(t,ir,g),k(t,R,g),y(Vo,R,null),e(R,am),e(R,Zo),e(Zo,rm),e(Zo,oa),e(oa,im),e(Zo,lm),e(R,dm),e(R,Go),e(Go,cm),e(Go,Un),e(Un,mm),e(Go,pm),e(R,hm),e(R,Jo),e(Jo,fm),e(Jo,Yo),e(Yo,um),e(Jo,gm),e(R,_m),e(R,Z),y(Qo,Z,null),e(Z,km),e(Z,We),e(We,bm),e(We,Rn),e(Rn,vm),e(We,Tm),e(We,na),e(na,ym),e(We,wm),e(Z,$m),y(Mt,Z,null),e(Z,Em),y(zt,Z,null),e(Z,Fm),y(qt,Z,null),k(t,lr,g),k(t,He,g),e(He,xt),e(xt,sa),y(Xo,sa,null),e(He,Mm),e(He,aa),e(aa,zm),k(t,dr,g),k(t,W,g),y(en,W,null),e(W,qm),e(W,ra),e(ra,xm),e(W,Cm),e(W,tn),e(tn,jm),e(tn,Wn),e(Wn,Pm),e(tn,Sm),e(W,Lm),e(W,on),e(on,Dm),e(on,nn),e(nn,Nm),e(on,Am),e(W,Om),e(W,G),y(sn,G,null),e(G,Im),e(G,Ke),e(Ke,Um),e(Ke,Hn),e(Hn,Rm),e(Ke,Wm),e(Ke,ia),e(ia,Hm),e(Ke,Km),e(G,Bm),y(Ct,G,null),e(G,Vm),y(jt,G,null),e(G,Zm),y(Pt,G,null),k(t,cr,g),k(t,Be,g),e(Be,St),e(St,la),y(an,la,null),e(Be,Gm),e(Be,da),e(da,Jm),k(t,mr,g),k(t,H,g),y(rn,H,null),e(H,Ym),e(H,ca),e(ca,Qm),e(H,Xm),e(H,ln),e(ln,ep),e(ln,Kn),e(Kn,tp),e(ln,op),e(H,np),e(H,dn),e(dn,sp),e(dn,cn),e(cn,ap),e(dn,rp),e(H,ip),e(H,J),y(mn,J,null),e(J,lp),e(J,Ve),e(Ve,dp),e(Ve,Bn),e(Bn,cp),e(Ve,mp),e(Ve,ma),e(ma,pp),e(Ve,hp),e(J,fp),y(Lt,J,null),e(J,up),y(Dt,J,null),e(J,gp),y(Nt,J,null),pr=!0},p(t,[g]){const pn={};g&2&&(pn.$$scope={dirty:g,ctx:t}),et.$set(pn);const pa={};g&2&&(pa.$$scope={dirty:g,ctx:t}),at.$set(pa);const ha={};g&2&&(ha.$$scope={dirty:g,ctx:t}),rt.$set(ha);const fa={};g&2&&(fa.$$scope={dirty:g,ctx:t}),lt.$set(fa);const hn={};g&2&&(hn.$$scope={dirty:g,ctx:t}),dt.$set(hn);const ua={};g&2&&(ua.$$scope={dirty:g,ctx:t}),ct.$set(ua);const ga={};g&2&&(ga.$$scope={dirty:g,ctx:t}),pt.$set(ga);const _a={};g&2&&(_a.$$scope={dirty:g,ctx:t}),ht.$set(_a);const fn={};g&2&&(fn.$$scope={dirty:g,ctx:t}),ft.$set(fn);const ka={};g&2&&(ka.$$scope={dirty:g,ctx:t}),ut.$set(ka);const un={};g&2&&(un.$$scope={dirty:g,ctx:t}),gt.$set(un);const ba={};g&2&&(ba.$$scope={dirty:g,ctx:t}),kt.$set(ba);const va={};g&2&&(va.$$scope={dirty:g,ctx:t}),bt.$set(va);const Ta={};g&2&&(Ta.$$scope={dirty:g,ctx:t}),vt.$set(Ta);const ya={};g&2&&(ya.$$scope={dirty:g,ctx:t}),yt.$set(ya);const wa={};g&2&&(wa.$$scope={dirty:g,ctx:t}),$t.$set(wa);const $a={};g&2&&($a.$$scope={dirty:g,ctx:t}),Et.$set($a);const Ea={};g&2&&(Ea.$$scope={dirty:g,ctx:t}),Mt.$set(Ea);const Fa={};g&2&&(Fa.$$scope={dirty:g,ctx:t}),zt.$set(Fa);const Ma={};g&2&&(Ma.$$scope={dirty:g,ctx:t}),qt.$set(Ma);const za={};g&2&&(za.$$scope={dirty:g,ctx:t}),Ct.$set(za);const ae={};g&2&&(ae.$$scope={dirty:g,ctx:t}),jt.$set(ae);const qa={};g&2&&(qa.$$scope={dirty:g,ctx:t}),Pt.$set(qa);const xa={};g&2&&(xa.$$scope={dirty:g,ctx:t}),Lt.$set(xa);const Ca={};g&2&&(Ca.$$scope={dirty:g,ctx:t}),Dt.$set(Ca);const Ze={};g&2&&(Ze.$$scope={dirty:g,ctx:t}),Nt.$set(Ze)},i(t){pr||(w(l.$$.fragment,t),w(It.$$.fragment,t),w(Gt.$$.fragment,t),w(Jt.$$.fragment,t),w(et.$$.fragment,t),w(Qt.$$.fragment,t),w(eo.$$.fragment,t),w(to.$$.fragment,t),w(oo.$$.fragment,t),w(no.$$.fragment,t),w(so.$$.fragment,t),w(ao.$$.fragment,t),w(ro.$$.fragment,t),w(io.$$.fragment,t),w(fo.$$.fragment,t),w(at.$$.fragment,t),w(rt.$$.fragment,t),w(uo.$$.fragment,t),w(go.$$.fragment,t),w(To.$$.fragment,t),w(lt.$$.fragment,t),w(dt.$$.fragment,t),w(ct.$$.fragment,t),w(yo.$$.fragment,t),w(wo.$$.fragment,t),w(Mo.$$.fragment,t),w(pt.$$.fragment,t),w(ht.$$.fragment,t),w(ft.$$.fragment,t),w(ut.$$.fragment,t),w(gt.$$.fragment,t),w(zo.$$.fragment,t),w(qo.$$.fragment,t),w(Po.$$.fragment,t),w(kt.$$.fragment,t),w(bt.$$.fragment,t),w(vt.$$.fragment,t),w(So.$$.fragment,t),w(Lo.$$.fragment,t),w(Oo.$$.fragment,t),w(yt.$$.fragment,t),w(Io.$$.fragment,t),w(Uo.$$.fragment,t),w(Ko.$$.fragment,t),w($t.$$.fragment,t),w(Et.$$.fragment,t),w(Bo.$$.fragment,t),w(Vo.$$.fragment,t),w(Qo.$$.fragment,t),w(Mt.$$.fragment,t),w(zt.$$.fragment,t),w(qt.$$.fragment,t),w(Xo.$$.fragment,t),w(en.$$.fragment,t),w(sn.$$.fragment,t),w(Ct.$$.fragment,t),w(jt.$$.fragment,t),w(Pt.$$.fragment,t),w(an.$$.fragment,t),w(rn.$$.fragment,t),w(mn.$$.fragment,t),w(Lt.$$.fragment,t),w(Dt.$$.fragment,t),w(Nt.$$.fragment,t),pr=!0)},o(t){$(l.$$.fragment,t),$(It.$$.fragment,t),$(Gt.$$.fragment,t),$(Jt.$$.fragment,t),$(et.$$.fragment,t),$(Qt.$$.fragment,t),$(eo.$$.fragment,t),$(to.$$.fragment,t),$(oo.$$.fragment,t),$(no.$$.fragment,t),$(so.$$.fragment,t),$(ao.$$.fragment,t),$(ro.$$.fragment,t),$(io.$$.fragment,t),$(fo.$$.fragment,t),$(at.$$.fragment,t),$(rt.$$.fragment,t),$(uo.$$.fragment,t),$(go.$$.fragment,t),$(To.$$.fragment,t),$(lt.$$.fragment,t),$(dt.$$.fragment,t),$(ct.$$.fragment,t),$(yo.$$.fragment,t),$(wo.$$.fragment,t),$(Mo.$$.fragment,t),$(pt.$$.fragment,t),$(ht.$$.fragment,t),$(ft.$$.fragment,t),$(ut.$$.fragment,t),$(gt.$$.fragment,t),$(zo.$$.fragment,t),$(qo.$$.fragment,t),$(Po.$$.fragment,t),$(kt.$$.fragment,t),$(bt.$$.fragment,t),$(vt.$$.fragment,t),$(So.$$.fragment,t),$(Lo.$$.fragment,t),$(Oo.$$.fragment,t),$(yt.$$.fragment,t),$(Io.$$.fragment,t),$(Uo.$$.fragment,t),$(Ko.$$.fragment,t),$($t.$$.fragment,t),$(Et.$$.fragment,t),$(Bo.$$.fragment,t),$(Vo.$$.fragment,t),$(Qo.$$.fragment,t),$(Mt.$$.fragment,t),$(zt.$$.fragment,t),$(qt.$$.fragment,t),$(Xo.$$.fragment,t),$(en.$$.fragment,t),$(sn.$$.fragment,t),$(Ct.$$.fragment,t),$(jt.$$.fragment,t),$(Pt.$$.fragment,t),$(an.$$.fragment,t),$(rn.$$.fragment,t),$(mn.$$.fragment,t),$(Lt.$$.fragment,t),$(Dt.$$.fragment,t),$(Nt.$$.fragment,t),pr=!1},d(t){o(d),t&&o(_),t&&o(c),E(l),t&&o(ja),t&&o($e),E(It),t&&o(Pa),t&&o(Ye),t&&o(Sa),t&&o(Qe),t&&o(La),t&&o(gn),t&&o(Da),t&&o(_n),t&&o(Na),t&&o(kn),t&&o(Aa),t&&o(bn),t&&o(Oa),t&&o(vn),t&&o(Ia),t&&o(Tn),t&&o(Ua),t&&o(te),t&&o(Ra),t&&o(re),t&&o(Wa),t&&o(ie),t&&o(Ha),t&&o(Ee),E(Gt),t&&o(Ka),t&&o(D),E(Jt),E(et),E(Qt),t&&o(Ba),t&&o(ze),E(eo),t&&o(Va),t&&o(C),E(to),E(oo),E(no),E(so),E(ao),t&&o(Za),t&&o(xe),E(ro),t&&o(Ga),t&&o(q),E(io),E(fo),E(at),E(rt),t&&o(Ja),t&&o(je),E(uo),t&&o(Ya),t&&o(N),E(go),E(To),E(lt),E(dt),E(ct),t&&o(Qa),t&&o(Se),E(yo),t&&o(Xa),t&&o(A),E(wo),E(Mo),E(pt),E(ht),E(ft),E(ut),E(gt),t&&o(er),t&&o(De),E(zo),t&&o(tr),t&&o(O),E(qo),E(Po),E(kt),E(bt),E(vt),t&&o(or),t&&o(Ae),E(So),t&&o(nr),t&&o(I),E(Lo),E(Oo),E(yt),t&&o(sr),t&&o(Ie),E(Io),t&&o(ar),t&&o(U),E(Uo),E(Ko),E($t),E(Et),t&&o(rr),t&&o(Re),E(Bo),t&&o(ir),t&&o(R),E(Vo),E(Qo),E(Mt),E(zt),E(qt),t&&o(lr),t&&o(He),E(Xo),t&&o(dr),t&&o(W),E(en),E(sn),E(Ct),E(jt),E(Pt),t&&o(cr),t&&o(Be),E(an),t&&o(mr),t&&o(H),E(rn),E(mn),E(Lt),E(Dt),E(Nt)}}}const Bf={local:"esm",sections:[{local:"overview",title:"Overview"},{local:"transformers.EsmConfig",title:"EsmConfig"},{local:"transformers.EsmTokenizer",title:"EsmTokenizer"},{local:"transformers.EsmModel",title:"EsmModel"},{local:"transformers.EsmForMaskedLM",title:"EsmForMaskedLM"},{local:"transformers.EsmForSequenceClassification",title:"EsmForSequenceClassification"},{local:"transformers.EsmForTokenClassification",title:"EsmForTokenClassification"},{local:"transformers.EsmForProteinFolding",title:"EsmForProteinFolding"},{local:"transformers.TFEsmModel",title:"TFEsmModel"},{local:"transformers.TFEsmForMaskedLM",title:"TFEsmForMaskedLM"},{local:"transformers.TFEsmForSequenceClassification",title:"TFEsmForSequenceClassification"},{local:"transformers.TFEsmForTokenClassification",title:"TFEsmForTokenClassification"}],title:"ESM"};function Vf(F){return kf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class eu extends ff{constructor(d){super();uf(this,d,Vf,Kf,gf,{})}}export{eu as default,Bf as metadata};
