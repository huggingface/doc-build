...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/imagegpt/feature_extraction_imagegpt.py#L101",returnDescription:`
<p>A <a
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/imagegpt/modeling_imagegpt.py#L652",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/imagegpt#transformers.ImageGPTConfig"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/imagegpt/modeling_imagegpt.py#L945",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/imagegpt/modeling_imagegpt.py#L1097",returnDescription:`
...
`}}),Me=new dn({props:{$$slots:{default:[Tc]},$$scope:{ctx:$}}}),ze=new cn({props:{anchor:"transformers.ImageGPTForImageClassification.forward.example",$$slots:{default:[bc]},$$scope:{ctx:$}}}),{c(){p=a("meta"),T=l(),f=a("h1"),g=a("a"),v=a("span"),b(c.$$.fragment),_=l(),O=a("span"),hn=r("ImageGPT"),ya=l(),re=a("h2"),_e=a("a"),Qt=a("span"),b(Se.$$.fragment),gn=l(),Kt=a("span"),un=r("Overview"),Ia=l(),ve=a("p"),fn=r("The ImageGPT model was proposed in "),Re=a("a"),_n=r("Generative Pretraining from Pixels"),vn=r(` by Mark
...
top-1 accuracy on a linear probe of our features.`),ka=l(),Te=a("img"),$a=l(),Et=a("small"),yn=r("Summary of the approach. Taken from the [original paper](https://cdn.openai.com/papers/Generative_Pretraining_from_Pixels_V2.pdf)."),xa=l(),R=a("p"),In=r("This model was contributed by "),We=a("a"),wn=r("nielsr"),Pn=r(", based on "),Be=a("a"),kn=r("this issue"),$n=r(`. The original code can be found
...
and behavior.`),hi=l(),W=a("div"),b(ct.$$.fragment),gi=l(),me=a("p"),ui=r("The "),Ot=a("a"),fi=r("ImageGPTModel"),_i=r(" forward method, overrides the "),ia=a("code"),vi=r("__call__"),Ti=r(" special method."),bi=l(),b($e.$$.fragment),yi=l(),b(xe.$$.fragment),Da=l(),pe=a("h2"),Ge=a("a"),la=a("span"),b(mt.$$.fragment),Ii=l(),da=a("span"),wi=r("ImageGPTForCausalImageModeling"),Na=l(),D=a("div"),b(pt.$$.fragment),Pi=l(),ca=a("p"),ki=r(`The ImageGPT Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ji=l(),B=a("div"),b(ft.$$.fragment),qi=l(),he=a("p"),Ai=r("The "),St=a("a"),Di=r("ImageGPTForCausalImageModeling"),Ni=r(" forward method, overrides the "),ma=a("code"),Oi=r("__call__"),Li=r(" special method."),Si=l(),b(Ee.$$.fragment),Ri=l(),b(Ce.$$.fragment),Oa=l(),ge=a("h2"),Fe=a("a"),pa=a("span"),b(_t.$$.fragment),Wi=l(),ha=a("span"),Bi=r("ImageGPTForImageClassification"),La=l(),N=a("div"),b(vt.$$.fragment),Hi=l(),Tt=a("p"),Vi=r(`The ImageGPT Model transformer with an image classification head on top (linear layer).
...
ResNet, and 99.0% accuracy with full fine-tuning, matching the top supervised pre-trained models. We are also
competitive with self-supervised benchmarks on ImageNet when substituting pixels for a VQVAE encoding, achieving 69.0%
top-1 accuracy on a linear probe of our features.`),fl.forEach(t),ul.forEach(t),ka=d(o),Te=n(o,"IMG",{src:!0,alt:!0,width:!0}),$a=d(o),Et=n(o,"SMALL",{});var _l=s(Et);yn=i(_l,"Summary of the approach. Taken from the [original paper](https://cdn.openai.com/papers/Generative_Pretraining_from_Pixels_V2.pdf)."),_l.forEach(t),xa=d(o),R=n(o,"P",{});var je=s(R);In=i(je,"This model was contributed by "),We=n(je,"A",{href:!0,rel:!0});var vl=s(We);wn=i(vl,"nielsr"),vl.forEach(t),Pn=i(je,", based on "),Be=n(je,"A",{href:!0,rel:!0});var Tl=s(Be);kn=i(Tl,"this issue"),Tl.forEach(t),$n=i(je,`. The original code can be found
