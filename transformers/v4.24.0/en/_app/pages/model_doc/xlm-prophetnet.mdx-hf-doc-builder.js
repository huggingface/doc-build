import{S as Rl,i as Vl,s as Yl,e as s,k as p,w as b,t as n,M as Jl,c as a,d as t,m as h,a as i,x as y,h as r,b as l,G as e,g as _,y as T,q as w,o as P,B as M,v as Ql,L as Xn}from"../../chunks/vendor-hf-doc-builder.js";import{T as zn}from"../../chunks/Tip-hf-doc-builder.js";import{D as X}from"../../chunks/Docstring-hf-doc-builder.js";import{C as qn}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as be}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as xn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Zl(N){let c,v,g,m,k;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var L=i(g);m=r(L,"Module"),L.forEach(t),k=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){_(d,c,u),e(c,v),e(c,g),e(g,m),e(c,k)},d(d){d&&t(c)}}}function Kl(N){let c,v,g,m,k;return m=new qn({props:{code:`from transformers import XLMProphetNetTokenizer, XLMProphetNetModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states_ngram = outputs.last_hidden_state_ngram  <span class="hljs-comment"># predict hidden states</span>`}}),{c(){c=s("p"),v=n("Example:"),g=p(),b(m.$$.fragment)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Example:"),u.forEach(t),g=h(d),y(m.$$.fragment,d)},m(d,u){_(d,c,u),e(c,v),_(d,g,u),T(m,d,u),k=!0},p:Xn,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(c),d&&t(g),M(m,d)}}}function ec(N){let c,v,g,m,k;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var L=i(g);m=r(L,"Module"),L.forEach(t),k=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){_(d,c,u),e(c,v),e(c,g),e(g,m),e(c,k)},d(d){d&&t(c)}}}function tc(N){let c,v,g,m,k;return m=new qn({props:{code:`from transformers import XLMProphetNetTokenizer, XLMProphetNetEncoder
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){c=s("p"),v=n("Example:"),g=p(),b(m.$$.fragment)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Example:"),u.forEach(t),g=h(d),y(m.$$.fragment,d)},m(d,u){_(d,c,u),e(c,v),_(d,g,u),T(m,d,u),k=!0},p:Xn,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(c),d&&t(g),M(m,d)}}}function oc(N){let c,v,g,m,k;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var L=i(g);m=r(L,"Module"),L.forEach(t),k=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){_(d,c,u),e(c,v),e(c,g),e(g,m),e(c,k)},d(d){d&&t(c)}}}function nc(N){let c,v,g,m,k;return m=new qn({props:{code:`from transformers import XLMProphetNetTokenizer, XLMProphetNetDecoder
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){c=s("p"),v=n("Example:"),g=p(),b(m.$$.fragment)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Example:"),u.forEach(t),g=h(d),y(m.$$.fragment,d)},m(d,u){_(d,c,u),e(c,v),_(d,g,u),T(m,d,u),k=!0},p:Xn,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(c),d&&t(g),M(m,d)}}}function rc(N){let c,v,g,m,k;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var L=i(g);m=r(L,"Module"),L.forEach(t),k=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){_(d,c,u),e(c,v),e(c,g),e(g,m),e(c,k)},d(d){d&&t(c)}}}function sc(N){let c,v,g,m,k;return m=new qn({props:{code:`from transformers import XLMProphetNetTokenizer, XLMProphetNetForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_ngram_next_tokens = outputs.logits_ngram  <span class="hljs-comment"># logits to predict 2nd, 3rd, ... next tokens</span>`}}),{c(){c=s("p"),v=n("Example:"),g=p(),b(m.$$.fragment)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Example:"),u.forEach(t),g=h(d),y(m.$$.fragment,d)},m(d,u){_(d,c,u),e(c,v),_(d,g,u),T(m,d,u),k=!0},p:Xn,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(c),d&&t(g),M(m,d)}}}function ac(N){let c,v,g,m,k;return{c(){c=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var L=i(g);m=r(L,"Module"),L.forEach(t),k=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){_(d,c,u),e(c,v),e(c,g),e(g,m),e(c,k)},d(d){d&&t(c)}}}function ic(N){let c,v,g,m,k;return m=new qn({props:{code:`from transformers import XLMProphetNetTokenizer, XLMProphetNetForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),{c(){c=s("p"),v=n("Example:"),g=p(),b(m.$$.fragment)},l(d){c=a(d,"P",{});var u=i(c);v=r(u,"Example:"),u.forEach(t),g=h(d),y(m.$$.fragment,d)},m(d,u){_(d,c,u),e(c,v),_(d,g,u),T(m,d,u),k=!0},p:Xn,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(c),d&&t(g),M(m,d)}}}function dc(N){let c,v,g,m,k,d,u,L,Nr,En,K,Fo,Lr,$r,Qe,zr,xr,Cn,ee,ye,Oo,Ze,Xr,jo,qr,Fn,Te,Er,Ke,Cr,Fr,On,Qt,Or,jn,Zt,jr,Dn,Kt,Do,Dr,An,we,Ar,et,Sr,Ir,Sn,te,Pe,Ao,tt,Br,So,Gr,In,H,ot,Wr,oe,Hr,eo,Ur,Rr,nt,Vr,Yr,Jr,ne,Qr,to,Zr,Kr,oo,es,ts,Bn,re,Me,Io,rt,os,Bo,ns,Gn,$,st,rs,U,ss,no,as,is,ro,ds,ls,at,cs,ps,hs,it,us,so,ms,fs,gs,R,dt,_s,Go,ks,vs,lt,ao,bs,Wo,ys,Ts,io,ws,Ho,Ps,Ms,Ne,ct,Ns,Uo,Ls,$s,Le,pt,zs,Ro,xs,Xs,$e,ht,qs,ut,Es,Vo,Cs,Fs,Wn,se,ze,Yo,mt,Os,Jo,js,Hn,q,ft,Ds,gt,As,lo,Ss,Is,Bs,ae,Gs,_t,Ws,Hs,Qo,Us,Rs,Vs,kt,Ys,vt,Js,Qs,Zs,D,bt,Ks,ie,ea,co,ta,oa,Zo,na,ra,sa,xe,aa,Xe,Un,de,qe,Ko,yt,ia,en,da,Rn,z,Tt,la,wt,ca,po,pa,ha,ua,le,ma,Pt,fa,ga,tn,_a,ka,va,Mt,ba,Nt,ya,Ta,wa,O,Pa,on,Ma,Na,nn,La,$a,rn,za,xa,ho,Xa,qa,Ea,A,Lt,Ca,ce,Fa,uo,Oa,ja,sn,Da,Aa,Sa,Ee,Ia,Ce,Vn,pe,Fe,an,$t,Ba,dn,Ga,Yn,x,zt,Wa,xt,Ha,mo,Ua,Ra,Va,he,Ya,Xt,Ja,Qa,ln,Za,Ka,ei,qt,ti,Et,oi,ni,ri,j,si,cn,ai,ii,pn,di,li,hn,ci,pi,fo,hi,ui,mi,S,Ct,fi,ue,gi,go,_i,ki,un,vi,bi,yi,Oe,Ti,je,Jn,me,De,mn,Ft,wi,fn,Pi,Qn,E,Ot,Mi,jt,Ni,_o,Li,$i,zi,fe,xi,Dt,Xi,qi,gn,Ei,Ci,Fi,At,Oi,St,ji,Di,Ai,I,It,Si,ge,Ii,ko,Bi,Gi,_n,Wi,Hi,Ui,Ae,Ri,Se,Zn,_e,Ie,kn,Bt,Vi,vn,Yi,Kn,C,Gt,Ji,Wt,Qi,vo,Zi,Ki,ed,ke,td,Ht,od,nd,bn,rd,sd,ad,Ut,id,Rt,dd,ld,cd,B,Vt,pd,ve,hd,bo,ud,md,yn,fd,gd,_d,Be,kd,Ge,er;return d=new be({}),Ze=new be({}),tt=new be({}),ot=new X({props:{name:"class transformers.XLMProphetNetConfig",anchor:"transformers.XLMProphetNetConfig",parameters:[{name:"activation_dropout",val:": typing.Optional[float] = 0.1"},{name:"activation_function",val:": typing.Union[str, typing.Callable, NoneType] = 'gelu'"},{name:"vocab_size",val:": typing.Optional[int] = 30522"},{name:"hidden_size",val:": typing.Optional[int] = 1024"},{name:"encoder_ffn_dim",val:": typing.Optional[int] = 4096"},{name:"num_encoder_layers",val:": typing.Optional[int] = 12"},{name:"num_encoder_attention_heads",val:": typing.Optional[int] = 16"},{name:"decoder_ffn_dim",val:": typing.Optional[int] = 4096"},{name:"num_decoder_layers",val:": typing.Optional[int] = 12"},{name:"num_decoder_attention_heads",val:": typing.Optional[int] = 16"},{name:"attention_dropout",val:": typing.Optional[float] = 0.1"},{name:"dropout",val:": typing.Optional[float] = 0.1"},{name:"max_position_embeddings",val:": typing.Optional[int] = 512"},{name:"init_std",val:": typing.Optional[float] = 0.02"},{name:"is_encoder_decoder",val:": typing.Optional[bool] = True"},{name:"add_cross_attention",val:": typing.Optional[bool] = True"},{name:"decoder_start_token_id",val:": typing.Optional[int] = 0"},{name:"ngram",val:": typing.Optional[int] = 2"},{name:"num_buckets",val:": typing.Optional[int] = 32"},{name:"relative_max_distance",val:": typing.Optional[int] = 128"},{name:"disable_ngram_loss",val:": typing.Optional[bool] = False"},{name:"eps",val:": typing.Optional[float] = 0.0"},{name:"use_cache",val:": typing.Optional[bool] = True"},{name:"pad_token_id",val:": typing.Optional[int] = 0"},{name:"bos_token_id",val:": typing.Optional[int] = 1"},{name:"eos_token_id",val:": typing.Optional[int] = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMProphetNetConfig.activation_dropout",description:`<strong>activation_dropout</strong> (<code>float</code>, <em>optional</em>, defaults to 0.1) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/configuration_xlm_prophetnet.py#L33"}}),rt=new be({}),st=new X({props:{name:"class transformers.XLMProphetNetTokenizer",anchor:"transformers.XLMProphetNetTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '[SEP]'"},{name:"eos_token",val:" = '[SEP]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"unk_token",val:" = '[UNK]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMProphetNetTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/tokenization_xlm_prophetnet.py#L316",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ct=new X({props:{name:"convert_tokens_to_string",anchor:"transformers.XLMProphetNetTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/tokenization_xlm_prophetnet.py#L294"}}),pt=new X({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.XLMProphetNetTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.XLMProphetNetTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/tokenization_xlm_prophetnet.py#L243",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/modeling_xlm_prophetnet.py#L1832",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/xlm-prophetnet#transformers.XLMProphetNetConfig"
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/modeling_xlm_prophetnet.py#L1315",returnDescription:`
<p>A <a
...
<li>1 for tokens that are <strong>not masked</strong>,</li>
<li>0 for tokens that are <strong>masked</strong>.</li>
</ul>`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/modeling_xlm_prophetnet.py#L1463",returnDescription:`
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/modeling_xlm_prophetnet.py#L1949",returnDescription:`
...
ignored (masked), the loss is only computed for the tokens with labels n <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/xlm_prophetnet/modeling_xlm_prophetnet.py#L2176",returnDescription:`
...
`}}),Be=new zn({props:{$$slots:{default:[ac]},$$scope:{ctx:N}}}),Ge=new xn({props:{anchor:"transformers.XLMProphetNetForCausalLM.forward.example",$$slots:{default:[ic]},$$scope:{ctx:N}}}),{c(){c=s("meta"),v=p(),g=s("h1"),m=s("a"),k=s("span"),b(d.$$.fragment),u=p(),L=s("span"),Nr=n("XLM-ProphetNet"),En=p(),K=s("p"),Fo=s("strong"),Lr=n("DISCLAIMER:"),$r=n(" If you see something strange, file a "),Qe=s("a"),zr=n("Github Issue"),xr=n(` and assign
...
`),at=s("a"),cs=n("SentencePiece"),ps=n("."),hs=p(),it=s("p"),us=n("This tokenizer inherits from "),so=s("a"),ms=n("PreTrainedTokenizer"),fs=n(` which contains most of the main methods. Users should refer to
...
does not make use of token type ids, therefore a list of zeros is returned.`),Xs=p(),$e=s("div"),b(ht.$$.fragment),qs=p(),ut=s("p"),Es=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Vo=s("code"),Cs=n("prepare_for_model"),Fs=n(" method."),Wn=p(),se=s("h2"),ze=s("a"),Yo=s("span"),b(mt.$$.fragment),Os=p(),Jo=s("span"),js=n("XLMProphetNetModel"),Hn=p(),q=s("div"),b(ft.$$.fragment),Ds=p(),gt=s("p"),As=n(`The bare XLMProphetNet Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ua=p(),le=s("p"),ma=n("Original ProphetNet code can be found "),Pt=s("a"),fa=n("here"),ga=n(`. Checkpoints were converted
from original Fairseq checkpoints. For more information on the checkpoint conversion, please take a look at the
...
embeddings instead of randomly initialized word embeddings.`),Ea=p(),A=s("div"),b(Lt.$$.fragment),Ca=p(),ce=s("p"),Fa=n("The "),uo=s("a"),Oa=n("XLMProphetNetEncoder"),ja=n(" forward method, overrides the "),sn=s("code"),Da=n("__call__"),Aa=n(" special method."),Sa=p(),b(Ee.$$.fragment),Ia=p(),b(Ce.$$.fragment),Vn=p(),pe=s("h2"),Fe=s("a"),an=s("span"),b($t.$$.fragment),Ba=p(),dn=s("span"),Ga=n("XLMProphetNetDecoder"),Yn=p(),x=s("div"),b(zt.$$.fragment),Wa=p(),xt=s("p"),Ha=n(`The standalone decoder part of the XLMProphetNetModel.
This model inherits from `),mo=s("a"),Ua=n("PreTrainedModel"),Ra=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
The word embedding parameters. This can be used to initialize `),fo=s("a"),hi=n("XLMProphetNetEncoder"),ui=n(` with pre-defined word
embeddings instead of randomly initialized word embeddings.`),mi=p(),S=s("div"),b(Ct.$$.fragment),fi=p(),ue=s("p"),gi=n("The "),go=s("a"),_i=n("XLMProphetNetDecoder"),ki=n(" forward method, overrides the "),un=s("code"),vi=n("__call__"),bi=n(" special method."),yi=p(),b(Oe.$$.fragment),Ti=p(),b(je.$$.fragment),Jn=p(),me=s("h2"),De=s("a"),mn=s("span"),b(Ft.$$.fragment),wi=p(),fn=s("span"),Pi=n("XLMProphetNetForConditionalGeneration"),Qn=p(),E=s("div"),b(Ot.$$.fragment),Mi=p(),jt=s("p"),Ni=n(`The XLMProphetNet Model with a language modeling head. Can be used for sequence generation tasks.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matters related to general usage and
behavior.`),cd=p(),B=s("div"),b(Vt.$$.fragment),pd=p(),ve=s("p"),hd=n("The "),bo=s("a"),ud=n("XLMProphetNetForCausalLM"),md=n(" forward method, overrides the "),yn=s("code"),fd=n("__call__"),gd=n(" special method."),_d=p(),b(Be.$$.fragment),kd=p(),b(Ge.$$.fragment),this.h()},l(o){const f=Jl('[data-svelte="svelte-1phssyn"]',document.head);c=a(f,"META",{name:!0,content:!0}),f.forEach(t),v=h(o),g=a(o,"H1",{class:!0});var Yt=i(g);m=a(Yt,"A",{id:!0,class:!0,href:!0});var Tn=i(m);k=a(Tn,"SPAN",{});var wn=i(k);y(d.$$.fragment,wn),wn.forEach(t),Tn.forEach(t),u=h(Yt),L=a(Yt,"SPAN",{});var Pn=i(L);Nr=r(Pn,"XLM-ProphetNet"),Pn.forEach(t),Yt.forEach(t),En=h(o),K=a(o,"P",{});var We=i(K);Fo=a(We,"STRONG",{});var Mn=i(Fo);Lr=r(Mn,"DISCLAIMER:"),Mn.forEach(t),$r=r(We," If you see something strange, file a "),Qe=a(We,"A",{href:!0,rel:!0});var Nn=i(Qe);zr=r(Nn,"Github Issue"),Nn.forEach(t),xr=r(We,` and assign
...
`),at=a(He,"A",{href:!0,rel:!0});var Sd=i(at);cs=r(Sd,"SentencePiece"),Sd.forEach(t),ps=r(He,"."),He.forEach(t),hs=h(F),it=a(F,"P",{});var sr=i(it);us=r(sr,"This tokenizer inherits from "),so=a(sr,"A",{href:!0});var Id=i(so);ms=r(Id,"PreTrainedTokenizer"),Id.forEach(t),fs=r(sr,` which contains most of the main methods. Users should refer to
...
does not make use of token type ids, therefore a list of zeros is returned.`),Ud.forEach(t),dr.forEach(t),Xs=h(F),$e=a(F,"DIV",{class:!0});var lr=i($e);y(ht.$$.fragment,lr),qs=h(lr),ut=a(lr,"P",{});var cr=i(ut);Es=r(cr,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Vo=a(cr,"CODE",{});var Rd=i(Vo);Cs=r(Rd,"prepare_for_model"),Rd.forEach(t),Fs=r(cr," method."),cr.forEach(t),lr.forEach(t),F.forEach(t),Wn=h(o),se=a(o,"H2",{class:!0});var pr=i(se);ze=a(pr,"A",{id:!0,class:!0,href:!0});var Vd=i(ze);Yo=a(Vd,"SPAN",{});var Yd=i(Yo);y(mt.$$.fragment,Yd),Yd.forEach(t),Vd.forEach(t),Os=h(pr),Jo=a(pr,"SPAN",{});var Jd=i(Jo);js=r(Jd,"XLMProphetNetModel"),Jd.forEach(t),pr.forEach(t),Hn=h(o),q=a(o,"DIV",{class:!0});var V=i(q);y(ft.$$.fragment,V),Ds=h(V),gt=a(V,"P",{});var hr=i(gt);As=r(hr,`The bare XLMProphetNet Model outputting raw hidden-states without any specific head on top.
...
from original Fairseq checkpoints. For more information on the checkpoint conversion, please take a look at the
file `),Qo=a(Mo,"CODE",{});var Kd=i(Qo);Us=r(Kd,"convert_prophetnet_original_pytorch_checkpoint_to_pytorch.py"),Kd.forEach(t),Rs=r(Mo,"."),Mo.forEach(t),Vs=h(V),kt=a(V,"P",{});var ur=i(kt);Ys=r(ur,"This model is a PyTorch "),vt=a(ur,"A",{href:!0,rel:!0});var el=i(vt);Js=r(el,"torch.nn.Module"),el.forEach(t),Qs=r(ur,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matters related to general usage and
behavior.`),ur.forEach(t),Zs=h(V),D=a(V,"DIV",{class:!0});var Ue=i(D);y(bt.$$.fragment,Ue),Ks=h(Ue),ie=a(Ue,"P",{});var No=i(ie);ea=r(No,"The "),co=a(No,"A",{href:!0});var tl=i(co);ta=r(tl,"XLMProphetNetModel"),tl.forEach(t),oa=r(No," forward method, overrides the "),Zo=a(No,"CODE",{});var ol=i(Zo);na=r(ol,"__call__"),ol.forEach(t),ra=r(No," special method."),No.forEach(t),sa=h(Ue),y(xe.$$.fragment,Ue),aa=h(Ue),y(Xe.$$.fragment,Ue),Ue.forEach(t),V.forEach(t),Un=h(o),de=a(o,"H2",{class:!0});var mr=i(de);qe=a(mr,"A",{id:!0,class:!0,href:!0});var nl=i(qe);Ko=a(nl,"SPAN",{});var rl=i(Ko);y(yt.$$.fragment,rl),rl.forEach(t),nl.forEach(t),ia=h(mr),en=a(mr,"SPAN",{});var sl=i(en);da=r(sl,"XLMProphetNetEncoder"),sl.forEach(t),mr.forEach(t),Rn=h(o),z=a(o,"DIV",{class:!0});var G=i(z);y(Tt.$$.fragment,G),la=h(G),wt=a(G,"P",{});var fr=i(wt);ca=r(fr,`The standalone encoder part of the XLMProphetNetModel.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fr.forEach(t),ua=h(G),le=a(G,"P",{});var Lo=i(le);ma=r(Lo,"Original ProphetNet code can be found "),Pt=a(Lo,"A",{href:!0,rel:!0});var il=i(Pt);fa=r(il,"here"),il.forEach(t),ga=r(Lo,`. Checkpoints were converted
from original Fairseq checkpoints. For more information on the checkpoint conversion, please take a look at the
...
The word embedding parameters. This can be used to initialize `),fo=a(J,"A",{href:!0});var Nl=i(fo);hi=r(Nl,"XLMProphetNetEncoder"),Nl.forEach(t),ui=r(J,` with pre-defined word
embeddings instead of randomly initialized word embeddings.`),J.forEach(t),mi=h(W),S=a(W,"DIV",{class:!0});var Ve=i(S);y(Ct.$$.fragment,Ve),fi=h(Ve),ue=a(Ve,"P",{});var xo=i(ue);gi=r(xo,"The "),go=a(xo,"A",{href:!0});var Ll=i(go);_i=r(Ll,"XLMProphetNetDecoder"),Ll.forEach(t),ki=r(xo," forward method, overrides the "),un=a(xo,"CODE",{});var $l=i(un);vi=r($l,"__call__"),$l.forEach(t),bi=r(xo," special method."),xo.forEach(t),yi=h(Ve),y(Oe.$$.fragment,Ve),Ti=h(Ve),y(je.$$.fragment,Ve),Ve.forEach(t),W.forEach(t),Jn=h(o),me=a(o,"H2",{class:!0});var br=i(me);De=a(br,"A",{id:!0,class:!0,href:!0});var zl=i(De);mn=a(zl,"SPAN",{});var xl=i(mn);y(Ft.$$.fragment,xl),xl.forEach(t),zl.forEach(t),wi=h(br),fn=a(br,"SPAN",{});var Xl=i(fn);Pi=r(Xl,"XLMProphetNetForConditionalGeneration"),Xl.forEach(t),br.forEach(t),Qn=h(o),E=a(o,"DIV",{class:!0});var Q=i(E);y(Ot.$$.fragment,Q),Mi=h(Q),jt=a(Q,"P",{});var yr=i(jt);Ni=r(yr,`The XLMProphetNet Model with a language modeling head. Can be used for sequence generation tasks.
