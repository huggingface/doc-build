...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){c=a("p"),v=n("Examples:"),g=m(),w(f.$$.fragment)},l(l){c=s(l,"P",{});var h=r(c);v=i(h,"Examples:"),h.forEach(t),g=p(l),x(f.$$.fragment,l)},m(l,h){_(l,c,h),e(c,v),_(l,g,h),$(f,l,h),b=!0},p:Bt,i(l){b||(y(f.$$.fragment,l),b=!0)},o(l){T(f.$$.fragment,l),b=!1},d(l){l&&t(c),l&&t(g),B(f,l)}}}function Rh(F){let c,v,g,f,b;return{c(){c=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=r(c);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(h,"CODE",{});var E=r(g);f=i(E,"Module"),E.forEach(t),b=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,v),e(c,g),e(g,f),e(c,b)},d(l){l&&t(c)}}}function Uh(F){let c,v,g,f,b;return f=new Ft({props:{code:`from transformers import BeitFeatureExtractor, BeitForMaskedImageModeling
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])`}}),{c(){c=a("p"),v=n("Example:"),g=m(),w(f.$$.fragment)},l(l){c=s(l,"P",{});var h=r(c);v=i(h,"Example:"),h.forEach(t),g=p(l),x(f.$$.fragment,l)},m(l,h){_(l,c,h),e(c,v),_(l,g,h),$(f,l,h),b=!0},p:Bt,i(l){b||(y(f.$$.fragment,l),b=!0)},o(l){T(f.$$.fragment,l),b=!1},d(l){l&&t(c),l&&t(g),B(f,l)}}}function Gh(F){let c,v,g,f,b,l,h,E,hn,ir,me,Ae,Da,Et,fn,Va,un,lr,W,gn,kt,_n,bn,Mt,vn,wn,It,xn,$n,dr,ea,yn,cr,ta,Wa,Tn,mr,oa,Bn,pr,C,M,Fn,aa,En,kn,sa,Mn,In,jt,jn,Pn,ra,Cn,zn,na,An,qn,ia,Ln,Sn,la,Nn,On,Dn,Pt,Vn,Ct,Wn,Rn,Un,zt,Hn,da,Jn,Gn,Xn,pe,Kn,Ra,Yn,Qn,At,Zn,ei,ti,he,oi,qt,ai,si,Lt,ri,ni,ii,O,li,Ua,di,ci,Ha,mi,pi,ca,hi,fi,Ja,ui,gi,hr,qe,fm,fr,St,_i,ma,bi,ur,R,vi,Nt,wi,xi,Ot,$i,yi,Dt,Ti,Bi,gr,fe,Le,Ga,Vt,Fi,Xa,Ei,_r,ue,Wt,ki,Rt,Mi,pa,Ii,ji,br,ge,Ut,Pi,Ht,Ci,ha,zi,Ai,vr,_e,Se,Ka,Jt,qi,Ya,Li,wr,Z,Gt,Si,be,Ni,fa,Oi,Di,Xt,Vi,Wi,Ri,Ne,xr,ve,Oe,Qa,Kt,Ui,Za,Hi,$r,A,Yt,Ji,es,Gi,Xi,Qt,Ki,ua,Yi,Qi,Zi,ie,Zt,el,ts,tl,ol,De,al,Ve,eo,sl,to,rl,ga,nl,il,yr,we,We,os,oo,ll,as,dl,Tr,ee,ao,cl,so,ml,ro,pl,hl,fl,U,no,ul,xe,gl,_a,_l,bl,ss,vl,wl,xl,Re,$l,Ue,Br,$e,He,rs,io,yl,ns,Tl,Fr,te,lo,Bl,oe,Fl,ba,El,kl,va,Ml,Il,co,jl,Pl,Cl,H,mo,zl,ye,Al,wa,ql,Ll,is,Sl,Nl,Ol,Je,Dl,Ge,Er,Te,Xe,ls,po,Vl,ds,Wl,kr,D,ho,Rl,cs,Ul,Hl,fo,Jl,uo,Gl,Xl,Kl,J,go,Yl,Be,Ql,xa,Zl,ed,ms,td,od,ad,Ke,sd,Ye,Mr,Fe,Qe,ps,_o,rd,hs,nd,Ir,V,bo,id,fs,ld,dd,vo,cd,wo,md,pd,hd,G,xo,fd,Ee,ud,$a,gd,_d,us,bd,vd,wd,Ze,xd,et,jr,ke,tt,gs,$o,$d,_s,yd,Pr,I,yo,Td,bs,Bd,Fd,To,Ed,ya,kd,Md,Id,Bo,jd,Fo,Pd,Cd,zd,vs,Ad,qd,ae,ws,Eo,Ld,Sd,xs,ko,Nd,Od,$s,Mo,Dd,Vd,ys,Io,Wd,Rd,X,jo,Ud,Me,Hd,Ts,Jd,Gd,Bs,Xd,Kd,Yd,ot,Qd,at,Cr,Ie,st,Fs,Po,Zd,Es,ec,zr,j,Co,tc,ks,oc,ac,zo,sc,Ta,rc,nc,ic,Ao,lc,qo,dc,cc,mc,Ms,pc,hc,se,Is,Lo,fc,uc,js,So,gc,_c,Ps,No,bc,vc,Cs,Oo,wc,xc,q,Do,$c,je,yc,zs,Tc,Bc,As,Fc,Ec,kc,rt,Mc,Pe,Ic,qs,jc,Pc,Ls,Cc,zc,Ac,nt,Ar,Ce,it,Ss,Vo,qc,Ns,Lc,qr,P,Wo,Sc,Os,Nc,Oc,Ro,Dc,Ba,Vc,Wc,Rc,Uo,Uc,Ho,Hc,Jc,Gc,Ds,Xc,Kc,re,Vs,Jo,Yc,Qc,Ws,Go,Zc,em,Rs,Xo,tm,om,Us,Ko,am,sm,K,Yo,rm,ze,nm,Hs,im,lm,Js,dm,cm,mm,lt,pm,dt,Lr;return l=new Q({}),Et=new Q({}),Vt=new Q({}),Wt=new k({props:{name:"class transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",parameters:[{name:"last_hidden_state",val:": FloatTensor = None"},{name:"pooler_output",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
set to <code>True</code>.`,name:"size"},{anchor:"transformers.BeitFeatureExtractor.resample",description:`<strong>resample</strong> (<code>int</code>, <em>optional</em>, defaults to <code>PIL.Image.Resampling.BICUBIC</code>) &#x2014;
...
to <code>True</code>.`,name:"resample"},{anchor:"transformers.BeitFeatureExtractor.do_center_crop",description:`<strong>do_center_crop</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/feature_extraction_beit.py#L103",returnDescription:`
<p>A <a
...
None, predictions will not be resized.`,name:"target_sizes"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/feature_extraction_beit.py#L232",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_beit.py#L647",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/model_doc/beit#transformers.models.beit.modeling_beit.BeitModelOutputWithPooling"
>transformers.models.beit.modeling_beit.BeitModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/beit#transformers.BeitConfig"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_beit.py#L746",returnDescription:`
<p>A <a
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_beit.py#L845",returnDescription:`
<p>A <a
...
Ground truth semantic segmentation maps for computing the loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code>, a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_beit.py#L1200",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_flax_beit.py#L749"}}),jo=new k({props:{name:"__call__",anchor:"transformers.FlaxBeitModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"bool_masked_pos",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_flax_beit.py#L635",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/model_doc/beit#transformers.models.beit.modeling_flax_beit.FlaxBeitModelOutputWithPooling"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_flax_beit.py#L833"}}),Do=new k({props:{name:"__call__",anchor:"transformers.FlaxBeitForMaskedImageModeling.__call__",parameters:[{name:"pixel_values",val:""},{name:"bool_masked_pos",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_flax_beit.py#L635",returnDescription:`
<p>A <a
...
`}}),rt=new yt({props:{$$slots:{default:[Rh]},$$scope:{ctx:F}}}),nt=new Tt({props:{anchor:"transformers.FlaxBeitForMaskedImageModeling.__call__.example",$$slots:{default:[Uh]},$$scope:{ctx:F}}}),Vo=new Q({}),Wo=new k({props:{name:"class transformers.FlaxBeitForImageClassification",anchor:"transformers.FlaxBeitForImageClassification",parameters:[{name:"config",val:": BeitConfig"},{name:"input_shape",val:" = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxBeitForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.24.0/en/model_doc/beit#transformers.BeitConfig">BeitConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.24.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_flax_beit.py#L920"}}),Yo=new k({props:{name:"__call__",anchor:"transformers.FlaxBeitForImageClassification.__call__",parameters:[{name:"pixel_values",val:""},{name:"bool_masked_pos",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/beit/modeling_flax_beit.py#L635",returnDescription:`
<p>A <a
...
performing masked image modeling. You can find it `),Ct=a("a"),Wn=n("here"),Rn=n("."),Un=m(),zt=a("li"),Hn=n(`As the BEiT models expect each image to be of the same size (resolution), one can use
...
each checkpoint. For example, `),Ra=a("code"),Yn=n("microsoft/beit-base-patch16-224"),Qn=n(` refers to a base-sized architecture with patch
...
pre-train a model from scratch, one needs to either set the `),Ua=a("code"),di=n("use_relative_position_bias"),ci=n(` or the
...
position embeddings.`),hr=m(),qe=a("img"),fr=m(),St=a("small"),_i=n("BEiT pre-training. Taken from the "),ma=a("a"),bi=n("original paper."),ur=m(),R=a("p"),vi=n("This model was contributed by "),Nt=a("a"),wi=n("nielsr"),xi=n(`. The JAX/FLAX version of this model was
contributed by `),Ot=a("a"),$i=n("kamalkraj"),yi=n(". The original code can be found "),Dt=a("a"),Ti=n("here"),Bi=n("."),gr=m(),fe=a("h2"),Le=a("a"),Ga=a("span"),w(Vt.$$.fragment),Fi=m(),Xa=a("span"),Ei=n("BEiT specific outputs"),_r=m(),ue=a("div"),w(Wt.$$.fragment),ki=m(),Rt=a("p"),Mi=n("Class for outputs of "),pa=a("a"),Ii=n("BeitModel"),ji=n("."),br=m(),ge=a("div"),w(Ut.$$.fragment),Pi=m(),Ht=a("p"),Ci=n("Class for outputs of "),ha=a("a"),zi=n("FlaxBeitModel"),Ai=n("."),vr=m(),_e=a("h2"),Se=a("a"),Ka=a("span"),w(Jt.$$.fragment),qi=m(),Ya=a("span"),Li=n("BeitConfig"),wr=m(),Z=a("div"),w(Gt.$$.fragment),Si=m(),be=a("p"),Ni=n("This is the configuration class to store the configuration of a "),fa=a("a"),Oi=n("BeitModel"),Di=n(`. It is used to instantiate an BEiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BEiT
`),Xt=a("a"),Vi=n("microsoft/beit-base-patch16-224-pt22k"),Wi=n(" architecture."),Ri=m(),w(Ne.$$.fragment),xr=m(),ve=a("h2"),Oe=a("a"),Qa=a("span"),w(Kt.$$.fragment),Ui=m(),Za=a("span"),Hi=n("BeitFeatureExtractor"),$r=m(),A=a("div"),w(Yt.$$.fragment),Ji=m(),es=a("p"),Gi=n("Constructs a BEiT feature extractor."),Xi=m(),Qt=a("p"),Ki=n("This feature extractor inherits from "),ua=a("a"),Yi=n("FeatureExtractionMixin"),Qi=n(` which contains most of
...
behavior.`),fl=m(),U=a("div"),w(no.$$.fragment),ul=m(),xe=a("p"),gl=n("The "),_a=a("a"),_l=n("BeitModel"),bl=n(" forward method, overrides the "),ss=a("code"),vl=n("__call__"),wl=n(" special method."),xl=m(),w(Re.$$.fragment),$l=m(),w(Ue.$$.fragment),Br=m(),$e=a("h2"),He=a("a"),rs=a("span"),w(io.$$.fragment),yl=m(),ns=a("span"),Tl=n("BeitForMaskedImageModeling"),Fr=m(),te=a("div"),w(lo.$$.fragment),Bl=m(),oe=a("p"),Fl=n(`Beit Model transformer with a \u2018language\u2019 modeling head on top. BEiT does masked image modeling by predicting
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cl=m(),H=a("div"),w(mo.$$.fragment),zl=m(),ye=a("p"),Al=n("The "),wa=a("a"),ql=n("BeitForMaskedImageModeling"),Ll=n(" forward method, overrides the "),is=a("code"),Sl=n("__call__"),Nl=n(" special method."),Ol=m(),w(Je.$$.fragment),Dl=m(),w(Ge.$$.fragment),Er=m(),Te=a("h2"),Xe=a("a"),ls=a("span"),w(po.$$.fragment),Vl=m(),ds=a("span"),Wl=n("BeitForImageClassification"),kr=m(),D=a("div"),w(ho.$$.fragment),Rl=m(),cs=a("p"),Ul=n(`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
...
performing masked image modeling. You can find it `),Ct=s(Sr,"A",{href:!0,rel:!0});var $m=r(Ct);Wn=i($m,"here"),$m.forEach(t),Rn=i(Sr,"."),Sr.forEach(t),Un=p(Y),zt=s(Y,"LI",{});var Nr=r(zt);Hn=i(Nr,`As the BEiT models expect each image to be of the same size (resolution), one can use
...
each checkpoint. For example, `),Ra=s(Fa,"CODE",{});var Tm=r(Ra);Yn=i(Tm,"microsoft/beit-base-patch16-224"),Tm.forEach(t),Qn=i(Fa,` refers to a base-sized architecture with patch
...
relative position bias among the several self-attention layers. During fine-tuning, each layer\u2019s relative position
bias is initialized with the shared relative position bias obtained after pre-training. Note that, if one wants to
pre-train a model from scratch, one needs to either set the `),Ua=s(le,"CODE",{});var km=r(Ua);di=i(km,"use_relative_position_bias"),km.forEach(t),ci=i(le,` or the
...
position embeddings.`),le.forEach(t),Y.forEach(t),hr=p(o),qe=s(o,"IMG",{src:!0,alt:!0,width:!0}),fr=p(o),St=s(o,"SMALL",{});var hm=r(St);_i=i(hm,"BEiT pre-training. Taken from the "),ma=s(hm,"A",{href:!0});var Pm=r(ma);bi=i(Pm,"original paper."),Pm.forEach(t),hm.forEach(t),ur=p(o),R=s(o,"P",{});var ct=r(R);vi=i(ct,"This model was contributed by "),Nt=s(ct,"A",{href:!0,rel:!0});var Cm=r(Nt);wi=i(Cm,"nielsr"),Cm.forEach(t),xi=i(ct,`. The JAX/FLAX version of this model was
contributed by `),Ot=s(ct,"A",{href:!0,rel:!0});var zm=r(Ot);$i=i(zm,"kamalkraj"),zm.forEach(t),yi=i(ct,". The original code can be found "),Dt=s(ct,"A",{href:!0,rel:!0});var Am=r(Dt);Ti=i(Am,"here"),Am.forEach(t),Bi=i(ct,"."),ct.forEach(t),gr=p(o),fe=s(o,"H2",{class:!0});var Or=r(fe);Le=s(Or,"A",{id:!0,class:!0,href:!0});var qm=r(Le);Ga=s(qm,"SPAN",{});var Lm=r(Ga);x(Vt.$$.fragment,Lm),Lm.forEach(t),qm.forEach(t),Fi=p(Or),Xa=s(Or,"SPAN",{});var Sm=r(Xa);Ei=i(Sm,"BEiT specific outputs"),Sm.forEach(t),Or.forEach(t),_r=p(o),ue=s(o,"DIV",{class:!0});var Dr=r(ue);x(Wt.$$.fragment,Dr),ki=p(Dr),Rt=s(Dr,"P",{});var Vr=r(Rt);Mi=i(Vr,"Class for outputs of "),pa=s(Vr,"A",{href:!0});var Nm=r(pa);Ii=i(Nm,"BeitModel"),Nm.forEach(t),ji=i(Vr,"."),Vr.forEach(t),Dr.forEach(t),br=p(o),ge=s(o,"DIV",{class:!0});var Wr=r(ge);x(Ut.$$.fragment,Wr),Pi=p(Wr),Ht=s(Wr,"P",{});var Rr=r(Ht);Ci=i(Rr,"Class for outputs of "),ha=s(Rr,"A",{href:!0});var Om=r(ha);zi=i(Om,"FlaxBeitModel"),Om.forEach(t),Ai=i(Rr,"."),Rr.forEach(t),Wr.forEach(t),vr=p(o),_e=s(o,"H2",{class:!0});var Ur=r(_e);Se=s(Ur,"A",{id:!0,class:!0,href:!0});var Dm=r(Se);Ka=s(Dm,"SPAN",{});var Vm=r(Ka);x(Jt.$$.fragment,Vm),Vm.forEach(t),Dm.forEach(t),qi=p(Ur),Ya=s(Ur,"SPAN",{});var Wm=r(Ya);Li=i(Wm,"BeitConfig"),Wm.forEach(t),Ur.forEach(t),wr=p(o),Z=s(o,"DIV",{class:!0});var ka=r(Z);x(Gt.$$.fragment,ka),Si=p(ka),be=s(ka,"P",{});var Ma=r(be);Ni=i(Ma,"This is the configuration class to store the configuration of a "),fa=s(Ma,"A",{href:!0});var Rm=r(fa);Oi=i(Rm,"BeitModel"),Rm.forEach(t),Di=i(Ma,`. It is used to instantiate an BEiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BEiT
`),Xt=s(Ma,"A",{href:!0,rel:!0});var Um=r(Xt);Vi=i(Um,"microsoft/beit-base-patch16-224-pt22k"),Um.forEach(t),Wi=i(Ma," architecture."),Ma.forEach(t),Ri=p(ka),x(Ne.$$.fragment,ka),ka.forEach(t),xr=p(o),ve=s(o,"H2",{class:!0});var Hr=r(ve);Oe=s(Hr,"A",{id:!0,class:!0,href:!0});var Hm=r(Oe);Qa=s(Hm,"SPAN",{});var Jm=r(Qa);x(Kt.$$.fragment,Jm),Jm.forEach(t),Hm.forEach(t),Ui=p(Hr),Za=s(Hr,"SPAN",{});var Gm=r(Za);Hi=i(Gm,"BeitFeatureExtractor"),Gm.forEach(t),Hr.forEach(t),$r=p(o),A=s(o,"DIV",{class:!0});var de=r(A);x(Yt.$$.fragment,de),Ji=p(de),es=s(de,"P",{});var Xm=r(es);Gi=i(Xm,"Constructs a BEiT feature extractor."),Xm.forEach(t),Xi=p(de),Qt=s(de,"P",{});var Jr=r(Qt);Ki=i(Jr,"This feature extractor inherits from "),ua=s(Jr,"A",{href:!0});var Km=r(ua);Yi=i(Km,"FeatureExtractionMixin"),Km.forEach(t),Qi=i(Jr,` which contains most of
