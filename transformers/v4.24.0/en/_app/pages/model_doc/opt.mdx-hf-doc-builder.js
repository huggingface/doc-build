...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=n("p"),v=a("Example:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function Yd(x){let d,v,m,h,T;return{c(){d=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),h=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(c,"CODE",{});var E=i(m);h=r(E,"Module"),E.forEach(t),T=r(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),c.forEach(t)},m(l,c){g(l,d,c),e(d,v),e(d,m),e(m,h),e(d,T)},d(l){l&&t(d)}}}function ec(x){let d,v,m,h,T;return h=new Se({props:{code:`from transformers import GPT2Tokenizer, OPTModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),v=a("Example:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function tc(x){let d,v,m,h,T;return h=new Se({props:{code:`from transformers import GPT2Tokenizer, OPTForCausalLM
...
<span class="hljs-string">&quot;Hey, are you consciours? Can you talk to me?\\nI&#x27;m not consciours, but I can talk to you.&quot;</span>`}}),{c(){d=n("p"),v=a("Example:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function oc(x){let d,v,m,h,T,l,c,E,De,xe,L,ne,ae,F,We,J,Ge,ze,W,Be,re,ie,He,Me,K,Qe,Ee,V,ve,Ue,me,C,A,Ce,G,le,Ke,X,Ve,Ze,N,I,de,ye,Re,ce,be,Je,Y,ke,pe,Xe,se,S,Ye,B,j,et;return{c(){d=n("p"),v=a("TensorFlow models and layers in "),m=n("code"),h=a("transformers"),T=a(" accept two formats as input:"),l=p(),c=n("ul"),E=n("li"),De=a("having all inputs as keyword arguments (like PyTorch models), or"),xe=p(),L=n("li"),ne=a("having all inputs as a list, tuple or dict in the first positional argument."),ae=p(),F=n("p"),We=a(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
format outside of Keras methods like `),ie=n("code"),He=a("fit()"),Me=a(" and "),K=n("code"),Qe=a("predict()"),Ee=a(`, such as when creating your own layers or models with
the Keras `),V=n("code"),ve=a("Functional"),Ue=a(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),de=n("code"),ye=a("model([input_ids, attention_mask])"),Re=a(" or "),ce=n("code"),be=a("model([input_ids, attention_mask, token_type_ids])"),Je=p(),Y=n("li"),ke=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(y){d=s(y,"P",{});var z=i(d);v=r(z,"TensorFlow models and layers in "),m=s(z,"CODE",{});var pt=i(m);h=r(pt,"transformers"),pt.forEach(t),T=r(z," accept two formats as input:"),z.forEach(t),l=u(y),c=s(y,"UL",{});var ee=i(c);E=s(ee,"LI",{});var ut=i(E);De=r(ut,"having all inputs as keyword arguments (like PyTorch models), or"),ut.forEach(t),xe=u(ee),L=s(ee,"LI",{});var ht=i(L);ne=r(ht,"having all inputs as a list, tuple or dict in the first positional argument."),ht.forEach(t),ee.forEach(t),ae=u(y),F=s(y,"P",{});var M=i(F);We=r(M,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),W=s(M,"CODE",{});var ft=i(W);Be=r(ft,"model.fit()"),ft.forEach(t),re=r(M,` supports! If, however, you want to use the second
format outside of Keras methods like `),ie=s(M,"CODE",{});var we=i(ie);He=r(we,"fit()"),we.forEach(t),Me=r(M," and "),K=s(M,"CODE",{});var gt=i(K);Qe=r(gt,"predict()"),gt.forEach(t),Ee=r(M,`, such as when creating your own layers or models with
the Keras `),V=s(M,"CODE",{});var _t=i(V);ve=r(_t,"Functional"),_t.forEach(t),Ue=r(M,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),M.forEach(t),me=u(y),C=s(y,"UL",{});var Z=i(C);A=s(Z,"LI",{});var D=i(A);Ce=r(D,"a single Tensor with "),G=s(D,"CODE",{});var fe=i(G);le=r(fe,"input_ids"),fe.forEach(t),Ke=r(D," only and nothing else: "),X=s(D,"CODE",{});var tt=i(X);Ve=r(tt,"model(input_ids)"),tt.forEach(t),D.forEach(t),Ze=u(Z),N=s(Z,"LI",{});var H=i(N);I=r(H,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(H,"CODE",{});var Tt=i(de);ye=r(Tt,"model([input_ids, attention_mask])"),Tt.forEach(t),Re=r(H," or "),ce=s(H,"CODE",{});var ot=i(ce);be=r(ot,"model([input_ids, attention_mask, token_type_ids])"),ot.forEach(t),H.forEach(t),Je=u(Z),Y=s(Z,"LI",{});var nt=i(Y);ke=r(nt,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),pe=s(nt,"CODE",{});var rt=i(pe);Xe=r(rt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),rt.forEach(t),nt.forEach(t),Z.forEach(t),se=u(y),S=s(y,"P",{});var q=i(S);Ye=r(q,`Note that when creating models and layers with
`),B=s(q,"A",{href:!0,rel:!0});var Pe=i(B);j=r(Pe,"subclassing"),Pe.forEach(t),et=r(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(B,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(B,"rel","nofollow")},m(y,z){g(y,d,z),e(d,v),e(d,m),e(m,h),e(d,T),g(y,l,z),g(y,c,z),e(c,E),e(E,De),e(c,xe),e(c,L),e(L,ne),g(y,ae,z),g(y,F,z),e(F,We),e(F,J),e(J,Ge),e(F,ze),e(F,W),e(W,Be),e(F,re),e(F,ie),e(ie,He),e(F,Me),e(F,K),e(K,Qe),e(F,Ee),e(F,V),e(V,ve),e(F,Ue),g(y,me,z),g(y,C,z),e(C,A),e(A,Ce),e(A,G),e(G,le),e(A,Ke),e(A,X),e(X,Ve),e(C,Ze),e(C,N),e(N,I),e(N,de),e(de,ye),e(N,Re),e(N,ce),e(ce,be),e(C,Je),e(C,Y),e(Y,ke),e(Y,pe),e(pe,Xe),g(y,se,z),g(y,S,z),e(S,Ye),e(S,B),e(B,j),e(S,et)},d(y){y&&t(d),y&&t(l),y&&t(c),y&&t(ae),y&&t(F),y&&t(me),y&&t(C),y&&t(se),y&&t(S)}}}function nc(x){let d,v,m,h,T;return{c(){d=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),h=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(c,"CODE",{});var E=i(m);h=r(E,"Module"),E.forEach(t),T=r(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),c.forEach(t)},m(l,c){g(l,d,c),e(d,v),e(d,m),e(m,h),e(d,T)},d(l){l&&t(d)}}}function sc(x){let d,v,m,h,T;return h=new Se({props:{code:`from transformers import GPT2Tokenizer, TFOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),v=a("Example:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function ac(x){let d,v,m,h,T,l,c,E,De,xe,L,ne,ae,F,We,J,Ge,ze,W,Be,re,ie,He,Me,K,Qe,Ee,V,ve,Ue,me,C,A,Ce,G,le,Ke,X,Ve,Ze,N,I,de,ye,Re,ce,be,Je,Y,ke,pe,Xe,se,S,Ye,B,j,et;return{c(){d=n("p"),v=a("TensorFlow models and layers in "),m=n("code"),h=a("transformers"),T=a(" accept two formats as input:"),l=p(),c=n("ul"),E=n("li"),De=a("having all inputs as keyword arguments (like PyTorch models), or"),xe=p(),L=n("li"),ne=a("having all inputs as a list, tuple or dict in the first positional argument."),ae=p(),F=n("p"),We=a(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),J=n("code"),Ge=a("model.fit()"),ze=a(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),W=n("code"),Be=a("model.fit()"),re=a(` supports! If, however, you want to use the second
format outside of Keras methods like `),ie=n("code"),He=a("fit()"),Me=a(" and "),K=n("code"),Qe=a("predict()"),Ee=a(`, such as when creating your own layers or models with
the Keras `),V=n("code"),ve=a("Functional"),Ue=a(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),pe=s(nt,"CODE",{});var rt=i(pe);Xe=r(rt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),rt.forEach(t),nt.forEach(t),Z.forEach(t),se=u(y),S=s(y,"P",{});var q=i(S);Ye=r(q,`Note that when creating models and layers with
`),B=s(q,"A",{href:!0,rel:!0});var Pe=i(B);j=r(Pe,"subclassing"),Pe.forEach(t),et=r(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(B,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(B,"rel","nofollow")},m(y,z){g(y,d,z),e(d,v),e(d,m),e(m,h),e(d,T),g(y,l,z),g(y,c,z),e(c,E),e(E,De),e(c,xe),e(c,L),e(L,ne),g(y,ae,z),g(y,F,z),e(F,We),e(F,J),e(J,Ge),e(F,ze),e(F,W),e(W,Be),e(F,re),e(F,ie),e(ie,He),e(F,Me),e(F,K),e(K,Qe),e(F,Ee),e(F,V),e(V,ve),e(F,Ue),g(y,me,z),g(y,C,z),e(C,A),e(A,Ce),e(A,G),e(G,le),e(A,Ke),e(A,X),e(X,Ve),e(C,Ze),e(C,N),e(N,I),e(N,de),e(de,ye),e(N,Re),e(N,ce),e(ce,be),e(C,Je),e(C,Y),e(Y,ke),e(Y,pe),e(pe,Xe),g(y,se,z),g(y,S,z),e(S,Ye),e(S,B),e(B,j),e(S,et)},d(y){y&&t(d),y&&t(l),y&&t(c),y&&t(ae),y&&t(F),y&&t(me),y&&t(C),y&&t(se),y&&t(S)}}}function rc(x){let d,v,m,h,T;return h=new Se({props:{code:`from transformers import GPT2Tokenizer, TFOPTForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=n("p"),v=a("Example:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function ic(x){let d,v,m,h,T;return{c(){d=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),h=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(c,"CODE",{});var E=i(m);h=r(E,"Module"),E.forEach(t),T=r(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),c.forEach(t)},m(l,c){g(l,d,c),e(d,v),e(d,m),e(m,h),e(d,T)},d(l){l&&t(d)}}}function lc(x){let d,v,m,h,T;return h=new Se({props:{code:`import torch
...
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=n("p"),v=a("Example of single-label classification:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example of single-label classification:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function dc(x){let d,v;return d=new Se({props:{code:'# To train a model on `num_labels` classes, you can pass `num_labels=num_labels` to `.from_pretrained(...)`\nnum_labels = len(model.config.id2label)\nmodel = OPTForSequenceClassification.from_pretrained("ArthurZ/opt-350m-dummy-sc", num_labels=num_labels)\n\nlabels = torch.tensor([1])\nloss = model(**inputs, labels=labels).loss\nround(loss.item(), 2)',highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`</span>
...
<span class="hljs-number">1.71</span>`}}),{c(){b(d.$$.fragment)},l(m){k(d.$$.fragment,m)},m(m,h){w(d,m,h),v=!0},p:Ie,i(m){v||(P(d.$$.fragment,m),v=!0)},o(m){$(d.$$.fragment,m),v=!1},d(m){O(d,m)}}}function cc(x){let d,v,m,h,T;return h=new Se({props:{code:`import torch
from transformers import GPT2Tokenizer, OPTForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=n("p"),v=a("Example of multi-label classification:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example of multi-label classification:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function pc(x){let d,v;return d=new Se({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){b(d.$$.fragment)},l(m){k(d.$$.fragment,m)},m(m,h){w(d,m,h),v=!0},p:Ie,i(m){v||(P(d.$$.fragment,m),v=!0)},o(m){$(d.$$.fragment,m),v=!1},d(m){O(d,m)}}}function uc(x){let d,v,m,h,T;return{c(){d=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),h=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(c,"CODE",{});var E=i(m);h=r(E,"Module"),E.forEach(t),T=r(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),c.forEach(t)},m(l,c){g(l,d,c),e(d,v),e(d,m),e(m,h),e(d,T)},d(l){l&&t(d)}}}function hc(x){let d,v,m,h,T;return h=new Se({props:{code:`from transformers import GPT2Tokenizer, OPTForQuestionAnswering
import torch
...
<span class="hljs-string">&#x27; Henson?&#x27;</span>`}}),{c(){d=n("p"),v=a("Example:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function mc(x){let d,v,m,h,T;return h=new Se({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),v=a("Example:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function fc(x){let d,v,m,h,T;return h=new Se({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=n("p"),v=a("Example:"),m=p(),b(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);v=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,v),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function gc(x){let d,v,m,h,T,l,c,E,De,xe,L,ne,ae,F,We,J,Ge,ze,W,Be,re,ie,He,Me,K,Qe,Ee,V,ve,Ue,me,C,A,Ce,G,le,Ke,X,Ve,Ze,N,I,de,ye,Re,ce,be,Je,Y,ke,pe,Xe,se,S,Ye,B,j,et,y,z,pt,ee,ut,ht,M,mt,ft,we,gt,_t,Z,D,fe,tt,H,Tt,ot,nt,rt,q,Pe,wa,vt,Pa,Tn,$a,Oa,vo,Fa,xa,za,yt,Ma,vn,Ea,Ca,yn,qa,ja,La,At,qs,bt,Nt,Wn,yo,Aa,Gn,Na,js,$e,bo,Ia,ko,Sa,bn,Da,Wa,Ga,wo,Ba,Po,Ha,Qa,Ua,qe,$o,Ka,kt,Va,kn,Za,Ra,Bn,Ja,Xa,Ya,It,er,St,Ls,wt,Dt,Hn,Oo,tr,Qn,or,As,Pt,Fo,nr,Wt,xo,sr,Gt,Ns,$t,Bt,Un,zo,ar,Kn,rr,Is,ue,Mo,ir,Eo,lr,wn,dr,cr,pr,Co,ur,qo,hr,mr,fr,Ht,gr,je,jo,_r,Ot,Tr,Pn,vr,yr,Vn,br,kr,wr,Qt,Pr,Ut,Ss,Ft,Kt,Zn,Lo,$r,Rn,Or,Ds,te,Ao,Fr,Jn,xr,zr,No,Mr,$n,Er,Cr,qr,Io,jr,So,Lr,Ar,Nr,Vt,Ir,Zt,Do,Sr,Rt,Ws,xt,Jt,Xn,Wo,Dr,Yn,Wr,Gs,Q,Go,Gr,es,Br,Hr,On,Fn,Qr,Ur,Kr,Oe,Vr,ts,Zr,Rr,os,Jr,Xr,ns,Yr,ei,ss,ti,oi,ni,Bo,si,xn,ai,ri,ii,Ho,li,Qo,di,ci,pi,R,Uo,ui,zt,hi,zn,mi,fi,as,gi,_i,Ti,Xt,vi,Yt,yi,eo,bi,to,ki,oo,Bs,Mt,no,rs,Ko,wi,is,Pi,Hs,he,Vo,$i,Et,Oi,ls,Fi,xi,ds,zi,Mi,Ei,Zo,Ci,Mn,qi,ji,Li,Ro,Ai,Jo,Ni,Ii,Si,Le,Xo,Di,Ct,Wi,En,Gi,Bi,cs,Hi,Qi,Ui,so,Ki,ao,Qs,qt,ro,ps,Yo,Vi,us,Zi,Us,jt,en,Ri,io,tn,Ji,lo,Ks,Lt,co,hs,on,Xi,ms,Yi,Vs,U,nn,el,fs,tl,ol,sn,nl,Cn,sl,al,rl,an,il,rn,ll,dl,cl,gs,pl,ul,st,_s,ln,hl,ml,Ts,dn,fl,gl,vs,cn,_l,Tl,ys,pn,vl,yl,po,un,bl,uo,Zs;return l=new at({}),F=new at({}),H=new at({}),Pe=new oe({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"max_position_embeddings",val:" = 2048"},{name:"do_layer_norm_before",val:" = True"},{name:"_remove_final_layer_norm",val:" = False"},{name:"word_embed_proj_dim",val:" = None"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"num_attention_heads",val:" = 12"},{name:"activation_function",val:" = 'relu'"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
Vocabulary size of the OPT model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.24.0/en/model_doc/opt#transformers.OPTModel">OPTModel</a>`,name:"vocab_size"},{anchor:"transformers.OPTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p>Indices can be obtained using <code>OPTTokenizer</code>. See <a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.24.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/opt/modeling_opt.py#L751",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.24.0/en/model_doc/opt#transformers.OPTConfig"
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/opt/modeling_opt.py#L834",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/opt/modeling_tf_opt.py#L799",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Whether or not to return a <a href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/opt/modeling_tf_opt.py#L898",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/opt/modeling_opt.py#L1014",returnDescription:`
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.24.0/src/transformers/models/opt/modeling_opt.py#L1136",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/v4.24.0/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),uo=new Ne({props:{anchor:"transformers.FlaxOPTForCausalLM.__call__.example",$$slots:{default:[fc]},$$scope:{ctx:x}}}),{c(){d=n("meta"),v=p(),m=n("h1"),h=n("a"),T=n("span"),b(l.$$.fragment),c=p(),E=n("span"),De=a("OPT"),xe=p(),L=n("h2"),ne=n("a"),ae=n("span"),b(F.$$.fragment),We=p(),J=n("span"),Ge=a("Overview"),ze=p(),W=n("p"),Be=a("The OPT model was proposed in "),re=n("a"),ie=a("Open Pre-trained Transformer Language Models"),He=a(` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),Me=p(),K=n("p"),Qe=a("The abstract from the paper is the following:"),Ee=p(),V=n("p"),ve=n("em"),Ue=a("Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),me=p(),C=n("p"),A=a("Tips:"),Ce=p(),G=n("ul"),le=n("li"),Ke=a("OPT has the same architecture as "),X=n("code"),Ve=a("BartDecoder"),Ze=a("."),N=p(),I=n("li"),de=a("Contrary to GPT2, OPT adds the EOS token "),ye=n("code"),Re=a("</s>"),ce=a(" to the beginning of every prompt. "),be=n("strong"),Je=a("Note"),Y=a(": Make sure to pass "),ke=n("code"),pe=a("use_fast=False"),Xe=a(" when loading OPT\u2019s tokenizer with "),se=n("a"),S=a("AutoTokenizer"),Ye=a(" to get the correct tokenizer."),B=p(),j=n("p"),et=a("This model was contributed by "),y=n("a"),z=a("Arthur Zucker"),pt=a(", "),ee=n("a"),ut=a("Younes Belkada"),ht=a(", and "),M=n("a"),mt=a("Patrick Von Platen"),ft=a(`.
The original code can be found `),we=n("a"),gt=a("here"),_t=a("."),Z=p(),D=n("h2"),fe=n("a"),tt=n("span"),b(H.$$.fragment),Tt=p(),ot=n("span"),nt=a("OPTConfig"),rt=p(),q=n("div"),b(Pe.$$.fragment),wa=p(),vt=n("p"),Pa=a("This is the configuration class to store the configuration of a "),Tn=n("a"),$a=a("OPTModel"),Oa=a(`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
`),vo=n("a"),Fa=a("facebook/opt-350m"),xa=a(" architecture."),za=p(),yt=n("p"),Ma=a("Configuration objects inherit from "),vn=n("a"),Ea=a("PretrainedConfig"),Ca=a(` and can be used to control the model outputs. Read the
documentation from `),yn=n("a"),qa=a("PretrainedConfig"),ja=a(" for more information."),La=p(),b(At.$$.fragment),qs=p(),bt=n("h2"),Nt=n("a"),Wn=n("span"),b(yo.$$.fragment),Aa=p(),Gn=n("span"),Na=a("OPTModel"),js=p(),$e=n("div"),b(bo.$$.fragment),Ia=p(),ko=n("p"),Sa=a(`The bare OPT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),bn=n("a"),Da=a("PreTrainedModel"),Wa=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ga=p(),wo=n("p"),Ba=a("This model is also a PyTorch "),Po=n("a"),Ha=a("torch.nn.Module"),Qa=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ua=p(),qe=n("div"),b($o.$$.fragment),Ka=p(),kt=n("p"),Va=a("The "),kn=n("a"),Za=a("OPTModel"),Ra=a(" forward method, overrides the "),Bn=n("code"),Ja=a("__call__"),Xa=a(" special method."),Ya=p(),b(It.$$.fragment),er=p(),b(St.$$.fragment),Ls=p(),wt=n("h2"),Dt=n("a"),Hn=n("span"),b(Oo.$$.fragment),tr=p(),Qn=n("span"),or=a("OPTForCausalLM"),As=p(),Pt=n("div"),b(Fo.$$.fragment),nr=p(),Wt=n("div"),b(xo.$$.fragment),sr=p(),b(Gt.$$.fragment),Ns=p(),$t=n("h2"),Bt=n("a"),Un=n("span"),b(zo.$$.fragment),ar=p(),Kn=n("span"),rr=a("TFOPTModel"),Is=p(),ue=n("div"),b(Mo.$$.fragment),ir=p(),Eo=n("p"),lr=a(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),fr=p(),b(Ht.$$.fragment),gr=p(),je=n("div"),b(jo.$$.fragment),_r=p(),Ot=n("p"),Tr=a("The "),Pn=n("a"),vr=a("TFOPTModel"),yr=a(" forward method, overrides the "),Vn=n("code"),br=a("__call__"),kr=a(" special method."),wr=p(),b(Qt.$$.fragment),Pr=p(),b(Ut.$$.fragment),Ss=p(),Ft=n("h2"),Kt=n("a"),Zn=n("span"),b(Lo.$$.fragment),$r=p(),Rn=n("span"),Or=a("TFOPTForCausalLM"),Ds=p(),te=n("div"),b(Ao.$$.fragment),Fr=p(),Jn=n("p"),xr=a("The OPT Model transformer with a language modeling head on top."),zr=p(),No=n("p"),Mr=a("This model inherits from "),$n=n("a"),Er=a("TFPreTrainedModel"),Cr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qr=p(),Io=n("p"),jr=a("This model is also a "),So=n("a"),Lr=a("tf.keras.Model"),Ar=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nr=p(),b(Vt.$$.fragment),Ir=p(),Zt=n("div"),b(Do.$$.fragment),Sr=p(),b(Rt.$$.fragment),Ws=p(),xt=n("h2"),Jt=n("a"),Xn=n("span"),b(Wo.$$.fragment),Dr=p(),Yn=n("span"),Wr=a("OPTForSequenceClassification"),Gs=p(),Q=n("div"),b(Go.$$.fragment),Gr=p(),es=n("p"),Br=a("The OPT Model transformer with a sequence classification head on top (linear layer)."),Hr=p(),On=n("p"),Fn=n("a"),Qr=a("OPTForSequenceClassification"),Ur=a(` uses the last token in order to do the classification, as other causal models
...
each row of the batch).`),ni=p(),Bo=n("p"),si=a("This model inherits from "),xn=n("a"),ai=a("PreTrainedModel"),ri=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ii=p(),Ho=n("p"),li=a("This model is also a PyTorch "),Qo=n("a"),di=a("torch.nn.Module"),ci=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=p(),R=n("div"),b(Uo.$$.fragment),ui=p(),zt=n("p"),hi=a("The "),zn=n("a"),mi=a("OPTForSequenceClassification"),fi=a(" forward method, overrides the "),as=n("code"),gi=a("__call__"),_i=a(" special method."),Ti=p(),b(Xt.$$.fragment),vi=p(),b(Yt.$$.fragment),yi=p(),b(eo.$$.fragment),bi=p(),b(to.$$.fragment),ki=p(),b(oo.$$.fragment),Bs=p(),Mt=n("h2"),no=n("a"),rs=n("span"),b(Ko.$$.fragment),wi=p(),is=n("span"),Pi=a("OPTForQuestionAnswering"),Hs=p(),he=n("div"),b(Vo.$$.fragment),$i=p(),Et=n("p"),Oi=a(`The OPT Model transformer with a span classification head on top for extractive question-answering tasks like SQuAD
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Si=p(),Le=n("div"),b(Xo.$$.fragment),Di=p(),Ct=n("p"),Wi=a("The "),En=n("a"),Gi=a("OPTForQuestionAnswering"),Bi=a(" forward method, overrides the "),cs=n("code"),Hi=a("__call__"),Qi=a(" special method."),Ui=p(),b(so.$$.fragment),Ki=p(),b(ao.$$.fragment),Qs=p(),qt=n("h2"),ro=n("a"),ps=n("span"),b(Yo.$$.fragment),Vi=p(),us=n("span"),Zi=a("FlaxOPTModel"),Us=p(),jt=n("div"),b(en.$$.fragment),Ri=p(),io=n("div"),b(tn.$$.fragment),Ji=p(),b(lo.$$.fragment),Ks=p(),Lt=n("h2"),co=n("a"),hs=n("span"),b(on.$$.fragment),Xi=p(),ms=n("span"),Yi=a("FlaxOPTForCausalLM"),Vs=p(),U=n("div"),b(nn.$$.fragment),el=p(),fs=n("p"),tl=a(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),cl=p(),gs=n("p"),pl=a("Finally, this model supports inherent JAX features such as:"),ul=p(),st=n("ul"),_s=n("li"),ln=n("a"),hl=a("Just-In-Time (JIT) compilation"),ml=p(),Ts=n("li"),dn=n("a"),fl=a("Automatic Differentiation"),gl=p(),vs=n("li"),cn=n("a"),_l=a("Vectorization"),Tl=p(),ys=n("li"),pn=n("a"),vl=a("Parallelization"),yl=p(),po=n("div"),b(un.$$.fragment),bl=p(),b(uo.$$.fragment),this.h()},l(o){const _=Rd('[data-svelte="svelte-1phssyn"]',document.head);d=s(_,"META",{name:!0,content:!0}),_.forEach(t),v=u(o),m=s(o,"H1",{class:!0});var hn=i(m);h=s(hn,"A",{id:!0,class:!0,href:!0});var bs=i(h);T=s(bs,"SPAN",{});var ks=i(T);k(l.$$.fragment,ks),ks.forEach(t),bs.forEach(t),c=u(hn),E=s(hn,"SPAN",{});var ws=i(E);De=r(ws,"OPT"),ws.forEach(t),hn.forEach(t),xe=u(o),L=s(o,"H2",{class:!0});var mn=i(L);ne=s(mn,"A",{id:!0,class:!0,href:!0});var Ps=i(ne);ae=s(Ps,"SPAN",{});var $s=i(ae);k(F.$$.fragment,$s),$s.forEach(t),Ps.forEach(t),We=u(mn),J=s(mn,"SPAN",{});var Os=i(J);Ge=r(Os,"Overview"),Os.forEach(t),mn.forEach(t),ze=u(o),W=s(o,"P",{});var fn=i(W);Be=r(fn,"The OPT model was proposed in "),re=s(fn,"A",{href:!0,rel:!0});var Fs=i(re);ie=r(Fs,"Open Pre-trained Transformer Language Models"),Fs.forEach(t),He=r(fn,` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),fn.forEach(t),Me=u(o),K=s(o,"P",{});var xs=i(K);Qe=r(xs,"The abstract from the paper is the following:"),xs.forEach(t),Ee=u(o),V=s(o,"P",{});var zs=i(V);ve=s(zs,"EM",{});var Ms=i(ve);Ue=r(Ms,"Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),Ms.forEach(t),zs.forEach(t),me=u(o),C=s(o,"P",{});var Es=i(C);A=r(Es,"Tips:"),Es.forEach(t),Ce=u(o),G=s(o,"UL",{});var gn=i(G);le=s(gn,"LI",{});var _n=i(le);Ke=r(_n,"OPT has the same architecture as "),X=s(_n,"CODE",{});var Cs=i(X);Ve=r(Cs,"BartDecoder"),Cs.forEach(t),Ze=r(_n,"."),_n.forEach(t),N=u(gn),I=s(gn,"LI",{});var Fe=i(I);de=r(Fe,"Contrary to GPT2, OPT adds the EOS token "),ye=s(Fe,"CODE",{});var wl=i(ye);Re=r(wl,"</s>"),wl.forEach(t),ce=r(Fe," to the beginning of every prompt. "),be=s(Fe,"STRONG",{});var Pl=i(be);Je=r(Pl,"Note"),Pl.forEach(t),Y=r(Fe,": Make sure to pass "),ke=s(Fe,"CODE",{});var $l=i(ke);pe=r($l,"use_fast=False"),$l.forEach(t),Xe=r(Fe," when loading OPT\u2019s tokenizer with "),se=s(Fe,"A",{href:!0});var Ol=i(se);S=r(Ol,"AutoTokenizer"),Ol.forEach(t),Ye=r(Fe," to get the correct tokenizer."),Fe.forEach(t),gn.forEach(t),B=u(o),j=s(o,"P",{});var it=i(j);et=r(it,"This model was contributed by "),y=s(it,"A",{href:!0,rel:!0});var Fl=i(y);z=r(Fl,"Arthur Zucker"),Fl.forEach(t),pt=r(it,", "),ee=s(it,"A",{href:!0,rel:!0});var xl=i(ee);ut=r(xl,"Younes Belkada"),xl.forEach(t),ht=r(it,", and "),M=s(it,"A",{href:!0,rel:!0});var zl=i(M);mt=r(zl,"Patrick Von Platen"),zl.forEach(t),ft=r(it,`.
The original code can be found `),we=s(it,"A",{href:!0,rel:!0});var Ml=i(we);gt=r(Ml,"here"),Ml.forEach(t),_t=r(it,"."),it.forEach(t),Z=u(o),D=s(o,"H2",{class:!0});var Rs=i(D);fe=s(Rs,"A",{id:!0,class:!0,href:!0});var El=i(fe);tt=s(El,"SPAN",{});var Cl=i(tt);k(H.$$.fragment,Cl),Cl.forEach(t),El.forEach(t),Tt=u(Rs),ot=s(Rs,"SPAN",{});var ql=i(ot);nt=r(ql,"OPTConfig"),ql.forEach(t),Rs.forEach(t),rt=u(o),q=s(o,"DIV",{class:!0});var ho=i(q);k(Pe.$$.fragment,ho),wa=u(ho),vt=s(ho,"P",{});var qn=i(vt);Pa=r(qn,"This is the configuration class to store the configuration of a "),Tn=s(qn,"A",{href:!0});var jl=i(Tn);$a=r(jl,"OPTModel"),jl.forEach(t),Oa=r(qn,`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
`),vo=s(qn,"A",{href:!0,rel:!0});var Ll=i(vo);Fa=r(Ll,"facebook/opt-350m"),Ll.forEach(t),xa=r(qn," architecture."),qn.forEach(t),za=u(ho),yt=s(ho,"P",{});var jn=i(yt);Ma=r(jn,"Configuration objects inherit from "),vn=s(jn,"A",{href:!0});var Al=i(vn);Ea=r(Al,"PretrainedConfig"),Al.forEach(t),Ca=r(jn,` and can be used to control the model outputs. Read the
documentation from `),yn=s(jn,"A",{href:!0});var Nl=i(yn);qa=r(Nl,"PretrainedConfig"),Nl.forEach(t),ja=r(jn," for more information."),jn.forEach(t),La=u(ho),k(At.$$.fragment,ho),ho.forEach(t),qs=u(o),bt=s(o,"H2",{class:!0});var Js=i(bt);Nt=s(Js,"A",{id:!0,class:!0,href:!0});var Il=i(Nt);Wn=s(Il,"SPAN",{});var Sl=i(Wn);k(yo.$$.fragment,Sl),Sl.forEach(t),Il.forEach(t),Aa=u(Js),Gn=s(Js,"SPAN",{});var Dl=i(Gn);Na=r(Dl,"OPTModel"),Dl.forEach(t),Js.forEach(t),js=u(o),$e=s(o,"DIV",{class:!0});var mo=i($e);k(bo.$$.fragment,mo),Ia=u(mo),ko=s(mo,"P",{});var Xs=i(ko);Sa=r(Xs,`The bare OPT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),bn=s(Xs,"A",{href:!0});var Wl=i(bn);Da=r(Wl,"PreTrainedModel"),Wl.forEach(t),Wa=r(Xs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xs.forEach(t),Ga=u(mo),wo=s(mo,"P",{});var Ys=i(wo);Ba=r(Ys,"This model is also a PyTorch "),Po=s(Ys,"A",{href:!0,rel:!0});var Gl=i(Po);Ha=r(Gl,"torch.nn.Module"),Gl.forEach(t),Qa=r(Ys,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),Ua=u(mo),qe=s(mo,"DIV",{class:!0});var fo=i(qe);k($o.$$.fragment,fo),Ka=u(fo),kt=s(fo,"P",{});var Ln=i(kt);Va=r(Ln,"The "),kn=s(Ln,"A",{href:!0});var Bl=i(kn);Za=r(Bl,"OPTModel"),Bl.forEach(t),Ra=r(Ln," forward method, overrides the "),Bn=s(Ln,"CODE",{});var Hl=i(Bn);Ja=r(Hl,"__call__"),Hl.forEach(t),Xa=r(Ln," special method."),Ln.forEach(t),Ya=u(fo),k(It.$$.fragment,fo),er=u(fo),k(St.$$.fragment,fo),fo.forEach(t),mo.forEach(t),Ls=u(o),wt=s(o,"H2",{class:!0});var ea=i(wt);Dt=s(ea,"A",{id:!0,class:!0,href:!0});var Ql=i(Dt);Hn=s(Ql,"SPAN",{});var Ul=i(Hn);k(Oo.$$.fragment,Ul),Ul.forEach(t),Ql.forEach(t),tr=u(ea),Qn=s(ea,"SPAN",{});var Kl=i(Qn);or=r(Kl,"OPTForCausalLM"),Kl.forEach(t),ea.forEach(t),As=u(o),Pt=s(o,"DIV",{class:!0});var ta=i(Pt);k(Fo.$$.fragment,ta),nr=u(ta),Wt=s(ta,"DIV",{class:!0});var oa=i(Wt);k(xo.$$.fragment,oa),sr=u(oa),k(Gt.$$.fragment,oa),oa.forEach(t),ta.forEach(t),Ns=u(o),$t=s(o,"H2",{class:!0});var na=i($t);Bt=s(na,"A",{id:!0,class:!0,href:!0});var Vl=i(Bt);Un=s(Vl,"SPAN",{});var Zl=i(Un);k(zo.$$.fragment,Zl),Zl.forEach(t),Vl.forEach(t),ar=u(na),Kn=s(na,"SPAN",{});var Rl=i(Kn);rr=r(Rl,"TFOPTModel"),Rl.forEach(t),na.forEach(t),Is=u(o),ue=s(o,"DIV",{class:!0});var lt=i(ue);k(Mo.$$.fragment,lt),ir=u(lt),Eo=s(lt,"P",{});var sa=i(Eo);lr=r(sa,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),la.forEach(t),Nr=u(Ae),k(Vt.$$.fragment,Ae),Ir=u(Ae),Zt=s(Ae,"DIV",{class:!0});var da=i(Zt);k(Do.$$.fragment,da),Sr=u(da),k(Rt.$$.fragment,da),da.forEach(t),Ae.forEach(t),Ws=u(o),xt=s(o,"H2",{class:!0});var ca=i(xt);Jt=s(ca,"A",{id:!0,class:!0,href:!0});var id=i(Jt);Xn=s(id,"SPAN",{});var ld=i(Xn);k(Wo.$$.fragment,ld),ld.forEach(t),id.forEach(t),Dr=u(ca),Yn=s(ca,"SPAN",{});var dd=i(Yn);Wr=r(dd,"OPTForSequenceClassification"),dd.forEach(t),ca.forEach(t),Gs=u(o),Q=s(o,"DIV",{class:!0});var ge=i(Q);k(Go.$$.fragment,ge),Gr=u(ge),es=s(ge,"P",{});var cd=i(es);Br=r(cd,"The OPT Model transformer with a sequence classification head on top (linear layer)."),cd.forEach(t),Hr=u(ge),On=s(ge,"P",{});var kl=i(On);Fn=s(kl,"A",{href:!0});var pd=i(Fn);Qr=r(pd,"OPTForSequenceClassification"),pd.forEach(t),Ur=r(kl,` uses the last token in order to do the classification, as other causal models
...
each row of the batch).`),dt.forEach(t),ni=u(ge),Bo=s(ge,"P",{});var pa=i(Bo);si=r(pa,"This model inherits from "),xn=s(pa,"A",{href:!0});var gd=i(xn);ai=r(gd,"PreTrainedModel"),gd.forEach(t),ri=r(pa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pa.forEach(t),ii=u(ge),Ho=s(ge,"P",{});var ua=i(Ho);li=r(ua,"This model is also a PyTorch "),Qo=s(ua,"A",{href:!0,rel:!0});var _d=i(Qo);di=r(_d,"torch.nn.Module"),_d.forEach(t),ci=r(ua,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ua.forEach(t),pi=u(ge),R=s(ge,"DIV",{class:!0});var _e=i(R);k(Uo.$$.fragment,_e),ui=u(_e),zt=s(_e,"P",{});var Nn=i(zt);hi=r(Nn,"The "),zn=s(Nn,"A",{href:!0});var Td=i(zn);mi=r(Td,"OPTForSequenceClassification"),Td.forEach(t),fi=r(Nn," forward method, overrides the "),as=s(Nn,"CODE",{});var vd=i(as);gi=r(vd,"__call__"),vd.forEach(t),_i=r(Nn," special method."),Nn.forEach(t),Ti=u(_e),k(Xt.$$.fragment,_e),vi=u(_e),k(Yt.$$.fragment,_e),yi=u(_e),k(eo.$$.fragment,_e),bi=u(_e),k(to.$$.fragment,_e),ki=u(_e),k(oo.$$.fragment,_e),_e.forEach(t),ge.forEach(t),Bs=u(o),Mt=s(o,"H2",{class:!0});var ha=i(Mt);no=s(ha,"A",{id:!0,class:!0,href:!0});var yd=i(no);rs=s(yd,"SPAN",{});var bd=i(rs);k(Ko.$$.fragment,bd),bd.forEach(t),yd.forEach(t),wi=u(ha),is=s(ha,"SPAN",{});var kd=i(is);Pi=r(kd,"OPTForQuestionAnswering"),kd.forEach(t),ha.forEach(t),Hs=u(o),he=s(o,"DIV",{class:!0});var ct=i(he);k(Vo.$$.fragment,ct),$i=u(ct),Et=s(ct,"P",{});var In=i(Et);Oi=r(In,`The OPT Model transformer with a span classification head on top for extractive question-answering tasks like SQuAD
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fa.forEach(t),Si=u(ct),Le=s(ct,"DIV",{class:!0});var _o=i(Le);k(Xo.$$.fragment,_o),Di=u(_o),Ct=s(_o,"P",{});var Sn=i(Ct);Wi=r(Sn,"The "),En=s(Sn,"A",{href:!0});var Fd=i(En);Gi=r(Fd,"OPTForQuestionAnswering"),Fd.forEach(t),Bi=r(Sn," forward method, overrides the "),cs=s(Sn,"CODE",{});var xd=i(cs);Hi=r(xd,"__call__"),xd.forEach(t),Qi=r(Sn," special method."),Sn.forEach(t),Ui=u(_o),k(so.$$.fragment,_o),Ki=u(_o),k(ao.$$.fragment,_o),_o.forEach(t),ct.forEach(t),Qs=u(o),qt=s(o,"H2",{class:!0});var ga=i(qt);ro=s(ga,"A",{id:!0,class:!0,href:!0});var zd=i(ro);ps=s(zd,"SPAN",{});var Md=i(ps);k(Yo.$$.fragment,Md),Md.forEach(t),zd.forEach(t),Vi=u(ga),us=s(ga,"SPAN",{});var Ed=i(us);Zi=r(Ed,"FlaxOPTModel"),Ed.forEach(t),ga.forEach(t),Us=u(o),jt=s(o,"DIV",{class:!0});var _a=i(jt);k(en.$$.fragment,_a),Ri=u(_a),io=s(_a,"DIV",{class:!0});var Ta=i(io);k(tn.$$.fragment,Ta),Ji=u(Ta),k(lo.$$.fragment,Ta),Ta.forEach(t),_a.forEach(t),Ks=u(o),Lt=s(o,"H2",{class:!0});var va=i(Lt);co=s(va,"A",{id:!0,class:!0,href:!0});var Cd=i(co);hs=s(Cd,"SPAN",{});var qd=i(hs);k(on.$$.fragment,qd),qd.forEach(t),Cd.forEach(t),Xi=u(va),ms=s(va,"SPAN",{});var jd=i(ms);Yi=r(jd,"FlaxOPTForCausalLM"),jd.forEach(t),va.forEach(t),Vs=u(o),U=s(o,"DIV",{class:!0});var Te=i(U);k(nn.$$.fragment,Te),el=u(Te),fs=s(Te,"P",{});var Ld=i(fs);tl=r(Ld,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
autoregressive tasks.`),Ld.forEach(t),ol=u(Te),sn=s(Te,"P",{});var ya=i(sn);nl=r(ya,"This model inherits from "),Cn=s(ya,"A",{href:!0});var Ad=i(Cn);sl=r(Ad,"FlaxPreTrainedModel"),Ad.forEach(t),al=r(ya,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ya.forEach(t),rl=u(Te),an=s(Te,"P",{});var ba=i(an);il=r(ba,`This model is also a Flax Linen
`),rn=s(ba,"A",{href:!0,rel:!0});var Nd=i(rn);ll=r(Nd,"flax.nn.Module"),Nd.forEach(t),dl=r(ba,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ba.forEach(t),cl=u(Te),gs=s(Te,"P",{});var Id=i(gs);pl=r(Id,"Finally, this model supports inherent JAX features such as:"),Id.forEach(t),ul=u(Te),st=s(Te,"UL",{});var To=i(st);_s=s(To,"LI",{});var Sd=i(_s);ln=s(Sd,"A",{href:!0,rel:!0});var Dd=i(ln);hl=r(Dd,"Just-In-Time (JIT) compilation"),Dd.forEach(t),Sd.forEach(t),ml=u(To),Ts=s(To,"LI",{});var Wd=i(Ts);dn=s(Wd,"A",{href:!0,rel:!0});var Gd=i(dn);fl=r(Gd,"Automatic Differentiation"),Gd.forEach(t),Wd.forEach(t),gl=u(To),vs=s(To,"LI",{});var Bd=i(vs);cn=s(Bd,"A",{href:!0,rel:!0});var Hd=i(cn);_l=r(Hd,"Vectorization"),Hd.forEach(t),Bd.forEach(t),Tl=u(To),ys=s(To,"LI",{});var Qd=i(ys);pn=s(Qd,"A",{href:!0,rel:!0});var Ud=i(pn);vl=r(Ud,"Parallelization"),Ud.forEach(t),Qd.forEach(t),To.forEach(t),yl=u(Te),po=s(Te,"DIV",{class:!0});var ka=i(po);k(un.$$.fragment,ka),bl=u(ka),k(uo.$$.fragment,ka),ka.forEach(t),Te.forEach(t),this.h()},h(){f(d,"name","hf:doc:metadata"),f(d,"content",JSON.stringify(_c)),f(h,"id","opt"),f(h,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(h,"href","#opt"),f(m,"class","relative group"),f(ne,"id","overview"),f(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(ne,"href","#overview"),f(L,"class","relative group"),f(re,"href","https://arxiv.org/pdf/2205.01068"),f(re,"rel","nofollow"),f(se,"href","/docs/transformers/v4.24.0/en/model_doc/auto#transformers.AutoTokenizer"),f(y,"href","https://huggingface.co/ArthurZ"),f(y,"rel","nofollow"),f(ee,"href","https://huggingface.co/ybelkada"),f(ee,"rel","nofollow"),f(M,"href","https://huggingface.co/patrickvonplaten"),f(M,"rel","nofollow"),f(we,"href","https://github.com/facebookresearch/metaseq"),f(we,"rel","nofollow"),f(fe,"id","transformers.OPTConfig"),f(fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(fe,"href","#transformers.OPTConfig"),f(D,"class","relative group"),f(Tn,"href","/docs/transformers/v4.24.0/en/model_doc/opt#transformers.OPTModel"),f(vo,"href","https://huggingface.co/facebook/opt-350m"),f(vo,"rel","nofollow"),f(vn,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),f(yn,"href","/docs/transformers/v4.24.0/en/main_classes/configuration#transformers.PretrainedConfig"),f(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Nt,"id","transformers.OPTModel"),f(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Nt,"href","#transformers.OPTModel"),f(bt,"class","relative group"),f(bn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),f(Po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Po,"rel","nofollow"),f(kn,"href","/docs/transformers/v4.24.0/en/model_doc/opt#transformers.OPTModel"),f(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Dt,"id","transformers.OPTForCausalLM"),f(Dt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Dt,"href","#transformers.OPTForCausalLM"),f(wt,"class","relative group"),f(Wt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Bt,"id","transformers.TFOPTModel"),f(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Bt,"href","#transformers.TFOPTModel"),f($t,"class","relative group"),f(wn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.TFPreTrainedModel"),f(qo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(qo,"rel","nofollow"),f(Pn,"href","/docs/transformers/v4.24.0/en/model_doc/opt#transformers.TFOPTModel"),f(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Kt,"id","transformers.TFOPTForCausalLM"),f(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Kt,"href","#transformers.TFOPTForCausalLM"),f(Ft,"class","relative group"),f($n,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.TFPreTrainedModel"),f(So,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(So,"rel","nofollow"),f(Zt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Jt,"id","transformers.OPTForSequenceClassification"),f(Jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Jt,"href","#transformers.OPTForSequenceClassification"),f(xt,"class","relative group"),f(Fn,"href","/docs/transformers/v4.24.0/en/model_doc/opt#transformers.OPTForSequenceClassification"),f(xn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),f(Qo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Qo,"rel","nofollow"),f(zn,"href","/docs/transformers/v4.24.0/en/model_doc/opt#transformers.OPTForSequenceClassification"),f(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(no,"id","transformers.OPTForQuestionAnswering"),f(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(no,"href","#transformers.OPTForQuestionAnswering"),f(Mt,"class","relative group"),f(Mn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.PreTrainedModel"),f(Jo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Jo,"rel","nofollow"),f(En,"href","/docs/transformers/v4.24.0/en/model_doc/opt#transformers.OPTForQuestionAnswering"),f(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ro,"id","transformers.FlaxOPTModel"),f(ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(ro,"href","#transformers.FlaxOPTModel"),f(qt,"class","relative group"),f(io,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(jt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(co,"id","transformers.FlaxOPTForCausalLM"),f(co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(co,"href","#transformers.FlaxOPTForCausalLM"),f(Lt,"class","relative group"),f(Cn,"href","/docs/transformers/v4.24.0/en/main_classes/model#transformers.FlaxPreTrainedModel"),f(rn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),f(rn,"rel","nofollow"),f(ln,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),f(ln,"rel","nofollow"),f(dn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),f(dn,"rel","nofollow"),f(cn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),f(cn,"rel","nofollow"),f(pn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),f(pn,"rel","nofollow"),f(po,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,d),g(o,v,_),g(o,m,_),e(m,h),e(h,T),w(l,T,null),e(m,c),e(m,E),e(E,De),g(o,xe,_),g(o,L,_),e(L,ne),e(ne,ae),w(F,ae,null),e(L,We),e(L,J),e(J,Ge),g(o,ze,_),g(o,W,_),e(W,Be),e(W,re),e(re,ie),e(W,He),g(o,Me,_),g(o,K,_),e(K,Qe),g(o,Ee,_),g(o,V,_),e(V,ve),e(ve,Ue),g(o,me,_),g(o,C,_),e(C,A),g(o,Ce,_),g(o,G,_),e(G,le),e(le,Ke),e(le,X),e(X,Ve),e(le,Ze),e(G,N),e(G,I),e(I,de),e(I,ye),e(ye,Re),e(I,ce),e(I,be),e(be,Je),e(I,Y),e(I,ke),e(ke,pe),e(I,Xe),e(I,se),e(se,S),e(I,Ye),g(o,B,_),g(o,j,_),e(j,et),e(j,y),e(y,z),e(j,pt),e(j,ee),e(ee,ut),e(j,ht),e(j,M),e(M,mt),e(j,ft),e(j,we),e(we,gt),e(j,_t),g(o,Z,_),g(o,D,_),e(D,fe),e(fe,tt),w(H,tt,null),e(D,Tt),e(D,ot),e(ot,nt),g(o,rt,_),g(o,q,_),w(Pe,q,null),e(q,wa),e(q,vt),e(vt,Pa),e(vt,Tn),e(Tn,$a),e(vt,Oa),e(vt,vo),e(vo,Fa),e(vt,xa),e(q,za),e(q,yt),e(yt,Ma),e(yt,vn),e(vn,Ea),e(yt,Ca),e(yt,yn),e(yn,qa),e(yt,ja),e(q,La),w(At,q,null),g(o,qs,_),g(o,bt,_),e(bt,Nt),e(Nt,Wn),w(yo,Wn,null),e(bt,Aa),e(bt,Gn),e(Gn,Na),g(o,js,_),g(o,$e,_),w(bo,$e,null),e($e,Ia),e($e,ko),e(ko,Sa),e(ko,bn),e(bn,Da),e(ko,Wa),e($e,Ga),e($e,wo),e(wo,Ba),e(wo,Po),e(Po,Ha),e(wo,Qa),e($e,Ua),e($e,qe),w($o,qe,null),e(qe,Ka),e(qe,kt),e(kt,Va),e(kt,kn),e(kn,Za),e(kt,Ra),e(kt,Bn),e(Bn,Ja),e(kt,Xa),e(qe,Ya),w(It,qe,null),e(qe,er),w(St,qe,null),g(o,Ls,_),g(o,wt,_),e(wt,Dt),e(Dt,Hn),w(Oo,Hn,null),e(wt,tr),e(wt,Qn),e(Qn,or),g(o,As,_),g(o,Pt,_),w(Fo,Pt,null),e(Pt,nr),e(Pt,Wt),w(xo,Wt,null),e(Wt,sr),w(Gt,Wt,null),g(o,Ns,_),g(o,$t,_),e($t,Bt),e(Bt,Un),w(zo,Un,null),e($t,ar),e($t,Kn),e(Kn,rr),g(o,Is,_),g(o,ue,_),w(Mo,ue,null),e(ue,ir),e(ue,Eo),e(Eo,lr),e(Eo,wn),e(wn,dr),e(Eo,cr),e(ue,pr),e(ue,Co),e(Co,ur),e(Co,qo),e(qo,hr),e(Co,mr),e(ue,fr),w(Ht,ue,null),e(ue,gr),e(ue,je),w(jo,je,null),e(je,_r),e(je,Ot),e(Ot,Tr),e(Ot,Pn),e(Pn,vr),e(Ot,yr),e(Ot,Vn),e(Vn,br),e(Ot,kr),e(je,wr),w(Qt,je,null),e(je,Pr),w(Ut,je,null),g(o,Ss,_),g(o,Ft,_),e(Ft,Kt),e(Kt,Zn),w(Lo,Zn,null),e(Ft,$r),e(Ft,Rn),e(Rn,Or),g(o,Ds,_),g(o,te,_),w(Ao,te,null),e(te,Fr),e(te,Jn),e(Jn,xr),e(te,zr),e(te,No),e(No,Mr),e(No,$n),e($n,Er),e(No,Cr),e(te,qr),e(te,Io),e(Io,jr),e(Io,So),e(So,Lr),e(Io,Ar),e(te,Nr),w(Vt,te,null),e(te,Ir),e(te,Zt),w(Do,Zt,null),e(Zt,Sr),w(Rt,Zt,null),g(o,Ws,_),g(o,xt,_),e(xt,Jt),e(Jt,Xn),w(Wo,Xn,null),e(xt,Dr),e(xt,Yn),e(Yn,Wr),g(o,Gs,_),g(o,Q,_),w(Go,Q,null),e(Q,Gr),e(Q,es),e(es,Br),e(Q,Hr),e(Q,On),e(On,Fn),e(Fn,Qr),e(On,Ur),e(Q,Kr),e(Q,Oe),e(Oe,Vr),e(Oe,ts),e(ts,Zr),e(Oe,Rr),e(Oe,os),e(os,Jr),e(Oe,Xr),e(Oe,ns),e(ns,Yr),e(Oe,ei),e(Oe,ss),e(ss,ti),e(Oe,oi),e(Q,ni),e(Q,Bo),e(Bo,si),e(Bo,xn),e(xn,ai),e(Bo,ri),e(Q,ii),e(Q,Ho),e(Ho,li),e(Ho,Qo),e(Qo,di),e(Ho,ci),e(Q,pi),e(Q,R),w(Uo,R,null),e(R,ui),e(R,zt),e(zt,hi),e(zt,zn),e(zn,mi),e(zt,fi),e(zt,as),e(as,gi),e(zt,_i),e(R,Ti),w(Xt,R,null),e(R,vi),w(Yt,R,null),e(R,yi),w(eo,R,null),e(R,bi),w(to,R,null),e(R,ki),w(oo,R,null),g(o,Bs,_),g(o,Mt,_),e(Mt,no),e(no,rs),w(Ko,rs,null),e(Mt,wi),e(Mt,is),e(is,Pi),g(o,Hs,_),g(o,he,_),w(Vo,he,null),e(he,$i),e(he,Et),e(Et,Oi),e(Et,ls),e(ls,Fi),e(Et,xi),e(Et,ds),e(ds,zi),e(Et,Mi),e(he,Ei),e(he,Zo),e(Zo,Ci),e(Zo,Mn),e(Mn,qi),e(Zo,ji),e(he,Li),e(he,Ro),e(Ro,Ai),e(Ro,Jo),e(Jo,Ni),e(Ro,Ii),e(he,Si),e(he,Le),w(Xo,Le,null),e(Le,Di),e(Le,Ct),e(Ct,Wi),e(Ct,En),e(En,Gi),e(Ct,Bi),e(Ct,cs),e(cs,Hi),e(Ct,Qi),e(Le,Ui),w(so,Le,null),e(Le,Ki),w(ao,Le,null),g(o,Qs,_),g(o,qt,_),e(qt,ro),e(ro,ps),w(Yo,ps,null),e(qt,Vi),e(qt,us),e(us,Zi),g(o,Us,_),g(o,jt,_),w(en,jt,null),e(jt,Ri),e(jt,io),w(tn,io,null),e(io,Ji),w(lo,io,null),g(o,Ks,_),g(o,Lt,_),e(Lt,co),e(co,hs),w(on,hs,null),e(Lt,Xi),e(Lt,ms),e(ms,Yi),g(o,Vs,_),g(o,U,_),w(nn,U,null),e(U,el),e(U,fs),e(fs,tl),e(U,ol),e(U,sn),e(sn,nl),e(sn,Cn),e(Cn,sl),e(sn,al),e(U,rl),e(U,an),e(an,il),e(an,rn),e(rn,ll),e(an,dl),e(U,cl),e(U,gs),e(gs,pl),e(U,ul),e(U,st),e(st,_s),e(_s,ln),e(ln,hl),e(st,ml),e(st,Ts),e(Ts,dn),e(dn,fl),e(st,gl),e(st,vs),e(vs,cn),e(cn,_l),e(st,Tl),e(st,ys),e(ys,pn),e(pn,vl),e(U,yl),e(U,po),w(un,po,null),e(po,bl),w(uo,po,null),Zs=!0},p(o,[_]){const hn={};_&2&&(hn.$$scope={dirty:_,ctx:o}),At.$set(hn);const bs={};_&2&&(bs.$$scope={dirty:_,ctx:o}),It.$set(bs);const ks={};_&2&&(ks.$$scope={dirty:_,ctx:o}),St.$set(ks);const ws={};_&2&&(ws.$$scope={dirty:_,ctx:o}),Gt.$set(ws);const mn={};_&2&&(mn.$$scope={dirty:_,ctx:o}),Ht.$set(mn);const Ps={};_&2&&(Ps.$$scope={dirty:_,ctx:o}),Qt.$set(Ps);const $s={};_&2&&($s.$$scope={dirty:_,ctx:o}),Ut.$set($s);const Os={};_&2&&(Os.$$scope={dirty:_,ctx:o}),Vt.$set(Os);const fn={};_&2&&(fn.$$scope={dirty:_,ctx:o}),Rt.$set(fn);const Fs={};_&2&&(Fs.$$scope={dirty:_,ctx:o}),Xt.$set(Fs);const xs={};_&2&&(xs.$$scope={dirty:_,ctx:o}),Yt.$set(xs);const zs={};_&2&&(zs.$$scope={dirty:_,ctx:o}),eo.$set(zs);const Ms={};_&2&&(Ms.$$scope={dirty:_,ctx:o}),to.$set(Ms);const Es={};_&2&&(Es.$$scope={dirty:_,ctx:o}),oo.$set(Es);const gn={};_&2&&(gn.$$scope={dirty:_,ctx:o}),so.$set(gn);const _n={};_&2&&(_n.$$scope={dirty:_,ctx:o}),ao.$set(_n);const Cs={};_&2&&(Cs.$$scope={dirty:_,ctx:o}),lo.$set(Cs);const Fe={};_&2&&(Fe.$$scope={dirty:_,ctx:o}),uo.$set(Fe)},i(o){Zs||(P(l.$$.fragment,o),P(F.$$.fragment,o),P(H.$$.fragment,o),P(Pe.$$.fragment,o),P(At.$$.fragment,o),P(yo.$$.fragment,o),P(bo.$$.fragment,o),P($o.$$.fragment,o),P(It.$$.fragment,o),P(St.$$.fragment,o),P(Oo.$$.fragment,o),P(Fo.$$.fragment,o),P(xo.$$.fragment,o),P(Gt.$$.fragment,o),P(zo.$$.fragment,o),P(Mo.$$.fragment,o),P(Ht.$$.fragment,o),P(jo.$$.fragment,o),P(Qt.$$.fragment,o),P(Ut.$$.fragment,o),P(Lo.$$.fragment,o),P(Ao.$$.fragment,o),P(Vt.$$.fragment,o),P(Do.$$.fragment,o),P(Rt.$$.fragment,o),P(Wo.$$.fragment,o),P(Go.$$.fragment,o),P(Uo.$$.fragment,o),P(Xt.$$.fragment,o),P(Yt.$$.fragment,o),P(eo.$$.fragment,o),P(to.$$.fragment,o),P(oo.$$.fragment,o),P(Ko.$$.fragment,o),P(Vo.$$.fragment,o),P(Xo.$$.fragment,o),P(so.$$.fragment,o),P(ao.$$.fragment,o),P(Yo.$$.fragment,o),P(en.$$.fragment,o),P(tn.$$.fragment,o),P(lo.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(un.$$.fragment,o),P(uo.$$.fragment,o),Zs=!0)},o(o){$(l.$$.fragment,o),$(F.$$.fragment,o),$(H.$$.fragment,o),$(Pe.$$.fragment,o),$(At.$$.fragment,o),$(yo.$$.fragment,o),$(bo.$$.fragment,o),$($o.$$.fragment,o),$(It.$$.fragment,o),$(St.$$.fragment,o),$(Oo.$$.fragment,o),$(Fo.$$.fragment,o),$(xo.$$.fragment,o),$(Gt.$$.fragment,o),$(zo.$$.fragment,o),$(Mo.$$.fragment,o),$(Ht.$$.fragment,o),$(jo.$$.fragment,o),$(Qt.$$.fragment,o),$(Ut.$$.fragment,o),$(Lo.$$.fragment,o),$(Ao.$$.fragment,o),$(Vt.$$.fragment,o),$(Do.$$.fragment,o),$(Rt.$$.fragment,o),$(Wo.$$.fragment,o),$(Go.$$.fragment,o),$(Uo.$$.fragment,o),$(Xt.$$.fragment,o),$(Yt.$$.fragment,o),$(eo.$$.fragment,o),$(to.$$.fragment,o),$(oo.$$.fragment,o),$(Ko.$$.fragment,o),$(Vo.$$.fragment,o),$(Xo.$$.fragment,o),$(so.$$.fragment,o),$(ao.$$.fragment,o),$(Yo.$$.fragment,o),$(en.$$.fragment,o),$(tn.$$.fragment,o),$(lo.$$.fragment,o),$(on.$$.fragment,o),$(nn.$$.fragment,o),$(un.$$.fragment,o),$(uo.$$.fragment,o),Zs=!1},d(o){t(d),o&&t(v),o&&t(m),O(l),o&&t(xe),o&&t(L),O(F),o&&t(ze),o&&t(W),o&&t(Me),o&&t(K),o&&t(Ee),o&&t(V),o&&t(me),o&&t(C),o&&t(Ce),o&&t(G),o&&t(B),o&&t(j),o&&t(Z),o&&t(D),O(H),o&&t(rt),o&&t(q),O(Pe),O(At),o&&t(qs),o&&t(bt),O(yo),o&&t(js),o&&t($e),O(bo),O($o),O(It),O(St),o&&t(Ls),o&&t(wt),O(Oo),o&&t(As),o&&t(Pt),O(Fo),O(xo),O(Gt),o&&t(Ns),o&&t($t),O(zo),o&&t(Is),o&&t(ue),O(Mo),O(Ht),O(jo),O(Qt),O(Ut),o&&t(Ss),o&&t(Ft),O(Lo),o&&t(Ds),o&&t(te),O(Ao),O(Vt),O(Do),O(Rt),o&&t(Ws),o&&t(xt),O(Wo),o&&t(Gs),o&&t(Q),O(Go),O(Uo),O(Xt),O(Yt),O(eo),O(to),O(oo),o&&t(Bs),o&&t(Mt),O(Ko),o&&t(Hs),o&&t(he),O(Vo),O(Xo),O(so),O(ao),o&&t(Qs),o&&t(qt),O(Yo),o&&t(Us),o&&t(jt),O(en),O(tn),O(lo),o&&t(Ks),o&&t(Lt),O(on),o&&t(Vs),o&&t(U),O(nn),O(un),O(uo)}}}const _c={local:"opt",sections:[{local:"overview",title:"Overview"},{local:"transformers.OPTConfig",title:"OPTConfig"},{local:"transformers.OPTModel",title:"OPTModel"},{local:"transformers.OPTForCausalLM",title:"OPTForCausalLM"},{local:"transformers.TFOPTModel",title:"TFOPTModel"},{local:"transformers.TFOPTForCausalLM",title:"TFOPTForCausalLM"},{local:"transformers.OPTForSequenceClassification",title:"OPTForSequenceClassification"},{local:"transformers.OPTForQuestionAnswering",title:"OPTForQuestionAnswering"},{local:"transformers.FlaxOPTModel",title:"FlaxOPTModel"},{local:"transformers.FlaxOPTForCausalLM",title:"FlaxOPTForCausalLM"}],title:"OPT"};function Tc(x){return Jd(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class $c extends Kd{constructor(d){super();Vd(this,d,Tc,gc,Zd,{})}}export{$c as default,_c as metadata};
