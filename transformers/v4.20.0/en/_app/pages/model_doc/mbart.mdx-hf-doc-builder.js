...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/tokenization_mbart.py#L222",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/tokenization_mbart_fast.py#L165",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/tokenization_mbart_fast.py#L194",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart50/tokenization_mbart50.py#L289",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart50/tokenization_mbart50.py#L259",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L173",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.0/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/v4.20.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.0/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/modeling_tf_mbart.py#L1176",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/modeling_tf_mbart.py#L1284",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.0/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/v4.20.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.0/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
respectively.`),ea.forEach(t),bp=u(o),xo=s(o,"P",{});var nu=r(xo);pm=d(nu,"MBart-50 has its own tokenizer "),mi=s(nu,"A",{href:!0});var ZT=r(mi);um=d(ZT,"MBart50Tokenizer"),ZT.forEach(t),hm=d(nu,"."),nu.forEach(t),kp=u(o),fi=s(o,"UL",{});var YT=r(fi);kd=s(YT,"LI",{});var e0=r(kd);mm=d(e0,"Supervised training"),e0.forEach(t),YT.forEach(t),vp=u(o),y(wa.$$.fragment,o),yp=u(o),_i=s(o,"UL",{});var t0=r(_i);Ma=s(t0,"LI",{});var au=r(Ma);vd=s(au,"P",{});var o0=r(vd);fm=d(o0,"Generation"),o0.forEach(t),_m=u(au),Te=s(au,"P",{});var nt=r(Te);gm=d(nt,"To generate using the mBART-50 multilingual translation models, "),yd=s(nt,"CODE",{});var n0=r(yd);bm=d(n0,"eos_token_id"),n0.forEach(t),km=d(nt,` is used as the
`),Td=s(nt,"CODE",{});var a0=r(Td);vm=d(a0,"decoder_start_token_id"),a0.forEach(t),ym=d(nt,` and the target language id is forced as the first generated token. To force the
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),$d=s(nt,"EM",{});var i0=r($d);xm=d(i0,"facebook/mbart-50-large-many-to-many"),i0.forEach(t),zm=d(nt," checkpoint."),nt.forEach(t),au.forEach(t),t0.forEach(t),Tp=u(o),y($a.$$.fragment,o),wp=u(o),Lt=s(o,"H2",{class:!0});var su=r(Lt);zo=s(su,"A",{id:!0,class:!0,href:!0});var d0=r(zo);xd=s(d0,"SPAN",{});var l0=r(xd);y(xa.$$.fragment,l0),l0.forEach(t),d0.forEach(t),Fm=u(su),zd=s(su,"SPAN",{});var c0=r(zd);qm=d(c0,"MBartConfig"),c0.forEach(t),su.forEach(t),Mp=u(o),Ge=s(o,"DIV",{class:!0});var ta=r(Ge);y(za.$$.fragment,ta),Bm=u(ta),Gt=s(ta,"P",{});var Gi=r(Gt);jm=d(Gi,"This is the configuration class to store the configuration of a "),gi=s(Gi,"A",{href:!0});var p0=r(gi);Em=d(p0,"MBartModel"),p0.forEach(t),Cm=d(Gi,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
...
documentation from `),ki=s(Wi,"A",{href:!0});var m0=r(ki);Dm=d(m0,"PretrainedConfig"),m0.forEach(t),Lm=d(Wi," for more information."),Wi.forEach(t),Gm=u(ta),y(Fo.$$.fragment,ta),ta.forEach(t),$p=u(o),Ut=s(o,"H2",{class:!0});var ru=r(Ut);qo=s(ru,"A",{id:!0,class:!0,href:!0});var f0=r(qo);Fd=s(f0,"SPAN",{});var _0=r(Fd);y(qa.$$.fragment,_0),_0.forEach(t),f0.forEach(t),Wm=u(ru),qd=s(ru,"SPAN",{});var g0=r(qd);Um=d(g0,"MBartTokenizer"),g0.forEach(t),ru.forEach(t),xp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);y(Ba.$$.fragment,Se),Rm=u(Se),Bd=s(Se,"P",{});var b0=r(Bd);Xm=d(b0,"Construct an MBART tokenizer."),b0.forEach(t),Qm=u(Se),ht=s(Se,"P",{});var oa=r(ht);Hm=d(oa,"Adapted from "),vi=s(oa,"A",{href:!0});var k0=r(vi);Vm=d(k0,"RobertaTokenizer"),k0.forEach(t),Jm=d(oa," and "),yi=s(oa,"A",{href:!0});var v0=r(yi);Km=d(v0,"XLNetTokenizer"),v0.forEach(t),Zm=d(oa,`. Based on
`),ja=s(oa,"A",{href:!0,rel:!0});var y0=r(ja);Ym=d(y0,"SentencePiece"),y0.forEach(t),ef=d(oa,"."),oa.forEach(t),tf=u(Se),Ea=s(Se,"P",{});var iu=r(Ea);of=d(iu,"The tokenization method is "),jd=s(iu,"CODE",{});var T0=r(jd);nf=d(T0,"<tokens> <eos> <language code>"),T0.forEach(t),af=d(iu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),iu.forEach(t),sf=u(Se),y(Bo.$$.fragment,Se),rf=u(Se),jo=s(Se,"DIV",{class:!0});var du=r(jo);y(Ca.$$.fragment,du),df=u(du),Ed=s(du,"P",{});var w0=r(Ed);lf=d(w0,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
refer to this superclass for more information regarding those methods.`),mu.forEach(t),Of=u(Y),Wa=s(Y,"P",{});var fu=r(Wa);If=d(fu,"The tokenization method is "),Gd=s(fu,"CODE",{});var A0=r(Gd);Nf=d(A0,"<tokens> <eos> <language code>"),A0.forEach(t),Df=d(fu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),fu.forEach(t),Lf=u(Y),y(Co.$$.fragment,Y),Gf=u(Y),qe=s(Y,"DIV",{class:!0});var yt=r(qe);y(Ua.$$.fragment,yt),Wf=u(yt),Wd=s(yt,"P",{});var O0=r(Wd);Uf=d(O0,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),O0.forEach(t),Rf=u(yt),Ra=s(yt,"P",{});var _u=r(Ra);Xf=d(_u,"An MBART sequence has the following format, where "),Ud=s(_u,"CODE",{});var I0=r(Ud);Qf=d(I0,"X"),I0.forEach(t),Hf=d(_u," represents the sequence:"),_u.forEach(t),Vf=u(yt),Xa=s(yt,"UL",{});var gu=r(Xa);Qa=s(gu,"LI",{});var bu=r(Qa);Rd=s(bu,"CODE",{});var N0=r(Rd);Jf=d(N0,"input_ids"),N0.forEach(t),Kf=d(bu," (for encoder) "),Xd=s(bu,"CODE",{});var D0=r(Xd);Zf=d(D0,"X [eos, src_lang_code]"),D0.forEach(t),bu.forEach(t),Yf=u(gu),Ha=s(gu,"LI",{});var ku=r(Ha);Qd=s(ku,"CODE",{});var L0=r(Qd);e_=d(L0,"decoder_input_ids"),L0.forEach(t),t_=d(ku,": (for decoder) "),Hd=s(ku,"CODE",{});var G0=r(Hd);o_=d(G0,"X [eos, tgt_lang_code]"),G0.forEach(t),ku.forEach(t),gu.forEach(t),n_=u(yt),Vd=s(yt,"P",{});var W0=r(Vd);a_=d(W0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),W0.forEach(t),yt.forEach(t),s_=u(Y),Po=s(Y,"DIV",{class:!0});var vu=r(Po);y(Va.$$.fragment,vu),r_=u(vu),Jd=s(vu,"P",{});var U0=r(Jd);i_=d(U0,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),U0.forEach(t),vu.forEach(t),d_=u(Y),So=s(Y,"DIV",{class:!0});var yu=r(So);y(Ja.$$.fragment,yu),l_=u(yu),Kd=s(yu,"P",{});var R0=r(Kd);c_=d(R0,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),R0.forEach(t),yu.forEach(t),p_=u(Y),Ao=s(Y,"DIV",{class:!0});var Tu=r(Ao);y(Ka.$$.fragment,Tu),u_=u(Tu),Zd=s(Tu,"P",{});var X0=r(Zd);h_=d(X0,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),X0.forEach(t),Tu.forEach(t),Y.forEach(t),qp=u(o),Qt=s(o,"H2",{class:!0});var wu=r(Qt);Oo=s(wu,"A",{id:!0,class:!0,href:!0});var Q0=r(Oo);Yd=s(Q0,"SPAN",{});var H0=r(Yd);y(Za.$$.fragment,H0),H0.forEach(t),Q0.forEach(t),m_=u(wu),el=s(wu,"SPAN",{});var V0=r(el);f_=d(V0,"MBart50Tokenizer"),V0.forEach(t),wu.forEach(t),Bp=u(o),I=s(o,"DIV",{class:!0});var ee=r(I);y(Ya.$$.fragment,ee),__=u(ee),es=s(ee,"P",{});var Mu=r(es);g_=d(Mu,"Construct a MBart50 tokenizer. Based on "),ts=s(Mu,"A",{href:!0,rel:!0});var J0=r(ts);b_=d(J0,"SentencePiece"),J0.forEach(t),k_=d(Mu,"."),Mu.forEach(t),v_=u(ee),os=s(ee,"P",{});var $u=r(os);y_=d($u,"This tokenizer inherits from "),wi=s($u,"A",{href:!0});var K0=r(wi);T_=d(K0,"PreTrainedTokenizer"),K0.forEach(t),w_=d($u,` which contains most of the main methods. Users should refer to
