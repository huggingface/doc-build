...
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/v4.20.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/v4.20.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.0/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.0/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/v4.20.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.0/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.0/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mT=c(),Mt=n("div"),b(jr.$$.fragment),uT=c(),No=n("p"),fT=r("The "),Sd=n("a"),gT=r("ElectraForMultipleChoice"),_T=r(" forward method, overrides the "),Tp=n("code"),vT=r("__call__"),kT=r(" special method."),TT=c(),b(Gn.$$.fragment),bT=c(),b(Xn.$$.fragment),Bu=c(),Io=n("h2"),Yn=n("a"),bp=n("span"),b(Cr.$$.fragment),yT=c(),yp=n("span"),ET=r("ElectraForTokenClassification"),Vu=c(),Ve=n("div"),b(qr.$$.fragment),wT=c(),Ep=n("p"),$T=r("Electra model with a token classification head on top."),FT=c(),wp=n("p"),xT=r("Both the discriminator and generator may be loaded into this model."),MT=c(),Pr=n("p"),zT=r("This model inherits from "),Wd=n("a"),jT=r("PreTrainedModel"),CT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lb=c(),it=n("div"),b(Ur.$$.fragment),db=c(),Uo=n("p"),cb=r("The "),Hd=n("a"),pb=r("ElectraForQuestionAnswering"),hb=r(" forward method, overrides the "),jp=n("code"),mb=r("__call__"),ub=r(" special method."),fb=c(),b(ns.$$.fragment),gb=c(),b(ss.$$.fragment),_b=c(),b(as.$$.fragment),Gu=c(),Ro=n("h2"),rs=n("a"),Cp=n("span"),b(Rr.$$.fragment),vb=c(),qp=n("span"),kb=r("TFElectraModel"),Xu=c(),Ke=n("div"),b(Hr.$$.fragment),Tb=c(),Pp=n("p"),bb=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),yb=c(),Qr=n("p"),Eb=r("This model inherits from "),Qd=n("a"),wb=r("TFPreTrainedModel"),$b=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wy=c(),b(fs.$$.fragment),$y=c(),lt=n("div"),b(ri.$$.fragment),Fy=c(),Ko=n("p"),xy=r("The "),Gd=n("a"),My=r("TFElectraForMaskedLM"),zy=r(" forward method, overrides the "),Hp=n("code"),jy=r("__call__"),Cy=r(" special method."),qy=c(),b(gs.$$.fragment),Py=c(),b(_s.$$.fragment),Ay=c(),b(vs.$$.fragment),of=c(),Jo=n("h2"),ks=n("a"),Qp=n("span"),b(ii.$$.fragment),Oy=c(),Bp=n("span"),Ly=r("TFElectraForSequenceClassification"),nf=c(),Je=n("div"),b(li.$$.fragment),Ny=c(),Vp=n("p"),Iy=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Lw=c(),hh=n("p"),Nw=r("Finally, this model supports inherent JAX features such as:"),Iw=c(),Kt=n("ul"),mh=n("li"),Li=n("a"),Dw=r("Just-In-Time (JIT) compilation"),Sw=c(),uh=n("li"),Ni=n("a"),Ww=r("Automatic Differentiation"),Uw=c(),fh=n("li"),Ii=n("a"),Rw=r("Vectorization"),Hw=c(),gh=n("li"),Di=n("a"),Qw=r("Parallelization"),Bw=c(),qt=n("div"),b(Si.$$.fragment),Vw=c(),an=n("p"),Kw=r("The "),_h=n("code"),Jw=r("FlaxElectraPreTrainedModel"),Gw=r(" forward method, overrides the "),vh=n("code"),Xw=r("__call__"),Yw=r(" special method."),Zw=c(),b(Ds.$$.fragment),e0=c(),b(Ss.$$.fragment),mf=c(),rn=n("h2"),Ws=n("a"),kh=n("span"),b(Wi.$$.fragment),t0=c(),Th=n("span"),o0=r("FlaxElectraForPreTraining"),uf=c(),Pe=n("div"),b(Ui.$$.fragment),n0=c(),bh=n("p"),s0=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),a0=c(),yh=n("p"),r0=r("It is recommended to load the discriminator checkpoint into that model."),i0=c(),Ri=n("p"),l0=r("This model inherits from "),rc=n("a"),d0=r("FlaxPreTrainedModel"),c0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),p0=c(),Hi=n("p"),h0=r(`This model is also a Flax Linen
`),Qi=n("a"),m0=r("flax.nn.Module"),u0=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),f0=c(),Eh=n("p"),g0=r("Finally, this model supports inherent JAX features such as:"),_0=c(),Jt=n("ul"),wh=n("li"),Bi=n("a"),v0=r("Just-In-Time (JIT) compilation"),k0=c(),$h=n("li"),Vi=n("a"),T0=r("Automatic Differentiation"),b0=c(),Fh=n("li"),Ki=n("a"),y0=r("Vectorization"),E0=c(),xh=n("li"),Ji=n("a"),w0=r("Parallelization"),$0=c(),Pt=n("div"),b(Gi.$$.fragment),F0=c(),ln=n("p"),x0=r("The "),Mh=n("code"),M0=r("FlaxElectraPreTrainedModel"),z0=r(" forward method, overrides the "),zh=n("code"),j0=r("__call__"),C0=r(" special method."),q0=c(),b(Us.$$.fragment),P0=c(),b(Rs.$$.fragment),ff=c(),dn=n("h2"),Hs=n("a"),jh=n("span"),b(Xi.$$.fragment),A0=c(),Ch=n("span"),O0=r("FlaxElectraForCausalLM"),gf=c(),De=n("div"),b(Yi.$$.fragment),L0=c(),qh=n("p"),N0=r(`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),I0=c(),Zi=n("p"),D0=r("This model inherits from "),ic=n("a"),S0=r("FlaxPreTrainedModel"),W0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),U0=c(),el=n("p"),R0=r(`This model is also a Flax Linen
`),tl=n("a"),H0=r("flax.nn.Module"),Q0=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),B0=c(),Ph=n("p"),V0=r("Finally, this model supports inherent JAX features such as:"),K0=c(),Gt=n("ul"),Ah=n("li"),ol=n("a"),J0=r("Just-In-Time (JIT) compilation"),G0=c(),Oh=n("li"),nl=n("a"),X0=r("Automatic Differentiation"),Y0=c(),Lh=n("li"),sl=n("a"),Z0=r("Vectorization"),e$=c(),Nh=n("li"),al=n("a"),t$=r("Parallelization"),o$=c(),At=n("div"),b(rl.$$.fragment),n$=c(),cn=n("p"),s$=r("The "),Ih=n("code"),a$=r("FlaxElectraPreTrainedModel"),r$=r(" forward method, overrides the "),Dh=n("code"),i$=r("__call__"),l$=r(" special method."),d$=c(),b(Qs.$$.fragment),c$=c(),b(Bs.$$.fragment),_f=c(),pn=n("h2"),Vs=n("a"),Sh=n("span"),b(il.$$.fragment),p$=c(),Wh=n("span"),h$=r("FlaxElectraForMaskedLM"),vf=c(),Se=n("div"),b(ll.$$.fragment),m$=c(),dl=n("p"),u$=r("Electra Model with a "),Uh=n("code"),f$=r("language modeling"),g$=r(" head on top."),_$=c(),cl=n("p"),v$=r("This model inherits from "),lc=n("a"),k$=r("FlaxPreTrainedModel"),T$=r(`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),P2=c(),dm=n("p"),A2=r("Finally, this model supports inherent JAX features such as:"),O2=c(),Zt=n("ul"),cm=n("li"),Pl=n("a"),L2=r("Just-In-Time (JIT) compilation"),N2=c(),pm=n("li"),Al=n("a"),I2=r("Automatic Differentiation"),D2=c(),hm=n("li"),Ol=n("a"),S2=r("Vectorization"),W2=c(),mm=n("li"),Ll=n("a"),U2=r("Parallelization"),R2=c(),Nt=n("div"),b(Nl.$$.fragment),H2=c(),gn=n("p"),Q2=r("The "),um=n("code"),B2=r("FlaxElectraPreTrainedModel"),V2=r(" forward method, overrides the "),fm=n("code"),K2=r("__call__"),J2=r(" special method."),G2=c(),b(ea.$$.fragment),X2=c(),b(ta.$$.fragment),Ef=c(),_n=n("h2"),oa=n("a"),gm=n("span"),b(Il.$$.fragment),Y2=c(),_m=n("span"),Z2=r("FlaxElectraForTokenClassification"),wf=c(),Ae=n("div"),b(Dl.$$.fragment),e1=c(),vm=n("p"),t1=r("Electra model with a token classification head on top."),o1=c(),km=n("p"),n1=r("Both the discriminator and generator may be loaded into this model."),s1=c(),Sl=n("p"),a1=r("This model inherits from "),pc=n("a"),r1=r("FlaxPreTrainedModel"),i1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),l1=c(),Wl=n("p"),d1=r(`This model is also a Flax Linen
`),Ul=n("a"),c1=r("flax.nn.Module"),p1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),h1=c(),Tm=n("p"),m1=r("Finally, this model supports inherent JAX features such as:"),u1=c(),eo=n("ul"),bm=n("li"),Rl=n("a"),f1=r("Just-In-Time (JIT) compilation"),g1=c(),ym=n("li"),Hl=n("a"),_1=r("Automatic Differentiation"),v1=c(),Em=n("li"),Ql=n("a"),k1=r("Vectorization"),T1=c(),wm=n("li"),Bl=n("a"),b1=r("Parallelization"),y1=c(),It=n("div"),b(Vl.$$.fragment),E1=c(),vn=n("p"),w1=r("The "),$m=n("code"),$1=r("FlaxElectraPreTrainedModel"),F1=r(" forward method, overrides the "),Fm=n("code"),x1=r("__call__"),M1=r(" special method."),z1=c(),b(na.$$.fragment),j1=c(),b(sa.$$.fragment),$f=c(),kn=n("h2"),aa=n("a"),xm=n("span"),b(Kl.$$.fragment),C1=c(),Mm=n("span"),q1=r("FlaxElectraForQuestionAnswering"),Ff=c(),Re=n("div"),b(Jl.$$.fragment),P1=c(),Tn=n("p"),A1=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=n("code"),O1=r("span start logits"),L1=r(" and "),jm=n("code"),N1=r("span end logits"),I1=r(")."),D1=c(),Gl=n("p"),S1=r("This model inherits from "),hc=n("a"),W1=r("FlaxPreTrainedModel"),U1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),R1=c(),Xl=n("p"),H1=r(`This model is also a Flax Linen
`),Yl=n("a"),Q1=r("flax.nn.Module"),B1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),V1=c(),Cm=n("p"),K1=r("Finally, this model supports inherent JAX features such as:"),J1=c(),to=n("ul"),qm=n("li"),Zl=n("a"),G1=r("Just-In-Time (JIT) compilation"),X1=c(),Pm=n("li"),ed=n("a"),Y1=r("Automatic Differentiation"),Z1=c(),Am=n("li"),td=n("a"),eF=r("Vectorization"),tF=c(),Om=n("li"),od=n("a"),oF=r("Parallelization"),nF=c(),Dt=n("div"),b(nd.$$.fragment),sF=c(),bn=n("p"),aF=r("The "),Lm=n("code"),rF=r("FlaxElectraPreTrainedModel"),iF=r(" forward method, overrides the "),Nm=n("code"),lF=r("__call__"),dF=r(" special method."),cF=c(),b(ra.$$.fragment),pF=c(),b(ia.$$.fragment),this.h()},l(o){const k=uj('[data-svelte="svelte-1phssyn"]',document.head);d=s(k,"META",{name:!0,content:!0}),k.forEach(t),g=p(o),h=s(o,"H1",{class:!0});var sd=a(h);m=s(sd,"A",{id:!0,class:!0,href:!0});var Im=a(m);_=s(Im,"SPAN",{});var Dm=a(_);y(l.$$.fragment,Dm),Dm.forEach(t),Im.forEach(t),u=p(sd),M=s(sd,"SPAN",{});var Sm=a(M);ue=i(Sm,"ELECTRA"),Sm.forEach(t),sd.forEach(t),J=p(o),j=s(o,"H2",{class:!0});var ad=a(j);ee=s(ad,"A",{id:!0,class:!0,href:!0});var Wm=a(ee);D=s(Wm,"SPAN",{});var Um=a(D);y(oe.$$.fragment,Um),Um.forEach(t),Wm.forEach(t),fe=p(ad),S=s(ad,"SPAN",{});var Rm=a(S);ge=i(Rm,"Overview"),Rm.forEach(t),ad.forEach(t),pe=p(o),K=s(o,"P",{});var rd=a(K);O=i(rd,"The ELECTRA model was proposed in the paper "),ne=s(rd,"A",{href:!0,rel:!0});var Hm=a(ne);X=i(Hm,`ELECTRA: Pre-training Text Encoders as Discriminators Rather Than
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),_k=p(Wt),gr=s(Wt,"P",{});var Uf=a(gr);vk=i(Uf,"This model is also a PyTorch "),_r=s(Uf,"A",{href:!0,rel:!0});var QF=a(_r);kk=i(QF,"torch.nn.Module"),QF.forEach(t),Tk=i(Uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),bk=p(Wt),at=s(Wt,"DIV",{class:!0});var co=a(at);y(vr.$$.fragment,co),yk=p(co),Po=s(co,"P",{});var gc=a(Po);Ek=i(gc,"The "),Ld=s(gc,"A",{href:!0});var BF=a(Ld);wk=i(BF,"ElectraForMaskedLM"),BF.forEach(t),$k=i(gc," forward method, overrides the "),hp=s(gc,"CODE",{});var VF=a(hp);Fk=i(VF,"__call__"),VF.forEach(t),xk=i(gc," special method."),gc.forEach(t),Mk=p(co),y(Sn.$$.fragment,co),zk=p(co),y(Wn.$$.fragment,co),jk=p(co),y(Un.$$.fragment,co),co.forEach(t),Wt.forEach(t),Uu=p(o),Ao=s(o,"H2",{class:!0});var Rf=a(Ao);Rn=s(Rf,"A",{id:!0,class:!0,href:!0});var KF=a(Rn);mp=s(KF,"SPAN",{});var JF=a(mp);y(kr.$$.fragment,JF),JF.forEach(t),KF.forEach(t),Ck=p(Rf),up=s(Rf,"SPAN",{});var GF=a(up);qk=i(GF,"ElectraForSequenceClassification"),GF.forEach(t),Rf.forEach(t),Ru=p(o),ot=s(o,"DIV",{class:!0});var po=a(ot);y(Tr.$$.fragment,po),Pk=p(po),fp=s(po,"P",{});var XF=a(fp);Ak=i(XF,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hf.forEach(t),Dk=p(po),yr=s(po,"P",{});var Qf=a(yr);Sk=i(Qf,"This model is also a PyTorch "),Er=s(Qf,"A",{href:!0,rel:!0});var ZF=a(Er);Wk=i(ZF,"torch.nn.Module"),ZF.forEach(t),Uk=i(Qf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qf.forEach(t),Rk=p(po),He=s(po,"DIV",{class:!0});var ht=a(He);y(wr.$$.fragment,ht),Hk=p(ht),Oo=s(ht,"P",{});var _c=a(Oo);Qk=i(_c,"The "),Id=s(_c,"A",{href:!0});var ex=a(Id);Bk=i(ex,"ElectraForSequenceClassification"),ex.forEach(t),Vk=i(_c," forward method, overrides the "),gp=s(_c,"CODE",{});var tx=a(gp);Kk=i(tx,"__call__"),tx.forEach(t),Jk=i(_c," special method."),_c.forEach(t),Gk=p(ht),y(Hn.$$.fragment,ht),Xk=p(ht),y(Qn.$$.fragment,ht),Yk=p(ht),y(Bn.$$.fragment,ht),Zk=p(ht),y(Vn.$$.fragment,ht),eT=p(ht),y(Kn.$$.fragment,ht),ht.forEach(t),po.forEach(t),Hu=p(o),Lo=s(o,"H2",{class:!0});var Bf=a(Lo);Jn=s(Bf,"A",{id:!0,class:!0,href:!0});var ox=a(Jn);_p=s(ox,"SPAN",{});var nx=a(_p);y($r.$$.fragment,nx),nx.forEach(t),ox.forEach(t),tT=p(Bf),vp=s(Bf,"SPAN",{});var sx=a(vp);oT=i(sx,"ElectraForMultipleChoice"),sx.forEach(t),Bf.forEach(t),Qu=p(o),nt=s(o,"DIV",{class:!0});var ho=a(nt);y(Fr.$$.fragment,ho),nT=p(ho),kp=s(ho,"P",{});var ax=a(kp);sT=i(ax,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eg.forEach(t),lb=p(uo),it=s(uo,"DIV",{class:!0});var fo=a(it);y(Ur.$$.fragment,fo),db=p(fo),Uo=s(fo,"P",{});var bc=a(Uo);cb=i(bc,"The "),Hd=s(bc,"A",{href:!0});var Fx=a(Hd);pb=i(Fx,"ElectraForQuestionAnswering"),Fx.forEach(t),hb=i(bc," forward method, overrides the "),jp=s(bc,"CODE",{});var xx=a(jp);mb=i(xx,"__call__"),xx.forEach(t),ub=i(bc," special method."),bc.forEach(t),fb=p(fo),y(ns.$$.fragment,fo),gb=p(fo),y(ss.$$.fragment,fo),_b=p(fo),y(as.$$.fragment,fo),fo.forEach(t),uo.forEach(t),Gu=p(o),Ro=s(o,"H2",{class:!0});var tg=a(Ro);rs=s(tg,"A",{id:!0,class:!0,href:!0});var Mx=a(rs);Cp=s(Mx,"SPAN",{});var zx=a(Cp);y(Rr.$$.fragment,zx),zx.forEach(t),Mx.forEach(t),vb=p(tg),qp=s(tg,"SPAN",{});var jx=a(qp);kb=i(jx,"TFElectraModel"),jx.forEach(t),tg.forEach(t),Xu=p(o),Ke=s(o,"DIV",{class:!0});var Rt=a(Ke);y(Hr.$$.fragment,Rt),Tb=p(Rt),Pp=s(Rt,"P",{});var Cx=a(Pp);bb=i(Cx,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),Cx.forEach(t),yb=p(Rt),Qr=s(Rt,"P",{});var og=a(Qr);Eb=i(og,"This model inherits from "),Qd=s(og,"A",{href:!0});var qx=a(Qd);wb=i(qx,"TFPreTrainedModel"),qx.forEach(t),$b=i(og,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hg.forEach(t),Vy=p(Ht),y(Ts.$$.fragment,Ht),Ky=p(Ht),dt=s(Ht,"DIV",{class:!0});var _o=a(dt);y(hi.$$.fragment,_o),Jy=p(_o),Go=s(_o,"P",{});var $c=a(Go);Gy=i($c,"The "),Yd=s($c,"A",{href:!0});var r4=a(Yd);Xy=i(r4,"TFElectraForSequenceClassification"),r4.forEach(t),Yy=i($c," forward method, overrides the "),Kp=s($c,"CODE",{});var i4=a(Kp);Zy=i(i4,"__call__"),i4.forEach(t),eE=i($c," special method."),$c.forEach(t),tE=p(_o),y(bs.$$.fragment,_o),oE=p(_o),y(ys.$$.fragment,_o),nE=p(_o),y(Es.$$.fragment,_o),_o.forEach(t),Ht.forEach(t),sf=p(o),Xo=s(o,"H2",{class:!0});var mg=a(Xo);ws=s(mg,"A",{id:!0,class:!0,href:!0});var l4=a(ws);Jp=s(l4,"SPAN",{});var d4=a(Jp);y(mi.$$.fragment,d4),d4.forEach(t),l4.forEach(t),sE=p(mg),Gp=s(mg,"SPAN",{});var c4=a(Gp);aE=i(c4,"TFElectraForMultipleChoice"),c4.forEach(t),mg.forEach(t),af=p(o),Ge=s(o,"DIV",{class:!0});var Qt=a(Ge);y(ui.$$.fragment,Qt),rE=p(Qt),Xp=s(Qt,"P",{});var p4=a(Xp);iE=i(p4,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),p4.forEach(t),lE=p(Qt),fi=s(Qt,"P",{});var ug=a(fi);dE=i(ug,"This model inherits from "),Zd=s(ug,"A",{href:!0});var h4=a(Zd);cE=i(h4,"TFPreTrainedModel"),h4.forEach(t),pE=i(ug,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ug.forEach(t),hE=p(Qt),gi=s(Qt,"P",{});var fg=a(gi);mE=i(fg,"This model is also a "),_i=s(fg,"A",{href:!0,rel:!0});var m4=a(_i);uE=i(m4,"tf.keras.Model"),m4.forEach(t),fE=i(fg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fg.forEach(t),gE=p(Qt),y($s.$$.fragment,Qt),_E=p(Qt),Ct=s(Qt,"DIV",{class:!0});var ga=a(Ct);y(vi.$$.fragment,ga),vE=p(ga),Yo=s(ga,"P",{});var Fc=a(Yo);kE=i(Fc,"The "),ec=s(Fc,"A",{href:!0});var u4=a(ec);TE=i(u4,"TFElectraForMultipleChoice"),u4.forEach(t),bE=i(Fc," forward method, overrides the "),Yp=s(Fc,"CODE",{});var f4=a(Yp);yE=i(f4,"__call__"),f4.forEach(t),EE=i(Fc," special method."),Fc.forEach(t),wE=p(ga),y(Fs.$$.fragment,ga),$E=p(ga),y(xs.$$.fragment,ga),ga.forEach(t),Qt.forEach(t),rf=p(o),Zo=s(o,"H2",{class:!0});var gg=a(Zo);Ms=s(gg,"A",{id:!0,class:!0,href:!0});var g4=a(Ms);Zp=s(g4,"SPAN",{});var _4=a(Zp);y(ki.$$.fragment,_4),_4.forEach(t),g4.forEach(t),FE=p(gg),eh=s(gg,"SPAN",{});var v4=a(eh);xE=i(v4,"TFElectraForTokenClassification"),v4.forEach(t),gg.forEach(t),lf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(Ti.$$.fragment,ft),ME=p(ft),th=s(ft,"P",{});var k4=a(th);zE=i(k4,"Electra model with a token classification head on top."),k4.forEach(t),jE=p(ft),oh=s(ft,"P",{});var T4=a(oh);CE=i(T4,"Both the discriminator and generator may be loaded into this model."),T4.forEach(t),qE=p(ft),bi=s(ft,"P",{});var _g=a(bi);PE=i(_g,"This model inherits from "),tc=s(_g,"A",{href:!0});var b4=a(tc);AE=i(b4,"TFPreTrainedModel"),b4.forEach(t),OE=i(_g,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_g.forEach(t),LE=p(ft),yi=s(ft,"P",{});var vg=a(yi);NE=i(vg,"This model is also a "),Ei=s(vg,"A",{href:!0,rel:!0});var y4=a(Ei);IE=i(y4,"tf.keras.Model"),y4.forEach(t),DE=i(vg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vg.forEach(t),SE=p(ft),y(zs.$$.fragment,ft),WE=p(ft),ct=s(ft,"DIV",{class:!0});var vo=a(ct);y(wi.$$.fragment,vo),UE=p(vo),en=s(vo,"P",{});var xc=a(en);RE=i(xc,"The "),oc=s(xc,"A",{href:!0});var E4=a(oc);HE=i(E4,"TFElectraForTokenClassification"),E4.forEach(t),QE=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var w4=a(nh);BE=i(w4,"__call__"),w4.forEach(t),VE=i(xc," special method."),xc.forEach(t),KE=p(vo),y(js.$$.fragment,vo),JE=p(vo),y(Cs.$$.fragment,vo),GE=p(vo),y(qs.$$.fragment,vo),vo.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var kg=a(tn);Ps=s(kg,"A",{id:!0,class:!0,href:!0});var $4=a(Ps);sh=s($4,"SPAN",{});var F4=a(sh);y($i.$$.fragment,F4),F4.forEach(t),$4.forEach(t),XE=p(kg),ah=s(kg,"SPAN",{});var x4=a(ah);YE=i(x4,"TFElectraForQuestionAnswering"),x4.forEach(t),kg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Bt=a(Xe);y(Fi.$$.fragment,Bt),ZE=p(Bt),on=s(Bt,"P",{});var Mc=a(on);ew=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var M4=a(rh);tw=i(M4,"span start logits"),M4.forEach(t),ow=i(Mc," and "),ih=s(Mc,"CODE",{});var z4=a(ih);nw=i(z4,"span end logits"),z4.forEach(t),sw=i(Mc,")."),Mc.forEach(t),aw=p(Bt),xi=s(Bt,"P",{});var Tg=a(xi);rw=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var j4=a(nc);iw=i(j4,"TFPreTrainedModel"),j4.forEach(t),lw=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dw=p(Bt),Mi=s(Bt,"P",{});var bg=a(Mi);cw=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var C4=a(zi);pw=i(C4,"tf.keras.Model"),C4.forEach(t),hw=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mw=p(Bt),y(As.$$.fragment,Bt),uw=p(Bt),pt=s(Bt,"DIV",{class:!0});var ko=a(pt);y(ji.$$.fragment,ko),fw=p(ko),nn=s(ko,"P",{});var zc=a(nn);gw=i(zc,"The "),sc=s(zc,"A",{href:!0});var q4=a(sc);_w=i(q4,"TFElectraForQuestionAnswering"),q4.forEach(t),vw=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var P4=a(lh);kw=i(P4,"__call__"),P4.forEach(t),Tw=i(zc," special method."),zc.forEach(t),bw=p(ko),y(Os.$$.fragment,ko),yw=p(ko),y(Ls.$$.fragment,ko),Ew=p(ko),y(Ns.$$.fragment,ko),ko.forEach(t),Bt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var A4=a(Is);dh=s(A4,"SPAN",{});var O4=a(dh);y(Ci.$$.fragment,O4),O4.forEach(t),A4.forEach(t),ww=p(yg),ch=s(yg,"SPAN",{});var L4=a(ch);$w=i(L4,"FlaxElectraModel"),L4.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),Fw=p(gt),ph=s(gt,"P",{});var N4=a(ph);xw=i(N4,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),N4.forEach(t),Mw=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zw=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var I4=a(ac);jw=i(I4,"FlaxPreTrainedModel"),I4.forEach(t),Cw=i(Eg,`. Check the superclass documentation for the generic methods the
...
`),Oi=s(wg,"A",{href:!0,rel:!0});var D4=a(Oi);Aw=i(D4,"flax.nn.Module"),D4.forEach(t),Ow=i(wg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wg.forEach(t),Lw=p(gt),hh=s(gt,"P",{});var S4=a(hh);Nw=i(S4,"Finally, this model supports inherent JAX features such as:"),S4.forEach(t),Iw=p(gt),Kt=s(gt,"UL",{});var _a=a(Kt);mh=s(_a,"LI",{});var W4=a(mh);Li=s(W4,"A",{href:!0,rel:!0});var U4=a(Li);Dw=i(U4,"Just-In-Time (JIT) compilation"),U4.forEach(t),W4.forEach(t),Sw=p(_a),uh=s(_a,"LI",{});var R4=a(uh);Ni=s(R4,"A",{href:!0,rel:!0});var H4=a(Ni);Ww=i(H4,"Automatic Differentiation"),H4.forEach(t),R4.forEach(t),Uw=p(_a),fh=s(_a,"LI",{});var Q4=a(fh);Ii=s(Q4,"A",{href:!0,rel:!0});var B4=a(Ii);Rw=i(B4,"Vectorization"),B4.forEach(t),Q4.forEach(t),Hw=p(_a),gh=s(_a,"LI",{});var V4=a(gh);Di=s(V4,"A",{href:!0,rel:!0});var K4=a(Di);Qw=i(K4,"Parallelization"),K4.forEach(t),V4.forEach(t),_a.forEach(t),Bw=p(gt),qt=s(gt,"DIV",{class:!0});var va=a(qt);y(Si.$$.fragment,va),Vw=p(va),an=s(va,"P",{});var jc=a(an);Kw=i(jc,"The "),_h=s(jc,"CODE",{});var J4=a(_h);Jw=i(J4,"FlaxElectraPreTrainedModel"),J4.forEach(t),Gw=i(jc," forward method, overrides the "),vh=s(jc,"CODE",{});var G4=a(vh);Xw=i(G4,"__call__"),G4.forEach(t),Yw=i(jc," special method."),jc.forEach(t),Zw=p(va),y(Ds.$$.fragment,va),e0=p(va),y(Ss.$$.fragment,va),va.forEach(t),gt.forEach(t),mf=p(o),rn=s(o,"H2",{class:!0});var $g=a(rn);Ws=s($g,"A",{id:!0,class:!0,href:!0});var X4=a(Ws);kh=s(X4,"SPAN",{});var Y4=a(kh);y(Wi.$$.fragment,Y4),Y4.forEach(t),X4.forEach(t),t0=p($g),Th=s($g,"SPAN",{});var Z4=a(Th);o0=i(Z4,"FlaxElectraForPreTraining"),Z4.forEach(t),$g.forEach(t),uf=p(o),Pe=s(o,"DIV",{class:!0});var Ye=a(Pe);y(Ui.$$.fragment,Ye),n0=p(Ye),bh=s(Ye,"P",{});var eM=a(bh);s0=i(eM,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),eM.forEach(t),a0=p(Ye),yh=s(Ye,"P",{});var tM=a(yh);r0=i(tM,"It is recommended to load the discriminator checkpoint into that model."),tM.forEach(t),i0=p(Ye),Ri=s(Ye,"P",{});var Fg=a(Ri);l0=i(Fg,"This model inherits from "),rc=s(Fg,"A",{href:!0});var oM=a(rc);d0=i(oM,"FlaxPreTrainedModel"),oM.forEach(t),c0=i(Fg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Fg.forEach(t),p0=p(Ye),Hi=s(Ye,"P",{});var xg=a(Hi);h0=i(xg,`This model is also a Flax Linen
`),Qi=s(xg,"A",{href:!0,rel:!0});var nM=a(Qi);m0=i(nM,"flax.nn.Module"),nM.forEach(t),u0=i(xg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xg.forEach(t),f0=p(Ye),Eh=s(Ye,"P",{});var sM=a(Eh);g0=i(sM,"Finally, this model supports inherent JAX features such as:"),sM.forEach(t),_0=p(Ye),Jt=s(Ye,"UL",{});var ka=a(Jt);wh=s(ka,"LI",{});var aM=a(wh);Bi=s(aM,"A",{href:!0,rel:!0});var rM=a(Bi);v0=i(rM,"Just-In-Time (JIT) compilation"),rM.forEach(t),aM.forEach(t),k0=p(ka),$h=s(ka,"LI",{});var iM=a($h);Vi=s(iM,"A",{href:!0,rel:!0});var lM=a(Vi);T0=i(lM,"Automatic Differentiation"),lM.forEach(t),iM.forEach(t),b0=p(ka),Fh=s(ka,"LI",{});var dM=a(Fh);Ki=s(dM,"A",{href:!0,rel:!0});var cM=a(Ki);y0=i(cM,"Vectorization"),cM.forEach(t),dM.forEach(t),E0=p(ka),xh=s(ka,"LI",{});var pM=a(xh);Ji=s(pM,"A",{href:!0,rel:!0});var hM=a(Ji);w0=i(hM,"Parallelization"),hM.forEach(t),pM.forEach(t),ka.forEach(t),$0=p(Ye),Pt=s(Ye,"DIV",{class:!0});var Ta=a(Pt);y(Gi.$$.fragment,Ta),F0=p(Ta),ln=s(Ta,"P",{});var Cc=a(ln);x0=i(Cc,"The "),Mh=s(Cc,"CODE",{});var mM=a(Mh);M0=i(mM,"FlaxElectraPreTrainedModel"),mM.forEach(t),z0=i(Cc," forward method, overrides the "),zh=s(Cc,"CODE",{});var uM=a(zh);j0=i(uM,"__call__"),uM.forEach(t),C0=i(Cc," special method."),Cc.forEach(t),q0=p(Ta),y(Us.$$.fragment,Ta),P0=p(Ta),y(Rs.$$.fragment,Ta),Ta.forEach(t),Ye.forEach(t),ff=p(o),dn=s(o,"H2",{class:!0});var Mg=a(dn);Hs=s(Mg,"A",{id:!0,class:!0,href:!0});var fM=a(Hs);jh=s(fM,"SPAN",{});var gM=a(jh);y(Xi.$$.fragment,gM),gM.forEach(t),fM.forEach(t),A0=p(Mg),Ch=s(Mg,"SPAN",{});var _M=a(Ch);O0=i(_M,"FlaxElectraForCausalLM"),_M.forEach(t),Mg.forEach(t),gf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),L0=p(_t),qh=s(_t,"P",{});var vM=a(qh);N0=i(vM,`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),vM.forEach(t),I0=p(_t),Zi=s(_t,"P",{});var zg=a(Zi);D0=i(zg,"This model inherits from "),ic=s(zg,"A",{href:!0});var kM=a(ic);S0=i(kM,"FlaxPreTrainedModel"),kM.forEach(t),W0=i(zg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),zg.forEach(t),U0=p(_t),el=s(_t,"P",{});var jg=a(el);R0=i(jg,`This model is also a Flax Linen
`),tl=s(jg,"A",{href:!0,rel:!0});var TM=a(tl);H0=i(TM,"flax.nn.Module"),TM.forEach(t),Q0=i(jg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jg.forEach(t),B0=p(_t),Ph=s(_t,"P",{});var bM=a(Ph);V0=i(bM,"Finally, this model supports inherent JAX features such as:"),bM.forEach(t),K0=p(_t),Gt=s(_t,"UL",{});var ba=a(Gt);Ah=s(ba,"LI",{});var yM=a(Ah);ol=s(yM,"A",{href:!0,rel:!0});var EM=a(ol);J0=i(EM,"Just-In-Time (JIT) compilation"),EM.forEach(t),yM.forEach(t),G0=p(ba),Oh=s(ba,"LI",{});var wM=a(Oh);nl=s(wM,"A",{href:!0,rel:!0});var $M=a(nl);X0=i($M,"Automatic Differentiation"),$M.forEach(t),wM.forEach(t),Y0=p(ba),Lh=s(ba,"LI",{});var FM=a(Lh);sl=s(FM,"A",{href:!0,rel:!0});var xM=a(sl);Z0=i(xM,"Vectorization"),xM.forEach(t),FM.forEach(t),e$=p(ba),Nh=s(ba,"LI",{});var MM=a(Nh);al=s(MM,"A",{href:!0,rel:!0});var zM=a(al);t$=i(zM,"Parallelization"),zM.forEach(t),MM.forEach(t),ba.forEach(t),o$=p(_t),At=s(_t,"DIV",{class:!0});var ya=a(At);y(rl.$$.fragment,ya),n$=p(ya),cn=s(ya,"P",{});var qc=a(cn);s$=i(qc,"The "),Ih=s(qc,"CODE",{});var jM=a(Ih);a$=i(jM,"FlaxElectraPreTrainedModel"),jM.forEach(t),r$=i(qc," forward method, overrides the "),Dh=s(qc,"CODE",{});var CM=a(Dh);i$=i(CM,"__call__"),CM.forEach(t),l$=i(qc," special method."),qc.forEach(t),d$=p(ya),y(Qs.$$.fragment,ya),c$=p(ya),y(Bs.$$.fragment,ya),ya.forEach(t),_t.forEach(t),_f=p(o),pn=s(o,"H2",{class:!0});var Cg=a(pn);Vs=s(Cg,"A",{id:!0,class:!0,href:!0});var qM=a(Vs);Sh=s(qM,"SPAN",{});var PM=a(Sh);y(il.$$.fragment,PM),PM.forEach(t),qM.forEach(t),p$=p(Cg),Wh=s(Cg,"SPAN",{});var AM=a(Wh);h$=i(AM,"FlaxElectraForMaskedLM"),AM.forEach(t),Cg.forEach(t),vf=p(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(ll.$$.fragment,vt),m$=p(vt),dl=s(vt,"P",{});var qg=a(dl);u$=i(qg,"Electra Model with a "),Uh=s(qg,"CODE",{});var OM=a(Uh);f$=i(OM,"language modeling"),OM.forEach(t),g$=i(qg," head on top."),qg.forEach(t),_$=p(vt),cl=s(vt,"P",{});var Pg=a(cl);v$=i(Pg,"This model inherits from "),lc=s(Pg,"A",{href:!0});var LM=a(lc);k$=i(LM,"FlaxPreTrainedModel"),LM.forEach(t),T$=i(Pg,`. Check the superclass documentation for the generic methods the
