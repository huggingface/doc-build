...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),b(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),v=!0},p:oo,i(r){v||(P(u.$$.fragment,r),v=!0)},o(r){$(u.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(p),y(u,r)}}}function Ns(G){let d,T,p,u,v,r,_,X,L,z,C,q,ot,me,no,nt,so,Nt,R,ao,fe,ro,io,Gt,Y,lo,ue,co,po,Xt,Ie,ho,xt,ge,zt,Se,mo,Mt,I,K,st,_e,fo,at,uo,Ct,Q,go,rt,_o,To,Et,Te,Ft,S,Z,it,ve,vo,lt,bo,qt,M,be,ko,D,wo,De,Po,$o,ke,yo,No,Go,B,Xo,Be,xo,zo,We,Mo,Co,Eo,ee,jt,W,te,dt,we,Fo,ct,qo,At,N,Pe,jo,$e,Ao,pt,Lo,Io,So,ht,Do,Bo,oe,Wo,ye,Oo,mt,Ho,Uo,Vo,ne,Jo,Ne,Ro,Oe,Yo,Ko,Lt,O,se,ft,Ge,Qo,ut,Zo,It,j,Xe,en,xe,tn,ze,on,nn,sn,E,Me,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,St,U,ie,_t,Ce,fn,Tt,un,Dt,A,Ee,gn,V,_n,vt,Tn,vn,Fe,bn,kn,wn,F,qe,Pn,J,$n,Ue,yn,Nn,bt,Gn,Xn,xn,le,zn,de,Bt;return r=new Le({}),me=new Le({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Le({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.20.0/en/model_doc/gpt_neox#transformers.GPTNeoXModel">GPTNeoXModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTNeoXConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/v4.20.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L396",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.0/en/model_doc/gpt_neox#transformers.GPTNeoXConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L535",returnDescription:`
<p>A <a
