...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gw=c(),li=n("p"),Yw=r("This model is also a Flax Linen "),di=n("a"),Zw=r("flax.linen.Module"),e0=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t0=c(),Rp=n("p"),o0=r("Finally, this model supports inherent JAX features such as:"),n0=c(),Wt=n("ul"),Lp=n("li"),ci=n("a"),s0=r("Just-In-Time (JIT) compilation"),a0=c(),Ep=n("li"),pi=n("a"),r0=r("Automatic Differentiation"),i0=c(),zp=n("li"),hi=n("a"),l0=r("Vectorization"),d0=c(),qp=n("li"),mi=n("a"),c0=r("Parallelization"),p0=c(),ui=n("p"),h0=r("This class overrides "),kd=n("a"),m0=r("FlaxRobertaForMaskedLM"),u0=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),f0=c(),Lt=n("div"),T(fi.$$.fragment),g0=c(),Wo=n("p"),_0=r("The "),Cp=n("code"),b0=r("FlaxRobertaPreTrainedModel"),k0=r(" forward method, overrides the "),jp=n("code"),v0=r("__call__"),T0=r(" special method."),y0=c(),T(ms.$$.fragment),w0=c(),T(us.$$.fragment),Pm=c(),Bo=n("h2"),fs=n("a"),Xp=n("span"),T(gi.$$.fragment),$0=c(),Pp=n("span"),M0=r("FlaxXLMRobertaForSequenceClassification"),Am=c(),Ce=n("div"),T(_i.$$.fragment),F0=c(),Ap=n("p"),x0=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),R0=c(),bi=n("p"),L0=r("This model inherits from "),vd=n("a"),E0=r("FlaxPreTrainedModel"),z0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),q0=c(),ki=n("p"),C0=r("This model is also a Flax Linen "),vi=n("a"),j0=r("flax.linen.Module"),X0=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P0=c(),Op=n("p"),A0=r("Finally, this model supports inherent JAX features such as:"),O0=c(),Bt=n("ul"),Np=n("li"),Ti=n("a"),N0=r("Just-In-Time (JIT) compilation"),I0=c(),Ip=n("li"),yi=n("a"),D0=r("Automatic Differentiation"),S0=c(),Dp=n("li"),wi=n("a"),W0=r("Vectorization"),B0=c(),Sp=n("li"),$i=n("a"),U0=r("Parallelization"),Q0=c(),Mi=n("p"),H0=r("This class overrides "),Td=n("a"),V0=r("FlaxRobertaForSequenceClassification"),J0=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),K0=c(),Et=n("div"),T(Fi.$$.fragment),G0=c(),Uo=n("p"),Y0=r("The "),Wp=n("code"),Z0=r("FlaxRobertaPreTrainedModel"),e$=r(" forward method, overrides the "),Bp=n("code"),t$=r("__call__"),o$=r(" special method."),n$=c(),T(gs.$$.fragment),s$=c(),T(_s.$$.fragment),Om=c(),Qo=n("h2"),bs=n("a"),Up=n("span"),T(xi.$$.fragment),a$=c(),Qp=n("span"),r$=r("FlaxXLMRobertaForMultipleChoice"),Nm=c(),je=n("div"),T(Ri.$$.fragment),i$=c(),Hp=n("p"),l$=r(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
not make use of token type ids, therefore a list of zeros is returned.`),Zh.forEach(t),kl.forEach(t),sg=p(et),Fl=s(et,"DIV",{class:!0});var em=a(Fl);y(ta.$$.fragment,em),em.forEach(t),et.forEach(t),sm=p(o),co=s(o,"H2",{class:!0});var Um=a(co);an=s(Um,"A",{id:!0,class:!0,href:!0});var l1=a(an);lc=s(l1,"SPAN",{});var d1=a(lc);y(oa.$$.fragment,d1),d1.forEach(t),l1.forEach(t),ag=p(Um),dc=s(Um,"SPAN",{});var c1=a(dc);rg=i(c1,"XLMRobertaTokenizerFast"),c1.forEach(t),Um.forEach(t),am=p(o),at=s(o,"DIV",{class:!0});var Gt=a(at);y(na.$$.fragment,Gt),ig=p(Gt),yt=s(Gt,"P",{});var Yt=a(yt);lg=i(Yt,"Construct a \u201Cfast\u201D XLM-RoBERTa tokenizer (backed by HuggingFace\u2019s "),cc=s(Yt,"EM",{});var p1=a(cc);dg=i(p1,"tokenizers"),p1.forEach(t),cg=i(Yt,` library). Adapted from
`),xl=s(Yt,"A",{href:!0});var h1=a(xl);pg=i(h1,"RobertaTokenizer"),h1.forEach(t),hg=i(Yt," and "),Rl=s(Yt,"A",{href:!0});var m1=a(Rl);mg=i(m1,"XLNetTokenizer"),m1.forEach(t),ug=i(Yt,`. Based on
`),sa=s(Yt,"A",{href:!0,rel:!0});var u1=a(sa);fg=i(u1,"BPE"),u1.forEach(t),gg=i(Yt,"."),Yt.forEach(t),_g=p(Gt),aa=s(Gt,"P",{});var Qm=a(aa);bg=i(Qm,"This tokenizer inherits from "),Ll=s(Qm,"A",{href:!0});var f1=a(Ll);kg=i(f1,"PreTrainedTokenizerFast"),f1.forEach(t),vg=i(Qm,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Qm.forEach(t),Tg=p(Gt),Kt=s(Gt,"DIV",{class:!0});var Ed=a(Kt);y(ra.$$.fragment,Ed),yg=p(Ed),pc=s(Ed,"P",{});var g1=a(pc);wg=i(g1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),g1.forEach(t),$g=p(Ed),ia=s(Ed,"UL",{});var Hm=a(ia);El=s(Hm,"LI",{});var r1=a(El);Mg=i(r1,"single sequence: "),hc=s(r1,"CODE",{});var _1=a(hc);Fg=i(_1,"<s> X </s>"),_1.forEach(t),r1.forEach(t),xg=p(Hm),zl=s(Hm,"LI",{});var i1=a(zl);Rg=i(i1,"pair of sequences: "),mc=s(i1,"CODE",{});var b1=a(mc);Lg=i(b1,"<s> A </s></s> B </s>"),b1.forEach(t),i1.forEach(t),Hm.forEach(t),Ed.forEach(t),Eg=p(Gt),rn=s(Gt,"DIV",{class:!0});var Vm=a(rn);y(la.$$.fragment,Vm),zg=p(Vm),uc=s(Vm,"P",{});var k1=a(uc);qg=i(k1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),k1.forEach(t),Vm.forEach(t),Gt.forEach(t),rm=p(o),po=s(o,"H2",{class:!0});var Jm=a(po);ln=s(Jm,"A",{id:!0,class:!0,href:!0});var v1=a(ln);fc=s(v1,"SPAN",{});var T1=a(fc);y(da.$$.fragment,T1),T1.forEach(t),v1.forEach(t),Cg=p(Jm),gc=s(Jm,"SPAN",{});var y1=a(gc);jg=i(y1,"XLMRobertaModel"),y1.forEach(t),Jm.forEach(t),im=p(o),He=s(o,"DIV",{class:!0});var jt=a(He);y(ca.$$.fragment,jt),Xg=p(jt),_c=s(jt,"P",{});var w1=a(_c);Pg=i(w1,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),w1.forEach(t),Ag=p(jt),pa=s(jt,"P",{});var Km=a(pa);Og=i(Km,"This model inherits from "),ql=s(Km,"A",{href:!0});var $1=a(ql);Ng=i($1,"PreTrainedModel"),$1.forEach(t),Ig=i(Km,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Km.forEach(t),Dg=p(jt),ha=s(jt,"P",{});var Gm=a(ha);Sg=i(Gm,"This model is also a PyTorch "),ma=s(Gm,"A",{href:!0,rel:!0});var M1=a(ma);Wg=i(M1,"torch.nn.Module"),M1.forEach(t),Bg=i(Gm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gm.forEach(t),Ug=p(jt),ua=s(jt,"P",{});var Ym=a(ua);Qg=i(Ym,"This class overrides "),Cl=s(Ym,"A",{href:!0});var F1=a(Cl);Hg=i(F1,"RobertaModel"),F1.forEach(t),Vg=i(Ym,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Ym.forEach(t),Jg=p(jt),wt=s(jt,"DIV",{class:!0});var xs=a(wt);y(fa.$$.fragment,xs),Kg=p(xs),ho=s(xs,"P",{});var zd=a(ho);Gg=i(zd,"The "),jl=s(zd,"A",{href:!0});var x1=a(jl);Yg=i(x1,"RobertaModel"),x1.forEach(t),Zg=i(zd," forward method, overrides the "),bc=s(zd,"CODE",{});var R1=a(bc);e_=i(R1,"__call__"),R1.forEach(t),t_=i(zd," special method."),zd.forEach(t),o_=p(xs),y(dn.$$.fragment,xs),n_=p(xs),y(cn.$$.fragment,xs),xs.forEach(t),jt.forEach(t),lm=p(o),mo=s(o,"H2",{class:!0});var Zm=a(mo);pn=s(Zm,"A",{id:!0,class:!0,href:!0});var L1=a(pn);kc=s(L1,"SPAN",{});var E1=a(kc);y(ga.$$.fragment,E1),E1.forEach(t),L1.forEach(t),s_=p(Zm),vc=s(Zm,"SPAN",{});var z1=a(vc);a_=i(z1,"XLMRobertaForCausalLM"),z1.forEach(t),Zm.forEach(t),dm=p(o),Ve=s(o,"DIV",{class:!0});var Xt=a(Ve);y(_a.$$.fragment,Xt),r_=p(Xt),ba=s(Xt,"P",{});var eu=a(ba);i_=i(eu,"XLM-RoBERTa Model with a "),Tc=s(eu,"CODE",{});var q1=a(Tc);l_=i(q1,"language modeling"),q1.forEach(t),d_=i(eu," head on top for CLM fine-tuning."),eu.forEach(t),c_=p(Xt),ka=s(Xt,"P",{});var tu=a(ka);p_=i(tu,"This model inherits from "),Xl=s(tu,"A",{href:!0});var C1=a(Xl);h_=i(C1,"PreTrainedModel"),C1.forEach(t),m_=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tu.forEach(t),u_=p(Xt),va=s(Xt,"P",{});var ou=a(va);f_=i(ou,"This model is also a PyTorch "),Ta=s(ou,"A",{href:!0,rel:!0});var j1=a(Ta);g_=i(j1,"torch.nn.Module"),j1.forEach(t),__=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),b_=p(Xt),ya=s(Xt,"P",{});var nu=a(ya);k_=i(nu,"This class overrides "),Pl=s(nu,"A",{href:!0});var X1=a(Pl);v_=i(X1,"RobertaForCausalLM"),X1.forEach(t),T_=i(nu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),nu.forEach(t),y_=p(Xt),$t=s(Xt,"DIV",{class:!0});var Rs=a($t);y(wa.$$.fragment,Rs),w_=p(Rs),uo=s(Rs,"P",{});var qd=a(uo);$_=i(qd,"The "),Al=s(qd,"A",{href:!0});var P1=a(Al);M_=i(P1,"RobertaForCausalLM"),P1.forEach(t),F_=i(qd," forward method, overrides the "),yc=s(qd,"CODE",{});var A1=a(yc);x_=i(A1,"__call__"),A1.forEach(t),R_=i(qd," special method."),qd.forEach(t),L_=p(Rs),y(hn.$$.fragment,Rs),E_=p(Rs),y(mn.$$.fragment,Rs),Rs.forEach(t),Xt.forEach(t),cm=p(o),fo=s(o,"H2",{class:!0});var su=a(fo);un=s(su,"A",{id:!0,class:!0,href:!0});var O1=a(un);wc=s(O1,"SPAN",{});var N1=a(wc);y($a.$$.fragment,N1),N1.forEach(t),O1.forEach(t),z_=p(su),$c=s(su,"SPAN",{});var I1=a($c);q_=i(I1,"XLMRobertaForMaskedLM"),I1.forEach(t),su.forEach(t),pm=p(o),Je=s(o,"DIV",{class:!0});var Pt=a(Je);y(Ma.$$.fragment,Pt),C_=p(Pt),Fa=s(Pt,"P",{});var au=a(Fa);j_=i(au,"XLM-RoBERTa Model with a "),Mc=s(au,"CODE",{});var D1=a(Mc);X_=i(D1,"language modeling"),D1.forEach(t),P_=i(au," head on top."),au.forEach(t),A_=p(Pt),xa=s(Pt,"P",{});var ru=a(xa);O_=i(ru,"This model inherits from "),Ol=s(ru,"A",{href:!0});var S1=a(Ol);N_=i(S1,"PreTrainedModel"),S1.forEach(t),I_=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ru.forEach(t),D_=p(Pt),Ra=s(Pt,"P",{});var iu=a(Ra);S_=i(iu,"This model is also a PyTorch "),La=s(iu,"A",{href:!0,rel:!0});var W1=a(La);W_=i(W1,"torch.nn.Module"),W1.forEach(t),B_=i(iu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),iu.forEach(t),U_=p(Pt),Ea=s(Pt,"P",{});var lu=a(Ea);Q_=i(lu,"This class overrides "),Nl=s(lu,"A",{href:!0});var B1=a(Nl);H_=i(B1,"RobertaForMaskedLM"),B1.forEach(t),V_=i(lu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),lu.forEach(t),J_=p(Pt),rt=s(Pt,"DIV",{class:!0});var Zt=a(rt);y(za.$$.fragment,Zt),K_=p(Zt),go=s(Zt,"P",{});var Cd=a(go);G_=i(Cd,"The "),Il=s(Cd,"A",{href:!0});var U1=a(Il);Y_=i(U1,"RobertaForMaskedLM"),U1.forEach(t),Z_=i(Cd," forward method, overrides the "),Fc=s(Cd,"CODE",{});var Q1=a(Fc);eb=i(Q1,"__call__"),Q1.forEach(t),tb=i(Cd," special method."),Cd.forEach(t),ob=p(Zt),y(fn.$$.fragment,Zt),nb=p(Zt),y(gn.$$.fragment,Zt),sb=p(Zt),y(_n.$$.fragment,Zt),Zt.forEach(t),Pt.forEach(t),hm=p(o),_o=s(o,"H2",{class:!0});var du=a(_o);bn=s(du,"A",{id:!0,class:!0,href:!0});var H1=a(bn);xc=s(H1,"SPAN",{});var V1=a(xc);y(qa.$$.fragment,V1),V1.forEach(t),H1.forEach(t),ab=p(du),Rc=s(du,"SPAN",{});var J1=a(Rc);rb=i(J1,"XLMRobertaForSequenceClassification"),J1.forEach(t),du.forEach(t),mm=p(o),Ke=s(o,"DIV",{class:!0});var At=a(Ke);y(Ca.$$.fragment,At),ib=p(At),Lc=s(At,"P",{});var K1=a(Lc);lb=i(K1,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),K1.forEach(t),db=p(At),ja=s(At,"P",{});var cu=a(ja);cb=i(cu,"This model inherits from "),Dl=s(cu,"A",{href:!0});var G1=a(Dl);pb=i(G1,"PreTrainedModel"),G1.forEach(t),hb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),mb=p(At),Xa=s(At,"P",{});var pu=a(Xa);ub=i(pu,"This model is also a PyTorch "),Pa=s(pu,"A",{href:!0,rel:!0});var Y1=a(Pa);fb=i(Y1,"torch.nn.Module"),Y1.forEach(t),gb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),_b=p(At),Aa=s(At,"P",{});var hu=a(Aa);bb=i(hu,"This class overrides "),Sl=s(hu,"A",{href:!0});var Z1=a(Sl);kb=i(Z1,"RobertaForSequenceClassification"),Z1.forEach(t),vb=i(hu,`. Please check the superclass for the appropriate
...
alongside usage examples.`),Du.forEach(t),GT=p(_t),xt=s(_t,"DIV",{class:!0});var zs=a(xt);y(jr.$$.fragment,zs),YT=p(zs),Co=s(zs,"P",{});var Sd=a(Co);ZT=i(Sd,"The "),cd=s(Sd,"A",{href:!0});var cF=a(cd);ey=i(cF,"TFRobertaForMultipleChoice"),cF.forEach(t),ty=i(Sd," forward method, overrides the "),ap=s(Sd,"CODE",{});var pF=a(ap);oy=i(pF,"__call__"),pF.forEach(t),ny=i(Sd," special method."),Sd.forEach(t),sy=p(zs),y(Gn.$$.fragment,zs),ay=p(zs),y(Yn.$$.fragment,zs),zs.forEach(t),_t.forEach(t),Rm=p(o),jo=s(o,"H2",{class:!0});var Su=a(jo);Zn=s(Su,"A",{id:!0,class:!0,href:!0});var hF=a(Zn);rp=s(hF,"SPAN",{});var mF=a(rp);y(Xr.$$.fragment,mF),mF.forEach(t),hF.forEach(t),ry=p(Su),ip=s(Su,"SPAN",{});var uF=a(ip);iy=i(uF,"TFXLMRobertaForTokenClassification"),uF.forEach(t),Su.forEach(t),Lm=p(o),Se=s(o,"DIV",{class:!0});var bt=a(Se);y(Pr.$$.fragment,bt),ly=p(bt),lp=s(bt,"P",{});var fF=a(lp);dy=i(fF,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),fF.forEach(t),cy=p(bt),Ar=s(bt,"P",{});var Wu=a(Ar);py=i(Wu,"This model inherits from "),pd=s(Wu,"A",{href:!0});var gF=a(pd);hy=i(gF,"TFPreTrainedModel"),gF.forEach(t),my=i(Wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wu.forEach(t),uy=p(bt),Or=s(bt,"P",{});var Bu=a(Or);fy=i(Bu,"This model is also a "),Nr=s(Bu,"A",{href:!0,rel:!0});var _F=a(Nr);gy=i(_F,"tf.keras.Model"),_F.forEach(t),_y=i(Bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bu.forEach(t),by=p(bt),y(es.$$.fragment,bt),ky=p(bt),Ir=s(bt,"P",{});var Uu=a(Ir);vy=i(Uu,"This class overrides "),hd=s(Uu,"A",{href:!0});var bF=a(hd);Ty=i(bF,"TFRobertaForTokenClassification"),bF.forEach(t),yy=i(Uu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Uu.forEach(t),wy=p(bt),pt=s(bt,"DIV",{class:!0});var so=a(pt);y(Dr.$$.fragment,so),$y=p(so),Xo=s(so,"P",{});var Wd=a(Xo);My=i(Wd,"The "),md=s(Wd,"A",{href:!0});var kF=a(md);Fy=i(kF,"TFRobertaForTokenClassification"),kF.forEach(t),xy=i(Wd," forward method, overrides the "),dp=s(Wd,"CODE",{});var vF=a(dp);Ry=i(vF,"__call__"),vF.forEach(t),Ly=i(Wd," special method."),Wd.forEach(t),Ey=p(so),y(ts.$$.fragment,so),zy=p(so),y(os.$$.fragment,so),qy=p(so),y(ns.$$.fragment,so),so.forEach(t),bt.forEach(t),Em=p(o),Po=s(o,"H2",{class:!0});var Qu=a(Po);ss=s(Qu,"A",{id:!0,class:!0,href:!0});var TF=a(ss);cp=s(TF,"SPAN",{});var yF=a(cp);y(Sr.$$.fragment,yF),yF.forEach(t),TF.forEach(t),Cy=p(Qu),pp=s(Qu,"SPAN",{});var wF=a(pp);jy=i(wF,"TFXLMRobertaForQuestionAnswering"),wF.forEach(t),Qu.forEach(t),zm=p(o),We=s(o,"DIV",{class:!0});var kt=a(We);y(Wr.$$.fragment,kt),Xy=p(kt),Ao=s(kt,"P",{});var Bd=a(Ao);Py=i(Bd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Bd,"CODE",{});var $F=a(hp);Ay=i($F,"span start logits"),$F.forEach(t),Oy=i(Bd," and "),mp=s(Bd,"CODE",{});var MF=a(mp);Ny=i(MF,"span end logits"),MF.forEach(t),Iy=i(Bd,")."),Bd.forEach(t),Dy=p(kt),Br=s(kt,"P",{});var Hu=a(Br);Sy=i(Hu,"This model inherits from "),ud=s(Hu,"A",{href:!0});var FF=a(ud);Wy=i(FF,"TFPreTrainedModel"),FF.forEach(t),By=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hu.forEach(t),Uy=p(kt),Ur=s(kt,"P",{});var Vu=a(Ur);Qy=i(Vu,"This model is also a "),Qr=s(Vu,"A",{href:!0,rel:!0});var xF=a(Qr);Hy=i(xF,"tf.keras.Model"),xF.forEach(t),Vy=i(Vu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vu.forEach(t),Jy=p(kt),y(as.$$.fragment,kt),Ky=p(kt),Hr=s(kt,"P",{});var Ju=a(Hr);Gy=i(Ju,"This class overrides "),up=s(Ju,"CODE",{});var RF=a(up);Yy=i(RF,"TFRobertaForQuestionAnsweringSimple"),RF.forEach(t),Zy=i(Ju,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Ju.forEach(t),ew=p(kt),ht=s(kt,"DIV",{class:!0});var ao=a(ht);y(Vr.$$.fragment,ao),tw=p(ao),Oo=s(ao,"P",{});var Ud=a(Oo);ow=i(Ud,"The "),fd=s(Ud,"A",{href:!0});var LF=a(fd);nw=i(LF,"TFRobertaForQuestionAnswering"),LF.forEach(t),sw=i(Ud," forward method, overrides the "),fp=s(Ud,"CODE",{});var EF=a(fp);aw=i(EF,"__call__"),EF.forEach(t),rw=i(Ud," special method."),Ud.forEach(t),iw=p(ao),y(rs.$$.fragment,ao),lw=p(ao),y(is.$$.fragment,ao),dw=p(ao),y(ls.$$.fragment,ao),ao.forEach(t),kt.forEach(t),qm=p(o),No=s(o,"H2",{class:!0});var Ku=a(No);ds=s(Ku,"A",{id:!0,class:!0,href:!0});var zF=a(ds);gp=s(zF,"SPAN",{});var qF=a(gp);y(Jr.$$.fragment,qF),qF.forEach(t),zF.forEach(t),cw=p(Ku),_p=s(Ku,"SPAN",{});var CF=a(_p);pw=i(CF,"FlaxXLMRobertaModel"),CF.forEach(t),Ku.forEach(t),Cm=p(o),Be=s(o,"DIV",{class:!0});var vt=a(Be);y(Kr.$$.fragment,vt),hw=p(vt),Gr=s(vt,"P",{});var Gu=a(Gr);mw=i(Gu,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=s(Gu,"A",{href:!0});var jF=a(gd);uw=i(jF,"FlaxPreTrainedModel"),jF.forEach(t),fw=i(Gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gu.forEach(t),gw=p(vt),Yr=s(vt,"P",{});var Yu=a(Yr);_w=i(Yu,"This model is also a Flax Linen "),Zr=s(Yu,"A",{href:!0,rel:!0});var XF=a(Zr);bw=i(XF,"flax.linen.Module"),XF.forEach(t),kw=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),vw=p(vt),bp=s(vt,"P",{});var PF=a(bp);Tw=i(PF,"Finally, this model supports inherent JAX features such as:"),PF.forEach(t),yw=p(vt),St=s(vt,"UL",{});var qs=a(St);kp=s(qs,"LI",{});var AF=a(kp);ei=s(AF,"A",{href:!0,rel:!0});var OF=a(ei);ww=i(OF,"Just-In-Time (JIT) compilation"),OF.forEach(t),AF.forEach(t),$w=p(qs),vp=s(qs,"LI",{});var NF=a(vp);ti=s(NF,"A",{href:!0,rel:!0});var IF=a(ti);Mw=i(IF,"Automatic Differentiation"),IF.forEach(t),NF.forEach(t),Fw=p(qs),Tp=s(qs,"LI",{});var DF=a(Tp);oi=s(DF,"A",{href:!0,rel:!0});var SF=a(oi);xw=i(SF,"Vectorization"),SF.forEach(t),DF.forEach(t),Rw=p(qs),yp=s(qs,"LI",{});var WF=a(yp);ni=s(WF,"A",{href:!0,rel:!0});var BF=a(ni);Lw=i(BF,"Parallelization"),BF.forEach(t),WF.forEach(t),qs.forEach(t),Ew=p(vt),si=s(vt,"P",{});var Zu=a(si);zw=i(Zu,"This class overrides "),_d=s(Zu,"A",{href:!0});var UF=a(_d);qw=i(UF,"FlaxRobertaModel"),UF.forEach(t),Cw=i(Zu,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Zu.forEach(t),jw=p(vt),Rt=s(vt,"DIV",{class:!0});var Cs=a(Rt);y(ai.$$.fragment,Cs),Xw=p(Cs),Io=s(Cs,"P",{});var Qd=a(Io);Pw=i(Qd,"The "),wp=s(Qd,"CODE",{});var QF=a(wp);Aw=i(QF,"FlaxRobertaPreTrainedModel"),QF.forEach(t),Ow=i(Qd," forward method, overrides the "),$p=s(Qd,"CODE",{});var HF=a($p);Nw=i(HF,"__call__"),HF.forEach(t),Iw=i(Qd," special method."),Qd.forEach(t),Dw=p(Cs),y(cs.$$.fragment,Cs),Sw=p(Cs),y(ps.$$.fragment,Cs),Cs.forEach(t),vt.forEach(t),jm=p(o),Do=s(o,"H2",{class:!0});var ef=a(Do);hs=s(ef,"A",{id:!0,class:!0,href:!0});var VF=a(hs);Mp=s(VF,"SPAN",{});var JF=a(Mp);y(ri.$$.fragment,JF),JF.forEach(t),VF.forEach(t),Ww=p(ef),Fp=s(ef,"SPAN",{});var KF=a(Fp);Bw=i(KF,"FlaxXLMRobertaForMaskedLM"),KF.forEach(t),ef.forEach(t),Xm=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(ii.$$.fragment,Tt),Uw=p(Tt),So=s(Tt,"P",{});var Hd=a(So);Qw=i(Hd,"XLM-RoBERTa Model with a "),xp=s(Hd,"CODE",{});var GF=a(xp);Hw=i(GF,"language modeling"),GF.forEach(t),Vw=i(Hd,` head on top.
This model inherits from `),bd=s(Hd,"A",{href:!0});var YF=a(bd);Jw=i(YF,"FlaxPreTrainedModel"),YF.forEach(t),Kw=i(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hd.forEach(t),Gw=p(Tt),li=s(Tt,"P",{});var tf=a(li);Yw=i(tf,"This model is also a Flax Linen "),di=s(tf,"A",{href:!0,rel:!0});var ZF=a(di);Zw=i(ZF,"flax.linen.Module"),ZF.forEach(t),e0=i(tf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tf.forEach(t),t0=p(Tt),Rp=s(Tt,"P",{});var ex=a(Rp);o0=i(ex,"Finally, this model supports inherent JAX features such as:"),ex.forEach(t),n0=p(Tt),Wt=s(Tt,"UL",{});var js=a(Wt);Lp=s(js,"LI",{});var tx=a(Lp);ci=s(tx,"A",{href:!0,rel:!0});var ox=a(ci);s0=i(ox,"Just-In-Time (JIT) compilation"),ox.forEach(t),tx.forEach(t),a0=p(js),Ep=s(js,"LI",{});var nx=a(Ep);pi=s(nx,"A",{href:!0,rel:!0});var sx=a(pi);r0=i(sx,"Automatic Differentiation"),sx.forEach(t),nx.forEach(t),i0=p(js),zp=s(js,"LI",{});var ax=a(zp);hi=s(ax,"A",{href:!0,rel:!0});var rx=a(hi);l0=i(rx,"Vectorization"),rx.forEach(t),ax.forEach(t),d0=p(js),qp=s(js,"LI",{});var ix=a(qp);mi=s(ix,"A",{href:!0,rel:!0});var lx=a(mi);c0=i(lx,"Parallelization"),lx.forEach(t),ix.forEach(t),js.forEach(t),p0=p(Tt),ui=s(Tt,"P",{});var of=a(ui);h0=i(of,"This class overrides "),kd=s(of,"A",{href:!0});var dx=a(kd);m0=i(dx,"FlaxRobertaForMaskedLM"),dx.forEach(t),u0=i(of,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),of.forEach(t),f0=p(Tt),Lt=s(Tt,"DIV",{class:!0});var Xs=a(Lt);y(fi.$$.fragment,Xs),g0=p(Xs),Wo=s(Xs,"P",{});var Vd=a(Wo);_0=i(Vd,"The "),Cp=s(Vd,"CODE",{});var cx=a(Cp);b0=i(cx,"FlaxRobertaPreTrainedModel"),cx.forEach(t),k0=i(Vd," forward method, overrides the "),jp=s(Vd,"CODE",{});var px=a(jp);v0=i(px,"__call__"),px.forEach(t),T0=i(Vd," special method."),Vd.forEach(t),y0=p(Xs),y(ms.$$.fragment,Xs),w0=p(Xs),y(us.$$.fragment,Xs),Xs.forEach(t),Tt.forEach(t),Pm=p(o),Bo=s(o,"H2",{class:!0});var nf=a(Bo);fs=s(nf,"A",{id:!0,class:!0,href:!0});var hx=a(fs);Xp=s(hx,"SPAN",{});var mx=a(Xp);y(gi.$$.fragment,mx),mx.forEach(t),hx.forEach(t),$0=p(nf),Pp=s(nf,"SPAN",{});var ux=a(Pp);M0=i(ux,"FlaxXLMRobertaForSequenceClassification"),ux.forEach(t),nf.forEach(t),Am=p(o),Ce=s(o,"DIV",{class:!0});var tt=a(Ce);y(_i.$$.fragment,tt),F0=p(tt),Ap=s(tt,"P",{});var fx=a(Ap);x0=i(fx,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),fx.forEach(t),R0=p(tt),bi=s(tt,"P",{});var sf=a(bi);L0=i(sf,"This model inherits from "),vd=s(sf,"A",{href:!0});var gx=a(vd);E0=i(gx,"FlaxPreTrainedModel"),gx.forEach(t),z0=i(sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sf.forEach(t),q0=p(tt),ki=s(tt,"P",{});var af=a(ki);C0=i(af,"This model is also a Flax Linen "),vi=s(af,"A",{href:!0,rel:!0});var _x=a(vi);j0=i(_x,"flax.linen.Module"),_x.forEach(t),X0=i(af,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),af.forEach(t),P0=p(tt),Op=s(tt,"P",{});var bx=a(Op);A0=i(bx,"Finally, this model supports inherent JAX features such as:"),bx.forEach(t),O0=p(tt),Bt=s(tt,"UL",{});var Ps=a(Bt);Np=s(Ps,"LI",{});var kx=a(Np);Ti=s(kx,"A",{href:!0,rel:!0});var vx=a(Ti);N0=i(vx,"Just-In-Time (JIT) compilation"),vx.forEach(t),kx.forEach(t),I0=p(Ps),Ip=s(Ps,"LI",{});var Tx=a(Ip);yi=s(Tx,"A",{href:!0,rel:!0});var yx=a(yi);D0=i(yx,"Automatic Differentiation"),yx.forEach(t),Tx.forEach(t),S0=p(Ps),Dp=s(Ps,"LI",{});var wx=a(Dp);wi=s(wx,"A",{href:!0,rel:!0});var $x=a(wi);W0=i($x,"Vectorization"),$x.forEach(t),wx.forEach(t),B0=p(Ps),Sp=s(Ps,"LI",{});var Mx=a(Sp);$i=s(Mx,"A",{href:!0,rel:!0});var Fx=a($i);U0=i(Fx,"Parallelization"),Fx.forEach(t),Mx.forEach(t),Ps.forEach(t),Q0=p(tt),Mi=s(tt,"P",{});var rf=a(Mi);H0=i(rf,"This class overrides "),Td=s(rf,"A",{href:!0});var xx=a(Td);V0=i(xx,"FlaxRobertaForSequenceClassification"),xx.forEach(t),J0=i(rf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),rf.forEach(t),K0=p(tt),Et=s(tt,"DIV",{class:!0});var As=a(Et);y(Fi.$$.fragment,As),G0=p(As),Uo=s(As,"P",{});var Jd=a(Uo);Y0=i(Jd,"The "),Wp=s(Jd,"CODE",{});var Rx=a(Wp);Z0=i(Rx,"FlaxRobertaPreTrainedModel"),Rx.forEach(t),e$=i(Jd," forward method, overrides the "),Bp=s(Jd,"CODE",{});var Lx=a(Bp);t$=i(Lx,"__call__"),Lx.forEach(t),o$=i(Jd," special method."),Jd.forEach(t),n$=p(As),y(gs.$$.fragment,As),s$=p(As),y(_s.$$.fragment,As),As.forEach(t),tt.forEach(t),Om=p(o),Qo=s(o,"H2",{class:!0});var lf=a(Qo);bs=s(lf,"A",{id:!0,class:!0,href:!0});var Ex=a(bs);Up=s(Ex,"SPAN",{});var zx=a(Up);y(xi.$$.fragment,zx),zx.forEach(t),Ex.forEach(t),a$=p(lf),Qp=s(lf,"SPAN",{});var qx=a(Qp);r$=i(qx,"FlaxXLMRobertaForMultipleChoice"),qx.forEach(t),lf.forEach(t),Nm=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Ri.$$.fragment,ot),i$=p(ot),Hp=s(ot,"P",{});var Cx=a(Hp);l$=i(Cx,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
