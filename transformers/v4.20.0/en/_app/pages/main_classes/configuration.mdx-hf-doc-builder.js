import{S as Es,i as xs,s as Ts,e as r,k as d,w as y,t as o,M as Ds,c as a,d as t,m as l,a as s,x as w,h as n,b as p,G as e,g as x,y as $,q as k,o as P,B as C,v as js,L as Ps}from"../../chunks/vendor-hf-doc-builder.js";import{T as $a}from"../../chunks/Tip-hf-doc-builder.js";import{D as T}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Cs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as $s}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ks}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function zs(z){let f,b,u,g,E;return{c(){f=r("p"),b=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&quot;foo&quot;</span>: <span class="hljs-literal">False</span>}`}}),{c(){f=r("p"),b=o("Examples:"),u=d(),y(g.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=n(_,"Examples:"),_.forEach(t),u=l(c),w(g.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,u,_),$(g,c,_),E=!0},p:Ps,i(c){E||(k(g.$$.fragment,c),E=!0)},o(c){P(g.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(u),C(g,c)}}}function Ss(z){let f,b;return{c(){f=r("p"),b=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(u){f=a(u,"P",{});var g=s(f);b=n(g,"This API is experimental and may have some slight breaking changes in the next releases."),g.forEach(t)},m(u,g){x(u,f,g),e(f,b)},d(u){u&&t(f)}}}function Fs(z){let f,b,u,g,E,c,_,q,Do,ao,H,jo,Ge,zo,Ao,so,D,Oo,dt,qo,So,lt,Fo,Io,ct,Lo,No,ft,Wo,Mo,io,R,G,mt,$e,Vo,ht,Bo,lo,m,ke,Ro,ut,Uo,Jo,X,Ho,gt,Go,Xo,S,W,pt,Ko,Qo,_t,Yo,Zo,Xe,en,tn,on,j,bt,nn,rn,vt,an,sn,Ke,dn,ln,Qe,cn,fn,Ye,mn,hn,un,K,yt,gn,pn,wt,_n,bn,vn,Q,$t,yn,wn,kt,$n,kn,Pn,Pt,Cn,En,F,Y,Ct,xn,Tn,Et,Dn,jn,zn,Z,xt,An,On,Tt,qn,Sn,Fn,ee,Dt,In,Ln,jt,Nn,Wn,Mn,te,zt,Vn,Bn,At,Rn,Un,Jn,M,Pe,Hn,Ce,Gn,Ot,Xn,Kn,Qn,oe,Yn,ne,Ee,Zn,I,er,qt,tr,or,St,nr,rr,Ft,ar,sr,ir,re,xe,dr,Te,lr,Ze,cr,fr,mr,ae,De,hr,je,ur,et,gr,pr,_r,A,ze,br,Ae,vr,tt,yr,wr,$r,se,kr,ie,Pr,de,Oe,Cr,L,Er,It,xr,Tr,ot,Dr,jr,Lt,zr,Ar,Or,V,qe,qr,Se,Sr,Nt,Fr,Ir,Lr,le,Nr,ce,Fe,Wr,U,Mr,Wt,Vr,Br,nt,Rr,Ur,Jr,fe,Ie,Hr,Mt,Gr,Xr,me,Le,Kr,Vt,Qr,Yr,he,Ne,Zr,Bt,ea,ta,ue,We,oa,Rt,na,ra,ge,Me,aa,Ve,sa,Ut,ia,da,la,O,Be,ca,Re,fa,Jt,ma,ha,ua,J,ga,Ht,pa,_a,Gt,ba,va,ya,Xt,wa,co;return c=new $s({}),$e=new $s({}),ke=new T({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
Store the string that was passed to <a href="/docs/transformers/v4.20.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">PreTrainedModel.from_pretrained()</a> or
<a href="/docs/transformers/v4.20.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">TFPreTrainedModel.from_pretrained()</a> as <code>pretrained_model_name_or_path</code> if the configuration was created
...
that can be used as decoder models within the <a href="/docs/transformers/v4.20.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
Forward Chunking work?</a>.`,name:"chunk_size_feed_forward"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/configuration_utils.py#L54",parameterGroups:[{title:"Parameters for sequence generation",parametersDescription:`
<ul>
...
Whether the model should return a <a
  href="/docs/transformers/v4.20.0/en/main_classes/output#transformers.utils.ModelOutput"
...
<code>repo_url</code> is not specified.`,name:"use_auth_token"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/utils/hub.py#L855",returnDescription:`
...
Additional parameters from which to initialize the configuration object.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/configuration_utils.py#L663",returnDescription:`
<p>The configuration object instantiated from those parameters.</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig"
...
Path to the JSON file containing the parameters.`,name:"json_file"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/configuration_utils.py#L714",returnDescription:`
...
<a href="/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
...
by the <code>return_unused_kwargs</code> keyword parameter.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/configuration_utils.py#L452",returnDescription:`
...
The identifier of the pre-trained checkpoint from which we want the dictionary of parameters.`,name:"pretrained_model_name_or_path"}],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/configuration_utils.py#L535",returnDescription:`
...
`}}),Le=new T({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.20.0/src/transformers/configuration_utils.py#L742",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
...
`),ft=r("code"),Wo=o("vocab_size"),Mo=o("."),io=d(),R=r("h2"),G=r("a"),mt=r("span"),y($e.$$.fragment),Vo=d(),ht=r("span"),Bo=o("PretrainedConfig"),lo=d(),m=r("div"),y(ke.$$.fragment),Ro=d(),ut=r("p"),Uo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Jo=d(),y(X.$$.fragment),Ho=d(),gt=r("p"),Go=o("Class attributes (overridden by derived classes):"),Xo=d(),S=r("ul"),W=r("li"),pt=r("strong"),Ko=o("model_type"),Qo=o(" ("),_t=r("code"),Yo=o("str"),Zo=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
...
`),Qe=r("a"),cn=o("EncoderDecoderConfig"),fn=o(" or "),Ye=r("a"),mn=o("~RagConfig"),hn=o("."),un=d(),K=r("li"),yt=r("strong"),gn=o("keys_to_ignore_at_inference"),pn=o(" ("),wt=r("code"),_n=o("List[str]"),bn=o(`) \u2014 A list of keys to ignore by default when looking at dictionary
...
serializes to a Python dictionary.`),Yr=d(),he=r("div"),y(Ne.$$.fragment),Zr=d(),Bt=r("p"),ea=o("Save this instance to a JSON file."),ta=d(),ue=r("div"),y(We.$$.fragment),oa=d(),Rt=r("p"),na=o("Serializes this instance to a JSON string."),ra=d(),ge=r("div"),y(Me.$$.fragment),aa=d(),Ve=r("p"),sa=o("Updates attributes of this class with attributes from "),Ut=r("code"),ia=o("config_dict"),da=o("."),la=d(),O=r("div"),y(Be.$$.fragment),ca=d(),Re=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ma=o("update_str"),ha=o("."),ua=d(),J=r("p"),ga=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),pa=o("true"),_a=o(" or "),Gt=r("code"),ba=o("false"),va=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),ya=d(),Xt=r("p"),wa=o("The keys to change have to already exist in the config object."),this.h()},l(i){const v=Ds('[data-svelte="svelte-1phssyn"]',document.head);f=a(v,"META",{name:!0,content:!0}),v.forEach(t),b=l(i),u=a(i,"H1",{class:!0});var Ue=s(u);g=a(Ue,"A",{id:!0,class:!0,href:!0});var Kt=s(g);E=a(Kt,"SPAN",{});var Qt=s(E);w(c.$$.fragment,Qt),Qt.forEach(t),Kt.forEach(t),_=l(Ue),q=a(Ue,"SPAN",{});var Yt=s(q);Do=n(Yt,"Configuration"),Yt.forEach(t),Ue.forEach(t),ao=l(i),H=a(i,"P",{});var Je=s(H);jo=n(Je,"The base class "),Ge=a(Je,"A",{href:!0});var ka=s(Ge);zo=n(ka,"PretrainedConfig"),ka.forEach(t),Ao=n(Je,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),ft=a(B,"CODE",{});var xa=s(ft);Wo=n(xa,"vocab_size"),xa.forEach(t),Mo=n(B,"."),B.forEach(t),io=l(i),R=a(i,"H2",{class:!0});var fo=s(R);G=a(fo,"A",{id:!0,class:!0,href:!0});var Ta=s(G);mt=a(Ta,"SPAN",{});var Da=s(mt);w($e.$$.fragment,Da),Da.forEach(t),Ta.forEach(t),Vo=l(fo),ht=a(fo,"SPAN",{});var ja=s(ht);Bo=n(ja,"PretrainedConfig"),ja.forEach(t),fo.forEach(t),lo=l(i),m=a(i,"DIV",{class:!0});var h=s(m);w(ke.$$.fragment,h),Ro=l(h),ut=a(h,"P",{});var za=s(ut);Uo=n(za,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
`),Qe=a(N,"A",{href:!0});var Na=s(Qe);cn=n(Na,"EncoderDecoderConfig"),Na.forEach(t),fn=n(N," or "),Ye=a(N,"A",{href:!0});var Wa=s(Ye);mn=n(Wa,"~RagConfig"),Wa.forEach(t),hn=n(N,"."),N.forEach(t),un=l(pe),K=a(pe,"LI",{});var Zt=s(K);yt=a(Zt,"STRONG",{});var Ma=s(yt);gn=n(Ma,"keys_to_ignore_at_inference"),Ma.forEach(t),pn=n(Zt," ("),wt=a(Zt,"CODE",{});var Va=s(wt);_n=n(Va,"List[str]"),Va.forEach(t),bn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Zt.forEach(t),vn=l(pe),Q=a(pe,"LI",{});var eo=s(Q);$t=a(eo,"STRONG",{});var Ba=s($t);yn=n(Ba,"attribute_map"),Ba.forEach(t),wn=n(eo," ("),kt=a(eo,"CODE",{});var Ra=s(kt);$n=n(Ra,"Dict[str, str]"),Ra.forEach(t),kn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
...
`),nt=a(st,"A",{href:!0});var ms=s(nt);Rr=n(ms,"from_pretrained()"),ms.forEach(t),Ur=n(st," class method."),st.forEach(t),wo.forEach(t),Jr=l(h),fe=a(h,"DIV",{class:!0});var $o=s(fe);w(Ie.$$.fragment,$o),Hr=l($o),Mt=a($o,"P",{});var hs=s(Mt);Gr=n(hs,"Serializes this instance to a Python dictionary."),hs.forEach(t),$o.forEach(t),Xr=l(h),me=a(h,"DIV",{class:!0});var ko=s(me);w(Le.$$.fragment,ko),Kr=l(ko),Vt=a(ko,"P",{});var us=s(Vt);Qr=n(us,`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),us.forEach(t),ko.forEach(t),Yr=l(h),he=a(h,"DIV",{class:!0});var Po=s(he);w(Ne.$$.fragment,Po),Zr=l(Po),Bt=a(Po,"P",{});var gs=s(Bt);ea=n(gs,"Save this instance to a JSON file."),gs.forEach(t),Po.forEach(t),ta=l(h),ue=a(h,"DIV",{class:!0});var Co=s(ue);w(We.$$.fragment,Co),oa=l(Co),Rt=a(Co,"P",{});var ps=s(Rt);na=n(ps,"Serializes this instance to a JSON string."),ps.forEach(t),Co.forEach(t),ra=l(h),ge=a(h,"DIV",{class:!0});var Eo=s(ge);w(Me.$$.fragment,Eo),aa=l(Eo),Ve=a(Eo,"P",{});var xo=s(Ve);sa=n(xo,"Updates attributes of this class with attributes from "),Ut=a(xo,"CODE",{});var _s=s(Ut);ia=n(_s,"config_dict"),_s.forEach(t),da=n(xo,"."),xo.forEach(t),Eo.forEach(t),la=l(h),O=a(h,"DIV",{class:!0});var we=s(O);w(Be.$$.fragment,we),ca=l(we),Re=a(we,"P",{});var To=s(Re);fa=n(To,"Updates attributes of this class with attributes from "),Jt=a(To,"CODE",{});var bs=s(Jt);ma=n(bs,"update_str"),bs.forEach(t),ha=n(To,"."),To.forEach(t),ua=l(we),J=a(we,"P",{});var it=s(J);ga=n(it,"The expected format is ints, floats and strings as is, and for booleans use "),Ht=a(it,"CODE",{});var vs=s(Ht);pa=n(vs,"true"),vs.forEach(t),_a=n(it," or "),Gt=a(it,"CODE",{});var ys=s(Gt);ba=n(ys,"false"),ys.forEach(t),va=n(it,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),it.forEach(t),ya=l(we),Xt=a(we,"P",{});var ws=s(Xt);wa=n(ws,"The keys to change have to already exist in the config object."),ws.forEach(t),we.forEach(t),h.forEach(t),this.h()},h(){p(f,"name","hf:doc:metadata"),p(f,"content",JSON.stringify(Is)),p(g,"id","configuration"),p(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(g,"href","#configuration"),p(u,"class","relative group"),p(Ge,"href","/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig"),p(G,"id","transformers.PretrainedConfig"),p(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(G,"href","#transformers.PretrainedConfig"),p(R,"class","relative group"),p(Xe,"href","/docs/transformers/v4.20.0/en/model_doc/auto#transformers.AutoConfig"),p(Ke,"href","/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig"),p(Qe,"href","/docs/transformers/v4.20.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),p(Ye,"href","/docs/transformers/v4.20.0/en/model_doc/rag#transformers.RagConfig"),p(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ze,"href","/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig"),p(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(et,"href","/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig"),p(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(tt,"href","/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig"),p(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ot,"href","/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig"),p(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(nt,"href","/docs/transformers/v4.20.0/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),p(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(m,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,v){e(document.head,f),x(i,b,v),x(i,u,v),e(u,g),e(g,E),$(c,E,null),e(u,_),e(u,q),e(q,Do),x(i,ao,v),x(i,H,v),e(H,jo),e(H,Ge),e(Ge,zo),e(H,Ao),x(i,so,v),x(i,D,v),e(D,Oo),e(D,dt),e(dt,qo),e(D,So),e(D,lt),e(lt,Fo),e(D,Io),e(D,ct),e(ct,Lo),e(D,No),e(D,ft),e(ft,Wo),e(D,Mo),x(i,io,v),x(i,R,v),e(R,G),e(G,mt),$($e,mt,null),e(R,Vo),e(R,ht),e(ht,Bo),x(i,lo,v),x(i,m,v),$(ke,m,null),e(m,Ro),e(m,ut),e(ut,Uo),e(m,Jo),$(X,m,null),e(m,Ho),e(m,gt),e(gt,Go),e(m,Xo),e(m,S),e(S,W),e(W,pt),e(pt,Ko),e(W,Qo),e(W,_t),e(_t,Yo),e(W,Zo),e(W,Xe),e(Xe,en),e(W,tn),e(S,on),e(S,j),e(j,bt),e(bt,nn),e(j,rn),e(j,vt),e(vt,an),e(j,sn),e(j,Ke),e(Ke,dn),e(j,ln),e(j,Qe),e(Qe,cn),e(j,fn),e(j,Ye),e(Ye,mn),e(j,hn),e(S,un),e(S,K),e(K,yt),e(yt,gn),e(K,pn),e(K,wt),e(wt,_n),e(K,bn),e(S,vn),e(S,Q),e(Q,$t),e($t,yn),e(Q,wn),e(Q,kt),e(kt,$n),e(Q,kn),e(m,Pn),e(m,Pt),e(Pt,Cn),e(m,En),e(m,F),e(F,Y),e(Y,Ct),e(Ct,xn),e(Y,Tn),e(Y,Et),e(Et,Dn),e(Y,jn),e(F,zn),e(F,Z),e(Z,xt),e(xt,An),e(Z,On),e(Z,Tt),e(Tt,qn),e(Z,Sn),e(F,Fn),e(F,ee),e(ee,Dt),e(Dt,In),e(ee,Ln),e(ee,jt),e(jt,Nn),e(ee,Wn),e(F,Mn),e(F,te),e(te,zt),e(zt,Vn),e(te,Bn),e(te,At),e(At,Rn),e(te,Un),e(m,Jn),e(m,M),$(Pe,M,null),e(M,Hn),e(M,Ce),e(Ce,Gn),e(Ce,Ot),e(Ot,Xn),e(Ce,Kn),e(M,Qn),$(oe,M,null),e(m,Yn),e(m,ne),$(Ee,ne,null),e(ne,Zn),e(ne,I),e(I,er),e(I,qt),e(qt,tr),e(I,or),e(I,St),e(St,nr),e(I,rr),e(I,Ft),e(Ft,ar),e(I,sr),e(m,ir),e(m,re),$(xe,re,null),e(re,dr),e(re,Te),e(Te,lr),e(Te,Ze),e(Ze,cr),e(Te,fr),e(m,mr),e(m,ae),$(De,ae,null),e(ae,hr),e(ae,je),e(je,ur),e(je,et),e(et,gr),e(je,pr),e(m,_r),e(m,A),$(ze,A,null),e(A,br),e(A,Ae),e(Ae,vr),e(Ae,tt),e(tt,yr),e(Ae,wr),e(A,$r),$(se,A,null),e(A,kr),$(ie,A,null),e(m,Pr),e(m,de),$(Oe,de,null),e(de,Cr),e(de,L),e(L,Er),e(L,It),e(It,xr),e(L,Tr),e(L,ot),e(ot,Dr),e(L,jr),e(L,Lt),e(Lt,zr),e(L,Ar),e(m,Or),e(m,V),$(qe,V,null),e(V,qr),e(V,Se),e(Se,Sr),e(Se,Nt),e(Nt,Fr),e(Se,Ir),e(V,Lr),$(le,V,null),e(m,Nr),e(m,ce),$(Fe,ce,null),e(ce,Wr),e(ce,U),e(U,Mr),e(U,Wt),e(Wt,Vr),e(U,Br),e(U,nt),e(nt,Rr),e(U,Ur),e(m,Jr),e(m,fe),$(Ie,fe,null),e(fe,Hr),e(fe,Mt),e(Mt,Gr),e(m,Xr),e(m,me),$(Le,me,null),e(me,Kr),e(me,Vt),e(Vt,Qr),e(m,Yr),e(m,he),$(Ne,he,null),e(he,Zr),e(he,Bt),e(Bt,ea),e(m,ta),e(m,ue),$(We,ue,null),e(ue,oa),e(ue,Rt),e(Rt,na),e(m,ra),e(m,ge),$(Me,ge,null),e(ge,aa),e(ge,Ve),e(Ve,sa),e(Ve,Ut),e(Ut,ia),e(Ve,da),e(m,la),e(m,O),$(Be,O,null),e(O,ca),e(O,Re),e(Re,fa),e(Re,Jt),e(Jt,ma),e(Re,ha),e(O,ua),e(O,J),e(J,ga),e(J,Ht),e(Ht,pa),e(J,_a),e(J,Gt),e(Gt,ba),e(J,va),e(O,ya),e(O,Xt),e(Xt,wa),co=!0},p(i,[v]){const Ue={};v&2&&(Ue.$$scope={dirty:v,ctx:i}),X.$set(Ue);const Kt={};v&2&&(Kt.$$scope={dirty:v,ctx:i}),oe.$set(Kt);const Qt={};v&2&&(Qt.$$scope={dirty:v,ctx:i}),se.$set(Qt);const Yt={};v&2&&(Yt.$$scope={dirty:v,ctx:i}),ie.$set(Yt);const Je={};v&2&&(Je.$$scope={dirty:v,ctx:i}),le.$set(Je)},i(i){co||(k(c.$$.fragment,i),k($e.$$.fragment,i),k(ke.$$.fragment,i),k(X.$$.fragment,i),k(Pe.$$.fragment,i),k(oe.$$.fragment,i),k(Ee.$$.fragment,i),k(xe.$$.fragment,i),k(De.$$.fragment,i),k(ze.$$.fragment,i),k(se.$$.fragment,i),k(ie.$$.fragment,i),k(Oe.$$.fragment,i),k(qe.$$.fragment,i),k(le.$$.fragment,i),k(Fe.$$.fragment,i),k(Ie.$$.fragment,i),k(Le.$$.fragment,i),k(Ne.$$.fragment,i),k(We.$$.fragment,i),k(Me.$$.fragment,i),k(Be.$$.fragment,i),co=!0)},o(i){P(c.$$.fragment,i),P($e.$$.fragment,i),P(ke.$$.fragment,i),P(X.$$.fragment,i),P(Pe.$$.fragment,i),P(oe.$$.fragment,i),P(Ee.$$.fragment,i),P(xe.$$.fragment,i),P(De.$$.fragment,i),P(ze.$$.fragment,i),P(se.$$.fragment,i),P(ie.$$.fragment,i),P(Oe.$$.fragment,i),P(qe.$$.fragment,i),P(le.$$.fragment,i),P(Fe.$$.fragment,i),P(Ie.$$.fragment,i),P(Le.$$.fragment,i),P(Ne.$$.fragment,i),P(We.$$.fragment,i),P(Me.$$.fragment,i),P(Be.$$.fragment,i),co=!1},d(i){t(f),i&&t(b),i&&t(u),C(c),i&&t(ao),i&&t(H),i&&t(so),i&&t(D),i&&t(io),i&&t(R),C($e),i&&t(lo),i&&t(m),C(ke),C(X),C(Pe),C(oe),C(Ee),C(xe),C(De),C(ze),C(se),C(ie),C(Oe),C(qe),C(le),C(Fe),C(Ie),C(Le),C(Ne),C(We),C(Me),C(Be)}}}const Is={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Ls(z){return js(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Us extends Es{constructor(f){super();xs(this,f,Ls,Fs,Ts,{})}}export{Us as default,Is as metadata};
