...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.2/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_distilbert.py#L625",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_distilbert.py#L723",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_distilbert.py#L1051",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_distilbert.py#L956",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_distilbert.py#L839",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
general usage and behavior.`),Ub=p(),Sd=o("p"),Hb=a("Finally, this model supports inherent JAX features such as:"),Vb=p(),Mt=o("ul"),Id=o("li"),ga=o("a"),Kb=a("Just-In-Time (JIT) compilation"),Jb=p(),Wd=o("li"),_a=o("a"),Gb=a("Automatic Differentiation"),Xb=p(),Qd=o("li"),va=o("a"),Yb=a("Vectorization"),Zb=p(),Rd=o("li"),ba=o("a"),e2=a("Parallelization"),t2=p(),gt=o("div"),T(ka.$$.fragment),s2=p(),zs=o("p"),o2=a("The "),Ud=o("code"),n2=a("FlaxDistilBertPreTrainedModel"),r2=a(" forward method, overrides the "),Hd=o("code"),a2=a("__call__"),i2=a(" special method."),l2=p(),T(Go.$$.fragment),d2=p(),T(Xo.$$.fragment),ih=p(),js=o("h2"),Yo=o("a"),Vd=o("span"),T(Ta.$$.fragment),c2=p(),Kd=o("span"),p2=a("FlaxDistilBertForMaskedLM"),lh=p(),Ee=o("div"),T($a.$$.fragment),h2=p(),wa=o("p"),u2=a("DistilBert Model with a "),Jd=o("code"),f2=a("language modeling"),m2=a(" head on top."),g2=p(),ya=o("p"),_2=a("This model inherits from "),il=o("a"),v2=a("FlaxPreTrainedModel"),b2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k2=p(),Fa=o("p"),T2=a("This model is also a Flax Linen "),Da=o("a"),$2=a("flax.linen.Module"),w2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),y2=p(),Gd=o("p"),F2=a("Finally, this model supports inherent JAX features such as:"),D2=p(),Et=o("ul"),Xd=o("li"),xa=o("a"),x2=a("Just-In-Time (JIT) compilation"),B2=p(),Yd=o("li"),Ba=o("a"),M2=a("Automatic Differentiation"),E2=p(),Zd=o("li"),Ma=o("a"),z2=a("Vectorization"),j2=p(),ec=o("li"),Ea=o("a"),C2=a("Parallelization"),q2=p(),_t=o("div"),T(za.$$.fragment),P2=p(),Cs=o("p"),A2=a("The "),tc=o("code"),O2=a("FlaxDistilBertPreTrainedModel"),N2=a(" forward method, overrides the "),sc=o("code"),L2=a("__call__"),S2=a(" special method."),I2=p(),T(Zo.$$.fragment),W2=p(),T(en.$$.fragment),dh=p(),qs=o("h2"),tn=o("a"),oc=o("span"),T(ja.$$.fragment),Q2=p(),nc=o("span"),R2=a("FlaxDistilBertForSequenceClassification"),ch=p(),ze=o("div"),T(Ca.$$.fragment),U2=p(),rc=o("p"),H2=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V2=p(),qa=o("p"),K2=a("This model inherits from "),ll=o("a"),J2=a("FlaxPreTrainedModel"),G2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),X2=p(),Pa=o("p"),Y2=a("This model is also a Flax Linen "),Aa=o("a"),Z2=a("flax.linen.Module"),ek=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),jk=p(),gc=o("p"),Ck=a("Finally, this model supports inherent JAX features such as:"),qk=p(),jt=o("ul"),_c=o("li"),Va=o("a"),Pk=a("Just-In-Time (JIT) compilation"),Ak=p(),vc=o("li"),Ka=o("a"),Ok=a("Automatic Differentiation"),Nk=p(),bc=o("li"),Ja=o("a"),Lk=a("Vectorization"),Sk=p(),kc=o("li"),Ga=o("a"),Ik=a("Parallelization"),Wk=p(),bt=o("div"),T(Xa.$$.fragment),Qk=p(),Os=o("p"),Rk=a("The "),Tc=o("code"),Uk=a("FlaxDistilBertPreTrainedModel"),Hk=a(" forward method, overrides the "),$c=o("code"),Vk=a("__call__"),Kk=a(" special method."),Jk=p(),T(rn.$$.fragment),Gk=p(),T(an.$$.fragment),uh=p(),Ns=o("h2"),ln=o("a"),wc=o("span"),T(Ya.$$.fragment),Xk=p(),yc=o("span"),Yk=a("FlaxDistilBertForTokenClassification"),fh=p(),Ce=o("div"),T(Za.$$.fragment),Zk=p(),Fc=o("p"),eT=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dh.forEach(t),nm=h(Wt),Ke=n(Wt,"DIV",{class:!0});var Qt=r(Ke);$(or.$$.fragment,Qt),rm=h(Qt),is=n(Qt,"P",{});var ul=r(is);am=i(ul,"The "),Li=n(ul,"A",{href:!0});var B$=r(Li);im=i(B$,"DistilBertForMaskedLM"),B$.forEach(t),lm=i(ul," forward method, overrides the "),Kl=n(ul,"CODE",{});var M$=r(Kl);dm=i(M$,"__call__"),M$.forEach(t),cm=i(ul," special method."),ul.forEach(t),pm=h(Qt),$(eo.$$.fragment,Qt),hm=h(Qt),$(to.$$.fragment,Qt),um=h(Qt),$(so.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),Lp=h(s),ls=n(s,"H2",{class:!0});var xh=r(ls);oo=n(xh,"A",{id:!0,class:!0,href:!0});var E$=r(oo);Jl=n(E$,"SPAN",{});var z$=r(Jl);$(nr.$$.fragment,z$),z$.forEach(t),E$.forEach(t),fm=h(xh),Gl=n(xh,"SPAN",{});var j$=r(Gl);mm=i(j$,"DistilBertForSequenceClassification"),j$.forEach(t),xh.forEach(t),Sp=h(s),Re=n(s,"DIV",{class:!0});var Rt=r(Re);$(rr.$$.fragment,Rt),gm=h(Rt),Xl=n(Rt,"P",{});var C$=r(Xl);_m=i(C$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ph.forEach(t),_g=h(Ht),Je=n(Ht,"DIV",{class:!0});var Vt=r(Je);$(Tr.$$.fragment,Vt),vg=h(Vt),us=n(Vt,"P",{});var gl=r(us);bg=i(gl,"The "),Ui=n(gl,"A",{href:!0});var Y$=r(Ui);kg=i(Y$,"DistilBertForTokenClassification"),Y$.forEach(t),Tg=i(gl," forward method, overrides the "),ad=n(gl,"CODE",{});var Z$=r(ad);$g=i(Z$,"__call__"),Z$.forEach(t),wg=i(gl," special method."),gl.forEach(t),yg=h(Vt),$(fo.$$.fragment,Vt),Fg=h(Vt),$(mo.$$.fragment,Vt),Dg=h(Vt),$(go.$$.fragment,Vt),Vt.forEach(t),Ht.forEach(t),Up=h(s),fs=n(s,"H2",{class:!0});var Ah=r(fs);_o=n(Ah,"A",{id:!0,class:!0,href:!0});var ew=r(_o);id=n(ew,"SPAN",{});var tw=r(id);$($r.$$.fragment,tw),tw.forEach(t),ew.forEach(t),xg=h(Ah),ld=n(Ah,"SPAN",{});var sw=r(ld);Bg=i(sw,"DistilBertForQuestionAnswering"),sw.forEach(t),Ah.forEach(t),Hp=h(s),Ve=n(s,"DIV",{class:!0});var Kt=r(Ve);$(wr.$$.fragment,Kt),Mg=h(Kt),ms=n(Kt,"P",{});var _l=r(ms);Eg=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),Uv=h(Dt),sa=n(Dt,"P",{});var eu=r(sa);Hv=i(eu,"This model is also a "),oa=n(eu,"A",{href:!0,rel:!0});var Hw=r(oa);Vv=i(Hw,"tf.keras.Model"),Hw.forEach(t),Kv=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jv=h(Dt),$(So.$$.fragment,Dt),Gv=h(Dt),Ze=n(Dt,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xv=h(Yt),Ds=n(Yt,"P",{});var wl=r(Ds);Yv=i(wl,"The "),ol=n(wl,"A",{href:!0});var Vw=r(ol);Zv=i(Vw,"TFDistilBertForTokenClassification"),Vw.forEach(t),eb=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var Kw=r(zd);tb=i(Kw,"__call__"),Kw.forEach(t),sb=i(wl," special method."),wl.forEach(t),ob=h(Yt),$(Io.$$.fragment,Yt),nb=h(Yt),$(Wo.$$.fragment,Yt),rb=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),oh=h(s),xs=n(s,"H2",{class:!0});var tu=r(xs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var Jw=r(Ro);jd=n(Jw,"SPAN",{});var Gw=r(jd);$(ra.$$.fragment,Gw),Gw.forEach(t),Jw.forEach(t),ab=h(tu),Cd=n(tu,"SPAN",{});var Xw=r(Cd);ib=i(Xw,"TFDistilBertForQuestionAnswering"),Xw.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var xt=r(Ie);$(aa.$$.fragment,xt),lb=h(xt),Bs=n(xt,"P",{});var yl=r(Bs);db=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Yw=r(qd);cb=i(Yw,"span start logits"),Yw.forEach(t),pb=i(yl," and "),Pd=n(yl,"CODE",{});var Zw=r(Pd);hb=i(Zw,"span end logits"),Zw.forEach(t),ub=i(yl,")."),yl.forEach(t),fb=h(xt),ia=n(xt,"P",{});var su=r(ia);mb=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var e1=r(nl);gb=i(e1,"TFPreTrainedModel"),e1.forEach(t),_b=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),vb=h(xt),la=n(xt,"P",{});var ou=r(la);bb=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var t1=r(da);kb=i(t1,"tf.keras.Model"),t1.forEach(t),Tb=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$b=h(xt),$(Uo.$$.fragment,xt),wb=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yb=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);Fb=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var s1=r(rl);Db=i(s1,"TFDistilBertForQuestionAnswering"),s1.forEach(t),xb=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var o1=r(Ad);Bb=i(o1,"__call__"),o1.forEach(t),Mb=i(Fl," special method."),Fl.forEach(t),Eb=h(Zt),$(Ho.$$.fragment,Zt),zb=h(Zt),$(Vo.$$.fragment,Zt),jb=h(Zt),$(Ko.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var n1=r(Jo);Od=n(n1,"SPAN",{});var r1=r(Od);$(pa.$$.fragment,r1),r1.forEach(t),n1.forEach(t),Cb=h(nu),Nd=n(nu,"SPAN",{});var a1=r(Nd);qb=i(a1,"FlaxDistilBertModel"),a1.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),Pb=h(st),Ld=n(st,"P",{});var i1=r(Ld);Ab=i(i1,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i1.forEach(t),Ob=h(st),ua=n(st,"P",{});var ru=r(ua);Nb=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l1=r(al);Lb=i(l1,"FlaxPreTrainedModel"),l1.forEach(t),Sb=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Ib=h(st),fa=n(st,"P",{});var au=r(fa);Wb=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d1=r(ma);Qb=i(d1,"flax.linen.Module"),d1.forEach(t),Rb=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Ub=h(st),Sd=n(st,"P",{});var c1=r(Sd);Hb=i(c1,"Finally, this model supports inherent JAX features such as:"),c1.forEach(t),Vb=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p1=r(Id);ga=n(p1,"A",{href:!0,rel:!0});var h1=r(ga);Kb=i(h1,"Just-In-Time (JIT) compilation"),h1.forEach(t),p1.forEach(t),Jb=h(kn),Wd=n(kn,"LI",{});var u1=r(Wd);_a=n(u1,"A",{href:!0,rel:!0});var f1=r(_a);Gb=i(f1,"Automatic Differentiation"),f1.forEach(t),u1.forEach(t),Xb=h(kn),Qd=n(kn,"LI",{});var m1=r(Qd);va=n(m1,"A",{href:!0,rel:!0});var g1=r(va);Yb=i(g1,"Vectorization"),g1.forEach(t),m1.forEach(t),Zb=h(kn),Rd=n(kn,"LI",{});var _1=r(Rd);ba=n(_1,"A",{href:!0,rel:!0});var v1=r(ba);e2=i(v1,"Parallelization"),v1.forEach(t),_1.forEach(t),kn.forEach(t),t2=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),s2=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);o2=i(Dl,"The "),Ud=n(Dl,"CODE",{});var b1=r(Ud);n2=i(b1,"FlaxDistilBertPreTrainedModel"),b1.forEach(t),r2=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var k1=r(Hd);a2=i(k1,"__call__"),k1.forEach(t),i2=i(Dl," special method."),Dl.forEach(t),l2=h(Tn),$(Go.$$.fragment,Tn),d2=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T1=r(Yo);Vd=n(T1,"SPAN",{});var $1=r(Vd);$(Ta.$$.fragment,$1),$1.forEach(t),T1.forEach(t),c2=h(iu),Kd=n(iu,"SPAN",{});var w1=r(Kd);p2=i(w1,"FlaxDistilBertForMaskedLM"),w1.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),h2=h(ot),wa=n(ot,"P",{});var lu=r(wa);u2=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y1=r(Jd);f2=i(y1,"language modeling"),y1.forEach(t),m2=i(lu," head on top."),lu.forEach(t),g2=h(ot),ya=n(ot,"P",{});var du=r(ya);_2=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var F1=r(il);v2=i(F1,"FlaxPreTrainedModel"),F1.forEach(t),b2=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),k2=h(ot),Fa=n(ot,"P",{});var cu=r(Fa);T2=i(cu,"This model is also a Flax Linen "),Da=n(cu,"A",{href:!0,rel:!0});var D1=r(Da);$2=i(D1,"flax.linen.Module"),D1.forEach(t),w2=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),y2=h(ot),Gd=n(ot,"P",{});var x1=r(Gd);F2=i(x1,"Finally, this model supports inherent JAX features such as:"),x1.forEach(t),D2=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var B1=r(Xd);xa=n(B1,"A",{href:!0,rel:!0});var M1=r(xa);x2=i(M1,"Just-In-Time (JIT) compilation"),M1.forEach(t),B1.forEach(t),B2=h($n),Yd=n($n,"LI",{});var E1=r(Yd);Ba=n(E1,"A",{href:!0,rel:!0});var z1=r(Ba);M2=i(z1,"Automatic Differentiation"),z1.forEach(t),E1.forEach(t),E2=h($n),Zd=n($n,"LI",{});var j1=r(Zd);Ma=n(j1,"A",{href:!0,rel:!0});var C1=r(Ma);z2=i(C1,"Vectorization"),C1.forEach(t),j1.forEach(t),j2=h($n),ec=n($n,"LI",{});var q1=r(ec);Ea=n(q1,"A",{href:!0,rel:!0});var P1=r(Ea);C2=i(P1,"Parallelization"),P1.forEach(t),q1.forEach(t),$n.forEach(t),q2=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),P2=h(wn),Cs=n(wn,"P",{});var xl=r(Cs);A2=i(xl,"The "),tc=n(xl,"CODE",{});var A1=r(tc);O2=i(A1,"FlaxDistilBertPreTrainedModel"),A1.forEach(t),N2=i(xl," forward method, overrides the "),sc=n(xl,"CODE",{});var O1=r(sc);L2=i(O1,"__call__"),O1.forEach(t),S2=i(xl," special method."),xl.forEach(t),I2=h(wn),$(Zo.$$.fragment,wn),W2=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N1=r(tn);oc=n(N1,"SPAN",{});var L1=r(oc);$(ja.$$.fragment,L1),L1.forEach(t),N1.forEach(t),Q2=h(pu),nc=n(pu,"SPAN",{});var S1=r(nc);R2=i(S1,"FlaxDistilBertForSequenceClassification"),S1.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),U2=h(nt),rc=n(nt,"P",{});var I1=r(rc);H2=i(I1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
