import{S as mp,i as up,s as fp,e as n,k as p,w as k,t as r,M as gp,c as s,d as o,m as h,a,x as b,h as i,b as m,G as e,g as v,y as w,q as y,o as T,B as M,v as _p,L as ee}from"../../chunks/vendor-hf-doc-builder.js";import{T as Jo}from"../../chunks/Tip-hf-doc-builder.js";import{D as I}from"../../chunks/Docstring-hf-doc-builder.js";import{C as V}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Z}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as K}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function vp(z){let d,g,l,f,$;return f=new V({props:{code:`from transformers import MvpModel, MvpConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(c,_){v(c,d,_),e(d,g),e(d,l),e(l,f),e(d,$)},d(c){c&&o(d)}}}function Mp(z){let d,g,l,f,$;return f=new V({props:{code:`from transformers import MvpTokenizer, MvpModel
import torch
...
the latter silently ignores them.`)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),l=s(_,"CODE",{});var q=a(l);f=i(q,"Module"),q.forEach(o),$=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(c,_){v(c,d,_),e(d,g),e(d,l),e(l,f),e(d,$)},d(c){c&&o(d)}}}function zp(z){let d,g;return d=new V({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(d.$$.fragment)},l(l){b(d.$$.fragment,l)},m(l,f){w(d,l,f),g=!0},p:ee,i(l){g||(y(d.$$.fragment,l),g=!0)},o(l){T(d.$$.fragment,l),g=!1},d(l){M(d,l)}}}function xp(z){let d,g;return d=new V({props:{code:`with torch.no_grad():
...
the latter silently ignores them.`)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),l=s(_,"CODE",{});var q=a(l);f=i(q,"Module"),q.forEach(o),$=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(c,_){v(c,d,_),e(d,g),e(d,l),e(l,f),e(d,$)},d(c){c&&o(d)}}}function Cp(z){let d,g;return d=new V({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(d.$$.fragment)},l(l){b(d.$$.fragment,l)},m(l,f){w(d,l,f),g=!0},p:ee,i(l){g||(y(d.$$.fragment,l),g=!0)},o(l){T(d.$$.fragment,l),g=!1},d(l){M(d,l)}}}function Fp(z){let d,g;return d=new V({props:{code:`with torch.no_grad():
...
the latter silently ignores them.`)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),l=s(_,"CODE",{});var q=a(l);f=i(q,"Module"),q.forEach(o),$=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(c,_){v(c,d,_),e(d,g),e(d,l),e(l,f),e(d,$)},d(c){c&&o(d)}}}function jp(z){let d,g;return d=new V({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(d.$$.fragment)},l(l){b(d.$$.fragment,l)},m(l,f){w(d,l,f),g=!0},p:ee,i(l){g||(y(d.$$.fragment,l),g=!0)},o(l){T(d.$$.fragment,l),g=!1},d(l){M(d,l)}}}function Ep(z){let d,g;return d=new V({props:{code:`with torch.no_grad():
    outputs = model(**inputs)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predict_answer = tokenizer.decode(predict_answer_tokens)`}}),{c(){k(d.$$.fragment)},l(l){b(d.$$.fragment,l)},m(l,f){w(d,l,f),g=!0},p:ee,i(l){g||(y(d.$$.fragment,l),g=!0)},o(l){T(d.$$.fragment,l),g=!1},d(l){M(d,l)}}}function Ip(z){let d,g,l,f,$;return f=new V({props:{code:`from transformers import MvpTokenizer, MvpForCausalLM
...
[<span class="hljs-number">1</span>, <span class="hljs-number">8</span>, <span class="hljs-number">50267</span>]`}}),{c(){d=n("p"),g=r("Example:"),l=p(),k(f.$$.fragment)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Example:"),_.forEach(o),l=h(c),b(f.$$.fragment,c)},m(c,_){v(c,d,_),e(d,g),v(c,l,_),w(f,c,_),$=!0},p:ee,i(c){$||(y(f.$$.fragment,c),$=!0)},o(c){T(f.$$.fragment,c),$=!1},d(c){c&&o(d),c&&o(l),M(f,c)}}}function Ap(z){let d,g,l,f,$,c,_,q,re,U,W,Y,Yo,dt,ya,Xo,Ta,ms,$e,Ma,lt,$a,za,us,ko,xa,fs,Q,Zo,qa,Ca,Ko,Fa,Pa,en,ja,Ea,tn,Ia,gs,bo,Aa,_s,H,ct,La,pt,Oa,Sa,Na,ht,Da,on,Va,Ua,Ba,mt,Ga,nn,Ra,Wa,Qa,ie,Ha,ut,Ja,Ya,sn,Xa,Za,vs,te,Ka,ft,er,tr,gt,or,nr,ks,de,ze,an,_t,sr,rn,ar,bs,vt,ws,wo,rr,ys,kt,Ts,oe,ir,dn,dr,lr,bt,cr,pr,Ms,wt,$s,le,xe,ln,yt,hr,cn,mr,zs,B,Tt,ur,ce,fr,yo,gr,_r,Mt,vr,kr,br,pe,wr,To,yr,Tr,Mo,Mr,$r,zr,qe,xs,he,Ce,pn,$t,xr,hn,qr,qs,x,zt,Cr,mn,Fr,Pr,un,jr,Er,Fe,Ir,xt,Ar,fn,Lr,Or,Sr,Pe,Nr,qt,Dr,$o,Vr,Ur,Br,ne,Ct,Gr,gn,Rr,Wr,Ft,zo,Qr,_n,Hr,Jr,xo,Yr,vn,Xr,Zr,je,Pt,Kr,kn,ei,ti,Ee,jt,oi,bn,ni,si,Ie,Et,ai,It,ri,wn,ii,di,Cs,me,Ae,yn,At,li,Tn,ci,Fs,F,Lt,pi,Ot,hi,Mn,mi,ui,fi,$n,gi,_i,Le,vi,St,ki,zn,bi,wi,yi,Oe,Ti,Nt,Mi,qo,$i,zi,xi,Se,Dt,qi,xn,Ci,Ps,ue,Ne,qn,Vt,Fi,Cn,Pi,js,G,Ut,ji,Bt,Ei,Co,Ii,Ai,Li,Gt,Oi,Rt,Si,Ni,Di,J,Wt,Vi,fe,Ui,Fo,Bi,Gi,Fn,Ri,Wi,Qi,De,Hi,Ve,Es,ge,Ue,Pn,Qt,Ji,jn,Yi,Is,R,Ht,Xi,Jt,Zi,Po,Ki,ed,td,Yt,od,Xt,nd,sd,ad,P,Zt,rd,_e,id,jo,dd,ld,En,cd,pd,hd,Be,md,In,ud,fd,An,gd,_d,Ge,vd,Ln,kd,bd,Re,As,ve,We,On,Kt,wd,Sn,yd,Ls,N,eo,Td,Nn,Md,$d,to,zd,Eo,xd,qd,Cd,oo,Fd,no,Pd,jd,Ed,j,so,Id,ke,Ad,Io,Ld,Od,Dn,Sd,Nd,Dd,Qe,Vd,Vn,Ud,Bd,ao,Gd,Un,Rd,Wd,Qd,He,Hd,Bn,Jd,Yd,Je,Os,be,Ye,Gn,ro,Xd,Rn,Zd,Ss,D,io,Kd,we,el,Wn,tl,ol,Qn,nl,sl,al,lo,rl,Ao,il,dl,ll,co,cl,po,pl,hl,ml,E,ho,ul,ye,fl,Lo,gl,_l,Hn,vl,kl,bl,Xe,wl,Jn,yl,Tl,Oo,Ml,Yn,$l,zl,Ze,xl,Xn,ql,Cl,Ke,Ns,Te,et,Zn,mo,Fl,Kn,Pl,Ds,Me,uo,jl,tt,fo,El,ot,Vs;return c=new Z({}),dt=new Z({}),_t=new Z({}),vt=new V({props:{code:`from transformers import MvpTokenizer, MvpForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(generated_ids, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&quot;Don&#x27;t do it if these are your reasons&quot;</span>]`}}),kt=new V({props:{code:`from transformers import MvpTokenizerFast, MvpForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(generated_ids, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Iron Man is a fictional superhero appearing in American comic books published by Marvel Comics.&#x27;</span>]`}}),wt=new V({props:{code:`from transformers import MvpForConditionalGeneration
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.2/en/model_doc/mvp#transformers.MvpModel">MvpModel</a>.`,name:"vocab_size"},{anchor:"transformers.MvpConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/tokenization_mvp.py#L325",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Pt=new I({props:{name:"convert_tokens_to_string",anchor:"transformers.MvpTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/tokenization_mvp.py#L290"}}),jt=new I({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.MvpTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MvpTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/tokenization_mvp.py#L377",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/tokenization_mvp.py#L350",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/tokenization_mvp_fast.py#L266",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Vt=new Z({}),Ut=new I({props:{name:"class transformers.MvpModel",anchor:"transformers.MvpModel",parameters:[{name:"config",val:": MvpConfig"}],parametersDescription:[{anchor:"transformers.MvpModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.2/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.21.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/modeling_mvp.py#L1287"}}),Wt=new I({props:{name:"forward",anchor:"transformers.MvpModel.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MvpModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.2/en/model_doc/mvp#transformers.MvpTokenizer">MvpTokenizer</a>. See <a href="/docs/transformers/v4.21.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/modeling_mvp.py#L1325",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.2/en/model_doc/mvp#transformers.MvpConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/modeling_mvp.py#L1465",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/modeling_mvp.py#L1615"}}),Qe=new Jo({props:{$$slots:{default:[qp]},$$scope:{ctx:z}}}),He=new K({props:{anchor:"transformers.MvpForSequenceClassification.forward.example",$$slots:{default:[Cp]},$$scope:{ctx:z}}}),Je=new K({props:{anchor:"transformers.MvpForSequenceClassification.forward.example-2",$$slots:{default:[Fp]},$$scope:{ctx:z}}}),ro=new Z({}),io=new I({props:{name:"class transformers.MvpForQuestionAnswering",anchor:"transformers.MvpForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MvpForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.2/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.21.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/modeling_mvp.py#L1722"}}),ho=new I({props:{name:"forward",anchor:"transformers.MvpForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": Tensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MvpForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.2/en/model_doc/mvp#transformers.MvpTokenizer">MvpTokenizer</a>. See <a href="/docs/transformers/v4.21.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.2/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/modeling_mvp.py#L1740"}}),Xe=new Jo({props:{$$slots:{default:[Pp]},$$scope:{ctx:z}}}),Ze=new K({props:{anchor:"transformers.MvpForQuestionAnswering.forward.example",$$slots:{default:[jp]},$$scope:{ctx:z}}}),Ke=new K({props:{anchor:"transformers.MvpForQuestionAnswering.forward.example-2",$$slots:{default:[Ep]},$$scope:{ctx:z}}}),mo=new Z({}),uo=new I({props:{name:"class transformers.MvpForCausalLM",anchor:"transformers.MvpForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/modeling_mvp.py#L1852"}}),fo=new I({props:{name:"forward",anchor:"transformers.MvpForCausalLM.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MvpForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/mvp/modeling_mvp.py#L1887",returnDescription:`
<p>A <a
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Sr=p(),k(Pe.$$.fragment),Nr=p(),qt=n("p"),Dr=r("This tokenizer inherits from "),$o=n("a"),Vr=r("PreTrainedTokenizer"),Ur=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Br=p(),ne=n("div"),k(Ct.$$.fragment),Gr=p(),gn=n("p"),Rr=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
make use of token type ids, therefore a list of zeros is returned.`),Ps=p(),ue=n("h2"),Ne=n("a"),qn=n("span"),k(Vt.$$.fragment),Fi=p(),Cn=n("span"),Pi=r("MvpModel"),js=p(),G=n("div"),k(Ut.$$.fragment),ji=p(),Bt=n("p"),Ei=r(`The bare MVP Model outputting raw hidden-states without any specific head on top.
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Hs.forEach(o),Sr=h(C),b(Pe.$$.fragment,C),Nr=h(C),qt=s(C,"P",{});var Js=a(qt);Dr=i(Js,"This tokenizer inherits from "),$o=s(Js,"A",{href:!0});var lc=a($o);Vr=i(lc,"PreTrainedTokenizer"),lc.forEach(o),Ur=i(Js,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Js.forEach(o),Br=h(C),ne=s(C,"DIV",{class:!0});var Bo=a(ne);b(Ct.$$.fragment,Bo),Gr=h(Bo),gn=s(Bo,"P",{});var cc=a(gn);Rr=i(cc,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A MVP sequence has the following format:`),cc.forEach(o),Wr=h(Bo),Ft=s(Bo,"UL",{});var Ys=a(Ft);zo=s(Ys,"LI",{});var Il=a(zo);Qr=i(Il,"single sequence: "),_n=s(Il,"CODE",{});var pc=a(_n);Hr=i(pc,"<s> X </s>"),pc.forEach(o),Il.forEach(o),Jr=h(Ys),xo=s(Ys,"LI",{});var Al=a(xo);Yr=i(Al,"pair of sequences: "),vn=s(Al,"CODE",{});var hc=a(vn);Xr=i(hc,"<s> A </s></s> B </s>"),hc.forEach(o),Al.forEach(o),Ys.forEach(o),Bo.forEach(o),Zr=h(C),je=s(C,"DIV",{class:!0});var Xs=a(je);b(Pt.$$.fragment,Xs),Kr=h(Xs),kn=s(Xs,"P",{});var mc=a(kn);ei=i(mc,"Converts a sequence of tokens (string) in a single string."),mc.forEach(o),Xs.forEach(o),ti=h(C),Ee=s(C,"DIV",{class:!0});var Zs=a(Ee);b(jt.$$.fragment,Zs),oi=h(Zs),bn=s(Zs,"P",{});var uc=a(bn);ni=i(uc,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. MVP does not
...
make use of token type ids, therefore a list of zeros is returned.`),Tc.forEach(o),aa.forEach(o),A.forEach(o),Ps=h(t),ue=s(t,"H2",{class:!0});var ra=a(ue);Ne=s(ra,"A",{id:!0,class:!0,href:!0});var Mc=a(Ne);qn=s(Mc,"SPAN",{});var $c=a(qn);b(Vt.$$.fragment,$c),$c.forEach(o),Mc.forEach(o),Fi=h(ra),Cn=s(ra,"SPAN",{});var zc=a(Cn);Pi=i(zc,"MvpModel"),zc.forEach(o),ra.forEach(o),js=h(t),G=s(t,"DIV",{class:!0});var at=a(G);b(Ut.$$.fragment,at),ji=h(at),Bt=s(at,"P",{});var ia=a(Bt);Ei=i(ia,`The bare MVP Model outputting raw hidden-states without any specific head on top.
