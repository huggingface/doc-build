...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.2/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qv=p(),dt=n("div"),T(qr.$$.fragment),Vv=p(),Lo=n("p"),Jv=r("The "),bd=n("a"),Kv=r("RobertaForQuestionAnswering"),Gv=r(" forward method, overrides the "),pp=n("code"),Xv=r("__call__"),Yv=r(" special method."),Zv=p(),T(Zn.$$.fragment),e2=p(),T(es.$$.fragment),t2=p(),T(ts.$$.fragment),hf=p(),Ao=n("h2"),os=n("a"),hp=n("span"),T(jr.$$.fragment),o2=p(),mp=n("span"),n2=r("TFRobertaModel"),mf=p(),Qe=n("div"),T(Pr.$$.fragment),s2=p(),fp=n("p"),a2=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),r2=p(),Lr=n("p"),i2=r("This model inherits from "),kd=n("a"),l2=r("TFPreTrainedModel"),d2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),c2=p(),Ar=n("p"),p2=r("This model is also a "),Or=n("a"),h2=r("tf.keras.Model"),m2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),f2=p(),T(ns.$$.fragment),u2=p(),Rt=n("div"),T(Nr.$$.fragment),g2=p(),Oo=n("p"),_2=r("The "),vd=n("a"),b2=r("TFRobertaModel"),k2=r(" forward method, overrides the "),up=n("code"),v2=r("__call__"),T2=r(" special method."),y2=p(),T(ss.$$.fragment),w2=p(),T(as.$$.fragment),ff=p(),No=n("h2"),rs=n("a"),gp=n("span"),T(Ir.$$.fragment),$2=p(),_p=n("span"),F2=r("TFRobertaForCausalLM"),uf=p(),Io=n("div"),T(Dr.$$.fragment),x2=p(),Mt=n("div"),T(Sr.$$.fragment),R2=p(),Do=n("p"),M2=r("The "),Td=n("a"),E2=r("TFRobertaForCausalLM"),z2=r(" forward method, overrides the "),bp=n("code"),C2=r("__call__"),q2=r(" special method."),j2=p(),T(is.$$.fragment),P2=p(),T(ls.$$.fragment),gf=p(),So=n("h2"),ds=n("a"),kp=n("span"),T(Wr.$$.fragment),L2=p(),vp=n("span"),A2=r("TFRobertaForMaskedLM"),_f=p(),Ve=n("div"),T(Br.$$.fragment),O2=p(),Ur=n("p"),N2=r("RoBERTa Model with a "),Tp=n("code"),I2=r("language modeling"),D2=r(" head on top."),S2=p(),Hr=n("p"),W2=r("This model inherits from "),yd=n("a"),B2=r("TFPreTrainedModel"),U2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),H2=p(),Qr=n("p"),Q2=r("This model is also a "),Vr=n("a"),V2=r("tf.keras.Model"),J2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),K2=p(),T(cs.$$.fragment),G2=p(),ct=n("div"),T(Jr.$$.fragment),X2=p(),Wo=n("p"),Y2=r("The "),wd=n("a"),Z2=r("TFRobertaForMaskedLM"),eT=r(" forward method, overrides the "),yp=n("code"),tT=r("__call__"),oT=r(" special method."),nT=p(),T(ps.$$.fragment),sT=p(),T(hs.$$.fragment),aT=p(),T(ms.$$.fragment),bf=p(),Bo=n("h2"),fs=n("a"),wp=n("span"),T(Kr.$$.fragment),rT=p(),$p=n("span"),iT=r("TFRobertaForSequenceClassification"),kf=p(),Je=n("div"),T(Gr.$$.fragment),lT=p(),Fp=n("p"),dT=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Aw=p(),Zp=n("p"),Ow=r("Finally, this model supports inherent JAX features such as:"),Nw=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),Iw=r("Just-In-Time (JIT) compilation"),Dw=p(),th=n("li"),Li=n("a"),Sw=r("Automatic Differentiation"),Ww=p(),oh=n("li"),Ai=n("a"),Bw=r("Vectorization"),Uw=p(),nh=n("li"),Oi=n("a"),Hw=r("Parallelization"),Qw=p(),Ct=n("div"),T(Ni.$$.fragment),Vw=p(),tn=n("p"),Jw=r("The "),sh=n("code"),Kw=r("FlaxRobertaPreTrainedModel"),Gw=r(" forward method, overrides the "),ah=n("code"),Xw=r("__call__"),Yw=r(" special method."),Zw=p(),T(Os.$$.fragment),e1=p(),T(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),T(Ii.$$.fragment),t1=p(),ih=n("span"),o1=r("FlaxRobertaForMaskedLM"),Cf=p(),Ie=n("div"),T(Di.$$.fragment),n1=p(),Si=n("p"),s1=r("RoBERTa Model with a "),lh=n("code"),a1=r("language modeling"),r1=r(" head on top."),i1=p(),Wi=n("p"),l1=r("This model inherits from "),Pd=n("a"),d1=r("FlaxPreTrainedModel"),c1=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w$=p(),Eh=n("p"),$$=r("Finally, this model supports inherent JAX features such as:"),F$=p(),Jt=n("ul"),zh=n("li"),pl=n("a"),x$=r("Just-In-Time (JIT) compilation"),R$=p(),Ch=n("li"),hl=n("a"),M$=r("Automatic Differentiation"),E$=p(),qh=n("li"),ml=n("a"),z$=r("Vectorization"),C$=p(),jh=n("li"),fl=n("a"),q$=r("Parallelization"),j$=p(),Pt=n("div"),T(ul.$$.fragment),P$=p(),ln=n("p"),L$=r("The "),Ph=n("code"),A$=r("FlaxRobertaPreTrainedModel"),O$=r(" forward method, overrides the "),Lh=n("code"),N$=r("__call__"),I$=r(" special method."),D$=p(),T(Qs.$$.fragment),S$=p(),T(Vs.$$.fragment),Af=p(),dn=n("h2"),Js=n("a"),Ah=n("span"),T(gl.$$.fragment),W$=p(),Oh=n("span"),B$=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),T(_l.$$.fragment),U$=p(),Nh=n("p"),H$=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(qr.$$.fragment,po),Vv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Jv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var Tx=a(bd);Kv=i(Tx,"RobertaForQuestionAnswering"),Tx.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var yx=a(pp);Xv=i(yx,"__call__"),yx.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),e2=h(po),y(es.$$.fragment,po),t2=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var wx=a(os);hp=s(wx,"SPAN",{});var $x=a(hp);y(jr.$$.fragment,$x),$x.forEach(t),wx.forEach(t),o2=h(gu),mp=s(gu,"SPAN",{});var Fx=a(mp);n2=i(Fx,"TFRobertaModel"),Fx.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),s2=h(Ot),fp=s(Ot,"P",{});var xx=a(fp);a2=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),r2=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);i2=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var Rx=a(kd);l2=i(Rx,"TFPreTrainedModel"),Rx.forEach(t),d2=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),f2=h(Ot),y(ns.$$.fragment,Ot),u2=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),g2=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_2=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var Ex=a(vd);b2=i(Ex,"TFRobertaModel"),Ex.forEach(t),k2=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var zx=a(up);v2=i(zx,"__call__"),zx.forEach(t),T2=i(Gd," special method."),Gd.forEach(t),y2=h(na),y(ss.$$.fragment,na),w2=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var Cx=a(rs);gp=s(Cx,"SPAN",{});var qx=a(gp);y(Ir.$$.fragment,qx),qx.forEach(t),Cx.forEach(t),$2=h(ku),_p=s(ku,"SPAN",{});var jx=a(_p);F2=i(jx,"TFRobertaForCausalLM"),jx.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);y(Dr.$$.fragment,vu),x2=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),R2=h(sa),Do=s(sa,"P",{});var Xd=a(Do);M2=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var Px=a(Td);E2=i(Px,"TFRobertaForCausalLM"),Px.forEach(t),z2=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var Lx=a(bp);C2=i(Lx,"__call__"),Lx.forEach(t),q2=i(Xd," special method."),Xd.forEach(t),j2=h(sa),y(is.$$.fragment,sa),P2=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tu=a(So);ds=s(Tu,"A",{id:!0,class:!0,href:!0});var Ax=a(ds);kp=s(Ax,"SPAN",{});var Ox=a(kp);y(Wr.$$.fragment,Ox),Ox.forEach(t),Ax.forEach(t),L2=h(Tu),vp=s(Tu,"SPAN",{});var Nx=a(vp);A2=i(Nx,"TFRobertaForMaskedLM"),Nx.forEach(t),Tu.forEach(t),_f=h(o),Ve=s(o,"DIV",{class:!0});var Nt=a(Ve);y(Br.$$.fragment,Nt),O2=h(Nt),Ur=s(Nt,"P",{});var yu=a(Ur);N2=i(yu,"RoBERTa Model with a "),Tp=s(yu,"CODE",{});var Ix=a(Tp);I2=i(Ix,"language modeling"),Ix.forEach(t),D2=i(yu," head on top."),yu.forEach(t),S2=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);W2=i(wu,"This model inherits from "),yd=s(wu,"A",{href:!0});var Dx=a(yd);B2=i(Dx,"TFPreTrainedModel"),Dx.forEach(t),U2=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),y(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);yT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),y(gs.$$.fragment,mo),RT=h(mo),y(_s.$$.fragment,mo),MT=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);y(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var e4=a(Mp);zT=i(e4,"TFRobertaForMultipleChoice"),e4.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),CT=h(Dt),Ep=s(Dt,"P",{});var t4=a(Ep);qT=i(t4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s4=a(Rd);HT=i(s4,"TFRobertaForMultipleChoice"),s4.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a4=a(zp);VT=i(a4,"__call__"),a4.forEach(t),JT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var r4=a(ws);Cp=s(r4,"SPAN",{});var i4=a(Cp);y(ii.$$.fragment,i4),i4.forEach(t),r4.forEach(t),XT=h(Cu),qp=s(Cu,"SPAN",{});var l4=a(qp);YT=i(l4,"TFRobertaForTokenClassification"),l4.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var d4=a(jp);ey=i(d4,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d4.forEach(t),ty=h(St),di=s(St,"P",{});var qu=a(di);oy=i(qu,"This model inherits from "),Md=s(qu,"A",{href:!0});var c4=a(Md);ny=i(c4,"TFPreTrainedModel"),c4.forEach(t),sy=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),ay=h(St),ci=s(St,"P",{});var ju=a(ci);ry=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var p4=a(pi);iy=i(p4,"tf.keras.Model"),p4.forEach(t),ly=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),py=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h4=a(Ed);my=i(h4,"TFRobertaForTokenClassification"),h4.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var m4=a(Pp);uy=i(m4,"__call__"),m4.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),y(Fs.$$.fragment,fo),by=h(fo),y(xs.$$.fragment,fo),ky=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var f4=a(Ms);Lp=s(f4,"SPAN",{});var u4=a(Lp);y(mi.$$.fragment,u4),u4.forEach(t),f4.forEach(t),vy=h(Pu),Ap=s(Pu,"SPAN",{});var g4=a(Ap);Ty=i(g4,"TFRobertaForQuestionAnswering"),g4.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _4=a(Op);$y=i(_4,"span start logits"),_4.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var b4=a(Np);xy=i(b4,"span end logits"),b4.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ey=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var k4=a(zd);zy=i(k4,"TFPreTrainedModel"),k4.forEach(t),Cy=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),qy=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jy=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var v4=a(_i);Py=i(v4,"tf.keras.Model"),v4.forEach(t),Ly=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),Cd=s(nc,"A",{href:!0});var T4=a(Cd);Dy=i(T4,"TFRobertaForQuestionAnswering"),T4.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var y4=a(Ip);Wy=i(y4,"__call__"),y4.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),y(zs.$$.fragment,uo),Hy=h(uo),y(Cs.$$.fragment,uo),Qy=h(uo),y(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var w4=a(js);Dp=s(w4,"SPAN",{});var $4=a(Dp);y(ki.$$.fragment,$4),$4.forEach(t),w4.forEach(t),Vy=h(Ou),Sp=s(Ou,"SPAN",{});var F4=a(Sp);Jy=i(F4,"FlaxRobertaModel"),F4.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var x4=a(Wp);Gy=i(x4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x4.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yy=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var R4=a(qd);Zy=i(R4,"FlaxPreTrainedModel"),R4.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q1=h(kt),kh=s(kt,"P",{});var xR=a(kh);V1=i(xR,"Finally, this model supports inherent JAX features such as:"),xR.forEach(t),J1=h(kt),Vt=s(kt,"UL",{});var ha=a(Vt);vh=s(ha,"LI",{});var RR=a(vh);tl=s(RR,"A",{href:!0,rel:!0});var MR=a(tl);K1=i(MR,"Just-In-Time (JIT) compilation"),MR.forEach(t),RR.forEach(t),G1=h(ha),Th=s(ha,"LI",{});var ER=a(Th);ol=s(ER,"A",{href:!0,rel:!0});var zR=a(ol);X1=i(zR,"Automatic Differentiation"),zR.forEach(t),ER.forEach(t),Y1=h(ha),yh=s(ha,"LI",{});var CR=a(yh);nl=s(CR,"A",{href:!0,rel:!0});var qR=a(nl);Z1=i(qR,"Vectorization"),qR.forEach(t),CR.forEach(t),e$=h(ha),wh=s(ha,"LI",{});var jR=a(wh);sl=s(jR,"A",{href:!0,rel:!0});var PR=a(sl);t$=i(PR,"Parallelization"),PR.forEach(t),jR.forEach(t),ha.forEach(t),o$=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);y(al.$$.fragment,ma),n$=h(ma),an=s(ma,"P",{});var ic=a(an);s$=i(ic,"The "),$h=s(ic,"CODE",{});var LR=a($h);a$=i(LR,"FlaxRobertaPreTrainedModel"),LR.forEach(t),r$=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AR=a(Fh);i$=i(AR,"__call__"),AR.forEach(t),l$=i(ic," special method."),ic.forEach(t),d$=h(ma),y(Bs.$$.fragment,ma),c$=h(ma),y(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OR=a(Hs);xh=s(OR,"SPAN",{});var NR=a(xh);y(rl.$$.fragment,NR),NR.forEach(t),OR.forEach(t),p$=h(Gu),Rh=s(Gu,"SPAN",{});var IR=a(Rh);h$=i(IR,"FlaxRobertaForMultipleChoice"),IR.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),m$=h(vt),Mh=s(vt,"P",{});var DR=a(Mh);f$=i(DR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DR.forEach(t),u$=h(vt),ll=s(vt,"P",{});var Xu=a(ll);g$=i(Xu,"This model inherits from "),Ad=s(Xu,"A",{href:!0});var SR=a(Ad);_$=i(SR,"FlaxPreTrainedModel"),SR.forEach(t),b$=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k$=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v$=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var WR=a(cl);T$=i(WR,"flax.linen.Module"),WR.forEach(t),y$=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w$=h(vt),Eh=s(vt,"P",{});var BR=a(Eh);$$=i(BR,"Finally, this model supports inherent JAX features such as:"),BR.forEach(t),F$=h(vt),Jt=s(vt,"UL",{});var fa=a(Jt);zh=s(fa,"LI",{});var UR=a(zh);pl=s(UR,"A",{href:!0,rel:!0});var HR=a(pl);x$=i(HR,"Just-In-Time (JIT) compilation"),HR.forEach(t),UR.forEach(t),R$=h(fa),Ch=s(fa,"LI",{});var QR=a(Ch);hl=s(QR,"A",{href:!0,rel:!0});var VR=a(hl);M$=i(VR,"Automatic Differentiation"),VR.forEach(t),QR.forEach(t),E$=h(fa),qh=s(fa,"LI",{});var JR=a(qh);ml=s(JR,"A",{href:!0,rel:!0});var KR=a(ml);z$=i(KR,"Vectorization"),KR.forEach(t),JR.forEach(t),C$=h(fa),jh=s(fa,"LI",{});var GR=a(jh);fl=s(GR,"A",{href:!0,rel:!0});var XR=a(fl);q$=i(XR,"Parallelization"),XR.forEach(t),GR.forEach(t),fa.forEach(t),j$=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);y(ul.$$.fragment,ua),P$=h(ua),ln=s(ua,"P",{});var lc=a(ln);L$=i(lc,"The "),Ph=s(lc,"CODE",{});var YR=a(Ph);A$=i(YR,"FlaxRobertaPreTrainedModel"),YR.forEach(t),O$=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZR=a(Lh);N$=i(ZR,"__call__"),ZR.forEach(t),I$=i(lc," special method."),lc.forEach(t),D$=h(ua),y(Qs.$$.fragment,ua),S$=h(ua),y(Vs.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Js=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Js);Ah=s(eM,"SPAN",{});var tM=a(Ah);y(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W$=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B$=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U$=h(Tt),Nh=s(Tt,"P",{});var nM=a(Nh);H$=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nM.forEach(t),Q$=h(Tt),bl=s(Tt,"P",{});var eg=a(bl);V$=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sM=a(Od);J$=i(sM,"FlaxPreTrainedModel"),sM.forEach(t),K$=i(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),G$=h(Tt),kl=s(Tt,"P",{});var tg=a(kl);X$=i(tg,"This model is also a Flax Linen "),vl=s(tg,"A",{href:!0,rel:!0});var aM=a(vl);Y$=i(aM,"flax.linen.Module"),aM.forEach(t),Z$=i(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
