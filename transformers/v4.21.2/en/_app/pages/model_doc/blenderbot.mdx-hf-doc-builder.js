import{S as Lm,i as Sm,s as Dm,e as n,k as l,w as k,t as a,M as Gm,c as r,d as t,m as c,a as s,x as y,h as d,b as h,G as e,g as f,y as T,q as w,o as $,B as x,v as Wm,L as nt}from"../../chunks/vendor-hf-doc-builder.js";import{T as xo}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ve}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ce}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ot}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Um(F){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Rm(F){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var z=s(g);u=d(z,"Module"),z.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Hm(F){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">6</span>, <span class="hljs-number">1280</span>]`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Vm(F){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var z=s(g);u=d(z,"Module"),z.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Km(F){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
`),U=r(se,"CODE",{});var dt=s(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),se.forEach(t),V.forEach(t)},m(B,q){f(B,p,q),e(p,v),f(B,g,q),f(B,u,q),e(u,b),e(b,i),e(u,m),e(u,z),e(z,Me),f(B,pe,q),f(B,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(B,G,q),f(B,N,q),e(N,_e),f(B,R,q),f(B,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,re),e(re,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(B){B&&t(p),B&&t(g),B&&t(u),B&&t(pe),B&&t(E),B&&t(G),B&&t(N),B&&t(R),B&&t(M)}}}function Xm(F){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var z=s(g);u=d(z,"Module"),z.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Ym(F){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, TFBlenderbotModel
...
first positional argument :`),be.forEach(t),R=c(B),M=r(B,"UL",{});var V=s(M);j=r(V,"LI",{});var K=s(j);Oe=d(K,"a single Tensor with "),J=r(K,"CODE",{});var st=s(J);Q=d(st,"input_ids"),st.forEach(t),Pe=d(K," only and nothing else: "),W=r(K,"CODE",{});var Je=s(W);Ne=d(Je,"model(input_ids)"),Je.forEach(t),K.forEach(t),Ae=c(V),A=r(V,"LI",{});var I=s(A);he=d(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=r(I,"CODE",{});var ve=s(re);$e=d(ve,"model([input_ids, attention_mask])"),ve.forEach(t),ue=d(I," or "),H=r(I,"CODE",{});var at=s(H);Ie=d(at,"model([input_ids, attention_mask, token_type_ids])"),at.forEach(t),I.forEach(t),xe=c(V),C=r(V,"LI",{});var se=s(C);Le=d(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(se,"CODE",{});var dt=s(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),se.forEach(t),V.forEach(t)},m(B,q){f(B,p,q),e(p,v),f(B,g,q),f(B,u,q),e(u,b),e(b,i),e(u,m),e(u,z),e(z,Me),f(B,pe,q),f(B,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(B,G,q),f(B,N,q),e(N,_e),f(B,R,q),f(B,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,re),e(re,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(B){B&&t(p),B&&t(g),B&&t(u),B&&t(pe),B&&t(E),B&&t(G),B&&t(N),B&&t(R),B&&t(M)}}}function ef(F){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var z=s(g);u=d(z,"Module"),z.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function tf(F){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var z=s(g);u=d(z,"Module"),z.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function of(F){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function nf(F){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function sf(F){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var z=s(g);u=d(z,"Module"),z.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function af(F){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function df(F){let p,v,g,u,b;return u=new Ve({props:{code:`import jax.numpy as jnp
from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function lf(F){let p,v,g,u,b,i,m,z,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,he,re,$e,ue,H,Ie,xe,C,Le,U,Se,B,q,ge,rt,Ke,O,me,De,be,V,K,st,Je,I,ve,at,se,dt,zd,qd,Bo,Ed,Fo,Md,Cd,jd,Ge,Od,Fr,Pd,Nd,zr,Ad,Id,Kn,Ld,Sd,ba,it,qt,qr,zo,Dd,Er,Gd,va,Jn,Wd,ka,qo,ya,lt,Et,Mr,Eo,Ud,Cr,Rd,Ta,ke,Mo,Hd,ct,Vd,Qn,Kd,Jd,Co,Qd,Xd,Yd,pt,Zd,Xn,ei,ti,Yn,oi,ni,ri,Mt,wa,ht,Ct,jr,jo,si,Or,ai,$a,ae,Oo,di,Pr,ii,li,jt,Nr,ci,pi,Zn,hi,ui,mi,Po,fi,er,_i,gi,bi,Qe,No,vi,Ar,ki,yi,Ir,tr,Ti,Lr,wi,xa,ut,Ot,Sr,Ao,$i,Dr,xi,Ba,de,Io,Bi,Lo,Fi,Gr,zi,qi,Ei,Pt,Wr,Mi,Ci,or,ji,Oi,Pi,So,Ni,nr,Ai,Ii,Li,Xe,Do,Si,Ur,Di,Gi,Rr,rr,Wi,Hr,Ui,Fa,mt,Nt,Vr,Go,Ri,Kr,Hi,za,We,Vi,Jr,Ki,Ji,Qr,Qi,Xi,Xr,Yi,qa,ye,Wo,Zi,Uo,el,sr,tl,ol,nl,Ro,rl,Ho,sl,al,dl,Be,Vo,il,ft,ll,ar,cl,pl,Yr,hl,ul,ml,At,fl,It,Ea,_t,Lt,Zr,Ko,_l,es,gl,Ma,Ue,bl,dr,vl,kl,ts,yl,Tl,os,wl,Ca,Te,Jo,$l,Qo,xl,ir,Bl,Fl,zl,Xo,ql,Yo,El,Ml,Cl,Fe,Zo,jl,gt,Ol,lr,Pl,Nl,ns,Al,Il,Ll,St,Sl,Dt,ja,bt,Gt,rs,en,Dl,ss,Gl,Oa,vt,tn,Wl,Wt,on,Ul,Ut,Pa,kt,Rt,as,nn,Rl,ds,Hl,Na,ie,rn,Vl,sn,Kl,cr,Jl,Ql,Xl,an,Yl,dn,Zl,ec,tc,Ht,oc,ze,ln,nc,yt,rc,pr,sc,ac,is,dc,ic,lc,Vt,cc,Kt,Aa,Tt,Jt,ls,cn,pc,cs,hc,Ia,le,pn,uc,hn,mc,hr,fc,_c,gc,un,bc,mn,vc,kc,yc,Qt,Tc,X,fn,wc,wt,$c,ur,xc,Bc,ps,Fc,zc,qc,Xt,Ec,hs,Mc,Cc,us,ms,fs,_s,jc,Oc,gs,bs,vs,_n,Pc,ks,Nc,Ac,La,$t,Yt,ys,gn,Ic,Ts,Lc,Sa,L,bn,Sc,vn,Dc,mr,Gc,Wc,Uc,kn,Rc,yn,Hc,Vc,Kc,ws,Jc,Qc,Re,$s,Tn,Xc,Yc,xs,wn,Zc,ep,Bs,$n,tp,op,Fs,xn,np,rp,qe,Bn,sp,xt,ap,zs,dp,ip,qs,lp,cp,pp,Zt,hp,eo,up,to,Fn,mp,oo,fp,no,zn,_p,ro,Da,Bt,so,Es,qn,gp,Ms,bp,Ga,S,En,vp,Mn,kp,fr,yp,Tp,wp,Cn,$p,jn,xp,Bp,Fp,Cs,zp,qp,He,js,On,Ep,Mp,Os,Pn,Cp,jp,Ps,Nn,Op,Pp,Ns,An,Np,Ap,D,In,Ip,Ft,Lp,As,Sp,Dp,Is,Gp,Wp,Up,ao,Rp,Ls,Hp,Vp,Ss,Ds,Gs,Ws,Kp,Jp,Us,Rs,Hs,Vs,Qp,Xp,Ks,Js,Qs,Xs,Yp,Zp,Ys,Zs,Ln,io,lo,ea,Sn,eh,ta,th,oh,oa,nh,rh,co,Dn,sh,po,ah,ho,Gn,dh,uo,Wa;return i=new ce({}),R=new ce({}),be=new ce({}),zo=new ce({}),qo=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Will be ignored`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/blenderbot/tokenization_blenderbot_fast.py#L61",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.2/en/model_doc/blenderbot#transformers.BlenderbotConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/blenderbot/modeling_blenderbot.py#L1284",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/blenderbot/modeling_blenderbot.py#L1451",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1170",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1295",returnDescription:`
<p>A <a
...
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),Rr=n("ul"),rr=n("li"),Wi=a("single sequence: "),Hr=n("code"),Ui=a("X </s>"),Fa=l(),mt=n("h2"),Nt=n("a"),Vr=n("span"),k(Go.$$.fragment),Ri=l(),Kr=n("span"),Hi=a("BlenderbotModel"),za=l(),We=n("p"),Vi=a("See "),Jr=n("code"),Ki=a("transformers.BartModel"),Ji=a(" for arguments to "),Qr=n("em"),Qi=a("forward"),Xi=a(" and "),Xr=n("em"),Yi=a("generate"),qa=l(),ye=n("div"),k(Wo.$$.fragment),Zi=l(),Uo=n("p"),el=a(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),dl=l(),Be=n("div"),k(Vo.$$.fragment),il=l(),ft=n("p"),ll=a("The "),ar=n("a"),cl=a("BlenderbotModel"),pl=a(" forward method, overrides the "),Yr=n("code"),hl=a("__call__"),ul=a(" special method."),ml=l(),k(At.$$.fragment),fl=l(),k(It.$$.fragment),Ea=l(),_t=n("h2"),Lt=n("a"),Zr=n("span"),k(Ko.$$.fragment),_l=l(),es=n("span"),gl=a("BlenderbotForConditionalGeneration"),Ma=l(),Ue=n("p"),bl=a("See "),dr=n("a"),vl=a("BartForConditionalGeneration"),kl=a(" for arguments to "),ts=n("em"),yl=a("forward"),Tl=a(" and "),os=n("em"),wl=a("generate"),Ca=l(),Te=n("div"),k(Jo.$$.fragment),$l=l(),Qo=n("p"),xl=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cl=l(),Fe=n("div"),k(Zo.$$.fragment),jl=l(),gt=n("p"),Ol=a("The "),lr=n("a"),Pl=a("BlenderbotForConditionalGeneration"),Nl=a(" forward method, overrides the "),ns=n("code"),Al=a("__call__"),Il=a(" special method."),Ll=l(),k(St.$$.fragment),Sl=l(),k(Dt.$$.fragment),ja=l(),bt=n("h2"),Gt=n("a"),rs=n("span"),k(en.$$.fragment),Dl=l(),ss=n("span"),Gl=a("BlenderbotForCausalLM"),Oa=l(),vt=n("div"),k(tn.$$.fragment),Wl=l(),Wt=n("div"),k(on.$$.fragment),Ul=l(),k(Ut.$$.fragment),Pa=l(),kt=n("h2"),Rt=n("a"),as=n("span"),k(nn.$$.fragment),Rl=l(),ds=n("span"),Hl=a("TFBlenderbotModel"),Na=l(),ie=n("div"),k(rn.$$.fragment),Vl=l(),sn=n("p"),Kl=a(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),tc=l(),k(Ht.$$.fragment),oc=l(),ze=n("div"),k(ln.$$.fragment),nc=l(),yt=n("p"),rc=a("The "),pr=n("a"),sc=a("TFBlenderbotModel"),ac=a(" forward method, overrides the "),is=n("code"),dc=a("__call__"),ic=a(" special method."),lc=l(),k(Vt.$$.fragment),cc=l(),k(Kt.$$.fragment),Aa=l(),Tt=n("h2"),Jt=n("a"),ls=n("span"),k(cn.$$.fragment),pc=l(),cs=n("span"),hc=a("TFBlenderbotForConditionalGeneration"),Ia=l(),le=n("div"),k(pn.$$.fragment),uc=l(),hn=n("p"),mc=a(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc=l(),k(Qt.$$.fragment),Tc=l(),X=n("div"),k(fn.$$.fragment),wc=l(),wt=n("p"),$c=a("The "),ur=n("a"),xc=a("TFBlenderbotForConditionalGeneration"),Bc=a(" forward method, overrides the "),ps=n("code"),Fc=a("__call__"),zc=a(" special method."),qc=l(),k(Xt.$$.fragment),Ec=l(),hs=n("p"),Mc=a("Conversation example::"),Cc=l(),us=n("blockquote"),ms=n("blockquote"),fs=n("blockquote"),_s=n("p"),jc=a(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Kc=l(),ws=n("p"),Jc=a("Finally, this model supports inherent JAX features such as:"),Qc=l(),Re=n("ul"),$s=n("li"),Tn=n("a"),Xc=a("Just-In-Time (JIT) compilation"),Yc=l(),xs=n("li"),wn=n("a"),Zc=a("Automatic Differentiation"),ep=l(),Bs=n("li"),$n=n("a"),tp=a("Vectorization"),op=l(),Fs=n("li"),xn=n("a"),np=a("Parallelization"),rp=l(),qe=n("div"),k(Bn.$$.fragment),sp=l(),xt=n("p"),ap=a("The "),zs=n("code"),dp=a("FlaxBlenderbotPreTrainedModel"),ip=a(" forward method, overrides the "),qs=n("code"),lp=a("__call__"),cp=a(" special method."),pp=l(),k(Zt.$$.fragment),hp=l(),k(eo.$$.fragment),up=l(),to=n("div"),k(Fn.$$.fragment),mp=l(),k(oo.$$.fragment),fp=l(),no=n("div"),k(zn.$$.fragment),_p=l(),k(ro.$$.fragment),Da=l(),Bt=n("h2"),so=n("a"),Es=n("span"),k(qn.$$.fragment),gp=l(),Ms=n("span"),bp=a("FlaxBlenderbotForConditionalGeneration"),Ga=l(),S=n("div"),k(En.$$.fragment),vp=l(),Mn=n("p"),kp=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Fp=l(),Cs=n("p"),zp=a("Finally, this model supports inherent JAX features such as:"),qp=l(),He=n("ul"),js=n("li"),On=n("a"),Ep=a("Just-In-Time (JIT) compilation"),Mp=l(),Os=n("li"),Pn=n("a"),Cp=a("Automatic Differentiation"),jp=l(),Ps=n("li"),Nn=n("a"),Op=a("Vectorization"),Pp=l(),Ns=n("li"),An=n("a"),Np=a("Parallelization"),Ap=l(),D=n("div"),k(In.$$.fragment),Ip=l(),Ft=n("p"),Lp=a("The "),As=n("code"),Sp=a("FlaxBlenderbotPreTrainedModel"),Dp=a(" forward method, overrides the "),Is=n("code"),Gp=a("__call__"),Wp=a(" special method."),Up=l(),k(ao.$$.fragment),Rp=l(),Ls=n("p"),Hp=a("Conversation example::"),Vp=l(),Ss=n("blockquote"),Ds=n("blockquote"),Gs=n("blockquote"),Ws=n("p"),Kp=a("from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),Jp=l(),Us=n("blockquote"),Rs=n("blockquote"),Hs=n("blockquote"),Vs=n("p"),Qp=a(`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
...
`),Kn=r(fo,"A",{href:!0});var bh=s(Kn);Ld=d(bh,"BlenderbotSmall"),bh.forEach(t),Sd=d(fo,"."),fo.forEach(t),_r.forEach(t),ba=c(o),it=r(o,"H2",{class:!0});var Va=s(it);qt=r(Va,"A",{id:!0,class:!0,href:!0});var vh=s(qt);qr=r(vh,"SPAN",{});var kh=s(qr);y(zo.$$.fragment,kh),kh.forEach(t),vh.forEach(t),Dd=c(Va),Er=r(Va,"SPAN",{});var yh=s(Er);Gd=d(yh,"Usage"),yh.forEach(t),Va.forEach(t),va=c(o),Jn=r(o,"P",{});var Th=s(Jn);Wd=d(Th,"Here is an example of model usage:"),Th.forEach(t),ka=c(o),y(qo.$$.fragment,o),ya=c(o),lt=r(o,"H2",{class:!0});var Ka=s(lt);Et=r(Ka,"A",{id:!0,class:!0,href:!0});var wh=s(Et);Mr=r(wh,"SPAN",{});var $h=s(Mr);y(Eo.$$.fragment,$h),$h.forEach(t),wh.forEach(t),Ud=c(Ka),Cr=r(Ka,"SPAN",{});var xh=s(Cr);Rd=d(xh,"BlenderbotConfig"),xh.forEach(t),Ka.forEach(t),Ta=c(o),ke=r(o,"DIV",{class:!0});var _o=s(ke);y(Mo.$$.fragment,_o),Hd=c(_o),ct=r(_o,"P",{});var gr=s(ct);Vd=d(gr,"This is the configuration class to store the configuration of a "),Qn=r(gr,"A",{href:!0});var Bh=s(Qn);Kd=d(Bh,"BlenderbotModel"),Bh.forEach(t),Jd=d(gr,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
