...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),v=n("Example:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function hm($){let l,v,p,u,b,i,f,D,Pe,pe,F,Z,W,ee,Ne,H,Ie,qe,I,V,te,be,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,M,S,G,Qe,We,P,He,ne,Te;return{c(){l=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),b=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),W=a("code"),ee=n("tf.keras.Model.fit"),Ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),V=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),be=c(),C=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),R=a("code"),Ge=n("model(input_ids)"),De=c(),O=a("li"),Be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),We=c(),P=a("li"),He=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),Te=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);v=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);b=r(se,"LI",{});var nt=d(b);i=s(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(se),D=r(se,"LI",{});var st=d(D);Pe=s(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var N=d(F);Z=s(N,"This second option is useful when using "),W=r(N,"CODE",{});var at=d(W);ee=s(at,"tf.keras.Model.fit"),at.forEach(t),Ne=s(N,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),v=n("Examples:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Examples:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function mm($){let l,v,p,u,b,i,f,D,Pe,pe,F,Z,W,ee,Ne,H,Ie,qe,I,V,te,be,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,M,S,G,Qe,We,P,He,ne,Te,q,z,se,nt,st,N,at,rt,Fe,U,ae,ze,dt,re,it,de,Ve,Re,rd,dd,qs,id,ld,cd,ke,hd,$s,pd,ud,Ds,md,fd,Qn,_d,gd,Fs,vd,bd,Td,X,kd,zs,wd,yd,xs,Ed,Ld,Wn,qd,$d,Ms,Dd,Fd,Ss,zd,xd,Cs,Md,Sd,Cd,Ue,Od,Os,jd,Ad,js,Pd,Nd,As,Id,Gd,Bd,$o,Qd,Do,Wd,Hd,Vd,Fo,Rd,zo,Ud,Xd,Ha,jt,Jd,xo,Zd,Kd,Va,lt,At,Ps,Mo,Yd,Ns,ei,Ra,we,So,ti,ct,oi,Hn,ni,si,Co,ai,ri,di,ht,ii,Vn,li,ci,Rn,hi,pi,ui,Pt,Ua,pt,Nt,Is,Oo,mi,Gs,fi,Xa,A,jo,_i,Bs,gi,vi,It,Un,bi,Ti,Xn,ki,wi,yi,Ao,Ei,Jn,Li,qi,$i,Xe,Po,Di,Qs,Fi,zi,No,Zn,xi,Ws,Mi,Si,Kn,Ci,Hs,Oi,ji,Gt,Io,Ai,Go,Pi,Vs,Ni,Ii,Gi,Bt,Bo,Bi,Rs,Qi,Wi,Yn,Qo,Ja,ut,Qt,Us,Wo,Hi,Xs,Vi,Za,ye,Ho,Ri,Vo,Ui,Js,Xi,Ji,Zi,Wt,es,Ki,Yi,ts,el,tl,ol,Ro,nl,os,sl,al,Ka,mt,Ht,Zs,Uo,rl,Ks,dl,Ya,ft,Xo,il,Ys,ll,er,_t,Jo,cl,ea,hl,tr,gt,Zo,pl,ta,ul,or,vt,Ko,ml,oa,fl,nr,bt,Yo,_l,na,gl,sr,Tt,en,vl,sa,bl,ar,kt,tn,Tl,aa,kl,rr,wt,on,wl,ra,yl,dr,yt,Vt,da,nn,El,ia,Ll,ir,Ee,sn,ql,an,$l,ns,Dl,Fl,zl,rn,xl,dn,Ml,Sl,Cl,xe,ln,Ol,Et,jl,ss,Al,Pl,la,Nl,Il,Gl,Rt,Bl,Ut,lr,Lt,Xt,ca,cn,Ql,ha,Wl,cr,Le,hn,Hl,pn,Vl,as,Rl,Ul,Xl,un,Jl,mn,Zl,Kl,Yl,fe,fn,ec,qt,tc,rs,oc,nc,pa,sc,ac,rc,Jt,dc,Zt,ic,Kt,hr,$t,Yt,ua,_n,lc,ma,cc,pr,ie,gn,hc,fa,pc,uc,vn,mc,ds,fc,_c,gc,bn,vc,Tn,bc,Tc,kc,B,kn,wc,Dt,yc,is,Ec,Lc,_a,qc,$c,Dc,eo,Fc,to,zc,oo,xc,no,Mc,so,ur,Ft,ao,ga,wn,Sc,va,Cc,mr,le,yn,Oc,zt,jc,ba,Ac,Pc,Ta,Nc,Ic,Gc,En,Bc,ls,Qc,Wc,Hc,Ln,Vc,qn,Rc,Uc,Xc,_e,$n,Jc,xt,Zc,cs,Kc,Yc,ka,eh,th,oh,ro,nh,io,sh,lo,fr,Mt,co,wa,Dn,ah,ya,rh,_r,ce,Fn,dh,zn,ih,hs,lh,ch,hh,xn,ph,Mn,uh,mh,fh,ho,_h,Me,Sn,gh,St,vh,ps,bh,Th,Ea,kh,wh,yh,po,Eh,uo,gr,Ct,mo,La,Cn,Lh,qa,qh,vr,he,On,$h,jn,Dh,us,Fh,zh,xh,An,Mh,Pn,Sh,Ch,Oh,fo,jh,Se,Nn,Ah,Ot,Ph,ms,Nh,Ih,$a,Gh,Bh,Qh,_o,Wh,go,br;return i=new Ce({}),ee=new Ce({}),Mo=new Ce({}),So=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/led/modeling_tf_led.py#L1411"}}),on=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/v4.21.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.2/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/led/modeling_led.py#L2201",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.2/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/led/modeling_led.py#L2341",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/led/modeling_led.py#L2503",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/led/modeling_led.py#L2630",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/led/modeling_tf_led.py#L2247",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.2/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/led/modeling_tf_led.py#L2358",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.2/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
documentation from `),Rn=a("a"),hi=n("PretrainedConfig"),pi=n(" for more information."),ui=c(),T(Pt.$$.fragment),Ua=c(),pt=a("h2"),Nt=a("a"),Is=a("span"),T(Oo.$$.fragment),mi=c(),Gs=a("span"),fi=n("LEDTokenizer"),Xa=c(),A=a("div"),T(jo.$$.fragment),_i=c(),Bs=a("p"),gi=n("Construct a LED tokenizer."),vi=c(),It=a("p"),Un=a("a"),bi=n("LEDTokenizer"),Ti=n(" is identical to "),Xn=a("a"),ki=n("BartTokenizer"),wi=n(` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),zi=c(),No=a("ul"),Zn=a("li"),xi=n("single sequence: "),Ws=a("code"),Mi=n("<s> X </s>"),Si=c(),Kn=a("li"),Ci=n("pair of sequences: "),Hs=a("code"),Oi=n("<s> A </s></s> B </s>"),ji=c(),Gt=a("div"),T(Io.$$.fragment),Ai=c(),Go=a("p"),Pi=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Vs=a("code"),Ni=n("prepare_for_model"),Ii=n(" method."),Gi=c(),Bt=a("div"),T(Bo.$$.fragment),Bi=c(),Rs=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Wi=c(),Yn=a("div"),T(Qo.$$.fragment),Ja=c(),ut=a("h2"),Qt=a("a"),Us=a("span"),T(Wo.$$.fragment),Hi=c(),Xs=a("span"),Vi=n("LEDTokenizerFast"),Za=c(),ye=a("div"),T(Ho.$$.fragment),Ri=c(),Vo=a("p"),Ui=n("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Js=a("em"),Xi=n("tokenizers"),Ji=n(" library)."),Zi=c(),Wt=a("p"),es=a("a"),Ki=n("LEDTokenizerFast"),Yi=n(" is identical to "),ts=a("a"),el=n("BartTokenizerFast"),tl=n(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),ol=c(),Ro=a("p"),nl=n("Refer to superclass "),os=a("a"),sl=n("BartTokenizerFast"),al=n(" for usage examples and documentation concerning parameters."),Ka=c(),mt=a("h2"),Ht=a("a"),Zs=a("span"),T(Uo.$$.fragment),rl=c(),Ks=a("span"),dl=n("LED specific outputs"),Ya=c(),ft=a("div"),T(Xo.$$.fragment),il=c(),Ys=a("p"),ll=n("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),er=c(),_t=a("div"),T(Jo.$$.fragment),cl=c(),ea=a("p"),hl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
decoding.`),rr=c(),wt=a("div"),T(on.$$.fragment),wl=c(),ra=a("p"),yl=n("Base class for sequence-to-sequence language models outputs."),dr=c(),yt=a("h2"),Vt=a("a"),da=a("span"),T(nn.$$.fragment),El=c(),ia=a("span"),Ll=n("LEDModel"),ir=c(),Ee=a("div"),T(sn.$$.fragment),ql=c(),an=a("p"),$l=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Cl=c(),xe=a("div"),T(ln.$$.fragment),Ol=c(),Et=a("p"),jl=n("The "),ss=a("a"),Al=n("LEDModel"),Pl=n(" forward method, overrides the "),la=a("code"),Nl=n("__call__"),Il=n(" special method."),Gl=c(),T(Rt.$$.fragment),Bl=c(),T(Ut.$$.fragment),lr=c(),Lt=a("h2"),Xt=a("a"),ca=a("span"),T(cn.$$.fragment),Ql=c(),ha=a("span"),Wl=n("LEDForConditionalGeneration"),cr=c(),Le=a("div"),T(hn.$$.fragment),Hl=c(),pn=a("p"),Vl=n(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),kc=c(),B=a("div"),T(kn.$$.fragment),wc=c(),Dt=a("p"),yc=n("The "),is=a("a"),Ec=n("LEDForSequenceClassification"),Lc=n(" forward method, overrides the "),_a=a("code"),qc=n("__call__"),$c=n(" special method."),Dc=c(),T(eo.$$.fragment),Fc=c(),T(to.$$.fragment),zc=c(),T(oo.$$.fragment),xc=c(),T(no.$$.fragment),Mc=c(),T(so.$$.fragment),ur=c(),Ft=a("h2"),ao=a("a"),ga=a("span"),T(wn.$$.fragment),Sc=c(),va=a("span"),Cc=n("LEDForQuestionAnswering"),mr=c(),le=a("div"),T(yn.$$.fragment),Oc=c(),zt=a("p"),jc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),ba=a("code"),Ac=n("span start logits"),Pc=n(" and "),Ta=a("code"),Nc=n("span end logits"),Ic=n(")."),Gc=c(),En=a("p"),Bc=n("This model inherits from "),ls=a("a"),Qc=n("PreTrainedModel"),Wc=n(`. See the superclass documentation for the generic methods the library
...
behavior.`),fh=c(),T(ho.$$.fragment),_h=c(),Me=a("div"),T(Sn.$$.fragment),gh=c(),St=a("p"),vh=n("The "),ps=a("a"),bh=n("TFLEDModel"),Th=n(" forward method, overrides the "),Ea=a("code"),kh=n("__call__"),wh=n(" special method."),yh=c(),T(po.$$.fragment),Eh=c(),T(uo.$$.fragment),gr=c(),Ct=a("h2"),mo=a("a"),La=a("span"),T(Cn.$$.fragment),Lh=c(),qa=a("span"),qh=n("TFLEDForConditionalGeneration"),vr=c(),he=a("div"),T(On.$$.fragment),$h=c(),jn=a("p"),Dh=n(`The LED Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oh=c(),T(fo.$$.fragment),jh=c(),Se=a("div"),T(Nn.$$.fragment),Ah=c(),Ot=a("p"),Ph=n("The "),ms=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),$a=a("code"),Gh=n("__call__"),Bh=n(" special method."),Qh=c(),T(_o.$$.fragment),Wh=c(),T(go.$$.fragment),this.h()},l(o){const _=Vu('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),v=h(o),p=r(o,"H1",{class:!0});var In=d(p);u=r(In,"A",{id:!0,class:!0,href:!0});var Da=d(u);b=r(Da,"SPAN",{});var Fa=d(b);k(i.$$.fragment,Fa),Fa.forEach(t),Da.forEach(t),f=h(In),D=r(In,"SPAN",{});var za=d(D);Pe=s(za,"LED"),za.forEach(t),In.forEach(t),pe=h(o),F=r(o,"H2",{class:!0});var Gn=d(F);Z=r(Gn,"A",{id:!0,class:!0,href:!0});var xa=d(Z);W=r(xa,"SPAN",{});var Ma=d(W);k(ee.$$.fragment,Ma),Ma.forEach(t),xa.forEach(t),Ne=h(Gn),H=r(Gn,"SPAN",{});var Sa=d(H);Ie=s(Sa,"Overview"),Sa.forEach(t),Gn.forEach(t),qe=h(o),I=r(o,"P",{});var Bn=d(I);V=s(Bn,"The LED model was proposed in "),te=r(Bn,"A",{href:!0,rel:!0});var Ca=d(te);be=s(Ca,"Longformer: The Long-Document Transformer"),Ca.forEach(t),C=s(Bn,` by Iz
...
`),P=r(Q,"A",{href:!0});var Ia=d(P);He=s(Ia,"BartForConditionalGeneration"),Ia.forEach(t),ne=s(Q," exchanging the traditional "),Te=r(Q,"EM",{});var Ga=d(Te);q=s(Ga,"self-attention"),Ga.forEach(t),z=s(Q,` layer with
...
`),Ss=r(ge,"CODE",{});var rp=d(Ss);zd=s(rp,"<s>"),rp.forEach(t),xd=s(ge," token. For question answering, it is advised to put "),Cs=r(ge,"EM",{});var dp=d(Cs);Md=s(dp,"global attention"),dp.forEach(t),Sd=s(ge," on all tokens of the question."),ge.forEach(t),Cd=h(J),Ue=r(J,"LI",{});var vo=d(Ue);Od=s(vo,"To fine-tune LED on all 16384, "),Os=r(vo,"EM",{});var ip=d(Os);jd=s(ip,"gradient checkpointing"),ip.forEach(t),Ad=s(vo,` can be enabled in case training leads to out-of-memory (OOM)
...
flag can be used to disable the caching mechanism to save memory.`),vo.forEach(t),Bd=h(J),$o=r(J,"LI",{});var Tr=d($o);Qd=s(Tr,"A notebook showing how to evaluate LED, can be accessed "),Do=r(Tr,"A",{href:!0,rel:!0});var hp=d(Do);Wd=s(hp,"here"),hp.forEach(t),Hd=s(Tr,"."),Tr.forEach(t),Vd=h(J),Fo=r(J,"LI",{});var kr=d(Fo);Rd=s(kr,"A notebook showing how to fine-tune LED, can be accessed "),zo=r(kr,"A",{href:!0,rel:!0});var pp=d(zo);Ud=s(pp,"here"),pp.forEach(t),Xd=s(kr,"."),kr.forEach(t),J.forEach(t),Ha=h(o),jt=r(o,"P",{});var wr=d(jt);Jd=s(wr,"This model was contributed by "),xo=r(wr,"A",{href:!0,rel:!0});var up=d(xo);Zd=s(up,"patrickvonplaten"),up.forEach(t),Kd=s(wr,"."),wr.forEach(t),Va=h(o),lt=r(o,"H2",{class:!0});var yr=d(lt);At=r(yr,"A",{id:!0,class:!0,href:!0});var mp=d(At);Ps=r(mp,"SPAN",{});var fp=d(Ps);k(Mo.$$.fragment,fp),fp.forEach(t),mp.forEach(t),Yd=h(yr),Ns=r(yr,"SPAN",{});var _p=d(Ns);ei=s(_p,"LEDConfig"),_p.forEach(t),yr.forEach(t),Ra=h(o),we=r(o,"DIV",{class:!0});var bo=d(we);k(So.$$.fragment,bo),ti=h(bo),ct=r(bo,"P",{});var _s=d(ct);oi=s(_s,"This is the configuration class to store the configuration of a "),Hn=r(_s,"A",{href:!0});var gp=d(Hn);ni=s(gp,"LEDModel"),gp.forEach(t),si=s(_s,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),Co=r(_s,"A",{href:!0,rel:!0});var vp=d(Co);ai=s(vp,"allenai/led-base-16384"),vp.forEach(t),ri=s(_s," architecture."),_s.forEach(t),di=h(bo),ht=r(bo,"P",{});var gs=d(ht);ii=s(gs,"Configuration objects inherit from "),Vn=r(gs,"A",{href:!0});var bp=d(Vn);li=s(bp,"PretrainedConfig"),bp.forEach(t),ci=s(gs,` and can be used to control the model outputs. Read the
documentation from `),Rn=r(gs,"A",{href:!0});var Tp=d(Rn);hi=s(Tp,"PretrainedConfig"),Tp.forEach(t),pi=s(gs," for more information."),gs.forEach(t),ui=h(bo),k(Pt.$$.fragment,bo),bo.forEach(t),Ua=h(o),pt=r(o,"H2",{class:!0});var Er=d(pt);Nt=r(Er,"A",{id:!0,class:!0,href:!0});var kp=d(Nt);Is=r(kp,"SPAN",{});var wp=d(Is);k(Oo.$$.fragment,wp),wp.forEach(t),kp.forEach(t),mi=h(Er),Gs=r(Er,"SPAN",{});var yp=d(Gs);fi=s(yp,"LEDTokenizer"),yp.forEach(t),Er.forEach(t),Xa=h(o),A=r(o,"DIV",{class:!0});var Y=d(A);k(jo.$$.fragment,Y),_i=h(Y),Bs=r(Y,"P",{});var Ep=d(Bs);gi=s(Ep,"Construct a LED tokenizer."),Ep.forEach(t),vi=h(Y),It=r(Y,"P",{});var Qa=d(It);Un=r(Qa,"A",{href:!0});var Lp=d(Un);bi=s(Lp,"LEDTokenizer"),Lp.forEach(t),Ti=s(Qa," is identical to "),Xn=r(Qa,"A",{href:!0});var qp=d(Xn);ki=s(qp,"BartTokenizer"),qp.forEach(t),wi=s(Qa,` and runs end-to-end tokenization: punctuation splitting and
...
make use of token type ids, therefore a list of zeros is returned.`),Mp.forEach(t),Fr.forEach(t),Wi=h(Y),Yn=r(Y,"DIV",{class:!0});var Sp=d(Yn);k(Qo.$$.fragment,Sp),Sp.forEach(t),Y.forEach(t),Ja=h(o),ut=r(o,"H2",{class:!0});var zr=d(ut);Qt=r(zr,"A",{id:!0,class:!0,href:!0});var Cp=d(Qt);Us=r(Cp,"SPAN",{});var Op=d(Us);k(Wo.$$.fragment,Op),Op.forEach(t),Cp.forEach(t),Hi=h(zr),Xs=r(zr,"SPAN",{});var jp=d(Xs);Vi=s(jp,"LEDTokenizerFast"),jp.forEach(t),zr.forEach(t),Za=h(o),ye=r(o,"DIV",{class:!0});var To=d(ye);k(Ho.$$.fragment,To),Ri=h(To),Vo=r(To,"P",{});var xr=d(Vo);Ui=s(xr,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Js=r(xr,"EM",{});var Ap=d(Js);Xi=s(Ap,"tokenizers"),Ap.forEach(t),Ji=s(xr," library)."),xr.forEach(t),Zi=h(To),Wt=r(To,"P",{});var Wa=d(Wt);es=r(Wa,"A",{href:!0});var Pp=d(es);Ki=s(Pp,"LEDTokenizerFast"),Pp.forEach(t),Yi=s(Wa," is identical to "),ts=r(Wa,"A",{href:!0});var Np=d(ts);el=s(Np,"BartTokenizerFast"),Np.forEach(t),tl=s(Wa,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Wa.forEach(t),ol=h(To),Ro=r(To,"P",{});var Mr=d(Ro);nl=s(Mr,"Refer to superclass "),os=r(Mr,"A",{href:!0});var Ip=d(os);sl=s(Ip,"BartTokenizerFast"),Ip.forEach(t),al=s(Mr," for usage examples and documentation concerning parameters."),Mr.forEach(t),To.forEach(t),Ka=h(o),mt=r(o,"H2",{class:!0});var Sr=d(mt);Ht=r(Sr,"A",{id:!0,class:!0,href:!0});var Gp=d(Ht);Zs=r(Gp,"SPAN",{});var Bp=d(Zs);k(Uo.$$.fragment,Bp),Bp.forEach(t),Gp.forEach(t),rl=h(Sr),Ks=r(Sr,"SPAN",{});var Qp=d(Ks);dl=s(Qp,"LED specific outputs"),Qp.forEach(t),Sr.forEach(t),Ya=h(o),ft=r(o,"DIV",{class:!0});var Cr=d(ft);k(Xo.$$.fragment,Cr),il=h(Cr),Ys=r(Cr,"P",{});var Wp=d(Ys);ll=s(Wp,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Wp.forEach(t),Cr.forEach(t),er=h(o),_t=r(o,"DIV",{class:!0});var Or=d(_t);k(Jo.$$.fragment,Or),cl=h(Or),ea=r(Or,"P",{});var Hp=d(ea);hl=s(Hp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Hp.forEach(t),Or.forEach(t),tr=h(o),gt=r(o,"DIV",{class:!0});var jr=d(gt);k(Zo.$$.fragment,jr),pl=h(jr),ta=r(jr,"P",{});var Vp=d(ta);ul=s(Vp,"Base class for sequence-to-sequence language models outputs."),Vp.forEach(t),jr.forEach(t),or=h(o),vt=r(o,"DIV",{class:!0});var Ar=d(vt);k(Ko.$$.fragment,Ar),ml=h(Ar),oa=r(Ar,"P",{});var Rp=d(oa);fl=s(Rp,"Base class for outputs of sequence-to-sequence sentence classification models."),Rp.forEach(t),Ar.forEach(t),nr=h(o),bt=r(o,"DIV",{class:!0});var Pr=d(bt);k(Yo.$$.fragment,Pr),_l=h(Pr),na=r(Pr,"P",{});var Up=d(na);gl=s(Up,"Base class for outputs of sequence-to-sequence question answering models."),Up.forEach(t),Pr.forEach(t),sr=h(o),Tt=r(o,"DIV",{class:!0});var Nr=d(Tt);k(en.$$.fragment,Nr),vl=h(Nr),sa=r(Nr,"P",{});var Xp=d(sa);bl=s(Xp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Xp.forEach(t),Nr.forEach(t),ar=h(o),kt=r(o,"DIV",{class:!0});var Ir=d(kt);k(tn.$$.fragment,Ir),Tl=h(Ir),aa=r(Ir,"P",{});var Jp=d(aa);kl=s(Jp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Wr.forEach(t),Cl=h(ko),xe=r(ko,"DIV",{class:!0});var wo=d(xe);k(ln.$$.fragment,wo),Ol=h(wo),Et=r(wo,"P",{});var bs=d(Et);jl=s(bs,"The "),ss=r(bs,"A",{href:!0});var nu=d(ss);Al=s(nu,"LEDModel"),nu.forEach(t),Pl=s(bs," forward method, overrides the "),la=r(bs,"CODE",{});var su=d(la);Nl=s(su,"__call__"),su.forEach(t),Il=s(bs," special method."),bs.forEach(t),Gl=h(wo),k(Rt.$$.fragment,wo),Bl=h(wo),k(Ut.$$.fragment,wo),wo.forEach(t),ko.forEach(t),lr=h(o),Lt=r(o,"H2",{class:!0});var Hr=d(Lt);Xt=r(Hr,"A",{id:!0,class:!0,href:!0});var au=d(Xt);ca=r(au,"SPAN",{});var ru=d(ca);k(cn.$$.fragment,ru),ru.forEach(t),au.forEach(t),Ql=h(Hr),ha=r(Hr,"SPAN",{});var du=d(ha);Wl=s(du,"LEDForConditionalGeneration"),du.forEach(t),Hr.forEach(t),cr=h(o),Le=r(o,"DIV",{class:!0});var yo=d(Le);k(hn.$$.fragment,yo),Hl=h(yo),pn=r(yo,"P",{});var Vr=d(pn);Vl=s(Vr,`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Rr.forEach(t),Yl=h(yo),fe=r(yo,"DIV",{class:!0});var Ze=d(fe);k(fn.$$.fragment,Ze),ec=h(Ze),qt=r(Ze,"P",{});var Ts=d(qt);tc=s(Ts,"The "),rs=r(Ts,"A",{href:!0});var cu=d(rs);oc=s(cu,"LEDForConditionalGeneration"),cu.forEach(t),nc=s(Ts," forward method, overrides the "),pa=r(Ts,"CODE",{});var hu=d(pa);sc=s(hu,"__call__"),hu.forEach(t),ac=s(Ts," special method."),Ts.forEach(t),rc=h(Ze),k(Jt.$$.fragment,Ze),dc=h(Ze),k(Zt.$$.fragment,Ze),ic=h(Ze),k(Kt.$$.fragment,Ze),Ze.forEach(t),yo.forEach(t),hr=h(o),$t=r(o,"H2",{class:!0});var Ur=d($t);Yt=r(Ur,"A",{id:!0,class:!0,href:!0});var pu=d(Yt);ua=r(pu,"SPAN",{});var uu=d(ua);k(_n.$$.fragment,uu),uu.forEach(t),pu.forEach(t),lc=h(Ur),ma=r(Ur,"SPAN",{});var mu=d(ma);cc=s(mu,"LEDForSequenceClassification"),mu.forEach(t),Ur.forEach(t),pr=h(o),ie=r(o,"DIV",{class:!0});var Ke=d(ie);k(gn.$$.fragment,Ke),hc=h(Ke),fa=r(Ke,"P",{});var fu=d(fa);pc=s(fu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),od.forEach(t),fh=h(tt),k(ho.$$.fragment,tt),_h=h(tt),Me=r(tt,"DIV",{class:!0});var Eo=d(Me);k(Sn.$$.fragment,Eo),gh=h(Eo),St=r(Eo,"P",{});var Es=d(St);vh=s(Es,"The "),ps=r(Es,"A",{href:!0});var Cu=d(ps);bh=s(Cu,"TFLEDModel"),Cu.forEach(t),Th=s(Es," forward method, overrides the "),Ea=r(Es,"CODE",{});var Ou=d(Ea);kh=s(Ou,"__call__"),Ou.forEach(t),wh=s(Es," special method."),Es.forEach(t),yh=h(Eo),k(po.$$.fragment,Eo),Eh=h(Eo),k(uo.$$.fragment,Eo),Eo.forEach(t),tt.forEach(t),gr=h(o),Ct=r(o,"H2",{class:!0});var nd=d(Ct);mo=r(nd,"A",{id:!0,class:!0,href:!0});var ju=d(mo);La=r(ju,"SPAN",{});var Au=d(La);k(Cn.$$.fragment,Au),Au.forEach(t),ju.forEach(t),Lh=h(nd),qa=r(nd,"SPAN",{});var Pu=d(qa);qh=s(Pu,"TFLEDForConditionalGeneration"),Pu.forEach(t),nd.forEach(t),vr=h(o),he=r(o,"DIV",{class:!0});var ot=d(he);k(On.$$.fragment,ot),$h=h(ot),jn=r(ot,"P",{});var sd=d(jn);Dh=s(sd,`The LED Model with a language modeling head. Can be used for summarization.
