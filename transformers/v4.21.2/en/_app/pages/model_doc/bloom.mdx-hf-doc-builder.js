...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(n.$$.fragment)},l(c){$(n.$$.fragment,c)},m(c,m){w(n,c,m),g=!0},p:ee,i(c){g||(y(n.$$.fragment,c),g=!0)},o(c){T(n.$$.fragment,c),g=!1},d(c){B(n,c)}}}function Il(F){let n,g,c,m,b,s,p,C,te,O,H,R,Xo,De,ws,Zo,ys,Vt,fe,Ts,We,Bs,Fs,Ut,M,et,He,Cs,zs,ot,Ve,qs,xs,tt,Ue,Ms,Es,st,Re,js,Ps,nt,Ge,Ss,As,Mo,Ye,Ns,Is,Rt,se,ge,at,Je,Ls,rt,Os,Gt,D,Ke,Ds,ne,Ws,Eo,Hs,Vs,Qe,Us,Rs,Gs,ae,Ys,jo,Js,Ks,Po,Qs,Xs,Zs,_e,Yt,re,be,lt,Xe,en,it,on,Jt,E,Ze,tn,dt,sn,nn,eo,an,So,rn,ln,dn,oo,cn,to,mn,pn,hn,V,so,un,le,fn,Ao,gn,_n,ct,bn,vn,kn,ve,$n,ke,Kt,ie,$e,mt,no,wn,pt,yn,Qt,z,ao,Tn,ro,Bn,ht,Fn,Cn,zn,ut,qn,xn,we,Mn,lo,En,ft,jn,Pn,Sn,ye,An,io,Nn,No,In,Ln,Xt,de,Te,gt,co,On,_t,Dn,Zt,j,mo,Wn,bt,Hn,Vn,po,Un,Io,Rn,Gn,Yn,ho,Jn,uo,Kn,Qn,Xn,U,fo,Zn,ce,ea,Lo,oa,ta,vt,sa,na,aa,Be,ra,Fe,es,me,Ce,kt,go,la,$t,ia,os,q,_o,da,wt,ca,ma,Oo,Do,pa,ha,ua,W,fa,yt,ga,_a,Tt,ba,va,Bt,ka,$a,Ft,wa,ya,Ta,bo,Ba,Wo,Fa,Ca,za,vo,qa,ko,xa,Ma,Ea,x,$o,ja,pe,Pa,Ho,Sa,Aa,Ct,Na,Ia,La,ze,Oa,qe,Da,xe,Wa,Me,Ha,Ee,ts,he,je,zt,wo,Va,qt,Ua,ss,P,yo,Ra,xt,Ga,Ya,To,Ja,Vo,Ka,Qa,Xa,Bo,Za,Fo,er,or,tr,A,Co,sr,ue,nr,Uo,ar,rr,Mt,lr,ir,dr,Pe,cr,Se,mr,Ae,ns;return s=new Oe({}),De=new Oe({}),Je=new Oe({}),Ke=new X({props:{name:"class transformers.BloomConfig",anchor:"transformers.BloomConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 64"},{name:"n_layer",val:" = 2"},{name:"n_head",val:" = 8"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"use_cache",val:" = False"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"apply_residual_connection_post_layernorm",val:" = False"},{name:"hidden_dropout",val:" = 0.0"},{name:"attention_dropout",val:" = 0.0"},{name:"pretraining_tp",val:" = 1"},{name:"slow_but_exact",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BloomConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
Vocabulary size of the Bloom model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.2/en/model_doc/bloom#transformers.BloomModel">BloomModel</a>.`,name:"vocab_size"},{anchor:"transformers.BloomConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
resolved in the future once the main model has been fine-tuned with TP_rank=1.`,name:"slow_but_exact"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/configuration_bloom.py#L42"}}),_e=new Z({props:{anchor:"transformers.BloomConfig.example",$$slots:{default:[yl]},$$scope:{ctx:F}}}),Xe=new Oe({}),Ze=new X({props:{name:"class transformers.BloomModel",anchor:"transformers.BloomModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BloomModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.2/en/model_doc/bloom#transformers.BloomConfig">BloomConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/modeling_bloom.py#L561"}}),so=new X({props:{name:"forward",anchor:"transformers.BloomModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.2/en/model_doc/bloom#transformers.BloomTokenizerFast">BloomTokenizerFast</a>. See <a href="/docs/transformers/v4.21.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.2/en/model_doc/bloom#transformers.BloomConfig"
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/tokenization_bloom_fast.py#L49"}}),we=new Z({props:{anchor:"transformers.BloomTokenizerFast.example",$$slots:{default:[Fl]},$$scope:{ctx:F}}}),ye=new Ht({props:{$$slots:{default:[Cl]},$$scope:{ctx:F}}}),co=new Oe({}),mo=new X({props:{name:"class transformers.BloomForCausalLM",anchor:"transformers.BloomForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BloomForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.2/en/model_doc/bloom#transformers.BloomConfig">BloomConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/modeling_bloom.py#L752"}}),fo=new X({props:{name:"forward",anchor:"transformers.BloomForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/modeling_bloom.py#L792",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/modeling_bloom.py#L886"}}),$o=new X({props:{name:"forward",anchor:"transformers.BloomForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/modeling_bloom.py#L898",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/modeling_bloom.py#L1007"}}),Co=new X({props:{name:"forward",anchor:"transformers.BloomForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/bloom/modeling_bloom.py#L1027",returnDescription:`
<p>A <a
...
and behavior.`),hn=u(),V=a("div"),k(so.$$.fragment),un=u(),le=a("p"),fn=i("The "),Ao=a("a"),gn=i("BloomModel"),_n=i(" forward method, overrides the "),ct=a("code"),bn=i("__call__"),vn=i(" special method."),kn=u(),k(ve.$$.fragment),$n=u(),k(ke.$$.fragment),Kt=u(),ie=a("h2"),$e=a("a"),mt=a("span"),k(no.$$.fragment),wn=u(),pt=a("span"),yn=i("BloomTokenizerFast"),Qt=u(),z=a("div"),k(ao.$$.fragment),Tn=u(),ro=a("p"),Bn=i("Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),ht=a("em"),Fn=i("tokenizers"),Cn=i(` library). Based on byte-level
...
embeddings).`),Vn=u(),po=a("p"),Un=i("This model inherits from "),Io=a("a"),Rn=i("PreTrainedModel"),Gn=i(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ea=u(),x=a("div"),k($o.$$.fragment),ja=u(),pe=a("p"),Pa=i("The "),Ho=a("a"),Sa=i("BloomForSequenceClassification"),Aa=i(" forward method, overrides the "),Ct=a("code"),Na=i("__call__"),Ia=i(" special method."),La=u(),k(ze.$$.fragment),Oa=u(),k(qe.$$.fragment),Da=u(),k(xe.$$.fragment),Wa=u(),k(Me.$$.fragment),Ha=u(),k(Ee.$$.fragment),ts=u(),he=a("h2"),je=a("a"),zt=a("span"),k(wo.$$.fragment),Va=u(),qt=a("span"),Ua=i("BloomForTokenClassification"),ss=u(),P=a("div"),k(yo.$$.fragment),Ra=u(),xt=a("p"),Ga=i(`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tr=u(),A=a("div"),k(Co.$$.fragment),sr=u(),ue=a("p"),nr=i("The "),Uo=a("a"),ar=i("BloomForTokenClassification"),rr=i(" forward method, overrides the "),Mt=a("code"),lr=i("__call__"),ir=i(" special method."),dr=u(),k(Pe.$$.fragment),cr=u(),k(Se.$$.fragment),mr=u(),k(Ae.$$.fragment),this.h()},l(o){const _=$l('[data-svelte="svelte-1phssyn"]',document.head);n=r(_,"META",{name:!0,content:!0}),_.forEach(t),g=f(o),c=r(o,"H1",{class:!0});var zo=l(c);m=r(zo,"A",{id:!0,class:!0,href:!0});var Et=l(m);b=r(Et,"SPAN",{});var jt=l(b);$(s.$$.fragment,jt),jt.forEach(t),Et.forEach(t),p=f(zo),C=r(zo,"SPAN",{});var Pt=l(C);te=d(Pt,"BLOOM"),Pt.forEach(t),zo.forEach(t),O=f(o),H=r(o,"H2",{class:!0});var qo=l(H);R=r(qo,"A",{id:!0,class:!0,href:!0});var St=l(R);Xo=r(St,"SPAN",{});var At=l(Xo);$(De.$$.fragment,At),At.forEach(t),St.forEach(t),ws=f(qo),Zo=r(qo,"SPAN",{});var Nt=l(Zo);ys=d(Nt,"Overview"),Nt.forEach(t),qo.forEach(t),Vt=f(o),fe=r(o,"P",{});var xo=l(fe);Ts=d(xo,"The BLOOM model has been proposed with its various versions through the "),We=r(xo,"A",{href:!0,rel:!0});var It=l(We);Bs=d(It,"BigScience Workshop"),It.forEach(t),Fs=d(xo,`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
The architecture of BLOOM is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on different 46 languages including code.
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),xo.forEach(t),Ut=f(o),M=r(o,"UL",{});var S=l(M);et=r(S,"LI",{});var Lt=l(et);He=r(Lt,"A",{href:!0,rel:!0});var Ot=l(He);Cs=d(Ot,"bloom-350m"),Ot.forEach(t),Lt.forEach(t),zs=f(S),ot=r(S,"LI",{});var Dt=l(ot);Ve=r(Dt,"A",{href:!0,rel:!0});var Wt=l(Ve);qs=d(Wt,"bloom-760m"),Wt.forEach(t),Dt.forEach(t),xs=f(S),tt=r(S,"LI",{});var ur=l(tt);Ue=r(ur,"A",{href:!0,rel:!0});var fr=l(Ue);Ms=d(fr,"bloom-1b3"),fr.forEach(t),ur.forEach(t),Es=f(S),st=r(S,"LI",{});var gr=l(st);Re=r(gr,"A",{href:!0,rel:!0});var _r=l(Re);js=d(_r,"bloom-2b5"),_r.forEach(t),gr.forEach(t),Ps=f(S),nt=r(S,"LI",{});var br=l(nt);Ge=r(br,"A",{href:!0,rel:!0});var vr=l(Ge);Ss=d(vr,"bloom-6b3"),vr.forEach(t),br.forEach(t),As=f(S),Mo=r(S,"LI",{});var pr=l(Mo);Ye=r(pr,"A",{href:!0,rel:!0});var kr=l(Ye);Ns=d(kr,"bloom"),kr.forEach(t),Is=d(pr," (176B parameters)"),pr.forEach(t),S.forEach(t),Rt=f(o),se=r(o,"H2",{class:!0});var as=l(se);ge=r(as,"A",{id:!0,class:!0,href:!0});var $r=l(ge);at=r($r,"SPAN",{});var wr=l(at);$(Je.$$.fragment,wr),wr.forEach(t),$r.forEach(t),Ls=f(as),rt=r(as,"SPAN",{});var yr=l(rt);Os=d(yr,"BloomConfig"),yr.forEach(t),as.forEach(t),Gt=f(o),D=r(o,"DIV",{class:!0});var Ne=l(D);$(Ke.$$.fragment,Ne),Ds=f(Ne),ne=r(Ne,"P",{});var Ro=l(ne);Ws=d(Ro,"This is the configuration class to store the configuration of a "),Eo=r(Ro,"A",{href:!0});var Tr=l(Eo);Hs=d(Tr,"BloomModel"),Tr.forEach(t),Vs=d(Ro,`. It is used to instantiate a Bloom
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
`),Qe=r(Ro,"A",{href:!0,rel:!0});var Br=l(Qe);Us=d(Br,"bigscience/bloom"),Br.forEach(t),Rs=d(Ro,"."),Ro.forEach(t),Gs=f(Ne),ae=r(Ne,"P",{});var Go=l(ae);Ys=d(Go,"Configuration objects inherit from "),jo=r(Go,"A",{href:!0});var Fr=l(jo);Js=d(Fr,"PretrainedConfig"),Fr.forEach(t),Ks=d(Go,` and can be used to control the model outputs. Read the
...
refer to this superclass for more information regarding those methods.`),ps.forEach(t),N.forEach(t),Xt=f(o),de=r(o,"H2",{class:!0});var hs=l(de);Te=r(hs,"A",{id:!0,class:!0,href:!0});var Hr=l(Te);gt=r(Hr,"SPAN",{});var Vr=l(gt);$(co.$$.fragment,Vr),Vr.forEach(t),Hr.forEach(t),On=f(hs),_t=r(hs,"SPAN",{});var Ur=l(_t);Dn=d(Ur,"BloomForCausalLM"),Ur.forEach(t),hs.forEach(t),Zt=f(o),j=r(o,"DIV",{class:!0});var Y=l(j);$(mo.$$.fragment,Y),Wn=f(Y),bt=r(Y,"P",{});var Rr=l(bt);Hn=d(Rr,`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Rr.forEach(t),Vn=f(Y),po=r(Y,"P",{});var us=l(po);Un=d(us,"This model inherits from "),Io=r(us,"A",{href:!0});var Gr=l(Io);Rn=d(Gr,"PreTrainedModel"),Gr.forEach(t),Gn=d(us,`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bs.forEach(t),Ea=f(I),x=r(I,"DIV",{class:!0});var L=l(x);$($o.$$.fragment,L),ja=f(L),pe=r(L,"P",{});var Ko=l(pe);Pa=d(Ko,"The "),Ho=r(Ko,"A",{href:!0});var il=l(Ho);Sa=d(il,"BloomForSequenceClassification"),il.forEach(t),Aa=d(Ko," forward method, overrides the "),Ct=r(Ko,"CODE",{});var dl=l(Ct);Na=d(dl,"__call__"),dl.forEach(t),Ia=d(Ko," special method."),Ko.forEach(t),La=f(L),$(ze.$$.fragment,L),Oa=f(L),$(qe.$$.fragment,L),Da=f(L),$(xe.$$.fragment,L),Wa=f(L),$(Me.$$.fragment,L),Ha=f(L),$(Ee.$$.fragment,L),L.forEach(t),I.forEach(t),ts=f(o),he=r(o,"H2",{class:!0});var vs=l(he);je=r(vs,"A",{id:!0,class:!0,href:!0});var cl=l(je);zt=r(cl,"SPAN",{});var ml=l(zt);$(wo.$$.fragment,ml),ml.forEach(t),cl.forEach(t),Va=f(vs),qt=r(vs,"SPAN",{});var pl=l(qt);Ua=d(pl,"BloomForTokenClassification"),pl.forEach(t),vs.forEach(t),ss=f(o),P=r(o,"DIV",{class:!0});var K=l(P);$(yo.$$.fragment,K),Ra=f(K),xt=r(K,"P",{});var hl=l(xt);Ga=d(hl,`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
