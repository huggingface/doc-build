...
`),J=n("code"),Z=i("model([input_ids, attention_mask])"),ee=i(" or "),te=n("code"),ue=i("model([input_ids, attention_mask, token_type_ids])"),xe=p(),B=n("li"),Ce=i(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
first positional argument :`),Re.forEach(t),pe=u(b),E=s(b,"UL",{});var N=a(E);L=s(N,"LI",{});var oe=a(L);re=l(oe,"a single Tensor with "),Q=s(oe,"CODE",{});var Ke=a(Q);ve=l(Ke,"input_ids"),Ke.forEach(t),ie=l(oe," only and nothing else: "),U=s(oe,"CODE",{});var Ae=a(U);Fe=l(Ae,"model(input_ids)"),Ae.forEach(t),oe.forEach(t),be=u(N),j=s(N,"LI",{});var z=a(j);Me=l(z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),J=s(z,"CODE",{});var Je=a(J);Z=l(Je,"model([input_ids, attention_mask])"),Je.forEach(t),ee=l(z," or "),te=s(z,"CODE",{});var me=a(te);ue=l(me,"model([input_ids, attention_mask, token_type_ids])"),me.forEach(t),z.forEach(t),xe=u(N),B=s(N,"LI",{});var je=a(B);Ce=l(je,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=s(je,"CODE",{});var Ze=a(q);ze=l(Ze,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ze.forEach(t),je.forEach(t),N.forEach(t)},m(b,x){g(b,d,x),e(d,v),g(b,h,x),g(b,c,x),e(c,T),e(T,r),e(c,f),e(c,C),e(C,$e),g(b,ae,x),g(b,M,x),e(M,K),e(M,W),e(W,X),e(M,Pe),e(M,G),e(G,Oe),e(M,Te),g(b,A,x),g(b,H,x),e(H,Y),g(b,pe,x),g(b,E,x),e(E,L),e(L,re),e(L,Q),e(Q,ve),e(L,ie),e(L,U),e(U,Fe),e(E,be),e(E,j),e(j,Me),e(j,J),e(J,Z),e(j,ee),e(j,te),e(te,ue),e(E,xe),e(E,B),e(B,Ce),e(B,q),e(q,ze)},d(b){b&&t(d),b&&t(h),b&&t(c),b&&t(ae),b&&t(M),b&&t(A),b&&t(H),b&&t(pe),b&&t(E)}}}function Rl(F){let d,v,h,c,T;return{c(){d=n("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),c=i("Module"),T=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var f=a(d);v=l(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(f,"CODE",{});var C=a(h);c=l(C,"Module"),C.forEach(t),T=l(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),v=i("Example:"),h=p(),y(c.$$.fragment)},l(r){d=s(r,"P",{});var f=a(d);v=l(f,"Example:"),f.forEach(t),h=u(r),k(c.$$.fragment,r)},m(r,f){g(r,d,f),e(d,v),g(r,h,f),w(c,r,f),T=!0},p:Ie,i(r){T||($(c.$$.fragment,r),T=!0)},o(r){P(c.$$.fragment,r),T=!1},d(r){r&&t(d),r&&t(h),O(c,r)}}}function Jl(F){let d,v,h,c,T,r,f,C,$e,ae,M,K,W,X,Pe,G,Oe,Te,A,H,Y,pe,E,L,re,Q,ve,ie,U,Fe,be,j,Me,J,Z,ee,te,ue,xe,B,Ce,q,ze;return{c(){d=n("p"),v=i("TF 2.0 models accepts two formats as inputs:"),h=p(),c=n("ul"),T=n("li"),r=i("having all inputs as keyword arguments (like PyTorch models), or"),f=p(),C=n("li"),$e=i("having all inputs as a list, tuple or dict in the first positional arguments."),ae=p(),M=n("p"),K=i("This second option is useful when using "),W=n("code"),X=i("tf.keras.Model.fit"),Pe=i(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=n("code"),Oe=i("model(inputs)"),Te=i("."),A=p(),H=n("p"),Y=i(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=p(),E=n("ul"),L=n("li"),re=i("a single Tensor with "),Q=n("code"),ve=i("input_ids"),ie=i(" only and nothing else: "),U=n("code"),Fe=i("model(input_ids)"),be=p(),j=n("li"),Me=i(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),J=n("code"),Z=i("model([input_ids, attention_mask])"),ee=i(" or "),te=n("code"),ue=i("model([input_ids, attention_mask, token_type_ids])"),xe=p(),B=n("li"),Ce=i(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),q=n("code"),ze=i('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){d=s(b,"P",{});var x=a(d);v=l(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),h=u(b),c=s(b,"UL",{});var he=a(c);T=s(he,"LI",{});var Ee=a(T);r=l(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),f=u(he),C=s(he,"LI",{});var Be=a(C);$e=l(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),he.forEach(t),ae=u(b),M=s(b,"P",{});var V=a(M);K=l(V,"This second option is useful when using "),W=s(V,"CODE",{});var qe=a(W);X=l(qe,"tf.keras.Model.fit"),qe.forEach(t),Pe=l(V,` method which currently requires having all the
...
<p>Indices can be obtained using <code>OPTTokenizer</code>. See <a href="/docs/transformers/v4.21.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.2/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/opt/modeling_opt.py#L745",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.2/en/model_doc/opt#transformers.OPTConfig"
...
Whether or not to return a <a href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/opt/modeling_opt.py#L828",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/opt/modeling_tf_opt.py#L796",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/opt/modeling_opt.py#L1008",returnDescription:`
...
<a href="/docs/transformers/v4.21.2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/opt/modeling_flax_opt.py#L769"}}),Io=new se({props:{name:"__call__",anchor:"transformers.FlaxOPTForCausalLM.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"deterministic",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/v4.21.2/src/transformers/models/opt/modeling_flax_opt.py#L585",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
<p><a
  href="/docs/transformers/v4.21.2/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),At=new Ne({props:{anchor:"transformers.FlaxOPTForCausalLM.__call__.example",$$slots:{default:[nd]},$$scope:{ctx:F}}}),{c(){d=n("meta"),v=p(),h=n("h1"),c=n("a"),T=n("span"),y(r.$$.fragment),f=p(),C=n("span"),$e=i("OPT"),ae=p(),M=n("h2"),K=n("a"),W=n("span"),y(X.$$.fragment),Pe=p(),G=n("span"),Oe=i("Overview"),Te=p(),A=n("p"),H=i("The OPT model was proposed in "),Y=n("a"),pe=i("Open Pre-trained Transformer Language Models"),E=i(` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),L=p(),re=n("p"),Q=i("The abstract from the paper is the following:"),ve=p(),ie=n("p"),U=n("em"),Fe=i("Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),be=p(),j=n("p"),Me=i("Tips:"),J=p(),Z=n("ul"),ee=n("li"),te=i("OPT has the same architecture as "),ue=n("code"),xe=i("BartDecoder"),B=i("."),Ce=p(),q=n("li"),ze=i("Contrary to GPT2, OPT adds the EOS token "),b=n("code"),x=i("</s>"),he=i(" to the beginning of every prompt. "),Ee=n("strong"),Be=i("Note"),V=i(": Make sure to pass "),qe=n("code"),Ve=i("use_fast=False"),Re=i(" when loading OPT\u2019s tokenizer with "),N=n("a"),oe=i("AutoTokenizer"),Ke=i(" to get the correct tokenizer."),Ae=p(),z=n("p"),Je=i("This model was contributed by "),me=n("a"),je=i("Arthur Zucker"),Ze=i(", "),Bt=n("a"),Ss=i("Younes Belkada"),As=i(", and "),Vt=n("a"),Ds=i("Patrick Von Platen"),Ws=i(`.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jr=p(),D=n("div"),y($o.$$.fragment),Lr=p(),lt=n("p"),Nr=i("The "),en=n("a"),Ir=i("OPTForSequenceClassification"),Sr=i(" forward method, overrides the "),Mn=n("code"),Ar=i("__call__"),Dr=i(" special method."),Wr=p(),y(xt.$$.fragment),Gr=p(),y(Ct.$$.fragment),Hr=p(),y(zt.$$.fragment),Ur=p(),y(Et.$$.fragment),Br=p(),y(qt.$$.fragment),ds=p(),dt=n("h2"),jt=n("a"),xn=n("span"),y(Po.$$.fragment),Vr=p(),Cn=n("span"),Rr=i("FlaxOPTModel"),cs=p(),ct=n("div"),y(Oo.$$.fragment),Kr=p(),Lt=n("div"),y(Fo.$$.fragment),Jr=p(),y(Nt.$$.fragment),ps=p(),pt=n("h2"),It=n("a"),zn=n("span"),y(Mo.$$.fragment),Zr=p(),En=n("span"),Xr=i("FlaxOPTForCausalLM"),us=p(),S=n("div"),y(xo.$$.fragment),Yr=p(),qn=n("p"),Qr=i(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ks.forEach(t),ja=u(Ge),co=s(Ge,"P",{});var ws=a(co);La=l(ws,"This model is also a "),po=s(ws,"A",{href:!0,rel:!0});var Xi=a(po);Na=l(Xi,"tf.keras.Model"),Xi.forEach(t),Ia=l(ws,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ws.forEach(t),Sa=u(Ge),k(yt.$$.fragment,Ge),Aa=u(Ge),ke=s(Ge,"DIV",{class:!0});var Ht=a(ke);k(uo.$$.fragment,Ht),Da=u(Ht),at=s(Ht,"P",{});var an=a(at);Wa=l(an,"The "),Jo=s(an,"A",{href:!0});var Yi=a(Jo);Ga=l(Yi,"TFOPTModel"),Yi.forEach(t),Ha=l(an," forward method, overrides the "),_n=s(an,"CODE",{});var Qi=a(_n);Ua=l(Qi,"__call__"),Qi.forEach(t),Ba=l(an," special method."),an.forEach(t),Va=u(Ht),k(kt.$$.fragment,Ht),Ra=u(Ht),k(wt.$$.fragment,Ht),Ht.forEach(t),Ge.forEach(t),as=u(o),rt=s(o,"H2",{class:!0});var $s=a(rt);$t=s($s,"A",{id:!0,class:!0,href:!0});var el=a($t);Tn=s(el,"SPAN",{});var tl=a(Tn);k(ho.$$.fragment,tl),tl.forEach(t),el.forEach(t),Ka=u($s),vn=s($s,"SPAN",{});var ol=a(vn);Ja=l(ol,"TFOPTForCausalLM"),ol.forEach(t),$s.forEach(t),rs=u(o),R=s(o,"DIV",{class:!0});var we=a(R);k(mo.$$.fragment,we),Za=u(we),bn=s(we,"P",{});var nl=a(bn);Xa=l(nl,"The OPT Model transformer with a language modeling head on top."),nl.forEach(t),Ya=u(we),fo=s(we,"P",{});var Ps=a(fo);Qa=l(Ps,"This model inherits from "),Zo=s(Ps,"A",{href:!0});var sl=a(Zo);er=l(sl,"TFPreTrainedModel"),sl.forEach(t),tr=l(Ps,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cs.forEach(t),jr=u(le),D=s(le,"DIV",{class:!0});var de=a(D);k($o.$$.fragment,de),Lr=u(de),lt=s(de,"P",{});var rn=a(lt);Nr=l(rn,"The "),en=s(rn,"A",{href:!0});var _l=a(en);Ir=l(_l,"OPTForSequenceClassification"),_l.forEach(t),Sr=l(rn," forward method, overrides the "),Mn=s(rn,"CODE",{});var Tl=a(Mn);Ar=l(Tl,"__call__"),Tl.forEach(t),Dr=l(rn," special method."),rn.forEach(t),Wr=u(de),k(xt.$$.fragment,de),Gr=u(de),k(Ct.$$.fragment,de),Hr=u(de),k(zt.$$.fragment,de),Ur=u(de),k(Et.$$.fragment,de),Br=u(de),k(qt.$$.fragment,de),de.forEach(t),le.forEach(t),ds=u(o),dt=s(o,"H2",{class:!0});var zs=a(dt);jt=s(zs,"A",{id:!0,class:!0,href:!0});var vl=a(jt);xn=s(vl,"SPAN",{});var bl=a(xn);k(Po.$$.fragment,bl),bl.forEach(t),vl.forEach(t),Vr=u(zs),Cn=s(zs,"SPAN",{});var yl=a(Cn);Rr=l(yl,"FlaxOPTModel"),yl.forEach(t),zs.forEach(t),cs=u(o),ct=s(o,"DIV",{class:!0});var Es=a(ct);k(Oo.$$.fragment,Es),Kr=u(Es),Lt=s(Es,"DIV",{class:!0});var qs=a(Lt);k(Fo.$$.fragment,qs),Jr=u(qs),k(Nt.$$.fragment,qs),qs.forEach(t),Es.forEach(t),ps=u(o),pt=s(o,"H2",{class:!0});var js=a(pt);It=s(js,"A",{id:!0,class:!0,href:!0});var kl=a(It);zn=s(kl,"SPAN",{});var wl=a(zn);k(Mo.$$.fragment,wl),wl.forEach(t),kl.forEach(t),Zr=u(js),En=s(js,"SPAN",{});var $l=a(En);Xr=l($l,"FlaxOPTForCausalLM"),$l.forEach(t),js.forEach(t),us=u(o),S=s(o,"DIV",{class:!0});var ce=a(S);k(xo.$$.fragment,ce),Yr=u(ce),qn=s(ce,"P",{});var Pl=a(qn);Qr=l(Pl,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
