...
superclass.`),Ws=c(),D=l("p"),Da=o("Defining a "),Ut=l("code"),Fa=o("model_type"),Ba=o(" for your configuration (here "),Gt=l("code"),Sa=o('model_type="resnet"'),Ha=o(`) is not mandatory, unless you want to
...
directly upload your config to the Hub.`),Ks=c(),V=l("h2"),oe=l("a"),Qt=l("span"),p(Ce.$$.fragment),tn=c(),Xt=l("span"),sn=o("Writing a custom model"),Vs=c(),B=l("p"),on=o(`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
...
easy to transfer those weights:`),ro=c(),p(Me.$$.fragment),io=c(),H=l("p"),On=o("Now let\u2019s see how to make sure that when we do "),ct=l("a"),Dn=o("save_pretrained()"),Fn=o(" or "),dt=l("a"),Bn=o("push_to_hub()"),Sn=o(`, the
...
in this `),Be=l("a"),Cl=o("model repo"),Pl=o("."),Ro=c(),de=l("p"),Al=o("See the "),wt=l("a"),Tl=o("sharing tutorial"),Ml=o(" for more information on the push to Hub method."),qo=c(),Q=l("h2"),he=l("a"),ws=l("span"),p(Se.$$.fragment),Rl=c(),bs=l("span"),ql=o("Using a model with custom code"),Io=c(),R=l("p"),Il=o(`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
hash of any commit.`),Fo=c(),X=l("h2"),ue=l("a"),Es=l("span"),p(Ye.$$.fragment),Yl=c(),js=l("span"),zl=o("Registering a model with custom code to the auto classes"),Bo=c(),vt=l("p"),Ul=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
...
superclass.`),Pt.forEach(s),Ws=d(e),D=r(e,"P",{});var At=i(D);Da=a(At,"Defining a "),Ut=r(At,"CODE",{});var Er=i(Ut);Fa=a(Er,"model_type"),Er.forEach(s),Ba=a(At," for your configuration (here "),Gt=r(At,"CODE",{});var jr=i(Gt);Sa=a(jr,'model_type="resnet"'),jr.forEach(s),Ha=a(At,`) is not mandatory, unless you want to
...
we will use the pretrained version of the resnet50d. Since our model is just a wrapper around it, it\u2019s going to be
easy to transfer those weights:`),Vr.forEach(s),ro=d(e),_(Me.$$.fragment,e),io=d(e),H=r(e,"P",{});var qt=i(H);On=a(qt,"Now let\u2019s see how to make sure that when we do "),ct=r(qt,"A",{href:!0});var Jr=i(ct);Dn=a(Jr,"save_pretrained()"),Jr.forEach(s),Fn=a(qt," or "),dt=r(qt,"A",{href:!0});var Qr=i(dt);Bn=a(Qr,"push_to_hub()"),Qr.forEach(s),Sn=a(qt,`, the
...
hash of any commit.`),Ti.forEach(s),Fo=d(e),X=r(e,"H2",{class:!0});var ta=i(X);ue=r(ta,"A",{id:!0,class:!0,href:!0});var Mi=i(ue);Es=r(Mi,"SPAN",{});var Ri=i(Es);_(Ye.$$.fragment,Ri),Ri.forEach(s),Mi.forEach(s),Yl=d(ta),js=r(ta,"SPAN",{});var qi=i(js);zl=a(qi,"Registering a model with custom code to the auto classes"),qi.forEach(s),ta.forEach(s),Bo=d(e),vt=r(e,"P",{});var Ii=i(vt);Ul=a(Ii,`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
get the custom models (contrarily to automatically downloading the model code from the Hub).`),Ii.forEach(s),So=d(e),L=r(e,"P",{});var Nt=i(L);Gl=a(Nt,"As long as your config has a "),Cs=r(Nt,"CODE",{});var Ni=i(Cs);Kl=a(Ni,"model_type"),Ni.forEach(s),Vl=a(Nt,` attribute that is different from existing model types, and that your model
