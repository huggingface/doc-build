...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=r("p"),T=i("Example:"),u=h(),b(p.$$.fragment)},l(a){d=n(a,"P",{});var g=s(d);T=l(g,"Example:"),g.forEach(o),u=f(a),w(p.$$.fragment,a)},m(a,g){_(a,d,g),e(d,T),_(a,u,g),P(p,a,g),v=!0},p:vo,i(a){v||($(p.$$.fragment,a),v=!0)},o(a){y(p.$$.fragment,a),v=!1},d(a){a&&o(d),a&&o(u),D(p,a)}}}function tn(x){let d,T;return{c(){d=r("p"),T=i(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
PIL images.`),p.forEach(o)},m(u,p){_(u,d,p),e(d,T)},d(u){u&&o(d)}}}function on(x){let d,T,u,p,v;return{c(){d=r("p"),T=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),p=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=n(a,"P",{});var g=s(d);T=l(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n(g,"CODE",{});var E=s(u);p=l(E,"Module"),E.forEach(o),v=l(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(a,g){_(a,d,g),e(d,T),e(d,u),e(u,p),e(d,v)},d(a){a&&o(d)}}}function an(x){let d,T,u,p,v;return p=new To({props:{code:`from transformers import DPTFeatureExtractor, DPTModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">577</span>, <span class="hljs-number">1024</span>]`}}),{c(){d=r("p"),T=i("Example:"),u=h(),b(p.$$.fragment)},l(a){d=n(a,"P",{});var g=s(d);T=l(g,"Example:"),g.forEach(o),u=f(a),w(p.$$.fragment,a)},m(a,g){_(a,d,g),e(d,T),_(a,u,g),P(p,a,g),v=!0},p:vo,i(a){v||($(p.$$.fragment,a),v=!0)},o(a){y(p.$$.fragment,a),v=!1},d(a){a&&o(d),a&&o(u),D(p,a)}}}function rn(x){let d,T,u,p,v;return{c(){d=r("p"),T=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),p=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=n(a,"P",{});var g=s(d);T=l(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n(g,"CODE",{});var E=s(u);p=l(E,"Module"),E.forEach(o),v=l(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(a,g){_(a,d,g),e(d,T),e(d,u),e(u,p),e(d,v)},d(a){a&&o(d)}}}function nn(x){let d,T,u,p,v;return p=new To({props:{code:`from transformers import DPTFeatureExtractor, DPTForDepthEstimation
import torch
import numpy as np
...
<span class="hljs-meta">&gt;&gt;&gt; </span>depth = Image.fromarray(formatted)`}}),{c(){d=r("p"),T=i("Examples:"),u=h(),b(p.$$.fragment)},l(a){d=n(a,"P",{});var g=s(d);T=l(g,"Examples:"),g.forEach(o),u=f(a),w(p.$$.fragment,a)},m(a,g){_(a,d,g),e(d,T),_(a,u,g),P(p,a,g),v=!0},p:vo,i(a){v||($(p.$$.fragment,a),v=!0)},o(a){y(p.$$.fragment,a),v=!1},d(a){a&&o(d),a&&o(u),D(p,a)}}}function sn(x){let d,T,u,p,v;return{c(){d=r("p"),T=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),p=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=n(a,"P",{});var g=s(d);T=l(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n(g,"CODE",{});var E=s(u);p=l(E,"Module"),E.forEach(o),v=l(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(a,g){_(a,d,g),e(d,T),e(d,u),e(u,p),e(d,v)},d(a){a&&o(d)}}}function ln(x){let d,T,u,p,v;return p=new To({props:{code:`from transformers import DPTFeatureExtractor, DPTForSemanticSegmentation
from PIL import Image
import requests
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/dpt/feature_extraction_dpt.py#L133",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/dpt/modeling_dpt.py#L708",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.0/en/model_doc/dpt#transformers.DPTConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/dpt/modeling_dpt.py#L863"}}),Oe=new J({props:{name:"forward",anchor:"transformers.DPTForDepthEstimation.forward",parameters:[{name:"pixel_values",val:""},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.DPTForDepthEstimation.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.19.0/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
Ground truth depth estimation maps for computing the loss.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/dpt/modeling_dpt.py#L878",returnDescription:`
...
should refer to this superclass for more information regarding those methods.`),ia=h(),L=r("div"),b(ze.$$.fragment),la=h(),$t=r("p"),da=i("Main method to prepare for the model one or several image(s)."),ca=h(),b(ae.$$.fragment),Zt=h(),R=r("h2"),re=r("a"),yt=r("span"),b(Ie.$$.fragment),pa=h(),Dt=r("span"),ma=i("DPTModel"),Qt=h(),S=r("div"),b(Ce.$$.fragment),ha=h(),Me=r("p"),fa=i(`The bare DPT Model transformer outputting raw hidden-states without any specific head on top.
...
should refer to this superclass for more information regarding those methods.`),lo.forEach(o),ia=f(fe),L=n(fe,"DIV",{class:!0});var ct=s(L);w(ze.$$.fragment,ct),la=f(ct),$t=n(ct,"P",{});var Er=s($t);da=l(Er,"Main method to prepare for the model one or several image(s)."),Er.forEach(o),ca=f(ct),w(ae.$$.fragment,ct),ct.forEach(o),fe.forEach(o),Zt=f(t),R=n(t,"H2",{class:!0});var co=s(R);re=n(co,"A",{id:!0,class:!0,href:!0});var kr=s(re);yt=n(kr,"SPAN",{});var Fr=s(yt);w(Ie.$$.fragment,Fr),Fr.forEach(o),kr.forEach(o),pa=f(co),Dt=n(co,"SPAN",{});var jr=s(Dt);ma=l(jr,"DPTModel"),jr.forEach(o),co.forEach(o),Qt=f(t),S=n(t,"DIV",{class:!0});var pt=s(S);w(Ce.$$.fragment,pt),ha=f(pt),Me=n(pt,"P",{});var po=s(Me);fa=l(po,`The bare DPT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Se=n(po,"A",{href:!0,rel:!0});var zr=s(Se);ua=l(zr,"torch.nn.Module"),zr.forEach(o),ga=l(po,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),po.forEach(o),_a=f(pt),I=n(pt,"DIV",{class:!0});var ue=s(I);w(qe.$$.fragment,ue),va=f(ue),U=n(ue,"P",{});var mt=s(U);Ta=l(mt,"The "),at=n(mt,"A",{href:!0});var Ir=s(at);ba=l(Ir,"DPTModel"),Ir.forEach(o),wa=l(mt," forward method, overrides the "),xt=n(mt,"CODE",{});var Cr=s(xt);Pa=l(Cr,"__call__"),Cr.forEach(o),$a=l(mt," special method."),mt.forEach(o),ya=f(ue),w(ne.$$.fragment,ue),Da=f(ue),w(se.$$.fragment,ue),ue.forEach(o),pt.forEach(o),eo=f(t),H=n(t,"H2",{class:!0});var mo=s(H);ie=n(mo,"A",{id:!0,class:!0,href:!0});var Mr=s(ie);Et=n(Mr,"SPAN",{});var Sr=s(Et);w(Ae.$$.fragment,Sr),Sr.forEach(o),Mr.forEach(o),xa=f(mo),kt=n(mo,"SPAN",{});var qr=s(kt);Ea=l(qr,"DPTForDepthEstimation"),qr.forEach(o),mo.forEach(o),to=f(t),j=n(t,"DIV",{class:!0});var ge=s(j);w(Le.$$.fragment,ge),ka=f(ge),Ft=n(ge,"P",{});var Ar=s(Ft);Fa=l(Ar,"DPT Model with a depth estimation head on top (consisting of 3 convolutional layers) e.g. for KITTI, NYUv2."),Ar.forEach(o),ja=f(ge),Ne=n(ge,"P",{});var ho=s(Ne);za=l(ho,"This model is a PyTorch "),Ve=n(ho,"A",{href:!0,rel:!0});var Lr=s(Ve);Ia=l(Lr,"torch.nn.Module"),Lr.forEach(o),Ca=l(ho,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
