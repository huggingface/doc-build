import{S as Lm,i as Sm,s as Dm,e as n,k as l,w as k,t as a,M as Gm,c as r,d as t,m as c,a as s,x as y,h as d,b as h,F as e,g as f,y as T,q as w,o as $,B as x,v as Wm,L as nt}from"../../chunks/vendor-6b77c823.js";import{T as xo}from"../../chunks/Tip-39098574.js";import{D as P}from"../../chunks/Docstring-1088f2fb.js";import{C as Ve}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ce}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as ot}from"../../chunks/ExampleCodeBlock-5212b321.js";function Um(z){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Hm(z){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">6</span>, <span class="hljs-number">1280</span>]`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Vm(z){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Km(z){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
`),U=r(se,"CODE",{});var dt=s(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),se.forEach(t),V.forEach(t)},m(B,q){f(B,p,q),e(p,v),f(B,g,q),f(B,u,q),e(u,b),e(b,i),e(u,m),e(u,F),e(F,Me),f(B,pe,q),f(B,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(B,G,q),f(B,N,q),e(N,_e),f(B,R,q),f(B,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,re),e(re,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(B){B&&t(p),B&&t(g),B&&t(u),B&&t(pe),B&&t(E),B&&t(G),B&&t(N),B&&t(R),B&&t(M)}}}function Xm(z){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Ym(z){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, TFBlenderbotModel
...
first positional argument :`),be.forEach(t),R=c(B),M=r(B,"UL",{});var V=s(M);j=r(V,"LI",{});var K=s(j);Oe=d(K,"a single Tensor with "),J=r(K,"CODE",{});var st=s(J);Q=d(st,"input_ids"),st.forEach(t),Pe=d(K," only and nothing else: "),W=r(K,"CODE",{});var Je=s(W);Ne=d(Je,"model(input_ids)"),Je.forEach(t),K.forEach(t),Ae=c(V),A=r(V,"LI",{});var I=s(A);he=d(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=r(I,"CODE",{});var ve=s(re);$e=d(ve,"model([input_ids, attention_mask])"),ve.forEach(t),ue=d(I," or "),H=r(I,"CODE",{});var at=s(H);Ie=d(at,"model([input_ids, attention_mask, token_type_ids])"),at.forEach(t),I.forEach(t),xe=c(V),C=r(V,"LI",{});var se=s(C);Le=d(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(se,"CODE",{});var dt=s(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),se.forEach(t),V.forEach(t)},m(B,q){f(B,p,q),e(p,v),f(B,g,q),f(B,u,q),e(u,b),e(b,i),e(u,m),e(u,F),e(F,Me),f(B,pe,q),f(B,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(B,G,q),f(B,N,q),e(N,_e),f(B,R,q),f(B,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,re),e(re,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(B){B&&t(p),B&&t(g),B&&t(u),B&&t(pe),B&&t(E),B&&t(G),B&&t(N),B&&t(R),B&&t(M)}}}function ef(z){let p,v,g,u,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function of(z){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotModel
...
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function af(z){let p,v,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
Will be ignored`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/blenderbot/tokenization_blenderbot_fast.py#L61",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.0/en/model_doc/blenderbot#transformers.BlenderbotConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/blenderbot/modeling_blenderbot.py#L1275",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/blenderbot/modeling_blenderbot.py#L1442",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1134",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.0/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1254",returnDescription:`
<p>A <a
...
`}}),uo=new ot({props:{anchor:"transformers.FlaxBlenderbotForConditionalGeneration.decode.example",$$slots:{default:[df]},$$scope:{ctx:z}}}),{c(){p=n("meta"),v=l(),g=n("h1"),u=n("a"),b=n("span"),k(i.$$.fragment),m=l(),F=n("span"),Me=a("Blenderbot"),pe=l(),E=n("p"),fe=n("strong"),te=a("DISCLAIMER:"),Ce=a(" If you see something strange, file a "),oe=n("a"),ne=a("Github Issue"),je=a(" ."),we=l(),G=n("h2"),N=n("a"),_e=n("span"),k(R.$$.fragment),M=l(),j=n("span"),Oe=a("Overview"),J=l(),Q=n("p"),Pe=a("The Blender chatbot model was proposed in "),W=n("a"),Ne=a("Recipes for building an open-domain chatbot"),Ae=a(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),Rr=n("ul"),rr=n("li"),Wi=a("single sequence: "),Hr=n("code"),Ui=a("X </s>"),za=l(),mt=n("h2"),Nt=n("a"),Vr=n("span"),k(Go.$$.fragment),Ri=l(),Kr=n("span"),Hi=a("BlenderbotModel"),Fa=l(),We=n("p"),Vi=a("See "),Jr=n("code"),Ki=a("transformers.BartModel"),Ji=a(" for arguments to "),Qr=n("em"),Qi=a("forward"),Xi=a(" and "),Xr=n("em"),Yi=a("generate"),qa=l(),ye=n("div"),k(Wo.$$.fragment),Zi=l(),Uo=n("p"),el=a(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc=l(),k(Qt.$$.fragment),Tc=l(),X=n("div"),k(fn.$$.fragment),wc=l(),wt=n("p"),$c=a("The "),ur=n("a"),xc=a("TFBlenderbotForConditionalGeneration"),Bc=a(" forward method, overrides the "),ps=n("code"),zc=a("__call__"),Fc=a(" special method."),qc=l(),k(Xt.$$.fragment),Ec=l(),hs=n("p"),Mc=a("Conversation example::"),Cc=l(),us=n("blockquote"),ms=n("blockquote"),fs=n("blockquote"),_s=n("p"),jc=a(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Kc=l(),ws=n("p"),Jc=a("Finally, this model supports inherent JAX features such as:"),Qc=l(),Re=n("ul"),$s=n("li"),Tn=n("a"),Xc=a("Just-In-Time (JIT) compilation"),Yc=l(),xs=n("li"),wn=n("a"),Zc=a("Automatic Differentiation"),ep=l(),Bs=n("li"),$n=n("a"),tp=a("Vectorization"),op=l(),zs=n("li"),xn=n("a"),np=a("Parallelization"),rp=l(),qe=n("div"),k(Bn.$$.fragment),sp=l(),xt=n("p"),ap=a("The "),Fs=n("code"),dp=a("FlaxBlenderbotPreTrainedModel"),ip=a(" forward method, overrides the "),qs=n("code"),lp=a("__call__"),cp=a(" special method."),pp=l(),k(Zt.$$.fragment),hp=l(),k(eo.$$.fragment),up=l(),to=n("div"),k(zn.$$.fragment),mp=l(),k(oo.$$.fragment),fp=l(),no=n("div"),k(Fn.$$.fragment),_p=l(),k(ro.$$.fragment),Da=l(),Bt=n("h2"),so=n("a"),Es=n("span"),k(qn.$$.fragment),gp=l(),Ms=n("span"),bp=a("FlaxBlenderbotForConditionalGeneration"),Ga=l(),S=n("div"),k(En.$$.fragment),vp=l(),Mn=n("p"),kp=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zp=l(),Cs=n("p"),Fp=a("Finally, this model supports inherent JAX features such as:"),qp=l(),He=n("ul"),js=n("li"),On=n("a"),Ep=a("Just-In-Time (JIT) compilation"),Mp=l(),Os=n("li"),Pn=n("a"),Cp=a("Automatic Differentiation"),jp=l(),Ps=n("li"),Nn=n("a"),Op=a("Vectorization"),Pp=l(),Ns=n("li"),An=n("a"),Np=a("Parallelization"),Ap=l(),D=n("div"),k(In.$$.fragment),Ip=l(),zt=n("p"),Lp=a("The "),As=n("code"),Sp=a("FlaxBlenderbotPreTrainedModel"),Dp=a(" forward method, overrides the "),Is=n("code"),Gp=a("__call__"),Wp=a(" special method."),Up=l(),k(ao.$$.fragment),Rp=l(),Ls=n("p"),Hp=a("Conversation example::"),Vp=l(),Ss=n("blockquote"),Ds=n("blockquote"),Gs=n("blockquote"),Ws=n("p"),Kp=a("from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),Jp=l(),Us=n("blockquote"),Rs=n("blockquote"),Hs=n("blockquote"),Vs=n("p"),Qp=a(`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rd.forEach(t),Fl=c(vo),Xo=r(vo,"P",{});var sd=s(Xo);ql=d(sd,"This model is also a PyTorch "),Yo=r(sd,"A",{href:!0,rel:!0});var uu=s(Yo);El=d(uu,"torch.nn.Module"),uu.forEach(t),Ml=d(sd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
