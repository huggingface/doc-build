...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.2/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y1=r(qd);cb=i(Y1,"span start logits"),Y1.forEach(t),pb=i(yl," and "),Pd=n(yl,"CODE",{});var Z1=r(Pd);hb=i(Z1,"span end logits"),Z1.forEach(t),ub=i(yl,")."),yl.forEach(t),fb=h(Bt),ia=n(Bt,"P",{});var ou=r(ia);mb=i(ou,"This model inherits from "),nl=n(ou,"A",{href:!0});var e2=r(nl);gb=i(e2,"TFPreTrainedModel"),e2.forEach(t),_b=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),vb=h(Bt),la=n(Bt,"P",{});var su=r(la);bb=i(su,"This model is also a "),da=n(su,"A",{href:!0,rel:!0});var t2=r(da);kb=i(t2,"tf.keras.Model"),t2.forEach(t),Tb=i(su,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),su.forEach(t),$b=h(Bt),$(Us.$$.fragment,Bt),wb=h(Bt),et=n(Bt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yb=h(Zt),Eo=n(Zt,"P",{});var Dl=r(Eo);Db=i(Dl,"The "),rl=n(Dl,"A",{href:!0});var o2=r(rl);Fb=i(o2,"TFDistilBertForQuestionAnswering"),o2.forEach(t),Bb=i(Dl," forward method, overrides the "),Ad=n(Dl,"CODE",{});var s2=r(Ad);xb=i(s2,"__call__"),s2.forEach(t),Mb=i(Dl," special method."),Dl.forEach(t),Eb=h(Zt),$(Hs.$$.fragment,Zt),zb=h(Zt),$(Vs.$$.fragment,Zt),jb=h(Zt),$(Ks.$$.fragment,Zt),Zt.forEach(t),Bt.forEach(t),rh=h(o),zo=n(o,"H2",{class:!0});var nu=r(zo);Js=n(nu,"A",{id:!0,class:!0,href:!0});var n2=r(Js);Od=n(n2,"SPAN",{});var r2=r(Od);$(pa.$$.fragment,r2),r2.forEach(t),n2.forEach(t),Cb=h(nu),Nd=n(nu,"SPAN",{});var a2=r(Nd);qb=i(a2,"FlaxDistilBertModel"),a2.forEach(t),nu.forEach(t),ah=h(o),Me=n(o,"DIV",{class:!0});var ot=r(Me);$(ha.$$.fragment,ot),Pb=h(ot),Ld=n(ot,"P",{});var i2=r(Ld);Ab=i(i2,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i2.forEach(t),Ob=h(ot),ua=n(ot,"P",{});var ru=r(ua);Nb=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l2=r(al);Lb=i(l2,"FlaxPreTrainedModel"),l2.forEach(t),Sb=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Ib=h(ot),fa=n(ot,"P",{});var au=r(fa);Wb=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d2=r(ma);Qb=i(d2,"flax.linen.Module"),d2.forEach(t),Rb=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Ub=h(ot),Sd=n(ot,"P",{});var c2=r(Sd);Hb=i(c2,"Finally, this model supports inherent JAX features such as:"),c2.forEach(t),Vb=h(ot),Mt=n(ot,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p2=r(Id);ga=n(p2,"A",{href:!0,rel:!0});var h2=r(ga);Kb=i(h2,"Just-In-Time (JIT) compilation"),h2.forEach(t),p2.forEach(t),Jb=h(kn),Wd=n(kn,"LI",{});var u2=r(Wd);_a=n(u2,"A",{href:!0,rel:!0});var f2=r(_a);Gb=i(f2,"Automatic Differentiation"),f2.forEach(t),u2.forEach(t),Xb=h(kn),Qd=n(kn,"LI",{});var m2=r(Qd);va=n(m2,"A",{href:!0,rel:!0});var g2=r(va);Yb=i(g2,"Vectorization"),g2.forEach(t),m2.forEach(t),Zb=h(kn),Rd=n(kn,"LI",{});var _2=r(Rd);ba=n(_2,"A",{href:!0,rel:!0});var v2=r(ba);ek=i(v2,"Parallelization"),v2.forEach(t),_2.forEach(t),kn.forEach(t),tk=h(ot),gt=n(ot,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),ok=h(Tn),jo=n(Tn,"P",{});var Fl=r(jo);sk=i(Fl,"The "),Ud=n(Fl,"CODE",{});var b2=r(Ud);nk=i(b2,"FlaxDistilBertPreTrainedModel"),b2.forEach(t),rk=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var k2=r(Hd);ak=i(k2,"__call__"),k2.forEach(t),ik=i(Fl," special method."),Fl.forEach(t),lk=h(Tn),$(Gs.$$.fragment,Tn),dk=h(Tn),$(Xs.$$.fragment,Tn),Tn.forEach(t),ot.forEach(t),ih=h(o),Co=n(o,"H2",{class:!0});var iu=r(Co);Ys=n(iu,"A",{id:!0,class:!0,href:!0});var T2=r(Ys);Vd=n(T2,"SPAN",{});var $2=r(Vd);$(Ta.$$.fragment,$2),$2.forEach(t),T2.forEach(t),ck=h(iu),Kd=n(iu,"SPAN",{});var w2=r(Kd);pk=i(w2,"FlaxDistilBertForMaskedLM"),w2.forEach(t),iu.forEach(t),lh=h(o),Ee=n(o,"DIV",{class:!0});var st=r(Ee);$($a.$$.fragment,st),hk=h(st),wa=n(st,"P",{});var lu=r(wa);uk=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y2=r(Jd);fk=i(y2,"language modeling"),y2.forEach(t),mk=i(lu," head on top."),lu.forEach(t),gk=h(st),ya=n(st,"P",{});var du=r(ya);_k=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var D2=r(il);vk=i(D2,"FlaxPreTrainedModel"),D2.forEach(t),bk=i(du,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jT=h(rt),gc=n(rt,"P",{});var iy=r(gc);CT=i(iy,"Finally, this model supports inherent JAX features such as:"),iy.forEach(t),qT=h(rt),jt=n(rt,"UL",{});var Fn=r(jt);_c=n(Fn,"LI",{});var ly=r(_c);Va=n(ly,"A",{href:!0,rel:!0});var dy=r(Va);PT=i(dy,"Just-In-Time (JIT) compilation"),dy.forEach(t),ly.forEach(t),AT=h(Fn),vc=n(Fn,"LI",{});var cy=r(vc);Ka=n(cy,"A",{href:!0,rel:!0});var py=r(Ka);OT=i(py,"Automatic Differentiation"),py.forEach(t),cy.forEach(t),NT=h(Fn),bc=n(Fn,"LI",{});var hy=r(bc);Ja=n(hy,"A",{href:!0,rel:!0});var uy=r(Ja);LT=i(uy,"Vectorization"),uy.forEach(t),hy.forEach(t),ST=h(Fn),kc=n(Fn,"LI",{});var fy=r(kc);Ga=n(fy,"A",{href:!0,rel:!0});var my=r(Ga);IT=i(my,"Parallelization"),my.forEach(t),fy.forEach(t),Fn.forEach(t),WT=h(rt),bt=n(rt,"DIV",{class:!0});var Bn=r(bt);$(Xa.$$.fragment,Bn),QT=h(Bn),No=n(Bn,"P",{});var Ml=r(No);RT=i(Ml,"The "),Tc=n(Ml,"CODE",{});var gy=r(Tc);UT=i(gy,"FlaxDistilBertPreTrainedModel"),gy.forEach(t),HT=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _y=r($c);VT=i(_y,"__call__"),_y.forEach(t),KT=i(Ml," special method."),Ml.forEach(t),JT=h(Bn),$(rn.$$.fragment,Bn),GT=h(Bn),$(an.$$.fragment,Bn),Bn.forEach(t),rt.forEach(t),uh=h(o),Lo=n(o,"H2",{class:!0});var _u=r(Lo);ln=n(_u,"A",{id:!0,class:!0,href:!0});var vy=r(ln);wc=n(vy,"SPAN",{});var by=r(wc);$(Ya.$$.fragment,by),by.forEach(t),vy.forEach(t),XT=h(_u),yc=n(_u,"SPAN",{});var ky=r(yc);YT=i(ky,"FlaxDistilBertForTokenClassification"),ky.forEach(t),_u.forEach(t),fh=h(o),Ce=n(o,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),ZT=h(at),Dc=n(at,"P",{});var Ty=r(Dc);e$=i(Ty,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ty.forEach(t),t$=h(at),ei=n(at,"P",{});var vu=r(ei);o$=i(vu,"This model inherits from "),cl=n(vu,"A",{href:!0});var $y=r(cl);s$=i($y,"FlaxPreTrainedModel"),$y.forEach(t),n$=i(vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),vu.forEach(t),r$=h(at),ti=n(at,"P",{});var bu=r(ti);a$=i(bu,"This model is also a Flax Linen "),oi=n(bu,"A",{href:!0,rel:!0});var wy=r(oi);i$=i(wy,"flax.linen.Module"),wy.forEach(t),l$=i(bu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
