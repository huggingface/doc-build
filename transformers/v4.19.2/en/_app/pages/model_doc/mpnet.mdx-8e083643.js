import{S as Gg,i as Yg,s as Zg,e as n,k as m,w as T,t as r,M as e_,c as s,d as t,m as h,a,x as M,h as i,b,F as e,g as _,y as $,q as w,o as P,B as N,v as t_,L as be}from"../../chunks/vendor-6b77c823.js";import{T as Fe}from"../../chunks/Tip-39098574.js";import{D as J}from"../../chunks/Docstring-1088f2fb.js";import{C as Te}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ae}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as ve}from"../../chunks/ExampleCodeBlock-5212b321.js";function o_(y){let l,g,c,p,v;return p=new Te({props:{code:`from transformers import MPNetModel, MPNetConfig
...
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function M_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),g=r("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),v=!0},p:be,i(d){v||(w(p.$$.fragment,d),v=!0)},o(d){P(p.$$.fragment,d),v=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function w_(y){let l,g,c,p,v,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function P_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:be,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function F_(y){let l,g,c,p,v,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function E_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:be,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function x_(y){let l,g,c,p,v,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function C_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),g=r("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),v=!0},p:be,i(d){v||(w(p.$$.fragment,d),v=!0)},o(d){P(p.$$.fragment,d),v=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function L_(y){let l,g,c,p,v,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function A_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:be,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function S_(y){let l,g,c,p,v,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function D_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:be,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function H_(y){let l,g,c,p,v,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he,u,F,K,_e,Me,I,ke,$e,we,A,S,Pe,ge,fe,Ne,ie,ue,no,Ka,un,Gl,Xa,Yl,qi,Ge,gn,Zl,dt,ed,ta,td,od,oa,nd,sd,_n,ad,rd,id,Nt,ld,na,dd,cd,sa,pd,md,hd,so,xi,yt,ao,Ja,kn,fd,Ga,ud,Ci,Ee,vn,gd,bn,_d,aa,kd,vd,bd,ht,Tn,Td,Ya,Md,$d,Mn,ra,wd,Za,Pd,Nd,ia,yd,er,Fd,Ed,ro,$n,zd,wn,qd,tr,xd,Cd,jd,io,Pn,Ld,or,Ad,Od,la,Nn,ji,Ft,lo,nr,yn,Id,sr,Sd,Li,Ye,Fn,Dd,En,Wd,ar,Qd,Hd,Rd,zn,Ud,da,Bd,Vd,Kd,co,qn,Xd,rr,Jd,Ai,Et,po,ir,xn,Gd,lr,Yd,Oi,Oe,Cn,Zd,dr,ec,tc,jn,oc,ca,nc,sc,ac,Ln,rc,An,ic,lc,dc,Ze,On,cc,zt,pc,pa,mc,hc,cr,fc,uc,gc,mo,_c,ho,Ii,qt,fo,pr,In,kc,mr,vc,Si,xt,Sn,bc,He,Dn,Tc,Ct,Mc,ma,$c,wc,hr,Pc,Nc,yc,uo,Fc,go,Ec,_o,Di,jt,ko,fr,Wn,zc,ur,qc,Wi,Ie,Qn,xc,gr,Cc,jc,Hn,Lc,ha,Ac,Oc,Ic,Rn,Sc,Un,Dc,Wc,Qc,ye,Bn,Hc,Lt,Rc,fa,Uc,Bc,_r,Vc,Kc,Xc,vo,Jc,bo,Gc,To,Yc,Mo,Zc,$o,Qi,At,wo,kr,Vn,ep,vr,tp,Hi,Se,Kn,op,br,np,sp,Xn,ap,ua,rp,ip,lp,Jn,dp,Gn,cp,pp,mp,et,Yn,hp,Ot,fp,ga,up,gp,Tr,_p,kp,vp,Po,bp,No,Ri,It,yo,Mr,Zn,Tp,$r,Mp,Ui,De,es,$p,wr,wp,Pp,ts,Np,_a,yp,Fp,Ep,os,zp,ns,qp,xp,Cp,Re,ss,jp,St,Lp,ka,Ap,Op,Pr,Ip,Sp,Dp,Fo,Wp,Eo,Qp,zo,Bi,Dt,qo,Nr,as,Hp,yr,Rp,Vi,We,rs,Up,Wt,Bp,Fr,Vp,Kp,Er,Xp,Jp,Gp,is,Yp,va,Zp,em,tm,ls,om,ds,nm,sm,am,Ue,cs,rm,Qt,im,ba,lm,dm,zr,cm,pm,mm,xo,hm,Co,fm,jo,Ki,Ht,Lo,qr,ps,um,xr,gm,Xi,ze,ms,_m,Cr,km,vm,hs,bm,Ta,Tm,Mm,$m,fs,wm,us,Pm,Nm,ym,Ao,Fm,tt,gs,Em,Rt,zm,Ma,qm,xm,jr,Cm,jm,Lm,Oo,Am,Io,Ji,Ut,So,Lr,_s,Om,Ar,Im,Gi,qe,ks,Sm,vs,Dm,Or,Wm,Qm,Hm,bs,Rm,$a,Um,Bm,Vm,Ts,Km,Ms,Xm,Jm,Gm,Do,Ym,Be,$s,Zm,Bt,eh,wa,th,oh,Ir,nh,sh,ah,Wo,rh,Qo,ih,Ho,Yi,Vt,Ro,Sr,ws,lh,Dr,dh,Zi,xe,Ps,ch,Wr,ph,mh,Ns,hh,Pa,fh,uh,gh,ys,_h,Fs,kh,vh,bh,Uo,Th,Ve,Es,Mh,Kt,$h,Na,wh,Ph,Qr,Nh,yh,Fh,Bo,Eh,Vo,zh,Ko,el,Xt,Xo,Hr,zs,qh,Rr,xh,tl,Ce,qs,Ch,Ur,jh,Lh,xs,Ah,ya,Oh,Ih,Sh,Cs,Dh,js,Wh,Qh,Hh,Jo,Rh,ot,Ls,Uh,Jt,Bh,Fa,Vh,Kh,Br,Xh,Jh,Gh,Go,Yh,Yo,ol,Gt,Zo,Vr,As,Zh,Kr,ef,nl,je,Os,tf,Xr,of,nf,Is,sf,Ea,af,rf,lf,Ss,df,Ds,cf,pf,mf,en,hf,Ke,Ws,ff,Yt,uf,za,gf,_f,Jr,kf,vf,bf,tn,Tf,on,Mf,nn,sl,Zt,sn,Gr,Qs,$f,Yr,wf,al,Le,Hs,Pf,eo,Nf,Zr,yf,Ff,ei,Ef,zf,qf,Rs,xf,qa,Cf,jf,Lf,Us,Af,Bs,Of,If,Sf,an,Df,Xe,Vs,Wf,to,Qf,xa,Hf,Rf,ti,Uf,Bf,Vf,rn,Kf,ln,Xf,dn,rl;return d=new Ae({}),G=new Ae({}),un=new Ae({}),gn=new J({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/tokenization_mpnet.py#L231",returnDescription:`
...
Set to True if the token list is already formatted with special tokens for the model`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/tokenization_mpnet.py#L256",returnDescription:`
...
Optional second list of IDs for sequence pairs`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/tokenization_mpnet_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
configuration. Check out the <a href="/docs/transformers/v4.19.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L483"}}),On=new J({props:{name:"forward",anchor:"transformers.MPNetModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.19.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetConfig"
...
`}}),mo=new Fe({props:{$$slots:{default:[n_]},$$scope:{ctx:y}}}),ho=new ve({props:{anchor:"transformers.MPNetModel.forward.example",$$slots:{default:[s_]},$$scope:{ctx:y}}}),In=new Ae({}),Sn=new J({props:{name:"class transformers.MPNetForMaskedLM",anchor:"transformers.MPNetForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L576"}}),Dn=new J({props:{name:"forward",anchor:"transformers.MPNetForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.19.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.2/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L595",returnDescription:`
<p>A <a
...
`}}),uo=new Fe({props:{$$slots:{default:[a_]},$$scope:{ctx:y}}}),go=new ve({props:{anchor:"transformers.MPNetForMaskedLM.forward.example",$$slots:{default:[r_]},$$scope:{ctx:y}}}),_o=new ve({props:{anchor:"transformers.MPNetForMaskedLM.forward.example-2",$$slots:{default:[i_]},$$scope:{ctx:y}}}),Wn=new Ae({}),Qn=new J({props:{name:"class transformers.MPNetForSequenceClassification",anchor:"transformers.MPNetForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L685"}}),Bn=new J({props:{name:"forward",anchor:"transformers.MPNetForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.19.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.2/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L698",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L780"}}),Yn=new J({props:{name:"forward",anchor:"transformers.MPNetForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.19.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.2/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L793",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L886",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L971"}}),cs=new J({props:{name:"forward",anchor:"transformers.MPNetForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.19.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.2/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_mpnet.py#L985",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_tf_mpnet.py#L669",returnDescription:`
<p>A <a
...
`}}),Oo=new Fe({props:{$$slots:{default:[M_]},$$scope:{ctx:y}}}),Io=new ve({props:{anchor:"transformers.TFMPNetModel.call.example",$$slots:{default:[$_]},$$scope:{ctx:y}}}),_s=new Ae({}),ks=new J({props:{name:"class transformers.TFMPNetForMaskedLM",anchor:"transformers.TFMPNetForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMPNetForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_tf_mpnet.py#L784",returnDescription:`
<p>A <a
...
`}}),Wo=new Fe({props:{$$slots:{default:[P_]},$$scope:{ctx:y}}}),Qo=new ve({props:{anchor:"transformers.TFMPNetForMaskedLM.call.example",$$slots:{default:[N_]},$$scope:{ctx:y}}}),Ho=new ve({props:{anchor:"transformers.TFMPNetForMaskedLM.call.example-2",$$slots:{default:[y_]},$$scope:{ctx:y}}}),ws=new Ae({}),Ps=new J({props:{name:"class transformers.TFMPNetForSequenceClassification",anchor:"transformers.TFMPNetForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMPNetForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_tf_mpnet.py#L889",returnDescription:`
<p>A <a
...
`}}),Bo=new Fe({props:{$$slots:{default:[E_]},$$scope:{ctx:y}}}),Vo=new ve({props:{anchor:"transformers.TFMPNetForSequenceClassification.call.example",$$slots:{default:[z_]},$$scope:{ctx:y}}}),Ko=new ve({props:{anchor:"transformers.TFMPNetForSequenceClassification.call.example-2",$$slots:{default:[q_]},$$scope:{ctx:y}}}),zs=new Ae({}),qs=new J({props:{name:"class transformers.TFMPNetForMultipleChoice",anchor:"transformers.TFMPNetForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMPNetForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.2/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_tf_mpnet.py#L979",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1090",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1172",returnDescription:`
<p>A <a
...
documentation from `),sa=n("a"),pd=r("PretrainedConfig"),md=r(" for more information."),hd=m(),T(so.$$.fragment),xi=m(),yt=n("h2"),ao=n("a"),Ja=n("span"),T(kn.$$.fragment),fd=m(),Ga=n("span"),ud=r("MPNetTokenizer"),Ci=m(),Ee=n("div"),T(vn.$$.fragment),gd=m(),bn=n("p"),_d=r("This tokenizer inherits from "),aa=n("a"),kd=r("BertTokenizer"),vd=r(` which contains most of the methods. Users should refer to the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc=m(),ye=n("div"),T(Bn.$$.fragment),Hc=m(),Lt=n("p"),Rc=r("The "),fa=n("a"),Uc=r("MPNetForSequenceClassification"),Bc=r(" forward method, overrides the "),_r=n("code"),Vc=r("__call__"),Kc=r(" special method."),Xc=m(),T(vo.$$.fragment),Jc=m(),T(bo.$$.fragment),Gc=m(),T(To.$$.fragment),Yc=m(),T(Mo.$$.fragment),Zc=m(),T($o.$$.fragment),Qi=m(),At=n("h2"),wo=n("a"),kr=n("span"),T(Vn.$$.fragment),ep=m(),vr=n("span"),tp=r("MPNetForMultipleChoice"),Hi=m(),Se=n("div"),T(Kn.$$.fragment),op=m(),br=n("p"),np=r(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
layers on top of the hidden-states output to compute `),Fr=n("code"),Vp=r("span start logits"),Kp=r(" and "),Er=n("code"),Xp=r("span end logits"),Jp=r(")."),Gp=m(),is=n("p"),Yp=r("This model inherits from "),va=n("a"),Zp=r("PreTrainedModel"),em=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
behavior.`),ym=m(),T(Ao.$$.fragment),Fm=m(),tt=n("div"),T(gs.$$.fragment),Em=m(),Rt=n("p"),zm=r("The "),Ma=n("a"),qm=r("TFMPNetModel"),xm=r(" forward method, overrides the "),jr=n("code"),Cm=r("__call__"),jm=r(" special method."),Lm=m(),T(Oo.$$.fragment),Am=m(),T(Io.$$.fragment),Ji=m(),Ut=n("h2"),So=n("a"),Lr=n("span"),T(_s.$$.fragment),Om=m(),Ar=n("span"),Im=r("TFMPNetForMaskedLM"),Gi=m(),qe=n("div"),T(ks.$$.fragment),Sm=m(),vs=n("p"),Dm=r("MPNet Model with a "),Or=n("code"),Wm=r("language modeling"),Qm=r(" head on top."),Hm=m(),bs=n("p"),Rm=r("This model inherits from "),$a=n("a"),Um=r("TFPreTrainedModel"),Bm=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bh=m(),T(Uo.$$.fragment),Th=m(),Ve=n("div"),T(Es.$$.fragment),Mh=m(),Kt=n("p"),$h=r("The "),Na=n("a"),wh=r("TFMPNetForSequenceClassification"),Ph=r(" forward method, overrides the "),Qr=n("code"),Nh=r("__call__"),yh=r(" special method."),Fh=m(),T(Bo.$$.fragment),Eh=m(),T(Vo.$$.fragment),zh=m(),T(Ko.$$.fragment),el=m(),Xt=n("h2"),Xo=n("a"),Hr=n("span"),T(zs.$$.fragment),qh=m(),Rr=n("span"),xh=r("TFMPNetForMultipleChoice"),tl=m(),Ce=n("div"),T(qs.$$.fragment),Ch=m(),Ur=n("p"),jh=r(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mf=m(),T(en.$$.fragment),hf=m(),Ke=n("div"),T(Ws.$$.fragment),ff=m(),Yt=n("p"),uf=r("The "),za=n("a"),gf=r("TFMPNetForTokenClassification"),_f=r(" forward method, overrides the "),Jr=n("code"),kf=r("__call__"),vf=r(" special method."),bf=m(),T(tn.$$.fragment),Tf=m(),T(on.$$.fragment),Mf=m(),T(nn.$$.fragment),sl=m(),Zt=n("h2"),sn=n("a"),Gr=n("span"),T(Qs.$$.fragment),$f=m(),Yr=n("span"),wf=r("TFMPNetForQuestionAnswering"),al=m(),Le=n("div"),T(Hs.$$.fragment),Pf=m(),eo=n("p"),Nf=r(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ml.forEach(t),Qc=h(gt),ye=s(gt,"DIV",{class:!0});var Je=a(ye);M(Bn.$$.fragment,Je),Hc=h(Je),Lt=s(Je,"P",{});var Aa=a(Lt);Rc=i(Aa,"The "),fa=s(Aa,"A",{href:!0});var Eu=a(fa);Uc=i(Eu,"MPNetForSequenceClassification"),Eu.forEach(t),Bc=i(Aa," forward method, overrides the "),_r=s(Aa,"CODE",{});var zu=a(_r);Vc=i(zu,"__call__"),zu.forEach(t),Kc=i(Aa," special method."),Aa.forEach(t),Xc=h(Je),M(vo.$$.fragment,Je),Jc=h(Je),M(bo.$$.fragment,Je),Gc=h(Je),M(To.$$.fragment,Je),Yc=h(Je),M(Mo.$$.fragment,Je),Zc=h(Je),M($o.$$.fragment,Je),Je.forEach(t),gt.forEach(t),Qi=h(o),At=s(o,"H2",{class:!0});var $l=a(At);wo=s($l,"A",{id:!0,class:!0,href:!0});var qu=a(wo);kr=s(qu,"SPAN",{});var xu=a(kr);M(Vn.$$.fragment,xu),xu.forEach(t),qu.forEach(t),ep=h($l),vr=s($l,"SPAN",{});var Cu=a(vr);tp=i(Cu,"MPNetForMultipleChoice"),Cu.forEach(t),$l.forEach(t),Hi=h(o),Se=s(o,"DIV",{class:!0});var _t=a(Se);M(Kn.$$.fragment,_t),op=h(_t),br=s(_t,"P",{});var ju=a(br);np=i(ju,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fl.forEach(t),Cp=h(kt),Re=s(kt,"DIV",{class:!0});var vt=a(Re);M(ss.$$.fragment,vt),jp=h(vt),St=s(vt,"P",{});var Ia=a(St);Lp=i(Ia,"The "),ka=s(Ia,"A",{href:!0});var Uu=a(ka);Ap=i(Uu,"MPNetForTokenClassification"),Uu.forEach(t),Op=i(Ia," forward method, overrides the "),Pr=s(Ia,"CODE",{});var Bu=a(Pr);Ip=i(Bu,"__call__"),Bu.forEach(t),Sp=i(Ia," special method."),Ia.forEach(t),Dp=h(vt),M(Fo.$$.fragment,vt),Wp=h(vt),M(Eo.$$.fragment,vt),Qp=h(vt),M(zo.$$.fragment,vt),vt.forEach(t),kt.forEach(t),Bi=h(o),Dt=s(o,"H2",{class:!0});var El=a(Dt);qo=s(El,"A",{id:!0,class:!0,href:!0});var Vu=a(qo);Nr=s(Vu,"SPAN",{});var Ku=a(Nr);M(as.$$.fragment,Ku),Ku.forEach(t),Vu.forEach(t),Hp=h(El),yr=s(El,"SPAN",{});var Xu=a(yr);Rp=i(Xu,"MPNetForQuestionAnswering"),Xu.forEach(t),El.forEach(t),Vi=h(o),We=s(o,"DIV",{class:!0});var bt=a(We);M(rs.$$.fragment,bt),Up=h(bt),Wt=s(bt,"P",{});var Sa=a(Wt);Bp=i(Sa,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Fr=s(Sa,"CODE",{});var Ju=a(Fr);Vp=i(Ju,"span start logits"),Ju.forEach(t),Kp=i(Sa," and "),Er=s(Sa,"CODE",{});var Gu=a(Er);Xp=i(Gu,"span end logits"),Gu.forEach(t),Jp=i(Sa,")."),Sa.forEach(t),Gp=h(bt),is=s(bt,"P",{});var zl=a(is);Yp=i(zl,"This model inherits from "),va=s(zl,"A",{href:!0});var Yu=a(va);Zp=i(Yu,"PreTrainedModel"),Yu.forEach(t),em=i(zl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jl.forEach(t),ym=h(nt),M(Ao.$$.fragment,nt),Fm=h(nt),tt=s(nt,"DIV",{class:!0});var hn=a(tt);M(gs.$$.fragment,hn),Em=h(hn),Rt=s(hn,"P",{});var Wa=a(Rt);zm=i(Wa,"The "),Ma=s(Wa,"A",{href:!0});var lg=a(Ma);qm=i(lg,"TFMPNetModel"),lg.forEach(t),xm=i(Wa," forward method, overrides the "),jr=s(Wa,"CODE",{});var dg=a(jr);Cm=i(dg,"__call__"),dg.forEach(t),jm=i(Wa," special method."),Wa.forEach(t),Lm=h(hn),M(Oo.$$.fragment,hn),Am=h(hn),M(Io.$$.fragment,hn),hn.forEach(t),nt.forEach(t),Ji=h(o),Ut=s(o,"H2",{class:!0});var Ll=a(Ut);So=s(Ll,"A",{id:!0,class:!0,href:!0});var cg=a(So);Lr=s(cg,"SPAN",{});var pg=a(Lr);M(_s.$$.fragment,pg),pg.forEach(t),cg.forEach(t),Om=h(Ll),Ar=s(Ll,"SPAN",{});var mg=a(Ar);Im=i(mg,"TFMPNetForMaskedLM"),mg.forEach(t),Ll.forEach(t),Gi=h(o),qe=s(o,"DIV",{class:!0});var st=a(qe);M(ks.$$.fragment,st),Sm=h(st),vs=s(st,"P",{});var Al=a(vs);Dm=i(Al,"MPNet Model with a "),Or=s(Al,"CODE",{});var hg=a(Or);Wm=i(hg,"language modeling"),hg.forEach(t),Qm=i(Al," head on top."),Al.forEach(t),Hm=h(st),bs=s(st,"P",{});var Ol=a(bs);Rm=i(Ol,"This model inherits from "),$a=s(Ol,"A",{href:!0});var fg=a($a);Um=i(fg,"TFPreTrainedModel"),fg.forEach(t),Bm=i(Ol,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Il.forEach(t),Gm=h(st),M(Do.$$.fragment,st),Ym=h(st),Be=s(st,"DIV",{class:!0});var Mt=a(Be);M($s.$$.fragment,Mt),Zm=h(Mt),Bt=s(Mt,"P",{});var Qa=a(Bt);eh=i(Qa,"The "),wa=s(Qa,"A",{href:!0});var gg=a(wa);th=i(gg,"TFMPNetForMaskedLM"),gg.forEach(t),oh=i(Qa," forward method, overrides the "),Ir=s(Qa,"CODE",{});var _g=a(Ir);nh=i(_g,"__call__"),_g.forEach(t),sh=i(Qa," special method."),Qa.forEach(t),ah=h(Mt),M(Wo.$$.fragment,Mt),rh=h(Mt),M(Qo.$$.fragment,Mt),ih=h(Mt),M(Ho.$$.fragment,Mt),Mt.forEach(t),st.forEach(t),Yi=h(o),Vt=s(o,"H2",{class:!0});var Sl=a(Vt);Ro=s(Sl,"A",{id:!0,class:!0,href:!0});var kg=a(Ro);Sr=s(kg,"SPAN",{});var vg=a(Sr);M(ws.$$.fragment,vg),vg.forEach(t),kg.forEach(t),lh=h(Sl),Dr=s(Sl,"SPAN",{});var bg=a(Dr);dh=i(bg,"TFMPNetForSequenceClassification"),bg.forEach(t),Sl.forEach(t),Zi=h(o),xe=s(o,"DIV",{class:!0});var at=a(xe);M(Ps.$$.fragment,at),ch=h(at),Wr=s(at,"P",{});var Tg=a(Wr);ph=i(Tg,`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
