...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/imagegpt/feature_extraction_imagegpt.py#L96",returnDescription:`
<p>A <a
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/imagegpt/modeling_imagegpt.py#L655",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.2/en/model_doc/imagegpt#transformers.ImageGPTConfig"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/imagegpt/modeling_imagegpt.py#L948",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/imagegpt/modeling_imagegpt.py#L1100",returnDescription:`
...
train an XL variant, which they didn\u2019t release. The differences in size are summarized in the following table:`),Fa=l(),be=a("table"),to=a("thead"),G=a("tr"),oo=a("th"),ao=a("strong"),Kn=r("Model variant"),Yn=l(),no=a("th"),so=a("strong"),Zn=r("Depths"),es=l(),ro=a("th"),io=a("strong"),ts=r("Hidden sizes"),os=l(),lo=a("th"),co=a("strong"),as=r("Decoder hidden size"),ns=l(),mo=a("th"),po=a("strong"),ss=r("Params (M)"),rs=l(),ho=a("th"),go=a("strong"),is=r("ImageNet-1k Top 1"),ls=l(),E=a("tbody"),F=a("tr"),uo=a("td"),ds=r("MiT-b0"),cs=l(),fo=a("td"),ms=r("[2, 2, 2, 2]"),ps=l(),_o=a("td"),hs=r("[32, 64, 160, 256]"),gs=l(),vo=a("td"),us=r("256"),fs=l(),To=a("td"),_s=r("3.7"),vs=l(),bo=a("td"),Ts=r("70.5"),bs=l(),C=a("tr"),yo=a("td"),ys=r("MiT-b1"),Is=l(),Io=a("td"),ws=r("[2, 2, 2, 2]"),Ps=l(),wo=a("td"),ks=r("[64, 128, 320, 512]"),$s=l(),Po=a("td"),xs=r("256"),Gs=l(),ko=a("td"),Es=r("14.0"),Fs=l(),$o=a("td"),Cs=r("78.7"),Ms=l(),M=a("tr"),xo=a("td"),zs=r("MiT-b2"),js=l(),Go=a("td"),qs=r("[3, 4, 6, 3]"),As=l(),Eo=a("td"),Ds=r("[64, 128, 320, 512]"),Ns=l(),Fo=a("td"),Os=r("768"),Ls=l(),Co=a("td"),Ss=r("25.4"),Ws=l(),Mo=a("td"),Rs=r("81.6"),Bs=l(),z=a("tr"),zo=a("td"),Hs=r("MiT-b3"),Vs=l(),jo=a("td"),Us=r("[3, 4, 18, 3]"),Js=l(),qo=a("td"),Xs=r("[64, 128, 320, 512]"),Qs=l(),Ao=a("td"),Ks=r("768"),Ys=l(),Do=a("td"),Zs=r("45.2"),er=l(),No=a("td"),tr=r("83.1"),or=l(),j=a("tr"),Oo=a("td"),ar=r("MiT-b4"),nr=l(),Lo=a("td"),sr=r("[3, 8, 27, 3]"),rr=l(),So=a("td"),ir=r("[64, 128, 320, 512]"),lr=l(),Wo=a("td"),dr=r("768"),cr=l(),Ro=a("td"),mr=r("62.6"),pr=l(),Bo=a("td"),hr=r("83.6"),gr=l(),q=a("tr"),Ho=a("td"),ur=r("MiT-b5"),fr=l(),Vo=a("td"),_r=r("[3, 6, 40, 3]"),vr=l(),Uo=a("td"),Tr=r("[64, 128, 320, 512]"),br=l(),Jo=a("td"),yr=r("768"),Ir=l(),Xo=a("td"),wr=r("82.0"),Pr=l(),Qo=a("td"),kr=r("83.8"),Ca=l(),ie=a("h2"),ye=a("a"),Ko=a("span"),b(Ye.$$.fragment),$r=l(),Yo=a("span"),xr=r("ImageGPTConfig"),Ma=l(),L=a("div"),b(Ze.$$.fragment),Gr=l(),te=a("p"),Er=r("This is the configuration class to store the configuration of a "),jt=a("a"),Fr=r("ImageGPTModel"),Cr=r(" or a "),Zo=a("code"),Mr=r("TFImageGPTModel"),zr=r(`. It is
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ji=l(),B=a("div"),b(ft.$$.fragment),qi=l(),he=a("p"),Ai=r("The "),St=a("a"),Di=r("ImageGPTForCausalImageModeling"),Ni=r(" forward method, overrides the "),ma=a("code"),Oi=r("__call__"),Li=r(" special method."),Si=l(),b(Ee.$$.fragment),Wi=l(),b(Fe.$$.fragment),Oa=l(),ge=a("h2"),Ce=a("a"),pa=a("span"),b(_t.$$.fragment),Ri=l(),ha=a("span"),Bi=r("ImageGPTForImageClassification"),La=l(),N=a("div"),b(vt.$$.fragment),Hi=l(),Tt=a("p"),Vi=r(`The ImageGPT Model transformer with an image classification head on top (linear layer).
