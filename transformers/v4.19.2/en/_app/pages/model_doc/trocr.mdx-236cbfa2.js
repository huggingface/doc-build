import{S as hi,i as mi,s as fi,e as s,k as c,w as C,t as o,M as pi,c as n,d as r,m as h,a as i,x as w,h as a,b as l,N as ui,F as e,g as f,y as k,q as $,o as y,B as O,v as gi,L as ci}from"../../chunks/vendor-6b77c823.js";import{T as li}from"../../chunks/Tip-39098574.js";import{D as Z}from"../../chunks/Docstring-1088f2fb.js";import{C as Hs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as jt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as di}from"../../chunks/ExampleCodeBlock-5212b321.js";function _i(S){let p,x,u,g,T;return g=new Hs({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=s("p"),x=o("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);x=a(_,"Example:"),_.forEach(r),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,x),f(m,u,_),k(g,m,_),T=!0},p:ci,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){y(g.$$.fragment,m),T=!1},d(m){m&&r(p),m&&r(u),O(g,m)}}}function vi(S){let p,x,u,g,T,m,_,D;return{c(){p=s("p"),x=o(`This class method is simply calling the feature extractor
...
methods above for more information.`),this.h()},l(j){p=n(j,"P",{});var R=i(p);x=a(R,`This class method is simply calling the feature extractor
...
methods above for more information.`),R.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/v4.19.2/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(j,R){f(j,p,R),e(p,x),e(p,u),e(u,g),e(p,T),e(p,m),e(m,_),e(p,D)},d(j){j&&r(p)}}}function Ti(S){let p,x,u,g,T,m,_,D;return{c(){p=s("p"),x=o("This class method is simply calling "),u=s("a"),g=o("save_pretrained()"),T=o(` and
`),m=s("code"),_=o("save_pretrained"),D=o(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(j){p=n(j,"P",{});var R=i(p);x=a(R,"This class method is simply calling "),u=n(R,"A",{href:!0});var z=i(u);g=a(z,"save_pretrained()"),z.forEach(r),T=a(R,` and
`),m=n(R,"CODE",{});var F=i(m);_=a(F,"save_pretrained"),F.forEach(r),D=a(R,`. Please refer to the docstrings of the methods
above for more information.`),R.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/v4.19.2/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(j,R){f(j,p,R),e(p,x),e(p,u),e(u,g),e(p,T),e(p,m),e(m,_),e(p,D)},d(j){j&&r(p)}}}function bi(S){let p,x,u,g,T;return g=new Hs({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),x=o("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);x=a(_,"Example:"),_.forEach(r),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,x),f(m,u,_),k(g,m,_),T=!0},p:ci,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){y(g.$$.fragment,m),T=!1},d(m){m&&r(p),m&&r(u),O(g,m)}}}function Ci(S){let p,x,u,g,T,m,_,D,j,R,z,F,zt,$e,ro,Lt,oo,ur,W,ao,ye,so,no,Oe,io,lo,gr,st,co,_r,nt,Ft,ho,vr,re,Us,Tr,oe,mo,it,fo,po,br,ae,uo,Dt,go,_o,Cr,B,vo,Re,To,bo,xe,Co,wo,wr,lt,ko,kr,H,Ee,$o,Pe,yo,Oo,Ro,I,xo,Me,Eo,Po,je,Mo,jo,ze,zo,Lo,Fo,Le,Do,dt,qo,Ao,$r,J,se,qt,Fe,Io,At,Vo,yr,U,No,It,So,Wo,ct,Bo,Ho,Or,v,Uo,Vt,Xo,Go,Nt,Zo,Jo,St,Yo,Ko,Wt,Qo,ea,ht,ta,ra,Bt,oa,aa,Ht,sa,na,Ut,ia,la,Xt,da,ca,Rr,mt,Gt,ha,xr,De,Er,ne,ma,qe,fa,pa,Pr,Y,ie,Zt,Ae,ua,Jt,ga,Mr,q,Ie,_a,K,va,ft,Ta,ba,Ve,Ca,wa,ka,Q,$a,pt,ya,Oa,ut,Ra,xa,Ea,le,jr,ee,de,Yt,Ne,Pa,Kt,Ma,zr,b,Se,ja,Qt,za,La,P,gt,Fa,Da,er,qa,Aa,tr,Ia,Va,rr,Na,Sa,or,Wa,Ba,We,ar,Ha,Ua,Xa,_t,Ga,Za,Ja,ce,Be,Ya,V,Ka,sr,Qa,es,vt,ts,rs,nr,os,as,ss,X,He,ns,ir,is,ls,he,ds,G,Ue,cs,Xe,hs,Tt,ms,fs,ps,me,us,fe,Ge,gs,Ze,_s,bt,vs,Ts,bs,pe,Je,Cs,Ye,ws,Ct,ks,$s,ys,ue,Ke,Os,lr,Rs,Lr,te,ge,dr,Qe,xs,cr,Es,Fr,A,et,Ps,N,Ms,wt,js,zs,hr,Ls,Fs,kt,Ds,qs,As,tt,Is,rt,Vs,Ns,Ss,_e,ot,Ws,ve,Dr;return m=new jt({}),$e=new jt({}),Fe=new jt({}),De=new Hs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.19.2/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/trocr/processing_trocr.py#L23"}}),Be=new Z({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/trocr/processing_trocr.py#L44"}}),He=new Z({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/v4.19.2/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/v4.19.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/processing_utils.py#L94"}}),me=new li({props:{$$slots:{default:[Ti]},$$scope:{ctx:S}}}),Ge=new Z({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/trocr/processing_trocr.py#L53"}}),Je=new Z({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/trocr/processing_trocr.py#L60"}}),Ke=new Z({props:{name:"as_target_processor",anchor:"transformers.TrOCRProcessor.as_target_processor",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/trocr/processing_trocr.py#L67"}}),Qe=new jt({}),et=new Z({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.2/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.19.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/trocr/modeling_trocr.py#L775"}}),ot=new Z({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/v4.19.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.2/en/model_doc/trocr#transformers.TrOCRConfig"
...
tasks.`),vr=c(),re=s("img"),Tr=c(),oe=s("small"),mo=o("TrOCR architecture. Taken from the "),it=s("a"),fo=o("original paper"),po=o("."),br=c(),ae=s("p"),uo=o("Please refer to the "),Dt=s("code"),go=o("VisionEncoderDecoder"),_o=o(" class on how to use this model."),Cr=c(),B=s("p"),vo=o("This model was contributed by "),Re=s("a"),To=o("nielsr"),bo=o(`. The original code can be found
...
can be reloaded using the `),Tt=s("a"),ms=o("from_pretrained()"),fs=o(" method."),ps=c(),C(me.$$.fragment),us=c(),fe=s("div"),C(Ge.$$.fragment),gs=c(),Ze=s("p"),_s=o("This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=s("a"),vs=o("batch_decode()"),Ts=o(`. Please refer
...
into a single instance to both extract the input features and decode the predicted token ids.`),E.forEach(r),Rr=h(t),mt=n(t,"UL",{});var On=i(mt);Gt=n(On,"LI",{});var Rn=i(Gt);ha=a(Rn,"Step-by-step Optical Character Recognition (OCR)"),Rn.forEach(r),On.forEach(r),xr=h(t),w(De.$$.fragment,t),Er=h(t),ne=n(t,"P",{});var Wr=i(ne);ma=a(Wr,"See the "),qe=n(Wr,"A",{href:!0,rel:!0});var xn=i(qe);fa=a(xn,"model hub"),xn.forEach(r),pa=a(Wr," to look for TrOCR checkpoints."),Wr.forEach(r),Pr=h(t),Y=n(t,"H2",{class:!0});var Br=i(Y);ie=n(Br,"A",{id:!0,class:!0,href:!0});var En=i(ie);Zt=n(En,"SPAN",{});var Pn=i(Zt);w(Ae.$$.fragment,Pn),Pn.forEach(r),En.forEach(r),ua=h(Br),Jt=n(Br,"SPAN",{});var Mn=i(Jt);ga=a(Mn,"TrOCRConfig"),Mn.forEach(r),Br.forEach(r),Mr=h(t),q=n(t,"DIV",{class:!0});var be=i(q);w(Ie.$$.fragment,be),_a=h(be),K=n(be,"P",{});var xt=i(K);va=a(xt,"This is the configuration class to store the configuration of a "),ft=n(xt,"A",{href:!0});var jn=i(ft);Ta=a(jn,"TrOCRForCausalLM"),jn.forEach(r),ba=a(xt,`. It is used to instantiate an
TrOCR model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the TrOCR
`),Ve=n(xt,"A",{href:!0,rel:!0});var zn=i(Ve);Ca=a(zn,"microsoft/trocr-base-handwritten"),zn.forEach(r),wa=a(xt," architecture."),xt.forEach(r),ka=h(be),Q=n(be,"P",{});var Et=i(Q);$a=a(Et,"Configuration objects inherit from "),pt=n(Et,"A",{href:!0});var Ln=i(pt);ya=a(Ln,"PretrainedConfig"),Ln.forEach(r),Oa=a(Et,` and can be used to control the model outputs. Read the
...
can be reloaded using the `),Tt=n(Xr,"A",{href:!0});var Yn=i(Tt);ms=a(Yn,"from_pretrained()"),Yn.forEach(r),fs=a(Xr," method."),Xr.forEach(r),ps=h(Mt),w(me.$$.fragment,Mt),Mt.forEach(r),us=h(M),fe=n(M,"DIV",{class:!0});var Gr=i(fe);w(Ge.$$.fragment,Gr),gs=h(Gr),Ze=n(Gr,"P",{});var Zr=i(Ze);_s=a(Zr,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=n(Zr,"A",{href:!0});var Kn=i(bt);vs=a(Kn,"batch_decode()"),Kn.forEach(r),Ts=a(Zr,`. Please refer
to the docstring of this method for more information.`),Zr.forEach(r),Gr.forEach(r),bs=h(M),pe=n(M,"DIV",{class:!0});var Jr=i(pe);w(Je.$$.fragment,Jr),Cs=h(Jr),Ye=n(Jr,"P",{});var Yr=i(Ye);ws=a(Yr,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),Ct=n(Yr,"A",{href:!0});var Qn=i(Ct);ks=a(Qn,"decode()"),Qn.forEach(r),$s=a(Yr,`. Please refer to the
