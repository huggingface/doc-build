import{S as ei,i as oi,s as ti,e as a,k as g,w as k,t as d,M as ni,c as i,d as t,m as _,a as l,x as v,h as c,b as u,F as e,g as b,y as w,q as $,o as T,B as N,v as si,L as D}from"../../chunks/vendor-6b77c823.js";import{T as it}from"../../chunks/Tip-39098574.js";import{D as L}from"../../chunks/Docstring-1088f2fb.js";import{C as W}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ue}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as I}from"../../chunks/ExampleCodeBlock-5212b321.js";function ri(M){let s,f,r,m,y;return m=new W({props:{code:`from transformers import NystromformerModel, NystromformerConfig
...
`}}),{c(){k(s.$$.fragment)},l(r){v(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||($(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function mi(M){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var F=l(r);m=c(F,"Module"),F.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){k(s.$$.fragment)},l(r){v(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||($(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function hi(M){let s,f,r,m,y;return m=new W({props:{code:`import torch
from transformers import AutoTokenizer, NystromformerForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(s.$$.fragment)},l(r){v(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||($(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function gi(M){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var F=l(r);m=c(F,"Module"),F.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),v(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||($(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function ki(M){let s,f;return s=new W({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(r){v(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||($(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function vi(M){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var F=l(r);m=c(F,"Module"),F.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),v(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||($(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function $i(M){let s,f;return s=new W({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(r){v(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||($(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function Ti(M){let s,f,r,m,y,n,p,F,zn,Zt,Y,ge,lt,Je,jn,dt,Cn,Xt,_e,An,Ze,ct,En,Pn,en,Lo,On,on,Io,mt,Sn,tn,U,Ln,Xe,In,Dn,eo,Wn,Qn,nn,J,ye,pt,oo,Hn,ft,Bn,sn,A,to,Vn,Z,Un,Do,Rn,Gn,no,Kn,Yn,Jn,X,Zn,Wo,Xn,es,Qo,os,ts,ns,be,rn,ee,ke,ht,so,ss,ut,rs,an,B,ro,as,ao,is,io,ls,ds,cs,Q,lo,ms,oe,ps,Ho,fs,hs,gt,us,gs,_s,ve,ys,we,ln,te,$e,_t,co,bs,yt,ks,dn,V,mo,vs,ne,ws,bt,$s,Ts,po,Ns,Ms,Fs,q,fo,xs,se,qs,Bo,zs,js,kt,Cs,As,Es,Te,Ps,Ne,Os,Me,cn,re,Fe,vt,ho,Ss,wt,Ls,mn,E,uo,Is,$t,Ds,Ws,go,Qs,_o,Hs,Bs,Vs,x,yo,Us,ae,Rs,Vo,Gs,Ks,Tt,Ys,Js,Zs,xe,Xs,qe,er,ze,or,je,tr,Ce,pn,ie,Ae,Nt,bo,nr,Mt,sr,fn,P,ko,rr,Ft,ar,ir,vo,lr,wo,dr,cr,mr,H,$o,pr,le,fr,Uo,hr,ur,xt,gr,_r,yr,Ee,br,Pe,hn,de,Oe,qt,To,kr,zt,vr,un,O,No,wr,jt,$r,Tr,Mo,Nr,Fo,Mr,Fr,xr,z,xo,qr,ce,zr,Ro,jr,Cr,Ct,Ar,Er,Pr,Se,Or,Le,Sr,Ie,gn,me,De,At,qo,Lr,Et,Ir,_n,S,zo,Dr,pe,Wr,Pt,Qr,Hr,Ot,Br,Vr,Ur,jo,Rr,Co,Gr,Kr,Yr,j,Ao,Jr,fe,Zr,Go,Xr,ea,St,oa,ta,na,We,sa,Qe,ra,He,yn;return n=new ue({}),Je=new ue({}),oo=new ue({}),to=new L({props:{name:"class transformers.NystromformerConfig",anchor:"transformers.NystromformerConfig",parameters:[{name:"vocab_size",val:" = 30000"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu_new'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 510"},{name:"type_vocab_size",val:" = 2"},{name:"segment_means_seq_len",val:" = 64"},{name:"num_landmarks",val:" = 64"},{name:"conv_kernel_size",val:" = 65"},{name:"inv_coeff_init_option",val:" = False"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.NystromformerConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30000) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.2/en/model_doc/nystromformer#transformers.NystromformerConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/nystromformer/modeling_nystromformer.py#L680",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/nystromformer/modeling_nystromformer.py#L778",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/nystromformer/modeling_nystromformer.py#L873",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/nystromformer/modeling_nystromformer.py#L970",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/nystromformer/modeling_nystromformer.py#L1050",returnDescription:`
<p>A <a
...
behavior.`),cs=g(),Q=a("div"),k(lo.$$.fragment),ms=g(),oe=a("p"),ps=d("The "),Ho=a("a"),fs=d("NystromformerModel"),hs=d(" forward method, overrides the "),gt=a("code"),us=d("__call__"),gs=d(" special method."),_s=g(),k(ve.$$.fragment),ys=g(),k(we.$$.fragment),ln=g(),te=a("h2"),$e=a("a"),_t=a("span"),k(co.$$.fragment),bs=g(),yt=a("span"),ks=d("NystromformerForMaskedLM"),dn=g(),V=a("div"),k(mo.$$.fragment),vs=g(),ne=a("p"),ws=d("Nystr\xF6mformer Model with a "),bt=a("code"),$s=d("language modeling"),Ts=d(` head on top.
This model is a PyTorch `),po=a("a"),Ns=d("torch.nn.Module"),Ms=d(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fs=g(),q=a("div"),k(fo.$$.fragment),xs=g(),se=a("p"),qs=d("The "),Bo=a("a"),zs=d("NystromformerForMaskedLM"),js=d(" forward method, overrides the "),kt=a("code"),Cs=d("__call__"),As=d(" special method."),Es=g(),k(Te.$$.fragment),Ps=g(),k(Ne.$$.fragment),Os=g(),k(Me.$$.fragment),cn=g(),re=a("h2"),Fe=a("a"),vt=a("span"),k(ho.$$.fragment),Ss=g(),wt=a("span"),Ls=d("NystromformerForSequenceClassification"),mn=g(),E=a("div"),k(uo.$$.fragment),Is=g(),$t=a("p"),Ds=d(`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),mr=g(),H=a("div"),k($o.$$.fragment),pr=g(),le=a("p"),fr=d("The "),Uo=a("a"),hr=d("NystromformerForMultipleChoice"),ur=d(" forward method, overrides the "),xt=a("code"),gr=d("__call__"),_r=d(" special method."),yr=g(),k(Ee.$$.fragment),br=g(),k(Pe.$$.fragment),hn=g(),de=a("h2"),Oe=a("a"),qt=a("span"),k(To.$$.fragment),kr=g(),zt=a("span"),vr=d("NystromformerForTokenClassification"),un=g(),O=a("div"),k(No.$$.fragment),wr=g(),jt=a("p"),$r=d(`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Yr=g(),j=a("div"),k(Ao.$$.fragment),Jr=g(),fe=a("p"),Zr=d("The "),Go=a("a"),Xr=d("NystromformerForQuestionAnswering"),ea=d(" forward method, overrides the "),St=a("code"),oa=d("__call__"),ta=d(" special method."),na=g(),k(We.$$.fragment),sa=g(),k(Qe.$$.fragment),ra=g(),k(He.$$.fragment),this.h()},l(o){const h=ni('[data-svelte="svelte-1phssyn"]',document.head);s=i(h,"META",{name:!0,content:!0}),h.forEach(t),f=_(o),r=i(o,"H1",{class:!0});var Eo=l(r);m=i(Eo,"A",{id:!0,class:!0,href:!0});var Lt=l(m);y=i(Lt,"SPAN",{});var It=l(y);v(n.$$.fragment,It),It.forEach(t),Lt.forEach(t),p=_(Eo),F=i(Eo,"SPAN",{});var Dt=l(F);zn=c(Dt,"Nystr\xF6mformer"),Dt.forEach(t),Eo.forEach(t),Zt=_(o),Y=i(o,"H2",{class:!0});var Po=l(Y);ge=i(Po,"A",{id:!0,class:!0,href:!0});var Wt=l(ge);lt=i(Wt,"SPAN",{});var Qt=l(lt);v(Je.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),jn=_(Po),dt=i(Po,"SPAN",{});var Ht=l(dt);Cn=c(Ht,"Overview"),Ht.forEach(t),Po.forEach(t),Xt=_(o),_e=i(o,"P",{});var Oo=l(_e);An=c(Oo,"The Nystr\xF6mformer model was proposed in "),Ze=i(Oo,"A",{href:!0,rel:!0});var Bt=l(Ze);ct=i(Bt,"EM",{});var Vt=l(ct);En=c(Vt,"Nystr\xF6mformer: A Nystr\xF6m-Based Algorithm for Approximating Self-Attention"),Vt.forEach(t),Bt.forEach(t),Pn=c(Oo,` by Yunyang Xiong, Zhanpeng Zeng, Rudrasis Chakraborty, Mingxing Tan, Glenn
...
sequence length, and find that our Nystr\xF6mformer performs comparably, or in a few cases, even slightly better, than
standard self-attention. On longer sequence tasks in the Long Range Arena (LRA) benchmark, Nystr\xF6mformer performs
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),Gt.forEach(t),Rt.forEach(t),tn=_(o),U=i(o,"P",{});var he=l(U);Ln=c(he,"This model was contributed by "),Xe=i(he,"A",{href:!0,rel:!0});var Kt=l(Xe);In=c(Kt,"novice03"),Kt.forEach(t),Dn=c(he,". The original code can be found "),eo=i(he,"A",{href:!0,rel:!0});var Yt=l(eo);Wn=c(Yt,"here"),Yt.forEach(t),Qn=c(he,"."),he.forEach(t),nn=_(o),J=i(o,"H2",{class:!0});var So=l(J);ye=i(So,"A",{id:!0,class:!0,href:!0});var Jt=l(ye);pt=i(Jt,"SPAN",{});var aa=l(pt);v(oo.$$.fragment,aa),aa.forEach(t),Jt.forEach(t),Hn=_(So),ft=i(So,"SPAN",{});var ia=l(ft);Bn=c(ia,"NystromformerConfig"),ia.forEach(t),So.forEach(t),sn=_(o),A=i(o,"DIV",{class:!0});var Be=l(A);v(to.$$.fragment,Be),Vn=_(Be),Z=i(Be,"P",{});var Ko=l(Z);Un=c(Ko,"This is the configuration class to store the configuration of a "),Do=i(Ko,"A",{href:!0});var la=l(Do);Rn=c(la,"NystromformerModel"),la.forEach(t),Gn=c(Ko,`. It is used to instantiate
an Nystromformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Nystromformer
...
documentation from `),Qo=i(Yo,"A",{href:!0});var ma=l(Qo);os=c(ma,"PretrainedConfig"),ma.forEach(t),ts=c(Yo," for more information."),Yo.forEach(t),ns=_(Be),v(be.$$.fragment,Be),Be.forEach(t),rn=_(o),ee=i(o,"H2",{class:!0});var bn=l(ee);ke=i(bn,"A",{id:!0,class:!0,href:!0});var pa=l(ke);ht=i(pa,"SPAN",{});var fa=l(ht);v(so.$$.fragment,fa),fa.forEach(t),pa.forEach(t),ss=_(bn),ut=i(bn,"SPAN",{});var ha=l(ut);rs=c(ha,"NystromformerModel"),ha.forEach(t),bn.forEach(t),an=_(o),B=i(o,"DIV",{class:!0});var Jo=l(B);v(ro.$$.fragment,Jo),as=_(Jo),ao=i(Jo,"P",{});var kn=l(ao);is=c(kn,`The bare Nystr\xF6mformer Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),io=i(kn,"A",{href:!0,rel:!0});var ua=l(io);ls=c(ua,"torch.nn.Module"),ua.forEach(t),ds=c(kn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kn.forEach(t),cs=_(Jo),Q=i(Jo,"DIV",{class:!0});var Ve=l(Q);v(lo.$$.fragment,Ve),ms=_(Ve),oe=i(Ve,"P",{});var Zo=l(oe);ps=c(Zo,"The "),Ho=i(Zo,"A",{href:!0});var ga=l(Ho);fs=c(ga,"NystromformerModel"),ga.forEach(t),hs=c(Zo," forward method, overrides the "),gt=i(Zo,"CODE",{});var _a=l(gt);us=c(_a,"__call__"),_a.forEach(t),gs=c(Zo," special method."),Zo.forEach(t),_s=_(Ve),v(ve.$$.fragment,Ve),ys=_(Ve),v(we.$$.fragment,Ve),Ve.forEach(t),Jo.forEach(t),ln=_(o),te=i(o,"H2",{class:!0});var vn=l(te);$e=i(vn,"A",{id:!0,class:!0,href:!0});var ya=l($e);_t=i(ya,"SPAN",{});var ba=l(_t);v(co.$$.fragment,ba),ba.forEach(t),ya.forEach(t),bs=_(vn),yt=i(vn,"SPAN",{});var ka=l(yt);ks=c(ka,"NystromformerForMaskedLM"),ka.forEach(t),vn.forEach(t),dn=_(o),V=i(o,"DIV",{class:!0});var Xo=l(V);v(mo.$$.fragment,Xo),vs=_(Xo),ne=i(Xo,"P",{});var et=l(ne);ws=c(et,"Nystr\xF6mformer Model with a "),bt=i(et,"CODE",{});var va=l(bt);$s=c(va,"language modeling"),va.forEach(t),Ts=c(et,` head on top.
This model is a PyTorch `),po=i(et,"A",{href:!0,rel:!0});var wa=l(po);Ns=c(wa,"torch.nn.Module"),wa.forEach(t),Ms=c(et,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),et.forEach(t),Fs=_(Xo),q=i(Xo,"DIV",{class:!0});var R=l(q);v(fo.$$.fragment,R),xs=_(R),se=i(R,"P",{});var ot=l(se);qs=c(ot,"The "),Bo=i(ot,"A",{href:!0});var $a=l(Bo);zs=c($a,"NystromformerForMaskedLM"),$a.forEach(t),js=c(ot," forward method, overrides the "),kt=i(ot,"CODE",{});var Ta=l(kt);Cs=c(Ta,"__call__"),Ta.forEach(t),As=c(ot," special method."),ot.forEach(t),Es=_(R),v(Te.$$.fragment,R),Ps=_(R),v(Ne.$$.fragment,R),Os=_(R),v(Me.$$.fragment,R),R.forEach(t),Xo.forEach(t),cn=_(o),re=i(o,"H2",{class:!0});var wn=l(re);Fe=i(wn,"A",{id:!0,class:!0,href:!0});var Na=l(Fe);vt=i(Na,"SPAN",{});var Ma=l(vt);v(ho.$$.fragment,Ma),Ma.forEach(t),Na.forEach(t),Ss=_(wn),wt=i(wn,"SPAN",{});var Fa=l(wt);Ls=c(Fa,"NystromformerForSequenceClassification"),Fa.forEach(t),wn.forEach(t),mn=_(o),E=i(o,"DIV",{class:!0});var Ue=l(E);v(uo.$$.fragment,Ue),Is=_(Ue),$t=i(Ue,"P",{});var xa=l($t);Ds=c(xa,`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),xa.forEach(t),Ws=_(Ue),go=i(Ue,"P",{});var $n=l(go);Qs=c($n,"This model is a PyTorch "),_o=i($n,"A",{href:!0,rel:!0});var qa=l(_o);Hs=c(qa,"torch.nn.Module"),qa.forEach(t),Bs=c($n,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$n.forEach(t),Vs=_(Ue),x=i(Ue,"DIV",{class:!0});var C=l(x);v(yo.$$.fragment,C),Us=_(C),ae=i(C,"P",{});var tt=l(ae);Rs=c(tt,"The "),Vo=i(tt,"A",{href:!0});var za=l(Vo);Gs=c(za,"NystromformerForSequenceClassification"),za.forEach(t),Ks=c(tt," forward method, overrides the "),Tt=i(tt,"CODE",{});var ja=l(Tt);Ys=c(ja,"__call__"),ja.forEach(t),Js=c(tt," special method."),tt.forEach(t),Zs=_(C),v(xe.$$.fragment,C),Xs=_(C),v(qe.$$.fragment,C),er=_(C),v(ze.$$.fragment,C),or=_(C),v(je.$$.fragment,C),tr=_(C),v(Ce.$$.fragment,C),C.forEach(t),Ue.forEach(t),pn=_(o),ie=i(o,"H2",{class:!0});var Tn=l(ie);Ae=i(Tn,"A",{id:!0,class:!0,href:!0});var Ca=l(Ae);Nt=i(Ca,"SPAN",{});var Aa=l(Nt);v(bo.$$.fragment,Aa),Aa.forEach(t),Ca.forEach(t),nr=_(Tn),Mt=i(Tn,"SPAN",{});var Ea=l(Mt);sr=c(Ea,"NystromformerForMultipleChoice"),Ea.forEach(t),Tn.forEach(t),fn=_(o),P=i(o,"DIV",{class:!0});var Re=l(P);v(ko.$$.fragment,Re),rr=_(Re),Ft=i(Re,"P",{});var Pa=l(Ft);ar=c(Pa,`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
and a softmax) e.g. for RocStories/SWAG tasks.`),Pa.forEach(t),ir=_(Re),vo=i(Re,"P",{});var Nn=l(vo);lr=c(Nn,"This model is a PyTorch "),wo=i(Nn,"A",{href:!0,rel:!0});var Oa=l(wo);dr=c(Oa,"torch.nn.Module"),Oa.forEach(t),cr=c(Nn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Nn.forEach(t),mr=_(Re),H=i(Re,"DIV",{class:!0});var Ge=l(H);v($o.$$.fragment,Ge),pr=_(Ge),le=i(Ge,"P",{});var nt=l(le);fr=c(nt,"The "),Uo=i(nt,"A",{href:!0});var Sa=l(Uo);hr=c(Sa,"NystromformerForMultipleChoice"),Sa.forEach(t),ur=c(nt," forward method, overrides the "),xt=i(nt,"CODE",{});var La=l(xt);gr=c(La,"__call__"),La.forEach(t),_r=c(nt," special method."),nt.forEach(t),yr=_(Ge),v(Ee.$$.fragment,Ge),br=_(Ge),v(Pe.$$.fragment,Ge),Ge.forEach(t),Re.forEach(t),hn=_(o),de=i(o,"H2",{class:!0});var Mn=l(de);Oe=i(Mn,"A",{id:!0,class:!0,href:!0});var Ia=l(Oe);qt=i(Ia,"SPAN",{});var Da=l(qt);v(To.$$.fragment,Da),Da.forEach(t),Ia.forEach(t),kr=_(Mn),zt=i(Mn,"SPAN",{});var Wa=l(zt);vr=c(Wa,"NystromformerForTokenClassification"),Wa.forEach(t),Mn.forEach(t),un=_(o),O=i(o,"DIV",{class:!0});var Ke=l(O);v(No.$$.fragment,Ke),wr=_(Ke),jt=i(Ke,"P",{});var Qa=l(jt);$r=c(Qa,`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fn.forEach(t),xr=_(Ke),z=i(Ke,"DIV",{class:!0});var G=l(z);v(xo.$$.fragment,G),qr=_(G),ce=i(G,"P",{});var st=l(ce);zr=c(st,"The "),Ro=i(st,"A",{href:!0});var Ba=l(Ro);jr=c(Ba,"NystromformerForTokenClassification"),Ba.forEach(t),Cr=c(st," forward method, overrides the "),Ct=i(st,"CODE",{});var Va=l(Ct);Ar=c(Va,"__call__"),Va.forEach(t),Er=c(st," special method."),st.forEach(t),Pr=_(G),v(Se.$$.fragment,G),Or=_(G),v(Le.$$.fragment,G),Sr=_(G),v(Ie.$$.fragment,G),G.forEach(t),Ke.forEach(t),gn=_(o),me=i(o,"H2",{class:!0});var xn=l(me);De=i(xn,"A",{id:!0,class:!0,href:!0});var Ua=l(De);At=i(Ua,"SPAN",{});var Ra=l(At);v(qo.$$.fragment,Ra),Ra.forEach(t),Ua.forEach(t),Lr=_(xn),Et=i(xn,"SPAN",{});var Ga=l(Et);Ir=c(Ga,"NystromformerForQuestionAnswering"),Ga.forEach(t),xn.forEach(t),_n=_(o),S=i(o,"DIV",{class:!0});var Ye=l(S);v(zo.$$.fragment,Ye),Dr=_(Ye),pe=i(Ye,"P",{});var rt=l(pe);Wr=c(rt,`Nystr\xF6mformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
