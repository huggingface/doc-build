import{S as BM,i as jM,s as CM,e as a,k as p,w as v,t as i,M as EM,c as s,d as t,m as u,a as r,x as y,h as d,b as f,F as e,g as b,y as T,q as w,o as M,B as $,v as PM,L as P}from"../../chunks/vendor-6b77c823.js";import{T as at}from"../../chunks/Tip-39098574.js";import{D as F}from"../../chunks/Docstring-1088f2fb.js";import{C as B}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as R}from"../../chunks/IconCopyLink-7a11ce68.js";import{E}from"../../chunks/ExampleCodeBlock-5212b321.js";function SM(x){let l,k,m,c,g;return c=new B({props:{code:`from transformers import MBartModel, MBartConfig
...
<span class="hljs-number">3.55</span>`}}),{c(){v(l.$$.fragment)},l(m){y(l.$$.fragment,m)},m(m,c){T(l,m,c),k=!0},p:P,i(m){k||(w(l.$$.fragment,m),k=!0)},o(m){M(l.$$.fragment,m),k=!1},d(m){$(l,m)}}}function VM(x){let l,k,m,c,g;return{c(){l=a("p"),k=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),c=i("Module"),g=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){l=s(n,"P",{});var h=r(l);k=d(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var q=r(m);c=d(q,"Module"),q.forEach(t),g=d(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart50/tokenization_mbart50.py#L48"}}),Io=new E({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[IM]},$$scope:{ctx:x}}}),ns=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart50/tokenization_mbart50.py#L257",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ps=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart50/tokenization_mbart50.py#L348"}}),us=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart50/tokenization_mbart50.py#L354"}}),hs=new R({}),ms=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.2/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_mbart.py#L1301",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_mbart.py#L1570",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_mbart.py#L1443",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_mbart.py#L1722",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_tf_mbart.py#L1158",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_tf_mbart.py#L1266",returnDescription:`
<p>A <a
...
`}}),vn=new at({props:{$$slots:{default:[a$]},$$scope:{ctx:x}}}),yn=new E({props:{anchor:"transformers.TFMBartForConditionalGeneration.call.example",$$slots:{default:[s$]},$$scope:{ctx:x}}}),Tn=new E({props:{anchor:"transformers.TFMBartForConditionalGeneration.call.example-2",$$slots:{default:[r$]},$$scope:{ctx:x}}}),lr=new R({}),cr=new F({props:{name:"class transformers.FlaxMBartModel",anchor:"transformers.FlaxMBartModel",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.2/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/v4.19.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/v4.19.2/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Kn=new E({props:{anchor:"transformers.FlaxMBartForQuestionAnswering.decode.example",$$slots:{default:[w$]},$$scope:{ctx:x}}}),{c(){l=a("meta"),k=p(),m=a("h1"),c=a("a"),g=a("span"),v(n.$$.fragment),h=p(),q=a("span"),st=i("MBart and MBart-50"),ze=p(),C=a("p"),Ie=a("strong"),he=i("DISCLAIMER:"),rt=i(" If you see something strange, file a "),me=a("a"),fe=i("Github Issue"),it=i(` and assign
...
respectively.`),ea.forEach(t),bp=u(o),xo=s(o,"P",{});var nu=r(xo);pm=d(nu,"MBart-50 has its own tokenizer "),mi=s(nu,"A",{href:!0});var ZT=r(mi);um=d(ZT,"MBart50Tokenizer"),ZT.forEach(t),hm=d(nu,"."),nu.forEach(t),kp=u(o),fi=s(o,"UL",{});var YT=r(fi);kd=s(YT,"LI",{});var e2=r(kd);mm=d(e2,"Supervised training"),e2.forEach(t),YT.forEach(t),vp=u(o),y(wa.$$.fragment,o),yp=u(o),_i=s(o,"UL",{});var t2=r(_i);Ma=s(t2,"LI",{});var au=r(Ma);vd=s(au,"P",{});var o2=r(vd);fm=d(o2,"Generation"),o2.forEach(t),_m=u(au),Te=s(au,"P",{});var nt=r(Te);gm=d(nt,"To generate using the mBART-50 multilingual translation models, "),yd=s(nt,"CODE",{});var n2=r(yd);bm=d(n2,"eos_token_id"),n2.forEach(t),km=d(nt,` is used as the
`),Td=s(nt,"CODE",{});var a2=r(Td);vm=d(a2,"decoder_start_token_id"),a2.forEach(t),ym=d(nt,` and the target language id is forced as the first generated token. To force the
...
documentation from `),ki=s(Wi,"A",{href:!0});var m2=r(ki);Dm=d(m2,"PretrainedConfig"),m2.forEach(t),Lm=d(Wi," for more information."),Wi.forEach(t),Gm=u(ta),y(Fo.$$.fragment,ta),ta.forEach(t),$p=u(o),Ut=s(o,"H2",{class:!0});var ru=r(Ut);qo=s(ru,"A",{id:!0,class:!0,href:!0});var f2=r(qo);Fd=s(f2,"SPAN",{});var _2=r(Fd);y(qa.$$.fragment,_2),_2.forEach(t),f2.forEach(t),Wm=u(ru),qd=s(ru,"SPAN",{});var g2=r(qd);Um=d(g2,"MBartTokenizer"),g2.forEach(t),ru.forEach(t),xp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);y(Ba.$$.fragment,Se),Rm=u(Se),Bd=s(Se,"P",{});var b2=r(Bd);Xm=d(b2,"Construct an MBART tokenizer."),b2.forEach(t),Qm=u(Se),ht=s(Se,"P",{});var oa=r(ht);Vm=d(oa,"Adapted from "),vi=s(oa,"A",{href:!0});var k2=r(vi);Hm=d(k2,"RobertaTokenizer"),k2.forEach(t),Jm=d(oa," and "),yi=s(oa,"A",{href:!0});var v2=r(yi);Km=d(v2,"XLNetTokenizer"),v2.forEach(t),Zm=d(oa,`. Based on
`),ja=s(oa,"A",{href:!0,rel:!0});var y2=r(ja);Ym=d(y2,"SentencePiece"),y2.forEach(t),ef=d(oa,"."),oa.forEach(t),tf=u(Se),Ca=s(Se,"P",{});var iu=r(Ca);of=d(iu,"The tokenization method is "),jd=s(iu,"CODE",{});var T2=r(jd);nf=d(T2,"<tokens> <eos> <language code>"),T2.forEach(t),af=d(iu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),iu.forEach(t),sf=u(Se),y(Bo.$$.fragment,Se),rf=u(Se),jo=s(Se,"DIV",{class:!0});var du=r(jo);y(Ea.$$.fragment,du),df=u(du),Cd=s(du,"P",{});var w2=r(Cd);lf=d(w2,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
refer to this superclass for more information regarding those methods.`),mu.forEach(t),Of=u(Y),Wa=s(Y,"P",{});var fu=r(Wa);If=d(fu,"The tokenization method is "),Gd=s(fu,"CODE",{});var A2=r(Gd);Nf=d(A2,"<tokens> <eos> <language code>"),A2.forEach(t),Df=d(fu," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),fu.forEach(t),Lf=u(Y),y(Eo.$$.fragment,Y),Gf=u(Y),qe=s(Y,"DIV",{class:!0});var yt=r(qe);y(Ua.$$.fragment,yt),Wf=u(yt),Wd=s(yt,"P",{});var O2=r(Wd);Uf=d(O2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),O2.forEach(t),Rf=u(yt),Ra=s(yt,"P",{});var _u=r(Ra);Xf=d(_u,"An MBART sequence has the following format, where "),Ud=s(_u,"CODE",{});var I2=r(Ud);Qf=d(I2,"X"),I2.forEach(t),Vf=d(_u," represents the sequence:"),_u.forEach(t),Hf=u(yt),Xa=s(yt,"UL",{});var gu=r(Xa);Qa=s(gu,"LI",{});var bu=r(Qa);Rd=s(bu,"CODE",{});var N2=r(Rd);Jf=d(N2,"input_ids"),N2.forEach(t),Kf=d(bu," (for encoder) "),Xd=s(bu,"CODE",{});var D2=r(Xd);Zf=d(D2,"X [eos, src_lang_code]"),D2.forEach(t),bu.forEach(t),Yf=u(gu),Va=s(gu,"LI",{});var ku=r(Va);Qd=s(ku,"CODE",{});var L2=r(Qd);e_=d(L2,"decoder_input_ids"),L2.forEach(t),t_=d(ku,": (for decoder) "),Vd=s(ku,"CODE",{});var G2=r(Vd);o_=d(G2,"X [eos, tgt_lang_code]"),G2.forEach(t),ku.forEach(t),gu.forEach(t),n_=u(yt),Hd=s(yt,"P",{});var W2=r(Hd);a_=d(W2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),W2.forEach(t),yt.forEach(t),s_=u(Y),Po=s(Y,"DIV",{class:!0});var vu=r(Po);y(Ha.$$.fragment,vu),r_=u(vu),Jd=s(vu,"P",{});var U2=r(Jd);i_=d(U2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),U2.forEach(t),vu.forEach(t),d_=u(Y),So=s(Y,"DIV",{class:!0});var yu=r(So);y(Ja.$$.fragment,yu),l_=u(yu),Kd=s(yu,"P",{});var R2=r(Kd);c_=d(R2,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),R2.forEach(t),yu.forEach(t),p_=u(Y),Ao=s(Y,"DIV",{class:!0});var Tu=r(Ao);y(Ka.$$.fragment,Tu),u_=u(Tu),Zd=s(Tu,"P",{});var X2=r(Zd);h_=d(X2,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),X2.forEach(t),Tu.forEach(t),Y.forEach(t),qp=u(o),Qt=s(o,"H2",{class:!0});var wu=r(Qt);Oo=s(wu,"A",{id:!0,class:!0,href:!0});var Q2=r(Oo);Yd=s(Q2,"SPAN",{});var V2=r(Yd);y(Za.$$.fragment,V2),V2.forEach(t),Q2.forEach(t),m_=u(wu),el=s(wu,"SPAN",{});var H2=r(el);f_=d(H2,"MBart50Tokenizer"),H2.forEach(t),wu.forEach(t),Bp=u(o),I=s(o,"DIV",{class:!0});var ee=r(I);y(Ya.$$.fragment,ee),__=u(ee),es=s(ee,"P",{});var Mu=r(es);g_=d(Mu,"Construct a MBart50 tokenizer. Based on "),ts=s(Mu,"A",{href:!0,rel:!0});var J2=r(ts);b_=d(J2,"SentencePiece"),J2.forEach(t),k_=d(Mu,"."),Mu.forEach(t),v_=u(ee),os=s(ee,"P",{});var $u=r(os);y_=d($u,"This tokenizer inherits from "),wi=s($u,"A",{href:!0});var K2=r(wi);T_=d(K2,"PreTrainedTokenizer"),K2.forEach(t),w_=d($u,` which contains most of the main methods. Users should refer to
...
separator.`),n1.forEach(t),aa.forEach(t),D_=u(ee),No=s(ee,"DIV",{class:!0});var Bu=r(No);y(ds.$$.fragment,Bu),L_=u(Bu),il=s(Bu,"P",{});var a1=r(il);G_=d(a1,"Converts a sequence of tokens (strings for sub-words) in a single string."),a1.forEach(t),Bu.forEach(t),W_=u(ee),Do=s(ee,"DIV",{class:!0});var ju=r(Do);y(ls.$$.fragment,ju),U_=u(ju),cs=s(ju,"P",{});var Cu=r(cs);R_=d(Cu,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),dl=s(Cu,"CODE",{});var s1=r(dl);X_=d(s1,"prepare_for_model"),s1.forEach(t),Q_=d(Cu," method."),Cu.forEach(t),ju.forEach(t),V_=u(ee),Lo=s(ee,"DIV",{class:!0});var Eu=r(Lo);y(ps.$$.fragment,Eu),H_=u(Eu),ll=s(Eu,"P",{});var r1=r(ll);J_=d(r1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),r1.forEach(t),Eu.forEach(t),K_=u(ee),Go=s(ee,"DIV",{class:!0});var Pu=r(Go);y(us.$$.fragment,Pu),Z_=u(Pu),cl=s(Pu,"P",{});var i1=r(cl);Y_=d(i1,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),i1.forEach(t),Pu.forEach(t),ee.forEach(t),jp=u(o),Vt=s(o,"H2",{class:!0});var Su=r(Vt);Wo=s(Su,"A",{id:!0,class:!0,href:!0});var d1=r(Wo);pl=s(d1,"SPAN",{});var l1=r(pl);y(hs.$$.fragment,l1),l1.forEach(t),d1.forEach(t),eg=u(Su),ul=s(Su,"SPAN",{});var c1=r(ul);tg=d(c1,"MBart50TokenizerFast"),c1.forEach(t),Su.forEach(t),Cp=u(o),K=s(o,"DIV",{class:!0});var Ae=r(K);y(ms.$$.fragment,Ae),og=u(Ae),Ht=s(Ae,"P",{});var Ri=r(Ht);ng=d(Ri,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),hl=s(Ri,"EM",{});var p1=r(hl);ag=d(p1,"tokenizers"),p1.forEach(t),sg=d(Ri,` library). Based on
...
refer to this superclass for more information regarding those methods.`),Au.forEach(t),ug=u(Ae),y(Uo.$$.fragment,Ae),hg=u(Ae),Be=s(Ae,"DIV",{class:!0});var Tt=r(Be);y(gs.$$.fragment,Tt),mg=u(Tt),ml=s(Tt,"P",{});var m1=r(ml);fg=d(m1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),m1.forEach(t),_g=u(Tt),bs=s(Tt,"P",{});var Ou=r(bs);gg=d(Ou,"An MBART-50 sequence has the following format, where "),fl=s(Ou,"CODE",{});var f1=r(fl);bg=d(f1,"X"),f1.forEach(t),kg=d(Ou," represents the sequence:"),Ou.forEach(t),vg=u(Tt),ks=s(Tt,"UL",{});var Iu=r(ks);vs=s(Iu,"LI",{});var Nu=r(vs);_l=s(Nu,"CODE",{});var _1=r(_l);yg=d(_1,"input_ids"),_1.forEach(t),Tg=d(Nu," (for encoder) "),gl=s(Nu,"CODE",{});var g1=r(gl);wg=d(g1,"[src_lang_code] X [eos]"),g1.forEach(t),Nu.forEach(t),Mg=u(Iu),ys=s(Iu,"LI",{});var Du=r(ys);bl=s(Du,"CODE",{});var b1=r(bl);$g=d(b1,"labels"),b1.forEach(t),xg=d(Du,": (for decoder) "),kl=s(Du,"CODE",{});var k1=r(kl);zg=d(k1,"[tgt_lang_code] X [eos]"),k1.forEach(t),Du.forEach(t),Iu.forEach(t),Fg=u(Tt),vl=s(Tt,"P",{});var v1=r(vl);qg=d(v1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),v1.forEach(t),Tt.forEach(t),Bg=u(Ae),Ro=s(Ae,"DIV",{class:!0});var Lu=r(Ro);y(Ts.$$.fragment,Lu),jg=u(Lu),yl=s(Lu,"P",{});var y1=r(yl);Cg=d(y1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),y1.forEach(t),Lu.forEach(t),Eg=u(Ae),Xo=s(Ae,"DIV",{class:!0});var Gu=r(Xo);y(ws.$$.fragment,Gu),Pg=u(Gu),Tl=s(Gu,"P",{});var T1=r(Tl);Sg=d(T1,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),T1.forEach(t),Gu.forEach(t),Ae.forEach(t),Ep=u(o),Jt=s(o,"H2",{class:!0});var Wu=r(Jt);Qo=s(Wu,"A",{id:!0,class:!0,href:!0});var w1=r(Qo);wl=s(w1,"SPAN",{});var M1=r(wl);y(Ms.$$.fragment,M1),M1.forEach(t),w1.forEach(t),Ag=u(Wu),Ml=s(Wu,"SPAN",{});var $1=r(Ml);Og=d($1,"MBartModel"),$1.forEach(t),Wu.forEach(t),Pp=u(o),We=s(o,"DIV",{class:!0});var sa=r(We);y($s.$$.fragment,sa),Ig=u(sa),xs=s(sa,"P",{});var Uu=r(xs);Ng=d(Uu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ru.forEach(t),Xg=u(sa),Ze=s(sa,"DIV",{class:!0});var ra=r(Ze);y(qs.$$.fragment,ra),Qg=u(ra),Kt=s(ra,"P",{});var Xi=r(Kt);Vg=d(Xi,"The "),xi=s(Xi,"A",{href:!0});var F1=r(xi);Hg=d(F1,"MBartModel"),F1.forEach(t),Jg=d(Xi," forward method, overrides the "),$l=s(Xi,"CODE",{});var q1=r($l);Kg=d(q1,"__call__"),q1.forEach(t),Zg=d(Xi," special method."),Xi.forEach(t),Yg=u(ra),y(Vo.$$.fragment,ra),eb=u(ra),y(Ho.$$.fragment,ra),ra.forEach(t),sa.forEach(t),Sp=u(o),Zt=s(o,"H2",{class:!0});var Xu=r(Zt);Jo=s(Xu,"A",{id:!0,class:!0,href:!0});var B1=r(Jo);xl=s(B1,"SPAN",{});var j1=r(xl);y(Bs.$$.fragment,j1),j1.forEach(t),B1.forEach(t),tb=u(Xu),zl=s(Xu,"SPAN",{});var C1=r(zl);ob=d(C1,"MBartForConditionalGeneration"),C1.forEach(t),Xu.forEach(t),Ap=u(o),Ue=s(o,"DIV",{class:!0});var ia=r(Ue);y(js.$$.fragment,ia),nb=u(ia),Cs=s(ia,"P",{});var Qu=r(Cs);ab=d(Qu,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ku.forEach(t),Ob=u(Mt),Ce=s(Mt,"DIV",{class:!0});var $t=r(Ce);y(Ls.$$.fragment,$t),Ib=u($t),oo=s($t,"P",{});var Hi=r(oo);Nb=d(Hi,"The "),Bi=s(Hi,"A",{href:!0});var U1=r(Bi);Db=d(U1,"MBartForQuestionAnswering"),U1.forEach(t),Lb=d(Hi," forward method, overrides the "),El=s(Hi,"CODE",{});var R1=r(El);Gb=d(R1,"__call__"),R1.forEach(t),Wb=d(Hi," special method."),Hi.forEach(t),Ub=u($t),y(tn.$$.fragment,$t),Rb=u($t),y(on.$$.fragment,$t),Xb=u($t),y(nn.$$.fragment,$t),$t.forEach(t),Mt.forEach(t),Np=u(o),no=s(o,"H2",{class:!0});var Zu=r(no);an=s(Zu,"A",{id:!0,class:!0,href:!0});var X1=r(an);Pl=s(X1,"SPAN",{});var Q1=r(Pl);y(Gs.$$.fragment,Q1),Q1.forEach(t),X1.forEach(t),Qb=u(Zu),Sl=s(Zu,"SPAN",{});var V1=r(Sl);Vb=d(V1,"MBartForSequenceClassification"),V1.forEach(t),Zu.forEach(t),Dp=u(o),Me=s(o,"DIV",{class:!0});var xt=r(Me);y(Ws.$$.fragment,xt),Hb=u(xt),Al=s(xt,"P",{});var H1=r(Al);Jb=d(H1,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),uh.forEach(t),bv=u(pe),Vl=s(pe,"P",{});var Tw=r(Vl);kv=d(Tw,"Finally, this model supports inherent JAX features such as:"),Tw.forEach(t),vv=u(pe),mt=s(pe,"UL",{});var la=r(mt);Hl=s(la,"LI",{});var ww=r(Hl);mr=s(ww,"A",{href:!0,rel:!0});var Mw=r(mr);yv=d(Mw,"Just-In-Time (JIT) compilation"),Mw.forEach(t),ww.forEach(t),Tv=u(la),Jl=s(la,"LI",{});var $w=r(Jl);fr=s($w,"A",{href:!0,rel:!0});var xw=r(fr);wv=d(xw,"Automatic Differentiation"),xw.forEach(t),$w.forEach(t),Mv=u(la),Kl=s(la,"LI",{});var zw=r(Kl);_r=s(zw,"A",{href:!0,rel:!0});var Fw=r(_r);$v=d(Fw,"Vectorization"),Fw.forEach(t),zw.forEach(t),xv=u(la),Zl=s(la,"LI",{});var qw=r(Zl);gr=s(qw,"A",{href:!0,rel:!0});var Bw=r(gr);zv=d(Bw,"Parallelization"),Bw.forEach(t),qw.forEach(t),la.forEach(t),Fv=u(pe),et=s(pe,"DIV",{class:!0});var ca=r(et);y(br.$$.fragment,ca),qv=u(ca),ho=s(ca,"P",{});var Yi=r(ho);Bv=d(Yi,"The "),Yl=s(Yi,"CODE",{});var jw=r(Yl);jv=d(jw,"FlaxMBartPreTrainedModel"),jw.forEach(t),Cv=d(Yi," forward method, overrides the "),ec=s(Yi,"CODE",{});var Cw=r(ec);Ev=d(Cw,"__call__"),Cw.forEach(t),Pv=d(Yi," special method."),Yi.forEach(t),Sv=u(ca),y(Mn.$$.fragment,ca),Av=u(ca),y($n.$$.fragment,ca),ca.forEach(t),Ov=u(pe),xn=s(pe,"DIV",{class:!0});var hh=r(xn);y(kr.$$.fragment,hh),Iv=u(hh),y(zn.$$.fragment,hh),hh.forEach(t),Nv=u(pe),Fn=s(pe,"DIV",{class:!0});var mh=r(Fn);y(vr.$$.fragment,mh),Dv=u(mh),y(qn.$$.fragment,mh),mh.forEach(t),pe.forEach(t),Hp=u(o),mo=s(o,"H2",{class:!0});var fh=r(mo);Bn=s(fh,"A",{id:!0,class:!0,href:!0});var Ew=r(Bn);tc=s(Ew,"SPAN",{});var Pw=r(tc);y(yr.$$.fragment,Pw),Pw.forEach(t),Ew.forEach(t),Lv=u(fh),oc=s(fh,"SPAN",{});var Sw=r(oc);Gv=d(Sw,"FlaxMBartForConditionalGeneration"),Sw.forEach(t),fh.forEach(t),Jp=u(o),U=s(o,"DIV",{class:!0});var ue=r(U);y(Tr.$$.fragment,ue),Wv=u(ue),wr=s(ue,"P",{});var _h=r(wr);Uv=d(_h,`The MMBart Model with a language modeling head. Can be used for summarization.
