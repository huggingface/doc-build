import{S as Mi,i as Fi,s as Ci,e as s,k as h,w as b,t as l,M as Ei,c as a,d as o,m as u,a as r,x as y,h as i,b as c,F as e,g as T,y as k,q as $,o as P,B as w,v as qi,L as ge}from"../../chunks/vendor-6b77c823.js";import{T as hn}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-1088f2fb.js";import{C as Q}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as me}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as fe}from"../../chunks/ExampleCodeBlock-5212b321.js";function zi(N){let d,_,p,m,v;return m=new Q({props:{code:`from transformers import GPTNeoModel, GPTNeoConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),_=l("Example:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){T(n,d,f),e(d,_),T(n,p,f),k(m,n,f),v=!0},p:ge,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){P(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Ri(N){let d,_,p,m,v,n,f,x,Qn,un,Y,_e,ho,Re,Yn,uo,Zn,mn,J,es,Xe,ts,os,Ke,ns,ss,fn,Ht,as,gn,ve,rs,Qe,ls,is,_n,Z,Te,mo,Ye,ds,fo,cs,vn,be,ps,go,hs,us,Tn,Ze,bn,ee,ye,_o,et,ms,vo,fs,yn,L,tt,gs,te,_s,Vt,vs,Ts,ot,bs,ys,ks,oe,$s,Ut,Ps,ws,Jt,Ns,xs,Gs,ke,kn,ne,$e,To,nt,Ms,bo,Fs,$n,E,st,Cs,yo,Es,qs,at,zs,Rt,js,As,Is,rt,Ls,lt,Ss,Os,Ds,O,it,Bs,se,Ws,Xt,Hs,Vs,ko,Us,Js,Rs,Pe,Xs,we,Pn,ae,Ne,$o,dt,Ks,Po,Qs,wn,q,ct,Ys,wo,Zs,ea,pt,ta,Kt,oa,na,sa,ht,aa,ut,ra,la,ia,D,mt,da,re,ca,Qt,pa,ha,No,ua,ma,fa,xe,ga,Ge,Nn,le,Me,xo,ft,_a,Go,va,xn,G,gt,Ta,Mo,ba,ya,Yt,Zt,ka,$a,Pa,S,wa,Fo,Na,xa,Co,Ga,Ma,Eo,Fa,Ca,qo,Ea,qa,za,_t,ja,eo,Aa,Ia,La,vt,Sa,Tt,Oa,Da,Ba,C,bt,Wa,ie,Ha,to,Va,Ua,zo,Ja,Ra,Xa,Fe,Ka,Ce,Qa,Ee,Ya,qe,Za,ze,Gn,de,je,jo,yt,er,Ao,tr,Mn,M,kt,or,Io,nr,sr,$t,ar,oo,rr,lr,ir,Pt,dr,wt,cr,pr,hr,Lo,ur,mr,H,So,Nt,fr,gr,Oo,xt,_r,vr,Do,Gt,Tr,br,Bo,Mt,yr,kr,B,Ft,$r,ce,Pr,Wo,wr,Nr,Ho,xr,Gr,Mr,Ae,Fr,Ie,Fn,pe,Le,Vo,Ct,Cr,Uo,Er,Cn,F,Et,qr,Jo,zr,jr,qt,Ar,no,Ir,Lr,Sr,zt,Or,jt,Dr,Br,Wr,Ro,Hr,Vr,V,Xo,At,Ur,Jr,Ko,It,Rr,Xr,Qo,Lt,Kr,Qr,Yo,St,Yr,Zr,W,Ot,el,he,tl,Zo,ol,nl,en,sl,al,rl,Se,ll,Oe,En;return n=new me({}),Re=new me({}),Ye=new me({}),Ze=new Q({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.19.2/en/model_doc/gpt_neo#transformers.GPTNeoModel">GPTNeoModel</a>. Vocabulary size of the model. Defines the different
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/v4.19.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.2/en/model_doc/gpt_neo#transformers.GPTNeoConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L709",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.2/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L824",returnDescription:`
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ia=h(),D=s("div"),b(mt.$$.fragment),da=h(),re=s("p"),ca=l("The "),Qt=s("a"),pa=l("GPTNeoForCausalLM"),ha=l(" forward method, overrides the "),No=s("code"),ua=l("__call__"),ma=l(" special method."),fa=h(),b(xe.$$.fragment),ga=h(),b(Ge.$$.fragment),Nn=h(),le=s("h2"),Me=s("a"),xo=s("span"),b(ft.$$.fragment),_a=h(),Go=s("span"),va=l("GPTNeoForSequenceClassification"),xn=h(),G=s("div"),b(gt.$$.fragment),Ta=h(),Mo=s("p"),ba=l("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),ya=h(),Yt=s("p"),Zt=s("a"),ka=l("GPTNeoForSequenceClassification"),$a=l(` uses the last token in order to do the classification, as other causal models
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),hr=h(),Lo=s("p"),ur=l("Finally, this model supports inherent JAX features such as:"),mr=h(),H=s("ul"),So=s("li"),Nt=s("a"),fr=l("Just-In-Time (JIT) compilation"),gr=h(),Oo=s("li"),xt=s("a"),_r=l("Automatic Differentiation"),vr=h(),Do=s("li"),Gt=s("a"),Tr=l("Vectorization"),br=h(),Bo=s("li"),Mt=s("a"),yr=l("Parallelization"),kr=h(),B=s("div"),b(Ft.$$.fragment),$r=h(),ce=s("p"),Pr=l("The "),Wo=s("code"),wr=l("FlaxGPTNeoPreTrainedModel"),Nr=l(" forward method, overrides the "),Ho=s("code"),xr=l("__call__"),Gr=l(" special method."),Mr=h(),b(Ae.$$.fragment),Fr=h(),b(Ie.$$.fragment),Fn=h(),pe=s("h2"),Le=s("a"),Vo=s("span"),b(Ct.$$.fragment),Cr=h(),Uo=s("span"),Er=l("FlaxGPTNeoForCausalLM"),Cn=h(),F=s("div"),b(Et.$$.fragment),qr=h(),Jo=s("p"),zr=l(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
documentation from `),Jt=a(ao,"A",{href:!0});var Tl=r(Jt);Ns=i(Tl,"PretrainedConfig"),Tl.forEach(o),xs=i(ao," for more information."),ao.forEach(o),Gs=u(De),y(ke.$$.fragment,De),De.forEach(o),kn=u(t),ne=a(t,"H2",{class:!0});var An=r(ne);$e=a(An,"A",{id:!0,class:!0,href:!0});var bl=r($e);To=a(bl,"SPAN",{});var yl=r(To);y(nt.$$.fragment,yl),yl.forEach(o),bl.forEach(o),Ms=u(An),bo=a(An,"SPAN",{});var kl=r(bo);Fs=i(kl,"GPTNeoModel"),kl.forEach(o),An.forEach(o),$n=u(t),E=a(t,"DIV",{class:!0});var R=r(E);y(st.$$.fragment,R),Cs=u(R),yo=a(R,"P",{});var $l=r(yo);Es=i($l,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),$l.forEach(o),qs=u(R),at=a(R,"P",{});var In=r(at);zs=i(In,"This model inherits from "),Rt=a(In,"A",{href:!0});var Pl=r(Rt);js=i(Pl,"PreTrainedModel"),Pl.forEach(o),As=i(In,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
