...
The [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) class provides an API for feature-complete training in PyTorch for most standard use cases. It's used in most of the [example scripts](../examples).

Before instantiating your [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer), create a [TrainingArguments](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.TrainingArguments) to access all the points of customization during training.
...
The [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) contains the basic training loop which supports the above features. To inject custom behavior you can subclass them and override the following methods:
...
The [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) class is optimized for 🤗 Transformers models and can have surprising behaviors
when you use it on other models. When using it on your own model, make sure:

- your model always return tuples or subclasses of [ModelOutput](/docs/transformers/v4.15.0/en/main_classes/output#transformers.file_utils.ModelOutput).
- your model can compute the loss if a `labels` argument is provided and that loss is returned as the first
  element of the tuple (if your model returns tuples)
- your model can accept multiple label arguments (use the `label_names` in your [TrainingArguments](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.TrainingArguments) to indicate their name to the [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer)) but none of them should be named `"label"`.

</Tip>

Here is an example of how to customize [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) using a custom loss function for multi-label classification:
...
Another way to customize the training loop behavior for the PyTorch [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) is to use [callbacks](callback) that can inspect the training loop state (for progress reporting, logging on TensorBoard or other ML platforms...) and take decisions (like early stopping).
...
- **eval_dataset** (`torch.utils.data.Dataset`, *optional*) --
  ...
  `model.forward()` method are automatically removed.
- **tokenizer** ([PreTrainedTokenizerBase](/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase), *optional*) --
  The tokenizer used to preprocess the data. If provided, will be used to automatically pad the inputs the
  maximum length when batching inputs, and it will be saved along the model to make it easier to rerun an
  interrupted training or reuse the fine-tuned model.
- **model_init** (`Callable[[], PreTrainedModel]`, *optional*) --
  A function that instantiates the model to be used. If provided, each call to
  [train()](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer.train) will start from a new instance of the model as given by this function.
...
- **compute_metrics** (`Callable[[EvalPrediction], Dict]`, *optional*) --
  ...
  [EvalPrediction](/docs/transformers/v4.15.0/en/internal/trainer_utils#transformers.EvalPrediction) and return a dictionary string to metric values.
- **callbacks** (List of [TrainerCallback](/docs/transformers/v4.15.0/en/main_classes/callback#transformers.TrainerCallback), *optional*) --
  A list of callbacks to customize the training loop. Will add those to the list of default callbacks
  detailed in [here](callback).

  If you want to remove one of the default callbacks used, use the [Trainer.remove_callback()](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer.remove_callback) method.
- **optimizers** (`Tuple[torch.optim.Optimizer, torch.optim.lr_scheduler.LambdaLR]`, *optional*) -- A tuple
  containing the optimizer and the scheduler to use. Will default to an instance of
  [AdamW](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.AdamW) on your model and a scheduler given by
  [get_linear_schedule_with_warmup()](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.get_linear_schedule_with_warmup) controlled by `args`.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **model** -- Always points to the core model. If using a transformers model, it will be a
  [PreTrainedModel](/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel) subclass.
...
<div class="docstring">
<docstring><name>add\_callback</name><anchor>transformers.Trainer.add_callback</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L494</source><parameters>[{"name": "callback", "val": ""}]</parameters><paramsdesc>- **callback** (`type` or `TrainerCallback`) --
...
<div class="docstring">
<docstring><name>autocast\_smart\_context\_manager</name><anchor>transformers.Trainer.autocast_smart_context_manager</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L1849</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>compute\_loss</name><anchor>transformers.Trainer.compute_loss</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L1913</source><parameters>[{"name": "model", "val": ""}, {"name": "inputs", "val": ""}, {"name": "return_outputs", "val": " = False"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>create\_optimizer</name><anchor>transformers.Trainer.create_optimizer</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L804</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>create\_optimizer\_and\_scheduler</name><anchor>transformers.Trainer.create_optimizer_and_scheduler</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L793</source><parameters>[{"name": "num_training_steps", "val": ": int"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>create\_scheduler</name><anchor>transformers.Trainer.create_scheduler</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L849</source><parameters>[{"name": "num_training_steps", "val": ": int"}, {"name": "optimizer", "val": ": Optimizer = None"}]</parameters><paramsdesc>- **num_training_steps** (int) -- The number of training steps to do.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
For models that inherit from [PreTrainedModel](/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel), uses that method to compute the number of
...
<div class="docstring">
<docstring><name>get\_test\_dataloader</name><anchor>transformers.Trainer.get_test_dataloader</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L750</source><parameters>[{"name": "test_dataset", "val": ": Dataset"}]</parameters><paramsdesc>- **test_dataset** (`torch.utils.data.Dataset`, *optional*) --
...
<div class="docstring">
<docstring><name>get\_train\_dataloader</name><anchor>transformers.Trainer.get_train_dataloader</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L628</source><parameters>[]</parameters></docstring>
...
[Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer): we need to reinitialize the model at each new run. This is incompatible
with the `optimizers` argument, so you need to subclass [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) and override the
method [create_optimizer_and_scheduler()](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer.create_optimizer_and_scheduler) for custom optimizer/scheduler.
...
<div class="docstring">
<docstring><name>init\_git\_repo</name><anchor>transformers.Trainer.init_git_repo</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L2583</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>is\_local\_process\_zero</name><anchor>transformers.Trainer.is_local_process_zero</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L1937</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>is\_world\_process\_zero</name><anchor>transformers.Trainer.is_world_process_zero</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L1944</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>log</name><anchor>transformers.Trainer.log</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L1803</source><parameters>[{"name": "logs", "val": ": typing.Dict[str, float]"}]</parameters><paramsdesc>- **logs** (`Dict[str, float]`) --
...
<div class="docstring">
<docstring><name>log\_metrics</name><anchor>transformers.trainer_pt_utils.log_metrics</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer_pt_utils.py#L857</source><parameters>[{"name": "split", "val": ""}, {"name": "metrics", "val": ""}]</parameters><paramsdesc>- **split** (`str`) --
...
Note that this tracker doesn't account for memory allocations outside of [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer)'s
...
This also means that if any other tool that is used along the [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) calls
`torch.cuda.reset_peak_memory_stats`, the gpu peak memory stats could be invalid. And the
[Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) will disrupt the normal behavior of any such tools that rely on calling
...
<div class="docstring">
<docstring><name>metrics\_format</name><anchor>transformers.trainer_pt_utils.metrics_format</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer_pt_utils.py#L831</source><parameters>[{"name": "metrics", "val": ": typing.Dict[str, float]"}]</parameters><paramsdesc>- **metrics** (`Dict[str, float]`) --
...
<div class="docstring">
<docstring><name>num\_examples</name><anchor>transformers.Trainer.num_examples</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L866</source><parameters>[{"name": "dataloader", "val": ": DataLoader"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>pop\_callback</name><anchor>transformers.Trainer.pop_callback</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L505</source><parameters>[{"name": "callback", "val": ""}]</parameters><paramsdesc>- **callback** (`type` or `TrainerCallback`) --
  A `TrainerCallback` class or an instance of a `TrainerCallback`.
...
<div class="docstring">
<docstring><name>predict</name><anchor>transformers.Trainer.predict</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L2190</source><parameters>[{"name": "test_dataset", "val": ": Dataset"}, {"name": "ignore_keys", "val": ": typing.Optional[typing.List[str]] = None"}, {"name": "metric_key_prefix", "val": ": str = 'test'"}]</parameters><paramsdesc>- **test_dataset** (`Dataset`) --
...
<div class="docstring">
<docstring><name>prediction\_loop</name><anchor>transformers.Trainer.prediction_loop</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L2749</source><parameters>[{"name": "dataloader", "val": ": DataLoader"}, {"name": "description", "val": ": str"}, {"name": "prediction_loss_only", "val": ": typing.Optional[bool] = None"}, {"name": "ignore_keys", "val": ": typing.Optional[typing.List[str]] = None"}, {"name": "metric_key_prefix", "val": ": str = 'eval'"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>push\_to\_hub</name><anchor>transformers.Trainer.push_to_hub</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L2700</source><parameters>[{"name": "commit_message", "val": ": typing.Optional[str] = 'End of training'"}, {"name": "blocking", "val": ": bool = True"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **commit_message** (`str`, *optional*, defaults to `"End of training"`) --
...
<div class="docstring">
<docstring><name>remove\_callback</name><anchor>transformers.Trainer.remove_callback</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L521</source><parameters>[{"name": "callback", "val": ""}]</parameters><paramsdesc>- **callback** (`type` or `TrainerCallback`) --
  A `TrainerCallback` class or an instance of a `TrainerCallback`.
...
<div class="docstring">
<docstring><name>save\_metrics</name><anchor>transformers.trainer_pt_utils.save_metrics</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer_pt_utils.py#L948</source><parameters>[{"name": "split", "val": ""}, {"name": "metrics", "val": ""}, {"name": "combined", "val": " = True"}]</parameters><paramsdesc>- **split** (`str`) --
...
<div class="docstring">
<docstring><name>save\_model</name><anchor>transformers.Trainer.save_model</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer.py#L1956</source><parameters>[{"name": "output_dir", "val": ": typing.Optional[str] = None"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>save\_state</name><anchor>transformers.trainer_pt_utils.save_state</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/trainer_pt_utils.py#L986</source><parameters>[]</parameters></docstring>
...
- **do_train** (`bool`, *optional*, defaults to `False`) --
  Whether to run training or not. This argument is not directly used by [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer), it's
...
- **do_eval** (`bool`, *optional*) --
  ...
  [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer), it's intended to be used by your training/evaluation scripts instead. See
...
- **do_predict** (`bool`, *optional*, defaults to `False`) --
  ...
  the [example scripts](https://github.com/huggingface/transformers/tree/master/examples) for more
  details.
- **evaluation_strategy** (`str` or [IntervalStrategy](/docs/transformers/v4.15.0/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"no"`) --
...
- **learning_rate** (`float`, *optional*, defaults to 5e-5) --
  The initial learning rate for [AdamW](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
- **weight_decay** (`float`, *optional*, defaults to 0) --
  The weight decay to apply (if not zero) to all layers except all bias and LayerNorm weights in
  [AdamW](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
- **adam_beta1** (`float`, *optional*, defaults to 0.9) --
  The beta1 hyperparameter for the [AdamW](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
- **adam_beta2** (`float`, *optional*, defaults to 0.999) --
  The beta2 hyperparameter for the [AdamW](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
- **adam_epsilon** (`float`, *optional*, defaults to 1e-8) --
  The epsilon hyperparameter for the [AdamW](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
...
- **lr_scheduler_type** (`str` or [SchedulerType](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.SchedulerType), *optional*, defaults to `"linear"`) --
  The scheduler type to use. See the documentation of [SchedulerType](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.SchedulerType) for all possible
  values.
...
- **logging_strategy** (`str` or [IntervalStrategy](/docs/transformers/v4.15.0/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"steps"`) --
...
- **save_strategy** (`str` or [IntervalStrategy](/docs/transformers/v4.15.0/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"steps"`) --
...
- **adafactor** (`bool`, *optional*, defaults to `False`) --
  Whether or not to use the [Adafactor](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.Adafactor) optimizer instead of
  [AdamW](/docs/transformers/v4.15.0/en/main_classes/optimizer_schedules#transformers.AdamW).
...
- **push_to_hub** (`bool`, *optional*, defaults to `False`) --
  ...
  [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) will be pushed.
...
- **hub_strategy** (`str` or `HubStrategy`, *optional*, defaults to `"every_save"`) --
  ...
  - `"end"`: push the model, its configuration, the tokenizer (if passed along to the
    [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer)) and a draft of a model card at the end of training.
  - `"every_save"`: push the model, its configuration, the tokenizer (if passed along to the
    [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer)) and a draft of a model card each time there is a model save. The pushes
...
Using [HfArgumentParser](/docs/transformers/v4.15.0/en/internal/trainer_utils#transformers.HfArgumentParser) we can turn this class into [argparse](https://docs.python.org/3/library/argparse#module-argparse) arguments that can be specified on the command
line.
...
<div class="docstring">
<docstring><name>get\_process\_log\_level</name><anchor>transformers.TrainingArguments.get_process_log_level</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/training_args.py#L1168</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>get\_warmup\_steps</name><anchor>transformers.TrainingArguments.get_warmup_steps</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/training_args.py#L1253</source><parameters>[{"name": "num_training_steps", "val": ": int"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>main\_process\_first</name><anchor>transformers.TrainingArguments.main_process_first</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/training_args.py#L1200</source><parameters>[{"name": "local", "val": " = True"}, {"name": "desc", "val": " = 'work'"}]</parameters><paramsdesc>- **local** (`bool`, *optional*, defaults to `True`) --
...
<div class="docstring">
<docstring><name>to\_dict</name><anchor>transformers.TrainingArguments.to_dict</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/training_args.py#L1262</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>to\_json\_string</name><anchor>transformers.TrainingArguments.to_json_string</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/training_args.py#L1277</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>to\_sanitized\_dict</name><anchor>transformers.TrainingArguments.to_sanitized_dict</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/training_args.py#L1283</source><parameters>[]</parameters></docstring>
...
By default, [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) will save all checkpoints in the `output_dir` you set in the
[TrainingArguments](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.TrainingArguments) you are using. Those will go in subfolder named `checkpoint-xxx` with xxx
being the step at which the training was at.

Resuming training from a checkpoint can be done when calling [Trainer.train()](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer.train) with either:
...
the `hub-strategy` value of your [TrainingArguments](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.TrainingArguments) to either:
...
By default [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) will use `logging.INFO` for the main process and `logging.WARNING` for the replicas if any.

These defaults can be overridden to use any of the 5 `logging` levels with [TrainingArguments](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.TrainingArguments)'s
arguments:

- `log_level` - for the main process
- `log_level_replica` - for the replicas

Further, if [TrainingArguments](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.TrainingArguments)'s `log_on_each_node` is set to `False` only the main node will
use the log level settings for its main process, all other nodes will use the log level settings for replicas.

Note that [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) is going to set `transformers`'s log level separately for each node in its
`Trainer.__init__()`. So you may want to set this sooner (see the next example) if you tap into other
`transformers` functionality before creating the [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) object.
...
When resuming from a checkpoint generated by [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) all efforts are made to restore the
...
The [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer) has been extended to support libraries that may dramatically improve your training
...
By integrating [FairScale](https://github.com/facebookresearch/fairscale/) the [Trainer](/docs/transformers/v4.15.0/en/main_classes/trainer#transformers.Trainer)
