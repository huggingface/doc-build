...
We have seen in the [training tutorial](/docs/transformers/v4.15.0/en/training): how to fine-tune a model on a given task. You have probably
...
or removing TF. For instance, if you trained a [DistilBertForSequenceClassification](/docs/transformers/v4.15.0/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification), try to type

```
>>> from transformers import TFDistilBertForSequenceClassification
```

and if you trained a [TFDistilBertForSequenceClassification](/docs/transformers/v4.15.0/en/model_doc/distilbert#transformers.TFDistilBertForSequenceClassification), try to type
...
- a *config.json* file, which saves the [configuration](/docs/transformers/v4.15.0/en/main_classes/configuration) of your model ;
- a *pytorch_model.bin* file, which is the PyTorch checkpoint (unless you can't have it for some reason) ;
- a *tf_model.h5* file, which is the TensorFlow checkpoint (unless you can't have it for some reason) ;
- a *special_tokens_map.json*, which is part of your [tokenizer](/docs/transformers/v4.15.0/en/main_classes/tokenizer) save;
- a *tokenizer_config.json*, which is part of your [tokenizer](/docs/transformers/v4.15.0/en/main_classes/tokenizer) save;
- files named *vocab.json*, *vocab.txt*, *merges.txt*, or similar, which contain the vocabulary of your tokenizer, part
  of your [tokenizer](/docs/transformers/v4.15.0/en/main_classes/tokenizer) save;
- maybe a *added_tokens.json*, which is part of your [tokenizer](/docs/transformers/v4.15.0/en/main_classes/tokenizer) save.
