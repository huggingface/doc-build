...
Adapted from [CamembertTokenizer](/docs/transformers/v4.15.0/en/model_doc/camembert#transformers.CamembertTokenizer) and [BartTokenizer](/docs/transformers/v4.15.0/en/model_doc/bart#transformers.BartTokenizer). Construct a
...
<div class="docstring">
<docstring><name>convert\_tokens\_to\_string</name><anchor>transformers.BarthezTokenizer.convert_tokens_to_string</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/barthez/tokenization_barthez.py#L277</source><parameters>[{"name": "tokens", "val": ""}]</parameters></docstring>
Converts a sequence of tokens (strings for sub-words) in a single string.

</div>
<div class="docstring">
<docstring><name>create\_token\_type\_ids\_from\_sequences</name><anchor>transformers.BarthezTokenizer.create_token_type_ids_from_sequences</anchor><source>https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/barthez/tokenization_barthez.py#L214</source><parameters>[{"name": "token_ids_0", "val": ": typing.List[int]"}, {"name": "token_ids_1", "val": ": typing.Optional[typing.List[int]] = None"}]</parameters><paramsdesc>- **token_ids_0** (`List[int]`) --
  List of IDs.
- **token_ids_1** (`List[int]`, *optional*) --
...
Adapted from [CamembertTokenizer](/docs/transformers/v4.15.0/en/model_doc/camembert#transformers.CamembertTokenizer) and [BartTokenizer](/docs/transformers/v4.15.0/en/model_doc/bart#transformers.BartTokenizer). Construct a "fast"
BARThez tokenizer. Based on [SentencePiece](https://github.com/google/sentencepiece).
