...
page](/docs/transformers/v4.15.0/en/pretrained_models) to see the checkpoints available for each type of model and all [the community models](https://huggingface.co/models).

Each one of the models in the library falls into one of the following categories:

- [autoregressive-models](/docs/transformers/v4.15.0/en/model_summary#autoregressive-models)
- [autoencoding-models](/docs/transformers/v4.15.0/en/model_summary#autoencoding-models)
- [seq-to-seq-models](/docs/transformers/v4.15.0/en/model_summary#seq-to-seq-models)
- [multimodal-models](/docs/transformers/v4.15.0/en/model_summary#multimodal-models)
- [retrieval-based-models](/docs/transformers/v4.15.0/en/model_summary#retrieval-based-models)
...
- Use [Axial position encoding](/docs/transformers/v4.15.0/en/model_summary#axial-pos-encoding) (see below for more details). It’s a mechanism to avoid
  having a huge positional encoding matrix (when the sequence length is very big) by factorizing it into smaller
  matrices.
- Replace traditional attention by [LSH (local-sensitive hashing) attention](/docs/transformers/v4.15.0/en/model_summary#lsh-attention) (see below for more
...
[local attention section](/docs/transformers/v4.15.0/en/model_summary#local-attention) for more information.
...
<!--More information in this [model documentation](/docs/transformers/v4.15.0/en/model_doc/mmbt). TODO: write this page
-->
...
[Reformer](/docs/transformers/v4.15.0/en/model_summary#reformer) uses LSH attention. In the softmax(QK^t), only the biggest elements (in the softmax
...
[Longformer](/docs/transformers/v4.15.0/en/model_summary#longformer) uses local attention: often, the local context (e.g., what are the two tokens to the
...
[Reformer](/docs/transformers/v4.15.0/en/model_summary#reformer) uses axial positional encodings: in traditional transformer models, the positional encoding
