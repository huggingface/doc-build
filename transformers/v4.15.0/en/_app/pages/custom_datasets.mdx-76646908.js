import{S as dm,i as cm,s as mm,e as l,k as f,w as d,t as n,M as _m,c as i,d as t,m as h,a as p,x as c,h as o,b as u,F as s,g as r,y as m,q as _,o as w,B as g}from"../chunks/vendor-ab4e3193.js";import{T as Su}from"../chunks/Tip-b5c6375a.js";import{I as z}from"../chunks/IconCopyLink-d992940d.js";import{C as $}from"../chunks/CodeBlock-516df0c5.js";import{C as wm}from"../chunks/ColabDropdown-ee6d20de.js";import"../chunks/CopyButton-204b56db.js";function gm(G){let b,E,k,y,q,v,P,T;return{c(){b=l("p"),E=n(`For a more in-depth example of how to fine-tune a model for text classification, take a look at the corresponding
...
`),k=i(x,"A",{href:!0,rel:!0});var A=p(k);y=o(A,"PyTorch notebook"),A.forEach(t),q=o(x,`
or `),v=i(x,"A",{href:!0,rel:!0});var C=p(v);P=o(C,"TensorFlow notebook"),C.forEach(t),T=o(x,"."),x.forEach(t),this.h()},h(){u(k,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/question_answering.ipynb"),u(k,"rel","nofollow"),u(v,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/question_answering-tf.ipynb"),u(v,"rel","nofollow")},m(j,x){r(j,b,x),s(b,E),s(b,k),s(k,y),s(b,q),s(b,v),s(v,P),s(b,T)},d(j){j&&t(b)}}}function km(G){let b,E,k,y,q,v,P,T,j,x,A,C,Es,gi,to,ue,$i,st,bi,ki,so,at,ao,qs,vi,no,M,Da,Ts,xi,yi,Sa,As,ji,Ei,Ia,zs,qi,oo,Ps,ro,J,de,Ma,nt,Ti,Na,Ai,lo,ce,zi,ot,Pi,Fi,io,me,po,K,_e,La,rt,Ci,Ba,Di,fo,Fs,Si,ho,lt,uo,we,Ii,Oa,Mi,Ni,co,it,mo,X,ge,Ha,pt,Li,Wa,Bi,_o,N,Oi,Cs,Hi,Wi,ft,Qi,Ri,wo,ht,go,Ds,Ui,$o,ut,bo,L,Vi,Qa,Yi,Gi,Ra,Ji,Ki,ko,dt,vo,F,Xi,Ua,Zi,ep,Va,tp,sp,Ya,ap,np,Ga,op,rp,xo,ct,yo,Z,$e,Ja,mt,lp,Ka,ip,jo,be,pp,Ss,fp,hp,Eo,_t,qo,Is,up,To,B,wt,dp,Ms,cp,mp,_p,gt,wp,Ns,gp,$p,bp,$t,kp,Xa,vp,xp,Ao,bt,zo,ee,ke,Za,kt,yp,en,jp,Po,Ls,Ep,Fo,D,qp,Bs,Tp,Ap,tn,zp,Pp,sn,Fp,Cp,Co,vt,Do,S,Dp,an,Sp,Ip,nn,Mp,Np,on,Lp,Bp,So,xt,Io,Os,Op,Mo,yt,No,ve,Hp,Hs,Wp,Qp,Lo,jt,Bo,Ws,Rp,Oo,Et,Ho,xe,Up,rn,Vp,Yp,Wo,qt,Qo,Qs,Ro,te,ye,ln,Tt,Gp,pn,Jp,Uo,je,Kp,At,Xp,Zp,Vo,Ee,Yo,se,qe,fn,zt,ef,hn,tf,Go,Rs,sf,Jo,Pt,Ko,Us,af,Xo,Ft,Zo,Vs,nf,er,Ct,tr,Ys,of,sr,O,Gs,un,rf,lf,pf,H,dn,ff,hf,cn,uf,df,mn,cf,mf,_f,Js,_n,wf,gf,ar,ae,Te,wn,Dt,$f,gn,bf,nr,Ae,kf,Ks,vf,xf,or,St,rr,ze,yf,$n,jf,Ef,lr,It,ir,W,qf,bn,Tf,Af,kn,zf,Pf,pr,Q,Mt,Ff,vn,Cf,Df,Sf,ne,If,xn,Mf,Nf,yn,Lf,Bf,Of,Nt,Hf,jn,Wf,Qf,fr,Xs,Rf,hr,Lt,ur,Pe,Uf,En,Vf,Yf,dr,Bt,cr,Zs,Gf,mr,Ot,_r,oe,Fe,qn,Ht,Jf,Tn,Kf,wr,Ce,Xf,ea,Zf,eh,gr,Wt,$r,De,th,ta,sh,ah,br,Qt,kr,Se,nh,sa,oh,rh,vr,Rt,xr,aa,lh,yr,Ut,jr,re,Ie,An,Vt,ih,zn,ph,Er,na,fh,qr,Yt,Tr,R,hh,Pn,uh,dh,Fn,ch,mh,Ar,Gt,zr,Me,_h,oa,wh,gh,Pr,Jt,Fr,ra,$h,Cr,Kt,Dr,la,bh,Sr,Xt,Ir,Ne,kh,Cn,vh,xh,Mr,Zt,Nr,ia,Lr,le,Le,Dn,es,yh,Sn,jh,Br,Be,Eh,ts,qh,Th,Or,Oe,Hr,ie,He,In,ss,Ah,Mn,zh,Wr,pa,Ph,Qr,as,Rr,fa,Fh,Ur,ns,Vr,pe,We,Nn,os,Ch,Ln,Dh,Yr,Qe,Sh,ha,Ih,Mh,Gr,rs,Jr,ua,Nh,Kr,U,I,Lh,Bn,Bh,Oh,On,Hh,Wh,Hn,Qh,Rh,Uh,ls,Vh,Wn,Yh,Gh,Jh,is,Kh,Qn,Xh,Zh,Xr,da,eu,Zr,ps,el,Re,tu,Rn,su,au,tl,fs,sl,ca,nu,al,hs,nl,fe,Ue,Un,us,ou,Vn,ru,ol,Ve,lu,ma,iu,pu,rl,ds,ll,Ye,fu,_a,hu,uu,il,cs,pl,Ge,du,wa,cu,mu,fl,ms,hl,ga,_u,ul,_s,dl,he,Je,Yn,ws,wu,Gn,gu,cl,$a,$u,ml,gs,_l,V,bu,Jn,ku,vu,Kn,xu,yu,wl,$s,gl,ba,ju,$l,bs,bl,Ke,Eu,ka,qu,Tu,kl,ks,vl,va,Au,xl,vs,yl,Xe,zu,Xn,Pu,Fu,jl,xs,El;return v=new z({}),A=new wm({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Mixed",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/custom_datasets.ipynb"},{label:"PyTorch",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/pytorch/custom_datasets.ipynb"},{label:"TensorFlow",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/tensorflow/custom_datasets.ipynb"}]}}),at=new $({props:{code:"pip install datasets,",highlighted:"pip install datasets"}}),nt=new z({}),me=new Su({props:{$$slots:{default:[gm]},$$scope:{ctx:G}}}),rt=new z({}),lt=new $({props:{code:`from datasets import load_dataset
...
input and labels. Realign the labels and tokens by:`),pr=f(),Q=l("ol"),Mt=l("li"),Ff=n("Mapping all tokens to their corresponding word with the "),vn=l("code"),Cf=n("word_ids"),Df=n(" method."),Sf=f(),ne=l("li"),If=n("Assigning the label "),xn=l("code"),Mf=n("-100"),Nf=n(" to the special tokens "),yn=l("code"),Lf=n("[CLS]"),Bf=n(" and \u201C[SEP]``` so the PyTorch loss function ignores\nthem."),Of=f(),Nt=l("li"),Hf=n("Only labeling the first token of a given word. Assign "),jn=l("code"),Wf=n("-100"),Qf=n(" to the other subtokens from the same word."),fr=f(),Xs=l("p"),Rf=n("Here is how you can create a function that will realign the labels and tokens:"),hr=f(),d(Lt.$$.fragment),ur=f(),Pe=l("p"),Uf=n("Now tokenize and align the labels over the entire dataset with \u{1F917} Datasets "),En=l("code"),Vf=n("map"),Yf=n(" function:"),dr=f(),d(Bt.$$.fragment),cr=f(),Zs=l("p"),Gf=n("Finally, pad your text and labels, so they are a uniform length:"),mr=f(),d(Ot.$$.fragment),_r=f(),oe=l("h3"),Fe=l("a"),qn=l("span"),d(Ht.$$.fragment),Jf=f(),Tn=l("span"),Kf=n("Fine-tune with the Trainer API"),wr=f(),Ce=l("p"),Xf=n("Load your model with the "),ea=l("a"),Zf=n("AutoModelForTokenClassification"),eh=n(" class along with the number of expected labels:"),gr=f(),d(Wt.$$.fragment),$r=f(),De=l("p"),th=n("Gather your training arguments in "),ta=l("a"),sh=n("TrainingArguments"),ah=n(":"),br=f(),d(Qt.$$.fragment),kr=f(),Se=l("p"),nh=n("Collect your model, training arguments, dataset, data collator, and tokenizer in "),sa=l("a"),oh=n("Trainer"),rh=n(":"),vr=f(),d(Rt.$$.fragment),xr=f(),aa=l("p"),lh=n("Fine-tune your model:"),yr=f(),d(Ut.$$.fragment),jr=f(),re=l("h3"),Ie=l("a"),An=l("span"),d(Vt.$$.fragment),ih=f(),zn=l("span"),ph=n("Fine-tune with TensorFlow"),Er=f(),na=l("p"),fh=n("Batch your examples together and pad your text and labels, so they are a uniform length:"),qr=f(),d(Yt.$$.fragment),Tr=f(),R=l("p"),hh=n("Convert your datasets to the "),Pn=l("code"),uh=n("tf.data.Dataset"),dh=n(" format with "),Fn=l("code"),ch=n("to_tf_dataset"),mh=n(":"),Ar=f(),d(Gt.$$.fragment),zr=f(),Me=l("p"),_h=n("Load the model with the "),oa=l("a"),wh=n("TFAutoModelForTokenClassification"),gh=n(" class along with the number of expected labels:"),Pr=f(),d(Jt.$$.fragment),Fr=f(),ra=l("p"),$h=n("Set up an optimizer function, learning rate schedule, and some training hyperparameters:"),Cr=f(),d(Kt.$$.fragment),Dr=f(),la=l("p"),bh=n("Compile the model:"),Sr=f(),d(Xt.$$.fragment),Ir=f(),Ne=l("p"),kh=n("Call "),Cn=l("code"),vh=n("model.fit"),xh=n(" to fine-tune your model:"),Mr=f(),d(Zt.$$.fragment),Nr=f(),ia=l("a"),Lr=f(),le=l("h2"),Le=l("a"),Dn=l("span"),d(es.$$.fragment),yh=f(),Sn=l("span"),jh=n("Question Answering with SQuAD"),Br=f(),Be=l("p"),Eh=n(`There are many types of question answering (QA) tasks. Extractive QA focuses on identifying the answer from the text
given a question. In this example, learn how to fine-tune a model on the `),ts=l("a"),qh=n("SQuAD"),Th=n(" dataset."),Or=f(),d(Oe.$$.fragment),Hr=f(),ie=l("h3"),He=l("a"),In=l("span"),d(ss.$$.fragment),Ah=f(),Mn=l("span"),zh=n("Load SQuAD dataset"),Wr=f(),pa=l("p"),Ph=n("Load the SQuAD dataset from the \u{1F917} Datasets library:"),Qr=f(),d(as.$$.fragment),Rr=f(),fa=l("p"),Fh=n("Take a look at an example from the dataset:"),Ur=f(),d(ns.$$.fragment),Vr=f(),pe=l("h3"),We=l("a"),Nn=l("span"),d(os.$$.fragment),Ch=f(),Ln=l("span"),Dh=n("Preprocess"),Yr=f(),Qe=l("p"),Sh=n("Load the DistilBERT tokenizer with an "),ha=l("a"),Ih=n("AutoTokenizer"),Mh=n(":"),Gr=f(),d(rs.$$.fragment),Jr=f(),ua=l("p"),Nh=n("There are a few things to be aware of when preprocessing text for question answering:"),Kr=f(),U=l("ol"),I=l("li"),Lh=n("Some examples in a dataset may have a very long "),Bn=l("code"),Bh=n("context"),Oh=n(` that exceeds the maximum input length of the model. You
