import{S as Il,i as Xl,s as Ul,e as a,k as d,w as _,t as s,M as Bl,c as n,d as o,m as c,a as i,x as v,h as r,b as l,F as e,g as h,y as b,q as w,o as y,B as M}from"../../chunks/vendor-ab4e3193.js";import{T as Go}from"../../chunks/Tip-b5c6375a.js";import{D as X}from"../../chunks/Docstring-b69c0bd4.js";import{C as Vt}from"../../chunks/CodeBlock-516df0c5.js";import{I as ge}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Yl(V){let p,L,u,W,k;return{c(){p=a("p"),L=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),W=s("Module"),k=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=n(g,"P",{});var f=i(p);L=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n(f,"CODE",{});var T=i(u);W=r(T,"Module"),T.forEach(o),k=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){h(g,p,f),e(p,L),e(p,u),e(u,W),e(p,k)},d(g){g&&o(p)}}}function Hl(V){let p,L,u,W,k;return{c(){p=a("p"),L=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),W=s("Module"),k=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=n(g,"P",{});var f=i(p);L=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n(f,"CODE",{});var T=i(u);W=r(T,"Module"),T.forEach(o),k=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){h(g,p,f),e(p,L),e(p,u),e(u,W),e(p,k)},d(g){g&&o(p)}}}function Kl(V){let p,L,u,W,k;return{c(){p=a("p"),L=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),W=s("Module"),k=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=n(g,"P",{});var f=i(p);L=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n(f,"CODE",{});var T=i(u);W=r(T,"Module"),T.forEach(o),k=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){h(g,p,f),e(p,L),e(p,u),e(u,W),e(p,k)},d(g){g&&o(p)}}}function Rl(V){let p,L,u,W,k;return{c(){p=a("p"),L=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),W=s("Module"),k=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=n(g,"P",{});var f=i(p);L=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n(f,"CODE",{});var T=i(u);W=r(T,"Module"),T.forEach(o),k=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){h(g,p,f),e(p,L),e(p,u),e(u,W),e(p,k)},d(g){g&&o(p)}}}function Zl(V){let p,L,u,W,k;return{c(){p=a("p"),L=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),W=s("Module"),k=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=n(g,"P",{});var f=i(p);L=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n(f,"CODE",{});var T=i(u);W=r(T,"Module"),T.forEach(o),k=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
The dropout probability for output of the feature extractor.`,name:"feat_proj_dropout"},{anchor:"transformers.WavLMConfig.feat_extract_activation",description:"<strong>feat_extract_activation</strong> (<code>str, </code>optional<code>, defaults to </code>&#x201C;gelu&#x201D;<code>) -- The non-linear activation function (function or string) in the 1D convolutional layers of the feature extractor. If string, </code>&#x201C;gelu&#x201D;<code>, </code>&#x201C;relu&#x201D;<code>, </code>&#x201C;selu&#x201D;<code>and</code>&#x201C;gelu_new&#x201D;` are supported.",name:"feat_extract_activation"},{anchor:"transformers.WavLMConfig.feat_quantizer_dropout",description:`<strong>feat_quantizer_dropout</strong> (obj &#x2014;<em>float</em>, <em>optional</em>, defaults to 0.0):
The dropout probabilitiy for quantized feature extractor states.`,name:"feat_quantizer_dropout"},{anchor:"transformers.WavLMConfig.conv_dim",description:`<strong>conv_dim</strong> (<code>Tuple[int]</code>, <em>optional</em>, defaults to <code>(512, 512, 512, 512, 512, 512, 512)</code>) &#x2014;
...
Michael Zeng, Furu Wei.`),oa=d(),Ot=a("p"),on=s("The abstract from the paper is the following:"),aa=d(),Nt=a("p"),_o=a("em"),an=s(`Self-supervised learning (SSL) achieves great success in speech recognition, while limited exploration has been
...
benchmark, and brings significant improvements for various speech processing tasks on their representative benchmarks.`),na=d(),It=a("p"),nn=s("Tips:"),sa=d(),U=a("ul"),Pe=a("li"),sn=s(`WavLM is a speech model that accepts a float array corresponding to the raw waveform of the speech signal. Please use
`),Xt=a("a"),rn=s("Wav2Vec2Processor"),ln=s(" for the feature extraction."),dn=d(),Se=a("li"),cn=s(`WavLM model can be fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
using `),Ut=a("a"),mn=s("Wav2Vec2CTCTokenizer"),pn=s("."),hn=d(),vo=a("li"),un=s("WavLM performs especially well on speaker verification, speaker identification, and speaker diarization tasks."),ra=d(),be=a("p"),fn=s("Relevant checkpoints can be found under "),ze=a("a"),gn=s("https://huggingface.co/models?other=wavlm"),_n=s("."),ia=d(),B=a("p"),vn=s("This model was contributed by "),Ae=a("a"),bn=s("patrickvonplaten"),wn=s(`. The Authors\u2019 code can be
found `),De=a("a"),yn=s("here"),Mn=s("."),la=d(),ee=a("h2"),we=a("a"),bo=a("span"),_(Ve.$$.fragment),Wn=d(),wo=a("span"),Ln=s("WavLMConfig"),da=d(),$=a("div"),_(Oe.$$.fragment),kn=d(),te=a("p"),Tn=s("This is the configuration class to store the configuration of a "),Bt=a("a"),$n=s("WavLMModel"),Cn=s(`. It is used to
instantiate an WavLM model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the WavLM `),Ne=a("a"),Fn=s("facebook/wavlm-base-960h"),xn=s(" architecture."),jn=d(),oe=a("p"),qn=s("Configuration objects inherit from "),Yt=a("a"),En=s("PretrainedConfig"),Pn=s(` and can be used to control the model
outputs. Read the documentation from `),Ht=a("a"),Sn=s("PretrainedConfig"),zn=s(" for more information."),An=d(),yo=a("p"),Dn=s("Example:"),Vn=d(),_(Ie.$$.fragment),On=d(),Mo=a("p"),Nn=s("Example:"),In=d(),_(Xe.$$.fragment),ca=d(),ae=a("h2"),ye=a("a"),Wo=a("span"),_(Ue.$$.fragment),Xn=d(),Lo=a("span"),Un=s("WavLM specific outputs"),ma=d(),ne=a("div"),_(Be.$$.fragment),Bn=d(),Ye=a("p"),Yn=s("Output type of "),ko=a("code"),Hn=s("WavLMBaseModelOutput"),Kn=s(", with potential hidden states and attentions."),pa=d(),se=a("h2"),Me=a("a"),To=a("span"),_(He.$$.fragment),Rn=d(),$o=a("span"),Zn=s("WavLMModel"),ha=d(),j=a("div"),_(Ke.$$.fragment),Qn=d(),Re=a("p"),Jn=s(`The bare WavLM Model transformer outputting raw hidden-states without any specific head on top.
WavLM was proposed in `),Ze=a("a"),Gn=s("WavLM: Unified Speech Representation Learning with Labeled and Unlabeled Data"),es=s(` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),ts=d(),Qe=a("p"),os=s("This model inherits from "),Kt=a("a"),as=s("PreTrainedModel"),ns=s(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),ss=d(),Je=a("p"),rs=s("This model is a PyTorch "),Ge=a("a"),is=s("torch.nn.Module"),ls=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ds=d(),E=a("div"),_(et.$$.fragment),cs=d(),re=a("p"),ms=s("The "),Rt=a("a"),ps=s("WavLMModel"),hs=s(" forward method, overrides the "),Co=a("code"),us=s("__call__"),fs=s(" special method."),gs=d(),_(We.$$.fragment),_s=d(),Fo=a("p"),vs=s("Example:"),bs=d(),_(tt.$$.fragment),ua=d(),ie=a("h2"),Le=a("a"),xo=a("span"),_(ot.$$.fragment),ws=d(),jo=a("span"),ys=s("WavLMForCTC"),fa=d(),q=a("div"),_(at.$$.fragment),Ms=d(),le=a("p"),Ws=s("WavLM Model with a "),qo=a("code"),Ls=s("language modeling"),ks=s(` head on top for Connectionist Temporal Classification (CTC).
WavLM was proposed in `),nt=a("a"),Ts=s("WavLM: Unified Speech Representation Learning with Labeled and Unlabeled Data"),$s=s(` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),Cs=d(),st=a("p"),Fs=s("This model inherits from "),Zt=a("a"),xs=s("PreTrainedModel"),js=s(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),qs=d(),rt=a("p"),Es=s("This model is a PyTorch "),it=a("a"),Ps=s("torch.nn.Module"),Ss=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zs=d(),P=a("div"),_(lt.$$.fragment),As=d(),de=a("p"),Ds=s("The "),Qt=a("a"),Vs=s("WavLMForCTC"),Os=s(" forward method, overrides the "),Eo=a("code"),Ns=s("__call__"),Is=s(" special method."),Xs=d(),_(ke.$$.fragment),Us=d(),Po=a("p"),Bs=s("Example:"),Ys=d(),_(dt.$$.fragment),ga=d(),ce=a("h2"),Te=a("a"),So=a("span"),_(ct.$$.fragment),Hs=d(),zo=a("span"),Ks=s("WavLMForSequenceClassification"),_a=d(),C=a("div"),_(mt.$$.fragment),Rs=d(),Ao=a("p"),Zs=s(`WavLM Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),Qs=d(),pt=a("p"),Js=s("WavLM was proposed in "),ht=a("a"),Gs=s("WavLM: Unified Speech Representation Learning with Labeled and Unlabeled Data"),er=s(` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),tr=d(),ut=a("p"),or=s("This model inherits from "),Jt=a("a"),ar=s("PreTrainedModel"),nr=s(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),sr=d(),ft=a("p"),rr=s("This model is a PyTorch "),gt=a("a"),ir=s("torch.nn.Module"),lr=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),dr=d(),S=a("div"),_(_t.$$.fragment),cr=d(),me=a("p"),mr=s("The "),Gt=a("a"),pr=s("WavLMForSequenceClassification"),hr=s(" forward method, overrides the "),Do=a("code"),ur=s("__call__"),fr=s(" special method."),gr=d(),_($e.$$.fragment),_r=d(),Vo=a("p"),vr=s("Example:"),br=d(),_(vt.$$.fragment),va=d(),pe=a("h2"),Ce=a("a"),Oo=a("span"),_(bt.$$.fragment),wr=d(),No=a("span"),yr=s("WavLMForAudioFrameClassification"),ba=d(),F=a("div"),_(wt.$$.fragment),Mr=d(),Io=a("p"),Wr=s("WavLM Model with a frame classification head on top for tasks like Speaker Diarization."),Lr=d(),yt=a("p"),kr=s("WavLM was proposed in "),Mt=a("a"),Tr=s("WavLM: Unified Speech Representation Learning with Labeled and Unlabeled Data"),$r=s(` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),Cr=d(),Wt=a("p"),Fr=s("This model inherits from "),eo=a("a"),xr=s("PreTrainedModel"),jr=s(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),qr=d(),Lt=a("p"),Er=s("This model is a PyTorch "),kt=a("a"),Pr=s("torch.nn.Module"),Sr=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zr=d(),z=a("div"),_(Tt.$$.fragment),Ar=d(),he=a("p"),Dr=s("The "),to=a("a"),Vr=s("WavLMForAudioFrameClassification"),Or=s(" forward method, overrides the "),Xo=a("code"),Nr=s("__call__"),Ir=s(" special method."),Xr=d(),_(Fe.$$.fragment),Ur=d(),Uo=a("p"),Br=s("Example:"),Yr=d(),_($t.$$.fragment),wa=d(),ue=a("h2"),xe=a("a"),Bo=a("span"),_(Ct.$$.fragment),Hr=d(),Yo=a("span"),Kr=s("WavLMForXVector"),ya=d(),x=a("div"),_(Ft.$$.fragment),Rr=d(),Ho=a("p"),Zr=s("WavLM Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Qr=d(),xt=a("p"),Jr=s("WavLM was proposed in "),jt=a("a"),Gr=s("WavLM: Unified Speech Representation Learning with Labeled and Unlabeled Data"),ei=s(` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),ti=d(),qt=a("p"),oi=s("This model inherits from "),oo=a("a"),ai=s("PreTrainedModel"),ni=s(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),si=d(),Et=a("p"),ri=s("This model is a PyTorch "),Pt=a("a"),ii=s("torch.nn.Module"),li=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),di=d(),A=a("div"),_(St.$$.fragment),ci=d(),fe=a("p"),mi=s("The "),ao=a("a"),pi=s("WavLMForXVector"),hi=s(" forward method, overrides the "),Ko=a("code"),ui=s("__call__"),fi=s(" special method."),gi=d(),_(je.$$.fragment),_i=d(),Ro=a("p"),vi=s("Example:"),bi=d(),_(zt.$$.fragment),this.h()},l(t){const m=Bl('[data-svelte="svelte-1phssyn"]',document.head);p=n(m,"META",{name:!0,content:!0}),m.forEach(o),L=c(t),u=n(t,"H1",{class:!0});var At=i(u);W=n(At,"A",{id:!0,class:!0,href:!0});var Zo=i(W);k=n(Zo,"SPAN",{});var Qo=i(k);v(g.$$.fragment,Qo),Qo.forEach(o),Zo.forEach(o),f=c(At),T=n(At,"SPAN",{});var Jo=i(T);Za=r(Jo,"WavLM"),Jo.forEach(o),At.forEach(o),ea=c(t),G=n(t,"H2",{class:!0});var Dt=i(G);_e=n(Dt,"A",{id:!0,class:!0,href:!0});var wi=i(_e);fo=n(wi,"SPAN",{});var yi=i(fo);v(qe.$$.fragment,yi),yi.forEach(o),wi.forEach(o),Qa=c(Dt),go=n(Dt,"SPAN",{});var Mi=i(go);Ja=r(Mi,"Overview"),Mi.forEach(o),Dt.forEach(o),ta=c(t),ve=n(t,"P",{});var Wa=i(ve);Ga=r(Wa,"The WavLM model was proposed in "),Ee=n(Wa,"A",{href:!0,rel:!0});var Wi=i(Ee);en=r(Wi,"WavLM: Large-Scale Self-Supervised Pre-Training for Full Stack Speech Processing"),Wi.forEach(o),tn=r(Wa,` by Sanyuan Chen, Chengyi Wang, Zhengyang Chen, Yu Wu, Shujie Liu, Zhuo Chen,
Jinyu Li, Naoyuki Kanda, Takuya Yoshioka, Xiong Xiao, Jian Wu, Long Zhou, Shuo Ren, Yanmin Qian, Yao Qian, Jian Wu,
Michael Zeng, Furu Wei.`),Wa.forEach(o),oa=c(t),Ot=n(t,"P",{});var Li=i(Ot);on=r(Li,"The abstract from the paper is the following:"),Li.forEach(o),aa=c(t),Nt=n(t,"P",{});var ki=i(Nt);_o=n(ki,"EM",{});var Ti=i(_o);an=r(Ti,`Self-supervised learning (SSL) achieves great success in speech recognition, while limited exploration has been
attempted for other speech processing tasks. As speech signal contains multi-faceted information including speaker
identity, paralinguistics, spoken content, etc., learning universal representations for all speech tasks is
challenging. In this paper, we propose a new pre-trained model, WavLM, to solve full-stack downstream speech tasks.
WavLM is built based on the HuBERT framework, with an emphasis on both spoken content modeling and speaker identity
