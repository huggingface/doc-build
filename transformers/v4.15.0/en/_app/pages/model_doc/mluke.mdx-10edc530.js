...
<p><a
  href="/docs/transformers/v4.15.0/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),{c(){k=o("meta"),V=p(),h=o("h1"),_=o("a"),le=o("span"),O($.$$.fragment),je=p(),ce=o("span"),Fe=a("mLUKE"),ye=p(),b=o("h2"),L=o("a"),de=o("span"),O(P.$$.fragment),Oe=p(),pe=o("span"),Be=a("Overview"),ve=p(),y=o("p"),Ce=a("The mLUKE model was proposed in "),A=o("a"),Xe=a("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Ye=a(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
of the `),I=o("a"),He=a("LUKE model"),Ve=a(" trained on the basis of XLM-RoBERTa."),be=p(),J=o("p"),Je=a(`It is based on XLM-RoBERTa and adds entity embeddings, which helps improve performance on various downstream tasks
involving reasoning about entities such as named entity recognition, extractive question answering, relation
classification, cloze-style knowledge completion.`),we=p(),G=o("p"),Ge=a("The abstract from the paper is the following:"),Te=p(),Q=o("p"),ue=o("em"),Qe=a(`Recent studies have shown that multilingual pretrained language models can be effectively improved with cross-lingual
...
knowledge more likely than using only word representations.`),Le=p(),Z=o("p"),Ze=a("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),xe=p(),O(N.$$.fragment),qe=p(),x=o("p"),et=a("Note that mLUKE has its own tokenizer, "),ee=o("a"),tt=a("MLukeTokenizer"),nt=a(". You can initialize it as follows:"),ze=p(),O(U.$$.fragment),Ee=p(),q=o("p"),ot=a("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),te=o("a"),st=a("LUKE\u2019s documentation page"),it=a(` for all
tips, code examples and notebooks.`),Me=p(),v=o("p"),at=a("This model was contributed by "),S=o("a"),rt=a("ryo0634"),lt=a(". The original code can be found "),W=o("a"),ct=a("here"),dt=a("."),$e=p(),w=o("h2"),z=o("a"),me=o("span"),O(K.$$.fragment),pt=p(),he=o("span"),ut=a("MLukeTokenizer"),Pe=p(),m=o("div"),O(D.$$.fragment),mt=p(),g=o("p"),ht=a("Adapted from "),ne=o("a"),ft=a("XLMRobertaTokenizer"),_t=a(" and "),oe=o("a"),gt=a("LukeTokenizer"),kt=a(`. Based on
`),R=o("a"),yt=a("SentencePiece"),vt=a("."),bt=p(),j=o("p"),wt=a("This tokenizer inherits from "),se=o("a"),Tt=a("PreTrainedTokenizer"),Lt=a(` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),xt=p(),T=o("p"),qt=a(`Attributes:
sp_model (`),fe=o("code"),zt=a("SentencePieceProcessor"),Et=a(`):
The `),_e=o("em"),Mt=a("SentencePiece"),$t=a(" processor that is used for every conversion (string, tokens and IDs)."),Pt=p(),E=o("div"),O(F.$$.fragment),At=p(),ge=o("p"),It=a(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Nt=p(),ke=o("div"),this.h()},l(e){const c=fn('[data-svelte="svelte-1phssyn"]',document.head);k=s(c,"META",{name:!0,content:!0}),c.forEach(n),V=u(e),h=s(e,"H1",{class:!0});var Ie=i(h);_=s(Ie,"A",{id:!0,class:!0,href:!0});var St=i(_);le=s(St,"SPAN",{});var Wt=i(le);B($.$$.fragment,Wt),Wt.forEach(n),St.forEach(n),je=u(Ie),ce=s(Ie,"SPAN",{});var Kt=i(ce);Fe=r(Kt,"mLUKE"),Kt.forEach(n),Ie.forEach(n),ye=u(e),b=s(e,"H2",{class:!0});var Ne=i(b);L=s(Ne,"A",{id:!0,class:!0,href:!0});var Dt=i(L);de=s(Dt,"SPAN",{});var Rt=i(de);B(P.$$.fragment,Rt),Rt.forEach(n),Dt.forEach(n),Oe=u(Ne),pe=s(Ne,"SPAN",{});var jt=i(pe);Be=r(jt,"Overview"),jt.forEach(n),Ne.forEach(n),ve=u(e),y=s(e,"P",{});var ie=i(y);Ce=r(ie,"The mLUKE model was proposed in "),A=s(ie,"A",{href:!0,rel:!0});var Ft=i(A);Xe=r(Ft,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Ft.forEach(n),Ye=r(ie,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
of the `),I=s(ie,"A",{href:!0,rel:!0});var Ot=i(I);He=r(Ot,"LUKE model"),Ot.forEach(n),Ve=r(ie," trained on the basis of XLM-RoBERTa."),ie.forEach(n),be=u(e),J=s(e,"P",{});var Bt=i(J);Je=r(Bt,`It is based on XLM-RoBERTa and adds entity embeddings, which helps improve performance on various downstream tasks
involving reasoning about entities such as named entity recognition, extractive question answering, relation
...
representations into the input allows us to extract more language-agnostic features. We also evaluate the model with a
multilingual cloze prompt task with the mLAMA dataset. We show that entity-based prompt elicits correct factual
knowledge more likely than using only word representations.`),Yt.forEach(n),Xt.forEach(n),Le=u(e),Z=s(e,"P",{});var Ht=i(Z);Ze=r(Ht,"One can directly plug in the weights of mLUKE into a LUKE model, like so:"),Ht.forEach(n),xe=u(e),B(N.$$.fragment,e),qe=u(e),x=s(e,"P",{});var Ue=i(x);et=r(Ue,"Note that mLUKE has its own tokenizer, "),ee=s(Ue,"A",{href:!0});var Vt=i(ee);tt=r(Vt,"MLukeTokenizer"),Vt.forEach(n),nt=r(Ue,". You can initialize it as follows:"),Ue.forEach(n),ze=u(e),B(U.$$.fragment,e),Ee=u(e),q=s(e,"P",{});var Se=i(q);ot=r(Se,"As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),te=s(Se,"A",{href:!0});var Jt=i(te);st=r(Jt,"LUKE\u2019s documentation page"),Jt.forEach(n),it=r(Se,` for all
tips, code examples and notebooks.`),Se.forEach(n),Me=u(e),v=s(e,"P",{});var ae=i(v);at=r(ae,"This model was contributed by "),S=s(ae,"A",{href:!0,rel:!0});var Gt=i(S);rt=r(Gt,"ryo0634"),Gt.forEach(n),lt=r(ae,". The original code can be found "),W=s(ae,"A",{href:!0,rel:!0});var Qt=i(W);ct=r(Qt,"here"),Qt.forEach(n),dt=r(ae,"."),ae.forEach(n),$e=u(e),w=s(e,"H2",{class:!0});var We=i(w);z=s(We,"A",{id:!0,class:!0,href:!0});var Zt=i(z);me=s(Zt,"SPAN",{});var en=i(me);B(K.$$.fragment,en),en.forEach(n),Zt.forEach(n),pt=u(We),he=s(We,"SPAN",{});var tn=i(he);ut=r(tn,"MLukeTokenizer"),tn.forEach(n),We.forEach(n),Pe=u(e),m=s(e,"DIV",{class:!0});var f=i(m);B(D.$$.fragment,f),mt=u(f),g=s(f,"P",{});var M=i(g);ht=r(M,"Adapted from "),ne=s(M,"A",{href:!0});var nn=i(ne);ft=r(nn,"XLMRobertaTokenizer"),nn.forEach(n),_t=r(M," and "),oe=s(M,"A",{href:!0});var on=i(oe);gt=r(on,"LukeTokenizer"),on.forEach(n),kt=r(M,`. Based on
`),R=s(M,"A",{href:!0,rel:!0});var sn=i(R);yt=r(sn,"SentencePiece"),sn.forEach(n),vt=r(M,"."),M.forEach(n),bt=u(f),j=s(f,"P",{});var Ke=i(j);wt=r(Ke,"This tokenizer inherits from "),se=s(Ke,"A",{href:!0});var an=i(se);Tt=r(an,"PreTrainedTokenizer"),an.forEach(n),Lt=r(Ke,` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),Ke.forEach(n),xt=u(f),T=s(f,"P",{});var re=i(T);qt=r(re,`Attributes:
sp_model (`),fe=s(re,"CODE",{});var rn=i(fe);zt=r(rn,"SentencePieceProcessor"),rn.forEach(n),Et=r(re,`):
The `),_e=s(re,"EM",{});var ln=i(_e);Mt=r(ln,"SentencePiece"),ln.forEach(n),$t=r(re," processor that is used for every conversion (string, tokens and IDs)."),re.forEach(n),Pt=u(f),E=s(f,"DIV",{class:!0});var De=i(E);B(F.$$.fragment,De),At=u(De),ge=s(De,"P",{});var cn=i(ge);It=r(cn,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
