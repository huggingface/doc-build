...
linear layers on top of the hidden-states output to compute `),Lc=o("code"),Gk=a("span start logits"),Xk=a(" and "),Sc=o("code"),Yk=a("span end logits"),Zk=a(")."),ew=l(),Ga=o("p"),tw=a("This model inherits from "),Ji=o("a"),sw=a("FlaxPreTrainedModel"),ow=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),kp.forEach(t),Um=d(Wt),Ke=n(Wt,"DIV",{class:!0});var Rt=r(Ke);k(On.$$.fragment,Rt),Vm=d(Rt),_s=n(Rt,"P",{});var Zi=r(_s);Jm=i(Zi,"The "),yi=n(Zi,"A",{href:!0});var q0=r(yi);Km=i(q0,"DistilBertForMultipleChoice"),q0.forEach(t),Gm=i(Zi," forward method, overrides the "),Ql=n(Zi,"CODE",{});var A0=r(Ql);Xm=i(A0,"__call__"),A0.forEach(t),Ym=i(Zi," special method."),Zi.forEach(t),Zm=d(Rt),k(io.$$.fragment,Rt),eg=d(Rt),Ul=n(Rt,"P",{});var I0=r(Ul);tg=i(I0,"Examples:"),I0.forEach(t),sg=d(Rt),k(Wn.$$.fragment,Rt),Rt.forEach(t),Wt.forEach(t),Mh=d(s),vs=n(s,"H2",{class:!0});var wp=r(vs);lo=n(wp,"A",{id:!0,class:!0,href:!0});var L0=r(lo);Vl=n(L0,"SPAN",{});var S0=r(Vl);k(Rn.$$.fragment,S0),S0.forEach(t),L0.forEach(t),og=d(wp),Jl=n(wp,"SPAN",{});var N0=r(Jl);ng=i(N0,"DistilBertForTokenClassification"),N0.forEach(t),wp.forEach(t),Eh=d(s),Qe=n(s,"DIV",{class:!0});var Ht=r(Qe);k(Hn.$$.fragment,Ht),rg=d(Ht),Kl=n(Ht,"P",{});var O0=r(Kl);ag=i(O0,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),$p.forEach(t),hg=d(Ht),Un=n(Ht,"P",{});var Dp=r(Un);pg=i(Dp,"This model is also a PyTorch "),Vn=n(Dp,"A",{href:!0,rel:!0});var R0=r(Vn);ug=i(R0,"torch.nn.Module"),R0.forEach(t),fg=i(Dp,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Dp.forEach(t),mg=d(Ht),Ge=n(Ht,"DIV",{class:!0});var Qt=r(Ge);k(Jn.$$.fragment,Qt),gg=d(Qt),Ts=n(Qt,"P",{});var el=r(Ts);_g=i(el,"The "),Mi=n(el,"A",{href:!0});var H0=r(Mi);vg=i(H0,"DistilBertForTokenClassification"),H0.forEach(t),Tg=i(el," forward method, overrides the "),Gl=n(el,"CODE",{});var Q0=r(Gl);bg=i(Q0,"__call__"),Q0.forEach(t),kg=i(el," special method."),el.forEach(t),wg=d(Qt),k(co.$$.fragment,Qt),$g=d(Qt),Xl=n(Qt,"P",{});var U0=r(Xl);Dg=i(U0,"Example:"),U0.forEach(t),Fg=d(Qt),k(Kn.$$.fragment,Qt),Qt.forEach(t),Ht.forEach(t),xh=d(s),bs=n(s,"H2",{class:!0});var Fp=r(bs);ho=n(Fp,"A",{id:!0,class:!0,href:!0});var V0=r(ho);Yl=n(V0,"SPAN",{});var J0=r(Yl);k(Gn.$$.fragment,J0),J0.forEach(t),V0.forEach(t),yg=d(Fp),Zl=n(Fp,"SPAN",{});var K0=r(Zl);Bg=i(K0,"DistilBertForQuestionAnswering"),K0.forEach(t),Fp.forEach(t),zh=d(s),Ue=n(s,"DIV",{class:!0});var Ut=r(Ue);k(Xn.$$.fragment,Ut),Mg=d(Ut),ks=n(Ut,"P",{});var tl=r(ks);Eg=i(tl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Up.forEach(t),ET=d(Ft),k(Eo.$$.fragment,Ft),xT=d(Ft),ot=n(Ft,"DIV",{class:!0});var Zt=r(ot);k(Hr.$$.fragment,Zt),zT=d(Zt),qs=n(Zt,"P",{});var dl=r(qs);CT=i(dl,"The "),Wi=n(dl,"A",{href:!0});var t$=r(Wi);jT=i(t$,"TFDistilBertForQuestionAnswering"),t$.forEach(t),PT=i(dl," forward method, overrides the "),jd=n(dl,"CODE",{});var s$=r(jd);qT=i(s$,"__call__"),s$.forEach(t),AT=i(dl," special method."),dl.forEach(t),IT=d(Zt),k(xo.$$.fragment,Zt),LT=d(Zt),Pd=n(Zt,"P",{});var o$=r(Pd);ST=i(o$,"Example:"),o$.forEach(t),NT=d(Zt),k(Qr.$$.fragment,Zt),Zt.forEach(t),Ft.forEach(t),Hh=d(s),As=n(s,"H2",{class:!0});var Vp=r(As);zo=n(Vp,"A",{id:!0,class:!0,href:!0});var n$=r(zo);qd=n(n$,"SPAN",{});var r$=r(qd);k(Ur.$$.fragment,r$),r$.forEach(t),n$.forEach(t),OT=d(Vp),Ad=n(Vp,"SPAN",{});var a$=r(Ad);WT=i(a$,"FlaxDistilBertModel"),a$.forEach(t),Vp.forEach(t),Qh=d(s),Be=n(s,"DIV",{class:!0});var ht=r(Be);k(Vr.$$.fragment,ht),RT=d(ht),Id=n(ht,"P",{});var i$=r(Id);HT=i(i$,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i$.forEach(t),QT=d(ht),Jr=n(ht,"P",{});var Jp=r(Jr);UT=i(Jp,"This model inherits from "),Ri=n(Jp,"A",{href:!0});var l$=r(Ri);VT=i(l$,"FlaxPreTrainedModel"),l$.forEach(t),JT=i(Jp,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
PyTorch models)`),Jp.forEach(t),KT=d(ht),Kr=n(ht,"P",{});var Kp=r(Kr);GT=i(Kp,"This model is also a Flax Linen "),Gr=n(Kp,"A",{href:!0,rel:!0});var d$=r(Gr);XT=i(d$,"flax.linen.Module"),d$.forEach(t),YT=i(Kp,` subclass. Use it as a regular Flax linen Module
and refer to the Flax documentation for all matter related to general usage and behavior.`),Kp.forEach(t),ZT=d(ht),Ld=n(ht,"P",{});var c$=r(Ld);eb=i(c$,"Finally, this model supports inherent JAX features such as:"),c$.forEach(t),tb=d(ht),Bt=n(ht,"UL",{});var Uo=r(Bt);Sd=n(Uo,"LI",{});var h$=r(Sd);Xr=n(h$,"A",{href:!0,rel:!0});var p$=r(Xr);sb=i(p$,"Just-In-Time (JIT) compilation"),p$.forEach(t),h$.forEach(t),ob=d(Uo),Nd=n(Uo,"LI",{});var u$=r(Nd);Yr=n(u$,"A",{href:!0,rel:!0});var f$=r(Yr);nb=i(f$,"Automatic Differentiation"),f$.forEach(t),u$.forEach(t),rb=d(Uo),Od=n(Uo,"LI",{});var m$=r(Od);Zr=n(m$,"A",{href:!0,rel:!0});var g$=r(Zr);ab=i(g$,"Vectorization"),g$.forEach(t),m$.forEach(t),ib=d(Uo),Wd=n(Uo,"LI",{});var _$=r(Wd);ea=n(_$,"A",{href:!0,rel:!0});var v$=r(ea);lb=i(v$,"Parallelization"),v$.forEach(t),_$.forEach(t),Uo.forEach(t),db=d(ht),nt=n(ht,"DIV",{class:!0});var es=r(nt);k(ta.$$.fragment,es),cb=d(es),Is=n(es,"P",{});var cl=r(Is);hb=i(cl,"The "),Rd=n(cl,"CODE",{});var T$=r(Rd);pb=i(T$,"FlaxDistilBertPreTrainedModel"),T$.forEach(t),ub=i(cl," forward method, overrides the "),Hd=n(cl,"CODE",{});var b$=r(Hd);fb=i(b$,"__call__"),b$.forEach(t),mb=i(cl," special method."),cl.forEach(t),gb=d(es),k(Co.$$.fragment,es),_b=d(es),Qd=n(es,"P",{});var k$=r(Qd);vb=i(k$,"Example:"),k$.forEach(t),Tb=d(es),k(sa.$$.fragment,es),es.forEach(t),ht.forEach(t),Uh=d(s),Ls=n(s,"H2",{class:!0});var Gp=r(Ls);jo=n(Gp,"A",{id:!0,class:!0,href:!0});var w$=r(jo);Ud=n(w$,"SPAN",{});var $$=r(Ud);k(oa.$$.fragment,$$),$$.forEach(t),w$.forEach(t),bb=d(Gp),Vd=n(Gp,"SPAN",{});var D$=r(Vd);kb=i(D$,"FlaxDistilBertForMaskedLM"),D$.forEach(t),Gp.forEach(t),Vh=d(s),Me=n(s,"DIV",{class:!0});var pt=r(Me);k(na.$$.fragment,pt),wb=d(pt),ra=n(pt,"P",{});var Xp=r(ra);$b=i(Xp,"DistilBert Model with a "),Jd=n(Xp,"CODE",{});var F$=r(Jd);Db=i(F$,"language modeling"),F$.forEach(t),Fb=i(Xp," head on top."),Xp.forEach(t),yb=d(pt),aa=n(pt,"P",{});var Yp=r(aa);Bb=i(Yp,"This model inherits from "),Hi=n(Yp,"A",{href:!0});var y$=r(Hi);Mb=i(y$,"FlaxPreTrainedModel"),y$.forEach(t),Eb=i(Yp,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
...
linear layers on top of the hidden-states output to compute `),Lc=n(ml,"CODE",{});var RD=r(Lc);Gk=i(RD,"span start logits"),RD.forEach(t),Xk=i(ml," and "),Sc=n(ml,"CODE",{});var HD=r(Sc);Yk=i(HD,"span end logits"),HD.forEach(t),Zk=i(ml,")."),ml.forEach(t),ew=d(gt),Ga=n(gt,"P",{});var cu=r(Ga);tw=i(cu,"This model inherits from "),Ji=n(cu,"A",{href:!0});var QD=r(Ji);sw=i(QD,"FlaxPreTrainedModel"),QD.forEach(t),ow=i(cu,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
