...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(n)},m(g,p){_(g,h,p),e(h,y),e(h,u),e(u,f),e(h,x)},d(g){g&&n(h)}}}function sT($){let h,y,u,f,x;return{c(){h=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var p=a(h);y=o(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(p,"CODE",{});var R=a(u);f=o(R,"Module"),R.forEach(n),x=o(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(n)},m(g,p){_(g,h,p),e(h,y),e(h,u),e(u,f),e(h,x)},d(g){g&&n(h)}}}function aT($){let h,y,u,f,x;return{c(){h=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var p=a(h);y=o(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(p,"CODE",{});var R=a(u);f=o(R,"Module"),R.forEach(n),x=o(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var p=a(h);y=o(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(p,"CODE",{});var R=a(u);f=o(R,"Module"),R.forEach(n),x=o(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(n)},m(g,p){_(g,h,p),e(h,y),e(h,u),e(u,f),e(h,x)},d(g){g&&n(h)}}}function _T($){let h,y,u,f,x,g,p,R,Zd,La,$e,tt,Rr,Ct,ei,Fr,ti,Ia,sn,oi,Oa,ot,ni,St,ri,si,Wa,an,ai,Ha,dn,zr,di,Ba,nt,ii,Dt,ci,li,Qa,Ee,rt,$r,Lt,hi,Er,pi,Va,de,It,ui,me,cn,mi,gi,Mr,_i,fi,ln,vi,bi,hn,Ti,wi,ki,st,Ot,qi,Wt,yi,pn,xi,Ri,Fi,at,Ht,zi,Bt,$i,un,Ei,Mi,Ua,Me,dt,Gr,Qt,Gi,Ar,Ai,Ka,Vt,it,Ut,ji,jr,Pi,Ya,Ge,ct,Pr,Kt,Ni,Nr,Ci,Ja,Ae,Yt,Si,Cr,Di,Xa,Jt,Xt,Za,je,lt,Sr,Zt,Li,Dr,Ii,ed,X,eo,Oi,Lr,Wi,Hi,Ir,Bi,Qi,to,Vi,ht,oo,Ui,Or,Ki,Yi,pt,no,Ji,Pe,Xi,Wr,Zi,ec,Hr,tc,oc,nc,ut,ro,rc,so,sc,Br,ac,dc,td,Ne,mt,Qr,ao,ic,Vr,cc,od,D,io,lc,Ce,hc,mn,pc,uc,Ur,mc,gc,_c,gt,fc,Kr,vc,bc,ie,Tc,Yr,wc,kc,gn,qc,yc,Jr,xc,Rc,_n,Fc,zc,$c,A,Ec,fn,Mc,Gc,Xr,Ac,jc,Zr,Pc,Nc,es,Cc,Sc,ts,Dc,Lc,vn,Ic,Oc,os,Wc,Hc,bn,Bc,Qc,Tn,Vc,Uc,ns,Kc,Yc,Jc,co,Xc,wn,Zc,el,tl,lo,ol,ho,nl,rl,sl,ee,po,al,Se,dl,kn,il,cl,rs,ll,hl,pl,_t,ul,ss,ml,gl,uo,nd,De,ft,as,mo,_l,ds,fl,rd,E,go,vl,Le,bl,qn,Tl,wl,is,kl,ql,yl,vt,xl,cs,Rl,Fl,ls,zl,$l,ce,El,hs,Ml,Gl,yn,Al,jl,ps,Pl,Nl,xn,Cl,Sl,Dl,j,Ll,
,bg,Tg,wg,At,kg,fa,qg,yg,va,xg,Rg,ue,Fg,ba,zg,$g,ar,Eg,Mg,Ta,Gg,Ag,dr,jg,Pg,Ng,O,Cg,ir,Sg,Dg,wa,Lg,Ig,ka,Og,Wg,qa,Hg,Bg,ya,Qg,Vg,cr,Ug,Kg,xa,Yg,Jg,lr,Xg,Zg,Ra,e_,t_,o_,Ko,n_,hr,r_,s_,a_,Yo,d_,Jo,i_,c_,l_,Fa,h_,p_,se,Xo,u_,Ze,m_,pr,g_,__,za,f_,v_,b_,jt,T_,$a,w_,k_,Zo,q_,Pt,en,y_,Ea,x_,ud;return g=new _e({}),Ct=new _e({}),Lt=new _e({}),It=new G({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/rag/configuration_rag.py#L84",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
Separator inserted between the title and the text of the retrieved document when calling
<a href="/docs/transformers/v4.15.0/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"title_sep"},{anchor:"transformers.RagConfig.doc_sep",description:`<strong>doc_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; // &quot;</code>) &#x2014;
...
`}}),Ht=new G({props:{name:"to_dict",anchor:"transformers.RagConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/rag/configuration_rag.py#L185",returnDescription:`
...
`),un=r("a"),Ei=t("to_dict()"),Mi=t("."),Ua=c(),Me=r("h2"),dt=r("a"),Gr=r("span"),v(Qt.$$.fragment),Gi=c(),Ar=r("span"),Ai=t("RagTokenizer"),Ka=c(),Vt=r("div"),it=r("div"),v(Ut.$$.fragment),ji=c(),jr=r("p"),Pi=t(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Ya=c(),Ge=r("h2"),ct=r("a"),Pr=r("span"),v(Kt.$$.fragment),Ni=c(),Nr=r("span"),Ci=t("Rag specific outputs"),Ja=c(),Ae=r("div"),v(Yt.$$.fragment),Si=c(),Cr=r("p"),Di=t("Base class for retriever augmented marginalized models outputs."),Xa=c(),Jt=r("div"),v(Xt.$$.fragment),Za=c(),je=r("h2"),lt=r("a"),Sr=r("span"),v(Zt.$$.fragment),Li=c(),Dr=r("span"),Ii=t("RagRetriever"),ed=c(),X=r("div"),v(eo.$$.fragment),Oi=c(),Lr=r("p"),Wi=t(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
compatible any `),Xr=r("em"),Ac=t("autoencoding"),jc=t(" model as the "),Zr=r("code"),Pc=t("question_encoder"),Nc=t(" and any "),es=r("em"),Cc=t("seq2seq"),Sc=t(` model with language model head as
...
`),Gn=r("a"),$h=t("generate()"),Eh=t("` documentation for more information on how to\nset other generate input parameters."),sd=c(),Oe=r("h2"),wt=r("a"),ws=r("span"),v(qo.$$.fragment),Mh=c(),ks=r("span"),Gh=t("RagTokenForGeneration"),ad=c(),M=r("div"),v(yo.$$.fragment),Ah=c(),We=r("p"),jh=t("The "),An=r("a"),Ph=t("RagTokenForGeneration"),Nh=t(" forward method, overrides the "),qs=r("code"),Ch=t("__call__"),Sh=t(" special method."),Dh=c(),v(kt.$$.fragment),Lh=c(),ys=r("p"),Ih=t("A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Oh=c(),xs=r("p"),Wh=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
generator can be any `),Fs=r("em"),Yh=t("seq2seq"),Jh=t(" model, preferably "),Pn=r("a"),Xh=t("BartForConditionalGeneration"),Zh=t("."),ep=c(),P=r("p"),tp=t("The model can be initialized with a "),Nn=r("a"),op=t("RagRetriever"),np=t(` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Ep=c(),oe=r("div"),v(zo.$$.fragment),Mp=c(),He=r("p"),Gp=t("The "),In=r("a"),Ap=t("RagTokenForGeneration"),jp=t(" forward method, overrides the "),js=r("code"),Pp=t("__call__"),Np=t(" special method."),Cp=c(),v(qt.$$.fragment),Sp=c(),Ps=r("p"),Dp=t("Example:"),Lp=c(),v($o.$$.fragment),Ip=c(),yt=r("div"),v(Eo.$$.fragment),Op=c(),Ns=r("p"),Wp=t("Implements RAG token decoding."),dd=c(),Be=r("h2"),xt=r("a"),Cs=r("span"),v(Mo.$$.fragment),Hp=c(),Ss=r("span"),Bp=t("TFRagModel"),id=c(),N=r("div"),v(Go.$$.fragment),Qp=c(),Qe=r("p"),Vp=t("The "),On=r("a"),Up=t("TFRagModel"),Kp=t(" forward method, overrides the "),Ds=r("code"),Yp=t("__call__"),Jp=t(" special method."),Xp=c(),v(Rt.$$.fragment),Zp=c(),Ls=r("p"),eu=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
embeddings, pruning heads etc.)`),Pu=c(),jo=r("p"),Nu=t("This model is also a Tensorflow "),Po=r("a"),Cu=t("tf.keras.Model"),Su=t(`
...
the `),ia=r("code"),Mm=t("generator"),Gm=t(". It has been tested with "),er=r("a"),Am=t("TFDPRQuestionEncoder"),jm=t(" as the "),ca=r("code"),Pm=t("question_encoder"),Nm=t(`
...
the generator can be any `),Ta=r("em"),Gg=t("seq2seq"),Ag=t(" model, preferably "),dr=r("a"),jg=t("TFBartForConditionalGeneration"),Pg=t("."),Ng=c(),O=r("p"),Cg=t("The model can be initialized with a "),ir=r("a"),Sg=t("RagRetriever"),Dg=t(` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
...
`),hn=s(et,"A",{href:!0});var P_=a(hn);Ti=o(P_,"PretrainedConfig"),P_.forEach(n),wi=o(et," for more information."),et.forEach(n),ki=l(Nt),st=s(Nt,"DIV",{class:!0});var _d=a(st);b(Ot.$$.fragment,_d),qi=l(_d),Wt=s(_d,"P",{});var fd=a(Wt);yi=o(fd,"Instantiate a "),pn=s(fd,"A",{href:!0});var N_=a(pn);xi=o(N_,"EncoderDecoderConfig"),N_.forEach(n),Ri=o(fd,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),fd.forEach(n),_d.forEach(n),Fi=l(Nt),at=s(Nt,"DIV",{class:!0});var vd=a(at);b(Ht.$$.fragment,vd),zi=l(vd),Bt=s(vd,"P",{});var bd=a(Bt);$i=o(bd,`Serializes this instance to a Python dictionary. Override the default
`),un=s(bd,"A",{href:!0});var C_=a(un);Ei=o(C_,"to_dict()"),C_.forEach(n),Mi=o(bd,"."),bd.forEach(n),vd.forEach(n),Nt.forEach(n),Ua=l(d),Me=s(d,"H2",{class:!0});var Td=a(Me);dt=s(Td,"A",{id:!0,class:!0,href:!0});var S_=a(dt);Gr=s(S_,"SPAN",{});var D_=a(Gr);b(Qt.$$.fragment,D_),D_.forEach(n),S_.forEach(n),Gi=l(Td),Ar=s(Td,"SPAN",{});var L_=a(Ar);Ai=o(L_,"RagTokenizer"),L_.forEach(n),Td.forEach(n),Ka=l(d),Vt=s(d,"DIV",{class:!0});var I_=a(Vt);it=s(I_,"DIV",{class:!0});var wd=a(it);b(Ut.$$.fragment,wd),ji=l(wd),jr=s(wd,"P",{});var O_=a(jr);Pi=o(O_,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
compatible any `),Xr=s(W,"EM",{});var gf=a(Xr);Ac=o(gf,"autoencoding"),gf.forEach(n),jc=o(W," model as the "),Zr=s(W,"CODE",{});var _f=a(Zr);Pc=o(_f,"question_encoder"),_f.forEach(n),Nc=o(W," and any "),es=s(W,"EM",{});var ff=a(es);Cc=o(ff,"seq2seq"),ff.forEach(n),Sc=o(W,` model with language model head as
...
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Od.forEach(n),Pu=l(U),jo=s(U,"P",{});var Wd=a(jo);Nu=o(Wd,"This model is also a Tensorflow "),Po=s(Wd,"A",{href:!0,rel:!0});var Kv=a(Po);Cu=o(Kv,"tf.keras.Model"),Kv.forEach(n),Su=o(Wd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
the `),ia=s(Y,"CODE",{});var gb=a(ia);Mm=o(gb,"generator"),gb.forEach(n),Gm=o(Y,". It has been tested with "),er=s(Y,"A",{href:!0});var _b=a(er);Am=o(_b,"TFDPRQuestionEncoder"),_b.forEach(n),jm=o(Y," as the "),ca=s(Y,"CODE",{});var fb=a(ca);Pm=o(fb,"question_encoder"),fb.forEach(n),Nm=o(Y,`
...
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Ab.forEach(n),Rg=l(S),ue=s(S,"P",{});var Fe=a(ue);Fg=o(Fe,"The question encoder can be any "),ba=s(Fe,"EM",{});var jb=a(ba);zg=o(jb,"autoencoding"),jb.forEach(n),$g=o(Fe," model, preferably "),ar=s(Fe,"A",{href:!0});var Pb=a(ar);Eg=o(Pb,"TFDPRQuestionEncoder"),Pb.forEach(n),Mg=o(Fe,`, and
the generator can be any `),Ta=s(Fe,"EM",{});var Nb=a(Ta);Gg=o(Nb,"seq2seq"),Nb.forEach(n),Ag=o(Fe," model, preferably "),dr=s(Fe,"A",{href:!0});var Cb=a(dr);jg=o(Cb,"TFBartForConditionalGeneration"),Cb.forEach(n),Pg=o(Fe,"."),Fe.forEach(n),Ng=l(S),O=s(S,"P",{});var J=a(O);Cg=o(J,"The model can be initialized with a "),ir=s(J,"A",{href:!0});var Sb=a(ir);Sg=o(Sb,"RagRetriever"),Sb.forEach(n),Dg=o(J,` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
