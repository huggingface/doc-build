import{S as Oi,i as Wi,s as Ii,e as a,k as l,w as k,t as s,M as Li,c as r,d as t,m as d,a as i,x as C,h as n,b as c,F as e,g as h,y as H,q as $,o as E,B as F}from"../../chunks/vendor-ab4e3193.js";import{T as ho}from"../../chunks/Tip-b5c6375a.js";import{D as ze}from"../../chunks/Docstring-b69c0bd4.js";import{C as zo}from"../../chunks/CodeBlock-516df0c5.js";import{I as yt}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Ni(A){let p,y,f,g,v;return{c(){p=a("p"),y=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=s("Module"),v=s(`
...
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var _=i(p);y=n(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var T=i(f);g=n(T,"Module"),T.forEach(t),v=n(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){h(b,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Xi(A){let p,y,f,g,v,b,_,T,Ee,ie,j,K,O,J,Fe,W,je,we,D,I,G,_e,x,q,le,Q,Te,de,L,xe,ke,M,Me,Y,X,be,Z,qe,ee,N,ce,te,Pe,u,w,ve,ye,Ue,B,De,oe,pe,S,z,Ke,Se,se,Ae,P,ne,Ye,Xe,Us,mo,Ks,Ys,wt,Xs,Js,Gs,Je,Qs,fo,Zs,en,go,tn,on,sn,Do,nn,an,Tt,us,Ge,lt,Ao,kt,rn,Oo,ln,hs,ae,Ct,dn,Ht,cn,$t,pn,un,hn,Et,mn,_o,fn,gn,_n,Ft,bn,jt,vn,yn,wn,ue,xt,Tn,Qe,kn,bo,Cn,Hn,Wo,$n,En,Fn,dt,jn,Io,xn,Mn,Mt,ms,Ze,ct,Lo,qt,qn,No,Pn,fs,re,Pt,Sn,et,zn,Bo,Dn,An,St,On,Wn,In,zt,Ln,vo,Nn,Bn,Rn,Dt,Vn,At,Un,Kn,Yn,he,Ot,Xn,tt,Jn,yo,Gn,Qn,Ro,Zn,ea,ta,pt,oa,Vo,sa,na,Wt,gs,ot,ut,Uo,It,aa,Ko,ra,_s,R,Lt,ia,Yo,la,da,Nt,ca,Bt,pa,ua,ha,Rt,ma,wo,fa,ga,_a,Vt,ba,Ut,va,ya,wa,me,Kt,Ta,st,ka,To,Ca,Ha,Xo,$a,Ea,Fa,ht,ja,Jo,xa,Ma,Yt,bs,nt,mt,Go,Xt,qa,Qo,Pa,vs,V,Jt,Sa,Zo,za,Da,Gt,Aa,ko,Oa,Wa,Ia,Qt,La,Zt,Na,Ba,Ra,ft,Va,fe,eo,Ua,at,Ka,Co,Ya,Xa,es,Ja,Ga,Qa,gt,Za,ts,er,tr,to,ys,rt,_t,os,oo,or,ss,sr,ws,U,so,nr,no,ar,ns,rr,ir,lr,ao,dr,Ho,cr,pr,ur,ro,hr,io,mr,fr,gr,bt,_r,ge,lo,br,it,vr,$o,yr,wr,as,Tr,kr,Cr,vt,Hr,rs,$r,Er,co,Ts;return b=new yt({}),J=new yt({}),z=new yt({}),ne=new ze({props:{name:"class transformers.HubertConfig",anchor:"transformers.HubertConfig",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_layer_norm",val:" = True"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/hubert/configuration_hubert.py#L29",parametersDescription:[{anchor:"transformers.HubertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss`}}),Xt=new yt({}),Jt=new ze({props:{name:"class transformers.TFHubertModel",anchor:"transformers.TFHubertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/hubert/modeling_tf_hubert.py#L1383",parametersDescription:[{anchor:"transformers.TFHubertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.15.0/en/model_doc/hubert#transformers.HubertConfig">HubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
...
reduction on the more challenging dev-other and test-other evaluation subsets.`),ke=l(),M=a("p"),Me=s("Tips:"),Y=l(),X=a("ul"),be=a("li"),Z=s("Hubert is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),qe=l(),ee=a("li"),N=s(`Hubert model was fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
using `),ce=a("a"),te=s("Wav2Vec2CTCTokenizer"),Pe=s("."),u=l(),w=a("p"),ve=s("This model was contributed by "),ye=a("a"),Ue=s("patrickvonplaten"),B=s("."),De=l(),oe=a("h2"),pe=a("a"),S=a("span"),k(z.$$.fragment),Ke=l(),Se=a("span"),se=s("HubertConfig"),Ae=l(),P=a("div"),k(ne.$$.fragment),Ye=l(),Xe=a("p"),Us=s("This is the configuration class to store the configuration of a "),mo=a("a"),Ks=s("HubertModel"),Ys=s(`. It is used to
...
`),wt=a("a"),Xs=s("facebook/hubert-base-ls960"),Js=s(" architecture."),Gs=l(),Je=a("p"),Qs=s("Configuration objects inherit from "),fo=a("a"),Zs=s("PretrainedConfig"),en=s(` and can be used to control the model
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wa=l(),me=a("div"),k(Kt.$$.fragment),Ta=l(),st=a("p"),ka=s("The "),To=a("a"),Ca=s("HubertForSequenceClassification"),Ha=s(" forward method, overrides the "),Xo=a("code"),$a=s("__call__"),Ea=s(" special method."),Fa=l(),k(ht.$$.fragment),ja=l(),Jo=a("p"),xa=s("Example:"),Ma=l(),k(Yt.$$.fragment),bs=l(),nt=a("h2"),mt=a("a"),Go=a("span"),k(Xt.$$.fragment),qa=l(),Qo=a("span"),Pa=s("TFHubertModel"),vs=l(),V=a("div"),k(Jt.$$.fragment),Sa=l(),Zo=a("p"),za=s("The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),Da=l(),Gt=a("p"),Aa=s("This model inherits from "),ko=a("a"),Oa=s("TFPreTrainedModel"),Wa=s(`. Check the superclass documentation for the
...
state-of-the-art wav2vec 2.0 performance on the Librispeech (960h) and Libri-light (60,000h) benchmarks with 10min, 1h,
10h, 100h, and 960h fine-tuning subsets. Using a 1B parameter model, HuBERT shows up to 19% and 13% relative WER
reduction on the more challenging dev-other and test-other evaluation subsets.`),qr.forEach(t),Mr.forEach(t),ke=d(o),M=r(o,"P",{});var Pr=i(M);Me=n(Pr,"Tips:"),Pr.forEach(t),Y=d(o),X=r(o,"UL",{});var Cs=i(X);be=r(Cs,"LI",{});var Sr=i(be);Z=n(Sr,"Hubert is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),Sr.forEach(t),qe=d(Cs),ee=r(Cs,"LI",{});var Hs=i(ee);N=n(Hs,`Hubert model was fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
...
instantiate an Hubert model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Hubert
`),wt=r(Eo,"A",{href:!0,rel:!0});var Lr=i(wt);Xs=n(Lr,"facebook/hubert-base-ls960"),Lr.forEach(t),Js=n(Eo," architecture."),Eo.forEach(t),Gs=d(Oe),Je=r(Oe,"P",{});var Fo=i(Je);Qs=n(Fo,"Configuration objects inherit from "),fo=r(Fo,"A",{href:!0});var Nr=i(fo);Zs=n(Nr,"PretrainedConfig"),Nr.forEach(t),en=n(Fo,` and can be used to control the model
...
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),js.forEach(t),hn=d(We),Et=r(We,"P",{});var xs=i(Et);mn=n(xs,"This model inherits from "),_o=r(xs,"A",{href:!0});var Xr=i(_o);fn=n(Xr,"PreTrainedModel"),Xr.forEach(t),gn=n(xs,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),xs.forEach(t),_n=d(We),Ft=r(We,"P",{});var Ms=i(Ft);bn=n(Ms,"This model is a PyTorch "),jt=r(Ms,"A",{href:!0,rel:!0});var Jr=i(jt);vn=n(Jr,"torch.nn.Module"),Jr.forEach(t),yn=n(Ms,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Os.forEach(t),wa=d(Ce),me=r(Ce,"DIV",{class:!0});var Be=i(me);C(Kt.$$.fragment,Be),Ta=d(Be),st=r(Be,"P",{});var qo=i(st);ka=n(qo,"The "),To=r(qo,"A",{href:!0});var _i=i(To);Ca=n(_i,"HubertForSequenceClassification"),_i.forEach(t),Ha=n(qo," forward method, overrides the "),Xo=r(qo,"CODE",{});var bi=i(Xo);$a=n(bi,"__call__"),bi.forEach(t),Ea=n(qo," special method."),qo.forEach(t),Fa=d(Be),C(ht.$$.fragment,Be),ja=d(Be),Jo=r(Be,"P",{});var vi=i(Jo);xa=n(vi,"Example:"),vi.forEach(t),Ma=d(Be),C(Yt.$$.fragment,Be),Be.forEach(t),Ce.forEach(t),bs=d(o),nt=r(o,"H2",{class:!0});var Ws=i(nt);mt=r(Ws,"A",{id:!0,class:!0,href:!0});var yi=i(mt);Go=r(yi,"SPAN",{});var wi=i(Go);C(Xt.$$.fragment,wi),wi.forEach(t),yi.forEach(t),qa=d(Ws),Qo=r(Ws,"SPAN",{});var Ti=i(Qo);Pa=n(Ti,"TFHubertModel"),Ti.forEach(t),Ws.forEach(t),vs=d(o),V=r(o,"DIV",{class:!0});var He=i(V);C(Jt.$$.fragment,He),Sa=d(He),Zo=r(He,"P",{});var ki=i(Zo);za=n(ki,"The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),ki.forEach(t),Da=d(He),Gt=r(He,"P",{});var Is=i(Gt);Aa=n(Is,"This model inherits from "),ko=r(Is,"A",{href:!0});var Ci=i(ko);Oa=n(Ci,"TFPreTrainedModel"),Ci.forEach(t),Wa=n(Is,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
