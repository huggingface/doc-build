import{S as td,i as od,s as nd,e as n,k as d,w as u,t as r,M as sd,c as s,d as o,m as l,a,x as f,h as i,b as c,F as e,g as p,y as _,q as g,o as k,B as M}from"../../chunks/vendor-ab4e3193.js";import{T as ed}from"../../chunks/Tip-b5c6375a.js";import{D as ee}from"../../chunks/Docstring-b69c0bd4.js";import{C as Et}from"../../chunks/CodeBlock-516df0c5.js";import{I as ke}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function ad(Me){let m,C,v,T,F;return{c(){m=n("p"),C=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),F=r(`
...
the latter silently ignores them.`)},l(z){m=s(z,"P",{});var $=a(m);C=i($,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s($,"CODE",{});var N=a(v);T=i(N,"Module"),N.forEach(o),F=i($,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),$.forEach(o)},m(z,$){p(z,m,$),e(m,C),e(m,v),e(v,T),e(m,F)},d(z){z&&o(m)}}}function id(Me){let m,C,v,T,F,z,$,N,$n,Ao,W,te,xt,ve,En,Ct,xn,Oo,oe,Cn,be,Pn,jn,Do,dt,Fn,No,lt,Pt,Sn,Io,ne,Ln,ye,An,On,Go,H,se,jt,we,Dn,Ft,Nn,Bo,A,In,St,Gn,Bn,Lt,Un,Wn,At,Hn,Vn,Uo,P,Kn,ct,Qn,Xn,Ot,Rn,Jn,Dt,Zn,Yn,Nt,es,ts,Wo,ht,It,os,Ho,Te,Vo,pt,ze,Gt,ns,ss,E,as,Bt,rs,is,Ut,ds,ls,Wt,cs,hs,Ht,ps,ms,Vt,us,fs,Ko,qe,Qo,V,ae,Kt,$e,_s,Qt,gs,Xo,x,Ee,ks,K,Ms,mt,vs,bs,xe,ys,ws,Ts,Q,zs,ut,qs,$s,ft,Es,xs,Cs,Xt,Ps,js,Ce,Ro,X,re,Rt,Pe,Fs,Jt,Ss,Jo,y,je,Ls,Fe,As,Se,Os,Ds,Ns,Le,Is,_t,Gs,Bs,Us,Zt,Ws,Hs,Ae,Vs,O,Oe,Ks,De,Qs,Yt,Xs,Rs,Js,Ne,Ie,eo,Zs,Ys,to,ea,ta,Ge,oo,oa,na,no,sa,aa,so,ra,ia,ie,Be,da,Ue,la,ao,ca,ha,pa,I,We,ma,gt,ua,kt,fa,_a,ro,ga,ka,io,Zo,R,de,lo,He,Ma,co,va,Yo,S,Ve,ba,Ke,ya,Mt,wa,Ta,za,Qe,qa,Xe,$a,Ea,xa,j,Re,Ca,J,Pa,vt,ja,Fa,ho,Sa,La,Aa,le,Oa,po,Da,Na,Je,en,Z,ce,mo,Ze,Ia,uo,Ga,tn,L,Ye,Ba,et,Ua,bt,Wa,Ha,Va,tt,Ka,ot,Qa,Xa,Ra,b,nt,Ja,Y,Za,yt,Ya,er,fo,tr,or,nr,he,sr,_o,ar,rr,st,ir,go,dr,lr,ko,Mo,vo,bo,cr,hr,yo,wo,To,zo,pr,mr,qo,$o,Eo,xo,ur,fr,Co,Po,at,pe,me,jo,rt,_r,Fo,gr,kr,So,Mr,on;return z=new ke({}),ve=new ke({}),we=new ke({}),Te=new Et({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
Liptchinsky, Sergey Edunov, Edouard Grave, Michael Auli, Armand Joulin.`),Do=d(),dt=n("p"),Fn=r("The abstract from the paper is the following:"),No=d(),lt=n("p"),Pt=n("em"),Sn=r(`Existing work in translation demonstrated the potential of massively multilingual machine translation by training a
...
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),Io=d(),ne=n("p"),Ln=r("This model was contributed by "),ye=n("a"),An=r("valhalla"),On=r("."),Go=d(),H=n("h3"),se=n("a"),jt=n("span"),u(we.$$.fragment),Dn=d(),Ft=n("span"),Nn=r("Training and Generation"),Bo=d(),A=n("p"),In=r(`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),St=n("code"),Gn=r("[lang_code] X [eos]"),Bn=r(", where "),Lt=n("code"),Un=r("lang_code"),Wn=r(` is source language
...
outputs. Read the documentation from `),ft=n("a"),Es=r("PretrainedConfig"),xs=r(" for more information."),Cs=d(),Xt=n("p"),Ps=r("Example:"),js=d(),u(Ce.$$.fragment),Ro=d(),X=n("h2"),re=n("a"),Rt=n("span"),u(Pe.$$.fragment),Fs=d(),Jt=n("span"),Ss=r("M2M100Tokenizer"),Jo=d(),y=n("div"),u(je.$$.fragment),Ls=d(),Fe=n("p"),As=r("Construct an M2M100 tokenizer. Based on "),Se=n("a"),Os=r("SentencePiece"),Ds=r("."),Ns=d(),Le=n("p"),Is=r("This tokenizer inherits from "),_t=n("a"),Gs=r("PreTrainedTokenizer"),Bs=r(` which contains most of the main methods.
...
special tokens using the tokenizer `),ao=n("code"),ca=r("prepare_for_model"),ha=r(" method."),pa=d(),I=n("div"),u(We.$$.fragment),ma=d(),gt=n("p"),ua=r("Create the token type IDs corresponding to the sequences passed. "),kt=n("a"),fa=r("What are token type IDs?"),_a=d(),ro=n("p"),ga=r("Should be overridden in a subclass if the model has a special way of building those."),ka=d(),io=n("div"),Zo=d(),R=n("h2"),de=n("a"),lo=n("span"),u(He.$$.fragment),Ma=d(),co=n("span"),va=r("M2M100Model"),Yo=d(),S=n("div"),u(Ve.$$.fragment),ba=d(),Ke=n("p"),ya=r(`The bare M2M100 Model outputting raw hidden-states without any specific head on top.
...
general usage and behavior.`),xa=d(),j=n("div"),u(Re.$$.fragment),Ca=d(),J=n("p"),Pa=r("The "),vt=n("a"),ja=r("M2M100Model"),Fa=r(" forward method, overrides the "),ho=n("code"),Sa=r("__call__"),La=r(" special method."),Aa=d(),u(le.$$.fragment),Oa=d(),po=n("p"),Da=r("Example:"),Na=d(),u(Je.$$.fragment),en=d(),Z=n("h2"),ce=n("a"),mo=n("span"),u(Ze.$$.fragment),Ia=d(),uo=n("span"),Ga=r("M2M100ForConditionalGeneration"),tn=d(),L=n("div"),u(Ye.$$.fragment),Ba=d(),et=n("p"),Ua=r(`The M2M100 Model with a language modeling head. Can be used for summarization.
...
model_inputs = tokenizer(text_to_translate, return_tensors=\u2018pt\u2019)`),fr=d(),Co=n("blockquote"),Po=n("blockquote"),at=n("blockquote"),pe=n("h1"),me=n("a"),jo=n("span"),u(rt.$$.fragment),_r=d(),Fo=n("span"),gr=r("translate to French"),kr=d(),So=n("p"),Mr=r(`gen_tokens = model.generate( **model_inputs, forced_bos_token_id=tokenizer.get_lang_id(\u201Cfr\u201D))
print(tokenizer.batch_decode(gen_tokens, skip_special_tokens=True))`),this.h()},l(t){const h=sd('[data-svelte="svelte-1phssyn"]',document.head);m=s(h,"META",{name:!0,content:!0}),h.forEach(o),C=l(t),v=s(t,"H1",{class:!0});var it=a(v);T=s(it,"A",{id:!0,class:!0,href:!0});var Lo=a(T);F=s(Lo,"SPAN",{});var br=a(F);f(z.$$.fragment,br),br.forEach(o),Lo.forEach(o),$=l(it),N=s(it,"SPAN",{});var yr=a(N);$n=i(yr,"M2M100"),yr.forEach(o),it.forEach(o),Ao=l(t),W=s(t,"H2",{class:!0});var nn=a(W);te=s(nn,"A",{id:!0,class:!0,href:!0});var wr=a(te);xt=s(wr,"SPAN",{});var Tr=a(xt);f(ve.$$.fragment,Tr),Tr.forEach(o),wr.forEach(o),En=l(nn),Ct=s(nn,"SPAN",{});var zr=a(Ct);xn=i(zr,"Overview"),zr.forEach(o),nn.forEach(o),Oo=l(t),oe=s(t,"P",{});var sn=a(oe);Cn=i(sn,"The M2M100 model was proposed in "),be=s(sn,"A",{href:!0,rel:!0});var qr=a(be);Pn=i(qr,"Beyond English-Centric Multilingual Machine Translation"),qr.forEach(o),jn=i(sn,` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
Siddharth Goyal, Mandeep Baines, Onur Celebi, Guillaume Wenzek, Vishrav Chaudhary, Naman Goyal, Tom Birch, Vitaliy
Liptchinsky, Sergey Edunov, Edouard Grave, Michael Auli, Armand Joulin.`),sn.forEach(o),Do=l(t),dt=s(t,"P",{});var $r=a(dt);Fn=i($r,"The abstract from the paper is the following:"),$r.forEach(o),No=l(t),lt=s(t,"P",{});var Er=a(lt);Pt=s(Er,"EM",{});var xr=a(Pt);Sn=i(xr,`Existing work in translation demonstrated the potential of massively multilingual machine translation by training a
single model able to translate between any pair of languages. However, much of this work is English-Centric by training
only on data which was translated from or to English. While this is supported by large sources of training data, it
does not reflect translation needs worldwide. In this work, we create a true Many-to-Many multilingual translation
model that can translate directly between any pair of 100 languages. We build and open source a training dataset that
...
to create high quality models. Our focus on non-English-Centric models brings gains of more than 10 BLEU when directly
translating between non-English directions while performing competitively to the best single systems of WMT. We
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),xr.forEach(o),Er.forEach(o),Io=l(t),ne=s(t,"P",{});var an=a(ne);Ln=i(an,"This model was contributed by "),ye=s(an,"A",{href:!0,rel:!0});var Cr=a(ye);An=i(Cr,"valhalla"),Cr.forEach(o),On=i(an,"."),an.forEach(o),Go=l(t),H=s(t,"H3",{class:!0});var rn=a(H);se=s(rn,"A",{id:!0,class:!0,href:!0});var Pr=a(se);jt=s(Pr,"SPAN",{});var jr=a(jt);f(we.$$.fragment,jr),jr.forEach(o),Pr.forEach(o),Dn=l(rn),Ft=s(rn,"SPAN",{});var Fr=a(Ft);Nn=i(Fr,"Training and Generation"),Fr.forEach(o),rn.forEach(o),Bo=l(t),A=s(t,"P",{});var ue=a(A);In=i(ue,`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),St=s(ue,"CODE",{});var Sr=a(St);Gn=i(Sr,"[lang_code] X [eos]"),Sr.forEach(o),Bn=i(ue,", where "),Lt=s(ue,"CODE",{});var Lr=a(Lt);Un=i(Lr,"lang_code"),Lr.forEach(o),Wn=i(ue,` is source language
...
outputs. Read the documentation from `),ft=s(Tt,"A",{href:!0});var oi=a(ft);Es=i(oi,"PretrainedConfig"),oi.forEach(o),xs=i(Tt," for more information."),Tt.forEach(o),Cs=l(B),Xt=s(B,"P",{});var ni=a(Xt);Ps=i(ni,"Example:"),ni.forEach(o),js=l(B),f(Ce.$$.fragment,B),B.forEach(o),Ro=l(t),X=s(t,"H2",{class:!0});var cn=a(X);re=s(cn,"A",{id:!0,class:!0,href:!0});var si=a(re);Rt=s(si,"SPAN",{});var ai=a(Rt);f(Pe.$$.fragment,ai),ai.forEach(o),si.forEach(o),Fs=l(cn),Jt=s(cn,"SPAN",{});var ri=a(Jt);Ss=i(ri,"M2M100Tokenizer"),ri.forEach(o),cn.forEach(o),Jo=l(t),y=s(t,"DIV",{class:!0});var q=a(y);f(je.$$.fragment,q),Ls=l(q),Fe=s(q,"P",{});var hn=a(Fe);As=i(hn,"Construct an M2M100 tokenizer. Based on "),Se=s(hn,"A",{href:!0,rel:!0});var ii=a(Se);Os=i(ii,"SentencePiece"),ii.forEach(o),Ds=i(hn,"."),hn.forEach(o),Ns=l(q),Le=s(q,"P",{});var pn=a(Le);Is=i(pn,"This tokenizer inherits from "),_t=s(pn,"A",{href:!0});var di=a(_t);Gs=i(di,"PreTrainedTokenizer"),di.forEach(o),Bs=i(pn,` which contains most of the main methods.
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),bn.forEach(o),xa=l(_e),j=s(_e,"DIV",{class:!0});var U=a(j);f(Re.$$.fragment,U),Ca=l(U),J=s(U,"P",{});var qt=a(J);Pa=i(qt,"The "),vt=s(qt,"A",{href:!0});var Ti=a(vt);ja=i(Ti,"M2M100Model"),Ti.forEach(o),Fa=i(qt," forward method, overrides the "),ho=s(qt,"CODE",{});var zi=a(ho);Sa=i(zi,"__call__"),zi.forEach(o),La=i(qt," special method."),qt.forEach(o),Aa=l(U),f(le.$$.fragment,U),Oa=l(U),po=s(U,"P",{});var qi=a(po);Da=i(qi,"Example:"),qi.forEach(o),Na=l(U),f(Je.$$.fragment,U),U.forEach(o),_e.forEach(o),en=l(t),Z=s(t,"H2",{class:!0});var yn=a(Z);ce=s(yn,"A",{id:!0,class:!0,href:!0});var $i=a(ce);mo=s($i,"SPAN",{});var Ei=a(mo);f(Ze.$$.fragment,Ei),Ei.forEach(o),$i.forEach(o),Ia=l(yn),uo=s(yn,"SPAN",{});var xi=a(uo);Ga=i(xi,"M2M100ForConditionalGeneration"),xi.forEach(o),yn.forEach(o),tn=l(t),L=s(t,"DIV",{class:!0});var ge=a(L);f(Ye.$$.fragment,ge),Ba=l(ge),et=s(ge,"P",{});var wn=a(et);Ua=i(wn,`The M2M100 Model with a language modeling head. Can be used for summarization.
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Tn.forEach(o),Ra=l(ge),b=s(ge,"DIV",{class:!0});var w=a(b);f(nt.$$.fragment,w),Ja=l(w),Y=s(w,"P",{});var $t=a(Y);Za=i($t,"The "),yt=s($t,"A",{href:!0});var ji=a(yt);Ya=i(ji,"M2M100ForConditionalGeneration"),ji.forEach(o),er=i($t," forward method, overrides the "),fo=s($t,"CODE",{});var Fi=a(fo);tr=i(Fi,"__call__"),Fi.forEach(o),or=i($t," special method."),$t.forEach(o),nr=l(w),f(he.$$.fragment,w),sr=l(w),_o=s(w,"P",{});var Si=a(_o);ar=i(Si,"Example:"),Si.forEach(o),rr=l(w),f(st.$$.fragment,w),ir=l(w),go=s(w,"P",{});var Li=a(go);dr=i(Li,"Translation example::"),Li.forEach(o),lr=l(w),ko=s(w,"BLOCKQUOTE",{});var Ai=a(ko);Mo=s(Ai,"BLOCKQUOTE",{});var Oi=a(Mo);vo=s(Oi,"BLOCKQUOTE",{});var Di=a(vo);bo=s(Di,"P",{});var Ni=a(bo);cr=i(Ni,"from transformers import M2M100Tokenizer, M2M100ForConditionalGeneration"),Ni.forEach(o),Di.forEach(o),Oi.forEach(o),Ai.forEach(o),hr=l(w),yo=s(w,"BLOCKQUOTE",{});var Ii=a(yo);wo=s(Ii,"BLOCKQUOTE",{});var Gi=a(wo);To=s(Gi,"BLOCKQUOTE",{});var Bi=a(To);zo=s(Bi,"P",{});var Ui=a(zo);pr=i(Ui,`model = M2M100ForConditionalGeneration.from_pretrained(\u2018facebook/m2m100_418M\u2019)
