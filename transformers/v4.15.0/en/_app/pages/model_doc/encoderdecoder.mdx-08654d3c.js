import{S as Di,i as ji,s as $i,e as a,k as i,w as u,t,M as qi,c as s,d as o,m as c,a as d,x as g,h as r,b as l,F as e,g as h,y as _,q as v,o as b,B as y}from"../../chunks/vendor-ab4e3193.js";import{T as dd}from"../../chunks/Tip-b5c6375a.js";import{D as O}from"../../chunks/Docstring-b69c0bd4.js";import{C as ze}from"../../chunks/CodeBlock-516df0c5.js";import{I as Gn}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Pi(Q){let m,D,f,w,P;return{c(){m=a("p"),D=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=t("Module"),P=t(`
...
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);D=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,D),e(m,f),e(f,w),e(m,P)},d(k){k&&o(m)}}}function Ai(Q){let m,D,f,w,P,k,T,F,Mt,Un,me,zt,wo,Dt,jt,Vn,he,$t,De,qt,Pt,Hn,fe,Ft,Eo,Ct,At,Yn,W,St,xo,Nt,It,je,Lt,Bt,Jn,R,Ot,Ko,Wt,Rt,Qo,Gt,Ut,Zn,$e,Kn,G,Vt,qe,Ht,Yt,Pe,Jt,Zt,Qn,X,ue,Xo,Fe,Kt,en,Qt,Xn,z,Ce,Xt,ge,Mo,er,or,zo,nr,tr,rr,ee,ar,Do,sr,dr,jo,ir,cr,lr,on,pr,mr,Ae,hr,_e,Se,fr,Ne,ur,$o,gr,_r,vr,ve,Ie,br,oe,yr,nn,kr,Tr,tn,wr,Er,et,ne,be,rn,Le,xr,an,Mr,ot,E,Be,zr,te,Dr,sn,jr,$r,dn,qr,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,cn,Ir,Lr,Re,Br,qo,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Yr,Jr,ln,Zr,Kr,pn,Qr,Xr,ea,C,Ve,oa,re,na,Fo,ta,ra,mn,aa,sa,da,ye,ia,hn,ca,la,He,pa,A,Ye,ma,fn,ha,fa,ae,ua,un,ga,_a,gn,va,ba,ya,_n,ka,Ta,Je,nt,se,ke,vn,Ze,wa,bn,Ea,tt,x,Ke,xa,de,Ma,yn,za,Da,kn,ja,$a,qa,Qe,Pa,Xe,Fa,Ca,Aa,Tn,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,no,Ra,Ga,Ua,V,wn,Va,Ha,En,Ya,Ja,xn,Za,Ka,Qa,S,to,Xa,ie,es,Ao,os,ns,Mn,ts,rs,as,Te,ss,zn,ds,is,ro,cs,L,ao,ls,Dn,ps,ms,jn,hs,fs,so,rt,ce,we,$n,io,us,qn,gs,at,M,co,_s,le,vs,Pn,bs,ys,Fn,ks,Ts,ws,lo,Es,po,xs,Ms,zs,Cn,Ds,js,mo,$s,So,qs,Ps,Fs,ho,Cs,fo,As,Ss,Ns,H,No,Is,Ls,An,Bs,Os,Sn,Ws,Rs,Gs,N,uo,Us,pe,Vs,Io,Hs,Ys,Nn,Js,Zs,Ks,Ee,Qs,In,Xs,ed,go,od,B,_o,nd,Ln,td,rd,Bn,ad,sd,vo,st;return k=new Gn({}),$e=new ze({props:{code:`# a workaround to load from pytorch checkpoint
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),Je=new ze({props:{code:`from transformers import EncoderDecoderModel
...
any other models (see the examples for more information).`),Yn=i(),W=a("p"),St=t("An application of this architecture could be to leverage two pretrained "),xo=a("a"),Nt=t("BertModel"),It=t(` as the encoder
and decoder for a summarization model as was shown in: `),je=a("a"),Lt=t("Text Summarization with Pretrained Encoders"),Bt=t(" by Yang Liu and Mirella Lapata."),Jn=i(),R=a("p"),Ot=t("The "),Ko=a("code"),Wt=t("from_pretrained()"),Rt=t(` currently doesn\u2019t support initializing the model from a
...
were contributed by `),Pe=a("a"),Jt=t("ydshieh"),Zt=t("."),Qn=i(),X=a("h2"),ue=a("a"),Xo=a("span"),u(Fe.$$.fragment),Kt=i(),en=a("span"),Qt=t("EncoderDecoderConfig"),Xn=i(),z=a("div"),u(Ce.$$.fragment),Xt=i(),ge=a("p"),Mo=a("a"),er=t("EncoderDecoderConfig"),or=t(` is the configuration class to store the configuration of a
...
general usage and behavior.`),Hr=i(),U=a("p"),Po=a("a"),Yr=t("EncoderDecoderModel"),Jr=t(` is a generic model class that will be instantiated as a transformer
...
:meth`),pn=a("em"),Qr=t("~transformers.AutoModelForCausalLM.from_pretrained"),Xr=t(" class method for the decoder."),ea=i(),C=a("div"),u(Ve.$$.fragment),oa=i(),re=a("p"),na=t("The "),Fo=a("a"),ta=t("EncoderDecoderModel"),ra=t(" forward method, overrides the "),mn=a("code"),aa=t("__call__"),sa=t(" special method."),da=i(),u(ye.$$.fragment),ia=i(),hn=a("p"),ca=t("Examples:"),la=i(),u(He.$$.fragment),pa=i(),A=a("div"),u(Ye.$$.fragment),ma=i(),fn=a("p"),ha=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
train the model, you need to first set it back in training mode with `),gn=a("code"),va=t("model.train()"),ba=t("."),ya=i(),_n=a("p"),ka=t("Example:"),Ta=i(),u(Je.$$.fragment),nt=i(),se=a("h2"),ke=a("a"),vn=a("span"),u(Ze.$$.fragment),wa=i(),bn=a("span"),Ea=t("TFEncoderDecoderModel"),tt=i(),x=a("div"),u(Ke.$$.fragment),xa=i(),de=a("p"),Ma=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
architecture with one of the base model classes of the library as encoder and another one as decoder when created
with the :meth`),En=a("em"),Ya=t("~transformers.TFAutoModel.from_pretrained"),Ja=t(` class method for the encoder and
...
any other models (see the examples for more information).`),ct.forEach(o),Yn=c(n),W=s(n,"P",{});var Lo=d(W);St=r(Lo,"An application of this architecture could be to leverage two pretrained "),xo=s(Lo,"A",{href:!0});var md=d(xo);Nt=r(md,"BertModel"),md.forEach(o),It=r(Lo,` as the encoder
and decoder for a summarization model as was shown in: `),je=s(Lo,"A",{href:!0,rel:!0});var hd=d(je);Lt=r(hd,"Text Summarization with Pretrained Encoders"),hd.forEach(o),Bt=r(Lo," by Yang Liu and Mirella Lapata."),Lo.forEach(o),Jn=c(n),R=s(n,"P",{});var Bo=d(R);Ot=r(Bo,"The "),Ko=s(Bo,"CODE",{});var fd=d(Ko);Wt=r(fd,"from_pretrained()"),fd.forEach(o),Rt=r(Bo,` currently doesn\u2019t support initializing the model from a
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Bo.forEach(o),Zn=c(n),g($e.$$.fragment,n),Kn=c(n),G=s(n,"P",{});var Oo=d(G);Vt=r(Oo,"This model was contributed by "),qe=s(Oo,"A",{href:!0,rel:!0});var gd=d(qe);Ht=r(gd,"thomwolf"),gd.forEach(o),Yt=r(Oo,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),Pe=s(Oo,"A",{href:!0,rel:!0});var _d=d(Pe);Jt=r(_d,"ydshieh"),_d.forEach(o),Zt=r(Oo,"."),Oo.forEach(o),Qn=c(n),X=s(n,"H2",{class:!0});var lt=d(X);ue=s(lt,"A",{id:!0,class:!0,href:!0});var vd=d(ue);Xo=s(vd,"SPAN",{});var bd=d(Xo);g(Fe.$$.fragment,bd),bd.forEach(o),vd.forEach(o),Kt=c(lt),en=s(lt,"SPAN",{});var yd=d(en);Qt=r(yd,"EncoderDecoderConfig"),yd.forEach(o),lt.forEach(o),Xn=c(n),z=s(n,"DIV",{class:!0});var I=d(z);g(Ce.$$.fragment,I),Xt=c(I),ge=s(I,"P",{});var Rn=d(ge);Mo=s(Rn,"A",{href:!0});var kd=d(Mo);er=r(kd,"EncoderDecoderConfig"),kd.forEach(o),or=r(Rn,` is the configuration class to store the configuration of a
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),_t.forEach(o),Hr=c(j),U=s(j,"P",{});var yo=d(U);Po=s(yo,"A",{href:!0});var Id=d(Po);Yr=r(Id,"EncoderDecoderModel"),Id.forEach(o),Jr=r(yo,` is a generic model class that will be instantiated as a transformer
architecture with one of the base model classes of the library as encoder and another one as decoder when created
...
:meth`),pn=s(yo,"EM",{});var Bd=d(pn);Qr=r(Bd,"~transformers.AutoModelForCausalLM.from_pretrained"),Bd.forEach(o),Xr=r(yo," class method for the decoder."),yo.forEach(o),ea=c(j),C=s(j,"DIV",{class:!0});var Y=d(C);g(Ve.$$.fragment,Y),oa=c(Y),re=s(Y,"P",{});var Uo=d(re);na=r(Uo,"The "),Fo=s(Uo,"A",{href:!0});var Od=d(Fo);ta=r(Od,"EncoderDecoderModel"),Od.forEach(o),ra=r(Uo," forward method, overrides the "),mn=s(Uo,"CODE",{});var Wd=d(mn);aa=r(Wd,"__call__"),Wd.forEach(o),sa=r(Uo," special method."),Uo.forEach(o),da=c(Y),g(ye.$$.fragment,Y),ia=c(Y),hn=s(Y,"P",{});var Rd=d(hn);ca=r(Rd,"Examples:"),Rd.forEach(o),la=c(Y),g(He.$$.fragment,Y),Y.forEach(o),pa=c(j),A=s(j,"DIV",{class:!0});var J=d(A);g(Ye.$$.fragment,J),ma=c(J),fn=s(J,"P",{});var Gd=d(fn);ha=r(Gd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Gd.forEach(o),fa=c(J),ae=s(J,"P",{});var Vo=d(ae);ua=r(Vo,"The model is set in evaluation mode by default using "),un=s(Vo,"CODE",{});var Ud=d(un);ga=r(Ud,"model.eval()"),Ud.forEach(o),_a=r(Vo,` (Dropout modules are deactivated). To
train the model, you need to first set it back in training mode with `),gn=s(Vo,"CODE",{});var Vd=d(gn);va=r(Vd,"model.train()"),Vd.forEach(o),ba=r(Vo,"."),Vo.forEach(o),ya=c(J),_n=s(J,"P",{});var Hd=d(_n);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=c(J),g(Je.$$.fragment,J),J.forEach(o),j.forEach(o),nt=c(n),se=s(n,"H2",{class:!0});var vt=d(se);ke=s(vt,"A",{id:!0,class:!0,href:!0});var Yd=d(ke);vn=s(Yd,"SPAN",{});var Jd=d(vn);g(Ze.$$.fragment,Jd),Jd.forEach(o),Yd.forEach(o),wa=c(vt),bn=s(vt,"SPAN",{});var Zd=d(bn);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),vt.forEach(o),tt=c(n),x=s(n,"DIV",{class:!0});var $=d(x);g(Ke.$$.fragment,$),xa=c($),de=s($,"P",{});var Ho=d(de);Ma=r(Ho,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
architecture with one of the base model classes of the library as encoder and another one as decoder when created
with the :meth`),En=s(ko,"EM",{});var ri=d(En);Ya=r(ri,"~transformers.TFAutoModel.from_pretrained"),ri.forEach(o),Ja=r(ko,` class method for the encoder and
:meth`),xn=s(ko,"EM",{});var ai=d(xn);Za=r(ai,"~transformers.TFAutoModelForCausalLM.from_pretrained"),ai.forEach(o),Ka=r(ko," class method for the decoder."),ko.forEach(o),Qa=c($),S=s($,"DIV",{class:!0});var Z=d(S);g(to.$$.fragment,Z),Xa=c(Z),ie=s(Z,"P",{});var Yo=d(ie);es=r(Yo,"The "),Ao=s(Yo,"A",{href:!0});var si=d(Ao);os=r(si,"TFEncoderDecoderModel"),si.forEach(o),ns=r(Yo," forward method, overrides the "),Mn=s(Yo,"CODE",{});var di=d(Mn);ts=r(di,"__call__"),di.forEach(o),rs=r(Yo," special method."),Yo.forEach(o),as=c(Z),g(Te.$$.fragment,Z),ss=c(Z),zn=s(Z,"P",{});var ii=d(zn);ds=r(ii,"Examples:"),ii.forEach(o),is=c(Z),g(ro.$$.fragment,Z),Z.forEach(o),cs=c($),L=s($,"DIV",{class:!0});var xe=d(L);g(ao.$$.fragment,xe),ls=c(xe),Dn=s(xe,"P",{});var ci=d(Dn);ps=r(ci,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ci.forEach(o),ms=c(xe),jn=s(xe,"P",{});var li=d(jn);hs=r(li,"Example:"),li.forEach(o),fs=c(xe),g(so.$$.fragment,xe),xe.forEach(o),$.forEach(o),rt=c(n),ce=s(n,"H2",{class:!0});var Tt=d(ce);we=s(Tt,"A",{id:!0,class:!0,href:!0});var pi=d(we);$n=s(pi,"SPAN",{});var mi=d($n);g(io.$$.fragment,mi),mi.forEach(o),pi.forEach(o),us=c(Tt),qn=s(Tt,"SPAN",{});var hi=d(qn);gs=r(hi,"FlaxEncoderDecoderModel"),hi.forEach(o),Tt.forEach(o),at=c(n),M=s(n,"DIV",{class:!0});var q=d(M);g(co.$$.fragment,q),_s=c(q),le=s(q,"P",{});var Jo=d(le);vs=r(Jo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Pn=s(Jo,"CODE",{});var fi=d(Pn);bs=r(fi,"from_pretrained()"),fi.forEach(o),ys=r(Jo,` function and the decoder is loaded via
`),Fn=s(Jo,"CODE",{});var ui=d(Fn);ks=r(ui,"from_pretrained()"),ui.forEach(o),Ts=r(Jo,` function. Cross-attention layers are automatically added
to the decoder and should be fine-tuned on a downstream generative task, like summarization.`),Jo.forEach(o),ws=c(q),lo=s(q,"P",{});var wt=d(lo);Es=r(wt,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
