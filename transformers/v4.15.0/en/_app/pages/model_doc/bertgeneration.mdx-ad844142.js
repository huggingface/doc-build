import{S as la,i as ca,s as ha,e as s,k as l,w as v,t as n,M as pa,c as a,d as o,m as c,a as i,x as b,h as r,b as d,F as e,g as p,y as k,q as T,o as w,B as y}from"../../chunks/vendor-ab4e3193.js";import{T as da}from"../../chunks/Tip-b5c6375a.js";import{D as gt}from"../../chunks/Docstring-b69c0bd4.js";import{C as Vt}from"../../chunks/CodeBlock-516df0c5.js";import{I as _t}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function ua(ie){let u,q,f,g,D;return{c(){u=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),g=n("Module"),D=n(`
...
Generation Tasks`),rr=n(" by Sascha Rothe, Shashi Narayan, and Aliaksei Severyn."),sr=l(),B=s("p"),ar=n("To behave as an decoder the model needs to be initialized with the "),Dt=s("code"),ir=n("is_decoder"),dr=n(` argument of the configuration
set to `),jt=s("code"),lr=n("True"),cr=n(". To be used in a Seq2Seq model, the model needs to initialized with both "),St=s("code"),hr=n("is_decoder"),pr=n(`
...
Generation Tasks`),Rs.forEach(o),rr=r(ut," by Sascha Rothe, Shashi Narayan, and Aliaksei Severyn."),ut.forEach(o),sr=c(z),B=a(z,"P",{});var C=i(B);ar=r(C,"To behave as an decoder the model needs to be initialized with the "),Dt=a(C,"CODE",{});var Ws=i(Dt);ir=r(Ws,"is_decoder"),Ws.forEach(o),dr=r(C,` argument of the configuration
set to `),jt=a(C,"CODE",{});var Us=i(jt);lr=r(Us,"True"),Us.forEach(o),cr=r(C,". To be used in a Seq2Seq model, the model needs to initialized with both "),St=a(C,"CODE",{});var Hs=i(St);hr=r(Hs,"is_decoder"),Hs.forEach(o),pr=r(C,`
argument and `),At=a(C,"CODE",{});var Vs=i(At);ur=r(Vs,"add_cross_attention"),Vs.forEach(o),fr=r(C," set to "),Mt=a(C,"CODE",{});var Js=i(Mt);mr=r(Js,"True"),Js.forEach(o),gr=r(C,"; an "),Nt=a(C,"CODE",{});var Ks=i(Nt);_r=r(Ks,"encoder_hidden_states"),Ks.forEach(o),vr=r(C,` is then expected as an
input to the forward pass.`),C.forEach(o),br=c(z),x=a(z,"DIV",{class:!0});var F=i(x);b(De.$$.fragment,F),kr=c(F),K=a(F,"P",{});var ft=i(K);Tr=r(ft,"The "),it=a(ft,"A",{href:!0});var Qs=i(it);wr=r(Qs,"BertGenerationEncoder"),Qs.forEach(o),yr=r(ft," forward method, overrides the "),Lt=a(ft,"CODE",{});var Xs=i(Lt);Er=r(Xs,"__call__"),Xs.forEach(o),Br=r(ft," special method."),ft.forEach(o),zr=c(F),b(ne.$$.fragment,F),$r=c(F),Ft=a(F,"P",{});var Ys=i(Ft);Gr=r(Ys,"Example:"),Ys.forEach(o),qr=c(F),b(je.$$.fragment,F),F.forEach(o),z.forEach(o),uo=c(t),Q=a(t,"H2",{class:!0});var qo=i(Q);re=a(qo,"A",{id:!0,class:!0,href:!0});var Zs=i(re);Ot=a(Zs,"SPAN",{});var ea=i(Ot);b(Se.$$.fragment,ea),ea.forEach(o),Zs.forEach(o),xr=c(qo),It=a(qo,"SPAN",{});var ta=i(It);Pr=r(ta,"BertGenerationDecoder"),ta.forEach(o),qo.forEach(o),fo=c(t),G=a(t,"DIV",{class:!0});var O=i(G);b(Ae.$$.fragment,O),Cr=c(O),Me=a(O,"P",{});var xo=i(Me);Dr=r(xo,"BertGeneration Model with a "),Rt=a(xo,"CODE",{});var oa=i(Rt);jr=r(oa,"language modeling"),oa.forEach(o),Sr=r(xo," head on top for CLM fine-tuning."),xo.forEach(o),Ar=c(O),Ne=a(O,"P",{});var Po=i(Ne);Mr=r(Po,"This model inherits from "),dt=a(Po,"A",{href:!0});var na=i(dt);Nr=r(na,"PreTrainedModel"),na.forEach(o),Lr=r(Po,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
