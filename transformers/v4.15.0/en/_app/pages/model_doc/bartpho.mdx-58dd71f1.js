import{S as Uo,i as Go,s as Ho,e as s,k as p,w as v,t as r,M as Ko,c as n,d as o,m as c,a,x as T,h as i,b as d,F as t,g as h,y as w,L as Qo,q as y,o as q,B}from"../../chunks/vendor-ab4e3193.js";import{D as Pe}from"../../chunks/Docstring-b69c0bd4.js";import{C as Wo}from"../../chunks/CodeBlock-516df0c5.js";import{I as ho}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Jo(nt){let _,ee,f,g,ge,S,at,_e,rt,je,z,x,ke,M,it,be,lt,Le,R,pt,I,ct,dt,De,te,ht,Se,oe,ve,mt,Me,se,ut,Ie,N,Ne,ne,ft,Ce,ae,C,gt,re,_t,kt,Oe,O,Fe,ie,Te,bt,Ve,k,vt,F,Tt,wt,V,yt,qt,Xe,A,P,we,X,Bt,ye,zt,We,m,W,At,$,$t,le,Et,xt,U,Rt,Pt,jt,G,Lt,pe,Dt,St,Mt,E,It,qe,Nt,Ct,Be,Ot,Ft,Vt,b,H,Xt,ze,Wt,Ut,K,ce,Gt,Ae,Ht,Kt,de,Qt,$e,Jt,Yt,j,Q,Zt,Ee,eo,to,L,J,oo,xe,so,no,D,Y,ao,Z,ro,Re,io,lo,Ue;return S=new ho({}),M=new ho({}),N=new Wo({props:{code:`import torch
...
`}}),Q=new Pe({props:{name:"convert_tokens_to_string",anchor:"transformers.BartphoTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/bartpho/tokenization_bartpho.py#L285"}}),J=new Pe({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/bartpho/tokenization_bartpho.py#L237",parametersDescription:[{anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
For example:`),Oe=p(),v(O.$$.fragment),Fe=p(),ie=s("ul"),Te=s("li"),bt=r(`This implementation is only for tokenization: \u201Cmonolingual_vocab_file\u201D consists of Vietnamese-specialized types
extracted from the pre-trained SentencePiece model \u201Cvocab_file\u201D that is available from the multilingual XLM-RoBERTa.
Other languages, if employing this pre-trained multilingual SentencePiece model \u201Cvocab_file\u201D for subword
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),Ve=p(),k=s("p"),vt=r("This model was contributed by "),F=s("a"),Tt=r("dqnguyen"),wt=r(". The original code can be found "),V=s("a"),yt=r("here"),qt=r("."),Xe=p(),A=s("h2"),P=s("a"),we=s("span"),v(X.$$.fragment),Bt=p(),ye=s("span"),zt=r("BartphoTokenizer"),We=p(),m=s("div"),v(W.$$.fragment),At=p(),$=s("p"),$t=r("Adapted from "),le=s("a"),Et=r("XLMRobertaTokenizer"),xt=r(". Based on "),U=s("a"),Rt=r("SentencePiece"),Pt=r("."),jt=p(),G=s("p"),Lt=r("This tokenizer inherits from "),pe=s("a"),Dt=r("PreTrainedTokenizer"),St=r(` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),Mt=p(),E=s("p"),It=r(`Attributes:
sp_model (`),qe=s("code"),Nt=r("SentencePieceProcessor"),Ct=r(`):
The `),Be=s("em"),Ot=r("SentencePiece"),Ft=r(" processor that is used for every conversion (string, tokens and IDs)."),Vt=p(),b=s("div"),v(H.$$.fragment),Xt=p(),ze=s("p"),Wt=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An BARTPho sequence has the following format:`),Ut=p(),K=s("ul"),ce=s("li"),Gt=r("single sequence: "),Ae=s("code"),Ht=r("<s> X </s>"),Kt=p(),de=s("li"),Qt=r("pair of sequences: "),$e=s("code"),Jt=r("<s> A </s></s> B </s>"),Yt=p(),j=s("div"),v(Q.$$.fragment),Zt=p(),Ee=s("p"),eo=r("Converts a sequence of tokens (strings for sub-words) in a single string."),to=p(),L=s("div"),v(J.$$.fragment),oo=p(),xe=s("p"),so=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
...
on a downstream task of Vietnamese text summarization show that in both automatic and human evaluations, our BARTpho
outperforms the strong baseline mBART and improves the state-of-the-art. We release BARTpho to facilitate future
research and applications of generative Vietnamese NLP tasks.`),wo.forEach(o),To.forEach(o),Me=c(e),se=n(e,"P",{});var yo=a(se);ut=i(yo,"Example of use:"),yo.forEach(o),Ie=c(e),T(N.$$.fragment,e),Ne=c(e),ne=n(e,"P",{});var qo=a(ne);ft=i(qo,"Tips:"),qo.forEach(o),Ce=c(e),ae=n(e,"UL",{});var Bo=a(ae);C=n(Bo,"LI",{});var Qe=a(C);gt=i(Qe,`Following mBART, BARTpho uses the \u201Clarge\u201D architecture of BART with an additional layer-normalization layer on top of
both the encoder and decoder. Thus, usage examples in the `),re=n(Qe,"A",{href:!0});var zo=a(re);_t=i(zo,"documentation of BART"),zo.forEach(o),kt=i(Qe,`, when adapting to use
with BARTpho, should be adjusted by replacing the BART-specialized classes with the mBART-specialized counterparts.
For example:`),Qe.forEach(o),Bo.forEach(o),Oe=c(e),T(O.$$.fragment,e),Fe=c(e),ie=n(e,"UL",{});var Ao=a(ie);Te=n(Ao,"LI",{});var $o=a(Te);bt=i($o,`This implementation is only for tokenization: \u201Cmonolingual_vocab_file\u201D consists of Vietnamese-specialized types
extracted from the pre-trained SentencePiece model \u201Cvocab_file\u201D that is available from the multilingual XLM-RoBERTa.
Other languages, if employing this pre-trained multilingual SentencePiece model \u201Cvocab_file\u201D for subword
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),$o.forEach(o),Ao.forEach(o),Ve=c(e),k=n(e,"P",{});var he=a(k);vt=i(he,"This model was contributed by "),F=n(he,"A",{href:!0,rel:!0});var Eo=a(F);Tt=i(Eo,"dqnguyen"),Eo.forEach(o),wt=i(he,". The original code can be found "),V=n(he,"A",{href:!0,rel:!0});var xo=a(V);yt=i(xo,"here"),xo.forEach(o),qt=i(he,"."),he.forEach(o),Xe=c(e),A=n(e,"H2",{class:!0});var Je=a(A);P=n(Je,"A",{id:!0,class:!0,href:!0});var Ro=a(P);we=n(Ro,"SPAN",{});var Po=a(we);T(X.$$.fragment,Po),Po.forEach(o),Ro.forEach(o),Bt=c(Je),ye=n(Je,"SPAN",{});var jo=a(ye);zt=i(jo,"BartphoTokenizer"),jo.forEach(o),Je.forEach(o),We=c(e),m=n(e,"DIV",{class:!0});var u=a(m);T(W.$$.fragment,u),At=c(u),$=n(u,"P",{});var me=a($);$t=i(me,"Adapted from "),le=n(me,"A",{href:!0});var Lo=a(le);Et=i(Lo,"XLMRobertaTokenizer"),Lo.forEach(o),xt=i(me,". Based on "),U=n(me,"A",{href:!0,rel:!0});var Do=a(U);Rt=i(Do,"SentencePiece"),Do.forEach(o),Pt=i(me,"."),me.forEach(o),jt=c(u),G=n(u,"P",{});var Ye=a(G);Lt=i(Ye,"This tokenizer inherits from "),pe=n(Ye,"A",{href:!0});var So=a(pe);Dt=i(So,"PreTrainedTokenizer"),So.forEach(o),St=i(Ye,` which contains most of the main methods.
...
The `),Be=n(ue,"EM",{});var Io=a(Be);Ot=i(Io,"SentencePiece"),Io.forEach(o),Ft=i(ue," processor that is used for every conversion (string, tokens and IDs)."),ue.forEach(o),Vt=c(u),b=n(u,"DIV",{class:!0});var fe=a(b);T(H.$$.fragment,fe),Xt=c(fe),ze=n(fe,"P",{});var No=a(ze);Wt=i(No,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An BARTPho sequence has the following format:`),No.forEach(o),Ut=c(fe),K=n(fe,"UL",{});var Ze=a(K);ce=n(Ze,"LI",{});var po=a(ce);Gt=i(po,"single sequence: "),Ae=n(po,"CODE",{});var Co=a(Ae);Ht=i(Co,"<s> X </s>"),Co.forEach(o),po.forEach(o),Kt=c(Ze),de=n(Ze,"LI",{});var co=a(de);Qt=i(co,"pair of sequences: "),$e=n(co,"CODE",{});var Oo=a($e);Jt=i(Oo,"<s> A </s></s> B </s>"),Oo.forEach(o),co.forEach(o),Ze.forEach(o),fe.forEach(o),Yt=c(u),j=n(u,"DIV",{class:!0});var et=a(j);T(Q.$$.fragment,et),Zt=c(et),Ee=n(et,"P",{});var Fo=a(Ee);eo=i(Fo,"Converts a sequence of tokens (strings for sub-words) in a single string."),Fo.forEach(o),et.forEach(o),to=c(u),L=n(u,"DIV",{class:!0});var tt=a(L);T(J.$$.fragment,tt),oo=c(tt),xe=n(tt,"P",{});var Vo=a(xe);so=i(Vo,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
make use of token type ids, therefore a list of zeros is returned.`),Vo.forEach(o),tt.forEach(o),no=c(u),D=n(u,"DIV",{class:!0});var ot=a(D);T(Y.$$.fragment,ot),ao=c(ot),Z=n(ot,"P",{});var st=a(Z);ro=i(st,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Re=n(st,"CODE",{});var Xo=a(Re);io=i(Xo,"prepare_for_model"),Xo.forEach(o),lo=i(st," method."),st.forEach(o),ot.forEach(o),u.forEach(o),this.h()},h(){d(_,"name","hf:doc:metadata"),d(_,"content",JSON.stringify(Yo)),d(g,"id","bartpho"),d(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(g,"href","#bartpho"),d(f,"class","relative group"),d(x,"id","overview"),d(x,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(x,"href","#overview"),d(z,"class","relative group"),d(I,"href","https://arxiv.org/abs/2109.09701"),d(I,"rel","nofollow"),d(re,"href","bart"),d(F,"href","https://huggingface.co/dqnguyen"),d(F,"rel","nofollow"),d(V,"href","https://github.com/VinAIResearch/BARTpho"),d(V,"rel","nofollow"),d(P,"id","transformers.BartphoTokenizer"),d(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(P,"href","#transformers.BartphoTokenizer"),d(A,"class","relative group"),d(le,"href","/docs/transformers/v4.15.0/en/model_doc/xlmroberta#transformers.XLMRobertaTokenizer"),d(U,"href","https://github.com/google/sentencepiece"),d(U,"rel","nofollow"),d(pe,"href","/docs/transformers/v4.15.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d(b,"class","docstring"),d(j,"class","docstring"),d(L,"class","docstring"),d(D,"class","docstring"),d(m,"class","docstring")},m(e,l){t(document.head,_),h(e,ee,l),h(e,f,l),t(f,g),t(g,ge),w(S,ge,null),t(f,at),t(f,_e),t(_e,rt),h(e,je,l),h(e,z,l),t(z,x),t(x,ke),w(M,ke,null),t(z,it),t(z,be),t(be,lt),h(e,Le,l),h(e,R,l),t(R,pt),t(R,I),t(I,ct),t(R,dt),h(e,De,l),h(e,te,l),t(te,ht),h(e,Se,l),h(e,oe,l),t(oe,ve),t(ve,mt),h(e,Me,l),h(e,se,l),t(se,ut),h(e,Ie,l),w(N,e,l),h(e,Ne,l),h(e,ne,l),t(ne,ft),h(e,Ce,l),h(e,ae,l),t(ae,C),t(C,gt),t(C,re),t(re,_t),t(C,kt),h(e,Oe,l),w(O,e,l),h(e,Fe,l),h(e,ie,l),t(ie,Te),t(Te,bt),h(e,Ve,l),h(e,k,l),t(k,vt),t(k,F),t(F,Tt),t(k,wt),t(k,V),t(V,yt),t(k,qt),h(e,Xe,l),h(e,A,l),t(A,P),t(P,we),w(X,we,null),t(A,Bt),t(A,ye),t(ye,zt),h(e,We,l),h(e,m,l),w(W,m,null),t(m,At),t(m,$),t($,$t),t($,le),t(le,Et),t($,xt),t($,U),t(U,Rt),t($,Pt),t(m,jt),t(m,G),t(G,Lt),t(G,pe),t(pe,Dt),t(G,St),t(m,Mt),t(m,E),t(E,It),t(E,qe),t(qe,Nt),t(E,Ct),t(E,Be),t(Be,Ot),t(E,Ft),t(m,Vt),t(m,b),w(H,b,null),t(b,Xt),t(b,ze),t(ze,Wt),t(b,Ut),t(b,K),t(K,ce),t(ce,Gt),t(ce,Ae),t(Ae,Ht),t(K,Kt),t(K,de),t(de,Qt),t(de,$e),t($e,Jt),t(m,Yt),t(m,j),w(Q,j,null),t(j,Zt),t(j,Ee),t(Ee,eo),t(m,to),t(m,L),w(J,L,null),t(L,oo),t(L,xe),t(xe,so),t(m,no),t(m,D),w(Y,D,null),t(D,ao),t(D,Z),t(Z,ro),t(Z,Re),t(Re,io),t(Z,lo),Ue=!0},p:Qo,i(e){Ue||(y(S.$$.fragment,e),y(M.$$.fragment,e),y(N.$$.fragment,e),y(O.$$.fragment,e),y(X.$$.fragment,e),y(W.$$.fragment,e),y(H.$$.fragment,e),y(Q.$$.fragment,e),y(J.$$.fragment,e),y(Y.$$.fragment,e),Ue=!0)},o(e){q(S.$$.fragment,e),q(M.$$.fragment,e),q(N.$$.fragment,e),q(O.$$.fragment,e),q(X.$$.fragment,e),q(W.$$.fragment,e),q(H.$$.fragment,e),q(Q.$$.fragment,e),q(J.$$.fragment,e),q(Y.$$.fragment,e),Ue=!1},d(e){o(_),e&&o(ee),e&&o(f),B(S),e&&o(je),e&&o(z),B(M),e&&o(Le),e&&o(R),e&&o(De),e&&o(te),e&&o(Se),e&&o(oe),e&&o(Me),e&&o(se),e&&o(Ie),B(N,e),e&&o(Ne),e&&o(ne),e&&o(Ce),e&&o(ae),e&&o(Oe),B(O,e),e&&o(Fe),e&&o(ie),e&&o(Ve),e&&o(k),e&&o(Xe),e&&o(A),B(X),e&&o(We),e&&o(m),B(W),B(H),B(Q),B(J),B(Y)}}}const Yo={local:"bartpho",sections:[{local:"overview",title:"Overview"},{local:"transformers.BartphoTokenizer",title:"BartphoTokenizer"}],title:"BARTpho"};function Zo(nt,_,ee){let{fw:f}=_;return nt.$$set=g=>{"fw"in g&&ee(0,f=g.fw)},[f]}class as extends Uo{constructor(_){super();Go(this,_,Zo,Jo,Ho,{fw:0})}}export{as as default,Yo as metadata};
