import{S as vs,i as ws,s as bs,e as n,k as d,w as v,t as r,M as ys,c as a,d as o,m as c,a as s,x as w,h as i,b as l,F as e,g as f,y as b,q as y,o as E,B as S}from"../../chunks/vendor-ab4e3193.js";import{T as Ea}from"../../chunks/Tip-b5c6375a.js";import{D as Ue}from"../../chunks/Docstring-b69c0bd4.js";import{C as uo}from"../../chunks/CodeBlock-516df0c5.js";import{I as pt}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Es(K){let m,W,h,_,D;return{c(){m=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),D=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=a(u,"P",{});var g=s(m);W=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(g,"CODE",{});var $=s(h);_=i($,"Module"),$.forEach(o),D=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){f(u,m,g),e(m,W),e(m,h),e(h,_),e(m,D)},d(u){u&&o(m)}}}function Ss(K){let m,W,h,_,D;return{c(){m=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),D=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=a(u,"P",{});var g=s(m);W=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(g,"CODE",{});var $=s(h);_=i($,"Module"),$.forEach(o),D=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){f(u,m,g),e(m,W),e(m,h),e(h,_),e(m,D)},d(u){u&&o(m)}}}function Ws(K){let m,W,h,_,D;return{c(){m=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),D=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){m=a(u,"P",{});var g=s(m);W=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(g,"CODE",{});var $=s(h);_=i($,"Module"),$.forEach(o),D=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
time, SEW reduces word error rate by 25-50% across different model sizes.`),Nt=d(),Be=n("p"),Wo=r("Tips:"),Ot=d(),te=n("ul"),ut=n("li"),Do=r("SEW-D is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),Co=d(),me=n("li"),ko=r(`SEWDForCTC is fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
using `),Qe=n("a"),To=r("Wav2Vec2CTCTokenizer"),xo=r("."),Kt=d(),oe=n("p"),$o=r("This model was contributed by "),fe=n("a"),qo=r("anton-l"),jo=r("."),Lt=d(),I=n("h2"),ne=n("a"),gt=n("span"),v(he.$$.fragment),Po=d(),_t=n("span"),Fo=r("SEWDConfig"),It=d(),k=n("div"),v(ue.$$.fragment),Mo=d(),H=n("p"),zo=r("This is the configuration class to store the configuration of a "),Ye=n("a"),Ao=r("SEWDModel"),Vo=r(`. It is used to
instantiate a SEW-D model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the SEW-D `),ge=n("a"),No=r("asapp/sew-d-tiny-100k"),Oo=r(" architecture."),Ko=d(),U=n("p"),Lo=r("Configuration objects inherit from "),Ge=n("a"),Io=r("PretrainedConfig"),Ho=r(` and can be used to control the model
...
methods the library implements for all its model (such as downloading or saving etc.).`),ia=d(),Oe=n("p"),la=r("This model is a PyTorch "),Ke=n("a"),da=r("torch.nn.Module"),ca=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
