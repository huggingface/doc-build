...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Jp=l(),Wn=n("p"),Xp=a("This model is also a PyTorch "),Qn=n("a"),Gp=a("torch.nn.Module"),Yp=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
embeddings, pruning heads etc.)`),vh=l(),Kn=n("p"),kh=a("This model is also a "),Jn=n("a"),Th=a("tf.keras.Model"),Mh=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),bh=l(),M(bo.$$.fragment),wh=l(),Re=n("div"),M(Xn.$$.fragment),Ph=l(),Ht=n("p"),Nh=a("The "),nr=n("a"),$h=a("TFMPNetModel"),yh=a(" forward method, overrides the "),Na=n("code"),Fh=a("__call__"),zh=a(" special method."),Eh=l(),M(wo.$$.fragment),qh=l(),$a=n("p"),Ch=a("Example:"),xh=l(),M(Gn.$$.fragment),Ci=l(),Rt=n("h2"),Po=n("a"),ya=n("span"),M(Yn.$$.fragment),jh=l(),Fa=n("span"),Lh=a("TFMPNetForMaskedLM"),xi=l(),Fe=n("div"),M(Zn.$$.fragment),Ah=l(),es=n("p"),Ih=a("MPNet Model with a "),za=n("code"),Dh=a("language modeling"),Sh=a(" head on top."),Oh=l(),ts=n("p"),Wh=a("This model inherits from "),sr=n("a"),Qh=a("TFPreTrainedModel"),Bh=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Hh=l(),os=n("p"),Rh=a("This model is also a "),ns=n("a"),Uh=a("tf.keras.Model"),Vh=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Kh=l(),M(No.$$.fragment),Jh=l(),Ue=n("div"),M(ss.$$.fragment),Xh=l(),Ut=n("p"),Gh=a("The "),rr=n("a"),Yh=a("TFMPNetForMaskedLM"),Zh=a(" forward method, overrides the "),Ea=n("code"),em=a("__call__"),tm=a(" special method."),om=l(),M($o.$$.fragment),nm=l(),qa=n("p"),sm=a("Example:"),rm=l(),M(rs.$$.fragment),ji=l(),Vt=n("h2"),yo=n("a"),Ca=n("span"),M(as.$$.fragment),am=l(),xa=n("span"),im=a("TFMPNetForSequenceClassification"),Li=l(),ze=n("div"),M(is.$$.fragment),lm=l(),ja=n("p"),dm=a(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),vm=l(),M(Fo.$$.fragment),km=l(),Ve=n("div"),M(ps.$$.fragment),Tm=l(),Kt=n("p"),Mm=a("The "),ir=n("a"),bm=a("TFMPNetForSequenceClassification"),wm=a(" forward method, overrides the "),La=n("code"),Pm=a("__call__"),Nm=a(" special method."),$m=l(),M(zo.$$.fragment),ym=l(),Aa=n("p"),Fm=a("Example:"),zm=l(),M(hs.$$.fragment),Ai=l(),Jt=n("h2"),Eo=n("a"),Ia=n("span"),M(ms.$$.fragment),Em=l(),Da=n("span"),qm=a("TFMPNetForMultipleChoice"),Ii=l(),Ee=n("div"),M(us.$$.fragment),Cm=l(),Sa=n("p"),xm=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Qm=l(),M(qo.$$.fragment),Bm=l(),Ke=n("div"),M(vs.$$.fragment),Hm=l(),Xt=n("p"),Rm=a("The "),dr=n("a"),Um=a("TFMPNetForMultipleChoice"),Vm=a(" forward method, overrides the "),Oa=n("code"),Km=a("__call__"),Jm=a(" special method."),Xm=l(),M(Co.$$.fragment),Gm=l(),Wa=n("p"),Ym=a("Example:"),Zm=l(),M(ks.$$.fragment),Di=l(),Gt=n("h2"),xo=n("a"),Qa=n("span"),M(Ts.$$.fragment),eu=l(),Ba=n("span"),tu=a("TFMPNetForTokenClassification"),Si=l(),qe=n("div"),M(Ms.$$.fragment),ou=l(),Ha=n("p"),nu=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
output) e.g. for GLUE tasks.`),Jg.forEach(t),cm=d(nt),ls=s(nt,"P",{});var Nl=r(ls);pm=i(Nl,"This model inherits from "),ar=s(Nl,"A",{href:!0});var Xg=r(ar);hm=i(Xg,"TFPreTrainedModel"),Xg.forEach(t),mm=i(Nl,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
