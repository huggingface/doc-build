...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,h,f),e(h,I),e(h,u),e(u,_),e(h,$)},d(g){g&&o(h)}}}function yl(q){let h,I,u,_,$;return{c(){h=n("p"),I=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),_=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var f=r(h);I=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var B=r(u);_=i(B,"Module"),B.forEach(o),$=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,h,f),e(h,I),e(h,u),e(u,_),e(h,$)},d(g){g&&o(h)}}}function Il(q){let h,I,u,_,$;return{c(){h=n("p"),I=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),_=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var f=r(h);I=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var B=r(u);_=i(B,"Module"),B.forEach(o),$=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,h,f),e(h,I),e(h,u),e(u,_),e(h,$)},d(g){g&&o(h)}}}function $l(q){let h,I,u,_,$;return{c(){h=n("p"),I=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),_=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var f=r(h);I=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var B=r(u);_=i(B,"Module"),B.forEach(o),$=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,h,f),e(h,I),e(h,u),e(u,_),e(h,$)},d(g){g&&o(h)}}}function Bl(q){let h,I,u,_,$;return{c(){h=n("p"),I=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),_=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var f=r(h);I=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var B=r(u);_=i(B,"Module"),B.forEach(o),$=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,h,f),e(h,I),e(h,u),e(u,_),e(h,$)},d(g){g&&o(h)}}}function zl(q){let h,I,u,_,$;return{c(){h=n("p"),I=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),_=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var f=r(h);I=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var B=r(u);_=i(B,"Module"),B.forEach(o),$=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
inference up to four times faster.`),Xo=d(),Pt=n("p"),Gn=a("The abstract from the paper is the following:"),en=d(),jt=n("p"),ho=n("em"),Vn=a(`Transformer based models, like BERT and RoBERTa, have achieved state-of-the-art results in many Natural Language
...
been open-sourced.`),tn=d(),Q=n("p"),Jn=a("This model was contributed by "),je=n("a"),Kn=a("kssteven"),Yn=a(". The original code can be found "),Ae=n("a"),Zn=a("here"),Xn=a("."),on=d(),oe=n("h2"),ke=n("a"),po=n("span"),b(Se.$$.fragment),es=d(),uo=n("span"),ts=a("IBertConfig"),nn=d(),O=n("div"),b(Le.$$.fragment),os=d(),Re=n("p"),ns=a("This is the configuration class to store the configuration of a "),At=n("a"),ss=a("IBertModel"),rs=a(`. It is used to
instantiate a I-BERT model according to the specified arguments,`),as=d(),ne=n("p"),is=a("Configuration objects inherit from "),St=n("a"),ls=a("PretrainedConfig"),ds=a(` and can be used to control the model
outputs. Read the documentation from `),Lt=n("a"),cs=a("PretrainedConfig"),hs=a(" for more information."),sn=d(),se=n("h2"),we=n("a"),mo=n("span"),b(Ne.$$.fragment),ps=d(),fo=n("span"),us=a("IBertModel"),rn=d(),M=n("div"),b(De.$$.fragment),ms=d(),go=n("p"),fs=a("The bare I-BERT Model transformer outputting raw hidden-states without any specific head on top."),gs=d(),We=n("p"),_s=a("This model inherits from "),Rt=n("a"),bs=a("PreTrainedModel"),vs=a(`. Check the superclass documentation for the generic
...
cross-attention is added between the self-attention layers, following the architecture described in `),_o=n("code"),Bs=a("Attention is all you need <https://arxiv.org/abs/1706.03762>"),zs=a(`__ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ms=d(),j=n("div"),b(Ue.$$.fragment),qs=d(),re=n("p"),Fs=a("The "),Nt=n("a"),Es=a("IBertModel"),Cs=a(" forward method, overrides the "),bo=n("code"),xs=a("__call__"),Ps=a(" special method."),js=d(),b(Te.$$.fragment),As=d(),vo=n("p"),Ss=a("Example:"),Ls=d(),b(Ge.$$.fragment),an=d(),ae=n("h2"),ye=n("a"),ko=n("span"),b(Ve.$$.fragment),Rs=d(),wo=n("span"),Ns=a("IBertForMaskedLM"),ln=d(),F=n("div"),b(Je.$$.fragment),Ds=d(),Ke=n("p"),Ws=a("I-BERT Model with a "),To=n("code"),Os=a("language modeling"),Qs=a(" head on top."),Hs=d(),Ye=n("p"),Us=a("This model inherits from "),Dt=n("a"),Gs=a("PreTrainedModel"),Vs=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Js=d(),Ze=n("p"),Ks=a("This model is also a PyTorch "),Xe=n("a"),Ys=a("torch.nn.Module"),Zs=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Xs=d(),A=n("div"),b(et.$$.fragment),er=d(),ie=n("p"),tr=a("The "),Wt=n("a"),or=a("IBertForMaskedLM"),nr=a(" forward method, overrides the "),yo=n("code"),sr=a("__call__"),rr=a(" special method."),ar=d(),b(Ie.$$.fragment),ir=d(),Io=n("p"),lr=a("Example:"),dr=d(),b(tt.$$.fragment),dn=d(),le=n("h2"),$e=n("a"),$o=n("span"),b(ot.$$.fragment),cr=d(),Bo=n("span"),hr=a("IBertForSequenceClassification"),cn=d(),E=n("div"),b(nt.$$.fragment),pr=d(),zo=n("p"),ur=a(`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),mr=d(),st=n("p"),fr=a("This model inherits from "),Ot=n("a"),gr=a("PreTrainedModel"),_r=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),br=d(),rt=n("p"),vr=a("This model is also a PyTorch "),at=n("a"),kr=a("torch.nn.Module"),wr=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Tr=d(),z=n("div"),b(it.$$.fragment),yr=d(),de=n("p"),Ir=a("The "),Qt=n("a"),$r=a("IBertForSequenceClassification"),Br=a(" forward method, overrides the "),Mo=n("code"),zr=a("__call__"),Mr=a(" special method."),qr=d(),b(Be.$$.fragment),Fr=d(),qo=n("p"),Er=a("Example of single-label classification:"),Cr=d(),b(lt.$$.fragment),xr=d(),Fo=n("p"),Pr=a("Example of multi-label classification:"),jr=d(),b(dt.$$.fragment),hn=d(),ce=n("h2"),ze=n("a"),Eo=n("span"),b(ct.$$.fragment),Ar=d(),Co=n("span"),Sr=a("IBertForMultipleChoice"),pn=d(),C=n("div"),b(ht.$$.fragment),Lr=d(),xo=n("p"),Rr=a(`I-BERT Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Nr=d(),pt=n("p"),Dr=a("This model inherits from "),Ht=n("a"),Wr=a("PreTrainedModel"),Or=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Qr=d(),ut=n("p"),Hr=a("This model is also a PyTorch "),mt=n("a"),Ur=a("torch.nn.Module"),Gr=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Vr=d(),S=n("div"),b(ft.$$.fragment),Jr=d(),he=n("p"),Kr=a("The "),Ut=n("a"),Yr=a("IBertForMultipleChoice"),Zr=a(" forward method, overrides the "),Po=n("code"),Xr=a("__call__"),ea=a(" special method."),ta=d(),b(Me.$$.fragment),oa=d(),jo=n("p"),na=a("Example:"),sa=d(),b(gt.$$.fragment),un=d(),pe=n("h2"),qe=n("a"),Ao=n("span"),b(_t.$$.fragment),ra=d(),So=n("span"),aa=a("IBertForTokenClassification"),mn=d(),x=n("div"),b(bt.$$.fragment),ia=d(),Lo=n("p"),la=a(`I-BERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),da=d(),vt=n("p"),ca=a("This model inherits from "),Gt=n("a"),ha=a("PreTrainedModel"),pa=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),ua=d(),kt=n("p"),ma=a("This model is also a PyTorch "),wt=n("a"),fa=a("torch.nn.Module"),ga=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),_a=d(),L=n("div"),b(Tt.$$.fragment),ba=d(),ue=n("p"),va=a("The "),Vt=n("a"),ka=a("IBertForTokenClassification"),wa=a(" forward method, overrides the "),Ro=n("code"),Ta=a("__call__"),ya=a(" special method."),Ia=d(),b(Fe.$$.fragment),$a=d(),No=n("p"),Ba=a("Example:"),za=d(),b(yt.$$.fragment),fn=d(),me=n("h2"),Ee=n("a"),Do=n("span"),b(It.$$.fragment),Ma=d(),Wo=n("span"),qa=a("IBertForQuestionAnswering"),gn=d(),P=n("div"),b($t.$$.fragment),Fa=d(),fe=n("p"),Ea=a(`I-BERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Oo=n("code"),Ca=a("span start logits"),xa=a(" and "),Qo=n("code"),Pa=a("span end logits"),ja=a(")."),Aa=d(),Bt=n("p"),Sa=a("This model inherits from "),Jt=n("a"),La=a("PreTrainedModel"),Ra=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Na=d(),zt=n("p"),Da=a("This model is also a PyTorch "),Mt=n("a"),Wa=a("torch.nn.Module"),Oa=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Qa=d(),R=n("div"),b(qt.$$.fragment),Ha=d(),ge=n("p"),Ua=a("The "),Kt=n("a"),Ga=a("IBertForQuestionAnswering"),Va=a(" forward method, overrides the "),Ho=n("code"),Ja=a("__call__"),Ka=a(" special method."),Ya=d(),b(Ce.$$.fragment),Za=d(),Uo=n("p"),Xa=a("Example:"),ei=d(),b(Ft.$$.fragment),this.h()},l(t){const p=wl('[data-svelte="svelte-1phssyn"]',document.head);h=s(p,"META",{name:!0,content:!0}),p.forEach(o),I=c(t),u=s(t,"H1",{class:!0});var Et=r(u);_=s(Et,"A",{id:!0,class:!0,href:!0});var Go=r(_);$=s(Go,"SPAN",{});var Vo=r($);v(g.$$.fragment,Vo),Vo.forEach(o),Go.forEach(o),f=c(Et),B=s(Et,"SPAN",{});var Jo=r(B);Dn=i(Jo,"I-BERT"),Jo.forEach(o),Et.forEach(o),Yo=c(t),te=s(t,"H2",{class:!0});var Ct=r(te);be=s(Ct,"A",{id:!0,class:!0,href:!0});var Ko=r(be);lo=s(Ko,"SPAN",{});var ti=r(lo);v(xe.$$.fragment,ti),ti.forEach(o),Ko.forEach(o),Wn=c(Ct),co=s(Ct,"SPAN",{});var oi=r(co);On=i(oi,"Overview"),oi.forEach(o),Ct.forEach(o),Zo=c(t),ve=s(t,"P",{});var bn=r(ve);Qn=i(bn,"The I-BERT model was proposed in "),Pe=s(bn,"A",{href:!0,rel:!0});var ni=r(Pe);Hn=i(ni,"I-BERT: Integer-only BERT Quantization"),ni.forEach(o),Un=i(bn,` by
Sehoon Kim, Amir Gholami, Zhewei Yao, Michael W. Mahoney and Kurt Keutzer. It\u2019s a quantized version of RoBERTa running
inference up to four times faster.`),bn.forEach(o),Xo=c(t),Pt=s(t,"P",{});var si=r(Pt);Gn=i(si,"The abstract from the paper is the following:"),si.forEach(o),en=c(t),jt=s(t,"P",{});var ri=r(jt);ho=s(ri,"EM",{});var ai=r(ho);Vn=i(ai,`Transformer based models, like BERT and RoBERTa, have achieved state-of-the-art results in many Natural Language
Processing tasks. However, their memory footprint, inference latency, and power consumption are prohibitive for
efficient inference at the edge, and even at the data center. While quantization can be a viable solution for this,
previous work on quantizing Transformer based models use floating-point arithmetic during inference, which cannot
efficiently utilize integer-only logical units such as the recent Turing Tensor Cores, or traditional integer-only ARM
