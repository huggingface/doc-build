...
docstrings of the methods above for more information.`),D.forEach(t)},m(I,D){u(I,m,D),e(m,w),e(m,f),e(f,g),e(m,k),e(m,h),e(h,_),e(m,P)},d(I){I&&t(m)}}}function yi(U){let m,w,f,g,k;return{c(){m=a("p"),w=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),k=n(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(h,_){u(h,m,_),e(m,w),e(m,f),e(f,g),e(m,k)},d(h){h&&t(m)}}}function wi(U){let m,w,f,g,k;return{c(){m=a("p"),w=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(h){m=s(h,"P",{});var _=i(m);w=r(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var P=i(f);g=r(P,"Module"),P.forEach(t),k=r(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
