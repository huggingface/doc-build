...
PIL images.`),u.forEach(t)},m(g,u){h(g,p,u),e(p,P)},d(g){g&&t(p)}}}function Gc(ee){let p,P,g,u,k;return{c(){p=a("p"),P=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=r("Module"),k=r(`
...
outputs. Read the documentation from `),qt=a("a"),Lr=r("PretrainedConfig"),Sr=r(" for more information."),Or=l(),Yo=a("p"),Wr=r("Example:"),Rr=l(),v(Ke.$$.fragment),za=l(),pe=a("h2"),xe=a("a"),Zo=a("span"),v(Ye.$$.fragment),Hr=l(),ea=a("span"),Br=r("ImageGPTFeatureExtractor"),ja=l(),R=a("div"),v(Ze.$$.fragment),Vr=l(),ta=a("p"),Ur=r(`Constructs an ImageGPT feature extractor. This feature extractor can be used to resize images to a smaller
...
general usage and behavior.`),gi=l(),S=a("div"),v(it.$$.fragment),ui=l(),ue=a("p"),fi=r("The "),Dt=a("a"),_i=r("ImageGPTModel"),vi=r(" forward method, overrides the "),ia=a("code"),Ti=r("__call__"),bi=r(" special method."),Ii=l(),v($e.$$.fragment),yi=l(),la=a("p"),wi=r("Examples:"),Pi=l(),v(lt.$$.fragment),Da=l(),fe=a("h2"),Fe=a("a"),da=a("span"),v(dt.$$.fragment),ki=l(),ca=a("span"),xi=r("ImageGPTForCausalImageModeling"),Na=l(),D=a("div"),v(ct.$$.fragment),Gi=l(),ma=a("p"),Ei=r(`The ImageGPT Model transformer with a language modeling head on top (linear layer with weights tied to the input
