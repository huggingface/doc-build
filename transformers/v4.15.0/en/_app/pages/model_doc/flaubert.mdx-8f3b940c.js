...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.15.0/en/model_doc/flaubert#transformers.FlaubertModel">FlaubertModel</a> or
<a href="/docs/transformers/v4.15.0/en/model_doc/flaubert#transformers.TFFlaubertModel">TFFlaubertModel</a>.`,name:"vocab_size"},{anchor:"transformers.FlaubertConfig.emb_dim",description:`<strong>emb_dim</strong> (<code>int</code>, <em>optional</em>, defaults to 2048) &#x2014;
...
layers on top of the hidden-states output to compute `),Lr=a("code"),nh=o("span start logits"),sh=o(" and "),Er=a("code"),ah=o("span end logits"),rh=o(")."),ih=l(),In=a("p"),lh=o("This model inherits from "),la=a("a"),dh=o("PreTrainedModel"),ch=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
SQuAD (a linear layers on top of the hidden-states output to compute `),jr=a("code"),jh=o("span start logits"),Xh=o(" and "),Xr=a("code"),Ah=o("span end logits"),Sh=o(")."),Nh=l(),Un=a("p"),Ih=o("This model inherits from "),pa=a("a"),Dh=o("PreTrainedModel"),Wh=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
layer on top of the hidden-states output to compute `),pi=a("code"),Ff=o("span start logits"),Mf=o(" and "),hi=a("code"),$f=o("span end logits"),xf=o(")."),Lf=l(),As=a("p"),Ef=o("This model inherits from "),Fa=a("a"),zf=o("TFPreTrainedModel"),Cf=o(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
