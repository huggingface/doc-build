...
time, SEW reduces word error rate by 25-50% across different model sizes.`),Nt=c(),Be=n("p"),Wo=r("Tips:"),Ot=c(),te=n("ul"),ut=n("li"),Co=r("SEW is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),ko=c(),fe=n("li"),To=r(`SEWForCTC is fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded using
`),Qe=n("a"),$o=r("Wav2Vec2CTCTokenizer"),xo=r("."),Kt=c(),oe=n("p"),qo=r("This model was contributed by "),me=n("a"),Po=r("anton-l"),jo=r("."),Lt=c(),I=n("h2"),ne=n("a"),gt=n("span"),v(he.$$.fragment),Fo=c(),_t=n("span"),Mo=r("SEWConfig"),It=c(),T=n("div"),v(ue.$$.fragment),zo=c(),H=n("p"),Ao=r("This is the configuration class to store the configuration of a "),Ye=n("a"),Do=r("SEWModel"),Vo=r(`. It is used to
instantiate a SEW model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the SEW `),ge=n("a"),No=r("asapp/sew-tiny-100k"),Oo=r(" architecture."),Ko=c(),U=n("p"),Lo=r("Configuration objects inherit from "),Ge=n("a"),Io=r("PretrainedConfig"),Ho=r(` and can be used to control the model
...
behavior.`),pn=c(),P=n("div"),v(Ce.$$.fragment),fn=c(),J=n("p"),mn=r("The "),et=n("a"),hn=r("SEWModel"),un=r(" forward method, overrides the "),Et=n("code"),gn=r("__call__"),_n=r(" special method."),vn=c(),v(se.$$.fragment),wn=c(),yt=n("p"),bn=r("Example:"),En=c(),v(ke.$$.fragment),Rt=c(),B=n("h2"),re=n("a"),St=n("span"),v(Te.$$.fragment),yn=c(),Wt=n("span"),Sn=r("SEWForCTC"),Jt=c(),x=n("div"),v($e.$$.fragment),Wn=c(),Q=n("p"),Cn=r("SEW Model with a "),Ct=n("code"),kn=r("language modeling"),Tn=r(` head on top for Connectionist Temporal Classification (CTC).
...
Artzi.`),qn=c(),qe=n("p"),Pn=r("This model inherits from "),tt=n("a"),jn=r("PreTrainedModel"),Fn=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),Mn=c(),Pe=n("p"),zn=r("This model is a PyTorch "),je=n("a"),An=r("torch.nn.Module"),Dn=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
