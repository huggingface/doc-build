import{S as Fi,i as Ii,s as Pi,e as n,k as d,w as _,t as r,M as Ci,c as s,d as o,m as c,a as i,x as v,h as a,b as l,N as Mi,F as e,g as f,y as b,q as S,o as w,B as y}from"../../chunks/vendor-ab4e3193.js";import{T as cr}from"../../chunks/Tip-b5c6375a.js";import{D as de}from"../../chunks/Docstring-b69c0bd4.js";import{C as mr}from"../../chunks/CodeBlock-516df0c5.js";import{I as xe}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function ki(D){let h,x;return{c(){h=n("p"),x=r(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
PIL images.`),p.forEach(o)},m(g,p){f(g,h,p),e(h,x)},d(g){g&&o(h)}}}function zi(D){let h,x,g,p,I;return{c(){h=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),p=r("Module"),I=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){h=s(u,"P",{});var $=i(h);x=a($,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s($,"CODE",{});var C=i(g);p=a(C,"Module"),C.forEach(o),I=a($,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),$.forEach(o)},m(u,$){f(u,h,$),e(h,x),e(h,g),e(g,p),e(h,I)},d(u){u&&o(h)}}}function ji(D){let h,x,g,p,I;return{c(){h=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),p=r("Module"),I=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){h=s(u,"P",{});var $=i(h);x=a($,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s($,"CODE",{});var C=i(g);p=a(C,"Module"),C.forEach(o),I=a($,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),$.forEach(o)},m(u,$){f(u,h,$),e(h,x),e(h,g),e(g,p),e(h,I)},d(u){u&&o(h)}}}function Ai(D){let h,x,g,p,I;return{c(){h=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),p=r("Module"),I=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){h=s(u,"P",{});var $=i(h);x=a($,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s($,"CODE",{});var C=i(g);p=a(C,"Module"),C.forEach(o),I=a($,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
