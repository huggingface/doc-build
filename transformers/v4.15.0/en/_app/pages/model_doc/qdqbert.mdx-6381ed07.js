import{S as Ru,i as Uu,s as Vu,e as r,k as d,w as _,t as n,M as Xu,c as a,d as o,m as c,a as i,x as b,h as s,b as l,F as e,g as u,y as v,q as k,o as Q,B as w}from"../../chunks/vendor-ab4e3193.js";import{T as ut}from"../../chunks/Tip-b5c6375a.js";import{D as x}from"../../chunks/Docstring-b69c0bd4.js";import{C as Z}from"../../chunks/CodeBlock-516df0c5.js";import{I as K}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Ju(D){let h,y,m,T,$;return{c(){h=r("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=a(g,"P",{});var f=i(h);y=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(f,"CODE",{});var q=i(m);T=s(q,"Module"),q.forEach(o),$=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,h,f),e(h,y),e(h,m),e(m,T),e(h,$)},d(g){g&&o(h)}}}function Gu(D){let h,y,m,T,$;return{c(){h=r("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=a(g,"P",{});var f=i(h);y=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(f,"CODE",{});var q=i(m);T=s(q,"Module"),q.forEach(o),$=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,h,f),e(h,y),e(h,m),e(m,T),e(h,$)},d(g){g&&o(h)}}}function Ku(D){let h,y,m,T,$;return{c(){h=r("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=a(g,"P",{});var f=i(h);y=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(f,"CODE",{});var q=i(m);T=s(q,"Module"),q.forEach(o),$=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,h,f),e(h,y),e(h,m),e(m,T),e(h,$)},d(g){g&&o(h)}}}function Zu(D){let h,y,m,T,$;return{c(){h=r("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=a(g,"P",{});var f=i(h);y=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(f,"CODE",{});var q=i(m);T=s(q,"Module"),q.forEach(o),$=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,h,f),e(h,y),e(h,m),e(m,T),e(h,$)},d(g){g&&o(h)}}}function Yu(D){let h,y,m,T,$;return{c(){h=r("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=a(g,"P",{});var f=i(h);y=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(f,"CODE",{});var q=i(m);T=s(q,"Module"),q.forEach(o),$=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,h,f),e(h,y),e(h,m),e(m,T),e(h,$)},d(g){g&&o(h)}}}function em(D){let h,y,m,T,$;return{c(){h=r("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=a(g,"P",{});var f=i(h);y=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(f,"CODE",{});var q=i(m);T=s(q,"Module"),q.forEach(o),$=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,h,f),e(h,y),e(h,m),e(m,T),e(h,$)},d(g){g&&o(h)}}}function tm(D){let h,y,m,T,$;return{c(){h=r("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=a(g,"P",{});var f=i(h);y=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(f,"CODE",{});var q=i(m);T=s(q,"Module"),q.forEach(o),$=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,h,f),e(h,y),e(h,m),e(m,T),e(h,$)},d(g){g&&o(h)}}}function om(D){let h,y,m,T,$;return{c(){h=r("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=a(g,"P",{});var f=i(h);y=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(f,"CODE",{});var q=i(m);T=s(q,"Module"),q.forEach(o),$=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
SQUAD task can be found at `),Xo=r("a"),Na=n("transformers/examples/research_projects/quantization-qdqbert/"),Sa=n("."),sr=d(),He=r("p"),La=n("This model was contributed by "),vt=r("a"),Ia=n("shangz"),Oa=n("."),rr=d(),be=r("h3"),Re=r("a"),Nn=r("span"),_(kt.$$.fragment),Wa=d(),Sn=r("span"),Ha=n("Set default quantizers"),ar=d(),E=r("p"),Ra=n(`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
`),Ln=r("code"),Ua=n("TensorQuantizer"),Va=n(" in "),Qt=r("a"),Xa=n("Pytorch Quantization Toolkit"),Ja=n(". "),In=r("code"),Ga=n("TensorQuantizer"),Ka=n(` is the module
...
Example:`),lr=d(),_(Tt.$$.fragment),dr=d(),ve=r("h3"),Ve=r("a"),Hn=r("span"),_(yt.$$.fragment),ri=d(),Rn=r("span"),ai=n("Calibration"),cr=d(),Jo=r("p"),ii=n(`Calibration is the terminology of passing data samples to the quantizer and deciding the best scaling factors for
tensors. After setting up the tensor quantizers, one can use the following example to calibrate the model:`),pr=d(),_($t.$$.fragment),hr=d(),ke=r("h3"),Xe=r("a"),Un=r("span"),_(qt.$$.fragment),li=d(),Vn=r("span"),di=n("Export to ONNX"),ur=d(),te=r("p"),ci=n("The goal of exporting to ONNX is to deploy inference by "),Dt=r("a"),pi=n("TensorRT"),hi=n(`. Fake
...
the instructions in `),zt=r("a"),ui=n("torch.onnx"),mi=n(". Example:"),mr=d(),_(Bt.$$.fragment),fr=d(),Qe=r("h2"),Je=r("a"),Xn=r("span"),_(Mt.$$.fragment),fi=d(),Jn=r("span"),gi=n("QDQBertConfig"),gr=d(),F=r("div"),_(xt.$$.fragment),_i=d(),we=r("p"),bi=n("This is the configuration class to store the configuration of a "),Go=r("a"),vi=n("QDQBertModel"),ki=n(`. It is used to
instantiate an QDQBERT model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BERT `),Et=r("a"),Qi=n("bert-base-uncased"),wi=n(" architecture."),Ti=d(),Te=r("p"),yi=n("Configuration objects inherit from "),Ko=r("a"),$i=n("PretrainedConfig"),qi=n(` and can be used to control the model
outputs. Read the documentation from `),Zo=r("a"),Di=n("PretrainedConfig"),zi=n(" for more information."),Bi=d(),Gn=r("p"),Mi=n("Examples:"),xi=d(),_(Ft.$$.fragment),_r=d(),ye=r("h2"),Ge=r("a"),Kn=r("span"),_(Pt.$$.fragment),Ei=d(),Zn=r("span"),Fi=n("QDQBertModel"),br=d(),z=r("div"),_(jt.$$.fragment),Pi=d(),Yn=r("p"),ji=n("The bare QDQBERT Model transformer outputting raw hidden-states without any specific head on top."),Ci=d(),Ct=r("p"),Ai=n("This model inherits from "),Yo=r("a"),Ni=n("PreTrainedModel"),Si=n(`. Check the superclass documentation for the generic
...
input to the forward pass.`),ll=d(),I=r("div"),_(It.$$.fragment),dl=d(),$e=r("p"),cl=n("The "),en=r("a"),pl=n("QDQBertModel"),hl=n(" forward method, overrides the "),as=r("code"),ul=n("__call__"),ml=n(" special method."),fl=d(),_(Ke.$$.fragment),gl=d(),is=r("p"),_l=n("Example:"),bl=d(),_(Ot.$$.fragment),vr=d(),qe=r("h2"),Ze=r("a"),ls=r("span"),_(Wt.$$.fragment),vl=d(),ds=r("span"),kl=n("QDQBertLMHeadModel"),kr=d(),P=r("div"),_(Ht.$$.fragment),Ql=d(),Rt=r("p"),wl=n("QDQBERT Model with a "),cs=r("code"),Tl=n("language modeling"),yl=n(" head on top for CLM fine-tuning."),$l=d(),Ut=r("p"),ql=n("This model inherits from "),tn=r("a"),Dl=n("PreTrainedModel"),zl=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Bl=d(),Vt=r("p"),Ml=n("This model is also a PyTorch "),Xt=r("a"),xl=n("torch.nn.Module"),El=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Fl=d(),O=r("div"),_(Jt.$$.fragment),Pl=d(),De=r("p"),jl=n("The "),on=r("a"),Cl=n("QDQBertLMHeadModel"),Al=n(" forward method, overrides the "),ps=r("code"),Nl=n("__call__"),Sl=n(" special method."),Ll=d(),_(Ye.$$.fragment),Il=d(),hs=r("p"),Ol=n("Example:"),Wl=d(),_(Gt.$$.fragment),Qr=d(),ze=r("h2"),et=r("a"),us=r("span"),_(Kt.$$.fragment),Hl=d(),ms=r("span"),Rl=n("QDQBertForMaskedLM"),wr=d(),j=r("div"),_(Zt.$$.fragment),Ul=d(),Yt=r("p"),Vl=n("QDQBERT Model with a "),fs=r("code"),Xl=n("language modeling"),Jl=n(" head on top."),Gl=d(),eo=r("p"),Kl=n("This model inherits from "),nn=r("a"),Zl=n("PreTrainedModel"),Yl=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),ed=d(),to=r("p"),td=n("This model is also a PyTorch "),oo=r("a"),od=n("torch.nn.Module"),nd=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),sd=d(),W=r("div"),_(no.$$.fragment),rd=d(),Be=r("p"),ad=n("The "),sn=r("a"),id=n("QDQBertForMaskedLM"),ld=n(" forward method, overrides the "),gs=r("code"),dd=n("__call__"),cd=n(" special method."),pd=d(),_(tt.$$.fragment),hd=d(),_s=r("p"),ud=n("Example:"),md=d(),_(so.$$.fragment),Tr=d(),Me=r("h2"),ot=r("a"),bs=r("span"),_(ro.$$.fragment),fd=d(),vs=r("span"),gd=n("QDQBertForSequenceClassification"),yr=d(),C=r("div"),_(ao.$$.fragment),_d=d(),ks=r("p"),bd=n(`Bert Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),vd=d(),io=r("p"),kd=n("This model inherits from "),rn=r("a"),Qd=n("PreTrainedModel"),wd=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Td=d(),lo=r("p"),yd=n("This model is also a PyTorch "),co=r("a"),$d=n("torch.nn.Module"),qd=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Dd=d(),B=r("div"),_(po.$$.fragment),zd=d(),xe=r("p"),Bd=n("The "),an=r("a"),Md=n("QDQBertForSequenceClassification"),xd=n(" forward method, overrides the "),Qs=r("code"),Ed=n("__call__"),Fd=n(" special method."),Pd=d(),_(nt.$$.fragment),jd=d(),ws=r("p"),Cd=n("Example of single-label classification:"),Ad=d(),_(ho.$$.fragment),Nd=d(),Ts=r("p"),Sd=n("Example of multi-label classification:"),Ld=d(),_(uo.$$.fragment),$r=d(),Ee=r("h2"),st=r("a"),ys=r("span"),_(mo.$$.fragment),Id=d(),$s=r("span"),Od=n("QDQBertForNextSentencePrediction"),qr=d(),A=r("div"),_(fo.$$.fragment),Wd=d(),go=r("p"),Hd=n("Bert Model with a "),qs=r("code"),Rd=n("next sentence prediction (classification)"),Ud=n(" head on top."),Vd=d(),_o=r("p"),Xd=n("This model inherits from "),ln=r("a"),Jd=n("PreTrainedModel"),Gd=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Kd=d(),bo=r("p"),Zd=n("This model is also a PyTorch "),vo=r("a"),Yd=n("torch.nn.Module"),ec=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),tc=d(),H=r("div"),_(ko.$$.fragment),oc=d(),Fe=r("p"),nc=n("The "),dn=r("a"),sc=n("QDQBertForNextSentencePrediction"),rc=n(" forward method, overrides the "),Ds=r("code"),ac=n("__call__"),ic=n(" special method."),lc=d(),_(rt.$$.fragment),dc=d(),zs=r("p"),cc=n("Example:"),pc=d(),_(Qo.$$.fragment),Dr=d(),Pe=r("h2"),at=r("a"),Bs=r("span"),_(wo.$$.fragment),hc=d(),Ms=r("span"),uc=n("QDQBertForMultipleChoice"),zr=d(),N=r("div"),_(To.$$.fragment),mc=d(),xs=r("p"),fc=n(`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),gc=d(),yo=r("p"),_c=n("This model inherits from "),cn=r("a"),bc=n("PreTrainedModel"),vc=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),kc=d(),$o=r("p"),Qc=n("This model is also a PyTorch "),qo=r("a"),wc=n("torch.nn.Module"),Tc=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),yc=d(),R=r("div"),_(Do.$$.fragment),$c=d(),je=r("p"),qc=n("The "),pn=r("a"),Dc=n("QDQBertForMultipleChoice"),zc=n(" forward method, overrides the "),Es=r("code"),Bc=n("__call__"),Mc=n(" special method."),xc=d(),_(it.$$.fragment),Ec=d(),Fs=r("p"),Fc=n("Example:"),Pc=d(),_(zo.$$.fragment),Br=d(),Ce=r("h2"),lt=r("a"),Ps=r("span"),_(Bo.$$.fragment),jc=d(),js=r("span"),Cc=n("QDQBertForTokenClassification"),Mr=d(),S=r("div"),_(Mo.$$.fragment),Ac=d(),Cs=r("p"),Nc=n(`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Sc=d(),xo=r("p"),Lc=n("This model inherits from "),hn=r("a"),Ic=n("PreTrainedModel"),Oc=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Wc=d(),Eo=r("p"),Hc=n("This model is also a PyTorch "),Fo=r("a"),Rc=n("torch.nn.Module"),Uc=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Vc=d(),U=r("div"),_(Po.$$.fragment),Xc=d(),Ae=r("p"),Jc=n("The "),un=r("a"),Gc=n("QDQBertForTokenClassification"),Kc=n(" forward method, overrides the "),As=r("code"),Zc=n("__call__"),Yc=n(" special method."),ep=d(),_(dt.$$.fragment),tp=d(),Ns=r("p"),op=n("Example:"),np=d(),_(jo.$$.fragment),xr=d(),Ne=r("h2"),ct=r("a"),Ss=r("span"),_(Co.$$.fragment),sp=d(),Ls=r("span"),rp=n("QDQBertForQuestionAnswering"),Er=d(),L=r("div"),_(Ao.$$.fragment),ap=d(),Se=r("p"),ip=n(`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Is=r("code"),lp=n("span start logits"),dp=n(" and "),Os=r("code"),cp=n("span end logits"),pp=n(")."),hp=d(),No=r("p"),up=n("This model inherits from "),mn=r("a"),mp=n("PreTrainedModel"),fp=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),gp=d(),So=r("p"),_p=n("This model is also a PyTorch "),Lo=r("a"),bp=n("torch.nn.Module"),vp=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),kp=d(),V=r("div"),_(Io.$$.fragment),Qp=d(),Le=r("p"),wp=n("The "),fn=r("a"),Tp=n("QDQBertForQuestionAnswering"),yp=n(" forward method, overrides the "),Ws=r("code"),$p=n("__call__"),qp=n(" special method."),Dp=d(),_(pt.$$.fragment),zp=d(),Hs=r("p"),Bp=n("Example:"),Mp=d(),_(Oo.$$.fragment),this.h()},l(t){const p=Xu('[data-svelte="svelte-1phssyn"]',document.head);h=a(p,"META",{name:!0,content:!0}),p.forEach(o),y=c(t),m=a(t,"H1",{class:!0});var Wo=i(m);T=a(Wo,"A",{id:!0,class:!0,href:!0});var Rs=i(T);$=a(Rs,"SPAN",{});var Us=i($);b(g.$$.fragment,Us),Us.forEach(o),Rs.forEach(o),f=c(Wo),q=a(Wo,"SPAN",{});var Vs=i(q);_a=s(Vs,"QDQBERT"),Vs.forEach(o),Wo.forEach(o),Zs=c(t),_e=a(t,"H2",{class:!0});var Ho=i(_e);Ie=a(Ho,"A",{id:!0,class:!0,href:!0});var Xs=i(Ie);zn=a(Xs,"SPAN",{});var Js=i(zn);b(mt.$$.fragment,Js),Js.forEach(o),Xs.forEach(o),ba=c(Ho),Bn=a(Ho,"SPAN",{});var Gs=i(Bn);va=s(Gs,"Overview"),Gs.forEach(o),Ho.forEach(o),Ys=c(t),Oe=a(t,"P",{});var Pr=i(Oe);ka=s(Pr,"The QDQBERT model can be referenced in "),ft=a(Pr,"A",{href:!0,rel:!0});var xp=i(ft);Qa=s(xp,`Integer Quantization for Deep Learning Inference: Principles and Empirical
Evaluation`),xp.forEach(o),wa=s(Pr,` by Hao Wu, Patrick Judd, Xiaojie Zhang, Mikhail Isaev and Paulius
Micikevicius.`),Pr.forEach(o),er=c(t),Ro=a(t,"P",{});var Ep=i(Ro);Ta=s(Ep,"The abstract from the paper is the following:"),Ep.forEach(o),tr=c(t),Uo=a(t,"P",{});var Fp=i(Uo);Mn=a(Fp,"EM",{});var Pp=i(Mn);ya=s(Pp,`Quantization techniques can reduce the size of Deep Neural Networks and improve inference latency and throughput by
taking advantage of high throughput integer instructions. In this paper we review the mathematical aspects of
quantization parameters and evaluate their choices on a wide range of neural network models for different application
domains, including vision, speech, and language. We focus on quantization techniques that are amenable to acceleration
by processors with high-throughput integer math pipelines. We also present a workflow for 8-bit quantization that is
...
inputs and weights, (ii) matmul inputs, (iii) residual add inputs, in BERT model.`),Ap.forEach(o),Cp.forEach(o),Da=c(ht),Fn=a(ht,"LI",{});var Np=i(Fn);We=a(Np,"P",{});var Ks=i(We);za=s(Ks,"QDQBERT requires the dependency of "),gt=a(Ks,"A",{href:!0,rel:!0});var Sp=i(gt);Ba=s(Sp,"Pytorch Quantization Toolkit"),Sp.forEach(o),Ma=s(Ks,". To install "),Pn=a(Ks,"CODE",{});var Lp=i(Pn);xa=s(Lp,"pip install pytorch-quantization --extra-index-url https://pypi.ngc.nvidia.com"),Lp.forEach(o),Ks.forEach(o),Np.forEach(o),Ea=c(ht),jn=a(ht,"LI",{});var Ip=i(jn);_t=a(Ip,"P",{});var jr=i(_t);Fa=s(jr,"QDQBERT model can be loaded from any checkpoint of HuggingFace BERT model (for example "),Cn=a(jr,"EM",{});var Op=i(Cn);Pa=s(Op,"bert-base-uncased"),Op.forEach(o),ja=s(jr,`), and
perform Quantization Aware Training/Post Training Quantization.`),jr.forEach(o),Ip.forEach(o),Ca=c(ht),An=a(ht,"LI",{});var Wp=i(An);bt=a(Wp,"P",{});var Cr=i(bt);Aa=s(Cr,`A complete example of using QDQBERT model to perform Quatization Aware Training and Post Training Quantization for
SQUAD task can be found at `),Xo=a(Cr,"A",{href:!0});var Hp=i(Xo);Na=s(Hp,"transformers/examples/research_projects/quantization-qdqbert/"),Hp.forEach(o),Sa=s(Cr,"."),Cr.forEach(o),Wp.forEach(o),ht.forEach(o),sr=c(t),He=a(t,"P",{});var Ar=i(He);La=s(Ar,"This model was contributed by "),vt=a(Ar,"A",{href:!0,rel:!0});var Rp=i(vt);Ia=s(Rp,"shangz"),Rp.forEach(o),Oa=s(Ar,"."),Ar.forEach(o),rr=c(t),be=a(t,"H3",{class:!0});var Nr=i(be);Re=a(Nr,"A",{id:!0,class:!0,href:!0});var Up=i(Re);Nn=a(Up,"SPAN",{});var Vp=i(Nn);b(kt.$$.fragment,Vp),Vp.forEach(o),Up.forEach(o),Wa=c(Nr),Sn=a(Nr,"SPAN",{});var Xp=i(Sn);Ha=s(Xp,"Set default quantizers"),Xp.forEach(o),Nr.forEach(o),ar=c(t),E=a(t,"P",{});var ee=i(E);Ra=s(ee,`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
`),Ln=a(ee,"CODE",{});var Jp=i(Ln);Ua=s(Jp,"TensorQuantizer"),Jp.forEach(o),Va=s(ee," in "),Qt=a(ee,"A",{href:!0,rel:!0});var Gp=i(Qt);Xa=s(Gp,"Pytorch Quantization Toolkit"),Gp.forEach(o),Ja=s(ee,". "),In=a(ee,"CODE",{});var Kp=i(In);Ga=s(Kp,"TensorQuantizer"),Kp.forEach(o),Ka=s(ee,` is the module
for quantizing tensors, with `),On=a(ee,"CODE",{});var Zp=i(On);Za=s(Zp,"QuantDescriptor"),Zp.forEach(o),Ya=s(ee," defining how the tensor should be quantized. Refer to "),wt=a(ee,"A",{href:!0,rel:!0});var Yp=i(wt);ei=s(Yp,`Pytorch
Quantization Toolkit userguide`),Yp.forEach(o),ti=s(ee," for more details."),ee.forEach(o),ir=c(t),Ue=a(t,"P",{});var Sr=i(Ue);oi=s(Sr,"Before creating QDQBERT model, one has to set the default "),Wn=a(Sr,"CODE",{});var eh=i(Wn);ni=s(eh,"QuantDescriptor"),eh.forEach(o),si=s(Sr,` defining default tensor quantizers.
Example:`),Sr.forEach(o),lr=c(t),b(Tt.$$.fragment,t),dr=c(t),ve=a(t,"H3",{class:!0});var Lr=i(ve);Ve=a(Lr,"A",{id:!0,class:!0,href:!0});var th=i(Ve);Hn=a(th,"SPAN",{});var oh=i(Hn);b(yt.$$.fragment,oh),oh.forEach(o),th.forEach(o),ri=c(Lr),Rn=a(Lr,"SPAN",{});var nh=i(Rn);ai=s(nh,"Calibration"),nh.forEach(o),Lr.forEach(o),cr=c(t),Jo=a(t,"P",{});var sh=i(Jo);ii=s(sh,`Calibration is the terminology of passing data samples to the quantizer and deciding the best scaling factors for
tensors. After setting up the tensor quantizers, one can use the following example to calibrate the model:`),sh.forEach(o),pr=c(t),b($t.$$.fragment,t),hr=c(t),ke=a(t,"H3",{class:!0});var Ir=i(ke);Xe=a(Ir,"A",{id:!0,class:!0,href:!0});var rh=i(Xe);Un=a(rh,"SPAN",{});var ah=i(Un);b(qt.$$.fragment,ah),ah.forEach(o),rh.forEach(o),li=c(Ir),Vn=a(Ir,"SPAN",{});var ih=i(Vn);di=s(ih,"Export to ONNX"),ih.forEach(o),Ir.forEach(o),ur=c(t),te=a(t,"P",{});var gn=i(te);ci=s(gn,"The goal of exporting to ONNX is to deploy inference by "),Dt=a(gn,"A",{href:!0,rel:!0});var lh=i(Dt);pi=s(lh,"TensorRT"),lh.forEach(o),hi=s(gn,`. Fake
quantization will be broken into a pair of QuantizeLinear/DequantizeLinear ONNX ops. After setting static member of
TensorQuantizer to use Pytorch\u2019s own fake quantization functions, fake quantized model can be exported to ONNX, follow
the instructions in `),zt=a(gn,"A",{href:!0,rel:!0});var dh=i(zt);ui=s(dh,"torch.onnx"),dh.forEach(o),mi=s(gn,". Example:"),gn.forEach(o),mr=c(t),b(Bt.$$.fragment,t),fr=c(t),Qe=a(t,"H2",{class:!0});var Or=i(Qe);Je=a(Or,"A",{id:!0,class:!0,href:!0});var ch=i(Je);Xn=a(ch,"SPAN",{});var ph=i(Xn);b(Mt.$$.fragment,ph),ph.forEach(o),ch.forEach(o),fi=c(Or),Jn=a(Or,"SPAN",{});var hh=i(Jn);gi=s(hh,"QDQBertConfig"),hh.forEach(o),Or.forEach(o),gr=c(t),F=a(t,"DIV",{class:!0});var oe=i(F);b(xt.$$.fragment,oe),_i=c(oe),we=a(oe,"P",{});var _n=i(we);bi=s(_n,"This is the configuration class to store the configuration of a "),Go=a(_n,"A",{href:!0});var uh=i(Go);vi=s(uh,"QDQBertModel"),uh.forEach(o),ki=s(_n,`. It is used to
instantiate an QDQBERT model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BERT `),Et=a(_n,"A",{href:!0,rel:!0});var mh=i(Et);Qi=s(mh,"bert-base-uncased"),mh.forEach(o),wi=s(_n," architecture."),_n.forEach(o),Ti=c(oe),Te=a(oe,"P",{});var bn=i(Te);yi=s(bn,"Configuration objects inherit from "),Ko=a(bn,"A",{href:!0});var fh=i(Ko);$i=s(fh,"PretrainedConfig"),fh.forEach(o),qi=s(bn,` and can be used to control the model
outputs. Read the documentation from `),Zo=a(bn,"A",{href:!0});var gh=i(Zo);Di=s(gh,"PretrainedConfig"),gh.forEach(o),zi=s(bn," for more information."),bn.forEach(o),Bi=c(oe),Gn=a(oe,"P",{});var _h=i(Gn);Mi=s(_h,"Examples:"),_h.forEach(o),xi=c(oe),b(Ft.$$.fragment,oe),oe.forEach(o),_r=c(t),ye=a(t,"H2",{class:!0});var Wr=i(ye);Ge=a(Wr,"A",{id:!0,class:!0,href:!0});var bh=i(Ge);Kn=a(bh,"SPAN",{});var vh=i(Kn);b(Pt.$$.fragment,vh),vh.forEach(o),bh.forEach(o),Ei=c(Wr),Zn=a(Wr,"SPAN",{});var kh=i(Zn);Fi=s(kh,"QDQBertModel"),kh.forEach(o),Wr.forEach(o),br=c(t),z=a(t,"DIV",{class:!0});var X=i(z);b(jt.$$.fragment,X),Pi=c(X),Yn=a(X,"P",{});var Qh=i(Yn);ji=s(Qh,"The bare QDQBERT Model transformer outputting raw hidden-states without any specific head on top."),Qh.forEach(o),Ci=c(X),Ct=a(X,"P",{});var Hr=i(Ct);Ai=s(Hr,"This model inherits from "),Yo=a(Hr,"A",{href:!0});var wh=i(Yo);Ni=s(wh,"PreTrainedModel"),wh.forEach(o),Si=s(Hr,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Hr.forEach(o),Li=c(X),At=a(X,"P",{});var Rr=i(At);Ii=s(Rr,"This model is also a PyTorch "),Nt=a(Rr,"A",{href:!0,rel:!0});var Th=i(Nt);Oi=s(Th,"torch.nn.Module"),Th.forEach(o),Wi=s(Rr,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
