import{S as gs,i as _s,s as Ts,e as a,k as d,w as v,t as s,M as vs,c as r,d as o,m as c,a as n,x as w,h as i,b as l,F as e,g as p,y as b,q as y,o as $,B as D}from"../../chunks/vendor-ab4e3193.js";import{T as so}from"../../chunks/Tip-b5c6375a.js";import{D as ne}from"../../chunks/Docstring-b69c0bd4.js";import{C as qo}from"../../chunks/CodeBlock-516df0c5.js";import{I as Ye}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function ws(A){let h,T,m,u,x;return{c(){h=a("p"),T=s(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
breaking changes to fix it in the future. If you see something strange, file a `),m=r(_,"A",{href:!0,rel:!0});var E=n(m);u=i(E,"Github Issue"),E.forEach(o),x=i(_,"."),_.forEach(o),this.h()},h(){l(m,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),l(m,"rel","nofollow")},m(g,_){p(g,h,_),e(h,T),e(h,m),e(m,u),e(h,x)},d(g){g&&o(h)}}}function bs(A){let h,T;return{c(){h=a("p"),T=s(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
PIL images.`),u.forEach(o)},m(m,u){p(m,h,u),e(h,T)},d(m){m&&o(h)}}}function ys(A){let h,T,m,u,x;return{c(){h=a("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),u=s("Module"),x=s(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(g,_){p(g,h,_),e(h,T),e(h,m),e(m,u),e(h,x)},d(g){g&&o(h)}}}function $s(A){let h,T,m,u,x;return{c(){h=a("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),u=s("Module"),x=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var _=n(h);T=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var E=n(m);u=i(E,"Module"),E.forEach(o),x=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(g,_){p(g,h,_),e(h,T),e(h,m),e(m,u),e(h,x)},d(g){g&&o(h)}}}function Ds(A){let h,T,m,u,x;return{c(){h=a("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),u=s("Module"),x=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var _=n(h);T=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var E=n(m);u=i(E,"Module"),E.forEach(o),x=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Whether to add a bias to the queries, keys and values.`,name:"qkv_bias"}]}}),ke=new qo({props:{code:`from transformers import DeiTModel, DeiTConfig
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jo.forEach(o),lr=c(vt),j=r(vt,"DIV",{class:!0});var B=n(j);w(qe.$$.fragment,B),dr=c(B),ee=r(B,"P",{});var wt=n(ee);cr=i(wt,"The "),ft=r(wt,"A",{href:!0});var Kn=n(ft);hr=i(Kn,"DeiTModel"),Kn.forEach(o),fr=i(wt," forward method, overrides the "),Ht=r(wt,"CODE",{});var Xn=n(Ht);mr=i(Xn,"__call__"),Xn.forEach(o),pr=i(wt," special method."),wt.forEach(o),ur=c(B),w(me.$$.fragment,B),gr=c(B),Bt=r(B,"P",{});var Zn=n(Bt);_r=i(Zn,"Examples:"),Zn.forEach(o),Tr=c(B),w(Le.$$.fragment,B),B.forEach(o),vt.forEach(o),yo=c(t),te=r(t,"H2",{class:!0});var Mo=n(te);pe=r(Mo,"A",{id:!0,class:!0,href:!0});var Qn=n(pe);Rt=r(Qn,"SPAN",{});var Yn=n(Rt);w(We.$$.fragment,Yn),Yn.forEach(o),Qn.forEach(o),vr=c(Mo),Ut=r(Mo,"SPAN",{});var es=n(Ut);wr=i(es,"DeiTForImageClassification"),es.forEach(o),Mo.forEach(o),$o=c(t),q=r(t,"DIV",{class:!0});var we=n(q);w(Se.$$.fragment,we),br=c(we),Jt=r(we,"P",{});var ts=n(Jt);yr=i(ts,`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),ts.forEach(o),$r=c(we),Oe=r(we,"P",{});var zo=n(Oe);Dr=i(zo,"This model is a PyTorch "),Ve=r(zo,"A",{href:!0,rel:!0});var os=n(Ve);xr=i(os,"torch.nn.Module"),os.forEach(o),Ir=i(zo,` subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zo.forEach(o),Er=c(we),M=r(we,"DIV",{class:!0});var R=n(M);w(He.$$.fragment,R),kr=c(R),oe=r(R,"P",{});var bt=n(oe);Fr=i(bt,"The "),mt=r(bt,"A",{href:!0});var as=n(mt);Cr=i(as,"DeiTForImageClassification"),as.forEach(o),Pr=i(bt," forward method, overrides the "),Gt=r(bt,"CODE",{});var rs=n(Gt);jr=i(rs,"__call__"),rs.forEach(o),Mr=i(bt," special method."),bt.forEach(o),zr=c(R),w(ue.$$.fragment,R),Ar=c(R),Kt=r(R,"P",{});var ns=n(Kt);Nr=i(ns,"Examples:"),ns.forEach(o),qr=c(R),w(Be.$$.fragment,R),R.forEach(o),we.forEach(o),Do=c(t),ae=r(t,"H2",{class:!0});var Ao=n(ae);ge=r(Ao,"A",{id:!0,class:!0,href:!0});var ss=n(ge);Xt=r(ss,"SPAN",{});var is=n(Xt);w(Re.$$.fragment,is),is.forEach(o),ss.forEach(o),Lr=c(Ao),Zt=r(Ao,"SPAN",{});var ls=n(Zt);Wr=i(ls,"DeiTForImageClassificationWithTeacher"),ls.forEach(o),Ao.forEach(o),xo=c(t),k=r(t,"DIV",{class:!0});var W=n(k);w(Ue.$$.fragment,W),Sr=c(W),Qt=r(W,"P",{});var ds=n(Qt);Or=i(ds,`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
