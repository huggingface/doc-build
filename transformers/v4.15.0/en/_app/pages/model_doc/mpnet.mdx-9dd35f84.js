import{S as z_,i as E_,s as q_,e as n,k as l,w as M,t as a,M as C_,c as s,d as t,m as d,a as r,x as b,h as i,b as h,F as e,g as m,y as w,q as P,o as N,B as $}from"../../chunks/vendor-ab4e3193.js";import{T as Ne}from"../../chunks/Tip-b5c6375a.js";import{D as ne}from"../../chunks/Docstring-b69c0bd4.js";import{C as Ye}from"../../chunks/CodeBlock-516df0c5.js";import{I as xe}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function x_(Q){let p,y,f,g,k;return{c(){p=n("p"),y=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=a("Module"),k=a(`
...
the latter silently ignores them.`)},l(v){p=s(v,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),k=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(v,_){m(v,p,_),e(p,y),e(p,f),e(f,g),e(p,k)},d(v){v&&t(p)}}}function S_(Q){let p,y,f,g,k,v,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),k=n("li"),v=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in
the first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);k=s(K,"LI",{});var _e=r(k);v=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ke=r(F);le=i(ke,"having all inputs as a list, tuple or dict in the first positional arguments."),ke.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ve=r(S);J=i(ve,"tf.keras.Model.fit"),ve.forEach(t),de=i(I,` method which currently requires having all
the tensors in the first argument of the model call function: `),O=s(I,"CODE",{});var Te=r(O);ce=i(Te,"model(inputs)"),Te.forEach(t),se=i(I,"."),I.forEach(t),R=d(c),A=s(c,"P",{});var Me=r(A);G=i(Me,`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in
...
`),x=s(ie,"CODE",{});var fe=r(x);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),L.forEach(t)},m(c,T){m(c,p,T),e(p,y),m(c,f,T),m(c,g,T),e(g,k),e(k,v),e(g,_),e(g,F),e(F,le),m(c,U,T),m(c,z,T),e(z,X),e(z,S),e(S,J),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,R,T),m(c,A,T),e(A,G),m(c,V,T),m(c,E,T),e(E,q),e(q,Y),e(q,B),e(B,re),e(q,Z),e(q,H),e(H,ae),e(E,ee),e(E,C),e(C,pe),e(C,W),e(W,te),e(E,he),e(E,j),e(j,oe),e(j,x),e(x,me)},d(c){c&&t(p),c&&t(f),c&&t(g),c&&t(U),c&&t(z),c&&t(R),c&&t(A),c&&t(V),c&&t(E)}}}function O_(Q){let p,y,f,g,k;return{c(){p=n("p"),y=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=s(v,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),k=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(v,_){m(v,p,_),e(p,y),e(p,f),e(f,g),e(p,k)},d(v){v&&t(p)}}}function W_(Q){let p,y,f,g,k,v,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),k=n("li"),v=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in
the first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),te=a("model([input_ids, attention_mask])"),he=l(),j=n("li"),oe=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);k=s(K,"LI",{});var _e=r(k);v=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ke=r(F);le=i(ke,"having all inputs as a list, tuple or dict in the first positional arguments."),ke.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ve=r(S);J=i(ve,"tf.keras.Model.fit"),ve.forEach(t),de=i(I,` method which currently requires having all
...
the latter silently ignores them.`)},l(v){p=s(v,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),k=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(v,_){m(v,p,_),e(p,y),e(p,f),e(f,g),e(p,k)},d(v){v&&t(p)}}}function B_(Q){let p,y,f,g,k,v,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),k=n("li"),v=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in
the first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),te=a("model([input_ids, attention_mask])"),he=l(),j=n("li"),oe=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);k=s(K,"LI",{});var _e=r(k);v=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ke=r(F);le=i(ke,"having all inputs as a list, tuple or dict in the first positional arguments."),ke.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ve=r(S);J=i(ve,"tf.keras.Model.fit"),ve.forEach(t),de=i(I,` method which currently requires having all
...
the latter silently ignores them.`)},l(v){p=s(v,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),k=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(v,_){m(v,p,_),e(p,y),e(p,f),e(f,g),e(p,k)},d(v){v&&t(p)}}}function V_(Q){let p,y,f,g,k,v,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),k=n("li"),v=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in
the first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),te=a("model([input_ids, attention_mask])"),he=l(),j=n("li"),oe=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);k=s(K,"LI",{});var _e=r(k);v=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ke=r(F);le=i(ke,"having all inputs as a list, tuple or dict in the first positional arguments."),ke.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ve=r(S);J=i(ve,"tf.keras.Model.fit"),ve.forEach(t),de=i(I,` method which currently requires having all
...
the latter silently ignores them.`)},l(v){p=s(v,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),k=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(v,_){m(v,p,_),e(p,y),e(p,f),e(f,g),e(p,k)},d(v){v&&t(p)}}}function X_(Q){let p,y,f,g,k,v,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),k=n("li"),v=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in
the first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),te=a("model([input_ids, attention_mask])"),he=l(),j=n("li"),oe=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);k=s(K,"LI",{});var _e=r(k);v=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ke=r(F);le=i(ke,"having all inputs as a list, tuple or dict in the first positional arguments."),ke.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ve=r(S);J=i(ve,"tf.keras.Model.fit"),ve.forEach(t),de=i(I,` method which currently requires having all
...
the first positional argument :`),Me.forEach(t),V=d(c),E=s(c,"UL",{});var L=r(E);q=s(L,"LI",{});var D=r(q);Y=i(D,"a single Tensor with "),B=s(D,"CODE",{});var be=r(B);re=i(be,"input_ids"),be.forEach(t),Z=i(D," only and nothing else: "),H=s(D,"CODE",{});var ge=r(H);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),ee=d(L),C=s(L,"LI",{});var ue=r(C);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var we=r(W);te=i(we,"model([input_ids, attention_mask])"),we.forEach(t),ue.forEach(t),he=d(L),j=s(L,"LI",{});var ie=r(j);oe=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=s(ie,"CODE",{});var fe=r(x);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),L.forEach(t)},m(c,T){m(c,p,T),e(p,y),m(c,f,T),m(c,g,T),e(g,k),e(k,v),e(g,_),e(g,F),e(F,le),m(c,U,T),m(c,z,T),e(z,X),e(z,S),e(S,J),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,R,T),m(c,A,T),e(A,G),m(c,V,T),m(c,E,T),e(E,q),e(q,Y),e(q,B),e(B,re),e(q,Z),e(q,H),e(H,ae),e(E,ee),e(E,C),e(C,pe),e(C,W),e(W,te),e(E,he),e(E,j),e(j,oe),e(j,x),e(x,me)},d(c){c&&t(p),c&&t(f),c&&t(g),c&&t(U),c&&t(z),c&&t(R),c&&t(A),c&&t(V),c&&t(E)}}}function J_(Q){let p,y,f,g,k;return{c(){p=n("p"),y=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=s(v,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),k=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(v,_){m(v,p,_),e(p,y),e(p,f),e(f,g),e(p,k)},d(v){v&&t(p)}}}function G_(Q){let p,y,f,g,k,v,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me,c,T,K,_e,ke,I,ve,Te,Me,L,D,be,ge,ue,we,ie,fe,oo,Er,Wo,Al,qr,Il,mi,je,Qo,Dl,it,Sl,Is,Ol,Wl,Ds,Ql,Bl,Bo,Hl,Rl,Ul,yt,Vl,Ss,Kl,Xl,Os,Jl,Gl,Yl,Cr,Zl,ed,Ho,ui,Ft,no,xr,Ro,td,jr,od,fi,$e,Uo,nd,Vo,sd,Ws,rd,ad,id,dt,Ko,ld,Lr,dd,cd,Xo,Qs,pd,Ar,hd,md,Bs,ud,Ir,fd,gd,so,Jo,_d,Go,vd,Dr,kd,Td,Md,ro,Yo,bd,Sr,wd,Pd,Or,gi,zt,ao,Wr,Zo,Nd,Qr,$d,_i,Ze,en,yd,tn,Fd,Br,zd,Ed,qd,on,Cd,Hs,xd,jd,Ld,io,nn,Ad,Hr,Id,vi,Et,lo,Rr,sn,Dd,Ur,Sd,ki,Le,rn,Od,Vr,Wd,Qd,an,Bd,Rs,Hd,Rd,Ud,ln,Vd,dn,Kd,Xd,Jd,Oe,cn,Gd,qt,Yd,Us,Zd,ec,Kr,tc,oc,nc,co,sc,Xr,rc,ac,pn,Ti,Ct,po,Jr,hn,ic,Gr,lc,Mi,mn,We,un,dc,xt,cc,Vs,pc,hc,Yr,mc,uc,fc,ho,gc,Zr,_c,vc,fn,bi,jt,mo,ea,gn,kc,ta,Tc,wi,Ae,_n,Mc,oa,bc,wc,vn,Pc,Ks,Nc,$c,yc,kn,Fc,Tn,zc,Ec,qc,Pe,Mn,Cc,Lt,xc,Xs,jc,Lc,na,Ac,Ic,Dc,uo,Sc,sa,Oc,Wc,bn,Qc,ra,Bc,Hc,wn,Pi,At,fo,aa,Pn,Rc,ia,Uc,Ni,Ie,Nn,Vc,la,Kc,Xc,$n,Jc,Js,Gc,Yc,Zc,yn,ep,Fn,tp,op,np,Qe,zn,sp,It,rp,Gs,ap,ip,da,lp,dp,cp,go,pp,ca,hp,mp,En,$i,Dt,_o,pa,qn,up,ha,fp,yi,De,Cn,gp,ma,_p,vp,xn,kp,Ys,Tp,Mp,bp,jn,wp,Ln,Pp,Np,$p,Be,An,yp,St,Fp,Zs,zp,Ep,ua,qp,Cp,xp,vo,jp,fa,Lp,Ap,In,Fi,Ot,ko,ga,Dn,Ip,_a,Dp,zi,Se,Sn,Sp,Wt,Op,va,Wp,Qp,ka,Bp,Hp,Rp,On,Up,er,Vp,Kp,Xp,Wn,Jp,Qn,Gp,Yp,Zp,He,Bn,eh,Qt,th,tr,oh,nh,Ta,sh,rh,ah,To,ih,Ma,lh,dh,Hn,Ei,Bt,Mo,ba,Rn,ch,wa,ph,qi,ye,Un,hh,Pa,mh,uh,Vn,fh,or,gh,_h,vh,Kn,kh,Xn,Th,Mh,bh,bo,wh,Re,Jn,Ph,Ht,Nh,nr,$h,yh,Na,Fh,zh,Eh,wo,qh,$a,Ch,xh,Gn,Ci,Rt,Po,ya,Yn,jh,Fa,Lh,xi,Fe,Zn,Ah,es,Ih,za,Dh,Sh,Oh,ts,Wh,sr,Qh,Bh,Hh,os,Rh,ns,Uh,Vh,Kh,No,Xh,Ue,ss,Jh,Ut,Gh,rr,Yh,Zh,Ea,em,tm,om,$o,nm,qa,sm,rm,rs,ji,Vt,yo,Ca,as,am,xa,im,Li,ze,is,lm,ja,dm,cm,ls,pm,ar,hm,mm,um,ds,fm,cs,gm,_m,vm,Fo,km,Ve,ps,Tm,Kt,Mm,ir,bm,wm,La,Pm,Nm,$m,zo,ym,Aa,Fm,zm,hs,Ai,Xt,Eo,Ia,ms,Em,Da,qm,Ii,Ee,us,Cm,Sa,xm,jm,fs,Lm,lr,Am,Im,Dm,gs,Sm,_s,Om,Wm,Qm,qo,Bm,Ke,vs,Hm,Jt,Rm,dr,Um,Vm,Oa,Km,Xm,Jm,Co,Gm,Wa,Ym,Zm,ks,Di,Gt,xo,Qa,Ts,eu,Ba,tu,Si,qe,Ms,ou,Ha,nu,su,bs,ru,cr,au,iu,lu,ws,du,Ps,cu,pu,hu,jo,mu,Xe,Ns,uu,Yt,fu,pr,gu,_u,Ra,vu,ku,Tu,Lo,Mu,Ua,bu,wu,$s,Oi,Zt,Ao,Va,ys,Pu,Ka,Nu,Wi,Ce,Fs,$u,eo,yu,Xa,Fu,zu,Ja,Eu,qu,Cu,zs,xu,hr,ju,Lu,Au,Es,Iu,qs,Du,Su,Ou,Io,Wu,Je,Cs,Qu,to,Bu,mr,Hu,Ru,Ga,Uu,Vu,Ku,Do,Xu,Ya,Ju,Gu,xs,Qi;return v=new xe({}),J=new xe({}),Wo=new xe({}),Qo=new ne({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/mpnet/configuration_mpnet.py#L29",parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
Vocabulary size of the MPNet model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.15.0/en/model_doc/mpnet#transformers.MPNetModel">MPNetModel</a> or
<a href="/docs/transformers/v4.15.0/en/model_doc/mpnet#transformers.TFMPNetModel">TFMPNetModel</a>.`,name:"vocab_size"},{anchor:"transformers.MPNetConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),bo=new Ne({props:{$$slots:{default:[S_]},$$scope:{ctx:Q}}}),Jn=new ne({props:{name:"call",anchor:"transformers.TFMPNetModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/mpnet/modeling_tf_mpnet.py#L684",parametersDescription:[{anchor:"transformers.TFMPNetModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See
...
<span class="hljs-meta">&gt;&gt;&gt; </span>answer = <span class="hljs-string">&#x27; &#x27;</span>.join(all_tokens[tf.math.argmax(start_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] : tf.math.argmax(end_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>]+<span class="hljs-number">1</span>])`}}),{c(){p=n("meta"),y=l(),f=n("h1"),g=n("a"),k=n("span"),M(v.$$.fragment),_=l(),F=n("span"),le=a("MPNet"),U=l(),z=n("h2"),X=n("a"),S=n("span"),M(J.$$.fragment),de=l(),O=n("span"),ce=a("Overview"),se=l(),R=n("p"),A=a("The MPNet model was proposed in "),G=n("a"),V=a("MPNet: Masked and Permuted Pre-training for Language Understanding"),E=a(" by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),q=l(),Y=n("p"),B=a(`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
...
to that of the MPNet `),Bo=n("a"),Hl=a("mpnet-base"),Rl=a(" architecture."),Ul=l(),yt=n("p"),Vl=a("Configuration objects inherit from "),Ss=n("a"),Kl=a("PretrainedConfig"),Xl=a(` and can be used to control the model
outputs. Read the documentation from `),Os=n("a"),Jl=a("PretrainedConfig"),Gl=a(" for more information."),Yl=l(),Cr=n("p"),Zl=a("Examples:"),ed=l(),M(Ho.$$.fragment),ui=l(),Ft=n("h2"),no=n("a"),xr=n("span"),M(Ro.$$.fragment),td=l(),jr=n("span"),od=a("MPNetTokenizer"),fi=l(),$e=n("div"),M(Uo.$$.fragment),nd=l(),Vo=n("p"),sd=a("This tokenizer inherits from "),Ws=n("a"),rd=a("BertTokenizer"),ad=a(` which contains most of the methods. Users should
refer to the superclass for more information regarding methods.`),id=l(),dt=n("div"),M(Ko.$$.fragment),ld=l(),Lr=n("p"),dd=a(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A MPNet sequence has the following format:`),cd=l(),Xo=n("ul"),Qs=n("li"),pd=a("single sequence: "),Ar=n("code"),hd=a("<s> X </s>"),md=l(),Bs=n("li"),ud=a("pair of sequences: "),Ir=n("code"),fd=a("<s> A </s></s> B </s>"),gd=l(),so=n("div"),M(Jo.$$.fragment),_d=l(),Go=n("p"),vd=a(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned`),vi=l(),Et=n("h2"),lo=n("a"),Rr=n("span"),M(sn.$$.fragment),Dd=l(),Ur=n("span"),Sd=a("MPNetModel"),ki=l(),Le=n("div"),M(rn.$$.fragment),Od=l(),Vr=n("p"),Wd=a("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),Qd=l(),an=n("p"),Bd=a("This model inherits from "),Rs=n("a"),Hd=a("PreTrainedModel"),Rd=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ud=l(),ln=n("p"),Vd=a("This model is also a PyTorch "),dn=n("a"),Kd=a("torch.nn.Module"),Xd=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Jd=l(),Oe=n("div"),M(cn.$$.fragment),Gd=l(),qt=n("p"),Yd=a("The "),Us=n("a"),Zd=a("MPNetModel"),ec=a(" forward method, overrides the "),Kr=n("code"),tc=a("__call__"),oc=a(" special method."),nc=l(),M(co.$$.fragment),sc=l(),Xr=n("p"),rc=a("Example:"),ac=l(),M(pn.$$.fragment),Ti=l(),Ct=n("h2"),po=n("a"),Jr=n("span"),M(hn.$$.fragment),ic=l(),Gr=n("span"),lc=a("MPNetForMaskedLM"),Mi=l(),mn=n("div"),We=n("div"),M(un.$$.fragment),dc=l(),xt=n("p"),cc=a("The "),Vs=n("a"),pc=a("MPNetForMaskedLM"),hc=a(" forward method, overrides the "),Yr=n("code"),mc=a("__call__"),uc=a(" special method."),fc=l(),M(ho.$$.fragment),gc=l(),Zr=n("p"),_c=a("Example:"),vc=l(),M(fn.$$.fragment),bi=l(),jt=n("h2"),mo=n("a"),ea=n("span"),M(gn.$$.fragment),kc=l(),ta=n("span"),Tc=a("MPNetForSequenceClassification"),wi=l(),Ae=n("div"),M(_n.$$.fragment),Mc=l(),oa=n("p"),bc=a(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),wc=l(),vn=n("p"),Pc=a("This model inherits from "),Ks=n("a"),Nc=a("PreTrainedModel"),$c=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),yc=l(),kn=n("p"),Fc=a("This model is also a PyTorch "),Tn=n("a"),zc=a("torch.nn.Module"),Ec=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),qc=l(),Pe=n("div"),M(Mn.$$.fragment),Cc=l(),Lt=n("p"),xc=a("The "),Xs=n("a"),jc=a("MPNetForSequenceClassification"),Lc=a(" forward method, overrides the "),na=n("code"),Ac=a("__call__"),Ic=a(" special method."),Dc=l(),M(uo.$$.fragment),Sc=l(),sa=n("p"),Oc=a("Example of single-label classification:"),Wc=l(),M(bn.$$.fragment),Qc=l(),ra=n("p"),Bc=a("Example of multi-label classification:"),Hc=l(),M(wn.$$.fragment),Pi=l(),At=n("h2"),fo=n("a"),aa=n("span"),M(Pn.$$.fragment),Rc=l(),ia=n("span"),Uc=a("MPNetForMultipleChoice"),Ni=l(),Ie=n("div"),M(Nn.$$.fragment),Vc=l(),la=n("p"),Kc=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Xc=l(),$n=n("p"),Jc=a("This model inherits from "),Js=n("a"),Gc=a("PreTrainedModel"),Yc=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Zc=l(),yn=n("p"),ep=a("This model is also a PyTorch "),Fn=n("a"),tp=a("torch.nn.Module"),op=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),np=l(),Qe=n("div"),M(zn.$$.fragment),sp=l(),It=n("p"),rp=a("The "),Gs=n("a"),ap=a("MPNetForMultipleChoice"),ip=a(" forward method, overrides the "),da=n("code"),lp=a("__call__"),dp=a(" special method."),cp=l(),M(go.$$.fragment),pp=l(),ca=n("p"),hp=a("Example:"),mp=l(),M(En.$$.fragment),$i=l(),Dt=n("h2"),_o=n("a"),pa=n("span"),M(qn.$$.fragment),up=l(),ha=n("span"),fp=a("MPNetForTokenClassification"),yi=l(),De=n("div"),M(Cn.$$.fragment),gp=l(),ma=n("p"),_p=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),vp=l(),xn=n("p"),kp=a("This model inherits from "),Ys=n("a"),Tp=a("PreTrainedModel"),Mp=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),bp=l(),jn=n("p"),wp=a("This model is also a PyTorch "),Ln=n("a"),Pp=a("torch.nn.Module"),Np=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),$p=l(),Be=n("div"),M(An.$$.fragment),yp=l(),St=n("p"),Fp=a("The "),Zs=n("a"),zp=a("MPNetForTokenClassification"),Ep=a(" forward method, overrides the "),ua=n("code"),qp=a("__call__"),Cp=a(" special method."),xp=l(),M(vo.$$.fragment),jp=l(),fa=n("p"),Lp=a("Example:"),Ap=l(),M(In.$$.fragment),Fi=l(),Ot=n("h2"),ko=n("a"),ga=n("span"),M(Dn.$$.fragment),Ip=l(),_a=n("span"),Dp=a("MPNetForQuestionAnswering"),zi=l(),Se=n("div"),M(Sn.$$.fragment),Sp=l(),Wt=n("p"),Op=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),va=n("code"),Wp=a("span start logits"),Qp=a(" and "),ka=n("code"),Bp=a("span end logits"),Hp=a(")."),Rp=l(),On=n("p"),Up=a("This model inherits from "),er=n("a"),Vp=a("PreTrainedModel"),Kp=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Xp=l(),Wn=n("p"),Jp=a("This model is also a PyTorch "),Qn=n("a"),Gp=a("torch.nn.Module"),Yp=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Zp=l(),He=n("div"),M(Bn.$$.fragment),eh=l(),Qt=n("p"),th=a("The "),tr=n("a"),oh=a("MPNetForQuestionAnswering"),nh=a(" forward method, overrides the "),Ta=n("code"),sh=a("__call__"),rh=a(" special method."),ah=l(),M(To.$$.fragment),ih=l(),Ma=n("p"),lh=a("Example:"),dh=l(),M(Hn.$$.fragment),Ei=l(),Bt=n("h2"),Mo=n("a"),ba=n("span"),M(Rn.$$.fragment),ch=l(),wa=n("span"),ph=a("TFMPNetModel"),qi=l(),ye=n("div"),M(Un.$$.fragment),hh=l(),Pa=n("p"),mh=a("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),uh=l(),Vn=n("p"),fh=a("This model inherits from "),or=n("a"),gh=a("TFPreTrainedModel"),_h=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),vh=l(),Kn=n("p"),kh=a("This model is also a "),Xn=n("a"),Th=a("tf.keras.Model"),Mh=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),bh=l(),M(bo.$$.fragment),wh=l(),Re=n("div"),M(Jn.$$.fragment),Ph=l(),Ht=n("p"),Nh=a("The "),nr=n("a"),$h=a("TFMPNetModel"),yh=a(" forward method, overrides the "),Na=n("code"),Fh=a("__call__"),zh=a(" special method."),Eh=l(),M(wo.$$.fragment),qh=l(),$a=n("p"),Ch=a("Example:"),xh=l(),M(Gn.$$.fragment),Ci=l(),Rt=n("h2"),Po=n("a"),ya=n("span"),M(Yn.$$.fragment),jh=l(),Fa=n("span"),Lh=a("TFMPNetForMaskedLM"),xi=l(),Fe=n("div"),M(Zn.$$.fragment),Ah=l(),es=n("p"),Ih=a("MPNet Model with a "),za=n("code"),Dh=a("language modeling"),Sh=a(" head on top."),Oh=l(),ts=n("p"),Wh=a("This model inherits from "),sr=n("a"),Qh=a("TFPreTrainedModel"),Bh=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Hh=l(),os=n("p"),Rh=a("This model is also a "),ns=n("a"),Uh=a("tf.keras.Model"),Vh=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Kh=l(),M(No.$$.fragment),Xh=l(),Ue=n("div"),M(ss.$$.fragment),Jh=l(),Ut=n("p"),Gh=a("The "),rr=n("a"),Yh=a("TFMPNetForMaskedLM"),Zh=a(" forward method, overrides the "),Ea=n("code"),em=a("__call__"),tm=a(" special method."),om=l(),M($o.$$.fragment),nm=l(),qa=n("p"),sm=a("Example:"),rm=l(),M(rs.$$.fragment),ji=l(),Vt=n("h2"),yo=n("a"),Ca=n("span"),M(as.$$.fragment),am=l(),xa=n("span"),im=a("TFMPNetForSequenceClassification"),Li=l(),ze=n("div"),M(is.$$.fragment),lm=l(),ja=n("p"),dm=a(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),cm=l(),ls=n("p"),pm=a("This model inherits from "),ar=n("a"),hm=a("TFPreTrainedModel"),mm=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),um=l(),ds=n("p"),fm=a("This model is also a "),cs=n("a"),gm=a("tf.keras.Model"),_m=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),vm=l(),M(Fo.$$.fragment),km=l(),Ve=n("div"),M(ps.$$.fragment),Tm=l(),Kt=n("p"),Mm=a("The "),ir=n("a"),bm=a("TFMPNetForSequenceClassification"),wm=a(" forward method, overrides the "),La=n("code"),Pm=a("__call__"),Nm=a(" special method."),$m=l(),M(zo.$$.fragment),ym=l(),Aa=n("p"),Fm=a("Example:"),zm=l(),M(hs.$$.fragment),Ai=l(),Xt=n("h2"),Eo=n("a"),Ia=n("span"),M(ms.$$.fragment),Em=l(),Da=n("span"),qm=a("TFMPNetForMultipleChoice"),Ii=l(),Ee=n("div"),M(us.$$.fragment),Cm=l(),Sa=n("p"),xm=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),jm=l(),fs=n("p"),Lm=a("This model inherits from "),lr=n("a"),Am=a("TFPreTrainedModel"),Im=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Dm=l(),gs=n("p"),Sm=a("This model is also a "),_s=n("a"),Om=a("tf.keras.Model"),Wm=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Qm=l(),M(qo.$$.fragment),Bm=l(),Ke=n("div"),M(vs.$$.fragment),Hm=l(),Jt=n("p"),Rm=a("The "),dr=n("a"),Um=a("TFMPNetForMultipleChoice"),Vm=a(" forward method, overrides the "),Oa=n("code"),Km=a("__call__"),Xm=a(" special method."),Jm=l(),M(Co.$$.fragment),Gm=l(),Wa=n("p"),Ym=a("Example:"),Zm=l(),M(ks.$$.fragment),Di=l(),Gt=n("h2"),xo=n("a"),Qa=n("span"),M(Ts.$$.fragment),eu=l(),Ba=n("span"),tu=a("TFMPNetForTokenClassification"),Si=l(),qe=n("div"),M(Ms.$$.fragment),ou=l(),Ha=n("p"),nu=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),su=l(),bs=n("p"),ru=a("This model inherits from "),cr=n("a"),au=a("TFPreTrainedModel"),iu=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),lu=l(),ws=n("p"),du=a("This model is also a "),Ps=n("a"),cu=a("tf.keras.Model"),pu=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),hu=l(),M(jo.$$.fragment),mu=l(),Xe=n("div"),M(Ns.$$.fragment),uu=l(),Yt=n("p"),fu=a("The "),pr=n("a"),gu=a("TFMPNetForTokenClassification"),_u=a(" forward method, overrides the "),Ra=n("code"),vu=a("__call__"),ku=a(" special method."),Tu=l(),M(Lo.$$.fragment),Mu=l(),Ua=n("p"),bu=a("Example:"),wu=l(),M($s.$$.fragment),Oi=l(),Zt=n("h2"),Ao=n("a"),Va=n("span"),M(ys.$$.fragment),Pu=l(),Ka=n("span"),Nu=a("TFMPNetForQuestionAnswering"),Wi=l(),Ce=n("div"),M(Fs.$$.fragment),$u=l(),eo=n("p"),yu=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Xa=n("code"),Fu=a("span start logits"),zu=a(" and "),Ja=n("code"),Eu=a("span end logits"),qu=a(")."),Cu=l(),zs=n("p"),xu=a("This model inherits from "),hr=n("a"),ju=a("TFPreTrainedModel"),Lu=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Au=l(),Es=n("p"),Iu=a("This model is also a "),qs=n("a"),Du=a("tf.keras.Model"),Su=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Ou=l(),M(Io.$$.fragment),Wu=l(),Je=n("div"),M(Cs.$$.fragment),Qu=l(),to=n("p"),Bu=a("The "),mr=n("a"),Hu=a("TFMPNetForQuestionAnswering"),Ru=a(" forward method, overrides the "),Ga=n("code"),Uu=a("__call__"),Vu=a(" special method."),Ku=l(),M(Do.$$.fragment),Xu=l(),Ya=n("p"),Ju=a("Example:"),Gu=l(),M(xs.$$.fragment),this.h()},l(o){const u=C_('[data-svelte="svelte-1phssyn"]',document.head);p=s(u,"META",{name:!0,content:!0}),u.forEach(t),y=d(o),f=s(o,"H1",{class:!0});var js=r(f);g=s(js,"A",{id:!0,class:!0,href:!0});var Za=r(g);k=s(Za,"SPAN",{});var ei=r(k);b(v.$$.fragment,ei),ei.forEach(t),Za.forEach(t),_=d(js),F=s(js,"SPAN",{});var ti=r(F);le=i(ti,"MPNet"),ti.forEach(t),js.forEach(t),U=d(o),z=s(o,"H2",{class:!0});var Ls=r(z);X=s(Ls,"A",{id:!0,class:!0,href:!0});var oi=r(X);S=s(oi,"SPAN",{});var ni=r(S);b(J.$$.fragment,ni),ni.forEach(t),oi.forEach(t),de=d(Ls),O=s(Ls,"SPAN",{});var si=r(O);ce=i(si,"Overview"),si.forEach(t),Ls.forEach(t),se=d(o),R=s(o,"P",{});var As=r(R);A=i(As,"The MPNet model was proposed in "),G=s(As,"A",{href:!0,rel:!0});var ri=r(G);V=i(ri,"MPNet: Masked and Permuted Pre-training for Language Understanding"),ri.forEach(t),E=i(As," by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),As.forEach(t),q=d(o),Y=s(o,"P",{});var ai=r(Y);B=i(ai,`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
...
Named-Entity-Recognition (NER) tasks.`),hg.forEach(t),vp=d(_t),xn=s(_t,"P",{});var hl=r(xn);kp=i(hl,"This model inherits from "),Ys=s(hl,"A",{href:!0});var mg=r(Ys);Tp=i(mg,"PreTrainedModel"),mg.forEach(t),Mp=i(hl,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),fl.forEach(t),Xp=d(kt),Wn=s(kt,"P",{});var gl=r(Wn);Jp=i(gl,"This model is also a PyTorch "),Qn=s(gl,"A",{href:!0,rel:!0});var Pg=r(Qn);Gp=i(Pg,"torch.nn.Module"),Pg.forEach(t),Yp=i(gl,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
softmax) e.g. for RocStories/SWAG tasks.`),s_.forEach(t),jm=d(st),fs=s(st,"P",{});var Fl=r(fs);Lm=i(Fl,"This model inherits from "),lr=s(Fl,"A",{href:!0});var r_=r(lr);Am=i(r_,"TFPreTrainedModel"),r_.forEach(t),Im=i(Fl,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
