...
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function Zm(z){let p,y,u,T,$;return{c(){p=s("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function eu(z){let p,y,u,T,$;return{c(){p=s("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function tu(z){let p,y,u,T,$;return{c(){p=s("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function ou(z){let p,y,u,T,$;return{c(){p=s("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function nu(z){let p,y,u,T,$;return{c(){p=s("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function ru(z){let p,y,u,T,$;return{c(){p=s("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function su(z){let p,y,u,T,$;return{c(){p=s("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function au(z){let p,y,u,T,$;return{c(){p=s("p"),y=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),T=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var f=i(p);y=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(f,"CODE",{});var B=i(u);T=r(B,"Module"),B.forEach(o),$=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,p,f),e(p,y),e(p,u),e(u,T),e(p,$)},d(g){g&&o(p)}}}function iu(z){let p,y,u,T,$,g,f,B,Ma,ts,ke,Ue,Dn,mt,wa,Wn,Ta,os,Ge,ya,ut,$a,Ba,ns,Ko,za,rs,Xo,Rn,Fa,ss,Yo,Pa,as,Qe,xa,ft,Ea,Ca,is,ee,qa,gt,ja,Aa,_t,Na,Sa,ds,Zo,La,ls,en,Ia,cs,vt,hs,bt,ps,tn,Oa,ms,kt,us,Mt,fs,on,Da,gs,te,Wa,Hn,Ra,Ha,Un,Ua,Ga,_s,wt,vs,Tt,bs,yt,ks,oe,Qa,$t,Va,Ja,Bt,Ka,Xa,Ms,Me,Ve,Gn,zt,Ya,Qn,Za,ws,q,Ft,ei,we,ti,nn,oi,ni,Pt,ri,si,ai,Te,ii,rn,di,li,sn,ci,hi,pi,Vn,mi,ui,xt,Ts,ye,Je,Jn,Et,fi,Kn,gi,ys,F,Ct,_i,Xn,vi,bi,qt,ki,an,Mi,wi,Ti,jt,yi,At,$i,Bi,zi,Nt,Fi,St,Pi,xi,Ei,C,Ci,Yn,qi,ji,Zn,Ai,Ni,er,Si,Li,tr,Ii,Oi,or,Di,Wi,nr,Ri,Hi,Ui,W,Lt,Gi,$e,Qi,dn,Vi,Ji,rr,Ki,Xi,Yi,Ke,Zi,sr,ed,td,It,$s,Be,Xe,ar,Ot,od,ir,nd,Bs,j,Dt,rd,Wt,sd,dr,ad,id,dd,Rt,ld,ln,cd,hd,pd,Ht,md,Ut,ud,fd,gd,R,Gt,_d,ze,vd,cn,bd,kd,lr,Md,wd,Td,Ye,yd,cr,$d,Bd,Qt,zs,Fe,Ze,hr,Vt,zd,pr,Fd,Fs,A,Jt,Pd,Kt,xd,mr,Ed,Cd,qd,Xt,jd,hn,Ad,Nd,Sd,Yt,Ld,Zt,Id,Od,Dd,H,eo,Wd,Pe,Rd,pn,Hd,Ud,ur,Gd,Qd,Vd,et,Jd,fr,Kd,Xd,to,Ps,xe,tt,gr,oo,Yd,_r,Zd,xs,N,no,el,ro,tl,vr,ol,nl,rl,so,sl,mn,al,il,dl,ao,ll,io,cl,hl,pl,U,lo,ml,Ee,ul,un,fl,gl,br,_l,vl,bl,ot,kl,kr,Ml,wl,co,Es,Ce,nt,Mr,ho,Tl,wr,yl,Cs,S,po,$l,qe,Bl,Tr,zl,Fl,yr,Pl,xl,El,mo,Cl,fn,ql,jl,Al,uo,Nl,fo,Sl,Ll,Il,G,go,Ol,je,Dl,gn,Wl,Rl,$r,Hl,Ul,Gl,rt,Ql,Br,Vl,Jl,_o,qs,Ae,st,zr,vo,Kl,Fr,Xl,js,L,bo,Yl,Pr,Zl,ec,ko,tc,_n,oc,nc,rc,Mo,sc,wo,ac,ic,dc,x,To,lc,Ne,cc,vn,hc,pc,xr,mc,uc,fc,at,gc,Er,_c,vc,yo,bc,Cr,kc,Mc,$o,As,Se,it,qr,Bo,wc,jr,Tc,Ns,I,zo,yc,Ar,$c,Bc,Fo,zc,bn,Fc,Pc,xc,Po,Ec,xo,Cc,qc,jc,Q,Eo,Ac,Le,Nc,kn,Sc,Lc,Nr,Ic,Oc,Dc,dt,Wc,Sr,Rc,Hc,Co,Ss,Ie,lt,Lr,qo,Uc,Ir,Gc,Ls,O,jo,Qc,Or,Vc,Jc,Ao,Kc,Mn,Xc,Yc,Zc,No,eh,So,th,oh,nh,V,Lo,rh,Oe,sh,wn,ah,ih,Dr,dh,lh,ch,ct,hh,Wr,ph,mh,Io,Is,De,ht,Rr,Oo,uh,Hr,fh,Os,D,Do,gh,We,_h,Ur,vh,bh,Gr,kh,Mh,wh,Wo,Th,Tn,yh,$h,Bh,Ro,zh,Ho,Fh,Ph,xh,J,Uo,Eh,Re,Ch,yn,qh,jh,Qr,Ah,Nh,Sh,pt,Lh,Vr,Ih,Oh,Go,Ds;return g=new Z({}),mt=new Z({}),vt=new E({props:{code:",",highlighted:""}}),bt=new E({props:{code:`wget --content-disposition https://api.ngc.nvidia.com/v2/models/nvidia/megatron_bert_345m/versions/v0.1_uncased/zip
...
<a href="/docs/transformers/v4.15.0/en/model_doc/megatron_bert#transformers.MegatronBertModel">MegatronBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MegatronBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
of 89.4%).`),ss=d(),Yo=s("p"),Pa=n("Tips:"),as=d(),Qe=s("p"),xa=n("We have provided pretrained "),ft=s("a"),Ea=n("BERT-345M"),Ca=n(` checkpoints
for use to evaluate or finetuning downstream tasks.`),is=d(),ee=s("p"),qa=n("To access these checkpoints, first "),gt=s("a"),ja=n("sign up"),Aa=n(` for and setup the NVIDIA GPU Cloud (NGC)
...
\u201Cpipeline parallel\u201D techniques.`),Ms=d(),Me=s("h2"),Ve=s("a"),Gn=s("span"),_(zt.$$.fragment),Ya=d(),Qn=s("span"),Za=n("MegatronBertConfig"),ws=d(),q=s("div"),_(Ft.$$.fragment),ei=d(),we=s("p"),ti=n("This is the configuration class to store the configuration of a "),nn=s("a"),oi=n("MegatronBertModel"),ni=n(`. It is
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ei=d(),C=s("p"),Ci=n("To behave as an decoder the model needs to be initialized with the "),Yn=s("code"),qi=n("is_decoder"),ji=n(` argument of the configuration
...
input to the forward pass.`),Ui=d(),W=s("div"),_(Lt.$$.fragment),Gi=d(),$e=s("p"),Qi=n("The "),dn=s("a"),Vi=n("MegatronBertModel"),Ji=n(" forward method, overrides the "),rr=s("code"),Ki=n("__call__"),Xi=n(" special method."),Yi=d(),_(Ke.$$.fragment),Zi=d(),sr=s("p"),ed=n("Example:"),td=d(),_(It.$$.fragment),$s=d(),Be=s("h2"),Xe=s("a"),ar=s("span"),_(Ot.$$.fragment),od=d(),ir=s("span"),nd=n("MegatronBertForMaskedLM"),Bs=d(),j=s("div"),_(Dt.$$.fragment),rd=d(),Wt=s("p"),sd=n("MegatronBert Model with a "),dr=s("code"),ad=n("language modeling"),id=n(" head on top."),dd=d(),Rt=s("p"),ld=n("This model inherits from "),ln=s("a"),cd=n("PreTrainedModel"),hd=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),pd=d(),Ht=s("p"),md=n("This model is also a PyTorch "),Ut=s("a"),ud=n("torch.nn.Module"),fd=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),gd=d(),R=s("div"),_(Gt.$$.fragment),_d=d(),ze=s("p"),vd=n("The "),cn=s("a"),bd=n("MegatronBertForMaskedLM"),kd=n(" forward method, overrides the "),lr=s("code"),Md=n("__call__"),wd=n(" special method."),Td=d(),_(Ye.$$.fragment),yd=d(),cr=s("p"),$d=n("Example:"),Bd=d(),_(Qt.$$.fragment),zs=d(),Fe=s("h2"),Ze=s("a"),hr=s("span"),_(Vt.$$.fragment),zd=d(),pr=s("span"),Fd=n("MegatronBertForCausalLM"),Fs=d(),A=s("div"),_(Jt.$$.fragment),Pd=d(),Kt=s("p"),xd=n("MegatronBert Model with a "),mr=s("code"),Ed=n("language modeling"),Cd=n(" head on top for CLM fine-tuning."),qd=d(),Xt=s("p"),jd=n("This model inherits from "),hn=s("a"),Ad=n("PreTrainedModel"),Nd=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Sd=d(),Yt=s("p"),Ld=n("This model is also a PyTorch "),Zt=s("a"),Id=n("torch.nn.Module"),Od=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Dd=d(),H=s("div"),_(eo.$$.fragment),Wd=d(),Pe=s("p"),Rd=n("The "),pn=s("a"),Hd=n("MegatronBertForCausalLM"),Ud=n(" forward method, overrides the "),ur=s("code"),Gd=n("__call__"),Qd=n(" special method."),Vd=d(),_(et.$$.fragment),Jd=d(),fr=s("p"),Kd=n("Example:"),Xd=d(),_(to.$$.fragment),Ps=d(),xe=s("h2"),tt=s("a"),gr=s("span"),_(oo.$$.fragment),Yd=d(),_r=s("span"),Zd=n("MegatronBertForNextSentencePrediction"),xs=d(),N=s("div"),_(no.$$.fragment),el=d(),ro=s("p"),tl=n("MegatronBert Model with a "),vr=s("code"),ol=n("next sentence prediction (classification)"),nl=n(" head on top."),rl=d(),so=s("p"),sl=n("This model inherits from "),mn=s("a"),al=n("PreTrainedModel"),il=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),dl=d(),ao=s("p"),ll=n("This model is also a PyTorch "),io=s("a"),cl=n("torch.nn.Module"),hl=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),pl=d(),U=s("div"),_(lo.$$.fragment),ml=d(),Ee=s("p"),ul=n("The "),un=s("a"),fl=n("MegatronBertForNextSentencePrediction"),gl=n(" forward method, overrides the "),br=s("code"),_l=n("__call__"),vl=n(" special method."),bl=d(),_(ot.$$.fragment),kl=d(),kr=s("p"),Ml=n("Example:"),wl=d(),_(co.$$.fragment),Es=d(),Ce=s("h2"),nt=s("a"),Mr=s("span"),_(ho.$$.fragment),Tl=d(),wr=s("span"),yl=n("MegatronBertForPreTraining"),Cs=d(),S=s("div"),_(po.$$.fragment),$l=d(),qe=s("p"),Bl=n("MegatronBert Model with two heads on top as done during the pretraining: a "),Tr=s("code"),zl=n("masked language modeling"),Fl=n(` head and a
`),yr=s("code"),Pl=n("next sentence prediction (classification)"),xl=n(" head."),El=d(),mo=s("p"),Cl=n("This model inherits from "),fn=s("a"),ql=n("PreTrainedModel"),jl=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Al=d(),uo=s("p"),Nl=n("This model is also a PyTorch "),fo=s("a"),Sl=n("torch.nn.Module"),Ll=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Il=d(),G=s("div"),_(go.$$.fragment),Ol=d(),je=s("p"),Dl=n("The "),gn=s("a"),Wl=n("MegatronBertForPreTraining"),Rl=n(" forward method, overrides the "),$r=s("code"),Hl=n("__call__"),Ul=n(" special method."),Gl=d(),_(rt.$$.fragment),Ql=d(),Br=s("p"),Vl=n("Example:"),Jl=d(),_(_o.$$.fragment),qs=d(),Ae=s("h2"),st=s("a"),zr=s("span"),_(vo.$$.fragment),Kl=d(),Fr=s("span"),Xl=n("MegatronBertForSequenceClassification"),js=d(),L=s("div"),_(bo.$$.fragment),Yl=d(),Pr=s("p"),Zl=n(`MegatronBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),xc=d(),Po=s("p"),Ec=n("This model is also a PyTorch "),xo=s("a"),Cc=n("torch.nn.Module"),qc=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),jc=d(),Q=s("div"),_(Eo.$$.fragment),Ac=d(),Le=s("p"),Nc=n("The "),kn=s("a"),Sc=n("MegatronBertForMultipleChoice"),Lc=n(" forward method, overrides the "),Nr=s("code"),Ic=n("__call__"),Oc=n(" special method."),Dc=d(),_(dt.$$.fragment),Wc=d(),Sr=s("p"),Rc=n("Example:"),Hc=d(),_(Co.$$.fragment),Ss=d(),Ie=s("h2"),lt=s("a"),Lr=s("span"),_(qo.$$.fragment),Uc=d(),Ir=s("span"),Gc=n("MegatronBertForTokenClassification"),Ls=d(),O=s("div"),_(jo.$$.fragment),Qc=d(),Or=s("p"),Vc=n(`MegatronBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
linear layers on top of the hidden-states output to compute `),Ur=s("code"),vh=n("span start logits"),bh=n(" and "),Gr=s("code"),kh=n("span end logits"),Mh=n(")."),wh=d(),Wo=s("p"),Th=n("This model inherits from "),Tn=s("a"),yh=n("PreTrainedModel"),$h=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
linear layers on top of the hidden-states output to compute `),Ur=a(In,"CODE",{});var Dm=i(Ur);vh=r(Dm,"span start logits"),Dm.forEach(o),bh=r(In," and "),Gr=a(In,"CODE",{});var Wm=i(Gr);kh=r(Wm,"span end logits"),Wm.forEach(o),Mh=r(In,")."),In.forEach(o),wh=l(ve),Wo=a(ve,"P",{});var ba=i(Wo);Th=r(ba,"This model inherits from "),Tn=a(ba,"A",{href:!0});var Rm=i(Tn);yh=r(Rm,"PreTrainedModel"),Rm.forEach(o),$h=r(ba,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
