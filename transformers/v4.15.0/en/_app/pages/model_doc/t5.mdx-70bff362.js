import{S as Vw,i as Kw,s as Yw,e as o,k as d,w as f,t as a,M as Zw,c as s,d as t,m as l,a as i,x as _,h as r,b as c,F as e,g as p,y as g,q as T,o as v,B as k}from"../../chunks/vendor-ab4e3193.js";import{T as bt}from"../../chunks/Tip-b5c6375a.js";import{D as P}from"../../chunks/Docstring-b69c0bd4.js";import{C as R}from"../../chunks/CodeBlock-516df0c5.js";import{I as $e}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Jw(N){let u,$,b,y,z;return{c(){u=o("p"),$=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),y=a("Module"),z=a(`
...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var w=i(u);$=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var E=i(b);y=r(E,"Module"),E.forEach(t),z=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(x,w){p(x,u,w),e(u,$),e(u,b),e(b,y),e(u,z)},d(x){x&&t(u)}}}function dy(N){let u,$,b,y,z,x,w,E,Ee,ae,j,te,O,re,je,G,qe,Te,B,I,ie,pe,F,C,he,K,ve,ue,U,Fe,ke,M,Me,H,V,fe,A,Pe,_e,D,Ce,W,Ae,m,q,ne,Oe,rt,S,Ge,oe,it,L,Y,dt,Le,Z,lt,Ne,Ie,ct,Dl,Sa,Lp,Sl,Be,ei,ti,co,Np,Ip,ni,oi,po,Dp,Sp,si,ai,ho,Op,Gp,ri,ii,uo,Bp,Up,di,Oa,mo,Wp,Rp,Ol,Ga,Hp,Gl,wt,li,bn,ci,Vp,Kp,Ba,Yp,Zp,Jp,pi,wn,hi,Xp,Qp,Ua,eh,th,nh,ui,yn,mi,oh,sh,Wa,ah,rh,Bl,xn,ih,fo,dh,lh,Ul,yt,ch,_o,ph,hh,go,uh,mh,Wl,Ra,Rl,Ht,zn,fi,To,fh,_i,_h,Hl,pt,gh,gi,Th,vh,Ti,kh,bh,vi,wh,yh,Vl,$n,xh,Ha,zh,$h,Kl,Va,Vt,ki,Eh,jh,ge,qh,bi,Fh,Mh,wi,Ph,Ch,yi,Ah,Lh,xi,Nh,Ih,zi,Dh,Sh,Ka,Oh,Gh,Bh,$i,Uh,Yl,vo,Zl,En,Wh,ko,Rh,Hh,Jl,Ya,bo,Ei,Vh,Kh,ji,Yh,Xl,wo,Ql,se,Zh,qi,Jh,Xh,Fi,Qh,eu,Mi,tu,nu,Pi,ou,su,Ci,au,ru,Ai,iu,du,Li,lu,cu,ec,xt,pu,Ni,hu,uu,Ii,mu,fu,tc,me,_u,Di,gu,Tu,Si,vu,ku,Oi,bu,wu,Gi,yu,xu,yo,zu,$u,Bi,Eu,ju,nc,xo,oc,Za,qu,sc,zt,Ui,zo,Fu,Wi,Mu,Pu,Cu,Ri,Kt,Au,$o,Lu,Nu,Eo,Iu,Du,Su,Hi,jo,Ou,Vi,Gu,Bu,ac,Ja,rc,Yt,jn,Ki,qo,Uu,Yi,Wu,ic,ht,Ru,Xa,Hu,Vu,Fo,Ku,Yu,Mo,Zu,Ju,dc,Po,lc,Ue,Xu,Zi,Qu,em,Ji,tm,nm,Qa,om,sm,Xi,am,rm,cc,er,im,pc,Co,hc,tr,uc,Zt,qn,Qi,Ao,dm,ed,lm,mc,nr,cm,fc,Fn,td,Jt,pm,Lo,hm,um,No,mm,fm,_m,nd,De,gm,Io,Tm,vm,Do,km,bm,So,wm,ym,Oo,xm,zm,Go,$m,Em,_c,Xt,Mn,od,Bo,jm,sd,qm,gc,gt,Uo,Fm,Tt,Mm,or,Pm,Cm,sr,Am,Lm,Wo,Nm,Im,Dm,Qt,Sm,ar,Om,Gm,rr,Bm,Um,Tc,en,Pn,ad,Ro,Wm,rd,Rm,vc,J,Ho,Hm,Vo,Vm,Ko,Km,Ym,Zm,Yo,Jm,ir,Xm,Qm,ef,tn,tf,id,nf,of,dd,sf,af,rf,$t,Zo,df,ld,lf,cf,Jo,dr,pf,cd,hf,uf,lr,mf,pd,ff,_f,Cn,Xo,gf,Qo,Tf,hd,vf,kf,bf,An,es,wf,ud,yf,xf,md,kc,nn,Ln,fd,ts,zf,_d,$f,bc,Se,ns,Ef,on,jf,gd,qf,Ff,os,Mf,Pf,Cf,ss,Af,cr,Lf,Nf,If,Et,as,Df,Td,Sf,Of,rs,pr,Gf,vd,Bf,Uf,hr,Wf,kd,Rf,Hf,Nn,is,Vf,bd,Kf,wc,sn,In,wd,ds,Yf,yd,Zf,yc,X,ls,Jf,xd,Xf,Qf,cs,e_,ps,t_,n_,o_,hs,s_,ur,a_,r_,i_,us,d_,ms,l_,c_,p_,We,fs,h_,an,u_,mr,m_,f_,zd,__,g_,T_,Dn,v_,$d,k_,b_,_s,w_,Re,gs,y_,Ed,x_,z_,jd,$_,E_,qd,j_,q_,Ts,F_,ut,vs,M_,Fd,P_,C_,Md,A_,L_,ks,xc,rn,Sn,Pd,bs,N_,Cd,I_,zc,Q,ws,D_,ys,S_,Ad,O_,G_,B_,xs,U_,zs,W_,R_,H_,$s,V_,fr,K_,Y_,Z_,Es,J_,js,X_,Q_,eg,He,qs,tg,dn,ng,_r,og,sg,Ld,ag,rg,ig,On,dg,Nd,lg,cg,Fs,pg,Ve,Ms,hg,Id,ug,mg,Dd,fg,_g,Sd,gg,Tg,Ps,vg,mt,Cs,kg,Od,bg,wg,Gd,yg,xg,As,$c,ln,Gn,Bd,Ls,zg,Ud,$g,Ec,ee,Ns,Eg,Wd,jg,qg,Is,Fg,Ds,Mg,Pg,Cg,Ss,Ag,gr,Lg,Ng,Ig,Os,Dg,Gs,Sg,Og,Gg,Ke,Bs,Bg,cn,Ug,Tr,Wg,Rg,Rd,Hg,Vg,Kg,Bn,Yg,Hd,Zg,Jg,Us,Xg,Ye,Ws,Qg,Vd,eT,tT,Kd,nT,oT,Yd,sT,aT,Rs,rT,ft,Hs,iT,Zd,dT,lT,Jd,cT,pT,Vs,jc,pn,Un,Xd,Ks,hT,Qd,uT,qc,de,Ys,mT,el,fT,_T,Zs,gT,Js,TT,vT,kT,Xs,bT,vr,wT,yT,xT,Qs,zT,ea,$T,ET,jT,Wn,qT,Ze,ta,FT,hn,MT,kr,PT,CT,tl,AT,LT,NT,Rn,IT,nl,DT,ST,na,Fc,un,Hn,ol,oa,OT,sl,GT,Mc,le,sa,BT,aa,UT,al,WT,RT,HT,ra,VT,ia,KT,YT,ZT,da,JT,br,XT,QT,ev,la,tv,ca,nv,ov,sv,Vn,av,Je,pa,rv,mn,iv,wr,dv,lv,rl,cv,pv,hv,Kn,uv,il,mv,fv,ha,Pc,fn,Yn,dl,ua,_v,ll,gv,Cc,ce,ma,Tv,cl,vv,kv,fa,bv,_a,wv,yv,xv,ga,zv,yr,$v,Ev,jv,Ta,qv,va,Fv,Mv,Pv,Zn,Cv,Xe,ka,Av,_n,Lv,xr,Nv,Iv,pl,Dv,Sv,Ov,Jn,Gv,hl,Bv,Uv,ba,Ac,gn,Xn,ul,wa,Wv,ml,Rv,Lc,vt,Qe,ya,Hv,Tn,Vv,fl,Kv,Yv,_l,Zv,Jv,Xv,Qn,Qv,gl,ek,tk,xa,nk,jt,za,ok,Tl,sk,ak,$a,rk,qt,Ea,ik,vl,dk,lk,ja,Nc,vn,eo,kl,qa,ck,bl,pk,Ic,kt,et,Fa,hk,kn,uk,wl,mk,fk,yl,_k,gk,Tk,to,vk,xl,kk,bk,Ma,wk,Ft,Pa,yk,zl,xk,zk,Ca,$k,Mt,Aa,Ek,$l,jk,qk,La,Dc;return x=new $e({}),re=new $e({}),To=new $e({}),vo=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`}}),Dn=new bt({props:{$$slots:{default:[Jw]},$$scope:{ctx:N}}}),_s=new R({props:{code:`from transformers import T5Tokenizer, T5Model
...
`}}),Jn=new bt({props:{$$slots:{default:[ay]},$$scope:{ctx:N}}}),ba=new R({props:{code:`from transformers import T5Tokenizer, TFT5EncoderModel
...
processed as follows:`),Yl=d(),f(vo.$$.fragment),Zl=d(),En=o("p"),Wh=a("If you\u2019re interested in pre-training T5 on a new corpus, check out the "),ko=o("a"),Rh=a("run_t5_mlm_flax.py"),Hh=a(` script in the Examples
directory.`),Jl=d(),Ya=o("ul"),bo=o("li"),Ei=o("p"),Vh=a("Supervised training"),Kh=d(),ji=o("p"),Yh=a(`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),Xl=d(),f(wo.$$.fragment),Ql=d(),se=o("p"),Zh=a("As you can see, only 2 inputs are required for the model in order to compute a loss: "),qi=o("code"),Jh=a("input_ids"),Xh=a(` (which are the
...
ignored. The code example below illustrates all of this.`),nc=d(),f(xo.$$.fragment),oc=d(),Za=o("p"),qu=a("Additional training tips:"),sc=d(),zt=o("ul"),Ui=o("li"),zo=o("p"),Fu=a("T5 models need a slightly higher learning rate than the default one set in the "),Wi=o("code"),Mu=a("Trainer"),Pu=a(` when using the AdamW
...
batch) leads to very slow training on TPU.`),ac=d(),Ja=o("a"),rc=d(),Yt=o("h2"),jn=o("a"),Ki=o("span"),f(qo.$$.fragment),Uu=d(),Yi=o("span"),Wu=a("Inference"),ic=d(),ht=o("p"),Ru=a("At inference time, it is recommended to use "),Xa=o("a"),Hu=a("generate()"),Vu=a(`. This
...
There\u2019s also `),Mo=o("a"),Zu=a("this blog post"),Ju=a(` which explains how
generation works in general in encoder-decoder models.`),dc=d(),f(Po.$$.fragment),lc=d(),Ue=o("p"),Xu=a("Note that T5 uses the "),Zi=o("code"),Qu=a("pad_token_id"),em=a(" as the "),Ji=o("code"),tm=a("decoder_start_token_id"),nm=a(`, so when doing generation without using
`),Qa=o("a"),om=a("generate()"),sm=a(", make sure you start it with the "),Xi=o("code"),am=a("pad_token_id"),rm=a("."),cc=d(),er=o("p"),im=a("The example above only shows a single example. You can also do batched inference, like so:"),pc=d(),f(Co.$$.fragment),hc=d(),tr=o("a"),uc=d(),Zt=o("h2"),qn=o("a"),Qi=o("span"),f(Ao.$$.fragment),dm=d(),ed=o("span"),lm=a("Example scripts"),mc=d(),nr=o("p"),cm=a("T5 is supported by several example scripts, both for pre-training and fine-tuning."),fc=d(),Fn=o("ul"),td=o("li"),Jt=o("p"),pm=a("pre-training: the "),Lo=o("a"),hm=a("run_t5_mlm_flax.py"),um=a(`
...
outputs. Read the documentation from `),rr=o("a"),Bm=a("PretrainedConfig"),Um=a(" for more information."),Tc=d(),en=o("h2"),Pn=o("a"),ad=o("span"),f(Ro.$$.fragment),Wm=d(),rd=o("span"),Rm=a("T5Tokenizer"),vc=d(),J=o("div"),f(Ho.$$.fragment),Hm=d(),Vo=o("p"),Vm=a("Construct a T5 tokenizer. Based on "),Ko=o("a"),Km=a("SentencePiece"),Ym=a("."),Zm=d(),Yo=o("p"),Jm=a("This tokenizer inherits from "),ir=o("a"),Xm=a("PreTrainedTokenizer"),Qm=a(` which contains most of the main methods.
...
The `),dd=o("em"),sf=a("SentencePiece"),af=a(" processor that is used for every conversion (string, tokens and IDs)."),rf=d(),$t=o("div"),f(Zo.$$.fragment),df=d(),ld=o("p"),lf=a(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),cf=d(),Jo=o("ul"),dr=o("li"),pf=a("single sequence: "),cd=o("code"),hf=a("X </s>"),uf=d(),lr=o("li"),mf=a("pair of sequences: "),pd=o("code"),ff=a("A </s> B </s>"),_f=d(),Cn=o("div"),f(Xo.$$.fragment),gf=d(),Qo=o("p"),Tf=a(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
use of token type ids, therefore a list of zeros is returned.`),wc=d(),sn=o("h2"),In=o("a"),wd=o("span"),f(ds.$$.fragment),Yf=d(),yd=o("span"),Zf=a("T5Model"),yc=d(),X=o("div"),f(ls.$$.fragment),Jf=d(),xd=o("p"),Xf=a("The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Qf=d(),cs=o("p"),e_=a("The T5 model was proposed in "),ps=o("a"),t_=a("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),n_=a(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Z_=d(),Es=o("p"),J_=a("This model is also a PyTorch "),js=o("a"),X_=a("torch.nn.Module"),Q_=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Gg=d(),Ke=o("div"),f(Bs.$$.fragment),Bg=d(),cn=o("p"),Ug=a("The "),Tr=o("a"),Wg=a("T5EncoderModel"),Rg=a(" forward method, overrides the "),Rd=o("code"),Hg=a("__call__"),Vg=a(" special method."),Kg=d(),f(Bn.$$.fragment),Yg=d(),Hd=o("p"),Zg=a("Example:"),Jg=d(),f(Us.$$.fragment),Xg=d(),Ye=o("div"),f(Ws.$$.fragment),Qg=d(),Vd=o("p"),eT=a("This is an experimental feature and is a subject to change at a moment\u2019s notice."),tT=d(),Kd=o("p"),nT=a(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),oT=d(),Yd=o("p"),sT=a("Example:"),aT=d(),f(Rs.$$.fragment),rT=d(),ft=o("div"),f(Hs.$$.fragment),iT=d(),Zd=o("p"),dT=a("Moves the model to cpu from a model parallel state."),lT=d(),Jd=o("p"),cT=a("Example:"),pT=d(),f(Vs.$$.fragment),jc=d(),pn=o("h2"),Un=o("a"),Xd=o("span"),f(Ks.$$.fragment),hT=d(),Qd=o("span"),uT=a("TFT5Model"),qc=d(),de=o("div"),f(Ys.$$.fragment),mT=d(),el=o("p"),fT=a("The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),_T=d(),Zs=o("p"),gT=a("The T5 model was proposed in "),Js=o("a"),TT=a("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),vT=a(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a text-to-text
...
for summarization: `),W=s($r,"EM",{});var Ok=i(W);Ae=r(Ok,"summarize: \u2026"),Ok.forEach(t),m=r($r,"."),$r.forEach(t),Dk.forEach(t),q=l(zr),ne=s(zr,"LI",{});var Gk=i(ne);Oe=s(Gk,"P",{});var Bk=i(Oe);rt=r(Bk,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),Bk.forEach(t),Gk.forEach(t),S=l(zr),Ge=s(zr,"LI",{});var Uk=i(Ge);oe=s(Uk,"P",{});var no=i(oe);it=r(no,"See the "),L=s(no,"A",{href:!0});var Wk=i(L);Y=r(Wk,"training"),Wk.forEach(t),dt=r(no,", "),Le=s(no,"A",{href:!0});var Rk=i(Le);Z=r(Rk,"inference"),Rk.forEach(t),lt=r(no," and "),Ne=s(no,"A",{href:!0});var Hk=i(Ne);Ie=r(Hk,"scripts"),Hk.forEach(t),ct=r(no," sections below for all details regarding usage."),no.forEach(t),Uk.forEach(t),zr.forEach(t),Dl=l(n),Sa=s(n,"P",{});var Vk=i(Sa);Lp=r(Vk,"T5 comes in different sizes:"),Vk.forEach(t),Sl=l(n),Be=s(n,"UL",{});var Pt=i(Be);ei=s(Pt,"LI",{});var Kk=i(ei);ti=s(Kk,"P",{});var Yk=i(ti);co=s(Yk,"A",{href:!0,rel:!0});var Zk=i(co);Np=r(Zk,"t5-small"),Zk.forEach(t),Yk.forEach(t),Kk.forEach(t),Ip=l(Pt),ni=s(Pt,"LI",{});var Jk=i(ni);oi=s(Jk,"P",{});var Xk=i(oi);po=s(Xk,"A",{href:!0,rel:!0});var Qk=i(po);Dp=r(Qk,"t5-base"),Qk.forEach(t),Xk.forEach(t),Jk.forEach(t),Sp=l(Pt),si=s(Pt,"LI",{});var e5=i(si);ai=s(e5,"P",{});var t5=i(ai);ho=s(t5,"A",{href:!0,rel:!0});var n5=i(ho);Op=r(n5,"t5-large"),n5.forEach(t),t5.forEach(t),e5.forEach(t),Gp=l(Pt),ri=s(Pt,"LI",{});var o5=i(ri);ii=s(o5,"P",{});var s5=i(ii);uo=s(s5,"A",{href:!0,rel:!0});var a5=i(uo);Bp=r(a5,"t5-3b"),a5.forEach(t),s5.forEach(t),o5.forEach(t),Up=l(Pt),di=s(Pt,"LI",{});var r5=i(di);Oa=s(r5,"P",{});var Fk=i(Oa);mo=s(Fk,"A",{href:!0,rel:!0});var i5=i(mo);Wp=r(i5,"t5-11b"),i5.forEach(t),Rp=r(Fk,"."),Fk.forEach(t),r5.forEach(t),Pt.forEach(t),Ol=l(n),Ga=s(n,"P",{});var d5=i(Ga);Hp=r(d5,"Based on the original T5 model, Google has released some follow-up works:"),d5.forEach(t),Gl=l(n),wt=s(n,"UL",{});var Er=i(wt);li=s(Er,"LI",{});var l5=i(li);bn=s(l5,"P",{});var Ll=i(bn);ci=s(Ll,"STRONG",{});var c5=i(ci);Vp=r(c5,"T5v1.1"),c5.forEach(t),Kp=r(Ll,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),Ba=s(Ll,"A",{href:!0});var p5=i(Ba);Yp=r(p5,"here"),p5.forEach(t),Zp=r(Ll,"."),Ll.forEach(t),l5.forEach(t),Jp=l(Er),pi=s(Er,"LI",{});var h5=i(pi);wn=s(h5,"P",{});var Nl=i(wn);hi=s(Nl,"STRONG",{});var u5=i(hi);Xp=r(u5,"mT5"),u5.forEach(t),Qp=r(Nl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
...
processed as follows:`),N5.forEach(t),qr.forEach(t),j5.forEach(t),Yl=l(n),_(vo.$$.fragment,n),Zl=l(n),En=s(n,"P",{});var Bc=i(En);Wh=r(Bc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),ko=s(Bc,"A",{href:!0,rel:!0});var I5=i(ko);Rh=r(I5,"run_t5_mlm_flax.py"),I5.forEach(t),Hh=r(Bc,` script in the Examples
directory.`),Bc.forEach(t),Jl=l(n),Ya=s(n,"UL",{});var D5=i(Ya);bo=s(D5,"LI",{});var Uc=i(bo);Ei=s(Uc,"P",{});var S5=i(Ei);Vh=r(S5,"Supervised training"),S5.forEach(t),Kh=l(Uc),ji=s(Uc,"P",{});var O5=i(ji);Yh=r(O5,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),O5.forEach(t),Uc.forEach(t),D5.forEach(t),Xl=l(n),_(wo.$$.fragment,n),Ql=l(n),se=s(n,"P",{});var be=i(se);Zh=r(be,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),qi=s(be,"CODE",{});var G5=i(qi);Jh=r(G5,"input_ids"),G5.forEach(t),Xh=r(be,` (which are the
...
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Fr.forEach(t),tc=l(n),me=s(n,"P",{});var nt=i(me);_u=r(nt,"In addition, we must make sure that padding token id\u2019s of the "),Di=s(nt,"CODE",{});var Z5=i(Di);gu=r(Z5,"labels"),Z5.forEach(t),Tu=r(nt,` are not taken into account by the loss
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Si=s(nt,"CODE",{});var J5=i(Si);vu=r(J5,"ignore_index"),J5.forEach(t),ku=r(nt,`
...
ignored. The code example below illustrates all of this.`),nt.forEach(t),nc=l(n),_(xo.$$.fragment,n),oc=l(n),Za=s(n,"P",{});var nb=i(Za);qu=r(nb,"Additional training tips:"),nb.forEach(t),sc=l(n),zt=s(n,"UL",{});var Mr=i(zt);Ui=s(Mr,"LI",{});var ob=i(Ui);zo=s(ob,"P",{});var Wc=i(zo);Fu=r(Wc,"T5 models need a slightly higher learning rate than the default one set in the "),Wi=s(Wc,"CODE",{});var sb=i(Wi);Mu=r(sb,"Trainer"),sb.forEach(t),Pu=r(Wc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
...
There\u2019s also `),Mo=s(so,"A",{href:!0,rel:!0});var fb=i(Mo);Zu=r(fb,"this blog post"),fb.forEach(t),Ju=r(so,` which explains how
generation works in general in encoder-decoder models.`),so.forEach(t),dc=l(n),_(Po.$$.fragment,n),lc=l(n),Ue=s(n,"P",{});var Ct=i(Ue);Xu=r(Ct,"Note that T5 uses the "),Zi=s(Ct,"CODE",{});var _b=i(Zi);Qu=r(_b,"pad_token_id"),_b.forEach(t),em=r(Ct," as the "),Ji=s(Ct,"CODE",{});var gb=i(Ji);tm=r(gb,"decoder_start_token_id"),gb.forEach(t),nm=r(Ct,`, so when doing generation without using
`),Qa=s(Ct,"A",{href:!0});var Tb=i(Qa);om=r(Tb,"generate()"),Tb.forEach(t),sm=r(Ct,", make sure you start it with the "),Xi=s(Ct,"CODE",{});var vb=i(Xi);am=r(vb,"pad_token_id"),vb.forEach(t),rm=r(Ct,"."),Ct.forEach(t),cc=l(n),er=s(n,"P",{});var kb=i(er);im=r(kb,"The example above only shows a single example. You can also do batched inference, like so:"),kb.forEach(t),pc=l(n),_(Co.$$.fragment,n),hc=l(n),tr=s(n,"A",{id:!0}),i(tr).forEach(t),uc=l(n),Zt=s(n,"H2",{class:!0});var Vc=i(Zt);qn=s(Vc,"A",{id:!0,class:!0,href:!0});var bb=i(qn);Qi=s(bb,"SPAN",{});var wb=i(Qi);_(Ao.$$.fragment,wb),wb.forEach(t),bb.forEach(t),dm=l(Vc),ed=s(Vc,"SPAN",{});var yb=i(ed);lm=r(yb,"Example scripts"),yb.forEach(t),Vc.forEach(t),mc=l(n),nr=s(n,"P",{});var xb=i(nr);cm=r(xb,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),xb.forEach(t),fc=l(n),Fn=s(n,"UL",{});var Kc=i(Fn);td=s(Kc,"LI",{});var zb=i(td);Jt=s(zb,"P",{});var Cr=i(Jt);pm=r(Cr,"pre-training: the "),Lo=s(Cr,"A",{href:!0,rel:!0});var $b=i(Lo);hm=r($b,"run_t5_mlm_flax.py"),$b.forEach(t),um=r(Cr,`
...
outputs. Read the documentation from `),rr=s(Lr,"A",{href:!0});var Gb=i(rr);Bm=r(Gb,"PretrainedConfig"),Gb.forEach(t),Um=r(Lr," for more information."),Lr.forEach(t),Ar.forEach(t),Tc=l(n),en=s(n,"H2",{class:!0});var Zc=i(en);Pn=s(Zc,"A",{id:!0,class:!0,href:!0});var Bb=i(Pn);ad=s(Bb,"SPAN",{});var Ub=i(ad);_(Ro.$$.fragment,Ub),Ub.forEach(t),Bb.forEach(t),Wm=l(Zc),rd=s(Zc,"SPAN",{});var Wb=i(rd);Rm=r(Wb,"T5Tokenizer"),Wb.forEach(t),Zc.forEach(t),vc=l(n),J=s(n,"DIV",{class:!0});var we=i(J);_(Ho.$$.fragment,we),Hm=l(we),Vo=s(we,"P",{});var Jc=i(Vo);Vm=r(Jc,"Construct a T5 tokenizer. Based on "),Ko=s(Jc,"A",{href:!0,rel:!0});var Rb=i(Ko);Km=r(Rb,"SentencePiece"),Rb.forEach(t),Ym=r(Jc,"."),Jc.forEach(t),Zm=l(we),Yo=s(we,"P",{});var Xc=i(Yo);Jm=r(Xc,"This tokenizer inherits from "),ir=s(Xc,"A",{href:!0});var Hb=i(ir);Xm=r(Hb,"PreTrainedTokenizer"),Hb.forEach(t),Qm=r(Xc,` which contains most of the main methods.
...
The `),dd=s(Nr,"EM",{});var Kb=i(dd);sf=r(Kb,"SentencePiece"),Kb.forEach(t),af=r(Nr," processor that is used for every conversion (string, tokens and IDs)."),Nr.forEach(t),rf=l(we),$t=s(we,"DIV",{class:!0});var Ir=i($t);_(Zo.$$.fragment,Ir),df=l(Ir),ld=s(Ir,"P",{});var Yb=i(ld);lf=r(Yb,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),Yb.forEach(t),cf=l(Ir),Jo=s(Ir,"UL",{});var Qc=i(Jo);dr=s(Qc,"LI",{});var Mk=i(dr);pf=r(Mk,"single sequence: "),cd=s(Mk,"CODE",{});var Zb=i(cd);hf=r(Zb,"X </s>"),Zb.forEach(t),Mk.forEach(t),uf=l(Qc),lr=s(Qc,"LI",{});var Pk=i(lr);mf=r(Pk,"pair of sequences: "),pd=s(Pk,"CODE",{});var Jb=i(pd);ff=r(Jb,"A </s> B </s>"),Jb.forEach(t),Pk.forEach(t),Qc.forEach(t),Ir.forEach(t),_f=l(we),Cn=s(we,"DIV",{class:!0});var ep=i(Cn);_(Xo.$$.fragment,ep),gf=l(ep),Qo=s(ep,"P",{});var tp=i(Qo);Tf=r(tp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
use of token type ids, therefore a list of zeros is returned.`),l1.forEach(t),rp.forEach(t),At.forEach(t),wc=l(n),sn=s(n,"H2",{class:!0});var ip=i(sn);In=s(ip,"A",{id:!0,class:!0,href:!0});var c1=i(In);wd=s(c1,"SPAN",{});var p1=i(wd);_(ds.$$.fragment,p1),p1.forEach(t),c1.forEach(t),Yf=l(ip),yd=s(ip,"SPAN",{});var h1=i(yd);Zf=r(h1,"T5Model"),h1.forEach(t),ip.forEach(t),yc=l(n),X=s(n,"DIV",{class:!0});var ye=i(X);_(ls.$$.fragment,ye),Jf=l(ye),xd=s(ye,"P",{});var u1=i(xd);Xf=r(u1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),u1.forEach(t),Qf=l(ye),cs=s(ye,"P",{});var dp=i(cs);e_=r(dp,"The T5 model was proposed in "),ps=s(dp,"A",{href:!0,rel:!0});var m1=i(ps);t_=r(m1,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),m1.forEach(t),n_=r(dp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a text-to-text
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),mp.forEach(t),Z_=l(xe),Es=s(xe,"P",{});var fp=i(Es);J_=r(fp,"This model is also a PyTorch "),js=s(fp,"A",{href:!0,rel:!0});var M1=i(js);X_=r(M1,"torch.nn.Module"),M1.forEach(t),Q_=r(fp,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),vp.forEach(t),Gg=l(ze),Ke=s(ze,"DIV",{class:!0});var St=i(Ke);_(Bs.$$.fragment,St),Bg=l(St),cn=s(St,"P",{});var Br=i(cn);Ug=r(Br,"The "),Tr=s(Br,"A",{href:!0});var V1=i(Tr);Wg=r(V1,"T5EncoderModel"),V1.forEach(t),Rg=r(Br," forward method, overrides the "),Rd=s(Br,"CODE",{});var K1=i(Rd);Hg=r(K1,"__call__"),K1.forEach(t),Vg=r(Br," special method."),Br.forEach(t),Kg=l(St),_(Bn.$$.fragment,St),Yg=l(St),Hd=s(St,"P",{});var Y1=i(Hd);Zg=r(Y1,"Example:"),Y1.forEach(t),Jg=l(St),_(Us.$$.fragment,St),St.forEach(t),Xg=l(ze),Ye=s(ze,"DIV",{class:!0});var Ot=i(Ye);_(Ws.$$.fragment,Ot),Qg=l(Ot),Vd=s(Ot,"P",{});var Z1=i(Vd);eT=r(Z1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Z1.forEach(t),tT=l(Ot),Kd=s(Ot,"P",{});var J1=i(Kd);nT=r(J1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),J1.forEach(t),oT=l(Ot),Yd=s(Ot,"P",{});var X1=i(Yd);sT=r(X1,"Example:"),X1.forEach(t),aT=l(Ot),_(Rs.$$.fragment,Ot),Ot.forEach(t),rT=l(ze),ft=s(ze,"DIV",{class:!0});var lo=i(ft);_(Hs.$$.fragment,lo),iT=l(lo),Zd=s(lo,"P",{});var Q1=i(Zd);dT=r(Q1,"Moves the model to cpu from a model parallel state."),Q1.forEach(t),lT=l(lo),Jd=s(lo,"P",{});var ew=i(Jd);cT=r(ew,"Example:"),ew.forEach(t),pT=l(lo),_(Vs.$$.fragment,lo),lo.forEach(t),ze.forEach(t),jc=l(n),pn=s(n,"H2",{class:!0});var kp=i(pn);Un=s(kp,"A",{id:!0,class:!0,href:!0});var tw=i(Un);Xd=s(tw,"SPAN",{});var nw=i(Xd);_(Ks.$$.fragment,nw),nw.forEach(t),tw.forEach(t),hT=l(kp),Qd=s(kp,"SPAN",{});var ow=i(Qd);uT=r(ow,"TFT5Model"),ow.forEach(t),kp.forEach(t),qc=l(n),de=s(n,"DIV",{class:!0});var ot=i(de);_(Ys.$$.fragment,ot),mT=l(ot),el=s(ot,"P",{});var sw=i(el);fT=r(sw,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),sw.forEach(t),_T=l(ot),Zs=s(ot,"P",{});var bp=i(Zs);gT=r(bp,"The T5 model was proposed in "),Js=s(bp,"A",{href:!0,rel:!0});var aw=i(Js);TT=r(aw,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),aw.forEach(t),vT=r(bp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a text-to-text
