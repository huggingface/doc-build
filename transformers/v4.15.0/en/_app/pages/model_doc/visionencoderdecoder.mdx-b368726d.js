import{S as Ns,i as Rs,s as Bs,e as a,k as c,w,t as n,M as Gs,c as s,d as o,m as l,a as d,x as E,h as t,b as i,F as e,g as _,y as x,q as T,o as k,B as j}from"../../chunks/vendor-ab4e3193.js";import{T as Os}from"../../chunks/Tip-b5c6375a.js";import{D as oe}from"../../chunks/Docstring-b69c0bd4.js";import{C as tn}from"../../chunks/CodeBlock-516df0c5.js";import{I as $n}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Ws(me){let p,P,g,D,A;return{c(){p=a("p"),P=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),D=n("Module"),A=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(M){p=s(M,"P",{});var $=d(p);P=t($,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s($,"CODE",{});var I=d(g);D=t(I,"Module"),I.forEach(o),A=t($,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(M){p=s(M,"P",{});var $=d(p);P=t($,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s($,"CODE",{});var I=d(g);D=t(I,"Module"),I.forEach(o),A=t($,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),$.forEach(o)},m(M,$){_(M,p,$),e(p,P),e(p,g),e(g,D),e(p,A)},d(M){M&&o(p)}}}function Hs(me){let p,P,g,D,A,M,$,I,Pn,rn,u,Cn,Ye,qn,zn,To,Fn,An,Je,Sn,In,Ke,Ln,On,Qe,Nn,Rn,ko,Bn,Gn,Xe,Wn,Un,eo,Hn,Zn,oo,Yn,Jn,an,ne,Kn,he,Qn,Xn,sn,L,et,no,ot,nt,to,tt,rt,dn,W,te,jo,fe,at,Do,st,cn,V,ge,dt,re,ro,it,ct,ao,lt,pt,mt,U,ht,so,ft,gt,io,ut,_t,vt,Mo,bt,yt,ue,wt,ae,_e,Et,ve,xt,co,Tt,kt,jt,se,be,Dt,H,Mt,Vo,Vt,$t,$o,Pt,Ct,ln,Z,de,Po,ye,qt,Co,zt,pn,h,we,Ft,Y,At,qo,St,It,zo,Lt,Ot,Nt,Ee,Rt,xe,Bt,Gt,Wt,Te,Ut,ke,Ht,Zt,Yt,Fo,Jt,Kt,je,Qt,lo,Xt,er,or,De,nr,Me,tr,rr,ar,O,po,sr,dr,Ao,ir,cr,So,lr,pr,mr,C,Ve,hr,J,fr,mo,gr,ur,Io,_r,vr,br,ie,yr,Lo,wr,Er,$e,xr,q,Pe,Tr,Oo,kr,jr,K,Dr,No,Mr,Vr,Ro,$r,Pr,Cr,Bo,qr,zr,Ce,mn,Q,ce,Go,qe,Fr,Wo,Ar,hn,f,ze,Sr,X,Ir,Uo,Lr,Or,Ho,Nr,Rr,Br,Fe,Gr,Ae,Wr,Ur,Hr,Se,Zr,Ie,Yr,Jr,Kr,Zo,Qr,Xr,Le,ea,ho,oa,na,ta,Oe,ra,Ne,aa,sa,da,N,fo,ia,ca,Yo,la,pa,Jo,ma,ha,fa,z,Re,ga,ee,ua,go,_a,va,Ko,ba,ya,wa,le,Ea,Qo,xa,Ta,Be,ka,S,Ge,ja,Xo,Da,Ma,en,Va,$a,We,fn;return M=new $n({}),fe=new $n({}),ge=new oe({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){p=a("meta"),P=c(),g=a("h1"),D=a("a"),A=a("span"),w(M.$$.fragment),$=c(),I=a("span"),Pn=n("Vision Encoder Decoder Models"),rn=c(),u=a("p"),Cn=n("The "),Ye=a("a"),qn=n("VisionEncoderDecoderModel"),zn=n(` can be used to initialize an image-to-text-sequence model with any
pretrained vision autoencoding model as the encoder (`),To=a("em"),Fn=n("e.g."),An=c(),Je=a("a"),Sn=n("ViT"),In=n(", "),Ke=a("a"),Ln=n("BEiT"),On=n(", "),Qe=a("a"),Nn=n("DeiT"),Rn=n(`)
and any pretrained language model as the decoder (`),ko=a("em"),Bn=n("e.g."),Gn=c(),Xe=a("a"),Wn=n("RoBERTa"),Un=n(", "),eo=a("a"),Hn=n("GPT2"),Zn=n(", "),oo=a("a"),Yn=n("BERT"),Jn=n(")."),an=c(),ne=a("p"),Kn=n(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
model configuration and decoder model configuration.`),jt=c(),se=a("div"),w(be.$$.fragment),Dt=c(),H=a("p"),Mt=n("Serializes this instance to a Python dictionary. Override the default "),Vo=a("em"),Vt=n("to_dict()"),$t=n(" from "),$o=a("em"),Pt=n("PretrainedConfig"),Ct=n("."),ln=c(),Z=a("h2"),de=a("a"),Po=a("span"),w(ye.$$.fragment),qt=c(),Co=a("span"),zt=n("VisionEncoderDecoderModel"),pn=c(),h=a("div"),w(we.$$.fragment),Ft=c(),Y=a("p"),At=n(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),qo=a("code"),St=n("from_pretrained()"),It=n(` function and the decoder is loaded via
`),zo=a("code"),Lt=n("from_pretrained()"),Ot=n(` function. Cross-attention layers are automatically added
...
character recognition (OCR) yields a significant performance improvement.`),Yt=c(),Fo=a("p"),Jt=n(`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
...
:meth`),So=a("em"),lr=n("~transformers.AutoModelForCausalLM.from_pretrained"),pr=n(" class method for the decoder."),mr=c(),C=a("div"),w(Ve.$$.fragment),hr=c(),J=a("p"),fr=n("The "),mo=a("a"),gr=n("VisionEncoderDecoderModel"),ur=n(" forward method, overrides the "),Io=a("code"),_r=n("__call__"),vr=n(" special method."),br=c(),w(ie.$$.fragment),yr=c(),Lo=a("p"),wr=n("Examples:"),Er=c(),w($e.$$.fragment),xr=c(),q=a("div"),w(Pe.$$.fragment),Tr=c(),Oo=a("p"),kr=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
train the model, you need to first set it back in training mode with `),Ro=a("code"),$r=n("model.train()"),Pr=n("."),Cr=c(),Bo=a("p"),qr=n("Example:"),zr=c(),w(Ce.$$.fragment),mn=c(),Q=a("h2"),ce=a("a"),Go=a("span"),w(qe.$$.fragment),Fr=c(),Wo=a("span"),Ar=n("FlaxVisionEncoderDecoderModel"),hn=c(),f=a("div"),w(ze.$$.fragment),Sr=c(),X=a("p"),Ir=n(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Uo=a("code"),Lr=n("from_pretrained()"),Or=n(` function and the decoder is loaded via
...
Zhou, Wei Li, Peter J. Liu.`),Hr=c(),Se=a("p"),Zr=n("Additionally, in "),Ie=a("a"),Yr=n("TrOCR: Transformer-based Optical Character Recognition with Pre-trained Models"),Jr=n(` it is shown how leveraging large pretrained vision models for optical
...
other models (see the examples for more information).`),Xr=c(),Le=a("p"),ea=n("This model inherits from "),ho=a("a"),oa=n("FlaxPreTrainedModel"),na=n(`. Check the superclass documentation for the
...
:meth`),Yo=a("em"),la=n("~transformers.FlaxAutoModel.from_pretrained"),pa=n(` class method for the encoder and
:meth`),Jo=a("em"),ma=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),ha=n(" class method for the decoder."),fa=c(),z=a("div"),w(Re.$$.fragment),ga=c(),ee=a("p"),ua=n("The "),go=a("a"),_a=n("FlaxVisionEncoderDecoderModel"),va=n(" forward method, overrides the "),Ko=a("code"),ba=n("__call__"),ya=n(" special method."),wa=c(),w(le.$$.fragment),Ea=c(),Qo=a("p"),xa=n("Examples:"),Ta=c(),w(Be.$$.fragment),ka=c(),S=a("div"),w(Ge.$$.fragment),ja=c(),Xo=a("p"),Da=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Ma=c(),en=a("p"),Va=n("Example:"),$a=c(),w(We.$$.fragment),this.h()},l(r){const m=Gs('[data-svelte="svelte-1phssyn"]',document.head);p=s(m,"META",{name:!0,content:!0}),m.forEach(o),P=l(r),g=s(r,"H1",{class:!0});var Ue=d(g);D=s(Ue,"A",{id:!0,class:!0,href:!0});var on=d(D);A=s(on,"SPAN",{});var Pa=d(A);E(M.$$.fragment,Pa),Pa.forEach(o),on.forEach(o),$=l(Ue),I=s(Ue,"SPAN",{});var Ca=d(I);Pn=t(Ca,"Vision Encoder Decoder Models"),Ca.forEach(o),Ue.forEach(o),rn=l(r),u=s(r,"P",{});var v=d(u);Cn=t(v,"The "),Ye=s(v,"A",{href:!0});var qa=d(Ye);qn=t(qa,"VisionEncoderDecoderModel"),qa.forEach(o),zn=t(v,` can be used to initialize an image-to-text-sequence model with any
pretrained vision autoencoding model as the encoder (`),To=s(v,"EM",{});var za=d(To);Fn=t(za,"e.g."),za.forEach(o),An=l(v),Je=s(v,"A",{href:!0});var Fa=d(Je);Sn=t(Fa,"ViT"),Fa.forEach(o),In=t(v,", "),Ke=s(v,"A",{href:!0});var Aa=d(Ke);Ln=t(Aa,"BEiT"),Aa.forEach(o),On=t(v,", "),Qe=s(v,"A",{href:!0});var Sa=d(Qe);Nn=t(Sa,"DeiT"),Sa.forEach(o),Rn=t(v,`)
and any pretrained language model as the decoder (`),ko=s(v,"EM",{});var Ia=d(ko);Bn=t(Ia,"e.g."),Ia.forEach(o),Gn=l(v),Xe=s(v,"A",{href:!0});var La=d(Xe);Wn=t(La,"RoBERTa"),La.forEach(o),Un=t(v,", "),eo=s(v,"A",{href:!0});var Oa=d(eo);Hn=t(Oa,"GPT2"),Oa.forEach(o),Zn=t(v,", "),oo=s(v,"A",{href:!0});var Na=d(oo);Yn=t(Na,"BERT"),Na.forEach(o),Jn=t(v,")."),v.forEach(o),an=l(r),ne=s(r,"P",{});var gn=d(ne);Kn=t(gn,`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
character recognition (OCR) yields a significant performance improvement.`),En.forEach(o),Yt=l(b),Fo=s(b,"P",{});var cs=d(Fo);Jt=t(cs,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
...
Zhou, Wei Li, Peter J. Liu.`),jn.forEach(o),Hr=l(y),Se=s(y,"P",{});var Dn=d(Se);Zr=t(Dn,"Additionally, in "),Ie=s(Dn,"A",{href:!0,rel:!0});var Ms=d(Ie);Yr=t(Ms,"TrOCR: Transformer-based Optical Character Recognition with Pre-trained Models"),Ms.forEach(o),Jr=t(Dn,` it is shown how leveraging large pretrained vision models for optical
...
other models (see the examples for more information).`),Vs.forEach(o),Xr=l(y),Le=s(y,"P",{});var Mn=d(Le);ea=t(Mn,"This model inherits from "),ho=s(Mn,"A",{href:!0});var $s=d(ho);oa=t($s,"FlaxPreTrainedModel"),$s.forEach(o),na=t(Mn,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
