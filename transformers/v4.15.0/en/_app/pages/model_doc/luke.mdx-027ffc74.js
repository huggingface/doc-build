...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Mr=l(),wt=a("p"),Cr=o("This model is also a PyTorch "),Lt=a("a"),Fr=o("torch.nn.Module"),Pr=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Jr=l(),qt=a("p"),Xr=o("This model is also a PyTorch "),Mt=a("a"),Gr=o("torch.nn.Module"),Zr=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),ed=l(),D=a("div"),_(Ct.$$.fragment),td=l(),ve=a("p"),nd=o("The "),Tn=a("a"),od=o("LukeForEntityClassification"),sd=o(" forward method, overrides the "),xo=a("code"),ad=o("__call__"),id=o(" special method."),rd=l(),_(De.$$.fragment),dd=l(),$o=a("p"),ld=o("Examples:"),cd=l(),_(Ft.$$.fragment),cs=l(),be=a("h2"),Be=a("a"),qo=a("span"),_(Pt.$$.fragment),pd=l(),Mo=a("span"),hd=o("LukeForEntityPairClassification"),ps=l(),A=a("div"),_(jt.$$.fragment),ud=l(),Co=a("p"),md=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
tokens) for entity pair classification tasks, such as TACRED.`),fd=l(),At=a("p"),gd=o("This model inherits from "),wn=a("a"),_d=o("PreTrainedModel"),kd=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),yd=l(),It=a("p"),vd=o("This model is also a PyTorch "),St=a("a"),bd=o("torch.nn.Module"),Td=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),wd=l(),B=a("div"),_(Nt.$$.fragment),Ld=l(),Te=a("p"),Ed=o("The "),Ln=a("a"),zd=o("LukeForEntityPairClassification"),xd=o(" forward method, overrides the "),Fo=a("code"),$d=o("__call__"),qd=o(" special method."),Md=l(),_(We.$$.fragment),Cd=l(),Po=a("p"),Fd=o("Examples:"),Pd=l(),_(Dt.$$.fragment),hs=l(),we=a("h2"),Oe=a("a"),jo=a("span"),_(Bt.$$.fragment),jd=l(),Ao=a("span"),Ad=o("LukeForEntitySpanClassification"),us=l(),I=a("div"),_(Wt.$$.fragment),Id=l(),Io=a("p"),Sd=o(`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
