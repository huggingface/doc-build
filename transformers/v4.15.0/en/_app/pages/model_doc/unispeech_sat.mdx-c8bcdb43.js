import{S as ed,i as td,s as od,e as s,k as c,w as _,t as a,M as ad,c as r,d as o,m as d,a as i,x as v,h as n,b as l,F as e,g as m,y as S,q as b,o as w,B as y}from"../../chunks/vendor-ab4e3193.js";import{T as zo}from"../../chunks/Tip-b5c6375a.js";import{D as A}from"../../chunks/Docstring-b69c0bd4.js";import{C as oo}from"../../chunks/CodeBlock-516df0c5.js";import{I as ae}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function nd(C){let h,T,u,k,U;return{c(){h=s("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),k=a("Module"),U=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(f,"CODE",{});var $=i(u);k=n($,"Module"),$.forEach(o),U=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,h,f),e(h,T),e(h,u),e(u,k),e(h,U)},d(g){g&&o(h)}}}function sd(C){let h,T,u,k,U;return{c(){h=s("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),k=a("Module"),U=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(f,"CODE",{});var $=i(u);k=n($,"Module"),$.forEach(o),U=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){m(g,h,f),e(h,T),e(h,u),e(u,k),e(h,U)},d(g){g&&o(h)}}}function rd(C){let h,T,u,k,U;return{c(){h=s("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),k=a("Module"),U=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(f,"CODE",{});var $=i(u);k=n($,"Module"),$.forEach(o),U=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Dimensionality of the <em>XVector</em> embedding vectors.`,name:"xvector_output_dim"}]}}),Ye=new oo({props:{code:`from transformers import UniSpeechSatModel, UniSpeechSatConfig
...
weights.`,name:"config"}]}}),ct=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatModel.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1143",parametersDescription:[{anchor:"transformers.UniSpeechSatModel.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss`}}),St=new ae({}),bt=new A({props:{name:"class transformers.UniSpeechSatForSequenceClassification",anchor:"transformers.UniSpeechSatForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1475",parametersDescription:[{anchor:"transformers.UniSpeechSatForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatConfig">UniSpeechSatConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),$t=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1504",parametersDescription:[{anchor:"transformers.UniSpeechSatForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechSatProcessor</code>
should be used for padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See
...
`}}),Me=new zo({props:{$$slots:{default:[rd]},$$scope:{ctx:C}}}),Ft=new oo({props:{code:`from transformers import Wav2Vec2FeatureExtractor, UniSpeechSatForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss`}}),xt=new ae({}),jt=new A({props:{name:"class transformers.UniSpeechSatForAudioFrameClassification",anchor:"transformers.UniSpeechSatForAudioFrameClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1580",parametersDescription:[{anchor:"transformers.UniSpeechSatForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatConfig">UniSpeechSatConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),At=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatForAudioFrameClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1607",parametersDescription:[{anchor:"transformers.UniSpeechSatForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechSatProcessor</code>
should be used for padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See
...
<span class="hljs-meta">... </span>    <span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Speakers are not the same!&quot;</span>)`}}),Xt=new ae({}),Rt=new A({props:{name:"class transformers.UniSpeechSatForPreTraining",anchor:"transformers.UniSpeechSatForPreTraining",parameters:[{name:"config",val:": UniSpeechSatConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1200",parametersDescription:[{anchor:"transformers.UniSpeechSatForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatConfig">UniSpeechSatConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),Kt=new A({props:{name:"forward",anchor:"transformers.UniSpeechSatForPreTraining.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1256",parametersDescription:[{anchor:"transformers.UniSpeechSatForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>UniSpeechSatProcessor</code>
should be used for padding and conversion into a tensor of type <em>torch.FloatTensor</em>. See
...
decoded using `),io=s("a"),Bn=a("Wav2Vec2CTCTokenizer"),Hn=a("."),Xn=c(),Lo=s("li"),Rn=a("UniSpeechSat performs especially well on speaker verification, speaker identification, and speaker diarization tasks."),Pa=c(),X=s("p"),Zn=a("This model was contributed by "),He=s("a"),Qn=a("patrickvonplaten"),Yn=a(`. The Authors\u2019 code can be
found `),Xe=s("a"),Jn=a("here"),Kn=a("."),Ma=c(),se=s("h2"),Fe=s("a"),No=s("span"),_(Re.$$.fragment),Gn=c(),Wo=s("span"),es=a("UniSpeechSatConfig"),Aa=c(),q=s("div"),_(Ze.$$.fragment),ts=c(),re=s("p"),os=a("This is the configuration class to store the configuration of a "),lo=s("a"),as=a("UniSpeechSatModel"),ns=a(`. It is
...
`),Qe=s("a"),ss=a("facebook/unispeech_sat-base-960h"),rs=a(" architecture."),is=c(),ie=s("p"),ls=a("Configuration objects inherit from "),co=s("a"),cs=a("PretrainedConfig"),ds=a(` and can be used to control the model
outputs. Read the documentation from `),po=s("a"),ps=a("PretrainedConfig"),hs=a(" for more information."),ms=c(),Io=s("p"),us=a("Example:"),fs=c(),_(Ye.$$.fragment),za=c(),le=s("h2"),xe=s("a"),Bo=s("span"),_(Je.$$.fragment),gs=c(),Ho=s("span"),_s=a("UniSpeechSat specific outputs"),Da=c(),ce=s("div"),_(Ke.$$.fragment),vs=c(),Ge=s("p"),Ss=a("Output type of "),Xo=s("code"),bs=a("UniSpeechSatBaseModelOutput"),ws=a(", with potential hidden states and attentions."),Oa=c(),de=s("div"),_(et.$$.fragment),ys=c(),tt=s("p"),ks=a("Output type of "),Ro=s("code"),Ts=a("UniSpeechSatForPreTrainingOutput"),Us=a(`, with potential hidden states and
attentions.`),Va=c(),pe=s("h2"),je=s("a"),Zo=s("span"),_(ot.$$.fragment),$s=c(),Qo=s("span"),Fs=a("UniSpeechSatModel"),La=c(),E=s("div"),_(at.$$.fragment),xs=c(),nt=s("p"),js=a(`The bare UniSpeechSat Model transformer outputting raw hidden-states without any specific head on top.
UniSpeechSat was proposed in `),st=s("a"),Cs=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),qs=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Es=c(),rt=s("p"),Ps=a("This model inherits from "),ho=s("a"),Ms=a("PreTrainedModel"),As=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),zs=c(),it=s("p"),Ds=a("This model is a PyTorch "),lt=s("a"),Os=a("torch.nn.Module"),Vs=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ls=c(),z=s("div"),_(ct.$$.fragment),Ns=c(),he=s("p"),Ws=a("The "),mo=s("a"),Is=a("UniSpeechSatModel"),Bs=a(" forward method, overrides the "),Yo=s("code"),Hs=a("__call__"),Xs=a(" special method."),Rs=c(),_(Ce.$$.fragment),Zs=c(),Jo=s("p"),Qs=a("Example:"),Ys=c(),_(dt.$$.fragment),Na=c(),me=s("h2"),qe=s("a"),Ko=s("span"),_(pt.$$.fragment),Js=c(),Go=s("span"),Ks=a("UniSpeechSatForCTC"),Wa=c(),P=s("div"),_(ht.$$.fragment),Gs=c(),ue=s("p"),er=a("UniSpeechSat Model with a "),ea=s("code"),tr=a("language modeling"),or=a(` head on top for Connectionist Temporal Classification (CTC).
UniSpeechSat was proposed in `),mt=s("a"),ar=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),nr=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),sr=c(),ut=s("p"),rr=a("This model inherits from "),uo=s("a"),ir=a("PreTrainedModel"),lr=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),cr=c(),ft=s("p"),dr=a("This model is a PyTorch "),gt=s("a"),pr=a("torch.nn.Module"),hr=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
like SUPERB Keyword Spotting.`),xr=c(),wt=s("p"),jr=a("UniSpeechSat was proposed in "),yt=s("a"),Cr=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),qr=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Er=c(),kt=s("p"),Pr=a("This model inherits from "),go=s("a"),Mr=a("PreTrainedModel"),Ar=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),zr=c(),Tt=s("p"),Dr=a("This model is a PyTorch "),Ut=s("a"),Or=a("torch.nn.Module"),Vr=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lr=c(),O=s("div"),_($t.$$.fragment),Nr=c(),_e=s("p"),Wr=a("The "),_o=s("a"),Ir=a("UniSpeechSatForSequenceClassification"),Br=a(" forward method, overrides the "),ra=s("code"),Hr=a("__call__"),Xr=a(" special method."),Rr=c(),_(Me.$$.fragment),Zr=c(),ia=s("p"),Qr=a("Example:"),Yr=c(),_(Ft.$$.fragment),Ha=c(),ve=s("h2"),Ae=s("a"),la=s("span"),_(xt.$$.fragment),Jr=c(),ca=s("span"),Kr=a("UniSpeechSatForAudioFrameClassification"),Xa=c(),x=s("div"),_(jt.$$.fragment),Gr=c(),da=s("p"),ei=a("UniSpeech-SAT Model with a frame classification head on top for tasks like Speaker Diarization."),ti=c(),Ct=s("p"),oi=a("UniSpeechSat was proposed in "),qt=s("a"),ai=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),ni=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),si=c(),Et=s("p"),ri=a("This model inherits from "),vo=s("a"),ii=a("PreTrainedModel"),li=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),ci=c(),Pt=s("p"),di=a("This model is a PyTorch "),Mt=s("a"),pi=a("torch.nn.Module"),hi=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),mi=c(),V=s("div"),_(At.$$.fragment),ui=c(),Se=s("p"),fi=a("The "),So=s("a"),gi=a("UniSpeechSatForAudioFrameClassification"),_i=a(" forward method, overrides the "),pa=s("code"),vi=a("__call__"),Si=a(" special method."),bi=c(),_(ze.$$.fragment),wi=c(),ha=s("p"),yi=a("Example:"),ki=c(),_(zt.$$.fragment),Ra=c(),be=s("h2"),De=s("a"),ma=s("span"),_(Dt.$$.fragment),Ti=c(),ua=s("span"),Ui=a("UniSpeechSatForXVector"),Za=c(),j=s("div"),_(Ot.$$.fragment),$i=c(),fa=s("p"),Fi=a("UniSpeech-SAT Model with an XVector feature extraction head on top for tasks like Speaker Verification."),xi=c(),Vt=s("p"),ji=a("UniSpeechSat was proposed in "),Lt=s("a"),Ci=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),qi=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Ei=c(),Nt=s("p"),Pi=a("This model inherits from "),bo=s("a"),Mi=a("PreTrainedModel"),Ai=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),zi=c(),Wt=s("p"),Di=a("This model is a PyTorch "),It=s("a"),Oi=a("torch.nn.Module"),Vi=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Li=c(),L=s("div"),_(Bt.$$.fragment),Ni=c(),we=s("p"),Wi=a("The "),wo=s("a"),Ii=a("UniSpeechSatForXVector"),Bi=a(" forward method, overrides the "),ga=s("code"),Hi=a("__call__"),Xi=a(" special method."),Ri=c(),_(Oe.$$.fragment),Zi=c(),_a=s("p"),Qi=a("Example:"),Yi=c(),_(Ht.$$.fragment),Qa=c(),ye=s("h2"),Ve=s("a"),va=s("span"),_(Xt.$$.fragment),Ji=c(),Sa=s("span"),Ki=a("UniSpeechSatForPreTraining"),Ya=c(),M=s("div"),_(Rt.$$.fragment),Gi=c(),ke=s("p"),el=a("UniSpeechSat Model with a quantizer and "),ba=s("code"),tl=a("VQ"),ol=a(` head on top.
UniSpeechSat was proposed in `),Zt=s("a"),al=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),nl=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),sl=c(),Qt=s("p"),rl=a("This model inherits from "),yo=s("a"),il=a("PreTrainedModel"),ll=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),cl=c(),Yt=s("p"),dl=a("This model is a PyTorch "),Jt=s("a"),pl=a("torch.nn.Module"),hl=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ml=c(),N=s("div"),_(Kt.$$.fragment),ul=c(),Te=s("p"),fl=a("The "),ko=s("a"),gl=a("UniSpeechSatForPreTraining"),_l=a(" forward method, overrides the "),wa=s("code"),vl=a("__call__"),Sl=a(" special method."),bl=c(),_(Le.$$.fragment),wl=c(),ya=s("p"),yl=a("Example:"),kl=c(),_(Gt.$$.fragment),this.h()},l(t){const p=ad('[data-svelte="svelte-1phssyn"]',document.head);h=r(p,"META",{name:!0,content:!0}),p.forEach(o),T=d(t),u=r(t,"H1",{class:!0});var eo=i(u);k=r(eo,"A",{id:!0,class:!0,href:!0});var ka=i(k);U=r(ka,"SPAN",{});var Ta=i(U);v(g.$$.fragment,Ta),Ta.forEach(o),ka.forEach(o),f=d(eo),$=r(eo,"SPAN",{});var Ua=i($);Cn=n(Ua,"UniSpeech-SAT"),Ua.forEach(o),eo.forEach(o),Fa=d(t),ne=r(t,"H2",{class:!0});var to=i(ne);Ue=r(to,"A",{id:!0,class:!0,href:!0});var $a=i(Ue);Do=r($a,"SPAN",{});var Tl=i(Do);v(Ne.$$.fragment,Tl),Tl.forEach(o),$a.forEach(o),qn=d(to),Oo=r(to,"SPAN",{});var Ul=i(Oo);En=n(Ul,"Overview"),Ul.forEach(o),to.forEach(o),xa=d(t),$e=r(t,"P",{});var Ka=i($e);Pn=n(Ka,"The UniSpeech-SAT model was proposed in "),We=r(Ka,"A",{href:!0,rel:!0});var $l=i(We);Mn=n($l,`UniSpeech-SAT: Universal Speech Representation Learning with Speaker Aware
Pre-Training`),$l.forEach(o),An=n(Ka,` by Sanyuan Chen, Yu Wu, Chengyi Wang, Zhengyang Chen, Zhuo Chen,
...
Please use `),ro=r(Ga,"A",{href:!0});var ql=i(ro);Ln=n(ql,"Wav2Vec2Processor"),ql.forEach(o),Nn=n(Ga," for the feature extraction."),Ga.forEach(o),Wn=d(To),Be=r(To,"LI",{});var en=i(Be);In=n(en,`UniSpeechSat model can be fine-tuned using connectionist temporal classification (CTC) so the model output has to be
decoded using `),io=r(en,"A",{href:!0});var El=i(io);Bn=n(El,"Wav2Vec2CTCTokenizer"),El.forEach(o),Hn=n(en,"."),en.forEach(o),Xn=d(To),Lo=r(To,"LI",{});var Pl=i(Lo);Rn=n(Pl,"UniSpeechSat performs especially well on speaker verification, speaker identification, and speaker diarization tasks."),Pl.forEach(o),To.forEach(o),Pa=d(t),X=r(t,"P",{});var Uo=i(X);Zn=n(Uo,"This model was contributed by "),He=r(Uo,"A",{href:!0,rel:!0});var Ml=i(He);Qn=n(Ml,"patrickvonplaten"),Ml.forEach(o),Yn=n(Uo,`. The Authors\u2019 code can be
found `),Xe=r(Uo,"A",{href:!0,rel:!0});var Al=i(Xe);Jn=n(Al,"here"),Al.forEach(o),Kn=n(Uo,"."),Uo.forEach(o),Ma=d(t),se=r(t,"H2",{class:!0});var tn=i(se);Fe=r(tn,"A",{id:!0,class:!0,href:!0});var zl=i(Fe);No=r(zl,"SPAN",{});var Dl=i(No);v(Re.$$.fragment,Dl),Dl.forEach(o),zl.forEach(o),Gn=d(tn),Wo=r(tn,"SPAN",{});var Ol=i(Wo);es=n(Ol,"UniSpeechSatConfig"),Ol.forEach(o),tn.forEach(o),Aa=d(t),q=r(t,"DIV",{class:!0});var R=i(q);v(Ze.$$.fragment,R),ts=d(R),re=r(R,"P",{});var $o=i(re);os=n($o,"This is the configuration class to store the configuration of a "),lo=r($o,"A",{href:!0});var Vl=i(lo);as=n(Vl,"UniSpeechSatModel"),Vl.forEach(o),ns=n($o,`. It is
used to instantiate an UniSpeechSat model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the UniSpeechSat
`),Qe=r($o,"A",{href:!0,rel:!0});var Ll=i(Qe);ss=n(Ll,"facebook/unispeech_sat-base-960h"),Ll.forEach(o),rs=n($o," architecture."),$o.forEach(o),is=d(R),ie=r(R,"P",{});var Fo=i(ie);ls=n(Fo,"Configuration objects inherit from "),co=r(Fo,"A",{href:!0});var Nl=i(co);cs=n(Nl,"PretrainedConfig"),Nl.forEach(o),ds=n(Fo,` and can be used to control the model
outputs. Read the documentation from `),po=r(Fo,"A",{href:!0});var Wl=i(po);ps=n(Wl,"PretrainedConfig"),Wl.forEach(o),hs=n(Fo," for more information."),Fo.forEach(o),ms=d(R),Io=r(R,"P",{});var Il=i(Io);us=n(Il,"Example:"),Il.forEach(o),fs=d(R),v(Ye.$$.fragment,R),R.forEach(o),za=d(t),le=r(t,"H2",{class:!0});var on=i(le);xe=r(on,"A",{id:!0,class:!0,href:!0});var Bl=i(xe);Bo=r(Bl,"SPAN",{});var Hl=i(Bo);v(Je.$$.fragment,Hl),Hl.forEach(o),Bl.forEach(o),gs=d(on),Ho=r(on,"SPAN",{});var Xl=i(Ho);_s=n(Xl,"UniSpeechSat specific outputs"),Xl.forEach(o),on.forEach(o),Da=d(t),ce=r(t,"DIV",{class:!0});var an=i(ce);v(Ke.$$.fragment,an),vs=d(an),Ge=r(an,"P",{});var nn=i(Ge);Ss=n(nn,"Output type of "),Xo=r(nn,"CODE",{});var Rl=i(Xo);bs=n(Rl,"UniSpeechSatBaseModelOutput"),Rl.forEach(o),ws=n(nn,", with potential hidden states and attentions."),nn.forEach(o),an.forEach(o),Oa=d(t),de=r(t,"DIV",{class:!0});var sn=i(de);v(et.$$.fragment,sn),ys=d(sn),tt=r(sn,"P",{});var rn=i(tt);ks=n(rn,"Output type of "),Ro=r(rn,"CODE",{});var Zl=i(Ro);Ts=n(Zl,"UniSpeechSatForPreTrainingOutput"),Zl.forEach(o),Us=n(rn,`, with potential hidden states and
attentions.`),rn.forEach(o),sn.forEach(o),Va=d(t),pe=r(t,"H2",{class:!0});var ln=i(pe);je=r(ln,"A",{id:!0,class:!0,href:!0});var Ql=i(je);Zo=r(Ql,"SPAN",{});var Yl=i(Zo);v(ot.$$.fragment,Yl),Yl.forEach(o),Ql.forEach(o),$s=d(ln),Qo=r(ln,"SPAN",{});var Jl=i(Qo);Fs=n(Jl,"UniSpeechSatModel"),Jl.forEach(o),ln.forEach(o),La=d(t),E=r(t,"DIV",{class:!0});var Z=i(E);v(at.$$.fragment,Z),xs=d(Z),nt=r(Z,"P",{});var cn=i(nt);js=n(cn,`The bare UniSpeechSat Model transformer outputting raw hidden-states without any specific head on top.
UniSpeechSat was proposed in `),st=r(cn,"A",{href:!0,rel:!0});var Kl=i(st);Cs=n(Kl,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Kl.forEach(o),qs=n(cn," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),cn.forEach(o),Es=d(Z),rt=r(Z,"P",{});var dn=i(rt);Ps=n(dn,"This model inherits from "),ho=r(dn,"A",{href:!0});var Gl=i(ho);Ms=n(Gl,"PreTrainedModel"),Gl.forEach(o),As=n(dn,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),dn.forEach(o),zs=d(Z),it=r(Z,"P",{});var pn=i(it);Ds=n(pn,"This model is a PyTorch "),lt=r(pn,"A",{href:!0,rel:!0});var ec=i(lt);Os=n(ec,"torch.nn.Module"),ec.forEach(o),Vs=n(pn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),pn.forEach(o),Ls=d(Z),z=r(Z,"DIV",{class:!0});var Q=i(z);v(ct.$$.fragment,Q),Ns=d(Q),he=r(Q,"P",{});var xo=i(he);Ws=n(xo,"The "),mo=r(xo,"A",{href:!0});var tc=i(mo);Is=n(tc,"UniSpeechSatModel"),tc.forEach(o),Bs=n(xo," forward method, overrides the "),Yo=r(xo,"CODE",{});var oc=i(Yo);Hs=n(oc,"__call__"),oc.forEach(o),Xs=n(xo," special method."),xo.forEach(o),Rs=d(Q),v(Ce.$$.fragment,Q),Zs=d(Q),Jo=r(Q,"P",{});var ac=i(Jo);Qs=n(ac,"Example:"),ac.forEach(o),Ys=d(Q),v(dt.$$.fragment,Q),Q.forEach(o),Z.forEach(o),Na=d(t),me=r(t,"H2",{class:!0});var hn=i(me);qe=r(hn,"A",{id:!0,class:!0,href:!0});var nc=i(qe);Ko=r(nc,"SPAN",{});var sc=i(Ko);v(pt.$$.fragment,sc),sc.forEach(o),nc.forEach(o),Js=d(hn),Go=r(hn,"SPAN",{});var rc=i(Go);Ks=n(rc,"UniSpeechSatForCTC"),rc.forEach(o),hn.forEach(o),Wa=d(t),P=r(t,"DIV",{class:!0});var Y=i(P);v(ht.$$.fragment,Y),Gs=d(Y),ue=r(Y,"P",{});var jo=i(ue);er=n(jo,"UniSpeechSat Model with a "),ea=r(jo,"CODE",{});var ic=i(ea);tr=n(ic,"language modeling"),ic.forEach(o),or=n(jo,` head on top for Connectionist Temporal Classification (CTC).
UniSpeechSat was proposed in `),mt=r(jo,"A",{href:!0,rel:!0});var lc=i(mt);ar=n(lc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),lc.forEach(o),nr=n(jo," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),jo.forEach(o),sr=d(Y),ut=r(Y,"P",{});var mn=i(ut);rr=n(mn,"This model inherits from "),uo=r(mn,"A",{href:!0});var cc=i(uo);ir=n(cc,"PreTrainedModel"),cc.forEach(o),lr=n(mn,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),mn.forEach(o),cr=d(Y),ft=r(Y,"P",{});var un=i(ft);dr=n(un,"This model is a PyTorch "),gt=r(un,"A",{href:!0,rel:!0});var dc=i(gt);pr=n(dc,"torch.nn.Module"),dc.forEach(o),hr=n(un,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),un.forEach(o),mr=d(Y),D=r(Y,"DIV",{class:!0});var J=i(D);v(_t.$$.fragment,J),ur=d(J),fe=r(J,"P",{});var Co=i(fe);fr=n(Co,"The "),fo=r(Co,"A",{href:!0});var pc=i(fo);gr=n(pc,"UniSpeechSatForCTC"),pc.forEach(o),_r=n(Co," forward method, overrides the "),ta=r(Co,"CODE",{});var hc=i(ta);vr=n(hc,"__call__"),hc.forEach(o),Sr=n(Co," special method."),Co.forEach(o),br=d(J),v(Ee.$$.fragment,J),wr=d(J),oa=r(J,"P",{});var mc=i(oa);yr=n(mc,"Example:"),mc.forEach(o),kr=d(J),v(vt.$$.fragment,J),J.forEach(o),Y.forEach(o),Ia=d(t),ge=r(t,"H2",{class:!0});var fn=i(ge);Pe=r(fn,"A",{id:!0,class:!0,href:!0});var uc=i(Pe);aa=r(uc,"SPAN",{});var fc=i(aa);v(St.$$.fragment,fc),fc.forEach(o),uc.forEach(o),Tr=d(fn),na=r(fn,"SPAN",{});var gc=i(na);Ur=n(gc,"UniSpeechSatForSequenceClassification"),gc.forEach(o),fn.forEach(o),Ba=d(t),F=r(t,"DIV",{class:!0});var W=i(F);v(bt.$$.fragment,W),$r=d(W),sa=r(W,"P",{});var _c=i(sa);Fr=n(_c,`UniSpeechSat Model with a sequence classification head on top (a linear layer over the pooled output) for tasks
like SUPERB Keyword Spotting.`),_c.forEach(o),xr=d(W),wt=r(W,"P",{});var gn=i(wt);jr=n(gn,"UniSpeechSat was proposed in "),yt=r(gn,"A",{href:!0,rel:!0});var vc=i(yt);Cr=n(vc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),vc.forEach(o),qr=n(gn," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),gn.forEach(o),Er=d(W),kt=r(W,"P",{});var _n=i(kt);Pr=n(_n,"This model inherits from "),go=r(_n,"A",{href:!0});var Sc=i(go);Mr=n(Sc,"PreTrainedModel"),Sc.forEach(o),Ar=n(_n,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),_n.forEach(o),zr=d(W),Tt=r(W,"P",{});var vn=i(Tt);Dr=n(vn,"This model is a PyTorch "),Ut=r(vn,"A",{href:!0,rel:!0});var bc=i(Ut);Or=n(bc,"torch.nn.Module"),bc.forEach(o),Vr=n(vn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vn.forEach(o),Lr=d(W),O=r(W,"DIV",{class:!0});var K=i(O);v($t.$$.fragment,K),Nr=d(K),_e=r(K,"P",{});var qo=i(_e);Wr=n(qo,"The "),_o=r(qo,"A",{href:!0});var wc=i(_o);Ir=n(wc,"UniSpeechSatForSequenceClassification"),wc.forEach(o),Br=n(qo," forward method, overrides the "),ra=r(qo,"CODE",{});var yc=i(ra);Hr=n(yc,"__call__"),yc.forEach(o),Xr=n(qo," special method."),qo.forEach(o),Rr=d(K),v(Me.$$.fragment,K),Zr=d(K),ia=r(K,"P",{});var kc=i(ia);Qr=n(kc,"Example:"),kc.forEach(o),Yr=d(K),v(Ft.$$.fragment,K),K.forEach(o),W.forEach(o),Ha=d(t),ve=r(t,"H2",{class:!0});var Sn=i(ve);Ae=r(Sn,"A",{id:!0,class:!0,href:!0});var Tc=i(Ae);la=r(Tc,"SPAN",{});var Uc=i(la);v(xt.$$.fragment,Uc),Uc.forEach(o),Tc.forEach(o),Jr=d(Sn),ca=r(Sn,"SPAN",{});var $c=i(ca);Kr=n($c,"UniSpeechSatForAudioFrameClassification"),$c.forEach(o),Sn.forEach(o),Xa=d(t),x=r(t,"DIV",{class:!0});var I=i(x);v(jt.$$.fragment,I),Gr=d(I),da=r(I,"P",{});var Fc=i(da);ei=n(Fc,"UniSpeech-SAT Model with a frame classification head on top for tasks like Speaker Diarization."),Fc.forEach(o),ti=d(I),Ct=r(I,"P",{});var bn=i(Ct);oi=n(bn,"UniSpeechSat was proposed in "),qt=r(bn,"A",{href:!0,rel:!0});var xc=i(qt);ai=n(xc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),xc.forEach(o),ni=n(bn," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),bn.forEach(o),si=d(I),Et=r(I,"P",{});var wn=i(Et);ri=n(wn,"This model inherits from "),vo=r(wn,"A",{href:!0});var jc=i(vo);ii=n(jc,"PreTrainedModel"),jc.forEach(o),li=n(wn,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),wn.forEach(o),ci=d(I),Pt=r(I,"P",{});var yn=i(Pt);di=n(yn,"This model is a PyTorch "),Mt=r(yn,"A",{href:!0,rel:!0});var Cc=i(Mt);pi=n(Cc,"torch.nn.Module"),Cc.forEach(o),hi=n(yn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),yn.forEach(o),mi=d(I),V=r(I,"DIV",{class:!0});var G=i(V);v(At.$$.fragment,G),ui=d(G),Se=r(G,"P",{});var Eo=i(Se);fi=n(Eo,"The "),So=r(Eo,"A",{href:!0});var qc=i(So);gi=n(qc,"UniSpeechSatForAudioFrameClassification"),qc.forEach(o),_i=n(Eo," forward method, overrides the "),pa=r(Eo,"CODE",{});var Ec=i(pa);vi=n(Ec,"__call__"),Ec.forEach(o),Si=n(Eo," special method."),Eo.forEach(o),bi=d(G),v(ze.$$.fragment,G),wi=d(G),ha=r(G,"P",{});var Pc=i(ha);yi=n(Pc,"Example:"),Pc.forEach(o),ki=d(G),v(zt.$$.fragment,G),G.forEach(o),I.forEach(o),Ra=d(t),be=r(t,"H2",{class:!0});var kn=i(be);De=r(kn,"A",{id:!0,class:!0,href:!0});var Mc=i(De);ma=r(Mc,"SPAN",{});var Ac=i(ma);v(Dt.$$.fragment,Ac),Ac.forEach(o),Mc.forEach(o),Ti=d(kn),ua=r(kn,"SPAN",{});var zc=i(ua);Ui=n(zc,"UniSpeechSatForXVector"),zc.forEach(o),kn.forEach(o),Za=d(t),j=r(t,"DIV",{class:!0});var B=i(j);v(Ot.$$.fragment,B),$i=d(B),fa=r(B,"P",{});var Dc=i(fa);Fi=n(Dc,"UniSpeech-SAT Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Dc.forEach(o),xi=d(B),Vt=r(B,"P",{});var Tn=i(Vt);ji=n(Tn,"UniSpeechSat was proposed in "),Lt=r(Tn,"A",{href:!0,rel:!0});var Oc=i(Lt);Ci=n(Oc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Oc.forEach(o),qi=n(Tn," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Tn.forEach(o),Ei=d(B),Nt=r(B,"P",{});var Un=i(Nt);Pi=n(Un,"This model inherits from "),bo=r(Un,"A",{href:!0});var Vc=i(bo);Mi=n(Vc,"PreTrainedModel"),Vc.forEach(o),Ai=n(Un,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),Un.forEach(o),zi=d(B),Wt=r(B,"P",{});var $n=i(Wt);Di=n($n,"This model is a PyTorch "),It=r($n,"A",{href:!0,rel:!0});var Lc=i(It);Oi=n(Lc,"torch.nn.Module"),Lc.forEach(o),Vi=n($n,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$n.forEach(o),Li=d(B),L=r(B,"DIV",{class:!0});var ee=i(L);v(Bt.$$.fragment,ee),Ni=d(ee),we=r(ee,"P",{});var Po=i(we);Wi=n(Po,"The "),wo=r(Po,"A",{href:!0});var Nc=i(wo);Ii=n(Nc,"UniSpeechSatForXVector"),Nc.forEach(o),Bi=n(Po," forward method, overrides the "),ga=r(Po,"CODE",{});var Wc=i(ga);Hi=n(Wc,"__call__"),Wc.forEach(o),Xi=n(Po," special method."),Po.forEach(o),Ri=d(ee),v(Oe.$$.fragment,ee),Zi=d(ee),_a=r(ee,"P",{});var Ic=i(_a);Qi=n(Ic,"Example:"),Ic.forEach(o),Yi=d(ee),v(Ht.$$.fragment,ee),ee.forEach(o),B.forEach(o),Qa=d(t),ye=r(t,"H2",{class:!0});var Fn=i(ye);Ve=r(Fn,"A",{id:!0,class:!0,href:!0});var Bc=i(Ve);va=r(Bc,"SPAN",{});var Hc=i(va);v(Xt.$$.fragment,Hc),Hc.forEach(o),Bc.forEach(o),Ji=d(Fn),Sa=r(Fn,"SPAN",{});var Xc=i(Sa);Ki=n(Xc,"UniSpeechSatForPreTraining"),Xc.forEach(o),Fn.forEach(o),Ya=d(t),M=r(t,"DIV",{class:!0});var te=i(M);v(Rt.$$.fragment,te),Gi=d(te),ke=r(te,"P",{});var Mo=i(ke);el=n(Mo,"UniSpeechSat Model with a quantizer and "),ba=r(Mo,"CODE",{});var Rc=i(ba);tl=n(Rc,"VQ"),Rc.forEach(o),ol=n(Mo,` head on top.
UniSpeechSat was proposed in `),Zt=r(Mo,"A",{href:!0,rel:!0});var Zc=i(Zt);al=n(Zc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Zc.forEach(o),nl=n(Mo," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Mo.forEach(o),sl=d(te),Qt=r(te,"P",{});var xn=i(Qt);rl=n(xn,"This model inherits from "),yo=r(xn,"A",{href:!0});var Qc=i(yo);il=n(Qc,"PreTrainedModel"),Qc.forEach(o),ll=n(xn,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),xn.forEach(o),cl=d(te),Yt=r(te,"P",{});var jn=i(Yt);dl=n(jn,"This model is a PyTorch "),Jt=r(jn,"A",{href:!0,rel:!0});var Yc=i(Jt);pl=n(Yc,"torch.nn.Module"),Yc.forEach(o),hl=n(jn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jn.forEach(o),ml=d(te),N=r(te,"DIV",{class:!0});var oe=i(N);v(Kt.$$.fragment,oe),ul=d(oe),Te=r(oe,"P",{});var Ao=i(Te);fl=n(Ao,"The "),ko=r(Ao,"A",{href:!0});var Jc=i(ko);gl=n(Jc,"UniSpeechSatForPreTraining"),Jc.forEach(o),_l=n(Ao," forward method, overrides the "),wa=r(Ao,"CODE",{});var Kc=i(wa);vl=n(Kc,"__call__"),Kc.forEach(o),Sl=n(Ao," special method."),Ao.forEach(o),bl=d(oe),v(Le.$$.fragment,oe),wl=d(oe),ya=r(oe,"P",{});var Gc=i(ya);yl=n(Gc,"Example:"),Gc.forEach(o),kl=d(oe),v(Gt.$$.fragment,oe),oe.forEach(o),te.forEach(o),this.h()},h(){l(h,"name","hf:doc:metadata"),l(h,"content",JSON.stringify(pd)),l(k,"id","unispeechsat"),l(k,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(k,"href","#unispeechsat"),l(u,"class","relative group"),l(Ue,"id","overview"),l(Ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ue,"href","#overview"),l(ne,"class","relative group"),l(We,"href","https://arxiv.org/abs/2110.05752"),l(We,"rel","nofollow"),l(ro,"href","/docs/transformers/v4.15.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor"),l(io,"href","/docs/transformers/v4.15.0/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),l(He,"href","https://huggingface.co/patrickvonplaten"),l(He,"rel","nofollow"),l(Xe,"href","https://github.com/microsoft/UniSpeech/tree/main/UniSpeech-SAT"),l(Xe,"rel","nofollow"),l(Fe,"id","transformers.UniSpeechSatConfig"),l(Fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Fe,"href","#transformers.UniSpeechSatConfig"),l(se,"class","relative group"),l(lo,"href","/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatModel"),l(Qe,"href","https://huggingface.co/facebook/unispeech_sat-base-960h"),l(Qe,"rel","nofollow"),l(co,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig"),l(po,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig"),l(q,"class","docstring"),l(xe,"id","transformers.models.unispeech_sat.modeling_unispeech_sat.UniSpeechSatBaseModelOutput"),l(xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(xe,"href","#transformers.models.unispeech_sat.modeling_unispeech_sat.UniSpeechSatBaseModelOutput"),l(le,"class","relative group"),l(ce,"class","docstring"),l(de,"class","docstring"),l(je,"id","transformers.UniSpeechSatModel"),l(je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(je,"href","#transformers.UniSpeechSatModel"),l(pe,"class","relative group"),l(st,"href","https://arxiv.org/abs/2006.11477"),l(st,"rel","nofollow"),l(ho,"href","/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel"),l(lt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(lt,"rel","nofollow"),l(mo,"href","/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatModel"),l(z,"class","docstring"),l(E,"class","docstring"),l(qe,"id","transformers.UniSpeechSatForCTC"),l(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(qe,"href","#transformers.UniSpeechSatForCTC"),l(me,"class","relative group"),l(mt,"href","https://arxiv.org/abs/2006.11477"),l(mt,"rel","nofollow"),l(uo,"href","/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel"),l(gt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(gt,"rel","nofollow"),l(fo,"href","/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatForCTC"),l(D,"class","docstring"),l(P,"class","docstring"),l(Pe,"id","transformers.UniSpeechSatForSequenceClassification"),l(Pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Pe,"href","#transformers.UniSpeechSatForSequenceClassification"),l(ge,"class","relative group"),l(yt,"href","https://arxiv.org/abs/2006.11477"),l(yt,"rel","nofollow"),l(go,"href","/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel"),l(Ut,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ut,"rel","nofollow"),l(_o,"href","/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatForSequenceClassification"),l(O,"class","docstring"),l(F,"class","docstring"),l(Ae,"id","transformers.UniSpeechSatForAudioFrameClassification"),l(Ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ae,"href","#transformers.UniSpeechSatForAudioFrameClassification"),l(ve,"class","relative group"),l(qt,"href","https://arxiv.org/abs/2006.11477"),l(qt,"rel","nofollow"),l(vo,"href","/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel"),l(Mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Mt,"rel","nofollow"),l(So,"href","/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatForAudioFrameClassification"),l(V,"class","docstring"),l(x,"class","docstring"),l(De,"id","transformers.UniSpeechSatForXVector"),l(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(De,"href","#transformers.UniSpeechSatForXVector"),l(be,"class","relative group"),l(Lt,"href","https://arxiv.org/abs/2006.11477"),l(Lt,"rel","nofollow"),l(bo,"href","/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel"),l(It,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(It,"rel","nofollow"),l(wo,"href","/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatForXVector"),l(L,"class","docstring"),l(j,"class","docstring"),l(Ve,"id","transformers.UniSpeechSatForPreTraining"),l(Ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ve,"href","#transformers.UniSpeechSatForPreTraining"),l(ye,"class","relative group"),l(Zt,"href","https://arxiv.org/abs/2006.11477"),l(Zt,"rel","nofollow"),l(yo,"href","/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel"),l(Jt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Jt,"rel","nofollow"),l(ko,"href","/docs/transformers/v4.15.0/en/model_doc/unispeech_sat#transformers.UniSpeechSatForPreTraining"),l(N,"class","docstring"),l(M,"class","docstring")},m(t,p){e(document.head,h),m(t,T,p),m(t,u,p),e(u,k),e(k,U),S(g,U,null),e(u,f),e(u,$),e($,Cn),m(t,Fa,p),m(t,ne,p),e(ne,Ue),e(Ue,Do),S(Ne,Do,null),e(ne,qn),e(ne,Oo),e(Oo,En),m(t,xa,p),m(t,$e,p),e($e,Pn),e($e,We),e(We,Mn),e($e,An),m(t,ja,p),m(t,ao,p),e(ao,zn),m(t,Ca,p),m(t,no,p),e(no,Vo),e(Vo,Dn),m(t,qa,p),m(t,so,p),e(so,On),m(t,Ea,p),m(t,H,p),e(H,Ie),e(Ie,Vn),e(Ie,ro),e(ro,Ln),e(Ie,Nn),e(H,Wn),e(H,Be),e(Be,In),e(Be,io),e(io,Bn),e(Be,Hn),e(H,Xn),e(H,Lo),e(Lo,Rn),m(t,Pa,p),m(t,X,p),e(X,Zn),e(X,He),e(He,Qn),e(X,Yn),e(X,Xe),e(Xe,Jn),e(X,Kn),m(t,Ma,p),m(t,se,p),e(se,Fe),e(Fe,No),S(Re,No,null),e(se,Gn),e(se,Wo),e(Wo,es),m(t,Aa,p),m(t,q,p),S(Ze,q,null),e(q,ts),e(q,re),e(re,os),e(re,lo),e(lo,as),e(re,ns),e(re,Qe),e(Qe,ss),e(re,rs),e(q,is),e(q,ie),e(ie,ls),e(ie,co),e(co,cs),e(ie,ds),e(ie,po),e(po,ps),e(ie,hs),e(q,ms),e(q,Io),e(Io,us),e(q,fs),S(Ye,q,null),m(t,za,p),m(t,le,p),e(le,xe),e(xe,Bo),S(Je,Bo,null),e(le,gs),e(le,Ho),e(Ho,_s),m(t,Da,p),m(t,ce,p),S(Ke,ce,null),e(ce,vs),e(ce,Ge),e(Ge,Ss),e(Ge,Xo),e(Xo,bs),e(Ge,ws),m(t,Oa,p),m(t,de,p),S(et,de,null),e(de,ys),e(de,tt),e(tt,ks),e(tt,Ro),e(Ro,Ts),e(tt,Us),m(t,Va,p),m(t,pe,p),e(pe,je),e(je,Zo),S(ot,Zo,null),e(pe,$s),e(pe,Qo),e(Qo,Fs),m(t,La,p),m(t,E,p),S(at,E,null),e(E,xs),e(E,nt),e(nt,js),e(nt,st),e(st,Cs),e(nt,qs),e(E,Es),e(E,rt),e(rt,Ps),e(rt,ho),e(ho,Ms),e(rt,As),e(E,zs),e(E,it),e(it,Ds),e(it,lt),e(lt,Os),e(it,Vs),e(E,Ls),e(E,z),S(ct,z,null),e(z,Ns),e(z,he),e(he,Ws),e(he,mo),e(mo,Is),e(he,Bs),e(he,Yo),e(Yo,Hs),e(he,Xs),e(z,Rs),S(Ce,z,null),e(z,Zs),e(z,Jo),e(Jo,Qs),e(z,Ys),S(dt,z,null),m(t,Na,p),m(t,me,p),e(me,qe),e(qe,Ko),S(pt,Ko,null),e(me,Js),e(me,Go),e(Go,Ks),m(t,Wa,p),m(t,P,p),S(ht,P,null),e(P,Gs),e(P,ue),e(ue,er),e(ue,ea),e(ea,tr),e(ue,or),e(ue,mt),e(mt,ar),e(ue,nr),e(P,sr),e(P,ut),e(ut,rr),e(ut,uo),e(uo,ir),e(ut,lr),e(P,cr),e(P,ft),e(ft,dr),e(ft,gt),e(gt,pr),e(ft,hr),e(P,mr),e(P,D),S(_t,D,null),e(D,ur),e(D,fe),e(fe,fr),e(fe,fo),e(fo,gr),e(fe,_r),e(fe,ta),e(ta,vr),e(fe,Sr),e(D,br),S(Ee,D,null),e(D,wr),e(D,oa),e(oa,yr),e(D,kr),S(vt,D,null),m(t,Ia,p),m(t,ge,p),e(ge,Pe),e(Pe,aa),S(St,aa,null),e(ge,Tr),e(ge,na),e(na,Ur),m(t,Ba,p),m(t,F,p),S(bt,F,null),e(F,$r),e(F,sa),e(sa,Fr),e(F,xr),e(F,wt),e(wt,jr),e(wt,yt),e(yt,Cr),e(wt,qr),e(F,Er),e(F,kt),e(kt,Pr),e(kt,go),e(go,Mr),e(kt,Ar),e(F,zr),e(F,Tt),e(Tt,Dr),e(Tt,Ut),e(Ut,Or),e(Tt,Vr),e(F,Lr),e(F,O),S($t,O,null),e(O,Nr),e(O,_e),e(_e,Wr),e(_e,_o),e(_o,Ir),e(_e,Br),e(_e,ra),e(ra,Hr),e(_e,Xr),e(O,Rr),S(Me,O,null),e(O,Zr),e(O,ia),e(ia,Qr),e(O,Yr),S(Ft,O,null),m(t,Ha,p),m(t,ve,p),e(ve,Ae),e(Ae,la),S(xt,la,null),e(ve,Jr),e(ve,ca),e(ca,Kr),m(t,Xa,p),m(t,x,p),S(jt,x,null),e(x,Gr),e(x,da),e(da,ei),e(x,ti),e(x,Ct),e(Ct,oi),e(Ct,qt),e(qt,ai),e(Ct,ni),e(x,si),e(x,Et),e(Et,ri),e(Et,vo),e(vo,ii),e(Et,li),e(x,ci),e(x,Pt),e(Pt,di),e(Pt,Mt),e(Mt,pi),e(Pt,hi),e(x,mi),e(x,V),S(At,V,null),e(V,ui),e(V,Se),e(Se,fi),e(Se,So),e(So,gi),e(Se,_i),e(Se,pa),e(pa,vi),e(Se,Si),e(V,bi),S(ze,V,null),e(V,wi),e(V,ha),e(ha,yi),e(V,ki),S(zt,V,null),m(t,Ra,p),m(t,be,p),e(be,De),e(De,ma),S(Dt,ma,null),e(be,Ti),e(be,ua),e(ua,Ui),m(t,Za,p),m(t,j,p),S(Ot,j,null),e(j,$i),e(j,fa),e(fa,Fi),e(j,xi),e(j,Vt),e(Vt,ji),e(Vt,Lt),e(Lt,Ci),e(Vt,qi),e(j,Ei),e(j,Nt),e(Nt,Pi),e(Nt,bo),e(bo,Mi),e(Nt,Ai),e(j,zi),e(j,Wt),e(Wt,Di),e(Wt,It),e(It,Oi),e(Wt,Vi),e(j,Li),e(j,L),S(Bt,L,null),e(L,Ni),e(L,we),e(we,Wi),e(we,wo),e(wo,Ii),e(we,Bi),e(we,ga),e(ga,Hi),e(we,Xi),e(L,Ri),S(Oe,L,null),e(L,Zi),e(L,_a),e(_a,Qi),e(L,Yi),S(Ht,L,null),m(t,Qa,p),m(t,ye,p),e(ye,Ve),e(Ve,va),S(Xt,va,null),e(ye,Ji),e(ye,Sa),e(Sa,Ki),m(t,Ya,p),m(t,M,p),S(Rt,M,null),e(M,Gi),e(M,ke),e(ke,el),e(ke,ba),e(ba,tl),e(ke,ol),e(ke,Zt),e(Zt,al),e(ke,nl),e(M,sl),e(M,Qt),e(Qt,rl),e(Qt,yo),e(yo,il),e(Qt,ll),e(M,cl),e(M,Yt),e(Yt,dl),e(Yt,Jt),e(Jt,pl),e(Yt,hl),e(M,ml),e(M,N),S(Kt,N,null),e(N,ul),e(N,Te),e(Te,fl),e(Te,ko),e(ko,gl),e(Te,_l),e(Te,wa),e(wa,vl),e(Te,Sl),e(N,bl),S(Le,N,null),e(N,wl),e(N,ya),e(ya,yl),e(N,kl),S(Gt,N,null),Ja=!0},p(t,[p]){const eo={};p&2&&(eo.$$scope={dirty:p,ctx:t}),Ce.$set(eo);const ka={};p&2&&(ka.$$scope={dirty:p,ctx:t}),Ee.$set(ka);const Ta={};p&2&&(Ta.$$scope={dirty:p,ctx:t}),Me.$set(Ta);const Ua={};p&2&&(Ua.$$scope={dirty:p,ctx:t}),ze.$set(Ua);const to={};p&2&&(to.$$scope={dirty:p,ctx:t}),Oe.$set(to);const $a={};p&2&&($a.$$scope={dirty:p,ctx:t}),Le.$set($a)},i(t){Ja||(b(g.$$.fragment,t),b(Ne.$$.fragment,t),b(Re.$$.fragment,t),b(Ze.$$.fragment,t),b(Ye.$$.fragment,t),b(Je.$$.fragment,t),b(Ke.$$.fragment,t),b(et.$$.fragment,t),b(ot.$$.fragment,t),b(at.$$.fragment,t),b(ct.$$.fragment,t),b(Ce.$$.fragment,t),b(dt.$$.fragment,t),b(pt.$$.fragment,t),b(ht.$$.fragment,t),b(_t.$$.fragment,t),b(Ee.$$.fragment,t),b(vt.$$.fragment,t),b(St.$$.fragment,t),b(bt.$$.fragment,t),b($t.$$.fragment,t),b(Me.$$.fragment,t),b(Ft.$$.fragment,t),b(xt.$$.fragment,t),b(jt.$$.fragment,t),b(At.$$.fragment,t),b(ze.$$.fragment,t),b(zt.$$.fragment,t),b(Dt.$$.fragment,t),b(Ot.$$.fragment,t),b(Bt.$$.fragment,t),b(Oe.$$.fragment,t),b(Ht.$$.fragment,t),b(Xt.$$.fragment,t),b(Rt.$$.fragment,t),b(Kt.$$.fragment,t),b(Le.$$.fragment,t),b(Gt.$$.fragment,t),Ja=!0)},o(t){w(g.$$.fragment,t),w(Ne.$$.fragment,t),w(Re.$$.fragment,t),w(Ze.$$.fragment,t),w(Ye.$$.fragment,t),w(Je.$$.fragment,t),w(Ke.$$.fragment,t),w(et.$$.fragment,t),w(ot.$$.fragment,t),w(at.$$.fragment,t),w(ct.$$.fragment,t),w(Ce.$$.fragment,t),w(dt.$$.fragment,t),w(pt.$$.fragment,t),w(ht.$$.fragment,t),w(_t.$$.fragment,t),w(Ee.$$.fragment,t),w(vt.$$.fragment,t),w(St.$$.fragment,t),w(bt.$$.fragment,t),w($t.$$.fragment,t),w(Me.$$.fragment,t),w(Ft.$$.fragment,t),w(xt.$$.fragment,t),w(jt.$$.fragment,t),w(At.$$.fragment,t),w(ze.$$.fragment,t),w(zt.$$.fragment,t),w(Dt.$$.fragment,t),w(Ot.$$.fragment,t),w(Bt.$$.fragment,t),w(Oe.$$.fragment,t),w(Ht.$$.fragment,t),w(Xt.$$.fragment,t),w(Rt.$$.fragment,t),w(Kt.$$.fragment,t),w(Le.$$.fragment,t),w(Gt.$$.fragment,t),Ja=!1},d(t){o(h),t&&o(T),t&&o(u),y(g),t&&o(Fa),t&&o(ne),y(Ne),t&&o(xa),t&&o($e),t&&o(ja),t&&o(ao),t&&o(Ca),t&&o(no),t&&o(qa),t&&o(so),t&&o(Ea),t&&o(H),t&&o(Pa),t&&o(X),t&&o(Ma),t&&o(se),y(Re),t&&o(Aa),t&&o(q),y(Ze),y(Ye),t&&o(za),t&&o(le),y(Je),t&&o(Da),t&&o(ce),y(Ke),t&&o(Oa),t&&o(de),y(et),t&&o(Va),t&&o(pe),y(ot),t&&o(La),t&&o(E),y(at),y(ct),y(Ce),y(dt),t&&o(Na),t&&o(me),y(pt),t&&o(Wa),t&&o(P),y(ht),y(_t),y(Ee),y(vt),t&&o(Ia),t&&o(ge),y(St),t&&o(Ba),t&&o(F),y(bt),y($t),y(Me),y(Ft),t&&o(Ha),t&&o(ve),y(xt),t&&o(Xa),t&&o(x),y(jt),y(At),y(ze),y(zt),t&&o(Ra),t&&o(be),y(Dt),t&&o(Za),t&&o(j),y(Ot),y(Bt),y(Oe),y(Ht),t&&o(Qa),t&&o(ye),y(Xt),t&&o(Ya),t&&o(M),y(Rt),y(Kt),y(Le),y(Gt)}}}const pd={local:"unispeechsat",sections:[{local:"overview",title:"Overview"},{local:"transformers.UniSpeechSatConfig",title:"UniSpeechSatConfig"},{local:"transformers.models.unispeech_sat.modeling_unispeech_sat.UniSpeechSatBaseModelOutput",title:"UniSpeechSat specific outputs"},{local:"transformers.UniSpeechSatModel",title:"UniSpeechSatModel"},{local:"transformers.UniSpeechSatForCTC",title:"UniSpeechSatForCTC"},{local:"transformers.UniSpeechSatForSequenceClassification",title:"UniSpeechSatForSequenceClassification"},{local:"transformers.UniSpeechSatForAudioFrameClassification",title:"UniSpeechSatForAudioFrameClassification"},{local:"transformers.UniSpeechSatForXVector",title:"UniSpeechSatForXVector"},{local:"transformers.UniSpeechSatForPreTraining",title:"UniSpeechSatForPreTraining"}],title:"UniSpeech-SAT"};function hd(C,h,T){let{fw:u}=h;return C.$$set=k=>{"fw"in k&&T(0,u=k.fw)},[u]}class Sd extends ed{constructor(h){super();td(this,h,hd,dd,od,{fw:0})}}export{Sd as default,pd as metadata};
