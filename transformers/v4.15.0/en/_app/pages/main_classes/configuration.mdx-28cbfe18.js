import{S as bs,i as vs,s as ys,e as r,k as d,w as g,t as o,M as ws,c as a,d as t,m as c,a as s,x as p,h as n,b as h,F as e,g as A,y as _,q as b,o as v,B as y}from"../../chunks/vendor-ab4e3193.js";import{T as gs}from"../../chunks/Tip-b5c6375a.js";import{D}from"../../chunks/Docstring-b69c0bd4.js";import{C as ps}from"../../chunks/CodeBlock-516df0c5.js";import{I as _s}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function $s(be){let m,C,u,w,j;return{c(){m=r("p"),C=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
...
initialize a model does `),u=a(P,"STRONG",{});var S=s(u);w=n(S,"not"),S.forEach(t),j=n(P," load the model weights. It only affects the model\u2019s configuration."),P.forEach(t)},m($,P){A($,m,P),e(m,C),e(m,u),e(u,w),e(m,j)},d($){$&&t(m)}}}function ks(be){let m,C,u,w,j;return{c(){m=r("p"),C=o("Passing "),u=r("code"),w=o("use_auth_token=True"),j=o(" is required when you want to use a private model.")},l($){m=a($,"P",{});var P=s(m);C=n(P,"Passing "),u=a(P,"CODE",{});var S=s(u);w=n(S,"use_auth_token=True"),S.forEach(t),j=n(P," is required when you want to use a private model."),P.forEach(t)},m($,P){A($,m,P),e(m,C),e(m,u),e(u,w),e(m,j)},d($){$&&t(m)}}}function Ps(be){let m,C,u,w,j,$,P,S,$o,Yt,J,ko,Be,Po,Co,Zt,E,Eo,ot,xo,To,nt,Do,jo,rt,zo,Oo,at,Ao,So,eo,V,R,st,ve,Fo,it,Io,to,l,ye,Lo,dt,No,qo,G,Mo,ct,Wo,Ho,F,M,lt,Vo,Bo,ft,Uo,Jo,Ue,Ro,Go,Xo,x,ht,Ko,Qo,mt,Yo,Zo,Je,en,tn,Re,on,nn,Ge,rn,an,sn,X,ut,dn,cn,gt,ln,fn,hn,K,pt,mn,un,_t,gn,pn,_n,bt,bn,vn,I,Q,vt,yn,wn,yt,$n,kn,Pn,Y,wt,Cn,En,$t,xn,Tn,Dn,Z,kt,jn,zn,Pt,On,An,Sn,ee,Ct,Fn,In,Et,Ln,Nn,qn,z,we,Mn,$e,Wn,xt,Hn,Vn,Bn,Tt,Un,Jn,ke,Rn,te,Pe,Gn,L,Xn,Dt,Kn,Qn,jt,Yn,Zn,zt,er,tr,or,oe,Ce,nr,Ee,rr,Xe,ar,sr,ir,ne,xe,dr,Te,cr,Ke,lr,fr,hr,T,De,mr,je,ur,Qe,gr,pr,_r,re,br,Ot,vr,yr,ze,wr,ae,Oe,$r,N,kr,At,Pr,Cr,Ye,Er,xr,St,Tr,Dr,jr,se,Ae,zr,B,Or,Ft,Ar,Sr,Ze,Fr,Ir,Lr,ie,Se,Nr,It,qr,Mr,de,Fe,Wr,Lt,Hr,Vr,ce,Ie,Br,Nt,Ur,Jr,le,Le,Rr,qt,Gr,Xr,fe,Ne,Kr,qe,Qr,Mt,Yr,Zr,ea,O,Me,ta,We,oa,Wt,na,ra,aa,U,sa,Ht,ia,da,Vt,ca,la,fa,Bt,ha,oo;return $=new _s({}),ve=new _s({}),ye=new D({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/configuration_utils.py#L48",parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
Store the string that was passed to <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">PreTrainedModel.from_pretrained()</a> or
<a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">TFPreTrainedModel.from_pretrained()</a> as <code>pretrained_model_name_or_path</code> if the configuration was created
...
`),ot=r("code"),xo=o("hidden_size"),To=o(", "),nt=r("code"),Do=o("num_attention_heads"),jo=o(", and "),rt=r("code"),zo=o("num_hidden_layers"),Oo=o(`. Text models further implement:
`),at=r("code"),Ao=o("vocab_size"),So=o("."),eo=d(),V=r("h2"),R=r("a"),st=r("span"),g(ve.$$.fragment),Fo=d(),it=r("span"),Io=o("PretrainedConfig"),to=d(),l=r("div"),g(ye.$$.fragment),Lo=d(),dt=r("p"),No=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),qo=d(),g(G.$$.fragment),Mo=d(),ct=r("p"),Wo=o("Class attributes (overridden by derived classes):"),Ho=d(),F=r("ul"),M=r("li"),lt=r("strong"),Vo=o("model_type"),Bo=o(" ("),ft=r("code"),Uo=o("str"),Jo=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
the correct object in `),Ue=r("a"),Ro=o("AutoConfig"),Go=o("."),Xo=d(),x=r("li"),ht=r("strong"),Ko=o("is_composition"),Qo=o(" ("),mt=r("code"),Yo=o("bool"),Zo=o(`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
...
naming of attributes.`),_n=d(),bt=r("p"),bn=o("Common attributes (present in all subclasses):"),vn=d(),I=r("ul"),Q=r("li"),vt=r("strong"),yn=o("vocab_size"),wn=o(" ("),yt=r("code"),$n=o("int"),kn=o(`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
...
model.`),Sn=d(),ee=r("li"),Ct=r("strong"),Fn=o("num_hidden_layers"),In=o(" ("),Et=r("code"),Ln=o("int"),Nn=o(") \u2014 The number of blocks in the model."),qn=d(),z=r("div"),g(we.$$.fragment),Mn=d(),$e=r("p"),Wn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),xt=r("code"),Hn=o("repo_path_or_name"),Vn=o("."),Bn=d(),Tt=r("p"),Un=o("Examples:"),Jn=d(),g(ke.$$.fragment),Rn=d(),te=r("div"),g(Pe.$$.fragment),Gn=d(),L=r("p"),Xn=o("Checks whether the passed dictionary has a "),Dt=r("em"),Kn=o("torch_dtype"),Qn=o(` key and if it\u2019s not None, converts torch.dtype to a
string of just the type. For example, `),jt=r("code"),Yn=o("torch.float32"),Zn=o(" get converted into "),zt=r("em"),er=o("\u201Cfloat32\u201D"),tr=o(` string, which can
then be stored in the json format.`),or=d(),oe=r("div"),g(Ce.$$.fragment),nr=d(),Ee=r("p"),rr=o("Instantiates a "),Xe=r("a"),ar=o("PretrainedConfig"),sr=o(" from a Python dictionary of parameters."),ir=d(),ne=r("div"),g(xe.$$.fragment),dr=d(),Te=r("p"),cr=o("Instantiates a "),Ke=r("a"),lr=o("PretrainedConfig"),fr=o(" from the path to a JSON file of parameters."),hr=d(),T=r("div"),g(De.$$.fragment),mr=d(),je=r("p"),ur=o("Instantiate a "),Qe=r("a"),gr=o("PretrainedConfig"),pr=o(` (or a derived class) from a pretrained model
configuration.`),_r=d(),g(re.$$.fragment),br=d(),Ot=r("p"),vr=o("Examples:"),yr=d(),g(ze.$$.fragment),wr=d(),ae=r("div"),g(Oe.$$.fragment),$r=d(),N=r("p"),kr=o("From a "),At=r("code"),Pr=o("pretrained_model_name_or_path"),Cr=o(`, resolve to a dictionary of parameters, to be used for instantiating a
`),Ye=r("a"),Er=o("PretrainedConfig"),xr=o(" using "),St=r("code"),Tr=o("from_dict"),Dr=o("."),jr=d(),se=r("div"),g(Ae.$$.fragment),zr=d(),B=r("p"),Or=o("Save a configuration object to the directory "),Ft=r("code"),Ar=o("save_directory"),Sr=o(`, so that it can be re-loaded using the
`),Ze=r("a"),Fr=o("from_pretrained()"),Ir=o(" class method."),Lr=d(),ie=r("div"),g(Se.$$.fragment),Nr=d(),It=r("p"),qr=o("Serializes this instance to a Python dictionary."),Mr=d(),de=r("div"),g(Fe.$$.fragment),Wr=d(),Lt=r("p"),Hr=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Vr=d(),ce=r("div"),g(Ie.$$.fragment),Br=d(),Nt=r("p"),Ur=o("Save this instance to a JSON file."),Jr=d(),le=r("div"),g(Le.$$.fragment),Rr=d(),qt=r("p"),Gr=o("Serializes this instance to a JSON string."),Xr=d(),fe=r("div"),g(Ne.$$.fragment),Kr=d(),qe=r("p"),Qr=o("Updates attributes of this class with attributes from "),Mt=r("code"),Yr=o("config_dict"),Zr=o("."),ea=d(),O=r("div"),g(Me.$$.fragment),ta=d(),We=r("p"),oa=o("Updates attributes of this class with attributes from "),Wt=r("code"),na=o("update_str"),ra=o("."),aa=d(),U=r("p"),sa=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),ia=o("true"),da=o(" or "),Vt=r("code"),ca=o("false"),la=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),fa=d(),Bt=r("p"),ha=o("The keys to change have to already exist in the config object."),this.h()},l(i){const k=ws('[data-svelte="svelte-1phssyn"]',document.head);m=a(k,"META",{name:!0,content:!0}),k.forEach(t),C=c(i),u=a(i,"H1",{class:!0});var He=s(u);w=a(He,"A",{id:!0,class:!0,href:!0});var Ut=s(w);j=a(Ut,"SPAN",{});var ma=s(j);p($.$$.fragment,ma),ma.forEach(t),Ut.forEach(t),P=c(He),S=a(He,"SPAN",{});var ua=s(S);$o=n(ua,"Configuration"),ua.forEach(t),He.forEach(t),Yt=c(i),J=a(i,"P",{});var no=s(J);ko=n(no,"The base class "),Be=a(no,"A",{href:!0});var ga=s(Be);Po=n(ga,"PretrainedConfig"),ga.forEach(t),Co=n(no,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),ot=a(W,"CODE",{});var pa=s(ot);xo=n(pa,"hidden_size"),pa.forEach(t),To=n(W,", "),nt=a(W,"CODE",{});var _a=s(nt);Do=n(_a,"num_attention_heads"),_a.forEach(t),jo=n(W,", and "),rt=a(W,"CODE",{});var ba=s(rt);zo=n(ba,"num_hidden_layers"),ba.forEach(t),Oo=n(W,`. Text models further implement:
`),at=a(W,"CODE",{});var va=s(at);Ao=n(va,"vocab_size"),va.forEach(t),So=n(W,"."),W.forEach(t),eo=c(i),V=a(i,"H2",{class:!0});var ro=s(V);R=a(ro,"A",{id:!0,class:!0,href:!0});var ya=s(R);st=a(ya,"SPAN",{});var wa=s(st);p(ve.$$.fragment,wa),wa.forEach(t),ya.forEach(t),Fo=c(ro),it=a(ro,"SPAN",{});var $a=s(it);Io=n($a,"PretrainedConfig"),$a.forEach(t),ro.forEach(t),to=c(i),l=a(i,"DIV",{class:!0});var f=s(l);p(ye.$$.fragment,f),Lo=c(f),dt=a(f,"P",{});var ka=s(dt);No=n(ka,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
the correct object in `),Ue=a(Ve,"A",{href:!0});var xa=s(Ue);Ro=n(xa,"AutoConfig"),xa.forEach(t),Go=n(Ve,"."),Ve.forEach(t),Xo=c(he),x=a(he,"LI",{});var q=s(x);ht=a(q,"STRONG",{});var Ta=s(ht);Ko=n(Ta,"is_composition"),Ta.forEach(t),Qo=n(q," ("),mt=a(q,"CODE",{});var Da=s(mt);Yo=n(Da,"bool"),Da.forEach(t),Zo=n(q,`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
config has to be initialized from two or more configs of type `),Je=a(q,"A",{href:!0});var ja=s(Je);en=n(ja,"PretrainedConfig"),ja.forEach(t),tn=n(q,` like:
`),Re=a(q,"A",{href:!0});var za=s(Re);on=n(za,"EncoderDecoderConfig"),za.forEach(t),nn=n(q," or "),Ge=a(q,"A",{href:!0});var Oa=s(Ge);rn=n(Oa,"~RagConfig"),Oa.forEach(t),an=n(q,"."),q.forEach(t),sn=c(he),X=a(he,"LI",{});var Jt=s(X);ut=a(Jt,"STRONG",{});var Aa=s(ut);dn=n(Aa,"keys_to_ignore_at_inference"),Aa.forEach(t),cn=n(Jt," ("),gt=a(Jt,"CODE",{});var Sa=s(gt);ln=n(Sa,"List[str]"),Sa.forEach(t),fn=n(Jt,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Jt.forEach(t),hn=c(he),K=a(he,"LI",{});var Rt=s(K);pt=a(Rt,"STRONG",{});var Fa=s(pt);mn=n(Fa,"attribute_map"),Fa.forEach(t),un=n(Rt," ("),_t=a(Rt,"CODE",{});var Ia=s(_t);gn=n(Ia,"Dict[str, str]"),Ia.forEach(t),pn=n(Rt,`) \u2014 A dict that maps model specific attribute names to the standardized
naming of attributes.`),Rt.forEach(t),he.forEach(t),_n=c(f),bt=a(f,"P",{});var La=s(bt);bn=n(La,"Common attributes (present in all subclasses):"),La.forEach(t),vn=c(f),I=a(f,"UL",{});var me=s(I);Q=a(me,"LI",{});var Gt=s(Q);vt=a(Gt,"STRONG",{});var Na=s(vt);yn=n(Na,"vocab_size"),Na.forEach(t),wn=n(Gt," ("),yt=a(Gt,"CODE",{});var qa=s(yt);$n=n(qa,"int"),qa.forEach(t),kn=n(Gt,`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
...
model.`),Kt.forEach(t),Sn=c(me),ee=a(me,"LI",{});var Qt=s(ee);Ct=a(Qt,"STRONG",{});var Ba=s(Ct);Fn=n(Ba,"num_hidden_layers"),Ba.forEach(t),In=n(Qt," ("),Et=a(Qt,"CODE",{});var Ua=s(Et);Ln=n(Ua,"int"),Ua.forEach(t),Nn=n(Qt,") \u2014 The number of blocks in the model."),Qt.forEach(t),me.forEach(t),qn=c(f),z=a(f,"DIV",{class:!0});var ue=s(z);p(we.$$.fragment,ue),Mn=c(ue),$e=a(ue,"P",{});var ao=s($e);Wn=n(ao,`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),xt=a(ao,"CODE",{});var Ja=s(xt);Hn=n(Ja,"repo_path_or_name"),Ja.forEach(t),Vn=n(ao,"."),ao.forEach(t),Bn=c(ue),Tt=a(ue,"P",{});var Ra=s(Tt);Un=n(Ra,"Examples:"),Ra.forEach(t),Jn=c(ue),p(ke.$$.fragment,ue),ue.forEach(t),Rn=c(f),te=a(f,"DIV",{class:!0});var so=s(te);p(Pe.$$.fragment,so),Gn=c(so),L=a(so,"P",{});var ge=s(L);Xn=n(ge,"Checks whether the passed dictionary has a "),Dt=a(ge,"EM",{});var Ga=s(Dt);Kn=n(Ga,"torch_dtype"),Ga.forEach(t),Qn=n(ge,` key and if it\u2019s not None, converts torch.dtype to a
string of just the type. For example, `),jt=a(ge,"CODE",{});var Xa=s(jt);Yn=n(Xa,"torch.float32"),Xa.forEach(t),Zn=n(ge," get converted into "),zt=a(ge,"EM",{});var Ka=s(zt);er=n(Ka,"\u201Cfloat32\u201D"),Ka.forEach(t),tr=n(ge,` string, which can
then be stored in the json format.`),ge.forEach(t),so.forEach(t),or=c(f),oe=a(f,"DIV",{class:!0});var io=s(oe);p(Ce.$$.fragment,io),nr=c(io),Ee=a(io,"P",{});var co=s(Ee);rr=n(co,"Instantiates a "),Xe=a(co,"A",{href:!0});var Qa=s(Xe);ar=n(Qa,"PretrainedConfig"),Qa.forEach(t),sr=n(co," from a Python dictionary of parameters."),co.forEach(t),io.forEach(t),ir=c(f),ne=a(f,"DIV",{class:!0});var lo=s(ne);p(xe.$$.fragment,lo),dr=c(lo),Te=a(lo,"P",{});var fo=s(Te);cr=n(fo,"Instantiates a "),Ke=a(fo,"A",{href:!0});var Ya=s(Ke);lr=n(Ya,"PretrainedConfig"),Ya.forEach(t),fr=n(fo," from the path to a JSON file of parameters."),fo.forEach(t),lo.forEach(t),hr=c(f),T=a(f,"DIV",{class:!0});var H=s(T);p(De.$$.fragment,H),mr=c(H),je=a(H,"P",{});var ho=s(je);ur=n(ho,"Instantiate a "),Qe=a(ho,"A",{href:!0});var Za=s(Qe);gr=n(Za,"PretrainedConfig"),Za.forEach(t),pr=n(ho,` (or a derived class) from a pretrained model
configuration.`),ho.forEach(t),_r=c(H),p(re.$$.fragment,H),br=c(H),Ot=a(H,"P",{});var es=s(Ot);vr=n(es,"Examples:"),es.forEach(t),yr=c(H),p(ze.$$.fragment,H),H.forEach(t),wr=c(f),ae=a(f,"DIV",{class:!0});var mo=s(ae);p(Oe.$$.fragment,mo),$r=c(mo),N=a(mo,"P",{});var pe=s(N);kr=n(pe,"From a "),At=a(pe,"CODE",{});var ts=s(At);Pr=n(ts,"pretrained_model_name_or_path"),ts.forEach(t),Cr=n(pe,`, resolve to a dictionary of parameters, to be used for instantiating a
`),Ye=a(pe,"A",{href:!0});var os=s(Ye);Er=n(os,"PretrainedConfig"),os.forEach(t),xr=n(pe," using "),St=a(pe,"CODE",{});var ns=s(St);Tr=n(ns,"from_dict"),ns.forEach(t),Dr=n(pe,"."),pe.forEach(t),mo.forEach(t),jr=c(f),se=a(f,"DIV",{class:!0});var uo=s(se);p(Ae.$$.fragment,uo),zr=c(uo),B=a(uo,"P",{});var et=s(B);Or=n(et,"Save a configuration object to the directory "),Ft=a(et,"CODE",{});var rs=s(Ft);Ar=n(rs,"save_directory"),rs.forEach(t),Sr=n(et,`, so that it can be re-loaded using the
`),Ze=a(et,"A",{href:!0});var as=s(Ze);Fr=n(as,"from_pretrained()"),as.forEach(t),Ir=n(et," class method."),et.forEach(t),uo.forEach(t),Lr=c(f),ie=a(f,"DIV",{class:!0});var go=s(ie);p(Se.$$.fragment,go),Nr=c(go),It=a(go,"P",{});var ss=s(It);qr=n(ss,"Serializes this instance to a Python dictionary."),ss.forEach(t),go.forEach(t),Mr=c(f),de=a(f,"DIV",{class:!0});var po=s(de);p(Fe.$$.fragment,po),Wr=c(po),Lt=a(po,"P",{});var is=s(Lt);Hr=n(is,`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),is.forEach(t),po.forEach(t),Vr=c(f),ce=a(f,"DIV",{class:!0});var _o=s(ce);p(Ie.$$.fragment,_o),Br=c(_o),Nt=a(_o,"P",{});var ds=s(Nt);Ur=n(ds,"Save this instance to a JSON file."),ds.forEach(t),_o.forEach(t),Jr=c(f),le=a(f,"DIV",{class:!0});var bo=s(le);p(Le.$$.fragment,bo),Rr=c(bo),qt=a(bo,"P",{});var cs=s(qt);Gr=n(cs,"Serializes this instance to a JSON string."),cs.forEach(t),bo.forEach(t),Xr=c(f),fe=a(f,"DIV",{class:!0});var vo=s(fe);p(Ne.$$.fragment,vo),Kr=c(vo),qe=a(vo,"P",{});var yo=s(qe);Qr=n(yo,"Updates attributes of this class with attributes from "),Mt=a(yo,"CODE",{});var ls=s(Mt);Yr=n(ls,"config_dict"),ls.forEach(t),Zr=n(yo,"."),yo.forEach(t),vo.forEach(t),ea=c(f),O=a(f,"DIV",{class:!0});var _e=s(O);p(Me.$$.fragment,_e),ta=c(_e),We=a(_e,"P",{});var wo=s(We);oa=n(wo,"Updates attributes of this class with attributes from "),Wt=a(wo,"CODE",{});var fs=s(Wt);na=n(fs,"update_str"),fs.forEach(t),ra=n(wo,"."),wo.forEach(t),aa=c(_e),U=a(_e,"P",{});var tt=s(U);sa=n(tt,"The expected format is ints, floats and strings as is, and for booleans use "),Ht=a(tt,"CODE",{});var hs=s(Ht);ia=n(hs,"true"),hs.forEach(t),da=n(tt," or "),Vt=a(tt,"CODE",{});var ms=s(Vt);ca=n(ms,"false"),ms.forEach(t),la=n(tt,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),tt.forEach(t),fa=c(_e),Bt=a(_e,"P",{});var us=s(Bt);ha=n(us,"The keys to change have to already exist in the config object."),us.forEach(t),_e.forEach(t),f.forEach(t),this.h()},h(){h(m,"name","hf:doc:metadata"),h(m,"content",JSON.stringify(Cs)),h(w,"id","configuration"),h(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(w,"href","#configuration"),h(u,"class","relative group"),h(Be,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(R,"id","transformers.PretrainedConfig"),h(R,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(R,"href","#transformers.PretrainedConfig"),h(V,"class","relative group"),h(Ue,"href","/docs/transformers/v4.15.0/en/model_doc/auto#transformers.AutoConfig"),h(Je,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(Re,"href","/docs/transformers/v4.15.0/en/model_doc/encoderdecoder#transformers.EncoderDecoderConfig"),h(Ge,"href","/docs/transformers/v4.15.0/en/model_doc/rag#transformers.RagConfig"),h(z,"class","docstring"),h(te,"class","docstring"),h(Xe,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(oe,"class","docstring"),h(Ke,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(ne,"class","docstring"),h(Qe,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(T,"class","docstring"),h(Ye,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(ae,"class","docstring"),h(Ze,"href","/docs/transformers/v4.15.0/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),h(se,"class","docstring"),h(ie,"class","docstring"),h(de,"class","docstring"),h(ce,"class","docstring"),h(le,"class","docstring"),h(fe,"class","docstring"),h(O,"class","docstring"),h(l,"class","docstring")},m(i,k){e(document.head,m),A(i,C,k),A(i,u,k),e(u,w),e(w,j),_($,j,null),e(u,P),e(u,S),e(S,$o),A(i,Yt,k),A(i,J,k),e(J,ko),e(J,Be),e(Be,Po),e(J,Co),A(i,Zt,k),A(i,E,k),e(E,Eo),e(E,ot),e(ot,xo),e(E,To),e(E,nt),e(nt,Do),e(E,jo),e(E,rt),e(rt,zo),e(E,Oo),e(E,at),e(at,Ao),e(E,So),A(i,eo,k),A(i,V,k),e(V,R),e(R,st),_(ve,st,null),e(V,Fo),e(V,it),e(it,Io),A(i,to,k),A(i,l,k),_(ye,l,null),e(l,Lo),e(l,dt),e(dt,No),e(l,qo),_(G,l,null),e(l,Mo),e(l,ct),e(ct,Wo),e(l,Ho),e(l,F),e(F,M),e(M,lt),e(lt,Vo),e(M,Bo),e(M,ft),e(ft,Uo),e(M,Jo),e(M,Ue),e(Ue,Ro),e(M,Go),e(F,Xo),e(F,x),e(x,ht),e(ht,Ko),e(x,Qo),e(x,mt),e(mt,Yo),e(x,Zo),e(x,Je),e(Je,en),e(x,tn),e(x,Re),e(Re,on),e(x,nn),e(x,Ge),e(Ge,rn),e(x,an),e(F,sn),e(F,X),e(X,ut),e(ut,dn),e(X,cn),e(X,gt),e(gt,ln),e(X,fn),e(F,hn),e(F,K),e(K,pt),e(pt,mn),e(K,un),e(K,_t),e(_t,gn),e(K,pn),e(l,_n),e(l,bt),e(bt,bn),e(l,vn),e(l,I),e(I,Q),e(Q,vt),e(vt,yn),e(Q,wn),e(Q,yt),e(yt,$n),e(Q,kn),e(I,Pn),e(I,Y),e(Y,wt),e(wt,Cn),e(Y,En),e(Y,$t),e($t,xn),e(Y,Tn),e(I,Dn),e(I,Z),e(Z,kt),e(kt,jn),e(Z,zn),e(Z,Pt),e(Pt,On),e(Z,An),e(I,Sn),e(I,ee),e(ee,Ct),e(Ct,Fn),e(ee,In),e(ee,Et),e(Et,Ln),e(ee,Nn),e(l,qn),e(l,z),_(we,z,null),e(z,Mn),e(z,$e),e($e,Wn),e($e,xt),e(xt,Hn),e($e,Vn),e(z,Bn),e(z,Tt),e(Tt,Un),e(z,Jn),_(ke,z,null),e(l,Rn),e(l,te),_(Pe,te,null),e(te,Gn),e(te,L),e(L,Xn),e(L,Dt),e(Dt,Kn),e(L,Qn),e(L,jt),e(jt,Yn),e(L,Zn),e(L,zt),e(zt,er),e(L,tr),e(l,or),e(l,oe),_(Ce,oe,null),e(oe,nr),e(oe,Ee),e(Ee,rr),e(Ee,Xe),e(Xe,ar),e(Ee,sr),e(l,ir),e(l,ne),_(xe,ne,null),e(ne,dr),e(ne,Te),e(Te,cr),e(Te,Ke),e(Ke,lr),e(Te,fr),e(l,hr),e(l,T),_(De,T,null),e(T,mr),e(T,je),e(je,ur),e(je,Qe),e(Qe,gr),e(je,pr),e(T,_r),_(re,T,null),e(T,br),e(T,Ot),e(Ot,vr),e(T,yr),_(ze,T,null),e(l,wr),e(l,ae),_(Oe,ae,null),e(ae,$r),e(ae,N),e(N,kr),e(N,At),e(At,Pr),e(N,Cr),e(N,Ye),e(Ye,Er),e(N,xr),e(N,St),e(St,Tr),e(N,Dr),e(l,jr),e(l,se),_(Ae,se,null),e(se,zr),e(se,B),e(B,Or),e(B,Ft),e(Ft,Ar),e(B,Sr),e(B,Ze),e(Ze,Fr),e(B,Ir),e(l,Lr),e(l,ie),_(Se,ie,null),e(ie,Nr),e(ie,It),e(It,qr),e(l,Mr),e(l,de),_(Fe,de,null),e(de,Wr),e(de,Lt),e(Lt,Hr),e(l,Vr),e(l,ce),_(Ie,ce,null),e(ce,Br),e(ce,Nt),e(Nt,Ur),e(l,Jr),e(l,le),_(Le,le,null),e(le,Rr),e(le,qt),e(qt,Gr),e(l,Xr),e(l,fe),_(Ne,fe,null),e(fe,Kr),e(fe,qe),e(qe,Qr),e(qe,Mt),e(Mt,Yr),e(qe,Zr),e(l,ea),e(l,O),_(Me,O,null),e(O,ta),e(O,We),e(We,oa),e(We,Wt),e(Wt,na),e(We,ra),e(O,aa),e(O,U),e(U,sa),e(U,Ht),e(Ht,ia),e(U,da),e(U,Vt),e(Vt,ca),e(U,la),e(O,fa),e(O,Bt),e(Bt,ha),oo=!0},p(i,[k]){const He={};k&2&&(He.$$scope={dirty:k,ctx:i}),G.$set(He);const Ut={};k&2&&(Ut.$$scope={dirty:k,ctx:i}),re.$set(Ut)},i(i){oo||(b($.$$.fragment,i),b(ve.$$.fragment,i),b(ye.$$.fragment,i),b(G.$$.fragment,i),b(we.$$.fragment,i),b(ke.$$.fragment,i),b(Pe.$$.fragment,i),b(Ce.$$.fragment,i),b(xe.$$.fragment,i),b(De.$$.fragment,i),b(re.$$.fragment,i),b(ze.$$.fragment,i),b(Oe.$$.fragment,i),b(Ae.$$.fragment,i),b(Se.$$.fragment,i),b(Fe.$$.fragment,i),b(Ie.$$.fragment,i),b(Le.$$.fragment,i),b(Ne.$$.fragment,i),b(Me.$$.fragment,i),oo=!0)},o(i){v($.$$.fragment,i),v(ve.$$.fragment,i),v(ye.$$.fragment,i),v(G.$$.fragment,i),v(we.$$.fragment,i),v(ke.$$.fragment,i),v(Pe.$$.fragment,i),v(Ce.$$.fragment,i),v(xe.$$.fragment,i),v(De.$$.fragment,i),v(re.$$.fragment,i),v(ze.$$.fragment,i),v(Oe.$$.fragment,i),v(Ae.$$.fragment,i),v(Se.$$.fragment,i),v(Fe.$$.fragment,i),v(Ie.$$.fragment,i),v(Le.$$.fragment,i),v(Ne.$$.fragment,i),v(Me.$$.fragment,i),oo=!1},d(i){t(m),i&&t(C),i&&t(u),y($),i&&t(Yt),i&&t(J),i&&t(Zt),i&&t(E),i&&t(eo),i&&t(V),y(ve),i&&t(to),i&&t(l),y(ye),y(G),y(we),y(ke),y(Pe),y(Ce),y(xe),y(De),y(re),y(ze),y(Oe),y(Ae),y(Se),y(Fe),y(Ie),y(Le),y(Ne),y(Me)}}}const Cs={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Es(be,m,C){let{fw:u}=m;return be.$$set=w=>{"fw"in w&&C(0,u=w.fw)},[u]}class As extends bs{constructor(m){super();vs(this,m,Es,Ps,ys,{fw:0})}}export{As as default,Cs as metadata};
