import{S as pg,i as hg,s as mg,e as n,k as d,w as _,t as r,L as fg,c as s,d as o,m as c,a,x as v,h as i,b as l,J as e,g as m,y as P,q as I,o as C,B as b}from"../../../chunks/vendor-b1433968.js";import{T as re}from"../../../chunks/Tip-c3840994.js";import{D as T}from"../../../chunks/Docstring-ff504c58.js";import{C as ne}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as O}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function ug(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("When used with "),f=n("code"),x=r("is_split_into_words=True"),$=r(`, this tokenizer will add a space before each word (even the first
one).`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"When used with "),f=s(g,"CODE",{});var k=a(f);x=i(k,"is_split_into_words=True"),k.forEach(o),$=i(g,`, this tokenizer will add a space before each word (even the first
one).`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function gg(y){let p,L,f,x,$,u,g,k;return{c(){p=n("p"),L=r("When used with "),f=n("code"),x=r("is_split_into_words=True"),$=r(`, this tokenizer needs to be instantiated with
`),u=n("code"),g=r("add_prefix_space=True"),k=r(".")},l(E){p=s(E,"P",{});var w=a(p);L=i(w,"When used with "),f=s(w,"CODE",{});var A=a(f);x=i(A,"is_split_into_words=True"),A.forEach(o),$=i(w,`, this tokenizer needs to be instantiated with
`),u=s(w,"CODE",{});var V=a(u);g=i(V,"add_prefix_space=True"),V.forEach(o),k=i(w,"."),w.forEach(o)},m(E,w){m(E,p,w),e(p,L),e(p,f),e(f,x),e(p,$),e(p,u),e(u,g),e(p,k)},d(E){E&&o(p)}}}function _g(y){let p,L,f,x,$,u,g,k;return{c(){p=n("p"),L=r(`This class method is simply calling CLIPFeatureExtractor\u2019s
`),f=n("code"),x=r("from_pretrained"),$=r(` and CLIPTokenizer\u2019s
`),u=n("code"),g=r("from_pretrained"),k=r(`. Please refer to the
docstrings of the methods above for more information.`)},l(E){p=s(E,"P",{});var w=a(p);L=i(w,`This class method is simply calling CLIPFeatureExtractor\u2019s
`),f=s(w,"CODE",{});var A=a(f);x=i(A,"from_pretrained"),A.forEach(o),$=i(w,` and CLIPTokenizer\u2019s
`),u=s(w,"CODE",{});var V=a(u);g=i(V,"from_pretrained"),V.forEach(o),k=i(w,`. Please refer to the
docstrings of the methods above for more information.`),w.forEach(o)},m(E,w){m(E,p,w),e(p,L),e(p,f),e(f,x),e(p,$),e(p,u),e(u,g),e(p,k)},d(E){E&&o(p)}}}function vg(y){let p,L,f,x,$,u,g,k;return{c(){p=n("p"),L=r("This class method is simply calling "),f=n("code"),x=r("save_pretrained"),$=r(` and
`),u=n("code"),g=r("save_pretrained"),k=r(`. Please refer to the
docstrings of the methods above for more information.`)},l(E){p=s(E,"P",{});var w=a(p);L=i(w,"This class method is simply calling "),f=s(w,"CODE",{});var A=a(f);x=i(A,"save_pretrained"),A.forEach(o),$=i(w,` and
`),u=s(w,"CODE",{});var V=a(u);g=i(V,"save_pretrained"),V.forEach(o),k=i(w,`. Please refer to the
docstrings of the methods above for more information.`),w.forEach(o)},m(E,w){m(E,p,w),e(p,L),e(p,f),e(f,x),e(p,$),e(p,u),e(u,g),e(p,k)},d(E){E&&o(p)}}}function Pg(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),x=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var k=a(f);x=i(k,"Module"),k.forEach(o),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function Ig(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),x=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var k=a(f);x=i(k,"Module"),k.forEach(o),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function Cg(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),x=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var k=a(f);x=i(k,"Module"),k.forEach(o),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function bg(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),x=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var k=a(f);x=i(k,"Module"),k.forEach(o),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function xg(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),x=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var k=a(f);x=i(k,"Module"),k.forEach(o),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function Lg(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),x=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var k=a(f);x=i(k,"Module"),k.forEach(o),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function $g(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),x=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var k=a(f);x=i(k,"Module"),k.forEach(o),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function kg(y){let p,L,f,x,$;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),x=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=a(p);L=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var k=a(f);x=i(k,"Module"),k.forEach(o),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,L),e(p,f),e(f,x),e(p,$)},d(u){u&&o(p)}}}function wg(y){let p,L,f,x,$,u,g,k,E,w,A,V,js,Ot,ji,Ms,Mi,fr,ot,qi,St,Fi,Ai,ur,$n,Di,gr,kn,qs,Vi,_r,we,nt,Fs,Wt,Ni,As,Oi,vr,wn,Si,Pr,st,Wi,Tn,Bi,Ri,Ir,D,Hi,yn,Ui,Gi,zn,Ji,Ki,En,Xi,Yi,jn,Zi,Qi,Mn,el,tl,qn,ol,nl,Cr,Bt,br,de,sl,Rt,al,rl,Ht,il,ll,xr,Te,at,Ds,Ut,dl,Vs,cl,Lr,se,Gt,pl,rt,Fn,hl,ml,An,fl,ul,gl,ye,_l,Dn,vl,Pl,Vn,Il,Cl,bl,it,Jt,xl,Kt,Ll,Nn,$l,kl,$r,ze,lt,Ns,Xt,wl,Os,Tl,kr,S,Yt,yl,Ee,zl,On,El,jl,Zt,Ml,ql,Fl,je,Al,Sn,Dl,Vl,Wn,Nl,Ol,Sl,Ss,Wl,Bl,Qt,wr,Me,dt,Ws,eo,Rl,Bs,Hl,Tr,W,to,Ul,qe,Gl,Bn,Jl,Kl,oo,Xl,Yl,Zl,Fe,Ql,Rn,ed,td,Hn,od,nd,sd,Rs,ad,rd,no,yr,Ae,ct,Hs,so,id,Us,ld,zr,z,ao,dd,Gs,cd,pd,Js,hd,md,ro,fd,Ks,ud,gd,_d,pt,vd,io,Pd,Un,Id,Cd,bd,ae,lo,xd,Xs,Ld,$d,Ys,Gn,kd,Zs,wd,Td,Qs,yd,zd,ht,co,Ed,po,jd,ea,Md,qd,Fd,ce,ho,Ad,Jn,Dd,Kn,Vd,Nd,ta,Od,Sd,oa,Er,De,mt,na,mo,Wd,sa,Bd,jr,q,fo,Rd,uo,Hd,aa,Ud,Gd,Jd,ra,Kd,Xd,go,Yd,_o,Zd,ia,Qd,ec,tc,ft,oc,vo,nc,Xn,sc,ac,Mr,Ve,ut,la,Po,rc,da,ic,qr,B,Io,lc,ca,dc,cc,Co,pc,pa,hc,mc,fc,gt,bo,uc,xo,gc,ha,_c,vc,Pc,_t,Lo,Ic,Ne,Cc,ma,bc,xc,fa,Lc,$c,Fr,Oe,vt,ua,$o,kc,ga,wc,Ar,F,ko,Tc,_a,yc,zc,H,Yn,Ec,jc,Zn,Mc,qc,Qn,Fc,Ac,va,Dc,Vc,es,Nc,Oc,Sc,Pt,wo,Wc,To,Bc,ts,Rc,Hc,Uc,It,yo,Gc,zo,Jc,os,Kc,Xc,Yc,pe,Eo,Zc,jo,Qc,ns,ep,tp,op,Ct,np,he,Mo,sp,Se,ap,Pa,rp,ip,ss,lp,dp,cp,bt,Dr,We,xt,Ia,qo,pp,Ca,hp,Vr,R,Fo,mp,Ao,fp,Do,up,gp,_p,U,Vo,vp,Be,Pp,as,Ip,Cp,ba,bp,xp,Lp,Lt,$p,xa,kp,wp,No,Tp,G,Oo,yp,Re,zp,rs,Ep,jp,La,Mp,qp,Fp,$t,Ap,$a,Dp,Vp,So,Np,J,Wo,Op,He,Sp,is,Wp,Bp,ka,Rp,Hp,Up,kt,Gp,wa,Jp,Kp,Bo,Nr,Ue,wt,Ta,Ro,Xp,ya,Yp,Or,Ho,K,Uo,Zp,Ge,Qp,ls,eh,th,za,oh,nh,sh,Tt,ah,Ea,rh,ih,Go,Sr,Je,yt,ja,Jo,lh,Ma,dh,Wr,Ko,X,Xo,ch,Ke,ph,ds,hh,mh,qa,fh,uh,gh,zt,_h,Fa,vh,Ph,Yo,Br,Xe,Et,Aa,Zo,Ih,Da,Ch,Rr,j,Qo,bh,en,xh,cs,Lh,$h,kh,tn,wh,on,Th,yh,zh,Va,Eh,jh,ie,Na,nn,Mh,qh,Oa,sn,Fh,Ah,Sa,an,Dh,Vh,Wa,rn,Nh,Oh,Y,ln,Sh,Ye,Wh,Ba,Bh,Rh,Ra,Hh,Uh,Gh,jt,Jh,Ha,Kh,Xh,dn,Yh,me,cn,Zh,Ua,Qh,em,pn,tm,fe,hn,om,Ga,nm,sm,mn,Hr,Ze,Mt,Ja,fn,am,Ka,rm,Ur,un,Z,gn,im,Qe,lm,Xa,dm,cm,Ya,pm,hm,mm,qt,fm,Za,um,gm,_n,Gr,et,Ft,Qa,vn,_m,er,vm,Jr,Pn,Q,In,Pm,tt,Im,tr,Cm,bm,or,xm,Lm,$m,At,km,nr,wm,Tm,Cn,Kr;return u=new O({}),Ot=new O({}),Wt=new O({}),Bt=new ne({props:{code:`from PIL import Image
import requests
...
`}}),co=new T({props:{name:"get\\_special\\_tokens\\_mask",anchor:"transformers.CLIPTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/clip/tokenization_clip.py#L240",parametersDescription:[{anchor:"transformers.CLIPTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
The tokenizer is a required input.`,name:"tokenizer"}]}}),wo=new T({props:{name:"batch\\_decode",anchor:"transformers.CLIPProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/clip/processing_clip.py#L162"}}),yo=new T({props:{name:"decode",anchor:"transformers.CLIPProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/clip/processing_clip.py#L170"}}),Eo=new T({props:{name:"from\\_pretrained",anchor:"transformers.CLIPProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/clip/processing_clip.py#L72",parametersDescription:[{anchor:"transformers.CLIPProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = logits_per_image.softmax(dim=<span class="hljs-number">1</span>) <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),Oo=new T({props:{name:"get\\_text\\_features",anchor:"transformers.CLIPModel.get_text_features",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/clip/modeling_clip.py#L875",parametersDescription:[{anchor:"transformers.CLIPModel.get_text_features.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See
<a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text_features = model.get_text_features(**inputs)`}}),Wo=new T({props:{name:"get\\_image\\_features",anchor:"transformers.CLIPModel.get_image_features",parameters:[{name:"pixel_values",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/clip/modeling_clip.py#L915",parametersDescription:[{anchor:"transformers.CLIPModel.get_image_features.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
<a href="/docs/transformers/v4.15.0/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See <code>CLIPFeatureExtractor.__call__()</code> for
...
<a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),ln=new T({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxCLIPPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"pixel_values",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/clip/modeling_flax_clip.py#L742",parametersDescription:[{anchor:"transformers.FlaxCLIPPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See
<a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>) <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),cn=new T({props:{name:"get\\_text\\_features",anchor:"transformers.FlaxCLIPPreTrainedModel.get_text_features",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/clip/modeling_flax_clip.py#L787",parametersDescription:[{anchor:"transformers.FlaxCLIPPreTrainedModel.get_text_features.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
