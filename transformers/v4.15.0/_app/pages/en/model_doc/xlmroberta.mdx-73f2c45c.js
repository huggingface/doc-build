...
the first positional argument :`),K=l(),L=s("ul"),C=s("li"),se=o("a single Tensor with "),B=s("code"),le=o("input_ids"),re=o(" only and nothing else: "),O=s("code"),fe=o("model(inputs_ids)"),de=l(),q=s("li"),me=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
documentation alongside usage examples.`),xl=l(),Nt=s("h2"),_o=s("a"),Sa=s("span"),v(nn.$$.fragment),zc=l(),Oa=s("span"),Lc=o("XLMRobertaTokenizer"),Pl=l(),Ee=s("div"),v(sn.$$.fragment),qc=l(),Tt=s("p"),Cc=o("Adapted from "),Rr=s("a"),xc=o("RobertaTokenizer"),Pc=o(" and "),Er=s("a"),Ac=o("XLNetTokenizer"),jc=o(`. Based on
`),rn=s("a"),Xc=o("SentencePiece"),Ic=o("."),Nc=l(),an=s("p"),Dc=o("This tokenizer inherits from "),zr=s("a"),Sc=o("PreTrainedTokenizer"),Oc=o(` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),Wc=l(),Dt=s("p"),Bc=o(`Attributes:
...
`),Cr=s("a"),kp=o("RobertaTokenizer"),vp=o(" and "),xr=s("a"),Tp=o("XLNetTokenizer"),wp=o(". Based on "),mn=s("a"),yp=o("BPE"),Mp=o("."),$p=l(),gn=s("p"),Fp=o("This tokenizer inherits from "),Pr=s("a"),Rp=o("PreTrainedTokenizerFast"),Ep=o(` which contains most of the main
methods. Users should refer to this superclass for more information regarding those methods.`),zp=l(),yt=s("div"),v(_n.$$.fragment),Lp=l(),ei=s("p"),qp=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
not make use of token type ids, therefore a list of zeros is returned.`),Xl=l(),Ot=s("h2"),wo=s("a"),si=s("span"),v(vn.$$.fragment),Sp=l(),ri=s("span"),Op=o("XLMRobertaModel"),Il=l(),Ie=s("div"),v(Tn.$$.fragment),Wp=l(),ai=s("p"),Bp=o("The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Qp=l(),wn=s("p"),Hp=o("This model inherits from "),Xr=s("a"),Up=o("PreTrainedModel"),Vp=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Gp=l(),yn=s("p"),Kp=o("This model is also a PyTorch "),Mn=s("a"),Jp=o("torch.nn.Module"),Zp=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Yp=l(),$n=s("p"),eh=o("This class overrides "),Ir=s("a"),th=o("RobertaModel"),oh=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),nh=l(),Ue=s("div"),v(Fn.$$.fragment),sh=l(),Wt=s("p"),rh=o("The "),Nr=s("a"),ah=o("RobertaModel"),ih=o(" forward method, overrides the "),ii=s("code"),lh=o("__call__"),dh=o(" special method."),ch=l(),v(yo.$$.fragment),ph=l(),li=s("p"),hh=o("Example:"),uh=l(),v(Rn.$$.fragment),Nl=l(),Bt=s("h2"),Mo=s("a"),di=s("span"),v(En.$$.fragment),fh=l(),ci=s("span"),mh=o("XLMRobertaForCausalLM"),Dl=l(),Ne=s("div"),v(zn.$$.fragment),gh=l(),Ln=s("p"),_h=o("XLM-RoBERTa Model with a "),pi=s("code"),bh=o("language modeling"),kh=o(" head on top for CLM fine-tuning."),vh=l(),qn=s("p"),Th=o("This model inherits from "),Dr=s("a"),wh=o("PreTrainedModel"),yh=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Mh=l(),Cn=s("p"),$h=o("This model is also a PyTorch "),xn=s("a"),Fh=o("torch.nn.Module"),Rh=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Eh=l(),Pn=s("p"),zh=o("This class overrides "),Sr=s("a"),Lh=o("RobertaForCausalLM"),qh=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Ch=l(),Ve=s("div"),v(An.$$.fragment),xh=l(),Qt=s("p"),Ph=o("The "),Or=s("a"),Ah=o("RobertaForCausalLM"),jh=o(" forward method, overrides the "),hi=s("code"),Xh=o("__call__"),Ih=o(" special method."),Nh=l(),v($o.$$.fragment),Dh=l(),ui=s("p"),Sh=o("Example:"),Oh=l(),v(jn.$$.fragment),Sl=l(),Ht=s("h2"),Fo=s("a"),fi=s("span"),v(Xn.$$.fragment),Wh=l(),mi=s("span"),Bh=o("XLMRobertaForMaskedLM"),Ol=l(),De=s("div"),v(In.$$.fragment),Qh=l(),Nn=s("p"),Hh=o("XLM-RoBERTa Model with a "),gi=s("code"),Uh=o("language modeling"),Vh=o(" head on top."),Gh=l(),Dn=s("p"),Kh=o("This model inherits from "),Wr=s("a"),Jh=o("PreTrainedModel"),Zh=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Yh=l(),Sn=s("p"),eu=o("This model is also a PyTorch "),On=s("a"),tu=o("torch.nn.Module"),ou=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),nu=l(),Wn=s("p"),su=o("This class overrides "),Br=s("a"),ru=o("RobertaForMaskedLM"),au=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),iu=l(),Ge=s("div"),v(Bn.$$.fragment),lu=l(),Ut=s("p"),du=o("The "),Qr=s("a"),cu=o("RobertaForMaskedLM"),pu=o(" forward method, overrides the "),_i=s("code"),hu=o("__call__"),uu=o(" special method."),fu=l(),v(Ro.$$.fragment),mu=l(),bi=s("p"),gu=o("Example:"),_u=l(),v(Qn.$$.fragment),Wl=l(),Vt=s("h2"),Eo=s("a"),ki=s("span"),v(Hn.$$.fragment),bu=l(),vi=s("span"),ku=o("XLMRobertaForSequenceClassification"),Bl=l(),Se=s("div"),v(Un.$$.fragment),vu=l(),Ti=s("p"),Tu=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wu=l(),Vn=s("p"),yu=o("This model inherits from "),Hr=s("a"),Mu=o("PreTrainedModel"),$u=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Fu=l(),Gn=s("p"),Ru=o("This model is also a PyTorch "),Kn=s("a"),Eu=o("torch.nn.Module"),zu=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Lu=l(),Jn=s("p"),qu=o("This class overrides "),Ur=s("a"),Cu=o("RobertaForSequenceClassification"),xu=o(`. Please check the superclass for the
...
a softmax) e.g. for RocStories/SWAG tasks.`),Zu=l(),ns=s("p"),Yu=o("This model inherits from "),Gr=s("a"),ef=o("PreTrainedModel"),tf=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),of=l(),ss=s("p"),nf=o("This model is also a PyTorch "),rs=s("a"),sf=o("torch.nn.Module"),rf=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),af=l(),as=s("p"),lf=o("This class overrides "),Kr=s("a"),df=o("RobertaForMultipleChoice"),cf=o(`. Please check the superclass for the
...
for Named-Entity-Recognition (NER) tasks.`),Ff=l(),ps=s("p"),Rf=o("This model inherits from "),Zr=s("a"),Ef=o("PreTrainedModel"),zf=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Lf=l(),hs=s("p"),qf=o("This model is also a PyTorch "),us=s("a"),Cf=o("torch.nn.Module"),xf=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Pf=l(),fs=s("p"),Af=o("This class overrides "),Yr=s("a"),jf=o("RobertaForTokenClassification"),Xf=o(`. Please check the superclass for the
...
linear layers on top of the hidden-states output to compute `),Xi=s("code"),Yf=o("span start logits"),em=o(" and "),Ii=s("code"),tm=o("span end logits"),om=o(")."),nm=l(),ks=s("p"),sm=o("This model inherits from "),ta=s("a"),rm=o("PreTrainedModel"),am=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),im=l(),vs=s("p"),lm=o("This model is also a PyTorch "),Ts=s("a"),dm=o("torch.nn.Module"),cm=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),pm=l(),ws=s("p"),hm=o("This class overrides "),oa=s("a"),um=o("RobertaForQuestionAnswering"),fm=o(`. Please check the superclass for the
appropriate documentation alongside usage examples.`),mm=l(),Ze=s("div"),v(ys.$$.fragment),gm=l(),oo=s("p"),_m=o("The "),na=s("a"),bm=o("RobertaForQuestionAnswering"),km=o(" forward method, overrides the "),Ni=s("code"),vm=o("__call__"),Tm=o(" special method."),wm=l(),v(Ao.$$.fragment),ym=l(),Di=s("p"),Mm=o("Example:"),$m=l(),v(Ms.$$.fragment),Jl=l(),no=s("h2"),jo=s("a"),Si=s("span"),v($s.$$.fragment),Fm=l(),Oi=s("span"),Rm=o("TFXLMRobertaModel"),Zl=l(),ze=s("div"),v(Fs.$$.fragment),Em=l(),Wi=s("p"),zm=o("The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Lm=l(),Rs=s("p"),qm=o("This model inherits from "),sa=s("a"),Cm=o("TFPreTrainedModel"),xm=o(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Pm=l(),Es=s("p"),Am=o("This model is also a "),zs=s("a"),jm=o("tf.keras.Model"),Xm=o(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Im=l(),v(Xo.$$.fragment),Nm=l(),Ls=s("p"),Dm=o("This class overrides "),ra=s("a"),Sm=o("TFRobertaModel"),Om=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Wm=l(),Ye=s("div"),v(qs.$$.fragment),Bm=l(),so=s("p"),Qm=o("The "),aa=s("a"),Hm=o("TFRobertaModel"),Um=o(" forward method, overrides the "),Bi=s("code"),Vm=o("__call__"),Gm=o(" special method."),Km=l(),v(Io.$$.fragment),Jm=l(),Qi=s("p"),Zm=o("Example:"),Ym=l(),v(Cs.$$.fragment),Yl=l(),ro=s("h2"),No=s("a"),Hi=s("span"),v(xs.$$.fragment),eg=l(),Ui=s("span"),tg=o("TFXLMRobertaForMaskedLM"),ed=l(),Le=s("div"),v(Ps.$$.fragment),og=l(),As=s("p"),ng=o("XLM-RoBERTa Model with a "),Vi=s("code"),sg=o("language modeling"),rg=o(" head on top."),ag=l(),js=s("p"),ig=o("This model inherits from "),ia=s("a"),lg=o("TFPreTrainedModel"),dg=o(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),cg=l(),Xs=s("p"),pg=o("This model is also a "),Is=s("a"),hg=o("tf.keras.Model"),ug=o(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),fg=l(),v(Do.$$.fragment),mg=l(),Ns=s("p"),gg=o("This class overrides "),la=s("a"),_g=o("TFRobertaForMaskedLM"),bg=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),kg=l(),et=s("div"),v(Ds.$$.fragment),vg=l(),ao=s("p"),Tg=o("The "),da=s("a"),wg=o("TFRobertaForMaskedLM"),yg=o(" forward method, overrides the "),Gi=s("code"),Mg=o("__call__"),$g=o(" special method."),Fg=l(),v(So.$$.fragment),Rg=l(),Ki=s("p"),Eg=o("Example:"),zg=l(),v(Ss.$$.fragment),td=l(),io=s("h2"),Oo=s("a"),Ji=s("span"),v(Os.$$.fragment),Lg=l(),Zi=s("span"),qg=o("TFXLMRobertaForSequenceClassification"),od=l(),qe=s("div"),v(Ws.$$.fragment),Cg=l(),Yi=s("p"),xg=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Pg=l(),Bs=s("p"),Ag=o("This model inherits from "),ca=s("a"),jg=o("TFPreTrainedModel"),Xg=o(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Ig=l(),Qs=s("p"),Ng=o("This model is also a "),Hs=s("a"),Dg=o("tf.keras.Model"),Sg=o(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Og=l(),v(Wo.$$.fragment),Wg=l(),Us=s("p"),Bg=o("This class overrides "),pa=s("a"),Qg=o("TFRobertaForSequenceClassification"),Hg=o(`. Please check the superclass for the
...
softmax) e.g. for RocStories/SWAG tasks.`),l_=l(),Zs=s("p"),d_=o("This model inherits from "),ua=s("a"),c_=o("TFPreTrainedModel"),p_=o(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),h_=l(),Ys=s("p"),u_=o("This model is also a "),er=s("a"),f_=o("tf.keras.Model"),m_=o(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),g_=l(),v(Ho.$$.fragment),__=l(),tr=s("p"),b_=o("This class overrides "),fa=s("a"),k_=o("TFRobertaForMultipleChoice"),v_=o(`. Please check the superclass for the
...
for Named-Entity-Recognition (NER) tasks.`),j_=l(),ar=s("p"),X_=o("This model inherits from "),ga=s("a"),I_=o("TFPreTrainedModel"),N_=o(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),D_=l(),ir=s("p"),S_=o("This model is also a "),lr=s("a"),O_=o("tf.keras.Model"),W_=o(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),B_=l(),v(Go.$$.fragment),Q_=l(),dr=s("p"),H_=o("This class overrides "),_a=s("a"),U_=o("TFRobertaForTokenClassification"),V_=o(`. Please check the superclass for the
...
layers on top of the hidden-states output to compute `),fl=s("code"),cb=o("span start logits"),pb=o(" and "),ml=s("code"),hb=o("span end logits"),ub=o(")."),fb=l(),fr=s("p"),mb=o("This model inherits from "),ka=s("a"),gb=o("TFPreTrainedModel"),_b=o(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),bb=l(),mr=s("p"),kb=o("This model is also a "),gr=s("a"),vb=o("tf.keras.Model"),Tb=o(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),wb=l(),v(Zo.$$.fragment),yb=l(),_r=s("p"),Mb=o("This class overrides "),gl=s("code"),$b=o("TFRobertaForQuestionAnsweringSimple"),Fb=o(`. Please check the superclass for
the appropriate documentation alongside usage examples.`),Rb=l(),st=s("div"),v(br.$$.fragment),Eb=l(),go=s("p"),zb=o("The "),va=s("a"),Lb=o("TFRobertaForQuestionAnswering"),qb=o(" forward method, overrides the "),_l=s("code"),Cb=o("__call__"),xb=o(" special method."),Pb=l(),v(Yo.$$.fragment),Ab=l(),bl=s("p"),jb=o("Example:"),Xb=l(),v(kr.$$.fragment),this.h()},l(a){const f=VT('[data-svelte="svelte-1phssyn"]',document.head);h=r(f,"META",{name:!0,content:!0}),f.forEach(t),F=d(a),m=r(a,"H1",{class:!0});var vr=i(m);_=r(vr,"A",{id:!0,class:!0,href:!0});var kl=i(_);k=r(kl,"SPAN",{});var vl=i(k);T(b.$$.fragment,vl),vl.forEach(t),kl.forEach(t),g=d(vr),E=r(vr,"SPAN",{});var Tl=i(E);pe=n(Tl,"XLM-RoBERTa"),Tl.forEach(t),vr.forEach(t),V=d(a),z=r(a,"H2",{class:!0});var Tr=i(z);Z=r(Tr,"A",{id:!0,class:!0,href:!0});var wl=i(Z);D=r(wl,"SPAN",{});var yl=i(D);T(ee.$$.fragment,yl),yl.forEach(t),wl.forEach(t),he=d(Tr),S=r(Tr,"SPAN",{});var Ml=i(S);ue=n(Ml,"Overview"),Ml.forEach(t),Tr.forEach(t),ie=d(a),U=r(a,"P",{});var wr=i(U);P=n(wr,"The XLM-RoBERTa model was proposed in "),te=r(wr,"A",{href:!0,rel:!0});var $l=i(te);K=n($l,"Unsupervised Cross-lingual Representation Learning at Scale"),$l.forEach(t),L=n(wr,` by Alexis Conneau, Kartikay Khandelwal, Naman Goyal, Vishrav Chaudhary, Guillaume
Wenzek, Francisco Guzm\xE1n, Edouard Grave, Myle Ott, Luke Zettlemoyer and Veselin Stoyanov. It is based on Facebook\u2019s
RoBERTa model released in 2019. It is a large multi-lingual language model, trained on 2.5TB of filtered CommonCrawl
...
languages at scale. Finally, we show, for the first time, the possibility of multilingual modeling without sacrificing
per-language performance; XLM-Ris very competitive with strong monolingual models on the GLUE and XNLI benchmarks. We
will make XLM-R code, data, and models publicly available.`),El.forEach(t),Rl.forEach(t),de=d(a),q=r(a,"P",{});var zl=i(q);me=n(zl,"Tips:"),zl.forEach(t),W=d(a),Y=r(a,"UL",{});var yr=i(Y);oe=r(yr,"LI",{});var Mr=i(oe);Q=n(Mr,`XLM-RoBERTa is a multilingual model trained on 100 different languages. Unlike some XLM multilingual models, it does
not require `),ae=r(Mr,"CODE",{});var Ll=i(ae);ge=n(Ll,"lang"),Ll.forEach(t),A=n(Mr,` tensors to understand which language is used, and should be able to determine the correct
language from the input ids.`),Mr.forEach(t),_e=d(yr),I=r(yr,"LI",{});var $r=i(I);be=n($r,"This implementation is the same as RoBERTa. Refer to the "),p=r($r,"A",{href:!0});var ql=i(p);R=n(ql,"documentation of RoBERTa"),ql.forEach(t),J=n($r,` for usage examples
...
documentation alongside usage examples.`),hd.forEach(t),pd.forEach(t),xl=d(a),Nt=r(a,"H2",{class:!0});var ud=i(Nt);_o=r(ud,"A",{id:!0,class:!0,href:!0});var Vb=i(_o);Sa=r(Vb,"SPAN",{});var Gb=i(Sa);T(nn.$$.fragment,Gb),Gb.forEach(t),Vb.forEach(t),zc=d(ud),Oa=r(ud,"SPAN",{});var Kb=i(Oa);Lc=n(Kb,"XLMRobertaTokenizer"),Kb.forEach(t),ud.forEach(t),Pl=d(a),Ee=r(a,"DIV",{class:!0});var Qe=i(Ee);T(sn.$$.fragment,Qe),qc=d(Qe),Tt=r(Qe,"P",{});var en=i(Tt);Cc=n(en,"Adapted from "),Rr=r(en,"A",{href:!0});var Jb=i(Rr);xc=n(Jb,"RobertaTokenizer"),Jb.forEach(t),Pc=n(en," and "),Er=r(en,"A",{href:!0});var Zb=i(Er);Ac=n(Zb,"XLNetTokenizer"),Zb.forEach(t),jc=n(en,`. Based on
`),rn=r(en,"A",{href:!0,rel:!0});var Yb=i(rn);Xc=n(Yb,"SentencePiece"),Yb.forEach(t),Ic=n(en,"."),en.forEach(t),Nc=d(Qe),an=r(Qe,"P",{});var fd=i(an);Dc=n(fd,"This tokenizer inherits from "),zr=r(fd,"A",{href:!0});var ek=i(zr);Sc=n(ek,"PreTrainedTokenizer"),ek.forEach(t),Oc=n(fd,` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),fd.forEach(t),Wc=d(Qe),Dt=r(Qe,"P",{});var wa=i(Dt);Bc=n(wa,`Attributes:
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),cc.forEach(t),Og=d(lt),T(Wo.$$.fragment,lt),Wg=d(lt),Us=r(lt,"P",{});var pc=i(Us);Bg=n(pc,"This class overrides "),pa=r(pc,"A",{href:!0});var cT=i(pa);Qg=n(cT,"TFRobertaForSequenceClassification"),cT.forEach(t),Hg=n(pc,`. Please check the superclass for the
...
softmax) e.g. for RocStories/SWAG tasks.`),_T.forEach(t),l_=d(dt),Zs=r(dt,"P",{});var uc=i(Zs);d_=n(uc,"This model inherits from "),ua=r(uc,"A",{href:!0});var bT=i(ua);c_=n(bT,"TFPreTrainedModel"),bT.forEach(t),p_=n(uc,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),uc.forEach(t),h_=d(dt),Ys=r(dt,"P",{});var fc=i(Ys);u_=n(fc,"This model is also a "),er=r(fc,"A",{href:!0,rel:!0});var kT=i(er);f_=n(kT,"tf.keras.Model"),kT.forEach(t),m_=n(fc,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),fc.forEach(t),g_=d(dt),T(Ho.$$.fragment,dt),__=d(dt),tr=r(dt,"P",{});var mc=i(tr);b_=n(mc,"This class overrides "),fa=r(mc,"A",{href:!0});var vT=i(fa);k_=n(vT,"TFRobertaForMultipleChoice"),vT.forEach(t),v_=n(mc,`. Please check the superclass for the
...
for Named-Entity-Recognition (NER) tasks.`),RT.forEach(t),j_=d(ct),ar=r(ct,"P",{});var _c=i(ar);X_=n(_c,"This model inherits from "),ga=r(_c,"A",{href:!0});var ET=i(ga);I_=n(ET,"TFPreTrainedModel"),ET.forEach(t),N_=n(_c,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),_c.forEach(t),D_=d(ct),ir=r(ct,"P",{});var bc=i(ir);S_=n(bc,"This model is also a "),lr=r(bc,"A",{href:!0,rel:!0});var zT=i(lr);O_=n(zT,"tf.keras.Model"),zT.forEach(t),W_=n(bc,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),bc.forEach(t),B_=d(ct),T(Go.$$.fragment,ct),Q_=d(ct),dr=r(ct,"P",{});var kc=i(dr);H_=n(kc,"This class overrides "),_a=r(kc,"A",{href:!0});var LT=i(_a);U_=n(LT,"TFRobertaForTokenClassification"),LT.forEach(t),V_=n(kc,`. Please check the superclass for the
...
layers on top of the hidden-states output to compute `),fl=r(Ia,"CODE",{});var XT=i(fl);cb=n(XT,"span start logits"),XT.forEach(t),pb=n(Ia," and "),ml=r(Ia,"CODE",{});var IT=i(ml);hb=n(IT,"span end logits"),IT.forEach(t),ub=n(Ia,")."),Ia.forEach(t),fb=d(pt),fr=r(pt,"P",{});var Tc=i(fr);mb=n(Tc,"This model inherits from "),ka=r(Tc,"A",{href:!0});var NT=i(ka);gb=n(NT,"TFPreTrainedModel"),NT.forEach(t),_b=n(Tc,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Tc.forEach(t),bb=d(pt),mr=r(pt,"P",{});var wc=i(mr);kb=n(wc,"This model is also a "),gr=r(wc,"A",{href:!0,rel:!0});var DT=i(gr);vb=n(DT,"tf.keras.Model"),DT.forEach(t),Tb=n(wc,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),wc.forEach(t),wb=d(pt),T(Zo.$$.fragment,pt),yb=d(pt),_r=r(pt,"P",{});var yc=i(_r);Mb=n(yc,"This class overrides "),gl=r(yc,"CODE",{});var ST=i(gl);$b=n(ST,"TFRobertaForQuestionAnsweringSimple"),ST.forEach(t),Fb=n(yc,`. Please check the superclass for
