...
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var u=n(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var F=n(f);T=i(F,"Module"),F.forEach(t),B=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(g,u){p(g,h,u),e(h,$),e(h,f),e(f,T),e(h,B)},d(g){g&&t(h)}}}function Np(E){let h,$,f,T,B;return{c(){h=a("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var u=n(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var F=n(f);T=i(F,"Module"),F.forEach(t),B=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ml=d(),N=a("div"),_(Yt.$$.fragment),pl=d(),Fe=a("p"),fl=r("The "),da=a("a"),ul=r("BeitForMaskedImageModeling"),gl=r(" forward method, overrides the "),Ya=a("code"),_l=r("__call__"),vl=r(" special method."),bl=d(),_(He.$$.fragment),xl=d(),Za=a("p"),wl=r("Examples:"),yl=d(),_(Zt.$$.fragment),un=d(),Ee=a("h2"),Je=a("a"),Qa=a("span"),_(Qt.$$.fragment),Tl=d(),es=a("span"),$l=r("BeitForImageClassification"),gn=d(),X=a("div"),_(eo.$$.fragment),Bl=d(),ts=a("p"),Fl=r(`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Kl=d(),q=a("div"),_(co.$$.fragment),Yl=d(),Me=a("p"),Zl=r("The "),ha=a("a"),Ql=r("BeitForSemanticSegmentation"),ed=r(" forward method, overrides the "),is=a("code"),td=r("__call__"),od=r(" special method."),ad=d(),_(Ke.$$.fragment),sd=d(),ls=a("p"),nd=r("Examples:"),rd=d(),_(ho.$$.fragment),bn=d(),je=a("h2"),Ye=a("a"),ds=a("span"),_(mo.$$.fragment),id=d(),cs=a("span"),ld=r("FlaxBeitModel"),xn=d(),I=a("div"),_(po.$$.fragment),dd=d(),hs=a("p"),cd=r("The bare Beit Model transformer outputting raw hidden-states without any specific head on top."),hd=d(),fo=a("p"),md=r("This model inherits from "),ma=a("a"),pd=r("FlaxPreTrainedModel"),fd=r(`. Check the superclass documentation for the
...
and refer to the Flax documentation for all matter related to general usage and behavior.`),Zd=d(),Ts=a("p"),Qd=r("Finally, this model supports inherent JAX features such as:"),ec=d(),se=a("ul"),$s=a("li"),ko=a("a"),tc=r("Just-In-Time (JIT) compilation"),oc=d(),Bs=a("li"),Io=a("a"),ac=r("Automatic Differentiation"),sc=d(),Fs=a("li"),Mo=a("a"),nc=r("Vectorization"),rc=d(),Es=a("li"),jo=a("a"),ic=r("Parallelization"),lc=d(),z=a("div"),_(Po.$$.fragment),dc=d(),ze=a("p"),cc=r("The "),ks=a("code"),hc=r("FlaxBeitPreTrainedModel"),mc=r(" forward method, overrides the "),Is=a("code"),pc=r("__call__"),fc=r(" special method."),uc=d(),_(et.$$.fragment),gc=d(),Ae=a("p"),_c=r("bool_masked_pos ("),Ms=a("code"),vc=r("numpy.ndarray"),bc=r(" of shape "),js=a("code"),xc=r("(batch_size, num_patches)"),wc=r(`):
Boolean masked positions. Indicates which patches are masked (1) and which aren\u2019t (0).`),yc=d(),Ps=a("p"),Tc=r("Examples:"),$c=d(),_(Co.$$.fragment),Tn=d(),Le=a("h2"),tt=a("a"),Cs=a("span"),_(zo.$$.fragment),Bc=d(),zs=a("span"),Fc=r("FlaxBeitForImageClassification"),$n=d(),j=a("div"),_(Ao.$$.fragment),Ec=d(),As=a("p"),kc=r(`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
...
and refer to the Flax documentation for all matter related to general usage and behavior.`),Nc=d(),Ls=a("p"),Sc=r("Finally, this model supports inherent JAX features such as:"),qc=d(),ne=a("ul"),Ns=a("li"),qo=a("a"),Oc=r("Just-In-Time (JIT) compilation"),Dc=d(),Ss=a("li"),Oo=a("a"),Wc=r("Automatic Differentiation"),Vc=d(),qs=a("li"),Do=a("a"),Uc=r("Vectorization"),Rc=d(),Os=a("li"),Wo=a("a"),Hc=r("Parallelization"),Jc=d(),D=a("div"),_(Vo.$$.fragment),Xc=d(),Ne=a("p"),Gc=r("The "),Ds=a("code"),Kc=r("FlaxBeitPreTrainedModel"),Yc=r(" forward method, overrides the "),Ws=a("code"),Zc=r("__call__"),Qc=r(" special method."),eh=d(),_(ot.$$.fragment),th=d(),Vs=a("p"),oh=r("Example:"),ah=d(),_(Uo.$$.fragment),this.h()},l(o){const m=Ip('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(t),$=c(o),f=s(o,"H1",{class:!0});var Ro=n(f);T=s(Ro,"A",{id:!0,class:!0,href:!0});var Us=n(T);B=s(Us,"SPAN",{});var Rs=n(B);v(g.$$.fragment,Rs),Rs.forEach(t),Us.forEach(t),u=c(Ro),F=s(Ro,"SPAN",{});var Hs=n(F);Qn=i(Hs,"BEiT"),Hs.forEach(t),Ro.forEach(t),Ks=c(o),fe=s(o,"H2",{class:!0});var Ho=n(fe);Se=s(Ho,"A",{id:!0,class:!0,href:!0});var Js=n(Se);Ia=s(Js,"SPAN",{});var Xs=n(Ia);v(ft.$$.fragment,Xs),Xs.forEach(t),Js.forEach(t),er=c(Ho),Ma=s(Ho,"SPAN",{});var Gs=n(Ma);tr=i(Gs,"Overview"),Gs.forEach(t),Ho.forEach(t),Ys=c(o),K=s(o,"P",{});var at=n(K);or=i(at,"The BEiT model was proposed in "),ut=s(at,"A",{href:!0,rel:!0});var sh=n(ut);ar=i(sh,"BEiT: BERT Pre-Training of Image Transformers"),sh.forEach(t),sr=i(at,` by
Hangbo Bao, Li Dong and Furu Wei. Inspired by BERT, BEiT is the first paper that makes self-supervised pre-training of
Vision Transformers (ViTs) outperform supervised pre-training. Rather than pre-training the model to predict the class
