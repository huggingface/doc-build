...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}]}}),Ot=new M({props:{name:"from\\_question\\_encoder\\_generator\\_configs",anchor:"transformers.RagConfig.from_question_encoder_generator_configs",parameters:[{name:"question_encoder_config",val:": PretrainedConfig"},{name:"generator_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/rag/configuration_rag.py#L172",returnDescription:`
...
weighted average in the cross-attention heads.`,name:"generator_cross_attentions"}]}}),Xt=new M({props:{name:"class transformers.models.rag.modeling\\_rag.RetrievAugLMOutput",anchor:"transformers.models.rag.modeling_rag.RetrievAugLMOutput",parameters:[{name:"logits",val:": FloatTensor = None"},{name:"doc_scores",val:": FloatTensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"retrieved_doc_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"retrieved_doc_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"question_encoder_last_hidden_state",val:": typing.Optional[torch.FloatTensor] = None"},{name:"question_enc_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"question_enc_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_enc_last_hidden_state",val:": typing.Optional[torch.FloatTensor] = None"},{name:"generator_enc_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_enc_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_dec_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_dec_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_cross_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/rag/modeling_rag.py#L131",parametersDescription:[{anchor:"transformers.models.rag.modeling_rag.RetrievAugLMOutput.logits",description:`<strong>logits</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, config.vocab_size)</code>) &#x2014;
Prediction scores of the language modeling head. The score is possibly marginalized over all documents for
...
`),un=r("a"),Ei=t("to_dict()"),Gi=t("."),Ua=c(),Ge=r("h2"),dt=r("a"),Mr=r("span"),v(Qt.$$.fragment),Mi=c(),Ar=r("span"),Ai=t("RagTokenizer"),Ka=c(),Vt=r("div"),it=r("div"),v(Ut.$$.fragment),ji=c(),jr=r("p"),Pi=t(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Ya=c(),Me=r("h2"),ct=r("a"),Pr=r("span"),v(Kt.$$.fragment),Ni=c(),Nr=r("span"),Ci=t("Rag specific outputs"),Ja=c(),Ae=r("div"),v(Yt.$$.fragment),Si=c(),Cr=r("p"),Di=t("Base class for retriever augmented marginalized models outputs."),Xa=c(),Jt=r("div"),v(Xt.$$.fragment),Za=c(),je=r("h2"),lt=r("a"),Sr=r("span"),v(Zt.$$.fragment),Li=c(),Dr=r("span"),Ii=t("RagRetriever"),ed=c(),X=r("div"),v(eo.$$.fragment),Oi=c(),Lr=r("p"),Wi=t(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
generator can be any `),Jr=r("em"),xc=t("seq2seq"),Rc=t(" model, preferably "),_n=r("a"),Fc=t("BartForConditionalGeneration"),zc=t("."),$c=c(),A=r("p"),Ec=t("The model can be initialized with a "),fn=r("a"),Gc=t("RagRetriever"),Mc=t(` for end-to-end generation or used in
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),gh=c(),te=r("div"),v(bo.$$.fragment),_h=c(),Ie=r("p"),fh=t("The "),Gn=r("a"),vh=t("RagSequenceForGeneration"),bh=t(" forward method, overrides the "),bs=r("code"),Th=t("__call__"),wh=t(" special method."),kh=c(),v(bt.$$.fragment),qh=c(),Ts=r("p"),yh=t("Example:"),xh=c(),v(To.$$.fragment),Rh=c(),Tt=r("div"),v(wo.$$.fragment),Fh=c(),ko=r("p"),zh=t(`Implements RAG sequence \u201Cthorough\u201D decoding. Read the
`),Mn=r("a"),$h=t("generate()"),Eh=t("` documentation for more information on how to\nset other generate input parameters."),sd=c(),Oe=r("h2"),wt=r("a"),ws=r("span"),v(qo.$$.fragment),Gh=c(),ks=r("span"),Mh=t("RagTokenForGeneration"),ad=c(),G=r("div"),v(yo.$$.fragment),Ah=c(),We=r("p"),jh=t("The "),An=r("a"),Ph=t("RagTokenForGeneration"),Nh=t(" forward method, overrides the "),qs=r("code"),Ch=t("__call__"),Sh=t(" special method."),Dh=c(),v(kt.$$.fragment),Lh=c(),ys=r("p"),Ih=t("A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Oh=c(),xs=r("p"),Wh=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
the `),Gs=r("code"),lp=t("generator"),hp=t(". It has been tested with "),Cn=r("a"),pp=t("DPRQuestionEncoder"),up=t(" as the "),Ms=r("code"),mp=t("question_encoder"),gp=t(`
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Ep=c(),oe=r("div"),v(zo.$$.fragment),Gp=c(),He=r("p"),Mp=t("The "),In=r("a"),Ap=t("RagTokenForGeneration"),jp=t(" forward method, overrides the "),js=r("code"),Pp=t("__call__"),Np=t(" special method."),Cp=c(),v(qt.$$.fragment),Sp=c(),Ps=r("p"),Dp=t("Example:"),Lp=c(),v($o.$$.fragment),Ip=c(),yt=r("div"),v(Eo.$$.fragment),Op=c(),Ns=r("p"),Wp=t("Implements RAG token decoding."),dd=c(),Be=r("h2"),xt=r("a"),Cs=r("span"),v(Go.$$.fragment),Hp=c(),Ss=r("span"),Bp=t("TFRagModel"),id=c(),N=r("div"),v(Mo.$$.fragment),Qp=c(),Qe=r("p"),Vp=t("The "),On=r("a"),Up=t("TFRagModel"),Kp=t(" forward method, overrides the "),Ds=r("code"),Yp=t("__call__"),Jp=t(" special method."),Xp=c(),v(Rt.$$.fragment),Zp=c(),Ls=r("p"),eu=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
and `),Vn=r("a"),Fu=t("TFBartForConditionalGeneration"),zu=t(" as the "),Us=r("code"),$u=t("generator"),Eu=t("."),Gu=c(),Ao=r("p"),Mu=t("This model inherits from "),Un=r("a"),Au=t("TFPreTrainedModel"),ju=t(`. Check the superclass documentation for the
...
the `),ia=r("code"),Gm=t("generator"),Mm=t(". It has been tested with "),er=r("a"),Am=t("TFDPRQuestionEncoder"),jm=t(" as the "),ca=r("code"),Pm=t("question_encoder"),Nm=t(`
...
SavedModel format.`),Jm=c(),re=r("div"),v(Wo.$$.fragment),Xm=c(),Ye=r("p"),Zm=t("The "),nr=r("a"),eg=t("TFRagSequenceForGeneration"),tg=t(" forward method, overrides the "),pa=r("code"),og=t("__call__"),ng=t(" special method."),rg=c(),v(Et.$$.fragment),sg=c(),ua=r("p"),ag=t("Example:"),dg=c(),v(Ho.$$.fragment),ig=c(),Gt=r("div"),v(Bo.$$.fragment),cg=c(),Qo=r("p"),lg=t(`Implements RAG sequence \u201Cthorough\u201D decoding. Read the
...
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Rg=c(),ue=r("p"),Fg=t("The question encoder can be any "),ba=r("em"),zg=t("autoencoding"),$g=t(" model, preferably "),ar=r("a"),Eg=t("TFDPRQuestionEncoder"),Gg=t(`, and
the generator can be any `),Ta=r("em"),Mg=t("seq2seq"),Ag=t(" model, preferably "),dr=r("a"),jg=t("TFBartForConditionalGeneration"),Pg=t("."),Ng=c(),O=r("p"),Cg=t("The model can be initialized with a "),ir=r("a"),Sg=t("RagRetriever"),Dg=t(` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
...
the `),Gs=s(V,"CODE",{});var fv=a(Gs);lp=o(fv,"generator"),fv.forEach(n),hp=o(V,". It has been tested with "),Cn=s(V,"A",{href:!0});var vv=a(Cn);pp=o(vv,"DPRQuestionEncoder"),vv.forEach(n),up=o(V," as the "),Ms=s(V,"CODE",{});var bv=a(Ms);mp=o(bv,"question_encoder"),bv.forEach(n),gp=o(V,`
...
the `),ia=s(Y,"CODE",{});var gb=a(ia);Gm=o(gb,"generator"),gb.forEach(n),Mm=o(Y,". It has been tested with "),er=s(Y,"A",{href:!0});var _b=a(er);Am=o(_b,"TFDPRQuestionEncoder"),_b.forEach(n),jm=o(Y," as the "),ca=s(Y,"CODE",{});var fb=a(ca);Pm=o(fb,"question_encoder"),fb.forEach(n),Nm=o(Y,`
...
`),rr=s(Ud,"A",{href:!0});var Rb=a(rr);hg=o(Rb,"generate()"),Rb.forEach(n),pg=o(Ud,"` documentation for more information on how to\nset other generate input parameters"),Ud.forEach(n),Vd.forEach(n),C.forEach(n),hd=l(d),Je=s(d,"H2",{class:!0});var Kd=a(Je);Mt=s(Kd,"A",{id:!0,class:!0,href:!0});var Fb=a(Mt);ma=s(Fb,"SPAN",{});var zb=a(ma);b(Vo.$$.fragment,zb),zb.forEach(n),Fb.forEach(n),ug=l(Kd),ga=s(Kd,"SPAN",{});var $b=a(ga);mg=o($b,"TFRagTokenForGeneration"),$b.forEach(n),Kd.forEach(n),pd=l(d),z=s(d,"DIV",{class:!0});var S=a(z);b(Uo.$$.fragment,S),gg=l(S),Xe=s(S,"P",{});var yr=a(Xe);_g=o(yr,"The "),sr=s(yr,"A",{href:!0});var Eb=a(sr);fg=o(Eb,"TFRagTokenForGeneration"),Eb.forEach(n),vg=o(yr," forward method, overrides the "),_a=s(yr,"CODE",{});var Gb=a(_a);bg=o(Gb,"__call__"),Gb.forEach(n),Tg=o(yr," special method."),yr.forEach(n),wg=l(S),b(At.$$.fragment,S),kg=l(S),fa=s(S,"P",{});var Mb=a(fa);qg=o(Mb,"A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Mb.forEach(n),yg=l(S),va=s(S,"P",{});var Ab=a(va);xg=o(Ab,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Ab.forEach(n),Rg=l(S),ue=s(S,"P",{});var Fe=a(ue);Fg=o(Fe,"The question encoder can be any "),ba=s(Fe,"EM",{});var jb=a(ba);zg=o(jb,"autoencoding"),jb.forEach(n),$g=o(Fe," model, preferably "),ar=s(Fe,"A",{href:!0});var Pb=a(ar);Eg=o(Pb,"TFDPRQuestionEncoder"),Pb.forEach(n),Gg=o(Fe,`, and
the generator can be any `),Ta=s(Fe,"EM",{});var Nb=a(Ta);Mg=o(Nb,"seq2seq"),Nb.forEach(n),Ag=o(Fe," model, preferably "),dr=s(Fe,"A",{href:!0});var Cb=a(dr);jg=o(Cb,"TFBartForConditionalGeneration"),Cb.forEach(n),Pg=o(Fe,"."),Fe.forEach(n),Ng=l(S),O=s(S,"P",{});var J=a(O);Cg=o(J,"The model can be initialized with a "),ir=s(J,"A",{href:!0});var Sb=a(ir);Sg=o(Sb,"RagRetriever"),Sb.forEach(n),Dg=o(J,` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
