...
the tensors in the first argument of the model call function: `),O=r("code"),ue=n("model(inputs)"),le=n("."),V=l(),j=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),G=l(),x=r("ul"),C=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),L=r("code"),fe=n("model(inputs_ids)"),ce=l(),P=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
the tensors in the first argument of the model call function: `),O=a(S,"CODE",{});var ve=i(O);ue=s(ve,"model(inputs)"),ve.forEach(t),le=s(S,"."),S.forEach(t),V=d(c),j=a(c,"P",{});var Te=i(j);te=s(Te,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),Te.forEach(t),G=d(c),x=a(c,"UL",{});var q=i(x);C=a(q,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),H=a(I,"CODE",{});var Fe=i(H);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),L=a(I,"CODE",{});var Me=i(L);fe=s(Me,"model(inputs_ids)"),Me.forEach(t),I.forEach(t),ce=d(q),P=a(q,"LI",{});var U=i(P);ge=s(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(U,"CODE",{});var ye=i(W);X=s(ye,"model([input_ids, attention_mask])"),ye.forEach(t),re=s(U," or "),Q=a(U,"CODE",{});var Y=i(Q);_e=s(Y,"model([input_ids, attention_mask, token_type_ids])"),Y.forEach(t),U.forEach(t),ae=d(q),N=a(q,"LI",{});var oe=i(N);pe=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
linear layers on top of the hidden-states output to compute `),pl=r("code"),jf=n("span start logits"),Nf=n(" and "),hl=r("code"),Sf=n("span end logits"),Af=n(")."),If=l(),Rs=r("p"),Df=n("This model inherits from "),za=r("a"),Of=n("PreTrainedModel"),Lf=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
`),wl=r("code"),qg=n("next sentence prediction (classification)"),jg=n(" head."),Ng=l(),nr=r("p"),Sg=n("This model inherits from "),qa=r("a"),Ag=n("TFPreTrainedModel"),Ig=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Dg=l(),sr=r("p"),Og=n("This model is also a "),rr=r("a"),Lg=n("tf.keras.Model"),Wg=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Rg=l(),w(an.$$.fragment),Hg=l(),ot=r("div"),w(ar.$$.fragment),Qg=l(),To=r("p"),Ug=n("The "),ja=r("a"),Vg=n("TFMobileBertForPreTraining"),Kg=n(" forward method, overrides the "),yl=r("code"),Gg=n("__call__"),Jg=n(" special method."),Yg=l(),w(ln.$$.fragment),Zg=l(),$l=r("p"),Xg=n("Examples:"),e_=l(),w(ir.$$.fragment),Jd=l(),ko=r("h2"),dn=r("a"),Fl=r("span"),w(lr.$$.fragment),t_=l(),Bl=r("span"),o_=n("TFMobileBertForMaskedLM"),Yd=l(),Ne=r("div"),w(dr.$$.fragment),n_=l(),cr=r("p"),s_=n("MobileBert Model with a "),El=r("code"),r_=n("language modeling"),a_=n(" head on top."),i_=l(),pr=r("p"),l_=n("This model inherits from "),Na=r("a"),d_=n("TFPreTrainedModel"),c_=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),p_=l(),hr=r("p"),h_=n("This model is also a "),mr=r("a"),m_=n("tf.keras.Model"),u_=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),f_=l(),w(cn.$$.fragment),g_=l(),nt=r("div"),w(ur.$$.fragment),__=l(),Mo=r("p"),b_=n("The "),Sa=r("a"),v_=n("TFMobileBertForMaskedLM"),T_=n(" forward method, overrides the "),zl=r("code"),k_=n("__call__"),M_=n(" special method."),w_=l(),w(pn.$$.fragment),y_=l(),xl=r("p"),$_=n("Example:"),F_=l(),w(fr.$$.fragment),Zd=l(),wo=r("h2"),hn=r("a"),Pl=r("span"),w(gr.$$.fragment),B_=l(),Cl=r("span"),E_=n("TFMobileBertForNextSentencePrediction"),Xd=l(),Se=r("div"),w(_r.$$.fragment),z_=l(),br=r("p"),x_=n("MobileBert Model with a "),ql=r("code"),P_=n("next sentence prediction (classification)"),C_=n(" head on top."),q_=l(),vr=r("p"),j_=n("This model inherits from "),Aa=r("a"),N_=n("TFPreTrainedModel"),S_=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
...
for Named-Entity-Recognition (NER) tasks.`),Yb=l(),Or=r("p"),Zb=n("This model inherits from "),Ra=r("a"),Xb=n("TFPreTrainedModel"),ev=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),tv=l(),Lr=r("p"),ov=n("This model is also a "),Wr=r("a"),nv=n("tf.keras.Model"),sv=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),rv=l(),w(Mn.$$.fragment),av=l(),it=r("div"),w(Rr.$$.fragment),iv=l(),xo=r("p"),lv=n("The "),Ha=r("a"),dv=n("TFMobileBertForTokenClassification"),cv=n(" forward method, overrides the "),Gl=r("code"),pv=n("__call__"),hv=n(" special method."),mv=l(),w(wn.$$.fragment),uv=l(),Jl=r("p"),fv=n("Example:"),gv=l(),w(Hr.$$.fragment),ac=l(),Po=r("h2"),yn=r("a"),Yl=r("span"),w(Qr.$$.fragment),_v=l(),Zl=r("span"),bv=n("TFMobileBertForQuestionAnswering"),ic=l(),Oe=r("div"),w(Ur.$$.fragment),vv=l(),Co=r("p"),Tv=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Xl=r("code"),kv=n("span start logits"),Mv=n(" and "),ed=r("code"),wv=n("span end logits"),yv=n(")."),$v=l(),Vr=r("p"),Fv=n("This model inherits from "),Qa=r("a"),Bv=n("TFPreTrainedModel"),Ev=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),zv=l(),Kr=r("p"),xv=n("This model is also a "),Gr=r("a"),Pv=n("tf.keras.Model"),Cv=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),qv=l(),w($n.$$.fragment),jv=l(),lt=r("div"),w(Jr.$$.fragment),Nv=l(),qo=r("p"),Sv=n("The "),Ua=r("a"),Av=n("TFMobileBertForQuestionAnswering"),Iv=n(" forward method, overrides the "),td=r("code"),Dv=n("__call__"),Ov=n(" special method."),Lv=l(),w(Fn.$$.fragment),Wv=l(),od=r("p"),Rv=n("Example:"),Hv=l(),w(Yr.$$.fragment),this.h()},l(o){const u=lM('[data-svelte="svelte-1phssyn"]',document.head);h=a(u,"META",{name:!0,content:!0}),u.forEach(t),k=d(o),f=a(o,"H1",{class:!0});var Zr=i(f);g=a(Zr,"A",{id:!0,class:!0,href:!0});var nd=i(g);v=a(nd,"SPAN",{});var sd=i(v);y(b.$$.fragment,sd),sd.forEach(t),nd.forEach(t),_=d(Zr),M=a(Zr,"SPAN",{});var rd=i(M);he=s(rd,"MobileBERT"),rd.forEach(t),Zr.forEach(t),K=d(o),z=a(o,"H2",{class:!0});var Xr=i(z);Z=a(Xr,"A",{id:!0,class:!0,href:!0});var ad=i(Z);D=a(ad,"SPAN",{});var id=i(D);y(ee.$$.fragment,id),id.forEach(t),ad.forEach(t),me=d(Xr),O=a(Xr,"SPAN",{});var ld=i(O);ue=s(ld,"Overview"),ld.forEach(t),Xr.forEach(t),le=d(o),V=a(o,"P",{});var ea=i(V);j=s(ea,"The MobileBERT model was proposed in "),te=a(ea,"A",{href:!0,rel:!0});var dd=i(te);G=s(dd,"MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),dd.forEach(t),x=s(ea,` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
Zhou. It\u2019s a bidirectional transformer based on the BERT model, which is compressed and accelerated using several
approaches.`),ea.forEach(t),C=d(o),ne=a(o,"P",{});var cd=i(ne);H=s(cd,"The abstract from the paper is the following:"),cd.forEach(t),de=d(o),se=a(o,"P",{});var pd=i(se);L=a(pd,"EM",{});var hd=i(L);fe=s(hd,`Natural Language Processing (NLP) has recently achieved great success by using huge pre-trained models with hundreds
of millions of parameters. However, these models suffer from heavy model sizes and high latency such that they cannot
be deployed to resource-limited mobile devices. In this paper, we propose MobileBERT for compressing and accelerating
the popular BERT model. Like the original BERT, MobileBERT is task-agnostic, that is, it can be generically applied to
various downstream NLP tasks via simple fine-tuning. Basically, MobileBERT is a thin version of BERT_LARGE, while
...
natural language inference tasks of GLUE, MobileBERT achieves a GLUEscore o 77.7 (0.6 lower than BERT_BASE), and 62 ms
latency on a Pixel 4 phone. On the SQuAD v1.1/v2.0 question answering task, MobileBERT achieves a dev F1 score of
90.0/79.2 (1.5/2.1 higher than BERT_BASE).`),hd.forEach(t),pd.forEach(t),ce=d(o),P=a(o,"P",{});var md=i(P);ge=s(md,"Tips:"),md.forEach(t),W=d(o),X=a(o,"UL",{});var ta=i(X);re=a(ta,"LI",{});var ud=i(re);Q=s(ud,`MobileBERT is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather
...
pooled output) e.g. for GLUE tasks.`),sk.forEach(t),fu=d(zt),ks=a(zt,"P",{});var jc=i(ks);gu=s(jc,"This model inherits from "),wa=a(jc,"A",{href:!0});var rk=i(wa);_u=s(rk,"PreTrainedModel"),rk.forEach(t),bu=s(jc,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
