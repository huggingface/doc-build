...
configuration with the defaults will yield a similar configuration to that of the GPTNeo `),He=n("a"),gs=r("gpt-neo-1.3B"),_s=r(" architecture."),vs=d(),re=n("p"),Ts=r("Configuration objects inherit from "),Dt=n("a"),ys=r("PretrainedConfig"),Ps=r(` and can be used to control the model
...
embeddings).`),ea=d(),tt=n("p"),ta=r("This model inherits from "),Ht=n("a"),oa=r("PreTrainedModel"),na=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),sa=d(),ot=n("p"),aa=r("This model is also a PyTorch "),nt=n("a"),ra=r("torch.nn.Module"),ia=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),la=d(),j=n("div"),_(st.$$.fragment),da=d(),ce=n("p"),ca=r("The "),Ut=n("a"),pa=r("GPTNeoForCausalLM"),ha=r(" forward method, overrides the "),bo=n("code"),ua=r("__call__"),fa=r(" special method."),ma=d(),_(xe.$$.fragment),ga=d(),wo=n("p"),_a=r("Example:"),va=d(),_(at.$$.fragment),Pn=d(),pe=n("h2"),$e=n("a"),No=n("span"),_(rt.$$.fragment),Ta=d(),xo=n("span"),ya=r("GPTNeoForSequenceClassification"),kn=d(),$=n("div"),_(it.$$.fragment),Pa=d(),$o=n("p"),ka=r("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),ba=d(),Vt=n("p"),Jt=n("a"),wa=r("GPTNeoForSequenceClassification"),Na=r(` uses the last token in order to do the classification, as
other causal models (e.g. GPT-1) do.`),xa=d(),W=n("p"),$a=r(`Since it does classification on the last token, it requires to know the position of the last token. If a
`),Go=n("code"),Ga=r("pad_token_id"),Ma=r(` is defined in the configuration, it finds the last token that is not a padding token in each
row. If no `),Mo=n("code"),Fa=r("pad_token_id"),Ea=r(` is defined, it simply takes the last value in each row of the batch. Since it cannot
guess the padding tokens when `),Fo=n("code"),za=r("inputs_embeds"),Ca=r(" are passed instead of "),Eo=n("code"),qa=r("input_ids"),ja=r(`, it does the same (take
the last value in each row of the batch).`),Aa=d(),lt=n("p"),Ia=r("This model inherits from "),Rt=n("a"),La=r("PreTrainedModel"),Sa=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Da=d(),dt=n("p"),Ba=r("This model is also a PyTorch "),ct=n("a"),Oa=r("torch.nn.Module"),Wa=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Ha=d(),F=n("div"),_(pt.$$.fragment),Ua=d(),he=n("p"),Va=r("The "),Xt=n("a"),Ja=r("GPTNeoForSequenceClassification"),Ra=r(" forward method, overrides the "),zo=n("code"),Xa=r("__call__"),Ka=r(" special method."),Qa=d(),_(Ge.$$.fragment),Ya=d(),Co=n("p"),Za=r("Example of single-label classification:"),er=d(),_(ht.$$.fragment),tr=d(),qo=n("p"),or=r("Example of multi-label classification:"),nr=d(),_(ut.$$.fragment),bn=d(),ue=n("h2"),Me=n("a"),jo=n("span"),_(ft.$$.fragment),sr=d(),Ao=n("span"),ar=r("FlaxGPTNeoModel"),wn=d(),G=n("div"),_(mt.$$.fragment),rr=d(),Io=n("p"),ir=r("The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),lr=d(),gt=n("p"),dr=r("This model inherits from "),Kt=n("a"),cr=r("FlaxPreTrainedModel"),pr=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),hr=d(),_t=n("p"),ur=r("This model is also a Flax Linen "),vt=n("a"),fr=r("flax.nn.Module"),mr=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),gr=d(),Lo=n("p"),_r=r("Finally, this model supports inherent JAX features such as:"),vr=d(),H=n("ul"),So=n("li"),Tt=n("a"),Tr=r("Just-In-Time (JIT) compilation"),yr=d(),Do=n("li"),yt=n("a"),Pr=r("Automatic Differentiation"),kr=d(),Bo=n("li"),Pt=n("a"),br=r("Vectorization"),wr=d(),Oo=n("li"),kt=n("a"),Nr=r("Parallelization"),xr=d(),A=n("div"),_(bt.$$.fragment),$r=d(),fe=n("p"),Gr=r("The "),Wo=n("code"),Mr=r("FlaxGPTNeoPreTrainedModel"),Fr=r(" forward method, overrides the "),Ho=n("code"),Er=r("__call__"),zr=r(" special method."),Cr=d(),_(Fe.$$.fragment),qr=d(),Uo=n("p"),jr=r("Example:"),Ar=d(),_(wt.$$.fragment),Nn=d(),me=n("h2"),Ee=n("a"),Vo=n("span"),_(Nt.$$.fragment),Ir=d(),Jo=n("span"),Lr=r("FlaxGPTNeoForCausalLM"),xn=d(),M=n("div"),_(xt.$$.fragment),Sr=d(),Ro=n("p"),Dr=r(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Br=d(),$t=n("p"),Or=r("This model inherits from "),Qt=n("a"),Wr=r("FlaxPreTrainedModel"),Hr=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Ur=d(),Gt=n("p"),Vr=r("This model is also a Flax Linen "),Mt=n("a"),Jr=r("flax.nn.Module"),Rr=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Xr=d(),Xo=n("p"),Kr=r("Finally, this model supports inherent JAX features such as:"),Qr=d(),U=n("ul"),Ko=n("li"),Ft=n("a"),Yr=r("Just-In-Time (JIT) compilation"),Zr=d(),Qo=n("li"),Et=n("a"),ei=r("Automatic Differentiation"),ti=d(),Yo=n("li"),zt=n("a"),oi=r("Vectorization"),ni=d(),Zo=n("li"),Ct=n("a"),si=r("Parallelization"),ai=d(),I=n("div"),_(qt.$$.fragment),ri=d(),ge=n("p"),ii=r("The "),en=n("code"),li=r("FlaxGPTNeoPreTrainedModel"),di=r(" forward method, overrides the "),tn=n("code"),ci=r("__call__"),pi=r(" special method."),hi=d(),_(ze.$$.fragment),ui=d(),on=n("p"),fi=r("Example:"),mi=d(),_(jt.$$.fragment),this.h()},l(t){const h=ed('[data-svelte="svelte-1phssyn"]',document.head);p=s(h,"META",{name:!0,content:!0}),h.forEach(o),w=c(t),f=s(t,"H1",{class:!0});var At=a(f);b=s(At,"A",{id:!0,class:!0,href:!0});var nn=a(b);N=s(nn,"SPAN",{});var sn=a(N);v(g.$$.fragment,sn),sn.forEach(o),nn.forEach(o),m=c(At),x=s(At,"SPAN",{});var an=a(x);Jn=i(an,"GPT Neo"),an.forEach(o),At.forEach(o),ln=c(t),oe=s(t,"H2",{class:!0});var It=a(oe);ve=s(It,"A",{id:!0,class:!0,href:!0});var _i=a(ve);ro=s(_i,"SPAN",{});var vi=a(ro);v(Ae.$$.fragment,vi),vi.forEach(o),_i.forEach(o),Rn=c(It),io=s(It,"SPAN",{});var Ti=a(io);Xn=i(Ti,"Overview"),Ti.forEach(o),It.forEach(o),dn=c(t),J=s(t,"P",{});var Yt=a(J);Kn=i(Yt,"The GPTNeo model was released in the "),Ie=s(Yt,"A",{href:!0,rel:!0});var yi=a(Ie);Qn=i(yi,"EleutherAI/gpt-neo"),yi.forEach(o),Yn=i(Yt,` repository by Sid
Black, Stella Biderman, Leo Gao, Phil Wang and Connor Leahy. It is a GPT2 like causal language model trained on the
