...
`),m=a("code"),k=n("from_pretrained"),z=n(` and Speech2TextTokenizer\u2019s
`),b=a("code"),y=n("from_pretrained"),E=n(`. Please refer to the
...
`),m=r($,"CODE",{});var M=i(m);k=s(M,"from_pretrained"),M.forEach(o),z=s($,` and Speech2TextTokenizer\u2019s
`),b=r($,"CODE",{});var L=i(b);y=s(L,"from_pretrained"),L.forEach(o),E=s($,`. Please refer to the
docstrings of the methods above for more information.`),$.forEach(o)},m(C,$){h(C,f,$),e(f,w),e(f,m),e(m,k),e(f,z),e(f,b),e(b,y),e(f,E)},d(C){C&&o(f)}}}function ul(Y){let f,w,m,k,z,b,y,E;return{c(){f=a("p"),w=n("This class method is simply calling "),m=a("code"),k=n("save_pretrained"),z=n(` and
`),b=a("code"),y=n("save_pretrained"),E=n(`. Please refer to the
docstrings of the methods above for more information.`)},l(C){f=r(C,"P",{});var $=i(f);w=s($,"This class method is simply calling "),m=r($,"CODE",{});var M=i(m);k=s(M,"save_pretrained"),M.forEach(o),z=s($,` and
`),b=r($,"CODE",{});var L=i(b);y=s(L,"save_pretrained"),L.forEach(o),E=s($,`. Please refer to the
docstrings of the methods above for more information.`),$.forEach(o)},m(C,$){h(C,f,$),e(f,w),e(f,m),e(m,k),e(f,z),e(f,b),e(b,y),e(f,E)},d(C){C&&o(f)}}}function _l(Y){let f,w,m,k,z;return{c(){f=a("p"),w=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),k=n("Module"),z=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){f=r(b,"P",{});var y=i(f);w=s(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(y,"CODE",{});var E=i(m);k=s(E,"Module"),E.forEach(o),z=s(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(b,y){h(b,f,y),e(f,w),e(f,m),e(m,k),e(f,z)},d(b){b&&o(f)}}}function gl(Y){let f,w,m,k,z;return{c(){f=a("p"),w=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),k=n("Module"),z=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){f=r(b,"P",{});var y=i(f);w=s(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(y,"CODE",{});var E=i(m);k=s(E,"Module"),E.forEach(o),z=s(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(b,y){h(b,f,y),e(f,w),e(f,m),e(m,k),e(f,z)},d(b){b&&o(f)}}}function vl(Y){let f,w,m,k,z,b,y,E,C,$,M,L,qo,Ue,Es,Po,qs,qn,O,Ps,Be,js,Fs,Re,Cs,Ms,He,As,Ds,Je,Is,Ns,Pn,Q,Ls,Ye,Os,Gs,Xe,Ws,Vs,jn,ce,be,jo,Ke,Us,Fo,Bs,Fn,ke,Rs,Co,Hs,Js,Cn,G,Ys,Ht,Xs,Ks,Jt,Qs,Zs,Yt,ea,ta,Xt,oa,na,Mn,q,sa,Mo,aa,ra,Ao,ia,ca,Do,da,la,Io,pa,ha,No,fa,ma,Qe,ua,_a,Lo,ga,An,Kt,Oo,va,Dn,Ze,In,Qt,et,Go,Ta,xa,A,ba,Wo,ka,ya,Vo,Sa,wa,Uo,$a,za,Bo,Ea,qa,Ro,Pa,ja,Nn,tt,Ln,ye,Fa,ot,Ca,Ma,On,de,Se,Ho,nt,Aa,Jo,Da,Gn,D,st,Ia,le,Na,Zt,La,Oa,at,Ga,Wa,Va,pe,Ua,eo,Ba,Ra,to,Ha,Ja,Ya,Yo,Xa,Ka,rt,Wn,he,we,Xo,it,Qa,Ko,Za,Vn,P,ct,er,Qo,tr,or,dt,nr,oo,sr,ar,rr,$e,lt,ir,Zo,cr,dr,ze,pt,lr,ht,pr,en,hr,fr,mr,Z,ft,ur,no,_r,so,gr,vr,tn,Tr,xr,on,Un,fe,Ee,nn,mt,br,sn,kr,Bn,I,ut,yr,an,Sr,wr,_t,$r,ao,zr,Er,qr,rn,Pr,jr,qe,gt,Fr,cn,Cr,Rn,me,Pe,dn,vt,Mr,ln,Ar,Hn,S,Tt,Dr,pn,Ir,Nr,W,ro,Lr,Or,io,Gr,Wr,co,Vr,Ur,xt,hn,Br,Rr,Hr,lo,Jr,Yr,Xr,je,bt,Kr,X,Qr,kt,fn,Zr,ei,ti,po,oi,ni,yt,mn,si,ai,ri,ii,ee,St,ci,wt,di,ho,li,pi,hi,Fe,fi,te,$t,mi,ue,ui,un,_i,gi,fo,vi,Ti,xi,Ce,bi,Me,zt,ki,Et,yi,mo,Si,wi,$i,Ae,qt,zi,Pt,Ei,uo,qi,Pi,ji,De,jt,Fi,_n,Ci,Jn,_e,Ie,gn,Ft,Mi,vn,Ai,Yn,R,Ct,Di,Mt,Ii,_o,Ni,Li,Oi,At,Gi,Dt,Wi,Vi,Ui,V,It,Bi,ge,Ri,go,Hi,Ji,Tn,Yi,Xi,Ki,Ne,Qi,xn,Zi,ec,Nt,Xn,ve,Le,bn,Lt,tc,kn,oc,Kn,H,Ot,nc,Gt,sc,vo,ac,rc,ic,Wt,cc,Vt,dc,lc,pc,U,Ut,hc,Te,fc,To,mc,uc,yn,_c,gc,vc,Oe,Tc,Sn,xc,bc,Bt,Qn;return b=new xe({}),Ue=new xe({}),Ke=new xe({}),Ze=new En({props:{code:`import torch
...
`),fo=r($o,"A",{href:!0});var Ud=i(fo);vi=s(Ud,"from_pretrained()"),Ud.forEach(o),Ti=s($o," class method."),$o.forEach(o),xi=l(wo),_(Ce.$$.fragment,wo),wo.forEach(o),bi=l(j),Me=r(j,"DIV",{class:!0});var _s=i(Me);_(zt.$$.fragment,_s),ki=l(_s),Et=r(_s,"P",{});var gs=i(Et);yi=s(gs,`This method forwards all its arguments to Speech2TextTokenizer\u2019s
...
`),uo=r(Ts,"A",{href:!0});var Rd=i(uo);qi=s(Rd,"decode()"),Rd.forEach(o),Pi=s(Ts,`. Please refer to the docstring of this method for more
information.`),Ts.forEach(o),vs.forEach(o),ji=l(j),De=r(j,"DIV",{class:!0});var xs=i(De);_(jt.$$.fragment,xs),Fi=l(xs),_n=r(xs,"P",{});var Hd=i(_n);Ci=s(Hd,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
...
This model inherits from `),_o=r(ks,"A",{href:!0});var Kd=i(_o);Ni=s(Kd,"PreTrainedModel"),Kd.forEach(o),Li=s(ks,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),ks.forEach(o),Oi=l(We),At=r(We,"P",{});var ys=i(At);Gi=s(ys,"This model is also a PyTorch "),Dt=r(ys,"A",{href:!0,rel:!0});var Qd=i(Dt);Wi=s(Qd,"torch.nn.Module"),Qd.forEach(o),Vi=s(ys,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
