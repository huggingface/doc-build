...
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function a1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function r1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function i1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function l1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function d1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),U=a("code"),re=n("model([input_ids, attention_mask])"),te=n(" or "),N=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),O=a("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var $=i(p);F=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),g=d(m),u=r(m,"UL",{});var J=i(u);x=r(J,"LI",{});var Le=i(x);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=r(J,"LI",{});var xe=i(M);de=s(xe,"having all inputs as a list, tuple or dict in the first positional arguments."),xe.forEach(t),J.forEach(t),X=d(m),E=r(m,"P",{});var j=i(E);ne=s(j,"This second option is useful when using "),Q=r(j,"CODE",{});var $e=i(Q);ce=s($e,"tf.keras.Model.fit"),$e.forEach(t),Z=s(j,` method which currently requires having all
the tensors in the first argument of the model call function: `),H=r(j,"CODE",{});var Fe=i(H);he=s(Fe,"model(inputs)"),Fe.forEach(t),ae=s(j,"."),j.forEach(t),R=d(m),P=r(m,"P",{});var be=i(P);se=s(be,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
...
trained and should be used as follows:`),Cd=l(),v(Mn.$$.fragment),Pd=l(),It=a("h2"),Do=a("a"),ri=a("span"),v(En.$$.fragment),wm=l(),ii=a("span"),vm=n("LongformerConfig"),Od=l(),je=a("div"),v(zn.$$.fragment),km=l(),Nt=a("p"),bm=n("This is the configuration class to store the configuration of a "),Ba=a("a"),Tm=n("LongformerModel"),ym=n(` or a
...
superclass for usage examples and documentation concerning parameters.`),Id=l(),Wt=a("h2"),Qo=a("a"),mi=a("span"),v(jn.$$.fragment),Jm=l(),fi=a("span"),Xm=n("LongformerTokenizerFast"),Nd=l(),pt=a("div"),v(An.$$.fragment),Ym=l(),In=a("p"),Zm=n("Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),pi=a("em"),ef=n("tokenizers"),tf=n(" library)."),of=l(),Ho=a("p"),Ga=a("a"),nf=n("LongformerTokenizerFast"),sf=n(" is identical to "),Ka=a("a"),af=n("RobertaTokenizerFast"),rf=n(`. Refer
...
attention to extend to long documents without the O(n^2) increase in memory and compute.`),op=l(),as=a("p"),np=n("The self-attention module "),Oi=a("code"),sp=n("LongformerSelfAttention"),ap=n(` implemented here supports the combination of local and
...
custom CUDA kernel to be memory and compute efficient.`),rp=l(),Ge=a("div"),v(rs.$$.fragment),ip=l(),ro=a("p"),lp=n("The "),Ya=a("a"),dp=n("LongformerModel"),cp=n(" forward method, overrides the "),ji=a("code"),hp=n("__call__"),mp=n(" special method."),fp=l(),v(Vo.$$.fragment),pp=l(),Ai=a("p"),gp=n("Examples:"),up=l(),v(is.$$.fragment),oc=l(),io=a("h2"),Go=a("a"),Ii=a("span"),v(ls.$$.fragment),_p=l(),Ni=a("span"),wp=n("LongformerForMaskedLM"),nc=l(),We=a("div"),v(ds.$$.fragment),vp=l(),cs=a("p"),kp=n("Longformer Model with a "),Si=a("code"),bp=n("language modeling"),Tp=n(" head on top."),yp=l(),hs=a("p"),Lp=n("This model inherits from "),Za=a("a"),xp=n("PreTrainedModel"),$p=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Fp=l(),ms=a("p"),Mp=n("This model is also a PyTorch "),fs=a("a"),Ep=n("torch.nn.Module"),zp=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),qp=l(),Ke=a("div"),v(ps.$$.fragment),Cp=l(),lo=a("p"),Pp=n("The "),er=a("a"),Op=n("LongformerForMaskedLM"),jp=n(" forward method, overrides the "),Di=a("code"),Ap=n("__call__"),Ip=n(" special method."),Np=l(),v(Ko.$$.fragment),Sp=l(),Bi=a("p"),Dp=n("Examples:"),Bp=l(),v(gs.$$.fragment),sc=l(),co=a("h2"),Jo=a("a"),Wi=a("span"),v(us.$$.fragment),Wp=l(),Qi=a("span"),Qp=n("LongformerForSequenceClassification"),ac=l(),Qe=a("div"),v(_s.$$.fragment),Hp=l(),Hi=a("p"),Rp=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),$g=l(),Je=a("div"),v(Es.$$.fragment),Fg=l(),fo=a("p"),Mg=n("The "),sr=a("a"),Eg=n("LongformerForMultipleChoice"),zg=n(" forward method, overrides the "),Xi=a("code"),qg=n("__call__"),Cg=n(" special method."),Pg=l(),v(Zo.$$.fragment),Og=l(),Yi=a("p"),jg=n("Example:"),Ag=l(),v(zs.$$.fragment),lc=l(),po=a("h2"),en=a("a"),Zi=a("span"),v(qs.$$.fragment),Ig=l(),el=a("span"),Ng=n("LongformerForTokenClassification"),dc=l(),Re=a("div"),v(Cs.$$.fragment),Sg=l(),tl=a("p"),Dg=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Rg=l(),Os=a("p"),Ug=n("This model is also a PyTorch "),js=a("a"),Vg=n("torch.nn.Module"),Gg=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
TriviaQA (a linear layers on top of the hidden-states output to compute `),rl=a("code"),cu=n("span start logits"),hu=n(" and "),il=a("code"),mu=n("span end logits"),fu=n(")."),pu=l(),Ds=a("p"),gu=n("This model inherits from "),ir=a("a"),uu=n("PreTrainedModel"),_u=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),wu=l(),Bs=a("p"),vu=n("This model is also a PyTorch "),Ws=a("a"),ku=n("torch.nn.Module"),bu=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Tu=l(),Ye=a("div"),v(Qs.$$.fragment),yu=l(),wo=a("p"),Lu=n("The "),lr=a("a"),xu=n("LongformerForQuestionAnswering"),$u=n(" forward method, overrides the "),ll=a("code"),Fu=n("__call__"),Mu=n(" special method."),Eu=l(),v(nn.$$.fragment),zu=l(),dl=a("p"),qu=n("Examples:"),Cu=l(),v(Hs.$$.fragment),mc=l(),vo=a("h2"),sn=a("a"),cl=a("span"),v(Rs.$$.fragment),Pu=l(),hl=a("span"),Ou=n("TFLongformerModel"),fc=l(),Ee=a("div"),v(Us.$$.fragment),ju=l(),ml=a("p"),Au=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Iu=l(),Vs=a("p"),Nu=n("This model inherits from "),dr=a("a"),Su=n("TFPreTrainedModel"),Du=n(`. Check the superclass documentation for the
...
dilated attention are more relevant for autoregressive language modeling than finetuning on downstream tasks.
Future release will add support for autoregressive attention, but the support for dilated attention requires a
custom CUDA kernel to be memory and compute efficient.`),o_=l(),_t=a("div"),v(Ys.$$.fragment),n_=l(),bo=a("p"),s_=n("The "),hr=a("a"),a_=n("TFLongformerModel"),r_=n(" forward method, overrides the "),pl=a("code"),i_=n("__call__"),l_=n(" special method."),d_=l(),v(rn.$$.fragment),pc=l(),To=a("h2"),ln=a("a"),gl=a("span"),v(Zs.$$.fragment),c_=l(),ul=a("span"),h_=n("TFLongformerForMaskedLM"),gc=l(),Ae=a("div"),v(ea.$$.fragment),m_=l(),ta=a("p"),f_=n("Longformer Model with a "),_l=a("code"),p_=n("language modeling"),g_=n(" head on top."),u_=l(),oa=a("p"),__=n("This model inherits from "),mr=a("a"),w_=n("TFPreTrainedModel"),v_=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),k_=l(),na=a("p"),b_=n("This model is also a "),sa=a("a"),T_=n("tf.keras.Model"),y_=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),L_=l(),v(dn.$$.fragment),x_=l(),Ze=a("div"),v(aa.$$.fragment),$_=l(),yo=a("p"),F_=n("The "),fr=a("a"),M_=n("TFLongformerForMaskedLM"),E_=n(" forward method, overrides the "),wl=a("code"),z_=n("__call__"),q_=n(" special method."),C_=l(),v(cn.$$.fragment),P_=l(),vl=a("p"),O_=n("Example:"),j_=l(),v(ra.$$.fragment),uc=l(),Lo=a("h2"),hn=a("a"),kl=a("span"),v(ia.$$.fragment),A_=l(),bl=a("span"),I_=n("TFLongformerForQuestionAnswering"),_c=l(),Ie=a("div"),v(la.$$.fragment),N_=l(),xo=a("p"),S_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layer on top of the hidden-states output to compute `),Tl=a("code"),D_=n("span start logits"),B_=n(" and "),yl=a("code"),W_=n("span end logits"),Q_=n(")."),H_=l(),da=a("p"),R_=n("This model inherits from "),pr=a("a"),U_=n("TFPreTrainedModel"),V_=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Tw=l(),v(gn.$$.fragment),yw=l(),tt=a("div"),v(va.$$.fragment),Lw=l(),Mo=a("p"),xw=n("The "),_r=a("a"),$w=n("TFLongformerForSequenceClassification"),Fw=n(" forward method, overrides the "),El=a("code"),Mw=n("__call__"),Ew=n(" special method."),zw=l(),v(un.$$.fragment),qw=l(),zl=a("p"),Cw=n("Example:"),Pw=l(),v(ka.$$.fragment),kc=l(),Eo=a("h2"),_n=a("a"),ql=a("span"),v(ba.$$.fragment),Ow=l(),Cl=a("span"),jw=n("TFLongformerForTokenClassification"),bc=l(),Se=a("div"),v(Ta.$$.fragment),Aw=l(),Pl=a("p"),Iw=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
