...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function GM(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function XM(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function YM(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function ZM(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function ez(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function tz(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the tensors in the first argument of the model call function: `),O=n("code"),me=r("model(inputs)"),le=r("."),J=l(),I=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),X=l(),P=n("ul"),q=n("li"),ae=r("a single Tensor with "),R=n("code"),de=r("input_ids"),re=r(" only and nothing else: "),S=n("code"),ue=r("model(inputs_ids)"),ce=l(),C=n("li"),fe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function gz(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function _z(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function vz(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function kz(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function Tz(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,$),e(h,g),e(g,v),e(h,k)},d(_){_&&t(h)}}}function wz(j){let h,$,g,v,k;return{c(){h=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=a(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);v=i(x,"Module"),x.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),Ur=new W({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxElectraPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/electra/modeling_flax_electra.py#L563",parametersDescription:[{anchor:"transformers.FlaxElectraPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See
<a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),ni=new W({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxElectraPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/electra/modeling_flax_electra.py#L563",parametersDescription:[{anchor:"transformers.FlaxElectraPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See
<a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),fi=new W({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxElectraPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/electra/modeling_flax_electra.py#L563",parametersDescription:[{anchor:"transformers.FlaxElectraPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See
<a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),$i=new W({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxElectraPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/electra/modeling_flax_electra.py#L563",parametersDescription:[{anchor:"transformers.FlaxElectraPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See
<a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),Ji=new W({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxElectraPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/electra/modeling_flax_electra.py#L563",parametersDescription:[{anchor:"transformers.FlaxElectraPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See
<a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),al=new W({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxElectraPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/electra/modeling_flax_electra.py#L563",parametersDescription:[{anchor:"transformers.FlaxElectraPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.15.0/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See
<a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),I_=l(),st=n("div"),T(ha.$$.fragment),L_=l(),qo=n("p"),N_=r("The "),zl=n("a"),D_=r("ElectraForMaskedLM"),O_=r(" forward method, overrides the "),oc=n("code"),S_=r("__call__"),W_=r(" special method."),B_=l(),T(Pn.$$.fragment),R_=l(),nc=n("p"),H_=r("Example:"),Q_=l(),T(pa.$$.fragment),Tm=l(),jo=n("h2"),Cn=n("a"),sc=n("span"),T(ma.$$.fragment),U_=l(),ac=n("span"),V_=r("ElectraForSequenceClassification"),Em=l(),Ze=n("div"),T(ua.$$.fragment),J_=l(),rc=n("p"),K_=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),G_=l(),fa=n("p"),X_=r("This model inherits from "),Pl=n("a"),Y_=r("PreTrainedModel"),Z_=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),ev=l(),ga=n("p"),tv=r("This model is also a PyTorch "),_a=n("a"),ov=r("torch.nn.Module"),nv=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),sv=l(),We=n("div"),T(va.$$.fragment),av=l(),Ao=n("p"),rv=r("The "),Cl=n("a"),iv=r("ElectraForSequenceClassification"),lv=r(" forward method, overrides the "),ic=n("code"),dv=r("__call__"),cv=r(" special method."),hv=l(),T(qn.$$.fragment),pv=l(),lc=n("p"),mv=r("Example of single-label classification:"),uv=l(),T(ka.$$.fragment),fv=l(),dc=n("p"),gv=r("Example of multi-label classification:"),_v=l(),T(Ta.$$.fragment),wm=l(),Io=n("h2"),jn=n("a"),cc=n("span"),T(Ea.$$.fragment),vv=l(),hc=n("span"),kv=r("ElectraForMultipleChoice"),ym=l(),et=n("div"),T(wa.$$.fragment),Tv=l(),pc=n("p"),Ev=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),wv=l(),ya=n("p"),yv=r("This model inherits from "),ql=n("a"),bv=r("PreTrainedModel"),Fv=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),$v=l(),ba=n("p"),xv=r("This model is also a PyTorch "),Fa=n("a"),Mv=r("torch.nn.Module"),zv=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Pv=l(),at=n("div"),T($a.$$.fragment),Cv=l(),Lo=n("p"),qv=r("The "),jl=n("a"),jv=r("ElectraForMultipleChoice"),Av=r(" forward method, overrides the "),mc=n("code"),Iv=r("__call__"),Lv=r(" special method."),Nv=l(),T(An.$$.fragment),Dv=l(),uc=n("p"),Ov=r("Example:"),Sv=l(),T(xa.$$.fragment),bm=l(),No=n("h2"),In=n("a"),fc=n("span"),T(Ma.$$.fragment),Wv=l(),gc=n("span"),Bv=r("ElectraForTokenClassification"),Fm=l(),He=n("div"),T(za.$$.fragment),Rv=l(),_c=n("p"),Hv=r("Electra model with a token classification head on top."),Qv=l(),vc=n("p"),Uv=r("Both the discriminator and generator may be loaded into this model."),Vv=l(),Pa=n("p"),Jv=r("This model inherits from "),Al=n("a"),Kv=r("PreTrainedModel"),Gv=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Xv=l(),Ca=n("p"),Yv=r("This model is also a PyTorch "),qa=n("a"),Zv=r("torch.nn.Module"),ek=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),tk=l(),rt=n("div"),T(ja.$$.fragment),ok=l(),Do=n("p"),nk=r("The "),Il=n("a"),sk=r("ElectraForTokenClassification"),ak=r(" forward method, overrides the "),kc=n("code"),rk=r("__call__"),ik=r(" special method."),lk=l(),T(Ln.$$.fragment),dk=l(),Tc=n("p"),ck=r("Example:"),hk=l(),T(Aa.$$.fragment),$m=l(),Oo=n("h2"),Nn=n("a"),Ec=n("span"),T(Ia.$$.fragment),pk=l(),wc=n("span"),mk=r("ElectraForQuestionAnswering"),xm=l(),tt=n("div"),T(La.$$.fragment),uk=l(),So=n("p"),fk=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),yc=n("code"),gk=r("span start logits"),_k=r(" and "),bc=n("code"),vk=r("span end logits"),kk=r(")."),Tk=l(),Na=n("p"),Ek=r("This model inherits from "),Ll=n("a"),wk=r("PreTrainedModel"),yk=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),bk=l(),Da=n("p"),Fk=r("This model is also a PyTorch "),Oa=n("a"),$k=r("torch.nn.Module"),xk=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Mk=l(),it=n("div"),T(Sa.$$.fragment),zk=l(),Wo=n("p"),Pk=r("The "),Nl=n("a"),Ck=r("ElectraForQuestionAnswering"),qk=r(" forward method, overrides the "),Fc=n("code"),jk=r("__call__"),Ak=r(" special method."),Ik=l(),T(Dn.$$.fragment),Lk=l(),$c=n("p"),Nk=r("Example:"),Dk=l(),T(Wa.$$.fragment),Mm=l(),Bo=n("h2"),On=n("a"),xc=n("span"),T(Ba.$$.fragment),Ok=l(),Mc=n("span"),Sk=r("TFElectraModel"),zm=l(),Qe=n("div"),T(Ra.$$.fragment),Wk=l(),zc=n("p"),Bk=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),Rk=l(),Ha=n("p"),Hk=r("This model inherits from "),Dl=n("a"),Qk=r("TFPreTrainedModel"),Uk=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Vk=l(),Qa=n("p"),Jk=r("This model is also a "),Ua=n("a"),Kk=r("tf.keras.Model"),Gk=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Xk=l(),T(Sn.$$.fragment),Yk=l(),lt=n("div"),T(Va.$$.fragment),Zk=l(),Ro=n("p"),eT=r("The "),Ol=n("a"),tT=r("TFElectraModel"),oT=r(" forward method, overrides the "),Pc=n("code"),nT=r("__call__"),sT=r(" special method."),aT=l(),T(Wn.$$.fragment),rT=l(),Cc=n("p"),iT=r("Example:"),lT=l(),T(Ja.$$.fragment),Pm=l(),Ho=n("h2"),Bn=n("a"),qc=n("span"),T(Ka.$$.fragment),dT=l(),jc=n("span"),cT=r("TFElectraForPreTraining"),Cm=l(),je=n("div"),T(Ga.$$.fragment),hT=l(),Ac=n("p"),pT=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),mT=l(),Ic=n("p"),uT=r(`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
of the two to have the correct classification head to be used for this model.`),fT=l(),Xa=n("p"),gT=r("This model inherits from "),Sl=n("a"),_T=r("TFPreTrainedModel"),vT=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),kT=l(),Ya=n("p"),TT=r("This model is also a "),Za=n("a"),ET=r("tf.keras.Model"),wT=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),yT=l(),T(Rn.$$.fragment),bT=l(),dt=n("div"),T(er.$$.fragment),FT=l(),Qo=n("p"),$T=r("The "),Wl=n("a"),xT=r("TFElectraForPreTraining"),MT=r(" forward method, overrides the "),Lc=n("code"),zT=r("__call__"),PT=r(" special method."),CT=l(),T(Hn.$$.fragment),qT=l(),Nc=n("p"),jT=r("Examples:"),AT=l(),T(tr.$$.fragment),qm=l(),Uo=n("h2"),Qn=n("a"),Dc=n("span"),T(or.$$.fragment),IT=l(),Oc=n("span"),LT=r("TFElectraForMaskedLM"),jm=l(),Ae=n("div"),T(nr.$$.fragment),NT=l(),Sc=n("p"),DT=r("Electra model with a language modeling head on top."),OT=l(),Wc=n("p"),ST=r(`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),KT=l(),T(Un.$$.fragment),GT=l(),ct=n("div"),T(ir.$$.fragment),XT=l(),Vo=n("p"),YT=r("The "),Rl=n("a"),ZT=r("TFElectraForMaskedLM"),e1=r(" forward method, overrides the "),Bc=n("code"),t1=r("__call__"),o1=r(" special method."),n1=l(),T(Vn.$$.fragment),s1=l(),Rc=n("p"),a1=r("Example:"),r1=l(),T(lr.$$.fragment),Am=l(),Jo=n("h2"),Jn=n("a"),Hc=n("span"),T(dr.$$.fragment),i1=l(),Qc=n("span"),l1=r("TFElectraForSequenceClassification"),Im=l(),Ue=n("div"),T(cr.$$.fragment),d1=l(),Uc=n("p"),c1=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),h1=l(),hr=n("p"),p1=r("This model inherits from "),Hl=n("a"),m1=r("TFPreTrainedModel"),u1=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),f1=l(),pr=n("p"),g1=r("This model is also a "),mr=n("a"),_1=r("tf.keras.Model"),v1=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),k1=l(),T(Kn.$$.fragment),T1=l(),ht=n("div"),T(ur.$$.fragment),E1=l(),Ko=n("p"),w1=r("The "),Ql=n("a"),y1=r("TFElectraForSequenceClassification"),b1=r(" forward method, overrides the "),Vc=n("code"),F1=r("__call__"),$1=r(" special method."),x1=l(),T(Gn.$$.fragment),M1=l(),Jc=n("p"),z1=r("Example:"),P1=l(),T(fr.$$.fragment),Lm=l(),Go=n("h2"),Xn=n("a"),Kc=n("span"),T(gr.$$.fragment),C1=l(),Gc=n("span"),q1=r("TFElectraForMultipleChoice"),Nm=l(),Ve=n("div"),T(_r.$$.fragment),j1=l(),Xc=n("p"),A1=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),I1=l(),vr=n("p"),L1=r("This model inherits from "),Ul=n("a"),N1=r("TFPreTrainedModel"),D1=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),O1=l(),kr=n("p"),S1=r("This model is also a "),Tr=n("a"),W1=r("tf.keras.Model"),B1=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),R1=l(),T(Yn.$$.fragment),H1=l(),pt=n("div"),T(Er.$$.fragment),Q1=l(),Xo=n("p"),U1=r("The "),Vl=n("a"),V1=r("TFElectraForMultipleChoice"),J1=r(" forward method, overrides the "),Yc=n("code"),K1=r("__call__"),G1=r(" special method."),X1=l(),T(Zn.$$.fragment),Y1=l(),Zc=n("p"),Z1=r("Example:"),eE=l(),T(wr.$$.fragment),Dm=l(),Yo=n("h2"),es=n("a"),eh=n("span"),T(yr.$$.fragment),tE=l(),th=n("span"),oE=r("TFElectraForTokenClassification"),Om=l(),Ie=n("div"),T(br.$$.fragment),nE=l(),oh=n("p"),sE=r("Electra model with a token classification head on top."),aE=l(),nh=n("p"),rE=r("Both the discriminator and generator may be loaded into this model."),iE=l(),Fr=n("p"),lE=r("This model inherits from "),Jl=n("a"),dE=r("TFPreTrainedModel"),cE=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),hE=l(),$r=n("p"),pE=r("This model is also a "),xr=n("a"),mE=r("tf.keras.Model"),uE=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),fE=l(),T(ts.$$.fragment),gE=l(),mt=n("div"),T(Mr.$$.fragment),_E=l(),Zo=n("p"),vE=r("The "),Kl=n("a"),kE=r("TFElectraForTokenClassification"),TE=r(" forward method, overrides the "),sh=n("code"),EE=r("__call__"),wE=r(" special method."),yE=l(),T(os.$$.fragment),bE=l(),ah=n("p"),FE=r("Example:"),$E=l(),T(zr.$$.fragment),Sm=l(),en=n("h2"),ns=n("a"),rh=n("span"),T(Pr.$$.fragment),xE=l(),ih=n("span"),ME=r("TFElectraForQuestionAnswering"),Wm=l(),Je=n("div"),T(Cr.$$.fragment),zE=l(),tn=n("p"),PE=r(`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),lh=n("code"),CE=r("span start logits"),qE=r(" and "),dh=n("code"),jE=r("span end logits"),AE=r(")."),IE=l(),qr=n("p"),LE=r("This model inherits from "),Gl=n("a"),NE=r("TFPreTrainedModel"),DE=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),OE=l(),jr=n("p"),SE=r("This model is also a "),Ar=n("a"),WE=r("tf.keras.Model"),BE=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),RE=l(),T(ss.$$.fragment),HE=l(),ut=n("div"),T(Ir.$$.fragment),QE=l(),on=n("p"),UE=r("The "),Xl=n("a"),VE=r("TFElectraForQuestionAnswering"),JE=r(" forward method, overrides the "),ch=n("code"),KE=r("__call__"),GE=r(" special method."),XE=l(),T(as.$$.fragment),YE=l(),hh=n("p"),ZE=r("Example:"),ew=l(),T(Lr.$$.fragment),Bm=l(),nn=n("h2"),rs=n("a"),ph=n("span"),T(Nr.$$.fragment),tw=l(),mh=n("span"),ow=r("FlaxElectraModel"),Rm=l(),Le=n("div"),T(Dr.$$.fragment),nw=l(),uh=n("p"),sw=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),aw=l(),Or=n("p"),rw=r("This model inherits from "),Yl=n("a"),iw=r("FlaxPreTrainedModel"),lw=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
PyTorch models)`),dw=l(),Sr=n("p"),cw=r("This model is also a Flax Linen "),Wr=n("a"),hw=r("flax.nn.Module"),pw=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),mw=l(),fh=n("p"),uw=r("Finally, this model supports inherent JAX features such as:"),fw=l(),Bt=n("ul"),gh=n("li"),Br=n("a"),gw=r("Just-In-Time (JIT) compilation"),_w=l(),_h=n("li"),Rr=n("a"),vw=r("Automatic Differentiation"),kw=l(),vh=n("li"),Hr=n("a"),Tw=r("Vectorization"),Ew=l(),kh=n("li"),Qr=n("a"),ww=r("Parallelization"),yw=l(),ft=n("div"),T(Ur.$$.fragment),bw=l(),sn=n("p"),Fw=r("The "),Th=n("code"),$w=r("FlaxElectraPreTrainedModel"),xw=r(" forward method, overrides the "),Eh=n("code"),Mw=r("__call__"),zw=r(" special method."),Pw=l(),T(is.$$.fragment),Cw=l(),wh=n("p"),qw=r("Example:"),jw=l(),T(Vr.$$.fragment),Hm=l(),an=n("h2"),ls=n("a"),yh=n("span"),T(Jr.$$.fragment),Aw=l(),bh=n("span"),Iw=r("FlaxElectraForPreTraining"),Qm=l(),Ce=n("div"),T(Kr.$$.fragment),Lw=l(),Fh=n("p"),Nw=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),Dw=l(),$h=n("p"),Ow=r("It is recommended to load the discriminator checkpoint into that model."),Sw=l(),Gr=n("p"),Ww=r("This model inherits from "),Zl=n("a"),Bw=r("FlaxPreTrainedModel"),Rw=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
...
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jw=l(),xh=n("p"),Kw=r("Finally, this model supports inherent JAX features such as:"),Gw=l(),Rt=n("ul"),Mh=n("li"),Zr=n("a"),Xw=r("Just-In-Time (JIT) compilation"),Yw=l(),zh=n("li"),ei=n("a"),Zw=r("Automatic Differentiation"),ey=l(),Ph=n("li"),ti=n("a"),ty=r("Vectorization"),oy=l(),Ch=n("li"),oi=n("a"),ny=r("Parallelization"),sy=l(),gt=n("div"),T(ni.$$.fragment),ay=l(),rn=n("p"),ry=r("The "),qh=n("code"),iy=r("FlaxElectraPreTrainedModel"),ly=r(" forward method, overrides the "),jh=n("code"),dy=r("__call__"),cy=r(" special method."),hy=l(),T(ds.$$.fragment),py=l(),Ah=n("p"),my=r("Example:"),uy=l(),T(si.$$.fragment),Um=l(),ln=n("h2"),cs=n("a"),Ih=n("span"),T(ai.$$.fragment),fy=l(),Lh=n("span"),gy=r("FlaxElectraForMaskedLM"),Vm=l(),Ne=n("div"),T(ri.$$.fragment),_y=l(),ii=n("p"),vy=r("Electra Model with a "),Nh=n("code"),ky=r("language modeling"),Ty=r(" head on top."),Ey=l(),li=n("p"),wy=r("This model inherits from "),ed=n("a"),yy=r("FlaxPreTrainedModel"),by=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
PyTorch models)`),Fy=l(),di=n("p"),$y=r("This model is also a Flax Linen "),ci=n("a"),xy=r("flax.nn.Module"),My=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zy=l(),Dh=n("p"),Py=r("Finally, this model supports inherent JAX features such as:"),Cy=l(),Ht=n("ul"),Oh=n("li"),hi=n("a"),qy=r("Just-In-Time (JIT) compilation"),jy=l(),Sh=n("li"),pi=n("a"),Ay=r("Automatic Differentiation"),Iy=l(),Wh=n("li"),mi=n("a"),Ly=r("Vectorization"),Ny=l(),Bh=n("li"),ui=n("a"),Dy=r("Parallelization"),Oy=l(),_t=n("div"),T(fi.$$.fragment),Sy=l(),dn=n("p"),Wy=r("The "),Rh=n("code"),By=r("FlaxElectraPreTrainedModel"),Ry=r(" forward method, overrides the "),Hh=n("code"),Hy=r("__call__"),Qy=r(" special method."),Uy=l(),T(hs.$$.fragment),Vy=l(),Qh=n("p"),Jy=r("Example:"),Ky=l(),T(gi.$$.fragment),Jm=l(),cn=n("h2"),ps=n("a"),Uh=n("span"),T(_i.$$.fragment),Gy=l(),Vh=n("span"),Xy=r("FlaxElectraForSequenceClassification"),Km=l(),De=n("div"),T(vi.$$.fragment),Yy=l(),Jh=n("p"),Zy=r(`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),eb=l(),ki=n("p"),tb=r("This model inherits from "),td=n("a"),ob=r("FlaxPreTrainedModel"),nb=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
PyTorch models)`),sb=l(),Ti=n("p"),ab=r("This model is also a Flax Linen "),Ei=n("a"),rb=r("flax.nn.Module"),ib=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),lb=l(),Kh=n("p"),db=r("Finally, this model supports inherent JAX features such as:"),cb=l(),Qt=n("ul"),Gh=n("li"),wi=n("a"),hb=r("Just-In-Time (JIT) compilation"),pb=l(),Xh=n("li"),yi=n("a"),mb=r("Automatic Differentiation"),ub=l(),Yh=n("li"),bi=n("a"),fb=r("Vectorization"),gb=l(),Zh=n("li"),Fi=n("a"),_b=r("Parallelization"),vb=l(),vt=n("div"),T($i.$$.fragment),kb=l(),hn=n("p"),Tb=r("The "),ep=n("code"),Eb=r("FlaxElectraPreTrainedModel"),wb=r(" forward method, overrides the "),tp=n("code"),yb=r("__call__"),bb=r(" special method."),Fb=l(),T(ms.$$.fragment),$b=l(),op=n("p"),xb=r("Example:"),Mb=l(),T(xi.$$.fragment),Gm=l(),pn=n("h2"),us=n("a"),np=n("span"),T(Mi.$$.fragment),zb=l(),sp=n("span"),Pb=r("FlaxElectraForMultipleChoice"),Xm=l(),Oe=n("div"),T(zi.$$.fragment),Cb=l(),ap=n("p"),qb=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),jb=l(),Pi=n("p"),Ab=r("This model inherits from "),od=n("a"),Ib=r("FlaxPreTrainedModel"),Lb=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
PyTorch models)`),Nb=l(),Ci=n("p"),Db=r("This model is also a Flax Linen "),qi=n("a"),Ob=r("flax.nn.Module"),Sb=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Wb=l(),rp=n("p"),Bb=r("Finally, this model supports inherent JAX features such as:"),Rb=l(),Ut=n("ul"),ip=n("li"),ji=n("a"),Hb=r("Just-In-Time (JIT) compilation"),Qb=l(),lp=n("li"),Ai=n("a"),Ub=r("Automatic Differentiation"),Vb=l(),dp=n("li"),Ii=n("a"),Jb=r("Vectorization"),Kb=l(),cp=n("li"),Li=n("a"),Gb=r("Parallelization"),Xb=l(),kt=n("div"),T(Ni.$$.fragment),Yb=l(),mn=n("p"),Zb=r("The "),hp=n("code"),e0=r("FlaxElectraPreTrainedModel"),t0=r(" forward method, overrides the "),pp=n("code"),o0=r("__call__"),n0=r(" special method."),s0=l(),T(fs.$$.fragment),a0=l(),mp=n("p"),r0=r("Example:"),i0=l(),T(Di.$$.fragment),Ym=l(),un=n("h2"),gs=n("a"),up=n("span"),T(Oi.$$.fragment),l0=l(),fp=n("span"),d0=r("FlaxElectraForTokenClassification"),Zm=l(),qe=n("div"),T(Si.$$.fragment),c0=l(),gp=n("p"),h0=r("Electra model with a token classification head on top."),p0=l(),_p=n("p"),m0=r("Both the discriminator and generator may be loaded into this model."),u0=l(),Wi=n("p"),f0=r("This model inherits from "),nd=n("a"),g0=r("FlaxPreTrainedModel"),_0=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
PyTorch models)`),v0=l(),Bi=n("p"),k0=r("This model is also a Flax Linen "),Ri=n("a"),T0=r("flax.nn.Module"),E0=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),w0=l(),vp=n("p"),y0=r("Finally, this model supports inherent JAX features such as:"),b0=l(),Vt=n("ul"),kp=n("li"),Hi=n("a"),F0=r("Just-In-Time (JIT) compilation"),$0=l(),Tp=n("li"),Qi=n("a"),x0=r("Automatic Differentiation"),M0=l(),Ep=n("li"),Ui=n("a"),z0=r("Vectorization"),P0=l(),wp=n("li"),Vi=n("a"),C0=r("Parallelization"),q0=l(),Tt=n("div"),T(Ji.$$.fragment),j0=l(),fn=n("p"),A0=r("The "),yp=n("code"),I0=r("FlaxElectraPreTrainedModel"),L0=r(" forward method, overrides the "),bp=n("code"),N0=r("__call__"),D0=r(" special method."),O0=l(),T(_s.$$.fragment),S0=l(),Fp=n("p"),W0=r("Example:"),B0=l(),T(Ki.$$.fragment),eu=l(),gn=n("h2"),vs=n("a"),$p=n("span"),T(Gi.$$.fragment),R0=l(),xp=n("span"),H0=r("FlaxElectraForQuestionAnswering"),tu=l(),Se=n("div"),T(Xi.$$.fragment),Q0=l(),_n=n("p"),U0=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mp=n("code"),V0=r("span start logits"),J0=r(" and "),zp=n("code"),K0=r("span end logits"),G0=r(")."),X0=l(),Yi=n("p"),Y0=r("This model inherits from "),sd=n("a"),Z0=r("FlaxPreTrainedModel"),e2=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
...
the two to have been trained for the masked language modeling task.`),A$.forEach(t),WT=d(bt),sr=s(bt,"P",{});var Wu=a(sr);BT=i(Wu,"This model inherits from "),Bl=s(Wu,"A",{href:!0});var I$=a(Bl);RT=i(I$,"TFPreTrainedModel"),I$.forEach(t),HT=i(Wu,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
