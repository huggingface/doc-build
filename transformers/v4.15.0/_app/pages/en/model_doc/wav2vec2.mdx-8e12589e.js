...
`),f=s(P,"A",{href:!0});var j=n(f);T=i(j,"from_pretrained()"),j.forEach(t),W=i(P,` and
PreTrainedTokenizer\u2019s `),u=s(P,"CODE",{});var A=n(u);g=i(A,"from_pretrained"),A.forEach(t),$=i(P,`.
Please refer to the docstrings of the methods above for more information.`),P.forEach(t),this.h()},h(){l(f,"href","/docs/transformers/v4.15.0/en/main_classes/feature_extractor#transformers.feature_extraction_utils.FeatureExtractionMixin.from_pretrained")},m(q,P){m(q,p,P),e(p,x),e(p,f),e(f,T),e(p,W),e(p,u),e(u,g),e(p,$)},d(q){q&&t(p)}}}function lk(C){let p,x,f,T,W,u,g,$;return{c(){p=a("p"),x=r(`This class method is simply calling
`),f=a("a"),T=r("save_pretrained()"),W=r(` and
`),u=a("code"),g=r("save_pretrained"),$=r(`. Please refer to the
...
`),f=s(P,"A",{href:!0});var j=n(f);T=i(j,"save_pretrained()"),j.forEach(t),W=i(P,` and
`),u=s(P,"CODE",{});var A=n(u);g=i(A,"save_pretrained"),A.forEach(t),$=i(P,`. Please refer to the
...
`),f=a("a"),T=r("from_pretrained()"),W=r(`,
Wav2Vec2CTCTokenizer\u2019s `),u=a("code"),g=r("from_pretrained"),$=r(`,
and `),q=a("code"),P=r("pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),j=r("."),A=c(),D=a("p"),N=r("Please refer to the docstrings of the methods above for more information."),this.h()},l(M){p=s(M,"P",{});var E=n(p);x=i(E,`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
`),f=s(E,"A",{href:!0});var ae=n(f);T=i(ae,"from_pretrained()"),ae.forEach(t),W=i(E,`,
Wav2Vec2CTCTokenizer\u2019s `),u=s(E,"CODE",{});var ee=n(u);g=i(ee,"from_pretrained"),ee.forEach(t),$=i(E,`,
...
`),f=a("code"),T=r("save_pretrained,"),W=c(),u=a("code"),g=r("save_pretrained"),$=r(` and pyctcdecode\u2019s
`),q=a("code"),P=r("pyctcdecode.BeamSearchDecoderCTC.save_to_dir"),j=r("."),A=c(),D=a("p"),N=r("Please refer to the docstrings of the methods above for more information.")},l(M){p=s(M,"P",{});var E=n(p);x=i(E,`This class method is simply calling
`),f=s(E,"CODE",{});var ae=n(f);T=i(ae,"save_pretrained,"),ae.forEach(t),W=d(E),u=s(E,"CODE",{});var ee=n(u);g=i(ee,"save_pretrained"),ee.forEach(t),$=i(E,` and pyctcdecode\u2019s
...
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function mk(C){let p,x,f,T,W;return{c(){p=a("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),W=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function fk(C){let p,x,f,T,W;return{c(){p=a("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),W=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function uk(C){let p,x,f,T,W;return{c(){p=a("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),W=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function gk(C){let p,x,f,T,W;return{c(){p=a("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),W=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function _k(C){let p,x,f,T,W;return{c(){p=a("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),W=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function vk(C){let p,x,f,T,W,u,g,$,q,P,j,A,D,N,M,E,ae,ee,S,B,fe,He,O,H,$e,ue,Ze,Ve,se,st,Ke,I,nt,he,me,Re,ge,rt,_e,ne,Fe,ve,it;return{c(){p=a("p"),x=r("TF 2.0 models accepts two formats as inputs:"),f=c(),T=a("ul"),W=a("li"),u=r("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),$=a("li"),q=r("having all inputs as a list, tuple or dict in the first positional arguments."),P=c(),j=a("p"),A=r("This second option is useful when using "),D=a("code"),N=r("tf.keras.Model.fit"),M=r(` method which currently requires having all
the tensors in the first argument of the model call function: `),E=a("code"),ae=r("model(inputs)"),ee=r("."),S=c(),B=a("p"),fe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),He=c(),O=a("ul"),H=a("li"),$e=r("a single Tensor with "),ue=a("code"),Ze=r("input_values"),Ve=r(" only and nothing else: "),se=a("code"),st=r("model(inputs_ids)"),Ke=c(),I=a("li"),nt=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),he=a("code"),me=r("model([input_values, attention_mask])"),Re=r(" or "),ge=a("code"),rt=r("model([input_values, attention_mask, token_type_ids])"),_e=c(),ne=a("li"),Fe=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ve=a("code"),it=r('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l(V){p=s(V,"P",{});var z=n(p);x=i(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),f=d(V),T=s(V,"UL",{});var Xe=n(T);W=s(Xe,"LI",{});var Je=n(W);u=i(Je,"having all inputs as keyword arguments (like PyTorch models), or"),Je.forEach(t),g=d(Xe),$=s(Xe,"LI",{});var Nt=n($);q=i(Nt,"having all inputs as a list, tuple or dict in the first positional arguments."),Nt.forEach(t),Xe.forEach(t),P=d(V),j=s(V,"P",{});var re=n(j);A=i(re,"This second option is useful when using "),D=s(re,"CODE",{});var wt=n(D);N=i(wt,"tf.keras.Model.fit"),wt.forEach(t),M=i(re,` method which currently requires having all
the tensors in the first argument of the model call function: `),E=s(re,"CODE",{});var we=n(E);ae=i(we,"model(inputs)"),we.forEach(t),ee=i(re,"."),re.forEach(t),S=d(V),B=s(V,"P",{});var je=n(B);fe=i(je,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),je.forEach(t),He=d(V),O=s(V,"UL",{});var J=n(O);H=s(J,"LI",{});var G=n(H);$e=i(G,"a single Tensor with "),ue=s(G,"CODE",{});var Bt=n(ue);Ze=i(Bt,"input_values"),Bt.forEach(t),Ve=i(G," only and nothing else: "),se=s(G,"CODE",{});var lt=n(se);st=i(lt,"model(inputs_ids)"),lt.forEach(t),G.forEach(t),Ke=d(J),I=s(J,"LI",{});var be=n(I);nt=i(be,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),he=s(be,"CODE",{});var bt=n(he);me=i(bt,"model([input_values, attention_mask])"),bt.forEach(t),Re=i(be," or "),ge=s(be,"CODE",{});var R=n(ge);rt=i(R,"model([input_values, attention_mask, token_type_ids])"),R.forEach(t),be.forEach(t),_e=d(J),ne=s(J,"LI",{});var ye=n(ne);Fe=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function kk(C){let p,x,f,T,W;return{c(){p=a("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),W=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function Tk(C){let p,x,f,T,W;return{c(){p=a("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),W=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(u,g){m(u,p,g),e(p,x),e(p,f),e(f,T),e(p,W)},d(u){u&&t(p)}}}function xk(C){let p,x,f,T,W;return{c(){p=a("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),W=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=s(u,"P",{});var g=n(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=n(f);T=i($,"Module"),$.forEach(t),W=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Qn=new F({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxWav2Vec2PreTrainedModel.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L795",parametersDescription:[{anchor:"transformers.FlaxWav2Vec2PreTrainedModel.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.15.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see
<a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),dr=new F({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxWav2Vec2PreTrainedModel.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L795",parametersDescription:[{anchor:"transformers.FlaxWav2Vec2PreTrainedModel.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.15.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should
be used for padding and conversion into a tensor of type <em>jnp.ndarray</em>. See
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see
<a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and <a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),kr=new F({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1174",parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.15.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should
be used for padding and conversion into a tensor of type <em>jnp.ndarray</em>. See
...
methods. Users should refer to this superclass for more information regarding those methods.`),Dh=c(),qo=a("div"),_(Sa.$$.fragment),Oh=c(),el=a("p"),Lh=r("Main method to featurize and prepare for the model one or several sequence(s). sequences."),nd=c(),Gt=a("h2"),Mo=a("a"),tl=a("span"),_(Ia.$$.fragment),Sh=c(),ol=a("span"),Ih=r("Wav2Vec2Processor"),rd=c(),L=a("div"),_(Na.$$.fragment),Nh=c(),al=a("p"),Bh=r(`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
processor.`),Uh=c(),Ee=a("p"),Mr=a("a"),Hh=r("Wav2Vec2Processor"),Rh=r(` offers all the functionalities of
...
two methods for more information.`),km=c(),yt=a("div"),_(Ja.$$.fragment),Tm=c(),Ga=a("p"),xm=r("Instantiate a "),Nr=a("a"),Wm=r("Wav2Vec2Processor"),$m=r(" from a pretrained Wav2Vec2 processor."),Vm=c(),_(Do.$$.fragment),Fm=c(),kt=a("div"),_(Za.$$.fragment),jm=c(),Zt=a("p"),Em=r("Save a Wav2Vec2 feature_extractor object and Wav2Vec2 tokenizer object to the directory "),il=a("code"),Pm=r("save_directory"),Cm=r(`, so
that it can be re-loaded using the `),Br=a("a"),qm=r("from_pretrained()"),Mm=r(" class method."),zm=c(),_(Oo.$$.fragment),Am=c(),Lo=a("div"),_(Ka.$$.fragment),Dm=c(),Qa=a("p"),Om=r(`This method forwards all its arguments to PreTrainedTokenizer\u2019s
...
above two methods for more information.`),bf=c(),Tt=a("div"),_(ls.$$.fragment),yf=c(),cs=a("p"),kf=r("Instantiate a "),Zr=a("a"),Tf=r("Wav2Vec2ProcessorWithLM"),xf=r(" from a pretrained Wav2Vec2 processor."),Wf=c(),_(Ho.$$.fragment),$f=c(),xt=a("div"),_(ds.$$.fragment),Vf=c(),Qt=a("p"),Ff=r(`Save the Wav2Vec2 feature_extractor, a tokenizer object and a pyctcdecode decoder to the directory
`),fl=a("code"),jf=r("save_directory"),Ef=r(`, so that they can be re-loaded using the
`),Kr=a("a"),Pf=r("from_pretrained()"),Cf=r(" class method."),qf=c(),_(Ro.$$.fragment),Mf=c(),Wt=a("div"),_(ps.$$.fragment),zf=c(),ul=a("p"),Af=r("Batch decode output logits to audio transcription with language model support."),Df=c(),_(Xo.$$.fragment),Of=c(),Jo=a("div"),_(hs.$$.fragment),Lf=c(),gl=a("p"),Sf=r("Decode output logits to audio transcription with language model support."),If=c(),Go=a("div"),_(ms.$$.fragment),Nf=c(),_l=a("p"),Bf=r(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),cd=c(),Yt=a("h2"),Zo=a("a"),vl=a("span"),_(fs.$$.fragment),Uf=c(),wl=a("span"),Hf=r("Wav2Vec2 specific outputs"),dd=c(),eo=a("div"),_(us.$$.fragment),Rf=c(),gs=a("p"),Xf=r("Output type of "),bl=a("code"),Jf=r("Wav2Vec2DecoderWithLM"),Gf=r(", with transcription."),pd=c(),to=a("div"),_(_s.$$.fragment),Zf=c(),vs=a("p"),Kf=r("Output type of "),yl=a("code"),Qf=r("Wav2Vec2BaseModelOutput"),Yf=r(", with potential hidden states and attentions."),hd=c(),oo=a("div"),_(ws.$$.fragment),eu=c(),bs=a("p"),tu=r("Output type of "),Qr=a("a"),ou=r("Wav2Vec2ForPreTraining"),au=r(", with potential hidden states and attentions."),md=c(),mt=a("div"),_(ys.$$.fragment),su=c(),ks=a("p"),nu=r("Output type of "),kl=a("code"),ru=r("FlaxWav2Vec2BaseModelOutput"),iu=r(", with potential hidden states and attentions."),lu=c(),Ko=a("div"),_(Ts.$$.fragment),cu=c(),Tl=a("p"),du=r("\u201CReturns a new object replacing the specified fields with new values."),fd=c(),ft=a("div"),_(xs.$$.fragment),pu=c(),Ws=a("p"),hu=r("Output type of "),xl=a("code"),mu=r("FlaxWav2Vec2ForPreTrainingOutput"),fu=r(`, with potential hidden states and
attentions.`),uu=c(),Qo=a("div"),_($s.$$.fragment),gu=c(),Wl=a("p"),_u=r("\u201CReturns a new object replacing the specified fields with new values."),ud=c(),ao=a("h2"),Yo=a("a"),$l=a("span"),_(Vs.$$.fragment),vu=c(),Vl=a("span"),wu=r("Wav2Vec2Model"),gd=c(),Te=a("div"),_(Fs.$$.fragment),bu=c(),js=a("p"),yu=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),Es=a("a"),ku=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Tu=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),xu=c(),Ps=a("p"),Wu=r("This model inherits from "),Yr=a("a"),$u=r("PreTrainedModel"),Vu=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),Fu=c(),Cs=a("p"),ju=r("This model is a PyTorch "),qs=a("a"),Eu=r("torch.nn.Module"),Pu=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cu=c(),Pe=a("div"),_(Ms.$$.fragment),qu=c(),so=a("p"),Mu=r("The "),ei=a("a"),zu=r("Wav2Vec2Model"),Au=r(" forward method, overrides the "),Fl=a("code"),Du=r("__call__"),Ou=r(" special method."),Lu=c(),_(ea.$$.fragment),Su=c(),jl=a("p"),Iu=r("Example:"),Nu=c(),_(zs.$$.fragment),_d=c(),no=a("h2"),ta=a("a"),El=a("span"),_(As.$$.fragment),Bu=c(),Pl=a("span"),Uu=r("Wav2Vec2ForCTC"),vd=c(),xe=a("div"),_(Ds.$$.fragment),Hu=c(),ro=a("p"),Ru=r("Wav2Vec2 Model with a "),Cl=a("code"),Xu=r("language modeling"),Ju=r(` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),Os=a("a"),Gu=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Zu=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Ku=c(),Ls=a("p"),Qu=r("This model inherits from "),ti=a("a"),Yu=r("PreTrainedModel"),eg=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),tg=c(),Ss=a("p"),og=r("This model is a PyTorch "),Is=a("a"),ag=r("torch.nn.Module"),sg=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ng=c(),Ce=a("div"),_(Ns.$$.fragment),rg=c(),io=a("p"),ig=r("The "),oi=a("a"),lg=r("Wav2Vec2ForCTC"),cg=r(" forward method, overrides the "),ql=a("code"),dg=r("__call__"),pg=r(" special method."),hg=c(),_(oa.$$.fragment),mg=c(),Ml=a("p"),fg=r("Example:"),ug=c(),_(Bs.$$.fragment),wd=c(),lo=a("h2"),aa=a("a"),zl=a("span"),_(Us.$$.fragment),gg=c(),Al=a("span"),_g=r("Wav2Vec2ForSequenceClassification"),bd=c(),ie=a("div"),_(Hs.$$.fragment),vg=c(),Dl=a("p"),wg=r(`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),bg=c(),Rs=a("p"),yg=r("Wav2Vec2 was proposed in "),Xs=a("a"),kg=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Tg=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),xg=c(),Js=a("p"),Wg=r("This model inherits from "),ai=a("a"),$g=r("PreTrainedModel"),Vg=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),Fg=c(),Gs=a("p"),jg=r("This model is a PyTorch "),Zs=a("a"),Eg=r("torch.nn.Module"),Pg=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cg=c(),qe=a("div"),_(Ks.$$.fragment),qg=c(),co=a("p"),Mg=r("The "),si=a("a"),zg=r("Wav2Vec2ForSequenceClassification"),Ag=r(" forward method, overrides the "),Ol=a("code"),Dg=r("__call__"),Og=r(" special method."),Lg=c(),_(sa.$$.fragment),Sg=c(),Ll=a("p"),Ig=r("Example:"),Ng=c(),_(Qs.$$.fragment),yd=c(),po=a("h2"),na=a("a"),Sl=a("span"),_(Ys.$$.fragment),Bg=c(),Il=a("span"),Ug=r("Wav2Vec2ForAudioFrameClassification"),kd=c(),le=a("div"),_(en.$$.fragment),Hg=c(),Nl=a("p"),Rg=r("Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),Xg=c(),tn=a("p"),Jg=r("Wav2Vec2 was proposed in "),on=a("a"),Gg=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Zg=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Kg=c(),an=a("p"),Qg=r("This model inherits from "),ni=a("a"),Yg=r("PreTrainedModel"),e_=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),t_=c(),sn=a("p"),o_=r("This model is a PyTorch "),nn=a("a"),a_=r("torch.nn.Module"),s_=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),n_=c(),Me=a("div"),_(rn.$$.fragment),r_=c(),ho=a("p"),i_=r("The "),ri=a("a"),l_=r("Wav2Vec2ForAudioFrameClassification"),c_=r(" forward method, overrides the "),Bl=a("code"),d_=r("__call__"),p_=r(" special method."),h_=c(),_(ra.$$.fragment),m_=c(),Ul=a("p"),f_=r("Example:"),u_=c(),_(ln.$$.fragment),Td=c(),mo=a("h2"),ia=a("a"),Hl=a("span"),_(cn.$$.fragment),g_=c(),Rl=a("span"),__=r("Wav2Vec2ForXVector"),xd=c(),ce=a("div"),_(dn.$$.fragment),v_=c(),Xl=a("p"),w_=r("Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),b_=c(),pn=a("p"),y_=r("Wav2Vec2 was proposed in "),hn=a("a"),k_=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),T_=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),x_=c(),mn=a("p"),W_=r("This model inherits from "),ii=a("a"),$_=r("PreTrainedModel"),V_=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),F_=c(),fn=a("p"),j_=r("This model is a PyTorch "),un=a("a"),E_=r("torch.nn.Module"),P_=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),C_=c(),ze=a("div"),_(gn.$$.fragment),q_=c(),fo=a("p"),M_=r("The "),li=a("a"),z_=r("Wav2Vec2ForXVector"),A_=r(" forward method, overrides the "),Jl=a("code"),D_=r("__call__"),O_=r(" special method."),L_=c(),_(la.$$.fragment),S_=c(),Gl=a("p"),I_=r("Example:"),N_=c(),_(_n.$$.fragment),Wd=c(),uo=a("h2"),ca=a("a"),Zl=a("span"),_(vn.$$.fragment),B_=c(),Kl=a("span"),U_=r("Wav2Vec2ForPreTraining"),$d=c(),We=a("div"),_(wn.$$.fragment),H_=c(),go=a("p"),R_=r("Wav2Vec2 Model with a quantizer and "),Ql=a("code"),X_=r("VQ"),J_=r(` head on top.
Wav2Vec2 was proposed in `),bn=a("a"),G_=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Z_=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),K_=c(),yn=a("p"),Q_=r("This model inherits from "),ci=a("a"),Y_=r("PreTrainedModel"),ev=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),tv=c(),kn=a("p"),ov=r("This model is a PyTorch "),Tn=a("a"),av=r("torch.nn.Module"),sv=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),nv=c(),Ae=a("div"),_(xn.$$.fragment),rv=c(),_o=a("p"),iv=r("The "),di=a("a"),lv=r("Wav2Vec2ForPreTraining"),cv=r(" forward method, overrides the "),Yl=a("code"),dv=r("__call__"),pv=r(" special method."),hv=c(),_(da.$$.fragment),mv=c(),ec=a("p"),fv=r("Example:"),uv=c(),_(Wn.$$.fragment),Vd=c(),vo=a("h2"),pa=a("a"),tc=a("span"),_($n.$$.fragment),gv=c(),oc=a("span"),_v=r("TFWav2Vec2Model"),Fd=c(),de=a("div"),_(Vn.$$.fragment),vv=c(),ac=a("p"),wv=r("The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),bv=c(),Fn=a("p"),yv=r("This model inherits from "),pi=a("a"),kv=r("TFPreTrainedModel"),Tv=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),xv=c(),jn=a("p"),Wv=r("This model is also a "),En=a("a"),$v=r("tf.keras.Model"),Vv=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Fv=c(),_(ha.$$.fragment),jv=c(),De=a("div"),_(Pn.$$.fragment),Ev=c(),wo=a("p"),Pv=r("The "),hi=a("a"),Cv=r("TFWav2Vec2Model"),qv=r(" forward method, overrides the "),sc=a("code"),Mv=r("__call__"),zv=r(" special method."),Av=c(),_(ma.$$.fragment),Dv=c(),nc=a("p"),Ov=r("Example:"),Lv=c(),_(Cn.$$.fragment),jd=c(),bo=a("h2"),fa=a("a"),rc=a("span"),_(qn.$$.fragment),Sv=c(),ic=a("span"),Iv=r("TFWav2Vec2ForCTC"),Ed=c(),pe=a("div"),_(Mn.$$.fragment),Nv=c(),zn=a("p"),Bv=r("TFWav2Vec2 Model with a "),lc=a("code"),Uv=r("language modeling"),Hv=r(" head on top for Connectionist Temporal Classification (CTC)."),Rv=c(),An=a("p"),Xv=r("This model inherits from "),mi=a("a"),Jv=r("TFPreTrainedModel"),Gv=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Zv=c(),Dn=a("p"),Kv=r("This model is also a "),On=a("a"),Qv=r("tf.keras.Model"),Yv=r(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),e2=c(),_(ua.$$.fragment),t2=c(),Oe=a("div"),_(Ln.$$.fragment),o2=c(),yo=a("p"),a2=r("The "),fi=a("a"),s2=r("TFWav2Vec2ForCTC"),n2=r(" forward method, overrides the "),cc=a("code"),r2=r("__call__"),i2=r(" special method."),l2=c(),_(ga.$$.fragment),c2=c(),dc=a("p"),d2=r("Example:"),p2=c(),_(Sn.$$.fragment),Pd=c(),ko=a("h2"),_a=a("a"),pc=a("span"),_(In.$$.fragment),h2=c(),hc=a("span"),m2=r("FlaxWav2Vec2Model"),Cd=c(),Z=a("div"),_(Nn.$$.fragment),f2=c(),Bn=a("p"),u2=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),Un=a("a"),g2=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),_2=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),v2=c(),Hn=a("p"),w2=r("This model inherits from "),ui=a("a"),b2=r("FlaxPreTrainedModel"),y2=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),k2=c(),Rn=a("p"),T2=r("This model is also a Flax Linen "),Xn=a("a"),x2=r("flax.nn.Module"),W2=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$2=c(),mc=a("p"),V2=r("Finally, this model supports inherent JAX features such as:"),F2=c(),ut=a("ul"),fc=a("li"),Jn=a("a"),j2=r("Just-In-Time (JIT) compilation"),E2=c(),uc=a("li"),Gn=a("a"),P2=r("Automatic Differentiation"),C2=c(),gc=a("li"),Zn=a("a"),q2=r("Vectorization"),M2=c(),_c=a("li"),Kn=a("a"),z2=r("Parallelization"),A2=c(),Le=a("div"),_(Qn.$$.fragment),D2=c(),To=a("p"),O2=r("The "),vc=a("code"),L2=r("FlaxWav2Vec2PreTrainedModel"),S2=r(" forward method, overrides the "),wc=a("code"),I2=r("__call__"),N2=r(" special method."),B2=c(),_(va.$$.fragment),U2=c(),bc=a("p"),H2=r("Example:"),R2=c(),_(Yn.$$.fragment),qd=c(),xo=a("h2"),wa=a("a"),yc=a("span"),_(er.$$.fragment),X2=c(),kc=a("span"),J2=r("FlaxWav2Vec2ForCTC"),Md=c(),K=a("div"),_(tr.$$.fragment),G2=c(),Wo=a("p"),Z2=r("Wav2Vec2 Model with a "),Tc=a("code"),K2=r("language modeling"),Q2=r(` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),or=a("a"),Y2=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),ew=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),tw=c(),ar=a("p"),ow=r("This model inherits from "),gi=a("a"),aw=r("FlaxPreTrainedModel"),sw=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),nw=c(),sr=a("p"),rw=r("This model is also a Flax Linen "),nr=a("a"),iw=r("flax.nn.Module"),lw=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),cw=c(),xc=a("p"),dw=r("Finally, this model supports inherent JAX features such as:"),pw=c(),gt=a("ul"),Wc=a("li"),rr=a("a"),hw=r("Just-In-Time (JIT) compilation"),mw=c(),$c=a("li"),ir=a("a"),fw=r("Automatic Differentiation"),uw=c(),Vc=a("li"),lr=a("a"),gw=r("Vectorization"),_w=c(),Fc=a("li"),cr=a("a"),vw=r("Parallelization"),ww=c(),Se=a("div"),_(dr.$$.fragment),bw=c(),$o=a("p"),yw=r("The "),jc=a("code"),kw=r("FlaxWav2Vec2PreTrainedModel"),Tw=r(" forward method, overrides the "),Ec=a("code"),xw=r("__call__"),Ww=r(" special method."),$w=c(),_(ba.$$.fragment),Vw=c(),Pc=a("p"),Fw=r("Example:"),jw=c(),_(pr.$$.fragment),zd=c(),Vo=a("h2"),ya=a("a"),Cc=a("span"),_(hr.$$.fragment),Ew=c(),qc=a("span"),Pw=r("FlaxWav2Vec2ForPreTraining"),Ad=c(),Q=a("div"),_(mr.$$.fragment),Cw=c(),Fo=a("p"),qw=r("Wav2Vec2 Model with a quantizer and "),Mc=a("code"),Mw=r("VQ"),zw=r(` head on top.
Wav2Vec2 was proposed in `),fr=a("a"),Aw=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Dw=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Ow=c(),ur=a("p"),Lw=r("This model inherits from "),_i=a("a"),Sw=r("FlaxPreTrainedModel"),Iw=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Nw=c(),gr=a("p"),Bw=r("This model is also a Flax Linen "),_r=a("a"),Uw=r("flax.nn.Module"),Hw=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rw=c(),zc=a("p"),Xw=r("Finally, this model supports inherent JAX features such as:"),Jw=c(),_t=a("ul"),Ac=a("li"),vr=a("a"),Gw=r("Just-In-Time (JIT) compilation"),Zw=c(),Dc=a("li"),wr=a("a"),Kw=r("Automatic Differentiation"),Qw=c(),Oc=a("li"),br=a("a"),Yw=r("Vectorization"),eb=c(),Lc=a("li"),yr=a("a"),tb=r("Parallelization"),ob=c(),Ie=a("div"),_(kr.$$.fragment),ab=c(),jo=a("p"),sb=r("The "),vi=a("a"),nb=r("FlaxWav2Vec2ForPreTraining"),rb=r(" forward method, overrides the "),Sc=a("code"),ib=r("__call__"),lb=r(" special method."),cb=c(),_(ka.$$.fragment),db=c(),Ic=a("p"),pb=r("Example:"),hb=c(),_(Tr.$$.fragment),this.h()},l(o){const h=rk('[data-svelte="svelte-1phssyn"]',document.head);p=s(h,"META",{name:!0,content:!0}),h.forEach(t),x=d(o),f=s(o,"H1",{class:!0});var xr=n(f);T=s(xr,"A",{id:!0,class:!0,href:!0});var Nc=n(T);W=s(Nc,"SPAN",{});var Bc=n(W);v(u.$$.fragment,Bc),Bc.forEach(t),Nc.forEach(t),g=d(xr),$=s(xr,"SPAN",{});var Uc=n($);q=i(Uc,"Wav2Vec2"),Uc.forEach(t),xr.forEach(t),P=d(o),j=s(o,"H2",{class:!0});var Wr=n(j);A=s(Wr,"A",{id:!0,class:!0,href:!0});var Hc=n(A);D=s(Hc,"SPAN",{});var Rc=n(D);v(N.$$.fragment,Rc),Rc.forEach(t),Hc.forEach(t),M=d(Wr),E=s(Wr,"SPAN",{});var Xc=n(E);ae=i(Xc,"Overview"),Xc.forEach(t),Wr.forEach(t),ee=d(o),S=s(o,"P",{});var $r=n(S);B=i($r,"The Wav2Vec2 model was proposed in "),fe=s($r,"A",{href:!0,rel:!0});var Jc=n(fe);He=i(Jc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Jc.forEach(t),O=i($r," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),$r.forEach(t),H=d(o),$e=s(o,"P",{});var Gc=n($e);ue=i(Gc,"The abstract from the paper is the following:"),Gc.forEach(t),Ze=d(o),Ve=s(o,"P",{});var Zc=n(Ve);se=s(Zc,"EM",{});var Kc=n(se);st=i(Kc,`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
transcribed speech can outperform the best semi-supervised methods while being conceptually simpler. wav2vec 2.0 masks
the speech input in the latent space and solves a contrastive task defined over a quantization of the latent
representations which are jointly learned. Experiments using all labeled data of Librispeech achieve 1.8/3.3 WER on the
clean/other test sets. When lowering the amount of labeled data to one hour, wav2vec 2.0 outperforms the previous state
