import{S as bb,i as kb,s as yb,e as n,k as l,w as v,t as a,L as wb,c as s,d as t,m as d,a as i,x as b,h as r,b as c,J as e,g as h,y as k,q as y,o as w,B as P}from"../../../chunks/vendor-b1433968.js";import{T as Le}from"../../../chunks/Tip-c3840994.js";import{D as H}from"../../../chunks/Docstring-ff504c58.js";import{C as Me}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as ze}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function Pb(q){let p,M,f,T,$;return{c(){p=n("p"),M=a("When used with "),f=n("code"),T=a("is_split_into_words=True"),$=a(`, this tokenizer will add a space before each word (even the first
one).`)},l(_){p=s(_,"P",{});var g=i(p);M=r(g,"When used with "),f=s(g,"CODE",{});var x=i(f);T=r(x,"is_split_into_words=True"),x.forEach(t),$=r(g,`, this tokenizer will add a space before each word (even the first
one).`),g.forEach(t)},m(_,g){h(_,p,g),e(p,M),e(p,f),e(f,T),e(p,$)},d(_){_&&t(p)}}}function $b(q){let p,M,f,T,$,_,g,x;return{c(){p=n("p"),M=a("When used with "),f=n("code"),T=a("is_split_into_words=True"),$=a(`, this tokenizer needs to be instantiated with
`),_=n("code"),g=a("add_prefix_space=True"),x=a(".")},l(Q){p=s(Q,"P",{});var C=i(p);M=r(C,"When used with "),f=s(C,"CODE",{});var z=i(f);T=r(z,"is_split_into_words=True"),z.forEach(t),$=r(C,`, this tokenizer needs to be instantiated with
...
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=i(p);M=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var x=i(f);T=r(x,"Module"),x.forEach(t),$=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=i(p);M=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var x=i(f);T=r(x,"Module"),x.forEach(t),$=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(_,g){h(_,p,g),e(p,M),e(p,f),e(f,T),e(p,$)},d(_){_&&t(p)}}}function jb(q){let p,M,f,T,$,_,g,x,Q,C,z,R,S,Z,ue,A,me,ce,W,L,ee,te,F,E,se,V,pe,ae,O,fe,he,j,ge,B,U,re,J,_e,oe,N,ie,K,Te;return{c(){p=n("p"),M=a("TF 2.0 models accepts two formats as inputs:"),f=l(),T=n("ul"),$=n("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),x=n("li"),Q=a("having all inputs as a list, tuple or dict in the first positional arguments."),C=l(),z=n("p"),R=a("This second option is useful when using "),S=n("code"),Z=a("tf.keras.Model.fit"),ue=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),A=n("code"),me=a("model(inputs)"),ce=a("."),W=l(),L=n("p"),ee=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),te=l(),F=n("ul"),E=n("li"),se=a("a single Tensor with "),V=n("code"),pe=a("input_ids"),ae=a(" only and nothing else: "),O=n("code"),fe=a("model(inputs_ids)"),he=l(),j=n("li"),ge=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ks=new ze({}),Xs=new H({props:{name:"class transformers.modeling\\_tf\\_outputs.TFSequenceClassifierOutputWithPast",anchor:"transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/modeling_tf_outputs.py#L717",parametersDescription:[{anchor:"transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, )</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),np=l(),v($o.$$.fragment),sp=l(),kn=n("p"),ap=a("This tokenizer inherits from "),za=n("a"),rp=a("PreTrainedTokenizer"),ip=a(` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),lp=l(),Mr=n("div"),Hl=l(),Jt=n("h2"),Mo=n("a"),Gr=n("span"),v(yn.$$.fragment),dp=l(),xr=n("span"),cp=a("GPT2TokenizerFast"),Ll=l(),be=n("div"),v(wn.$$.fragment),pp=l(),Pn=n("p"),hp=a("Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),zr=n("em"),up=a("tokenizers"),mp=a(` library). Based on byte-level
Byte-Pair-Encoding.`),fp=l(),Fr=n("p"),gp=a(`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
...
the model was not pretrained this way, it might yield a decrease in performance.`),yp=l(),v(Go.$$.fragment),wp=l(),Gn=n("p"),Pp=a("This tokenizer inherits from "),Fa=n("a"),$p=a("PreTrainedTokenizerFast"),Mp=a(` which contains most of the main
methods. Users should refer to this superclass for more information regarding those methods.`),Nl=l(),Kt=n("h2"),xo=n("a"),Er=n("span"),v(xn.$$.fragment),Gp=l(),qr=n("span"),xp=a("GPT2 specific outputs"),Il=l(),Xt=n("div"),v(zn.$$.fragment),zp=l(),Cr=n("p"),Fp=a("Base class for outputs of models predicting if two sentences are consecutive or not."),Sl=l(),Yt=n("div"),v(Fn.$$.fragment),jp=l(),Dr=n("p"),Ep=a("Base class for outputs of models predicting if two sentences are consecutive or not."),Al=l(),Qt=n("h2"),zo=n("a"),Hr=n("span"),v(jn.$$.fragment),qp=l(),Lr=n("span"),Cp=a("GPT2Model"),Ol=l(),ke=n("div"),v(En.$$.fragment),Dp=l(),Nr=n("p"),Hp=a("The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),Lp=l(),qn=n("p"),Np=a("This model inherits from "),ja=n("a"),Ip=a("PreTrainedModel"),Sp=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ap=l(),Cn=n("p"),Op=a("This model is also a PyTorch "),Dn=n("a"),Wp=a("torch.nn.Module"),Bp=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Up=l(),Ke=n("div"),v(Hn.$$.fragment),Rp=l(),Zt=n("p"),Vp=a("The "),Ea=n("a"),Jp=a("GPT2Model"),Kp=a(" forward method, overrides the "),Ir=n("code"),Xp=a("__call__"),Yp=a(" special method."),Qp=l(),v(Fo.$$.fragment),Zp=l(),Sr=n("p"),eh=a("Example:"),th=l(),v(Ln.$$.fragment),oh=l(),Xe=n("div"),v(Nn.$$.fragment),nh=l(),Ar=n("p"),sh=a("This is an experimental feature and is a subject to change at a moment\u2019s notice."),ah=l(),Or=n("p"),rh=a(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
...
input sequence).`),nu=l(),ts=n("p"),su=a("This model inherits from "),Da=n("a"),au=a("PreTrainedModel"),ru=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),iu=l(),os=n("p"),lu=a("This model is also a PyTorch "),ns=n("a"),du=a("torch.nn.Module"),cu=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),pu=l(),Ze=n("div"),v(ss.$$.fragment),hu=l(),no=n("p"),uu=a("The "),Ha=n("a"),mu=a("GPT2DoubleHeadsModel"),fu=a(" forward method, overrides the "),ai=n("code"),gu=a("__call__"),_u=a(" special method."),Tu=l(),v(Co.$$.fragment),vu=l(),ri=n("p"),bu=a("Example:"),ku=l(),v(as.$$.fragment),Vl=l(),so=n("h2"),Do=n("a"),ii=n("span"),v(rs.$$.fragment),yu=l(),li=n("span"),wu=a("GPT2ForSequenceClassification"),Jl=l(),we=n("div"),v(is.$$.fragment),Pu=l(),di=n("p"),$u=a("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Mu=l(),La=n("p"),Na=n("a"),Gu=a("GPT2ForSequenceClassification"),xu=a(` uses the last token in order to do the classification, as
other causal models (e.g. GPT-1) do.`),zu=l(),mt=n("p"),Fu=a(`Since it does classification on the last token, it requires to know the position of the last token. If a
`),ci=n("code"),ju=a("pad_token_id"),Eu=a(` is defined in the configuration, it finds the last token that is not a padding token in each
row. If no `),pi=n("code"),qu=a("pad_token_id"),Cu=a(` is defined, it simply takes the last value in each row of the batch. Since it cannot
guess the padding tokens when `),hi=n("code"),Du=a("inputs_embeds"),Hu=a(" are passed instead of "),ui=n("code"),Lu=a("input_ids"),Nu=a(`, it does the same (take
the last value in each row of the batch).`),Iu=l(),ls=n("p"),Su=a("This model inherits from "),Ia=n("a"),Au=a("PreTrainedModel"),Ou=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Wu=l(),ds=n("p"),Bu=a("This model is also a PyTorch "),cs=n("a"),Uu=a("torch.nn.Module"),Ru=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Vu=l(),Ge=n("div"),v(ps.$$.fragment),Ju=l(),ao=n("p"),Ku=a("The "),Sa=n("a"),Xu=a("GPT2ForSequenceClassification"),Yu=a(" forward method, overrides the "),mi=n("code"),Qu=a("__call__"),Zu=a(" special method."),em=l(),v(Ho.$$.fragment),tm=l(),fi=n("p"),om=a("Example of single-label classification:"),nm=l(),v(hs.$$.fragment),sm=l(),gi=n("p"),am=a("Example of multi-label classification:"),rm=l(),v(us.$$.fragment),Kl=l(),ro=n("h2"),Lo=n("a"),_i=n("span"),v(ms.$$.fragment),im=l(),Ti=n("span"),lm=a("GPT2ForTokenClassification"),Xl=l(),Je=n("div"),v(fs.$$.fragment),dm=l(),vi=n("p"),cm=a(`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),pm=l(),gs=n("p"),hm=a("This model inherits from "),Aa=n("a"),um=a("PreTrainedModel"),mm=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),fm=l(),_s=n("p"),gm=a("This model is also a PyTorch "),Ts=n("a"),_m=a("torch.nn.Module"),Tm=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),vm=l(),et=n("div"),v(vs.$$.fragment),bm=l(),io=n("p"),km=a("The "),Oa=n("a"),ym=a("GPT2ForTokenClassification"),wm=a(" forward method, overrides the "),bi=n("code"),Pm=a("__call__"),$m=a(" special method."),Mm=l(),v(No.$$.fragment),Gm=l(),ki=n("p"),xm=a("Example:"),zm=l(),v(bs.$$.fragment),Yl=l(),lo=n("h2"),Io=n("a"),yi=n("span"),v(ks.$$.fragment),Fm=l(),wi=n("span"),jm=a("TFGPT2Model"),Ql=l(),Ce=n("div"),v(ys.$$.fragment),Em=l(),Pi=n("p"),qm=a("The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),Cm=l(),ws=n("p"),Dm=a("This model inherits from "),Wa=n("a"),Hm=a("TFPreTrainedModel"),Lm=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Nm=l(),Ps=n("p"),Im=a("This model is also a "),$s=n("a"),Sm=a("tf.keras.Model"),Am=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Om=l(),v(So.$$.fragment),Wm=l(),tt=n("div"),v(Ms.$$.fragment),Bm=l(),co=n("p"),Um=a("The "),Ba=n("a"),Rm=a("TFGPT2Model"),Vm=a(" forward method, overrides the "),$i=n("code"),Jm=a("__call__"),Km=a(" special method."),Xm=l(),v(Ao.$$.fragment),Ym=l(),Mi=n("p"),Qm=a("Example:"),Zm=l(),v(Gs.$$.fragment),Zl=l(),po=n("h2"),Oo=n("a"),Gi=n("span"),v(xs.$$.fragment),ef=l(),xi=n("span"),tf=a("TFGPT2LMHeadModel"),ed=l(),De=n("div"),v(zs.$$.fragment),of=l(),zi=n("p"),nf=a(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),sf=l(),Fs=n("p"),af=a("This model inherits from "),Ua=n("a"),rf=a("TFPreTrainedModel"),lf=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),df=l(),js=n("p"),cf=a("This model is also a "),Es=n("a"),pf=a("tf.keras.Model"),hf=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
...
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),zf=l(),Ls=n("p"),Ff=a("This model inherits from "),Va=n("a"),jf=a("TFPreTrainedModel"),Ef=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),qf=l(),Ns=n("p"),Cf=a("This model is also a "),Is=n("a"),Df=a("tf.keras.Model"),Hf=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Lf=l(),v(Ro.$$.fragment),Nf=l(),nt=n("div"),v(Ss.$$.fragment),If=l(),mo=n("p"),Sf=a("The "),Ja=n("a"),Af=a("TFGPT2DoubleHeadsModel"),Of=a(" forward method, overrides the "),Di=n("code"),Wf=a("__call__"),Bf=a(" special method."),Uf=l(),v(Vo.$$.fragment),Rf=l(),Hi=n("p"),Vf=a("Examples:"),Jf=l(),v(As.$$.fragment),nd=l(),fo=n("h2"),Jo=n("a"),Li=n("span"),v(Os.$$.fragment),Kf=l(),Ni=n("span"),Xf=a("TFGPT2ForSequenceClassification"),sd=l(),de=n("div"),v(Ws.$$.fragment),Yf=l(),Ii=n("p"),Qf=a("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Zf=l(),Ka=n("p"),Xa=n("a"),eg=a("TFGPT2ForSequenceClassification"),tg=a(` uses the last token in order to do the classification, as
other causal models (e.g. GPT-1) do.`),og=l(),ft=n("p"),ng=a(`Since it does classification on the last token, it requires to know the position of the last token. If a
`),Si=n("code"),sg=a("pad_token_id"),ag=a(` is defined in the configuration, it finds the last token that is not a padding token in each
row. If no `),Ai=n("code"),rg=a("pad_token_id"),ig=a(` is defined, it simply takes the last value in each row of the batch. Since it cannot
guess the padding tokens when `),Oi=n("code"),lg=a("inputs_embeds"),dg=a(" are passed instead of "),Wi=n("code"),cg=a("input_ids"),pg=a(`, it does the same (take
the last value in each row of the batch).`),hg=l(),Bs=n("p"),ug=a("This model inherits from "),Ya=n("a"),mg=a("TFPreTrainedModel"),fg=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),gg=l(),Us=n("p"),_g=a("This model is also a "),Rs=n("a"),Tg=a("tf.keras.Model"),vg=a(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),bg=l(),v(Ko.$$.fragment),kg=l(),st=n("div"),v(Vs.$$.fragment),yg=l(),go=n("p"),wg=a("The "),Qa=n("a"),Pg=a("TFGPT2ForSequenceClassification"),$g=a(" forward method, overrides the "),Bi=n("code"),Mg=a("__call__"),Gg=a(" special method."),xg=l(),v(Xo.$$.fragment),zg=l(),Ui=n("p"),Fg=a("Example:"),jg=l(),v(Js.$$.fragment),ad=l(),_o=n("h2"),Yo=n("a"),Ri=n("span"),v(Ks.$$.fragment),Eg=l(),Vi=n("span"),qg=a("TFSequenceClassifierOutputWithPast"),rd=l(),To=n("div"),v(Xs.$$.fragment),Cg=l(),Ji=n("p"),Dg=a("Base class for outputs of sentence classification models."),id=l(),vo=n("h2"),Qo=n("a"),Ki=n("span"),v(Ys.$$.fragment),Hg=l(),Xi=n("span"),Lg=a("FlaxGPT2Model"),ld=l(),Pe=n("div"),v(Qs.$$.fragment),Ng=l(),Yi=n("p"),Ig=a("The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),Sg=l(),Zs=n("p"),Ag=a("This model inherits from "),Za=n("a"),Og=a("FlaxPreTrainedModel"),Wg=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Bg=l(),ea=n("p"),Ug=a("This model is also a Flax Linen "),ta=n("a"),Rg=a("flax.nn.Module"),Vg=a(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jg=l(),Qi=n("p"),Kg=a("Finally, this model supports inherent JAX features such as:"),Xg=l(),wt=n("ul"),Zi=n("li"),oa=n("a"),Yg=a("Just-In-Time (JIT) compilation"),Qg=l(),el=n("li"),na=n("a"),Zg=a("Automatic Differentiation"),e_=l(),tl=n("li"),sa=n("a"),t_=a("Vectorization"),o_=l(),ol=n("li"),aa=n("a"),n_=a("Parallelization"),s_=l(),at=n("div"),v(ra.$$.fragment),a_=l(),bo=n("p"),r_=a("The "),nl=n("code"),i_=a("FlaxGPT2PreTrainedModel"),l_=a(" forward method, overrides the "),sl=n("code"),d_=a("__call__"),c_=a(" special method."),p_=l(),v(Zo.$$.fragment),h_=l(),al=n("p"),u_=a("Example:"),m_=l(),v(ia.$$.fragment),dd=l(),ko=n("h2"),en=n("a"),rl=n("span"),v(la.$$.fragment),f_=l(),il=n("span"),g_=a("FlaxGPT2LMHeadModel"),cd=l(),$e=n("div"),v(da.$$.fragment),__=l(),ll=n("p"),T_=a(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),v_=l(),ca=n("p"),b_=a("This model inherits from "),er=n("a"),k_=a("FlaxPreTrainedModel"),y_=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),w_=l(),pa=n("p"),P_=a("This model is also a Flax Linen "),ha=n("a"),$_=a("flax.nn.Module"),M_=a(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),G_=l(),dl=n("p"),x_=a("Finally, this model supports inherent JAX features such as:"),z_=l(),Pt=n("ul"),cl=n("li"),ua=n("a"),F_=a("Just-In-Time (JIT) compilation"),j_=l(),pl=n("li"),ma=n("a"),E_=a("Automatic Differentiation"),q_=l(),hl=n("li"),fa=n("a"),C_=a("Vectorization"),D_=l(),ul=n("li"),ga=n("a"),H_=a("Parallelization"),L_=l(),rt=n("div"),v(_a.$$.fragment),N_=l(),yo=n("p"),I_=a("The "),ml=n("code"),S_=a("FlaxGPT2PreTrainedModel"),A_=a(" forward method, overrides the "),fl=n("code"),O_=a("__call__"),W_=a(" special method."),B_=l(),v(tn.$$.fragment),U_=l(),gl=n("p"),R_=a("Example:"),V_=l(),v(Ta.$$.fragment),this.h()},l(o){const m=wb('[data-svelte="svelte-1phssyn"]',document.head);p=s(m,"META",{name:!0,content:!0}),m.forEach(t),M=d(o),f=s(o,"H1",{class:!0});var va=i(f);T=s(va,"A",{id:!0,class:!0,href:!0});var _l=i(T);$=s(_l,"SPAN",{});var Tl=i($);b(_.$$.fragment,Tl),Tl.forEach(t),_l.forEach(t),g=d(va),x=s(va,"SPAN",{});var vl=i(x);Q=r(vl,"OpenAI GPT2"),vl.forEach(t),va.forEach(t),C=d(o),z=s(o,"H2",{class:!0});var ba=i(z);R=s(ba,"A",{id:!0,class:!0,href:!0});var bl=i(R);S=s(bl,"SPAN",{});var kl=i(S);b(Z.$$.fragment,kl),kl.forEach(t),bl.forEach(t),ue=d(ba),A=s(ba,"SPAN",{});var yl=i(A);me=r(yl,"Overview"),yl.forEach(t),ba.forEach(t),ce=d(o),W=s(o,"P",{});var ka=i(W);L=r(ka,"OpenAI GPT-2 model was proposed in "),ee=s(ka,"A",{href:!0,rel:!0});var wl=i(ee);te=r(wl,"Language Models are Unsupervised Multitask Learners"),wl.forEach(t),F=r(ka,` by Alec
Radford, Jeffrey Wu, Rewon Child, David Luan, Dario Amodei and Ilya Sutskever. It\u2019s a causal (unidirectional)
