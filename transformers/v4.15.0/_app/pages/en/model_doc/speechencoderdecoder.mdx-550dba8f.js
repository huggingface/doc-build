...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&#x27;my-model&#x27;</span>, config=encoder_decoder_config)`}}),te=new Ve({props:{name:"from\\_encoder\\_decoder\\_configs",anchor:"transformers.SpeechEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L92",returnDescription:`
...
`}}),ae=new Ve({props:{name:"to\\_dict",anchor:"transformers.SpeechEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L109",returnDescription:`
...
with any pretrained speech autoencoding model as the encoder (`),Oe=s(A,"EM",{});var Ct=d(Oe);Po=r(Ct,"e.g."),Ct.forEach(o),qo=l(A),Ee=s(A,"A",{href:!0});var Pt=d(Ee);zo=r(Pt,"Wav2Vec2"),Pt.forEach(o),Ao=r(A,", "),Se=s(A,"A",{href:!0});var qt=d(Se);Lo=r(qt,"Hubert"),qt.forEach(o),Fo=r(A,") and any pretrained autoregressive model as the decoder."),A.forEach(o),po=l(n),P=s(n,"P",{});var ze=d(P);Io=r(ze,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
Zhou, Wei Li, Peter J. Liu.`),ko.forEach(o),An=l(m),le=s(m,"P",{});var To=d(le);Ln=r(To,"Additionally, in "),he=s(To,"A",{href:!0,rel:!0});var or=d(he);Fn=r(or,"Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),or.forEach(o),In=r(To,` it is shown how leveraging large pretrained speech models for speech
