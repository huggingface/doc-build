...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Y=new Pe({props:{name:"get\\_special\\_tokens\\_mask",anchor:"transformers.BartphoTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/models/bartpho/tokenization_bartpho.py#L209",parametersDescription:[{anchor:"transformers.BartphoTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
adding special tokens. An BARTPho sequence has the following format:`),No.forEach(o),Ut=c(fe),K=n(fe,"UL",{});var Ze=a(K);ce=n(Ze,"LI",{});var po=a(ce);Gt=i(po,"single sequence: "),Ae=n(po,"CODE",{});var Co=a(Ae);Ht=i(Co,"<s> X </s>"),Co.forEach(o),po.forEach(o),Kt=c(Ze),de=n(Ze,"LI",{});var co=a(de);Jt=i(co,"pair of sequences: "),$e=n(co,"CODE",{});var Oo=a($e);Qt=i(Oo,"<s> A </s></s> B </s>"),Oo.forEach(o),co.forEach(o),Ze.forEach(o),fe.forEach(o),Yt=c(u),j=n(u,"DIV",{class:!0});var et=a(j);T(J.$$.fragment,et),Zt=c(et),Ee=n(et,"P",{});var Vo=a(Ee);eo=i(Vo,"Converts a sequence of tokens (strings for sub-words) in a single string."),Vo.forEach(o),et.forEach(o),to=c(u),L=n(u,"DIV",{class:!0});var tt=a(L);T(Q.$$.fragment,tt),oo=c(tt),xe=n(tt,"P",{});var Fo=a(xe);so=i(Fo,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
