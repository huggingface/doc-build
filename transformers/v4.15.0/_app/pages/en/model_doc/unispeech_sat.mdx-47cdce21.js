...
outputs. Read the documentation from `),po=s("a"),ps=a("PretrainedConfig"),hs=a(" for more information."),ms=c(),Io=s("p"),us=a("Example:"),fs=c(),_(Qe.$$.fragment),za=c(),le=s("h2"),xe=s("a"),Bo=s("span"),_(Ye.$$.fragment),gs=c(),Ho=s("span"),_s=a("UniSpeechSat specific outputs"),Da=c(),ce=s("div"),_(Ke.$$.fragment),vs=c(),Ge=s("p"),Ss=a("Output type of "),Xo=s("code"),bs=a("UniSpeechSatBaseModelOutput"),ws=a(", with potential hidden states and attentions."),Oa=c(),de=s("div"),_(et.$$.fragment),ys=c(),tt=s("p"),ks=a("Output type of "),Ro=s("code"),Ts=a("UniSpeechSatForPreTrainingOutput"),Us=a(`, with potential hidden states and
attentions.`),Va=c(),pe=s("h2"),je=s("a"),Zo=s("span"),_(ot.$$.fragment),$s=c(),Jo=s("span"),Fs=a("UniSpeechSatModel"),La=c(),E=s("div"),_(at.$$.fragment),xs=c(),nt=s("p"),js=a(`The bare UniSpeechSat Model transformer outputting raw hidden-states without any specific head on top.
UniSpeechSat was proposed in `),st=s("a"),Cs=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),qs=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Es=c(),rt=s("p"),Ps=a("This model inherits from "),ho=s("a"),As=a("PreTrainedModel"),Ms=a(`. Check the superclass documentation for the generic
...
methods the library implements for all its model (such as downloading or saving etc.).`),ci=c(),Pt=s("p"),di=a("This model is a PyTorch "),At=s("a"),pi=a("torch.nn.Module"),hi=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),mi=c(),V=s("div"),_(Mt.$$.fragment),ui=c(),Se=s("p"),fi=a("The "),So=s("a"),gi=a("UniSpeechSatForAudioFrameClassification"),_i=a(" forward method, overrides the "),pa=s("code"),vi=a("__call__"),Si=a(" special method."),bi=c(),_(ze.$$.fragment),wi=c(),ha=s("p"),yi=a("Example:"),ki=c(),_(zt.$$.fragment),Ra=c(),be=s("h2"),De=s("a"),ma=s("span"),_(Dt.$$.fragment),Ti=c(),ua=s("span"),Ui=a("UniSpeechSatForXVector"),Za=c(),j=s("div"),_(Ot.$$.fragment),$i=c(),fa=s("p"),Fi=a("UniSpeech-SAT Model with an XVector feature extraction head on top for tasks like Speaker Verification."),xi=c(),Vt=s("p"),ji=a("UniSpeechSat was proposed in "),Lt=s("a"),Ci=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),qi=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Ei=c(),Nt=s("p"),Pi=a("This model inherits from "),bo=s("a"),Ai=a("PreTrainedModel"),Mi=a(`. Check the superclass documentation for the generic
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Li=c(),L=s("div"),_(Bt.$$.fragment),Ni=c(),we=s("p"),Wi=a("The "),wo=s("a"),Ii=a("UniSpeechSatForXVector"),Bi=a(" forward method, overrides the "),ga=s("code"),Hi=a("__call__"),Xi=a(" special method."),Ri=c(),_(Oe.$$.fragment),Zi=c(),_a=s("p"),Ji=a("Example:"),Qi=c(),_(Ht.$$.fragment),Ja=c(),ye=s("h2"),Ve=s("a"),va=s("span"),_(Xt.$$.fragment),Yi=c(),Sa=s("span"),Ki=a("UniSpeechSatForPreTraining"),Qa=c(),A=s("div"),_(Rt.$$.fragment),Gi=c(),ke=s("p"),el=a("UniSpeechSat Model with a quantizer and "),ba=s("code"),tl=a("VQ"),ol=a(` head on top.
UniSpeechSat was proposed in `),Zt=s("a"),al=a("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),nl=a(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),sl=c(),Jt=s("p"),rl=a("This model inherits from "),yo=s("a"),il=a("PreTrainedModel"),ll=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),cl=c(),Qt=s("p"),dl=a("This model is a PyTorch "),Yt=s("a"),pl=a("torch.nn.Module"),hl=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ml=c(),N=s("div"),_(Kt.$$.fragment),ul=c(),Te=s("p"),fl=a("The "),ko=s("a"),gl=a("UniSpeechSatForPreTraining"),_l=a(" forward method, overrides the "),wa=s("code"),vl=a("__call__"),Sl=a(" special method."),bl=c(),_(Le.$$.fragment),wl=c(),ya=s("p"),yl=a("Example:"),kl=c(),_(Gt.$$.fragment),this.h()},l(t){const p=ad('[data-svelte="svelte-1phssyn"]',document.head);h=r(p,"META",{name:!0,content:!0}),p.forEach(o),T=d(t),u=r(t,"H1",{class:!0});var eo=i(u);k=r(eo,"A",{id:!0,class:!0,href:!0});var ka=i(k);U=r(ka,"SPAN",{});var Ta=i(U);v(g.$$.fragment,Ta),Ta.forEach(o),ka.forEach(o),f=d(eo),$=r(eo,"SPAN",{});var Ua=i($);Cn=n(Ua,"UniSpeech-SAT"),Ua.forEach(o),eo.forEach(o),Fa=d(t),ne=r(t,"H2",{class:!0});var to=i(ne);Ue=r(to,"A",{id:!0,class:!0,href:!0});var $a=i(Ue);Do=r($a,"SPAN",{});var Tl=i(Do);v(Ne.$$.fragment,Tl),Tl.forEach(o),$a.forEach(o),qn=d(to),Oo=r(to,"SPAN",{});var Ul=i(Oo);En=n(Ul,"Overview"),Ul.forEach(o),to.forEach(o),xa=d(t),$e=r(t,"P",{});var Ka=i($e);Pn=n(Ka,"The UniSpeech-SAT model was proposed in "),We=r(Ka,"A",{href:!0,rel:!0});var $l=i(We);An=n($l,`UniSpeech-SAT: Universal Speech Representation Learning with Speaker Aware
Pre-Training`),$l.forEach(o),Mn=n(Ka,` by Sanyuan Chen, Yu Wu, Chengyi Wang, Zhengyang Chen, Zhuo Chen,
...
found `),Xe=r(Uo,"A",{href:!0,rel:!0});var Ml=i(Xe);Yn=n(Ml,"here"),Ml.forEach(o),Kn=n(Uo,"."),Uo.forEach(o),Aa=d(t),se=r(t,"H2",{class:!0});var tn=i(se);Fe=r(tn,"A",{id:!0,class:!0,href:!0});var zl=i(Fe);No=r(zl,"SPAN",{});var Dl=i(No);v(Re.$$.fragment,Dl),Dl.forEach(o),zl.forEach(o),Gn=d(tn),Wo=r(tn,"SPAN",{});var Ol=i(Wo);es=n(Ol,"UniSpeechSatConfig"),Ol.forEach(o),tn.forEach(o),Ma=d(t),q=r(t,"DIV",{class:!0});var R=i(q);v(Ze.$$.fragment,R),ts=d(R),re=r(R,"P",{});var $o=i(re);os=n($o,"This is the configuration class to store the configuration of a "),lo=r($o,"A",{href:!0});var Vl=i(lo);as=n(Vl,"UniSpeechSatModel"),Vl.forEach(o),ns=n($o,`. It is
used to instantiate an UniSpeechSat model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the UniSpeechSat
`),Je=r($o,"A",{href:!0,rel:!0});var Ll=i(Je);ss=n(Ll,"facebook/unispeech_sat-base-960h"),Ll.forEach(o),rs=n($o," architecture."),$o.forEach(o),is=d(R),ie=r(R,"P",{});var Fo=i(ie);ls=n(Fo,"Configuration objects inherit from "),co=r(Fo,"A",{href:!0});var Nl=i(co);cs=n(Nl,"PretrainedConfig"),Nl.forEach(o),ds=n(Fo,` and can be used to control the model
