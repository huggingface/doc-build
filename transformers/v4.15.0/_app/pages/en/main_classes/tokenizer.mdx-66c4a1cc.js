...
put this inside your training loop.`)},l($){E=a($,"P",{});var P=s(E);C=o(P,`This encodes a dummy input and checks the number of added tokens, and is therefore not efficient. Do not
...
`}}),Dt=new v({props:{name:"get\\_added\\_vocab",anchor:"transformers.PreTrainedTokenizer.get_added_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/tokenization_utils.py#L362",returnDescription:`
...
`,returnType:`
<p><code>int</code> or <code>List[int]</code></p>
`}}),Yt=new v({props:{name:"get\\_added\\_vocab",anchor:"transformers.PreTrainedTokenizerFast.get_added_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/tokenization_utils_fast.py#L153",returnDescription:`
<p>The added tokens.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
...
Rust library `),ft=r("a"),Bi=n("tokenizers"),Fi=n(". The \u201CFast\u201D implementations allows:"),Ps=d(),Se=r("ol"),Bo=r("li"),Ai=n("a significant speed-up in particular when doing batched tokenization and"),Ci=d(),Fo=r("li"),Ni=n(`additional methods to map between the original string (character and words) and the token space (e.g. getting the
...
`),ar=r("code"),tc=n("short-cut-names"),nc=n(` of the pretrained models, and as associated values, the maximum length of the sequence
inputs of this model, or `),sr=r("code"),oc=n("None"),rc=n(" if the model has no maximum input size."),ac=d(),S=r("li"),ir=r("strong"),sc=n("pretrained_init_configuration"),ic=n(" ("),dr=r("code"),dc=n("Dict[str, Dict[str, Any]]"),cc=n(`) \u2014 A dictionary with, as keys, the
...
each vocabulary file required by the model, and as associated values, the filename for saving the associated
file (string).`),ah=d(),W=r("li"),jr=r("strong"),sh=n("pretrained_vocab_files_map"),ih=n(" ("),Vr=r("code"),dh=n("Dict[str, Dict[str, str]]"),ch=n(`) \u2014 A dictionary of dictionaries, with the
...
`),ea=r("code"),Dh=n("short-cut-names"),Ih=n(` of the pretrained models, and as associated values, a dictionary of specific arguments
to pass to the `),ta=r("code"),Lh=n("__init__"),Bh=n(` method of the tokenizer class for this pretrained model when loading the
tokenizer with the `),Vn=r("a"),Fh=n("from_pretrained()"),Ah=n(`
method.`),Ch=d(),Ye=r("li"),na=r("strong"),Nh=n("model_input_names"),Oh=n(" ("),oa=r("code"),Sh=n("List[str]"),Wh=n(") \u2014 A list of inputs expected in the forward pass of the model."),Rh=d(),Q=r("li"),ra=r("strong"),Uh=n("padding_side"),jh=n(" ("),aa=r("code"),Vh=n("str"),Hh=n(`) \u2014 The default value for the side on which the model should have padding
applied. Should be `),sa=r("code"),Mh=n("'right'"),Gh=n(" or "),ia=r("code"),Xh=n("'left'"),Yh=n("."),Jh=d(),Je=r("div"),h(Ot.$$.fragment),Kh=d(),da=r("p"),Qh=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
`),xa=r("code"),Kp=n("batch_encode"),Qp=n(` methods (tokens,
