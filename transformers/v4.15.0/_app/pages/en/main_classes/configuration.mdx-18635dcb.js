...
<a href="/docs/transformers/v4.15.0/en/main_classes/model#transformers.file_utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}]}}),Se=new D({props:{name:"to\\_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/configuration_utils.py#L709",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Fe=new D({props:{name:"to\\_diff\\_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/configuration_utils.py#L677",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Le=new D({props:{name:"to\\_json\\_file",anchor:"transformers.PretrainedConfig.to_json_file",parameters:[{name:"json_file_path",val:": typing.Union[str, os.PathLike]"},{name:"use_diff",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/v4.15.0/src/transformers/configuration_utils.py#L745",parametersDescription:[{anchor:"transformers.PretrainedConfig.to_json_file.json_file_path",description:`<strong>json_file_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`),at=r("code"),Ao=o("vocab_size"),So=o("."),eo=d(),V=r("h2"),R=r("a"),st=r("span"),g(ve.$$.fragment),Fo=d(),it=r("span"),Lo=o("PretrainedConfig"),to=d(),l=r("div"),g(ye.$$.fragment),Io=d(),dt=r("p"),No=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),qo=d(),g(G.$$.fragment),Mo=d(),ct=r("p"),Wo=o("Class attributes (overridden by derived classes):"),Ho=d(),F=r("ul"),M=r("li"),lt=r("strong"),Vo=o("model_type"),Bo=o(" ("),ft=r("code"),Jo=o("str"),Uo=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
the correct object in `),Je=r("a"),Ro=o("AutoConfig"),Go=o("."),Xo=d(),x=r("li"),ht=r("strong"),Ko=o("is_composition"),Qo=o(" ("),mt=r("code"),Yo=o("bool"),Zo=o(`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
...
naming of attributes.`),_n=d(),bt=r("p"),bn=o("Common attributes (present in all subclasses):"),vn=d(),L=r("ul"),Q=r("li"),vt=r("strong"),yn=o("vocab_size"),wn=o(" ("),yt=r("code"),$n=o("int"),kn=o(`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
...
model.`),Sn=d(),ee=r("li"),Ct=r("strong"),Fn=o("num_hidden_layers"),Ln=o(" ("),Et=r("code"),In=o("int"),Nn=o(") \u2014 The number of blocks in the model."),qn=d(),z=r("div"),g(we.$$.fragment),Mn=d(),$e=r("p"),Wn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),xt=r("code"),Hn=o("repo_path_or_name"),Vn=o("."),Bn=d(),Tt=r("p"),Jn=o("Examples:"),Un=d(),g(ke.$$.fragment),Rn=d(),te=r("div"),g(Pe.$$.fragment),Gn=d(),I=r("p"),Xn=o("Checks whether the passed dictionary has a "),Dt=r("em"),Kn=o("torch_dtype"),Qn=o(` key and if it\u2019s not None, converts torch.dtype to a
...
`),Ze=r("a"),Fr=o("from_pretrained()"),Lr=o(" class method."),Ir=d(),ie=r("div"),g(Se.$$.fragment),Nr=d(),Lt=r("p"),qr=o("Serializes this instance to a Python dictionary."),Mr=d(),de=r("div"),g(Fe.$$.fragment),Wr=d(),It=r("p"),Hr=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Vr=d(),ce=r("div"),g(Le.$$.fragment),Br=d(),Nt=r("p"),Jr=o("Save this instance to a JSON file."),Ur=d(),le=r("div"),g(Ie.$$.fragment),Rr=d(),qt=r("p"),Gr=o("Serializes this instance to a JSON string."),Xr=d(),fe=r("div"),g(Ne.$$.fragment),Kr=d(),qe=r("p"),Qr=o("Updates attributes of this class with attributes from "),Mt=r("code"),Yr=o("config_dict"),Zr=o("."),ea=d(),O=r("div"),g(Me.$$.fragment),ta=d(),We=r("p"),oa=o("Updates attributes of this class with attributes from "),Wt=r("code"),na=o("update_str"),ra=o("."),aa=d(),J=r("p"),sa=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),ia=o("true"),da=o(" or "),Vt=r("code"),ca=o("false"),la=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),fa=d(),Bt=r("p"),ha=o("The keys to change have to already exist in the config object."),this.h()},l(i){const k=ws('[data-svelte="svelte-1phssyn"]',document.head);m=a(k,"META",{name:!0,content:!0}),k.forEach(t),C=c(i),u=a(i,"H1",{class:!0});var He=s(u);w=a(He,"A",{id:!0,class:!0,href:!0});var Jt=s(w);j=a(Jt,"SPAN",{});var ma=s(j);p($.$$.fragment,ma),ma.forEach(t),Jt.forEach(t),P=c(He),S=a(He,"SPAN",{});var ua=s(S);$o=n(ua,"Configuration"),ua.forEach(t),He.forEach(t),Yt=c(i),U=a(i,"P",{});var no=s(U);ko=n(no,"The base class "),Be=a(no,"A",{href:!0});var ga=s(Be);Po=n(ga,"PretrainedConfig"),ga.forEach(t),Co=n(no,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
the correct object in `),Je=a(Ve,"A",{href:!0});var xa=s(Je);Ro=n(xa,"AutoConfig"),xa.forEach(t),Go=n(Ve,"."),Ve.forEach(t),Xo=c(he),x=a(he,"LI",{});var q=s(x);ht=a(q,"STRONG",{});var Ta=s(ht);Ko=n(Ta,"is_composition"),Ta.forEach(t),Qo=n(q," ("),mt=a(q,"CODE",{});var Da=s(mt);Yo=n(Da,"bool"),Da.forEach(t),Zo=n(q,`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
config has to be initialized from two or more configs of type `),Ue=a(q,"A",{href:!0});var ja=s(Ue);en=n(ja,"PretrainedConfig"),ja.forEach(t),tn=n(q,` like:
`),Re=a(q,"A",{href:!0});var za=s(Re);on=n(za,"EncoderDecoderConfig"),za.forEach(t),nn=n(q," or "),Ge=a(q,"A",{href:!0});var Oa=s(Ge);rn=n(Oa,"~RagConfig"),Oa.forEach(t),an=n(q,"."),q.forEach(t),sn=c(he),X=a(he,"LI",{});var Ut=s(X);ut=a(Ut,"STRONG",{});var Aa=s(ut);dn=n(Aa,"keys_to_ignore_at_inference"),Aa.forEach(t),cn=n(Ut," ("),gt=a(Ut,"CODE",{});var Sa=s(gt);ln=n(Sa,"List[str]"),Sa.forEach(t),fn=n(Ut,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Ut.forEach(t),hn=c(he),K=a(he,"LI",{});var Rt=s(K);pt=a(Rt,"STRONG",{});var Fa=s(pt);mn=n(Fa,"attribute_map"),Fa.forEach(t),un=n(Rt," ("),_t=a(Rt,"CODE",{});var La=s(_t);gn=n(La,"Dict[str, str]"),La.forEach(t),pn=n(Rt,`) \u2014 A dict that maps model specific attribute names to the standardized
naming of attributes.`),Rt.forEach(t),he.forEach(t),_n=c(f),bt=a(f,"P",{});var Ia=s(bt);bn=n(Ia,"Common attributes (present in all subclasses):"),Ia.forEach(t),vn=c(f),L=a(f,"UL",{});var me=s(L);Q=a(me,"LI",{});var Gt=s(Q);vt=a(Gt,"STRONG",{});var Na=s(vt);yn=n(Na,"vocab_size"),Na.forEach(t),wn=n(Gt," ("),yt=a(Gt,"CODE",{});var qa=s(yt);$n=n(qa,"int"),qa.forEach(t),kn=n(Gt,`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
