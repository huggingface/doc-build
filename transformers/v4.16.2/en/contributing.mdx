...
<h1 id="how-to-contribute-to-transformers">How to contribute to transformers?</h1>
...
<h2 id="you-can-contribute-in-so-many-ways">You can contribute in so many ways!</h2>
...
<h2 id="submitting-a-new-issue-or-feature-request">Submitting a new issue or feature request</h2>

Do your best to follow these guidelines when submitting an issue or a feature
request. It will make it easier for us to come back to you quickly and with good
feedback.

<h3 id="did-you-find-a-bug">Did you find a bug?</h3>
...
<h3 id="do-you-want-to-implement-a-new-model">Do you want to implement a new model?</h3>
...
<h3 id="do-you-want-a-new-feature-that-is-not-a-model">Do you want a new feature (that is not a model)?</h3>
...
<h2 id="start-contributing-pull-requests">Start contributing! (Pull Requests)</h2>
...
5. Add high-coverage tests. No quality testing = no merge.
   ...
   - If you are adding a new tokenizer, write tests, and make sure
     `RUN_SLOW=1 python -m pytest tests/test_tokenization_&amp;lcub;your_model_name}.py` passes.
...
<h3 id="syncing-forked-master-with-upstream-huggingface-master">Syncing forked master with upstream (HuggingFace) master</h3>
