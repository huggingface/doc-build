import{S as Tt,i as Bt,s as $t,e as l,k as h,w as S,t as n,M as At,c as t,d as a,m,a as c,x as q,h as r,b,F as s,g as o,y as D,q as R,o as x,B as L}from"../chunks/vendor-ab4e3193.js";import{T as Ct}from"../chunks/Tip-b5c6375a.js";import{I as ua}from"../chunks/IconCopyLink-d992940d.js";import{C as ba}from"../chunks/CodeBlockFw-bf59baca.js";import{C as Pt}from"../chunks/ColabDropdown-ee6d20de.js";import"../chunks/CopyButton-204b56db.js";function Nt($s){let j,P,_,E,z,T,ls,U;return{c(){j=l("p"),P=n("Hereby, "),_=l("em"),E=n("inference"),z=n(" is defined by a single forward pass, and "),T=l("em"),ls=n("training"),U=n(` is defined by a single forward pass and
...
- gpu_power_watts: <span class="hljs-number">280.0</span>
- gpu_performance_state: <span class="hljs-number">2</span>
- use_tpu: <span class="hljs-literal">False</span>`}}}),bs=new ua({}),ds=new ua({}),{c(){j=l("meta"),P=h(),_=l("h1"),E=l("a"),z=l("span"),S(T.$$.fragment),ls=h(),U=l("span"),V=n("Benchmarks"),B=h(),S(N.$$.fragment),ts=h(),ks=l("p"),da=n("Let\u2019s take a look at how \u{1F917} Transformers models can be benchmarked, best practices, and already available benchmarks."),Se=h(),W=l("p"),fa=n("A notebook explaining in more detail how to benchmark \u{1F917} Transformers models can be found "),cs=l("a"),ja=n("here"),ga=n("."),qe=h(),H=l("h2"),Y=l("a"),As=l("span"),S(ps.$$.fragment),_a=h(),Cs=l("span"),ya=n("How to benchmark \u{1F917} Transformers models"),De=h(),y=l("p"),ka=n("The classes "),Ps=l("code"),Ea=n("PyTorchBenchmark"),va=n("and "),Ns=l("code"),wa=n("TensorFlowBenchmark"),Ta=n("allow to flexibly benchmark \u{1F917} Transformers models. The benchmark classes allow us to measure the "),Fs=l("em"),Ba=n("peak memory usage"),$a=n(" and "),Ms=l("em"),Aa=n("required time"),Ca=n(" for both "),Is=l("em"),Pa=n("inference"),Na=n(" and "),Os=l("em"),Fa=n("training"),Ma=n("."),Re=h(),S(J.$$.fragment),xe=h(),g=l("p"),Ia=n("The benchmark classes "),Ss=l("code"),Oa=n("PyTorchBenchmark"),Sa=n("and "),qs=l("code"),qa=n("TensorFlowBenchmark"),Da=n("expect an object of type "),Ds=l("code"),Ra=n("PyTorchBenchmarkArguments"),xa=n(`and
`),Rs=l("code"),La=n("TensorFlowBenchmarkArguments"),za=n(" respectively, for instantiation. "),xs=l("code"),Ua=n("PyTorchBenchmarkArguments"),Va=n("and "),Ls=l("code"),Ha=n("TensorFlowBenchmarkArguments"),Xa=n("are data classes and contain all relevant configurations for their corresponding benchmark class. In the following example, it is shown how a BERT model of type "),zs=l("em"),Ga=n("bert-base-cased"),Wa=n(" can be benchmarked."),Le=h(),S(os.$$.fragment),ze=h(),i=l("p"),Ya=n("Here, three arguments are given to the benchmark argument data classes, namely "),Us=l("code"),Ja=n("models"),Qa=n(", "),Vs=l("code"),Ka=n("batch_sizes"),Za=n(`, and
...
`),hs=l("a"),tn=n("model hub"),cn=n(" The "),Ws=l("code"),pn=n("list"),on=n(" arguments "),Ys=l("code"),hn=n("batch_sizes"),mn=n(" and "),Js=l("code"),un=n("sequence_lengths"),bn=n(` define
...
out in the third section under `),pe=l("em"),Rn=n("ENVIRONMENT INFORMATION"),xn=n(". This information can optionally be saved in a "),oe=l("em"),Ln=n(".csv"),zn=n(` file
...
configurations must be inserted with the benchmark args as follows.`),We=h(),S(us.$$.fragment),Ye=h(),v=l("p"),tr=n("Again, "),ge=l("em"),cr=n("inference time"),pr=n(" and "),_e=l("em"),or=n("required memory"),hr=n(" for "),ye=l("em"),mr=n("inference"),ir=n(` are measured, but this time for customized configurations
...
available `),js=l("a"),Hr=n("here"),Xr=n("."),aa=h(),es=l("p"),Gr=n("With the new "),Oe=l("em"),Wr=n("benchmark"),Yr=n(" tools, it is easier than ever to share your benchmark results with the community"),na=h(),as=l("ul"),vs=l("li"),gs=l("a"),Jr=n("PyTorch Benchmarking Results"),Qr=n("."),Kr=h(),ws=l("li"),_s=l("a"),Zr=n("TensorFlow Benchmarking Results"),sl=n("."),this.h()},l(e){const p=At('[data-svelte="svelte-1phssyn"]',document.head);j=t(p,"META",{name:!0,content:!0}),p.forEach(a),P=m(e),_=t(e,"H1",{class:!0});var ys=c(_);E=t(ys,"A",{id:!0,class:!0,href:!0});var nl=c(E);z=t(nl,"SPAN",{});var rl=c(z);q(T.$$.fragment,rl),rl.forEach(a),nl.forEach(a),ls=m(ys),U=t(ys,"SPAN",{});var ll=c(U);V=r(ll,"Benchmarks"),ll.forEach(a),ys.forEach(a),B=m(e),q(N.$$.fragment,e),ts=m(e),ks=t(e,"P",{});var tl=c(ks);da=r(tl,"Let\u2019s take a look at how \u{1F917} Transformers models can be benchmarked, best practices, and already available benchmarks."),tl.forEach(a),Se=m(e),W=t(e,"P",{});var la=c(W);fa=r(la,"A notebook explaining in more detail how to benchmark \u{1F917} Transformers models can be found "),cs=t(la,"A",{href:!0,rel:!0});var cl=c(cs);ja=r(cl,"here"),cl.forEach(a),ga=r(la,"."),la.forEach(a),qe=m(e),H=t(e,"H2",{class:!0});var ta=c(H);Y=t(ta,"A",{id:!0,class:!0,href:!0});var pl=c(Y);As=t(pl,"SPAN",{});var ol=c(As);q(ps.$$.fragment,ol),ol.forEach(a),pl.forEach(a),_a=m(ta),Cs=t(ta,"SPAN",{});var hl=c(Cs);ya=r(hl,"How to benchmark \u{1F917} Transformers models"),hl.forEach(a),ta.forEach(a),De=m(e),y=t(e,"P",{});var w=c(y);ka=r(w,"The classes "),Ps=t(w,"CODE",{});var ml=c(Ps);Ea=r(ml,"PyTorchBenchmark"),ml.forEach(a),va=r(w,"and "),Ns=t(w,"CODE",{});var il=c(Ns);wa=r(il,"TensorFlowBenchmark"),il.forEach(a),Ta=r(w,"allow to flexibly benchmark \u{1F917} Transformers models. The benchmark classes allow us to measure the "),Fs=t(w,"EM",{});var ul=c(Fs);Ba=r(ul,"peak memory usage"),ul.forEach(a),$a=r(w," and "),Ms=t(w,"EM",{});var bl=c(Ms);Aa=r(bl,"required time"),bl.forEach(a),Ca=r(w," for both "),Is=t(w,"EM",{});var dl=c(Is);Pa=r(dl,"inference"),dl.forEach(a),Na=r(w," and "),Os=t(w,"EM",{});var fl=c(Os);Fa=r(fl,"training"),fl.forEach(a),Ma=r(w,"."),w.forEach(a),Re=m(e),q(J.$$.fragment,e),xe=m(e),g=t(e,"P",{});var k=c(g);Ia=r(k,"The benchmark classes "),Ss=t(k,"CODE",{});var jl=c(Ss);Oa=r(jl,"PyTorchBenchmark"),jl.forEach(a),Sa=r(k,"and "),qs=t(k,"CODE",{});var gl=c(qs);qa=r(gl,"TensorFlowBenchmark"),gl.forEach(a),Da=r(k,"expect an object of type "),Ds=t(k,"CODE",{});var _l=c(Ds);Ra=r(_l,"PyTorchBenchmarkArguments"),_l.forEach(a),xa=r(k,`and
`),Rs=t(k,"CODE",{});var yl=c(Rs);La=r(yl,"TensorFlowBenchmarkArguments"),yl.forEach(a),za=r(k," respectively, for instantiation. "),xs=t(k,"CODE",{});var kl=c(xs);Ua=r(kl,"PyTorchBenchmarkArguments"),kl.forEach(a),Va=r(k,"and "),Ls=t(k,"CODE",{});var El=c(Ls);Ha=r(El,"TensorFlowBenchmarkArguments"),El.forEach(a),Xa=r(k,"are data classes and contain all relevant configurations for their corresponding benchmark class. In the following example, it is shown how a BERT model of type "),zs=t(k,"EM",{});var vl=c(zs);Ga=r(vl,"bert-base-cased"),vl.forEach(a),Wa=r(k," can be benchmarked."),k.forEach(a),Le=m(e),q(os.$$.fragment,e),ze=m(e),i=t(e,"P",{});var d=c(i);Ya=r(d,"Here, three arguments are given to the benchmark argument data classes, namely "),Us=t(d,"CODE",{});var wl=c(Us);Ja=r(wl,"models"),wl.forEach(a),Qa=r(d,", "),Vs=t(d,"CODE",{});var Tl=c(Vs);Ka=r(Tl,"batch_sizes"),Tl.forEach(a),Za=r(d,`, and
...
`),hs=t(d,"A",{href:!0,rel:!0});var Cl=c(hs);tn=r(Cl,"model hub"),Cl.forEach(a),cn=r(d," The "),Ws=t(d,"CODE",{});var Pl=c(Ws);pn=r(Pl,"list"),Pl.forEach(a),on=r(d," arguments "),Ys=t(d,"CODE",{});var Nl=c(Ys);hn=r(Nl,"batch_sizes"),Nl.forEach(a),mn=r(d," and "),Js=t(d,"CODE",{});var Fl=c(Js);un=r(Fl,"sequence_lengths"),Fl.forEach(a),bn=r(d,` define
...
out in the third section under `),pe=t(f,"EM",{});var Vl=c(pe);Rn=r(Vl,"ENVIRONMENT INFORMATION"),Vl.forEach(a),xn=r(f,". This information can optionally be saved in a "),oe=t(f,"EM",{});var Hl=c(oe);Ln=r(Hl,".csv"),Hl.forEach(a),zn=r(f,` file
...
configurations must be inserted with the benchmark args as follows.`),ns.forEach(a),We=m(e),q(us.$$.fragment,e),Ye=m(e),v=t(e,"P",{});var I=c(v);tr=r(I,"Again, "),ge=t(I,"EM",{});var st=c(ge);cr=r(st,"inference time"),st.forEach(a),pr=r(I," and "),_e=t(I,"EM",{});var et=c(_e);or=r(et,"required memory"),et.forEach(a),hr=r(I," for "),ye=t(I,"EM",{});var at=c(ye);mr=r(at,"inference"),at.forEach(a),ir=r(I,` are measured, but this time for customized configurations
...
should be trained.`),I.forEach(a),Je=m(e),X=t(e,"H2",{class:!0});var pa=c(X);K=t(pa,"A",{id:!0,class:!0,href:!0});var rt=c(K);Ee=t(rt,"SPAN",{});var lt=c(Ee);q(bs.$$.fragment,lt),lt.forEach(a),rt.forEach(a),dr=m(pa),ve=t(pa,"SPAN",{});var tt=c(ve);fr=r(tt,"Benchmark best practices"),tt.forEach(a),pa.forEach(a),Qe=m(e),Es=t(e,"P",{});var ct=c(Es);jr=r(ct,"This section lists a couple of best practices one should be aware of when benchmarking a model."),ct.forEach(a),Ke=m(e),F=t(e,"UL",{});var Ts=c(F);C=t(Ts,"LI",{});var rs=c(C);gr=r(rs,`Currently, only single device benchmarking is supported. When benchmarking on GPU, it is recommended that the user
specifies on which device the code should be run by setting the `),we=t(rs,"CODE",{});var pt=c(we);_r=r(pt,"CUDA_VISIBLE_DEVICES"),pt.forEach(a),yr=r(rs,` environment variable in the
shell, `),Te=t(rs,"EM",{});var ot=c(Te);kr=r(ot,"e.g."),ot.forEach(a),Er=m(rs),Be=t(rs,"CODE",{});var ht=c(Be);vr=r(ht,"export CUDA_VISIBLE_DEVICES=0"),ht.forEach(a),wr=r(rs," before running the code."),rs.forEach(a),Tr=m(Ts),$=t(Ts,"LI",{});var O=c($);Br=r(O,"The option "),$e=t(O,"CODE",{});var mt=c($e);$r=r(mt,"no_multi_processing"),mt.forEach(a),Ar=r(O," should only be set to "),Ae=t(O,"CODE",{});var it=c(Ae);Cr=r(it,"True"),it.forEach(a),Pr=r(O,` for testing and debugging. To ensure accurate
memory measurement it is recommended to run each memory benchmark in a separate process by making sure
...
heavily between different GPU devices, library versions, etc., so that benchmark results on their own are not very
useful for the community.`),dt.forEach(a),Ts.forEach(a),Ze=m(e),G=t(e,"H2",{class:!0});var oa=c(G);Z=t(oa,"A",{id:!0,class:!0,href:!0});var ft=c(Z);Fe=t(ft,"SPAN",{});var jt=c(Fe);q(ds.$$.fragment,jt),jt.forEach(a),ft.forEach(a),qr=m(oa),Me=t(oa,"SPAN",{});var gt=c(Me);Dr=r(gt,"Sharing your benchmark"),gt.forEach(a),oa.forEach(a),sa=m(e),ss=t(e,"P",{});var ha=c(ss);Rr=r(ha,"Previously all available core models (10 at the time) have been benchmarked for "),Ie=t(ha,"EM",{});var _t=c(Ie);xr=r(_t,"inference time"),_t.forEach(a),Lr=r(ha,`, across many different
settings: using PyTorch, with and without TorchScript, using TensorFlow, with and without XLA. All of those tests were
