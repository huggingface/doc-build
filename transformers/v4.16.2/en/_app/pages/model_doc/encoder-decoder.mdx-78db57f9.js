import{S as qi,i as xi,s as ji,e as a,k as i,w as u,t as n,L as $i,c as s,d as o,m as c,a as d,x as g,h as r,b as l,J as e,g as h,y as _,q as v,o as b,B as y}from"../../chunks/vendor-b1433968.js";import{T as dd}from"../../chunks/Tip-c3840994.js";import{D as O}from"../../chunks/Docstring-ff504c58.js";import{C as Me}from"../../chunks/CodeBlock-5eeb61a8.js";import{I as Rt}from"../../chunks/IconCopyLink-7029626d.js";import"../../chunks/CopyButton-40b92840.js";function Pi(Q){let m,q,f,w,P;return{c(){m=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
...
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);q=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,q),e(m,f),e(f,w),e(m,P)},d(k){k&&o(m)}}}function Ai(Q){let m,q,f,w,P,k,T,F,zn,Gt,me,Mn,wo,qn,xn,Ut,he,jn,qe,$n,Pn,Vt,fe,Fn,Eo,Cn,An,Ht,W,Sn,Do,Nn,In,xe,Ln,Bn,Jt,R,On,Qo,Wn,Rn,Xo,Gn,Un,Yt,je,Zt,G,Vn,$e,Hn,Jn,Pe,Yn,Zn,Kt,X,ue,et,Fe,Kn,ot,Qn,Qt,M,Ce,Xn,ge,zo,er,or,Mo,tr,nr,rr,ee,ar,qo,sr,dr,xo,ir,cr,lr,tt,pr,mr,Ae,hr,_e,Se,fr,Ne,ur,jo,gr,_r,vr,ve,Ie,br,oe,yr,nt,kr,Tr,rt,wr,Er,Xt,te,be,at,Le,Dr,st,zr,en,E,Be,Mr,ne,qr,dt,xr,jr,it,$r,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ct,Ir,Lr,Re,Br,$o,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Jr,Yr,lt,Zr,Kr,pt,Qr,Xr,ea,C,Ve,oa,re,ta,Fo,na,ra,mt,aa,sa,da,ye,ia,ht,ca,la,He,pa,A,Je,ma,ft,ha,fa,ae,ua,ut,ga,_a,gt,va,ba,ya,_t,ka,Ta,Ye,on,se,ke,vt,Ze,wa,bt,Ea,tn,D,Ke,Da,de,za,yt,Ma,qa,kt,xa,ja,$a,Qe,Pa,Xe,Fa,Ca,Aa,Tt,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,to,Ra,Ga,Ua,V,Ao,Va,Ha,wt,Ja,Ya,Et,Za,Ka,Qa,S,no,Xa,ie,es,So,os,ts,Dt,ns,rs,as,Te,ss,zt,ds,is,ro,cs,L,ao,ls,Mt,ps,ms,qt,hs,fs,so,nn,ce,we,xt,io,us,jt,gs,rn,z,co,_s,le,vs,$t,bs,ys,Pt,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Ft,qs,xs,mo,js,No,$s,Ps,Fs,ho,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,Ct,Bs,Os,At,Ws,Rs,Gs,N,uo,Us,pe,Vs,Lo,Hs,Js,St,Ys,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,vo,an;return k=new Rt({}),je=new Me({props:{code:`# a workaround to load from pytorch checkpoint
...
`}}),Ie=new O({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2bert&quot;</span>)`}}),Ze=new Rt({}),Ke=new O({props:{name:"class transformers.TFEncoderDecoderModel",anchor:"transformers.TFEncoderDecoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L149",parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),no=new O({props:{name:"call",anchor:"transformers.TFEncoderDecoderModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L457",parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),vo=new Me({props:{code:`from transformers import FlaxEncoderDecoderModel
...
decoder model configuration.`),vr=i(),ve=a("div"),u(Ie.$$.fragment),br=i(),oe=a("p"),yr=n("Serializes this instance to a Python dictionary. Override the default "),nt=a("em"),kr=n("to_dict()"),Tr=n(" from "),rt=a("em"),wr=n("PretrainedConfig"),Er=n("."),Xt=i(),te=a("h2"),be=a("a"),at=a("span"),u(Le.$$.fragment),Dr=i(),st=a("span"),zr=n("EncoderDecoderModel"),en=i(),E=a("div"),u(Be.$$.fragment),Mr=i(),ne=a("p"),qr=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
the model, you need to first set it back in training mode with `),gt=a("code"),va=n("model.train()"),ba=n("."),ya=i(),_t=a("p"),ka=n("Example:"),Ta=i(),u(Ye.$$.fragment),on=i(),se=a("h2"),ke=a("a"),vt=a("span"),u(Ze.$$.fragment),wa=i(),bt=a("span"),Ea=n("TFEncoderDecoderModel"),tn=i(),D=a("div"),u(Ke.$$.fragment),Da=i(),de=a("p"),za=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
checkpoints.`),ms=i(),qt=a("p"),hs=n("Example:"),fs=i(),u(so.$$.fragment),nn=i(),ce=a("h2"),we=a("a"),xt=a("span"),u(io.$$.fragment),us=i(),jt=a("span"),gs=n("FlaxEncoderDecoderModel"),rn=i(),z=a("div"),u(co.$$.fragment),_s=i(),le=a("p"),vs=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),$t=a("code"),bs=n("from_pretrained()"),ys=n("function and the decoder is loaded via "),Pt=a("code"),ks=n("from_pretrained()"),Ts=n(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
checkpoints.`),rd=i(),Lt=a("p"),ad=n("Example:"),sd=i(),u(vo.$$.fragment),this.h()},l(t){const p=$i('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),q=c(t),f=s(t,"H1",{class:!0});var bo=d(f);w=s(bo,"A",{id:!0,class:!0,href:!0});var Bt=d(w);P=s(Bt,"SPAN",{});var Ot=d(P);g(k.$$.fragment,Ot),Ot.forEach(o),Bt.forEach(o),T=c(bo),F=s(bo,"SPAN",{});var id=d(F);zn=r(id,"Encoder Decoder Models"),id.forEach(o),bo.forEach(o),Gt=c(t),me=s(t,"P",{});var sn=d(me);Mn=r(sn,"The "),wo=s(sn,"A",{href:!0});var cd=d(wo);qn=r(cd,"EncoderDecoderModel"),cd.forEach(o),xn=r(sn,` can be used to initialize a sequence-to-sequence model with any
...
decoder model configuration.`),mn.forEach(o),pn.forEach(o),vr=c(I),ve=s(I,"DIV",{class:!0});var hn=d(ve);g(Ie.$$.fragment,hn),br=c(hn),oe=s(hn,"P",{});var Go=d(oe);yr=r(Go,"Serializes this instance to a Python dictionary. Override the default "),nt=s(Go,"EM",{});var Md=d(nt);kr=r(Md,"to_dict()"),Md.forEach(o),Tr=r(Go," from "),rt=s(Go,"EM",{});var qd=d(rt);wr=r(qd,"PretrainedConfig"),qd.forEach(o),Er=r(Go,"."),Go.forEach(o),hn.forEach(o),I.forEach(o),Xt=c(t),te=s(t,"H2",{class:!0});var fn=d(te);be=s(fn,"A",{id:!0,class:!0,href:!0});var xd=d(be);at=s(xd,"SPAN",{});var jd=d(at);g(Le.$$.fragment,jd),jd.forEach(o),xd.forEach(o),Dr=c(fn),st=s(fn,"SPAN",{});var $d=d(st);zr=r($d,"EncoderDecoderModel"),$d.forEach(o),fn.forEach(o),en=c(t),E=s(t,"DIV",{class:!0});var x=d(E);g(Be.$$.fragment,x),Mr=c(x),ne=s(x,"P",{});var Uo=d(ne);qr=r(Uo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
the model, you need to first set it back in training mode with `),gt=s(Ho,"CODE",{});var Vd=d(gt);va=r(Vd,"model.train()"),Vd.forEach(o),ba=r(Ho,"."),Ho.forEach(o),ya=c(Y),_t=s(Y,"P",{});var Hd=d(_t);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=c(Y),g(Ye.$$.fragment,Y),Y.forEach(o),x.forEach(o),on=c(t),se=s(t,"H2",{class:!0});var vn=d(se);ke=s(vn,"A",{id:!0,class:!0,href:!0});var Jd=d(ke);vt=s(Jd,"SPAN",{});var Yd=d(vt);g(Ze.$$.fragment,Yd),Yd.forEach(o),Jd.forEach(o),wa=c(vn),bt=s(vn,"SPAN",{});var Zd=d(bt);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),vn.forEach(o),tn=c(t),D=s(t,"DIV",{class:!0});var j=d(D);g(Ke.$$.fragment,j),Da=c(j),de=s(j,"P",{});var Jo=d(de);za=r(Jo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
generative task, like summarization.`),Jo.forEach(o),$a=c(j),Qe=s(j,"P",{});var bn=d(Qe);Pa=r(bn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Xe=s(bn,"A",{href:!0,rel:!0});var Xd=d(Xe);Fa=r(Xd,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Xd.forEach(o),Ca=r(bn,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),bn.forEach(o),Aa=c(j),Tt=s(j,"P",{});var ei=d(Tt);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
checkpoints.`),ci.forEach(o),ms=c(De),qt=s(De,"P",{});var li=d(qt);hs=r(li,"Example:"),li.forEach(o),fs=c(De),g(so.$$.fragment,De),De.forEach(o),j.forEach(o),nn=c(t),ce=s(t,"H2",{class:!0});var Tn=d(ce);we=s(Tn,"A",{id:!0,class:!0,href:!0});var pi=d(we);xt=s(pi,"SPAN",{});var mi=d(xt);g(io.$$.fragment,mi),mi.forEach(o),pi.forEach(o),us=c(Tn),jt=s(Tn,"SPAN",{});var hi=d(jt);gs=r(hi,"FlaxEncoderDecoderModel"),hi.forEach(o),Tn.forEach(o),rn=c(t),z=s(t,"DIV",{class:!0});var $=d(z);g(co.$$.fragment,$),_s=c($),le=s($,"P",{});var Zo=d(le);vs=r(Zo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),$t=s(Zo,"CODE",{});var fi=d($t);bs=r(fi,"from_pretrained()"),fi.forEach(o),ys=r(Zo,"function and the decoder is loaded via "),Pt=s(Zo,"CODE",{});var ui=d(Pt);ks=r(ui,"from_pretrained()"),ui.forEach(o),Ts=r(Zo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
(see the examples for more information).`),_i.forEach(o),xs=c($),mo=s($,"P",{});var En=d(mo);js=r(En,"This model inherits from "),No=s(En,"A",{href:!0});var vi=d(No);$s=r(vi,"FlaxPreTrainedModel"),vi.forEach(o),Ps=r(En,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),En.forEach(o),Fs=c($),ho=s($,"P",{});var Dn=d(ho);Cs=r(Dn,`This model is also a Flax Linen
`),fo=s(Dn,"A",{href:!0,rel:!0});var bi=d(fo);As=r(bi,"flax.nn.Module"),bi.forEach(o),Ss=r(Dn,` subclass. Use it as a
