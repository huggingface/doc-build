import{S as eT,i as tT,s as oT,e as r,k as c,w as v,t,M as nT,c as s,d as n,m as l,a,x as b,h as o,b as i,F as e,g as _,y as T,q as w,o as k,B as q}from"../../chunks/vendor-ab4e3193.js";import{T as ge}from"../../chunks/Tip-b5c6375a.js";import{D as M}from"../../chunks/Docstring-b69c0bd4.js";import{C as rn}from"../../chunks/CodeBlock-516df0c5.js";import{I as _e}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function rT($){let h,y,u,f,x;return{c(){h=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),f=t("Module"),x=t(`
...
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var p=a(h);y=o(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(p,"CODE",{});var R=a(u);f=o(R,"Module"),R.forEach(n),x=o(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(n)},m(g,p){_(g,h,p),e(h,y),e(h,u),e(u,f),e(h,x)},d(g){g&&n(h)}}}function _T($){let h,y,u,f,x,g,p,R,Zd,La,$e,tt,Rr,Ct,ei,Fr,ti,Ia,sn,oi,Oa,ot,ni,St,ri,si,Wa,an,ai,Ha,dn,zr,di,Ba,nt,ii,Dt,ci,li,Qa,Ee,rt,$r,Lt,hi,Er,pi,Va,de,It,ui,me,cn,mi,gi,jr,_i,fi,ln,vi,bi,hn,Ti,wi,ki,st,Ot,qi,Wt,yi,pn,xi,Ri,Fi,at,Ht,zi,Bt,$i,un,Ei,ji,Ua,je,dt,Mr,Qt,Mi,Gr,Gi,Ka,Vt,it,Ut,Ai,Ar,Pi,Ya,Me,ct,Pr,Kt,Ni,Nr,Ci,Ja,Ge,Yt,Si,Cr,Di,Xa,Jt,Xt,Za,Ae,lt,Sr,Zt,Li,Dr,Ii,ed,X,eo,Oi,Lr,Wi,Hi,Ir,Bi,Qi,to,Vi,ht,oo,Ui,Or,Ki,Yi,pt,no,Ji,Pe,Xi,Wr,Zi,ec,Hr,tc,oc,nc,ut,ro,rc,so,sc,Br,ac,dc,td,Ne,mt,Qr,ao,ic,Vr,cc,od,D,io,lc,Ce,hc,mn,pc,uc,Ur,mc,gc,_c,gt,fc,Kr,vc,bc,ie,Tc,Yr,wc,kc,gn,qc,yc,Jr,xc,Rc,_n,Fc,zc,$c,G,Ec,fn,jc,Mc,Xr,Gc,Ac,Zr,Pc,Nc,es,Cc,Sc,ts,Dc,Lc,vn,Ic,Oc,os,Wc,Hc,bn,Bc,Qc,Tn,Vc,Uc,ns,Kc,Yc,Jc,co,Xc,wn,Zc,el,tl,lo,ol,ho,nl,rl,sl,ee,po,al,Se,dl,kn,il,cl,rs,ll,hl,pl,_t,ul,ss,ml,gl,uo,nd,De,ft,as,mo,_l,ds,fl,rd,E,go,vl,Le,bl,qn,Tl,wl,is,kl,ql,yl,vt,xl,cs,Rl,Fl,ls,zl,$l,ce,El,hs,jl,Ml,yn,Gl,Al,ps,Pl,Nl,xn,Cl,Sl,Dl,A,Ll,Rn,Il,Ol,us,Wl,Hl,ms,Bl,Ql,gs,Vl,Ul,_s,Kl,Yl,Fn,Jl,Xl,fs,Zl,eh,zn,th,oh,$n,nh,rh,vs,sh,ah,dh,_o,ih,En,ch,lh,hh,fo,ph,vo,uh,mh,gh,te,bo,_h,Ie,fh,jn,vh,bh,bs,Th,wh,kh,bt,qh,Ts,yh,xh,To,Rh,Tt,wo,Fh,ko,zh,Mn,$h,Eh,sd,Oe,wt,ws,qo,jh,ks,Mh,ad,j,yo,Gh,We,Ah,Gn,Ph,Nh,qs,Ch,Sh,Dh,kt,Lh,ys,Ih,Oh,xs,Wh,Hh,le,Bh,Rs,Qh,Vh,An,Uh,Kh,Fs,Yh,Jh,Pn,Xh,Zh,ep,P,tp,Nn,op,np,zs,rp,sp,$s,ap,dp,Es,ip,cp,js,lp,hp,Cn,pp,up,Ms,mp,gp,Sn,_p,fp,Dn,vp,bp,Gs,Tp,wp,kp,xo,qp,Ln,yp,xp,Rp,Ro,Fp,Fo,zp,$p,Ep,oe,zo,jp,He,Mp,In,Gp,Ap,As,Pp,Np,Cp,qt,Sp,Ps,Dp,Lp,$o,Ip,yt,Eo,Op,Ns,Wp,dd,Be,xt,Cs,jo,Hp,Ss,Bp,id,N,Mo,Qp,Qe,Vp,On,Up,Kp,Ds,Yp,Jp,Xp,Rt,Zp,Ls,eu,tu,he,ou,Is,nu,ru,Wn,su,au,Os,du,iu,Hn,cu,lu,hu,L,pu,Bn,uu,mu,Ws,gu,_u,Hs,fu,vu,Bs,bu,Tu,Qs,wu,ku,Qn,qu,yu,Vs,xu,Ru,Vn,Fu,zu,Us,$u,Eu,ju,Go,Mu,Un,Gu,Au,Pu,Ao,Nu,Po,Cu,Su,Du,Ks,Lu,Iu,ne,No,Ou,Ve,Wu,Kn,Hu,Bu,Ys,Qu,Vu,Uu,Ft,Ku,Js,Yu,Ju,Co,cd,Ue,zt,Xs,So,Xu,Zs,Zu,ld,F,Do,em,Ke,tm,Yn,om,nm,ea,rm,sm,am,$t,dm,ta,im,cm,oa,lm,hm,pe,pm,na,um,mm,Jn,gm,_m,ra,fm,vm,Xn,bm,Tm,wm,I,km,Zn,qm,ym,sa,xm,Rm,aa,Fm,zm,da,$m,Em,ia,jm,Mm,er,Gm,Am,ca,Pm,Nm,tr,Cm,Sm,la,Dm,Lm,Im,Lo,Om,or,Wm,Hm,Bm,Io,Qm,Oo,Vm,Um,Km,ha,Ym,Jm,re,Wo,Xm,Ye,Zm,nr,eg,tg,pa,og,ng,rg,Et,sg,ua,ag,dg,Ho,ig,jt,Bo,cg,Qo,lg,rr,hg,pg,hd,Je,Mt,ma,Vo,ug,ga,mg,pd,z,Uo,gg,Xe,_g,sr,fg,vg,_a,bg,Tg,wg,Gt,kg,fa,qg,yg,va,xg,Rg,ue,Fg,ba,zg,$g,ar,Eg,jg,Ta,Mg,Gg,dr,Ag,Pg,Ng,O,Cg,ir,Sg,Dg,wa,Lg,Ig,ka,Og,Wg,qa,Hg,Bg,ya,Qg,Vg,cr,Ug,Kg,xa,Yg,Jg,lr,Xg,Zg,Ra,e_,t_,o_,Ko,n_,hr,r_,s_,a_,Yo,d_,Jo,i_,c_,l_,Fa,h_,p_,se,Xo,u_,Ze,m_,pr,g_,__,za,f_,v_,b_,At,T_,$a,w_,k_,Zo,q_,Pt,en,y_,Ea,x_,ud;return g=new _e({}),Ct=new _e({}),Lt=new _e({}),It=new M({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
`}}),Ht=new M({props:{name:"to_dict",anchor:"transformers.RagConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/rag/configuration_rag.py#L183",returnDescription:`
...
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),$l=c(),ce=r("p"),El=t("The question encoder can be any "),hs=r("em"),jl=t("autoencoding"),Ml=t(" model, preferably "),yn=r("a"),Gl=t("DPRQuestionEncoder"),Al=t(`, and the generator can be
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gh=c(),te=r("div"),v(bo.$$.fragment),_h=c(),Ie=r("p"),fh=t("The "),jn=r("a"),vh=t("RagSequenceForGeneration"),bh=t(" forward method, overrides the "),bs=r("code"),Th=t("__call__"),wh=t(" special method."),kh=c(),v(bt.$$.fragment),qh=c(),Ts=r("p"),yh=t("Example:"),xh=c(),v(To.$$.fragment),Rh=c(),Tt=r("div"),v(wo.$$.fragment),Fh=c(),ko=r("p"),zh=t("Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Mn=r("a"),$h=t("generate()"),Eh=t("`\ndocumentation for more information on how to set other generate input parameters."),sd=c(),Oe=r("h2"),wt=r("a"),ws=r("span"),v(qo.$$.fragment),jh=c(),ks=r("span"),Mh=t("RagTokenForGeneration"),ad=c(),j=r("div"),v(yo.$$.fragment),Gh=c(),We=r("p"),Ah=t("The "),Gn=r("a"),Ph=t("RagTokenForGeneration"),Nh=t(" forward method, overrides the "),qs=r("code"),Ch=t("__call__"),Sh=t(" special method."),Dh=c(),v(kt.$$.fragment),Lh=c(),ys=r("p"),Ih=t("A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Oh=c(),xs=r("p"),Wh=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
It has been tested with `),Cn=r("a"),pp=t("DPRQuestionEncoder"),up=t(" as the "),Ms=r("code"),mp=t("question_encoder"),gp=t(" and "),Sn=r("a"),_p=t("BartForConditionalGeneration"),fp=t(` or
`),Dn=r("a"),vp=t("T5ForConditionalGeneration"),bp=t(" as the "),Gs=r("code"),Tp=t("generator"),wp=t("."),kp=c(),xo=r("p"),qp=t("This model inherits from "),Ln=r("a"),yp=t("PreTrainedModel"),xp=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp=c(),Ro=r("p"),Fp=t("This model is also a PyTorch "),Fo=r("a"),zp=t("torch.nn.Module"),$p=t(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ep=c(),oe=r("div"),v(zo.$$.fragment),jp=c(),He=r("p"),Mp=t("The "),In=r("a"),Gp=t("RagTokenForGeneration"),Ap=t(" forward method, overrides the "),As=r("code"),Pp=t("__call__"),Np=t(" special method."),Cp=c(),v(qt.$$.fragment),Sp=c(),Ps=r("p"),Dp=t("Example:"),Lp=c(),v($o.$$.fragment),Ip=c(),yt=r("div"),v(Eo.$$.fragment),Op=c(),Ns=r("p"),Wp=t("Implements RAG token decoding."),dd=c(),Be=r("h2"),xt=r("a"),Cs=r("span"),v(jo.$$.fragment),Hp=c(),Ss=r("span"),Bp=t("TFRagModel"),id=c(),N=r("div"),v(Mo.$$.fragment),Qp=c(),Qe=r("p"),Vp=t("The "),On=r("a"),Up=t("TFRagModel"),Kp=t(" forward method, overrides the "),Ds=r("code"),Yp=t("__call__"),Jp=t(" special method."),Xp=c(),v(Rt.$$.fragment),Zp=c(),Ls=r("p"),eu=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
any `),Jr=s(fe,"EM",{});var pf=a(Jr);xc=o(pf,"seq2seq"),pf.forEach(n),Rc=o(fe," model, preferably "),_n=s(fe,"A",{href:!0});var uf=a(_n);Fc=o(uf,"BartForConditionalGeneration"),uf.forEach(n),zc=o(fe,"."),fe.forEach(n),$c=l(Z),G=s(Z,"P",{});var W=a(G);Ec=o(W,"The model can be initialized with a "),fn=s(W,"A",{href:!0});var mf=a(fn);jc=o(mf,"RagRetriever"),mf.forEach(n),Mc=o(W,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
`),$n=s(B,"A",{href:!0});var Uf=a($n);nh=o(Uf,"T5ForConditionalGeneration"),Uf.forEach(n),rh=o(B," as the "),vs=s(B,"CODE",{});var Kf=a(vs);sh=o(Kf,"generator"),Kf.forEach(n),ah=o(B,"."),B.forEach(n),dh=l(H),_o=s(H,"P",{});var Gd=a(_o);ih=o(Gd,"This model inherits from "),En=s(Gd,"A",{href:!0});var Yf=a(En);ch=o(Yf,"PreTrainedModel"),Yf.forEach(n),lh=o(Gd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gd.forEach(n),hh=l(H),fo=s(H,"P",{});var Ad=a(fo);ph=o(Ad,"This model is also a PyTorch "),vo=s(Ad,"A",{href:!0,rel:!0});var Jf=a(vo);uh=o(Jf,"torch.nn.Module"),Jf.forEach(n),mh=o(Ad,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ad.forEach(n),gh=l(H),te=s(H,"DIV",{class:!0});var Te=a(te);b(bo.$$.fragment,Te),_h=l(Te),Ie=s(Te,"P",{});var fr=a(Ie);fh=o(fr,"The "),jn=s(fr,"A",{href:!0});var Xf=a(jn);vh=o(Xf,"RagSequenceForGeneration"),Xf.forEach(n),bh=o(fr," forward method, overrides the "),bs=s(fr,"CODE",{});var Zf=a(bs);Th=o(Zf,"__call__"),Zf.forEach(n),wh=o(fr," special method."),fr.forEach(n),kh=l(Te),b(bt.$$.fragment,Te),qh=l(Te),Ts=s(Te,"P",{});var ev=a(Ts);yh=o(ev,"Example:"),ev.forEach(n),xh=l(Te),b(To.$$.fragment,Te),Te.forEach(n),Rh=l(H),Tt=s(H,"DIV",{class:!0});var Pd=a(Tt);b(wo.$$.fragment,Pd),Fh=l(Pd),ko=s(Pd,"P",{});var Nd=a(ko);zh=o(Nd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Mn=s(Nd,"A",{href:!0});var tv=a(Mn);$h=o(tv,"generate()"),tv.forEach(n),Eh=o(Nd,"`\ndocumentation for more information on how to set other generate input parameters."),Nd.forEach(n),Pd.forEach(n),H.forEach(n),sd=l(d),Oe=s(d,"H2",{class:!0});var Cd=a(Oe);wt=s(Cd,"A",{id:!0,class:!0,href:!0});var ov=a(wt);ws=s(ov,"SPAN",{});var nv=a(ws);b(qo.$$.fragment,nv),nv.forEach(n),ov.forEach(n),jh=l(Cd),ks=s(Cd,"SPAN",{});var rv=a(ks);Mh=o(rv,"RagTokenForGeneration"),rv.forEach(n),Cd.forEach(n),ad=l(d),j=s(d,"DIV",{class:!0});var Q=a(j);b(yo.$$.fragment,Q),Gh=l(Q),We=s(Q,"P",{});var vr=a(We);Ah=o(vr,"The "),Gn=s(vr,"A",{href:!0});var sv=a(Gn);Ph=o(sv,"RagTokenForGeneration"),sv.forEach(n),Nh=o(vr," forward method, overrides the "),qs=s(vr,"CODE",{});var av=a(qs);Ch=o(av,"__call__"),av.forEach(n),Sh=o(vr," special method."),vr.forEach(n),Dh=l(Q),b(kt.$$.fragment,Q),Lh=l(Q),ys=s(Q,"P",{});var dv=a(ys);Ih=o(dv,"A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),dv.forEach(n),Oh=l(Q),xs=s(Q,"P",{});var iv=a(xs);Wh=o(iv,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
It has been tested with `),Cn=s(V,"A",{href:!0});var vv=a(Cn);pp=o(vv,"DPRQuestionEncoder"),vv.forEach(n),up=o(V," as the "),Ms=s(V,"CODE",{});var bv=a(Ms);mp=o(bv,"question_encoder"),bv.forEach(n),gp=o(V," and "),Sn=s(V,"A",{href:!0});var Tv=a(Sn);_p=o(Tv,"BartForConditionalGeneration"),Tv.forEach(n),fp=o(V,` or
`),Dn=s(V,"A",{href:!0});var wv=a(Dn);vp=o(wv,"T5ForConditionalGeneration"),wv.forEach(n),bp=o(V," as the "),Gs=s(V,"CODE",{});var kv=a(Gs);Tp=o(kv,"generator"),kv.forEach(n),wp=o(V,"."),V.forEach(n),kp=l(Q),xo=s(Q,"P",{});var Sd=a(xo);qp=o(Sd,"This model inherits from "),Ln=s(Sd,"A",{href:!0});var qv=a(Ln);yp=o(qv,"PreTrainedModel"),qv.forEach(n),xp=o(Sd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd.forEach(n),Ep=l(Q),oe=s(Q,"DIV",{class:!0});var ke=a(oe);b(zo.$$.fragment,ke),jp=l(ke),He=s(ke,"P",{});var br=a(He);Mp=o(br,"The "),In=s(br,"A",{href:!0});var xv=a(In);Gp=o(xv,"RagTokenForGeneration"),xv.forEach(n),Ap=o(br," forward method, overrides the "),As=s(br,"CODE",{});var Rv=a(As);Pp=o(Rv,"__call__"),Rv.forEach(n),Np=o(br," special method."),br.forEach(n),Cp=l(ke),b(qt.$$.fragment,ke),Sp=l(ke),Ps=s(ke,"P",{});var Fv=a(Ps);Dp=o(Fv,"Example:"),Fv.forEach(n),Lp=l(ke),b($o.$$.fragment,ke),ke.forEach(n),Ip=l(Q),yt=s(Q,"DIV",{class:!0});var Ld=a(yt);b(Eo.$$.fragment,Ld),Op=l(Ld),Ns=s(Ld,"P",{});var zv=a(Ns);Wp=o(zv,"Implements RAG token decoding."),zv.forEach(n),Ld.forEach(n),Q.forEach(n),dd=l(d),Be=s(d,"H2",{class:!0});var Id=a(Be);xt=s(Id,"A",{id:!0,class:!0,href:!0});var $v=a(xt);Cs=s($v,"SPAN",{});var Ev=a(Cs);b(jo.$$.fragment,Ev),Ev.forEach(n),$v.forEach(n),Hp=l(Id),Ss=s(Id,"SPAN",{});var jv=a(Ss);Bp=o(jv,"TFRagModel"),jv.forEach(n),Id.forEach(n),id=l(d),N=s(d,"DIV",{class:!0});var U=a(N);b(Mo.$$.fragment,U),Qp=l(U),Qe=s(U,"P",{});var Tr=a(Qe);Vp=o(Tr,"The "),On=s(Tr,"A",{href:!0});var Mv=a(On);Up=o(Mv,"TFRagModel"),Mv.forEach(n),Kp=o(Tr," forward method, overrides the "),Ds=s(Tr,"CODE",{});var Gv=a(Ds);Yp=o(Gv,"__call__"),Gv.forEach(n),Jp=o(Tr," special method."),Tr.forEach(n),Xp=l(U),b(Rt.$$.fragment,U),Zp=l(U),Ls=s(U,"P",{});var Av=a(Ls);eu=o(Av,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
