import{S as z_,i as E_,s as q_,e as n,k as l,w as M,t as a,M as C_,c as s,d as t,m as d,a as r,x as b,h as i,b as h,F as e,g as m,y as w,q as P,o as N,B as $}from"../../chunks/vendor-ab4e3193.js";import{T as Ne}from"../../chunks/Tip-b5c6375a.js";import{D as ne}from"../../chunks/Docstring-91f1beab.js";import{C as Ye}from"../../chunks/CodeBlock-516df0c5.js";import{I as xe}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function x_(Q){let p,y,f,g,k;return{c(){p=n("p"),y=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=a("Module"),k=a(`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bo=new Ne({props:{$$slots:{default:[S_]},$$scope:{ctx:Q}}}),Jn=new ne({props:{name:"call",anchor:"transformers.TFMPNetModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/mpnet/modeling_tf_mpnet.py#L683",parametersDescription:[{anchor:"transformers.TFMPNetModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vh=l(),Kn=n("p"),kh=a("This model is also a "),Xn=n("a"),Th=a("tf.keras.Model"),Mh=a(` subclass. Use it
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vm=l(),M(Fo.$$.fragment),km=l(),Ve=n("div"),M(ps.$$.fragment),Tm=l(),Kt=n("p"),Mm=a("The "),ir=n("a"),bm=a("TFMPNetForSequenceClassification"),wm=a(" forward method, overrides the "),La=n("code"),Pm=a("__call__"),Nm=a(" special method."),$m=l(),M(zo.$$.fragment),ym=l(),Aa=n("p"),Fm=a("Example:"),zm=l(),M(hs.$$.fragment),Ai=l(),Xt=n("h2"),Eo=n("a"),Ia=n("span"),M(ms.$$.fragment),Em=l(),Da=n("span"),qm=a("TFMPNetForMultipleChoice"),Ii=l(),Ee=n("div"),M(us.$$.fragment),Cm=l(),Sa=n("p"),xm=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qm=l(),M(qo.$$.fragment),Bm=l(),Ke=n("div"),M(vs.$$.fragment),Hm=l(),Jt=n("p"),Rm=a("The "),dr=n("a"),Um=a("TFMPNetForMultipleChoice"),Vm=a(" forward method, overrides the "),Oa=n("code"),Km=a("__call__"),Xm=a(" special method."),Jm=l(),M(Co.$$.fragment),Gm=l(),Wa=n("p"),Ym=a("Example:"),Zm=l(),M(ks.$$.fragment),Di=l(),Gt=n("h2"),xo=n("a"),Qa=n("span"),M(Ts.$$.fragment),eu=l(),Ba=n("span"),tu=a("TFMPNetForTokenClassification"),Si=l(),qe=n("div"),M(Ms.$$.fragment),ou=l(),Ha=n("p"),nu=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),al.forEach(t),yc=d(ut),kn=s(ut,"P",{});var il=r(kn);Fc=i(il,"This model is also a PyTorch "),Tn=s(il,"A",{href:!0,rel:!0});var Xf=r(Tn);zc=i(Xf,"torch.nn.Module"),Xf.forEach(t),Ec=i(il,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fl.forEach(t),Xp=d(kt),Wn=s(kt,"P",{});var gl=r(Wn);Jp=i(gl,"This model is also a PyTorch "),Qn=s(gl,"A",{href:!0,rel:!0});var Pg=r(Qn);Gp=i(Pg,"torch.nn.Module"),Pg.forEach(t),Yp=i(gl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
