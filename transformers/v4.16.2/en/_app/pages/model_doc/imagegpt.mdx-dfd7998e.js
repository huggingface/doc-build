import{S as Ic,i as yc,s as wc,e as a,k as l,w as v,t as r,M as Pc,c as n,d as t,m as d,a as s,x as T,h as i,b as c,N as kc,F as e,g as h,y as b,q as I,o as y,B as w}from"../../chunks/vendor-ab4e3193.js";import{T as cn}from"../../chunks/Tip-b5c6375a.js";import{D as be}from"../../chunks/Docstring-b69c0bd4.js";import{C as mn}from"../../chunks/CodeBlock-516df0c5.js";import{I as kt}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Gc(ee){let p,P;return{c(){p=a("p"),P=r(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
the latter silently ignores them.`)},l(f){p=n(f,"P",{});var _=s(p);P=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(_,"CODE",{});var L=s(g);u=i(L,"Module"),L.forEach(t),k=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(f,_){h(f,p,_),e(p,P),e(p,g),e(g,u),e(p,k)},d(f){f&&t(p)}}}function Fc(ee){let p,P,g,u,k,f,_,L,hn,Ia,ce,Ie,Jt,De,pn,Xt,gn,ya,ye,un,Ne,fn,_n,wa,Gt,vn,Pa,xt,Qt,Tn,ka,we,Tl,Ga,Et,bn,xa,H,In,Le,yn,wn,Se,Pn,kn,Oe,Gn,xn,Ea,$t,En,$a,G,We,$n,Re,Fn,Cn,Mn,He,zn,Ft,jn,qn,An,Be,Dn,Ct,Nn,Ln,Sn,Ve,On,Kt,Wn,Rn,Hn,Ue,Bn,Mt,Vn,Un,Jn,Yt,Xn,Fa,Pe,Zt,x,eo,to,Qn,Kn,oo,ao,Yn,Zn,no,so,es,ts,ro,io,os,as,lo,co,ns,ss,mo,ho,rs,is,E,$,po,ls,ds,go,cs,ms,uo,hs,ps,fo,gs,us,_o,fs,_s,vo,vs,Ts,F,To,bs,Is,bo,ys,ws,Io,Ps,ks,yo,Gs,xs,wo,Es,$s,Po,Fs,Cs,C,ko,Ms,zs,Go,js,qs,xo,As,Ds,Eo,Ns,Ls,$o,Ss,Os,Fo,Ws,Rs,M,Co,Hs,Bs,Mo,Vs,Us,zo,Js,Xs,jo,Qs,Ks,qo,Ys,Zs,Ao,er,tr,z,Do,or,ar,No,nr,sr,Lo,rr,ir,So,lr,dr,Oo,cr,mr,Wo,hr,pr,j,Ro,gr,ur,Ho,fr,_r,Bo,vr,Tr,Vo,br,Ir,Uo,yr,wr,Jo,Pr,Ca,me,ke,Xo,Je,kr,Qo,Gr,Ma,q,Xe,xr,te,Er,zt,$r,Fr,Ko,Cr,Mr,Qe,zr,jr,qr,he,Ar,jt,Dr,Nr,qt,Lr,Sr,Or,Yo,Wr,Rr,Ke,za,pe,Ge,Zo,Ye,Hr,ea,Br,ja,R,Ze,Vr,ta,Ur,Jr,et,Xr,oa,Qr,Kr,Yr,oe,tt,Zr,aa,ei,ti,xe,qa,ge,Ee,na,ot,oi,sa,ai,Aa,A,at,ni,ra,si,ri,nt,ii,At,li,di,ci,st,mi,rt,hi,pi,gi,S,it,ui,ue,fi,Dt,_i,vi,ia,Ti,bi,Ii,$e,yi,la,wi,Pi,lt,Da,fe,Fe,da,dt,ki,ca,Gi,Na,D,ct,xi,ma,Ei,$i,mt,Fi,Nt,Ci,Mi,zi,ht,ji,pt,qi,Ai,Di,O,gt,Ni,_e,Li,Lt,Si,Oi,ha,Wi,Ri,Hi,Ce,Bi,pa,Vi,Ui,ut,La,ve,Me,ga,ft,Ji,ua,Xi,Sa,N,_t,Qi,vt,Ki,St,Yi,Zi,el,Tt,tl,Ot,ol,al,nl,bt,sl,It,rl,il,ll,W,yt,dl,Te,cl,Wt,ml,hl,fa,pl,gl,ul,ze,fl,_a,_l,vl,wt,Oa;return f=new kt({}),De=new kt({}),Je=new kt({}),Xe=new be({props:{name:"class transformers.ImageGPTConfig",anchor:"transformers.ImageGPTConfig",parameters:[{name:"vocab_size",val:" = 513"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 512"},{name:"n_layer",val:" = 24"},{name:"n_head",val:" = 8"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'quick_gelu'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"tie_word_embeddings",val:" = False"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/imagegpt/configuration_imagegpt.py#L30",parametersDescription:[{anchor:"transformers.ImageGPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
<p><a
  href="/docs/transformers/v4.16.2/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a></p>
`}}),xe=new cn({props:{warning:"&lcub;true}",$$slots:{default:[Gc]},$$scope:{ctx:ee}}}),ot=new kt({}),at=new be({props:{name:"class transformers.ImageGPTModel",anchor:"transformers.ImageGPTModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/imagegpt/modeling_imagegpt.py#L620",parametersDescription:[{anchor:"transformers.ImageGPTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/imagegpt#transformers.ImageGPTConfig">ImageGPTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),it=new be({props:{name:"forward",anchor:"transformers.ImageGPTModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/imagegpt/modeling_imagegpt.py#L655",parametersDescription:[{anchor:"transformers.ImageGPTModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.16.2/en/model_doc/imagegpt#transformers.ImageGPTConfig"
...
<span class="hljs-meta">... </span>    ax.imshow(img)`}}),ft=new kt({}),_t=new be({props:{name:"class transformers.ImageGPTForImageClassification",anchor:"transformers.ImageGPTForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/imagegpt/modeling_imagegpt.py#L1088",parametersDescription:[{anchor:"transformers.ImageGPTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/imagegpt#transformers.ImageGPTConfig">ImageGPTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yt=new be({props:{name:"forward",anchor:"transformers.ImageGPTForImageClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/imagegpt/modeling_imagegpt.py#L1100",parametersDescription:[{anchor:"transformers.ImageGPTForImageClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
model trained to predict the next pixel value, allowing for both unconditional and conditional image generation.`),wa=l(),Gt=a("p"),vn=r("The abstract from the paper is the following:"),Pa=l(),xt=a("p"),Qt=a("em"),Tn=r(`Inspired by progress in unsupervised representation learning for natural language, we examine whether similar models
...
train an XL variant, which they didn\u2019t release. The differences in size are summarized in the following table:`),Fa=l(),Pe=a("table"),Zt=a("thead"),x=a("tr"),eo=a("th"),to=a("strong"),Qn=r("Model variant"),Kn=l(),oo=a("th"),ao=a("strong"),Yn=r("Depths"),Zn=l(),no=a("th"),so=a("strong"),es=r("Hidden sizes"),ts=l(),ro=a("th"),io=a("strong"),os=r("Decoder hidden size"),as=l(),lo=a("th"),co=a("strong"),ns=r("Params (M)"),ss=l(),mo=a("th"),ho=a("strong"),rs=r("ImageNet-1k Top 1"),is=l(),E=a("tbody"),$=a("tr"),po=a("td"),ls=r("MiT-b0"),ds=l(),go=a("td"),cs=r("[2, 2, 2, 2]"),ms=l(),uo=a("td"),hs=r("[32, 64, 160, 256]"),ps=l(),fo=a("td"),gs=r("256"),us=l(),_o=a("td"),fs=r("3.7"),_s=l(),vo=a("td"),vs=r("70.5"),Ts=l(),F=a("tr"),To=a("td"),bs=r("MiT-b1"),Is=l(),bo=a("td"),ys=r("[2, 2, 2, 2]"),ws=l(),Io=a("td"),Ps=r("[64, 128, 320, 512]"),ks=l(),yo=a("td"),Gs=r("256"),xs=l(),wo=a("td"),Es=r("14.0"),$s=l(),Po=a("td"),Fs=r("78.7"),Cs=l(),C=a("tr"),ko=a("td"),Ms=r("MiT-b2"),zs=l(),Go=a("td"),js=r("[3, 4, 6, 3]"),qs=l(),xo=a("td"),As=r("[64, 128, 320, 512]"),Ds=l(),Eo=a("td"),Ns=r("768"),Ls=l(),$o=a("td"),Ss=r("25.4"),Os=l(),Fo=a("td"),Ws=r("81.6"),Rs=l(),M=a("tr"),Co=a("td"),Hs=r("MiT-b3"),Bs=l(),Mo=a("td"),Vs=r("[3, 4, 18, 3]"),Us=l(),zo=a("td"),Js=r("[64, 128, 320, 512]"),Xs=l(),jo=a("td"),Qs=r("768"),Ks=l(),qo=a("td"),Ys=r("45.2"),Zs=l(),Ao=a("td"),er=r("83.1"),tr=l(),z=a("tr"),Do=a("td"),or=r("MiT-b4"),ar=l(),No=a("td"),nr=r("[3, 8, 27, 3]"),sr=l(),Lo=a("td"),rr=r("[64, 128, 320, 512]"),ir=l(),So=a("td"),lr=r("768"),dr=l(),Oo=a("td"),cr=r("62.6"),mr=l(),Wo=a("td"),hr=r("83.6"),pr=l(),j=a("tr"),Ro=a("td"),gr=r("MiT-b5"),ur=l(),Ho=a("td"),fr=r("[3, 6, 40, 3]"),_r=l(),Bo=a("td"),vr=r("[64, 128, 320, 512]"),Tr=l(),Vo=a("td"),br=r("768"),Ir=l(),Uo=a("td"),yr=r("82.0"),wr=l(),Jo=a("td"),Pr=r("83.8"),Ca=l(),me=a("h2"),ke=a("a"),Xo=a("span"),v(Je.$$.fragment),kr=l(),Qo=a("span"),Gr=r("ImageGPTConfig"),Ma=l(),q=a("div"),v(Xe.$$.fragment),xr=l(),te=a("p"),Er=r("This is the configuration class to store the configuration of a "),zt=a("a"),$r=r("ImageGPTModel"),Fr=r(" or a "),Ko=a("code"),Cr=r("TFImageGPTModel"),Mr=r(`. It is
...
documentation from `),qt=a("a"),Lr=r("PretrainedConfig"),Sr=r(" for more information."),Or=l(),Yo=a("p"),Wr=r("Example:"),Rr=l(),v(Ke.$$.fragment),za=l(),pe=a("h2"),Ge=a("a"),Zo=a("span"),v(Ye.$$.fragment),Hr=l(),ea=a("span"),Br=r("ImageGPTFeatureExtractor"),ja=l(),R=a("div"),v(Ze.$$.fragment),Vr=l(),ta=a("p"),Ur=r(`Constructs an ImageGPT feature extractor. This feature extractor can be used to resize images to a smaller
resolution (such as 32x32 or 64x64), normalize them and finally color quantize them to obtain sequences of \u201Cpixel
values\u201D (color clusters).`),Jr=l(),et=a("p"),Xr=r("This feature extractor inherits from "),oa=a("code"),Qr=r("FeatureExtractionMixin"),Kr=r(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Yr=l(),oe=a("div"),v(tt.$$.fragment),Zr=l(),aa=a("p"),ei=r("Main method to prepare for the model one or several image(s)."),ti=l(),v(xe.$$.fragment),qa=l(),ge=a("h2"),Ee=a("a"),na=a("span"),v(ot.$$.fragment),oi=l(),sa=a("span"),ai=r("ImageGPTModel"),Aa=l(),A=a("div"),v(at.$$.fragment),ni=l(),ra=a("p"),si=r("The bare ImageGPT Model transformer outputting raw hidden-states without any specific head on top."),ri=l(),nt=a("p"),ii=r("This model inherits from "),At=a("a"),li=r("PreTrainedModel"),di=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),gi=l(),S=a("div"),v(it.$$.fragment),ui=l(),ue=a("p"),fi=r("The "),Dt=a("a"),_i=r("ImageGPTModel"),vi=r(" forward method, overrides the "),ia=a("code"),Ti=r("__call__"),bi=r(" special method."),Ii=l(),v($e.$$.fragment),yi=l(),la=a("p"),wi=r("Examples:"),Pi=l(),v(lt.$$.fragment),Da=l(),fe=a("h2"),Fe=a("a"),da=a("span"),v(dt.$$.fragment),ki=l(),ca=a("span"),Gi=r("ImageGPTForCausalImageModeling"),Na=l(),D=a("div"),v(ct.$$.fragment),xi=l(),ma=a("p"),Ei=r(`The ImageGPT Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),$i=l(),mt=a("p"),Fi=r("This model inherits from "),Nt=a("a"),Ci=r("PreTrainedModel"),Mi=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zi=l(),ht=a("p"),ji=r("This model is also a PyTorch "),pt=a("a"),qi=r("torch.nn.Module"),Ai=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Di=l(),O=a("div"),v(gt.$$.fragment),Ni=l(),_e=a("p"),Li=r("The "),Lt=a("a"),Si=r("ImageGPTForCausalImageModeling"),Oi=r(" forward method, overrides the "),ha=a("code"),Wi=r("__call__"),Ri=r(" special method."),Hi=l(),v(Ce.$$.fragment),Bi=l(),pa=a("p"),Vi=r("Examples:"),Ui=l(),v(ut.$$.fragment),La=l(),ve=a("h2"),Me=a("a"),ga=a("span"),v(ft.$$.fragment),Ji=l(),ua=a("span"),Xi=r("ImageGPTForImageClassification"),Sa=l(),N=a("div"),v(_t.$$.fragment),Qi=l(),vt=a("p"),Ki=r(`The ImageGPT Model transformer with an image classification head on top (linear layer).
`),St=a("a"),Yi=r("ImageGPTForImageClassification"),Zi=r(" average-pools the hidden states in order to do the classification."),el=l(),Tt=a("p"),tl=r("This model inherits from "),Ot=a("a"),ol=r("PreTrainedModel"),al=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nl=l(),bt=a("p"),sl=r("This model is also a PyTorch "),It=a("a"),rl=r("torch.nn.Module"),il=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ll=l(),W=a("div"),v(yt.$$.fragment),dl=l(),Te=a("p"),cl=r("The "),Wt=a("a"),ml=r("ImageGPTForImageClassification"),hl=r(" forward method, overrides the "),fa=a("code"),pl=r("__call__"),gl=r(" special method."),ul=l(),v(ze.$$.fragment),fl=l(),_a=a("p"),_l=r("Examples:"),vl=l(),v(wt.$$.fragment),this.h()},l(o){const m=Pc('[data-svelte="svelte-1phssyn"]',document.head);p=n(m,"META",{name:!0,content:!0}),m.forEach(t),P=d(o),g=n(o,"H1",{class:!0});var Pt=s(g);u=n(Pt,"A",{id:!0,class:!0,href:!0});var va=s(u);k=n(va,"SPAN",{});var Ta=s(k);T(f.$$.fragment,Ta),Ta.forEach(t),va.forEach(t),_=d(Pt),L=n(Pt,"SPAN",{});var ba=s(L);hn=i(ba,"ImageGPT"),ba.forEach(t),Pt.forEach(t),Ia=d(o),ce=n(o,"H2",{class:!0});var Wa=s(ce);Ie=n(Wa,"A",{id:!0,class:!0,href:!0});var bl=s(Ie);Jt=n(bl,"SPAN",{});var Il=s(Jt);T(De.$$.fragment,Il),Il.forEach(t),bl.forEach(t),pn=d(Wa),Xt=n(Wa,"SPAN",{});var yl=s(Xt);gn=i(yl,"Overview"),yl.forEach(t),Wa.forEach(t),ya=d(o),ye=n(o,"P",{});var Ra=s(ye);un=i(Ra,"The ImageGPT model was proposed in "),Ne=n(Ra,"A",{href:!0,rel:!0});var wl=s(Ne);fn=i(wl,"Generative Pretraining from Pixels"),wl.forEach(t),_n=i(Ra,` by Mark
Chen, Alec Radford, Rewon Child, Jeffrey Wu, Heewoo Jun, David Luan, Ilya Sutskever. ImageGPT (iGPT) is a GPT-2-like
model trained to predict the next pixel value, allowing for both unconditional and conditional image generation.`),Ra.forEach(t),wa=d(o),Gt=n(o,"P",{});var Pl=s(Gt);vn=i(Pl,"The abstract from the paper is the following:"),Pl.forEach(t),Pa=d(o),xt=n(o,"P",{});var kl=s(xt);Qt=n(kl,"EM",{});var Gl=s(Qt);Tn=i(Gl,`Inspired by progress in unsupervised representation learning for natural language, we examine whether similar models
can learn useful representations for images. We train a sequence Transformer to auto-regressively predict pixels,
without incorporating knowledge of the 2D input structure. Despite training on low-resolution ImageNet without labels,
we find that a GPT-2 scale model learns strong image representations as measured by linear probing, fine-tuning, and
low-data classification. On CIFAR-10, we achieve 96.3% accuracy with a linear probe, outperforming a supervised Wide
...
train an XL variant, which they didn\u2019t release. The differences in size are summarized in the following table:`),Dl.forEach(t),B.forEach(t),Fa=d(o),Pe=n(o,"TABLE",{});var Xa=s(Pe);Zt=n(Xa,"THEAD",{});var Nl=s(Zt);x=n(Nl,"TR",{});var V=s(x);eo=n(V,"TH",{});var Ll=s(eo);to=n(Ll,"STRONG",{});var Sl=s(to);Qn=i(Sl,"Model variant"),Sl.forEach(t),Ll.forEach(t),Kn=d(V),oo=n(V,"TH",{});var Ol=s(oo);ao=n(Ol,"STRONG",{});var Wl=s(ao);Yn=i(Wl,"Depths"),Wl.forEach(t),Ol.forEach(t),Zn=d(V),no=n(V,"TH",{});var Rl=s(no);so=n(Rl,"STRONG",{});var Hl=s(so);es=i(Hl,"Hidden sizes"),Hl.forEach(t),Rl.forEach(t),ts=d(V),ro=n(V,"TH",{});var Bl=s(ro);io=n(Bl,"STRONG",{});var Vl=s(io);os=i(Vl,"Decoder hidden size"),Vl.forEach(t),Bl.forEach(t),as=d(V),lo=n(V,"TH",{});var Ul=s(lo);co=n(Ul,"STRONG",{});var Jl=s(co);ns=i(Jl,"Params (M)"),Jl.forEach(t),Ul.forEach(t),ss=d(V),mo=n(V,"TH",{});var Xl=s(mo);ho=n(Xl,"STRONG",{});var Ql=s(ho);rs=i(Ql,"ImageNet-1k Top 1"),Ql.forEach(t),Xl.forEach(t),V.forEach(t),Nl.forEach(t),is=d(Xa),E=n(Xa,"TBODY",{});var U=s(E);$=n(U,"TR",{});var J=s($);po=n(J,"TD",{});var Kl=s(po);ls=i(Kl,"MiT-b0"),Kl.forEach(t),ds=d(J),go=n(J,"TD",{});var Yl=s(go);cs=i(Yl,"[2, 2, 2, 2]"),Yl.forEach(t),ms=d(J),uo=n(J,"TD",{});var Zl=s(uo);hs=i(Zl,"[32, 64, 160, 256]"),Zl.forEach(t),ps=d(J),fo=n(J,"TD",{});var ed=s(fo);gs=i(ed,"256"),ed.forEach(t),us=d(J),_o=n(J,"TD",{});var td=s(_o);fs=i(td,"3.7"),td.forEach(t),_s=d(J),vo=n(J,"TD",{});var od=s(vo);vs=i(od,"70.5"),od.forEach(t),J.forEach(t),Ts=d(U),F=n(U,"TR",{});var X=s(F);To=n(X,"TD",{});var ad=s(To);bs=i(ad,"MiT-b1"),ad.forEach(t),Is=d(X),bo=n(X,"TD",{});var nd=s(bo);ys=i(nd,"[2, 2, 2, 2]"),nd.forEach(t),ws=d(X),Io=n(X,"TD",{});var sd=s(Io);Ps=i(sd,"[64, 128, 320, 512]"),sd.forEach(t),ks=d(X),yo=n(X,"TD",{});var rd=s(yo);Gs=i(rd,"256"),rd.forEach(t),xs=d(X),wo=n(X,"TD",{});var id=s(wo);Es=i(id,"14.0"),id.forEach(t),$s=d(X),Po=n(X,"TD",{});var ld=s(Po);Fs=i(ld,"78.7"),ld.forEach(t),X.forEach(t),Cs=d(U),C=n(U,"TR",{});var Q=s(C);ko=n(Q,"TD",{});var dd=s(ko);Ms=i(dd,"MiT-b2"),dd.forEach(t),zs=d(Q),Go=n(Q,"TD",{});var cd=s(Go);js=i(cd,"[3, 4, 6, 3]"),cd.forEach(t),qs=d(Q),xo=n(Q,"TD",{});var md=s(xo);As=i(md,"[64, 128, 320, 512]"),md.forEach(t),Ds=d(Q),Eo=n(Q,"TD",{});var hd=s(Eo);Ns=i(hd,"768"),hd.forEach(t),Ls=d(Q),$o=n(Q,"TD",{});var pd=s($o);Ss=i(pd,"25.4"),pd.forEach(t),Os=d(Q),Fo=n(Q,"TD",{});var gd=s(Fo);Ws=i(gd,"81.6"),gd.forEach(t),Q.forEach(t),Rs=d(U),M=n(U,"TR",{});var K=s(M);Co=n(K,"TD",{});var ud=s(Co);Hs=i(ud,"MiT-b3"),ud.forEach(t),Bs=d(K),Mo=n(K,"TD",{});var fd=s(Mo);Vs=i(fd,"[3, 4, 18, 3]"),fd.forEach(t),Us=d(K),zo=n(K,"TD",{});var _d=s(zo);Js=i(_d,"[64, 128, 320, 512]"),_d.forEach(t),Xs=d(K),jo=n(K,"TD",{});var vd=s(jo);Qs=i(vd,"768"),vd.forEach(t),Ks=d(K),qo=n(K,"TD",{});var Td=s(qo);Ys=i(Td,"45.2"),Td.forEach(t),Zs=d(K),Ao=n(K,"TD",{});var bd=s(Ao);er=i(bd,"83.1"),bd.forEach(t),K.forEach(t),tr=d(U),z=n(U,"TR",{});var Y=s(z);Do=n(Y,"TD",{});var Id=s(Do);or=i(Id,"MiT-b4"),Id.forEach(t),ar=d(Y),No=n(Y,"TD",{});var yd=s(No);nr=i(yd,"[3, 8, 27, 3]"),yd.forEach(t),sr=d(Y),Lo=n(Y,"TD",{});var wd=s(Lo);rr=i(wd,"[64, 128, 320, 512]"),wd.forEach(t),ir=d(Y),So=n(Y,"TD",{});var Pd=s(So);lr=i(Pd,"768"),Pd.forEach(t),dr=d(Y),Oo=n(Y,"TD",{});var kd=s(Oo);cr=i(kd,"62.6"),kd.forEach(t),mr=d(Y),Wo=n(Y,"TD",{});var Gd=s(Wo);hr=i(Gd,"83.6"),Gd.forEach(t),Y.forEach(t),pr=d(U),j=n(U,"TR",{});var Z=s(j);Ro=n(Z,"TD",{});var xd=s(Ro);gr=i(xd,"MiT-b5"),xd.forEach(t),ur=d(Z),Ho=n(Z,"TD",{});var Ed=s(Ho);fr=i(Ed,"[3, 6, 40, 3]"),Ed.forEach(t),_r=d(Z),Bo=n(Z,"TD",{});var $d=s(Bo);vr=i($d,"[64, 128, 320, 512]"),$d.forEach(t),Tr=d(Z),Vo=n(Z,"TD",{});var Fd=s(Vo);br=i(Fd,"768"),Fd.forEach(t),Ir=d(Z),Uo=n(Z,"TD",{});var Cd=s(Uo);yr=i(Cd,"82.0"),Cd.forEach(t),wr=d(Z),Jo=n(Z,"TD",{});var Md=s(Jo);Pr=i(Md,"83.8"),Md.forEach(t),Z.forEach(t),U.forEach(t),Xa.forEach(t),Ca=d(o),me=n(o,"H2",{class:!0});var Qa=s(me);ke=n(Qa,"A",{id:!0,class:!0,href:!0});var zd=s(ke);Xo=n(zd,"SPAN",{});var jd=s(Xo);T(Je.$$.fragment,jd),jd.forEach(t),zd.forEach(t),kr=d(Qa),Qo=n(Qa,"SPAN",{});var qd=s(Qo);Gr=i(qd,"ImageGPTConfig"),qd.forEach(t),Qa.forEach(t),Ma=d(o),q=n(o,"DIV",{class:!0});var ae=s(q);T(Xe.$$.fragment,ae),xr=d(ae),te=n(ae,"P",{});var qe=s(te);Er=i(qe,"This is the configuration class to store the configuration of a "),zt=n(qe,"A",{href:!0});var Ad=s(zt);$r=i(Ad,"ImageGPTModel"),Ad.forEach(t),Fr=i(qe," or a "),Ko=n(qe,"CODE",{});var Dd=s(Ko);Cr=i(Dd,"TFImageGPTModel"),Dd.forEach(t),Mr=i(qe,`. It is
used to instantiate a GPT-2 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the ImageGPT
`),Qe=n(qe,"A",{href:!0,rel:!0});var Nd=s(Qe);zr=i(Nd,"small"),Nd.forEach(t),jr=i(qe," architecture."),qe.forEach(t),qr=d(ae),he=n(ae,"P",{});var Rt=s(he);Ar=i(Rt,"Configuration objects inherit from "),jt=n(Rt,"A",{href:!0});var Ld=s(jt);Dr=i(Ld,"PretrainedConfig"),Ld.forEach(t),Nr=i(Rt,` and can be used to control the model outputs. Read the
documentation from `),qt=n(Rt,"A",{href:!0});var Sd=s(qt);Lr=i(Sd,"PretrainedConfig"),Sd.forEach(t),Sr=i(Rt," for more information."),Rt.forEach(t),Or=d(ae),Yo=n(ae,"P",{});var Od=s(Yo);Wr=i(Od,"Example:"),Od.forEach(t),Rr=d(ae),T(Ke.$$.fragment,ae),ae.forEach(t),za=d(o),pe=n(o,"H2",{class:!0});var Ka=s(pe);Ge=n(Ka,"A",{id:!0,class:!0,href:!0});var Wd=s(Ge);Zo=n(Wd,"SPAN",{});var Rd=s(Zo);T(Ye.$$.fragment,Rd),Rd.forEach(t),Wd.forEach(t),Hr=d(Ka),ea=n(Ka,"SPAN",{});var Hd=s(ea);Br=i(Hd,"ImageGPTFeatureExtractor"),Hd.forEach(t),Ka.forEach(t),ja=d(o),R=n(o,"DIV",{class:!0});var Ae=s(R);T(Ze.$$.fragment,Ae),Vr=d(Ae),ta=n(Ae,"P",{});var Bd=s(ta);Ur=i(Bd,`Constructs an ImageGPT feature extractor. This feature extractor can be used to resize images to a smaller
resolution (such as 32x32 or 64x64), normalize them and finally color quantize them to obtain sequences of \u201Cpixel
values\u201D (color clusters).`),Bd.forEach(t),Jr=d(Ae),et=n(Ae,"P",{});var Ya=s(et);Xr=i(Ya,"This feature extractor inherits from "),oa=n(Ya,"CODE",{});var Vd=s(oa);Qr=i(Vd,"FeatureExtractionMixin"),Vd.forEach(t),Kr=i(Ya,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Ya.forEach(t),Yr=d(Ae),oe=n(Ae,"DIV",{class:!0});var Ht=s(oe);T(tt.$$.fragment,Ht),Zr=d(Ht),aa=n(Ht,"P",{});var Ud=s(aa);ei=i(Ud,"Main method to prepare for the model one or several image(s)."),Ud.forEach(t),ti=d(Ht),T(xe.$$.fragment,Ht),Ht.forEach(t),Ae.forEach(t),qa=d(o),ge=n(o,"H2",{class:!0});var Za=s(ge);Ee=n(Za,"A",{id:!0,class:!0,href:!0});var Jd=s(Ee);na=n(Jd,"SPAN",{});var Xd=s(na);T(ot.$$.fragment,Xd),Xd.forEach(t),Jd.forEach(t),oi=d(Za),sa=n(Za,"SPAN",{});var Qd=s(sa);ai=i(Qd,"ImageGPTModel"),Qd.forEach(t),Za.forEach(t),Aa=d(o),A=n(o,"DIV",{class:!0});var ne=s(A);T(at.$$.fragment,ne),ni=d(ne),ra=n(ne,"P",{});var Kd=s(ra);si=i(Kd,"The bare ImageGPT Model transformer outputting raw hidden-states without any specific head on top."),Kd.forEach(t),ri=d(ne),nt=n(ne,"P",{});var en=s(nt);ii=i(en,"This model inherits from "),At=n(en,"A",{href:!0});var Yd=s(At);li=i(Yd,"PreTrainedModel"),Yd.forEach(t),di=i(en,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
embeddings).`),rc.forEach(t),$i=d(re),mt=n(re,"P",{});var an=s(mt);Fi=i(an,"This model inherits from "),Nt=n(an,"A",{href:!0});var ic=s(Nt);Ci=i(ic,"PreTrainedModel"),ic.forEach(t),Mi=i(an,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
