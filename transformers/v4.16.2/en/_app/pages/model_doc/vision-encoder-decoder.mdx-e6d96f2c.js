import{S as Ji,i as Ki,s as Qi,e as r,k as c,w as f,t,M as Xi,c as a,d as o,m as l,a as d,x as u,h as n,b as i,F as e,g as T,y as g,q as _,o as v,B as b}from"../../chunks/vendor-ab4e3193.js";import{T as Ed}from"../../chunks/Tip-b5c6375a.js";import{D as B}from"../../chunks/Docstring-91f1beab.js";import{C as wo}from"../../chunks/CodeBlock-516df0c5.js";import{I as Ht}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function ec(Q){let p,P,m,M,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),M=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var x=d(p);P=n(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(x,"CODE",{});var C=d(m);M=n(C,"Module"),C.forEach(o),F=n(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(y,x){T(y,p,x),e(p,P),e(p,m),e(m,M),e(p,F)},d(y){y&&o(p)}}}function oc(Q){let p,P,m,M,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),M=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var x=d(p);P=n(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(x,"CODE",{});var C=d(m);M=n(C,"Module"),C.forEach(o),F=n(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(y,x){T(y,p,x),e(p,P),e(p,m),e(m,M),e(p,F)},d(y){y&&o(p)}}}function tc(Q){let p,P,m,M,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),M=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var x=d(p);P=n(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(x,"CODE",{});var C=d(m);M=n(C,"Module"),C.forEach(o),F=n(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(y,x){T(y,p,x),e(p,P),e(p,m),e(m,M),e(p,F)},d(y){y&&o(p)}}}function nc(Q){let p,P,m,M,F,y,x,C,Mn,Zt,j,Dn,Eo,Vn,$n,tt,qn,zn,ko,Pn,Fn,xo,Cn,An,jo,Sn,In,nt,Ln,Nn,Mo,On,Rn,Do,Bn,Gn,Vo,Wn,Un,Yt,he,Hn,xe,Zn,Yn,Jt,G,Jn,$o,Kn,Qn,qo,Xn,er,Kt,X,me,rt,je,or,at,tr,Qt,z,Me,nr,fe,zo,rr,ar,Po,sr,dr,ir,ee,cr,Fo,lr,pr,Co,hr,mr,fr,st,ur,gr,De,_r,ue,Ve,vr,$e,br,Ao,Tr,yr,wr,ge,qe,Er,oe,kr,dt,xr,jr,it,Mr,Dr,Xt,te,_e,ct,ze,Vr,lt,$r,en,w,Pe,qr,ne,zr,pt,Pr,Fr,ht,Cr,Ar,Sr,Fe,Ir,Ce,Lr,Nr,Or,Ae,Rr,Se,Br,Gr,Wr,mt,Ur,Hr,Ie,Zr,So,Yr,Jr,Kr,Le,Qr,Ne,Xr,ea,oa,W,Io,ta,na,ft,ra,aa,ut,sa,da,ia,A,Oe,ca,re,la,Lo,pa,ha,gt,ma,fa,ua,ve,ga,_t,_a,va,Re,ba,S,Be,Ta,vt,ya,wa,ae,Ea,bt,ka,xa,Tt,ja,Ma,Da,yt,Va,$a,Ge,on,se,be,wt,We,qa,Et,za,tn,E,Ue,Pa,de,Fa,kt,Ca,Aa,xt,Sa,Ia,La,He,Na,Ze,Oa,Ra,Ba,Ye,Ga,Je,Wa,Ua,Ha,jt,Za,Ya,Ke,Ja,No,Ka,Qa,Xa,Qe,es,Xe,os,ts,ns,U,Oo,rs,as,Mt,ss,ds,Dt,is,cs,ls,I,eo,ps,ie,hs,Ro,ms,fs,Vt,us,gs,_s,Te,vs,$t,bs,Ts,oo,ys,O,to,ws,qt,Es,ks,zt,xs,js,no,nn,ce,ye,Pt,ro,Ms,Ft,Ds,rn,k,ao,Vs,le,$s,Ct,qs,zs,At,Ps,Fs,Cs,so,As,io,Ss,Is,Ls,co,Ns,lo,Os,Rs,Bs,St,Gs,Ws,po,Us,Bo,Hs,Zs,Ys,ho,Js,mo,Ks,Qs,Xs,H,Go,ed,od,It,td,nd,Lt,rd,ad,sd,L,fo,dd,pe,id,Wo,cd,ld,Nt,pd,hd,md,we,fd,Ot,ud,gd,uo,_d,R,go,vd,Rt,bd,Td,Bt,yd,wd,_o,an;return y=new Ht({}),je=new Ht({}),Me=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
</ul>`,name:"kwargs"}]}}),De=new wo({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
and any pretrained language model as the decoder (`),nt=r("em"),Ln=t("e.g."),Nn=c(),Mo=r("a"),On=t("RoBERTa"),Rn=t(", "),Do=r("a"),Bn=t("GPT2"),Gn=t(", "),Vo=r("a"),Wn=t("BERT"),Un=t(")."),Yt=c(),he=r("p"),Hn=t(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
documentation from `),Co=r("a"),hr=t("PretrainedConfig"),mr=t(" for more information."),fr=c(),st=r("p"),ur=t("Examples:"),gr=c(),f(De.$$.fragment),_r=c(),ue=r("div"),f(Ve.$$.fragment),vr=c(),$e=r("p"),br=t("Instantiate a "),Ao=r("a"),Tr=t("VisionEncoderDecoderConfig"),yr=t(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),wr=c(),ge=r("div"),f(qe.$$.fragment),Er=c(),oe=r("p"),kr=t("Serializes this instance to a Python dictionary. Override the default "),dt=r("em"),xr=t("to_dict()"),jr=t(" from "),it=r("em"),Mr=t("PretrainedConfig"),Dr=t("."),Xt=c(),te=r("h2"),_e=r("a"),ct=r("span"),f(ze.$$.fragment),Vr=c(),lt=r("span"),$r=t("VisionEncoderDecoderModel"),en=c(),w=r("div"),f(Pe.$$.fragment),qr=c(),ne=r("p"),zr=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
...
other models (see the examples for more information).`),Hr=c(),Ie=r("p"),Zr=t("This model inherits from "),So=r("a"),Yr=t("PreTrainedModel"),Jr=t(`. Check the superclass documentation for the generic methods the
...
the model, you need to first set it back in training mode with `),Tt=r("code"),ja=t("model.train()"),Ma=t("."),Da=c(),yt=r("p"),Va=t("Example:"),$a=c(),f(Ge.$$.fragment),on=c(),se=r("h2"),be=r("a"),wt=r("span"),f(We.$$.fragment),qa=c(),Et=r("span"),za=t("TFVisionEncoderDecoderModel"),tn=c(),E=r("div"),f(Ue.$$.fragment),Pa=c(),de=r("p"),Fa=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ys=c(),ho=r("p"),Js=t(`This model is also a Flax Linen
...
checkpoints.`),Td=c(),Bt=r("p"),yd=t("Example:"),wd=c(),f(_o.$$.fragment),this.h()},l(s){const h=Xi('[data-svelte="svelte-1phssyn"]',document.head);p=a(h,"META",{name:!0,content:!0}),h.forEach(o),P=l(s),m=a(s,"H1",{class:!0});var vo=d(m);M=a(vo,"A",{id:!0,class:!0,href:!0});var Gt=d(M);F=a(Gt,"SPAN",{});var Wt=d(F);u(y.$$.fragment,Wt),Wt.forEach(o),Gt.forEach(o),x=l(vo),C=a(vo,"SPAN",{});var kd=d(C);Mn=n(kd,"Vision Encoder Decoder Models"),kd.forEach(o),vo.forEach(o),Zt=l(s),j=a(s,"P",{});var D=d(j);Dn=n(D,"The "),Eo=a(D,"A",{href:!0});var xd=d(Eo);Vn=n(xd,"VisionEncoderDecoderModel"),xd.forEach(o),$n=n(D,` can be used to initialize an image-to-text-sequence model with any
pretrained vision autoencoding model as the encoder (`),tt=a(D,"EM",{});var jd=d(tt);qn=n(jd,"e.g."),jd.forEach(o),zn=l(D),ko=a(D,"A",{href:!0});var Md=d(ko);Pn=n(Md,"ViT"),Md.forEach(o),Fn=n(D,", "),xo=a(D,"A",{href:!0});var Dd=d(xo);Cn=n(Dd,"BEiT"),Dd.forEach(o),An=n(D,", "),jo=a(D,"A",{href:!0});var Vd=d(jo);Sn=n(Vd,"DeiT"),Vd.forEach(o),In=n(D,`)
and any pretrained language model as the decoder (`),nt=a(D,"EM",{});var $d=d(nt);Ln=n($d,"e.g."),$d.forEach(o),Nn=l(D),Mo=a(D,"A",{href:!0});var qd=d(Mo);On=n(qd,"RoBERTa"),qd.forEach(o),Rn=n(D,", "),Do=a(D,"A",{href:!0});var zd=d(Do);Bn=n(zd,"GPT2"),zd.forEach(o),Gn=n(D,", "),Vo=a(D,"A",{href:!0});var Pd=d(Vo);Wn=n(Pd,"BERT"),Pd.forEach(o),Un=n(D,")."),D.forEach(o),Yt=l(s),he=a(s,"P",{});var sn=d(he);Hn=n(sn,`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
documentation from `),Co=a(Ho,"A",{href:!0});var Bd=d(Co);hr=n(Bd,"PretrainedConfig"),Bd.forEach(o),mr=n(Ho," for more information."),Ho.forEach(o),fr=l(N),st=a(N,"P",{});var Gd=d(st);ur=n(Gd,"Examples:"),Gd.forEach(o),gr=l(N),u(De.$$.fragment,N),_r=l(N),ue=a(N,"DIV",{class:!0});var cn=d(ue);u(Ve.$$.fragment,cn),vr=l(cn),$e=a(cn,"P",{});var ln=d($e);br=n(ln,"Instantiate a "),Ao=a(ln,"A",{href:!0});var Wd=d(Ao);Tr=n(Wd,"VisionEncoderDecoderConfig"),Wd.forEach(o),yr=n(ln,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),ln.forEach(o),cn.forEach(o),wr=l(N),ge=a(N,"DIV",{class:!0});var pn=d(ge);u(qe.$$.fragment,pn),Er=l(pn),oe=a(pn,"P",{});var Zo=d(oe);kr=n(Zo,"Serializes this instance to a Python dictionary. Override the default "),dt=a(Zo,"EM",{});var Ud=d(dt);xr=n(Ud,"to_dict()"),Ud.forEach(o),jr=n(Zo," from "),it=a(Zo,"EM",{});var Hd=d(it);Mr=n(Hd,"PretrainedConfig"),Hd.forEach(o),Dr=n(Zo,"."),Zo.forEach(o),pn.forEach(o),N.forEach(o),Xt=l(s),te=a(s,"H2",{class:!0});var hn=d(te);_e=a(hn,"A",{id:!0,class:!0,href:!0});var Zd=d(_e);ct=a(Zd,"SPAN",{});var Yd=d(ct);u(ze.$$.fragment,Yd),Yd.forEach(o),Zd.forEach(o),Vr=l(hn),lt=a(hn,"SPAN",{});var Jd=d(lt);$r=n(Jd,"VisionEncoderDecoderModel"),Jd.forEach(o),hn.forEach(o),en=l(s),w=a(s,"DIV",{class:!0});var V=d(w);u(Pe.$$.fragment,V),qr=l(V),ne=a(V,"P",{});var Yo=d(ne);zr=n(Yo,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),pt=a(Yo,"CODE",{});var Kd=d(pt);Pr=n(Kd,"from_pretrained()"),Kd.forEach(o),Fr=n(Yo,"function and the decoder is loaded via "),ht=a(Yo,"CODE",{});var Qd=d(ht);Cr=n(Qd,"from_pretrained()"),Qd.forEach(o),Ar=n(Yo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),Yo.forEach(o),Sr=l(V),Fe=a(V,"P",{});var mn=d(Fe);Ir=n(mn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
other models (see the examples for more information).`),oi.forEach(o),Hr=l(V),Ie=a(V,"P",{});var un=d(Ie);Zr=n(un,"This model inherits from "),So=a(un,"A",{href:!0});var ti=d(So);Yr=n(ti,"PreTrainedModel"),ti.forEach(o),Jr=n(un,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
:meth`),ut=a(bo,"EM",{});var si=d(ut);sa=n(si,"~transformers.AutoModelForCausalLM.from_pretrained"),si.forEach(o),da=n(bo," class method for the decoder."),bo.forEach(o),ia=l(V),A=a(V,"DIV",{class:!0});var Z=d(A);u(Oe.$$.fragment,Z),ca=l(Z),re=a(Z,"P",{});var Jo=d(re);la=n(Jo,"The "),Lo=a(Jo,"A",{href:!0});var di=d(Lo);pa=n(di,"VisionEncoderDecoderModel"),di.forEach(o),ha=n(Jo," forward method, overrides the "),gt=a(Jo,"CODE",{});var ii=d(gt);ma=n(ii,"__call__"),ii.forEach(o),fa=n(Jo," special method."),Jo.forEach(o),ua=l(Z),u(ve.$$.fragment,Z),ga=l(Z),_t=a(Z,"P",{});var ci=d(_t);_a=n(ci,"Examples:"),ci.forEach(o),va=l(Z),u(Re.$$.fragment,Z),Z.forEach(o),ba=l(V),S=a(V,"DIV",{class:!0});var Y=d(S);u(Be.$$.fragment,Y),Ta=l(Y),vt=a(Y,"P",{});var li=d(vt);ya=n(li,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),li.forEach(o),wa=l(Y),ae=a(Y,"P",{});var Ko=d(ae);Ea=n(Ko,"The model is set in evaluation mode by default using "),bt=a(Ko,"CODE",{});var pi=d(bt);ka=n(pi,"model.eval()"),pi.forEach(o),xa=n(Ko,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),Tt=a(Ko,"CODE",{});var hi=d(Tt);ja=n(hi,"model.train()"),hi.forEach(o),Ma=n(Ko,"."),Ko.forEach(o),Da=l(Y),yt=a(Y,"P",{});var mi=d(yt);Va=n(mi,"Example:"),mi.forEach(o),$a=l(Y),u(Ge.$$.fragment,Y),Y.forEach(o),V.forEach(o),on=l(s),se=a(s,"H2",{class:!0});var _n=d(se);be=a(_n,"A",{id:!0,class:!0,href:!0});var fi=d(be);wt=a(fi,"SPAN",{});var ui=d(wt);u(We.$$.fragment,ui),ui.forEach(o),fi.forEach(o),qa=l(_n),Et=a(_n,"SPAN",{});var gi=d(Et);za=n(gi,"TFVisionEncoderDecoderModel"),gi.forEach(o),_n.forEach(o),tn=l(s),E=a(s,"DIV",{class:!0});var $=d(E);u(Ue.$$.fragment,$),Pa=l($),de=a($,"P",{});var Qo=d(de);Fa=n(Qo,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
other models (see the examples for more information).`),yi.forEach(o),Ya=l($),Ke=a($,"P",{});var Tn=d(Ke);Ja=n(Tn,"This model inherits from "),No=a(Tn,"A",{href:!0});var wi=d(No);Ka=n(wi,"TFPreTrainedModel"),wi.forEach(o),Qa=n(Tn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Mt=a(To,"CODE",{});var xi=d(Mt);ss=n(xi,"from_pretrained()"),xi.forEach(o),ds=n(To,`class method for the encoder and
`),Dt=a(To,"CODE",{});var ji=d(Dt);is=n(ji,"from_pretrained()"),ji.forEach(o),cs=n(To,"class method for the decoder."),To.forEach(o),ls=l($),I=a($,"DIV",{class:!0});var J=d(I);u(eo.$$.fragment,J),ps=l(J),ie=a(J,"P",{});var Xo=d(ie);hs=n(Xo,"The "),Ro=a(Xo,"A",{href:!0});var Mi=d(Ro);ms=n(Mi,"TFVisionEncoderDecoderModel"),Mi.forEach(o),fs=n(Xo," forward method, overrides the "),Vt=a(Xo,"CODE",{});var Di=d(Vt);us=n(Di,"__call__"),Di.forEach(o),gs=n(Xo," special method."),Xo.forEach(o),_s=l(J),u(Te.$$.fragment,J),vs=l(J),$t=a(J,"P",{});var Vi=d($t);bs=n(Vi,"Examples:"),Vi.forEach(o),Ts=l(J),u(oo.$$.fragment,J),J.forEach(o),ys=l($),O=a($,"DIV",{class:!0});var Ee=d(O);u(to.$$.fragment,Ee),ws=l(Ee),qt=a(Ee,"P",{});var $i=d(qt);Es=n($i,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),$i.forEach(o),ks=l(Ee),zt=a(Ee,"P",{});var qi=d(zt);xs=n(qi,"Example:"),qi.forEach(o),js=l(Ee),u(no.$$.fragment,Ee),Ee.forEach(o),$.forEach(o),nn=l(s),ce=a(s,"H2",{class:!0});var wn=d(ce);ye=a(wn,"A",{id:!0,class:!0,href:!0});var zi=d(ye);Pt=a(zi,"SPAN",{});var Pi=d(Pt);u(ro.$$.fragment,Pi),Pi.forEach(o),zi.forEach(o),Ms=l(wn),Ft=a(wn,"SPAN",{});var Fi=d(Ft);Ds=n(Fi,"FlaxVisionEncoderDecoderModel"),Fi.forEach(o),wn.forEach(o),rn=l(s),k=a(s,"DIV",{class:!0});var q=d(k);u(ao.$$.fragment,q),Vs=l(q),le=a(q,"P",{});var et=d(le);$s=n(et,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xn.forEach(o),Ys=l(q),ho=a(q,"P",{});var jn=d(ho);Js=n(jn,`This model is also a Flax Linen
