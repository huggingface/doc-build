import{S as Rw,i as Hw,s as Vw,e as a,k as d,w as f,t as o,M as Kw,c as r,d as t,m as l,a as i,x as _,h as s,b as c,F as e,g as p,y as g,q as T,o as v,B as k}from"../../chunks/vendor-ab4e3193.js";import{T as zt}from"../../chunks/Tip-b5c6375a.js";import{D as P}from"../../chunks/Docstring-91f1beab.js";import{C as R}from"../../chunks/CodeBlock-516df0c5.js";import{I as qe}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Yw(N){let u,$,b,y,x;return{c(){u=a("p"),$=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=a("code"),y=o("Module"),x=o(`
...
the latter silently ignores them.`)},l(z){u=r(z,"P",{});var w=i(u);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=r(w,"CODE",{});var q=i(b);y=s(q,"Module"),q.forEach(t),x=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(z,w){p(z,u,w),e(u,$),e(u,b),e(b,y),e(u,x)},d(z){z&&t(u)}}}function ry(N){let u,$,b,y,x,z,w,q,Ee,se,E,te,O,ae,je,G,Fe,ve,B,I,re,pe,F,C,he,K,ke,ue,U,Me,be,M,Pe,H,V,me,A,Ce,fe,D,Ae,W,Le,m,j,ne,Ge,lt,S,Be,oe,ct,L,Y,pt,Ne,Z,ht,Ie,De,ut,Dl,Ba,qp,Sl,Ue,ei,ti,uo,Ep,jp,ni,oi,mo,Fp,Mp,si,ai,fo,Pp,Cp,ri,ii,_o,Ap,Lp,di,Ua,go,Np,Ip,Ol,Wa,Dp,Gl,xt,li,zn,ci,Sp,Op,Ra,Gp,Bp,Up,pi,xn,hi,Wp,Rp,Ha,Hp,Vp,Kp,ui,$n,mi,Yp,Zp,Va,Jp,Xp,Bl,qn,Qp,To,eh,th,Ul,$t,nh,vo,oh,sh,ko,ah,rh,Wl,Ka,Rl,Yt,En,fi,bo,ih,_i,dh,Hl,mt,lh,gi,ch,ph,Ti,hh,uh,vi,mh,fh,Vl,jn,_h,Ya,gh,Th,Kl,Fn,dt,ki,vh,kh,_e,bh,bi,wh,yh,wi,zh,xh,yi,$h,qh,zi,Eh,jh,xi,Fh,Mh,Za,Ph,Ch,Ah,$i,Lh,Nh,wo,Ih,yo,Dh,zo,Sh,Oh,Gh,ge,qi,Bh,Uh,Ei,Wh,Rh,xo,Hh,ie,Vh,ji,Kh,Yh,Fi,Zh,Jh,Mi,Xh,Qh,Pi,eu,tu,Ci,nu,ou,Ai,su,au,Li,ru,iu,du,Zt,lu,Ni,cu,pu,Ii,hu,uu,mu,Te,fu,Di,_u,gu,Si,Tu,vu,Oi,ku,bu,Gi,wu,yu,$o,zu,xu,Bi,$u,qu,Eu,qo,Yl,Ja,ju,Zl,qt,Ui,Eo,Fu,Wi,Mu,Pu,Cu,Ri,Jt,Au,jo,Lu,Nu,Fo,Iu,Du,Su,Hi,Mo,Ou,Vi,Gu,Bu,Jl,Xa,Xl,Xt,Mn,Ki,Po,Uu,Yi,Wu,Ql,ft,Ru,Qa,Hu,Vu,Co,Ku,Yu,Ao,Zu,Ju,ec,Lo,tc,We,Xu,Zi,Qu,em,Ji,tm,nm,er,om,sm,Xi,am,rm,nc,tr,im,oc,No,sc,nr,ac,Qt,Pn,Qi,Io,dm,ed,lm,rc,or,cm,ic,Cn,td,en,pm,Do,hm,um,So,mm,fm,_m,nd,Se,gm,Oo,Tm,vm,Go,km,bm,Bo,wm,ym,Uo,zm,xm,Wo,$m,qm,dc,tn,An,od,Ro,Em,sd,jm,lc,kt,Ho,Fm,bt,Mm,sr,Pm,Cm,ar,Am,Lm,Vo,Nm,Im,Dm,nn,Sm,rr,Om,Gm,ir,Bm,Um,cc,on,Ln,ad,Ko,Wm,rd,Rm,pc,J,Yo,Hm,Zo,Vm,Jo,Km,Ym,Zm,Xo,Jm,dr,Xm,Qm,ef,sn,tf,id,nf,of,dd,sf,af,rf,Et,Qo,df,ld,lf,cf,es,lr,pf,cd,hf,uf,cr,mf,pd,ff,_f,Nn,ts,gf,ns,Tf,hd,vf,kf,bf,In,os,wf,ud,yf,zf,md,hc,an,Dn,fd,ss,xf,_d,$f,uc,Oe,as,qf,rn,Ef,gd,jf,Ff,rs,Mf,Pf,Cf,is,Af,pr,Lf,Nf,If,jt,ds,Df,Td,Sf,Of,ls,hr,Gf,vd,Bf,Uf,ur,Wf,kd,Rf,Hf,Sn,cs,Vf,bd,Kf,mc,dn,On,wd,ps,Yf,yd,Zf,fc,X,hs,Jf,zd,Xf,Qf,us,e_,ms,t_,n_,o_,fs,s_,mr,a_,r_,i_,_s,d_,gs,l_,c_,p_,Re,Ts,h_,ln,u_,fr,m_,f_,xd,__,g_,T_,Gn,v_,$d,k_,b_,vs,w_,He,ks,y_,qd,z_,x_,Ed,$_,q_,jd,E_,j_,bs,F_,_t,ws,M_,Fd,P_,C_,Md,A_,L_,ys,_c,cn,Bn,Pd,zs,N_,Cd,I_,gc,Q,xs,D_,$s,S_,Ad,O_,G_,B_,qs,U_,Es,W_,R_,H_,js,V_,_r,K_,Y_,Z_,Fs,J_,Ms,X_,Q_,eg,Ve,Ps,tg,pn,ng,gr,og,sg,Ld,ag,rg,ig,Un,dg,Nd,lg,cg,Cs,pg,Ke,As,hg,Id,ug,mg,Dd,fg,_g,Sd,gg,Tg,Ls,vg,gt,Ns,kg,Od,bg,wg,Gd,yg,zg,Is,Tc,hn,Wn,Bd,Ds,xg,Ud,$g,vc,ee,Ss,qg,Wd,Eg,jg,Os,Fg,Gs,Mg,Pg,Cg,Bs,Ag,Tr,Lg,Ng,Ig,Us,Dg,Ws,Sg,Og,Gg,Ye,Rs,Bg,un,Ug,vr,Wg,Rg,Rd,Hg,Vg,Kg,Rn,Yg,Hd,Zg,Jg,Hs,Xg,Ze,Vs,Qg,Vd,eT,tT,Kd,nT,oT,Yd,sT,aT,Ks,rT,Tt,Ys,iT,Zd,dT,lT,Jd,cT,pT,Zs,kc,mn,Hn,Xd,Js,hT,Qd,uT,bc,de,Xs,mT,el,fT,_T,Qs,gT,ea,TT,vT,kT,ta,bT,kr,wT,yT,zT,na,xT,oa,$T,qT,ET,Vn,jT,Je,sa,FT,fn,MT,br,PT,CT,tl,AT,LT,NT,Kn,IT,nl,DT,ST,aa,wc,_n,Yn,ol,ra,OT,sl,GT,yc,le,ia,BT,da,UT,al,WT,RT,HT,la,VT,ca,KT,YT,ZT,pa,JT,wr,XT,QT,ev,ha,tv,ua,nv,ov,sv,Zn,av,Xe,ma,rv,gn,iv,yr,dv,lv,rl,cv,pv,hv,Jn,uv,il,mv,fv,fa,zc,Tn,Xn,dl,_a,_v,ll,gv,xc,ce,ga,Tv,cl,vv,kv,Ta,bv,va,wv,yv,zv,ka,xv,zr,$v,qv,Ev,ba,jv,wa,Fv,Mv,Pv,Qn,Cv,Qe,ya,Av,vn,Lv,xr,Nv,Iv,pl,Dv,Sv,Ov,eo,Gv,hl,Bv,Uv,za,$c,kn,to,ul,xa,Wv,ml,Rv,qc,wt,et,$a,Hv,bn,Vv,fl,Kv,Yv,_l,Zv,Jv,Xv,no,Qv,gl,ek,tk,qa,nk,Ft,Ea,ok,Tl,sk,ak,ja,rk,Mt,Fa,ik,vl,dk,lk,Ma,Ec,wn,oo,kl,Pa,ck,bl,pk,jc,yt,tt,Ca,hk,yn,uk,wl,mk,fk,yl,_k,gk,Tk,so,vk,zl,kk,bk,Aa,wk,Pt,La,yk,xl,zk,xk,Na,$k,Ct,Ia,qk,$l,Ek,jk,Da,Fc;return z=new qe({}),ae=new qe({}),bo=new qe({}),wo=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`}}),Un=new zt({props:{$$slots:{default:[Zw]},$$scope:{ctx:N}}}),Cs=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`}}),Rn=new zt({props:{$$slots:{default:[Jw]},$$scope:{ctx:N}}}),Hs=new R({props:{code:`from transformers import T5Tokenizer, T5EncoderModel
...
model.parallelize(device_map)`}}),Ys=new P({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/t5/modeling_t5.py#L1760"}}),Zs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
`}}),Jn=new zt({props:{$$slots:{default:[ty]},$$scope:{ctx:N}}}),fa=new R({props:{code:`from transformers import T5Tokenizer, TFT5ForConditionalGeneration
...
for summarization: `),W=a("em"),Le=o("summarize: \u2026"),m=o("."),j=d(),ne=a("li"),Ge=a("p"),lt=o("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),S=d(),Be=a("li"),oe=a("p"),ct=o("See the "),L=a("a"),Y=o("training"),pt=o(", "),Ne=a("a"),Z=o("inference"),ht=o(" and "),Ie=a("a"),De=o("scripts"),ut=o(" sections below for all details regarding usage."),Dl=d(),Ba=a("p"),qp=o("T5 comes in different sizes:"),Sl=d(),Ue=a("ul"),ei=a("li"),ti=a("p"),uo=a("a"),Ep=o("t5-small"),jp=d(),ni=a("li"),oi=a("p"),mo=a("a"),Fp=o("t5-base"),Mp=d(),si=a("li"),ai=a("p"),fo=a("a"),Pp=o("t5-large"),Cp=d(),ri=a("li"),ii=a("p"),_o=a("a"),Ap=o("t5-3b"),Lp=d(),di=a("li"),Ua=a("p"),go=a("a"),Np=o("t5-11b"),Ip=o("."),Ol=d(),Wa=a("p"),Dp=o("Based on the original T5 model, Google has released some follow-up works:"),Gl=d(),xt=a("ul"),li=a("li"),zn=a("p"),ci=a("strong"),Sp=o("T5v1.1"),Op=o(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
the documentation of mT5 which can be found `),Ha=a("a"),Hp=o("here"),Vp=o("."),Kp=d(),ui=a("li"),$n=a("p"),mi=a("strong"),Yp=o("byT5"),Zp=o(`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),Va=a("a"),Jp=o("here"),Xp=o("."),Bl=d(),qn=a("p"),Qp=o("All checkpoints can be found on the "),To=a("a"),eh=o("hub"),th=o("."),Ul=d(),$t=a("p"),nh=o("This model was contributed by "),vo=a("a"),oh=o("thomwolf"),sh=o(". The original code can be found "),ko=a("a"),ah=o("here"),rh=o("."),Wl=d(),Ka=a("a"),Rl=d(),Yt=a("h2"),En=a("a"),fi=a("span"),f(bo.$$.fragment),ih=d(),_i=a("span"),dh=o("Training"),Hl=d(),mt=a("p"),lh=o(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
`),Za=a("a"),Ph=o("T5Tokenizer"),Ch=o("."),Ah=d(),$i=a("p"),Lh=o(`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
`),Fi=a("code"),Zh=o("input_ids"),Jh=o(" of the encoded input sequence) and "),Mi=a("code"),Xh=o("labels"),Qh=o(" (which are the "),Pi=a("code"),eu=o("input_ids"),tu=o(` of the encoded
...
during T5\u2019s pre-training.`),du=d(),Zt=a("p"),lu=o(`However, the example above only shows a single training example. In practice, one trains deep learning models in
...
ignored. The code example below illustrates all of this.`),Eu=d(),f(qo.$$.fragment),Yl=d(),Ja=a("p"),ju=o("Additional training tips:"),Zl=d(),qt=a("ul"),Ui=a("li"),Eo=a("p"),Fu=o("T5 models need a slightly higher learning rate than the default one set in the "),Wi=a("code"),Mu=o("Trainer"),Pu=o(` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Cu=d(),Ri=a("li"),Jt=a("p"),Au=o("According to "),jo=a("a"),Lu=o("this forum post"),Nu=o(`, task prefixes matter when
...
batch) leads to very slow training on TPU.`),Jl=d(),Xa=a("a"),Xl=d(),Xt=a("h2"),Mn=a("a"),Ki=a("span"),f(Po.$$.fragment),Uu=d(),Yi=a("span"),Wu=o("Inference"),Ql=d(),ft=a("p"),Ru=o("At inference time, it is recommended to use "),Qa=a("a"),Hu=o("generate()"),Vu=o(`. This
...
There\u2019s also `),Ao=a("a"),Zu=o("this blog post"),Ju=o(` which explains how
generation works in general in encoder-decoder models.`),ec=d(),f(Lo.$$.fragment),tc=d(),We=a("p"),Xu=o("Note that T5 uses the "),Zi=a("code"),Qu=o("pad_token_id"),em=o(" as the "),Ji=a("code"),tm=o("decoder_start_token_id"),nm=o(`, so when doing generation without using
...
documentation from `),ir=a("a"),Bm=o("PretrainedConfig"),Um=o(" for more information."),cc=d(),on=a("h2"),Ln=a("a"),ad=a("span"),f(Ko.$$.fragment),Wm=d(),rd=a("span"),Rm=o("T5Tokenizer"),pc=d(),J=a("div"),f(Yo.$$.fragment),Hm=d(),Zo=a("p"),Vm=o("Construct a T5 tokenizer. Based on "),Jo=a("a"),Km=o("SentencePiece"),Ym=o("."),Zm=d(),Xo=a("p"),Jm=o("This tokenizer inherits from "),dr=a("a"),Xm=o("PreTrainedTokenizer"),Qm=o(` which contains most of the main methods. Users should refer to
...
use of token type ids, therefore a list of zeros is returned.`),mc=d(),dn=a("h2"),On=a("a"),wd=a("span"),f(ps.$$.fragment),Yf=d(),yd=a("span"),Zf=o("T5Model"),fc=d(),X=a("div"),f(hs.$$.fragment),Jf=d(),zd=a("p"),Xf=o("The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Qf=d(),us=a("p"),e_=o("The T5 model was proposed in "),ms=a("a"),t_=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Z_=d(),Fs=a("p"),J_=o("This model is also a PyTorch "),Ms=a("a"),X_=o("torch.nn.Module"),Q_=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
for summarization: `),W=r(qr,"EM",{});var Ok=i(W);Le=s(Ok,"summarize: \u2026"),Ok.forEach(t),m=s(qr,"."),qr.forEach(t),Dk.forEach(t),j=l($r),ne=r($r,"LI",{});var Gk=i(ne);Ge=r(Gk,"P",{});var Bk=i(Ge);lt=s(Bk,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),Bk.forEach(t),Gk.forEach(t),S=l($r),Be=r($r,"LI",{});var Uk=i(Be);oe=r(Uk,"P",{});var ao=i(oe);ct=s(ao,"See the "),L=r(ao,"A",{href:!0});var Wk=i(L);Y=s(Wk,"training"),Wk.forEach(t),pt=s(ao,", "),Ne=r(ao,"A",{href:!0});var Rk=i(Ne);Z=s(Rk,"inference"),Rk.forEach(t),ht=s(ao," and "),Ie=r(ao,"A",{href:!0});var Hk=i(Ie);De=s(Hk,"scripts"),Hk.forEach(t),ut=s(ao," sections below for all details regarding usage."),ao.forEach(t),Uk.forEach(t),$r.forEach(t),Dl=l(n),Ba=r(n,"P",{});var Vk=i(Ba);qp=s(Vk,"T5 comes in different sizes:"),Vk.forEach(t),Sl=l(n),Ue=r(n,"UL",{});var At=i(Ue);ei=r(At,"LI",{});var Kk=i(ei);ti=r(Kk,"P",{});var Yk=i(ti);uo=r(Yk,"A",{href:!0,rel:!0});var Zk=i(uo);Ep=s(Zk,"t5-small"),Zk.forEach(t),Yk.forEach(t),Kk.forEach(t),jp=l(At),ni=r(At,"LI",{});var Jk=i(ni);oi=r(Jk,"P",{});var Xk=i(oi);mo=r(Xk,"A",{href:!0,rel:!0});var Qk=i(mo);Fp=s(Qk,"t5-base"),Qk.forEach(t),Xk.forEach(t),Jk.forEach(t),Mp=l(At),si=r(At,"LI",{});var eb=i(si);ai=r(eb,"P",{});var tb=i(ai);fo=r(tb,"A",{href:!0,rel:!0});var nb=i(fo);Pp=s(nb,"t5-large"),nb.forEach(t),tb.forEach(t),eb.forEach(t),Cp=l(At),ri=r(At,"LI",{});var ob=i(ri);ii=r(ob,"P",{});var sb=i(ii);_o=r(sb,"A",{href:!0,rel:!0});var ab=i(_o);Ap=s(ab,"t5-3b"),ab.forEach(t),sb.forEach(t),ob.forEach(t),Lp=l(At),di=r(At,"LI",{});var rb=i(di);Ua=r(rb,"P",{});var Fk=i(Ua);go=r(Fk,"A",{href:!0,rel:!0});var ib=i(go);Np=s(ib,"t5-11b"),ib.forEach(t),Ip=s(Fk,"."),Fk.forEach(t),rb.forEach(t),At.forEach(t),Ol=l(n),Wa=r(n,"P",{});var db=i(Wa);Dp=s(db,"Based on the original T5 model, Google has released some follow-up works:"),db.forEach(t),Gl=l(n),xt=r(n,"UL",{});var Er=i(xt);li=r(Er,"LI",{});var lb=i(li);zn=r(lb,"P",{});var Ll=i(zn);ci=r(Ll,"STRONG",{});var cb=i(ci);Sp=s(cb,"T5v1.1"),cb.forEach(t),Op=s(Ll,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
`),Za=r(nt,"A",{href:!0});var Ab=i(Za);Ph=s(Ab,"T5Tokenizer"),Ab.forEach(t),Ch=s(nt,"."),nt.forEach(t),Ah=l(Lt),$i=r(Lt,"P",{});var Lb=i($i);Lh=s(Lb,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
`),Fi=r(we,"CODE",{});var Ob=i(Fi);Zh=s(Ob,"input_ids"),Ob.forEach(t),Jh=s(we," of the encoded input sequence) and "),Mi=r(we,"CODE",{});var Gb=i(Mi);Xh=s(Gb,"labels"),Gb.forEach(t),Qh=s(we," (which are the "),Pi=r(we,"CODE",{});var Bb=i(Pi);eu=s(Bb,"input_ids"),Bb.forEach(t),tu=s(we,` of the encoded
...
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
during T5\u2019s pre-training.`),we.forEach(t),du=l(ot),Zt=r(ot,"P",{});var Fr=i(Zt);lu=s(Fr,`However, the example above only shows a single training example. In practice, one trains deep learning models in
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
...
of the `),Oi=r(st,"CODE",{});var Zb=i(Oi);ku=s(Zb,"CrossEntropyLoss"),Zb.forEach(t),bu=s(st,". In Flax, one can use the "),Gi=r(st,"CODE",{});var Jb=i(Gi);wu=s(Jb,"decoder_attention_mask"),Jb.forEach(t),yu=s(st,` to ignore padded tokens from
...
ignored. The code example below illustrates all of this.`),st.forEach(t),Eu=l(ot),_(qo.$$.fragment,ot),ot.forEach(t),Ac.forEach(t),Yl=l(n),Ja=r(n,"P",{});var e1=i(Ja);ju=s(e1,"Additional training tips:"),e1.forEach(t),Zl=l(n),qt=r(n,"UL",{});var Mr=i(qt);Ui=r(Mr,"LI",{});var t1=i(Ui);Eo=r(t1,"P",{});var Nc=i(Eo);Fu=s(Nc,"T5 models need a slightly higher learning rate than the default one set in the "),Wi=r(Nc,"CODE",{});var n1=i(Wi);Mu=s(n1,"Trainer"),n1.forEach(t),Pu=s(Nc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Nc.forEach(t),t1.forEach(t),Cu=l(Mr),Ri=r(Mr,"LI",{});var o1=i(Ri);Jt=r(o1,"P",{});var Pr=i(Jt);Au=s(Pr,"According to "),jo=r(Pr,"A",{href:!0,rel:!0});var s1=i(jo);Lu=s(s1,"this forum post"),s1.forEach(t),Nu=s(Pr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),Ic.forEach(t),r1.forEach(t),Mr.forEach(t),Jl=l(n),Xa=r(n,"A",{id:!0}),i(Xa).forEach(t),Xl=l(n),Xt=r(n,"H2",{class:!0});var Dc=i(Xt);Mn=r(Dc,"A",{id:!0,class:!0,href:!0});var d1=i(Mn);Ki=r(d1,"SPAN",{});var l1=i(Ki);_(Po.$$.fragment,l1),l1.forEach(t),d1.forEach(t),Uu=l(Dc),Yi=r(Dc,"SPAN",{});var c1=i(Yi);Wu=s(c1,"Inference"),c1.forEach(t),Dc.forEach(t),Ql=l(n),ft=r(n,"P",{});var io=i(ft);Ru=s(io,"At inference time, it is recommended to use "),Qa=r(io,"A",{href:!0});var p1=i(Qa);Hu=s(p1,"generate()"),p1.forEach(t),Vu=s(io,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
...
There\u2019s also `),Ao=r(io,"A",{href:!0,rel:!0});var u1=i(Ao);Zu=s(u1,"this blog post"),u1.forEach(t),Ju=s(io,` which explains how
generation works in general in encoder-decoder models.`),io.forEach(t),ec=l(n),_(Lo.$$.fragment,n),tc=l(n),We=r(n,"P",{});var Nt=i(We);Xu=s(Nt,"Note that T5 uses the "),Zi=r(Nt,"CODE",{});var m1=i(Zi);Qu=s(m1,"pad_token_id"),m1.forEach(t),em=s(Nt," as the "),Ji=r(Nt,"CODE",{});var f1=i(Ji);tm=s(f1,"decoder_start_token_id"),f1.forEach(t),nm=s(Nt,`, so when doing generation without using
...
special tokens using the tokenizer `),hd=r(Vc,"CODE",{});var Z1=i(hd);vf=s(Z1,"prepare_for_model"),Z1.forEach(t),kf=s(Vc," method."),Vc.forEach(t),Hc.forEach(t),bf=l(ye),In=r(ye,"DIV",{class:!0});var Kc=i(In);_(os.$$.fragment,Kc),wf=l(Kc),ud=r(Kc,"P",{});var J1=i(ud);yf=s(J1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),J1.forEach(t),Kc.forEach(t),zf=l(ye),md=r(ye,"DIV",{class:!0}),i(md).forEach(t),ye.forEach(t),hc=l(n),an=r(n,"H2",{class:!0});var Yc=i(an);Dn=r(Yc,"A",{id:!0,class:!0,href:!0});var X1=i(Dn);fd=r(X1,"SPAN",{});var Q1=i(fd);_(ss.$$.fragment,Q1),Q1.forEach(t),X1.forEach(t),xf=l(Yc),_d=r(Yc,"SPAN",{});var e5=i(_d);$f=s(e5,"T5TokenizerFast"),e5.forEach(t),Yc.forEach(t),uc=l(n),Oe=r(n,"DIV",{class:!0});var It=i(Oe);_(as.$$.fragment,It),qf=l(It),rn=r(It,"P",{});var Dr=i(rn);Ef=s(Dr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),gd=r(Dr,"EM",{});var t5=i(gd);jf=s(t5,"tokenizers"),t5.forEach(t),Ff=s(Dr,` library). Based on
`),rs=r(Dr,"A",{href:!0,rel:!0});var n5=i(rs);Mf=s(n5,"Unigram"),n5.forEach(t),Pf=s(Dr,"."),Dr.forEach(t),Cf=l(It),is=r(It,"P",{});var Zc=i(is);Af=s(Zc,"This tokenizer inherits from "),pr=r(Zc,"A",{href:!0});var o5=i(pr);Lf=s(o5,"PreTrainedTokenizerFast"),o5.forEach(t),Nf=s(Zc,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Zc.forEach(t),If=l(It),jt=r(It,"DIV",{class:!0});var Sr=i(jt);_(ds.$$.fragment,Sr),Df=l(Sr),Td=r(Sr,"P",{});var s5=i(Td);Sf=s(s5,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),s5.forEach(t),Of=l(Sr),ls=r(Sr,"UL",{});var Jc=i(ls);hr=r(Jc,"LI",{});var Ck=i(hr);Gf=s(Ck,"single sequence: "),vd=r(Ck,"CODE",{});var a5=i(vd);Bf=s(a5,"X </s>"),a5.forEach(t),Ck.forEach(t),Uf=l(Jc),ur=r(Jc,"LI",{});var Ak=i(ur);Wf=s(Ak,"pair of sequences: "),kd=r(Ak,"CODE",{});var r5=i(kd);Rf=s(r5,"A </s> B </s>"),r5.forEach(t),Ak.forEach(t),Jc.forEach(t),Sr.forEach(t),Hf=l(It),Sn=r(It,"DIV",{class:!0});var Xc=i(Sn);_(cs.$$.fragment,Xc),Vf=l(Xc),bd=r(Xc,"P",{});var i5=i(bd);Kf=s(i5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),i5.forEach(t),Xc.forEach(t),It.forEach(t),mc=l(n),dn=r(n,"H2",{class:!0});var Qc=i(dn);On=r(Qc,"A",{id:!0,class:!0,href:!0});var d5=i(On);wd=r(d5,"SPAN",{});var l5=i(wd);_(ps.$$.fragment,l5),l5.forEach(t),d5.forEach(t),Yf=l(Qc),yd=r(Qc,"SPAN",{});var c5=i(yd);Zf=s(c5,"T5Model"),c5.forEach(t),Qc.forEach(t),fc=l(n),X=r(n,"DIV",{class:!0});var ze=i(X);_(hs.$$.fragment,ze),Jf=l(ze),zd=r(ze,"P",{});var p5=i(zd);Xf=s(p5,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),p5.forEach(t),Qf=l(ze),us=r(ze,"P",{});var ep=i(us);e_=s(ep,"The T5 model was proposed in "),ms=r(ep,"A",{href:!0,rel:!0});var h5=i(ms);t_=s(h5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rp.forEach(t),Z_=l(xe),Fs=r(xe,"P",{});var ip=i(Fs);J_=s(ip,"This model is also a PyTorch "),Ms=r(ip,"A",{href:!0,rel:!0});var j5=i(Ms);X_=s(j5,"torch.nn.Module"),j5.forEach(t),Q_=s(ip,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pp.forEach(t),Gg=l($e),Ye=r($e,"DIV",{class:!0});var Bt=i(Ye);_(Rs.$$.fragment,Bt),Bg=l(Bt),un=r(Bt,"P",{});var Br=i(un);Ug=s(Br,"The "),vr=r(Br,"A",{href:!0});var R5=i(vr);Wg=s(R5,"T5EncoderModel"),R5.forEach(t),Rg=s(Br," forward method, overrides the "),Rd=r(Br,"CODE",{});var H5=i(Rd);Hg=s(H5,"__call__"),H5.forEach(t),Vg=s(Br," special method."),Br.forEach(t),Kg=l(Bt),_(Rn.$$.fragment,Bt),Yg=l(Bt),Hd=r(Bt,"P",{});var V5=i(Hd);Zg=s(V5,"Example:"),V5.forEach(t),Jg=l(Bt),_(Hs.$$.fragment,Bt),Bt.forEach(t),Xg=l($e),Ze=r($e,"DIV",{class:!0});var Ut=i(Ze);_(Vs.$$.fragment,Ut),Qg=l(Ut),Vd=r(Ut,"P",{});var K5=i(Vd);eT=s(K5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),K5.forEach(t),tT=l(Ut),Kd=r(Ut,"P",{});var Y5=i(Kd);nT=s(Y5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Y5.forEach(t),oT=l(Ut),Yd=r(Ut,"P",{});var Z5=i(Yd);sT=s(Z5,"Example:"),Z5.forEach(t),aT=l(Ut),_(Ks.$$.fragment,Ut),Ut.forEach(t),rT=l($e),Tt=r($e,"DIV",{class:!0});var ho=i(Tt);_(Ys.$$.fragment,ho),iT=l(ho),Zd=r(ho,"P",{});var J5=i(Zd);dT=s(J5,"Moves the model to cpu from a model parallel state."),J5.forEach(t),lT=l(ho),Jd=r(ho,"P",{});var X5=i(Jd);cT=s(X5,"Example:"),X5.forEach(t),pT=l(ho),_(Zs.$$.fragment,ho),ho.forEach(t),$e.forEach(t),kc=l(n),mn=r(n,"H2",{class:!0});var hp=i(mn);Hn=r(hp,"A",{id:!0,class:!0,href:!0});var Q5=i(Hn);Xd=r(Q5,"SPAN",{});var ew=i(Xd);_(Js.$$.fragment,ew),ew.forEach(t),Q5.forEach(t),hT=l(hp),Qd=r(hp,"SPAN",{});var tw=i(Qd);uT=s(tw,"TFT5Model"),tw.forEach(t),hp.forEach(t),bc=l(n),de=r(n,"DIV",{class:!0});var at=i(de);_(Xs.$$.fragment,at),mT=l(at),el=r(at,"P",{});var nw=i(el);fT=s(nw,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),nw.forEach(t),_T=l(at),Qs=r(at,"P",{});var up=i(Qs);gT=s(up,"The T5 model was proposed in "),ea=r(up,"A",{href:!0,rel:!0});var ow=i(ea);TT=s(ow,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
