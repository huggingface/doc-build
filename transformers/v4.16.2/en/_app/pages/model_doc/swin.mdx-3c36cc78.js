import{S as Fn,i as qn,s as zn,e as n,k as c,w,t as r,M as Nn,c as a,d as o,m as h,a as s,x as v,h as i,b as l,N as On,F as t,g as f,y as b,q as S,o as y,B as $}from"../../chunks/vendor-ab4e3193.js";import{T as jn}from"../../chunks/Tip-b5c6375a.js";import{D as ot}from"../../chunks/Docstring-91f1beab.js";import{C as Yo}from"../../chunks/CodeBlock-516df0c5.js";import{I as nt}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Ln(ee){let m,T,p,u,E;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=r("Module"),E=r(`
...
`}}),R=new jn({props:{$$slots:{default:[Ln]},$$scope:{ctx:ee}}}),ue=new Yo({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),lt=c(),xe=n("p"),Nt=r("Tips:"),dt=c(),Ce=n("ul"),ne=n("li"),Ot=r("One can use the "),Ee=n("a"),Lt=r("AutoFeatureExtractor"),Dt=r(" API to prepare images for the model."),ct=c(),V=n("img"),ht=c(),K=n("small"),Wt=r("Swin Transformer architecture. Taken from the "),ke=n("a"),Ht=r("original paper"),Bt=r("."),ft=c(),A=n("p"),Ut=r("This model was contributed by "),ae=n("a"),Vt=r("novice03"),Kt=r(". The original code can be found "),se=n("a"),Yt=r("here"),Zt=r("."),mt=c(),N=n("h2"),Y=n("a"),Be=n("span"),w(re.$$.fragment),Rt=c(),Ue=n("span"),Gt=r("SwinConfig"),pt=c(),k=n("div"),w(ie.$$.fragment),Jt=c(),O=n("p"),Qt=r("This is the configuration class to store the configuration of a "),Me=n("a"),Xt=r("SwinModel"),eo=r(`. It is used to instantiate a Swin
...
architecture.`),no=c(),L=n("p"),ao=r("Configuration objects inherit from "),Pe=n("a"),so=r("PretrainedConfig"),ro=r(` and can be used to control the model outputs. Read the
...
(53.5 mIoU on ADE20K val). Its performance surpasses the previous state-of-the-art by a large margin of +2.7 box AP and
+2.6 mask AP on COCO, and +3.2 mIoU on ADE20K, demonstrating the potential of Transformer-based models as vision backbones.
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),nn.forEach(o),on.forEach(o),lt=h(e),xe=a(e,"P",{});var an=s(xe);Nt=i(an,"Tips:"),an.forEach(o),dt=h(e),Ce=a(e,"UL",{});var sn=s(Ce);ne=a(sn,"LI",{});var St=s(ne);Ot=i(St,"One can use the "),Ee=a(St,"A",{href:!0});var rn=s(Ee);Lt=i(rn,"AutoFeatureExtractor"),rn.forEach(o),Dt=i(St," API to prepare images for the model."),St.forEach(o),sn.forEach(o),ct=h(e),V=a(e,"IMG",{src:!0,alt:!0,width:!0}),ht=h(e),K=a(e,"SMALL",{});var yt=s(K);Wt=i(yt,"Swin Transformer architecture. Taken from the "),ke=a(yt,"A",{href:!0});var ln=s(ke);Ht=i(ln,"original paper"),ln.forEach(o),Bt=i(yt,"."),yt.forEach(o),ft=h(e),A=a(e,"P",{});var Fe=s(A);Ut=i(Fe,"This model was contributed by "),ae=a(Fe,"A",{href:!0,rel:!0});var dn=s(ae);Vt=i(dn,"novice03"),dn.forEach(o),Kt=i(Fe,". The original code can be found "),se=a(Fe,"A",{href:!0,rel:!0});var cn=s(se);Yt=i(cn,"here"),cn.forEach(o),Zt=i(Fe,"."),Fe.forEach(o),mt=h(e),N=a(e,"H2",{class:!0});var $t=s(N);Y=a($t,"A",{id:!0,class:!0,href:!0});var hn=s(Y);Be=a(hn,"SPAN",{});var fn=s(Be);v(re.$$.fragment,fn),fn.forEach(o),hn.forEach(o),Rt=h($t),Ue=a($t,"SPAN",{});var mn=s(Ue);Gt=i(mn,"SwinConfig"),mn.forEach(o),$t.forEach(o),pt=h(e),k=a(e,"DIV",{class:!0});var Q=s(k);v(ie.$$.fragment,Q),Jt=h(Q),O=a(Q,"P",{});var qe=s(O);Qt=i(qe,"This is the configuration class to store the configuration of a "),Me=a(qe,"A",{href:!0});var pn=s(Me);Xt=i(pn,"SwinModel"),pn.forEach(o),eo=i(qe,`. It is used to instantiate a Swin
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the Swin
`),le=a(qe,"A",{href:!0,rel:!0});var un=s(le);to=i(un,"microsoft/swin-tiny-patch4-window7-224"),un.forEach(o),oo=i(qe,`
architecture.`),qe.forEach(o),no=h(Q),L=a(Q,"P",{});var ze=s(L);ao=i(ze,"Configuration objects inherit from "),Pe=a(ze,"A",{href:!0});var gn=s(Pe);so=i(gn,"PretrainedConfig"),gn.forEach(o),ro=i(ze,` and can be used to control the model outputs. Read the
documentation from `),Ie=a(ze,"A",{href:!0});var _n=s(Ie);io=i(_n,"PretrainedConfig"),_n.forEach(o),lo=i(ze," for more information."),ze.forEach(o),co=h(Q),v(de.$$.fragment,Q),Q.forEach(o),ut=h(e),D=a(e,"H2",{class:!0});var Tt=s(D);Z=a(Tt,"A",{id:!0,class:!0,href:!0});var wn=s(Z);Ve=a(wn,"SPAN",{});var vn=s(Ve);v(ce.$$.fragment,vn),vn.forEach(o),wn.forEach(o),ho=h(Tt),Ke=a(Tt,"SPAN",{});var bn=s(Ke);fo=i(bn,"SwinModel"),bn.forEach(o),Tt.forEach(o),gt=h(e),I=a(e,"DIV",{class:!0});var Ne=s(I);v(he.$$.fragment,Ne),mo=h(Ne),fe=a(Ne,"P",{});var xt=s(fe);po=i(xt,`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),me=a(xt,"A",{href:!0,rel:!0});var Sn=s(me);uo=i(Sn,"torch.nn.Module"),Sn.forEach(o),go=i(xt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),xt.forEach(o),_o=h(Ne),x=a(Ne,"DIV",{class:!0});var j=s(x);v(pe.$$.fragment,j),wo=h(j),W=a(j,"P",{});var Oe=s(W);vo=i(Oe,"The "),Ae=a(Oe,"A",{href:!0});var yn=s(Ae);bo=i(yn,"SwinModel"),yn.forEach(o),So=i(Oe," forward method, overrides the "),Ye=a(Oe,"CODE",{});var $n=s(Ye);yo=i($n,"__call__"),$n.forEach(o),$o=i(Oe," special method."),Oe.forEach(o),To=h(j),v(R.$$.fragment,j),xo=h(j),Ze=a(j,"P",{});var Tn=s(Ze);Co=i(Tn,"Examples:"),Tn.forEach(o),Eo=h(j),v(ue.$$.fragment,j),j.forEach(o),Ne.forEach(o),_t=h(e),H=a(e,"H2",{class:!0});var Ct=s(H);G=a(Ct,"A",{id:!0,class:!0,href:!0});var xn=s(G);Re=a(xn,"SPAN",{});var Cn=s(Re);v(ge.$$.fragment,Cn),Cn.forEach(o),xn.forEach(o),ko=h(Ct),Ge=a(Ct,"SPAN",{});var En=s(Ge);Mo=i(En,"SwinForImageClassification"),En.forEach(o),Ct.forEach(o),wt=h(e),M=a(e,"DIV",{class:!0});var X=s(M);v(_e.$$.fragment,X),Po=h(X),Je=a(X,"P",{});var kn=s(Je);Io=i(kn,`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
