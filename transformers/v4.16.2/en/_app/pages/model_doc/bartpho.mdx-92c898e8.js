import{S as Uo,i as Go,s as Ho,e as s,k as p,w as v,t as r,M as Ko,c as n,d as o,m as c,a,x as T,h as i,b as d,F as t,g as h,y as w,L as Qo,q as y,o as q,B}from"../../chunks/vendor-ab4e3193.js";import{D as Pe}from"../../chunks/Docstring-91f1beab.js";import{C as Wo}from"../../chunks/CodeBlock-516df0c5.js";import{I as ho}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Jo(nt){let _,ee,f,g,ge,S,at,_e,rt,je,z,R,ke,M,it,be,lt,Le,x,pt,I,ct,dt,De,te,ht,Se,oe,ve,mt,Me,se,ut,Ie,N,Ne,ne,ft,Ce,ae,C,gt,re,_t,kt,Oe,O,Fe,ie,Te,bt,Ve,k,vt,F,Tt,wt,V,yt,qt,Xe,A,P,we,X,Bt,ye,zt,We,m,W,At,$,$t,le,Et,Rt,U,xt,Pt,jt,G,Lt,pe,Dt,St,Mt,E,It,qe,Nt,Ct,Be,Ot,Ft,Vt,b,H,Xt,ze,Wt,Ut,K,ce,Gt,Ae,Ht,Kt,de,Qt,$e,Jt,Yt,j,Q,Zt,Ee,eo,to,L,J,oo,Re,so,no,D,Y,ao,Z,ro,xe,io,lo,Ue;return S=new ho({}),M=new ho({}),N=new Wo({props:{code:`import torch
...
adding special tokens. An BARTPho sequence has the following format:`),Ut=p(),K=s("ul"),ce=s("li"),Gt=r("single sequence: "),Ae=s("code"),Ht=r("<s> X </s>"),Kt=p(),de=s("li"),Qt=r("pair of sequences: "),$e=s("code"),Jt=r("<s> A </s></s> B </s>"),Yt=p(),j=s("div"),v(Q.$$.fragment),Zt=p(),Ee=s("p"),eo=r("Converts a sequence of tokens (strings for sub-words) in a single string."),to=p(),L=s("div"),v(J.$$.fragment),oo=p(),Re=s("p"),so=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
