...
Zhang, Ming Zhou on 13 Jan, 2020.`),Ut=p(),Ue=o("p"),Ys=a(`XLM-ProphetNet is an encoder-decoder model and can predict n-future tokens for \u201Cngram\u201D language modeling instead of
just the next token. Its architecture is identical to ProhpetNet, but the model was trained on the multi-lingual
\u201Cwiki100\u201D Wikipedia dump.`),Yt=p(),Ye=o("p"),Js=a("The abstract from the paper is the following:"),Jt=p(),Je=o("p"),ft=o("em"),Qs=a(`In this paper, we present a new sequence-to-sequence pretraining model called ProphetNet, which introduces a novel
...
adding special tokens. A XLMProphetNet sequence has the following format:`),jo=p(),be=o("ul"),tt=o("li"),xo=a("single sequence: "),Nt=o("code"),zo=a("X [SEP]"),To=p(),st=o("li"),Do=a("pair of sequences: "),$t=o("code"),Co=a("A [SEP] B [SEP]"),Ao=p(),Y=o("div"),m(Ne.$$.fragment),So=p(),Lt=o("p"),Io=a("Converts a sequence of tokens (strings for sub-words) in a single string."),Fo=p(),J=o("div"),m($e.$$.fragment),Go=p(),Mt=o("p"),Bo=a(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLMProphetNet
...
special tokens using the tokenizer `),Et=o("code"),Vo=a("prepare_for_model"),Wo=a(" method."),ss=p(),S=o("h2"),Z=o("a"),qt=o("span"),m(Ee.$$.fragment),Uo=p(),yt=o("span"),Yo=a("XLMProphetNetModel"),os=p(),w=o("div"),m(qe.$$.fragment),Jo=p(),ye=o("p"),Qo=a("This class overrides "),ot=o("a"),Zo=a("ProphetNetModel"),Ko=a(`. Please check the superclass for the appropriate documentation alongside
...
alongside usage examples.`),Cr=p(),Bt=o("p"),Ar=a("Example:"),Sr=p(),m(Ve.$$.fragment),this.h()},l(e){const c=Yn('[data-svelte="svelte-1phssyn"]',document.head);X=r(c,"META",{name:!0,content:!0}),c.forEach(s),We=d(e),M=r(e,"H1",{class:!0});var ms=n(M);E=r(ms,"A",{id:!0,class:!0,href:!0});var Gr=n(E);dt=r(Gr,"SPAN",{});var Br=n(dt);u(pe.$$.fragment,Br),Br.forEach(s),Gr.forEach(s),Ss=d(ms),ct=r(ms,"SPAN",{});var Rr=n(ct);Is=i(Rr,"XLM-ProphetNet"),Rr.forEach(s),ms.forEach(s),Ht=d(e),x=r(e,"P",{});var Rt=n(x);ht=r(Rt,"STRONG",{});var Or=n(ht);Fs=i(Or,"DISCLAIMER:"),Or.forEach(s),Gs=i(Rt," If you see something strange, file a "),de=r(Rt,"A",{href:!0,rel:!0});var Hr=n(de);Bs=i(Hr,"Github Issue"),Hr.forEach(s),Rs=i(Rt,` and assign
@patrickvonplaten`),Rt.forEach(s),Vt=d(e),z=r(e,"H2",{class:!0});var us=n(z);O=r(us,"A",{id:!0,class:!0,href:!0});var Vr=n(O);mt=r(Vr,"SPAN",{});var Wr=n(mt);u(ce.$$.fragment,Wr),Wr.forEach(s),Vr.forEach(s),Os=d(us),ut=r(us,"SPAN",{});var Ur=n(ut);Hs=i(Ur,"Overview"),Ur.forEach(s),us.forEach(s),Wt=d(e),H=r(e,"P",{});var fs=n(H);Vs=i(fs,"The XLM-ProphetNet model was proposed in "),he=r(fs,"A",{href:!0,rel:!0});var Yr=n(he);Ws=i(Yr,"ProphetNet: Predicting Future N-gram for Sequence-to-Sequence Pre-training,"),Yr.forEach(s),Us=i(fs,` by Yu Yan, Weizhen Qi, Yeyun Gong, Dayiheng Liu, Nan Duan, Jiusheng Chen, Ruofei
Zhang, Ming Zhou on 13 Jan, 2020.`),fs.forEach(s),Ut=d(e),Ue=r(e,"P",{});var Jr=n(Ue);Ys=i(Jr,`XLM-ProphetNet is an encoder-decoder model and can predict n-future tokens for \u201Cngram\u201D language modeling instead of
just the next token. Its architecture is identical to ProhpetNet, but the model was trained on the multi-lingual
\u201Cwiki100\u201D Wikipedia dump.`),Jr.forEach(s),Yt=d(e),Ye=r(e,"P",{});var Qr=n(Ye);Js=i(Qr,"The abstract from the paper is the following:"),Qr.forEach(s),Jt=d(e),Je=r(e,"P",{});var Zr=n(Je);ft=r(Zr,"EM",{});var Kr=n(ft);Qs=i(Kr,`In this paper, we present a new sequence-to-sequence pretraining model called ProphetNet, which introduces a novel
self-supervised objective named future n-gram prediction and the proposed n-stream self-attention mechanism. Instead of
the optimization of one-step ahead prediction in traditional sequence-to-sequence model, the ProphetNet is optimized by
n-step ahead prediction which predicts the next n tokens simultaneously based on previous context tokens at each time
step. The future n-gram prediction explicitly encourages the model to plan for the future tokens and prevent
...
special tokens using the tokenizer `),Et=r(Ms,"CODE",{});var Pn=n(Et);Vo=i(Pn,"prepare_for_model"),Pn.forEach(s),Wo=i(Ms," method."),Ms.forEach(s),Ls.forEach(s),P.forEach(s),ss=d(e),S=r(e,"H2",{class:!0});var Es=n(S);Z=r(Es,"A",{id:!0,class:!0,href:!0});var wn=n(Z);qt=r(wn,"SPAN",{});var bn=n(qt);u(Ee.$$.fragment,bn),bn.forEach(s),wn.forEach(s),Uo=d(Es),yt=r(Es,"SPAN",{});var Nn=n(yt);Yo=i(Nn,"XLMProphetNetModel"),Nn.forEach(s),Es.forEach(s),os=d(e),w=r(e,"DIV",{class:!0});var re=n(w);u(qe.$$.fragment,re),Jo=d(re),ye=r(re,"P",{});var qs=n(ye);Qo=i(qs,"This class overrides "),ot=r(qs,"A",{href:!0});var $n=n(ot);Zo=i($n,"ProphetNetModel"),$n.forEach(s),Ko=i(qs,`. Please check the superclass for the appropriate documentation alongside
