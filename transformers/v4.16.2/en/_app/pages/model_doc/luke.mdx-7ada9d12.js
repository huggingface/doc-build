...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function ip(O){let h,L,m,w,E;return{c(){h=a("p"),L=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),w=o("Module"),E=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function rp(O){let h,L,m,w,E;return{c(){h=a("p"),L=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),w=o("Module"),E=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function dp(O){let h,L,m,w,E;return{c(){h=a("p"),L=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),w=o("Module"),E=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function lp(O){let h,L,m,w,E;return{c(){h=a("p"),L=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),w=o("Module"),E=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function cp(O){let h,L,m,w,E,g,f,z,Ds,Ro,le,xe,Sn,He,Bs,Nn,Ws,Ho,$e,Os,Ve,Us,Ks,Vo,Qt,Rs,Yo,Jt,Dn,Hs,Qo,Xt,Vs,Jo,R,Bn,Ye,Ys,Gt,Qs,Js,Xs,Wn,q,Gs,On,Zs,ea,Un,ta,na,Kn,oa,sa,Rn,aa,ia,Zt,ra,da,la,Qe,H,en,ca,pa,Hn,ha,ua,Vn,ma,fa,Yn,ga,_a,ka,Je,tn,Qn,ya,va,ba,nn,Jn,Ta,wa,La,U,Xn,Ea,za,ce,qe,on,xa,$a,Xe,qa,Ma,Ca,Me,sn,Fa,Pa,Ge,ja,Aa,Ia,an,rn,Sa,Na,Da,S,dn,Ba,Wa,Gn,Oa,Ua,Zn,Ka,Ra,eo,Ha,Va,to,Ya,Qa,Ja,pe,Xa,ln,Ga,Za,Ze,ei,ti,ni,et,oi,tt,si,ai,Xo,cn,ii,Go,nt,Zo,V,ri,ot,di,li,st,ci,pi,at,hi,ui,es,he,Ce,no,it,mi,oo,fi,ts,M,rt,gi,dt,_i,pn,ki,yi,vi,ue,bi,hn,Ti,wi,un,Li,Ei,zi,so,xi,$i,lt,ns,me,Fe,ao,ct,qi,io,Mi,os,C,pt,Ci,ro,Fi,Pi,x,ji,mn,Ai,Ii,fn,Si,Ni,gn,Di,Bi,lo,Wi,Oi,co,Ui,Ki,po,Ri,Hi,ho,Vi,Yi,Qi,Pe,ht,Ji,uo,Xi,Gi,mo,ss,fe,je,fo,ut,Zi,go,er,as,F,mt,tr,_o,nr,or,ft,sr,_n,ar,ir,rr,gt,dr,_t,lr,cr,pr,N,kt,hr,ge,ur,kn,mr,fr,ko,gr,_r,kr,Ae,yr,yo,vr,br,yt,is,_e,Ie,vo,vt,Tr,bo,wr,rs,P,bt,Lr,To,Er,zr,Tt,xr,yn,$r,qr,Mr,wt,Cr,Lt,Fr,Pr,jr,J,Et,Ar,ke,Ir,vn,Sr,Nr,wo,Dr,Br,Wr,Se,ds,ye,Ne,Lo,zt,Or,Eo,Ur,ls,j,xt,Kr,zo,Rr,Hr,$t,Vr,bn,Yr,Qr,Jr,qt,Xr,Mt,Gr,Zr,ed,D,Ct,td,ve,nd,Tn,od,sd,xo,ad,id,rd,De,dd,$o,ld,cd,Ft,cs,be,Be,qo,Pt,pd,Mo,hd,ps,A,jt,ud,Co,md,fd,At,gd,wn,_d,kd,yd,It,vd,St,bd,Td,wd,B,Nt,Ld,Te,Ed,Ln,zd,xd,Fo,$d,qd,Md,We,Cd,Po,Fd,Pd,Dt,hs,we,Oe,jo,Bt,jd,Ao,Ad,us,I,Wt,Id,Io,Sd,Nd,Ot,Dd,En,Bd,Wd,Od,Ut,Ud,Kt,Kd,Rd,Hd,W,Rt,Vd,Le,Yd,zn,Qd,Jd,So,Xd,Gd,Zd,Ue,el,No,tl,nl,Ht,ms;return g=new ze({}),He=new ze({}),nt=new In({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<p><a
  href="/docs/transformers/v4.16.2/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ut=new ze({}),mt=new K({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/luke/modeling_luke.py#L879",parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kt=new K({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>word_last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>entity_last_hidden_state = outputs.entity_last_hidden_state`}}),vt=new ze({}),bt=new K({props:{name:"class transformers.LukeForMaskedLM",anchor:"transformers.LukeForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/luke/modeling_luke.py#L1132",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Et=new K({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"labels",val:" = None"},{name:"entity_labels",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Predicted <span class="hljs-keyword">class</span>: person`}}),Pt=new ze({}),jt=new K({props:{name:"class transformers.LukeForEntityPairClassification",anchor:"transformers.LukeForEntityPairClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/luke/modeling_luke.py#L1383",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new K({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_idx = logits.argmax(-<span class="hljs-number">1</span>).item()
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])
Predicted <span class="hljs-keyword">class</span>: per:cities_of_residence`}}),Bt=new ze({}),Wt=new K({props:{name:"class transformers.LukeForEntitySpanClassification",anchor:"transformers.LukeForEntitySpanClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/luke/modeling_luke.py#L1503",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Rt=new K({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"entity_start_positions",val:" = None"},{name:"entity_end_positions",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`),Zt=a("a"),ra=o("LukeTokenizer"),da=o("."),la=l(),Qe=a("li"),H=a("p"),en=a("a"),ca=o("LukeTokenizer"),pa=o(" takes "),Hn=a("code"),ha=o("entities"),ua=o(" and "),Vn=a("code"),ma=o("entity_spans"),fa=o(` (character-based start and end
...
the HuggingFace implementation of LUKE. They can be found `),tt=a("a"),si=o("here"),ai=o("."),Xo=l(),cn=a("p"),ii=o("Example:"),Go=l(),_(nt.$$.fragment),Zo=l(),V=a("p"),ri=o("This model was contributed by "),ot=a("a"),di=o("ikuyamada"),li=o(" and "),st=a("a"),ci=o("nielsr"),pi=o(". The original code can be found "),at=a("a"),hi=o("here"),ui=o("."),es=l(),he=a("h2"),Ce=a("a"),no=a("span"),_(it.$$.fragment),mi=l(),oo=a("span"),fi=o("LukeConfig"),ts=l(),M=a("div"),_(rt.$$.fragment),gi=l(),dt=a("p"),_i=o("This is the configuration class to store the configuration of a "),pn=a("a"),ki=o("LukeModel"),yi=o(`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture.`),vi=l(),ue=a("p"),bi=o("Configuration objects inherit from "),hn=a("a"),Ti=o("PretrainedConfig"),wi=o(` and can be used to control the model outputs. Read the
documentation from `),un=a("a"),Li=o("PretrainedConfig"),Ei=o(" for more information."),zi=l(),so=a("p"),xi=o("Examples:"),$i=l(),_(lt.$$.fragment),ns=l(),me=a("h2"),Fe=a("a"),ao=a("span"),_(ct.$$.fragment),qi=l(),io=a("span"),Mi=o("LukeTokenizer"),os=l(),C=a("div"),_(pt.$$.fragment),Ci=l(),ro=a("p"),Fi=o("Construct a LUKE tokenizer."),Pi=l(),x=a("p"),ji=o("This tokenizer inherits from "),mn=a("a"),Ai=o("RobertaTokenizer"),Ii=o(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),fn=a("a"),Si=o("RobertaTokenizer"),Ni=o(", "),gn=a("a"),Di=o("LukeTokenizer"),Bi=o(`
also creates entity sequences, namely `),lo=a("code"),Wi=o("entity_ids"),Oi=o(", "),co=a("code"),Ui=o("entity_attention_mask"),Ki=o(", "),po=a("code"),Ri=o("entity_token_type_ids"),Hi=o(`, and
`),ho=a("code"),Vi=o("entity_position_ids"),Yi=o(" to be used by the LUKE model."),Qi=l(),Pe=a("div"),_(ht.$$.fragment),Ji=l(),uo=a("p"),Xi=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Gi=l(),mo=a("div"),ss=l(),fe=a("h2"),je=a("a"),fo=a("span"),_(ut.$$.fragment),Zi=l(),go=a("span"),er=o("LukeModel"),as=l(),F=a("div"),_(mt.$$.fragment),tr=l(),_o=a("p"),nr=o("The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),or=l(),ft=a("p"),sr=o("This model inherits from "),_n=a("a"),ar=o("PreTrainedModel"),ir=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rr=l(),gt=a("p"),dr=o("This model is also a PyTorch "),_t=a("a"),lr=o("torch.nn.Module"),cr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pr=l(),N=a("div"),_(kt.$$.fragment),hr=l(),ge=a("p"),ur=o("The "),kn=a("a"),mr=o("LukeModel"),fr=o(" forward method, overrides the "),ko=a("code"),gr=o("__call__"),_r=o(" special method."),kr=l(),_(Ae.$$.fragment),yr=l(),yo=a("p"),vr=o("Examples:"),br=l(),_(yt.$$.fragment),is=l(),_e=a("h2"),Ie=a("a"),vo=a("span"),_(vt.$$.fragment),Tr=l(),bo=a("span"),wr=o("LukeForMaskedLM"),rs=l(),P=a("div"),_(bt.$$.fragment),Lr=l(),To=a("p"),Er=o(`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),zr=l(),Tt=a("p"),xr=o("This model inherits from "),yn=a("a"),$r=o("PreTrainedModel"),qr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mr=l(),wt=a("p"),Cr=o("This model is also a PyTorch "),Lt=a("a"),Fr=o("torch.nn.Module"),Pr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
token) for entity classification tasks, such as Open Entity.`),Hr=l(),$t=a("p"),Vr=o("This model inherits from "),bn=a("a"),Yr=o("PreTrainedModel"),Qr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jr=l(),qt=a("p"),Xr=o("This model is also a PyTorch "),Mt=a("a"),Gr=o("torch.nn.Module"),Zr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ed=l(),D=a("div"),_(Ct.$$.fragment),td=l(),ve=a("p"),nd=o("The "),Tn=a("a"),od=o("LukeForEntityClassification"),sd=o(" forward method, overrides the "),xo=a("code"),ad=o("__call__"),id=o(" special method."),rd=l(),_(De.$$.fragment),dd=l(),$o=a("p"),ld=o("Examples:"),cd=l(),_(Ft.$$.fragment),cs=l(),be=a("h2"),Be=a("a"),qo=a("span"),_(Pt.$$.fragment),pd=l(),Mo=a("span"),hd=o("LukeForEntityPairClassification"),ps=l(),A=a("div"),_(jt.$$.fragment),ud=l(),Co=a("p"),md=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
tokens) for entity pair classification tasks, such as TACRED.`),fd=l(),At=a("p"),gd=o("This model inherits from "),wn=a("a"),_d=o("PreTrainedModel"),kd=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yd=l(),It=a("p"),vd=o("This model is also a PyTorch "),St=a("a"),bd=o("torch.nn.Module"),Td=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wd=l(),B=a("div"),_(Nt.$$.fragment),Ld=l(),Te=a("p"),Ed=o("The "),Ln=a("a"),zd=o("LukeForEntityPairClassification"),xd=o(" forward method, overrides the "),Fo=a("code"),$d=o("__call__"),qd=o(" special method."),Md=l(),_(We.$$.fragment),Cd=l(),Po=a("p"),Fd=o("Examples:"),Pd=l(),_(Dt.$$.fragment),hs=l(),we=a("h2"),Oe=a("a"),jo=a("span"),_(Bt.$$.fragment),jd=l(),Ao=a("span"),Ad=o("LukeForEntitySpanClassification"),us=l(),I=a("div"),_(Wt.$$.fragment),Id=l(),Io=a("p"),Sd=o(`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),hl.forEach(t),pl.forEach(t),Qo=c(n),Xt=i(n,"P",{});var ul=r(Xt);Vs=s(ul,"Tips:"),ul.forEach(t),Jo=c(n),R=i(n,"UL",{});var Ke=r(R);Bn=i(Ke,"LI",{});var ml=r(Bn);Ye=i(ml,"P",{});var gs=r(Ye);Ys=s(gs,"This implementation is the same as "),Gt=i(gs,"A",{href:!0});var fl=r(Gt);Qs=s(fl,"RobertaModel"),fl.forEach(t),Js=s(gs,` with the addition of entity embeddings as well
...
entity typing, e.g. the `),Xe=i(Oo,"A",{href:!0,rel:!0});var Ml=r(Xe);qa=s(Ml,"Open Entity dataset"),Ml.forEach(t),Ma=s(Oo,`.
This model places a linear head on top of the output entity representation.`),Oo.forEach(t),Ca=c(xn),Me=i(xn,"LI",{});var Uo=r(Me);sn=i(Uo,"A",{href:!0});var Cl=r(sn);Fa=s(Cl,"LukeForEntityPairClassification"),Cl.forEach(t),Pa=s(Uo,`, for tasks to classify the relationship between two entities
