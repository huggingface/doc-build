import{S as Vl,i as Xl,s as Zl,e as r,k as i,w as j,t as n,L as er,c as o,d as a,m as c,a as p,x as _,h as t,b as E,J as s,g as u,y as v,q as y,o as g,B as $}from"../chunks/vendor-b1433968.js";import{T as Ht}from"../chunks/Tip-c3840994.js";import{I as Mt}from"../chunks/IconCopyLink-7029626d.js";import{C as F}from"../chunks/CodeBlock-5eeb61a8.js";import"../chunks/CopyButton-40b92840.js";function sr(I){let h,w;return{c(){h=r("p"),w=n("This feature is currently available for PyTorch-only.")},l(d){h=o(d,"P",{});var f=p(h);w=t(f,"This feature is currently available for PyTorch-only."),f.forEach(a)},m(d,f){u(d,h,f),s(h,w)},d(d){d&&a(h)}}}function ar(I){let h,w,d,f,x;return{c(){h=r("p"),w=n("For multi-GPU training it requires DDP ("),d=r("code"),f=n("torch.distributed.launch"),x=n(").")},l(b){h=o(b,"P",{});var D=p(h);w=t(D,"For multi-GPU training it requires DDP ("),d=o(D,"CODE",{});var N=p(d);f=t(N,"torch.distributed.launch"),N.forEach(a),x=t(D,")."),D.forEach(a)},m(b,D){u(b,h,D),s(h,w),s(h,d),s(d,f),s(h,x)},d(b){b&&a(h)}}}function nr(I){let h,w,d,f,x;return{c(){h=r("p"),w=n("This feature can be used with any "),d=r("code"),f=n("nn.Module"),x=n("-based model.")},l(b){h=o(b,"P",{});var D=p(h);w=t(D,"This feature can be used with any "),d=o(D,"CODE",{});var N=p(d);f=t(N,"nn.Module"),N.forEach(a),x=t(D,"-based model."),D.forEach(a)},m(b,D){u(b,h,D),s(h,w),s(h,d),s(d,f),s(h,x)},d(b){b&&a(h)}}}function tr(I){let h,w,d,f,x,b,D,N,Pa,Cs,q,Y,Ue,oe,Aa,Ie,Sa,Ls,K,Ps,z,As,B,Ss,C,Ra,qe,Fa,Na,He,Ga,Ua,Me,Ia,qa,Rs,J,Ha,ge,Ma,Ya,Fs,pe,Ns,G,Ka,Ye,za,Ba,$e,Ja,Wa,Gs,De,Qa,Us,ue,Is,T,Ee,Va,Xa,Ke,Za,en,ze,sn,an,Be,nn,tn,qs,ie,Hs,ke,ln,Ms,m,rn,Je,on,pn,We,un,cn,Qe,hn,dn,Ve,fn,mn,Xe,bn,wn,Ze,jn,_n,es,vn,yn,Ys,W,gn,ss,$n,Dn,Ks,Oe,En,zs,ce,Bs,L,kn,as,On,xn,ns,Tn,Cn,ts,Ln,Pn,Js,xe,An,Ws,he,Qs,k,Sn,ls,Rn,Fn,rs,Nn,Gn,os,Un,In,ps,qn,Hn,us,Mn,Yn,Vs,P,Kn,is,zn,Bn,cs,Jn,Wn,hs,Qn,Vn,Xs,Te,Xn,Zs,Q,Zn,ds,et,st,ea,de,sa,V,at,fs,nt,tt,aa,X,lt,ms,rt,ot,na,A,pt,bs,ut,it,ws,ct,ht,js,dt,ft,ta,fe,la,U,mt,_s,bt,wt,vs,jt,_t,ra,me,oa,S,vt,ys,yt,gt,gs,$t,Dt,$s,Et,kt,pa,Z,Ot,Ds,xt,Tt,ua,Ce,Ct,ia,be,ca,H,ee,Es,we,Lt,ks,Pt,ha,Le,At,da,se,St,Os,Rt,Ft,fa,je,ma,Pe,Nt,ba,Ae,Gt,wa,Se,Ut,ja,_e,_a,Re,It,va,Fe,qt,ya,ve,ga;return b=new Mt({}),oe=new Mt({}),K=new Ht({props:{$$slots:{default:[sr]},$$scope:{ctx:I}}}),z=new Ht({props:{$$slots:{default:[ar]},$$scope:{ctx:I}}}),B=new Ht({props:{$$slots:{default:[nr]},$$scope:{ctx:I}}}),pe=new F({props:{code:"--debug underflow_overflow,",highlighted:"--debug underflow_overflow"}}),ue=new F({props:{code:`from .debug_utils import DebugUnderflowOverflow
...
debug_overflow = DebugUnderflowOverflow(model, max_frames_to_save=<span class="hljs-number">100</span>)`}}),we=new Mt({}),je=new F({props:{code:"debug_overflow = DebugUnderflowOverflow(model, trace_batch_nums=[1, 3]),",highlighted:'debug_overflow = DebugUnderflowOverflow(model, trace_batch_nums=[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>])'}}),_e=new F({props:{code:`                  *** Starting batch number=1 ***
abs min  abs max  metadata
                  shared Embedding
...
5.36e<span class="hljs-string">-05</span> 7.92e<span class="hljs-string">+02</span> output
[...]`}}),ve=new F({props:{code:"debug_overflow = DebugUnderflowOverflow(model, trace_batch_nums=[1, 3], abort_after_batch_num=3),",highlighted:'debug_overflow = DebugUnderflowOverflow(model, trace_batch_nums=[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>], abort_after_batch_num=<span class="hljs-number">3</span>)'}}),{c(){h=r("meta"),w=i(),d=r("h1"),f=r("a"),x=r("span"),j(b.$$.fragment),D=i(),N=r("span"),Pa=n("Debugging"),Cs=i(),q=r("h2"),Y=r("a"),Ue=r("span"),j(oe.$$.fragment),Aa=i(),Ie=r("span"),Sa=n("Underflow and Overflow Detection"),Ls=i(),j(K.$$.fragment),Ps=i(),j(z.$$.fragment),As=i(),j(B.$$.fragment),Ss=i(),C=r("p"),Ra=n("If you start getting "),qe=r("code"),Fa=n("loss=NaN"),Na=n(" or the model inhibits some other abnormal behavior due to "),He=r("code"),Ga=n("inf"),Ua=n(" or "),Me=r("code"),Ia=n("nan"),qa=n(` in
activations or weights one needs to discover where the first underflow or overflow happens and what led to it. Luckily
you can accomplish that easily by activating a special module that will do the detection automatically.`),Rs=i(),J=r("p"),Ha=n("If you\u2019re using "),ge=r("a"),Ma=n("Trainer"),Ya=n(", you just need to add:"),Fs=i(),j(pe.$$.fragment),Ns=i(),G=r("p"),Ka=n("to the normal command line arguments, or pass "),Ye=r("code"),za=n('debug="underflow_overflow"'),Ba=n(` when creating the
`),$e=r("a"),Ja=n("TrainingArguments"),Wa=n(" object."),Gs=i(),De=r("p"),Qa=n("If you\u2019re using your own training loop or another Trainer you can accomplish the same with:"),Us=i(),j(ue.$$.fragment),Is=i(),T=r("p"),Ee=r("a"),Va=n("DebugUnderflowOverflow"),Xa=n(` inserts hooks into the model that immediately after each
...
like this (this was caught with `),Be=r("code"),nn=n("google/mt5-small"),tn=n(" under fp16 mixed precision):"),qs=i(),j(ie.$$.fragment),Hs=i(),ke=r("p"),ln=n("The example output has been trimmed in the middle for brevity."),Ms=i(),m=r("p"),rn=n(`The second column shows the value of the absolute largest element, so if you have a closer look at the last few frames,
the inputs and outputs were in the range of `),Je=r("code"),on=n("1e4"),pn=n(`. So when this training was done under fp16 mixed precision the very
last step overflowed (since under `),We=r("code"),un=n("fp16"),cn=n(" the largest number before "),Qe=r("code"),hn=n("inf"),dn=n(" is "),Ve=r("code"),fn=n("64e3"),mn=n(`). To avoid overflows under
...
large activations is going to lead to a numerical overflow condition.`),Ys=i(),W=r("p"),gn=n("At the very start of the trace you can discover at which batch number the problem occurred (here "),ss=r("code"),$n=n("Detected inf/nan during batch_number=0"),Dn=n(" means the problem occurred on the first batch)."),Ks=i(),Oe=r("p"),En=n(`Each reported frame starts by declaring the fully qualified entry for the corresponding module this frame is reporting
for. If we look just at this frame:`),zs=i(),j(ce.$$.fragment),Bs=i(),L=r("p"),kn=n("Here, "),as=r("code"),On=n("encoder.block.2.layer.1.layer_norm"),xn=n(` indicates that it was a layer norm for the first layer, of the second
block of the encoder. And the specific calls of the `),ns=r("code"),Tn=n("forward"),Cn=n(" is "),ts=r("code"),Ln=n("T5LayerNorm"),Pn=n("."),Js=i(),xe=r("p"),An=n("Let\u2019s look at the last few frames of that report:"),Ws=i(),j(he.$$.fragment),Qs=i(),k=r("p"),Sn=n("The last frame reports for "),ls=r("code"),Rn=n("Dropout.forward"),Fn=n(` function with the first entry for the only input and the second for the
...
input elements was `),ps=r("code"),qn=n("6.27e+04"),Hn=n(" and same for the output was "),us=r("code"),Mn=n("inf"),Yn=n("."),Vs=i(),P=r("p"),Kn=n("You can see here, that "),is=r("code"),zn=n("T5DenseGatedGeluDense.forward"),Bn=n(` resulted in output activations, whose absolute max value was
around 62.7K, which is very close to fp16\u2019s top limit of 64K. In the next frame we have `),cs=r("code"),Jn=n("Dropout"),Wn=n(` which renormalizes
...
its default, e.g.:`),ia=i(),j(be.$$.fragment),ca=i(),H=r("h3"),ee=r("a"),Es=r("span"),j(we.$$.fragment),Lt=i(),ks=r("span"),Pt=n("Specific batch absolute mix and max value tracing"),ha=i(),Le=r("p"),At=n("The same debugging class can be used for per-batch tracing with the underflow/overflow detection feature turned off."),da=i(),se=r("p"),St=n("Let\u2019s say you want to watch the absolute min and max values for all the ingredients of each "),Os=r("code"),Rt=n("forward"),Ft=n(` call of a given
batch, and only do that for batches 1 and 3. Then you instantiate this class as:`),fa=i(),j(je.$$.fragment),ma=i(),Pe=r("p"),Nt=n("And now full batches 1 and 3 will be traced using the same format as the underflow/overflow detector does."),ba=i(),Ae=r("p"),Gt=n("Batches are 0-indexed."),wa=i(),Se=r("p"),Ut=n(`This is helpful if you know that the program starts misbehaving after a certain batch number, so you can fast-forward
...
numbers started to diverge.`),va=i(),Fe=r("p"),qt=n("You can also specify the batch number after which to stop the training, with:"),ya=i(),j(ve.$$.fragment),this.h()},l(e){const l=er('[data-svelte="svelte-1phssyn"]',document.head);h=o(l,"META",{name:!0,content:!0}),l.forEach(a),w=c(e),d=o(e,"H1",{class:!0});var ye=p(d);f=o(ye,"A",{id:!0,class:!0,href:!0});var xs=p(f);x=o(xs,"SPAN",{});var Ts=p(x);_(b.$$.fragment,Ts),Ts.forEach(a),xs.forEach(a),D=c(ye),N=o(ye,"SPAN",{});var Yt=p(N);Pa=t(Yt,"Debugging"),Yt.forEach(a),ye.forEach(a),Cs=c(e),q=o(e,"H2",{class:!0});var $a=p(q);Y=o($a,"A",{id:!0,class:!0,href:!0});var Kt=p(Y);Ue=o(Kt,"SPAN",{});var zt=p(Ue);_(oe.$$.fragment,zt),zt.forEach(a),Kt.forEach(a),Aa=c($a),Ie=o($a,"SPAN",{});var Bt=p(Ie);Sa=t(Bt,"Underflow and Overflow Detection"),Bt.forEach(a),$a.forEach(a),Ls=c(e),_(K.$$.fragment,e),Ps=c(e),_(z.$$.fragment,e),As=c(e),_(B.$$.fragment,e),Ss=c(e),C=o(e,"P",{});var ae=p(C);Ra=t(ae,"If you start getting "),qe=o(ae,"CODE",{});var Jt=p(qe);Fa=t(Jt,"loss=NaN"),Jt.forEach(a),Na=t(ae," or the model inhibits some other abnormal behavior due to "),He=o(ae,"CODE",{});var Wt=p(He);Ga=t(Wt,"inf"),Wt.forEach(a),Ua=t(ae," or "),Me=o(ae,"CODE",{});var Qt=p(Me);Ia=t(Qt,"nan"),Qt.forEach(a),qa=t(ae,` in
activations or weights one needs to discover where the first underflow or overflow happens and what led to it. Luckily
you can accomplish that easily by activating a special module that will do the detection automatically.`),ae.forEach(a),Rs=c(e),J=o(e,"P",{});var Da=p(J);Ha=t(Da,"If you\u2019re using "),ge=o(Da,"A",{href:!0});var Vt=p(ge);Ma=t(Vt,"Trainer"),Vt.forEach(a),Ya=t(Da,", you just need to add:"),Da.forEach(a),Fs=c(e),_(pe.$$.fragment,e),Ns=c(e),G=o(e,"P",{});var Ne=p(G);Ka=t(Ne,"to the normal command line arguments, or pass "),Ye=o(Ne,"CODE",{});var Xt=p(Ye);za=t(Xt,'debug="underflow_overflow"'),Xt.forEach(a),Ba=t(Ne,` when creating the
`),$e=o(Ne,"A",{href:!0});var Zt=p($e);Ja=t(Zt,"TrainingArguments"),Zt.forEach(a),Wa=t(Ne," object."),Ne.forEach(a),Gs=c(e),De=o(e,"P",{});var el=p(De);Qa=t(el,"If you\u2019re using your own training loop or another Trainer you can accomplish the same with:"),el.forEach(a),Us=c(e),_(ue.$$.fragment,e),Is=c(e),T=o(e,"P",{});var M=p(T);Ee=o(M,"A",{href:!0});var sl=p(Ee);Va=t(sl,"DebugUnderflowOverflow"),sl.forEach(a),Xa=t(M,` inserts hooks into the model that immediately after each
forward call will test input and output variables and also the corresponding module\u2019s weights. As soon as `),Ke=o(M,"CODE",{});var al=p(Ke);Za=t(al,"inf"),al.forEach(a),en=t(M,` or
`),ze=o(M,"CODE",{});var nl=p(ze);sn=t(nl,"nan"),nl.forEach(a),an=t(M,` is detected in at least one element of the activations or weights, the program will assert and print a report
like this (this was caught with `),Be=o(M,"CODE",{});var tl=p(Be);nn=t(tl,"google/mt5-small"),tl.forEach(a),tn=t(M," under fp16 mixed precision):"),M.forEach(a),qs=c(e),_(ie.$$.fragment,e),Hs=c(e),ke=o(e,"P",{});var ll=p(ke);ln=t(ll,"The example output has been trimmed in the middle for brevity."),ll.forEach(a),Ms=c(e),m=o(e,"P",{});var O=p(m);rn=t(O,`The second column shows the value of the absolute largest element, so if you have a closer look at the last few frames,
the inputs and outputs were in the range of `),Je=o(O,"CODE",{});var rl=p(Je);on=t(rl,"1e4"),rl.forEach(a),pn=t(O,`. So when this training was done under fp16 mixed precision the very
last step overflowed (since under `),We=o(O,"CODE",{});var ol=p(We);un=t(ol,"fp16"),ol.forEach(a),cn=t(O," the largest number before "),Qe=o(O,"CODE",{});var pl=p(Qe);hn=t(pl,"inf"),pl.forEach(a),dn=t(O," is "),Ve=o(O,"CODE",{});var ul=p(Ve);fn=t(ul,"64e3"),ul.forEach(a),mn=t(O,`). To avoid overflows under
...
that it happened during the first layer, of the 2nd block, during the very first batch. Finally, the absolute largest
input elements was `),ps=o(R,"CODE",{});var gl=p(ps);qn=t(gl,"6.27e+04"),gl.forEach(a),Hn=t(R," and same for the output was "),us=o(R,"CODE",{});var $l=p(us);Mn=t($l,"inf"),$l.forEach(a),Yn=t(R,"."),R.forEach(a),Vs=c(e),P=o(e,"P",{});var te=p(P);Kn=t(te,"You can see here, that "),is=o(te,"CODE",{});var Dl=p(is);zn=t(Dl,"T5DenseGatedGeluDense.forward"),Dl.forEach(a),Bn=t(te,` resulted in output activations, whose absolute max value was
around 62.7K, which is very close to fp16\u2019s top limit of 64K. In the next frame we have `),cs=o(te,"CODE",{});var El=p(cs);Jn=t(El,"Dropout"),El.forEach(a),Wn=t(te,` which renormalizes
the weights, after it zeroed some of the elements, which pushes the absolute max value to more than 64K, and we get an
...
started to go up and most likely switch to the `),bs=o(le,"CODE",{});var Ll=p(bs);ut=t(Ll,"fp32"),Ll.forEach(a),it=t(le,` mode here, so that the numbers don\u2019t overflow when multiplied
or summed up. Of course, there might be other solutions. For example, we could turn off `),ws=o(le,"CODE",{});var Pl=p(ws);ct=t(Pl,"amp"),Pl.forEach(a),ht=t(le,` temporarily if it\u2019s
...
its default, e.g.:`),Il.forEach(a),ia=c(e),_(be.$$.fragment,e),ca=c(e),H=o(e,"H3",{class:!0});var Ca=p(H);ee=o(Ca,"A",{id:!0,class:!0,href:!0});var ql=p(ee);Es=o(ql,"SPAN",{});var Hl=p(Es);_(we.$$.fragment,Hl),Hl.forEach(a),ql.forEach(a),Lt=c(Ca),ks=o(Ca,"SPAN",{});var Ml=p(ks);Pt=t(Ml,"Specific batch absolute mix and max value tracing"),Ml.forEach(a),Ca.forEach(a),ha=c(e),Le=o(e,"P",{});var Yl=p(Le);At=t(Yl,"The same debugging class can be used for per-batch tracing with the underflow/overflow detection feature turned off."),Yl.forEach(a),da=c(e),se=o(e,"P",{});var La=p(se);St=t(La,"Let\u2019s say you want to watch the absolute min and max values for all the ingredients of each "),Os=o(La,"CODE",{});var Kl=p(Os);Rt=t(Kl,"forward"),Kl.forEach(a),Ft=t(La,` call of a given
batch, and only do that for batches 1 and 3. Then you instantiate this class as:`),La.forEach(a),fa=c(e),_(je.$$.fragment,e),ma=c(e),Pe=o(e,"P",{});var zl=p(Pe);Nt=t(zl,"And now full batches 1 and 3 will be traced using the same format as the underflow/overflow detector does."),zl.forEach(a),ba=c(e),Ae=o(e,"P",{});var Bl=p(Ae);Gt=t(Bl,"Batches are 0-indexed."),Bl.forEach(a),wa=c(e),Se=o(e,"P",{});var Jl=p(Se);Ut=t(Jl,`This is helpful if you know that the program starts misbehaving after a certain batch number, so you can fast-forward
right to that area. Here is a sample truncated output for such configuration:`),Jl.forEach(a),ja=c(e),_(_e.$$.fragment,e),_a=c(e),Re=o(e,"P",{});var Wl=p(Re);It=t(Wl,`Here you will get a huge number of frames dumped - as many as there were forward calls in your model, so it may or may
not what you want, but sometimes it can be easier to use for debugging purposes than a normal debugger. For example, if
a problem starts happening at batch number 150. So you can dump traces for batches 149 and 150 and compare where
numbers started to diverge.`),Wl.forEach(a),va=c(e),Fe=o(e,"P",{});var Ql=p(Fe);qt=t(Ql,"You can also specify the batch number after which to stop the training, with:"),Ql.forEach(a),ya=c(e),_(ve.$$.fragment,e),this.h()},h(){E(h,"name","hf:doc:metadata"),E(h,"content",JSON.stringify(lr)),E(f,"id","debugging"),E(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),E(f,"href","#debugging"),E(d,"class","relative group"),E(Y,"id","underflow-and-overflow-detection"),E(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),E(Y,"href","#underflow-and-overflow-detection"),E(q,"class","relative group"),E(ge,"href","/docs/transformers/v4.16.2/en/main_classes/trainer#transformers.Trainer"),E($e,"href","/docs/transformers/v4.16.2/en/main_classes/trainer#transformers.TrainingArguments"),E(Ee,"href","/docs/transformers/v4.16.2/en/internal/trainer_utils#transformers.debug_utils.DebugUnderflowOverflow"),E(ee,"id","specific-batch-absolute-mix-and-max-value-tracing"),E(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),E(ee,"href","#specific-batch-absolute-mix-and-max-value-tracing"),E(H,"class","relative group")},m(e,l){s(document.head,h),u(e,w,l),u(e,d,l),s(d,f),s(f,x),v(b,x,null),s(d,D),s(d,N),s(N,Pa),u(e,Cs,l),u(e,q,l),s(q,Y),s(Y,Ue),v(oe,Ue,null),s(q,Aa),s(q,Ie),s(Ie,Sa),u(e,Ls,l),v(K,e,l),u(e,Ps,l),v(z,e,l),u(e,As,l),v(B,e,l),u(e,Ss,l),u(e,C,l),s(C,Ra),s(C,qe),s(qe,Fa),s(C,Na),s(C,He),s(He,Ga),s(C,Ua),s(C,Me),s(Me,Ia),s(C,qa),u(e,Rs,l),u(e,J,l),s(J,Ha),s(J,ge),s(ge,Ma),s(J,Ya),u(e,Fs,l),v(pe,e,l),u(e,Ns,l),u(e,G,l),s(G,Ka),s(G,Ye),s(Ye,za),s(G,Ba),s(G,$e),s($e,Ja),s(G,Wa),u(e,Gs,l),u(e,De,l),s(De,Qa),u(e,Us,l),v(ue,e,l),u(e,Is,l),u(e,T,l),s(T,Ee),s(Ee,Va),s(T,Xa),s(T,Ke),s(Ke,Za),s(T,en),s(T,ze),s(ze,sn),s(T,an),s(T,Be),s(Be,nn),s(T,tn),u(e,qs,l),v(ie,e,l),u(e,Hs,l),u(e,ke,l),s(ke,ln),u(e,Ms,l),u(e,m,l),s(m,rn),s(m,Je),s(Je,on),s(m,pn),s(m,We),s(We,un),s(m,cn),s(m,Qe),s(Qe,hn),s(m,dn),s(m,Ve),s(Ve,fn),s(m,mn),s(m,Xe),s(Xe,bn),s(m,wn),s(m,Ze),s(Ze,jn),s(m,_n),s(m,es),s(es,vn),s(m,yn),u(e,Ys,l),u(e,W,l),s(W,gn),s(W,ss),s(ss,$n),s(W,Dn),u(e,Ks,l),u(e,Oe,l),s(Oe,En),u(e,zs,l),v(ce,e,l),u(e,Bs,l),u(e,L,l),s(L,kn),s(L,as),s(as,On),s(L,xn),s(L,ns),s(ns,Tn),s(L,Cn),s(L,ts),s(ts,Ln),s(L,Pn),u(e,Js,l),u(e,xe,l),s(xe,An),u(e,Ws,l),v(he,e,l),u(e,Qs,l),u(e,k,l),s(k,Sn),s(k,ls),s(ls,Rn),s(k,Fn),s(k,rs),s(rs,Nn),s(k,Gn),s(k,os),s(os,Un),s(k,In),s(k,ps),s(ps,qn),s(k,Hn),s(k,us),s(us,Mn),s(k,Yn),u(e,Vs,l),u(e,P,l),s(P,Kn),s(P,is),s(is,zn),s(P,Bn),s(P,cs),s(cs,Jn),s(P,Wn),s(P,hs),s(hs,Qn),s(P,Vn),u(e,Xs,l),u(e,Te,l),s(Te,Xn),u(e,Zs,l),u(e,Q,l),s(Q,Zn),s(Q,ds),s(ds,et),s(Q,st),u(e,ea,l),v(de,e,l),u(e,sa,l),u(e,V,l),s(V,at),s(V,fs),s(fs,nt),s(V,tt),u(e,aa,l),u(e,X,l),s(X,lt),s(X,ms),s(ms,rt),s(X,ot),u(e,na,l),u(e,A,l),s(A,pt),s(A,bs),s(bs,ut),s(A,it),s(A,ws),s(ws,ct),s(A,ht),s(A,js),s(js,dt),s(A,ft),u(e,ta,l),v(fe,e,l),u(e,la,l),u(e,U,l),s(U,mt),s(U,_s),s(_s,bt),s(U,wt),s(U,vs),s(vs,jt),s(U,_t),u(e,ra,l),v(me,e,l),u(e,oa,l),u(e,S,l),s(S,vt),s(S,ys),s(ys,yt),s(S,gt),s(S,gs),s(gs,$t),s(S,Dt),s(S,$s),s($s,Et),s(S,kt),u(e,pa,l),u(e,Z,l),s(Z,Ot),s(Z,Ds),s(Ds,xt),s(Z,Tt),u(e,ua,l),u(e,Ce,l),s(Ce,Ct),u(e,ia,l),v(be,e,l),u(e,ca,l),u(e,H,l),s(H,ee),s(ee,Es),v(we,Es,null),s(H,Lt),s(H,ks),s(ks,Pt),u(e,ha,l),u(e,Le,l),s(Le,At),u(e,da,l),u(e,se,l),s(se,St),s(se,Os),s(Os,Rt),s(se,Ft),u(e,fa,l),v(je,e,l),u(e,ma,l),u(e,Pe,l),s(Pe,Nt),u(e,ba,l),u(e,Ae,l),s(Ae,Gt),u(e,wa,l),u(e,Se,l),s(Se,Ut),u(e,ja,l),v(_e,e,l),u(e,_a,l),u(e,Re,l),s(Re,It),u(e,va,l),u(e,Fe,l),s(Fe,qt),u(e,ya,l),v(ve,e,l),ga=!0},p(e,[l]){const ye={};l&2&&(ye.$$scope={dirty:l,ctx:e}),K.$set(ye);const xs={};l&2&&(xs.$$scope={dirty:l,ctx:e}),z.$set(xs);const Ts={};l&2&&(Ts.$$scope={dirty:l,ctx:e}),B.$set(Ts)},i(e){ga||(y(b.$$.fragment,e),y(oe.$$.fragment,e),y(K.$$.fragment,e),y(z.$$.fragment,e),y(B.$$.fragment,e),y(pe.$$.fragment,e),y(ue.$$.fragment,e),y(ie.$$.fragment,e),y(ce.$$.fragment,e),y(he.$$.fragment,e),y(de.$$.fragment,e),y(fe.$$.fragment,e),y(me.$$.fragment,e),y(be.$$.fragment,e),y(we.$$.fragment,e),y(je.$$.fragment,e),y(_e.$$.fragment,e),y(ve.$$.fragment,e),ga=!0)},o(e){g(b.$$.fragment,e),g(oe.$$.fragment,e),g(K.$$.fragment,e),g(z.$$.fragment,e),g(B.$$.fragment,e),g(pe.$$.fragment,e),g(ue.$$.fragment,e),g(ie.$$.fragment,e),g(ce.$$.fragment,e),g(he.$$.fragment,e),g(de.$$.fragment,e),g(fe.$$.fragment,e),g(me.$$.fragment,e),g(be.$$.fragment,e),g(we.$$.fragment,e),g(je.$$.fragment,e),g(_e.$$.fragment,e),g(ve.$$.fragment,e),ga=!1},d(e){a(h),e&&a(w),e&&a(d),$(b),e&&a(Cs),e&&a(q),$(oe),e&&a(Ls),$(K,e),e&&a(Ps),$(z,e),e&&a(As),$(B,e),e&&a(Ss),e&&a(C),e&&a(Rs),e&&a(J),e&&a(Fs),$(pe,e),e&&a(Ns),e&&a(G),e&&a(Gs),e&&a(De),e&&a(Us),$(ue,e),e&&a(Is),e&&a(T),e&&a(qs),$(ie,e),e&&a(Hs),e&&a(ke),e&&a(Ms),e&&a(m),e&&a(Ys),e&&a(W),e&&a(Ks),e&&a(Oe),e&&a(zs),$(ce,e),e&&a(Bs),e&&a(L),e&&a(Js),e&&a(xe),e&&a(Ws),$(he,e),e&&a(Qs),e&&a(k),e&&a(Vs),e&&a(P),e&&a(Xs),e&&a(Te),e&&a(Zs),e&&a(Q),e&&a(ea),$(de,e),e&&a(sa),e&&a(V),e&&a(aa),e&&a(X),e&&a(na),e&&a(A),e&&a(ta),$(fe,e),e&&a(la),e&&a(U),e&&a(ra),$(me,e),e&&a(oa),e&&a(S),e&&a(pa),e&&a(Z),e&&a(ua),e&&a(Ce),e&&a(ia),$(be,e),e&&a(ca),e&&a(H),$(we),e&&a(ha),e&&a(Le),e&&a(da),e&&a(se),e&&a(fa),$(je,e),e&&a(ma),e&&a(Pe),e&&a(ba),e&&a(Ae),e&&a(wa),e&&a(Se),e&&a(ja),$(_e,e),e&&a(_a),e&&a(Re),e&&a(va),e&&a(Fe),e&&a(ya),$(ve,e)}}}const lr={local:"debugging",sections:[{local:"underflow-and-overflow-detection",sections:[{local:"specific-batch-absolute-mix-and-max-value-tracing",title:"Specific batch absolute mix and max value tracing"}],title:"Underflow and Overflow Detection"}],title:"Debugging"};function rr(I,h,w){let{fw:d}=h;return I.$$set=f=>{"fw"in f&&w(0,d=f.fw)},[d]}class hr extends Vl{constructor(h){super();Xl(this,h,rr,tr,Zl,{fw:0})}}export{hr as default,lr as metadata};
