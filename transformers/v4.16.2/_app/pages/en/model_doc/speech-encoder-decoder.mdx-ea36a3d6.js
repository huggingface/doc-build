import{S as ur,i as gr,s as _r,e as a,k as i,w as T,t as n,L as vr,c as s,d as o,m as l,a as d,x as k,h as r,b as c,J as e,g as _,y as D,q as $,o as M,B as q}from"../../../chunks/vendor-b1433968.js";import{T as br}from"../../../chunks/Tip-c3840994.js";import{D as Ve}from"../../../chunks/Docstring-ff504c58.js";import{C as kn}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as Dn}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function wr(Be){let f,x,g,v,N;return{c(){f=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),v=n("Module"),N=n(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(o)},m(S,P){_(S,f,P),e(f,x),e(f,g),e(g,v),e(f,N)},d(S){S&&o(f)}}}function yr(Be){let f,x,g,v,N,S,P,J,Mo,ho,b,qo,ye,xo,Po,Oe,jo,Co,Ee,zo,Ao,Se,Fo,Lo,po,j,No,Re,Wo,Io,X,Vo,Bo,mo,C,Oo,Te,Ro,Ho,ke,Jo,Uo,fo,W,U,He,ee,Go,Je,Yo,uo,u,oe,Zo,G,De,Ko,Qo,$e,Xo,et,ot,I,tt,Me,nt,rt,qe,at,st,dt,Ue,ct,it,te,lt,Y,ne,ht,re,pt,xe,mt,ft,ut,Z,ae,gt,V,_t,Ge,vt,bt,Ye,wt,yt,go,B,K,Ze,se,Et,Ke,St,_o,h,de,Tt,O,kt,Qe,Dt,$t,Xe,Mt,qt,xt,ce,Pt,ie,jt,Ct,zt,le,At,he,Ft,Lt,Nt,eo,Wt,It,pe,Vt,Pe,Bt,Ot,Rt,me,Ht,fe,Jt,Ut,Gt,z,je,Yt,Zt,oo,Kt,Qt,to,Xt,en,on,w,ue,tn,R,nn,Ce,rn,an,no,sn,dn,cn,Q,ln,ro,hn,pn,ge,mn,y,_e,fn,ao,un,gn,H,_n,so,vn,bn,co,wn,yn,En,io,Sn,Tn,ve,vo;return S=new Dn({}),ee=new Dn({}),oe=new Ve({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/v4.16.2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/v4.16.2/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2bert&quot;</span>)`}}),{c(){f=a("meta"),x=i(),g=a("h1"),v=a("a"),N=a("span"),T(S.$$.fragment),P=i(),J=a("span"),Mo=n("Speech Encoder Decoder Models"),ho=i(),b=a("p"),qo=n("The "),ye=a("a"),xo=n("SpeechEncoderDecoderModel"),Po=n(` can be used to initialize a speech-sequence-to-text-sequence model
...
documentation from `),qe=a("a"),at=n("PretrainedConfig"),st=n(" for more information."),dt=i(),Ue=a("p"),ct=n("Examples:"),it=i(),T(te.$$.fragment),lt=i(),Y=a("div"),T(ne.$$.fragment),ht=i(),re=a("p"),pt=n("Instantiate a "),xe=a("a"),mt=n("SpeechEncoderDecoderConfig"),ft=n(` (or a derived class) from a pre-trained encoder model
...
the model, you need to first set it back in training mode with `),co=a("code"),wn=n("model.train()"),yn=n("."),En=i(),io=a("p"),Sn=n("Example:"),Tn=i(),T(ve.$$.fragment),this.h()},l(t){const p=vr('[data-svelte="svelte-1phssyn"]',document.head);f=s(p,"META",{name:!0,content:!0}),p.forEach(o),x=l(t),g=s(t,"H1",{class:!0});var be=d(g);v=s(be,"A",{id:!0,class:!0,href:!0});var $n=d(v);N=s($n,"SPAN",{});var Mn=d(N);k(S.$$.fragment,Mn),Mn.forEach(o),$n.forEach(o),P=l(be),J=s(be,"SPAN",{});var qn=d(J);Mo=r(qn,"Speech Encoder Decoder Models"),qn.forEach(o),be.forEach(o),ho=l(t),b=s(t,"P",{});var A=d(b);qo=r(A,"The "),ye=s(A,"A",{href:!0});var xn=d(ye);xo=r(xn,"SpeechEncoderDecoderModel"),xn.forEach(o),Po=r(A,` can be used to initialize a speech-sequence-to-text-sequence model
