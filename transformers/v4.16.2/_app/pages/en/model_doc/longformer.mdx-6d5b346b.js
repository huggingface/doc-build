...
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function k1(W){let p,x,g,u,$,w,_,M,de,X,E,ne,Q,ce,Z,H,he,ae,R,P,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,re,te,N,ue,ie,j,_e,B,oe;return{c(){p=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),$=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=a("p"),ne=n("This second option is useful when using "),Q=a("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),he=n("model(inputs)"),ae=n("."),R=l(),P=a("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=a("ul"),q=a("li"),me=n("a single Tensor with "),D=a("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=a("code"),pe=n("model(inputs_ids)"),ge=l(),C=a("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),re=n("model([input_ids, attention_mask])"),te=n(" or "),N=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),j=a("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=r(m,"UL",{});var J=i(u);$=r(J,"LI",{});var Le=i($);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=r(J,"LI",{});var $e=i(M);de=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),X=d(m),E=r(m,"P",{});var O=i(E);ne=s(O,"This second option is useful when using "),Q=r(O,"CODE",{});var Fe=i(Q);ce=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),Z=s(O,` method which currently requires having all the
...
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),rs=new S({props:{name:"forward",anchor:"transformers.LongformerModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/longformer/modeling_longformer.py#L1597",parametersDescription:[{anchor:"transformers.LongformerModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.LongformerConfig"
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bs=new S({props:{name:"forward",anchor:"transformers.LongformerForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/longformer/modeling_longformer.py#L1845",parametersDescription:[{anchor:"transformers.LongformerForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ls=new ze({}),$s=new S({props:{name:"class transformers.LongformerForMultipleChoice",anchor:"transformers.LongformerForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/longformer/modeling_longformer.py#L2190",parametersDescription:[{anchor:"transformers.LongformerForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Es=new S({props:{name:"forward",anchor:"transformers.LongformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/longformer/modeling_longformer.py#L2201",parametersDescription:[{anchor:"transformers.LongformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),As=new S({props:{name:"forward",anchor:"transformers.LongformerForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/longformer/modeling_longformer.py#L2111",parametersDescription:[{anchor:"transformers.LongformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new S({props:{name:"forward",anchor:"transformers.LongformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/longformer/modeling_longformer.py#L1971",parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
`}}),vn=new je({props:{$$slots:{default:[v1]},$$scope:{ctx:W}}}),xa=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
`),be=a("code"),A=n("</s>"),V=n(")."),Te=l(),le=a("p"),G=n("This model was contributed by "),ve=a("a"),Me=n("beltagy"),we=n(". The Authors\u2019 code can be found "),ke=a("a"),Oh=n("here"),Ah=n("."),sd=l(),jt=a("h2"),Oo=a("a"),Vr=a("span"),v($n.$$.fragment),Ih=l(),Gr=a("span"),Nh=n("Longformer Self Attention"),ad=l(),ye=a("p"),Sh=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
\u201Clocally\u201D attending tokens.`),Ed=l(),No=a("p"),dm=n("For more information, please refer to the official "),Fn=a("a"),cm=n("paper"),hm=n("."),zd=l(),Ot=a("h2"),So=a("a"),si=a("span"),v(xn.$$.fragment),mm=l(),ai=a("span"),fm=n("Training"),qd=l(),At=a("p"),Sa=a("a"),pm=n("LongformerForMaskedLM"),gm=n(" is trained the exact same way "),Da=a("a"),um=n("RobertaForMaskedLM"),_m=n(` is
trained and should be used as follows:`),Cd=l(),v(Mn.$$.fragment),Pd=l(),It=a("h2"),Do=a("a"),ri=a("span"),v(En.$$.fragment),wm=l(),ii=a("span"),vm=n("LongformerConfig"),jd=l(),Oe=a("div"),v(zn.$$.fragment),km=l(),Nt=a("p"),bm=n("This is the configuration class to store the configuration of a "),Ba=a("a"),Tm=n("LongformerModel"),ym=n(" or a "),Wa=a("a"),Lm=n("TFLongformerModel"),$m=n(`. It
...
parent class for more information.`),Nm=l(),li=a("p"),Sm=n("Example:"),Dm=l(),v(Cn.$$.fragment),Od=l(),Bt=a("h2"),Bo=a("a"),di=a("span"),v(Pn.$$.fragment),Bm=l(),ci=a("span"),Wm=n("LongformerTokenizer"),Ad=l(),ft=a("div"),v(jn.$$.fragment),Qm=l(),hi=a("p"),Hm=n("Construct a Longformer tokenizer."),Rm=l(),Wo=a("p"),Ua=a("a"),Um=n("LongformerTokenizer"),Vm=n(" is identical to "),Va=a("a"),Gm=n("RobertaTokenizer"),Km=n(`. Refer to the superclass for usage examples and
documentation concerning parameters.`),Id=l(),Wt=a("h2"),Qo=a("a"),mi=a("span"),v(On.$$.fragment),Jm=l(),fi=a("span"),Xm=n("LongformerTokenizerFast"),Nd=l(),pt=a("div"),v(An.$$.fragment),Ym=l(),In=a("p"),Zm=n("Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),pi=a("em"),ef=n("tokenizers"),tf=n(" library)."),of=l(),Ho=a("p"),Ga=a("a"),nf=n("LongformerTokenizerFast"),sf=n(" is identical to "),Ka=a("a"),af=n("RobertaTokenizerFast"),rf=n(`. Refer to the superclass for usage examples
and documentation concerning parameters.`),Sd=l(),Qt=a("h2"),Ro=a("a"),gi=a("span"),v(Nn.$$.fragment),lf=l(),ui=a("span"),df=n("Longformer specific outputs"),Dd=l(),Ht=a("div"),v(Sn.$$.fragment),cf=l(),_i=a("p"),hf=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Bd=l(),Rt=a("div"),v(Dn.$$.fragment),mf=l(),wi=a("p"),ff=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Wd=l(),Ut=a("div"),v(Bn.$$.fragment),pf=l(),vi=a("p"),gf=n("Base class for masked language models outputs."),Qd=l(),Vt=a("div"),v(Wn.$$.fragment),uf=l(),ki=a("p"),_f=n("Base class for outputs of question answering Longformer models."),Hd=l(),Gt=a("div"),v(Qn.$$.fragment),wf=l(),bi=a("p"),vf=n("Base class for outputs of sentence classification models."),Rd=l(),Kt=a("div"),v(Hn.$$.fragment),kf=l(),Ti=a("p"),bf=n("Base class for outputs of multiple choice Longformer models."),Ud=l(),Jt=a("div"),v(Rn.$$.fragment),Tf=l(),yi=a("p"),yf=n("Base class for outputs of token classification models."),Vd=l(),Xt=a("div"),v(Un.$$.fragment),Lf=l(),Li=a("p"),$f=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Gd=l(),Yt=a("div"),v(Vn.$$.fragment),Ff=l(),$i=a("p"),xf=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Kd=l(),Zt=a("div"),v(Gn.$$.fragment),Mf=l(),Fi=a("p"),Ef=n("Base class for masked language models outputs."),Jd=l(),eo=a("div"),v(Kn.$$.fragment),zf=l(),xi=a("p"),qf=n("Base class for outputs of question answering Longformer models."),Xd=l(),to=a("div"),v(Jn.$$.fragment),Cf=l(),Mi=a("p"),Pf=n("Base class for outputs of sentence classification models."),Yd=l(),oo=a("div"),v(Xn.$$.fragment),jf=l(),Ei=a("p"),Of=n("Base class for outputs of multiple choice models."),Zd=l(),no=a("div"),v(Yn.$$.fragment),Af=l(),zi=a("p"),If=n("Base class for outputs of token classification models."),ec=l(),so=a("h2"),Uo=a("a"),qi=a("span"),v(Zn.$$.fragment),Nf=l(),Ci=a("span"),Sf=n("LongformerModel"),tc=l(),qe=a("div"),v(es.$$.fragment),Df=l(),Pi=a("p"),Bf=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Wf=l(),ts=a("p"),Qf=n("This model inherits from "),Ja=a("a"),Hf=n("PreTrainedModel"),Rf=n(`. Check the superclass documentation for the generic methods the
...
kernel to be memory and compute efficient.`),rp=l(),Ge=a("div"),v(rs.$$.fragment),ip=l(),ro=a("p"),lp=n("The "),Ya=a("a"),dp=n("LongformerModel"),cp=n(" forward method, overrides the "),Oi=a("code"),hp=n("__call__"),mp=n(" special method."),fp=l(),v(Vo.$$.fragment),pp=l(),Ai=a("p"),gp=n("Examples:"),up=l(),v(is.$$.fragment),oc=l(),io=a("h2"),Go=a("a"),Ii=a("span"),v(ls.$$.fragment),_p=l(),Ni=a("span"),wp=n("LongformerForMaskedLM"),nc=l(),We=a("div"),v(ds.$$.fragment),vp=l(),cs=a("p"),kp=n("Longformer Model with a "),Si=a("code"),bp=n("language modeling"),Tp=n(" head on top."),yp=l(),hs=a("p"),Lp=n("This model inherits from "),Za=a("a"),$p=n("PreTrainedModel"),Fp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xp=l(),ms=a("p"),Mp=n("This model is also a PyTorch "),fs=a("a"),Ep=n("torch.nn.Module"),zp=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qp=l(),Ke=a("div"),v(ps.$$.fragment),Cp=l(),lo=a("p"),Pp=n("The "),er=a("a"),jp=n("LongformerForMaskedLM"),Op=n(" forward method, overrides the "),Di=a("code"),Ap=n("__call__"),Ip=n(" special method."),Np=l(),v(Ko.$$.fragment),Sp=l(),Bi=a("p"),Dp=n("Examples:"),Bp=l(),v(gs.$$.fragment),sc=l(),co=a("h2"),Jo=a("a"),Wi=a("span"),v(us.$$.fragment),Wp=l(),Qi=a("span"),Qp=n("LongformerForSequenceClassification"),ac=l(),Qe=a("div"),v(_s.$$.fragment),Hp=l(),Hi=a("p"),Rp=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jp=l(),vs=a("p"),Xp=n("This model is also a PyTorch "),ks=a("a"),Yp=n("torch.nn.Module"),Zp=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eg=l(),Ce=a("div"),v(bs.$$.fragment),tg=l(),ho=a("p"),og=n("The "),or=a("a"),ng=n("LongformerForSequenceClassification"),sg=n(" forward method, overrides the "),Ri=a("code"),ag=n("__call__"),rg=n(" special method."),ig=l(),v(Xo.$$.fragment),lg=l(),Ui=a("p"),dg=n("Example of single-label classification:"),cg=l(),v(Ts.$$.fragment),hg=l(),Vi=a("p"),mg=n("Example of multi-label classification:"),fg=l(),v(ys.$$.fragment),rc=l(),mo=a("h2"),Yo=a("a"),Gi=a("span"),v(Ls.$$.fragment),pg=l(),Ki=a("span"),gg=n("LongformerForMultipleChoice"),ic=l(),He=a("div"),v($s.$$.fragment),ug=l(),Ji=a("p"),_g=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),wg=l(),Fs=a("p"),vg=n("This model inherits from "),nr=a("a"),kg=n("PreTrainedModel"),bg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg=l(),xs=a("p"),yg=n("This model is also a PyTorch "),Ms=a("a"),Lg=n("torch.nn.Module"),$g=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fg=l(),Je=a("div"),v(Es.$$.fragment),xg=l(),fo=a("p"),Mg=n("The "),sr=a("a"),Eg=n("LongformerForMultipleChoice"),zg=n(" forward method, overrides the "),Xi=a("code"),qg=n("__call__"),Cg=n(" special method."),Pg=l(),v(Zo.$$.fragment),jg=l(),Yi=a("p"),Og=n("Example:"),Ag=l(),v(zs.$$.fragment),lc=l(),po=a("h2"),en=a("a"),Zi=a("span"),v(qs.$$.fragment),Ig=l(),el=a("span"),Ng=n("LongformerForTokenClassification"),dc=l(),Re=a("div"),v(Cs.$$.fragment),Sg=l(),tl=a("p"),Dg=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu=l(),Bs=a("p"),vu=n("This model is also a PyTorch "),Ws=a("a"),ku=n("torch.nn.Module"),bu=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tu=l(),Ye=a("div"),v(Qs.$$.fragment),yu=l(),wo=a("p"),Lu=n("The "),lr=a("a"),$u=n("LongformerForQuestionAnswering"),Fu=n(" forward method, overrides the "),ll=a("code"),xu=n("__call__"),Mu=n(" special method."),Eu=l(),v(nn.$$.fragment),zu=l(),dl=a("p"),qu=n("Examples:"),Cu=l(),v(Hs.$$.fragment),mc=l(),vo=a("h2"),sn=a("a"),cl=a("span"),v(Rs.$$.fragment),Pu=l(),hl=a("span"),ju=n("TFLongformerModel"),fc=l(),Ee=a("div"),v(Us.$$.fragment),Ou=l(),ml=a("p"),Au=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Iu=l(),Vs=a("p"),Nu=n("This model inherits from "),dr=a("a"),Su=n("TFPreTrainedModel"),Du=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bu=l(),Gs=a("p"),Wu=n("This model is also a "),Ks=a("a"),Qu=n("tf.keras.Model"),Hu=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru=l(),v(an.$$.fragment),Uu=l(),ko=a("p"),Vu=n("This class copies code from "),cr=a("a"),Gu=n("TFRobertaModel"),Ku=n(` and overwrites standard self-attention with longformer
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),o_=l(),_t=a("div"),v(Ys.$$.fragment),n_=l(),bo=a("p"),s_=n("The "),hr=a("a"),a_=n("TFLongformerModel"),r_=n(" forward method, overrides the "),pl=a("code"),i_=n("__call__"),l_=n(" special method."),d_=l(),v(rn.$$.fragment),pc=l(),To=a("h2"),ln=a("a"),gl=a("span"),v(Zs.$$.fragment),c_=l(),ul=a("span"),h_=n("TFLongformerForMaskedLM"),gc=l(),Ae=a("div"),v(ea.$$.fragment),m_=l(),ta=a("p"),f_=n("Longformer Model with a "),_l=a("code"),p_=n("language modeling"),g_=n(" head on top."),u_=l(),oa=a("p"),__=n("This model inherits from "),mr=a("a"),w_=n("TFPreTrainedModel"),v_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),k_=l(),na=a("p"),b_=n("This model is also a "),sa=a("a"),T_=n("tf.keras.Model"),y_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),L_=l(),v(dn.$$.fragment),$_=l(),Ze=a("div"),v(aa.$$.fragment),F_=l(),yo=a("p"),x_=n("The "),fr=a("a"),M_=n("TFLongformerForMaskedLM"),E_=n(" forward method, overrides the "),wl=a("code"),z_=n("__call__"),q_=n(" special method."),C_=l(),v(cn.$$.fragment),P_=l(),vl=a("p"),j_=n("Example:"),O_=l(),v(ra.$$.fragment),uc=l(),Lo=a("h2"),hn=a("a"),kl=a("span"),v(ia.$$.fragment),A_=l(),bl=a("span"),I_=n("TFLongformerForQuestionAnswering"),_c=l(),Ie=a("div"),v(la.$$.fragment),N_=l(),$o=a("p"),S_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Y_=l(),v(mn.$$.fragment),Z_=l(),et=a("div"),v(ma.$$.fragment),ew=l(),Fo=a("p"),tw=n("The "),gr=a("a"),ow=n("TFLongformerForQuestionAnswering"),nw=n(" forward method, overrides the "),Ll=a("code"),sw=n("__call__"),aw=n(" special method."),rw=l(),v(fn.$$.fragment),iw=l(),$l=a("p"),lw=n("Example:"),dw=l(),v(fa.$$.fragment),wc=l(),xo=a("h2"),pn=a("a"),Fl=a("span"),v(pa.$$.fragment),cw=l(),xl=a("span"),hw=n("TFLongformerForSequenceClassification"),vc=l(),Ne=a("div"),v(ga.$$.fragment),mw=l(),Ml=a("p"),fw=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uw=l(),v(wn.$$.fragment),Vw=l(),ot=a("div"),v(Fa.$$.fragment),Gw=l(),zo=a("p"),Kw=n("The "),vr=a("a"),Jw=n("TFLongformerForTokenClassification"),Xw=n(" forward method, overrides the "),jl=a("code"),Yw=n("__call__"),Zw=n(" special method."),ev=l(),v(vn.$$.fragment),tv=l(),Ol=a("p"),ov=n("Example:"),nv=l(),v(xa.$$.fragment),Tc=l(),qo=a("h2"),kn=a("a"),Al=a("span"),v(Ma.$$.fragment),sv=l(),Il=a("span"),av=n("TFLongformerForMultipleChoice"),yc=l(),De=a("div"),v(Ea.$$.fragment),rv=l(),Nl=a("p"),iv=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),lv=l(),za=a("p"),dv=n("This model inherits from "),kr=a("a"),cv=n("TFPreTrainedModel"),hv=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mv=l(),qa=a("p"),fv=n("This model is also a "),Ca=a("a"),pv=n("tf.keras.Model"),gv=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),uv=l(),v(bn.$$.fragment),_v=l(),nt=a("div"),v(Pa.$$.fragment),wv=l(),Co=a("p"),vv=n("The "),br=a("a"),kv=n("TFLongformerForMultipleChoice"),bv=n(" forward method, overrides the "),Sl=a("code"),Tv=n("__call__"),yv=n(" special method."),Lv=l(),v(Tn.$$.fragment),$v=l(),Dl=a("p"),Fv=n("Example:"),xv=l(),v(ja.$$.fragment),this.h()},l(o){const f=n1('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),x=d(o),g=r(o,"H1",{class:!0});var Oa=i(g);u=r(Oa,"A",{id:!0,class:!0,href:!0});var Bl=i(u);$=r(Bl,"SPAN",{});var Wl=i($);k(w.$$.fragment,Wl),Wl.forEach(t),Bl.forEach(t),_=d(Oa),M=r(Oa,"SPAN",{});var Ql=i(M);de=s(Ql,"Longformer"),Ql.forEach(t),Oa.forEach(t),X=d(o),E=r(o,"P",{});var yn=i(E);ne=r(yn,"STRONG",{});var Hl=i(ne);Q=s(Hl,"DISCLAIMER:"),Hl.forEach(t),ce=s(yn," This model is still a work in progress, if you see something strange, file a "),Z=r(yn,"A",{href:!0,rel:!0});var Rl=i(Z);H=s(Rl,"Github Issue"),Rl.forEach(t),he=s(yn,"."),yn.forEach(t),ae=d(o),R=r(o,"H2",{class:!0});var Aa=i(R);P=r(Aa,"A",{id:!0,class:!0,href:!0});var Ul=i(P);se=r(Ul,"SPAN",{});var Vl=i(se);k(K.$$.fragment,Vl),Vl.forEach(t),Ul.forEach(t),z=d(Aa),q=r(Aa,"SPAN",{});var Gl=i(q);me=s(Gl,"Overview"),Gl.forEach(t),Aa.forEach(t),D=d(o),Y=r(o,"P",{});var Ia=i(Y);fe=s(Ia,"The Longformer model was presented in "),I=r(Ia,"A",{href:!0,rel:!0});var Kl=i(I);pe=s(Kl,"Longformer: The Long-Document Transformer"),Kl.forEach(t),ge=s(Ia," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Ia.forEach(t),C=d(o),ee=r(o,"P",{});var Jl=i(ee);U=s(Jl,"The abstract from the paper is the following:"),Jl.forEach(t),re=d(o),te=r(o,"P",{});var Xl=i(te);N=r(Xl,"EM",{});var Yl=i(N);ue=s(Yl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
contrast to most prior work, we also pretrain Longformer and finetune it on a variety of downstream tasks. Our
pretrained Longformer consistently outperforms RoBERTa on long document tasks and sets new state-of-the-art results on
WikiHop and TriviaQA.`),Yl.forEach(t),Xl.forEach(t),ie=d(o),j=r(o,"P",{});var Zl=i(j);_e=s(Zl,"Tips:"),Zl.forEach(t),B=d(o),oe=r(o,"UL",{});var ed=i(oe);m=r(ed,"LI",{});var Ln=i(m);F=s(Ln,"Since the Longformer is based on RoBERTa, it doesn\u2019t have "),J=r(Ln,"CODE",{});var Mv=i(J);Le=s(Mv,"token_type_ids"),Mv.forEach(t),$e=s(Ln,`. You don\u2019t need to indicate which
token belongs to which segment. Just separate your segments with the separation token `),O=r(Ln,"CODE",{});var Ev=i(O);Fe=s(Ev,"tokenizer.sep_token"),Ev.forEach(t),xe=s(Ln,` (or
`),be=r(Ln,"CODE",{});var zv=i(be);A=s(zv,"</s>"),zv.forEach(t),V=s(Ln,")."),Ln.forEach(t),ed.forEach(t),Te=d(o),le=r(o,"P",{});var Tr=i(le);G=s(Tr,"This model was contributed by "),ve=r(Tr,"A",{href:!0,rel:!0});var qv=i(ve);Me=s(qv,"beltagy"),qv.forEach(t),we=s(Tr,". The Authors\u2019 code can be found "),ke=r(Tr,"A",{href:!0,rel:!0});var Cv=i(ke);Oh=s(Cv,"here"),Cv.forEach(t),Ah=s(Tr,"."),Tr.forEach(t),sd=d(o),jt=r(o,"H2",{class:!0});var $c=i(jt);Oo=r($c,"A",{id:!0,class:!0,href:!0});var Pv=i(Oo);Vr=r(Pv,"SPAN",{});var jv=i(Vr);k($n.$$.fragment,jv),jv.forEach(t),Pv.forEach(t),Ih=d($c),Gr=r($c,"SPAN",{});var Ov=i(Gr);Nh=s(Ov,"Longformer Self Attention"),Ov.forEach(t),$c.forEach(t),ad=d(o),ye=r(o,"P",{});var Pe=i(ye);Sh=s(Pe,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),ti=r(Lr,"CODE",{});var Wv=i(ti);em=s(Wv,"global_attention_mask"),Wv.forEach(t),tm=s(Lr,":"),Lr.forEach(t),wd=d(o),Ao=r(o,"UL",{});var Fc=i(Ao);oi=r(Fc,"LI",{});var Qv=i(oi);om=s(Qv,"0: the token attends \u201Clocally\u201D,"),Qv.forEach(t),nm=d(Fc),ni=r(Fc,"LI",{});var Hv=i(ni);sm=s(Hv,"1: the token attends \u201Cglobally\u201D."),Hv.forEach(t),Fc.forEach(t),vd=d(o),Io=r(o,"P",{});var xc=i(Io);am=s(xc,"For more information please also refer to "),Na=r(xc,"A",{href:!0});var Rv=i(Na);rm=s(Rv,"forward()"),Rv.forEach(t),im=s(xc," method."),xc.forEach(t),kd=d(o),Ve=r(o,"P",{});var wt=i(Ve);lm=s(wt,`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
...
size. It is assumed that the number of \u201Cglobally\u201D attending tokens is insignificant as compared to the number of
\u201Clocally\u201D attending tokens.`),wt.forEach(t),Ed=d(o),No=r(o,"P",{});var Mc=i(No);dm=s(Mc,"For more information, please refer to the official "),Fn=r(Mc,"A",{href:!0,rel:!0});var Uv=i(Fn);cm=s(Uv,"paper"),Uv.forEach(t),hm=s(Mc,"."),Mc.forEach(t),zd=d(o),Ot=r(o,"H2",{class:!0});var Ec=i(Ot);So=r(Ec,"A",{id:!0,class:!0,href:!0});var Vv=i(So);si=r(Vv,"SPAN",{});var Gv=i(si);k(xn.$$.fragment,Gv),Gv.forEach(t),Vv.forEach(t),mm=d(Ec),ai=r(Ec,"SPAN",{});var Kv=i(ai);fm=s(Kv,"Training"),Kv.forEach(t),Ec.forEach(t),qd=d(o),At=r(o,"P",{});var td=i(At);Sa=r(td,"A",{href:!0});var Jv=i(Sa);pm=s(Jv,"LongformerForMaskedLM"),Jv.forEach(t),gm=s(td," is trained the exact same way "),Da=r(td,"A",{href:!0});var Xv=i(Da);um=s(Xv,"RobertaForMaskedLM"),Xv.forEach(t),_m=s(td,` is
trained and should be used as follows:`),td.forEach(t),Cd=d(o),k(Mn.$$.fragment,o),Pd=d(o),It=r(o,"H2",{class:!0});var zc=i(It);Do=r(zc,"A",{id:!0,class:!0,href:!0});var Yv=i(Do);ri=r(Yv,"SPAN",{});var Zv=i(ri);k(En.$$.fragment,Zv),Zv.forEach(t),Yv.forEach(t),wm=d(zc),ii=r(zc,"SPAN",{});var ek=i(ii);vm=s(ek,"LongformerConfig"),ek.forEach(t),zc.forEach(t),jd=d(o),Oe=r(o,"DIV",{class:!0});var it=i(Oe);k(zn.$$.fragment,it),km=d(it),Nt=r(it,"P",{});var $r=i(Nt);bm=s($r,"This is the configuration class to store the configuration of a "),Ba=r($r,"A",{href:!0});var tk=i(Ba);Tm=s(tk,"LongformerModel"),tk.forEach(t),ym=s($r," or a "),Wa=r($r,"A",{href:!0});var ok=i(Wa);Lm=s(ok,"TFLongformerModel"),ok.forEach(t),$m=s($r,`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),$r.forEach(t),Fm=d(it),St=r(it,"P",{});var Fr=i(St);xm=s(Fr,"This is the configuration class to store the configuration of a "),Qa=r(Fr,"A",{href:!0});var nk=i(Qa);Mm=s(nk,"LongformerModel"),nk.forEach(t),Em=s(Fr,`. It is used to instantiate an
Longformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the RoBERTa
`),qn=r(Fr,"A",{href:!0,rel:!0});var sk=i(qn);zm=s(sk,"roberta-base"),sk.forEach(t),qm=s(Fr," architecture with a sequence length 4,096."),Fr.forEach(t),Cm=d(it),Dt=r(it,"P",{});var xr=i(Dt);Pm=s(xr,"The "),Ha=r(xr,"A",{href:!0});var ak=i(Ha);jm=s(ak,"LongformerConfig"),ak.forEach(t),Om=s(xr," class directly inherits "),Ra=r(xr,"A",{href:!0});var rk=i(Ra);Am=s(rk,"RobertaConfig"),rk.forEach(t),Im=s(xr,`. It reuses the same defaults. Please check the
parent class for more information.`),xr.forEach(t),Nm=d(it),li=r(it,"P",{});var ik=i(li);Sm=s(ik,"Example:"),ik.forEach(t),Dm=d(it),k(Cn.$$.fragment,it),it.forEach(t),Od=d(o),Bt=r(o,"H2",{class:!0});var qc=i(Bt);Bo=r(qc,"A",{id:!0,class:!0,href:!0});var lk=i(Bo);di=r(lk,"SPAN",{});var dk=i(di);k(Pn.$$.fragment,dk),dk.forEach(t),lk.forEach(t),Bm=d(qc),ci=r(qc,"SPAN",{});var ck=i(ci);Wm=s(ck,"LongformerTokenizer"),ck.forEach(t),qc.forEach(t),Ad=d(o),ft=r(o,"DIV",{class:!0});var Mr=i(ft);k(jn.$$.fragment,Mr),Qm=d(Mr),hi=r(Mr,"P",{});var hk=i(hi);Hm=s(hk,"Construct a Longformer tokenizer."),hk.forEach(t),Rm=d(Mr),Wo=r(Mr,"P",{});var od=i(Wo);Ua=r(od,"A",{href:!0});var mk=i(Ua);Um=s(mk,"LongformerTokenizer"),mk.forEach(t),Vm=s(od," is identical to "),Va=r(od,"A",{href:!0});var fk=i(Va);Gm=s(fk,"RobertaTokenizer"),fk.forEach(t),Km=s(od,`. Refer to the superclass for usage examples and
...
and documentation concerning parameters.`),nd.forEach(t),Er.forEach(t),Sd=d(o),Qt=r(o,"H2",{class:!0});var jc=i(Qt);Ro=r(jc,"A",{id:!0,class:!0,href:!0});var kk=i(Ro);gi=r(kk,"SPAN",{});var bk=i(gi);k(Nn.$$.fragment,bk),bk.forEach(t),kk.forEach(t),lf=d(jc),ui=r(jc,"SPAN",{});var Tk=i(ui);df=s(Tk,"Longformer specific outputs"),Tk.forEach(t),jc.forEach(t),Dd=d(o),Ht=r(o,"DIV",{class:!0});var Oc=i(Ht);k(Sn.$$.fragment,Oc),cf=d(Oc),_i=r(Oc,"P",{});var yk=i(_i);hf=s(yk,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),yk.forEach(t),Oc.forEach(t),Bd=d(o),Rt=r(o,"DIV",{class:!0});var Ac=i(Rt);k(Dn.$$.fragment,Ac),mf=d(Ac),wi=r(Ac,"P",{});var Lk=i(wi);ff=s(Lk,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Lk.forEach(t),Ac.forEach(t),Wd=d(o),Ut=r(o,"DIV",{class:!0});var Ic=i(Ut);k(Bn.$$.fragment,Ic),pf=d(Ic),vi=r(Ic,"P",{});var $k=i(vi);gf=s($k,"Base class for masked language models outputs."),$k.forEach(t),Ic.forEach(t),Qd=d(o),Vt=r(o,"DIV",{class:!0});var Nc=i(Vt);k(Wn.$$.fragment,Nc),uf=d(Nc),ki=r(Nc,"P",{});var Fk=i(ki);_f=s(Fk,"Base class for outputs of question answering Longformer models."),Fk.forEach(t),Nc.forEach(t),Hd=d(o),Gt=r(o,"DIV",{class:!0});var Sc=i(Gt);k(Qn.$$.fragment,Sc),wf=d(Sc),bi=r(Sc,"P",{});var xk=i(bi);vf=s(xk,"Base class for outputs of sentence classification models."),xk.forEach(t),Sc.forEach(t),Rd=d(o),Kt=r(o,"DIV",{class:!0});var Dc=i(Kt);k(Hn.$$.fragment,Dc),kf=d(Dc),Ti=r(Dc,"P",{});var Mk=i(Ti);bf=s(Mk,"Base class for outputs of multiple choice Longformer models."),Mk.forEach(t),Dc.forEach(t),Ud=d(o),Jt=r(o,"DIV",{class:!0});var Bc=i(Jt);k(Rn.$$.fragment,Bc),Tf=d(Bc),yi=r(Bc,"P",{});var Ek=i(yi);yf=s(Ek,"Base class for outputs of token classification models."),Ek.forEach(t),Bc.forEach(t),Vd=d(o),Xt=r(o,"DIV",{class:!0});var Wc=i(Xt);k(Un.$$.fragment,Wc),Lf=d(Wc),Li=r(Wc,"P",{});var zk=i(Li);$f=s(zk,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),zk.forEach(t),Wc.forEach(t),Gd=d(o),Yt=r(o,"DIV",{class:!0});var Qc=i(Yt);k(Vn.$$.fragment,Qc),Ff=d(Qc),$i=r(Qc,"P",{});var qk=i($i);xf=s(qk,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),qk.forEach(t),Qc.forEach(t),Kd=d(o),Zt=r(o,"DIV",{class:!0});var Hc=i(Zt);k(Gn.$$.fragment,Hc),Mf=d(Hc),Fi=r(Hc,"P",{});var Ck=i(Fi);Ef=s(Ck,"Base class for masked language models outputs."),Ck.forEach(t),Hc.forEach(t),Jd=d(o),eo=r(o,"DIV",{class:!0});var Rc=i(eo);k(Kn.$$.fragment,Rc),zf=d(Rc),xi=r(Rc,"P",{});var Pk=i(xi);qf=s(Pk,"Base class for outputs of question answering Longformer models."),Pk.forEach(t),Rc.forEach(t),Xd=d(o),to=r(o,"DIV",{class:!0});var Uc=i(to);k(Jn.$$.fragment,Uc),Cf=d(Uc),Mi=r(Uc,"P",{});var jk=i(Mi);Pf=s(jk,"Base class for outputs of sentence classification models."),jk.forEach(t),Uc.forEach(t),Yd=d(o),oo=r(o,"DIV",{class:!0});var Vc=i(oo);k(Xn.$$.fragment,Vc),jf=d(Vc),Ei=r(Vc,"P",{});var Ok=i(Ei);Of=s(Ok,"Base class for outputs of multiple choice models."),Ok.forEach(t),Vc.forEach(t),Zd=d(o),no=r(o,"DIV",{class:!0});var Gc=i(no);k(Yn.$$.fragment,Gc),Af=d(Gc),zi=r(Gc,"P",{});var Ak=i(zi);If=s(Ak,"Base class for outputs of token classification models."),Ak.forEach(t),Gc.forEach(t),ec=d(o),so=r(o,"H2",{class:!0});var Kc=i(so);Uo=r(Kc,"A",{id:!0,class:!0,href:!0});var Ik=i(Uo);qi=r(Ik,"SPAN",{});var Nk=i(qi);k(Zn.$$.fragment,Nk),Nk.forEach(t),Ik.forEach(t),Nf=d(Kc),Ci=r(Kc,"SPAN",{});var Sk=i(Ci);Sf=s(Sk,"LongformerModel"),Sk.forEach(t),Kc.forEach(t),tc=d(o),qe=r(o,"DIV",{class:!0});var st=i(qe);k(es.$$.fragment,st),Df=d(st),Pi=r(st,"P",{});var Dk=i(Pi);Bf=s(Dk,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Dk.forEach(t),Wf=d(st),ts=r(st,"P",{});var Jc=i(ts);Qf=s(Jc,"This model inherits from "),Ja=r(Jc,"A",{href:!0});var Bk=i(Ja);Hf=s(Bk,"PreTrainedModel"),Bk.forEach(t),Rf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),Uf=d(st),os=r(st,"P",{});var Xc=i(os);Vf=s(Xc,"This model is also a PyTorch "),ns=r(Xc,"A",{href:!0,rel:!0});var Wk=i(ns);Gf=s(Wk,"torch.nn.Module"),Wk.forEach(t),Kf=s(Xc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xc.forEach(t),Jf=d(st),ao=r(st,"P",{});var zr=i(ao);Xf=s(zr,"This class copied code from "),Xa=r(zr,"A",{href:!0});var Qk=i(Xa);Yf=s(Qk,"RobertaModel"),Qk.forEach(t),Zf=s(zr,` and overwrote standard self-attention with longformer self-attention
to provide the ability to process long sequences following the self-attention approach described in `),ss=r(zr,"A",{href:!0,rel:!0});var Hk=i(ss);ep=s(Hk,`Longformer:
the Long-Document Transformer`),Hk.forEach(t),tp=s(zr,` by Iz Beltagy, Matthew E. Peters, and Arman Cohan.
Longformer self-attention combines a local (sliding window) and global attention to extend to long documents
without the O(n^2) increase in memory and compute.`),zr.forEach(t),op=d(st),as=r(st,"P",{});var Yc=i(as);np=s(Yc,"The self-attention module "),ji=r(Yc,"CODE",{});var Rk=i(ji);sp=s(Rk,"LongformerSelfAttention"),Rk.forEach(t),ap=s(Yc,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Yc.forEach(t),rp=d(st),Ge=r(st,"DIV",{class:!0});var vt=i(Ge);k(rs.$$.fragment,vt),ip=d(vt),ro=r(vt,"P",{});var qr=i(ro);lp=s(qr,"The "),Ya=r(qr,"A",{href:!0});var Uk=i(Ya);dp=s(Uk,"LongformerModel"),Uk.forEach(t),cp=s(qr," forward method, overrides the "),Oi=r(qr,"CODE",{});var Vk=i(Oi);hp=s(Vk,"__call__"),Vk.forEach(t),mp=s(qr," special method."),qr.forEach(t),fp=d(vt),k(Vo.$$.fragment,vt),pp=d(vt),Ai=r(vt,"P",{});var Gk=i(Ai);gp=s(Gk,"Examples:"),Gk.forEach(t),up=d(vt),k(is.$$.fragment,vt),vt.forEach(t),st.forEach(t),oc=d(o),io=r(o,"H2",{class:!0});var Zc=i(io);Go=r(Zc,"A",{id:!0,class:!0,href:!0});var Kk=i(Go);Ii=r(Kk,"SPAN",{});var Jk=i(Ii);k(ls.$$.fragment,Jk),Jk.forEach(t),Kk.forEach(t),_p=d(Zc),Ni=r(Zc,"SPAN",{});var Xk=i(Ni);wp=s(Xk,"LongformerForMaskedLM"),Xk.forEach(t),Zc.forEach(t),nc=d(o),We=r(o,"DIV",{class:!0});var kt=i(We);k(ds.$$.fragment,kt),vp=d(kt),cs=r(kt,"P",{});var eh=i(cs);kp=s(eh,"Longformer Model with a "),Si=r(eh,"CODE",{});var Yk=i(Si);bp=s(Yk,"language modeling"),Yk.forEach(t),Tp=s(eh," head on top."),eh.forEach(t),yp=d(kt),hs=r(kt,"P",{});var th=i(hs);Lp=s(th,"This model inherits from "),Za=r(th,"A",{href:!0});var Zk=i(Za);$p=s(Zk,"PreTrainedModel"),Zk.forEach(t),Fp=s(th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),th.forEach(t),xp=d(kt),ms=r(kt,"P",{});var oh=i(ms);Mp=s(oh,"This model is also a PyTorch "),fs=r(oh,"A",{href:!0,rel:!0});var eb=i(fs);Ep=s(eb,"torch.nn.Module"),eb.forEach(t),zp=s(oh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oh.forEach(t),qp=d(kt),Ke=r(kt,"DIV",{class:!0});var bt=i(Ke);k(ps.$$.fragment,bt),Cp=d(bt),lo=r(bt,"P",{});var Cr=i(lo);Pp=s(Cr,"The "),er=r(Cr,"A",{href:!0});var tb=i(er);jp=s(tb,"LongformerForMaskedLM"),tb.forEach(t),Op=s(Cr," forward method, overrides the "),Di=r(Cr,"CODE",{});var ob=i(Di);Ap=s(ob,"__call__"),ob.forEach(t),Ip=s(Cr," special method."),Cr.forEach(t),Np=d(bt),k(Ko.$$.fragment,bt),Sp=d(bt),Bi=r(bt,"P",{});var nb=i(Bi);Dp=s(nb,"Examples:"),nb.forEach(t),Bp=d(bt),k(gs.$$.fragment,bt),bt.forEach(t),kt.forEach(t),sc=d(o),co=r(o,"H2",{class:!0});var nh=i(co);Jo=r(nh,"A",{id:!0,class:!0,href:!0});var sb=i(Jo);Wi=r(sb,"SPAN",{});var ab=i(Wi);k(us.$$.fragment,ab),ab.forEach(t),sb.forEach(t),Wp=d(nh),Qi=r(nh,"SPAN",{});var rb=i(Qi);Qp=s(rb,"LongformerForSequenceClassification"),rb.forEach(t),nh.forEach(t),ac=d(o),Qe=r(o,"DIV",{class:!0});var Tt=i(Qe);k(_s.$$.fragment,Tt),Hp=d(Tt),Hi=r(Tt,"P",{});var ib=i(Hi);Rp=s(ib,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sh.forEach(t),Jp=d(Tt),vs=r(Tt,"P",{});var ah=i(vs);Xp=s(ah,"This model is also a PyTorch "),ks=r(ah,"A",{href:!0,rel:!0});var db=i(ks);Yp=s(db,"torch.nn.Module"),db.forEach(t),Zp=s(ah,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ah.forEach(t),eg=d(Tt),Ce=r(Tt,"DIV",{class:!0});var at=i(Ce);k(bs.$$.fragment,at),tg=d(at),ho=r(at,"P",{});var Pr=i(ho);og=s(Pr,"The "),or=r(Pr,"A",{href:!0});var cb=i(or);ng=s(cb,"LongformerForSequenceClassification"),cb.forEach(t),sg=s(Pr," forward method, overrides the "),Ri=r(Pr,"CODE",{});var hb=i(Ri);ag=s(hb,"__call__"),hb.forEach(t),rg=s(Pr," special method."),Pr.forEach(t),ig=d(at),k(Xo.$$.fragment,at),lg=d(at),Ui=r(at,"P",{});var mb=i(Ui);dg=s(mb,"Example of single-label classification:"),mb.forEach(t),cg=d(at),k(Ts.$$.fragment,at),hg=d(at),Vi=r(at,"P",{});var fb=i(Vi);mg=s(fb,"Example of multi-label classification:"),fb.forEach(t),fg=d(at),k(ys.$$.fragment,at),at.forEach(t),Tt.forEach(t),rc=d(o),mo=r(o,"H2",{class:!0});var rh=i(mo);Yo=r(rh,"A",{id:!0,class:!0,href:!0});var pb=i(Yo);Gi=r(pb,"SPAN",{});var gb=i(Gi);k(Ls.$$.fragment,gb),gb.forEach(t),pb.forEach(t),pg=d(rh),Ki=r(rh,"SPAN",{});var ub=i(Ki);gg=s(ub,"LongformerForMultipleChoice"),ub.forEach(t),rh.forEach(t),ic=d(o),He=r(o,"DIV",{class:!0});var yt=i(He);k($s.$$.fragment,yt),ug=d(yt),Ji=r(yt,"P",{});var _b=i(Ji);_g=s(_b,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),_b.forEach(t),wg=d(yt),Fs=r(yt,"P",{});var ih=i(Fs);vg=s(ih,"This model inherits from "),nr=r(ih,"A",{href:!0});var wb=i(nr);kg=s(wb,"PreTrainedModel"),wb.forEach(t),bg=s(ih,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ih.forEach(t),Tg=d(yt),xs=r(yt,"P",{});var lh=i(xs);yg=s(lh,"This model is also a PyTorch "),Ms=r(lh,"A",{href:!0,rel:!0});var vb=i(Ms);Lg=s(vb,"torch.nn.Module"),vb.forEach(t),$g=s(lh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lh.forEach(t),Fg=d(yt),Je=r(yt,"DIV",{class:!0});var Lt=i(Je);k(Es.$$.fragment,Lt),xg=d(Lt),fo=r(Lt,"P",{});var jr=i(fo);Mg=s(jr,"The "),sr=r(jr,"A",{href:!0});var kb=i(sr);Eg=s(kb,"LongformerForMultipleChoice"),kb.forEach(t),zg=s(jr," forward method, overrides the "),Xi=r(jr,"CODE",{});var bb=i(Xi);qg=s(bb,"__call__"),bb.forEach(t),Cg=s(jr," special method."),jr.forEach(t),Pg=d(Lt),k(Zo.$$.fragment,Lt),jg=d(Lt),Yi=r(Lt,"P",{});var Tb=i(Yi);Og=s(Tb,"Example:"),Tb.forEach(t),Ag=d(Lt),k(zs.$$.fragment,Lt),Lt.forEach(t),yt.forEach(t),lc=d(o),po=r(o,"H2",{class:!0});var dh=i(po);en=r(dh,"A",{id:!0,class:!0,href:!0});var yb=i(en);Zi=r(yb,"SPAN",{});var Lb=i(Zi);k(qs.$$.fragment,Lb),Lb.forEach(t),yb.forEach(t),Ig=d(dh),el=r(dh,"SPAN",{});var $b=i(el);Ng=s($b,"LongformerForTokenClassification"),$b.forEach(t),dh.forEach(t),dc=d(o),Re=r(o,"DIV",{class:!0});var $t=i(Re);k(Cs.$$.fragment,$t),Sg=d($t),tl=r($t,"P",{});var Fb=i(tl);Dg=s(Fb,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hh.forEach(t),Kg=d($t),Xe=r($t,"DIV",{class:!0});var Ft=i(Xe);k(As.$$.fragment,Ft),Jg=d(Ft),go=r(Ft,"P",{});var Or=i(go);Xg=s(Or,"The "),rr=r(Or,"A",{href:!0});var Eb=i(rr);Yg=s(Eb,"LongformerForTokenClassification"),Eb.forEach(t),Zg=s(Or," forward method, overrides the "),ol=r(Or,"CODE",{});var zb=i(ol);eu=s(zb,"__call__"),zb.forEach(t),tu=s(Or," special method."),Or.forEach(t),ou=d(Ft),k(tn.$$.fragment,Ft),nu=d(Ft),nl=r(Ft,"P",{});var qb=i(nl);su=s(qb,"Example:"),qb.forEach(t),au=d(Ft),k(Is.$$.fragment,Ft),Ft.forEach(t),$t.forEach(t),cc=d(o),uo=r(o,"H2",{class:!0});var mh=i(uo);on=r(mh,"A",{id:!0,class:!0,href:!0});var Cb=i(on);sl=r(Cb,"SPAN",{});var Pb=i(sl);k(Ns.$$.fragment,Pb),Pb.forEach(t),Cb.forEach(t),ru=d(mh),al=r(mh,"SPAN",{});var jb=i(al);iu=s(jb,"LongformerForQuestionAnswering"),jb.forEach(t),mh.forEach(t),hc=d(o),Ue=r(o,"DIV",{class:!0});var xt=i(Ue);k(Ss.$$.fragment,xt),lu=d(xt),_o=r(xt,"P",{});var Ar=i(_o);du=s(Ar,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fh.forEach(t),wu=d(xt),Bs=r(xt,"P",{});var ph=i(Bs);vu=s(ph,"This model is also a PyTorch "),Ws=r(ph,"A",{href:!0,rel:!0});var Nb=i(Ws);ku=s(Nb,"torch.nn.Module"),Nb.forEach(t),bu=s(ph,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ph.forEach(t),Tu=d(xt),Ye=r(xt,"DIV",{class:!0});var Mt=i(Ye);k(Qs.$$.fragment,Mt),yu=d(Mt),wo=r(Mt,"P",{});var Ir=i(wo);Lu=s(Ir,"The "),lr=r(Ir,"A",{href:!0});var Sb=i(lr);$u=s(Sb,"LongformerForQuestionAnswering"),Sb.forEach(t),Fu=s(Ir," forward method, overrides the "),ll=r(Ir,"CODE",{});var Db=i(ll);xu=s(Db,"__call__"),Db.forEach(t),Mu=s(Ir," special method."),Ir.forEach(t),Eu=d(Mt),k(nn.$$.fragment,Mt),zu=d(Mt),dl=r(Mt,"P",{});var Bb=i(dl);qu=s(Bb,"Examples:"),Bb.forEach(t),Cu=d(Mt),k(Hs.$$.fragment,Mt),Mt.forEach(t),xt.forEach(t),mc=d(o),vo=r(o,"H2",{class:!0});var gh=i(vo);sn=r(gh,"A",{id:!0,class:!0,href:!0});var Wb=i(sn);cl=r(Wb,"SPAN",{});var Qb=i(cl);k(Rs.$$.fragment,Qb),Qb.forEach(t),Wb.forEach(t),Pu=d(gh),hl=r(gh,"SPAN",{});var Hb=i(hl);ju=s(Hb,"TFLongformerModel"),Hb.forEach(t),gh.forEach(t),fc=d(o),Ee=r(o,"DIV",{class:!0});var Be=i(Ee);k(Us.$$.fragment,Be),Ou=d(Be),ml=r(Be,"P",{});var Rb=i(ml);Au=s(Rb,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Rb.forEach(t),Iu=d(Be),Vs=r(Be,"P",{});var uh=i(Vs);Nu=s(uh,"This model inherits from "),dr=r(uh,"A",{href:!0});var Ub=i(dr);Su=s(Ub,"TFPreTrainedModel"),Ub.forEach(t),Du=s(uh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_h.forEach(t),Ru=d(Be),k(an.$$.fragment,Be),Uu=d(Be),ko=r(Be,"P",{});var Nr=i(ko);Vu=s(Nr,"This class copies code from "),cr=r(Nr,"A",{href:!0});var Gb=i(cr);Gu=s(Gb,"TFRobertaModel"),Gb.forEach(t),Ku=s(Nr,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$h.forEach(t),Y_=d(dt),k(mn.$$.fragment,dt),Z_=d(dt),et=r(dt,"DIV",{class:!0});var zt=i(et);k(ma.$$.fragment,zt),ew=d(zt),Fo=r(zt,"P",{});var Qr=i(Fo);tw=s(Qr,"The "),gr=r(Qr,"A",{href:!0});var gT=i(gr);ow=s(gT,"TFLongformerForQuestionAnswering"),gT.forEach(t),nw=s(Qr," forward method, overrides the "),Ll=r(Qr,"CODE",{});var uT=i(Ll);sw=s(uT,"__call__"),uT.forEach(t),aw=s(Qr," special method."),Qr.forEach(t),rw=d(zt),k(fn.$$.fragment,zt),iw=d(zt),$l=r(zt,"P",{});var _T=i($l);lw=s(_T,"Example:"),_T.forEach(t),dw=d(zt),k(fa.$$.fragment,zt),zt.forEach(t),dt.forEach(t),wc=d(o),xo=r(o,"H2",{class:!0});var Fh=i(xo);pn=r(Fh,"A",{id:!0,class:!0,href:!0});var wT=i(pn);Fl=r(wT,"SPAN",{});var vT=i(Fl);k(pa.$$.fragment,vT),vT.forEach(t),wT.forEach(t),cw=d(Fh),xl=r(Fh,"SPAN",{});var kT=i(xl);hw=s(kT,"TFLongformerForSequenceClassification"),kT.forEach(t),Fh.forEach(t),vc=d(o),Ne=r(o,"DIV",{class:!0});var ct=i(Ne);k(ga.$$.fragment,ct),mw=d(ct),Ml=r(ct,"P",{});var bT=i(Ml);fw=s(bT,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xh.forEach(t),ww=d(ct),_a=r(ct,"P",{});var Mh=i(_a);vw=s(Mh,"This model is also a "),wa=r(Mh,"A",{href:!0,rel:!0});var yT=i(wa);kw=s(yT,"tf.keras.Model"),yT.forEach(t),bw=s(Mh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mh.forEach(t),Tw=d(ct),k(gn.$$.fragment,ct),yw=d(ct),tt=r(ct,"DIV",{class:!0});var qt=i(tt);k(va.$$.fragment,qt),Lw=d(qt),Mo=r(qt,"P",{});var Hr=i(Mo);$w=s(Hr,"The "),_r=r(Hr,"A",{href:!0});var LT=i(_r);Fw=s(LT,"TFLongformerForSequenceClassification"),LT.forEach(t),xw=s(Hr," forward method, overrides the "),El=r(Hr,"CODE",{});var $T=i(El);Mw=s($T,"__call__"),$T.forEach(t),Ew=s(Hr," special method."),Hr.forEach(t),zw=d(qt),k(un.$$.fragment,qt),qw=d(qt),zl=r(qt,"P",{});var FT=i(zl);Cw=s(FT,"Example:"),FT.forEach(t),Pw=d(qt),k(ka.$$.fragment,qt),qt.forEach(t),ct.forEach(t),kc=d(o),Eo=r(o,"H2",{class:!0});var Eh=i(Eo);_n=r(Eh,"A",{id:!0,class:!0,href:!0});var xT=i(_n);ql=r(xT,"SPAN",{});var MT=i(ql);k(ba.$$.fragment,MT),MT.forEach(t),xT.forEach(t),jw=d(Eh),Cl=r(Eh,"SPAN",{});var ET=i(Cl);Ow=s(ET,"TFLongformerForTokenClassification"),ET.forEach(t),Eh.forEach(t),bc=d(o),Se=r(o,"DIV",{class:!0});var ht=i(Se);k(Ta.$$.fragment,ht),Aw=d(ht),Pl=r(ht,"P",{});var zT=i(Pl);Iw=s(zT,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
