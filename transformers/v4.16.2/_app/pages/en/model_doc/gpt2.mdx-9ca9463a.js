...
Argument used when doing sequence summary, used in the models <a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel">GPT2DoubleHeadsModel</a> and
<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.TFGPT2DoubleHeadsModel">TFGPT2DoubleHeadsModel</a>.</p>
...
<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel">GPT2DoubleHeadsModel</a>.</p>
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),Go=new Le({props:{$$slots:{default:[$b]},$$scope:{ctx:q}}}),zn=new Fe({}),Fn=new H({props:{name:"class transformers.models.gpt2.modeling\\_gpt2.GPT2DoubleHeadsModelOutput",anchor:"transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"mc_loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"mc_logits",val:": FloatTensor = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L492",parametersDescription:[{anchor:"transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
heads.`,name:"attentions"}]}}),jn=new Fe({}),En=new H({props:{name:"class transformers.GPT2Model",anchor:"transformers.GPT2Model",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L668",parametersDescription:[{anchor:"transformers.GPT2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Hn=new H({props:{name:"forward",anchor:"transformers.GPT2Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L737",parametersDescription:[{anchor:"transformers.GPT2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Nn=new H({props:{name:"parallelize",anchor:"transformers.GPT2Model.parallelize",parameters:[{name:"device_map",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L691",parametersDescription:[{anchor:"transformers.GPT2Model.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
...
model.parallelize(device_map)`}}),Sn=new H({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L711"}}),An=new Me({props:{code:`# On a 4 GPU machine with gpt2-large:
...
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),On=new Fe({}),Wn=new H({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L946",parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vn=new H({props:{name:"forward",anchor:"transformers.GPT2LMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L1015",parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Kn=new H({props:{name:"parallelize",anchor:"transformers.GPT2LMHeadModel.parallelize",parameters:[{name:"device_map",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L961",parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the gpt2 models have the
following number of attention modules:</p>
...
model.parallelize(device_map)`}}),Yn=new H({props:{name:"deparallelize",anchor:"transformers.GPT2LMHeadModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L973"}}),Qn=new Me({props:{code:`# On a 4 GPU machine with gpt2-large:
model = GPT2LMHeadModel.from_pretrained("gpt2-large")
device_map = {
    0: [0, 1, 2, 3, 4, 5, 6, 7],
    1: [8, 9, 10, 11, 12, 13, 14, 15],
...
model.parallelize(device_map)  <span class="hljs-comment"># Splits the model across several devices</span>
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),Zn=new Fe({}),es=new H({props:{name:"class transformers.GPT2DoubleHeadsModel",anchor:"transformers.GPT2DoubleHeadsModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L1115",parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ss=new H({props:{name:"forward",anchor:"transformers.GPT2DoubleHeadsModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"mc_token_ids",val:" = None"},{name:"labels",val:" = None"},{name:"mc_labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L1189",parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>mc_logits = outputs.mc_logits`}}),rs=new Fe({}),is=new H({props:{name:"class transformers.GPT2ForSequenceClassification",anchor:"transformers.GPT2ForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L1331",parametersDescription:[{anchor:"transformers.GPT2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ps=new H({props:{name:"forward",anchor:"transformers.GPT2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L1347",parametersDescription:[{anchor:"transformers.GPT2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ms=new Fe({}),fs=new H({props:{name:"class transformers.GPT2ForTokenClassification",anchor:"transformers.GPT2ForTokenClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L1457",parametersDescription:[{anchor:"transformers.GPT2ForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vs=new H({props:{name:"forward",anchor:"transformers.GPT2ForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_gpt2.py#L1479",parametersDescription:[{anchor:"transformers.GPT2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ks=new Fe({}),ys=new H({props:{name:"class transformers.TFGPT2Model",anchor:"transformers.TFGPT2Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_tf_gpt2.py#L727",parametersDescription:[{anchor:"transformers.TFGPT2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),So=new Le({props:{$$slots:{default:[jb]},$$scope:{ctx:q}}}),Ms=new H({props:{name:"call",anchor:"transformers.TFGPT2Model.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_tf_gpt2.py#L732",parametersDescription:[{anchor:"transformers.TFGPT2Model.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),zs=new Fe({}),Fs=new H({props:{name:"class transformers.TFGPT2LMHeadModel",anchor:"transformers.TFGPT2LMHeadModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_tf_gpt2.py#L843",parametersDescription:[{anchor:"transformers.TFGPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Wo=new Le({props:{$$slots:{default:[qb]},$$scope:{ctx:q}}}),qs=new H({props:{name:"call",anchor:"transformers.TFGPT2LMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_tf_gpt2.py#L861",parametersDescription:[{anchor:"transformers.TFGPT2LMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ds=new Fe({}),Hs=new H({props:{name:"class transformers.TFGPT2DoubleHeadsModel",anchor:"transformers.TFGPT2DoubleHeadsModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_tf_gpt2.py#L995",parametersDescription:[{anchor:"transformers.TFGPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new Le({props:{$$slots:{default:[Db]},$$scope:{ctx:q}}}),Ss=new H({props:{name:"call",anchor:"transformers.TFGPT2DoubleHeadsModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"mc_token_ids",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1004",parametersDescription:[{anchor:"transformers.TFGPT2DoubleHeadsModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.models.gpt2.modeling_tf_gpt2.TFGPT2DoubleHeadsModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ks=new Fe({}),Xs=new H({props:{name:"class transformers.modeling\\_tf\\_outputs.TFSequenceClassifierOutputWithPast",anchor:"transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/modeling_tf_outputs.py#L758",parametersDescription:[{anchor:"transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, )</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),ra=new H({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxGPT2PreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"encoder_hidden_states",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_flax_gpt2.py#L447",parametersDescription:[{anchor:"transformers.FlaxGPT2PreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),_a=new H({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxGPT2PreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"encoder_hidden_states",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/gpt2/modeling_flax_gpt2.py#L447",parametersDescription:[{anchor:"transformers.FlaxGPT2PreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code>. Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxGPT2PreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
key/value attention pairs. Using this (`),D=s(ze,"EM",{});var Z_=i(D);X=r(Z_,"past_key_values"),Z_.forEach(t),We=r(ze," or "),Ee=s(ze,"EM",{});var e2=i(Ee);Y=r(e2,"past"),e2.forEach(t),Be=r(ze,`) value prevents the model from re-computing
pre-computed values in the context of text generation. For PyTorch, see `),qe=s(ze,"EM",{});var t2=i(qe);ve=r(t2,"past_key_values"),t2.forEach(t),Ue=r(ze,` argument of the
`),wa=s(ze,"A",{href:!0});var o2=i(wa);sc=r(o2,"GPT2Model.forward()"),o2.forEach(t),ac=r(ze," method, or for TF the "),mr=s(ze,"EM",{});var n2=i(mr);rc=r(n2,"past"),n2.forEach(t),ic=r(ze,` argument of the
`),Pa=s(ze,"A",{href:!0});var s2=i(Pa);lc=r(s2,"TFGPT2Model.call()"),s2.forEach(t),dc=r(ze," method for more information on its usage."),ze.forEach(t),cc=d($t),kt=s($t,"LI",{});var on=i(kt);pc=r(on,"Enabling the "),fr=s(on,"EM",{});var a2=i(fr);hc=r(a2,"scale_attn_by_inverse_layer_idx"),a2.forEach(t),uc=r(on," and "),gr=s(on,"EM",{});var r2=i(gr);mc=r(r2,"reorder_and_upcast_attn"),r2.forEach(t),fc=r(on,` flags will apply the training stability
improvements from `),dn=s(on,"A",{href:!0,rel:!0});var i2=i(dn);gc=r(i2,"Mistral"),i2.forEach(t),_c=r(on," (for PyTorch only)."),on.forEach(t),$t.forEach(t),xl=d(o),Bt=s(o,"P",{});var Fl=i(Bt);cn=s(Fl,"A",{href:!0,rel:!0});var l2=i(cn);Tc=r(l2,"Write With Transformer"),l2.forEach(t),vc=r(Fl,` is a webapp created and hosted by
Hugging Face showcasing the generative capabilities of several models. GPT-2 is one of them and is available in five
different sizes: small, medium, large, xl and a distilled version of the small checkpoint: `),_r=s(Fl,"EM",{});var d2=i(_r);bc=r(d2,"distilgpt-2"),d2.forEach(t),kc=r(Fl,"."),Fl.forEach(t),jl=d(o),Mt=s(o,"P",{});var tr=i(Mt);yc=r(tr,"This model was contributed by "),pn=s(tr,"A",{href:!0,rel:!0});var c2=i(pn);wc=r(c2,"thomwolf"),c2.forEach(t),Pc=r(tr,". The original code can be found "),hn=s(tr,"A",{href:!0,rel:!0});var p2=i(hn);$c=r(p2,"here"),p2.forEach(t),Mc=r(tr,"."),tr.forEach(t),El=d(o),Ut=s(o,"H2",{class:!0});var hd=i(Ut);wo=s(hd,"A",{id:!0,class:!0,href:!0});var h2=i(wo);Tr=s(h2,"SPAN",{});var u2=i(Tr);b(un.$$.fragment,u2),u2.forEach(t),h2.forEach(t),Gc=d(hd),vr=s(hd,"SPAN",{});var m2=i(vr);zc=r(m2,"GPT2Config"),m2.forEach(t),hd.forEach(t),ql=d(o),Re=s(o,"DIV",{class:!0});var Gt=i(Re);b(mn.$$.fragment,Gt),Fc=d(Gt),yt=s(Gt,"P",{});var nn=i(yt);xc=r(nn,"This is the configuration class to store the configuration of a "),$a=s(nn,"A",{href:!0});var f2=i($a);jc=r(f2,"GPT2Model"),f2.forEach(t),Ec=r(nn," or a "),Ma=s(nn,"A",{href:!0});var g2=i(Ma);qc=r(g2,"TFGPT2Model"),g2.forEach(t),Cc=r(nn,`. It is used to
instantiate a GPT-2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the GPT-2
`),fn=s(nn,"A",{href:!0,rel:!0});var _2=i(fn);Dc=r(_2,"small"),_2.forEach(t),Hc=r(nn," architecture."),nn.forEach(t),Lc=d(Gt),Rt=s(Gt,"P",{});var or=i(Rt);Nc=r(or,"Configuration objects inherit from "),Ga=s(or,"A",{href:!0});var T2=i(Ga);Ic=r(T2,"PretrainedConfig"),T2.forEach(t),Sc=r(or,` and can be used to control the model outputs. Read the
documentation from `),za=s(or,"A",{href:!0});var v2=i(za);Ac=r(v2,"PretrainedConfig"),v2.forEach(t),Oc=r(or," for more information."),or.forEach(t),Wc=d(Gt),br=s(Gt,"P",{});var b2=i(br);Bc=r(b2,"Example:"),b2.forEach(t),Uc=d(Gt),b(gn.$$.fragment,Gt),Gt.forEach(t),Cl=d(o),Vt=s(o,"H2",{class:!0});var ud=i(Vt);Po=s(ud,"A",{id:!0,class:!0,href:!0});var k2=i(Po);kr=s(k2,"SPAN",{});var y2=i(kr);b(_n.$$.fragment,y2),y2.forEach(t),k2.forEach(t),Rc=d(ud),yr=s(ud,"SPAN",{});var w2=i(yr);Vc=r(w2,"GPT2Tokenizer"),w2.forEach(t),ud.forEach(t),Dl=d(o),le=s(o,"DIV",{class:!0});var Ne=i(le);b(Tn.$$.fragment,Ne),Jc=d(Ne),wr=s(Ne,"P",{});var P2=i(wr);Kc=r(P2,"Construct a GPT-2 tokenizer. Based on byte-level Byte-Pair-Encoding."),P2.forEach(t),Xc=d(Ne),Pr=s(Ne,"P",{});var $2=i(Pr);Yc=r($2,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),$2.forEach(t),Qc=d(Ne),b(vn.$$.fragment,Ne),Zc=d(Ne),bn=s(Ne,"P",{});var md=i(bn);ep=r(md,"You can get around that behavior by passing "),$r=s(md,"CODE",{});var M2=i($r);tp=r(M2,"add_prefix_space=True"),M2.forEach(t),op=r(md,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),md.forEach(t),np=d(Ne),b($o.$$.fragment,Ne),sp=d(Ne),kn=s(Ne,"P",{});var fd=i(kn);ap=r(fd,"This tokenizer inherits from "),Fa=s(fd,"A",{href:!0});var G2=i(Fa);rp=r(G2,"PreTrainedTokenizer"),G2.forEach(t),ip=r(fd,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),fd.forEach(t),lp=d(Ne),Mr=s(Ne,"DIV",{class:!0}),i(Mr).forEach(t),Ne.forEach(t),Hl=d(o),Jt=s(o,"H2",{class:!0});var gd=i(Jt);Mo=s(gd,"A",{id:!0,class:!0,href:!0});var z2=i(Mo);Gr=s(z2,"SPAN",{});var F2=i(Gr);b(yn.$$.fragment,F2),F2.forEach(t),z2.forEach(t),dp=d(gd),zr=s(gd,"SPAN",{});var x2=i(zr);cp=r(x2,"GPT2TokenizerFast"),x2.forEach(t),gd.forEach(t),Ll=d(o),be=s(o,"DIV",{class:!0});var it=i(be);b(wn.$$.fragment,it),pp=d(it),Pn=s(it,"P",{});var _d=i(Pn);hp=r(_d,"Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Fr=s(_d,"EM",{});var j2=i(Fr);up=r(j2,"tokenizers"),j2.forEach(t),mp=r(_d,` library). Based on byte-level
Byte-Pair-Encoding.`),_d.forEach(t),fp=d(it),xr=s(it,"P",{});var E2=i(xr);gp=r(E2,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),E2.forEach(t),_p=d(it),b($n.$$.fragment,it),Tp=d(it),Mn=s(it,"P",{});var Td=i(Mn);vp=r(Td,"You can get around that behavior by passing "),jr=s(Td,"CODE",{});var q2=i(jr);bp=r(q2,"add_prefix_space=True"),q2.forEach(t),kp=r(Td,` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),Td.forEach(t),yp=d(it),b(Go.$$.fragment,it),wp=d(it),Gn=s(it,"P",{});var vd=i(Gn);Pp=r(vd,"This tokenizer inherits from "),xa=s(vd,"A",{href:!0});var C2=i(xa);$p=r(C2,"PreTrainedTokenizerFast"),C2.forEach(t),Mp=r(vd,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),vd.forEach(t),it.forEach(t),Nl=d(o),Kt=s(o,"H2",{class:!0});var bd=i(Kt);zo=s(bd,"A",{id:!0,class:!0,href:!0});var D2=i(zo);Er=s(D2,"SPAN",{});var H2=i(Er);b(zn.$$.fragment,H2),H2.forEach(t),D2.forEach(t),Gp=d(bd),qr=s(bd,"SPAN",{});var L2=i(qr);zp=r(L2,"GPT2 specific outputs"),L2.forEach(t),bd.forEach(t),Il=d(o),Xt=s(o,"DIV",{class:!0});var kd=i(Xt);b(Fn.$$.fragment,kd),Fp=d(kd),Cr=s(kd,"P",{});var N2=i(Cr);xp=r(N2,"Base class for outputs of models predicting if two sentences are consecutive or not."),N2.forEach(t),kd.forEach(t),Sl=d(o),Yt=s(o,"DIV",{class:!0});var yd=i(Yt);b(xn.$$.fragment,yd),jp=d(yd),Dr=s(yd,"P",{});var I2=i(Dr);Ep=r(I2,"Base class for outputs of models predicting if two sentences are consecutive or not."),I2.forEach(t),yd.forEach(t),Al=d(o),Qt=s(o,"H2",{class:!0});var wd=i(Qt);Fo=s(wd,"A",{id:!0,class:!0,href:!0});var S2=i(Fo);Hr=s(S2,"SPAN",{});var A2=i(Hr);b(jn.$$.fragment,A2),A2.forEach(t),S2.forEach(t),qp=d(wd),Lr=s(wd,"SPAN",{});var O2=i(Lr);Cp=r(O2,"GPT2Model"),O2.forEach(t),wd.forEach(t),Ol=d(o),ke=s(o,"DIV",{class:!0});var lt=i(ke);b(En.$$.fragment,lt),Dp=d(lt),Nr=s(lt,"P",{});var W2=i(Nr);Hp=r(W2,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),W2.forEach(t),Lp=d(lt),qn=s(lt,"P",{});var Pd=i(qn);Np=r(Pd,"This model inherits from "),ja=s(Pd,"A",{href:!0});var B2=i(ja);Ip=r(B2,"PreTrainedModel"),B2.forEach(t),Sp=r(Pd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pd.forEach(t),Ap=d(lt),Cn=s(lt,"P",{});var $d=i(Cn);Op=r($d,"This model is also a PyTorch "),Dn=s($d,"A",{href:!0,rel:!0});var U2=i(Dn);Wp=r(U2,"torch.nn.Module"),U2.forEach(t),Bp=r($d,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$d.forEach(t),Up=d(lt),Ke=s(lt,"DIV",{class:!0});var zt=i(Ke);b(Hn.$$.fragment,zt),Rp=d(zt),Zt=s(zt,"P",{});var nr=i(Zt);Vp=r(nr,"The "),Ea=s(nr,"A",{href:!0});var R2=i(Ea);Jp=r(R2,"GPT2Model"),R2.forEach(t),Kp=r(nr," forward method, overrides the "),Ir=s(nr,"CODE",{});var V2=i(Ir);Xp=r(V2,"__call__"),V2.forEach(t),Yp=r(nr," special method."),nr.forEach(t),Qp=d(zt),b(xo.$$.fragment,zt),Zp=d(zt),Sr=s(zt,"P",{});var J2=i(Sr);eh=r(J2,"Example:"),J2.forEach(t),th=d(zt),b(Ln.$$.fragment,zt),zt.forEach(t),oh=d(lt),Xe=s(lt,"DIV",{class:!0});var Ft=i(Xe);b(Nn.$$.fragment,Ft),nh=d(Ft),Ar=s(Ft,"P",{});var K2=i(Ar);sh=r(K2,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),K2.forEach(t),ah=d(Ft),Or=s(Ft,"P",{});var X2=i(Or);rh=r(X2,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),X2.forEach(t),ih=d(Ft),Wr=s(Ft,"P",{});var Y2=i(Wr);lh=r(Y2,"Example:"),Y2.forEach(t),dh=d(Ft),b(In.$$.fragment,Ft),Ft.forEach(t),ch=d(lt),gt=s(lt,"DIV",{class:!0});var sn=i(gt);b(Sn.$$.fragment,sn),ph=d(sn),Br=s(sn,"P",{});var Q2=i(Br);hh=r(Q2,"Moves the model to cpu from a model parallel state."),Q2.forEach(t),uh=d(sn),Ur=s(sn,"P",{});var Z2=i(Ur);mh=r(Z2,"Example:"),Z2.forEach(t),fh=d(sn),b(An.$$.fragment,sn),sn.forEach(t),lt.forEach(t),Wl=d(o),eo=s(o,"H2",{class:!0});var Md=i(eo);jo=s(Md,"A",{id:!0,class:!0,href:!0});var eT=i(jo);Rr=s(eT,"SPAN",{});var tT=i(Rr);b(On.$$.fragment,tT),tT.forEach(t),eT.forEach(t),gh=d(Md),Vr=s(Md,"SPAN",{});var oT=i(Vr);_h=r(oT,"GPT2LMHeadModel"),oT.forEach(t),Md.forEach(t),Bl=d(o),ye=s(o,"DIV",{class:!0});var dt=i(ye);b(Wn.$$.fragment,dt),Th=d(dt),Jr=s(dt,"P",{});var nT=i(Jr);vh=r(nT,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),nT.forEach(t),bh=d(dt),Bn=s(dt,"P",{});var Gd=i(Bn);kh=r(Gd,"This model inherits from "),qa=s(Gd,"A",{href:!0});var sT=i(qa);yh=r(sT,"PreTrainedModel"),sT.forEach(t),wh=r(Gd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gd.forEach(t),Ph=d(dt),Un=s(dt,"P",{});var zd=i(Un);$h=r(zd,"This model is also a PyTorch "),Rn=s(zd,"A",{href:!0,rel:!0});var aT=i(Rn);Mh=r(aT,"torch.nn.Module"),aT.forEach(t),Gh=r(zd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zd.forEach(t),zh=d(dt),Ye=s(dt,"DIV",{class:!0});var xt=i(Ye);b(Vn.$$.fragment,xt),Fh=d(xt),to=s(xt,"P",{});var sr=i(to);xh=r(sr,"The "),Ca=s(sr,"A",{href:!0});var rT=i(Ca);jh=r(rT,"GPT2LMHeadModel"),rT.forEach(t),Eh=r(sr," forward method, overrides the "),Kr=s(sr,"CODE",{});var iT=i(Kr);qh=r(iT,"__call__"),iT.forEach(t),Ch=r(sr," special method."),sr.forEach(t),Dh=d(xt),b(Eo.$$.fragment,xt),Hh=d(xt),Xr=s(xt,"P",{});var lT=i(Xr);Lh=r(lT,"Example:"),lT.forEach(t),Nh=d(xt),b(Jn.$$.fragment,xt),xt.forEach(t),Ih=d(dt),Qe=s(dt,"DIV",{class:!0});var jt=i(Qe);b(Kn.$$.fragment,jt),Sh=d(jt),Yr=s(jt,"P",{});var dT=i(Yr);Ah=r(dT,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),dT.forEach(t),Oh=d(jt),Qr=s(jt,"P",{});var cT=i(Qr);Wh=r(cT,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),cT.forEach(t),Bh=d(jt),Zr=s(jt,"P",{});var pT=i(Zr);Uh=r(pT,"Example:"),pT.forEach(t),Rh=d(jt),b(Xn.$$.fragment,jt),jt.forEach(t),Vh=d(dt),_t=s(dt,"DIV",{class:!0});var an=i(_t);b(Yn.$$.fragment,an),Jh=d(an),ei=s(an,"P",{});var hT=i(ei);Kh=r(hT,"Moves the model to cpu from a model parallel state."),hT.forEach(t),Xh=d(an),ti=s(an,"P",{});var uT=i(ti);Yh=r(uT,"Example:"),uT.forEach(t),Qh=d(an),b(Qn.$$.fragment,an),an.forEach(t),dt.forEach(t),Ul=d(o),oo=s(o,"H2",{class:!0});var Fd=i(oo);qo=s(Fd,"A",{id:!0,class:!0,href:!0});var mT=i(qo);oi=s(mT,"SPAN",{});var fT=i(oi);b(Zn.$$.fragment,fT),fT.forEach(t),mT.forEach(t),Zh=d(Fd),ni=s(Fd,"SPAN",{});var gT=i(ni);eu=r(gT,"GPT2DoubleHeadsModel"),gT.forEach(t),Fd.forEach(t),Rl=d(o),Ve=s(o,"DIV",{class:!0});var Et=i(Ve);b(es.$$.fragment,Et),tu=d(Et),si=s(Et,"P",{});var _T=i(si);ou=r(_T,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),_T.forEach(t),nu=d(Et),ts=s(Et,"P",{});var xd=i(ts);su=r(xd,"This model inherits from "),Da=s(xd,"A",{href:!0});var TT=i(Da);au=r(TT,"PreTrainedModel"),TT.forEach(t),ru=r(xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xd.forEach(t),iu=d(Et),os=s(Et,"P",{});var jd=i(os);lu=r(jd,"This model is also a PyTorch "),ns=s(jd,"A",{href:!0,rel:!0});var vT=i(ns);du=r(vT,"torch.nn.Module"),vT.forEach(t),cu=r(jd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jd.forEach(t),pu=d(Et),Ze=s(Et,"DIV",{class:!0});var qt=i(Ze);b(ss.$$.fragment,qt),hu=d(qt),no=s(qt,"P",{});var ar=i(no);uu=r(ar,"The "),Ha=s(ar,"A",{href:!0});var bT=i(Ha);mu=r(bT,"GPT2DoubleHeadsModel"),bT.forEach(t),fu=r(ar," forward method, overrides the "),ai=s(ar,"CODE",{});var kT=i(ai);gu=r(kT,"__call__"),kT.forEach(t),_u=r(ar," special method."),ar.forEach(t),Tu=d(qt),b(Co.$$.fragment,qt),vu=d(qt),ri=s(qt,"P",{});var yT=i(ri);bu=r(yT,"Example:"),yT.forEach(t),ku=d(qt),b(as.$$.fragment,qt),qt.forEach(t),Et.forEach(t),Vl=d(o),so=s(o,"H2",{class:!0});var Ed=i(so);Do=s(Ed,"A",{id:!0,class:!0,href:!0});var wT=i(Do);ii=s(wT,"SPAN",{});var PT=i(ii);b(rs.$$.fragment,PT),PT.forEach(t),wT.forEach(t),yu=d(Ed),li=s(Ed,"SPAN",{});var $T=i(li);wu=r($T,"GPT2ForSequenceClassification"),$T.forEach(t),Ed.forEach(t),Jl=d(o),we=s(o,"DIV",{class:!0});var ct=i(we);b(is.$$.fragment,ct),Pu=d(ct),di=s(ct,"P",{});var MT=i(di);$u=r(MT,"The GPT2 Model transformer with a sequence classification head on top (linear layer)."),MT.forEach(t),Mu=d(ct),La=s(ct,"P",{});var J_=i(La);Na=s(J_,"A",{href:!0});var GT=i(Na);Gu=r(GT,"GPT2ForSequenceClassification"),GT.forEach(t),zu=r(J_,` uses the last token in order to do the classification, as other causal models
...
`),ci=s(Ct,"CODE",{});var zT=i(ci);ju=r(zT,"pad_token_id"),zT.forEach(t),Eu=r(Ct,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),pi=s(Ct,"CODE",{});var FT=i(pi);qu=r(FT,"pad_token_id"),FT.forEach(t),Cu=r(Ct,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),hi=s(Ct,"CODE",{});var xT=i(hi);Du=r(xT,"inputs_embeds"),xT.forEach(t),Hu=r(Ct," are passed instead of "),ui=s(Ct,"CODE",{});var jT=i(ui);Lu=r(jT,"input_ids"),jT.forEach(t),Nu=r(Ct,`, it does the same (take the last value in
each row of the batch).`),Ct.forEach(t),Iu=d(ct),ls=s(ct,"P",{});var qd=i(ls);Su=r(qd,"This model inherits from "),Ia=s(qd,"A",{href:!0});var ET=i(Ia);Au=r(ET,"PreTrainedModel"),ET.forEach(t),Ou=r(qd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qd.forEach(t),Wu=d(ct),ds=s(ct,"P",{});var Cd=i(ds);Bu=r(Cd,"This model is also a PyTorch "),cs=s(Cd,"A",{href:!0,rel:!0});var qT=i(cs);Uu=r(qT,"torch.nn.Module"),qT.forEach(t),Ru=r(Cd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cd.forEach(t),Vu=d(ct),Ge=s(ct,"DIV",{class:!0});var pt=i(Ge);b(ps.$$.fragment,pt),Ju=d(pt),ao=s(pt,"P",{});var rr=i(ao);Ku=r(rr,"The "),Sa=s(rr,"A",{href:!0});var CT=i(Sa);Xu=r(CT,"GPT2ForSequenceClassification"),CT.forEach(t),Yu=r(rr," forward method, overrides the "),mi=s(rr,"CODE",{});var DT=i(mi);Qu=r(DT,"__call__"),DT.forEach(t),Zu=r(rr," special method."),rr.forEach(t),em=d(pt),b(Ho.$$.fragment,pt),tm=d(pt),fi=s(pt,"P",{});var HT=i(fi);om=r(HT,"Example of single-label classification:"),HT.forEach(t),nm=d(pt),b(hs.$$.fragment,pt),sm=d(pt),gi=s(pt,"P",{});var LT=i(gi);am=r(LT,"Example of multi-label classification:"),LT.forEach(t),rm=d(pt),b(us.$$.fragment,pt),pt.forEach(t),ct.forEach(t),Kl=d(o),ro=s(o,"H2",{class:!0});var Dd=i(ro);Lo=s(Dd,"A",{id:!0,class:!0,href:!0});var NT=i(Lo);_i=s(NT,"SPAN",{});var IT=i(_i);b(ms.$$.fragment,IT),IT.forEach(t),NT.forEach(t),im=d(Dd),Ti=s(Dd,"SPAN",{});var ST=i(Ti);lm=r(ST,"GPT2ForTokenClassification"),ST.forEach(t),Dd.forEach(t),Xl=d(o),Je=s(o,"DIV",{class:!0});var Dt=i(Je);b(fs.$$.fragment,Dt),dm=d(Dt),vi=s(Dt,"P",{});var AT=i(vi);cm=r(AT,`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),AT.forEach(t),pm=d(Dt),gs=s(Dt,"P",{});var Hd=i(gs);hm=r(Hd,"This model inherits from "),Aa=s(Hd,"A",{href:!0});var OT=i(Aa);um=r(OT,"PreTrainedModel"),OT.forEach(t),mm=r(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(t),fm=d(Dt),_s=s(Dt,"P",{});var Ld=i(_s);gm=r(Ld,"This model is also a PyTorch "),Ts=s(Ld,"A",{href:!0,rel:!0});var WT=i(Ts);_m=r(WT,"torch.nn.Module"),WT.forEach(t),Tm=r(Ld,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld.forEach(t),vm=d(Dt),et=s(Dt,"DIV",{class:!0});var Ht=i(et);b(vs.$$.fragment,Ht),bm=d(Ht),io=s(Ht,"P",{});var ir=i(io);km=r(ir,"The "),Oa=s(ir,"A",{href:!0});var BT=i(Oa);ym=r(BT,"GPT2ForTokenClassification"),BT.forEach(t),wm=r(ir," forward method, overrides the "),bi=s(ir,"CODE",{});var UT=i(bi);Pm=r(UT,"__call__"),UT.forEach(t),$m=r(ir," special method."),ir.forEach(t),Mm=d(Ht),b(No.$$.fragment,Ht),Gm=d(Ht),ki=s(Ht,"P",{});var RT=i(ki);zm=r(RT,"Example:"),RT.forEach(t),Fm=d(Ht),b(bs.$$.fragment,Ht),Ht.forEach(t),Dt.forEach(t),Yl=d(o),lo=s(o,"H2",{class:!0});var Nd=i(lo);Io=s(Nd,"A",{id:!0,class:!0,href:!0});var VT=i(Io);yi=s(VT,"SPAN",{});var JT=i(yi);b(ks.$$.fragment,JT),JT.forEach(t),VT.forEach(t),xm=d(Nd),wi=s(Nd,"SPAN",{});var KT=i(wi);jm=r(KT,"TFGPT2Model"),KT.forEach(t),Nd.forEach(t),Ql=d(o),Ce=s(o,"DIV",{class:!0});var Tt=i(Ce);b(ys.$$.fragment,Tt),Em=d(Tt),Pi=s(Tt,"P",{});var XT=i(Pi);qm=r(XT,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),XT.forEach(t),Cm=d(Tt),ws=s(Tt,"P",{});var Id=i(ws);Dm=r(Id,"This model inherits from "),Wa=s(Id,"A",{href:!0});var YT=i(Wa);Hm=r(YT,"TFPreTrainedModel"),YT.forEach(t),Lm=r(Id,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Id.forEach(t),Nm=d(Tt),Ps=s(Tt,"P",{});var Sd=i(Ps);Im=r(Sd,"This model is also a "),$s=s(Sd,"A",{href:!0,rel:!0});var QT=i($s);Sm=r(QT,"tf.keras.Model"),QT.forEach(t),Am=r(Sd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sd.forEach(t),Om=d(Tt),b(So.$$.fragment,Tt),Wm=d(Tt),tt=s(Tt,"DIV",{class:!0});var Lt=i(tt);b(Ms.$$.fragment,Lt),Bm=d(Lt),co=s(Lt,"P",{});var lr=i(co);Um=r(lr,"The "),Ba=s(lr,"A",{href:!0});var ZT=i(Ba);Rm=r(ZT,"TFGPT2Model"),ZT.forEach(t),Vm=r(lr," forward method, overrides the "),$i=s(lr,"CODE",{});var ev=i($i);Jm=r(ev,"__call__"),ev.forEach(t),Km=r(lr," special method."),lr.forEach(t),Xm=d(Lt),b(Ao.$$.fragment,Lt),Ym=d(Lt),Mi=s(Lt,"P",{});var tv=i(Mi);Qm=r(tv,"Example:"),tv.forEach(t),Zm=d(Lt),b(Gs.$$.fragment,Lt),Lt.forEach(t),Tt.forEach(t),Zl=d(o),po=s(o,"H2",{class:!0});var Ad=i(po);Oo=s(Ad,"A",{id:!0,class:!0,href:!0});var ov=i(Oo);Gi=s(ov,"SPAN",{});var nv=i(Gi);b(zs.$$.fragment,nv),nv.forEach(t),ov.forEach(t),ef=d(Ad),zi=s(Ad,"SPAN",{});var sv=i(zi);tf=r(sv,"TFGPT2LMHeadModel"),sv.forEach(t),Ad.forEach(t),ed=d(o),De=s(o,"DIV",{class:!0});var vt=i(De);b(Fs.$$.fragment,vt),of=d(vt),Fi=s(vt,"P",{});var av=i(Fi);nf=r(av,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
