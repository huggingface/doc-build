import{S as Qq,i as Oq,s as Iq,e as o,k as l,w as v,t as a,L as Wq,c as r,d as s,m as d,a as i,x as b,h as n,b as p,M as Uq,J as e,g as c,y as w,q as y,o as k,B as j}from"../../../chunks/vendor-b1433968.js";import{T as As}from"../../../chunks/Tip-c3840994.js";import{D as pe}from"../../../chunks/Docstring-ff504c58.js";import{C as Ft}from"../../../chunks/CodeBlock-a320dbd7.js";import{C as Hr}from"../../../chunks/CodeBlockFw-e3b92d56.js";import{I as ss}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function Hq(U){let m,F,f,g,q;return{c(){m=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),g=a("Module"),q=a(`
...
first positional argument :`),se=l(),$=o("ul"),x=o("li"),oe=a("a single Tensor with "),H=o("code"),he=a("input_ids"),V=a(" only and nothing else: "),L=o("code"),te=a("model(inputs_ids)"),be=l(),C=o("li"),we=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
the latter silently ignores them.`)},l(T){m=r(T,"P",{});var _=i(m);F=n(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var A=i(f);g=n(A,"Module"),A.forEach(s),q=n(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(s)},m(T,_){c(T,m,_),e(m,F),e(m,f),e(f,g),e(m,q)},d(T){T&&s(m)}}}function t4(U){let m,F,f,g,q,T,_,A,_e,K,z,Y,O,Z,Te,I,ve,ce,W,N,ee,se,$,x,oe,H,he,V,L,te,be,C,we,Q,ae,ye,B,ke,re,P,je,G,ue,u,E,J,Fe,Ge,S,Ae,xe,Re,D,M,Ve,Ce,R,Ke,qe,Ee,Ye,ga,dh,ph,np,At,By,op,zt,ch,To,hh,uh,rp,_s,mh,_a,fh,gh,Ta,_h,Th,va,vh,bh,ip,vo,wh,lp,Ts,Me,yh,Br,kh,jh,bo,qh,Eh,Gr,Fh,Ah,ba,zh,$h,Rr,xh,Ch,Vr,Mh,Ph,Sh,Je,Dh,Kr,Nh,Lh,Yr,Qh,Oh,Jr,Ih,Wh,Xr,Uh,Hh,wa,Bh,Gh,Rh,Vs,Vh,Zr,Kh,Yh,ei,Jh,Xh,Zh,si,eu,dp,Ks,$t,ti,ya,su,ai,tu,pp,xt,au,wo,nu,ou,cp,yo,ni,ru,hp,Ct,iu,ko,lu,du,up,$s,oi,pu,cu,ka,hu,ri,uu,mu,fu,ja,gu,ii,_u,Tu,mp,jo,vu,fp,Mt,li,Ys,di,pi,bu,wu,ci,hi,yu,ku,ui,mi,ju,qu,Js,Xs,fi,Eu,Fu,gi,Au,zu,_i,$u,xu,Zs,Ti,Cu,Mu,vi,Pu,Su,bi,Du,Nu,et,wi,Lu,Qu,yi,Ou,Iu,ki,Wu,gp,xs,Uu,qa,Hu,Bu,Ea,Gu,Ru,_p,Fa,Tp,Cs,Vu,qo,Ku,Yu,Eo,Ju,Xu,vp,Aa,bp,Pt,Zu,za,em,sm,wp,St,tm,$a,am,nm,yp,Fo,ji,om,kp,Dt,rm,xa,im,lm,jp,ie,Ao,qi,dm,pm,cm,zo,Ei,hm,um,mm,$o,Fi,fm,gm,_m,xo,Ai,Tm,vm,bm,Co,zi,wm,ym,km,Mo,$i,jm,qm,Em,Po,xi,Fm,Am,zm,So,Ci,$m,xm,Cm,Do,Mi,Mm,Pm,qp,We,Sm,Ca,Dm,Nm,Ma,Lm,Qm,Pi,Om,Im,Si,Wm,Um,Di,Hm,Bm,Ep,No,Ni,Gm,Fp,ze,Rm,Lo,Vm,Km,Li,Ym,Jm,Qi,Xm,Zm,Oi,ef,sf,Qo,tf,af,Oo,nf,of,Ap,Nt,Ii,Pa,Wi,Ui,rf,lf,Hi,Bi,df,pf,st,Sa,Gi,cf,hf,zs,Ri,uf,mf,Vi,ff,gf,Ki,_f,Tf,Yi,vf,bf,Da,Ji,wf,yf,Pe,Xi,kf,jf,Zi,qf,Ef,el,Ff,Af,sl,zf,$f,tl,xf,Cf,al,Mf,Pf,nl,Sf,Df,Na,ol,Nf,Lf,ms,rl,Qf,Of,il,If,Wf,ll,Uf,Hf,dl,Bf,Gf,pl,Rf,zp,le,Io,Vf,Kf,cl,Yf,Jf,hl,Xf,Zf,ul,eg,sg,ml,tg,ag,fl,ng,og,gl,rg,ig,_l,lg,dg,$p,La,xp,vs,pg,Wo,cg,hg,Tl,ug,mg,vl,fg,gg,Cp,Qa,Mp,X,_g,bl,Tg,vg,wl,bg,wg,yl,yg,kg,kl,jg,qg,jl,Eg,Fg,ql,Ag,zg,Uo,$g,xg,Oa,Cg,Mg,Ia,Pg,Sg,Pp,Ho,El,Dg,Sp,Ms,Ng,Bo,Lg,Qg,Go,Og,Ig,Dp,Wa,Np,tt,Lt,Fl,Ua,Wg,Al,Ug,Lp,me,Hg,Ro,Bg,Gg,Vo,Rg,Vg,zl,Kg,Yg,$l,Jg,Xg,xl,Zg,e_,Ko,s_,t_,Cl,a_,n_,Qp,Qt,o_,Ml,r_,i_,Op,Ha,Ip,Ue,l_,Pl,d_,p_,Sl,c_,h_,Dl,u_,m_,Ba,f_,g_,Ga,__,T_,Wp,at,Ot,Nl,Ra,v_,Ll,b_,Up,nt,Va,w_,Ka,y_,Yo,k_,j_,Hp,ot,It,Ql,Ya,q_,Ol,E_,Bp,Xe,Ja,F_,fs,A_,Jo,z_,$_,Il,x_,C_,Wl,M_,P_,Xo,S_,D_,N_,Xa,L_,Za,Q_,O_,I_,Ul,W_,U_,en,Gp,rt,Wt,Hl,sn,H_,Bl,B_,Rp,de,tn,G_,Gl,R_,V_,ne,K_,Zo,Y_,J_,er,X_,Z_,Rl,eT,sT,Vl,tT,aT,Kl,nT,oT,Yl,rT,iT,Jl,lT,dT,Xl,pT,cT,Zl,hT,uT,mT,Se,ed,fT,gT,sd,_T,TT,td,vT,bT,ad,wT,yT,nd,kT,jT,od,qT,ET,rd,FT,AT,sr,tr,zT,$T,xT,Ut,an,CT,id,MT,PT,Ps,nn,ST,on,DT,ar,NT,LT,QT,rn,OT,ln,IT,WT,UT,ld,Vp,it,Ht,dd,dn,HT,pd,BT,Kp,De,pn,GT,cn,RT,nr,VT,KT,YT,hn,JT,un,XT,ZT,ev,mn,sv,or,tv,av,nv,fn,ov,gn,rv,iv,lv,ts,_n,dv,lt,pv,rr,cv,hv,cd,uv,mv,fv,Bt,gv,hd,_v,Tv,Tn,Yp,dt,Gt,ud,vn,vv,md,bv,Jp,gs,bn,wv,pt,yv,fd,kv,jv,ir,qv,Ev,Fv,wn,Av,yn,zv,$v,xv,as,kn,Cv,ct,Mv,lr,Pv,Sv,gd,Dv,Nv,Lv,Rt,Qv,_d,Ov,Iv,jn,Xp,ht,Vt,Td,qn,Wv,vd,Uv,Zp,Ze,En,Hv,bd,Bv,Gv,Fn,Rv,dr,Vv,Kv,Yv,An,Jv,zn,Xv,Zv,eb,ns,$n,sb,ut,tb,pr,ab,nb,wd,ob,rb,ib,Kt,lb,yd,db,pb,xn,ec,mt,Yt,kd,Cn,cb,jd,hb,sc,es,Mn,ub,ft,mb,qd,fb,gb,Ed,_b,Tb,vb,Pn,bb,cr,wb,yb,kb,Sn,jb,Dn,qb,Eb,Fb,os,Nn,Ab,gt,zb,hr,$b,xb,Fd,Cb,Mb,Pb,Jt,Sb,Ad,Db,Nb,Ln,tc,_t,Xt,zd,Qn,Lb,$d,Qb,ac,Ne,On,Ob,xd,Ib,Wb,In,Ub,ur,Hb,Bb,Gb,Wn,Rb,Un,Vb,Kb,Yb,Zt,Jb,rs,Hn,Xb,Tt,Zb,mr,ew,sw,Cd,tw,aw,nw,ea,ow,Md,rw,iw,Bn,nc,vt,sa,Pd,Gn,lw,Sd,dw,oc,Le,Rn,pw,Vn,cw,Dd,hw,uw,mw,Kn,fw,fr,gw,_w,Tw,Yn,vw,Jn,bw,ww,yw,ta,kw,is,Xn,jw,bt,qw,gr,Ew,Fw,Nd,Aw,zw,$w,aa,xw,Ld,Cw,Mw,Zn,rc,wt,na,Qd,eo,Pw,Od,Sw,ic,Qe,so,Dw,Id,Nw,Lw,to,Qw,_r,Ow,Iw,Ww,ao,Uw,no,Hw,Bw,Gw,oa,Rw,ls,oo,Vw,yt,Kw,Tr,Yw,Jw,Wd,Xw,Zw,ey,ra,sy,Ud,ty,ay,ro,lc,kt,ia,Hd,io,ny,Bd,oy,dc,Oe,lo,ry,jt,iy,Gd,ly,dy,Rd,py,cy,hy,po,uy,vr,my,fy,gy,co,_y,ho,Ty,vy,by,la,wy,ds,uo,yy,qt,ky,br,jy,qy,Vd,Ey,Fy,Ay,da,zy,Kd,$y,xy,mo,pc;return T=new ss({}),Z=new ss({}),ya=new ss({}),Fa=new Hr({props:{pt:{code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
`}}),dn=new ss({}),pn=new pe({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tapas.py#L856",parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),_n=new pe({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tapas.py#L894",parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),vn=new ss({}),bn=new pe({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tapas.py#L1009",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new pe({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tapas.py#L1028",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),qn=new ss({}),En=new pe({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tapas.py#L1468",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$n=new pe({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tapas.py#L1480",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],returnDescription:`
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),Qn=new ss({}),On=new pe({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tf_tapas.py#L976",parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new As({props:{$$slots:{default:[Vq]},$$scope:{ctx:U}}}),Hn=new pe({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tf_tapas.py#L982",parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Gn=new ss({}),Rn=new pe({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tf_tapas.py#L1066",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ta=new As({props:{$$slots:{default:[Yq]},$$scope:{ctx:U}}}),Xn=new pe({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tf_tapas.py#L1082",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),eo=new ss({}),so=new pe({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tf_tapas.py#L1649",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oa=new As({props:{$$slots:{default:[Xq]},$$scope:{ctx:U}}}),oo=new pe({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/tapas/modeling_tf_tapas.py#L1660",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),da=new As({props:{$$slots:{default:[s4]},$$scope:{ctx:U}}}),mo=new Ft({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){m=o("meta"),F=l(),f=o("h1"),g=o("a"),q=o("span"),v(T.$$.fragment),_=l(),A=o("span"),_e=a("TAPAS"),K=l(),z=o("h2"),Y=o("a"),O=o("span"),v(Z.$$.fragment),Te=l(),I=o("span"),ve=a("Overview"),ce=l(),W=o("p"),N=a("The TAPAS model was proposed in "),ee=o("a"),se=a("TAPAS: Weakly Supervised Table Parsing via Pre-training"),$=a(`
...
implementation. Original implementation available at `),Za=o("a"),Q_=a("https://github.com/google-research/tapas/tree/master"),O_=a("."),I_=l(),Ul=o("p"),W_=a("Example:"),U_=l(),v(en.$$.fragment),Gp=l(),rt=o("h2"),Wt=o("a"),Hl=o("span"),v(sn.$$.fragment),H_=l(),Bl=o("span"),B_=a("TapasTokenizer"),Rp=l(),de=o("div"),v(tn.$$.fragment),G_=l(),Gl=o("p"),R_=a(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
tokens, special tokens and padding.`),TT=l(),td=o("li"),vT=a(`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),bT=l(),ad=o("li"),wT=a(`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
...
wordpiece.`),xT=l(),Ut=o("div"),v(an.$$.fragment),CT=l(),id=o("p"),MT=a("Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),PT=l(),Ps=o("div"),v(nn.$$.fragment),ST=l(),on=o("p"),DT=a("Converts logits of "),ar=o("a"),NT=a("TapasForQuestionAnswering"),LT=a(` to actual predicted answer coordinates and optional
aggregation indices.`),QT=l(),rn=o("p"),OT=a(`The original implementation, on which this function is based, can be found
`),ln=o("a"),IT=a("here"),WT=a("."),UT=l(),ld=o("div"),Vp=l(),it=o("h2"),Ht=o("a"),dd=o("span"),v(dn.$$.fragment),HT=l(),pd=o("span"),BT=a("TapasModel"),Kp=l(),De=o("div"),v(pn.$$.fragment),GT=l(),cn=o("p"),RT=a(`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
and behavior.`),ev=l(),mn=o("p"),sv=a("This class is a small change compared to "),or=o("a"),tv=a("BertModel"),av=a(", taking into account the additional token type ids."),nv=l(),fn=o("p"),ov=a(`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
cross-attention is added between the self-attention layers, following the architecture described in `),gn=o("a"),rv=a(`Attention is
all you need`),iv=a(` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),lv=l(),ts=o("div"),v(_n.$$.fragment),dv=l(),lt=o("p"),pv=a("The "),rr=o("a"),cv=a("TapasModel"),hv=a(" forward method, overrides the "),cd=o("code"),uv=a("__call__"),mv=a(" special method."),fv=l(),v(Bt.$$.fragment),gv=l(),hd=o("p"),_v=a("Examples:"),Tv=l(),v(Tn.$$.fragment),Yp=l(),dt=o("h2"),Gt=o("a"),ud=o("span"),v(vn.$$.fragment),vv=l(),md=o("span"),bv=a("TapasForMaskedLM"),Jp=l(),gs=o("div"),v(bn.$$.fragment),wv=l(),pt=o("p"),yv=a("Tapas Model with a "),fd=o("code"),kv=a("language modeling"),jv=a(` head on top.
This model inherits from `),ir=o("a"),qv=a("PreTrainedModel"),Ev=a(`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fv=l(),wn=o("p"),Av=a("This model is also a PyTorch "),yn=o("a"),zv=a("torch.nn.Module"),$v=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xv=l(),as=o("div"),v(kn.$$.fragment),Cv=l(),ct=o("p"),Mv=a("The "),lr=o("a"),Pv=a("TapasForMaskedLM"),Sv=a(" forward method, overrides the "),gd=o("code"),Dv=a("__call__"),Nv=a(" special method."),Lv=l(),v(Rt.$$.fragment),Qv=l(),_d=o("p"),Ov=a("Examples:"),Iv=l(),v(jn.$$.fragment),Xp=l(),ht=o("h2"),Vt=o("a"),Td=o("span"),v(qn.$$.fragment),Wv=l(),vd=o("span"),Uv=a("TapasForSequenceClassification"),Zp=l(),Ze=o("div"),v(En.$$.fragment),Hv=l(),bd=o("p"),Bv=a(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Gv=l(),Fn=o("p"),Rv=a("This model inherits from "),dr=o("a"),Vv=a("PreTrainedModel"),Kv=a(`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yv=l(),An=o("p"),Jv=a("This model is also a PyTorch "),zn=o("a"),Xv=a("torch.nn.Module"),Zv=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eb=l(),ns=o("div"),v($n.$$.fragment),sb=l(),ut=o("p"),tb=a("The "),pr=o("a"),ab=a("TapasForSequenceClassification"),nb=a(" forward method, overrides the "),wd=o("code"),ob=a("__call__"),rb=a(" special method."),ib=l(),v(Kt.$$.fragment),lb=l(),yd=o("p"),db=a("Examples:"),pb=l(),v(xn.$$.fragment),ec=l(),mt=o("h2"),Yt=o("a"),kd=o("span"),v(Cn.$$.fragment),cb=l(),jd=o("span"),hb=a("TapasForQuestionAnswering"),sc=l(),es=o("div"),v(Mn.$$.fragment),ub=l(),ft=o("p"),mb=a(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),qd=o("code"),fb=a("logits"),gb=a(" and optional "),Ed=o("code"),_b=a("logits_aggregation"),Tb=a(`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),vb=l(),Pn=o("p"),bb=a("This model inherits from "),cr=o("a"),wb=a("PreTrainedModel"),yb=a(`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kb=l(),Sn=o("p"),jb=a("This model is also a PyTorch "),Dn=o("a"),qb=a("torch.nn.Module"),Eb=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fb=l(),os=o("div"),v(Nn.$$.fragment),Ab=l(),gt=o("p"),zb=a("The "),hr=o("a"),$b=a("TapasForQuestionAnswering"),xb=a(" forward method, overrides the "),Fd=o("code"),Cb=a("__call__"),Mb=a(" special method."),Pb=l(),v(Jt.$$.fragment),Sb=l(),Ad=o("p"),Db=a("Examples:"),Nb=l(),v(Ln.$$.fragment),tc=l(),_t=o("h2"),Xt=o("a"),zd=o("span"),v(Qn.$$.fragment),Lb=l(),$d=o("span"),Qb=a("TFTapasModel"),ac=l(),Ne=o("div"),v(On.$$.fragment),Ob=l(),xd=o("p"),Ib=a("The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Wb=l(),In=o("p"),Ub=a("This model inherits from "),ur=o("a"),Hb=a("TFPreTrainedModel"),Bb=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gb=l(),Wn=o("p"),Rb=a("This model is also a "),Un=o("a"),Vb=a("tf.keras.Model"),Kb=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yb=l(),v(Zt.$$.fragment),Jb=l(),rs=o("div"),v(Hn.$$.fragment),Xb=l(),Tt=o("p"),Zb=a("The "),mr=o("a"),ew=a("TFTapasModel"),sw=a(" forward method, overrides the "),Cd=o("code"),tw=a("__call__"),aw=a(" special method."),nw=l(),v(ea.$$.fragment),ow=l(),Md=o("p"),rw=a("Examples:"),iw=l(),v(Bn.$$.fragment),nc=l(),vt=o("h2"),sa=o("a"),Pd=o("span"),v(Gn.$$.fragment),lw=l(),Sd=o("span"),dw=a("TFTapasForMaskedLM"),oc=l(),Le=o("div"),v(Rn.$$.fragment),pw=l(),Vn=o("p"),cw=a("Tapas Model with a "),Dd=o("code"),hw=a("language modeling"),uw=a(" head on top."),mw=l(),Kn=o("p"),fw=a("This model inherits from "),fr=o("a"),gw=a("TFPreTrainedModel"),_w=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tw=l(),Yn=o("p"),vw=a("This model is also a "),Jn=o("a"),bw=a("tf.keras.Model"),ww=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yw=l(),v(ta.$$.fragment),kw=l(),is=o("div"),v(Xn.$$.fragment),jw=l(),bt=o("p"),qw=a("The "),gr=o("a"),Ew=a("TFTapasForMaskedLM"),Fw=a(" forward method, overrides the "),Nd=o("code"),Aw=a("__call__"),zw=a(" special method."),$w=l(),v(aa.$$.fragment),xw=l(),Ld=o("p"),Cw=a("Examples:"),Mw=l(),v(Zn.$$.fragment),rc=l(),wt=o("h2"),na=o("a"),Qd=o("span"),v(eo.$$.fragment),Pw=l(),Od=o("span"),Sw=a("TFTapasForSequenceClassification"),ic=l(),Qe=o("div"),v(so.$$.fragment),Dw=l(),Id=o("p"),Nw=a(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gw=l(),v(oa.$$.fragment),Rw=l(),ls=o("div"),v(oo.$$.fragment),Vw=l(),yt=o("p"),Kw=a("The "),Tr=o("a"),Yw=a("TFTapasForSequenceClassification"),Jw=a(" forward method, overrides the "),Wd=o("code"),Xw=a("__call__"),Zw=a(" special method."),ey=l(),v(ra.$$.fragment),sy=l(),Ud=o("p"),ty=a("Examples:"),ay=l(),v(ro.$$.fragment),lc=l(),kt=o("h2"),ia=o("a"),Hd=o("span"),v(io.$$.fragment),ny=l(),Bd=o("span"),oy=a("TFTapasForQuestionAnswering"),dc=l(),Oe=o("div"),v(lo.$$.fragment),ry=l(),jt=o("p"),iy=a(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
documentation from `),Xo=r(Ns,"A",{href:!0});var B2=i(Xo);S_=n(B2,"PretrainedConfig"),B2.forEach(s),D_=n(Ns," for more information."),Ns.forEach(s),N_=d(Ds),Xa=r(Ds,"P",{});var Cc=i(Xa);L_=n(Cc,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Za=r(Cc,"A",{href:!0,rel:!0});var G2=i(Za);Q_=n(G2,"https://github.com/google-research/tapas/tree/master"),G2.forEach(s),O_=n(Cc,"."),Cc.forEach(s),I_=d(Ds),Ul=r(Ds,"P",{});var R2=i(Ul);W_=n(R2,"Example:"),R2.forEach(s),U_=d(Ds),b(en.$$.fragment,Ds),Ds.forEach(s),Gp=d(t),rt=r(t,"H2",{class:!0});var Mc=i(rt);Wt=r(Mc,"A",{id:!0,class:!0,href:!0});var V2=i(Wt);Hl=r(V2,"SPAN",{});var K2=i(Hl);b(sn.$$.fragment,K2),K2.forEach(s),V2.forEach(s),H_=d(Mc),Bl=r(Mc,"SPAN",{});var Y2=i(Bl);B_=n(Y2,"TapasTokenizer"),Y2.forEach(s),Mc.forEach(s),Rp=d(t),de=r(t,"DIV",{class:!0});var Be=i(de);b(tn.$$.fragment,Be),G_=d(Be),Gl=r(Be,"P",{});var J2=i(Gl);R_=n(J2,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),J2.forEach(s),V_=d(Be),ne=r(Be,"P",{});var ge=i(ne);K_=n(ge,"This tokenizer inherits from "),Zo=r(ge,"A",{href:!0});var X2=i(Zo);Y_=n(X2,"PreTrainedTokenizer"),X2.forEach(s),J_=n(ge,` which contains most of the main methods. Users should refer to
...
`),Vl=r(ge,"CODE",{});var sj=i(Vl);tT=n(sj,"column_ids"),sj.forEach(s),aT=n(ge,", "),Kl=r(ge,"CODE",{});var tj=i(Kl);nT=n(tj,"row_ids"),tj.forEach(s),oT=n(ge,", "),Yl=r(ge,"CODE",{});var aj=i(Yl);rT=n(aj,"prev_labels"),aj.forEach(s),iT=n(ge,", "),Jl=r(ge,"CODE",{});var nj=i(Jl);lT=n(nj,"column_ranks"),nj.forEach(s),dT=n(ge,", "),Xl=r(ge,"CODE",{});var oj=i(Xl);pT=n(oj,"inv_column_ranks"),oj.forEach(s),cT=n(ge," and "),Zl=r(ge,"CODE",{});var rj=i(Zl);hT=n(rj,"numeric_relations"),rj.forEach(s),uT=n(ge,":"),ge.forEach(s),mT=d(Be),Se=r(Be,"UL",{});var us=i(Se);ed=r(us,"LI",{});var ij=i(ed);fT=n(ij,`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),ij.forEach(s),gT=d(us),sd=r(us,"LI",{});var lj=i(sd);_T=n(lj,`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),lj.forEach(s),TT=d(us),td=r(us,"LI",{});var dj=i(td);vT=n(dj,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),dj.forEach(s),bT=d(us),ad=r(us,"LI",{});var pj=i(ad);wT=n(pj,`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),pj.forEach(s),yT=d(us),nd=r(us,"LI",{});var cj=i(nd);kT=n(cj,`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),cj.forEach(s),jT=d(us),od=r(us,"LI",{});var hj=i(od);qT=n(hj,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),hj.forEach(s),ET=d(us),rd=r(us,"LI",{});var uj=i(rd);FT=n(uj,`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),uj.forEach(s),us.forEach(s),AT=d(Be),sr=r(Be,"P",{});var Hy=i(sr);tr=r(Hy,"A",{href:!0});var mj=i(tr);zT=n(mj,"TapasTokenizer"),mj.forEach(s),$T=n(Hy,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),Hy.forEach(s),xT=d(Be),Ut=r(Be,"DIV",{class:!0});var Pc=i(Ut);b(an.$$.fragment,Pc),CT=d(Pc),id=r(Pc,"P",{});var fj=i(id);MT=n(fj,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),fj.forEach(s),Pc.forEach(s),PT=d(Be),Ps=r(Be,"DIV",{class:!0});var Cr=i(Ps);b(nn.$$.fragment,Cr),ST=d(Cr),on=r(Cr,"P",{});var Sc=i(on);DT=n(Sc,"Converts logits of "),ar=r(Sc,"A",{href:!0});var gj=i(ar);NT=n(gj,"TapasForQuestionAnswering"),gj.forEach(s),LT=n(Sc,` to actual predicted answer coordinates and optional
...
`),ln=r(Dc,"A",{href:!0,rel:!0});var _j=i(ln);IT=n(_j,"here"),_j.forEach(s),WT=n(Dc,"."),Dc.forEach(s),Cr.forEach(s),UT=d(Be),ld=r(Be,"DIV",{class:!0}),i(ld).forEach(s),Be.forEach(s),Vp=d(t),it=r(t,"H2",{class:!0});var Nc=i(it);Ht=r(Nc,"A",{id:!0,class:!0,href:!0});var Tj=i(Ht);dd=r(Tj,"SPAN",{});var vj=i(dd);b(dn.$$.fragment,vj),vj.forEach(s),Tj.forEach(s),HT=d(Nc),pd=r(Nc,"SPAN",{});var bj=i(pd);BT=n(bj,"TapasModel"),bj.forEach(s),Nc.forEach(s),Kp=d(t),De=r(t,"DIV",{class:!0});var ks=i(De);b(pn.$$.fragment,ks),GT=d(ks),cn=r(ks,"P",{});var Lc=i(cn);RT=n(Lc,`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lc.forEach(s),YT=d(ks),hn=r(ks,"P",{});var Qc=i(hn);JT=n(Qc,"This model is also a PyTorch "),un=r(Qc,"A",{href:!0,rel:!0});var yj=i(un);XT=n(yj,"torch.nn.Module"),yj.forEach(s),ZT=n(Qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(s),ev=d(ks),mn=r(ks,"P",{});var Oc=i(mn);sv=n(Oc,"This class is a small change compared to "),or=r(Oc,"A",{href:!0});var kj=i(or);tv=n(kj,"BertModel"),kj.forEach(s),av=n(Oc,", taking into account the additional token type ids."),Oc.forEach(s),nv=d(ks),fn=r(ks,"P",{});var Ic=i(fn);ov=n(Ic,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
cross-attention is added between the self-attention layers, following the architecture described in `),gn=r(Ic,"A",{href:!0,rel:!0});var jj=i(gn);rv=n(jj,`Attention is
all you need`),jj.forEach(s),iv=n(Ic,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ic.forEach(s),lv=d(ks),ts=r(ks,"DIV",{class:!0});var Ls=i(ts);b(_n.$$.fragment,Ls),dv=d(Ls),lt=r(Ls,"P",{});var Mr=i(lt);pv=n(Mr,"The "),rr=r(Mr,"A",{href:!0});var qj=i(rr);cv=n(qj,"TapasModel"),qj.forEach(s),hv=n(Mr," forward method, overrides the "),cd=r(Mr,"CODE",{});var Ej=i(cd);uv=n(Ej,"__call__"),Ej.forEach(s),mv=n(Mr," special method."),Mr.forEach(s),fv=d(Ls),b(Bt.$$.fragment,Ls),gv=d(Ls),hd=r(Ls,"P",{});var Fj=i(hd);_v=n(Fj,"Examples:"),Fj.forEach(s),Tv=d(Ls),b(Tn.$$.fragment,Ls),Ls.forEach(s),ks.forEach(s),Yp=d(t),dt=r(t,"H2",{class:!0});var Wc=i(dt);Gt=r(Wc,"A",{id:!0,class:!0,href:!0});var Aj=i(Gt);ud=r(Aj,"SPAN",{});var zj=i(ud);b(vn.$$.fragment,zj),zj.forEach(s),Aj.forEach(s),vv=d(Wc),md=r(Wc,"SPAN",{});var $j=i(md);bv=n($j,"TapasForMaskedLM"),$j.forEach(s),Wc.forEach(s),Jp=d(t),gs=r(t,"DIV",{class:!0});var fa=i(gs);b(bn.$$.fragment,fa),wv=d(fa),pt=r(fa,"P",{});var Pr=i(pt);yv=n(Pr,"Tapas Model with a "),fd=r(Pr,"CODE",{});var xj=i(fd);kv=n(xj,"language modeling"),xj.forEach(s),jv=n(Pr,` head on top.
This model inherits from `),ir=r(Pr,"A",{href:!0});var Cj=i(ir);qv=n(Cj,"PreTrainedModel"),Cj.forEach(s),Ev=n(Pr,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pr.forEach(s),Fv=d(fa),wn=r(fa,"P",{});var Uc=i(wn);Av=n(Uc,"This model is also a PyTorch "),yn=r(Uc,"A",{href:!0,rel:!0});var Mj=i(yn);zv=n(Mj,"torch.nn.Module"),Mj.forEach(s),$v=n(Uc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uc.forEach(s),xv=d(fa),as=r(fa,"DIV",{class:!0});var Qs=i(as);b(kn.$$.fragment,Qs),Cv=d(Qs),ct=r(Qs,"P",{});var Sr=i(ct);Mv=n(Sr,"The "),lr=r(Sr,"A",{href:!0});var Pj=i(lr);Pv=n(Pj,"TapasForMaskedLM"),Pj.forEach(s),Sv=n(Sr," forward method, overrides the "),gd=r(Sr,"CODE",{});var Sj=i(gd);Dv=n(Sj,"__call__"),Sj.forEach(s),Nv=n(Sr," special method."),Sr.forEach(s),Lv=d(Qs),b(Rt.$$.fragment,Qs),Qv=d(Qs),_d=r(Qs,"P",{});var Dj=i(_d);Ov=n(Dj,"Examples:"),Dj.forEach(s),Iv=d(Qs),b(jn.$$.fragment,Qs),Qs.forEach(s),fa.forEach(s),Xp=d(t),ht=r(t,"H2",{class:!0});var Hc=i(ht);Vt=r(Hc,"A",{id:!0,class:!0,href:!0});var Nj=i(Vt);Td=r(Nj,"SPAN",{});var Lj=i(Td);b(qn.$$.fragment,Lj),Lj.forEach(s),Nj.forEach(s),Wv=d(Hc),vd=r(Hc,"SPAN",{});var Qj=i(vd);Uv=n(Qj,"TapasForSequenceClassification"),Qj.forEach(s),Hc.forEach(s),Zp=d(t),Ze=r(t,"DIV",{class:!0});var Os=i(Ze);b(En.$$.fragment,Os),Hv=d(Os),bd=r(Os,"P",{});var Oj=i(bd);Bv=n(Oj,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Oj.forEach(s),Gv=d(Os),Fn=r(Os,"P",{});var Bc=i(Fn);Rv=n(Bc,"This model inherits from "),dr=r(Bc,"A",{href:!0});var Ij=i(dr);Vv=n(Ij,"PreTrainedModel"),Ij.forEach(s),Kv=n(Bc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bc.forEach(s),Yv=d(Os),An=r(Os,"P",{});var Gc=i(An);Jv=n(Gc,"This model is also a PyTorch "),zn=r(Gc,"A",{href:!0,rel:!0});var Wj=i(zn);Xv=n(Wj,"torch.nn.Module"),Wj.forEach(s),Zv=n(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(s),eb=d(Os),ns=r(Os,"DIV",{class:!0});var Is=i(ns);b($n.$$.fragment,Is),sb=d(Is),ut=r(Is,"P",{});var Dr=i(ut);tb=n(Dr,"The "),pr=r(Dr,"A",{href:!0});var Uj=i(pr);ab=n(Uj,"TapasForSequenceClassification"),Uj.forEach(s),nb=n(Dr," forward method, overrides the "),wd=r(Dr,"CODE",{});var Hj=i(wd);ob=n(Hj,"__call__"),Hj.forEach(s),rb=n(Dr," special method."),Dr.forEach(s),ib=d(Is),b(Kt.$$.fragment,Is),lb=d(Is),yd=r(Is,"P",{});var Bj=i(yd);db=n(Bj,"Examples:"),Bj.forEach(s),pb=d(Is),b(xn.$$.fragment,Is),Is.forEach(s),Os.forEach(s),ec=d(t),mt=r(t,"H2",{class:!0});var Rc=i(mt);Yt=r(Rc,"A",{id:!0,class:!0,href:!0});var Gj=i(Yt);kd=r(Gj,"SPAN",{});var Rj=i(kd);b(Cn.$$.fragment,Rj),Rj.forEach(s),Gj.forEach(s),cb=d(Rc),jd=r(Rc,"SPAN",{});var Vj=i(jd);hb=n(Vj,"TapasForQuestionAnswering"),Vj.forEach(s),Rc.forEach(s),sc=d(t),es=r(t,"DIV",{class:!0});var Ws=i(es);b(Mn.$$.fragment,Ws),ub=d(Ws),ft=r(Ws,"P",{});var Nr=i(ft);mb=n(Nr,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),qd=r(Nr,"CODE",{});var Kj=i(qd);fb=n(Kj,"logits"),Kj.forEach(s),gb=n(Nr," and optional "),Ed=r(Nr,"CODE",{});var Yj=i(Ed);_b=n(Yj,"logits_aggregation"),Yj.forEach(s),Tb=n(Nr,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Nr.forEach(s),vb=d(Ws),Pn=r(Ws,"P",{});var Vc=i(Pn);bb=n(Vc,"This model inherits from "),cr=r(Vc,"A",{href:!0});var Jj=i(cr);wb=n(Jj,"PreTrainedModel"),Jj.forEach(s),yb=n(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(s),kb=d(Ws),Sn=r(Ws,"P",{});var Kc=i(Sn);jb=n(Kc,"This model is also a PyTorch "),Dn=r(Kc,"A",{href:!0,rel:!0});var Xj=i(Dn);qb=n(Xj,"torch.nn.Module"),Xj.forEach(s),Eb=n(Kc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kc.forEach(s),Fb=d(Ws),os=r(Ws,"DIV",{class:!0});var Us=i(os);b(Nn.$$.fragment,Us),Ab=d(Us),gt=r(Us,"P",{});var Lr=i(gt);zb=n(Lr,"The "),hr=r(Lr,"A",{href:!0});var Zj=i(hr);$b=n(Zj,"TapasForQuestionAnswering"),Zj.forEach(s),xb=n(Lr," forward method, overrides the "),Fd=r(Lr,"CODE",{});var eq=i(Fd);Cb=n(eq,"__call__"),eq.forEach(s),Mb=n(Lr," special method."),Lr.forEach(s),Pb=d(Us),b(Jt.$$.fragment,Us),Sb=d(Us),Ad=r(Us,"P",{});var sq=i(Ad);Db=n(sq,"Examples:"),sq.forEach(s),Nb=d(Us),b(Ln.$$.fragment,Us),Us.forEach(s),Ws.forEach(s),tc=d(t),_t=r(t,"H2",{class:!0});var Yc=i(_t);Xt=r(Yc,"A",{id:!0,class:!0,href:!0});var tq=i(Xt);zd=r(tq,"SPAN",{});var aq=i(zd);b(Qn.$$.fragment,aq),aq.forEach(s),tq.forEach(s),Lb=d(Yc),$d=r(Yc,"SPAN",{});var nq=i($d);Qb=n(nq,"TFTapasModel"),nq.forEach(s),Yc.forEach(s),ac=d(t),Ne=r(t,"DIV",{class:!0});var js=i(Ne);b(On.$$.fragment,js),Ob=d(js),xd=r(js,"P",{});var oq=i(xd);Ib=n(oq,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),oq.forEach(s),Wb=d(js),In=r(js,"P",{});var Jc=i(In);Ub=n(Jc,"This model inherits from "),ur=r(Jc,"A",{href:!0});var rq=i(ur);Hb=n(rq,"TFPreTrainedModel"),rq.forEach(s),Bb=n(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(s),Gb=d(js),Wn=r(js,"P",{});var Xc=i(Wn);Rb=n(Xc,"This model is also a "),Un=r(Xc,"A",{href:!0,rel:!0});var iq=i(Un);Vb=n(iq,"tf.keras.Model"),iq.forEach(s),Kb=n(Xc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xc.forEach(s),Yb=d(js),b(Zt.$$.fragment,js),Jb=d(js),rs=r(js,"DIV",{class:!0});var Hs=i(rs);b(Hn.$$.fragment,Hs),Xb=d(Hs),Tt=r(Hs,"P",{});var Qr=i(Tt);Zb=n(Qr,"The "),mr=r(Qr,"A",{href:!0});var lq=i(mr);ew=n(lq,"TFTapasModel"),lq.forEach(s),sw=n(Qr," forward method, overrides the "),Cd=r(Qr,"CODE",{});var dq=i(Cd);tw=n(dq,"__call__"),dq.forEach(s),aw=n(Qr," special method."),Qr.forEach(s),nw=d(Hs),b(ea.$$.fragment,Hs),ow=d(Hs),Md=r(Hs,"P",{});var pq=i(Md);rw=n(pq,"Examples:"),pq.forEach(s),iw=d(Hs),b(Bn.$$.fragment,Hs),Hs.forEach(s),js.forEach(s),nc=d(t),vt=r(t,"H2",{class:!0});var Zc=i(vt);sa=r(Zc,"A",{id:!0,class:!0,href:!0});var cq=i(sa);Pd=r(cq,"SPAN",{});var hq=i(Pd);b(Gn.$$.fragment,hq),hq.forEach(s),cq.forEach(s),lw=d(Zc),Sd=r(Zc,"SPAN",{});var uq=i(Sd);dw=n(uq,"TFTapasForMaskedLM"),uq.forEach(s),Zc.forEach(s),oc=d(t),Le=r(t,"DIV",{class:!0});var qs=i(Le);b(Rn.$$.fragment,qs),pw=d(qs),Vn=r(qs,"P",{});var eh=i(Vn);cw=n(eh,"Tapas Model with a "),Dd=r(eh,"CODE",{});var mq=i(Dd);hw=n(mq,"language modeling"),mq.forEach(s),uw=n(eh," head on top."),eh.forEach(s),mw=d(qs),Kn=r(qs,"P",{});var sh=i(Kn);fw=n(sh,"This model inherits from "),fr=r(sh,"A",{href:!0});var fq=i(fr);gw=n(fq,"TFPreTrainedModel"),fq.forEach(s),_w=n(sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sh.forEach(s),Tw=d(qs),Yn=r(qs,"P",{});var th=i(Yn);vw=n(th,"This model is also a "),Jn=r(th,"A",{href:!0,rel:!0});var gq=i(Jn);bw=n(gq,"tf.keras.Model"),gq.forEach(s),ww=n(th,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),th.forEach(s),yw=d(qs),b(ta.$$.fragment,qs),kw=d(qs),is=r(qs,"DIV",{class:!0});var Bs=i(is);b(Xn.$$.fragment,Bs),jw=d(Bs),bt=r(Bs,"P",{});var Or=i(bt);qw=n(Or,"The "),gr=r(Or,"A",{href:!0});var _q=i(gr);Ew=n(_q,"TFTapasForMaskedLM"),_q.forEach(s),Fw=n(Or," forward method, overrides the "),Nd=r(Or,"CODE",{});var Tq=i(Nd);Aw=n(Tq,"__call__"),Tq.forEach(s),zw=n(Or," special method."),Or.forEach(s),$w=d(Bs),b(aa.$$.fragment,Bs),xw=d(Bs),Ld=r(Bs,"P",{});var vq=i(Ld);Cw=n(vq,"Examples:"),vq.forEach(s),Mw=d(Bs),b(Zn.$$.fragment,Bs),Bs.forEach(s),qs.forEach(s),rc=d(t),wt=r(t,"H2",{class:!0});var ah=i(wt);na=r(ah,"A",{id:!0,class:!0,href:!0});var bq=i(na);Qd=r(bq,"SPAN",{});var wq=i(Qd);b(eo.$$.fragment,wq),wq.forEach(s),bq.forEach(s),Pw=d(ah),Od=r(ah,"SPAN",{});var yq=i(Od);Sw=n(yq,"TFTapasForSequenceClassification"),yq.forEach(s),ah.forEach(s),ic=d(t),Qe=r(t,"DIV",{class:!0});var Es=i(Qe);b(so.$$.fragment,Es),Dw=d(Es),Id=r(Es,"P",{});var kq=i(Id);Nw=n(kq,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),kq.forEach(s),Lw=d(Es),to=r(Es,"P",{});var nh=i(to);Qw=n(nh,"This model inherits from "),_r=r(nh,"A",{href:!0});var jq=i(_r);Ow=n(jq,"TFPreTrainedModel"),jq.forEach(s),Iw=n(nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nh.forEach(s),Ww=d(Es),ao=r(Es,"P",{});var oh=i(ao);Uw=n(oh,"This model is also a "),no=r(oh,"A",{href:!0,rel:!0});var qq=i(no);Hw=n(qq,"tf.keras.Model"),qq.forEach(s),Bw=n(oh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),oh.forEach(s),Gw=d(Es),b(oa.$$.fragment,Es),Rw=d(Es),ls=r(Es,"DIV",{class:!0});var Gs=i(ls);b(oo.$$.fragment,Gs),Vw=d(Gs),yt=r(Gs,"P",{});var Ir=i(yt);Kw=n(Ir,"The "),Tr=r(Ir,"A",{href:!0});var Eq=i(Tr);Yw=n(Eq,"TFTapasForSequenceClassification"),Eq.forEach(s),Jw=n(Ir," forward method, overrides the "),Wd=r(Ir,"CODE",{});var Fq=i(Wd);Xw=n(Fq,"__call__"),Fq.forEach(s),Zw=n(Ir," special method."),Ir.forEach(s),ey=d(Gs),b(ra.$$.fragment,Gs),sy=d(Gs),Ud=r(Gs,"P",{});var Aq=i(Ud);ty=n(Aq,"Examples:"),Aq.forEach(s),ay=d(Gs),b(ro.$$.fragment,Gs),Gs.forEach(s),Es.forEach(s),lc=d(t),kt=r(t,"H2",{class:!0});var rh=i(kt);ia=r(rh,"A",{id:!0,class:!0,href:!0});var zq=i(ia);Hd=r(zq,"SPAN",{});var $q=i(Hd);b(io.$$.fragment,$q),$q.forEach(s),zq.forEach(s),ny=d(rh),Bd=r(rh,"SPAN",{});var xq=i(Bd);oy=n(xq,"TFTapasForQuestionAnswering"),xq.forEach(s),rh.forEach(s),dc=d(t),Oe=r(t,"DIV",{class:!0});var Fs=i(Oe);b(lo.$$.fragment,Fs),ry=d(Fs),jt=r(Fs,"P",{});var Wr=i(jt);iy=n(Wr,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Gd=r(Wr,"CODE",{});var Cq=i(Gd);ly=n(Cq,"logits"),Cq.forEach(s),dy=n(Wr," and optional "),Rd=r(Wr,"CODE",{});var Mq=i(Rd);py=n(Mq,"logits_aggregation"),Mq.forEach(s),cy=n(Wr,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Wr.forEach(s),hy=d(Fs),po=r(Fs,"P",{});var ih=i(po);uy=n(ih,"This model inherits from "),vr=r(ih,"A",{href:!0});var Pq=i(vr);my=n(Pq,"TFPreTrainedModel"),Pq.forEach(s),fy=n(ih,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ih.forEach(s),gy=d(Fs),co=r(Fs,"P",{});var lh=i(co);_y=n(lh,"This model is also a "),ho=r(lh,"A",{href:!0,rel:!0});var Sq=i(ho);Ty=n(Sq,"tf.keras.Model"),Sq.forEach(s),vy=n(lh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),lh.forEach(s),by=d(Fs),b(la.$$.fragment,Fs),wy=d(Fs),ds=r(Fs,"DIV",{class:!0});var Rs=i(ds);b(uo.$$.fragment,Rs),yy=d(Rs),qt=r(Rs,"P",{});var Ur=i(qt);ky=n(Ur,"The "),br=r(Ur,"A",{href:!0});var Dq=i(br);jy=n(Dq,"TFTapasForQuestionAnswering"),Dq.forEach(s),qy=n(Ur," forward method, overrides the "),Vd=r(Ur,"CODE",{});var Nq=i(Vd);Ey=n(Nq,"__call__"),Nq.forEach(s),Fy=n(Ur," special method."),Ur.forEach(s),Ay=d(Rs),b(da.$$.fragment,Rs),zy=d(Rs),Kd=r(Rs,"P",{});var Lq=i(Kd);$y=n(Lq,"Examples:"),Lq.forEach(s),xy=d(Rs),b(mo.$$.fragment,Rs),Rs.forEach(s),Fs.forEach(s),this.h()},h(){p(m,"name","hf:doc:metadata"),p(m,"content",JSON.stringify(a4)),p(g,"id","tapas"),p(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(g,"href","#tapas"),p(f,"class","relative group"),p(Y,"id","overview"),p(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Y,"href","#overview"),p(z,"class","relative group"),p(ee,"href","https://www.aclweb.org/anthology/2020.acl-main.398"),p(ee,"rel","nofollow"),p(te,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),p(te,"rel","nofollow"),p(ae,"href","https://github.com/ppasupat/WikiTableQuestions"),p(ae,"rel","nofollow"),p(P,"href","https://github.com/salesforce/WikiSQL"),p(P,"rel","nofollow"),p(qe,"href","https://github.com/wenhuchen/Table-Fact-Checking"),p(qe,"rel","nofollow"),p(ga,"href","https://www.aclweb.org/anthology/2020.findings-emnlp.27/"),p(ga,"rel","nofollow"),Uq(At.src,By="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/tapas_architecture.png")||p(At,"src",By),p(At,"alt","drawing"),p(At,"width","600"),p(To,"href","https://ai.googleblog.com/2020/04/using-neural-networks-to-find-answers.html"),p(_a,"href","https://huggingface.co/nielsr"),p(_a,"rel","nofollow"),p(Ta,"href","https://huggingface.co/kamalkraj"),p(Ta,"rel","nofollow"),p(va,"href","https://github.com/google-research/tapas"),p(va,"rel","nofollow"),p(bo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig"),p(ba,"href","https://huggingface.co/models?search=tapas"),p(ba,"rel","nofollow"),p(wa,"href","https://github.com/google-research/tapas%3E"),p(wa,"rel","nofollow"),p($t,"id","usage-finetuning"),p($t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p($t,"href","#usage-finetuning"),p(Ks,"class","relative group"),p(wo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(ko,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(qa,"href","https://github.com/rusty1s/pytorch_scatter"),p(qa,"rel","nofollow"),p(Ea,"href","https://github.com/tensorflow/probability"),p(Ea,"rel","nofollow"),p(qo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasConfig"),p(Eo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(za,"href","https://github.com/google-research/tapas/issues/91#issuecomment-735719340"),p(za,"rel","nofollow"),p($a,"href","https://huggingface.co/models?search=tapas"),p($a,"rel","nofollow"),p(xa,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),p(xa,"rel","nofollow"),p(Ca,"href","https://github.com/google-research/tapas/issues/50#issuecomment-705465960"),p(Ca,"rel","nofollow"),p(Ma,"href","https://github.com/NielsRogge/tapas_utils"),p(Ma,"rel","nofollow"),p(Lo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer"),p(Qo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(Oo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),p(Io,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer"),p(Wo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer"),p(Uo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer"),p(Oa,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),p(Oa,"rel","nofollow"),p(Ia,"href","https://github.com/kamalkraj/Tapas-Tutorial/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),p(Ia,"rel","nofollow"),p(Bo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(Go,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),p(Lt,"id","usage-inference"),p(Lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Lt,"href","#usage-inference"),p(tt,"class","relative group"),p(Ro,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(Vo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),p(Ko,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer"),p(Ba,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),p(Ba,"rel","nofollow"),p(Ga,"href","https://github.com/kamalkraj/Tapas-Tutorial/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),p(Ga,"rel","nofollow"),p(Ot,"id","transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"),p(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ot,"href","#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"),p(at,"class","relative group"),p(Yo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(nt,"class","docstring"),p(It,"id","transformers.TapasConfig"),p(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(It,"href","#transformers.TapasConfig"),p(ot,"class","relative group"),p(Jo,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasModel"),p(Xo,"href","/docs/transformers/v4.16.2/en/main_classes/configuration#transformers.PretrainedConfig"),p(Za,"href","https://github.com/google-research/tapas/tree/master"),p(Za,"rel","nofollow"),p(Xe,"class","docstring"),p(Wt,"id","transformers.TapasTokenizer"),p(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Wt,"href","#transformers.TapasTokenizer"),p(rt,"class","relative group"),p(Zo,"href","/docs/transformers/v4.16.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(er,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer"),p(tr,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasTokenizer"),p(Ut,"class","docstring"),p(ar,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(ln,"href","https://github.com/google-research/tapas/blob/4908213eb4df7aa988573350278b44c4dbe3f71b/tapas/experiments/prediction_utils.py#L288"),p(ln,"rel","nofollow"),p(Ps,"class","docstring"),p(ld,"class","docstring"),p(de,"class","docstring"),p(Ht,"id","transformers.TapasModel"),p(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ht,"href","#transformers.TapasModel"),p(it,"class","relative group"),p(nr,"href","/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel"),p(un,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(un,"rel","nofollow"),p(or,"href","/docs/transformers/v4.16.2/en/model_doc/bert#transformers.BertModel"),p(gn,"href","https://arxiv.org/abs/1706.03762"),p(gn,"rel","nofollow"),p(rr,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasModel"),p(ts,"class","docstring"),p(De,"class","docstring"),p(Gt,"id","transformers.TapasForMaskedLM"),p(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Gt,"href","#transformers.TapasForMaskedLM"),p(dt,"class","relative group"),p(ir,"href","/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel"),p(yn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(yn,"rel","nofollow"),p(lr,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForMaskedLM"),p(as,"class","docstring"),p(gs,"class","docstring"),p(Vt,"id","transformers.TapasForSequenceClassification"),p(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Vt,"href","#transformers.TapasForSequenceClassification"),p(ht,"class","relative group"),p(dr,"href","/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel"),p(zn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(zn,"rel","nofollow"),p(pr,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForSequenceClassification"),p(ns,"class","docstring"),p(Ze,"class","docstring"),p(Yt,"id","transformers.TapasForQuestionAnswering"),p(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Yt,"href","#transformers.TapasForQuestionAnswering"),p(mt,"class","relative group"),p(cr,"href","/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel"),p(Dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Dn,"rel","nofollow"),p(hr,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),p(os,"class","docstring"),p(es,"class","docstring"),p(Xt,"id","transformers.TFTapasModel"),p(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Xt,"href","#transformers.TFTapasModel"),p(_t,"class","relative group"),p(ur,"href","/docs/transformers/v4.16.2/en/main_classes/model#transformers.TFPreTrainedModel"),p(Un,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(Un,"rel","nofollow"),p(mr,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TFTapasModel"),p(rs,"class","docstring"),p(Ne,"class","docstring"),p(sa,"id","transformers.TFTapasForMaskedLM"),p(sa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(sa,"href","#transformers.TFTapasForMaskedLM"),p(vt,"class","relative group"),p(fr,"href","/docs/transformers/v4.16.2/en/main_classes/model#transformers.TFPreTrainedModel"),p(Jn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(Jn,"rel","nofollow"),p(gr,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TFTapasForMaskedLM"),p(is,"class","docstring"),p(Le,"class","docstring"),p(na,"id","transformers.TFTapasForSequenceClassification"),p(na,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(na,"href","#transformers.TFTapasForSequenceClassification"),p(wt,"class","relative group"),p(_r,"href","/docs/transformers/v4.16.2/en/main_classes/model#transformers.TFPreTrainedModel"),p(no,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(no,"rel","nofollow"),p(Tr,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TFTapasForSequenceClassification"),p(ls,"class","docstring"),p(Qe,"class","docstring"),p(ia,"id","transformers.TFTapasForQuestionAnswering"),p(ia,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ia,"href","#transformers.TFTapasForQuestionAnswering"),p(kt,"class","relative group"),p(vr,"href","/docs/transformers/v4.16.2/en/main_classes/model#transformers.TFPreTrainedModel"),p(ho,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(ho,"rel","nofollow"),p(br,"href","/docs/transformers/v4.16.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),p(ds,"class","docstring"),p(Oe,"class","docstring")},m(t,h){e(document.head,m),c(t,F,h),c(t,f,h),e(f,g),e(g,q),w(T,q,null),e(f,_),e(f,A),e(A,_e),c(t,K,h),c(t,z,h),e(z,Y),e(Y,O),w(Z,O,null),e(z,Te),e(z,I),e(I,ve),c(t,ce,h),c(t,W,h),e(W,N),e(W,ee),e(ee,se),e(W,$),c(t,x,h),c(t,oe,h),e(oe,H),c(t,he,h),c(t,V,h),e(V,L),e(L,te),e(te,be),e(L,C),e(V,we),e(V,Q),e(Q,ae),e(ae,ye),e(Q,B),e(V,ke),e(V,re),e(re,P),e(P,je),e(re,G),c(t,ue,h),c(t,u,h),e(u,E),c(t,J,h),c(t,Fe,h),e(Fe,Ge),c(t,S,h),c(t,Ae,h),e(Ae,xe),e(xe,Re),c(t,D,h),c(t,M,h),e(M,Ve),e(M,Ce),e(Ce,R),e(M,Ke),e(M,qe),e(qe,Ee),e(M,Ye),e(M,ga),e(ga,dh),e(M,ph),c(t,np,h),c(t,At,h),c(t,op,h),c(t,zt,h),e(zt,ch),e(zt,To),e(To,hh),e(zt,uh),c(t,rp,h),c(t,_s,h),e(_s,mh),e(_s,_a),e(_a,fh),e(_s,gh),e(_s,Ta),e(Ta,_h),e(_s,Th),e(_s,va),e(va,vh),e(_s,bh),c(t,ip,h),c(t,vo,h),e(vo,wh),c(t,lp,h),c(t,Ts,h),e(Ts,Me),e(Me,yh),e(Me,Br),e(Br,kh),e(Me,jh),e(Me,bo),e(bo,qh),e(Me,Eh),e(Me,Gr),e(Gr,Fh),e(Me,Ah),e(Me,ba),e(ba,zh),e(Me,$h),e(Me,Rr),e(Rr,xh),e(Me,Ch),e(Me,Vr),e(Vr,Mh),e(Me,Ph),e(Ts,Sh),e(Ts,Je),e(Je,Dh),e(Je,Kr),e(Kr,Nh),e(Je,Lh),e(Je,Yr),e(Yr,Qh),e(Je,Oh),e(Je,Jr),e(Jr,Ih),e(Je,Wh),e(Je,Xr),e(Xr,Uh),e(Je,Hh),e(Je,wa),e(wa,Bh),e(Je,Gh),e(Ts,Rh),e(Ts,Vs),e(Vs,Vh),e(Vs,Zr),e(Zr,Kh),e(Vs,Yh),e(Vs,ei),e(ei,Jh),e(Vs,Xh),e(Ts,Zh),e(Ts,si),e(si,eu),c(t,dp,h),c(t,Ks,h),e(Ks,$t),e($t,ti),w(ya,ti,null),e(Ks,su),e(Ks,ai),e(ai,tu),c(t,pp,h),c(t,xt,h),e(xt,au),e(xt,wo),e(wo,nu),e(xt,ou),c(t,cp,h),c(t,yo,h),e(yo,ni),e(ni,ru),c(t,hp,h),c(t,Ct,h),e(Ct,iu),e(Ct,ko),e(ko,lu),e(Ct,du),c(t,up,h),c(t,$s,h),e($s,oi),e(oi,pu),e($s,cu),e($s,ka),e(ka,hu),e(ka,ri),e(ri,uu),e(ka,mu),e($s,fu),e($s,ja),e(ja,gu),e(ja,ii),e(ii,_u),e(ja,Tu),c(t,mp,h),c(t,jo,h),e(jo,vu),c(t,fp,h),c(t,Mt,h),e(Mt,li),e(li,Ys),e(Ys,di),e(di,pi),e(pi,bu),e(Ys,wu),e(Ys,ci),e(ci,hi),e(hi,yu),e(Ys,ku),e(Ys,ui),e(ui,mi),e(mi,ju),e(Mt,qu),e(Mt,Js),e(Js,Xs),e(Xs,fi),e(fi,Eu),e(Xs,Fu),e(Xs,gi),e(gi,Au),e(Xs,zu),e(Xs,_i),e(_i,$u),e(Js,xu),e(Js,Zs),e(Zs,Ti),e(Ti,Cu),e(Zs,Mu),e(Zs,vi),e(vi,Pu),e(Zs,Su),e(Zs,bi),e(bi,Du),e(Js,Nu),e(Js,et),e(et,wi),e(wi,Lu),e(et,Qu),e(et,yi),e(yi,Ou),e(et,Iu),e(et,ki),e(ki,Wu),c(t,gp,h),c(t,xs,h),e(xs,Uu),e(xs,qa),e(qa,Hu),e(xs,Bu),e(xs,Ea),e(Ea,Gu),e(xs,Ru),c(t,_p,h),w(Fa,t,h),c(t,Tp,h),c(t,Cs,h),e(Cs,Vu),e(Cs,qo),e(qo,Ku),e(Cs,Yu),e(Cs,Eo),e(Eo,Ju),e(Cs,Xu),c(t,vp,h),w(Aa,t,h),c(t,bp,h),c(t,Pt,h),e(Pt,Zu),e(Pt,za),e(za,em),e(Pt,sm),c(t,wp,h),c(t,St,h),e(St,tm),e(St,$a),e($a,am),e(St,nm),c(t,yp,h),c(t,Fo,h),e(Fo,ji),e(ji,om),c(t,kp,h),c(t,Dt,h),e(Dt,rm),e(Dt,xa),e(xa,im),e(Dt,lm),c(t,jp,h),c(t,ie,h),e(ie,Ao),e(Ao,qi),e(qi,dm),e(Ao,pm),e(ie,cm),e(ie,zo),e(zo,Ei),e(Ei,hm),e(zo,um),e(ie,mm),e(ie,$o),e($o,Fi),e(Fi,fm),e($o,gm),e(ie,_m),e(ie,xo),e(xo,Ai),e(Ai,Tm),e(xo,vm),e(ie,bm),e(ie,Co),e(Co,zi),e(zi,wm),e(Co,ym),e(ie,km),e(ie,Mo),e(Mo,$i),e($i,jm),e(Mo,qm),e(ie,Em),e(ie,Po),e(Po,xi),e(xi,Fm),e(Po,Am),e(ie,zm),e(ie,So),e(So,Ci),e(Ci,$m),e(So,xm),e(ie,Cm),e(ie,Do),e(Do,Mi),e(Mi,Mm),e(Do,Pm),c(t,qp,h),c(t,We,h),e(We,Sm),e(We,Ca),e(Ca,Dm),e(We,Nm),e(We,Ma),e(Ma,Lm),e(We,Qm),e(We,Pi),e(Pi,Om),e(We,Im),e(We,Si),e(Si,Wm),e(We,Um),e(We,Di),e(Di,Hm),e(We,Bm),c(t,Ep,h),c(t,No,h),e(No,Ni),e(Ni,Gm),c(t,Fp,h),c(t,ze,h),e(ze,Rm),e(ze,Lo),e(Lo,Vm),e(ze,Km),e(ze,Li),e(Li,Ym),e(ze,Jm),e(ze,Qi),e(Qi,Xm),e(ze,Zm),e(ze,Oi),e(Oi,ef),e(ze,sf),e(ze,Qo),e(Qo,tf),e(ze,af),e(ze,Oo),e(Oo,nf),e(ze,of),c(t,Ap,h),c(t,Nt,h),e(Nt,Ii),e(Ii,Pa),e(Pa,Wi),e(Wi,Ui),e(Ui,rf),e(Pa,lf),e(Pa,Hi),e(Hi,Bi),e(Bi,df),e(Nt,pf),e(Nt,st),e(st,Sa),e(Sa,Gi),e(Gi,cf),e(Sa,hf),e(Sa,zs),e(zs,Ri),e(Ri,uf),e(zs,mf),e(zs,Vi),e(Vi,ff),e(zs,gf),e(zs,Ki),e(Ki,_f),e(zs,Tf),e(zs,Yi),e(Yi,vf),e(st,bf),e(st,Da),e(Da,Ji),e(Ji,wf),e(Da,yf),e(Da,Pe),e(Pe,Xi),e(Xi,kf),e(Pe,jf),e(Pe,Zi),e(Zi,qf),e(Pe,Ef),e(Pe,el),e(el,Ff),e(Pe,Af),e(Pe,sl),e(sl,zf),e(Pe,$f),e(Pe,tl),e(tl,xf),e(Pe,Cf),e(Pe,al),e(al,Mf),e(Pe,Pf),e(Pe,nl),e(nl,Sf),e(st,Df),e(st,Na),e(Na,ol),e(ol,Nf),e(Na,Lf),e(Na,ms),e(ms,rl),e(rl,Qf),e(ms,Of),e(ms,il),e(il,If),e(ms,Wf),e(ms,ll),e(ll,Uf),e(ms,Hf),e(ms,dl),e(dl,Bf),e(ms,Gf),e(ms,pl),e(pl,Rf),c(t,zp,h),c(t,le,h),e(le,Io),e(Io,Vf),e(le,Kf),e(le,cl),e(cl,Yf),e(le,Jf),e(le,hl),e(hl,Xf),e(le,Zf),e(le,ul),e(ul,eg),e(le,sg),e(le,ml),e(ml,tg),e(le,ag),e(le,fl),e(fl,ng),e(le,og),e(le,gl),e(gl,rg),e(le,ig),e(le,_l),e(_l,lg),e(le,dg),c(t,$p,h),w(La,t,h),c(t,xp,h),c(t,vs,h),e(vs,pg),e(vs,Wo),e(Wo,cg),e(vs,hg),e(vs,Tl),e(Tl,ug),e(vs,mg),e(vs,vl),e(vl,fg),e(vs,gg),c(t,Cp,h),w(Qa,t,h),c(t,Mp,h),c(t,X,h),e(X,_g),e(X,bl),e(bl,Tg),e(X,vg),e(X,wl),e(wl,bg),e(X,wg),e(X,yl),e(yl,yg),e(X,kg),e(X,kl),e(kl,jg),e(X,qg),e(X,jl),e(jl,Eg),e(X,Fg),e(X,ql),e(ql,Ag),e(X,zg),e(X,Uo),e(Uo,$g),e(X,xg),e(X,Oa),e(Oa,Cg),e(X,Mg),e(X,Ia),e(Ia,Pg),e(X,Sg),c(t,Pp,h),c(t,Ho,h),e(Ho,El),e(El,Dg),c(t,Sp,h),c(t,Ms,h),e(Ms,Ng),e(Ms,Bo),e(Bo,Lg),e(Ms,Qg),e(Ms,Go),e(Go,Og),e(Ms,Ig),c(t,Dp,h),w(Wa,t,h),c(t,Np,h),c(t,tt,h),e(tt,Lt),e(Lt,Fl),w(Ua,Fl,null),e(tt,Wg),e(tt,Al),e(Al,Ug),c(t,Lp,h),c(t,me,h),e(me,Hg),e(me,Ro),e(Ro,Bg),e(me,Gg),e(me,Vo),e(Vo,Rg),e(me,Vg),e(me,zl),e(zl,Kg),e(me,Yg),e(me,$l),e($l,Jg),e(me,Xg),e(me,xl),e(xl,Zg),e(me,e_),e(me,Ko),e(Ko,s_),e(me,t_),e(me,Cl),e(Cl,a_),e(me,n_),c(t,Qp,h),c(t,Qt,h),e(Qt,o_),e(Qt,Ml),e(Ml,r_),e(Qt,i_),c(t,Op,h),w(Ha,t,h),c(t,Ip,h),c(t,Ue,h),e(Ue,l_),e(Ue,Pl),e(Pl,d_),e(Ue,p_),e(Ue,Sl),e(Sl,c_),e(Ue,h_),e(Ue,Dl),e(Dl,u_),e(Ue,m_),e(Ue,Ba),e(Ba,f_),e(Ue,g_),e(Ue,Ga),e(Ga,__),e(Ue,T_),c(t,Wp,h),c(t,at,h),e(at,Ot),e(Ot,Nl),w(Ra,Nl,null),e(at,v_),e(at,Ll),e(Ll,b_),c(t,Up,h),c(t,nt,h),w(Va,nt,null),e(nt,w_),e(nt,Ka),e(Ka,y_),e(Ka,Yo),e(Yo,k_),e(Ka,j_),c(t,Hp,h),c(t,ot,h),e(ot,It),e(It,Ql),w(Ya,Ql,null),e(ot,q_),e(ot,Ol),e(Ol,E_),c(t,Bp,h),c(t,Xe,h),w(Ja,Xe,null),e(Xe,F_),e(Xe,fs),e(fs,A_),e(fs,Jo),e(Jo,z_),e(fs,$_),e(fs,Il),e(Il,x_),e(fs,C_),e(fs,Wl),e(Wl,M_),e(fs,P_),e(fs,Xo),e(Xo,S_),e(fs,D_),e(Xe,N_),e(Xe,Xa),e(Xa,L_),e(Xa,Za),e(Za,Q_),e(Xa,O_),e(Xe,I_),e(Xe,Ul),e(Ul,W_),e(Xe,U_),w(en,Xe,null),c(t,Gp,h),c(t,rt,h),e(rt,Wt),e(Wt,Hl),w(sn,Hl,null),e(rt,H_),e(rt,Bl),e(Bl,B_),c(t,Rp,h),c(t,de,h),w(tn,de,null),e(de,G_),e(de,Gl),e(Gl,R_),e(de,V_),e(de,ne),e(ne,K_),e(ne,Zo),e(Zo,Y_),e(ne,J_),e(ne,er),e(er,X_),e(ne,Z_),e(ne,Rl),e(Rl,eT),e(ne,sT),e(ne,Vl),e(Vl,tT),e(ne,aT),e(ne,Kl),e(Kl,nT),e(ne,oT),e(ne,Yl),e(Yl,rT),e(ne,iT),e(ne,Jl),e(Jl,lT),e(ne,dT),e(ne,Xl),e(Xl,pT),e(ne,cT),e(ne,Zl),e(Zl,hT),e(ne,uT),e(de,mT),e(de,Se),e(Se,ed),e(ed,fT),e(Se,gT),e(Se,sd),e(sd,_T),e(Se,TT),e(Se,td),e(td,vT),e(Se,bT),e(Se,ad),e(ad,wT),e(Se,yT),e(Se,nd),e(nd,kT),e(Se,jT),e(Se,od),e(od,qT),e(Se,ET),e(Se,rd),e(rd,FT),e(de,AT),e(de,sr),e(sr,tr),e(tr,zT),e(sr,$T),e(de,xT),e(de,Ut),w(an,Ut,null),e(Ut,CT),e(Ut,id),e(id,MT),e(de,PT),e(de,Ps),w(nn,Ps,null),e(Ps,ST),e(Ps,on),e(on,DT),e(on,ar),e(ar,NT),e(on,LT),e(Ps,QT),e(Ps,rn),e(rn,OT),e(rn,ln),e(ln,IT),e(rn,WT),e(de,UT),e(de,ld),c(t,Vp,h),c(t,it,h),e(it,Ht),e(Ht,dd),w(dn,dd,null),e(it,HT),e(it,pd),e(pd,BT),c(t,Kp,h),c(t,De,h),w(pn,De,null),e(De,GT),e(De,cn),e(cn,RT),e(cn,nr),e(nr,VT),e(cn,KT),e(De,YT),e(De,hn),e(hn,JT),e(hn,un),e(un,XT),e(hn,ZT),e(De,ev),e(De,mn),e(mn,sv),e(mn,or),e(or,tv),e(mn,av),e(De,nv),e(De,fn),e(fn,ov),e(fn,gn),e(gn,rv),e(fn,iv),e(De,lv),e(De,ts),w(_n,ts,null),e(ts,dv),e(ts,lt),e(lt,pv),e(lt,rr),e(rr,cv),e(lt,hv),e(lt,cd),e(cd,uv),e(lt,mv),e(ts,fv),w(Bt,ts,null),e(ts,gv),e(ts,hd),e(hd,_v),e(ts,Tv),w(Tn,ts,null),c(t,Yp,h),c(t,dt,h),e(dt,Gt),e(Gt,ud),w(vn,ud,null),e(dt,vv),e(dt,md),e(md,bv),c(t,Jp,h),c(t,gs,h),w(bn,gs,null),e(gs,wv),e(gs,pt),e(pt,yv),e(pt,fd),e(fd,kv),e(pt,jv),e(pt,ir),e(ir,qv),e(pt,Ev),e(gs,Fv),e(gs,wn),e(wn,Av),e(wn,yn),e(yn,zv),e(wn,$v),e(gs,xv),e(gs,as),w(kn,as,null),e(as,Cv),e(as,ct),e(ct,Mv),e(ct,lr),e(lr,Pv),e(ct,Sv),e(ct,gd),e(gd,Dv),e(ct,Nv),e(as,Lv),w(Rt,as,null),e(as,Qv),e(as,_d),e(_d,Ov),e(as,Iv),w(jn,as,null),c(t,Xp,h),c(t,ht,h),e(ht,Vt),e(Vt,Td),w(qn,Td,null),e(ht,Wv),e(ht,vd),e(vd,Uv),c(t,Zp,h),c(t,Ze,h),w(En,Ze,null),e(Ze,Hv),e(Ze,bd),e(bd,Bv),e(Ze,Gv),e(Ze,Fn),e(Fn,Rv),e(Fn,dr),e(dr,Vv),e(Fn,Kv),e(Ze,Yv),e(Ze,An),e(An,Jv),e(An,zn),e(zn,Xv),e(An,Zv),e(Ze,eb),e(Ze,ns),w($n,ns,null),e(ns,sb),e(ns,ut),e(ut,tb),e(ut,pr),e(pr,ab),e(ut,nb),e(ut,wd),e(wd,ob),e(ut,rb),e(ns,ib),w(Kt,ns,null),e(ns,lb),e(ns,yd),e(yd,db),e(ns,pb),w(xn,ns,null),c(t,ec,h),c(t,mt,h),e(mt,Yt),e(Yt,kd),w(Cn,kd,null),e(mt,cb),e(mt,jd),e(jd,hb),c(t,sc,h),c(t,es,h),w(Mn,es,null),e(es,ub),e(es,ft),e(ft,mb),e(ft,qd),e(qd,fb),e(ft,gb),e(ft,Ed),e(Ed,_b),e(ft,Tb),e(es,vb),e(es,Pn),e(Pn,bb),e(Pn,cr),e(cr,wb),e(Pn,yb),e(es,kb),e(es,Sn),e(Sn,jb),e(Sn,Dn),e(Dn,qb),e(Sn,Eb),e(es,Fb),e(es,os),w(Nn,os,null),e(os,Ab),e(os,gt),e(gt,zb),e(gt,hr),e(hr,$b),e(gt,xb),e(gt,Fd),e(Fd,Cb),e(gt,Mb),e(os,Pb),w(Jt,os,null),e(os,Sb),e(os,Ad),e(Ad,Db),e(os,Nb),w(Ln,os,null),c(t,tc,h),c(t,_t,h),e(_t,Xt),e(Xt,zd),w(Qn,zd,null),e(_t,Lb),e(_t,$d),e($d,Qb),c(t,ac,h),c(t,Ne,h),w(On,Ne,null),e(Ne,Ob),e(Ne,xd),e(xd,Ib),e(Ne,Wb),e(Ne,In),e(In,Ub),e(In,ur),e(ur,Hb),e(In,Bb),e(Ne,Gb),e(Ne,Wn),e(Wn,Rb),e(Wn,Un),e(Un,Vb),e(Wn,Kb),e(Ne,Yb),w(Zt,Ne,null),e(Ne,Jb),e(Ne,rs),w(Hn,rs,null),e(rs,Xb),e(rs,Tt),e(Tt,Zb),e(Tt,mr),e(mr,ew),e(Tt,sw),e(Tt,Cd),e(Cd,tw),e(Tt,aw),e(rs,nw),w(ea,rs,null),e(rs,ow),e(rs,Md),e(Md,rw),e(rs,iw),w(Bn,rs,null),c(t,nc,h),c(t,vt,h),e(vt,sa),e(sa,Pd),w(Gn,Pd,null),e(vt,lw),e(vt,Sd),e(Sd,dw),c(t,oc,h),c(t,Le,h),w(Rn,Le,null),e(Le,pw),e(Le,Vn),e(Vn,cw),e(Vn,Dd),e(Dd,hw),e(Vn,uw),e(Le,mw),e(Le,Kn),e(Kn,fw),e(Kn,fr),e(fr,gw),e(Kn,_w),e(Le,Tw),e(Le,Yn),e(Yn,vw),e(Yn,Jn),e(Jn,bw),e(Yn,ww),e(Le,yw),w(ta,Le,null),e(Le,kw),e(Le,is),w(Xn,is,null),e(is,jw),e(is,bt),e(bt,qw),e(bt,gr),e(gr,Ew),e(bt,Fw),e(bt,Nd),e(Nd,Aw),e(bt,zw),e(is,$w),w(aa,is,null),e(is,xw),e(is,Ld),e(Ld,Cw),e(is,Mw),w(Zn,is,null),c(t,rc,h),c(t,wt,h),e(wt,na),e(na,Qd),w(eo,Qd,null),e(wt,Pw),e(wt,Od),e(Od,Sw),c(t,ic,h),c(t,Qe,h),w(so,Qe,null),e(Qe,Dw),e(Qe,Id),e(Id,Nw),e(Qe,Lw),e(Qe,to),e(to,Qw),e(to,_r),e(_r,Ow),e(to,Iw),e(Qe,Ww),e(Qe,ao),e(ao,Uw),e(ao,no),e(no,Hw),e(ao,Bw),e(Qe,Gw),w(oa,Qe,null),e(Qe,Rw),e(Qe,ls),w(oo,ls,null),e(ls,Vw),e(ls,yt),e(yt,Kw),e(yt,Tr),e(Tr,Yw),e(yt,Jw),e(yt,Wd),e(Wd,Xw),e(yt,Zw),e(ls,ey),w(ra,ls,null),e(ls,sy),e(ls,Ud),e(Ud,ty),e(ls,ay),w(ro,ls,null),c(t,lc,h),c(t,kt,h),e(kt,ia),e(ia,Hd),w(io,Hd,null),e(kt,ny),e(kt,Bd),e(Bd,oy),c(t,dc,h),c(t,Oe,h),w(lo,Oe,null),e(Oe,ry),e(Oe,jt),e(jt,iy),e(jt,Gd),e(Gd,ly),e(jt,dy),e(jt,Rd),e(Rd,py),e(jt,cy),e(Oe,hy),e(Oe,po),e(po,uy),e(po,vr),e(vr,my),e(po,fy),e(Oe,gy),e(Oe,co),e(co,_y),e(co,ho),e(ho,Ty),e(co,vy),e(Oe,by),w(la,Oe,null),e(Oe,wy),e(Oe,ds),w(uo,ds,null),e(ds,yy),e(ds,qt),e(qt,ky),e(qt,br),e(br,jy),e(qt,qy),e(qt,Vd),e(Vd,Ey),e(qt,Fy),e(ds,Ay),w(da,ds,null),e(ds,zy),e(ds,Kd),e(Kd,$y),e(ds,xy),w(mo,ds,null),pc=!0},p(t,[h]){const fo={};h&2&&(fo.$$scope={dirty:h,ctx:t}),Bt.$set(fo);const Yd={};h&2&&(Yd.$$scope={dirty:h,ctx:t}),Rt.$set(Yd);const Jd={};h&2&&(Jd.$$scope={dirty:h,ctx:t}),Kt.$set(Jd);const Xd={};h&2&&(Xd.$$scope={dirty:h,ctx:t}),Jt.$set(Xd);const go={};h&2&&(go.$$scope={dirty:h,ctx:t}),Zt.$set(go);const Zd={};h&2&&(Zd.$$scope={dirty:h,ctx:t}),ea.$set(Zd);const ep={};h&2&&(ep.$$scope={dirty:h,ctx:t}),ta.$set(ep);const sp={};h&2&&(sp.$$scope={dirty:h,ctx:t}),aa.$set(sp);const _o={};h&2&&(_o.$$scope={dirty:h,ctx:t}),oa.$set(_o);const tp={};h&2&&(tp.$$scope={dirty:h,ctx:t}),ra.$set(tp);const ap={};h&2&&(ap.$$scope={dirty:h,ctx:t}),la.$set(ap);const Et={};h&2&&(Et.$$scope={dirty:h,ctx:t}),da.$set(Et)},i(t){pc||(y(T.$$.fragment,t),y(Z.$$.fragment,t),y(ya.$$.fragment,t),y(Fa.$$.fragment,t),y(Aa.$$.fragment,t),y(La.$$.fragment,t),y(Qa.$$.fragment,t),y(Wa.$$.fragment,t),y(Ua.$$.fragment,t),y(Ha.$$.fragment,t),y(Ra.$$.fragment,t),y(Va.$$.fragment,t),y(Ya.$$.fragment,t),y(Ja.$$.fragment,t),y(en.$$.fragment,t),y(sn.$$.fragment,t),y(tn.$$.fragment,t),y(an.$$.fragment,t),y(nn.$$.fragment,t),y(dn.$$.fragment,t),y(pn.$$.fragment,t),y(_n.$$.fragment,t),y(Bt.$$.fragment,t),y(Tn.$$.fragment,t),y(vn.$$.fragment,t),y(bn.$$.fragment,t),y(kn.$$.fragment,t),y(Rt.$$.fragment,t),y(jn.$$.fragment,t),y(qn.$$.fragment,t),y(En.$$.fragment,t),y($n.$$.fragment,t),y(Kt.$$.fragment,t),y(xn.$$.fragment,t),y(Cn.$$.fragment,t),y(Mn.$$.fragment,t),y(Nn.$$.fragment,t),y(Jt.$$.fragment,t),y(Ln.$$.fragment,t),y(Qn.$$.fragment,t),y(On.$$.fragment,t),y(Zt.$$.fragment,t),y(Hn.$$.fragment,t),y(ea.$$.fragment,t),y(Bn.$$.fragment,t),y(Gn.$$.fragment,t),y(Rn.$$.fragment,t),y(ta.$$.fragment,t),y(Xn.$$.fragment,t),y(aa.$$.fragment,t),y(Zn.$$.fragment,t),y(eo.$$.fragment,t),y(so.$$.fragment,t),y(oa.$$.fragment,t),y(oo.$$.fragment,t),y(ra.$$.fragment,t),y(ro.$$.fragment,t),y(io.$$.fragment,t),y(lo.$$.fragment,t),y(la.$$.fragment,t),y(uo.$$.fragment,t),y(da.$$.fragment,t),y(mo.$$.fragment,t),pc=!0)},o(t){k(T.$$.fragment,t),k(Z.$$.fragment,t),k(ya.$$.fragment,t),k(Fa.$$.fragment,t),k(Aa.$$.fragment,t),k(La.$$.fragment,t),k(Qa.$$.fragment,t),k(Wa.$$.fragment,t),k(Ua.$$.fragment,t),k(Ha.$$.fragment,t),k(Ra.$$.fragment,t),k(Va.$$.fragment,t),k(Ya.$$.fragment,t),k(Ja.$$.fragment,t),k(en.$$.fragment,t),k(sn.$$.fragment,t),k(tn.$$.fragment,t),k(an.$$.fragment,t),k(nn.$$.fragment,t),k(dn.$$.fragment,t),k(pn.$$.fragment,t),k(_n.$$.fragment,t),k(Bt.$$.fragment,t),k(Tn.$$.fragment,t),k(vn.$$.fragment,t),k(bn.$$.fragment,t),k(kn.$$.fragment,t),k(Rt.$$.fragment,t),k(jn.$$.fragment,t),k(qn.$$.fragment,t),k(En.$$.fragment,t),k($n.$$.fragment,t),k(Kt.$$.fragment,t),k(xn.$$.fragment,t),k(Cn.$$.fragment,t),k(Mn.$$.fragment,t),k(Nn.$$.fragment,t),k(Jt.$$.fragment,t),k(Ln.$$.fragment,t),k(Qn.$$.fragment,t),k(On.$$.fragment,t),k(Zt.$$.fragment,t),k(Hn.$$.fragment,t),k(ea.$$.fragment,t),k(Bn.$$.fragment,t),k(Gn.$$.fragment,t),k(Rn.$$.fragment,t),k(ta.$$.fragment,t),k(Xn.$$.fragment,t),k(aa.$$.fragment,t),k(Zn.$$.fragment,t),k(eo.$$.fragment,t),k(so.$$.fragment,t),k(oa.$$.fragment,t),k(oo.$$.fragment,t),k(ra.$$.fragment,t),k(ro.$$.fragment,t),k(io.$$.fragment,t),k(lo.$$.fragment,t),k(la.$$.fragment,t),k(uo.$$.fragment,t),k(da.$$.fragment,t),k(mo.$$.fragment,t),pc=!1},d(t){s(m),t&&s(F),t&&s(f),j(T),t&&s(K),t&&s(z),j(Z),t&&s(ce),t&&s(W),t&&s(x),t&&s(oe),t&&s(he),t&&s(V),t&&s(ue),t&&s(u),t&&s(J),t&&s(Fe),t&&s(S),t&&s(Ae),t&&s(D),t&&s(M),t&&s(np),t&&s(At),t&&s(op),t&&s(zt),t&&s(rp),t&&s(_s),t&&s(ip),t&&s(vo),t&&s(lp),t&&s(Ts),t&&s(dp),t&&s(Ks),j(ya),t&&s(pp),t&&s(xt),t&&s(cp),t&&s(yo),t&&s(hp),t&&s(Ct),t&&s(up),t&&s($s),t&&s(mp),t&&s(jo),t&&s(fp),t&&s(Mt),t&&s(gp),t&&s(xs),t&&s(_p),j(Fa,t),t&&s(Tp),t&&s(Cs),t&&s(vp),j(Aa,t),t&&s(bp),t&&s(Pt),t&&s(wp),t&&s(St),t&&s(yp),t&&s(Fo),t&&s(kp),t&&s(Dt),t&&s(jp),t&&s(ie),t&&s(qp),t&&s(We),t&&s(Ep),t&&s(No),t&&s(Fp),t&&s(ze),t&&s(Ap),t&&s(Nt),t&&s(zp),t&&s(le),t&&s($p),j(La,t),t&&s(xp),t&&s(vs),t&&s(Cp),j(Qa,t),t&&s(Mp),t&&s(X),t&&s(Pp),t&&s(Ho),t&&s(Sp),t&&s(Ms),t&&s(Dp),j(Wa,t),t&&s(Np),t&&s(tt),j(Ua),t&&s(Lp),t&&s(me),t&&s(Qp),t&&s(Qt),t&&s(Op),j(Ha,t),t&&s(Ip),t&&s(Ue),t&&s(Wp),t&&s(at),j(Ra),t&&s(Up),t&&s(nt),j(Va),t&&s(Hp),t&&s(ot),j(Ya),t&&s(Bp),t&&s(Xe),j(Ja),j(en),t&&s(Gp),t&&s(rt),j(sn),t&&s(Rp),t&&s(de),j(tn),j(an),j(nn),t&&s(Vp),t&&s(it),j(dn),t&&s(Kp),t&&s(De),j(pn),j(_n),j(Bt),j(Tn),t&&s(Yp),t&&s(dt),j(vn),t&&s(Jp),t&&s(gs),j(bn),j(kn),j(Rt),j(jn),t&&s(Xp),t&&s(ht),j(qn),t&&s(Zp),t&&s(Ze),j(En),j($n),j(Kt),j(xn),t&&s(ec),t&&s(mt),j(Cn),t&&s(sc),t&&s(es),j(Mn),j(Nn),j(Jt),j(Ln),t&&s(tc),t&&s(_t),j(Qn),t&&s(ac),t&&s(Ne),j(On),j(Zt),j(Hn),j(ea),j(Bn),t&&s(nc),t&&s(vt),j(Gn),t&&s(oc),t&&s(Le),j(Rn),j(ta),j(Xn),j(aa),j(Zn),t&&s(rc),t&&s(wt),j(eo),t&&s(ic),t&&s(Qe),j(so),j(oa),j(oo),j(ra),j(ro),t&&s(lc),t&&s(kt),j(io),t&&s(dc),t&&s(Oe),j(lo),j(la),j(uo),j(da),j(mo)}}}const a4={local:"tapas",sections:[{local:"overview",title:"Overview"},{local:"usage-finetuning",title:"Usage: fine-tuning"},{local:"usage-inference",title:"Usage: inference"},{local:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",title:"TAPAS specific outputs"},{local:"transformers.TapasConfig",title:"TapasConfig"},{local:"transformers.TapasTokenizer",title:"TapasTokenizer"},{local:"transformers.TapasModel",title:"TapasModel"},{local:"transformers.TapasForMaskedLM",title:"TapasForMaskedLM"},{local:"transformers.TapasForSequenceClassification",title:"TapasForSequenceClassification"},{local:"transformers.TapasForQuestionAnswering",title:"TapasForQuestionAnswering"},{local:"transformers.TFTapasModel",title:"TFTapasModel"},{local:"transformers.TFTapasForMaskedLM",title:"TFTapasForMaskedLM"},{local:"transformers.TFTapasForSequenceClassification",title:"TFTapasForSequenceClassification"},{local:"transformers.TFTapasForQuestionAnswering",title:"TFTapasForQuestionAnswering"}],title:"TAPAS"};function n4(U,m,F){let{fw:f}=m;return U.$$set=g=>{"fw"in g&&F(0,f=g.fw)},[f]}class h4 extends Qq{constructor(m){super();Oq(this,m,n4,t4,Iq,{fw:0})}}export{h4 as default,a4 as metadata};
