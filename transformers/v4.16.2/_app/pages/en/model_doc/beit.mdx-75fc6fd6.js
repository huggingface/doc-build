import{S as Fp,i as Ep,s as kp,e as a,k as d,w as _,t as r,L as Ip,c as s,d as t,m as c,a as n,x as v,h as i,b as l,J as e,g as p,y as b,q as w,o as x,B as y}from"../../../chunks/vendor-b1433968.js";import{T as mt}from"../../../chunks/Tip-c3840994.js";import{D as P}from"../../../chunks/Docstring-ff504c58.js";import{C as pt}from"../../../chunks/CodeBlock-a320dbd7.js";import{I as ee}from"../../../chunks/IconCopyLink-7029626d.js";import"../../../chunks/CopyButton-f65cb278.js";function Mp(E){let h,$;return{c(){h=a("p"),$=r(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var u=n(h);$=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var F=n(f);T=i(F,"Module"),F.forEach(t),B=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(g,u){p(g,h,u),e(h,$),e(h,f),e(f,T),e(h,B)},d(g){g&&t(h)}}}function Np(E){let h,$,f,T,B,g,u,F,Qn,Ks,fe,Ne,Ia,ft,er,Ma,tr,Ys,K,or,ut,ar,sr,gt,nr,rr,_t,ir,lr,Zs,Jo,dr,Qs,Xo,ja,cr,en,Go,hr,tn,C,k,mr,Ko,pr,fr,Yo,ur,gr,vt,_r,vr,Zo,br,wr,Qo,xr,yr,ea,Tr,$r,ta,Br,Fr,Er,bt,kr,wt,Ir,Mr,jr,xt,Pr,oa,Cr,zr,Ar,ue,qr,Pa,Lr,Nr,yt,Sr,Or,Dr,ge,Wr,Tt,Vr,Ur,$t,Rr,Hr,Jr,R,Xr,Ca,Gr,Kr,za,Yr,Zr,aa,Qr,ei,Aa,ti,oi,on,Y,ai,Bt,si,ni,Ft,ri,ii,Et,li,di,an,_e,Se,qa,kt,ci,La,hi,sn,ve,It,mi,Mt,pi,sa,fi,ui,nn,be,jt,gi,Pt,_i,na,vi,bi,rn,we,Oe,Na,Ct,wi,Sa,xi,ln,H,zt,yi,xe,Ti,ra,$i,Bi,At,Fi,Ei,ki,Oa,Ii,Mi,qt,dn,ye,De,Da,Lt,ji,Wa,Pi,cn,J,Nt,Ci,Va,zi,Ai,St,qi,ia,Li,Ni,Si,re,Ot,Oi,Ua,Di,Wi,We,hn,Te,Ve,Ra,Dt,Vi,Ha,Ui,mn,te,Wt,Ri,Vt,Hi,Ut,Ji,Xi,Gi,q,Rt,Ki,$e,Yi,la,Zi,Qi,Ja,el,tl,ol,Ue,al,Xa,sl,nl,Ht,pn,Be,Re,Ga,Jt,rl,Ka,il,fn,oe,Xt,ll,Gt,dl,Kt,cl,hl,ml,L,Yt,pl,Fe,fl,da,ul,gl,Ya,_l,vl,bl,He,wl,Za,xl,yl,Zt,un,Ee,Je,Qa,Qt,Tl,es,$l,gn,X,eo,Bl,ts,Fl,El,to,kl,oo,Il,Ml,jl,N,ao,Pl,ke,Cl,ca,zl,Al,os,ql,Ll,Nl,Xe,Sl,as,Ol,Dl,so,_n,Ie,Ge,ss,no,Wl,ns,Vl,vn,G,ro,Ul,rs,Rl,Hl,io,Jl,lo,Xl,Gl,Kl,S,co,Yl,Me,Zl,ha,Ql,ed,is,td,od,ad,Ke,sd,ls,nd,rd,ho,bn,je,Ye,ds,mo,id,cs,ld,wn,I,po,dd,hs,cd,hd,fo,md,ma,pd,fd,ud,uo,gd,go,_d,vd,bd,ms,wd,xd,ae,ps,_o,yd,Td,fs,vo,$d,Bd,us,bo,Fd,Ed,gs,wo,kd,Id,O,xo,Md,Pe,jd,_s,Pd,Cd,vs,zd,Ad,qd,Ze,Ld,bs,Nd,Sd,yo,xn,Ce,Qe,ws,To,Od,xs,Dd,yn,M,$o,Wd,ys,Vd,Ud,Bo,Rd,pa,Hd,Jd,Xd,Fo,Gd,Eo,Kd,Yd,Zd,Ts,Qd,ec,se,$s,ko,tc,oc,Bs,Io,ac,sc,Fs,Mo,nc,rc,Es,jo,ic,lc,z,Po,dc,ze,cc,ks,hc,mc,Is,pc,fc,uc,et,gc,Ae,_c,Ms,vc,bc,js,wc,xc,yc,Ps,Tc,$c,Co,Tn,qe,tt,Cs,zo,Bc,zs,Fc,$n,j,Ao,Ec,As,kc,Ic,qo,Mc,fa,jc,Pc,Cc,Lo,zc,No,Ac,qc,Lc,qs,Nc,Sc,ne,Ls,So,Oc,Dc,Ns,Oo,Wc,Vc,Ss,Do,Uc,Rc,Os,Wo,Hc,Jc,D,Vo,Xc,Le,Gc,Ds,Kc,Yc,Ws,Zc,Qc,eh,ot,th,Vs,oh,ah,Uo,Bn;return g=new ee({}),ft=new ee({}),kt=new ee({}),It=new P({props:{name:"class transformers.models.beit.modeling\\_beit.BeitModelOutputWithPooling",anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",parameters:[{name:"last_hidden_state",val:": FloatTensor = None"},{name:"pooler_output",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/beit/modeling_beit.py#L47",parametersDescription:[{anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/v4.16.2/en/model_doc/beit#transformers.models.beit.modeling_beit.BeitModelOutputWithPooling"
>transformers.models.beit.modeling_beit.BeitModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.16.2/en/model_doc/beit#transformers.BeitConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = feature_extractor(images=image, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Qt=new ee({}),eo=new P({props:{name:"class transformers.BeitForImageClassification",anchor:"transformers.BeitForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/beit/modeling_beit.py#L802",parametersDescription:[{anchor:"transformers.BeitForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.16.2/en/model_doc/beit#transformers.BeitConfig">BeitConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ao=new P({props:{name:"forward",anchor:"transformers.BeitForImageClassification.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/models/beit/modeling_beit.py#L815",parametersDescription:[{anchor:"transformers.BeitForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.16.2/en/model_doc/beit#transformers.BeitFeatureExtractor">BeitFeatureExtractor</a>. See
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model predicts one of the 1000 ImageNet classes</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_idx = logits.argmax(-<span class="hljs-number">1</span>).item()
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])`}}),{c(){h=a("meta"),$=d(),f=a("h1"),T=a("a"),B=a("span"),_(g.$$.fragment),u=d(),F=a("span"),Qn=r("BEiT"),Ks=d(),fe=a("h2"),Ne=a("a"),Ia=a("span"),_(ft.$$.fragment),er=d(),Ma=a("span"),tr=r("Overview"),Ys=d(),K=a("p"),or=r("The BEiT model was proposed in "),ut=a("a"),ar=r("BEiT: BERT Pre-Training of Image Transformers"),sr=r(` by
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),yt=a("a"),Sr=r("hub"),Or=r("."),Dr=d(),ge=a("li"),Wr=r("The available checkpoints are either (1) pre-trained on "),Tt=a("a"),Vr=r("ImageNet-22k"),Ur=r(` (a collection of
...
contributed by `),Ft=a("a"),ri=r("kamalkraj"),ii=r(". The original code can be found "),Et=a("a"),li=r("here"),di=r("."),an=d(),_e=a("h2"),Se=a("a"),qa=a("span"),_(kt.$$.fragment),ci=d(),La=a("span"),hi=r("BEiT specific outputs"),sn=d(),ve=a("div"),_(It.$$.fragment),mi=d(),Mt=a("p"),pi=r("Class for outputs of "),sa=a("a"),fi=r("BeitModel"),ui=r("."),nn=d(),be=a("div"),_(jt.$$.fragment),gi=d(),Pt=a("p"),_i=r("Class for outputs of "),na=a("a"),vi=r("FlaxBeitModel"),bi=r("."),rn=d(),we=a("h2"),Oe=a("a"),Na=a("span"),_(Ct.$$.fragment),wi=d(),Sa=a("span"),xi=r("BeitConfig"),ln=d(),H=a("div"),_(zt.$$.fragment),yi=d(),xe=a("p"),Ti=r("This is the configuration class to store the configuration of a "),ra=a("a"),$i=r("BeitModel"),Bi=r(`. It is used to instantiate an BEiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BEiT
`),At=a("a"),Fi=r("microsoft/beit-base-patch16-224-in22k"),Ei=r(" architecture."),ki=d(),Oa=a("p"),Ii=r("Example:"),Mi=d(),_(qt.$$.fragment),dn=d(),ye=a("h2"),De=a("a"),Da=a("span"),_(Lt.$$.fragment),ji=d(),Wa=a("span"),Pi=r("BeitFeatureExtractor"),cn=d(),J=a("div"),_(Nt.$$.fragment),Ci=d(),Va=a("p"),zi=r("Constructs a BEiT feature extractor."),Ai=d(),St=a("p"),qi=r("This feature extractor inherits from "),ia=a("a"),Li=r("FeatureExtractionMixin"),Ni=r(` which contains most of
...
behavior.`),Gi=d(),q=a("div"),_(Rt.$$.fragment),Ki=d(),$e=a("p"),Yi=r("The "),la=a("a"),Zi=r("BeitModel"),Qi=r(" forward method, overrides the "),Ja=a("code"),el=r("__call__"),tl=r(" special method."),ol=d(),_(Ue.$$.fragment),al=d(),Xa=a("p"),sl=r("Examples:"),nl=d(),_(Ht.$$.fragment),pn=d(),Be=a("h2"),Re=a("a"),Ga=a("span"),_(Jt.$$.fragment),rl=d(),Ka=a("span"),il=r("BeitForMaskedImageModeling"),fn=d(),oe=a("div"),_(Xt.$$.fragment),ll=d(),Gt=a("p"),dl=r(`Beit Model transformer with a \u2018language\u2019 modeling head on top (to predict visual tokens).
This model is a PyTorch `),Kt=a("a"),cl=r("torch.nn.Module"),hl=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ml=d(),L=a("div"),_(Yt.$$.fragment),pl=d(),Fe=a("p"),fl=r("The "),da=a("a"),ul=r("BeitForMaskedImageModeling"),gl=r(" forward method, overrides the "),Ya=a("code"),_l=r("__call__"),vl=r(" special method."),bl=d(),_(He.$$.fragment),wl=d(),Za=a("p"),xl=r("Examples:"),yl=d(),_(Zt.$$.fragment),un=d(),Ee=a("h2"),Je=a("a"),Qa=a("span"),_(Qt.$$.fragment),Tl=d(),es=a("span"),$l=r("BeitForImageClassification"),gn=d(),X=a("div"),_(eo.$$.fragment),Bl=d(),ts=a("p"),Fl=r(`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
hidden states of the patch tokens) e.g. for ImageNet.`),El=d(),to=a("p"),kl=r("This model is a PyTorch "),oo=a("a"),Il=r("torch.nn.Module"),Ml=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jl=d(),N=a("div"),_(ao.$$.fragment),Pl=d(),ke=a("p"),Cl=r("The "),ca=a("a"),zl=r("BeitForImageClassification"),Al=r(" forward method, overrides the "),os=a("code"),ql=r("__call__"),Ll=r(" special method."),Nl=d(),_(Xe.$$.fragment),Sl=d(),as=a("p"),Ol=r("Examples:"),Dl=d(),_(so.$$.fragment),_n=d(),Ie=a("h2"),Ge=a("a"),ss=a("span"),_(no.$$.fragment),Wl=d(),ns=a("span"),Vl=r("BeitForSemanticSegmentation"),vn=d(),G=a("div"),_(ro.$$.fragment),Ul=d(),rs=a("p"),Rl=r("Beit Model transformer with a semantic segmentation head on top e.g. for ADE20k, CityScapes."),Hl=d(),io=a("p"),Jl=r("This model is a PyTorch "),lo=a("a"),Xl=r("torch.nn.Module"),Gl=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Kl=d(),S=a("div"),_(co.$$.fragment),Yl=d(),Me=a("p"),Zl=r("The "),ha=a("a"),Ql=r("BeitForSemanticSegmentation"),ed=r(" forward method, overrides the "),is=a("code"),td=r("__call__"),od=r(" special method."),ad=d(),_(Ke.$$.fragment),sd=d(),ls=a("p"),nd=r("Examples:"),rd=d(),_(ho.$$.fragment),bn=d(),je=a("h2"),Ye=a("a"),ds=a("span"),_(mo.$$.fragment),id=d(),cs=a("span"),ld=r("FlaxBeitModel"),wn=d(),I=a("div"),_(po.$$.fragment),dd=d(),hs=a("p"),cd=r("The bare Beit Model transformer outputting raw hidden-states without any specific head on top."),hd=d(),fo=a("p"),md=r("This model inherits from "),ma=a("a"),pd=r("FlaxPreTrainedModel"),fd=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),bd=d(),ms=a("p"),wd=r("Finally, this model supports inherent JAX features such as:"),xd=d(),ae=a("ul"),ps=a("li"),_o=a("a"),yd=r("Just-In-Time (JIT) compilation"),Td=d(),fs=a("li"),vo=a("a"),$d=r("Automatic Differentiation"),Bd=d(),us=a("li"),bo=a("a"),Fd=r("Vectorization"),Ed=d(),gs=a("li"),wo=a("a"),kd=r("Parallelization"),Id=d(),O=a("div"),_(xo.$$.fragment),Md=d(),Pe=a("p"),jd=r("The "),_s=a("code"),Pd=r("FlaxBeitPreTrainedModel"),Cd=r("forward method, overrides the "),vs=a("code"),zd=r("__call__"),Ad=r(" special method."),qd=d(),_(Ze.$$.fragment),Ld=d(),bs=a("p"),Nd=r("Examples:"),Sd=d(),_(yo.$$.fragment),xn=d(),Ce=a("h2"),Qe=a("a"),ws=a("span"),_(To.$$.fragment),Od=d(),xs=a("span"),Dd=r("FlaxBeitForMaskedImageModeling"),yn=d(),M=a("div"),_($o.$$.fragment),Wd=d(),ys=a("p"),Vd=r("Beit Model transformer with a \u2018language\u2019 modeling head on top (to predict visual tokens)."),Ud=d(),Bo=a("p"),Rd=r("This model inherits from "),pa=a("a"),Hd=r("FlaxPreTrainedModel"),Jd=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zd=d(),Ts=a("p"),Qd=r("Finally, this model supports inherent JAX features such as:"),ec=d(),se=a("ul"),$s=a("li"),ko=a("a"),tc=r("Just-In-Time (JIT) compilation"),oc=d(),Bs=a("li"),Io=a("a"),ac=r("Automatic Differentiation"),sc=d(),Fs=a("li"),Mo=a("a"),nc=r("Vectorization"),rc=d(),Es=a("li"),jo=a("a"),ic=r("Parallelization"),lc=d(),z=a("div"),_(Po.$$.fragment),dc=d(),ze=a("p"),cc=r("The "),ks=a("code"),hc=r("FlaxBeitPreTrainedModel"),mc=r("forward method, overrides the "),Is=a("code"),pc=r("__call__"),fc=r(" special method."),uc=d(),_(et.$$.fragment),gc=d(),Ae=a("p"),_c=r("bool_masked_pos ("),Ms=a("code"),vc=r("numpy.ndarray"),bc=r(" of shape "),js=a("code"),wc=r("(batch_size, num_patches)"),xc=r(`):
...
performing masked image modeling. You can find it `),wt=s(Fn,"A",{href:!0,rel:!0});var vh=n(wt);Ir=i(vh,"here"),vh.forEach(t),Mr=i(Fn,"."),Fn.forEach(t),jr=c(Z),xt=s(Z,"LI",{});var En=n(xt);Pr=i(En,`As the BEiT models expect each image to be of the same size (resolution), one can use
`),oa=s(En,"A",{href:!0});var bh=n(oa);Cr=i(bh,"BeitFeatureExtractor"),bh.forEach(t),zr=i(En," to resize (or rescale) and normalize images for the model."),En.forEach(t),Ar=c(Z),ue=s(Z,"LI",{});var ua=n(ue);qr=i(ua,`Both the patch resolution and image resolution used during pre-training or fine-tuning are reflected in the name of
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),yt=s(ua,"A",{href:!0,rel:!0});var xh=n(yt);Sr=i(xh,"hub"),xh.forEach(t),Or=i(ua,"."),ua.forEach(t),Dr=c(Z),ge=s(Z,"LI",{});var ga=n(ge);Wr=i(ga,"The available checkpoints are either (1) pre-trained on "),Tt=s(ga,"A",{href:!0,rel:!0});var yh=n(Tt);Vr=i(yh,"ImageNet-22k"),yh.forEach(t),Ur=i(ga,` (a collection of
...
contributed by `),Ft=s(st,"A",{href:!0,rel:!0});var Ih=n(Ft);ri=i(Ih,"kamalkraj"),Ih.forEach(t),ii=i(st,". The original code can be found "),Et=s(st,"A",{href:!0,rel:!0});var Mh=n(Et);li=i(Mh,"here"),Mh.forEach(t),di=i(st,"."),st.forEach(t),an=c(o),_e=s(o,"H2",{class:!0});var kn=n(_e);Se=s(kn,"A",{id:!0,class:!0,href:!0});var jh=n(Se);qa=s(jh,"SPAN",{});var Ph=n(qa);v(kt.$$.fragment,Ph),Ph.forEach(t),jh.forEach(t),ci=c(kn),La=s(kn,"SPAN",{});var Ch=n(La);hi=i(Ch,"BEiT specific outputs"),Ch.forEach(t),kn.forEach(t),sn=c(o),ve=s(o,"DIV",{class:!0});var In=n(ve);v(It.$$.fragment,In),mi=c(In),Mt=s(In,"P",{});var Mn=n(Mt);pi=i(Mn,"Class for outputs of "),sa=s(Mn,"A",{href:!0});var zh=n(sa);fi=i(zh,"BeitModel"),zh.forEach(t),ui=i(Mn,"."),Mn.forEach(t),In.forEach(t),nn=c(o),be=s(o,"DIV",{class:!0});var jn=n(be);v(jt.$$.fragment,jn),gi=c(jn),Pt=s(jn,"P",{});var Pn=n(Pt);_i=i(Pn,"Class for outputs of "),na=s(Pn,"A",{href:!0});var Ah=n(na);vi=i(Ah,"FlaxBeitModel"),Ah.forEach(t),bi=i(Pn,"."),Pn.forEach(t),jn.forEach(t),rn=c(o),we=s(o,"H2",{class:!0});var Cn=n(we);Oe=s(Cn,"A",{id:!0,class:!0,href:!0});var qh=n(Oe);Na=s(qh,"SPAN",{});var Lh=n(Na);v(Ct.$$.fragment,Lh),Lh.forEach(t),qh.forEach(t),wi=c(Cn),Sa=s(Cn,"SPAN",{});var Nh=n(Sa);xi=i(Nh,"BeitConfig"),Nh.forEach(t),Cn.forEach(t),ln=c(o),H=s(o,"DIV",{class:!0});var nt=n(H);v(zt.$$.fragment,nt),yi=c(nt),xe=s(nt,"P",{});var _a=n(xe);Ti=i(_a,"This is the configuration class to store the configuration of a "),ra=s(_a,"A",{href:!0});var Sh=n(ra);$i=i(Sh,"BeitModel"),Sh.forEach(t),Bi=i(_a,`. It is used to instantiate an BEiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BEiT
`),At=s(_a,"A",{href:!0,rel:!0});var Oh=n(At);Fi=i(Oh,"microsoft/beit-base-patch16-224-in22k"),Oh.forEach(t),Ei=i(_a," architecture."),_a.forEach(t),ki=c(nt),Oa=s(nt,"P",{});var Dh=n(Oa);Ii=i(Dh,"Example:"),Dh.forEach(t),Mi=c(nt),v(qt.$$.fragment,nt),nt.forEach(t),dn=c(o),ye=s(o,"H2",{class:!0});var zn=n(ye);De=s(zn,"A",{id:!0,class:!0,href:!0});var Wh=n(De);Da=s(Wh,"SPAN",{});var Vh=n(Da);v(Lt.$$.fragment,Vh),Vh.forEach(t),Wh.forEach(t),ji=c(zn),Wa=s(zn,"SPAN",{});var Uh=n(Wa);Pi=i(Uh,"BeitFeatureExtractor"),Uh.forEach(t),zn.forEach(t),cn=c(o),J=s(o,"DIV",{class:!0});var rt=n(J);v(Nt.$$.fragment,rt),Ci=c(rt),Va=s(rt,"P",{});var Rh=n(Va);zi=i(Rh,"Constructs a BEiT feature extractor."),Rh.forEach(t),Ai=c(rt),St=s(rt,"P",{});var An=n(St);qi=i(An,"This feature extractor inherits from "),ia=s(An,"A",{href:!0});var Hh=n(ia);Li=i(Hh,"FeatureExtractionMixin"),Hh.forEach(t),Ni=i(An,` which contains most of
the main methods. Users should refer to this superclass for more information regarding those methods.`),An.forEach(t),Si=c(rt),re=s(rt,"DIV",{class:!0});var va=n(re);v(Ot.$$.fragment,va),Oi=c(va),Ua=s(va,"P",{});var Jh=n(Ua);Di=i(Jh,"Main method to prepare for the model one or several image(s)."),Jh.forEach(t),Wi=c(va),v(We.$$.fragment,va),va.forEach(t),rt.forEach(t),hn=c(o),Te=s(o,"H2",{class:!0});var qn=n(Te);Ve=s(qn,"A",{id:!0,class:!0,href:!0});var Xh=n(Ve);Ra=s(Xh,"SPAN",{});var Gh=n(Ra);v(Dt.$$.fragment,Gh),Gh.forEach(t),Xh.forEach(t),Vi=c(qn),Ha=s(qn,"SPAN",{});var Kh=n(Ha);Ui=i(Kh,"BeitModel"),Kh.forEach(t),qn.forEach(t),mn=c(o),te=s(o,"DIV",{class:!0});var ba=n(te);v(Wt.$$.fragment,ba),Ri=c(ba),Vt=s(ba,"P",{});var Ln=n(Vt);Hi=i(Ln,`The bare Beit Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Ut=s(Ln,"A",{href:!0,rel:!0});var Yh=n(Ut);Ji=i(Yh,"torch.nn.Module"),Yh.forEach(t),Xi=i(Ln,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ln.forEach(t),Gi=c(ba),q=s(ba,"DIV",{class:!0});var le=n(q);v(Rt.$$.fragment,le),Ki=c(le),$e=s(le,"P",{});var wa=n($e);Yi=i(wa,"The "),la=s(wa,"A",{href:!0});var Zh=n(la);Zi=i(Zh,"BeitModel"),Zh.forEach(t),Qi=i(wa," forward method, overrides the "),Ja=s(wa,"CODE",{});var Qh=n(Ja);el=i(Qh,"__call__"),Qh.forEach(t),tl=i(wa," special method."),wa.forEach(t),ol=c(le),v(Ue.$$.fragment,le),al=c(le),Xa=s(le,"P",{});var em=n(Xa);sl=i(em,"Examples:"),em.forEach(t),nl=c(le),v(Ht.$$.fragment,le),le.forEach(t),ba.forEach(t),pn=c(o),Be=s(o,"H2",{class:!0});var Nn=n(Be);Re=s(Nn,"A",{id:!0,class:!0,href:!0});var tm=n(Re);Ga=s(tm,"SPAN",{});var om=n(Ga);v(Jt.$$.fragment,om),om.forEach(t),tm.forEach(t),rl=c(Nn),Ka=s(Nn,"SPAN",{});var am=n(Ka);il=i(am,"BeitForMaskedImageModeling"),am.forEach(t),Nn.forEach(t),fn=c(o),oe=s(o,"DIV",{class:!0});var xa=n(oe);v(Xt.$$.fragment,xa),ll=c(xa),Gt=s(xa,"P",{});var Sn=n(Gt);dl=i(Sn,`Beit Model transformer with a \u2018language\u2019 modeling head on top (to predict visual tokens).
This model is a PyTorch `),Kt=s(Sn,"A",{href:!0,rel:!0});var sm=n(Kt);cl=i(sm,"torch.nn.Module"),sm.forEach(t),hl=i(Sn,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Sn.forEach(t),ml=c(xa),L=s(xa,"DIV",{class:!0});var de=n(L);v(Yt.$$.fragment,de),pl=c(de),Fe=s(de,"P",{});var ya=n(Fe);fl=i(ya,"The "),da=s(ya,"A",{href:!0});var nm=n(da);ul=i(nm,"BeitForMaskedImageModeling"),nm.forEach(t),gl=i(ya," forward method, overrides the "),Ya=s(ya,"CODE",{});var rm=n(Ya);_l=i(rm,"__call__"),rm.forEach(t),vl=i(ya," special method."),ya.forEach(t),bl=c(de),v(He.$$.fragment,de),wl=c(de),Za=s(de,"P",{});var im=n(Za);xl=i(im,"Examples:"),im.forEach(t),yl=c(de),v(Zt.$$.fragment,de),de.forEach(t),xa.forEach(t),un=c(o),Ee=s(o,"H2",{class:!0});var On=n(Ee);Je=s(On,"A",{id:!0,class:!0,href:!0});var lm=n(Je);Qa=s(lm,"SPAN",{});var dm=n(Qa);v(Qt.$$.fragment,dm),dm.forEach(t),lm.forEach(t),Tl=c(On),es=s(On,"SPAN",{});var cm=n(es);$l=i(cm,"BeitForImageClassification"),cm.forEach(t),On.forEach(t),gn=c(o),X=s(o,"DIV",{class:!0});var it=n(X);v(eo.$$.fragment,it),Bl=c(it),ts=s(it,"P",{});var hm=n(ts);Fl=i(hm,`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
hidden states of the patch tokens) e.g. for ImageNet.`),hm.forEach(t),El=c(it),to=s(it,"P",{});var Dn=n(to);kl=i(Dn,"This model is a PyTorch "),oo=s(Dn,"A",{href:!0,rel:!0});var mm=n(oo);Il=i(mm,"torch.nn.Module"),mm.forEach(t),Ml=i(Dn,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dn.forEach(t),jl=c(it),N=s(it,"DIV",{class:!0});var ce=n(N);v(ao.$$.fragment,ce),Pl=c(ce),ke=s(ce,"P",{});var Ta=n(ke);Cl=i(Ta,"The "),ca=s(Ta,"A",{href:!0});var pm=n(ca);zl=i(pm,"BeitForImageClassification"),pm.forEach(t),Al=i(Ta," forward method, overrides the "),os=s(Ta,"CODE",{});var fm=n(os);ql=i(fm,"__call__"),fm.forEach(t),Ll=i(Ta," special method."),Ta.forEach(t),Nl=c(ce),v(Xe.$$.fragment,ce),Sl=c(ce),as=s(ce,"P",{});var um=n(as);Ol=i(um,"Examples:"),um.forEach(t),Dl=c(ce),v(so.$$.fragment,ce),ce.forEach(t),it.forEach(t),_n=c(o),Ie=s(o,"H2",{class:!0});var Wn=n(Ie);Ge=s(Wn,"A",{id:!0,class:!0,href:!0});var gm=n(Ge);ss=s(gm,"SPAN",{});var _m=n(ss);v(no.$$.fragment,_m),_m.forEach(t),gm.forEach(t),Wl=c(Wn),ns=s(Wn,"SPAN",{});var vm=n(ns);Vl=i(vm,"BeitForSemanticSegmentation"),vm.forEach(t),Wn.forEach(t),vn=c(o),G=s(o,"DIV",{class:!0});var lt=n(G);v(ro.$$.fragment,lt),Ul=c(lt),rs=s(lt,"P",{});var bm=n(rs);Rl=i(bm,"Beit Model transformer with a semantic segmentation head on top e.g. for ADE20k, CityScapes."),bm.forEach(t),Hl=c(lt),io=s(lt,"P",{});var Vn=n(io);Jl=i(Vn,"This model is a PyTorch "),lo=s(Vn,"A",{href:!0,rel:!0});var wm=n(lo);Xl=i(wm,"torch.nn.Module"),wm.forEach(t),Gl=i(Vn,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Vn.forEach(t),Kl=c(lt),S=s(lt,"DIV",{class:!0});var he=n(S);v(co.$$.fragment,he),Yl=c(he),Me=s(he,"P",{});var $a=n(Me);Zl=i($a,"The "),ha=s($a,"A",{href:!0});var xm=n(ha);Ql=i(xm,"BeitForSemanticSegmentation"),xm.forEach(t),ed=i($a," forward method, overrides the "),is=s($a,"CODE",{});var ym=n(is);td=i(ym,"__call__"),ym.forEach(t),od=i($a," special method."),$a.forEach(t),ad=c(he),v(Ke.$$.fragment,he),sd=c(he),ls=s(he,"P",{});var Tm=n(ls);nd=i(Tm,"Examples:"),Tm.forEach(t),rd=c(he),v(ho.$$.fragment,he),he.forEach(t),lt.forEach(t),bn=c(o),je=s(o,"H2",{class:!0});var Un=n(je);Ye=s(Un,"A",{id:!0,class:!0,href:!0});var $m=n(Ye);ds=s($m,"SPAN",{});var Bm=n(ds);v(mo.$$.fragment,Bm),Bm.forEach(t),$m.forEach(t),id=c(Un),cs=s(Un,"SPAN",{});var Fm=n(cs);ld=i(Fm,"FlaxBeitModel"),Fm.forEach(t),Un.forEach(t),wn=c(o),I=s(o,"DIV",{class:!0});var W=n(I);v(po.$$.fragment,W),dd=c(W),hs=s(W,"P",{});var Em=n(hs);cd=i(Em,"The bare Beit Model transformer outputting raw hidden-states without any specific head on top."),Em.forEach(t),hd=c(W),fo=s(W,"P",{});var Rn=n(fo);md=i(Rn,"This model inherits from "),ma=s(Rn,"A",{href:!0});var km=n(ma);pd=i(km,"FlaxPreTrainedModel"),km.forEach(t),fd=i(Rn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Rn.forEach(t),ud=c(W),uo=s(W,"P",{});var Hn=n(uo);gd=i(Hn,"This model is also a Flax Linen "),go=s(Hn,"A",{href:!0,rel:!0});var Im=n(go);_d=i(Im,"flax.linen.Module"),Im.forEach(t),vd=i(Hn,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Hn.forEach(t),bd=c(W),ms=s(W,"P",{});var Mm=n(ms);wd=i(Mm,"Finally, this model supports inherent JAX features such as:"),Mm.forEach(t),xd=c(W),ae=s(W,"UL",{});var dt=n(ae);ps=s(dt,"LI",{});var jm=n(ps);_o=s(jm,"A",{href:!0,rel:!0});var Pm=n(_o);yd=i(Pm,"Just-In-Time (JIT) compilation"),Pm.forEach(t),jm.forEach(t),Td=c(dt),fs=s(dt,"LI",{});var Cm=n(fs);vo=s(Cm,"A",{href:!0,rel:!0});var zm=n(vo);$d=i(zm,"Automatic Differentiation"),zm.forEach(t),Cm.forEach(t),Bd=c(dt),us=s(dt,"LI",{});var Am=n(us);bo=s(Am,"A",{href:!0,rel:!0});var qm=n(bo);Fd=i(qm,"Vectorization"),qm.forEach(t),Am.forEach(t),Ed=c(dt),gs=s(dt,"LI",{});var Lm=n(gs);wo=s(Lm,"A",{href:!0,rel:!0});var Nm=n(wo);kd=i(Nm,"Parallelization"),Nm.forEach(t),Lm.forEach(t),dt.forEach(t),Id=c(W),O=s(W,"DIV",{class:!0});var me=n(O);v(xo.$$.fragment,me),Md=c(me),Pe=s(me,"P",{});var Ba=n(Pe);jd=i(Ba,"The "),_s=s(Ba,"CODE",{});var Sm=n(_s);Pd=i(Sm,"FlaxBeitPreTrainedModel"),Sm.forEach(t),Cd=i(Ba,"forward method, overrides the "),vs=s(Ba,"CODE",{});var Om=n(vs);zd=i(Om,"__call__"),Om.forEach(t),Ad=i(Ba," special method."),Ba.forEach(t),qd=c(me),v(Ze.$$.fragment,me),Ld=c(me),bs=s(me,"P",{});var Dm=n(bs);Nd=i(Dm,"Examples:"),Dm.forEach(t),Sd=c(me),v(yo.$$.fragment,me),me.forEach(t),W.forEach(t),xn=c(o),Ce=s(o,"H2",{class:!0});var Jn=n(Ce);Qe=s(Jn,"A",{id:!0,class:!0,href:!0});var Wm=n(Qe);ws=s(Wm,"SPAN",{});var Vm=n(ws);v(To.$$.fragment,Vm),Vm.forEach(t),Wm.forEach(t),Od=c(Jn),xs=s(Jn,"SPAN",{});var Um=n(xs);Dd=i(Um,"FlaxBeitForMaskedImageModeling"),Um.forEach(t),Jn.forEach(t),yn=c(o),M=s(o,"DIV",{class:!0});var V=n(M);v($o.$$.fragment,V),Wd=c(V),ys=s(V,"P",{});var Rm=n(ys);Vd=i(Rm,"Beit Model transformer with a \u2018language\u2019 modeling head on top (to predict visual tokens)."),Rm.forEach(t),Ud=c(V),Bo=s(V,"P",{});var Xn=n(Bo);Rd=i(Xn,"This model inherits from "),pa=s(Xn,"A",{href:!0});var Hm=n(pa);Hd=i(Hm,"FlaxPreTrainedModel"),Hm.forEach(t),Jd=i(Xn,`. Check the superclass documentation for the generic methods the
...
Boolean masked positions. Indicates which patches are masked (1) and which aren\u2019t (0).`),Ea.forEach(t),yc=c(Q),Ps=s(Q,"P",{});var ip=n(Ps);Tc=i(ip,"Examples:"),ip.forEach(t),$c=c(Q),v(Co.$$.fragment,Q),Q.forEach(t),V.forEach(t),Tn=c(o),qe=s(o,"H2",{class:!0});var Kn=n(qe);tt=s(Kn,"A",{id:!0,class:!0,href:!0});var lp=n(tt);Cs=s(lp,"SPAN",{});var dp=n(Cs);v(zo.$$.fragment,dp),dp.forEach(t),lp.forEach(t),Bc=c(Kn),zs=s(Kn,"SPAN",{});var cp=n(zs);Fc=i(cp,"FlaxBeitForImageClassification"),cp.forEach(t),Kn.forEach(t),$n=c(o),j=s(o,"DIV",{class:!0});var U=n(j);v(Ao.$$.fragment,U),Ec=c(U),As=s(U,"P",{});var hp=n(As);kc=i(hp,`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
hidden states of the patch tokens) e.g. for ImageNet.`),hp.forEach(t),Ic=c(U),qo=s(U,"P",{});var Yn=n(qo);Mc=i(Yn,"This model inherits from "),fa=s(Yn,"A",{href:!0});var mp=n(fa);jc=i(mp,"FlaxPreTrainedModel"),mp.forEach(t),Pc=i(Yn,`. Check the superclass documentation for the generic methods the
