...
`}}),qt=new v({props:{name:"convert\\_tokens\\_to\\_ids",anchor:"transformers.PreTrainedTokenizer.convert_tokens_to_ids",parameters:[{name:"tokens",val:": typing.Union[str, typing.List[str]]"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils.py#L560",parametersDescription:[{anchor:"transformers.PreTrainedTokenizer.convert_tokens_to_ids.tokens",description:"<strong>tokens</strong> (<code>str</code> or <code>List[str]</code>) &#x2014; One or several token(s) to convert to token id(s).",name:"tokens"}],returnDescription:`
<p>The token id or list of token ids.</p>
`,returnType:`
<p><code>int</code> or <code>List[int]</code></p>
`}}),Dt=new v({props:{name:"get\\_added\\_vocab",anchor:"transformers.PreTrainedTokenizer.get_added_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils.py#L369",returnDescription:`
<p>The added tokens.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
`}}),It=new v({props:{name:"num\\_special\\_tokens\\_to\\_add",anchor:"transformers.PreTrainedTokenizer.num_special_tokens_to_add",parameters:[{name:"pair",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils.py#L458",parametersDescription:[{anchor:"transformers.PreTrainedTokenizer.num_special_tokens_to_add.pair",description:`<strong>pair</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether the number of added tokens should be computed in the case of a sequence pair or a single
sequence.`,name:"pair"}],returnDescription:`
<p>Number of special tokens added to sequences.</p>
`,returnType:`
<p><code>int</code></p>
`}}),Ge=new Tv({props:{$$slots:{default:[Pv]},$$scope:{ctx:pt}}}),Lt=new v({props:{name:"prepare\\_for\\_tokenization",anchor:"transformers.PreTrainedTokenizer.prepare_for_tokenization",parameters:[{name:"text",val:": str"},{name:"is_split_into_words",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils.py#L819",parametersDescription:[{anchor:"transformers.PreTrainedTokenizer.prepare_for_tokenization.text",description:`<strong>text</strong> (<code>str</code>) &#x2014;
...
`}}),Bt=new v({props:{name:"tokenize",anchor:"transformers.PreTrainedTokenizer.tokenize",parameters:[{name:"text",val:": str"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils.py#L481",parametersDescription:[{anchor:"transformers.PreTrainedTokenizer.tokenize.text",description:`<strong>text</strong> (<code>str</code>) &#x2014;
...
`,returnType:`
<p><code>int</code> or <code>List[int]</code></p>
`}}),an=new v({props:{name:"convert\\_to\\_tensors",anchor:"transformers.BatchEncoding.convert_to_tensors",parameters:[{name:"tensor_type",val:": typing.Union[str, transformers.file_utils.TensorType, NoneType] = None"},{name:"prepend_batch_axis",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils_base.py#L647",parametersDescription:[{anchor:"transformers.BatchEncoding.convert_to_tensors.tensor_type",description:`<strong>tensor_type</strong> (<code>str</code> or <a href="/docs/transformers/v4.16.2/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
...
Whether or not to add the batch dimension during the conversion.`,name:"prepend_batch_axis"}]}}),sn=new v({props:{name:"sequence\\_ids",anchor:"transformers.BatchEncoding.sequence_ids",parameters:[{name:"batch_index",val:": int = 0"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils_base.py#L300",parametersDescription:[{anchor:"transformers.BatchEncoding.sequence_ids.batch_index",description:"<strong>batch_index</strong> (<code>int</code>, <em>optional</em>, defaults to 0) &#x2014; The index to access in the batch.",name:"batch_index"}],returnDescription:`
...
`}}),dn=new v({props:{name:"to",anchor:"transformers.BatchEncoding.to",parameters:[{name:"device",val:": typing.Union[str, ForwardRef('torch.device')]"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils_base.py#L730",parametersDescription:[{anchor:"transformers.BatchEncoding.to.device",description:"<strong>device</strong> (<code>str</code> or <code>torch.device</code>) &#x2014; The device to put the tensors on.",name:"device"}],returnDescription:`
<p>The same instance after modification.</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.16.2/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ln=new v({props:{name:"token\\_to\\_chars",anchor:"transformers.BatchEncoding.token_to_chars",parameters:[{name:"batch_or_token_index",val:": int"},{name:"token_index",val:": typing.Optional[int] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils_base.py#L486",parametersDescription:[{anchor:"transformers.BatchEncoding.token_to_chars.batch_or_token_index",description:`<strong>batch_or_token_index</strong> (<code>int</code>) &#x2014;
Index of the sequence in the batch. If the batch only comprise one sequence, this can be the index of
...
or 1) the provided word index belongs to.`,name:"sequence_index"}],returnDescription:`
<p>Optional <a
  href="/docs/transformers/v4.16.2/en/internal/tokenization_utils#transformers.TokenSpan"
>TokenSpan</a> Span of tokens in the encoded sequence. Returns <code>None</code> if
no tokens correspond to the word.</p>
`}}),$n=new v({props:{name:"words",anchor:"transformers.BatchEncoding.words",parameters:[{name:"batch_index",val:": int = 0"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/tokenization_utils_base.py#L321",parametersDescription:[{anchor:"transformers.BatchEncoding.words.batch_index",description:"<strong>batch_index</strong> (<code>int</code>, <em>optional</em>, defaults to 0) &#x2014; The index to access in the batch.",name:"batch_index"}],returnDescription:`
<p>A list indicating the word corresponding to each token. Special tokens added by the
tokenizer are mapped to <code>None</code> and other tokens are mapped to the index of their corresponding word
(several tokens will be mapped to the same word index if they are parts of that word).</p>
`,returnType:`
<p><code>List[Optional[int]]</code></p>
`}}),{c(){E=r("meta"),C=d(),$=r("h1"),P=r("a"),Io=r("span"),h(mt.$$.fragment),Di=d(),Lo=r("span"),Ii=n("Tokenizer"),$s=d(),Oe=r("p"),Li=n(`A tokenizer is in charge of preparing the inputs for a model. The library contains tokenizers for all the models. Most
of the tokenizers are available in two flavors: a full python implementation and a \u201CFast\u201D implementation based on the
Rust library `),ft=r("a"),Bi=n("\u{1F917} Tokenizers"),Fi=n(". The \u201CFast\u201D implementations allows:"),Ps=d(),Se=r("ol"),Bo=r("li"),Ai=n("a significant speed-up in particular when doing batched tokenization and"),Ci=d(),Fo=r("li"),Ni=n(`additional methods to map between the original string (character and words) and the token space (e.g. getting the
...
and XLNet models).`),qs=d(),N=r("p"),Oi=n("The base classes "),In=r("a"),Si=n("PreTrainedTokenizer"),Wi=n(" and "),Ln=r("a"),Ri=n("PreTrainedTokenizerFast"),Ui=n(`
...
`),Fn=r("a"),Hi=n("SpecialTokensMixin"),Mi=n("."),Ds=d(),Ee=r("p"),An=r("a"),Gi=n("PreTrainedTokenizer"),Xi=n(" and "),Cn=r("a"),Yi=n("PreTrainedTokenizerFast"),Ji=n(` thus implement the main
methods for using all the tokenizers:`),Is=d(),de=r("ul"),Ao=r("li"),Ki=n(`Tokenizing (splitting strings in sub-word token strings), converting tokens strings to ids and back, and
...
tokenizer for easy access and making sure they are not split during tokenization.`),Ls=d(),q=r("p"),Nn=r("a"),nd=n("BatchEncoding"),od=n(` holds the output of the
`),On=r("a"),rd=n("PreTrainedTokenizerBase"),ad=n("\u2019s encoding methods ("),Oo=r("code"),sd=n("__call__"),id=n(`,
...
specific vocabulary augmentation methods of the various underlying dictionary structures (BPE, sentencepiece\u2026).`),Dd=d(),Xo=r("p"),Id=n("Class attributes (overridden by derived classes)"),Ld=d(),F=r("ul"),ce=r("li"),Yo=r("strong"),Bd=n("vocab_files_names"),Fd=n(" ("),Jo=r("code"),Ad=n("Dict[str, str]"),Cd=n(") \u2014 A dictionary with, as keys, the "),Ko=r("code"),Nd=n("__init__"),Od=n(` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),Sd=d(),O=r("li"),Qo=r("strong"),Wd=n("pretrained_vocab_files_map"),Rd=n(" ("),Zo=r("code"),Ud=n("Dict[str, Dict[str, str]]"),jd=n(`) \u2014 A dictionary of dictionaries, with the
high-level keys being the `),er=r("code"),Vd=n("__init__"),Hd=n(` keyword name of each vocabulary file required by the model, the
low-level being the `),tr=r("code"),Md=n("short-cut-names"),Gd=n(" of the pretrained models with, as associated values, the "),nr=r("code"),Xd=n("url"),Yd=n(` to the
associated pretrained vocabulary file.`),Jd=d(),G=r("li"),or=r("strong"),Kd=n("max_model_input_sizes"),Qd=n(" ("),rr=r("code"),Zd=n("Dict[str, Optional[int]]"),ec=n(") \u2014 A dictionary with, as keys, the "),ar=r("code"),tc=n("short-cut-names"),nc=n(`
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),sr=r("code"),oc=n("None"),rc=n(" if the model has no maximum input size."),ac=d(),S=r("li"),ir=r("strong"),sc=n("pretrained_init_configuration"),ic=n(" ("),dr=r("code"),dc=n("Dict[str, Dict[str, Any]]"),cc=n(`) \u2014 A dictionary with, as keys, the
`),cr=r("code"),lc=n("short-cut-names"),hc=n(` of the pretrained models, and as associated values, a dictionary of specific arguments to
pass to the `),lr=r("code"),pc=n("__init__"),mc=n(` method of the tokenizer class for this pretrained model when loading the tokenizer
with the `),Wn=r("a"),fc=n("from_pretrained()"),uc=n(" method."),_c=d(),Re=r("li"),hr=r("strong"),gc=n("model_input_names"),kc=n(" ("),pr=r("code"),vc=n("List[str]"),bc=n(") \u2014 A list of inputs expected in the forward pass of the model."),yc=d(),X=r("li"),mr=r("strong"),Tc=n("padding_side"),wc=n(" ("),fr=r("code"),zc=n("str"),xc=n(`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),ur=r("code"),Ec=n("'right'"),$c=n(" or "),_r=r("code"),Pc=n("'left'"),qc=n("."),Dc=d(),Ue=r("div"),h(vt.$$.fragment),Ic=d(),gr=r("p"),Lc=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
`),wr=r("code"),Zc=n("repo_path_or_name"),el=n("."),tl=d(),zr=r("p"),nl=n("Examples:"),ol=d(),h($t.$$.fragment),rl=d(),Ve=r("div"),h(Pt.$$.fragment),al=d(),xr=r("p"),sl=n(`Converts a single index or a sequence of indices in a token or a sequence of tokens, using the vocabulary and
...
(BPE/SentencePieces/WordPieces). Takes care of added tokens.`),As=d(),qe=r("h2"),Xe=r("a"),Fr=r("span"),h(Ft.$$.fragment),Il=d(),Ar=r("span"),Ll=n("PreTrainedTokenizerFast"),Cs=d(),J=r("p"),Bl=n("The "),Rn=r("a"),Fl=n("PreTrainedTokenizerFast"),Al=n(" depend on the "),At=r("a"),Cl=n("tokenizers"),Nl=n(` library. The tokenizers obtained from the \u{1F917} tokenizers library can be
...
specific vocabulary augmentation methods of the various underlying dictionary structures (BPE, sentencepiece\u2026).`),Jl=d(),Sr=r("p"),Kl=n("Class attributes (overridden by derived classes)"),Ql=d(),A=r("ul"),ue=r("li"),Wr=r("strong"),Zl=n("vocab_files_names"),eh=n(" ("),Rr=r("code"),th=n("Dict[str, str]"),nh=n(") \u2014 A dictionary with, as keys, the "),Ur=r("code"),oh=n("__init__"),rh=n(` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),ah=d(),W=r("li"),jr=r("strong"),sh=n("pretrained_vocab_files_map"),ih=n(" ("),Vr=r("code"),dh=n("Dict[str, Dict[str, str]]"),ch=n(`) \u2014 A dictionary of dictionaries, with the
high-level keys being the `),Hr=r("code"),lh=n("__init__"),hh=n(` keyword name of each vocabulary file required by the model, the
low-level being the `),Mr=r("code"),ph=n("short-cut-names"),mh=n(" of the pretrained models with, as associated values, the "),Gr=r("code"),fh=n("url"),uh=n(` to the
associated pretrained vocabulary file.`),_h=d(),K=r("li"),Xr=r("strong"),gh=n("max_model_input_sizes"),kh=n(" ("),Yr=r("code"),vh=n("Dict[str, Optional[int]]"),bh=n(") \u2014 A dictionary with, as keys, the "),Jr=r("code"),yh=n("short-cut-names"),Th=n(`
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),Kr=r("code"),wh=n("None"),zh=n(" if the model has no maximum input size."),xh=d(),R=r("li"),Qr=r("strong"),Eh=n("pretrained_init_configuration"),$h=n(" ("),Zr=r("code"),Ph=n("Dict[str, Dict[str, Any]]"),qh=n(`) \u2014 A dictionary with, as keys, the
`),ea=r("code"),Dh=n("short-cut-names"),Ih=n(` of the pretrained models, and as associated values, a dictionary of specific arguments to
pass to the `),ta=r("code"),Lh=n("__init__"),Bh=n(` method of the tokenizer class for this pretrained model when loading the tokenizer
with the `),Vn=r("a"),Fh=n("from_pretrained()"),Ah=n(" method."),Ch=d(),Ye=r("li"),na=r("strong"),Nh=n("model_input_names"),Oh=n(" ("),oa=r("code"),Sh=n("List[str]"),Wh=n(") \u2014 A list of inputs expected in the forward pass of the model."),Rh=d(),Q=r("li"),ra=r("strong"),Uh=n("padding_side"),jh=n(" ("),aa=r("code"),Vh=n("str"),Hh=n(`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),sa=r("code"),Mh=n("'right'"),Gh=n(" or "),ia=r("code"),Xh=n("'left'"),Yh=n("."),Jh=d(),Je=r("div"),h(Ot.$$.fragment),Kh=d(),da=r("p"),Qh=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),Zh=d(),Ke=r("div"),h(St.$$.fragment),ep=d(),ca=r("p"),tp=n("Convert a list of lists of token ids into a list of strings by calling decode."),np=d(),_e=r("div"),h(Wt.$$.fragment),op=d(),la=r("p"),rp=n(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),ap=d(),Rt=r("p"),sp=n("Similar to doing "),ha=r("code"),ip=n("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),dp=n("."),cp=d(),ge=r("div"),h(Ut.$$.fragment),lp=d(),pa=r("p"),hp=n("Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),pp=d(),jt=r("p"),mp=n("Same as doing "),ma=r("code"),fp=n("self.convert_tokens_to_ids(self.tokenize(text))"),up=n("."),_p=d(),Z=r("div"),h(Vt.$$.fragment),gp=d(),Ht=r("p"),kp=n(`Upload the tokenizer files to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),fa=r("code"),vp=n("repo_path_or_name"),bp=n("."),yp=d(),ua=r("p"),Tp=n("Examples:"),wp=d(),h(Mt.$$.fragment),zp=d(),Qe=r("div"),h(Gt.$$.fragment),xp=d(),_a=r("p"),Ep=n(`Converts a single index or a sequence of indices in a token or a sequence of tokens, using the vocabulary and
added tokens.`),$p=d(),Ze=r("div"),h(Xt.$$.fragment),Pp=d(),ga=r("p"),qp=n(`Converts a token string (or a sequence of tokens) in a single integer id (or a sequence of ids), using the
vocabulary.`),Dp=d(),et=r("div"),h(Yt.$$.fragment),Ip=d(),ka=r("p"),Lp=n("Returns the added tokens in the vocabulary as a dictionary of token to index."),Bp=d(),ke=r("div"),h(Jt.$$.fragment),Fp=d(),va=r("p"),Ap=n("Returns the number of added tokens when encoding a sequence with special tokens."),Cp=d(),h(tt.$$.fragment),Np=d(),ve=r("div"),h(Kt.$$.fragment),Op=d(),ba=r("p"),Sp=n(`Define the truncation and the padding strategies for fast tokenizers (provided by HuggingFace tokenizers
library) and restore the tokenizer settings afterwards.`),Wp=d(),ya=r("p"),Rp=n(`The provided tokenizer has no padding / truncation strategy before the managed section. If your tokenizer set a
padding / truncation strategy before, then it will be reset to no padding / truncation when exiting the managed
section.`),Up=d(),nt=r("div"),h(Qt.$$.fragment),jp=d(),Ta=r("p"),Vp=n(`Trains a tokenizer on a new corpus with the same defaults (in terms of special tokens or tokenization pipeline)
as the current one.`),Os=d(),De=r("h2"),ot=r("a"),wa=r("span"),h(Zt.$$.fragment),Hp=d(),za=r("span"),Mp=n("BatchEncoding"),Ss=d(),b=r("div"),h(en.$$.fragment),Gp=d(),Ie=r("p"),Xp=n("Holds the output of the "),Hn=r("a"),Yp=n("encode_plus()"),Jp=n(` and
`),xa=r("code"),Kp=n("batch_encode"),Qp=n(" methods (tokens, attention_masks, etc)."),Zp=d(),Ea=r("p"),em=n(`This class is derived from a python dictionary and can be used as a dictionary. In addition, this class exposes
...
of the tokenizers are available in two flavors: a full python implementation and a \u201CFast\u201D implementation based on the
Rust library `),ft=a(Rs,"A",{href:!0,rel:!0});var c_=s(ft);Bi=o(c_,"\u{1F917} Tokenizers"),c_.forEach(t),Fi=o(Rs,". The \u201CFast\u201D implementations allows:"),Rs.forEach(t),Ps=c(i),Se=a(i,"OL",{});var Us=s(Se);Bo=a(Us,"LI",{});var l_=s(Bo);Ai=o(l_,"a significant speed-up in particular when doing batched tokenization and"),l_.forEach(t),Ci=c(Us),Fo=a(Us,"LI",{});var h_=s(Fo);Ni=o(h_,`additional methods to map between the original string (character and words) and the token space (e.g. getting the
index of the token comprising a given character or the span of characters corresponding to a given token). Currently
no \u201CFast\u201D implementation is available for the SentencePiece-based tokenizers (for T5, ALBERT, CamemBERT, XLM-RoBERTa
...
`),cr=a(ae,"CODE",{});var K_=s(cr);lc=o(K_,"short-cut-names"),K_.forEach(t),hc=o(ae,` of the pretrained models, and as associated values, a dictionary of specific arguments to
pass to the `),lr=a(ae,"CODE",{});var Q_=s(lr);pc=o(Q_,"__init__"),Q_.forEach(t),mc=o(ae,` method of the tokenizer class for this pretrained model when loading the tokenizer
with the `),Wn=a(ae,"A",{href:!0});var Z_=s(Wn);fc=o(Z_,"from_pretrained()"),Z_.forEach(t),uc=o(ae," method."),ae.forEach(t),_c=c(ee),Re=a(ee,"LI",{});var xs=s(Re);hr=a(xs,"STRONG",{});var eg=s(hr);gc=o(eg,"model_input_names"),eg.forEach(t),kc=o(xs," ("),pr=a(xs,"CODE",{});var tg=s(pr);vc=o(tg,"List[str]"),tg.forEach(t),bc=o(xs,") \u2014 A list of inputs expected in the forward pass of the model."),xs.forEach(t),yc=c(ee),X=a(ee,"LI",{});var Ae=s(X);mr=a(Ae,"STRONG",{});var ng=s(mr);Tc=o(ng,"padding_side"),ng.forEach(t),wc=o(Ae," ("),fr=a(Ae,"CODE",{});var og=s(fr);zc=o(og,"str"),og.forEach(t),xc=o(Ae,`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),ur=a(Ae,"CODE",{});var rg=s(ur);Ec=o(rg,"'right'"),rg.forEach(t),$c=o(Ae," or "),_r=a(Ae,"CODE",{});var ag=s(_r);Pc=o(ag,"'left'"),ag.forEach(t),qc=o(Ae,"."),Ae.forEach(t),ee.forEach(t),Dc=c(T),Ue=a(T,"DIV",{class:!0});var Hs=s(Ue);p(vt.$$.fragment,Hs),Ic=c(Hs),gr=a(Hs,"P",{});var sg=s(gr);Lc=o(sg,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
low-level being the `),Mr=a(se,"CODE",{});var Wg=s(Mr);ph=o(Wg,"short-cut-names"),Wg.forEach(t),mh=o(se," of the pretrained models with, as associated values, the "),Gr=a(se,"CODE",{});var Rg=s(Gr);fh=o(Rg,"url"),Rg.forEach(t),uh=o(se,` to the
associated pretrained vocabulary file.`),se.forEach(t),_h=c(te),K=a(te,"LI",{});var Ce=s(K);Xr=a(Ce,"STRONG",{});var Ug=s(Xr);gh=o(Ug,"max_model_input_sizes"),Ug.forEach(t),kh=o(Ce," ("),Yr=a(Ce,"CODE",{});var jg=s(Yr);vh=o(jg,"Dict[str, Optional[int]]"),jg.forEach(t),bh=o(Ce,") \u2014 A dictionary with, as keys, the "),Jr=a(Ce,"CODE",{});var Vg=s(Jr);yh=o(Vg,"short-cut-names"),Vg.forEach(t),Th=o(Ce,`
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
...
`),ea=a(ie,"CODE",{});var Xg=s(ea);Dh=o(Xg,"short-cut-names"),Xg.forEach(t),Ih=o(ie,` of the pretrained models, and as associated values, a dictionary of specific arguments to
pass to the `),ta=a(ie,"CODE",{});var Yg=s(ta);Lh=o(Yg,"__init__"),Yg.forEach(t),Bh=o(ie,` method of the tokenizer class for this pretrained model when loading the tokenizer
with the `),Vn=a(ie,"A",{href:!0});var Jg=s(Vn);Fh=o(Jg,"from_pretrained()"),Jg.forEach(t),Ah=o(ie," method."),ie.forEach(t),Ch=c(te),Ye=a(te,"LI",{});var Es=s(Ye);na=a(Es,"STRONG",{});var Kg=s(na);Nh=o(Kg,"model_input_names"),Kg.forEach(t),Oh=o(Es," ("),oa=a(Es,"CODE",{});var Qg=s(oa);Sh=o(Qg,"List[str]"),Qg.forEach(t),Wh=o(Es,") \u2014 A list of inputs expected in the forward pass of the model."),Es.forEach(t),Rh=c(te),Q=a(te,"LI",{});var Ne=s(Q);ra=a(Ne,"STRONG",{});var Zg=s(ra);Uh=o(Zg,"padding_side"),Zg.forEach(t),jh=o(Ne," ("),aa=a(Ne,"CODE",{});var ek=s(aa);Vh=o(ek,"str"),ek.forEach(t),Hh=o(Ne,`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),sa=a(Ne,"CODE",{});var tk=s(sa);Mh=o(tk,"'right'"),tk.forEach(t),Gh=o(Ne," or "),ia=a(Ne,"CODE",{});var nk=s(ia);Xh=o(nk,"'left'"),nk.forEach(t),Yh=o(Ne,"."),Ne.forEach(t),te.forEach(t),Jh=c(w),Je=a(w,"DIV",{class:!0});var ti=s(Je);p(Ot.$$.fragment,ti),Kh=c(ti),da=a(ti,"P",{});var ok=s(da);Qh=o(ok,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
`),xa=a($o,"CODE",{});var Tk=s(xa);Kp=o(Tk,"batch_encode"),Tk.forEach(t),Qp=o($o," methods (tokens, attention_masks, etc)."),$o.forEach(t),Zp=c(z),Ea=a(z,"P",{});var wk=s(Ea);em=o(wk,`This class is derived from a python dictionary and can be used as a dictionary. In addition, this class exposes
