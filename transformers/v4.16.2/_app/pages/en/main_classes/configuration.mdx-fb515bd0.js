...
config.push_to_hub(<span class="hljs-string">&quot;my-finetuned-bert&quot;</span>, repo_url=<span class="hljs-string">&quot;https://huggingface.co/sgugger/my-finetuned-bert&quot;</span>)`}}),Pe=new D({props:{name:"dict\\_torch\\_dtype\\_to\\_str",anchor:"transformers.PretrainedConfig.dict_torch_dtype_to_str",parameters:[{name:"d",val:": typing.Dict[str, typing.Any]"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/configuration_utils.py#L844"}}),Ce=new D({props:{name:"from\\_dict",anchor:"transformers.PretrainedConfig.from_dict",parameters:[{name:"config_dict",val:": typing.Dict[str, typing.Any]"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/configuration_utils.py#L648",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_dict.config_dict",description:`<strong>config_dict</strong> (<code>Dict[str, Any]</code>) &#x2014;
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/v4.16.2/en/main_classes/model#transformers.file_utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}]}}),qe=new D({props:{name:"to\\_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/configuration_utils.py#L746",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Se=new D({props:{name:"to\\_diff\\_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/configuration_utils.py#L714",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Fe=new D({props:{name:"to\\_json\\_file",anchor:"transformers.PretrainedConfig.to_json_file",parameters:[{name:"json_file_path",val:": typing.Union[str, os.PathLike]"},{name:"use_diff",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/configuration_utils.py#L782",parametersDescription:[{anchor:"transformers.PretrainedConfig.to_json_file.json_file_path",description:`<strong>json_file_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`),at=r("code"),Ao=o("vocab_size"),qo=o("."),eo=d(),V=r("h2"),R=r("a"),st=r("span"),g(ve.$$.fragment),So=d(),it=r("span"),Fo=o("PretrainedConfig"),to=d(),l=r("div"),g(ye.$$.fragment),Lo=d(),dt=r("p"),Io=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),No=d(),g(G.$$.fragment),Mo=d(),ct=r("p"),Wo=o("Class attributes (overridden by derived classes):"),Ho=d(),S=r("ul"),M=r("li"),lt=r("strong"),Vo=o("model_type"),Bo=o(" ("),ft=r("code"),Jo=o("str"),Uo=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
the correct object in `),Je=r("a"),Ro=o("AutoConfig"),Go=o("."),Xo=d(),T=r("li"),ht=r("strong"),Ko=o("is_composition"),Qo=o(" ("),mt=r("code"),Yo=o("bool"),Zo=o(`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
config has to be initialized from two or more configs of type `),Ue=r("a"),en=o("PretrainedConfig"),tn=o(` like:
...
model.`),qn=d(),ee=r("li"),Ct=r("strong"),Sn=o("num_hidden_layers"),Fn=o(" ("),Et=r("code"),Ln=o("int"),In=o(") \u2014 The number of blocks in the model."),Nn=d(),z=r("div"),g(we.$$.fragment),Mn=d(),$e=r("p"),Wn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),Tt=r("code"),Hn=o("repo_path_or_name"),Vn=o("."),Bn=d(),xt=r("p"),Jn=o("Examples:"),Un=d(),g(ke.$$.fragment),Rn=d(),te=r("div"),g(Pe.$$.fragment),Gn=d(),L=r("p"),Xn=o("Checks whether the passed dictionary has a "),Dt=r("em"),Kn=o("torch_dtype"),Qn=o(` key and if it\u2019s not None, converts torch.dtype to a
...
`),Ze=r("a"),Sr=o("from_pretrained()"),Fr=o(" class method."),Lr=d(),ie=r("div"),g(qe.$$.fragment),Ir=d(),Ft=r("p"),Nr=o("Serializes this instance to a Python dictionary."),Mr=d(),de=r("div"),g(Se.$$.fragment),Wr=d(),Lt=r("p"),Hr=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Vr=d(),ce=r("div"),g(Fe.$$.fragment),Br=d(),It=r("p"),Jr=o("Save this instance to a JSON file."),Ur=d(),le=r("div"),g(Le.$$.fragment),Rr=d(),Nt=r("p"),Gr=o("Serializes this instance to a JSON string."),Xr=d(),fe=r("div"),g(Ie.$$.fragment),Kr=d(),Ne=r("p"),Qr=o("Updates attributes of this class with attributes from "),Mt=r("code"),Yr=o("config_dict"),Zr=o("."),ea=d(),O=r("div"),g(Me.$$.fragment),ta=d(),We=r("p"),oa=o("Updates attributes of this class with attributes from "),Wt=r("code"),na=o("update_str"),ra=o("."),aa=d(),J=r("p"),sa=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),ia=o("true"),da=o(" or "),Vt=r("code"),ca=o("false"),la=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),fa=d(),Bt=r("p"),ha=o("The keys to change have to already exist in the config object."),this.h()},l(i){const k=ws('[data-svelte="svelte-1phssyn"]',document.head);m=a(k,"META",{name:!0,content:!0}),k.forEach(t),C=c(i),u=a(i,"H1",{class:!0});var He=s(u);w=a(He,"A",{id:!0,class:!0,href:!0});var Jt=s(w);j=a(Jt,"SPAN",{});var ma=s(j);p($.$$.fragment,ma),ma.forEach(t),Jt.forEach(t),P=c(He),q=a(He,"SPAN",{});var ua=s(q);$o=n(ua,"Configuration"),ua.forEach(t),He.forEach(t),Yt=c(i),U=a(i,"P",{});var no=s(U);ko=n(no,"The base class "),Be=a(no,"A",{href:!0});var ga=s(Be);Po=n(ga,"PretrainedConfig"),ga.forEach(t),Co=n(no,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),at=a(W,"CODE",{});var va=s(at);Ao=n(va,"vocab_size"),va.forEach(t),qo=n(W,"."),W.forEach(t),eo=c(i),V=a(i,"H2",{class:!0});var ro=s(V);R=a(ro,"A",{id:!0,class:!0,href:!0});var ya=s(R);st=a(ya,"SPAN",{});var wa=s(st);p(ve.$$.fragment,wa),wa.forEach(t),ya.forEach(t),So=c(ro),it=a(ro,"SPAN",{});var $a=s(it);Fo=n($a,"PretrainedConfig"),$a.forEach(t),ro.forEach(t),to=c(i),l=a(i,"DIV",{class:!0});var f=s(l);p(ye.$$.fragment,f),Lo=c(f),dt=a(f,"P",{});var ka=s(dt);Io=n(ka,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
the correct object in `),Je=a(Ve,"A",{href:!0});var Ta=s(Je);Ro=n(Ta,"AutoConfig"),Ta.forEach(t),Go=n(Ve,"."),Ve.forEach(t),Xo=c(he),T=a(he,"LI",{});var N=s(T);ht=a(N,"STRONG",{});var xa=s(ht);Ko=n(xa,"is_composition"),xa.forEach(t),Qo=n(N," ("),mt=a(N,"CODE",{});var Da=s(mt);Yo=n(Da,"bool"),Da.forEach(t),Zo=n(N,`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
config has to be initialized from two or more configs of type `),Ue=a(N,"A",{href:!0});var ja=s(Ue);en=n(ja,"PretrainedConfig"),ja.forEach(t),tn=n(N,` like:
`),Re=a(N,"A",{href:!0});var za=s(Re);on=n(za,"EncoderDecoderConfig"),za.forEach(t),nn=n(N," or "),Ge=a(N,"A",{href:!0});var Oa=s(Ge);rn=n(Oa,"~RagConfig"),Oa.forEach(t),an=n(N,"."),N.forEach(t),sn=c(he),X=a(he,"LI",{});var Ut=s(X);ut=a(Ut,"STRONG",{});var Aa=s(ut);dn=n(Aa,"keys_to_ignore_at_inference"),Aa.forEach(t),cn=n(Ut," ("),gt=a(Ut,"CODE",{});var qa=s(gt);ln=n(qa,"List[str]"),qa.forEach(t),fn=n(Ut,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Ut.forEach(t),hn=c(he),K=a(he,"LI",{});var Rt=s(K);pt=a(Rt,"STRONG",{});var Sa=s(pt);mn=n(Sa,"attribute_map"),Sa.forEach(t),un=n(Rt," ("),_t=a(Rt,"CODE",{});var Fa=s(_t);gn=n(Fa,"Dict[str, str]"),Fa.forEach(t),pn=n(Rt,`) \u2014 A dict that maps model specific attribute names to the standardized
naming of attributes.`),Rt.forEach(t),he.forEach(t),_n=c(f),bt=a(f,"P",{});var La=s(bt);bn=n(La,"Common attributes (present in all subclasses):"),La.forEach(t),vn=c(f),F=a(f,"UL",{});var me=s(F);Q=a(me,"LI",{});var Gt=s(Q);vt=a(Gt,"STRONG",{});var Ia=s(vt);yn=n(Ia,"vocab_size"),Ia.forEach(t),wn=n(Gt," ("),yt=a(Gt,"CODE",{});var Na=s(yt);$n=n(Na,"int"),Na.forEach(t),kn=n(Gt,`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
