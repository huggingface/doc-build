import{S as dm,i as cm,s as mm,e as l,k as f,w as d,t as n,L as _m,c as i,d as t,m as h,a as p,x as c,h as o,b as u,J as s,g as r,y as m,q as _,o as w,B as g}from"../../chunks/vendor-b1433968.js";import{T as Su}from"../../chunks/Tip-c3840994.js";import{I as z}from"../../chunks/IconCopyLink-7029626d.js";import{C as $}from"../../chunks/CodeBlock-a320dbd7.js";import{C as wm}from"../../chunks/ColabDropdown-727dc22f.js";import"../../chunks/CopyButton-f65cb278.js";function gm(V){let b,q,k,y,E,v,P,T;return{c(){b=l("p"),q=n(`For a more in-depth example of how to fine-tune a model for text classification, take a look at the corresponding
`),k=l("a"),y=n("PyTorch notebook"),E=n(`
or `),v=l("a"),P=n("TensorFlow notebook"),T=n("."),this.h()},l(x){b=i(x,"P",{});var j=p(b);q=o(j,`For a more in-depth example of how to fine-tune a model for text classification, take a look at the corresponding
`),k=i(j,"A",{href:!0,rel:!0});var A=p(k);y=o(A,"PyTorch notebook"),A.forEach(t),E=o(j,`
or `),v=i(j,"A",{href:!0,rel:!0});var C=p(v);P=o(C,"TensorFlow notebook"),C.forEach(t),T=o(j,"."),j.forEach(t),this.h()},h(){u(k,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/text_classification.ipynb"),u(k,"rel","nofollow"),u(v,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/text_classification-tf.ipynb"),u(v,"rel","nofollow")},m(x,j){r(x,b,j),s(b,q),s(b,k),s(k,y),s(b,E),s(b,v),s(v,P),s(b,T)},d(x){x&&t(b)}}}function $m(V){let b,q,k,y,E,v,P,T;return{c(){b=l("p"),q=n(`For a more in-depth example of how to fine-tune a model for token classification, take a look at the corresponding
`),k=l("a"),y=n("PyTorch notebook"),E=n(`
or `),v=l("a"),P=n("TensorFlow notebook"),T=n("."),this.h()},l(x){b=i(x,"P",{});var j=p(b);q=o(j,`For a more in-depth example of how to fine-tune a model for token classification, take a look at the corresponding
`),k=i(j,"A",{href:!0,rel:!0});var A=p(k);y=o(A,"PyTorch notebook"),A.forEach(t),E=o(j,`
or `),v=i(j,"A",{href:!0,rel:!0});var C=p(v);P=o(C,"TensorFlow notebook"),C.forEach(t),T=o(j,"."),j.forEach(t),this.h()},h(){u(k,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/token_classification.ipynb"),u(k,"rel","nofollow"),u(v,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/token_classification-tf.ipynb"),u(v,"rel","nofollow")},m(x,j){r(x,b,j),s(b,q),s(b,k),s(k,y),s(b,E),s(b,v),s(v,P),s(b,T)},d(x){x&&t(b)}}}function bm(V){let b,q,k,y,E,v,P,T;return{c(){b=l("p"),q=n(`For a more in-depth example of how to fine-tune a model for question answering, take a look at the corresponding
`),k=l("a"),y=n("PyTorch notebook"),E=n(`
or `),v=l("a"),P=n("TensorFlow notebook"),T=n("."),this.h()},l(x){b=i(x,"P",{});var j=p(b);q=o(j,`For a more in-depth example of how to fine-tune a model for question answering, take a look at the corresponding
`),k=i(j,"A",{href:!0,rel:!0});var A=p(k);y=o(A,"PyTorch notebook"),A.forEach(t),E=o(j,`
or `),v=i(j,"A",{href:!0,rel:!0});var C=p(v);P=o(C,"TensorFlow notebook"),C.forEach(t),T=o(j,"."),j.forEach(t),this.h()},h(){u(k,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/question_answering.ipynb"),u(k,"rel","nofollow"),u(v,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/question_answering-tf.ipynb"),u(v,"rel","nofollow")},m(x,j){r(x,b,j),s(b,q),s(b,k),s(k,y),s(b,E),s(b,v),s(v,P),s(b,T)},d(x){x&&t(b)}}}function km(V){let b,q,k,y,E,v,P,T,x,j,A,C,qs,gi,to,ue,$i,st,bi,ki,so,at,ao,Es,vi,no,I,Da,Ts,ji,yi,Sa,As,xi,qi,Na,zs,Ei,oo,Ps,ro,J,de,Ia,nt,Ti,Ma,Ai,lo,ce,zi,ot,Pi,Fi,io,me,po,K,_e,La,rt,Ci,Oa,Di,fo,Fs,Si,ho,lt,uo,we,Ni,Ba,Ii,Mi,co,it,mo,X,ge,Wa,pt,Li,Ha,Oi,_o,M,Bi,Cs,Wi,Hi,ft,Qi,Ri,wo,ht,go,Ds,Ui,$o,ut,bo,L,Yi,Qa,Gi,Vi,Ra,Ji,Ki,ko,dt,vo,F,Xi,Ua,Zi,ep,Ya,tp,sp,Ga,ap,np,Va,op,rp,jo,ct,yo,Z,$e,Ja,mt,lp,Ka,ip,xo,be,pp,Ss,fp,hp,qo,_t,Eo,Ns,up,To,O,wt,dp,Is,cp,mp,_p,gt,wp,Ms,gp,$p,bp,$t,kp,Xa,vp,jp,Ao,bt,zo,ee,ke,Za,kt,yp,en,xp,Po,Ls,qp,Fo,D,Ep,Os,Tp,Ap,tn,zp,Pp,sn,Fp,Cp,Co,vt,Do,S,Dp,an,Sp,Np,nn,Ip,Mp,on,Lp,Op,So,jt,No,Bs,Bp,Io,yt,Mo,ve,Wp,Ws,Hp,Qp,Lo,xt,Oo,Hs,Rp,Bo,qt,Wo,je,Up,rn,Yp,Gp,Ho,Et,Qo,Qs,Ro,te,ye,ln,Tt,Vp,pn,Jp,Uo,xe,Kp,At,Xp,Zp,Yo,qe,Go,se,Ee,fn,zt,ef,hn,tf,Vo,Rs,sf,Jo,Pt,Ko,Us,af,Xo,Ft,Zo,Ys,nf,er,Ct,tr,Gs,of,sr,B,Vs,un,rf,lf,pf,W,dn,ff,hf,cn,uf,df,mn,cf,mf,_f,Js,_n,wf,gf,ar,ae,Te,wn,Dt,$f,gn,bf,nr,Ae,kf,Ks,vf,jf,or,St,rr,ze,yf,$n,xf,qf,lr,Nt,ir,H,Ef,bn,Tf,Af,kn,zf,Pf,pr,Q,It,Ff,vn,Cf,Df,Sf,ne,Nf,jn,If,Mf,yn,Lf,Of,Bf,Mt,Wf,xn,Hf,Qf,fr,Xs,Rf,hr,Lt,ur,Pe,Uf,qn,Yf,Gf,dr,Ot,cr,Zs,Vf,mr,Bt,_r,oe,Fe,En,Wt,Jf,Tn,Kf,wr,Ce,Xf,ea,Zf,eh,gr,Ht,$r,De,th,ta,sh,ah,br,Qt,kr,Se,nh,sa,oh,rh,vr,Rt,jr,aa,lh,yr,Ut,xr,re,Ne,An,Yt,ih,zn,ph,qr,na,fh,Er,Gt,Tr,R,hh,Pn,uh,dh,Fn,ch,mh,Ar,Vt,zr,Ie,_h,oa,wh,gh,Pr,Jt,Fr,ra,$h,Cr,Kt,Dr,la,bh,Sr,Xt,Nr,Me,kh,Cn,vh,jh,Ir,Zt,Mr,ia,Lr,le,Le,Dn,es,yh,Sn,xh,Or,Oe,qh,ts,Eh,Th,Br,Be,Wr,ie,We,Nn,ss,Ah,In,zh,Hr,pa,Ph,Qr,as,Rr,fa,Fh,Ur,ns,Yr,pe,He,Mn,os,Ch,Ln,Dh,Gr,Qe,Sh,ha,Nh,Ih,Vr,rs,Jr,ua,Mh,Kr,U,N,Lh,On,Oh,Bh,Bn,Wh,Hh,Wn,Qh,Rh,Uh,ls,Yh,Hn,Gh,Vh,Jh,is,Kh,Qn,Xh,Zh,Xr,da,eu,Zr,ps,el,Re,tu,Rn,su,au,tl,fs,sl,ca,nu,al,hs,nl,fe,Ue,Un,us,ou,Yn,ru,ol,Ye,lu,ma,iu,pu,rl,ds,ll,Ge,fu,_a,hu,uu,il,cs,pl,Ve,du,wa,cu,mu,fl,ms,hl,ga,_u,ul,_s,dl,he,Je,Gn,ws,wu,Vn,gu,cl,$a,$u,ml,gs,_l,Y,bu,Jn,ku,vu,Kn,ju,yu,wl,$s,gl,ba,xu,$l,bs,bl,Ke,qu,ka,Eu,Tu,kl,ks,vl,va,Au,jl,vs,yl,Xe,zu,Xn,Pu,Fu,xl,js,ql;return v=new z({}),A=new wm({props:{"hydrate-props":{classNames:"absolute z-10 right-0 top-0",options:[{label:"Mixed",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/custom_datasets.ipynb"},{label:"PyTorch",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/pytorch/custom_datasets.ipynb"},{label:"TensorFlow",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/tensorflow/custom_datasets.ipynb"}]}}}),at=new $({props:{code:"pip install datasets,",highlighted:"pip install datasets"}}),nt=new z({}),me=new Su({props:{$$slots:{default:[gm]},$$scope:{ctx:V}}}),rt=new z({}),lt=new $({props:{code:`from datasets import load_dataset
...
optimizer, schedule = create_optimizer(init_lr=<span class="hljs-number">2e-5</span>, num_warmup_steps=<span class="hljs-number">0</span>, num_train_steps=total_train_steps)`}}),xt=new $({props:{code:`from transformers import TFAutoModelForSequenceClassification
...
model.<span class="hljs-built_in">compile</span>(optimizer=optimizer)`}}),js=new $({props:{code:`model.fit(
    ...
    validation_data=tf_validation_set,
    epochs=num_train_epochs,
)`}}),{c(){b=l("meta"),q=f(),k=l("h1"),y=l("a"),E=l("span"),d(v.$$.fragment),P=f(),T=l("span"),x=n("How to fine-tune a model for common downstream tasks"),j=f(),d(A.$$.fragment),C=f(),qs=l("p"),gi=n(`This guide will show you how to fine-tune \u{1F917} Transformers models for common downstream tasks. You will use the \u{1F917}
...
longer sequences in the text to be no longer than the model\u2019s maximum input length:`),rd.forEach(t),$o=h(e),c(ut.$$.fragment,e),bo=h(e),L=i(e,"P",{});var xa=p(L);Yi=o(xa,"Use \u{1F917} Datasets "),Qa=i(xa,"CODE",{});var ld=p(Qa);Gi=o(ld,"map"),ld.forEach(t),Vi=o(xa,` function to apply the preprocessing function to the entire dataset. You can also set
