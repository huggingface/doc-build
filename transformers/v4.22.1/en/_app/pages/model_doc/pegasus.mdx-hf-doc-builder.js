...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function X_(z){let p,k,_,m,v;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,k),e(p,_),e(_,m),e(p,v)},d(d){d&&t(p)}}}function Z_(z){let p,k,_,m,v;return m=new He({props:{code:`from transformers import PegasusTokenizer, PegasusModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">4</span>, <span class="hljs-number">1024</span>]`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function Y_(z){let p,k,_,m,v;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,k),e(p,_),e(_,m),e(p,v)},d(d){d&&t(p)}}}function ev(z){let p,k,_,m,v;return m=new He({props:{code:`from transformers import PegasusTokenizer, PegasusForConditionalGeneration
...
<span class="hljs-string">&quot;California&#x27;s largest electricity provider has turned off power to hundreds of thousands of customers.&quot;</span>`}}),{c(){p=n("p"),k=r("Summarization example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Summarization example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function tv(z){let p,k,_,m,v;return m=new He({props:{code:`from transformers import PegasusTokenizer, PegasusForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function ov(z){let p,k,_,m,v,d,h,E,Qe,Ge,L,Pe,$e,q,ie,de,Je,Le,N,ee,xe,K,Xe,ze,le,Ne,te,ce,ue,Ze,Fe,S,A,Ye,oe,ne,qe,pe,et,Ee,D,De,G,tt,he,me,ot,fe,Q,nt,se,J,H,I,ge,V,Ce,st;return{c(){p=n("p"),k=r("TensorFlow models and layers in "),_=n("code"),m=r("transformers"),v=r(" accept two formats as input:"),d=l(),h=n("ul"),E=n("li"),Qe=r("having all inputs as keyword arguments (like PyTorch models), or"),Ge=l(),L=n("li"),Pe=r("having all inputs as a list, tuple or dict in the first positional argument."),$e=l(),q=n("p"),ie=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),je.forEach(t),this.h()},h(){u(V,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(V,"rel","nofollow")},m(x,F){f(x,p,F),e(p,k),e(p,_),e(_,m),e(p,v),f(x,d,F),f(x,h,F),e(h,E),e(E,Qe),e(h,Ge),e(h,L),e(L,Pe),f(x,$e,F),f(x,q,F),e(q,ie),e(q,de),e(de,Je),e(q,Le),e(q,N),e(N,ee),e(q,xe),e(q,K),e(K,Xe),e(q,ze),e(q,le),e(le,Ne),e(q,te),e(q,ce),e(ce,ue),e(q,Ze),f(x,Fe,F),f(x,S,F),e(S,A),e(A,Ye),e(A,oe),e(oe,ne),e(A,qe),e(A,pe),e(pe,et),e(S,Ee),e(S,D),e(D,De),e(D,G),e(G,tt),e(D,he),e(D,me),e(me,ot),e(S,fe),e(S,Q),e(Q,nt),e(Q,se),e(se,J),f(x,H,F),f(x,I,F),e(I,ge),e(I,V),e(V,Ce),e(I,st)},d(x){x&&t(p),x&&t(d),x&&t(h),x&&t($e),x&&t(q),x&&t(Fe),x&&t(S),x&&t(H),x&&t(I)}}}function nv(z){let p,k,_,m,v;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,k),e(p,_),e(_,m),e(p,v)},d(d){d&&t(p)}}}function sv(z){let p,k,_,m,v;return m=new He({props:{code:`from transformers import PegasusTokenizer, TFPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function av(z){let p,k,_,m,v,d,h,E,Qe,Ge,L,Pe,$e,q,ie,de,Je,Le,N,ee,xe,K,Xe,ze,le,Ne,te,ce,ue,Ze,Fe,S,A,Ye,oe,ne,qe,pe,et,Ee,D,De,G,tt,he,me,ot,fe,Q,nt,se,J,H,I,ge,V,Ce,st;return{c(){p=n("p"),k=r("TensorFlow models and layers in "),_=n("code"),m=r("transformers"),v=r(" accept two formats as input:"),d=l(),h=n("ul"),E=n("li"),Qe=r("having all inputs as keyword arguments (like PyTorch models), or"),Ge=l(),L=n("li"),Pe=r("having all inputs as a list, tuple or dict in the first positional argument."),$e=l(),q=n("p"),ie=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),de=n("code"),Je=r("model.fit()"),Le=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),N=n("code"),ee=r("model.fit()"),xe=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),K=n("code"),Xe=r("fit()"),ze=r(" and "),le=n("code"),Ne=r("predict()"),te=r(`, such as when creating your own layers or models with
the Keras `),ce=n("code"),ue=r("Functional"),Ze=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),se=s(dt,"CODE",{});var Me=a(se);J=i(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),dt.forEach(t),Z.forEach(t),H=c(x),I=s(x,"P",{});var je=a(I);ge=i(je,`Note that when creating models and layers with
`),V=s(je,"A",{href:!0,rel:!0});var Se=a(V);Ce=i(Se,"subclassing"),Se.forEach(t),st=i(je,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),je.forEach(t),this.h()},h(){u(V,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(V,"rel","nofollow")},m(x,F){f(x,p,F),e(p,k),e(p,_),e(_,m),e(p,v),f(x,d,F),f(x,h,F),e(h,E),e(E,Qe),e(h,Ge),e(h,L),e(L,Pe),f(x,$e,F),f(x,q,F),e(q,ie),e(q,de),e(de,Je),e(q,Le),e(q,N),e(N,ee),e(q,xe),e(q,K),e(K,Xe),e(q,ze),e(q,le),e(le,Ne),e(q,te),e(q,ce),e(ce,ue),e(q,Ze),f(x,Fe,F),f(x,S,F),e(S,A),e(A,Ye),e(A,oe),e(oe,ne),e(A,qe),e(A,pe),e(pe,et),e(S,Ee),e(S,D),e(D,De),e(D,G),e(G,tt),e(D,he),e(D,me),e(me,ot),e(S,fe),e(S,Q),e(Q,nt),e(Q,se),e(se,J),f(x,H,F),f(x,I,F),e(I,ge),e(I,V),e(V,Ce),e(I,st)},d(x){x&&t(p),x&&t(d),x&&t(h),x&&t($e),x&&t(q),x&&t(Fe),x&&t(S),x&&t(H),x&&t(I)}}}function rv(z){let p,k,_,m,v;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,k),e(p,_),e(_,m),e(p,v)},d(d){d&&t(p)}}}function iv(z){let p,k,_,m,v;return m=new He({props:{code:`from transformers import PegasusTokenizer, TFPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(summary_ids, skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">False</span>))`}}),{c(){p=n("p"),k=r("Summarization example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Summarization example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function dv(z){let p,k,_,m,v;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,k),e(p,_),e(_,m),e(p,v)},d(d){d&&t(p)}}}function lv(z){let p,k,_,m,v;return m=new He({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function cv(z){let p,k,_,m,v;return m=new He({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function uv(z){let p,k,_,m,v;return m=new He({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function pv(z){let p,k,_,m,v;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,k),e(p,_),e(_,m),e(p,v)},d(d){d&&t(p)}}}function hv(z){let p,k,_,m,v;return m=new He({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;np&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function mv(z){let p,k,_,m,v;return m=new He({props:{code:`import jax.numpy as jnp
from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);k=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,k),f(d,_,h),T(m,d,h),v=!0},p:ht,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){P(m.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function fv(z){let p,k,_,m,v,d,h,E,Qe,Ge,L,Pe,$e,q,ie,de,Je,Le,N,ee,xe,K,Xe,ze,le,Ne,te,ce,ue,Ze,Fe,S,A,Ye,oe,ne,qe,pe,et,Ee,D,De,G,tt,he,me,ot,fe,Q,nt,se,J,H,I,ge,V,Ce,st,x,F,Tt,X,wt,Pt,C,$t,xt,mt,B,at,Z,_e,rt,zt,ve,it,Ft,dt,Me,je,Se,ll,cl,ul,to,ln,pl,hl,cn,ml,fl,Li,qt,oo,$a,un,gl,xa,_l,Ni,ft,no,pn,vl,kl,hn,bl,yl,Tl,za,wl,Pl,Fa,$l,Di,Et,so,qa,mn,xl,Ea,zl,Ui,Te,Ca,Ma,Fl,ql,ja,Vs,El,Rs,Cl,Ml,fn,Sa,jl,Sl,Ct,Oa,Ol,Al,Aa,Il,Gl,gn,Ll,Ia,Nl,Dl,Ul,Ga,lt,Wl,La,Bl,Kl,Na,Vl,Rl,Da,Hl,Ql,Jl,Ua,Mt,Xl,_n,Zl,Yl,Wa,ec,tc,Wi,jt,ao,Ba,vn,oc,Ka,nc,Bi,kn,Ki,St,ro,Va,bn,sc,Ra,ac,Vi,Oe,yn,rc,Ot,ic,Hs,dc,lc,Tn,cc,uc,pc,At,hc,Qs,mc,fc,Js,gc,_c,vc,io,Ri,It,lo,Ha,wn,kc,Qa,bc,Hi,co,yc,Ja,Tc,wc,Qi,R,Pn,Pc,$n,$c,xn,xc,zc,Fc,zn,qc,Xs,Ec,Cc,Mc,Ue,Fn,jc,qn,Sc,Xa,Oc,Ac,Ic,En,Zs,Gc,Za,Lc,Nc,Cn,Dc,Ya,Uc,Wc,Bc,er,Kc,Vc,uo,Mn,Rc,tr,Hc,Qc,po,jn,Jc,or,Xc,Zc,ho,Sn,Yc,nr,eu,Ji,Gt,mo,sr,On,tu,ar,ou,Xi,ke,An,nu,Lt,su,rr,au,ru,In,iu,du,lu,Gn,cu,Ys,uu,pu,hu,gt,Ln,mu,ir,fu,gu,Nn,ea,_u,dr,vu,ku,Dn,bu,lr,yu,Tu,wu,fo,Un,Pu,cr,$u,Zi,Nt,go,ur,Wn,xu,pr,zu,Yi,Ae,Bn,Fu,Kn,qu,ta,Eu,Cu,Mu,Vn,ju,Rn,Su,Ou,Au,We,Hn,Iu,Dt,Gu,oa,Lu,Nu,hr,Du,Uu,Wu,_o,Bu,vo,ed,Ut,ko,mr,Qn,Ku,fr,Vu,td,Ie,Jn,Ru,Xn,Hu,na,Qu,Ju,Xu,Zn,Zu,Yn,Yu,ep,tp,Be,es,op,Wt,np,sa,sp,ap,gr,rp,ip,dp,bo,lp,yo,od,Bt,To,_r,ts,cp,vr,up,nd,Kt,os,pp,wo,ns,hp,Po,sd,Vt,$o,kr,ss,mp,br,fp,ad,be,as,gp,rs,_p,aa,vp,kp,bp,is,yp,ds,Tp,wp,Pp,xo,$p,Ke,ls,xp,Rt,zp,ra,Fp,qp,yr,Ep,Cp,Mp,zo,jp,Fo,rd,Ht,qo,Tr,cs,Sp,wr,Op,id,ye,us,Ap,ps,Ip,ia,Gp,Lp,Np,hs,Dp,ms,Up,Wp,Bp,Eo,Kp,Ve,fs,Vp,Qt,Rp,da,Hp,Qp,Pr,Jp,Xp,Zp,Co,Yp,Mo,dd,Jt,jo,$r,gs,eh,xr,th,ld,U,_s,oh,vs,nh,la,sh,ah,rh,ks,ih,bs,dh,lh,ch,zr,uh,ph,ct,Fr,ys,hh,mh,qr,Ts,fh,gh,Er,ws,_h,vh,Cr,Ps,kh,bh,Re,$s,yh,Xt,Th,Mr,wh,Ph,jr,$h,xh,zh,So,Fh,Oo,qh,Ao,xs,Eh,Io,Ch,Go,zs,Mh,Lo,cd,Zt,No,Sr,Fs,jh,Or,Sh,ud,W,qs,Oh,Es,Ah,ca,Ih,Gh,Lh,Cs,Nh,Ms,Dh,Uh,Wh,Ar,Bh,Kh,ut,Ir,js,Vh,Rh,Gr,Ss,Hh,Qh,Lr,Os,Jh,Xh,Nr,As,Zh,Yh,M,Is,em,Yt,tm,Dr,om,nm,Ur,sm,am,rm,Do,im,Wr,dm,lm,Br,Kr,Vr,Rr,cm,um,Hr,Qr,Jr,Xr,pm,hm,Zr,Yr,ei,ti,mm,fm,oi,ni,Gs,Uo,Wo,si,Ls,gm,ai,_m,vm,ri,km,bm,ii,ym,Tm,di,li,ci,ui,wm,Pm,pi,hi,mi,fi,$m,xm,gi,_i,vi,ki,zm,Fm,bi,yi,Ti,wi,qm,Em,Bo,Ns,Cm,Ko,Mm,Vo,Ds,jm,Ro,pd;return d=new Y({}),K=new Y({}),ge=new Y({}),un=new Y({}),mn=new Y({}),vn=new Y({}),kn=new He({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/tokenization_pegasus.py#L258",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.1/en/model_doc/pegasus#transformers.PegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/modeling_pegasus.py#L1359",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/modeling_pegasus.py#L1551",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1213",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1342",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/modeling_flax_pegasus.py#L986",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1049",returnDescription:`
<p>A <a
...
`}}),Lo=new pt({props:{anchor:"transformers.FlaxPegasusModel.decode.example",$$slots:{default:[uv]},$$scope:{ctx:z}}}),Fs=new Y({}),qs=new j({props:{name:"class transformers.FlaxPegasusForConditionalGeneration",anchor:"transformers.FlaxPegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1319",returnDescription:`
<p>A <a
...
`}}),Ro=new pt({props:{anchor:"transformers.FlaxPegasusForConditionalGeneration.decode.example",$$slots:{default:[mv]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=l(),_=n("h1"),m=n("a"),v=n("span"),b(d.$$.fragment),h=l(),E=n("span"),Qe=r("Pegasus"),Ge=l(),L=n("p"),Pe=n("strong"),$e=r("DISCLAIMER:"),q=r(" If you see something strange, file a "),ie=n("a"),de=r("Github Issue"),Je=r(`
...
found in `),Wa=n("code"),ec=r("convert_pegasus_tf_to_pytorch.py"),tc=r("."),Wi=l(),jt=n("h2"),ao=n("a"),Ba=n("span"),b(vn.$$.fragment),oc=l(),Ka=n("span"),nc=r("Usage Example"),Bi=l(),b(kn.$$.fragment),Ki=l(),St=n("h2"),ro=n("a"),Va=n("span"),b(bn.$$.fragment),sc=l(),Ra=n("span"),ac=r("PegasusConfig"),Vi=l(),Oe=n("div"),b(yn.$$.fragment),rc=l(),Ot=n("p"),ic=r("This is the configuration class to store the configuration of a "),Hs=n("a"),dc=r("PegasusModel"),lc=r(`. It is used to instantiate an
...
and behavior.`),Au=l(),We=n("div"),b(Hn.$$.fragment),Iu=l(),Dt=n("p"),Gu=r("The "),oa=n("a"),Lu=r("PegasusModel"),Nu=r(" forward method, overrides the "),hr=n("code"),Du=r("__call__"),Uu=r(" special method."),Wu=l(),b(_o.$$.fragment),Bu=l(),b(vo.$$.fragment),ed=l(),Ut=n("h2"),ko=n("a"),mr=n("span"),b(Qn.$$.fragment),Ku=l(),fr=n("span"),Vu=r("PegasusForConditionalGeneration"),td=l(),Ie=n("div"),b(Jn.$$.fragment),Ru=l(),Xn=n("p"),Hu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp=l(),Be=n("div"),b(es.$$.fragment),op=l(),Wt=n("p"),np=r("The "),sa=n("a"),sp=r("PegasusForConditionalGeneration"),ap=r(" forward method, overrides the "),gr=n("code"),rp=r("__call__"),ip=r(" special method."),dp=l(),b(bo.$$.fragment),lp=l(),b(yo.$$.fragment),od=l(),Bt=n("h2"),To=n("a"),_r=n("span"),b(ts.$$.fragment),cp=l(),vr=n("span"),up=r("PegasusForCausalLM"),nd=l(),Kt=n("div"),b(os.$$.fragment),pp=l(),wo=n("div"),b(ns.$$.fragment),hp=l(),b(Po.$$.fragment),sd=l(),Vt=n("h2"),$o=n("a"),kr=n("span"),b(ss.$$.fragment),mp=l(),br=n("span"),fp=r("TFPegasusModel"),ad=l(),be=n("div"),b(as.$$.fragment),gp=l(),rs=n("p"),_p=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),aa=n("a"),vp=r("TFPreTrainedModel"),kp=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bp=l(),b(Eo.$$.fragment),Kp=l(),Ve=n("div"),b(fs.$$.fragment),Vp=l(),Qt=n("p"),Rp=r("The "),da=n("a"),Hp=r("TFPegasusForConditionalGeneration"),Qp=r(" forward method, overrides the "),Pr=n("code"),Jp=r("__call__"),Xp=r(" special method."),Zp=l(),b(Co.$$.fragment),Yp=l(),b(Mo.$$.fragment),dd=l(),Jt=n("h2"),jo=n("a"),$r=n("span"),b(gs.$$.fragment),eh=l(),xr=n("span"),th=r("FlaxPegasusModel"),ld=l(),U=n("div"),b(_s.$$.fragment),oh=l(),vs=n("p"),nh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),fm=l(),oi=n("blockquote"),ni=n("blockquote"),Gs=n("blockquote"),Uo=n("h1"),Wo=n("a"),si=n("span"),b(Ls.$$.fragment),gm=l(),ai=n("span"),_m=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),vm=l(),ri=n("p"),km=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),bm=l(),ii=n("p"),ym=r("Mask filling example:"),Tm=l(),di=n("blockquote"),li=n("blockquote"),ci=n("blockquote"),ui=n("p"),wm=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
`),C=s(ua,"EM",{});var Um=a(C);$t=i(Um,"pegasus-large"),Um.forEach(t),xt=i(ua,", whence the other checkpoints are fine-tuned:"),ua.forEach(t),mt=c(o),B=s(o,"UL",{});var _t=a(B);at=s(_t,"LI",{});var Wm=a(at);Z=i(Wm,"Each checkpoint is 2.2 GB on disk and 568M parameters."),Wm.forEach(t),_e=c(_t),rt=s(_t,"LI",{});var Bm=a(rt);zt=i(Bm,"FP16 is not supported (help/ideas on this appreciated!)."),Bm.forEach(t),ve=c(_t),it=s(_t,"LI",{});var Km=a(it);Ft=i(Km,"Summarizing xsum in fp32 takes about 400ms/sample, with default parameters on a v100 GPU."),Km.forEach(t),dt=c(_t),Me=s(_t,"LI",{});var md=a(Me);je=i(md,"Full replication results and correctly pre-processed data can be found in this "),Se=s(md,"A",{href:!0,rel:!0});var Vm=a(Se);ll=i(Vm,"Issue"),Vm.forEach(t),cl=i(md,"."),md.forEach(t),ul=c(_t),to=s(_t,"LI",{});var Ii=a(to);ln=s(Ii,"A",{href:!0,rel:!0});var Rm=a(ln);pl=i(Rm,"Distilled checkpoints"),Rm.forEach(t),hl=i(Ii," are described in this "),cn=s(Ii,"A",{href:!0,rel:!0});var Hm=a(cn);ml=i(Hm,"paper"),Hm.forEach(t),fl=i(Ii,"."),Ii.forEach(t),_t.forEach(t),Li=c(o),qt=s(o,"H3",{class:!0});var fd=a(qt);oo=s(fd,"A",{id:!0,class:!0,href:!0});var Qm=a(oo);$a=s(Qm,"SPAN",{});var Jm=a($a);y(un.$$.fragment,Jm),Jm.forEach(t),Qm.forEach(t),gl=c(fd),xa=s(fd,"SPAN",{});var Xm=a(xa);_l=i(Xm,"Examples"),Xm.forEach(t),fd.forEach(t),Ni=c(o),ft=s(o,"UL",{});var pa=a(ft);no=s(pa,"LI",{});var Gi=a(no);pn=s(Gi,"A",{href:!0,rel:!0});var Zm=a(pn);vl=i(Zm,"Script"),Zm.forEach(t),kl=i(Gi,` to fine-tune pegasus
on the XSUM dataset. Data download instructions at `),hn=s(Gi,"A",{href:!0,rel:!0});var Ym=a(hn);bl=i(Ym,"examples/pytorch/summarization/"),Ym.forEach(t),yl=i(Gi,"."),Gi.forEach(t),Tl=c(pa),za=s(pa,"LI",{});var ef=a(za);wl=i(ef,"FP16 is not supported (help/ideas on this appreciated!)."),ef.forEach(t),Pl=c(pa),Fa=s(pa,"LI",{});var tf=a(Fa);$l=i(tf,"The adafactor optimizer is recommended for pegasus fine-tuning."),tf.forEach(t),pa.forEach(t),Di=c(o),Et=s(o,"H2",{class:!0});var gd=a(Et);so=s(gd,"A",{id:!0,class:!0,href:!0});var of=a(so);qa=s(of,"SPAN",{});var nf=a(qa);y(mn.$$.fragment,nf),nf.forEach(t),of.forEach(t),xl=c(gd),Ea=s(gd,"SPAN",{});var sf=a(Ea);zl=i(sf,"Implementation Notes"),sf.forEach(t),gd.forEach(t),Ui=c(o),Te=s(o,"UL",{});var vt=a(Te);Ca=s(vt,"LI",{});var af=a(Ca);Ma=s(af,"P",{});var rf=a(Ma);Fl=i(rf,"All models are transformer encoder-decoders with 16 layers in each component."),rf.forEach(t),af.forEach(t),ql=c(vt),ja=s(vt,"LI",{});var df=a(ja);Vs=s(df,"P",{});var Sm=a(Vs);El=i(Sm,"The implementation is completely inherited from "),Rs=s(Sm,"A",{href:!0});var lf=a(Rs);Cl=i(lf,"BartForConditionalGeneration"),lf.forEach(t),Sm.forEach(t),df.forEach(t),Ml=c(vt),fn=s(vt,"LI",{});var _d=a(fn);Sa=s(_d,"P",{});var cf=a(Sa);jl=i(cf,"Some key configuration differences:"),cf.forEach(t),Sl=c(_d),Ct=s(_d,"UL",{});var ha=a(Ct);Oa=s(ha,"LI",{});var uf=a(Oa);Ol=i(uf,"static, sinusoidal position embeddings"),uf.forEach(t),Al=c(ha),Aa=s(ha,"LI",{});var pf=a(Aa);Il=i(pf,"the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),pf.forEach(t),Gl=c(ha),gn=s(ha,"LI",{});var vd=a(gn);Ll=i(vd,"more beams are used ("),Ia=s(vd,"CODE",{});var hf=a(Ia);Nl=i(hf,"num_beams=8"),hf.forEach(t),Dl=i(vd,")"),vd.forEach(t),ha.forEach(t),_d.forEach(t),Ul=c(vt),Ga=s(vt,"LI",{});var mf=a(Ga);lt=s(mf,"P",{});var Qo=a(lt);Wl=i(Qo,"All pretrained pegasus checkpoints are the same besides three attributes: "),La=s(Qo,"CODE",{});var ff=a(La);Bl=i(ff,"tokenizer.model_max_length"),ff.forEach(t),Kl=i(Qo,` (maximum
input size), `),Na=s(Qo,"CODE",{});var gf=a(Na);Vl=i(gf,"max_length"),gf.forEach(t),Rl=i(Qo," (the maximum number of tokens to generate) and "),Da=s(Qo,"CODE",{});var _f=a(Da);Hl=i(_f,"length_penalty"),_f.forEach(t),Ql=i(Qo,"."),Qo.forEach(t),mf.forEach(t),Jl=c(vt),Ua=s(vt,"LI",{});var vf=a(Ua);Mt=s(vf,"P",{});var ma=a(Mt);Xl=i(ma,"The code to convert checkpoints trained in the author\u2019s "),_n=s(ma,"A",{href:!0,rel:!0});var kf=a(_n);Zl=i(kf,"repo"),kf.forEach(t),Yl=i(ma,` can be
found in `),Wa=s(ma,"CODE",{});var bf=a(Wa);ec=i(bf,"convert_pegasus_tf_to_pytorch.py"),bf.forEach(t),tc=i(ma,"."),ma.forEach(t),vf.forEach(t),vt.forEach(t),Wi=c(o),jt=s(o,"H2",{class:!0});var kd=a(jt);ao=s(kd,"A",{id:!0,class:!0,href:!0});var yf=a(ao);Ba=s(yf,"SPAN",{});var Tf=a(Ba);y(vn.$$.fragment,Tf),Tf.forEach(t),yf.forEach(t),oc=c(kd),Ka=s(kd,"SPAN",{});var wf=a(Ka);nc=i(wf,"Usage Example"),wf.forEach(t),kd.forEach(t),Bi=c(o),y(kn.$$.fragment,o),Ki=c(o),St=s(o,"H2",{class:!0});var bd=a(St);ro=s(bd,"A",{id:!0,class:!0,href:!0});var Pf=a(ro);Va=s(Pf,"SPAN",{});var $f=a(Va);y(bn.$$.fragment,$f),$f.forEach(t),Pf.forEach(t),sc=c(bd),Ra=s(bd,"SPAN",{});var xf=a(Ra);ac=i(xf,"PegasusConfig"),xf.forEach(t),bd.forEach(t),Vi=c(o),Oe=s(o,"DIV",{class:!0});var Jo=a(Oe);y(yn.$$.fragment,Jo),rc=c(Jo),Ot=s(Jo,"P",{});var fa=a(Ot);ic=i(fa,"This is the configuration class to store the configuration of a "),Hs=s(fa,"A",{href:!0});var zf=a(Hs);dc=i(zf,"PegasusModel"),zf.forEach(t),lc=i(fa,`. It is used to instantiate an
PEGASUS model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PEGASUS
...
separator.`),Nf.forEach(t),Xo.forEach(t),Vc=c(we),uo=s(we,"DIV",{class:!0});var Fd=a(uo);y(Mn.$$.fragment,Fd),Rc=c(Fd),tr=s(Fd,"P",{});var Df=a(tr);Hc=i(Df,"Converts a sequence of tokens (string) in a single string."),Df.forEach(t),Fd.forEach(t),Qc=c(we),po=s(we,"DIV",{class:!0});var qd=a(po);y(jn.$$.fragment,qd),Jc=c(qd),or=s(qd,"P",{});var Uf=a(or);Xc=i(Uf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Uf.forEach(t),qd.forEach(t),Zc=c(we),ho=s(we,"DIV",{class:!0});var Ed=a(ho);y(Sn.$$.fragment,Ed),Yc=c(Ed),nr=s(Ed,"P",{});var Wf=a(nr);eu=i(Wf,"Just EOS"),Wf.forEach(t),Ed.forEach(t),we.forEach(t),Ji=c(o),Gt=s(o,"H2",{class:!0});var Cd=a(Gt);mo=s(Cd,"A",{id:!0,class:!0,href:!0});var Bf=a(mo);sr=s(Bf,"SPAN",{});var Kf=a(sr);y(On.$$.fragment,Kf),Kf.forEach(t),Bf.forEach(t),tu=c(Cd),ar=s(Cd,"SPAN",{});var Vf=a(ar);ou=i(Vf,"PegasusTokenizerFast"),Vf.forEach(t),Cd.forEach(t),Xi=c(o),ke=s(o,"DIV",{class:!0});var kt=a(ke);y(An.$$.fragment,kt),nu=c(kt),Lt=s(kt,"P",{});var _a=a(Lt);su=i(_a,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),rr=s(_a,"EM",{});var Rf=a(rr);au=i(Rf,"tokenizers"),Rf.forEach(t),ru=i(_a,` library). Based on
`),In=s(_a,"A",{href:!0,rel:!0});var Hf=a(In);iu=i(Hf,"Unigram"),Hf.forEach(t),du=i(_a,"."),_a.forEach(t),lu=c(kt),Gn=s(kt,"P",{});var Md=a(Gn);cu=i(Md,"This tokenizer inherits from "),Ys=s(Md,"A",{href:!0});var Qf=a(Ys);uu=i(Qf,"PreTrainedTokenizerFast"),Qf.forEach(t),pu=i(Md,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Md.forEach(t),hu=c(kt),gt=s(kt,"DIV",{class:!0});var va=a(gt);y(Ln.$$.fragment,va),mu=c(va),ir=s(va,"P",{});var Jf=a(ir);fu=i(Jf,"Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),Jf.forEach(t),gu=c(va),Nn=s(va,"UL",{});var jd=a(Nn);ea=s(jd,"LI",{});var Am=a(ea);_u=i(Am,"single sequence: "),dr=s(Am,"CODE",{});var Xf=a(dr);vu=i(Xf,"X </s>"),Xf.forEach(t),Am.forEach(t),ku=c(jd),Dn=s(jd,"LI",{});var Sd=a(Dn);bu=i(Sd,"pair of sequences: "),lr=s(Sd,"CODE",{});var Zf=a(lr);yu=i(Zf,"A B </s>"),Zf.forEach(t),Tu=i(Sd," (not intended use)"),Sd.forEach(t),jd.forEach(t),va.forEach(t),wu=c(kt),fo=s(kt,"DIV",{class:!0});var Od=a(fo);y(Un.$$.fragment,Od),Pu=c(Od),cr=s(Od,"P",{});var Yf=a(cr);$u=i(Yf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Yf.forEach(t),Od.forEach(t),kt.forEach(t),Zi=c(o),Nt=s(o,"H2",{class:!0});var Ad=a(Nt);go=s(Ad,"A",{id:!0,class:!0,href:!0});var eg=a(go);ur=s(eg,"SPAN",{});var tg=a(ur);y(Wn.$$.fragment,tg),tg.forEach(t),eg.forEach(t),xu=c(Ad),pr=s(Ad,"SPAN",{});var og=a(pr);zu=i(og,"PegasusModel"),og.forEach(t),Ad.forEach(t),Yi=c(o),Ae=s(o,"DIV",{class:!0});var Zo=a(Ae);y(Bn.$$.fragment,Zo),Fu=c(Zo),Kn=s(Zo,"P",{});var Id=a(Kn);qu=i(Id,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gd.forEach(t),Au=c(Zo),We=s(Zo,"DIV",{class:!0});var Yo=a(We);y(Hn.$$.fragment,Yo),Iu=c(Yo),Dt=s(Yo,"P",{});var ka=a(Dt);Gu=i(ka,"The "),oa=s(ka,"A",{href:!0});var ag=a(oa);Lu=i(ag,"PegasusModel"),ag.forEach(t),Nu=i(ka," forward method, overrides the "),hr=s(ka,"CODE",{});var rg=a(hr);Du=i(rg,"__call__"),rg.forEach(t),Uu=i(ka," special method."),ka.forEach(t),Wu=c(Yo),y(_o.$$.fragment,Yo),Bu=c(Yo),y(vo.$$.fragment,Yo),Yo.forEach(t),Zo.forEach(t),ed=c(o),Ut=s(o,"H2",{class:!0});var Ld=a(Ut);ko=s(Ld,"A",{id:!0,class:!0,href:!0});var ig=a(ko);mr=s(ig,"SPAN",{});var dg=a(mr);y(Qn.$$.fragment,dg),dg.forEach(t),ig.forEach(t),Ku=c(Ld),fr=s(Ld,"SPAN",{});var lg=a(fr);Vu=i(lg,"PegasusForConditionalGeneration"),lg.forEach(t),Ld.forEach(t),td=c(o),Ie=s(o,"DIV",{class:!0});var en=a(Ie);y(Jn.$$.fragment,en),Ru=c(en),Xn=s(en,"P",{});var Nd=a(Xn);Hu=i(Nd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd.forEach(t),tp=c(en),Be=s(en,"DIV",{class:!0});var tn=a(Be);y(es.$$.fragment,tn),op=c(tn),Wt=s(tn,"P",{});var ba=a(Wt);np=i(ba,"The "),sa=s(ba,"A",{href:!0});var pg=a(sa);sp=i(pg,"PegasusForConditionalGeneration"),pg.forEach(t),ap=i(ba," forward method, overrides the "),gr=s(ba,"CODE",{});var hg=a(gr);rp=i(hg,"__call__"),hg.forEach(t),ip=i(ba," special method."),ba.forEach(t),dp=c(tn),y(bo.$$.fragment,tn),lp=c(tn),y(yo.$$.fragment,tn),tn.forEach(t),en.forEach(t),od=c(o),Bt=s(o,"H2",{class:!0});var Ud=a(Bt);To=s(Ud,"A",{id:!0,class:!0,href:!0});var mg=a(To);_r=s(mg,"SPAN",{});var fg=a(_r);y(ts.$$.fragment,fg),fg.forEach(t),mg.forEach(t),cp=c(Ud),vr=s(Ud,"SPAN",{});var gg=a(vr);up=i(gg,"PegasusForCausalLM"),gg.forEach(t),Ud.forEach(t),nd=c(o),Kt=s(o,"DIV",{class:!0});var Wd=a(Kt);y(os.$$.fragment,Wd),pp=c(Wd),wo=s(Wd,"DIV",{class:!0});var Bd=a(wo);y(ns.$$.fragment,Bd),hp=c(Bd),y(Po.$$.fragment,Bd),Bd.forEach(t),Wd.forEach(t),sd=c(o),Vt=s(o,"H2",{class:!0});var Kd=a(Vt);$o=s(Kd,"A",{id:!0,class:!0,href:!0});var _g=a($o);kr=s(_g,"SPAN",{});var vg=a(kr);y(ss.$$.fragment,vg),vg.forEach(t),_g.forEach(t),mp=c(Kd),br=s(Kd,"SPAN",{});var kg=a(br);fp=i(kg,"TFPegasusModel"),kg.forEach(t),Kd.forEach(t),ad=c(o),be=s(o,"DIV",{class:!0});var bt=a(be);y(as.$$.fragment,bt),gp=c(bt),rs=s(bt,"P",{});var Vd=a(rs);_p=i(Vd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),aa=s(Vd,"A",{href:!0});var bg=a(aa);vp=i(bg,"TFPreTrainedModel"),bg.forEach(t),kp=i(Vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019)`),__.forEach(t),g_.forEach(t),f_.forEach(t),m_.forEach(t),hm=c(O),Zr=s(O,"BLOCKQUOTE",{});var v_=a(Zr);Yr=s(v_,"BLOCKQUOTE",{});var k_=a(Yr);ei=s(k_,"BLOCKQUOTE",{});var b_=a(ei);ti=s(b_,"P",{});var y_=a(ti);mm=i(y_,`ARTICLE_TO_SUMMARIZE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs =
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),y_.forEach(t),b_.forEach(t),k_.forEach(t),v_.forEach(t),fm=c(O),oi=s(O,"BLOCKQUOTE",{});var T_=a(oi);ni=s(T_,"BLOCKQUOTE",{});var w_=a(ni);Gs=s(w_,"BLOCKQUOTE",{});var al=a(Gs);Uo=s(al,"H1",{class:!0});var rl=a(Uo);Wo=s(rl,"A",{id:!0,class:!0,href:!0});var P_=a(Wo);si=s(P_,"SPAN",{});var $_=a(si);y(Ls.$$.fragment,$_),$_.forEach(t),P_.forEach(t),gm=c(rl),ai=s(rl,"SPAN",{});var x_=a(ai);_m=i(x_,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),x_.forEach(t),rl.forEach(t),vm=c(al),ri=s(al,"P",{});var z_=a(ri);km=i(z_,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),z_.forEach(t),al.forEach(t),w_.forEach(t),T_.forEach(t),bm=c(O),ii=s(O,"P",{});var F_=a(ii);ym=i(F_,"Mask filling example:"),F_.forEach(t),Tm=c(O),di=s(O,"BLOCKQUOTE",{});var q_=a(di);li=s(q_,"BLOCKQUOTE",{});var E_=a(li);ci=s(E_,"BLOCKQUOTE",{});var C_=a(ci);ui=s(C_,"P",{});var M_=a(ui);wm=i(M_,`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019) >>> TXT = \u201CMy friends are <mask> but they eat too many
