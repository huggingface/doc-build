import{S as Nh,i as Lh,s as Dh,e as n,k as p,w,t as a,M as Oh,c as r,d as t,m as h,a as i,x as y,h as s,b as c,G as e,g as _,y as $,q as x,o as E,B as k,v as Sh,L as Co}from"../../chunks/vendor-hf-doc-builder.js";import{T as ct}from"../../chunks/Tip-hf-doc-builder.js";import{D as Y}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Po}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as pt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as jo}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Wh(I){let d,T,m,u,v;return{c(){d=n("p"),T=a(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),m=n("a"),u=a("Github Issue"),v=a("."),this.h()},l(l){d=r(l,"P",{});var f=i(d);T=s(f,`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),m=r(f,"A",{href:!0,rel:!0});var V=i(m);u=s(V,"Github Issue"),V.forEach(t),v=s(f,"."),f.forEach(t),this.h()},h(){c(m,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),c(m,"rel","nofollow")},m(l,f){_(l,d,f),e(d,T),e(d,m),e(m,u),e(d,v)},d(l){l&&t(d)}}}function Bh(I){let d,T,m,u,v;return u=new Po({props:{code:`from transformers import ViTModel, ViTConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=n("p"),T=a("Example:"),m=p(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Example:"),f.forEach(t),m=h(l),y(u.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,m,f),$(u,l,f),v=!0},p:Co,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function Uh(I){let d,T;return{c(){d=n("p"),T=a(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
PIL images.`),u.forEach(t)},m(m,u){_(m,d,u),e(d,T)},d(m){m&&t(d)}}}function Rh(I){let d,T,m,u,v;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),u=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var V=i(m);u=s(V,"Module"),V.forEach(t),v=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){_(l,d,f),e(d,T),e(d,m),e(m,u),e(d,v)},d(l){l&&t(d)}}}function Hh(I){let d,T,m,u,v;return u=new Po({props:{code:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">197</span>, <span class="hljs-number">768</span>]`}}),{c(){d=n("p"),T=a("Example:"),m=p(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Example:"),f.forEach(t),m=h(l),y(u.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,m,f),$(u,l,f),v=!0},p:Co,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function Kh(I){let d,T,m,u,v;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),u=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var V=i(m);u=s(V,"Module"),V.forEach(t),v=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){_(l,d,f),e(d,T),e(d,m),e(m,u),e(d,v)},d(l){l&&t(d)}}}function Jh(I){let d,T,m,u,v;return u=new Po({props:{code:`from transformers import ViTFeatureExtractor, ViTForMaskedImageModeling
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),{c(){d=n("p"),T=a("Examples:"),m=p(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Examples:"),f.forEach(t),m=h(l),y(u.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,m,f),$(u,l,f),v=!0},p:Co,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function Gh(I){let d,T,m,u,v;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),u=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var V=i(m);u=s(V,"Module"),V.forEach(t),v=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){_(l,d,f),e(d,T),e(d,m),e(m,u),e(d,v)},d(l){l&&t(d)}}}function Xh(I){let d,T,m,u,v;return u=new Po({props:{code:`from transformers import ViTFeatureExtractor, ViTForImageClassification
import torch
from datasets import load_dataset
...
Egyptian cat`}}),{c(){d=n("p"),T=a("Example:"),m=p(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Example:"),f.forEach(t),m=h(l),y(u.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,m,f),$(u,l,f),v=!0},p:Co,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function Zh(I){let d,T,m,u,v,l,f,V,Ge,Pe,L,Ae,S,F,ye,W,Xe,$e,te,qe,ee,oe,ae,Ze,se,ze,_e,ne,Ne,ve,re,P,q,Te,ie,Le,C,B,Qe,le,z,Ye,de,xe,et,ce,pe,tt,D,ot,he,at,U,N,Ee,R,st,fe;return{c(){d=n("p"),T=a("TensorFlow models and layers in "),m=n("code"),u=a("transformers"),v=a(" accept two formats as input:"),l=p(),f=n("ul"),V=n("li"),Ge=a("having all inputs as keyword arguments (like PyTorch models), or"),Pe=p(),L=n("li"),Ae=a("having all inputs as a list, tuple or dict in the first positional argument."),S=p(),F=n("p"),ye=a(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
positional argument:`),j.forEach(t),re=h(b),P=r(b,"UL",{});var A=i(P);q=r(A,"LI",{});var me=i(q);Te=s(me,"a single Tensor with "),ie=r(me,"CODE",{});var Ve=i(ie);Le=s(Ve,"pixel_values"),Ve.forEach(t),C=s(me," only and nothing else: "),B=r(me,"CODE",{});var bt=i(B);Qe=s(bt,"model(pixel_values)"),bt.forEach(t),me.forEach(t),le=h(A),z=r(A,"LI",{});var ue=i(z);Ye=s(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),R=r(ge,"A",{href:!0,rel:!0});var $t=i(R);st=s($t,"subclassing"),$t.forEach(t),fe=s(ge,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ge.forEach(t),this.h()},h(){c(R,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),c(R,"rel","nofollow")},m(b,M){_(b,d,M),e(d,T),e(d,m),e(m,u),e(d,v),_(b,l,M),_(b,f,M),e(f,V),e(V,Ge),e(f,Pe),e(f,L),e(L,Ae),_(b,S,M),_(b,F,M),e(F,ye),e(F,W),e(W,Xe),e(F,$e),e(F,te),e(te,qe),e(F,ee),e(F,oe),e(oe,ae),e(F,Ze),e(F,se),e(se,ze),e(F,_e),e(F,ne),e(ne,Ne),e(F,ve),_(b,re,M),_(b,P,M),e(P,q),e(q,Te),e(q,ie),e(ie,Le),e(q,C),e(q,B),e(B,Qe),e(P,le),e(P,z),e(z,Ye),e(z,de),e(de,xe),e(z,et),e(z,ce),e(ce,pe),e(P,tt),e(P,D),e(D,ot),e(D,he),e(he,at),_(b,U,M),_(b,N,M),e(N,Ee),e(N,R),e(R,st),e(N,fe)},d(b){b&&t(d),b&&t(l),b&&t(f),b&&t(S),b&&t(F),b&&t(re),b&&t(P),b&&t(U),b&&t(N)}}}function Qh(I){let d,T,m,u,v;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),u=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var V=i(m);u=s(V,"Module"),V.forEach(t),v=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){_(l,d,f),e(d,T),e(d,m),e(m,u),e(d,v)},d(l){l&&t(d)}}}function Yh(I){let d,T,m,u,v;return u=new Po({props:{code:`from transformers import ViTFeatureExtractor, TFViTModel
from datasets import load_dataset
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(last_hidden_states.shape)
[<span class="hljs-number">1</span>, <span class="hljs-number">197</span>, <span class="hljs-number">768</span>]`}}),{c(){d=n("p"),T=a("Example:"),m=p(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Example:"),f.forEach(t),m=h(l),y(u.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,m,f),$(u,l,f),v=!0},p:Co,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function ef(I){let d,T,m,u,v,l,f,V,Ge,Pe,L,Ae,S,F,ye,W,Xe,$e,te,qe,ee,oe,ae,Ze,se,ze,_e,ne,Ne,ve,re,P,q,Te,ie,Le,C,B,Qe,le,z,Ye,de,xe,et,ce,pe,tt,D,ot,he,at,U,N,Ee,R,st,fe;return{c(){d=n("p"),T=a("TensorFlow models and layers in "),m=n("code"),u=a("transformers"),v=a(" accept two formats as input:"),l=p(),f=n("ul"),V=n("li"),Ge=a("having all inputs as keyword arguments (like PyTorch models), or"),Pe=p(),L=n("li"),Ae=a("having all inputs as a list, tuple or dict in the first positional argument."),S=p(),F=n("p"),ye=a(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),W=n("code"),Xe=a("model.fit()"),$e=a(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),te=n("code"),qe=a("model.fit()"),ee=a(` supports! If, however, you want to use the second
format outside of Keras methods like `),oe=n("code"),ae=a("fit()"),Ze=a(" and "),se=n("code"),ze=a("predict()"),_e=a(`, such as when creating your own layers or models with
the Keras `),ne=n("code"),Ne=a("Functional"),ve=a(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),he=r(nt,"CODE",{});var yt=i(he);at=s(yt,'model({"pixel_values": pixel_values, "token_type_ids": token_type_ids})'),yt.forEach(t),nt.forEach(t),A.forEach(t),U=h(b),N=r(b,"P",{});var ge=i(N);Ee=s(ge,`Note that when creating models and layers with
`),R=r(ge,"A",{href:!0,rel:!0});var $t=i(R);st=s($t,"subclassing"),$t.forEach(t),fe=s(ge,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ge.forEach(t),this.h()},h(){c(R,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),c(R,"rel","nofollow")},m(b,M){_(b,d,M),e(d,T),e(d,m),e(m,u),e(d,v),_(b,l,M),_(b,f,M),e(f,V),e(V,Ge),e(f,Pe),e(f,L),e(L,Ae),_(b,S,M),_(b,F,M),e(F,ye),e(F,W),e(W,Xe),e(F,$e),e(F,te),e(te,qe),e(F,ee),e(F,oe),e(oe,ae),e(F,Ze),e(F,se),e(se,ze),e(F,_e),e(F,ne),e(ne,Ne),e(F,ve),_(b,re,M),_(b,P,M),e(P,q),e(q,Te),e(q,ie),e(ie,Le),e(q,C),e(q,B),e(B,Qe),e(P,le),e(P,z),e(z,Ye),e(z,de),e(de,xe),e(z,et),e(z,ce),e(ce,pe),e(P,tt),e(P,D),e(D,ot),e(D,he),e(he,at),_(b,U,M),_(b,N,M),e(N,Ee),e(N,R),e(R,st),e(N,fe)},d(b){b&&t(d),b&&t(l),b&&t(f),b&&t(S),b&&t(F),b&&t(re),b&&t(P),b&&t(U),b&&t(N)}}}function tf(I){let d,T,m,u,v;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),u=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var V=i(m);u=s(V,"Module"),V.forEach(t),v=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){_(l,d,f),e(d,T),e(d,m),e(m,u),e(d,v)},d(l){l&&t(d)}}}function of(I){let d,T,m,u,v;return u=new Po({props:{code:`from transformers import ViTFeatureExtractor, TFViTForImageClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(model.config.id2label[predicted_label])
Egyptian cat`}}),{c(){d=n("p"),T=a("Example:"),m=p(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Example:"),f.forEach(t),m=h(l),y(u.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,m,f),$(u,l,f),v=!0},p:Co,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function af(I){let d,T,m,u,v;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),u=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var V=i(m);u=s(V,"Module"),V.forEach(t),v=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){_(l,d,f),e(d,T),e(d,m),e(m,u),e(d,v)},d(l){l&&t(d)}}}function sf(I){let d,T,m,u,v;return u=new Po({props:{code:`from transformers import ViTFeatureExtractor, FlaxViTModel
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=a("Examples:"),m=p(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Examples:"),f.forEach(t),m=h(l),y(u.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,m,f),$(u,l,f),v=!0},p:Co,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function nf(I){let d,T,m,u,v;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),u=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var V=i(m);u=s(V,"Module"),V.forEach(t),v=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){_(l,d,f),e(d,T),e(d,m),e(m,u),e(d,v)},d(l){l&&t(d)}}}function rf(I){let d,T,m,u,v;return u=new Po({props:{code:`from transformers import ViTFeatureExtractor, FlaxViTForImageClassification
from PIL import Image
import jax
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){d=n("p"),T=a("Example:"),m=p(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var f=i(d);T=s(f,"Example:"),f.forEach(t),m=h(l),y(u.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,m,f),$(u,l,f),v=!0},p:Co,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function lf(I){let d,T,m,u,v,l,f,V,Ge,Pe,L,Ae,S,F,ye,W,Xe,$e,te,qe,ee,oe,ae,Ze,se,ze,_e,ne,Ne,ve,re,P,q,Te,ie,Le,C,B,Qe,le,z,Ye,de,xe,et,ce,pe,tt,D,ot,he,at,U,N,Ee,R,st,fe,b,M,mt,H,ut,ke,j,gt,Fe,_t,vt,Tt,A,me,Ve,bt,ue,Ie,wt,nt,yt,ge,$t,Sn,Ua,Cr,Wn,De,Is,O,Ra,Pr,Ar,Ha,qr,zr,Ka,Nr,Lr,Ms,Dr,Or,js,Sr,Wr,Cs,Br,Ur,Ps,Rr,Hr,Ja,Kr,Jr,Gr,As,Ga,Xa,Xr,Zr,Qr,qs,Ao,Yr,qo,ei,ti,oi,zs,Za,Qa,ai,si,Bn,ht,ni,zo,ri,ii,No,li,di,Un,Bt,ci,Lo,pi,hi,Rn,xt,Ut,Ns,Do,fi,Ls,mi,Hn,Me,Oo,ui,Et,gi,Ya,_i,vi,So,Ti,bi,wi,kt,yi,es,$i,xi,ts,Ei,ki,Fi,Rt,Kn,Ft,Ht,Ds,Wo,Vi,Os,Ii,Jn,je,Bo,Mi,Ss,ji,Ci,Uo,Pi,os,Ai,qi,zi,ft,Ro,Ni,Ws,Li,Di,Kt,Gn,Vt,Jt,Bs,Ho,Oi,Us,Si,Xn,rt,Ko,Wi,Jo,Bi,Go,Ui,Ri,Hi,Oe,Xo,Ki,It,Ji,as,Gi,Xi,Rs,Zi,Qi,Yi,Gt,el,Xt,Zn,Mt,Zt,Hs,Zo,tl,Ks,ol,Qn,it,Qo,al,jt,sl,Yo,nl,rl,ea,il,ll,dl,Se,ta,cl,Ct,pl,ss,hl,fl,Js,ml,ul,gl,Qt,_l,Yt,Yn,Pt,eo,Gs,oa,vl,Xs,Tl,er,Ce,aa,bl,Zs,wl,yl,sa,$l,na,xl,El,kl,We,ra,Fl,At,Vl,ns,Il,Ml,Qs,jl,Cl,Pl,to,Al,oo,tr,qt,ao,Ys,ia,ql,en,zl,or,G,la,Nl,tn,Ll,Dl,da,Ol,rs,Sl,Wl,Bl,ca,Ul,pa,Rl,Hl,Kl,so,Jl,Be,ha,Gl,zt,Xl,is,Zl,Ql,on,Yl,ed,td,no,od,ro,ar,Nt,io,an,fa,ad,sn,sd,sr,X,ma,nd,nn,rd,id,ua,ld,ls,dd,cd,pd,ga,hd,_a,fd,md,ud,lo,gd,Ue,va,_d,Lt,vd,ds,Td,bd,rn,wd,yd,$d,co,xd,po,nr,Dt,ho,ln,Ta,Ed,dn,kd,rr,K,ba,Fd,cn,Vd,Id,wa,Md,cs,jd,Cd,Pd,ya,Ad,$a,qd,zd,Nd,pn,Ld,Dd,lt,hn,xa,Od,Sd,fn,Ea,Wd,Bd,mn,ka,Ud,Rd,un,Fa,Hd,Kd,Re,Va,Jd,Ot,Gd,gn,Xd,Zd,_n,Qd,Yd,ec,fo,tc,mo,ir,St,uo,vn,Ia,oc,Tn,ac,lr,J,Ma,sc,bn,nc,rc,ja,ic,ps,lc,dc,cc,Ca,pc,Pa,hc,fc,mc,wn,uc,gc,dt,yn,Aa,_c,vc,$n,qa,Tc,bc,xn,za,wc,yc,En,Na,$c,xc,He,La,Ec,Wt,kc,kn,Fc,Vc,Fn,Ic,Mc,jc,go,Cc,_o,dr;return l=new pt({}),L=new ct({props:{$$slots:{default:[Wh]},$$scope:{ctx:I}}}),W=new pt({}),Do=new pt({}),Oo=new Y({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/vit/feature_extraction_vit.py#L82",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/vit/modeling_vit.py#L522",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.1/en/model_doc/vit#transformers.ViTConfig"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/vit/modeling_vit.py#L622",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/vit/modeling_vit.py#L731",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/vit/modeling_tf_vit.py#L667",returnDescription:`
<p>A <a
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/vit/modeling_tf_vit.py#L753",returnDescription:`
<p>A <a
...
`}}),co=new ct({props:{$$slots:{default:[tf]},$$scope:{ctx:I}}}),po=new jo({props:{anchor:"transformers.TFViTForImageClassification.call.example",$$slots:{default:[of]},$$scope:{ctx:I}}}),Ta=new pt({}),ba=new Y({props:{name:"class transformers.FlaxViTModel",anchor:"transformers.FlaxViTModel",parameters:[{name:"config",val:": ViTConfig"},{name:"input_shape",val:" = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxViTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/vit/modeling_flax_vit.py#L536"}}),Va=new Y({props:{name:"__call__",anchor:"transformers.FlaxViTModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/vit/modeling_flax_vit.py#L451",returnDescription:`
<p>A <a
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),fe=n("a"),b=a("hub"),M=a("."),mt=p(),H=n("li"),ut=a("The available checkpoints are either (1) pre-trained on "),ke=n("a"),j=a("ImageNet-21k"),gt=a(` (a collection of
...
images and 1,000 classes).`),Tt=p(),A=n("li"),me=a(`The Vision Transformer was pre-trained using a resolution of 224x224. During fine-tuning, it is often beneficial to
...
go to him!`),Rn=p(),xt=n("h2"),Ut=n("a"),Ns=n("span"),w(Do.$$.fragment),fi=p(),Ls=n("span"),mi=a("ViTConfig"),Hn=p(),Me=n("div"),w(Oo.$$.fragment),ui=p(),Et=n("p"),gi=a("This is the configuration class to store the configuration of a "),Ya=n("a"),_i=a("ViTModel"),vi=a(`. It is used to instantiate an ViT
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),dl=p(),Se=n("div"),w(ta.$$.fragment),cl=p(),Ct=n("p"),pl=a("The "),ss=n("a"),hl=a("ViTForMaskedImageModeling"),fl=a(" forward method, overrides the "),Js=n("code"),ml=a("__call__"),ul=a(" special method."),gl=p(),w(Qt.$$.fragment),_l=p(),w(Yt.$$.fragment),Yn=p(),Pt=n("h2"),eo=n("a"),Gs=n("span"),w(oa.$$.fragment),vl=p(),Xs=n("span"),Tl=a("ViTForImageClassification"),er=p(),Ce=n("div"),w(aa.$$.fragment),bl=p(),Zs=n("p"),wl=a(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
behavior.`),Kl=p(),w(so.$$.fragment),Jl=p(),Be=n("div"),w(ha.$$.fragment),Gl=p(),zt=n("p"),Xl=a("The "),is=n("a"),Zl=a("TFViTModel"),Ql=a(" forward method, overrides the "),on=n("code"),Yl=a("__call__"),ed=a(" special method."),td=p(),w(no.$$.fragment),od=p(),w(ro.$$.fragment),ar=p(),Nt=n("h2"),io=n("a"),an=n("span"),w(fa.$$.fragment),ad=p(),sn=n("span"),sd=a("TFViTForImageClassification"),sr=p(),X=n("div"),w(ma.$$.fragment),nd=p(),nn=n("p"),rd=a(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pd=p(),ga=n("p"),hd=a("This model is also a "),_a=n("a"),fd=a("tf.keras.Model"),md=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
general usage and behavior.`),Nd=p(),pn=n("p"),Ld=a("Finally, this model supports inherent JAX features such as:"),Dd=p(),lt=n("ul"),hn=n("li"),xa=n("a"),Od=a("Just-In-Time (JIT) compilation"),Sd=p(),fn=n("li"),Ea=n("a"),Wd=a("Automatic Differentiation"),Bd=p(),mn=n("li"),ka=n("a"),Ud=a("Vectorization"),Rd=p(),un=n("li"),Fa=n("a"),Hd=a("Parallelization"),Kd=p(),Re=n("div"),w(Va.$$.fragment),Jd=p(),Ot=n("p"),Gd=a("The "),gn=n("code"),Xd=a("FlaxViTPreTrainedModel"),Zd=a(" forward method, overrides the "),_n=n("code"),Qd=a("__call__"),Yd=a(" special method."),ec=p(),w(fo.$$.fragment),tc=p(),w(mo.$$.fragment),ir=p(),St=n("h2"),uo=n("a"),vn=n("span"),w(Ia.$$.fragment),oc=p(),Tn=n("span"),ac=a("FlaxViTForImageClassification"),lr=p(),J=n("div"),w(Ma.$$.fragment),sc=p(),bn=n("p"),nc=a(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),fe=r(hs,"A",{href:!0,rel:!0});var Nc=i(fe);b=s(Nc,"hub"),Nc.forEach(t),M=s(hs,"."),hs.forEach(t),mt=h(Z),H=r(Z,"LI",{});var fs=i(H);ut=s(fs,"The available checkpoints are either (1) pre-trained on "),ke=r(fs,"A",{href:!0,rel:!0});var Lc=i(ke);j=s(Lc,"ImageNet-21k"),Lc.forEach(t),gt=s(fs,` (a collection of
14 million images and 21k classes) only, or (2) also fine-tuned on `),Fe=r(fs,"A",{href:!0,rel:!0});var Dc=i(Fe);_t=s(Dc,"ImageNet"),Dc.forEach(t),vt=s(fs,` (also referred to as ILSVRC 2012, a collection of 1.3 million
images and 1,000 classes).`),fs.forEach(t),Tt=h(Z),A=r(Z,"LI",{});var ms=i(A);me=s(ms,`The Vision Transformer was pre-trained using a resolution of 224x224. During fine-tuning, it is often beneficial to
use a higher resolution than pre-training `),Ve=r(ms,"A",{href:!0,rel:!0});var Oc=i(Ve);bt=s(Oc,"(Touvron et al., 2019)"),Oc.forEach(t),ue=s(ms,", "),Ie=r(ms,"A",{href:!0,rel:!0});var Sc=i(Ie);wt=s(Sc,`(Kolesnikov
et al., 2020)`),Sc.forEach(t),nt=s(ms,`. In order to fine-tune at higher resolution, the authors perform
2D interpolation of the pre-trained position embeddings, according to their location in the original image.`),ms.forEach(t),yt=h(Z),ge=r(Z,"LI",{});var Wc=i(ge);$t=s(Wc,`The best results are obtained with supervised pre-training, which is not the case in NLP. The authors also performed
an experiment with a self-supervised pre-training objective, namely masked patched prediction (inspired by masked
language modeling). With this approach, the smaller ViT-B/16 model achieves 79.9% accuracy on ImageNet, a significant
...
go to him!`),pr.forEach(t),Rn=h(o),xt=r(o,"H2",{class:!0});var hr=i(xt);Ut=r(hr,"A",{id:!0,class:!0,href:!0});var lp=i(Ut);Ns=r(lp,"SPAN",{});var dp=i(Ns);y(Do.$$.fragment,dp),dp.forEach(t),lp.forEach(t),fi=h(hr),Ls=r(hr,"SPAN",{});var cp=i(Ls);mi=s(cp,"ViTConfig"),cp.forEach(t),hr.forEach(t),Hn=h(o),Me=r(o,"DIV",{class:!0});var To=i(Me);y(Oo.$$.fragment,To),ui=h(To),Et=r(To,"P",{});var gs=i(Et);gi=s(gs,"This is the configuration class to store the configuration of a "),Ya=r(gs,"A",{href:!0});var pp=i(Ya);_i=s(pp,"ViTModel"),pp.forEach(t),vi=s(gs,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
`),So=r(gs,"A",{href:!0,rel:!0});var hp=i(So);Ti=s(hp,"google/vit-base-patch16-224"),hp.forEach(t),bi=s(gs," architecture."),gs.forEach(t),wi=h(To),kt=r(To,"P",{});var _s=i(kt);yi=s(_s,"Configuration objects inherit from "),es=r(_s,"A",{href:!0});var fp=i(es);$i=s(fp,"PretrainedConfig"),fp.forEach(t),xi=s(_s,` and can be used to control the model outputs. Read the
documentation from `),ts=r(_s,"A",{href:!0});var mp=i(ts);Ei=s(mp,"PretrainedConfig"),mp.forEach(t),ki=s(_s," for more information."),_s.forEach(t),Fi=h(To),y(Rt.$$.fragment,To),To.forEach(t),Kn=h(o),Ft=r(o,"H2",{class:!0});var fr=i(Ft);Ht=r(fr,"A",{id:!0,class:!0,href:!0});var up=i(Ht);Ds=r(up,"SPAN",{});var gp=i(Ds);y(Wo.$$.fragment,gp),gp.forEach(t),up.forEach(t),Vi=h(fr),Os=r(fr,"SPAN",{});var _p=i(Os);Ii=s(_p,"ViTFeatureExtractor"),_p.forEach(t),fr.forEach(t),Jn=h(o),je=r(o,"DIV",{class:!0});var bo=i(je);y(Bo.$$.fragment,bo),Mi=h(bo),Ss=r(bo,"P",{});var vp=i(Ss);ji=s(vp,"Constructs a ViT feature extractor."),vp.forEach(t),Ci=h(bo),Uo=r(bo,"P",{});var mr=i(Uo);Pi=s(mr,"This feature extractor inherits from "),os=r(mr,"A",{href:!0});var Tp=i(os);Ai=s(Tp,"FeatureExtractionMixin"),Tp.forEach(t),qi=s(mr,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),mr.forEach(t),zi=h(bo),ft=r(bo,"DIV",{class:!0});var vs=i(ft);y(Ro.$$.fragment,vs),Ni=h(vs),Ws=r(vs,"P",{});var bp=i(Ws);Li=s(bp,"Main method to prepare for the model one or several image(s)."),bp.forEach(t),Di=h(vs),y(Kt.$$.fragment,vs),vs.forEach(t),bo.forEach(t),Gn=h(o),Vt=r(o,"H2",{class:!0});var ur=i(Vt);Jt=r(ur,"A",{id:!0,class:!0,href:!0});var wp=i(Jt);Bs=r(wp,"SPAN",{});var yp=i(Bs);y(Ho.$$.fragment,yp),yp.forEach(t),wp.forEach(t),Oi=h(ur),Us=r(ur,"SPAN",{});var $p=i(Us);Si=s($p,"ViTModel"),$p.forEach(t),ur.forEach(t),Xn=h(o),rt=r(o,"DIV",{class:!0});var Ts=i(rt);y(Ko.$$.fragment,Ts),Wi=h(Ts),Jo=r(Ts,"P",{});var gr=i(Jo);Bi=s(gr,`The bare ViT Model transformer outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yr.forEach(t),Kl=h(Ke),y(so.$$.fragment,Ke),Jl=h(Ke),Be=r(Ke,"DIV",{class:!0});var Eo=i(Be);y(ha.$$.fragment,Eo),Gl=h(Eo),zt=r(Eo,"P",{});var Es=i(zt);Xl=s(Es,"The "),is=r(Es,"A",{href:!0});var Kp=i(is);Zl=s(Kp,"TFViTModel"),Kp.forEach(t),Ql=s(Es," forward method, overrides the "),on=r(Es,"CODE",{});var Jp=i(on);Yl=s(Jp,"__call__"),Jp.forEach(t),ed=s(Es," special method."),Es.forEach(t),td=h(Eo),y(no.$$.fragment,Eo),od=h(Eo),y(ro.$$.fragment,Eo),Eo.forEach(t),Ke.forEach(t),ar=h(o),Nt=r(o,"H2",{class:!0});var $r=i(Nt);io=r($r,"A",{id:!0,class:!0,href:!0});var Gp=i(io);an=r(Gp,"SPAN",{});var Xp=i(an);y(fa.$$.fragment,Xp),Xp.forEach(t),Gp.forEach(t),ad=h($r),sn=r($r,"SPAN",{});var Zp=i(sn);sd=s(Zp,"TFViTForImageClassification"),Zp.forEach(t),$r.forEach(t),sr=h(o),X=r(o,"DIV",{class:!0});var Je=i(X);y(ma.$$.fragment,Je),nd=h(Je),nn=r(Je,"P",{});var Qp=i(nn);rd=s(Qp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xr.forEach(t),pd=h(Je),ga=r(Je,"P",{});var Er=i(ga);hd=s(Er,"This model is also a "),_a=r(Er,"A",{href:!0,rel:!0});var eh=i(_a);fd=s(eh,"tf.keras.Model"),eh.forEach(t),md=s(Er,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Vr.forEach(t),Nd=h(be),pn=r(be,"P",{});var dh=i(pn);Ld=s(dh,"Finally, this model supports inherent JAX features such as:"),dh.forEach(t),Dd=h(be),lt=r(be,"UL",{});var Fo=i(lt);hn=r(Fo,"LI",{});var ch=i(hn);xa=r(ch,"A",{href:!0,rel:!0});var ph=i(xa);Od=s(ph,"Just-In-Time (JIT) compilation"),ph.forEach(t),ch.forEach(t),Sd=h(Fo),fn=r(Fo,"LI",{});var hh=i(fn);Ea=r(hh,"A",{href:!0,rel:!0});var fh=i(Ea);Wd=s(fh,"Automatic Differentiation"),fh.forEach(t),hh.forEach(t),Bd=h(Fo),mn=r(Fo,"LI",{});var mh=i(mn);ka=r(mh,"A",{href:!0,rel:!0});var uh=i(ka);Ud=s(uh,"Vectorization"),uh.forEach(t),mh.forEach(t),Rd=h(Fo),un=r(Fo,"LI",{});var gh=i(un);Fa=r(gh,"A",{href:!0,rel:!0});var _h=i(Fa);Hd=s(_h,"Parallelization"),_h.forEach(t),gh.forEach(t),Fo.forEach(t),Kd=h(be),Re=r(be,"DIV",{class:!0});var Vo=i(Re);y(Va.$$.fragment,Vo),Jd=h(Vo),Ot=r(Vo,"P",{});var Fs=i(Ot);Gd=s(Fs,"The "),gn=r(Fs,"CODE",{});var vh=i(gn);Xd=s(vh,"FlaxViTPreTrainedModel"),vh.forEach(t),Zd=s(Fs," forward method, overrides the "),_n=r(Fs,"CODE",{});var Th=i(_n);Qd=s(Th,"__call__"),Th.forEach(t),Yd=s(Fs," special method."),Fs.forEach(t),ec=h(Vo),y(fo.$$.fragment,Vo),tc=h(Vo),y(mo.$$.fragment,Vo),Vo.forEach(t),be.forEach(t),ir=h(o),St=r(o,"H2",{class:!0});var Ir=i(St);uo=r(Ir,"A",{id:!0,class:!0,href:!0});var bh=i(uo);vn=r(bh,"SPAN",{});var wh=i(vn);y(Ia.$$.fragment,wh),wh.forEach(t),bh.forEach(t),oc=h(Ir),Tn=r(Ir,"SPAN",{});var yh=i(Tn);ac=s(yh,"FlaxViTForImageClassification"),yh.forEach(t),Ir.forEach(t),lr=h(o),J=r(o,"DIV",{class:!0});var we=i(J);y(Ma.$$.fragment,we),sc=h(we),bn=r(we,"P",{});var $h=i(bn);nc=s($h,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
