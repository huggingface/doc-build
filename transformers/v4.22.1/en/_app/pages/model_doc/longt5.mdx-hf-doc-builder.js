...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),v=a("Example:"),m=u(),b(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);v=s(c,"Example:"),c.forEach(o),m=h(n),k(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,v),T(n,m,c),y(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(L){let l,v,m,p,_,n,c,z,la,vn,ee,ge,_o,Ke,ca,To,pa,bn,fe,ua,Ze,ha,ma,kn,Vt,ga,yn,Yt,vo,fa,wn,Rt,_a,$n,E,O,Jt,Ta,va,Kt,ba,ka,bo,ya,wa,ko,$a,xa,yo,La,za,wo,qa,Fa,ja,Qe,Ma,Zt,Ca,Ea,Oa,Xe,Pa,$o,Ga,Sa,Aa,F,Na,xo,Ia,Da,Lo,Wa,Ua,zo,Ba,Ha,qo,Va,Ya,Fo,Ra,Ja,jo,Ka,Za,Qa,q,Mo,Xa,es,Co,ts,os,Eo,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,Ln,Q,_s,nt,Ts,vs,at,bs,ks,zn,te,_e,Ao,st,ys,No,ws,qn,K,rt,$s,Z,xs,Qt,Ls,zs,Xt,qs,Fs,dt,js,Ms,Cs,oe,Es,eo,Os,Ps,to,Gs,Ss,Fn,ne,Te,Io,it,As,Do,Ns,jn,j,lt,Is,Wo,Ds,Ws,ct,Us,pt,Bs,Hs,Vs,ut,Ys,oo,Rs,Js,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,no,nr,ar,Uo,sr,rr,dr,ve,ir,be,Mn,se,ke,Bo,ft,lr,Ho,cr,Cn,M,_t,pr,Tt,ur,Vo,hr,mr,gr,vt,fr,bt,_r,Tr,vr,kt,br,ao,kr,yr,wr,yt,$r,wt,xr,Lr,zr,W,$t,qr,re,Fr,so,jr,Mr,Yo,Cr,Er,Or,ye,Pr,we,En,de,$e,Ro,xt,Gr,Jo,Sr,On,C,Lt,Ar,Ko,Nr,Ir,zt,Dr,qt,Wr,Ur,Br,Ft,Hr,ro,Vr,Yr,Rr,jt,Jr,Mt,Kr,Zr,Qr,U,Ct,Xr,ie,ed,io,td,od,Zo,nd,ad,sd,xe,rd,Le,Pn,le,ze,Qo,Et,dd,Xo,id,Gn,A,Ot,ld,B,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,Fe,Td,je,Gt,vd,Me,bd,Ce,St,kd,Ee,Sn,pe,Oe,on,At,yd,nn,wd,An,N,Nt,$d,H,It,xd,ue,Ld,an,zd,qd,sn,Fd,jd,Md,Pe,Cd,Ge,Ed,Se,Dt,Od,Ae,Pd,Ne,Wt,Gd,Ie,Nn;return n=new Je({}),Ke=new Je({}),ot=new X({props:{code:`import evaluate
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.22.1/en/model_doc/longt5#transformers.LongT5Model">LongT5Model</a>.`,name:"vocab_size"},{anchor:"transformers.LongT5Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.1/en/model_doc/longt5#transformers.LongT5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/longt5/modeling_longt5.py#L1936",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/longt5/modeling_longt5.py#L2124"}}),Ct=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/longt5/modeling_longt5.py#L2159",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/longt5/modeling_flax_longt5.py#L1718",returnDescription:`
<p>A <a
...
and behavior.`),er=u(),D=r("div"),b(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),no=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Uo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),b(ve.$$.fragment),ir=u(),b(be.$$.fragment),Mn=u(),se=r("h2"),ke=r("a"),Bo=r("span"),b(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),Cn=u(),M=r("div"),b(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Vo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),vt=r("p"),fr=a("The LongT5 model was proposed in "),bt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Tr=a(` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),vr=u(),kt=r("p"),br=a("This model inherits from "),ao=r("a"),kr=a("PreTrainedModel"),yr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wr=u(),yt=r("p"),$r=a("This model is also a PyTorch "),wt=r("a"),xr=a("torch.nn.Module"),Lr=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=u(),W=r("div"),b($t.$$.fragment),qr=u(),re=r("p"),Fr=a("The "),so=r("a"),jr=a("LongT5ForConditionalGeneration"),Mr=a(" forward method, overrides the "),Yo=r("code"),Cr=a("__call__"),Er=a(" special method."),Or=u(),b(ye.$$.fragment),Pr=u(),b(we.$$.fragment),En=u(),de=r("h2"),$e=r("a"),Ro=r("span"),b(xt.$$.fragment),Gr=u(),Jo=r("span"),Sr=a("LongT5EncoderModel"),On=u(),C=r("div"),b(Lt.$$.fragment),Ar=u(),Ko=r("p"),Nr=a("The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Ir=u(),zt=r("p"),Dr=a("The LongT5 model was proposed in "),qt=r("a"),Wr=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr=u(),U=r("div"),b(Ct.$$.fragment),Xr=u(),ie=r("p"),ed=a("The "),io=r("a"),td=a("LongT5EncoderModel"),od=a(" forward method, overrides the "),Zo=r("code"),nd=a("__call__"),ad=a(" special method."),sd=u(),b(xe.$$.fragment),rd=u(),b(Le.$$.fragment),Pn=u(),le=r("h2"),ze=r("a"),Qo=r("span"),b(Et.$$.fragment),dd=u(),Xo=r("span"),id=a("FlaxLongT5Model"),Gn=u(),A=r("div"),b(Ot.$$.fragment),ld=u(),B=r("div"),b(Pt.$$.fragment),cd=u(),ce=r("p"),pd=a("The "),en=r("code"),ud=a("FlaxLongT5PreTrainedModel"),hd=a(" forward method, overrides the "),tn=r("code"),md=a("__call__"),gd=a(" special method."),fd=u(),b(qe.$$.fragment),_d=u(),b(Fe.$$.fragment),Td=u(),je=r("div"),b(Gt.$$.fragment),vd=u(),b(Me.$$.fragment),bd=u(),Ce=r("div"),b(St.$$.fragment),kd=u(),b(Ee.$$.fragment),Sn=u(),pe=r("h2"),Oe=r("a"),on=r("span"),b(At.$$.fragment),yd=u(),nn=r("span"),wd=a("FlaxLongT5ForConditionalGeneration"),An=u(),N=r("div"),b(Nt.$$.fragment),$d=u(),H=r("div"),b(It.$$.fragment),xd=u(),ue=r("p"),Ld=a("The "),an=r("code"),zd=a("FlaxLongT5PreTrainedModel"),qd=a(" forward method, overrides the "),sn=r("code"),Fd=a("__call__"),jd=a(" special method."),Md=u(),b(Pe.$$.fragment),Cd=u(),b(Ge.$$.fragment),Ed=u(),Se=r("div"),b(Dt.$$.fragment),Od=u(),b(Ae.$$.fragment),Pd=u(),Ne=r("div"),b(Wt.$$.fragment),Gd=u(),b(Ie.$$.fragment),this.h()},l(t){const f=tl('[data-svelte="svelte-1phssyn"]',document.head);l=d(f,"META",{name:!0,content:!0}),f.forEach(o),v=h(t),m=d(t,"H1",{class:!0});var Ut=i(m);p=d(Ut,"A",{id:!0,class:!0,href:!0});var rn=i(p);_=d(rn,"SPAN",{});var dn=i(_);k(n.$$.fragment,dn),dn.forEach(o),rn.forEach(o),c=h(Ut),z=d(Ut,"SPAN",{});var ln=i(z);la=s(ln,"LongT5"),ln.forEach(o),Ut.forEach(o),vn=h(t),ee=d(t,"H2",{class:!0});var Bt=i(ee);ge=d(Bt,"A",{id:!0,class:!0,href:!0});var cn=i(ge);_o=d(cn,"SPAN",{});var pn=i(_o);k(Ke.$$.fragment,pn),pn.forEach(o),cn.forEach(o),ca=h(Bt),To=d(Bt,"SPAN",{});var un=i(To);pa=s(un,"Overview"),un.forEach(o),Bt.forEach(o),bn=h(t),fe=d(t,"P",{});var Ht=i(fe);ua=s(Ht,"The LongT5 model was proposed in "),Ze=d(Ht,"A",{href:!0,rel:!0});var hn=i(Ze);ha=s(hn,"LongT5: Efficient Text-To-Text Transformer for Long Sequences"),hn.forEach(o),ma=s(Ht,`
by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an
encoder-decoder transformer pre-trained in a text-to-text denoising generative setting. LongT5 model is an extension of
T5 model, and it enables using one of the two different efficient attention mechanisms - (1) Local attention, or (2)
Transient-Global attention.`),Ht.forEach(o),kn=h(t),Vt=d(t,"P",{});var mn=i(Vt);ga=s(mn,"The abstract from the paper is the following:"),mn.forEach(o),yn=h(t),Yt=d(t,"P",{});var gn=i(Yt);vo=d(gn,"EM",{});var fn=i(vo);fa=s(fn,`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
performance of Transformer-based neural models. In this paper, we present a new model, called LongT5, with which we
explore the effects of scaling both the input length and model size at the same time. Specifically, we integrated
attention ideas from long-input transformers (ETC), and adopted pre-training strategies from summarization pre-training
(PEGASUS) into the scalable T5 architecture. The result is a new attention mechanism we call {\\em Transient Global}
...
encoder `),bo=d(I,"EM",{});var Nd=i(bo);ya=s(Nd,"self-attention"),Nd.forEach(o),wa=s(I," layer with efficient either "),ko=d(I,"EM",{});var Id=i(ko);$a=s(Id,"local"),Id.forEach(o),xa=s(I," attention or "),yo=d(I,"EM",{});var Dd=i(yo);La=s(Dd,"transient-global"),Dd.forEach(o),za=s(I," ("),wo=d(I,"EM",{});var Wd=i(wo);qa=s(Wd,"tglobal"),Wd.forEach(o),Fa=s(I,") attention."),I.forEach(o),ja=h(V),Qe=d(V,"LI",{});var In=i(Qe);Ma=s(In,`Unlike the T5 model, LongT5 does not use a task prefix. Furthermore, it uses a different pre-training objective
...
a few new parameters \u2014 global relative position biases and a layer normalization for global token\u2019s embedding.
The complexity of this mechanism is `),So=d(P,"CODE",{});var ni=i(So);ps=s(ni,"O(l(r + l/k))"),ni.forEach(o),us=s(P,"."),P.forEach(o),hs=h(V),et=d(V,"LI",{});var Wn=i(et);ms=s(Wn,"An example showing how to evaluate a fine-tuned LongT5 model on the "),tt=d(Wn,"A",{href:!0,rel:!0});var ai=i(tt);gs=s(ai,"pubmed dataset"),ai.forEach(o),fs=s(Wn," is below."),Wn.forEach(o),V.forEach(o),xn=h(t),k(ot.$$.fragment,t),Ln=h(t),Q=d(t,"P",{});var lo=i(Q);_s=s(lo,"This model was contributed by "),nt=d(lo,"A",{href:!0,rel:!0});var si=i(nt);Ts=s(si,"stancld"),si.forEach(o),vs=s(lo,`.
The original code can be found `),at=d(lo,"A",{href:!0,rel:!0});var ri=i(at);bs=s(ri,"here"),ri.forEach(o),ks=s(lo,"."),lo.forEach(o),zn=h(t),te=d(t,"H2",{class:!0});var Un=i(te);_e=d(Un,"A",{id:!0,class:!0,href:!0});var di=i(_e);Ao=d(di,"SPAN",{});var ii=i(Ao);k(st.$$.fragment,ii),ii.forEach(o),di.forEach(o),ys=h(Un),No=d(Un,"SPAN",{});var li=i(No);ws=s(li,"LongT5Config"),li.forEach(o),Un.forEach(o),qn=h(t),K=d(t,"DIV",{class:!0});var co=i(K);k(rt.$$.fragment,co),$s=h(co),Z=d(co,"P",{});var De=i(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Qt=d(De,"A",{href:!0});var ci=i(Qt);Ls=s(ci,"LongT5Model"),ci.forEach(o),zs=s(De," or a "),Xt=d(De,"A",{href:!0});var pi=i(Xt);qs=s(pi,"FlaxLongT5Model"),pi.forEach(o),Fs=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
...
documentation from `),to=d(po,"A",{href:!0});var mi=i(to);Gs=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(po," for more information."),po.forEach(o),co.forEach(o),Fn=h(t),ne=d(t,"H2",{class:!0});var Bn=i(ne);Te=d(Bn,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);k(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),As=h(Bn),Do=d(Bn,"SPAN",{});var _i=i(Do);Ns=s(_i,"LongT5Model"),_i.forEach(o),Bn.forEach(o),jn=h(t),j=d(t,"DIV",{class:!0});var Y=i(j);k(lt.$$.fragment,Y),Is=h(Y),Wo=d(Y,"P",{});var Ti=i(Wo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Ws=h(Y),ct=d(Y,"P",{});var Hn=i(ct);Us=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var vi=i(pt);Bs=s(vi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),vi.forEach(o),Hs=s(Hn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Hn.forEach(o),Vs=h(Y),ut=d(Y,"P",{});var Vn=i(ut);Ys=s(Vn,"This model inherits from "),oo=d(Vn,"A",{href:!0});var bi=i(oo);Rs=s(bi,"PreTrainedModel"),bi.forEach(o),Js=s(Vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yn.forEach(o),er=h(Y),D=d(Y,"DIV",{class:!0});var We=i(D);k(gt.$$.fragment,We),tr=h(We),ae=d(We,"P",{});var uo=i(ae);or=s(uo,"The "),no=d(uo,"A",{href:!0});var yi=i(no);nr=s(yi,"LongT5Model"),yi.forEach(o),ar=s(uo," forward method, overrides the "),Uo=d(uo,"CODE",{});var wi=i(Uo);sr=s(wi,"__call__"),wi.forEach(o),rr=s(uo," special method."),uo.forEach(o),dr=h(We),k(ve.$$.fragment,We),ir=h(We),k(be.$$.fragment,We),We.forEach(o),Y.forEach(o),Mn=h(t),se=d(t,"H2",{class:!0});var Rn=i(se);ke=d(Rn,"A",{id:!0,class:!0,href:!0});var $i=i(ke);Bo=d($i,"SPAN",{});var xi=i(Bo);k(ft.$$.fragment,xi),xi.forEach(o),$i.forEach(o),lr=h(Rn),Ho=d(Rn,"SPAN",{});var Li=i(Ho);cr=s(Li,"LongT5ForConditionalGeneration"),Li.forEach(o),Rn.forEach(o),Cn=h(t),M=d(t,"DIV",{class:!0});var R=i(M);k(_t.$$.fragment,R),pr=h(R),Tt=d(R,"P",{});var Jn=i(Tt);ur=s(Jn,"LONGT5 Model with a "),Vo=d(Jn,"CODE",{});var zi=i(Vo);hr=s(zi,"language modeling"),zi.forEach(o),mr=s(Jn," head on top."),Jn.forEach(o),gr=h(R),vt=d(R,"P",{});var Kn=i(vt);fr=s(Kn,"The LongT5 model was proposed in "),bt=d(Kn,"A",{href:!0,rel:!0});var qi=i(bt);_r=s(qi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),qi.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),vr=h(R),kt=d(R,"P",{});var Zn=i(kt);br=s(Zn,"This model inherits from "),ao=d(Zn,"A",{href:!0});var Fi=i(ao);kr=s(Fi,"PreTrainedModel"),Fi.forEach(o),yr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),zr=h(R),W=d(R,"DIV",{class:!0});var Ue=i(W);k($t.$$.fragment,Ue),qr=h(Ue),re=d(Ue,"P",{});var ho=i(re);Fr=s(ho,"The "),so=d(ho,"A",{href:!0});var Mi=i(so);jr=s(Mi,"LongT5ForConditionalGeneration"),Mi.forEach(o),Mr=s(ho," forward method, overrides the "),Yo=d(ho,"CODE",{});var Ci=i(Yo);Cr=s(Ci,"__call__"),Ci.forEach(o),Er=s(ho," special method."),ho.forEach(o),Or=h(Ue),k(ye.$$.fragment,Ue),Pr=h(Ue),k(we.$$.fragment,Ue),Ue.forEach(o),R.forEach(o),En=h(t),de=d(t,"H2",{class:!0});var Xn=i(de);$e=d(Xn,"A",{id:!0,class:!0,href:!0});var Ei=i($e);Ro=d(Ei,"SPAN",{});var Oi=i(Ro);k(xt.$$.fragment,Oi),Oi.forEach(o),Ei.forEach(o),Gr=h(Xn),Jo=d(Xn,"SPAN",{});var Pi=i(Jo);Sr=s(Pi,"LongT5EncoderModel"),Pi.forEach(o),Xn.forEach(o),On=h(t),C=d(t,"DIV",{class:!0});var J=i(C);k(Lt.$$.fragment,J),Ar=h(J),Ko=d(J,"P",{});var Gi=i(Ko);Nr=s(Gi,"The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Gi.forEach(o),Ir=h(J),zt=d(J,"P",{});var ea=i(zt);Dr=s(ea,"The LongT5 model was proposed in "),qt=d(ea,"A",{href:!0,rel:!0});var Si=i(qt);Wr=s(Si,`LongT5: Efficient Text-To-Text Transformer for Long
