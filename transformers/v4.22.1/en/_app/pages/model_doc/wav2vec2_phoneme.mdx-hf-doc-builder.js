...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L506",returnDescription:`
<p>The
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L450",returnDescription:`
<p>The decoded
...
mapping phonemes of the training languages to the target language using articulatory features. Experiments show that
this simple method significantly outperforms prior work which introduced task-specific architectures and used only part
of a monolingually pretrained model.`),lt.forEach(t),ct.forEach(t),Ve=l(e),oe=r(e,"P",{});var dt=a(oe);ao=i(dt,"Tips:"),dt.forEach(t),qe=l(e),u=r(e,"UL",{});var _=a(u);pe=r(_,"LI",{});var pt=a(pe);so=i(pt,"Wav2Vec2Phoneme uses the exact same architecture as Wav2Vec2"),pt.forEach(t),io=l(_),he=r(_,"LI",{});var ht=a(he);co=i(ht,"Wav2Vec2Phoneme is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),ht.forEach(t),lo=l(_),R=r(_,"LI",{});var Oe=a(R);po=i(Oe,`Wav2Vec2Phoneme model was trained using connectionist temporal classification (CTC) so the model output has to be
decoded using `),te=r(Oe,"A",{href:!0});var mt=a(te);ho=i(mt,"Wav2Vec2PhonemeCTCTokenizer"),mt.forEach(t),mo=i(Oe,"."),Oe.forEach(t),uo=l(_),me=r(_,"LI",{});var ut=a(me);fo=i(ut,`Wav2Vec2Phoneme can be fine-tuned on multiple language at once and decode unseen languages in a single forward pass
