...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(n,h){g(n,l,h),o(l,b),o(l,_),o(_,p),o(l,v)},d(n){n&&t(l)}}}function An(S){let l,b,_,p,v;return p=new Rt({props:{code:`from transformers import PegasusTokenizer, PegasusModel
...
the latter silently ignores them.`)},l(n){l=a(n,"P",{});var h=r(l);b=d(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(h,"CODE",{});var C=r(_);p=d(C,"Module"),C.forEach(t),v=d(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(n,h){g(n,l,h),o(l,b),o(l,_),o(_,p),o(l,v)},d(n){n&&t(l)}}}function jn(S){let l,b,_,p,v;return p=new Rt({props:{code:`from transformers import PegasusTokenizer, PegasusXForConditionalGeneration
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.1/en/model_doc/pegasus_x#transformers.PegasusXConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/pegasus_x/modeling_pegasus_x.py#L1574",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Po.forEach(t),ft=f(Q),q=a(Q,"DIV",{class:!0});var ee=r(q);T(me.$$.fragment,ee),gt=f(ee),I=a(ee,"P",{});var Ie=r(I);_t=d(Ie,"The "),Me=a(Ie,"A",{href:!0});var vn=r(Me);vt=d(vn,"PegasusXModel"),vn.forEach(t),bt=d(Ie," forward method, overrides the "),Ze=a(Ie,"CODE",{});var bn=r(Ze);yt=d(bn,"__call__"),bn.forEach(t),Tt=d(Ie," special method."),Ie.forEach(t),wt=f(ee),T(H.$$.fragment,ee),kt=f(ee),T(B.$$.fragment,ee),ee.forEach(t),Q.forEach(t),_o=f(e),U=a(e,"H2",{class:!0});var $o=r(U);Z=a($o,"A",{id:!0,class:!0,href:!0});var yn=r(Z);Je=a(yn,"SPAN",{});var Tn=r(Je);T(fe.$$.fragment,Tn),Tn.forEach(t),yn.forEach(t),Pt=f($o),Ke=a($o,"SPAN",{});var wn=r(Ke);$t=d(wn,"PegasusXForConditionalGeneration"),wn.forEach(t),$o.forEach(t),vo=f(e),X=a(e,"DIV",{class:!0});var oe=r(X);T(ge.$$.fragment,oe),xt=f(oe),_e=a(oe,"P",{});var xo=r(_e);zt=d(xo,`The PEGASUS-X for conditional generation (e.g. summarization).
