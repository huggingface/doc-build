import{S as Fi,i as Ai,s as Ii,e as o,k as d,w as v,t as n,M as Li,c as a,d as s,m as p,a as i,x as b,h as r,b as l,N as Ri,G as e,g as u,y as w,q as x,o as k,B as $,v as Oi,L as Ci}from"../../chunks/vendor-hf-doc-builder.js";import{T as qo}from"../../chunks/Tip-hf-doc-builder.js";import{D as U}from"../../chunks/Docstring-hf-doc-builder.js";import{C as zs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as qe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Mi}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ni(F){let m,j,f,g,D;return g=new zs({props:{code:`from transformers import DonutSwinConfig, DonutSwinModel
...
`),h=o("code"),_=n("from_pretrained"),q=n(` methods. Please refer to the docstrings of the
...
`),f=a(y,"A",{href:!0});var C=i(f);g=r(C,"from_pretrained()"),C.forEach(s),D=r(y,` and the tokenizer
`),h=a(y,"CODE",{});var A=i(h);_=r(A,"from_pretrained"),A.forEach(s),q=r(y,` methods. Please refer to the docstrings of the
methods above for more information.`),y.forEach(s),this.h()},h(){l(f,"href","/docs/transformers/v4.22.1/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(M,y){u(M,m,y),e(m,j),e(m,f),e(f,g),e(m,D),e(m,h),e(h,_),e(m,q)},d(M){M&&s(m)}}}function Wi(F){let m,j,f,g,D,h,_,q;return{c(){m=o("p"),j=n("This class method is simply calling "),f=o("a"),g=n("save_pretrained()"),D=n(` and
`),h=o("code"),_=n("save_pretrained"),q=n(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(M){m=a(M,"P",{});var y=i(m);j=r(y,"This class method is simply calling "),f=a(y,"A",{href:!0});var C=i(f);g=r(C,"save_pretrained()"),C.forEach(s),D=r(y,` and
`),h=a(y,"CODE",{});var A=i(h);_=r(A,"save_pretrained"),A.forEach(s),q=r(y,`. Please refer to the docstrings of the methods
above for more information.`),y.forEach(s),this.h()},h(){l(f,"href","/docs/transformers/v4.22.1/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(M,y){u(M,m,y),e(m,j),e(m,f),e(f,g),e(m,D),e(m,h),e(h,_),e(m,q)},d(M){M&&s(m)}}}function Hi(F){let m,j,f,g,D;return{c(){m=o("p"),j=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),g=n("Module"),D=n(`
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){m=o("p"),j=n("Example:"),f=d(),v(g.$$.fragment)},l(h){m=a(h,"P",{});var _=i(m);j=r(_,"Example:"),_.forEach(s),f=p(h),b(g.$$.fragment,h)},m(h,_){u(h,m,_),e(m,j),u(h,f,_),w(g,h,_),D=!0},p:Ci,i(h){D||(x(g.$$.fragment,h),D=!0)},o(h){k(g.$$.fragment,h),D=!1},d(h){h&&s(m),h&&s(f),$(g,h)}}}function Bi(F){let m,j,f,g,D,h,_,q,M,y,C,A,Bt,Pe,Po,Jt,zo,Ss,ae,So,ze,Mo,Co,Ms,ft,Fo,Cs,gt,Gt,Ao,Fs,ne,fr,As,re,Io,_t,Lo,Ro,Is,W,Oo,Se,No,Vo,Me,Uo,Wo,Ls,vt,Ho,Rs,ie,Ce,Xo,Fe,Bo,Jo,Go,Ae,Yo,bt,Qo,Ko,Os,G,le,Yt,Ie,Zo,Qt,ea,Ns,H,ta,Kt,sa,oa,wt,aa,na,Vs,T,ra,xt,ia,la,Zt,ca,da,es,pa,ua,kt,ma,ha,$t,fa,ga,ts,_a,va,ss,ba,wa,Us,jt,os,xa,Ws,Le,Hs,Dt,as,ka,Xs,Re,Bs,yt,ns,$a,Js,Oe,Gs,ce,ja,Ne,Da,ya,Ys,Y,de,rs,Ve,Ea,is,Ta,Qs,pe,qa,Ue,Pa,za,Ks,Q,ue,ls,We,Sa,cs,Ma,Zs,I,He,Ca,K,Fa,Et,Aa,Ia,Xe,La,Ra,Oa,Z,Na,Tt,Va,Ua,qt,Wa,Ha,Xa,me,eo,ee,he,ds,Be,Ba,ps,Ja,to,L,Je,Ga,us,Ya,Qa,Ge,Ka,Pt,Za,en,tn,X,Ye,sn,ms,on,an,fe,so,te,ge,hs,Qe,nn,fs,rn,oo,E,Ke,ln,gs,cn,dn,P,zt,pn,un,St,mn,hn,_s,fn,gn,vs,_n,vn,Ze,bs,bn,wn,xn,Mt,kn,$n,jn,_e,et,Dn,N,yn,ws,En,Tn,xs,qn,Pn,ks,zn,Sn,Mn,B,tt,Cn,$s,Fn,An,ve,In,J,st,Ln,ot,Rn,Ct,On,Nn,Vn,be,Un,we,at,Wn,nt,Hn,Ft,Xn,Bn,Jn,xe,rt,Gn,it,Yn,At,Qn,Kn,ao,se,ke,js,lt,Zn,Ds,er,no,V,ct,tr,dt,sr,pt,or,ar,nr,O,ut,rr,oe,ir,It,lr,cr,ys,dr,pr,ur,$e,mr,je,ro;return h=new qe({}),Pe=new qe({}),Ie=new qe({}),Le=new zs({props:{code:`import re
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/donut/feature_extraction_donut.py#L125",returnDescription:`
<p>A <a
...
An instance of [<code>XLMRobertaTokenizer</code>/<code>XLMRobertaTokenizerFast</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/donut/processing_donut.py#L25"}}),et=new U({props:{name:"__call__",anchor:"transformers.DonutProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/donut/processing_donut.py#L48"}}),tt=new U({props:{name:"from_pretrained",anchor:"transformers.DonutProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DonutProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
namespace).
kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/processing_utils.py#L94"}}),be=new qo({props:{$$slots:{default:[Wi]},$$scope:{ctx:F}}}),at=new U({props:{name:"batch_decode",anchor:"transformers.DonutProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/donut/processing_donut.py#L81"}}),rt=new U({props:{name:"decode",anchor:"transformers.DonutProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/donut/processing_donut.py#L88"}}),lt=new qe({}),ct=new U({props:{name:"class transformers.DonutSwinModel",anchor:"transformers.DonutSwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],parametersDescription:[{anchor:"transformers.DonutSwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/donut#transformers.DonutSwinConfig">DonutSwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/donut/modeling_donut_swin.py#L852"}}),ut=new U({props:{name:"forward",anchor:"transformers.DonutSwinModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.DonutSwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.1/en/model_doc/donut#transformers.DonutSwinConfig"
...
`}}),$e=new qo({props:{$$slots:{default:[Hi]},$$scope:{ctx:F}}}),je=new Mi({props:{anchor:"transformers.DonutSwinModel.forward.example",$$slots:{default:[Xi]},$$scope:{ctx:F}}}),{c(){m=o("meta"),j=d(),f=o("h1"),g=o("a"),D=o("span"),v(h.$$.fragment),_=d(),q=o("span"),M=n("Donut"),y=d(),C=o("h2"),A=o("a"),Bt=o("span"),v(Pe.$$.fragment),Po=d(),Jt=o("span"),zo=n("Overview"),Ss=d(),ae=o("p"),So=n("The Donut model was proposed in "),ze=o("a"),Mo=n("OCR-free Document Understanding Transformer"),Co=n(` by
...
`),wt=o("a"),aa=n("generate()"),na=n(" to autoregressively generate text given the input image."),Vs=d(),T=o("p"),ra=n("The "),xt=o("a"),ia=n("DonutFeatureExtractor"),la=n(` class is responsible for preprocessing the input image and
...
`),xs=o("code"),qn=n("as_target_processor()"),Pn=n(` this method forwards all its arguments to DonutTokenizer\u2019s
`),ks=o("code"),zn=n("__call__"),Sn=n(". Please refer to the doctsring of the above two methods for more information."),Mn=d(),B=o("div"),v(tt.$$.fragment),Cn=d(),$s=o("p"),Fn=n("Instantiate a processor associated with a pretrained model."),An=d(),v(ve.$$.fragment),In=d(),J=o("div"),v(st.$$.fragment),Ln=d(),ot=o("p"),Rn=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Ct=o("a"),On=n("from_pretrained()"),Nn=n(" method."),Vn=d(),v(be.$$.fragment),Un=d(),we=o("div"),v(at.$$.fragment),Wn=d(),nt=o("p"),Hn=n("This method forwards all its arguments to DonutTokenizer\u2019s "),Ft=o("a"),Xn=n("batch_decode()"),Bn=n(`. Please refer
...
behavior.`),nr=d(),O=o("div"),v(ut.$$.fragment),rr=d(),oe=o("p"),ir=n("The "),It=o("a"),lr=n("DonutSwinModel"),cr=n(" forward method, overrides the "),ys=o("code"),dr=n("__call__"),pr=n(" special method."),ur=d(),v($e.$$.fragment),mr=d(),v(je.$$.fragment),this.h()},l(t){const c=Li('[data-svelte="svelte-1phssyn"]',document.head);m=a(c,"META",{name:!0,content:!0}),c.forEach(s),j=p(t),f=a(t,"H1",{class:!0});var mt=i(f);g=a(mt,"A",{id:!0,class:!0,href:!0});var Es=i(g);D=a(Es,"SPAN",{});var Ts=i(D);b(h.$$.fragment,Ts),Ts.forEach(s),Es.forEach(s),_=p(mt),q=a(mt,"SPAN",{});var qs=i(q);M=r(qs,"Donut"),qs.forEach(s),mt.forEach(s),y=p(t),C=a(t,"H2",{class:!0});var ht=i(C);A=a(ht,"A",{id:!0,class:!0,href:!0});var Ps=i(A);Bt=a(Ps,"SPAN",{});var gr=i(Bt);b(Pe.$$.fragment,gr),gr.forEach(s),Ps.forEach(s),Po=p(ht),Jt=a(ht,"SPAN",{});var _r=i(Jt);zo=r(_r,"Overview"),_r.forEach(s),ht.forEach(s),Ss=p(t),ae=a(t,"P",{});var io=i(ae);So=r(io,"The Donut model was proposed in "),ze=a(io,"A",{href:!0,rel:!0});var vr=i(ze);Mo=r(vr,"OCR-free Document Understanding Transformer"),vr.forEach(s),Co=r(io,` by
Geewook Kim, Teakgyu Hong, Moonbin Yim, Jeongyeon Nam, Jinyoung Park, Jinyeong Yim, Wonseok Hwang, Sangdoo Yun, Dongyoon Han, Seunghyun Park.
Donut consists of an image Transformer encoder and an autoregressive text Transformer decoder to perform document understanding
tasks such as document image classification, form understanding and visual question answering.`),io.forEach(s),Ms=p(t),ft=a(t,"P",{});var br=i(ft);Fo=r(br,"The abstract from the paper is the following:"),br.forEach(s),Cs=p(t),gt=a(t,"P",{});var wr=i(gt);Gt=a(wr,"EM",{});var xr=i(Gt);Ao=r(xr,"Understanding document images (e.g., invoices) is a core but challenging task since it requires complex functions such as reading text and a holistic understanding of the document. Current Visual Document Understanding (VDU) methods outsource the task of reading text to off-the-shelf Optical Character Recognition (OCR) engines and focus on the understanding task with the OCR outputs. Although such OCR-based approaches have shown promising performance, they suffer from 1) high computational costs for using OCR; 2) inflexibility of OCR models on languages or types of document; 3) OCR error propagation to the subsequent process. To address these issues, in this paper, we introduce a novel OCR-free VDU model named Donut, which stands for Document understanding transformer. As the first step in OCR-free VDU research, we propose a simple architecture (i.e., Transformer) with a pre-training objective (i.e., cross-entropy loss). Donut is conceptually simple yet effective. Through extensive experiments and analyses, we show a simple OCR-free VDU model, Donut, achieves state-of-the-art performances on various VDU tasks in terms of both speed and accuracy. In addition, we offer a synthetic data generator that helps the model pre-training to be flexible in various languages and domains."),xr.forEach(s),wr.forEach(s),Fs=p(t),ne=a(t,"IMG",{src:!0,alt:!0,width:!0}),As=p(t),re=a(t,"SMALL",{});var lo=i(re);Io=r(lo,"Donut high-level overview. Taken from the "),_t=a(lo,"A",{href:!0});var kr=i(_t);Lo=r(kr,"original paper"),kr.forEach(s),Ro=r(lo,"."),lo.forEach(s),Is=p(t),W=a(t,"P",{});var Lt=i(W);Oo=r(Lt,"This model was contributed by "),Se=a(Lt,"A",{href:!0,rel:!0});var $r=i(Se);No=r($r,"nielsr"),$r.forEach(s),Vo=r(Lt,`. The original code can be found
`),Me=a(Lt,"A",{href:!0,rel:!0});var jr=i(Me);Uo=r(jr,"here"),jr.forEach(s),Wo=r(Lt,"."),Lt.forEach(s),Ls=p(t),vt=a(t,"P",{});var Dr=i(vt);Ho=r(Dr,"Tips:"),Dr.forEach(s),Rs=p(t),ie=a(t,"UL",{});var co=i(ie);Ce=a(co,"LI",{});var po=i(Ce);Xo=r(po,"The quickest way to get started with Donut is by checking the "),Fe=a(po,"A",{href:!0,rel:!0});var yr=i(Fe);Bo=r(yr,`tutorial
...
`),wt=a(Rt,"A",{href:!0});var Sr=i(wt);aa=r(Sr,"generate()"),Sr.forEach(s),na=r(Rt," to autoregressively generate text given the input image."),Rt.forEach(s),Vs=p(t),T=a(t,"P",{});var z=i(T);ra=r(z,"The "),xt=a(z,"A",{href:!0});var Mr=i(xt);ia=r(Mr,"DonutFeatureExtractor"),Mr.forEach(s),la=r(z,` class is responsible for preprocessing the input image and
[`),Zt=a(z,"CODE",{});var Cr=i(Zt);ca=r(Cr,"XLMRobertaTokenizer"),Cr.forEach(s),da=r(z,"/"),es=a(z,"CODE",{});var Fr=i(es);pa=r(Fr,"XLMRobertaTokenizerFast"),Fr.forEach(s),ua=r(z,`] decodes the generated target tokens to the target string. The
