import{S as Ui,i as Vi,s as Bi,e as n,k as u,w as b,t as r,M as Ki,c as a,d as o,m as g,a as l,x as $,h as i,b as c,N as Ri,G as e,g as _,y as T,q as y,o as S,B as k,v as Yi,L as Pt}from"../../chunks/vendor-hf-doc-builder.js";import{T as mo}from"../../chunks/Tip-hf-doc-builder.js";import{D as A}from"../../chunks/Docstring-hf-doc-builder.js";import{C as zt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ce}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as qt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Zi(F){let d,v;return d=new zt({props:{code:`from transformers import SwinModel, SwinConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){b(d.$$.fragment)},l(h){$(d.$$.fragment,h)},m(h,m){T(d,h,m),v=!0},p:Pt,i(h){v||(y(d.$$.fragment,h),v=!0)},o(h){S(d.$$.fragment,h),v=!1},d(h){k(d,h)}}}function Gi(F){let d,v,h,m,w;return{c(){d=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(p,"CODE",{});var x=l(h);m=i(x,"Module"),x.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,v),e(d,h),e(h,m),e(d,w)},d(s){s&&o(d)}}}function Ji(F){let d,v,h,m,w;return m=new zt({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){d=n("p"),v=r("Example:"),h=u(),b(m.$$.fragment)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Example:"),p.forEach(o),h=g(s),$(m.$$.fragment,s)},m(s,p){_(s,d,p),e(d,v),_(s,h,p),T(m,s,p),w=!0},p:Pt,i(s){w||(y(m.$$.fragment,s),w=!0)},o(s){S(m.$$.fragment,s),w=!1},d(s){s&&o(d),s&&o(h),k(m,s)}}}function Qi(F){let d,v,h,m,w;return{c(){d=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(p,"CODE",{});var x=l(h);m=i(x,"Module"),x.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,v),e(d,h),e(h,m),e(d,w)},d(s){s&&o(d)}}}function Xi(F){let d,v,h,m,w;return m=new zt({props:{code:`from transformers import AutoFeatureExtractor, SwinForMaskedImageModeling
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),{c(){d=n("p"),v=r("Examples:"),h=u(),b(m.$$.fragment)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Examples:"),p.forEach(o),h=g(s),$(m.$$.fragment,s)},m(s,p){_(s,d,p),e(d,v),_(s,h,p),T(m,s,p),w=!0},p:Pt,i(s){w||(y(m.$$.fragment,s),w=!0)},o(s){S(m.$$.fragment,s),w=!1},d(s){s&&o(d),s&&o(h),k(m,s)}}}function el(F){let d,v,h,m,w;return{c(){d=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(p,"CODE",{});var x=l(h);m=i(x,"Module"),x.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,v),e(d,h),e(h,m),e(d,w)},d(s){s&&o(d)}}}function tl(F){let d,v,h,m,w;return m=new zt({props:{code:`from transformers import AutoFeatureExtractor, SwinForImageClassification
import torch
from datasets import load_dataset
...
the latter silently ignores them.`)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(p,"CODE",{});var x=l(h);m=i(x,"Module"),x.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,v),e(d,h),e(h,m),e(d,w)},d(s){s&&o(d)}}}function sl(F){let d,v,h,m,w;return m=new zt({props:{code:`from transformers import AutoFeatureExtractor, TFSwinModel
from datasets import load_dataset
...
the latter silently ignores them.`)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(p,"CODE",{});var x=l(h);m=i(x,"Module"),x.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,v),e(d,h),e(h,m),e(d,w)},d(s){s&&o(d)}}}function al(F){let d,v,h,m,w;return m=new zt({props:{code:`from transformers import AutoFeatureExtractor, TFSwinForMaskedImageModeling
...
the latter silently ignores them.`)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(p,"CODE",{});var x=l(h);m=i(x,"Module"),x.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,v),e(d,h),e(h,m),e(d,w)},d(s){s&&o(d)}}}function il(F){let d,v,h,m,w;return m=new zt({props:{code:`from transformers import AutoFeatureExtractor, TFSwinForImageClassification
import tensorflow as tf
from datasets import load_dataset
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(model.config.id2label[predicted_label])
tabby, tabby cat`}}),{c(){d=n("p"),v=r("Example:"),h=u(),b(m.$$.fragment)},l(s){d=a(s,"P",{});var p=l(d);v=i(p,"Example:"),p.forEach(o),h=g(s),$(m.$$.fragment,s)},m(s,p){_(s,d,p),e(d,v),_(s,h,p),T(m,s,p),w=!0},p:Pt,i(s){w||(y(m.$$.fragment,s),w=!0)},o(s){S(m.$$.fragment,s),w=!1},d(s){s&&o(d),s&&o(h),k(m,s)}}}function ll(F){let d,v,h,m,w,s,p,x,Hs,ss,K,pe,fo,Be,Ws,uo,Us,ns,he,Vs,Ke,Bs,Ks,as,Ot,Rs,rs,Nt,go,Ys,is,Dt,Zs,ls,B,Re,Gs,Lt,Js,Qs,Xs,Ye,en,_o,tn,on,sn,M,nn,wo,an,rn,vo,ln,dn,bo,cn,pn,$o,hn,mn,To,fn,un,yo,gn,_n,So,wn,vn,ds,me,Pr,cs,fe,bn,Ht,$n,Tn,ps,q,yn,Ze,Sn,kn,Ge,Fn,xn,Je,Mn,En,hs,R,ue,ko,Qe,jn,Fo,In,ms,j,Xe,Cn,Y,An,Wt,qn,Pn,et,zn,On,Nn,Z,Dn,Ut,Ln,Hn,Vt,Wn,Un,Vn,ge,fs,G,_e,xo,tt,Bn,Mo,Kn,us,H,ot,Rn,st,Yn,nt,Zn,Gn,Jn,P,at,Qn,J,Xn,Bt,ea,ta,Eo,oa,sa,na,we,aa,ve,gs,Q,be,jo,rt,ra,Io,ia,_s,W,it,la,X,da,lt,ca,pa,dt,ha,ma,fa,z,ct,ua,ee,ga,Kt,_a,wa,Co,va,ba,$a,$e,Ta,Te,ws,te,ye,Ao,pt,ya,qo,Sa,vs,I,ht,ka,Po,Fa,xa,mt,Ma,ft,Ea,ja,Ia,O,ut,Ca,oe,Aa,Rt,qa,Pa,zo,za,Oa,Na,Se,Da,ke,bs,se,Fe,Oo,gt,La,No,Ha,$s,U,_t,Wa,wt,Ua,vt,Va,Ba,Ka,N,bt,Ra,ne,Ya,Yt,Za,Ga,Do,Ja,Qa,Xa,xe,er,Me,Ts,ae,Ee,Lo,$t,tr,Ho,or,ys,V,Tt,sr,re,nr,yt,ar,rr,St,ir,lr,dr,D,kt,cr,ie,pr,Zt,hr,mr,Wo,fr,ur,gr,je,_r,Ie,Ss,le,Ce,Uo,Ft,wr,Vo,vr,ks,C,xt,br,Bo,$r,Tr,Mt,yr,Et,Sr,kr,Fr,L,jt,xr,de,Mr,Gt,Er,jr,Ko,Ir,Cr,Ar,Ae,qr,qe,Fs;return s=new ce({}),Be=new ce({}),Qe=new ce({}),Xe=new A({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
<p>Example &#x2014;`,name:"encoder_stride"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/configuration_swin.py#L31"}}),ge=new qt({props:{anchor:"transformers.SwinConfig.example",$$slots:{default:[Zi]},$$scope:{ctx:F}}}),tt=new ce({}),ot=new A({props:{name:"class transformers.SwinModel",anchor:"transformers.SwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],parametersDescription:[{anchor:"transformers.SwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_swin.py#L915"}}),at=new A({props:{name:"forward",anchor:"transformers.SwinModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_swin.py#L942",returnDescription:`
<p>A <code>transformers.models.swin.modeling_swin.SwinModelOutput</code> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.1/en/model_doc/swin#transformers.SwinConfig"
...
`}}),we=new mo({props:{$$slots:{default:[Gi]},$$scope:{ctx:F}}}),ve=new qt({props:{anchor:"transformers.SwinModel.forward.example",$$slots:{default:[Ji]},$$scope:{ctx:F}}}),rt=new ce({}),it=new A({props:{name:"class transformers.SwinForMaskedImageModeling",anchor:"transformers.SwinForMaskedImageModeling",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_swin.py#L1014"}}),ct=new A({props:{name:"forward",anchor:"transformers.SwinForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_swin.py#L1031",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_swin.py#L1125"}}),ut=new A({props:{name:"forward",anchor:"transformers.SwinForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_swin.py#L1140",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_tf_swin.py#L1185"}}),bt=new A({props:{name:"call",anchor:"transformers.TFSwinModel.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFSwinModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_tf_swin.py#L1295"}}),kt=new A({props:{name:"call",anchor:"transformers.TFSwinForMaskedImageModeling.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFSwinForMaskedImageModeling.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_tf_swin.py#L1303",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_tf_swin.py#L1416"}}),jt=new A({props:{name:"call",anchor:"transformers.TFSwinForImageClassification.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFSwinForImageClassification.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/swin/modeling_tf_swin.py#L1430",returnDescription:`
...
`}}),Ae=new mo({props:{$$slots:{default:[rl]},$$scope:{ctx:F}}}),qe=new qt({props:{anchor:"transformers.TFSwinForImageClassification.call.example",$$slots:{default:[il]},$$scope:{ctx:F}}}),{c(){d=n("meta"),v=u(),h=n("h1"),m=n("a"),w=n("span"),b(s.$$.fragment),p=u(),x=n("span"),Hs=r("Swin Transformer"),ss=u(),K=n("h2"),pe=n("a"),fo=n("span"),b(Be.$$.fragment),Ws=u(),uo=n("span"),Us=r("Overview"),ns=u(),he=n("p"),Vs=r("The Swin Transformer was proposed in "),Ke=n("a"),Bs=r("Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),Ks=r(`
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),is=u(),Dt=n("p"),Zs=r("Tips:"),ls=u(),B=n("ul"),Re=n("li"),Gs=r("One can use the "),Lt=n("a"),Js=r("AutoFeatureExtractor"),Qs=r(" API to prepare images for the model."),Xs=u(),Ye=n("li"),en=r("Swin pads the inputs supporting any input height and width (if divisible by "),_o=n("code"),tn=r("32"),on=r(")."),sn=u(),M=n("li"),nn=r("Swin can be used as a "),wo=n("em"),an=r("backbone"),rn=r(". When "),vo=n("code"),ln=r("output_hidden_states = True"),dn=r(", it will output both "),bo=n("code"),cn=r("hidden_states"),pn=r(" and "),$o=n("code"),hn=r("reshaped_hidden_states"),mn=r(". The "),To=n("code"),fn=r("reshaped_hidden_states"),un=r(" have a shape of "),yo=n("code"),gn=r("(batch, num_channels, height, width)"),_n=r(" rather than "),So=n("code"),wn=r("(batch_size, sequence_length, num_channels)"),vn=r("."),ds=u(),me=n("img"),cs=u(),fe=n("small"),bn=r("Swin Transformer architecture. Taken from the "),Ht=n("a"),$n=r("original paper"),Tn=r("."),ps=u(),q=n("p"),yn=r("This model was contributed by "),Ze=n("a"),Sn=r("novice03"),kn=r(". The Tensorflow version of this model was contributed by "),Ge=n("a"),Fn=r("amyeroberts"),xn=r(". The original code can be found "),Je=n("a"),Mn=r("here"),En=r("."),hs=u(),R=n("h2"),ue=n("a"),ko=n("span"),b(Qe.$$.fragment),jn=u(),Fo=n("span"),In=r("SwinConfig"),ms=u(),j=n("div"),b(Xe.$$.fragment),Cn=u(),Y=n("p"),An=r("This is the configuration class to store the configuration of a "),Wt=n("a"),qn=r("SwinModel"),Pn=r(`. It is used to instantiate a Swin
...
documentation from `),Vt=n("a"),Wn=r("PretrainedConfig"),Un=r(" for more information."),Vn=u(),b(ge.$$.fragment),fs=u(),G=n("h2"),_e=n("a"),xo=n("span"),b(tt.$$.fragment),Bn=u(),Mo=n("span"),Kn=r("SwinModel"),us=u(),H=n("div"),b(ot.$$.fragment),Rn=u(),st=n("p"),Yn=r(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),nt=n("a"),Zn=r("torch.nn.Module"),Gn=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Jn=u(),P=n("div"),b(at.$$.fragment),Qn=u(),J=n("p"),Xn=r("The "),Bt=n("a"),ea=r("SwinModel"),ta=r(" forward method, overrides the "),Eo=n("code"),oa=r("__call__"),sa=r(" special method."),na=u(),b(we.$$.fragment),aa=u(),b(ve.$$.fragment),gs=u(),Q=n("h2"),be=n("a"),jo=n("span"),b(rt.$$.fragment),ra=u(),Io=n("span"),ia=r("SwinForMaskedImageModeling"),_s=u(),W=n("div"),b(it.$$.fragment),la=u(),X=n("p"),da=r("Swin Model with a decoder on top for masked image modeling, as proposed in "),lt=n("a"),ca=r("SimMIM"),pa=r(`.
This model is a PyTorch `),dt=n("a"),ha=r("torch.nn.Module"),ma=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fa=u(),z=n("div"),b(ct.$$.fragment),ua=u(),ee=n("p"),ga=r("The "),Kt=n("a"),_a=r("SwinForMaskedImageModeling"),wa=r(" forward method, overrides the "),Co=n("code"),va=r("__call__"),ba=r(" special method."),$a=u(),b($e.$$.fragment),Ta=u(),b(Te.$$.fragment),ws=u(),te=n("h2"),ye=n("a"),Ao=n("span"),b(pt.$$.fragment),ya=u(),qo=n("span"),Sa=r("SwinForImageClassification"),vs=u(),I=n("div"),b(ht.$$.fragment),ka=u(),Po=n("p"),Fa=r(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),xa=u(),mt=n("p"),Ma=r("This model is a PyTorch "),ft=n("a"),Ea=r("torch.nn.Module"),ja=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ia=u(),O=n("div"),b(ut.$$.fragment),Ca=u(),oe=n("p"),Aa=r("The "),Rt=n("a"),qa=r("SwinForImageClassification"),Pa=r(" forward method, overrides the "),zo=n("code"),za=r("__call__"),Oa=r(" special method."),Na=u(),b(Se.$$.fragment),Da=u(),b(ke.$$.fragment),bs=u(),se=n("h2"),Fe=n("a"),Oo=n("span"),b(gt.$$.fragment),La=u(),No=n("span"),Ha=r("TFSwinModel"),$s=u(),U=n("div"),b(_t.$$.fragment),Wa=u(),wt=n("p"),Ua=r(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a Tensorflow
`),vt=n("a"),Va=r("tf.keras.layers.Layer"),Ba=r(` sub-class. Use it as a
regular Tensorflow Module and refer to the Tensorflow documentation for all matter related to general usage and
behavior.`),Ka=u(),N=n("div"),b(bt.$$.fragment),Ra=u(),ne=n("p"),Ya=r("The "),Yt=n("a"),Za=r("TFSwinModel"),Ga=r(" forward method, overrides the "),Do=n("code"),Ja=r("__call__"),Qa=r(" special method."),Xa=u(),b(xe.$$.fragment),er=u(),b(Me.$$.fragment),Ts=u(),ae=n("h2"),Ee=n("a"),Lo=n("span"),b($t.$$.fragment),tr=u(),Ho=n("span"),or=r("TFSwinForMaskedImageModeling"),ys=u(),V=n("div"),b(Tt.$$.fragment),sr=u(),re=n("p"),nr=r("Swin Model with a decoder on top for masked image modeling, as proposed in "),yt=n("a"),ar=r("SimMIM"),rr=r(`.
This model is a Tensorflow
`),St=n("a"),ir=r("tf.keras.layers.Layer"),lr=r(` sub-class. Use it as a
regular Tensorflow Module and refer to the Tensorflow documentation for all matter related to general usage and
behavior.`),dr=u(),D=n("div"),b(kt.$$.fragment),cr=u(),ie=n("p"),pr=r("The "),Zt=n("a"),hr=r("TFSwinForMaskedImageModeling"),mr=r(" forward method, overrides the "),Wo=n("code"),fr=r("__call__"),ur=r(" special method."),gr=u(),b(je.$$.fragment),_r=u(),b(Ie.$$.fragment),Ss=u(),le=n("h2"),Ce=n("a"),Uo=n("span"),b(Ft.$$.fragment),wr=u(),Vo=n("span"),vr=r("TFSwinForImageClassification"),ks=u(),C=n("div"),b(xt.$$.fragment),br=u(),Bo=n("p"),$r=r(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
regular Tensorflow Module and refer to the Tensorflow documentation for all matter related to general usage and
behavior.`),Fr=u(),L=n("div"),b(jt.$$.fragment),xr=u(),de=n("p"),Mr=r("The "),Gt=n("a"),Er=r("TFSwinForImageClassification"),jr=r(" forward method, overrides the "),Ko=n("code"),Ir=r("__call__"),Cr=r(" special method."),Ar=u(),b(Ae.$$.fragment),qr=u(),b(qe.$$.fragment),this.h()},l(t){const f=Ki('[data-svelte="svelte-1phssyn"]',document.head);d=a(f,"META",{name:!0,content:!0}),f.forEach(o),v=g(t),h=a(t,"H1",{class:!0});var It=l(h);m=a(It,"A",{id:!0,class:!0,href:!0});var Ro=l(m);w=a(Ro,"SPAN",{});var Yo=l(w);$(s.$$.fragment,Yo),Yo.forEach(o),Ro.forEach(o),p=g(It),x=a(It,"SPAN",{});var Zo=l(x);Hs=i(Zo,"Swin Transformer"),Zo.forEach(o),It.forEach(o),ss=g(t),K=a(t,"H2",{class:!0});var Ct=l(K);pe=a(Ct,"A",{id:!0,class:!0,href:!0});var Go=l(pe);fo=a(Go,"SPAN",{});var Jo=l(fo);$(Be.$$.fragment,Jo),Jo.forEach(o),Go.forEach(o),Ws=g(Ct),uo=a(Ct,"SPAN",{});var Qo=l(uo);Us=i(Qo,"Overview"),Qo.forEach(o),Ct.forEach(o),ns=g(t),he=a(t,"P",{});var At=l(he);Vs=i(At,"The Swin Transformer was proposed in "),Ke=a(At,"A",{href:!0,rel:!0});var Xo=l(Ke);Bs=i(Xo,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),Xo.forEach(o),Ks=i(At,`
