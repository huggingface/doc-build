import{S as gm,i as _m,s as vm,e as o,k as l,w as M,t as r,M as km,c as s,d as t,m as c,a,x as b,h as i,b as p,G as e,g as f,y,q as w,o as x,B as $,v as Tm,L as Bt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Dn}from"../../chunks/Tip-hf-doc-builder.js";import{D as Z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Pe}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as fe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Vt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Mm(E){let h,k,_,g,v;return g=new Pe({props:{code:`from transformers import MarianModel, MarianConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,k),e(h,_),e(_,g),e(h,v)},d(d){d&&t(h)}}}function wm(E){let h,k,_,g,v;return g=new Pe({props:{code:`from transformers import MarianTokenizer, MarianModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">26</span>, <span class="hljs-number">512</span>]`}}),{c(){h=o("p"),k=r("Example:"),_=l(),M(g.$$.fragment)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Example:"),u.forEach(t),_=c(d),b(g.$$.fragment,d)},m(d,u){f(d,h,u),e(h,k),f(d,_,u),y(g,d,u),v=!0},p:Bt,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){x(g.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(g,d)}}}function xm(E){let h,k,_,g,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,k),e(h,_),e(_,g),e(h,v)},d(d){d&&t(h)}}}function $m(E){let h,k,_,g,v;return g=new Pe({props:{code:`from transformers import MarianTokenizer, MarianMTModel
...
<span class="hljs-string">&quot;Where&#x27;s the bus stop?&quot;</span>`}}),{c(){h=o("p"),k=r("Examples:"),_=l(),M(g.$$.fragment)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Examples:"),u.forEach(t),_=c(d),b(g.$$.fragment,d)},m(d,u){f(d,h,u),e(h,k),f(d,_,u),y(g,d,u),v=!0},p:Bt,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){x(g.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(g,d)}}}function zm(E){let h,k,_,g,v;return g=new Pe({props:{code:`from transformers import MarianTokenizer, MarianForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){h=o("p"),k=r("Example:"),_=l(),M(g.$$.fragment)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Example:"),u.forEach(t),_=c(d),b(g.$$.fragment,d)},m(d,u){f(d,h,u),e(h,k),f(d,_,u),y(g,d,u),v=!0},p:Bt,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){x(g.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(g,d)}}}function jm(E){let h,k,_,g,v,d,u,q,Be,Ne,C,ve,ke,z,Q,ee,Ke,Ce,V,Ge,Le,L,X,Te,H,Je,Me,te,Ie,P,ne,N,I,Ye,B,oe,Ze,W,Xe,Qe,A,be,O,et,se,ae,tt,re,K,nt,ie,ye,de,S,ot,D,we,st;return{c(){h=o("p"),k=r("TensorFlow models and layers in "),_=o("code"),g=r("transformers"),v=r(" accept two formats as input:"),d=l(),u=o("ul"),q=o("li"),Be=r("having all inputs as keyword arguments (like PyTorch models), or"),Ne=l(),C=o("li"),ve=r("having all inputs as a list, tuple or dict in the first positional argument."),ke=l(),z=o("p"),Q=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),V=o("code"),Ge=r("model.fit()"),Le=r(` supports! If, however, you want to use the second
...
the Keras `),te=o("code"),Ie=r("Functional"),P=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),ne=l(),N=o("ul"),I=o("li"),Ye=r("a single Tensor with "),B=o("code"),oe=r("input_ids"),Ze=r(" only and nothing else: "),W=o("code"),Xe=r("model(input_ids)"),Qe=l(),A=o("li"),be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),D=o("a"),we=r("subclassing"),st=r(` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(T){h=s(T,"P",{});var j=a(h);k=i(j,"TensorFlow models and layers in "),_=s(j,"CODE",{});var xe=a(_);g=i(xe,"transformers"),xe.forEach(t),v=i(j," accept two formats as input:"),j.forEach(t),d=c(T),u=s(T,"UL",{});var $e=a(u);q=s($e,"LI",{});var Ae=a(q);Be=i(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),Ne=c($e),C=s($e,"LI",{});var ft=a(C);ve=i(ft,"having all inputs as a list, tuple or dict in the first positional argument."),ft.forEach(t),$e.forEach(t),ke=c(T),z=s(T,"P",{});var F=a(z);Q=i(F,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),ee=s(F,"CODE",{});var gt=a(ee);Ke=i(gt,"model.fit()"),gt.forEach(t),Ce=i(F,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),V=s(F,"CODE",{});var le=a(V);Ge=i(le,"model.fit()"),le.forEach(t),Le=i(F,` supports! If, however, you want to use the second
format outside of Keras methods like `),L=s(F,"CODE",{});var ze=a(L);X=i(ze,"fit()"),ze.forEach(t),Te=i(F," and "),H=s(F,"CODE",{});var _t=a(H);Je=i(_t,"predict()"),_t.forEach(t),Me=i(F,`, such as when creating your own layers or models with
the Keras `),te=s(F,"CODE",{});var at=a(te);Ie=i(at,"Functional"),at.forEach(t),P=i(F,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),F.forEach(t),ne=c(T),N=s(T,"UL",{});var G=a(N);I=s(G,"LI",{});var ce=a(I);Ye=i(ce,"a single Tensor with "),B=s(ce,"CODE",{});var vt=a(B);oe=i(vt,"input_ids"),vt.forEach(t),Ze=i(ce," only and nothing else: "),W=s(ce,"CODE",{});var je=a(W);Xe=i(je,"model(input_ids)"),je.forEach(t),ce.forEach(t),Qe=c(G),A=s(G,"LI",{});var pe=a(A);be=i(pe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),ie=s(it,"CODE",{});var Tt=a(ie);ye=i(Tt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Tt.forEach(t),it.forEach(t),G.forEach(t),de=c(T),S=s(T,"P",{});var U=a(S);ot=i(U,`Note that when creating models and layers with
`),D=s(U,"A",{href:!0,rel:!0});var Mt=a(D);we=i(Mt,"subclassing"),Mt.forEach(t),st=i(U,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),U.forEach(t),this.h()},h(){p(D,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),p(D,"rel","nofollow")},m(T,j){f(T,h,j),e(h,k),e(h,_),e(_,g),e(h,v),f(T,d,j),f(T,u,j),e(u,q),e(q,Be),e(u,Ne),e(u,C),e(C,ve),f(T,ke,j),f(T,z,j),e(z,Q),e(z,ee),e(ee,Ke),e(z,Ce),e(z,V),e(V,Ge),e(z,Le),e(z,L),e(L,X),e(z,Te),e(z,H),e(H,Je),e(z,Me),e(z,te),e(te,Ie),e(z,P),f(T,ne,j),f(T,N,j),e(N,I),e(I,Ye),e(I,B),e(B,oe),e(I,Ze),e(I,W),e(W,Xe),e(N,Qe),e(N,A),e(A,be),e(A,O),e(O,et),e(A,se),e(A,ae),e(ae,tt),e(N,re),e(N,K),e(K,nt),e(K,ie),e(ie,ye),f(T,de,j),f(T,S,j),e(S,ot),e(S,D),e(D,we),e(S,st)},d(T){T&&t(h),T&&t(d),T&&t(u),T&&t(ke),T&&t(z),T&&t(ne),T&&t(N),T&&t(de),T&&t(S)}}}function Em(E){let h,k,_,g,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,k),e(h,_),e(_,g),e(h,v)},d(d){d&&t(h)}}}function qm(E){let h,k,_,g,v;return g=new Pe({props:{code:`from transformers import MarianTokenizer, TFMarianModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=o("p"),k=r("Example:"),_=l(),M(g.$$.fragment)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Example:"),u.forEach(t),_=c(d),b(g.$$.fragment,d)},m(d,u){f(d,h,u),e(h,k),f(d,_,u),y(g,d,u),v=!0},p:Bt,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){x(g.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(g,d)}}}function Fm(E){let h,k,_,g,v,d,u,q,Be,Ne,C,ve,ke,z,Q,ee,Ke,Ce,V,Ge,Le,L,X,Te,H,Je,Me,te,Ie,P,ne,N,I,Ye,B,oe,Ze,W,Xe,Qe,A,be,O,et,se,ae,tt,re,K,nt,ie,ye,de,S,ot,D,we,st;return{c(){h=o("p"),k=r("TensorFlow models and layers in "),_=o("code"),g=r("transformers"),v=r(" accept two formats as input:"),d=l(),u=o("ul"),q=o("li"),Be=r("having all inputs as keyword arguments (like PyTorch models), or"),Ne=l(),C=o("li"),ve=r("having all inputs as a list, tuple or dict in the first positional argument."),ke=l(),z=o("p"),Q=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),ee=o("code"),Ke=r("model.fit()"),Ce=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),V=o("code"),Ge=r("model.fit()"),Le=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),L=o("code"),X=r("fit()"),Te=r(" and "),H=o("code"),Je=r("predict()"),Me=r(`, such as when creating your own layers or models with
the Keras `),te=o("code"),Ie=r("Functional"),P=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),ie=s(it,"CODE",{});var Tt=a(ie);ye=i(Tt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Tt.forEach(t),it.forEach(t),G.forEach(t),de=c(T),S=s(T,"P",{});var U=a(S);ot=i(U,`Note that when creating models and layers with
`),D=s(U,"A",{href:!0,rel:!0});var Mt=a(D);we=i(Mt,"subclassing"),Mt.forEach(t),st=i(U,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),U.forEach(t),this.h()},h(){p(D,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),p(D,"rel","nofollow")},m(T,j){f(T,h,j),e(h,k),e(h,_),e(_,g),e(h,v),f(T,d,j),f(T,u,j),e(u,q),e(q,Be),e(u,Ne),e(u,C),e(C,ve),f(T,ke,j),f(T,z,j),e(z,Q),e(z,ee),e(ee,Ke),e(z,Ce),e(z,V),e(V,Ge),e(z,Le),e(z,L),e(L,X),e(z,Te),e(z,H),e(H,Je),e(z,Me),e(z,te),e(te,Ie),e(z,P),f(T,ne,j),f(T,N,j),e(N,I),e(I,Ye),e(I,B),e(B,oe),e(I,Ze),e(I,W),e(W,Xe),e(N,Qe),e(N,A),e(A,be),e(A,O),e(O,et),e(A,se),e(A,ae),e(ae,tt),e(N,re),e(N,K),e(K,nt),e(K,ie),e(ie,ye),f(T,de,j),f(T,S,j),e(S,ot),e(S,D),e(D,we),e(S,st)},d(T){T&&t(h),T&&t(d),T&&t(u),T&&t(ke),T&&t(z),T&&t(ne),T&&t(N),T&&t(de),T&&t(S)}}}function Pm(E){let h,k,_,g,v;return{c(){h=o("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,k),e(h,_),e(_,g),e(h,v)},d(d){d&&t(h)}}}function Nm(E){let h,k,_,g,v;return g=new Pe({props:{code:`from transformers import MarianTokenizer, TFMarianMTModel
...
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,k),e(h,_),e(_,g),e(h,v)},d(d){d&&t(h)}}}function Lm(E){let h,k,_,g,v;return g=new Pe({props:{code:`from transformers import MarianTokenizer, FlaxMarianModel
...
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,k),e(h,_),e(_,g),e(h,v)},d(d){d&&t(h)}}}function Am(E){let h,k,_,g,v;return g=new Pe({props:{code:`from transformers import MarianTokenizer, FlaxMarianMTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){h=o("p"),k=r("Example:"),_=l(),M(g.$$.fragment)},l(d){h=s(d,"P",{});var u=a(h);k=i(u,"Example:"),u.forEach(t),_=c(d),b(g.$$.fragment,d)},m(d,u){f(d,h,u),e(h,k),f(d,_,u),y(g,d,u),v=!0},p:Bt,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){x(g.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(g,d)}}}function Om(E){let h,k,_,g,v,d,u,q,Be,Ne,C,ve,ke,z,Q,ee,Ke,Ce,V,Ge,Le,L,X,Te,H,Je,Me,te,Ie,P,ne,N,I,Ye,B,oe,Ze,W,Xe,Qe,A,be,O,et,se,ae,tt,re,K,nt,ie,ye,de,S,ot,D,we,st,T,j,xe,$e,Ae,ft,F,gt,le,ze,_t,at,G,ce,vt,je,pe,rt,kt,it,Tt,U,Mt,Ks,Li,Ii,Gs,Ai,Oi,Si,Js,Hn,Di,Ys,Hi,Wi,Ui,Zs,Wn,Ri,Un,Vi,Bi,cr,bt,Kt,Xs,Rn,Ki,Qs,Gi,pr,Oe,_s,Ji,ea,Yi,Zi,Vn,Xi,Bn,Qi,ed,td,yt,nd,ta,od,sd,na,ad,rd,id,oa,dd,hr,wt,Gt,sa,Kn,ld,aa,cd,ur,Jt,ra,pd,hd,ia,Gn,ud,mr,xt,Yt,da,Jn,md,la,fd,fr,Se,Yn,gd,ca,_d,vd,kd,Zn,Td,pa,Md,bd,yd,Xn,wd,Qn,xd,$d,zd,eo,jd,ha,Ed,qd,gr,Zt,Fd,to,Pd,Nd,_r,no,vr,vs,Cd,kr,oo,Tr,$t,Xt,ua,so,Ld,ma,Id,Mr,ks,Ad,br,ao,yr,Ts,Od,wr,ro,xr,zt,Qt,fa,io,Sd,ga,Dd,$r,Ee,lo,Hd,jt,Wd,Ms,Ud,Rd,co,Vd,Bd,Kd,Et,Gd,bs,Jd,Yd,ys,Zd,Xd,Qd,en,zr,qt,tn,_a,po,el,va,tl,jr,he,ho,nl,uo,ol,mo,sl,al,rl,fo,il,ws,dl,ll,cl,nn,pl,on,go,hl,ka,ul,Er,Ft,sn,Ta,_o,ml,Ma,fl,qr,qe,vo,gl,ko,_l,xs,vl,kl,Tl,To,Ml,Mo,bl,yl,wl,De,bo,xl,Pt,$l,$s,zl,jl,ba,El,ql,Fl,an,Pl,rn,Fr,Nt,dn,ya,yo,Nl,wa,Cl,Pr,Fe,wo,Ll,xo,Il,zs,Al,Ol,Sl,$o,Dl,zo,Hl,Wl,Ul,ge,jo,Rl,Ct,Vl,js,Bl,Kl,xa,Gl,Jl,Yl,ln,Zl,Eo,Xl,qo,Ql,ec,tc,cn,Nr,Lt,pn,$a,Fo,nc,za,oc,Cr,It,Po,sc,hn,No,ac,un,Lr,At,mn,ja,Co,rc,Ea,ic,Ir,ue,Lo,dc,Io,lc,Es,cc,pc,hc,Ao,uc,Oo,mc,fc,gc,fn,_c,He,So,vc,Ot,kc,qs,Tc,Mc,qa,bc,yc,wc,gn,xc,_n,Ar,St,vn,Fa,Do,$c,Pa,zc,Or,me,Ho,jc,Wo,Ec,Fs,qc,Fc,Pc,Uo,Nc,Ro,Cc,Lc,Ic,kn,Ac,_e,Vo,Oc,Dt,Sc,Ps,Dc,Hc,Na,Wc,Uc,Rc,Tn,Vc,Bo,Bc,Ko,Kc,Gc,Jc,Mn,Sr,Ht,bn,Ca,Go,Yc,La,Zc,Dr,J,Jo,Xc,Yo,Qc,Ns,ep,tp,np,Zo,op,Xo,sp,ap,rp,Ia,ip,dp,dt,Aa,Qo,lp,cp,Oa,es,pp,hp,Sa,ts,up,mp,Da,ns,fp,gp,We,os,_p,Wt,vp,Ha,kp,Tp,Wa,Mp,bp,yp,yn,wp,wn,Hr,Ut,xn,Ua,ss,xp,Ra,$p,Wr,Y,as,zp,rs,jp,Cs,Ep,qp,Fp,is,Pp,ds,Np,Cp,Lp,Va,Ip,Ap,lt,Ba,ls,Op,Sp,Ka,cs,Dp,Hp,Ga,ps,Wp,Up,Ja,hs,Rp,Vp,Ue,us,Bp,Rt,Kp,Ya,Gp,Jp,Za,Yp,Zp,Xp,$n,Qp,zn,Ur;return d=new fe({}),H=new fe({}),Rn=new fe({}),Kn=new fe({}),Jn=new fe({}),no=new Pe({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
[<span class="hljs-string">&quot;c&#x27;est une phrase en anglais que nous voulons traduire en fran\xE7ais&quot;</span>,
 ...
 <span class="hljs-string">&#x27;Y esto al espa\xF1ol&#x27;</span>]`}}),oo=new Pe({props:{code:`from huggingface_hub import list_models
...
old_style_multi_models = [<span class="hljs-string">f&quot;<span class="hljs-subst">{org}</span>/<span class="hljs-subst">{s}</span>&quot;</span> <span class="hljs-keyword">for</span> s <span class="hljs-keyword">in</span> suffix <span class="hljs-keyword">if</span> s != s.lower()]`}}),so=new fe({}),ao=new Pe({props:{code:`['Helsinki-NLP/opus-mt-NORTH_EU-NORTH_EU',
...
}`}}),ro=new Pe({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.1/en/model_doc/marian#transformers.MarianConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/marian/modeling_marian.py#L1398",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/marian/modeling_marian.py#L1573",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/marian/modeling_tf_marian.py#L1205",returnDescription:`
<p>A <a
...
`}}),gn=new Dn({props:{$$slots:{default:[Em]},$$scope:{ctx:E}}}),_n=new Vt({props:{anchor:"transformers.TFMarianModel.call.example",$$slots:{default:[qm]},$$scope:{ctx:E}}}),Do=new fe({}),Ho=new Z({props:{name:"class transformers.TFMarianMTModel",anchor:"transformers.TFMarianMTModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/marian/modeling_tf_marian.py#L1299"}}),kn=new Dn({props:{$$slots:{default:[Fm]},$$scope:{ctx:E}}}),Vo=new Z({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/marian/modeling_tf_marian.py#L1333",returnDescription:`
<p>A <a
...
`}}),Tn=new Dn({props:{$$slots:{default:[Pm]},$$scope:{ctx:E}}}),Mn=new Vt({props:{anchor:"transformers.TFMarianMTModel.call.example",$$slots:{default:[Nm]},$$scope:{ctx:E}}}),Go=new fe({}),Jo=new Z({props:{name:"class transformers.FlaxMarianModel",anchor:"transformers.FlaxMarianModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/marian/modeling_flax_marian.py#L1142",returnDescription:`
<p>A <a
...
`}}),yn=new Dn({props:{$$slots:{default:[Cm]},$$scope:{ctx:E}}}),wn=new Vt({props:{anchor:"transformers.FlaxMarianModel.__call__.example",$$slots:{default:[Lm]},$$scope:{ctx:E}}}),ss=new fe({}),as=new Z({props:{name:"class transformers.FlaxMarianMTModel",anchor:"transformers.FlaxMarianMTModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),$n=new Dn({props:{$$slots:{default:[Im]},$$scope:{ctx:E}}}),zn=new Vt({props:{anchor:"transformers.FlaxMarianMTModel.__call__.example",$$slots:{default:[Am]},$$scope:{ctx:E}}}),{c(){h=o("meta"),k=l(),_=o("h1"),g=o("a"),v=o("span"),M(d.$$.fragment),u=l(),q=o("span"),Be=r("MarianMT"),Ne=l(),C=o("p"),ve=o("strong"),ke=r("Bugs:"),z=r(" If you see something strange, file a "),Q=o("a"),ee=r("Github Issue"),Ke=r(`
and assign @patrickvonplaten.`),Ce=l(),V=o("p"),Ge=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),Le=l(),L=o("h2"),X=o("a"),Te=o("span"),M(H.$$.fragment),Je=l(),Me=o("span"),te=r("Implementation Notes"),Ie=l(),P=o("ul"),ne=o("li"),N=o("p"),I=r("Each model is about 298 MB on disk, there are more than 1,000 models."),Ye=l(),B=o("li"),oe=o("p"),Ze=r("The list of supported language pairs can be found "),W=o("a"),Xe=r("here"),Qe=r("."),A=l(),be=o("li"),O=o("p"),et=r("Models were originally trained by "),se=o("a"),ae=r("J\xF6rg Tiedemann"),tt=r(" using the "),re=o("a"),K=r("Marian"),nt=r(" C++ library, which supports fast training and translation."),ie=l(),ye=o("li"),de=o("p"),S=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),ot=l(),D=o("li"),we=o("p"),st=r("The 80 opus models that require BPE preprocessing are not supported."),T=l(),j=o("li"),xe=o("p"),$e=r("The modeling code is the same as "),Ae=o("a"),ft=r("BartForConditionalGeneration"),F=r(" with a few minor modifications:"),gt=l(),le=o("ul"),ze=o("li"),_t=r("static (sinusoid) positional embeddings ("),at=o("code"),G=r("MarianConfig.static_position_embeddings=True"),ce=r(")"),vt=l(),je=o("li"),pe=r("no layernorm_embedding ("),rt=o("code"),kt=r("MarianConfig.normalize_embedding=False"),it=r(")"),Tt=l(),U=o("li"),Mt=r("the model starts generating with "),Ks=o("code"),Li=r("pad_token_id"),Ii=r(` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Gs=o("code"),Ai=r("<s/>"),Oi=r("),"),Si=l(),Js=o("li"),Hn=o("p"),Di=r("Code to bulk convert models can be found in "),Ys=o("code"),Hi=r("convert_marian_to_pytorch.py"),Wi=r("."),Ui=l(),Zs=o("li"),Wn=o("p"),Ri=r("This model was contributed by "),Un=o("a"),Vi=r("sshleifer"),Bi=r("."),cr=l(),bt=o("h2"),Kt=o("a"),Xs=o("span"),M(Rn.$$.fragment),Ki=l(),Qs=o("span"),Gi=r("Naming"),pr=l(),Oe=o("ul"),_s=o("li"),Ji=r("All model names use the following format: "),ea=o("code"),Yi=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),Zi=l(),Vn=o("li"),Xi=r("The language codes used to name models are inconsistent. Two digit codes can usually be found "),Bn=o("a"),Qi=r("here"),ed=r(`, three digit codes require googling \u201Clanguage
...
group use a combination of ISO-639-5 codes and ISO-639-2 codes.`),hr=l(),wt=o("h2"),Gt=o("a"),sa=o("span"),M(Kn.$$.fragment),ld=l(),aa=o("span"),cd=r("Examples"),ur=l(),Jt=o("ul"),ra=o("li"),pd=r(`Since Marian models are smaller than many other translation models available in the library, they can be useful for
fine-tuning experiments and integration tests.`),hd=l(),ia=o("li"),Gn=o("a"),ud=r("Fine-tune on GPU"),mr=l(),xt=o("h2"),Yt=o("a"),da=o("span"),M(Jn.$$.fragment),md=l(),la=o("span"),fd=r("Multilingual Models"),fr=l(),Se=o("ul"),Yn=o("li"),gd=r("All model names use the following format: "),ca=o("code"),_d=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),vd=r(":"),kd=l(),Zn=o("li"),Td=r(`If a model can output multiple languages, and you should specify a language code by prepending the desired output
language to the `),pa=o("code"),Md=r("src_text"),bd=r("."),yd=l(),Xn=o("li"),wd=r("You can see a models\u2019s supported language codes in its model card, under target constituents, like in "),Qn=o("a"),xd=r("opus-mt-en-roa"),$d=r("."),zd=l(),eo=o("li"),jd=r("Note that if a model is only multilingual on the source side, like "),ha=o("code"),Ed=r("Helsinki-NLP/opus-mt-roa-en"),qd=r(`, no language
codes are required.`),gr=l(),Zt=o("p"),Fd=r("New multi-lingual models from the "),to=o("a"),Pd=r("Tatoeba-Challenge repo"),Nd=r(`
...
group:`),br=l(),M(ao.$$.fragment),yr=l(),Ts=o("p"),Od=r("Example of translating english to many romance languages, using old-style 2 character language codes"),wr=l(),M(ro.$$.fragment),xr=l(),zt=o("h2"),Qt=o("a"),fa=o("span"),M(io.$$.fragment),Sd=l(),ga=o("span"),Dd=r("MarianConfig"),$r=l(),Ee=o("div"),M(lo.$$.fragment),Hd=l(),jt=o("p"),Wd=r("This is the configuration class to store the configuration of a "),Ms=o("a"),Ud=r("MarianModel"),Rd=r(`. It is used to instantiate an
...
`),co=o("a"),Vd=r("Helsinki-NLP/opus-mt-en-de"),Bd=r(" architecture."),Kd=l(),Et=o("p"),Gd=r("Configuration objects inherit from "),bs=o("a"),Jd=r("PretrainedConfig"),Yd=r(` and can be used to control the model outputs. Read the
documentation from `),ys=o("a"),Zd=r("PretrainedConfig"),Xd=r(" for more information."),Qd=l(),M(en.$$.fragment),zr=l(),qt=o("h2"),tn=o("a"),_a=o("span"),M(po.$$.fragment),el=l(),va=o("span"),tl=r("MarianTokenizer"),jr=l(),he=o("div"),M(ho.$$.fragment),nl=l(),uo=o("p"),ol=r("Construct a Marian tokenizer. Based on "),mo=o("a"),sl=r("SentencePiece"),al=r("."),rl=l(),fo=o("p"),il=r("This tokenizer inherits from "),ws=o("a"),dl=r("PreTrainedTokenizer"),ll=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),cl=l(),M(nn.$$.fragment),pl=l(),on=o("div"),M(go.$$.fragment),hl=l(),ka=o("p"),ul=r("Build model inputs from a sequence by appending eos_token_id."),Er=l(),Ft=o("h2"),sn=o("a"),Ta=o("span"),M(_o.$$.fragment),ml=l(),Ma=o("span"),fl=r("MarianModel"),qr=l(),qe=o("div"),M(vo.$$.fragment),gl=l(),ko=o("p"),_l=r(`The bare Marian Model outputting raw hidden-states without any specific head on top.
This model inherits from `),xs=o("a"),vl=r("PreTrainedModel"),kl=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),wl=l(),De=o("div"),M(bo.$$.fragment),xl=l(),Pt=o("p"),$l=r("The "),$s=o("a"),zl=r("MarianModel"),jl=r(" forward method, overrides the "),ba=o("code"),El=r("__call__"),ql=r(" special method."),Fl=l(),M(an.$$.fragment),Pl=l(),M(rn.$$.fragment),Fr=l(),Nt=o("h2"),dn=o("a"),ya=o("span"),M(yo.$$.fragment),Nl=l(),wa=o("span"),Cl=r("MarianMTModel"),Pr=l(),Fe=o("div"),M(wo.$$.fragment),Ll=l(),xo=o("p"),Il=r(`The Marian Model with a language modeling head. Can be used for summarization.
This model inherits from `),zs=o("a"),Al=r("PreTrainedModel"),Ol=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sl=l(),$o=o("p"),Dl=r("This model is also a PyTorch "),zo=o("a"),Hl=r("torch.nn.Module"),Wl=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ul=l(),ge=o("div"),M(jo.$$.fragment),Rl=l(),Ct=o("p"),Vl=r("The "),js=o("a"),Bl=r("MarianMTModel"),Kl=r(" forward method, overrides the "),xa=o("code"),Gl=r("__call__"),Jl=r(" special method."),Yl=l(),M(ln.$$.fragment),Zl=l(),Eo=o("p"),Xl=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),qo=o("a"),Ql=r("here"),ec=r("."),tc=l(),M(cn.$$.fragment),Nr=l(),Lt=o("h2"),pn=o("a"),$a=o("span"),M(Fo.$$.fragment),nc=l(),za=o("span"),oc=r("MarianForCausalLM"),Cr=l(),It=o("div"),M(Po.$$.fragment),sc=l(),hn=o("div"),M(No.$$.fragment),ac=l(),M(un.$$.fragment),Lr=l(),At=o("h2"),mn=o("a"),ja=o("span"),M(Co.$$.fragment),rc=l(),Ea=o("span"),ic=r("TFMarianModel"),Ir=l(),ue=o("div"),M(Lo.$$.fragment),dc=l(),Io=o("p"),lc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
behavior.`),gc=l(),M(fn.$$.fragment),_c=l(),He=o("div"),M(So.$$.fragment),vc=l(),Ot=o("p"),kc=r("The "),qs=o("a"),Tc=r("TFMarianModel"),Mc=r(" forward method, overrides the "),qa=o("code"),bc=r("__call__"),yc=r(" special method."),wc=l(),M(gn.$$.fragment),xc=l(),M(_n.$$.fragment),Ar=l(),St=o("h2"),vn=o("a"),Fa=o("span"),M(Do.$$.fragment),$c=l(),Pa=o("span"),zc=r("TFMarianMTModel"),Or=l(),me=o("div"),M(Ho.$$.fragment),jc=l(),Wo=o("p"),Ec=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
This model inherits from `),Fs=o("a"),qc=r("TFPreTrainedModel"),Fc=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc=l(),Uo=o("p"),Nc=r("This model is also a "),Ro=o("a"),Cc=r("tf.keras.Model"),Lc=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ic=l(),M(kn.$$.fragment),Ac=l(),_e=o("div"),M(Vo.$$.fragment),Oc=l(),Dt=o("p"),Sc=r("The "),Ps=o("a"),Dc=r("TFMarianMTModel"),Hc=r(" forward method, overrides the "),Na=o("code"),Wc=r("__call__"),Uc=r(" special method."),Rc=l(),M(Tn.$$.fragment),Vc=l(),Bo=o("p"),Bc=r(`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rp=l(),Ia=o("p"),ip=r("Finally, this model supports inherent JAX features such as:"),dp=l(),dt=o("ul"),Aa=o("li"),Qo=o("a"),lp=r("Just-In-Time (JIT) compilation"),cp=l(),Oa=o("li"),es=o("a"),pp=r("Automatic Differentiation"),hp=l(),Sa=o("li"),ts=o("a"),up=r("Vectorization"),mp=l(),Da=o("li"),ns=o("a"),fp=r("Parallelization"),gp=l(),We=o("div"),M(os.$$.fragment),_p=l(),Wt=o("p"),vp=r("The "),Ha=o("code"),kp=r("FlaxMarianPreTrainedModel"),Tp=r(" forward method, overrides the "),Wa=o("code"),Mp=r("__call__"),bp=r(" special method."),yp=l(),M(yn.$$.fragment),wp=l(),M(wn.$$.fragment),Hr=l(),Ut=o("h2"),xn=o("a"),Ua=o("span"),M(ss.$$.fragment),xp=l(),Ra=o("span"),$p=r("FlaxMarianMTModel"),Wr=l(),Y=o("div"),M(as.$$.fragment),zp=l(),rs=o("p"),jp=r(`The MARIAN Model with a language modeling head. Can be used for translation.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp=l(),is=o("p"),Pp=r(`This model is also a Flax Linen
`),ds=o("a"),Np=r("flax.nn.Module"),Cp=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Lp=l(),Va=o("p"),Ip=r("Finally, this model supports inherent JAX features such as:"),Ap=l(),lt=o("ul"),Ba=o("li"),ls=o("a"),Op=r("Just-In-Time (JIT) compilation"),Sp=l(),Ka=o("li"),cs=o("a"),Dp=r("Automatic Differentiation"),Hp=l(),Ga=o("li"),ps=o("a"),Wp=r("Vectorization"),Up=l(),Ja=o("li"),hs=o("a"),Rp=r("Parallelization"),Vp=l(),Ue=o("div"),M(us.$$.fragment),Bp=l(),Rt=o("p"),Kp=r("The "),Ya=o("code"),Gp=r("FlaxMarianPreTrainedModel"),Jp=r(" forward method, overrides the "),Za=o("code"),Yp=r("__call__"),Zp=r(" special method."),Xp=l(),M($n.$$.fragment),Qp=l(),M(zn.$$.fragment),this.h()},l(n){const m=km('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(t),k=c(n),_=s(n,"H1",{class:!0});var ms=a(_);g=s(ms,"A",{id:!0,class:!0,href:!0});var Xa=a(g);v=s(Xa,"SPAN",{});var Qa=a(v);b(d.$$.fragment,Qa),Qa.forEach(t),Xa.forEach(t),u=c(ms),q=s(ms,"SPAN",{});var er=a(q);Be=i(er,"MarianMT"),er.forEach(t),ms.forEach(t),Ne=c(n),C=s(n,"P",{});var jn=a(C);ve=s(jn,"STRONG",{});var tr=a(ve);ke=i(tr,"Bugs:"),tr.forEach(t),z=i(jn," If you see something strange, file a "),Q=s(jn,"A",{href:!0,rel:!0});var nr=a(Q);ee=i(nr,"Github Issue"),nr.forEach(t),Ke=i(jn,`
and assign @patrickvonplaten.`),jn.forEach(t),Ce=c(n),V=s(n,"P",{});var or=a(V);Ge=i(or,"Translations should be similar, but not identical to output in the test set linked to in each model card."),or.forEach(t),Le=c(n),L=s(n,"H2",{class:!0});var fs=a(L);X=s(fs,"A",{id:!0,class:!0,href:!0});var sr=a(X);Te=s(sr,"SPAN",{});var ar=a(Te);b(H.$$.fragment,ar),ar.forEach(t),sr.forEach(t),Je=c(fs),Me=s(fs,"SPAN",{});var rr=a(Me);te=i(rr,"Implementation Notes"),rr.forEach(t),fs.forEach(t),Ie=c(n),P=s(n,"UL",{});var R=a(P);ne=s(R,"LI",{});var ir=a(ne);N=s(ir,"P",{});var dr=a(N);I=i(dr,"Each model is about 298 MB on disk, there are more than 1,000 models."),dr.forEach(t),ir.forEach(t),Ye=c(R),B=s(R,"LI",{});var lr=a(B);oe=s(lr,"P",{});var gs=a(oe);Ze=i(gs,"The list of supported language pairs can be found "),W=s(gs,"A",{href:!0,rel:!0});var th=a(W);Xe=i(th,"here"),th.forEach(t),Qe=i(gs,"."),gs.forEach(t),lr.forEach(t),A=c(R),be=s(R,"LI",{});var nh=a(be);O=s(nh,"P",{});var Ls=a(O);et=i(Ls,"Models were originally trained by "),se=s(Ls,"A",{href:!0,rel:!0});var oh=a(se);ae=i(oh,"J\xF6rg Tiedemann"),oh.forEach(t),tt=i(Ls," using the "),re=s(Ls,"A",{href:!0,rel:!0});var sh=a(re);K=i(sh,"Marian"),sh.forEach(t),nt=i(Ls," C++ library, which supports fast training and translation."),Ls.forEach(t),nh.forEach(t),ie=c(R),ye=s(R,"LI",{});var ah=a(ye);de=s(ah,"P",{});var rh=a(de);S=i(rh,`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),rh.forEach(t),ah.forEach(t),ot=c(R),D=s(R,"LI",{});var ih=a(D);we=s(ih,"P",{});var dh=a(we);st=i(dh,"The 80 opus models that require BPE preprocessing are not supported."),dh.forEach(t),ih.forEach(t),T=c(R),j=s(R,"LI",{});var Rr=a(j);xe=s(Rr,"P",{});var Vr=a(xe);$e=i(Vr,"The modeling code is the same as "),Ae=s(Vr,"A",{href:!0});var lh=a(Ae);ft=i(lh,"BartForConditionalGeneration"),lh.forEach(t),F=i(Vr," with a few minor modifications:"),Vr.forEach(t),gt=c(Rr),le=s(Rr,"UL",{});var Is=a(le);ze=s(Is,"LI",{});var Br=a(ze);_t=i(Br,"static (sinusoid) positional embeddings ("),at=s(Br,"CODE",{});var ch=a(at);G=i(ch,"MarianConfig.static_position_embeddings=True"),ch.forEach(t),ce=i(Br,")"),Br.forEach(t),vt=c(Is),je=s(Is,"LI",{});var Kr=a(je);pe=i(Kr,"no layernorm_embedding ("),rt=s(Kr,"CODE",{});var ph=a(rt);kt=i(ph,"MarianConfig.normalize_embedding=False"),ph.forEach(t),it=i(Kr,")"),Kr.forEach(t),Tt=c(Is),U=s(Is,"LI",{});var As=a(U);Mt=i(As,"the model starts generating with "),Ks=s(As,"CODE",{});var hh=a(Ks);Li=i(hh,"pad_token_id"),hh.forEach(t),Ii=i(As,` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Gs=s(As,"CODE",{});var uh=a(Gs);Ai=i(uh,"<s/>"),uh.forEach(t),Oi=i(As,"),"),As.forEach(t),Is.forEach(t),Rr.forEach(t),Si=c(R),Js=s(R,"LI",{});var mh=a(Js);Hn=s(mh,"P",{});var Gr=a(Hn);Di=i(Gr,"Code to bulk convert models can be found in "),Ys=s(Gr,"CODE",{});var fh=a(Ys);Hi=i(fh,"convert_marian_to_pytorch.py"),fh.forEach(t),Wi=i(Gr,"."),Gr.forEach(t),mh.forEach(t),Ui=c(R),Zs=s(R,"LI",{});var gh=a(Zs);Wn=s(gh,"P",{});var Jr=a(Wn);Ri=i(Jr,"This model was contributed by "),Un=s(Jr,"A",{href:!0,rel:!0});var _h=a(Un);Vi=i(_h,"sshleifer"),_h.forEach(t),Bi=i(Jr,"."),Jr.forEach(t),gh.forEach(t),R.forEach(t),cr=c(n),bt=s(n,"H2",{class:!0});var Yr=a(bt);Kt=s(Yr,"A",{id:!0,class:!0,href:!0});var vh=a(Kt);Xs=s(vh,"SPAN",{});var kh=a(Xs);b(Rn.$$.fragment,kh),kh.forEach(t),vh.forEach(t),Ki=c(Yr),Qs=s(Yr,"SPAN",{});var Th=a(Qs);Gi=i(Th,"Naming"),Th.forEach(t),Yr.forEach(t),pr=c(n),Oe=s(n,"UL",{});var En=a(Oe);_s=s(En,"LI",{});var eh=a(_s);Ji=i(eh,"All model names use the following format: "),ea=s(eh,"CODE",{});var Mh=a(ea);Yi=i(Mh,"Helsinki-NLP/opus-mt-{src}-{tgt}"),Mh.forEach(t),eh.forEach(t),Zi=c(En),Vn=s(En,"LI",{});var Zr=a(Vn);Xi=i(Zr,"The language codes used to name models are inconsistent. Two digit codes can usually be found "),Bn=s(Zr,"A",{href:!0,rel:!0});var bh=a(Bn);Qi=i(bh,"here"),bh.forEach(t),ed=i(Zr,`, three digit codes require googling \u201Clanguage
code {code}\u201C.`),Zr.forEach(t),td=c(En),yt=s(En,"LI",{});var Os=a(yt);nd=i(Os,"Codes formatted like "),ta=s(Os,"CODE",{});var yh=a(ta);od=i(yh,"es_AR"),yh.forEach(t),sd=i(Os," are usually "),na=s(Os,"CODE",{});var wh=a(na);ad=i(wh,"code_{region}"),wh.forEach(t),rd=i(Os,". That one is Spanish from Argentina."),Os.forEach(t),id=c(En),oa=s(En,"LI",{});var xh=a(oa);dd=i(xh,`The models were converted in two stages. The first 1000 models use ISO-639-2 codes to identify languages, the second
group use a combination of ISO-639-5 codes and ISO-639-2 codes.`),xh.forEach(t),En.forEach(t),hr=c(n),wt=s(n,"H2",{class:!0});var Xr=a(wt);Gt=s(Xr,"A",{id:!0,class:!0,href:!0});var $h=a(Gt);sa=s($h,"SPAN",{});var zh=a(sa);b(Kn.$$.fragment,zh),zh.forEach(t),$h.forEach(t),ld=c(Xr),aa=s(Xr,"SPAN",{});var jh=a(aa);cd=i(jh,"Examples"),jh.forEach(t),Xr.forEach(t),ur=c(n),Jt=s(n,"UL",{});var Qr=a(Jt);ra=s(Qr,"LI",{});var Eh=a(ra);pd=i(Eh,`Since Marian models are smaller than many other translation models available in the library, they can be useful for
fine-tuning experiments and integration tests.`),Eh.forEach(t),hd=c(Qr),ia=s(Qr,"LI",{});var qh=a(ia);Gn=s(qh,"A",{href:!0,rel:!0});var Fh=a(Gn);ud=i(Fh,"Fine-tune on GPU"),Fh.forEach(t),qh.forEach(t),Qr.forEach(t),mr=c(n),xt=s(n,"H2",{class:!0});var ei=a(xt);Yt=s(ei,"A",{id:!0,class:!0,href:!0});var Ph=a(Yt);da=s(Ph,"SPAN",{});var Nh=a(da);b(Jn.$$.fragment,Nh),Nh.forEach(t),Ph.forEach(t),md=c(ei),la=s(ei,"SPAN",{});var Ch=a(la);fd=i(Ch,"Multilingual Models"),Ch.forEach(t),ei.forEach(t),fr=c(n),Se=s(n,"UL",{});var qn=a(Se);Yn=s(qn,"LI",{});var ti=a(Yn);gd=i(ti,"All model names use the following format: "),ca=s(ti,"CODE",{});var Lh=a(ca);_d=i(Lh,"Helsinki-NLP/opus-mt-{src}-{tgt}"),Lh.forEach(t),vd=i(ti,":"),ti.forEach(t),kd=c(qn),Zn=s(qn,"LI",{});var ni=a(Zn);Td=i(ni,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
language to the `),pa=s(ni,"CODE",{});var Ih=a(pa);Md=i(Ih,"src_text"),Ih.forEach(t),bd=i(ni,"."),ni.forEach(t),yd=c(qn),Xn=s(qn,"LI",{});var oi=a(Xn);wd=i(oi,"You can see a models\u2019s supported language codes in its model card, under target constituents, like in "),Qn=s(oi,"A",{href:!0,rel:!0});var Ah=a(Qn);xd=i(Ah,"opus-mt-en-roa"),Ah.forEach(t),$d=i(oi,"."),oi.forEach(t),zd=c(qn),eo=s(qn,"LI",{});var si=a(eo);jd=i(si,"Note that if a model is only multilingual on the source side, like "),ha=s(si,"CODE",{});var Oh=a(ha);Ed=i(Oh,"Helsinki-NLP/opus-mt-roa-en"),Oh.forEach(t),qd=i(si,`, no language
codes are required.`),si.forEach(t),qn.forEach(t),gr=c(n),Zt=s(n,"P",{});var ai=a(Zt);Fd=i(ai,"New multi-lingual models from the "),to=s(ai,"A",{href:!0,rel:!0});var Sh=a(to);Pd=i(Sh,"Tatoeba-Challenge repo"),Sh.forEach(t),Nd=i(ai,`
require 3 character language codes:`),ai.forEach(t),_r=c(n),b(no.$$.fragment,n),vr=c(n),vs=s(n,"P",{});var Dh=a(vs);Cd=i(Dh,"Here is the code to see all available pretrained models on the hub:"),Dh.forEach(t),kr=c(n),b(oo.$$.fragment,n),Tr=c(n),$t=s(n,"H2",{class:!0});var ri=a($t);Xt=s(ri,"A",{id:!0,class:!0,href:!0});var Hh=a(Xt);ua=s(Hh,"SPAN",{});var Wh=a(ua);b(so.$$.fragment,Wh),Wh.forEach(t),Hh.forEach(t),Ld=c(ri),ma=s(ri,"SPAN",{});var Uh=a(ma);Id=i(Uh,"Old Style Multi-Lingual Models"),Uh.forEach(t),ri.forEach(t),Mr=c(n),ks=s(n,"P",{});var Rh=a(ks);Ad=i(Rh,`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),Rh.forEach(t),br=c(n),b(ao.$$.fragment,n),yr=c(n),Ts=s(n,"P",{});var Vh=a(Ts);Od=i(Vh,"Example of translating english to many romance languages, using old-style 2 character language codes"),Vh.forEach(t),wr=c(n),b(ro.$$.fragment,n),xr=c(n),zt=s(n,"H2",{class:!0});var ii=a(zt);Qt=s(ii,"A",{id:!0,class:!0,href:!0});var Bh=a(Qt);fa=s(Bh,"SPAN",{});var Kh=a(fa);b(io.$$.fragment,Kh),Kh.forEach(t),Bh.forEach(t),Sd=c(ii),ga=s(ii,"SPAN",{});var Gh=a(ga);Dd=i(Gh,"MarianConfig"),Gh.forEach(t),ii.forEach(t),$r=c(n),Ee=s(n,"DIV",{class:!0});var Fn=a(Ee);b(lo.$$.fragment,Fn),Hd=c(Fn),jt=s(Fn,"P",{});var Ss=a(jt);Wd=i(Ss,"This is the configuration class to store the configuration of a "),Ms=s(Ss,"A",{href:!0});var Jh=a(Ms);Ud=i(Jh,"MarianModel"),Jh.forEach(t),Rd=i(Ss,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
`),co=s(Ss,"A",{href:!0,rel:!0});var Yh=a(co);Vd=i(Yh,"Helsinki-NLP/opus-mt-en-de"),Yh.forEach(t),Bd=i(Ss," architecture."),Ss.forEach(t),Kd=c(Fn),Et=s(Fn,"P",{});var Ds=a(Et);Gd=i(Ds,"Configuration objects inherit from "),bs=s(Ds,"A",{href:!0});var Zh=a(bs);Jd=i(Zh,"PretrainedConfig"),Zh.forEach(t),Yd=i(Ds,` and can be used to control the model outputs. Read the
documentation from `),ys=s(Ds,"A",{href:!0});var Xh=a(ys);Zd=i(Xh,"PretrainedConfig"),Xh.forEach(t),Xd=i(Ds," for more information."),Ds.forEach(t),Qd=c(Fn),b(en.$$.fragment,Fn),Fn.forEach(t),zr=c(n),qt=s(n,"H2",{class:!0});var di=a(qt);tn=s(di,"A",{id:!0,class:!0,href:!0});var Qh=a(tn);_a=s(Qh,"SPAN",{});var eu=a(_a);b(po.$$.fragment,eu),eu.forEach(t),Qh.forEach(t),el=c(di),va=s(di,"SPAN",{});var tu=a(va);tl=i(tu,"MarianTokenizer"),tu.forEach(t),di.forEach(t),jr=c(n),he=s(n,"DIV",{class:!0});var ct=a(he);b(ho.$$.fragment,ct),nl=c(ct),uo=s(ct,"P",{});var li=a(uo);ol=i(li,"Construct a Marian tokenizer. Based on "),mo=s(li,"A",{href:!0,rel:!0});var nu=a(mo);sl=i(nu,"SentencePiece"),nu.forEach(t),al=i(li,"."),li.forEach(t),rl=c(ct),fo=s(ct,"P",{});var ci=a(fo);il=i(ci,"This tokenizer inherits from "),ws=s(ci,"A",{href:!0});var ou=a(ws);dl=i(ou,"PreTrainedTokenizer"),ou.forEach(t),ll=i(ci,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ci.forEach(t),cl=c(ct),b(nn.$$.fragment,ct),pl=c(ct),on=s(ct,"DIV",{class:!0});var pi=a(on);b(go.$$.fragment,pi),hl=c(pi),ka=s(pi,"P",{});var su=a(ka);ul=i(su,"Build model inputs from a sequence by appending eos_token_id."),su.forEach(t),pi.forEach(t),ct.forEach(t),Er=c(n),Ft=s(n,"H2",{class:!0});var hi=a(Ft);sn=s(hi,"A",{id:!0,class:!0,href:!0});var au=a(sn);Ta=s(au,"SPAN",{});var ru=a(Ta);b(_o.$$.fragment,ru),ru.forEach(t),au.forEach(t),ml=c(hi),Ma=s(hi,"SPAN",{});var iu=a(Ma);fl=i(iu,"MarianModel"),iu.forEach(t),hi.forEach(t),qr=c(n),qe=s(n,"DIV",{class:!0});var Pn=a(qe);b(vo.$$.fragment,Pn),gl=c(Pn),ko=s(Pn,"P",{});var ui=a(ko);_l=i(ui,`The bare Marian Model outputting raw hidden-states without any specific head on top.
This model inherits from `),xs=s(ui,"A",{href:!0});var du=a(xs);vl=i(du,"PreTrainedModel"),du.forEach(t),kl=i(ui,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ui.forEach(t),Tl=c(Pn),To=s(Pn,"P",{});var mi=a(To);Ml=i(mi,"This model is also a PyTorch "),Mo=s(mi,"A",{href:!0,rel:!0});var lu=a(Mo);bl=i(lu,"torch.nn.Module"),lu.forEach(t),yl=i(mi,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mi.forEach(t),wl=c(Pn),De=s(Pn,"DIV",{class:!0});var Nn=a(De);b(bo.$$.fragment,Nn),xl=c(Nn),Pt=s(Nn,"P",{});var Hs=a(Pt);$l=i(Hs,"The "),$s=s(Hs,"A",{href:!0});var cu=a($s);zl=i(cu,"MarianModel"),cu.forEach(t),jl=i(Hs," forward method, overrides the "),ba=s(Hs,"CODE",{});var pu=a(ba);El=i(pu,"__call__"),pu.forEach(t),ql=i(Hs," special method."),Hs.forEach(t),Fl=c(Nn),b(an.$$.fragment,Nn),Pl=c(Nn),b(rn.$$.fragment,Nn),Nn.forEach(t),Pn.forEach(t),Fr=c(n),Nt=s(n,"H2",{class:!0});var fi=a(Nt);dn=s(fi,"A",{id:!0,class:!0,href:!0});var hu=a(dn);ya=s(hu,"SPAN",{});var uu=a(ya);b(yo.$$.fragment,uu),uu.forEach(t),hu.forEach(t),Nl=c(fi),wa=s(fi,"SPAN",{});var mu=a(wa);Cl=i(mu,"MarianMTModel"),mu.forEach(t),fi.forEach(t),Pr=c(n),Fe=s(n,"DIV",{class:!0});var Cn=a(Fe);b(wo.$$.fragment,Cn),Ll=c(Cn),xo=s(Cn,"P",{});var gi=a(xo);Il=i(gi,`The Marian Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gi.forEach(t),Sl=c(Cn),$o=s(Cn,"P",{});var _i=a($o);Dl=i(_i,"This model is also a PyTorch "),zo=s(_i,"A",{href:!0,rel:!0});var gu=a(zo);Hl=i(gu,"torch.nn.Module"),gu.forEach(t),Wl=i(_i,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_i.forEach(t),Ul=c(Cn),ge=s(Cn,"DIV",{class:!0});var pt=a(ge);b(jo.$$.fragment,pt),Rl=c(pt),Ct=s(pt,"P",{});var Ws=a(Ct);Vl=i(Ws,"The "),js=s(Ws,"A",{href:!0});var _u=a(js);Bl=i(_u,"MarianMTModel"),_u.forEach(t),Kl=i(Ws," forward method, overrides the "),xa=s(Ws,"CODE",{});var vu=a(xa);Gl=i(vu,"__call__"),vu.forEach(t),Jl=i(Ws," special method."),Ws.forEach(t),Yl=c(pt),b(ln.$$.fragment,pt),Zl=c(pt),Eo=s(pt,"P",{});var vi=a(Eo);Xl=i(vi,`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),qo=s(vi,"A",{href:!0,rel:!0});var ku=a(qo);Ql=i(ku,"here"),ku.forEach(t),ec=i(vi,"."),vi.forEach(t),tc=c(pt),b(cn.$$.fragment,pt),pt.forEach(t),Cn.forEach(t),Nr=c(n),Lt=s(n,"H2",{class:!0});var ki=a(Lt);pn=s(ki,"A",{id:!0,class:!0,href:!0});var Tu=a(pn);$a=s(Tu,"SPAN",{});var Mu=a($a);b(Fo.$$.fragment,Mu),Mu.forEach(t),Tu.forEach(t),nc=c(ki),za=s(ki,"SPAN",{});var bu=a(za);oc=i(bu,"MarianForCausalLM"),bu.forEach(t),ki.forEach(t),Cr=c(n),It=s(n,"DIV",{class:!0});var Ti=a(It);b(Po.$$.fragment,Ti),sc=c(Ti),hn=s(Ti,"DIV",{class:!0});var Mi=a(hn);b(No.$$.fragment,Mi),ac=c(Mi),b(un.$$.fragment,Mi),Mi.forEach(t),Ti.forEach(t),Lr=c(n),At=s(n,"H2",{class:!0});var bi=a(At);mn=s(bi,"A",{id:!0,class:!0,href:!0});var yu=a(mn);ja=s(yu,"SPAN",{});var wu=a(ja);b(Co.$$.fragment,wu),wu.forEach(t),yu.forEach(t),rc=c(bi),Ea=s(bi,"SPAN",{});var xu=a(Ea);ic=i(xu,"TFMarianModel"),xu.forEach(t),bi.forEach(t),Ir=c(n),ue=s(n,"DIV",{class:!0});var ht=a(ue);b(Lo.$$.fragment,ht),dc=c(ht),Io=s(ht,"P",{});var yi=a(Io);lc=i(yi,`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yi.forEach(t),hc=c(ht),Ao=s(ht,"P",{});var wi=a(Ao);uc=i(wi,"This model is also a "),Oo=s(wi,"A",{href:!0,rel:!0});var zu=a(Oo);mc=i(zu,"tf.keras.Model"),zu.forEach(t),fc=i(wi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wi.forEach(t),gc=c(ht),b(fn.$$.fragment,ht),_c=c(ht),He=s(ht,"DIV",{class:!0});var Ln=a(He);b(So.$$.fragment,Ln),vc=c(Ln),Ot=s(Ln,"P",{});var Us=a(Ot);kc=i(Us,"The "),qs=s(Us,"A",{href:!0});var ju=a(qs);Tc=i(ju,"TFMarianModel"),ju.forEach(t),Mc=i(Us," forward method, overrides the "),qa=s(Us,"CODE",{});var Eu=a(qa);bc=i(Eu,"__call__"),Eu.forEach(t),yc=i(Us," special method."),Us.forEach(t),wc=c(Ln),b(gn.$$.fragment,Ln),xc=c(Ln),b(_n.$$.fragment,Ln),Ln.forEach(t),ht.forEach(t),Ar=c(n),St=s(n,"H2",{class:!0});var xi=a(St);vn=s(xi,"A",{id:!0,class:!0,href:!0});var qu=a(vn);Fa=s(qu,"SPAN",{});var Fu=a(Fa);b(Do.$$.fragment,Fu),Fu.forEach(t),qu.forEach(t),$c=c(xi),Pa=s(xi,"SPAN",{});var Pu=a(Pa);zc=i(Pu,"TFMarianMTModel"),Pu.forEach(t),xi.forEach(t),Or=c(n),me=s(n,"DIV",{class:!0});var ut=a(me);b(Ho.$$.fragment,ut),jc=c(ut),Wo=s(ut,"P",{});var $i=a(Wo);Ec=i($i,`The MARIAN Model with a language modeling head. Can be used for summarization.
This model inherits from `),Fs=s($i,"A",{href:!0});var Nu=a(Fs);qc=i(Nu,"TFPreTrainedModel"),Nu.forEach(t),Fc=i($i,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$i.forEach(t),Pc=c(ut),Uo=s(ut,"P",{});var zi=a(Uo);Nc=i(zi,"This model is also a "),Ro=s(zi,"A",{href:!0,rel:!0});var Cu=a(Ro);Cc=i(Cu,"tf.keras.Model"),Cu.forEach(t),Lc=i(zi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zi.forEach(t),Ic=c(ut),b(kn.$$.fragment,ut),Ac=c(ut),_e=s(ut,"DIV",{class:!0});var mt=a(_e);b(Vo.$$.fragment,mt),Oc=c(mt),Dt=s(mt,"P",{});var Rs=a(Dt);Sc=i(Rs,"The "),Ps=s(Rs,"A",{href:!0});var Lu=a(Ps);Dc=i(Lu,"TFMarianMTModel"),Lu.forEach(t),Hc=i(Rs," forward method, overrides the "),Na=s(Rs,"CODE",{});var Iu=a(Na);Wc=i(Iu,"__call__"),Iu.forEach(t),Uc=i(Rs," special method."),Rs.forEach(t),Rc=c(mt),b(Tn.$$.fragment,mt),Vc=c(mt),Bo=s(mt,"P",{});var ji=a(Bo);Bc=i(ji,`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),Ko=s(ji,"A",{href:!0,rel:!0});var Au=a(Ko);Kc=i(Au,"here"),Au.forEach(t),Gc=i(ji,"."),ji.forEach(t),Jc=c(mt),b(Mn.$$.fragment,mt),mt.forEach(t),ut.forEach(t),Sr=c(n),Ht=s(n,"H2",{class:!0});var Ei=a(Ht);bn=s(Ei,"A",{id:!0,class:!0,href:!0});var Ou=a(bn);Ca=s(Ou,"SPAN",{});var Su=a(Ca);b(Go.$$.fragment,Su),Su.forEach(t),Ou.forEach(t),Yc=c(Ei),La=s(Ei,"SPAN",{});var Du=a(La);Zc=i(Du,"FlaxMarianModel"),Du.forEach(t),Ei.forEach(t),Dr=c(n),J=s(n,"DIV",{class:!0});var Re=a(J);b(Jo.$$.fragment,Re),Xc=c(Re),Yo=s(Re,"P",{});var qi=a(Yo);Qc=i(qi,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qi.forEach(t),np=c(Re),Zo=s(Re,"P",{});var Fi=a(Zo);op=i(Fi,`This model is also a Flax Linen
`),Xo=s(Fi,"A",{href:!0,rel:!0});var Wu=a(Xo);sp=i(Wu,"flax.nn.Module"),Wu.forEach(t),ap=i(Fi,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Fi.forEach(t),rp=c(Re),Ia=s(Re,"P",{});var Uu=a(Ia);ip=i(Uu,"Finally, this model supports inherent JAX features such as:"),Uu.forEach(t),dp=c(Re),dt=s(Re,"UL",{});var In=a(dt);Aa=s(In,"LI",{});var Ru=a(Aa);Qo=s(Ru,"A",{href:!0,rel:!0});var Vu=a(Qo);lp=i(Vu,"Just-In-Time (JIT) compilation"),Vu.forEach(t),Ru.forEach(t),cp=c(In),Oa=s(In,"LI",{});var Bu=a(Oa);es=s(Bu,"A",{href:!0,rel:!0});var Ku=a(es);pp=i(Ku,"Automatic Differentiation"),Ku.forEach(t),Bu.forEach(t),hp=c(In),Sa=s(In,"LI",{});var Gu=a(Sa);ts=s(Gu,"A",{href:!0,rel:!0});var Ju=a(ts);up=i(Ju,"Vectorization"),Ju.forEach(t),Gu.forEach(t),mp=c(In),Da=s(In,"LI",{});var Yu=a(Da);ns=s(Yu,"A",{href:!0,rel:!0});var Zu=a(ns);fp=i(Zu,"Parallelization"),Zu.forEach(t),Yu.forEach(t),In.forEach(t),gp=c(Re),We=s(Re,"DIV",{class:!0});var An=a(We);b(os.$$.fragment,An),_p=c(An),Wt=s(An,"P",{});var Vs=a(Wt);vp=i(Vs,"The "),Ha=s(Vs,"CODE",{});var Xu=a(Ha);kp=i(Xu,"FlaxMarianPreTrainedModel"),Xu.forEach(t),Tp=i(Vs," forward method, overrides the "),Wa=s(Vs,"CODE",{});var Qu=a(Wa);Mp=i(Qu,"__call__"),Qu.forEach(t),bp=i(Vs," special method."),Vs.forEach(t),yp=c(An),b(yn.$$.fragment,An),wp=c(An),b(wn.$$.fragment,An),An.forEach(t),Re.forEach(t),Hr=c(n),Ut=s(n,"H2",{class:!0});var Pi=a(Ut);xn=s(Pi,"A",{id:!0,class:!0,href:!0});var em=a(xn);Ua=s(em,"SPAN",{});var tm=a(Ua);b(ss.$$.fragment,tm),tm.forEach(t),em.forEach(t),xp=c(Pi),Ra=s(Pi,"SPAN",{});var nm=a(Ra);$p=i(nm,"FlaxMarianMTModel"),nm.forEach(t),Pi.forEach(t),Wr=c(n),Y=s(n,"DIV",{class:!0});var Ve=a(Y);b(as.$$.fragment,Ve),zp=c(Ve),rs=s(Ve,"P",{});var Ni=a(rs);jp=i(Ni,`The MARIAN Model with a language modeling head. Can be used for translation.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ni.forEach(t),Fp=c(Ve),is=s(Ve,"P",{});var Ci=a(is);Pp=i(Ci,`This model is also a Flax Linen
`),ds=s(Ci,"A",{href:!0,rel:!0});var sm=a(ds);Np=i(sm,"flax.nn.Module"),sm.forEach(t),Cp=i(Ci,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ci.forEach(t),Lp=c(Ve),Va=s(Ve,"P",{});var am=a(Va);Ip=i(am,"Finally, this model supports inherent JAX features such as:"),am.forEach(t),Ap=c(Ve),lt=s(Ve,"UL",{});var On=a(lt);Ba=s(On,"LI",{});var rm=a(Ba);ls=s(rm,"A",{href:!0,rel:!0});var im=a(ls);Op=i(im,"Just-In-Time (JIT) compilation"),im.forEach(t),rm.forEach(t),Sp=c(On),Ka=s(On,"LI",{});var dm=a(Ka);cs=s(dm,"A",{href:!0,rel:!0});var lm=a(cs);Dp=i(lm,"Automatic Differentiation"),lm.forEach(t),dm.forEach(t),Hp=c(On),Ga=s(On,"LI",{});var cm=a(Ga);ps=s(cm,"A",{href:!0,rel:!0});var pm=a(ps);Wp=i(pm,"Vectorization"),pm.forEach(t),cm.forEach(t),Up=c(On),Ja=s(On,"LI",{});var hm=a(Ja);hs=s(hm,"A",{href:!0,rel:!0});var um=a(hs);Rp=i(um,"Parallelization"),um.forEach(t),hm.forEach(t),On.forEach(t),Vp=c(Ve),Ue=s(Ve,"DIV",{class:!0});var Sn=a(Ue);b(us.$$.fragment,Sn),Bp=c(Sn),Rt=s(Sn,"P",{});var Bs=a(Rt);Kp=i(Bs,"The "),Ya=s(Bs,"CODE",{});var mm=a(Ya);Gp=i(mm,"FlaxMarianPreTrainedModel"),mm.forEach(t),Jp=i(Bs," forward method, overrides the "),Za=s(Bs,"CODE",{});var fm=a(Za);Yp=i(fm,"__call__"),fm.forEach(t),Zp=i(Bs," special method."),Bs.forEach(t),Xp=c(Sn),b($n.$$.fragment,Sn),Qp=c(Sn),b(zn.$$.fragment,Sn),Sn.forEach(t),Ve.forEach(t),this.h()},h(){p(h,"name","hf:doc:metadata"),p(h,"content",JSON.stringify(Sm)),p(g,"id","marianmt"),p(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(g,"href","#marianmt"),p(_,"class","relative group"),p(Q,"href","https://github.com/huggingface/transformers/issues/new?assignees=sshleifer&labels=&template=bug-report.md&title"),p(Q,"rel","nofollow"),p(X,"id","implementation-notes"),p(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(X,"href","#implementation-notes"),p(L,"class","relative group"),p(W,"href","https://huggingface.co/Helsinki-NLP"),p(W,"rel","nofollow"),p(se,"href","https://researchportal.helsinki.fi/en/persons/j%C3%B6rg-tiedemann"),p(se,"rel","nofollow"),p(re,"href","https://marian-nmt.github.io/"),p(re,"rel","nofollow"),p(Ae,"href","/docs/transformers/v4.22.1/en/model_doc/bart#transformers.BartForConditionalGeneration"),p(Un,"href","https://huggingface.co/sshleifer"),p(Un,"rel","nofollow"),p(Kt,"id","naming"),p(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Kt,"href","#naming"),p(bt,"class","relative group"),p(Bn,"href","https://developers.google.com/admin-sdk/directory/v1/languages"),p(Bn,"rel","nofollow"),p(Gt,"id","examples"),p(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Gt,"href","#examples"),p(wt,"class","relative group"),p(Gn,"href","https://github.com/huggingface/transformers/blob/master/examples/legacy/seq2seq/train_distil_marian_enro.sh"),p(Gn,"rel","nofollow"),p(Yt,"id","multilingual-models"),p(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Yt,"href","#multilingual-models"),p(xt,"class","relative group"),p(Qn,"href","https://huggingface.co/Helsinki-NLP/opus-mt-en-roa"),p(Qn,"rel","nofollow"),p(to,"href","https://github.com/Helsinki-NLP/Tatoeba-Challenge"),p(to,"rel","nofollow"),p(Xt,"id","old-style-multilingual-models"),p(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Xt,"href","#old-style-multilingual-models"),p($t,"class","relative group"),p(Qt,"id","transformers.MarianConfig"),p(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Qt,"href","#transformers.MarianConfig"),p(zt,"class","relative group"),p(Ms,"href","/docs/transformers/v4.22.1/en/model_doc/marian#transformers.MarianModel"),p(co,"href","https://huggingface.co/Helsinki-NLP/opus-mt-en-de"),p(co,"rel","nofollow"),p(bs,"href","/docs/transformers/v4.22.1/en/main_classes/configuration#transformers.PretrainedConfig"),p(ys,"href","/docs/transformers/v4.22.1/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(tn,"id","transformers.MarianTokenizer"),p(tn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(tn,"href","#transformers.MarianTokenizer"),p(qt,"class","relative group"),p(mo,"href","https://github.com/google/sentencepiece"),p(mo,"rel","nofollow"),p(ws,"href","/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(on,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(sn,"id","transformers.MarianModel"),p(sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(sn,"href","#transformers.MarianModel"),p(Ft,"class","relative group"),p(xs,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel"),p(Mo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Mo,"rel","nofollow"),p($s,"href","/docs/transformers/v4.22.1/en/model_doc/marian#transformers.MarianModel"),p(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(dn,"id","transformers.MarianMTModel"),p(dn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(dn,"href","#transformers.MarianMTModel"),p(Nt,"class","relative group"),p(zs,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel"),p(zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(zo,"rel","nofollow"),p(js,"href","/docs/transformers/v4.22.1/en/model_doc/marian#transformers.MarianMTModel"),p(qo,"href","https://huggingface.co/models?search=Helsinki-NLP"),p(qo,"rel","nofollow"),p(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(pn,"id","transformers.MarianForCausalLM"),p(pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(pn,"href","#transformers.MarianForCausalLM"),p(Lt,"class","relative group"),p(hn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(It,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(mn,"id","transformers.TFMarianModel"),p(mn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(mn,"href","#transformers.TFMarianModel"),p(At,"class","relative group"),p(Es,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.TFPreTrainedModel"),p(Oo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(Oo,"rel","nofollow"),p(qs,"href","/docs/transformers/v4.22.1/en/model_doc/marian#transformers.TFMarianModel"),p(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(vn,"id","transformers.TFMarianMTModel"),p(vn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(vn,"href","#transformers.TFMarianMTModel"),p(St,"class","relative group"),p(Fs,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.TFPreTrainedModel"),p(Ro,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(Ro,"rel","nofollow"),p(Ps,"href","/docs/transformers/v4.22.1/en/model_doc/marian#transformers.TFMarianMTModel"),p(Ko,"href","https://huggingface.co/models?search=Helsinki-NLP"),p(Ko,"rel","nofollow"),p(_e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(bn,"id","transformers.FlaxMarianModel"),p(bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(bn,"href","#transformers.FlaxMarianModel"),p(Ht,"class","relative group"),p(Ns,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Xo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(Xo,"rel","nofollow"),p(Qo,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(Qo,"rel","nofollow"),p(es,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(es,"rel","nofollow"),p(ts,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(ts,"rel","nofollow"),p(ns,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(ns,"rel","nofollow"),p(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(xn,"id","transformers.FlaxMarianMTModel"),p(xn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(xn,"href","#transformers.FlaxMarianMTModel"),p(Ut,"class","relative group"),p(Cs,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(ds,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(ds,"rel","nofollow"),p(ls,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(ls,"rel","nofollow"),p(cs,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(cs,"rel","nofollow"),p(ps,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(ps,"rel","nofollow"),p(hs,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(hs,"rel","nofollow"),p(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,m){e(document.head,h),f(n,k,m),f(n,_,m),e(_,g),e(g,v),y(d,v,null),e(_,u),e(_,q),e(q,Be),f(n,Ne,m),f(n,C,m),e(C,ve),e(ve,ke),e(C,z),e(C,Q),e(Q,ee),e(C,Ke),f(n,Ce,m),f(n,V,m),e(V,Ge),f(n,Le,m),f(n,L,m),e(L,X),e(X,Te),y(H,Te,null),e(L,Je),e(L,Me),e(Me,te),f(n,Ie,m),f(n,P,m),e(P,ne),e(ne,N),e(N,I),e(P,Ye),e(P,B),e(B,oe),e(oe,Ze),e(oe,W),e(W,Xe),e(oe,Qe),e(P,A),e(P,be),e(be,O),e(O,et),e(O,se),e(se,ae),e(O,tt),e(O,re),e(re,K),e(O,nt),e(P,ie),e(P,ye),e(ye,de),e(de,S),e(P,ot),e(P,D),e(D,we),e(we,st),e(P,T),e(P,j),e(j,xe),e(xe,$e),e(xe,Ae),e(Ae,ft),e(xe,F),e(j,gt),e(j,le),e(le,ze),e(ze,_t),e(ze,at),e(at,G),e(ze,ce),e(le,vt),e(le,je),e(je,pe),e(je,rt),e(rt,kt),e(je,it),e(le,Tt),e(le,U),e(U,Mt),e(U,Ks),e(Ks,Li),e(U,Ii),e(U,Gs),e(Gs,Ai),e(U,Oi),e(P,Si),e(P,Js),e(Js,Hn),e(Hn,Di),e(Hn,Ys),e(Ys,Hi),e(Hn,Wi),e(P,Ui),e(P,Zs),e(Zs,Wn),e(Wn,Ri),e(Wn,Un),e(Un,Vi),e(Wn,Bi),f(n,cr,m),f(n,bt,m),e(bt,Kt),e(Kt,Xs),y(Rn,Xs,null),e(bt,Ki),e(bt,Qs),e(Qs,Gi),f(n,pr,m),f(n,Oe,m),e(Oe,_s),e(_s,Ji),e(_s,ea),e(ea,Yi),e(Oe,Zi),e(Oe,Vn),e(Vn,Xi),e(Vn,Bn),e(Bn,Qi),e(Vn,ed),e(Oe,td),e(Oe,yt),e(yt,nd),e(yt,ta),e(ta,od),e(yt,sd),e(yt,na),e(na,ad),e(yt,rd),e(Oe,id),e(Oe,oa),e(oa,dd),f(n,hr,m),f(n,wt,m),e(wt,Gt),e(Gt,sa),y(Kn,sa,null),e(wt,ld),e(wt,aa),e(aa,cd),f(n,ur,m),f(n,Jt,m),e(Jt,ra),e(ra,pd),e(Jt,hd),e(Jt,ia),e(ia,Gn),e(Gn,ud),f(n,mr,m),f(n,xt,m),e(xt,Yt),e(Yt,da),y(Jn,da,null),e(xt,md),e(xt,la),e(la,fd),f(n,fr,m),f(n,Se,m),e(Se,Yn),e(Yn,gd),e(Yn,ca),e(ca,_d),e(Yn,vd),e(Se,kd),e(Se,Zn),e(Zn,Td),e(Zn,pa),e(pa,Md),e(Zn,bd),e(Se,yd),e(Se,Xn),e(Xn,wd),e(Xn,Qn),e(Qn,xd),e(Xn,$d),e(Se,zd),e(Se,eo),e(eo,jd),e(eo,ha),e(ha,Ed),e(eo,qd),f(n,gr,m),f(n,Zt,m),e(Zt,Fd),e(Zt,to),e(to,Pd),e(Zt,Nd),f(n,_r,m),y(no,n,m),f(n,vr,m),f(n,vs,m),e(vs,Cd),f(n,kr,m),y(oo,n,m),f(n,Tr,m),f(n,$t,m),e($t,Xt),e(Xt,ua),y(so,ua,null),e($t,Ld),e($t,ma),e(ma,Id),f(n,Mr,m),f(n,ks,m),e(ks,Ad),f(n,br,m),y(ao,n,m),f(n,yr,m),f(n,Ts,m),e(Ts,Od),f(n,wr,m),y(ro,n,m),f(n,xr,m),f(n,zt,m),e(zt,Qt),e(Qt,fa),y(io,fa,null),e(zt,Sd),e(zt,ga),e(ga,Dd),f(n,$r,m),f(n,Ee,m),y(lo,Ee,null),e(Ee,Hd),e(Ee,jt),e(jt,Wd),e(jt,Ms),e(Ms,Ud),e(jt,Rd),e(jt,co),e(co,Vd),e(jt,Bd),e(Ee,Kd),e(Ee,Et),e(Et,Gd),e(Et,bs),e(bs,Jd),e(Et,Yd),e(Et,ys),e(ys,Zd),e(Et,Xd),e(Ee,Qd),y(en,Ee,null),f(n,zr,m),f(n,qt,m),e(qt,tn),e(tn,_a),y(po,_a,null),e(qt,el),e(qt,va),e(va,tl),f(n,jr,m),f(n,he,m),y(ho,he,null),e(he,nl),e(he,uo),e(uo,ol),e(uo,mo),e(mo,sl),e(uo,al),e(he,rl),e(he,fo),e(fo,il),e(fo,ws),e(ws,dl),e(fo,ll),e(he,cl),y(nn,he,null),e(he,pl),e(he,on),y(go,on,null),e(on,hl),e(on,ka),e(ka,ul),f(n,Er,m),f(n,Ft,m),e(Ft,sn),e(sn,Ta),y(_o,Ta,null),e(Ft,ml),e(Ft,Ma),e(Ma,fl),f(n,qr,m),f(n,qe,m),y(vo,qe,null),e(qe,gl),e(qe,ko),e(ko,_l),e(ko,xs),e(xs,vl),e(ko,kl),e(qe,Tl),e(qe,To),e(To,Ml),e(To,Mo),e(Mo,bl),e(To,yl),e(qe,wl),e(qe,De),y(bo,De,null),e(De,xl),e(De,Pt),e(Pt,$l),e(Pt,$s),e($s,zl),e(Pt,jl),e(Pt,ba),e(ba,El),e(Pt,ql),e(De,Fl),y(an,De,null),e(De,Pl),y(rn,De,null),f(n,Fr,m),f(n,Nt,m),e(Nt,dn),e(dn,ya),y(yo,ya,null),e(Nt,Nl),e(Nt,wa),e(wa,Cl),f(n,Pr,m),f(n,Fe,m),y(wo,Fe,null),e(Fe,Ll),e(Fe,xo),e(xo,Il),e(xo,zs),e(zs,Al),e(xo,Ol),e(Fe,Sl),e(Fe,$o),e($o,Dl),e($o,zo),e(zo,Hl),e($o,Wl),e(Fe,Ul),e(Fe,ge),y(jo,ge,null),e(ge,Rl),e(ge,Ct),e(Ct,Vl),e(Ct,js),e(js,Bl),e(Ct,Kl),e(Ct,xa),e(xa,Gl),e(Ct,Jl),e(ge,Yl),y(ln,ge,null),e(ge,Zl),e(ge,Eo),e(Eo,Xl),e(Eo,qo),e(qo,Ql),e(Eo,ec),e(ge,tc),y(cn,ge,null),f(n,Nr,m),f(n,Lt,m),e(Lt,pn),e(pn,$a),y(Fo,$a,null),e(Lt,nc),e(Lt,za),e(za,oc),f(n,Cr,m),f(n,It,m),y(Po,It,null),e(It,sc),e(It,hn),y(No,hn,null),e(hn,ac),y(un,hn,null),f(n,Lr,m),f(n,At,m),e(At,mn),e(mn,ja),y(Co,ja,null),e(At,rc),e(At,Ea),e(Ea,ic),f(n,Ir,m),f(n,ue,m),y(Lo,ue,null),e(ue,dc),e(ue,Io),e(Io,lc),e(Io,Es),e(Es,cc),e(Io,pc),e(ue,hc),e(ue,Ao),e(Ao,uc),e(Ao,Oo),e(Oo,mc),e(Ao,fc),e(ue,gc),y(fn,ue,null),e(ue,_c),e(ue,He),y(So,He,null),e(He,vc),e(He,Ot),e(Ot,kc),e(Ot,qs),e(qs,Tc),e(Ot,Mc),e(Ot,qa),e(qa,bc),e(Ot,yc),e(He,wc),y(gn,He,null),e(He,xc),y(_n,He,null),f(n,Ar,m),f(n,St,m),e(St,vn),e(vn,Fa),y(Do,Fa,null),e(St,$c),e(St,Pa),e(Pa,zc),f(n,Or,m),f(n,me,m),y(Ho,me,null),e(me,jc),e(me,Wo),e(Wo,Ec),e(Wo,Fs),e(Fs,qc),e(Wo,Fc),e(me,Pc),e(me,Uo),e(Uo,Nc),e(Uo,Ro),e(Ro,Cc),e(Uo,Lc),e(me,Ic),y(kn,me,null),e(me,Ac),e(me,_e),y(Vo,_e,null),e(_e,Oc),e(_e,Dt),e(Dt,Sc),e(Dt,Ps),e(Ps,Dc),e(Dt,Hc),e(Dt,Na),e(Na,Wc),e(Dt,Uc),e(_e,Rc),y(Tn,_e,null),e(_e,Vc),e(_e,Bo),e(Bo,Bc),e(Bo,Ko),e(Ko,Kc),e(Bo,Gc),e(_e,Jc),y(Mn,_e,null),f(n,Sr,m),f(n,Ht,m),e(Ht,bn),e(bn,Ca),y(Go,Ca,null),e(Ht,Yc),e(Ht,La),e(La,Zc),f(n,Dr,m),f(n,J,m),y(Jo,J,null),e(J,Xc),e(J,Yo),e(Yo,Qc),e(Yo,Ns),e(Ns,ep),e(Yo,tp),e(J,np),e(J,Zo),e(Zo,op),e(Zo,Xo),e(Xo,sp),e(Zo,ap),e(J,rp),e(J,Ia),e(Ia,ip),e(J,dp),e(J,dt),e(dt,Aa),e(Aa,Qo),e(Qo,lp),e(dt,cp),e(dt,Oa),e(Oa,es),e(es,pp),e(dt,hp),e(dt,Sa),e(Sa,ts),e(ts,up),e(dt,mp),e(dt,Da),e(Da,ns),e(ns,fp),e(J,gp),e(J,We),y(os,We,null),e(We,_p),e(We,Wt),e(Wt,vp),e(Wt,Ha),e(Ha,kp),e(Wt,Tp),e(Wt,Wa),e(Wa,Mp),e(Wt,bp),e(We,yp),y(yn,We,null),e(We,wp),y(wn,We,null),f(n,Hr,m),f(n,Ut,m),e(Ut,xn),e(xn,Ua),y(ss,Ua,null),e(Ut,xp),e(Ut,Ra),e(Ra,$p),f(n,Wr,m),f(n,Y,m),y(as,Y,null),e(Y,zp),e(Y,rs),e(rs,jp),e(rs,Cs),e(Cs,Ep),e(rs,qp),e(Y,Fp),e(Y,is),e(is,Pp),e(is,ds),e(ds,Np),e(is,Cp),e(Y,Lp),e(Y,Va),e(Va,Ip),e(Y,Ap),e(Y,lt),e(lt,Ba),e(Ba,ls),e(ls,Op),e(lt,Sp),e(lt,Ka),e(Ka,cs),e(cs,Dp),e(lt,Hp),e(lt,Ga),e(Ga,ps),e(ps,Wp),e(lt,Up),e(lt,Ja),e(Ja,hs),e(hs,Rp),e(Y,Vp),e(Y,Ue),y(us,Ue,null),e(Ue,Bp),e(Ue,Rt),e(Rt,Kp),e(Rt,Ya),e(Ya,Gp),e(Rt,Jp),e(Rt,Za),e(Za,Yp),e(Rt,Zp),e(Ue,Xp),y($n,Ue,null),e(Ue,Qp),y(zn,Ue,null),Ur=!0},p(n,[m]){const ms={};m&2&&(ms.$$scope={dirty:m,ctx:n}),en.$set(ms);const Xa={};m&2&&(Xa.$$scope={dirty:m,ctx:n}),nn.$set(Xa);const Qa={};m&2&&(Qa.$$scope={dirty:m,ctx:n}),an.$set(Qa);const er={};m&2&&(er.$$scope={dirty:m,ctx:n}),rn.$set(er);const jn={};m&2&&(jn.$$scope={dirty:m,ctx:n}),ln.$set(jn);const tr={};m&2&&(tr.$$scope={dirty:m,ctx:n}),cn.$set(tr);const nr={};m&2&&(nr.$$scope={dirty:m,ctx:n}),un.$set(nr);const or={};m&2&&(or.$$scope={dirty:m,ctx:n}),fn.$set(or);const fs={};m&2&&(fs.$$scope={dirty:m,ctx:n}),gn.$set(fs);const sr={};m&2&&(sr.$$scope={dirty:m,ctx:n}),_n.$set(sr);const ar={};m&2&&(ar.$$scope={dirty:m,ctx:n}),kn.$set(ar);const rr={};m&2&&(rr.$$scope={dirty:m,ctx:n}),Tn.$set(rr);const R={};m&2&&(R.$$scope={dirty:m,ctx:n}),Mn.$set(R);const ir={};m&2&&(ir.$$scope={dirty:m,ctx:n}),yn.$set(ir);const dr={};m&2&&(dr.$$scope={dirty:m,ctx:n}),wn.$set(dr);const lr={};m&2&&(lr.$$scope={dirty:m,ctx:n}),$n.$set(lr);const gs={};m&2&&(gs.$$scope={dirty:m,ctx:n}),zn.$set(gs)},i(n){Ur||(w(d.$$.fragment,n),w(H.$$.fragment,n),w(Rn.$$.fragment,n),w(Kn.$$.fragment,n),w(Jn.$$.fragment,n),w(no.$$.fragment,n),w(oo.$$.fragment,n),w(so.$$.fragment,n),w(ao.$$.fragment,n),w(ro.$$.fragment,n),w(io.$$.fragment,n),w(lo.$$.fragment,n),w(en.$$.fragment,n),w(po.$$.fragment,n),w(ho.$$.fragment,n),w(nn.$$.fragment,n),w(go.$$.fragment,n),w(_o.$$.fragment,n),w(vo.$$.fragment,n),w(bo.$$.fragment,n),w(an.$$.fragment,n),w(rn.$$.fragment,n),w(yo.$$.fragment,n),w(wo.$$.fragment,n),w(jo.$$.fragment,n),w(ln.$$.fragment,n),w(cn.$$.fragment,n),w(Fo.$$.fragment,n),w(Po.$$.fragment,n),w(No.$$.fragment,n),w(un.$$.fragment,n),w(Co.$$.fragment,n),w(Lo.$$.fragment,n),w(fn.$$.fragment,n),w(So.$$.fragment,n),w(gn.$$.fragment,n),w(_n.$$.fragment,n),w(Do.$$.fragment,n),w(Ho.$$.fragment,n),w(kn.$$.fragment,n),w(Vo.$$.fragment,n),w(Tn.$$.fragment,n),w(Mn.$$.fragment,n),w(Go.$$.fragment,n),w(Jo.$$.fragment,n),w(os.$$.fragment,n),w(yn.$$.fragment,n),w(wn.$$.fragment,n),w(ss.$$.fragment,n),w(as.$$.fragment,n),w(us.$$.fragment,n),w($n.$$.fragment,n),w(zn.$$.fragment,n),Ur=!0)},o(n){x(d.$$.fragment,n),x(H.$$.fragment,n),x(Rn.$$.fragment,n),x(Kn.$$.fragment,n),x(Jn.$$.fragment,n),x(no.$$.fragment,n),x(oo.$$.fragment,n),x(so.$$.fragment,n),x(ao.$$.fragment,n),x(ro.$$.fragment,n),x(io.$$.fragment,n),x(lo.$$.fragment,n),x(en.$$.fragment,n),x(po.$$.fragment,n),x(ho.$$.fragment,n),x(nn.$$.fragment,n),x(go.$$.fragment,n),x(_o.$$.fragment,n),x(vo.$$.fragment,n),x(bo.$$.fragment,n),x(an.$$.fragment,n),x(rn.$$.fragment,n),x(yo.$$.fragment,n),x(wo.$$.fragment,n),x(jo.$$.fragment,n),x(ln.$$.fragment,n),x(cn.$$.fragment,n),x(Fo.$$.fragment,n),x(Po.$$.fragment,n),x(No.$$.fragment,n),x(un.$$.fragment,n),x(Co.$$.fragment,n),x(Lo.$$.fragment,n),x(fn.$$.fragment,n),x(So.$$.fragment,n),x(gn.$$.fragment,n),x(_n.$$.fragment,n),x(Do.$$.fragment,n),x(Ho.$$.fragment,n),x(kn.$$.fragment,n),x(Vo.$$.fragment,n),x(Tn.$$.fragment,n),x(Mn.$$.fragment,n),x(Go.$$.fragment,n),x(Jo.$$.fragment,n),x(os.$$.fragment,n),x(yn.$$.fragment,n),x(wn.$$.fragment,n),x(ss.$$.fragment,n),x(as.$$.fragment,n),x(us.$$.fragment,n),x($n.$$.fragment,n),x(zn.$$.fragment,n),Ur=!1},d(n){t(h),n&&t(k),n&&t(_),$(d),n&&t(Ne),n&&t(C),n&&t(Ce),n&&t(V),n&&t(Le),n&&t(L),$(H),n&&t(Ie),n&&t(P),n&&t(cr),n&&t(bt),$(Rn),n&&t(pr),n&&t(Oe),n&&t(hr),n&&t(wt),$(Kn),n&&t(ur),n&&t(Jt),n&&t(mr),n&&t(xt),$(Jn),n&&t(fr),n&&t(Se),n&&t(gr),n&&t(Zt),n&&t(_r),$(no,n),n&&t(vr),n&&t(vs),n&&t(kr),$(oo,n),n&&t(Tr),n&&t($t),$(so),n&&t(Mr),n&&t(ks),n&&t(br),$(ao,n),n&&t(yr),n&&t(Ts),n&&t(wr),$(ro,n),n&&t(xr),n&&t(zt),$(io),n&&t($r),n&&t(Ee),$(lo),$(en),n&&t(zr),n&&t(qt),$(po),n&&t(jr),n&&t(he),$(ho),$(nn),$(go),n&&t(Er),n&&t(Ft),$(_o),n&&t(qr),n&&t(qe),$(vo),$(bo),$(an),$(rn),n&&t(Fr),n&&t(Nt),$(yo),n&&t(Pr),n&&t(Fe),$(wo),$(jo),$(ln),$(cn),n&&t(Nr),n&&t(Lt),$(Fo),n&&t(Cr),n&&t(It),$(Po),$(No),$(un),n&&t(Lr),n&&t(At),$(Co),n&&t(Ir),n&&t(ue),$(Lo),$(fn),$(So),$(gn),$(_n),n&&t(Ar),n&&t(St),$(Do),n&&t(Or),n&&t(me),$(Ho),$(kn),$(Vo),$(Tn),$(Mn),n&&t(Sr),n&&t(Ht),$(Go),n&&t(Dr),n&&t(J),$(Jo),$(os),$(yn),$(wn),n&&t(Hr),n&&t(Ut),$(ss),n&&t(Wr),n&&t(Y),$(as),$(us),$($n),$(zn)}}}const Sm={local:"marianmt",sections:[{local:"implementation-notes",title:"Implementation Notes"},{local:"naming",title:"Naming"},{local:"examples",title:"Examples"},{local:"multilingual-models",title:"Multilingual Models"},{local:"old-style-multilingual-models",title:"Old Style Multi-Lingual Models"},{local:"transformers.MarianConfig",title:"MarianConfig"},{local:"transformers.MarianTokenizer",title:"MarianTokenizer"},{local:"transformers.MarianModel",title:"MarianModel"},{local:"transformers.MarianMTModel",title:"MarianMTModel"},{local:"transformers.MarianForCausalLM",title:"MarianForCausalLM"},{local:"transformers.TFMarianModel",title:"TFMarianModel"},{local:"transformers.TFMarianMTModel",title:"TFMarianMTModel"},{local:"transformers.FlaxMarianModel",title:"FlaxMarianModel"},{local:"transformers.FlaxMarianMTModel",title:"FlaxMarianMTModel"}],title:"MarianMT"};function Dm(E){return Tm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Km extends gm{constructor(h){super();_m(this,h,Dm,Om,vm,{})}}export{Km as default,Sm as metadata};
