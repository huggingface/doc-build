import{S as Lm,i as Sm,s as Dm,e as n,k as l,w as y,t as a,M as Gm,c as r,d as t,m as c,a as s,x as k,h as d,b as h,G as e,g as f,y as T,q as w,o as $,B as x,v as Wm,L as _t}from"../../chunks/vendor-hf-doc-builder.js";import{T as Uo}from"../../chunks/Tip-hf-doc-builder.js";import{D as N}from"../../chunks/Docstring-hf-doc-builder.js";import{C as dt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Te}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ft}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Um(F){let p,v,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function Rm(F){let p,v,g,m,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=a("Module"),b=a(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,v),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function Hm(F){let p,v,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">6</span>, <span class="hljs-number">1280</span>]`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function Vm(F){let p,v,g,m,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var E=s(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,v),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function Km(F){let p,v,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Bot:   That&#x27;s too bad. Have you tried encouraging them to change their eating habits?</span>`}}),{c(){p=n("p"),v=a("Conversation example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Conversation example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function Jm(F){let p,v,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function Qm(F){let p,v,g,m,b,i,u,E,Je,Le,A,xe,Be,z,ae,de,Qe,Se,I,Y,Fe,U,Xe,ze,ie,De,Z,le,ce,Ye,qe,C,j,Ze,ee,we,Ee,pe,Ge,R,L,he,ue,et,me,fe,tt,We,O,te,V,_e,Me,P,ot,G,H,ge;return{c(){p=n("p"),v=a("TensorFlow models and layers in "),g=n("code"),m=a("transformers"),b=a(" accept two formats as input:"),i=l(),u=n("ul"),E=n("li"),Je=a("having all inputs as keyword arguments (like PyTorch models), or"),Le=l(),A=n("li"),xe=a("having all inputs as a list, tuple or dict in the first positional argument."),Be=l(),z=n("p"),ae=a(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),I=n("code"),Y=a("model.fit()"),Fe=a(` supports! If, however, you want to use the second
format outside of Keras methods like `),U=n("code"),Xe=a("fit()"),ze=a(" and "),ie=n("code"),De=a("predict()"),Z=a(`, such as when creating your own layers or models with
...
`),V=n("code"),_e=a('model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me=l(),P=n("p"),ot=a(`Note that when creating models and layers with
`),G=n("a"),H=a("subclassing"),ge=a(` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(B){p=r(B,"P",{});var q=s(p);v=d(q,"TensorFlow models and layers in "),g=r(q,"CODE",{});var gt=s(g);m=d(gt,"transformers"),gt.forEach(t),b=d(q," accept two formats as input:"),q.forEach(t),i=c(B),u=r(B,"UL",{});var Ce=s(u);E=r(Ce,"LI",{});var bt=s(E);Je=d(bt,"having all inputs as keyword arguments (like PyTorch models), or"),bt.forEach(t),Le=c(Ce),A=r(Ce,"LI",{});var je=s(A);xe=d(je,"having all inputs as a list, tuple or dict in the first positional argument."),je.forEach(t),Ce.forEach(t),Be=c(B),z=r(B,"P",{});var M=s(z);ae=d(M,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),I=r(M,"CODE",{});var vt=s(I);Y=d(vt,"model.fit()"),vt.forEach(t),Fe=d(M,` supports! If, however, you want to use the second
format outside of Keras methods like `),U=r(M,"CODE",{});var yt=s(U);Xe=d(yt,"fit()"),yt.forEach(t),ze=d(M," and "),ie=r(M,"CODE",{});var kt=s(ie);De=d(kt,"predict()"),kt.forEach(t),Z=d(M,`, such as when creating your own layers or models with
the Keras `),le=r(M,"CODE",{});var K=s(le);ce=d(K,"Functional"),K.forEach(t),Ye=d(M,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),M.forEach(t),qe=c(B),C=r(B,"UL",{});var J=s(C);j=r(J,"LI",{});var Q=s(j);Ze=d(Q,"a single Tensor with "),ee=r(Q,"CODE",{});var Tt=s(ee);we=d(Tt,"input_ids"),Tt.forEach(t),Ee=d(Q," only and nothing else: "),pe=r(Q,"CODE",{});var wt=s(pe);Ge=d(wt,"model(input_ids)"),wt.forEach(t),Q.forEach(t),R=c(J),L=r(J,"LI",{});var X=s(L);he=d(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ue=r(X,"CODE",{});var $t=s(ue);et=d($t,"model([input_ids, attention_mask])"),$t.forEach(t),me=d(X," or "),fe=r(X,"CODE",{});var xt=s(fe);tt=d(xt,"model([input_ids, attention_mask, token_type_ids])"),xt.forEach(t),X.forEach(t),We=c(J),O=r(J,"LI",{});var $e=s(O);te=d($e,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),V=r($e,"CODE",{});var Bt=s(V);_e=d(Bt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Bt.forEach(t),$e.forEach(t),J.forEach(t),Me=c(B),P=r(B,"P",{});var Pe=s(P);ot=d(Pe,`Note that when creating models and layers with
`),G=r(Pe,"A",{href:!0,rel:!0});var it=s(G);H=d(it,"subclassing"),it.forEach(t),ge=d(Pe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Pe.forEach(t),this.h()},h(){h(G,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(G,"rel","nofollow")},m(B,q){f(B,p,q),e(p,v),e(p,g),e(g,m),e(p,b),f(B,i,q),f(B,u,q),e(u,E),e(E,Je),e(u,Le),e(u,A),e(A,xe),f(B,Be,q),f(B,z,q),e(z,ae),e(z,de),e(de,Qe),e(z,Se),e(z,I),e(I,Y),e(z,Fe),e(z,U),e(U,Xe),e(z,ze),e(z,ie),e(ie,De),e(z,Z),e(z,le),e(le,ce),e(z,Ye),f(B,qe,q),f(B,C,q),e(C,j),e(j,Ze),e(j,ee),e(ee,we),e(j,Ee),e(j,pe),e(pe,Ge),e(C,R),e(C,L),e(L,he),e(L,ue),e(ue,et),e(L,me),e(L,fe),e(fe,tt),e(C,We),e(C,O),e(O,te),e(O,V),e(V,_e),f(B,Me,q),f(B,P,q),e(P,ot),e(P,G),e(G,H),e(P,ge)},d(B){B&&t(p),B&&t(i),B&&t(u),B&&t(Be),B&&t(z),B&&t(qe),B&&t(C),B&&t(Me),B&&t(P)}}}function Xm(F){let p,v,g,m,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var E=s(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,v),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function Ym(F){let p,v,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, TFBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function Zm(F){let p,v,g,m,b,i,u,E,Je,Le,A,xe,Be,z,ae,de,Qe,Se,I,Y,Fe,U,Xe,ze,ie,De,Z,le,ce,Ye,qe,C,j,Ze,ee,we,Ee,pe,Ge,R,L,he,ue,et,me,fe,tt,We,O,te,V,_e,Me,P,ot,G,H,ge;return{c(){p=n("p"),v=a("TensorFlow models and layers in "),g=n("code"),m=a("transformers"),b=a(" accept two formats as input:"),i=l(),u=n("ul"),E=n("li"),Je=a("having all inputs as keyword arguments (like PyTorch models), or"),Le=l(),A=n("li"),xe=a("having all inputs as a list, tuple or dict in the first positional argument."),Be=l(),z=n("p"),ae=a(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),de=n("code"),Qe=a("model.fit()"),Se=a(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=n("code"),Y=a("model.fit()"),Fe=a(` supports! If, however, you want to use the second
format outside of Keras methods like `),U=n("code"),Xe=a("fit()"),ze=a(" and "),ie=n("code"),De=a("predict()"),Z=a(`, such as when creating your own layers or models with
the Keras `),le=n("code"),ce=a("Functional"),Ye=a(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),V=r($e,"CODE",{});var Bt=s(V);_e=d(Bt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Bt.forEach(t),$e.forEach(t),J.forEach(t),Me=c(B),P=r(B,"P",{});var Pe=s(P);ot=d(Pe,`Note that when creating models and layers with
`),G=r(Pe,"A",{href:!0,rel:!0});var it=s(G);H=d(it,"subclassing"),it.forEach(t),ge=d(Pe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Pe.forEach(t),this.h()},h(){h(G,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(G,"rel","nofollow")},m(B,q){f(B,p,q),e(p,v),e(p,g),e(g,m),e(p,b),f(B,i,q),f(B,u,q),e(u,E),e(E,Je),e(u,Le),e(u,A),e(A,xe),f(B,Be,q),f(B,z,q),e(z,ae),e(z,de),e(de,Qe),e(z,Se),e(z,I),e(I,Y),e(z,Fe),e(z,U),e(U,Xe),e(z,ze),e(z,ie),e(ie,De),e(z,Z),e(z,le),e(le,ce),e(z,Ye),f(B,qe,q),f(B,C,q),e(C,j),e(j,Ze),e(j,ee),e(ee,we),e(j,Ee),e(j,pe),e(pe,Ge),e(C,R),e(C,L),e(L,he),e(L,ue),e(ue,et),e(L,me),e(L,fe),e(fe,tt),e(C,We),e(C,O),e(O,te),e(O,V),e(V,_e),f(B,Me,q),f(B,P,q),e(P,ot),e(P,G),e(G,H),e(P,ge)},d(B){B&&t(p),B&&t(i),B&&t(u),B&&t(Be),B&&t(z),B&&t(qe),B&&t(C),B&&t(Me),B&&t(P)}}}function ef(F){let p,v,g,m,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var E=s(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,v),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function tf(F){let p,v,g,m,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var E=s(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,v),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function of(F){let p,v,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function nf(F){let p,v,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function rf(F){let p,v,g,m,b;return m=new dt({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function sf(F){let p,v,g,m,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var E=s(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,v),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function af(F){let p,v,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function df(F){let p,v,g,m,b;return m=new dt({props:{code:`import jax.numpy as jnp
from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),v=a("Example:"),g=l(),y(m.$$.fragment)},l(i){p=r(i,"P",{});var u=s(p);v=d(u,"Example:"),u.forEach(t),g=c(i),k(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,v),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(m,i)}}}function lf(F){let p,v,g,m,b,i,u,E,Je,Le,A,xe,Be,z,ae,de,Qe,Se,I,Y,Fe,U,Xe,ze,ie,De,Z,le,ce,Ye,qe,C,j,Ze,ee,we,Ee,pe,Ge,R,L,he,ue,et,me,fe,tt,We,O,te,V,_e,Me,P,ot,G,H,ge,B,q,gt,Ce,bt,je,M,Oe,vt,yt,kt,K,J,Q,Tt,wt,X,$t,xt,$e,Bt,Pe,it,Ft,Kt,Wr,Ro,Dd,Ur,Gd,Ca,pr,Wd,ja,Ho,Oa,zt,Jt,Rr,Vo,Ud,Hr,Rd,Pa,Ne,Ko,Hd,qt,Vd,hr,Kd,Jd,Jo,Qd,Xd,Yd,Et,Zd,ur,ei,ti,mr,oi,ni,ri,Qt,Na,Mt,Xt,Vr,Qo,si,Kr,ai,Aa,be,Xo,di,Jr,ii,li,Yt,Qr,ci,pi,fr,hi,ui,mi,Yo,fi,_r,_i,gi,bi,lt,Zo,vi,Xr,yi,ki,Yr,gr,Ti,Zr,wi,Ia,Ct,Zt,es,en,$i,ts,xi,La,ve,tn,Bi,on,Fi,os,zi,qi,Ei,eo,ns,Mi,Ci,br,ji,Oi,Pi,nn,Ni,vr,Ai,Ii,Li,ct,rn,Si,rs,Di,Gi,ss,yr,Wi,as,Ui,Sa,jt,to,ds,sn,Ri,is,Hi,Da,nt,Vi,ls,Ki,Ji,cs,Qi,Xi,ps,Yi,Ga,Ae,an,Zi,dn,el,kr,tl,ol,nl,ln,rl,cn,sl,al,dl,Ue,pn,il,Ot,ll,Tr,cl,pl,hs,hl,ul,ml,oo,fl,no,Wa,Pt,ro,us,hn,_l,ms,gl,Ua,rt,bl,wr,vl,yl,fs,kl,Tl,_s,wl,Ra,Ie,un,$l,mn,xl,$r,Bl,Fl,zl,fn,ql,_n,El,Ml,Cl,Re,gn,jl,Nt,Ol,xr,Pl,Nl,gs,Al,Il,Ll,so,Sl,ao,Ha,At,io,bs,bn,Dl,vs,Gl,Va,It,vn,Wl,lo,yn,Ul,co,Ka,Lt,po,ys,kn,Rl,ks,Hl,Ja,ye,Tn,Vl,wn,Kl,Br,Jl,Ql,Xl,$n,Yl,xn,Zl,ec,tc,ho,oc,He,Bn,nc,St,rc,Fr,sc,ac,Ts,dc,ic,lc,uo,cc,mo,Qa,Dt,fo,ws,Fn,pc,$s,hc,Xa,ke,zn,uc,qn,mc,zr,fc,_c,gc,En,bc,Mn,vc,yc,kc,_o,Tc,oe,Cn,wc,Gt,$c,qr,xc,Bc,xs,Fc,zc,qc,go,Ec,Bs,Mc,Cc,Fs,zs,qs,Es,jc,Oc,Ms,Cs,js,jn,Pc,Os,Nc,Ac,Ya,Wt,bo,Ps,On,Ic,Ns,Lc,Za,S,Pn,Sc,Nn,Dc,Er,Gc,Wc,Uc,An,Rc,In,Hc,Vc,Kc,As,Jc,Qc,st,Is,Ln,Xc,Yc,Ls,Sn,Zc,ep,Ss,Dn,tp,op,Ds,Gn,np,rp,Ve,Wn,sp,Ut,ap,Gs,dp,ip,Ws,lp,cp,pp,vo,hp,yo,up,ko,Un,mp,To,fp,wo,Rn,_p,$o,ed,Rt,xo,Us,Hn,gp,Rs,bp,td,D,Vn,vp,Kn,yp,Mr,kp,Tp,wp,Jn,$p,Qn,xp,Bp,Fp,Hs,zp,qp,at,Vs,Xn,Ep,Mp,Ks,Yn,Cp,jp,Js,Zn,Op,Pp,Qs,er,Np,Ap,W,tr,Ip,Ht,Lp,Xs,Sp,Dp,Ys,Gp,Wp,Up,Bo,Rp,Zs,Hp,Vp,ea,ta,oa,na,Kp,Jp,ra,sa,aa,da,Qp,Xp,ia,la,ca,pa,Yp,Zp,ha,ua,or,Fo,zo,ma,nr,eh,fa,th,oh,_a,nh,rh,qo,rr,sh,Eo,ah,Mo,sr,dh,Co,od;return i=new Te({}),U=new Te({}),_e=new Te({}),Ro=new Te({}),Ho=new dt({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Will be ignored`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/blenderbot/tokenization_blenderbot_fast.py#L61",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.BlenderbotConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/blenderbot/modeling_blenderbot.py#L1286",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.22.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/blenderbot/modeling_blenderbot.py#L1453",returnDescription:`
<p>A <a
...
`}}),co=new ft({props:{anchor:"transformers.BlenderbotForCausalLM.forward.example",$$slots:{default:[Jm]},$$scope:{ctx:F}}}),kn=new Te({}),Tn=new N({props:{name:"class transformers.TFBlenderbotModel",anchor:"transformers.TFBlenderbotModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFBlenderbotModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.BlenderbotConfig">BlenderbotConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1147"}}),ho=new Uo({props:{$$slots:{default:[Qm]},$$scope:{ctx:F}}}),Bn=new N({props:{name:"call",anchor:"transformers.TFBlenderbotModel.call",parameters:[{name:"input_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFBlenderbotModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1175",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1269"}}),_o=new Uo({props:{$$slots:{default:[Zm]},$$scope:{ctx:F}}}),Cn=new N({props:{name:"call",anchor:"transformers.TFBlenderbotForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFBlenderbotForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.BlenderbotTokenizer">BlenderbotTokenizer</a>. See <a href="/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1319",returnDescription:`
<p>A <a
...
`}}),$o=new ft({props:{anchor:"transformers.FlaxBlenderbotModel.decode.example",$$slots:{default:[rf]},$$scope:{ctx:F}}}),Hn=new Te({}),Vn=new N({props:{name:"class transformers.FlaxBlenderbotForConditionalGeneration",anchor:"transformers.FlaxBlenderbotForConditionalGeneration",parameters:[{name:"config",val:": BlenderbotConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxBlenderbotForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.BlenderbotConfig">BlenderbotConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
failure cases of our models.`),Ge=l(),R=n("p"),L=a("This model was contributed by "),he=n("a"),ue=a("sshleifer"),et=a(". The authors\u2019 code can be found "),me=n("a"),fe=a("here"),tt=a(" ."),We=l(),O=n("h2"),te=n("a"),V=n("span"),y(_e.$$.fragment),Me=l(),P=n("span"),ot=a("Implementation Notes"),G=l(),H=n("ul"),ge=n("li"),B=a("Blenderbot uses a standard "),q=n("a"),gt=a("seq2seq model transformer"),Ce=a(" based architecture."),bt=l(),je=n("li"),M=a("Available checkpoints can be found in the "),Oe=n("a"),vt=a("model hub"),yt=a("."),kt=l(),K=n("li"),J=a("This is the "),Q=n("em"),Tt=a("default"),wt=a(` Blenderbot model class. However, some smaller checkpoints, such as
`),X=n("code"),$t=a("facebook/blenderbot_small_90M"),xt=a(`, have a different architecture and consequently should be used with
`),$e=n("a"),Bt=a("BlenderbotSmall"),Pe=a("."),it=l(),Ft=n("h2"),Kt=n("a"),Wr=n("span"),y(Ro.$$.fragment),Dd=l(),Ur=n("span"),Gd=a("Usage"),Ca=l(),pr=n("p"),Wd=a("Here is an example of model usage:"),ja=l(),y(Ho.$$.fragment),Oa=l(),zt=n("h2"),Jt=n("a"),Rr=n("span"),y(Vo.$$.fragment),Ud=l(),Hr=n("span"),Rd=a("BlenderbotConfig"),Pa=l(),Ne=n("div"),y(Ko.$$.fragment),Hd=l(),qt=n("p"),Vd=a("This is the configuration class to store the configuration of a "),hr=n("a"),Kd=a("BlenderbotModel"),Jd=a(`. It is used to instantiate an
...
documentation from `),mr=n("a"),oi=a("PretrainedConfig"),ni=a(" for more information."),ri=l(),y(Qt.$$.fragment),Na=l(),Mt=n("h2"),Xt=n("a"),Vr=n("span"),y(Qo.$$.fragment),si=l(),Kr=n("span"),ai=a("BlenderbotTokenizer"),Aa=l(),be=n("div"),y(Xo.$$.fragment),di=l(),Jr=n("p"),ii=a("Construct a Blenderbot tokenizer."),li=l(),Yt=n("p"),Qr=n("code"),ci=a("Blenderbot"),pi=a(" is nearly identical to "),fr=n("a"),hi=a("RobertaTokenizer"),ui=a(` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),mi=l(),Yo=n("p"),fi=a("Refer to superclass "),_r=n("a"),_i=a("RobertaTokenizer"),gi=a(" for usage examples and documentation concerning parameters."),bi=l(),lt=n("div"),y(Zo.$$.fragment),vi=l(),Xr=n("p"),yi=a(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),ki=l(),Yr=n("ul"),gr=n("li"),Ti=a("single sequence: "),Zr=n("code"),wi=a("X </s>"),Ia=l(),Ct=n("h2"),Zt=n("a"),es=n("span"),y(en.$$.fragment),$i=l(),ts=n("span"),xi=a("BlenderbotTokenizerFast"),La=l(),ve=n("div"),y(tn.$$.fragment),Bi=l(),on=n("p"),Fi=a("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),os=n("em"),zi=a("tokenizers"),qi=a(" library)."),Ei=l(),eo=n("p"),ns=n("code"),Mi=a("BlenderbotFast"),Ci=a(" is nearly identical to "),br=n("a"),ji=a("RobertaTokenizerFast"),Oi=a(` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Pi=l(),nn=n("p"),Ni=a("Refer to superclass "),vr=n("a"),Ai=a("RobertaTokenizerFast"),Ii=a(" for usage examples and documentation concerning parameters."),Li=l(),ct=n("div"),y(rn.$$.fragment),Si=l(),rs=n("p"),Di=a(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),ss=n("ul"),yr=n("li"),Wi=a("single sequence: "),as=n("code"),Ui=a("X </s>"),Sa=l(),jt=n("h2"),to=n("a"),ds=n("span"),y(sn.$$.fragment),Ri=l(),is=n("span"),Hi=a("BlenderbotModel"),Da=l(),nt=n("p"),Vi=a("See "),ls=n("code"),Ki=a("transformers.BartModel"),Ji=a(" for arguments to "),cs=n("em"),Qi=a("forward"),Xi=a(" and "),ps=n("em"),Yi=a("generate"),Ga=l(),Ae=n("div"),y(an.$$.fragment),Zi=l(),dn=n("p"),el=a(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
This model inherits from `),kr=n("a"),tl=a("PreTrainedModel"),ol=a(`. Check the superclass documentation for the generic methods the
...
and behavior.`),dl=l(),Ue=n("div"),y(pn.$$.fragment),il=l(),Ot=n("p"),ll=a("The "),Tr=n("a"),cl=a("BlenderbotModel"),pl=a(" forward method, overrides the "),hs=n("code"),hl=a("__call__"),ul=a(" special method."),ml=l(),y(oo.$$.fragment),fl=l(),y(no.$$.fragment),Wa=l(),Pt=n("h2"),ro=n("a"),us=n("span"),y(hn.$$.fragment),_l=l(),ms=n("span"),gl=a("BlenderbotForConditionalGeneration"),Ua=l(),rt=n("p"),bl=a("See "),wr=n("a"),vl=a("BartForConditionalGeneration"),yl=a(" for arguments to "),fs=n("em"),kl=a("forward"),Tl=a(" and "),_s=n("em"),wl=a("generate"),Ra=l(),Ie=n("div"),y(un.$$.fragment),$l=l(),mn=n("p"),xl=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),$r=n("a"),Bl=a("PreTrainedModel"),Fl=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zl=l(),fn=n("p"),ql=a("This model is also a PyTorch "),_n=n("a"),El=a("torch.nn.Module"),Ml=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cl=l(),Re=n("div"),y(gn.$$.fragment),jl=l(),Nt=n("p"),Ol=a("The "),xr=n("a"),Pl=a("BlenderbotForConditionalGeneration"),Nl=a(" forward method, overrides the "),gs=n("code"),Al=a("__call__"),Il=a(" special method."),Ll=l(),y(so.$$.fragment),Sl=l(),y(ao.$$.fragment),Ha=l(),At=n("h2"),io=n("a"),bs=n("span"),y(bn.$$.fragment),Dl=l(),vs=n("span"),Gl=a("BlenderbotForCausalLM"),Va=l(),It=n("div"),y(vn.$$.fragment),Wl=l(),lo=n("div"),y(yn.$$.fragment),Ul=l(),y(co.$$.fragment),Ka=l(),Lt=n("h2"),po=n("a"),ys=n("span"),y(kn.$$.fragment),Rl=l(),ks=n("span"),Hl=a("TFBlenderbotModel"),Ja=l(),ye=n("div"),y(Tn.$$.fragment),Vl=l(),wn=n("p"),Kl=a(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Br=n("a"),Jl=a("TFPreTrainedModel"),Ql=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xl=l(),$n=n("p"),Yl=a("This model is also a "),xn=n("a"),Zl=a("tf.keras.Model"),ec=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tc=l(),y(ho.$$.fragment),oc=l(),He=n("div"),y(Bn.$$.fragment),nc=l(),St=n("p"),rc=a("The "),Fr=n("a"),sc=a("TFBlenderbotModel"),ac=a(" forward method, overrides the "),Ts=n("code"),dc=a("__call__"),ic=a(" special method."),lc=l(),y(uo.$$.fragment),cc=l(),y(mo.$$.fragment),Qa=l(),Dt=n("h2"),fo=n("a"),ws=n("span"),y(Fn.$$.fragment),pc=l(),$s=n("span"),hc=a("TFBlenderbotForConditionalGeneration"),Xa=l(),ke=n("div"),y(zn.$$.fragment),uc=l(),qn=n("p"),mc=a(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
This model inherits from `),zr=n("a"),fc=a("TFPreTrainedModel"),_c=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gc=l(),En=n("p"),bc=a("This model is also a "),Mn=n("a"),vc=a("tf.keras.Model"),yc=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kc=l(),y(_o.$$.fragment),Tc=l(),oe=n("div"),y(Cn.$$.fragment),wc=l(),Gt=n("p"),$c=a("The "),qr=n("a"),xc=a("TFBlenderbotForConditionalGeneration"),Bc=a(" forward method, overrides the "),xs=n("code"),Fc=a("__call__"),zc=a(" special method."),qc=l(),y(go.$$.fragment),Ec=l(),Bs=n("p"),Mc=a("Conversation example::"),Cc=l(),Fs=n("blockquote"),zs=n("blockquote"),qs=n("blockquote"),Es=n("p"),jc=a(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
skip_special_tokens=True)[0])`),Ya=l(),Wt=n("h2"),bo=n("a"),Ps=n("span"),y(On.$$.fragment),Ic=l(),Ns=n("span"),Lc=a("FlaxBlenderbotModel"),Za=l(),S=n("div"),y(Pn.$$.fragment),Sc=l(),Nn=n("p"),Dc=a(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
`),In=n("a"),Hc=a("flax.nn.Module"),Vc=a(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Kc=l(),As=n("p"),Jc=a("Finally, this model supports inherent JAX features such as:"),Qc=l(),st=n("ul"),Is=n("li"),Ln=n("a"),Xc=a("Just-In-Time (JIT) compilation"),Yc=l(),Ls=n("li"),Sn=n("a"),Zc=a("Automatic Differentiation"),ep=l(),Ss=n("li"),Dn=n("a"),tp=a("Vectorization"),op=l(),Ds=n("li"),Gn=n("a"),np=a("Parallelization"),rp=l(),Ve=n("div"),y(Wn.$$.fragment),sp=l(),Ut=n("p"),ap=a("The "),Gs=n("code"),dp=a("FlaxBlenderbotPreTrainedModel"),ip=a(" forward method, overrides the "),Ws=n("code"),lp=a("__call__"),cp=a(" special method."),pp=l(),y(vo.$$.fragment),hp=l(),y(yo.$$.fragment),up=l(),ko=n("div"),y(Un.$$.fragment),mp=l(),y(To.$$.fragment),fp=l(),wo=n("div"),y(Rn.$$.fragment),_p=l(),y($o.$$.fragment),ed=l(),Rt=n("h2"),xo=n("a"),Us=n("span"),y(Hn.$$.fragment),gp=l(),Rs=n("span"),bp=a("FlaxBlenderbotForConditionalGeneration"),td=l(),D=n("div"),y(Vn.$$.fragment),vp=l(),Kn=n("p"),yp=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mr=n("a"),kp=a("FlaxPreTrainedModel"),Tp=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp=l(),Jn=n("p"),$p=a(`This model is also a Flax Linen
`),Qn=n("a"),xp=a("flax.nn.Module"),Bp=a(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Fp=l(),Hs=n("p"),zp=a("Finally, this model supports inherent JAX features such as:"),qp=l(),at=n("ul"),Vs=n("li"),Xn=n("a"),Ep=a("Just-In-Time (JIT) compilation"),Mp=l(),Ks=n("li"),Yn=n("a"),Cp=a("Automatic Differentiation"),jp=l(),Js=n("li"),Zn=n("a"),Op=a("Vectorization"),Pp=l(),Qs=n("li"),er=n("a"),Np=a("Parallelization"),Ap=l(),W=n("div"),y(tr.$$.fragment),Ip=l(),Ht=n("p"),Lp=a("The "),Xs=n("code"),Sp=a("FlaxBlenderbotPreTrainedModel"),Dp=a(" forward method, overrides the "),Ys=n("code"),Gp=a("__call__"),Wp=a(" special method."),Up=l(),y(Bo.$$.fragment),Rp=l(),Zs=n("p"),Hp=a("Conversation example::"),Vp=l(),ea=n("blockquote"),ta=n("blockquote"),oa=n("blockquote"),na=n("p"),Kp=a("from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),Jp=l(),ra=n("blockquote"),sa=n("blockquote"),aa=n("blockquote"),da=n("p"),Qp=a(`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
...
max_length=1024, return_tensors=\u2018np\u2019)`),Zp=l(),ha=n("blockquote"),ua=n("blockquote"),or=n("blockquote"),Fo=n("h1"),zo=n("a"),ma=n("span"),y(nr.$$.fragment),eh=l(),fa=n("span"),th=a("Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),oh=l(),_a=n("p"),nh=a(`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),rh=l(),qo=n("div"),y(rr.$$.fragment),sh=l(),y(Eo.$$.fragment),ah=l(),Mo=n("div"),y(sr.$$.fragment),dh=l(),y(Co.$$.fragment),this.h()},l(o){const _=Gm('[data-svelte="svelte-1phssyn"]',document.head);p=r(_,"META",{name:!0,content:!0}),_.forEach(t),v=c(o),g=r(o,"H1",{class:!0});var ar=s(g);m=r(ar,"A",{id:!0,class:!0,href:!0});var ga=s(m);b=r(ga,"SPAN",{});var ba=s(b);k(i.$$.fragment,ba),ba.forEach(t),ga.forEach(t),u=c(ar),E=r(ar,"SPAN",{});var va=s(E);Je=d(va,"Blenderbot"),va.forEach(t),ar.forEach(t),Le=c(o),A=r(o,"P",{});var jo=s(A);xe=r(jo,"STRONG",{});var ya=s(xe);Be=d(ya,"DISCLAIMER:"),ya.forEach(t),z=d(jo," If you see something strange, file a "),ae=r(jo,"A",{href:!0,rel:!0});var ka=s(ae);de=d(ka,"Github Issue"),ka.forEach(t),Qe=d(jo," ."),jo.forEach(t),Se=c(o),I=r(o,"H2",{class:!0});var dr=s(I);Y=r(dr,"A",{id:!0,class:!0,href:!0});var Ta=s(Y);Fe=r(Ta,"SPAN",{});var wa=s(Fe);k(U.$$.fragment,wa),wa.forEach(t),Ta.forEach(t),Xe=c(dr),ze=r(dr,"SPAN",{});var $a=s(ze);ie=d($a,"Overview"),$a.forEach(t),dr.forEach(t),De=c(o),Z=r(o,"P",{});var ir=s(Z);le=d(ir,"The Blender chatbot model was proposed in "),ce=r(ir,"A",{href:!0,rel:!0});var xa=s(ce);Ye=d(xa,"Recipes for building an open-domain chatbot"),xa.forEach(t),qe=d(ir,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),ir.forEach(t),C=c(o),j=r(o,"P",{});var Ba=s(j);Ze=d(Ba,"The abstract of the paper is the following:"),Ba.forEach(t),ee=c(o),we=r(o,"P",{});var Fa=s(we);Ee=r(Fa,"EM",{});var za=s(Ee);pe=d(za,`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
scaling neural models in the number of parameters and the size of the data they are trained on gives improved results,
we show that other ingredients are important for a high-performing chatbot. Good conversation requires a number of
skills that an expert conversationalist blends in a seamless way: providing engaging talking points and listening to
their partners, and displaying knowledge, empathy and personality appropriately, while maintaining a consistent
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),za.forEach(t),Fa.forEach(t),Ge=c(o),R=r(o,"P",{});var Vt=s(R);L=d(Vt,"This model was contributed by "),he=r(Vt,"A",{href:!0,rel:!0});var qa=s(he);ue=d(qa,"sshleifer"),qa.forEach(t),et=d(Vt,". The authors\u2019 code can be found "),me=r(Vt,"A",{href:!0,rel:!0});var ch=s(me);fe=d(ch,"here"),ch.forEach(t),tt=d(Vt," ."),Vt.forEach(t),We=c(o),O=r(o,"H2",{class:!0});var nd=s(O);te=r(nd,"A",{id:!0,class:!0,href:!0});var ph=s(te);V=r(ph,"SPAN",{});var hh=s(V);k(_e.$$.fragment,hh),hh.forEach(t),ph.forEach(t),Me=c(nd),P=r(nd,"SPAN",{});var uh=s(P);ot=d(uh,"Implementation Notes"),uh.forEach(t),nd.forEach(t),G=c(o),H=r(o,"UL",{});var Cr=s(H);ge=r(Cr,"LI",{});var rd=s(ge);B=d(rd,"Blenderbot uses a standard "),q=r(rd,"A",{href:!0,rel:!0});var mh=s(q);gt=d(mh,"seq2seq model transformer"),mh.forEach(t),Ce=d(rd," based architecture."),rd.forEach(t),bt=c(Cr),je=r(Cr,"LI",{});var sd=s(je);M=d(sd,"Available checkpoints can be found in the "),Oe=r(sd,"A",{href:!0,rel:!0});var fh=s(Oe);vt=d(fh,"model hub"),fh.forEach(t),yt=d(sd,"."),sd.forEach(t),kt=c(Cr),K=r(Cr,"LI",{});var Oo=s(K);J=d(Oo,"This is the "),Q=r(Oo,"EM",{});var _h=s(Q);Tt=d(_h,"default"),_h.forEach(t),wt=d(Oo,` Blenderbot model class. However, some smaller checkpoints, such as
`),X=r(Oo,"CODE",{});var gh=s(X);$t=d(gh,"facebook/blenderbot_small_90M"),gh.forEach(t),xt=d(Oo,`, have a different architecture and consequently should be used with
`),$e=r(Oo,"A",{href:!0});var bh=s($e);Bt=d(bh,"BlenderbotSmall"),bh.forEach(t),Pe=d(Oo,"."),Oo.forEach(t),Cr.forEach(t),it=c(o),Ft=r(o,"H2",{class:!0});var ad=s(Ft);Kt=r(ad,"A",{id:!0,class:!0,href:!0});var vh=s(Kt);Wr=r(vh,"SPAN",{});var yh=s(Wr);k(Ro.$$.fragment,yh),yh.forEach(t),vh.forEach(t),Dd=c(ad),Ur=r(ad,"SPAN",{});var kh=s(Ur);Gd=d(kh,"Usage"),kh.forEach(t),ad.forEach(t),Ca=c(o),pr=r(o,"P",{});var Th=s(pr);Wd=d(Th,"Here is an example of model usage:"),Th.forEach(t),ja=c(o),k(Ho.$$.fragment,o),Oa=c(o),zt=r(o,"H2",{class:!0});var dd=s(zt);Jt=r(dd,"A",{id:!0,class:!0,href:!0});var wh=s(Jt);Rr=r(wh,"SPAN",{});var $h=s(Rr);k(Vo.$$.fragment,$h),$h.forEach(t),wh.forEach(t),Ud=c(dd),Hr=r(dd,"SPAN",{});var xh=s(Hr);Rd=d(xh,"BlenderbotConfig"),xh.forEach(t),dd.forEach(t),Pa=c(o),Ne=r(o,"DIV",{class:!0});var Po=s(Ne);k(Ko.$$.fragment,Po),Hd=c(Po),qt=r(Po,"P",{});var jr=s(qt);Vd=d(jr,"This is the configuration class to store the configuration of a "),hr=r(jr,"A",{href:!0});var Bh=s(hr);Kd=d(Bh,"BlenderbotModel"),Bh.forEach(t),Jd=d(jr,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),Jo=r(jr,"A",{href:!0,rel:!0});var Fh=s(Jo);Qd=d(Fh,"facebook/blenderbot-3B"),Fh.forEach(t),Xd=d(jr," architecture."),jr.forEach(t),Yd=c(Po),Et=r(Po,"P",{});var Or=s(Et);Zd=d(Or,"Configuration objects inherit from "),ur=r(Or,"A",{href:!0});var zh=s(ur);ei=d(zh,"PretrainedConfig"),zh.forEach(t),ti=d(Or,` and can be used to control the model outputs. Read the
documentation from `),mr=r(Or,"A",{href:!0});var qh=s(mr);oi=d(qh,"PretrainedConfig"),qh.forEach(t),ni=d(Or," for more information."),Or.forEach(t),ri=c(Po),k(Qt.$$.fragment,Po),Po.forEach(t),Na=c(o),Mt=r(o,"H2",{class:!0});var id=s(Mt);Xt=r(id,"A",{id:!0,class:!0,href:!0});var Eh=s(Xt);Vr=r(Eh,"SPAN",{});var Mh=s(Vr);k(Qo.$$.fragment,Mh),Mh.forEach(t),Eh.forEach(t),si=c(id),Kr=r(id,"SPAN",{});var Ch=s(Kr);ai=d(Ch,"BlenderbotTokenizer"),Ch.forEach(t),id.forEach(t),Aa=c(o),be=r(o,"DIV",{class:!0});var pt=s(be);k(Xo.$$.fragment,pt),di=c(pt),Jr=r(pt,"P",{});var jh=s(Jr);ii=d(jh,"Construct a Blenderbot tokenizer."),jh.forEach(t),li=c(pt),Yt=r(pt,"P",{});var Ea=s(Yt);Qr=r(Ea,"CODE",{});var Oh=s(Qr);ci=d(Oh,"Blenderbot"),Oh.forEach(t),pi=d(Ea," is nearly identical to "),fr=r(Ea,"A",{href:!0});var Ph=s(fr);hi=d(Ph,"RobertaTokenizer"),Ph.forEach(t),ui=d(Ea,` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Ea.forEach(t),mi=c(pt),Yo=r(pt,"P",{});var ld=s(Yo);fi=d(ld,"Refer to superclass "),_r=r(ld,"A",{href:!0});var Nh=s(_r);_i=d(Nh,"RobertaTokenizer"),Nh.forEach(t),gi=d(ld," for usage examples and documentation concerning parameters."),ld.forEach(t),bi=c(pt),lt=r(pt,"DIV",{class:!0});var Pr=s(lt);k(Zo.$$.fragment,Pr),vi=c(Pr),Xr=r(Pr,"P",{});var Ah=s(Xr);yi=d(Ah,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Ah.forEach(t),ki=c(Pr),Yr=r(Pr,"UL",{});var Ih=s(Yr);gr=r(Ih,"LI",{});var ih=s(gr);Ti=d(ih,"single sequence: "),Zr=r(ih,"CODE",{});var Lh=s(Zr);wi=d(Lh,"X </s>"),Lh.forEach(t),ih.forEach(t),Ih.forEach(t),Pr.forEach(t),pt.forEach(t),Ia=c(o),Ct=r(o,"H2",{class:!0});var cd=s(Ct);Zt=r(cd,"A",{id:!0,class:!0,href:!0});var Sh=s(Zt);es=r(Sh,"SPAN",{});var Dh=s(es);k(en.$$.fragment,Dh),Dh.forEach(t),Sh.forEach(t),$i=c(cd),ts=r(cd,"SPAN",{});var Gh=s(ts);xi=d(Gh,"BlenderbotTokenizerFast"),Gh.forEach(t),cd.forEach(t),La=c(o),ve=r(o,"DIV",{class:!0});var ht=s(ve);k(tn.$$.fragment,ht),Bi=c(ht),on=r(ht,"P",{});var pd=s(on);Fi=d(pd,"Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),os=r(pd,"EM",{});var Wh=s(os);zi=d(Wh,"tokenizers"),Wh.forEach(t),qi=d(pd," library)."),pd.forEach(t),Ei=c(ht),eo=r(ht,"P",{});var Ma=s(eo);ns=r(Ma,"CODE",{});var Uh=s(ns);Mi=d(Uh,"BlenderbotFast"),Uh.forEach(t),Ci=d(Ma," is nearly identical to "),br=r(Ma,"A",{href:!0});var Rh=s(br);ji=d(Rh,"RobertaTokenizerFast"),Rh.forEach(t),Oi=d(Ma,` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Ma.forEach(t),Pi=c(ht),nn=r(ht,"P",{});var hd=s(nn);Ni=d(hd,"Refer to superclass "),vr=r(hd,"A",{href:!0});var Hh=s(vr);Ai=d(Hh,"RobertaTokenizerFast"),Hh.forEach(t),Ii=d(hd," for usage examples and documentation concerning parameters."),hd.forEach(t),Li=c(ht),ct=r(ht,"DIV",{class:!0});var Nr=s(ct);k(rn.$$.fragment,Nr),Si=c(Nr),rs=r(Nr,"P",{});var Vh=s(rs);Di=d(Vh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Vh.forEach(t),Gi=c(Nr),ss=r(Nr,"UL",{});var Kh=s(ss);yr=r(Kh,"LI",{});var lh=s(yr);Wi=d(lh,"single sequence: "),as=r(lh,"CODE",{});var Jh=s(as);Ui=d(Jh,"X </s>"),Jh.forEach(t),lh.forEach(t),Kh.forEach(t),Nr.forEach(t),ht.forEach(t),Sa=c(o),jt=r(o,"H2",{class:!0});var ud=s(jt);to=r(ud,"A",{id:!0,class:!0,href:!0});var Qh=s(to);ds=r(Qh,"SPAN",{});var Xh=s(ds);k(sn.$$.fragment,Xh),Xh.forEach(t),Qh.forEach(t),Ri=c(ud),is=r(ud,"SPAN",{});var Yh=s(is);Hi=d(Yh,"BlenderbotModel"),Yh.forEach(t),ud.forEach(t),Da=c(o),nt=r(o,"P",{});var lr=s(nt);Vi=d(lr,"See "),ls=r(lr,"CODE",{});var Zh=s(ls);Ki=d(Zh,"transformers.BartModel"),Zh.forEach(t),Ji=d(lr," for arguments to "),cs=r(lr,"EM",{});var eu=s(cs);Qi=d(eu,"forward"),eu.forEach(t),Xi=d(lr," and "),ps=r(lr,"EM",{});var tu=s(ps);Yi=d(tu,"generate"),tu.forEach(t),lr.forEach(t),Ga=c(o),Ae=r(o,"DIV",{class:!0});var No=s(Ae);k(an.$$.fragment,No),Zi=c(No),dn=r(No,"P",{});var md=s(dn);el=d(md,`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
This model inherits from `),kr=r(md,"A",{href:!0});var ou=s(kr);tl=d(ou,"PreTrainedModel"),ou.forEach(t),ol=d(md,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fd.forEach(t),dl=c(No),Ue=r(No,"DIV",{class:!0});var Ao=s(Ue);k(pn.$$.fragment,Ao),il=c(Ao),Ot=r(Ao,"P",{});var Ar=s(Ot);ll=d(Ar,"The "),Tr=r(Ar,"A",{href:!0});var ru=s(Tr);cl=d(ru,"BlenderbotModel"),ru.forEach(t),pl=d(Ar," forward method, overrides the "),hs=r(Ar,"CODE",{});var su=s(hs);hl=d(su,"__call__"),su.forEach(t),ul=d(Ar," special method."),Ar.forEach(t),ml=c(Ao),k(oo.$$.fragment,Ao),fl=c(Ao),k(no.$$.fragment,Ao),Ao.forEach(t),No.forEach(t),Wa=c(o),Pt=r(o,"H2",{class:!0});var _d=s(Pt);ro=r(_d,"A",{id:!0,class:!0,href:!0});var au=s(ro);us=r(au,"SPAN",{});var du=s(us);k(hn.$$.fragment,du),du.forEach(t),au.forEach(t),_l=c(_d),ms=r(_d,"SPAN",{});var iu=s(ms);gl=d(iu,"BlenderbotForConditionalGeneration"),iu.forEach(t),_d.forEach(t),Ua=c(o),rt=r(o,"P",{});var cr=s(rt);bl=d(cr,"See "),wr=r(cr,"A",{href:!0});var lu=s(wr);vl=d(lu,"BartForConditionalGeneration"),lu.forEach(t),yl=d(cr," for arguments to "),fs=r(cr,"EM",{});var cu=s(fs);kl=d(cu,"forward"),cu.forEach(t),Tl=d(cr," and "),_s=r(cr,"EM",{});var pu=s(_s);wl=d(pu,"generate"),pu.forEach(t),cr.forEach(t),Ra=c(o),Ie=r(o,"DIV",{class:!0});var Io=s(Ie);k(un.$$.fragment,Io),$l=c(Io),mn=r(Io,"P",{});var gd=s(mn);xl=d(gd,`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),$r=r(gd,"A",{href:!0});var hu=s($r);Bl=d(hu,"PreTrainedModel"),hu.forEach(t),Fl=d(gd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gd.forEach(t),zl=c(Io),fn=r(Io,"P",{});var bd=s(fn);ql=d(bd,"This model is also a PyTorch "),_n=r(bd,"A",{href:!0,rel:!0});var uu=s(_n);El=d(uu,"torch.nn.Module"),uu.forEach(t),Ml=d(bd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bd.forEach(t),Cl=c(Io),Re=r(Io,"DIV",{class:!0});var Lo=s(Re);k(gn.$$.fragment,Lo),jl=c(Lo),Nt=r(Lo,"P",{});var Ir=s(Nt);Ol=d(Ir,"The "),xr=r(Ir,"A",{href:!0});var mu=s(xr);Pl=d(mu,"BlenderbotForConditionalGeneration"),mu.forEach(t),Nl=d(Ir," forward method, overrides the "),gs=r(Ir,"CODE",{});var fu=s(gs);Al=d(fu,"__call__"),fu.forEach(t),Il=d(Ir," special method."),Ir.forEach(t),Ll=c(Lo),k(so.$$.fragment,Lo),Sl=c(Lo),k(ao.$$.fragment,Lo),Lo.forEach(t),Io.forEach(t),Ha=c(o),At=r(o,"H2",{class:!0});var vd=s(At);io=r(vd,"A",{id:!0,class:!0,href:!0});var _u=s(io);bs=r(_u,"SPAN",{});var gu=s(bs);k(bn.$$.fragment,gu),gu.forEach(t),_u.forEach(t),Dl=c(vd),vs=r(vd,"SPAN",{});var bu=s(vs);Gl=d(bu,"BlenderbotForCausalLM"),bu.forEach(t),vd.forEach(t),Va=c(o),It=r(o,"DIV",{class:!0});var yd=s(It);k(vn.$$.fragment,yd),Wl=c(yd),lo=r(yd,"DIV",{class:!0});var kd=s(lo);k(yn.$$.fragment,kd),Ul=c(kd),k(co.$$.fragment,kd),kd.forEach(t),yd.forEach(t),Ka=c(o),Lt=r(o,"H2",{class:!0});var Td=s(Lt);po=r(Td,"A",{id:!0,class:!0,href:!0});var vu=s(po);ys=r(vu,"SPAN",{});var yu=s(ys);k(kn.$$.fragment,yu),yu.forEach(t),vu.forEach(t),Rl=c(Td),ks=r(Td,"SPAN",{});var ku=s(ks);Hl=d(ku,"TFBlenderbotModel"),ku.forEach(t),Td.forEach(t),Ja=c(o),ye=r(o,"DIV",{class:!0});var ut=s(ye);k(Tn.$$.fragment,ut),Vl=c(ut),wn=r(ut,"P",{});var wd=s(wn);Kl=d(wd,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Br=r(wd,"A",{href:!0});var Tu=s(Br);Jl=d(Tu,"TFPreTrainedModel"),Tu.forEach(t),Ql=d(wd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wd.forEach(t),Xl=c(ut),$n=r(ut,"P",{});var $d=s($n);Yl=d($d,"This model is also a "),xn=r($d,"A",{href:!0,rel:!0});var wu=s(xn);Zl=d(wu,"tf.keras.Model"),wu.forEach(t),ec=d($d,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$d.forEach(t),tc=c(ut),k(ho.$$.fragment,ut),oc=c(ut),He=r(ut,"DIV",{class:!0});var So=s(He);k(Bn.$$.fragment,So),nc=c(So),St=r(So,"P",{});var Lr=s(St);rc=d(Lr,"The "),Fr=r(Lr,"A",{href:!0});var $u=s(Fr);sc=d($u,"TFBlenderbotModel"),$u.forEach(t),ac=d(Lr," forward method, overrides the "),Ts=r(Lr,"CODE",{});var xu=s(Ts);dc=d(xu,"__call__"),xu.forEach(t),ic=d(Lr," special method."),Lr.forEach(t),lc=c(So),k(uo.$$.fragment,So),cc=c(So),k(mo.$$.fragment,So),So.forEach(t),ut.forEach(t),Qa=c(o),Dt=r(o,"H2",{class:!0});var xd=s(Dt);fo=r(xd,"A",{id:!0,class:!0,href:!0});var Bu=s(fo);ws=r(Bu,"SPAN",{});var Fu=s(ws);k(Fn.$$.fragment,Fu),Fu.forEach(t),Bu.forEach(t),pc=c(xd),$s=r(xd,"SPAN",{});var zu=s($s);hc=d(zu,"TFBlenderbotForConditionalGeneration"),zu.forEach(t),xd.forEach(t),Xa=c(o),ke=r(o,"DIV",{class:!0});var mt=s(ke);k(zn.$$.fragment,mt),uc=c(mt),qn=r(mt,"P",{});var Bd=s(qn);mc=d(Bd,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
This model inherits from `),zr=r(Bd,"A",{href:!0});var qu=s(zr);fc=d(qu,"TFPreTrainedModel"),qu.forEach(t),_c=d(Bd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bd.forEach(t),gc=c(mt),En=r(mt,"P",{});var Fd=s(En);bc=d(Fd,"This model is also a "),Mn=r(Fd,"A",{href:!0,rel:!0});var Eu=s(Mn);vc=d(Eu,"tf.keras.Model"),Eu.forEach(t),yc=d(Fd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fd.forEach(t),kc=c(mt),k(_o.$$.fragment,mt),Tc=c(mt),oe=r(mt,"DIV",{class:!0});var Ke=s(oe);k(Cn.$$.fragment,Ke),wc=c(Ke),Gt=r(Ke,"P",{});var Sr=s(Gt);$c=d(Sr,"The "),qr=r(Sr,"A",{href:!0});var Mu=s(qr);xc=d(Mu,"TFBlenderbotForConditionalGeneration"),Mu.forEach(t),Bc=d(Sr," forward method, overrides the "),xs=r(Sr,"CODE",{});var Cu=s(xs);Fc=d(Cu,"__call__"),Cu.forEach(t),zc=d(Sr," special method."),Sr.forEach(t),qc=c(Ke),k(go.$$.fragment,Ke),Ec=c(Ke),Bs=r(Ke,"P",{});var ju=s(Bs);Mc=d(ju,"Conversation example::"),ju.forEach(t),Cc=c(Ke),Fs=r(Ke,"BLOCKQUOTE",{});var Ou=s(Fs);zs=r(Ou,"BLOCKQUOTE",{});var Pu=s(zs);qs=r(Pu,"BLOCKQUOTE",{});var Nu=s(qs);Es=r(Nu,"P",{});var Au=s(Es);jc=d(Au,`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
\u2018facebook/blenderbot-400M-distill\u2019 >>> model = TFBlenderbotForConditionalGeneration.from_pretrained(mname) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(mname) >>> UTTERANCE = \u201CMy friends are cool but they eat too
many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs = tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019) >>>
reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
skip_special_tokens=True)[0])`),Au.forEach(t),Nu.forEach(t),Pu.forEach(t),Ou.forEach(t),Oc=c(Ke),Ms=r(Ke,"BLOCKQUOTE",{});var Iu=s(Ms);Cs=r(Iu,"BLOCKQUOTE",{});var Lu=s(Cs);js=r(Lu,"BLOCKQUOTE",{});var Su=s(js);jn=r(Su,"P",{});var zd=s(jn);Pc=d(zd,`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
eat too many carbs.</s> `),Os=r(zd,"S",{});var Du=s(Os);Nc=d(Du,`That\u2019s unfortunate. \u201D \u2026 \u201CAre they trying to lose weight or are they just trying to
be healthier?`),Du.forEach(t),Ac=d(zd,` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),zd.forEach(t),Su.forEach(t),Lu.forEach(t),Iu.forEach(t),Ke.forEach(t),mt.forEach(t),Ya=c(o),Wt=r(o,"H2",{class:!0});var qd=s(Wt);bo=r(qd,"A",{id:!0,class:!0,href:!0});var Gu=s(bo);Ps=r(Gu,"SPAN",{});var Wu=s(Ps);k(On.$$.fragment,Wu),Wu.forEach(t),Gu.forEach(t),Ic=c(qd),Ns=r(qd,"SPAN",{});var Uu=s(Ns);Lc=d(Uu,"FlaxBlenderbotModel"),Uu.forEach(t),qd.forEach(t),Za=c(o),S=r(o,"DIV",{class:!0});var ne=s(S);k(Pn.$$.fragment,ne),Sc=c(ne),Nn=r(ne,"P",{});var Ed=s(Nn);Dc=d(Ed,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
`),In=r(Md,"A",{href:!0,rel:!0});var Hu=s(In);Hc=d(Hu,"flax.nn.Module"),Hu.forEach(t),Vc=d(Md,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Md.forEach(t),Kc=c(ne),As=r(ne,"P",{});var Vu=s(As);Jc=d(Vu,"Finally, this model supports inherent JAX features such as:"),Vu.forEach(t),Qc=c(ne),st=r(ne,"UL",{});var Do=s(st);Is=r(Do,"LI",{});var Ku=s(Is);Ln=r(Ku,"A",{href:!0,rel:!0});var Ju=s(Ln);Xc=d(Ju,"Just-In-Time (JIT) compilation"),Ju.forEach(t),Ku.forEach(t),Yc=c(Do),Ls=r(Do,"LI",{});var Qu=s(Ls);Sn=r(Qu,"A",{href:!0,rel:!0});var Xu=s(Sn);Zc=d(Xu,"Automatic Differentiation"),Xu.forEach(t),Qu.forEach(t),ep=c(Do),Ss=r(Do,"LI",{});var Yu=s(Ss);Dn=r(Yu,"A",{href:!0,rel:!0});var Zu=s(Dn);tp=d(Zu,"Vectorization"),Zu.forEach(t),Yu.forEach(t),op=c(Do),Ds=r(Do,"LI",{});var em=s(Ds);Gn=r(em,"A",{href:!0,rel:!0});var tm=s(Gn);np=d(tm,"Parallelization"),tm.forEach(t),em.forEach(t),Do.forEach(t),rp=c(ne),Ve=r(ne,"DIV",{class:!0});var Go=s(Ve);k(Wn.$$.fragment,Go),sp=c(Go),Ut=r(Go,"P",{});var Dr=s(Ut);ap=d(Dr,"The "),Gs=r(Dr,"CODE",{});var om=s(Gs);dp=d(om,"FlaxBlenderbotPreTrainedModel"),om.forEach(t),ip=d(Dr," forward method, overrides the "),Ws=r(Dr,"CODE",{});var nm=s(Ws);lp=d(nm,"__call__"),nm.forEach(t),cp=d(Dr," special method."),Dr.forEach(t),pp=c(Go),k(vo.$$.fragment,Go),hp=c(Go),k(yo.$$.fragment,Go),Go.forEach(t),up=c(ne),ko=r(ne,"DIV",{class:!0});var Cd=s(ko);k(Un.$$.fragment,Cd),mp=c(Cd),k(To.$$.fragment,Cd),Cd.forEach(t),fp=c(ne),wo=r(ne,"DIV",{class:!0});var jd=s(wo);k(Rn.$$.fragment,jd),_p=c(jd),k($o.$$.fragment,jd),jd.forEach(t),ne.forEach(t),ed=c(o),Rt=r(o,"H2",{class:!0});var Od=s(Rt);xo=r(Od,"A",{id:!0,class:!0,href:!0});var rm=s(xo);Us=r(rm,"SPAN",{});var sm=s(Us);k(Hn.$$.fragment,sm),sm.forEach(t),rm.forEach(t),gp=c(Od),Rs=r(Od,"SPAN",{});var am=s(Rs);bp=d(am,"FlaxBlenderbotForConditionalGeneration"),am.forEach(t),Od.forEach(t),td=c(o),D=r(o,"DIV",{class:!0});var re=s(D);k(Vn.$$.fragment,re),vp=c(re),Kn=r(re,"P",{});var Pd=s(Kn);yp=d(Pd,`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mr=r(Pd,"A",{href:!0});var dm=s(Mr);kp=d(dm,"FlaxPreTrainedModel"),dm.forEach(t),Tp=d(Pd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pd.forEach(t),wp=c(re),Jn=r(re,"P",{});var Nd=s(Jn);$p=d(Nd,`This model is also a Flax Linen
`),Qn=r(Nd,"A",{href:!0,rel:!0});var im=s(Qn);xp=d(im,"flax.nn.Module"),im.forEach(t),Bp=d(Nd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Nd.forEach(t),Fp=c(re),Hs=r(re,"P",{});var lm=s(Hs);zp=d(lm,"Finally, this model supports inherent JAX features such as:"),lm.forEach(t),qp=c(re),at=r(re,"UL",{});var Wo=s(at);Vs=r(Wo,"LI",{});var cm=s(Vs);Xn=r(cm,"A",{href:!0,rel:!0});var pm=s(Xn);Ep=d(pm,"Just-In-Time (JIT) compilation"),pm.forEach(t),cm.forEach(t),Mp=c(Wo),Ks=r(Wo,"LI",{});var hm=s(Ks);Yn=r(hm,"A",{href:!0,rel:!0});var um=s(Yn);Cp=d(um,"Automatic Differentiation"),um.forEach(t),hm.forEach(t),jp=c(Wo),Js=r(Wo,"LI",{});var mm=s(Js);Zn=r(mm,"A",{href:!0,rel:!0});var fm=s(Zn);Op=d(fm,"Vectorization"),fm.forEach(t),mm.forEach(t),Pp=c(Wo),Qs=r(Wo,"LI",{});var _m=s(Qs);er=r(_m,"A",{href:!0,rel:!0});var gm=s(er);Np=d(gm,"Parallelization"),gm.forEach(t),_m.forEach(t),Wo.forEach(t),Ap=c(re),W=r(re,"DIV",{class:!0});var se=s(W);k(tr.$$.fragment,se),Ip=c(se),Ht=r(se,"P",{});var Gr=s(Ht);Lp=d(Gr,"The "),Xs=r(Gr,"CODE",{});var bm=s(Xs);Sp=d(bm,"FlaxBlenderbotPreTrainedModel"),bm.forEach(t),Dp=d(Gr," forward method, overrides the "),Ys=r(Gr,"CODE",{});var vm=s(Ys);Gp=d(vm,"__call__"),vm.forEach(t),Wp=d(Gr," special method."),Gr.forEach(t),Up=c(se),k(Bo.$$.fragment,se),Rp=c(se),Zs=r(se,"P",{});var ym=s(Zs);Hp=d(ym,"Conversation example::"),ym.forEach(t),Vp=c(se),ea=r(se,"BLOCKQUOTE",{});var km=s(ea);ta=r(km,"BLOCKQUOTE",{});var Tm=s(ta);oa=r(Tm,"BLOCKQUOTE",{});var wm=s(oa);na=r(wm,"P",{});var $m=s(na);Kp=d($m,"from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),$m.forEach(t),wm.forEach(t),Tm.forEach(t),km.forEach(t),Jp=c(se),ra=r(se,"BLOCKQUOTE",{});var xm=s(ra);sa=r(xm,"BLOCKQUOTE",{});var Bm=s(sa);aa=r(Bm,"BLOCKQUOTE",{});var Fm=s(aa);da=r(Fm,"P",{});var zm=s(da);Qp=d(zm,`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019)`),zm.forEach(t),Fm.forEach(t),Bm.forEach(t),xm.forEach(t),Xp=c(se),ia=r(se,"BLOCKQUOTE",{});var qm=s(ia);la=r(qm,"BLOCKQUOTE",{});var Em=s(la);ca=r(Em,"BLOCKQUOTE",{});var Mm=s(ca);pa=r(Mm,"P",{});var Cm=s(pa);Yp=d(Cm,`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs = tokenizer([UTTERANCE],
max_length=1024, return_tensors=\u2018np\u2019)`),Cm.forEach(t),Mm.forEach(t),Em.forEach(t),qm.forEach(t),Zp=c(se),ha=r(se,"BLOCKQUOTE",{});var jm=s(ha);ua=r(jm,"BLOCKQUOTE",{});var Om=s(ua);or=r(Om,"BLOCKQUOTE",{});var Ad=s(or);Fo=r(Ad,"H1",{class:!0});var Id=s(Fo);zo=r(Id,"A",{id:!0,class:!0,href:!0});var Pm=s(zo);ma=r(Pm,"SPAN",{});var Nm=s(ma);k(nr.$$.fragment,Nm),Nm.forEach(t),Pm.forEach(t),eh=c(Id),fa=r(Id,"SPAN",{});var Am=s(fa);th=d(Am,"Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),Am.forEach(t),Id.forEach(t),oh=c(Ad),_a=r(Ad,"P",{});var Im=s(_a);nh=d(Im,`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),Im.forEach(t),Ad.forEach(t),Om.forEach(t),jm.forEach(t),se.forEach(t),rh=c(re),qo=r(re,"DIV",{class:!0});var Ld=s(qo);k(rr.$$.fragment,Ld),sh=c(Ld),k(Eo.$$.fragment,Ld),Ld.forEach(t),ah=c(re),Mo=r(re,"DIV",{class:!0});var Sd=s(Mo);k(sr.$$.fragment,Sd),dh=c(Sd),k(Co.$$.fragment,Sd),Sd.forEach(t),re.forEach(t),this.h()},h(){h(p,"name","hf:doc:metadata"),h(p,"content",JSON.stringify(cf)),h(m,"id","blenderbot"),h(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(m,"href","#blenderbot"),h(g,"class","relative group"),h(ae,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),h(ae,"rel","nofollow"),h(Y,"id","overview"),h(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Y,"href","#overview"),h(I,"class","relative group"),h(ce,"href","https://arxiv.org/pdf/2004.13637.pdf"),h(ce,"rel","nofollow"),h(he,"href","https://huggingface.co/sshleifer"),h(he,"rel","nofollow"),h(me,"href","https://github.com/facebookresearch/ParlAI"),h(me,"rel","nofollow"),h(te,"id","implementation-notes"),h(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(te,"href","#implementation-notes"),h(O,"class","relative group"),h(q,"href","https://arxiv.org/pdf/1706.03762.pdf"),h(q,"rel","nofollow"),h(Oe,"href","https://huggingface.co/models?search=blenderbot"),h(Oe,"rel","nofollow"),h($e,"href","blenderbot-small"),h(Kt,"id","usage"),h(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Kt,"href","#usage"),h(Ft,"class","relative group"),h(Jt,"id","transformers.BlenderbotConfig"),h(Jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Jt,"href","#transformers.BlenderbotConfig"),h(zt,"class","relative group"),h(hr,"href","/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.BlenderbotModel"),h(Jo,"href","https://huggingface.co/facebook/blenderbot-3B"),h(Jo,"rel","nofollow"),h(ur,"href","/docs/transformers/v4.22.1/en/main_classes/configuration#transformers.PretrainedConfig"),h(mr,"href","/docs/transformers/v4.22.1/en/main_classes/configuration#transformers.PretrainedConfig"),h(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Xt,"id","transformers.BlenderbotTokenizer"),h(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Xt,"href","#transformers.BlenderbotTokenizer"),h(Mt,"class","relative group"),h(fr,"href","/docs/transformers/v4.22.1/en/model_doc/roberta#transformers.RobertaTokenizer"),h(_r,"href","/docs/transformers/v4.22.1/en/model_doc/roberta#transformers.RobertaTokenizer"),h(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Zt,"id","transformers.BlenderbotTokenizerFast"),h(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Zt,"href","#transformers.BlenderbotTokenizerFast"),h(Ct,"class","relative group"),h(br,"href","/docs/transformers/v4.22.1/en/model_doc/roberta#transformers.RobertaTokenizerFast"),h(vr,"href","/docs/transformers/v4.22.1/en/model_doc/roberta#transformers.RobertaTokenizerFast"),h(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(to,"id","transformers.BlenderbotModel"),h(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(to,"href","#transformers.BlenderbotModel"),h(jt,"class","relative group"),h(kr,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel"),h(cn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(cn,"rel","nofollow"),h(Tr,"href","/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.BlenderbotModel"),h(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ro,"id","transformers.BlenderbotForConditionalGeneration"),h(ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ro,"href","#transformers.BlenderbotForConditionalGeneration"),h(Pt,"class","relative group"),h(wr,"href","/docs/transformers/v4.22.1/en/model_doc/bart#transformers.BartForConditionalGeneration"),h($r,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel"),h(_n,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(_n,"rel","nofollow"),h(xr,"href","/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.BlenderbotForConditionalGeneration"),h(Re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(io,"id","transformers.BlenderbotForCausalLM"),h(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(io,"href","#transformers.BlenderbotForCausalLM"),h(At,"class","relative group"),h(lo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(It,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(po,"id","transformers.TFBlenderbotModel"),h(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(po,"href","#transformers.TFBlenderbotModel"),h(Lt,"class","relative group"),h(Br,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.TFPreTrainedModel"),h(xn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(xn,"rel","nofollow"),h(Fr,"href","/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.TFBlenderbotModel"),h(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(fo,"id","transformers.TFBlenderbotForConditionalGeneration"),h(fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(fo,"href","#transformers.TFBlenderbotForConditionalGeneration"),h(Dt,"class","relative group"),h(zr,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.TFPreTrainedModel"),h(Mn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Mn,"rel","nofollow"),h(qr,"href","/docs/transformers/v4.22.1/en/model_doc/blenderbot#transformers.TFBlenderbotForConditionalGeneration"),h(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(bo,"id","transformers.FlaxBlenderbotModel"),h(bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(bo,"href","#transformers.FlaxBlenderbotModel"),h(Wt,"class","relative group"),h(Er,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(In,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),h(In,"rel","nofollow"),h(Ln,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),h(Ln,"rel","nofollow"),h(Sn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),h(Sn,"rel","nofollow"),h(Dn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),h(Dn,"rel","nofollow"),h(Gn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),h(Gn,"rel","nofollow"),h(Ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ko,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(wo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(xo,"id","transformers.FlaxBlenderbotForConditionalGeneration"),h(xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(xo,"href","#transformers.FlaxBlenderbotForConditionalGeneration"),h(Rt,"class","relative group"),h(Mr,"href","/docs/transformers/v4.22.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(Qn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),h(Qn,"rel","nofollow"),h(Xn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),h(Xn,"rel","nofollow"),h(Yn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),h(Yn,"rel","nofollow"),h(Zn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),h(Zn,"rel","nofollow"),h(er,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),h(er,"rel","nofollow"),h(zo,"id","generate-reply->>>-reply_ids-=-model.generate(inputs[\u2018input_ids\u2019],-num_beams=4,-max_length=5,"),h(zo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(zo,"href","#generate-reply->>>-reply_ids-=-model.generate(inputs[\u2018input_ids\u2019],-num_beams=4,-max_length=5,"),h(Fo,"class","relative group"),h(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(qo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Mo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,p),f(o,v,_),f(o,g,_),e(g,m),e(m,b),T(i,b,null),e(g,u),e(g,E),e(E,Je),f(o,Le,_),f(o,A,_),e(A,xe),e(xe,Be),e(A,z),e(A,ae),e(ae,de),e(A,Qe),f(o,Se,_),f(o,I,_),e(I,Y),e(Y,Fe),T(U,Fe,null),e(I,Xe),e(I,ze),e(ze,ie),f(o,De,_),f(o,Z,_),e(Z,le),e(Z,ce),e(ce,Ye),e(Z,qe),f(o,C,_),f(o,j,_),e(j,Ze),f(o,ee,_),f(o,we,_),e(we,Ee),e(Ee,pe),f(o,Ge,_),f(o,R,_),e(R,L),e(R,he),e(he,ue),e(R,et),e(R,me),e(me,fe),e(R,tt),f(o,We,_),f(o,O,_),e(O,te),e(te,V),T(_e,V,null),e(O,Me),e(O,P),e(P,ot),f(o,G,_),f(o,H,_),e(H,ge),e(ge,B),e(ge,q),e(q,gt),e(ge,Ce),e(H,bt),e(H,je),e(je,M),e(je,Oe),e(Oe,vt),e(je,yt),e(H,kt),e(H,K),e(K,J),e(K,Q),e(Q,Tt),e(K,wt),e(K,X),e(X,$t),e(K,xt),e(K,$e),e($e,Bt),e(K,Pe),f(o,it,_),f(o,Ft,_),e(Ft,Kt),e(Kt,Wr),T(Ro,Wr,null),e(Ft,Dd),e(Ft,Ur),e(Ur,Gd),f(o,Ca,_),f(o,pr,_),e(pr,Wd),f(o,ja,_),T(Ho,o,_),f(o,Oa,_),f(o,zt,_),e(zt,Jt),e(Jt,Rr),T(Vo,Rr,null),e(zt,Ud),e(zt,Hr),e(Hr,Rd),f(o,Pa,_),f(o,Ne,_),T(Ko,Ne,null),e(Ne,Hd),e(Ne,qt),e(qt,Vd),e(qt,hr),e(hr,Kd),e(qt,Jd),e(qt,Jo),e(Jo,Qd),e(qt,Xd),e(Ne,Yd),e(Ne,Et),e(Et,Zd),e(Et,ur),e(ur,ei),e(Et,ti),e(Et,mr),e(mr,oi),e(Et,ni),e(Ne,ri),T(Qt,Ne,null),f(o,Na,_),f(o,Mt,_),e(Mt,Xt),e(Xt,Vr),T(Qo,Vr,null),e(Mt,si),e(Mt,Kr),e(Kr,ai),f(o,Aa,_),f(o,be,_),T(Xo,be,null),e(be,di),e(be,Jr),e(Jr,ii),e(be,li),e(be,Yt),e(Yt,Qr),e(Qr,ci),e(Yt,pi),e(Yt,fr),e(fr,hi),e(Yt,ui),e(be,mi),e(be,Yo),e(Yo,fi),e(Yo,_r),e(_r,_i),e(Yo,gi),e(be,bi),e(be,lt),T(Zo,lt,null),e(lt,vi),e(lt,Xr),e(Xr,yi),e(lt,ki),e(lt,Yr),e(Yr,gr),e(gr,Ti),e(gr,Zr),e(Zr,wi),f(o,Ia,_),f(o,Ct,_),e(Ct,Zt),e(Zt,es),T(en,es,null),e(Ct,$i),e(Ct,ts),e(ts,xi),f(o,La,_),f(o,ve,_),T(tn,ve,null),e(ve,Bi),e(ve,on),e(on,Fi),e(on,os),e(os,zi),e(on,qi),e(ve,Ei),e(ve,eo),e(eo,ns),e(ns,Mi),e(eo,Ci),e(eo,br),e(br,ji),e(eo,Oi),e(ve,Pi),e(ve,nn),e(nn,Ni),e(nn,vr),e(vr,Ai),e(nn,Ii),e(ve,Li),e(ve,ct),T(rn,ct,null),e(ct,Si),e(ct,rs),e(rs,Di),e(ct,Gi),e(ct,ss),e(ss,yr),e(yr,Wi),e(yr,as),e(as,Ui),f(o,Sa,_),f(o,jt,_),e(jt,to),e(to,ds),T(sn,ds,null),e(jt,Ri),e(jt,is),e(is,Hi),f(o,Da,_),f(o,nt,_),e(nt,Vi),e(nt,ls),e(ls,Ki),e(nt,Ji),e(nt,cs),e(cs,Qi),e(nt,Xi),e(nt,ps),e(ps,Yi),f(o,Ga,_),f(o,Ae,_),T(an,Ae,null),e(Ae,Zi),e(Ae,dn),e(dn,el),e(dn,kr),e(kr,tl),e(dn,ol),e(Ae,nl),e(Ae,ln),e(ln,rl),e(ln,cn),e(cn,sl),e(ln,al),e(Ae,dl),e(Ae,Ue),T(pn,Ue,null),e(Ue,il),e(Ue,Ot),e(Ot,ll),e(Ot,Tr),e(Tr,cl),e(Ot,pl),e(Ot,hs),e(hs,hl),e(Ot,ul),e(Ue,ml),T(oo,Ue,null),e(Ue,fl),T(no,Ue,null),f(o,Wa,_),f(o,Pt,_),e(Pt,ro),e(ro,us),T(hn,us,null),e(Pt,_l),e(Pt,ms),e(ms,gl),f(o,Ua,_),f(o,rt,_),e(rt,bl),e(rt,wr),e(wr,vl),e(rt,yl),e(rt,fs),e(fs,kl),e(rt,Tl),e(rt,_s),e(_s,wl),f(o,Ra,_),f(o,Ie,_),T(un,Ie,null),e(Ie,$l),e(Ie,mn),e(mn,xl),e(mn,$r),e($r,Bl),e(mn,Fl),e(Ie,zl),e(Ie,fn),e(fn,ql),e(fn,_n),e(_n,El),e(fn,Ml),e(Ie,Cl),e(Ie,Re),T(gn,Re,null),e(Re,jl),e(Re,Nt),e(Nt,Ol),e(Nt,xr),e(xr,Pl),e(Nt,Nl),e(Nt,gs),e(gs,Al),e(Nt,Il),e(Re,Ll),T(so,Re,null),e(Re,Sl),T(ao,Re,null),f(o,Ha,_),f(o,At,_),e(At,io),e(io,bs),T(bn,bs,null),e(At,Dl),e(At,vs),e(vs,Gl),f(o,Va,_),f(o,It,_),T(vn,It,null),e(It,Wl),e(It,lo),T(yn,lo,null),e(lo,Ul),T(co,lo,null),f(o,Ka,_),f(o,Lt,_),e(Lt,po),e(po,ys),T(kn,ys,null),e(Lt,Rl),e(Lt,ks),e(ks,Hl),f(o,Ja,_),f(o,ye,_),T(Tn,ye,null),e(ye,Vl),e(ye,wn),e(wn,Kl),e(wn,Br),e(Br,Jl),e(wn,Ql),e(ye,Xl),e(ye,$n),e($n,Yl),e($n,xn),e(xn,Zl),e($n,ec),e(ye,tc),T(ho,ye,null),e(ye,oc),e(ye,He),T(Bn,He,null),e(He,nc),e(He,St),e(St,rc),e(St,Fr),e(Fr,sc),e(St,ac),e(St,Ts),e(Ts,dc),e(St,ic),e(He,lc),T(uo,He,null),e(He,cc),T(mo,He,null),f(o,Qa,_),f(o,Dt,_),e(Dt,fo),e(fo,ws),T(Fn,ws,null),e(Dt,pc),e(Dt,$s),e($s,hc),f(o,Xa,_),f(o,ke,_),T(zn,ke,null),e(ke,uc),e(ke,qn),e(qn,mc),e(qn,zr),e(zr,fc),e(qn,_c),e(ke,gc),e(ke,En),e(En,bc),e(En,Mn),e(Mn,vc),e(En,yc),e(ke,kc),T(_o,ke,null),e(ke,Tc),e(ke,oe),T(Cn,oe,null),e(oe,wc),e(oe,Gt),e(Gt,$c),e(Gt,qr),e(qr,xc),e(Gt,Bc),e(Gt,xs),e(xs,Fc),e(Gt,zc),e(oe,qc),T(go,oe,null),e(oe,Ec),e(oe,Bs),e(Bs,Mc),e(oe,Cc),e(oe,Fs),e(Fs,zs),e(zs,qs),e(qs,Es),e(Es,jc),e(oe,Oc),e(oe,Ms),e(Ms,Cs),e(Cs,js),e(js,jn),e(jn,Pc),e(jn,Os),e(Os,Nc),e(jn,Ac),f(o,Ya,_),f(o,Wt,_),e(Wt,bo),e(bo,Ps),T(On,Ps,null),e(Wt,Ic),e(Wt,Ns),e(Ns,Lc),f(o,Za,_),f(o,S,_),T(Pn,S,null),e(S,Sc),e(S,Nn),e(Nn,Dc),e(Nn,Er),e(Er,Gc),e(Nn,Wc),e(S,Uc),e(S,An),e(An,Rc),e(An,In),e(In,Hc),e(An,Vc),e(S,Kc),e(S,As),e(As,Jc),e(S,Qc),e(S,st),e(st,Is),e(Is,Ln),e(Ln,Xc),e(st,Yc),e(st,Ls),e(Ls,Sn),e(Sn,Zc),e(st,ep),e(st,Ss),e(Ss,Dn),e(Dn,tp),e(st,op),e(st,Ds),e(Ds,Gn),e(Gn,np),e(S,rp),e(S,Ve),T(Wn,Ve,null),e(Ve,sp),e(Ve,Ut),e(Ut,ap),e(Ut,Gs),e(Gs,dp),e(Ut,ip),e(Ut,Ws),e(Ws,lp),e(Ut,cp),e(Ve,pp),T(vo,Ve,null),e(Ve,hp),T(yo,Ve,null),e(S,up),e(S,ko),T(Un,ko,null),e(ko,mp),T(To,ko,null),e(S,fp),e(S,wo),T(Rn,wo,null),e(wo,_p),T($o,wo,null),f(o,ed,_),f(o,Rt,_),e(Rt,xo),e(xo,Us),T(Hn,Us,null),e(Rt,gp),e(Rt,Rs),e(Rs,bp),f(o,td,_),f(o,D,_),T(Vn,D,null),e(D,vp),e(D,Kn),e(Kn,yp),e(Kn,Mr),e(Mr,kp),e(Kn,Tp),e(D,wp),e(D,Jn),e(Jn,$p),e(Jn,Qn),e(Qn,xp),e(Jn,Bp),e(D,Fp),e(D,Hs),e(Hs,zp),e(D,qp),e(D,at),e(at,Vs),e(Vs,Xn),e(Xn,Ep),e(at,Mp),e(at,Ks),e(Ks,Yn),e(Yn,Cp),e(at,jp),e(at,Js),e(Js,Zn),e(Zn,Op),e(at,Pp),e(at,Qs),e(Qs,er),e(er,Np),e(D,Ap),e(D,W),T(tr,W,null),e(W,Ip),e(W,Ht),e(Ht,Lp),e(Ht,Xs),e(Xs,Sp),e(Ht,Dp),e(Ht,Ys),e(Ys,Gp),e(Ht,Wp),e(W,Up),T(Bo,W,null),e(W,Rp),e(W,Zs),e(Zs,Hp),e(W,Vp),e(W,ea),e(ea,ta),e(ta,oa),e(oa,na),e(na,Kp),e(W,Jp),e(W,ra),e(ra,sa),e(sa,aa),e(aa,da),e(da,Qp),e(W,Xp),e(W,ia),e(ia,la),e(la,ca),e(ca,pa),e(pa,Yp),e(W,Zp),e(W,ha),e(ha,ua),e(ua,or),e(or,Fo),e(Fo,zo),e(zo,ma),T(nr,ma,null),e(Fo,eh),e(Fo,fa),e(fa,th),e(or,oh),e(or,_a),e(_a,nh),e(D,rh),e(D,qo),T(rr,qo,null),e(qo,sh),T(Eo,qo,null),e(D,ah),e(D,Mo),T(sr,Mo,null),e(Mo,dh),T(Co,Mo,null),od=!0},p(o,[_]){const ar={};_&2&&(ar.$$scope={dirty:_,ctx:o}),Qt.$set(ar);const ga={};_&2&&(ga.$$scope={dirty:_,ctx:o}),oo.$set(ga);const ba={};_&2&&(ba.$$scope={dirty:_,ctx:o}),no.$set(ba);const va={};_&2&&(va.$$scope={dirty:_,ctx:o}),so.$set(va);const jo={};_&2&&(jo.$$scope={dirty:_,ctx:o}),ao.$set(jo);const ya={};_&2&&(ya.$$scope={dirty:_,ctx:o}),co.$set(ya);const ka={};_&2&&(ka.$$scope={dirty:_,ctx:o}),ho.$set(ka);const dr={};_&2&&(dr.$$scope={dirty:_,ctx:o}),uo.$set(dr);const Ta={};_&2&&(Ta.$$scope={dirty:_,ctx:o}),mo.$set(Ta);const wa={};_&2&&(wa.$$scope={dirty:_,ctx:o}),_o.$set(wa);const $a={};_&2&&($a.$$scope={dirty:_,ctx:o}),go.$set($a);const ir={};_&2&&(ir.$$scope={dirty:_,ctx:o}),vo.$set(ir);const xa={};_&2&&(xa.$$scope={dirty:_,ctx:o}),yo.$set(xa);const Ba={};_&2&&(Ba.$$scope={dirty:_,ctx:o}),To.$set(Ba);const Fa={};_&2&&(Fa.$$scope={dirty:_,ctx:o}),$o.$set(Fa);const za={};_&2&&(za.$$scope={dirty:_,ctx:o}),Bo.$set(za);const Vt={};_&2&&(Vt.$$scope={dirty:_,ctx:o}),Eo.$set(Vt);const qa={};_&2&&(qa.$$scope={dirty:_,ctx:o}),Co.$set(qa)},i(o){od||(w(i.$$.fragment,o),w(U.$$.fragment,o),w(_e.$$.fragment,o),w(Ro.$$.fragment,o),w(Ho.$$.fragment,o),w(Vo.$$.fragment,o),w(Ko.$$.fragment,o),w(Qt.$$.fragment,o),w(Qo.$$.fragment,o),w(Xo.$$.fragment,o),w(Zo.$$.fragment,o),w(en.$$.fragment,o),w(tn.$$.fragment,o),w(rn.$$.fragment,o),w(sn.$$.fragment,o),w(an.$$.fragment,o),w(pn.$$.fragment,o),w(oo.$$.fragment,o),w(no.$$.fragment,o),w(hn.$$.fragment,o),w(un.$$.fragment,o),w(gn.$$.fragment,o),w(so.$$.fragment,o),w(ao.$$.fragment,o),w(bn.$$.fragment,o),w(vn.$$.fragment,o),w(yn.$$.fragment,o),w(co.$$.fragment,o),w(kn.$$.fragment,o),w(Tn.$$.fragment,o),w(ho.$$.fragment,o),w(Bn.$$.fragment,o),w(uo.$$.fragment,o),w(mo.$$.fragment,o),w(Fn.$$.fragment,o),w(zn.$$.fragment,o),w(_o.$$.fragment,o),w(Cn.$$.fragment,o),w(go.$$.fragment,o),w(On.$$.fragment,o),w(Pn.$$.fragment,o),w(Wn.$$.fragment,o),w(vo.$$.fragment,o),w(yo.$$.fragment,o),w(Un.$$.fragment,o),w(To.$$.fragment,o),w(Rn.$$.fragment,o),w($o.$$.fragment,o),w(Hn.$$.fragment,o),w(Vn.$$.fragment,o),w(tr.$$.fragment,o),w(Bo.$$.fragment,o),w(nr.$$.fragment,o),w(rr.$$.fragment,o),w(Eo.$$.fragment,o),w(sr.$$.fragment,o),w(Co.$$.fragment,o),od=!0)},o(o){$(i.$$.fragment,o),$(U.$$.fragment,o),$(_e.$$.fragment,o),$(Ro.$$.fragment,o),$(Ho.$$.fragment,o),$(Vo.$$.fragment,o),$(Ko.$$.fragment,o),$(Qt.$$.fragment,o),$(Qo.$$.fragment,o),$(Xo.$$.fragment,o),$(Zo.$$.fragment,o),$(en.$$.fragment,o),$(tn.$$.fragment,o),$(rn.$$.fragment,o),$(sn.$$.fragment,o),$(an.$$.fragment,o),$(pn.$$.fragment,o),$(oo.$$.fragment,o),$(no.$$.fragment,o),$(hn.$$.fragment,o),$(un.$$.fragment,o),$(gn.$$.fragment,o),$(so.$$.fragment,o),$(ao.$$.fragment,o),$(bn.$$.fragment,o),$(vn.$$.fragment,o),$(yn.$$.fragment,o),$(co.$$.fragment,o),$(kn.$$.fragment,o),$(Tn.$$.fragment,o),$(ho.$$.fragment,o),$(Bn.$$.fragment,o),$(uo.$$.fragment,o),$(mo.$$.fragment,o),$(Fn.$$.fragment,o),$(zn.$$.fragment,o),$(_o.$$.fragment,o),$(Cn.$$.fragment,o),$(go.$$.fragment,o),$(On.$$.fragment,o),$(Pn.$$.fragment,o),$(Wn.$$.fragment,o),$(vo.$$.fragment,o),$(yo.$$.fragment,o),$(Un.$$.fragment,o),$(To.$$.fragment,o),$(Rn.$$.fragment,o),$($o.$$.fragment,o),$(Hn.$$.fragment,o),$(Vn.$$.fragment,o),$(tr.$$.fragment,o),$(Bo.$$.fragment,o),$(nr.$$.fragment,o),$(rr.$$.fragment,o),$(Eo.$$.fragment,o),$(sr.$$.fragment,o),$(Co.$$.fragment,o),od=!1},d(o){t(p),o&&t(v),o&&t(g),x(i),o&&t(Le),o&&t(A),o&&t(Se),o&&t(I),x(U),o&&t(De),o&&t(Z),o&&t(C),o&&t(j),o&&t(ee),o&&t(we),o&&t(Ge),o&&t(R),o&&t(We),o&&t(O),x(_e),o&&t(G),o&&t(H),o&&t(it),o&&t(Ft),x(Ro),o&&t(Ca),o&&t(pr),o&&t(ja),x(Ho,o),o&&t(Oa),o&&t(zt),x(Vo),o&&t(Pa),o&&t(Ne),x(Ko),x(Qt),o&&t(Na),o&&t(Mt),x(Qo),o&&t(Aa),o&&t(be),x(Xo),x(Zo),o&&t(Ia),o&&t(Ct),x(en),o&&t(La),o&&t(ve),x(tn),x(rn),o&&t(Sa),o&&t(jt),x(sn),o&&t(Da),o&&t(nt),o&&t(Ga),o&&t(Ae),x(an),x(pn),x(oo),x(no),o&&t(Wa),o&&t(Pt),x(hn),o&&t(Ua),o&&t(rt),o&&t(Ra),o&&t(Ie),x(un),x(gn),x(so),x(ao),o&&t(Ha),o&&t(At),x(bn),o&&t(Va),o&&t(It),x(vn),x(yn),x(co),o&&t(Ka),o&&t(Lt),x(kn),o&&t(Ja),o&&t(ye),x(Tn),x(ho),x(Bn),x(uo),x(mo),o&&t(Qa),o&&t(Dt),x(Fn),o&&t(Xa),o&&t(ke),x(zn),x(_o),x(Cn),x(go),o&&t(Ya),o&&t(Wt),x(On),o&&t(Za),o&&t(S),x(Pn),x(Wn),x(vo),x(yo),x(Un),x(To),x(Rn),x($o),o&&t(ed),o&&t(Rt),x(Hn),o&&t(td),o&&t(D),x(Vn),x(tr),x(Bo),x(nr),x(rr),x(Eo),x(sr),x(Co)}}}const cf={local:"blenderbot",sections:[{local:"overview",title:"Overview"},{local:"implementation-notes",title:"Implementation Notes"},{local:"usage",title:"Usage"},{local:"transformers.BlenderbotConfig",title:"BlenderbotConfig"},{local:"transformers.BlenderbotTokenizer",title:"BlenderbotTokenizer"},{local:"transformers.BlenderbotTokenizerFast",title:"BlenderbotTokenizerFast"},{local:"transformers.BlenderbotModel",title:"BlenderbotModel"},{local:"transformers.BlenderbotForConditionalGeneration",title:"BlenderbotForConditionalGeneration"},{local:"transformers.BlenderbotForCausalLM",title:"BlenderbotForCausalLM"},{local:"transformers.TFBlenderbotModel",title:"TFBlenderbotModel"},{local:"transformers.TFBlenderbotForConditionalGeneration",title:"TFBlenderbotForConditionalGeneration"},{local:"transformers.FlaxBlenderbotModel",title:"FlaxBlenderbotModel"},{local:"transformers.FlaxBlenderbotForConditionalGeneration",title:"FlaxBlenderbotForConditionalGeneration"}],title:"Blenderbot"};function pf(F){return Wm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class bf extends Lm{constructor(p){super();Sm(this,p,pf,lf,Dm,{})}}export{bf as default,cf as metadata};
