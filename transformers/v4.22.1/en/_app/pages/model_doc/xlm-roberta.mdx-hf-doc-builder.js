...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ua=new A({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),fa=new We({}),ga=new A({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L91"}}),Ba=new A({props:{name:"forward",anchor:"transformers.XLMRobertaForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),sr=new A({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),Ri=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),il=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.1/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),bl=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.22.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.22.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Y1=c(),uh=s("p"),Z1=o("Finally, this model supports inherent JAX features such as:"),e$=c(),mo=s("ul"),fh=s("li"),ol=s("a"),t$=o("Just-In-Time (JIT) compilation"),o$=c(),gh=s("li"),nl=s("a"),n$=o("Automatic Differentiation"),s$=c(),_h=s("li"),sl=s("a"),a$=o("Vectorization"),r$=c(),bh=s("li"),al=s("a"),i$=o("Parallelization"),l$=c(),rl=s("p"),d$=o("This class overrides "),Ad=s("a"),c$=o("FlaxRobertaForTokenClassification"),p$=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),h$=c(),Yt=s("div"),y(il.$$.fragment),m$=c(),mn=s("p"),u$=o("The "),kh=s("code"),f$=o("FlaxRobertaPreTrainedModel"),g$=o(" forward method, overrides the "),vh=s("code"),_$=o("__call__"),b$=o(" special method."),k$=c(),y(Os.$$.fragment),v$=c(),y(Ns.$$.fragment),Jm=c(),un=s("h2"),Is=s("a"),yh=s("span"),y(ll.$$.fragment),y$=c(),Th=s("span"),T$=o("FlaxXLMRobertaForQuestionAnswering"),Gm=c(),ot=s("div"),y(dl.$$.fragment),w$=c(),fn=s("p"),$$=o(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=c(),Mh=s("p"),O$=o("Finally, this model supports inherent JAX features such as:"),N$=c(),uo=s("ul"),Fh=s("li"),ml=s("a"),I$=o("Just-In-Time (JIT) compilation"),D$=c(),xh=s("li"),ul=s("a"),S$=o("Automatic Differentiation"),W$=c(),Rh=s("li"),fl=s("a"),B$=o("Vectorization"),U$=c(),Lh=s("li"),gl=s("a"),Q$=o("Parallelization"),H$=c(),_l=s("p"),V$=o("This class overrides "),Nd=s("a"),K$=o("FlaxRobertaForQuestionAnswering"),J$=o(`. Please check the superclass for the appropriate
...
alongside usage examples.`),Ku.forEach(t),Gy=p(At),Ht=a(At,"DIV",{class:!0});var Hs=r(Ht);T(Hr.$$.fragment,Hs),Yy=p(Hs),Jo=a(Hs,"P",{});var ec=r(Jo);Zy=n(ec,"The "),Td=a(ec,"A",{href:!0});var c0=r(Td);e2=n(c0,"TFRobertaForMultipleChoice"),c0.forEach(t),t2=n(ec," forward method, overrides the "),fp=a(ec,"CODE",{});var p0=r(fp);o2=n(p0,"__call__"),p0.forEach(t),n2=n(ec," special method."),ec.forEach(t),s2=p(Hs),T(ms.$$.fragment,Hs),a2=p(Hs),T(us.$$.fragment,Hs),Hs.forEach(t),At.forEach(t),Pm=p(i),Go=a(i,"H2",{class:!0});var Ju=r(Go);fs=a(Ju,"A",{id:!0,class:!0,href:!0});var h0=r(fs);gp=a(h0,"SPAN",{});var m0=r(gp);T(Vr.$$.fragment,m0),m0.forEach(t),h0.forEach(t),r2=p(Ju),_p=a(Ju,"SPAN",{});var u0=r(_p);i2=n(u0,"TFXLMRobertaForTokenClassification"),u0.forEach(t),Ju.forEach(t),Am=p(i),lt=a(i,"DIV",{class:!0});var Ot=r(lt);T(Kr.$$.fragment,Ot),l2=p(Ot),bp=a(Ot,"P",{});var f0=r(bp);d2=n(f0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),f0.forEach(t),c2=p(Ot),Jr=a(Ot,"P",{});var Gu=r(Jr);p2=n(Gu,"This model inherits from "),wd=a(Gu,"A",{href:!0});var g0=r(wd);h2=n(g0,"TFPreTrainedModel"),g0.forEach(t),m2=n(Gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gu.forEach(t),u2=p(Ot),Gr=a(Ot,"P",{});var Yu=r(Gr);f2=n(Yu,"This model is also a "),Yr=a(Yu,"A",{href:!0,rel:!0});var _0=r(Yr);g2=n(_0,"tf.keras.Model"),_0.forEach(t),_2=n(Yu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yu.forEach(t),b2=p(Ot),T(gs.$$.fragment,Ot),k2=p(Ot),Zr=a(Ot,"P",{});var Zu=r(Zr);v2=n(Zu,"This class overrides "),$d=a(Zu,"A",{href:!0});var b0=r($d);y2=n(b0,"TFRobertaForTokenClassification"),b0.forEach(t),T2=n(Zu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Zu.forEach(t),w2=p(Ot),zt=a(Ot,"DIV",{class:!0});var Mo=r(zt);T(ei.$$.fragment,Mo),$2=p(Mo),Yo=a(Mo,"P",{});var tc=r(Yo);M2=n(tc,"The "),Md=a(tc,"A",{href:!0});var k0=r(Md);F2=n(k0,"TFRobertaForTokenClassification"),k0.forEach(t),x2=n(tc," forward method, overrides the "),kp=a(tc,"CODE",{});var v0=r(kp);R2=n(v0,"__call__"),v0.forEach(t),L2=n(tc," special method."),tc.forEach(t),E2=p(Mo),T(_s.$$.fragment,Mo),z2=p(Mo),T(bs.$$.fragment,Mo),q2=p(Mo),T(ks.$$.fragment,Mo),Mo.forEach(t),Ot.forEach(t),Om=p(i),Zo=a(i,"H2",{class:!0});var ef=r(Zo);vs=a(ef,"A",{id:!0,class:!0,href:!0});var y0=r(vs);vp=a(y0,"SPAN",{});var T0=r(vp);T(ti.$$.fragment,T0),T0.forEach(t),y0.forEach(t),C2=p(ef),yp=a(ef,"SPAN",{});var w0=r(yp);j2=n(w0,"TFXLMRobertaForQuestionAnswering"),w0.forEach(t),ef.forEach(t),Nm=p(i),dt=a(i,"DIV",{class:!0});var Nt=r(dt);T(oi.$$.fragment,Nt),X2=p(Nt),en=a(Nt,"P",{});var oc=r(en);P2=n(oc,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Tp=a(oc,"CODE",{});var $0=r(Tp);A2=n($0,"span start logits"),$0.forEach(t),O2=n(oc," and "),wp=a(oc,"CODE",{});var M0=r(wp);N2=n(M0,"span end logits"),M0.forEach(t),I2=n(oc,")."),oc.forEach(t),D2=p(Nt),ni=a(Nt,"P",{});var tf=r(ni);S2=n(tf,"This model inherits from "),Fd=a(tf,"A",{href:!0});var F0=r(Fd);W2=n(F0,"TFPreTrainedModel"),F0.forEach(t),B2=n(tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tf.forEach(t),U2=p(Nt),si=a(Nt,"P",{});var of=r(si);Q2=n(of,"This model is also a "),ai=a(of,"A",{href:!0,rel:!0});var x0=r(ai);H2=n(x0,"tf.keras.Model"),x0.forEach(t),V2=n(of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),of.forEach(t),K2=p(Nt),T(ys.$$.fragment,Nt),J2=p(Nt),ri=a(Nt,"P",{});var nf=r(ri);G2=n(nf,"This class overrides "),$p=a(nf,"CODE",{});var R0=r($p);Y2=n(R0,"TFRobertaForQuestionAnsweringSimple"),R0.forEach(t),Z2=n(nf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),nf.forEach(t),eT=p(Nt),qt=a(Nt,"DIV",{class:!0});var Fo=r(qt);T(ii.$$.fragment,Fo),tT=p(Fo),tn=a(Fo,"P",{});var nc=r(tn);oT=n(nc,"The "),xd=a(nc,"A",{href:!0});var L0=r(xd);nT=n(L0,"TFRobertaForQuestionAnswering"),L0.forEach(t),sT=n(nc," forward method, overrides the "),Mp=a(nc,"CODE",{});var E0=r(Mp);aT=n(E0,"__call__"),E0.forEach(t),rT=n(nc," special method."),nc.forEach(t),iT=p(Fo),T(Ts.$$.fragment,Fo),lT=p(Fo),T(ws.$$.fragment,Fo),dT=p(Fo),T($s.$$.fragment,Fo),Fo.forEach(t),Nt.forEach(t),Im=p(i),on=a(i,"H2",{class:!0});var sf=r(on);Ms=a(sf,"A",{id:!0,class:!0,href:!0});var z0=r(Ms);Fp=a(z0,"SPAN",{});var q0=r(Fp);T(li.$$.fragment,q0),q0.forEach(t),z0.forEach(t),cT=p(sf),xp=a(sf,"SPAN",{});var C0=r(xp);pT=n(C0,"FlaxXLMRobertaModel"),C0.forEach(t),sf.forEach(t),Dm=p(i),ct=a(i,"DIV",{class:!0});var It=r(ct);T(di.$$.fragment,It),hT=p(It),ci=a(It,"P",{});var af=r(ci);mT=n(af,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Rd=a(af,"A",{href:!0});var j0=r(Rd);uT=n(j0,"FlaxPreTrainedModel"),j0.forEach(t),fT=n(af,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),rf.forEach(t),vT=p(It),Rp=a(It,"P",{});var P0=r(Rp);yT=n(P0,"Finally, this model supports inherent JAX features such as:"),P0.forEach(t),TT=p(It),lo=a(It,"UL",{});var Vs=r(lo);Lp=a(Vs,"LI",{});var A0=r(Lp);mi=a(A0,"A",{href:!0,rel:!0});var O0=r(mi);wT=n(O0,"Just-In-Time (JIT) compilation"),O0.forEach(t),A0.forEach(t),$T=p(Vs),Ep=a(Vs,"LI",{});var N0=r(Ep);ui=a(N0,"A",{href:!0,rel:!0});var I0=r(ui);MT=n(I0,"Automatic Differentiation"),I0.forEach(t),N0.forEach(t),FT=p(Vs),zp=a(Vs,"LI",{});var D0=r(zp);fi=a(D0,"A",{href:!0,rel:!0});var S0=r(fi);xT=n(S0,"Vectorization"),S0.forEach(t),D0.forEach(t),RT=p(Vs),qp=a(Vs,"LI",{});var W0=r(qp);gi=a(W0,"A",{href:!0,rel:!0});var B0=r(gi);LT=n(B0,"Parallelization"),B0.forEach(t),W0.forEach(t),Vs.forEach(t),ET=p(It),_i=a(It,"P",{});var lf=r(_i);zT=n(lf,"This class overrides "),Ld=a(lf,"A",{href:!0});var U0=r(Ld);qT=n(U0,"FlaxRobertaModel"),U0.forEach(t),CT=n(lf,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),lf.forEach(t),jT=p(It),Vt=a(It,"DIV",{class:!0});var Ks=r(Vt);T(bi.$$.fragment,Ks),XT=p(Ks),nn=a(Ks,"P",{});var sc=r(nn);PT=n(sc,"The "),Cp=a(sc,"CODE",{});var Q0=r(Cp);AT=n(Q0,"FlaxRobertaPreTrainedModel"),Q0.forEach(t),OT=n(sc," forward method, overrides the "),jp=a(sc,"CODE",{});var H0=r(jp);NT=n(H0,"__call__"),H0.forEach(t),IT=n(sc," special method."),sc.forEach(t),DT=p(Ks),T(Fs.$$.fragment,Ks),ST=p(Ks),T(xs.$$.fragment,Ks),Ks.forEach(t),It.forEach(t),Sm=p(i),sn=a(i,"H2",{class:!0});var df=r(sn);Rs=a(df,"A",{id:!0,class:!0,href:!0});var V0=r(Rs);Xp=a(V0,"SPAN",{});var K0=r(Xp);T(ki.$$.fragment,K0),K0.forEach(t),V0.forEach(t),WT=p(df),Pp=a(df,"SPAN",{});var J0=r(Pp);BT=n(J0,"FlaxXLMRobertaForMaskedLM"),J0.forEach(t),df.forEach(t),Wm=p(i),pt=a(i,"DIV",{class:!0});var Dt=r(pt);T(vi.$$.fragment,Dt),UT=p(Dt),an=a(Dt,"P",{});var ac=r(an);QT=n(ac,"XLM-RoBERTa Model with a "),Ap=a(ac,"CODE",{});var G0=r(Ap);HT=n(G0,"language modeling"),G0.forEach(t),VT=n(ac,` head on top.
This model inherits from `),Ed=a(ac,"A",{href:!0});var Y0=r(Ed);KT=n(Y0,"FlaxPreTrainedModel"),Y0.forEach(t),JT=n(ac,`. Check the superclass documentation for the generic methods the
