...
<span class="hljs-meta">&gt;&gt;&gt; </span>accelerator = Accelerator()`}}),J=new ie({}),Q=new I({props:{codee:`train_dataloader, eval_dataloader, model, optimizer = accelerator.prepare(
...
<span class="hljs-meta">... </span>)`}}),R=new ie({}),X=new I({props:{codee:`for epoch in range(num_epochs):
...
<span class="hljs-meta">... </span>        progress_bar.update(<span class="hljs-number">1</span>)`}}),Z=new I({props:{codee:`+ from accelerate import Accelerator
...
<span class="hljs-addition">+         accelerator.backward(loss)</span>
          ...
          lr_scheduler.step()
          optimizer.zero_grad()
          progress_bar.update(1)`}}),ee=new ie({}),te=new ie({}),ae=new I({props:{codee:"accelerate config,",highlighted:"accelerate config"}}),re=new I({props:{codee:"accelerate launch train.py,",highlighted:"accelerate launch train.py"}}),oe=new ie({}),le=new I({props:{codee:`from accelerate import notebook_launcher
