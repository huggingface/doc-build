...
PyTorch tensors, you will lose the specific device of your tensors however.`),j.forEach(t)},m(ge,j){$(ge,h,j),e(h,P),e(h,b),e(b,y),e(h,E),e(h,w),e(w,x),e(h,B)},d(ge){ge&&t(h)}}}function sh(W){let h,P;return{c(){h=r("p"),P=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(b){h=s(b,"P",{});var y=a(h);P=n(y,"This API is experimental and may have some slight breaking changes in the next releases."),y.forEach(t)},m(b,y){$(b,h,y),e(h,P)},d(b){b&&t(h)}}}function ah(W){let h,P,b,y,E,w,x,B,ge,j,D,ro,so,ks,vs,ao,bs,Ts,io,ys,ws,lo,zs,xs,qr,co,$s,Er,ke,De,So,ot,Ps,Co,qs,Br,p,nt,Es,ve,Bs,po,Ls,Ds,mo,Is,Ns,As,Oo,Fs,Ss,Wo,Cs,Os,I,te,jo,Ws,js,Mo,Ms,Rs,Ro,Us,Vs,Hs,F,Uo,Gs,Xs,Vo,Ys,Js,Ho,Ks,Qs,Go,Zs,ea,Xo,ta,oa,na,V,Yo,ra,sa,Jo,aa,ia,Ko,da,la,Qo,ca,pa,ma,S,Zo,ha,ua,en,fa,_a,tn,ga,ka,on,va,ba,ho,Ta,ya,wa,Ie,nn,za,xa,rn,$a,Pa,qa,H,sn,Ea,Ba,an,La,Da,dn,Ia,Na,ln,Aa,Fa,Sa,G,cn,Ca,Oa,pn,Wa,ja,mn,Ma,Ra,hn,Ua,Va,Ha,Ne,rt,Ga,un,Xa,Ya,Ae,st,Ja,fn,Ka,Qa,Fe,at,Za,_n,ei,ti,oe,it,oi,gn,ni,ri,Se,si,ne,dt,ai,kn,ii,di,vn,li,ci,Ce,lt,pi,bn,mi,hi,Oe,ct,ui,pt,fi,Tn,_i,gi,ki,re,mt,vi,uo,bi,fo,Ti,yi,yn,wi,zi,se,ht,xi,wn,$i,Pi,ut,qi,zn,Ei,Bi,Li,ae,ft,Di,xn,Ii,Ni,_t,Ai,$n,Fi,Si,Ci,ie,gt,Oi,Pn,Wi,ji,We,Mi,C,kt,Ri,vt,Ui,_o,Vi,Hi,Gi,je,Xi,qn,Yi,Ji,bt,Ki,Me,Tt,Qi,be,Zi,En,ed,td,Bn,od,nd,rd,de,yt,sd,Ln,ad,id,le,Dn,dd,ld,In,cd,pd,Nn,md,hd,ud,X,wt,fd,An,_d,gd,Q,kd,Fn,vd,bd,Sn,Td,yd,Cn,wd,zd,xd,Re,$d,Ue,zt,Pd,M,qd,On,Ed,Bd,Wn,Ld,Dd,jn,Id,Nd,Mn,Ad,Fd,Sd,Ve,xt,Cd,Rn,Od,Wd,Y,$t,jd,Pt,Md,Un,Rd,Ud,Vd,Vn,Hd,Gd,qt,Xd,ce,Et,Yd,Bt,Jd,Hn,Kd,Qd,Zd,He,el,J,Lt,tl,Gn,ol,nl,Dt,rl,Xn,sl,al,il,It,dl,Yn,ll,cl,pl,pe,Nt,ml,Jn,hl,ul,At,fl,Kn,_l,gl,kl,Ge,Ft,vl,St,bl,Qn,Tl,yl,wl,Xe,Ct,zl,Zn,xl,Lr,Te,Ye,er,Ot,$l,tr,Pl,Dr,A,Wt,ql,ye,El,go,Bl,Ll,ko,Dl,Il,Nl,q,jt,Al,or,Fl,Sl,nr,Cl,Ol,Mt,Wl,vo,jl,Ml,Rl,Rt,Ul,rr,Vl,Hl,Gl,Ut,sr,Xl,Yl,Vt,Jl,ar,Kl,Ql,Zl,R,ec,bo,tc,oc,ir,nc,rc,dr,sc,ac,lr,ic,dc,lc,cr,cc,pc,Ht,mc,N,Gt,hc,pr,uc,fc,mr,_c,gc,Xt,kc,To,vc,bc,Tc,hr,yc,wc,Yt,zc,me,Jt,xc,we,$c,ur,Pc,qc,fr,Ec,Bc,Lc,_r,Dc,Ir,ze,Je,gr,Kt,Ic,kr,Nc,Nr,xe,Qt,Ac,$e,Fc,vr,Sc,Cc,Ke,Oc,br,Wc,jc,Mc,Ar,Pe,Zt,Rc,Tr,Uc,Fr,qe,eo,Vc,yr,Hc,Sr;return w=new gs({}),ot=new gs({}),nt=new z({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/tokenization_utils_base.py#L1433",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
adding special tokens.`),di=d(),vn=r("p"),li=o("This implementation does not add special tokens and this method should be overridden in a subclass."),ci=d(),Ce=r("div"),u(lt.$$.fragment),pi=d(),bn=r("p"),mi=o("Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),hi=d(),Oe=r("div"),u(ct.$$.fragment),ui=d(),pt=r("p"),fi=o("Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=r("code"),_i=o('" ".join(tokens)'),gi=o(` but we
...
`),bo=r("a"),tc=o("BertTokenizer"),oc=d(),ir=r("code"),nc=o("cls_token"),rc=o(" is already registered to be :obj"),dr=r("em"),sc=o("\u2019[CLS]\u2019"),ac=o(` and XLM\u2019s one is also registered to be
...
matrix of the model so that its embedding matrix matches the tokenizer.`),gc=d(),Xt=r("p"),kc=o("In order to do that, please use the "),To=r("a"),vc=o("resize_token_embeddings()"),bc=o(" method."),Tc=d(),hr=r("p"),yc=o("Examples:"),wc=d(),u(Yt.$$.fragment),zc=d(),me=r("div"),u(Jt.$$.fragment),xc=d(),we=r("p"),$c=o("Make sure that all the special tokens attributes of the tokenizer ("),ur=r("code"),Pc=o("tokenizer.mask_token"),qc=o(`,
`),fr=r("code"),Ec=o("tokenizer.cls_token"),Bc=o(", etc.) are in the vocabulary."),Lc=d(),_r=r("p"),Dc=o("Add the missing ones to the vocabulary if needed."),Ir=d(),ze=r("h2"),Je=r("a"),gr=r("span"),u(Kt.$$.fragment),Ic=d(),kr=r("span"),Nc=o("Enums and namedtuples"),Nr=d(),xe=r("div"),u(Qt.$$.fragment),Ac=d(),$e=r("p"),Fc=o("Possible values for the "),vr=r("code"),Sc=o("truncation"),Cc=o(" argument in "),Ke=r("a"),Oc=o("PreTrainedTokenizerBase."),br=r("strong"),Wc=o("call"),jc=o("()"),Mc=o(`. Useful for tab-completion in
an IDE.`),Ar=d(),Pe=r("div"),u(Zt.$$.fragment),Rc=d(),Tr=r("p"),Uc=o("Character span in the original string."),Fr=d(),qe=r("div"),u(eo.$$.fragment),Vc=d(),yr=r("p"),Hc=o("Token span in an encoded string (list of tokens)."),this.h()},l(i){const T=eh('[data-svelte="svelte-1phssyn"]',document.head);h=s(T,"META",{name:!0,content:!0}),T.forEach(t),P=l(i),b=s(i,"H1",{class:!0});var to=a(b);y=s(to,"A",{id:!0,class:!0,href:!0});var wr=a(y);E=s(wr,"SPAN",{});var zr=a(E);f(w.$$.fragment,zr),zr.forEach(t),wr.forEach(t),x=l(to),B=s(to,"SPAN",{});var xr=a(B);ge=n(xr,"Utilities for Tokenizers"),xr.forEach(t),to.forEach(t),j=l(i),D=s(i,"P",{});var U=a(D);ro=n(U,`This page lists all the utility functions used by the tokenizers, mainly the class
`),so=s(U,"A",{href:!0});var Xc=a(so);ks=n(Xc,"PreTrainedTokenizerBase"),Xc.forEach(t),vs=n(U,` that implements the common methods between
`),ao=s(U,"A",{href:!0});var Yc=a(ao);bs=n(Yc,"PreTrainedTokenizer"),Yc.forEach(t),Ts=n(U," and "),io=s(U,"A",{href:!0});var Jc=a(io);ys=n(Jc,"PreTrainedTokenizerFast"),Jc.forEach(t),ws=n(U,` and the mixin
`),lo=s(U,"A",{href:!0});var Kc=a(lo);zs=n(Kc,"SpecialTokensMixin"),Kc.forEach(t),xs=n(U,"."),U.forEach(t),qr=l(i),co=s(i,"P",{});var Qc=a(co);$s=n(Qc,"Most of those are only useful if you are studying the code of the tokenizers in the library."),Qc.forEach(t),Er=l(i),ke=s(i,"H2",{class:!0});var Cr=a(ke);De=s(Cr,"A",{id:!0,class:!0,href:!0});var Zc=a(De);So=s(Zc,"SPAN",{});var ep=a(So);f(ot.$$.fragment,ep),ep.forEach(t),Zc.forEach(t),Ps=l(Cr),Co=s(Cr,"SPAN",{});var tp=a(Co);qs=n(tp,"PreTrainedTokenizerBase"),tp.forEach(t),Cr.forEach(t),Br=l(i),p=s(i,"DIV",{class:!0});var m=a(p);f(nt.$$.fragment,m),Es=l(m),ve=s(m,"P",{});var yo=a(ve);Bs=n(yo,"Base class for "),po=s(yo,"A",{href:!0});var op=a(po);Ls=n(op,"PreTrainedTokenizer"),op.forEach(t),Ds=n(yo," and "),mo=s(yo,"A",{href:!0});var np=a(mo);Is=n(np,"PreTrainedTokenizerFast"),np.forEach(t),Ns=n(yo,"."),yo.forEach(t),As=l(m),Oo=s(m,"P",{});var rp=a(Oo);Fs=n(rp,"Handles shared (mostly boiler plate) methods for those two classes."),rp.forEach(t),Ss=l(m),Wo=s(m,"P",{});var sp=a(Wo);Cs=n(sp,"Class attributes (overridden by derived classes)"),sp.forEach(t),Os=l(m),I=s(m,"UL",{});var O=a(I);te=s(O,"LI",{});var oo=a(te);jo=s(oo,"STRONG",{});var ap=a(jo);Ws=n(ap,"vocab_files_names"),ap.forEach(t),js=n(oo," ("),Mo=s(oo,"CODE",{});var ip=a(Mo);Ms=n(ip,"Dict[str, str]"),ip.forEach(t),Rs=n(oo,") \u2014 A dictionary with, as keys, the "),Ro=s(oo,"CODE",{});var dp=a(Ro);Us=n(dp,"__init__"),dp.forEach(t),Vs=n(oo,` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
...
adding special tokens.`),Sp.forEach(t),di=l(zo),vn=s(zo,"P",{});var Cp=a(vn);li=n(Cp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Cp.forEach(t),zo.forEach(t),ci=l(m),Ce=s(m,"DIV",{class:!0});var Mr=a(Ce);f(lt.$$.fragment,Mr),pi=l(Mr),bn=s(Mr,"P",{});var Op=a(bn);mi=n(Op,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Op.forEach(t),Mr.forEach(t),hi=l(m),Oe=s(m,"DIV",{class:!0});var Rr=a(Oe);f(ct.$$.fragment,Rr),ui=l(Rr),pt=s(Rr,"P",{});var Ur=a(pt);fi=n(Ur,"Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=s(Ur,"CODE",{});var Wp=a(Tn);_i=n(Wp,'" ".join(tokens)'),Wp.forEach(t),gi=n(Ur,` but we
often want to remove sub-word tokenization artifacts at the same time.`),Ur.forEach(t),Rr.forEach(t),ki=l(m),re=s(m,"DIV",{class:!0});var xo=a(re);f(mt.$$.fragment,xo),vi=l(xo),uo=s(xo,"P",{});var Gc=a(uo);bi=n(Gc,"Create the token type IDs corresponding to the sequences passed. "),fo=s(Gc,"A",{href:!0});var jp=a(fo);Ti=n(jp,`What are token type
...
in the batch.`),om.forEach(t),gd=l(Qe),Q=s(Qe,"P",{});var Ze=a(Q);kd=n(Ze,"Padding side (left/right) padding token ids are defined at the tokenizer level (with "),Fn=s(Ze,"CODE",{});var nm=a(Fn);vd=n(nm,"self.padding_side"),nm.forEach(t),bd=n(Ze,`,
...
`),bo=s(_e,"A",{href:!0});var Dm=a(bo);tc=n(Dm,"BertTokenizer"),Dm.forEach(t),oc=l(_e),ir=s(_e,"CODE",{});var Im=a(ir);nc=n(Im,"cls_token"),Im.forEach(t),rc=n(_e," is already registered to be :obj"),dr=s(_e,"EM",{});var Nm=a(dr);sc=n(Nm,"\u2019[CLS]\u2019"),Nm.forEach(t),ac=n(_e,` and XLM\u2019s one is also registered to be
