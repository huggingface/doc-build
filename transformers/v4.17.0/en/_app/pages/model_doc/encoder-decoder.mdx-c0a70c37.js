import{S as qi,i as xi,s as ji,e as a,k as i,w as u,t as n,M as $i,c as s,d as o,m as c,a as d,x as g,h as r,b as l,F as e,g as h,y as _,q as v,o as b,B as y}from"../../chunks/vendor-4833417e.js";import{T as dd}from"../../chunks/Tip-fffd6df1.js";import{D as O}from"../../chunks/Docstring-4f315ed9.js";import{C as Me}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Rt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Pi(Q){let m,q,f,w,P;return{c(){m=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
...
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);q=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,q),e(m,f),e(f,w),e(m,P)},d(k){k&&o(m)}}}function Ai(Q){let m,q,f,w,P,k,T,F,zn,Gt,me,Mn,wo,qn,xn,Ut,he,jn,qe,$n,Pn,Vt,fe,Fn,Eo,Cn,An,Ht,W,Sn,Do,Nn,In,xe,Ln,Bn,Yt,R,On,Qo,Wn,Rn,Xo,Gn,Un,Jt,je,Zt,G,Vn,$e,Hn,Yn,Pe,Jn,Zn,Kt,X,ue,et,Fe,Kn,ot,Qn,Qt,M,Ce,Xn,ge,zo,er,or,Mo,tr,nr,rr,ee,ar,qo,sr,dr,xo,ir,cr,lr,tt,pr,mr,Ae,hr,_e,Se,fr,Ne,ur,jo,gr,_r,vr,ve,Ie,br,oe,yr,nt,kr,Tr,rt,wr,Er,Xt,te,be,at,Le,Dr,st,zr,en,E,Be,Mr,ne,qr,dt,xr,jr,it,$r,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ct,Ir,Lr,Re,Br,$o,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Yr,Jr,lt,Zr,Kr,pt,Qr,Xr,ea,C,Ve,oa,re,ta,Fo,na,ra,mt,aa,sa,da,ye,ia,ht,ca,la,He,pa,A,Ye,ma,ft,ha,fa,ae,ua,ut,ga,_a,gt,va,ba,ya,_t,ka,Ta,Je,on,se,ke,vt,Ze,wa,bt,Ea,tn,D,Ke,Da,de,za,yt,Ma,qa,kt,xa,ja,$a,Qe,Pa,Xe,Fa,Ca,Aa,Tt,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,to,Ra,Ga,Ua,V,Ao,Va,Ha,wt,Ya,Ja,Et,Za,Ka,Qa,S,no,Xa,ie,es,So,os,ts,Dt,ns,rs,as,Te,ss,zt,ds,is,ro,cs,L,ao,ls,Mt,ps,ms,qt,hs,fs,so,nn,ce,we,xt,io,us,jt,gs,rn,z,co,_s,le,vs,$t,bs,ys,Pt,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Ft,qs,xs,mo,js,No,$s,Ps,Fs,ho,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,Ct,Bs,Os,At,Ws,Rs,Gs,N,uo,Us,pe,Vs,Lo,Hs,Ys,St,Js,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,vo,an;return k=new Rt({}),je=new Me({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),Fe=new Rt({}),Ce=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26",parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
`}}),Ie=new O({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
the model, you need to first set it back in training mode with `),gt=a("code"),va=n("model.train()"),ba=n("."),ya=i(),_t=a("p"),ka=n("Example:"),Ta=i(),u(Je.$$.fragment),on=i(),se=a("h2"),ke=a("a"),vt=a("span"),u(Ze.$$.fragment),wa=i(),bt=a("span"),Ea=n("TFEncoderDecoderModel"),tn=i(),D=a("div"),u(Ke.$$.fragment),Da=i(),de=a("p"),za=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
generative task, like summarization.`),Yo.forEach(o),$a=c(j),Qe=s(j,"P",{});var bn=d(Qe);Pa=r(bn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
