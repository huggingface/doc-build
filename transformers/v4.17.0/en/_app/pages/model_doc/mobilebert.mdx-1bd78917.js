...
`}}),ln=new Ee({props:{$$slots:{default:[TM]},$$scope:{ctx:R}}}),ir=new qe({props:{code:`import tensorflow as tf
...
`}}),Tn=new Ee({props:{$$slots:{default:[EM]},$$scope:{ctx:R}}}),Ar=new qe({props:{code:`from transformers import MobileBertTokenizer, TFMobileBertForMultipleChoice
import tensorflow as tf
