import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as fa,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as v,q as b,o as k,B as T}from"../../chunks/vendor-4833417e.js";import{T as ca}from"../../chunks/Tip-fffd6df1.js";import{D as He}from"../../chunks/Docstring-7b52c3d4.js";import{C as Jt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as bt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function ma(ie){let u,q,f,w,D;return{c(){u=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),w=n("Module"),D=n(`
...
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var E=i(u);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(E,"CODE",{});var S=i(f);w=r(S,"Module"),S.forEach(o),D=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(y,E){p(y,u,E),e(u,q),e(u,f),e(f,w),e(u,D)},d(y){y&&o(u)}}}function _a(ie){let u,q,f,w,D,y,E,S,Co,Kt,R,Y,kt,de,So,Tt,Mo,Qt,M,Ao,Ve,No,Lo,le,Fo,Io,Xt,Je,Oo,Yt,Ke,wt,Ro,Zt,Qe,Uo,eo,Xe,ce,Wo,Ye,Ho,Vo,to,he,oo,Ze,pe,Jo,et,Ko,Qo,no,ue,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,yt,on,nn,rn,Et,sn,ao,N,an,fe,dn,ln,me,cn,hn,io,U,ee,Bt,ge,pn,zt,un,lo,$,_e,fn,ve,mn,$t,gn,_n,vn,W,bn,rt,kn,Tn,st,wn,yn,En,Gt,Bn,zn,be,co,H,te,qt,ke,$n,Pt,Gn,ho,C,Te,qn,we,Pn,ye,jn,xn,Dn,Ee,Cn,at,Sn,Mn,An,it,Be,po,V,oe,jt,ze,Nn,xt,Ln,uo,m,$e,Fn,Dt,In,On,Ge,Rn,dt,Un,Wn,Hn,qe,Vn,Pe,Jn,Kn,Qn,je,Xn,xe,Yn,Zn,er,J,tr,lt,or,nr,De,rr,sr,ar,B,ir,Ct,dr,lr,St,cr,hr,Mt,pr,ur,At,fr,mr,Nt,gr,_r,Lt,vr,br,kr,P,Ce,Tr,K,wr,ct,yr,Er,Ft,Br,zr,$r,ne,Gr,It,qr,Pr,Se,fo,Q,re,Ot,Me,jr,Rt,xr,mo,G,Ae,Dr,Ne,Cr,Ut,Sr,Mr,Ar,Le,Nr,ht,Lr,Fr,Ir,Fe,Or,Ie,Rr,Ur,Wr,j,Oe,Hr,X,Vr,pt,Jr,Kr,Wt,Qr,Xr,Yr,se,Zr,Ht,es,ts,Re,go;return y=new bt({}),de=new bt({}),he=new Jt({props:{codee:`# leverage checkpoints for Bert2Bert model...
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>]))`}}),ge=new bt({}),_e=new He({props:{name:"class transformers.BertGenerationConfig",anchor:"transformers.BertGenerationConfig",parameters:[{name:"vocab_size",val:" = 50358"},{name:"hidden_size",val:" = 1024"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 16"},{name:"intermediate_size",val:" = 4096"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 1"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/bert_generation/configuration_bert_generation.py#L20",parametersDescription:[{anchor:"transformers.BertGenerationConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50358) &#x2014;
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}]}}),be=new Jt({props:{codee:`from transformers import BertGenerationConfig, BertGenerationEncoder
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),ke=new bt({}),Te=new He({props:{name:"class transformers.BertGenerationTokenizer",anchor:"transformers.BertGenerationTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"sep_token",val:" = '<::::>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/bert_generation/tokenization_bert_generation.py#L41",parametersDescription:[{anchor:"transformers.BertGenerationTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}]}}),Be=new He({props:{name:"save_vocabulary",anchor:"transformers.BertGenerationTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/bert_generation/tokenization_bert_generation.py#L155"}}),ze=new bt({}),$e=new He({props:{name:"class transformers.BertGenerationEncoder",anchor:"transformers.BertGenerationEncoder",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/bert_generation/modeling_bert_generation.py#L253",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ce=new He({props:{name:"forward",anchor:"transformers.BertGenerationEncoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Me=new bt({}),Ae=new He({props:{name:"class transformers.BertGenerationDecoder",anchor:"transformers.BertGenerationDecoder",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/bert_generation/modeling_bert_generation.py#L442",parametersDescription:[{anchor:"transformers.BertGenerationDecoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oe=new He({props:{name:"forward",anchor:"transformers.BertGenerationDecoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/bert_generation/modeling_bert_generation.py#L461",parametersDescription:[{anchor:"transformers.BertGenerationDecoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationTokenizer">BertGenerationTokenizer</a>. See <a href="/docs/transformers/v4.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
found `),me=s("a"),cn=n("here"),hn=n("."),io=l(),U=s("h2"),ee=s("a"),Bt=s("span"),g(ge.$$.fragment),pn=l(),zt=s("span"),un=n("BertGenerationConfig"),lo=l(),$=s("div"),g(_e.$$.fragment),fn=l(),ve=s("p"),mn=n("This is the configuration class to store the configuration of a "),$t=s("code"),gn=n("BertGenerationPreTrainedModel"),_n=n(` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),vn=l(),W=s("p"),bn=n("Configuration objects inherit from "),rt=s("a"),kn=n("PretrainedConfig"),Tn=n(` and can be used to control the model outputs. Read the
documentation from `),st=s("a"),wn=n("PretrainedConfig"),yn=n(" for more information."),En=l(),Gt=s("p"),Bn=n("Examples:"),zn=l(),g(be.$$.fragment),co=l(),H=s("h2"),te=s("a"),qt=s("span"),g(ke.$$.fragment),$n=l(),Pt=s("span"),Gn=n("BertGenerationTokenizer"),ho=l(),C=s("div"),g(Te.$$.fragment),qn=l(),we=s("p"),Pn=n("Construct a BertGeneration tokenizer. Based on "),ye=s("a"),jn=n("SentencePiece"),xn=n("."),Dn=l(),Ee=s("p"),Cn=n("This tokenizer inherits from "),at=s("a"),Sn=n("PreTrainedTokenizer"),Mn=n(` which contains most of the main methods. Users should refer to
...
GPT-2 and RoBERTa checkpoints and conducted an extensive empirical study on the utility of initializing our model, both
encoder and decoder, with these checkpoints. Our models result in new state-of-the-art results on Machine Translation,
Text Summarization, Sentence Splitting, and Sentence Fusion.`),hs.forEach(o),cs.forEach(o),Zt=c(t),Qe=a(t,"P",{});var ps=i(Qe);Uo=r(ps,"Usage:"),ps.forEach(o),eo=c(t),Xe=a(t,"UL",{});var us=i(Xe);ce=a(us,"LI",{});var vo=i(ce);Wo=r(vo,"The model can be used in combination with the "),Ye=a(vo,"A",{href:!0});var fs=i(Ye);Ho=r(fs,"EncoderDecoderModel"),fs.forEach(o),Vo=r(vo,` to leverage two pretrained
BERT checkpoints for subsequent fine-tuning.`),vo.forEach(o),us.forEach(o),to=c(t),_(he.$$.fragment,t),oo=c(t),Ze=a(t,"UL",{});var ms=i(Ze);pe=a(ms,"LI",{});var bo=i(pe);Jo=r(bo,"Pretrained "),et=a(bo,"A",{href:!0});var gs=i(et);Ko=r(gs,"EncoderDecoderModel"),gs.forEach(o),Qo=r(bo," are also directly available in the model hub, e.g.,"),bo.forEach(o),ms.forEach(o),no=c(t),_(ue.$$.fragment,t),ro=c(t),tt=a(t,"P",{});var _s=i(tt);Xo=r(_s,"Tips:"),_s.forEach(o),so=c(t),Z=a(t,"UL",{});var ko=i(Z);A=a(ko,"LI",{});var We=i(A);ot=a(We,"A",{href:!0});var vs=i(ot);Yo=r(vs,"BertGenerationEncoder"),vs.forEach(o),Zo=r(We," and "),nt=a(We,"A",{href:!0});var bs=i(nt);en=r(bs,"BertGenerationDecoder"),bs.forEach(o),tn=r(We,` should be used in
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Do.forEach(o),Wr=c(I),j=a(I,"DIV",{class:!0});var O=i(j);_(Oe.$$.fragment,O),Hr=c(O),X=a(O,"P",{});var vt=i(X);Vr=r(vt,"The "),pt=a(vt,"A",{href:!0});var ia=i(pt);Jr=r(ia,"BertGenerationDecoder"),ia.forEach(o),Kr=r(vt," forward method, overrides the "),Wt=a(vt,"CODE",{});var da=i(Wt);Qr=r(da,"__call__"),da.forEach(o),Xr=r(vt," special method."),vt.forEach(o),Yr=c(O),_(se.$$.fragment,O),Zr=c(O),Ht=a(O,"P",{});var la=i(Ht);es=r(la,"Example:"),la.forEach(o),ts=c(O),_(Re.$$.fragment,O),O.forEach(o),I.forEach(o),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(va)),d(w,"id","bertgeneration"),d(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(w,"href","#bertgeneration"),d(f,"class","relative group"),d(Y,"id","overview"),d(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Y,"href","#overview"),d(R,"class","relative group"),d(Ve,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(le,"href","https://arxiv.org/abs/1907.12461"),d(le,"rel","nofollow"),d(Ye,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(et,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(ot,"href","/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(nt,"href","/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(fe,"href","https://huggingface.co/patrickvonplaten"),d(fe,"rel","nofollow"),d(me,"href","https://tfhub.dev/s?module-type=text-generation&subtype=module,placeholder"),d(me,"rel","nofollow"),d(ee,"id","transformers.BertGenerationConfig"),d(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ee,"href","#transformers.BertGenerationConfig"),d(U,"class","relative group"),d(rt,"href","/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig"),d(st,"href","/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig"),d($,"class","docstring"),d(te,"id","transformers.BertGenerationTokenizer"),d(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(te,"href","#transformers.BertGenerationTokenizer"),d(H,"class","relative group"),d(ye,"href","https://github.com/google/sentencepiece"),d(ye,"rel","nofollow"),d(at,"href","/docs/transformers/v4.17.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d(it,"class","docstring"),d(C,"class","docstring"),d(oe,"id","transformers.BertGenerationEncoder"),d(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(oe,"href","#transformers.BertGenerationEncoder"),d(V,"class","relative group"),d(dt,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel"),d(Pe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Pe,"rel","nofollow"),d(xe,"href","https://arxiv.org/abs/1706.03762"),d(xe,"rel","nofollow"),d(lt,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(De,"href","https://arxiv.org/abs/1907.12461"),d(De,"rel","nofollow"),d(ct,"href","/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(P,"class","docstring"),d(m,"class","docstring"),d(re,"id","transformers.BertGenerationDecoder"),d(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(re,"href","#transformers.BertGenerationDecoder"),d(Q,"class","relative group"),d(ht,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel"),d(Ie,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Ie,"rel","nofollow"),d(pt,"href","/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(j,"class","docstring"),d(G,"class","docstring")},m(t,h){e(document.head,u),p(t,q,h),p(t,f,h),e(f,w),e(w,D),v(y,D,null),e(f,E),e(f,S),e(S,Co),p(t,Kt,h),p(t,R,h),e(R,Y),e(Y,kt),v(de,kt,null),e(R,So),e(R,Tt),e(Tt,Mo),p(t,Qt,h),p(t,M,h),e(M,Ao),e(M,Ve),e(Ve,No),e(M,Lo),e(M,le),e(le,Fo),e(M,Io),p(t,Xt,h),p(t,Je,h),e(Je,Oo),p(t,Yt,h),p(t,Ke,h),e(Ke,wt),e(wt,Ro),p(t,Zt,h),p(t,Qe,h),e(Qe,Uo),p(t,eo,h),p(t,Xe,h),e(Xe,ce),e(ce,Wo),e(ce,Ye),e(Ye,Ho),e(ce,Vo),p(t,to,h),v(he,t,h),p(t,oo,h),p(t,Ze,h),e(Ze,pe),e(pe,Jo),e(pe,et),e(et,Ko),e(pe,Qo),p(t,no,h),v(ue,t,h),p(t,ro,h),p(t,tt,h),e(tt,Xo),p(t,so,h),p(t,Z,h),e(Z,A),e(A,ot),e(ot,Yo),e(A,Zo),e(A,nt),e(nt,en),e(A,tn),e(A,yt),e(yt,on),e(A,nn),e(Z,rn),e(Z,Et),e(Et,sn),p(t,ao,h),p(t,N,h),e(N,an),e(N,fe),e(fe,dn),e(N,ln),e(N,me),e(me,cn),e(N,hn),p(t,io,h),p(t,U,h),e(U,ee),e(ee,Bt),v(ge,Bt,null),e(U,pn),e(U,zt),e(zt,un),p(t,lo,h),p(t,$,h),v(_e,$,null),e($,fn),e($,ve),e(ve,mn),e(ve,$t),e($t,gn),e(ve,_n),e($,vn),e($,W),e(W,bn),e(W,rt),e(rt,kn),e(W,Tn),e(W,st),e(st,wn),e(W,yn),e($,En),e($,Gt),e(Gt,Bn),e($,zn),v(be,$,null),p(t,co,h),p(t,H,h),e(H,te),e(te,qt),v(ke,qt,null),e(H,$n),e(H,Pt),e(Pt,Gn),p(t,ho,h),p(t,C,h),v(Te,C,null),e(C,qn),e(C,we),e(we,Pn),e(we,ye),e(ye,jn),e(we,xn),e(C,Dn),e(C,Ee),e(Ee,Cn),e(Ee,at),e(at,Sn),e(Ee,Mn),e(C,An),e(C,it),v(Be,it,null),p(t,po,h),p(t,V,h),e(V,oe),e(oe,jt),v(ze,jt,null),e(V,Nn),e(V,xt),e(xt,Ln),p(t,uo,h),p(t,m,h),v($e,m,null),e(m,Fn),e(m,Dt),e(Dt,In),e(m,On),e(m,Ge),e(Ge,Rn),e(Ge,dt),e(dt,Un),e(Ge,Wn),e(m,Hn),e(m,qe),e(qe,Vn),e(qe,Pe),e(Pe,Jn),e(qe,Kn),e(m,Qn),e(m,je),e(je,Xn),e(je,xe),e(xe,Yn),e(je,Zn),e(m,er),e(m,J),e(J,tr),e(J,lt),e(lt,or),e(J,nr),e(J,De),e(De,rr),e(J,sr),e(m,ar),e(m,B),e(B,ir),e(B,Ct),e(Ct,dr),e(B,lr),e(B,St),e(St,cr),e(B,hr),e(B,Mt),e(Mt,pr),e(B,ur),e(B,At),e(At,fr),e(B,mr),e(B,Nt),e(Nt,gr),e(B,_r),e(B,Lt),e(Lt,vr),e(B,br),e(m,kr),e(m,P),v(Ce,P,null),e(P,Tr),e(P,K),e(K,wr),e(K,ct),e(ct,yr),e(K,Er),e(K,Ft),e(Ft,Br),e(K,zr),e(P,$r),v(ne,P,null),e(P,Gr),e(P,It),e(It,qr),e(P,Pr),v(Se,P,null),p(t,fo,h),p(t,Q,h),e(Q,re),e(re,Ot),v(Me,Ot,null),e(Q,jr),e(Q,Rt),e(Rt,xr),p(t,mo,h),p(t,G,h),v(Ae,G,null),e(G,Dr),e(G,Ne),e(Ne,Cr),e(Ne,Ut),e(Ut,Sr),e(Ne,Mr),e(G,Ar),e(G,Le),e(Le,Nr),e(Le,ht),e(ht,Lr),e(Le,Fr),e(G,Ir),e(G,Fe),e(Fe,Or),e(Fe,Ie),e(Ie,Rr),e(Fe,Ur),e(G,Wr),e(G,j),v(Oe,j,null),e(j,Hr),e(j,X),e(X,Vr),e(X,pt),e(pt,Jr),e(X,Kr),e(X,Wt),e(Wt,Qr),e(X,Xr),e(j,Yr),v(se,j,null),e(j,Zr),e(j,Ht),e(Ht,es),e(j,ts),v(Re,j,null),go=!0},p(t,[h]){const Ue={};h&2&&(Ue.$$scope={dirty:h,ctx:t}),ne.$set(Ue);const Vt={};h&2&&(Vt.$$scope={dirty:h,ctx:t}),se.$set(Vt)},i(t){go||(b(y.$$.fragment,t),b(de.$$.fragment,t),b(he.$$.fragment,t),b(ue.$$.fragment,t),b(ge.$$.fragment,t),b(_e.$$.fragment,t),b(be.$$.fragment,t),b(ke.$$.fragment,t),b(Te.$$.fragment,t),b(Be.$$.fragment,t),b(ze.$$.fragment,t),b($e.$$.fragment,t),b(Ce.$$.fragment,t),b(ne.$$.fragment,t),b(Se.$$.fragment,t),b(Me.$$.fragment,t),b(Ae.$$.fragment,t),b(Oe.$$.fragment,t),b(se.$$.fragment,t),b(Re.$$.fragment,t),go=!0)},o(t){k(y.$$.fragment,t),k(de.$$.fragment,t),k(he.$$.fragment,t),k(ue.$$.fragment,t),k(ge.$$.fragment,t),k(_e.$$.fragment,t),k(be.$$.fragment,t),k(ke.$$.fragment,t),k(Te.$$.fragment,t),k(Be.$$.fragment,t),k(ze.$$.fragment,t),k($e.$$.fragment,t),k(Ce.$$.fragment,t),k(ne.$$.fragment,t),k(Se.$$.fragment,t),k(Me.$$.fragment,t),k(Ae.$$.fragment,t),k(Oe.$$.fragment,t),k(se.$$.fragment,t),k(Re.$$.fragment,t),go=!1},d(t){o(u),t&&o(q),t&&o(f),T(y),t&&o(Kt),t&&o(R),T(de),t&&o(Qt),t&&o(M),t&&o(Xt),t&&o(Je),t&&o(Yt),t&&o(Ke),t&&o(Zt),t&&o(Qe),t&&o(eo),t&&o(Xe),t&&o(to),T(he,t),t&&o(oo),t&&o(Ze),t&&o(no),T(ue,t),t&&o(ro),t&&o(tt),t&&o(so),t&&o(Z),t&&o(ao),t&&o(N),t&&o(io),t&&o(U),T(ge),t&&o(lo),t&&o($),T(_e),T(be),t&&o(co),t&&o(H),T(ke),t&&o(ho),t&&o(C),T(Te),T(Be),t&&o(po),t&&o(V),T(ze),t&&o(uo),t&&o(m),T($e),T(Ce),T(ne),T(Se),t&&o(fo),t&&o(Q),T(Me),t&&o(mo),t&&o(G),T(Ae),T(Oe),T(se),T(Re)}}}const va={local:"bertgeneration",sections:[{local:"overview",title:"Overview"},{local:"transformers.BertGenerationConfig",title:"BertGenerationConfig"},{local:"transformers.BertGenerationTokenizer",title:"BertGenerationTokenizer"},{local:"transformers.BertGenerationEncoder",title:"BertGenerationEncoder"},{local:"transformers.BertGenerationDecoder",title:"BertGenerationDecoder"}],title:"BertGeneration"};function ba(ie,u,q){let{fw:f}=u;return ie.$$set=w=>{"fw"in w&&q(0,f=w.fw)},[f]}class za extends ha{constructor(u){super();pa(this,u,ba,_a,ua,{fw:0})}}export{za as default,va as metadata};
