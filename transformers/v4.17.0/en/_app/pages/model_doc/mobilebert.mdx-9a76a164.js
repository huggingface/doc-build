...
tensors in the first argument of the model call function: `),O=a(S,"CODE",{});var ve=i(O);ue=s(ve,"model(inputs)"),ve.forEach(t),le=s(S,"."),S.forEach(t),V=d(c),j=a(c,"P",{});var Te=i(j);te=s(Te,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),C.forEach(t)},m(c,T){m(c,h,T),e(h,k),m(c,f,T),m(c,g,T),e(g,v),e(v,b),e(g,_),e(g,M),e(M,he),m(c,K,T),m(c,z,T),e(z,Z),e(z,D),e(D,ee),e(z,me),e(z,O),e(O,ue),e(z,le),m(c,V,T),m(c,j,T),e(j,te),m(c,G,T),m(c,P,T),e(P,x),e(x,ne),e(x,H),e(H,de),e(x,se),e(x,L),e(L,fe),e(P,ce),e(P,q),e(q,ge),e(q,W),e(W,X),e(q,re),e(q,Q),e(Q,_e),e(P,ae),e(P,N),e(N,pe),e(N,A),e(A,be)},d(c){c&&t(h),c&&t(f),c&&t(g),c&&t(K),c&&t(z),c&&t(V),c&&t(j),c&&t(G),c&&t(P)}}}function bM(R){let h,k,f,g,v;return{c(){h=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){h=a(b,"P",{});var _=i(h);k=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){m(b,h,_),e(h,k),e(h,f),e(f,g),e(h,v)},d(b){b&&t(h)}}}function vM(R){let h,k,f,g,v,b,_,M,he,K,z,Z,D,ee,me,O,ue,le,V,j,te,G,P,x,ne,H,de,se,L,fe,ce,q,ge,W,X,re,Q,_e,ae,N,pe,A,be;return{c(){h=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=r("ul"),v=r("li"),b=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),z=r("p"),Z=n("This second option is useful when using "),D=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=r("code"),ue=n("model(inputs)"),le=n("."),V=l(),j=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=l(),P=r("ul"),x=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),L=r("code"),fe=n("model(inputs_ids)"),ce=l(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),X=n("model([input_ids, attention_mask])"),re=n(" or "),Q=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=l(),N=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){h=a(c,"P",{});var T=i(h);k=s(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=a(c,"UL",{});var J=i(g);v=a(J,"LI",{});var ke=i(v);b=s(ke,"having all inputs as keyword arguments (like PyTorch models), or"),ke.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),K=d(c),z=a(c,"P",{});var S=i(z);Z=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);ee=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
the latter silently ignores them.`)},l(b){h=a(b,"P",{});var _=i(h);k=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){m(b,h,_),e(h,k),e(h,f),e(f,g),e(h,v)},d(b){b&&t(h)}}}function kM(R){let h,k,f,g,v,b,_,M,he,K,z,Z,D,ee,me,O,ue,le,V,j,te,G,P,x,ne,H,de,se,L,fe,ce,q,ge,W,X,re,Q,_e,ae,N,pe,A,be;return{c(){h=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=r("ul"),v=r("li"),b=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),z=r("p"),Z=n("This second option is useful when using "),D=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=r("code"),ue=n("model(inputs)"),le=n("."),V=l(),j=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=l(),P=r("ul"),x=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),L=r("code"),fe=n("model(inputs_ids)"),ce=l(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),X=n("model([input_ids, attention_mask])"),re=n(" or "),Q=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=l(),N=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){h=a(c,"P",{});var T=i(h);k=s(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=a(c,"UL",{});var J=i(g);v=a(J,"LI",{});var ke=i(v);b=s(ke,"having all inputs as keyword arguments (like PyTorch models), or"),ke.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),K=d(c),z=a(c,"P",{});var S=i(z);Z=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);ee=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
the latter silently ignores them.`)},l(b){h=a(b,"P",{});var _=i(h);k=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){m(b,h,_),e(h,k),e(h,f),e(f,g),e(h,v)},d(b){b&&t(h)}}}function wM(R){let h,k,f,g,v,b,_,M,he,K,z,Z,D,ee,me,O,ue,le,V,j,te,G,P,x,ne,H,de,se,L,fe,ce,q,ge,W,X,re,Q,_e,ae,N,pe,A,be;return{c(){h=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=r("ul"),v=r("li"),b=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),z=r("p"),Z=n("This second option is useful when using "),D=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=r("code"),ue=n("model(inputs)"),le=n("."),V=l(),j=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=l(),P=r("ul"),x=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),L=r("code"),fe=n("model(inputs_ids)"),ce=l(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),X=n("model([input_ids, attention_mask])"),re=n(" or "),Q=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=l(),N=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){h=a(c,"P",{});var T=i(h);k=s(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=a(c,"UL",{});var J=i(g);v=a(J,"LI",{});var ke=i(v);b=s(ke,"having all inputs as keyword arguments (like PyTorch models), or"),ke.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),K=d(c),z=a(c,"P",{});var S=i(z);Z=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);ee=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
the latter silently ignores them.`)},l(b){h=a(b,"P",{});var _=i(h);k=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){m(b,h,_),e(h,k),e(h,f),e(f,g),e(h,v)},d(b){b&&t(h)}}}function $M(R){let h,k,f,g,v,b,_,M,he,K,z,Z,D,ee,me,O,ue,le,V,j,te,G,P,x,ne,H,de,se,L,fe,ce,q,ge,W,X,re,Q,_e,ae,N,pe,A,be;return{c(){h=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=r("ul"),v=r("li"),b=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),z=r("p"),Z=n("This second option is useful when using "),D=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=r("code"),ue=n("model(inputs)"),le=n("."),V=l(),j=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=l(),P=r("ul"),x=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),L=r("code"),fe=n("model(inputs_ids)"),ce=l(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),X=n("model([input_ids, attention_mask])"),re=n(" or "),Q=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=l(),N=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){h=a(c,"P",{});var T=i(h);k=s(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=a(c,"UL",{});var J=i(g);v=a(J,"LI",{});var ke=i(v);b=s(ke,"having all inputs as keyword arguments (like PyTorch models), or"),ke.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),K=d(c),z=a(c,"P",{});var S=i(z);Z=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);ee=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
the latter silently ignores them.`)},l(b){h=a(b,"P",{});var _=i(h);k=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){m(b,h,_),e(h,k),e(h,f),e(f,g),e(h,v)},d(b){b&&t(h)}}}function BM(R){let h,k,f,g,v,b,_,M,he,K,z,Z,D,ee,me,O,ue,le,V,j,te,G,P,x,ne,H,de,se,L,fe,ce,q,ge,W,X,re,Q,_e,ae,N,pe,A,be;return{c(){h=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=r("ul"),v=r("li"),b=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),z=r("p"),Z=n("This second option is useful when using "),D=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=r("code"),ue=n("model(inputs)"),le=n("."),V=l(),j=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=l(),P=r("ul"),x=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),L=r("code"),fe=n("model(inputs_ids)"),ce=l(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),X=n("model([input_ids, attention_mask])"),re=n(" or "),Q=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=l(),N=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){h=a(c,"P",{});var T=i(h);k=s(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=a(c,"UL",{});var J=i(g);v=a(J,"LI",{});var ke=i(v);b=s(ke,"having all inputs as keyword arguments (like PyTorch models), or"),ke.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),K=d(c),z=a(c,"P",{});var S=i(z);Z=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);ee=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
the latter silently ignores them.`)},l(b){h=a(b,"P",{});var _=i(h);k=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){m(b,h,_),e(h,k),e(h,f),e(f,g),e(h,v)},d(b){b&&t(h)}}}function zM(R){let h,k,f,g,v,b,_,M,he,K,z,Z,D,ee,me,O,ue,le,V,j,te,G,P,x,ne,H,de,se,L,fe,ce,q,ge,W,X,re,Q,_e,ae,N,pe,A,be;return{c(){h=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=r("ul"),v=r("li"),b=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),z=r("p"),Z=n("This second option is useful when using "),D=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=r("code"),ue=n("model(inputs)"),le=n("."),V=l(),j=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=l(),P=r("ul"),x=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),L=r("code"),fe=n("model(inputs_ids)"),ce=l(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),X=n("model([input_ids, attention_mask])"),re=n(" or "),Q=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=l(),N=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){h=a(c,"P",{});var T=i(h);k=s(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=a(c,"UL",{});var J=i(g);v=a(J,"LI",{});var ke=i(v);b=s(ke,"having all inputs as keyword arguments (like PyTorch models), or"),ke.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),K=d(c),z=a(c,"P",{});var S=i(z);Z=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);ee=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
the latter silently ignores them.`)},l(b){h=a(b,"P",{});var _=i(h);k=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){m(b,h,_),e(h,k),e(h,f),e(f,g),e(h,v)},d(b){b&&t(h)}}}function qM(R){let h,k,f,g,v,b,_,M,he,K,z,Z,D,ee,me,O,ue,le,V,j,te,G,P,x,ne,H,de,se,L,fe,ce,q,ge,W,X,re,Q,_e,ae,N,pe,A,be;return{c(){h=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=r("ul"),v=r("li"),b=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),z=r("p"),Z=n("This second option is useful when using "),D=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=r("code"),ue=n("model(inputs)"),le=n("."),V=l(),j=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=l(),P=r("ul"),x=r("li"),ne=n("a single Tensor with "),H=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),L=r("code"),fe=n("model(inputs_ids)"),ce=l(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),X=n("model([input_ids, attention_mask])"),re=n(" or "),Q=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=l(),N=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){h=a(c,"P",{});var T=i(h);k=s(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=a(c,"UL",{});var J=i(g);v=a(J,"LI",{});var ke=i(v);b=s(ke,"having all inputs as keyword arguments (like PyTorch models), or"),ke.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),K=d(c),z=a(c,"P",{});var S=i(z);Z=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);ee=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
the latter silently ignores them.`)},l(b){h=a(b,"P",{});var _=i(h);k=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){m(b,h,_),e(h,k),e(h,f),e(f,g),e(h,v)},d(b){b&&t(h)}}}function CM(R){let h,k,f,g,v,b,_,M,he,K,z,Z,D,ee,me,O,ue,le,V,j,te,G,P,x,ne,H,de,se,L,fe,ce,q,ge,W,X,re,Q,_e,ae,N,pe,A,be,c,T,J,ke,$e,S,we,ve,Te,C,I,Fe,Me,U,ye,Y,oe,Be,Ht,_p,na,bp,vp,sa,Tp,kp,Mp,Qt,wp,ra,yp,$p,aa,Fp,Bp,Ep,fi,zp,Pp,zn,qp,gi,xp,wd,Ut,No,_i,Pn,Cp,bi,jp,yd,ct,qn,Np,vi,Sp,Ap,So,ia,Ip,Dp,la,Op,Lp,Wp,xn,Rp,da,Hp,Qp,$d,Vt,Ao,Ti,Cn,Up,ki,Vp,Fd,pt,jn,Kp,Nn,Gp,Mi,Jp,Yp,Zp,Io,ca,Xp,eh,pa,th,oh,nh,Sn,sh,ha,rh,ah,Bd,Kt,Do,wi,An,ih,yi,lh,Ed,Gt,In,dh,Dn,ch,ma,ph,hh,zd,Jt,On,mh,Ln,uh,ua,fh,gh,Pd,Yt,Oo,$i,Wn,_h,Fi,bh,qd,xe,Rn,vh,Bi,Th,kh,Hn,Mh,fa,wh,yh,$h,Qn,Fh,Un,Bh,Eh,zh,Ei,Vn,Ph,qh,Ke,Kn,xh,Zt,Ch,ga,jh,Nh,zi,Sh,Ah,Ih,Lo,Dh,P
g,e_,ir,Jd,ko,dn,Fl,lr,t_,Bl,o_,Yd,Ne,dr,n_,cr,s_,El,r_,a_,i_,pr,l_,Na,d_,c_,p_,hr,h_,mr,m_,u_,f_,cn,g_,nt,ur,__,Mo,b_,Sa,v_,T_,zl,k_,M_,w_,pn,y_,Pl,$_,F_,fr,Zd,wo,hn,ql,gr,B_,xl,E_,Xd,Se,_r,z_,br,P_,Cl,q_,x_,C_,vr,j_,Aa,N_,S_,A_,Tr,I_,kr,D_,O_,L_,mn,W_,st,Mr,R_,yo,H_,Ia,Q_,U_,jl,V_,K_,G_,un,J_,Nl,Y_,Z_,wr,ec,$o,fn,Sl,yr,X_,Al,eb,tc,Ae,$r,tb,Il,ob,nb,Fr,sb,Da,rb,ab,ib,Br,lb,Er,db,cb,pb,gn,hb,rt,zr,mb,Fo,ub,Oa,fb,gb,Dl,_b,bb,vb,_n,Tb,Ol,kb,Mb,Pr,oc,Bo,bn,Ll,qr,wb,Wl,yb,nc,Ie,xr,$b,Rl,Fb,Bb,Cr,Eb,La,zb,Pb,qb,jr,xb,Nr,Cb,jb,Nb,vn,Sb,at,Sr,Ab,Eo,Ib,Wa,Db,Ob,Hl,Lb,Wb,Rb,Tn,Hb,Ql,Qb,Ub,Ar,sc,zo,kn,Ul,Ir,Vb,Vl,Kb,rc,De,Dr,Gb,Kl,Jb,Yb,Or,Zb,Ra,Xb,ev,tv,Lr,ov,Wr,nv,sv,rv,Mn,av,it,Rr,iv,Po,lv,Ha,dv,cv,Gl,pv,hv,mv,wn,uv,Jl,fv,gv,Hr,ac,qo,yn,Yl,Qr,_v,Zl,bv,ic,Oe,Ur,vv,xo,Tv,Xl,kv,Mv,ed,wv,yv,$v,Vr,Fv,Qa,Bv,Ev,zv,Kr,Pv,Gr,qv,xv,Cv,$n,jv,lt,Jr,Nv,Co,Sv,Ua,Av,Iv,td,Dv,Ov,Lv,Fn,Wv,od,Rv,Hv,Yr,lc;return b=new ze({}),ee=new ze({}),I=new ze({}),oe=new ie({props:{name:"class transformers.MobileBertConfig",anchor:"transformers.MobileBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 512"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 512"},{name:"hidden_act",val:" = 'relu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"embedding_size",val:" = 128"},{name:"trigram_input",val:" = True"},{name:"use_bottleneck",val:" = True"},{name:"intra_bottleneck_size",val:" = 128"},{name:"use_bottleneck_attention",val:" = False"},{name:"key_query_shared_bottleneck",val:" = True"},{name:"num_feedforward_networks",val:" = 4"},{name:"normalization_type",val:" = 'no_norm'"},{name:"classifier_activation",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/mobilebert/configuration_mobilebert.py#L28",parametersDescription:[{anchor:"transformers.MobileBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vf=l(),Xe=r("div"),w(Ds.$$.fragment),Tf=l(),ho=r("p"),kf=n("The "),Ea=r("a"),Mf=n("MobileBertForTokenClassification"),wf=n(" forward method, overrides the "),il=r("code"),yf=n("__call__"),$f=n(" special method."),Ff=l(),w(Xo.$$.fragment),Bf=l(),ll=r("p"),Ef=n("Example:"),zf=l(),w(Os.$$.fragment),Hd=l(),mo=r("h2"),en=r("a"),dl=r("span"),w(Ls.$$.fragment),Pf=l(),cl=r("span"),qf=n("MobileBertForQuestionAnswering"),Qd=l(),Ve=r("div"),w(Ws.$$.fragment),xf=l(),uo=r("p"),Cf=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),A_=l(),Tr=r("p"),I_=n("This model is also a "),kr=r("a"),D_=n("tf.keras.Model"),O_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
for Named-Entity-Recognition (NER) tasks.`),Yb=l(),Or=r("p"),Zb=n("This model inherits from "),Ra=r("a"),Xb=n("TFPreTrainedModel"),ev=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tv=l(),Lr=r("p"),ov=n("This model is also a "),Wr=r("a"),nv=n("tf.keras.Model"),sv=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rv=l(),w(Mn.$$.fragment),av=l(),it=r("div"),w(Rr.$$.fragment),iv=l(),Po=r("p"),lv=n("The "),Ha=r("a"),dv=n("TFMobileBertForTokenClassification"),cv=n(" forward method, overrides the "),Gl=r("code"),pv=n("__call__"),hv=n(" special method."),mv=l(),w(wn.$$.fragment),uv=l(),Jl=r("p"),fv=n("Example:"),gv=l(),w(Hr.$$.fragment),ac=l(),qo=r("h2"),yn=r("a"),Yl=r("span"),w(Qr.$$.fragment),_v=l(),Zl=r("span"),bv=n("TFMobileBertForQuestionAnswering"),ic=l(),Oe=r("div"),w(Ur.$$.fragment),vv=l(),xo=r("p"),Tv=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip.forEach(t),pb=d(bt),y(gn.$$.fragment,bt),hb=d(bt),rt=a(bt,"DIV",{class:!0});var Ot=i(rt);y(zr.$$.fragment,Ot),mb=d(Ot),Fo=a(Ot,"P",{});var ci=i(Fo);ub=s(ci,"The "),Oa=a(ci,"A",{href:!0});var E1=i(Oa);fb=s(E1,"TFMobileBertForSequenceClassification"),E1.forEach(t),gb=s(ci," forward method, overrides the "),Dl=a(ci,"CODE",{});var z1=i(Dl);_b=s(z1,"__call__"),z1.forEach(t),bb=s(ci," special method."),ci.forEach(t),vb=d(Ot),y(_n.$$.fragment,Ot),Tb=d(Ot),Ol=a(Ot,"P",{});var P1=i(Ol);kb=s(P1,"Example:"),P1.forEach(t),Mb=d(Ot),y(Pr.$$.fragment,Ot),Ot.forEach(t),bt.forEach(t),oc=d(o),Bo=a(o,"H2",{class:!0});var lp=i(Bo);bn=a(lp,"A",{id:!0,class:!0,href:!0});var q1=i(bn);Ll=a(q1,"SPAN",{});var x1=i(Ll);y(qr.$$.fragment,x1),x1.forEach(t),q1.forEach(t),wb=d(lp),Wl=a(lp,"SPAN",{});var C1=i(Wl);yb=s(C1,"TFMobileBertForMultipleChoice"),C1.forEach(t),lp.forEach(t),nc=d(o),Ie=a(o,"DIV",{class:!0});var vt=i(Ie);y(xr.$$.fragment,vt),$b=d(vt),Rl=a(vt,"P",{});var j1=i(Rl);Fb=s(j1,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),j1.forEach(t),Bb=d(vt),Cr=a(vt,"P",{});var dp=i(Cr);Eb=s(dp,"This model inherits from "),La=a(dp,"A",{href:!0});var N1=i(La);zb=s(N1,"TFPreTrainedModel"),N1.forEach(t),Pb=s(dp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),cp.forEach(t),Nb=d(vt),y(vn.$$.fragment,vt),Sb=d(vt),at=a(vt,"DIV",{class:!0});var Lt=i(at);y(Sr.$$.fragment,Lt),Ab=d(Lt),Eo=a(Lt,"P",{});var pi=i(Eo);Ib=s(pi,"The "),Wa=a(pi,"A",{href:!0});var A1=i(Wa);Db=s(A1,"TFMobileBertForMultipleChoice"),A1.forEach(t),Ob=s(pi," forward method, overrides the "),Hl=a(pi,"CODE",{});var I1=i(Hl);Lb=s(I1,"__call__"),I1.forEach(t),Wb=s(pi," special method."),pi.forEach(t),Rb=d(Lt),y(Tn.$$.fragment,Lt),Hb=d(Lt),Ql=a(Lt,"P",{});var D1=i(Ql);Qb=s(D1,"Example:"),D1.forEach(t),Ub=d(Lt),y(Ar.$$.fragment,Lt),Lt.forEach(t),vt.forEach(t),sc=d(o),zo=a(o,"H2",{class:!0});var pp=i(zo);kn=a(pp,"A",{id:!0,class:!0,href:!0});var O1=i(kn);Ul=a(O1,"SPAN",{});var L1=i(Ul);y(Ir.$$.fragment,L1),L1.forEach(t),O1.forEach(t),Vb=d(pp),Vl=a(pp,"SPAN",{});var W1=i(Vl);Kb=s(W1,"TFMobileBertForTokenClassification"),W1.forEach(t),pp.forEach(t),rc=d(o),De=a(o,"DIV",{class:!0});var Tt=i(De);y(Dr.$$.fragment,Tt),Gb=d(Tt),Kl=a(Tt,"P",{});var R1=i(Kl);Jb=s(R1,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R1.forEach(t),Yb=d(Tt),Or=a(Tt,"P",{});var hp=i(Or);Zb=s(hp,"This model inherits from "),Ra=a(hp,"A",{href:!0});var H1=i(Ra);Xb=s(H1,"TFPreTrainedModel"),H1.forEach(t),ev=s(hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),tv=d(Tt),Lr=a(Tt,"P",{});var mp=i(Lr);ov=s(mp,"This model is also a "),Wr=a(mp,"A",{href:!0,rel:!0});var Q1=i(Wr);nv=s(Q1,"tf.keras.Model"),Q1.forEach(t),sv=s(mp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mp.forEach(t),rv=d(Tt),y(Mn.$$.fragment,Tt),av=d(Tt),it=a(Tt,"DIV",{class:!0});var Wt=i(it);y(Rr.$$.fragment,Wt),iv=d(Wt),Po=a(Wt,"P",{});var hi=i(Po);lv=s(hi,"The "),Ha=a(hi,"A",{href:!0});var U1=i(Ha);dv=s(U1,"TFMobileBertForTokenClassification"),U1.forEach(t),cv=s(hi," forward method, overrides the "),Gl=a(hi,"CODE",{});var V1=i(Gl);pv=s(V1,"__call__"),V1.forEach(t),hv=s(hi," special method."),hi.forEach(t),mv=d(Wt),y(wn.$$.fragment,Wt),uv=d(Wt),Jl=a(Wt,"P",{});var K1=i(Jl);fv=s(K1,"Example:"),K1.forEach(t),gv=d(Wt),y(Hr.$$.fragment,Wt),Wt.forEach(t),Tt.forEach(t),ac=d(o),qo=a(o,"H2",{class:!0});var up=i(qo);yn=a(up,"A",{id:!0,class:!0,href:!0});var G1=i(yn);Yl=a(G1,"SPAN",{});var J1=i(Yl);y(Qr.$$.fragment,J1),J1.forEach(t),G1.forEach(t),_v=d(up),Zl=a(up,"SPAN",{});var Y1=i(Zl);bv=s(Y1,"TFMobileBertForQuestionAnswering"),Y1.forEach(t),up.forEach(t),ic=d(o),Oe=a(o,"DIV",{class:!0});var kt=i(Oe);y(Ur.$$.fragment,kt),vv=d(kt),xo=a(kt,"P",{});var mi=i(xo);Tv=s(mi,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
