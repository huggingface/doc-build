...
`}}),ko=new Ne({props:{$$slots:{default:[W_]},$$scope:{ctx:H}}}),Sn=new Ye({props:{code:`from transformers import MPNetTokenizer, MPNetForTokenClassification
import torch
...
`}}),So=new Ne({props:{$$slots:{default:[ev]},$$scope:{ctx:H}}}),Ls=new Ye({props:{code:`from transformers import MPNetTokenizer, TFMPNetForQuestionAnswering
import tensorflow as tf
