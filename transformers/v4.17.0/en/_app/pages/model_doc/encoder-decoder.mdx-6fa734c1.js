import{S as xi,i as ji,s as $i,e as a,k as i,w as u,t as n,M as qi,c as s,d as o,m as c,a as d,x as g,h as r,b as l,F as e,g as m,y as _,q as v,o as b,B as y}from"../../chunks/vendor-4833417e.js";import{T as dd}from"../../chunks/Tip-fffd6df1.js";import{D as O}from"../../chunks/Docstring-7b52c3d4.js";import{C as Me}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Rt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Pi(Q){let h,x,f,w,P;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
...
the latter silently ignores them.`)},l(k){h=s(k,"P",{});var T=d(h);x=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){m(k,h,T),e(h,x),e(h,f),e(f,w),e(h,P)},d(k){k&&o(h)}}}function Ai(Q){let h,x,f,w,P,k,T,F,zn,Gt,he,Mn,wo,xn,jn,Ut,me,$n,xe,qn,Pn,Vt,fe,Fn,Eo,Cn,An,Ht,W,Sn,Do,Nn,In,je,Ln,Bn,Yt,R,On,Qo,Wn,Rn,Xo,Gn,Un,Jt,$e,Zt,G,Vn,qe,Hn,Yn,Pe,Jn,Zn,Kt,X,ue,et,Fe,Kn,ot,Qn,Qt,M,Ce,Xn,ge,zo,er,or,Mo,tr,nr,rr,ee,ar,xo,sr,dr,jo,ir,cr,lr,tt,pr,hr,Ae,mr,_e,Se,fr,Ne,ur,$o,gr,_r,vr,ve,Ie,br,oe,yr,nt,kr,Tr,rt,wr,Er,Xt,te,be,at,Le,Dr,st,zr,en,E,Be,Mr,ne,xr,dt,jr,$r,it,qr,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ct,Ir,Lr,Re,Br,qo,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Yr,Jr,lt,Zr,Kr,pt,Qr,Xr,ea,C,Ve,oa,re,ta,Fo,na,ra,ht,aa,sa,da,ye,ia,mt,ca,la,He,pa,A,Ye,ha,ft,ma,fa,ae,ua,ut,ga,_a,gt,va,ba,ya,_t,ka,Ta,Je,on,se,ke,vt,Ze,wa,bt,Ea,tn,D,Ke,Da,de,za,yt,Ma,xa,kt,ja,$a,qa,Qe,Pa,Xe,Fa,Ca,Aa,Tt,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,to,Ra,Ga,Ua,V,Ao,Va,Ha,wt,Ya,Ja,Et,Za,Ka,Qa,S,no,Xa,ie,es,So,os,ts,Dt,ns,rs,as,Te,ss,zt,ds,is,ro,cs,L,ao,ls,Mt,ps,hs,xt,ms,fs,so,nn,ce,we,jt,io,us,$t,gs,rn,z,co,_s,le,vs,qt,bs,ys,Pt,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Ft,xs,js,ho,$s,No,qs,Ps,Fs,mo,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,Ct,Bs,Os,At,Ws,Rs,Gs,N,uo,Us,pe,Vs,Lo,Hs,Ys,St,Js,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,vo,an;return k=new Rt({}),$e=new Me({props:{codee:`# a workaround to load from pytorch checkpoint
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),vo=new Me({props:{codee:`from transformers import FlaxEncoderDecoderModel
...
decoder model configuration.`),vr=i(),ve=a("div"),u(Ie.$$.fragment),br=i(),oe=a("p"),yr=n("Serializes this instance to a Python dictionary. Override the default "),nt=a("em"),kr=n("to_dict()"),Tr=n(" from "),rt=a("em"),wr=n("PretrainedConfig"),Er=n("."),Xt=i(),te=a("h2"),be=a("a"),at=a("span"),u(Le.$$.fragment),Dr=i(),st=a("span"),zr=n("EncoderDecoderModel"),en=i(),E=a("div"),u(Be.$$.fragment),Mr=i(),ne=a("p"),xr=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
checkpoints.`),hs=i(),xt=a("p"),ms=n("Example:"),fs=i(),u(so.$$.fragment),nn=i(),ce=a("h2"),we=a("a"),jt=a("span"),u(io.$$.fragment),us=i(),$t=a("span"),gs=n("FlaxEncoderDecoderModel"),rn=i(),z=a("div"),u(co.$$.fragment),_s=i(),le=a("p"),vs=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),qt=a("code"),bs=n("from_pretrained()"),ys=n("function and the decoder is loaded via "),Pt=a("code"),ks=n("from_pretrained()"),Ts=n(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
checkpoints.`),rd=i(),Lt=a("p"),ad=n("Example:"),sd=i(),u(vo.$$.fragment),this.h()},l(t){const p=qi('[data-svelte="svelte-1phssyn"]',document.head);h=s(p,"META",{name:!0,content:!0}),p.forEach(o),x=c(t),f=s(t,"H1",{class:!0});var bo=d(f);w=s(bo,"A",{id:!0,class:!0,href:!0});var Bt=d(w);P=s(Bt,"SPAN",{});var Ot=d(P);g(k.$$.fragment,Ot),Ot.forEach(o),Bt.forEach(o),T=c(bo),F=s(bo,"SPAN",{});var id=d(F);zn=r(id,"Encoder Decoder Models"),id.forEach(o),bo.forEach(o),Gt=c(t),he=s(t,"P",{});var sn=d(he);Mn=r(sn,"The "),wo=s(sn,"A",{href:!0});var cd=d(wo);xn=r(cd,"EncoderDecoderModel"),cd.forEach(o),jn=r(sn,` can be used to initialize a sequence-to-sequence model with any
...
decoder model configuration.`),hn.forEach(o),pn.forEach(o),vr=c(I),ve=s(I,"DIV",{class:!0});var mn=d(ve);g(Ie.$$.fragment,mn),br=c(mn),oe=s(mn,"P",{});var Go=d(oe);yr=r(Go,"Serializes this instance to a Python dictionary. Override the default "),nt=s(Go,"EM",{});var Md=d(nt);kr=r(Md,"to_dict()"),Md.forEach(o),Tr=r(Go," from "),rt=s(Go,"EM",{});var xd=d(rt);wr=r(xd,"PretrainedConfig"),xd.forEach(o),Er=r(Go,"."),Go.forEach(o),mn.forEach(o),I.forEach(o),Xt=c(t),te=s(t,"H2",{class:!0});var fn=d(te);be=s(fn,"A",{id:!0,class:!0,href:!0});var jd=d(be);at=s(jd,"SPAN",{});var $d=d(at);g(Le.$$.fragment,$d),$d.forEach(o),jd.forEach(o),Dr=c(fn),st=s(fn,"SPAN",{});var qd=d(st);zr=r(qd,"EncoderDecoderModel"),qd.forEach(o),fn.forEach(o),en=c(t),E=s(t,"DIV",{class:!0});var j=d(E);g(Be.$$.fragment,j),Mr=c(j),ne=s(j,"P",{});var Uo=d(ne);xr=r(Uo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
generative task, like summarization.`),Yo.forEach(o),qa=c($),Qe=s($,"P",{});var bn=d(Qe);Pa=r(bn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),bn.forEach(o),Aa=c($),Tt=s($,"P",{});var ei=d(Tt);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
checkpoints.`),ci.forEach(o),hs=c(De),xt=s(De,"P",{});var li=d(xt);ms=r(li,"Example:"),li.forEach(o),fs=c(De),g(so.$$.fragment,De),De.forEach(o),$.forEach(o),nn=c(t),ce=s(t,"H2",{class:!0});var Tn=d(ce);we=s(Tn,"A",{id:!0,class:!0,href:!0});var pi=d(we);jt=s(pi,"SPAN",{});var hi=d(jt);g(io.$$.fragment,hi),hi.forEach(o),pi.forEach(o),us=c(Tn),$t=s(Tn,"SPAN",{});var mi=d($t);gs=r(mi,"FlaxEncoderDecoderModel"),mi.forEach(o),Tn.forEach(o),rn=c(t),z=s(t,"DIV",{class:!0});var q=d(z);g(co.$$.fragment,q),_s=c(q),le=s(q,"P",{});var Zo=d(le);vs=r(Zo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),qt=s(Zo,"CODE",{});var fi=d(qt);bs=r(fi,"from_pretrained()"),fi.forEach(o),ys=r(Zo,"function and the decoder is loaded via "),Pt=s(Zo,"CODE",{});var ui=d(Pt);ks=r(ui,"from_pretrained()"),ui.forEach(o),Ts=r(Zo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
(see the examples for more information).`),_i.forEach(o),js=c(q),ho=s(q,"P",{});var En=d(ho);$s=r(En,"This model inherits from "),No=s(En,"A",{href:!0});var vi=d(No);qs=r(vi,"FlaxPreTrainedModel"),vi.forEach(o),Ps=r(En,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
