import{S as ZT,i as YT,s as e1,e as n,k as d,w as m,t as r,M as t1,c as a,d as t,m as l,a as s,x as f,h as i,b as c,F as e,g as u,y as _,q as g,o as k,B as b}from"../../chunks/vendor-4833417e.js";import{T as De}from"../../chunks/Tip-fffd6df1.js";import{D as F}from"../../chunks/Docstring-7b52c3d4.js";import{C as P}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as J}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function o1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("When used with "),v=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer will add a space before each word (even the first one).")},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"When used with "),v=a(y,"CODE",{});var q=s(v);w=i(q,"is_split_into_words=True"),q.forEach(t),x=i(y,", this tokenizer will add a space before each word (even the first one)."),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function n1(j){let p,B,v,w,x,T,y,q;return{c(){p=n("p"),B=r("When used with "),v=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer needs to be instantiated with "),T=n("code"),y=r("add_prefix_space=True"),q=r(".")},l(ne){p=a(ne,"P",{});var A=s(p);B=i(A,"When used with "),v=a(A,"CODE",{});var $=s(v);w=i($,"is_split_into_words=True"),$.forEach(t),x=i(A,", this tokenizer needs to be instantiated with "),T=a(A,"CODE",{});var le=s(T);y=i(le,"add_prefix_space=True"),le.forEach(t),q=i(A,"."),A.forEach(t)},m(ne,A){u(ne,p,A),e(p,B),e(p,v),e(v,w),e(p,x),e(p,T),e(T,y),e(p,q)},d(ne){ne&&t(p)}}}function a1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function s1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function r1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function i1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function d1(j){let p,B,v,w,x,T,y,q,ne,A,$,le,_e,Ke,ge,ke,Ze,Je,H,O,Le,ae,C,I,Ye,ce,pe,et,Q,tt,ot,D,qe,be,Xe,X,se,nt,at,V,st,ve,Ge;return{c(){p=n("p"),B=r("TF 2.0 models accepts two formats as inputs:"),v=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=n("li"),ne=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),le=r("This second option is useful when using "),_e=n("code"),Ke=r("tf.keras.Model.fit"),ge=r(` method which currently requires having all the
...
`),ve=n("code"),Ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=a(z,"P",{});var M=s(p);B=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),v=l(z),w=a(z,"UL",{});var U=s(w);x=a(U,"LI",{});var It=s(x);T=i(It,"having all inputs as keyword arguments (like PyTorch models), or"),It.forEach(t),y=l(U),q=a(U,"LI",{});var We=s(q);ne=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),U.forEach(t),A=l(z),$=a(z,"P",{});var re=s($);le=i(re,"This second option is useful when using "),_e=a(re,"CODE",{});var St=s(_e);Ke=i(St,"tf.keras.Model.fit"),St.forEach(t),ge=i(re,` method which currently requires having all the
...
`),ve=a(He,"CODE",{});var Dt=s(ve);Ge=i(Dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Dt.forEach(t),He.forEach(t),ie.forEach(t)},m(z,M){u(z,p,M),e(p,B),u(z,v,M),u(z,w,M),e(w,x),e(x,T),e(w,y),e(w,q),e(q,ne),u(z,A,M),u(z,$,M),e($,le),e($,_e),e(_e,Ke),e($,ge),e($,ke),e(ke,Ze),e($,Je),u(z,H,M),u(z,O,M),e(O,Le),u(z,ae,M),u(z,C,M),e(C,I),e(I,Ye),e(I,ce),e(ce,pe),e(I,et),e(I,Q),e(Q,tt),e(C,ot),e(C,D),e(D,qe),e(D,be),e(be,Xe),e(D,X),e(D,se),e(se,nt),e(C,at),e(C,V),e(V,st),e(V,ve),e(ve,Ge)},d(z){z&&t(p),z&&t(v),z&&t(w),z&&t(A),z&&t($),z&&t(H),z&&t(O),z&&t(ae),z&&t(C)}}}function l1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function c1(j){let p,B,v,w,x,T,y,q,ne,A,$,le,_e,Ke,ge,ke,Ze,Je,H,O,Le,ae,C,I,Ye,ce,pe,et,Q,tt,ot,D,qe,be,Xe,X,se,nt,at,V,st,ve,Ge;return{c(){p=n("p"),B=r("TF 2.0 models accepts two formats as inputs:"),v=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=n("li"),ne=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),le=r("This second option is useful when using "),_e=n("code"),Ke=r("tf.keras.Model.fit"),ge=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ke=n("code"),Ze=r("model(inputs)"),Je=r("."),H=d(),O=n("p"),Le=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ae=d(),C=n("ul"),I=n("li"),Ye=r("a single Tensor with "),ce=n("code"),pe=r("input_ids"),et=r(" only and nothing else: "),Q=n("code"),tt=r("model(input_ids)"),ot=d(),D=n("li"),qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),be=n("code"),Xe=r("model([input_ids, attention_mask])"),X=r(" or "),se=n("code"),nt=r("model([input_ids, attention_mask, token_type_ids])"),at=d(),V=n("li"),st=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ve=n("code"),Ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=a(z,"P",{});var M=s(p);B=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),v=l(z),w=a(z,"UL",{});var U=s(w);x=a(U,"LI",{});var It=s(x);T=i(It,"having all inputs as keyword arguments (like PyTorch models), or"),It.forEach(t),y=l(U),q=a(U,"LI",{});var We=s(q);ne=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),U.forEach(t),A=l(z),$=a(z,"P",{});var re=s($);le=i(re,"This second option is useful when using "),_e=a(re,"CODE",{});var St=s(_e);Ke=i(St,"tf.keras.Model.fit"),St.forEach(t),ge=i(re,` method which currently requires having all the
...
first positional argument :`),Nt.forEach(t),ae=l(z),C=a(z,"UL",{});var ie=s(C);I=a(ie,"LI",{});var he=s(I);Ye=i(he,"a single Tensor with "),ce=a(he,"CODE",{});var ye=s(ce);pe=i(ye,"input_ids"),ye.forEach(t),et=i(he," only and nothing else: "),Q=a(he,"CODE",{});var Fe=s(Q);tt=i(Fe,"model(input_ids)"),Fe.forEach(t),he.forEach(t),ot=l(ie),D=a(ie,"LI",{});var de=s(D);qe=i(de,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),be=a(de,"CODE",{});var Ue=s(be);Xe=i(Ue,"model([input_ids, attention_mask])"),Ue.forEach(t),X=i(de," or "),se=a(de,"CODE",{});var Ot=s(se);nt=i(Ot,"model([input_ids, attention_mask, token_type_ids])"),Ot.forEach(t),de.forEach(t),at=l(ie),V=a(ie,"LI",{});var He=s(V);st=i(He,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ve=a(He,"CODE",{});var Dt=s(ve);Ge=i(Dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Dt.forEach(t),He.forEach(t),ie.forEach(t)},m(z,M){u(z,p,M),e(p,B),u(z,v,M),u(z,w,M),e(w,x),e(x,T),e(w,y),e(w,q),e(q,ne),u(z,A,M),u(z,$,M),e($,le),e($,_e),e(_e,Ke),e($,ge),e($,ke),e(ke,Ze),e($,Je),u(z,H,M),u(z,O,M),e(O,Le),u(z,ae,M),u(z,C,M),e(C,I),e(I,Ye),e(I,ce),e(ce,pe),e(I,et),e(I,Q),e(Q,tt),e(C,ot),e(C,D),e(D,qe),e(D,be),e(be,Xe),e(D,X),e(D,se),e(se,nt),e(C,at),e(C,V),e(V,st),e(V,ve),e(ve,Ge)},d(z){z&&t(p),z&&t(v),z&&t(w),z&&t(A),z&&t($),z&&t(H),z&&t(O),z&&t(ae),z&&t(C)}}}function p1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function h1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function u1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function m1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function f1(j){let p,B,v,w,x;return{c(){p=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var y=s(p);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);w=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){u(T,p,y),e(p,B),e(p,v),e(v,w),e(p,x)},d(T){T&&t(p)}}}function _1(j){let p,B,v,w,x,T,y,q,ne,A,$,le,_e,Ke,ge,ke,Ze,Je,H,O,Le,ae,C,I,Ye,ce,pe,et,Q,tt,ot,D,qe,be,Xe,X,se,nt,at,V,st,ve,Ge,z,M,U,It,We,re,St,Re,Nt,ie,he,ye,Fe,de,Ue,Ot,He,Dt,yl,ht,un,Zc,mn,Yc,ep,tp,rt,op,Vs,np,ap,ei,sp,rp,fn,ip,dp,lp,To,_n,cp,pp,gn,hp,up,Tl,Lt,wo,ti,kn,mp,oi,fp,wl,$e,it,_p,ni,gp,kp,Js,bp,vp,Xs,yp,Tp,wp,Gt,xp,Ks,zp,Bp,ai,qp,Fp,$p,Wt,jp,si,Mp,Ep,ri,Pp,Cp,Ap,Zs,Ys,Ip,Sp,Np,Rt,Op,ii,Dp,Lp,di,Gp,Wp,xl,Ut,xo,li,bn,Rp,ci,Up,zl,ut,Hp,pi,Qp,Vp,hi,Jp,Xp,Bl,vn,ql,Ht,zo,ui,yn,Kp,mi,Zp,Fl,Te,Tn,Yp,Qt,eh,er,th,oh,wn,nh,ah,sh,Vt,rh,tr,ih,dh,or,lh,ch,ph,fi,hh,uh,xn,$l,Jt,Bo,_i,zn,mh,gi,fh,jl,E,Bn,_h,ki,gh,kh,bi,bh,vh,qn,yh,Fn,Th,vi,wh,xh,zh,qo,Bh,$n,qh,nr,Fh,$h,jh,mt,jn,Mh,yi,Eh,Ph,Mn,ar,Ch,Ti,Ah,Ih,sr,Sh,wi,Nh,Oh,Fo,En,Dh,xi,Lh,Gh,$o,Pn,Wh,zi,Rh,Uh,jo,Cn,Hh,An,Qh,Bi,Vh,Jh,Ml,Xt,Mo,qi,In,Xh,Fi,Kh,El,G,Sn,Zh,Nn,Yh,$i,eu,tu,ou,ji,nu,au,On,su,Dn,ru,Mi,iu,du,lu,Eo,cu,Ln,pu,rr,hu,uu,mu,Po,Gn,fu,Ei,_u,Pl,Kt,Co,Pi,Wn,gu,Ci,ku,Cl,Qe,Rn,bu,Un,vu,ir,yu,Tu,wu,Hn,xu,Qn,zu,Bu,qu,je,Vn,Fu,Zt,$u,dr,ju,Mu,Ai,Eu,Pu,Cu,Ao,Au,Ii,Iu,Su,Jn,Al,Yt,Io,Si,Xn,Nu,Ni,Ou,Il,Ve,Kn,Du,Zn,Lu,lr,Gu,Wu,Ru,Yn,Uu,ea,Hu,Qu,Vu,K,ta,Ju,eo,Xu,cr,Ku,Zu,Oi,Yu,em,tm,So,om,Di,nm,am,oa,sm,Li,rm,im,na,Sl,to,No,Gi,aa,dm,Wi,lm,Nl,we,sa,cm,Ri,pm,hm,ra,um,pr,mm,fm,_m,ia,gm,da,km,bm,vm,Z,la,ym,oo,Tm,hr,wm,xm,Ui,zm,Bm,qm,Oo,Fm,Hi,$m,jm,ca,Mm,Qi,Em,Pm,pa,Ol,no,Do,Vi,ha,Cm,Ji,Am,Dl,xe,ua,Im,ao,Sm,Xi,Nm,Om,Ki,Dm,Lm,Gm,ma,Wm,ur,Rm,Um,Hm,fa,Qm,_a,Vm,Jm,Xm,Me,ga,Km,so,Zm,mr,Ym,ef,Zi,tf,of,nf,Lo,af,Yi,sf,rf,ka,Ll,ro,Go,ed,ba,df,td,lf,Gl,io,va,cf,ft,ya,pf,od,hf,uf,Ta,Wl,lo,Wo,nd,wa,mf,ad,ff,Rl,ze,xa,_f,za,gf,fr,kf,bf,vf,Ba,yf,qa,Tf,wf,xf,Ro,zf,Ee,Fa,Bf,co,qf,_r,Ff,$f,sd,jf,Mf,Ef,Uo,Pf,rd,Cf,Af,$a,Ul,po,Ho,id,ja,If,dd,Sf,Hl,Be,Ma,Nf,Ea,Of,gr,Df,Lf,Gf,Pa,Wf,Ca,Rf,Uf,Hf,Qo,Qf,Y,Aa,Vf,ho,Jf,kr,Xf,Kf,ld,Zf,Yf,e_,Vo,t_,cd,o_,n_,Ia,a_,pd,s_,r_,Sa,Ql,uo,Jo,hd,Na,i_,ud,d_,Vl,W,Oa,l_,Da,c_,br,p_,h_,u_,La,m_,Ga,f_,__,g_,md,k_,b_,dt,fd,Wa,v_,y_,_d,Ra,T_,w_,gd,Ua,x_,z_,kd,Ha,B_,q_,Pe,Qa,F_,mo,$_,bd,j_,M_,vd,E_,P_,C_,Xo,A_,yd,I_,S_,Va,N_,_t,Ja,O_,Td,D_,L_,Xa,G_,gt,Ka,W_,wd,R_,U_,Za,Jl,fo,Ko,xd,Ya,H_,zd,Q_,Xl,R,es,V_,ts,J_,vr,X_,K_,Z_,os,Y_,ns,eg,tg,og,Bd,ng,ag,lt,qd,as,sg,rg,Fd,ss,ig,dg,$d,rs,lg,cg,jd,is,pg,hg,ee,ds,ug,_o,mg,Md,fg,_g,Ed,gg,kg,bg,Zo,vg,Pd,yg,Tg,ls,wg,Cd,xg,zg,cs,Bg,kt,ps,qg,Ad,Fg,$g,hs,jg,bt,us,Mg,Id,Eg,Pg,ms,Kl,go,Yo,Sd,fs,Cg,Nd,Ag,Zl,S,_s,Ig,Od,Sg,Ng,gs,Og,yr,Dg,Lg,Gg,ks,Wg,bs,Rg,Ug,Hg,Dd,Qg,Vg,ct,Ld,vs,Jg,Xg,Gd,ys,Kg,Zg,Wd,Ts,Yg,ek,Rd,ws,tk,ok,Ce,xs,nk,ko,ak,Ud,sk,rk,Hd,ik,dk,lk,en,ck,Qd,pk,hk,zs,uk,vt,Bs,mk,Vd,fk,_k,qs,gk,yt,Fs,kk,Jd,bk,vk,$s,Yl,bo,tn,Xd,js,yk,Kd,Tk,ec,N,Ms,wk,vo,xk,Zd,zk,Bk,Yd,qk,Fk,$k,Es,jk,Tr,Mk,Ek,Pk,Ps,Ck,Cs,Ak,Ik,Sk,el,Nk,Ok,pt,tl,As,Dk,Lk,ol,Is,Gk,Wk,nl,Ss,Rk,Uk,al,Ns,Hk,Qk,Ae,Os,Vk,yo,Jk,sl,Xk,Kk,rl,Zk,Yk,eb,on,tb,il,ob,nb,Ds,ab,Tt,Ls,sb,dl,rb,ib,Gs,db,wt,Ws,lb,ll,cb,pb,Rs,tc;return T=new J({}),ae=new J({}),Ue=new J({}),kn=new J({}),bn=new J({}),vn=new P({props:{code:`from transformers import BartForConditionalGeneration, BartTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("meta"),B=d(),v=n("h1"),w=n("a"),x=n("span"),m(T.$$.fragment),y=d(),q=n("span"),ne=r("BART"),A=d(),$=n("p"),le=n("strong"),_e=r("DISCLAIMER:"),Ke=r(" If you see something strange, file a "),ge=n("a"),ke=r("Github Issue"),Ze=r(` and assign
...
of up to 6 ROUGE.`),M=d(),U=n("p"),It=r("This model was contributed by "),We=n("a"),re=r("sshleifer"),St=r(". The Authors\u2019 code can be found "),Re=n("a"),Nt=r("here"),ie=r("."),he=d(),ye=n("h3"),Fe=n("a"),de=n("span"),m(Ue.$$.fragment),Ot=d(),He=n("span"),Dt=r("Examples"),yl=d(),ht=n("ul"),un=n("li"),Zc=r(`Examples and scripts for fine-tuning BART and other models for sequence to sequence tasks can be found in
...
`),Xs=n("a"),yp=r("encode()"),Tp=r(" to get the proper splitting."),wp=d(),Gt=n("li"),xp=r("The forward pass of "),Ks=n("a"),zp=r("BartModel"),Bp=r(" will create the "),ai=n("code"),qp=r("decoder_input_ids"),Fp=r(` if they are not passed.
...
mask-filling tasks.`),xl=d(),Ut=n("h2"),xo=n("a"),li=n("span"),m(bn.$$.fragment),Rp=d(),ci=n("span"),Up=r("Mask Filling"),zl=d(),ut=n("p"),Hp=r("The "),pi=n("code"),Qp=r("facebook/bart-base"),Vp=r(" and "),hi=n("code"),Jp=r("facebook/bart-large"),Xp=r(" checkpoints can be used to fill multi-token masks."),Bl=d(),m(vn.$$.fragment),ql=d(),Ht=n("h2"),zo=n("a"),ui=n("span"),m(yn.$$.fragment),Kp=d(),mi=n("span"),Zp=r("BartConfig"),Fl=d(),Te=n("div"),m(Tn.$$.fragment),Yp=d(),Qt=n("p"),eh=r("This is the configuration class to store the configuration of a "),er=n("a"),th=r("BartModel"),oh=r(`. It is used to instantiate a BART
...
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),vh=d(),m(qn.$$.fragment),yh=d(),Fn=n("p"),Th=r("You can get around that behavior by passing "),vi=n("code"),wh=r("add_prefix_space=True"),xh=r(` when instantiating this tokenizer or when you
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vm=d(),Z=n("div"),m(la.$$.fragment),ym=d(),oo=n("p"),Tm=r("The "),hr=n("a"),wm=r("BartForSequenceClassification"),xm=r(" forward method, overrides the "),Ui=n("code"),zm=r("__call__"),Bm=r(" special method."),qm=d(),m(Oo.$$.fragment),Fm=d(),Hi=n("p"),$m=r("Example of single-label classification:"),jm=d(),m(ca.$$.fragment),Mm=d(),Qi=n("p"),Em=r("Example of multi-label classification:"),Pm=d(),m(pa.$$.fragment),Ol=d(),no=n("h2"),Do=n("a"),Vi=n("span"),m(ha.$$.fragment),Cm=d(),Ji=n("span"),Am=r("BartForQuestionAnswering"),Dl=d(),xe=n("div"),m(ua.$$.fragment),Im=d(),ao=n("p"),Sm=r(`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vf=d(),Ba=n("p"),yf=r("This model is also a "),qa=n("a"),Tf=r("tf.keras.Model"),wf=r(` subclass. Use it
...
tasks.`),Ng=d(),gs=n("p"),Og=r("This model inherits from "),yr=n("a"),Dg=r("FlaxPreTrainedModel"),Lg=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gg=d(),ks=n("p"),Wg=r(`This model is also a Flax Linen
`),bs=n("a"),Rg=r("flax.nn.Module"),Ug=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Hg=d(),Dd=n("p"),Qg=r("Finally, this model supports inherent JAX features such as:"),Vg=d(),ct=n("ul"),Ld=n("li"),vs=n("a"),Jg=r("Just-In-Time (JIT) compilation"),Xg=d(),Gd=n("li"),ys=n("a"),Kg=r("Automatic Differentiation"),Zg=d(),Wd=n("li"),Ts=n("a"),Yg=r("Vectorization"),ek=d(),Rd=n("li"),ws=n("a"),tk=r("Parallelization"),ok=d(),Ce=n("div"),m(xs.$$.fragment),nk=d(),ko=n("p"),ak=r("The "),Ud=n("code"),sk=r("FlaxBartPreTrainedModel"),rk=r("forward method, overrides the "),Hd=n("code"),ik=r("__call__"),dk=r(" special method."),lk=d(),m(en.$$.fragment),ck=d(),Qd=n("p"),pk=r("Example:"),hk=d(),m(zs.$$.fragment),uk=d(),vt=n("div"),m(Bs.$$.fragment),mk=d(),Vd=n("p"),fk=r("Example:"),_k=d(),m(qs.$$.fragment),gk=d(),yt=n("div"),m(Fs.$$.fragment),kk=d(),Jd=n("p"),bk=r("Example:"),vk=d(),m($s.$$.fragment),Yl=d(),bo=n("h2"),tn=n("a"),Xd=n("span"),m(js.$$.fragment),yk=d(),Kd=n("span"),Tk=r("FlaxBartForQuestionAnswering"),ec=d(),N=n("div"),m(Ms.$$.fragment),wk=d(),vo=n("p"),xk=r(`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
documentation from `),or=a(Mr,"A",{href:!0});var Yb=s(or);lh=i(Yb,"PretrainedConfig"),Yb.forEach(t),ch=i(Mr," for more information."),Mr.forEach(t),ph=l(zt),fi=a(zt,"P",{});var ev=s(fi);hh=i(ev,"Example:"),ev.forEach(t),uh=l(zt),f(xn.$$.fragment,zt),zt.forEach(t),$l=l(o),Jt=a(o,"H2",{class:!0});var ic=s(Jt);Bo=a(ic,"A",{id:!0,class:!0,href:!0});var tv=s(Bo);_i=a(tv,"SPAN",{});var ov=s(_i);f(zn.$$.fragment,ov),ov.forEach(t),tv.forEach(t),mh=l(ic),gi=a(ic,"SPAN",{});var nv=s(gi);fh=i(nv,"BartTokenizer"),nv.forEach(t),ic.forEach(t),jl=l(o),E=a(o,"DIV",{class:!0});var L=s(E);f(Bn.$$.fragment,L),_h=l(L),ki=a(L,"P",{});var av=s(ki);gh=i(av,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),av.forEach(t),kh=l(L),bi=a(L,"P",{});var sv=s(bi);bh=i(sv,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),sv.forEach(t),vh=l(L),f(qn.$$.fragment,L),yh=l(L),Fn=a(L,"P",{});var dc=s(Fn);Th=i(dc,"You can get around that behavior by passing "),vi=a(dc,"CODE",{});var rv=s(vi);wh=i(rv,"add_prefix_space=True"),rv.forEach(t),xh=i(dc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),dc.forEach(t),zh=l(L),f(qo.$$.fragment,L),Bh=l(L),$n=a(L,"P",{});var lc=s($n);qh=i(lc,"This tokenizer inherits from "),nr=a(lc,"A",{href:!0});var iv=s(nr);Fh=i(iv,"PreTrainedTokenizer"),iv.forEach(t),$h=i(lc,` which contains most of the main methods. Users should refer to
...
special tokens using the tokenizer `),Bi=a(mc,"CODE",{});var uv=s(Bi);Vh=i(uv,"prepare_for_model"),uv.forEach(t),Jh=i(mc," method."),mc.forEach(t),uc.forEach(t),L.forEach(t),Ml=l(o),Xt=a(o,"H2",{class:!0});var fc=s(Xt);Mo=a(fc,"A",{id:!0,class:!0,href:!0});var mv=s(Mo);qi=a(mv,"SPAN",{});var fv=s(qi);f(In.$$.fragment,fv),fv.forEach(t),mv.forEach(t),Xh=l(fc),Fi=a(fc,"SPAN",{});var _v=s(Fi);Kh=i(_v,"BartTokenizerFast"),_v.forEach(t),fc.forEach(t),El=l(o),G=a(o,"DIV",{class:!0});var ue=s(G);f(Sn.$$.fragment,ue),Zh=l(ue),Nn=a(ue,"P",{});var _c=s(Nn);Yh=i(_c,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),$i=a(_c,"EM",{});var gv=s($i);eu=i(gv,"tokenizers"),gv.forEach(t),tu=i(_c,` library), derived from the GPT-2 tokenizer,
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yc.forEach(t),wu=l(rn),Hn=a(rn,"P",{});var Tc=s(Hn);xu=i(Tc,"This model is also a PyTorch "),Qn=a(Tc,"A",{href:!0,rel:!0});var Bv=s(Qn);zu=i(Bv,"torch.nn.Module"),Bv.forEach(t),Bu=i(Tc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc.forEach(t),qu=l(rn),je=a(rn,"DIV",{class:!0});var Bt=s(je);f(Vn.$$.fragment,Bt),Fu=l(Bt),Zt=a(Bt,"P",{});var Pr=s(Zt);$u=i(Pr,"The "),dr=a(Pr,"A",{href:!0});var qv=s(dr);ju=i(qv,"BartModel"),qv.forEach(t),Mu=i(Pr," forward method, overrides the "),Ai=a(Pr,"CODE",{});var Fv=s(Ai);Eu=i(Fv,"__call__"),Fv.forEach(t),Pu=i(Pr," special method."),Pr.forEach(t),Cu=l(Bt),f(Ao.$$.fragment,Bt),Au=l(Bt),Ii=a(Bt,"P",{});var $v=s(Ii);Iu=i($v,"Example:"),$v.forEach(t),Su=l(Bt),f(Jn.$$.fragment,Bt),Bt.forEach(t),rn.forEach(t),Al=l(o),Yt=a(o,"H2",{class:!0});var wc=s(Yt);Io=a(wc,"A",{id:!0,class:!0,href:!0});var jv=s(Io);Si=a(jv,"SPAN",{});var Mv=s(Si);f(Xn.$$.fragment,Mv),Mv.forEach(t),jv.forEach(t),Nu=l(wc),Ni=a(wc,"SPAN",{});var Ev=s(Ni);Ou=i(Ev,"BartForConditionalGeneration"),Ev.forEach(t),wc.forEach(t),Il=l(o),Ve=a(o,"DIV",{class:!0});var dn=s(Ve);f(Kn.$$.fragment,dn),Du=l(dn),Zn=a(dn,"P",{});var xc=s(Zn);Lu=i(xc,`The BART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zc.forEach(t),Vu=l(dn),K=a(dn,"DIV",{class:!0});var Ie=s(K);f(ta.$$.fragment,Ie),Ju=l(Ie),eo=a(Ie,"P",{});var Cr=s(eo);Xu=i(Cr,"The "),cr=a(Cr,"A",{href:!0});var Av=s(cr);Ku=i(Av,"BartForConditionalGeneration"),Av.forEach(t),Zu=i(Cr," forward method, overrides the "),Oi=a(Cr,"CODE",{});var Iv=s(Oi);Yu=i(Iv,"__call__"),Iv.forEach(t),em=i(Cr," special method."),Cr.forEach(t),tm=l(Ie),f(So.$$.fragment,Ie),om=l(Ie),Di=a(Ie,"P",{});var Sv=s(Di);nm=i(Sv,"Summarization example:"),Sv.forEach(t),am=l(Ie),f(oa.$$.fragment,Ie),sm=l(Ie),Li=a(Ie,"P",{});var Nv=s(Li);rm=i(Nv,"Mask filling example:"),Nv.forEach(t),im=l(Ie),f(na.$$.fragment,Ie),Ie.forEach(t),dn.forEach(t),Sl=l(o),to=a(o,"H2",{class:!0});var Bc=s(to);No=a(Bc,"A",{id:!0,class:!0,href:!0});var Ov=s(No);Gi=a(Ov,"SPAN",{});var Dv=s(Gi);f(aa.$$.fragment,Dv),Dv.forEach(t),Ov.forEach(t),dm=l(Bc),Wi=a(Bc,"SPAN",{});var Lv=s(Wi);lm=i(Lv,"BartForSequenceClassification"),Lv.forEach(t),Bc.forEach(t),Nl=l(o),we=a(o,"DIV",{class:!0});var qt=s(we);f(sa.$$.fragment,qt),cm=l(qt),Ri=a(qt,"P",{});var Gv=s(Ri);pm=i(Gv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Gv.forEach(t),hm=l(qt),ra=a(qt,"P",{});var qc=s(ra);um=i(qc,"This model inherits from "),pr=a(qc,"A",{href:!0});var Wv=s(pr);mm=i(Wv,"PreTrainedModel"),Wv.forEach(t),fm=i(qc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qc.forEach(t),_m=l(qt),ia=a(qt,"P",{});var Fc=s(ia);gm=i(Fc,"This model is also a PyTorch "),da=a(Fc,"A",{href:!0,rel:!0});var Rv=s(da);km=i(Rv,"torch.nn.Module"),Rv.forEach(t),bm=i(Fc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fc.forEach(t),vm=l(qt),Z=a(qt,"DIV",{class:!0});var Se=s(Z);f(la.$$.fragment,Se),ym=l(Se),oo=a(Se,"P",{});var Ar=s(oo);Tm=i(Ar,"The "),hr=a(Ar,"A",{href:!0});var Uv=s(hr);wm=i(Uv,"BartForSequenceClassification"),Uv.forEach(t),xm=i(Ar," forward method, overrides the "),Ui=a(Ar,"CODE",{});var Hv=s(Ui);zm=i(Hv,"__call__"),Hv.forEach(t),Bm=i(Ar," special method."),Ar.forEach(t),qm=l(Se),f(Oo.$$.fragment,Se),Fm=l(Se),Hi=a(Se,"P",{});var Qv=s(Hi);$m=i(Qv,"Example of single-label classification:"),Qv.forEach(t),jm=l(Se),f(ca.$$.fragment,Se),Mm=l(Se),Qi=a(Se,"P",{});var Vv=s(Qi);Em=i(Vv,"Example of multi-label classification:"),Vv.forEach(t),Pm=l(Se),f(pa.$$.fragment,Se),Se.forEach(t),qt.forEach(t),Ol=l(o),no=a(o,"H2",{class:!0});var $c=s(no);Do=a($c,"A",{id:!0,class:!0,href:!0});var Jv=s(Do);Vi=a(Jv,"SPAN",{});var Xv=s(Vi);f(ha.$$.fragment,Xv),Xv.forEach(t),Jv.forEach(t),Cm=l($c),Ji=a($c,"SPAN",{});var Kv=s(Ji);Am=i(Kv,"BartForQuestionAnswering"),Kv.forEach(t),$c.forEach(t),Dl=l(o),xe=a(o,"DIV",{class:!0});var Ft=s(xe);f(ua.$$.fragment,Ft),Im=l(Ft),ao=a(Ft,"P",{});var Ir=s(ao);Sm=i(Ir,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Xi=a(Ir,"CODE",{});var Zv=s(Xi);Nm=i(Zv,"span start logits"),Zv.forEach(t),Om=i(Ir," and "),Ki=a(Ir,"CODE",{});var Yv=s(Ki);Dm=i(Yv,"span end logits"),Yv.forEach(t),Lm=i(Ir,")."),Ir.forEach(t),Gm=l(Ft),ma=a(Ft,"P",{});var jc=s(ma);Wm=i(jc,"This model inherits from "),ur=a(jc,"A",{href:!0});var ey=s(ur);Rm=i(ey,"PreTrainedModel"),ey.forEach(t),Um=i(jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),vf=l(jt),Ba=a(jt,"P",{});var Ic=s(Ba);yf=i(Ic,"This model is also a "),qa=a(Ic,"A",{href:!0,rel:!0});var uy=s(qa);Tf=i(uy,"tf.keras.Model"),uy.forEach(t),wf=i(Ic,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
This model inherits from `),gr=a(Nc,"A",{href:!0});var vy=s(gr);Df=i(vy,"TFPreTrainedModel"),vy.forEach(t),Lf=i(Nc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nc.forEach(t),Gf=l(Et),Pa=a(Et,"P",{});var Oc=s(Pa);Wf=i(Oc,"This model is also a "),Ca=a(Oc,"A",{href:!0,rel:!0});var yy=s(Ca);Rf=i(yy,"tf.keras.Model"),yy.forEach(t),Uf=i(Oc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
