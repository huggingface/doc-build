import{S as pp,i as fp,s as up,e as a,k as c,w as v,t as n,M as mp,c as r,d as t,m as l,a as i,x as T,h as s,b as d,F as e,g as p,y as k,q as x,o as b,B as y}from"../../chunks/vendor-4833417e.js";import{T as Yt}from"../../chunks/Tip-fffd6df1.js";import{D}from"../../chunks/Docstring-7b52c3d4.js";import{C as ln}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as We}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function _p(G){let h,$,m,_,S,g,w,E;return{c(){h=a("p"),$=n(`This class method is simply calling the feature extractor
...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var w=i(h);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(w,"CODE",{});var E=i(m);_=s(E,"Module"),E.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(g,w){p(g,h,w),e(h,$),e(h,m),e(m,_),e(h,S)},d(g){g&&t(h)}}}function wp(G){let h,$,m,_,S,g,w,E,A,q,z,N,R,ee,Fe,V,Pe,$e,M,J,te,ye,j,C,je,oe,ne,Ce,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,u,F,X,st,Ne,Q,Ue,_e,at,W,ce,rt,He,P,it,ze,Le,dt,hn,tr,or,pn,nr,sr,fn,ar,rr,Zs,U,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,fr,Zn,ur,mr,es,_r,gr,Xt,vr,Tr,ts,kr,ea,un,os,xr,ta,Qt,oa,mn,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,zr,rs,qr,Fr,is,Pr,jr,ds,Cr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Ur,so,Hr,Br,Rr,ht,Vr,gn,Jr,Kr,vn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,fs,oi,da,H,io,ni,us,si,ai,co,ri,Tn,ii,di,ci,$t,lo,li,ms,hi,pi,Et,ho,fi,po,ui,_s,mi,_i,gi,Be,fo,vi,kn,Ti,xn,ki,xi,gs,bi,yi,bn,uo,ca,ft,zt,vs,mo,wi,Ts,Si,la,pe,_o,$i,ks,Ei,zi,go,qi,yn,Fi,Pi,ji,xs,Ci,Mi,qt,vo,Ai,bs,Ii,ha,ut,Ft,ys,To,Di,ws,Ni,pa,I,ko,Li,Ss,Oi,Gi,ge,wn,Wi,Ui,Sn,Hi,Bi,$n,Ri,Vi,xo,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,Pt,bo,ed,Oe,td,yo,Es,od,nd,sd,zn,ad,rd,wo,zs,id,dd,cd,ld,Re,So,hd,qs,pd,fd,jt,ud,Ve,$o,md,Eo,_d,qn,gd,vd,Td,Ct,kd,Mt,zo,xd,qo,bd,Fn,yd,wd,Sd,At,Fo,$d,Po,Ed,Pn,zd,qd,Fd,It,jo,Pd,Fs,jd,fa,mt,Dt,Ps,Co,Cd,js,Md,ua,we,Mo,Ad,Ao,Id,jn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Ud,ve,No,Hd,_t,Bd,Cn,Rd,Vd,Cs,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,ma,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Uo,ic,Ho,dc,cc,lc,Te,Bo,hc,vt,pc,An,fc,uc,Ds,mc,_c,gc,Ot,vc,Ns,Tc,kc,Ro,ga,Tt,Gt,Ls,Vo,xc,Os,bc,va,fe,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,zc,Xo,qc,Fc,Pc,Wt,jc,ke,Qo,Cc,kt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Ut,Oc,Ws,Gc,Wc,Zo,Ta,xt,Ht,Us,en,Uc,Hs,Hc,ka,ue,tn,Bc,on,Rc,Nn,Vc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Bt,el,xe,an,tl,bt,ol,Ln,nl,sl,Bs,al,rl,il,Rt,dl,Rs,cl,ll,rn,xa;return g=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{codee:`import torch
...
`}}),Nt=new Yt({props:{$$slots:{default:[vp]},$$scope:{ctx:G}}}),Lo=new ln({props:{codee:`from transformers import Speech2TextTokenizer, Speech2TextModel
import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Bo=new D({props:{name:"forward",anchor:"transformers.Speech2TextForConditionalGeneration.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1274",parametersDescription:[{anchor:"transformers.Speech2TextForConditionalGeneration.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a <code>numpy.ndarray</code>, <em>e.g.</em>
via the soundfile library (<code>pip install soundfile</code>). To prepare the array into <code>input_features</code>, the
<a href="/docs/transformers/v4.17.0/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
`}}),Ot=new Yt({props:{$$slots:{default:[Tp]},$$scope:{ctx:G}}}),Ro=new ln({props:{codee:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
import soundfile as sf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){h=a("meta"),$=c(),m=a("h1"),_=a("a"),S=a("span"),v(g.$$.fragment),w=c(),E=a("span"),A=n("Speech2Text"),q=c(),z=a("h2"),N=a("a"),R=a("span"),v(ee.$$.fragment),Fe=c(),V=a("span"),Pe=n("Overview"),$e=c(),M=a("p"),J=n("The Speech2Text model was proposed in "),te=a("a"),ye=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),j=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
...
documentation from `),vn=a("a"),Yr=n("PretrainedConfig"),Xr=n(" for more information."),Qr=c(),hs=a("p"),Zr=n("Example:"),ei=c(),v(ao.$$.fragment),ia=c(),pt=a("h2"),St=a("a"),ps=a("span"),v(ro.$$.fragment),ti=c(),fs=a("span"),oi=n("Speech2TextTokenizer"),da=c(),H=a("div"),v(io.$$.fragment),ni=c(),us=a("p"),si=n("Construct an Speech2Text tokenizer."),ai=c(),co=a("p"),ri=n("This tokenizer inherits from "),Tn=a("a"),ii=n("PreTrainedTokenizer"),di=n(` which contains some of the main methods. Users should refer to
...
special tokens using the tokenizer `),_s=a("code"),mi=n("prepare_for_model"),_i=n(" method."),gi=c(),Be=a("div"),v(fo.$$.fragment),vi=c(),kn=a("p"),Ti=n("Create the token type IDs corresponding to the sequences passed. "),xn=a("a"),ki=n(`What are token type
IDs?`),xi=c(),gs=a("p"),bi=n("Should be overridden in a subclass if the model has a special way of building those."),yi=c(),bn=a("div"),v(uo.$$.fragment),ca=c(),ft=a("h2"),zt=a("a"),vs=a("span"),v(mo.$$.fragment),wi=c(),Ts=a("span"),Si=n("Speech2TextFeatureExtractor"),la=c(),pe=a("div"),v(_o.$$.fragment),$i=c(),ks=a("p"),Ei=n("Constructs a Speech2Text feature extractor."),zi=c(),go=a("p"),qi=n("This feature extractor inherits from "),yn=a("a"),Fi=n("Speech2TextFeatureExtractor"),Pi=n(` which contains most of the main methods. Users
...
mean and variance normalization to the extracted features.`),Mi=c(),qt=a("div"),v(vo.$$.fragment),Ai=c(),bs=a("p"),Ii=n("Main method to featurize and prepare for the model one or several sequence(s). sequences."),ha=c(),ut=a("h2"),Ft=a("a"),ys=a("span"),v(To.$$.fragment),Di=c(),ws=a("span"),Ni=n("Speech2TextProcessor"),pa=c(),I=a("div"),v(ko.$$.fragment),Li=c(),Ss=a("p"),Oi=n(`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
information.`),ld=c(),Re=a("div"),v(So.$$.fragment),hd=c(),qs=a("p"),pd=n("Instantiate a processor associated with a pretrained model."),fd=c(),v(jt.$$.fragment),ud=c(),Ve=a("div"),v($o.$$.fragment),md=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),qn=a("a"),gd=n("from_pretrained()"),vd=n(" method."),Td=c(),v(Ct.$$.fragment),kd=c(),Mt=a("div"),v(zo.$$.fragment),xd=c(),qo=a("p"),bd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=a("a"),yd=n("batch_decode()"),wd=n(`. Please
refer to the docstring of this method for more information.`),Sd=c(),At=a("div"),v(Fo.$$.fragment),$d=c(),Po=a("p"),Ed=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Pn=a("a"),zd=n("decode()"),qd=n(`. Please refer
...
Speech2Text.`),fa=c(),mt=a("h2"),Dt=a("a"),Ps=a("span"),v(Co.$$.fragment),Cd=c(),js=a("span"),Md=n("Speech2TextModel"),ua=c(),we=a("div"),v(Mo.$$.fragment),Ad=c(),Ao=a("p"),Id=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Ud=c(),ve=a("div"),v(No.$$.fragment),Hd=c(),_t=a("p"),Bd=n("The "),Cn=a("a"),Rd=n("Speech2TextModel"),Vd=n(" forward method, overrides the "),Cs=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),v(Nt.$$.fragment),Xd=c(),Ms=a("p"),Qd=n("Example:"),Zd=c(),v(Lo.$$.fragment),ma=c(),gt=a("h2"),Lt=a("a"),As=a("span"),v(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),v(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),Te=a("div"),v(Bo.$$.fragment),hc=c(),vt=a("p"),pc=n("The "),An=a("a"),fc=n("Speech2TextForConditionalGeneration"),uc=n(" forward method, overrides the "),Ds=a("code"),mc=n("__call__"),_c=n(" special method."),gc=c(),v(Ot.$$.fragment),vc=c(),Ns=a("p"),Tc=n("Example:"),kc=c(),v(Ro.$$.fragment),ga=c(),Tt=a("h2"),Gt=a("a"),Ls=a("span"),v(Vo.$$.fragment),xc=c(),Os=a("span"),bc=n("TFSpeech2TextModel"),va=c(),fe=a("div"),v(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
behavior.`),Pc=c(),v(Wt.$$.fragment),jc=c(),ke=a("div"),v(Qo.$$.fragment),Cc=c(),kt=a("p"),Mc=n("The "),Dn=a("a"),Ac=n("TFSpeech2TextModel"),Ic=n(" forward method, overrides the "),Gs=a("code"),Dc=n("__call__"),Nc=n(" special method."),Lc=c(),v(Ut.$$.fragment),Oc=c(),Ws=a("p"),Gc=n("Example:"),Wc=c(),v(Zo.$$.fragment),Ta=c(),xt=a("h2"),Ht=a("a"),Us=a("span"),v(en.$$.fragment),Uc=c(),Hs=a("span"),Hc=n("TFSpeech2TextForConditionalGeneration"),ka=c(),ue=a("div"),v(tn.$$.fragment),Bc=c(),on=a("p"),Rc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zc=c(),v(Bt.$$.fragment),el=c(),xe=a("div"),v(an.$$.fragment),tl=c(),bt=a("p"),ol=n("The "),Ln=a("a"),nl=n("TFSpeech2TextForConditionalGeneration"),sl=n(" forward method, overrides the "),Bs=a("code"),al=n("__call__"),rl=n(" special method."),il=c(),v(Rt.$$.fragment),dl=c(),Rs=a("p"),cl=n("Example:"),ll=c(),v(rn.$$.fragment),this.h()},l(o){const f=mp('[data-svelte="svelte-1phssyn"]',document.head);h=r(f,"META",{name:!0,content:!0}),f.forEach(t),$=l(o),m=r(o,"H1",{class:!0});var dn=i(m);_=r(dn,"A",{id:!0,class:!0,href:!0});var Vs=i(_);S=r(Vs,"SPAN",{});var Js=i(S);T(g.$$.fragment,Js),Js.forEach(t),Vs.forEach(t),w=l(dn),E=r(dn,"SPAN",{});var Ks=i(E);A=s(Ks,"Speech2Text"),Ks.forEach(t),dn.forEach(t),q=l(o),z=r(o,"H2",{class:!0});var cn=i(z);N=r(cn,"A",{id:!0,class:!0,href:!0});var Ys=i(N);R=r(Ys,"SPAN",{});var Xs=i(R);T(ee.$$.fragment,Xs),Xs.forEach(t),Ys.forEach(t),Fe=l(cn),V=r(cn,"SPAN",{});var Qs=i(V);Pe=s(Qs,"Overview"),Qs.forEach(t),cn.forEach(t),$e=l(o),M=r(o,"P",{});var Je=i(M);J=s(Je,"The Speech2Text model was proposed in "),te=r(Je,"A",{href:!0,rel:!0});var ml=i(te);ye=s(ml,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),ml.forEach(t),j=s(Je,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),C=r(Je,"A",{href:!0,rel:!0});var _l=i(C);je=s(_l,"LibriSpeech"),_l.forEach(t),oe=s(Je,", "),ne=r(Je,"A",{href:!0,rel:!0});var gl=i(ne);Ce=s(gl,"CoVoST 2"),gl.forEach(t),se=s(Je,", "),ae=r(Je,"A",{href:!0,rel:!0});var vl=i(ae);Me=s(vl,"MuST-C"),vl.forEach(t),O=s(Je,"."),Je.forEach(t),Ee=l(o),L=r(o,"P",{});var On=i(L);Ae=s(On,"This model was contributed by "),re=r(On,"A",{href:!0,rel:!0});var Tl=i(re);ie=s(Tl,"valhalla"),Tl.forEach(t),Ie=s(On,". The original code can be found "),de=r(On,"A",{href:!0,rel:!0});var kl=i(de);K=s(kl,"here"),kl.forEach(t),De=s(On,"."),On.forEach(t),Z=l(o),Y=r(o,"H2",{class:!0});var ba=i(Y);u=r(ba,"A",{id:!0,class:!0,href:!0});var xl=i(u);F=r(xl,"SPAN",{});var bl=i(F);T(X.$$.fragment,bl),bl.forEach(t),xl.forEach(t),st=l(ba),Ne=r(ba,"SPAN",{});var yl=i(Ne);Q=s(yl,"Inference"),yl.forEach(t),ba.forEach(t),Ue=l(o),_e=r(o,"P",{});var ya=i(_e);at=s(ya,`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
...
documentation from `),vn=r(Wn,"A",{href:!0});var Ql=i(vn);Yr=s(Ql,"PretrainedConfig"),Ql.forEach(t),Xr=s(Wn," for more information."),Wn.forEach(t),Qr=l(Ye),hs=r(Ye,"P",{});var Zl=i(hs);Zr=s(Zl,"Example:"),Zl.forEach(t),ei=l(Ye),T(ao.$$.fragment,Ye),Ye.forEach(t),ia=l(o),pt=r(o,"H2",{class:!0});var Ea=i(pt);St=r(Ea,"A",{id:!0,class:!0,href:!0});var eh=i(St);ps=r(eh,"SPAN",{});var th=i(ps);T(ro.$$.fragment,th),th.forEach(t),eh.forEach(t),ti=l(Ea),fs=r(Ea,"SPAN",{});var oh=i(fs);oi=s(oh,"Speech2TextTokenizer"),oh.forEach(t),Ea.forEach(t),da=l(o),H=r(o,"DIV",{class:!0});var be=i(H);T(io.$$.fragment,be),ni=l(be),us=r(be,"P",{});var nh=i(us);si=s(nh,"Construct an Speech2Text tokenizer."),nh.forEach(t),ai=l(be),co=r(be,"P",{});var za=i(co);ri=s(za,"This tokenizer inherits from "),Tn=r(za,"A",{href:!0});var sh=i(Tn);ii=s(sh,"PreTrainedTokenizer"),sh.forEach(t),di=s(za,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),za.forEach(t),ci=l(be),$t=r(be,"DIV",{class:!0});var qa=i($t);T(lo.$$.fragment,qa),li=l(qa),ms=r(qa,"P",{});var ah=i(ms);hi=s(ah,"Build model inputs from a sequence by appending eos_token_id."),ah.forEach(t),qa.forEach(t),pi=l(be),Et=r(be,"DIV",{class:!0});var Fa=i(Et);T(ho.$$.fragment,Fa),fi=l(Fa),po=r(Fa,"P",{});var Pa=i(po);ui=s(Pa,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),_s=r(Pa,"CODE",{});var rh=i(_s);mi=s(rh,"prepare_for_model"),rh.forEach(t),_i=s(Pa," method."),Pa.forEach(t),Fa.forEach(t),gi=l(be),Be=r(be,"DIV",{class:!0});var Un=i(Be);T(fo.$$.fragment,Un),vi=l(Un),kn=r(Un,"P",{});var hl=i(kn);Ti=s(hl,"Create the token type IDs corresponding to the sequences passed. "),xn=r(hl,"A",{href:!0});var ih=i(xn);ki=s(ih,`What are token type
IDs?`),ih.forEach(t),hl.forEach(t),xi=l(Un),gs=r(Un,"P",{});var dh=i(gs);bi=s(dh,"Should be overridden in a subclass if the model has a special way of building those."),dh.forEach(t),Un.forEach(t),yi=l(be),bn=r(be,"DIV",{class:!0});var ch=i(bn);T(uo.$$.fragment,ch),ch.forEach(t),be.forEach(t),ca=l(o),ft=r(o,"H2",{class:!0});var ja=i(ft);zt=r(ja,"A",{id:!0,class:!0,href:!0});var lh=i(zt);vs=r(lh,"SPAN",{});var hh=i(vs);T(mo.$$.fragment,hh),hh.forEach(t),lh.forEach(t),wi=l(ja),Ts=r(ja,"SPAN",{});var ph=i(Ts);Si=s(ph,"Speech2TextFeatureExtractor"),ph.forEach(t),ja.forEach(t),la=l(o),pe=r(o,"DIV",{class:!0});var Xe=i(pe);T(_o.$$.fragment,Xe),$i=l(Xe),ks=r(Xe,"P",{});var fh=i(ks);Ei=s(fh,"Constructs a Speech2Text feature extractor."),fh.forEach(t),zi=l(Xe),go=r(Xe,"P",{});var Ca=i(go);qi=s(Ca,"This feature extractor inherits from "),yn=r(Ca,"A",{href:!0});var uh=i(yn);Fi=s(uh,"Speech2TextFeatureExtractor"),uh.forEach(t),Pi=s(Ca,` which contains most of the main methods. Users
...
information.`),Ge.forEach(t),Zi=l(B),Pt=r(B,"DIV",{class:!0});var Ia=i(Pt);T(bo.$$.fragment,Ia),ed=l(Ia),Oe=r(Ia,"P",{});var Vt=i(Oe);td=s(Vt,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),Vt.forEach(t),Ia.forEach(t),ld=l(B),Re=r(B,"DIV",{class:!0});var Hn=i(Re);T(So.$$.fragment,Hn),hd=l(Hn),qs=r(Hn,"P",{});var qh=i(qs);pd=s(qh,"Instantiate a processor associated with a pretrained model."),qh.forEach(t),fd=l(Hn),T(jt.$$.fragment,Hn),Hn.forEach(t),ud=l(B),Ve=r(B,"DIV",{class:!0});var Bn=i(Ve);T($o.$$.fragment,Bn),md=l(Bn),Eo=r(Bn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),qn=r(Da,"A",{href:!0});var Fh=i(qn);gd=s(Fh,"from_pretrained()"),Fh.forEach(t),vd=s(Da," method."),Da.forEach(t),Td=l(Bn),T(Ct.$$.fragment,Bn),Bn.forEach(t),kd=l(B),Mt=r(B,"DIV",{class:!0});var Na=i(Mt);T(zo.$$.fragment,Na),xd=l(Na),qo=r(Na,"P",{});var La=i(qo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var Ph=i(Fn);yd=s(Ph,"batch_decode()"),Ph.forEach(t),wd=s(La,`. Please
refer to the docstring of this method for more information.`),La.forEach(t),Na.forEach(t),Sd=l(B),At=r(B,"DIV",{class:!0});var Oa=i(At);T(Fo.$$.fragment,Oa),$d=l(Oa),Po=r(Oa,"P",{});var Ga=i(Po);Ed=s(Ga,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Pn=r(Ga,"A",{href:!0});var jh=i(Pn);zd=s(jh,"decode()"),jh.forEach(t),qd=s(Ga,`. Please refer
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(B),It=r(B,"DIV",{class:!0});var Wa=i(It);T(jo.$$.fragment,Wa),Pd=l(Wa),Fs=r(Wa,"P",{});var Ch=i(Fs);jd=s(Ch,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),Ch.forEach(t),Wa.forEach(t),B.forEach(t),fa=l(o),mt=r(o,"H2",{class:!0});var Ua=i(mt);Dt=r(Ua,"A",{id:!0,class:!0,href:!0});var Mh=i(Dt);Ps=r(Mh,"SPAN",{});var Ah=i(Ps);T(Co.$$.fragment,Ah),Ah.forEach(t),Mh.forEach(t),Cd=l(Ua),js=r(Ua,"SPAN",{});var Ih=i(js);Md=s(Ih,"Speech2TextModel"),Ih.forEach(t),Ua.forEach(t),ua=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);T(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ha=i(Ao);Id=s(Ha,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ba.forEach(t),Ud=l(Jt),ve=r(Jt,"DIV",{class:!0});var Qe=i(ve);T(No.$$.fragment,Qe),Hd=l(Qe),_t=r(Qe,"P",{});var Rn=i(_t);Bd=s(Rn,"The "),Cn=r(Rn,"A",{href:!0});var Lh=i(Cn);Rd=s(Lh,"Speech2TextModel"),Lh.forEach(t),Vd=s(Rn," forward method, overrides the "),Cs=r(Rn,"CODE",{});var Oh=i(Cs);Jd=s(Oh,"__call__"),Oh.forEach(t),Kd=s(Rn," special method."),Rn.forEach(t),Yd=l(Qe),T(Nt.$$.fragment,Qe),Xd=l(Qe),Ms=r(Qe,"P",{});var Gh=i(Ms);Qd=s(Gh,"Example:"),Gh.forEach(t),Zd=l(Qe),T(Lo.$$.fragment,Qe),Qe.forEach(t),Jt.forEach(t),ma=l(o),gt=r(o,"H2",{class:!0});var Ra=i(gt);Lt=r(Ra,"A",{id:!0,class:!0,href:!0});var Wh=i(Lt);As=r(Wh,"SPAN",{});var Uh=i(As);T(Oo.$$.fragment,Uh),Uh.forEach(t),Wh.forEach(t),ec=l(Ra),Is=r(Ra,"SPAN",{});var Hh=i(Is);tc=s(Hh,"Speech2TextForConditionalGeneration"),Hh.forEach(t),Ra.forEach(t),_a=l(o),Se=r(o,"DIV",{class:!0});var Kt=i(Se);T(Go.$$.fragment,Kt),oc=l(Kt),Wo=r(Kt,"P",{});var Va=i(Wo);nc=s(Va,`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ja.forEach(t),lc=l(Kt),Te=r(Kt,"DIV",{class:!0});var Ze=i(Te);T(Bo.$$.fragment,Ze),hc=l(Ze),vt=r(Ze,"P",{});var Vn=i(vt);pc=s(Vn,"The "),An=r(Vn,"A",{href:!0});var Vh=i(An);fc=s(Vh,"Speech2TextForConditionalGeneration"),Vh.forEach(t),uc=s(Vn," forward method, overrides the "),Ds=r(Vn,"CODE",{});var Jh=i(Ds);mc=s(Jh,"__call__"),Jh.forEach(t),_c=s(Vn," special method."),Vn.forEach(t),gc=l(Ze),T(Ot.$$.fragment,Ze),vc=l(Ze),Ns=r(Ze,"P",{});var Kh=i(Ns);Tc=s(Kh,"Example:"),Kh.forEach(t),kc=l(Ze),T(Ro.$$.fragment,Ze),Ze.forEach(t),Kt.forEach(t),ga=l(o),Tt=r(o,"H2",{class:!0});var Ka=i(Tt);Gt=r(Ka,"A",{id:!0,class:!0,href:!0});var Yh=i(Gt);Ls=r(Yh,"SPAN",{});var Xh=i(Ls);T(Vo.$$.fragment,Xh),Xh.forEach(t),Yh.forEach(t),xc=l(Ka),Os=r(Ka,"SPAN",{});var Qh=i(Os);bc=s(Qh,"TFSpeech2TextModel"),Qh.forEach(t),Ka.forEach(t),va=l(o),fe=r(o,"DIV",{class:!0});var et=i(fe);T(Jo.$$.fragment,et),yc=l(et),Ko=r(et,"P",{});var Ya=i(Ko);wc=s(Ya,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xa.forEach(t),Pc=l(et),T(Wt.$$.fragment,et),jc=l(et),ke=r(et,"DIV",{class:!0});var tt=i(ke);T(Qo.$$.fragment,tt),Cc=l(tt),kt=r(tt,"P",{});var Jn=i(kt);Mc=s(Jn,"The "),Dn=r(Jn,"A",{href:!0});var tp=i(Dn);Ac=s(tp,"TFSpeech2TextModel"),tp.forEach(t),Ic=s(Jn," forward method, overrides the "),Gs=r(Jn,"CODE",{});var op=i(Gs);Dc=s(op,"__call__"),op.forEach(t),Nc=s(Jn," special method."),Jn.forEach(t),Lc=l(tt),T(Ut.$$.fragment,tt),Oc=l(tt),Ws=r(tt,"P",{});var np=i(Ws);Gc=s(np,"Example:"),np.forEach(t),Wc=l(tt),T(Zo.$$.fragment,tt),tt.forEach(t),et.forEach(t),Ta=l(o),xt=r(o,"H2",{class:!0});var Qa=i(xt);Ht=r(Qa,"A",{id:!0,class:!0,href:!0});var sp=i(Ht);Us=r(sp,"SPAN",{});var ap=i(Us);T(en.$$.fragment,ap),ap.forEach(t),sp.forEach(t),Uc=l(Qa),Hs=r(Qa,"SPAN",{});var rp=i(Hs);Hc=s(rp,"TFSpeech2TextForConditionalGeneration"),rp.forEach(t),Qa.forEach(t),ka=l(o),ue=r(o,"DIV",{class:!0});var ot=i(ue);T(tn.$$.fragment,ot),Bc=l(ot),on=r(ot,"P",{});var Za=i(on);Rc=s(Za,`The Speech2Text Model with a language modeling head. Can be used for summarization.
