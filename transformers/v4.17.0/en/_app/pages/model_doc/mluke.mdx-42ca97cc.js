...
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/mluke/tokenization_mluke.py#L1493"}}),{c(){_=o("meta"),V=p(),h=o("h1"),f=o("a"),le=o("span"),E(U.$$.fragment),Ke=p(),ce=o("span"),De=r("mLUKE"),ge=p(),b=o("h2"),T=o("a"),de=o("span"),E(W.$$.fragment),Re=p(),pe=o("span"),Fe=r("Overview"),_e=p(),k=o("p"),Oe=r("The mLUKE model was proposed in "),S=o("a"),Be=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),je=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
sequences, depending on the task you want to prepare them for.`),qt=p(),ie=o("div"),E(H.$$.fragment),this.h()},l(e){const c=sn('[data-svelte="svelte-1phssyn"]',document.head);_=s(c,"META",{name:!0,content:!0}),c.forEach(n),V=u(e),h=s(e,"H1",{class:!0});var $e=i(h);f=s($e,"A",{id:!0,class:!0,href:!0});var Mt=i(f);le=s(Mt,"SPAN",{});var Et=i(le);$(U.$$.fragment,Et),Et.forEach(n),Mt.forEach(n),Ke=u($e),ce=s($e,"SPAN",{});var $t=i(ce);De=a($t,"mLUKE"),$t.forEach(n),$e.forEach(n),ge=u(e),b=s(e,"H2",{class:!0});var Ae=i(b);T=s(Ae,"A",{id:!0,class:!0,href:!0});var At=i(T);de=s(At,"SPAN",{});var Pt=i(de);$(W.$$.fragment,Pt),Pt.forEach(n),At.forEach(n),Re=u(Ae),pe=s(Ae,"SPAN",{});var Nt=i(pe);Fe=a(Nt,"Overview"),Nt.forEach(n),Ae.forEach(n),_e=u(e),k=s(e,"P",{});var re=i(k);Oe=a(re,"The mLUKE model was proposed in "),S=s(re,"A",{href:!0,rel:!0});var It=i(S);Be=a(It,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),It.forEach(n),je=a(re,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
tips, code examples and notebooks.`),Ne.forEach(n),xe=u(e),y=s(e,"P",{});var ae=i(y);ot=a(ae,"This model was contributed by "),F=s(ae,"A",{href:!0,rel:!0});var Bt=i(F);st=a(Bt,"ryo0634"),Bt.forEach(n),it=a(ae,". The original code can be found "),O=s(ae,"A",{href:!0,rel:!0});var jt=i(O);rt=a(jt,"here"),jt.forEach(n),at=a(ae,"."),ae.forEach(n),ze=u(e),w=s(e,"H2",{class:!0});var Ie=i(w);x=s(Ie,"A",{id:!0,class:!0,href:!0});var Xt=i(x);me=s(Xt,"SPAN",{});var Ct=i(me);$(B.$$.fragment,Ct),Ct.forEach(n),Xt.forEach(n),lt=u(Ie),he=s(Ie,"SPAN",{});var Yt=i(he);ct=a(Yt,"MLukeTokenizer"),Yt.forEach(n),Ie.forEach(n),Me=u(e),m=s(e,"DIV",{class:!0});var v=i(m);$(j.$$.fragment,v),dt=u(v),g=s(v,"P",{});var M=i(g);pt=a(M,"Adapted from "),ne=s(M,"A",{href:!0});var Ht=i(ne);ut=a(Ht,"XLMRobertaTokenizer"),Ht.forEach(n),mt=a(M," and "),oe=s(M,"A",{href:!0});var Vt=i(oe);ht=a(Vt,"LukeTokenizer"),Vt.forEach(n),ft=a(M,`. Based on
`),X=s(M,"A",{href:!0,rel:!0});var Jt=i(X);gt=a(Jt,"SentencePiece"),Jt.forEach(n),_t=a(M,"."),M.forEach(n),kt=u(v),C=s(v,"P",{});var Ue=i(C);yt=a(Ue,"This tokenizer inherits from "),se=s(Ue,"A",{href:!0});var Gt=i(se);vt=a(Gt,"PreTrainedTokenizer"),Gt.forEach(n),bt=a(Ue,` which contains most of the main methods. Users should refer to
