import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as fa,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as v,q as b,o as k,B as T}from"../../chunks/vendor-4833417e.js";import{T as ca}from"../../chunks/Tip-fffd6df1.js";import{D as He}from"../../chunks/Docstring-4f315ed9.js";import{C as Jt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as bt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function ma(ie){let u,q,f,y,C;return{c(){u=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),y=n("Module"),C=n(`
...
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var E=i(u);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(E,"CODE",{});var S=i(f);y=r(S,"Module"),S.forEach(o),C=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(w,E){p(w,u,E),e(u,q),e(u,f),e(f,y),e(u,C)},d(w){w&&o(u)}}}function _a(ie){let u,q,f,y,C,w,E,S,Do,Kt,R,Y,kt,de,So,Tt,Ao,Qt,A,Mo,Ve,No,Lo,le,Fo,Oo,Xt,Je,Io,Yt,Ke,yt,Ro,Zt,Qe,Wo,eo,Xe,ce,Uo,Ye,Ho,Vo,to,he,oo,Ze,pe,Jo,et,Ko,Qo,no,ue,ro,tt,Xo,so,Z,M,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,N,an,fe,dn,ln,me,cn,hn,io,W,ee,Bt,ge,pn,zt,un,lo,$,_e,fn,ve,mn,$t,gn,_n,vn,U,bn,rt,kn,Tn,st,yn,wn,En,Gt,Bn,zn,be,co,H,te,qt,ke,$n,Pt,Gn,ho,D,Te,qn,ye,Pn,we,jn,xn,Cn,Ee,Dn,at,Sn,An,Mn,it,Be,po,V,oe,jt,ze,Nn,xt,Ln,uo,m,$e,Fn,Ct,On,In,Ge,Rn,dt,Wn,Un,Hn,qe,Vn,Pe,Jn,Kn,Qn,je,Xn,xe,Yn,Zn,er,J,tr,lt,or,nr,Ce,rr,sr,ar,B,ir,Dt,dr,lr,St,cr,hr,At,pr,ur,Mt,fr,mr,Nt,gr,_r,Lt,vr,br,kr,P,De,Tr,K,yr,ct,wr,Er,Ft,Br,zr,$r,ne,Gr,Ot,qr,Pr,Se,fo,Q,re,It,Ae,jr,Rt,xr,mo,G,Me,Cr,Ne,Dr,Wt,Sr,Ar,Mr,Le,Nr,ht,Lr,Fr,Or,Fe,Ir,Oe,Rr,Wr,Ur,j,Ie,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Re,go;return w=new bt({}),de=new bt({}),he=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
configuration. Check out the <a href="/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),De=new He({props:{name:"forward",anchor:"transformers.BertGenerationEncoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
found `),me=s("a"),cn=n("here"),hn=n("."),io=l(),W=s("h2"),ee=s("a"),Bt=s("span"),g(ge.$$.fragment),pn=l(),zt=s("span"),un=n("BertGenerationConfig"),lo=l(),$=s("div"),g(_e.$$.fragment),fn=l(),ve=s("p"),mn=n("This is the configuration class to store the configuration of a "),$t=s("code"),gn=n("BertGenerationPreTrainedModel"),_n=n(` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),vn=l(),U=s("p"),bn=n("Configuration objects inherit from "),rt=s("a"),kn=n("PretrainedConfig"),Tn=n(` and can be used to control the model outputs. Read the
documentation from `),st=s("a"),yn=n("PretrainedConfig"),wn=n(" for more information."),En=l(),Gt=s("p"),Bn=n("Examples:"),zn=l(),g(be.$$.fragment),co=l(),H=s("h2"),te=s("a"),qt=s("span"),g(ke.$$.fragment),$n=l(),Pt=s("span"),Gn=n("BertGenerationTokenizer"),ho=l(),D=s("div"),g(Te.$$.fragment),qn=l(),ye=s("p"),Pn=n("Construct a BertGeneration tokenizer. Based on "),we=s("a"),jn=n("SentencePiece"),xn=n("."),Cn=l(),Ee=s("p"),Dn=n("This tokenizer inherits from "),at=s("a"),Sn=n("PreTrainedTokenizer"),An=n(` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Co.forEach(o),Ur=c(O),j=a(O,"DIV",{class:!0});var I=i(j);_(Ie.$$.fragment,I),Hr=c(I),X=a(I,"P",{});var vt=i(X);Vr=r(vt,"The "),pt=a(vt,"A",{href:!0});var ia=i(pt);Jr=r(ia,"BertGenerationDecoder"),ia.forEach(o),Kr=r(vt," forward method, overrides the "),Ut=a(vt,"CODE",{});var da=i(Ut);Qr=r(da,"__call__"),da.forEach(o),Xr=r(vt," special method."),vt.forEach(o),Yr=c(I),_(se.$$.fragment,I),Zr=c(I),Ht=a(I,"P",{});var la=i(Ht);es=r(la,"Example:"),la.forEach(o),ts=c(I),_(Re.$$.fragment,I),I.forEach(o),O.forEach(o),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(va)),d(y,"id","bertgeneration"),d(y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(y,"href","#bertgeneration"),d(f,"class","relative group"),d(Y,"id","overview"),d(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Y,"href","#overview"),d(R,"class","relative group"),d(Ve,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(le,"href","https://arxiv.org/abs/1907.12461"),d(le,"rel","nofollow"),d(Ye,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(et,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(ot,"href","/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(nt,"href","/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(fe,"href","https://huggingface.co/patrickvonplaten"),d(fe,"rel","nofollow"),d(me,"href","https://tfhub.dev/s?module-type=text-generation&subtype=module,placeholder"),d(me,"rel","nofollow"),d(ee,"id","transformers.BertGenerationConfig"),d(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ee,"href","#transformers.BertGenerationConfig"),d(W,"class","relative group"),d(rt,"href","/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig"),d(st,"href","/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig"),d($,"class","docstring"),d(te,"id","transformers.BertGenerationTokenizer"),d(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(te,"href","#transformers.BertGenerationTokenizer"),d(H,"class","relative group"),d(we,"href","https://github.com/google/sentencepiece"),d(we,"rel","nofollow"),d(at,"href","/docs/transformers/v4.17.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d(it,"class","docstring"),d(D,"class","docstring"),d(oe,"id","transformers.BertGenerationEncoder"),d(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(oe,"href","#transformers.BertGenerationEncoder"),d(V,"class","relative group"),d(dt,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel"),d(Pe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Pe,"rel","nofollow"),d(xe,"href","https://arxiv.org/abs/1706.03762"),d(xe,"rel","nofollow"),d(lt,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(Ce,"href","https://arxiv.org/abs/1907.12461"),d(Ce,"rel","nofollow"),d(ct,"href","/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(P,"class","docstring"),d(m,"class","docstring"),d(re,"id","transformers.BertGenerationDecoder"),d(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(re,"href","#transformers.BertGenerationDecoder"),d(Q,"class","relative group"),d(ht,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel"),d(Oe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Oe,"rel","nofollow"),d(pt,"href","/docs/transformers/v4.17.0/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(j,"class","docstring"),d(G,"class","docstring")},m(t,h){e(document.head,u),p(t,q,h),p(t,f,h),e(f,y),e(y,C),v(w,C,null),e(f,E),e(f,S),e(S,Do),p(t,Kt,h),p(t,R,h),e(R,Y),e(Y,kt),v(de,kt,null),e(R,So),e(R,Tt),e(Tt,Ao),p(t,Qt,h),p(t,A,h),e(A,Mo),e(A,Ve),e(Ve,No),e(A,Lo),e(A,le),e(le,Fo),e(A,Oo),p(t,Xt,h),p(t,Je,h),e(Je,Io),p(t,Yt,h),p(t,Ke,h),e(Ke,yt),e(yt,Ro),p(t,Zt,h),p(t,Qe,h),e(Qe,Wo),p(t,eo,h),p(t,Xe,h),e(Xe,ce),e(ce,Uo),e(ce,Ye),e(Ye,Ho),e(ce,Vo),p(t,to,h),v(he,t,h),p(t,oo,h),p(t,Ze,h),e(Ze,pe),e(pe,Jo),e(pe,et),e(et,Ko),e(pe,Qo),p(t,no,h),v(ue,t,h),p(t,ro,h),p(t,tt,h),e(tt,Xo),p(t,so,h),p(t,Z,h),e(Z,M),e(M,ot),e(ot,Yo),e(M,Zo),e(M,nt),e(nt,en),e(M,tn),e(M,wt),e(wt,on),e(M,nn),e(Z,rn),e(Z,Et),e(Et,sn),p(t,ao,h),p(t,N,h),e(N,an),e(N,fe),e(fe,dn),e(N,ln),e(N,me),e(me,cn),e(N,hn),p(t,io,h),p(t,W,h),e(W,ee),e(ee,Bt),v(ge,Bt,null),e(W,pn),e(W,zt),e(zt,un),p(t,lo,h),p(t,$,h),v(_e,$,null),e($,fn),e($,ve),e(ve,mn),e(ve,$t),e($t,gn),e(ve,_n),e($,vn),e($,U),e(U,bn),e(U,rt),e(rt,kn),e(U,Tn),e(U,st),e(st,yn),e(U,wn),e($,En),e($,Gt),e(Gt,Bn),e($,zn),v(be,$,null),p(t,co,h),p(t,H,h),e(H,te),e(te,qt),v(ke,qt,null),e(H,$n),e(H,Pt),e(Pt,Gn),p(t,ho,h),p(t,D,h),v(Te,D,null),e(D,qn),e(D,ye),e(ye,Pn),e(ye,we),e(we,jn),e(ye,xn),e(D,Cn),e(D,Ee),e(Ee,Dn),e(Ee,at),e(at,Sn),e(Ee,An),e(D,Mn),e(D,it),v(Be,it,null),p(t,po,h),p(t,V,h),e(V,oe),e(oe,jt),v(ze,jt,null),e(V,Nn),e(V,xt),e(xt,Ln),p(t,uo,h),p(t,m,h),v($e,m,null),e(m,Fn),e(m,Ct),e(Ct,On),e(m,In),e(m,Ge),e(Ge,Rn),e(Ge,dt),e(dt,Wn),e(Ge,Un),e(m,Hn),e(m,qe),e(qe,Vn),e(qe,Pe),e(Pe,Jn),e(qe,Kn),e(m,Qn),e(m,je),e(je,Xn),e(je,xe),e(xe,Yn),e(je,Zn),e(m,er),e(m,J),e(J,tr),e(J,lt),e(lt,or),e(J,nr),e(J,Ce),e(Ce,rr),e(J,sr),e(m,ar),e(m,B),e(B,ir),e(B,Dt),e(Dt,dr),e(B,lr),e(B,St),e(St,cr),e(B,hr),e(B,At),e(At,pr),e(B,ur),e(B,Mt),e(Mt,fr),e(B,mr),e(B,Nt),e(Nt,gr),e(B,_r),e(B,Lt),e(Lt,vr),e(B,br),e(m,kr),e(m,P),v(De,P,null),e(P,Tr),e(P,K),e(K,yr),e(K,ct),e(ct,wr),e(K,Er),e(K,Ft),e(Ft,Br),e(K,zr),e(P,$r),v(ne,P,null),e(P,Gr),e(P,Ot),e(Ot,qr),e(P,Pr),v(Se,P,null),p(t,fo,h),p(t,Q,h),e(Q,re),e(re,It),v(Ae,It,null),e(Q,jr),e(Q,Rt),e(Rt,xr),p(t,mo,h),p(t,G,h),v(Me,G,null),e(G,Cr),e(G,Ne),e(Ne,Dr),e(Ne,Wt),e(Wt,Sr),e(Ne,Ar),e(G,Mr),e(G,Le),e(Le,Nr),e(Le,ht),e(ht,Lr),e(Le,Fr),e(G,Or),e(G,Fe),e(Fe,Ir),e(Fe,Oe),e(Oe,Rr),e(Fe,Wr),e(G,Ur),e(G,j),v(Ie,j,null),e(j,Hr),e(j,X),e(X,Vr),e(X,pt),e(pt,Jr),e(X,Kr),e(X,Ut),e(Ut,Qr),e(X,Xr),e(j,Yr),v(se,j,null),e(j,Zr),e(j,Ht),e(Ht,es),e(j,ts),v(Re,j,null),go=!0},p(t,[h]){const We={};h&2&&(We.$$scope={dirty:h,ctx:t}),ne.$set(We);const Vt={};h&2&&(Vt.$$scope={dirty:h,ctx:t}),se.$set(Vt)},i(t){go||(b(w.$$.fragment,t),b(de.$$.fragment,t),b(he.$$.fragment,t),b(ue.$$.fragment,t),b(ge.$$.fragment,t),b(_e.$$.fragment,t),b(be.$$.fragment,t),b(ke.$$.fragment,t),b(Te.$$.fragment,t),b(Be.$$.fragment,t),b(ze.$$.fragment,t),b($e.$$.fragment,t),b(De.$$.fragment,t),b(ne.$$.fragment,t),b(Se.$$.fragment,t),b(Ae.$$.fragment,t),b(Me.$$.fragment,t),b(Ie.$$.fragment,t),b(se.$$.fragment,t),b(Re.$$.fragment,t),go=!0)},o(t){k(w.$$.fragment,t),k(de.$$.fragment,t),k(he.$$.fragment,t),k(ue.$$.fragment,t),k(ge.$$.fragment,t),k(_e.$$.fragment,t),k(be.$$.fragment,t),k(ke.$$.fragment,t),k(Te.$$.fragment,t),k(Be.$$.fragment,t),k(ze.$$.fragment,t),k($e.$$.fragment,t),k(De.$$.fragment,t),k(ne.$$.fragment,t),k(Se.$$.fragment,t),k(Ae.$$.fragment,t),k(Me.$$.fragment,t),k(Ie.$$.fragment,t),k(se.$$.fragment,t),k(Re.$$.fragment,t),go=!1},d(t){o(u),t&&o(q),t&&o(f),T(w),t&&o(Kt),t&&o(R),T(de),t&&o(Qt),t&&o(A),t&&o(Xt),t&&o(Je),t&&o(Yt),t&&o(Ke),t&&o(Zt),t&&o(Qe),t&&o(eo),t&&o(Xe),t&&o(to),T(he,t),t&&o(oo),t&&o(Ze),t&&o(no),T(ue,t),t&&o(ro),t&&o(tt),t&&o(so),t&&o(Z),t&&o(ao),t&&o(N),t&&o(io),t&&o(W),T(ge),t&&o(lo),t&&o($),T(_e),T(be),t&&o(co),t&&o(H),T(ke),t&&o(ho),t&&o(D),T(Te),T(Be),t&&o(po),t&&o(V),T(ze),t&&o(uo),t&&o(m),T($e),T(De),T(ne),T(Se),t&&o(fo),t&&o(Q),T(Ae),t&&o(mo),t&&o(G),T(Me),T(Ie),T(se),T(Re)}}}const va={local:"bertgeneration",sections:[{local:"overview",title:"Overview"},{local:"transformers.BertGenerationConfig",title:"BertGenerationConfig"},{local:"transformers.BertGenerationTokenizer",title:"BertGenerationTokenizer"},{local:"transformers.BertGenerationEncoder",title:"BertGenerationEncoder"},{local:"transformers.BertGenerationDecoder",title:"BertGenerationDecoder"}],title:"BertGeneration"};function ba(ie,u,q){let{fw:f}=u;return ie.$$set=y=>{"fw"in y&&q(0,f=y.fw)},[f]}class za extends ha{constructor(u){super();pa(this,u,ba,_a,ua,{fw:0})}}export{za as default,va as metadata};
