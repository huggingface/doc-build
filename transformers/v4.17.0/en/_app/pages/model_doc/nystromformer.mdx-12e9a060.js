...
`}}),ve=new Ko({props:{$$slots:{default:[Ni]},$$scope:{ctx:q}}}),Ge=new je({props:{code:`from transformers import AutoTokenizer, NystromformerModel
import torch
...
`}}),ze=new Ko({props:{$$slots:{default:[qi]},$$scope:{ctx:q}}}),vo=new je({props:{code:`from transformers import AutoTokenizer, NystromformerForTokenClassification
import torch
