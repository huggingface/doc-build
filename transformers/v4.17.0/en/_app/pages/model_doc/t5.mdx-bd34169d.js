import{S as uw,i as mw,s as fw,e as o,k as d,w as f,t as r,M as _w,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as p,y as g,q as T,o as v,B as k}from"../../chunks/vendor-4833417e.js";import{T as zt}from"../../chunks/Tip-fffd6df1.js";import{D as M}from"../../chunks/Docstring-4f315ed9.js";import{C as R}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ve}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function gw(L){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
...
`),W=s(Ie,"CODE",{});var ft=a(W);Ae=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),N.forEach(t)},m(m,j){p(m,u,j),e(u,x),p(m,b,j),p(m,w,j),e(w,z),e(z,$),e(w,y),e(w,E),e(E,Ee),p(m,oe,j),p(m,q,j),e(q,ee),e(q,O),e(O,se),e(q,qe),e(q,G),e(G,je),e(q,ke),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,U),e(U,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,A),e(A,Pe),e(F,fe),e(F,D),e(D,Ce),e(D,W),e(W,Ae)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(q),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function bw(L){let u,x,b,w,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l($){u=s($,"P",{});var y=a(u);x=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var E=a(b);w=i(E,"Module"),E.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m($,y){p($,u,y),e(u,x),e(u,b),e(b,w),e(u,z)},d($){$&&t(u)}}}function qw(L){let u,x,b,w,z,$,y,E,Ee,oe,q,ee,O,se,qe,G,je,ke,B,I,ae,pe,F,C,he,K,be,ue,U,Fe,ye,P,Me,H,V,me,A,Pe,fe,D,Ce,W,Ae,m,j,te,Oe,pt,S,Ge,ne,ht,N,Y,ut,Ne,Z,mt,Le,Ie,ft,Vl,Xa,Sp,Kl,Be,di,li,To,Op,Gp,ci,pi,vo,Bp,Up,hi,ui,ko,Wp,Rp,mi,fi,bo,Hp,Vp,_i,Qa,yo,Kp,Yp,Yl,er,Zp,Zl,xt,gi,zn,Ti,Jp,Xp,tr,Qp,eh,th,vi,xn,ki,nh,oh,nr,sh,ah,rh,bi,En,yi,ih,dh,or,lh,ch,Jl,qn,ph,wo,hh,uh,Xl,Et,mh,$o,fh,_h,zo,gh,Th,Ql,sr,ec,Zt,jn,wi,xo,vh,$i,kh,tc,_t,bh,zi,yh,wh,xi,$h,zh,Ei,xh,Eh,nc,Fn,qh,ar,jh,Fh,oc,Mn,dt,qi,Mh,Ph,_e,Ch,ji,Ah,Nh,Fi,Lh,Ih,Mi,Dh,Sh,Pi,Oh,Gh,Ci,Bh,Uh,rr,Wh,Rh,Hh,Ai,Vh,Kh,Eo,Yh,qo,Zh,jo,Jh,Xh,Qh,ge,Ni,eu,tu,Li,nu,ou,Fo,su,re,au,Ii,ru,iu,Di,du,lu,Si,cu,pu,Oi,hu,uu,Gi,mu,fu,Bi,_u,gu,Ui,Tu,vu,ku,Jt,bu,Wi,yu,wu,Ri,$u,zu,xu,Te,Eu,Hi,qu,ju,Vi,Fu,Mu,Ki,Pu,Cu,Yi,Au,Nu,Mo,Lu,Iu,Zi,Du,Su,Ou,Po,sc,ir,Gu,ac,qt,Ji,Co,Bu,Xi,Uu,Wu,Ru,Qi,Xt,Hu,Ao,Vu,Ku,No,Yu,Zu,Ju,ed,Lo,Xu,td,Qu,em,rc,dr,ic,Qt,Pn,nd,Io,tm,od,nm,dc,gt,om,lr,sm,am,Do,rm,im,So,dm,lm,lc,Oo,cc,Ue,cm,sd,pm,hm,ad,um,mm,cr,fm,_m,rd,gm,Tm,pc,pr,vm,hc,Go,uc,hr,mc,en,Cn,id,Bo,km,dd,bm,fc,Tt,ym,Uo,wm,$m,ld,zm,xm,cd,Em,qm,_c,tn,An,pd,Wo,jm,hd,Fm,gc,ur,Mm,Tc,Nn,ud,nn,Pm,Ro,Cm,Am,Ho,Nm,Lm,Im,md,De,Dm,Vo,Sm,Om,Ko,Gm,Bm,Yo,Um,Wm,Zo,Rm,Hm,Jo,Vm,Km,vc,on,Ln,fd,Xo,Ym,_d,Zm,kc,wt,Qo,Jm,$t,Xm,mr,Qm,ef,fr,tf,nf,es,of,sf,af,sn,rf,_r,df,lf,gr,cf,pf,bc,an,In,gd,ts,hf,Td,uf,yc,ie,ns,mf,os,ff,ss,_f,gf,Tf,as,vf,Tr,kf,bf,yf,jt,rs,wf,vd,$f,zf,is,vr,xf,kd,Ef,qf,kr,jf,bd,Ff,Mf,Dn,ds,Pf,ls,Cf,yd,Af,Nf,Lf,Sn,cs,If,wd,Df,Sf,br,ps,wc,rn,On,$d,hs,Of,zd,Gf,$c,Se,us,Bf,dn,Uf,xd,Wf,Rf,ms,Hf,Vf,Kf,fs,Yf,yr,Zf,Jf,Xf,Ft,_s,Qf,Ed,e_,t_,gs,wr,n_,qd,o_,s_,$r,a_,jd,r_,i_,Gn,Ts,d_,Fd,l_,zc,ln,Bn,Md,vs,c_,Pd,p_,xc,J,ks,h_,Cd,u_,m_,bs,f_,ys,__,g_,T_,ws,v_,zr,k_,b_,y_,$s,w_,zs,$_,z_,x_,We,xs,E_,cn,q_,xr,j_,F_,Ad,M_,P_,C_,Un,A_,Nd,N_,L_,Es,I_,Re,qs,D_,Ld,S_,O_,Id,G_,B_,Dd,U_,W_,js,R_,vt,Fs,H_,Sd,V_,K_,Od,Y_,Z_,Ms,Ec,pn,Wn,Gd,Ps,J_,Bd,X_,qc,X,Cs,Q_,As,eg,Ud,tg,ng,og,Ns,sg,Ls,ag,rg,ig,Is,dg,Er,lg,cg,pg,Ds,hg,Ss,ug,mg,fg,He,Os,_g,hn,gg,qr,Tg,vg,Wd,kg,bg,yg,Rn,wg,Rd,$g,zg,Gs,xg,Ve,Bs,Eg,Hd,qg,jg,Vd,Fg,Mg,Kd,Pg,Cg,Us,Ag,kt,Ws,Ng,Yd,Lg,Ig,Zd,Dg,Sg,Rs,jc,un,Hn,Jd,Hs,Og,Xd,Gg,Fc,Q,Vs,Bg,Qd,Ug,Wg,Ks,Rg,Ys,Hg,Vg,Kg,Zs,Yg,jr,Zg,Jg,Xg,Js,Qg,Xs,eT,tT,nT,Ke,Qs,oT,mn,sT,Fr,aT,rT,el,iT,dT,lT,Vn,cT,tl,pT,hT,ea,uT,Ye,ta,mT,nl,fT,_T,ol,gT,TT,sl,vT,kT,na,bT,bt,oa,yT,al,wT,$T,rl,zT,xT,sa,Mc,fn,Kn,il,aa,ET,dl,qT,Pc,de,ra,jT,ll,FT,MT,ia,PT,da,CT,AT,NT,la,LT,Mr,IT,DT,ST,ca,OT,pa,GT,BT,UT,Yn,WT,Ze,ha,RT,_n,HT,Pr,VT,KT,cl,YT,ZT,JT,Zn,XT,pl,QT,ev,ua,Cc,gn,Jn,hl,ma,tv,ul,nv,Ac,le,fa,ov,_a,sv,ml,av,rv,iv,ga,dv,Ta,lv,cv,pv,va,hv,Cr,uv,mv,fv,ka,_v,ba,gv,Tv,vv,Xn,kv,Je,ya,bv,Tn,yv,Ar,wv,$v,fl,zv,xv,Ev,Qn,qv,_l,jv,Fv,wa,Nc,vn,eo,gl,$a,Mv,Tl,Pv,Lc,ce,za,Cv,vl,Av,Nv,xa,Lv,Ea,Iv,Dv,Sv,qa,Ov,Nr,Gv,Bv,Uv,ja,Wv,Fa,Rv,Hv,Vv,to,Kv,Xe,Ma,Yv,kn,Zv,Lr,Jv,Xv,kl,Qv,ek,tk,no,nk,bl,ok,sk,Pa,Ic,bn,oo,yl,Ca,ak,wl,rk,Dc,lt,Aa,ik,Qe,Na,dk,yn,lk,$l,ck,pk,zl,hk,uk,mk,so,fk,xl,_k,gk,La,Tk,Mt,Ia,vk,El,kk,bk,Da,yk,Pt,Sa,wk,ql,$k,zk,Oa,Sc,wn,ao,jl,Ga,xk,Fl,Ek,Oc,ct,Ba,qk,et,Ua,jk,$n,Fk,Ml,Mk,Pk,Pl,Ck,Ak,Nk,ro,Lk,Cl,Ik,Dk,Wa,Sk,Ct,Ra,Ok,Al,Gk,Bk,Ha,Uk,At,Va,Wk,Nl,Rk,Hk,Ka,Gc;return $=new ve({}),se=new ve({}),xo=new ve({}),Eo=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[yw]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/t5/modeling_tf_t5.py#L1355",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.17.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[$w]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/t5/modeling_tf_t5.py#L1630",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=o("meta"),x=d(),b=o("h1"),w=o("a"),z=o("span"),f($.$$.fragment),y=d(),E=o("span"),Ee=r("T5"),oe=d(),q=o("h2"),ee=o("a"),O=o("span"),f(se.$$.fragment),qe=d(),G=o("span"),je=r("Overview"),ke=d(),B=o("p"),I=r("The T5 model was presented in "),ae=o("a"),pe=r("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),F=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),W=o("em"),Ae=r("summarize: \u2026"),m=r("."),j=d(),te=o("li"),Oe=o("p"),pt=r("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),S=d(),Ge=o("li"),ne=o("p"),ht=r("See the "),N=o("a"),Y=r("training"),ut=r(", "),Ne=o("a"),Z=r("inference"),mt=r(" and "),Le=o("a"),Ie=r("scripts"),ft=r(" sections below for all details regarding usage."),Vl=d(),Xa=o("p"),Sp=r("T5 comes in different sizes:"),Kl=d(),Be=o("ul"),di=o("li"),li=o("p"),To=o("a"),Op=r("t5-small"),Gp=d(),ci=o("li"),pi=o("p"),vo=o("a"),Bp=r("t5-base"),Up=d(),hi=o("li"),ui=o("p"),ko=o("a"),Wp=r("t5-large"),Rp=d(),mi=o("li"),fi=o("p"),bo=o("a"),Hp=r("t5-3b"),Vp=d(),_i=o("li"),Qa=o("p"),yo=o("a"),Kp=r("t5-11b"),Yp=r("."),Yl=d(),er=o("p"),Zp=r("Based on the original T5 model, Google has released some follow-up works:"),Zl=d(),xt=o("ul"),gi=o("li"),zn=o("p"),Ti=o("strong"),Jp=r("T5v1.1"),Xp=r(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),or=o("a"),lh=r("here"),ch=r("."),Jl=d(),qn=o("p"),ph=r("All checkpoints can be found on the "),wo=o("a"),hh=r("hub"),uh=r("."),Xl=d(),Et=o("p"),mh=r("This model was contributed by "),$o=o("a"),fh=r("thomwolf"),_h=r(". The original code can be found "),zo=o("a"),gh=r("here"),Th=r("."),Ql=d(),sr=o("a"),ec=d(),Zt=o("h2"),jn=o("a"),wi=o("span"),f(xo.$$.fragment),vh=d(),$i=o("span"),kh=r("Training"),tc=d(),_t=o("p"),bh=r(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fg=d(),He=o("div"),f(Os.$$.fragment),_g=d(),hn=o("p"),gg=r("The "),qr=o("a"),Tg=r("T5ForConditionalGeneration"),vg=r(" forward method, overrides the "),Wd=o("code"),kg=r("__call__"),bg=r(" special method."),yg=d(),f(Rn.$$.fragment),wg=d(),Rd=o("p"),$g=r("Examples:"),zg=d(),f(Gs.$$.fragment),xg=d(),Ve=o("div"),f(Bs.$$.fragment),Eg=d(),Hd=o("p"),qg=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),jg=d(),Vd=o("p"),Fg=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vv=d(),f(Xn.$$.fragment),kv=d(),Je=o("div"),f(ya.$$.fragment),bv=d(),Tn=o("p"),yv=r("The "),Ar=o("a"),wv=r("TFT5ForConditionalGeneration"),$v=r(" forward method, overrides the "),fl=o("code"),zv=r("__call__"),xv=r(" special method."),Ev=d(),f(Qn.$$.fragment),qv=d(),_l=o("p"),jv=r("Examples:"),Fv=d(),f(wa.$$.fragment),Nc=d(),vn=o("h2"),eo=o("a"),gl=o("span"),f($a.$$.fragment),Mv=d(),Tl=o("span"),Pv=r("TFT5EncoderModel"),Lc=d(),ce=o("div"),f(za.$$.fragment),Cv=d(),vl=o("p"),Av=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Nv=d(),xa=o("p"),Lv=r("The T5 model was proposed in "),Ea=o("a"),Iv=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
use of token type ids, therefore a list of zeros is returned.`),T5.forEach(t),rp.forEach(t),Sf=l(st),br=s(st,"DIV",{class:!0});var v5=a(br);_(ps.$$.fragment,v5),v5.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);On=s(ip,"A",{id:!0,class:!0,href:!0});var k5=a(On);$d=s(k5,"SPAN",{});var b5=a($d);_(hs.$$.fragment,b5),b5.forEach(t),k5.forEach(t),Of=l(ip),zd=s(ip,"SPAN",{});var y5=a(zd);Gf=i(y5,"T5TokenizerFast"),y5.forEach(t),ip.forEach(t),$c=l(n),Se=s(n,"DIV",{class:!0});var Dt=a(Se);_(us.$$.fragment,Dt),Bf=l(Dt),dn=s(Dt,"P",{});var Kr=a(dn);Uf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),xd=s(Kr,"EM",{});var w5=a(xd);Wf=i(w5,"tokenizers"),w5.forEach(t),Rf=i(Kr,` library). Based on
...
use of token type ids, therefore a list of zeros is returned.`),j5.forEach(t),cp.forEach(t),Dt.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Bn=s(pp,"A",{id:!0,class:!0,href:!0});var F5=a(Bn);Md=s(F5,"SPAN",{});var M5=a(Md);_(vs.$$.fragment,M5),M5.forEach(t),F5.forEach(t),c_=l(pp),Pd=s(pp,"SPAN",{});var P5=a(Pd);p_=i(P5,"T5Model"),P5.forEach(t),pp.forEach(t),xc=l(n),J=s(n,"DIV",{class:!0});var $e=a(J);_(ks.$$.fragment,$e),h_=l($e),Cd=s($e,"P",{});var C5=a(Cd);u_=i(C5,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),C5.forEach(t),m_=l($e),bs=s($e,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var A5=a(ys);__=i(A5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),A5.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l($e),ws=s($e,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var N5=a(zr);k_=i(N5,"PreTrainedModel"),N5.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),vv=l(rt),_(Xn.$$.fragment,rt),kv=l(rt),Je=s(rt,"DIV",{class:!0});var Ht=a(Je);_(ya.$$.fragment,Ht),bv=l(Ht),Tn=s(Ht,"P",{});var ei=a(Tn);yv=i(ei,"The "),Ar=s(ei,"A",{href:!0});var Dy=a(Ar);wv=i(Dy,"TFT5ForConditionalGeneration"),Dy.forEach(t),$v=i(ei," forward method, overrides the "),fl=s(ei,"CODE",{});var Sy=a(fl);zv=i(Sy,"__call__"),Sy.forEach(t),xv=i(ei," special method."),ei.forEach(t),Ev=l(Ht),_(Qn.$$.fragment,Ht),qv=l(Ht),_l=s(Ht,"P",{});var Oy=a(_l);jv=i(Oy,"Examples:"),Oy.forEach(t),Fv=l(Ht),_(wa.$$.fragment,Ht),Ht.forEach(t),rt.forEach(t),Nc=l(n),vn=s(n,"H2",{class:!0});var Cp=a(vn);eo=s(Cp,"A",{id:!0,class:!0,href:!0});var Gy=a(eo);gl=s(Gy,"SPAN",{});var By=a(gl);_($a.$$.fragment,By),By.forEach(t),Gy.forEach(t),Mv=l(Cp),Tl=s(Cp,"SPAN",{});var Uy=a(Tl);Pv=i(Uy,"TFT5EncoderModel"),Uy.forEach(t),Cp.forEach(t),Lc=l(n),ce=s(n,"DIV",{class:!0});var it=a(ce);_(za.$$.fragment,it),Cv=l(it),vl=s(it,"P",{});var Wy=a(vl);Av=i(Wy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Wy.forEach(t),Nv=l(it),xa=s(it,"P",{});var Ap=a(xa);Lv=i(Ap,"The T5 model was proposed in "),Ea=s(Ap,"A",{href:!0,rel:!0});var Ry=a(Ea);Iv=i(Ry,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
