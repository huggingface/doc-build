import{S as Ql,i as Yl,s as Zl,e as n,k as d,w as _,t as r,M as ed,c as s,d as o,m as c,a,x as v,h as i,b as l,F as e,g as u,y as T,q as y,o as P,B as k}from"../../chunks/vendor-4833417e.js";import{T as rn}from"../../chunks/Tip-fffd6df1.js";import{D as V}from"../../chunks/Docstring-7b52c3d4.js";import{C as je}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as _e}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function td(O){let p,w,f,b,N;return{c(){p=n("p"),w=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),b=r("Module"),N=r(`
...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var m=a(p);w=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var $=a(f);b=i($,"Module"),$.forEach(o),N=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(g,m){u(g,p,m),e(p,w),e(p,f),e(f,b),e(p,N)},d(g){g&&o(p)}}}function rd(O){let p,w,f,b,N,g,m,$,Jn,ln,oe,ve,ro,Ae,Rn,io,Xn,dn,J,Kn,Ie,Qn,Yn,Le,Zn,es,cn,Lt,ts,pn,Te,os,Se,ns,ss,hn,ne,ye,lo,De,as,co,rs,un,Pe,is,po,ls,ds,fn,Be,mn,se,ke,ho,Oe,cs,uo,ps,gn,z,We,hs,ae,us,St,fs,ms,He,gs,_s,vs,re,Ts,Dt,ys,Ps,Bt,ks,bs,ws,fo,Ns,$s,Ue,_n,ie,be,mo,Ve,Gs,go,xs,vn,F,Je,Ms,_o,Es,zs,Re,Fs,Ot,qs,Cs,js,Xe,As,Ke,Is,Ls,Ss,C,Qe,Ds,le,Bs,Wt,Os,Ws,vo,Hs,Us,Vs,we,Js,To,Rs,Xs,Ye,Tn,de,Ne,yo,Ze,Ks,Po,Qs,yn,q,et,Ys,ko,Zs,ea,tt,ta,Ht,oa,na,sa,ot,aa,nt,ra,ia,la,j,st,da,ce,ca,Ut,pa,ha,bo,ua,fa,ma,$e,ga,wo,_a,va,at,Pn,pe,Ge,No,rt,Ta,$o,ya,kn,G,it,Pa,Go,ka,ba,Vt,Jt,wa,Na,$a,W,Ga,xo,xa,Ma,Mo,Ea,za,Eo,Fa,qa,zo,Ca,ja,Aa,lt,Ia,Rt,La,Sa,Da,dt,Ba,ct,Oa,Wa,Ha,E,pt,Ua,he,Va,Xt,Ja,Ra,Fo,Xa,Ka,Qa,xe,Ya,qo,Za,er,ht,tr,Co,or,nr,ut,bn,ue,Me,jo,ft,sr,Ao,ar,wn,x,mt,rr,Io,ir,lr,gt,dr,Kt,cr,pr,hr,_t,ur,vt,fr,mr,gr,Lo,_r,vr,H,So,Tt,Tr,yr,Do,yt,Pr,kr,Bo,Pt,br,wr,Oo,kt,Nr,$r,A,bt,Gr,fe,xr,Wo,Mr,Er,Ho,zr,Fr,qr,Ee,Cr,Uo,jr,Ar,wt,Nn,me,ze,Vo,Nt,Ir,Jo,Lr,$n,M,$t,Sr,Ro,Dr,Br,Gt,Or,Qt,Wr,Hr,Ur,xt,Vr,Mt,Jr,Rr,Xr,Xo,Kr,Qr,U,Ko,Et,Yr,Zr,Qo,zt,ei,ti,Yo,Ft,oi,ni,Zo,qt,si,ai,I,Ct,ri,ge,ii,en,li,di,tn,ci,pi,hi,Fe,ui,on,fi,mi,jt,Gn;return g=new _e({}),Ae=new _e({}),De=new _e({}),Be=new je({props:{codee:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Ve=new _e({}),Je=new V({props:{name:"class transformers.GPTNeoModel",anchor:"transformers.GPTNeoModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L475",parametersDescription:[{anchor:"transformers.GPTNeoModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.17.0/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qe=new V({props:{name:"forward",anchor:"transformers.GPTNeoModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L496",parametersDescription:[{anchor:"transformers.GPTNeoModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/v4.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.17.0/en/model_doc/gpt_neo#transformers.GPTNeoConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ze=new _e({}),et=new V({props:{name:"class transformers.GPTNeoForCausalLM",anchor:"transformers.GPTNeoForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L663",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.17.0/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),st=new V({props:{name:"forward",anchor:"transformers.GPTNeoForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L713",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
documentation from `),Bt=n("a"),ks=r("PretrainedConfig"),bs=r(" for more information."),ws=d(),fo=n("p"),Ns=r("Example:"),$s=d(),_(Ue.$$.fragment),_n=d(),ie=n("h2"),be=n("a"),mo=n("span"),_(Ve.$$.fragment),Gs=d(),go=n("span"),xs=r("GPTNeoModel"),vn=d(),F=n("div"),_(Je.$$.fragment),Ms=d(),_o=n("p"),Es=r("The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),zs=d(),Re=n("p"),Fs=r("This model inherits from "),Ot=n("a"),qs=r("PreTrainedModel"),Cs=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Ss=d(),C=n("div"),_(Qe.$$.fragment),Ds=d(),le=n("p"),Bs=r("The "),Wt=n("a"),Os=r("GPTNeoModel"),Ws=r(" forward method, overrides the "),vo=n("code"),Hs=r("__call__"),Us=r(" special method."),Vs=d(),_(we.$$.fragment),Js=d(),To=n("p"),Rs=r("Example:"),Xs=d(),_(Ye.$$.fragment),Tn=d(),de=n("h2"),Ne=n("a"),yo=n("span"),_(Ze.$$.fragment),Ks=d(),Po=n("span"),Qs=r("GPTNeoForCausalLM"),yn=d(),q=n("div"),_(et.$$.fragment),Ys=d(),ko=n("p"),Zs=r(`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),la=d(),j=n("div"),_(st.$$.fragment),da=d(),ce=n("p"),ca=r("The "),Ut=n("a"),pa=r("GPTNeoForCausalLM"),ha=r(" forward method, overrides the "),bo=n("code"),ua=r("__call__"),fa=r(" special method."),ma=d(),_($e.$$.fragment),ga=d(),wo=n("p"),_a=r("Example:"),va=d(),_(at.$$.fragment),Pn=d(),pe=n("h2"),Ge=n("a"),No=n("span"),_(rt.$$.fragment),Ta=d(),$o=n("span"),ya=r("GPTNeoForSequenceClassification"),kn=d(),G=n("div"),_(it.$$.fragment),Pa=d(),Go=n("p"),ka=r("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),ba=d(),Vt=n("p"),Jt=n("a"),wa=r("GPTNeoForSequenceClassification"),Na=r(` uses the last token in order to do the classification, as other causal models
...
`),vt=n("a"),fr=r("flax.nn.Module"),mr=r(` subclass. Use it as a
...
256 tokens.`),ki.forEach(o),pn=c(t),Te=s(t,"P",{});var xn=a(Te);os=i(xn,"This model was contributed by "),Se=s(xn,"A",{href:!0,rel:!0});var bi=a(Se);ns=i(bi,"valhalla"),bi.forEach(o),ss=i(xn,"."),xn.forEach(o),hn=c(t),ne=s(t,"H3",{class:!0});var Mn=a(ne);ye=s(Mn,"A",{id:!0,class:!0,href:!0});var wi=a(ye);lo=s(wi,"SPAN",{});var Ni=a(lo);v(De.$$.fragment,Ni),Ni.forEach(o),wi.forEach(o),as=c(Mn),co=s(Mn,"SPAN",{});var $i=a(co);rs=i($i,"Generation"),$i.forEach(o),Mn.forEach(o),un=c(t),Pe=s(t,"P",{});var En=a(Pe);is=i(En,"The "),po=s(En,"CODE",{});var Gi=a(po);ls=i(Gi,"generate()"),Gi.forEach(o),ds=i(En," method can be used to generate text using GPT Neo model."),En.forEach(o),fn=c(t),v(Be.$$.fragment,t),mn=c(t),se=s(t,"H2",{class:!0});var zn=a(se);ke=s(zn,"A",{id:!0,class:!0,href:!0});var xi=a(ke);ho=s(xi,"SPAN",{});var Mi=a(ho);v(Oe.$$.fragment,Mi),Mi.forEach(o),xi.forEach(o),cs=c(zn),uo=s(zn,"SPAN",{});var Ei=a(uo);ps=i(Ei,"GPTNeoConfig"),Ei.forEach(o),zn.forEach(o),gn=c(t),z=s(t,"DIV",{class:!0});var R=a(z);v(We.$$.fragment,R),hs=c(R),ae=s(R,"P",{});var Zt=a(ae);us=i(Zt,"This is the configuration class to store the configuration of a "),St=s(Zt,"A",{href:!0});var zi=a(St);fs=i(zi,"GPTNeoModel"),zi.forEach(o),ms=i(Zt,`. It is used to instantiate a GPT
Neo model according to the specified arguments, defining the model architecture. Instantiating a configuration with
the defaults will yield a similar configuration to that of the GPTNeo
`),He=s(Zt,"A",{href:!0,rel:!0});var Fi=a(He);gs=i(Fi,"gpt-neo-1.3B"),Fi.forEach(o),_s=i(Zt," architecture."),Zt.forEach(o),vs=c(R),re=s(R,"P",{});var eo=a(re);Ts=i(eo,"Configuration objects inherit from "),Dt=s(eo,"A",{href:!0});var qi=a(Dt);ys=i(qi,"PretrainedConfig"),qi.forEach(o),Ps=i(eo,` and can be used to control the model outputs. Read the
documentation from `),Bt=s(eo,"A",{href:!0});var Ci=a(Bt);ks=i(Ci,"PretrainedConfig"),Ci.forEach(o),bs=i(eo," for more information."),eo.forEach(o),ws=c(R),fo=s(R,"P",{});var ji=a(fo);Ns=i(ji,"Example:"),ji.forEach(o),$s=c(R),v(Ue.$$.fragment,R),R.forEach(o),_n=c(t),ie=s(t,"H2",{class:!0});var Fn=a(ie);be=s(Fn,"A",{id:!0,class:!0,href:!0});var Ai=a(be);mo=s(Ai,"SPAN",{});var Ii=a(mo);v(Ve.$$.fragment,Ii),Ii.forEach(o),Ai.forEach(o),Gs=c(Fn),go=s(Fn,"SPAN",{});var Li=a(go);xs=i(Li,"GPTNeoModel"),Li.forEach(o),Fn.forEach(o),vn=c(t),F=s(t,"DIV",{class:!0});var X=a(F);v(Je.$$.fragment,X),Ms=c(X),_o=s(X,"P",{});var Si=a(_o);Es=i(Si,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),Si.forEach(o),zs=c(X),Re=s(X,"P",{});var qn=a(Re);Fs=i(qn,"This model inherits from "),Ot=s(qn,"A",{href:!0});var Di=a(Ot);qs=i(Di,"PreTrainedModel"),Di.forEach(o),Cs=i(qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dn.forEach(o),Ha=c(L),E=s(L,"DIV",{class:!0});var S=a(E);v(pt.$$.fragment,S),Ua=c(S),he=s(S,"P",{});var no=a(he);Va=i(no,"The "),Xt=s(no,"A",{href:!0});var pl=a(Xt);Ja=i(pl,"GPTNeoForSequenceClassification"),pl.forEach(o),Ra=i(no," forward method, overrides the "),Fo=s(no,"CODE",{});var hl=a(Fo);Xa=i(hl,"__call__"),hl.forEach(o),Ka=i(no," special method."),no.forEach(o),Qa=c(S),v(xe.$$.fragment,S),Ya=c(S),qo=s(S,"P",{});var ul=a(qo);Za=i(ul,"Example of single-label classification:"),ul.forEach(o),er=c(S),v(ht.$$.fragment,S),tr=c(S),Co=s(S,"P",{});var fl=a(Co);or=i(fl,"Example of multi-label classification:"),fl.forEach(o),nr=c(S),v(ut.$$.fragment,S),S.forEach(o),L.forEach(o),bn=c(t),ue=s(t,"H2",{class:!0});var Bn=a(ue);Me=s(Bn,"A",{id:!0,class:!0,href:!0});var ml=a(Me);jo=s(ml,"SPAN",{});var gl=a(jo);v(ft.$$.fragment,gl),gl.forEach(o),ml.forEach(o),sr=c(Bn),Ao=s(Bn,"SPAN",{});var _l=a(Ao);ar=i(_l,"FlaxGPTNeoModel"),_l.forEach(o),Bn.forEach(o),wn=c(t),x=s(t,"DIV",{class:!0});var D=a(x);v(mt.$$.fragment,D),rr=c(D),Io=s(D,"P",{});var vl=a(Io);ir=i(vl,"The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),vl.forEach(o),lr=c(D),gt=s(D,"P",{});var On=a(gt);dr=i(On,"This model inherits from "),Kt=s(On,"A",{href:!0});var Tl=a(Kt);cr=i(Tl,"FlaxPreTrainedModel"),Tl.forEach(o),pr=i(On,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),On.forEach(o),hr=c(D),_t=s(D,"P",{});var Wn=a(_t);ur=i(Wn,`This model is also a Flax Linen
`),vt=s(Wn,"A",{href:!0,rel:!0});var yl=a(vt);fr=i(yl,"flax.nn.Module"),yl.forEach(o),mr=i(Wn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Wn.forEach(o),gr=c(D),Lo=s(D,"P",{});var Pl=a(Lo);_r=i(Pl,"Finally, this model supports inherent JAX features such as:"),Pl.forEach(o),vr=c(D),H=s(D,"UL",{});var qe=a(H);So=s(qe,"LI",{});var kl=a(So);Tt=s(kl,"A",{href:!0,rel:!0});var bl=a(Tt);Tr=i(bl,"Just-In-Time (JIT) compilation"),bl.forEach(o),kl.forEach(o),yr=c(qe),Do=s(qe,"LI",{});var wl=a(Do);yt=s(wl,"A",{href:!0,rel:!0});var Nl=a(yt);Pr=i(Nl,"Automatic Differentiation"),Nl.forEach(o),wl.forEach(o),kr=c(qe),Bo=s(qe,"LI",{});var $l=a(Bo);Pt=s($l,"A",{href:!0,rel:!0});var Gl=a(Pt);br=i(Gl,"Vectorization"),Gl.forEach(o),$l.forEach(o),wr=c(qe),Oo=s(qe,"LI",{});var xl=a(Oo);kt=s(xl,"A",{href:!0,rel:!0});var Ml=a(kt);Nr=i(Ml,"Parallelization"),Ml.forEach(o),xl.forEach(o),qe.forEach(o),$r=c(D),A=s(D,"DIV",{class:!0});var ee=a(A);v(bt.$$.fragment,ee),Gr=c(ee),fe=s(ee,"P",{});var so=a(fe);xr=i(so,"The "),Wo=s(so,"CODE",{});var El=a(Wo);Mr=i(El,"FlaxGPTNeoPreTrainedModel"),El.forEach(o),Er=i(so,"forward method, overrides the "),Ho=s(so,"CODE",{});var zl=a(Ho);zr=i(zl,"__call__"),zl.forEach(o),Fr=i(so," special method."),so.forEach(o),qr=c(ee),v(Ee.$$.fragment,ee),Cr=c(ee),Uo=s(ee,"P",{});var Fl=a(Uo);jr=i(Fl,"Example:"),Fl.forEach(o),Ar=c(ee),v(wt.$$.fragment,ee),ee.forEach(o),D.forEach(o),Nn=c(t),me=s(t,"H2",{class:!0});var Hn=a(me);ze=s(Hn,"A",{id:!0,class:!0,href:!0});var ql=a(ze);Vo=s(ql,"SPAN",{});var Cl=a(Vo);v(Nt.$$.fragment,Cl),Cl.forEach(o),ql.forEach(o),Ir=c(Hn),Jo=s(Hn,"SPAN",{});var jl=a(Jo);Lr=i(jl,"FlaxGPTNeoForCausalLM"),jl.forEach(o),Hn.forEach(o),$n=c(t),M=s(t,"DIV",{class:!0});var B=a(M);v($t.$$.fragment,B),Sr=c(B),Ro=s(B,"P",{});var Al=a(Ro);Dr=i(Al,`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Vn.forEach(o),Xr=c(B),Xo=s(B,"P",{});var Sl=a(Xo);Kr=i(Sl,"Finally, this model supports inherent JAX features such as:"),Sl.forEach(o),Qr=c(B),U=s(B,"UL",{});var Ce=a(U);Ko=s(Ce,"LI",{});var Dl=a(Ko);Et=s(Dl,"A",{href:!0,rel:!0});var Bl=a(Et);Yr=i(Bl,"Just-In-Time (JIT) compilation"),Bl.forEach(o),Dl.forEach(o),Zr=c(Ce),Qo=s(Ce,"LI",{});var Ol=a(Qo);zt=s(Ol,"A",{href:!0,rel:!0});var Wl=a(zt);ei=i(Wl,"Automatic Differentiation"),Wl.forEach(o),Ol.forEach(o),ti=c(Ce),Yo=s(Ce,"LI",{});var Hl=a(Yo);Ft=s(Hl,"A",{href:!0,rel:!0});var Ul=a(Ft);oi=i(Ul,"Vectorization"),Ul.forEach(o),Hl.forEach(o),ni=c(Ce),Zo=s(Ce,"LI",{});var Vl=a(Zo);qt=s(Vl,"A",{href:!0,rel:!0});var Jl=a(qt);si=i(Jl,"Parallelization"),Jl.forEach(o),Vl.forEach(o),Ce.forEach(o),ai=c(B),I=s(B,"DIV",{class:!0});var te=a(I);v(Ct.$$.fragment,te),ri=c(te),ge=s(te,"P",{});var ao=a(ge);ii=i(ao,"The "),en=s(ao,"CODE",{});var Rl=a(en);li=i(Rl,"FlaxGPTNeoPreTrainedModel"),Rl.forEach(o),di=i(ao,"forward method, overrides the "),tn=s(ao,"CODE",{});var Xl=a(tn);ci=i(Xl,"__call__"),Xl.forEach(o),pi=i(ao," special method."),ao.forEach(o),hi=c(te),v(Fe.$$.fragment,te),ui=c(te),on=s(te,"P",{});var Kl=a(on);fi=i(Kl,"Example:"),Kl.forEach(o),mi=c(te),v(jt.$$.fragment,te),te.forEach(o),B.forEach(o),this.h()},h(){l(p,"name","hf:doc:metadata"),l(p,"content",JSON.stringify(id)),l(b,"id","gpt-neo"),l(b,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(b,"href","#gpt-neo"),l(f,"class","relative group"),l(ve,"id","overview"),l(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ve,"href","#overview"),l(oe,"class","relative group"),l(Ie,"href","https://github.com/EleutherAI/gpt-neo"),l(Ie,"rel","nofollow"),l(Le,"href","https://pile.eleuther.ai/"),l(Le,"rel","nofollow"),l(Se,"href","https://huggingface.co/valhalla"),l(Se,"rel","nofollow"),l(ye,"id","generation"),l(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ye,"href","#generation"),l(ne,"class","relative group"),l(ke,"id","transformers.GPTNeoConfig"),l(ke,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ke,"href","#transformers.GPTNeoConfig"),l(se,"class","relative group"),l(St,"href","/docs/transformers/v4.17.0/en/model_doc/gpt_neo#transformers.GPTNeoModel"),l(He,"href","https://huggingface.co/EleutherAI/gpt-neo-1.3B"),l(He,"rel","nofollow"),l(Dt,"href","/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig"),l(Bt,"href","/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig"),l(z,"class","docstring"),l(be,"id","transformers.GPTNeoModel"),l(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(be,"href","#transformers.GPTNeoModel"),l(ie,"class","relative group"),l(Ot,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel"),l(Ke,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ke,"rel","nofollow"),l(Wt,"href","/docs/transformers/v4.17.0/en/model_doc/gpt_neo#transformers.GPTNeoModel"),l(C,"class","docstring"),l(F,"class","docstring"),l(Ne,"id","transformers.GPTNeoForCausalLM"),l(Ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ne,"href","#transformers.GPTNeoForCausalLM"),l(de,"class","relative group"),l(Ht,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel"),l(nt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(nt,"rel","nofollow"),l(Ut,"href","/docs/transformers/v4.17.0/en/model_doc/gpt_neo#transformers.GPTNeoForCausalLM"),l(j,"class","docstring"),l(q,"class","docstring"),l(Ge,"id","transformers.GPTNeoForSequenceClassification"),l(Ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ge,"href","#transformers.GPTNeoForSequenceClassification"),l(pe,"class","relative group"),l(Jt,"href","/docs/transformers/v4.17.0/en/model_doc/gpt_neo#transformers.GPTNeoForSequenceClassification"),l(Rt,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel"),l(ct,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(ct,"rel","nofollow"),l(Xt,"href","/docs/transformers/v4.17.0/en/model_doc/gpt_neo#transformers.GPTNeoForSequenceClassification"),l(E,"class","docstring"),l(G,"class","docstring"),l(Me,"id","transformers.FlaxGPTNeoModel"),l(Me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Me,"href","#transformers.FlaxGPTNeoModel"),l(ue,"class","relative group"),l(Kt,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.FlaxPreTrainedModel"),l(vt,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),l(vt,"rel","nofollow"),l(Tt,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),l(Tt,"rel","nofollow"),l(yt,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),l(yt,"rel","nofollow"),l(Pt,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),l(Pt,"rel","nofollow"),l(kt,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),l(kt,"rel","nofollow"),l(A,"class","docstring"),l(x,"class","docstring"),l(ze,"id","transformers.FlaxGPTNeoForCausalLM"),l(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ze,"href","#transformers.FlaxGPTNeoForCausalLM"),l(me,"class","relative group"),l(Qt,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.FlaxPreTrainedModel"),l(Mt,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),l(Mt,"rel","nofollow"),l(Et,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),l(Et,"rel","nofollow"),l(zt,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),l(zt,"rel","nofollow"),l(Ft,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),l(Ft,"rel","nofollow"),l(qt,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),l(qt,"rel","nofollow"),l(I,"class","docstring"),l(M,"class","docstring")},m(t,h){e(document.head,p),u(t,w,h),u(t,f,h),e(f,b),e(b,N),T(g,N,null),e(f,m),e(f,$),e($,Jn),u(t,ln,h),u(t,oe,h),e(oe,ve),e(ve,ro),T(Ae,ro,null),e(oe,Rn),e(oe,io),e(io,Xn),u(t,dn,h),u(t,J,h),e(J,Kn),e(J,Ie),e(Ie,Qn),e(J,Yn),e(J,Le),e(Le,Zn),e(J,es),u(t,cn,h),u(t,Lt,h),e(Lt,ts),u(t,pn,h),u(t,Te,h),e(Te,os),e(Te,Se),e(Se,ns),e(Te,ss),u(t,hn,h),u(t,ne,h),e(ne,ye),e(ye,lo),T(De,lo,null),e(ne,as),e(ne,co),e(co,rs),u(t,un,h),u(t,Pe,h),e(Pe,is),e(Pe,po),e(po,ls),e(Pe,ds),u(t,fn,h),T(Be,t,h),u(t,mn,h),u(t,se,h),e(se,ke),e(ke,ho),T(Oe,ho,null),e(se,cs),e(se,uo),e(uo,ps),u(t,gn,h),u(t,z,h),T(We,z,null),e(z,hs),e(z,ae),e(ae,us),e(ae,St),e(St,fs),e(ae,ms),e(ae,He),e(He,gs),e(ae,_s),e(z,vs),e(z,re),e(re,Ts),e(re,Dt),e(Dt,ys),e(re,Ps),e(re,Bt),e(Bt,ks),e(re,bs),e(z,ws),e(z,fo),e(fo,Ns),e(z,$s),T(Ue,z,null),u(t,_n,h),u(t,ie,h),e(ie,be),e(be,mo),T(Ve,mo,null),e(ie,Gs),e(ie,go),e(go,xs),u(t,vn,h),u(t,F,h),T(Je,F,null),e(F,Ms),e(F,_o),e(_o,Es),e(F,zs),e(F,Re),e(Re,Fs),e(Re,Ot),e(Ot,qs),e(Re,Cs),e(F,js),e(F,Xe),e(Xe,As),e(Xe,Ke),e(Ke,Is),e(Xe,Ls),e(F,Ss),e(F,C),T(Qe,C,null),e(C,Ds),e(C,le),e(le,Bs),e(le,Wt),e(Wt,Os),e(le,Ws),e(le,vo),e(vo,Hs),e(le,Us),e(C,Vs),T(we,C,null),e(C,Js),e(C,To),e(To,Rs),e(C,Xs),T(Ye,C,null),u(t,Tn,h),u(t,de,h),e(de,Ne),e(Ne,yo),T(Ze,yo,null),e(de,Ks),e(de,Po),e(Po,Qs),u(t,yn,h),u(t,q,h),T(et,q,null),e(q,Ys),e(q,ko),e(ko,Zs),e(q,ea),e(q,tt),e(tt,ta),e(tt,Ht),e(Ht,oa),e(tt,na),e(q,sa),e(q,ot),e(ot,aa),e(ot,nt),e(nt,ra),e(ot,ia),e(q,la),e(q,j),T(st,j,null),e(j,da),e(j,ce),e(ce,ca),e(ce,Ut),e(Ut,pa),e(ce,ha),e(ce,bo),e(bo,ua),e(ce,fa),e(j,ma),T($e,j,null),e(j,ga),e(j,wo),e(wo,_a),e(j,va),T(at,j,null),u(t,Pn,h),u(t,pe,h),e(pe,Ge),e(Ge,No),T(rt,No,null),e(pe,Ta),e(pe,$o),e($o,ya),u(t,kn,h),u(t,G,h),T(it,G,null),e(G,Pa),e(G,Go),e(Go,ka),e(G,ba),e(G,Vt),e(Vt,Jt),e(Jt,wa),e(Vt,Na),e(G,$a),e(G,W),e(W,Ga),e(W,xo),e(xo,xa),e(W,Ma),e(W,Mo),e(Mo,Ea),e(W,za),e(W,Eo),e(Eo,Fa),e(W,qa),e(W,zo),e(zo,Ca),e(W,ja),e(G,Aa),e(G,lt),e(lt,Ia),e(lt,Rt),e(Rt,La),e(lt,Sa),e(G,Da),e(G,dt),e(dt,Ba),e(dt,ct),e(ct,Oa),e(dt,Wa),e(G,Ha),e(G,E),T(pt,E,null),e(E,Ua),e(E,he),e(he,Va),e(he,Xt),e(Xt,Ja),e(he,Ra),e(he,Fo),e(Fo,Xa),e(he,Ka),e(E,Qa),T(xe,E,null),e(E,Ya),e(E,qo),e(qo,Za),e(E,er),T(ht,E,null),e(E,tr),e(E,Co),e(Co,or),e(E,nr),T(ut,E,null),u(t,bn,h),u(t,ue,h),e(ue,Me),e(Me,jo),T(ft,jo,null),e(ue,sr),e(ue,Ao),e(Ao,ar),u(t,wn,h),u(t,x,h),T(mt,x,null),e(x,rr),e(x,Io),e(Io,ir),e(x,lr),e(x,gt),e(gt,dr),e(gt,Kt),e(Kt,cr),e(gt,pr),e(x,hr),e(x,_t),e(_t,ur),e(_t,vt),e(vt,fr),e(_t,mr),e(x,gr),e(x,Lo),e(Lo,_r),e(x,vr),e(x,H),e(H,So),e(So,Tt),e(Tt,Tr),e(H,yr),e(H,Do),e(Do,yt),e(yt,Pr),e(H,kr),e(H,Bo),e(Bo,Pt),e(Pt,br),e(H,wr),e(H,Oo),e(Oo,kt),e(kt,Nr),e(x,$r),e(x,A),T(bt,A,null),e(A,Gr),e(A,fe),e(fe,xr),e(fe,Wo),e(Wo,Mr),e(fe,Er),e(fe,Ho),e(Ho,zr),e(fe,Fr),e(A,qr),T(Ee,A,null),e(A,Cr),e(A,Uo),e(Uo,jr),e(A,Ar),T(wt,A,null),u(t,Nn,h),u(t,me,h),e(me,ze),e(ze,Vo),T(Nt,Vo,null),e(me,Ir),e(me,Jo),e(Jo,Lr),u(t,$n,h),u(t,M,h),T($t,M,null),e(M,Sr),e(M,Ro),e(Ro,Dr),e(M,Br),e(M,Gt),e(Gt,Or),e(Gt,Qt),e(Qt,Wr),e(Gt,Hr),e(M,Ur),e(M,xt),e(xt,Vr),e(xt,Mt),e(Mt,Jr),e(xt,Rr),e(M,Xr),e(M,Xo),e(Xo,Kr),e(M,Qr),e(M,U),e(U,Ko),e(Ko,Et),e(Et,Yr),e(U,Zr),e(U,Qo),e(Qo,zt),e(zt,ei),e(U,ti),e(U,Yo),e(Yo,Ft),e(Ft,oi),e(U,ni),e(U,Zo),e(Zo,qt),e(qt,si),e(M,ai),e(M,I),T(Ct,I,null),e(I,ri),e(I,ge),e(ge,ii),e(ge,en),e(en,li),e(ge,di),e(ge,tn),e(tn,ci),e(ge,pi),e(I,hi),T(Fe,I,null),e(I,ui),e(I,on),e(on,fi),e(I,mi),T(jt,I,null),Gn=!0},p(t,[h]){const At={};h&2&&(At.$$scope={dirty:h,ctx:t}),we.$set(At);const nn={};h&2&&(nn.$$scope={dirty:h,ctx:t}),$e.$set(nn);const sn={};h&2&&(sn.$$scope={dirty:h,ctx:t}),xe.$set(sn);const an={};h&2&&(an.$$scope={dirty:h,ctx:t}),Ee.$set(an);const It={};h&2&&(It.$$scope={dirty:h,ctx:t}),Fe.$set(It)},i(t){Gn||(y(g.$$.fragment,t),y(Ae.$$.fragment,t),y(De.$$.fragment,t),y(Be.$$.fragment,t),y(Oe.$$.fragment,t),y(We.$$.fragment,t),y(Ue.$$.fragment,t),y(Ve.$$.fragment,t),y(Je.$$.fragment,t),y(Qe.$$.fragment,t),y(we.$$.fragment,t),y(Ye.$$.fragment,t),y(Ze.$$.fragment,t),y(et.$$.fragment,t),y(st.$$.fragment,t),y($e.$$.fragment,t),y(at.$$.fragment,t),y(rt.$$.fragment,t),y(it.$$.fragment,t),y(pt.$$.fragment,t),y(xe.$$.fragment,t),y(ht.$$.fragment,t),y(ut.$$.fragment,t),y(ft.$$.fragment,t),y(mt.$$.fragment,t),y(bt.$$.fragment,t),y(Ee.$$.fragment,t),y(wt.$$.fragment,t),y(Nt.$$.fragment,t),y($t.$$.fragment,t),y(Ct.$$.fragment,t),y(Fe.$$.fragment,t),y(jt.$$.fragment,t),Gn=!0)},o(t){P(g.$$.fragment,t),P(Ae.$$.fragment,t),P(De.$$.fragment,t),P(Be.$$.fragment,t),P(Oe.$$.fragment,t),P(We.$$.fragment,t),P(Ue.$$.fragment,t),P(Ve.$$.fragment,t),P(Je.$$.fragment,t),P(Qe.$$.fragment,t),P(we.$$.fragment,t),P(Ye.$$.fragment,t),P(Ze.$$.fragment,t),P(et.$$.fragment,t),P(st.$$.fragment,t),P($e.$$.fragment,t),P(at.$$.fragment,t),P(rt.$$.fragment,t),P(it.$$.fragment,t),P(pt.$$.fragment,t),P(xe.$$.fragment,t),P(ht.$$.fragment,t),P(ut.$$.fragment,t),P(ft.$$.fragment,t),P(mt.$$.fragment,t),P(bt.$$.fragment,t),P(Ee.$$.fragment,t),P(wt.$$.fragment,t),P(Nt.$$.fragment,t),P($t.$$.fragment,t),P(Ct.$$.fragment,t),P(Fe.$$.fragment,t),P(jt.$$.fragment,t),Gn=!1},d(t){o(p),t&&o(w),t&&o(f),k(g),t&&o(ln),t&&o(oe),k(Ae),t&&o(dn),t&&o(J),t&&o(cn),t&&o(Lt),t&&o(pn),t&&o(Te),t&&o(hn),t&&o(ne),k(De),t&&o(un),t&&o(Pe),t&&o(fn),k(Be,t),t&&o(mn),t&&o(se),k(Oe),t&&o(gn),t&&o(z),k(We),k(Ue),t&&o(_n),t&&o(ie),k(Ve),t&&o(vn),t&&o(F),k(Je),k(Qe),k(we),k(Ye),t&&o(Tn),t&&o(de),k(Ze),t&&o(yn),t&&o(q),k(et),k(st),k($e),k(at),t&&o(Pn),t&&o(pe),k(rt),t&&o(kn),t&&o(G),k(it),k(pt),k(xe),k(ht),k(ut),t&&o(bn),t&&o(ue),k(ft),t&&o(wn),t&&o(x),k(mt),k(bt),k(Ee),k(wt),t&&o(Nn),t&&o(me),k(Nt),t&&o($n),t&&o(M),k($t),k(Ct),k(Fe),k(jt)}}}const id={local:"gpt-neo",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTNeoConfig",title:"GPTNeoConfig"},{local:"transformers.GPTNeoModel",title:"GPTNeoModel"},{local:"transformers.GPTNeoForCausalLM",title:"GPTNeoForCausalLM"},{local:"transformers.GPTNeoForSequenceClassification",title:"GPTNeoForSequenceClassification"},{local:"transformers.FlaxGPTNeoModel",title:"FlaxGPTNeoModel"},{local:"transformers.FlaxGPTNeoForCausalLM",title:"FlaxGPTNeoForCausalLM"}],title:"GPT Neo"};function ld(O,p,w){let{fw:f}=p;return O.$$set=b=>{"fw"in b&&w(0,f=b.fw)},[f]}class md extends Ql{constructor(p){super();Yl(this,p,ld,rd,Zl,{fw:0})}}export{md as default,id as metadata};
