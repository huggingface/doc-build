...
this superclass for more information regarding those methods.`),_l=d(),ia=o("p"),vl=r("Examples:"),kl=d(),v(Rn.$$.fragment),Tl=d(),Dt=o("div"),v(Bn.$$.fragment),Ml=d(),da=o("p"),yl=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
fine-tuning experiments and integration tests.`),su.forEach(t),fd=l(Ms),Gs=s(Ms,"LI",{});var au=a(Gs);Mn=s(au,"A",{href:!0,rel:!0});var ru=a(Mn);gd=i(ru,"Fine-tune on GPU"),ru.forEach(t),au.forEach(t),_d=l(Ms),Js=s(Ms,"LI",{});var iu=a(Js);yn=s(iu,"A",{href:!0,rel:!0});var du=a(yn);vd=i(du,"Fine-tune on GPU with pytorch-lightning"),du.forEach(t),iu.forEach(t),Ms.forEach(t),sr=l(n),mt=s(n,"H2",{class:!0});var Br=a(mt);It=s(Br,"A",{id:!0,class:!0,href:!0});var lu=a(It);Ys=s(lu,"SPAN",{});var cu=a(Ys);k(bn.$$.fragment,cu),cu.forEach(t),lu.forEach(t),kd=l(Br),Ks=s(Br,"SPAN",{});var pu=a(Ks);Td=i(pu,"Multilingual Models"),pu.forEach(t),Br.forEach(t),ar=l(n),Pe=s(n,"UL",{});var an=a(Pe);xn=s(an,"LI",{});var Vr=a(xn);Md=i(Vr,"All model names use the following format: "),Zs=s(Vr,"CODE",{});var hu=a(Zs);yd=i(hu,"Helsinki-NLP/opus-mt-{src}-{tgt}"),hu.forEach(t),bd=i(Vr,":"),Vr.forEach(t),xd=l(an),wn=s(an,"LI",{});var Gr=a(wn);wd=i(Gr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
group:`),Mu.forEach(t),hr=l(n),k(Nn.$$.fragment,n),ur=l(n),ns=s(n,"P",{});var yu=a(ns);Wd=i(yu,"Example of translating english to many romance languages, using old-style 2 character language codes"),yu.forEach(t),mr=l(n),k(Cn.$$.fragment,n),fr=l(n),gt=s(n,"H2",{class:!0});var Xr=a(gt);Ot=s(Xr,"A",{id:!0,class:!0,href:!0});var bu=a(Ot);na=s(bu,"SPAN",{});var xu=a(na);k(Ln.$$.fragment,xu),xu.forEach(t),bu.forEach(t),Rd=l(Xr),oa=s(Xr,"SPAN",{});var wu=a(oa);Bd=i(wu,"MarianConfig"),wu.forEach(t),Xr.forEach(t),gr=l(n),le=s(n,"DIV",{class:!0});var Ke=a(le);k(In.$$.fragment,Ke),Vd=l(Ke),_t=s(Ke,"P",{});var ys=a(_t);Gd=i(ys,"This is the configuration class to store the configuration of a "),os=s(ys,"A",{href:!0});var zu=a(os);Jd=i(zu,"MarianModel"),zu.forEach(t),Yd=i(ys,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
...
this superclass for more information regarding those methods.`),ti.forEach(t),_l=l(Fe),ia=s(Fe,"P",{});var Iu=a(ia);vl=i(Iu,"Examples:"),Iu.forEach(t),kl=l(Fe),k(Rn.$$.fragment,Fe),Tl=l(Fe),Dt=s(Fe,"DIV",{class:!0});var ni=a(Dt);k(Bn.$$.fragment,ni),Ml=l(ni),da=s(ni,"P",{});var Au=a(da);yl=i(Au,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
models are listed `),$o=s(vi,"A",{href:!0,rel:!0});var Tm=a($o);cp=i(Tm,"here"),Tm.forEach(t),pp=i(vi,"."),vi.forEach(t),hp=l(Ce),$a=s(Ce,"P",{});var Mm=a($a);up=i(Mm,"Examples:"),Mm.forEach(t),mp=l(Ce),k(jo.$$.fragment,Ce),Ce.forEach(t),et.forEach(t),qr=l(n),Et=s(n,"H2",{class:!0});var ki=a(Et);Qt=s(ki,"A",{id:!0,class:!0,href:!0});var ym=a(Qt);ja=s(ym,"SPAN",{});var bm=a(ja);k(qo.$$.fragment,bm),bm.forEach(t),ym.forEach(t),fp=l(ki),qa=s(ki,"SPAN",{});var xm=a(qa);gp=i(xm,"FlaxMarianModel"),xm.forEach(t),ki.forEach(t),Er=l(n),R=s(n,"DIV",{class:!0});var Le=a(R);k(Eo.$$.fragment,Le),_p=l(Le),Po=s(Le,"P",{});var Ti=a(Po);vp=i(Ti,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
