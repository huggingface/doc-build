import{S as ic,i as cc,s as lc,e as a,k as l,w as m,t as s,M as dc,c as n,d as o,m as d,a as i,x as u,h as r,b as c,F as e,g as p,y as _,q as g,o as v,B as T}from"../../chunks/vendor-4833417e.js";import{T as nc}from"../../chunks/Tip-fffd6df1.js";import{D as L}from"../../chunks/Docstring-4f315ed9.js";import{C as Ps}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as gt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function hc(ye){let f,q,k,w,D,S,O,I;return{c(){f=a("p"),q=s(`This class method is simply calling the feature extractor
...
`),k=n(b,"A",{href:!0});var C=i(k);w=r(C,"from_pretrained()"),C.forEach(o),D=r(b,` and the tokenizer
`),S=n(b,"CODE",{});var M=i(S);O=r(M,"from_pretrained"),M.forEach(o),I=r(b,` methods. Please refer to the docstrings of the
methods above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/v4.17.0/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(P,b){p(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,O),e(f,I)},d(P){P&&o(f)}}}function pc(ye){let f,q,k,w,D,S,O,I;return{c(){f=a("p"),q=s("This class method is simply calling "),k=a("a"),w=s("save_pretrained()"),D=s(` and
`),S=a("code"),O=s("save_pretrained"),I=s(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(P){f=n(P,"P",{});var b=i(f);q=r(b,"This class method is simply calling "),k=n(b,"A",{href:!0});var C=i(k);w=r(C,"save_pretrained()"),C.forEach(o),D=r(b,` and
`),S=n(b,"CODE",{});var M=i(S);O=r(M,"save_pretrained"),M.forEach(o),I=r(b,`. Please refer to the docstrings of the methods
above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/v4.17.0/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){p(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,O),e(f,I)},d(P){P&&o(f)}}}function fc(ye){let f,q,k,w,D,S,O,I,P,b,C,M,so,$e,Cs,ro,js,Lo,R,qs,vt,Ms,Fs,Ee,As,Ls,Do,y,Ds,ao,Is,Ws,no,Vs,Ns,Tt,Os,Bs,kt,Us,Hs,xt,Rs,Js,io,Gs,Ks,Io,ie,Qs,ze,Xs,Ys,Wo,ce,Zs,Pe,er,tr,Vo,bt,or,No,J,Ce,sr,je,rr,ar,nr,qe,ir,wt,cr,lr,dr,Me,hr,Fe,pr,fr,Oo,ee,le,co,Ae,mr,lo,ur,Bo,G,_r,St,gr,vr,yt,Tr,kr,Uo,z,xr,$t,br,wr,Et,Sr,yr,zt,$r,Er,Pt,zr,Pr,Ct,Cr,jr,Ho,jt,ho,qr,Ro,Le,Jo,qt,De,po,Mr,Fr,fo,Ar,Go,Ie,Ko,de,Lr,We,Dr,Ir,Qo,te,he,mo,Ve,Wr,uo,Vr,Xo,j,Ne,Nr,oe,Or,Mt,Br,Ur,Oe,Hr,Rr,Jr,se,Gr,Ft,Kr,Qr,At,Xr,Yr,Zr,_o,ea,ta,Be,Yo,re,pe,go,Ue,oa,vo,sa,Zo,E,He,ra,To,aa,na,Re,ia,Lt,ca,la,da,fe,Je,ha,ko,pa,fa,K,Ge,ma,xo,ua,_a,Ke,ga,bo,va,Ta,ka,Dt,Qe,es,ae,me,wo,Xe,xa,So,ba,ts,x,Ye,wa,yo,Sa,ya,F,It,$a,Ea,Wt,za,Pa,Vt,Ca,ja,Ze,$o,qa,Ma,Fa,Nt,Aa,La,Da,ue,et,Ia,B,Wa,Eo,Va,Na,Ot,Oa,Ba,tt,zo,Ua,Ha,Ra,Ja,Q,ot,Ga,Po,Ka,Qa,_e,Xa,X,st,Ya,rt,Za,Bt,en,tn,on,ge,sn,ve,at,rn,nt,an,Ut,nn,cn,ln,Te,it,dn,ct,hn,Ht,pn,fn,mn,ke,lt,un,Co,_n,os,ne,xe,jo,dt,gn,qo,vn,ss,W,ht,Tn,U,kn,Rt,xn,bn,Mo,wn,Sn,Jt,yn,$n,En,pt,zn,ft,Pn,Cn,jn,Y,mt,qn,Fo,Mn,Fn,ut,rs;return S=new gt({}),$e=new gt({}),Ae=new gt({}),Le=new Ps({props:{code:`import torch
...
`,returnType:`
<p><code>str</code></p>
`}}),Qe=new L({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L235"}}),Xe=new gt({}),Ye=new L({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L23",parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("meta"),q=l(),k=a("h1"),w=a("a"),D=a("span"),m(S.$$.fragment),O=l(),I=a("span"),P=s("Speech2Text2"),b=l(),C=a("h2"),M=a("a"),so=a("span"),m($e.$$.fragment),Cs=l(),ro=a("span"),js=s("Overview"),Lo=l(),R=a("p"),qs=s("The Speech2Text2 model is used together with "),vt=a("a"),Ms=s("Wav2Vec2"),Fs=s(` for Speech Translation models proposed in
...
model.`),Io=l(),ie=a("p"),Qs=s("This model was contributed by "),ze=a("a"),Xs=s("Patrick von Platen"),Ys=s("."),Wo=l(),ce=a("p"),Zs=s("The original code can be found "),Pe=a("a"),er=s("here"),tr=s("."),Vo=l(),bt=a("p"),or=s("Tips:"),No=l(),J=a("ul"),Ce=a("li"),sr=s(`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
the `),je=a("a"),rr=s("official models"),ar=s(" ."),nr=l(),qe=a("li"),ir=s("Speech2Text2 is always used within the "),wt=a("a"),cr=s("SpeechEncoderDecoder"),lr=s(" framework."),dr=l(),Me=a("li"),hr=s("Speech2Text2\u2019s tokenizer is based on "),Fe=a("a"),pr=s("fastBPE"),fr=s("."),Oo=l(),ee=a("h2"),le=a("a"),co=a("span"),m(Ae.$$.fragment),mr=l(),lo=a("span"),ur=s("Inference"),Bo=l(),G=a("p"),_r=s("Speech2Text2\u2019s "),St=a("a"),gr=s("SpeechEncoderDecoderModel"),vr=s(` model accepts raw waveform input values from speech and
...
`),Ct=a("a"),Cr=s("Speech2Text2Tokenizer"),jr=s(` into a single instance to both extract the input features and decode the
predicted token ids.`),Ho=l(),jt=a("ul"),ho=a("li"),qr=s("Step-by-step Speech Translation"),Ro=l(),m(Le.$$.fragment),Jo=l(),qt=a("ul"),De=a("li"),po=a("p"),Mr=s("Speech Translation via Pipelines"),Fr=l(),fo=a("p"),Ar=s("The automatic speech recognition pipeline can also be used to translate speech in just a couple lines of code"),Go=l(),m(Ie.$$.fragment),Ko=l(),de=a("p"),Lr=s("See "),We=a("a"),Dr=s("model hub"),Ir=s(" to look for Speech2Text2 checkpoints."),Qo=l(),te=a("h2"),he=a("a"),mo=a("span"),m(Ve.$$.fragment),Wr=l(),uo=a("span"),Vr=s("Speech2Text2Config"),Xo=l(),j=a("div"),m(Ne.$$.fragment),Nr=l(),oe=a("p"),Or=s("This is the configuration class to store the configuration of a "),Mt=a("a"),Br=s("Speech2Text2ForCausalLM"),Ur=s(`. It is used to
...
documentation from `),At=a("a"),Xr=s("PretrainedConfig"),Yr=s(" for more information."),Zr=l(),_o=a("p"),ea=s("Example:"),ta=l(),m(Be.$$.fragment),Yo=l(),re=a("h2"),pe=a("a"),go=a("span"),m(Ue.$$.fragment),oa=l(),vo=a("span"),sa=s("Speech2TextTokenizer"),Zo=l(),E=a("div"),m(He.$$.fragment),ra=l(),To=a("p"),aa=s("Constructs a Speech2Text2Tokenizer."),na=l(),Re=a("p"),ia=s("This tokenizer inherits from "),Lt=a("a"),ca=s("PreTrainedTokenizer"),la=s(` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),da=l(),fe=a("div"),m(Je.$$.fragment),ha=l(),ko=a("p"),pa=s("Convert a list of lists of token ids into a list of strings by calling decode."),fa=l(),K=a("div"),m(Ge.$$.fragment),ma=l(),xo=a("p"),ua=s(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
...
a single processor.`),ya=l(),F=a("p"),It=a("a"),$a=s("Speech2Text2Processor"),Ea=s(" offers all the functionalities of "),Wt=a("a"),za=s("AutoFeatureExtractor"),Pa=s(" and "),Vt=a("a"),Ca=s("Speech2Text2Tokenizer"),ja=s(`.
...
refer to the docstring of this method for more information.`),ln=l(),Te=a("div"),m(it.$$.fragment),dn=l(),ct=a("p"),hn=s("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Ht=a("a"),pn=s("decode()"),fn=s(`. Please refer
to the docstring of this method for more information.`),mn=l(),ke=a("div"),m(lt.$$.fragment),un=l(),Co=a("p"),_n=s(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text2.`),os=l(),ne=a("h2"),xe=a("a"),jo=a("span"),m(dt.$$.fragment),gn=l(),qo=a("span"),vn=s("Speech2Text2ForCausalLM"),ss=l(),W=a("div"),m(ht.$$.fragment),Tn=l(),U=a("p"),kn=s("The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of "),Rt=a("a"),xn=s("EncoderDecoderModel"),bn=s(" and "),Mo=a("code"),wn=s("SpeechEncoderDecoder"),Sn=s(`.
...
etc.)`),En=l(),pt=a("p"),zn=s("This model is also a PyTorch "),ft=a("a"),Pn=s("torch.nn.Module"),Cn=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jn=l(),Y=a("div"),m(mt.$$.fragment),qn=l(),Fo=a("p"),Mn=s("Example:"),Fn=l(),m(ut.$$.fragment),this.h()},l(t){const h=dc('[data-svelte="svelte-1phssyn"]',document.head);f=n(h,"META",{name:!0,content:!0}),h.forEach(o),q=d(t),k=n(t,"H1",{class:!0});var _t=i(k);w=n(_t,"A",{id:!0,class:!0,href:!0});var Ao=i(w);D=n(Ao,"SPAN",{});var Dn=i(D);u(S.$$.fragment,Dn),Dn.forEach(o),Ao.forEach(o),O=d(_t),I=n(_t,"SPAN",{});var In=i(I);P=r(In,"Speech2Text2"),In.forEach(o),_t.forEach(o),b=d(t),C=n(t,"H2",{class:!0});var as=i(C);M=n(as,"A",{id:!0,class:!0,href:!0});var Wn=i(M);so=n(Wn,"SPAN",{});var Vn=i(so);u($e.$$.fragment,Vn),Vn.forEach(o),Wn.forEach(o),Cs=d(as),ro=n(as,"SPAN",{});var Nn=i(ro);js=r(Nn,"Overview"),Nn.forEach(o),as.forEach(o),Lo=d(t),R=n(t,"P",{});var Gt=i(R);qs=r(Gt,"The Speech2Text2 model is used together with "),vt=n(Gt,"A",{href:!0});var On=i(vt);Ms=r(On,"Wav2Vec2"),On.forEach(o),Fs=r(Gt,` for Speech Translation models proposed in
...
`),Ct=n(V,"A",{href:!0});var hi=i(Ct);Cr=r(hi,"Speech2Text2Tokenizer"),hi.forEach(o),jr=r(V,` into a single instance to both extract the input features and decode the
predicted token ids.`),V.forEach(o),Ho=d(t),jt=n(t,"UL",{});var pi=i(jt);ho=n(pi,"LI",{});var fi=i(ho);qr=r(fi,"Step-by-step Speech Translation"),fi.forEach(o),pi.forEach(o),Ro=d(t),u(Le.$$.fragment,t),Jo=d(t),qt=n(t,"UL",{});var mi=i(qt);De=n(mi,"LI",{});var ps=i(De);po=n(ps,"P",{});var ui=i(po);Mr=r(ui,"Speech Translation via Pipelines"),ui.forEach(o),Fr=d(ps),fo=n(ps,"P",{});var _i=i(fo);Ar=r(_i,"The automatic speech recognition pipeline can also be used to translate speech in just a couple lines of code"),_i.forEach(o),ps.forEach(o),mi.forEach(o),Go=d(t),u(Ie.$$.fragment,t),Ko=d(t),de=n(t,"P",{});var fs=i(de);Lr=r(fs,"See "),We=n(fs,"A",{href:!0,rel:!0});var gi=i(We);Dr=r(gi,"model hub"),gi.forEach(o),Ir=r(fs," to look for Speech2Text2 checkpoints."),fs.forEach(o),Qo=d(t),te=n(t,"H2",{class:!0});var ms=i(te);he=n(ms,"A",{id:!0,class:!0,href:!0});var vi=i(he);mo=n(vi,"SPAN",{});var Ti=i(mo);u(Ve.$$.fragment,Ti),Ti.forEach(o),vi.forEach(o),Wr=d(ms),uo=n(ms,"SPAN",{});var ki=i(uo);Vr=r(ki,"Speech2Text2Config"),ki.forEach(o),ms.forEach(o),Xo=d(t),j=n(t,"DIV",{class:!0});var Z=i(j);u(Ne.$$.fragment,Z),Nr=d(Z),oe=n(Z,"P",{});var Xt=i(oe);Or=r(Xt,"This is the configuration class to store the configuration of a "),Mt=n(Xt,"A",{href:!0});var xi=i(Mt);Br=r(xi,"Speech2Text2ForCausalLM"),xi.forEach(o),Ur=r(Xt,`. It is used to
instantiate an Speech2Text2 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the Speech2Text2
...
documentation from `),At=n(Yt,"A",{href:!0});var Si=i(At);Xr=r(Si,"PretrainedConfig"),Si.forEach(o),Yr=r(Yt," for more information."),Yt.forEach(o),Zr=d(Z),_o=n(Z,"P",{});var yi=i(_o);ea=r(yi,"Example:"),yi.forEach(o),ta=d(Z),u(Be.$$.fragment,Z),Z.forEach(o),Yo=d(t),re=n(t,"H2",{class:!0});var us=i(re);pe=n(us,"A",{id:!0,class:!0,href:!0});var $i=i(pe);go=n($i,"SPAN",{});var Ei=i(go);u(Ue.$$.fragment,Ei),Ei.forEach(o),$i.forEach(o),oa=d(us),vo=n(us,"SPAN",{});var zi=i(vo);sa=r(zi,"Speech2TextTokenizer"),zi.forEach(o),us.forEach(o),Zo=d(t),E=n(t,"DIV",{class:!0});var N=i(E);u(He.$$.fragment,N),ra=d(N),To=n(N,"P",{});var Pi=i(To);aa=r(Pi,"Constructs a Speech2Text2Tokenizer."),Pi.forEach(o),na=d(N),Re=n(N,"P",{});var _s=i(Re);ia=r(_s,"This tokenizer inherits from "),Lt=n(_s,"A",{href:!0});var Ci=i(Lt);ca=r(Ci,"PreTrainedTokenizer"),Ci.forEach(o),la=r(_s,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),_s.forEach(o),da=d(N),fe=n(N,"DIV",{class:!0});var gs=i(fe);u(Je.$$.fragment,gs),ha=d(gs),ko=n(gs,"P",{});var ji=i(ko);pa=r(ji,"Convert a list of lists of token ids into a list of strings by calling decode."),ji.forEach(o),gs.forEach(o),fa=d(N),K=n(N,"DIV",{class:!0});var Zt=i(K);u(Ge.$$.fragment,Zt),ma=d(Zt),xo=n(Zt,"P",{});var qi=i(xo);ua=r(qi,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
...
refer to the docstring of this method for more information.`),ws.forEach(o),bs.forEach(o),ln=d($),Te=n($,"DIV",{class:!0});var Ss=i(Te);u(it.$$.fragment,Ss),dn=d(Ss),ct=n(Ss,"P",{});var ys=i(ct);hn=r(ys,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Ht=n(ys,"A",{href:!0});var Qi=i(Ht);pn=r(Qi,"decode()"),Qi.forEach(o),fn=r(ys,`. Please refer
to the docstring of this method for more information.`),ys.forEach(o),Ss.forEach(o),mn=d($),ke=n($,"DIV",{class:!0});var $s=i(ke);u(lt.$$.fragment,$s),un=d($s),Co=n($s,"P",{});var Xi=i(Co);_n=r(Xi,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text2.`),Xi.forEach(o),$s.forEach(o),$.forEach(o),os=d(t),ne=n(t,"H2",{class:!0});var Es=i(ne);xe=n(Es,"A",{id:!0,class:!0,href:!0});var Yi=i(xe);jo=n(Yi,"SPAN",{});var Zi=i(jo);u(dt.$$.fragment,Zi),Zi.forEach(o),Yi.forEach(o),gn=d(Es),qo=n(Es,"SPAN",{});var ec=i(qo);vn=r(ec,"Speech2Text2ForCausalLM"),ec.forEach(o),Es.forEach(o),ss=d(t),W=n(t,"DIV",{class:!0});var we=i(W);u(ht.$$.fragment,we),Tn=d(we),U=n(we,"P",{});var Se=i(U);kn=r(Se,"The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of "),Rt=n(Se,"A",{href:!0});var tc=i(Rt);xn=r(tc,"EncoderDecoderModel"),tc.forEach(o),bn=r(Se," and "),Mo=n(Se,"CODE",{});var oc=i(Mo);wn=r(oc,"SpeechEncoderDecoder"),oc.forEach(o),Sn=r(Se,`.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Se.forEach(o),En=d(we),pt=n(we,"P",{});var zs=i(pt);zn=r(zs,"This model is also a PyTorch "),ft=n(zs,"A",{href:!0,rel:!0});var rc=i(ft);Pn=r(rc,"torch.nn.Module"),rc.forEach(o),Cn=r(zs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zs.forEach(o),jn=d(we),Y=n(we,"DIV",{class:!0});var oo=i(Y);u(mt.$$.fragment,oo),qn=d(oo),Fo=n(oo,"P",{});var ac=i(Fo);Mn=r(ac,"Example:"),ac.forEach(o),Fn=d(oo),u(ut.$$.fragment,oo),oo.forEach(o),we.forEach(o),this.h()},h(){c(f,"name","hf:doc:metadata"),c(f,"content",JSON.stringify(mc)),c(w,"id","speech2text2"),c(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(w,"href","#speech2text2"),c(k,"class","relative group"),c(M,"id","overview"),c(M,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(M,"href","#overview"),c(C,"class","relative group"),c(vt,"href","wav2vec2"),c(Ee,"href","https://arxiv.org/abs/2104.06678"),c(Ee,"rel","nofollow"),c(Tt,"href","wav2vec2"),c(kt,"href","hubert"),c(xt,"href","speech-encoder-decoder"),c(ze,"href","https://huggingface.co/patrickvonplaten"),c(ze,"rel","nofollow"),c(Pe,"href","https://github.com/pytorch/fairseq/blob/1f7ef9ed1e1061f8c7f88f8b94c7186834398690/fairseq/models/wav2vec/wav2vec2_asr.py#L266"),c(Pe,"rel","nofollow"),c(je,"href","https://huggingface.co/models?other=speech2text2"),c(je,"rel","nofollow"),c(wt,"href","speech-encoder-decoder"),c(Fe,"href","https://github.com/glample/fastBPE"),c(Fe,"rel","nofollow"),c(le,"id","inference"),c(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(le,"href","#inference"),c(ee,"class","relative group"),c(St,"href","/docs/transformers/v4.17.0/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderModel"),c(yt,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate"),c($t,"href","/docs/transformers/v4.17.0/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor"),c(Et,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer"),c(zt,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor"),c(Pt,"href","/docs/transformers/v4.17.0/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor"),c(Ct,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer"),c(We,"href","https://huggingface.co/models?filter=speech2text2"),c(We,"rel","nofollow"),c(he,"id","transformers.Speech2Text2Config"),c(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(he,"href","#transformers.Speech2Text2Config"),c(te,"class","relative group"),c(Mt,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2ForCausalLM"),c(Oe,"href","https://huggingface.co/facebook/s2t-small-librispeech-asr"),c(Oe,"rel","nofollow"),c(Ft,"href","/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(At,"href","/docs/transformers/v4.17.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(j,"class","docstring"),c(pe,"id","transformers.Speech2Text2Tokenizer"),c(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(pe,"href","#transformers.Speech2Text2Tokenizer"),c(re,"class","relative group"),c(Lt,"href","/docs/transformers/v4.17.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(fe,"class","docstring"),c(K,"class","docstring"),c(Dt,"class","docstring"),c(E,"class","docstring"),c(me,"id","transformers.Speech2Text2Processor"),c(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(me,"href","#transformers.Speech2Text2Processor"),c(ae,"class","relative group"),c(It,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor"),c(Wt,"href","/docs/transformers/v4.17.0/en/model_doc/auto#transformers.AutoFeatureExtractor"),c(Vt,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer"),c(Ze,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor.__call__"),c(Nt,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor.decode"),c(Ot,"href","/docs/transformers/v4.17.0/en/model_doc/speech_to_text_2#transformers.Speech2Text2Processor.as_target_processor"),c(tt,"href","/docs/transformers/v4.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"),c(ue,"class","docstring"),c(Q,"class","docstring"),c(Bt,"href","/docs/transformers/v4.17.0/en/main_classes/processors#transformers.ProcessorMixin.from_pretrained"),c(X,"class","docstring"),c(Ut,"href","/docs/transformers/v4.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode"),c(ve,"class","docstring"),c(Ht,"href","/docs/transformers/v4.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode"),c(Te,"class","docstring"),c(ke,"class","docstring"),c(x,"class","docstring"),c(xe,"id","transformers.Speech2Text2ForCausalLM"),c(xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xe,"href","#transformers.Speech2Text2ForCausalLM"),c(ne,"class","relative group"),c(Rt,"href","/docs/transformers/v4.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),c(Jt,"href","/docs/transformers/v4.17.0/en/main_classes/model#transformers.PreTrainedModel"),c(ft,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ft,"rel","nofollow"),c(Y,"class","docstring"),c(W,"class","docstring")},m(t,h){e(document.head,f),p(t,q,h),p(t,k,h),e(k,w),e(w,D),_(S,D,null),e(k,O),e(k,I),e(I,P),p(t,b,h),p(t,C,h),e(C,M),e(M,so),_($e,so,null),e(C,Cs),e(C,ro),e(ro,js),p(t,Lo,h),p(t,R,h),e(R,qs),e(R,vt),e(vt,Ms),e(R,Fs),e(R,Ee),e(Ee,As),e(R,Ls),p(t,Do,h),p(t,y,h),e(y,Ds),e(y,ao),e(ao,Is),e(y,Ws),e(y,no),e(no,Vs),e(y,Ns),e(y,Tt),e(Tt,Os),e(y,Bs),e(y,kt),e(kt,Us),e(y,Hs),e(y,xt),e(xt,Rs),e(y,Js),e(y,io),e(io,Gs),e(y,Ks),p(t,Io,h),p(t,ie,h),e(ie,Qs),e(ie,ze),e(ze,Xs),e(ie,Ys),p(t,Wo,h),p(t,ce,h),e(ce,Zs),e(ce,Pe),e(Pe,er),e(ce,tr),p(t,Vo,h),p(t,bt,h),e(bt,or),p(t,No,h),p(t,J,h),e(J,Ce),e(Ce,sr),e(Ce,je),e(je,rr),e(Ce,ar),e(J,nr),e(J,qe),e(qe,ir),e(qe,wt),e(wt,cr),e(qe,lr),e(J,dr),e(J,Me),e(Me,hr),e(Me,Fe),e(Fe,pr),e(Me,fr),p(t,Oo,h),p(t,ee,h),e(ee,le),e(le,co),_(Ae,co,null),e(ee,mr),e(ee,lo),e(lo,ur),p(t,Bo,h),p(t,G,h),e(G,_r),e(G,St),e(St,gr),e(G,vr),e(G,yt),e(yt,Tr),e(G,kr),p(t,Uo,h),p(t,z,h),e(z,xr),e(z,$t),e($t,br),e(z,wr),e(z,Et),e(Et,Sr),e(z,yr),e(z,zt),e(zt,$r),e(z,Er),e(z,Pt),e(Pt,zr),e(z,Pr),e(z,Ct),e(Ct,Cr),e(z,jr),p(t,Ho,h),p(t,jt,h),e(jt,ho),e(ho,qr),p(t,Ro,h),_(Le,t,h),p(t,Jo,h),p(t,qt,h),e(qt,De),e(De,po),e(po,Mr),e(De,Fr),e(De,fo),e(fo,Ar),p(t,Go,h),_(Ie,t,h),p(t,Ko,h),p(t,de,h),e(de,Lr),e(de,We),e(We,Dr),e(de,Ir),p(t,Qo,h),p(t,te,h),e(te,he),e(he,mo),_(Ve,mo,null),e(te,Wr),e(te,uo),e(uo,Vr),p(t,Xo,h),p(t,j,h),_(Ne,j,null),e(j,Nr),e(j,oe),e(oe,Or),e(oe,Mt),e(Mt,Br),e(oe,Ur),e(oe,Oe),e(Oe,Hr),e(oe,Rr),e(j,Jr),e(j,se),e(se,Gr),e(se,Ft),e(Ft,Kr),e(se,Qr),e(se,At),e(At,Xr),e(se,Yr),e(j,Zr),e(j,_o),e(_o,ea),e(j,ta),_(Be,j,null),p(t,Yo,h),p(t,re,h),e(re,pe),e(pe,go),_(Ue,go,null),e(re,oa),e(re,vo),e(vo,sa),p(t,Zo,h),p(t,E,h),_(He,E,null),e(E,ra),e(E,To),e(To,aa),e(E,na),e(E,Re),e(Re,ia),e(Re,Lt),e(Lt,ca),e(Re,la),e(E,da),e(E,fe),_(Je,fe,null),e(fe,ha),e(fe,ko),e(ko,pa),e(E,fa),e(E,K),_(Ge,K,null),e(K,ma),e(K,xo),e(xo,ua),e(K,_a),e(K,Ke),e(Ke,ga),e(Ke,bo),e(bo,va),e(Ke,Ta),e(E,ka),e(E,Dt),_(Qe,Dt,null),p(t,es,h),p(t,ae,h),e(ae,me),e(me,wo),_(Xe,wo,null),e(ae,xa),e(ae,So),e(So,ba),p(t,ts,h),p(t,x,h),_(Ye,x,null),e(x,wa),e(x,yo),e(yo,Sa),e(x,ya),e(x,F),e(F,It),e(It,$a),e(F,Ea),e(F,Wt),e(Wt,za),e(F,Pa),e(F,Vt),e(Vt,Ca),e(F,ja),e(F,Ze),e(Ze,$o),e($o,qa),e(Ze,Ma),e(F,Fa),e(F,Nt),e(Nt,Aa),e(F,La),e(x,Da),e(x,ue),_(et,ue,null),e(ue,Ia),e(ue,B),e(B,Wa),e(B,Eo),e(Eo,Va),e(B,Na),e(B,Ot),e(Ot,Oa),e(B,Ba),e(B,tt),e(tt,zo),e(zo,Ua),e(tt,Ha),e(B,Ra),e(x,Ja),e(x,Q),_(ot,Q,null),e(Q,Ga),e(Q,Po),e(Po,Ka),e(Q,Qa),_(_e,Q,null),e(x,Xa),e(x,X),_(st,X,null),e(X,Ya),e(X,rt),e(rt,Za),e(rt,Bt),e(Bt,en),e(rt,tn),e(X,on),_(ge,X,null),e(x,sn),e(x,ve),_(at,ve,null),e(ve,rn),e(ve,nt),e(nt,an),e(nt,Ut),e(Ut,nn),e(nt,cn),e(x,ln),e(x,Te),_(it,Te,null),e(Te,dn),e(Te,ct),e(ct,hn),e(ct,Ht),e(Ht,pn),e(ct,fn),e(x,mn),e(x,ke),_(lt,ke,null),e(ke,un),e(ke,Co),e(Co,_n),p(t,os,h),p(t,ne,h),e(ne,xe),e(xe,jo),_(dt,jo,null),e(ne,gn),e(ne,qo),e(qo,vn),p(t,ss,h),p(t,W,h),_(ht,W,null),e(W,Tn),e(W,U),e(U,kn),e(U,Rt),e(Rt,xn),e(U,bn),e(U,Mo),e(Mo,wn),e(U,Sn),e(U,Jt),e(Jt,yn),e(U,$n),e(W,En),e(W,pt),e(pt,zn),e(pt,ft),e(ft,Pn),e(pt,Cn),e(W,jn),e(W,Y),_(mt,Y,null),e(Y,qn),e(Y,Fo),e(Fo,Mn),e(Y,Fn),_(ut,Y,null),rs=!0},p(t,[h]){const _t={};h&2&&(_t.$$scope={dirty:h,ctx:t}),_e.$set(_t);const Ao={};h&2&&(Ao.$$scope={dirty:h,ctx:t}),ge.$set(Ao)},i(t){rs||(g(S.$$.fragment,t),g($e.$$.fragment,t),g(Ae.$$.fragment,t),g(Le.$$.fragment,t),g(Ie.$$.fragment,t),g(Ve.$$.fragment,t),g(Ne.$$.fragment,t),g(Be.$$.fragment,t),g(Ue.$$.fragment,t),g(He.$$.fragment,t),g(Je.$$.fragment,t),g(Ge.$$.fragment,t),g(Qe.$$.fragment,t),g(Xe.$$.fragment,t),g(Ye.$$.fragment,t),g(et.$$.fragment,t),g(ot.$$.fragment,t),g(_e.$$.fragment,t),g(st.$$.fragment,t),g(ge.$$.fragment,t),g(at.$$.fragment,t),g(it.$$.fragment,t),g(lt.$$.fragment,t),g(dt.$$.fragment,t),g(ht.$$.fragment,t),g(mt.$$.fragment,t),g(ut.$$.fragment,t),rs=!0)},o(t){v(S.$$.fragment,t),v($e.$$.fragment,t),v(Ae.$$.fragment,t),v(Le.$$.fragment,t),v(Ie.$$.fragment,t),v(Ve.$$.fragment,t),v(Ne.$$.fragment,t),v(Be.$$.fragment,t),v(Ue.$$.fragment,t),v(He.$$.fragment,t),v(Je.$$.fragment,t),v(Ge.$$.fragment,t),v(Qe.$$.fragment,t),v(Xe.$$.fragment,t),v(Ye.$$.fragment,t),v(et.$$.fragment,t),v(ot.$$.fragment,t),v(_e.$$.fragment,t),v(st.$$.fragment,t),v(ge.$$.fragment,t),v(at.$$.fragment,t),v(it.$$.fragment,t),v(lt.$$.fragment,t),v(dt.$$.fragment,t),v(ht.$$.fragment,t),v(mt.$$.fragment,t),v(ut.$$.fragment,t),rs=!1},d(t){o(f),t&&o(q),t&&o(k),T(S),t&&o(b),t&&o(C),T($e),t&&o(Lo),t&&o(R),t&&o(Do),t&&o(y),t&&o(Io),t&&o(ie),t&&o(Wo),t&&o(ce),t&&o(Vo),t&&o(bt),t&&o(No),t&&o(J),t&&o(Oo),t&&o(ee),T(Ae),t&&o(Bo),t&&o(G),t&&o(Uo),t&&o(z),t&&o(Ho),t&&o(jt),t&&o(Ro),T(Le,t),t&&o(Jo),t&&o(qt),t&&o(Go),T(Ie,t),t&&o(Ko),t&&o(de),t&&o(Qo),t&&o(te),T(Ve),t&&o(Xo),t&&o(j),T(Ne),T(Be),t&&o(Yo),t&&o(re),T(Ue),t&&o(Zo),t&&o(E),T(He),T(Je),T(Ge),T(Qe),t&&o(es),t&&o(ae),T(Xe),t&&o(ts),t&&o(x),T(Ye),T(et),T(ot),T(_e),T(st),T(ge),T(at),T(it),T(lt),t&&o(os),t&&o(ne),T(dt),t&&o(ss),t&&o(W),T(ht),T(mt),T(ut)}}}const mc={local:"speech2text2",sections:[{local:"overview",title:"Overview"},{local:"inference",title:"Inference"},{local:"transformers.Speech2Text2Config",title:"Speech2Text2Config"},{local:"transformers.Speech2Text2Tokenizer",title:"Speech2TextTokenizer"},{local:"transformers.Speech2Text2Processor",title:"Speech2Text2Processor"},{local:"transformers.Speech2Text2ForCausalLM",title:"Speech2Text2ForCausalLM"}],title:"Speech2Text2"};function uc(ye,f,q){let{fw:k}=f;return ye.$$set=w=>{"fw"in w&&q(0,k=w.fw)},[k]}class bc extends ic{constructor(f){super();cc(this,f,uc,fc,lc,{fw:0})}}export{bc as default,mc as metadata};
