import{S as Wh,i as Bh,s as Hh,e as a,k as l,w as L,t as n,M as Rh,c as r,d as t,m as d,a as i,x as v,h as s,b as c,F as e,g as u,y as w,q as T,o as M,B as x}from"../../chunks/vendor-4833417e.js";import{T as Qe}from"../../chunks/Tip-fffd6df1.js";import{D as _e}from"../../chunks/Docstring-7b52c3d4.js";import{C as tt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Ve}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Kh(B){let h,j,f,g,b;return{c(){h=a("p"),j=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),b=n(`
...
the latter silently ignores them.`)},l(y){h=r(y,"P",{});var _=i(h);j=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),b=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(y,_){u(y,h,_),e(h,j),e(h,f),e(f,g),e(h,b)},d(y){y&&t(h)}}}function sm(B){let h,j,f,g,b,y,_,$,re,Y,z,ae,S,Z,ne,A,ie,se,J,D,G,Q,F,E,le,W,V,ee,H,te,de,q,ce,O,pe,oe,R,ue,he,P,me,U,fe,p,k,X,$e,Me,N,be,Fe,xe,I,K,je,ye,C,ze,ke,ge,Ee,Yn,Br,Hr,Cs,Rr,Kr,go,Vr,Xr,_o,Yr,Zr,Sa,yo,Da,ot,Gr,Ps,Jr,Qr,Ns,ei,ti,Aa,bo,Oa,Zn,et,oi,Gn,ni,si,ko,ai,ri,Lo,ii,li,Ua,nt,di,vo,ci,pi,wo,ui,hi,Wa,ft,At,Is,To,mi,Ss,fi,Ba,qe,Mo,gi,gt,_i,Jn,yi,bi,xo,ki,Li,vi,_t,wi,Qn,Ti,Mi,es,xi,ji,$i,Ds,Fi,zi,jo,Ha,yt,Ot,As,$o,Ei,Os,qi,Ra,Be,Fo,Ci,Us,Pi,Ni,Ut,ts,Ii,Si,os,Di,Ai,Oi,zo,Ui,ns,Wi,Bi,Ka,bt,Wt,Ws,Eo,Hi,Bs,Ri,Va,He,qo,Ki,Hs,Vi,Xi,Bt,ss,Yi,Zi,as,Gi,Ji,Qi,Co,el,rs,tl,ol,Xa,kt,Ht,Rs,Po,nl,Ks,sl,Ya,Re,No,al,Io,rl,So,il,ll,dl,Do,cl,Ao,pl,ul,hl,Ne,Oo,ml,Lt,fl,is,gl,_l,Vs,yl,bl,kl,Rt,Ll,Xs,vl,wl,Uo,Za,vt,Kt,Ys,Wo,Tl,Zs,Ml,Ga,Ke,Bo,xl,wt,jl,Gs,$l,Fl,Ho,zl,El,ql,Ro,Cl,Ko,Pl,Nl,Il,Ie,Vo,Sl,Tt,Dl,ls,Al,Ol,Js,Ul,Wl,Bl,Vt,Hl,Qs,Rl,Kl,Xo,Ja,Mt,Xt,ea,Yo,Vl,ta,Xl,Qa,Ce,Zo,Yl,Go,Zl,Jo,Gl,Jl,Ql,Qo,ed,en,td,od,nd,tn,sd,on,ad,rd,id,Se,nn,ld,xt,dd,ds,cd,pd,oa,ud,hd,md,Yt,fd,na,gd,_d,sn,er,jt,Zt,sa,an,yd,aa,bd,tr,Pe,rn,kd,$t,Ld,ln,vd,wd,dn,Td,Md,xd,cn,jd,pn,$d,Fd,zd,un,Ed,hn,qd,Cd,Pd,De,mn,Nd,Ft,Id,cs,Sd,Dd,ra,Ad,Od,Ud,Gt,Wd,ia,Bd,Hd,fn,or,zt,Jt,la,gn,Rd,da,Kd,nr,Le,_n,Vd,ca,Xd,Yd,yn,Zd,ps,Gd,Jd,Qd,bn,ec,kn,tc,oc,nc,Qt,sc,Ae,Ln,ac,Et,rc,us,ic,lc,pa,dc,cc,pc,eo,uc,ua,hc,mc,vn,sr,qt,to,ha,wn,fc,ma,gc,ar,ve,Tn,_c,Mn,yc,fa,bc,kc,Lc,xn,vc,hs,wc,Tc,Mc,jn,xc,$n,jc,$c,Fc,oo,zc,Oe,Fn,Ec,Ct,qc,ms,Cc,Pc,ga,Nc,Ic,Sc,no,Dc,_a,Ac,Oc,zn,rr,Pt,so,ya,En,Uc,ba,Wc,ir,we,qn,Bc,ka,Hc,Rc,Cn,Kc,fs,Vc,Xc,Yc,Pn,Zc,Nn,Gc,Jc,Qc,ao,ep,Ue,In,tp,Nt,op,gs,np,sp,La,ap,rp,ip,ro,lp,va,dp,cp,Sn,lr,It,io,wa,Dn,pp,Ta,up,dr,Te,An,hp,Ma,mp,fp,On,gp,_s,_p,yp,bp,Un,kp,Wn,Lp,vp,wp,lo,Tp,We,Bn,Mp,St,xp,ys,jp,$p,xa,Fp,zp,Ep,co,qp,ja,Cp,Pp,Hn,cr;return y=new Ve({}),A=new Ve({}),yo=new tt({props:{codee:`def normalize_bbox(bbox, width, height):
    return [
...
`}}),eo=new Qe({props:{$$slots:{default:[Gh]},$$scope:{ctx:B}}}),vn=new tt({props:{codee:`from transformers import LayoutLMTokenizer, TFLayoutLMModel
...
`),wo=a("a"),ui=n("here"),hi=n("."),Wa=l(),ft=a("h2"),At=a("a"),Is=a("span"),L(To.$$.fragment),mi=l(),Ss=a("span"),fi=n("LayoutLMConfig"),Ba=l(),qe=a("div"),L(Mo.$$.fragment),gi=l(),gt=a("p"),_i=n("This is the configuration class to store the configuration of a "),Jn=a("a"),yi=n("LayoutLMModel"),bi=n(`. It is used to instantiate a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wp=l(),L(lo.$$.fragment),Tp=l(),We=a("div"),L(Bn.$$.fragment),Mp=l(),St=a("p"),xp=n("The "),ys=a("a"),jp=n("TFLayoutLMForTokenClassification"),$p=n(" forward method, overrides the "),xa=a("code"),Fp=n("__call__"),zp=n(" special method."),Ep=l(),L(co.$$.fragment),qp=l(),ja=a("p"),Cp=n("Examples:"),Pp=l(),L(Hn.$$.fragment),this.h()},l(o){const m=Rh('[data-svelte="svelte-1phssyn"]',document.head);h=r(m,"META",{name:!0,content:!0}),m.forEach(t),j=d(o),f=r(o,"H1",{class:!0});var Rn=i(f);g=r(Rn,"A",{id:!0,class:!0,href:!0});var $a=i(g);b=r($a,"SPAN",{});var Fa=i(b);v(y.$$.fragment,Fa),Fa.forEach(t),$a.forEach(t),_=d(Rn),$=r(Rn,"SPAN",{});var za=i($);re=s(za,"LayoutLM"),za.forEach(t),Rn.forEach(t),Y=d(o),z=r(o,"A",{id:!0}),i(z).forEach(t),ae=d(o),S=r(o,"H2",{class:!0});var Kn=i(S);Z=r(Kn,"A",{id:!0,class:!0,href:!0});var Ea=i(Z);ne=r(Ea,"SPAN",{});var qa=i(ne);v(A.$$.fragment,qa),qa.forEach(t),Ea.forEach(t),ie=d(Kn),se=r(Kn,"SPAN",{});var Ca=i(se);J=s(Ca,"Overview"),Ca.forEach(t),Kn.forEach(t),D=d(o),G=r(o,"P",{});var Vn=i(G);Q=s(Vn,"The LayoutLM model was proposed in the paper "),F=r(Vn,"A",{href:!0,rel:!0});var Pa=i(F);E=s(Pa,`LayoutLM: Pre-training of Text and Layout for Document Image
...
`),wo=r(ks,"A",{href:!0,rel:!0});var tu=i(wo);ui=s(tu,"here"),tu.forEach(t),hi=s(ks,"."),ks.forEach(t),Wa=d(o),ft=r(o,"H2",{class:!0});var hr=i(ft);At=r(hr,"A",{id:!0,class:!0,href:!0});var ou=i(At);Is=r(ou,"SPAN",{});var nu=i(Is);v(To.$$.fragment,nu),nu.forEach(t),ou.forEach(t),mi=d(hr),Ss=r(hr,"SPAN",{});var su=i(Ss);fi=s(su,"LayoutLMConfig"),su.forEach(t),hr.forEach(t),Ba=d(o),qe=r(o,"DIV",{class:!0});var st=i(qe);v(Mo.$$.fragment,st),gi=d(st),gt=r(st,"P",{});var Ls=i(gt);_i=s(Ls,"This is the configuration class to store the configuration of a "),Jn=r(Ls,"A",{href:!0});var au=i(Jn);yi=s(au,"LayoutLMModel"),au.forEach(t),bi=s(Ls,`. It is used to instantiate a
LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the LayoutLM
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ir.forEach(t),Fc=d(Ze),v(oo.$$.fragment,Ze),zc=d(Ze),Oe=r(Ze,"DIV",{class:!0});var ut=i(Oe);v(Fn.$$.fragment,ut),Ec=d(ut),Ct=r(ut,"P",{});var zs=i(Ct);qc=s(zs,"The "),ms=r(zs,"A",{href:!0});var Lh=i(ms);Cc=s(Lh,"TFLayoutLMForMaskedLM"),Lh.forEach(t),Pc=s(zs," forward method, overrides the "),ga=r(zs,"CODE",{});var vh=i(ga);Nc=s(vh,"__call__"),vh.forEach(t),Ic=s(zs," special method."),zs.forEach(t),Sc=d(ut),v(no.$$.fragment,ut),Dc=d(ut),_a=r(ut,"P",{});var wh=i(_a);Ac=s(wh,"Examples:"),wh.forEach(t),Oc=d(ut),v(zn.$$.fragment,ut),ut.forEach(t),Ze.forEach(t),rr=d(o),Pt=r(o,"H2",{class:!0});var Sr=i(Pt);so=r(Sr,"A",{id:!0,class:!0,href:!0});var Th=i(so);ya=r(Th,"SPAN",{});var Mh=i(ya);v(En.$$.fragment,Mh),Mh.forEach(t),Th.forEach(t),Uc=d(Sr),ba=r(Sr,"SPAN",{});var xh=i(ba);Wc=s(xh,"TFLayoutLMForSequenceClassification"),xh.forEach(t),Sr.forEach(t),ir=d(o),we=r(o,"DIV",{class:!0});var Ge=i(we);v(qn.$$.fragment,Ge),Bc=d(Ge),ka=r(Ge,"P",{});var jh=i(ka);Hc=s(jh,`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
