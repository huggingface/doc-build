import{S as ic,i as cc,s as lc,e as a,k as l,w as m,t as s,M as dc,c as n,d as o,m as d,a as i,x as u,h as r,b as c,F as e,g as p,y as _,q as g,o as v,B as T}from"../../chunks/vendor-4833417e.js";import{T as nc}from"../../chunks/Tip-fffd6df1.js";import{D as L}from"../../chunks/Docstring-7b52c3d4.js";import{C as Ps}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as gt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function hc(ye){let f,q,k,w,D,S,B,I;return{c(){f=a("p"),q=s(`This class method is simply calling the feature extractor
...
methods above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/v4.17.0/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(P,b){p(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,B),e(f,I)},d(P){P&&o(f)}}}function pc(ye){let f,q,k,w,D,S,B,I;return{c(){f=a("p"),q=s("This class method is simply calling "),k=a("a"),w=s("save_pretrained()"),D=s(` and
...
above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/v4.17.0/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){p(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,B),e(f,I)},d(P){P&&o(f)}}}function fc(ye){let f,q,k,w,D,S,B,I,P,b,j,M,so,$e,js,ro,Cs,Lo,R,qs,vt,Ms,Fs,Ee,As,Ls,Do,y,Ds,ao,Is,Ws,no,Vs,Ns,Tt,Bs,Os,kt,Us,Hs,xt,Rs,Js,io,Gs,Ks,Io,ie,Qs,ze,Xs,Ys,Wo,ce,Zs,Pe,er,tr,Vo,bt,or,No,J,je,sr,Ce,rr,ar,nr,qe,ir,wt,cr,lr,dr,Me,hr,Fe,pr,fr,Bo,ee,le,co,Ae,mr,lo,ur,Oo,G,_r,St,gr,vr,yt,Tr,kr,Uo,z,xr,$t,br,wr,Et,Sr,yr,zt,$r,Er,Pt,zr,Pr,jt,jr,Cr,Ho,Ct,ho,qr,Ro,Le,Jo,qt,De,po,Mr,Fr,fo,Ar,Go,Ie,Ko,de,Lr,We,Dr,Ir,Qo,te,he,mo,Ve,Wr,uo,Vr,Xo,C,Ne,Nr,oe,Br,Mt,Or,Ur,Be,Hr,Rr,Jr,se,Gr,Ft,Kr,Qr,At,Xr,Yr,Zr,_o,ea,ta,Oe,Yo,re,pe,go,Ue,oa,vo,sa,Zo,E,He,ra,To,aa,na,Re,ia,Lt,ca,la,da,fe,Je,ha,ko,pa,fa,K,Ge,ma,xo,ua,_a,Ke,ga,bo,va,Ta,ka,Dt,Qe,es,ae,me,wo,Xe,xa,So,ba,ts,x,Ye,wa,yo,Sa,ya,F,It,$a,Ea,Wt,za,Pa,Vt,ja,Ca,Ze,$o,qa,Ma,Fa,Nt,Aa,La,Da,ue,et,Ia,O,Wa,Eo,Va,Na,Bt,Ba,Oa,tt,zo,Ua,Ha,Ra,Ja,Q,ot,Ga,Po,Ka,Qa,_e,Xa,X,st,Ya,rt,Za,Ot,en,tn,on,ge,sn,ve,at,rn,nt,an,Ut,nn,cn,ln,Te,it,dn,ct,hn,Ht,pn,fn,mn,ke,lt,un,jo,_n,os,ne,xe,Co,dt,gn,qo,vn,ss,W,ht,Tn,U,kn,Rt,xn,bn,Mo,wn,Sn,Jt,yn,$n,En,pt,zn,ft,Pn,jn,Cn,Y,mt,qn,Fo,Mn,Fn,ut,rs;return S=new gt({}),$e=new gt({}),Ae=new gt({}),Le=new Ps({props:{code:`import torch
...
the `),Ce=a("a"),rr=s("official models"),ar=s(" ."),nr=l(),qe=a("li"),ir=s("Speech2Text2 is always used within the "),wt=a("a"),cr=s("SpeechEncoderDecoder"),lr=s(" framework."),dr=l(),Me=a("li"),hr=s("Speech2Text2\u2019s tokenizer is based on "),Fe=a("a"),pr=s("fastBPE"),fr=s("."),Bo=l(),ee=a("h2"),le=a("a"),co=a("span"),m(Ae.$$.fragment),mr=l(),lo=a("span"),ur=s("Inference"),Oo=l(),G=a("p"),_r=s("Speech2Text2\u2019s "),St=a("a"),gr=s("SpeechEncoderDecoderModel"),vr=s(` model accepts raw waveform input values from speech and
...
documentation from `),At=a("a"),Xr=s("PretrainedConfig"),Yr=s(" for more information."),Zr=l(),_o=a("p"),ea=s("Example:"),ta=l(),m(Oe.$$.fragment),Yo=l(),re=a("h2"),pe=a("a"),go=a("span"),m(Ue.$$.fragment),oa=l(),vo=a("span"),sa=s("Speech2TextTokenizer"),Zo=l(),E=a("div"),m(He.$$.fragment),ra=l(),To=a("p"),aa=s("Constructs a Speech2Text2Tokenizer."),na=l(),Re=a("p"),ia=s("This tokenizer inherits from "),Lt=a("a"),ca=s("PreTrainedTokenizer"),la=s(` which contains some of the main methods. Users should refer to
...
Speech2Text2.`),os=l(),ne=a("h2"),xe=a("a"),Co=a("span"),m(dt.$$.fragment),gn=l(),qo=a("span"),vn=s("Speech2Text2ForCausalLM"),ss=l(),W=a("div"),m(ht.$$.fragment),Tn=l(),U=a("p"),kn=s("The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of "),Rt=a("a"),xn=s("EncoderDecoderModel"),bn=s(" and "),Mo=a("code"),wn=s("SpeechEncoderDecoder"),Sn=s(`.
