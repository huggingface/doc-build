import{S as Hf,i as Kf,s as Vf,e as n,k as i,w as _,t as s,M as Qf,c as a,d as t,m as l,a as r,x as g,h as d,b as c,F as e,g as p,y as b,q as v,o as k,B as y}from"../../chunks/vendor-4833417e.js";import{T as ho}from"../../chunks/Tip-fffd6df1.js";import{D as P}from"../../chunks/Docstring-7b52c3d4.js";import{C as pt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as he}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Jf(D){let u,x,f,T,z;return{c(){u=n("p"),x=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=s("Module"),z=s(`
...
the latter silently ignores them.`)},l(B){u=a(B,"P",{});var w=r(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var $=r(f);T=d($,"Module"),$.forEach(t),z=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(B,w){p(B,u,w),e(u,x),e(u,f),e(f,T),e(u,z)},d(B){B&&t(u)}}}function Yf(D){let u,x,f,T,z,B,w,$,Ce,ue,E,ke,oe,je,ne,ae,Pe,$e,G,N,ye,R,q,C,Ne,Q,J,Ie,U,Ae,Oe,I,me,re,Fe,fe,H,Le,Ee,M,Se,W,De;return{c(){u=n("p"),x=s("TF 2.0 models accepts two formats as inputs:"),f=i(),T=n("ul"),z=n("li"),B=s("having all inputs as keyword arguments (like PyTorch models), or"),w=i(),$=n("li"),Ce=s("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),E=n("p"),ke=s("This second option is useful when using "),oe=n("code"),je=s("tf.keras.Model.fit"),ne=s(` method which currently requires having all the
...
the latter silently ignores them.`)},l(B){u=a(B,"P",{});var w=r(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var $=r(f);T=d($,"Module"),$.forEach(t),z=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(B,w){p(B,u,w),e(u,x),e(u,f),e(f,T),e(u,z)},d(B){B&&t(u)}}}function a_(D){let u,x,f,T,z,B,w,$,Ce,ue,E,ke,oe,je,ne,ae,Pe,$e,G,N,ye,R,q,C,Ne,Q,J,Ie,U,Ae,Oe,I,me,re,Fe,fe,H,Le,Ee,M,Se,W,De,m,F,Te,ht,Ve,j,_e,Ge,we,K,V,ut,Qe,A,Be,mt,se,ft,Ad,Od,uo,Ld,mo,Sd,Dd,Gd,Ue,Ud,Ea,Wd,Rd,qa,Hd,Kd,Wn,Vd,Qd,qs,_t,It,Ma,fo,Jd,Ca,Xd,Ms,Rn,Yd,Cs,_o,js,gt,At,ja,go,Zd,Pa,ei,Ps,de,bo,ti,bt,oi,Hn,ni,ai,vo,ri,si,di,vt,ii,Kn,li,ci,Vn,pi,hi,ui,Na,mi,fi,ko,Ns,kt,Ot,Ia,yo,_i,Aa,gi,Is,ie,To,bi,Oa,vi,ki,Lt,La,yi,Ti,Qn,wi,Bi,zi,wo,xi,Jn,$i,Fi,Ei,Je,Bo,qi,Sa,Mi,Ci,Da,Xn,ji,Ga,Pi,As,yt,St,Ua,zo,Ni,Wa,Ii,Os,le,xo,Ai,$o,Oi,Ra,Li,Si,Di,Dt,Ha,Gi,Ui,Yn,Wi,Ri,Hi,Fo,Ki,Zn,Vi,Qi,Ji,Xe,Eo,Xi,Ka,Yi,Zi,Va,ea,el,Qa,tl,Ls,Tt,Gt,Ja,qo,ol,Xa,nl,Ss,We,al,Ya,rl,sl,Za,dl,il,er,ll,Ds,ze,Mo,cl,Co,pl,ta,hl,ul,ml,jo,fl,Po,_l,gl,bl,ge,No,vl,wt,kl,oa,yl,Tl,tr,wl,Bl,zl,Ut,xl,or,$l,Fl,Io,Gs,Bt,Wt,nr,Ao,El,ar,ql,Us,Re,Ml,na,Cl,jl,rr,Pl,Nl,sr,Il,Ws,xe,Oo,Al,Lo,Ol,aa,Ll,Sl,Dl,So,Gl,Do,Ul,Wl,Rl,X,Go,Hl,zt,Kl,ra,Vl,Ql,dr,Jl,Xl,Yl,Rt,Zl,ir,ec,tc,lr,cr,pr,hr,oc,nc,ur,mr,fr,Uo,ac,_r,rc,sc,Rs,xt,Ht,gr,Wo,dc,br,ic,Hs,$t,Ro,lc,Ye,Ho,cc,vr,pc,hc,Ko,Ks,Ft,Kt,kr,Vo,uc,yr,mc,Vs,ce,Qo,fc,Jo,_c,sa,gc,bc,vc,Xo,kc,Yo,yc,Tc,wc,Vt,Bc,be,Zo,zc,Et,xc,da,$c,Fc,Tr,Ec,qc,Mc,Qt,Cc,wr,jc,Pc,en,Qs,qt,Jt,Br,tn,Nc,zr,Ic,Js,pe,on,Ac,nn,Oc,ia,Lc,Sc,Dc,an,Gc,rn,Uc,Wc,Rc,Xt,Hc,Y,sn,Kc,Mt,Vc,la,Qc,Jc,xr,Xc,Yc,Zc,Yt,ep,$r,tp,op,Fr,Er,qr,Mr,np,ap,Cr,jr,Pr,dn,rp,Nr,sp,dp,Xs,Ct,Zt,Ir,ln,ip,Ar,lp,Ys,O,cn,cp,pn,pp,ca,hp,up,mp,hn,fp,un,_p,gp,bp,Or,vp,kp,He,Lr,mn,yp,Tp,Sr,fn,wp,Bp,Dr,_n,zp,xp,Gr,gn,$p,Fp,ve,bn,Ep,jt,qp,Ur,Mp,Cp,Wr,jp,Pp,Np,eo,Ip,Rr,Ap,Op,vn,Lp,Ze,kn,Sp,Hr,Dp,Gp,yn,Up,et,Tn,Wp,Kr,Rp,Hp,wn,Zs,Pt,to,Vr,Bn,Kp,Qr,Vp,ed,L,zn,Qp,xn,Jp,pa,Xp,Yp,Zp,$n,eh,Fn,th,oh,nh,Jr,ah,rh,Ke,Xr,En,sh,dh,Yr,qn,ih,lh,Zr,Mn,ch,ph,es,Cn,hh,uh,S,jn,mh,Nt,fh,ts,_h,gh,os,bh,vh,kh,oo,yh,ns,Th,wh,as,rs,ss,ds,Bh,zh,is,ls,cs,ps,xh,$h,hs,us,ms,fs,Fh,Eh,_s,gs,Pn,no,ao,bs,Nn,qh,vs,Mh,Ch,ks,jh,Ph,tt,In,Nh,ys,Ih,Ah,An,Oh,ot,On,Lh,Ts,Sh,Dh,Ln,td;return B=new he({}),R=new he({}),we=new he({}),fo=new he({}),_o=new pt({props:{codee:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}]}}),ko=new pt({props:{codee:`from transformers import BlenderbotModel, BlenderbotConfig
...
`}}),eo=new ho({props:{$$slots:{default:[o_]},$$scope:{ctx:D}}}),vn=new pt({props:{codee:`from transformers import BlenderbotTokenizer, FlaxBlenderbotModel
...
`),vo=n("a"),ri=s("facebook/blenderbot-3B"),si=s(" architecture."),di=i(),vt=n("p"),ii=s("Configuration objects inherit from "),Kn=n("a"),li=s("PretrainedConfig"),ci=s(` and can be used to control the model outputs. Read the
documentation from `),Vn=n("a"),pi=s("PretrainedConfig"),hi=s(" for more information."),ui=i(),Na=n("p"),mi=s("Example:"),fi=i(),_(ko.$$.fragment),Ns=i(),kt=n("h2"),Ot=n("a"),Ia=n("span"),_(yo.$$.fragment),_i=i(),Aa=n("span"),gi=s("BlenderbotTokenizer"),Is=i(),ie=n("div"),_(To.$$.fragment),bi=i(),Oa=n("p"),vi=s("Construct a Blenderbot tokenizer."),ki=i(),Lt=n("p"),La=n("code"),yi=s("Blenderbot"),Ti=s(" is nearly identical to "),Qn=n("a"),wi=s("RobertaTokenizer"),Bi=s(` and runs end-to-end tokenization: punctuation splitting
...
skip_special_tokens=True)[0])`),Rs=i(),xt=n("h2"),Ht=n("a"),gr=n("span"),_(Wo.$$.fragment),dc=i(),br=n("span"),ic=s("BlenderbotForCausalLM"),Hs=i(),$t=n("div"),_(Ro.$$.fragment),lc=i(),Ye=n("div"),_(Ho.$$.fragment),cc=i(),vr=n("p"),pc=s("Example:"),hc=i(),_(Ko.$$.fragment),Ks=i(),Ft=n("h2"),Kt=n("a"),kr=n("span"),_(Vo.$$.fragment),uc=i(),yr=n("span"),mc=s("TFBlenderbotModel"),Vs=i(),ce=n("div"),_(Qo.$$.fragment),fc=i(),Jo=n("p"),_c=s(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bp=i(),Or=n("p"),vp=s("Finally, this model supports inherent JAX features such as:"),kp=i(),He=n("ul"),Lr=n("li"),mn=n("a"),yp=s("Just-In-Time (JIT) compilation"),Tp=i(),Sr=n("li"),fn=n("a"),wp=s("Automatic Differentiation"),Bp=i(),Dr=n("li"),_n=n("a"),zp=s("Vectorization"),xp=i(),Gr=n("li"),gn=n("a"),$p=s("Parallelization"),Fp=i(),ve=n("div"),_(bn.$$.fragment),Ep=i(),jt=n("p"),qp=s("The "),Ur=n("code"),Mp=s("FlaxBlenderbotPreTrainedModel"),Cp=s("forward method, overrides the "),Wr=n("code"),jp=s("__call__"),Pp=s(" special method."),Np=i(),_(eo.$$.fragment),Ip=i(),Rr=n("p"),Ap=s("Example:"),Op=i(),_(vn.$$.fragment),Lp=i(),Ze=n("div"),_(kn.$$.fragment),Sp=i(),Hr=n("p"),Dp=s("Example:"),Gp=i(),_(yn.$$.fragment),Up=i(),et=n("div"),_(Tn.$$.fragment),Wp=i(),Kr=n("p"),Rp=s("Example:"),Hp=i(),_(wn.$$.fragment),Zs=i(),Pt=n("h2"),to=n("a"),Vr=n("span"),_(Bn.$$.fragment),Kp=i(),Qr=n("span"),Vp=s("FlaxBlenderbotForConditionalGeneration"),ed=i(),L=n("div"),_(zn.$$.fragment),Qp=i(),xn=n("p"),Jp=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),vo=a(ma,"A",{href:!0,rel:!0});var fu=r(vo);ri=d(fu,"facebook/blenderbot-3B"),fu.forEach(t),si=d(ma," architecture."),ma.forEach(t),di=l(nt),vt=a(nt,"P",{});var fa=r(vt);ii=d(fa,"Configuration objects inherit from "),Kn=a(fa,"A",{href:!0});var _u=r(Kn);li=d(_u,"PretrainedConfig"),_u.forEach(t),ci=d(fa,` and can be used to control the model outputs. Read the
documentation from `),Vn=a(fa,"A",{href:!0});var gu=r(Vn);pi=d(gu,"PretrainedConfig"),gu.forEach(t),hi=d(fa," for more information."),fa.forEach(t),ui=l(nt),Na=a(nt,"P",{});var bu=r(Na);mi=d(bu,"Example:"),bu.forEach(t),fi=l(nt),g(ko.$$.fragment,nt),nt.forEach(t),Ns=l(o),kt=a(o,"H2",{class:!0});var id=r(kt);Ot=a(id,"A",{id:!0,class:!0,href:!0});var vu=r(Ot);Ia=a(vu,"SPAN",{});var ku=r(Ia);g(yo.$$.fragment,ku),ku.forEach(t),vu.forEach(t),_i=l(id),Aa=a(id,"SPAN",{});var yu=r(Aa);gi=d(yu,"BlenderbotTokenizer"),yu.forEach(t),id.forEach(t),Is=l(o),ie=a(o,"DIV",{class:!0});var at=r(ie);g(To.$$.fragment,at),bi=l(at),Oa=a(at,"P",{});var Tu=r(Oa);vi=d(Tu,"Construct a Blenderbot tokenizer."),Tu.forEach(t),ki=l(at),Lt=a(at,"P",{});var Fs=r(Lt);La=a(Fs,"CODE",{});var wu=r(La);yi=d(wu,"Blenderbot"),wu.forEach(t),Ti=d(Fs," is nearly identical to "),Qn=a(Fs,"A",{href:!0});var Bu=r(Qn);wi=d(Bu,"RobertaTokenizer"),Bu.forEach(t),Bi=d(Fs,` and runs end-to-end tokenization: punctuation splitting
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bd.forEach(t),Rl=l(lo),X=a(lo,"DIV",{class:!0});var qe=r(X);g(Go.$$.fragment,qe),Hl=l(qe),zt=a(qe,"P",{});var va=r(zt);Kl=d(va,"The "),ra=a(va,"A",{href:!0});var am=r(ra);Vl=d(am,"BlenderbotForConditionalGeneration"),am.forEach(t),Ql=d(va," forward method, overrides the "),dr=a(va,"CODE",{});var rm=r(dr);Jl=d(rm,"__call__"),rm.forEach(t),Xl=d(va," special method."),va.forEach(t),Yl=l(qe),g(Rt.$$.fragment,qe),Zl=l(qe),ir=a(qe,"P",{});var sm=r(ir);ec=d(sm,"Conversation example::"),sm.forEach(t),tc=l(qe),lr=a(qe,"BLOCKQUOTE",{});var dm=r(lr);cr=a(dm,"BLOCKQUOTE",{});var im=r(cr);pr=a(im,"BLOCKQUOTE",{});var lm=r(pr);hr=a(lm,"P",{});var cm=r(hr);oc=d(cm,`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration >>> mname =
\u2018facebook/blenderbot-400M-distill\u2019 >>> model = BlenderbotForConditionalGeneration.from_pretrained(mname) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(mname) >>> UTTERANCE = \u201CMy friends are cool but they eat too
many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs = tokenizer([UTTERANCE], return_tensors=\u2018pt\u2019) >>>
reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
skip_special_tokens=True)[0])`),cm.forEach(t),lm.forEach(t),im.forEach(t),dm.forEach(t),nc=l(qe),ur=a(qe,"BLOCKQUOTE",{});var pm=r(ur);mr=a(pm,"BLOCKQUOTE",{});var hm=r(mr);fr=a(hm,"BLOCKQUOTE",{});var um=r(fr);Uo=a(um,"P",{});var vd=r(Uo);ac=d(vd,`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
eat too many carbs.</s> `),_r=a(vd,"S",{});var mm=r(_r);rc=d(mm,`That\u2019s unfortunate. \u201D \u2026 \u201CAre they trying to lose weight or are they just trying to
be healthier?`),mm.forEach(t),sc=d(vd,` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018pt\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),vd.forEach(t),um.forEach(t),hm.forEach(t),pm.forEach(t),qe.forEach(t),lo.forEach(t),Rs=l(o),xt=a(o,"H2",{class:!0});var kd=r(xt);Ht=a(kd,"A",{id:!0,class:!0,href:!0});var fm=r(Ht);gr=a(fm,"SPAN",{});var _m=r(gr);g(Wo.$$.fragment,_m),_m.forEach(t),fm.forEach(t),dc=l(kd),br=a(kd,"SPAN",{});var gm=r(br);ic=d(gm,"BlenderbotForCausalLM"),gm.forEach(t),kd.forEach(t),Hs=l(o),$t=a(o,"DIV",{class:!0});var yd=r($t);g(Ro.$$.fragment,yd),lc=l(yd),Ye=a(yd,"DIV",{class:!0});var ka=r(Ye);g(Ho.$$.fragment,ka),cc=l(ka),vr=a(ka,"P",{});var bm=r(vr);pc=d(bm,"Example:"),bm.forEach(t),hc=l(ka),g(Ko.$$.fragment,ka),ka.forEach(t),yd.forEach(t),Ks=l(o),Ft=a(o,"H2",{class:!0});var Td=r(Ft);Kt=a(Td,"A",{id:!0,class:!0,href:!0});var vm=r(Kt);kr=a(vm,"SPAN",{});var km=r(kr);g(Vo.$$.fragment,km),km.forEach(t),vm.forEach(t),uc=l(Td),yr=a(Td,"SPAN",{});var ym=r(yr);mc=d(ym,"TFBlenderbotModel"),ym.forEach(t),Td.forEach(t),Vs=l(o),ce=a(o,"DIV",{class:!0});var dt=r(ce);g(Qo.$$.fragment,dt),fc=l(dt),Jo=a(dt,"P",{});var wd=r(Jo);_c=d(wd,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wd.forEach(t),vc=l(dt),Xo=a(dt,"P",{});var Bd=r(Xo);kc=d(Bd,"This model is also a "),Yo=a(Bd,"A",{href:!0,rel:!0});var wm=r(Yo);yc=d(wm,"tf.keras.Model"),wm.forEach(t),Tc=d(Bd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
