import{S as op,i as sp,s as ap,e as a,k as l,w as _,t as o,M as ip,c as i,d as t,m as c,a as r,x as k,h as s,b as d,F as e,g as u,y,q as v,o as b,B as T}from"../../chunks/vendor-4833417e.js";import{T as Ro}from"../../chunks/Tip-fffd6df1.js";import{D as O}from"../../chunks/Docstring-4f315ed9.js";import{C as Nn}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ze}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function rp(U){let h,L,m,w,E;return{c(){h=a("p"),L=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),w=o("Module"),E=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function hp(U){let h,L,m,w,E,g,f,z,Bs,Ho,le,xe,Dn,He,Ws,Bn,Os,Vo,$e,Us,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Wn,Vs,Jo,Gt,Ys,Xo,R,On,Ye,Qs,Zt,Js,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ia,ra,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,va,ba,Ta,on,Gn,wa,La,Ea,K,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Ma,Ca,Fa,Me,an,Pa,ja,Ge,Aa,Ia,Sa,rn,dn,Na,Da,Ba,S,ln,Wa,Oa,eo,Ua,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,ei,Ze,ti,ni,oi,et,si,tt,ai,ii,Go,pn,ri,Zo,nt,es,V,di,ot,li,ci,st,pi,hi,at,ui,mi,ts,he,Ce,so,it,fi,ao,gi,ns,M,rt,_i,dt,ki,hn,yi,vi,bi,ue,Ti,un,wi,Li,mn,Ei,zi,xi,io,$i,qi,lt,os,me,Fe,ro,ct,Mi,lo,Ci,ss,C,pt,Fi,co,Pi,ji,x,Ai,fn,Ii,Si,gn,Ni,Di,_n,Bi,Wi,po,Oi,Ui,ho,Ki,Ri,uo,Hi,Vi,mo,Yi,Qi,Ji,Pe,ht,Xi,fo,Gi,Zi,kn,ut,as,fe,je,go,mt,er,_o,tr,is,F,ft,nr,ko,or,sr,gt,ar,yn,ir,rr,dr,_t,lr,kt,cr,pr,hr,N,yt,ur,ge,mr,vn,fr,gr,yo,_r,kr,yr,Ae,vr,vo,br,Tr,vt,rs,_e,Ie,bo,bt,wr,To,Lr,ds,P,Tt,Er,wo,zr,xr,wt,$r,bn,qr,Mr,Cr,Lt,Fr,Et,Pr,jr,Ar,J,zt,Ir,ke,Sr,Tn,Nr,Dr,Lo,Br,Wr,Or,Se,ls,ye,Ne,Eo,xt,Ur,zo,Kr,cs,j,$t,Rr,xo,Hr,Vr,qt,Yr,wn,Qr,Jr,Xr,Mt,Gr,Ct,Zr,ed,td,D,Ft,nd,ve,od,Ln,sd,ad,$o,id,rd,dd,De,ld,qo,cd,pd,Pt,ps,be,Be,Mo,jt,hd,Co,ud,hs,A,At,md,Fo,fd,gd,It,_d,En,kd,yd,vd,St,bd,Nt,Td,wd,Ld,B,Dt,Ed,Te,zd,zn,xd,$d,Po,qd,Md,Cd,We,Fd,jo,Pd,jd,Bt,us,we,Oe,Ao,Wt,Ad,Io,Id,ms,I,Ot,Sd,So,Nd,Dd,Ut,Bd,xn,Wd,Od,Ud,Kt,Kd,Rt,Rd,Hd,Vd,W,Ht,Yd,Le,Qd,$n,Jd,Xd,No,Gd,Zd,el,Ue,tl,Do,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Nn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
model according to the specified arguments, defining the model architecture.`),bi=l(),ue=a("p"),Ti=o("Configuration objects inherit from "),un=a("a"),wi=o("PretrainedConfig"),Li=o(` and can be used to control the model outputs. Read the
...
and behavior.`),hr=l(),N=a("div"),_(yt.$$.fragment),ur=l(),ge=a("p"),mr=o("The "),vn=a("a"),fr=o("LukeModel"),gr=o(" forward method, overrides the "),yo=a("code"),_r=o("__call__"),kr=o(" special method."),yr=l(),_(Ae.$$.fragment),vr=l(),vo=a("p"),br=o("Examples:"),Tr=l(),_(vt.$$.fragment),rs=l(),_e=a("h2"),Ie=a("a"),bo=a("span"),_(bt.$$.fragment),wr=l(),To=a("span"),Lr=o("LukeForMaskedLM"),ds=l(),P=a("div"),_(Tt.$$.fragment),Er=l(),wo=a("p"),zr=o(`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),xr=l(),wt=a("p"),$r=o("This model inherits from "),bn=a("a"),qr=o("PreTrainedModel"),Mr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cr=l(),Lt=a("p"),Fr=o("This model is also a PyTorch "),Et=a("a"),Pr=o("torch.nn.Module"),jr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ar=l(),J=a("div"),_(zt.$$.fragment),Ir=l(),ke=a("p"),Sr=o("The "),Tn=a("a"),Nr=o("LukeForMaskedLM"),Dr=o(" forward method, overrides the "),Lo=a("code"),Br=o("__call__"),Wr=o(" special method."),Or=l(),_(Se.$$.fragment),ls=l(),ye=a("h2"),Ne=a("a"),Eo=a("span"),_(xt.$$.fragment),Ur=l(),zo=a("span"),Kr=o("LukeForEntityClassification"),cs=l(),j=a("div"),_($t.$$.fragment),Rr=l(),xo=a("p"),Hr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Vr=l(),qt=a("p"),Yr=o("This model inherits from "),wn=a("a"),Qr=o("PreTrainedModel"),Jr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vd=l(),St=a("p"),bd=o("This model is also a PyTorch "),Nt=a("a"),Td=o("torch.nn.Module"),wd=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld=l(),B=a("div"),_(Dt.$$.fragment),Ed=l(),Te=a("p"),zd=o("The "),zn=a("a"),xd=o("LukeForEntityPairClassification"),$d=o(" forward method, overrides the "),Po=a("code"),qd=o("__call__"),Md=o(" special method."),Cd=l(),_(We.$$.fragment),Fd=l(),jo=a("p"),Pd=o("Examples:"),jd=l(),_(Bt.$$.fragment),us=l(),we=a("h2"),Oe=a("a"),Ao=a("span"),_(Wt.$$.fragment),Ad=l(),Io=a("span"),Id=o("LukeForEntitySpanClassification"),ms=l(),I=a("div"),_(Ot.$$.fragment),Sd=l(),So=a("p"),Nd=o(`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
...
`),en=i(Y,"A",{href:!0});var Tl=r(en);da=s(Tl,"LukeTokenizer"),Tl.forEach(t),la=s(Y,"."),Y.forEach(t),_l.forEach(t),ca=c(Ke),Qe=i(Ke,"LI",{});var ks=r(Qe);H=i(ks,"P",{});var Ee=r(H);tn=i(Ee,"A",{href:!0});var wl=r(tn);pa=s(wl,"LukeTokenizer"),wl.forEach(t),ha=s(Ee," takes "),Yn=i(Ee,"CODE",{});var Ll=r(Yn);ua=s(Ll,"entities"),Ll.forEach(t),ma=s(Ee," and "),Qn=i(Ee,"CODE",{});var El=r(Qn);fa=s(El,"entity_spans"),El.forEach(t),ga=s(Ee,` (character-based start and end
...
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
named entity recognition.`),sl.forEach(t),Ta=c(ys),on=i(ys,"LI",{});var al=r(on);Gn=i(al,"EM",{});var $l=r(Gn);wa=s($l,"Inputting Wikipedia entities to compute knowledge-enhanced token representations"),$l.forEach(t),La=s(al,`: LUKE learns rich information
(or knowledge) about Wikipedia entities during pretraining and stores the information in its entity embedding. By
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xs.forEach(t),hr=c(ee),N=i(ee,"DIV",{class:!0});var te=r(N);k(yt.$$.fragment,te),ur=c(te),ge=i(te,"P",{});var Fn=r(ge);mr=s(Fn,"The "),vn=i(Fn,"A",{href:!0});var yc=r(vn);fr=s(yc,"LukeModel"),yc.forEach(t),gr=s(Fn," forward method, overrides the "),yo=i(Fn,"CODE",{});var vc=r(yo);_r=s(vc,"__call__"),vc.forEach(t),kr=s(Fn," special method."),Fn.forEach(t),yr=c(te),k(Ae.$$.fragment,te),vr=c(te),vo=i(te,"P",{});var bc=r(vo);br=s(bc,"Examples:"),bc.forEach(t),Tr=c(te),k(vt.$$.fragment,te),te.forEach(t),ee.forEach(t),rs=c(n),_e=i(n,"H2",{class:!0});var $s=r(_e);Ie=i($s,"A",{id:!0,class:!0,href:!0});var Tc=r(Ie);bo=i(Tc,"SPAN",{});var wc=r(bo);k(bt.$$.fragment,wc),wc.forEach(t),Tc.forEach(t),wr=c($s),To=i($s,"SPAN",{});var Lc=r(To);Lr=s(Lc,"LukeForMaskedLM"),Lc.forEach(t),$s.forEach(t),ds=c(n),P=i(n,"DIV",{class:!0});var ne=r(P);k(Tt.$$.fragment,ne),Er=c(ne),wo=i(ne,"P",{});var Ec=r(wo);zr=s(Ec,`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),Ec.forEach(t),xr=c(ne),wt=i(ne,"P",{});var qs=r(wt);$r=s(qs,"This model inherits from "),bn=i(qs,"A",{href:!0});var zc=r(bn);qr=s(zc,"PreTrainedModel"),zc.forEach(t),Mr=s(qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
