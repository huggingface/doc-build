import{S as mf,i as uf,s as gf,e as a,k as d,w,t as r,M as _f,c as s,d as t,m as c,a as n,x as b,h as i,b as l,F as e,g as m,y,q as $,o as x,B as V}from"../../chunks/vendor-4833417e.js";import{T as _e}from"../../chunks/Tip-fffd6df1.js";import{D as W}from"../../chunks/Docstring-7b52c3d4.js";import{C as Vt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ve}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function vf(I){let h,v,f,g,T;return{c(){h=a("p"),v=r(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
breaking changes to fix it in the future. If you see something strange, file a `),f=s(u,"A",{href:!0,rel:!0});var F=n(f);g=i(F,"Github Issue"),F.forEach(t),T=i(u,"."),u.forEach(t),this.h()},h(){l(f,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),l(f,"rel","nofollow")},m(_,u){m(_,h,u),e(h,v),e(h,f),e(f,g),e(h,T)},d(_){_&&t(h)}}}function Tf(I){let h,v;return{c(){h=a("p"),v=r(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=n(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var F=n(f);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=n(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var F=n(f);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,v),e(h,f),e(f,g),e(h,T)},d(_){_&&t(h)}}}function $f(I){let h,v,f,g,T,_,u,F,he,R,k,ie,j,U,oe,C,pe,ae;return{c(){h=a("p"),v=r("TF 2.0 models accepts two formats as inputs:"),f=d(),g=a("ul"),T=a("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),F=a("li"),he=r("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=r("This second option is useful when using "),j=a("code"),U=r("tf.keras.Model.fit"),oe=r(` method which currently requires having all the
...
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=n(C);pe=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,M){m(E,h,M),e(h,v),m(E,f,M),m(E,g,M),e(g,T),e(T,_),e(g,u),e(g,F),e(F,he),m(E,R,M),m(E,k,M),e(k,ie),e(k,j),e(j,U),e(k,oe),e(k,C),e(C,pe),e(k,ae)},d(E){E&&t(h),E&&t(f),E&&t(g),E&&t(R),E&&t(k)}}}function xf(I){let h,v,f,g,T;return{c(){h=a("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),T=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=n(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var F=n(f);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,v),e(h,f),e(f,g),e(h,T)},d(_){_&&t(h)}}}function Vf(I){let h,v,f,g,T,_,u,F,he,R,k,ie,j,U,oe,C,pe,ae;return{c(){h=a("p"),v=r("TF 2.0 models accepts two formats as inputs:"),f=d(),g=a("ul"),T=a("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),F=a("li"),he=r("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=r("This second option is useful when using "),j=a("code"),U=r("tf.keras.Model.fit"),oe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),C=a("code"),pe=r("model(inputs)"),ae=r(".")},l(E){h=s(E,"P",{});var M=n(h);v=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),f=c(E),g=s(E,"UL",{});var z=n(g);T=s(z,"LI",{});var Me=n(T);_=i(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),u=c(z),F=s(z,"LI",{});var se=n(F);he=i(se,"having all inputs as a list, tuple or dict in the first positional arguments."),se.forEach(t),z.forEach(t),R=c(E),k=s(E,"P",{});var L=n(k);ie=i(L,"This second option is useful when using "),j=s(L,"CODE",{});var je=n(j);U=i(je,"tf.keras.Model.fit"),je.forEach(t),oe=i(L,` method which currently requires having all the
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=n(C);pe=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,M){m(E,h,M),e(h,v),m(E,f,M),m(E,g,M),e(g,T),e(T,_),e(g,u),e(g,F),e(F,he),m(E,R,M),m(E,k,M),e(k,ie),e(k,j),e(j,U),e(k,oe),e(k,C),e(C,pe),e(k,ae)},d(E){E&&t(h),E&&t(f),E&&t(g),E&&t(R),E&&t(k)}}}function Ff(I){let h,v,f,g,T;return{c(){h=a("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),T=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=n(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var F=n(f);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=n(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var F=n(f);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,v),e(h,f),e(f,g),e(h,T)},d(_){_&&t(h)}}}function If(I){let h,v,f,g,T,_,u,F,he,R,k,ie,j,U,oe,C,pe,ae,E,M,z,Me,se,L,je,Te,Xo,tr,sn,Zo,Da,or,nn,Qo,ar,rn,N,Ft,sr,Et,nr,rr,ir,Oa,lr,dr,kt,cr,Yo,hr,pr,fr,Pe,mr,Sa,ur,gr,It,_r,vr,Tr,Ce,wr,Mt,br,yr,jt,$r,xr,Vr,Ae,Fr,Pt,Er,kr,Ct,Ir,Mr,jr,Wa,Pr,ln,ea,Cr,dn,le,Ua,P,ta,Ar,qr,oa,zr,Nr,aa,Lr,Dr,Ba,Or,Sr,Ra,Wr,Ur,Ha,Br,Rr,Ja,Hr,Jr,sa,Kr,Gr,Xr,Ka,na,ra,Zr,Qr,Yr,Ga,At,ei,qt,ti,oi,ai,Xa,ia,la,si,ni,cn,we,ri,zt,ii,li,Nt,di,ci,hn,et,hi,Lt,pi,fi,pn,qe,tt,Za,Dt,mi,Qa,ui,fn,B,Ot,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Vi,ha,Fi,Ei,ki,Ya,Ii,Mi,Wt,mn,Le,ot,es,Ut,ji,ts,Pi,un,ne,Bt,Ci,os,Ai,qi,Rt,zi,pa,Ni,Li,Di,be,Ht,Oi,as,Si,Wi,at,gn,De,st,ss,Jt,Ui,ns,Bi,_n,fe,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,fa,Qi,Yi,rs,el,tl,ol,nt,al,is,sl,nl,Qt,vn,Se,rt,ls,Yt,rl,ds,il,Tn,me,eo,ll,We,dl,cs,cl,hl,to,pl,fl,ml,J,oo,ul,Ue,gl,ma,_l,vl,hs,Tl,wl,bl,it,yl,ps,$l,xl,ao,wn,Be,lt,fs,so,Vl,ms,Fl,bn,re,no,El,us,kl,Il,ro,Ml,io,jl,Pl,Cl,K,lo,Al,Re,ql,ua,zl,Nl,gs,Ll,Dl,Ol,dt,Sl,_s,Wl,Ul,co,yn,He,ct,vs,ho,Bl,Ts,Rl,$n,D,po,Hl,ws,Jl,Kl,fo,Gl,ga,Xl,Zl,Ql,mo,Yl,uo,ed,td,od,ht,ad,G,go,sd,Je,nd,_a,rd,id,bs,ld,dd,cd,pt,hd,ys,pd,fd,_o,xn,Ke,ft,$s,vo,md,xs,ud,Vn,O,To,gd,Vs,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Vd,Fd,mt,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,Fs,Pd,Cd,Ad,ut,qd,Es,zd,Nd,xo,Fn,Xe,gt,ks,Vo,Ld,Is,Dd,En,A,Fo,Od,Ms,Sd,Wd,Eo,Ud,wa,Bd,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,js,Zd,Qd,ue,Ps,Mo,Yd,ec,Cs,jo,tc,oc,As,Po,ac,sc,qs,Co,nc,rc,Z,Ao,ic,Ze,lc,zs,dc,cc,Ns,hc,pc,fc,_t,mc,Ls,uc,gc,qo,kn,Qe,vt,Ds,zo,_c,Os,vc,In,q,No,Tc,Ss,wc,bc,Lo,yc,ba,$c,xc,Vc,Do,Fc,Oo,Ec,kc,Ic,Ws,Mc,jc,ge,Us,So,Pc,Cc,Bs,Wo,Ac,qc,Rs,Uo,zc,Nc,Hs,Bo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Js,Wc,Uc,Ks,Bc,Rc,Hc,Tt,Jc,Gs,Kc,Gc,Ho,Mn;return _=new ve({}),k=new _e({props:{$$slots:{default:[vf]},$$scope:{ctx:I}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.17.0/src/transformers/models/vit/configuration_vit.py#L29",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
`}}),nt=new _e({props:{$$slots:{default:[wf]},$$scope:{ctx:I}}}),Qt=new Vt({props:{codee:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){h=a("meta"),v=d(),f=a("h1"),g=a("a"),T=a("span"),w(_.$$.fragment),u=d(),F=a("span"),he=r("Vision Transformer (ViT)"),R=d(),w(k.$$.fragment),ie=d(),j=a("h2"),U=a("a"),oe=a("span"),w(C.$$.fragment),pe=d(),ae=a("span"),E=r("Overview"),M=d(),z=a("p"),Me=r("The Vision Transformer (ViT) model was proposed in "),se=a("a"),L=r(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
go to him!`),pn=d(),qe=a("h2"),tt=a("a"),Za=a("span"),w(Dt.$$.fragment),mi=d(),Qa=a("span"),ui=r("ViTConfig"),fn=d(),B=a("div"),w(Ot.$$.fragment),gi=d(),ze=a("p"),_i=r("This is the configuration class to store the configuration of a "),da=a("a"),vi=r("ViTModel"),Ti=r(`. It is used to instantiate an ViT
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ml=d(),J=a("div"),w(oo.$$.fragment),ul=d(),Ue=a("p"),gl=r("The "),ma=a("a"),_l=r("ViTForMaskedImageModeling"),vl=r(" forward method, overrides the "),hs=a("code"),Tl=r("__call__"),wl=r(" special method."),bl=d(),w(it.$$.fragment),yl=d(),ps=a("p"),$l=r("Examples:"),xl=d(),w(ao.$$.fragment),wn=d(),Be=a("h2"),lt=a("a"),fs=a("span"),w(so.$$.fragment),Vl=d(),ms=a("span"),Fl=r("ViTForImageClassification"),bn=d(),re=a("div"),w(no.$$.fragment),El=d(),us=a("p"),kl=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Il=d(),ro=a("p"),Ml=r("This model is a PyTorch "),io=a("a"),jl=r("torch.nn.Module"),Pl=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cl=d(),K=a("div"),w(lo.$$.fragment),Al=d(),Re=a("p"),ql=r("The "),ua=a("a"),zl=r("ViTForImageClassification"),Nl=r(" forward method, overrides the "),gs=a("code"),Ll=r("__call__"),Dl=r(" special method."),Ol=d(),w(dt.$$.fragment),Sl=d(),_s=a("p"),Wl=r("Example:"),Ul=d(),w(co.$$.fragment),yn=d(),He=a("h2"),ct=a("a"),vs=a("span"),w(ho.$$.fragment),Bl=d(),Ts=a("span"),Rl=r("TFViTModel"),$n=d(),D=a("div"),w(po.$$.fragment),Hl=d(),ws=a("p"),Jl=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Kl=d(),fo=a("p"),Gl=r("This model inherits from "),ga=a("a"),Xl=r("TFPreTrainedModel"),Zl=r(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fd=d(),w(mt.$$.fragment),Ed=d(),X=a("div"),w($o.$$.fragment),kd=d(),Ge=a("p"),Id=r("The "),Ta=a("a"),Md=r("TFViTForImageClassification"),jd=r(" forward method, overrides the "),Fs=a("code"),Pd=r("__call__"),Cd=r(" special method."),Ad=d(),w(ut.$$.fragment),qd=d(),Es=a("p"),zd=r("Examples:"),Nd=d(),w(xo.$$.fragment),Fn=d(),Xe=a("h2"),gt=a("a"),ks=a("span"),w(Vo.$$.fragment),Ld=d(),Is=a("span"),Dd=r("FlaxVitModel"),En=d(),A=a("div"),w(Fo.$$.fragment),Od=d(),Ms=a("p"),Sd=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Ud=r("This model inherits from "),wa=a("a"),Bd=r("FlaxPreTrainedModel"),Rd=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),js=a("p"),Zd=r("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Ps=a("li"),Mo=a("a"),Yd=r("Just-In-Time (JIT) compilation"),ec=d(),Cs=a("li"),jo=a("a"),tc=r("Automatic Differentiation"),oc=d(),As=a("li"),Po=a("a"),ac=r("Vectorization"),sc=d(),qs=a("li"),Co=a("a"),nc=r("Parallelization"),rc=d(),Z=a("div"),w(Ao.$$.fragment),ic=d(),Ze=a("p"),lc=r("The "),zs=a("code"),dc=r("FlaxViTPreTrainedModel"),cc=r("forward method, overrides the "),Ns=a("code"),hc=r("__call__"),pc=r(" special method."),fc=d(),w(_t.$$.fragment),mc=d(),Ls=a("p"),uc=r("Examples:"),gc=d(),w(qo.$$.fragment),kn=d(),Qe=a("h2"),vt=a("a"),Ds=a("span"),w(zo.$$.fragment),_c=d(),Os=a("span"),vc=r("FlaxViTForImageClassification"),In=d(),q=a("div"),w(No.$$.fragment),Tc=d(),Ss=a("p"),wc=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
found `),Nt=s(Va,"A",{href:!0,rel:!0});var kh=n(Nt);di=i(kh,"here"),kh.forEach(t),ci=i(Va,"."),Va.forEach(t),hn=c(o),et=s(o,"P",{});var An=n(et);hi=i(An,"Note that we converted the weights from Ross Wightman\u2019s "),Lt=s(An,"A",{href:!0,rel:!0});var Ih=n(Lt);pi=i(Ih,"timm library"),Ih.forEach(t),fi=i(An,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),An.forEach(t),pn=c(o),qe=s(o,"H2",{class:!0});var qn=n(qe);tt=s(qn,"A",{id:!0,class:!0,href:!0});var Mh=n(tt);Za=s(Mh,"SPAN",{});var jh=n(Za);b(Dt.$$.fragment,jh),jh.forEach(t),Mh.forEach(t),mi=c(qn),Qa=s(qn,"SPAN",{});var Ph=n(Qa);ui=i(Ph,"ViTConfig"),Ph.forEach(t),qn.forEach(t),fn=c(o),B=s(o,"DIV",{class:!0});var ye=n(B);b(Ot.$$.fragment,ye),gi=c(ye),ze=s(ye,"P",{});var Fa=n(ze);_i=i(Fa,"This is the configuration class to store the configuration of a "),da=s(Fa,"A",{href:!0});var Ch=n(da);vi=i(Ch,"ViTModel"),Ch.forEach(t),Ti=i(Fa,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pa.forEach(t),ml=c(ja),J=s(ja,"DIV",{class:!0});var xe=n(J);b(oo.$$.fragment,xe),ul=c(xe),Ue=s(xe,"P",{});var Ca=n(Ue);gl=i(Ca,"The "),ma=s(Ca,"A",{href:!0});var op=n(ma);_l=i(op,"ViTForMaskedImageModeling"),op.forEach(t),vl=i(Ca," forward method, overrides the "),hs=s(Ca,"CODE",{});var ap=n(hs);Tl=i(ap,"__call__"),ap.forEach(t),wl=i(Ca," special method."),Ca.forEach(t),bl=c(xe),b(it.$$.fragment,xe),yl=c(xe),ps=s(xe,"P",{});var sp=n(ps);$l=i(sp,"Examples:"),sp.forEach(t),xl=c(xe),b(ao.$$.fragment,xe),xe.forEach(t),ja.forEach(t),wn=c(o),Be=s(o,"H2",{class:!0});var Sn=n(Be);lt=s(Sn,"A",{id:!0,class:!0,href:!0});var np=n(lt);fs=s(np,"SPAN",{});var rp=n(fs);b(so.$$.fragment,rp),rp.forEach(t),np.forEach(t),Vl=c(Sn),ms=s(Sn,"SPAN",{});var ip=n(ms);Fl=i(ip,"ViTForImageClassification"),ip.forEach(t),Sn.forEach(t),bn=c(o),re=s(o,"DIV",{class:!0});var yt=n(re);b(no.$$.fragment,yt),El=c(yt),us=s(yt,"P",{});var lp=n(us);kl=i(lp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wn.forEach(t),Cl=c(yt),K=s(yt,"DIV",{class:!0});var Ve=n(K);b(lo.$$.fragment,Ve),Al=c(Ve),Re=s(Ve,"P",{});var Aa=n(Re);ql=i(Aa,"The "),ua=s(Aa,"A",{href:!0});var cp=n(ua);zl=i(cp,"ViTForImageClassification"),cp.forEach(t),Nl=i(Aa," forward method, overrides the "),gs=s(Aa,"CODE",{});var hp=n(gs);Ll=i(hp,"__call__"),hp.forEach(t),Dl=i(Aa," special method."),Aa.forEach(t),Ol=c(Ve),b(dt.$$.fragment,Ve),Sl=c(Ve),_s=s(Ve,"P",{});var pp=n(_s);Wl=i(pp,"Example:"),pp.forEach(t),Ul=c(Ve),b(co.$$.fragment,Ve),Ve.forEach(t),yt.forEach(t),yn=c(o),He=s(o,"H2",{class:!0});var Un=n(He);ct=s(Un,"A",{id:!0,class:!0,href:!0});var fp=n(ct);vs=s(fp,"SPAN",{});var mp=n(vs);b(ho.$$.fragment,mp),mp.forEach(t),fp.forEach(t),Bl=c(Un),Ts=s(Un,"SPAN",{});var up=n(Ts);Rl=i(up,"TFViTModel"),up.forEach(t),Un.forEach(t),$n=c(o),D=s(o,"DIV",{class:!0});var de=n(D);b(po.$$.fragment,de),Hl=c(de),ws=s(de,"P",{});var gp=n(ws);Jl=i(gp,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),gp.forEach(t),Kl=c(de),fo=s(de,"P",{});var Bn=n(fo);Gl=i(Bn,"This model inherits from "),ga=s(Bn,"A",{href:!0});var _p=n(ga);Xl=i(_p,"TFPreTrainedModel"),_p.forEach(t),Zl=i(Bn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bn.forEach(t),Ql=c(de),mo=s(de,"P",{});var Rn=n(mo);Yl=i(Rn,"This model is also a "),uo=s(Rn,"A",{href:!0,rel:!0});var vp=n(uo);ed=i(vp,"tf.keras.Model"),vp.forEach(t),td=i(Rn,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rn.forEach(t),od=c(de),b(ht.$$.fragment,de),ad=c(de),G=s(de,"DIV",{class:!0});var Fe=n(G);b(go.$$.fragment,Fe),sd=c(Fe),Je=s(Fe,"P",{});var qa=n(Je);nd=i(qa,"The "),_a=s(qa,"A",{href:!0});var Tp=n(_a);rd=i(Tp,"TFViTModel"),Tp.forEach(t),id=i(qa," forward method, overrides the "),bs=s(qa,"CODE",{});var wp=n(bs);ld=i(wp,"__call__"),wp.forEach(t),dd=i(qa," special method."),qa.forEach(t),cd=c(Fe),b(pt.$$.fragment,Fe),hd=c(Fe),ys=s(Fe,"P",{});var bp=n(ys);pd=i(bp,"Examples:"),bp.forEach(t),fd=c(Fe),b(_o.$$.fragment,Fe),Fe.forEach(t),de.forEach(t),xn=c(o),Ke=s(o,"H2",{class:!0});var Hn=n(Ke);ft=s(Hn,"A",{id:!0,class:!0,href:!0});var yp=n(ft);$s=s(yp,"SPAN",{});var $p=n($s);b(vo.$$.fragment,$p),$p.forEach(t),yp.forEach(t),md=c(Hn),xs=s(Hn,"SPAN",{});var xp=n(xs);ud=i(xp,"TFViTForImageClassification"),xp.forEach(t),Hn.forEach(t),Vn=c(o),O=s(o,"DIV",{class:!0});var ce=n(O);b(To.$$.fragment,ce),gd=c(ce),Vs=s(ce,"P",{});var Vp=n(Vs);_d=i(Vp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
