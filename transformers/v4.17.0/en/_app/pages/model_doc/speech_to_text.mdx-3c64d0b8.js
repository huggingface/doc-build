import{S as pp,i as fp,s as up,e as a,k as c,w as v,t as n,M as mp,c as r,d as t,m as l,a as i,x as T,h as s,b as d,F as e,g as p,y as x,q as k,o as b,B as y}from"../../chunks/vendor-4833417e.js";import{T as Yt}from"../../chunks/Tip-fffd6df1.js";import{D}from"../../chunks/Docstring-7b52c3d4.js";import{C as ln}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as We}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function _p(G){let h,$,m,_,S,g,w,E;return{c(){h=a("p"),$=n(`This class method is simply calling the feature extractor
...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var w=i(h);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(w,"CODE",{});var E=i(m);_=s(E,"Module"),E.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(g,w){p(g,h,w),e(h,$),e(h,m),e(m,_),e(h,S)},d(g){g&&t(h)}}}function wp(G){let h,$,m,_,S,g,w,E,A,q,z,N,V,ee,Fe,B,je,$e,M,J,te,ye,P,C,Pe,oe,ne,Ce,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,u,F,X,st,Ne,Q,Ue,_e,at,W,ce,rt,Re,j,it,ze,Le,dt,hn,tr,or,pn,nr,sr,fn,ar,rr,Zs,U,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,fr,Zn,ur,mr,es,_r,gr,Xt,vr,Tr,ts,xr,ea,un,os,kr,ta,Qt,oa,mn,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,zr,rs,qr,Fr,is,jr,Pr,ds,Cr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Ur,so,Rr,Hr,Vr,ht,Br,gn,Jr,Kr,vn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,fs,oi,da,R,io,ni,us,si,ai,co,ri,Tn,ii,di,ci,$t,lo,li,ms,hi,pi,Et,ho,fi,po,ui,_s,mi,_i,gi,He,fo,vi,xn,Ti,kn,xi,ki,gs,bi,yi,bn,uo,ca,ft,zt,vs,mo,wi,Ts,Si,la,pe,_o,$i,xs,Ei,zi,go,qi,yn,Fi,ji,Pi,ks,Ci,Mi,qt,vo,Ai,bs,Ii,ha,ut,Ft,ys,To,Di,ws,Ni,pa,I,xo,Li,Ss,Oi,Gi,ge,wn,Wi,Ui,Sn,Ri,Hi,$n,Vi,Bi,ko,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,jt,bo,ed,Oe,td,yo,Es,od,nd,sd,zn,ad,rd,wo,zs,id,dd,cd,ld,Ve,So,hd,qs,pd,fd,Pt,ud,Be,$o,md,Eo,_d,qn,gd,vd,Td,Ct,xd,Mt,zo,kd,qo,bd,Fn,yd,wd,Sd,At,Fo,$d,jo,Ed,jn,zd,qd,Fd,It,Po,jd,Fs,Pd,fa,mt,Dt,js,Co,Cd,Ps,Md,ua,we,Mo,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Ud,ve,No,Rd,_t,Hd,Cn,Vd,Bd,Cs,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,ma,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Uo,ic,Ro,dc,cc,lc,Te,Ho,hc,vt,pc,An,fc,uc,Ds,mc,_c,gc,Ot,vc,Ns,Tc,xc,Vo,ga,Tt,Gt,Ls,Bo,kc,Os,bc,va,fe,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,zc,Xo,qc,Fc,jc,Wt,Pc,xe,Qo,Cc,xt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Ut,Oc,Ws,Gc,Wc,Zo,Ta,kt,Rt,Us,en,Uc,Rs,Rc,xa,ue,tn,Hc,on,Vc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Ht,el,ke,an,tl,bt,ol,Ln,nl,sl,Hs,al,rl,il,Vt,dl,Vs,cl,ll,rn,ka;return g=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){h=a("meta"),$=c(),m=a("h1"),_=a("a"),S=a("span"),v(g.$$.fragment),w=c(),E=a("span"),A=n("Speech2Text"),q=c(),z=a("h2"),N=a("a"),V=a("span"),v(ee.$$.fragment),Fe=c(),B=a("span"),je=n("Overview"),$e=c(),M=a("p"),J=n("The Speech2Text model was proposed in "),te=a("a"),ye=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),P=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
...
can be reloaded using the `),qn=a("a"),gd=n("from_pretrained()"),vd=n(" method."),Td=c(),v(Ct.$$.fragment),xd=c(),Mt=a("div"),v(zo.$$.fragment),kd=c(),qo=a("p"),bd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=a("a"),yd=n("batch_decode()"),wd=n(`. Please
...
Speech2Text.`),fa=c(),mt=a("h2"),Dt=a("a"),js=a("span"),v(Co.$$.fragment),Cd=c(),Ps=a("span"),Md=n("Speech2TextModel"),ua=c(),we=a("div"),v(Mo.$$.fragment),Ad=c(),Ao=a("p"),Id=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Ud=c(),ve=a("div"),v(No.$$.fragment),Rd=c(),_t=a("p"),Hd=n("The "),Cn=a("a"),Vd=n("Speech2TextModel"),Bd=n(" forward method, overrides the "),Cs=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),v(Nt.$$.fragment),Xd=c(),Ms=a("p"),Qd=n("Example:"),Zd=c(),v(Lo.$$.fragment),ma=c(),gt=a("h2"),Lt=a("a"),As=a("span"),v(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),v(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
can be reloaded using the `),qn=r(Da,"A",{href:!0});var Fh=i(qn);gd=s(Fh,"from_pretrained()"),Fh.forEach(t),vd=s(Da," method."),Da.forEach(t),Td=l(Hn),T(Ct.$$.fragment,Hn),Hn.forEach(t),xd=l(H),Mt=r(H,"DIV",{class:!0});var Na=i(Mt);T(zo.$$.fragment,Na),kd=l(Na),qo=r(Na,"P",{});var La=i(qo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var jh=i(Fn);yd=s(jh,"batch_decode()"),jh.forEach(t),wd=s(La,`. Please
...
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(H),It=r(H,"DIV",{class:!0});var Wa=i(It);T(Po.$$.fragment,Wa),jd=l(Wa),Fs=r(Wa,"P",{});var Ch=i(Fs);Pd=s(Ch,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),Ch.forEach(t),Wa.forEach(t),H.forEach(t),fa=l(o),mt=r(o,"H2",{class:!0});var Ua=i(mt);Dt=r(Ua,"A",{id:!0,class:!0,href:!0});var Mh=i(Dt);js=r(Mh,"SPAN",{});var Ah=i(js);T(Co.$$.fragment,Ah),Ah.forEach(t),Mh.forEach(t),Cd=l(Ua),Ps=r(Ua,"SPAN",{});var Ih=i(Ps);Md=s(Ih,"Speech2TextModel"),Ih.forEach(t),Ua.forEach(t),ua=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);T(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ra=i(Ao);Id=s(Ra,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
