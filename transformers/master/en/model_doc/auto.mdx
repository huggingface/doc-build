...
<docstring><name>class transformers.AutoConfig</name><anchor>transformers.AutoConfig</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/configuration_auto.py#L515</source><parameters>[]</parameters></docstring>
...
- **convnext** -- [ConvNextConfig](/docs/transformers/master/en/model_doc/convnext#transformers.ConvNextConfig) (ConvNext model)
...
- **plbart** -- [PLBartConfig](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartConfig) (PLBart model)
- **poolformer** -- [PoolFormerConfig](/docs/transformers/master/en/model_doc/poolformer#transformers.PoolFormerConfig) (PoolFormer model)
...
- **realm** -- [RealmConfig](/docs/transformers/master/en/model_doc/realm#transformers.RealmConfig) (Realm model)
...
- **swin** -- [SwinConfig](/docs/transformers/master/en/model_doc/swin#transformers.SwinConfig) (Swin model)
...
- **vilt** -- [ViltConfig](/docs/transformers/master/en/model_doc/vilt#transformers.ViltConfig) (ViLT model)
...
- **vit_mae** -- [ViTMAEConfig](/docs/transformers/master/en/model_doc/vit_mae#transformers.ViTMAEConfig) (ViTMAE model)
...
- **xglm** -- [XGLMConfig](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMConfig) (XGLM model)
...
- **xlm-roberta-xl** -- [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) (XLM-RoBERTa-XL model)
- **xlnet** -- [XLNetConfig](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetConfig) (XLNet model)
- **yoso** -- [YosoConfig](/docs/transformers/master/en/model_doc/yoso#transformers.YosoConfig) (YOSO model)
...
<docstring><name>class transformers.AutoTokenizer</name><anchor>transformers.AutoTokenizer</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/tokenization_auto.py#L351</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>from_pretrained</name><anchor>transformers.AutoTokenizer.from_pretrained</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/tokenization_auto.py#L365</source><parameters>[{"name": "pretrained_model_name_or_path", "val": ""}, {"name": "*inputs", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
  Can be either:
...
- **plbart** -- [PLBartTokenizer](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartTokenizer) (PLBart model)
...
- **xglm** -- [XGLMTokenizer](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMTokenizer) or [XGLMTokenizerFast](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMTokenizerFast) (XGLM model)
...
<div class="docstring">
<docstring><name>register</name><anchor>transformers.AutoTokenizer.register</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/tokenization_auto.py#L561</source><parameters>[{"name": "config_class", "val": ""}, {"name": "slow_tokenizer_class", "val": " = None"}, {"name": "fast_tokenizer_class", "val": " = None"}]</parameters><paramsdesc>- **config_class** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
...
<docstring><name>class transformers.AutoFeatureExtractor</name><anchor>transformers.AutoFeatureExtractor</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/feature_extraction_auto.py#L169</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>from_pretrained</name><anchor>transformers.AutoFeatureExtractor.from_pretrained</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/feature_extraction_auto.py#L183</source><parameters>[{"name": "pretrained_model_name_or_path", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
  This can be either:
  ...
  - a path to a *directory* containing a feature extractor file saved using the
    [save_pretrained()](/docs/transformers/master/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained) method, e.g.,
    `./my_model_directory/`.
...
- **convnext** -- [ConvNextFeatureExtractor](/docs/transformers/master/en/model_doc/convnext#transformers.ConvNextFeatureExtractor) (ConvNext model)
...
- **poolformer** -- [PoolFormerFeatureExtractor](/docs/transformers/master/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor) (PoolFormer model)
- **segformer** -- [SegformerFeatureExtractor](/docs/transformers/master/en/model_doc/segformer#transformers.SegformerFeatureExtractor) (SegFormer model)
...
- **swin** -- [ViTFeatureExtractor](/docs/transformers/master/en/model_doc/vit#transformers.ViTFeatureExtractor) (Swin model)
- **vit** -- [ViTFeatureExtractor](/docs/transformers/master/en/model_doc/vit#transformers.ViTFeatureExtractor) (ViT model)
- **vit_mae** -- [ViTFeatureExtractor](/docs/transformers/master/en/model_doc/vit#transformers.ViTFeatureExtractor) (ViTMAE model)
...
<docstring><name>class transformers.AutoProcessor</name><anchor>transformers.AutoProcessor</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/processing_auto.py#L71</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>from_pretrained</name><anchor>transformers.AutoProcessor.from_pretrained</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/processing_auto.py#L85</source><parameters>[{"name": "pretrained_model_name_or_path", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
  This can be either:
...
<div class="docstring">
<docstring><name>register</name><anchor>transformers.AutoProcessor.register</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/processing_auto.py#L238</source><parameters>[{"name": "config_class", "val": ""}, {"name": "processor_class", "val": ""}]</parameters><paramsdesc>- **config_class** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  The configuration corresponding to the model to register.
...
<docstring><name>class transformers.AutoModel</name><anchor>transformers.AutoModel</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L672</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [ConvNextConfig](/docs/transformers/master/en/model_doc/convnext#transformers.ConvNextConfig) configuration class: [ConvNextModel](/docs/transformers/master/en/model_doc/convnext#transformers.ConvNextModel) (ConvNext model)
  ...
  - [PLBartConfig](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartConfig) configuration class: [PLBartModel](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartModel) (PLBart model)
  ...
  - [PoolFormerConfig](/docs/transformers/master/en/model_doc/poolformer#transformers.PoolFormerConfig) configuration class: [PoolFormerModel](/docs/transformers/master/en/model_doc/poolformer#transformers.PoolFormerModel) (PoolFormer model)
  ...
  - [SwinConfig](/docs/transformers/master/en/model_doc/swin#transformers.SwinConfig) configuration class: [SwinModel](/docs/transformers/master/en/model_doc/swin#transformers.SwinModel) (Swin model)
  ...
  - [ViTMAEConfig](/docs/transformers/master/en/model_doc/vit_mae#transformers.ViTMAEConfig) configuration class: [ViTMAEModel](/docs/transformers/master/en/model_doc/vit_mae#transformers.ViTMAEModel) (ViTMAE model)
  - [ViltConfig](/docs/transformers/master/en/model_doc/vilt#transformers.ViltConfig) configuration class: [ViltModel](/docs/transformers/master/en/model_doc/vilt#transformers.ViltModel) (ViLT model)
  ...
  - [XGLMConfig](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMConfig) configuration class: [XGLMModel](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMModel) (XGLM model)
  ...
  - [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) configuration class: [XLMRobertaXLModel](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel) (XLM-RoBERTa-XL model)
  - [XLNetConfig](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetConfig) configuration class: [XLNetModel](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetModel) (XLNet model)
  - [YosoConfig](/docs/transformers/master/en/model_doc/yoso#transformers.YosoConfig) configuration class: [YosoModel](/docs/transformers/master/en/model_doc/yoso#transformers.YosoModel) (YOSO model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **convnext** -- [ConvNextModel](/docs/transformers/master/en/model_doc/convnext#transformers.ConvNextModel) (ConvNext model)
...
- **plbart** -- [PLBartModel](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartModel) (PLBart model)
- **poolformer** -- [PoolFormerModel](/docs/transformers/master/en/model_doc/poolformer#transformers.PoolFormerModel) (PoolFormer model)
...
- **swin** -- [SwinModel](/docs/transformers/master/en/model_doc/swin#transformers.SwinModel) (Swin model)
...
- **vilt** -- [ViltModel](/docs/transformers/master/en/model_doc/vilt#transformers.ViltModel) (ViLT model)
...
- **vit_mae** -- [ViTMAEModel](/docs/transformers/master/en/model_doc/vit_mae#transformers.ViTMAEModel) (ViTMAE model)
...
- **xglm** -- [XGLMModel](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMModel) (XGLM model)
...
- **xlm-roberta-xl** -- [XLMRobertaXLModel](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel) (XLM-RoBERTa-XL model)
- **xlnet** -- [XLNetModel](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetModel) (XLNet model)
- **yoso** -- [YosoModel](/docs/transformers/master/en/model_doc/yoso#transformers.YosoModel) (YOSO model)
...
<docstring><name>class transformers.AutoModelForPreTraining</name><anchor>transformers.AutoModelForPreTraining</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L679</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [ViTMAEConfig](/docs/transformers/master/en/model_doc/vit_mae#transformers.ViTMAEConfig) configuration class: [ViTMAEForPreTraining](/docs/transformers/master/en/model_doc/vit_mae#transformers.ViTMAEForPreTraining) (ViTMAE model)
  ...
  - [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) configuration class: [XLMRobertaXLForMaskedLM](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM) (XLM-RoBERTa-XL model)
...
- **vit_mae** -- [ViTMAEForPreTraining](/docs/transformers/master/en/model_doc/vit_mae#transformers.ViTMAEForPreTraining) (ViTMAE model)
...
- **xlm-roberta-xl** -- [XLMRobertaXLForMaskedLM](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM) (XLM-RoBERTa-XL model)
...
<docstring><name>class transformers.AutoModelForCausalLM</name><anchor>transformers.AutoModelForCausalLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L694</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [OpenAIGPTConfig](/docs/transformers/master/en/model_doc/openai-gpt#transformers.OpenAIGPTConfig) configuration class: [OpenAIGPTLMHeadModel](/docs/transformers/master/en/model_doc/openai-gpt#transformers.OpenAIGPTLMHeadModel) (OpenAI GPT model)
  - [PLBartConfig](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartConfig) configuration class: [PLBartForCausalLM](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartForCausalLM) (PLBart model)
  ...
  - [TransfoXLConfig](/docs/transformers/master/en/model_doc/transfo-xl#transformers.TransfoXLConfig) configuration class: [TransfoXLLMHeadModel](/docs/transformers/master/en/model_doc/transfo-xl#transformers.TransfoXLLMHeadModel) (Transformer-XL model)
  - [XGLMConfig](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMConfig) configuration class: [XGLMForCausalLM](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMForCausalLM) (XGLM model)
  - [XLMConfig](/docs/transformers/master/en/model_doc/xlm#transformers.XLMConfig) configuration class: [XLMWithLMHeadModel](/docs/transformers/master/en/model_doc/xlm#transformers.XLMWithLMHeadModel) (XLM model)
  ...
  - [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) configuration class: [XLMRobertaXLForCausalLM](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForCausalLM) (XLM-RoBERTa-XL model)
  - [XLNetConfig](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetConfig) configuration class: [XLNetLMHeadModel](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetLMHeadModel) (XLNet model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **plbart** -- [PLBartForCausalLM](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartForCausalLM) (PLBart model)
...
- **xglm** -- [XGLMForCausalLM](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMForCausalLM) (XGLM model)
- **xlm** -- [XLMWithLMHeadModel](/docs/transformers/master/en/model_doc/xlm#transformers.XLMWithLMHeadModel) (XLM model)
...
- **xlm-roberta-xl** -- [XLMRobertaXLForCausalLM](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForCausalLM) (XLM-RoBERTa-XL model)
- **xlnet** -- [XLNetLMHeadModel](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetLMHeadModel) (XLNet model)
...
<docstring><name>class transformers.AutoModelForMaskedLM</name><anchor>transformers.AutoModelForMaskedLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L701</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [XLMRobertaConfig](/docs/transformers/master/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig) configuration class: [XLMRobertaForMaskedLM](/docs/transformers/master/en/model_doc/xlm-roberta#transformers.XLMRobertaForMaskedLM) (XLM-RoBERTa model)
  - [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) configuration class: [XLMRobertaXLForMaskedLM](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM) (XLM-RoBERTa-XL model)
  - [YosoConfig](/docs/transformers/master/en/model_doc/yoso#transformers.YosoConfig) configuration class: [YosoForMaskedLM](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForMaskedLM) (YOSO model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **xlm-roberta** -- [XLMRobertaForMaskedLM](/docs/transformers/master/en/model_doc/xlm-roberta#transformers.XLMRobertaForMaskedLM) (XLM-RoBERTa model)
- **xlm-roberta-xl** -- [XLMRobertaXLForMaskedLM](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM) (XLM-RoBERTa-XL model)
- **yoso** -- [YosoForMaskedLM](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForMaskedLM) (YOSO model)
...
<docstring><name>class transformers.AutoModelForSeq2SeqLM</name><anchor>transformers.AutoModelForSeq2SeqLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L708</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [PLBartConfig](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartConfig) configuration class: [PLBartForConditionalGeneration](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartForConditionalGeneration) (PLBart model)
...
- **plbart** -- [PLBartForConditionalGeneration](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartForConditionalGeneration) (PLBart model)
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [PLBartConfig](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartConfig) configuration class: [PLBartForSequenceClassification](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartForSequenceClassification) (PLBart model)
  ...
  - [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) configuration class: [XLMRobertaXLForSequenceClassification](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForSequenceClassification) (XLM-RoBERTa-XL model)
  - [XLNetConfig](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetConfig) configuration class: [XLNetForSequenceClassification](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetForSequenceClassification) (XLNet model)
  - [YosoConfig](/docs/transformers/master/en/model_doc/yoso#transformers.YosoConfig) configuration class: [YosoForSequenceClassification](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForSequenceClassification) (YOSO model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **plbart** -- [PLBartForSequenceClassification](/docs/transformers/master/en/model_doc/plbart#transformers.PLBartForSequenceClassification) (PLBart model)
...
- **xlm-roberta-xl** -- [XLMRobertaXLForSequenceClassification](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForSequenceClassification) (XLM-RoBERTa-XL model)
...
- **yoso** -- [YosoForSequenceClassification](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForSequenceClassification) (YOSO model)
...
<docstring><name>class transformers.AutoModelForMultipleChoice</name><anchor>transformers.AutoModelForMultipleChoice</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L751</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) configuration class: [XLMRobertaXLForMultipleChoice](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMultipleChoice) (XLM-RoBERTa-XL model)
  - [XLNetConfig](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetConfig) configuration class: [XLNetForMultipleChoice](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetForMultipleChoice) (XLNet model)
  - [YosoConfig](/docs/transformers/master/en/model_doc/yoso#transformers.YosoConfig) configuration class: [YosoForMultipleChoice](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForMultipleChoice) (YOSO model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **xlm-roberta-xl** -- [XLMRobertaXLForMultipleChoice](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMultipleChoice) (XLM-RoBERTa-XL model)
- **xlnet** -- [XLNetForMultipleChoice](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetForMultipleChoice) (XLNet model)
- **yoso** -- [YosoForMultipleChoice](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForMultipleChoice) (YOSO model)
...
<docstring><name>class transformers.AutoModelForNextSentencePrediction</name><anchor>transformers.AutoModelForNextSentencePrediction</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L758</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) configuration class: [XLMRobertaXLForTokenClassification](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForTokenClassification) (XLM-RoBERTa-XL model)
  - [XLNetConfig](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetConfig) configuration class: [XLNetForTokenClassification](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetForTokenClassification) (XLNet model)
  - [YosoConfig](/docs/transformers/master/en/model_doc/yoso#transformers.YosoConfig) configuration class: [YosoForTokenClassification](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForTokenClassification) (YOSO model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **xlm-roberta-xl** -- [XLMRobertaXLForTokenClassification](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForTokenClassification) (XLM-RoBERTa-XL model)
...
- **yoso** -- [YosoForTokenClassification](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForTokenClassification) (YOSO model)
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [XLMRobertaXLConfig](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig) configuration class: [XLMRobertaXLForQuestionAnswering](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForQuestionAnswering) (XLM-RoBERTa-XL model)
  - [XLNetConfig](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetConfig) configuration class: [XLNetForQuestionAnsweringSimple](/docs/transformers/master/en/model_doc/xlnet#transformers.XLNetForQuestionAnsweringSimple) (XLNet model)
  - [YosoConfig](/docs/transformers/master/en/model_doc/yoso#transformers.YosoConfig) configuration class: [YosoForQuestionAnswering](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForQuestionAnswering) (YOSO model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **xlm-roberta-xl** -- [XLMRobertaXLForQuestionAnswering](/docs/transformers/master/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForQuestionAnswering) (XLM-RoBERTa-XL model)
...
- **yoso** -- [YosoForQuestionAnswering](/docs/transformers/master/en/model_doc/yoso#transformers.YosoForQuestionAnswering) (YOSO model)
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [ConvNextConfig](/docs/transformers/master/en/model_doc/convnext#transformers.ConvNextConfig) configuration class: [ConvNextForImageClassification](/docs/transformers/master/en/model_doc/convnext#transformers.ConvNextForImageClassification) (ConvNext model)
  ...
  - [PoolFormerConfig](/docs/transformers/master/en/model_doc/poolformer#transformers.PoolFormerConfig) configuration class: [PoolFormerForImageClassification](/docs/transformers/master/en/model_doc/poolformer#transformers.PoolFormerForImageClassification) (PoolFormer model)
  ...
  - [SwinConfig](/docs/transformers/master/en/model_doc/swin#transformers.SwinConfig) configuration class: [SwinForImageClassification](/docs/transformers/master/en/model_doc/swin#transformers.SwinForImageClassification) (Swin model)
...
- **convnext** -- [ConvNextForImageClassification](/docs/transformers/master/en/model_doc/convnext#transformers.ConvNextForImageClassification) (ConvNext model)
...
- **poolformer** -- [PoolFormerForImageClassification](/docs/transformers/master/en/model_doc/poolformer#transformers.PoolFormerForImageClassification) (PoolFormer model)
...
- **swin** -- [SwinForImageClassification](/docs/transformers/master/en/model_doc/swin#transformers.SwinForImageClassification) (Swin model)
...
<docstring><name>class transformers.AutoModelForVision2Seq</name><anchor>transformers.AutoModelForVision2Seq</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L797</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.AutoModelForAudioClassification</name><anchor>transformers.AutoModelForAudioClassification</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L804</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.AutoModelForCTC</name><anchor>transformers.AutoModelForCTC</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L811</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.AutoModelForSpeechSeq2Seq</name><anchor>transformers.AutoModelForSpeechSeq2Seq</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L818</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.AutoModelForAudioXVector</name><anchor>transformers.AutoModelForAudioXVector</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L836</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [DeiTConfig](/docs/transformers/master/en/model_doc/deit#transformers.DeiTConfig) configuration class: [DeiTForMaskedImageModeling](/docs/transformers/master/en/model_doc/deit#transformers.DeiTForMaskedImageModeling) (DeiT model)
  - [SwinConfig](/docs/transformers/master/en/model_doc/swin#transformers.SwinConfig) configuration class: [SwinForMaskedImageModeling](/docs/transformers/master/en/model_doc/swin#transformers.SwinForMaskedImageModeling) (Swin model)
  - [ViTConfig](/docs/transformers/master/en/model_doc/vit#transformers.ViTConfig) configuration class: [ViTForMaskedImageModeling](/docs/transformers/master/en/model_doc/vit#transformers.ViTForMaskedImageModeling) (ViT model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **deit** -- [DeiTForMaskedImageModeling](/docs/transformers/master/en/model_doc/deit#transformers.DeiTForMaskedImageModeling) (DeiT model)
- **swin** -- [SwinForMaskedImageModeling](/docs/transformers/master/en/model_doc/swin#transformers.SwinForMaskedImageModeling) (Swin model)
- **vit** -- [ViTForMaskedImageModeling](/docs/transformers/master/en/model_doc/vit#transformers.ViTForMaskedImageModeling) (ViT model)
...
<docstring><name>class transformers.AutoModelForImageSegmentation</name><anchor>transformers.AutoModelForImageSegmentation</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L774</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.AutoModelForSemanticSegmentation</name><anchor>transformers.AutoModelForSemanticSegmentation</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_auto.py#L781</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [BeitConfig](/docs/transformers/master/en/model_doc/beit#transformers.BeitConfig) configuration class: [BeitForSemanticSegmentation](/docs/transformers/master/en/model_doc/beit#transformers.BeitForSemanticSegmentation) (BEiT model)
...
- **beit** -- [BeitForSemanticSegmentation](/docs/transformers/master/en/model_doc/beit#transformers.BeitForSemanticSegmentation) (BEiT model)
- **segformer** -- [SegformerForSemanticSegmentation](/docs/transformers/master/en/model_doc/segformer#transformers.SegformerForSemanticSegmentation) (SegFormer model)
...
<docstring><name>class transformers.TFAutoModel</name><anchor>transformers.TFAutoModel</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_tf_auto.py#L371</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [Speech2TextConfig](/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextConfig) configuration class: [TFSpeech2TextModel](/docs/transformers/master/en/model_doc/speech_to_text#transformers.TFSpeech2TextModel) (Speech2Text model)
...
- **speech_to_text** -- [TFSpeech2TextModel](/docs/transformers/master/en/model_doc/speech_to_text#transformers.TFSpeech2TextModel) (Speech2Text model)
...
<docstring><name>class transformers.TFAutoModelForCausalLM</name><anchor>transformers.TFAutoModelForCausalLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_tf_auto.py#L393</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.TFAutoModelForImageClassification</name><anchor>transformers.TFAutoModelForImageClassification</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_tf_auto.py#L400</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.TFAutoModelForMaskedLM</name><anchor>transformers.TFAutoModelForMaskedLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_tf_auto.py#L414</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.TFAutoModelForSeq2SeqLM</name><anchor>transformers.TFAutoModelForSeq2SeqLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_tf_auto.py#L421</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.TFAutoModelForTokenClassification</name><anchor>transformers.TFAutoModelForTokenClassification</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_tf_auto.py#L457</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.TFAutoModelForVision2Seq</name><anchor>transformers.TFAutoModelForVision2Seq</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_tf_auto.py#L407</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.TFAutoModelForSpeechSeq2Seq</name><anchor>transformers.TFAutoModelForSpeechSeq2Seq</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_tf_auto.py#L482</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
- **speech_to_text** -- [TFSpeech2TextForConditionalGeneration](/docs/transformers/master/en/model_doc/speech_to_text#transformers.TFSpeech2TextForConditionalGeneration) (Speech2Text model)
...
<docstring><name>class transformers.FlaxAutoModel</name><anchor>transformers.FlaxAutoModel</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_flax_auto.py#L220</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [Wav2Vec2Config](/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2Config) configuration class: [FlaxWav2Vec2Model](/docs/transformers/master/en/model_doc/wav2vec2#transformers.FlaxWav2Vec2Model) (Wav2Vec2 model)
  - [XGLMConfig](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMConfig) configuration class: [FlaxXGLMModel](/docs/transformers/master/en/model_doc/xglm#transformers.FlaxXGLMModel) (XGLM model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **xglm** -- [FlaxXGLMModel](/docs/transformers/master/en/model_doc/xglm#transformers.FlaxXGLMModel) (XGLM model)
...
<docstring><name>class transformers.FlaxAutoModelForCausalLM</name><anchor>transformers.FlaxAutoModelForCausalLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_flax_auto.py#L234</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>from_config</name><anchor>transformers.models.auto.auto_factory._BaseAutoModelClass.from_config</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/auto_factory.py#L390</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config** ([PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig)) --
  ...
  - [GPTNeoConfig](/docs/transformers/master/en/model_doc/gpt_neo#transformers.GPTNeoConfig) configuration class: [FlaxGPTNeoForCausalLM](/docs/transformers/master/en/model_doc/gpt_neo#transformers.FlaxGPTNeoForCausalLM) (GPT Neo model)
  - [XGLMConfig](/docs/transformers/master/en/model_doc/xglm#transformers.XGLMConfig) configuration class: [FlaxXGLMForCausalLM](/docs/transformers/master/en/model_doc/xglm#transformers.FlaxXGLMForCausalLM) (XGLM model)</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **xglm** -- [FlaxXGLMForCausalLM](/docs/transformers/master/en/model_doc/xglm#transformers.FlaxXGLMForCausalLM) (XGLM model)
...
<docstring><name>class transformers.FlaxAutoModelForPreTraining</name><anchor>transformers.FlaxAutoModelForPreTraining</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_flax_auto.py#L227</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.FlaxAutoModelForMaskedLM</name><anchor>transformers.FlaxAutoModelForMaskedLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_flax_auto.py#L241</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.FlaxAutoModelForMultipleChoice</name><anchor>transformers.FlaxAutoModelForMultipleChoice</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_flax_auto.py#L282</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
...
<docstring><name>class transformers.FlaxAutoModelForVision2Seq</name><anchor>transformers.FlaxAutoModelForVision2Seq</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/auto/modeling_flax_auto.py#L307</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>
