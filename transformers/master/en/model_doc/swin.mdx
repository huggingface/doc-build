...
<docstring><name>class transformers.SwinModel</name><anchor>transformers.SwinModel</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/swin/modeling_swin.py#L671</source><parameters>[{"name": "config", "val": ""}, {"name": "add_pooling_layer", "val": " = True"}]</parameters><paramsdesc>- **config** ([SwinConfig](/docs/transformers/master/en/model_doc/swin#transformers.SwinConfig)) -- Model configuration class with all the parameters of the model.
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SwinModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/swin/modeling_swin.py#L698</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SwinForImageClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/swin/modeling_swin.py#L782</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [AutoFeatureExtractor](/docs/transformers/master/en/model_doc/auto#transformers.AutoFeatureExtractor). See
  `AutoFeatureExtractor.__call__()`for details.
- **head_mask** (`torch.FloatTensor` of shape `(num_heads,)` or `(num_layers, num_heads)`, *optional*) --
  Mask to nullify selected heads of the self-attention modules. Mask values selected in `[0, 1]`:
