import{S as gF,i as jF,s as yF,e as o,k as u,w as f,t as a,M as wF,c as l,d as t,m as c,a as r,x as d,h as n,b as h,F as s,g as i,y as m,q as _,o as v,B as g}from"../../chunks/vendor-4833417e.js";import{T as vF}from"../../chunks/Tip-fffd6df1.js";import{D as Cv}from"../../chunks/Docstring-7b52c3d4.js";import{C as j}from"../../chunks/CodeBlock-90ffda97.js";import{I as y}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function bF(xn){let w,L;return{c(){w=o("p"),L=a("This section is a must-read")},l(b){w=l(b,"P",{});var $=r(w);L=n($,"This section is a must-read"),$.forEach(t)},m(b,$){i(b,w,$),s(w,L)},d(b){b&&t(w)}}}function qF(xn){let w,L,b,$,fs,F,In,ds,ms,pt,V;return{c(){w=o("p"),L=a("Note, that once "),b=o("code"),$=a("load_state_dict_from_zero_checkpoint"),fs=a(" was run, the "),F=o("code"),In=a("model"),ds=a(` will no longer be useable in the
...
--disable-pip-version-check 2&gt;&amp;1 | <span class="hljs-built_in">tee</span> build.log`}}),Yn=new j({props:{codee:'CUDA_VISIBLE_DEVICES=0 python -c "import torch; print(torch.cuda.get_device_capability())",',highlighted:'CUDA_VISIBLE_DEVICES=0 python -c <span class="hljs-string">&quot;import torch; print(torch.cuda.get_device_capability())&quot;</span>'}}),Kn=new j({props:{codee:`git clone https://github.com/microsoft/DeepSpeed/
cd DeepSpeed
rm -rf build
...
python setup.py build_ext -j8 bdist_wheel`}}),Xn=new j({props:{codee:'python -c "import torch; print(torch.cuda.get_arch_list())",',highlighted:'python -c <span class="hljs-string">&quot;import torch; print(torch.cuda.get_arch_list())&quot;</span>'}}),Qn=new j({props:{codee:`CUDA_VISIBLE_DEVICES=0 python -c "import torch; \\
...
print(torch.cuda.get_device_properties(torch.device(&#x27;cuda&#x27;)))&quot;</span>`}}),eo=new j({props:{codee:"_CudaDeviceProperties(name='GeForce RTX 3090', major=8, minor=6, total_memory=24268MB, multi_processor_count=82),",highlighted:'_CudaDeviceProperties(name=<span class="hljs-string">&#x27;GeForce RTX 3090&#x27;</span>, major=8, minor=6, total_memory=24268MB, multi_processor_count=82)'}}),to=new y({}),no=new j({props:{codee:"python -m torch.distributed.launch --nproc_per_node=2 your_program.py <normal cl args>,",highlighted:"python -m torch.distributed.launch --nproc_per_node=2 your_program.py &lt;normal cl args&gt;"}}),oo=new j({props:{codee:"deepspeed --num_gpus=2 your_program.py <normal cl args> --deepspeed ds_config.json,",highlighted:"deepspeed --num_gpus=2 your_program.py &lt;normal cl args&gt; --deepspeed ds_config.json"}}),ro=new j({props:{codee:`deepspeed examples/pytorch/translation/run_translation.py \\
...
--source_lang en --target_lang ro`}}),io=new y({}),uo=new j({props:{codee:`deepspeed --num_gpus=1 examples/pytorch/translation/run_translation.py \\
...
--do_train --max_train_samples 500 --num_train_epochs 1 \\
--dataset_name wmt16 --dataset_config <span class="hljs-string">&quot;ro-en&quot;</span> \\
--source_lang en --target_lang ro`}}),ho=new j({props:{codee:`{
  "zero_optimization": {
     "stage": 2,
     "offload_optimizer": {
         "device": "cpu",
...
<span class="hljs-punctuation">}</span>`}}),_o=new j({props:{codee:"deepspeed --include localhost:1 examples/pytorch/translation/run_translation.py ...,",highlighted:"deepspeed --include localhost:1 examples/pytorch/translation/run_translation.py ..."}}),vo=new y({}),go=new j({props:{codee:`# DeepSpeed requires a distributed environment even when only one process is used.
...
trainer = Trainer(...)
trainer.train()`}}),jo=new j({props:{codee:`%%bash
...
EOT`}}),yo=new j({props:{codee:`!git clone https://github.com/huggingface/transformers
...
!cd transformers; deepspeed examples/pytorch/translation/run_translation.py ...`}}),wo=new j({props:{codee:`%%bash
...
git clone https://github.com/huggingface/transformers
cd transformers
deepspeed examples/pytorch/translation/run_translation.py ...`}}),bo=new y({}),$o=new j({props:{codee:`git clone https://github.com/microsoft/DeepSpeedExamples
...
find . -name <span class="hljs-string">&#x27;*json&#x27;</span>`}}),ko=new j({props:{codee:"grep -i Lamb $(find . -name '*json'),",highlighted:'grep -i Lamb $(find . -name <span class="hljs-string">&#x27;*json&#x27;</span>)'}}),zo=new j({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
...
<span class="hljs-punctuation">}</span>`}}),Do=new y({}),Oo=new j({props:{codee:'TrainingArguments(..., deepspeed="/path/to/ds_config.json"),',highlighted:'TrainingArguments(..., deepspeed=<span class="hljs-string">&quot;/path/to/ds_config.json&quot;</span>)'}}),To=new j({props:{codee:`ds_config_dict = dict(scheduler=scheduler_params, optimizer=optimizer_params)
...
TrainingArguments(..., deepspeed=ds_config_dict)`}}),Ao=new y({}),Zt=new vF({props:{warning:"&lcub;true}",$$slots:{default:[bF]},$$scope:{ctx:xn}}}),Co=new y({}),Uo=new y({}),Go=new j({props:{codee:`{
    "zero_optimization": {
        "stage": 2,
        "offload_optimizer": {
            "device": "cpu",
    ...
    <span class="hljs-attr">&quot;zero_optimization&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;contiguous_gradients&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">true</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Mo=new y({}),Lo=new j({props:{codee:`{
    "zero_optimization": {
        "stage": 3,
        "offload_optimizer": {
            "device": "cpu",
    ...
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Jo=new y({}),Xo=new j({props:{codee:`{
    "zero_optimization": {
        "stage": 3,
        "offload_optimizer": {
            "device": "nvme",
    ...
    <span class="hljs-attr">&quot;zero_optimization&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;stage3_gather_fp16_weights_on_model_save&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">true</span>
    <span class="hljs-punctuation">}</span><span class="hljs-punctuation">,</span>
<span class="hljs-punctuation">}</span>`}}),tl=new y({}),nl=new y({}),ol=new j({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
...
<span class="hljs-punctuation">}</span>`}}),ll=new j({props:{codee:`{
    "fp16": {
        "enabled": true,
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;steps_per_print&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">2000</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;wall_clock_breakdown&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">false</span>
<span class="hljs-punctuation">}</span>`}}),rl=new y({}),pl=new j({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;train_micro_batch_size_per_gpu&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;auto&quot;</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;wall_clock_breakdown&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">false</span>
<span class="hljs-punctuation">}</span>`}}),il=new j({props:{codee:`{
    "fp16": {
        "enabled": true,
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;steps_per_print&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">2000</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;wall_clock_breakdown&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">false</span>
<span class="hljs-punctuation">}</span>`}}),ul=new y({}),cl=new y({}),fl=new j({props:{codee:`{
   "optimizer": {
       "type": "AdamW",
       "params": {
         "lr": "auto",
   ...
   <span class="hljs-attr">&quot;optimizer&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
       ...
       <span class="hljs-punctuation">}</span>
   <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),gl=new j({props:{codee:`{
   "optimizer": {
       "type": "AdamW",
       "params": {
         "lr": 0.001,
   ...
   <span class="hljs-attr">&quot;optimizer&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
       ...
       <span class="hljs-punctuation">}</span>
   <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),jl=new j({props:{codee:`{
...
<span class="hljs-punctuation">}</span>`}}),yl=new y({}),ql=new j({props:{codee:`{
   "scheduler": {
         "type": "WarmupLR",
         "params": {
             "warmup_min_lr": "auto",
   ...
   <span class="hljs-attr">&quot;scheduler&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
         ...
         <span class="hljs-punctuation">}</span>
     <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),El=new j({props:{codee:`{
   "scheduler": {
         "type": "WarmupLR",
         "params": {
             "warmup_min_lr": 0,
   ...
   <span class="hljs-attr">&quot;scheduler&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
         ...
         <span class="hljs-punctuation">}</span>
     <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),$l=new j({props:{codee:`{
   "scheduler": {
         "type": "WarmupDecayLR",
         "params": {
   ...
   <span class="hljs-attr">&quot;scheduler&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
         ...
         <span class="hljs-punctuation">}</span>
     <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),kl=new y({}),Pl=new j({props:{codee:`{
    "fp16": {
        "enabled": "false",
    }
},`,highlighted:`<span class="hljs-punctuation">{</span>
    ...
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Dl=new y({}),Ol=new j({props:{codee:`{
    "fp16": {
        "enabled": "auto",
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;fp16&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;min_loss_scale&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">1</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Tl=new j({props:{codee:`{
    "fp16": {
        "enabled": true,
        "loss_scale": 0,
        "loss_scale_window": 1000,
    ...
    <span class="hljs-attr">&quot;fp16&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        ...
        <span class="hljs-attr">&quot;min_loss_scale&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">1</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Sl=new j({props:{codee:`"amp": {
    "enabled": "auto",
    "opt_level": "auto"
...
<span class="hljs-punctuation">}</span>`}}),Cl=new j({props:{codee:`{
    "amp": {
        "enabled": true,
        "opt_level": "O1"
    }
    ...
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Il=new y({}),Rl=new j({props:{codee:`{
    "train_batch_size": "auto",
    "train_micro_batch_size_per_gpu": "auto"
},`,highlighted:`<span class="hljs-punctuation">{</span>
    <span class="hljs-attr">&quot;train_batch_size&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;auto&quot;</span><span class="hljs-punctuation">,</span>
...
<span class="hljs-punctuation">}</span>`}}),Ul=new j({props:{codee:`{
    "train_batch_size": 12,
...
<span class="hljs-punctuation">}</span>`}}),Gl=new y({}),Ml=new j({props:{codee:`{
    "gradient_accumulation_steps": "auto"
},`,highlighted:`<span class="hljs-punctuation">{</span>
...
<span class="hljs-punctuation">}</span>`}}),Hl=new y({}),Wl=new j({props:{codee:`{
    ...
    <span class="hljs-attr">&quot;zero_optimization&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        <span class="hljs-attr">&quot;stage3_gather_fp16_weights_on_model_save&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">true</span>
    <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>`}}),Vl=new j({props:{codee:`from transformers.trainer_utils import get_last_checkpoint
...
checkpoint_dir = get_last_checkpoint(trainer.args.output_dir)
fp32_model = load_state_dict_from_zero_checkpoint(trainer.model, checkpoint_dir)`}}),Yl=new j({props:{codee:`from deepspeed.utils.zero_to_fp32 import load_state_dict_from_zero_checkpoint
...
trainer.deepspeed.save_checkpoint(checkpoint_dir)
fp32_model = load_state_dict_from_zero_checkpoint(trainer.model, checkpoint_dir)`}}),Ma=new vF({props:{$$slots:{default:[qF]},$$scope:{ctx:xn}}}),Kl=new j({props:{codee:`from deepspeed.utils.zero_to_fp32 import get_fp32_state_dict_from_zero_checkpoint
...
model = model.cpu()
model.load_state_dict(state_dict)`}}),Jl=new j({props:{codee:`$ ls -l output_dir/checkpoint-1/
...
-rw-rw-r-- 1 stas stas  339 Mar 27 20:42 trainer_state.json
-rw-rw-r-- 1 stas stas 2.3K Mar 27 20:42 training_args.bin
-rwxrw-r-- 1 stas stas 5.5K Mar 27 13:16 zero_to_fp32.py*`}}),Xl=new j({props:{codee:"python zero_to_fp32.py . pytorch_model.bin,",highlighted:"python zero_to_fp32.py . pytorch_model.bin"}}),er=new y({}),sr=new y({}),tr=new j({props:{codee:`from transformers import T5ForConditionalGeneration, T5Config
import deepspeed
...
<span class="hljs-keyword">with</span> deepspeed.zero.Init():
    ...
    model = T5ForConditionalGeneration(config)`}}),ar=new j({props:{codee:`from transformers import AutoModel, Trainer, TrainingArguments
...
--source_lang en --target_lang ro --dataset_name wmt16 \\
--source_prefix <span class="hljs-string">&quot;translate English to Romanian: &quot;</span>`}}),hr=new y({}),fr=new j({props:{codee:`$ python -c 'from transformers import AutoModel; \\
...
SW: Model with 2783M total params, 65M largest layer params.
  per CPU  |  per GPU |   Options
   ...
   62.23GB |   5.43GB | offload_param=none, offload_optimizer=cpu , zero_init=0
    0.37GB |  46.91GB | offload_param=none, offload_optimizer=none, zero_init=1
   15.56GB |  46.91GB | offload_param=none, offload_optimizer=none, zero_init=0`}}),dr=new j({props:{codee:`$ python -c 'from transformers import AutoModel; \\
from deepspeed.runtime.zero.stage3 import estimate_zero3_model_states_mem_needs_all_live; \\
model = AutoModel.from_pretrained("bigscience/T0_3B"); \\
...
SW: Model with 2783M total params, 65M largest layer params.
  per CPU  |  per GPU |   Options
   ...
   62.23GB |   2.84GB | offload_param=none, offload_optimizer=cpu , zero_init=0
    0.74GB |  23.58GB | offload_param=none, offload_optimizer=none, zero_init=1
   31.11GB |  23.58GB | offload_param=none, offload_optimizer=none, zero_init=0
`}}),_r=new y({}),gr=new j({props:{codee:`python -c 'import torch; print(f"torch: {torch.__version__}")'
...
python -c <span class="hljs-string">&#x27;import deepspeed; print(f&quot;deepspeed: {deepspeed.__version__}&quot;)&#x27;</span>`}}),$r=new y({}),Pr=new y({}),Tr=new y({}),Ar=new j({props:{codee:`from transformers.deepspeed import HfDeepSpeedConfig
...
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Sr=new j({props:{codee:`from transformers.deepspeed import HfDeepSpeedConfig
