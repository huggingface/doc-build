import{S as iM,i as lM,s as dM,e as o,k as l,w as p,t as r,M as cM,c as s,d as t,m as d,a,x as m,h as i,b as c,F as e,g as v,y as u,q as g,o as h,B as f}from"../../chunks/vendor-4833417e.js";import{T as Fc}from"../../chunks/Tip-fffd6df1.js";import{D as _}from"../../chunks/Docstring-7b52c3d4.js";import{C as O}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function pM(ee){let x,E;return{c(){x=o("p"),E=r("Passing `use_auth_token=True\u201C is required when you want to use a private model.")},l(T){x=s(T,"P",{});var $=a(x);E=i($,"Passing `use_auth_token=True\u201C is required when you want to use a private model."),$.forEach(t)},m(T,$){v(T,x,$),e(x,E)},d(T){T&&t(x)}}}function mM(ee){let x,E,T,$,te;return{c(){x=o("p"),E=r("Activate the special "),T=o("a"),$=r("\u201Coffline-mode\u201D"),te=r(` to
...
use this method in a firewalled environment.`),I.forEach(t),this.h()},h(){c(T,"href","https://huggingface.co/transformers/installation.html#offline-mode"),c(T,"rel","nofollow")},m(A,I){v(A,x,I),e(x,E),e(x,T),e(T,$),e(x,te)},d(A){A&&t(x)}}}function uM(ee){let x,E;return{c(){x=o("p"),E=r("This API is experimental and may have some slight breaking changes in the next releases.")},l(T){x=s(T,"P",{});var $=a(x);E=i($,"This API is experimental and may have some slight breaking changes in the next releases."),$.forEach(t)},m(T,$){v(T,x,$),e(x,E)},d(T){T&&t(x)}}}function gM(ee){let x,E,T,$,te;return{c(){x=o("p"),E=r("Passing "),T=o("code"),$=r("use_auth_token=True"),te=r(" is required when you want to use a private model.")},l(A){x=s(A,"P",{});var I=a(x);E=i(I,"Passing "),T=s(I,"CODE",{});var Me=a(T);$=i(Me,"use_auth_token=True"),Me.forEach(t),te=i(I," is required when you want to use a private model."),I.forEach(t)},m(A,I){v(A,x,I),e(x,E),e(x,T),e(T,$),e(x,te)},d(A){A&&t(x)}}}function hM(ee){let x,E;return{c(){x=o("p"),E=r("This API is experimental and may have some slight breaking changes in the next releases.")},l(T){x=s(T,"P",{});var $=a(x);E=i($,"This API is experimental and may have some slight breaking changes in the next releases."),$.forEach(t)},m(T,$){v(T,x,$),e(x,E)},d(T){T&&t(x)}}}function fM(ee){let x,E,T,$,te,A,I,Me,Am,Oc,ie,Gm,Aa,Sm,Nm,Ga,Cm,Im,Sa,Bm,Wm,zc,nt,Na,Um,Hm,Ca,Vm,Xm,Dc,wt,Ir,Rm,Ym,Br,Km,Ac,B,Zm,Ia,Jm,Qm,Wr,eu,tu,Ba,nu,ou,Wa,su,au,Ua,ru,iu,Gc,ot,Tt,Ur,Hn,lu,Hr,du,Sc,w,Vn,cu,Vr,pu,mu,Ha,Va,uu,gu,hu,Xn,Xr,fu,_u,Rr,bu,vu,Yr,yu,ku,ne,Kr,Ae,Zr,xu,wu,Xa,Tu,ju,Ra,$u,Mu,Pu,Rn,Ge,Jr,Eu,Lu,Qr,qu,Fu,ei,Ou,zu,Du,st,jt,ti,Au,Gu,Ya,Su,Nu,Cu,$t,ni,Iu,Bu,oi,Wu,Uu,Hu,Mt,si,Vu,Xu,ai,Ru,Yu,Ku,ri,Pt,ii,Zu,Ju,li,Qu,eg,tg,di,Et,ci,ng,og,pi,sg,ag,rg,mi,V,ui,ig,lg,gi,dg,cg,hi,pg,mg,fi,ug,gg,_i,hg,fg,_g,le,Yn,bg,Kn,vg,bi,yg,kg,xg,vi,wg,Tg,Zn,jg,z,Jn,$g,yi,Mg,Pg,at,Eg,ki,Lg,qg,xi,Fg,Og,zg,Qn,Dg,wi,Ag,Gg,Sg,eo,Ng,Ti,Cg,Ig,Bg,Lt,Wg,qt,Ug,ji,Hg,Vg,to,Xg,Ft,no,Rg,$i,Yg,Kg,Ot,oo,Zg,Mi,Jg,Qg,Se,so,eh,Pi,th,nh,Ei,oh,sh,Ne,ao,ah,Li,rh,ih,qi,lh,dh,zt,ro,ch,Fi,ph,mh,Dt,io,uh,Oi,gh,hh,At,lo,fh,zi,_h,bh,Ce,co,vh,Di,yh,kh,Gt,xh,Ie,po,wh,mo,Th,Ai,jh,$h,Mh,uo,Ph,Gi,Eh,Lh,qh,St,go,Fh,ho,Oh,Si,zh,Dh,Ah,Nt,fo,Gh,Ni,Sh,Nh,Be,_o,Ch,Ci,Ih,Bh,bo,Wh,Ii,Uh,Hh,Nc,Ka,Cc,rt,Ct,Bi,vo,Vh,Wi,Xh,Ic,de,Rh,Ui,Yh,Kh,Hi,Zh,Jh,Vi,Qh,ef,Bc,yo,Wc,We,tf,Xi,nf,of,Ri,sf,af,Uc,ko,Hc,It,rf,Yi,lf,df,Vc,xo,Xc,Za,cf,Rc,it,Bt,Ki,wo,pf,Zi,mf,Yc,L,To,uf,jo,gf,Ji,hf,ff,_f,Ue,$o,bf,Qi,vf,yf,lt,kf,el,xf,wf,tl,Tf,jf,$f,Wt,Mo,Mf,nl,Pf,Ef,Ut,Po,Lf,dt,qf,ol,Ff,Of,Eo,zf,Df,Af,Ht,Lo,Gf,sl,Sf,Nf,Vt,qo,Cf,al,If,Bf,Xt,Fo,Wf,rl,Uf,Hf,Rt,Oo,Vf,il,Xf,Rf,Yt,zo,Yf,ct,Kf,ll,Zf,Jf,Ja,Qf,e_,Kc,pt,Kt,dl,Do,t_,cl,n_,Zc,y,Ao,o_,pl,s_,a_,Qa,er,r_,i_,l_,Go,ml,d_,c_,ul,p_,m_,gl,u_,g_,mt,He,hl,h_,f_,tr,__,b_,nr,v_,y_,k_,Zt,fl,x_,w_,_l,T_,j_,$_,X,bl,M_,P_,vl,E_,L_,yl,q_,F_,kl,O_,z_,xl,D_,A_,G_,ce,So,S_,No,N_,wl,C_,I_,B_,Tl,W_,U_,Co,H_,Jt,Io,V_,jl,X_,R_,S,Bo,Y_,$l,K_,Z_,Wo,J_,Ml,Q_,eb,tb,Uo,nb,Pl,ob,sb,ab,Qt,rb,El,ib,lb,Ho,db,en,Vo,cb,Ll,pb,mb,tn,Xo,ub,ql,gb,hb,nn,Ro,fb,Fl,_b,bb,on,Yo,vb,Ol,yb,kb,sn,Ko,xb,zl,wb,Tb,an,Zo,jb,Dl,$b,Mb,rn,Jo,Pb,Al,Eb,Lb,ln,Qo,qb,Gl,Fb,Ob,Ve,es,zb,ts,Db,Sl,Ab,Gb,Sb,ns,Nb,Nl,Cb,Ib,Bb,dn,os,Wb,ss,Ub,or,Hb,Vb,Xb,cn,as,Rb,Cl,Yb,Kb,pn,rs,Zb,Il,Jb,Qb,mn,is,ev,Bl,tv,nv,un,ls,ov,Wl,sv,av,gn,ds,rv,Ul,iv,lv,hn,cs,dv,Hl,cv,pv,pe,ps,mv,oe,uv,Vl,gv,hv,Xl,fv,_v,Rl,bv,vv,Yl,yv,kv,xv,ut,wv,Kl,Tv,jv,Zl,$v,Mv,Pv,gt,Ev,Jl,Lv,qv,Ql,Fv,Ov,Jc,ht,fn,ed,ms,zv,td,Dv,Qc,Pe,us,Av,gs,Gv,nd,Sv,Nv,Cv,_n,hs,Iv,od,Bv,ep,ft,bn,sd,fs,Wv,ad,Uv,tp,M,_s,Hv,rd,Vv,Xv,sr,ar,Rv,Yv,Kv,id,Zv,Jv,_t,Xe,ld,Qv,ey,rr,ty,ny,ir,oy,sy,ay,vn,dd,ry,iy,cd,ly,dy,cy,R,pd,py,my,md,uy,gy,ud,hy,fy,gd,_y,by,hd,vy,yy,ky,me,bs,xy,vs,wy,fd,Ty,jy,$y,_d,My,Py,ys,Ey,W,ks,Ly,bd,qy,Fy,xs,Oy,vd,zy,Dy,Ay,ws,Gy,yd,Sy,Ny,Cy,kd,Iy,By,Ts,Wy,Re,js,Uy,xd,Hy,Vy,yn,Xy,kn,$s,Ry,Ms,Yy,wd,Ky,Zy,Jy,Y,Ps,Qy,se,ek,Td,tk,nk,jd,ok,sk,$d,ak,rk,Md,ik,lk,dk,Pd,ck,pk,Ed,mk,uk,Es,gk,K,Ls,hk,ae,fk,Ld,_k,bk,qd,vk,yk,Fd,kk,xk,Od,wk,Tk,jk,zd,$k,Mk,Dd,Pk,Ek,qs,Lk,ue,Fs,qk,re,Fk,Ad,Ok,zk,Gd,Dk,Ak,Sd,Gk,Sk,Nd,Nk,Ck,Ik,Cd,Bk,Wk,Os,np,bt,xn,Id,zs,Uk,Bd,Hk,op,P,Ds,Vk,As,Xk,lr,Rk,Yk,Kk,wn,Gs,Zk,Ss,Jk,dr,Qk,ex,tx,ge,Ns,nx,Wd,ox,sx,Ud,ax,rx,Cs,ix,he,Is,lx,Hd,dx,cx,Vd,px,mx,Bs,ux,Tn,Ws,gx,Xd,hx,fx,fe,Us,_x,Rd,bx,vx,Yd,yx,kx,Hs,xx,U,Vs,wx,Kd,Tx,jx,vt,$x,Zd,Mx,Px,cr,Ex,Lx,qx,Xs,Fx,Rs,Ox,zx,Dx,Jd,Ax,Gx,Ys,Sx,_e,Ks,Nx,Qd,Cx,Ix,ec,Bx,Wx,Zs,Ux,be,Js,Hx,tc,Vx,Xx,nc,Rx,Yx,Qs,Kx,jn,ea,Zx,ta,Jx,pr,Qx,ew,tw,ve,na,nw,oc,ow,sw,sc,aw,rw,oa,sp,G,sa,iw,aa,lw,mr,dw,cw,pw,$n,ra,mw,ia,uw,ur,gw,hw,fw,N,la,_w,ac,bw,vw,da,yw,ca,kw,xw,ww,Ee,Tw,rc,jw,$w,ic,Mw,Pw,gr,Ew,Lw,qw,pa,Fw,ma,Ow,zw,Dw,lc,Aw,Gw,ua,Sw,ye,ga,Nw,dc,Cw,Iw,cc,Bw,Ww,ha,Uw,Mn,fa,Hw,_a,Vw,hr,Xw,Rw,Yw,ke,ba,Kw,pc,Zw,Jw,mc,Qw,e1,va,ap,Le,ya,t1,ka,n1,fr,o1,s1,a1,H,xa,r1,uc,i1,l1,yt,d1,gc,c1,p1,_r,m1,u1,g1,wa,h1,Ta,f1,_1,b1,hc,v1,y1,ja,rp,kt,Pn,fc,$a,k1,_c,x1,ip,qe,Ma,w1,bc,T1,j1,xe,Pa,$1,Ea,M1,vc,P1,E1,L1,yc,q1,F1,La,lp;return A=new xt({}),Hn=new xt({}),Vn=new _({props:{name:"class transformers.PreTrainedModel",anchor:"transformers.PreTrainedModel",parameters:[{name:"config",val:": PretrainedConfig"},{name:"*inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/modeling_utils.py#L423"}}),Yn=new _({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
<span class="hljs-comment"># Make a change to an existing repo that has been cloned locally in *my-finetuned-bert*.</span>
{<span class="hljs-built_in">object</span>}.push_to_hub(<span class="hljs-string">&quot;my-finetuned-bert&quot;</span>, repo_url=<span class="hljs-string">&quot;https://huggingface.co/sgugger/my-finetuned-bert&quot;</span>)`}}),{c(){x=o("meta"),E=l(),T=o("h1"),$=o("a"),te=o("span"),p(A.$$.fragment),I=l(),Me=o("span"),Am=r("Models"),Oc=l(),ie=o("p"),Gm=r("The base classes "),Aa=o("a"),Sm=r("PreTrainedModel"),Nm=r(", "),Ga=o("a"),Cm=r("TFPreTrainedModel"),Im=r(`, and
...
S3 repository).`),zc=l(),nt=o("p"),Na=o("a"),Um=r("PreTrainedModel"),Hm=r(" and "),Ca=o("a"),Vm=r("TFPreTrainedModel"),Xm=r(` also implement a few methods which
are common among all the models to:`),Dc=l(),wt=o("ul"),Ir=o("li"),Rm=r("resize the input token embeddings when new tokens are added to the vocabulary"),Ym=l(),Br=o("li"),Km=r("prune the attention heads of the model."),Ac=l(),B=o("p"),Zm=r("The other methods that are common to each model are defined in "),Ia=o("a"),Jm=r("ModuleUtilsMixin"),Qm=r(`
...
`),bi=o("code"),yg=r("repo_path_or_name"),kg=r("."),xg=l(),vi=o("p"),wg=r("Examples:"),Tg=l(),p(Zn.$$.fragment),jg=l(),z=o("div"),p(Jn.$$.fragment),$g=l(),yi=o("p"),Mg=r("Instantiate a pretrained pytorch model from a pre-trained model configuration."),Pg=l(),at=o("p"),Eg=r("The model is set in evaluation mode by default using "),ki=o("code"),Lg=r("model.eval()"),qg=r(` (Dropout modules are deactivated). To train
...
weights are discarded.`),Bg=l(),p(Lt.$$.fragment),Wg=l(),p(qt.$$.fragment),Ug=l(),ji=o("p"),Hg=r("Examples:"),Vg=l(),p(to.$$.fragment),Xg=l(),Ft=o("div"),p(no.$$.fragment),Rg=l(),$i=o("p"),Yg=r("Returns the model\u2019s input embeddings."),Kg=l(),Ot=o("div"),p(oo.$$.fragment),Zg=l(),Mi=o("p"),Jg=r("Returns the model\u2019s output embeddings."),Qg=l(),Se=o("div"),p(so.$$.fragment),eh=l(),Pi=o("p"),th=r("Deactivates gradient checkpointing for the current model."),nh=l(),Ei=o("p"),oh=r(`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
...
activations\u201D.`),dh=l(),zt=o("div"),p(ro.$$.fragment),ch=l(),Fi=o("p"),ph=r("If needed prunes and maybe initializes weights."),mh=l(),Dt=o("div"),p(io.$$.fragment),uh=l(),Oi=o("p"),gh=r(`A method executed at the end of each Transformer model initialization, to execute code that needs the model\u2019s
modules properly initialized (such as weight initialization).`),hh=l(),At=o("div"),p(lo.$$.fragment),fh=l(),zi=o("p"),_h=r("Prunes heads of the base model."),bh=l(),Ce=o("div"),p(co.$$.fragment),vh=l(),Di=o("p"),yh=r(`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),kh=l(),p(Gt.$$.fragment),xh=l(),Ie=o("div"),p(po.$$.fragment),wh=l(),mo=o("p"),Th=r("Resizes input token embeddings matrix of the model if "),Ai=o("code"),jh=r("new_num_tokens != config.vocab_size"),$h=r("."),Mh=l(),uo=o("p"),Ph=r("Takes care of tying weights embeddings afterwards if the model class has a "),Gi=o("code"),Eh=r("tie_weights()"),Lh=r(" method."),qh=l(),St=o("div"),p(go.$$.fragment),Fh=l(),ho=o("p"),Oh=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),p(fo.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),p(_o.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
for this model architecture.`),k_=l(),Zt=o("li"),fl=o("strong"),x_=r("base_model_prefix"),w_=r(" ("),_l=o("code"),T_=r("str"),j_=r(`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),$_=l(),X=o("li"),bl=o("strong"),M_=r("main_input_name"),P_=r(" ("),vl=o("code"),E_=r("str"),L_=r(") \u2014 The name of the principal input to the model (often "),yl=o("code"),q_=r("input_ids"),F_=r(` for NLP
models, `),kl=o("code"),O_=r("pixel_values"),z_=r(" for vision models and "),xl=o("code"),D_=r("input_values"),A_=r(" for speech models)."),G_=l(),ce=o("div"),p(So.$$.fragment),S_=l(),No=o("p"),N_=r(`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),wl=o("code"),C_=r("repo_path_or_name"),I_=r("."),B_=l(),Tl=o("p"),W_=r("Examples:"),U_=l(),p(Co.$$.fragment),H_=l(),Jt=o("div"),p(Io.$$.fragment),V_=l(),jl=o("p"),X_=r(`This is a thin wrapper that sets the model\u2019s loss output head as the loss if the user does not specify a loss
function themselves.`),R_=l(),S=o("div"),p(Bo.$$.fragment),Y_=l(),$l=o("p"),K_=r("Instantiate a pretrained TF 2.0 model from a pre-trained model configuration."),Z_=l(),Wo=o("p"),J_=r("The warning "),Ml=o("em"),Q_=r("Weights from XXX not initialized from pretrained model"),eb=r(` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
weights are discarded.`),ab=l(),p(Qt.$$.fragment),rb=l(),El=o("p"),ib=r("Examples:"),lb=l(),p(Ho.$$.fragment),db=l(),en=o("div"),p(Vo.$$.fragment),cb=l(),Ll=o("p"),pb=r("Dict of bias attached to an LM head. The key represents the name of the bias attribute."),mb=l(),tn=o("div"),p(Xo.$$.fragment),ub=l(),ql=o("p"),gb=r("Returns the model\u2019s input embeddings layer."),hb=l(),nn=o("div"),p(Ro.$$.fragment),fb=l(),Fl=o("p"),_b=r("The LM Head layer. This method must be overwritten by all the models that have a lm head."),bb=l(),on=o("div"),p(Yo.$$.fragment),vb=l(),Ol=o("p"),yb=r("Returns the model\u2019s output embeddings"),kb=l(),sn=o("div"),p(Ko.$$.fragment),xb=l(),zl=o("p"),wb=r(`Get the layer that handles a bias attribute in case the model has an LM head with weights tied to the
embeddings`),Tb=l(),an=o("div"),p(Zo.$$.fragment),jb=l(),Dl=o("p"),$b=r("Get the concatenated _prefix name of the bias from the model name to the parent layer"),Mb=l(),rn=o("div"),p(Jo.$$.fragment),Pb=l(),Al=o("p"),Eb=r(`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),Lb=l(),ln=o("div"),p(Qo.$$.fragment),qb=l(),Gl=o("p"),Fb=r("Prunes heads of the base model."),Ob=l(),Ve=o("div"),p(es.$$.fragment),zb=l(),ts=o("p"),Db=r("Resizes input token embeddings matrix of the model if "),Sl=o("code"),Ab=r("new_num_tokens != config.vocab_size"),Gb=r("."),Sb=l(),ns=o("p"),Nb=r("Takes care of tying weights embeddings afterwards if the model class has a "),Nl=o("code"),Cb=r("tie_weights()"),Ib=r(" method."),Bb=l(),dn=o("div"),p(os.$$.fragment),Wb=l(),ss=o("p"),Ub=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
...
weights are discarded.`),Cy=l(),kd=o("p"),Iy=r("Examples:"),By=l(),p(Ts.$$.fragment),Wy=l(),Re=o("div"),p(js.$$.fragment),Uy=l(),xd=o("p"),Hy=r(`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),Vy=l(),p(yn.$$.fragment),Xy=l(),kn=o("div"),p($s.$$.fragment),Ry=l(),Ms=o("p"),Yy=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=o("code"),Ky=r("[from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Zy=r(" class method"),Jy=l(),Y=o("div"),p(Ps.$$.fragment),Qy=l(),se=o("p"),ek=r("Cast the floating-point "),Td=o("code"),tk=r("params"),nk=r(" to "),jd=o("code"),ok=r("jax.numpy.bfloat16"),sk=r(". This returns a new "),$d=o("code"),ak=r("params"),rk=r(` tree and does not cast
...
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),Mk=l(),Dd=o("p"),Pk=r("Examples:"),Ek=l(),p(qs.$$.fragment),Lk=l(),ue=o("div"),p(Fs.$$.fragment),qk=l(),re=o("p"),Fk=r("Cast the floating-point "),Ad=o("code"),Ok=r("parmas"),zk=r(" to "),Gd=o("code"),Dk=r("jax.numpy.float32"),Ak=r(`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=o("code"),Gk=r("params"),Sk=r(" tree and does not cast the "),Nd=o("code"),Nk=r("params"),Ck=r(" in place."),Ik=l(),Cd=o("p"),Bk=r("Examples:"),Wk=l(),p(Os.$$.fragment),np=l(),bt=o("h2"),xn=o("a"),Id=o("span"),p(zs.$$.fragment),Uk=l(),Bd=o("span"),Hk=r("Generation"),op=l(),P=o("div"),p(Ds.$$.fragment),Vk=l(),As=o("p"),Xk=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),Rk=r("PreTrainedModel"),Yk=r("."),Kk=l(),wn=o("div"),p(Gs.$$.fragment),Zk=l(),Ss=o("p"),Jk=r("Implement in subclasses of "),dr=o("a"),Qk=r("PreTrainedModel"),ex=r(" for custom behavior to adjust the logits in the generate method."),tx=l(),ge=o("div"),p(Ns.$$.fragment),nx=l(),Wd=o("p"),ox=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),sx=l(),Ud=o("p"),ax=r("Examples:"),rx=l(),p(Cs.$$.fragment),ix=l(),he=o("div"),p(Is.$$.fragment),lx=l(),Hd=o("p"),dx=r("Generates sequences for models with a language modeling head using beam search decoding."),cx=l(),Vd=o("p"),px=r("Examples:"),mx=l(),p(Bs.$$.fragment),ux=l(),Tn=o("div"),p(Ws.$$.fragment),gx=l(),Xd=o("p"),hx=r(`compute the transition probabilities of sequences given generation
...
post`),zx=r("."),Dx=l(),Jd=o("p"),Ax=r("Examples:"),Gx=l(),p(Ys.$$.fragment),Sx=l(),_e=o("div"),p(Ks.$$.fragment),Nx=l(),Qd=o("p"),Cx=r("Generates sequences for models with a language modeling head using greedy decoding."),Ix=l(),ec=o("p"),Bx=r("Examples:"),Wx=l(),p(Zs.$$.fragment),Ux=l(),be=o("div"),p(Js.$$.fragment),Hx=l(),tc=o("p"),Vx=r("Generates sequences for models with a language modeling head using beam search decoding."),Xx=l(),nc=o("p"),Rx=r("Examples:"),Yx=l(),p(Qs.$$.fragment),Kx=l(),jn=o("div"),p(ea.$$.fragment),Zx=l(),ta=o("p"),Jx=r("Implement in subclasses of "),pr=o("a"),Qx=r("PreTrainedModel"),ew=r(" for custom behavior to prepare inputs in the generate method."),tw=l(),ve=o("div"),p(na.$$.fragment),nw=l(),oc=o("p"),ow=r("Generates sequences for models with a language modeling head using multinomial sampling."),sw=l(),sc=o("p"),aw=r("Examples:"),rw=l(),p(oa.$$.fragment),sp=l(),G=o("div"),p(sa.$$.fragment),iw=l(),aa=o("p"),lw=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),dw=r("TFPreTrainedModel"),cw=r("."),pw=l(),$n=o("div"),p(ra.$$.fragment),mw=l(),ia=o("p"),uw=r("Implement in subclasses of "),ur=o("a"),gw=r("PreTrainedModel"),hw=r(" for custom behavior to adjust the logits in the generate method."),fw=l(),N=o("div"),p(la.$$.fragment),_w=l(),ac=o("p"),bw=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),vw=l(),da=o("p"),yw=r("Adapted in part from "),ca=o("a"),kw=r(`Facebook\u2019s XLM beam search
code`),xw=r("."),ww=l(),Ee=o("p"),Tw=r("Apart from "),rc=o("code"),jw=r("input_ids"),$w=r(" and "),ic=o("code"),Mw=r("attention_mask"),Pw=r(`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=o("a"),Ew=r("PretrainedConfig"),Lw=r(` of the model. The default values indicated are the default
values of those config.`),qw=l(),pa=o("p"),Fw=r("Most of these parameters are explained in more detail in "),ma=o("a"),Ow=r(`this blog
post`),zw=r("."),Dw=l(),lc=o("p"),Aw=r("Examples:"),Gw=l(),p(ua.$$.fragment),Sw=l(),ye=o("div"),p(ga.$$.fragment),Nw=l(),dc=o("p"),Cw=r("Generates sequences for models with a language modeling head using greedy decoding."),Iw=l(),cc=o("p"),Bw=r("Examples:"),Ww=l(),p(ha.$$.fragment),Uw=l(),Mn=o("div"),p(fa.$$.fragment),Hw=l(),_a=o("p"),Vw=r("Implement in subclasses of "),hr=o("a"),Xw=r("TFPreTrainedModel"),Rw=r(" for custom behavior to prepare inputs in the generate method."),Yw=l(),ke=o("div"),p(ba.$$.fragment),Kw=l(),pc=o("p"),Zw=r("Generates sequences for models with a language modeling head using multinomial sampling."),Jw=l(),mc=o("p"),Qw=r("Examples:"),e1=l(),p(va.$$.fragment),ap=l(),Le=o("div"),p(ya.$$.fragment),t1=l(),ka=o("p"),n1=r("A class containing all of the functions supporting generation, to be used as a mixin in "),fr=o("a"),o1=r("FlaxPreTrainedModel"),s1=r("."),a1=l(),H=o("div"),p(xa.$$.fragment),r1=l(),uc=o("p"),i1=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),l1=l(),yt=o("p"),d1=r("Apart from "),gc=o("code"),c1=r("input_ids"),p1=r(`, all the arguments below will default to the value of the attribute of the same name
inside the `),_r=o("a"),m1=r("PretrainedConfig"),u1=r(` of the model. The default values indicated are the default values of those
config.`),g1=l(),wa=o("p"),h1=r("Most of these parameters are explained in more detail in "),Ta=o("a"),f1=r(`this blog
post`),_1=r("."),b1=l(),hc=o("p"),v1=r("Examples:"),y1=l(),p(ja.$$.fragment),rp=l(),kt=o("h2"),Pn=o("a"),fc=o("span"),p($a.$$.fragment),k1=l(),_c=o("span"),x1=r("Pushing to the Hub"),ip=l(),qe=o("div"),p(Ma.$$.fragment),w1=l(),bc=o("p"),T1=r("A Mixin containing the functionality to push a model or tokenizer to the hub."),j1=l(),xe=o("div"),p(Pa.$$.fragment),$1=l(),Ea=o("p"),M1=r(`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vc=o("code"),P1=r("repo_path_or_name"),E1=r("."),L1=l(),yc=o("p"),q1=r("Examples:"),F1=l(),p(La.$$.fragment),this.h()},l(n){const b=cM('[data-svelte="svelte-1phssyn"]',document.head);x=s(b,"META",{name:!0,content:!0}),b.forEach(t),E=d(n),T=s(n,"H1",{class:!0});var qa=a(T);$=s(qa,"A",{id:!0,class:!0,href:!0});var kc=a($);te=s(kc,"SPAN",{});var xc=a(te);m(A.$$.fragment,xc),xc.forEach(t),kc.forEach(t),I=d(qa),Me=s(qa,"SPAN",{});var wc=a(Me);Am=i(wc,"Models"),wc.forEach(t),qa.forEach(t),Oc=d(n),ie=s(n,"P",{});var Fe=a(ie);Gm=i(Fe,"The base classes "),Aa=s(Fe,"A",{href:!0});var A1=a(Aa);Sm=i(A1,"PreTrainedModel"),A1.forEach(t),Nm=i(Fe,", "),Ga=s(Fe,"A",{href:!0});var G1=a(Ga);Cm=i(G1,"TFPreTrainedModel"),G1.forEach(t),Im=i(Fe,`, and
...
file or directory, or from a pretrained model configuration provided by the library (downloaded from HuggingFace\u2019s AWS
S3 repository).`),Fe.forEach(t),zc=d(n),nt=s(n,"P",{});var Tc=a(nt);Na=s(Tc,"A",{href:!0});var N1=a(Na);Um=i(N1,"PreTrainedModel"),N1.forEach(t),Hm=i(Tc," and "),Ca=s(Tc,"A",{href:!0});var C1=a(Ca);Vm=i(C1,"TFPreTrainedModel"),C1.forEach(t),Xm=i(Tc,` also implement a few methods which
are common among all the models to:`),Tc.forEach(t),Dc=d(n),wt=s(n,"UL",{});var dp=a(wt);Ir=s(dp,"LI",{});var I1=a(Ir);Rm=i(I1,"resize the input token embeddings when new tokens are added to the vocabulary"),I1.forEach(t),Ym=d(dp),Br=s(dp,"LI",{});var B1=a(Br);Km=i(B1,"prune the attention heads of the model."),B1.forEach(t),dp.forEach(t),Ac=d(n),B=s(n,"P",{});var we=a(B);Zm=i(we,"The other methods that are common to each model are defined in "),Ia=s(we,"A",{href:!0});var W1=a(Ia);Jm=i(W1,"ModuleUtilsMixin"),W1.forEach(t),Qm=i(we,`
...
`),Ua=s(we,"A",{href:!0});var X1=a(Ua);ru=i(X1,"FlaxGenerationMixin"),X1.forEach(t),iu=i(we," (for the Flax/JAX models)."),we.forEach(t),Gc=d(n),ot=s(n,"H2",{class:!0});var cp=a(ot);Tt=s(cp,"A",{id:!0,class:!0,href:!0});var R1=a(Tt);Ur=s(R1,"SPAN",{});var Y1=a(Ur);m(Hn.$$.fragment,Y1),Y1.forEach(t),R1.forEach(t),lu=d(cp),Hr=s(cp,"SPAN",{});var K1=a(Hr);du=i(K1,"PreTrainedModel"),K1.forEach(t),cp.forEach(t),Sc=d(n),w=s(n,"DIV",{class:!0});var j=a(w);m(Vn.$$.fragment,j),cu=d(j),Vr=s(j,"P",{});var Z1=a(Vr);pu=i(Z1,"Base class for all models."),Z1.forEach(t),mu=d(j),Ha=s(j,"P",{});var O1=a(Ha);Va=s(O1,"A",{href:!0});var J1=a(Va);uu=i(J1,"PreTrainedModel"),J1.forEach(t),gu=i(O1,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),O1.forEach(t),hu=d(j),Xn=s(j,"UL",{});var pp=a(Xn);Xr=s(pp,"LI",{});var Q1=a(Xr);fu=i(Q1,"resize the input embeddings,"),Q1.forEach(t),_u=d(pp),Rr=s(pp,"LI",{});var eT=a(Rr);bu=i(eT,"prune heads in the self-attention heads."),eT.forEach(t),pp.forEach(t),vu=d(j),Yr=s(j,"P",{});var tT=a(Yr);yu=i(tT,"Class attributes (overridden by derived classes):"),tT.forEach(t),ku=d(j),ne=s(j,"UL",{});var Ye=a(ne);Kr=s(Ye,"LI",{});var nT=a(Kr);Ae=s(nT,"P",{});var Fa=a(Ae);Zr=s(Fa,"STRONG",{});var oT=a(Zr);xu=i(oT,"config_class"),oT.forEach(t),wu=i(Fa," ("),Xa=s(Fa,"A",{href:!0});var sT=a(Xa);Tu=i(sT,"PretrainedConfig"),sT.forEach(t),ju=i(Fa,") \u2014 A subclass of "),Ra=s(Fa,"A",{href:!0});var aT=a(Ra);$u=i(aT,"PretrainedConfig"),aT.forEach(t),Mu=i(Fa,` to use as configuration class
...
taking as arguments:`),Oa.forEach(t),Du=d(mp),st=s(mp,"UL",{});var br=a(st);jt=s(br,"LI",{});var jc=a(jt);ti=s(jc,"STRONG",{});var dT=a(ti);Au=i(dT,"model"),dT.forEach(t),Gu=i(jc," ("),Ya=s(jc,"A",{href:!0});var cT=a(Ya);Su=i(cT,"PreTrainedModel"),cT.forEach(t),Nu=i(jc,") \u2014 An instance of the model on which to load the TensorFlow checkpoint."),jc.forEach(t),Cu=d(br),$t=s(br,"LI",{});var $c=a($t);ni=s($c,"STRONG",{});var pT=a(ni);Iu=i(pT,"config"),pT.forEach(t),Bu=i($c," ("),oi=s($c,"CODE",{});var mT=a(oi);Wu=i(mT,"PreTrainedConfig"),mT.forEach(t),Uu=i($c,") \u2014 An instance of the configuration associated to the model."),$c.forEach(t),Hu=d(br),Mt=s(br,"LI",{});var Mc=a(Mt);si=s(Mc,"STRONG",{});var uT=a(si);Vu=i(uT,"path"),uT.forEach(t),Xu=i(Mc," ("),ai=s(Mc,"CODE",{});var gT=a(ai);Ru=i(gT,"str"),gT.forEach(t),Yu=i(Mc,") \u2014 A path to the TensorFlow checkpoint."),Mc.forEach(t),br.forEach(t),mp.forEach(t),Ku=d(Ye),ri=s(Ye,"LI",{});var hT=a(ri);Pt=s(hT,"P",{});var Pc=a(Pt);ii=s(Pc,"STRONG",{});var fT=a(ii);Zu=i(fT,"base_model_prefix"),fT.forEach(t),Ju=i(Pc," ("),li=s(Pc,"CODE",{});var _T=a(li);Qu=i(_T,"str"),_T.forEach(t),eg=i(Pc,`) \u2014 A string indicating the attribute associated to the base model in derived
...
models, `),fi=s(Oe,"CODE",{});var jT=a(fi);ug=i(jT,"pixel_values"),jT.forEach(t),gg=i(Oe," for vision models and "),_i=s(Oe,"CODE",{});var $T=a(_i);hg=i($T,"input_values"),$T.forEach(t),fg=i(Oe," for speech models)."),Oe.forEach(t),kT.forEach(t),Ye.forEach(t),_g=d(j),le=s(j,"DIV",{class:!0});var En=a(le);m(Yn.$$.fragment,En),bg=d(En),Kn=s(En,"P",{});var up=a(Kn);vg=i(up,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),bi=s(up,"CODE",{});var MT=a(bi);yg=i(MT,"repo_path_or_name"),MT.forEach(t),kg=i(up,"."),up.forEach(t),xg=d(En),vi=s(En,"P",{});var PT=a(vi);wg=i(PT,"Examples:"),PT.forEach(t),Tg=d(En),m(Zn.$$.fragment,En),En.forEach(t),jg=d(j),z=s(j,"DIV",{class:!0});var C=a(z);m(Jn.$$.fragment,C),$g=d(C),yi=s(C,"P",{});var ET=a(yi);Mg=i(ET,"Instantiate a pretrained pytorch model from a pre-trained model configuration."),ET.forEach(t),Pg=d(C),at=s(C,"P",{});var vr=a(at);Eg=i(vr,"The model is set in evaluation mode by default using "),ki=s(vr,"CODE",{});var LT=a(ki);Lg=i(LT,"model.eval()"),LT.forEach(t),qg=i(vr,` (Dropout modules are deactivated). To train
the model, you should first set it back in training mode with `),xi=s(vr,"CODE",{});var qT=a(xi);Fg=i(qT,"model.train()"),qT.forEach(t),Og=i(vr,"."),vr.forEach(t),zg=d(C),Qn=s(C,"P",{});var gp=a(Qn);Dg=i(gp,"The warning "),wi=s(gp,"EM",{});var FT=a(wi);Ag=i(FT,"Weights from XXX not initialized from pretrained model"),FT.forEach(t),Gg=i(gp,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
weights are discarded.`),hp.forEach(t),Bg=d(C),m(Lt.$$.fragment,C),Wg=d(C),m(qt.$$.fragment,C),Ug=d(C),ji=s(C,"P",{});var zT=a(ji);Hg=i(zT,"Examples:"),zT.forEach(t),Vg=d(C),m(to.$$.fragment,C),C.forEach(t),Xg=d(j),Ft=s(j,"DIV",{class:!0});var fp=a(Ft);m(no.$$.fragment,fp),Rg=d(fp),$i=s(fp,"P",{});var DT=a($i);Yg=i(DT,"Returns the model\u2019s input embeddings."),DT.forEach(t),fp.forEach(t),Kg=d(j),Ot=s(j,"DIV",{class:!0});var _p=a(Ot);m(oo.$$.fragment,_p),Zg=d(_p),Mi=s(_p,"P",{});var AT=a(Mi);Jg=i(AT,"Returns the model\u2019s output embeddings."),AT.forEach(t),_p.forEach(t),Qg=d(j),Se=s(j,"DIV",{class:!0});var yr=a(Se);m(so.$$.fragment,yr),eh=d(yr),Pi=s(yr,"P",{});var GT=a(Pi);th=i(GT,"Deactivates gradient checkpointing for the current model."),GT.forEach(t),nh=d(yr),Ei=s(yr,"P",{});var ST=a(Ei);oh=i(ST,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
...
activations\u201D.`),CT.forEach(t),kr.forEach(t),dh=d(j),zt=s(j,"DIV",{class:!0});var bp=a(zt);m(ro.$$.fragment,bp),ch=d(bp),Fi=s(bp,"P",{});var IT=a(Fi);ph=i(IT,"If needed prunes and maybe initializes weights."),IT.forEach(t),bp.forEach(t),mh=d(j),Dt=s(j,"DIV",{class:!0});var vp=a(Dt);m(io.$$.fragment,vp),uh=d(vp),Oi=s(vp,"P",{});var BT=a(Oi);gh=i(BT,`A method executed at the end of each Transformer model initialization, to execute code that needs the model\u2019s
modules properly initialized (such as weight initialization).`),BT.forEach(t),vp.forEach(t),hh=d(j),At=s(j,"DIV",{class:!0});var yp=a(At);m(lo.$$.fragment,yp),fh=d(yp),zi=s(yp,"P",{});var WT=a(zi);_h=i(WT,"Prunes heads of the base model."),WT.forEach(t),yp.forEach(t),bh=d(j),Ce=s(j,"DIV",{class:!0});var xr=a(Ce);m(co.$$.fragment,xr),vh=d(xr),Di=s(xr,"P",{});var UT=a(Di);yh=i(UT,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),UT.forEach(t),kh=d(xr),m(Gt.$$.fragment,xr),xr.forEach(t),xh=d(j),Ie=s(j,"DIV",{class:!0});var wr=a(Ie);m(po.$$.fragment,wr),wh=d(wr),mo=s(wr,"P",{});var kp=a(mo);Th=i(kp,"Resizes input token embeddings matrix of the model if "),Ai=s(kp,"CODE",{});var HT=a(Ai);jh=i(HT,"new_num_tokens != config.vocab_size"),HT.forEach(t),$h=i(kp,"."),kp.forEach(t),Mh=d(wr),uo=s(wr,"P",{});var xp=a(uo);Ph=i(xp,"Takes care of tying weights embeddings afterwards if the model class has a "),Gi=s(xp,"CODE",{});var VT=a(Gi);Eh=i(VT,"tie_weights()"),VT.forEach(t),Lh=i(xp," method."),xp.forEach(t),wr.forEach(t),qh=d(j),St=s(j,"DIV",{class:!0});var wp=a(St);m(go.$$.fragment,wp),Fh=d(wp),ho=s(wp,"P",{});var Tp=a(ho);Oh=i(Tp,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=s(Tp,"CODE",{});var XT=a(Si);zh=i(XT,"[from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),XT.forEach(t),Dh=i(Tp," class method."),Tp.forEach(t),wp.forEach(t),Ah=d(j),Nt=s(j,"DIV",{class:!0});var jp=a(Nt);m(fo.$$.fragment,jp),Gh=d(jp),Ni=s(jp,"P",{});var RT=a(Ni);Sh=i(RT,"Set model\u2019s input embeddings."),RT.forEach(t),jp.forEach(t),Nh=d(j),Be=s(j,"DIV",{class:!0});var Tr=a(Be);m(_o.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var YT=a(Ci);Ih=i(YT,"Tie the weights between the input embeddings and the output embeddings."),YT.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var $p=a(bo);Wh=i($p,"If the "),Ii=s($p,"CODE",{});var KT=a(Ii);Uh=i(KT,"torchscript"),KT.forEach(t),Hh=i($p,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
weights instead.`),$p.forEach(t),Tr.forEach(t),j.forEach(t),Nc=d(n),Ka=s(n,"A",{id:!0}),a(Ka).forEach(t),Cc=d(n),rt=s(n,"H3",{class:!0});var Mp=a(rt);Ct=s(Mp,"A",{id:!0,class:!0,href:!0});var ZT=a(Ct);Bi=s(ZT,"SPAN",{});var JT=a(Bi);m(vo.$$.fragment,JT),JT.forEach(t),ZT.forEach(t),Vh=d(Mp),Wi=s(Mp,"SPAN",{});var QT=a(Wi);Xh=i(QT,"Model Instantiation dtype"),QT.forEach(t),Mp.forEach(t),Ic=d(n),de=s(n,"P",{});var Ln=a(de);Rh=i(Ln,"Under Pytorch a model normally gets instantiated with "),Ui=s(Ln,"CODE",{});var e2=a(Ui);Yh=i(e2,"torch.float32"),e2.forEach(t),Kh=i(Ln,` format. This can be an issue if one tries to
load a model whose weights are in fp16, since it\u2019d require twice as much memory. To overcome this limitation, you can
either explicitly pass the desired `),Hi=s(Ln,"CODE",{});var t2=a(Hi);Zh=i(t2,"dtype"),t2.forEach(t),Jh=i(Ln," using "),Vi=s(Ln,"CODE",{});var n2=a(Vi);Qh=i(n2,"torch_dtype"),n2.forEach(t),ef=i(Ln," argument:"),Ln.forEach(t),Bc=d(n),m(yo.$$.fragment,n),Wc=d(n),We=s(n,"P",{});var jr=a(We);tf=i(jr,"or, if you want the model to always load in the most optimal memory pattern, you can use the special value "),Xi=s(jr,"CODE",{});var o2=a(Xi);nf=i(o2,'"auto"'),o2.forEach(t),of=i(jr,`,
and then `),Ri=s(jr,"CODE",{});var s2=a(Ri);sf=i(s2,"dtype"),s2.forEach(t),af=i(jr," will be automatically derived from the model\u2019s weights:"),jr.forEach(t),Uc=d(n),m(ko.$$.fragment,n),Hc=d(n),It=s(n,"P",{});var Pp=a(It);rf=i(Pp,"Models instantiated from scratch can also be told which "),Yi=s(Pp,"CODE",{});var a2=a(Yi);lf=i(a2,"dtype"),a2.forEach(t),df=i(Pp," to use with:"),Pp.forEach(t),Vc=d(n),m(xo.$$.fragment,n),Xc=d(n),Za=s(n,"P",{});var r2=a(Za);cf=i(r2,"Due to Pytorch design, this functionality is only available for floating dtypes."),r2.forEach(t),Rc=d(n),it=s(n,"H2",{class:!0});var Ep=a(it);Bt=s(Ep,"A",{id:!0,class:!0,href:!0});var i2=a(Bt);Ki=s(i2,"SPAN",{});var l2=a(Ki);m(wo.$$.fragment,l2),l2.forEach(t),i2.forEach(t),pf=d(Ep),Zi=s(Ep,"SPAN",{});var d2=a(Zi);mf=i(d2,"ModuleUtilsMixin"),d2.forEach(t),Ep.forEach(t),Yc=d(n),L=s(n,"DIV",{class:!0});var D=a(L);m(To.$$.fragment,D),uf=d(D),jo=s(D,"P",{});var Lp=a(jo);gf=i(Lp,"A few utilities for "),Ji=s(Lp,"CODE",{});var c2=a(Ji);hf=i(c2,"torch.nn.Modules"),c2.forEach(t),ff=i(Lp,", to be used as a mixin."),Lp.forEach(t),_f=d(D),Ue=s(D,"DIV",{class:!0});var $r=a(Ue);m($o.$$.fragment,$r),bf=d($r),Qi=s($r,"P",{});var p2=a(Qi);vf=i(p2,"Add a memory hook before and after each sub-module forward pass to record increase in memory consumption."),p2.forEach(t),yf=d($r),lt=s($r,"P",{});var Mr=a(lt);kf=i(Mr,"Increase in memory consumption is stored in a "),el=s(Mr,"CODE",{});var m2=a(el);xf=i(m2,"mem_rss_diff"),m2.forEach(t),wf=i(Mr,` attribute for each module and can be reset to zero
with `),tl=s(Mr,"CODE",{});var u2=a(tl);Tf=i(u2,"model.reset_memory_hooks_state()"),u2.forEach(t),jf=i(Mr,"."),Mr.forEach(t),$r.forEach(t),$f=d(D),Wt=s(D,"DIV",{class:!0});var qp=a(Wt);m(Mo.$$.fragment,qp),Mf=d(qp),nl=s(qp,"P",{});var g2=a(nl);Pf=i(g2,"Helper function to estimate the total number of tokens from the model inputs."),g2.forEach(t),qp.forEach(t),Ef=d(D),Ut=s(D,"DIV",{class:!0});var Fp=a(Ut);m(Po.$$.fragment,Fp),Lf=d(Fp),dt=s(Fp,"P",{});var Pr=a(dt);qf=i(Pr,`Get number of (optionally, non-embeddings) floating-point operations for the forward and backward passes of a
batch with this transformer model. Default approximation neglects the quadratic dependency on the number of
tokens (valid if `),ol=s(Pr,"CODE",{});var h2=a(ol);Ff=i(h2,"12 * d_model << sequence_length"),h2.forEach(t),Of=i(Pr,") as laid out in "),Eo=s(Pr,"A",{href:!0,rel:!0});var f2=a(Eo);zf=i(f2,`this
paper`),f2.forEach(t),Df=i(Pr,` section 2.1. Should be overridden for transformers with parameter
re-use e.g. Albert or Universal Transformers, or if doing long-range modeling with very high sequence lengths.`),Pr.forEach(t),Fp.forEach(t),Af=d(D),Ht=s(D,"DIV",{class:!0});var Op=a(Ht);m(Lo.$$.fragment,Op),Gf=d(Op),sl=s(Op,"P",{});var _2=a(sl);Sf=i(_2,"Makes broadcastable attention and causal masks so that future and masked tokens are ignored."),_2.forEach(t),Op.forEach(t),Nf=d(D),Vt=s(D,"DIV",{class:!0});var zp=a(Vt);m(qo.$$.fragment,zp),Cf=d(zp),al=s(zp,"P",{});var b2=a(al);If=i(b2,"Prepare the head mask if needed."),b2.forEach(t),zp.forEach(t),Bf=d(D),Xt=s(D,"DIV",{class:!0});var Dp=a(Xt);m(Fo.$$.fragment,Dp),Wf=d(Dp),rl=s(Dp,"P",{});var v2=a(rl);Uf=i(v2,"Invert an attention mask (e.g., switches 0. and 1.)."),v2.forEach(t),Dp.forEach(t),Hf=d(D),Rt=s(D,"DIV",{class:!0});var Ap=a(Rt);m(Oo.$$.fragment,Ap),Vf=d(Ap),il=s(Ap,"P",{});var y2=a(il);Xf=i(y2,"Get number of (optionally, trainable or non-embeddings) parameters in the module."),y2.forEach(t),Ap.forEach(t),Rf=d(D),Yt=s(D,"DIV",{class:!0});var Gp=a(Yt);m(zo.$$.fragment,Gp),Yf=d(Gp),ct=s(Gp,"P",{});var Er=a(ct);Kf=i(Er,"Reset the "),ll=s(Er,"CODE",{});var k2=a(ll);Zf=i(k2,"mem_rss_diff"),k2.forEach(t),Jf=i(Er," attribute of each module (see "),Ja=s(Er,"A",{href:!0});var x2=a(Ja);Qf=i(x2,"add_memory_hooks()"),x2.forEach(t),e_=i(Er,")."),Er.forEach(t),Gp.forEach(t),D.forEach(t),Kc=d(n),pt=s(n,"H2",{class:!0});var Sp=a(pt);Kt=s(Sp,"A",{id:!0,class:!0,href:!0});var w2=a(Kt);dl=s(w2,"SPAN",{});var T2=a(dl);m(Do.$$.fragment,T2),T2.forEach(t),w2.forEach(t),t_=d(Sp),cl=s(Sp,"SPAN",{});var j2=a(cl);n_=i(j2,"TFPreTrainedModel"),j2.forEach(t),Sp.forEach(t),Zc=d(n),y=s(n,"DIV",{class:!0});var k=a(y);m(Ao.$$.fragment,k),o_=d(k),pl=s(k,"P",{});var $2=a(pl);s_=i($2,"Base class for all TF models."),$2.forEach(t),a_=d(k),Qa=s(k,"P",{});var z1=a(Qa);er=s(z1,"A",{href:!0});var M2=a(er);r_=i(M2,"TFPreTrainedModel"),M2.forEach(t),i_=i(z1,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),z1.forEach(t),l_=d(k),Go=s(k,"UL",{});var Np=a(Go);ml=s(Np,"LI",{});var P2=a(ml);d_=i(P2,"resize the input embeddings,"),P2.forEach(t),c_=d(Np),ul=s(Np,"LI",{});var E2=a(ul);p_=i(E2,"prune heads in the self-attention heads."),E2.forEach(t),Np.forEach(t),m_=d(k),gl=s(k,"P",{});var L2=a(gl);u_=i(L2,"Class attributes (overridden by derived classes):"),L2.forEach(t),g_=d(k),mt=s(k,"UL",{});var Lr=a(mt);He=s(Lr,"LI",{});var za=a(He);hl=s(za,"STRONG",{});var q2=a(hl);h_=i(q2,"config_class"),q2.forEach(t),f_=i(za," ("),tr=s(za,"A",{href:!0});var F2=a(tr);__=i(F2,"PretrainedConfig"),F2.forEach(t),b_=i(za,") \u2014 A subclass of "),nr=s(za,"A",{href:!0});var O2=a(nr);v_=i(O2,"PretrainedConfig"),O2.forEach(t),y_=i(za,` to use as configuration class
for this model architecture.`),za.forEach(t),k_=d(Lr),Zt=s(Lr,"LI",{});var Lc=a(Zt);fl=s(Lc,"STRONG",{});var z2=a(fl);x_=i(z2,"base_model_prefix"),z2.forEach(t),w_=i(Lc," ("),_l=s(Lc,"CODE",{});var D2=a(_l);T_=i(D2,"str"),D2.forEach(t),j_=i(Lc,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Lc.forEach(t),$_=d(Lr),X=s(Lr,"LI",{});var ze=a(X);bl=s(ze,"STRONG",{});var A2=a(bl);M_=i(A2,"main_input_name"),A2.forEach(t),P_=i(ze," ("),vl=s(ze,"CODE",{});var G2=a(vl);E_=i(G2,"str"),G2.forEach(t),L_=i(ze,") \u2014 The name of the principal input to the model (often "),yl=s(ze,"CODE",{});var S2=a(yl);q_=i(S2,"input_ids"),S2.forEach(t),F_=i(ze,` for NLP
models, `),kl=s(ze,"CODE",{});var N2=a(kl);O_=i(N2,"pixel_values"),N2.forEach(t),z_=i(ze," for vision models and "),xl=s(ze,"CODE",{});var C2=a(xl);D_=i(C2,"input_values"),C2.forEach(t),A_=i(ze," for speech models)."),ze.forEach(t),Lr.forEach(t),G_=d(k),ce=s(k,"DIV",{class:!0});var qn=a(ce);m(So.$$.fragment,qn),S_=d(qn),No=s(qn,"P",{});var Cp=a(No);N_=i(Cp,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),wl=s(Cp,"CODE",{});var I2=a(wl);C_=i(I2,"repo_path_or_name"),I2.forEach(t),I_=i(Cp,"."),Cp.forEach(t),B_=d(qn),Tl=s(qn,"P",{});var B2=a(Tl);W_=i(B2,"Examples:"),B2.forEach(t),U_=d(qn),m(Co.$$.fragment,qn),qn.forEach(t),H_=d(k),Jt=s(k,"DIV",{class:!0});var Ip=a(Jt);m(Io.$$.fragment,Ip),V_=d(Ip),jl=s(Ip,"P",{});var W2=a(jl);X_=i(W2,`This is a thin wrapper that sets the model\u2019s loss output head as the loss if the user does not specify a loss
function themselves.`),W2.forEach(t),Ip.forEach(t),R_=d(k),S=s(k,"DIV",{class:!0});var Z=a(S);m(Bo.$$.fragment,Z),Y_=d(Z),$l=s(Z,"P",{});var U2=a($l);K_=i(U2,"Instantiate a pretrained TF 2.0 model from a pre-trained model configuration."),U2.forEach(t),Z_=d(Z),Wo=s(Z,"P",{});var Bp=a(Wo);J_=i(Bp,"The warning "),Ml=s(Bp,"EM",{});var H2=a(Ml);Q_=i(H2,"Weights from XXX not initialized from pretrained model"),H2.forEach(t),eb=i(Bp,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var hj=a(Kl);Tv=i(hj,"data"),hj.forEach(t),jv=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var fj=a(Zl);$v=i(fj,"(inputs,)"),fj.forEach(t),Mv=i(Fr,"."),Fr.forEach(t),Pv=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);Ev=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var _j=a(Jl);Lv=i(_j,"loss"),_j.forEach(t),qv=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var bj=a(Ql);Fv=i(bj,"loss"),bj.forEach(t),Ov=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jc=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);fn=s(lm,"A",{id:!0,class:!0,href:!0});var vj=a(fn);ed=s(vj,"SPAN",{});var yj=a(ed);m(ms.$$.fragment,yj),yj.forEach(t),vj.forEach(t),zv=d(lm),td=s(lm,"SPAN",{});var kj=a(td);Dv=i(kj,"TFModelUtilsMixin"),kj.forEach(t),lm.forEach(t),Qc=d(n),Pe=s(n,"DIV",{class:!0});var zr=a(Pe);m(us.$$.fragment,zr),Av=d(zr),gs=s(zr,"P",{});var dm=a(gs);Gv=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var xj=a(nd);Sv=i(xj,"tf.keras.Model"),xj.forEach(t),Nv=i(dm,", to be used as a mixin."),dm.forEach(t),Cv=d(zr),_n=s(zr,"DIV",{class:!0});var cm=a(_n);m(hs.$$.fragment,cm),Iv=d(cm),od=s(cm,"P",{});var wj=a(od);Bv=i(wj,"Get the number of (optionally, trainable) parameters in the model."),wj.forEach(t),cm.forEach(t),zr.forEach(t),ep=d(n),ft=s(n,"H2",{class:!0});var pm=a(ft);bn=s(pm,"A",{id:!0,class:!0,href:!0});var Tj=a(bn);sd=s(Tj,"SPAN",{});var jj=a(sd);m(fs.$$.fragment,jj),jj.forEach(t),Tj.forEach(t),Wv=d(pm),ad=s(pm,"SPAN",{});var $j=a(ad);Uv=i($j,"FlaxPreTrainedModel"),$j.forEach(t),pm.forEach(t),tp=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(_s.$$.fragment,q),Hv=d(q),rd=s(q,"P",{});var Mj=a(rd);Vv=i(Mj,"Base class for all models."),Mj.forEach(t),Xv=d(q),sr=s(q,"P",{});var D1=a(sr);ar=s(D1,"A",{href:!0});var Pj=a(ar);Rv=i(Pj,"FlaxPreTrainedModel"),Pj.forEach(t),Yv=i(D1,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),D1.forEach(t),Kv=d(q),id=s(q,"P",{});var Ej=a(id);Zv=i(Ej,"Class attributes (overridden by derived classes):"),Ej.forEach(t),Jv=d(q),_t=s(q,"UL",{});var Dr=a(_t);Xe=s(Dr,"LI",{});var Da=a(Xe);ld=s(Da,"STRONG",{});var Lj=a(ld);Qv=i(Lj,"config_class"),Lj.forEach(t),ey=i(Da," ("),rr=s(Da,"A",{href:!0});var qj=a(rr);ty=i(qj,"PretrainedConfig"),qj.forEach(t),ny=i(Da,") \u2014 A subclass of "),ir=s(Da,"A",{href:!0});var Fj=a(ir);oy=i(Fj,"PretrainedConfig"),Fj.forEach(t),sy=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),ay=d(Dr),vn=s(Dr,"LI",{});var qc=a(vn);dd=s(qc,"STRONG",{});var Oj=a(dd);ry=i(Oj,"base_model_prefix"),Oj.forEach(t),iy=i(qc," ("),cd=s(qc,"CODE",{});var zj=a(cd);ly=i(zj,"str"),zj.forEach(t),dy=i(qc,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qc.forEach(t),cy=d(Dr),R=s(Dr,"LI",{});var De=a(R);pd=s(De,"STRONG",{});var Dj=a(pd);py=i(Dj,"main_input_name"),Dj.forEach(t),my=i(De," ("),md=s(De,"CODE",{});var Aj=a(md);uy=i(Aj,"str"),Aj.forEach(t),gy=i(De,") \u2014 The name of the principal input to the model (often "),ud=s(De,"CODE",{});var Gj=a(ud);hy=i(Gj,"input_ids"),Gj.forEach(t),fy=i(De,` for NLP
models, `),gd=s(De,"CODE",{});var Sj=a(gd);_y=i(Sj,"pixel_values"),Sj.forEach(t),by=i(De," for vision models and "),hd=s(De,"CODE",{});var Nj=a(hd);vy=i(Nj,"input_values"),Nj.forEach(t),yy=i(De," for speech models)."),De.forEach(t),Dr.forEach(t),ky=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),xy=d(On),vs=s(On,"P",{});var mm=a(vs);wy=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),fd=s(mm,"CODE",{});var Cj=a(fd);Ty=i(Cj,"repo_path_or_name"),Cj.forEach(t),jy=i(mm,"."),mm.forEach(t),$y=d(On),_d=s(On,"P",{});var Ij=a(_d);My=i(Ij,"Examples:"),Ij.forEach(t),Py=d(On),m(ys.$$.fragment,On),On.forEach(t),Ey=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Ly=d(Te),bd=s(Te,"P",{});var Bj=a(bd);qy=i(Bj,"Instantiate a pretrained flax model from a pre-trained model configuration."),Bj.forEach(t),Fy=d(Te),xs=s(Te,"P",{});var um=a(xs);Oy=i(um,"The warning "),vd=s(um,"EM",{});var Wj=a(vd);zy=i(Wj,"Weights from XXX not initialized from pretrained model"),Wj.forEach(t),Dy=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
library are already mapped with an auto class.`),Vj.forEach(t),Vy=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),Xy=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m($s.$$.fragment,hm),Ry=d(hm),Ms=s(hm,"P",{});var fm=a(Ms);Yy=i(fm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(fm,"CODE",{});var Xj=a(wd);Ky=i(Xj,"[from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Xj.forEach(t),Zy=i(fm," class method"),fm.forEach(t),hm.forEach(t),Jy=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qy=d(Ze),se=s(Ze,"P",{});var Je=a(se);ek=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var Rj=a(Td);tk=i(Rj,"params"),Rj.forEach(t),nk=i(Je," to "),jd=s(Je,"CODE",{});var Yj=a(jd);ok=i(Yj,"jax.numpy.bfloat16"),Yj.forEach(t),sk=i(Je,". This returns a new "),$d=s(Je,"CODE",{});var Kj=a($d);ak=i(Kj,"params"),Kj.forEach(t),rk=i(Je,` tree and does not cast
the `),Md=s(Je,"CODE",{});var Zj=a(Md);ik=i(Zj,"params"),Zj.forEach(t),lk=i(Je," in place."),Je.forEach(t),dk=d(Ze),Pd=s(Ze,"P",{});var Jj=a(Pd);ck=i(Jj,`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),Jj.forEach(t),pk=d(Ze),Ed=s(Ze,"P",{});var Qj=a(Ed);mk=i(Qj,"Examples:"),Qj.forEach(t),uk=d(Ze),m(Es.$$.fragment,Ze),Ze.forEach(t),gk=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Ls.$$.fragment,Qe),hk=d(Qe),ae=s(Qe,"P",{});var et=a(ae);fk=i(et,"Cast the floating-point "),Ld=s(et,"CODE",{});var e$=a(Ld);_k=i(e$,"parmas"),e$.forEach(t),bk=i(et," to "),qd=s(et,"CODE",{});var t$=a(qd);vk=i(t$,"jax.numpy.float16"),t$.forEach(t),yk=i(et,". This returns a new "),Fd=s(et,"CODE",{});var n$=a(Fd);kk=i(n$,"params"),n$.forEach(t),xk=i(et,` tree and does not cast the
...
post`),$$.forEach(t),zx=i(xm,"."),xm.forEach(t),Dx=d(je),Jd=s(je,"P",{});var M$=a(Jd);Ax=i(M$,"Examples:"),M$.forEach(t),Gx=d(je),m(Ys.$$.fragment,je),je.forEach(t),Sx=d(F),_e=s(F,"DIV",{class:!0});var Sn=a(_e);m(Ks.$$.fragment,Sn),Nx=d(Sn),Qd=s(Sn,"P",{});var P$=a(Qd);Cx=i(P$,"Generates sequences for models with a language modeling head using greedy decoding."),P$.forEach(t),Ix=d(Sn),ec=s(Sn,"P",{});var E$=a(ec);Bx=i(E$,"Examples:"),E$.forEach(t),Wx=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),Ux=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),Hx=d(Nn),tc=s(Nn,"P",{});var L$=a(tc);Vx=i(L$,"Generates sequences for models with a language modeling head using beam search decoding."),L$.forEach(t),Xx=d(Nn),nc=s(Nn,"P",{});var q$=a(nc);Rx=i(q$,"Examples:"),q$.forEach(t),Yx=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),Kx=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Zx=d(wm),ta=s(wm,"P",{});var Tm=a(ta);Jx=i(Tm,"Implement in subclasses of "),pr=s(Tm,"A",{href:!0});var F$=a(pr);Qx=i(F$,"PreTrainedModel"),F$.forEach(t),ew=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),tw=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),nw=d(Cn),oc=s(Cn,"P",{});var O$=a(oc);ow=i(O$,"Generates sequences for models with a language modeling head using multinomial sampling."),O$.forEach(t),sw=d(Cn),sc=s(Cn,"P",{});var z$=a(sc);aw=i(z$,"Examples:"),z$.forEach(t),rw=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sp=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),iw=d(J),aa=s(J,"P",{});var jm=a(aa);lw=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var D$=a(mr);dw=i(D$,"TFPreTrainedModel"),D$.forEach(t),cw=i(jm,"."),jm.forEach(t),pw=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),mw=d($m),ia=s($m,"P",{});var Mm=a(ia);uw=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var A$=a(ur);gw=i(A$,"PreTrainedModel"),A$.forEach(t),hw=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),fw=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),_w=d(Q),ac=s(Q,"P",{});var G$=a(ac);bw=i(G$,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),G$.forEach(t),vw=d(Q),da=s(Q,"P",{});var Pm=a(da);yw=i(Pm,"Adapted in part from "),ca=s(Pm,"A",{href:!0,rel:!0});var S$=a(ca);kw=i(S$,`Facebook\u2019s XLM beam search
code`),S$.forEach(t),xw=i(Pm,"."),Pm.forEach(t),ww=d(Q),Ee=s(Q,"P",{});var In=a(Ee);Tw=i(In,"Apart from "),rc=s(In,"CODE",{});var N$=a(rc);jw=i(N$,"input_ids"),N$.forEach(t),$w=i(In," and "),ic=s(In,"CODE",{});var C$=a(ic);Mw=i(C$,"attention_mask"),C$.forEach(t),Pw=i(In,`, all the arguments below will default to the value of the attribute
...
values of those config.`),In.forEach(t),qw=d(Q),pa=s(Q,"P",{});var Em=a(pa);Fw=i(Em,"Most of these parameters are explained in more detail in "),ma=s(Em,"A",{href:!0,rel:!0});var B$=a(ma);Ow=i(B$,`this blog
post`),B$.forEach(t),zw=i(Em,"."),Em.forEach(t),Dw=d(Q),lc=s(Q,"P",{});var W$=a(lc);Aw=i(W$,"Examples:"),W$.forEach(t),Gw=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),Sw=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),Nw=d(Bn),dc=s(Bn,"P",{});var U$=a(dc);Cw=i(U$,"Generates sequences for models with a language modeling head using greedy decoding."),U$.forEach(t),Iw=d(Bn),cc=s(Bn,"P",{});var H$=a(cc);Bw=i(H$,"Examples:"),H$.forEach(t),Ww=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),Uw=d(J),Mn=s(J,"DIV",{class:!0});var Lm=a(Mn);m(fa.$$.fragment,Lm),Hw=d(Lm),_a=s(Lm,"P",{});var qm=a(_a);Vw=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var V$=a(hr);Xw=i(V$,"TFPreTrainedModel"),V$.forEach(t),Rw=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Lm.forEach(t),Yw=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),Kw=d(Wn),pc=s(Wn,"P",{});var X$=a(pc);Zw=i(X$,"Generates sequences for models with a language modeling head using multinomial sampling."),X$.forEach(t),Jw=d(Wn),mc=s(Wn,"P",{});var R$=a(mc);Qw=i(R$,"Examples:"),R$.forEach(t),e1=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ap=d(n),Le=s(n,"DIV",{class:!0});var Sr=a(Le);m(ya.$$.fragment,Sr),t1=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);n1=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),fr=s(Fm,"A",{href:!0});var Y$=a(fr);o1=i(Y$,"FlaxPreTrainedModel"),Y$.forEach(t),s1=i(Fm,"."),Fm.forEach(t),a1=d(Sr),H=s(Sr,"DIV",{class:!0});var $e=a(H);m(xa.$$.fragment,$e),r1=d($e),uc=s($e,"P",{});var K$=a(uc);i1=i(K$,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),K$.forEach(t),l1=d($e),yt=s($e,"P",{});var Nr=a(yt);d1=i(Nr,"Apart from "),gc=s(Nr,"CODE",{});var Z$=a(gc);c1=i(Z$,"input_ids"),Z$.forEach(t),p1=i(Nr,`, all the arguments below will default to the value of the attribute of the same name
inside the `),_r=s(Nr,"A",{href:!0});var J$=a(_r);m1=i(J$,"PretrainedConfig"),J$.forEach(t),u1=i(Nr,` of the model. The default values indicated are the default values of those
config.`),Nr.forEach(t),g1=d($e),wa=s($e,"P",{});var Om=a(wa);h1=i(Om,"Most of these parameters are explained in more detail in "),Ta=s(Om,"A",{href:!0,rel:!0});var Q$=a(Ta);f1=i(Q$,`this blog
post`),Q$.forEach(t),_1=i(Om,"."),Om.forEach(t),b1=d($e),hc=s($e,"P",{});var eM=a(hc);v1=i(eM,"Examples:"),eM.forEach(t),y1=d($e),m(ja.$$.fragment,$e),$e.forEach(t),Sr.forEach(t),rp=d(n),kt=s(n,"H2",{class:!0});var zm=a(kt);Pn=s(zm,"A",{id:!0,class:!0,href:!0});var tM=a(Pn);fc=s(tM,"SPAN",{});var nM=a(fc);m($a.$$.fragment,nM),nM.forEach(t),tM.forEach(t),k1=d(zm),_c=s(zm,"SPAN",{});var oM=a(_c);x1=i(oM,"Pushing to the Hub"),oM.forEach(t),zm.forEach(t),ip=d(n),qe=s(n,"DIV",{class:!0});var Cr=a(qe);m(Ma.$$.fragment,Cr),w1=d(Cr),bc=s(Cr,"P",{});var sM=a(bc);T1=i(sM,"A Mixin containing the functionality to push a model or tokenizer to the hub."),sM.forEach(t),j1=d(Cr),xe=s(Cr,"DIV",{class:!0});var Un=a(xe);m(Pa.$$.fragment,Un),$1=d(Un),Ea=s(Un,"P",{});var Dm=a(Ea);M1=i(Dm,`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vc=s(Dm,"CODE",{});var aM=a(vc);P1=i(aM,"repo_path_or_name"),aM.forEach(t),E1=i(Dm,"."),Dm.forEach(t),L1=d(Un),yc=s(Un,"P",{});var rM=a(yc);q1=i(rM,"Examples:"),rM.forEach(t),F1=d(Un),m(La.$$.fragment,Un),Un.forEach(t),Cr.forEach(t),this.h()},h(){c(x,"name","hf:doc:metadata"),c(x,"content",JSON.stringify(_M)),c($,"id","models"),c($,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c($,"href","#models"),c(T,"class","relative group"),c(Aa,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Ga,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Sa,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Na,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Ca,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Ia,"href","/docs/transformers/master/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin"),c(Ba,"href","/docs/transformers/master/en/main_classes/model#transformers.generation_utils.GenerationMixin"),c(Wa,"href","/docs/transformers/master/en/main_classes/model#transformers.generation_tf_utils.TFGenerationMixin"),c(Ua,"href","/docs/transformers/master/en/main_classes/model#transformers.generation_flax_utils.FlaxGenerationMixin"),c(Tt,"id","transformers.PreTrainedModel"),c(Tt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Tt,"href","#transformers.PreTrainedModel"),c(ot,"class","relative group"),c(Va,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Xa,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ra,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ya,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(le,"class","docstring"),c(z,"class","docstring"),c(Ft,"class","docstring"),c(Ot,"class","docstring"),c(Se,"class","docstring"),c(Ne,"class","docstring"),c(zt,"class","docstring"),c(Dt,"class","docstring"),c(At,"class","docstring"),c(Ce,"class","docstring"),c(Ie,"class","docstring"),c(St,"class","docstring"),c(Nt,"class","docstring"),c(Be,"class","docstring"),c(w,"class","docstring"),c(Ka,"id","from_pretrained-torch-dtype"),c(Ct,"id","model-instantiation-dtype"),c(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ct,"href","#model-instantiation-dtype"),c(rt,"class","relative group"),c(Bt,"id","transformers.modeling_utils.ModuleUtilsMixin"),c(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Bt,"href","#transformers.modeling_utils.ModuleUtilsMixin"),c(it,"class","relative group"),c(Ue,"class","docstring"),c(Wt,"class","docstring"),c(Eo,"href","https://arxiv.org/pdf/2001.08361.pdf"),c(Eo,"rel","nofollow"),c(Ut,"class","docstring"),c(Ht,"class","docstring"),c(Vt,"class","docstring"),c(Xt,"class","docstring"),c(Rt,"class","docstring"),c(Ja,"href","/docs/transformers/master/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin.add_memory_hooks"),c(Yt,"class","docstring"),c(L,"class","docstring"),c(Kt,"id","transformers.TFPreTrainedModel"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#transformers.TFPreTrainedModel"),c(pt,"class","relative group"),c(er,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(tr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(nr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(ce,"class","docstring"),c(Jt,"class","docstring"),c(S,"class","docstring"),c(en,"class","docstring"),c(tn,"class","docstring"),c(nn,"class","docstring"),c(on,"class","docstring"),c(sn,"class","docstring"),c(an,"class","docstring"),c(rn,"class","docstring"),c(ln,"class","docstring"),c(Ve,"class","docstring"),c(or,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained"),c(dn,"class","docstring"),c(cn,"class","docstring"),c(pn,"class","docstring"),c(mn,"class","docstring"),c(un,"class","docstring"),c(gn,"class","docstring"),c(hn,"class","docstring"),c(pe,"class","docstring"),c(y,"class","docstring"),c(fn,"id","transformers.modeling_tf_utils.TFModelUtilsMixin"),c(fn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(fn,"href","#transformers.modeling_tf_utils.TFModelUtilsMixin"),c(ht,"class","relative group"),c(_n,"class","docstring"),c(Pe,"class","docstring"),c(bn,"id","transformers.FlaxPreTrainedModel"),c(bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(bn,"href","#transformers.FlaxPreTrainedModel"),c(ft,"class","relative group"),c(ar,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(rr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(ir,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(me,"class","docstring"),c(W,"class","docstring"),c(Re,"class","docstring"),c(kn,"class","docstring"),c(Y,"class","docstring"),c(K,"class","docstring"),c(ue,"class","docstring"),c(M,"class","docstring"),c(xn,"id","transformers.generation_utils.GenerationMixin"),c(xn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xn,"href","#transformers.generation_utils.GenerationMixin"),c(bt,"class","relative group"),c(lr,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(dr,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(wn,"class","docstring"),c(ge,"class","docstring"),c(he,"class","docstring"),c(Tn,"class","docstring"),c(fe,"class","docstring"),c(cr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Rs,"href","https://huggingface.co/blog/how-to-generate"),c(Rs,"rel","nofollow"),c(U,"class","docstring"),c(_e,"class","docstring"),c(be,"class","docstring"),c(pr,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(jn,"class","docstring"),c(ve,"class","docstring"),c(P,"class","docstring"),c(mr,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(ur,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c($n,"class","docstring"),c(ca,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),c(ca,"rel","nofollow"),c(gr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(ma,"href","https://huggingface.co/blog/how-to-generate"),c(ma,"rel","nofollow"),c(N,"class","docstring"),c(ye,"class","docstring"),c(hr,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Mn,"class","docstring"),c(ke,"class","docstring"),c(G,"class","docstring"),c(fr,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(_r,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ta,"href","https://huggingface.co/blog/how-to-generate"),c(Ta,"rel","nofollow"),c(H,"class","docstring"),c(Le,"class","docstring"),c(Pn,"id","transformers.file_utils.PushToHubMixin"),c(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pn,"href","#transformers.file_utils.PushToHubMixin"),c(kt,"class","relative group"),c(xe,"class","docstring"),c(qe,"class","docstring")},m(n,b){e(document.head,x),v(n,E,b),v(n,T,b),e(T,$),e($,te),u(A,te,null),e(T,I),e(T,Me),e(Me,Am),v(n,Oc,b),v(n,ie,b),e(ie,Gm),e(ie,Aa),e(Aa,Sm),e(ie,Nm),e(ie,Ga),e(Ga,Cm),e(ie,Im),e(ie,Sa),e(Sa,Bm),e(ie,Wm),v(n,zc,b),v(n,nt,b),e(nt,Na),e(Na,Um),e(nt,Hm),e(nt,Ca),e(Ca,Vm),e(nt,Xm),v(n,Dc,b),v(n,wt,b),e(wt,Ir),e(Ir,Rm),e(wt,Ym),e(wt,Br),e(Br,Km),v(n,Ac,b),v(n,B,b),e(B,Zm),e(B,Ia),e(Ia,Jm),e(B,Qm),e(B,Wr),e(Wr,eu),e(B,tu),e(B,Ba),e(Ba,nu),e(B,ou),e(B,Wa),e(Wa,su),e(B,au),e(B,Ua),e(Ua,ru),e(B,iu),v(n,Gc,b),v(n,ot,b),e(ot,Tt),e(Tt,Ur),u(Hn,Ur,null),e(ot,lu),e(ot,Hr),e(Hr,du),v(n,Sc,b),v(n,w,b),u(Vn,w,null),e(w,cu),e(w,Vr),e(Vr,pu),e(w,mu),e(w,Ha),e(Ha,Va),e(Va,uu),e(Ha,gu),e(w,hu),e(w,Xn),e(Xn,Xr),e(Xr,fu),e(Xn,_u),e(Xn,Rr),e(Rr,bu),e(w,vu),e(w,Yr),e(Yr,yu),e(w,ku),e(w,ne),e(ne,Kr),e(Kr,Ae),e(Ae,Zr),e(Zr,xu),e(Ae,wu),e(Ae,Xa),e(Xa,Tu),e(Ae,ju),e(Ae,Ra),e(Ra,$u),e(Ae,Mu),e(ne,Pu),e(ne,Rn),e(Rn,Ge),e(Ge,Jr),e(Jr,Eu),e(Ge,Lu),e(Ge,Qr),e(Qr,qu),e(Ge,Fu),e(Ge,ei),e(ei,Ou),e(Ge,zu),e(Rn,Du),e(Rn,st),e(st,jt),e(jt,ti),e(ti,Au),e(jt,Gu),e(jt,Ya),e(Ya,Su),e(jt,Nu),e(st,Cu),e(st,$t),e($t,ni),e(ni,Iu),e($t,Bu),e($t,oi),e(oi,Wu),e($t,Uu),e(st,Hu),e(st,Mt),e(Mt,si),e(si,Vu),e(Mt,Xu),e(Mt,ai),e(ai,Ru),e(Mt,Yu),e(ne,Ku),e(ne,ri),e(ri,Pt),e(Pt,ii),e(ii,Zu),e(Pt,Ju),e(Pt,li),e(li,Qu),e(Pt,eg),e(ne,tg),e(ne,di),e(di,Et),e(Et,ci),e(ci,ng),e(Et,og),e(Et,pi),e(pi,sg),e(Et,ag),e(ne,rg),e(ne,mi),e(mi,V),e(V,ui),e(ui,ig),e(V,lg),e(V,gi),e(gi,dg),e(V,cg),e(V,hi),e(hi,pg),e(V,mg),e(V,fi),e(fi,ug),e(V,gg),e(V,_i),e(_i,hg),e(V,fg),e(w,_g),e(w,le),u(Yn,le,null),e(le,bg),e(le,Kn),e(Kn,vg),e(Kn,bi),e(bi,yg),e(Kn,kg),e(le,xg),e(le,vi),e(vi,wg),e(le,Tg),u(Zn,le,null),e(w,jg),e(w,z),u(Jn,z,null),e(z,$g),e(z,yi),e(yi,Mg),e(z,Pg),e(z,at),e(at,Eg),e(at,ki),e(ki,Lg),e(at,qg),e(at,xi),e(xi,Fg),e(at,Og),e(z,zg),e(z,Qn),e(Qn,Dg),e(Qn,wi),e(wi,Ag),e(Qn,Gg),e(z,Sg),e(z,eo),e(eo,Ng),e(eo,Ti),e(Ti,Cg),e(eo,Ig),e(z,Bg),u(Lt,z,null),e(z,Wg),u(qt,z,null),e(z,Ug),e(z,ji),e(ji,Hg),e(z,Vg),u(to,z,null),e(w,Xg),e(w,Ft),u(no,Ft,null),e(Ft,Rg),e(Ft,$i),e($i,Yg),e(w,Kg),e(w,Ot),u(oo,Ot,null),e(Ot,Zg),e(Ot,Mi),e(Mi,Jg),e(w,Qg),e(w,Se),u(so,Se,null),e(Se,eh),e(Se,Pi),e(Pi,th),e(Se,nh),e(Se,Ei),e(Ei,oh),e(w,sh),e(w,Ne),u(ao,Ne,null),e(Ne,ah),e(Ne,Li),e(Li,rh),e(Ne,ih),e(Ne,qi),e(qi,lh),e(w,dh),e(w,zt),u(ro,zt,null),e(zt,ch),e(zt,Fi),e(Fi,ph),e(w,mh),e(w,Dt),u(io,Dt,null),e(Dt,uh),e(Dt,Oi),e(Oi,gh),e(w,hh),e(w,At),u(lo,At,null),e(At,fh),e(At,zi),e(zi,_h),e(w,bh),e(w,Ce),u(co,Ce,null),e(Ce,vh),e(Ce,Di),e(Di,yh),e(Ce,kh),u(Gt,Ce,null),e(w,xh),e(w,Ie),u(po,Ie,null),e(Ie,wh),e(Ie,mo),e(mo,Th),e(mo,Ai),e(Ai,jh),e(mo,$h),e(Ie,Mh),e(Ie,uo),e(uo,Ph),e(uo,Gi),e(Gi,Eh),e(uo,Lh),e(w,qh),e(w,St),u(go,St,null),e(St,Fh),e(St,ho),e(ho,Oh),e(ho,Si),e(Si,zh),e(ho,Dh),e(w,Ah),e(w,Nt),u(fo,Nt,null),e(Nt,Gh),e(Nt,Ni),e(Ni,Sh),e(w,Nh),e(w,Be),u(_o,Be,null),e(Be,Ch),e(Be,Ci),e(Ci,Ih),e(Be,Bh),e(Be,bo),e(bo,Wh),e(bo,Ii),e(Ii,Uh),e(bo,Hh),v(n,Nc,b),v(n,Ka,b),v(n,Cc,b),v(n,rt,b),e(rt,Ct),e(Ct,Bi),u(vo,Bi,null),e(rt,Vh),e(rt,Wi),e(Wi,Xh),v(n,Ic,b),v(n,de,b),e(de,Rh),e(de,Ui),e(Ui,Yh),e(de,Kh),e(de,Hi),e(Hi,Zh),e(de,Jh),e(de,Vi),e(Vi,Qh),e(de,ef),v(n,Bc,b),u(yo,n,b),v(n,Wc,b),v(n,We,b),e(We,tf),e(We,Xi),e(Xi,nf),e(We,of),e(We,Ri),e(Ri,sf),e(We,af),v(n,Uc,b),u(ko,n,b),v(n,Hc,b),v(n,It,b),e(It,rf),e(It,Yi),e(Yi,lf),e(It,df),v(n,Vc,b),u(xo,n,b),v(n,Xc,b),v(n,Za,b),e(Za,cf),v(n,Rc,b),v(n,it,b),e(it,Bt),e(Bt,Ki),u(wo,Ki,null),e(it,pf),e(it,Zi),e(Zi,mf),v(n,Yc,b),v(n,L,b),u(To,L,null),e(L,uf),e(L,jo),e(jo,gf),e(jo,Ji),e(Ji,hf),e(jo,ff),e(L,_f),e(L,Ue),u($o,Ue,null),e(Ue,bf),e(Ue,Qi),e(Qi,vf),e(Ue,yf),e(Ue,lt),e(lt,kf),e(lt,el),e(el,xf),e(lt,wf),e(lt,tl),e(tl,Tf),e(lt,jf),e(L,$f),e(L,Wt),u(Mo,Wt,null),e(Wt,Mf),e(Wt,nl),e(nl,Pf),e(L,Ef),e(L,Ut),u(Po,Ut,null),e(Ut,Lf),e(Ut,dt),e(dt,qf),e(dt,ol),e(ol,Ff),e(dt,Of),e(dt,Eo),e(Eo,zf),e(dt,Df),e(L,Af),e(L,Ht),u(Lo,Ht,null),e(Ht,Gf),e(Ht,sl),e(sl,Sf),e(L,Nf),e(L,Vt),u(qo,Vt,null),e(Vt,Cf),e(Vt,al),e(al,If),e(L,Bf),e(L,Xt),u(Fo,Xt,null),e(Xt,Wf),e(Xt,rl),e(rl,Uf),e(L,Hf),e(L,Rt),u(Oo,Rt,null),e(Rt,Vf),e(Rt,il),e(il,Xf),e(L,Rf),e(L,Yt),u(zo,Yt,null),e(Yt,Yf),e(Yt,ct),e(ct,Kf),e(ct,ll),e(ll,Zf),e(ct,Jf),e(ct,Ja),e(Ja,Qf),e(ct,e_),v(n,Kc,b),v(n,pt,b),e(pt,Kt),e(Kt,dl),u(Do,dl,null),e(pt,t_),e(pt,cl),e(cl,n_),v(n,Zc,b),v(n,y,b),u(Ao,y,null),e(y,o_),e(y,pl),e(pl,s_),e(y,a_),e(y,Qa),e(Qa,er),e(er,r_),e(Qa,i_),e(y,l_),e(y,Go),e(Go,ml),e(ml,d_),e(Go,c_),e(Go,ul),e(ul,p_),e(y,m_),e(y,gl),e(gl,u_),e(y,g_),e(y,mt),e(mt,He),e(He,hl),e(hl,h_),e(He,f_),e(He,tr),e(tr,__),e(He,b_),e(He,nr),e(nr,v_),e(He,y_),e(mt,k_),e(mt,Zt),e(Zt,fl),e(fl,x_),e(Zt,w_),e(Zt,_l),e(_l,T_),e(Zt,j_),e(mt,$_),e(mt,X),e(X,bl),e(bl,M_),e(X,P_),e(X,vl),e(vl,E_),e(X,L_),e(X,yl),e(yl,q_),e(X,F_),e(X,kl),e(kl,O_),e(X,z_),e(X,xl),e(xl,D_),e(X,A_),e(y,G_),e(y,ce),u(So,ce,null),e(ce,S_),e(ce,No),e(No,N_),e(No,wl),e(wl,C_),e(No,I_),e(ce,B_),e(ce,Tl),e(Tl,W_),e(ce,U_),u(Co,ce,null),e(y,H_),e(y,Jt),u(Io,Jt,null),e(Jt,V_),e(Jt,jl),e(jl,X_),e(y,R_),e(y,S),u(Bo,S,null),e(S,Y_),e(S,$l),e($l,K_),e(S,Z_),e(S,Wo),e(Wo,J_),e(Wo,Ml),e(Ml,Q_),e(Wo,eb),e(S,tb),e(S,Uo),e(Uo,nb),e(Uo,Pl),e(Pl,ob),e(Uo,sb),e(S,ab),u(Qt,S,null),e(S,rb),e(S,El),e(El,ib),e(S,lb),u(Ho,S,null),e(y,db),e(y,en),u(Vo,en,null),e(en,cb),e(en,Ll),e(Ll,pb),e(y,mb),e(y,tn),u(Xo,tn,null),e(tn,ub),e(tn,ql),e(ql,gb),e(y,hb),e(y,nn),u(Ro,nn,null),e(nn,fb),e(nn,Fl),e(Fl,_b),e(y,bb),e(y,on),u(Yo,on,null),e(on,vb),e(on,Ol),e(Ol,yb),e(y,kb),e(y,sn),u(Ko,sn,null),e(sn,xb),e(sn,zl),e(zl,wb),e(y,Tb),e(y,an),u(Zo,an,null),e(an,jb),e(an,Dl),e(Dl,$b),e(y,Mb),e(y,rn),u(Jo,rn,null),e(rn,Pb),e(rn,Al),e(Al,Eb),e(y,Lb),e(y,ln),u(Qo,ln,null),e(ln,qb),e(ln,Gl),e(Gl,Fb),e(y,Ob),e(y,Ve),u(es,Ve,null),e(Ve,zb),e(Ve,ts),e(ts,Db),e(ts,Sl),e(Sl,Ab),e(ts,Gb),e(Ve,Sb),e(Ve,ns),e(ns,Nb),e(ns,Nl),e(Nl,Cb),e(ns,Ib),e(y,Bb),e(y,dn),u(os,dn,null),e(dn,Wb),e(dn,ss),e(ss,Ub),e(ss,or),e(or,Hb),e(ss,Vb),e(y,Xb),e(y,cn),u(as,cn,null),e(cn,Rb),e(cn,Cl),e(Cl,Yb),e(y,Kb),e(y,pn),u(rs,pn,null),e(pn,Zb),e(pn,Il),e(Il,Jb),e(y,Qb),e(y,mn),u(is,mn,null),e(mn,ev),e(mn,Bl),e(Bl,tv),e(y,nv),e(y,un),u(ls,un,null),e(un,ov),e(un,Wl),e(Wl,sv),e(y,av),e(y,gn),u(ds,gn,null),e(gn,rv),e(gn,Ul),e(Ul,iv),e(y,lv),e(y,hn),u(cs,hn,null),e(hn,dv),e(hn,Hl),e(Hl,cv),e(y,pv),e(y,pe),u(ps,pe,null),e(pe,mv),e(pe,oe),e(oe,uv),e(oe,Vl),e(Vl,gv),e(oe,hv),e(oe,Xl),e(Xl,fv),e(oe,_v),e(oe,Rl),e(Rl,bv),e(oe,vv),e(oe,Yl),e(Yl,yv),e(oe,kv),e(pe,xv),e(pe,ut),e(ut,wv),e(ut,Kl),e(Kl,Tv),e(ut,jv),e(ut,Zl),e(Zl,$v),e(ut,Mv),e(pe,Pv),e(pe,gt),e(gt,Ev),e(gt,Jl),e(Jl,Lv),e(gt,qv),e(gt,Ql),e(Ql,Fv),e(gt,Ov),v(n,Jc,b),v(n,ht,b),e(ht,fn),e(fn,ed),u(ms,ed,null),e(ht,zv),e(ht,td),e(td,Dv),v(n,Qc,b),v(n,Pe,b),u(us,Pe,null),e(Pe,Av),e(Pe,gs),e(gs,Gv),e(gs,nd),e(nd,Sv),e(gs,Nv),e(Pe,Cv),e(Pe,_n),u(hs,_n,null),e(_n,Iv),e(_n,od),e(od,Bv),v(n,ep,b),v(n,ft,b),e(ft,bn),e(bn,sd),u(fs,sd,null),e(ft,Wv),e(ft,ad),e(ad,Uv),v(n,tp,b),v(n,M,b),u(_s,M,null),e(M,Hv),e(M,rd),e(rd,Vv),e(M,Xv),e(M,sr),e(sr,ar),e(ar,Rv),e(sr,Yv),e(M,Kv),e(M,id),e(id,Zv),e(M,Jv),e(M,_t),e(_t,Xe),e(Xe,ld),e(ld,Qv),e(Xe,ey),e(Xe,rr),e(rr,ty),e(Xe,ny),e(Xe,ir),e(ir,oy),e(Xe,sy),e(_t,ay),e(_t,vn),e(vn,dd),e(dd,ry),e(vn,iy),e(vn,cd),e(cd,ly),e(vn,dy),e(_t,cy),e(_t,R),e(R,pd),e(pd,py),e(R,my),e(R,md),e(md,uy),e(R,gy),e(R,ud),e(ud,hy),e(R,fy),e(R,gd),e(gd,_y),e(R,by),e(R,hd),e(hd,vy),e(R,yy),e(M,ky),e(M,me),u(bs,me,null),e(me,xy),e(me,vs),e(vs,wy),e(vs,fd),e(fd,Ty),e(vs,jy),e(me,$y),e(me,_d),e(_d,My),e(me,Py),u(ys,me,null),e(M,Ey),e(M,W),u(ks,W,null),e(W,Ly),e(W,bd),e(bd,qy),e(W,Fy),e(W,xs),e(xs,Oy),e(xs,vd),e(vd,zy),e(xs,Dy),e(W,Ay),e(W,ws),e(ws,Gy),e(ws,yd),e(yd,Sy),e(ws,Ny),e(W,Cy),e(W,kd),e(kd,Iy),e(W,By),u(Ts,W,null),e(M,Wy),e(M,Re),u(js,Re,null),e(Re,Uy),e(Re,xd),e(xd,Hy),e(Re,Vy),u(yn,Re,null),e(M,Xy),e(M,kn),u($s,kn,null),e(kn,Ry),e(kn,Ms),e(Ms,Yy),e(Ms,wd),e(wd,Ky),e(Ms,Zy),e(M,Jy),e(M,Y),u(Ps,Y,null),e(Y,Qy),e(Y,se),e(se,ek),e(se,Td),e(Td,tk),e(se,nk),e(se,jd),e(jd,ok),e(se,sk),e(se,$d),e($d,ak),e(se,rk),e(se,Md),e(Md,ik),e(se,lk),e(Y,dk),e(Y,Pd),e(Pd,ck),e(Y,pk),e(Y,Ed),e(Ed,mk),e(Y,uk),u(Es,Y,null),e(M,gk),e(M,K),u(Ls,K,null),e(K,hk),e(K,ae),e(ae,fk),e(ae,Ld),e(Ld,_k),e(ae,bk),e(ae,qd),e(qd,vk),e(ae,yk),e(ae,Fd),e(Fd,kk),e(ae,xk),e(ae,Od),e(Od,wk),e(ae,Tk),e(K,jk),e(K,zd),e(zd,$k),e(K,Mk),e(K,Dd),e(Dd,Pk),e(K,Ek),u(qs,K,null),e(M,Lk),e(M,ue),u(Fs,ue,null),e(ue,qk),e(ue,re),e(re,Fk),e(re,Ad),e(Ad,Ok),e(re,zk),e(re,Gd),e(Gd,Dk),e(re,Ak),e(re,Sd),e(Sd,Gk),e(re,Sk),e(re,Nd),e(Nd,Nk),e(re,Ck),e(ue,Ik),e(ue,Cd),e(Cd,Bk),e(ue,Wk),u(Os,ue,null),v(n,np,b),v(n,bt,b),e(bt,xn),e(xn,Id),u(zs,Id,null),e(bt,Uk),e(bt,Bd),e(Bd,Hk),v(n,op,b),v(n,P,b),u(Ds,P,null),e(P,Vk),e(P,As),e(As,Xk),e(As,lr),e(lr,Rk),e(As,Yk),e(P,Kk),e(P,wn),u(Gs,wn,null),e(wn,Zk),e(wn,Ss),e(Ss,Jk),e(Ss,dr),e(dr,Qk),e(Ss,ex),e(P,tx),e(P,ge),u(Ns,ge,null),e(ge,nx),e(ge,Wd),e(Wd,ox),e(ge,sx),e(ge,Ud),e(Ud,ax),e(ge,rx),u(Cs,ge,null),e(P,ix),e(P,he),u(Is,he,null),e(he,lx),e(he,Hd),e(Hd,dx),e(he,cx),e(he,Vd),e(Vd,px),e(he,mx),u(Bs,he,null),e(P,ux),e(P,Tn),u(Ws,Tn,null),e(Tn,gx),e(Tn,Xd),e(Xd,hx),e(P,fx),e(P,fe),u(Us,fe,null),e(fe,_x),e(fe,Rd),e(Rd,bx),e(fe,vx),e(fe,Yd),e(Yd,yx),e(fe,kx),u(Hs,fe,null),e(P,xx),e(P,U),u(Vs,U,null),e(U,wx),e(U,Kd),e(Kd,Tx),e(U,jx),e(U,vt),e(vt,$x),e(vt,Zd),e(Zd,Mx),e(vt,Px),e(vt,cr),e(cr,Ex),e(vt,Lx),e(U,qx),e(U,Xs),e(Xs,Fx),e(Xs,Rs),e(Rs,Ox),e(Xs,zx),e(U,Dx),e(U,Jd),e(Jd,Ax),e(U,Gx),u(Ys,U,null),e(P,Sx),e(P,_e),u(Ks,_e,null),e(_e,Nx),e(_e,Qd),e(Qd,Cx),e(_e,Ix),e(_e,ec),e(ec,Bx),e(_e,Wx),u(Zs,_e,null),e(P,Ux),e(P,be),u(Js,be,null),e(be,Hx),e(be,tc),e(tc,Vx),e(be,Xx),e(be,nc),e(nc,Rx),e(be,Yx),u(Qs,be,null),e(P,Kx),e(P,jn),u(ea,jn,null),e(jn,Zx),e(jn,ta),e(ta,Jx),e(ta,pr),e(pr,Qx),e(ta,ew),e(P,tw),e(P,ve),u(na,ve,null),e(ve,nw),e(ve,oc),e(oc,ow),e(ve,sw),e(ve,sc),e(sc,aw),e(ve,rw),u(oa,ve,null),v(n,sp,b),v(n,G,b),u(sa,G,null),e(G,iw),e(G,aa),e(aa,lw),e(aa,mr),e(mr,dw),e(aa,cw),e(G,pw),e(G,$n),u(ra,$n,null),e($n,mw),e($n,ia),e(ia,uw),e(ia,ur),e(ur,gw),e(ia,hw),e(G,fw),e(G,N),u(la,N,null),e(N,_w),e(N,ac),e(ac,bw),e(N,vw),e(N,da),e(da,yw),e(da,ca),e(ca,kw),e(da,xw),e(N,ww),e(N,Ee),e(Ee,Tw),e(Ee,rc),e(rc,jw),e(Ee,$w),e(Ee,ic),e(ic,Mw),e(Ee,Pw),e(Ee,gr),e(gr,Ew),e(Ee,Lw),e(N,qw),e(N,pa),e(pa,Fw),e(pa,ma),e(ma,Ow),e(pa,zw),e(N,Dw),e(N,lc),e(lc,Aw),e(N,Gw),u(ua,N,null),e(G,Sw),e(G,ye),u(ga,ye,null),e(ye,Nw),e(ye,dc),e(dc,Cw),e(ye,Iw),e(ye,cc),e(cc,Bw),e(ye,Ww),u(ha,ye,null),e(G,Uw),e(G,Mn),u(fa,Mn,null),e(Mn,Hw),e(Mn,_a),e(_a,Vw),e(_a,hr),e(hr,Xw),e(_a,Rw),e(G,Yw),e(G,ke),u(ba,ke,null),e(ke,Kw),e(ke,pc),e(pc,Zw),e(ke,Jw),e(ke,mc),e(mc,Qw),e(ke,e1),u(va,ke,null),v(n,ap,b),v(n,Le,b),u(ya,Le,null),e(Le,t1),e(Le,ka),e(ka,n1),e(ka,fr),e(fr,o1),e(ka,s1),e(Le,a1),e(Le,H),u(xa,H,null),e(H,r1),e(H,uc),e(uc,i1),e(H,l1),e(H,yt),e(yt,d1),e(yt,gc),e(gc,c1),e(yt,p1),e(yt,_r),e(_r,m1),e(yt,u1),e(H,g1),e(H,wa),e(wa,h1),e(wa,Ta),e(Ta,f1),e(wa,_1),e(H,b1),e(H,hc),e(hc,v1),e(H,y1),u(ja,H,null),v(n,rp,b),v(n,kt,b),e(kt,Pn),e(Pn,fc),u($a,fc,null),e(kt,k1),e(kt,_c),e(_c,x1),v(n,ip,b),v(n,qe,b),u(Ma,qe,null),e(qe,w1),e(qe,bc),e(bc,T1),e(qe,j1),e(qe,xe),u(Pa,xe,null),e(xe,$1),e(xe,Ea),e(Ea,M1),e(Ea,vc),e(vc,P1),e(Ea,E1),e(xe,L1),e(xe,yc),e(yc,q1),e(xe,F1),u(La,xe,null),lp=!0},p(n,[b]){const qa={};b&2&&(qa.$$scope={dirty:b,ctx:n}),Lt.$set(qa);const kc={};b&2&&(kc.$$scope={dirty:b,ctx:n}),qt.$set(kc);const xc={};b&2&&(xc.$$scope={dirty:b,ctx:n}),Gt.$set(xc);const wc={};b&2&&(wc.$$scope={dirty:b,ctx:n}),Qt.$set(wc);const Fe={};b&2&&(Fe.$$scope={dirty:b,ctx:n}),yn.$set(Fe)},i(n){lp||(g(A.$$.fragment,n),g(Hn.$$.fragment,n),g(Vn.$$.fragment,n),g(Yn.$$.fragment,n),g(Zn.$$.fragment,n),g(Jn.$$.fragment,n),g(Lt.$$.fragment,n),g(qt.$$.fragment,n),g(to.$$.fragment,n),g(no.$$.fragment,n),g(oo.$$.fragment,n),g(so.$$.fragment,n),g(ao.$$.fragment,n),g(ro.$$.fragment,n),g(io.$$.fragment,n),g(lo.$$.fragment,n),g(co.$$.fragment,n),g(Gt.$$.fragment,n),g(po.$$.fragment,n),g(go.$$.fragment,n),g(fo.$$.fragment,n),g(_o.$$.fragment,n),g(vo.$$.fragment,n),g(yo.$$.fragment,n),g(ko.$$.fragment,n),g(xo.$$.fragment,n),g(wo.$$.fragment,n),g(To.$$.fragment,n),g($o.$$.fragment,n),g(Mo.$$.fragment,n),g(Po.$$.fragment,n),g(Lo.$$.fragment,n),g(qo.$$.fragment,n),g(Fo.$$.fragment,n),g(Oo.$$.fragment,n),g(zo.$$.fragment,n),g(Do.$$.fragment,n),g(Ao.$$.fragment,n),g(So.$$.fragment,n),g(Co.$$.fragment,n),g(Io.$$.fragment,n),g(Bo.$$.fragment,n),g(Qt.$$.fragment,n),g(Ho.$$.fragment,n),g(Vo.$$.fragment,n),g(Xo.$$.fragment,n),g(Ro.$$.fragment,n),g(Yo.$$.fragment,n),g(Ko.$$.fragment,n),g(Zo.$$.fragment,n),g(Jo.$$.fragment,n),g(Qo.$$.fragment,n),g(es.$$.fragment,n),g(os.$$.fragment,n),g(as.$$.fragment,n),g(rs.$$.fragment,n),g(is.$$.fragment,n),g(ls.$$.fragment,n),g(ds.$$.fragment,n),g(cs.$$.fragment,n),g(ps.$$.fragment,n),g(ms.$$.fragment,n),g(us.$$.fragment,n),g(hs.$$.fragment,n),g(fs.$$.fragment,n),g(_s.$$.fragment,n),g(bs.$$.fragment,n),g(ys.$$.fragment,n),g(ks.$$.fragment,n),g(Ts.$$.fragment,n),g(js.$$.fragment,n),g(yn.$$.fragment,n),g($s.$$.fragment,n),g(Ps.$$.fragment,n),g(Es.$$.fragment,n),g(Ls.$$.fragment,n),g(qs.$$.fragment,n),g(Fs.$$.fragment,n),g(Os.$$.fragment,n),g(zs.$$.fragment,n),g(Ds.$$.fragment,n),g(Gs.$$.fragment,n),g(Ns.$$.fragment,n),g(Cs.$$.fragment,n),g(Is.$$.fragment,n),g(Bs.$$.fragment,n),g(Ws.$$.fragment,n),g(Us.$$.fragment,n),g(Hs.$$.fragment,n),g(Vs.$$.fragment,n),g(Ys.$$.fragment,n),g(Ks.$$.fragment,n),g(Zs.$$.fragment,n),g(Js.$$.fragment,n),g(Qs.$$.fragment,n),g(ea.$$.fragment,n),g(na.$$.fragment,n),g(oa.$$.fragment,n),g(sa.$$.fragment,n),g(ra.$$.fragment,n),g(la.$$.fragment,n),g(ua.$$.fragment,n),g(ga.$$.fragment,n),g(ha.$$.fragment,n),g(fa.$$.fragment,n),g(ba.$$.fragment,n),g(va.$$.fragment,n),g(ya.$$.fragment,n),g(xa.$$.fragment,n),g(ja.$$.fragment,n),g($a.$$.fragment,n),g(Ma.$$.fragment,n),g(Pa.$$.fragment,n),g(La.$$.fragment,n),lp=!0)},o(n){h(A.$$.fragment,n),h(Hn.$$.fragment,n),h(Vn.$$.fragment,n),h(Yn.$$.fragment,n),h(Zn.$$.fragment,n),h(Jn.$$.fragment,n),h(Lt.$$.fragment,n),h(qt.$$.fragment,n),h(to.$$.fragment,n),h(no.$$.fragment,n),h(oo.$$.fragment,n),h(so.$$.fragment,n),h(ao.$$.fragment,n),h(ro.$$.fragment,n),h(io.$$.fragment,n),h(lo.$$.fragment,n),h(co.$$.fragment,n),h(Gt.$$.fragment,n),h(po.$$.fragment,n),h(go.$$.fragment,n),h(fo.$$.fragment,n),h(_o.$$.fragment,n),h(vo.$$.fragment,n),h(yo.$$.fragment,n),h(ko.$$.fragment,n),h(xo.$$.fragment,n),h(wo.$$.fragment,n),h(To.$$.fragment,n),h($o.$$.fragment,n),h(Mo.$$.fragment,n),h(Po.$$.fragment,n),h(Lo.$$.fragment,n),h(qo.$$.fragment,n),h(Fo.$$.fragment,n),h(Oo.$$.fragment,n),h(zo.$$.fragment,n),h(Do.$$.fragment,n),h(Ao.$$.fragment,n),h(So.$$.fragment,n),h(Co.$$.fragment,n),h(Io.$$.fragment,n),h(Bo.$$.fragment,n),h(Qt.$$.fragment,n),h(Ho.$$.fragment,n),h(Vo.$$.fragment,n),h(Xo.$$.fragment,n),h(Ro.$$.fragment,n),h(Yo.$$.fragment,n),h(Ko.$$.fragment,n),h(Zo.$$.fragment,n),h(Jo.$$.fragment,n),h(Qo.$$.fragment,n),h(es.$$.fragment,n),h(os.$$.fragment,n),h(as.$$.fragment,n),h(rs.$$.fragment,n),h(is.$$.fragment,n),h(ls.$$.fragment,n),h(ds.$$.fragment,n),h(cs.$$.fragment,n),h(ps.$$.fragment,n),h(ms.$$.fragment,n),h(us.$$.fragment,n),h(hs.$$.fragment,n),h(fs.$$.fragment,n),h(_s.$$.fragment,n),h(bs.$$.fragment,n),h(ys.$$.fragment,n),h(ks.$$.fragment,n),h(Ts.$$.fragment,n),h(js.$$.fragment,n),h(yn.$$.fragment,n),h($s.$$.fragment,n),h(Ps.$$.fragment,n),h(Es.$$.fragment,n),h(Ls.$$.fragment,n),h(qs.$$.fragment,n),h(Fs.$$.fragment,n),h(Os.$$.fragment,n),h(zs.$$.fragment,n),h(Ds.$$.fragment,n),h(Gs.$$.fragment,n),h(Ns.$$.fragment,n),h(Cs.$$.fragment,n),h(Is.$$.fragment,n),h(Bs.$$.fragment,n),h(Ws.$$.fragment,n),h(Us.$$.fragment,n),h(Hs.$$.fragment,n),h(Vs.$$.fragment,n),h(Ys.$$.fragment,n),h(Ks.$$.fragment,n),h(Zs.$$.fragment,n),h(Js.$$.fragment,n),h(Qs.$$.fragment,n),h(ea.$$.fragment,n),h(na.$$.fragment,n),h(oa.$$.fragment,n),h(sa.$$.fragment,n),h(ra.$$.fragment,n),h(la.$$.fragment,n),h(ua.$$.fragment,n),h(ga.$$.fragment,n),h(ha.$$.fragment,n),h(fa.$$.fragment,n),h(ba.$$.fragment,n),h(va.$$.fragment,n),h(ya.$$.fragment,n),h(xa.$$.fragment,n),h(ja.$$.fragment,n),h($a.$$.fragment,n),h(Ma.$$.fragment,n),h(Pa.$$.fragment,n),h(La.$$.fragment,n),lp=!1},d(n){t(x),n&&t(E),n&&t(T),f(A),n&&t(Oc),n&&t(ie),n&&t(zc),n&&t(nt),n&&t(Dc),n&&t(wt),n&&t(Ac),n&&t(B),n&&t(Gc),n&&t(ot),f(Hn),n&&t(Sc),n&&t(w),f(Vn),f(Yn),f(Zn),f(Jn),f(Lt),f(qt),f(to),f(no),f(oo),f(so),f(ao),f(ro),f(io),f(lo),f(co),f(Gt),f(po),f(go),f(fo),f(_o),n&&t(Nc),n&&t(Ka),n&&t(Cc),n&&t(rt),f(vo),n&&t(Ic),n&&t(de),n&&t(Bc),f(yo,n),n&&t(Wc),n&&t(We),n&&t(Uc),f(ko,n),n&&t(Hc),n&&t(It),n&&t(Vc),f(xo,n),n&&t(Xc),n&&t(Za),n&&t(Rc),n&&t(it),f(wo),n&&t(Yc),n&&t(L),f(To),f($o),f(Mo),f(Po),f(Lo),f(qo),f(Fo),f(Oo),f(zo),n&&t(Kc),n&&t(pt),f(Do),n&&t(Zc),n&&t(y),f(Ao),f(So),f(Co),f(Io),f(Bo),f(Qt),f(Ho),f(Vo),f(Xo),f(Ro),f(Yo),f(Ko),f(Zo),f(Jo),f(Qo),f(es),f(os),f(as),f(rs),f(is),f(ls),f(ds),f(cs),f(ps),n&&t(Jc),n&&t(ht),f(ms),n&&t(Qc),n&&t(Pe),f(us),f(hs),n&&t(ep),n&&t(ft),f(fs),n&&t(tp),n&&t(M),f(_s),f(bs),f(ys),f(ks),f(Ts),f(js),f(yn),f($s),f(Ps),f(Es),f(Ls),f(qs),f(Fs),f(Os),n&&t(np),n&&t(bt),f(zs),n&&t(op),n&&t(P),f(Ds),f(Gs),f(Ns),f(Cs),f(Is),f(Bs),f(Ws),f(Us),f(Hs),f(Vs),f(Ys),f(Ks),f(Zs),f(Js),f(Qs),f(ea),f(na),f(oa),n&&t(sp),n&&t(G),f(sa),f(ra),f(la),f(ua),f(ga),f(ha),f(fa),f(ba),f(va),n&&t(ap),n&&t(Le),f(ya),f(xa),f(ja),n&&t(rp),n&&t(kt),f($a),n&&t(ip),n&&t(qe),f(Ma),f(Pa),f(La)}}}const _M={local:"models",sections:[{local:"transformers.PreTrainedModel",sections:[{local:"model-instantiation-dtype",title:"Model Instantiation dtype"}],title:"PreTrainedModel"},{local:"transformers.modeling_utils.ModuleUtilsMixin",title:"ModuleUtilsMixin"},{local:"transformers.TFPreTrainedModel",title:"TFPreTrainedModel"},{local:"transformers.modeling_tf_utils.TFModelUtilsMixin",title:"TFModelUtilsMixin"},{local:"transformers.FlaxPreTrainedModel",title:"FlaxPreTrainedModel"},{local:"transformers.generation_utils.GenerationMixin",title:"Generation"},{local:"transformers.file_utils.PushToHubMixin",title:"Pushing to the Hub"}],title:"Models"};function bM(ee,x,E){let{fw:T}=x;return ee.$$set=$=>{"fw"in $&&E(0,T=$.fw)},[T]}class jM extends iM{constructor(x){super();lM(this,x,bM,fM,dM,{fw:0})}}export{jM as default,_M as metadata};
