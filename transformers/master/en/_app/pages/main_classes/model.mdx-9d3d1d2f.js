import{S as iM,i as lM,s as dM,e as o,k as l,w as p,t as r,M as cM,c as s,d as t,m as d,a,x as m,h as i,b as c,F as e,g as v,y as u,q as g,o as h,B as f}from"../../chunks/vendor-4833417e.js";import{T as Fc}from"../../chunks/Tip-fffd6df1.js";import{D as _}from"../../chunks/Docstring-7b52c3d4.js";import{C as O}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function pM(ee){let x,E;return{c(){x=o("p"),E=r("Passing `use_auth_token=True\u201C is required when you want to use a private model.")},l(T){x=s(T,"P",{});var j=a(x);E=i(j,"Passing `use_auth_token=True\u201C is required when you want to use a private model."),j.forEach(t)},m(T,j){v(T,x,j),e(x,E)},d(T){T&&t(x)}}}function mM(ee){let x,E,T,j,te;return{c(){x=o("p"),E=r("Activate the special "),T=o("a"),j=r("\u201Coffline-mode\u201D"),te=r(` to
...
</ul>`,name:"config"}]}}),Lt=new Fc({props:{$$slots:{default:[pM]},$$scope:{ctx:ee}}}),qt=new Fc({props:{$$slots:{default:[mM]},$$scope:{ctx:ee}}}),to=new O({props:{codee:`from transformers import BertConfig, BertModel
...
</ul>`,name:"config"}]}}),Qt=new Fc({props:{$$slots:{default:[gM]},$$scope:{ctx:ee}}}),Ho=new O({props:{codee:`from transformers import BertConfig, TFBertModel
...
`}}),Xo=new _({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new _({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new _({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new _({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new _({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
An instance of <a href="/docs/transformers/master/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/master/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/master/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
An instance of <a href="/docs/transformers/master/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/master/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/master/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/master/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),Dh=r("[from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),zh=r(" class method."),Ah=l(),Nt=o("div"),p(fo.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),p(_o.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
`),wd=o("code"),Ky=r("[from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Zy=r(" class method"),Jy=l(),Y=o("div"),p(Ps.$$.fragment),Qy=l(),se=o("p"),ek=r("Cast the floating-point "),Td=o("code"),tk=r("params"),nk=r(" to "),$d=o("code"),ok=r("jax.numpy.bfloat16"),sk=r(". This returns a new "),jd=o("code"),ak=r("params"),rk=r(` tree and does not cast
the `),Md=o("code"),ik=r("params"),lk=r(" in place."),dk=l(),Pd=o("p"),ck=r(`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),pk=l(),Ed=o("p"),mk=r("Examples:"),uk=l(),p(Es.$$.fragment),gk=l(),K=o("div"),p(Ls.$$.fragment),hk=l(),ae=o("p"),fk=r("Cast the floating-point "),Ld=o("code"),_k=r("parmas"),bk=r(" to "),qd=o("code"),vk=r("jax.numpy.float16"),yk=r(". This returns a new "),Fd=o("code"),kk=r("params"),xk=r(` tree and does not cast the
`),Od=o("code"),wk=r("params"),Tk=r(" in place."),$k=l(),Dd=o("p"),jk=r(`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),Mk=l(),zd=o("p"),Pk=r("Examples:"),Ek=l(),p(qs.$$.fragment),Lk=l(),ue=o("div"),p(Fs.$$.fragment),qk=l(),re=o("p"),Fk=r("Cast the floating-point "),Ad=o("code"),Ok=r("parmas"),Dk=r(" to "),Gd=o("code"),zk=r("jax.numpy.float32"),Ak=r(`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=o("code"),Gk=r("params"),Sk=r(" tree and does not cast the "),Nd=o("code"),Nk=r("params"),Ck=r(" in place."),Ik=l(),Cd=o("p"),Bk=r("Examples:"),Wk=l(),p(Os.$$.fragment),np=l(),bt=o("h2"),xn=o("a"),Id=o("span"),p(Ds.$$.fragment),Uk=l(),Bd=o("span"),Hk=r("Generation"),op=l(),P=o("div"),p(zs.$$.fragment),Vk=l(),As=o("p"),Xk=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),Rk=r("PreTrainedModel"),Yk=r("."),Kk=l(),wn=o("div"),p(Gs.$$.fragment),Zk=l(),Ss=o("p"),Jk=r("Implement in subclasses of "),dr=o("a"),Qk=r("PreTrainedModel"),ex=r(" for custom behavior to adjust the logits in the generate method."),tx=l(),ge=o("div"),p(Ns.$$.fragment),nx=l(),Wd=o("p"),ox=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),sx=l(),Ud=o("p"),ax=r("Examples:"),rx=l(),p(Cs.$$.fragment),ix=l(),he=o("div"),p(Is.$$.fragment),lx=l(),Hd=o("p"),dx=r("Generates sequences for models with a language modeling head using beam search decoding."),cx=l(),Vd=o("p"),px=r("Examples:"),mx=l(),p(Bs.$$.fragment),ux=l(),Tn=o("div"),p(Ws.$$.fragment),gx=l(),Xd=o("p"),hx=r(`compute the transition probabilities of sequences given generation
scores and beam indices`),fx=l(),fe=o("div"),p(Us.$$.fragment),_x=l(),Rd=o("p"),bx=r("Generates sequences for models with a language modeling head using beam search decoding."),vx=l(),Yd=o("p"),yx=r("Examples:"),kx=l(),p(Hs.$$.fragment),xx=l(),U=o("div"),p(Vs.$$.fragment),wx=l(),Kd=o("p"),Tx=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),$x=l(),vt=o("p"),jx=r("Apart from "),Zd=o("code"),Mx=r("inputs"),Px=r(`, all the arguments below will default to the value of the attribute of the same name inside
the `),cr=o("a"),Ex=r("PretrainedConfig"),Lx=r(" of the model. The default values indicated are the default values of those config."),qx=l(),Xs=o("p"),Fx=r("Most of these parameters are explained in more detail in "),Rs=o("a"),Ox=r(`this blog
post`),Dx=r("."),zx=l(),Jd=o("p"),Ax=r("Examples:"),Gx=l(),p(Ys.$$.fragment),Sx=l(),_e=o("div"),p(Ks.$$.fragment),Nx=l(),Qd=o("p"),Cx=r("Generates sequences for models with a language modeling head using greedy decoding."),Ix=l(),ec=o("p"),Bx=r("Examples:"),Wx=l(),p(Zs.$$.fragment),Ux=l(),be=o("div"),p(Js.$$.fragment),Hx=l(),tc=o("p"),Vx=r("Generates sequences for models with a language modeling head using beam search decoding."),Xx=l(),nc=o("p"),Rx=r("Examples:"),Yx=l(),p(Qs.$$.fragment),Kx=l(),$n=o("div"),p(ea.$$.fragment),Zx=l(),ta=o("p"),Jx=r("Implement in subclasses of "),pr=o("a"),Qx=r("PreTrainedModel"),e1=r(" for custom behavior to prepare inputs in the generate method."),t1=l(),ve=o("div"),p(na.$$.fragment),n1=l(),oc=o("p"),o1=r("Generates sequences for models with a language modeling head using multinomial sampling."),s1=l(),sc=o("p"),a1=r("Examples:"),r1=l(),p(oa.$$.fragment),sp=l(),G=o("div"),p(sa.$$.fragment),i1=l(),aa=o("p"),l1=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),d1=r("TFPreTrainedModel"),c1=r("."),p1=l(),jn=o("div"),p(ra.$$.fragment),m1=l(),ia=o("p"),u1=r("Implement in subclasses of "),ur=o("a"),g1=r("PreTrainedModel"),h1=r(" for custom behavior to adjust the logits in the generate method."),f1=l(),N=o("div"),p(la.$$.fragment),_1=l(),ac=o("p"),b1=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),v1=l(),da=o("p"),y1=r("Adapted in part from "),ca=o("a"),k1=r(`Facebook\u2019s XLM beam search
code`),x1=r("."),w1=l(),Ee=o("p"),T1=r("Apart from "),rc=o("code"),$1=r("input_ids"),j1=r(" and "),ic=o("code"),M1=r("attention_mask"),P1=r(`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=o("a"),E1=r("PretrainedConfig"),L1=r(` of the model. The default values indicated are the default
values of those config.`),q1=l(),pa=o("p"),F1=r("Most of these parameters are explained in more detail in "),ma=o("a"),O1=r(`this blog
post`),D1=r("."),z1=l(),lc=o("p"),A1=r("Examples:"),G1=l(),p(ua.$$.fragment),S1=l(),ye=o("div"),p(ga.$$.fragment),N1=l(),dc=o("p"),C1=r("Generates sequences for models with a language modeling head using greedy decoding."),I1=l(),cc=o("p"),B1=r("Examples:"),W1=l(),p(ha.$$.fragment),U1=l(),Mn=o("div"),p(fa.$$.fragment),H1=l(),_a=o("p"),V1=r("Implement in subclasses of "),hr=o("a"),X1=r("TFPreTrainedModel"),R1=r(" for custom behavior to prepare inputs in the generate method."),Y1=l(),ke=o("div"),p(ba.$$.fragment),K1=l(),pc=o("p"),Z1=r("Generates sequences for models with a language modeling head using multinomial sampling."),J1=l(),mc=o("p"),Q1=r("Examples:"),ew=l(),p(va.$$.fragment),ap=l(),Le=o("div"),p(ya.$$.fragment),tw=l(),ka=o("p"),nw=r("A class containing all of the functions supporting generation, to be used as a mixin in "),fr=o("a"),ow=r("FlaxPreTrainedModel"),sw=r("."),aw=l(),H=o("div"),p(xa.$$.fragment),rw=l(),uc=o("p"),iw=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
`),Si=s(Tp,"CODE",{});var XT=a(Si);Dh=i(XT,"[from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),XT.forEach(t),zh=i(Tp," class method."),Tp.forEach(t),wp.forEach(t),Ah=d($),Nt=s($,"DIV",{class:!0});var $p=a(Nt);m(fo.$$.fragment,$p),Gh=d($p),Ni=s($p,"P",{});var RT=a(Ni);Sh=i(RT,"Set model\u2019s input embeddings."),RT.forEach(t),$p.forEach(t),Nh=d($),Be=s($,"DIV",{class:!0});var Tr=a(Be);m(_o.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var YT=a(Ci);Ih=i(YT,"Tie the weights between the input embeddings and the output embeddings."),YT.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var jp=a(bo);Wh=i(jp,"If the "),Ii=s(jp,"CODE",{});var KT=a(Ii);Uh=i(KT,"torchscript"),KT.forEach(t),Hh=i(jp,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
embeddings`),J2.forEach(t),Rp.forEach(t),Tb=d(k),an=s(k,"DIV",{class:!0});var Yp=a(an);m(Zo.$$.fragment,Yp),$b=d(Yp),zl=s(Yp,"P",{});var Q2=a(zl);jb=i(Q2,"Get the concatenated _prefix name of the bias from the model name to the parent layer"),Q2.forEach(t),Yp.forEach(t),Mb=d(k),rn=s(k,"DIV",{class:!0});var Kp=a(rn);m(Jo.$$.fragment,Kp),Pb=d(Kp),Al=s(Kp,"P",{});var e$=a(Al);Eb=i(e$,`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),e$.forEach(t),Kp.forEach(t),Lb=d(k),ln=s(k,"DIV",{class:!0});var Zp=a(ln);m(Qo.$$.fragment,Zp),qb=d(Zp),Gl=s(Zp,"P",{});var t$=a(Gl);Fb=i(t$,"Prunes heads of the base model."),t$.forEach(t),Zp.forEach(t),Ob=d(k),Ve=s(k,"DIV",{class:!0});var qr=a(Ve);m(es.$$.fragment,qr),Db=d(qr),ts=s(qr,"P",{});var Jp=a(ts);zb=i(Jp,"Resizes input token embeddings matrix of the model if "),Sl=s(Jp,"CODE",{});var n$=a(Sl);Ab=i(n$,"new_num_tokens != config.vocab_size"),n$.forEach(t),Gb=i(Jp,"."),Jp.forEach(t),Sb=d(qr),ns=s(qr,"P",{});var Qp=a(ns);Nb=i(Qp,"Takes care of tying weights embeddings afterwards if the model class has a "),Nl=s(Qp,"CODE",{});var o$=a(Nl);Cb=i(o$,"tie_weights()"),o$.forEach(t),Ib=i(Qp," method."),Qp.forEach(t),qr.forEach(t),Bb=d(k),dn=s(k,"DIV",{class:!0});var em=a(dn);m(os.$$.fragment,em),Wb=d(em),ss=s(em,"P",{});var tm=a(ss);Ub=i(tm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),or=s(tm,"A",{href:!0});var s$=a(or);Hb=i(s$,"from_pretrained()"),s$.forEach(t),Vb=i(tm," class method."),tm.forEach(t),em.forEach(t),Xb=d(k),cn=s(k,"DIV",{class:!0});var nm=a(cn);m(as.$$.fragment,nm),Rb=d(nm),Cl=s(nm,"P",{});var a$=a(Cl);Yb=i(a$,"Method used for serving the model."),a$.forEach(t),nm.forEach(t),Kb=d(k),pn=s(k,"DIV",{class:!0});var om=a(pn);m(rs.$$.fragment,om),Zb=d(om),Il=s(om,"P",{});var r$=a(Il);Jb=i(r$,"Prepare the output of the saved model. Each model must implement this function."),r$.forEach(t),om.forEach(t),Qb=d(k),mn=s(k,"DIV",{class:!0});var sm=a(mn);m(is.$$.fragment,sm),ev=d(sm),Bl=s(sm,"P",{});var i$=a(Bl);tv=i(i$,"Set all the bias in the LM head."),i$.forEach(t),sm.forEach(t),nv=d(k),un=s(k,"DIV",{class:!0});var am=a(un);m(ls.$$.fragment,am),ov=d(am),Wl=s(am,"P",{});var l$=a(Wl);sv=i(l$,"Set model\u2019s input embeddings"),l$.forEach(t),am.forEach(t),av=d(k),gn=s(k,"DIV",{class:!0});var rm=a(gn);m(ds.$$.fragment,rm),rv=d(rm),Ul=s(rm,"P",{});var d$=a(Ul);iv=i(d$,"Set model\u2019s output embeddings"),d$.forEach(t),rm.forEach(t),lv=d(k),hn=s(k,"DIV",{class:!0});var im=a(hn);m(cs.$$.fragment,im),dv=d(im),Hl=s(im,"P",{});var c$=a(Hl);cv=i(c$,"A modification of Keras\u2019s default test_step that cleans up the printed metrics when we use a dummy loss."),c$.forEach(t),im.forEach(t),pv=d(k),pe=s(k,"DIV",{class:!0});var Fn=a(pe);m(ps.$$.fragment,Fn),mv=d(Fn),oe=s(Fn,"P",{});var Ke=a(oe);uv=i(Ke,"A modification of Keras\u2019s default "),Vl=s(Ke,"CODE",{});var p$=a(Vl);gv=i(p$,"train_step"),p$.forEach(t),hv=i(Ke,` that cleans up the printed metrics when we use a dummy loss. If
a user specifies a loss at model compile time, this function behaves as the original Keras `),Xl=s(Ke,"CODE",{});var m$=a(Xl);fv=i(m$,"train_step"),m$.forEach(t),_v=i(Ke,`. In
...
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var h$=a(Kl);Tv=i(h$,"data"),h$.forEach(t),$v=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var f$=a(Zl);jv=i(f$,"(inputs,)"),f$.forEach(t),Mv=i(Fr,"."),Fr.forEach(t),Pv=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);Ev=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var _$=a(Jl);Lv=i(_$,"loss"),_$.forEach(t),qv=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var b$=a(Ql);Fv=i(b$,"loss"),b$.forEach(t),Ov=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jc=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);fn=s(lm,"A",{id:!0,class:!0,href:!0});var v$=a(fn);ed=s(v$,"SPAN",{});var y$=a(ed);m(ms.$$.fragment,y$),y$.forEach(t),v$.forEach(t),Dv=d(lm),td=s(lm,"SPAN",{});var k$=a(td);zv=i(k$,"TFModelUtilsMixin"),k$.forEach(t),lm.forEach(t),Qc=d(n),Pe=s(n,"DIV",{class:!0});var Dr=a(Pe);m(us.$$.fragment,Dr),Av=d(Dr),gs=s(Dr,"P",{});var dm=a(gs);Gv=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var x$=a(nd);Sv=i(x$,"tf.keras.Model"),x$.forEach(t),Nv=i(dm,", to be used as a mixin."),dm.forEach(t),Cv=d(Dr),_n=s(Dr,"DIV",{class:!0});var cm=a(_n);m(hs.$$.fragment,cm),Iv=d(cm),od=s(cm,"P",{});var w$=a(od);Bv=i(w$,"Get the number of (optionally, trainable) parameters in the model."),w$.forEach(t),cm.forEach(t),Dr.forEach(t),ep=d(n),ft=s(n,"H2",{class:!0});var pm=a(ft);bn=s(pm,"A",{id:!0,class:!0,href:!0});var T$=a(bn);sd=s(T$,"SPAN",{});var $$=a(sd);m(fs.$$.fragment,$$),$$.forEach(t),T$.forEach(t),Wv=d(pm),ad=s(pm,"SPAN",{});var j$=a(ad);Uv=i(j$,"FlaxPreTrainedModel"),j$.forEach(t),pm.forEach(t),tp=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(_s.$$.fragment,q),Hv=d(q),rd=s(q,"P",{});var M$=a(rd);Vv=i(M$,"Base class for all models."),M$.forEach(t),Xv=d(q),sr=s(q,"P",{});var zw=a(sr);ar=s(zw,"A",{href:!0});var P$=a(ar);Rv=i(P$,"FlaxPreTrainedModel"),P$.forEach(t),Yv=i(zw,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),zw.forEach(t),Kv=d(q),id=s(q,"P",{});var E$=a(id);Zv=i(E$,"Class attributes (overridden by derived classes):"),E$.forEach(t),Jv=d(q),_t=s(q,"UL",{});var zr=a(_t);Xe=s(zr,"LI",{});var za=a(Xe);ld=s(za,"STRONG",{});var L$=a(ld);Qv=i(L$,"config_class"),L$.forEach(t),ey=i(za," ("),rr=s(za,"A",{href:!0});var q$=a(rr);ty=i(q$,"PretrainedConfig"),q$.forEach(t),ny=i(za,") \u2014 A subclass of "),ir=s(za,"A",{href:!0});var F$=a(ir);oy=i(F$,"PretrainedConfig"),F$.forEach(t),sy=i(za,` to use as configuration class
for this model architecture.`),za.forEach(t),ay=d(zr),vn=s(zr,"LI",{});var qc=a(vn);dd=s(qc,"STRONG",{});var O$=a(dd);ry=i(O$,"base_model_prefix"),O$.forEach(t),iy=i(qc," ("),cd=s(qc,"CODE",{});var D$=a(cd);ly=i(D$,"str"),D$.forEach(t),dy=i(qc,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qc.forEach(t),cy=d(zr),R=s(zr,"LI",{});var ze=a(R);pd=s(ze,"STRONG",{});var z$=a(pd);py=i(z$,"main_input_name"),z$.forEach(t),my=i(ze," ("),md=s(ze,"CODE",{});var A$=a(md);uy=i(A$,"str"),A$.forEach(t),gy=i(ze,") \u2014 The name of the principal input to the model (often "),ud=s(ze,"CODE",{});var G$=a(ud);hy=i(G$,"input_ids"),G$.forEach(t),fy=i(ze,` for NLP
models, `),gd=s(ze,"CODE",{});var S$=a(gd);_y=i(S$,"pixel_values"),S$.forEach(t),by=i(ze," for vision models and "),hd=s(ze,"CODE",{});var N$=a(hd);vy=i(N$,"input_values"),N$.forEach(t),yy=i(ze," for speech models)."),ze.forEach(t),zr.forEach(t),ky=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),xy=d(On),vs=s(On,"P",{});var mm=a(vs);wy=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),fd=s(mm,"CODE",{});var C$=a(fd);Ty=i(C$,"repo_path_or_name"),C$.forEach(t),$y=i(mm,"."),mm.forEach(t),jy=d(On),_d=s(On,"P",{});var I$=a(_d);My=i(I$,"Examples:"),I$.forEach(t),Py=d(On),m(ys.$$.fragment,On),On.forEach(t),Ey=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Ly=d(Te),bd=s(Te,"P",{});var B$=a(bd);qy=i(B$,"Instantiate a pretrained flax model from a pre-trained model configuration."),B$.forEach(t),Fy=d(Te),xs=s(Te,"P",{});var um=a(xs);Oy=i(um,"The warning "),vd=s(um,"EM",{});var W$=a(vd);Dy=i(W$,"Weights from XXX not initialized from pretrained model"),W$.forEach(t),zy=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
library are already mapped with an auto class.`),V$.forEach(t),Vy=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),Xy=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m(js.$$.fragment,hm),Ry=d(hm),Ms=s(hm,"P",{});var fm=a(Ms);Yy=i(fm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(fm,"CODE",{});var X$=a(wd);Ky=i(X$,"[from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),X$.forEach(t),Zy=i(fm," class method"),fm.forEach(t),hm.forEach(t),Jy=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qy=d(Ze),se=s(Ze,"P",{});var Je=a(se);ek=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var R$=a(Td);tk=i(R$,"params"),R$.forEach(t),nk=i(Je," to "),$d=s(Je,"CODE",{});var Y$=a($d);ok=i(Y$,"jax.numpy.bfloat16"),Y$.forEach(t),sk=i(Je,". This returns a new "),jd=s(Je,"CODE",{});var K$=a(jd);ak=i(K$,"params"),K$.forEach(t),rk=i(Je,` tree and does not cast
the `),Md=s(Je,"CODE",{});var Z$=a(Md);ik=i(Z$,"params"),Z$.forEach(t),lk=i(Je," in place."),Je.forEach(t),dk=d(Ze),Pd=s(Ze,"P",{});var J$=a(Pd);ck=i(J$,`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),J$.forEach(t),pk=d(Ze),Ed=s(Ze,"P",{});var Q$=a(Ed);mk=i(Q$,"Examples:"),Q$.forEach(t),uk=d(Ze),m(Es.$$.fragment,Ze),Ze.forEach(t),gk=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Ls.$$.fragment,Qe),hk=d(Qe),ae=s(Qe,"P",{});var et=a(ae);fk=i(et,"Cast the floating-point "),Ld=s(et,"CODE",{});var ej=a(Ld);_k=i(ej,"parmas"),ej.forEach(t),bk=i(et," to "),qd=s(et,"CODE",{});var tj=a(qd);vk=i(tj,"jax.numpy.float16"),tj.forEach(t),yk=i(et,". This returns a new "),Fd=s(et,"CODE",{});var nj=a(Fd);kk=i(nj,"params"),nj.forEach(t),xk=i(et,` tree and does not cast the
`),Od=s(et,"CODE",{});var oj=a(Od);wk=i(oj,"params"),oj.forEach(t),Tk=i(et," in place."),et.forEach(t),$k=d(Qe),Dd=s(Qe,"P",{});var sj=a(Dd);jk=i(sj,`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),sj.forEach(t),Mk=d(Qe),zd=s(Qe,"P",{});var aj=a(zd);Pk=i(aj,"Examples:"),aj.forEach(t),Ek=d(Qe),m(qs.$$.fragment,Qe),Qe.forEach(t),Lk=d(q),ue=s(q,"DIV",{class:!0});var Dn=a(ue);m(Fs.$$.fragment,Dn),qk=d(Dn),re=s(Dn,"P",{});var tt=a(re);Fk=i(tt,"Cast the floating-point "),Ad=s(tt,"CODE",{});var rj=a(Ad);Ok=i(rj,"parmas"),rj.forEach(t),Dk=i(tt," to "),Gd=s(tt,"CODE",{});var ij=a(Gd);zk=i(ij,"jax.numpy.float32"),ij.forEach(t),Ak=i(tt,`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var lj=a(Sd);Gk=i(lj,"params"),lj.forEach(t),Sk=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var dj=a(Nd);Nk=i(dj,"params"),dj.forEach(t),Ck=i(tt," in place."),tt.forEach(t),Ik=d(Dn),Cd=s(Dn,"P",{});var cj=a(Cd);Bk=i(cj,"Examples:"),cj.forEach(t),Wk=d(Dn),m(Os.$$.fragment,Dn),Dn.forEach(t),q.forEach(t),np=d(n),bt=s(n,"H2",{class:!0});var _m=a(bt);xn=s(_m,"A",{id:!0,class:!0,href:!0});var pj=a(xn);Id=s(pj,"SPAN",{});var mj=a(Id);m(Ds.$$.fragment,mj),mj.forEach(t),pj.forEach(t),Uk=d(_m),Bd=s(_m,"SPAN",{});var uj=a(Bd);Hk=i(uj,"Generation"),uj.forEach(t),_m.forEach(t),op=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(zs.$$.fragment,F),Vk=d(F),As=s(F,"P",{});var bm=a(As);Xk=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var gj=a(lr);Rk=i(gj,"PreTrainedModel"),gj.forEach(t),Yk=i(bm,"."),bm.forEach(t),Kk=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Zk=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);Jk=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var hj=a(dr);Qk=i(hj,"PreTrainedModel"),hj.forEach(t),ex=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),tx=d(F),ge=s(F,"DIV",{class:!0});var zn=a(ge);m(Ns.$$.fragment,zn),nx=d(zn),Wd=s(zn,"P",{});var fj=a(Wd);ox=i(fj,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),fj.forEach(t),sx=d(zn),Ud=s(zn,"P",{});var _j=a(Ud);ax=i(_j,"Examples:"),_j.forEach(t),rx=d(zn),m(Cs.$$.fragment,zn),zn.forEach(t),ix=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),lx=d(An),Hd=s(An,"P",{});var bj=a(Hd);dx=i(bj,"Generates sequences for models with a language modeling head using beam search decoding."),bj.forEach(t),cx=d(An),Vd=s(An,"P",{});var vj=a(Vd);px=i(vj,"Examples:"),vj.forEach(t),mx=d(An),m(Bs.$$.fragment,An),An.forEach(t),ux=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),gx=d(km),Xd=s(km,"P",{});var yj=a(Xd);hx=i(yj,`compute the transition probabilities of sequences given generation
scores and beam indices`),yj.forEach(t),km.forEach(t),fx=d(F),fe=s(F,"DIV",{class:!0});var Gn=a(fe);m(Us.$$.fragment,Gn),_x=d(Gn),Rd=s(Gn,"P",{});var kj=a(Rd);bx=i(kj,"Generates sequences for models with a language modeling head using beam search decoding."),kj.forEach(t),vx=d(Gn),Yd=s(Gn,"P",{});var xj=a(Yd);yx=i(xj,"Examples:"),xj.forEach(t),kx=d(Gn),m(Hs.$$.fragment,Gn),Gn.forEach(t),xx=d(F),U=s(F,"DIV",{class:!0});var $e=a(U);m(Vs.$$.fragment,$e),wx=d($e),Kd=s($e,"P",{});var wj=a(Kd);Tx=i(wj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),wj.forEach(t),$x=d($e),vt=s($e,"P",{});var Gr=a(vt);jx=i(Gr,"Apart from "),Zd=s(Gr,"CODE",{});var Tj=a(Zd);Mx=i(Tj,"inputs"),Tj.forEach(t),Px=i(Gr,`, all the arguments below will default to the value of the attribute of the same name inside
the `),cr=s(Gr,"A",{href:!0});var $j=a(cr);Ex=i($j,"PretrainedConfig"),$j.forEach(t),Lx=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),qx=d($e),Xs=s($e,"P",{});var xm=a(Xs);Fx=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var jj=a(Rs);Ox=i(jj,`this blog
post`),jj.forEach(t),Dx=i(xm,"."),xm.forEach(t),zx=d($e),Jd=s($e,"P",{});var Mj=a(Jd);Ax=i(Mj,"Examples:"),Mj.forEach(t),Gx=d($e),m(Ys.$$.fragment,$e),$e.forEach(t),Sx=d(F),_e=s(F,"DIV",{class:!0});var Sn=a(_e);m(Ks.$$.fragment,Sn),Nx=d(Sn),Qd=s(Sn,"P",{});var Pj=a(Qd);Cx=i(Pj,"Generates sequences for models with a language modeling head using greedy decoding."),Pj.forEach(t),Ix=d(Sn),ec=s(Sn,"P",{});var Ej=a(ec);Bx=i(Ej,"Examples:"),Ej.forEach(t),Wx=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),Ux=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),Hx=d(Nn),tc=s(Nn,"P",{});var Lj=a(tc);Vx=i(Lj,"Generates sequences for models with a language modeling head using beam search decoding."),Lj.forEach(t),Xx=d(Nn),nc=s(Nn,"P",{});var qj=a(nc);Rx=i(qj,"Examples:"),qj.forEach(t),Yx=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),Kx=d(F),$n=s(F,"DIV",{class:!0});var wm=a($n);m(ea.$$.fragment,wm),Zx=d(wm),ta=s(wm,"P",{});var Tm=a(ta);Jx=i(Tm,"Implement in subclasses of "),pr=s(Tm,"A",{href:!0});var Fj=a(pr);Qx=i(Fj,"PreTrainedModel"),Fj.forEach(t),e1=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),t1=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),n1=d(Cn),oc=s(Cn,"P",{});var Oj=a(oc);o1=i(Oj,"Generates sequences for models with a language modeling head using multinomial sampling."),Oj.forEach(t),s1=d(Cn),sc=s(Cn,"P",{});var Dj=a(sc);a1=i(Dj,"Examples:"),Dj.forEach(t),r1=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sp=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),i1=d(J),aa=s(J,"P",{});var $m=a(aa);l1=i($m,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s($m,"A",{href:!0});var zj=a(mr);d1=i(zj,"TFPreTrainedModel"),zj.forEach(t),c1=i($m,"."),$m.forEach(t),p1=d(J),jn=s(J,"DIV",{class:!0});var jm=a(jn);m(ra.$$.fragment,jm),m1=d(jm),ia=s(jm,"P",{});var Mm=a(ia);u1=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var Aj=a(ur);g1=i(Aj,"PreTrainedModel"),Aj.forEach(t),h1=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),jm.forEach(t),f1=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),_1=d(Q),ac=s(Q,"P",{});var Gj=a(ac);b1=i(Gj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),Gj.forEach(t),v1=d(Q),da=s(Q,"P",{});var Pm=a(da);y1=i(Pm,"Adapted in part from "),ca=s(Pm,"A",{href:!0,rel:!0});var Sj=a(ca);k1=i(Sj,`Facebook\u2019s XLM beam search
code`),Sj.forEach(t),x1=i(Pm,"."),Pm.forEach(t),w1=d(Q),Ee=s(Q,"P",{});var In=a(Ee);T1=i(In,"Apart from "),rc=s(In,"CODE",{});var Nj=a(rc);$1=i(Nj,"input_ids"),Nj.forEach(t),j1=i(In," and "),ic=s(In,"CODE",{});var Cj=a(ic);M1=i(Cj,"attention_mask"),Cj.forEach(t),P1=i(In,`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=s(In,"A",{href:!0});var Ij=a(gr);E1=i(Ij,"PretrainedConfig"),Ij.forEach(t),L1=i(In,` of the model. The default values indicated are the default
values of those config.`),In.forEach(t),q1=d(Q),pa=s(Q,"P",{});var Em=a(pa);F1=i(Em,"Most of these parameters are explained in more detail in "),ma=s(Em,"A",{href:!0,rel:!0});var Bj=a(ma);O1=i(Bj,`this blog
post`),Bj.forEach(t),D1=i(Em,"."),Em.forEach(t),z1=d(Q),lc=s(Q,"P",{});var Wj=a(lc);A1=i(Wj,"Examples:"),Wj.forEach(t),G1=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),S1=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),N1=d(Bn),dc=s(Bn,"P",{});var Uj=a(dc);C1=i(Uj,"Generates sequences for models with a language modeling head using greedy decoding."),Uj.forEach(t),I1=d(Bn),cc=s(Bn,"P",{});var Hj=a(cc);B1=i(Hj,"Examples:"),Hj.forEach(t),W1=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),U1=d(J),Mn=s(J,"DIV",{class:!0});var Lm=a(Mn);m(fa.$$.fragment,Lm),H1=d(Lm),_a=s(Lm,"P",{});var qm=a(_a);V1=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var Vj=a(hr);X1=i(Vj,"TFPreTrainedModel"),Vj.forEach(t),R1=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Lm.forEach(t),Y1=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),K1=d(Wn),pc=s(Wn,"P",{});var Xj=a(pc);Z1=i(Xj,"Generates sequences for models with a language modeling head using multinomial sampling."),Xj.forEach(t),J1=d(Wn),mc=s(Wn,"P",{});var Rj=a(mc);Q1=i(Rj,"Examples:"),Rj.forEach(t),ew=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ap=d(n),Le=s(n,"DIV",{class:!0});var Sr=a(Le);m(ya.$$.fragment,Sr),tw=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);nw=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),fr=s(Fm,"A",{href:!0});var Yj=a(fr);ow=i(Yj,"FlaxPreTrainedModel"),Yj.forEach(t),sw=i(Fm,"."),Fm.forEach(t),aw=d(Sr),H=s(Sr,"DIV",{class:!0});var je=a(H);m(xa.$$.fragment,je),rw=d(je),uc=s(je,"P",{});var Kj=a(uc);iw=i(Kj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),Kj.forEach(t),lw=d(je),yt=s(je,"P",{});var Nr=a(yt);dw=i(Nr,"Apart from "),gc=s(Nr,"CODE",{});var Zj=a(gc);cw=i(Zj,"input_ids"),Zj.forEach(t),pw=i(Nr,`, all the arguments below will default to the value of the attribute of the same name
inside the `),_r=s(Nr,"A",{href:!0});var Jj=a(_r);mw=i(Jj,"PretrainedConfig"),Jj.forEach(t),uw=i(Nr,` of the model. The default values indicated are the default values of those
config.`),Nr.forEach(t),gw=d(je),wa=s(je,"P",{});var Om=a(wa);hw=i(Om,"Most of these parameters are explained in more detail in "),Ta=s(Om,"A",{href:!0,rel:!0});var Qj=a(Ta);fw=i(Qj,`this blog
post`),Qj.forEach(t),_w=i(Om,"."),Om.forEach(t),bw=d(je),hc=s(je,"P",{});var eM=a(hc);vw=i(eM,"Examples:"),eM.forEach(t),yw=d(je),m($a.$$.fragment,je),je.forEach(t),Sr.forEach(t),rp=d(n),kt=s(n,"H2",{class:!0});var Dm=a(kt);Pn=s(Dm,"A",{id:!0,class:!0,href:!0});var tM=a(Pn);fc=s(tM,"SPAN",{});var nM=a(fc);m(ja.$$.fragment,nM),nM.forEach(t),tM.forEach(t),kw=d(Dm),_c=s(Dm,"SPAN",{});var oM=a(_c);xw=i(oM,"Pushing to the Hub"),oM.forEach(t),Dm.forEach(t),ip=d(n),qe=s(n,"DIV",{class:!0});var Cr=a(qe);m(Ma.$$.fragment,Cr),ww=d(Cr),bc=s(Cr,"P",{});var sM=a(bc);Tw=i(sM,"A Mixin containing the functionality to push a model or tokenizer to the hub."),sM.forEach(t),$w=d(Cr),xe=s(Cr,"DIV",{class:!0});var Un=a(xe);m(Pa.$$.fragment,Un),jw=d(Un),Ea=s(Un,"P",{});var zm=a(Ea);Mw=i(zm,`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vc=s(zm,"CODE",{});var aM=a(vc);Pw=i(aM,"repo_path_or_name"),aM.forEach(t),Ew=i(zm,"."),zm.forEach(t),Lw=d(Un),yc=s(Un,"P",{});var rM=a(yc);qw=i(rM,"Examples:"),rM.forEach(t),Fw=d(Un),m(La.$$.fragment,Un),Un.forEach(t),Cr.forEach(t),this.h()},h(){c(x,"name","hf:doc:metadata"),c(x,"content",JSON.stringify(_M)),c(j,"id","models"),c(j,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(j,"href","#models"),c(T,"class","relative group"),c(Aa,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Ga,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Sa,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Na,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Ca,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Ia,"href","/docs/transformers/master/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin"),c(Ba,"href","/docs/transformers/master/en/main_classes/model#transformers.generation_utils.GenerationMixin"),c(Wa,"href","/docs/transformers/master/en/main_classes/model#transformers.generation_tf_utils.TFGenerationMixin"),c(Ua,"href","/docs/transformers/master/en/main_classes/model#transformers.generation_flax_utils.FlaxGenerationMixin"),c(Tt,"id","transformers.PreTrainedModel"),c(Tt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Tt,"href","#transformers.PreTrainedModel"),c(ot,"class","relative group"),c(Va,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Xa,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ra,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ya,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(le,"class","docstring"),c(D,"class","docstring"),c(Ft,"class","docstring"),c(Ot,"class","docstring"),c(Se,"class","docstring"),c(Ne,"class","docstring"),c(Dt,"class","docstring"),c(zt,"class","docstring"),c(At,"class","docstring"),c(Ce,"class","docstring"),c(Ie,"class","docstring"),c(St,"class","docstring"),c(Nt,"class","docstring"),c(Be,"class","docstring"),c(w,"class","docstring"),c(Ka,"id","from_pretrained-torch-dtype"),c(Ct,"id","model-instantiation-dtype"),c(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ct,"href","#model-instantiation-dtype"),c(rt,"class","relative group"),c(Bt,"id","transformers.modeling_utils.ModuleUtilsMixin"),c(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Bt,"href","#transformers.modeling_utils.ModuleUtilsMixin"),c(it,"class","relative group"),c(Ue,"class","docstring"),c(Wt,"class","docstring"),c(Eo,"href","https://arxiv.org/pdf/2001.08361.pdf"),c(Eo,"rel","nofollow"),c(Ut,"class","docstring"),c(Ht,"class","docstring"),c(Vt,"class","docstring"),c(Xt,"class","docstring"),c(Rt,"class","docstring"),c(Ja,"href","/docs/transformers/master/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin.add_memory_hooks"),c(Yt,"class","docstring"),c(L,"class","docstring"),c(Kt,"id","transformers.TFPreTrainedModel"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#transformers.TFPreTrainedModel"),c(pt,"class","relative group"),c(er,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(tr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(nr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(ce,"class","docstring"),c(Jt,"class","docstring"),c(S,"class","docstring"),c(en,"class","docstring"),c(tn,"class","docstring"),c(nn,"class","docstring"),c(on,"class","docstring"),c(sn,"class","docstring"),c(an,"class","docstring"),c(rn,"class","docstring"),c(ln,"class","docstring"),c(Ve,"class","docstring"),c(or,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained"),c(dn,"class","docstring"),c(cn,"class","docstring"),c(pn,"class","docstring"),c(mn,"class","docstring"),c(un,"class","docstring"),c(gn,"class","docstring"),c(hn,"class","docstring"),c(pe,"class","docstring"),c(y,"class","docstring"),c(fn,"id","transformers.modeling_tf_utils.TFModelUtilsMixin"),c(fn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(fn,"href","#transformers.modeling_tf_utils.TFModelUtilsMixin"),c(ht,"class","relative group"),c(_n,"class","docstring"),c(Pe,"class","docstring"),c(bn,"id","transformers.FlaxPreTrainedModel"),c(bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(bn,"href","#transformers.FlaxPreTrainedModel"),c(ft,"class","relative group"),c(ar,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(rr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(ir,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(me,"class","docstring"),c(W,"class","docstring"),c(Re,"class","docstring"),c(kn,"class","docstring"),c(Y,"class","docstring"),c(K,"class","docstring"),c(ue,"class","docstring"),c(M,"class","docstring"),c(xn,"id","transformers.generation_utils.GenerationMixin"),c(xn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xn,"href","#transformers.generation_utils.GenerationMixin"),c(bt,"class","relative group"),c(lr,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(dr,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(wn,"class","docstring"),c(ge,"class","docstring"),c(he,"class","docstring"),c(Tn,"class","docstring"),c(fe,"class","docstring"),c(cr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Rs,"href","https://huggingface.co/blog/how-to-generate"),c(Rs,"rel","nofollow"),c(U,"class","docstring"),c(_e,"class","docstring"),c(be,"class","docstring"),c(pr,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c($n,"class","docstring"),c(ve,"class","docstring"),c(P,"class","docstring"),c(mr,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(ur,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(jn,"class","docstring"),c(ca,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),c(ca,"rel","nofollow"),c(gr,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(ma,"href","https://huggingface.co/blog/how-to-generate"),c(ma,"rel","nofollow"),c(N,"class","docstring"),c(ye,"class","docstring"),c(hr,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Mn,"class","docstring"),c(ke,"class","docstring"),c(G,"class","docstring"),c(fr,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(_r,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ta,"href","https://huggingface.co/blog/how-to-generate"),c(Ta,"rel","nofollow"),c(H,"class","docstring"),c(Le,"class","docstring"),c(Pn,"id","transformers.file_utils.PushToHubMixin"),c(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pn,"href","#transformers.file_utils.PushToHubMixin"),c(kt,"class","relative group"),c(xe,"class","docstring"),c(qe,"class","docstring")},m(n,b){e(document.head,x),v(n,E,b),v(n,T,b),e(T,j),e(j,te),u(A,te,null),e(T,I),e(T,Me),e(Me,Am),v(n,Oc,b),v(n,ie,b),e(ie,Gm),e(ie,Aa),e(Aa,Sm),e(ie,Nm),e(ie,Ga),e(Ga,Cm),e(ie,Im),e(ie,Sa),e(Sa,Bm),e(ie,Wm),v(n,Dc,b),v(n,nt,b),e(nt,Na),e(Na,Um),e(nt,Hm),e(nt,Ca),e(Ca,Vm),e(nt,Xm),v(n,zc,b),v(n,wt,b),e(wt,Ir),e(Ir,Rm),e(wt,Ym),e(wt,Br),e(Br,Km),v(n,Ac,b),v(n,B,b),e(B,Zm),e(B,Ia),e(Ia,Jm),e(B,Qm),e(B,Wr),e(Wr,eu),e(B,tu),e(B,Ba),e(Ba,nu),e(B,ou),e(B,Wa),e(Wa,su),e(B,au),e(B,Ua),e(Ua,ru),e(B,iu),v(n,Gc,b),v(n,ot,b),e(ot,Tt),e(Tt,Ur),u(Hn,Ur,null),e(ot,lu),e(ot,Hr),e(Hr,du),v(n,Sc,b),v(n,w,b),u(Vn,w,null),e(w,cu),e(w,Vr),e(Vr,pu),e(w,mu),e(w,Ha),e(Ha,Va),e(Va,uu),e(Ha,gu),e(w,hu),e(w,Xn),e(Xn,Xr),e(Xr,fu),e(Xn,_u),e(Xn,Rr),e(Rr,bu),e(w,vu),e(w,Yr),e(Yr,yu),e(w,ku),e(w,ne),e(ne,Kr),e(Kr,Ae),e(Ae,Zr),e(Zr,xu),e(Ae,wu),e(Ae,Xa),e(Xa,Tu),e(Ae,$u),e(Ae,Ra),e(Ra,ju),e(Ae,Mu),e(ne,Pu),e(ne,Rn),e(Rn,Ge),e(Ge,Jr),e(Jr,Eu),e(Ge,Lu),e(Ge,Qr),e(Qr,qu),e(Ge,Fu),e(Ge,ei),e(ei,Ou),e(Ge,Du),e(Rn,zu),e(Rn,st),e(st,$t),e($t,ti),e(ti,Au),e($t,Gu),e($t,Ya),e(Ya,Su),e($t,Nu),e(st,Cu),e(st,jt),e(jt,ni),e(ni,Iu),e(jt,Bu),e(jt,oi),e(oi,Wu),e(jt,Uu),e(st,Hu),e(st,Mt),e(Mt,si),e(si,Vu),e(Mt,Xu),e(Mt,ai),e(ai,Ru),e(Mt,Yu),e(ne,Ku),e(ne,ri),e(ri,Pt),e(Pt,ii),e(ii,Zu),e(Pt,Ju),e(Pt,li),e(li,Qu),e(Pt,eg),e(ne,tg),e(ne,di),e(di,Et),e(Et,ci),e(ci,ng),e(Et,og),e(Et,pi),e(pi,sg),e(Et,ag),e(ne,rg),e(ne,mi),e(mi,V),e(V,ui),e(ui,ig),e(V,lg),e(V,gi),e(gi,dg),e(V,cg),e(V,hi),e(hi,pg),e(V,mg),e(V,fi),e(fi,ug),e(V,gg),e(V,_i),e(_i,hg),e(V,fg),e(w,_g),e(w,le),u(Yn,le,null),e(le,bg),e(le,Kn),e(Kn,vg),e(Kn,bi),e(bi,yg),e(Kn,kg),e(le,xg),e(le,vi),e(vi,wg),e(le,Tg),u(Zn,le,null),e(w,$g),e(w,D),u(Jn,D,null),e(D,jg),e(D,yi),e(yi,Mg),e(D,Pg),e(D,at),e(at,Eg),e(at,ki),e(ki,Lg),e(at,qg),e(at,xi),e(xi,Fg),e(at,Og),e(D,Dg),e(D,Qn),e(Qn,zg),e(Qn,wi),e(wi,Ag),e(Qn,Gg),e(D,Sg),e(D,eo),e(eo,Ng),e(eo,Ti),e(Ti,Cg),e(eo,Ig),e(D,Bg),u(Lt,D,null),e(D,Wg),u(qt,D,null),e(D,Ug),e(D,$i),e($i,Hg),e(D,Vg),u(to,D,null),e(w,Xg),e(w,Ft),u(no,Ft,null),e(Ft,Rg),e(Ft,ji),e(ji,Yg),e(w,Kg),e(w,Ot),u(oo,Ot,null),e(Ot,Zg),e(Ot,Mi),e(Mi,Jg),e(w,Qg),e(w,Se),u(so,Se,null),e(Se,eh),e(Se,Pi),e(Pi,th),e(Se,nh),e(Se,Ei),e(Ei,oh),e(w,sh),e(w,Ne),u(ao,Ne,null),e(Ne,ah),e(Ne,Li),e(Li,rh),e(Ne,ih),e(Ne,qi),e(qi,lh),e(w,dh),e(w,Dt),u(ro,Dt,null),e(Dt,ch),e(Dt,Fi),e(Fi,ph),e(w,mh),e(w,zt),u(io,zt,null),e(zt,uh),e(zt,Oi),e(Oi,gh),e(w,hh),e(w,At),u(lo,At,null),e(At,fh),e(At,Di),e(Di,_h),e(w,bh),e(w,Ce),u(co,Ce,null),e(Ce,vh),e(Ce,zi),e(zi,yh),e(Ce,kh),u(Gt,Ce,null),e(w,xh),e(w,Ie),u(po,Ie,null),e(Ie,wh),e(Ie,mo),e(mo,Th),e(mo,Ai),e(Ai,$h),e(mo,jh),e(Ie,Mh),e(Ie,uo),e(uo,Ph),e(uo,Gi),e(Gi,Eh),e(uo,Lh),e(w,qh),e(w,St),u(go,St,null),e(St,Fh),e(St,ho),e(ho,Oh),e(ho,Si),e(Si,Dh),e(ho,zh),e(w,Ah),e(w,Nt),u(fo,Nt,null),e(Nt,Gh),e(Nt,Ni),e(Ni,Sh),e(w,Nh),e(w,Be),u(_o,Be,null),e(Be,Ch),e(Be,Ci),e(Ci,Ih),e(Be,Bh),e(Be,bo),e(bo,Wh),e(bo,Ii),e(Ii,Uh),e(bo,Hh),v(n,Nc,b),v(n,Ka,b),v(n,Cc,b),v(n,rt,b),e(rt,Ct),e(Ct,Bi),u(vo,Bi,null),e(rt,Vh),e(rt,Wi),e(Wi,Xh),v(n,Ic,b),v(n,de,b),e(de,Rh),e(de,Ui),e(Ui,Yh),e(de,Kh),e(de,Hi),e(Hi,Zh),e(de,Jh),e(de,Vi),e(Vi,Qh),e(de,ef),v(n,Bc,b),u(yo,n,b),v(n,Wc,b),v(n,We,b),e(We,tf),e(We,Xi),e(Xi,nf),e(We,of),e(We,Ri),e(Ri,sf),e(We,af),v(n,Uc,b),u(ko,n,b),v(n,Hc,b),v(n,It,b),e(It,rf),e(It,Yi),e(Yi,lf),e(It,df),v(n,Vc,b),u(xo,n,b),v(n,Xc,b),v(n,Za,b),e(Za,cf),v(n,Rc,b),v(n,it,b),e(it,Bt),e(Bt,Ki),u(wo,Ki,null),e(it,pf),e(it,Zi),e(Zi,mf),v(n,Yc,b),v(n,L,b),u(To,L,null),e(L,uf),e(L,$o),e($o,gf),e($o,Ji),e(Ji,hf),e($o,ff),e(L,_f),e(L,Ue),u(jo,Ue,null),e(Ue,bf),e(Ue,Qi),e(Qi,vf),e(Ue,yf),e(Ue,lt),e(lt,kf),e(lt,el),e(el,xf),e(lt,wf),e(lt,tl),e(tl,Tf),e(lt,$f),e(L,jf),e(L,Wt),u(Mo,Wt,null),e(Wt,Mf),e(Wt,nl),e(nl,Pf),e(L,Ef),e(L,Ut),u(Po,Ut,null),e(Ut,Lf),e(Ut,dt),e(dt,qf),e(dt,ol),e(ol,Ff),e(dt,Of),e(dt,Eo),e(Eo,Df),e(dt,zf),e(L,Af),e(L,Ht),u(Lo,Ht,null),e(Ht,Gf),e(Ht,sl),e(sl,Sf),e(L,Nf),e(L,Vt),u(qo,Vt,null),e(Vt,Cf),e(Vt,al),e(al,If),e(L,Bf),e(L,Xt),u(Fo,Xt,null),e(Xt,Wf),e(Xt,rl),e(rl,Uf),e(L,Hf),e(L,Rt),u(Oo,Rt,null),e(Rt,Vf),e(Rt,il),e(il,Xf),e(L,Rf),e(L,Yt),u(Do,Yt,null),e(Yt,Yf),e(Yt,ct),e(ct,Kf),e(ct,ll),e(ll,Zf),e(ct,Jf),e(ct,Ja),e(Ja,Qf),e(ct,e_),v(n,Kc,b),v(n,pt,b),e(pt,Kt),e(Kt,dl),u(zo,dl,null),e(pt,t_),e(pt,cl),e(cl,n_),v(n,Zc,b),v(n,y,b),u(Ao,y,null),e(y,o_),e(y,pl),e(pl,s_),e(y,a_),e(y,Qa),e(Qa,er),e(er,r_),e(Qa,i_),e(y,l_),e(y,Go),e(Go,ml),e(ml,d_),e(Go,c_),e(Go,ul),e(ul,p_),e(y,m_),e(y,gl),e(gl,u_),e(y,g_),e(y,mt),e(mt,He),e(He,hl),e(hl,h_),e(He,f_),e(He,tr),e(tr,__),e(He,b_),e(He,nr),e(nr,v_),e(He,y_),e(mt,k_),e(mt,Zt),e(Zt,fl),e(fl,x_),e(Zt,w_),e(Zt,_l),e(_l,T_),e(Zt,$_),e(mt,j_),e(mt,X),e(X,bl),e(bl,M_),e(X,P_),e(X,vl),e(vl,E_),e(X,L_),e(X,yl),e(yl,q_),e(X,F_),e(X,kl),e(kl,O_),e(X,D_),e(X,xl),e(xl,z_),e(X,A_),e(y,G_),e(y,ce),u(So,ce,null),e(ce,S_),e(ce,No),e(No,N_),e(No,wl),e(wl,C_),e(No,I_),e(ce,B_),e(ce,Tl),e(Tl,W_),e(ce,U_),u(Co,ce,null),e(y,H_),e(y,Jt),u(Io,Jt,null),e(Jt,V_),e(Jt,$l),e($l,X_),e(y,R_),e(y,S),u(Bo,S,null),e(S,Y_),e(S,jl),e(jl,K_),e(S,Z_),e(S,Wo),e(Wo,J_),e(Wo,Ml),e(Ml,Q_),e(Wo,eb),e(S,tb),e(S,Uo),e(Uo,nb),e(Uo,Pl),e(Pl,ob),e(Uo,sb),e(S,ab),u(Qt,S,null),e(S,rb),e(S,El),e(El,ib),e(S,lb),u(Ho,S,null),e(y,db),e(y,en),u(Vo,en,null),e(en,cb),e(en,Ll),e(Ll,pb),e(y,mb),e(y,tn),u(Xo,tn,null),e(tn,ub),e(tn,ql),e(ql,gb),e(y,hb),e(y,nn),u(Ro,nn,null),e(nn,fb),e(nn,Fl),e(Fl,_b),e(y,bb),e(y,on),u(Yo,on,null),e(on,vb),e(on,Ol),e(Ol,yb),e(y,kb),e(y,sn),u(Ko,sn,null),e(sn,xb),e(sn,Dl),e(Dl,wb),e(y,Tb),e(y,an),u(Zo,an,null),e(an,$b),e(an,zl),e(zl,jb),e(y,Mb),e(y,rn),u(Jo,rn,null),e(rn,Pb),e(rn,Al),e(Al,Eb),e(y,Lb),e(y,ln),u(Qo,ln,null),e(ln,qb),e(ln,Gl),e(Gl,Fb),e(y,Ob),e(y,Ve),u(es,Ve,null),e(Ve,Db),e(Ve,ts),e(ts,zb),e(ts,Sl),e(Sl,Ab),e(ts,Gb),e(Ve,Sb),e(Ve,ns),e(ns,Nb),e(ns,Nl),e(Nl,Cb),e(ns,Ib),e(y,Bb),e(y,dn),u(os,dn,null),e(dn,Wb),e(dn,ss),e(ss,Ub),e(ss,or),e(or,Hb),e(ss,Vb),e(y,Xb),e(y,cn),u(as,cn,null),e(cn,Rb),e(cn,Cl),e(Cl,Yb),e(y,Kb),e(y,pn),u(rs,pn,null),e(pn,Zb),e(pn,Il),e(Il,Jb),e(y,Qb),e(y,mn),u(is,mn,null),e(mn,ev),e(mn,Bl),e(Bl,tv),e(y,nv),e(y,un),u(ls,un,null),e(un,ov),e(un,Wl),e(Wl,sv),e(y,av),e(y,gn),u(ds,gn,null),e(gn,rv),e(gn,Ul),e(Ul,iv),e(y,lv),e(y,hn),u(cs,hn,null),e(hn,dv),e(hn,Hl),e(Hl,cv),e(y,pv),e(y,pe),u(ps,pe,null),e(pe,mv),e(pe,oe),e(oe,uv),e(oe,Vl),e(Vl,gv),e(oe,hv),e(oe,Xl),e(Xl,fv),e(oe,_v),e(oe,Rl),e(Rl,bv),e(oe,vv),e(oe,Yl),e(Yl,yv),e(oe,kv),e(pe,xv),e(pe,ut),e(ut,wv),e(ut,Kl),e(Kl,Tv),e(ut,$v),e(ut,Zl),e(Zl,jv),e(ut,Mv),e(pe,Pv),e(pe,gt),e(gt,Ev),e(gt,Jl),e(Jl,Lv),e(gt,qv),e(gt,Ql),e(Ql,Fv),e(gt,Ov),v(n,Jc,b),v(n,ht,b),e(ht,fn),e(fn,ed),u(ms,ed,null),e(ht,Dv),e(ht,td),e(td,zv),v(n,Qc,b),v(n,Pe,b),u(us,Pe,null),e(Pe,Av),e(Pe,gs),e(gs,Gv),e(gs,nd),e(nd,Sv),e(gs,Nv),e(Pe,Cv),e(Pe,_n),u(hs,_n,null),e(_n,Iv),e(_n,od),e(od,Bv),v(n,ep,b),v(n,ft,b),e(ft,bn),e(bn,sd),u(fs,sd,null),e(ft,Wv),e(ft,ad),e(ad,Uv),v(n,tp,b),v(n,M,b),u(_s,M,null),e(M,Hv),e(M,rd),e(rd,Vv),e(M,Xv),e(M,sr),e(sr,ar),e(ar,Rv),e(sr,Yv),e(M,Kv),e(M,id),e(id,Zv),e(M,Jv),e(M,_t),e(_t,Xe),e(Xe,ld),e(ld,Qv),e(Xe,ey),e(Xe,rr),e(rr,ty),e(Xe,ny),e(Xe,ir),e(ir,oy),e(Xe,sy),e(_t,ay),e(_t,vn),e(vn,dd),e(dd,ry),e(vn,iy),e(vn,cd),e(cd,ly),e(vn,dy),e(_t,cy),e(_t,R),e(R,pd),e(pd,py),e(R,my),e(R,md),e(md,uy),e(R,gy),e(R,ud),e(ud,hy),e(R,fy),e(R,gd),e(gd,_y),e(R,by),e(R,hd),e(hd,vy),e(R,yy),e(M,ky),e(M,me),u(bs,me,null),e(me,xy),e(me,vs),e(vs,wy),e(vs,fd),e(fd,Ty),e(vs,$y),e(me,jy),e(me,_d),e(_d,My),e(me,Py),u(ys,me,null),e(M,Ey),e(M,W),u(ks,W,null),e(W,Ly),e(W,bd),e(bd,qy),e(W,Fy),e(W,xs),e(xs,Oy),e(xs,vd),e(vd,Dy),e(xs,zy),e(W,Ay),e(W,ws),e(ws,Gy),e(ws,yd),e(yd,Sy),e(ws,Ny),e(W,Cy),e(W,kd),e(kd,Iy),e(W,By),u(Ts,W,null),e(M,Wy),e(M,Re),u($s,Re,null),e(Re,Uy),e(Re,xd),e(xd,Hy),e(Re,Vy),u(yn,Re,null),e(M,Xy),e(M,kn),u(js,kn,null),e(kn,Ry),e(kn,Ms),e(Ms,Yy),e(Ms,wd),e(wd,Ky),e(Ms,Zy),e(M,Jy),e(M,Y),u(Ps,Y,null),e(Y,Qy),e(Y,se),e(se,ek),e(se,Td),e(Td,tk),e(se,nk),e(se,$d),e($d,ok),e(se,sk),e(se,jd),e(jd,ak),e(se,rk),e(se,Md),e(Md,ik),e(se,lk),e(Y,dk),e(Y,Pd),e(Pd,ck),e(Y,pk),e(Y,Ed),e(Ed,mk),e(Y,uk),u(Es,Y,null),e(M,gk),e(M,K),u(Ls,K,null),e(K,hk),e(K,ae),e(ae,fk),e(ae,Ld),e(Ld,_k),e(ae,bk),e(ae,qd),e(qd,vk),e(ae,yk),e(ae,Fd),e(Fd,kk),e(ae,xk),e(ae,Od),e(Od,wk),e(ae,Tk),e(K,$k),e(K,Dd),e(Dd,jk),e(K,Mk),e(K,zd),e(zd,Pk),e(K,Ek),u(qs,K,null),e(M,Lk),e(M,ue),u(Fs,ue,null),e(ue,qk),e(ue,re),e(re,Fk),e(re,Ad),e(Ad,Ok),e(re,Dk),e(re,Gd),e(Gd,zk),e(re,Ak),e(re,Sd),e(Sd,Gk),e(re,Sk),e(re,Nd),e(Nd,Nk),e(re,Ck),e(ue,Ik),e(ue,Cd),e(Cd,Bk),e(ue,Wk),u(Os,ue,null),v(n,np,b),v(n,bt,b),e(bt,xn),e(xn,Id),u(Ds,Id,null),e(bt,Uk),e(bt,Bd),e(Bd,Hk),v(n,op,b),v(n,P,b),u(zs,P,null),e(P,Vk),e(P,As),e(As,Xk),e(As,lr),e(lr,Rk),e(As,Yk),e(P,Kk),e(P,wn),u(Gs,wn,null),e(wn,Zk),e(wn,Ss),e(Ss,Jk),e(Ss,dr),e(dr,Qk),e(Ss,ex),e(P,tx),e(P,ge),u(Ns,ge,null),e(ge,nx),e(ge,Wd),e(Wd,ox),e(ge,sx),e(ge,Ud),e(Ud,ax),e(ge,rx),u(Cs,ge,null),e(P,ix),e(P,he),u(Is,he,null),e(he,lx),e(he,Hd),e(Hd,dx),e(he,cx),e(he,Vd),e(Vd,px),e(he,mx),u(Bs,he,null),e(P,ux),e(P,Tn),u(Ws,Tn,null),e(Tn,gx),e(Tn,Xd),e(Xd,hx),e(P,fx),e(P,fe),u(Us,fe,null),e(fe,_x),e(fe,Rd),e(Rd,bx),e(fe,vx),e(fe,Yd),e(Yd,yx),e(fe,kx),u(Hs,fe,null),e(P,xx),e(P,U),u(Vs,U,null),e(U,wx),e(U,Kd),e(Kd,Tx),e(U,$x),e(U,vt),e(vt,jx),e(vt,Zd),e(Zd,Mx),e(vt,Px),e(vt,cr),e(cr,Ex),e(vt,Lx),e(U,qx),e(U,Xs),e(Xs,Fx),e(Xs,Rs),e(Rs,Ox),e(Xs,Dx),e(U,zx),e(U,Jd),e(Jd,Ax),e(U,Gx),u(Ys,U,null),e(P,Sx),e(P,_e),u(Ks,_e,null),e(_e,Nx),e(_e,Qd),e(Qd,Cx),e(_e,Ix),e(_e,ec),e(ec,Bx),e(_e,Wx),u(Zs,_e,null),e(P,Ux),e(P,be),u(Js,be,null),e(be,Hx),e(be,tc),e(tc,Vx),e(be,Xx),e(be,nc),e(nc,Rx),e(be,Yx),u(Qs,be,null),e(P,Kx),e(P,$n),u(ea,$n,null),e($n,Zx),e($n,ta),e(ta,Jx),e(ta,pr),e(pr,Qx),e(ta,e1),e(P,t1),e(P,ve),u(na,ve,null),e(ve,n1),e(ve,oc),e(oc,o1),e(ve,s1),e(ve,sc),e(sc,a1),e(ve,r1),u(oa,ve,null),v(n,sp,b),v(n,G,b),u(sa,G,null),e(G,i1),e(G,aa),e(aa,l1),e(aa,mr),e(mr,d1),e(aa,c1),e(G,p1),e(G,jn),u(ra,jn,null),e(jn,m1),e(jn,ia),e(ia,u1),e(ia,ur),e(ur,g1),e(ia,h1),e(G,f1),e(G,N),u(la,N,null),e(N,_1),e(N,ac),e(ac,b1),e(N,v1),e(N,da),e(da,y1),e(da,ca),e(ca,k1),e(da,x1),e(N,w1),e(N,Ee),e(Ee,T1),e(Ee,rc),e(rc,$1),e(Ee,j1),e(Ee,ic),e(ic,M1),e(Ee,P1),e(Ee,gr),e(gr,E1),e(Ee,L1),e(N,q1),e(N,pa),e(pa,F1),e(pa,ma),e(ma,O1),e(pa,D1),e(N,z1),e(N,lc),e(lc,A1),e(N,G1),u(ua,N,null),e(G,S1),e(G,ye),u(ga,ye,null),e(ye,N1),e(ye,dc),e(dc,C1),e(ye,I1),e(ye,cc),e(cc,B1),e(ye,W1),u(ha,ye,null),e(G,U1),e(G,Mn),u(fa,Mn,null),e(Mn,H1),e(Mn,_a),e(_a,V1),e(_a,hr),e(hr,X1),e(_a,R1),e(G,Y1),e(G,ke),u(ba,ke,null),e(ke,K1),e(ke,pc),e(pc,Z1),e(ke,J1),e(ke,mc),e(mc,Q1),e(ke,ew),u(va,ke,null),v(n,ap,b),v(n,Le,b),u(ya,Le,null),e(Le,tw),e(Le,ka),e(ka,nw),e(ka,fr),e(fr,ow),e(ka,sw),e(Le,aw),e(Le,H),u(xa,H,null),e(H,rw),e(H,uc),e(uc,iw),e(H,lw),e(H,yt),e(yt,dw),e(yt,gc),e(gc,cw),e(yt,pw),e(yt,_r),e(_r,mw),e(yt,uw),e(H,gw),e(H,wa),e(wa,hw),e(wa,Ta),e(Ta,fw),e(wa,_w),e(H,bw),e(H,hc),e(hc,vw),e(H,yw),u($a,H,null),v(n,rp,b),v(n,kt,b),e(kt,Pn),e(Pn,fc),u(ja,fc,null),e(kt,kw),e(kt,_c),e(_c,xw),v(n,ip,b),v(n,qe,b),u(Ma,qe,null),e(qe,ww),e(qe,bc),e(bc,Tw),e(qe,$w),e(qe,xe),u(Pa,xe,null),e(xe,jw),e(xe,Ea),e(Ea,Mw),e(Ea,vc),e(vc,Pw),e(Ea,Ew),e(xe,Lw),e(xe,yc),e(yc,qw),e(xe,Fw),u(La,xe,null),lp=!0},p(n,[b]){const qa={};b&2&&(qa.$$scope={dirty:b,ctx:n}),Lt.$set(qa);const kc={};b&2&&(kc.$$scope={dirty:b,ctx:n}),qt.$set(kc);const xc={};b&2&&(xc.$$scope={dirty:b,ctx:n}),Gt.$set(xc);const wc={};b&2&&(wc.$$scope={dirty:b,ctx:n}),Qt.$set(wc);const Fe={};b&2&&(Fe.$$scope={dirty:b,ctx:n}),yn.$set(Fe)},i(n){lp||(g(A.$$.fragment,n),g(Hn.$$.fragment,n),g(Vn.$$.fragment,n),g(Yn.$$.fragment,n),g(Zn.$$.fragment,n),g(Jn.$$.fragment,n),g(Lt.$$.fragment,n),g(qt.$$.fragment,n),g(to.$$.fragment,n),g(no.$$.fragment,n),g(oo.$$.fragment,n),g(so.$$.fragment,n),g(ao.$$.fragment,n),g(ro.$$.fragment,n),g(io.$$.fragment,n),g(lo.$$.fragment,n),g(co.$$.fragment,n),g(Gt.$$.fragment,n),g(po.$$.fragment,n),g(go.$$.fragment,n),g(fo.$$.fragment,n),g(_o.$$.fragment,n),g(vo.$$.fragment,n),g(yo.$$.fragment,n),g(ko.$$.fragment,n),g(xo.$$.fragment,n),g(wo.$$.fragment,n),g(To.$$.fragment,n),g(jo.$$.fragment,n),g(Mo.$$.fragment,n),g(Po.$$.fragment,n),g(Lo.$$.fragment,n),g(qo.$$.fragment,n),g(Fo.$$.fragment,n),g(Oo.$$.fragment,n),g(Do.$$.fragment,n),g(zo.$$.fragment,n),g(Ao.$$.fragment,n),g(So.$$.fragment,n),g(Co.$$.fragment,n),g(Io.$$.fragment,n),g(Bo.$$.fragment,n),g(Qt.$$.fragment,n),g(Ho.$$.fragment,n),g(Vo.$$.fragment,n),g(Xo.$$.fragment,n),g(Ro.$$.fragment,n),g(Yo.$$.fragment,n),g(Ko.$$.fragment,n),g(Zo.$$.fragment,n),g(Jo.$$.fragment,n),g(Qo.$$.fragment,n),g(es.$$.fragment,n),g(os.$$.fragment,n),g(as.$$.fragment,n),g(rs.$$.fragment,n),g(is.$$.fragment,n),g(ls.$$.fragment,n),g(ds.$$.fragment,n),g(cs.$$.fragment,n),g(ps.$$.fragment,n),g(ms.$$.fragment,n),g(us.$$.fragment,n),g(hs.$$.fragment,n),g(fs.$$.fragment,n),g(_s.$$.fragment,n),g(bs.$$.fragment,n),g(ys.$$.fragment,n),g(ks.$$.fragment,n),g(Ts.$$.fragment,n),g($s.$$.fragment,n),g(yn.$$.fragment,n),g(js.$$.fragment,n),g(Ps.$$.fragment,n),g(Es.$$.fragment,n),g(Ls.$$.fragment,n),g(qs.$$.fragment,n),g(Fs.$$.fragment,n),g(Os.$$.fragment,n),g(Ds.$$.fragment,n),g(zs.$$.fragment,n),g(Gs.$$.fragment,n),g(Ns.$$.fragment,n),g(Cs.$$.fragment,n),g(Is.$$.fragment,n),g(Bs.$$.fragment,n),g(Ws.$$.fragment,n),g(Us.$$.fragment,n),g(Hs.$$.fragment,n),g(Vs.$$.fragment,n),g(Ys.$$.fragment,n),g(Ks.$$.fragment,n),g(Zs.$$.fragment,n),g(Js.$$.fragment,n),g(Qs.$$.fragment,n),g(ea.$$.fragment,n),g(na.$$.fragment,n),g(oa.$$.fragment,n),g(sa.$$.fragment,n),g(ra.$$.fragment,n),g(la.$$.fragment,n),g(ua.$$.fragment,n),g(ga.$$.fragment,n),g(ha.$$.fragment,n),g(fa.$$.fragment,n),g(ba.$$.fragment,n),g(va.$$.fragment,n),g(ya.$$.fragment,n),g(xa.$$.fragment,n),g($a.$$.fragment,n),g(ja.$$.fragment,n),g(Ma.$$.fragment,n),g(Pa.$$.fragment,n),g(La.$$.fragment,n),lp=!0)},o(n){h(A.$$.fragment,n),h(Hn.$$.fragment,n),h(Vn.$$.fragment,n),h(Yn.$$.fragment,n),h(Zn.$$.fragment,n),h(Jn.$$.fragment,n),h(Lt.$$.fragment,n),h(qt.$$.fragment,n),h(to.$$.fragment,n),h(no.$$.fragment,n),h(oo.$$.fragment,n),h(so.$$.fragment,n),h(ao.$$.fragment,n),h(ro.$$.fragment,n),h(io.$$.fragment,n),h(lo.$$.fragment,n),h(co.$$.fragment,n),h(Gt.$$.fragment,n),h(po.$$.fragment,n),h(go.$$.fragment,n),h(fo.$$.fragment,n),h(_o.$$.fragment,n),h(vo.$$.fragment,n),h(yo.$$.fragment,n),h(ko.$$.fragment,n),h(xo.$$.fragment,n),h(wo.$$.fragment,n),h(To.$$.fragment,n),h(jo.$$.fragment,n),h(Mo.$$.fragment,n),h(Po.$$.fragment,n),h(Lo.$$.fragment,n),h(qo.$$.fragment,n),h(Fo.$$.fragment,n),h(Oo.$$.fragment,n),h(Do.$$.fragment,n),h(zo.$$.fragment,n),h(Ao.$$.fragment,n),h(So.$$.fragment,n),h(Co.$$.fragment,n),h(Io.$$.fragment,n),h(Bo.$$.fragment,n),h(Qt.$$.fragment,n),h(Ho.$$.fragment,n),h(Vo.$$.fragment,n),h(Xo.$$.fragment,n),h(Ro.$$.fragment,n),h(Yo.$$.fragment,n),h(Ko.$$.fragment,n),h(Zo.$$.fragment,n),h(Jo.$$.fragment,n),h(Qo.$$.fragment,n),h(es.$$.fragment,n),h(os.$$.fragment,n),h(as.$$.fragment,n),h(rs.$$.fragment,n),h(is.$$.fragment,n),h(ls.$$.fragment,n),h(ds.$$.fragment,n),h(cs.$$.fragment,n),h(ps.$$.fragment,n),h(ms.$$.fragment,n),h(us.$$.fragment,n),h(hs.$$.fragment,n),h(fs.$$.fragment,n),h(_s.$$.fragment,n),h(bs.$$.fragment,n),h(ys.$$.fragment,n),h(ks.$$.fragment,n),h(Ts.$$.fragment,n),h($s.$$.fragment,n),h(yn.$$.fragment,n),h(js.$$.fragment,n),h(Ps.$$.fragment,n),h(Es.$$.fragment,n),h(Ls.$$.fragment,n),h(qs.$$.fragment,n),h(Fs.$$.fragment,n),h(Os.$$.fragment,n),h(Ds.$$.fragment,n),h(zs.$$.fragment,n),h(Gs.$$.fragment,n),h(Ns.$$.fragment,n),h(Cs.$$.fragment,n),h(Is.$$.fragment,n),h(Bs.$$.fragment,n),h(Ws.$$.fragment,n),h(Us.$$.fragment,n),h(Hs.$$.fragment,n),h(Vs.$$.fragment,n),h(Ys.$$.fragment,n),h(Ks.$$.fragment,n),h(Zs.$$.fragment,n),h(Js.$$.fragment,n),h(Qs.$$.fragment,n),h(ea.$$.fragment,n),h(na.$$.fragment,n),h(oa.$$.fragment,n),h(sa.$$.fragment,n),h(ra.$$.fragment,n),h(la.$$.fragment,n),h(ua.$$.fragment,n),h(ga.$$.fragment,n),h(ha.$$.fragment,n),h(fa.$$.fragment,n),h(ba.$$.fragment,n),h(va.$$.fragment,n),h(ya.$$.fragment,n),h(xa.$$.fragment,n),h($a.$$.fragment,n),h(ja.$$.fragment,n),h(Ma.$$.fragment,n),h(Pa.$$.fragment,n),h(La.$$.fragment,n),lp=!1},d(n){t(x),n&&t(E),n&&t(T),f(A),n&&t(Oc),n&&t(ie),n&&t(Dc),n&&t(nt),n&&t(zc),n&&t(wt),n&&t(Ac),n&&t(B),n&&t(Gc),n&&t(ot),f(Hn),n&&t(Sc),n&&t(w),f(Vn),f(Yn),f(Zn),f(Jn),f(Lt),f(qt),f(to),f(no),f(oo),f(so),f(ao),f(ro),f(io),f(lo),f(co),f(Gt),f(po),f(go),f(fo),f(_o),n&&t(Nc),n&&t(Ka),n&&t(Cc),n&&t(rt),f(vo),n&&t(Ic),n&&t(de),n&&t(Bc),f(yo,n),n&&t(Wc),n&&t(We),n&&t(Uc),f(ko,n),n&&t(Hc),n&&t(It),n&&t(Vc),f(xo,n),n&&t(Xc),n&&t(Za),n&&t(Rc),n&&t(it),f(wo),n&&t(Yc),n&&t(L),f(To),f(jo),f(Mo),f(Po),f(Lo),f(qo),f(Fo),f(Oo),f(Do),n&&t(Kc),n&&t(pt),f(zo),n&&t(Zc),n&&t(y),f(Ao),f(So),f(Co),f(Io),f(Bo),f(Qt),f(Ho),f(Vo),f(Xo),f(Ro),f(Yo),f(Ko),f(Zo),f(Jo),f(Qo),f(es),f(os),f(as),f(rs),f(is),f(ls),f(ds),f(cs),f(ps),n&&t(Jc),n&&t(ht),f(ms),n&&t(Qc),n&&t(Pe),f(us),f(hs),n&&t(ep),n&&t(ft),f(fs),n&&t(tp),n&&t(M),f(_s),f(bs),f(ys),f(ks),f(Ts),f($s),f(yn),f(js),f(Ps),f(Es),f(Ls),f(qs),f(Fs),f(Os),n&&t(np),n&&t(bt),f(Ds),n&&t(op),n&&t(P),f(zs),f(Gs),f(Ns),f(Cs),f(Is),f(Bs),f(Ws),f(Us),f(Hs),f(Vs),f(Ys),f(Ks),f(Zs),f(Js),f(Qs),f(ea),f(na),f(oa),n&&t(sp),n&&t(G),f(sa),f(ra),f(la),f(ua),f(ga),f(ha),f(fa),f(ba),f(va),n&&t(ap),n&&t(Le),f(ya),f(xa),f($a),n&&t(rp),n&&t(kt),f(ja),n&&t(ip),n&&t(qe),f(Ma),f(Pa),f(La)}}}const _M={local:"models",sections:[{local:"transformers.PreTrainedModel",sections:[{local:"model-instantiation-dtype",title:"Model Instantiation dtype"}],title:"PreTrainedModel"},{local:"transformers.modeling_utils.ModuleUtilsMixin",title:"ModuleUtilsMixin"},{local:"transformers.TFPreTrainedModel",title:"TFPreTrainedModel"},{local:"transformers.modeling_tf_utils.TFModelUtilsMixin",title:"TFModelUtilsMixin"},{local:"transformers.FlaxPreTrainedModel",title:"FlaxPreTrainedModel"},{local:"transformers.generation_utils.GenerationMixin",title:"Generation"},{local:"transformers.file_utils.PushToHubMixin",title:"Pushing to the Hub"}],title:"Models"};function bM(ee,x,E){let{fw:T}=x;return ee.$$set=j=>{"fw"in j&&E(0,T=j.fw)},[T]}class $M extends iM{constructor(x){super();lM(this,x,bM,fM,dM,{fw:0})}}export{$M as default,_M as metadata};
