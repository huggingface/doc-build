...
</ul>`,name:"config"}]}}),Lt=new Fc({props:{$$slots:{default:[pM]},$$scope:{ctx:ee}}}),qt=new Fc({props:{$$slots:{default:[mM]},$$scope:{ctx:ee}}}),to=new O({props:{code:`from transformers import BertConfig, BertModel
...
</ul>`,name:"config"}]}}),Qt=new Fc({props:{$$slots:{default:[gM]},$$scope:{ctx:ee}}}),Ho=new O({props:{code:`from transformers import BertConfig, TFBertModel
