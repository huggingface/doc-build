import{S as Um,i as Vm,s as Km,e as o,k as l,w as m,t,M as Zm,c as a,d as s,m as d,a as r,x as g,h as n,b as c,F as e,g as w,y as u,q as _,o as h,B as f}from"../../chunks/vendor-4833417e.js";import{T as Rm}from"../../chunks/Tip-fffd6df1.js";import{D as be}from"../../chunks/Docstring-4f315ed9.js";import{C as ye}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Co}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Xm(it){let p,P,j,T,I,E,xe,W,G,B,v;return{c(){p=o("p"),P=t("Apart from "),j=o("code"),T=t("inputs"),I=t(`, all the arguments below will default to the value of the attribute of the same name as
...
`),Dn=o("code"),Fa=t("do_sample=True"),Aa=t("."),za=l(),V=o("li"),Nn=o("em"),Pa=t("beam-search decoding"),Da=t(" by calling "),mn=o("a"),Na=t("beam_search()"),Ca=t(" if "),Cn=o("code"),Ia=t("num_beams>1"),Wa=t(` and
...
`),ss=o("code"),Pr=t("do_sample=True"),Dr=t("."),Nr=l(),Y=o("li"),os=o("em"),Cr=t("beam-search decoding"),Ir=t(" by calling "),bn=o("a"),Wr=t("beam_search()"),Br=t(" if "),as=o("code"),Hr=t("num_beams>1"),Rr=t(` and
...
decoding`),Tl=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),El=l(),Gs=o("p"),Ol=t("Examples:"),ql=l(),m(At.$$.fragment),fo=l(),Te=o("h2"),Je=o("a"),Ss=o("span"),m(zt.$$.fragment),Gl=l(),$s=o("span"),Sl=t("TFGenerationMixn"),bo=l(),ke=o("div"),m(Pt.$$.fragment),$l=l(),Dt=o("p"),Fl=t("A class containing all of the functions supporting generation, to be used as a mixin in "),yn=o("a"),Al=t("TFPreTrainedModel"),zl=t("."),Pl=l(),O=o("div"),m(Nt.$$.fragment),Dl=l(),Fs=o("p"),Nl=t(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
post`),td=t("."),nd=l(),Ps=o("p"),sd=t("Examples:"),od=l(),m(Ht.$$.fragment),xo=l(),Ee=o("h2"),Qe=o("a"),Ds=o("span"),m(Rt.$$.fragment),ad=l(),Ns=o("span"),rd=t("FlaxGenerationMixn"),ko=l(),z=o("div"),m(Ut.$$.fragment),id=l(),Vt=o("p"),ld=t(`A class containing all functions for auto-regressive text generation, to be used as a mixin in
...
and `),Vs=o("code"),Gd=t("do_sample=True"),Sd=t("."),$d=l(),pe=o("li"),Ks=o("em"),Fd=t("beam-search decoding"),Ad=t(" by calling "),Zs=o("code"),zd=t("_beam_search"),Pd=t(" if "),Xs=o("code"),Dd=t("num_beams>1"),Nd=t(`
...
post`),yc=t("."),jc=l(),mo=o("p"),Mc=t("Examples:"),Lc=l(),m(Qt.$$.fragment),this.h()},l(i){const y=Zm('[data-svelte="svelte-1phssyn"]',document.head);p=a(y,"META",{name:!0,content:!0}),y.forEach(s),P=d(i),j=a(i,"H1",{class:!0});var Yt=r(j);T=a(Yt,"A",{id:!0,class:!0,href:!0});var go=r(T);I=a(go,"SPAN",{});var wc=r(I);g(E.$$.fragment,wc),wc.forEach(s),go.forEach(s),xe=d(Yt),W=a(Yt,"SPAN",{});var Tc=r(W);G=n(Tc,"Generation"),Tc.forEach(s),Yt.forEach(s),B=d(i),v=a(i,"P",{});var D=r(v);$=n(D,"The methods for auto-regressive text generation, namely "),b=a(D,"A",{href:!0});var Ec=r(b);Me=n(Ec,"generate()"),Ec.forEach(s),Le=n(D," (for the PyTorch models), "),H=a(D,"A",{href:!0});var Oc=r(H);Io=n(Oc,"generate()"),Oc.forEach(s),Wo=n(D," (for the TensorFlow models) and "),en=a(D,"A",{href:!0});var qc=r(en);Bo=n(qc,"generate()"),qc.forEach(s),Ho=n(D," (for the Flax/JAX models), are implemented in "),tn=a(D,"A",{href:!0});var Gc=r(tn);Ro=n(Gc,"GenerationMixin"),Gc.forEach(s),Uo=n(D,", "),nn=a(D,"A",{href:!0});var Sc=r(nn);Vo=n(Sc,"TFGenerationMixin"),Sc.forEach(s),Ko=n(D," and "),sn=a(D,"A",{href:!0});var $c=r(sn);Zo=n($c,"FlaxGenerationMixin"),$c.forEach(s),Xo=n(D," respectively."),D.forEach(s),uo=d(i),S=a(i,"P",{});var _e=r(S);Jo=n(_e,"The "),On=a(_e,"CODE",{});var Fc=r(On);Qo=n(Fc,"GenerationMixin"),Fc.forEach(s),Yo=n(_e," classes are inherited by the corresponding base model classes, "),qn=a(_e,"EM",{});var Ac=r(qn);ea=n(Ac,"e.g."),Ac.forEach(s),ta=d(_e),on=a(_e,"A",{href:!0});var zc=r(on);na=n(zc,"PreTrainedModel"),zc.forEach(s),sa=n(_e,", "),an=a(_e,"A",{href:!0});var Pc=r(an);oa=n(Pc,"TFPreTrainedModel"),Pc.forEach(s),aa=n(_e,", and "),rn=a(_e,"A",{href:!0});var Dc=r(rn);ra=n(Dc,"FlaxPreTrainedModel"),Dc.forEach(s),ia=n(_e,` respectively, therefore exposing all
methods for auto-regressive text generation to every model class.`),_e.forEach(s),_o=d(i),we=a(i,"H2",{class:!0});var yo=r(we);Ze=a(yo,"A",{id:!0,class:!0,href:!0});var Nc=r(Ze);Gn=a(Nc,"SPAN",{});var Cc=r(Gn);g(lt.$$.fragment,Cc),Cc.forEach(s),Nc.forEach(s),la=d(yo),Sn=a(yo,"SPAN",{});var Ic=r(Sn);da=n(Ic,"GenerationMixn"),Ic.forEach(s),yo.forEach(s),ho=d(i),k=a(i,"DIV",{class:!0});var L=r(k);g(dt.$$.fragment,L),ca=d(L),ct=a(L,"P",{});var jo=r(ct);pa=n(jo,"A class containing all functions for auto-regressive text generation, to be used as a mixin in "),ln=a(jo,"A",{href:!0});var Wc=r(ln);ma=n(Wc,"PreTrainedModel"),Wc.forEach(s),ga=n(jo,"."),jo.forEach(s),ua=d(L),pt=a(L,"P",{});var Mo=r(pt);_a=n(Mo,"The class exposes "),dn=a(Mo,"A",{href:!0});var Bc=r(dn);ha=n(Bc,"generate()"),Bc.forEach(s),fa=n(Mo,", which can be used for:"),Mo.forEach(s),ba=d(L),F=a(L,"UL",{});var he=r(F);R=a(he,"LI",{});var Ge=r(R);$n=a(Ge,"EM",{});var Hc=r($n);xa=n(Hc,"greedy decoding"),Hc.forEach(s),ka=n(Ge," by calling "),cn=a(Ge,"A",{href:!0});var Rc=r(cn);va=n(Rc,"greedy_search()"),Rc.forEach(s),ya=n(Ge," if "),Fn=a(Ge,"CODE",{});var Uc=r(Fn);ja=n(Uc,"num_beams=1"),Uc.forEach(s),Ma=n(Ge,` and
...
`),Dn=a(Se,"CODE",{});var Jc=r(Dn);Fa=n(Jc,"do_sample=True"),Jc.forEach(s),Aa=n(Se,"."),Se.forEach(s),za=d(he),V=a(he,"LI",{});var $e=r(V);Nn=a($e,"EM",{});var Qc=r(Nn);Pa=n(Qc,"beam-search decoding"),Qc.forEach(s),Da=n($e," by calling "),mn=a($e,"A",{href:!0});var Yc=r(mn);Na=n(Yc,"beam_search()"),Yc.forEach(s),Ca=n($e," if "),Cn=a($e,"CODE",{});var ep=r(Cn);Ia=n(ep,"num_beams>1"),ep.forEach(s),Wa=n($e,` and
...
`),es=a(Pe,"CODE",{});var bp=r(es);Er=n(bp,"do_sample=False"),bp.forEach(s),Or=n(Pe,"."),Pe.forEach(s),qr=d(fe),Q=a(fe,"LI",{});var De=r(Q);ts=a(De,"EM",{});var xp=r(ts);Gr=n(xp,"multinomial sampling"),xp.forEach(s),Sr=n(De," by calling "),fn=a(De,"A",{href:!0});var kp=r(fn);$r=n(kp,"sample()"),kp.forEach(s),Fr=n(De," if "),ns=a(De,"CODE",{});var vp=r(ns);Ar=n(vp,"num_beams=1"),vp.forEach(s),zr=n(De,` and
`),ss=a(De,"CODE",{});var yp=r(ss);Pr=n(yp,"do_sample=True"),yp.forEach(s),Dr=n(De,"."),De.forEach(s),Nr=d(fe),Y=a(fe,"LI",{});var Ne=r(Y);os=a(Ne,"EM",{});var jp=r(os);Cr=n(jp,"beam-search decoding"),jp.forEach(s),Ir=n(Ne," by calling "),bn=a(Ne,"A",{href:!0});var Mp=r(bn);Wr=n(Mp,"beam_search()"),Mp.forEach(s),Br=n(Ne," if "),as=a(Ne,"CODE",{});var Lp=r(as);Hr=n(Lp,"num_beams>1"),Lp.forEach(s),Rr=n(Ne,` and
`),rs=a(Ne,"CODE",{});var wp=r(rs);Ur=n(wp,"do_sample=False"),wp.forEach(s),Vr=n(Ne,"."),Ne.forEach(s),Kr=d(fe),ee=a(fe,"LI",{});var Ce=r(ee);is=a(Ce,"EM",{});var Tp=r(is);Zr=n(Tp,"beam-search multinomial sampling"),Tp.forEach(s),Xr=n(Ce," by calling "),xn=a(Ce,"A",{href:!0});var Ep=r(xn);Jr=n(Ep,"beam_sample()"),Ep.forEach(s),Qr=n(Ce,` if
...
`),_s=a(We,"CODE",{});var Dp=r(_s);xi=n(Dp,"force_words_ids!=None"),Dp.forEach(s),ki=n(We,"."),We.forEach(s),fe.forEach(s),vi=d(M),g(Xe.$$.fragment,M),yi=d(M),gt=a(M,"P",{});var Lo=r(gt);ji=n(Lo,"Most of these parameters are explained in more detail in "),ut=a(Lo,"A",{href:!0,rel:!0});var Np=r(ut);Mi=n(Np,`this blog
post`),Np.forEach(s),Li=n(Lo,"."),Lo.forEach(s),wi=d(M),hs=a(M,"P",{});var Cp=r(hs);Ti=n(Cp,"Examples:"),Cp.forEach(s),Ei=d(M),fs=a(M,"P",{});var Ip=r(fs);Oi=n(Ip,"Greedy Decoding:"),Ip.forEach(s),qi=d(M),g(_t.$$.fragment,M),Gi=d(M),bs=a(M,"P",{});var Wp=r(bs);Si=n(Wp,"Multinomial Sampling:"),Wp.forEach(s),$i=d(M),g(ht.$$.fragment,M),Fi=d(M),xs=a(M,"P",{});var Bp=r(xs);Ai=n(Bp,"Beam-search decoding:"),Bp.forEach(s),zi=d(M),g(ft.$$.fragment,M),M.forEach(s),Pi=d(L),se=a(L,"DIV",{class:!0});var et=r(se);g(bt.$$.fragment,et),Di=d(et),xt=a(et,"P",{});var wo=r(xt);Ni=n(wo,"Generates sequences of token ids for models with a language modeling head using "),ks=a(wo,"STRONG",{});var Hp=r(ks);Ci=n(Hp,"greedy decoding"),Hp.forEach(s),Ii=n(wo,` and can be
...
decoding`),em.forEach(s),Tl=n(Go," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Go.forEach(s),El=d(at),Gs=a(at,"P",{});var tm=r(Gs);Ol=n(tm,"Examples:"),tm.forEach(s),ql=d(at),g(At.$$.fragment,at),at.forEach(s),L.forEach(s),fo=d(i),Te=a(i,"H2",{class:!0});var So=r(Te);Je=a(So,"A",{id:!0,class:!0,href:!0});var nm=r(Je);Ss=a(nm,"SPAN",{});var sm=r(Ss);g(zt.$$.fragment,sm),sm.forEach(s),nm.forEach(s),Gl=d(So),$s=a(So,"SPAN",{});var om=r($s);Sl=n(om,"TFGenerationMixn"),om.forEach(s),So.forEach(s),bo=d(i),ke=a(i,"DIV",{class:!0});var wn=r(ke);g(Pt.$$.fragment,wn),$l=d(wn),Dt=a(wn,"P",{});var $o=r(Dt);Fl=n($o,"A class containing all of the functions supporting generation, to be used as a mixin in "),yn=a($o,"A",{href:!0});var am=r(yn);Al=n(am,"TFPreTrainedModel"),am.forEach(s),zl=n($o,"."),$o.forEach(s),Pl=d(wn),O=a(wn,"DIV",{class:!0});var N=r(O);g(Nt.$$.fragment,N),Dl=d(N),Fs=a(N,"P",{});var rm=r(Fs);Nl=n(rm,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
beam-search decoding, sampling with temperature, sampling with top-k or nucleus sampling.`),rm.forEach(s),Cl=d(N),Ct=a(N,"P",{});var Fo=r(Ct);Il=n(Fo,"Adapted in part from "),It=a(Fo,"A",{href:!0,rel:!0});var im=r(It);Wl=n(im,`Facebook\u2019s XLM beam search
code`),im.forEach(s),Bl=n(Fo,"."),Fo.forEach(s),Hl=d(N),ve=a(N,"P",{});var rt=r(ve);Rl=n(rt,"Apart from "),As=a(rt,"CODE",{});var lm=r(As);Ul=n(lm,"input_ids"),lm.forEach(s),Vl=n(rt," and "),zs=a(rt,"CODE",{});var dm=r(zs);Kl=n(dm,"attention_mask"),dm.forEach(s),Zl=n(rt,`, all the arguments below will default to the value of the attribute
...
values of those config.`),rt.forEach(s),Ql=d(N),Wt=a(N,"P",{});var Ao=r(Wt);Yl=n(Ao,"Most of these parameters are explained in more detail in "),Bt=a(Ao,"A",{href:!0,rel:!0});var pm=r(Bt);ed=n(pm,`this blog
post`),pm.forEach(s),td=n(Ao,"."),Ao.forEach(s),nd=d(N),Ps=a(N,"P",{});var mm=r(Ps);sd=n(mm,"Examples:"),mm.forEach(s),od=d(N),g(Ht.$$.fragment,N),N.forEach(s),wn.forEach(s),xo=d(i),Ee=a(i,"H2",{class:!0});var zo=r(Ee);Qe=a(zo,"A",{id:!0,class:!0,href:!0});var gm=r(Qe);Ds=a(gm,"SPAN",{});var um=r(Ds);g(Rt.$$.fragment,um),um.forEach(s),gm.forEach(s),ad=d(zo),Ns=a(zo,"SPAN",{});var _m=r(Ns);rd=n(_m,"FlaxGenerationMixn"),_m.forEach(s),zo.forEach(s),ko=d(i),z=a(i,"DIV",{class:!0});var je=r(z);g(Ut.$$.fragment,je),id=d(je),Vt=a(je,"P",{});var Po=r(Vt);ld=n(Po,`A class containing all functions for auto-regressive text generation, to be used as a mixin in
`),Mn=a(Po,"A",{href:!0});var hm=r(Mn);dd=n(hm,"FlaxPreTrainedModel"),hm.forEach(s),cd=n(Po,"."),Po.forEach(s),pd=d(je),Kt=a(je,"P",{});var Do=r(Kt);md=n(Do,"The class exposes "),Ln=a(Do,"A",{href:!0});var fm=r(Ln);gd=n(fm,"generate()"),fm.forEach(s),ud=n(Do,", which can be used for:"),Do.forEach(s),_d=d(je),Oe=a(je,"UL",{});var Tn=r(Oe);de=a(Tn,"LI",{});var Be=r(de);Cs=a(Be,"EM",{});var bm=r(Cs);hd=n(bm,"greedy decoding"),bm.forEach(s),fd=n(Be," by calling "),Is=a(Be,"CODE",{});var xm=r(Is);bd=n(xm,"_greedy_search()"),xm.forEach(s),xd=n(Be,`if
