import{S as Po,i as Do,s as So,e as s,k as c,w as v,t as r,R as Mo,c as n,d as o,m as d,a,x as T,h as i,b as p,F as t,g as h,y as w,L as Io,q as y,o as q,B}from"../../chunks/vendor-9daddcfa.js";import{D as $e}from"../../chunks/Docstring-ea6f8b76.js";import{C as Lo}from"../../chunks/CodeBlock-37b92346.js";import{I as to}from"../../chunks/IconCopyLink-a413fd1b.js";import"../../chunks/CopyButton-6099fd9d.js";function No(et){let _,Z,f,g,ue,D,tt,fe,ot,Ee,z,E,ge,S,st,_e,nt,Re,R,at,M,rt,it,xe,ee,lt,je,te,ke,pt,Le,oe,ct,Pe,I,De,se,dt,Se,ne,N,ht,ae,mt,ut,Me,C,Ie,re,be,ft,Ne,k,gt,O,_t,kt,F,bt,vt,Ce,A,x,ve,V,Tt,Te,wt,Oe,m,X,yt,$,qt,ie,Bt,zt,W,At,$t,Et,U,Rt,le,xt,jt,Lt,b,G,Pt,we,Dt,St,H,pe,Mt,ye,It,Nt,ce,Ct,qe,Ot,Ft,j,K,Vt,Be,Xt,Wt,L,Q,Ut,ze,Gt,Ht,P,J,Kt,Y,Qt,Ae,Jt,Yt,Fe;return D=new to({}),S=new to({}),I=new Lo({props:{code:`import torch
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),{c(){_=s("meta"),Z=c(),f=s("h1"),g=s("a"),ue=s("span"),v(D.$$.fragment),tt=c(),fe=s("span"),ot=r("BARTpho"),Ee=c(),z=s("h2"),E=s("a"),ge=s("span"),v(S.$$.fragment),st=c(),_e=s("span"),nt=r("Overview"),Re=c(),R=s("p"),at=r("The BARTpho model was proposed in "),M=s("a"),rt=r("BARTpho: Pre-trained Sequence-to-Sequence Models for Vietnamese"),it=r(" by Nguyen Luong Tran, Duong Minh Le and Dat Quoc Nguyen."),xe=c(),ee=s("p"),lt=r("The abstract from the paper is the following:"),je=c(),te=s("p"),ke=s("em"),pt=r(`We present BARTpho with two versions \u2014 BARTpho_word and BARTpho_syllable \u2014 the first public large-scale monolingual
...
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),Ne=c(),k=s("p"),gt=r("This model was contributed by "),O=s("a"),_t=r("dqnguyen"),kt=r(". The original code can be found "),F=s("a"),bt=r("here"),vt=r("."),Ce=c(),A=s("h2"),x=s("a"),ve=s("span"),v(V.$$.fragment),Tt=c(),Te=s("span"),wt=r("BartphoTokenizer"),Oe=c(),m=s("div"),v(X.$$.fragment),yt=c(),$=s("p"),qt=r("Adapted from "),ie=s("a"),Bt=r("XLMRobertaTokenizer"),zt=r(". Based on "),W=s("a"),At=r("SentencePiece"),$t=r("."),Et=c(),U=s("p"),Rt=r("This tokenizer inherits from "),le=s("a"),xt=r("PreTrainedTokenizer"),jt=r(` which contains most of the main methods. Users should refer to
...
extracted from the pre-trained SentencePiece model \u201Cvocab_file\u201D that is available from the multilingual XLM-RoBERTa.
Other languages, if employing this pre-trained multilingual SentencePiece model \u201Cvocab_file\u201D for subword
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),ko.forEach(o),_o.forEach(o),Ne=d(e),k=n(e,"P",{});var de=a(k);gt=i(de,"This model was contributed by "),O=n(de,"A",{href:!0,rel:!0});var bo=a(O);_t=i(bo,"dqnguyen"),bo.forEach(o),kt=i(de,". The original code can be found "),F=n(de,"A",{href:!0,rel:!0});var vo=a(F);bt=i(vo,"here"),vo.forEach(o),vt=i(de,"."),de.forEach(o),Ce=d(e),A=n(e,"H2",{class:!0});var Ge=a(A);x=n(Ge,"A",{id:!0,class:!0,href:!0});var To=a(x);ve=n(To,"SPAN",{});var wo=a(ve);T(V.$$.fragment,wo),wo.forEach(o),To.forEach(o),Tt=d(Ge),Te=n(Ge,"SPAN",{});var yo=a(Te);wt=i(yo,"BartphoTokenizer"),yo.forEach(o),Ge.forEach(o),Oe=d(e),m=n(e,"DIV",{class:!0});var u=a(m);T(X.$$.fragment,u),yt=d(u),$=n(u,"P",{});var he=a($);qt=i(he,"Adapted from "),ie=n(he,"A",{href:!0});var qo=a(ie);Bt=i(qo,"XLMRobertaTokenizer"),qo.forEach(o),zt=i(he,". Based on "),W=n(he,"A",{href:!0,rel:!0});var Bo=a(W);At=i(Bo,"SentencePiece"),Bo.forEach(o),$t=i(he,"."),he.forEach(o),Et=d(u),U=n(u,"P",{});var He=a(U);Rt=i(He,"This tokenizer inherits from "),le=n(He,"A",{href:!0});var zo=a(le);xt=i(zo,"PreTrainedTokenizer"),zo.forEach(o),jt=i(He,` which contains most of the main methods. Users should refer to
