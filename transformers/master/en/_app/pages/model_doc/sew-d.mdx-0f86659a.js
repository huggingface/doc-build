...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){p=n("meta"),W=d(),h=n("h1"),_=n("a"),D=n("span"),v(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Vt=d(),N=n("h2"),Z=n("a"),ut=n("span"),v(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),Lt=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),me=n("a"),Eo=r(`Performance-Efficiency Trade-offs
...
Yoav Artzi.`),ct.forEach(o),jn=c(O),qe=s(O,"P",{});var po=a(qe);Pn=i(po,"This model inherits from "),nt=s(po,"A",{href:!0});var ia=a(nt);Fn=i(ia,"PreTrainedModel"),ia.forEach(o),Mn=i(po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),zn=c(O),xe=s(O,"P",{});var fo=a(xe);An=i(fo,"This model is a PyTorch "),je=s(fo,"A",{href:!0,rel:!0});var la=a(je);Vn=i(la,"torch.nn.Module"),la.forEach(o),Ln=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),On=c(O),C=s(O,"DIV",{class:!0});var F=a(C);w(Pe.$$.fragment,F),In=c(F),Y=s(F,"P",{});var mt=a(Y);Nn=i(mt,"The "),st=s(mt,"A",{href:!0});var da=a(st);Kn=i(da,"SEWDForCTC"),da.forEach(o),Hn=i(mt," forward method, overrides the "),$t=s(mt,"CODE",{});var ca=a($t);Rn=i(ca,"__call__"),ca.forEach(o),Un=i(mt," special method."),mt.forEach(o),Jn=c(F),w(ie.$$.fragment,F),Qn=c(F),qt=s(F,"P",{});var ma=a(qt);Bn=i(ma,"Example:"),ma.forEach(o),Yn=c(F),w(Fe.$$.fragment,F),Gn=c(F),w(Me.$$.fragment,F),F.forEach(o),O.forEach(o),Gt=c(t),G=s(t,"H2",{class:!0});var ho=a(G);le=s(ho,"A",{id:!0,class:!0,href:!0});var pa=a(le);xt=s(pa,"SPAN",{});var fa=a(xt);w(ze.$$.fragment,fa),fa.forEach(o),pa.forEach(o),Xn=c(ho),jt=s(ho,"SPAN",{});var ha=a(jt);Zn=i(ha,"SEWDForSequenceClassification"),ha.forEach(o),ho.forEach(o),Xt=c(t),k=s(t,"DIV",{class:!0});var M=a(k);w(Ae.$$.fragment,M),es=c(M),Pt=s(M,"P",{});var ua=a(Pt);ts=i(ua,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
