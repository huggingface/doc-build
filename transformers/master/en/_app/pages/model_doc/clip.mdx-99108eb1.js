...
testing).`,name:"initializer_factor"}]}}),cs=new N({props:{codee:`from transformers import CLIPTextModel, CLIPTextConfig
...
A factor for initializing all weight matrices (should be kept to 1, used internally for initialization
testing).`,name:"initializer_factor"}]}}),fs=new N({props:{codee:`from transformers import CLIPVisionModel, CLIPVisionConfig
...
`}}),Io=new ce({props:{$$slots:{default:[dP]},$$scope:{ctx:x}}}),Hs=new N({props:{codee:`from PIL import Image
import requests
from transformers import CLIPProcessor, CLIPModel
...
applying the projection layer to the pooled output of <a
  href="/docs/transformers/master/en/model_doc/clip#transformers.CLIPTextModel"
>CLIPTextModel</a>.</p>
`}}),To=new ce({props:{$$slots:{default:[cP]},$$scope:{ctx:x}}}),Gs=new N({props:{codee:`from transformers import CLIPTokenizer, CLIPModel
...
applying the projection layer to the pooled output of <a
  href="/docs/transformers/master/en/model_doc/clip#transformers.CLIPVisionModel"
>CLIPVisionModel</a>.</p>
`}}),Co=new ce({props:{$$slots:{default:[pP]},$$scope:{ctx:x}}}),Xs=new N({props:{codee:`from PIL import Image
import requests
from transformers import CLIPProcessor, CLIPModel
...
`}}),yo=new ce({props:{$$slots:{default:[mP]},$$scope:{ctx:x}}}),en=new N({props:{codee:`from transformers import CLIPTokenizer, CLIPTextModel
...
`}}),ko=new ce({props:{$$slots:{default:[hP]},$$scope:{ctx:x}}}),nn=new N({props:{codee:`from PIL import Image
import requests
...
`}}),xo=new ce({props:{$$slots:{default:[uP]},$$scope:{ctx:x}}}),mn=new N({props:{codee:`import tensorflow as tf
...
the projection layer to the pooled output of <a
  href="/docs/transformers/master/en/model_doc/clip#transformers.TFCLIPTextModel"
>TFCLIPTextModel</a>.</p>
`}}),Eo=new ce({props:{$$slots:{default:[gP]},$$scope:{ctx:x}}}),fn=new N({props:{codee:`from transformers import CLIPTokenizer, TFCLIPModel
...
`}}),zo=new ce({props:{$$slots:{default:[_P]},$$scope:{ctx:x}}}),gn=new N({props:{codee:`from PIL import Image
import requests
from transformers import CLIPProcessor, TFCLIPModel
...
`}}),Mo=new ce({props:{$$slots:{default:[vP]},$$scope:{ctx:x}}}),In=new N({props:{codee:`from transformers import CLIPTokenizer, TFCLIPTextModel
...
`}}),qo=new ce({props:{$$slots:{default:[PP]},$$scope:{ctx:x}}}),yn=new N({props:{codee:`from PIL import Image
import requests
...
`}}),Ao=new ce({props:{$$slots:{default:[IP]},$$scope:{ctx:x}}}),qn=new N({props:{codee:`import jax
from PIL import Image
import requests
...
`}}),An=new N({props:{codee:`from transformers import CLIPTokenizer, FlaxCLIPModel
...
`}}),Vn=new N({props:{codee:`from PIL import Image
import requests
from transformers import CLIPProcessor, FlaxCLIPModel
...
`}}),Vo=new ce({props:{$$slots:{default:[TP]},$$scope:{ctx:x}}}),Bn=new N({props:{codee:`from transformers import CLIPTokenizer, FlaxCLIPTextModel
...
`}}),So=new ce({props:{$$slots:{default:[CP]},$$scope:{ctx:x}}}),Kn=new N({props:{codee:`from PIL import Image
import requests
...
size is given, it will be padded (so the returned result has the size asked).`),Wp=l(),uo=s("div"),g(Fs.$$.fragment),Bp=l(),It=s("p"),Up=r("Resizes "),Or=s("code"),Rp=r("image"),Hp=r(". Note that this will trigger a conversion of "),Sr=s("code"),Kp=r("image"),Gp=r(" to a PIL Image."),_l=l(),Tt=s("h2"),go=s("a"),Wr=s("span"),g(qs.$$.fragment),Jp=l(),Br=s("span"),Xp=r("CLIPProcessor"),vl=l(),U=s("div"),g(Ds.$$.fragment),Zp=l(),Ur=s("p"),Qp=r("Constructs a CLIP processor which wraps a CLIP feature extractor and a CLIP tokenizer into a single processor."),Yp=l(),K=s("p"),La=s("a"),em=r("CLIPProcessor"),tm=r(" offers all the functionalities of "),ka=s("a"),om=r("CLIPFeatureExtractor"),sm=r(" and "),wa=s("a"),nm=r("CLIPTokenizer"),am=r(`. See the
`),Rr=s("code"),rm=r("__call__()"),im=r("and "),$a=s("a"),lm=r("decode()"),dm=r(" for more information."),cm=l(),_o=s("div"),g(As.$$.fragment),pm=l(),Ns=s("p"),mm=r("This method forwards all its arguments to CLIPTokenizer\u2019s "),xa=s("a"),hm=r("batch_decode()"),fm=r(`. Please refer
to the docstring of this method for more information.`),um=l(),vo=s("div"),g(Vs.$$.fragment),gm=l(),Os=s("p"),_m=r("This method forwards all its arguments to CLIPTokenizer\u2019s "),Ea=s("a"),vm=r("decode()"),Pm=r(`. Please refer to the
docstring of this method for more information.`),Pl=l(),Ct=s("h2"),Po=s("a"),Hr=s("span"),g(Ss.$$.fragment),Im=l(),Kr=s("span"),Tm=r("CLIPModel"),Il=l(),R=s("div"),g(Ws.$$.fragment),Cm=l(),Bs=s("p"),bm=r("This model is a PyTorch "),Us=s("a"),ym=r("torch.nn.Module"),Lm=r(` subclass. Use it
