import{S as tn,i as nn,s as on,e as o,k as p,w as E,t as r,R as sn,c as s,d as n,m,a as i,x as $,h as a,b as l,F as t,g as d,y as A,L as rn,q as P,o as N,B as I}from"../../chunks/vendor-9daddcfa.js";import{D as xt}from"../../chunks/Docstring-ea6f8b76.js";import{C as en}from"../../chunks/CodeBlock-37b92346.js";import{I as zt}from"../../chunks/IconCopyLink-a413fd1b.js";import"../../chunks/CopyButton-6099fd9d.js";function an(Se){let _,V,h,f,le,U,Ke,ce,Re,ge,b,T,de,W,De,pe,Fe,_e,k,Oe,S,Be,je,K,Xe,Ce,ke,J,Ye,ye,G,He,ve,Q,me,Ve,be,Z,Je,we,R,Te,L,Ge,ee,Qe,Ze,Le,D,qe,q,et,te,tt,nt,xe,y,ot,F,st,it,O,rt,at,ze,w,x,ue,B,lt,he,ct,Me,u,j,dt,g,pt,ne,mt,ut,oe,ht,ft,X,gt,_t,kt,C,yt,se,vt,bt,wt,z,Y,Tt,fe,Lt,qt,ie,H,Ee;return U=new zt({}),W=new zt({}),R=new en({props:{code:`from transformers import LukeModel
...
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/mluke/tokenization_mluke.py#L1493"}}),{c(){_=o("meta"),V=p(),h=o("h1"),f=o("a"),le=o("span"),E(U.$$.fragment),Ke=p(),ce=o("span"),Re=r("mLUKE"),ge=p(),b=o("h2"),T=o("a"),de=o("span"),E(W.$$.fragment),De=p(),pe=o("span"),Fe=r("Overview"),_e=p(),k=o("p"),Oe=r("The mLUKE model was proposed in "),S=o("a"),Be=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),je=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
knowledge more likely than using only word representations.`),be=p(),Z=o("p"),Je=r("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),we=p(),E(R.$$.fragment),Te=p(),L=o("p"),Ge=r("Note that mLUKE has its own tokenizer, "),ee=o("a"),Qe=r("MLukeTokenizer"),Ze=r(". You can initialize it as follows:"),Le=p(),E(D.$$.fragment),qe=p(),q=o("p"),et=r("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),te=o("a"),tt=r("LUKE\u2019s documentation page"),nt=r(` for all
...
sequences, depending on the task you want to prepare them for.`),qt=p(),ie=o("div"),E(H.$$.fragment),this.h()},l(e){const c=sn('[data-svelte="svelte-1phssyn"]',document.head);_=s(c,"META",{name:!0,content:!0}),c.forEach(n),V=m(e),h=s(e,"H1",{class:!0});var $e=i(h);f=s($e,"A",{id:!0,class:!0,href:!0});var Mt=i(f);le=s(Mt,"SPAN",{});var Et=i(le);$(U.$$.fragment,Et),Et.forEach(n),Mt.forEach(n),Ke=m($e),ce=s($e,"SPAN",{});var $t=i(ce);Re=a($t,"mLUKE"),$t.forEach(n),$e.forEach(n),ge=m(e),b=s(e,"H2",{class:!0});var Ae=i(b);T=s(Ae,"A",{id:!0,class:!0,href:!0});var At=i(T);de=s(At,"SPAN",{});var Pt=i(de);$(W.$$.fragment,Pt),Pt.forEach(n),At.forEach(n),De=m(Ae),pe=s(Ae,"SPAN",{});var Nt=i(pe);Fe=a(Nt,"Overview"),Nt.forEach(n),Ae.forEach(n),_e=m(e),k=s(e,"P",{});var re=i(k);Oe=a(re,"The mLUKE model was proposed in "),S=s(re,"A",{href:!0,rel:!0});var It=i(S);Be=a(It,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),It.forEach(n),je=a(re,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
representations into the input allows us to extract more language-agnostic features. We also evaluate the model with a
multilingual cloze prompt task with the mLAMA dataset. We show that entity-based prompt elicits correct factual
knowledge more likely than using only word representations.`),Rt.forEach(n),Kt.forEach(n),be=m(e),Z=s(e,"P",{});var Dt=i(Z);Je=a(Dt,"One can directly plug in the weights of mLUKE into a LUKE model, like so:"),Dt.forEach(n),we=m(e),$(R.$$.fragment,e),Te=m(e),L=s(e,"P",{});var Pe=i(L);Ge=a(Pe,"Note that mLUKE has its own tokenizer, "),ee=s(Pe,"A",{href:!0});var Ft=i(ee);Qe=a(Ft,"MLukeTokenizer"),Ft.forEach(n),Ze=a(Pe,". You can initialize it as follows:"),Pe.forEach(n),Le=m(e),$(D.$$.fragment,e),qe=m(e),q=s(e,"P",{});var Ne=i(q);et=a(Ne,"As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),te=s(Ne,"A",{href:!0});var Ot=i(te);tt=a(Ot,"LUKE\u2019s documentation page"),Ot.forEach(n),nt=a(Ne,` for all
