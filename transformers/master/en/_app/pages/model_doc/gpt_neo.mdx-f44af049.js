import{S as Ql,i as Yl,s as Zl,e as n,k as d,w as _,t as r,M as ed,c as s,d as o,m as c,a,x as T,h as i,b as l,F as e,g as u,y as v,q as y,o as P,B as k}from"../../chunks/vendor-4833417e.js";import{T as rn}from"../../chunks/Tip-fffd6df1.js";import{D as V}from"../../chunks/Docstring-7b52c3d4.js";import{C as je}from"../../chunks/CodeBlock-90ffda97.js";import{I as _e}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function td(O){let p,w,m,b,N;return{c(){p=n("p"),w=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),b=r("Module"),N=r(`
...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var f=a(p);w=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(f,"CODE",{});var $=a(m);b=i($,"Module"),$.forEach(o),N=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,p,f),e(p,w),e(p,m),e(m,b),e(p,N)},d(g){g&&o(p)}}}function rd(O){let p,w,m,b,N,g,f,$,Jn,ln,oe,Te,ro,Ae,Rn,io,Xn,dn,J,Kn,Ie,Qn,Yn,Le,Zn,es,cn,Lt,ts,pn,ve,os,Se,ns,ss,hn,ne,ye,lo,De,as,co,rs,un,Pe,is,po,ls,ds,mn,Be,fn,se,ke,ho,Oe,cs,uo,ps,gn,z,We,hs,ae,us,St,ms,fs,He,gs,_s,Ts,re,vs,Dt,ys,Ps,Bt,ks,bs,ws,mo,Ns,$s,Ue,_n,ie,be,fo,Ve,Gs,go,xs,Tn,F,Je,Ms,_o,Es,zs,Re,Fs,Ot,qs,Cs,js,Xe,As,Ke,Is,Ls,Ss,C,Qe,Ds,le,Bs,Wt,Os,Ws,To,Hs,Us,Vs,we,Js,vo,Rs,Xs,Ye,vn,de,Ne,yo,Ze,Ks,Po,Qs,yn,q,et,Ys,ko,Zs,ea,tt,ta,Ht,oa,na,sa,ot,aa,nt,ra,ia,la,j,st,da,ce,ca,Ut,pa,ha,bo,ua,ma,fa,$e,ga,wo,_a,Ta,at,Pn,pe,Ge,No,rt,va,$o,ya,kn,G,it,Pa,Go,ka,ba,Vt,Jt,wa,Na,$a,W,Ga,xo,xa,Ma,Mo,Ea,za,Eo,Fa,qa,zo,Ca,ja,Aa,lt,Ia,Rt,La,Sa,Da,dt,Ba,ct,Oa,Wa,Ha,E,pt,Ua,he,Va,Xt,Ja,Ra,Fo,Xa,Ka,Qa,xe,Ya,qo,Za,er,ht,tr,Co,or,nr,ut,bn,ue,Me,jo,mt,sr,Ao,ar,wn,x,ft,rr,Io,ir,lr,gt,dr,Kt,cr,pr,hr,_t,ur,Tt,mr,fr,gr,Lo,_r,Tr,H,So,vt,vr,yr,Do,yt,Pr,kr,Bo,Pt,br,wr,Oo,kt,Nr,$r,A,bt,Gr,me,xr,Wo,Mr,Er,Ho,zr,Fr,qr,Ee,Cr,Uo,jr,Ar,wt,Nn,fe,ze,Vo,Nt,Ir,Jo,Lr,$n,M,$t,Sr,Ro,Dr,Br,Gt,Or,Qt,Wr,Hr,Ur,xt,Vr,Mt,Jr,Rr,Xr,Xo,Kr,Qr,U,Ko,Et,Yr,Zr,Qo,zt,ei,ti,Yo,Ft,oi,ni,Zo,qt,si,ai,I,Ct,ri,ge,ii,en,li,di,tn,ci,pi,hi,Fe,ui,on,mi,fi,jt,Gn;return g=new _e({}),Ae=new _e({}),De=new _e({}),Be=new je({props:{codee:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/master/en/model_doc/gpt_neo#transformers.GPTNeoModel">GPTNeoModel</a>. Vocabulary size of the model. Defines the different
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Ve=new _e({}),Je=new V({props:{name:"class transformers.GPTNeoModel",anchor:"transformers.GPTNeoModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L475",parametersDescription:[{anchor:"transformers.GPTNeoModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qe=new V({props:{name:"forward",anchor:"transformers.GPTNeoModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L496",parametersDescription:[{anchor:"transformers.GPTNeoModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ze=new _e({}),et=new V({props:{name:"class transformers.GPTNeoForCausalLM",anchor:"transformers.GPTNeoForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L663",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),st=new V({props:{name:"forward",anchor:"transformers.GPTNeoForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L713",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
256 tokens.`),pn=d(),ve=n("p"),os=r("This model was contributed by "),Se=n("a"),ns=r("valhalla"),ss=r("."),hn=d(),ne=n("h3"),ye=n("a"),lo=n("span"),_(De.$$.fragment),as=d(),co=n("span"),rs=r("Generation"),un=d(),Pe=n("p"),is=r("The "),po=n("code"),ls=r("generate()"),ds=r(" method can be used to generate text using GPT Neo model."),mn=d(),_(Be.$$.fragment),fn=d(),se=n("h2"),ke=n("a"),ho=n("span"),_(Oe.$$.fragment),cs=d(),uo=n("span"),ps=r("GPTNeoConfig"),gn=d(),z=n("div"),_(We.$$.fragment),hs=d(),ae=n("p"),us=r("This is the configuration class to store the configuration of a "),St=n("a"),ms=r("GPTNeoModel"),fs=r(`. It is used to instantiate a GPT
...
documentation from `),Bt=n("a"),ks=r("PretrainedConfig"),bs=r(" for more information."),ws=d(),mo=n("p"),Ns=r("Example:"),$s=d(),_(Ue.$$.fragment),_n=d(),ie=n("h2"),be=n("a"),fo=n("span"),_(Ve.$$.fragment),Gs=d(),go=n("span"),xs=r("GPTNeoModel"),Tn=d(),F=n("div"),_(Je.$$.fragment),Ms=d(),_o=n("p"),Es=r("The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),zs=d(),Re=n("p"),Fs=r("This model inherits from "),Ot=n("a"),qs=r("PreTrainedModel"),Cs=r(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ha=d(),E=n("div"),_(pt.$$.fragment),Ua=d(),he=n("p"),Va=r("The "),Xt=n("a"),Ja=r("GPTNeoForSequenceClassification"),Ra=r(" forward method, overrides the "),Fo=n("code"),Xa=r("__call__"),Ka=r(" special method."),Qa=d(),_(xe.$$.fragment),Ya=d(),qo=n("p"),Za=r("Example of single-label classification:"),er=d(),_(ht.$$.fragment),tr=d(),Co=n("p"),or=r("Example of multi-label classification:"),nr=d(),_(ut.$$.fragment),bn=d(),ue=n("h2"),Me=n("a"),jo=n("span"),_(mt.$$.fragment),sr=d(),Ao=n("span"),ar=r("FlaxGPTNeoModel"),wn=d(),x=n("div"),_(ft.$$.fragment),rr=d(),Io=n("p"),ir=r("The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),lr=d(),gt=n("p"),dr=r("This model inherits from "),Kt=n("a"),cr=r("FlaxPreTrainedModel"),pr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hr=d(),_t=n("p"),ur=r(`This model is also a Flax Linen
`),Tt=n("a"),mr=r("flax.nn.Module"),fr=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),gr=d(),Lo=n("p"),_r=r("Finally, this model supports inherent JAX features such as:"),Tr=d(),H=n("ul"),So=n("li"),vt=n("a"),vr=r("Just-In-Time (JIT) compilation"),yr=d(),Do=n("li"),yt=n("a"),Pr=r("Automatic Differentiation"),kr=d(),Bo=n("li"),Pt=n("a"),br=r("Vectorization"),wr=d(),Oo=n("li"),kt=n("a"),Nr=r("Parallelization"),$r=d(),A=n("div"),_(bt.$$.fragment),Gr=d(),me=n("p"),xr=r("The "),Wo=n("code"),Mr=r("FlaxGPTNeoPreTrainedModel"),Er=r("forward method, overrides the "),Ho=n("code"),zr=r("__call__"),Fr=r(" special method."),qr=d(),_(Ee.$$.fragment),Cr=d(),Uo=n("p"),jr=r("Example:"),Ar=d(),_(wt.$$.fragment),Nn=d(),fe=n("h2"),ze=n("a"),Vo=n("span"),_(Nt.$$.fragment),Ir=d(),Jo=n("span"),Lr=r("FlaxGPTNeoForCausalLM"),$n=d(),M=n("div"),_($t.$$.fragment),Sr=d(),Ro=n("p"),Dr=r(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
documentation from `),Bt=s(eo,"A",{href:!0});var Ci=a(Bt);ks=i(Ci,"PretrainedConfig"),Ci.forEach(o),bs=i(eo," for more information."),eo.forEach(o),ws=c(R),mo=s(R,"P",{});var ji=a(mo);Ns=i(ji,"Example:"),ji.forEach(o),$s=c(R),T(Ue.$$.fragment,R),R.forEach(o),_n=c(t),ie=s(t,"H2",{class:!0});var Fn=a(ie);be=s(Fn,"A",{id:!0,class:!0,href:!0});var Ai=a(be);fo=s(Ai,"SPAN",{});var Ii=a(fo);T(Ve.$$.fragment,Ii),Ii.forEach(o),Ai.forEach(o),Gs=c(Fn),go=s(Fn,"SPAN",{});var Li=a(go);xs=i(Li,"GPTNeoModel"),Li.forEach(o),Fn.forEach(o),Tn=c(t),F=s(t,"DIV",{class:!0});var X=a(F);T(Je.$$.fragment,X),Ms=c(X),_o=s(X,"P",{});var Si=a(_o);Es=i(Si,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),Si.forEach(o),zs=c(X),Re=s(X,"P",{});var qn=a(Re);Fs=i(qn,"This model inherits from "),Ot=s(qn,"A",{href:!0});var Di=a(Ot);qs=i(Di,"PreTrainedModel"),Di.forEach(o),Cs=i(qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
