...
</ul>`,name:"kwargs"}]}}),te=new kn({props:{codee:`from transformers import BertConfig, Wav2Vec2Config, SpeechEncoderDecoderConfig, SpeechEncoderDecoderModel
...
`}}),Q=new br({props:{$$slots:{default:[wr]},$$scope:{ctx:Be}}}),ge=new kn({props:{codee:`from transformers import SpeechEncoderDecoderModel, Speech2Text2Processor
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),ve=new kn({props:{codee:`from transformers import SpeechEncoderDecoderModel
