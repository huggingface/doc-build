import{S as Ck,i as Sk,s as Ak,e as n,k as d,w as m,t as r,R as Ik,c as s,d as t,m as l,a,x as g,h as i,b as c,F as e,g as u,y as f,q as _,o as k,B as v}from"../../chunks/vendor-9daddcfa.js";import{T as qo}from"../../chunks/Tip-c0a70391.js";import{D as M}from"../../chunks/Docstring-ea6f8b76.js";import{C as Se}from"../../chunks/CodeBlock-37b92346.js";import{I as Z}from"../../chunks/IconCopyLink-a413fd1b.js";import"../../chunks/CopyButton-6099fd9d.js";function Ok(G){let h,z,b,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),T=r("Module"),x=r(`
...
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(P,"CODE",{});var $=a(b);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,b),e(b,T),e(h,x)},d(w){w&&t(h)}}}function Rk(G){let h,z,b,T,x,w,P,$,Ae,me,E,we,ae,Ie,re,ie,Oe,Me,D,A,xe,K,C,S,Le,Y,ee,Ne,U,Ge,De,I,ge,de,je,te,V,Ue,Be,B,We,oe,R,y,q,ze,mt,$e,Q,gt,Ve,le,O,J,qe,ft,X,_t,Qe,H,kt,Eo,Yd,el,ca,tl,ol,Mi,fe,ua,nl,sl,pa,al,rl,ha,il,dl,Fo,ll,Mo,cl,ul,pl,Wt,jo,hl,ml,Co,gl,fl,ji,vt,Rt,ma,So,_l,ga,kl,Ci,Je,Ht,Ao,vl,yl,Io,bl,Tl,Pl,fa,wl,xl,_a,zl,Si,yt,Kt,ka,Oo,$l,va,ql,Ai,_e,ya,ba,El,Fl,Ta,xs,Ml,zs,jl,Cl,Lo,Pa,Sl,Al,bt,wa,Il,Ol,xa,Ll,Nl,No,Gl,za,Dl,Ul,Bl,$a,Re,Wl,qa,Rl,Hl,Ea,Kl,Vl,Fa,Ql,Jl,Xl,Ma,Tt,Zl,Go,Yl,ec,ja,tc,oc,Ii,Pt,Vt,Ca,Do,nc,Sa,sc,Oi,Uo,Li,wt,Qt,Aa,Bo,ac,Ia,rc,Ni,ce,Wo,ic,xt,dc,$s,lc,cc,Ro,uc,pc,hc,zt,mc,qs,gc,fc,Es,_c,kc,vc,Oa,yc,bc,Ho,Gi,$t,Jt,La,Ko,Tc,Na,Pc,Di,Xt,wc,Ga,xc,zc,Ui,W,Vo,$c,Qo,qc,Jo,Ec,Fc,Mc,Xo,jc,Fs,Cc,Sc,Ac,Ce,Zo,Ic,Yo,Oc,Da,Lc,Nc,Gc,en,Ms,Dc,Ua,Uc,Bc,tn,Wc,Ba,Rc,Hc,Kc,Wa,Vc,Qc,Zt,on,Jc,Ra,Xc,Zc,Yt,nn,Yc,Ha,eu,tu,eo,sn,ou,Ka,nu,Bi,qt,to,Va,an,su,Qa,au,Wi,ue,rn,ru,Et,iu,Ja,du,lu,dn,cu,uu,pu,ln,hu,js,mu,gu,fu,Xe,cn,_u,Xa,ku,vu,un,Cs,yu,Za,bu,Tu,pn,Pu,Ya,wu,xu,zu,oo,hn,$u,er,qu,Ri,Ft,no,tr,mn,Eu,or,Fu,Hi,Ee,gn,Mu,fn,ju,Ss,Cu,Su,Au,_n,Iu,kn,Ou,Lu,Nu,ke,vn,Gu,Mt,Du,As,Uu,Bu,nr,Wu,Ru,Hu,so,Ku,sr,Vu,Qu,yn,Ki,jt,ao,ar,bn,Ju,rr,Xu,Vi,Fe,Tn,Zu,Pn,Yu,Is,ep,tp,op,wn,np,xn,sp,ap,rp,ve,zn,ip,Ct,dp,Os,lp,cp,ir,up,pp,hp,ro,mp,dr,gp,fp,$n,Qi,St,io,lr,qn,_p,cr,kp,Ji,At,En,vp,Ze,Fn,yp,ur,bp,Tp,Mn,Xi,It,lo,pr,jn,Pp,hr,wp,Zi,pe,Cn,xp,Sn,zp,Ls,$p,qp,Ep,An,Fp,In,Mp,jp,Cp,co,Sp,ye,On,Ap,Ot,Ip,Ns,Op,Lp,mr,Np,Gp,Dp,uo,Up,gr,Bp,Wp,Ln,Yi,Lt,po,fr,Nn,Rp,_r,Hp,ed,he,Gn,Kp,Dn,Vp,Gs,Qp,Jp,Xp,Un,Zp,Bn,Yp,eh,th,ho,oh,be,Wn,nh,Nt,sh,Ds,ah,rh,kr,ih,dh,lh,mo,ch,vr,uh,ph,Rn,td,Gt,go,yr,Hn,hh,br,mh,od,L,Kn,gh,Vn,fh,Us,_h,kh,vh,Qn,yh,Jn,bh,Th,Ph,Tr,wh,xh,He,Pr,Xn,zh,$h,wr,Zn,qh,Eh,xr,Yn,Fh,Mh,zr,es,jh,Ch,Te,ts,Sh,Dt,Ah,$r,Ih,Oh,qr,Lh,Nh,Gh,fo,Dh,Er,Uh,Bh,os,Wh,Ye,ns,Rh,Fr,Hh,Kh,ss,Vh,et,as,Qh,Mr,Jh,Xh,rs,nd,Ut,_o,jr,is,Zh,Cr,Yh,sd,N,ds,em,ls,tm,Bs,om,nm,sm,cs,am,us,rm,im,dm,Sr,lm,cm,Ke,Ar,ps,um,pm,Ir,hs,hm,mm,Or,ms,gm,fm,Lr,gs,_m,km,F,fs,vm,Bt,ym,Nr,bm,Tm,Gr,Pm,wm,xm,ko,zm,Dr,$m,qm,Ur,Br,Wr,Rr,Em,Fm,Hr,Kr,Vr,Qr,Mm,jm,Jr,Xr,Zr,Yr,Cm,Sm,ei,ti,_s,vo,yo,oi,ks,Am,ni,Im,Om,si,Lm,Nm,ai,Gm,Dm,ri,ii,di,li,Um,Bm,ci,ui,pi,hi,Wm,Rm,mi,gi,fi,_i,Hm,Km,ki,vi,yi,bi,Vm,Qm,tt,vs,Jm,Ti,Xm,Zm,ys,Ym,ot,bs,eg,Pi,tg,og,Ts,ad;return w=new Z({}),K=new Z({}),qe=new Z({}),So=new Z({}),Oo=new Z({}),Do=new Z({}),Uo=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
`}}),mo=new qo({props:{$$slots:{default:[Uk]},$$scope:{ctx:G}}}),Rn=new Se({props:{code:`from transformers import PegasusTokenizer, TFPegasusForConditionalGeneration
...
extractive summary.`),Be=d(),B=n("li"),We=r("Pegasus achieves SOTA summarization performance on all 12 downstream tasks, as measured by ROUGE and human eval."),oe=d(),R=n("p"),y=r("This model was contributed by "),q=n("a"),ze=r("sshleifer"),mt=r(". The Authors\u2019 code can be found "),$e=n("a"),Q=r("here"),gt=r("."),Ve=d(),le=n("h2"),O=n("a"),J=n("span"),m(qe.$$.fragment),ft=d(),X=n("span"),_t=r("Checkpoints"),Qe=d(),H=n("p"),kt=r("All the "),Eo=n("a"),Yd=r("checkpoints"),el=r(` are fine-tuned for summarization, besides
`),ca=n("em"),tl=r("pegasus-large"),ol=r(", whence the other checkpoints are fine-tuned:"),Mi=d(),fe=n("ul"),ua=n("li"),nl=r("Each checkpoint is 2.2 GB on disk and 568M parameters."),sl=d(),pa=n("li"),al=r("FP16 is not supported (help/ideas on this appreciated!)."),rl=d(),ha=n("li"),il=r("Summarizing xsum in fp32 takes about 400ms/sample, with default parameters on a v100 GPU."),dl=d(),Fo=n("li"),ll=r("Full replication results and correctly pre-processed data can be found in this "),Mo=n("a"),cl=r("Issue"),ul=r("."),pl=d(),Wt=n("li"),jo=n("a"),hl=r("Distilled checkpoints"),ml=r(" are described in this "),Co=n("a"),gl=r("paper"),fl=r("."),ji=d(),vt=n("h3"),Rt=n("a"),ma=n("span"),m(So.$$.fragment),_l=d(),ga=n("span"),kl=r("Examples"),Ci=d(),Je=n("ul"),Ht=n("li"),Ao=n("a"),vl=r("Script"),yl=r(` to fine-tune pegasus
...
documentation from `),Es=n("a"),_c=r("PretrainedConfig"),kc=r(" for more information."),vc=d(),Oa=n("p"),yc=r("Example:"),bc=d(),m(Ho.$$.fragment),Gi=d(),$t=n("h2"),Jt=n("a"),La=n("span"),m(Ko.$$.fragment),Tc=d(),Na=n("span"),Pc=r("PegasusTokenizer"),Di=d(),Xt=n("p"),wc=r("warning: "),Ga=n("code"),xc=r("add_tokens"),zc=r(" does not work at the moment."),Ui=d(),W=n("div"),m(Vo.$$.fragment),$c=d(),Qo=n("p"),qc=r("Construct a PEGASUS tokenizer. Based on "),Jo=n("a"),Ec=r("SentencePiece"),Fc=r("."),Mc=d(),Xo=n("p"),jc=r("This tokenizer inherits from "),Fs=n("a"),Cc=r("PreTrainedTokenizer"),Sc=r(` which contains most of the main methods. Users should refer to
...
and behavior.`),Nu=d(),ke=n("div"),m(vn.$$.fragment),Gu=d(),Mt=n("p"),Du=r("The "),As=n("a"),Uu=r("PegasusModel"),Bu=r(" forward method, overrides the "),nr=n("code"),Wu=r("__call__"),Ru=r(" special method."),Hu=d(),m(so.$$.fragment),Ku=d(),sr=n("p"),Vu=r("Example:"),Qu=d(),m(yn.$$.fragment),Ki=d(),jt=n("h2"),ao=n("a"),ar=n("span"),m(bn.$$.fragment),Ju=d(),rr=n("span"),Xu=r("PegasusForConditionalGeneration"),Vi=d(),Fe=n("div"),m(Tn.$$.fragment),Zu=d(),Pn=n("p"),Yu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Kd.forEach(t),Ph=l(ne),Tr=s(ne,"P",{});var v_=a(Tr);wh=i(v_,"Finally, this model supports inherent JAX features such as:"),v_.forEach(t),xh=l(ne),He=s(ne,"UL",{});var zo=a(He);Pr=s(zo,"LI",{});var y_=a(Pr);Xn=s(y_,"A",{href:!0,rel:!0});var b_=a(Xn);zh=i(b_,"Just-In-Time (JIT) compilation"),b_.forEach(t),y_.forEach(t),$h=l(zo),wr=s(zo,"LI",{});var T_=a(wr);Zn=s(T_,"A",{href:!0,rel:!0});var P_=a(Zn);qh=i(P_,"Automatic Differentiation"),P_.forEach(t),T_.forEach(t),Eh=l(zo),xr=s(zo,"LI",{});var w_=a(xr);Yn=s(w_,"A",{href:!0,rel:!0});var x_=a(Yn);Fh=i(x_,"Vectorization"),x_.forEach(t),w_.forEach(t),Mh=l(zo),zr=s(zo,"LI",{});var z_=a(zr);es=s(z_,"A",{href:!0,rel:!0});var $_=a(es);jh=i($_,"Parallelization"),$_.forEach(t),z_.forEach(t),zo.forEach(t),Ch=l(ne),Te=s(ne,"DIV",{class:!0});var ht=a(Te);g(ts.$$.fragment,ht),Sh=l(ht),Dt=s(ht,"P",{});var sa=a(Dt);Ah=i(sa,"The "),$r=s(sa,"CODE",{});var q_=a($r);Ih=i(q_,"FlaxPegasusPreTrainedModel"),q_.forEach(t),Oh=i(sa,"forward method, overrides the "),qr=s(sa,"CODE",{});var E_=a(qr);Lh=i(E_,"__call__"),E_.forEach(t),Nh=i(sa," special method."),sa.forEach(t),Gh=l(ht),g(fo.$$.fragment,ht),Dh=l(ht),Er=s(ht,"P",{});var F_=a(Er);Uh=i(F_,"Example:"),F_.forEach(t),Bh=l(ht),g(os.$$.fragment,ht),ht.forEach(t),Wh=l(ne),Ye=s(ne,"DIV",{class:!0});var aa=a(Ye);g(ns.$$.fragment,aa),Rh=l(aa),Fr=s(aa,"P",{});var M_=a(Fr);Hh=i(M_,"Example:"),M_.forEach(t),Kh=l(aa),g(ss.$$.fragment,aa),aa.forEach(t),Vh=l(ne),et=s(ne,"DIV",{class:!0});var ra=a(et);g(as.$$.fragment,ra),Qh=l(ra),Mr=s(ra,"P",{});var j_=a(Mr);Jh=i(j_,"Example:"),j_.forEach(t),Xh=l(ra),g(rs.$$.fragment,ra),ra.forEach(t),ne.forEach(t),nd=l(o),Ut=s(o,"H2",{class:!0});var Vd=a(Ut);_o=s(Vd,"A",{id:!0,class:!0,href:!0});var C_=a(_o);jr=s(C_,"SPAN",{});var S_=a(jr);g(is.$$.fragment,S_),S_.forEach(t),C_.forEach(t),Zh=l(Vd),Cr=s(Vd,"SPAN",{});var A_=a(Cr);Yh=i(A_,"FlaxPegasusForConditionalGeneration"),A_.forEach(t),Vd.forEach(t),sd=l(o),N=s(o,"DIV",{class:!0});var se=a(N);g(ds.$$.fragment,se),em=l(se),ls=s(se,"P",{});var Qd=a(ls);tm=i(Qd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jd.forEach(t),dm=l(se),Sr=s(se,"P",{});var L_=a(Sr);lm=i(L_,"Finally, this model supports inherent JAX features such as:"),L_.forEach(t),cm=l(se),Ke=s(se,"UL",{});var $o=a(Ke);Ar=s($o,"LI",{});var N_=a(Ar);ps=s(N_,"A",{href:!0,rel:!0});var G_=a(ps);um=i(G_,"Just-In-Time (JIT) compilation"),G_.forEach(t),N_.forEach(t),pm=l($o),Ir=s($o,"LI",{});var D_=a(Ir);hs=s(D_,"A",{href:!0,rel:!0});var U_=a(hs);hm=i(U_,"Automatic Differentiation"),U_.forEach(t),D_.forEach(t),mm=l($o),Or=s($o,"LI",{});var B_=a(Or);ms=s(B_,"A",{href:!0,rel:!0});var W_=a(ms);gm=i(W_,"Vectorization"),W_.forEach(t),B_.forEach(t),fm=l($o),Lr=s($o,"LI",{});var R_=a(Lr);gs=s(R_,"A",{href:!0,rel:!0});var H_=a(gs);_m=i(H_,"Parallelization"),H_.forEach(t),R_.forEach(t),$o.forEach(t),km=l(se),F=s(se,"DIV",{class:!0});var j=a(F);g(fs.$$.fragment,j),vm=l(j),Bt=s(j,"P",{});var ia=a(Bt);ym=i(ia,"The "),Nr=s(ia,"CODE",{});var K_=a(Nr);bm=i(K_,"FlaxPegasusPreTrainedModel"),K_.forEach(t),Tm=i(ia,"forward method, overrides the "),Gr=s(ia,"CODE",{});var V_=a(Gr);Pm=i(V_,"__call__"),V_.forEach(t),wm=i(ia," special method."),ia.forEach(t),xm=l(j),g(ko.$$.fragment,j),zm=l(j),Dr=s(j,"P",{});var Q_=a(Dr);$m=i(Q_,"Summarization example:"),Q_.forEach(t),qm=l(j),Ur=s(j,"BLOCKQUOTE",{});var J_=a(Ur);Br=s(J_,"BLOCKQUOTE",{});var X_=a(Br);Wr=s(X_,"BLOCKQUOTE",{});var Z_=a(Wr);Rr=s(Z_,"P",{});var Y_=a(Rr);Em=i(Y_,"from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),Y_.forEach(t),Z_.forEach(t),X_.forEach(t),J_.forEach(t),Fm=l(j),Hr=s(j,"BLOCKQUOTE",{});var ek=a(Hr);Kr=s(ek,"BLOCKQUOTE",{});var tk=a(Kr);Vr=s(tk,"BLOCKQUOTE",{});var ok=a(Vr);Qr=s(ok,"P",{});var nk=a(Qr);Mm=i(nk,`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
