import{S as QT,i as HT,s as RT,e as a,k as l,w as k,t as n,Y as Po,M as UT,c as r,d as t,m as d,a as i,x as v,h as s,Z as jo,b as c,F as e,g as h,y as b,q as T,o as y,B as L}from"../../chunks/vendor-6b77c823.js";import{T as je}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-abef54e3.js";import{C as rt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ze}from"../../chunks/IconCopyLink-7a11ce68.js";function VT(Q){let p,x,g,u,$;return{c(){p=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),$=n(`
...
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function ZT(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,j,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,ae,K,R,re,_e,O,ie,U,we;return{c(){p=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),$=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=a("p"),Z=n("This second option is useful when using "),I=a("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),pe=n("model(inputs)"),le=n("."),G=l(),j=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),K=n(" or "),R=a("code"),re=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),O=a("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
tensors in the first argument of the model call function: `),S=r(A,"CODE",{});var $e=i(S);pe=s($e,"model(inputs)"),$e.forEach(t),le=s(A,"."),A.forEach(t),G=d(m),j=r(m,"P",{});var Fe=i(j);te=s(Fe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Fe.forEach(t),X=d(m),z=r(m,"UL",{});var P=i(z);C=r(P,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=r(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=r(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(P),q=r(P,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r(N,"CODE",{});var ke=i(W);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=r(N,"CODE",{});var be=i(R);re=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(P),O=r(P,"LI",{});var oe=i(O);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),P.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,j,F),e(j,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,ae),e(q,K),e(q,R),e(R,re),e(z,_e),e(z,O),e(O,ie),e(O,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(j),m&&t(X),m&&t(z)}}}function e1(Q){let p,x,g,u,$;return{c(){p=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function t1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,j,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,ae,K,R,re,_e,O,ie,U,we;return{c(){p=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),$=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=a("p"),Z=n("This second option is useful when using "),I=a("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),pe=n("model(inputs)"),le=n("."),G=l(),j=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=a("ul"),C=a("li"),ne=n("a single Tensor with "),H=a("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=a("code"),ge=n("model(inputs_ids)"),ce=l(),q=a("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),K=n(" or "),R=a("code"),re=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),O=a("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=r(m,"UL",{});var Y=i(u);$=r(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=r(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=r(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=r(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=d(m),z=r(m,"UL",{});var P=i(z);C=r(P,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=r(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=r(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(P),q=r(P,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r(N,"CODE",{});var ke=i(W);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=r(N,"CODE",{});var be=i(R);re=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(P),O=r(P,"LI",{});var oe=i(O);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),P.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,j,F),e(j,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,ae),e(q,K),e(q,R),e(R,re),e(z,_e),e(z,O),e(O,ie),e(O,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(j),m&&t(X),m&&t(z)}}}function o1(Q){let p,x,g,u,$;return{c(){p=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function n1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,j,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,ae,K,R,re,_e,O,ie,U,we;return{c(){p=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),$=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=a("p"),Z=n("This second option is useful when using "),I=a("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),pe=n("model(inputs)"),le=n("."),G=l(),j=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=a("ul"),C=a("li"),ne=n("a single Tensor with "),H=a("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=a("code"),ge=n("model(inputs_ids)"),ce=l(),q=a("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),K=n(" or "),R=a("code"),re=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),O=a("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=r(m,"UL",{});var Y=i(u);$=r(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=r(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=r(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=r(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=d(m),z=r(m,"UL",{});var P=i(z);C=r(P,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=r(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=r(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(P),q=r(P,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r(N,"CODE",{});var ke=i(W);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=r(N,"CODE",{});var be=i(R);re=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(P),O=r(P,"LI",{});var oe=i(O);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),P.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,j,F),e(j,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,ae),e(q,K),e(q,R),e(R,re),e(z,_e),e(z,O),e(O,ie),e(O,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(j),m&&t(X),m&&t(z)}}}function s1(Q){let p,x,g,u,$;return{c(){p=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function a1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,j,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,ae,K,R,re,_e,O,ie,U,we;return{c(){p=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),$=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=a("p"),Z=n("This second option is useful when using "),I=a("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),pe=n("model(inputs)"),le=n("."),G=l(),j=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=a("ul"),C=a("li"),ne=n("a single Tensor with "),H=a("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=a("code"),ge=n("model(inputs_ids)"),ce=l(),q=a("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),K=n(" or "),R=a("code"),re=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),O=a("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=r(m,"UL",{});var Y=i(u);$=r(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=r(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=r(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=r(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=d(m),z=r(m,"UL",{});var P=i(z);C=r(P,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=r(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=r(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(P),q=r(P,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r(N,"CODE",{});var ke=i(W);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=r(N,"CODE",{});var be=i(R);re=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(P),O=r(P,"LI",{});var oe=i(O);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),P.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,j,F),e(j,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,ae),e(q,K),e(q,R),e(R,re),e(z,_e),e(z,O),e(O,ie),e(O,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(j),m&&t(X),m&&t(z)}}}function r1(Q){let p,x,g,u,$;return{c(){p=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function i1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,j,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,ae,K,R,re,_e,O,ie,U,we;return{c(){p=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),$=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=a("p"),Z=n("This second option is useful when using "),I=a("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),pe=n("model(inputs)"),le=n("."),G=l(),j=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=a("ul"),C=a("li"),ne=n("a single Tensor with "),H=a("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=a("code"),ge=n("model(inputs_ids)"),ce=l(),q=a("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),K=n(" or "),R=a("code"),re=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),O=a("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=r(m,"UL",{});var Y=i(u);$=r(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=r(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=r(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=r(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=d(m),z=r(m,"UL",{});var P=i(z);C=r(P,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),H=r(V,"CODE",{});var xe=i(H);de=s(xe,"input_ids"),xe.forEach(t),se=s(V," only and nothing else: "),D=r(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=d(P),q=r(P,"LI",{});var N=i(q);ue=s(N,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r(N,"CODE",{});var ke=i(W);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(N," or "),R=r(N,"CODE",{});var be=i(R);re=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),N.forEach(t),_e=d(P),O=r(P,"LI",{});var oe=i(O);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(oe,"CODE",{});var Me=i(U);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(t),oe.forEach(t),P.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,me),h(m,J,F),h(m,E,F),e(E,Z),e(E,I),e(I,ee),e(E,fe),e(E,S),e(S,pe),e(E,le),h(m,G,F),h(m,j,F),e(j,te),h(m,X,F),h(m,z,F),e(z,C),e(C,ne),e(C,H),e(H,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,ae),e(q,K),e(q,R),e(R,re),e(z,_e),e(z,O),e(O,ie),e(O,U),e(U,we)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(J),m&&t(E),m&&t(G),m&&t(j),m&&t(X),m&&t(z)}}}function l1(Q){let p,x,g,u,$;return{c(){p=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function d1(Q){let p,x,g,u,$,w,_,M,me,J,E,Z,I,ee,fe,S,pe,le,G,j,te,X,z,C,ne,H,de,se,D,ge,ce,q,ue,W,ae,K,R,re,_e,O,ie,U,we;return{c(){p=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),$=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=a("p"),Z=n("This second option is useful when using "),I=a("code"),ee=n("tf.keras.Model.fit"),fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),pe=n("model(inputs)"),le=n("."),G=l(),j=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=a("ul"),C=a("li"),ne=n("a single Tensor with "),H=a("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=a("code"),ge=n("model(inputs_ids)"),ce=l(),q=a("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),K=n(" or "),R=a("code"),re=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),O=a("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=r(m,"UL",{});var Y=i(u);$=r(Y,"LI",{});var Te=i($);w=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(Y),M=r(Y,"LI",{});var he=i(M);me=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(t),Y.forEach(t),J=d(m),E=r(m,"P",{});var A=i(E);Z=s(A,"This second option is useful when using "),I=r(A,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(t),fe=s(A,` method which currently requires having all the
...
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),os=new B({props:{name:"forward",anchor:"transformers.LongformerModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/longformer/modeling_longformer.py#L1608",parametersDescription:[{anchor:"transformers.LongformerModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),Uo=new je({props:{$$slots:{default:[VT]},$$scope:{ctx:Q}}}),ns=new rt({props:{code:`import torch
...
`}}),Go=new je({props:{$$slots:{default:[GT]},$$scope:{ctx:Q}}}),hs=new rt({props:{code:`import torch
...
`}}),Jo=new je({props:{$$slots:{default:[KT]},$$scope:{ctx:Q}}}),ws=new rt({props:{code:`import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$s=new B({props:{name:"forward",anchor:"transformers.LongformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/longformer/modeling_longformer.py#L2199",parametersDescription:[{anchor:"transformers.LongformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Yo=new je({props:{$$slots:{default:[JT]},$$scope:{ctx:Q}}}),Fs=new rt({props:{code:`from transformers import LongformerTokenizer, LongformerForMultipleChoice
import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Cs=new B({props:{name:"forward",anchor:"transformers.LongformerForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/longformer/modeling_longformer.py#L2118",parametersDescription:[{anchor:"transformers.LongformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),en=new je({props:{$$slots:{default:[XT]},$$scope:{ctx:Q}}}),Ps=new rt({props:{code:`from transformers import LongformerTokenizer, LongformerForTokenClassification
import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ss=new B({props:{name:"forward",anchor:"transformers.LongformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/longformer/modeling_longformer.py#L1978",parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),on=new je({props:{$$slots:{default:[YT]},$$scope:{ctx:Q}}}),Ds=new rt({props:{code:`from transformers import LongformerTokenizer, LongformerForQuestionAnswering
import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ln=new je({props:{$$slots:{default:[t1]},$$scope:{ctx:Q}}}),ta=new B({props:{name:"call",anchor:"transformers.TFLongformerForMaskedLM.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/longformer/modeling_tf_longformer.py#L2111",parametersDescription:[{anchor:"transformers.TFLongformerForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),dn=new je({props:{$$slots:{default:[o1]},$$scope:{ctx:Q}}}),oa=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMaskedLM
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new je({props:{$$slots:{default:[n1]},$$scope:{ctx:Q}}}),la=new B({props:{name:"call",anchor:"transformers.TFLongformerForQuestionAnswering.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/longformer/modeling_tf_longformer.py#L2220",parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),mn=new je({props:{$$slots:{default:[s1]},$$scope:{ctx:Q}}}),da=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForQuestionAnswering
import tensorflow as tf
...
`}}),gn=new je({props:{$$slots:{default:[r1]},$$scope:{ctx:Q}}}),ua=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
`}}),wn=new je({props:{$$slots:{default:[l1]},$$scope:{ctx:Q}}}),ya=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new je({props:{$$slots:{default:[d1]},$$scope:{ctx:Q}}}),Ea=new B({props:{name:"call",anchor:"transformers.TFLongformerForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/longformer/modeling_tf_longformer.py#L2513",parametersDescription:[{anchor:"transformers.TFLongformerForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),bn=new je({props:{$$slots:{default:[c1]},$$scope:{ctx:Q}}}),za=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMultipleChoice
import tensorflow as tf
...
WikiHop and TriviaQA.`),ce=l(),q=a("p"),ue=n("Tips:"),W=l(),ae=a("ul"),K=a("li"),R=n("Since the Longformer is based on RoBERTa, it doesn\u2019t have "),re=a("code"),_e=n("token_type_ids"),O=n(`. You don\u2019t need to indicate which
...
`),m=a("code"),F=n("</s>"),Y=n(")."),Te=l(),he=a("p"),A=n("This model was contributed by "),ve=a("a"),$e=n("beltagy"),Fe=n(". The Authors\u2019 code can be found "),P=a("a"),V=n("here"),xe=n("."),ye=l(),N=a("h2"),ke=a("a"),be=a("span"),k(oe.$$.fragment),Me=l(),Qr=a("span"),Eh=n("Longformer Self Attention"),Zl=l(),Le=a("p"),zh=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
attend \u201Clocally\u201D to each other meaning that each token attends to its `),ed=new Po,td=n(` previous tokens and
`),od=new Po,nd=n(" succeding tokens with "),sd=new Po,ad=n(` being the window length as defined in
`),Hr=a("code"),qh=n("config.attention_window"),Ch=n(". Note that "),Rr=a("code"),Ph=n("config.attention_window"),jh=n(" can be of type "),Ur=a("code"),Oh=n("List"),Ah=n(` to define a
different `),rd=new Po,id=n(` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
...
`),Jr=a("code"),Rh=n("global_attention_mask"),Uh=n(":"),md=l(),Oo=a("ul"),Xr=a("li"),Vh=n("0: the token attends \u201Clocally\u201D,"),Gh=l(),Yr=a("li"),Kh=n("1: the token attends \u201Cglobally\u201D."),fd=l(),Ao=a("p"),Jh=n("For more information please also refer to "),ja=a("a"),Xh=n("forward()"),Yh=n(" method."),pd=l(),Ve=a("p"),Zh=n(`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
...
\u201Clocally\u201D attending tokens.`),yd=l(),No=a("p"),em=n("For more information, please refer to the official "),Tn=a("a"),tm=n("paper"),om=n("."),Ld=l(),Ot=a("h2"),Io=a("a"),Zr=a("span"),k(yn.$$.fragment),nm=l(),ei=a("span"),sm=n("Training"),$d=l(),At=a("p"),Oa=a("a"),am=n("LongformerForMaskedLM"),rm=n(" is trained the exact same way "),Aa=a("a"),im=n("RobertaForMaskedLM"),lm=n(` is
trained and should be used as follows:`),Fd=l(),k(Ln.$$.fragment),xd=l(),Nt=a("h2"),So=a("a"),ti=a("span"),k($n.$$.fragment),dm=l(),oi=a("span"),cm=n("LongformerConfig"),Md=l(),Oe=a("div"),k(Fn.$$.fragment),hm=l(),It=a("p"),mm=n("This is the configuration class to store the configuration of a "),Na=a("a"),fm=n("LongformerModel"),pm=n(" or a "),Ia=a("a"),gm=n("TFLongformerModel"),um=n(`. It
...
parent class for more information.`),Em=l(),ni=a("p"),zm=n("Example:"),qm=l(),k(Mn.$$.fragment),Ed=l(),Bt=a("h2"),Do=a("a"),si=a("span"),k(En.$$.fragment),Cm=l(),ai=a("span"),Pm=n("LongformerTokenizer"),zd=l(),ft=a("div"),k(zn.$$.fragment),jm=l(),ri=a("p"),Om=n("Construct a Longformer tokenizer."),Am=l(),Bo=a("p"),Wa=a("a"),Nm=n("LongformerTokenizer"),Im=n(" is identical to "),Qa=a("a"),Sm=n("RobertaTokenizer"),Dm=n(`. Refer to the superclass for usage examples and
documentation concerning parameters.`),qd=l(),Wt=a("h2"),Wo=a("a"),ii=a("span"),k(qn.$$.fragment),Bm=l(),li=a("span"),Wm=n("LongformerTokenizerFast"),Cd=l(),pt=a("div"),k(Cn.$$.fragment),Qm=l(),Pn=a("p"),Hm=n("Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),di=a("em"),Rm=n("tokenizers"),Um=n(" library)."),Vm=l(),Qo=a("p"),Ha=a("a"),Gm=n("LongformerTokenizerFast"),Km=n(" is identical to "),Ra=a("a"),Jm=n("RobertaTokenizerFast"),Xm=n(`. Refer to the superclass for usage examples
and documentation concerning parameters.`),Pd=l(),Qt=a("h2"),Ho=a("a"),ci=a("span"),k(jn.$$.fragment),Ym=l(),hi=a("span"),Zm=n("Longformer specific outputs"),jd=l(),Ht=a("div"),k(On.$$.fragment),ef=l(),mi=a("p"),tf=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Od=l(),Rt=a("div"),k(An.$$.fragment),of=l(),fi=a("p"),nf=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Ad=l(),Ut=a("div"),k(Nn.$$.fragment),sf=l(),pi=a("p"),af=n("Base class for masked language models outputs."),Nd=l(),Vt=a("div"),k(In.$$.fragment),rf=l(),gi=a("p"),lf=n("Base class for outputs of question answering Longformer models."),Id=l(),Gt=a("div"),k(Sn.$$.fragment),df=l(),ui=a("p"),cf=n("Base class for outputs of sentence classification models."),Sd=l(),Kt=a("div"),k(Dn.$$.fragment),hf=l(),_i=a("p"),mf=n("Base class for outputs of multiple choice Longformer models."),Dd=l(),Jt=a("div"),k(Bn.$$.fragment),ff=l(),wi=a("p"),pf=n("Base class for outputs of token classification models."),Bd=l(),Xt=a("div"),k(Wn.$$.fragment),gf=l(),ki=a("p"),uf=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Wd=l(),Yt=a("div"),k(Qn.$$.fragment),_f=l(),vi=a("p"),wf=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Qd=l(),Zt=a("div"),k(Hn.$$.fragment),kf=l(),bi=a("p"),vf=n("Base class for masked language models outputs."),Hd=l(),eo=a("div"),k(Rn.$$.fragment),bf=l(),Ti=a("p"),Tf=n("Base class for outputs of question answering Longformer models."),Rd=l(),to=a("div"),k(Un.$$.fragment),yf=l(),yi=a("p"),Lf=n("Base class for outputs of sentence classification models."),Ud=l(),oo=a("div"),k(Vn.$$.fragment),$f=l(),Li=a("p"),Ff=n("Base class for outputs of multiple choice models."),Vd=l(),no=a("div"),k(Gn.$$.fragment),xf=l(),$i=a("p"),Mf=n("Base class for outputs of token classification models."),Gd=l(),so=a("h2"),Ro=a("a"),Fi=a("span"),k(Kn.$$.fragment),Ef=l(),xi=a("span"),zf=n("LongformerModel"),Kd=l(),qe=a("div"),k(Jn.$$.fragment),qf=l(),Mi=a("p"),Cf=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Pf=l(),Xn=a("p"),jf=n("This model inherits from "),Ua=a("a"),Of=n("PreTrainedModel"),Af=n(`. Check the superclass documentation for the generic methods the
...
kernel to be memory and compute efficient.`),Xf=l(),Ge=a("div"),k(os.$$.fragment),Yf=l(),ro=a("p"),Zf=n("The "),Ga=a("a"),ep=n("LongformerModel"),tp=n(" forward method, overrides the "),zi=a("code"),op=n("__call__"),np=n(" special method."),sp=l(),k(Uo.$$.fragment),ap=l(),qi=a("p"),rp=n("Examples:"),ip=l(),k(ns.$$.fragment),Jd=l(),io=a("h2"),Vo=a("a"),Ci=a("span"),k(ss.$$.fragment),lp=l(),Pi=a("span"),dp=n("LongformerForMaskedLM"),Xd=l(),We=a("div"),k(as.$$.fragment),cp=l(),rs=a("p"),hp=n("Longformer Model with a "),ji=a("code"),mp=n("language modeling"),fp=n(" head on top."),pp=l(),is=a("p"),gp=n("This model inherits from "),Ka=a("a"),up=n("PreTrainedModel"),_p=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp=l(),ls=a("p"),kp=n("This model is also a PyTorch "),ds=a("a"),vp=n("torch.nn.Module"),bp=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tp=l(),Ke=a("div"),k(cs.$$.fragment),yp=l(),lo=a("p"),Lp=n("The "),Ja=a("a"),$p=n("LongformerForMaskedLM"),Fp=n(" forward method, overrides the "),Oi=a("code"),xp=n("__call__"),Mp=n(" special method."),Ep=l(),k(Go.$$.fragment),zp=l(),Ai=a("p"),qp=n("Examples:"),Cp=l(),k(hs.$$.fragment),Yd=l(),co=a("h2"),Ko=a("a"),Ni=a("span"),k(ms.$$.fragment),Pp=l(),Ii=a("span"),jp=n("LongformerForSequenceClassification"),Zd=l(),Qe=a("div"),k(fs.$$.fragment),Op=l(),Si=a("p"),Ap=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
for Named-Entity-Recognition (NER) tasks.`),Cg=l(),Es=a("p"),Pg=n("This model inherits from "),tr=a("a"),jg=n("PreTrainedModel"),Og=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ag=l(),zs=a("p"),Ng=n("This model is also a PyTorch "),qs=a("a"),Ig=n("torch.nn.Module"),Sg=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dg=l(),Xe=a("div"),k(Cs.$$.fragment),Bg=l(),go=a("p"),Wg=n("The "),or=a("a"),Qg=n("LongformerForTokenClassification"),Hg=n(" forward method, overrides the "),Xi=a("code"),Rg=n("__call__"),Ug=n(" special method."),Vg=l(),k(en.$$.fragment),Gg=l(),Yi=a("p"),Kg=n("Example:"),Jg=l(),k(Ps.$$.fragment),sc=l(),uo=a("h2"),tn=a("a"),Zi=a("span"),k(js.$$.fragment),Xg=l(),el=a("span"),Yg=n("LongformerForQuestionAnswering"),ac=l(),Ue=a("div"),k(Os.$$.fragment),Zg=l(),_o=a("p"),eu=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu=l(),Hs=a("p"),Pu=n("This model is also a "),Rs=a("a"),ju=n("tf.keras.Model"),Ou=n(` subclass. Use it
...
TriviaQA (a linear layer on top of the hidden-states output to compute `),_l=a("code"),q_=n("span start logits"),C_=n(" and "),wl=a("code"),P_=n("span end logits"),j_=n(")."),O_=l(),aa=a("p"),A_=n("This model inherits from "),cr=a("a"),N_=n("TFPreTrainedModel"),I_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ik=l(),k(vn.$$.fragment),lk=l(),nt=a("div"),k(Ea.$$.fragment),dk=l(),Co=a("p"),ck=n("The "),_r=a("a"),hk=n("TFLongformerForMultipleChoice"),mk=n(" forward method, overrides the "),jl=a("code"),fk=n("__call__"),pk=n(" special method."),gk=l(),k(bn.$$.fragment),uk=l(),Ol=a("p"),_k=n("Example:"),wk=l(),k(za.$$.fragment),this.h()},l(o){const f=UT('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),x=d(o),g=r(o,"H1",{class:!0});var qa=i(g);u=r(qa,"A",{id:!0,class:!0,href:!0});var Al=i(u);$=r(Al,"SPAN",{});var Nl=i($);v(w.$$.fragment,Nl),Nl.forEach(t),Al.forEach(t),_=d(qa),M=r(qa,"SPAN",{});var Il=i(M);me=s(Il,"Longformer"),Il.forEach(t),qa.forEach(t),J=d(o),E=r(o,"H2",{class:!0});var Ca=i(E);Z=r(Ca,"A",{id:!0,class:!0,href:!0});var Sl=i(Z);I=r(Sl,"SPAN",{});var Dl=i(I);v(ee.$$.fragment,Dl),Dl.forEach(t),Sl.forEach(t),fe=d(Ca),S=r(Ca,"SPAN",{});var Bl=i(S);pe=s(Bl,"Overview"),Bl.forEach(t),Ca.forEach(t),le=d(o),G=r(o,"P",{});var Pa=i(G);j=s(Pa,"The Longformer model was presented in "),te=r(Pa,"A",{href:!0,rel:!0});var Wl=i(te);X=s(Wl,"Longformer: The Long-Document Transformer"),Wl.forEach(t),z=s(Pa," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Pa.forEach(t),C=d(o),ne=r(o,"P",{});var Ql=i(ne);H=s(Ql,"The abstract from the paper is the following:"),Ql.forEach(t),de=d(o),se=r(o,"P",{});var Hl=i(se);D=r(Hl,"EM",{});var Rl=i(D);ge=s(Rl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
`),m=r(gt,"CODE",{});var kk=i(m);F=s(kk,"</s>"),kk.forEach(t),Y=s(gt,")."),gt.forEach(t),Vl.forEach(t),Te=d(o),he=r(o,"P",{});var wr=i(he);A=s(wr,"This model was contributed by "),ve=r(wr,"A",{href:!0,rel:!0});var vk=i(ve);$e=s(vk,"beltagy"),vk.forEach(t),Fe=s(wr,". The Authors\u2019 code can be found "),P=r(wr,"A",{href:!0,rel:!0});var bk=i(P);V=s(bk,"here"),bk.forEach(t),xe=s(wr,"."),wr.forEach(t),ye=d(o),N=r(o,"H2",{class:!0});var kc=i(N);ke=r(kc,"A",{id:!0,class:!0,href:!0});var Tk=i(ke);be=r(Tk,"SPAN",{});var yk=i(be);v(oe.$$.fragment,yk),yk.forEach(t),Tk.forEach(t),Me=d(kc),Qr=r(kc,"SPAN",{});var Lk=i(Qr);Eh=s(Lk,"Longformer Self Attention"),Lk.forEach(t),kc.forEach(t),Zl=d(o),Le=r(o,"P",{});var Pe=i(Le);zh=s(Pe,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
attend \u201Clocally\u201D to each other meaning that each token attends to its `),ed=jo(Pe),td=s(Pe,` previous tokens and
`),od=jo(Pe),nd=s(Pe," succeding tokens with "),sd=jo(Pe),ad=s(Pe,` being the window length as defined in
`),Hr=r(Pe,"CODE",{});var $k=i(Hr);qh=s($k,"config.attention_window"),$k.forEach(t),Ch=s(Pe,". Note that "),Rr=r(Pe,"CODE",{});var Fk=i(Rr);Ph=s(Fk,"config.attention_window"),Fk.forEach(t),jh=s(Pe," can be of type "),Ur=r(Pe,"CODE",{});var xk=i(Ur);Oh=s(xk,"List"),xk.forEach(t),Ah=s(Pe,` to define a
different `),rd=jo(Pe),id=s(Pe,` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),Vr=r(Pe,"CODE",{});var Mk=i(Vr);Nh=s(Mk,"BertSelfAttention"),Mk.forEach(t),Ih=s(Pe,"."),Pe.forEach(t),ld=d(o),ut=r(o,"P",{});var kr=i(ut);Sh=s(kr,`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
that every \u201Clocally\u201D attending token not only attends to tokens within its window `),dd=jo(kr),cd=s(kr,`, but also to all \u201Cglobally\u201D
...
`),Jr=r(vr,"CODE",{});var qk=i(Jr);Rh=s(qk,"global_attention_mask"),qk.forEach(t),Uh=s(vr,":"),vr.forEach(t),md=d(o),Oo=r(o,"UL",{});var vc=i(Oo);Xr=r(vc,"LI",{});var Ck=i(Xr);Vh=s(Ck,"0: the token attends \u201Clocally\u201D,"),Ck.forEach(t),Gh=d(vc),Yr=r(vc,"LI",{});var Pk=i(Yr);Kh=s(Pk,"1: the token attends \u201Cglobally\u201D."),Pk.forEach(t),vc.forEach(t),fd=d(o),Ao=r(o,"P",{});var bc=i(Ao);Jh=s(bc,"For more information please also refer to "),ja=r(bc,"A",{href:!0});var jk=i(ja);Xh=s(jk,"forward()"),jk.forEach(t),Yh=s(bc," method."),bc.forEach(t),pd=d(o),Ve=r(o,"P",{});var kt=i(Ve);Zh=s(kt,`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
...
parent class for more information.`),yr.forEach(t),Em=d(it),ni=r(it,"P",{});var Jk=i(ni);zm=s(Jk,"Example:"),Jk.forEach(t),qm=d(it),v(Mn.$$.fragment,it),it.forEach(t),Ed=d(o),Bt=r(o,"H2",{class:!0});var $c=i(Bt);Do=r($c,"A",{id:!0,class:!0,href:!0});var Xk=i(Do);si=r(Xk,"SPAN",{});var Yk=i(si);v(En.$$.fragment,Yk),Yk.forEach(t),Xk.forEach(t),Cm=d($c),ai=r($c,"SPAN",{});var Zk=i(ai);Pm=s(Zk,"LongformerTokenizer"),Zk.forEach(t),$c.forEach(t),zd=d(o),ft=r(o,"DIV",{class:!0});var Lr=i(ft);v(zn.$$.fragment,Lr),jm=d(Lr),ri=r(Lr,"P",{});var ev=i(ri);Om=s(ev,"Construct a Longformer tokenizer."),ev.forEach(t),Am=d(Lr),Bo=r(Lr,"P",{});var Xl=i(Bo);Wa=r(Xl,"A",{href:!0});var tv=i(Wa);Nm=s(tv,"LongformerTokenizer"),tv.forEach(t),Im=s(Xl," is identical to "),Qa=r(Xl,"A",{href:!0});var ov=i(Qa);Sm=s(ov,"RobertaTokenizer"),ov.forEach(t),Dm=s(Xl,`. Refer to the superclass for usage examples and
documentation concerning parameters.`),Xl.forEach(t),Lr.forEach(t),qd=d(o),Wt=r(o,"H2",{class:!0});var Fc=i(Wt);Wo=r(Fc,"A",{id:!0,class:!0,href:!0});var nv=i(Wo);ii=r(nv,"SPAN",{});var sv=i(ii);v(qn.$$.fragment,sv),sv.forEach(t),nv.forEach(t),Bm=d(Fc),li=r(Fc,"SPAN",{});var av=i(li);Wm=s(av,"LongformerTokenizerFast"),av.forEach(t),Fc.forEach(t),Cd=d(o),pt=r(o,"DIV",{class:!0});var $r=i(pt);v(Cn.$$.fragment,$r),Qm=d($r),Pn=r($r,"P",{});var xc=i(Pn);Hm=s(xc,"Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),di=r(xc,"EM",{});var rv=i(di);Rm=s(rv,"tokenizers"),rv.forEach(t),Um=s(xc," library)."),xc.forEach(t),Vm=d($r),Qo=r($r,"P",{});var Yl=i(Qo);Ha=r(Yl,"A",{href:!0});var iv=i(Ha);Gm=s(iv,"LongformerTokenizerFast"),iv.forEach(t),Km=s(Yl," is identical to "),Ra=r(Yl,"A",{href:!0});var lv=i(Ra);Jm=s(lv,"RobertaTokenizerFast"),lv.forEach(t),Xm=s(Yl,`. Refer to the superclass for usage examples
and documentation concerning parameters.`),Yl.forEach(t),$r.forEach(t),Pd=d(o),Qt=r(o,"H2",{class:!0});var Mc=i(Qt);Ho=r(Mc,"A",{id:!0,class:!0,href:!0});var dv=i(Ho);ci=r(dv,"SPAN",{});var cv=i(ci);v(jn.$$.fragment,cv),cv.forEach(t),dv.forEach(t),Ym=d(Mc),hi=r(Mc,"SPAN",{});var hv=i(hi);Zm=s(hv,"Longformer specific outputs"),hv.forEach(t),Mc.forEach(t),jd=d(o),Ht=r(o,"DIV",{class:!0});var Ec=i(Ht);v(On.$$.fragment,Ec),ef=d(Ec),mi=r(Ec,"P",{});var mv=i(mi);tf=s(mv,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),mv.forEach(t),Ec.forEach(t),Od=d(o),Rt=r(o,"DIV",{class:!0});var zc=i(Rt);v(An.$$.fragment,zc),of=d(zc),fi=r(zc,"P",{});var fv=i(fi);nf=s(fv,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),fv.forEach(t),zc.forEach(t),Ad=d(o),Ut=r(o,"DIV",{class:!0});var qc=i(Ut);v(Nn.$$.fragment,qc),sf=d(qc),pi=r(qc,"P",{});var pv=i(pi);af=s(pv,"Base class for masked language models outputs."),pv.forEach(t),qc.forEach(t),Nd=d(o),Vt=r(o,"DIV",{class:!0});var Cc=i(Vt);v(In.$$.fragment,Cc),rf=d(Cc),gi=r(Cc,"P",{});var gv=i(gi);lf=s(gv,"Base class for outputs of question answering Longformer models."),gv.forEach(t),Cc.forEach(t),Id=d(o),Gt=r(o,"DIV",{class:!0});var Pc=i(Gt);v(Sn.$$.fragment,Pc),df=d(Pc),ui=r(Pc,"P",{});var uv=i(ui);cf=s(uv,"Base class for outputs of sentence classification models."),uv.forEach(t),Pc.forEach(t),Sd=d(o),Kt=r(o,"DIV",{class:!0});var jc=i(Kt);v(Dn.$$.fragment,jc),hf=d(jc),_i=r(jc,"P",{});var _v=i(_i);mf=s(_v,"Base class for outputs of multiple choice Longformer models."),_v.forEach(t),jc.forEach(t),Dd=d(o),Jt=r(o,"DIV",{class:!0});var Oc=i(Jt);v(Bn.$$.fragment,Oc),ff=d(Oc),wi=r(Oc,"P",{});var wv=i(wi);pf=s(wv,"Base class for outputs of token classification models."),wv.forEach(t),Oc.forEach(t),Bd=d(o),Xt=r(o,"DIV",{class:!0});var Ac=i(Xt);v(Wn.$$.fragment,Ac),gf=d(Ac),ki=r(Ac,"P",{});var kv=i(ki);uf=s(kv,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),kv.forEach(t),Ac.forEach(t),Wd=d(o),Yt=r(o,"DIV",{class:!0});var Nc=i(Yt);v(Qn.$$.fragment,Nc),_f=d(Nc),vi=r(Nc,"P",{});var vv=i(vi);wf=s(vv,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),vv.forEach(t),Nc.forEach(t),Qd=d(o),Zt=r(o,"DIV",{class:!0});var Ic=i(Zt);v(Hn.$$.fragment,Ic),kf=d(Ic),bi=r(Ic,"P",{});var bv=i(bi);vf=s(bv,"Base class for masked language models outputs."),bv.forEach(t),Ic.forEach(t),Hd=d(o),eo=r(o,"DIV",{class:!0});var Sc=i(eo);v(Rn.$$.fragment,Sc),bf=d(Sc),Ti=r(Sc,"P",{});var Tv=i(Ti);Tf=s(Tv,"Base class for outputs of question answering Longformer models."),Tv.forEach(t),Sc.forEach(t),Rd=d(o),to=r(o,"DIV",{class:!0});var Dc=i(to);v(Un.$$.fragment,Dc),yf=d(Dc),yi=r(Dc,"P",{});var yv=i(yi);Lf=s(yv,"Base class for outputs of sentence classification models."),yv.forEach(t),Dc.forEach(t),Ud=d(o),oo=r(o,"DIV",{class:!0});var Bc=i(oo);v(Vn.$$.fragment,Bc),$f=d(Bc),Li=r(Bc,"P",{});var Lv=i(Li);Ff=s(Lv,"Base class for outputs of multiple choice models."),Lv.forEach(t),Bc.forEach(t),Vd=d(o),no=r(o,"DIV",{class:!0});var Wc=i(no);v(Gn.$$.fragment,Wc),xf=d(Wc),$i=r(Wc,"P",{});var $v=i($i);Mf=s($v,"Base class for outputs of token classification models."),$v.forEach(t),Wc.forEach(t),Gd=d(o),so=r(o,"H2",{class:!0});var Qc=i(so);Ro=r(Qc,"A",{id:!0,class:!0,href:!0});var Fv=i(Ro);Fi=r(Fv,"SPAN",{});var xv=i(Fi);v(Kn.$$.fragment,xv),xv.forEach(t),Fv.forEach(t),Ef=d(Qc),xi=r(Qc,"SPAN",{});var Mv=i(xi);zf=s(Mv,"LongformerModel"),Mv.forEach(t),Qc.forEach(t),Kd=d(o),qe=r(o,"DIV",{class:!0});var st=i(qe);v(Jn.$$.fragment,st),qf=d(st),Mi=r(st,"P",{});var Ev=i(Mi);Cf=s(Ev,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Ev.forEach(t),Pf=d(st),Xn=r(st,"P",{});var Hc=i(Xn);jf=s(Hc,"This model inherits from "),Ua=r(Hc,"A",{href:!0});var zv=i(Ua);Of=s(zv,"PreTrainedModel"),zv.forEach(t),Af=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
to provide the ability to process long sequences following the self-attention approach described in `),es=r(Fr,"A",{href:!0,rel:!0});var Pv=i(es);Rf=s(Pv,`Longformer:
the Long-Document Transformer`),Pv.forEach(t),Uf=s(Fr,` by Iz Beltagy, Matthew E. Peters, and Arman Cohan.
Longformer self-attention combines a local (sliding window) and global attention to extend to long documents
without the O(n^2) increase in memory and compute.`),Fr.forEach(t),Vf=d(st),ts=r(st,"P",{});var Uc=i(ts);Gf=s(Uc,"The self-attention module "),Ei=r(Uc,"CODE",{});var jv=i(Ei);Kf=s(jv,"LongformerSelfAttention"),jv.forEach(t),Jf=s(Uc,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Uc.forEach(t),Xf=d(st),Ge=r(st,"DIV",{class:!0});var vt=i(Ge);v(os.$$.fragment,vt),Yf=d(vt),ro=r(vt,"P",{});var xr=i(ro);Zf=s(xr,"The "),Ga=r(xr,"A",{href:!0});var Ov=i(Ga);ep=s(Ov,"LongformerModel"),Ov.forEach(t),tp=s(xr," forward method, overrides the "),zi=r(xr,"CODE",{});var Av=i(zi);op=s(Av,"__call__"),Av.forEach(t),np=s(xr," special method."),xr.forEach(t),sp=d(vt),v(Uo.$$.fragment,vt),ap=d(vt),qi=r(vt,"P",{});var Nv=i(qi);rp=s(Nv,"Examples:"),Nv.forEach(t),ip=d(vt),v(ns.$$.fragment,vt),vt.forEach(t),st.forEach(t),Jd=d(o),io=r(o,"H2",{class:!0});var Vc=i(io);Vo=r(Vc,"A",{id:!0,class:!0,href:!0});var Iv=i(Vo);Ci=r(Iv,"SPAN",{});var Sv=i(Ci);v(ss.$$.fragment,Sv),Sv.forEach(t),Iv.forEach(t),lp=d(Vc),Pi=r(Vc,"SPAN",{});var Dv=i(Pi);dp=s(Dv,"LongformerForMaskedLM"),Dv.forEach(t),Vc.forEach(t),Xd=d(o),We=r(o,"DIV",{class:!0});var bt=i(We);v(as.$$.fragment,bt),cp=d(bt),rs=r(bt,"P",{});var Gc=i(rs);hp=s(Gc,"Longformer Model with a "),ji=r(Gc,"CODE",{});var Bv=i(ji);mp=s(Bv,"language modeling"),Bv.forEach(t),fp=s(Gc," head on top."),Gc.forEach(t),pp=d(bt),is=r(bt,"P",{});var Kc=i(is);gp=s(Kc,"This model inherits from "),Ka=r(Kc,"A",{href:!0});var Wv=i(Ka);up=s(Wv,"PreTrainedModel"),Wv.forEach(t),_p=s(Kc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jc.forEach(t),Tp=d(bt),Ke=r(bt,"DIV",{class:!0});var Tt=i(Ke);v(cs.$$.fragment,Tt),yp=d(Tt),lo=r(Tt,"P",{});var Mr=i(lo);Lp=s(Mr,"The "),Ja=r(Mr,"A",{href:!0});var Hv=i(Ja);$p=s(Hv,"LongformerForMaskedLM"),Hv.forEach(t),Fp=s(Mr," forward method, overrides the "),Oi=r(Mr,"CODE",{});var Rv=i(Oi);xp=s(Rv,"__call__"),Rv.forEach(t),Mp=s(Mr," special method."),Mr.forEach(t),Ep=d(Tt),v(Go.$$.fragment,Tt),zp=d(Tt),Ai=r(Tt,"P",{});var Uv=i(Ai);qp=s(Uv,"Examples:"),Uv.forEach(t),Cp=d(Tt),v(hs.$$.fragment,Tt),Tt.forEach(t),bt.forEach(t),Yd=d(o),co=r(o,"H2",{class:!0});var Xc=i(co);Ko=r(Xc,"A",{id:!0,class:!0,href:!0});var Vv=i(Ko);Ni=r(Vv,"SPAN",{});var Gv=i(Ni);v(ms.$$.fragment,Gv),Gv.forEach(t),Vv.forEach(t),Pp=d(Xc),Ii=r(Xc,"SPAN",{});var Kv=i(Ii);jp=s(Kv,"LongformerForSequenceClassification"),Kv.forEach(t),Xc.forEach(t),Zd=d(o),Qe=r(o,"DIV",{class:!0});var yt=i(Qe);v(fs.$$.fragment,yt),Op=d(yt),Si=r(yt,"P",{});var Jv=i(Si);Ap=s(Jv,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
for Named-Entity-Recognition (NER) tasks.`),gb.forEach(t),Cg=d(Ft),Es=r(Ft,"P",{});var sh=i(Es);Pg=s(sh,"This model inherits from "),tr=r(sh,"A",{href:!0});var ub=i(tr);jg=s(ub,"PreTrainedModel"),ub.forEach(t),Og=s(sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lh.forEach(t),fu=d(Mt),Ye=r(Mt,"DIV",{class:!0});var Et=i(Ye);v(Ss.$$.fragment,Et),pu=d(Et),wo=r(Et,"P",{});var Pr=i(wo);gu=s(Pr,"The "),sr=r(Pr,"A",{href:!0});var Mb=i(sr);uu=s(Mb,"LongformerForQuestionAnswering"),Mb.forEach(t),_u=s(Pr," forward method, overrides the "),nl=r(Pr,"CODE",{});var Eb=i(nl);wu=s(Eb,"__call__"),Eb.forEach(t),ku=s(Pr," special method."),Pr.forEach(t),vu=d(Et),v(on.$$.fragment,Et),bu=d(Et),sl=r(Et,"P",{});var zb=i(sl);Tu=s(zb,"Examples:"),zb.forEach(t),yu=d(Et),v(Ds.$$.fragment,Et),Et.forEach(t),Mt.forEach(t),rc=d(o),ko=r(o,"H2",{class:!0});var dh=i(ko);nn=r(dh,"A",{id:!0,class:!0,href:!0});var qb=i(nn);al=r(qb,"SPAN",{});var Cb=i(al);v(Bs.$$.fragment,Cb),Cb.forEach(t),qb.forEach(t),Lu=d(dh),rl=r(dh,"SPAN",{});var Pb=i(rl);$u=s(Pb,"TFLongformerModel"),Pb.forEach(t),dh.forEach(t),ic=d(o),Ee=r(o,"DIV",{class:!0});var Be=i(Ee);v(Ws.$$.fragment,Be),Fu=d(Be),il=r(Be,"P",{});var jb=i(il);xu=s(jb,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),jb.forEach(t),Mu=d(Be),Qs=r(Be,"P",{});var ch=i(Qs);Eu=s(ch,"This model inherits from "),ar=r(ch,"A",{href:!0});var Ob=i(ar);zu=s(Ob,"TFPreTrainedModel"),Ob.forEach(t),qu=s(ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ch.forEach(t),Cu=d(Be),Hs=r(Be,"P",{});var hh=i(Hs);Pu=s(hh,"This model is also a "),Rs=r(hh,"A",{href:!0,rel:!0});var Ab=i(Rs);ju=s(Ab,"tf.keras.Model"),Ab.forEach(t),Ou=s(hh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hh.forEach(t),Au=d(Be),v(sn.$$.fragment,Be),Nu=d(Be),vo=r(Be,"P",{});var jr=i(vo);Iu=s(jr,"This class copies code from "),rr=r(jr,"A",{href:!0});var Nb=i(rr);Su=s(Nb,"TFRobertaModel"),Nb.forEach(t),Du=s(jr,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
`),Us=r(jr,"A",{href:!0,rel:!0});var Ib=i(Us);Bu=s(Ib,"Longformer: the Long-Document Transformer"),Ib.forEach(t),Wu=s(jr,` by Iz Beltagy, Matthew E. Peters, and
Arman Cohan. Longformer self-attention combines a local (sliding window) and global attention to extend to long
documents without the O(n^2) increase in memory and compute.`),jr.forEach(t),Qu=d(Be),Vs=r(Be,"P",{});var mh=i(Vs);Hu=s(mh,"The self-attention module "),ll=r(mh,"CODE",{});var Sb=i(ll);Ru=s(Sb,"TFLongformerSelfAttention"),Sb.forEach(t),Uu=s(mh,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),mh.forEach(t),Vu=d(Be),wt=r(Be,"DIV",{class:!0});var Or=i(wt);v(Gs.$$.fragment,Or),Gu=d(Or),bo=r(Or,"P",{});var Ar=i(bo);Ku=s(Ar,"The "),ir=r(Ar,"A",{href:!0});var Db=i(ir);Ju=s(Db,"TFLongformerModel"),Db.forEach(t),Xu=s(Ar," forward method, overrides the "),dl=r(Ar,"CODE",{});var Bb=i(dl);Yu=s(Bb,"__call__"),Bb.forEach(t),Zu=s(Ar," special method."),Ar.forEach(t),e_=d(Or),v(an.$$.fragment,Or),Or.forEach(t),Be.forEach(t),lc=d(o),To=r(o,"H2",{class:!0});var fh=i(To);rn=r(fh,"A",{id:!0,class:!0,href:!0});var Wb=i(rn);cl=r(Wb,"SPAN",{});var Qb=i(cl);v(Ks.$$.fragment,Qb),Qb.forEach(t),Wb.forEach(t),t_=d(fh),hl=r(fh,"SPAN",{});var Hb=i(hl);o_=s(Hb,"TFLongformerForMaskedLM"),Hb.forEach(t),fh.forEach(t),dc=d(o),Ae=r(o,"DIV",{class:!0});var lt=i(Ae);v(Js.$$.fragment,lt),n_=d(lt),Xs=r(lt,"P",{});var ph=i(Xs);s_=s(ph,"Longformer Model with a "),ml=r(ph,"CODE",{});var Rb=i(ml);a_=s(Rb,"language modeling"),Rb.forEach(t),r_=s(ph," head on top."),ph.forEach(t),i_=d(lt),Ys=r(lt,"P",{});var gh=i(Ys);l_=s(gh,"This model inherits from "),lr=r(gh,"A",{href:!0});var Ub=i(lr);d_=s(Ub,"TFPreTrainedModel"),Ub.forEach(t),c_=s(gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
TriviaQA (a linear layer on top of the hidden-states output to compute `),_l=r(Ir,"CODE",{});var eT=i(_l);q_=s(eT,"span start logits"),eT.forEach(t),C_=s(Ir," and "),wl=r(Ir,"CODE",{});var tT=i(wl);P_=s(tT,"span end logits"),tT.forEach(t),j_=s(Ir,")."),Ir.forEach(t),O_=d(dt),aa=r(dt,"P",{});var wh=i(aa);A_=s(wh,"This model inherits from "),cr=r(wh,"A",{href:!0});var oT=i(cr);N_=s(oT,"TFPreTrainedModel"),oT.forEach(t),I_=s(wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lh.forEach(t),Pw=d(ht),va=r(ht,"P",{});var $h=i(va);jw=s($h,"This model is also a "),ba=r($h,"A",{href:!0,rel:!0});var bT=i(ba);Ow=s(bT,"tf.keras.Model"),bT.forEach(t),Aw=s($h,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$h.forEach(t),Nw=d(ht),v(_n.$$.fragment,ht),Iw=d(ht),ot=r(ht,"DIV",{class:!0});var Pt=i(ot);v(Ta.$$.fragment,Pt),Sw=d(Pt),zo=r(Pt,"P",{});var Br=i(zo);Dw=s(Br,"The "),gr=r(Br,"A",{href:!0});var TT=i(gr);Bw=s(TT,"TFLongformerForTokenClassification"),TT.forEach(t),Ww=s(Br," forward method, overrides the "),El=r(Br,"CODE",{});var yT=i(El);Qw=s(yT,"__call__"),yT.forEach(t),Hw=s(Br," special method."),Br.forEach(t),Rw=d(Pt),v(wn.$$.fragment,Pt),Uw=d(Pt),zl=r(Pt,"P",{});var LT=i(zl);Vw=s(LT,"Example:"),LT.forEach(t),Gw=d(Pt),v(ya.$$.fragment,Pt),Pt.forEach(t),ht.forEach(t),uc=d(o),qo=r(o,"H2",{class:!0});var Fh=i(qo);kn=r(Fh,"A",{id:!0,class:!0,href:!0});var $T=i(kn);ql=r($T,"SPAN",{});var FT=i(ql);v(La.$$.fragment,FT),FT.forEach(t),$T.forEach(t),Kw=d(Fh),Cl=r(Fh,"SPAN",{});var xT=i(Cl);Jw=s(xT,"TFLongformerForMultipleChoice"),xT.forEach(t),Fh.forEach(t),_c=d(o),De=r(o,"DIV",{class:!0});var mt=i(De);v($a.$$.fragment,mt),Xw=d(mt),Pl=r(mt,"P",{});var MT=i(Pl);Yw=s(MT,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
