...
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var p=a(h);y=o(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(p,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(n)},m(g,p){_(g,h,p),e(h,y),e(h,m),e(m,f),e(h,x)},d(g){g&&n(h)}}}function vT($){let h,y,m,f,x,g,p,R,ti,Ia,$e,ot,Fr,St,oi,zr,ni,Oa,an,ri,Wa,nt,si,Dt,ai,di,Ha,dn,ii,Ba,cn,$r,ci,Qa,rt,li,Lt,hi,pi,Va,Ee,st,Er,It,mi,jr,ui,Ua,de,Ot,gi,ue,ln,_i,fi,Mr,vi,bi,hn,Ti,wi,pn,ki,qi,yi,at,Wt,xi,Ht,Ri,mn,Fi,zi,$i,dt,Bt,Ei,Qt,ji,un,Mi,Gi,Ka,je,it,Gr,Vt,Ai,Ar,Pi,Ya,Me,Ut,Ni,ct,Kt,Ci,Pr,Si,Ja,Ge,lt,Nr,Yt,Di,Cr,Li,Xa,Ae,Jt,Ii,Sr,Oi,Za,Xt,Zt,ed,Pe,ht,Dr,eo,Wi,Lr,Hi,td,X,to,Bi,Ir,Qi,Vi,Or,Ui,Ki,oo,Yi,pt,no,Ji,Wr,Xi,Zi,mt,ro,ec,Ne,tc,Hr,oc,nc,Br,rc,sc,ac,ut,so,dc,ao,ic,Qr,cc,lc,od,Ce,gt,Vr,io,hc,Ur,pc,nd,D,co,mc,Se,uc,gn,gc,_c,Kr,fc,vc,bc,_t,Tc,Yr,wc,kc,ie,qc,Jr,yc,xc,_n,Rc,Fc,Xr,zc,$c,fn,Ec,jc,Mc,G,Gc,vn,Ac,Pc,Zr,Nc,Cc,es,Sc,Dc,ts,Lc,Ic,os,Oc,Wc,bn,Hc,Bc,ns,Qc,Vc,Tn,Uc,Kc,wn,Yc,Jc,rs,Xc,Zc,el,lo,tl,kn,ol,nl,rl,ho,sl,po,al,dl,il,ee,mo,cl,De,ll,qn,hl,pl,ss,ml,ul,gl,ft,_l,as,fl,vl,uo,rd,Le,vt,ds,go,bl,is,Tl,sd,E,_o,wl,Ie,kl,yn,ql,yl,cs,xl,Rl,Fl,bt,zl,ls,$l,El,hs,jl,Ml,ce,Gl,ps,Al,Pl,xn,Nl,Cl,ms,Sl,Dl,Rn,Ll,Il,Ol,A,Wl,Fn,Hl,Bl,us,Ql,Vl,gs,Ul,Kl,_s,Yl,Jl,fs,Xl,Zl,zn,eh,th,vs,oh,nh,$n,rh,sh,En,ah,dh,bs,ih,ch,lh,fo,hh,jn,ph,mh,uh,vo,gh,bo,_h,fh,vh,te,To,bh,Oe,Th,Mn,wh,kh,Ts,qh,yh,xh,Tt,Rh,ws,Fh,zh,wo,$h,wt,ko,Eh,qo,jh,Gn,Mh,Gh,ad,We,kt,ks,yo,Ah,qs,Ph,dd,j,xo,Nh,He,Ch,An,Sh,Dh,ys,Lh,Ih,Oh,qt,Wh,xs,Hh,Bh,Rs,Qh,Vh,le,Uh,Fs,Kh,Yh,Pn,Jh,Xh,zs,Zh,ep,Nn,tp,op,np,P,rp,Cn,sp,ap,$s,dp,ip,Es,cp,lp,js,hp,pp,Ms,mp,up,Sn,gp,_p,Gs,fp,vp,Dn,bp,Tp,Ln,wp,kp,As,qp,yp,xp,Ro,Rp,In,Fp,zp,$p,Fo,Ep,zo,jp,Mp,Gp,oe,$o,Ap,Be,Pp,On,Np,Cp,Ps,Sp,Dp,Lp,yt,Ip,Ns,Op,Wp,Eo,Hp,xt,jo,Bp,Cs,Qp,id,Qe,Rt,Ss,Mo,Vp,Ds,Up,cd,N,Go,Kp,Ve,Yp,Wn,Jp,Xp,Ls,Zp,em,tm,Ft,om,Is,nm,rm,he,sm,Os,am,dm,Hn,im,cm,Ws,lm,hm,Bn,pm,mm,um,L,gm,Qn,_m,fm,Hs,vm,bm,Bs,Tm,wm,Qs,km,qm,Vs,ym,xm,Vn,Rm,Fm,Us,zm,$m,Un,Em,jm,Ks,Mm,Gm,Am,Ao,Pm,Kn,Nm,Cm,Sm,Po,Dm,No,Lm,Im,Om,Ys,Wm,Hm,ne,Co,Bm,Ue,Qm,Yn,Vm,Um,Js,Km,Ym,Jm,zt,Xm,Xs,Zm,eu,So,ld,Ke,$t,Zs,Do,tu,ea,ou,hd,F,Lo,nu,Ye,ru,Jn,su,au,ta,du,iu,cu,Et,lu,oa,hu,pu,na,mu,uu,pe,gu,ra,_u,fu,Xn,vu,bu,sa,Tu,wu,Zn,ku,qu,yu,I,xu,er,Ru,Fu,aa,zu,$u,da,Eu,ju,ia,Mu,Gu,ca,Au,Pu,tr,Nu,Cu,la,Su,Du,or,Lu,Iu,ha,Ou,Wu,Hu,Io,Bu,nr,Qu,Vu,Uu,Oo,Ku,Wo,Yu,Ju,Xu,pa,Zu,eg,re,Ho,tg,Je,og,rr,ng,rg,ma,sg,ag,dg,jt,ig,ua,cg,lg,Bo,hg,Mt,Qo,pg,Vo,mg,sr,ug,gg,pd,Xe,Gt,ga,Uo,_g,_a,fg,md,z,Ko,vg,Ze,bg,ar,Tg,wg,fa,kg,qg,yg,At,xg,va,Rg,Fg,ba,zg,$g,me,Eg,Ta,jg,Mg,dr,Gg,Ag,wa,Pg,Ng,ir,Cg,Sg,Dg,O,Lg,cr,Ig,Og,ka,Wg,Hg,qa,Bg,Qg,ya,Vg,Ug,xa,Kg,Yg,lr,Jg,Xg,Ra,Zg,e_,hr,t_,o_,Fa,n_,r_,s_,Yo,a_,pr,d_,i_,c_,Jo,l_,Xo,h_,p_,m_,za,u_,g_,se,Zo,__,et,f_,mr,v_,b_,$a,T_,w_,k_,Pt,q_,Ea,y_,x_,en,R_,Nt,tn,F_,ja,z_,ud;return g=new _e({}),St=new _e({}),It=new _e({}),Ot=new M({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
parametric-only seq2seq baseline.`),Qa=c(),rt=r("p"),li=t("This model was contributed by "),Lt=r("a"),hi=t("ola13"),pi=t("."),Va=c(),Ee=r("h2"),st=r("a"),Er=r("span"),v(It.$$.fragment),mi=c(),jr=r("span"),ui=t("RagConfig"),Ua=c(),de=r("div"),v(Ot.$$.fragment),gi=c(),ue=r("p"),ln=r("a"),_i=t("RagConfig"),fi=t(" stores the configuration of a "),Mr=r("em"),vi=t("RagModel"),bi=t(". Configuration objects inherit from "),hn=r("a"),Ti=t("PretrainedConfig"),wi=t(` and
...
decoder model configuration.`),$i=c(),dt=r("div"),v(Bt.$$.fragment),Ei=c(),Qt=r("p"),ji=t("Serializes this instance to a Python dictionary. Override the default "),un=r("a"),Mi=t("to_dict()"),Gi=t("."),Ka=c(),je=r("h2"),it=r("a"),Gr=r("span"),v(Vt.$$.fragment),Ai=c(),Ar=r("span"),Pi=t("RagTokenizer"),Ya=c(),Me=r("div"),v(Ut.$$.fragment),Ni=c(),ct=r("div"),v(Kt.$$.fragment),Ci=c(),Pr=r("p"),Si=t(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Ja=c(),Ge=r("h2"),lt=r("a"),Nr=r("span"),v(Yt.$$.fragment),Di=c(),Cr=r("span"),Li=t("Rag specific outputs"),Xa=c(),Ae=r("div"),v(Jt.$$.fragment),Ii=c(),Sr=r("p"),Oi=t("Base class for retriever augmented marginalized models outputs."),Za=c(),Xt=r("div"),v(Zt.$$.fragment),ed=c(),Pe=r("h2"),ht=r("a"),Dr=r("span"),v(eo.$$.fragment),Wi=c(),Lr=r("span"),Hi=t("RagRetriever"),td=c(),X=r("div"),v(to.$$.fragment),Bi=c(),Ir=r("p"),Qi=t(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gp=c(),oe=r("div"),v($o.$$.fragment),Ap=c(),Be=r("p"),Pp=t("The "),On=r("a"),Np=t("RagTokenForGeneration"),Cp=t(" forward method, overrides the "),Ps=r("code"),Sp=t("__call__"),Dp=t(" special method."),Lp=c(),v(yt.$$.fragment),Ip=c(),Ns=r("p"),Op=t("Example:"),Wp=c(),v(Eo.$$.fragment),Hp=c(),xt=r("div"),v(jo.$$.fragment),Bp=c(),Cs=r("p"),Qp=t("Implements RAG token decoding."),id=c(),Qe=r("h2"),Rt=r("a"),Ss=r("span"),v(Mo.$$.fragment),Vp=c(),Ds=r("span"),Up=t("TFRagModel"),cd=c(),N=r("div"),v(Go.$$.fragment),Kp=c(),Ve=r("p"),Yp=t("The "),Wn=r("a"),Jp=t("TFRagModel"),Xp=t(" forward method, overrides the "),Ls=r("code"),Zp=t("__call__"),em=t(" special method."),tm=c(),v(Ft.$$.fragment),om=c(),Is=r("p"),nm=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
as the `),ha=r("code"),Ou=t("generator"),Wu=t("."),Hu=c(),Io=r("p"),Bu=t("This model inherits from "),nr=r("a"),Qu=t("TFPreTrainedModel"),Vu=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
outperforming parametric seq2seq models and task-specific retrieve-and-extract architectures. For language generation
tasks, we find that RAG models generate more specific, diverse and factual language than a state-of-the-art
parametric-only seq2seq baseline.`),E_.forEach(n),$_.forEach(n),Qa=l(d),rt=s(d,"P",{});var gd=a(rt);li=o(gd,"This model was contributed by "),Lt=s(gd,"A",{href:!0,rel:!0});var j_=a(Lt);hi=o(j_,"ola13"),j_.forEach(n),pi=o(gd,"."),gd.forEach(n),Va=l(d),Ee=s(d,"H2",{class:!0});var _d=a(Ee);st=s(_d,"A",{id:!0,class:!0,href:!0});var M_=a(st);Er=s(M_,"SPAN",{});var G_=a(Er);b(It.$$.fragment,G_),G_.forEach(n),M_.forEach(n),mi=l(_d),jr=s(_d,"SPAN",{});var A_=a(jr);ui=o(A_,"RagConfig"),A_.forEach(n),_d.forEach(n),Ua=l(d),de=s(d,"DIV",{class:!0});var Ct=a(de);b(Ot.$$.fragment,Ct),gi=l(Ct),ue=s(Ct,"P",{});var tt=a(ue);ln=s(tt,"A",{href:!0});var P_=a(ln);_i=o(P_,"RagConfig"),P_.forEach(n),fi=o(tt," stores the configuration of a "),Mr=s(tt,"EM",{});var N_=a(Mr);vi=o(N_,"RagModel"),N_.forEach(n),bi=o(tt,". Configuration objects inherit from "),hn=s(tt,"A",{href:!0});var C_=a(hn);Ti=o(C_,"PretrainedConfig"),C_.forEach(n),wi=o(tt,` and
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),$s=s(V,"EM",{});var _v=a($s);dp=o(_v,"autoencoding"),_v.forEach(n),ip=o(V," model as the "),Es=s(V,"CODE",{});var fv=a(Es);cp=o(fv,"question_encoder"),fv.forEach(n),lp=o(V," and any "),js=s(V,"EM",{});var vv=a(js);hp=o(vv,"seq2seq"),vv.forEach(n),pp=o(V," model with language model head as the "),Ms=s(V,"CODE",{});var bv=a(Ms);mp=o(bv,"generator"),bv.forEach(n),up=o(V,`.
It has been tested with `),Sn=s(V,"A",{href:!0});var Tv=a(Sn);gp=o(Tv,"DPRQuestionEncoder"),Tv.forEach(n),_p=o(V," as the "),Gs=s(V,"CODE",{});var wv=a(Gs);fp=o(wv,"question_encoder"),wv.forEach(n),vp=o(V," and "),Dn=s(V,"A",{href:!0});var kv=a(Dn);bp=o(kv,"BartForConditionalGeneration"),kv.forEach(n),Tp=o(V,` or
`),Ln=s(V,"A",{href:!0});var qv=a(Ln);wp=o(qv,"T5ForConditionalGeneration"),qv.forEach(n),kp=o(V," as the "),As=s(V,"CODE",{});var yv=a(As);qp=o(yv,"generator"),yv.forEach(n),yp=o(V,"."),V.forEach(n),xp=l(Q),Ro=s(Q,"P",{});var Ld=a(Ro);Rp=o(Ld,"This model inherits from "),In=s(Ld,"A",{href:!0});var xv=a(In);Fp=o(xv,"PreTrainedModel"),xv.forEach(n),zp=o(Ld,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Id.forEach(n),Gp=l(Q),oe=s(Q,"DIV",{class:!0});var ke=a(oe);b($o.$$.fragment,ke),Ap=l(ke),Be=s(ke,"P",{});var Tr=a(Be);Pp=o(Tr,"The "),On=s(Tr,"A",{href:!0});var Fv=a(On);Np=o(Fv,"RagTokenForGeneration"),Fv.forEach(n),Cp=o(Tr," forward method, overrides the "),Ps=s(Tr,"CODE",{});var zv=a(Ps);Sp=o(zv,"__call__"),zv.forEach(n),Dp=o(Tr," special method."),Tr.forEach(n),Lp=l(ke),b(yt.$$.fragment,ke),Ip=l(ke),Ns=s(ke,"P",{});var $v=a(Ns);Op=o($v,"Example:"),$v.forEach(n),Wp=l(ke),b(Eo.$$.fragment,ke),ke.forEach(n),Hp=l(Q),xt=s(Q,"DIV",{class:!0});var Od=a(xt);b(jo.$$.fragment,Od),Bp=l(Od),Cs=s(Od,"P",{});var Ev=a(Cs);Qp=o(Ev,"Implements RAG token decoding."),Ev.forEach(n),Od.forEach(n),Q.forEach(n),id=l(d),Qe=s(d,"H2",{class:!0});var Wd=a(Qe);Rt=s(Wd,"A",{id:!0,class:!0,href:!0});var jv=a(Rt);Ss=s(jv,"SPAN",{});var Mv=a(Ss);b(Mo.$$.fragment,Mv),Mv.forEach(n),jv.forEach(n),Vp=l(Wd),Ds=s(Wd,"SPAN",{});var Gv=a(Ds);Up=o(Gv,"TFRagModel"),Gv.forEach(n),Wd.forEach(n),cd=l(d),N=s(d,"DIV",{class:!0});var U=a(N);b(Go.$$.fragment,U),Kp=l(U),Ve=s(U,"P",{});var wr=a(Ve);Yp=o(wr,"The "),Wn=s(wr,"A",{href:!0});var Av=a(Wn);Jp=o(Av,"TFRagModel"),Av.forEach(n),Xp=o(wr," forward method, overrides the "),Ls=s(wr,"CODE",{});var Pv=a(Ls);Zp=o(Pv,"__call__"),Pv.forEach(n),em=o(wr," special method."),wr.forEach(n),tm=l(U),b(Ft.$$.fragment,U),om=l(U),Is=s(U,"P",{});var Nv=a(Is);nm=o(Nv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
...
any `),Ws=s(qe,"EM",{});var Dv=a(Ws);lm=o(Dv,"seq2seq"),Dv.forEach(n),hm=o(qe," model, preferably "),Bn=s(qe,"A",{href:!0});var Lv=a(Bn);pm=o(Lv,"TFBartForConditionalGeneration"),Lv.forEach(n),mm=o(qe,"."),qe.forEach(n),um=l(U),L=s(U,"P",{});var K=a(L);gm=o(K,"The model can be initialized with a "),Qn=s(K,"A",{href:!0});var Iv=a(Qn);_m=o(Iv,"RagRetriever"),Iv.forEach(n),fm=o(K,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
as the `),Ks=s(K,"CODE",{});var Kv=a(Ks);Mm=o(Kv,"generator"),Kv.forEach(n),Gm=o(K,"."),K.forEach(n),Am=l(U),Ao=s(U,"P",{});var Hd=a(Ao);Pm=o(Hd,"This model inherits from "),Kn=s(Hd,"A",{href:!0});var Yv=a(Kn);Nm=o(Yv,"TFPreTrainedModel"),Yv.forEach(n),Cm=o(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(n),Sm=l(U),Po=s(U,"P",{});var Bd=a(Po);Dm=o(Bd,"This model is also a Tensorflow "),No=s(Bd,"A",{href:!0,rel:!0});var Jv=a(No);Lm=o(Jv,"tf.keras.Model"),Jv.forEach(n),Im=o(Bd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
as the `),ha=s(Y,"CODE",{});var wb=a(ha);Ou=o(wb,"generator"),wb.forEach(n),Wu=o(Y,"."),Y.forEach(n),Hu=l(C),Io=s(C,"P",{});var Vd=a(Io);Bu=o(Vd,"This model inherits from "),nr=s(Vd,"A",{href:!0});var kb=a(nr);Qu=o(kb,"TFPreTrainedModel"),kb.forEach(n),Vu=o(Vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
