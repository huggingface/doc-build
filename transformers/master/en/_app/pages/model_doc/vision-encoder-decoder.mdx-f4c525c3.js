...
documentation from `),So=a(Yo,"A",{href:!0});var Kd=s(So);vr=n(Kd,"PretrainedConfig"),Kd.forEach(o),br=n(Yo," for more information."),Yo.forEach(o),Tr=l(N),it=a(N,"P",{});var Qd=s(it);wr=n(Qd,"Examples:"),Qd.forEach(o),yr=l(N),g(Me.$$.fragment,N),Er=l(N),ue=a(N,"DIV",{class:!0});var pn=s(ue);g(Ve.$$.fragment,pn),kr=l(pn),$e=a(pn,"P",{});var mn=s($e);xr=n(mn,"Instantiate a "),Io=a(mn,"A",{href:!0});var Xd=s(Io);jr=n(Xd,"VisionEncoderDecoderConfig"),Xd.forEach(o),Dr=n(mn,` (or a derived class) from a pre-trained encoder model
