...
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);P=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(j,"CODE",{});var C=s(h);M=n(C,"Module"),C.forEach(o),F=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,P),e(p,h),e(h,M),e(p,F)},d(y){y&&o(p)}}}function pc(Q){let p,P,h,M,F,y,j,C,Vn,Jt,f,$n,Eo,qn,zn,rt,Pn,Fn,ko,Cn,An,xo,In,Sn,jo,Ln,Nn,Do,On,Rn,at,Bn,Gn,Mo,Wn,Un,Vo,Hn,Zn,$o,Yn,Jn,qo,Kn,Qn,Kt,me,Xn,xe,er,or,Qt,G,tr,zo,nr,rr,Po,ar,sr,Xt,X,he,st,je,dr,dt,ir,en,z,De,cr,fe,Fo,lr,pr,Co,mr,hr,fr,ee,ur,Ao,gr,_r,Io,vr,br,Tr,it,wr,yr,Me,Er,ue,Ve,kr,$e,xr,So,jr,Dr,Mr,ge,qe,Vr,oe,$r,ct,qr,zr,lt,Pr,Fr,on,te,_e,pt,ze,Cr,mt,Ar,tn,E,Pe,Ir,ne,Sr,ht,Lr,Nr,ft,Or,Rr,Br,Fe,Gr,Ce,Wr,Ur,Hr,Ae,Zr,Ie,Yr,Jr,Kr,ut,Qr,Xr,Se,ea,Lo,oa,ta,na,Le,ra,Ne,aa,sa,da,W,No,ia,ca,gt,la,pa,_t,ma,ha,fa,A,Oe,ua,re,ga,Oo,_a,va,vt,ba,Ta,wa,ve,ya,bt,Ea,ka,Re,xa,I,Be,ja,Tt,Da,Ma,ae,Va,wt,$a,qa,yt,za,Pa,Fa,Et,Ca,Aa,Ge,nn,se,be,kt,We,Ia,xt,Sa,rn,k,Ue,La,de,Na,jt,Oa,Ra,Dt,Ba,Ga,Wa,He,Ua,Ze,Ha,Za,Ya,Ye,Ja,Je,Ka,Qa,Xa,Mt,es,os,Ke,ts,Ro,ns,rs,as,Qe,ss,Xe,ds,is,cs,U,Bo,ls,ps,Vt,ms,hs,$t,fs,us,gs,S,eo,_s,ie,vs,Go,bs,Ts,qt,ws,ys,Es,Te,ks,zt,xs,js,oo,Ds,O,to,Ms,Pt,Vs,$s,Ft,qs,zs,no,an,ce,we,Ct,ro,Ps,At,Fs,sn,x,ao,Cs,le,As,It,Is,Ss,St,Ls,Ns,Os,so,Rs,io,Bs,Gs,Ws,co,Us,lo,Hs,Zs,Ys,Lt,Js,Ks,po,Qs,Wo,Xs,ed,od,mo,td,ho,nd,rd,ad,H,Uo,sd,dd,Nt,id,cd,Ot,ld,pd,md,L,fo,hd,pe,fd,Ho,ud,gd,Rt,_d,vd,bd,ye,Td,Bt,wd,yd,uo,Ed,R,go,kd,Gt,xd,jd,Wt,Dd,Md,_o,dn;return y=new Yt({}),je=new Yt({}),De=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
and any pretrained language model as the decoder (`),at=r("em"),Bn=t("e.g."),Gn=c(),Mo=r("a"),Wn=t("RoBERTa"),Un=t(", "),Vo=r("a"),Hn=t("GPT2"),Zn=t(", "),$o=r("a"),Yn=t("BERT"),Jn=t(", "),qo=r("a"),Kn=t("DistilBERT"),Qn=t(")."),Kt=c(),me=r("p"),Xn=t(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
documentation from `),Io=a(Yo,"A",{href:!0});var Kd=s(Io);vr=n(Kd,"PretrainedConfig"),Kd.forEach(o),br=n(Yo," for more information."),Yo.forEach(o),Tr=l(N),it=a(N,"P",{});var Qd=s(it);wr=n(Qd,"Examples:"),Qd.forEach(o),yr=l(N),g(Me.$$.fragment,N),Er=l(N),ue=a(N,"DIV",{class:!0});var pn=s(ue);g(Ve.$$.fragment,pn),kr=l(pn),$e=a(pn,"P",{});var mn=s($e);xr=n(mn,"Instantiate a "),So=a(mn,"A",{href:!0});var Xd=s(So);jr=n(Xd,"VisionEncoderDecoderConfig"),Xd.forEach(o),Dr=n(mn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),mn.forEach(o),pn.forEach(o),Mr=l(N),ge=a(N,"DIV",{class:!0});var hn=s(ge);g(qe.$$.fragment,hn),Vr=l(hn),oe=a(hn,"P",{});var Jo=s(oe);$r=n(Jo,"Serializes this instance to a Python dictionary. Override the default "),ct=a(Jo,"EM",{});var ei=s(ct);qr=n(ei,"to_dict()"),ei.forEach(o),zr=n(Jo," from "),lt=a(Jo,"EM",{});var oi=s(lt);Pr=n(oi,"PretrainedConfig"),oi.forEach(o),Fr=n(Jo,"."),Jo.forEach(o),hn.forEach(o),N.forEach(o),on=l(d),te=a(d,"H2",{class:!0});var fn=s(te);_e=a(fn,"A",{id:!0,class:!0,href:!0});var ti=s(_e);pt=a(ti,"SPAN",{});var ni=s(pt);g(ze.$$.fragment,ni),ni.forEach(o),ti.forEach(o),Cr=l(fn),mt=a(fn,"SPAN",{});var ri=s(mt);Ar=n(ri,"VisionEncoderDecoderModel"),ri.forEach(o),fn.forEach(o),tn=l(d),E=a(d,"DIV",{class:!0});var V=s(E);g(Pe.$$.fragment,V),Ir=l(V),ne=a(V,"P",{});var Ko=s(ne);Sr=n(Ko,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
`),ho=a(Mn,"A",{href:!0,rel:!0});var Yi=s(ho);nd=n(Yi,"flax.nn.Module"),Yi.forEach(o),rd=n(Mn,` subclass. Use it as a
