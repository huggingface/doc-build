import{S as Hu,i as Ku,s as Qu,e as n,k as l,w as f,t as r,M as Vu,c as a,d as t,m as i,a as s,x as _,h as d,b as c,F as e,g as p,y as g,q as b,o as k,B as v}from"../../chunks/vendor-6b77c823.js";import{T as zn}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-abef54e3.js";import{C as rt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Fe}from"../../chunks/IconCopyLink-7a11ce68.js";function Ju(K){let h,x,y,T,B;return{c(){h=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var q=s(y);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,h,w),e(h,x),e(h,y),e(y,T),e(h,B)},d(S){S&&t(h)}}}function Xu(K){let h,x,y,T,B;return{c(){h=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var q=s(y);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,h,w),e(h,x),e(h,y),e(y,T),e(h,B)},d(S){S&&t(h)}}}function Yu(K){let h,x,y,T,B,S,w,q,Ce,ue,z,je,U,Pe,Oe,W,Le,Ne,Q,V,Ie,Z,C,O,fe,ae,$e,J,A,Te,se,L,we,re,Me,ee,de,le,Ae,X,Ee,R,De;return{c(){h=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),y=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),q=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),z=n("p"),je=r("This second option is useful when using "),U=n("code"),Pe=r("tf.keras.Model.fit"),Oe=r(` method which currently requires having all the
...
`),R=a(Be,"CODE",{});var ze=s(R);De=d(ze,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ze.forEach(t),Be.forEach(t),Y.forEach(t)},m(u,F){p(u,h,F),e(h,x),p(u,y,F),p(u,T,F),e(T,B),e(B,S),e(T,w),e(T,q),e(q,Ce),p(u,ue,F),p(u,z,F),e(z,je),e(z,U),e(U,Pe),e(z,Oe),e(z,W),e(W,Le),e(z,Ne),p(u,Q,F),p(u,V,F),e(V,Ie),p(u,Z,F),p(u,C,F),e(C,O),e(O,fe),e(O,ae),e(ae,$e),e(O,J),e(O,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Me),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,X),e(X,Ee),e(X,R),e(R,De)},d(u){u&&t(h),u&&t(y),u&&t(T),u&&t(ue),u&&t(z),u&&t(Q),u&&t(V),u&&t(Z),u&&t(C)}}}function Zu(K){let h,x,y,T,B;return{c(){h=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var q=s(y);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,h,w),e(h,x),e(h,y),e(y,T),e(h,B)},d(S){S&&t(h)}}}function ef(K){let h,x,y,T,B,S,w,q,Ce,ue,z,je,U,Pe,Oe,W,Le,Ne,Q,V,Ie,Z,C,O,fe,ae,$e,J,A,Te,se,L,we,re,Me,ee,de,le,Ae,X,Ee,R,De;return{c(){h=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),y=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),q=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),z=n("p"),je=r("This second option is useful when using "),U=n("code"),Pe=r("tf.keras.Model.fit"),Oe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),Le=r("model(inputs)"),Ne=r("."),Q=l(),V=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=l(),C=n("ul"),O=n("li"),fe=r("a single Tensor with "),ae=n("code"),$e=r("input_ids"),J=r(" only and nothing else: "),A=n("code"),Te=r("model(input_ids)"),se=l(),L=n("li"),we=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),Me=r("model([input_ids, attention_mask])"),ee=r(" or "),de=n("code"),le=r("model([input_ids, attention_mask, token_type_ids])"),Ae=l(),X=n("li"),Ee=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){h=a(u,"P",{});var F=s(h);x=d(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),y=i(u),T=a(u,"UL",{});var ie=s(T);B=a(ie,"LI",{});var dt=s(B);S=d(dt,"having all inputs as keyword arguments (like PyTorch models), or"),dt.forEach(t),w=i(ie),q=a(ie,"LI",{});var Re=s(q);Ce=d(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(t),ie.forEach(t),ue=i(u),z=a(u,"P",{});var j=s(z);je=d(j,"This second option is useful when using "),U=a(j,"CODE",{});var lt=s(U);Pe=d(lt,"tf.keras.Model.fit"),lt.forEach(t),Oe=d(j,` method which currently requires having all the
...
first positional argument :`),it.forEach(t),Z=i(u),C=a(u,"UL",{});var Y=s(C);O=a(Y,"LI",{});var D=s(O);fe=d(D,"a single Tensor with "),ae=a(D,"CODE",{});var ct=s(ae);$e=d(ct,"input_ids"),ct.forEach(t),J=d(D," only and nothing else: "),A=a(D,"CODE",{});var pt=s(A);Te=d(pt,"model(input_ids)"),pt.forEach(t),D.forEach(t),se=i(Y),L=a(Y,"LI",{});var te=s(L);we=d(te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(te,"CODE",{});var ce=s(re);Me=d(ce,"model([input_ids, attention_mask])"),ce.forEach(t),ee=d(te," or "),de=a(te,"CODE",{});var _e=s(de);le=d(_e,"model([input_ids, attention_mask, token_type_ids])"),_e.forEach(t),te.forEach(t),Ae=i(Y),X=a(Y,"LI",{});var Be=s(X);Ee=d(Be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(Be,"CODE",{});var ze=s(R);De=d(ze,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ze.forEach(t),Be.forEach(t),Y.forEach(t)},m(u,F){p(u,h,F),e(h,x),p(u,y,F),p(u,T,F),e(T,B),e(B,S),e(T,w),e(T,q),e(q,Ce),p(u,ue,F),p(u,z,F),e(z,je),e(z,U),e(U,Pe),e(z,Oe),e(z,W),e(W,Le),e(z,Ne),p(u,Q,F),p(u,V,F),e(V,Ie),p(u,Z,F),p(u,C,F),e(C,O),e(O,fe),e(O,ae),e(ae,$e),e(O,J),e(O,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Me),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,X),e(X,Ee),e(X,R),e(R,De)},d(u){u&&t(h),u&&t(y),u&&t(T),u&&t(ue),u&&t(z),u&&t(Q),u&&t(V),u&&t(Z),u&&t(C)}}}function tf(K){let h,x,y,T,B;return{c(){h=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var q=s(y);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,h,w),e(h,x),e(h,y),e(y,T),e(h,B)},d(S){S&&t(h)}}}function of(K){let h,x,y,T,B;return{c(){h=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var q=s(y);T=d(q,"Module"),q.forEach(t),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(S,w){p(S,h,w),e(h,x),e(h,y),e(y,T),e(h,B)},d(S){S&&t(h)}}}function nf(K){let h,x,y,T,B,S,w,q,Ce,ue,z,je,U,Pe,Oe,W,Le,Ne,Q,V,Ie,Z,C,O,fe,ae,$e,J,A,Te,se,L,we,re,Me,ee,de,le,Ae,X,Ee,R,De,u,F,ie,dt,Re,j,lt,Se,it,Y,D,ct,pt,te,ce,_e,Be,ze,md,la,hd,ur,pe,eo,ud,mt,fd,xn,_d,gd,to,bd,kd,vd,ht,yd,qn,Td,wd,Fn,Sd,Bd,zd,ia,xd,qd,oo,fr,ut,$t,ca,no,Fd,pa,$d,_r,G,ao,Md,ma,Ed,Cd,so,jd,$n,Pd,Od,Ld,He,ro,Nd,ha,Id,Ad,ua,Dd,Gd,Mt,lo,Ud,ft,Wd,fa,Rd,Hd,_a,Kd,Qd,Vd,Ke,io,Jd,Mn,Xd,En,Yd,Zd,ga,el,tl,Cn,co,gr,_t,Et,ba,po,ol,ka,nl,br,Ge,mo,al,ho,sl,va,rl,dl,ll,Ct,uo,il,ya,cl,kr,gt,jt,Ta,fo,pl,wa,ml,vr,xe,_o,hl,go,ul,jn,fl,_l,gl,bo,bl,ko,kl,vl,yl,ge,vo,Tl,bt,wl,Pn,Sl,Bl,Sa,zl,xl,ql,Pt,Fl,Ba,$l,Ml,yo,yr,kt,Ot,za,To,El,xa,Cl,Tr,qe,wo,jl,So,Pl,On,Ol,Ll,Nl,Bo,Il,zo,Al,Dl,Gl,be,xo,Ul,vt,Wl,Ln,Rl,Hl,qa,Kl,Ql,Vl,Lt,Jl,Fa,Xl,Yl,qo,wr,yt,Nt,$a,Fo,Zl,Ma,ei,Sr,Tt,$o,ti,Qe,Mo,oi,Ea,ni,ai,Eo,Br,wt,It,Ca,Co,si,ja,ri,zr,me,jo,di,Po,li,Nn,ii,ci,pi,Oo,mi,Lo,hi,ui,fi,At,_i,ke,No,gi,St,bi,In,ki,vi,Pa,yi,Ti,wi,Dt,Si,Oa,Bi,zi,Io,xr,Bt,Gt,La,Ao,xi,Na,qi,qr,he,Do,Fi,Go,$i,An,Mi,Ei,Ci,Uo,ji,Wo,Pi,Oi,Li,Ut,Ni,P,Ro,Ii,zt,Ai,Dn,Di,Gi,Ia,Ui,Wi,Ri,Wt,Hi,Aa,Ki,Qi,Da,Ga,Ua,Wa,Vi,Ji,Ra,Ha,Ka,Qa,Xi,Yi,Va,Ja,Xa,Ya,Zi,ec,Za,es,ts,Ho,tc,os,oc,nc,ac,ns,as,ss,rs,sc,Fr,xt,Rt,ds,Ko,rc,ls,dc,$r,N,Qo,lc,Vo,ic,Gn,cc,pc,mc,Jo,hc,Xo,uc,fc,_c,is,gc,bc,Ue,cs,Yo,kc,vc,ps,Zo,yc,Tc,ms,en,wc,Sc,hs,tn,Bc,zc,Ve,on,xc,us,qc,Fc,nn,$c,Je,an,Mc,fs,Ec,Cc,sn,jc,Xe,rn,Pc,_s,Oc,Lc,dn,Mr,qt,Ht,gs,ln,Nc,bs,Ic,Er,I,cn,Ac,pn,Dc,Un,Gc,Uc,Wc,mn,Rc,hn,Hc,Kc,Qc,ks,Vc,Jc,We,vs,un,Xc,Yc,ys,fn,Zc,ep,Ts,_n,tp,op,ws,gn,np,ap,$,bn,sp,Ft,rp,Ss,dp,lp,Bs,ip,cp,pp,Kt,mp,zs,hp,up,xs,qs,Fs,$s,fp,_p,Ms,Es,Cs,js,gp,bp,Ps,Os,Ls,Ns,kp,vp,Is,As,kn,Qt,Vt,Ds,vn,yp,Gs,Tp,wp,Us,Sp,Bp,Ws,zp,xp,Rs,Hs,Ks,Qs,qp,Fp,Vs,Js,Xs,Ys,$p,Mp,Zs,er,tr,or,Ep,Cp,nr,ar,sr,rr,jp,Pp,Ye,yn,Op,dr,Lp,Np,Tn,Ip,Ze,wn,Ap,lr,Dp,Gp,Sn,Cr;return S=new Fe({}),se=new Fe({}),ze=new Fe({}),eo=new E({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/blenderbot_small/configuration_blenderbot_small.py#L29",parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xo=new E({props:{name:"forward",anchor:"transformers.BlenderbotSmallForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1244",parametersDescription:[{anchor:"transformers.BlenderbotSmallForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/blenderbot-small#transformers.BlenderbotSmallTokenizer">BlenderbotSmallTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ao=new Fe({}),Do=new E({props:{name:"class transformers.TFBlenderbotSmallForConditionalGeneration",anchor:"transformers.TFBlenderbotSmallForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1200",parametersDescription:[{anchor:"transformers.TFBlenderbotSmallForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig">BlenderbotSmallConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ut=new zn({props:{$$slots:{default:[ef]},$$scope:{ctx:K}}}),Ro=new E({props:{name:"call",anchor:"transformers.TFBlenderbotSmallForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1233",parametersDescription:[{anchor:"transformers.TFBlenderbotSmallForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/blenderbot-small#transformers.BlenderbotSmallTokenizer">BlenderbotSmallTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=n("meta"),x=l(),y=n("h1"),T=n("a"),B=n("span"),f(S.$$.fragment),w=l(),q=n("span"),Ce=r("Blenderbot Small"),ue=l(),z=n("p"),je=r("Note that "),U=n("a"),Pe=r("BlenderbotSmallModel"),Oe=r(` and
...
found `),D=n("a"),ct=r("here"),pt=r(" ."),te=l(),ce=n("h2"),_e=n("a"),Be=n("span"),f(ze.$$.fragment),md=l(),la=n("span"),hd=r("BlenderbotSmallConfig"),ur=l(),pe=n("div"),f(eo.$$.fragment),ud=l(),mt=n("p"),fd=r("This is the configuration class to store the configuration of a "),xn=n("a"),_d=r("BlenderbotSmallModel"),gd=r(`. It is used to instantiate
...
does not make use of token type ids, therefore a list of zeros is returned.`),kr=l(),gt=n("h2"),jt=n("a"),Ta=n("span"),f(fo.$$.fragment),pl=l(),wa=n("span"),ml=r("BlenderbotSmallModel"),vr=l(),xe=n("div"),f(_o.$$.fragment),hl=l(),go=n("p"),ul=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
behavior.`),fi=l(),f(At.$$.fragment),_i=l(),ke=n("div"),f(No.$$.fragment),gi=l(),St=n("p"),bi=r("The "),In=n("a"),ki=r("TFBlenderbotSmallModel"),vi=r(" forward method, overrides the "),Pa=n("code"),yi=r("__call__"),Ti=r(" special method."),wi=l(),f(Dt.$$.fragment),Si=l(),Oa=n("p"),Bi=r("Example:"),zi=l(),f(Io.$$.fragment),xr=l(),Bt=n("h2"),Gt=n("a"),La=n("span"),f(Ao.$$.fragment),xi=l(),Na=n("span"),qi=r("TFBlenderbotSmallForConditionalGeneration"),qr=l(),he=n("div"),f(Do.$$.fragment),Fi=l(),Go=n("p"),$i=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Cp=l(),nr=n("blockquote"),ar=n("blockquote"),sr=n("blockquote"),rr=n("p"),jp=r("tokenizer.decode(predictions).split()"),Pp=l(),Ye=n("div"),f(yn.$$.fragment),Op=l(),dr=n("p"),Lp=r("Example:"),Np=l(),f(Tn.$$.fragment),Ip=l(),Ze=n("div"),f(wn.$$.fragment),Ap=l(),lr=n("p"),Dp=r("Example:"),Gp=l(),f(Sn.$$.fragment),this.h()},l(o){const m=Vu('[data-svelte="svelte-1phssyn"]',document.head);h=a(m,"META",{name:!0,content:!0}),m.forEach(t),x=i(o),y=a(o,"H1",{class:!0});var Bn=s(y);T=a(Bn,"A",{id:!0,class:!0,href:!0});var ir=s(T);B=a(ir,"SPAN",{});var cr=s(B);_(S.$$.fragment,cr),cr.forEach(t),ir.forEach(t),w=i(Bn),q=a(Bn,"SPAN",{});var pr=s(q);Ce=d(pr,"Blenderbot Small"),pr.forEach(t),Bn.forEach(t),ue=i(o),z=a(o,"P",{});var ve=s(z);je=d(ve,"Note that "),U=a(ve,"A",{href:!0});var mr=s(U);Pe=d(mr,"BlenderbotSmallModel"),mr.forEach(t),Oe=d(ve,` and
...
IDs?`),km.forEach(t),Up.forEach(t),Zd=i(Vn),ga=a(Vn,"P",{});var vm=s(ga);el=d(vm,"Should be overridden in a subclass if the model has a special way of building those."),vm.forEach(t),Vn.forEach(t),tl=i(ye),Cn=a(ye,"DIV",{class:!0});var ym=s(Cn);_(co.$$.fragment,ym),ym.forEach(t),ye.forEach(t),gr=i(o),_t=a(o,"H2",{class:!0});var Ar=s(_t);Et=a(Ar,"A",{id:!0,class:!0,href:!0});var Tm=s(Et);ba=a(Tm,"SPAN",{});var wm=s(ba);_(po.$$.fragment,wm),wm.forEach(t),Tm.forEach(t),ol=i(Ar),ka=a(Ar,"SPAN",{});var Sm=s(ka);nl=d(Sm,"BlenderbotSmallTokenizerFast"),Sm.forEach(t),Ar.forEach(t),br=i(o),Ge=a(o,"DIV",{class:!0});var Jn=s(Ge);_(mo.$$.fragment,Jn),al=i(Jn),ho=a(Jn,"P",{});var Dr=s(ho);sl=d(Dr,"Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),va=a(Dr,"EM",{});var Bm=s(va);rl=d(Bm,"tokenizers"),Bm.forEach(t),dl=d(Dr," library)."),Dr.forEach(t),ll=i(Jn),Ct=a(Jn,"DIV",{class:!0});var Gr=s(Ct);_(uo.$$.fragment,Gr),il=i(Gr),ya=a(Gr,"P",{});var zm=s(ya);cl=d(zm,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),zm.forEach(t),Gr.forEach(t),Jn.forEach(t),kr=i(o),gt=a(o,"H2",{class:!0});var Ur=s(gt);jt=a(Ur,"A",{id:!0,class:!0,href:!0});var xm=s(jt);Ta=a(xm,"SPAN",{});var qm=s(Ta);_(fo.$$.fragment,qm),qm.forEach(t),xm.forEach(t),pl=i(Ur),wa=a(Ur,"SPAN",{});var Fm=s(wa);ml=d(Fm,"BlenderbotSmallModel"),Fm.forEach(t),Ur.forEach(t),vr=i(o),xe=a(o,"DIV",{class:!0});var Jt=s(xe);_(_o.$$.fragment,Jt),hl=i(Jt),go=a(Jt,"P",{});var Wr=s(go);ul=d(Wr,`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr.forEach(t),yl=i(Jt),ge=a(Jt,"DIV",{class:!0});var tt=s(ge);_(vo.$$.fragment,tt),Tl=i(tt),bt=a(tt,"P",{});var Xn=s(bt);wl=d(Xn,"The "),Pn=a(Xn,"A",{href:!0});var Em=s(Pn);Sl=d(Em,"BlenderbotSmallModel"),Em.forEach(t),Bl=d(Xn," forward method, overrides the "),Sa=a(Xn,"CODE",{});var Cm=s(Sa);zl=d(Cm,"__call__"),Cm.forEach(t),xl=d(Xn," special method."),Xn.forEach(t),ql=i(tt),_(Pt.$$.fragment,tt),Fl=i(tt),Ba=a(tt,"P",{});var jm=s(Ba);$l=d(jm,"Example:"),jm.forEach(t),Ml=i(tt),_(yo.$$.fragment,tt),tt.forEach(t),Jt.forEach(t),yr=i(o),kt=a(o,"H2",{class:!0});var Hr=s(kt);Ot=a(Hr,"A",{id:!0,class:!0,href:!0});var Pm=s(Ot);za=a(Pm,"SPAN",{});var Om=s(za);_(To.$$.fragment,Om),Om.forEach(t),Pm.forEach(t),El=i(Hr),xa=a(Hr,"SPAN",{});var Lm=s(xa);Cl=d(Lm,"BlenderbotSmallForConditionalGeneration"),Lm.forEach(t),Hr.forEach(t),Tr=i(o),qe=a(o,"DIV",{class:!0});var Xt=s(qe);_(wo.$$.fragment,Xt),jl=i(Xt),So=a(Xt,"P",{});var Kr=s(So);Pl=d(Kr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zr.forEach(t),fi=i(nt),_(At.$$.fragment,nt),_i=i(nt),ke=a(nt,"DIV",{class:!0});var at=s(ke);_(No.$$.fragment,at),gi=i(at),St=a(at,"P",{});var ea=s(St);bi=d(ea,"The "),In=a(ea,"A",{href:!0});var Ym=s(In);ki=d(Ym,"TFBlenderbotSmallModel"),Ym.forEach(t),vi=d(ea," forward method, overrides the "),Pa=a(ea,"CODE",{});var Zm=s(Pa);yi=d(Zm,"__call__"),Zm.forEach(t),Ti=d(ea," special method."),ea.forEach(t),wi=i(at),_(Dt.$$.fragment,at),Si=i(at),Oa=a(at,"P",{});var eh=s(Oa);Bi=d(eh,"Example:"),eh.forEach(t),zi=i(at),_(Io.$$.fragment,at),at.forEach(t),nt.forEach(t),xr=i(o),Bt=a(o,"H2",{class:!0});var ed=s(Bt);Gt=a(ed,"A",{id:!0,class:!0,href:!0});var th=s(Gt);La=a(th,"SPAN",{});var oh=s(La);_(Ao.$$.fragment,oh),oh.forEach(t),th.forEach(t),xi=i(ed),Na=a(ed,"SPAN",{});var nh=s(Na);qi=d(nh,"TFBlenderbotSmallForConditionalGeneration"),nh.forEach(t),ed.forEach(t),qr=i(o),he=a(o,"DIV",{class:!0});var st=s(he);_(Do.$$.fragment,st),Fi=i(st),Go=a(st,"P",{});var td=s(Go);$i=d(td,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),nd.forEach(t),wh.forEach(t),Th.forEach(t),yh.forEach(t),ac=i(H),ns=a(H,"BLOCKQUOTE",{});var Bh=s(ns);as=a(Bh,"BLOCKQUOTE",{});var zh=s(as);ss=a(zh,"BLOCKQUOTE",{});var xh=s(ss);rs=a(xh,"P",{});var qh=s(rs);sc=d(qh,`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),qh.forEach(t),xh.forEach(t),zh.forEach(t),Bh.forEach(t),H.forEach(t),st.forEach(t),Fr=i(o),xt=a(o,"H2",{class:!0});var ad=s(xt);Rt=a(ad,"A",{id:!0,class:!0,href:!0});var Fh=s(Rt);ds=a(Fh,"SPAN",{});var $h=s(ds);_(Ko.$$.fragment,$h),$h.forEach(t),Fh.forEach(t),rc=i(ad),ls=a(ad,"SPAN",{});var Mh=s(ls);dc=d(Mh,"FlaxBlenderbotSmallModel"),Mh.forEach(t),ad.forEach(t),$r=i(o),N=a(o,"DIV",{class:!0});var oe=s(N);_(Qo.$$.fragment,oe),lc=i(oe),Vo=a(oe,"P",{});var sd=s(Vo);ic=d(sd,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
