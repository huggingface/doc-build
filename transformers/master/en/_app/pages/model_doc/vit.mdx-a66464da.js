import{S as up,i as gp,s as _p,e as a,k as d,w,t as n,M as vp,c as s,d as t,m as c,a as r,x as b,h as i,b as l,F as e,g as f,y,q as $,o as x,B as E}from"../../chunks/vendor-4833417e.js";import{T as Ee}from"../../chunks/Tip-fffd6df1.js";import{D as B}from"../../chunks/Docstring-7b52c3d4.js";import{C as zo}from"../../chunks/CodeBlock-90ffda97.js";import{I as Ve}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function Tp(I){let h,v,m,u,T;return{c(){h=a("p"),v=n(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
Whether to add a bias to the queries, keys and values.`,name:"qkv_bias"}]}}),Ct=new zo({props:{codee:`from transformers import ViTModel, ViTConfig
...
`}}),Ye=new Ee({props:{$$slots:{default:[bp]},$$scope:{ctx:I}}}),Ut=new zo({props:{codee:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
`}}),tt=new Ee({props:{$$slots:{default:[yp]},$$scope:{ctx:I}}}),Gt=new zo({props:{codee:`from transformers import ViTFeatureExtractor, ViTForImageClassification
import torch
from datasets import load_dataset
...
`}}),st=new Ee({props:{$$slots:{default:[xp]},$$scope:{ctx:I}}}),oo=new zo({props:{codee:`from transformers import ViTFeatureExtractor, TFViTModel
...
`}}),it=new Ee({props:{$$slots:{default:[Vp]},$$scope:{ctx:I}}}),co=new zo({props:{codee:`from transformers import ViTFeatureExtractor, TFViTForImageClassification
...
`}}),dt=new Ee({props:{$$slots:{default:[Fp]},$$scope:{ctx:I}}}),bo=new zo({props:{codee:`from transformers import ViTFeatureExtractor, FlaxViTModel
from PIL import Image
import requests
...
`}}),ht=new Ee({props:{$$slots:{default:[kp]},$$scope:{ctx:I}}}),Po=new zo({props:{codee:`from transformers import ViTFeatureExtractor, FlaxViTForImageClassification
from PIL import Image
import jax
import requests
