...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){p=n("meta"),W=d(),h=n("h1"),_=n("a"),D=n("span"),v(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Vt=d(),K=n("h2"),Z=n("a"),ut=n("span"),v(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),Lt=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),me=n("a"),Eo=r(`Performance-Efficiency Trade-offs
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(V),P=a(V,"DIV",{class:!0});var L=s(P);w(De.$$.fragment,L),hn=c(L),J=a(L,"P",{});var dt=s(J);un=i(dt,"The "),ot=a(dt,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWDModel"),Za.forEach(o),_n=i(dt," forward method, overrides the "),Wt=a(dt,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(L),w(se.$$.fragment,L),yn=c(L),Dt=a(L,"P",{});var ts=s(Dt);En=i(ts,"Example:"),ts.forEach(o),Sn=c(L),w(ke.$$.fragment,L),L.forEach(o),V.forEach(o),Yt=c(t),Q=a(t,"H2",{class:!0});var mo=s(Q);re=a(mo,"A",{id:!0,class:!0,href:!0});var os=s(re);kt=a(os,"SPAN",{});var ns=s(kt);w(Ce.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=c(mo),Ct=a(mo,"SPAN",{});var as=s(Ct);Dn=i(as,"SEWDForCTC"),as.forEach(o),mo.forEach(o),Bt=c(t),x=a(t,"DIV",{class:!0});var I=s(x);w(Te.$$.fragment,I),kn=c(I),Y=a(I,"P",{});var ct=s(Y);Cn=i(ct,"SEW-D Model with a "),Tt=a(ct,"CODE",{});var ss=s(Tt);Tn=i(ss,"language modeling"),ss.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),ct.forEach(o),jn=c(I),qe=a(I,"P",{});var po=s(qe);Pn=i(po,"This model inherits from "),nt=a(po,"A",{href:!0});var is=s(nt);Fn=i(is,"PreTrainedModel"),is.forEach(o),Mn=i(po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),zn=c(I),xe=a(I,"P",{});var fo=s(xe);An=i(fo,"This model is a PyTorch "),je=a(fo,"A",{href:!0,rel:!0});var ls=s(je);Vn=i(ls,"torch.nn.Module"),ls.forEach(o),Ln=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),In=c(I),C=a(I,"DIV",{class:!0});var F=s(C);w(Pe.$$.fragment,F),Nn=c(F),B=a(F,"P",{});var mt=s(B);Kn=i(mt,"The "),at=a(mt,"A",{href:!0});var ds=s(at);On=i(ds,"SEWDForCTC"),ds.forEach(o),Hn=i(mt," forward method, overrides the "),$t=a(mt,"CODE",{});var cs=s($t);Rn=i(cs,"__call__"),cs.forEach(o),Un=i(mt," special method."),mt.forEach(o),Jn=c(F),w(ie.$$.fragment,F),Qn=c(F),qt=a(F,"P",{});var ms=s(qt);Yn=i(ms,"Example:"),ms.forEach(o),Bn=c(F),w(Fe.$$.fragment,F),Gn=c(F),w(Me.$$.fragment,F),F.forEach(o),I.forEach(o),Gt=c(t),G=a(t,"H2",{class:!0});var ho=s(G);le=a(ho,"A",{id:!0,class:!0,href:!0});var ps=s(le);xt=a(ps,"SPAN",{});var fs=s(xt);w(ze.$$.fragment,fs),fs.forEach(o),ps.forEach(o),Xn=c(ho),jt=a(ho,"SPAN",{});var hs=s(jt);Zn=i(hs,"SEWDForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=c(t),k=a(t,"DIV",{class:!0});var M=s(k);w(Ae.$$.fragment,M),ea=c(M),Pt=a(M,"P",{});var us=s(Pt);ta=i(us,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
