import{S as Ji,i as Ki,s as Qi,e as r,k as c,w as f,t,M as Xi,c as a,d as o,m as l,a as d,x as u,h as n,b as i,F as e,g as T,y as g,q as _,o as v,B as b}from"../../chunks/vendor-4833417e.js";import{T as Ed}from"../../chunks/Tip-fffd6df1.js";import{D as B}from"../../chunks/Docstring-7b52c3d4.js";import{C as yo}from"../../chunks/CodeBlock-90ffda97.js";import{I as Ht}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function ec(Q){let p,P,h,D,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r("code"),D=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var x=d(p);P=n(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(x,"CODE",{});var C=d(h);D=n(C,"Module"),C.forEach(o),F=n(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(w,x){T(w,p,x),e(p,P),e(p,h),e(h,D),e(p,F)},d(w){w&&o(p)}}}function oc(Q){let p,P,h,D,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r("code"),D=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var x=d(p);P=n(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(x,"CODE",{});var C=d(h);D=n(C,"Module"),C.forEach(o),F=n(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(w,x){T(w,p,x),e(p,P),e(p,h),e(h,D),e(p,F)},d(w){w&&o(p)}}}function tc(Q){let p,P,h,D,F;return{c(){p=r("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r("code"),D=t("Module"),F=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var x=d(p);P=n(x,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(x,"CODE",{});var C=d(h);D=n(C,"Module"),C.forEach(o),F=n(x,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),x.forEach(o)},m(w,x){T(w,p,x),e(p,P),e(p,h),e(h,D),e(p,F)},d(w){w&&o(p)}}}function nc(Q){let p,P,h,D,F,w,x,C,Dn,Zt,j,Mn,Eo,Vn,$n,tt,qn,zn,ko,Pn,Fn,xo,Cn,An,jo,In,Sn,nt,Ln,Nn,Do,On,Rn,Mo,Bn,Gn,Vo,Wn,Un,Yt,me,Hn,xe,Zn,Yn,Jt,G,Jn,$o,Kn,Qn,qo,Xn,er,Kt,X,he,rt,je,or,at,tr,Qt,z,De,nr,fe,zo,rr,ar,Po,sr,dr,ir,ee,cr,Fo,lr,pr,Co,mr,hr,fr,st,ur,gr,Me,_r,ue,Ve,vr,$e,br,Ao,Tr,wr,yr,ge,qe,Er,oe,kr,dt,xr,jr,it,Dr,Mr,Xt,te,_e,ct,ze,Vr,lt,$r,en,y,Pe,qr,ne,zr,pt,Pr,Fr,mt,Cr,Ar,Ir,Fe,Sr,Ce,Lr,Nr,Or,Ae,Rr,Ie,Br,Gr,Wr,ht,Ur,Hr,Se,Zr,Io,Yr,Jr,Kr,Le,Qr,Ne,Xr,ea,oa,W,So,ta,na,ft,ra,aa,ut,sa,da,ia,A,Oe,ca,re,la,Lo,pa,ma,gt,ha,fa,ua,ve,ga,_t,_a,va,Re,ba,I,Be,Ta,vt,wa,ya,ae,Ea,bt,ka,xa,Tt,ja,Da,Ma,wt,Va,$a,Ge,on,se,be,yt,We,qa,Et,za,tn,E,Ue,Pa,de,Fa,kt,Ca,Aa,xt,Ia,Sa,La,He,Na,Ze,Oa,Ra,Ba,Ye,Ga,Je,Wa,Ua,Ha,jt,Za,Ya,Ke,Ja,No,Ka,Qa,Xa,Qe,es,Xe,os,ts,ns,U,Oo,rs,as,Dt,ss,ds,Mt,is,cs,ls,S,eo,ps,ie,ms,Ro,hs,fs,Vt,us,gs,_s,Te,vs,$t,bs,Ts,oo,ws,O,to,ys,qt,Es,ks,zt,xs,js,no,nn,ce,we,Pt,ro,Ds,Ft,Ms,rn,k,ao,Vs,le,$s,Ct,qs,zs,At,Ps,Fs,Cs,so,As,io,Is,Ss,Ls,co,Ns,lo,Os,Rs,Bs,It,Gs,Ws,po,Us,Bo,Hs,Zs,Ys,mo,Js,ho,Ks,Qs,Xs,H,Go,ed,od,St,td,nd,Lt,rd,ad,sd,L,fo,dd,pe,id,Wo,cd,ld,Nt,pd,md,hd,ye,fd,Ot,ud,gd,uo,_d,R,go,vd,Rt,bd,Td,Bt,wd,yd,_o,an;return w=new Ht({}),je=new Ht({}),De=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
`}}),ve=new Ed({props:{$$slots:{default:[ec]},$$scope:{ctx:Q}}}),Re=new yo({props:{codee:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests
...
`}}),Te=new Ed({props:{$$slots:{default:[oc]},$$scope:{ctx:Q}}}),oo=new yo({props:{codee:`from transformers import AutoFeatureExtractor, AutoTokenizer, TFVisionEncoderDecoderModel
from PIL import Image
import requests
...
`}}),ye=new Ed({props:{$$slots:{default:[tc]},$$scope:{ctx:Q}}}),uo=new yo({props:{codee:`from transformers import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){p=r("meta"),P=c(),h=r("h1"),D=r("a"),F=r("span"),f(w.$$.fragment),x=c(),C=r("span"),Dn=t("Vision Encoder Decoder Models"),Zt=c(),j=r("p"),Mn=t("The "),Eo=r("a"),Vn=t("VisionEncoderDecoderModel"),$n=t(` can be used to initialize an image-to-text-sequence model with any
pretrained vision autoencoding model as the encoder (`),tt=r("em"),qn=t("e.g."),zn=c(),ko=r("a"),Pn=t("ViT"),Fn=t(", "),xo=r("a"),Cn=t("BEiT"),An=t(", "),jo=r("a"),In=t("DeiT"),Sn=t(`)
and any pretrained language model as the decoder (`),nt=r("em"),Ln=t("e.g."),Nn=c(),Do=r("a"),On=t("RoBERTa"),Rn=t(", "),Mo=r("a"),Bn=t("GPT2"),Gn=t(", "),Vo=r("a"),Wn=t("BERT"),Un=t(")."),Yt=c(),me=r("p"),Hn=t(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
example) `),xe=r("a"),Zn=t("TrOCR: Transformer-based Optical Character Recognition with Pre-trained Models"),Yn=t(` by Minghao Li, Tengchao Lv, Lei Cui, Yijuan Lu, Dinei Florencio, Cha Zhang,
Zhoujun Li, Furu Wei.`),Jt=c(),G=r("p"),Jn=t("An example of how to use a "),$o=r("a"),Kn=t("VisionEncoderDecoderModel"),Qn=t(" for inference can be seen in "),qo=r("a"),Xn=t("TrOCR"),er=t("."),Kt=c(),X=r("h2"),he=r("a"),rt=r("span"),f(je.$$.fragment),or=c(),at=r("span"),tr=t("VisionEncoderDecoderConfig"),Qt=c(),z=r("div"),f(De.$$.fragment),nr=c(),fe=r("p"),zo=r("a"),rr=t("VisionEncoderDecoderConfig"),ar=t(` is the configuration class to store the configuration of a
...
documentation from `),Co=r("a"),mr=t("PretrainedConfig"),hr=t(" for more information."),fr=c(),st=r("p"),ur=t("Examples:"),gr=c(),f(Me.$$.fragment),_r=c(),ue=r("div"),f(Ve.$$.fragment),vr=c(),$e=r("p"),br=t("Instantiate a "),Ao=r("a"),Tr=t("VisionEncoderDecoderConfig"),wr=t(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),yr=c(),ge=r("div"),f(qe.$$.fragment),Er=c(),oe=r("p"),kr=t("Serializes this instance to a Python dictionary. Override the default "),dt=r("em"),xr=t("to_dict()"),jr=t(" from "),it=r("em"),Dr=t("PretrainedConfig"),Mr=t("."),Xt=c(),te=r("h2"),_e=r("a"),ct=r("span"),f(ze.$$.fragment),Vr=c(),lt=r("span"),$r=t("VisionEncoderDecoderModel"),en=c(),y=r("div"),f(Pe.$$.fragment),qr=c(),ne=r("p"),zr=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),pt=r("code"),Pr=t("from_pretrained()"),Fr=t("function and the decoder is loaded via "),mt=r("code"),Cr=t("from_pretrained()"),Ar=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),Ir=c(),Fe=r("p"),Sr=t(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Or=c(),Ae=r("p"),Rr=t("Additionally, in "),Ie=r("a"),Br=t(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),Gr=t(` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),Wr=c(),ht=r("p"),Ur=t(`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),Hr=c(),Se=r("p"),Zr=t("This model inherits from "),Io=r("a"),Yr=t("PreTrainedModel"),Jr=t(`. Check the superclass documentation for the generic methods the
...
and behavior.`),oa=c(),W=r("p"),So=r("a"),ta=t("VisionEncoderDecoderModel"),na=t(` is a generic model class that will be instantiated as a transformer architecture with
...
:meth`),ut=r("em"),sa=t("~transformers.AutoModelForCausalLM.from_pretrained"),da=t(" class method for the decoder."),ia=c(),A=r("div"),f(Oe.$$.fragment),ca=c(),re=r("p"),la=t("The "),Lo=r("a"),pa=t("VisionEncoderDecoderModel"),ma=t(" forward method, overrides the "),gt=r("code"),ha=t("__call__"),fa=t(" special method."),ua=c(),f(ve.$$.fragment),ga=c(),_t=r("p"),_a=t("Examples:"),va=c(),f(Re.$$.fragment),ba=c(),I=r("div"),f(Be.$$.fragment),Ta=c(),vt=r("p"),wa=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ya=c(),ae=r("p"),Ea=t("The model is set in evaluation mode by default using "),bt=r("code"),ka=t("model.eval()"),xa=t(` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),Tt=r("code"),ja=t("model.train()"),Da=t("."),Ma=c(),wt=r("p"),Va=t("Example:"),$a=c(),f(Ge.$$.fragment),on=c(),se=r("h2"),be=r("a"),yt=r("span"),f(We.$$.fragment),qa=c(),Et=r("span"),za=t("TFVisionEncoderDecoderModel"),tn=c(),E=r("div"),f(Ue.$$.fragment),Pa=c(),de=r("p"),Fa=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),kt=r("code"),Ca=t("from_pretrained()"),Aa=t("function and the decoder is loaded via "),xt=r("code"),Ia=t("from_pretrained()"),Sa=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),Ba=c(),Ye=r("p"),Ga=t("Additionally, in "),Je=r("a"),Wa=t(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
other models (see the examples for more information).`),Ya=c(),Ke=r("p"),Ja=t("This model inherits from "),No=r("a"),Ka=t("TFPreTrainedModel"),Qa=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),Mt=r("code"),is=t("from_pretrained()"),cs=t("class method for the decoder."),ls=c(),S=r("div"),f(eo.$$.fragment),ps=c(),ie=r("p"),ms=t("The "),Ro=r("a"),hs=t("TFVisionEncoderDecoderModel"),fs=t(" forward method, overrides the "),Vt=r("code"),us=t("__call__"),gs=t(" special method."),_s=c(),f(Te.$$.fragment),vs=c(),$t=r("p"),bs=t("Examples:"),Ts=c(),f(oo.$$.fragment),ws=c(),O=r("div"),f(to.$$.fragment),ys=c(),qt=r("p"),Es=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ks=c(),zt=r("p"),xs=t("Example:"),js=c(),f(no.$$.fragment),nn=c(),ce=r("h2"),we=r("a"),Pt=r("span"),f(ro.$$.fragment),Ds=c(),Ft=r("span"),Ms=t("FlaxVisionEncoderDecoderModel"),rn=c(),k=r("div"),f(ao.$$.fragment),Vs=c(),le=r("p"),$s=t(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
tasks was shown in `),io=r("a"),Is=t(`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Ss=t(` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
...
character recognition (OCR) yields a significant performance improvement.`),Bs=c(),It=r("p"),Gs=t(`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ys=c(),mo=r("p"),Js=t(`This model is also a Flax Linen
`),ho=r("a"),Ks=t("flax.nn.Module"),Qs=t(` subclass. Use it as a
...
another one as decoder module when created with the :meth`),St=r("em"),td=t("~transformers.FlaxAutoModel.from_pretrained"),nd=t(` class method
for the encoder and :meth`),Lt=r("em"),rd=t("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),ad=t(" class method for the decoder."),sd=c(),L=r("div"),f(fo.$$.fragment),dd=c(),pe=r("p"),id=t("The "),Wo=r("a"),cd=t("FlaxVisionEncoderDecoderModel"),ld=t(" forward method, overrides the "),Nt=r("code"),pd=t("__call__"),md=t(" special method."),hd=c(),f(ye.$$.fragment),fd=c(),Ot=r("p"),ud=t("Examples:"),gd=c(),f(uo.$$.fragment),_d=c(),R=r("div"),f(go.$$.fragment),vd=c(),Rt=r("p"),bd=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Td=c(),Bt=r("p"),wd=t("Example:"),yd=c(),f(_o.$$.fragment),this.h()},l(s){const m=Xi('[data-svelte="svelte-1phssyn"]',document.head);p=a(m,"META",{name:!0,content:!0}),m.forEach(o),P=l(s),h=a(s,"H1",{class:!0});var vo=d(h);D=a(vo,"A",{id:!0,class:!0,href:!0});var Gt=d(D);F=a(Gt,"SPAN",{});var Wt=d(F);u(w.$$.fragment,Wt),Wt.forEach(o),Gt.forEach(o),x=l(vo),C=a(vo,"SPAN",{});var kd=d(C);Dn=n(kd,"Vision Encoder Decoder Models"),kd.forEach(o),vo.forEach(o),Zt=l(s),j=a(s,"P",{});var M=d(j);Mn=n(M,"The "),Eo=a(M,"A",{href:!0});var xd=d(Eo);Vn=n(xd,"VisionEncoderDecoderModel"),xd.forEach(o),$n=n(M,` can be used to initialize an image-to-text-sequence model with any
pretrained vision autoencoding model as the encoder (`),tt=a(M,"EM",{});var jd=d(tt);qn=n(jd,"e.g."),jd.forEach(o),zn=l(M),ko=a(M,"A",{href:!0});var Dd=d(ko);Pn=n(Dd,"ViT"),Dd.forEach(o),Fn=n(M,", "),xo=a(M,"A",{href:!0});var Md=d(xo);Cn=n(Md,"BEiT"),Md.forEach(o),An=n(M,", "),jo=a(M,"A",{href:!0});var Vd=d(jo);In=n(Vd,"DeiT"),Vd.forEach(o),Sn=n(M,`)
and any pretrained language model as the decoder (`),nt=a(M,"EM",{});var $d=d(nt);Ln=n($d,"e.g."),$d.forEach(o),Nn=l(M),Do=a(M,"A",{href:!0});var qd=d(Do);On=n(qd,"RoBERTa"),qd.forEach(o),Rn=n(M,", "),Mo=a(M,"A",{href:!0});var zd=d(Mo);Bn=n(zd,"GPT2"),zd.forEach(o),Gn=n(M,", "),Vo=a(M,"A",{href:!0});var Pd=d(Vo);Wn=n(Pd,"BERT"),Pd.forEach(o),Un=n(M,")."),M.forEach(o),Yt=l(s),me=a(s,"P",{});var sn=d(me);Hn=n(sn,`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
example) `),xe=a(sn,"A",{href:!0,rel:!0});var Fd=d(xe);Zn=n(Fd,"TrOCR: Transformer-based Optical Character Recognition with Pre-trained Models"),Fd.forEach(o),Yn=n(sn,` by Minghao Li, Tengchao Lv, Lei Cui, Yijuan Lu, Dinei Florencio, Cha Zhang,
Zhoujun Li, Furu Wei.`),sn.forEach(o),Jt=l(s),G=a(s,"P",{});var Uo=d(G);Jn=n(Uo,"An example of how to use a "),$o=a(Uo,"A",{href:!0});var Cd=d($o);Kn=n(Cd,"VisionEncoderDecoderModel"),Cd.forEach(o),Qn=n(Uo," for inference can be seen in "),qo=a(Uo,"A",{href:!0});var Ad=d(qo);Xn=n(Ad,"TrOCR"),Ad.forEach(o),er=n(Uo,"."),Uo.forEach(o),Kt=l(s),X=a(s,"H2",{class:!0});var dn=d(X);he=a(dn,"A",{id:!0,class:!0,href:!0});var Id=d(he);rt=a(Id,"SPAN",{});var Sd=d(rt);u(je.$$.fragment,Sd),Sd.forEach(o),Id.forEach(o),or=l(dn),at=a(dn,"SPAN",{});var Ld=d(at);tr=n(Ld,"VisionEncoderDecoderConfig"),Ld.forEach(o),dn.forEach(o),Qt=l(s),z=a(s,"DIV",{class:!0});var N=d(z);u(De.$$.fragment,N),nr=l(N),fe=a(N,"P",{});var Ut=d(fe);zo=a(Ut,"A",{href:!0});var Nd=d(zo);rr=n(Nd,"VisionEncoderDecoderConfig"),Nd.forEach(o),ar=n(Ut,` is the configuration class to store the configuration of a
...
documentation from `),Co=a(Ho,"A",{href:!0});var Bd=d(Co);mr=n(Bd,"PretrainedConfig"),Bd.forEach(o),hr=n(Ho," for more information."),Ho.forEach(o),fr=l(N),st=a(N,"P",{});var Gd=d(st);ur=n(Gd,"Examples:"),Gd.forEach(o),gr=l(N),u(Me.$$.fragment,N),_r=l(N),ue=a(N,"DIV",{class:!0});var cn=d(ue);u(Ve.$$.fragment,cn),vr=l(cn),$e=a(cn,"P",{});var ln=d($e);br=n(ln,"Instantiate a "),Ao=a(ln,"A",{href:!0});var Wd=d(Ao);Tr=n(Wd,"VisionEncoderDecoderConfig"),Wd.forEach(o),wr=n(ln,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),ln.forEach(o),cn.forEach(o),yr=l(N),ge=a(N,"DIV",{class:!0});var pn=d(ge);u(qe.$$.fragment,pn),Er=l(pn),oe=a(pn,"P",{});var Zo=d(oe);kr=n(Zo,"Serializes this instance to a Python dictionary. Override the default "),dt=a(Zo,"EM",{});var Ud=d(dt);xr=n(Ud,"to_dict()"),Ud.forEach(o),jr=n(Zo," from "),it=a(Zo,"EM",{});var Hd=d(it);Dr=n(Hd,"PretrainedConfig"),Hd.forEach(o),Mr=n(Zo,"."),Zo.forEach(o),pn.forEach(o),N.forEach(o),Xt=l(s),te=a(s,"H2",{class:!0});var mn=d(te);_e=a(mn,"A",{id:!0,class:!0,href:!0});var Zd=d(_e);ct=a(Zd,"SPAN",{});var Yd=d(ct);u(ze.$$.fragment,Yd),Yd.forEach(o),Zd.forEach(o),Vr=l(mn),lt=a(mn,"SPAN",{});var Jd=d(lt);$r=n(Jd,"VisionEncoderDecoderModel"),Jd.forEach(o),mn.forEach(o),en=l(s),y=a(s,"DIV",{class:!0});var V=d(y);u(Pe.$$.fragment,V),qr=l(V),ne=a(V,"P",{});var Yo=d(ne);zr=n(Yo,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),pt=a(Yo,"CODE",{});var Kd=d(pt);Pr=n(Kd,"from_pretrained()"),Kd.forEach(o),Fr=n(Yo,"function and the decoder is loaded via "),mt=a(Yo,"CODE",{});var Qd=d(mt);Cr=n(Qd,"from_pretrained()"),Qd.forEach(o),Ar=n(Yo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),Yo.forEach(o),Ir=l(V),Fe=a(V,"P",{});var hn=d(Fe);Sr=n(hn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Ce=a(hn,"A",{href:!0,rel:!0});var Xd=d(Ce);Lr=n(Xd,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Xd.forEach(o),Nr=n(hn,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),hn.forEach(o),Or=l(V),Ae=a(V,"P",{});var fn=d(Ae);Rr=n(fn,"Additionally, in "),Ie=a(fn,"A",{href:!0,rel:!0});var ei=d(Ie);Br=n(ei,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),ei.forEach(o),Gr=n(fn,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),fn.forEach(o),Wr=l(V),ht=a(V,"P",{});var oi=d(ht);Ur=n(oi,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),oi.forEach(o),Hr=l(V),Se=a(V,"P",{});var un=d(Se);Zr=n(un,"This model inherits from "),Io=a(un,"A",{href:!0});var ti=d(Io);Yr=n(ti,"PreTrainedModel"),ti.forEach(o),Jr=n(un,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gn.forEach(o),oa=l(V),W=a(V,"P",{});var bo=d(W);So=a(bo,"A",{href:!0});var ri=d(So);ta=n(ri,"VisionEncoderDecoderModel"),ri.forEach(o),na=n(bo,` is a generic model class that will be instantiated as a transformer architecture with
one of the base vision model classes of the library as encoder and another one as decoder when created with the
...
:meth`),ut=a(bo,"EM",{});var si=d(ut);sa=n(si,"~transformers.AutoModelForCausalLM.from_pretrained"),si.forEach(o),da=n(bo," class method for the decoder."),bo.forEach(o),ia=l(V),A=a(V,"DIV",{class:!0});var Z=d(A);u(Oe.$$.fragment,Z),ca=l(Z),re=a(Z,"P",{});var Jo=d(re);la=n(Jo,"The "),Lo=a(Jo,"A",{href:!0});var di=d(Lo);pa=n(di,"VisionEncoderDecoderModel"),di.forEach(o),ma=n(Jo," forward method, overrides the "),gt=a(Jo,"CODE",{});var ii=d(gt);ha=n(ii,"__call__"),ii.forEach(o),fa=n(Jo," special method."),Jo.forEach(o),ua=l(Z),u(ve.$$.fragment,Z),ga=l(Z),_t=a(Z,"P",{});var ci=d(_t);_a=n(ci,"Examples:"),ci.forEach(o),va=l(Z),u(Re.$$.fragment,Z),Z.forEach(o),ba=l(V),I=a(V,"DIV",{class:!0});var Y=d(I);u(Be.$$.fragment,Y),Ta=l(Y),vt=a(Y,"P",{});var li=d(vt);wa=n(li,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),li.forEach(o),ya=l(Y),ae=a(Y,"P",{});var Ko=d(ae);Ea=n(Ko,"The model is set in evaluation mode by default using "),bt=a(Ko,"CODE",{});var pi=d(bt);ka=n(pi,"model.eval()"),pi.forEach(o),xa=n(Ko,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),Tt=a(Ko,"CODE",{});var mi=d(Tt);ja=n(mi,"model.train()"),mi.forEach(o),Da=n(Ko,"."),Ko.forEach(o),Ma=l(Y),wt=a(Y,"P",{});var hi=d(wt);Va=n(hi,"Example:"),hi.forEach(o),$a=l(Y),u(Ge.$$.fragment,Y),Y.forEach(o),V.forEach(o),on=l(s),se=a(s,"H2",{class:!0});var _n=d(se);be=a(_n,"A",{id:!0,class:!0,href:!0});var fi=d(be);yt=a(fi,"SPAN",{});var ui=d(yt);u(We.$$.fragment,ui),ui.forEach(o),fi.forEach(o),qa=l(_n),Et=a(_n,"SPAN",{});var gi=d(Et);za=n(gi,"TFVisionEncoderDecoderModel"),gi.forEach(o),_n.forEach(o),tn=l(s),E=a(s,"DIV",{class:!0});var $=d(E);u(Ue.$$.fragment,$),Pa=l($),de=a($,"P",{});var Qo=d(de);Fa=n(Qo,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),kt=a(Qo,"CODE",{});var _i=d(kt);Ca=n(_i,"from_pretrained()"),_i.forEach(o),Aa=n(Qo,"function and the decoder is loaded via "),xt=a(Qo,"CODE",{});var vi=d(xt);Ia=n(vi,"from_pretrained()"),vi.forEach(o),Sa=n(Qo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),vn.forEach(o),Ba=l($),Ye=a($,"P",{});var bn=d(Ye);Ga=n(bn,"Additionally, in "),Je=a(bn,"A",{href:!0,rel:!0});var Ti=d(Je);Wa=n(Ti,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),Ti.forEach(o),Ua=n(bn,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),bn.forEach(o),Ha=l($),jt=a($,"P",{});var wi=d(jt);Za=n(wi,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),wi.forEach(o),Ya=l($),Ke=a($,"P",{});var Tn=d(Ke);Ja=n(Tn,"This model inherits from "),No=a(Tn,"A",{href:!0});var yi=d(No);Ka=n(yi,"TFPreTrainedModel"),yi.forEach(o),Qa=n(Tn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tn.forEach(o),Xa=l($),Qe=a($,"P",{});var wn=d(Qe);es=n(wn,"This model is also a "),Xe=a(wn,"A",{href:!0,rel:!0});var Ei=d(Xe);os=n(Ei,"tf.keras.Model"),Ei.forEach(o),ts=n(wn,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wn.forEach(o),ns=l($),U=a($,"P",{});var To=d(U);Oo=a(To,"A",{href:!0});var ki=d(Oo);rs=n(ki,"TFVisionEncoderDecoderModel"),ki.forEach(o),as=n(To,` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
...
`),Mt=a(To,"CODE",{});var ji=d(Mt);is=n(ji,"from_pretrained()"),ji.forEach(o),cs=n(To,"class method for the decoder."),To.forEach(o),ls=l($),S=a($,"DIV",{class:!0});var J=d(S);u(eo.$$.fragment,J),ps=l(J),ie=a(J,"P",{});var Xo=d(ie);ms=n(Xo,"The "),Ro=a(Xo,"A",{href:!0});var Di=d(Ro);hs=n(Di,"TFVisionEncoderDecoderModel"),Di.forEach(o),fs=n(Xo," forward method, overrides the "),Vt=a(Xo,"CODE",{});var Mi=d(Vt);us=n(Mi,"__call__"),Mi.forEach(o),gs=n(Xo," special method."),Xo.forEach(o),_s=l(J),u(Te.$$.fragment,J),vs=l(J),$t=a(J,"P",{});var Vi=d($t);bs=n(Vi,"Examples:"),Vi.forEach(o),Ts=l(J),u(oo.$$.fragment,J),J.forEach(o),ws=l($),O=a($,"DIV",{class:!0});var Ee=d(O);u(to.$$.fragment,Ee),ys=l(Ee),qt=a(Ee,"P",{});var $i=d(qt);Es=n($i,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),$i.forEach(o),ks=l(Ee),zt=a(Ee,"P",{});var qi=d(zt);xs=n(qi,"Example:"),qi.forEach(o),js=l(Ee),u(no.$$.fragment,Ee),Ee.forEach(o),$.forEach(o),nn=l(s),ce=a(s,"H2",{class:!0});var yn=d(ce);we=a(yn,"A",{id:!0,class:!0,href:!0});var zi=d(we);Pt=a(zi,"SPAN",{});var Pi=d(Pt);u(ro.$$.fragment,Pi),Pi.forEach(o),zi.forEach(o),Ds=l(yn),Ft=a(yn,"SPAN",{});var Fi=d(Ft);Ms=n(Fi,"FlaxVisionEncoderDecoderModel"),Fi.forEach(o),yn.forEach(o),rn=l(s),k=a(s,"DIV",{class:!0});var q=d(k);u(ao.$$.fragment,q),Vs=l(q),le=a(q,"P",{});var et=d(le);$s=n(et,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
tasks was shown in `),io=a(En,"A",{href:!0,rel:!0});var Ii=d(io);Is=n(Ii,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Ii.forEach(o),Ss=n(En,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),En.forEach(o),Ls=l(q),co=a(q,"P",{});var kn=d(co);Ns=n(kn,"Additionally, in "),lo=a(kn,"A",{href:!0,rel:!0});var Si=d(lo);Os=n(Si,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),Si.forEach(o),Rs=n(kn,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),kn.forEach(o),Bs=l(q),It=a(q,"P",{});var Li=d(It);Gs=n(Li,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xn.forEach(o),Ys=l(q),mo=a(q,"P",{});var jn=d(mo);Js=n(jn,`This model is also a Flax Linen
`),ho=a(jn,"A",{href:!0,rel:!0});var Oi=d(ho);Ks=n(Oi,"flax.nn.Module"),Oi.forEach(o),Qs=n(jn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jn.forEach(o),Xs=l(q),H=a(q,"P",{});var wo=d(H);Go=a(wo,"A",{href:!0});var Ri=d(Go);ed=n(Ri,"FlaxVisionEncoderDecoderModel"),Ri.forEach(o),od=n(wo,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base vision model classes of the library as encoder module and
another one as decoder module when created with the :meth`),St=a(wo,"EM",{});var Bi=d(St);td=n(Bi,"~transformers.FlaxAutoModel.from_pretrained"),Bi.forEach(o),nd=n(wo,` class method
for the encoder and :meth`),Lt=a(wo,"EM",{});var Gi=d(Lt);rd=n(Gi,"~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Gi.forEach(o),ad=n(wo," class method for the decoder."),wo.forEach(o),sd=l(q),L=a(q,"DIV",{class:!0});var K=d(L);u(fo.$$.fragment,K),dd=l(K),pe=a(K,"P",{});var ot=d(pe);id=n(ot,"The "),Wo=a(ot,"A",{href:!0});var Wi=d(Wo);cd=n(Wi,"FlaxVisionEncoderDecoderModel"),Wi.forEach(o),ld=n(ot," forward method, overrides the "),Nt=a(ot,"CODE",{});var Ui=d(Nt);pd=n(Ui,"__call__"),Ui.forEach(o),md=n(ot," special method."),ot.forEach(o),hd=l(K),u(ye.$$.fragment,K),fd=l(K),Ot=a(K,"P",{});var Hi=d(Ot);ud=n(Hi,"Examples:"),Hi.forEach(o),gd=l(K),u(uo.$$.fragment,K),K.forEach(o),_d=l(q),R=a(q,"DIV",{class:!0});var ke=d(R);u(go.$$.fragment,ke),vd=l(ke),Rt=a(ke,"P",{});var Zi=d(Rt);bd=n(Zi,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Zi.forEach(o),Td=l(ke),Bt=a(ke,"P",{});var Yi=d(Bt);wd=n(Yi,"Example:"),Yi.forEach(o),yd=l(ke),u(_o.$$.fragment,ke),ke.forEach(o),q.forEach(o),this.h()},h(){i(p,"name","hf:doc:metadata"),i(p,"content",JSON.stringify(rc)),i(D,"id","vision-encoder-decoder-models"),i(D,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(D,"href","#vision-encoder-decoder-models"),i(h,"class","relative group"),i(Eo,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(ko,"href","vit"),i(xo,"href","beit"),i(jo,"href","deit"),i(Do,"href","roberta"),i(Mo,"href","gpt2"),i(Vo,"href","bert"),i(xe,"href","https://arxiv.org/abs/2109.10282"),i(xe,"rel","nofollow"),i($o,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(qo,"href","trocr"),i(he,"id","transformers.VisionEncoderDecoderConfig"),i(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(he,"href","#transformers.VisionEncoderDecoderConfig"),i(X,"class","relative group"),i(zo,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"),i(Po,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(Fo,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),i(Co,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),i(Ao,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"),i(ue,"class","docstring"),i(ge,"class","docstring"),i(z,"class","docstring"),i(_e,"id","transformers.VisionEncoderDecoderModel"),i(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(_e,"href","#transformers.VisionEncoderDecoderModel"),i(te,"class","relative group"),i(Ce,"href","https://arxiv.org/abs/1907.12461"),i(Ce,"rel","nofollow"),i(Ie,"href","https://arxiv.org/abs/2109.10282"),i(Ie,"rel","nofollow"),i(Io,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),i(Ne,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),i(Ne,"rel","nofollow"),i(So,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(Lo,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),i(A,"class","docstring"),i(I,"class","docstring"),i(y,"class","docstring"),i(be,"id","transformers.TFVisionEncoderDecoderModel"),i(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(be,"href","#transformers.TFVisionEncoderDecoderModel"),i(se,"class","relative group"),i(Ze,"href","https://arxiv.org/abs/1907.12461"),i(Ze,"rel","nofollow"),i(Je,"href","https://arxiv.org/abs/2109.10282"),i(Je,"rel","nofollow"),i(No,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),i(Xe,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),i(Xe,"rel","nofollow"),i(Oo,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.TFVisionEncoderDecoderModel"),i(Ro,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.TFVisionEncoderDecoderModel"),i(S,"class","docstring"),i(O,"class","docstring"),i(E,"class","docstring"),i(we,"id","transformers.FlaxVisionEncoderDecoderModel"),i(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(we,"href","#transformers.FlaxVisionEncoderDecoderModel"),i(ce,"class","relative group"),i(io,"href","https://arxiv.org/abs/1907.12461"),i(io,"rel","nofollow"),i(lo,"href","https://arxiv.org/abs/2109.10282"),i(lo,"rel","nofollow"),i(Bo,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel"),i(ho,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),i(ho,"rel","nofollow"),i(Go,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.FlaxVisionEncoderDecoderModel"),i(Wo,"href","/docs/transformers/master/en/model_doc/vision-encoder-decoder#transformers.FlaxVisionEncoderDecoderModel"),i(L,"class","docstring"),i(R,"class","docstring"),i(k,"class","docstring")},m(s,m){e(document.head,p),T(s,P,m),T(s,h,m),e(h,D),e(D,F),g(w,F,null),e(h,x),e(h,C),e(C,Dn),T(s,Zt,m),T(s,j,m),e(j,Mn),e(j,Eo),e(Eo,Vn),e(j,$n),e(j,tt),e(tt,qn),e(j,zn),e(j,ko),e(ko,Pn),e(j,Fn),e(j,xo),e(xo,Cn),e(j,An),e(j,jo),e(jo,In),e(j,Sn),e(j,nt),e(nt,Ln),e(j,Nn),e(j,Do),e(Do,On),e(j,Rn),e(j,Mo),e(Mo,Bn),e(j,Gn),e(j,Vo),e(Vo,Wn),e(j,Un),T(s,Yt,m),T(s,me,m),e(me,Hn),e(me,xe),e(xe,Zn),e(me,Yn),T(s,Jt,m),T(s,G,m),e(G,Jn),e(G,$o),e($o,Kn),e(G,Qn),e(G,qo),e(qo,Xn),e(G,er),T(s,Kt,m),T(s,X,m),e(X,he),e(he,rt),g(je,rt,null),e(X,or),e(X,at),e(at,tr),T(s,Qt,m),T(s,z,m),g(De,z,null),e(z,nr),e(z,fe),e(fe,zo),e(zo,rr),e(fe,ar),e(fe,Po),e(Po,sr),e(fe,dr),e(z,ir),e(z,ee),e(ee,cr),e(ee,Fo),e(Fo,lr),e(ee,pr),e(ee,Co),e(Co,mr),e(ee,hr),e(z,fr),e(z,st),e(st,ur),e(z,gr),g(Me,z,null),e(z,_r),e(z,ue),g(Ve,ue,null),e(ue,vr),e(ue,$e),e($e,br),e($e,Ao),e(Ao,Tr),e($e,wr),e(z,yr),e(z,ge),g(qe,ge,null),e(ge,Er),e(ge,oe),e(oe,kr),e(oe,dt),e(dt,xr),e(oe,jr),e(oe,it),e(it,Dr),e(oe,Mr),T(s,Xt,m),T(s,te,m),e(te,_e),e(_e,ct),g(ze,ct,null),e(te,Vr),e(te,lt),e(lt,$r),T(s,en,m),T(s,y,m),g(Pe,y,null),e(y,qr),e(y,ne),e(ne,zr),e(ne,pt),e(pt,Pr),e(ne,Fr),e(ne,mt),e(mt,Cr),e(ne,Ar),e(y,Ir),e(y,Fe),e(Fe,Sr),e(Fe,Ce),e(Ce,Lr),e(Fe,Nr),e(y,Or),e(y,Ae),e(Ae,Rr),e(Ae,Ie),e(Ie,Br),e(Ae,Gr),e(y,Wr),e(y,ht),e(ht,Ur),e(y,Hr),e(y,Se),e(Se,Zr),e(Se,Io),e(Io,Yr),e(Se,Jr),e(y,Kr),e(y,Le),e(Le,Qr),e(Le,Ne),e(Ne,Xr),e(Le,ea),e(y,oa),e(y,W),e(W,So),e(So,ta),e(W,na),e(W,ft),e(ft,ra),e(W,aa),e(W,ut),e(ut,sa),e(W,da),e(y,ia),e(y,A),g(Oe,A,null),e(A,ca),e(A,re),e(re,la),e(re,Lo),e(Lo,pa),e(re,ma),e(re,gt),e(gt,ha),e(re,fa),e(A,ua),g(ve,A,null),e(A,ga),e(A,_t),e(_t,_a),e(A,va),g(Re,A,null),e(y,ba),e(y,I),g(Be,I,null),e(I,Ta),e(I,vt),e(vt,wa),e(I,ya),e(I,ae),e(ae,Ea),e(ae,bt),e(bt,ka),e(ae,xa),e(ae,Tt),e(Tt,ja),e(ae,Da),e(I,Ma),e(I,wt),e(wt,Va),e(I,$a),g(Ge,I,null),T(s,on,m),T(s,se,m),e(se,be),e(be,yt),g(We,yt,null),e(se,qa),e(se,Et),e(Et,za),T(s,tn,m),T(s,E,m),g(Ue,E,null),e(E,Pa),e(E,de),e(de,Fa),e(de,kt),e(kt,Ca),e(de,Aa),e(de,xt),e(xt,Ia),e(de,Sa),e(E,La),e(E,He),e(He,Na),e(He,Ze),e(Ze,Oa),e(He,Ra),e(E,Ba),e(E,Ye),e(Ye,Ga),e(Ye,Je),e(Je,Wa),e(Ye,Ua),e(E,Ha),e(E,jt),e(jt,Za),e(E,Ya),e(E,Ke),e(Ke,Ja),e(Ke,No),e(No,Ka),e(Ke,Qa),e(E,Xa),e(E,Qe),e(Qe,es),e(Qe,Xe),e(Xe,os),e(Qe,ts),e(E,ns),e(E,U),e(U,Oo),e(Oo,rs),e(U,as),e(U,Dt),e(Dt,ss),e(U,ds),e(U,Mt),e(Mt,is),e(U,cs),e(E,ls),e(E,S),g(eo,S,null),e(S,ps),e(S,ie),e(ie,ms),e(ie,Ro),e(Ro,hs),e(ie,fs),e(ie,Vt),e(Vt,us),e(ie,gs),e(S,_s),g(Te,S,null),e(S,vs),e(S,$t),e($t,bs),e(S,Ts),g(oo,S,null),e(E,ws),e(E,O),g(to,O,null),e(O,ys),e(O,qt),e(qt,Es),e(O,ks),e(O,zt),e(zt,xs),e(O,js),g(no,O,null),T(s,nn,m),T(s,ce,m),e(ce,we),e(we,Pt),g(ro,Pt,null),e(ce,Ds),e(ce,Ft),e(Ft,Ms),T(s,rn,m),T(s,k,m),g(ao,k,null),e(k,Vs),e(k,le),e(le,$s),e(le,Ct),e(Ct,qs),e(le,zs),e(le,At),e(At,Ps),e(le,Fs),e(k,Cs),e(k,so),e(so,As),e(so,io),e(io,Is),e(so,Ss),e(k,Ls),e(k,co),e(co,Ns),e(co,lo),e(lo,Os),e(co,Rs),e(k,Bs),e(k,It),e(It,Gs),e(k,Ws),e(k,po),e(po,Us),e(po,Bo),e(Bo,Hs),e(po,Zs),e(k,Ys),e(k,mo),e(mo,Js),e(mo,ho),e(ho,Ks),e(mo,Qs),e(k,Xs),e(k,H),e(H,Go),e(Go,ed),e(H,od),e(H,St),e(St,td),e(H,nd),e(H,Lt),e(Lt,rd),e(H,ad),e(k,sd),e(k,L),g(fo,L,null),e(L,dd),e(L,pe),e(pe,id),e(pe,Wo),e(Wo,cd),e(pe,ld),e(pe,Nt),e(Nt,pd),e(pe,md),e(L,hd),g(ye,L,null),e(L,fd),e(L,Ot),e(Ot,ud),e(L,gd),g(uo,L,null),e(k,_d),e(k,R),g(go,R,null),e(R,vd),e(R,Rt),e(Rt,bd),e(R,Td),e(R,Bt),e(Bt,wd),e(R,yd),g(_o,R,null),an=!0},p(s,[m]){const vo={};m&2&&(vo.$$scope={dirty:m,ctx:s}),ve.$set(vo);const Gt={};m&2&&(Gt.$$scope={dirty:m,ctx:s}),Te.$set(Gt);const Wt={};m&2&&(Wt.$$scope={dirty:m,ctx:s}),ye.$set(Wt)},i(s){an||(_(w.$$.fragment,s),_(je.$$.fragment,s),_(De.$$.fragment,s),_(Me.$$.fragment,s),_(Ve.$$.fragment,s),_(qe.$$.fragment,s),_(ze.$$.fragment,s),_(Pe.$$.fragment,s),_(Oe.$$.fragment,s),_(ve.$$.fragment,s),_(Re.$$.fragment,s),_(Be.$$.fragment,s),_(Ge.$$.fragment,s),_(We.$$.fragment,s),_(Ue.$$.fragment,s),_(eo.$$.fragment,s),_(Te.$$.fragment,s),_(oo.$$.fragment,s),_(to.$$.fragment,s),_(no.$$.fragment,s),_(ro.$$.fragment,s),_(ao.$$.fragment,s),_(fo.$$.fragment,s),_(ye.$$.fragment,s),_(uo.$$.fragment,s),_(go.$$.fragment,s),_(_o.$$.fragment,s),an=!0)},o(s){v(w.$$.fragment,s),v(je.$$.fragment,s),v(De.$$.fragment,s),v(Me.$$.fragment,s),v(Ve.$$.fragment,s),v(qe.$$.fragment,s),v(ze.$$.fragment,s),v(Pe.$$.fragment,s),v(Oe.$$.fragment,s),v(ve.$$.fragment,s),v(Re.$$.fragment,s),v(Be.$$.fragment,s),v(Ge.$$.fragment,s),v(We.$$.fragment,s),v(Ue.$$.fragment,s),v(eo.$$.fragment,s),v(Te.$$.fragment,s),v(oo.$$.fragment,s),v(to.$$.fragment,s),v(no.$$.fragment,s),v(ro.$$.fragment,s),v(ao.$$.fragment,s),v(fo.$$.fragment,s),v(ye.$$.fragment,s),v(uo.$$.fragment,s),v(go.$$.fragment,s),v(_o.$$.fragment,s),an=!1},d(s){o(p),s&&o(P),s&&o(h),b(w),s&&o(Zt),s&&o(j),s&&o(Yt),s&&o(me),s&&o(Jt),s&&o(G),s&&o(Kt),s&&o(X),b(je),s&&o(Qt),s&&o(z),b(De),b(Me),b(Ve),b(qe),s&&o(Xt),s&&o(te),b(ze),s&&o(en),s&&o(y),b(Pe),b(Oe),b(ve),b(Re),b(Be),b(Ge),s&&o(on),s&&o(se),b(We),s&&o(tn),s&&o(E),b(Ue),b(eo),b(Te),b(oo),b(to),b(no),s&&o(nn),s&&o(ce),b(ro),s&&o(rn),s&&o(k),b(ao),b(fo),b(ye),b(uo),b(go),b(_o)}}}const rc={local:"vision-encoder-decoder-models",sections:[{local:"transformers.VisionEncoderDecoderConfig",title:"VisionEncoderDecoderConfig"},{local:"transformers.VisionEncoderDecoderModel",title:"VisionEncoderDecoderModel"},{local:"transformers.TFVisionEncoderDecoderModel",title:"TFVisionEncoderDecoderModel"},{local:"transformers.FlaxVisionEncoderDecoderModel",title:"FlaxVisionEncoderDecoderModel"}],title:"Vision Encoder Decoder Models"};function ac(Q,p,P){let{fw:h}=p;return Q.$$set=D=>{"fw"in D&&P(0,h=D.fw)},[h]}class mc extends Ji{constructor(p){super();Ki(this,p,ac,nc,Qi,{fw:0})}}export{mc as default,rc as metadata};
