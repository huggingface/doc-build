import{S as Ca,i as Ia,s as Aa,e as s,k as c,w,t as r,M as Pa,c as a,d as o,m as h,a as n,x as v,h as i,b as l,N as qa,F as e,g as m,y as b,q as S,o as $,B as y}from"../../chunks/vendor-6b77c823.js";import{T as Ls}from"../../chunks/Tip-39098574.js";import{D as ze}from"../../chunks/Docstring-abef54e3.js";import{C as eo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as at}from"../../chunks/IconCopyLink-7a11ce68.js";function za(O){let p,T,f,_,k;return{c(){p=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=n(p);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var M=n(f);_=i(M,"Module"),M.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,T),e(p,f),e(f,_),e(p,k)},d(u){u&&o(p)}}}function Na(O){let p,T,f,_,k;return{c(){p=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=n(p);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var M=n(f);_=i(M,"Module"),M.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,T),e(p,f),e(f,_),e(p,k)},d(u){u&&o(p)}}}function Oa(O){let p,T,f,_,k;return{c(){p=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=n(p);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var M=n(f);_=i(M,"Module"),M.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,T),e(p,f),e(f,_),e(p,k)},d(u){u&&o(p)}}}function La(O){let p,T,f,_,k,u,g,M,to,xt,L,J,nt,de,oo,rt,so,Et,D,ao,ce,no,ro,io,jt,Ne,lo,Ft,Oe,it,co,Ct,Le,ho,It,De,he,mo,We,po,fo,At,Q,Ds,Pt,X,uo,He,go,_o,qt,P,wo,me,vo,bo,pe,So,$o,zt,W,ee,lt,fe,yo,dt,To,Nt,F,ue,ko,H,Mo,Be,xo,Eo,ge,jo,Fo,Co,B,Io,Ue,Ao,Po,Ve,qo,zo,No,_e,Ot,U,te,ct,we,Oo,ht,Lo,Lt,I,ve,Do,be,Wo,Se,Ho,Bo,Uo,x,$e,Vo,V,Ko,Ke,Yo,Zo,mt,Ro,Go,Jo,oe,Qo,pt,Xo,es,ye,Dt,K,se,ft,Te,ts,ut,os,Wt,A,ke,ss,Y,as,gt,ns,rs,Me,is,ls,ds,E,xe,cs,Z,hs,Ye,ms,ps,_t,fs,us,gs,ae,_s,wt,ws,vs,Ee,Ht,R,ne,vt,je,bs,bt,Ss,Bt,C,Fe,$s,St,ys,Ts,Ce,ks,Ie,Ms,xs,Es,j,Ae,js,G,Fs,Ze,Cs,Is,$t,As,Ps,qs,re,zs,yt,Ns,Os,Pe,Ut;return u=new at({}),de=new at({}),fe=new at({}),ue=new ze({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/swin/configuration_swin.py#L29",parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
`}}),oe=new Ls({props:{$$slots:{default:[za]},$$scope:{ctx:O}}}),ye=new eo({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
`}}),ae=new Ls({props:{$$slots:{default:[Na]},$$scope:{ctx:O}}}),Ee=new eo({props:{code:`from transformers import AutoFeatureExtractor, SwinForMaskedImageModeling
import torch
...
`}}),re=new Ls({props:{$$slots:{default:[Oa]},$$scope:{ctx:O}}}),Pe=new eo({props:{code:`from transformers import AutoFeatureExtractor, SwinForImageClassification
import torch
from datasets import load_dataset
...
tabby, tabby cat`}}),{c(){p=s("meta"),T=c(),f=s("h1"),_=s("a"),k=s("span"),w(u.$$.fragment),g=c(),M=s("span"),to=r("Swin Transformer"),xt=c(),L=s("h2"),J=s("a"),nt=s("span"),w(de.$$.fragment),oo=c(),rt=s("span"),so=r("Overview"),Et=c(),D=s("p"),ao=r("The Swin Transformer was proposed in "),ce=s("a"),no=r("Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),ro=s("br"),io=r(`
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),jt=c(),Ne=s("p"),lo=r("The abstract from the paper is the following:"),Ft=c(),Oe=s("p"),it=s("em"),co=r(`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),Ct=c(),Le=s("p"),ho=r("Tips:"),It=c(),De=s("ul"),he=s("li"),mo=r("One can use the "),We=s("a"),po=r("AutoFeatureExtractor"),fo=r(" API to prepare images for the model."),At=c(),Q=s("img"),Pt=c(),X=s("small"),uo=r("Swin Transformer architecture. Taken from the "),He=s("a"),go=r("original paper"),_o=r("."),qt=c(),P=s("p"),wo=r("This model was contributed by "),me=s("a"),vo=r("novice03"),bo=r(". The original code can be found "),pe=s("a"),So=r("here"),$o=r("."),zt=c(),W=s("h2"),ee=s("a"),lt=s("span"),w(fe.$$.fragment),yo=c(),dt=s("span"),To=r("SwinConfig"),Nt=c(),F=s("div"),w(ue.$$.fragment),ko=c(),H=s("p"),Mo=r("This is the configuration class to store the configuration of a "),Be=s("a"),xo=r("SwinModel"),Eo=r(`. It is used to instantiate a Swin
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the Swin
`),ge=s("a"),jo=r("microsoft/swin-tiny-patch4-window7-224"),Fo=r(`
architecture.`),Co=c(),B=s("p"),Io=r("Configuration objects inherit from "),Ue=s("a"),Ao=r("PretrainedConfig"),Po=r(` and can be used to control the model outputs. Read the
documentation from `),Ve=s("a"),qo=r("PretrainedConfig"),zo=r(" for more information."),No=c(),w(_e.$$.fragment),Ot=c(),U=s("h2"),te=s("a"),ct=s("span"),w(we.$$.fragment),Oo=c(),ht=s("span"),Lo=r("SwinModel"),Lt=c(),I=s("div"),w(ve.$$.fragment),Do=c(),be=s("p"),Wo=r(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Se=s("a"),Ho=r("torch.nn.Module"),Bo=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Uo=c(),x=s("div"),w($e.$$.fragment),Vo=c(),V=s("p"),Ko=r("The "),Ke=s("a"),Yo=r("SwinModel"),Zo=r(" forward method, overrides the "),mt=s("code"),Ro=r("__call__"),Go=r(" special method."),Jo=c(),w(oe.$$.fragment),Qo=c(),pt=s("p"),Xo=r("Example:"),es=c(),w(ye.$$.fragment),Dt=c(),K=s("h2"),se=s("a"),ft=s("span"),w(Te.$$.fragment),ts=c(),ut=s("span"),os=r("SwinForMaskedImageModeling"),Wt=c(),A=s("div"),w(ke.$$.fragment),ss=c(),Y=s("p"),as=r("Swin Model with a decoder on top for masked image modeling, as proposed in "),gt=s("code"),ns=r("SimMIM <https://arxiv.org/abs/2111.09886>"),rs=r(`__.
This model is a PyTorch `),Me=s("a"),is=r("torch.nn.Module"),ls=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ds=c(),E=s("div"),w(xe.$$.fragment),cs=c(),Z=s("p"),hs=r("The "),Ye=s("a"),ms=r("SwinForMaskedImageModeling"),ps=r(" forward method, overrides the "),_t=s("code"),fs=r("__call__"),us=r(" special method."),gs=c(),w(ae.$$.fragment),_s=c(),wt=s("p"),ws=r("Examples:"),vs=c(),w(Ee.$$.fragment),Ht=c(),R=s("h2"),ne=s("a"),vt=s("span"),w(je.$$.fragment),bs=c(),bt=s("span"),Ss=r("SwinForImageClassification"),Bt=c(),C=s("div"),w(Fe.$$.fragment),$s=c(),St=s("p"),ys=r(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Ts=c(),Ce=s("p"),ks=r("This model is a PyTorch "),Ie=s("a"),Ms=r("torch.nn.Module"),xs=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Es=c(),j=s("div"),w(Ae.$$.fragment),js=c(),G=s("p"),Fs=r("The "),Ze=s("a"),Cs=r("SwinForImageClassification"),Is=r(" forward method, overrides the "),$t=s("code"),As=r("__call__"),Ps=r(" special method."),qs=c(),w(re.$$.fragment),zs=c(),yt=s("p"),Ns=r("Example:"),Os=c(),w(Pe.$$.fragment),this.h()},l(t){const d=Pa('[data-svelte="svelte-1phssyn"]',document.head);p=a(d,"META",{name:!0,content:!0}),d.forEach(o),T=h(t),f=a(t,"H1",{class:!0});var qe=n(f);_=a(qe,"A",{id:!0,class:!0,href:!0});var Tt=n(_);k=a(Tt,"SPAN",{});var kt=n(k);v(u.$$.fragment,kt),kt.forEach(o),Tt.forEach(o),g=h(qe),M=a(qe,"SPAN",{});var Ws=n(M);to=i(Ws,"Swin Transformer"),Ws.forEach(o),qe.forEach(o),xt=h(t),L=a(t,"H2",{class:!0});var Vt=n(L);J=a(Vt,"A",{id:!0,class:!0,href:!0});var Hs=n(J);nt=a(Hs,"SPAN",{});var Bs=n(nt);v(de.$$.fragment,Bs),Bs.forEach(o),Hs.forEach(o),oo=h(Vt),rt=a(Vt,"SPAN",{});var Us=n(rt);so=i(Us,"Overview"),Us.forEach(o),Vt.forEach(o),Et=h(t),D=a(t,"P",{});var Mt=n(D);ao=i(Mt,"The Swin Transformer was proposed in "),ce=a(Mt,"A",{href:!0,rel:!0});var Vs=n(ce);no=i(Vs,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),Vs.forEach(o),ro=a(Mt,"BR",{}),io=i(Mt,`
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),Mt.forEach(o),jt=h(t),Ne=a(t,"P",{});var Ks=n(Ne);lo=i(Ks,"The abstract from the paper is the following:"),Ks.forEach(o),Ft=h(t),Oe=a(t,"P",{});var Ys=n(Oe);it=a(Ys,"EM",{});var Zs=n(it);co=i(Zs,`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
for computer vision. Challenges in adapting Transformer from language to vision arise from differences between the two domains,
such as large variations in the scale of visual entities and the high resolution of pixels in images compared to words in text.
To address these differences, we propose a hierarchical Transformer whose representation is computed with \\bold{S}hifted
\\bold{win}dows. The shifted windowing scheme brings greater efficiency by limiting self-attention computation to non-overlapping
...
(53.5 mIoU on ADE20K val). Its performance surpasses the previous state-of-the-art by a large margin of +2.7 box AP and
+2.6 mask AP on COCO, and +3.2 mIoU on ADE20K, demonstrating the potential of Transformer-based models as vision backbones.
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),Zs.forEach(o),Ys.forEach(o),Ct=h(t),Le=a(t,"P",{});var Rs=n(Le);ho=i(Rs,"Tips:"),Rs.forEach(o),It=h(t),De=a(t,"UL",{});var Gs=n(De);he=a(Gs,"LI",{});var Kt=n(he);mo=i(Kt,"One can use the "),We=a(Kt,"A",{href:!0});var Js=n(We);po=i(Js,"AutoFeatureExtractor"),Js.forEach(o),fo=i(Kt," API to prepare images for the model."),Kt.forEach(o),Gs.forEach(o),At=h(t),Q=a(t,"IMG",{src:!0,alt:!0,width:!0}),Pt=h(t),X=a(t,"SMALL",{});var Yt=n(X);uo=i(Yt,"Swin Transformer architecture. Taken from the "),He=a(Yt,"A",{href:!0});var Qs=n(He);go=i(Qs,"original paper"),Qs.forEach(o),_o=i(Yt,"."),Yt.forEach(o),qt=h(t),P=a(t,"P",{});var Re=n(P);wo=i(Re,"This model was contributed by "),me=a(Re,"A",{href:!0,rel:!0});var Xs=n(me);vo=i(Xs,"novice03"),Xs.forEach(o),bo=i(Re,". The original code can be found "),pe=a(Re,"A",{href:!0,rel:!0});var ea=n(pe);So=i(ea,"here"),ea.forEach(o),$o=i(Re,"."),Re.forEach(o),zt=h(t),W=a(t,"H2",{class:!0});var Zt=n(W);ee=a(Zt,"A",{id:!0,class:!0,href:!0});var ta=n(ee);lt=a(ta,"SPAN",{});var oa=n(lt);v(fe.$$.fragment,oa),oa.forEach(o),ta.forEach(o),yo=h(Zt),dt=a(Zt,"SPAN",{});var sa=n(dt);To=i(sa,"SwinConfig"),sa.forEach(o),Zt.forEach(o),Nt=h(t),F=a(t,"DIV",{class:!0});var ie=n(F);v(ue.$$.fragment,ie),ko=h(ie),H=a(ie,"P",{});var Ge=n(H);Mo=i(Ge,"This is the configuration class to store the configuration of a "),Be=a(Ge,"A",{href:!0});var aa=n(Be);xo=i(aa,"SwinModel"),aa.forEach(o),Eo=i(Ge,`. It is used to instantiate a Swin
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the Swin
`),ge=a(Ge,"A",{href:!0,rel:!0});var na=n(ge);jo=i(na,"microsoft/swin-tiny-patch4-window7-224"),na.forEach(o),Fo=i(Ge,`
architecture.`),Ge.forEach(o),Co=h(ie),B=a(ie,"P",{});var Je=n(B);Io=i(Je,"Configuration objects inherit from "),Ue=a(Je,"A",{href:!0});var ra=n(Ue);Ao=i(ra,"PretrainedConfig"),ra.forEach(o),Po=i(Je,` and can be used to control the model outputs. Read the
documentation from `),Ve=a(Je,"A",{href:!0});var ia=n(Ve);qo=i(ia,"PretrainedConfig"),ia.forEach(o),zo=i(Je," for more information."),Je.forEach(o),No=h(ie),v(_e.$$.fragment,ie),ie.forEach(o),Ot=h(t),U=a(t,"H2",{class:!0});var Rt=n(U);te=a(Rt,"A",{id:!0,class:!0,href:!0});var la=n(te);ct=a(la,"SPAN",{});var da=n(ct);v(we.$$.fragment,da),da.forEach(o),la.forEach(o),Oo=h(Rt),ht=a(Rt,"SPAN",{});var ca=n(ht);Lo=i(ca,"SwinModel"),ca.forEach(o),Rt.forEach(o),Lt=h(t),I=a(t,"DIV",{class:!0});var Qe=n(I);v(ve.$$.fragment,Qe),Do=h(Qe),be=a(Qe,"P",{});var Gt=n(be);Wo=i(Gt,`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Se=a(Gt,"A",{href:!0,rel:!0});var ha=n(Se);Ho=i(ha,"torch.nn.Module"),ha.forEach(o),Bo=i(Gt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Gt.forEach(o),Uo=h(Qe),x=a(Qe,"DIV",{class:!0});var q=n(x);v($e.$$.fragment,q),Vo=h(q),V=a(q,"P",{});var Xe=n(V);Ko=i(Xe,"The "),Ke=a(Xe,"A",{href:!0});var ma=n(Ke);Yo=i(ma,"SwinModel"),ma.forEach(o),Zo=i(Xe," forward method, overrides the "),mt=a(Xe,"CODE",{});var pa=n(mt);Ro=i(pa,"__call__"),pa.forEach(o),Go=i(Xe," special method."),Xe.forEach(o),Jo=h(q),v(oe.$$.fragment,q),Qo=h(q),pt=a(q,"P",{});var fa=n(pt);Xo=i(fa,"Example:"),fa.forEach(o),es=h(q),v(ye.$$.fragment,q),q.forEach(o),Qe.forEach(o),Dt=h(t),K=a(t,"H2",{class:!0});var Jt=n(K);se=a(Jt,"A",{id:!0,class:!0,href:!0});var ua=n(se);ft=a(ua,"SPAN",{});var ga=n(ft);v(Te.$$.fragment,ga),ga.forEach(o),ua.forEach(o),ts=h(Jt),ut=a(Jt,"SPAN",{});var _a=n(ut);os=i(_a,"SwinForMaskedImageModeling"),_a.forEach(o),Jt.forEach(o),Wt=h(t),A=a(t,"DIV",{class:!0});var et=n(A);v(ke.$$.fragment,et),ss=h(et),Y=a(et,"P",{});var tt=n(Y);as=i(tt,"Swin Model with a decoder on top for masked image modeling, as proposed in "),gt=a(tt,"CODE",{});var wa=n(gt);ns=i(wa,"SimMIM <https://arxiv.org/abs/2111.09886>"),wa.forEach(o),rs=i(tt,`__.
This model is a PyTorch `),Me=a(tt,"A",{href:!0,rel:!0});var va=n(Me);is=i(va,"torch.nn.Module"),va.forEach(o),ls=i(tt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),tt.forEach(o),ds=h(et),E=a(et,"DIV",{class:!0});var z=n(E);v(xe.$$.fragment,z),cs=h(z),Z=a(z,"P",{});var ot=n(Z);hs=i(ot,"The "),Ye=a(ot,"A",{href:!0});var ba=n(Ye);ms=i(ba,"SwinForMaskedImageModeling"),ba.forEach(o),ps=i(ot," forward method, overrides the "),_t=a(ot,"CODE",{});var Sa=n(_t);fs=i(Sa,"__call__"),Sa.forEach(o),us=i(ot," special method."),ot.forEach(o),gs=h(z),v(ae.$$.fragment,z),_s=h(z),wt=a(z,"P",{});var $a=n(wt);ws=i($a,"Examples:"),$a.forEach(o),vs=h(z),v(Ee.$$.fragment,z),z.forEach(o),et.forEach(o),Ht=h(t),R=a(t,"H2",{class:!0});var Qt=n(R);ne=a(Qt,"A",{id:!0,class:!0,href:!0});var ya=n(ne);vt=a(ya,"SPAN",{});var Ta=n(vt);v(je.$$.fragment,Ta),Ta.forEach(o),ya.forEach(o),bs=h(Qt),bt=a(Qt,"SPAN",{});var ka=n(bt);Ss=i(ka,"SwinForImageClassification"),ka.forEach(o),Qt.forEach(o),Bt=h(t),C=a(t,"DIV",{class:!0});var le=n(C);v(Fe.$$.fragment,le),$s=h(le),St=a(le,"P",{});var Ma=n(St);ys=i(Ma,`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Ma.forEach(o),Ts=h(le),Ce=a(le,"P",{});var Xt=n(Ce);ks=i(Xt,"This model is a PyTorch "),Ie=a(Xt,"A",{href:!0,rel:!0});var xa=n(Ie);Ms=i(xa,"torch.nn.Module"),xa.forEach(o),xs=i(Xt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xt.forEach(o),Es=h(le),j=a(le,"DIV",{class:!0});var N=n(j);v(Ae.$$.fragment,N),js=h(N),G=a(N,"P",{});var st=n(G);Fs=i(st,"The "),Ze=a(st,"A",{href:!0});var Ea=n(Ze);Cs=i(Ea,"SwinForImageClassification"),Ea.forEach(o),Is=i(st," forward method, overrides the "),$t=a(st,"CODE",{});var ja=n($t);As=i(ja,"__call__"),ja.forEach(o),Ps=i(st," special method."),st.forEach(o),qs=h(N),v(re.$$.fragment,N),zs=h(N),yt=a(N,"P",{});var Fa=n(yt);Ns=i(Fa,"Example:"),Fa.forEach(o),Os=h(N),v(Pe.$$.fragment,N),N.forEach(o),le.forEach(o),this.h()},h(){l(p,"name","hf:doc:metadata"),l(p,"content",JSON.stringify(Da)),l(_,"id","swin-transformer"),l(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(_,"href","#swin-transformer"),l(f,"class","relative group"),l(J,"id","overview"),l(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(J,"href","#overview"),l(L,"class","relative group"),l(ce,"href","https://arxiv.org/abs/2103.14030"),l(ce,"rel","nofollow"),l(We,"href","/docs/transformers/master/en/model_doc/auto#transformers.AutoFeatureExtractor"),qa(Q.src,Ds="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/swin_transformer_architecture.png")||l(Q,"src",Ds),l(Q,"alt","drawing"),l(Q,"width","600"),l(He,"href","https://arxiv.org/abs/2102.03334"),l(me,"href","https://huggingface.co/novice03%3E"),l(me,"rel","nofollow"),l(pe,"href","https://github.com/microsoft/Swin-Transformer"),l(pe,"rel","nofollow"),l(ee,"id","transformers.SwinConfig"),l(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ee,"href","#transformers.SwinConfig"),l(W,"class","relative group"),l(Be,"href","/docs/transformers/master/en/model_doc/swin#transformers.SwinModel"),l(ge,"href","https://huggingface.co/microsoft/swin-tiny-patch4-window7-224"),l(ge,"rel","nofollow"),l(Ue,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),l(Ve,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),l(F,"class","docstring"),l(te,"id","transformers.SwinModel"),l(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(te,"href","#transformers.SwinModel"),l(U,"class","relative group"),l(Se,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Se,"rel","nofollow"),l(Ke,"href","/docs/transformers/master/en/model_doc/swin#transformers.SwinModel"),l(x,"class","docstring"),l(I,"class","docstring"),l(se,"id","transformers.SwinForMaskedImageModeling"),l(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(se,"href","#transformers.SwinForMaskedImageModeling"),l(K,"class","relative group"),l(Me,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Me,"rel","nofollow"),l(Ye,"href","/docs/transformers/master/en/model_doc/swin#transformers.SwinForMaskedImageModeling"),l(E,"class","docstring"),l(A,"class","docstring"),l(ne,"id","transformers.SwinForImageClassification"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.SwinForImageClassification"),l(R,"class","relative group"),l(Ie,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ie,"rel","nofollow"),l(Ze,"href","/docs/transformers/master/en/model_doc/swin#transformers.SwinForImageClassification"),l(j,"class","docstring"),l(C,"class","docstring")},m(t,d){e(document.head,p),m(t,T,d),m(t,f,d),e(f,_),e(_,k),b(u,k,null),e(f,g),e(f,M),e(M,to),m(t,xt,d),m(t,L,d),e(L,J),e(J,nt),b(de,nt,null),e(L,oo),e(L,rt),e(rt,so),m(t,Et,d),m(t,D,d),e(D,ao),e(D,ce),e(ce,no),e(D,ro),e(D,io),m(t,jt,d),m(t,Ne,d),e(Ne,lo),m(t,Ft,d),m(t,Oe,d),e(Oe,it),e(it,co),m(t,Ct,d),m(t,Le,d),e(Le,ho),m(t,It,d),m(t,De,d),e(De,he),e(he,mo),e(he,We),e(We,po),e(he,fo),m(t,At,d),m(t,Q,d),m(t,Pt,d),m(t,X,d),e(X,uo),e(X,He),e(He,go),e(X,_o),m(t,qt,d),m(t,P,d),e(P,wo),e(P,me),e(me,vo),e(P,bo),e(P,pe),e(pe,So),e(P,$o),m(t,zt,d),m(t,W,d),e(W,ee),e(ee,lt),b(fe,lt,null),e(W,yo),e(W,dt),e(dt,To),m(t,Nt,d),m(t,F,d),b(ue,F,null),e(F,ko),e(F,H),e(H,Mo),e(H,Be),e(Be,xo),e(H,Eo),e(H,ge),e(ge,jo),e(H,Fo),e(F,Co),e(F,B),e(B,Io),e(B,Ue),e(Ue,Ao),e(B,Po),e(B,Ve),e(Ve,qo),e(B,zo),e(F,No),b(_e,F,null),m(t,Ot,d),m(t,U,d),e(U,te),e(te,ct),b(we,ct,null),e(U,Oo),e(U,ht),e(ht,Lo),m(t,Lt,d),m(t,I,d),b(ve,I,null),e(I,Do),e(I,be),e(be,Wo),e(be,Se),e(Se,Ho),e(be,Bo),e(I,Uo),e(I,x),b($e,x,null),e(x,Vo),e(x,V),e(V,Ko),e(V,Ke),e(Ke,Yo),e(V,Zo),e(V,mt),e(mt,Ro),e(V,Go),e(x,Jo),b(oe,x,null),e(x,Qo),e(x,pt),e(pt,Xo),e(x,es),b(ye,x,null),m(t,Dt,d),m(t,K,d),e(K,se),e(se,ft),b(Te,ft,null),e(K,ts),e(K,ut),e(ut,os),m(t,Wt,d),m(t,A,d),b(ke,A,null),e(A,ss),e(A,Y),e(Y,as),e(Y,gt),e(gt,ns),e(Y,rs),e(Y,Me),e(Me,is),e(Y,ls),e(A,ds),e(A,E),b(xe,E,null),e(E,cs),e(E,Z),e(Z,hs),e(Z,Ye),e(Ye,ms),e(Z,ps),e(Z,_t),e(_t,fs),e(Z,us),e(E,gs),b(ae,E,null),e(E,_s),e(E,wt),e(wt,ws),e(E,vs),b(Ee,E,null),m(t,Ht,d),m(t,R,d),e(R,ne),e(ne,vt),b(je,vt,null),e(R,bs),e(R,bt),e(bt,Ss),m(t,Bt,d),m(t,C,d),b(Fe,C,null),e(C,$s),e(C,St),e(St,ys),e(C,Ts),e(C,Ce),e(Ce,ks),e(Ce,Ie),e(Ie,Ms),e(Ce,xs),e(C,Es),e(C,j),b(Ae,j,null),e(j,js),e(j,G),e(G,Fs),e(G,Ze),e(Ze,Cs),e(G,Is),e(G,$t),e($t,As),e(G,Ps),e(j,qs),b(re,j,null),e(j,zs),e(j,yt),e(yt,Ns),e(j,Os),b(Pe,j,null),Ut=!0},p(t,[d]){const qe={};d&2&&(qe.$$scope={dirty:d,ctx:t}),oe.$set(qe);const Tt={};d&2&&(Tt.$$scope={dirty:d,ctx:t}),ae.$set(Tt);const kt={};d&2&&(kt.$$scope={dirty:d,ctx:t}),re.$set(kt)},i(t){Ut||(S(u.$$.fragment,t),S(de.$$.fragment,t),S(fe.$$.fragment,t),S(ue.$$.fragment,t),S(_e.$$.fragment,t),S(we.$$.fragment,t),S(ve.$$.fragment,t),S($e.$$.fragment,t),S(oe.$$.fragment,t),S(ye.$$.fragment,t),S(Te.$$.fragment,t),S(ke.$$.fragment,t),S(xe.$$.fragment,t),S(ae.$$.fragment,t),S(Ee.$$.fragment,t),S(je.$$.fragment,t),S(Fe.$$.fragment,t),S(Ae.$$.fragment,t),S(re.$$.fragment,t),S(Pe.$$.fragment,t),Ut=!0)},o(t){$(u.$$.fragment,t),$(de.$$.fragment,t),$(fe.$$.fragment,t),$(ue.$$.fragment,t),$(_e.$$.fragment,t),$(we.$$.fragment,t),$(ve.$$.fragment,t),$($e.$$.fragment,t),$(oe.$$.fragment,t),$(ye.$$.fragment,t),$(Te.$$.fragment,t),$(ke.$$.fragment,t),$(xe.$$.fragment,t),$(ae.$$.fragment,t),$(Ee.$$.fragment,t),$(je.$$.fragment,t),$(Fe.$$.fragment,t),$(Ae.$$.fragment,t),$(re.$$.fragment,t),$(Pe.$$.fragment,t),Ut=!1},d(t){o(p),t&&o(T),t&&o(f),y(u),t&&o(xt),t&&o(L),y(de),t&&o(Et),t&&o(D),t&&o(jt),t&&o(Ne),t&&o(Ft),t&&o(Oe),t&&o(Ct),t&&o(Le),t&&o(It),t&&o(De),t&&o(At),t&&o(Q),t&&o(Pt),t&&o(X),t&&o(qt),t&&o(P),t&&o(zt),t&&o(W),y(fe),t&&o(Nt),t&&o(F),y(ue),y(_e),t&&o(Ot),t&&o(U),y(we),t&&o(Lt),t&&o(I),y(ve),y($e),y(oe),y(ye),t&&o(Dt),t&&o(K),y(Te),t&&o(Wt),t&&o(A),y(ke),y(xe),y(ae),y(Ee),t&&o(Ht),t&&o(R),y(je),t&&o(Bt),t&&o(C),y(Fe),y(Ae),y(re),y(Pe)}}}const Da={local:"swin-transformer",sections:[{local:"overview",title:"Overview"},{local:"transformers.SwinConfig",title:"SwinConfig"},{local:"transformers.SwinModel",title:"SwinModel"},{local:"transformers.SwinForMaskedImageModeling",title:"SwinForMaskedImageModeling"},{local:"transformers.SwinForImageClassification",title:"SwinForImageClassification"}],title:"Swin Transformer"};function Wa(O,p,T){let{fw:f}=p;return O.$$set=_=>{"fw"in _&&T(0,f=_.fw)},[f]}class Ya extends Ca{constructor(p){super();Ia(this,p,Wa,La,Aa,{fw:0})}}export{Ya as default,Da as metadata};
