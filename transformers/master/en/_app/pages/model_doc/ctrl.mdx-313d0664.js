import{S as Dc,i as Ac,s as Oc,e as a,k as l,w,t as n,L as Hc,c as r,d as t,m as d,a as i,x as L,h as s,b as c,J as e,g as u,y as $,q as R,o as M,B as E}from"../../chunks/vendor-9e2b328e.js";import{T as Lt}from"../../chunks/Tip-76f97a76.js";import{D as Ie}from"../../chunks/Docstring-50fd6873.js";import{C as Vt}from"../../chunks/CodeBlock-88e23343.js";import{I as lt}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Wc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var b=i(m);g=s(b,"Module"),b.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Bc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var b=i(m);g=s(b,"Module"),b.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Uc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var b=i(m);g=s(b,"Module"),b.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Vc(B){let p,C,m,g,v,T,_,b,me,Q,y,X,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),b=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),y=a("p"),X=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
...
`),G=r(ye,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,m,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,b),e(b,me),u(h,Q,k),u(h,y,k),e(y,X),e(y,A),e(A,Y),e(y,ge),e(y,O),e(O,_e),e(y,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,U),e(U,he),e(q,ne),e(q,V),e(V,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(m),h&&t(g),h&&t(Q),h&&t(y),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Gc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var b=i(m);g=s(b,"Module"),b.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Kc(B){let p,C,m,g,v,T,_,b,me,Q,y,X,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),b=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),y=a("p"),X=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),b=r(re,"LI",{});var ue=i(b);me=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),y=r(h,"P",{});var N=i(y);X=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),V=r(P,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var K=i(z);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var ye=i(I);te=s(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(ye,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,m,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,b),e(b,me),u(h,Q,k),u(h,y,k),e(y,X),e(y,A),e(A,Y),e(y,ge),e(y,O),e(O,_e),e(y,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,U),e(U,he),e(q,ne),e(q,V),e(V,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(m),h&&t(g),h&&t(Q),h&&t(y),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Jc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var b=i(m);g=s(b,"Module"),b.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Xc(B){let p,C,m,g,v,T,_,b,me,Q,y,X,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),b=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),y=a("p"),X=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),b=r(re,"LI",{});var ue=i(b);me=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),y=r(h,"P",{});var N=i(y);X=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),V=r(P,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var K=i(z);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var ye=i(I);te=s(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(ye,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,m,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,b),e(b,me),u(h,Q,k),u(h,y,k),e(y,X),e(y,A),e(A,Y),e(y,ge),e(y,O),e(O,_e),e(y,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,U),e(U,he),e(q,ne),e(q,V),e(V,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(m),h&&t(g),h&&t(Q),h&&t(y),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Qc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var b=i(m);g=s(b,"Module"),b.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Yc(B){let p,C,m,g,v,T,_,b,me,Q,y,X,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,Ce,h,k,re,Ae,ue,N,Me,Oe,He,D,P,We,Ee,K,Be,Fe,ye,Ue,wn,ca,ha,Ko,Ln,pa,ua,bs,Xe,fa,Gt,ma,ga,Kt,_a,Ta,ws,dt,$t,$n,Jt,va,Rn,ka,Ls,be,Xt,Ca,Je,ya,Jo,ba,wa,Xo,La,$a,Qt,Ra,Ma,Ea,ct,Fa,Qo,qa,za,Yo,Pa,xa,Sa,Mn,ja,Ia,Yt,$s,ht,Rt,En,Zt,Na,Fn,Da,Rs,Ne,eo,Aa,qn,Oa,Ha,to,Wa,Zo,Ba,Ua,Va,zn,Ms,pt,Mt,Pn,oo,Ga,xn,Ka,Es,we,no,Ja,Sn,Xa,Qa,so,Ya,en,Za,er,tr,ao,or,ro,nr,sr,ar,qe,io,rr,ut,ir,tn,lr,dr,jn,cr,hr,pr,Et,ur,In,fr,mr,lo,Fs,ft,Ft,Nn,co,gr,Dn,_r,qs,Le,ho,Tr,An,vr,kr,po,Cr,on,yr,br,wr,uo,Lr,fo,$r,Rr,Mr,ze,mo,Er,mt,Fr,nn,qr,zr,On,Pr,xr,Sr,qt,jr,Hn,Ir,Nr,go,zs,gt,zt,Wn,_o,Dr,Bn,Ar,Ps,$e,To,Or,Re,Hr,sn,Wr,Br,Un,Ur,Vr,Vn,Gr,Kr,Gn,Jr,Xr,Kn,Qr,Yr,Zr,vo,ei,an,ti,oi,ni,ko,si,Co,ai,ri,ii,ie,yo,li,_t,di,rn,ci,hi,Jn,pi,ui,fi,Pt,mi,Xn,gi,_i,bo,Ti,Qn,vi,ki,wo,xs,Tt,xt,Yn,Lo,Ci,Zn,yi,Ss,le,$o,bi,es,wi,Li,Ro,$i,ln,Ri,Mi,Ei,Mo,Fi,Eo,qi,zi,Pi,St,xi,Pe,Fo,Si,vt,ji,dn,Ii,Ni,ts,Di,Ai,Oi,jt,Hi,os,Wi,Bi,qo,js,kt,It,ns,zo,Ui,ss,Vi,Is,de,Po,Gi,as,Ki,Ji,xo,Xi,cn,Qi,Yi,Zi,So,el,jo,tl,ol,nl,Nt,sl,xe,Io,al,Ct,rl,hn,il,ll,rs,dl,cl,hl,Dt,pl,is,ul,fl,No,Ns,yt,At,ls,Do,ml,ds,gl,Ds,J,Ao,_l,cs,Tl,vl,pn,un,kl,Cl,yl,De,bl,hs,wl,Ll,ps,$l,Rl,us,Ml,El,fs,Fl,ql,zl,Oo,Pl,fn,xl,Sl,jl,Ho,Il,Wo,Nl,Dl,Al,Ot,Ol,Se,Bo,Hl,bt,Wl,mn,Bl,Ul,ms,Vl,Gl,Kl,Ht,Jl,gs,Xl,Ql,Uo,As;return T=new lt({}),Y=new lt({}),Jt=new lt({}),Xt=new Ie({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),io=new Ie({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/modeling_ctrl.py#L354",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),mo=new Ie({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/modeling_ctrl.py#L516",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new Lt({props:{$$slots:{default:[Vc]},$$scope:{ctx:B}}}),Fo=new Ie({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/modeling_tf_ctrl.py#L542",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new Lt({props:{$$slots:{default:[Kc]},$$scope:{ctx:B}}}),Io=new Ie({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/modeling_tf_ctrl.py#L669",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ot=new Lt({props:{$$slots:{default:[Xc]},$$scope:{ctx:B}}}),Bo=new Ie({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/modeling_tf_ctrl.py#L792",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("meta"),C=l(),m=a("h1"),g=a("a"),v=a("span"),w(T.$$.fragment),_=l(),b=a("span"),me=n("CTRL"),Q=l(),y=a("h2"),X=a("a"),A=a("span"),w(Y.$$.fragment),ge=l(),O=a("span"),_e=n("Overview"),ce=l(),x=a("p"),S=n("CTRL model was proposed in "),Z=a("a"),oe=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),Te=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
TensorFlow models accepts `),Fe=a("code"),ye=n("past"),Ue=n(" as input. Using the "),wn=a("code"),ca=n("past_key_values"),ha=n(` value prevents the model from re-computing
...
embeddings).`),kr=l(),po=a("p"),Cr=n("This model inherits from "),on=a("a"),yr=n("PreTrainedModel"),br=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),nl=l(),w(Nt.$$.fragment),sl=l(),xe=a("div"),w(Io.$$.fragment),al=l(),Ct=a("p"),rl=n("The "),hn=a("a"),il=n("TFCTRLLMHeadModel"),ll=n(" forward method, overrides the "),rs=a("code"),dl=n("__call__"),cl=n(" special method."),hl=l(),w(Dt.$$.fragment),pl=l(),is=a("p"),ul=n("Example:"),fl=l(),w(No.$$.fragment),Ns=l(),yt=a("h2"),At=a("a"),ls=a("span"),w(Do.$$.fragment),ml=l(),ds=a("span"),gl=n("TFCTRLForSequenceClassification"),Ds=l(),J=a("div"),w(Ao.$$.fragment),_l=l(),cs=a("p"),Tl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),vl=l(),pn=a("p"),un=a("a"),kl=n("TFCTRLForSequenceClassification"),Cl=n(` uses the last token in order to do the classification, as other causal models
...
more information.`),Os.forEach(t),h=d(Wt),k=r(Wt,"LI",{});var rd=i(k);re=s(rd,`CTRL is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
...
TensorFlow models accepts `),Fe=r(Qe,"CODE",{});var dd=i(Fe);ye=s(dd,"past"),dd.forEach(t),Ue=s(Qe," as input. Using the "),wn=r(Qe,"CODE",{});var cd=i(wn);ca=s(cd,"past_key_values"),cd.forEach(t),ha=s(Qe,` value prevents the model from re-computing
...
documentation from `),Yo=r(_n,"A",{href:!0});var yd=i(Yo);Pa=s(yd,"PretrainedConfig"),yd.forEach(t),xa=s(_n," for more information."),_n.forEach(t),Sa=d(Ye),Mn=r(Ye,"P",{});var bd=i(Mn);ja=s(bd,"Examples:"),bd.forEach(t),Ia=d(Ye),L(Yt.$$.fragment,Ye),Ye.forEach(t),$s=d(o),ht=r(o,"H2",{class:!0});var Bs=i(ht);Rt=r(Bs,"A",{id:!0,class:!0,href:!0});var wd=i(Rt);En=r(wd,"SPAN",{});var Ld=i(En);L(Zt.$$.fragment,Ld),Ld.forEach(t),wd.forEach(t),Na=d(Bs),Fn=r(Bs,"SPAN",{});var $d=i(Fn);Da=s($d,"CTRLTokenizer"),$d.forEach(t),Bs.forEach(t),Rs=d(o),Ne=r(o,"DIV",{class:!0});var Ut=i(Ne);L(eo.$$.fragment,Ut),Aa=d(Ut),qn=r(Ut,"P",{});var Rd=i(qn);Oa=s(Rd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Rd.forEach(t),Ha=d(Ut),to=r(Ut,"P",{});var Us=i(to);Wa=s(Us,"This tokenizer inherits from "),Zo=r(Us,"A",{href:!0});var Md=i(Zo);Ba=s(Md,"PreTrainedTokenizer"),Md.forEach(t),Ua=s(Us,` which contains most of the main methods. Users should refer to
...
embeddings).`),Od.forEach(t),kr=d(tt),po=r(tt,"P",{});var Xs=i(po);Cr=s(Xs,"This model inherits from "),on=r(Xs,"A",{href:!0});var Hd=i(on);yr=s(Hd,"PreTrainedModel"),Hd.forEach(t),br=s(Xs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
