import{S as pp,i as mp,s as fp,e as a,k as c,w as T,t as n,R as up,c as r,d as t,m as l,a as i,x as v,h as s,b as d,F as e,g as p,y as k,q as x,o as b,B as y}from"../../chunks/vendor-9daddcfa.js";import{T as Yt}from"../../chunks/Tip-c0a70391.js";import{D}from"../../chunks/Docstring-ea6f8b76.js";import{C as ln}from"../../chunks/CodeBlock-37b92346.js";import{I as We}from"../../chunks/IconCopyLink-a413fd1b.js";import"../../chunks/CopyButton-6099fd9d.js";function _p(G){let h,$,u,_,S,g,w,E;return{c(){h=a("p"),$=n(`This class method is simply calling the feature extractor
...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var w=i(h);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var E=i(u);_=s(E,"Module"),E.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(g,w){p(g,h,w),e(h,$),e(h,u),e(u,_),e(h,S)},d(g){g&&t(h)}}}function wp(G){let h,$,u,_,S,g,w,E,A,q,z,N,H,ee,Fe,V,je,$e,M,J,te,ye,P,C,Pe,oe,ne,Ce,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,f,F,X,st,Ne,Q,Re,_e,at,W,ce,rt,Ue,j,it,ze,Le,dt,hn,tr,or,pn,nr,sr,mn,ar,rr,Zs,R,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,mr,Zn,fr,ur,es,_r,gr,Xt,Tr,vr,ts,kr,ea,fn,os,xr,ta,Qt,oa,un,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,zr,rs,qr,Fr,is,jr,Pr,ds,Cr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Rr,so,Ur,Br,Hr,ht,Vr,gn,Jr,Kr,Tn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,ms,oi,da,U,io,ni,fs,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,us,hi,pi,Et,ho,mi,po,fi,_s,ui,_i,gi,Be,mo,Ti,kn,vi,xn,ki,xi,gs,bi,yi,bn,fo,ca,mt,zt,Ts,uo,wi,vs,Si,la,pe,_o,$i,ks,Ei,zi,go,qi,yn,Fi,ji,Pi,xs,Ci,Mi,qt,To,Ai,bs,Ii,ha,ft,Ft,ys,vo,Di,ws,Ni,pa,I,ko,Li,Ss,Oi,Gi,ge,wn,Wi,Ri,Sn,Ui,Bi,$n,Hi,Vi,xo,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,jt,bo,ed,Oe,td,yo,Es,od,nd,sd,zn,ad,rd,wo,zs,id,dd,cd,ld,He,So,hd,qs,pd,md,Pt,fd,Ve,$o,ud,Eo,_d,qn,gd,Td,vd,Ct,kd,Mt,zo,xd,qo,bd,Fn,yd,wd,Sd,At,Fo,$d,jo,Ed,jn,zd,qd,Fd,It,Po,jd,Fs,Pd,ma,ut,Dt,js,Co,Cd,Ps,Md,fa,we,Mo,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Rd,Te,No,Ud,_t,Bd,Cn,Hd,Vd,Cs,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,ua,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Ro,ic,Uo,dc,cc,lc,ve,Bo,hc,Tt,pc,An,mc,fc,Ds,uc,_c,gc,Ot,Tc,Ns,vc,kc,Ho,ga,vt,Gt,Ls,Vo,xc,Os,bc,Ta,me,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,zc,Xo,qc,Fc,jc,Wt,Pc,ke,Qo,Cc,kt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Rt,Oc,Ws,Gc,Wc,Zo,va,xt,Ut,Rs,en,Rc,Us,Uc,ka,fe,tn,Bc,on,Hc,Nn,Vc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Bt,el,xe,an,tl,bt,ol,Ln,nl,sl,Bs,al,rl,il,Ht,dl,Hs,cl,ll,rn,xa;return g=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
`}}),Rt=new Yt({props:{$$slots:{default:[xp]},$$scope:{ctx:G}}}),Zo=new ln({props:{code:`from transformers import Speech2TextTokenizer, TFSpeech2TextModel
...
predicted token ids.`),Zs=c(),R=a("p"),ir=n("The feature extractor depends on "),Yn=a("code"),dr=n("torchaudio"),cr=n(" and the tokenizer depends on "),Xn=a("code"),lr=n("sentencepiece"),hr=n(` so be sure to
...
`),so=a("a"),Ur=n("facebook/s2t-small-librispeech-asr"),Br=n(" architecture."),Hr=c(),ht=a("p"),Vr=n("Configuration objects inherit from "),gn=a("a"),Jr=n("PretrainedConfig"),Kr=n(` and can be used to control the model outputs. Read the
documentation from `),Tn=a("a"),Yr=n("PretrainedConfig"),Xr=n(" for more information."),Qr=c(),hs=a("p"),Zr=n("Example:"),ei=c(),T(ao.$$.fragment),ia=c(),pt=a("h2"),St=a("a"),ps=a("span"),T(ro.$$.fragment),ti=c(),ms=a("span"),oi=n("Speech2TextTokenizer"),da=c(),U=a("div"),T(io.$$.fragment),ni=c(),fs=a("p"),si=n("Construct an Speech2Text tokenizer."),ai=c(),co=a("p"),ri=n("This tokenizer inherits from "),vn=a("a"),ii=n("PreTrainedTokenizer"),di=n(` which contains some of the main methods. Users should refer to
...
single processor.`),Gi=c(),ge=a("p"),wn=a("a"),Wi=n("Speech2TextProcessor"),Ri=n(" offers all the functionalities of "),Sn=a("a"),Ui=n("Speech2TextFeatureExtractor"),Bi=n(` and
...
and behavior.`),Rd=c(),Te=a("div"),T(No.$$.fragment),Ud=c(),_t=a("p"),Bd=n("The "),Cn=a("a"),Hd=n("Speech2TextModel"),Vd=n(" forward method, overrides the "),Cs=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),T(Nt.$$.fragment),Xd=c(),Ms=a("p"),Qd=n("Example:"),Zd=c(),T(Lo.$$.fragment),ua=c(),gt=a("h2"),Lt=a("a"),As=a("span"),T(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),T(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mn=a("a"),sc=n("PreTrainedModel"),ac=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rc=c(),Ro=a("p"),ic=n("This model is also a PyTorch "),Uo=a("a"),dc=n("torch.nn.Module"),cc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),ve=a("div"),T(Bo.$$.fragment),hc=c(),Tt=a("p"),pc=n("The "),An=a("a"),mc=n("Speech2TextForConditionalGeneration"),fc=n(" forward method, overrides the "),Ds=a("code"),uc=n("__call__"),_c=n(" special method."),gc=c(),T(Ot.$$.fragment),Tc=c(),Ns=a("p"),vc=n("Example:"),kc=c(),T(Ho.$$.fragment),ga=c(),vt=a("h2"),Gt=a("a"),Ls=a("span"),T(Vo.$$.fragment),xc=c(),Os=a("span"),bc=n("TFSpeech2TextModel"),Ta=c(),me=a("div"),T(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
behavior.`),jc=c(),T(Wt.$$.fragment),Pc=c(),ke=a("div"),T(Qo.$$.fragment),Cc=c(),kt=a("p"),Mc=n("The "),Dn=a("a"),Ac=n("TFSpeech2TextModel"),Ic=n(" forward method, overrides the "),Gs=a("code"),Dc=n("__call__"),Nc=n(" special method."),Lc=c(),T(Rt.$$.fragment),Oc=c(),Ws=a("p"),Gc=n("Example:"),Wc=c(),T(Zo.$$.fragment),va=c(),xt=a("h2"),Ut=a("a"),Rs=a("span"),T(en.$$.fragment),Rc=c(),Us=a("span"),Uc=n("TFSpeech2TextForConditionalGeneration"),ka=c(),fe=a("div"),T(tn.$$.fragment),Bc=c(),on=a("p"),Hc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
predicted token ids.`),Ke.forEach(t),Zs=l(o),R=r(o,"P",{});var ue=i(R);ir=s(ue,"The feature extractor depends on "),Yn=r(ue,"CODE",{});var ql=i(Yn);dr=s(ql,"torchaudio"),ql.forEach(t),cr=s(ue," and the tokenizer depends on "),Xn=r(ue,"CODE",{});var Fl=i(Xn);lr=s(Fl,"sentencepiece"),Fl.forEach(t),hr=s(ue,` so be sure to
install those packages before running the examples. You could either install those as extra speech dependencies with
...
single processor.`),kh.forEach(t),Gi=l(B),ge=r(B,"P",{});var Ge=i(ge);wn=r(Ge,"A",{href:!0});var xh=i(wn);Wi=s(xh,"Speech2TextProcessor"),xh.forEach(t),Ri=s(Ge," offers all the functionalities of "),Sn=r(Ge,"A",{href:!0});var bh=i(Sn);Ui=s(bh,"Speech2TextFeatureExtractor"),bh.forEach(t),Bi=s(Ge,` and
...
information.`),Ge.forEach(t),Zi=l(B),jt=r(B,"DIV",{class:!0});var Ia=i(jt);v(bo.$$.fragment,Ia),ed=l(Ia),Oe=r(Ia,"P",{});var Vt=i(Oe);td=s(Vt,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),Vt.forEach(t),Ia.forEach(t),ld=l(B),He=r(B,"DIV",{class:!0});var Un=i(He);v(So.$$.fragment,Un),hd=l(Un),qs=r(Un,"P",{});var qh=i(qs);pd=s(qh,"Instantiate a processor associated with a pretrained model."),qh.forEach(t),md=l(Un),v(Pt.$$.fragment,Un),Un.forEach(t),fd=l(B),Ve=r(B,"DIV",{class:!0});var Bn=i(Ve);v($o.$$.fragment,Bn),ud=l(Bn),Eo=r(Bn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
refer to the docstring of this method for more information.`),La.forEach(t),Na.forEach(t),Sd=l(B),At=r(B,"DIV",{class:!0});var Oa=i(At);v(Fo.$$.fragment,Oa),$d=l(Oa),jo=r(Oa,"P",{});var Ga=i(jo);Ed=s(Ga,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),jn=r(Ga,"A",{href:!0});var Ph=i(jn);zd=s(Ph,"decode()"),Ph.forEach(t),qd=s(Ga,`. Please refer
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(B),It=r(B,"DIV",{class:!0});var Wa=i(It);v(Po.$$.fragment,Wa),jd=l(Wa),Fs=r(Wa,"P",{});var Ch=i(Fs);Pd=s(Ch,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),Ch.forEach(t),Wa.forEach(t),B.forEach(t),ma=l(o),ut=r(o,"H2",{class:!0});var Ra=i(ut);Dt=r(Ra,"A",{id:!0,class:!0,href:!0});var Mh=i(Dt);js=r(Mh,"SPAN",{});var Ah=i(js);v(Co.$$.fragment,Ah),Ah.forEach(t),Mh.forEach(t),Cd=l(Ra),Ps=r(Ra,"SPAN",{});var Ih=i(Ps);Md=s(Ih,"Speech2TextModel"),Ih.forEach(t),Ra.forEach(t),fa=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);v(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ua=i(Ao);Id=s(Ua,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ua.forEach(t),Ld=l(Jt),Io=r(Jt,"P",{});var Ba=i(Io);Od=s(Ba,"This model is also a PyTorch "),Do=r(Ba,"A",{href:!0,rel:!0});var Nh=i(Do);Gd=s(Nh,"torch.nn.Module"),Nh.forEach(t),Wd=s(Ba,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ba.forEach(t),Rd=l(Jt),Te=r(Jt,"DIV",{class:!0});var Qe=i(Te);v(No.$$.fragment,Qe),Ud=l(Qe),_t=r(Qe,"P",{});var Hn=i(_t);Bd=s(Hn,"The "),Cn=r(Hn,"A",{href:!0});var Lh=i(Cn);Hd=s(Lh,"Speech2TextModel"),Lh.forEach(t),Vd=s(Hn," forward method, overrides the "),Cs=r(Hn,"CODE",{});var Oh=i(Cs);Jd=s(Oh,"__call__"),Oh.forEach(t),Kd=s(Hn," special method."),Hn.forEach(t),Yd=l(Qe),v(Nt.$$.fragment,Qe),Xd=l(Qe),Ms=r(Qe,"P",{});var Gh=i(Ms);Qd=s(Gh,"Example:"),Gh.forEach(t),Zd=l(Qe),v(Lo.$$.fragment,Qe),Qe.forEach(t),Jt.forEach(t),ua=l(o),gt=r(o,"H2",{class:!0});var Ha=i(gt);Lt=r(Ha,"A",{id:!0,class:!0,href:!0});var Wh=i(Lt);As=r(Wh,"SPAN",{});var Rh=i(As);v(Oo.$$.fragment,Rh),Rh.forEach(t),Wh.forEach(t),ec=l(Ha),Is=r(Ha,"SPAN",{});var Uh=i(Is);tc=s(Uh,"Speech2TextForConditionalGeneration"),Uh.forEach(t),Ha.forEach(t),_a=l(o),Se=r(o,"DIV",{class:!0});var Kt=i(Se);v(Go.$$.fragment,Kt),oc=l(Kt),Wo=r(Kt,"P",{});var Va=i(Wo);nc=s(Va,`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Va.forEach(t),rc=l(Kt),Ro=r(Kt,"P",{});var Ja=i(Ro);ic=s(Ja,"This model is also a PyTorch "),Uo=r(Ja,"A",{href:!0,rel:!0});var Hh=i(Uo);dc=s(Hh,"torch.nn.Module"),Hh.forEach(t),cc=s(Ja,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xa.forEach(t),jc=l(et),v(Wt.$$.fragment,et),Pc=l(et),ke=r(et,"DIV",{class:!0});var tt=i(ke);v(Qo.$$.fragment,tt),Cc=l(tt),kt=r(tt,"P",{});var Jn=i(kt);Mc=s(Jn,"The "),Dn=r(Jn,"A",{href:!0});var tp=i(Dn);Ac=s(tp,"TFSpeech2TextModel"),tp.forEach(t),Ic=s(Jn," forward method, overrides the "),Gs=r(Jn,"CODE",{});var op=i(Gs);Dc=s(op,"__call__"),op.forEach(t),Nc=s(Jn," special method."),Jn.forEach(t),Lc=l(tt),v(Rt.$$.fragment,tt),Oc=l(tt),Ws=r(tt,"P",{});var np=i(Ws);Gc=s(np,"Example:"),np.forEach(t),Wc=l(tt),v(Zo.$$.fragment,tt),tt.forEach(t),et.forEach(t),va=l(o),xt=r(o,"H2",{class:!0});var Qa=i(xt);Ut=r(Qa,"A",{id:!0,class:!0,href:!0});var sp=i(Ut);Rs=r(sp,"SPAN",{});var ap=i(Rs);v(en.$$.fragment,ap),ap.forEach(t),sp.forEach(t),Rc=l(Qa),Us=r(Qa,"SPAN",{});var rp=i(Us);Uc=s(rp,"TFSpeech2TextForConditionalGeneration"),rp.forEach(t),Qa.forEach(t),ka=l(o),fe=r(o,"DIV",{class:!0});var ot=i(fe);v(tn.$$.fragment,ot),Bc=l(ot),on=r(ot,"P",{});var Za=i(on);Hc=s(Za,`The Speech2Text Model with a language modeling head. Can be used for summarization.
