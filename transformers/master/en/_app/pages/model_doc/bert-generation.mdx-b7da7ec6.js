import{S as ha,i as pa,s as ma,e as s,k as l,w as g,t as n,M as ua,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as T}from"../../chunks/vendor-4833417e.js";import{T as ca}from"../../chunks/Tip-fffd6df1.js";import{D as He}from"../../chunks/Docstring-4f315ed9.js";import{C as Jt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as vt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function fa(ie){let m,q,u,y,C;return{c(){m=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),y=n("Module"),C=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){m=a(w,"P",{});var E=i(m);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(E,"CODE",{});var S=i(u);y=r(S,"Module"),S.forEach(o),C=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(w,E){p(w,m,E),e(m,q),e(m,u),e(u,y),e(m,C)},d(w){w&&o(m)}}}function ga(ie){let m,q,u,y,C;return{c(){m=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),y=n("Module"),C=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){m=a(w,"P",{});var E=i(m);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(E,"CODE",{});var S=i(u);y=r(S,"Module"),S.forEach(o),C=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(w,E){p(w,m,E),e(m,q),e(m,u),e(u,y),e(m,C)},d(w){w&&o(m)}}}function _a(ie){let m,q,u,y,C,w,E,S,Do,Kt,R,Y,kt,de,So,Tt,Ao,Qt,A,Mo,Ve,No,Lo,le,Fo,Oo,Xt,Je,Io,Yt,Ke,yt,Ro,Zt,Qe,Wo,eo,Xe,ce,Uo,Ye,Ho,Vo,to,he,oo,Ze,pe,Jo,et,Ko,Qo,no,me,ro,tt,Xo,so,Z,M,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,N,an,ue,dn,ln,fe,cn,hn,io,W,ee,Bt,ge,pn,zt,mn,lo,$,_e,un,be,fn,$t,gn,_n,bn,U,vn,rt,kn,Tn,st,yn,wn,En,Gt,Bn,zn,ve,co,H,te,qt,ke,$n,Pt,Gn,ho,D,Te,qn,ye,Pn,we,jn,xn,Cn,Ee,Dn,at,Sn,An,Mn,it,Be,po,V,oe,jt,ze,Nn,xt,Ln,mo,f,$e,Fn,Ct,On,In,Ge,Rn,dt,Wn,Un,Hn,qe,Vn,Pe,Jn,Kn,Qn,je,Xn,xe,Yn,Zn,er,J,tr,lt,or,nr,Ce,rr,sr,ar,B,ir,Dt,dr,lr,St,cr,hr,At,pr,mr,Mt,ur,fr,Nt,gr,_r,Lt,br,vr,kr,P,De,Tr,K,yr,ct,wr,Er,Ft,Br,zr,$r,ne,Gr,Ot,qr,Pr,Se,uo,Q,re,It,Ae,jr,Rt,xr,fo,G,Me,Cr,Ne,Dr,Wt,Sr,Ar,Mr,Le,Nr,ht,Lr,Fr,Or,Fe,Ir,Oe,Rr,Wr,Ur,j,Ie,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Re,go;return w=new vt({}),de=new vt({}),he=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
BERT checkpoints for subsequent fine-tuning.`),to=l(),g(he.$$.fragment),oo=l(),Ze=s("ul"),pe=s("li"),Jo=n("Pretrained "),et=s("a"),Ko=n("EncoderDecoderModel"),Qo=n(" are also directly available in the model hub, e.g.,"),no=l(),g(me.$$.fragment),ro=l(),tt=s("p"),Xo=n("Tips:"),so=l(),Z=s("ul"),M=s("li"),ot=s("a"),Yo=n("BertGenerationEncoder"),Zo=n(" and "),nt=s("a"),en=n("BertGenerationDecoder"),tn=n(` should be used in
...
found `),fe=s("a"),cn=n("here"),hn=n("."),io=l(),W=s("h2"),ee=s("a"),Bt=s("span"),g(ge.$$.fragment),pn=l(),zt=s("span"),mn=n("BertGenerationConfig"),lo=l(),$=s("div"),g(_e.$$.fragment),un=l(),be=s("p"),fn=n("This is the configuration class to store the configuration of a "),$t=s("code"),gn=n("BertGenerationPreTrainedModel"),_n=n(` It is used to
...
this superclass for more information regarding those methods.`),Mn=l(),it=s("div"),g(Be.$$.fragment),po=l(),V=s("h2"),oe=s("a"),jt=s("span"),g(ze.$$.fragment),Nn=l(),xt=s("span"),Ln=n("BertGenerationEncoder"),mo=l(),f=s("div"),g($e.$$.fragment),Fn=l(),Ct=s("p"),On=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=l(),Ge=s("p"),Rn=n("This model inherits from "),dt=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
to `),St=s("code"),cr=n("True"),hr=n(". To be used in a Seq2Seq model, the model needs to initialized with both "),At=s("code"),pr=n("is_decoder"),mr=n(` argument and
`),Mt=s("code"),ur=n("add_cross_attention"),fr=n(" set to "),Nt=s("code"),gr=n("True"),_r=n("; an "),Lt=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=l(),P=s("div"),g(De.$$.fragment),Tr=l(),K=s("p"),yr=n("The "),ct=s("a"),wr=n("BertGenerationEncoder"),Er=n(" forward method, overrides the "),Ft=s("code"),Br=n("__call__"),zr=n(" special method."),$r=l(),g(ne.$$.fragment),Gr=l(),Ot=s("p"),qr=n("Example:"),Pr=l(),g(Se.$$.fragment),uo=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Ae.$$.fragment),jr=l(),Rt=s("span"),xr=n("BertGenerationDecoder"),fo=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ne=s("p"),Dr=n("BertGeneration Model with a "),Wt=s("code"),Sr=n("language modeling"),Ar=n(" head on top for CLM fine-tuning."),Mr=l(),Le=s("p"),Nr=n("This model inherits from "),ht=s("a"),Lr=n("PreTrainedModel"),Fr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Or=l(),Fe=s("p"),Ir=n("This model is also a PyTorch "),Oe=s("a"),Rr=n("torch.nn.Module"),Wr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ur=l(),j=s("div"),g(Ie.$$.fragment),Hr=l(),X=s("p"),Vr=n("The "),pt=s("a"),Jr=n("BertGenerationDecoder"),Kr=n(" forward method, overrides the "),Ut=s("code"),Qr=n("__call__"),Xr=n(" special method."),Yr=l(),g(se.$$.fragment),Zr=l(),Ht=s("p"),es=n("Example:"),ts=l(),g(Re.$$.fragment),this.h()},l(t){const h=ua('[data-svelte="svelte-1phssyn"]',document.head);m=a(h,"META",{name:!0,content:!0}),h.forEach(o),q=c(t),u=a(t,"H1",{class:!0});var We=i(u);y=a(We,"A",{id:!0,class:!0,href:!0});var Vt=i(y);C=a(Vt,"SPAN",{});var os=i(C);_(w.$$.fragment,os),os.forEach(o),Vt.forEach(o),E=c(We),S=a(We,"SPAN",{});var ns=i(S);Do=r(ns,"BertGeneration"),ns.forEach(o),We.forEach(o),Kt=c(t),R=a(t,"H2",{class:!0});var _o=i(R);Y=a(_o,"A",{id:!0,class:!0,href:!0});var rs=i(Y);kt=a(rs,"SPAN",{});var ss=i(kt);_(de.$$.fragment,ss),ss.forEach(o),rs.forEach(o),So=c(_o),Tt=a(_o,"SPAN",{});var as=i(Tt);Ao=r(as,"Overview"),as.forEach(o),_o.forEach(o),Qt=c(t),A=a(t,"P",{});var mt=i(A);Mo=r(mt,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
Therefore, no EOS token should be added to the end of the input.`),Ts.forEach(o),ko.forEach(o),ao=c(t),N=a(t,"P",{});var ut=i(N);an=r(ut,"This model was contributed by "),ue=a(ut,"A",{href:!0,rel:!0});var ys=i(ue);dn=r(ys,"patrickvonplaten"),ys.forEach(o),ln=r(ut,`. The original code can be
found `),fe=a(ut,"A",{href:!0,rel:!0});var ws=i(fe);cn=r(ws,"here"),ws.forEach(o),hn=r(ut,"."),ut.forEach(o),io=c(t),W=a(t,"H2",{class:!0});var To=i(W);ee=a(To,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(ge.$$.fragment,Bs),Bs.forEach(o),Es.forEach(o),pn=c(To),zt=a(To,"SPAN",{});var zs=i(zt);mn=r(zs,"BertGenerationConfig"),zs.forEach(o),To.forEach(o),lo=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(_e.$$.fragment,L),un=c(L),be=a(L,"P",{});var yo=i(be);fn=r(yo,"This is the configuration class to store the configuration of a "),$t=a(yo,"CODE",{});var $s=i($t);gn=r($s,"BertGenerationPreTrainedModel"),$s.forEach(o),_n=r(yo,` It is used to
