import{S as pp,i as mp,s as fp,e as a,k as c,w as T,t as n,M as up,c as r,d as t,m as l,a as i,x as v,h as s,b as d,F as e,g as p,y as k,q as x,o as b,B as y}from"../../chunks/vendor-329198bb.js";import{T as Yt}from"../../chunks/Tip-39ae8a84.js";import{D}from"../../chunks/Docstring-88811472.js";import{C as ln}from"../../chunks/CodeBlock-49151c5f.js";import{I as We}from"../../chunks/IconCopyLink-236b0ec7.js";import"../../chunks/CopyButton-970e2b07.js";function _p(G){let h,$,u,_,S,g,w,E;return{c(){h=a("p"),$=n(`This class method is simply calling the feature extractor
...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var w=i(h);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var E=i(u);_=s(E,"Module"),E.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(g,w){p(g,h,w),e(h,$),e(h,u),e(u,_),e(h,S)},d(g){g&&t(h)}}}function kp(G){let h,$,u,_,S,g,w,E,A,q,z,N,H,ee,Fe,V,je,$e,M,J,te,ye,P,C,Pe,oe,ne,Ce,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),$=n("TF 2.0 models accepts two formats as inputs:"),u=c(),_=a("ul"),S=a("li"),g=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),E=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),q=c(),z=a("p"),N=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=a("code"),je=n("model(inputs)"),$e=n("."),M=c(),J=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),W.forEach(t)},m(f,F){p(f,h,F),e(h,$),p(f,u,F),p(f,_,F),e(_,S),e(S,g),e(_,w),e(_,E),e(E,A),p(f,q,F),p(f,z,F),e(z,N),e(z,H),e(H,ee),e(z,Fe),e(z,V),e(V,je),e(z,$e),p(f,M,F),p(f,J,F),e(J,te),p(f,ye,F),p(f,P,F),e(P,C),e(C,Pe),e(C,oe),e(oe,ne),e(C,Ce),e(C,se),e(se,ae),e(P,Me),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(h),f&&t(u),f&&t(_),f&&t(q),f&&t(z),f&&t(M),f&&t(J),f&&t(ye),f&&t(P)}}}function xp(G){let h,$,u,_,S;return{c(){h=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),_=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var w=i(h);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var E=i(u);_=s(E,"Module"),E.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(g,w){p(g,h,w),e(h,$),e(h,u),e(u,_),e(h,S)},d(g){g&&t(h)}}}function bp(G){let h,$,u,_,S,g,w,E,A,q,z,N,H,ee,Fe,V,je,$e,M,J,te,ye,P,C,Pe,oe,ne,Ce,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),$=n("TF 2.0 models accepts two formats as inputs:"),u=c(),_=a("ul"),S=a("li"),g=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),E=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),q=c(),z=a("p"),N=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=a("code"),je=n("model(inputs)"),$e=n("."),M=c(),J=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ye=c(),P=a("ul"),C=a("li"),Pe=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),Ce=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Me=c(),O=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),Ie=n("model([input_ids, attention_mask, token_type_ids])"),de=c(),K=a("li"),De=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){h=r(f,"P",{});var F=i(h);$=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),u=l(f),_=r(f,"UL",{});var X=i(_);S=r(X,"LI",{});var st=i(S);g=s(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(X),E=r(X,"LI",{});var Ne=i(E);A=s(Ne,"having all inputs as a list, tuple or dict in the first positional arguments."),Ne.forEach(t),X.forEach(t),q=l(f),z=r(f,"P",{});var Q=i(z);N=s(Q,"This second option is useful when using "),H=r(Q,"CODE",{});var Ue=i(H);ee=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Fe=s(Q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var w=i(h);$=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var E=i(u);_=s(E,"Module"),E.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(g,w){p(g,h,w),e(h,$),e(h,u),e(u,_),e(h,S)},d(g){g&&t(h)}}}function wp(G){let h,$,u,_,S,g,w,E,A,q,z,N,H,ee,Fe,V,je,$e,M,J,te,ye,P,C,Pe,oe,ne,Ce,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,f,F,X,st,Ne,Q,Ue,_e,at,W,ce,rt,Be,j,it,ze,Le,dt,hn,tr,or,pn,nr,sr,mn,ar,rr,Zs,U,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,mr,Zn,fr,ur,es,_r,gr,Xt,Tr,vr,ts,kr,ea,fn,os,xr,ta,Qt,oa,un,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,zr,rs,qr,Fr,is,jr,Pr,ds,Cr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Ur,so,Br,Rr,Hr,ht,Vr,gn,Jr,Kr,Tn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,ms,oi,da,B,io,ni,fs,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,us,hi,pi,Et,ho,mi,po,fi,_s,ui,_i,gi,Re,mo,Ti,kn,vi,xn,ki,xi,gs,bi,yi,bn,fo,ca,mt,zt,Ts,uo,wi,vs,Si,la,pe,_o,$i,ks,Ei,zi,go,qi,yn,Fi,ji,Pi,xs,Ci,Mi,qt,To,Ai,bs,Ii,ha,ft,Ft,ys,vo,Di,ws,Ni,pa,I,ko,Li,Ss,Oi,Gi,ge,wn,Wi,Ui,Sn,Bi,Ri,$n,Hi,Vi,xo,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,jt,bo,ed,Oe,td,yo,Es,od,nd,sd,zn,ad,rd,wo,zs,id,dd,cd,ld,He,So,hd,qs,pd,md,Pt,fd,Ve,$o,ud,Eo,_d,qn,gd,Td,vd,Ct,kd,Mt,zo,xd,qo,bd,Fn,yd,wd,Sd,At,Fo,$d,jo,Ed,jn,zd,qd,Fd,It,Po,jd,Fs,Pd,ma,ut,Dt,js,Co,Cd,Ps,Md,fa,we,Mo,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Ud,Te,No,Bd,_t,Rd,Cn,Hd,Vd,Cs,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,ua,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Uo,ic,Bo,dc,cc,lc,ve,Ro,hc,Tt,pc,An,mc,fc,Ds,uc,_c,gc,Ot,Tc,Ns,vc,kc,Ho,ga,vt,Gt,Ls,Vo,xc,Os,bc,Ta,me,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,zc,Xo,qc,Fc,jc,Wt,Pc,ke,Qo,Cc,kt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Ut,Oc,Ws,Gc,Wc,Zo,va,xt,Bt,Us,en,Uc,Bs,Bc,ka,fe,tn,Rc,on,Hc,Nn,Vc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Rt,el,xe,an,tl,bt,ol,Ln,nl,sl,Rs,al,rl,il,Ht,dl,Hs,cl,ll,rn,xa;return g=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new D({props:{name:"forward",anchor:"transformers.Speech2TextForConditionalGeneration.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1274",parametersDescription:[{anchor:"transformers.Speech2TextForConditionalGeneration.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a <code>numpy.ndarray</code>, <em>e.g.</em>
via the soundfile library (<code>pip install soundfile</code>). To prepare the array into <code>input_features</code>, the
<a href="/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
`}}),Ot=new Yt({props:{$$slots:{default:[vp]},$$scope:{ctx:G}}}),Ho=new ln({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
import soundfile as sf
...
`}}),Ht=new Yt({props:{$$slots:{default:[yp]},$$scope:{ctx:G}}}),rn=new ln({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){h=a("meta"),$=c(),u=a("h1"),_=a("a"),S=a("span"),T(g.$$.fragment),w=c(),E=a("span"),A=n("Speech2Text"),q=c(),z=a("h2"),N=a("a"),H=a("span"),T(ee.$$.fragment),Fe=c(),V=a("span"),je=n("Overview"),$e=c(),M=a("p"),J=n("The Speech2Text model was proposed in "),te=a("a"),ye=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),P=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
...
`),W=a("code"),ce=n("generate()"),rt=n(" method can be used for inference."),Be=c(),j=a("p"),it=n("The "),ze=a("a"),Le=n("Speech2TextFeatureExtractor"),dt=n(` class is responsible for extracting the log-mel filter-bank
...
`),so=a("a"),Br=n("facebook/s2t-small-librispeech-asr"),Rr=n(" architecture."),Hr=c(),ht=a("p"),Vr=n("Configuration objects inherit from "),gn=a("a"),Jr=n("PretrainedConfig"),Kr=n(` and can be used to control the model outputs. Read the
documentation from `),Tn=a("a"),Yr=n("PretrainedConfig"),Xr=n(" for more information."),Qr=c(),hs=a("p"),Zr=n("Example:"),ei=c(),T(ao.$$.fragment),ia=c(),pt=a("h2"),St=a("a"),ps=a("span"),T(ro.$$.fragment),ti=c(),ms=a("span"),oi=n("Speech2TextTokenizer"),da=c(),B=a("div"),T(io.$$.fragment),ni=c(),fs=a("p"),si=n("Construct an Speech2Text tokenizer."),ai=c(),co=a("p"),ri=n("This tokenizer inherits from "),vn=a("a"),ii=n("PreTrainedTokenizer"),di=n(` which contains some of the main methods. Users should refer to
...
special tokens using the tokenizer `),_s=a("code"),ui=n("prepare_for_model"),_i=n(" method."),gi=c(),Re=a("div"),T(mo.$$.fragment),Ti=c(),kn=a("p"),vi=n("Create the token type IDs corresponding to the sequences passed. "),xn=a("a"),ki=n(`What are token type
...
should refer to this superclass for more information regarding those methods.`),Pi=c(),xs=a("p"),Ci=n(`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
...
single processor.`),Gi=c(),ge=a("p"),wn=a("a"),Wi=n("Speech2TextProcessor"),Ui=n(" offers all the functionalities of "),Sn=a("a"),Bi=n("Speech2TextFeatureExtractor"),Ri=n(` and
`),$n=a("a"),Hi=n("Speech2TextTokenizer"),Vi=n(". See the "),xo=a("a"),$s=a("strong"),Ji=n("call"),Ki=n("()"),Yi=n(" and "),En=a("a"),Xi=n("decode()"),Qi=n(` for more
...
information.`),ld=c(),He=a("div"),T(So.$$.fragment),hd=c(),qs=a("p"),pd=n("Instantiate a processor associated with a pretrained model."),md=c(),T(Pt.$$.fragment),fd=c(),Ve=a("div"),T($o.$$.fragment),ud=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
and behavior.`),Ud=c(),Te=a("div"),T(No.$$.fragment),Bd=c(),_t=a("p"),Rd=n("The "),Cn=a("a"),Hd=n("Speech2TextModel"),Vd=n(" forward method, overrides the "),Cs=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),T(Nt.$$.fragment),Xd=c(),Ms=a("p"),Qd=n("Example:"),Zd=c(),T(Lo.$$.fragment),ua=c(),gt=a("h2"),Lt=a("a"),As=a("span"),T(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),T(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mn=a("a"),sc=n("PreTrainedModel"),ac=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rc=c(),Uo=a("p"),ic=n("This model is also a PyTorch "),Bo=a("a"),dc=n("torch.nn.Module"),cc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),ve=a("div"),T(Ro.$$.fragment),hc=c(),Tt=a("p"),pc=n("The "),An=a("a"),mc=n("Speech2TextForConditionalGeneration"),fc=n(" forward method, overrides the "),Ds=a("code"),uc=n("__call__"),_c=n(" special method."),gc=c(),T(Ot.$$.fragment),Tc=c(),Ns=a("p"),vc=n("Example:"),kc=c(),T(Ho.$$.fragment),ga=c(),vt=a("h2"),Gt=a("a"),Ls=a("span"),T(Vo.$$.fragment),xc=c(),Os=a("span"),bc=n("TFSpeech2TextModel"),Ta=c(),me=a("div"),T(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
behavior.`),jc=c(),T(Wt.$$.fragment),Pc=c(),ke=a("div"),T(Qo.$$.fragment),Cc=c(),kt=a("p"),Mc=n("The "),Dn=a("a"),Ac=n("TFSpeech2TextModel"),Ic=n(" forward method, overrides the "),Gs=a("code"),Dc=n("__call__"),Nc=n(" special method."),Lc=c(),T(Ut.$$.fragment),Oc=c(),Ws=a("p"),Gc=n("Example:"),Wc=c(),T(Zo.$$.fragment),va=c(),xt=a("h2"),Bt=a("a"),Us=a("span"),T(en.$$.fragment),Uc=c(),Bs=a("span"),Bc=n("TFSpeech2TextForConditionalGeneration"),ka=c(),fe=a("div"),T(tn.$$.fragment),Rc=c(),on=a("p"),Hc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zc=c(),T(Rt.$$.fragment),el=c(),xe=a("div"),T(an.$$.fragment),tl=c(),bt=a("p"),ol=n("The "),Ln=a("a"),nl=n("TFSpeech2TextForConditionalGeneration"),sl=n(" forward method, overrides the "),Rs=a("code"),al=n("__call__"),rl=n(" special method."),il=c(),T(Ht.$$.fragment),dl=c(),Hs=a("p"),cl=n("Example:"),ll=c(),T(rn.$$.fragment),this.h()},l(o){const m=up('[data-svelte="svelte-1phssyn"]',document.head);h=r(m,"META",{name:!0,content:!0}),m.forEach(t),$=l(o),u=r(o,"H1",{class:!0});var dn=i(u);_=r(dn,"A",{id:!0,class:!0,href:!0});var Vs=i(_);S=r(Vs,"SPAN",{});var Js=i(S);v(g.$$.fragment,Js),Js.forEach(t),Vs.forEach(t),w=l(dn),E=r(dn,"SPAN",{});var Ks=i(E);A=s(Ks,"Speech2Text"),Ks.forEach(t),dn.forEach(t),q=l(o),z=r(o,"H2",{class:!0});var cn=i(z);N=r(cn,"A",{id:!0,class:!0,href:!0});var Ys=i(N);H=r(Ys,"SPAN",{});var Xs=i(H);v(ee.$$.fragment,Xs),Xs.forEach(t),Ys.forEach(t),Fe=l(cn),V=r(cn,"SPAN",{});var Qs=i(V);je=s(Qs,"Overview"),Qs.forEach(t),cn.forEach(t),$e=l(o),M=r(o,"P",{});var Je=i(M);J=s(Je,"The Speech2Text model was proposed in "),te=r(Je,"A",{href:!0,rel:!0});var ul=i(te);ye=s(ul,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),ul.forEach(t),P=s(Je,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
...
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
`),W=r(ya,"CODE",{});var wl=i(W);ce=s(wl,"generate()"),wl.forEach(t),rt=s(ya," method can be used for inference."),ya.forEach(t),Be=l(o),j=r(o,"P",{});var Ke=i(j);it=s(Ke,"The "),ze=r(Ke,"A",{href:!0});var Sl=i(ze);Le=s(Sl,"Speech2TextFeatureExtractor"),Sl.forEach(t),dt=s(Ke,` class is responsible for extracting the log-mel filter-bank
...
example shows how to transate English speech to French text using the `),ds=r(qe,"EM",{});var Bl=i(ds);Cr=s(Bl,"facebook/s2t-medium-mustc-multilingual-st"),Bl.forEach(t),Mr=s(qe,`
checkpoint.`),qe.forEach(t),wa.forEach(t),Nl.forEach(t),na=l(o),v(eo.$$.fragment,o),sa=l(o),yt=r(o,"P",{});var Sa=i(yt);Ar=s(Sa,"See the "),to=r(Sa,"A",{href:!0,rel:!0});var Rl=i(to);Ir=s(Rl,"model hub"),Rl.forEach(t),Dr=s(Sa," to look for Speech2Text checkpoints."),Sa.forEach(t),aa=l(o),ct=r(o,"H2",{class:!0});var $a=i(ct);wt=r($a,"A",{id:!0,class:!0,href:!0});var Hl=i(wt);cs=r(Hl,"SPAN",{});var Vl=i(cs);v(oo.$$.fragment,Vl),Vl.forEach(t),Hl.forEach(t),Nr=l($a),ls=r($a,"SPAN",{});var Jl=i(ls);Lr=s(Jl,"Speech2TextConfig"),Jl.forEach(t),$a.forEach(t),ra=l(o),he=r(o,"DIV",{class:!0});var Ye=i(he);v(no.$$.fragment,Ye),Or=l(Ye),lt=r(Ye,"P",{});var Gn=i(lt);Gr=s(Gn,"This is the configuration class to store the configuration of a "),_n=r(Gn,"A",{href:!0});var Kl=i(_n);Wr=s(Kl,"Speech2TextModel"),Kl.forEach(t),Ur=s(Gn,`. It is used to instantiate an
Speech2Text model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Speech2Text
`),so=r(Gn,"A",{href:!0,rel:!0});var Yl=i(so);Br=s(Yl,"facebook/s2t-small-librispeech-asr"),Yl.forEach(t),Rr=s(Gn," architecture."),Gn.forEach(t),Hr=l(Ye),ht=r(Ye,"P",{});var Wn=i(ht);Vr=s(Wn,"Configuration objects inherit from "),gn=r(Wn,"A",{href:!0});var Xl=i(gn);Jr=s(Xl,"PretrainedConfig"),Xl.forEach(t),Kr=s(Wn,` and can be used to control the model outputs. Read the
documentation from `),Tn=r(Wn,"A",{href:!0});var Ql=i(Tn);Yr=s(Ql,"PretrainedConfig"),Ql.forEach(t),Xr=s(Wn," for more information."),Wn.forEach(t),Qr=l(Ye),hs=r(Ye,"P",{});var Zl=i(hs);Zr=s(Zl,"Example:"),Zl.forEach(t),ei=l(Ye),v(ao.$$.fragment,Ye),Ye.forEach(t),ia=l(o),pt=r(o,"H2",{class:!0});var Ea=i(pt);St=r(Ea,"A",{id:!0,class:!0,href:!0});var eh=i(St);ps=r(eh,"SPAN",{});var th=i(ps);v(ro.$$.fragment,th),th.forEach(t),eh.forEach(t),ti=l(Ea),ms=r(Ea,"SPAN",{});var oh=i(ms);oi=s(oh,"Speech2TextTokenizer"),oh.forEach(t),Ea.forEach(t),da=l(o),B=r(o,"DIV",{class:!0});var be=i(B);v(io.$$.fragment,be),ni=l(be),fs=r(be,"P",{});var nh=i(fs);si=s(nh,"Construct an Speech2Text tokenizer."),nh.forEach(t),ai=l(be),co=r(be,"P",{});var za=i(co);ri=s(za,"This tokenizer inherits from "),vn=r(za,"A",{href:!0});var sh=i(vn);ii=s(sh,"PreTrainedTokenizer"),sh.forEach(t),di=s(za,` which contains some of the main methods. Users should refer to
...
special tokens using the tokenizer `),_s=r(ja,"CODE",{});var rh=i(_s);ui=s(rh,"prepare_for_model"),rh.forEach(t),_i=s(ja," method."),ja.forEach(t),Fa.forEach(t),gi=l(be),Re=r(be,"DIV",{class:!0});var Un=i(Re);v(mo.$$.fragment,Un),Ti=l(Un),kn=r(Un,"P",{});var hl=i(kn);vi=s(hl,"Create the token type IDs corresponding to the sequences passed. "),xn=r(hl,"A",{href:!0});var ih=i(xn);ki=s(ih,`What are token type
...
should refer to this superclass for more information regarding those methods.`),Ca.forEach(t),Pi=l(Xe),xs=r(Xe,"P",{});var uh=i(xs);Ci=s(uh,`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
mean and variance normalization to the extracted features.`),uh.forEach(t),Mi=l(Xe),qt=r(Xe,"DIV",{class:!0});var Ma=i(qt);v(To.$$.fragment,Ma),Ai=l(Ma),bs=r(Ma,"P",{});var _h=i(bs);Ii=s(_h,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),_h.forEach(t),Ma.forEach(t),Xe.forEach(t),ha=l(o),ft=r(o,"H2",{class:!0});var Aa=i(ft);Ft=r(Aa,"A",{id:!0,class:!0,href:!0});var gh=i(Ft);ys=r(gh,"SPAN",{});var Th=i(ys);v(vo.$$.fragment,Th),Th.forEach(t),gh.forEach(t),Di=l(Aa),ws=r(Aa,"SPAN",{});var vh=i(ws);Ni=s(vh,"Speech2TextProcessor"),vh.forEach(t),Aa.forEach(t),pa=l(o),I=r(o,"DIV",{class:!0});var R=i(I);v(ko.$$.fragment,R),Li=l(R),Ss=r(R,"P",{});var kh=i(Ss);Oi=s(kh,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
single processor.`),kh.forEach(t),Gi=l(R),ge=r(R,"P",{});var Ge=i(ge);wn=r(Ge,"A",{href:!0});var xh=i(wn);Wi=s(xh,"Speech2TextProcessor"),xh.forEach(t),Ui=s(Ge," offers all the functionalities of "),Sn=r(Ge,"A",{href:!0});var bh=i(Sn);Bi=s(bh,"Speech2TextFeatureExtractor"),bh.forEach(t),Ri=s(Ge,` and
`),$n=r(Ge,"A",{href:!0});var yh=i($n);Hi=s(yh,"Speech2TextTokenizer"),yh.forEach(t),Vi=s(Ge,". See the "),xo=r(Ge,"A",{href:!0});var pl=i(xo);$s=r(pl,"STRONG",{});var wh=i($s);Ji=s(wh,"call"),wh.forEach(t),Ki=s(pl,"()"),pl.forEach(t),Yi=s(Ge," and "),En=r(Ge,"A",{href:!0});var Sh=i(En);Xi=s(Sh,"decode()"),Sh.forEach(t),Qi=s(Ge,` for more
information.`),Ge.forEach(t),Zi=l(R),jt=r(R,"DIV",{class:!0});var Ia=i(jt);v(bo.$$.fragment,Ia),ed=l(Ia),Oe=r(Ia,"P",{});var Vt=i(Oe);td=s(Vt,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),Vt.forEach(t),Ia.forEach(t),ld=l(R),He=r(R,"DIV",{class:!0});var Bn=i(He);v(So.$$.fragment,Bn),hd=l(Bn),qs=r(Bn,"P",{});var qh=i(qs);pd=s(qh,"Instantiate a processor associated with a pretrained model."),qh.forEach(t),md=l(Bn),v(Pt.$$.fragment,Bn),Bn.forEach(t),fd=l(R),Ve=r(R,"DIV",{class:!0});var Rn=i(Ve);v($o.$$.fragment,Rn),ud=l(Rn),Eo=r(Rn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),qn=r(Da,"A",{href:!0});var Fh=i(qn);gd=s(Fh,"from_pretrained()"),Fh.forEach(t),Td=s(Da," method."),Da.forEach(t),vd=l(Rn),v(Ct.$$.fragment,Rn),Rn.forEach(t),kd=l(R),Mt=r(R,"DIV",{class:!0});var Na=i(Mt);v(zo.$$.fragment,Na),xd=l(Na),qo=r(Na,"P",{});var La=i(qo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var jh=i(Fn);yd=s(jh,"batch_decode()"),jh.forEach(t),wd=s(La,`. Please
refer to the docstring of this method for more information.`),La.forEach(t),Na.forEach(t),Sd=l(R),At=r(R,"DIV",{class:!0});var Oa=i(At);v(Fo.$$.fragment,Oa),$d=l(Oa),jo=r(Oa,"P",{});var Ga=i(jo);Ed=s(Ga,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),jn=r(Ga,"A",{href:!0});var Ph=i(jn);zd=s(Ph,"decode()"),Ph.forEach(t),qd=s(Ga,`. Please refer
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(R),It=r(R,"DIV",{class:!0});var Wa=i(It);v(Po.$$.fragment,Wa),jd=l(Wa),Fs=r(Wa,"P",{});var Ch=i(Fs);Pd=s(Ch,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),Ch.forEach(t),Wa.forEach(t),R.forEach(t),ma=l(o),ut=r(o,"H2",{class:!0});var Ua=i(ut);Dt=r(Ua,"A",{id:!0,class:!0,href:!0});var Mh=i(Dt);js=r(Mh,"SPAN",{});var Ah=i(js);v(Co.$$.fragment,Ah),Ah.forEach(t),Mh.forEach(t),Cd=l(Ua),Ps=r(Ua,"SPAN",{});var Ih=i(Ps);Md=s(Ih,"Speech2TextModel"),Ih.forEach(t),Ua.forEach(t),fa=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);v(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ba=i(Ao);Id=s(Ba,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Pn=r(Ba,"A",{href:!0});var Dh=i(Pn);Dd=s(Dh,"PreTrainedModel"),Dh.forEach(t),Nd=s(Ba,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ba.forEach(t),Ld=l(Jt),Io=r(Jt,"P",{});var Ra=i(Io);Od=s(Ra,"This model is also a PyTorch "),Do=r(Ra,"A",{href:!0,rel:!0});var Nh=i(Do);Gd=s(Nh,"torch.nn.Module"),Nh.forEach(t),Wd=s(Ra,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ra.forEach(t),Ud=l(Jt),Te=r(Jt,"DIV",{class:!0});var Qe=i(Te);v(No.$$.fragment,Qe),Bd=l(Qe),_t=r(Qe,"P",{});var Hn=i(_t);Rd=s(Hn,"The "),Cn=r(Hn,"A",{href:!0});var Lh=i(Cn);Hd=s(Lh,"Speech2TextModel"),Lh.forEach(t),Vd=s(Hn," forward method, overrides the "),Cs=r(Hn,"CODE",{});var Oh=i(Cs);Jd=s(Oh,"__call__"),Oh.forEach(t),Kd=s(Hn," special method."),Hn.forEach(t),Yd=l(Qe),v(Nt.$$.fragment,Qe),Xd=l(Qe),Ms=r(Qe,"P",{});var Gh=i(Ms);Qd=s(Gh,"Example:"),Gh.forEach(t),Zd=l(Qe),v(Lo.$$.fragment,Qe),Qe.forEach(t),Jt.forEach(t),ua=l(o),gt=r(o,"H2",{class:!0});var Ha=i(gt);Lt=r(Ha,"A",{id:!0,class:!0,href:!0});var Wh=i(Lt);As=r(Wh,"SPAN",{});var Uh=i(As);v(Oo.$$.fragment,Uh),Uh.forEach(t),Wh.forEach(t),ec=l(Ha),Is=r(Ha,"SPAN",{});var Bh=i(Is);tc=s(Bh,"Speech2TextForConditionalGeneration"),Bh.forEach(t),Ha.forEach(t),_a=l(o),Se=r(o,"DIV",{class:!0});var Kt=i(Se);v(Go.$$.fragment,Kt),oc=l(Kt),Wo=r(Kt,"P",{});var Va=i(Wo);nc=s(Va,`The Speech2Text Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mn=r(Va,"A",{href:!0});var Rh=i(Mn);sc=s(Rh,"PreTrainedModel"),Rh.forEach(t),ac=s(Va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Va.forEach(t),rc=l(Kt),Uo=r(Kt,"P",{});var Ja=i(Uo);ic=s(Ja,"This model is also a PyTorch "),Bo=r(Ja,"A",{href:!0,rel:!0});var Hh=i(Bo);dc=s(Hh,"torch.nn.Module"),Hh.forEach(t),cc=s(Ja,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ja.forEach(t),lc=l(Kt),ve=r(Kt,"DIV",{class:!0});var Ze=i(ve);v(Ro.$$.fragment,Ze),hc=l(Ze),Tt=r(Ze,"P",{});var Vn=i(Tt);pc=s(Vn,"The "),An=r(Vn,"A",{href:!0});var Vh=i(An);mc=s(Vh,"Speech2TextForConditionalGeneration"),Vh.forEach(t),fc=s(Vn," forward method, overrides the "),Ds=r(Vn,"CODE",{});var Jh=i(Ds);uc=s(Jh,"__call__"),Jh.forEach(t),_c=s(Vn," special method."),Vn.forEach(t),gc=l(Ze),v(Ot.$$.fragment,Ze),Tc=l(Ze),Ns=r(Ze,"P",{});var Kh=i(Ns);vc=s(Kh,"Example:"),Kh.forEach(t),kc=l(Ze),v(Ho.$$.fragment,Ze),Ze.forEach(t),Kt.forEach(t),ga=l(o),vt=r(o,"H2",{class:!0});var Ka=i(vt);Gt=r(Ka,"A",{id:!0,class:!0,href:!0});var Yh=i(Gt);Ls=r(Yh,"SPAN",{});var Xh=i(Ls);v(Vo.$$.fragment,Xh),Xh.forEach(t),Yh.forEach(t),xc=l(Ka),Os=r(Ka,"SPAN",{});var Qh=i(Os);bc=s(Qh,"TFSpeech2TextModel"),Qh.forEach(t),Ka.forEach(t),Ta=l(o),me=r(o,"DIV",{class:!0});var et=i(me);v(Jo.$$.fragment,et),yc=l(et),Ko=r(et,"P",{});var Ya=i(Ko);wc=s(Ya,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xa.forEach(t),jc=l(et),v(Wt.$$.fragment,et),Pc=l(et),ke=r(et,"DIV",{class:!0});var tt=i(ke);v(Qo.$$.fragment,tt),Cc=l(tt),kt=r(tt,"P",{});var Jn=i(kt);Mc=s(Jn,"The "),Dn=r(Jn,"A",{href:!0});var tp=i(Dn);Ac=s(tp,"TFSpeech2TextModel"),tp.forEach(t),Ic=s(Jn," forward method, overrides the "),Gs=r(Jn,"CODE",{});var op=i(Gs);Dc=s(op,"__call__"),op.forEach(t),Nc=s(Jn," special method."),Jn.forEach(t),Lc=l(tt),v(Ut.$$.fragment,tt),Oc=l(tt),Ws=r(tt,"P",{});var np=i(Ws);Gc=s(np,"Example:"),np.forEach(t),Wc=l(tt),v(Zo.$$.fragment,tt),tt.forEach(t),et.forEach(t),va=l(o),xt=r(o,"H2",{class:!0});var Qa=i(xt);Bt=r(Qa,"A",{id:!0,class:!0,href:!0});var sp=i(Bt);Us=r(sp,"SPAN",{});var ap=i(Us);v(en.$$.fragment,ap),ap.forEach(t),sp.forEach(t),Uc=l(Qa),Bs=r(Qa,"SPAN",{});var rp=i(Bs);Bc=s(rp,"TFSpeech2TextForConditionalGeneration"),rp.forEach(t),Qa.forEach(t),ka=l(o),fe=r(o,"DIV",{class:!0});var ot=i(fe);v(tn.$$.fragment,ot),Rc=l(ot),on=r(ot,"P",{});var Za=i(on);Hc=s(Za,`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),er.forEach(t),Zc=l(ot),v(Rt.$$.fragment,ot),el=l(ot),xe=r(ot,"DIV",{class:!0});var nt=i(xe);v(an.$$.fragment,nt),tl=l(nt),bt=r(nt,"P",{});var Kn=i(bt);ol=s(Kn,"The "),Ln=r(Kn,"A",{href:!0});var cp=i(Ln);nl=s(cp,"TFSpeech2TextForConditionalGeneration"),cp.forEach(t),sl=s(Kn," forward method, overrides the "),Rs=r(Kn,"CODE",{});var lp=i(Rs);al=s(lp,"__call__"),lp.forEach(t),rl=s(Kn," special method."),Kn.forEach(t),il=l(nt),v(Ht.$$.fragment,nt),dl=l(nt),Hs=r(nt,"P",{});var hp=i(Hs);cl=s(hp,"Example:"),hp.forEach(t),ll=l(nt),v(rn.$$.fragment,nt),nt.forEach(t),ot.forEach(t),this.h()},h(){d(h,"name","hf:doc:metadata"),d(h,"content",JSON.stringify(Sp)),d(_,"id","speech2text"),d(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(_,"href","#speech2text"),d(u,"class","relative group"),d(N,"id","overview"),d(N,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(N,"href","#overview"),d(z,"class","relative group"),d(te,"href","https://arxiv.org/abs/2010.05171"),d(te,"rel","nofollow"),d(C,"href","http://www.openslr.org/12"),d(C,"rel","nofollow"),d(ne,"href","https://github.com/facebookresearch/covost"),d(ne,"rel","nofollow"),d(ae,"href","https://ict.fbk.eu/must-c/"),d(ae,"rel","nofollow"),d(re,"href","https://huggingface.co/valhalla"),d(re,"rel","nofollow"),d(de,"href","https://github.com/pytorch/fairseq/tree/master/examples/speech_to_text"),d(de,"rel","nofollow"),d(f,"id","inference"),d(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(f,"href","#inference"),d(Y,"class","relative group"),d(ze,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor"),d(hn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextProcessor"),d(pn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor"),d(mn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer"),d(Xt,"href","http://www.mega-nerd.com/libsndfile/"),d(Xt,"rel","nofollow"),d(to,"href","https://huggingface.co/models?filter=speech_to_text"),d(to,"rel","nofollow"),d(wt,"id","transformers.Speech2TextConfig"),d(wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(wt,"href","#transformers.Speech2TextConfig"),d(ct,"class","relative group"),d(_n,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextModel"),d(so,"href","https://huggingface.co/facebook/s2t-small-librispeech-asr"),d(so,"rel","nofollow"),d(gn,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),d(Tn,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),d(he,"class","docstring"),d(St,"id","transformers.Speech2TextTokenizer"),d(St,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(St,"href","#transformers.Speech2TextTokenizer"),d(pt,"class","relative group"),d(vn,"href","/docs/transformers/master/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d($t,"class","docstring"),d(Et,"class","docstring"),d(xn,"href","../glossary#token-type-ids"),d(Re,"class","docstring"),d(bn,"class","docstring"),d(B,"class","docstring"),d(zt,"id","transformers.Speech2TextFeatureExtractor"),d(zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(zt,"href","#transformers.Speech2TextFeatureExtractor"),d(mt,"class","relative group"),d(yn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor"),d(qt,"class","docstring"),d(pe,"class","docstring"),d(Ft,"id","transformers.Speech2TextProcessor"),d(Ft,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ft,"href","#transformers.Speech2TextProcessor"),d(ft,"class","relative group"),d(wn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextProcessor"),d(Sn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor"),d($n,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer"),d(xo,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextProcessor.__call__"),d(En,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextProcessor.decode"),d(yo,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor.__call__"),d(zn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextProcessor.as_target_processor"),d(wo,"href","/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"),d(jt,"class","docstring"),d(He,"class","docstring"),d(qn,"href","/docs/transformers/master/en/main_classes/processors#transformers.ProcessorMixin.from_pretrained"),d(Ve,"class","docstring"),d(Fn,"href","/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode"),d(Mt,"class","docstring"),d(jn,"href","/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode"),d(At,"class","docstring"),d(It,"class","docstring"),d(I,"class","docstring"),d(Dt,"id","transformers.Speech2TextModel"),d(Dt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Dt,"href","#transformers.Speech2TextModel"),d(ut,"class","relative group"),d(Pn,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),d(Do,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Do,"rel","nofollow"),d(Cn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextModel"),d(Te,"class","docstring"),d(we,"class","docstring"),d(Lt,"id","transformers.Speech2TextForConditionalGeneration"),d(Lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Lt,"href","#transformers.Speech2TextForConditionalGeneration"),d(gt,"class","relative group"),d(Mn,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),d(Bo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Bo,"rel","nofollow"),d(An,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextForConditionalGeneration"),d(ve,"class","docstring"),d(Se,"class","docstring"),d(Gt,"id","transformers.TFSpeech2TextModel"),d(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Gt,"href","#transformers.TFSpeech2TextModel"),d(vt,"class","relative group"),d(In,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),d(Xo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),d(Xo,"rel","nofollow"),d(Dn,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.TFSpeech2TextModel"),d(ke,"class","docstring"),d(me,"class","docstring"),d(Bt,"id","transformers.TFSpeech2TextForConditionalGeneration"),d(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Bt,"href","#transformers.TFSpeech2TextForConditionalGeneration"),d(xt,"class","relative group"),d(Nn,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),d(sn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),d(sn,"rel","nofollow"),d(Ln,"href","/docs/transformers/master/en/model_doc/speech_to_text#transformers.TFSpeech2TextForConditionalGeneration"),d(xe,"class","docstring"),d(fe,"class","docstring")},m(o,m){e(document.head,h),p(o,$,m),p(o,u,m),e(u,_),e(_,S),k(g,S,null),e(u,w),e(u,E),e(E,A),p(o,q,m),p(o,z,m),e(z,N),e(N,H),k(ee,H,null),e(z,Fe),e(z,V),e(V,je),p(o,$e,m),p(o,M,m),e(M,J),e(M,te),e(te,ye),e(M,P),e(M,C),e(C,Pe),e(M,oe),e(M,ne),e(ne,Ce),e(M,se),e(M,ae),e(ae,Me),e(M,O),p(o,Ee,m),p(o,L,m),e(L,Ae),e(L,re),e(re,ie),e(L,Ie),e(L,de),e(de,K),e(L,De),p(o,Z,m),p(o,Y,m),e(Y,f),e(f,F),k(X,F,null),e(Y,st),e(Y,Ne),e(Ne,Q),p(o,Ue,m),p(o,_e,m),e(_e,at),e(_e,W),e(W,ce),e(_e,rt),p(o,Be,m),p(o,j,m),e(j,it),e(j,ze),e(ze,Le),e(j,dt),e(j,hn),e(hn,tr),e(j,or),e(j,pn),e(pn,nr),e(j,sr),e(j,mn),e(mn,ar),e(j,rr),p(o,Zs,m),p(o,U,m),e(U,ir),e(U,Yn),e(Yn,dr),e(U,cr),e(U,Xn),e(Xn,lr),e(U,hr),e(U,Qn),e(Qn,pr),e(U,mr),e(U,Zn),e(Zn,fr),e(U,ur),e(U,es),e(es,_r),e(U,gr),e(U,Xt),e(Xt,Tr),e(U,vr),e(U,ts),e(ts,kr),p(o,ea,m),p(o,fn,m),e(fn,os),e(os,xr),p(o,ta,m),k(Qt,o,m),p(o,oa,m),p(o,un,m),e(un,Zt),e(Zt,ns),e(ns,br),e(Zt,yr),e(Zt,le),e(le,wr),e(le,ss),e(ss,Sr),e(le,$r),e(le,as),e(as,Er),e(le,zr),e(le,rs),e(rs,qr),e(le,Fr),e(le,is),e(is,jr),e(le,Pr),e(le,ds),e(ds,Cr),e(le,Mr),p(o,na,m),k(eo,o,m),p(o,sa,m),p(o,yt,m),e(yt,Ar),e(yt,to),e(to,Ir),e(yt,Dr),p(o,aa,m),p(o,ct,m),e(ct,wt),e(wt,cs),k(oo,cs,null),e(ct,Nr),e(ct,ls),e(ls,Lr),p(o,ra,m),p(o,he,m),k(no,he,null),e(he,Or),e(he,lt),e(lt,Gr),e(lt,_n),e(_n,Wr),e(lt,Ur),e(lt,so),e(so,Br),e(lt,Rr),e(he,Hr),e(he,ht),e(ht,Vr),e(ht,gn),e(gn,Jr),e(ht,Kr),e(ht,Tn),e(Tn,Yr),e(ht,Xr),e(he,Qr),e(he,hs),e(hs,Zr),e(he,ei),k(ao,he,null),p(o,ia,m),p(o,pt,m),e(pt,St),e(St,ps),k(ro,ps,null),e(pt,ti),e(pt,ms),e(ms,oi),p(o,da,m),p(o,B,m),k(io,B,null),e(B,ni),e(B,fs),e(fs,si),e(B,ai),e(B,co),e(co,ri),e(co,vn),e(vn,ii),e(co,di),e(B,ci),e(B,$t),k(lo,$t,null),e($t,li),e($t,us),e(us,hi),e(B,pi),e(B,Et),k(ho,Et,null),e(Et,mi),e(Et,po),e(po,fi),e(po,_s),e(_s,ui),e(po,_i),e(B,gi),e(B,Re),k(mo,Re,null),e(Re,Ti),e(Re,kn),e(kn,vi),e(kn,xn),e(xn,ki),e(Re,xi),e(Re,gs),e(gs,bi),e(B,yi),e(B,bn),k(fo,bn,null),p(o,ca,m),p(o,mt,m),e(mt,zt),e(zt,Ts),k(uo,Ts,null),e(mt,wi),e(mt,vs),e(vs,Si),p(o,la,m),p(o,pe,m),k(_o,pe,null),e(pe,$i),e(pe,ks),e(ks,Ei),e(pe,zi),e(pe,go),e(go,qi),e(go,yn),e(yn,Fi),e(go,ji),e(pe,Pi),e(pe,xs),e(xs,Ci),e(pe,Mi),e(pe,qt),k(To,qt,null),e(qt,Ai),e(qt,bs),e(bs,Ii),p(o,ha,m),p(o,ft,m),e(ft,Ft),e(Ft,ys),k(vo,ys,null),e(ft,Di),e(ft,ws),e(ws,Ni),p(o,pa,m),p(o,I,m),k(ko,I,null),e(I,Li),e(I,Ss),e(Ss,Oi),e(I,Gi),e(I,ge),e(ge,wn),e(wn,Wi),e(ge,Ui),e(ge,Sn),e(Sn,Bi),e(ge,Ri),e(ge,$n),e($n,Hi),e(ge,Vi),e(ge,xo),e(xo,$s),e($s,Ji),e(xo,Ki),e(ge,Yi),e(ge,En),e(En,Xi),e(ge,Qi),e(I,Zi),e(I,jt),k(bo,jt,null),e(jt,ed),e(jt,Oe),e(Oe,td),e(Oe,yo),e(yo,Es),e(Es,od),e(yo,nd),e(Oe,sd),e(Oe,zn),e(zn,ad),e(Oe,rd),e(Oe,wo),e(wo,zs),e(zs,id),e(wo,dd),e(Oe,cd),e(I,ld),e(I,He),k(So,He,null),e(He,hd),e(He,qs),e(qs,pd),e(He,md),k(Pt,He,null),e(I,fd),e(I,Ve),k($o,Ve,null),e(Ve,ud),e(Ve,Eo),e(Eo,_d),e(Eo,qn),e(qn,gd),e(Eo,Td),e(Ve,vd),k(Ct,Ve,null),e(I,kd),e(I,Mt),k(zo,Mt,null),e(Mt,xd),e(Mt,qo),e(qo,bd),e(qo,Fn),e(Fn,yd),e(qo,wd),e(I,Sd),e(I,At),k(Fo,At,null),e(At,$d),e(At,jo),e(jo,Ed),e(jo,jn),e(jn,zd),e(jo,qd),e(I,Fd),e(I,It),k(Po,It,null),e(It,jd),e(It,Fs),e(Fs,Pd),p(o,ma,m),p(o,ut,m),e(ut,Dt),e(Dt,js),k(Co,js,null),e(ut,Cd),e(ut,Ps),e(Ps,Md),p(o,fa,m),p(o,we,m),k(Mo,we,null),e(we,Ad),e(we,Ao),e(Ao,Id),e(Ao,Pn),e(Pn,Dd),e(Ao,Nd),e(we,Ld),e(we,Io),e(Io,Od),e(Io,Do),e(Do,Gd),e(Io,Wd),e(we,Ud),e(we,Te),k(No,Te,null),e(Te,Bd),e(Te,_t),e(_t,Rd),e(_t,Cn),e(Cn,Hd),e(_t,Vd),e(_t,Cs),e(Cs,Jd),e(_t,Kd),e(Te,Yd),k(Nt,Te,null),e(Te,Xd),e(Te,Ms),e(Ms,Qd),e(Te,Zd),k(Lo,Te,null),p(o,ua,m),p(o,gt,m),e(gt,Lt),e(Lt,As),k(Oo,As,null),e(gt,ec),e(gt,Is),e(Is,tc),p(o,_a,m),p(o,Se,m),k(Go,Se,null),e(Se,oc),e(Se,Wo),e(Wo,nc),e(Wo,Mn),e(Mn,sc),e(Wo,ac),e(Se,rc),e(Se,Uo),e(Uo,ic),e(Uo,Bo),e(Bo,dc),e(Uo,cc),e(Se,lc),e(Se,ve),k(Ro,ve,null),e(ve,hc),e(ve,Tt),e(Tt,pc),e(Tt,An),e(An,mc),e(Tt,fc),e(Tt,Ds),e(Ds,uc),e(Tt,_c),e(ve,gc),k(Ot,ve,null),e(ve,Tc),e(ve,Ns),e(Ns,vc),e(ve,kc),k(Ho,ve,null),p(o,ga,m),p(o,vt,m),e(vt,Gt),e(Gt,Ls),k(Vo,Ls,null),e(vt,xc),e(vt,Os),e(Os,bc),p(o,Ta,m),p(o,me,m),k(Jo,me,null),e(me,yc),e(me,Ko),e(Ko,wc),e(Ko,In),e(In,Sc),e(Ko,$c),e(me,Ec),e(me,Yo),e(Yo,zc),e(Yo,Xo),e(Xo,qc),e(Yo,Fc),e(me,jc),k(Wt,me,null),e(me,Pc),e(me,ke),k(Qo,ke,null),e(ke,Cc),e(ke,kt),e(kt,Mc),e(kt,Dn),e(Dn,Ac),e(kt,Ic),e(kt,Gs),e(Gs,Dc),e(kt,Nc),e(ke,Lc),k(Ut,ke,null),e(ke,Oc),e(ke,Ws),e(Ws,Gc),e(ke,Wc),k(Zo,ke,null),p(o,va,m),p(o,xt,m),e(xt,Bt),e(Bt,Us),k(en,Us,null),e(xt,Uc),e(xt,Bs),e(Bs,Bc),p(o,ka,m),p(o,fe,m),k(tn,fe,null),e(fe,Rc),e(fe,on),e(on,Hc),e(on,Nn),e(Nn,Vc),e(on,Jc),e(fe,Kc),e(fe,nn),e(nn,Yc),e(nn,sn),e(sn,Xc),e(nn,Qc),e(fe,Zc),k(Rt,fe,null),e(fe,el),e(fe,xe),k(an,xe,null),e(xe,tl),e(xe,bt),e(bt,ol),e(bt,Ln),e(Ln,nl),e(bt,sl),e(bt,Rs),e(Rs,al),e(bt,rl),e(xe,il),k(Ht,xe,null),e(xe,dl),e(xe,Hs),e(Hs,cl),e(xe,ll),k(rn,xe,null),xa=!0},p(o,[m]){const dn={};m&2&&(dn.$$scope={dirty:m,ctx:o}),Pt.$set(dn);const Vs={};m&2&&(Vs.$$scope={dirty:m,ctx:o}),Ct.$set(Vs);const Js={};m&2&&(Js.$$scope={dirty:m,ctx:o}),Nt.$set(Js);const Ks={};m&2&&(Ks.$$scope={dirty:m,ctx:o}),Ot.$set(Ks);const cn={};m&2&&(cn.$$scope={dirty:m,ctx:o}),Wt.$set(cn);const Ys={};m&2&&(Ys.$$scope={dirty:m,ctx:o}),Ut.$set(Ys);const Xs={};m&2&&(Xs.$$scope={dirty:m,ctx:o}),Rt.$set(Xs);const Qs={};m&2&&(Qs.$$scope={dirty:m,ctx:o}),Ht.$set(Qs)},i(o){xa||(x(g.$$.fragment,o),x(ee.$$.fragment,o),x(X.$$.fragment,o),x(Qt.$$.fragment,o),x(eo.$$.fragment,o),x(oo.$$.fragment,o),x(no.$$.fragment,o),x(ao.$$.fragment,o),x(ro.$$.fragment,o),x(io.$$.fragment,o),x(lo.$$.fragment,o),x(ho.$$.fragment,o),x(mo.$$.fragment,o),x(fo.$$.fragment,o),x(uo.$$.fragment,o),x(_o.$$.fragment,o),x(To.$$.fragment,o),x(vo.$$.fragment,o),x(ko.$$.fragment,o),x(bo.$$.fragment,o),x(So.$$.fragment,o),x(Pt.$$.fragment,o),x($o.$$.fragment,o),x(Ct.$$.fragment,o),x(zo.$$.fragment,o),x(Fo.$$.fragment,o),x(Po.$$.fragment,o),x(Co.$$.fragment,o),x(Mo.$$.fragment,o),x(No.$$.fragment,o),x(Nt.$$.fragment,o),x(Lo.$$.fragment,o),x(Oo.$$.fragment,o),x(Go.$$.fragment,o),x(Ro.$$.fragment,o),x(Ot.$$.fragment,o),x(Ho.$$.fragment,o),x(Vo.$$.fragment,o),x(Jo.$$.fragment,o),x(Wt.$$.fragment,o),x(Qo.$$.fragment,o),x(Ut.$$.fragment,o),x(Zo.$$.fragment,o),x(en.$$.fragment,o),x(tn.$$.fragment,o),x(Rt.$$.fragment,o),x(an.$$.fragment,o),x(Ht.$$.fragment,o),x(rn.$$.fragment,o),xa=!0)},o(o){b(g.$$.fragment,o),b(ee.$$.fragment,o),b(X.$$.fragment,o),b(Qt.$$.fragment,o),b(eo.$$.fragment,o),b(oo.$$.fragment,o),b(no.$$.fragment,o),b(ao.$$.fragment,o),b(ro.$$.fragment,o),b(io.$$.fragment,o),b(lo.$$.fragment,o),b(ho.$$.fragment,o),b(mo.$$.fragment,o),b(fo.$$.fragment,o),b(uo.$$.fragment,o),b(_o.$$.fragment,o),b(To.$$.fragment,o),b(vo.$$.fragment,o),b(ko.$$.fragment,o),b(bo.$$.fragment,o),b(So.$$.fragment,o),b(Pt.$$.fragment,o),b($o.$$.fragment,o),b(Ct.$$.fragment,o),b(zo.$$.fragment,o),b(Fo.$$.fragment,o),b(Po.$$.fragment,o),b(Co.$$.fragment,o),b(Mo.$$.fragment,o),b(No.$$.fragment,o),b(Nt.$$.fragment,o),b(Lo.$$.fragment,o),b(Oo.$$.fragment,o),b(Go.$$.fragment,o),b(Ro.$$.fragment,o),b(Ot.$$.fragment,o),b(Ho.$$.fragment,o),b(Vo.$$.fragment,o),b(Jo.$$.fragment,o),b(Wt.$$.fragment,o),b(Qo.$$.fragment,o),b(Ut.$$.fragment,o),b(Zo.$$.fragment,o),b(en.$$.fragment,o),b(tn.$$.fragment,o),b(Rt.$$.fragment,o),b(an.$$.fragment,o),b(Ht.$$.fragment,o),b(rn.$$.fragment,o),xa=!1},d(o){t(h),o&&t($),o&&t(u),y(g),o&&t(q),o&&t(z),y(ee),o&&t($e),o&&t(M),o&&t(Ee),o&&t(L),o&&t(Z),o&&t(Y),y(X),o&&t(Ue),o&&t(_e),o&&t(Be),o&&t(j),o&&t(Zs),o&&t(U),o&&t(ea),o&&t(fn),o&&t(ta),y(Qt,o),o&&t(oa),o&&t(un),o&&t(na),y(eo,o),o&&t(sa),o&&t(yt),o&&t(aa),o&&t(ct),y(oo),o&&t(ra),o&&t(he),y(no),y(ao),o&&t(ia),o&&t(pt),y(ro),o&&t(da),o&&t(B),y(io),y(lo),y(ho),y(mo),y(fo),o&&t(ca),o&&t(mt),y(uo),o&&t(la),o&&t(pe),y(_o),y(To),o&&t(ha),o&&t(ft),y(vo),o&&t(pa),o&&t(I),y(ko),y(bo),y(So),y(Pt),y($o),y(Ct),y(zo),y(Fo),y(Po),o&&t(ma),o&&t(ut),y(Co),o&&t(fa),o&&t(we),y(Mo),y(No),y(Nt),y(Lo),o&&t(ua),o&&t(gt),y(Oo),o&&t(_a),o&&t(Se),y(Go),y(Ro),y(Ot),y(Ho),o&&t(ga),o&&t(vt),y(Vo),o&&t(Ta),o&&t(me),y(Jo),y(Wt),y(Qo),y(Ut),y(Zo),o&&t(va),o&&t(xt),y(en),o&&t(ka),o&&t(fe),y(tn),y(Rt),y(an),y(Ht),y(rn)}}}const Sp={local:"speech2text",sections:[{local:"overview",title:"Overview"},{local:"inference",title:"Inference"},{local:"transformers.Speech2TextConfig",title:"Speech2TextConfig"},{local:"transformers.Speech2TextTokenizer",title:"Speech2TextTokenizer"},{local:"transformers.Speech2TextFeatureExtractor",title:"Speech2TextFeatureExtractor"},{local:"transformers.Speech2TextProcessor",title:"Speech2TextProcessor"},{local:"transformers.Speech2TextModel",title:"Speech2TextModel"},{local:"transformers.Speech2TextForConditionalGeneration",title:"Speech2TextForConditionalGeneration"},{local:"transformers.TFSpeech2TextModel",title:"TFSpeech2TextModel"},{local:"transformers.TFSpeech2TextForConditionalGeneration",title:"TFSpeech2TextForConditionalGeneration"}],title:"Speech2Text"};function $p(G,h,$){let{fw:u}=h;return G.$$set=_=>{"fw"in _&&$(0,u=_.fw)},[u]}class Cp extends pp{constructor(h){super();mp(this,h,$p,wp,fp,{fw:0})}}export{Cp as default,Sp as metadata};
