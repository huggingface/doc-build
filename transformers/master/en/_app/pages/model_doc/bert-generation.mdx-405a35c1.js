import{S as la,i as ca,s as ha,e as s,k as l,w as b,t as n,L as pa,c as a,d as o,m as c,a as i,x as v,h as r,b as d,J as e,g as p,y as k,q as T,o as w,B as y}from"../../chunks/vendor-9e2b328e.js";import{T as da}from"../../chunks/Tip-76f97a76.js";import{D as gt}from"../../chunks/Docstring-50fd6873.js";import{C as Vt}from"../../chunks/CodeBlock-88e23343.js";import{I as _t}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function ua(ie){let u,q,m,g,C;return{c(){u=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=n("Module"),C=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){u=a(_,"P",{});var E=i(u);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(E,"CODE",{});var S=i(m);g=r(S,"Module"),S.forEach(o),C=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(_,E){p(_,u,E),e(u,q),e(u,m),e(m,g),e(u,C)},d(_){_&&o(u)}}}function ma(ie){let u,q,m,g,C;return{c(){u=s("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=n("Module"),C=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){u=a(_,"P",{});var E=i(u);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(E,"CODE",{});var S=i(m);g=r(S,"Module"),S.forEach(o),C=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(o)},m(_,E){p(_,u,E),e(u,q),e(u,m),e(m,g),e(u,C)},d(_){_&&o(u)}}}function fa(ie){let u,q,m,g,C,_,E,S,Co,Jt,R,Y,bt,de,Do,vt,So,Kt,A,Ao,Ue,Mo,No,le,Lo,Fo,Qt,He,Oo,Xt,Ve,kt,Io,Yt,Je,Ro,Zt,Ke,ce,Wo,Qe,Uo,Ho,eo,he,to,Xe,pe,Vo,Ye,Jo,Ko,oo,ue,no,Ze,Qo,ro,Z,M,et,Xo,Yo,tt,Zo,en,Tt,tn,on,nn,wt,rn,so,N,sn,me,an,dn,fe,ln,cn,ao,W,ee,yt,ge,hn,Et,pn,io,$,_e,un,be,mn,Bt,fn,gn,_n,U,bn,ot,vn,kn,nt,Tn,wn,yn,zt,En,Bn,ve,lo,H,te,$t,ke,zn,Gt,$n,co,D,Te,Gn,we,qn,ye,Pn,jn,xn,Ee,Cn,rt,Dn,Sn,An,qt,ho,V,oe,Pt,Be,Mn,jt,Nn,po,f,ze,Ln,xt,Fn,On,$e,In,st,Rn,Wn,Un,Ge,Hn,qe,Vn,Jn,Kn,Pe,Qn,je,Xn,Yn,Zn,J,er,at,tr,or,xe,nr,rr,sr,B,ar,Ct,ir,dr,Dt,lr,cr,St,hr,pr,At,ur,mr,Mt,fr,gr,Nt,_r,br,vr,P,Ce,kr,K,Tr,it,wr,yr,Lt,Er,Br,zr,ne,$r,Ft,Gr,qr,De,uo,Q,re,Ot,Se,Pr,It,jr,mo,G,Ae,xr,Me,Cr,Rt,Dr,Sr,Ar,Ne,Mr,dt,Nr,Lr,Fr,Le,Or,Fe,Ir,Rr,Wr,j,Oe,Ur,X,Hr,lt,Vr,Jr,Wt,Kr,Qr,Xr,se,Yr,Ut,Zr,es,Ie,fo;return _=new _t({}),de=new _t({}),he=new Vt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ce=new gt({props:{name:"forward",anchor:"transformers.BertGenerationEncoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",parametersDescription:[{anchor:"transformers.BertGenerationEncoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),se=new da({props:{$$slots:{default:[ma]},$$scope:{ctx:ie}}}),Ie=new Vt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationDecoder, BertGenerationConfig
import torch
...
Therefore, no EOS token should be added to the end of the input.`),so=l(),N=s("p"),sn=n("This model was contributed by "),me=s("a"),an=n("patrickvonplaten"),dn=n(`. The original code can be
found `),fe=s("a"),ln=n("here"),cn=n("."),ao=l(),W=s("h2"),ee=s("a"),yt=s("span"),b(ge.$$.fragment),hn=l(),Et=s("span"),pn=n("BertGenerationConfig"),io=l(),$=s("div"),b(_e.$$.fragment),un=l(),be=s("p"),mn=n("This is the configuration class to store the configuration of a "),Bt=s("code"),fn=n("BertGenerationPreTrainedModel"),gn=n(` It is used to
...
`),At=s("code"),ur=n("add_cross_attention"),mr=n(" set to "),Mt=s("code"),fr=n("True"),gr=n("; an "),Nt=s("code"),_r=n("encoder_hidden_states"),br=n(" is then expected as an input to the forward pass."),vr=l(),P=s("div"),b(Ce.$$.fragment),kr=l(),K=s("p"),Tr=n("The "),it=s("a"),wr=n("BertGenerationEncoder"),yr=n(" forward method, overrides the "),Lt=s("code"),Er=n("__call__"),Br=n(" special method."),zr=l(),b(ne.$$.fragment),$r=l(),Ft=s("p"),Gr=n("Example:"),qr=l(),b(De.$$.fragment),uo=l(),Q=s("h2"),re=s("a"),Ot=s("span"),b(Se.$$.fragment),Pr=l(),It=s("span"),jr=n("BertGenerationDecoder"),mo=l(),G=s("div"),b(Ae.$$.fragment),xr=l(),Me=s("p"),Cr=n("BertGeneration Model with a "),Rt=s("code"),Dr=n("language modeling"),Sr=n(" head on top for CLM fine-tuning."),Ar=l(),Ne=s("p"),Mr=n("This model inherits from "),dt=s("a"),Nr=n("PreTrainedModel"),Lr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fr=l(),Le=s("p"),Or=n("This model is also a PyTorch "),Fe=s("a"),Ir=n("torch.nn.Module"),Rr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wr=l(),j=s("div"),b(Oe.$$.fragment),Ur=l(),X=s("p"),Hr=n("The "),lt=s("a"),Vr=n("BertGenerationDecoder"),Jr=n(" forward method, overrides the "),Wt=s("code"),Kr=n("__call__"),Qr=n(" special method."),Xr=l(),b(se.$$.fragment),Yr=l(),Ut=s("p"),Zr=n("Example:"),es=l(),b(Ie.$$.fragment),this.h()},l(t){const h=pa('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(o),q=c(t),m=a(t,"H1",{class:!0});var Re=i(m);g=a(Re,"A",{id:!0,class:!0,href:!0});var Ht=i(g);C=a(Ht,"SPAN",{});var ts=i(C);v(_.$$.fragment,ts),ts.forEach(o),Ht.forEach(o),E=c(Re),S=a(Re,"SPAN",{});var os=i(S);Co=r(os,"BertGeneration"),os.forEach(o),Re.forEach(o),Jt=c(t),R=a(t,"H2",{class:!0});var go=i(R);Y=a(go,"A",{id:!0,class:!0,href:!0});var ns=i(Y);bt=a(ns,"SPAN",{});var rs=i(bt);v(de.$$.fragment,rs),rs.forEach(o),ns.forEach(o),Do=c(go),vt=a(go,"SPAN",{});var ss=i(vt);So=r(ss,"Overview"),ss.forEach(o),go.forEach(o),Kt=c(t),A=a(t,"P",{});var ct=i(A);Ao=r(ct,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
Therefore, no EOS token should be added to the end of the input.`),ks.forEach(o),vo.forEach(o),so=c(t),N=a(t,"P",{});var ht=i(N);sn=r(ht,"This model was contributed by "),me=a(ht,"A",{href:!0,rel:!0});var Ts=i(me);an=r(Ts,"patrickvonplaten"),Ts.forEach(o),dn=r(ht,`. The original code can be
found `),fe=a(ht,"A",{href:!0,rel:!0});var ws=i(fe);ln=r(ws,"here"),ws.forEach(o),cn=r(ht,"."),ht.forEach(o),ao=c(t),W=a(t,"H2",{class:!0});var ko=i(W);ee=a(ko,"A",{id:!0,class:!0,href:!0});var ys=i(ee);yt=a(ys,"SPAN",{});var Es=i(yt);v(ge.$$.fragment,Es),Es.forEach(o),ys.forEach(o),hn=c(ko),Et=a(ko,"SPAN",{});var Bs=i(Et);pn=r(Bs,"BertGenerationConfig"),Bs.forEach(o),ko.forEach(o),io=c(t),$=a(t,"DIV",{class:!0});var L=i($);v(_e.$$.fragment,L),un=c(L),be=a(L,"P",{});var To=i(be);mn=r(To,"This is the configuration class to store the configuration of a "),Bt=a(To,"CODE",{});var zs=i(Bt);fn=r(zs,"BertGenerationPreTrainedModel"),zs.forEach(o),gn=r(To,` It is used to
...
this superclass for more information regarding those methods.`),Eo.forEach(o),An=c(ae),qt=a(ae,"DIV",{class:!0}),i(qt).forEach(o),ae.forEach(o),ho=c(t),V=a(t,"H2",{class:!0});var Bo=i(V);oe=a(Bo,"A",{id:!0,class:!0,href:!0});var Ss=i(oe);Pt=a(Ss,"SPAN",{});var As=i(Pt);v(Be.$$.fragment,As),As.forEach(o),Ss.forEach(o),Mn=c(Bo),jt=a(Bo,"SPAN",{});var Ms=i(jt);Nn=r(Ms,"BertGenerationEncoder"),Ms.forEach(o),Bo.forEach(o),po=c(t),f=a(t,"DIV",{class:!0});var z=i(f);v(ze.$$.fragment,z),Ln=c(z),xt=a(z,"P",{});var Ns=i(xt);Fn=r(Ns,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Ns.forEach(o),On=c(z),$e=a(z,"P",{});var zo=i($e);In=r(zo,"This model inherits from "),st=a(zo,"A",{href:!0});var Ls=i(st);Rn=r(Ls,"PreTrainedModel"),Ls.forEach(o),Wn=r(zo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),At=a(x,"CODE",{});var Vs=i(At);ur=r(Vs,"add_cross_attention"),Vs.forEach(o),mr=r(x," set to "),Mt=a(x,"CODE",{});var Js=i(Mt);fr=r(Js,"True"),Js.forEach(o),gr=r(x,"; an "),Nt=a(x,"CODE",{});var Ks=i(Nt);_r=r(Ks,"encoder_hidden_states"),Ks.forEach(o),br=r(x," is then expected as an input to the forward pass."),x.forEach(o),vr=c(z),P=a(z,"DIV",{class:!0});var F=i(P);v(Ce.$$.fragment,F),kr=c(F),K=a(F,"P",{});var mt=i(K);Tr=r(mt,"The "),it=a(mt,"A",{href:!0});var Qs=i(it);wr=r(Qs,"BertGenerationEncoder"),Qs.forEach(o),yr=r(mt," forward method, overrides the "),Lt=a(mt,"CODE",{});var Xs=i(Lt);Er=r(Xs,"__call__"),Xs.forEach(o),Br=r(mt," special method."),mt.forEach(o),zr=c(F),v(ne.$$.fragment,F),$r=c(F),Ft=a(F,"P",{});var Ys=i(Ft);Gr=r(Ys,"Example:"),Ys.forEach(o),qr=c(F),v(De.$$.fragment,F),F.forEach(o),z.forEach(o),uo=c(t),Q=a(t,"H2",{class:!0});var qo=i(Q);re=a(qo,"A",{id:!0,class:!0,href:!0});var Zs=i(re);Ot=a(Zs,"SPAN",{});var ea=i(Ot);v(Se.$$.fragment,ea),ea.forEach(o),Zs.forEach(o),Pr=c(qo),It=a(qo,"SPAN",{});var ta=i(It);jr=r(ta,"BertGenerationDecoder"),ta.forEach(o),qo.forEach(o),mo=c(t),G=a(t,"DIV",{class:!0});var O=i(G);v(Ae.$$.fragment,O),xr=c(O),Me=a(O,"P",{});var Po=i(Me);Cr=r(Po,"BertGeneration Model with a "),Rt=a(Po,"CODE",{});var oa=i(Rt);Dr=r(oa,"language modeling"),oa.forEach(o),Sr=r(Po," head on top for CLM fine-tuning."),Po.forEach(o),Ar=c(O),Ne=a(O,"P",{});var jo=i(Ne);Mr=r(jo,"This model inherits from "),dt=a(jo,"A",{href:!0});var na=i(dt);Nr=r(na,"PreTrainedModel"),na.forEach(o),Lr=r(jo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
