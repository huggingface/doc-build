...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}]}}),oo=new $t({props:{codee:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
`}}),jt=new zn({props:{$$slots:{default:[kf]},$$scope:{ctx:H}}}),yo=new $t({props:{codee:`from transformers import BlenderbotSmallTokenizer, BlenderbotSmallModel
...
`}}),Mo=new $t({props:{codee:`from transformers import BlenderbotSmallTokenizer, BlenderbotSmallForCausalLM
...
`}}),Dt=new zn({props:{$$slots:{default:[Tf]},$$scope:{ctx:H}}}),Io=new $t({props:{codee:`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallModel
...
`}}),nn=new $t({props:{codee:`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallModel
...
`}}),sn=new $t({props:{codee:`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration
...
`}}),dn=new $t({props:{codee:`import jax.numpy as jnp
...
`}}),Tn=new $t({props:{codee:`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration
...
`}}),Sn=new $t({props:{codee:`import jax.numpy as jnp
from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration
