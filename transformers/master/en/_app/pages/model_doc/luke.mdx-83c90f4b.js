import{S as op,i as sp,s as ap,e as a,k as l,w as _,t as o,R as rp,c as r,d as t,m as c,a as i,x as k,h as s,b as d,F as e,g as u,y,q as b,o as v,B as w}from"../../chunks/vendor-9daddcfa.js";import{T as Ro}from"../../chunks/Tip-c0a70391.js";import{D as O}from"../../chunks/Docstring-ea6f8b76.js";import{C as Nn}from"../../chunks/CodeBlock-37b92346.js";import{I as ze}from"../../chunks/IconCopyLink-a413fd1b.js";import"../../chunks/CopyButton-6099fd9d.js";function ip(U){let h,L,m,T,E;return{c(){h=a("p"),L=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),T=o("Module"),E=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var z=i(m);T=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var z=i(m);T=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,T),e(h,E)},d(g){g&&t(h)}}}function hp(U){let h,L,m,T,E,g,f,z,Bs,Ho,le,xe,Dn,He,Ws,Bn,Os,Vo,$e,Us,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Wn,Vs,Jo,Gt,Ys,Xo,R,On,Ye,Qs,Zt,Js,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ra,ia,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,wa,on,Gn,Ta,La,Ea,K,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Ca,Ma,Fa,Ce,an,Pa,ja,Ge,Aa,Ia,Sa,rn,dn,Na,Da,Ba,S,ln,Wa,Oa,eo,Ua,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,er,Ze,tr,nr,or,et,sr,tt,ar,rr,Go,pn,ir,Zo,nt,es,V,dr,ot,lr,cr,st,pr,hr,at,ur,mr,ts,he,Me,so,rt,fr,ao,gr,ns,C,it,_r,dt,kr,hn,yr,br,vr,ue,wr,un,Tr,Lr,mn,Er,zr,xr,ro,$r,qr,lt,os,me,Fe,io,ct,Cr,lo,Mr,ss,M,pt,Fr,co,Pr,jr,x,Ar,fn,Ir,Sr,gn,Nr,Dr,_n,Br,Wr,po,Or,Ur,ho,Kr,Rr,uo,Hr,Vr,mo,Yr,Qr,Jr,Pe,ht,Xr,fo,Gr,Zr,kn,ut,as,fe,je,go,mt,ei,_o,ti,rs,F,ft,ni,ko,oi,si,gt,ai,yn,ri,ii,di,_t,li,kt,ci,pi,hi,N,yt,ui,ge,mi,bn,fi,gi,yo,_i,ki,yi,Ae,bi,bo,vi,wi,bt,is,_e,Ie,vo,vt,Ti,wo,Li,ds,P,wt,Ei,To,zi,xi,Tt,$i,vn,qi,Ci,Mi,Lt,Fi,Et,Pi,ji,Ai,J,zt,Ii,ke,Si,wn,Ni,Di,Lo,Bi,Wi,Oi,Se,ls,ye,Ne,Eo,xt,Ui,zo,Ki,cs,j,$t,Ri,xo,Hi,Vi,qt,Yi,Tn,Qi,Ji,Xi,Ct,Gi,Mt,Zi,ed,td,D,Ft,nd,be,od,Ln,sd,ad,$o,rd,id,dd,De,ld,qo,cd,pd,Pt,ps,ve,Be,Co,jt,hd,Mo,ud,hs,A,At,md,Fo,fd,gd,It,_d,En,kd,yd,bd,St,vd,Nt,wd,Td,Ld,B,Dt,Ed,we,zd,zn,xd,$d,Po,qd,Cd,Md,We,Fd,jo,Pd,jd,Bt,us,Te,Oe,Ao,Wt,Ad,Io,Id,ms,I,Ot,Sd,So,Nd,Dd,Ut,Bd,xn,Wd,Od,Ud,Kt,Kd,Rt,Rd,Hd,Vd,W,Ht,Yd,Le,Qd,$n,Jd,Xd,No,Gd,Zd,el,Ue,tl,Do,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Nn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
`}}),ut=new O({props:{name:"save_vocabulary",anchor:"transformers.LukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/tokenization_luke.py#L1379"}}),mt=new ze({}),ft=new O({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/modeling_luke.py#L879",parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yt=new O({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>word_last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>entity_last_hidden_state = outputs.entity_last_hidden_state`}}),vt=new ze({}),wt=new O({props:{name:"class transformers.LukeForMaskedLM",anchor:"transformers.LukeForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/modeling_luke.py#L1132",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zt=new O({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"labels",val:" = None"},{name:"entity_labels",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Predicted <span class="hljs-keyword">class</span>: person`}}),jt=new ze({}),At=new O({props:{name:"class transformers.LukeForEntityPairClassification",anchor:"transformers.LukeForEntityPairClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/modeling_luke.py#L1383",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Dt=new O({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_idx = logits.argmax(-<span class="hljs-number">1</span>).item()
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])
Predicted <span class="hljs-keyword">class</span>: per:cities_of_residence`}}),Wt=new ze({}),Ot=new O({props:{name:"class transformers.LukeForEntitySpanClassification",anchor:"transformers.LukeForEntitySpanClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/modeling_luke.py#L1503",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new O({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"entity_start_positions",val:" = None"},{name:"entity_end_positions",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
documentation from `),mn=a("a"),Er=o("PretrainedConfig"),zr=o(" for more information."),xr=l(),ro=a("p"),$r=o("Examples:"),qr=l(),_(lt.$$.fragment),os=l(),me=a("h2"),Fe=a("a"),io=a("span"),_(ct.$$.fragment),Cr=l(),lo=a("span"),Mr=o("LukeTokenizer"),ss=l(),M=a("div"),_(pt.$$.fragment),Fr=l(),co=a("p"),Pr=o("Construct a LUKE tokenizer."),jr=l(),x=a("p"),Ar=o("This tokenizer inherits from "),fn=a("a"),Ir=o("RobertaTokenizer"),Sr=o(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),gn=a("a"),Nr=o("RobertaTokenizer"),Dr=o(", "),_n=a("a"),Br=o("LukeTokenizer"),Wr=o(`
...
sequences, depending on the task you want to prepare them for.`),Zr=l(),kn=a("div"),_(ut.$$.fragment),as=l(),fe=a("h2"),je=a("a"),go=a("span"),_(mt.$$.fragment),ei=l(),_o=a("span"),ti=o("LukeModel"),rs=l(),F=a("div"),_(ft.$$.fragment),ni=l(),ko=a("p"),oi=o("The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),si=l(),gt=a("p"),ai=o("This model inherits from "),yn=a("a"),ri=o("PreTrainedModel"),ii=o(`. Check the superclass documentation for the generic methods the
...
and behavior.`),hi=l(),N=a("div"),_(yt.$$.fragment),ui=l(),ge=a("p"),mi=o("The "),bn=a("a"),fi=o("LukeModel"),gi=o(" forward method, overrides the "),yo=a("code"),_i=o("__call__"),ki=o(" special method."),yi=l(),_(Ae.$$.fragment),bi=l(),bo=a("p"),vi=o("Examples:"),wi=l(),_(bt.$$.fragment),is=l(),_e=a("h2"),Ie=a("a"),vo=a("span"),_(vt.$$.fragment),Ti=l(),wo=a("span"),Li=o("LukeForMaskedLM"),ds=l(),P=a("div"),_(wt.$$.fragment),Ei=l(),To=a("p"),zi=o(`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ai=l(),J=a("div"),_(zt.$$.fragment),Ii=l(),ke=a("p"),Si=o("The "),wn=a("a"),Ni=o("LukeForMaskedLM"),Di=o(" forward method, overrides the "),Lo=a("code"),Bi=o("__call__"),Wi=o(" special method."),Oi=l(),_(Se.$$.fragment),ls=l(),ye=a("h2"),Ne=a("a"),Eo=a("span"),_(xt.$$.fragment),Ui=l(),zo=a("span"),Ki=o("LukeForEntityClassification"),cs=l(),j=a("div"),_($t.$$.fragment),Ri=l(),xo=a("p"),Hi=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),D=a("div"),_(Ft.$$.fragment),nd=l(),be=a("p"),od=o("The "),Ln=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),rd=o("__call__"),id=o(" special method."),dd=l(),_(De.$$.fragment),ld=l(),qo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),Be=a("a"),Co=a("span"),_(jt.$$.fragment),hd=l(),Mo=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Fo=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vd=l(),W=a("div"),_(Ht.$$.fragment),Yd=l(),Le=a("p"),Qd=o("The "),$n=a("a"),Jd=o("LukeForEntitySpanClassification"),Xd=o(" forward method, overrides the "),No=a("code"),Gd=o("__call__"),Zd=o(" special method."),el=l(),_(Ue.$$.fragment),tl=l(),Do=a("p"),nl=o("Examples:"),ol=l(),_(Vt.$$.fragment),this.h()},l(n){const p=rp('[data-svelte="svelte-1phssyn"]',document.head);h=r(p,"META",{name:!0,content:!0}),p.forEach(t),L=c(n),m=r(n,"H1",{class:!0});var Yt=i(m);T=r(Yt,"A",{id:!0,class:!0,href:!0});var Bo=i(T);E=r(Bo,"SPAN",{});var Wo=i(E);k(g.$$.fragment,Wo),Wo.forEach(t),Bo.forEach(t),f=c(Yt),z=r(Yt,"SPAN",{});var Oo=i(z);Bs=s(Oo,"LUKE"),Oo.forEach(t),Yt.forEach(t),Ho=c(n),le=r(n,"H2",{class:!0});var Qt=i(le);xe=r(Qt,"A",{id:!0,class:!0,href:!0});var il=i(xe);Dn=r(il,"SPAN",{});var dl=i(Dn);k(He.$$.fragment,dl),dl.forEach(t),il.forEach(t),Ws=c(Qt),Bn=r(Qt,"SPAN",{});var ll=i(Bn);Os=s(ll,"Overview"),ll.forEach(t),Qt.forEach(t),Vo=c(n),$e=r(n,"P",{});var gs=i($e);Us=s(gs,"The LUKE model was proposed in "),Ve=r(gs,"A",{href:!0,rel:!0});var cl=i(Ve);Ks=s(cl,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),cl.forEach(t),Rs=s(gs,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),ul.forEach(t),hl.forEach(t),Jo=c(n),Gt=r(n,"P",{});var ml=i(Gt);Ys=s(ml,"Tips:"),ml.forEach(t),Xo=c(n),R=r(n,"UL",{});var Ke=i(R);On=r(Ke,"LI",{});var fl=i(On);Ye=r(fl,"P",{});var _s=i(Ye);Qs=s(_s,"This implementation is the same as "),Zt=r(_s,"A",{href:!0});var gl=i(Zt);Js=s(gl,"RobertaModel"),gl.forEach(t),Xs=s(_s,` with the addition of entity embeddings as well
...
`),en=r(Y,"A",{href:!0});var wl=i(en);da=s(wl,"LukeTokenizer"),wl.forEach(t),la=s(Y,"."),Y.forEach(t),_l.forEach(t),ca=c(Ke),Qe=r(Ke,"LI",{});var ks=i(Qe);H=r(ks,"P",{});var Ee=i(H);tn=r(Ee,"A",{href:!0});var Tl=i(tn);pa=s(Tl,"LukeTokenizer"),Tl.forEach(t),ha=s(Ee," takes "),Yn=r(Ee,"CODE",{});var Ll=i(Yn);ua=s(Ll,"entities"),Ll.forEach(t),ma=s(Ee," and "),Qn=r(Ee,"CODE",{});var El=i(Qn);fa=s(El,"entity_spans"),El.forEach(t),ga=s(Ee,` (character-based start and end
...
`),oo=r(Q,"CODE",{});var Dl=i(oo);Qa=s(Dl,'task="entity_span_classification"'),Dl.forEach(t),Ja=s(Q,". Please refer to the example code of each head models."),Q.forEach(t),Xa=c(X),pe=r(X,"P",{});var Cn=i(pe);Ga=s(Cn,"A demo notebook on how to fine-tune "),cn=r(Cn,"A",{href:!0});var Bl=i(cn);Za=s(Bl,"LukeForEntityPairClassification"),Bl.forEach(t),er=s(Cn,` for relation
...
this superclass for more information regarding those methods. Compared to `),gn=r($,"A",{href:!0});var ac=i(gn);Nr=s(ac,"RobertaTokenizer"),ac.forEach(t),Dr=s($,", "),_n=r($,"A",{href:!0});var rc=i(_n);Br=s(rc,"LukeTokenizer"),rc.forEach(t),Wr=s($,`
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xs.forEach(t),hi=c(ee),N=r(ee,"DIV",{class:!0});var te=i(N);k(yt.$$.fragment,te),ui=c(te),ge=r(te,"P",{});var Fn=i(ge);mi=s(Fn,"The "),bn=r(Fn,"A",{href:!0});var yc=i(bn);fi=s(yc,"LukeModel"),yc.forEach(t),gi=s(Fn," forward method, overrides the "),yo=r(Fn,"CODE",{});var bc=i(yo);_i=s(bc,"__call__"),bc.forEach(t),ki=s(Fn," special method."),Fn.forEach(t),yi=c(te),k(Ae.$$.fragment,te),bi=c(te),bo=r(te,"P",{});var vc=i(bo);vi=s(vc,"Examples:"),vc.forEach(t),wi=c(te),k(bt.$$.fragment,te),te.forEach(t),ee.forEach(t),is=c(n),_e=r(n,"H2",{class:!0});var $s=i(_e);Ie=r($s,"A",{id:!0,class:!0,href:!0});var wc=i(Ie);vo=r(wc,"SPAN",{});var Tc=i(vo);k(vt.$$.fragment,Tc),Tc.forEach(t),wc.forEach(t),Ti=c($s),wo=r($s,"SPAN",{});var Lc=i(wo);Li=s(Lc,"LukeForMaskedLM"),Lc.forEach(t),$s.forEach(t),ds=c(n),P=r(n,"DIV",{class:!0});var ne=i(P);k(wt.$$.fragment,ne),Ei=c(ne),To=r(ne,"P",{});var Ec=i(To);zi=s(Ec,`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
...
tokens) for entity pair classification tasks, such as TACRED.`),Oc.forEach(t),gd=c(ae),It=r(ae,"P",{});var As=i(It);_d=s(As,"This model inherits from "),En=r(As,"A",{href:!0});var Uc=i(En);kd=s(Uc,"PreTrainedModel"),Uc.forEach(t),yd=s(As,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
