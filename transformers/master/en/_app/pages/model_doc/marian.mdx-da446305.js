...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var _=a(u);z=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var j=a(f);g=i(j,"Module"),j.forEach(t),w=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(x,_){h(x,u,_),e(u,z),e(u,f),e(f,g),e(u,w)},d(x){x&&t(u)}}}function uf(C){let u,z,f,g,w,x,_,j,Ae,ue,q,ke,X,Se,Q,ee,Oe,$e,V,A,qe,L,E,F,te,ne,ve,He,G,P,Te,N,De,oe,Me,se,ae,re,Ue,S,We,O,H,m,$,ye,ot,be,D,st,at,Re,I,ie,rt,Be,U,it,dt,de,xe,bi,Zo,xi,wi,zi,lt,pn,ji,Es,$i,qi,Ei,hn,Pi,Ps,Fi,Ni,Ci,ct,Li,Fs,Ii,Ai,Ns,Si,Oi,Hi,Cs,un,Di,Ls,Ui,Wi,Ri,Is,mn,Bi,fn,Vi,Gi,Qa,pt,Nt,As,gn,Ji,Ss,Yi,er,Ee,Xo,Ki,Os,Zi,Xi,_n,Qi,kn,ed,td,nd,ht,od,Hs,sd,ad,Ds,rd,id,dd,Us,ld,tr,ut,Ct,Ws,vn,cd,Rs,pd,nr,Je,Bs,hd,ud,Vs,Tn,md,fd,Gs,Mn,gd,or,mt,Lt,Js,yn,_d,Ys,kd,sr,Pe,bn,vd,Ks,Td,Md,yd,xn,bd,Zs,xd,wd,zd,wn,jd,zn,$d,qd,Ed,jn,Pd,Xs,Fd,Nd,ar,It,Cd,$n,Ld,Id,rr,qn,ir,Qo,Ad,dr,En,lr,ft,At,Qs,Pn,Sd,ea,Od,cr,es,Hd,pr,Fn,hr,ts,Dd,ur,Nn,mr,gt,St,ta,Cn,Ud,na,Wd,fr,le,Ln,Rd,_t,Bd,ns,Vd,Gd,In,Jd,Yd,Kd,kt,Zd,os,Xd,Qd,ss,el,tl,nl,oa,ol,sl,An,gr,vt,Ot,sa,Sn,al,aa,rl,_r,W,On,il,Hn,dl,Dn,ll,cl,pl,Un,hl,as,ul,ml,fl,ra,gl,_l,Wn,kl,Ht,Rn,vl,ia,Tl,kr,Tt,Dt,da,Bn,Ml,la,yl,vr,we,Vn,bl,Gn,xl,rs,wl,zl,jl,Jn,$l,Yn,ql,El,Pl,me,Kn,Fl,Mt,Nl,is,Cl,Ll,ca,Il,Al,Sl,Ut,Ol,pa,Hl,Dl,Zn,Tr,yt,Wt,ha,Xn,Ul,ua,Wl,Mr,ze,Qn,Rl,eo,Bl,ds,Vl,Gl,Jl,to,Yl,no,Kl,Zl,Xl,J,oo,Ql,bt,ec,ls,tc,nc,ma,oc,sc,ac,Rt,rc,so,ic,ao,dc,lc,cc,fa,pc,hc,ro,yr,xt,Bt,ga,io,uc,_a,mc,br,lo,Ye,co,fc,ka,gc,_c,po,xr,wt,Vt,va,ho,kc,Ta,vc,wr,ce,uo,Tc,mo,Mc,cs,yc,bc,xc,fo,wc,go,zc,jc,$c,Gt,qc,fe,_o,Ec,zt,Pc,ps,Fc,Nc,Ma,Cc,Lc,Ic,Jt,Ac,ya,Sc,Oc,ko,zr,jt,Yt,ba,vo,Hc,xa,Dc,jr,pe,To,Uc,Mo,Wc,hs,Rc,Bc,Vc,yo,Gc,bo,Jc,Yc,Kc,Kt,Zc,Y,xo,Xc,$t,Qc,us,ep,tp,wa,np,op,sp,Zt,ap,wo,rp,zo,ip,dp,lp,za,cp,pp,jo,$r,qt,Xt,ja,$o,hp,$a,up,qr,R,qo,mp,Eo,fp,ms,gp,_p,kp,Po,vp,Fo,Tp,Mp,yp,qa,bp,xp,Ve,Ea,No,wp,zp,Pa,Co,jp,$p,Fa,Lo,qp,Ep,Na,Io,Pp,Fp,ge,Ao,Np,Et,Cp,Ca,Lp,Ip,La,Ap,Sp,Op,Qt,Hp,Ia,Dp,Up,So,Er,Pt,en,Aa,Oo,Wp,Sa,Rp,Pr,B,Ho,Bp,Do,Vp,fs,Gp,Jp,Yp,Uo,Kp,Wo,Zp,Xp,Qp,Oa,eh,th,Ge,Ha,Ro,nh,oh,Da,Bo,sh,ah,Ua,Vo,rh,ih,Wa,Go,dh,lh,_e,Jo,ch,Ft,ph,Ra,hh,uh,Ba,mh,fh,gh,tn,_h,Va,kh,vh,Yo,Fr;return x=new he({}),te=new he({}),gn=new he({}),vn=new he({}),yn=new he({}),qn=new je({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oo=new Z({props:{name:"forward",anchor:"transformers.MarianMTModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/marian/modeling_marian.py#L1260",parametersDescription:[{anchor:"transformers.MarianMTModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Gt=new cn({props:{$$slots:{default:[rf]},$$scope:{ctx:C}}}),_o=new Z({props:{name:"call",anchor:"transformers.TFMarianModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/marian/modeling_tf_marian.py#L1229",parametersDescription:[{anchor:"transformers.TFMarianModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Available models are listed `),ao=o("a"),dc=r("here"),lc=r("."),cc=d(),fa=o("p"),pc=r("Examples:"),hc=d(),k(ro.$$.fragment),yr=d(),xt=o("h2"),Bt=o("a"),ga=o("span"),k(io.$$.fragment),uc=d(),_a=o("span"),mc=r("MarianForCausalLM"),br=d(),lo=o("div"),Ye=o("div"),k(co.$$.fragment),fc=d(),ka=o("p"),gc=r("Example:"),_c=d(),k(po.$$.fragment),xr=d(),wt=o("h2"),Vt=o("a"),va=o("span"),k(ho.$$.fragment),kc=d(),Ta=o("span"),vc=r("TFMarianModel"),wr=d(),ce=o("div"),k(uo.$$.fragment),Tc=d(),mo=o("p"),Mc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
fine-tuning experiments and integration tests.`),tu.forEach(t),ud=l(Ts),Vs=s(Ts,"LI",{});var nu=a(Vs);Tn=s(nu,"A",{href:!0,rel:!0});var ou=a(Tn);md=i(ou,"Fine-tune on GPU"),ou.forEach(t),nu.forEach(t),fd=l(Ts),Gs=s(Ts,"LI",{});var su=a(Gs);Mn=s(su,"A",{href:!0,rel:!0});var au=a(Mn);gd=i(au,"Fine-tune on GPU with pytorch-lightning"),au.forEach(t),su.forEach(t),Ts.forEach(t),or=l(n),mt=s(n,"H2",{class:!0});var Rr=a(mt);Lt=s(Rr,"A",{id:!0,class:!0,href:!0});var ru=a(Lt);Js=s(ru,"SPAN",{});var iu=a(Js);v(yn.$$.fragment,iu),iu.forEach(t),ru.forEach(t),_d=l(Rr),Ys=s(Rr,"SPAN",{});var du=a(Ys);kd=i(du,"Multilingual Models"),du.forEach(t),Rr.forEach(t),sr=l(n),Pe=s(n,"UL",{});var sn=a(Pe);bn=s(sn,"LI",{});var Br=a(bn);vd=i(Br,"All model names use the following format: "),Ks=s(Br,"CODE",{});var lu=a(Ks);Td=i(lu,"Helsinki-NLP/opus-mt-{src}-{tgt}"),lu.forEach(t),Md=i(Br,":"),Br.forEach(t),yd=l(sn),xn=s(sn,"LI",{});var Vr=a(xn);bd=i(Vr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
group:`),ku.forEach(t),pr=l(n),v(Fn.$$.fragment,n),hr=l(n),ts=s(n,"P",{});var vu=a(ts);Dd=i(vu,"Example of translating english to many romance languages, using old-style 2 character language codes"),vu.forEach(t),ur=l(n),v(Nn.$$.fragment,n),mr=l(n),gt=s(n,"H2",{class:!0});var Zr=a(gt);St=s(Zr,"A",{id:!0,class:!0,href:!0});var Tu=a(St);ta=s(Tu,"SPAN",{});var Mu=a(ta);v(Cn.$$.fragment,Mu),Mu.forEach(t),Tu.forEach(t),Ud=l(Zr),na=s(Zr,"SPAN",{});var yu=a(na);Wd=i(yu,"MarianConfig"),yu.forEach(t),Zr.forEach(t),fr=l(n),le=s(n,"DIV",{class:!0});var Ke=a(le);v(Ln.$$.fragment,Ke),Rd=l(Ke),_t=s(Ke,"P",{});var Ms=a(_t);Bd=i(Ms,"This is the configuration class to store the configuration of a "),ns=s(Ms,"A",{href:!0});var bu=a(ns);Vd=i(bu,"MarianModel"),bu.forEach(t),Gd=i(Ms,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
...
models are listed `),zo=s(gi,"A",{href:!0,rel:!0});var km=a(zo);ip=i(km,"here"),km.forEach(t),dp=i(gi,"."),gi.forEach(t),lp=l(Ce),za=s(Ce,"P",{});var vm=a(za);cp=i(vm,"Examples:"),vm.forEach(t),pp=l(Ce),v(jo.$$.fragment,Ce),Ce.forEach(t),et.forEach(t),$r=l(n),qt=s(n,"H2",{class:!0});var _i=a(qt);Xt=s(_i,"A",{id:!0,class:!0,href:!0});var Tm=a(Xt);ja=s(Tm,"SPAN",{});var Mm=a(ja);v($o.$$.fragment,Mm),Mm.forEach(t),Tm.forEach(t),hp=l(_i),$a=s(_i,"SPAN",{});var ym=a($a);up=i(ym,"FlaxMarianModel"),ym.forEach(t),_i.forEach(t),qr=l(n),R=s(n,"DIV",{class:!0});var Le=a(R);v(qo.$$.fragment,Le),mp=l(Le),Eo=s(Le,"P",{});var ki=a(Eo);fp=i(ki,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ms=s(ki,"A",{href:!0});var bm=a(ms);gp=i(bm,"FlaxPreTrainedModel"),bm.forEach(t),_p=i(ki,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
