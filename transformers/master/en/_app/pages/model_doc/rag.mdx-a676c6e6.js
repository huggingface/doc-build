...
the latter silently ignores them.`)},l(g){h=s(g,"P",{});var p=a(h);y=o(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(p,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(n)},m(g,p){_(g,h,p),e(h,y),e(h,m),e(m,f),e(h,x)},d(g){g&&n(h)}}}function vT($){let h,y,m,f,x,g,p,R,ti,Ia,$e,ot,Fr,St,oi,zr,ni,Oa,an,ri,Wa,nt,si,Dt,ai,di,Ha,dn,ii,Ba,cn,$r,ci,Qa,rt,li,Lt,hi,pi,Ua,Ee,st,Er,It,mi,jr,ui,Va,de,Ot,gi,ue,ln,_i,fi,Mr,vi,bi,hn,Ti,wi,pn,ki,qi,yi,at,Wt,xi,Ht,Ri,mn,Fi,zi,$i,dt,Bt,Ei,Qt,ji,un,Mi,Gi,Ka,je,it,Gr,Ut,Ai,Ar,Ni,Ya,Me,Vt,Pi,ct,Kt,Ci,Nr,Si,Ja,Ge,lt,Pr,Yt,Di,Cr,Li,Xa,Ae,Jt,Ii,Sr,Oi,Za,Xt,Zt,ed,Ne,ht,Dr,eo,Wi,Lr,Hi,td,X,to,Bi,Ir,Qi,Ui,Or,Vi,Ki,oo,Yi,pt,no,Ji,Wr,Xi,Zi,mt,ro,ec,Pe,tc,Hr,oc,nc,Br,rc,sc,ac,ut,so,dc,ao,ic,Qr,cc,lc,od,Ce,gt,Ur,io,hc,Vr,pc,nd,D,co,mc,Se,uc,gn,gc,_c,Kr,fc,vc,bc,_t,Tc,Yr,wc,kc,ie,qc,Jr,yc,xc,_n,Rc,Fc,Xr,zc,$c,fn,Ec,jc,Mc,G,Gc,vn,Ac,Nc,Zr,Pc,Cc,es,Sc,Dc,ts,Lc,Ic,os,Oc,Wc,bn,Hc,Bc,ns,Qc,Uc,Tn,Vc,Kc,wn,Yc,Jc,rs,Xc,Zc,el,lo,tl,kn,ol,nl,rl,ho,sl,po,al,dl,il,ee,mo,cl,De,ll,qn,hl,pl,ss,ml,ul,gl,ft,_l,as,fl,vl,uo,rd,Le,vt,ds,go,bl,is,Tl,sd,E,_o,wl,Ie,kl,yn,ql,yl,cs,xl,Rl,Fl,bt,zl,ls,$l,El,hs,jl,Ml,ce,Gl,ps,Al,Nl,xn,Pl,Cl,ms,Sl,Dl,Rn,Ll,Il,Ol,A,Wl,Fn,Hl,Bl,us,Ql,Ul,gs,Vl,Kl,_s,Yl,Jl,fs,Xl,Zl,zn,eh,th,vs,oh,nh,$n,rh,sh,En,ah,dh,bs,ih,ch,lh,fo,hh,jn,ph,mh,uh,vo,gh,bo,_h,fh,vh,te,To,bh,Oe,Th,Mn,wh,kh,Ts,qh,yh,xh,Tt,Rh,ws,Fh,zh,wo,$h,wt,ko,Eh,qo,jh,Gn,Mh,Gh,ad,We,kt,ks,yo,Ah,qs,Nh,dd,j,xo,Ph,He,Ch,An,Sh,Dh,ys,Lh,Ih,Oh,qt,Wh,xs,Hh,Bh,Rs,Qh,Uh,le,Vh,Fs,Kh,Yh,Nn,Jh,Xh,zs,Zh,ep,Pn,tp,op,np,N,rp,Cn,sp,ap,$s,dp,ip,Es,cp,lp,js,hp,pp,Ms,mp,up,Sn,gp,_p,Gs,fp,vp,Dn,bp,Tp,Ln,wp,kp,As,qp,yp,xp,Ro,Rp,In,Fp,zp,$p,Fo,Ep,zo,jp,Mp,Gp,oe,$o,Ap,Be,Np,On,Pp,Cp,Ns,Sp,Dp,Lp,yt,Ip,Ps,Op,Wp,Eo,Hp,xt,jo,Bp,Cs,Qp,id,Qe,Rt,Ss,Mo,Up,Ds,Vp,cd,P,Go,Kp,Ue,Yp,Wn,Jp,Xp,Ls,Zp,em,tm,Ft,om,Is,nm,rm,he,sm,Os,am,dm,Hn,im,cm,Ws,lm,hm,Bn,pm,mm,um,L,gm,Qn,_m,fm,Hs,vm,bm,Bs,Tm,wm,Qs,km,qm,Us,ym,xm,Un,Rm,Fm,Vs,zm,$m,Vn,Em,jm,Ks,Mm,Gm,Am,Ao,Nm,Kn,Pm,Cm,Sm,No,Dm,Po,Lm,Im,Om,Ys,Wm,Hm,ne,Co,Bm,Ve,Qm,Yn,Um,Vm,Js,Km,Ym,Jm,zt,Xm,Xs,Zm,eu,So,ld,Ke,$t,Zs,Do,tu,ea,ou,hd,F,Lo,nu,Ye,ru,Jn,su,au,ta,du,iu,cu,Et,lu,oa,hu,pu,na,mu,uu,pe,gu,ra,_u,fu,Xn,vu,bu,sa,Tu,wu,Zn,ku,qu,yu,I,xu,er,Ru,Fu,aa,zu,$u,da,Eu,ju,ia,Mu,Gu,ca,Au,Nu,tr,Pu,Cu,la,Su,Du,or,Lu,Iu,ha,Ou,Wu,Hu,Io,Bu,nr,Qu,Uu,Vu,Oo,Ku,Wo,Yu,Ju,Xu,pa,Zu,eg,re,Ho,tg,Je,og,rr,ng,rg,ma,sg,ag,dg,jt,ig,ua,cg,lg,Bo,hg,Mt,Qo,pg,Uo,mg,sr,ug,gg,pd,Xe,Gt,ga,Vo,_g,_a,fg,md,z,Ko,vg,Ze,bg,ar,Tg,wg,fa,kg,qg,yg,At,xg,va,Rg,Fg,ba,zg,$g,me,Eg,Ta,jg,Mg,dr,Gg,Ag,wa,Ng,Pg,ir,Cg,Sg,Dg,O,Lg,cr,Ig,Og,ka,Wg,Hg,qa,Bg,Qg,ya,Ug,Vg,xa,Kg,Yg,lr,Jg,Xg,Ra,Zg,e_,hr,t_,o_,Fa,n_,r_,s_,Yo,a_,pr,d_,i_,c_,Jo,l_,Xo,h_,p_,m_,za,u_,g_,se,Zo,__,et,f_,mr,v_,b_,$a,T_,w_,k_,Nt,q_,Ea,y_,x_,en,R_,Pt,tn,F_,ja,z_,ud;return g=new _e({}),St=new _e({}),It=new _e({}),Ot=new M({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/master/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate)</code>
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/master/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],returnDescription:`
<p>The generated
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/master/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}]}}),Ft=new ge({props:{$$slots:{default:[pT]},$$scope:{ctx:$}}}),Co=new M({props:{name:"call",anchor:"transformers.TFRagModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"doc_scores",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"n_docs",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/rag/modeling_tf_rag.py#L535",parametersDescription:[{anchor:"transformers.TFRagModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/master/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
which generator to use, it also specifies a compatible generator tokenizer. Use that tokenizer class to
...
`,returnType:`
<p><code>tf.Tensor</code> of shape <code>(batch_size * num_return_sequences, sequence_length)</code></p>
`}}),{c(){h=r("meta"),y=c(),m=r("h1"),f=r("a"),x=r("span"),v(g.$$.fragment),p=c(),R=r("span"),ti=t("RAG"),Ia=c(),$e=r("h2"),ot=r("a"),Fr=r("span"),v(St.$$.fragment),oi=c(),zr=r("span"),ni=t("Overview"),Oa=c(),an=r("p"),ri=t(`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
...
parametric-only seq2seq baseline.`),Qa=c(),rt=r("p"),li=t("This model was contributed by "),Lt=r("a"),hi=t("ola13"),pi=t("."),Ua=c(),Ee=r("h2"),st=r("a"),Er=r("span"),v(It.$$.fragment),mi=c(),jr=r("span"),ui=t("RagConfig"),Va=c(),de=r("div"),v(Ot.$$.fragment),gi=c(),ue=r("p"),ln=r("a"),_i=t("RagConfig"),fi=t(" stores the configuration of a "),Mr=r("em"),vi=t("RagModel"),bi=t(". Configuration objects inherit from "),hn=r("a"),Ti=t("PretrainedConfig"),wi=t(` and
...
decoder model configuration.`),$i=c(),dt=r("div"),v(Bt.$$.fragment),Ei=c(),Qt=r("p"),ji=t("Serializes this instance to a Python dictionary. Override the default "),un=r("a"),Mi=t("to_dict()"),Gi=t("."),Ka=c(),je=r("h2"),it=r("a"),Gr=r("span"),v(Ut.$$.fragment),Ai=c(),Ar=r("span"),Ni=t("RagTokenizer"),Ya=c(),Me=r("div"),v(Vt.$$.fragment),Pi=c(),ct=r("div"),v(Kt.$$.fragment),Ci=c(),Nr=r("p"),Si=t(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Ja=c(),Ge=r("h2"),lt=r("a"),Pr=r("span"),v(Yt.$$.fragment),Di=c(),Cr=r("span"),Li=t("Rag specific outputs"),Xa=c(),Ae=r("div"),v(Jt.$$.fragment),Ii=c(),Sr=r("p"),Oi=t("Base class for retriever augmented marginalized models outputs."),Za=c(),Xt=r("div"),v(Zt.$$.fragment),ed=c(),Ne=r("h2"),ht=r("a"),Dr=r("span"),v(eo.$$.fragment),Wi=c(),Lr=r("span"),Hi=t("RagRetriever"),td=c(),X=r("div"),v(to.$$.fragment),Bi=c(),Ir=r("p"),Qi=t(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
contents, and it formats them to be used with a RagModel.`),Ui=c(),Or=r("p"),Vi=t("Examples:"),Ki=c(),v(oo.$$.fragment),Yi=c(),pt=r("div"),v(no.$$.fragment),Ji=c(),Wr=r("p"),Xi=t("Retriever initialization function. It loads the index into memory."),Zi=c(),mt=r("div"),v(ro.$$.fragment),ec=c(),Pe=r("p"),tc=t("Postprocessing retrieved "),Hr=r("code"),oc=t("docs"),nc=t(" and combining them with "),Br=r("code"),rc=t("input_strings"),sc=t("."),ac=c(),ut=r("div"),v(so.$$.fragment),dc=c(),ao=r("p"),ic=t("Retrieves documents for specified "),Qr=r("code"),cc=t("question_hidden_states"),lc=t("."),od=c(),Ce=r("h2"),gt=r("a"),Ur=r("span"),v(io.$$.fragment),hc=c(),Vr=r("span"),pc=t("RagModel"),nd=c(),D=r("div"),v(co.$$.fragment),mc=c(),Se=r("p"),uc=t("The "),gn=r("a"),gc=t("RagModel"),_c=t(" forward method, overrides the "),Kr=r("code"),fc=t("__call__"),vc=t(" special method."),bc=c(),v(_t.$$.fragment),Tc=c(),Yr=r("p"),wc=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
...
and behavior.`),il=c(),ee=r("div"),v(mo.$$.fragment),cl=c(),De=r("p"),ll=t("The "),qn=r("a"),hl=t("RagModel"),pl=t(" forward method, overrides the "),ss=r("code"),ml=t("__call__"),ul=t(" special method."),gl=c(),v(ft.$$.fragment),_l=c(),as=r("p"),fl=t("Example:"),vl=c(),v(uo.$$.fragment),rd=c(),Le=r("h2"),vt=r("a"),ds=r("span"),v(go.$$.fragment),bl=c(),is=r("span"),Tl=t("RagSequenceForGeneration"),sd=c(),E=r("div"),v(_o.$$.fragment),wl=c(),Ie=r("p"),kl=t("The "),yn=r("a"),ql=t("RagSequenceForGeneration"),yl=t(" forward method, overrides the "),cs=r("code"),xl=t("__call__"),Rl=t(" special method."),Fl=c(),v(bt.$$.fragment),zl=c(),ls=r("p"),$l=t("A RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),El=c(),hs=r("p"),jl=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),Ml=c(),ce=r("p"),Gl=t("The question encoder can be any "),ps=r("em"),Al=t("autoencoding"),Nl=t(" model, preferably "),xn=r("a"),Pl=t("DPRQuestionEncoder"),Cl=t(`, and the generator can be
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vh=c(),te=r("div"),v(To.$$.fragment),bh=c(),Oe=r("p"),Th=t("The "),Mn=r("a"),wh=t("RagSequenceForGeneration"),kh=t(" forward method, overrides the "),Ts=r("code"),qh=t("__call__"),yh=t(" special method."),xh=c(),v(Tt.$$.fragment),Rh=c(),ws=r("p"),Fh=t("Example:"),zh=c(),v(wo.$$.fragment),$h=c(),wt=r("div"),v(ko.$$.fragment),Eh=c(),qo=r("p"),jh=t("Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Gn=r("a"),Mh=t("generate()"),Gh=t("`\ndocumentation for more information on how to set other generate input parameters."),ad=c(),We=r("h2"),kt=r("a"),ks=r("span"),v(yo.$$.fragment),Ah=c(),qs=r("span"),Nh=t("RagTokenForGeneration"),dd=c(),j=r("div"),v(xo.$$.fragment),Ph=c(),He=r("p"),Ch=t("The "),An=r("a"),Sh=t("RagTokenForGeneration"),Dh=t(" forward method, overrides the "),ys=r("code"),Lh=t("__call__"),Ih=t(" special method."),Oh=c(),v(qt.$$.fragment),Wh=c(),xs=r("p"),Hh=t("A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Bh=c(),Rs=r("p"),Qh=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),Uh=c(),le=r("p"),Vh=t("The question encoder can be any "),Fs=r("em"),Kh=t("autoencoding"),Yh=t(" model, preferably "),Nn=r("a"),Jh=t("DPRQuestionEncoder"),Xh=t(`, and the generator can be
any `),zs=r("em"),Zh=t("seq2seq"),ep=t(" model, preferably "),Pn=r("a"),tp=t("BartForConditionalGeneration"),op=t("."),np=c(),N=r("p"),rp=t("The model can be initialized with a "),Cn=r("a"),sp=t("RagRetriever"),ap=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gp=c(),oe=r("div"),v($o.$$.fragment),Ap=c(),Be=r("p"),Np=t("The "),On=r("a"),Pp=t("RagTokenForGeneration"),Cp=t(" forward method, overrides the "),Ns=r("code"),Sp=t("__call__"),Dp=t(" special method."),Lp=c(),v(yt.$$.fragment),Ip=c(),Ps=r("p"),Op=t("Example:"),Wp=c(),v(Eo.$$.fragment),Hp=c(),xt=r("div"),v(jo.$$.fragment),Bp=c(),Cs=r("p"),Qp=t("Implements RAG token decoding."),id=c(),Qe=r("h2"),Rt=r("a"),Ss=r("span"),v(Mo.$$.fragment),Up=c(),Ds=r("span"),Vp=t("TFRagModel"),cd=c(),P=r("div"),v(Go.$$.fragment),Kp=c(),Ue=r("p"),Yp=t("The "),Wn=r("a"),Jp=t("TFRagModel"),Xp=t(" forward method, overrides the "),Ls=r("code"),Zp=t("__call__"),em=t(" special method."),tm=c(),v(Ft.$$.fragment),om=c(),Is=r("p"),nm=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
as the `),Ks=r("code"),Mm=t("generator"),Gm=t("."),Am=c(),Ao=r("p"),Nm=t("This model inherits from "),Kn=r("a"),Pm=t("TFPreTrainedModel"),Cm=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sm=c(),No=r("p"),Dm=t("This model is also a Tensorflow "),Po=r("a"),Lm=t("tf.keras.Model"),Im=t(`
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),aa=r("em"),zu=t("autoencoding"),$u=t(" model as the "),da=r("code"),Eu=t("question_encoder"),ju=t(" and any "),ia=r("em"),Mu=t("seq2seq"),Gu=t(" model with language model head as the "),ca=r("code"),Au=t("generator"),Nu=t(`.
It has been tested with `),tr=r("a"),Pu=t("TFDPRQuestionEncoder"),Cu=t(" as the "),la=r("code"),Su=t("question_encoder"),Du=t(" and "),or=r("a"),Lu=t("TFBartForConditionalGeneration"),Iu=t(`
...
SavedModel format.`),g_=c(),se=r("div"),v(Zo.$$.fragment),__=c(),et=r("p"),f_=t("The "),mr=r("a"),v_=t("TFRagTokenForGeneration"),b_=t(" forward method, overrides the "),$a=r("code"),T_=t("__call__"),w_=t(" special method."),k_=c(),v(Nt.$$.fragment),q_=c(),Ea=r("p"),y_=t("Example:"),x_=c(),v(en.$$.fragment),R_=c(),Pt=r("div"),v(tn.$$.fragment),F_=c(),ja=r("p"),z_=t("Implements TFRAG token decoding."),this.h()},l(d){const u=sT('[data-svelte="svelte-1phssyn"]',document.head);h=s(u,"META",{name:!0,content:!0}),u.forEach(n),y=l(d),m=s(d,"H1",{class:!0});var on=a(m);f=s(on,"A",{id:!0,class:!0,href:!0});var Ma=a(f);x=s(Ma,"SPAN",{});var Ga=a(x);b(g.$$.fragment,Ga),Ga.forEach(n),Ma.forEach(n),p=l(on),R=s(on,"SPAN",{});var Aa=a(R);ti=o(Aa,"RAG"),Aa.forEach(n),on.forEach(n),Ia=l(d),$e=s(d,"H2",{class:!0});var nn=a($e);ot=s(nn,"A",{id:!0,class:!0,href:!0});var Na=a(ot);Fr=s(Na,"SPAN",{});var Pa=a(Fr);b(St.$$.fragment,Pa),Pa.forEach(n),Na.forEach(n),oi=l(nn),zr=s(nn,"SPAN",{});var Ca=a(zr);ni=o(Ca,"Overview"),Ca.forEach(n),nn.forEach(n),Oa=l(d),an=s(d,"P",{});var Sa=a(an);ri=o(Sa,`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
sequence-to-sequence models. RAG models retrieve documents, pass them to a seq2seq model, then marginalize to generate
outputs. The retriever and seq2seq modules are initialized from pretrained models, and fine-tuned jointly, allowing
...
outperforming parametric seq2seq models and task-specific retrieve-and-extract architectures. For language generation
tasks, we find that RAG models generate more specific, diverse and factual language than a state-of-the-art
parametric-only seq2seq baseline.`),E_.forEach(n),$_.forEach(n),Qa=l(d),rt=s(d,"P",{});var gd=a(rt);li=o(gd,"This model was contributed by "),Lt=s(gd,"A",{href:!0,rel:!0});var j_=a(Lt);hi=o(j_,"ola13"),j_.forEach(n),pi=o(gd,"."),gd.forEach(n),Ua=l(d),Ee=s(d,"H2",{class:!0});var _d=a(Ee);st=s(_d,"A",{id:!0,class:!0,href:!0});var M_=a(st);Er=s(M_,"SPAN",{});var G_=a(Er);b(It.$$.fragment,G_),G_.forEach(n),M_.forEach(n),mi=l(_d),jr=s(_d,"SPAN",{});var A_=a(jr);ui=o(A_,"RagConfig"),A_.forEach(n),_d.forEach(n),Va=l(d),de=s(d,"DIV",{class:!0});var Ct=a(de);b(Ot.$$.fragment,Ct),gi=l(Ct),ue=s(Ct,"P",{});var tt=a(ue);ln=s(tt,"A",{href:!0});var N_=a(ln);_i=o(N_,"RagConfig"),N_.forEach(n),fi=o(tt," stores the configuration of a "),Mr=s(tt,"EM",{});var P_=a(Mr);vi=o(P_,"RagModel"),P_.forEach(n),bi=o(tt,". Configuration objects inherit from "),hn=s(tt,"A",{href:!0});var C_=a(hn);Ti=o(C_,"PretrainedConfig"),C_.forEach(n),wi=o(tt,` and
...
any `),Xr=s(fe,"EM",{});var uf=a(Xr);zc=o(uf,"seq2seq"),uf.forEach(n),$c=o(fe," model, preferably "),fn=s(fe,"A",{href:!0});var gf=a(fn);Ec=o(gf,"BartForConditionalGeneration"),gf.forEach(n),jc=o(fe,"."),fe.forEach(n),Mc=l(Z),G=s(Z,"P",{});var W=a(G);Gc=o(W,"The model can be initialized with a "),vn=s(W,"A",{href:!0});var _f=a(vn);Ac=o(_f,"RagRetriever"),_f.forEach(n),Nc=o(W,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
`),En=s(B,"A",{href:!0});var Yf=a(En);ah=o(Yf,"T5ForConditionalGeneration"),Yf.forEach(n),dh=o(B," as the "),bs=s(B,"CODE",{});var Jf=a(bs);ih=o(Jf,"generator"),Jf.forEach(n),ch=o(B,"."),B.forEach(n),lh=l(H),fo=s(H,"P",{});var Nd=a(fo);hh=o(Nd,"This model inherits from "),jn=s(Nd,"A",{href:!0});var Xf=a(jn);ph=o(Xf,"PreTrainedModel"),Xf.forEach(n),mh=o(Nd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nd.forEach(n),uh=l(H),vo=s(H,"P",{});var Pd=a(vo);gh=o(Pd,"This model is also a PyTorch "),bo=s(Pd,"A",{href:!0,rel:!0});var Zf=a(bo);_h=o(Zf,"torch.nn.Module"),Zf.forEach(n),fh=o(Pd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pd.forEach(n),vh=l(H),te=s(H,"DIV",{class:!0});var Te=a(te);b(To.$$.fragment,Te),bh=l(Te),Oe=s(Te,"P",{});var vr=a(Oe);Th=o(vr,"The "),Mn=s(vr,"A",{href:!0});var ev=a(Mn);wh=o(ev,"RagSequenceForGeneration"),ev.forEach(n),kh=o(vr," forward method, overrides the "),Ts=s(vr,"CODE",{});var tv=a(Ts);qh=o(tv,"__call__"),tv.forEach(n),yh=o(vr," special method."),vr.forEach(n),xh=l(Te),b(Tt.$$.fragment,Te),Rh=l(Te),ws=s(Te,"P",{});var ov=a(ws);Fh=o(ov,"Example:"),ov.forEach(n),zh=l(Te),b(wo.$$.fragment,Te),Te.forEach(n),$h=l(H),wt=s(H,"DIV",{class:!0});var Cd=a(wt);b(ko.$$.fragment,Cd),Eh=l(Cd),qo=s(Cd,"P",{});var Sd=a(qo);jh=o(Sd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Gn=s(Sd,"A",{href:!0});var nv=a(Gn);Mh=o(nv,"generate()"),nv.forEach(n),Gh=o(Sd,"`\ndocumentation for more information on how to set other generate input parameters."),Sd.forEach(n),Cd.forEach(n),H.forEach(n),ad=l(d),We=s(d,"H2",{class:!0});var Dd=a(We);kt=s(Dd,"A",{id:!0,class:!0,href:!0});var rv=a(kt);ks=s(rv,"SPAN",{});var sv=a(ks);b(yo.$$.fragment,sv),sv.forEach(n),rv.forEach(n),Ah=l(Dd),qs=s(Dd,"SPAN",{});var av=a(qs);Nh=o(av,"RagTokenForGeneration"),av.forEach(n),Dd.forEach(n),dd=l(d),j=s(d,"DIV",{class:!0});var Q=a(j);b(xo.$$.fragment,Q),Ph=l(Q),He=s(Q,"P",{});var br=a(He);Ch=o(br,"The "),An=s(br,"A",{href:!0});var dv=a(An);Sh=o(dv,"RagTokenForGeneration"),dv.forEach(n),Dh=o(br," forward method, overrides the "),ys=s(br,"CODE",{});var iv=a(ys);Lh=o(iv,"__call__"),iv.forEach(n),Ih=o(br," special method."),br.forEach(n),Oh=l(Q),b(qt.$$.fragment,Q),Wh=l(Q),xs=s(Q,"P",{});var cv=a(xs);Hh=o(cv,"A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),cv.forEach(n),Bh=l(Q),Rs=s(Q,"P",{});var lv=a(Rs);Qh=o(lv,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),lv.forEach(n),Uh=l(Q),le=s(Q,"P",{});var we=a(le);Vh=o(we,"The question encoder can be any "),Fs=s(we,"EM",{});var hv=a(Fs);Kh=o(hv,"autoencoding"),hv.forEach(n),Yh=o(we," model, preferably "),Nn=s(we,"A",{href:!0});var pv=a(Nn);Jh=o(pv,"DPRQuestionEncoder"),pv.forEach(n),Xh=o(we,`, and the generator can be
any `),zs=s(we,"EM",{});var mv=a(zs);Zh=o(mv,"seq2seq"),mv.forEach(n),ep=o(we," model, preferably "),Pn=s(we,"A",{href:!0});var uv=a(Pn);tp=o(uv,"BartForConditionalGeneration"),uv.forEach(n),op=o(we,"."),we.forEach(n),np=l(Q),N=s(Q,"P",{});var U=a(N);rp=o(U,"The model can be initialized with a "),Cn=s(U,"A",{href:!0});var gv=a(Cn);sp=o(gv,"RagRetriever"),gv.forEach(n),ap=o(U,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Id.forEach(n),Gp=l(Q),oe=s(Q,"DIV",{class:!0});var ke=a(oe);b($o.$$.fragment,ke),Ap=l(ke),Be=s(ke,"P",{});var Tr=a(Be);Np=o(Tr,"The "),On=s(Tr,"A",{href:!0});var Fv=a(On);Pp=o(Fv,"RagTokenForGeneration"),Fv.forEach(n),Cp=o(Tr," forward method, overrides the "),Ns=s(Tr,"CODE",{});var zv=a(Ns);Sp=o(zv,"__call__"),zv.forEach(n),Dp=o(Tr," special method."),Tr.forEach(n),Lp=l(ke),b(yt.$$.fragment,ke),Ip=l(ke),Ps=s(ke,"P",{});var $v=a(Ps);Op=o($v,"Example:"),$v.forEach(n),Wp=l(ke),b(Eo.$$.fragment,ke),ke.forEach(n),Hp=l(Q),xt=s(Q,"DIV",{class:!0});var Od=a(xt);b(jo.$$.fragment,Od),Bp=l(Od),Cs=s(Od,"P",{});var Ev=a(Cs);Qp=o(Ev,"Implements RAG token decoding."),Ev.forEach(n),Od.forEach(n),Q.forEach(n),id=l(d),Qe=s(d,"H2",{class:!0});var Wd=a(Qe);Rt=s(Wd,"A",{id:!0,class:!0,href:!0});var jv=a(Rt);Ss=s(jv,"SPAN",{});var Mv=a(Ss);b(Mo.$$.fragment,Mv),Mv.forEach(n),jv.forEach(n),Up=l(Wd),Ds=s(Wd,"SPAN",{});var Gv=a(Ds);Vp=o(Gv,"TFRagModel"),Gv.forEach(n),Wd.forEach(n),cd=l(d),P=s(d,"DIV",{class:!0});var V=a(P);b(Go.$$.fragment,V),Kp=l(V),Ue=s(V,"P",{});var wr=a(Ue);Yp=o(wr,"The "),Wn=s(wr,"A",{href:!0});var Av=a(Wn);Jp=o(Av,"TFRagModel"),Av.forEach(n),Xp=o(wr," forward method, overrides the "),Ls=s(wr,"CODE",{});var Nv=a(Ls);Zp=o(Nv,"__call__"),Nv.forEach(n),em=o(wr," special method."),wr.forEach(n),tm=l(V),b(Ft.$$.fragment,V),om=l(V),Is=s(V,"P",{});var Pv=a(Is);nm=o(Pv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Pv.forEach(n),rm=l(V),he=s(V,"P",{});var qe=a(he);sm=o(qe,"The question encoder can be any "),Os=s(qe,"EM",{});var Cv=a(Os);am=o(Cv,"autoencoding"),Cv.forEach(n),dm=o(qe," model, preferably "),Hn=s(qe,"A",{href:!0});var Sv=a(Hn);im=o(Sv,"TFDPRQuestionEncoder"),Sv.forEach(n),cm=o(qe,`, and the generator can be
...
as the `),Ks=s(K,"CODE",{});var Kv=a(Ks);Mm=o(Kv,"generator"),Kv.forEach(n),Gm=o(K,"."),K.forEach(n),Am=l(V),Ao=s(V,"P",{});var Hd=a(Ao);Nm=o(Hd,"This model inherits from "),Kn=s(Hd,"A",{href:!0});var Yv=a(Kn);Pm=o(Yv,"TFPreTrainedModel"),Yv.forEach(n),Cm=o(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(n),Sm=l(V),No=s(V,"P",{});var Bd=a(No);Dm=o(Bd,"This model is also a Tensorflow "),Po=s(Bd,"A",{href:!0,rel:!0});var Jv=a(Po);Lm=o(Jv,"tf.keras.Model"),Jv.forEach(n),Im=o(Bd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
SavedModel format.`),Xv.forEach(n),Hm=l(V),ne=s(V,"DIV",{class:!0});var ye=a(ne);b(Co.$$.fragment,ye),Bm=l(ye),Ve=s(ye,"P",{});var kr=a(Ve);Qm=o(kr,"The "),Yn=s(kr,"A",{href:!0});var Zv=a(Yn);Um=o(Zv,"TFRagModel"),Zv.forEach(n),Vm=o(kr," forward method, overrides the "),Js=s(kr,"CODE",{});var eb=a(Js);Km=o(eb,"__call__"),eb.forEach(n),Ym=o(kr," special method."),kr.forEach(n),Jm=l(ye),b(zt.$$.fragment,ye),Xm=l(ye),Xs=s(ye,"P",{});var tb=a(Xs);Zm=o(tb,"Example:"),tb.forEach(n),eu=l(ye),b(So.$$.fragment,ye),ye.forEach(n),V.forEach(n),ld=l(d),Ke=s(d,"H2",{class:!0});var Qd=a(Ke);$t=s(Qd,"A",{id:!0,class:!0,href:!0});var ob=a($t);Zs=s(ob,"SPAN",{});var nb=a(Zs);b(Do.$$.fragment,nb),nb.forEach(n),ob.forEach(n),tu=l(Qd),ea=s(Qd,"SPAN",{});var rb=a(ea);ou=o(rb,"TFRagSequenceForGeneration"),rb.forEach(n),Qd.forEach(n),hd=l(d),F=s(d,"DIV",{class:!0});var C=a(F);b(Lo.$$.fragment,C),nu=l(C),Ye=s(C,"P",{});var qr=a(Ye);ru=o(qr,"The "),Jn=s(qr,"A",{href:!0});var sb=a(Jn);su=o(sb,"TFRagSequenceForGeneration"),sb.forEach(n),au=o(qr," forward method, overrides the "),ta=s(qr,"CODE",{});var ab=a(ta);du=o(ab,"__call__"),ab.forEach(n),iu=o(qr," special method."),qr.forEach(n),cu=l(C),b(Et.$$.fragment,C),lu=l(C),oa=s(C,"P",{});var db=a(oa);hu=o(db,"A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),db.forEach(n),pu=l(C),na=s(C,"P",{});var ib=a(na);mu=o(ib,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),aa=s(Y,"EM",{});var ub=a(aa);zu=o(ub,"autoencoding"),ub.forEach(n),$u=o(Y," model as the "),da=s(Y,"CODE",{});var gb=a(da);Eu=o(gb,"question_encoder"),gb.forEach(n),ju=o(Y," and any "),ia=s(Y,"EM",{});var _b=a(ia);Mu=o(_b,"seq2seq"),_b.forEach(n),Gu=o(Y," model with language model head as the "),ca=s(Y,"CODE",{});var fb=a(ca);Au=o(fb,"generator"),fb.forEach(n),Nu=o(Y,`.
It has been tested with `),tr=s(Y,"A",{href:!0});var vb=a(tr);Pu=o(vb,"TFDPRQuestionEncoder"),vb.forEach(n),Cu=o(Y," as the "),la=s(Y,"CODE",{});var bb=a(la);Su=o(bb,"question_encoder"),bb.forEach(n),Du=o(Y," and "),or=s(Y,"A",{href:!0});var Tb=a(or);Lu=o(Tb,"TFBartForConditionalGeneration"),Tb.forEach(n),Iu=o(Y,`
...
SavedModel format.`),yb.forEach(n),eg=l(C),re=s(C,"DIV",{class:!0});var Re=a(re);b(Ho.$$.fragment,Re),tg=l(Re),Je=s(Re,"P",{});var yr=a(Je);og=o(yr,"The "),rr=s(yr,"A",{href:!0});var xb=a(rr);ng=o(xb,"TFRagSequenceForGeneration"),xb.forEach(n),rg=o(yr," forward method, overrides the "),ma=s(yr,"CODE",{});var Rb=a(ma);sg=o(Rb,"__call__"),Rb.forEach(n),ag=o(yr," special method."),yr.forEach(n),dg=l(Re),b(jt.$$.fragment,Re),ig=l(Re),ua=s(Re,"P",{});var Fb=a(ua);cg=o(Fb,"Example:"),Fb.forEach(n),lg=l(Re),b(Bo.$$.fragment,Re),Re.forEach(n),hg=l(C),Mt=s(C,"DIV",{class:!0});var Kd=a(Mt);b(Qo.$$.fragment,Kd),pg=l(Kd),Uo=s(Kd,"P",{});var Yd=a(Uo);mg=o(Yd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),sr=s(Yd,"A",{href:!0});var zb=a(sr);ug=o(zb,"generate()"),zb.forEach(n),gg=o(Yd,"`\ndocumentation for more information on how to set other generate input parameters"),Yd.forEach(n),Kd.forEach(n),C.forEach(n),pd=l(d),Xe=s(d,"H2",{class:!0});var Jd=a(Xe);Gt=s(Jd,"A",{id:!0,class:!0,href:!0});var $b=a(Gt);ga=s($b,"SPAN",{});var Eb=a(ga);b(Vo.$$.fragment,Eb),Eb.forEach(n),$b.forEach(n),_g=l(Jd),_a=s(Jd,"SPAN",{});var jb=a(_a);fg=o(jb,"TFRagTokenForGeneration"),jb.forEach(n),Jd.forEach(n),md=l(d),z=s(d,"DIV",{class:!0});var S=a(z);b(Ko.$$.fragment,S),vg=l(S),Ze=s(S,"P",{});var xr=a(Ze);bg=o(xr,"The "),ar=s(xr,"A",{href:!0});var Mb=a(ar);Tg=o(Mb,"TFRagTokenForGeneration"),Mb.forEach(n),wg=o(xr," forward method, overrides the "),fa=s(xr,"CODE",{});var Gb=a(fa);kg=o(Gb,"__call__"),Gb.forEach(n),qg=o(xr," special method."),xr.forEach(n),yg=l(S),b(At.$$.fragment,S),xg=l(S),va=s(S,"P",{});var Ab=a(va);Rg=o(Ab,"A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Ab.forEach(n),Fg=l(S),ba=s(S,"P",{});var Nb=a(ba);zg=o(Nb,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Nb.forEach(n),$g=l(S),me=s(S,"P",{});var Fe=a(me);Eg=o(Fe,"The question encoder can be any "),Ta=s(Fe,"EM",{});var Pb=a(Ta);jg=o(Pb,"autoencoding"),Pb.forEach(n),Mg=o(Fe," model, preferably "),dr=s(Fe,"A",{href:!0});var Cb=a(dr);Gg=o(Cb,"TFDPRQuestionEncoder"),Cb.forEach(n),Ag=o(Fe,`, and the generator can be
...
SavedModel format.`),Jb.forEach(n),g_=l(S),se=s(S,"DIV",{class:!0});var ze=a(se);b(Zo.$$.fragment,ze),__=l(ze),et=s(ze,"P",{});var Rr=a(et);f_=o(Rr,"The "),mr=s(Rr,"A",{href:!0});var Xb=a(mr);v_=o(Xb,"TFRagTokenForGeneration"),Xb.forEach(n),b_=o(Rr," forward method, overrides the "),$a=s(Rr,"CODE",{});var Zb=a($a);T_=o(Zb,"__call__"),Zb.forEach(n),w_=o(Rr," special method."),Rr.forEach(n),k_=l(ze),b(Nt.$$.fragment,ze),q_=l(ze),Ea=s(ze,"P",{});var eT=a(Ea);y_=o(eT,"Example:"),eT.forEach(n),x_=l(ze),b(en.$$.fragment,ze),ze.forEach(n),R_=l(S),Pt=s(S,"DIV",{class:!0});var ei=a(Pt);b(tn.$$.fragment,ei),F_=l(ei),ja=s(ei,"P",{});var tT=a(ja);z_=o(tT,"Implements TFRAG token decoding."),tT.forEach(n),ei.forEach(n),S.forEach(n),this.h()},h(){i(h,"name","hf:doc:metadata"),i(h,"content",JSON.stringify(bT)),i(f,"id","rag"),i(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(f,"href","#rag"),i(m,"class","relative group"),i(ot,"id","overview"),i(ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(ot,"href","#overview"),i($e,"class","relative group"),i(Dt,"href","https://arxiv.org/abs/2005.11401"),i(Dt,"rel","nofollow"),i(Lt,"href","https://huggingface.co/ola13"),i(Lt,"rel","nofollow"),i(st,"id","transformers.RagConfig"),i(st,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(st,"href","#transformers.RagConfig"),i(Ee,"class","relative group"),i(ln,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagConfig"),i(hn,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),i(pn,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),i(mn,"href","/docs/transformers/master/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),i(at,"class","docstring"),i(un,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig.to_dict"),i(dt,"class","docstring"),i(de,"class","docstring"),i(it,"id","transformers.RagTokenizer"),i(it,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(it,"href","#transformers.RagTokenizer"),i(je,"class","relative group"),i(ct,"class","docstring"),i(Me,"class","docstring"),i(lt,"id","transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"),i(lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(lt,"href","#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"),i(Ge,"class","relative group"),i(Ae,"class","docstring"),i(Xt,"class","docstring"),i(ht,"id","transformers.RagRetriever"),i(ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(ht,"href","#transformers.RagRetriever"),i(Ne,"class","relative group"),i(pt,"class","docstring"),i(mt,"class","docstring"),i(ut,"class","docstring"),i(X,"class","docstring"),i(gt,"id","transformers.RagModel"),i(gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(gt,"href","#transformers.RagModel"),i(Ce,"class","relative group"),i(gn,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagModel"),i(_n,"href","/docs/transformers/master/en/model_doc/dpr#transformers.DPRQuestionEncoder"),i(fn,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartForConditionalGeneration"),i(vn,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagRetriever"),i(bn,"href","/docs/transformers/master/en/model_doc/dpr#transformers.DPRQuestionEncoder"),i(Tn,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartForConditionalGeneration"),i(wn,"href","/docs/transformers/master/en/model_doc/t5#transformers.T5ForConditionalGeneration"),i(kn,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),i(po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),i(po,"rel","nofollow"),i(qn,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagModel"),i(ee,"class","docstring"),i(D,"class","docstring"),i(vt,"id","transformers.RagSequenceForGeneration"),i(vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(vt,"href","#transformers.RagSequenceForGeneration"),i(Le,"class","relative group"),i(yn,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagSequenceForGeneration"),i(xn,"href","/docs/transformers/master/en/model_doc/dpr#transformers.DPRQuestionEncoder"),i(Rn,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartForConditionalGeneration"),i(Fn,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagRetriever"),i(zn,"href","/docs/transformers/master/en/model_doc/dpr#transformers.DPRQuestionEncoder"),i($n,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartForConditionalGeneration"),i(En,"href","/docs/transformers/master/en/model_doc/t5#transformers.T5ForConditionalGeneration"),i(jn,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),i(bo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),i(bo,"rel","nofollow"),i(Mn,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagSequenceForGeneration"),i(te,"class","docstring"),i(Gn,"href","/docs/transformers/master/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),i(wt,"class","docstring"),i(E,"class","docstring"),i(kt,"id","transformers.RagTokenForGeneration"),i(kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(kt,"href","#transformers.RagTokenForGeneration"),i(We,"class","relative group"),i(An,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagTokenForGeneration"),i(Nn,"href","/docs/transformers/master/en/model_doc/dpr#transformers.DPRQuestionEncoder"),i(Pn,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartForConditionalGeneration"),i(Cn,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagRetriever"),i(Sn,"href","/docs/transformers/master/en/model_doc/dpr#transformers.DPRQuestionEncoder"),i(Dn,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartForConditionalGeneration"),i(Ln,"href","/docs/transformers/master/en/model_doc/t5#transformers.T5ForConditionalGeneration"),i(In,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),i(zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),i(zo,"rel","nofollow"),i(On,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagTokenForGeneration"),i(oe,"class","docstring"),i(xt,"class","docstring"),i(j,"class","docstring"),i(Rt,"id","transformers.TFRagModel"),i(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(Rt,"href","#transformers.TFRagModel"),i(Qe,"class","relative group"),i(Wn,"href","/docs/transformers/master/en/model_doc/rag#transformers.TFRagModel"),i(Hn,"href","/docs/transformers/master/en/model_doc/dpr#transformers.TFDPRQuestionEncoder"),i(Bn,"href","/docs/transformers/master/en/model_doc/bart#transformers.TFBartForConditionalGeneration"),i(Qn,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagRetriever"),i(Un,"href","/docs/transformers/master/en/model_doc/dpr#transformers.TFDPRQuestionEncoder"),i(Vn,"href","/docs/transformers/master/en/model_doc/bart#transformers.TFBartForConditionalGeneration"),i(Kn,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),i(Po,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),i(Po,"rel","nofollow"),i(Yn,"href","/docs/transformers/master/en/model_doc/rag#transformers.TFRagModel"),i(ne,"class","docstring"),i(P,"class","docstring"),i($t,"id","transformers.TFRagSequenceForGeneration"),i($t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i($t,"href","#transformers.TFRagSequenceForGeneration"),i(Ke,"class","relative group"),i(Jn,"href","/docs/transformers/master/en/model_doc/rag#transformers.TFRagSequenceForGeneration"),i(Xn,"href","/docs/transformers/master/en/model_doc/dpr#transformers.TFDPRQuestionEncoder"),i(Zn,"href","/docs/transformers/master/en/model_doc/bart#transformers.TFBartForConditionalGeneration"),i(er,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagRetriever"),i(tr,"href","/docs/transformers/master/en/model_doc/dpr#transformers.TFDPRQuestionEncoder"),i(or,"href","/docs/transformers/master/en/model_doc/bart#transformers.TFBartForConditionalGeneration"),i(nr,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),i(Wo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),i(Wo,"rel","nofollow"),i(rr,"href","/docs/transformers/master/en/model_doc/rag#transformers.TFRagSequenceForGeneration"),i(re,"class","docstring"),i(sr,"href","/docs/transformers/master/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),i(Mt,"class","docstring"),i(F,"class","docstring"),i(Gt,"id","transformers.TFRagTokenForGeneration"),i(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),i(Gt,"href","#transformers.TFRagTokenForGeneration"),i(Xe,"class","relative group"),i(ar,"href","/docs/transformers/master/en/model_doc/rag#transformers.TFRagTokenForGeneration"),i(dr,"href","/docs/transformers/master/en/model_doc/dpr#transformers.TFDPRQuestionEncoder"),i(ir,"href","/docs/transformers/master/en/model_doc/bart#transformers.TFBartForConditionalGeneration"),i(cr,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagRetriever"),i(lr,"href","/docs/transformers/master/en/model_doc/dpr#transformers.TFDPRQuestionEncoder"),i(hr,"href","/docs/transformers/master/en/model_doc/bart#transformers.TFBartForConditionalGeneration"),i(pr,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),i(Xo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),i(Xo,"rel","nofollow"),i(mr,"href","/docs/transformers/master/en/model_doc/rag#transformers.TFRagTokenForGeneration"),i(se,"class","docstring"),i(Pt,"class","docstring"),i(z,"class","docstring")},m(d,u){e(document.head,h),_(d,y,u),_(d,m,u),e(m,f),e(f,x),T(g,x,null),e(m,p),e(m,R),e(R,ti),_(d,Ia,u),_(d,$e,u),e($e,ot),e(ot,Fr),T(St,Fr,null),e($e,oi),e($e,zr),e(zr,ni),_(d,Oa,u),_(d,an,u),e(an,ri),_(d,Wa,u),_(d,nt,u),e(nt,si),e(nt,Dt),e(Dt,ai),e(nt,di),_(d,Ha,u),_(d,dn,u),e(dn,ii),_(d,Ba,u),_(d,cn,u),e(cn,$r),e($r,ci),_(d,Qa,u),_(d,rt,u),e(rt,li),e(rt,Lt),e(Lt,hi),e(rt,pi),_(d,Ua,u),_(d,Ee,u),e(Ee,st),e(st,Er),T(It,Er,null),e(Ee,mi),e(Ee,jr),e(jr,ui),_(d,Va,u),_(d,de,u),T(Ot,de,null),e(de,gi),e(de,ue),e(ue,ln),e(ln,_i),e(ue,fi),e(ue,Mr),e(Mr,vi),e(ue,bi),e(ue,hn),e(hn,Ti),e(ue,wi),e(ue,pn),e(pn,ki),e(ue,qi),e(de,yi),e(de,at),T(Wt,at,null),e(at,xi),e(at,Ht),e(Ht,Ri),e(Ht,mn),e(mn,Fi),e(Ht,zi),e(de,$i),e(de,dt),T(Bt,dt,null),e(dt,Ei),e(dt,Qt),e(Qt,ji),e(Qt,un),e(un,Mi),e(Qt,Gi),_(d,Ka,u),_(d,je,u),e(je,it),e(it,Gr),T(Ut,Gr,null),e(je,Ai),e(je,Ar),e(Ar,Ni),_(d,Ya,u),_(d,Me,u),T(Vt,Me,null),e(Me,Pi),e(Me,ct),T(Kt,ct,null),e(ct,Ci),e(ct,Nr),e(Nr,Si),_(d,Ja,u),_(d,Ge,u),e(Ge,lt),e(lt,Pr),T(Yt,Pr,null),e(Ge,Di),e(Ge,Cr),e(Cr,Li),_(d,Xa,u),_(d,Ae,u),T(Jt,Ae,null),e(Ae,Ii),e(Ae,Sr),e(Sr,Oi),_(d,Za,u),_(d,Xt,u),T(Zt,Xt,null),_(d,ed,u),_(d,Ne,u),e(Ne,ht),e(ht,Dr),T(eo,Dr,null),e(Ne,Wi),e(Ne,Lr),e(Lr,Hi),_(d,td,u),_(d,X,u),T(to,X,null),e(X,Bi),e(X,Ir),e(Ir,Qi),e(X,Ui),e(X,Or),e(Or,Vi),e(X,Ki),T(oo,X,null),e(X,Yi),e(X,pt),T(no,pt,null),e(pt,Ji),e(pt,Wr),e(Wr,Xi),e(X,Zi),e(X,mt),T(ro,mt,null),e(mt,ec),e(mt,Pe),e(Pe,tc),e(Pe,Hr),e(Hr,oc),e(Pe,nc),e(Pe,Br),e(Br,rc),e(Pe,sc),e(X,ac),e(X,ut),T(so,ut,null),e(ut,dc),e(ut,ao),e(ao,ic),e(ao,Qr),e(Qr,cc),e(ao,lc),_(d,od,u),_(d,Ce,u),e(Ce,gt),e(gt,Ur),T(io,Ur,null),e(Ce,hc),e(Ce,Vr),e(Vr,pc),_(d,nd,u),_(d,D,u),T(co,D,null),e(D,mc),e(D,Se),e(Se,uc),e(Se,gn),e(gn,gc),e(Se,_c),e(Se,Kr),e(Kr,fc),e(Se,vc),e(D,bc),T(_t,D,null),e(D,Tc),e(D,Yr),e(Yr,wc),e(D,kc),e(D,ie),e(ie,qc),e(ie,Jr),e(Jr,yc),e(ie,xc),e(ie,_n),e(_n,Rc),e(ie,Fc),e(ie,Xr),e(Xr,zc),e(ie,$c),e(ie,fn),e(fn,Ec),e(ie,jc),e(D,Mc),e(D,G),e(G,Gc),e(G,vn),e(vn,Ac),e(G,Nc),e(G,Zr),e(Zr,Pc),e(G,Cc),e(G,es),e(es,Sc),e(G,Dc),e(G,ts),e(ts,Lc),e(G,Ic),e(G,os),e(os,Oc),e(G,Wc),e(G,bn),e(bn,Hc),e(G,Bc),e(G,ns),e(ns,Qc),e(G,Uc),e(G,Tn),e(Tn,Vc),e(G,Kc),e(G,wn),e(wn,Yc),e(G,Jc),e(G,rs),e(rs,Xc),e(G,Zc),e(D,el),e(D,lo),e(lo,tl),e(lo,kn),e(kn,ol),e(lo,nl),e(D,rl),e(D,ho),e(ho,sl),e(ho,po),e(po,al),e(ho,dl),e(D,il),e(D,ee),T(mo,ee,null),e(ee,cl),e(ee,De),e(De,ll),e(De,qn),e(qn,hl),e(De,pl),e(De,ss),e(ss,ml),e(De,ul),e(ee,gl),T(ft,ee,null),e(ee,_l),e(ee,as),e(as,fl),e(ee,vl),T(uo,ee,null),_(d,rd,u),_(d,Le,u),e(Le,vt),e(vt,ds),T(go,ds,null),e(Le,bl),e(Le,is),e(is,Tl),_(d,sd,u),_(d,E,u),T(_o,E,null),e(E,wl),e(E,Ie),e(Ie,kl),e(Ie,yn),e(yn,ql),e(Ie,yl),e(Ie,cs),e(cs,xl),e(Ie,Rl),e(E,Fl),T(bt,E,null),e(E,zl),e(E,ls),e(ls,$l),e(E,El),e(E,hs),e(hs,jl),e(E,Ml),e(E,ce),e(ce,Gl),e(ce,ps),e(ps,Al),e(ce,Nl),e(ce,xn),e(xn,Pl),e(ce,Cl),e(ce,ms),e(ms,Sl),e(ce,Dl),e(ce,Rn),e(Rn,Ll),e(ce,Il),e(E,Ol),e(E,A),e(A,Wl),e(A,Fn),e(Fn,Hl),e(A,Bl),e(A,us),e(us,Ql),e(A,Ul),e(A,gs),e(gs,Vl),e(A,Kl),e(A,_s),e(_s,Yl),e(A,Jl),e(A,fs),e(fs,Xl),e(A,Zl),e(A,zn),e(zn,eh),e(A,th),e(A,vs),e(vs,oh),e(A,nh),e(A,$n),e($n,rh),e(A,sh),e(A,En),e(En,ah),e(A,dh),e(A,bs),e(bs,ih),e(A,ch),e(E,lh),e(E,fo),e(fo,hh),e(fo,jn),e(jn,ph),e(fo,mh),e(E,uh),e(E,vo),e(vo,gh),e(vo,bo),e(bo,_h),e(vo,fh),e(E,vh),e(E,te),T(To,te,null),e(te,bh),e(te,Oe),e(Oe,Th),e(Oe,Mn),e(Mn,wh),e(Oe,kh),e(Oe,Ts),e(Ts,qh),e(Oe,yh),e(te,xh),T(Tt,te,null),e(te,Rh),e(te,ws),e(ws,Fh),e(te,zh),T(wo,te,null),e(E,$h),e(E,wt),T(ko,wt,null),e(wt,Eh),e(wt,qo),e(qo,jh),e(qo,Gn),e(Gn,Mh),e(qo,Gh),_(d,ad,u),_(d,We,u),e(We,kt),e(kt,ks),T(yo,ks,null),e(We,Ah),e(We,qs),e(qs,Nh),_(d,dd,u),_(d,j,u),T(xo,j,null),e(j,Ph),e(j,He),e(He,Ch),e(He,An),e(An,Sh),e(He,Dh),e(He,ys),e(ys,Lh),e(He,Ih),e(j,Oh),T(qt,j,null),e(j,Wh),e(j,xs),e(xs,Hh),e(j,Bh),e(j,Rs),e(Rs,Qh),e(j,Uh),e(j,le),e(le,Vh),e(le,Fs),e(Fs,Kh),e(le,Yh),e(le,Nn),e(Nn,Jh),e(le,Xh),e(le,zs),e(zs,Zh),e(le,ep),e(le,Pn),e(Pn,tp),e(le,op),e(j,np),e(j,N),e(N,rp),e(N,Cn),e(Cn,sp),e(N,ap),e(N,$s),e($s,dp),e(N,ip),e(N,Es),e(Es,cp),e(N,lp),e(N,js),e(js,hp),e(N,pp),e(N,Ms),e(Ms,mp),e(N,up),e(N,Sn),e(Sn,gp),e(N,_p),e(N,Gs),e(Gs,fp),e(N,vp),e(N,Dn),e(Dn,bp),e(N,Tp),e(N,Ln),e(Ln,wp),e(N,kp),e(N,As),e(As,qp),e(N,yp),e(j,xp),e(j,Ro),e(Ro,Rp),e(Ro,In),e(In,Fp),e(Ro,zp),e(j,$p),e(j,Fo),e(Fo,Ep),e(Fo,zo),e(zo,jp),e(Fo,Mp),e(j,Gp),e(j,oe),T($o,oe,null),e(oe,Ap),e(oe,Be),e(Be,Np),e(Be,On),e(On,Pp),e(Be,Cp),e(Be,Ns),e(Ns,Sp),e(Be,Dp),e(oe,Lp),T(yt,oe,null),e(oe,Ip),e(oe,Ps),e(Ps,Op),e(oe,Wp),T(Eo,oe,null),e(j,Hp),e(j,xt),T(jo,xt,null),e(xt,Bp),e(xt,Cs),e(Cs,Qp),_(d,id,u),_(d,Qe,u),e(Qe,Rt),e(Rt,Ss),T(Mo,Ss,null),e(Qe,Up),e(Qe,Ds),e(Ds,Vp),_(d,cd,u),_(d,P,u),T(Go,P,null),e(P,Kp),e(P,Ue),e(Ue,Yp),e(Ue,Wn),e(Wn,Jp),e(Ue,Xp),e(Ue,Ls),e(Ls,Zp),e(Ue,em),e(P,tm),T(Ft,P,null),e(P,om),e(P,Is),e(Is,nm),e(P,rm),e(P,he),e(he,sm),e(he,Os),e(Os,am),e(he,dm),e(he,Hn),e(Hn,im),e(he,cm),e(he,Ws),e(Ws,lm),e(he,hm),e(he,Bn),e(Bn,pm),e(he,mm),e(P,um),e(P,L),e(L,gm),e(L,Qn),e(Qn,_m),e(L,fm),e(L,Hs),e(Hs,vm),e(L,bm),e(L,Bs),e(Bs,Tm),e(L,wm),e(L,Qs),e(Qs,km),e(L,qm),e(L,Us),e(Us,ym),e(L,xm),e(L,Un),e(Un,Rm),e(L,Fm),e(L,Vs),e(Vs,zm),e(L,$m),e(L,Vn),e(Vn,Em),e(L,jm),e(L,Ks),e(Ks,Mm),e(L,Gm),e(P,Am),e(P,Ao),e(Ao,Nm),e(Ao,Kn),e(Kn,Pm),e(Ao,Cm),e(P,Sm),e(P,No),e(No,Dm),e(No,Po),e(Po,Lm),e(No,Im),e(P,Om),e(P,Ys),e(Ys,Wm),e(P,Hm),e(P,ne),T(Co,ne,null),e(ne,Bm),e(ne,Ve),e(Ve,Qm),e(Ve,Yn),e(Yn,Um),e(Ve,Vm),e(Ve,Js),e(Js,Km),e(Ve,Ym),e(ne,Jm),T(zt,ne,null),e(ne,Xm),e(ne,Xs),e(Xs,Zm),e(ne,eu),T(So,ne,null),_(d,ld,u),_(d,Ke,u),e(Ke,$t),e($t,Zs),T(Do,Zs,null),e(Ke,tu),e(Ke,ea),e(ea,ou),_(d,hd,u),_(d,F,u),T(Lo,F,null),e(F,nu),e(F,Ye),e(Ye,ru),e(Ye,Jn),e(Jn,su),e(Ye,au),e(Ye,ta),e(ta,du),e(Ye,iu),e(F,cu),T(Et,F,null),e(F,lu),e(F,oa),e(oa,hu),e(F,pu),e(F,na),e(na,mu),e(F,uu),e(F,pe),e(pe,gu),e(pe,ra),e(ra,_u),e(pe,fu),e(pe,Xn),e(Xn,vu),e(pe,bu),e(pe,sa),e(sa,Tu),e(pe,wu),e(pe,Zn),e(Zn,ku),e(pe,qu),e(F,yu),e(F,I),e(I,xu),e(I,er),e(er,Ru),e(I,Fu),e(I,aa),e(aa,zu),e(I,$u),e(I,da),e(da,Eu),e(I,ju),e(I,ia),e(ia,Mu),e(I,Gu),e(I,ca),e(ca,Au),e(I,Nu),e(I,tr),e(tr,Pu),e(I,Cu),e(I,la),e(la,Su),e(I,Du),e(I,or),e(or,Lu),e(I,Iu),e(I,ha),e(ha,Ou),e(I,Wu),e(F,Hu),e(F,Io),e(Io,Bu),e(Io,nr),e(nr,Qu),e(Io,Uu),e(F,Vu),e(F,Oo),e(Oo,Ku),e(Oo,Wo),e(Wo,Yu),e(Oo,Ju),e(F,Xu),e(F,pa),e(pa,Zu),e(F,eg),e(F,re),T(Ho,re,null),e(re,tg),e(re,Je),e(Je,og),e(Je,rr),e(rr,ng),e(Je,rg),e(Je,ma),e(ma,sg),e(Je,ag),e(re,dg),T(jt,re,null),e(re,ig),e(re,ua),e(ua,cg),e(re,lg),T(Bo,re,null),e(F,hg),e(F,Mt),T(Qo,Mt,null),e(Mt,pg),e(Mt,Uo),e(Uo,mg),e(Uo,sr),e(sr,ug),e(Uo,gg),_(d,pd,u),_(d,Xe,u),e(Xe,Gt),e(Gt,ga),T(Vo,ga,null),e(Xe,_g),e(Xe,_a),e(_a,fg),_(d,md,u),_(d,z,u),T(Ko,z,null),e(z,vg),e(z,Ze),e(Ze,bg),e(Ze,ar),e(ar,Tg),e(Ze,wg),e(Ze,fa),e(fa,kg),e(Ze,qg),e(z,yg),T(At,z,null),e(z,xg),e(z,va),e(va,Rg),e(z,Fg),e(z,ba),e(ba,zg),e(z,$g),e(z,me),e(me,Eg),e(me,Ta),e(Ta,jg),e(me,Mg),e(me,dr),e(dr,Gg),e(me,Ag),e(me,wa),e(wa,Ng),e(me,Pg),e(me,ir),e(ir,Cg),e(me,Sg),e(z,Dg),e(z,O),e(O,Lg),e(O,cr),e(cr,Ig),e(O,Og),e(O,ka),e(ka,Wg),e(O,Hg),e(O,qa),e(qa,Bg),e(O,Qg),e(O,ya),e(ya,Ug),e(O,Vg),e(O,xa),e(xa,Kg),e(O,Yg),e(O,lr),e(lr,Jg),e(O,Xg),e(O,Ra),e(Ra,Zg),e(O,e_),e(O,hr),e(hr,t_),e(O,o_),e(O,Fa),e(Fa,n_),e(O,r_),e(z,s_),e(z,Yo),e(Yo,a_),e(Yo,pr),e(pr,d_),e(Yo,i_),e(z,c_),e(z,Jo),e(Jo,l_),e(Jo,Xo),e(Xo,h_),e(Jo,p_),e(z,m_),e(z,za),e(za,u_),e(z,g_),e(z,se),T(Zo,se,null),e(se,__),e(se,et),e(et,f_),e(et,mr),e(mr,v_),e(et,b_),e(et,$a),e($a,T_),e(et,w_),e(se,k_),T(Nt,se,null),e(se,q_),e(se,Ea),e(Ea,y_),e(se,x_),T(en,se,null),e(z,R_),e(z,Pt),T(tn,Pt,null),e(Pt,F_),e(Pt,ja),e(ja,z_),ud=!0},p(d,[u]){const on={};u&2&&(on.$$scope={dirty:u,ctx:d}),_t.$set(on);const Ma={};u&2&&(Ma.$$scope={dirty:u,ctx:d}),ft.$set(Ma);const Ga={};u&2&&(Ga.$$scope={dirty:u,ctx:d}),bt.$set(Ga);const Aa={};u&2&&(Aa.$$scope={dirty:u,ctx:d}),Tt.$set(Aa);const nn={};u&2&&(nn.$$scope={dirty:u,ctx:d}),qt.$set(nn);const Na={};u&2&&(Na.$$scope={dirty:u,ctx:d}),yt.$set(Na);const Pa={};u&2&&(Pa.$$scope={dirty:u,ctx:d}),Ft.$set(Pa);const Ca={};u&2&&(Ca.$$scope={dirty:u,ctx:d}),zt.$set(Ca);const Sa={};u&2&&(Sa.$$scope={dirty:u,ctx:d}),Et.$set(Sa);const rn={};u&2&&(rn.$$scope={dirty:u,ctx:d}),jt.$set(rn);const Da={};u&2&&(Da.$$scope={dirty:u,ctx:d}),At.$set(Da);const La={};u&2&&(La.$$scope={dirty:u,ctx:d}),Nt.$set(La)},i(d){ud||(w(g.$$.fragment,d),w(St.$$.fragment,d),w(It.$$.fragment,d),w(Ot.$$.fragment,d),w(Wt.$$.fragment,d),w(Bt.$$.fragment,d),w(Ut.$$.fragment,d),w(Vt.$$.fragment,d),w(Kt.$$.fragment,d),w(Yt.$$.fragment,d),w(Jt.$$.fragment,d),w(Zt.$$.fragment,d),w(eo.$$.fragment,d),w(to.$$.fragment,d),w(oo.$$.fragment,d),w(no.$$.fragment,d),w(ro.$$.fragment,d),w(so.$$.fragment,d),w(io.$$.fragment,d),w(co.$$.fragment,d),w(_t.$$.fragment,d),w(mo.$$.fragment,d),w(ft.$$.fragment,d),w(uo.$$.fragment,d),w(go.$$.fragment,d),w(_o.$$.fragment,d),w(bt.$$.fragment,d),w(To.$$.fragment,d),w(Tt.$$.fragment,d),w(wo.$$.fragment,d),w(ko.$$.fragment,d),w(yo.$$.fragment,d),w(xo.$$.fragment,d),w(qt.$$.fragment,d),w($o.$$.fragment,d),w(yt.$$.fragment,d),w(Eo.$$.fragment,d),w(jo.$$.fragment,d),w(Mo.$$.fragment,d),w(Go.$$.fragment,d),w(Ft.$$.fragment,d),w(Co.$$.fragment,d),w(zt.$$.fragment,d),w(So.$$.fragment,d),w(Do.$$.fragment,d),w(Lo.$$.fragment,d),w(Et.$$.fragment,d),w(Ho.$$.fragment,d),w(jt.$$.fragment,d),w(Bo.$$.fragment,d),w(Qo.$$.fragment,d),w(Vo.$$.fragment,d),w(Ko.$$.fragment,d),w(At.$$.fragment,d),w(Zo.$$.fragment,d),w(Nt.$$.fragment,d),w(en.$$.fragment,d),w(tn.$$.fragment,d),ud=!0)},o(d){k(g.$$.fragment,d),k(St.$$.fragment,d),k(It.$$.fragment,d),k(Ot.$$.fragment,d),k(Wt.$$.fragment,d),k(Bt.$$.fragment,d),k(Ut.$$.fragment,d),k(Vt.$$.fragment,d),k(Kt.$$.fragment,d),k(Yt.$$.fragment,d),k(Jt.$$.fragment,d),k(Zt.$$.fragment,d),k(eo.$$.fragment,d),k(to.$$.fragment,d),k(oo.$$.fragment,d),k(no.$$.fragment,d),k(ro.$$.fragment,d),k(so.$$.fragment,d),k(io.$$.fragment,d),k(co.$$.fragment,d),k(_t.$$.fragment,d),k(mo.$$.fragment,d),k(ft.$$.fragment,d),k(uo.$$.fragment,d),k(go.$$.fragment,d),k(_o.$$.fragment,d),k(bt.$$.fragment,d),k(To.$$.fragment,d),k(Tt.$$.fragment,d),k(wo.$$.fragment,d),k(ko.$$.fragment,d),k(yo.$$.fragment,d),k(xo.$$.fragment,d),k(qt.$$.fragment,d),k($o.$$.fragment,d),k(yt.$$.fragment,d),k(Eo.$$.fragment,d),k(jo.$$.fragment,d),k(Mo.$$.fragment,d),k(Go.$$.fragment,d),k(Ft.$$.fragment,d),k(Co.$$.fragment,d),k(zt.$$.fragment,d),k(So.$$.fragment,d),k(Do.$$.fragment,d),k(Lo.$$.fragment,d),k(Et.$$.fragment,d),k(Ho.$$.fragment,d),k(jt.$$.fragment,d),k(Bo.$$.fragment,d),k(Qo.$$.fragment,d),k(Vo.$$.fragment,d),k(Ko.$$.fragment,d),k(At.$$.fragment,d),k(Zo.$$.fragment,d),k(Nt.$$.fragment,d),k(en.$$.fragment,d),k(tn.$$.fragment,d),ud=!1},d(d){n(h),d&&n(y),d&&n(m),q(g),d&&n(Ia),d&&n($e),q(St),d&&n(Oa),d&&n(an),d&&n(Wa),d&&n(nt),d&&n(Ha),d&&n(dn),d&&n(Ba),d&&n(cn),d&&n(Qa),d&&n(rt),d&&n(Ua),d&&n(Ee),q(It),d&&n(Va),d&&n(de),q(Ot),q(Wt),q(Bt),d&&n(Ka),d&&n(je),q(Ut),d&&n(Ya),d&&n(Me),q(Vt),q(Kt),d&&n(Ja),d&&n(Ge),q(Yt),d&&n(Xa),d&&n(Ae),q(Jt),d&&n(Za),d&&n(Xt),q(Zt),d&&n(ed),d&&n(Ne),q(eo),d&&n(td),d&&n(X),q(to),q(oo),q(no),q(ro),q(so),d&&n(od),d&&n(Ce),q(io),d&&n(nd),d&&n(D),q(co),q(_t),q(mo),q(ft),q(uo),d&&n(rd),d&&n(Le),q(go),d&&n(sd),d&&n(E),q(_o),q(bt),q(To),q(Tt),q(wo),q(ko),d&&n(ad),d&&n(We),q(yo),d&&n(dd),d&&n(j),q(xo),q(qt),q($o),q(yt),q(Eo),q(jo),d&&n(id),d&&n(Qe),q(Mo),d&&n(cd),d&&n(P),q(Go),q(Ft),q(Co),q(zt),q(So),d&&n(ld),d&&n(Ke),q(Do),d&&n(hd),d&&n(F),q(Lo),q(Et),q(Ho),q(jt),q(Bo),q(Qo),d&&n(pd),d&&n(Xe),q(Vo),d&&n(md),d&&n(z),q(Ko),q(At),q(Zo),q(Nt),q(en),q(tn)}}}const bT={local:"rag",sections:[{local:"overview",title:"Overview"},{local:"transformers.RagConfig",title:"RagConfig"},{local:"transformers.RagTokenizer",title:"RagTokenizer"},{local:"transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput",title:"Rag specific outputs"},{local:"transformers.RagRetriever",title:"RagRetriever"},{local:"transformers.RagModel",title:"RagModel"},{local:"transformers.RagSequenceForGeneration",title:"RagSequenceForGeneration"},{local:"transformers.RagTokenForGeneration",title:"RagTokenForGeneration"},{local:"transformers.TFRagModel",title:"TFRagModel"},{local:"transformers.TFRagSequenceForGeneration",title:"TFRagSequenceForGeneration"},{local:"transformers.TFRagTokenForGeneration",title:"TFRagTokenForGeneration"}],title:"RAG"};function TT($,h,y){let{fw:m}=h;return $.$$set=f=>{"fw"in f&&y(0,m=f.fw)},[m]}class RT extends oT{constructor(h){super();nT(this,h,TT,vT,rT,{fw:0})}}export{RT as default,bT as metadata};
