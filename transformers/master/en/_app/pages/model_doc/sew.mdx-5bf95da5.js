import{S as yn,i as Sn,s as Wn,e as s,k as c,w as v,t as r,M as kn,c as a,d as o,m as d,a as n,x as w,h as i,b as l,F as e,g as f,y as b,q as E,o as y,B as S}from"../../chunks/vendor-4833417e.js";import{T as ka}from"../../chunks/Tip-fffd6df1.js";import{D as Je}from"../../chunks/Docstring-4f315ed9.js";import{C as ft}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ht}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Cn(I){let p,W,h,_,k;return{c(){p=s("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),_=r("Module"),k=r(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">9.52</span>`}}),{c(){p=s("meta"),W=c(),h=s("h1"),_=s("a"),k=s("span"),v(u.$$.fragment),g=c(),P=s("span"),vo=r("SEW"),Vt=c(),N=s("h2"),Z=s("a"),ut=s("span"),v(de.$$.fragment),wo=c(),gt=s("span"),bo=r("Overview"),Ot=c(),ee=s("p"),Eo=r("SEW (Squeezed and Efficient Wav2Vec) was proposed in "),me=s("a"),yo=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training
for Speech Recognition`),So=r(` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q.
Weinberger, Yoav Artzi.`),Lt=c(),Qe=s("p"),Wo=r("The abstract from the paper is the following:"),It=c(),Be=s("p"),_t=s("em"),ko=r(`This paper is a study of performance-efficiency trade-offs in pre-trained models for automatic speech recognition
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Os=c(),T=s("div"),v(Fe.$$.fragment),Ls=c(),Y=s("p"),Is=r("The "),at=s("a"),Ns=r("SEWForCTC"),Ks=r(" forward method, overrides the "),jt=s("code"),Hs=r("__call__"),Rs=r(" special method."),Us=c(),v(ie.$$.fragment),Js=c(),qt=s("p"),Qs=r("Example:"),Bs=c(),v(Me.$$.fragment),Ys=c(),v(ze.$$.fragment),Gt=c(),G=s("h2"),le=s("a"),xt=s("span"),v(Ae.$$.fragment),Gs=c(),Pt=s("span"),Xs=r("SEWForSequenceClassification"),Xt=c(),C=s("div"),v(De.$$.fragment),Zs=c(),Ft=s("p"),ea=r(`SEW Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),ta=c(),Ve=s("p"),oa=r("SEW was proposed in "),Oe=s("a"),sa=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),aa=r(` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),na=c(),Le=s("p"),ra=r("This model inherits from "),nt=s("a"),ia=r("PreTrainedModel"),la=r(`. Check the superclass documentation for the generic methods the
...
`),Ge=a(so,"A",{href:!0});var Aa=n(Ge);qo=i(Aa,"Wav2Vec2CTCTokenizer"),Aa.forEach(o),xo=i(so,"."),so.forEach(o),oo.forEach(o),Ht=d(t),oe=a(t,"P",{});var ao=n(oe);Po=i(ao,"This model was contributed by "),fe=a(ao,"A",{href:!0,rel:!0});var Da=n(fe);Fo=i(Da,"anton-l"),Da.forEach(o),Mo=i(ao,"."),ao.forEach(o),Rt=d(t),K=a(t,"H2",{class:!0});var no=n(K);se=a(no,"A",{id:!0,class:!0,href:!0});var Va=n(se);wt=a(Va,"SPAN",{});var Oa=n(wt);w(he.$$.fragment,Oa),Oa.forEach(o),Va.forEach(o),zo=d(no),bt=a(no,"SPAN",{});var La=n(bt);Ao=i(La,"SEWConfig"),La.forEach(o),no.forEach(o),Ut=d(t),j=a(t,"DIV",{class:!0});var D=n(j);w(ue.$$.fragment,D),Do=d(D),H=a(D,"P",{});var it=n(H);Vo=i(it,"This is the configuration class to store the configuration of a "),Xe=a(it,"A",{href:!0});var Ia=n(Xe);Oo=i(Ia,"SEWModel"),Ia.forEach(o),Lo=i(it,`. It is used to instantiate a SEW model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the SEW
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),ps=d(V),F=a(V,"DIV",{class:!0});var O=n(F);w(ke.$$.fragment,O),fs=d(O),J=a(O,"P",{});var ct=n(J);hs=i(ct,"The "),ot=a(ct,"A",{href:!0});var Xa=n(ot);us=i(Xa,"SEWModel"),Xa.forEach(o),gs=i(ct," forward method, overrides the "),Wt=a(ct,"CODE",{});var Za=n(Wt);_s=i(Za,"__call__"),Za.forEach(o),vs=i(ct," special method."),ct.forEach(o),ws=d(O),w(ne.$$.fragment,O),bs=d(O),kt=a(O,"P",{});var en=n(kt);Es=i(en,"Example:"),en.forEach(o),ys=d(O),w(Ce.$$.fragment,O),O.forEach(o),V.forEach(o),Bt=d(t),Q=a(t,"H2",{class:!0});var mo=n(Q);re=a(mo,"A",{id:!0,class:!0,href:!0});var tn=n(re);Ct=a(tn,"SPAN",{});var on=n(Ct);w(Te.$$.fragment,on),on.forEach(o),tn.forEach(o),Ss=d(mo),Tt=a(mo,"SPAN",{});var sn=n(Tt);Ws=i(sn,"SEWForCTC"),sn.forEach(o),mo.forEach(o),Yt=d(t),x=a(t,"DIV",{class:!0});var L=n(x);w($e.$$.fragment,L),ks=d(L),B=a(L,"P",{});var dt=n(B);Cs=i(dt,"SEW Model with a "),$t=a(dt,"CODE",{});var an=n($t);Ts=i(an,"language modeling"),an.forEach(o),$s=i(dt,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),dt.forEach(o),xs=d(L),qe=a(L,"P",{});var po=n(qe);Ps=i(po,"This model inherits from "),st=a(po,"A",{href:!0});var rn=n(st);Fs=i(rn,"PreTrainedModel"),rn.forEach(o),Ms=i(po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),zs=d(L),xe=a(L,"P",{});var fo=n(xe);As=i(fo,"This model is a PyTorch "),Pe=a(fo,"A",{href:!0,rel:!0});var ln=n(Pe);Ds=i(ln,"torch.nn.Module"),ln.forEach(o),Vs=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),Os=d(L),T=a(L,"DIV",{class:!0});var M=n(T);w(Fe.$$.fragment,M),Ls=d(M),Y=a(M,"P",{});var mt=n(Y);Is=i(mt,"The "),at=a(mt,"A",{href:!0});var cn=n(at);Ns=i(cn,"SEWForCTC"),cn.forEach(o),Ks=i(mt," forward method, overrides the "),jt=a(mt,"CODE",{});var dn=n(jt);Hs=i(dn,"__call__"),dn.forEach(o),Rs=i(mt," special method."),mt.forEach(o),Us=d(M),w(ie.$$.fragment,M),Js=d(M),qt=a(M,"P",{});var mn=n(qt);Qs=i(mn,"Example:"),mn.forEach(o),Bs=d(M),w(Me.$$.fragment,M),Ys=d(M),w(ze.$$.fragment,M),M.forEach(o),L.forEach(o),Gt=d(t),G=a(t,"H2",{class:!0});var ho=n(G);le=a(ho,"A",{id:!0,class:!0,href:!0});var pn=n(le);xt=a(pn,"SPAN",{});var fn=n(xt);w(Ae.$$.fragment,fn),fn.forEach(o),pn.forEach(o),Gs=d(ho),Pt=a(ho,"SPAN",{});var hn=n(Pt);Xs=i(hn,"SEWForSequenceClassification"),hn.forEach(o),ho.forEach(o),Xt=d(t),C=a(t,"DIV",{class:!0});var z=n(C);w(De.$$.fragment,z),Zs=d(z),Ft=a(z,"P",{});var un=n(Ft);ea=i(un,`SEW Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),un.forEach(o),ta=d(z),Ve=a(z,"P",{});var uo=n(Ve);oa=i(uo,"SEW was proposed in "),Oe=a(uo,"A",{href:!0,rel:!0});var gn=n(Oe);sa=i(gn,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),gn.forEach(o),aa=i(uo,` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),uo.forEach(o),na=d(z),Le=a(z,"P",{});var go=n(Le);ra=i(go,"This model inherits from "),nt=a(go,"A",{href:!0});var _n=n(nt);ia=i(_n,"PreTrainedModel"),_n.forEach(o),la=i(go,`. Check the superclass documentation for the generic methods the
