import{S as Sw,i as Ow,s as Gw,e as o,k as d,w as f,t as r,M as Bw,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as p,y as g,q as T,o as k,B as v}from"../../chunks/vendor-4833417e.js";import{T as $t}from"../../chunks/Tip-fffd6df1.js";import{D as M}from"../../chunks/Docstring-7b52c3d4.js";import{C as R}from"../../chunks/CodeBlock-90ffda97.js";import{I as xe}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function Uw(I){let u,x,b,y,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),y=r("Module"),z=r(`
...
loss = model(input_ids=input_ids, labels=labels).loss`}}),xo=new R({props:{codee:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
<span class="hljs-comment"># the forward function automatically creates the correct decoder_input_ids</span>
loss = model(input_ids=input_ids, labels=labels).loss`}}),qo=new R({props:{codee:`from transformers import T5Tokenizer, T5ForConditionalGeneration
import torch
...
loss = model(input_ids=input_ids, attention_mask=attention_mask, labels=labels).loss`}}),Co=new xe({}),Io=new R({props:{codee:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
<span class="hljs-comment"># Das Haus ist wunderbar.</span>`}}),Lo=new R({props:{codee:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`}}),On=new $t({props:{$$slots:{default:[Uw]},$$scope:{ctx:I}}}),bs=new R({props:{codee:`from transformers import T5Tokenizer, T5Model
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}]}}),ys=new R({props:{codee:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
...
model.parallelize(device_map)`}}),$s=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/t5/modeling_t5.py#L1289"}}),zs=new R({props:{codee:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
`}}),Bn=new $t({props:{$$slots:{default:[Ww]},$$scope:{ctx:I}}}),Ns=new R({props:{codee:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}]}}),Ls=new R({props:{codee:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Ds=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/t5/modeling_t5.py#L1484"}}),Ss=new R({props:{codee:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
`}}),Wn=new $t({props:{$$slots:{default:[Rw]},$$scope:{ctx:I}}}),Ks=new R({props:{codee:`from transformers import T5Tokenizer, T5EncoderModel
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}]}}),Zs=new R({props:{codee:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Js=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/t5/modeling_t5.py#L1760"}}),Xs=new R({props:{codee:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
`}}),Vn=new $t({props:{$$slots:{default:[Vw]},$$scope:{ctx:I}}}),ia=new R({props:{codee:`from transformers import T5Tokenizer, TFT5Model
...
`}}),Zn=new $t({props:{$$slots:{default:[Yw]},$$scope:{ctx:I}}}),ga=new R({props:{codee:`from transformers import T5Tokenizer, TFT5ForConditionalGeneration
...
`}}),Qn=new $t({props:{$$slots:{default:[Jw]},$$scope:{ctx:I}}}),xa=new R({props:{codee:`from transformers import T5Tokenizer, TFT5EncoderModel
...
`}}),to=new $t({props:{$$slots:{default:[Xw]},$$scope:{ctx:I}}}),Fa=new R({props:{codee:`from transformers import T5Tokenizer, FlaxT5Model
...
`}}),Pa=new R({props:{codee:`from transformers import T5Tokenizer, FlaxT5ForConditionalGeneration
...
`}}),Aa=new R({props:{codee:`from transformers import T5Tokenizer, FlaxT5ForConditionalGeneration
...
`}}),oo=new $t({props:{$$slots:{default:[Qw]},$$scope:{ctx:I}}}),Da=new R({props:{codee:`from transformers import T5Tokenizer, FlaxT5ForConditionalGeneration
...
`}}),Ba=new R({props:{codee:`from transformers import T5Tokenizer, FlaxT5ForConditionalGeneration
import jax.numpy as jnp
