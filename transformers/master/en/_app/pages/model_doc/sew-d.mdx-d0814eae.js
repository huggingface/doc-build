...
library implements for all its model (such as downloading or saving etc.).`),cs=d(),Ie=n("p"),ms=r("This model is a PyTorch "),Ne=n("a"),ps=r("torch.nn.Module"),fs=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),hs=d(),T=n("div"),v(Ke.$$.fragment),us=d(),X=n("p"),gs=r("The "),rt=n("a"),_s=r("SEWDForSequenceClassification"),vs=r(" forward method, overrides the "),Ft=n("code"),ws=r("__call__"),bs=r(" special method."),ys=d(),v(de.$$.fragment),Es=d(),Mt=n("p"),Ss=r("Example:"),Ws=d(),v(He.$$.fragment),Ds=d(),v(Re.$$.fragment),this.h()},l(t){const m=Da('[data-svelte="svelte-1phssyn"]',document.head);p=s(m,"META",{name:!0,content:!0}),m.forEach(o),W=c(t),h=s(t,"H1",{class:!0});var Ue=a(h);_=s(Ue,"A",{id:!0,class:!0,href:!0});var zt=a(_);D=s(zt,"SPAN",{});var At=a(D);w(u.$$.fragment,At),At.forEach(o),zt.forEach(o),g=c(Ue),j=s(Ue,"SPAN",{});var Cs=a(j);vo=i(Cs,"SEW-D"),Cs.forEach(o),Ue.forEach(o),Vt=c(t),N=s(t,"H2",{class:!0});var eo=a(N);Z=s(eo,"A",{id:!0,class:!0,href:!0});var Ts=a(Z);ut=s(Ts,"SPAN",{});var $s=a(ut);w(ce.$$.fragment,$s),$s.forEach(o),Ts.forEach(o),wo=c(eo),gt=s(eo,"SPAN",{});var qs=a(gt);bo=i(qs,"Overview"),qs.forEach(o),eo.forEach(o),Ot=c(t),ee=s(t,"P",{});var to=a(ee);yo=i(to,"SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),me=s(to,"A",{href:!0,rel:!0});var xs=a(me);Eo=i(xs,`Performance-Efficiency Trade-offs
...
library implements for all its model (such as downloading or saving etc.).`),lo.forEach(o),dn=c(V),Se=s(V,"P",{});var co=a(Se);cn=i(co,"This model is a PyTorch "),We=s(co,"A",{href:!0,rel:!0});var Xs=a(We);mn=i(Xs,"torch.nn.Module"),Xs.forEach(o),pn=i(co,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(V),P=s(V,"DIV",{class:!0});var O=a(P);w(De.$$.fragment,O),hn=c(O),J=s(O,"P",{});var dt=a(J);un=i(dt,"The "),ot=s(dt,"A",{href:!0});var Zs=a(ot);gn=i(Zs,"SEWDModel"),Zs.forEach(o),_n=i(dt," forward method, overrides the "),Wt=s(dt,"CODE",{});var ea=a(Wt);vn=i(ea,"__call__"),ea.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(O),w(ae.$$.fragment,O),yn=c(O),Dt=s(O,"P",{});var ta=a(Dt);En=i(ta,"Example:"),ta.forEach(o),Sn=c(O),w(ke.$$.fragment,O),O.forEach(o),V.forEach(o),Bt=c(t),Q=s(t,"H2",{class:!0});var mo=a(Q);re=s(mo,"A",{id:!0,class:!0,href:!0});var oa=a(re);kt=s(oa,"SPAN",{});var na=a(kt);w(Ce.$$.fragment,na),na.forEach(o),oa.forEach(o),Wn=c(mo),Ct=s(mo,"SPAN",{});var sa=a(Ct);Dn=i(sa,"SEWDForCTC"),sa.forEach(o),mo.forEach(o),Yt=c(t),x=s(t,"DIV",{class:!0});var L=a(x);w(Te.$$.fragment,L),kn=c(L),B=s(L,"P",{});var ct=a(B);Cn=i(ct,"SEW-D Model with a "),Tt=s(ct,"CODE",{});var aa=a(Tt);Tn=i(aa,"language modeling"),aa.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),ct.forEach(o),jn=c(L),qe=s(L,"P",{});var po=a(qe);Pn=i(po,"This model inherits from "),nt=s(po,"A",{href:!0});var ia=a(nt);Fn=i(ia,"PreTrainedModel"),ia.forEach(o),Mn=i(po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),zn=c(L),xe=s(L,"P",{});var fo=a(xe);An=i(fo,"This model is a PyTorch "),je=s(fo,"A",{href:!0,rel:!0});var la=a(je);Vn=i(la,"torch.nn.Module"),la.forEach(o),On=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),Ln=c(L),C=s(L,"DIV",{class:!0});var F=a(C);w(Pe.$$.fragment,F),In=c(F),Y=s(F,"P",{});var mt=a(Y);Nn=i(mt,"The "),st=s(mt,"A",{href:!0});var da=a(st);Kn=i(da,"SEWDForCTC"),da.forEach(o),Hn=i(mt," forward method, overrides the "),$t=s(mt,"CODE",{});var ca=a($t);Rn=i(ca,"__call__"),ca.forEach(o),Un=i(mt," special method."),mt.forEach(o),Jn=c(F),w(ie.$$.fragment,F),Qn=c(F),qt=s(F,"P",{});var ma=a(qt);Bn=i(ma,"Example:"),ma.forEach(o),Yn=c(F),w(Fe.$$.fragment,F),Gn=c(F),w(Me.$$.fragment,F),F.forEach(o),L.forEach(o),Gt=c(t),G=s(t,"H2",{class:!0});var ho=a(G);le=s(ho,"A",{id:!0,class:!0,href:!0});var pa=a(le);xt=s(pa,"SPAN",{});var fa=a(xt);w(ze.$$.fragment,fa),fa.forEach(o),pa.forEach(o),Xn=c(ho),jt=s(ho,"SPAN",{});var ha=a(jt);Zn=i(ha,"SEWDForSequenceClassification"),ha.forEach(o),ho.forEach(o),Xt=c(t),k=s(t,"DIV",{class:!0});var M=a(k);w(Ae.$$.fragment,M),es=c(M),Pt=s(M,"P",{});var ua=a(Pt);ts=i(ua,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
