...
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Ab=a(or);lh=i(Ab,"here"),Ab.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Pb.forEach(t),Sr.forEach(t),Zl=l(n),qn=s(n,"P",{});var Bc=a(qn);ph=i(Bc,"All checkpoints can be found on the "),yo=s(Bc,"A",{href:!0,rel:!0});var Nb=a(yo);hh=i(Nb,"hub"),Nb.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),Et=s(n,"P",{});var Or=a(Et);mh=i(Or,"This model was contributed by "),$o=s(Or,"A",{href:!0,rel:!0});var Ib=a($o);fh=i(Ib,"thomwolf"),Ib.forEach(t),_h=i(Or,". The original code can be found "),zo=s(Or,"A",{href:!0,rel:!0});var Lb=a(zo);gh=i(Lb,"here"),Lb.forEach(t),Th=i(Or,"."),Or.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Jt=s(n,"H2",{class:!0});var Uc=a(Jt);jn=s(Uc,"A",{id:!0,class:!0,href:!0});var Db=a(jn);yi=s(Db,"SPAN",{});var Sb=a(yi);_(xo.$$.fragment,Sb),Sb.forEach(t),Db.forEach(t),kh=l(Uc),$i=s(Uc,"SPAN",{});var Ob=a($i);vh=i(Ob,"Training"),Ob.forEach(t),Uc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
`),Pi=s(tt,"CODE",{});var Yb=a(Pi);Oh=i(Yb,"<extra_id_1>"),Yb.forEach(t),Gh=i(tt,", \u2026 up to "),Ci=s(tt,"CODE",{});var Jb=a(Ci);Bh=i(Jb,"<extra_id_99>"),Jb.forEach(t),Uh=i(tt,`. As a default, 100 sentinel tokens are available in
`),rr=s(tt,"A",{href:!0});var Zb=a(rr);Wh=i(Zb,"T5Tokenizer"),Zb.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(It),Ai=s(It,"P",{});var Xb=a(Ai);Vh=i(Xb,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),Xb.forEach(t),Kh=l(It),_(Eo.$$.fragment,It),Yh=l(It),qo=s(It,"P",{});var Hc=a(qo);Jh=i(Hc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=s(Hc,"A",{href:!0,rel:!0});var Qb=a(jo);Zh=i(Qb,"run_t5_mlm_flax.py"),Qb.forEach(t),Xh=i(Hc,` script in the Examples
...
(`),Jo=s(wt,"A",{href:!0,rel:!0});var Q5=a(Jo);Rm=i(Q5,"PyTorch"),Q5.forEach(t),Hm=i(wt," and "),Zo=s(wt,"A",{href:!0,rel:!0});var e1=a(Zo);Vm=i(e1,"Tensorflow"),e1.forEach(t),Km=i(wt,`). These scripts allow
