import{S as Es,i as Ss,s as Ws,e as n,k as d,w as v,t as r,R as Ds,c as a,d as o,m as c,a as s,x as w,h as i,b as l,F as e,g as f,y as b,q as y,o as E,B as S}from"../../chunks/vendor-9daddcfa.js";import{T as ka}from"../../chunks/Tip-c0a70391.js";import{D as Je}from"../../chunks/Docstring-ea6f8b76.js";import{C as ft}from"../../chunks/CodeBlock-37b92346.js";import{I as ht}from"../../chunks/IconCopyLink-a413fd1b.js";import"../../chunks/CopyButton-6099fd9d.js";function ks(N){let p,W,h,_,D;return{c(){p=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),D=r(`
...
instance of <a href="/docs/transformers/master/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.SEWDConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/master/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.SEWDConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/sew-d#transformers.SEWDConfig"
...
<span class="hljs-number">0.21</span>`}}),ze=new ht({}),Ae=new Je({props:{name:"class transformers.SEWDForSequenceClassification",anchor:"transformers.SEWDForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/sew_d/modeling_sew_d.py#L1633",parametersDescription:[{anchor:"transformers.SEWDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/sew-d#transformers.SEWDConfig">SEWDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oe=new Je({props:{name:"forward",anchor:"transformers.SEWDForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/sew_d/modeling_sew_d.py#L1678",parametersDescription:[{anchor:"transformers.SEWDForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){p=n("meta"),W=d(),h=n("h1"),_=n("a"),D=n("span"),v(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Vt=d(),K=n("h2"),Z=n("a"),ut=n("span"),v(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),It=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),me=n("a"),Eo=r(`Performance-Efficiency Trade-offs
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(V),P=a(V,"DIV",{class:!0});var I=s(P);w(De.$$.fragment,I),hn=c(I),J=a(I,"P",{});var dt=s(J);un=i(dt,"The "),ot=a(dt,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWDModel"),Za.forEach(o),_n=i(dt," forward method, overrides the "),Wt=a(dt,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(I),w(se.$$.fragment,I),yn=c(I),Dt=a(I,"P",{});var ts=s(Dt);En=i(ts,"Example:"),ts.forEach(o),Sn=c(I),w(ke.$$.fragment,I),I.forEach(o),V.forEach(o),Yt=c(t),Q=a(t,"H2",{class:!0});var mo=s(Q);re=a(mo,"A",{id:!0,class:!0,href:!0});var os=s(re);kt=a(os,"SPAN",{});var ns=s(kt);w(Ce.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=c(mo),Ct=a(mo,"SPAN",{});var as=s(Ct);Dn=i(as,"SEWDForCTC"),as.forEach(o),mo.forEach(o),Bt=c(t),x=a(t,"DIV",{class:!0});var L=s(x);w(Te.$$.fragment,L),kn=c(L),Y=a(L,"P",{});var ct=s(Y);Cn=i(ct,"SEW-D Model with a "),Tt=a(ct,"CODE",{});var ss=s(Tt);Tn=i(ss,"language modeling"),ss.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),zn=c(L),xe=a(L,"P",{});var fo=s(xe);An=i(fo,"This model is a PyTorch "),je=a(fo,"A",{href:!0,rel:!0});var ls=s(je);Vn=i(ls,"torch.nn.Module"),ls.forEach(o),In=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),Ln=c(L),C=a(L,"DIV",{class:!0});var F=s(C);w(Pe.$$.fragment,F),Nn=c(F),B=a(F,"P",{});var mt=s(B);Kn=i(mt,"The "),at=a(mt,"A",{href:!0});var ds=s(at);On=i(ds,"SEWDForCTC"),ds.forEach(o),Hn=i(mt," forward method, overrides the "),$t=a(mt,"CODE",{});var cs=s($t);Rn=i(cs,"__call__"),cs.forEach(o),Un=i(mt," special method."),mt.forEach(o),Jn=c(F),w(ie.$$.fragment,F),Qn=c(F),qt=a(F,"P",{});var ms=s(qt);Yn=i(ms,"Example:"),ms.forEach(o),Bn=c(F),w(Fe.$$.fragment,F),Gn=c(F),w(Me.$$.fragment,F),F.forEach(o),L.forEach(o),Gt=c(t),G=a(t,"H2",{class:!0});var ho=s(G);le=a(ho,"A",{id:!0,class:!0,href:!0});var ps=s(le);xt=a(ps,"SPAN",{});var fs=s(xt);w(ze.$$.fragment,fs),fs.forEach(o),ps.forEach(o),Xn=c(ho),jt=a(ho,"SPAN",{});var hs=s(jt);Zn=i(hs,"SEWDForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=c(t),k=a(t,"DIV",{class:!0});var M=s(k);w(Ae.$$.fragment,M),ea=c(M),Pt=a(M,"P",{});var us=s(Pt);ta=i(us,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
...
library implements for all its model (such as downloading or saving etc.).`),go.forEach(o),ca=c(M),Ne=a(M,"P",{});var _o=s(Ne);ma=i(_o,"This model is a PyTorch "),Ke=a(_o,"A",{href:!0,rel:!0});var vs=s(Ke);pa=i(vs,"torch.nn.Module"),vs.forEach(o),fa=i(_o,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o.forEach(o),ha=c(M),T=a(M,"DIV",{class:!0});var z=s(T);w(Oe.$$.fragment,z),ua=c(z),X=a(z,"P",{});var pt=s(X);ga=i(pt,"The "),rt=a(pt,"A",{href:!0});var ws=s(rt);_a=i(ws,"SEWDForSequenceClassification"),ws.forEach(o),va=i(pt," forward method, overrides the "),Ft=a(pt,"CODE",{});var bs=s(Ft);wa=i(bs,"__call__"),bs.forEach(o),ba=i(pt," special method."),pt.forEach(o),ya=c(z),w(de.$$.fragment,z),Ea=c(z),Mt=a(z,"P",{});var ys=s(Mt);Sa=i(ys,"Example:"),ys.forEach(o),Wa=c(z),w(He.$$.fragment,z),Da=c(z),w(Re.$$.fragment,z),z.forEach(o),M.forEach(o),this.h()},h(){l(p,"name","hf:doc:metadata"),l(p,"content",JSON.stringify(qs)),l(_,"id","sewd"),l(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(_,"href","#sewd"),l(h,"class","relative group"),l(Z,"id","overview"),l(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Z,"href","#overview"),l(K,"class","relative group"),l(me,"href","https://arxiv.org/abs/2109.06870"),l(me,"rel","nofollow"),l(Ge,"href","/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),l(fe,"href","https://huggingface.co/anton-l"),l(fe,"rel","nofollow"),l(ne,"id","transformers.SEWDConfig"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.SEWDConfig"),l(O,"class","relative group"),l(Xe,"href","/docs/transformers/master/en/model_doc/sew-d#transformers.SEWDModel"),l(ge,"href","https://huggingface.co/asapp/sew-d-tiny-100k"),l(ge,"rel","nofollow"),l(Ze,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),l(et,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),l($,"class","docstring"),l(ae,"id","transformers.SEWDModel"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.SEWDModel"),l(U,"class","relative group"),l(ye,"href","https://arxiv.org/abs/2109.06870"),l(ye,"rel","nofollow"),l(tt,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),l(We,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(We,"rel","nofollow"),l(ot,"href","/docs/transformers/master/en/model_doc/sew-d#transformers.SEWDModel"),l(P,"class","docstring"),l(q,"class","docstring"),l(re,"id","transformers.SEWDForCTC"),l(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(re,"href","#transformers.SEWDForCTC"),l(Q,"class","relative group"),l($e,"href","https://arxiv.org/abs/2109.06870"),l($e,"rel","nofollow"),l(nt,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),l(je,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(je,"rel","nofollow"),l(at,"href","/docs/transformers/master/en/model_doc/sew-d#transformers.SEWDForCTC"),l(C,"class","docstring"),l(x,"class","docstring"),l(le,"id","transformers.SEWDForSequenceClassification"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.SEWDForSequenceClassification"),l(G,"class","relative group"),l(Ie,"href","https://arxiv.org/abs/2109.06870"),l(Ie,"rel","nofollow"),l(st,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),l(Ke,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ke,"rel","nofollow"),l(rt,"href","/docs/transformers/master/en/model_doc/sew-d#transformers.SEWDForSequenceClassification"),l(T,"class","docstring"),l(k,"class","docstring")},m(t,m){e(document.head,p),f(t,W,m),f(t,h,m),e(h,_),e(_,D),b(u,D,null),e(h,g),e(h,j),e(j,vo),f(t,Vt,m),f(t,K,m),e(K,Z),e(Z,ut),b(ce,ut,null),e(K,wo),e(K,gt),e(gt,bo),f(t,It,m),f(t,ee,m),e(ee,yo),e(ee,me),e(me,Eo),e(ee,So),f(t,Lt,m),f(t,Qe,m),e(Qe,Wo),f(t,Nt,m),f(t,Ye,m),e(Ye,_t),e(_t,Do),f(t,Kt,m),f(t,Be,m),e(Be,ko),f(t,Ot,m),f(t,te,m),e(te,vt),e(vt,Co),e(te,To),e(te,pe),e(pe,$o),e(pe,Ge),e(Ge,qo),e(pe,xo),f(t,Ht,m),f(t,oe,m),e(oe,jo),e(oe,fe),e(fe,Po),e(oe,Fo),f(t,Rt,m),f(t,O,m),e(O,ne),e(ne,wt),b(he,wt,null),e(O,Mo),e(O,bt),e(bt,zo),f(t,Ut,m),f(t,$,m),b(ue,$,null),e($,Ao),e($,H),e(H,Vo),e(H,Xe),e(Xe,Io),e(H,Lo),e(H,ge),e(ge,No),e(H,Ko),e($,Oo),e($,R),e(R,Ho),e(R,Ze),e(Ze,Ro),e(R,Uo),e(R,et),e(et,Jo),e(R,Qo),e($,Yo),e($,yt),e(yt,Bo),e($,Go),b(_e,$,null),f(t,Jt,m),f(t,U,m),e(U,ae),e(ae,Et),b(ve,Et,null),e(U,Xo),e(U,St),e(St,Zo),f(t,Qt,m),f(t,q,m),b(we,q,null),e(q,en),e(q,be),e(be,tn),e(be,ye),e(ye,on),e(be,nn),e(q,an),e(q,Ee),e(Ee,sn),e(Ee,tt),e(tt,rn),e(Ee,ln),e(q,dn),e(q,Se),e(Se,cn),e(Se,We),e(We,mn),e(Se,pn),e(q,fn),e(q,P),b(De,P,null),e(P,hn),e(P,J),e(J,un),e(J,ot),e(ot,gn),e(J,_n),e(J,Wt),e(Wt,vn),e(J,wn),e(P,bn),b(se,P,null),e(P,yn),e(P,Dt),e(Dt,En),e(P,Sn),b(ke,P,null),f(t,Yt,m),f(t,Q,m),e(Q,re),e(re,kt),b(Ce,kt,null),e(Q,Wn),e(Q,Ct),e(Ct,Dn),f(t,Bt,m),f(t,x,m),b(Te,x,null),e(x,kn),e(x,Y),e(Y,Cn),e(Y,Tt),e(Tt,Tn),e(Y,$n),e(Y,$e),e($e,qn),e(Y,xn),e(x,jn),e(x,qe),e(qe,Pn),e(qe,nt),e(nt,Fn),e(qe,Mn),e(x,zn),e(x,xe),e(xe,An),e(xe,je),e(je,Vn),e(xe,In),e(x,Ln),e(x,C),b(Pe,C,null),e(C,Nn),e(C,B),e(B,Kn),e(B,at),e(at,On),e(B,Hn),e(B,$t),e($t,Rn),e(B,Un),e(C,Jn),b(ie,C,null),e(C,Qn),e(C,qt),e(qt,Yn),e(C,Bn),b(Fe,C,null),e(C,Gn),b(Me,C,null),f(t,Gt,m),f(t,G,m),e(G,le),e(le,xt),b(ze,xt,null),e(G,Xn),e(G,jt),e(jt,Zn),f(t,Xt,m),f(t,k,m),b(Ae,k,null),e(k,ea),e(k,Pt),e(Pt,ta),e(k,oa),e(k,Ve),e(Ve,na),e(Ve,Ie),e(Ie,aa),e(Ve,sa),e(k,ra),e(k,Le),e(Le,ia),e(Le,st),e(st,la),e(Le,da),e(k,ca),e(k,Ne),e(Ne,ma),e(Ne,Ke),e(Ke,pa),e(Ne,fa),e(k,ha),e(k,T),b(Oe,T,null),e(T,ua),e(T,X),e(X,ga),e(X,rt),e(rt,_a),e(X,va),e(X,Ft),e(Ft,wa),e(X,ba),e(T,ya),b(de,T,null),e(T,Ea),e(T,Mt),e(Mt,Sa),e(T,Wa),b(He,T,null),e(T,Da),b(Re,T,null),Zt=!0},p(t,[m]){const Ue={};m&2&&(Ue.$$scope={dirty:m,ctx:t}),se.$set(Ue);const zt={};m&2&&(zt.$$scope={dirty:m,ctx:t}),ie.$set(zt);const At={};m&2&&(At.$$scope={dirty:m,ctx:t}),de.$set(At)},i(t){Zt||(y(u.$$.fragment,t),y(ce.$$.fragment,t),y(he.$$.fragment,t),y(ue.$$.fragment,t),y(_e.$$.fragment,t),y(ve.$$.fragment,t),y(we.$$.fragment,t),y(De.$$.fragment,t),y(se.$$.fragment,t),y(ke.$$.fragment,t),y(Ce.$$.fragment,t),y(Te.$$.fragment,t),y(Pe.$$.fragment,t),y(ie.$$.fragment,t),y(Fe.$$.fragment,t),y(Me.$$.fragment,t),y(ze.$$.fragment,t),y(Ae.$$.fragment,t),y(Oe.$$.fragment,t),y(de.$$.fragment,t),y(He.$$.fragment,t),y(Re.$$.fragment,t),Zt=!0)},o(t){E(u.$$.fragment,t),E(ce.$$.fragment,t),E(he.$$.fragment,t),E(ue.$$.fragment,t),E(_e.$$.fragment,t),E(ve.$$.fragment,t),E(we.$$.fragment,t),E(De.$$.fragment,t),E(se.$$.fragment,t),E(ke.$$.fragment,t),E(Ce.$$.fragment,t),E(Te.$$.fragment,t),E(Pe.$$.fragment,t),E(ie.$$.fragment,t),E(Fe.$$.fragment,t),E(Me.$$.fragment,t),E(ze.$$.fragment,t),E(Ae.$$.fragment,t),E(Oe.$$.fragment,t),E(de.$$.fragment,t),E(He.$$.fragment,t),E(Re.$$.fragment,t),Zt=!1},d(t){o(p),t&&o(W),t&&o(h),S(u),t&&o(Vt),t&&o(K),S(ce),t&&o(It),t&&o(ee),t&&o(Lt),t&&o(Qe),t&&o(Nt),t&&o(Ye),t&&o(Kt),t&&o(Be),t&&o(Ot),t&&o(te),t&&o(Ht),t&&o(oe),t&&o(Rt),t&&o(O),S(he),t&&o(Ut),t&&o($),S(ue),S(_e),t&&o(Jt),t&&o(U),S(ve),t&&o(Qt),t&&o(q),S(we),S(De),S(se),S(ke),t&&o(Yt),t&&o(Q),S(Ce),t&&o(Bt),t&&o(x),S(Te),S(Pe),S(ie),S(Fe),S(Me),t&&o(Gt),t&&o(G),S(ze),t&&o(Xt),t&&o(k),S(Ae),S(Oe),S(de),S(He),S(Re)}}}const qs={local:"sewd",sections:[{local:"overview",title:"Overview"},{local:"transformers.SEWDConfig",title:"SEWDConfig"},{local:"transformers.SEWDModel",title:"SEWDModel"},{local:"transformers.SEWDForCTC",title:"SEWDForCTC"},{local:"transformers.SEWDForSequenceClassification",title:"SEWDForSequenceClassification"}],title:"SEW-D"};function xs(N,p,W){let{fw:h}=p;return N.$$set=_=>{"fw"in _&&W(0,h=_.fw)},[h]}class Vs extends Es{constructor(p){super();Ss(this,p,xs,$s,Ws,{fw:0})}}export{Vs as default,qs as metadata};
