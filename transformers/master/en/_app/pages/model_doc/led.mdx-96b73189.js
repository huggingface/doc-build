import{S as zf,i as Ff,s as $f,e as n,k as i,w as f,t as r,M as xf,c as s,d as t,m as l,a,x as _,h as d,b as c,F as e,g as h,y as g,q as v,o as T,B as k}from"../../chunks/vendor-4833417e.js";import{T as go}from"../../chunks/Tip-fffd6df1.js";import{D as $}from"../../chunks/Docstring-7b52c3d4.js";import{C as Pt}from"../../chunks/CodeBlock-90ffda97.js";import{I as me}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function Mf(j){let u,L,b,w,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),w=r("Module"),q=r(`
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}]}}),Lo=new Pt({props:{codee:",",highlighted:""}}),Do=new me({}),Fo=new me({}),$o=new me({}),xo=new me({}),Mo=new $({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/tokenization_led.py#L39"}}),Co=new $({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.BartTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/bart/tokenization_bart.py#L338",parametersDescription:[{anchor:"transformers.BartTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`}}),eo=new go({props:{$$slots:{default:[Mf]},$$scope:{ctx:j}}}),an=new Pt({props:{codee:`from transformers import LEDTokenizer, LEDModel
import torch
...
`}}),oo=new go({props:{$$slots:{default:[Sf]},$$scope:{ctx:j}}}),un=new Pt({props:{codee:`from transformers import LEDTokenizer, LEDForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(prediction, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),mn=new Pt({props:{codee:`import torch
...
`}}),so=new go({props:{$$slots:{default:[Cf]},$$scope:{ctx:j}}}),bn=new Pt({props:{codee:`from transformers import LEDTokenizer, LEDForSequenceClassification
import torch
...
`}}),ro=new go({props:{$$slots:{default:[Of]},$$scope:{ctx:j}}}),Fn=new Pt({props:{codee:`from transformers import LEDTokenizer, LEDForQuestionAnswering
import torch
...
`}}),co=new go({props:{$$slots:{default:[Pf]},$$scope:{ctx:j}}}),An=new Pt({props:{codee:`from transformers import LEDTokenizer, TFLEDModel
...
`}}),uo=new go({props:{$$slots:{default:[jf]},$$scope:{ctx:j}}}),Qn=new Pt({props:{codee:`from transformers import LEDTokenizer, TFLEDForConditionalGeneration
import tensorflow as tf
