...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var z=i(m);T=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,T),e(h,E)},d(g){g&&t(h)}}}function hp(U){let h,L,m,T,E,g,f,z,Bs,Ho,le,xe,Dn,He,Ws,Bn,Os,Vo,$e,Us,Ve,Ks,Rs,Yo,Qt,Hs,Jo,Xt,Wn,Vs,Qo,Gt,Ys,Xo,R,On,Ye,Js,Zt,Qs,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ra,ia,en,da,la,ca,Je,H,tn,pa,ha,Yn,ua,ma,Jn,fa,ga,Qn,_a,ka,ya,Qe,nn,Xn,ba,va,wa,on,Gn,Ta,La,Ea,K,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Ca,Ma,Fa,Ce,an,Pa,ja,Ge,Aa,Ia,Sa,rn,dn,Na,Da,Ba,S,ln,Wa,Oa,eo,Ua,Ka,to,Ra,Ha,no,Va,Ya,oo,Ja,Qa,Xa,pe,Ga,cn,Za,er,Ze,tr,nr,or,et,sr,tt,ar,rr,Go,pn,ir,Zo,nt,es,V,dr,ot,lr,cr,st,pr,hr,at,ur,mr,ts,he,Me,so,rt,fr,ao,gr,ns,C,it,_r,dt,kr,hn,yr,br,vr,ue,wr,un,Tr,Lr,mn,Er,zr,xr,ro,$r,qr,lt,os,me,Fe,io,ct,Cr,lo,Mr,ss,M,pt,Fr,co,Pr,jr,x,Ar,fn,Ir,Sr,gn,Nr,Dr,_n,Br,Wr,po,Or,Ur,ho,Kr,Rr,uo,Hr,Vr,mo,Yr,Jr,Qr,Pe,ht,Xr,fo,Gr,Zr,kn,ut,as,fe,je,go,mt,ei,_o,ti,rs,F,ft,ni,ko,oi,si,gt,ai,yn,ri,ii,di,_t,li,kt,ci,pi,hi,N,yt,ui,ge,mi,bn,fi,gi,yo,_i,ki,yi,Ae,bi,bo,vi,wi,bt,is,_e,Ie,vo,vt,Ti,wo,Li,ds,P,wt,Ei,To,zi,xi,Tt,$i,vn,qi,Ci,Mi,Lt,Fi,Et,Pi,ji,Ai,Q,zt,Ii,ke,Si,wn,Ni,Di,Lo,Bi,Wi,Oi,Se,ls,ye,Ne,Eo,xt,Ui,zo,Ki,cs,j,$t,Ri,xo,Hi,Vi,qt,Yi,Tn,Ji,Qi,Xi,Ct,Gi,Mt,Zi,ed,td,D,Ft,nd,be,od,Ln,sd,ad,$o,rd,id,dd,De,ld,qo,cd,pd,Pt,ps,ve,Be,Co,jt,hd,Mo,ud,hs,A,At,md,Fo,fd,gd,It,_d,En,kd,yd,bd,St,vd,Nt,wd,Td,Ld,B,Dt,Ed,we,zd,zn,xd,$d,Po,qd,Cd,Md,We,Fd,jo,Pd,jd,Bt,us,Te,Oe,Ao,Wt,Ad,Io,Id,ms,I,Ot,Sd,So,Nd,Dd,Ut,Bd,xn,Wd,Od,Ud,Kt,Kd,Rt,Rd,Hd,Vd,W,Ht,Yd,Le,Jd,$n,Qd,Xd,No,Gd,Zd,el,Ue,tl,Do,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Nn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
`),en=a("a"),da=o("LukeTokenizer"),la=o("."),ca=l(),Je=a("li"),H=a("p"),tn=a("a"),pa=o("LukeTokenizer"),ha=o(" takes "),Yn=a("code"),ua=o("entities"),ma=o(" and "),Jn=a("code"),fa=o("entity_spans"),ga=o(` (character-based start and end
positions of the entities in the input text) as extra input. `),Qn=a("code"),_a=o("entities"),ka=o(` typically consist of [MASK] entities or
...
`),mo=a("code"),Yr=o("entity_position_ids"),Jr=o(" to be used by the LUKE model."),Qr=l(),Pe=a("div"),_(ht.$$.fragment),Xr=l(),fo=a("p"),Gr=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ai=l(),Q=a("div"),_(zt.$$.fragment),Ii=l(),ke=a("p"),Si=o("The "),wn=a("a"),Ni=o("LukeForMaskedLM"),Di=o(" forward method, overrides the "),Lo=a("code"),Bi=o("__call__"),Wi=o(" special method."),Oi=l(),_(Se.$$.fragment),ls=l(),ye=a("h2"),Ne=a("a"),Eo=a("span"),_(xt.$$.fragment),Ui=l(),zo=a("span"),Ki=o("LukeForEntityClassification"),cs=l(),j=a("div"),_($t.$$.fragment),Ri=l(),xo=a("p"),Hi=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vd=l(),W=a("div"),_(Ht.$$.fragment),Yd=l(),Le=a("p"),Jd=o("The "),$n=a("a"),Qd=o("LukeForEntitySpanClassification"),Xd=o(" forward method, overrides the "),No=a("code"),Gd=o("__call__"),Zd=o(" special method."),el=l(),_(Ue.$$.fragment),tl=l(),Do=a("p"),nl=o("Examples:"),ol=l(),_(Vt.$$.fragment),this.h()},l(n){const p=rp('[data-svelte="svelte-1phssyn"]',document.head);h=r(p,"META",{name:!0,content:!0}),p.forEach(t),L=c(n),m=r(n,"H1",{class:!0});var Yt=i(m);T=r(Yt,"A",{id:!0,class:!0,href:!0});var Bo=i(T);E=r(Bo,"SPAN",{});var Wo=i(E);k(g.$$.fragment,Wo),Wo.forEach(t),Bo.forEach(t),f=c(Yt),z=r(Yt,"SPAN",{});var Oo=i(z);Bs=s(Oo,"LUKE"),Oo.forEach(t),Yt.forEach(t),Ho=c(n),le=r(n,"H2",{class:!0});var Jt=i(le);xe=r(Jt,"A",{id:!0,class:!0,href:!0});var il=i(xe);Dn=r(il,"SPAN",{});var dl=i(Dn);k(He.$$.fragment,dl),dl.forEach(t),il.forEach(t),Ws=c(Jt),Bn=r(Jt,"SPAN",{});var ll=i(Bn);Os=s(ll,"Overview"),ll.forEach(t),Jt.forEach(t),Vo=c(n),$e=r(n,"P",{});var gs=i($e);Us=s(gs,"The LUKE model was proposed in "),Ve=r(gs,"A",{href:!0,rel:!0});var cl=i(Ve);Ks=s(cl,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),cl.forEach(t),Rs=s(gs,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
extractive and cloze-style question answering, entity typing, and relation classification.`),gs.forEach(t),Yo=c(n),Qt=r(n,"P",{});var pl=i(Qt);Hs=s(pl,"The abstract from the paper is the following:"),pl.forEach(t),Jo=c(n),Xt=r(n,"P",{});var hl=i(Xt);Wn=r(hl,"EM",{});var ul=i(Wn);Vs=s(ul,`Entity representations are useful in natural language tasks involving entities. In this paper, we propose new
pretrained contextualized representations of words and entities based on the bidirectional transformer. The proposed
model treats words and entities in a given text as independent tokens, and outputs contextualized representations of
them. Our model is trained using a new pretraining task based on the masked language model of BERT. The task involves
predicting randomly masked words and entities in a large entity-annotated corpus retrieved from Wikipedia. We also
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),ul.forEach(t),hl.forEach(t),Qo=c(n),Gt=r(n,"P",{});var ml=i(Gt);Ys=s(ml,"Tips:"),ml.forEach(t),Xo=c(n),R=r(n,"UL",{});var Ke=i(R);On=r(Ke,"LI",{});var fl=i(On);Ye=r(fl,"P",{});var _s=i(Ye);Js=s(_s,"This implementation is the same as "),Zt=r(_s,"A",{href:!0});var gl=i(Zt);Qs=s(gl,"RobertaModel"),gl.forEach(t),Xs=s(_s,` with the addition of entity embeddings as well
...
`),en=r(Y,"A",{href:!0});var wl=i(en);da=s(wl,"LukeTokenizer"),wl.forEach(t),la=s(Y,"."),Y.forEach(t),_l.forEach(t),ca=c(Ke),Je=r(Ke,"LI",{});var ks=i(Je);H=r(ks,"P",{});var Ee=i(H);tn=r(Ee,"A",{href:!0});var Tl=i(tn);pa=s(Tl,"LukeTokenizer"),Tl.forEach(t),ha=s(Ee," takes "),Yn=r(Ee,"CODE",{});var Ll=i(Yn);ua=s(Ll,"entities"),Ll.forEach(t),ma=s(Ee," and "),Jn=r(Ee,"CODE",{});var El=i(Jn);fa=s(El,"entity_spans"),El.forEach(t),ga=s(Ee,` (character-based start and end
positions of the entities in the input text) as extra input. `),Qn=r(Ee,"CODE",{});var zl=i(Qn);_a=s(zl,"entities"),zl.forEach(t),ka=s(Ee,` typically consist of [MASK] entities or
