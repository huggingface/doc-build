import{S as Et,i as qt,s as $t,e as n,k as c,w as q,t as s,M as Lt,c as r,d as t,m as l,a,x as $,h as i,b as p,F as o,g as m,y as L,L as Ft,q as F,o as I,B as A}from"../../chunks/vendor-4833417e.js";import{D as ze}from"../../chunks/Docstring-4f315ed9.js";import{I as Yo}from"../../chunks/IconCopyLink-4b81c553.js";function It(Je){let v,Y,_,g,ie,B,Ge,ce,Ke,Pe,T,y,le,N,Ye,de,eo,xe,z,oo,D,to,no,Ce,ee,ro,We,oe,pe,ao,Ve,te,so,Ee,f,me,io,co,he,lo,po,S,mo,ne,ho,fo,uo,fe,_o,go,ue,vo,qe,P,ko,O,bo,To,$e,R,wo,U,yo,Le,x,zo,M,Po,xo,Fe,C,Co,_e,Wo,Vo,Ie,w,W,ge,H,Eo,ve,qo,Ae,h,X,$o,ke,Lo,Fo,j,Io,re,Ao,Bo,No,V,Q,Do,be,So,Oo,E,Z,Ro,Te,Uo,Mo,k,J,Ho,we,Xo,jo,G,Qo,ye,Zo,Jo,Go,ae,K,Be;return B=new Yo({}),N=new Yo({}),H=new Yo({}),X=new ze({props:{name:"class transformers.Wav2Vec2PhonemeCTCTokenizer",anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"phone_delimiter_token",val:" = ' '"},{name:"word_delimiter_token",val:" = None"},{name:"do_phonemize",val:" = True"},{name:"phonemizer_lang",val:" = 'en-us'"},{name:"phonemizer_backend",val:" = 'espeak'"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L90",parametersDescription:[{anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`}}),J=new ze({props:{name:"decode",anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.decode",parameters:[{name:"token_ids",val:": typing.Union[int, typing.List[int], ForwardRef('np.ndarray'), ForwardRef('torch.Tensor'), ForwardRef('tf.Tensor')]"},{name:"skip_special_tokens",val:": bool = False"},{name:"clean_up_tokenization_spaces",val:": bool = True"},{name:"output_char_offsets",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L433",parametersDescription:[{anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.decode.token_ids",description:`<strong>token_ids</strong> (<code>Union[int, List[int], np.ndarray, torch.Tensor, tf.Tensor]</code>) &#x2014;
...
of a monolingually pretrained model.`),Ve=c(),te=n("p"),so=s("Tips:"),Ee=c(),f=n("ul"),me=n("li"),io=s("Wav2Vec2Phoneme uses the exact same architecture as Wav2Vec2"),co=c(),he=n("li"),lo=s("Wav2Vec2Phoneme is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),po=c(),S=n("li"),mo=s(`Wav2Vec2Phoneme model was trained using connectionist temporal classification (CTC) so the model output has to be
decoded using `),ne=n("a"),ho=s("Wav2Vec2PhonemeCTCTokenizer"),fo=s("."),uo=c(),fe=n("li"),_o=s(`Wav2Vec2Phoneme can be fine-tuned on multiple language at once and decode unseen languages in a single forward pass
...
should make use of a dictionary and language model.`),qe=c(),P=n("p"),ko=s("Relevant checkpoints can be found under "),O=n("a"),bo=s("https://huggingface.co/models?other=phoneme-recognition"),To=s("."),$e=c(),R=n("p"),wo=s("This model was contributed by "),U=n("a"),yo=s("patrickvonplaten"),Le=c(),x=n("p"),zo=s("The original code can be found "),M=n("a"),Po=s("here"),xo=s("."),Fe=c(),C=n("p"),Co=s("Wav2Vec2Phoneme\u2019s architecture is based on the Wav2Vec2 model, so one can refer to "),_e=n("code"),Wo=s("Wav2Vec2"),Vo=s("\u2019s documentation page except for the tokenizer."),Ie=c(),w=n("h2"),W=n("a"),ge=n("span"),q(H.$$.fragment),Eo=c(),ve=n("span"),qo=s("Wav2Vec2PhonemeCTCTokenizer"),Ae=c(),h=n("div"),q(X.$$.fragment),$o=c(),ke=n("p"),Lo=s("Constructs a Wav2Vec2PhonemeCTC tokenizer."),Fo=c(),j=n("p"),Io=s("This tokenizer inherits from "),re=n("a"),Ao=s("PreTrainedTokenizer"),Bo=s(` which contains some of the main methods. Users should refer to
...
mapping phonemes of the training languages to the target language using articulatory features. Experiments show that
this simple method significantly outperforms prior work which introduced task-specific architectures and used only part
of a monolingually pretrained model.`),lt.forEach(t),ct.forEach(t),Ve=l(e),te=r(e,"P",{});var dt=a(te);so=i(dt,"Tips:"),dt.forEach(t),Ee=l(e),f=r(e,"UL",{});var b=a(f);me=r(b,"LI",{});var pt=a(me);io=i(pt,"Wav2Vec2Phoneme uses the exact same architecture as Wav2Vec2"),pt.forEach(t),co=l(b),he=r(b,"LI",{});var mt=a(he);lo=i(mt,"Wav2Vec2Phoneme is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),mt.forEach(t),po=l(b),S=r(b,"LI",{});var Oe=a(S);mo=i(Oe,`Wav2Vec2Phoneme model was trained using connectionist temporal classification (CTC) so the model output has to be
decoded using `),ne=r(Oe,"A",{href:!0});var ht=a(ne);ho=i(ht,"Wav2Vec2PhonemeCTCTokenizer"),ht.forEach(t),fo=i(Oe,"."),Oe.forEach(t),uo=l(b),fe=r(b,"LI",{});var ft=a(fe);_o=i(ft,`Wav2Vec2Phoneme can be fine-tuned on multiple language at once and decode unseen languages in a single forward pass
