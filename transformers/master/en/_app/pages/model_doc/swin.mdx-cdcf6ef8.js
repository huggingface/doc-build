import{S as In,i as qn,s as zn,e as n,k as c,w,t as r,M as Nn,c as a,d as o,m as h,a as s,x as v,h as i,b as l,Z as On,F as t,g as f,y as b,q as S,o as y,B as $}from"../../chunks/vendor-329198bb.js";import{T as Pn}from"../../chunks/Tip-39ae8a84.js";import{D as ot}from"../../chunks/Docstring-88811472.js";import{C as Ko}from"../../chunks/CodeBlock-49151c5f.js";import{I as nt}from"../../chunks/IconCopyLink-236b0ec7.js";import"../../chunks/CopyButton-970e2b07.js";function Dn(ee){let m,T,p,u,C;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=r("Module"),C=r(`
...
<p>Example &#x2014;`,name:"layer_norm_eps"}]}}),de=new Ko({props:{code:`from transformers import SwinModel, SwinConfig
...
`}}),R=new Pn({props:{$$slots:{default:[Dn]},$$scope:{ctx:ee}}}),ue=new Ko({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
`}}),J=new Pn({props:{$$slots:{default:[Ln]},$$scope:{ctx:ee}}}),Se=new Ko({props:{code:`from transformers import AutoFeatureExtractor, SwinForImageClassification
import torch
from datasets import load_dataset
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),lt=c(),xe=n("p"),Nt=r("Tips:"),dt=c(),Ee=n("ul"),ne=n("li"),Ot=r("One can use the "),Ce=n("a"),Dt=r("AutoFeatureExtractor"),Lt=r(" API to prepare images for the model."),ct=c(),V=n("img"),ht=c(),Z=n("small"),Wt=r("Swin Transformer architecture. Taken from the "),ke=n("a"),Ht=r("original paper"),Ut=r("."),ft=c(),F=n("p"),Bt=r("This model was contributed by "),ae=n("a"),Vt=r("novice03"),Zt=r(". The original code can be found "),se=n("a"),Kt=r("here"),Yt=r("."),mt=c(),N=n("h2"),K=n("a"),Ue=n("span"),w(re.$$.fragment),Rt=c(),Be=n("span"),Gt=r("SwinConfig"),pt=c(),k=n("div"),w(ie.$$.fragment),Jt=c(),O=n("p"),Qt=r("This is the configuration class to store the configuration of a "),je=n("a"),Xt=r("SwinModel"),eo=r(`. It is used to instantiate a Swin
...
documentation from `),Me=n("a"),io=r("PretrainedConfig"),lo=r(" for more information."),co=c(),w(de.$$.fragment),ut=c(),L=n("h2"),Y=n("a"),Ve=n("span"),w(ce.$$.fragment),ho=c(),Ze=n("span"),fo=r("SwinModel"),gt=c(),M=n("div"),w(he.$$.fragment),mo=c(),fe=n("p"),po=r(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),me=n("a"),uo=r("torch.nn.Module"),go=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o=c(),x=n("div"),w(pe.$$.fragment),wo=c(),W=n("p"),vo=r("The "),Fe=n("a"),bo=r("SwinModel"),So=r(" forward method, overrides the "),Ke=n("code"),yo=r("__call__"),$o=r(" special method."),To=c(),w(R.$$.fragment),xo=c(),Ye=n("p"),Eo=r("Example:"),Co=c(),w(ue.$$.fragment),_t=c(),H=n("h2"),G=n("a"),Re=n("span"),w(ge.$$.fragment),ko=c(),Ge=n("span"),jo=r("SwinForImageClassification"),wt=c(),j=n("div"),w(_e.$$.fragment),Ao=c(),Je=n("p"),Mo=r(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Fo=c(),we=n("p"),Po=r("This model is a PyTorch "),ve=n("a"),Io=r("torch.nn.Module"),qo=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zo=c(),E=n("div"),w(be.$$.fragment),No=c(),U=n("p"),Oo=r("The "),Pe=n("a"),Do=r("SwinForImageClassification"),Lo=r(" forward method, overrides the "),Qe=n("code"),Wo=r("__call__"),Ho=r(" special method."),Uo=c(),w(J.$$.fragment),Bo=c(),Xe=n("p"),Vo=r("Example:"),Zo=c(),w(Se.$$.fragment),this.h()},l(e){const d=Nn('[data-svelte="svelte-1phssyn"]',document.head);m=a(d,"META",{name:!0,content:!0}),d.forEach(o),T=h(e),p=a(e,"H1",{class:!0});var ye=s(p);u=a(ye,"A",{id:!0,class:!0,href:!0});var et=s(u);C=a(et,"SPAN",{});var Ro=s(C);v(g.$$.fragment,Ro),Ro.forEach(o),et.forEach(o),_=h(ye),A=a(ye,"SPAN",{});var Go=s(A);kt=i(Go,"Swin Transformer"),Go.forEach(o),ye.forEach(o),at=h(e),q=a(e,"H2",{class:!0});var bt=s(q);B=a(bt,"A",{id:!0,class:!0,href:!0});var Jo=s(B);Le=a(Jo,"SPAN",{});var Qo=s(Le);v(te.$$.fragment,Qo),Qo.forEach(o),Jo.forEach(o),jt=h(bt),We=a(bt,"SPAN",{});var Xo=s(We);At=i(Xo,"Overview"),Xo.forEach(o),bt.forEach(o),st=h(e),z=a(e,"P",{});var tt=s(z);Mt=i(tt,"The Swin Transformer was proposed in "),oe=a(tt,"A",{href:!0,rel:!0});var en=s(oe);Ft=i(en,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),en.forEach(o),Pt=a(tt,"BR",{}),It=i(tt,`
...
(53.5 mIoU on ADE20K val). Its performance surpasses the previous state-of-the-art by a large margin of +2.7 box AP and
+2.6 mask AP on COCO, and +3.2 mIoU on ADE20K, demonstrating the potential of Transformer-based models as vision backbones.
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),nn.forEach(o),on.forEach(o),lt=h(e),xe=a(e,"P",{});var an=s(xe);Nt=i(an,"Tips:"),an.forEach(o),dt=h(e),Ee=a(e,"UL",{});var sn=s(Ee);ne=a(sn,"LI",{});var St=s(ne);Ot=i(St,"One can use the "),Ce=a(St,"A",{href:!0});var rn=s(Ce);Dt=i(rn,"AutoFeatureExtractor"),rn.forEach(o),Lt=i(St," API to prepare images for the model."),St.forEach(o),sn.forEach(o),ct=h(e),V=a(e,"IMG",{src:!0,alt:!0,width:!0}),ht=h(e),Z=a(e,"SMALL",{});var yt=s(Z);Wt=i(yt,"Swin Transformer architecture. Taken from the "),ke=a(yt,"A",{href:!0});var ln=s(ke);Ht=i(ln,"original paper"),ln.forEach(o),Ut=i(yt,"."),yt.forEach(o),ft=h(e),F=a(e,"P",{});var Ie=s(F);Bt=i(Ie,"This model was contributed by "),ae=a(Ie,"A",{href:!0,rel:!0});var dn=s(ae);Vt=i(dn,"novice03"),dn.forEach(o),Zt=i(Ie,". The original code can be found "),se=a(Ie,"A",{href:!0,rel:!0});var cn=s(se);Kt=i(cn,"here"),cn.forEach(o),Yt=i(Ie,"."),Ie.forEach(o),mt=h(e),N=a(e,"H2",{class:!0});var $t=s(N);K=a($t,"A",{id:!0,class:!0,href:!0});var hn=s(K);Ue=a(hn,"SPAN",{});var fn=s(Ue);v(re.$$.fragment,fn),fn.forEach(o),hn.forEach(o),Rt=h($t),Be=a($t,"SPAN",{});var mn=s(Be);Gt=i(mn,"SwinConfig"),mn.forEach(o),$t.forEach(o),pt=h(e),k=a(e,"DIV",{class:!0});var Q=s(k);v(ie.$$.fragment,Q),Jt=h(Q),O=a(Q,"P",{});var qe=s(O);Qt=i(qe,"This is the configuration class to store the configuration of a "),je=a(qe,"A",{href:!0});var pn=s(je);Xt=i(pn,"SwinModel"),pn.forEach(o),eo=i(qe,`. It is used to instantiate a Swin
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the Swin
`),le=a(qe,"A",{href:!0,rel:!0});var un=s(le);to=i(un,"microsoft/swin-tiny-patch4-window7-224"),un.forEach(o),oo=i(qe,`
architecture.`),qe.forEach(o),no=h(Q),D=a(Q,"P",{});var ze=s(D);ao=i(ze,"Configuration objects inherit from "),Ae=a(ze,"A",{href:!0});var gn=s(Ae);so=i(gn,"PretrainedConfig"),gn.forEach(o),ro=i(ze,` and can be used to control the model outputs. Read the
documentation from `),Me=a(ze,"A",{href:!0});var _n=s(Me);io=i(_n,"PretrainedConfig"),_n.forEach(o),lo=i(ze," for more information."),ze.forEach(o),co=h(Q),v(de.$$.fragment,Q),Q.forEach(o),ut=h(e),L=a(e,"H2",{class:!0});var Tt=s(L);Y=a(Tt,"A",{id:!0,class:!0,href:!0});var wn=s(Y);Ve=a(wn,"SPAN",{});var vn=s(Ve);v(ce.$$.fragment,vn),vn.forEach(o),wn.forEach(o),ho=h(Tt),Ze=a(Tt,"SPAN",{});var bn=s(Ze);fo=i(bn,"SwinModel"),bn.forEach(o),Tt.forEach(o),gt=h(e),M=a(e,"DIV",{class:!0});var Ne=s(M);v(he.$$.fragment,Ne),mo=h(Ne),fe=a(Ne,"P",{});var xt=s(fe);po=i(xt,`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),me=a(xt,"A",{href:!0,rel:!0});var Sn=s(me);uo=i(Sn,"torch.nn.Module"),Sn.forEach(o),go=i(xt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),xt.forEach(o),_o=h(Ne),x=a(Ne,"DIV",{class:!0});var P=s(x);v(pe.$$.fragment,P),wo=h(P),W=a(P,"P",{});var Oe=s(W);vo=i(Oe,"The "),Fe=a(Oe,"A",{href:!0});var yn=s(Fe);bo=i(yn,"SwinModel"),yn.forEach(o),So=i(Oe," forward method, overrides the "),Ke=a(Oe,"CODE",{});var $n=s(Ke);yo=i($n,"__call__"),$n.forEach(o),$o=i(Oe," special method."),Oe.forEach(o),To=h(P),v(R.$$.fragment,P),xo=h(P),Ye=a(P,"P",{});var Tn=s(Ye);Eo=i(Tn,"Example:"),Tn.forEach(o),Co=h(P),v(ue.$$.fragment,P),P.forEach(o),Ne.forEach(o),_t=h(e),H=a(e,"H2",{class:!0});var Et=s(H);G=a(Et,"A",{id:!0,class:!0,href:!0});var xn=s(G);Re=a(xn,"SPAN",{});var En=s(Re);v(ge.$$.fragment,En),En.forEach(o),xn.forEach(o),ko=h(Et),Ge=a(Et,"SPAN",{});var Cn=s(Ge);jo=i(Cn,"SwinForImageClassification"),Cn.forEach(o),Et.forEach(o),wt=h(e),j=a(e,"DIV",{class:!0});var X=s(j);v(_e.$$.fragment,X),Ao=h(X),Je=a(X,"P",{});var kn=s(Je);Mo=i(kn,`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),kn.forEach(o),Fo=h(X),we=a(X,"P",{});var Ct=s(we);Po=i(Ct,"This model is a PyTorch "),ve=a(Ct,"A",{href:!0,rel:!0});var jn=s(ve);Io=i(jn,"torch.nn.Module"),jn.forEach(o),qo=i(Ct,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ct.forEach(o),zo=h(X),E=a(X,"DIV",{class:!0});var I=s(E);v(be.$$.fragment,I),No=h(I),U=a(I,"P",{});var De=s(U);Oo=i(De,"The "),Pe=a(De,"A",{href:!0});var An=s(Pe);Do=i(An,"SwinForImageClassification"),An.forEach(o),Lo=i(De," forward method, overrides the "),Qe=a(De,"CODE",{});var Mn=s(Qe);Wo=i(Mn,"__call__"),Mn.forEach(o),Ho=i(De," special method."),De.forEach(o),Uo=h(I),v(J.$$.fragment,I),Bo=h(I),Xe=a(I,"P",{});var Fn=s(Xe);Vo=i(Fn,"Example:"),Fn.forEach(o),Zo=h(I),v(Se.$$.fragment,I),I.forEach(o),X.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(Hn)),l(u,"id","swin-transformer"),l(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(u,"href","#swin-transformer"),l(p,"class","relative group"),l(B,"id","overview"),l(B,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(B,"href","#overview"),l(q,"class","relative group"),l(oe,"href","https://arxiv.org/abs/2103.14030"),l(oe,"rel","nofollow"),l(Ce,"href","/docs/transformers/master/en/model_doc/auto#transformers.AutoFeatureExtractor"),On(V.src,Yo="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/swin_transformer_architecture.png")||l(V,"src",Yo),l(V,"alt","drawing"),l(V,"width","600"),l(ke,"href","https://arxiv.org/abs/2102.03334"),l(ae,"href","https://huggingface.co/novice03%3E"),l(ae,"rel","nofollow"),l(se,"href","https://github.com/microsoft/Swin-Transformer"),l(se,"rel","nofollow"),l(K,"id","transformers.SwinConfig"),l(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(K,"href","#transformers.SwinConfig"),l(N,"class","relative group"),l(je,"href","/docs/transformers/master/en/model_doc/swin#transformers.SwinModel"),l(le,"href","https://huggingface.co/microsoft/swin-tiny-patch4-window7-224"),l(le,"rel","nofollow"),l(Ae,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),l(Me,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),l(k,"class","docstring"),l(Y,"id","transformers.SwinModel"),l(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Y,"href","#transformers.SwinModel"),l(L,"class","relative group"),l(me,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(me,"rel","nofollow"),l(Fe,"href","/docs/transformers/master/en/model_doc/swin#transformers.SwinModel"),l(x,"class","docstring"),l(M,"class","docstring"),l(G,"id","transformers.SwinForImageClassification"),l(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(G,"href","#transformers.SwinForImageClassification"),l(H,"class","relative group"),l(ve,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(ve,"rel","nofollow"),l(Pe,"href","/docs/transformers/master/en/model_doc/swin#transformers.SwinForImageClassification"),l(E,"class","docstring"),l(j,"class","docstring")},m(e,d){t(document.head,m),f(e,T,d),f(e,p,d),t(p,u),t(u,C),b(g,C,null),t(p,_),t(p,A),t(A,kt),f(e,at,d),f(e,q,d),t(q,B),t(B,Le),b(te,Le,null),t(q,jt),t(q,We),t(We,At),f(e,st,d),f(e,z,d),t(z,Mt),t(z,oe),t(oe,Ft),t(z,Pt),t(z,It),f(e,rt,d),f(e,$e,d),t($e,qt),f(e,it,d),f(e,Te,d),t(Te,He),t(He,zt),f(e,lt,d),f(e,xe,d),t(xe,Nt),f(e,dt,d),f(e,Ee,d),t(Ee,ne),t(ne,Ot),t(ne,Ce),t(Ce,Dt),t(ne,Lt),f(e,ct,d),f(e,V,d),f(e,ht,d),f(e,Z,d),t(Z,Wt),t(Z,ke),t(ke,Ht),t(Z,Ut),f(e,ft,d),f(e,F,d),t(F,Bt),t(F,ae),t(ae,Vt),t(F,Zt),t(F,se),t(se,Kt),t(F,Yt),f(e,mt,d),f(e,N,d),t(N,K),t(K,Ue),b(re,Ue,null),t(N,Rt),t(N,Be),t(Be,Gt),f(e,pt,d),f(e,k,d),b(ie,k,null),t(k,Jt),t(k,O),t(O,Qt),t(O,je),t(je,Xt),t(O,eo),t(O,le),t(le,to),t(O,oo),t(k,no),t(k,D),t(D,ao),t(D,Ae),t(Ae,so),t(D,ro),t(D,Me),t(Me,io),t(D,lo),t(k,co),b(de,k,null),f(e,ut,d),f(e,L,d),t(L,Y),t(Y,Ve),b(ce,Ve,null),t(L,ho),t(L,Ze),t(Ze,fo),f(e,gt,d),f(e,M,d),b(he,M,null),t(M,mo),t(M,fe),t(fe,po),t(fe,me),t(me,uo),t(fe,go),t(M,_o),t(M,x),b(pe,x,null),t(x,wo),t(x,W),t(W,vo),t(W,Fe),t(Fe,bo),t(W,So),t(W,Ke),t(Ke,yo),t(W,$o),t(x,To),b(R,x,null),t(x,xo),t(x,Ye),t(Ye,Eo),t(x,Co),b(ue,x,null),f(e,_t,d),f(e,H,d),t(H,G),t(G,Re),b(ge,Re,null),t(H,ko),t(H,Ge),t(Ge,jo),f(e,wt,d),f(e,j,d),b(_e,j,null),t(j,Ao),t(j,Je),t(Je,Mo),t(j,Fo),t(j,we),t(we,Po),t(we,ve),t(ve,Io),t(we,qo),t(j,zo),t(j,E),b(be,E,null),t(E,No),t(E,U),t(U,Oo),t(U,Pe),t(Pe,Do),t(U,Lo),t(U,Qe),t(Qe,Wo),t(U,Ho),t(E,Uo),b(J,E,null),t(E,Bo),t(E,Xe),t(Xe,Vo),t(E,Zo),b(Se,E,null),vt=!0},p(e,[d]){const ye={};d&2&&(ye.$$scope={dirty:d,ctx:e}),R.$set(ye);const et={};d&2&&(et.$$scope={dirty:d,ctx:e}),J.$set(et)},i(e){vt||(S(g.$$.fragment,e),S(te.$$.fragment,e),S(re.$$.fragment,e),S(ie.$$.fragment,e),S(de.$$.fragment,e),S(ce.$$.fragment,e),S(he.$$.fragment,e),S(pe.$$.fragment,e),S(R.$$.fragment,e),S(ue.$$.fragment,e),S(ge.$$.fragment,e),S(_e.$$.fragment,e),S(be.$$.fragment,e),S(J.$$.fragment,e),S(Se.$$.fragment,e),vt=!0)},o(e){y(g.$$.fragment,e),y(te.$$.fragment,e),y(re.$$.fragment,e),y(ie.$$.fragment,e),y(de.$$.fragment,e),y(ce.$$.fragment,e),y(he.$$.fragment,e),y(pe.$$.fragment,e),y(R.$$.fragment,e),y(ue.$$.fragment,e),y(ge.$$.fragment,e),y(_e.$$.fragment,e),y(be.$$.fragment,e),y(J.$$.fragment,e),y(Se.$$.fragment,e),vt=!1},d(e){o(m),e&&o(T),e&&o(p),$(g),e&&o(at),e&&o(q),$(te),e&&o(st),e&&o(z),e&&o(rt),e&&o($e),e&&o(it),e&&o(Te),e&&o(lt),e&&o(xe),e&&o(dt),e&&o(Ee),e&&o(ct),e&&o(V),e&&o(ht),e&&o(Z),e&&o(ft),e&&o(F),e&&o(mt),e&&o(N),$(re),e&&o(pt),e&&o(k),$(ie),$(de),e&&o(ut),e&&o(L),$(ce),e&&o(gt),e&&o(M),$(he),$(pe),$(R),$(ue),e&&o(_t),e&&o(H),$(ge),e&&o(wt),e&&o(j),$(_e),$(be),$(J),$(Se)}}}const Hn={local:"swin-transformer",sections:[{local:"overview",title:"Overview"},{local:"transformers.SwinConfig",title:"SwinConfig"},{local:"transformers.SwinModel",title:"SwinModel"},{local:"transformers.SwinForImageClassification",title:"SwinForImageClassification"}],title:"Swin Transformer"};function Un(ee,m,T){let{fw:p}=m;return ee.$$set=u=>{"fw"in u&&T(0,p=u.fw)},[p]}class Gn extends In{constructor(m){super();qn(this,m,Un,Wn,zn,{fw:0})}}export{Gn as default,Hn as metadata};
