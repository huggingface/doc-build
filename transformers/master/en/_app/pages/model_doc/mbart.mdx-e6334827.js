...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Es=new U({}),Ps=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/mbart/modeling_tf_mbart.py#L1311",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[L2]},$$scope:{ctx:E}}}),Is=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/mbart/modeling_tf_mbart.py#L1344",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
target text format is `),Ve=a(jt,"CODE",{});var ZM=s(Ve);Kt=i(ZM,"[tgt_lang_code] X [eos]"),ZM.forEach(t),Fh=i(jt,". "),sd=a(jt,"CODE",{});var YM=s(sd);jh=i(YM,"bos"),YM.forEach(t),Eh=i(jt," is never used."),jt.forEach(t),fp=l(o),bt=a(o,"P",{});var ji=s(bt);Ph=i(ji,"The regular "),Pn=a(ji,"A",{href:!0});var GM=s(Pn);rd=a(GM,"STRONG",{});var ew=s(rd);Ch=i(ew,"call"),ew.forEach(t),Sh=i(GM,"()"),GM.forEach(t),Ah=i(ji,` will encode source text format, and it should be wrapped
inside the context manager `),Kr=a(ji,"A",{href:!0});var tw=s(Kr);Ih=i(tw,"as_target_tokenizer()"),tw.forEach(t),Nh=i(ji," to encode target text format."),ji.forEach(t),_p=l(o),Zr=a(o,"UL",{});var ow=s(Zr);id=a(ow,"LI",{});var nw=s(id);Oh=i(nw,"Supervised training"),nw.forEach(t),ow.forEach(t),gp=l(o),f(Cn.$$.fragment,o),kp=l(o),Yr=a(o,"UL",{});var aw=s(Yr);Sn=a(aw,"LI",{});var pu=s(Sn);dd=a(pu,"P",{});var sw=s(dd);Dh=i(sw,"Generation"),sw.forEach(t),Lh=l(pu),Zt=a(pu,"P",{});var Ei=s(Zt);Gh=i(Ei,"While generating the target text set the "),ld=a(Ei,"CODE",{});var rw=s(ld);Rh=i(rw,"decoder_start_token_id"),rw.forEach(t),Wh=i(Ei,` to the target language id. The following
example shows how to translate English to Romanian using the `),cd=a(Ei,"EM",{});var iw=s(cd);Uh=i(iw,"facebook/mbart-large-en-ro"),iw.forEach(t),Xh=i(Ei," model."),Ei.forEach(t),pu.forEach(t),aw.forEach(t),bp=l(o),f(An.$$.fragment,o),vp=l(o),Yt=a(o,"H2",{class:!0});var uu=s(Yt);Co=a(uu,"A",{id:!0,class:!0,href:!0});var dw=s(Co);pd=a(dw,"SPAN",{});var lw=s(pd);f(In.$$.fragment,lw),lw.forEach(t),dw.forEach(t),Hh=l(uu),ud=a(uu,"SPAN",{});var cw=s(ud);Vh=i(cw,"Overview of MBart-50"),cw.forEach(t),uu.forEach(t),yp=l(o),vt=a(o,"P",{});var Pi=s(vt);Qh=i(Pi,"MBart-50 was introduced in the "),Nn=a(Pi,"A",{href:!0,rel:!0});var pw=s(Nn);Jh=i(pw,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),pw.forEach(t),Kh=i(Pi,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
