...
first positional argument :`),U=i(),M=n("ul"),C=n("li"),Pe=r("a single Tensor with "),J=n("code"),Q=r("input_ids"),Ne=r(" only and nothing else: "),W=n("code"),Oe=r("model(input_ids)"),Ae=i(),O=n("li"),ue=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),we.forEach(t),U=l(m),M=s(m,"UL",{});var K=a(M);C=s(K,"LI",{});var V=a(C);Pe=d(V,"a single Tensor with "),J=s(V,"CODE",{});var ut=a(J);Q=d(ut,"input_ids"),ut.forEach(t),Ne=d(V," only and nothing else: "),W=s(V,"CODE",{});var Je=a(W);Oe=d(Je,"model(input_ids)"),Je.forEach(t),V.forEach(t),Ae=l(K),O=s(K,"LI",{});var A=a(O);ue=d(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),se=s(A,"CODE",{});var Be=a(se);$e=d(Be,"model([input_ids, attention_mask])"),Be.forEach(t),me=d(A," or "),H=s(A,"CODE",{});var mt=a(H);Ie=d(mt,"model([input_ids, attention_mask, token_type_ids])"),mt.forEach(t),A.forEach(t),qe=l(K),E=s(K,"LI",{});var ae=a(E);Se=d(ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=s(ae,"CODE",{});var ft=a(R);Le=d(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),ae.forEach(t),K.forEach(t)},m(m,$){p(m,u,$),e(u,x),p(m,f,$),p(m,T,$),e(T,z),e(z,B),e(T,w),e(T,F),e(F,Ee),p(m,he,$),p(m,q,$),e(q,ve),e(q,te),e(te,Ce),e(q,oe),e(q,ne),e(ne,je),e(q,Fe),p(m,G,$),p(m,N,$),e(N,ye),p(m,U,$),p(m,M,$),e(M,C),e(C,Pe),e(C,J),e(J,Q),e(C,Ne),e(C,W),e(W,Oe),e(M,Ae),e(M,O),e(O,ue),e(O,se),e(se,$e),e(O,me),e(O,H),e(H,Ie),e(M,qe),e(M,E),e(E,Se),e(E,R),e(R,Le)},d(m){m&&t(u),m&&t(f),m&&t(T),m&&t(he),m&&t(q),m&&t(G),m&&t(N),m&&t(U),m&&t(M)}}}function jf(D){let u,x,f,T,z;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(B){u=s(B,"P",{});var w=a(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(w,"CODE",{});var F=a(f);T=d(F,"Module"),F.forEach(t),z=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(B){u=s(B,"P",{});var w=a(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(w,"CODE",{});var F=a(f);T=d(F,"Module"),F.forEach(t),z=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(B,w){p(B,u,w),e(u,x),e(u,f),e(f,T),e(u,z)},d(B){B&&t(u)}}}function Of(D){let u,x,f,T,z,B,w,F,Ee,he,q,ve,te,Ce,oe,ne,je,Fe,G,N,ye,U,M,C,Pe,J,Q,Ne,W,Oe,Ae,O,ue,se,$e,me,H,Ie,qe,E,Se,R,Le,m,$,Te,ht,Ve,j,fe,De,we,K,V,ut,Je,A,Be,mt,ae,ft,$d,qd,uo,Md,mo,Ed,Cd,jd,Ge,Pd,qs,Nd,Od,Ms,Ad,Id,Rn,Sd,Ld,Tr,_t,Ot,Es,fo,Dd,Cs,Gd,wr,Un,Wd,Br,_o,zr,gt,At,js,go,Rd,Ps,Ud,xr,re,bo,Hd,bt,Kd,Hn,Vd,Jd,ko,Qd,Xd,Yd,kt,Zd,Kn,ei,ti,Vn,oi,ni,si,Ns,ai,ri,vo,Fr,vt,It,Os,yo,di,As,ii,$r,de,To,li,Is,ci,pi,St,Ss,hi,ui,Jn,mi,fi,_i,wo,gi,Qn,bi,ki,vi,Qe,Bo,yi,Ls,Ti,wi,Ds,Xn,Bi,Gs,zi,qr,yt,Lt,Ws,zo,xi,Rs,Fi,Mr,ie,xo,$i,Fo,qi,Us,Mi,Ei,Ci,Dt,Hs,ji,Pi,Yn,Ni,Oi,Ai,$o,Ii,Zn,Si,Li,Di,Xe,qo,Gi,Ks,Wi,Ri,Vs,es,Ui,Js,Hi,Er,Tt,Gt,Qs,Mo,Ki,Xs,Vi,Cr,We,Ji,Ys,Qi,Xi,Zs,Yi,Zi,ea,el,jr,ze,Eo,tl,Co,ol,ts,nl,sl,al,jo,rl,Po,dl,il,ll,_e,No,cl,wt,pl,os,hl,ul,ta,ml,fl,_l,Wt,gl,oa,bl,kl,Oo,Pr,Bt,Rt,na,Ao,vl,sa,yl,Nr,Re,Tl,ns,wl,Bl,aa,zl,xl,ra,Fl,Or,xe,Io,$l,So,ql,ss,Ml,El,Cl,Lo,jl,Do,Pl,Nl,Ol,ge,Go,Al,zt,Il,as,Sl,Ll,da,Dl,Gl,Wl,Ut,Rl,ia,Ul,Hl,Wo,Ar,xt,Ht,la,Ro,Kl,ca,Vl,Ir,Ft,Uo,Jl,Ye,Ho,Ql,pa,Xl,Yl,Ko,Sr,$t,Kt,ha,Vo,Zl,ua,ec,Lr,le,Jo,tc,Qo,oc,rs,nc,sc,ac,Xo,rc,Yo,dc,ic,lc,Vt,cc,be,Zo,pc,qt,hc,ds,uc,mc,ma,fc,_c,gc,Jt,bc,fa,kc,vc,en,Dr,Mt,Qt,_a,tn,yc,ga,Tc,Gr,ce,on,wc,nn,Bc,is,zc,xc,Fc,sn,$c,an,qc,Mc,Ec,Xt,Cc,X,rn,jc,Et,Pc,ls,Nc,Oc,ba,Ac,Ic,Sc,Yt,Lc,ka,Dc,Gc,va,ya,Ta,wa,Wc,Rc,Ba,za,xa,dn,Uc,Fa,Hc,Kc,Wr,Ct,Zt,$a,ln,Vc,qa,Jc,Rr,I,cn,Qc,pn,Xc,cs,Yc,Zc,ep,hn,tp,un,op,np,sp,Ma,ap,rp,Ue,Ea,mn,dp,ip,Ca,fn,lp,cp,ja,_n,pp,hp,Pa,gn,up,mp,ke,bn,fp,jt,_p,Na,gp,bp,Oa,kp,vp,yp,eo,Tp,Aa,wp,Bp,kn,zp,Ze,vn,xp,Ia,Fp,$p,yn,qp,et,Tn,Mp,Sa,Ep,Cp,wn,Ur,Pt,to,La,Bn,jp,Da,Pp,Hr,S,zn,Np,xn,Op,ps,Ap,Ip,Sp,Fn,Lp,$n,Dp,Gp,Wp,Ga,Rp,Up,He,Wa,qn,Hp,Kp,Ra,Mn,Vp,Jp,Ua,En,Qp,Xp,Ha,Cn,Yp,Zp,L,jn,eh,Nt,th,Ka,oh,nh,Va,sh,ah,rh,oo,dh,Ja,ih,lh,Qa,Xa,Ya,Za,ch,ph,er,tr,or,nr,hh,uh,sr,ar,rr,dr,mh,fh,ir,lr,Pn,no,so,cr,Nn,_h,pr,gh,bh,hr,kh,vh,tt,On,yh,ur,Th,wh,An,Bh,ot,In,zh,mr,xh,Fh,Sn,Kr;return B=new pe({}),U=new pe({}),we=new pe({}),fo=new pe({}),_o=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=n("meta"),x=i(),f=n("h1"),T=n("a"),z=n("span"),_(B.$$.fragment),w=i(),F=n("span"),Ee=r("Blenderbot"),he=i(),q=n("p"),ve=n("strong"),te=r("DISCLAIMER:"),Ce=r(" If you see something strange, file a "),oe=n("a"),ne=r("Github Issue"),je=r(" ."),Fe=i(),G=n("h2"),N=n("a"),ye=n("span"),_(U.$$.fragment),M=i(),C=n("span"),Pe=r("Overview"),J=i(),Q=n("p"),Ne=r("The Blender chatbot model was proposed in "),W=n("a"),Oe=r("Recipes for building an open-domain chatbot"),Ae=r(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),O=i(),ue=n("p"),se=r("The abstract of the paper is the following:"),$e=i(),me=n("p"),H=n("em"),Ie=r(`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
...
documentation from `),Vn=n("a"),oi=r("PretrainedConfig"),ni=r(" for more information."),si=i(),Ns=n("p"),ai=r("Example:"),ri=i(),_(vo.$$.fragment),Fr=i(),vt=n("h2"),It=n("a"),Os=n("span"),_(yo.$$.fragment),di=i(),As=n("span"),ii=r("BlenderbotTokenizer"),$r=i(),de=n("div"),_(To.$$.fragment),li=i(),Is=n("p"),ci=r("Construct a Blenderbot tokenizer."),pi=i(),St=n("p"),Ss=n("code"),hi=r("Blenderbot"),ui=r(" is nearly identical to "),Jn=n("a"),mi=r("RobertaTokenizer"),fi=r(` and runs end-to-end tokenization: punctuation splitting
...
adding special tokens. A Blenderbot sequence has the following format:`),wi=i(),Ds=n("ul"),Xn=n("li"),Bi=r("single sequence: "),Gs=n("code"),zi=r("X </s>"),qr=i(),yt=n("h2"),Lt=n("a"),Ws=n("span"),_(zo.$$.fragment),xi=i(),Rs=n("span"),Fi=r("BlenderbotTokenizerFast"),Mr=i(),ie=n("div"),_(xo.$$.fragment),$i=i(),Fo=n("p"),qi=r("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Us=n("em"),Mi=r("tokenizers"),Ei=r(" library)."),Ci=i(),Dt=n("p"),Hs=n("code"),ji=r("BlenderbotFast"),Pi=r(" is nearly identical to "),Yn=n("a"),Ni=r("RobertaTokenizerFast"),Oi=r(` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Ai=i(),$o=n("p"),Ii=r("Refer to superclass "),Zn=n("a"),Si=r("RobertaTokenizerFast"),Li=r(" for usage examples and documentation concerning parameters."),Di=i(),Xe=n("div"),_(qo.$$.fragment),Gi=i(),Ks=n("p"),Wi=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
and behavior.`),ll=i(),_e=n("div"),_(No.$$.fragment),cl=i(),wt=n("p"),pl=r("The "),os=n("a"),hl=r("BlenderbotModel"),ul=r(" forward method, overrides the "),ta=n("code"),ml=r("__call__"),fl=r(" special method."),_l=i(),_(Wt.$$.fragment),gl=i(),oa=n("p"),bl=r("Example:"),kl=i(),_(Oo.$$.fragment),Pr=i(),Bt=n("h2"),Rt=n("a"),na=n("span"),_(Ao.$$.fragment),vl=i(),sa=n("span"),yl=r("BlenderbotForConditionalGeneration"),Nr=i(),Re=n("p"),Tl=r("See "),ns=n("a"),wl=r("BartForConditionalGeneration"),Bl=r(" for arguments to "),aa=n("em"),zl=r("forward"),xl=r(" and "),ra=n("em"),Fl=r("generate"),Or=i(),xe=n("div"),_(Io.$$.fragment),$l=i(),So=n("p"),ql=r(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ol=i(),ge=n("div"),_(Go.$$.fragment),Al=i(),zt=n("p"),Il=r("The "),as=n("a"),Sl=r("BlenderbotForConditionalGeneration"),Ll=r(" forward method, overrides the "),da=n("code"),Dl=r("__call__"),Gl=r(" special method."),Wl=i(),_(Ut.$$.fragment),Rl=i(),ia=n("p"),Ul=r("Conversation example:"),Hl=i(),_(Wo.$$.fragment),Ar=i(),xt=n("h2"),Ht=n("a"),la=n("span"),_(Ro.$$.fragment),Kl=i(),ca=n("span"),Vl=r("BlenderbotForCausalLM"),Ir=i(),Ft=n("div"),_(Uo.$$.fragment),Jl=i(),Ye=n("div"),_(Ho.$$.fragment),Ql=i(),pa=n("p"),Xl=r("Example:"),Yl=i(),_(Ko.$$.fragment),Sr=i(),$t=n("h2"),Kt=n("a"),ha=n("span"),_(Vo.$$.fragment),Zl=i(),ua=n("span"),ec=r("TFBlenderbotModel"),Lr=i(),le=n("div"),_(Jo.$$.fragment),tc=i(),Qo=n("p"),oc=r(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ec=i(),_(Xt.$$.fragment),Cc=i(),X=n("div"),_(rn.$$.fragment),jc=i(),Et=n("p"),Pc=r("The "),ls=n("a"),Nc=r("TFBlenderbotForConditionalGeneration"),Oc=r(" forward method, overrides the "),ba=n("code"),Ac=r("__call__"),Ic=r(" special method."),Sc=i(),_(Yt.$$.fragment),Lc=i(),ka=n("p"),Dc=r("Conversation example::"),Gc=i(),va=n("blockquote"),ya=n("blockquote"),Ta=n("blockquote"),wa=n("p"),Wc=r(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),sp=i(),Ma=n("p"),ap=r("Finally, this model supports inherent JAX features such as:"),rp=i(),Ue=n("ul"),Ea=n("li"),mn=n("a"),dp=r("Just-In-Time (JIT) compilation"),ip=i(),Ca=n("li"),fn=n("a"),lp=r("Automatic Differentiation"),cp=i(),ja=n("li"),_n=n("a"),pp=r("Vectorization"),hp=i(),Pa=n("li"),gn=n("a"),up=r("Parallelization"),mp=i(),ke=n("div"),_(bn.$$.fragment),fp=i(),jt=n("p"),_p=r("The "),Na=n("code"),gp=r("FlaxBlenderbotPreTrainedModel"),bp=r("forward method, overrides the "),Oa=n("code"),kp=r("__call__"),vp=r(" special method."),yp=i(),_(eo.$$.fragment),Tp=i(),Aa=n("p"),wp=r("Example:"),Bp=i(),_(kn.$$.fragment),zp=i(),Ze=n("div"),_(vn.$$.fragment),xp=i(),Ia=n("p"),Fp=r("Example:"),$p=i(),_(yn.$$.fragment),qp=i(),et=n("div"),_(Tn.$$.fragment),Mp=i(),Sa=n("p"),Ep=r("Example:"),Cp=i(),_(wn.$$.fragment),Ur=i(),Pt=n("h2"),to=n("a"),La=n("span"),_(Bn.$$.fragment),jp=i(),Da=n("span"),Pp=r("FlaxBlenderbotForConditionalGeneration"),Hr=i(),S=n("div"),_(zn.$$.fragment),Np=i(),xn=n("p"),Op=r(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
documentation from `),Vn=s(fs,"A",{href:!0});var nu=a(Vn);oi=d(nu,"PretrainedConfig"),nu.forEach(t),ni=d(fs," for more information."),fs.forEach(t),si=l(nt),Ns=s(nt,"P",{});var su=a(Ns);ai=d(su,"Example:"),su.forEach(t),ri=l(nt),g(vo.$$.fragment,nt),nt.forEach(t),Fr=l(o),vt=s(o,"H2",{class:!0});var ed=a(vt);It=s(ed,"A",{id:!0,class:!0,href:!0});var au=a(It);Os=s(au,"SPAN",{});var ru=a(Os);g(yo.$$.fragment,ru),ru.forEach(t),au.forEach(t),di=l(ed),As=s(ed,"SPAN",{});var du=a(As);ii=d(du,"BlenderbotTokenizer"),du.forEach(t),ed.forEach(t),$r=l(o),de=s(o,"DIV",{class:!0});var st=a(de);g(To.$$.fragment,st),li=l(st),Is=s(st,"P",{});var iu=a(Is);ci=d(iu,"Construct a Blenderbot tokenizer."),iu.forEach(t),pi=l(st),St=s(st,"P",{});var vr=a(St);Ss=s(vr,"CODE",{});var lu=a(Ss);hi=d(lu,"Blenderbot"),lu.forEach(t),ui=d(vr," is nearly identical to "),Jn=s(vr,"A",{href:!0});var cu=a(Jn);mi=d(cu,"RobertaTokenizer"),cu.forEach(t),fi=d(vr,` and runs end-to-end tokenization: punctuation splitting
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dd.forEach(t),ll=l(io),_e=s(io,"DIV",{class:!0});var rt=a(_e);g(No.$$.fragment,rt),cl=l(rt),wt=s(rt,"P",{});var bs=a(wt);pl=d(bs,"The "),os=s(bs,"A",{href:!0});var ju=a(os);hl=d(ju,"BlenderbotModel"),ju.forEach(t),ul=d(bs," forward method, overrides the "),ta=s(bs,"CODE",{});var Pu=a(ta);ml=d(Pu,"__call__"),Pu.forEach(t),fl=d(bs," special method."),bs.forEach(t),_l=l(rt),g(Wt.$$.fragment,rt),gl=l(rt),oa=s(rt,"P",{});var Nu=a(oa);bl=d(Nu,"Example:"),Nu.forEach(t),kl=l(rt),g(Oo.$$.fragment,rt),rt.forEach(t),io.forEach(t),Pr=l(o),Bt=s(o,"H2",{class:!0});var id=a(Bt);Rt=s(id,"A",{id:!0,class:!0,href:!0});var Ou=a(Rt);na=s(Ou,"SPAN",{});var Au=a(na);g(Ao.$$.fragment,Au),Au.forEach(t),Ou.forEach(t),vl=l(id),sa=s(id,"SPAN",{});var Iu=a(sa);yl=d(Iu,"BlenderbotForConditionalGeneration"),Iu.forEach(t),id.forEach(t),Nr=l(o),Re=s(o,"P",{});var Wn=a(Re);Tl=d(Wn,"See "),ns=s(Wn,"A",{href:!0});var Su=a(ns);wl=d(Su,"BartForConditionalGeneration"),Su.forEach(t),Bl=d(Wn," for arguments to "),aa=s(Wn,"EM",{});var Lu=a(aa);zl=d(Lu,"forward"),Lu.forEach(t),xl=d(Wn," and "),ra=s(Wn,"EM",{});var Du=a(ra);Fl=d(Du,"generate"),Du.forEach(t),Wn.forEach(t),Or=l(o),xe=s(o,"DIV",{class:!0});var lo=a(xe);g(Io.$$.fragment,lo),$l=l(lo),So=s(lo,"P",{});var ld=a(So);ql=d(ld,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cd.forEach(t),Ol=l(lo),ge=s(lo,"DIV",{class:!0});var dt=a(ge);g(Go.$$.fragment,dt),Al=l(dt),zt=s(dt,"P",{});var ks=a(zt);Il=d(ks,"The "),as=s(ks,"A",{href:!0});var Ru=a(as);Sl=d(Ru,"BlenderbotForConditionalGeneration"),Ru.forEach(t),Ll=d(ks," forward method, overrides the "),da=s(ks,"CODE",{});var Uu=a(da);Dl=d(Uu,"__call__"),Uu.forEach(t),Gl=d(ks," special method."),ks.forEach(t),Wl=l(dt),g(Ut.$$.fragment,dt),Rl=l(dt),ia=s(dt,"P",{});var Hu=a(ia);Ul=d(Hu,"Conversation example:"),Hu.forEach(t),Hl=l(dt),g(Wo.$$.fragment,dt),dt.forEach(t),lo.forEach(t),Ar=l(o),xt=s(o,"H2",{class:!0});var pd=a(xt);Ht=s(pd,"A",{id:!0,class:!0,href:!0});var Ku=a(Ht);la=s(Ku,"SPAN",{});var Vu=a(la);g(Ro.$$.fragment,Vu),Vu.forEach(t),Ku.forEach(t),Kl=l(pd),ca=s(pd,"SPAN",{});var Ju=a(ca);Vl=d(Ju,"BlenderbotForCausalLM"),Ju.forEach(t),pd.forEach(t),Ir=l(o),Ft=s(o,"DIV",{class:!0});var hd=a(Ft);g(Uo.$$.fragment,hd),Jl=l(hd),Ye=s(hd,"DIV",{class:!0});var vs=a(Ye);g(Ho.$$.fragment,vs),Ql=l(vs),pa=s(vs,"P",{});var Qu=a(pa);Xl=d(Qu,"Example:"),Qu.forEach(t),Yl=l(vs),g(Ko.$$.fragment,vs),vs.forEach(t),hd.forEach(t),Sr=l(o),$t=s(o,"H2",{class:!0});var ud=a($t);Kt=s(ud,"A",{id:!0,class:!0,href:!0});var Xu=a(Kt);ha=s(Xu,"SPAN",{});var Yu=a(ha);g(Vo.$$.fragment,Yu),Yu.forEach(t),Xu.forEach(t),Zl=l(ud),ua=s(ud,"SPAN",{});var Zu=a(ua);ec=d(Zu,"TFBlenderbotModel"),Zu.forEach(t),ud.forEach(t),Lr=l(o),le=s(o,"DIV",{class:!0});var it=a(le);g(Jo.$$.fragment,it),tc=l(it),Qo=s(it,"P",{});var md=a(Qo);oc=d(md,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
