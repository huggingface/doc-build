import{S as vi,i as wi,s as bi,e as s,k as d,w as _,t as a,L as Ti,c as n,d as t,m as c,a as r,x as y,h as i,b as l,J as e,g as h,y as k,q as v,o as w,B as b}from"../../chunks/vendor-9e2b328e.js";import{T as Ko}from"../../chunks/Tip-76f97a76.js";import{D as O}from"../../chunks/Docstring-50fd6873.js";import{C as je}from"../../chunks/CodeBlock-88e23343.js";import{I as he}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Ni(q){let m,N,p,T,$;return{c(){m=s("p"),N=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s("code"),T=a("Module"),$=a(`
...
the latter silently ignores them.`)},l(g){m=n(g,"P",{});var u=r(m);N=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n(u,"CODE",{});var M=r(p);T=i(M,"Module"),M.forEach(t),$=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(g,u){h(g,m,u),e(m,N),e(m,p),e(p,T),e(m,$)},d(g){g&&t(m)}}}function Ci(q){let m,N,p,T,$,g,u,M,vs,Wt,Y,ue,Xo,Pe,ws,et,bs,Bt,ge,Ts,Se,ot,Ns,$s,Qt,qo,Ms,Ht,Fo,tt,zs,Ut,Q,qs,Le,Fs,Cs,Ie,As,xs,Rt,Z,_e,st,De,Es,nt,js,Vt,F,Oe,Ps,K,Ss,Co,Ls,Is,We,Ds,Os,Ws,X,Bs,Ao,Qs,Hs,xo,Us,Rs,Vs,rt,Gs,Js,Be,Gt,ee,ye,at,Qe,Ys,it,Zs,Jt,W,He,Ks,Ue,Xs,Re,en,on,tn,C,Ve,sn,oe,nn,Eo,rn,an,lt,ln,dn,cn,ke,mn,dt,fn,pn,Ge,Yt,te,ve,ct,Je,hn,mt,un,Zt,B,Ye,gn,se,_n,ft,yn,kn,Ze,vn,wn,bn,A,Ke,Tn,ne,Nn,jo,$n,Mn,pt,zn,qn,Fn,we,Cn,ht,An,xn,Xe,Kt,re,be,ut,eo,En,gt,jn,Xt,S,oo,Pn,_t,Sn,Ln,to,In,so,Dn,On,Wn,z,no,Bn,ae,Qn,Po,Hn,Un,yt,Rn,Vn,Gn,Te,Jn,kt,Yn,Zn,ro,Kn,vt,Xn,er,ao,es,ie,Ne,wt,io,or,bt,tr,os,L,lo,sr,Tt,nr,rr,co,ar,mo,ir,lr,dr,x,fo,cr,le,mr,So,fr,pr,Nt,hr,ur,gr,$e,_r,$t,yr,kr,po,ts,de,Me,Mt,ho,vr,zt,wr,ss,I,uo,br,qt,Tr,Nr,go,$r,_o,Mr,zr,qr,E,yo,Fr,ce,Cr,Lo,Ar,xr,Ft,Er,jr,Pr,ze,Sr,Ct,Lr,Ir,ko,ns,me,qe,At,vo,Dr,xt,Or,rs,D,wo,Wr,fe,Br,Et,Qr,Hr,jt,Ur,Rr,Vr,bo,Gr,To,Jr,Yr,Zr,j,No,Kr,pe,Xr,Io,ea,oa,Pt,ta,sa,na,Fe,ra,St,aa,ia,$o,as;return g=new he({}),Pe=new he({}),De=new he({}),Oe=new O({props:{name:"class transformers.NystromformerConfig",anchor:"transformers.NystromformerConfig",parameters:[{name:"vocab_size",val:" = 30000"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu_new'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 510"},{name:"type_vocab_size",val:" = 2"},{name:"segment_means_seq_len",val:" = 64"},{name:"num_landmarks",val:" = 64"},{name:"conv_kernel_size",val:" = 65"},{name:"inv_coeff_init_option",val:" = False"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/nystromformer/configuration_nystromformer.py#L29",parametersDescription:[{anchor:"transformers.NystromformerConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30000) &#x2014;
...
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),Ut=d(),Q=s("p"),qs=a("This model was contributed by "),Le=s("a"),Fs=a("novice03"),Cs=a(". The original code can be found "),Ie=s("a"),As=a("here"),xs=a("."),Rt=d(),Z=s("h2"),_e=s("a"),st=s("span"),_(De.$$.fragment),Es=d(),nt=s("span"),js=a("NystromformerConfig"),Vt=d(),F=s("div"),_(Oe.$$.fragment),Ps=d(),K=s("p"),Ss=a("This is the configuration class to store the configuration of a "),Co=s("a"),Ls=a("NystromformerModel"),Is=a(`. It is used to instantiate
...
`),We=s("a"),Ds=a("uw-madison/nystromformer-512"),Os=a(" architecture."),Ws=d(),X=s("p"),Bs=a("Configuration objects inherit from "),Ao=s("a"),Qs=a("PretrainedConfig"),Hs=a(` and can be used to control the model outputs. Read the
...
behavior.`),tn=d(),C=s("div"),_(Ve.$$.fragment),sn=d(),oe=s("p"),nn=a("The "),Eo=s("a"),rn=a("NystromformerModel"),an=a(" forward method, overrides the "),lt=s("code"),ln=a("__call__"),dn=a(" special method."),cn=d(),_(ke.$$.fragment),mn=d(),dt=s("p"),fn=a("Example:"),pn=d(),_(Ge.$$.fragment),Yt=d(),te=s("h2"),ve=s("a"),ct=s("span"),_(Je.$$.fragment),hn=d(),mt=s("span"),un=a("NystromformerForMaskedLM"),Zt=d(),B=s("div"),_(Ye.$$.fragment),gn=d(),se=s("p"),_n=a("Nystr\xF6mformer Model with a "),ft=s("code"),yn=a("language modeling"),kn=a(` head on top.
This model is a PyTorch `),Ze=s("a"),vn=a("torch.nn.Module"),wn=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),bn=d(),A=s("div"),_(Ke.$$.fragment),Tn=d(),ne=s("p"),Nn=a("The "),jo=s("a"),$n=a("NystromformerForMaskedLM"),Mn=a(" forward method, overrides the "),pt=s("code"),zn=a("__call__"),qn=a(" special method."),Fn=d(),_(we.$$.fragment),Cn=d(),ht=s("p"),An=a("Example:"),xn=d(),_(Xe.$$.fragment),Kt=d(),re=s("h2"),be=s("a"),ut=s("span"),_(eo.$$.fragment),En=d(),gt=s("span"),jn=a("NystromformerForSequenceClassification"),Xt=d(),S=s("div"),_(oo.$$.fragment),Pn=d(),_t=s("p"),Sn=a(`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),dr=d(),x=s("div"),_(fo.$$.fragment),cr=d(),le=s("p"),mr=a("The "),So=s("a"),fr=a("NystromformerForMultipleChoice"),pr=a(" forward method, overrides the "),Nt=s("code"),hr=a("__call__"),ur=a(" special method."),gr=d(),_($e.$$.fragment),_r=d(),$t=s("p"),yr=a("Example:"),kr=d(),_(po.$$.fragment),ts=d(),de=s("h2"),Me=s("a"),Mt=s("span"),_(ho.$$.fragment),vr=d(),zt=s("span"),wr=a("NystromformerForTokenClassification"),ss=d(),I=s("div"),_(uo.$$.fragment),br=d(),qt=s("p"),Tr=a(`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qr=d(),E=s("div"),_(yo.$$.fragment),Fr=d(),ce=s("p"),Cr=a("The "),Lo=s("a"),Ar=a("NystromformerForTokenClassification"),xr=a(" forward method, overrides the "),Ft=s("code"),Er=a("__call__"),jr=a(" special method."),Pr=d(),_(ze.$$.fragment),Sr=d(),Ct=s("p"),Lr=a("Example:"),Ir=d(),_(ko.$$.fragment),ns=d(),me=s("h2"),qe=s("a"),At=s("span"),_(vo.$$.fragment),Dr=d(),xt=s("span"),Or=a("NystromformerForQuestionAnswering"),rs=d(),D=s("div"),_(wo.$$.fragment),Wr=d(),fe=s("p"),Br=a(`Nystr\xF6mformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ps.forEach(t),Wn=c(Ce),z=n(Ce,"DIV",{class:!0});var P=r(z);y(no.$$.fragment,P),Bn=c(P),ae=n(P,"P",{});var Vo=r(ae);Qn=i(Vo,"The "),Po=n(Vo,"A",{href:!0});var Ua=r(Po);Hn=i(Ua,"NystromformerForSequenceClassification"),Ua.forEach(t),Un=i(Vo," forward method, overrides the "),yt=n(Vo,"CODE",{});var Ra=r(yt);Rn=i(Ra,"__call__"),Ra.forEach(t),Vn=i(Vo," special method."),Vo.forEach(t),Gn=c(P),y(Te.$$.fragment,P),Jn=c(P),kt=n(P,"P",{});var Va=r(kt);Yn=i(Va,"Example of single-label classification:"),Va.forEach(t),Zn=c(P),y(ro.$$.fragment,P),Kn=c(P),vt=n(P,"P",{});var Ga=r(vt);Xn=i(Ga,"Example of multi-label classification:"),Ga.forEach(t),er=c(P),y(ao.$$.fragment,P),P.forEach(t),Ce.forEach(t),es=c(o),ie=n(o,"H2",{class:!0});var hs=r(ie);Ne=n(hs,"A",{id:!0,class:!0,href:!0});var Ja=r(Ne);wt=n(Ja,"SPAN",{});var Ya=r(wt);y(io.$$.fragment,Ya),Ya.forEach(t),Ja.forEach(t),or=c(hs),bt=n(hs,"SPAN",{});var Za=r(bt);tr=i(Za,"NystromformerForMultipleChoice"),Za.forEach(t),hs.forEach(t),os=c(o),L=n(o,"DIV",{class:!0});var Ae=r(L);y(lo.$$.fragment,Ae),sr=c(Ae),Tt=n(Ae,"P",{});var Ka=r(Tt);nr=i(Ka,`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
and a softmax) e.g. for RocStories/SWAG tasks.`),Ka.forEach(t),rr=c(Ae),co=n(Ae,"P",{});var us=r(co);ar=i(us,"This model is a PyTorch "),mo=n(us,"A",{href:!0,rel:!0});var Xa=r(mo);ir=i(Xa,"torch.nn.Module"),Xa.forEach(t),lr=i(us,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),us.forEach(t),dr=c(Ae),x=n(Ae,"DIV",{class:!0});var V=r(x);y(fo.$$.fragment,V),cr=c(V),le=n(V,"P",{});var Go=r(le);mr=i(Go,"The "),So=n(Go,"A",{href:!0});var ei=r(So);fr=i(ei,"NystromformerForMultipleChoice"),ei.forEach(t),pr=i(Go," forward method, overrides the "),Nt=n(Go,"CODE",{});var oi=r(Nt);hr=i(oi,"__call__"),oi.forEach(t),ur=i(Go," special method."),Go.forEach(t),gr=c(V),y($e.$$.fragment,V),_r=c(V),$t=n(V,"P",{});var ti=r($t);yr=i(ti,"Example:"),ti.forEach(t),kr=c(V),y(po.$$.fragment,V),V.forEach(t),Ae.forEach(t),ts=c(o),de=n(o,"H2",{class:!0});var gs=r(de);Me=n(gs,"A",{id:!0,class:!0,href:!0});var si=r(Me);Mt=n(si,"SPAN",{});var ni=r(Mt);y(ho.$$.fragment,ni),ni.forEach(t),si.forEach(t),vr=c(gs),zt=n(gs,"SPAN",{});var ri=r(zt);wr=i(ri,"NystromformerForTokenClassification"),ri.forEach(t),gs.forEach(t),ss=c(o),I=n(o,"DIV",{class:!0});var xe=r(I);y(uo.$$.fragment,xe),br=c(xe),qt=n(xe,"P",{});var ai=r(qt);Tr=i(ai,`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
