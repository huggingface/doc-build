import{S as pi,i as hi,s as mi,e as o,k as d,w as f,t as a,M as ui,c as s,d as n,m as c,a as r,x as g,h as i,b as l,F as e,g as h,y as _,q as k,o as v,B as w}from"../../chunks/vendor-4833417e.js";import{T as ci}from"../../chunks/Tip-fffd6df1.js";import{D as L}from"../../chunks/Docstring-4f315ed9.js";import{C as Xr}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as lt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function fi(we){let m,q,u,b,A;return{c(){m=o("p"),q=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=o("code"),b=a("Module"),A=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=s(S,"P",{});var T=r(m);q=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var N=r(u);b=i(N,"Module"),N.forEach(n),A=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(n)},m(S,T){h(S,m,T),e(m,q),e(m,u),e(u,b),e(m,A)},d(S){S&&n(m)}}}function gi(we){let m,q,u,b,A;return{c(){m=o("p"),q=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=o("code"),b=a("Module"),A=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=s(S,"P",{});var T=r(m);q=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var N=r(u);b=i(N,"Module"),N.forEach(n),A=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(n)},m(S,T){h(S,m,T),e(m,q),e(m,u),e(u,b),e(m,A)},d(S){S&&n(m)}}}function _i(we){let m,q,u,b,A,S,T,N,oo,wn,J,se,Lt,be,so,Nt,ro,bn,re,ao,Se,io,lo,Sn,dt,co,yn,ct,po,Tn,pt,ho,zn,C,ye,mo,ht,uo,fo,go,j,_o,mt,ko,vo,ut,wo,bo,jt,So,yo,To,Te,zo,Qt,qo,$o,Eo,P,xo,Ot,Ao,Po,Wt,Fo,Mo,Bt,Io,Co,Ut,Do,Lo,qn,D,No,ze,jo,Qo,qe,Oo,Wo,$e,Bo,Uo,$n,K,ae,Ht,Ee,Ho,Vt,Vo,En,z,xe,Jo,R,Ko,ft,Ro,Go,Ae,Xo,Yo,Zo,G,es,gt,ts,ns,_t,os,ss,rs,Jt,as,is,Pe,xn,X,ie,Kt,Fe,ls,Rt,ds,An,y,Me,cs,Gt,ps,hs,Ie,ms,kt,us,fs,gs,Q,Ce,_s,Xt,ks,vs,De,vt,ws,Yt,bs,Ss,wt,ys,Zt,Ts,zs,le,Le,qs,Ne,$s,en,Es,xs,As,O,je,Ps,bt,Fs,St,Ms,Is,tn,Cs,Ds,yt,Qe,Pn,Y,de,nn,Oe,Ls,on,Ns,Fn,F,We,js,Be,Qs,sn,Os,Ws,Bs,Ue,Us,Tt,Hs,Vs,Js,W,He,Ks,rn,Rs,Gs,Ve,zt,Xs,an,Ys,Zs,qt,er,ln,tr,Mn,Z,ce,dn,Je,nr,cn,or,In,M,Ke,sr,Re,rr,Ge,ar,ir,lr,Xe,dr,Ye,cr,pr,hr,$,Ze,mr,ee,ur,$t,fr,gr,pn,_r,kr,vr,pe,wr,hn,br,Sr,et,Cn,te,he,mn,tt,yr,un,Tr,Dn,I,nt,zr,ne,qr,fn,$r,Er,gn,xr,Ar,Pr,ot,Fr,st,Mr,Ir,Cr,E,rt,Dr,oe,Lr,Et,Nr,jr,_n,Qr,Or,Wr,me,Br,kn,Ur,Hr,at,Ln;return S=new lt({}),be=new lt({}),Ee=new lt({}),xe=new L({props:{name:"class transformers.SplinterConfig",anchor:"transformers.SplinterConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 0"},{name:"question_token_id",val:" = 104"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/splinter/configuration_splinter.py#L32",parametersDescription:[{anchor:"transformers.SplinterConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Qe=new L({props:{name:"save_vocabulary",anchor:"transformers.SplinterTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/splinter/tokenization_splinter.py#L307"}}),Oe=new lt({}),We=new L({props:{name:"class transformers.SplinterTokenizerFast",anchor:"transformers.SplinterTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"question_token",val:" = '[QUESTION]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/splinter/tokenization_splinter_fast.py#L55",parametersDescription:[{anchor:"transformers.SplinterTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Je=new lt({}),Ke=new L({props:{name:"class transformers.SplinterModel",anchor:"transformers.SplinterModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/splinter/modeling_splinter.py#L606",parametersDescription:[{anchor:"transformers.SplinterModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/splinter#transformers.SplinterConfig">SplinterConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ze=new L({props:{name:"forward",anchor:"transformers.SplinterModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/splinter/modeling_splinter.py#L637",parametersDescription:[{anchor:"transformers.SplinterModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),tt=new lt({}),nt=new L({props:{name:"class transformers.SplinterForQuestionAnswering",anchor:"transformers.SplinterForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/splinter/modeling_splinter.py#L828",parametersDescription:[{anchor:"transformers.SplinterForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/splinter#transformers.SplinterConfig">SplinterConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),rt=new L({props:{name:"forward",anchor:"transformers.SplinterForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"question_positions",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/splinter/modeling_splinter.py#L839",parametersDescription:[{anchor:"transformers.SplinterForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/splinter#transformers.SplinterTokenizer">SplinterTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
with only 128 training examples), while maintaining competitive performance in the high-resource setting.`),Tn=d(),pt=o("p"),ho=a("Tips:"),zn=d(),C=o("ul"),ye=o("li"),mo=a(`Splinter was trained to predict answers spans conditioned on a special [QUESTION] token. These tokens contextualize
to question representations which are used to predict the answers. This layer is called QASS, and is the default
behaviour in the `),ht=o("a"),uo=a("SplinterForQuestionAnswering"),fo=a(" class. Therefore:"),go=d(),j=o("li"),_o=a("Use "),mt=o("a"),ko=a("SplinterTokenizer"),vo=a(" (rather than "),ut=o("a"),wo=a("BertTokenizer"),bo=a(`), as it already
...
are replaced with a special token, viewed as a question representation, that is later used during fine-tuning to select
the answer span. The resulting model obtains surprisingly good results on multiple benchmarks (e.g., 72.7 F1 on SQuAD
with only 128 training examples), while maintaining competitive performance in the high-resource setting.`),ra.forEach(n),Tn=c(t),pt=s(t,"P",{});var aa=r(pt);ho=i(aa,"Tips:"),aa.forEach(n),zn=c(t),C=s(t,"UL",{});var ue=r(C);ye=s(ue,"LI",{});var Qn=r(ye);mo=i(Qn,`Splinter was trained to predict answers spans conditioned on a special [QUESTION] token. These tokens contextualize
to question representations which are used to predict the answers. This layer is called QASS, and is the default
behaviour in the `),ht=s(Qn,"A",{href:!0});var ia=r(ht);uo=i(ia,"SplinterForQuestionAnswering"),ia.forEach(n),fo=i(Qn," class. Therefore:"),Qn.forEach(n),go=c(ue),j=s(ue,"LI",{});var fe=r(j);_o=i(fe,"Use "),mt=s(fe,"A",{href:!0});var la=r(mt);ko=i(la,"SplinterTokenizer"),la.forEach(n),vo=i(fe," (rather than "),ut=s(fe,"A",{href:!0});var da=r(ut);wo=i(da,"BertTokenizer"),da.forEach(n),bo=i(fe,`), as it already
contains this special token. Also, its default behavior is to use this token when two sequences are given (for
example, in the `),jt=s(fe,"EM",{});var ca=r(jt);So=i(ca,"run_qa.py"),ca.forEach(n),yo=i(fe," script)."),fe.forEach(n),To=c(ue),Te=s(ue,"LI",{});var On=r(Te);zo=i(On,"If you plan on using Splinter outside "),Qt=s(On,"EM",{});var pa=r(Qt);qo=i(pa,"run_qa.py"),pa.forEach(n),$o=i(On,`, please keep in mind the question token - it might be important for
the success of your model, especially in a few-shot setting.`),On.forEach(n),Eo=c(ue),P=s(ue,"LI",{});var B=r(P);xo=i(B,`Please note there are two different checkpoints for each size of Splinter. Both are basically the same, except that
one also has the pretrained wights of the QASS layer (`),Ot=s(B,"EM",{});var ha=r(Ot);Ao=i(ha,"tau/splinter-base-qass"),ha.forEach(n),Po=i(B," and "),Wt=s(B,"EM",{});var ma=r(Wt);Fo=i(ma,"tau/splinter-large-qass"),ma.forEach(n),Mo=i(B,`) and one
doesn\u2019t (`),Bt=s(B,"EM",{});var ua=r(Bt);Io=i(ua,"tau/splinter-base"),ua.forEach(n),Co=i(B," and "),Ut=s(B,"EM",{});var fa=r(Ut);Do=i(fa,"tau/splinter-large"),fa.forEach(n),Lo=i(B,`). This is done to support randomly initializing this layer at
