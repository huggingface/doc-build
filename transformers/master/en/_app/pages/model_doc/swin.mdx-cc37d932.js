import{S as In,i as qn,s as zn,e as n,k as c,w,t as r,M as Nn,c as a,d as o,m as h,a as s,x as v,h as i,b as l,N as On,F as t,g as f,y as b,q as S,o as y,B as $}from"../../chunks/vendor-4833417e.js";import{T as Pn}from"../../chunks/Tip-fffd6df1.js";import{D as ot}from"../../chunks/Docstring-7b52c3d4.js";import{C as Yo}from"../../chunks/CodeBlock-90ffda97.js";import{I as nt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function Dn(ee){let m,T,p,u,C;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=r("Module"),C=r(`
...
<p>Example &#x2014;`,name:"layer_norm_eps"}]}}),de=new Yo({props:{codee:`from transformers import SwinModel, SwinConfig
...
`}}),R=new Pn({props:{$$slots:{default:[Dn]},$$scope:{ctx:ee}}}),ue=new Yo({props:{codee:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
`}}),J=new Pn({props:{$$slots:{default:[Ln]},$$scope:{ctx:ee}}}),Se=new Yo({props:{codee:`from transformers import AutoFeatureExtractor, SwinForImageClassification
import torch
from datasets import load_dataset
...
documentation from `),Me=a(ze,"A",{href:!0});var _n=s(Me);io=i(_n,"PretrainedConfig"),_n.forEach(o),lo=i(ze," for more information."),ze.forEach(o),co=h(Q),v(de.$$.fragment,Q),Q.forEach(o),ut=h(e),L=a(e,"H2",{class:!0});var Tt=s(L);Z=a(Tt,"A",{id:!0,class:!0,href:!0});var wn=s(Z);Ve=a(wn,"SPAN",{});var vn=s(Ve);v(ce.$$.fragment,vn),vn.forEach(o),wn.forEach(o),ho=h(Tt),Ke=a(Tt,"SPAN",{});var bn=s(Ke);fo=i(bn,"SwinModel"),bn.forEach(o),Tt.forEach(o),gt=h(e),M=a(e,"DIV",{class:!0});var Ne=s(M);v(he.$$.fragment,Ne),mo=h(Ne),fe=a(Ne,"P",{});var xt=s(fe);po=i(xt,`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),me=a(xt,"A",{href:!0,rel:!0});var Sn=s(me);uo=i(Sn,"torch.nn.Module"),Sn.forEach(o),go=i(xt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),xt.forEach(o),_o=h(Ne),x=a(Ne,"DIV",{class:!0});var P=s(x);v(pe.$$.fragment,P),wo=h(P),W=a(P,"P",{});var Oe=s(W);vo=i(Oe,"The "),Fe=a(Oe,"A",{href:!0});var yn=s(Fe);bo=i(yn,"SwinModel"),yn.forEach(o),So=i(Oe," forward method, overrides the "),Ye=a(Oe,"CODE",{});var $n=s(Ye);yo=i($n,"__call__"),$n.forEach(o),$o=i(Oe," special method."),Oe.forEach(o),To=h(P),v(R.$$.fragment,P),xo=h(P),Ze=a(P,"P",{});var Tn=s(Ze);Eo=i(Tn,"Example:"),Tn.forEach(o),Co=h(P),v(ue.$$.fragment,P),P.forEach(o),Ne.forEach(o),_t=h(e),H=a(e,"H2",{class:!0});var Et=s(H);G=a(Et,"A",{id:!0,class:!0,href:!0});var xn=s(G);Re=a(xn,"SPAN",{});var En=s(Re);v(ge.$$.fragment,En),En.forEach(o),xn.forEach(o),ko=h(Et),Ge=a(Et,"SPAN",{});var Cn=s(Ge);jo=i(Cn,"SwinForImageClassification"),Cn.forEach(o),Et.forEach(o),wt=h(e),j=a(e,"DIV",{class:!0});var X=s(j);v(_e.$$.fragment,X),Ao=h(X),Je=a(X,"P",{});var kn=s(Je);Mo=i(kn,`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
