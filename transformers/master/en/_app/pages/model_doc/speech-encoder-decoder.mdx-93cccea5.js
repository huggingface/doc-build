...
</ul>`,name:"kwargs"}]}}),ge=new et({props:{codee:`from transformers import BertConfig, Wav2Vec2Config, SpeechEncoderDecoderConfig, SpeechEncoderDecoderModel
...
`}}),ce=new Ss({props:{$$slots:{default:[$s]},$$scope:{ctx:he}}}),je=new et({props:{codee:`from transformers import SpeechEncoderDecoderModel, Speech2Text2Processor
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),Pe=new et({props:{codee:`from transformers import SpeechEncoderDecoderModel
...
`}}),le=new Ss({props:{$$slots:{default:[js]},$$scope:{ctx:he}}}),Be=new et({props:{codee:`from transformers import FlaxSpeechEncoderDecoderModel, BartTokenizer
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),Ue=new et({props:{codee:`from transformers import FlaxSpeechEncoderDecoderModel
