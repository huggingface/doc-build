...
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ds=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2Model.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Rs=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1732",parametersDescription:[{anchor:"transformers.Wav2Vec2ForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),on=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1866",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1987",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2161",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),En=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"sampled_negative_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[ET]},$$scope:{ctx:E}}}),Ln=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[CT]},$$scope:{ctx:E}}}),Hn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Up.forEach(t),fv=c(At),De=s(At,"DIV",{class:!0});var Lt=n(De);g(En.$$.fragment,Lt),uv=c(Lt),go=s(Lt,"P",{});var Oi=n(go);gv=i(Oi,"The "),gi=s(Oi,"A",{href:!0});var Gk=n(gi);_v=i(Gk,"Wav2Vec2ForPreTraining"),Gk.forEach(t),vv=i(Oi," forward method, overrides the "),ac=s(Oi,"CODE",{});var Jk=n(ac);wv=i(Jk,"__call__"),Jk.forEach(t),bv=i(Oi," special method."),Oi.forEach(t),yv=c(Lt),g(ia.$$.fragment,Lt),kv=c(Lt),sc=s(Lt,"P",{});var Zk=n(sc);Tv=i(Zk,"Example:"),Zk.forEach(t),xv=c(Lt),g(Pn.$$.fragment,Lt),Lt.forEach(t),At.forEach(t),Ed=c(o),_o=s(o,"H2",{class:!0});var Hp=n(_o);la=s(Hp,"A",{id:!0,class:!0,href:!0});var Kk=n(la);nc=s(Kk,"SPAN",{});var Qk=n(nc);g(Cn.$$.fragment,Qk),Qk.forEach(t),Kk.forEach(t),Wv=c(Hp),rc=s(Hp,"SPAN",{});var Yk=n(rc);$v=i(Yk,"TFWav2Vec2Model"),Yk.forEach(t),Hp.forEach(t),Pd=c(o),le=s(o,"DIV",{class:!0});var it=n(le);g(qn.$$.fragment,it),jv=c(it),ic=s(it,"P",{});var e1=n(ic);Vv=i(e1,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),e1.forEach(t),Fv=c(it),zn=s(it,"P",{});var Rp=n(zn);Ev=i(Rp,"This model inherits from "),_i=s(Rp,"A",{href:!0});var t1=n(_i);Pv=i(t1,"TFPreTrainedModel"),t1.forEach(t),Cv=i(Rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp.forEach(t),qv=c(it),Mn=s(it,"P",{});var Xp=n(Mn);zv=i(Xp,"This model is also a "),An=s(Xp,"A",{href:!0,rel:!0});var o1=n(An);Mv=i(o1,"tf.keras.Model"),o1.forEach(t),Av=i(Xp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xp.forEach(t),Lv=c(it),g(ca.$$.fragment,it),Dv=c(it),Oe=s(it,"DIV",{class:!0});var Dt=n(Oe);g(Ln.$$.fragment,Dt),Ov=c(Dt),vo=s(Dt,"P",{});var Si=n(vo);Sv=i(Si,"The "),vi=s(Si,"A",{href:!0});var a1=n(vi);Nv=i(a1,"TFWav2Vec2Model"),a1.forEach(t),Iv=i(Si," forward method, overrides the "),lc=s(Si,"CODE",{});var s1=n(lc);Bv=i(s1,"__call__"),s1.forEach(t),Uv=i(Si," special method."),Si.forEach(t),Hv=c(Dt),g(da.$$.fragment,Dt),Rv=c(Dt),cc=s(Dt,"P",{});var n1=n(cc);Xv=i(n1,"Example:"),n1.forEach(t),Gv=c(Dt),g(Dn.$$.fragment,Dt),Dt.forEach(t),it.forEach(t),Cd=c(o),wo=s(o,"H2",{class:!0});var Gp=n(wo);pa=s(Gp,"A",{id:!0,class:!0,href:!0});var r1=n(pa);dc=s(r1,"SPAN",{});var i1=n(dc);g(On.$$.fragment,i1),i1.forEach(t),r1.forEach(t),Jv=c(Gp),pc=s(Gp,"SPAN",{});var l1=n(pc);Zv=i(l1,"TFWav2Vec2ForCTC"),l1.forEach(t),Gp.forEach(t),qd=c(o),ce=s(o,"DIV",{class:!0});var lt=n(ce);g(Sn.$$.fragment,lt),Kv=c(lt),Nn=s(lt,"P",{});var Jp=n(Nn);Qv=i(Jp,"TFWav2Vec2 Model with a "),mc=s(Jp,"CODE",{});var c1=n(mc);Yv=i(c1,"language modeling"),c1.forEach(t),e2=i(Jp," head on top for Connectionist Temporal Classification (CTC)."),Jp.forEach(t),t2=c(lt),In=s(lt,"P",{});var Zp=n(In);o2=i(Zp,"This model inherits from "),wi=s(Zp,"A",{href:!0});var d1=n(wi);a2=i(d1,"TFPreTrainedModel"),d1.forEach(t),s2=i(Zp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kp.forEach(t),c2=c(lt),g(ma.$$.fragment,lt),d2=c(lt),Se=s(lt,"DIV",{class:!0});var Ot=n(Se);g(Hn.$$.fragment,Ot),p2=c(Ot),bo=s(Ot,"P",{});var Ni=n(bo);m2=i(Ni,"The "),bi=s(Ni,"A",{href:!0});var m1=n(bi);h2=i(m1,"TFWav2Vec2ForCTC"),m1.forEach(t),f2=i(Ni," forward method, overrides the "),hc=s(Ni,"CODE",{});var h1=n(hc);u2=i(h1,"__call__"),h1.forEach(t),g2=i(Ni," special method."),Ni.forEach(t),_2=c(Ot),g(ha.$$.fragment,Ot),v2=c(Ot),fc=s(Ot,"P",{});var f1=n(fc);w2=i(f1,"Example:"),f1.forEach(t),b2=c(Ot),g(Rn.$$.fragment,Ot),Ot.forEach(t),lt.forEach(t),zd=c(o),yo=s(o,"H2",{class:!0});var Qp=n(yo);fa=s(Qp,"A",{id:!0,class:!0,href:!0});var u1=n(fa);uc=s(u1,"SPAN",{});var g1=n(uc);g(Xn.$$.fragment,g1),g1.forEach(t),u1.forEach(t),y2=c(Qp),gc=s(Qp,"SPAN",{});var _1=n(gc);k2=i(_1,"FlaxWav2Vec2Model"),_1.forEach(t),Qp.forEach(t),Md=c(o),K=s(o,"DIV",{class:!0});var He=n(K);g(Gn.$$.fragment,He),T2=c(He),Jn=s(He,"P",{});var Yp=n(Jn);x2=i(Yp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Auli.`),Yp.forEach(t),j2=c(He),Kn=s(He,"P",{});var em=n(Kn);V2=i(em,"This model inherits from "),yi=s(em,"A",{href:!0});var w1=n(yi);F2=i(w1,"FlaxPreTrainedModel"),w1.forEach(t),E2=i(em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),em.forEach(t),P2=c(He),Qn=s(He,"P",{});var tm=n(Qn);C2=i(tm,`This model is also a Flax Linen
`),Yn=s(tm,"A",{href:!0,rel:!0});var b1=n(Yn);q2=i(b1,"flax.nn.Module"),b1.forEach(t),z2=i(tm,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),tm.forEach(t),M2=c(He),_c=s(He,"P",{});var y1=n(_c);A2=i(y1,"Finally, this model supports inherent JAX features such as:"),y1.forEach(t),L2=c(He),bt=s(He,"UL",{});var $a=n(bt);vc=s($a,"LI",{});var k1=n(vc);er=s(k1,"A",{href:!0,rel:!0});var T1=n(er);D2=i(T1,"Just-In-Time (JIT) compilation"),T1.forEach(t),k1.forEach(t),O2=c($a),wc=s($a,"LI",{});var x1=n(wc);tr=s(x1,"A",{href:!0,rel:!0});var W1=n(tr);S2=i(W1,"Automatic Differentiation"),W1.forEach(t),x1.forEach(t),N2=c($a),bc=s($a,"LI",{});var $1=n(bc);or=s($1,"A",{href:!0,rel:!0});var j1=n(or);I2=i(j1,"Vectorization"),j1.forEach(t),$1.forEach(t),B2=c($a),yc=s($a,"LI",{});var V1=n(yc);ar=s(V1,"A",{href:!0,rel:!0});var F1=n(ar);U2=i(F1,"Parallelization"),F1.forEach(t),V1.forEach(t),$a.forEach(t),H2=c(He),Ne=s(He,"DIV",{class:!0});var St=n(Ne);g(sr.$$.fragment,St),R2=c(St),ko=s(St,"P",{});var Ii=n(ko);X2=i(Ii,"The "),kc=s(Ii,"CODE",{});var E1=n(kc);G2=i(E1,"FlaxWav2Vec2PreTrainedModel"),E1.forEach(t),J2=i(Ii,"forward method, overrides the "),Tc=s(Ii,"CODE",{});var P1=n(Tc);Z2=i(P1,"__call__"),P1.forEach(t),K2=i(Ii," special method."),Ii.forEach(t),Q2=c(St),g(ua.$$.fragment,St),Y2=c(St),xc=s(St,"P",{});var C1=n(xc);ew=i(C1,"Example:"),C1.forEach(t),tw=c(St),g(nr.$$.fragment,St),St.forEach(t),He.forEach(t),Ad=c(o),To=s(o,"H2",{class:!0});var om=n(To);ga=s(om,"A",{id:!0,class:!0,href:!0});var q1=n(ga);Wc=s(q1,"SPAN",{});var z1=n(Wc);g(rr.$$.fragment,z1),z1.forEach(t),q1.forEach(t),ow=c(om),$c=s(om,"SPAN",{});var M1=n($c);aw=i(M1,"FlaxWav2Vec2ForCTC"),M1.forEach(t),om.forEach(t),Ld=c(o),Q=s(o,"DIV",{class:!0});var Re=n(Q);g(ir.$$.fragment,Re),sw=c(Re),xo=s(Re,"P",{});var Bi=n(xo);nw=i(Bi,"Wav2Vec2 Model with a "),jc=s(Bi,"CODE",{});var A1=n(jc);rw=i(A1,"language modeling"),A1.forEach(t),iw=i(Bi,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),lr=s(Bi,"A",{href:!0,rel:!0});var L1=n(lr);lw=i(L1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),L1.forEach(t),cw=i(Bi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Bi.forEach(t),dw=c(Re),cr=s(Re,"P",{});var am=n(cr);pw=i(am,"This model inherits from "),ki=s(am,"A",{href:!0});var D1=n(ki);mw=i(D1,"FlaxPreTrainedModel"),D1.forEach(t),hw=i(am,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),am.forEach(t),fw=c(Re),dr=s(Re,"P",{});var sm=n(dr);uw=i(sm,`This model is also a Flax Linen
`),pr=s(sm,"A",{href:!0,rel:!0});var O1=n(pr);gw=i(O1,"flax.nn.Module"),O1.forEach(t),_w=i(sm,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),sm.forEach(t),vw=c(Re),Vc=s(Re,"P",{});var S1=n(Vc);ww=i(S1,"Finally, this model supports inherent JAX features such as:"),S1.forEach(t),bw=c(Re),yt=s(Re,"UL",{});var ja=n(yt);Fc=s(ja,"LI",{});var N1=n(Fc);mr=s(N1,"A",{href:!0,rel:!0});var I1=n(mr);yw=i(I1,"Just-In-Time (JIT) compilation"),I1.forEach(t),N1.forEach(t),kw=c(ja),Ec=s(ja,"LI",{});var B1=n(Ec);hr=s(B1,"A",{href:!0,rel:!0});var U1=n(hr);Tw=i(U1,"Automatic Differentiation"),U1.forEach(t),B1.forEach(t),xw=c(ja),Pc=s(ja,"LI",{});var H1=n(Pc);fr=s(H1,"A",{href:!0,rel:!0});var R1=n(fr);Ww=i(R1,"Vectorization"),R1.forEach(t),H1.forEach(t),$w=c(ja),Cc=s(ja,"LI",{});var X1=n(Cc);ur=s(X1,"A",{href:!0,rel:!0});var G1=n(ur);jw=i(G1,"Parallelization"),G1.forEach(t),X1.forEach(t),ja.forEach(t),Vw=c(Re),Ie=s(Re,"DIV",{class:!0});var Nt=n(Ie);g(gr.$$.fragment,Nt),Fw=c(Nt),Wo=s(Nt,"P",{});var Ui=n(Wo);Ew=i(Ui,"The "),qc=s(Ui,"CODE",{});var J1=n(qc);Pw=i(J1,"FlaxWav2Vec2PreTrainedModel"),J1.forEach(t),Cw=i(Ui,"forward method, overrides the "),zc=s(Ui,"CODE",{});var Z1=n(zc);qw=i(Z1,"__call__"),Z1.forEach(t),zw=i(Ui," special method."),Ui.forEach(t),Mw=c(Nt),g(_a.$$.fragment,Nt),Aw=c(Nt),Mc=s(Nt,"P",{});var K1=n(Mc);Lw=i(K1,"Example:"),K1.forEach(t),Dw=c(Nt),g(_r.$$.fragment,Nt),Nt.forEach(t),Re.forEach(t),Dd=c(o),$o=s(o,"H2",{class:!0});var nm=n($o);va=s(nm,"A",{id:!0,class:!0,href:!0});var Q1=n(va);Ac=s(Q1,"SPAN",{});var Y1=n(Ac);g(vr.$$.fragment,Y1),Y1.forEach(t),Q1.forEach(t),Ow=c(nm),Lc=s(nm,"SPAN",{});var eT=n(Lc);Sw=i(eT,"FlaxWav2Vec2ForPreTraining"),eT.forEach(t),nm.forEach(t),Od=c(o),Y=s(o,"DIV",{class:!0});var Xe=n(Y);g(wr.$$.fragment,Xe),Nw=c(Xe),jo=s(Xe,"P",{});var Hi=n(jo);Iw=i(Hi,"Wav2Vec2 Model with a quantizer and "),Dc=s(Hi,"CODE",{});var tT=n(Dc);Bw=i(tT,"VQ"),tT.forEach(t),Uw=i(Hi,` head on top.
