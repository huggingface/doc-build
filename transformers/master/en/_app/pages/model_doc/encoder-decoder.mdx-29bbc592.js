import{S as xi,i as ji,s as $i,e as a,k as i,w as u,t as n,L as qi,c as s,d as o,m as c,a as d,x as g,h as r,b as l,J as e,g as h,y as _,q as b,o as v,B as y}from"../../chunks/vendor-9e2b328e.js";import{T as dd}from"../../chunks/Tip-76f97a76.js";import{D as O}from"../../chunks/Docstring-50fd6873.js";import{C as Me}from"../../chunks/CodeBlock-88e23343.js";import{I as Rt}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Pi(Q){let m,x,f,w,P;return{c(){m=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
...
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);x=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,x),e(m,f),e(f,w),e(m,P)},d(k){k&&o(m)}}}function Ai(Q){let m,x,f,w,P,k,T,F,zn,Gt,me,Mn,wo,xn,jn,Ut,he,$n,xe,qn,Pn,Vt,fe,Fn,Eo,Cn,An,Ht,W,Sn,Do,Nn,In,je,Ln,Bn,Jt,R,On,Qo,Wn,Rn,Xo,Gn,Un,Yt,$e,Zt,G,Vn,qe,Hn,Jn,Pe,Yn,Zn,Kt,X,ue,et,Fe,Kn,ot,Qn,Qt,M,Ce,Xn,ge,zo,er,or,Mo,tr,nr,rr,ee,ar,xo,sr,dr,jo,ir,cr,lr,tt,pr,mr,Ae,hr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,oe,yr,nt,kr,Tr,rt,wr,Er,Xt,te,ve,at,Le,Dr,st,zr,en,E,Be,Mr,ne,xr,dt,jr,$r,it,qr,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ct,Ir,Lr,Re,Br,qo,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Jr,Yr,lt,Zr,Kr,pt,Qr,Xr,ea,C,Ve,oa,re,ta,Fo,na,ra,mt,aa,sa,da,ye,ia,ht,ca,la,He,pa,A,Je,ma,ft,ha,fa,ae,ua,ut,ga,_a,gt,ba,va,ya,_t,ka,Ta,Ye,on,se,ke,bt,Ze,wa,vt,Ea,tn,D,Ke,Da,de,za,yt,Ma,xa,kt,ja,$a,qa,Qe,Pa,Xe,Fa,Ca,Aa,Tt,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,to,Ra,Ga,Ua,V,Ao,Va,Ha,wt,Ja,Ya,Et,Za,Ka,Qa,S,no,Xa,ie,es,So,os,ts,Dt,ns,rs,as,Te,ss,zt,ds,is,ro,cs,L,ao,ls,Mt,ps,ms,xt,hs,fs,so,nn,ce,we,jt,io,us,$t,gs,rn,z,co,_s,le,bs,qt,vs,ys,Pt,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Ft,xs,js,mo,$s,No,qs,Ps,Fs,ho,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,Ct,Bs,Os,At,Ws,Rs,Gs,N,uo,Us,pe,Vs,Lo,Hs,Js,St,Ys,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,bo,an;return k=new Rt({}),$e=new Me({props:{code:`# a workaround to load from pytorch checkpoint
