import{S as op,i as sp,s as ap,e as a,k as l,w as _,t as o,M as rp,c as r,d as t,m as c,a as i,x as k,h as s,b as d,F as e,g as u,y,q as b,o as v,B as w}from"../../chunks/vendor-329198bb.js";import{T as Ro}from"../../chunks/Tip-39ae8a84.js";import{D as O}from"../../chunks/Docstring-88811472.js";import{C as Nn}from"../../chunks/CodeBlock-49151c5f.js";import{I as ze}from"../../chunks/IconCopyLink-236b0ec7.js";import"../../chunks/CopyButton-970e2b07.js";function ip(U){let h,L,m,T,E;return{c(){h=a("p"),L=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),T=o("Module"),E=o(`
...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var z=i(m);T=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,T),e(h,E)},d(g){g&&t(h)}}}function hp(U){let h,L,m,T,E,g,f,z,Bs,Ho,le,xe,Dn,He,Ws,Bn,Os,Vo,$e,Us,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Wn,Vs,Jo,Gt,Ys,Xo,R,On,Ye,Qs,Zt,Js,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ra,ia,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,wa,on,Gn,Ta,La,Ea,K,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Ma,Ca,Fa,Me,an,Pa,ja,Ge,Aa,Ia,Sa,rn,dn,Na,Da,Ba,S,ln,Wa,Oa,eo,Ua,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,er,Ze,tr,nr,or,et,sr,tt,ar,rr,Go,pn,ir,Zo,nt,es,V,dr,ot,lr,cr,st,pr,hr,at,ur,mr,ts,he,Ce,so,rt,fr,ao,gr,ns,M,it,_r,dt,kr,hn,yr,br,vr,ue,wr,un,Tr,Lr,mn,Er,zr,xr,ro,$r,qr,lt,os,me,Fe,io,ct,Mr,lo,Cr,ss,C,pt,Fr,co,Pr,jr,x,Ar,fn,Ir,Sr,gn,Nr,Dr,_n,Br,Wr,po,Or,Ur,ho,Kr,Rr,uo,Hr,Vr,mo,Yr,Qr,Jr,Pe,ht,Xr,fo,Gr,Zr,kn,ut,as,fe,je,go,mt,ei,_o,ti,rs,F,ft,ni,ko,oi,si,gt,ai,yn,ri,ii,di,_t,li,kt,ci,pi,hi,N,yt,ui,ge,mi,bn,fi,gi,yo,_i,ki,yi,Ae,bi,bo,vi,wi,bt,is,_e,Ie,vo,vt,Ti,wo,Li,ds,P,wt,Ei,To,zi,xi,Tt,$i,vn,qi,Mi,Ci,Lt,Fi,Et,Pi,ji,Ai,J,zt,Ii,ke,Si,wn,Ni,Di,Lo,Bi,Wi,Oi,Se,ls,ye,Ne,Eo,xt,Ui,zo,Ki,cs,j,$t,Ri,xo,Hi,Vi,qt,Yi,Tn,Qi,Ji,Xi,Mt,Gi,Ct,Zi,ed,td,D,Ft,nd,be,od,Ln,sd,ad,$o,rd,id,dd,De,ld,qo,cd,pd,Pt,ps,ve,Be,Mo,jt,hd,Co,ud,hs,A,At,md,Fo,fd,gd,It,_d,En,kd,yd,bd,St,vd,Nt,wd,Td,Ld,B,Dt,Ed,we,zd,zn,xd,$d,Po,qd,Md,Cd,We,Fd,jo,Pd,jd,Bt,us,Te,Oe,Ao,Wt,Ad,Io,Id,ms,I,Ot,Sd,So,Nd,Dd,Ut,Bd,xn,Wd,Od,Ud,Kt,Kd,Rt,Rd,Hd,Vd,W,Ht,Yd,Le,Qd,$n,Jd,Xd,No,Gd,Zd,el,Ue,tl,Do,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Nn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
documentation from `),mn=a("a"),Er=o("PretrainedConfig"),zr=o(" for more information."),xr=l(),ro=a("p"),$r=o("Examples:"),qr=l(),_(lt.$$.fragment),os=l(),me=a("h2"),Fe=a("a"),io=a("span"),_(ct.$$.fragment),Mr=l(),lo=a("span"),Cr=o("LukeTokenizer"),ss=l(),C=a("div"),_(pt.$$.fragment),Fr=l(),co=a("p"),Pr=o("Construct a LUKE tokenizer."),jr=l(),x=a("p"),Ar=o("This tokenizer inherits from "),fn=a("a"),Ir=o("RobertaTokenizer"),Sr=o(` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),D=a("div"),_(Ft.$$.fragment),nd=l(),be=a("p"),od=o("The "),Ln=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),rd=o("__call__"),id=o(" special method."),dd=l(),_(De.$$.fragment),ld=l(),qo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),Be=a("a"),Mo=a("span"),_(jt.$$.fragment),hd=l(),Co=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Fo=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
