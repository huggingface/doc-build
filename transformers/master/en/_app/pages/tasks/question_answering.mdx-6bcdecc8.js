...
or `),d=l(k,"A",{href:!0,rel:!0});var O=i(d);g=n(O,"TensorFlow notebook"),O.forEach(e),E=n(k,"."),k.forEach(e),this.h()},h(){c(m,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/question_answering.ipynb"),c(m,"rel","nofollow"),c(d,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/question_answering-tf.ipynb"),c(d,"rel","nofollow")},m(A,k){p(A,u,k),t(u,b),t(u,m),t(m,_),t(u,y),t(u,d),t(d,g),t(u,E)},d(A){A&&e(u)}}}function Wo(F){let u,b,m,_,y,d,g,E,A,k,T,O,Bs,Ve,Rt,J,lt,Ye,Je,it,Ge,Ut,Q,Ke,cs,We,Xe,us,Ze,sa,Ht,G,Vt,R,K,pt,ms,ta,ht,ea,Yt,Ns,aa,Jt,ds,Gt,Rs,na,Kt,_s,Wt,L,oa,ft,ra,la,ct,ia,pa,Xt,U,W,ut,gs,ha,mt,fa,Zt,ws,se,M,ca,dt,ua,ma,_t,da,_a,te,js,ee,Us,ga,ae,I,P,wa,gt,ja,$a,wt,va,xa,jt,qa,ba,ka,H,ya,$t,Ea,Aa,vt,Ta,Da,za,S,Ca,$s,xt,Fa,Pa,qt,Sa,Oa,bt,Qa,La,ne,X,Ma,kt,Ia,Ba,oe,vs,re,D,Na,xs,yt,Ra,Ua,Et,Ha,Va,At,Ya,Ja,le,qs,ie,B,Ga,Hs,Ka,Wa,Tt,Xa,Za,pe,bs,he,V,Z,Dt,ks,sn,zt,tn,fe,ss,en,Vs,an,nn,ce,ys,ue,ts,me,Ys,on,de,N,Es,rn,Js,ln,pn,hn,As,fn,Gs,cn,un,mn,Ts,dn,Ks,_n,gn,_e,Ds,ge,Y,es,Ct,zs,wn,Ft,jn,we,Ws,$n,je,as,$e,z,vn,Pt,xn,qn,Cs,St,bn,kn,Ot,yn,En,ve,Fs,xe,Xs,An,qe,Ps,be,ns,Tn,Zs,Dn,zn,ke,Ss,ye,os,Cn,Os,Qt,Fn,Pn,Ee,Qs,Ae,rs,Sn,Ls,Lt,On,Qn,Te,Ms,De,ls,ze;return d=new Nt({}),T=new Bo({props:{id:"ajPx5LwJD-I"}}),G=new He({props:{$$slots:{default:[Yo]},$$scope:{ctx:F}}}),ms=new Nt({}),ds=new C({props:{code:`from datasets import load_dataset
