import{S as Vl,i as Xl,s as Zl,e as r,k as i,w as j,t as n,R as er,c as o,d as a,m as c,a as p,x as _,h as t,b as E,F as s,g as u,y as v,q as y,o as g,B as $}from"../chunks/vendor-9daddcfa.js";import{T as Ht}from"../chunks/Tip-c0a70391.js";import{I as Mt}from"../chunks/IconCopyLink-a413fd1b.js";import{C as F}from"../chunks/CodeBlock-37b92346.js";import"../chunks/CopyButton-6099fd9d.js";function sr(I){let h,w;return{c(){h=r("p"),w=n("This feature is currently available for PyTorch-only.")},l(d){h=o(d,"P",{});var f=p(h);w=t(f,"This feature is currently available for PyTorch-only."),f.forEach(a)},m(d,f){u(d,h,f),s(h,w)},d(d){d&&a(h)}}}function ar(I){let h,w,d,f,x;return{c(){h=r("p"),w=n("For multi-GPU training it requires DDP ("),d=r("code"),f=n("torch.distributed.launch"),x=n(").")},l(b){h=o(b,"P",{});var D=p(h);w=t(D,"For multi-GPU training it requires DDP ("),d=o(D,"CODE",{});var N=p(d);f=t(N,"torch.distributed.launch"),N.forEach(a),x=t(D,")."),D.forEach(a)},m(b,D){u(b,h,D),s(h,w),s(h,d),s(d,f),s(h,x)},d(b){b&&a(h)}}}function nr(I){let h,w,d,f,x;return{c(){h=r("p"),w=n("This feature can be used with any "),d=r("code"),f=n("nn.Module"),x=n("-based model.")},l(b){h=o(b,"P",{});var D=p(h);w=t(D,"This feature can be used with any "),d=o(D,"CODE",{});var N=p(d);f=t(N,"nn.Module"),N.forEach(a),x=t(D,"-based model."),D.forEach(a)},m(b,D){u(b,h,D),s(h,w),s(h,d),s(d,f),s(h,x)},d(b){b&&a(h)}}}function tr(I){let h,w,d,f,x,b,D,N,La,Cs,q,Y,Ue,oe,Aa,Ie,Sa,Ps,K,Ls,z,As,B,Ss,C,Ra,qe,Fa,Na,He,Ga,Ua,Me,Ia,qa,Rs,W,Ha,ge,Ma,Ya,Fs,pe,Ns,G,Ka,Ye,za,Ba,$e,Wa,Ja,Gs,De,Qa,Us,ue,Is,T,Ee,Va,Xa,Ke,Za,en,ze,sn,an,Be,nn,tn,qs,ie,Hs,ke,ln,Ms,m,rn,We,on,pn,Je,un,cn,Qe,hn,dn,Ve,fn,mn,Xe,bn,wn,Ze,jn,_n,es,vn,yn,Ys,J,gn,ss,$n,Dn,Ks,Oe,En,zs,ce,Bs,P,kn,as,On,xn,ns,Tn,Cn,ts,Pn,Ln,Ws,xe,An,Js,he,Qs,k,Sn,ls,Rn,Fn,rs,Nn,Gn,os,Un,In,ps,qn,Hn,us,Mn,Yn,Vs,L,Kn,is,zn,Bn,cs,Wn,Jn,hs,Qn,Vn,Xs,Te,Xn,Zs,Q,Zn,ds,et,st,ea,de,sa,V,at,fs,nt,tt,aa,X,lt,ms,rt,ot,na,A,pt,bs,ut,it,ws,ct,ht,js,dt,ft,ta,fe,la,U,mt,_s,bt,wt,vs,jt,_t,ra,me,oa,S,vt,ys,yt,gt,gs,$t,Dt,$s,Et,kt,pa,Z,Ot,Ds,xt,Tt,ua,Ce,Ct,ia,be,ca,H,ee,Es,we,Pt,ks,Lt,ha,Pe,At,da,se,St,Os,Rt,Ft,fa,je,ma,Le,Nt,ba,Ae,Gt,wa,Se,Ut,ja,_e,_a,Re,It,va,Fe,qt,ya,ve,ga;return b=new Mt({}),oe=new Mt({}),K=new Ht({props:{$$slots:{default:[sr]},$$scope:{ctx:I}}}),z=new Ht({props:{$$slots:{default:[ar]},$$scope:{ctx:I}}}),B=new Ht({props:{$$slots:{default:[nr]},$$scope:{ctx:I}}}),pe=new F({props:{code:"--debug underflow_overflow",highlighted:"--debug underflow_overflow"}}),ue=new F({props:{code:`from .debug_utils import DebugUnderflowOverflow
...
you can accomplish that easily by activating a special module that will do the detection automatically.`),Rs=i(),W=r("p"),Ha=n("If you\u2019re using "),ge=r("a"),Ma=n("Trainer"),Ya=n(", you just need to add:"),Fs=i(),j(pe.$$.fragment),Ns=i(),G=r("p"),Ka=n("to the normal command line arguments, or pass "),Ye=r("code"),za=n('debug="underflow_overflow"'),Ba=n(` when creating the
...
input elements was `),ps=r("code"),qn=n("6.27e+04"),Hn=n(" and same for the output was "),us=r("code"),Mn=n("inf"),Yn=n("."),Vs=i(),L=r("p"),Kn=n("You can see here, that "),is=r("code"),zn=n("T5DenseGatedGeluDense.forward"),Bn=n(` resulted in output activations, whose absolute max value was
