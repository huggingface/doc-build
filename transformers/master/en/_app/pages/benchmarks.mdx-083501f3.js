import{S as Tt,i as Bt,s as $t,e as l,k as h,w as S,t as n,R as At,c as t,d as a,m,a as o,x as D,h as r,b,F as s,g as p,y as q,q as R,o as x,B as L}from"../chunks/vendor-9daddcfa.js";import{T as Pt}from"../chunks/Tip-c0a70391.js";import{I as ua}from"../chunks/IconCopyLink-a413fd1b.js";import{C as ba}from"../chunks/CodeBlockFw-76897d0e.js";import{D as Ct}from"../chunks/DocNotebookDropdown-fca2a2d3.js";import"../chunks/IconTensorflow-a035d33c.js";import"../chunks/CopyButton-6099fd9d.js";function Nt($s){let j,C,_,E,z,T,ls,U;return{c(){j=l("p"),C=n("Hereby, "),_=l("em"),E=n("inference"),z=n(" is defined by a single forward pass, and "),T=l("em"),ls=n("training"),U=n(` is defined by a single forward pass and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>benchmark = PyTorchBenchmark(args)`},group2:{id:"tf",code:`from transformers import TensorFlowBenchmark, TensorFlowBenchmarkArguments
...
<span class="hljs-meta">&gt;&gt;&gt; </span>benchmark = TensorFlowBenchmark(args)`}}}),ms=new ba({props:{group1:{id:"pt",code:"python examples/pytorch/benchmarking/run_benchmark.py --help",highlighted:'python examples/pytorch/benchmarking/run_benchmark.py --<span class="hljs-built_in">help</span>'},group2:{id:"tf",code:"python examples/tensorflow/benchmarking/run_benchmark_tf.py --help",highlighted:'python examples/tensorflow/benchmarking/run_benchmark_tf.py --<span class="hljs-built_in">help</span>'}}}),is=new ba({props:{group1:{id:"pt",code:`results = benchmark.run()
print(results)
...
- use_tpu: <span class="hljs-literal">False</span>`},group2:{id:"tf",code:`results = benchmark.run()
print(results)
...
- gpu_power_watts: <span class="hljs-number">280.0</span>
- gpu_performance_state: <span class="hljs-number">2</span>
- use_tpu: <span class="hljs-literal">False</span>`}}}),us=new ba({props:{group1:{id:"pt",code:`from transformers import PyTorchBenchmark, PyTorchBenchmarkArguments, BertConfig
...
- gpu_power_watts: <span class="hljs-number">280.0</span>
- gpu_performance_state: <span class="hljs-number">2</span>
- use_tpu: <span class="hljs-literal">False</span>`},group2:{id:"tf",code:`from transformers import TensorFlowBenchmark, TensorFlowBenchmarkArguments, BertConfig
...
out in the third section under `),ce=l("em"),Rn=n("ENVIRONMENT INFORMATION"),xn=n(". This information can optionally be saved in a "),pe=l("em"),Ln=n(".csv"),zn=n(` file
...
useful for the community.`),Ze=h(),G=l("h2"),Z=l("a"),Fe=l("span"),S(ds.$$.fragment),Dr=h(),Me=l("span"),qr=n("Sharing your benchmark"),sa=h(),ss=l("p"),Rr=n("Previously all available core models (10 at the time) have been benchmarked for "),Ie=l("em"),xr=n("inference time"),Lr=n(`, across many different
...
commands from root will print out a descriptive list of all configurable parameters for PyTorch and Tensorflow
respectively.`),d.forEach(a),Ue=m(e),D(ms.$$.fragment,e),Ve=m(e),Q=t(e,"P",{});var oa=o(Q);vn=r(oa,"An instantiated benchmark object can then simply be run by calling "),ee=t(oa,"CODE",{});var Dl=o(ee);wn=r(Dl,"benchmark.run()"),Dl.forEach(a),Tn=r(oa,"."),oa.forEach(a),He=m(e),D(is.$$.fragment,e),Xe=m(e),u=t(e,"P",{});var f=o(u);Bn=r(f,"By default, the "),ae=t(f,"EM",{});var ql=o(ae);$n=r(ql,"time"),ql.forEach(a),An=r(f," and the "),ne=t(f,"EM",{});var Rl=o(ne);Pn=r(Rl,"required memory"),Rl.forEach(a),Cn=r(f," for "),re=t(f,"EM",{});var xl=o(re);Nn=r(xl,"inference"),xl.forEach(a),Fn=r(f,` are benchmarked. In the example output above the first
...
out in the third section under `),ce=t(f,"EM",{});var Vl=o(ce);Rn=r(Vl,"ENVIRONMENT INFORMATION"),Vl.forEach(a),xn=r(f,". This information can optionally be saved in a "),pe=t(f,"EM",{});var Hl=o(pe);Ln=r(Hl,".csv"),Hl.forEach(a),zn=r(f,` file
...
heavily between different GPU devices, library versions, etc., so that benchmark results on their own are not very
useful for the community.`),dt.forEach(a),Ts.forEach(a),Ze=m(e),G=t(e,"H2",{class:!0});var pa=o(G);Z=t(pa,"A",{id:!0,class:!0,href:!0});var ft=o(Z);Fe=t(ft,"SPAN",{});var jt=o(Fe);D(ds.$$.fragment,jt),jt.forEach(a),ft.forEach(a),Dr=m(pa),Me=t(pa,"SPAN",{});var gt=o(Me);qr=r(gt,"Sharing your benchmark"),gt.forEach(a),pa.forEach(a),sa=m(e),ss=t(e,"P",{});var ha=o(ss);Rr=r(ha,"Previously all available core models (10 at the time) have been benchmarked for "),Ie=t(ha,"EM",{});var _t=o(Ie);xr=r(_t,"inference time"),_t.forEach(a),Lr=r(ha,`, across many different
settings: using PyTorch, with and without TorchScript, using TensorFlow, with and without XLA. All of those tests were
