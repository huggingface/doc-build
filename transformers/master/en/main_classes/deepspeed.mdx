...
1. Integration of the core DeepSpeed features via [Trainer](/docs/transformers/master/en/main_classes/trainer#transformers.Trainer). This is everything done for your type
