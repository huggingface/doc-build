...
<div class="docstring">
<docstring><name>dict\_torch\_dtype\_to\_str</name><anchor>transformers.PretrainedConfig.dict_torch_dtype_to_str</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L855</source><parameters>[{"name": "d", "val": ": typing.Dict[str, typing.Any]"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>from\_dict</name><anchor>transformers.PretrainedConfig.from_dict</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L657</source><parameters>[{"name": "config_dict", "val": ": typing.Dict[str, typing.Any]"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config_dict** (`Dict[str, Any]`) --
...
<div class="docstring">
<docstring><name>to\_json\_string</name><anchor>transformers.PretrainedConfig.to_json_string</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L775</source><parameters>[{"name": "use_diff", "val": ": bool = True"}]</parameters><paramsdesc>- **use_diff** (`bool`, *optional*, defaults to `True`) --
  If set to `True`, only the difference between the config instance and the default `PretrainedConfig()`
