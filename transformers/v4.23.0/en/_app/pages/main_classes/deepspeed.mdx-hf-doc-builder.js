...
`),Rp=o("a"),J4=a("zero-inference"),X4=a("."),Oj=u(),Ip=o("p"),Q4=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
...
`),lo=o("a"),f6=a("advanced install"),d6=a("."),Mj=u(),qt=o("p"),m6=a("If you\u2019re still struggling with the build, first make sure to read "),Lp=o("a"),_6=a("CUDA Extension Installation Notes"),v6=a("."),Lj=u(),Zp=o("p"),j6=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
...
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(C0,"A",{href:!0});var FU=r(Rp);J4=n(FU,"zero-inference"),FU.forEach(t),X4=n(C0,"."),C0.forEach(t),WU.forEach(t),Oj=c(e),Ip=l(e,"P",{});var VU=r(Ip);Q4=n(VU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
