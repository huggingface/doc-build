import{S as cr,i as fr,s as pr,e as s,k as m,w as b,t as l,M as gr,c as r,d as o,m as u,a as n,x as $,h as i,b as c,G as e,g as _,y,q as N,o as T,B as R,v as hr,L as Jt}from"../../chunks/vendor-hf-doc-builder.js";import{T as xo}from"../../chunks/Tip-hf-doc-builder.js";import{D as X}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ze}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Kt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function mr(x){let d,w,h,p,v;return p=new Qt({props:{code:`from transformers import RegNetConfig, RegNetModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),w=l("Example:"),h=m(),b(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Example:"),f.forEach(o),h=u(a),$(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,w),_(a,h,f),y(p,a,f),v=!0},p:Jt,i(a){v||(N(p.$$.fragment,a),v=!0)},o(a){T(p.$$.fragment,a),v=!1},d(a){a&&o(d),a&&o(h),R(p,a)}}}function ur(x){let d,w,h,p,v;return{c(){d=s("p"),w=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),p=l("Module"),v=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(f,"CODE",{});var F=n(h);p=i(F,"Module"),F.forEach(o),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){_(a,d,f),e(d,w),e(d,h),e(h,p),e(d,v)},d(a){a&&o(d)}}}function _r(x){let d,w,h,p,v;return p=new Qt({props:{code:`from transformers import AutoFeatureExtractor, RegNetModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">1088</span>, <span class="hljs-number">7</span>, <span class="hljs-number">7</span>]`}}),{c(){d=s("p"),w=l("Example:"),h=m(),b(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Example:"),f.forEach(o),h=u(a),$(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,w),_(a,h,f),y(p,a,f),v=!0},p:Jt,i(a){v||(N(p.$$.fragment,a),v=!0)},o(a){T(p.$$.fragment,a),v=!1},d(a){a&&o(d),a&&o(h),R(p,a)}}}function vr(x){let d,w,h,p,v;return{c(){d=s("p"),w=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),p=l("Module"),v=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(f,"CODE",{});var F=n(h);p=i(F,"Module"),F.forEach(o),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){_(a,d,f),e(d,w),e(d,h),e(h,p),e(d,v)},d(a){a&&o(d)}}}function wr(x){let d,w,h,p,v;return p=new Qt({props:{code:`from transformers import AutoFeatureExtractor, RegNetForImageClassification
import torch
from datasets import load_dataset
...
tabby, tabby cat`}}),{c(){d=s("p"),w=l("Example:"),h=m(),b(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Example:"),f.forEach(o),h=u(a),$(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,w),_(a,h,f),y(p,a,f),v=!0},p:Jt,i(a){v||(N(p.$$.fragment,a),v=!0)},o(a){T(p.$$.fragment,a),v=!1},d(a){a&&o(d),a&&o(h),R(p,a)}}}function br(x){let d,w,h,p,v;return{c(){d=s("p"),w=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),p=l("Module"),v=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(f,"CODE",{});var F=n(h);p=i(F,"Module"),F.forEach(o),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){_(a,d,f),e(d,w),e(d,h),e(h,p),e(d,v)},d(a){a&&o(d)}}}function $r(x){let d,w,h,p,v;return p=new Qt({props:{code:`from transformers import AutoFeatureExtractor, TFRegNetModel
from datasets import load_dataset
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(last_hidden_states.shape)
[<span class="hljs-number">1</span>, <span class="hljs-number">1088</span>, <span class="hljs-number">7</span>, <span class="hljs-number">7</span>]`}}),{c(){d=s("p"),w=l("Example:"),h=m(),b(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Example:"),f.forEach(o),h=u(a),$(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,w),_(a,h,f),y(p,a,f),v=!0},p:Jt,i(a){v||(N(p.$$.fragment,a),v=!0)},o(a){T(p.$$.fragment,a),v=!1},d(a){a&&o(d),a&&o(h),R(p,a)}}}function yr(x){let d,w,h,p,v;return{c(){d=s("p"),w=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),p=l("Module"),v=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(f,"CODE",{});var F=n(h);p=i(F,"Module"),F.forEach(o),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){_(a,d,f),e(d,w),e(d,h),e(h,p),e(d,v)},d(a){a&&o(d)}}}function Nr(x){let d,w,h,p,v;return p=new Qt({props:{code:`from transformers import AutoFeatureExtractor, TFRegNetForImageClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(model.config.id2label[predicted_label])
tabby, tabby cat`}}),{c(){d=s("p"),w=l("Example:"),h=m(),b(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);w=i(f,"Example:"),f.forEach(o),h=u(a),$(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,w),_(a,h,f),y(p,a,f),v=!0},p:Jt,i(a){v||(N(p.$$.fragment,a),v=!0)},o(a){T(p.$$.fragment,a),v=!1},d(a){a&&o(d),a&&o(h),R(p,a)}}}function Tr(x){let d,w,h,p,v,a,f,F,Fo,Xt,D,Y,$t,ye,Eo,yt,ko,Yt,Z,jo,Ne,Co,Ao,Zt,et,Mo,eo,tt,Io,to,ot,Nt,Po,oo,at,qo,ao,ee,Te,zo,st,Oo,Do,So,te,Lo,Re,Wo,Uo,xe,Ho,so,E,Vo,Fe,Bo,Go,Ee,Ko,Jo,ke,Qo,Xo,je,Yo,Zo,ro,S,oe,Tt,Ce,ea,Rt,ta,no,k,Ae,oa,L,aa,rt,sa,ra,Me,na,la,ia,W,da,nt,ca,fa,lt,pa,ga,ha,ae,lo,U,se,xt,Ie,ma,Ft,ua,io,P,Pe,_a,qe,va,ze,wa,ba,$a,C,Oe,ya,H,Na,it,Ta,Ra,Et,xa,Fa,Ea,re,ka,ne,co,V,le,kt,De,ja,jt,Ca,fo,j,Se,Aa,Ct,Ma,Ia,Le,Pa,We,qa,za,Oa,A,Ue,Da,B,Sa,dt,La,Wa,At,Ua,Ha,Va,ie,Ba,de,po,G,ce,Mt,He,Ga,It,Ka,go,q,Ve,Ja,Pt,Qa,Xa,M,Be,Ya,K,Za,ct,es,ts,qt,os,as,ss,fe,rs,pe,ho,J,ge,zt,Ge,ns,Ot,ls,mo,z,Ke,is,Dt,ds,cs,I,Je,fs,Q,ps,ft,gs,hs,St,ms,us,_s,he,vs,me,uo;return a=new Ze({}),ye=new Ze({}),Ce=new Ze({}),Ae=new X({props:{name:"class transformers.RegNetConfig",anchor:"transformers.RegNetConfig",parameters:[{name:"num_channels",val:" = 3"},{name:"embedding_size",val:" = 32"},{name:"hidden_sizes",val:" = [128, 192, 512, 1088]"},{name:"depths",val:" = [2, 6, 12, 2]"},{name:"groups_width",val:" = 64"},{name:"layer_type",val:" = 'y'"},{name:"hidden_act",val:" = 'relu'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RegNetConfig.num_channels",description:`<strong>num_channels</strong> (<code>int</code>, <em>optional</em>, defaults to 3) &#x2014;
...
If <code>True</code>, the first stage will downsample the inputs using a <code>stride</code> of 2.`,name:"downsample_in_first_stage"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/regnet/configuration_regnet.py#L28"}}),ae=new Kt({props:{anchor:"transformers.RegNetConfig.example",$$slots:{default:[mr]},$$scope:{ctx:x}}}),Ie=new Ze({}),Pe=new X({props:{name:"class transformers.RegNetModel",anchor:"transformers.RegNetModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.RegNetModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.0/en/model_doc/regnet#transformers.RegNetConfig">RegNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/regnet/modeling_regnet.py#L332"}}),Oe=new X({props:{name:"forward",anchor:"transformers.RegNetModel.forward",parameters:[{name:"pixel_values",val:": Tensor"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RegNetModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/regnet#transformers.RegNetConfig"
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/regnet/modeling_regnet.py#L400",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.modeling_outputs.ImageClassifierOutputWithNoAttention"
...
behavior. &#x2014;
config (<a href="/docs/transformers/v4.23.0/en/model_doc/regnet#transformers.RegNetConfig">RegNetConfig</a>): Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"regular"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/regnet/modeling_tf_regnet.py#L406"}}),Be=new X({props:{name:"call",anchor:"transformers.TFRegNetModel.call",parameters:[{name:"pixel_values",val:": Tensor"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFRegNetModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/regnet/modeling_tf_regnet.py#L411",returnDescription:`
...
config (<a href="/docs/transformers/v4.23.0/en/model_doc/regnet#transformers.RegNetConfig">RegNetConfig</a>): Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"regular"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/regnet/modeling_tf_regnet.py#L466"}}),Je=new X({props:{name:"call",anchor:"transformers.TFRegNetForImageClassification.call",parameters:[{name:"pixel_values",val:": Tensor = None"},{name:"labels",val:": Tensor = None"},{name:"output_hidden_states",val:": bool = None"},{name:"return_dict",val:": bool = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFRegNetForImageClassification.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/regnet/modeling_tf_regnet.py#L477",returnDescription:`
<p>A <a
...
documentation from `),lt=s("a"),pa=l("PretrainedConfig"),ga=l(" for more information."),ha=m(),b(ae.$$.fragment),lo=m(),U=s("h2"),se=s("a"),xt=s("span"),b(Ie.$$.fragment),ma=m(),Ft=s("span"),ua=l("RegNetModel"),io=m(),P=s("div"),b(Pe.$$.fragment),_a=m(),qe=s("p"),va=l(`The bare RegNet model outputting raw features without any specific head on top.
This model is a PyTorch `),ze=s("a"),wa=l("torch.nn.Module"),ba=l(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$a=m(),C=s("div"),b(Oe.$$.fragment),ya=m(),H=s("p"),Na=l("The "),it=s("a"),Ta=l("RegNetModel"),Ra=l(" forward method, overrides the "),Et=s("code"),xa=l("__call__"),Fa=l(" special method."),Ea=m(),b(re.$$.fragment),ka=m(),b(ne.$$.fragment),co=m(),V=s("h2"),le=s("a"),kt=s("span"),b(De.$$.fragment),ja=m(),jt=s("span"),Ca=l("RegNetForImageClassification"),fo=m(),j=s("div"),b(Se.$$.fragment),Aa=m(),Ct=s("p"),Ma=l(`RegNet Model with an image classification head on top (a linear layer on top of the pooled features), e.g. for
ImageNet.`),Ia=m(),Le=s("p"),Pa=l("This model is a PyTorch "),We=s("a"),qa=l("torch.nn.Module"),za=l(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Oa=m(),A=s("div"),b(Ue.$$.fragment),Da=m(),B=s("p"),Sa=l("The "),dt=s("a"),La=l("RegNetForImageClassification"),Wa=l(" forward method, overrides the "),At=s("code"),Ua=l("__call__"),Ha=l(" special method."),Va=m(),b(ie.$$.fragment),Ba=m(),b(de.$$.fragment),po=m(),G=s("h2"),ce=s("a"),Mt=s("span"),b(He.$$.fragment),Ga=m(),It=s("span"),Ka=l("TFRegNetModel"),go=m(),q=s("div"),b(Ve.$$.fragment),Ja=m(),Pt=s("p"),Qa=l("The bare RegNet model outputting raw features without any specific head on top."),Xa=m(),M=s("div"),b(Be.$$.fragment),Ya=m(),K=s("p"),Za=l("The "),ct=s("a"),es=l("TFRegNetModel"),ts=l(" forward method, overrides the "),qt=s("code"),os=l("__call__"),as=l(" special method."),ss=m(),b(fe.$$.fragment),rs=m(),b(pe.$$.fragment),ho=m(),J=s("h2"),ge=s("a"),zt=s("span"),b(Ge.$$.fragment),ns=m(),Ot=s("span"),ls=l("TFRegNetForImageClassification"),mo=m(),z=s("div"),b(Ke.$$.fragment),is=m(),Dt=s("p"),ds=l(`RegNet Model with an image classification head on top (a linear layer on top of the pooled features), e.g. for
ImageNet.`),cs=m(),I=s("div"),b(Je.$$.fragment),fs=m(),Q=s("p"),ps=l("The "),ft=s("a"),gs=l("TFRegNetForImageClassification"),hs=l(" forward method, overrides the "),St=s("code"),ms=l("__call__"),us=l(" special method."),_s=m(),b(he.$$.fragment),vs=m(),b(me.$$.fragment),this.h()},l(t){const g=gr('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(o),w=u(t),h=r(t,"H1",{class:!0});var Qe=n(h);p=r(Qe,"A",{id:!0,class:!0,href:!0});var Lt=n(p);v=r(Lt,"SPAN",{});var Wt=n(v);$(a.$$.fragment,Wt),Wt.forEach(o),Lt.forEach(o),f=u(Qe),F=r(Qe,"SPAN",{});var Ut=n(F);Fo=i(Ut,"RegNet"),Ut.forEach(o),Qe.forEach(o),Xt=u(t),D=r(t,"H2",{class:!0});var Xe=n(D);Y=r(Xe,"A",{id:!0,class:!0,href:!0});var Ht=n(Y);$t=r(Ht,"SPAN",{});var Vt=n($t);$(ye.$$.fragment,Vt),Vt.forEach(o),Ht.forEach(o),Eo=u(Xe),yt=r(Xe,"SPAN",{});var Bt=n(yt);ko=i(Bt,"Overview"),Bt.forEach(o),Xe.forEach(o),Yt=u(t),Z=r(t,"P",{});var Ye=n(Z);jo=i(Ye,"The RegNet model was proposed in "),Ne=r(Ye,"A",{href:!0,rel:!0});var ws=n(Ne);Co=i(ws,"Designing Network Design Spaces"),ws.forEach(o),Ao=i(Ye," by Ilija Radosavovic, Raj Prateek Kosaraju, Ross Girshick, Kaiming He, Piotr Doll\xE1r."),Ye.forEach(o),Zt=u(t),et=r(t,"P",{});var bs=n(et);Mo=i(bs,"The authors design search spaces to perform Neural Architecture Search (NAS). They first start from a high dimensional search space and iteratively reduce the search space by empirically applying constraints based on the best-performing models sampled by the current search space."),bs.forEach(o),eo=u(t),tt=r(t,"P",{});var $s=n(tt);Io=i($s,"The abstract from the paper is the following:"),$s.forEach(o),to=u(t),ot=r(t,"P",{});var ys=n(ot);Nt=r(ys,"EM",{});var Ns=n(Nt);Po=i(Ns,"In this work, we present a new network design paradigm. Our goal is to help advance the understanding of network design and discover design principles that generalize across settings. Instead of focusing on designing individual network instances, we design network design spaces that parametrize populations of networks. The overall process is analogous to classic manual design of networks, but elevated to the design space level. Using our methodology we explore the structure aspect of network design and arrive at a low-dimensional design space consisting of simple, regular networks that we call RegNet. The core insight of the RegNet parametrization is surprisingly simple: widths and depths of good networks can be explained by a quantized linear function. We analyze the RegNet design space and arrive at interesting findings that do not match the current practice of network design. The RegNet design space provides simple and fast networks that work well across a wide range of flop regimes. Under comparable training settings and flops, the RegNet models outperform the popular EfficientNet models while being up to 5x faster on GPUs."),Ns.forEach(o),ys.forEach(o),oo=u(t),at=r(t,"P",{});var Ts=n(at);qo=i(Ts,"Tips:"),Ts.forEach(o),ao=u(t),ee=r(t,"UL",{});var _o=n(ee);Te=r(_o,"LI",{});var vo=n(Te);zo=i(vo,"One can use "),st=r(vo,"A",{href:!0});var Rs=n(st);Oo=i(Rs,"AutoFeatureExtractor"),Rs.forEach(o),Do=i(vo," to prepare images for the model."),vo.forEach(o),So=u(_o),te=r(_o,"LI",{});var Gt=n(te);Lo=i(Gt,"The huge 10B model from "),Re=r(Gt,"A",{href:!0,rel:!0});var xs=n(Re);Wo=i(xs,"Self-supervised Pretraining of Visual Features in the Wild"),xs.forEach(o),Uo=i(Gt,", trained on one billion Instagram images, is available on the "),xe=r(Gt,"A",{href:!0,rel:!0});var Fs=n(xe);Ho=i(Fs,"hub"),Fs.forEach(o),Gt.forEach(o),_o.forEach(o),so=u(t),E=r(t,"P",{});var O=n(E);Vo=i(O,"This model was contributed by "),Fe=r(O,"A",{href:!0,rel:!0});var Es=n(Fe);Bo=i(Es,"Francesco"),Es.forEach(o),Go=i(O,`. The TensorFlow version of the model
...
The original code can be found `),je=r(O,"A",{href:!0,rel:!0});var Cs=n(je);Yo=i(Cs,"here"),Cs.forEach(o),Zo=i(O,"."),O.forEach(o),ro=u(t),S=r(t,"H2",{class:!0});var wo=n(S);oe=r(wo,"A",{id:!0,class:!0,href:!0});var As=n(oe);Tt=r(As,"SPAN",{});var Ms=n(Tt);$(Ce.$$.fragment,Ms),Ms.forEach(o),As.forEach(o),ea=u(wo),Rt=r(wo,"SPAN",{});var Is=n(Rt);ta=i(Is,"RegNetConfig"),Is.forEach(o),wo.forEach(o),no=u(t),k=r(t,"DIV",{class:!0});var ue=n(k);$(Ae.$$.fragment,ue),oa=u(ue),L=r(ue,"P",{});var pt=n(L);aa=i(pt,"This is the configuration class to store the configuration of a "),rt=r(pt,"A",{href:!0});var Ps=n(rt);sa=i(Ps,"RegNetModel"),Ps.forEach(o),ra=i(pt,`. It is used to instantiate a RegNet
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the RegNet
