...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),T=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=o("a"),g=s("TapasTokenizer"),v=s(" to convert table-question pairs into "),p=o("code"),f=s("input_ids"),z=s(", "),k=o("code"),W=s("attention_mask"),O=s(", "),G=o("code"),ae=s("token_type_ids"),w=s(" and so on. Again, based on which of the three cases you picked above, "),J=o("a"),Z=s("TFTapasForQuestionAnswering"),de=s(` requires different
inputs to be fine-tuned:`),U=c(),N=o("table"),y=o("thead"),C=o("tr"),B=o("th"),ee=o("strong"),pe=s("Task"),R=c(),ge=o("th"),he=o("strong"),X=s("Required inputs"),_e=c(),D=o("tbody"),L=o("tr"),I=o("td"),M=s("Conversational"),K=c(),H=o("td"),we=o("code"),ze=s("input_ids"),ue=s(", "),fe=o("code"),Ae=s("attention_mask"),se=s(", "),ke=o("code"),Te=s("token_type_ids"),Pe=s(", "),Ce=o("code"),je=s("labels"),Me=c(),$e=o("tr"),ce=o("td"),Se=s("Weak supervision for aggregation"),ye=c(),Y=o("td"),qe=o("code"),V=s("input_ids"),We=s(", "),oe=o("code"),He=s("attention_mask"),Ue=s(", "),b=o("code"),S=s("token_type_ids"),Ve=s(", "),ve=o("code"),Ye=s("labels"),Je=s(", "),Q=o("code"),Le=s("numeric_values"),ot=s(", "),Qe=o("code"),Ie=s("numeric_values_scale"),Xe=s(", "),le=o("code"),Ee=s("float_answer"),Ze=c(),xe=o("tr"),ne=o("td"),et=s("Strong supervision for aggregation"),Be=c(),re=o("td"),Re=o("code"),Fe=s("input ids"),tt=s(", "),Pt=o("code"),Mt=s("attention mask"),Ws=s(", "),St=o("code"),vs=s("token type ids"),ts=s(", "),Dt=o("code"),bs=s("labels"),ut=s(", "),De=o("code"),Hs=s("aggregation_labels"),Ot=c(),ie=o("p"),vt=o("a"),ss=s("TapasTokenizer"),Us=s(" creates the "),Nt=o("code"),ns=s("labels"),Bs=s(", "),Lt=o("code"),Qt=s("numeric_values"),Rs=s(" and "),It=o("code"),rs=s("numeric_values_scale"),Gs=s(" based on the "),Wt=o("code"),is=s("answer_coordinates"),Ks=s(" and "),Ht=o("code"),Vs=s("answer_text"),st=s(" columns of the TSV file. The "),Ut=o("code"),ls=s("float_answer"),Ys=s(" and "),Bt=o("code"),ds=s("aggregation_labels"),Js=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ps=c(),j(lt.$$.fragment),cs=c(),Oe=o("p"),hs=s("Note that "),bt=o("a"),Xs=s("TapasTokenizer"),Rt=s(" expects the data of the table to be "),Gt=o("strong"),Zs=s("text-only"),ea=s(". You can use "),dt=o("code"),ta=s(".astype(str)"),us=s(` on a dataframe to turn it into text-only data.
...
inputs to be fine-tuned:`),te.forEach(t),U=h(x),N=n(x,"TABLE",{});var _t=r(N);y=n(_t,"THEAD",{});var aa=r(y);C=n(aa,"TR",{});var wt=r(C);B=n(wt,"TH",{});var qa=r(B);ee=n(qa,"STRONG",{});var oa=r(ee);pe=a(oa,"Task"),oa.forEach(t),qa.forEach(t),R=h(wt),ge=n(wt,"TH",{});var $a=r(ge);he=n($a,"STRONG",{});var ua=r(he);X=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),wt.forEach(t),aa.forEach(t),_e=h(_t),D=n(_t,"TBODY",{});var nt=r(D);L=n(nt,"TR",{});var fs=r(L);I=n(fs,"TD",{});var ws=r(I);M=a(ws,"Conversational"),ws.forEach(t),K=h(fs),H=n(fs,"TD",{});var pt=r(H);we=n(pt,"CODE",{});var Ea=r(we);ze=a(Ea,"input_ids"),Ea.forEach(t),ue=a(pt,", "),fe=n(pt,"CODE",{});var ma=r(fe);Ae=a(ma,"attention_mask"),ma.forEach(t),se=a(pt,", "),ke=n(pt,"CODE",{});var ys=r(ke);Te=a(ys,"token_type_ids"),ys.forEach(t),Pe=a(pt,", "),Ce=n(pt,"CODE",{});var na=r(Ce);je=a(na,"labels"),na.forEach(t),pt.forEach(t),fs.forEach(t),Me=h(nt),$e=n(nt,"TR",{});var gs=r($e);ce=n(gs,"TD",{});var fa=r(ce);Se=a(fa,"Weak supervision for aggregation"),fa.forEach(t),ye=h(gs),Y=n(gs,"TD",{});var be=r(Y);qe=n(be,"CODE",{});var Fa=r(qe);V=a(Fa,"input_ids"),Fa.forEach(t),We=a(be,", "),oe=n(be,"CODE",{});var ks=r(oe);He=a(ks,"attention_mask"),ks.forEach(t),Ue=a(be,", "),b=n(be,"CODE",{});var Aa=r(b);S=a(Aa,"token_type_ids"),Aa.forEach(t),Ve=a(be,", "),ve=n(be,"CODE",{});var za=r(ve);Ye=a(za,"labels"),za.forEach(t),Je=a(be,", "),Q=n(be,"CODE",{});var ga=r(Q);Le=a(ga,"numeric_values"),ga.forEach(t),ot=a(be,", "),Qe=n(be,"CODE",{});var At=r(Qe);Ie=a(At,"numeric_values_scale"),At.forEach(t),Xe=a(be,", "),le=n(be,"CODE",{});var ra=r(le);Ee=a(ra,"float_answer"),ra.forEach(t),be.forEach(t),gs.forEach(t),Ze=h(nt),xe=n(nt,"TR",{});var _s=r(xe);ne=n(_s,"TD",{});var xa=r(ne);et=a(xa,"Strong supervision for aggregation"),xa.forEach(t),Be=h(_s),re=n(_s,"TD",{});var Ne=r(re);Re=n(Ne,"CODE",{});var Ca=r(Re);Fe=a(Ca,"input ids"),Ca.forEach(t),tt=a(Ne,", "),Pt=n(Ne,"CODE",{});var ia=r(Pt);Mt=a(ia,"attention mask"),ia.forEach(t),Ws=a(Ne,", "),St=n(Ne,"CODE",{});var Pa=r(St);vs=a(Pa,"token type ids"),Pa.forEach(t),ts=a(Ne,", "),Dt=n(Ne,"CODE",{});var Ma=r(Dt);bs=a(Ma,"labels"),Ma.forEach(t),ut=a(Ne,", "),De=n(Ne,"CODE",{});var Sa=r(De);Hs=a(Sa,"aggregation_labels"),Sa.forEach(t),Ne.forEach(t),_s.forEach(t),nt.forEach(t),_t.forEach(t),Ot=h(x),ie=n(x,"P",{});var me=r(ie);vt=n(me,"A",{href:!0});var Da=r(vt);ss=a(Da,"TapasTokenizer"),Da.forEach(t),Us=a(me," creates the "),Nt=n(me,"CODE",{});var la=r(Nt);ns=a(la,"labels"),la.forEach(t),Bs=a(me,", "),Lt=n(me,"CODE",{});var Oa=r(Lt);Qt=a(Oa,"numeric_values"),Oa.forEach(t),Rs=a(me," and "),It=n(me,"CODE",{});var Na=r(It);rs=a(Na,"numeric_values_scale"),Na.forEach(t),Gs=a(me," based on the "),Wt=n(me,"CODE",{});var _a=r(Wt);is=a(_a,"answer_coordinates"),_a.forEach(t),Ks=a(me," and "),Ht=n(me,"CODE",{});var js=r(Ht);Vs=a(js,"answer_text"),js.forEach(t),st=a(me," columns of the TSV file. The "),Ut=n(me,"CODE",{});var La=r(Ut);ls=a(La,"float_answer"),La.forEach(t),Ys=a(me," and "),Bt=n(me,"CODE",{});var Ta=r(Bt);ds=a(Ta,"aggregation_labels"),Ta.forEach(t),Js=a(me," are already in the TSV file of step 2. Here\u2019s an example:"),me.forEach(t),ps=h(x),q(lt.$$.fragment,x),cs=h(x),Oe=n(x,"P",{});var Ge=r(Oe);hs=a(Ge,"Note that "),bt=n(Ge,"A",{href:!0});var da=r(bt);Xs=a(da,"TapasTokenizer"),da.forEach(t),Rt=a(Ge," expects the data of the table to be "),Gt=n(Ge,"STRONG",{});var Yt=r(Gt);Zs=a(Yt,"text-only"),Yt.forEach(t),ea=a(Ge,". You can use "),dt=n(Ge,"CODE",{});var pa=r(dt);ta=a(pa,".astype(str)"),pa.forEach(t),us=a(Ge,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ge.forEach(t),ms=h(x),q(gt.$$.fragment,x),this.h()},h(){m(d,"href","/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer"),m(J,"href","/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),m(vt,"href","/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer"),m(bt,"href","/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer")},m(x,te){u(x,l,te),e(l,T),e(l,d),e(d,g),e(l,v),e(l,p),e(p,f),e(l,z),e(l,k),e(k,W),e(l,O),e(l,G),e(G,ae),e(l,w),e(l,J),e(J,Z),e(l,de),u(x,U,te),u(x,N,te),e(N,y),e(y,C),e(C,B),e(B,ee),e(ee,pe),e(C,R),e(C,ge),e(ge,he),e(he,X),e(N,_e),e(N,D),e(D,L),e(L,I),e(I,M),e(L,K),e(L,H),e(H,we),e(we,ze),e(H,ue),e(H,fe),e(fe,Ae),e(H,se),e(H,ke),e(ke,Te),e(H,Pe),e(H,Ce),e(Ce,je),e(D,Me),e(D,$e),e($e,ce),e(ce,Se),e($e,ye),e($e,Y),e(Y,qe),e(qe,V),e(Y,We),e(Y,oe),e(oe,He),e(Y,Ue),e(Y,b),e(b,S),e(Y,Ve),e(Y,ve),e(ve,Ye),e(Y,Je),e(Y,Q),e(Q,Le),e(Y,ot),e(Y,Qe),e(Qe,Ie),e(Y,Xe),e(Y,le),e(le,Ee),e(D,Ze),e(D,xe),e(xe,ne),e(ne,et),e(xe,Be),e(xe,re),e(re,Re),e(Re,Fe),e(re,tt),e(re,Pt),e(Pt,Mt),e(re,Ws),e(re,St),e(St,vs),e(re,ts),e(re,Dt),e(Dt,bs),e(re,ut),e(re,De),e(De,Hs),u(x,Ot,te),u(x,ie,te),e(ie,vt),e(vt,ss),e(ie,Us),e(ie,Nt),e(Nt,ns),e(ie,Bs),e(ie,Lt),e(Lt,Qt),e(ie,Rs),e(ie,It),e(It,rs),e(ie,Gs),e(ie,Wt),e(Wt,is),e(ie,Ks),e(ie,Ht),e(Ht,Vs),e(ie,st),e(ie,Ut),e(Ut,ls),e(ie,Ys),e(ie,Bt),e(Bt,ds),e(ie,Js),u(x,ps,te),$(lt,x,te),u(x,cs,te),u(x,Oe,te),e(Oe,hs),e(Oe,bt),e(bt,Xs),e(Oe,Rt),e(Oe,Gt),e(Gt,Zs),e(Oe,ea),e(Oe,dt),e(dt,ta),e(Oe,us),u(x,ms,te),$(gt,x,te),Kt=!0},p:Ft,i(x){Kt||(E(lt.$$.fragment,x),E(gt.$$.fragment,x),Kt=!0)},o(x){F(lt.$$.fragment,x),F(gt.$$.fragment,x),Kt=!1},d(x){x&&t(l),x&&t(U),x&&t(N),x&&t(Ot),x&&t(ie),x&&t(ps),A(lt,x),x&&t(cs),x&&t(Oe),x&&t(ms),A(gt,x)}}}function $y(P){let l,T;return l=new Tn({props:{$$slots:{default:[qy]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function Ey(P){let l,T,d,g,v,p,f,z;return f=new ht({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering, AdamW
...
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var z=r(d);g=a(z,"Module"),z.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
positional argument:`),L=c(),I=o("ul"),M=o("li"),K=s("a single Tensor with "),H=o("code"),we=s("input_ids"),ze=s(" only and nothing else: "),ue=o("code"),fe=s("model(input_ids)"),Ae=c(),se=o("li"),ke=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(b){l=n(b,"P",{});var S=r(l);T=a(S,"TensorFlow models and layers in "),d=n(S,"CODE",{});var Ve=r(d);g=a(Ve,"transformers"),Ve.forEach(t),v=a(S," accept two formats as input:"),S.forEach(t),p=h(b),f=n(b,"UL",{});var ve=r(f);z=n(ve,"LI",{});var Ye=r(z);k=a(Ye,"having all inputs as keyword arguments (like PyTorch models), or"),Ye.forEach(t),W=h(ve),O=n(ve,"LI",{});var Je=r(O);G=a(Je,"having all inputs as a list, tuple or dict in the first positional argument."),Je.forEach(t),ve.forEach(t),ae=h(b),w=n(b,"P",{});var Q=r(w);J=a(Q,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),Fe.forEach(t),this.h()},h(){m(oe,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(oe,"rel","nofollow")},m(b,S){u(b,l,S),e(l,T),e(l,d),e(d,g),e(l,v),u(b,p,S),u(b,f,S),e(f,z),e(z,k),e(f,W),e(f,O),e(O,G),u(b,ae,S),u(b,w,S),e(w,J),e(w,Z),e(Z,de),e(w,U),e(w,N),e(N,y),e(w,C),e(w,B),e(B,ee),e(w,pe),e(w,R),e(R,ge),e(w,he),e(w,X),e(X,_e),e(w,D),u(b,L,S),u(b,I,S),e(I,M),e(M,K),e(M,H),e(H,we),e(M,ze),e(M,ue),e(ue,fe),e(I,Ae),e(I,se),e(se,ke),e(se,Te),e(Te,Pe),e(se,Ce),e(se,je),e(je,Me),e(I,$e),e(I,ce),e(ce,Se),e(ce,ye),e(ye,Y),u(b,qe,S),u(b,V,S),e(V,We),e(V,oe),e(oe,He),e(V,Ue)},d(b){b&&t(l),b&&t(p),b&&t(f),b&&t(ae),b&&t(w),b&&t(L),b&&t(I),b&&t(qe),b&&t(V)}}}function By(P){let l,T,d,g,v;return{c(){l=o("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var z=r(d);g=a(z,"Module"),z.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
this threshold will be selected.`,name:"cell_classification_threshold"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/tokenization_tapas.py#L1939",returnDescription:`
<ul>
...
`}}),Un=new it({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/tokenization_tapas.py#L444"}}),Bn=new es({}),Rn=new it({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tapas.py#L853"}}),Zn=new it({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tapas.py#L1006"}}),or=new it({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tapas.py#L1025",returnDescription:`
<p>A <a
...
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tapas.py#L1478",returnDescription:`
<p>A <a
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tapas.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tf_tapas.py#L985",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tf_tapas.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy). Note: this is called
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tf_tapas.py#L1607",returnDescription:`
<p>A <a
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/tapas/modeling_tf_tapas.py#L1282",returnDescription:`
...
behavior.`),t_=c(),j(Bo.$$.fragment),s_=c(),As=o("div"),j(yr.$$.fragment),a_=c(),lo=o("p"),o_=s("The "),ki=o("a"),n_=s("TFTapasModel"),r_=s(" forward method, overrides the "),Ed=o("code"),i_=s("__call__"),l_=s(" special method."),d_=c(),j(Ro.$$.fragment),p_=c(),j(Go.$$.fragment),Sp=c(),po=o("h2"),Ko=o("a"),Fd=o("span"),j(kr.$$.fragment),c_=c(),Ad=o("span"),h_=s("TFTapasForMaskedLM"),Dp=c(),qt=o("div"),j(jr.$$.fragment),u_=c(),qr=o("p"),m_=s("Tapas Model with a "),zd=o("code"),f_=s("language modeling"),g_=s(" head on top."),__=c(),$r=o("p"),T_=s("This model inherits from "),ji=o("a"),v_=s("TFPreTrainedModel"),b_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
tokens, special tokens and padding.`),Hb.forEach(t),zm=h(os),sd=n(os,"LI",{});var Ub=r(sd);xm=a(Ub,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
...
SQA, WTQ or WikiSQL-supervised tasks.`),Gi.forEach(t),$g=h(ya),ur=n(ya,"P",{});var vc=r(ur);Eg=a(vc,"This model inherits from "),bi=n(vc,"A",{href:!0});var zw=r(bi);Fg=a(zw,"PreTrainedModel"),zw.forEach(t),Ag=a(vc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vc.forEach(t),zg=h(ya),mr=n(ya,"P",{});var bc=r(mr);xg=a(bc,"This model is also a PyTorch "),fr=n(bc,"A",{href:!0,rel:!0});var xw=r(fr);Cg=a(xw,"torch.nn.Module"),xw.forEach(t),Pg=a(bc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ec.forEach(t),q_=h(Ns),q(Vo.$$.fragment,Ns),$_=h(Ns),zs=n(Ns,"DIV",{class:!0});var fn=r(zs);q(Ar.$$.fragment,fn),E_=h(fn),co=n(fn,"P",{});var Yi=r(co);F_=a(Yi,"The "),qi=n(Yi,"A",{href:!0});var Kw=r(qi);A_=a(Kw,"TFTapasForMaskedLM"),Kw.forEach(t),z_=a(Yi," forward method, overrides the "),xd=n(Yi,"CODE",{});var Vw=r(xd);x_=a(Vw,"__call__"),Vw.forEach(t),C_=a(Yi," special method."),Yi.forEach(t),P_=h(fn),q(Yo.$$.fragment,fn),M_=h(fn),q(Jo.$$.fragment,fn),fn.forEach(t),Ns.forEach(t),Op=h(i),ho=n(i,"H2",{class:!0});var Fc=r(ho);Xo=n(Fc,"A",{id:!0,class:!0,href:!0});var Yw=r(Xo);Cd=n(Yw,"SPAN",{});var Jw=r(Cd);q(zr.$$.fragment,Jw),Jw.forEach(t),Yw.forEach(t),S_=h(Fc),Pd=n(Fc,"SPAN",{});var Xw=r(Pd);D_=a(Xw,"TFTapasForSequenceClassification"),Xw.forEach(t),Fc.forEach(t),Np=h(i),$t=n(i,"DIV",{class:!0});var Ls=r($t);q(xr.$$.fragment,Ls),O_=h(Ls),Md=n(Ls,"P",{});var Zw=r(Md);N_=a(Zw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
