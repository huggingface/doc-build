import{S as K_,i as R_,s as H_,e as n,k as l,w as b,t as r,M as V_,c as s,d as t,m as c,a,x as y,h as i,b as u,G as e,g as f,y as T,q as w,o as P,B as $,v as Q_,L as ht}from"../../chunks/vendor-hf-doc-builder.js";import{T as dn}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ve}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Y}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as pt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function J_(z){let p,v,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusModel, PegasusConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,v),e(p,_),e(_,m),e(p,k)},d(d){d&&t(p)}}}function Z_(z){let p,v,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, PegasusModel
...
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,v),e(p,_),e(_,m),e(p,k)},d(d){d&&t(p)}}}function ek(z){let p,v,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, PegasusForConditionalGeneration
...
format outside of Keras methods like `),K=s(M,"CODE",{});var mt=a(K);Xe=i(mt,"fit()"),mt.forEach(t),ze=i(M," and "),le=s(M,"CODE",{});var W=a(le);Ne=i(W,"predict()"),W.forEach(t),te=i(M,`, such as when creating your own layers or models with
...
about any of this, as you can just pass inputs like you would to any other Python function!`),je.forEach(t),this.h()},h(){u(R,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(R,"rel","nofollow")},m(x,F){f(x,p,F),e(p,v),e(p,_),e(_,m),e(p,k),f(x,d,F),f(x,h,F),e(h,E),e(E,Qe),e(h,Ge),e(h,L),e(L,Pe),f(x,$e,F),f(x,q,F),e(q,ie),e(q,de),e(de,Je),e(q,Le),e(q,N),e(N,ee),e(q,xe),e(q,K),e(K,Xe),e(q,ze),e(q,le),e(le,Ne),e(q,te),e(q,ce),e(ce,ue),e(q,Ze),f(x,Fe,F),f(x,S,F),e(S,A),e(A,Ye),e(A,oe),e(oe,ne),e(A,qe),e(A,pe),e(pe,et),e(S,Ee),e(S,D),e(D,De),e(D,G),e(G,tt),e(D,he),e(D,me),e(me,ot),e(S,fe),e(S,Q),e(Q,nt),e(Q,se),e(se,J),f(x,V,F),f(x,I,F),e(I,ge),e(I,R),e(R,Me),e(I,st)},d(x){x&&t(p),x&&t(d),x&&t(h),x&&t($e),x&&t(q),x&&t(Fe),x&&t(S),x&&t(V),x&&t(I)}}}function nk(z){let p,v,_,m,k;return{c(){p=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,v),e(p,_),e(_,m),e(p,k)},d(d){d&&t(p)}}}function sk(z){let p,v,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, TFPegasusModel
...
`),se=s(dt,"CODE",{});var Ce=a(se);J=i(Ce,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ce.forEach(t),dt.forEach(t),Z.forEach(t),V=c(x),I=s(x,"P",{});var je=a(I);ge=i(je,`Note that when creating models and layers with
`),R=s(je,"A",{href:!0,rel:!0});var Se=a(R);Me=i(Se,"subclassing"),Se.forEach(t),st=i(je,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),je.forEach(t),this.h()},h(){u(R,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(R,"rel","nofollow")},m(x,F){f(x,p,F),e(p,v),e(p,_),e(_,m),e(p,k),f(x,d,F),f(x,h,F),e(h,E),e(E,Qe),e(h,Ge),e(h,L),e(L,Pe),f(x,$e,F),f(x,q,F),e(q,ie),e(q,de),e(de,Je),e(q,Le),e(q,N),e(N,ee),e(q,xe),e(q,K),e(K,Xe),e(q,ze),e(q,le),e(le,Ne),e(q,te),e(q,ce),e(ce,ue),e(q,Ze),f(x,Fe,F),f(x,S,F),e(S,A),e(A,Ye),e(A,oe),e(oe,ne),e(A,qe),e(A,pe),e(pe,et),e(S,Ee),e(S,D),e(D,De),e(D,G),e(G,tt),e(D,he),e(D,me),e(me,ot),e(S,fe),e(S,Q),e(Q,nt),e(Q,se),e(se,J),f(x,V,F),f(x,I,F),e(I,ge),e(I,R),e(R,Me),e(I,st)},d(x){x&&t(p),x&&t(d),x&&t(h),x&&t($e),x&&t(q),x&&t(Fe),x&&t(S),x&&t(V),x&&t(I)}}}function rk(z){let p,v,_,m,k;return{c(){p=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,v),e(p,_),e(_,m),e(p,k)},d(d){d&&t(p)}}}function ik(z){let p,v,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, TFPegasusForConditionalGeneration
...
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,v),e(p,_),e(_,m),e(p,k)},d(d){d&&t(p)}}}function lk(z){let p,v,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,v),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function ck(z){let p,v,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),v=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,v),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function uk(z){let p,v,_,m,k;return m=new Ve({props:{code:`import jax.numpy as jnp
...
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,p,h),e(p,v),e(p,_),e(_,m),e(p,k)},d(d){d&&t(p)}}}function hk(z){let p,v,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;np&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),v=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,v),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function mk(z){let p,v,_,m,k;return m=new Ve({props:{code:`import jax.numpy as jnp
from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),v=r("Example:"),_=l(),b(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);v=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,v),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function fk(z){let p,v,_,m,k,d,h,E,Qe,Ge,L,Pe,$e,q,ie,de,Je,Le,N,ee,xe,K,Xe,ze,le,Ne,te,ce,ue,Ze,Fe,S,A,Ye,oe,ne,qe,pe,et,Ee,D,De,G,tt,he,me,ot,fe,Q,nt,se,J,V,I,ge,R,Me,st,x,F,Tt,X,wt,Pt,M,$t,xt,mt,W,at,Z,_e,rt,zt,ke,it,Ft,dt,Ce,je,Se,ll,cl,ul,to,ln,pl,hl,cn,ml,fl,Li,qt,oo,$a,un,gl,xa,_l,Ni,ft,no,pn,kl,vl,hn,bl,yl,Tl,za,wl,Pl,Fa,$l,Di,Et,so,qa,mn,xl,Ea,zl,Ui,Te,Ma,Ca,Fl,ql,ja,Rs,El,Hs,Ml,Cl,fn,Sa,jl,Sl,Mt,Oa,Ol,Al,Aa,Il,Gl,gn,Ll,Ia,Nl,Dl,Ul,Ga,lt,Bl,La,Wl,Kl,Na,Rl,Hl,Da,Vl,Ql,Jl,Ua,Ct,Xl,_n,Zl,Yl,Ba,ec,tc,Bi,jt,ao,Wa,kn,oc,Ka,nc,Wi,vn,Ki,St,ro,Ra,bn,sc,Ha,ac,Ri,Oe,yn,rc,Ot,ic,Vs,dc,lc,Tn,cc,uc,pc,At,hc,Qs,mc,fc,Js,gc,_c,kc,io,Hi,It,lo,Va,wn,vc,Qa,bc,Vi,co,yc,Ja,Tc,wc,Qi,H,Pn,Pc,$n,$c,xn,xc,zc,Fc,zn,qc,Xs,Ec,Mc,Cc,Ue,Fn,jc,qn,Sc,Xa,Oc,Ac,Ic,En,Zs,Gc,Za,Lc,Nc,Mn,Dc,Ya,Uc,Bc,Wc,er,Kc,Rc,uo,Cn,Hc,tr,Vc,Qc,po,jn,Jc,or,Xc,Zc,ho,Sn,Yc,nr,eu,Ji,Gt,mo,sr,On,tu,ar,ou,Xi,ve,An,nu,Lt,su,rr,au,ru,In,iu,du,lu,Gn,cu,Ys,uu,pu,hu,gt,Ln,mu,ir,fu,gu,Nn,ea,_u,dr,ku,vu,Dn,bu,lr,yu,Tu,wu,fo,Un,Pu,cr,$u,Zi,Nt,go,ur,Bn,xu,pr,zu,Yi,Ae,Wn,Fu,Kn,qu,ta,Eu,Mu,Cu,Rn,ju,Hn,Su,Ou,Au,Be,Vn,Iu,Dt,Gu,oa,Lu,Nu,hr,Du,Uu,Bu,_o,Wu,ko,ed,Ut,vo,mr,Qn,Ku,fr,Ru,td,Ie,Jn,Hu,Xn,Vu,na,Qu,Ju,Xu,Zn,Zu,Yn,Yu,ep,tp,We,es,op,Bt,np,sa,sp,ap,gr,rp,ip,dp,bo,lp,yo,od,Wt,To,_r,ts,cp,kr,up,nd,Kt,os,pp,wo,ns,hp,Po,sd,Rt,$o,vr,ss,mp,br,fp,ad,be,as,gp,rs,_p,aa,kp,vp,bp,is,yp,ds,Tp,wp,Pp,xo,$p,Ke,ls,xp,Ht,zp,ra,Fp,qp,yr,Ep,Mp,Cp,zo,jp,Fo,rd,Vt,qo,Tr,cs,Sp,wr,Op,id,ye,us,Ap,ps,Ip,ia,Gp,Lp,Np,hs,Dp,ms,Up,Bp,Wp,Eo,Kp,Re,fs,Rp,Qt,Hp,da,Vp,Qp,Pr,Jp,Xp,Zp,Mo,Yp,Co,dd,Jt,jo,$r,gs,eh,xr,th,ld,U,_s,oh,ks,nh,la,sh,ah,rh,vs,ih,bs,dh,lh,ch,zr,uh,ph,ct,Fr,ys,hh,mh,qr,Ts,fh,gh,Er,ws,_h,kh,Mr,Ps,vh,bh,He,$s,yh,Xt,Th,Cr,wh,Ph,jr,$h,xh,zh,So,Fh,Oo,qh,Ao,xs,Eh,Io,Mh,Go,zs,Ch,Lo,cd,Zt,No,Sr,Fs,jh,Or,Sh,ud,B,qs,Oh,Es,Ah,ca,Ih,Gh,Lh,Ms,Nh,Cs,Dh,Uh,Bh,Ar,Wh,Kh,ut,Ir,js,Rh,Hh,Gr,Ss,Vh,Qh,Lr,Os,Jh,Xh,Nr,As,Zh,Yh,C,Is,em,Yt,tm,Dr,om,nm,Ur,sm,am,rm,Do,im,Br,dm,lm,Wr,Kr,Rr,Hr,cm,um,Vr,Qr,Jr,Xr,pm,hm,Zr,Yr,ei,ti,mm,fm,oi,ni,Gs,Uo,Bo,si,Ls,gm,ai,_m,km,ri,vm,bm,ii,ym,Tm,di,li,ci,ui,wm,Pm,pi,hi,mi,fi,$m,xm,gi,_i,ki,vi,zm,Fm,bi,yi,Ti,wi,qm,Em,Wo,Ns,Mm,Ko,Cm,Ro,Ds,jm,Ho,pd;return d=new Y({}),K=new Y({}),ge=new Y({}),un=new Y({}),mn=new Y({}),kn=new Y({}),vn=new Ve({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/tokenization_pegasus.py#L258",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/pegasus#transformers.PegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_pegasus.py#L1359",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_pegasus.py#L1551",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1217",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1312"}}),Eo=new dn({props:{$$slots:{default:[ak]},$$scope:{ctx:z}}}),fs=new j({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1346",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L986",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1049",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1319",returnDescription:`
<p>A <a
...
`}}),Ho=new pt({props:{anchor:"transformers.FlaxPegasusForConditionalGeneration.decode.example",$$slots:{default:[mk]},$$scope:{ctx:z}}}),{c(){p=n("meta"),v=l(),_=n("h1"),m=n("a"),k=n("span"),b(d.$$.fragment),h=l(),E=n("span"),Qe=r("Pegasus"),Ge=l(),L=n("p"),Pe=n("strong"),$e=r("DISCLAIMER:"),q=r(" If you see something strange, file a "),ie=n("a"),de=r("Github Issue"),Je=r(`
...
on the XSUM dataset. Data download instructions at `),hn=n("a"),bl=r("examples/pytorch/summarization/"),yl=r("."),Tl=l(),za=n("li"),wl=r("FP16 is not supported (help/ideas on this appreciated!)."),Pl=l(),Fa=n("li"),$l=r("The adafactor optimizer is recommended for pegasus fine-tuning."),Di=l(),Et=n("h2"),so=n("a"),qa=n("span"),b(mn.$$.fragment),xl=l(),Ea=n("span"),zl=r("Implementation Notes"),Ui=l(),Te=n("ul"),Ma=n("li"),Ca=n("p"),Fl=r("All models are transformer encoder-decoders with 16 layers in each component."),ql=l(),ja=n("li"),Rs=n("p"),El=r("The implementation is completely inherited from "),Hs=n("a"),Ml=r("BartForConditionalGeneration"),Cl=l(),fn=n("li"),Sa=n("p"),jl=r("Some key configuration differences:"),Sl=l(),Mt=n("ul"),Oa=n("li"),Ol=r("static, sinusoidal position embeddings"),Al=l(),Aa=n("li"),Il=r("the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Gl=l(),gn=n("li"),Ll=r("more beams are used ("),Ia=n("code"),Nl=r("num_beams=8"),Dl=r(")"),Ul=l(),Ga=n("li"),lt=n("p"),Bl=r("All pretrained pegasus checkpoints are the same besides three attributes: "),La=n("code"),Wl=r("tokenizer.model_max_length"),Kl=r(` (maximum
...
documentation from `),Js=n("a"),gc=r("PretrainedConfig"),_c=r(" for more information."),kc=l(),b(io.$$.fragment),Hi=l(),It=n("h2"),lo=n("a"),Va=n("span"),b(wn.$$.fragment),vc=l(),Qa=n("span"),bc=r("PegasusTokenizer"),Vi=l(),co=n("p"),yc=r("warning: "),Ja=n("code"),Tc=r("add_tokens"),wc=r(" does not work at the moment."),Qi=l(),H=n("div"),b(Pn.$$.fragment),Pc=l(),$n=n("p"),$c=r("Construct a PEGASUS tokenizer. Based on "),xn=n("a"),xc=r("SentencePiece"),zc=r("."),Fc=l(),zn=n("p"),qc=r("This tokenizer inherits from "),Xs=n("a"),Ec=r("PreTrainedTokenizer"),Mc=r(` which contains most of the main methods. Users should refer to
...
and behavior.`),Au=l(),Be=n("div"),b(Vn.$$.fragment),Iu=l(),Dt=n("p"),Gu=r("The "),oa=n("a"),Lu=r("PegasusModel"),Nu=r(" forward method, overrides the "),hr=n("code"),Du=r("__call__"),Uu=r(" special method."),Bu=l(),b(_o.$$.fragment),Wu=l(),b(ko.$$.fragment),ed=l(),Ut=n("h2"),vo=n("a"),mr=n("span"),b(Qn.$$.fragment),Ku=l(),fr=n("span"),Ru=r("PegasusForConditionalGeneration"),td=l(),Ie=n("div"),b(Jn.$$.fragment),Hu=l(),Xn=n("p"),Vu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp=l(),We=n("div"),b(es.$$.fragment),op=l(),Bt=n("p"),np=r("The "),sa=n("a"),sp=r("PegasusForConditionalGeneration"),ap=r(" forward method, overrides the "),gr=n("code"),rp=r("__call__"),ip=r(" special method."),dp=l(),b(bo.$$.fragment),lp=l(),b(yo.$$.fragment),od=l(),Wt=n("h2"),To=n("a"),_r=n("span"),b(ts.$$.fragment),cp=l(),kr=n("span"),up=r("PegasusForCausalLM"),nd=l(),Kt=n("div"),b(os.$$.fragment),pp=l(),wo=n("div"),b(ns.$$.fragment),hp=l(),b(Po.$$.fragment),sd=l(),Rt=n("h2"),$o=n("a"),vr=n("span"),b(ss.$$.fragment),mp=l(),br=n("span"),fp=r("TFPegasusModel"),ad=l(),be=n("div"),b(as.$$.fragment),gp=l(),rs=n("p"),_p=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
behavior.`),Pp=l(),b(xo.$$.fragment),$p=l(),Ke=n("div"),b(ls.$$.fragment),xp=l(),Ht=n("p"),zp=r("The "),ra=n("a"),Fp=r("TFPegasusModel"),qp=r(" forward method, overrides the "),yr=n("code"),Ep=r("__call__"),Mp=r(" special method."),Cp=l(),b(zo.$$.fragment),jp=l(),b(Fo.$$.fragment),rd=l(),Vt=n("h2"),qo=n("a"),Tr=n("span"),b(cs.$$.fragment),Sp=l(),wr=n("span"),Op=r("TFPegasusForConditionalGeneration"),id=l(),ye=n("div"),b(us.$$.fragment),Ap=l(),ps=n("p"),Ip=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Np=l(),hs=n("p"),Dp=r("This model is also a "),ms=n("a"),Up=r("tf.keras.Model"),Bp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wp=l(),b(Eo.$$.fragment),Kp=l(),Re=n("div"),b(fs.$$.fragment),Rp=l(),Qt=n("p"),Hp=r("The "),da=n("a"),Vp=r("TFPegasusForConditionalGeneration"),Qp=r(" forward method, overrides the "),Pr=n("code"),Jp=r("__call__"),Xp=r(" special method."),Zp=l(),b(Mo.$$.fragment),Yp=l(),b(Co.$$.fragment),dd=l(),Jt=n("h2"),jo=n("a"),$r=n("span"),b(gs.$$.fragment),eh=l(),xr=n("span"),th=r("FlaxPegasusModel"),ld=l(),U=n("div"),b(_s.$$.fragment),oh=l(),ks=n("p"),nh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ch=l(),zr=n("p"),uh=r("Finally, this model supports inherent JAX features such as:"),ph=l(),ct=n("ul"),Fr=n("li"),ys=n("a"),hh=r("Just-In-Time (JIT) compilation"),mh=l(),qr=n("li"),Ts=n("a"),fh=r("Automatic Differentiation"),gh=l(),Er=n("li"),ws=n("a"),_h=r("Vectorization"),kh=l(),Mr=n("li"),Ps=n("a"),vh=r("Parallelization"),bh=l(),He=n("div"),b($s.$$.fragment),yh=l(),Xt=n("p"),Th=r("The "),Cr=n("code"),wh=r("FlaxPegasusPreTrainedModel"),Ph=r(" forward method, overrides the "),jr=n("code"),$h=r("__call__"),xh=r(" special method."),zh=l(),b(So.$$.fragment),Fh=l(),b(Oo.$$.fragment),qh=l(),Ao=n("div"),b(xs.$$.fragment),Eh=l(),b(Io.$$.fragment),Mh=l(),Go=n("div"),b(zs.$$.fragment),Ch=l(),b(Lo.$$.fragment),cd=l(),Zt=n("h2"),No=n("a"),Sr=n("span"),b(Fs.$$.fragment),jh=l(),Or=n("span"),Sh=r("FlaxPegasusForConditionalGeneration"),ud=l(),B=n("div"),b(qs.$$.fragment),Oh=l(),Es=n("p"),Ah=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bh=l(),Ar=n("p"),Wh=r("Finally, this model supports inherent JAX features such as:"),Kh=l(),ut=n("ul"),Ir=n("li"),js=n("a"),Rh=r("Just-In-Time (JIT) compilation"),Hh=l(),Gr=n("li"),Ss=n("a"),Vh=r("Automatic Differentiation"),Qh=l(),Lr=n("li"),Os=n("a"),Jh=r("Vectorization"),Xh=l(),Nr=n("li"),As=n("a"),Zh=r("Parallelization"),Yh=l(),C=n("div"),b(Is.$$.fragment),em=l(),Yt=n("p"),tm=r("The "),Dr=n("code"),om=r("FlaxPegasusPreTrainedModel"),nm=r(" forward method, overrides the "),Ur=n("code"),sm=r("__call__"),am=r(" special method."),rm=l(),b(Do.$$.fragment),im=l(),Br=n("p"),dm=r("Summarization example:"),lm=l(),Wr=n("blockquote"),Kr=n("blockquote"),Rr=n("blockquote"),Hr=n("p"),cm=r("from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),um=l(),Vr=n("blockquote"),Qr=n("blockquote"),Jr=n("blockquote"),Xr=n("p"),pm=r(`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),fm=l(),oi=n("blockquote"),ni=n("blockquote"),Gs=n("blockquote"),Uo=n("h1"),Bo=n("a"),si=n("span"),b(Ls.$$.fragment),gm=l(),ai=n("span"),_m=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),km=l(),ri=n("p"),vm=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),bm=l(),ii=n("p"),ym=r("Mask filling example:"),Tm=l(),di=n("blockquote"),li=n("blockquote"),ci=n("blockquote"),ui=n("p"),wm=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Fm=l(),bi=n("blockquote"),yi=n("blockquote"),Ti=n("blockquote"),wi=n("p"),qm=r("tokenizer.decode(predictions).split()"),Em=l(),Wo=n("div"),b(Ns.$$.fragment),Mm=l(),b(Ko.$$.fragment),Cm=l(),Ro=n("div"),b(Ds.$$.fragment),jm=l(),b(Ho.$$.fragment),this.h()},l(o){const g=V_('[data-svelte="svelte-1phssyn"]',document.head);p=s(g,"META",{name:!0,content:!0}),g.forEach(t),v=c(o),_=s(o,"H1",{class:!0});var Us=a(_);m=s(Us,"A",{id:!0,class:!0,href:!0});var Pi=a(m);k=s(Pi,"SPAN",{});var $i=a(k);y(d.$$.fragment,$i),$i.forEach(t),Pi.forEach(t),h=c(Us),E=s(Us,"SPAN",{});var xi=a(E);Qe=i(xi,"Pegasus"),xi.forEach(t),Us.forEach(t),Ge=c(o),L=s(o,"P",{});var Vo=a(L);Pe=s(Vo,"STRONG",{});var zi=a(Pe);$e=i(zi,"DISCLAIMER:"),zi.forEach(t),q=i(Vo," If you see something strange, file a "),ie=s(Vo,"A",{href:!0,rel:!0});var Fi=a(ie);de=i(Fi,"Github Issue"),Fi.forEach(t),Je=i(Vo,`
and assign @patrickvonplaten.`),Vo.forEach(t),Le=c(o),N=s(o,"H2",{class:!0});var Bs=a(N);ee=s(Bs,"A",{id:!0,class:!0,href:!0});var qi=a(ee);xe=s(qi,"SPAN",{});var Ei=a(xe);y(K.$$.fragment,Ei),Ei.forEach(t),qi.forEach(t),Xe=c(Bs),ze=s(Bs,"SPAN",{});var Mi=a(ze);le=i(Mi,"Overview"),Mi.forEach(t),Bs.forEach(t),Ne=c(o),te=s(o,"P",{});var Ws=a(te);ce=i(Ws,"The Pegasus model was proposed in "),ue=s(Ws,"A",{href:!0,rel:!0});var Ci=a(ue);Ze=i(Ci,"PEGASUS: Pre-training with Extracted Gap-sentences for Abstractive Summarization"),Ci.forEach(t),Fe=i(Ws," by Jingqing Zhang, Yao Zhao, Mohammad Saleh and Peter J. Liu on Dec 18, 2019."),Ws.forEach(t),S=c(o),A=s(o,"P",{});var ji=a(A);Ye=i(ji,"According to the abstract,"),ji.forEach(t),oe=c(o),ne=s(o,"UL",{});var Ks=a(ne);qe=s(Ks,"LI",{});var Si=a(qe);pe=i(Si,`Pegasus\u2019 pretraining task is intentionally similar to summarization: important sentences are removed/masked from an
input document and are generated together as one output sequence from the remaining sentences, similar to an
...
found in `),Ba=s(ma,"CODE",{});var bf=a(Ba);ec=i(bf,"convert_pegasus_tf_to_pytorch.py"),bf.forEach(t),tc=i(ma,"."),ma.forEach(t),kf.forEach(t),kt.forEach(t),Bi=c(o),jt=s(o,"H2",{class:!0});var vd=a(jt);ao=s(vd,"A",{id:!0,class:!0,href:!0});var yf=a(ao);Wa=s(yf,"SPAN",{});var Tf=a(Wa);y(kn.$$.fragment,Tf),Tf.forEach(t),yf.forEach(t),oc=c(vd),Ka=s(vd,"SPAN",{});var wf=a(Ka);nc=i(wf,"Usage Example"),wf.forEach(t),vd.forEach(t),Wi=c(o),y(vn.$$.fragment,o),Ki=c(o),St=s(o,"H2",{class:!0});var bd=a(St);ro=s(bd,"A",{id:!0,class:!0,href:!0});var Pf=a(ro);Ra=s(Pf,"SPAN",{});var $f=a(Ra);y(bn.$$.fragment,$f),$f.forEach(t),Pf.forEach(t),sc=c(bd),Ha=s(bd,"SPAN",{});var xf=a(Ha);ac=i(xf,"PegasusConfig"),xf.forEach(t),bd.forEach(t),Ri=c(o),Oe=s(o,"DIV",{class:!0});var Jo=a(Oe);y(yn.$$.fragment,Jo),rc=c(Jo),Ot=s(Jo,"P",{});var fa=a(Ot);ic=i(fa,"This is the configuration class to store the configuration of a "),Vs=s(fa,"A",{href:!0});var zf=a(Vs);dc=i(zf,"PegasusModel"),zf.forEach(t),lc=i(fa,`. It is used to instantiate an
PEGASUS model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PEGASUS
...
and adding special tokens. A PEGASUS sequence has the following format, where `),Xa=s($d,"CODE",{});var If=a(Xa);Oc=i(If,"X"),If.forEach(t),Ac=i($d," represents the sequence:"),$d.forEach(t),Ic=c(Xo),En=s(Xo,"UL",{});var xd=a(En);Zs=s(xd,"LI",{});var Om=a(Zs);Gc=i(Om,"single sequence: "),Za=s(Om,"CODE",{});var Gf=a(Za);Lc=i(Gf,"X </s>"),Gf.forEach(t),Om.forEach(t),Nc=c(xd),Mn=s(xd,"LI",{});var zd=a(Mn);Dc=i(zd,"pair of sequences: "),Ya=s(zd,"CODE",{});var Lf=a(Ya);Uc=i(Lf,"A B </s>"),Lf.forEach(t),Bc=i(zd," (not intended use)"),zd.forEach(t),xd.forEach(t),Wc=c(Xo),er=s(Xo,"P",{});var Nf=a(er);Kc=i(Nf,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Nf.forEach(t),Xo.forEach(t),Rc=c(we),uo=s(we,"DIV",{class:!0});var Fd=a(uo);y(Cn.$$.fragment,Fd),Hc=c(Fd),tr=s(Fd,"P",{});var Df=a(tr);Vc=i(Df,"Converts a sequence of tokens (string) in a single string."),Df.forEach(t),Fd.forEach(t),Qc=c(we),po=s(we,"DIV",{class:!0});var qd=a(po);y(jn.$$.fragment,qd),Jc=c(qd),or=s(qd,"P",{});var Uf=a(or);Xc=i(Uf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Uf.forEach(t),qd.forEach(t),Zc=c(we),ho=s(we,"DIV",{class:!0});var Ed=a(ho);y(Sn.$$.fragment,Ed),Yc=c(Ed),nr=s(Ed,"P",{});var Bf=a(nr);eu=i(Bf,"Just EOS"),Bf.forEach(t),Ed.forEach(t),we.forEach(t),Ji=c(o),Gt=s(o,"H2",{class:!0});var Md=a(Gt);mo=s(Md,"A",{id:!0,class:!0,href:!0});var Wf=a(mo);sr=s(Wf,"SPAN",{});var Kf=a(sr);y(On.$$.fragment,Kf),Kf.forEach(t),Wf.forEach(t),tu=c(Md),ar=s(Md,"SPAN",{});var Rf=a(ar);ou=i(Rf,"PegasusTokenizerFast"),Rf.forEach(t),Md.forEach(t),Xi=c(o),ve=s(o,"DIV",{class:!0});var vt=a(ve);y(An.$$.fragment,vt),nu=c(vt),Lt=s(vt,"P",{});var _a=a(Lt);su=i(_a,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),rr=s(_a,"EM",{});var Hf=a(rr);au=i(Hf,"tokenizers"),Hf.forEach(t),ru=i(_a,` library). Based on
`),In=s(_a,"A",{href:!0,rel:!0});var Vf=a(In);iu=i(Vf,"Unigram"),Vf.forEach(t),du=i(_a,"."),_a.forEach(t),lu=c(vt),Gn=s(vt,"P",{});var Cd=a(Gn);cu=i(Cd,"This tokenizer inherits from "),Ys=s(Cd,"A",{href:!0});var Qf=a(Ys);uu=i(Qf,"PreTrainedTokenizerFast"),Qf.forEach(t),pu=i(Cd,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Cd.forEach(t),hu=c(vt),gt=s(vt,"DIV",{class:!0});var ka=a(gt);y(Ln.$$.fragment,ka),mu=c(ka),ir=s(ka,"P",{});var Jf=a(ir);fu=i(Jf,"Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),Jf.forEach(t),gu=c(ka),Nn=s(ka,"UL",{});var jd=a(Nn);ea=s(jd,"LI",{});var Am=a(ea);_u=i(Am,"single sequence: "),dr=s(Am,"CODE",{});var Xf=a(dr);ku=i(Xf,"X </s>"),Xf.forEach(t),Am.forEach(t),vu=c(jd),Dn=s(jd,"LI",{});var Sd=a(Dn);bu=i(Sd,"pair of sequences: "),lr=s(Sd,"CODE",{});var Zf=a(lr);yu=i(Zf,"A B </s>"),Zf.forEach(t),Tu=i(Sd," (not intended use)"),Sd.forEach(t),jd.forEach(t),ka.forEach(t),wu=c(vt),fo=s(vt,"DIV",{class:!0});var Od=a(fo);y(Un.$$.fragment,Od),Pu=c(Od),cr=s(Od,"P",{});var Yf=a(cr);$u=i(Yf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Yf.forEach(t),Od.forEach(t),vt.forEach(t),Zi=c(o),Nt=s(o,"H2",{class:!0});var Ad=a(Nt);go=s(Ad,"A",{id:!0,class:!0,href:!0});var eg=a(go);ur=s(eg,"SPAN",{});var tg=a(ur);y(Bn.$$.fragment,tg),tg.forEach(t),eg.forEach(t),xu=c(Ad),pr=s(Ad,"SPAN",{});var og=a(pr);zu=i(og,"PegasusModel"),og.forEach(t),Ad.forEach(t),Yi=c(o),Ae=s(o,"DIV",{class:!0});var Zo=a(Ae);y(Wn.$$.fragment,Zo),Fu=c(Zo),Kn=s(Zo,"P",{});var Id=a(Kn);qu=i(Id,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd.forEach(t),tp=c(en),We=s(en,"DIV",{class:!0});var tn=a(We);y(es.$$.fragment,tn),op=c(tn),Bt=s(tn,"P",{});var ba=a(Bt);np=i(ba,"The "),sa=s(ba,"A",{href:!0});var pg=a(sa);sp=i(pg,"PegasusForConditionalGeneration"),pg.forEach(t),ap=i(ba," forward method, overrides the "),gr=s(ba,"CODE",{});var hg=a(gr);rp=i(hg,"__call__"),hg.forEach(t),ip=i(ba," special method."),ba.forEach(t),dp=c(tn),y(bo.$$.fragment,tn),lp=c(tn),y(yo.$$.fragment,tn),tn.forEach(t),en.forEach(t),od=c(o),Wt=s(o,"H2",{class:!0});var Ud=a(Wt);To=s(Ud,"A",{id:!0,class:!0,href:!0});var mg=a(To);_r=s(mg,"SPAN",{});var fg=a(_r);y(ts.$$.fragment,fg),fg.forEach(t),mg.forEach(t),cp=c(Ud),kr=s(Ud,"SPAN",{});var gg=a(kr);up=i(gg,"PegasusForCausalLM"),gg.forEach(t),Ud.forEach(t),nd=c(o),Kt=s(o,"DIV",{class:!0});var Bd=a(Kt);y(os.$$.fragment,Bd),pp=c(Bd),wo=s(Bd,"DIV",{class:!0});var Wd=a(wo);y(ns.$$.fragment,Wd),hp=c(Wd),y(Po.$$.fragment,Wd),Wd.forEach(t),Bd.forEach(t),sd=c(o),Rt=s(o,"H2",{class:!0});var Kd=a(Rt);$o=s(Kd,"A",{id:!0,class:!0,href:!0});var _g=a($o);vr=s(_g,"SPAN",{});var kg=a(vr);y(ss.$$.fragment,kg),kg.forEach(t),_g.forEach(t),mp=c(Kd),br=s(Kd,"SPAN",{});var vg=a(br);fp=i(vg,"TFPegasusModel"),vg.forEach(t),Kd.forEach(t),ad=c(o),be=s(o,"DIV",{class:!0});var bt=a(be);y(as.$$.fragment,bt),gp=c(bt),rs=s(bt,"P",{});var Rd=a(rs);_p=i(Rd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),aa=s(Rd,"A",{href:!0});var bg=a(aa);kp=i(bg,"TFPreTrainedModel"),bg.forEach(t),vp=i(Rd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rd.forEach(t),bp=c(bt),is=s(bt,"P",{});var Hd=a(is);yp=i(Hd,"This model is also a "),ds=s(Hd,"A",{href:!0,rel:!0});var yg=a(ds);Tp=i(yg,"tf.keras.Model"),yg.forEach(t),wp=i(Hd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hd.forEach(t),Pp=c(bt),y(xo.$$.fragment,bt),$p=c(bt),Ke=s(bt,"DIV",{class:!0});var on=a(Ke);y(ls.$$.fragment,on),xp=c(on),Ht=s(on,"P",{});var ya=a(Ht);zp=i(ya,"The "),ra=s(ya,"A",{href:!0});var Tg=a(ra);Fp=i(Tg,"TFPegasusModel"),Tg.forEach(t),qp=i(ya," forward method, overrides the "),yr=s(ya,"CODE",{});var wg=a(yr);Ep=i(wg,"__call__"),wg.forEach(t),Mp=i(ya," special method."),ya.forEach(t),Cp=c(on),y(zo.$$.fragment,on),jp=c(on),y(Fo.$$.fragment,on),on.forEach(t),bt.forEach(t),rd=c(o),Vt=s(o,"H2",{class:!0});var Vd=a(Vt);qo=s(Vd,"A",{id:!0,class:!0,href:!0});var Pg=a(qo);Tr=s(Pg,"SPAN",{});var $g=a(Tr);y(cs.$$.fragment,$g),$g.forEach(t),Pg.forEach(t),Sp=c(Vd),wr=s(Vd,"SPAN",{});var xg=a(wr);Op=i(xg,"TFPegasusForConditionalGeneration"),xg.forEach(t),Vd.forEach(t),id=c(o),ye=s(o,"DIV",{class:!0});var yt=a(ye);y(us.$$.fragment,yt),Ap=c(yt),ps=s(yt,"P",{});var Qd=a(ps);Ip=i(Qd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),sl.forEach(t),Bh=c(re),Ar=s(re,"P",{});var Zg=a(Ar);Wh=i(Zg,"Finally, this model supports inherent JAX features such as:"),Zg.forEach(t),Kh=c(re),ut=s(re,"UL",{});var rn=a(ut);Ir=s(rn,"LI",{});var Yg=a(Ir);js=s(Yg,"A",{href:!0,rel:!0});var e_=a(js);Rh=i(e_,"Just-In-Time (JIT) compilation"),e_.forEach(t),Yg.forEach(t),Hh=c(rn),Gr=s(rn,"LI",{});var t_=a(Gr);Ss=s(t_,"A",{href:!0,rel:!0});var o_=a(Ss);Vh=i(o_,"Automatic Differentiation"),o_.forEach(t),t_.forEach(t),Qh=c(rn),Lr=s(rn,"LI",{});var n_=a(Lr);Os=s(n_,"A",{href:!0,rel:!0});var s_=a(Os);Jh=i(s_,"Vectorization"),s_.forEach(t),n_.forEach(t),Xh=c(rn),Nr=s(rn,"LI",{});var a_=a(Nr);As=s(a_,"A",{href:!0,rel:!0});var r_=a(As);Zh=i(r_,"Parallelization"),r_.forEach(t),a_.forEach(t),rn.forEach(t),Yh=c(re),C=s(re,"DIV",{class:!0});var O=a(C);y(Is.$$.fragment,O),em=c(O),Yt=s(O,"P",{});var Pa=a(Yt);tm=i(Pa,"The "),Dr=s(Pa,"CODE",{});var i_=a(Dr);om=i(i_,"FlaxPegasusPreTrainedModel"),i_.forEach(t),nm=i(Pa," forward method, overrides the "),Ur=s(Pa,"CODE",{});var d_=a(Ur);sm=i(d_,"__call__"),d_.forEach(t),am=i(Pa," special method."),Pa.forEach(t),rm=c(O),y(Do.$$.fragment,O),im=c(O),Br=s(O,"P",{});var l_=a(Br);dm=i(l_,"Summarization example:"),l_.forEach(t),lm=c(O),Wr=s(O,"BLOCKQUOTE",{});var c_=a(Wr);Kr=s(c_,"BLOCKQUOTE",{});var u_=a(Kr);Rr=s(u_,"BLOCKQUOTE",{});var p_=a(Rr);Hr=s(p_,"P",{});var h_=a(Hr);cm=i(h_,"from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),h_.forEach(t),p_.forEach(t),u_.forEach(t),c_.forEach(t),um=c(O),Vr=s(O,"BLOCKQUOTE",{});var m_=a(Vr);Qr=s(m_,"BLOCKQUOTE",{});var f_=a(Qr);Jr=s(f_,"BLOCKQUOTE",{});var g_=a(Jr);Xr=s(g_,"P",{});var __=a(Xr);pm=i(__,`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),N_.forEach(t),L_.forEach(t),G_.forEach(t),I_.forEach(t),Fm=c(O),bi=s(O,"BLOCKQUOTE",{});var D_=a(bi);yi=s(D_,"BLOCKQUOTE",{});var U_=a(yi);Ti=s(U_,"BLOCKQUOTE",{});var B_=a(Ti);wi=s(B_,"P",{});var W_=a(wi);qm=i(W_,"tokenizer.decode(predictions).split()"),W_.forEach(t),B_.forEach(t),U_.forEach(t),D_.forEach(t),O.forEach(t),Em=c(re),Wo=s(re,"DIV",{class:!0});var il=a(Wo);y(Ns.$$.fragment,il),Mm=c(il),y(Ko.$$.fragment,il),il.forEach(t),Cm=c(re),Ro=s(re,"DIV",{class:!0});var dl=a(Ro);y(Ds.$$.fragment,dl),jm=c(dl),y(Ho.$$.fragment,dl),dl.forEach(t),re.forEach(t),this.h()},h(){u(p,"name","hf:doc:metadata"),u(p,"content",JSON.stringify(gk)),u(m,"id","pegasus"),u(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(m,"href","#pegasus"),u(_,"class","relative group"),u(ie,"href","https://github.com/huggingface/transformers/issues/new?assignees=sshleifer&labels=&template=bug-report.md&title"),u(ie,"rel","nofollow"),u(ee,"id","overview"),u(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ee,"href","#overview"),u(N,"class","relative group"),u(ue,"href","https://arxiv.org/pdf/1912.08777.pdf"),u(ue,"rel","nofollow"),u(he,"href","https://huggingface.co/sshleifer"),u(he,"rel","nofollow"),u(fe,"href","https://github.com/google-research/pegasus"),u(fe,"rel","nofollow"),u(V,"id","checkpoints"),u(V,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(V,"href","#checkpoints"),u(J,"class","relative group"),u(X,"href","https://huggingface.co/models?search=pegasus"),u(X,"rel","nofollow"),u(Se,"href","https://github.com/huggingface/transformers/issues/6844#issue-689259666"),u(Se,"rel","nofollow"),u(ln,"href","https://huggingface.co/models?search=distill-pegasus"),u(ln,"rel","nofollow"),u(cn,"href","https://arxiv.org/abs/2010.13002"),u(cn,"rel","nofollow"),u(oo,"id","examples"),u(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(oo,"href","#examples"),u(qt,"class","relative group"),u(pn,"href","https://github.com/huggingface/transformers/tree/main/examples/research_projects/seq2seq-distillation/finetune_pegasus_xsum.sh"),u(pn,"rel","nofollow"),u(hn,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/summarization/README.md"),u(hn,"rel","nofollow"),u(so,"id","implementation-notes"),u(so,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(so,"href","#implementation-notes"),u(Et,"class","relative group"),u(Hs,"href","/docs/transformers/v4.23.0/en/model_doc/bart#transformers.BartForConditionalGeneration"),u(_n,"href","https://github.com/google-research/pegasus"),u(_n,"rel","nofollow"),u(ao,"id","usage-example"),u(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ao,"href","#usage-example"),u(jt,"class","relative group"),u(ro,"id","transformers.PegasusConfig"),u(ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ro,"href","#transformers.PegasusConfig"),u(St,"class","relative group"),u(Vs,"href","/docs/transformers/v4.23.0/en/model_doc/pegasus#transformers.PegasusModel"),u(Tn,"href","https://huggingface.co/google/pegasus-large"),u(Tn,"rel","nofollow"),u(Qs,"href","/docs/transformers/v4.23.0/en/main_classes/configuration#transformers.PretrainedConfig"),u(Js,"href","/docs/transformers/v4.23.0/en/main_classes/configuration#transformers.PretrainedConfig"),u(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(lo,"id","transformers.PegasusTokenizer"),u(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(lo,"href","#transformers.PegasusTokenizer"),u(It,"class","relative group"),u(xn,"href","https://github.com/google/sentencepiece"),u(xn,"rel","nofollow"),u(Xs,"href","/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),u(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(uo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(po,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ho,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(mo,"id","transformers.PegasusTokenizerFast"),u(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(mo,"href","#transformers.PegasusTokenizerFast"),u(Gt,"class","relative group"),u(In,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),u(In,"rel","nofollow"),u(Ys,"href","/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),u(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(fo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(go,"id","transformers.PegasusModel"),u(go,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(go,"href","#transformers.PegasusModel"),u(Nt,"class","relative group"),u(ta,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel"),u(Hn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Hn,"rel","nofollow"),u(oa,"href","/docs/transformers/v4.23.0/en/model_doc/pegasus#transformers.PegasusModel"),u(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(vo,"id","transformers.PegasusForConditionalGeneration"),u(vo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(vo,"href","#transformers.PegasusForConditionalGeneration"),u(Ut,"class","relative group"),u(na,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel"),u(Yn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Yn,"rel","nofollow"),u(sa,"href","/docs/transformers/v4.23.0/en/model_doc/pegasus#transformers.PegasusForConditionalGeneration"),u(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(To,"id","transformers.PegasusForCausalLM"),u(To,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(To,"href","#transformers.PegasusForCausalLM"),u(Wt,"class","relative group"),u(wo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u($o,"id","transformers.TFPegasusModel"),u($o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u($o,"href","#transformers.TFPegasusModel"),u(Rt,"class","relative group"),u(aa,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.TFPreTrainedModel"),u(ds,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),u(ds,"rel","nofollow"),u(ra,"href","/docs/transformers/v4.23.0/en/model_doc/pegasus#transformers.TFPegasusModel"),u(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(qo,"id","transformers.TFPegasusForConditionalGeneration"),u(qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(qo,"href","#transformers.TFPegasusForConditionalGeneration"),u(Vt,"class","relative group"),u(ia,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.TFPreTrainedModel"),u(ms,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),u(ms,"rel","nofollow"),u(da,"href","/docs/transformers/v4.23.0/en/model_doc/pegasus#transformers.TFPegasusForConditionalGeneration"),u(Re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(jo,"id","transformers.FlaxPegasusModel"),u(jo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(jo,"href","#transformers.FlaxPegasusModel"),u(Jt,"class","relative group"),u(la,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel"),u(bs,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),u(bs,"rel","nofollow"),u(ys,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),u(ys,"rel","nofollow"),u(Ts,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),u(Ts,"rel","nofollow"),u(ws,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),u(ws,"rel","nofollow"),u(Ps,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),u(Ps,"rel","nofollow"),u(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Ao,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Go,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(No,"id","transformers.FlaxPegasusForConditionalGeneration"),u(No,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(No,"href","#transformers.FlaxPegasusForConditionalGeneration"),u(Zt,"class","relative group"),u(ca,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel"),u(Cs,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),u(Cs,"rel","nofollow"),u(js,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),u(js,"rel","nofollow"),u(Ss,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),u(Ss,"rel","nofollow"),u(Os,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),u(Os,"rel","nofollow"),u(As,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),u(As,"rel","nofollow"),u(Bo,"id","generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),u(Bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Bo,"href","#generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),u(Uo,"class","relative group"),u(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Wo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Ro,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,g){e(document.head,p),f(o,v,g),f(o,_,g),e(_,m),e(m,k),T(d,k,null),e(_,h),e(_,E),e(E,Qe),f(o,Ge,g),f(o,L,g),e(L,Pe),e(Pe,$e),e(L,q),e(L,ie),e(ie,de),e(L,Je),f(o,Le,g),f(o,N,g),e(N,ee),e(ee,xe),T(K,xe,null),e(N,Xe),e(N,ze),e(ze,le),f(o,Ne,g),f(o,te,g),e(te,ce),e(te,ue),e(ue,Ze),e(te,Fe),f(o,S,g),f(o,A,g),e(A,Ye),f(o,oe,g),f(o,ne,g),e(ne,qe),e(qe,pe),e(ne,et),e(ne,Ee),e(Ee,D),f(o,De,g),f(o,G,g),e(G,tt),e(G,he),e(he,me),e(G,ot),e(G,fe),e(fe,Q),e(G,nt),f(o,se,g),f(o,J,g),e(J,V),e(V,I),T(ge,I,null),e(J,R),e(J,Me),e(Me,st),f(o,x,g),f(o,F,g),e(F,Tt),e(F,X),e(X,wt),e(F,Pt),e(F,M),e(M,$t),e(F,xt),f(o,mt,g),f(o,W,g),e(W,at),e(at,Z),e(W,_e),e(W,rt),e(rt,zt),e(W,ke),e(W,it),e(it,Ft),e(W,dt),e(W,Ce),e(Ce,je),e(Ce,Se),e(Se,ll),e(Ce,cl),e(W,ul),e(W,to),e(to,ln),e(ln,pl),e(to,hl),e(to,cn),e(cn,ml),e(to,fl),f(o,Li,g),f(o,qt,g),e(qt,oo),e(oo,$a),T(un,$a,null),e(qt,gl),e(qt,xa),e(xa,_l),f(o,Ni,g),f(o,ft,g),e(ft,no),e(no,pn),e(pn,kl),e(no,vl),e(no,hn),e(hn,bl),e(no,yl),e(ft,Tl),e(ft,za),e(za,wl),e(ft,Pl),e(ft,Fa),e(Fa,$l),f(o,Di,g),f(o,Et,g),e(Et,so),e(so,qa),T(mn,qa,null),e(Et,xl),e(Et,Ea),e(Ea,zl),f(o,Ui,g),f(o,Te,g),e(Te,Ma),e(Ma,Ca),e(Ca,Fl),e(Te,ql),e(Te,ja),e(ja,Rs),e(Rs,El),e(Rs,Hs),e(Hs,Ml),e(Te,Cl),e(Te,fn),e(fn,Sa),e(Sa,jl),e(fn,Sl),e(fn,Mt),e(Mt,Oa),e(Oa,Ol),e(Mt,Al),e(Mt,Aa),e(Aa,Il),e(Mt,Gl),e(Mt,gn),e(gn,Ll),e(gn,Ia),e(Ia,Nl),e(gn,Dl),e(Te,Ul),e(Te,Ga),e(Ga,lt),e(lt,Bl),e(lt,La),e(La,Wl),e(lt,Kl),e(lt,Na),e(Na,Rl),e(lt,Hl),e(lt,Da),e(Da,Vl),e(lt,Ql),e(Te,Jl),e(Te,Ua),e(Ua,Ct),e(Ct,Xl),e(Ct,_n),e(_n,Zl),e(Ct,Yl),e(Ct,Ba),e(Ba,ec),e(Ct,tc),f(o,Bi,g),f(o,jt,g),e(jt,ao),e(ao,Wa),T(kn,Wa,null),e(jt,oc),e(jt,Ka),e(Ka,nc),f(o,Wi,g),T(vn,o,g),f(o,Ki,g),f(o,St,g),e(St,ro),e(ro,Ra),T(bn,Ra,null),e(St,sc),e(St,Ha),e(Ha,ac),f(o,Ri,g),f(o,Oe,g),T(yn,Oe,null),e(Oe,rc),e(Oe,Ot),e(Ot,ic),e(Ot,Vs),e(Vs,dc),e(Ot,lc),e(Ot,Tn),e(Tn,cc),e(Ot,uc),e(Oe,pc),e(Oe,At),e(At,hc),e(At,Qs),e(Qs,mc),e(At,fc),e(At,Js),e(Js,gc),e(At,_c),e(Oe,kc),T(io,Oe,null),f(o,Hi,g),f(o,It,g),e(It,lo),e(lo,Va),T(wn,Va,null),e(It,vc),e(It,Qa),e(Qa,bc),f(o,Vi,g),f(o,co,g),e(co,yc),e(co,Ja),e(Ja,Tc),e(co,wc),f(o,Qi,g),f(o,H,g),T(Pn,H,null),e(H,Pc),e(H,$n),e($n,$c),e($n,xn),e(xn,xc),e($n,zc),e(H,Fc),e(H,zn),e(zn,qc),e(zn,Xs),e(Xs,Ec),e(zn,Mc),e(H,Cc),e(H,Ue),T(Fn,Ue,null),e(Ue,jc),e(Ue,qn),e(qn,Sc),e(qn,Xa),e(Xa,Oc),e(qn,Ac),e(Ue,Ic),e(Ue,En),e(En,Zs),e(Zs,Gc),e(Zs,Za),e(Za,Lc),e(En,Nc),e(En,Mn),e(Mn,Dc),e(Mn,Ya),e(Ya,Uc),e(Mn,Bc),e(Ue,Wc),e(Ue,er),e(er,Kc),e(H,Rc),e(H,uo),T(Cn,uo,null),e(uo,Hc),e(uo,tr),e(tr,Vc),e(H,Qc),e(H,po),T(jn,po,null),e(po,Jc),e(po,or),e(or,Xc),e(H,Zc),e(H,ho),T(Sn,ho,null),e(ho,Yc),e(ho,nr),e(nr,eu),f(o,Ji,g),f(o,Gt,g),e(Gt,mo),e(mo,sr),T(On,sr,null),e(Gt,tu),e(Gt,ar),e(ar,ou),f(o,Xi,g),f(o,ve,g),T(An,ve,null),e(ve,nu),e(ve,Lt),e(Lt,su),e(Lt,rr),e(rr,au),e(Lt,ru),e(Lt,In),e(In,iu),e(Lt,du),e(ve,lu),e(ve,Gn),e(Gn,cu),e(Gn,Ys),e(Ys,uu),e(Gn,pu),e(ve,hu),e(ve,gt),T(Ln,gt,null),e(gt,mu),e(gt,ir),e(ir,fu),e(gt,gu),e(gt,Nn),e(Nn,ea),e(ea,_u),e(ea,dr),e(dr,ku),e(Nn,vu),e(Nn,Dn),e(Dn,bu),e(Dn,lr),e(lr,yu),e(Dn,Tu),e(ve,wu),e(ve,fo),T(Un,fo,null),e(fo,Pu),e(fo,cr),e(cr,$u),f(o,Zi,g),f(o,Nt,g),e(Nt,go),e(go,ur),T(Bn,ur,null),e(Nt,xu),e(Nt,pr),e(pr,zu),f(o,Yi,g),f(o,Ae,g),T(Wn,Ae,null),e(Ae,Fu),e(Ae,Kn),e(Kn,qu),e(Kn,ta),e(ta,Eu),e(Kn,Mu),e(Ae,Cu),e(Ae,Rn),e(Rn,ju),e(Rn,Hn),e(Hn,Su),e(Rn,Ou),e(Ae,Au),e(Ae,Be),T(Vn,Be,null),e(Be,Iu),e(Be,Dt),e(Dt,Gu),e(Dt,oa),e(oa,Lu),e(Dt,Nu),e(Dt,hr),e(hr,Du),e(Dt,Uu),e(Be,Bu),T(_o,Be,null),e(Be,Wu),T(ko,Be,null),f(o,ed,g),f(o,Ut,g),e(Ut,vo),e(vo,mr),T(Qn,mr,null),e(Ut,Ku),e(Ut,fr),e(fr,Ru),f(o,td,g),f(o,Ie,g),T(Jn,Ie,null),e(Ie,Hu),e(Ie,Xn),e(Xn,Vu),e(Xn,na),e(na,Qu),e(Xn,Ju),e(Ie,Xu),e(Ie,Zn),e(Zn,Zu),e(Zn,Yn),e(Yn,Yu),e(Zn,ep),e(Ie,tp),e(Ie,We),T(es,We,null),e(We,op),e(We,Bt),e(Bt,np),e(Bt,sa),e(sa,sp),e(Bt,ap),e(Bt,gr),e(gr,rp),e(Bt,ip),e(We,dp),T(bo,We,null),e(We,lp),T(yo,We,null),f(o,od,g),f(o,Wt,g),e(Wt,To),e(To,_r),T(ts,_r,null),e(Wt,cp),e(Wt,kr),e(kr,up),f(o,nd,g),f(o,Kt,g),T(os,Kt,null),e(Kt,pp),e(Kt,wo),T(ns,wo,null),e(wo,hp),T(Po,wo,null),f(o,sd,g),f(o,Rt,g),e(Rt,$o),e($o,vr),T(ss,vr,null),e(Rt,mp),e(Rt,br),e(br,fp),f(o,ad,g),f(o,be,g),T(as,be,null),e(be,gp),e(be,rs),e(rs,_p),e(rs,aa),e(aa,kp),e(rs,vp),e(be,bp),e(be,is),e(is,yp),e(is,ds),e(ds,Tp),e(is,wp),e(be,Pp),T(xo,be,null),e(be,$p),e(be,Ke),T(ls,Ke,null),e(Ke,xp),e(Ke,Ht),e(Ht,zp),e(Ht,ra),e(ra,Fp),e(Ht,qp),e(Ht,yr),e(yr,Ep),e(Ht,Mp),e(Ke,Cp),T(zo,Ke,null),e(Ke,jp),T(Fo,Ke,null),f(o,rd,g),f(o,Vt,g),e(Vt,qo),e(qo,Tr),T(cs,Tr,null),e(Vt,Sp),e(Vt,wr),e(wr,Op),f(o,id,g),f(o,ye,g),T(us,ye,null),e(ye,Ap),e(ye,ps),e(ps,Ip),e(ps,ia),e(ia,Gp),e(ps,Lp),e(ye,Np),e(ye,hs),e(hs,Dp),e(hs,ms),e(ms,Up),e(hs,Bp),e(ye,Wp),T(Eo,ye,null),e(ye,Kp),e(ye,Re),T(fs,Re,null),e(Re,Rp),e(Re,Qt),e(Qt,Hp),e(Qt,da),e(da,Vp),e(Qt,Qp),e(Qt,Pr),e(Pr,Jp),e(Qt,Xp),e(Re,Zp),T(Mo,Re,null),e(Re,Yp),T(Co,Re,null),f(o,dd,g),f(o,Jt,g),e(Jt,jo),e(jo,$r),T(gs,$r,null),e(Jt,eh),e(Jt,xr),e(xr,th),f(o,ld,g),f(o,U,g),T(_s,U,null),e(U,oh),e(U,ks),e(ks,nh),e(ks,la),e(la,sh),e(ks,ah),e(U,rh),e(U,vs),e(vs,ih),e(vs,bs),e(bs,dh),e(vs,lh),e(U,ch),e(U,zr),e(zr,uh),e(U,ph),e(U,ct),e(ct,Fr),e(Fr,ys),e(ys,hh),e(ct,mh),e(ct,qr),e(qr,Ts),e(Ts,fh),e(ct,gh),e(ct,Er),e(Er,ws),e(ws,_h),e(ct,kh),e(ct,Mr),e(Mr,Ps),e(Ps,vh),e(U,bh),e(U,He),T($s,He,null),e(He,yh),e(He,Xt),e(Xt,Th),e(Xt,Cr),e(Cr,wh),e(Xt,Ph),e(Xt,jr),e(jr,$h),e(Xt,xh),e(He,zh),T(So,He,null),e(He,Fh),T(Oo,He,null),e(U,qh),e(U,Ao),T(xs,Ao,null),e(Ao,Eh),T(Io,Ao,null),e(U,Mh),e(U,Go),T(zs,Go,null),e(Go,Ch),T(Lo,Go,null),f(o,cd,g),f(o,Zt,g),e(Zt,No),e(No,Sr),T(Fs,Sr,null),e(Zt,jh),e(Zt,Or),e(Or,Sh),f(o,ud,g),f(o,B,g),T(qs,B,null),e(B,Oh),e(B,Es),e(Es,Ah),e(Es,ca),e(ca,Ih),e(Es,Gh),e(B,Lh),e(B,Ms),e(Ms,Nh),e(Ms,Cs),e(Cs,Dh),e(Ms,Uh),e(B,Bh),e(B,Ar),e(Ar,Wh),e(B,Kh),e(B,ut),e(ut,Ir),e(Ir,js),e(js,Rh),e(ut,Hh),e(ut,Gr),e(Gr,Ss),e(Ss,Vh),e(ut,Qh),e(ut,Lr),e(Lr,Os),e(Os,Jh),e(ut,Xh),e(ut,Nr),e(Nr,As),e(As,Zh),e(B,Yh),e(B,C),T(Is,C,null),e(C,em),e(C,Yt),e(Yt,tm),e(Yt,Dr),e(Dr,om),e(Yt,nm),e(Yt,Ur),e(Ur,sm),e(Yt,am),e(C,rm),T(Do,C,null),e(C,im),e(C,Br),e(Br,dm),e(C,lm),e(C,Wr),e(Wr,Kr),e(Kr,Rr),e(Rr,Hr),e(Hr,cm),e(C,um),e(C,Vr),e(Vr,Qr),e(Qr,Jr),e(Jr,Xr),e(Xr,pm),e(C,hm),e(C,Zr),e(Zr,Yr),e(Yr,ei),e(ei,ti),e(ti,mm),e(C,fm),e(C,oi),e(oi,ni),e(ni,Gs),e(Gs,Uo),e(Uo,Bo),e(Bo,si),T(Ls,si,null),e(Uo,gm),e(Uo,ai),e(ai,_m),e(Gs,km),e(Gs,ri),e(ri,vm),e(C,bm),e(C,ii),e(ii,ym),e(C,Tm),e(C,di),e(di,li),e(li,ci),e(ci,ui),e(ui,wm),e(C,Pm),e(C,pi),e(pi,hi),e(hi,mi),e(mi,fi),e(fi,$m),e(C,xm),e(C,gi),e(gi,_i),e(_i,ki),e(ki,vi),e(vi,zm),e(C,Fm),e(C,bi),e(bi,yi),e(yi,Ti),e(Ti,wi),e(wi,qm),e(B,Em),e(B,Wo),T(Ns,Wo,null),e(Wo,Mm),T(Ko,Wo,null),e(B,Cm),e(B,Ro),T(Ds,Ro,null),e(Ro,jm),T(Ho,Ro,null),pd=!0},p(o,[g]){const Us={};g&2&&(Us.$$scope={dirty:g,ctx:o}),io.$set(Us);const Pi={};g&2&&(Pi.$$scope={dirty:g,ctx:o}),_o.$set(Pi);const $i={};g&2&&($i.$$scope={dirty:g,ctx:o}),ko.$set($i);const xi={};g&2&&(xi.$$scope={dirty:g,ctx:o}),bo.$set(xi);const Vo={};g&2&&(Vo.$$scope={dirty:g,ctx:o}),yo.$set(Vo);const zi={};g&2&&(zi.$$scope={dirty:g,ctx:o}),Po.$set(zi);const Fi={};g&2&&(Fi.$$scope={dirty:g,ctx:o}),xo.$set(Fi);const Bs={};g&2&&(Bs.$$scope={dirty:g,ctx:o}),zo.$set(Bs);const qi={};g&2&&(qi.$$scope={dirty:g,ctx:o}),Fo.$set(qi);const Ei={};g&2&&(Ei.$$scope={dirty:g,ctx:o}),Eo.$set(Ei);const Mi={};g&2&&(Mi.$$scope={dirty:g,ctx:o}),Mo.$set(Mi);const Ws={};g&2&&(Ws.$$scope={dirty:g,ctx:o}),Co.$set(Ws);const Ci={};g&2&&(Ci.$$scope={dirty:g,ctx:o}),So.$set(Ci);const ji={};g&2&&(ji.$$scope={dirty:g,ctx:o}),Oo.$set(ji);const Ks={};g&2&&(Ks.$$scope={dirty:g,ctx:o}),Io.$set(Ks);const Si={};g&2&&(Si.$$scope={dirty:g,ctx:o}),Lo.$set(Si);const Oi={};g&2&&(Oi.$$scope={dirty:g,ctx:o}),Do.$set(Oi);const eo={};g&2&&(eo.$$scope={dirty:g,ctx:o}),Ko.$set(eo);const Ai={};g&2&&(Ai.$$scope={dirty:g,ctx:o}),Ho.$set(Ai)},i(o){pd||(w(d.$$.fragment,o),w(K.$$.fragment,o),w(ge.$$.fragment,o),w(un.$$.fragment,o),w(mn.$$.fragment,o),w(kn.$$.fragment,o),w(vn.$$.fragment,o),w(bn.$$.fragment,o),w(yn.$$.fragment,o),w(io.$$.fragment,o),w(wn.$$.fragment,o),w(Pn.$$.fragment,o),w(Fn.$$.fragment,o),w(Cn.$$.fragment,o),w(jn.$$.fragment,o),w(Sn.$$.fragment,o),w(On.$$.fragment,o),w(An.$$.fragment,o),w(Ln.$$.fragment,o),w(Un.$$.fragment,o),w(Bn.$$.fragment,o),w(Wn.$$.fragment,o),w(Vn.$$.fragment,o),w(_o.$$.fragment,o),w(ko.$$.fragment,o),w(Qn.$$.fragment,o),w(Jn.$$.fragment,o),w(es.$$.fragment,o),w(bo.$$.fragment,o),w(yo.$$.fragment,o),w(ts.$$.fragment,o),w(os.$$.fragment,o),w(ns.$$.fragment,o),w(Po.$$.fragment,o),w(ss.$$.fragment,o),w(as.$$.fragment,o),w(xo.$$.fragment,o),w(ls.$$.fragment,o),w(zo.$$.fragment,o),w(Fo.$$.fragment,o),w(cs.$$.fragment,o),w(us.$$.fragment,o),w(Eo.$$.fragment,o),w(fs.$$.fragment,o),w(Mo.$$.fragment,o),w(Co.$$.fragment,o),w(gs.$$.fragment,o),w(_s.$$.fragment,o),w($s.$$.fragment,o),w(So.$$.fragment,o),w(Oo.$$.fragment,o),w(xs.$$.fragment,o),w(Io.$$.fragment,o),w(zs.$$.fragment,o),w(Lo.$$.fragment,o),w(Fs.$$.fragment,o),w(qs.$$.fragment,o),w(Is.$$.fragment,o),w(Do.$$.fragment,o),w(Ls.$$.fragment,o),w(Ns.$$.fragment,o),w(Ko.$$.fragment,o),w(Ds.$$.fragment,o),w(Ho.$$.fragment,o),pd=!0)},o(o){P(d.$$.fragment,o),P(K.$$.fragment,o),P(ge.$$.fragment,o),P(un.$$.fragment,o),P(mn.$$.fragment,o),P(kn.$$.fragment,o),P(vn.$$.fragment,o),P(bn.$$.fragment,o),P(yn.$$.fragment,o),P(io.$$.fragment,o),P(wn.$$.fragment,o),P(Pn.$$.fragment,o),P(Fn.$$.fragment,o),P(Cn.$$.fragment,o),P(jn.$$.fragment,o),P(Sn.$$.fragment,o),P(On.$$.fragment,o),P(An.$$.fragment,o),P(Ln.$$.fragment,o),P(Un.$$.fragment,o),P(Bn.$$.fragment,o),P(Wn.$$.fragment,o),P(Vn.$$.fragment,o),P(_o.$$.fragment,o),P(ko.$$.fragment,o),P(Qn.$$.fragment,o),P(Jn.$$.fragment,o),P(es.$$.fragment,o),P(bo.$$.fragment,o),P(yo.$$.fragment,o),P(ts.$$.fragment,o),P(os.$$.fragment,o),P(ns.$$.fragment,o),P(Po.$$.fragment,o),P(ss.$$.fragment,o),P(as.$$.fragment,o),P(xo.$$.fragment,o),P(ls.$$.fragment,o),P(zo.$$.fragment,o),P(Fo.$$.fragment,o),P(cs.$$.fragment,o),P(us.$$.fragment,o),P(Eo.$$.fragment,o),P(fs.$$.fragment,o),P(Mo.$$.fragment,o),P(Co.$$.fragment,o),P(gs.$$.fragment,o),P(_s.$$.fragment,o),P($s.$$.fragment,o),P(So.$$.fragment,o),P(Oo.$$.fragment,o),P(xs.$$.fragment,o),P(Io.$$.fragment,o),P(zs.$$.fragment,o),P(Lo.$$.fragment,o),P(Fs.$$.fragment,o),P(qs.$$.fragment,o),P(Is.$$.fragment,o),P(Do.$$.fragment,o),P(Ls.$$.fragment,o),P(Ns.$$.fragment,o),P(Ko.$$.fragment,o),P(Ds.$$.fragment,o),P(Ho.$$.fragment,o),pd=!1},d(o){t(p),o&&t(v),o&&t(_),$(d),o&&t(Ge),o&&t(L),o&&t(Le),o&&t(N),$(K),o&&t(Ne),o&&t(te),o&&t(S),o&&t(A),o&&t(oe),o&&t(ne),o&&t(De),o&&t(G),o&&t(se),o&&t(J),$(ge),o&&t(x),o&&t(F),o&&t(mt),o&&t(W),o&&t(Li),o&&t(qt),$(un),o&&t(Ni),o&&t(ft),o&&t(Di),o&&t(Et),$(mn),o&&t(Ui),o&&t(Te),o&&t(Bi),o&&t(jt),$(kn),o&&t(Wi),$(vn,o),o&&t(Ki),o&&t(St),$(bn),o&&t(Ri),o&&t(Oe),$(yn),$(io),o&&t(Hi),o&&t(It),$(wn),o&&t(Vi),o&&t(co),o&&t(Qi),o&&t(H),$(Pn),$(Fn),$(Cn),$(jn),$(Sn),o&&t(Ji),o&&t(Gt),$(On),o&&t(Xi),o&&t(ve),$(An),$(Ln),$(Un),o&&t(Zi),o&&t(Nt),$(Bn),o&&t(Yi),o&&t(Ae),$(Wn),$(Vn),$(_o),$(ko),o&&t(ed),o&&t(Ut),$(Qn),o&&t(td),o&&t(Ie),$(Jn),$(es),$(bo),$(yo),o&&t(od),o&&t(Wt),$(ts),o&&t(nd),o&&t(Kt),$(os),$(ns),$(Po),o&&t(sd),o&&t(Rt),$(ss),o&&t(ad),o&&t(be),$(as),$(xo),$(ls),$(zo),$(Fo),o&&t(rd),o&&t(Vt),$(cs),o&&t(id),o&&t(ye),$(us),$(Eo),$(fs),$(Mo),$(Co),o&&t(dd),o&&t(Jt),$(gs),o&&t(ld),o&&t(U),$(_s),$($s),$(So),$(Oo),$(xs),$(Io),$(zs),$(Lo),o&&t(cd),o&&t(Zt),$(Fs),o&&t(ud),o&&t(B),$(qs),$(Is),$(Do),$(Ls),$(Ns),$(Ko),$(Ds),$(Ho)}}}const gk={local:"pegasus",sections:[{local:"overview",title:"Overview"},{local:"checkpoints",sections:[{local:"examples",title:"Examples"}],title:"Checkpoints"},{local:"implementation-notes",title:"Implementation Notes"},{local:"usage-example",title:"Usage Example"},{local:"transformers.PegasusConfig",title:"PegasusConfig"},{local:"transformers.PegasusTokenizer",title:"PegasusTokenizer"},{local:"transformers.PegasusTokenizerFast",title:"PegasusTokenizerFast"},{local:"transformers.PegasusModel",title:"PegasusModel"},{local:"transformers.PegasusForConditionalGeneration",title:"PegasusForConditionalGeneration"},{local:"transformers.PegasusForCausalLM",title:"PegasusForCausalLM"},{local:"transformers.TFPegasusModel",title:"TFPegasusModel"},{local:"transformers.TFPegasusForConditionalGeneration",title:"TFPegasusForConditionalGeneration"},{local:"transformers.FlaxPegasusModel",title:"FlaxPegasusModel"},{local:"transformers.FlaxPegasusForConditionalGeneration",title:"FlaxPegasusForConditionalGeneration"}],title:"Pegasus"};function _k(z){return Q_(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Pk extends K_{constructor(p){super();R_(this,p,_k,fk,H_,{})}}export{Pk as default,gk as metadata};
