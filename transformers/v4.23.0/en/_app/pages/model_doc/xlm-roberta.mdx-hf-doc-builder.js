...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ma=new A({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),fa=new Be({}),ga=new A({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L91"}}),Wa=new A({props:{name:"forward",anchor:"transformers.XLMRobertaForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),sr=new A({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),Ri=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),il=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),bl=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gw=c(),yi=s("p"),Yw=o("This model is also a Flax Linen "),Ti=s("a"),Zw=o("flax.linen.Module"),e2=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t2=c(),Op=s("p"),o2=o("Finally, this model supports inherent JAX features such as:"),n2=c(),co=s("ul"),Np=s("li"),wi=s("a"),s2=o("Just-In-Time (JIT) compilation"),a2=c(),Ip=s("li"),$i=s("a"),r2=o("Automatic Differentiation"),i2=c(),Dp=s("li"),Mi=s("a"),l2=o("Vectorization"),d2=c(),Sp=s("li"),Fi=s("a"),c2=o("Parallelization"),p2=c(),xi=s("p"),h2=o("This class overrides "),zd=s("a"),u2=o("FlaxRobertaForMaskedLM"),m2=o(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),f2=c(),Vt=s("div"),y(Ri.$$.fragment),g2=c(),rn=s("p"),_2=o("The "),Bp=s("code"),b2=o("FlaxRobertaPreTrainedModel"),k2=o(" forward method, overrides the "),Wp=s("code"),v2=o("__call__"),y2=o(" special method."),T2=c(),y(Ls.$$.fragment),w2=c(),y(Es.$$.fragment),Wu=c(),ln=s("h2"),zs=s("a"),Up=s("span"),y(Li.$$.fragment),$2=c(),Qp=s("span"),M2=o("FlaxXLMRobertaForSequenceClassification"),Uu=c(),Ze=s("div"),y(Ei.$$.fragment),F2=c(),Hp=s("p"),x2=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),R2=c(),zi=s("p"),L2=o("This model inherits from "),qd=s("a"),E2=o("FlaxPreTrainedModel"),z2=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),q2=c(),qi=s("p"),C2=o("This model is also a Flax Linen "),Ci=s("a"),j2=o("flax.linen.Module"),X2=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P2=c(),Kp=s("p"),A2=o("Finally, this model supports inherent JAX features such as:"),O2=c(),po=s("ul"),Vp=s("li"),ji=s("a"),N2=o("Just-In-Time (JIT) compilation"),I2=c(),Jp=s("li"),Xi=s("a"),D2=o("Automatic Differentiation"),S2=c(),Gp=s("li"),Pi=s("a"),B2=o("Vectorization"),W2=c(),Yp=s("li"),Ai=s("a"),U2=o("Parallelization"),Q2=c(),Oi=s("p"),H2=o("This class overrides "),Cd=s("a"),K2=o("FlaxRobertaForSequenceClassification"),V2=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),J2=c(),Jt=s("div"),y(Ni.$$.fragment),G2=c(),dn=s("p"),Y2=o("The "),Zp=s("code"),Z2=o("FlaxRobertaPreTrainedModel"),e$=o(" forward method, overrides the "),eh=s("code"),t$=o("__call__"),o$=o(" special method."),n$=c(),y(qs.$$.fragment),s$=c(),y(Cs.$$.fragment),Qu=c(),cn=s("h2"),js=s("a"),th=s("span"),y(Ii.$$.fragment),a$=c(),oh=s("span"),r$=o("FlaxXLMRobertaForMultipleChoice"),Hu=c(),et=s("div"),y(Di.$$.fragment),i$=c(),nh=s("p"),l$=o(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
documentation alongside usage examples.`),vm.forEach(t),yb=p(no),ht=a(no,"DIV",{class:!0});var Ct=r(ht);T(Ga.$$.fragment,Ct),Tb=p(Ct),Xo=a(Ct,"P",{});var Qd=r(Xo);wb=n(Qd,"The "),td=a(Qd,"A",{href:!0});var e0=r(td);$b=n(e0,"RobertaForSequenceClassification"),e0.forEach(t),Mb=n(Qd," forward method, overrides the "),Ic=a(Qd,"CODE",{});var t0=r(Ic);Fb=n(t0,"__call__"),t0.forEach(t),xb=n(Qd," special method."),Qd.forEach(t),Rb=p(Ct),T(Xn.$$.fragment,Ct),Lb=p(Ct),T(Pn.$$.fragment,Ct),Eb=p(Ct),T(An.$$.fragment,Ct),zb=p(Ct),T(On.$$.fragment,Ct),qb=p(Ct),T(Nn.$$.fragment,Ct),Ct.forEach(t),no.forEach(t),Tu=p(i),Po=a(i,"H2",{class:!0});var ym=r(Po);In=a(ym,"A",{id:!0,class:!0,href:!0});var o0=r(In);Dc=a(o0,"SPAN",{});var n0=r(Dc);T(Ya.$$.fragment,n0),n0.forEach(t),o0.forEach(t),Cb=p(ym),Sc=a(ym,"SPAN",{});var s0=r(Sc);jb=n(s0,"XLMRobertaForMultipleChoice"),s0.forEach(t),ym.forEach(t),wu=p(i),_t=a(i,"DIV",{class:!0});var so=r(_t);T(Za.$$.fragment,so),Xb=p(so),Bc=a(so,"P",{});var a0=r(Bc);Pb=n(a0,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),a0.forEach(t),Ab=p(so),er=a(so,"P",{});var Tm=r(er);Ob=n(Tm,"This model inherits from "),od=a(Tm,"A",{href:!0});var r0=r(od);Nb=n(r0,"PreTrainedModel"),r0.forEach(t),Ib=n(Tm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tm.forEach(t),Db=p(so),tr=a(so,"P",{});var wm=r(tr);Sb=n(wm,"This model is also a PyTorch "),or=a(wm,"A",{href:!0,rel:!0});var i0=r(or);Bb=n(i0,"torch.nn.Module"),i0.forEach(t),Wb=n(wm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wm.forEach(t),Ub=p(so),nr=a(so,"P",{});var $m=r(nr);Qb=n($m,"This class overrides "),nd=a($m,"A",{href:!0});var l0=r(nd);Hb=n(l0,"RobertaForMultipleChoice"),l0.forEach(t),Kb=n($m,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),$m.forEach(t),Vb=p(so),Ut=a(so,"DIV",{class:!0});var Us=r(Ut);T(sr.$$.fragment,Us),Jb=p(Us),Ao=a(Us,"P",{});var Hd=r(Ao);Gb=n(Hd,"The "),sd=a(Hd,"A",{href:!0});var d0=r(sd);Yb=n(d0,"RobertaForMultipleChoice"),d0.forEach(t),Zb=n(Hd," forward method, overrides the "),Wc=a(Hd,"CODE",{});var c0=r(Wc);ek=n(c0,"__call__"),c0.forEach(t),tk=n(Hd," special method."),Hd.forEach(t),ok=p(Us),T(Dn.$$.fragment,Us),nk=p(Us),T(Sn.$$.fragment,Us),Us.forEach(t),so.forEach(t),$u=p(i),Oo=a(i,"H2",{class:!0});var Mm=r(Oo);Bn=a(Mm,"A",{id:!0,class:!0,href:!0});var p0=r(Bn);Uc=a(p0,"SPAN",{});var h0=r(Uc);T(ar.$$.fragment,h0),h0.forEach(t),p0.forEach(t),sk=p(Mm),Qc=a(Mm,"SPAN",{});var u0=r(Qc);ak=n(u0,"XLMRobertaForTokenClassification"),u0.forEach(t),Mm.forEach(t),Mu=p(i),bt=a(i,"DIV",{class:!0});var ao=r(bt);T(rr.$$.fragment,ao),rk=p(ao),Hc=a(ao,"P",{});var m0=r(Hc);ik=n(m0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),m0.forEach(t),lk=p(ao),ir=a(ao,"P",{});var Fm=r(ir);dk=n(Fm,"This model inherits from "),ad=a(Fm,"A",{href:!0});var f0=r(ad);ck=n(f0,"PreTrainedModel"),f0.forEach(t),pk=n(Fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fm.forEach(t),hk=p(ao),lr=a(ao,"P",{});var xm=r(lr);uk=n(xm,"This model is also a PyTorch "),dr=a(xm,"A",{href:!0,rel:!0});var g0=r(dr);mk=n(g0,"torch.nn.Module"),g0.forEach(t),fk=n(xm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xm.forEach(t),gk=p(ao),cr=a(ao,"P",{});var Rm=r(cr);_k=n(Rm,"This class overrides "),rd=a(Rm,"A",{href:!0});var _0=r(rd);bk=n(_0,"RobertaForTokenClassification"),_0.forEach(t),kk=n(Rm,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Rm.forEach(t),vk=p(ao),xt=a(ao,"DIV",{class:!0});var yo=r(xt);T(pr.$$.fragment,yo),yk=p(yo),No=a(yo,"P",{});var Kd=r(No);Tk=n(Kd,"The "),id=a(Kd,"A",{href:!0});var b0=r(id);wk=n(b0,"RobertaForTokenClassification"),b0.forEach(t),$k=n(Kd," forward method, overrides the "),Kc=a(Kd,"CODE",{});var k0=r(Kc);Mk=n(k0,"__call__"),k0.forEach(t),Fk=n(Kd," special method."),Kd.forEach(t),xk=p(yo),T(Wn.$$.fragment,yo),Rk=p(yo),T(Un.$$.fragment,yo),Lk=p(yo),T(Qn.$$.fragment,yo),yo.forEach(t),ao.forEach(t),Fu=p(i),Io=a(i,"H2",{class:!0});var Lm=r(Io);Hn=a(Lm,"A",{id:!0,class:!0,href:!0});var v0=r(Hn);Vc=a(v0,"SPAN",{});var y0=r(Vc);T(hr.$$.fragment,y0),y0.forEach(t),v0.forEach(t),Ek=p(Lm),Jc=a(Lm,"SPAN",{});var T0=r(Jc);zk=n(T0,"XLMRobertaForQuestionAnswering"),T0.forEach(t),Lm.forEach(t),xu=p(i),kt=a(i,"DIV",{class:!0});var ro=r(kt);T(ur.$$.fragment,ro),qk=p(ro),Do=a(ro,"P",{});var Vd=r(Do);Ck=n(Vd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Gc=a(Vd,"CODE",{});var w0=r(Gc);jk=n(w0,"span start logits"),w0.forEach(t),Xk=n(Vd," and "),Yc=a(Vd,"CODE",{});var $0=r(Yc);Pk=n($0,"span end logits"),$0.forEach(t),Ak=n(Vd,")."),Vd.forEach(t),Ok=p(ro),mr=a(ro,"P",{});var Em=r(mr);Nk=n(Em,"This model inherits from "),ld=a(Em,"A",{href:!0});var M0=r(ld);Ik=n(M0,"PreTrainedModel"),M0.forEach(t),Dk=n(Em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Em.forEach(t),Sk=p(ro),fr=a(ro,"P",{});var zm=r(fr);Bk=n(zm,"This model is also a PyTorch "),gr=a(zm,"A",{href:!0,rel:!0});var F0=r(gr);Wk=n(F0,"torch.nn.Module"),F0.forEach(t),Uk=n(zm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zm.forEach(t),Qk=p(ro),_r=a(ro,"P",{});var qm=r(_r);Hk=n(qm,"This class overrides "),dd=a(qm,"A",{href:!0});var x0=r(dd);Kk=n(x0,"RobertaForQuestionAnswering"),x0.forEach(t),Vk=n(qm,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),qm.forEach(t),Jk=p(ro),Rt=a(ro,"DIV",{class:!0});var To=r(Rt);T(br.$$.fragment,To),Gk=p(To),So=a(To,"P",{});var Jd=r(So);Yk=n(Jd,"The "),cd=a(Jd,"A",{href:!0});var R0=r(cd);Zk=n(R0,"RobertaForQuestionAnswering"),R0.forEach(t),ev=n(Jd," forward method, overrides the "),Zc=a(Jd,"CODE",{});var L0=r(Zc);tv=n(L0,"__call__"),L0.forEach(t),ov=n(Jd," special method."),Jd.forEach(t),nv=p(To),T(Kn.$$.fragment,To),sv=p(To),T(Vn.$$.fragment,To),av=p(To),T(Jn.$$.fragment,To),To.forEach(t),ro.forEach(t),Ru=p(i),Bo=a(i,"H2",{class:!0});var Cm=r(Bo);Gn=a(Cm,"A",{id:!0,class:!0,href:!0});var E0=r(Gn);ep=a(E0,"SPAN",{});var z0=r(ep);T(kr.$$.fragment,z0),z0.forEach(t),E0.forEach(t),rv=p(Cm),tp=a(Cm,"SPAN",{});var q0=r(tp);iv=n(q0,"TFXLMRobertaModel"),q0.forEach(t),Cm.forEach(t),Lu=p(i),st=a(i,"DIV",{class:!0});var jt=r(st);T(vr.$$.fragment,jt),lv=p(jt),op=a(jt,"P",{});var C0=r(op);dv=n(C0,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),C0.forEach(t),cv=p(jt),yr=a(jt,"P",{});var jm=r(yr);pv=n(jm,"This model inherits from "),pd=a(jm,"A",{href:!0});var j0=r(pd);hv=n(j0,"TFPreTrainedModel"),j0.forEach(t),uv=n(jm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jm.forEach(t),mv=p(jt),Tr=a(jt,"P",{});var Xm=r(Tr);fv=n(Xm,"This model is also a "),wr=a(Xm,"A",{href:!0,rel:!0});var X0=r(wr);gv=n(X0,"tf.keras.Model"),X0.forEach(t),_v=n(Xm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xm.forEach(t),bv=p(jt),T(Yn.$$.fragment,jt),kv=p(jt),$r=a(jt,"P",{});var Pm=r($r);vv=n(Pm,"This class overrides "),hd=a(Pm,"A",{href:!0});var P0=r(hd);yv=n(P0,"TFRobertaModel"),P0.forEach(t),Tv=n(Pm,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Pm.forEach(t),wv=p(jt),Qt=a(jt,"DIV",{class:!0});var Qs=r(Qt);T(Mr.$$.fragment,Qs),$v=p(Qs),Wo=a(Qs,"P",{});var Gd=r(Wo);Mv=n(Gd,"The "),ud=a(Gd,"A",{href:!0});var A0=r(ud);Fv=n(A0,"TFRobertaModel"),A0.forEach(t),xv=n(Gd," forward method, overrides the "),np=a(Gd,"CODE",{});var O0=r(np);Rv=n(O0,"__call__"),O0.forEach(t),Lv=n(Gd," special method."),Gd.forEach(t),Ev=p(Qs),T(Zn.$$.fragment,Qs),zv=p(Qs),T(es.$$.fragment,Qs),Qs.forEach(t),jt.forEach(t),Eu=p(i),Uo=a(i,"H2",{class:!0});var Am=r(Uo);ts=a(Am,"A",{id:!0,class:!0,href:!0});var N0=r(ts);sp=a(N0,"SPAN",{});var I0=r(sp);T(Fr.$$.fragment,I0),I0.forEach(t),N0.forEach(t),qv=p(Am),ap=a(Am,"SPAN",{});var D0=r(ap);Cv=n(D0,"TFXLMRobertaForMaskedLM"),D0.forEach(t),Am.forEach(t),zu=p(i),at=a(i,"DIV",{class:!0});var Xt=r(at);T(xr.$$.fragment,Xt),jv=p(Xt),Rr=a(Xt,"P",{});var Om=r(Rr);Xv=n(Om,"XLM-RoBERTa Model with a "),rp=a(Om,"CODE",{});var S0=r(rp);Pv=n(S0,"language modeling"),S0.forEach(t),Av=n(Om," head on top."),Om.forEach(t),Ov=p(Xt),Lr=a(Xt,"P",{});var Nm=r(Lr);Nv=n(Nm,"This model inherits from "),md=a(Nm,"A",{href:!0});var B0=r(md);Iv=n(B0,"TFPreTrainedModel"),B0.forEach(t),Dv=n(Nm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nm.forEach(t),Sv=p(Xt),Er=a(Xt,"P",{});var Im=r(Er);Bv=n(Im,"This model is also a "),zr=a(Im,"A",{href:!0,rel:!0});var W0=r(zr);Wv=n(W0,"tf.keras.Model"),W0.forEach(t),Uv=n(Im,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Im.forEach(t),Qv=p(Xt),T(os.$$.fragment,Xt),Hv=p(Xt),qr=a(Xt,"P",{});var Dm=r(qr);Kv=n(Dm,"This class overrides "),fd=a(Dm,"A",{href:!0});var U0=r(fd);Vv=n(U0,"TFRobertaForMaskedLM"),U0.forEach(t),Jv=n(Dm,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Dm.forEach(t),Gv=p(Xt),Lt=a(Xt,"DIV",{class:!0});var wo=r(Lt);T(Cr.$$.fragment,wo),Yv=p(wo),Qo=a(wo,"P",{});var Yd=r(Qo);Zv=n(Yd,"The "),gd=a(Yd,"A",{href:!0});var Q0=r(gd);ey=n(Q0,"TFRobertaForMaskedLM"),Q0.forEach(t),ty=n(Yd," forward method, overrides the "),ip=a(Yd,"CODE",{});var H0=r(ip);oy=n(H0,"__call__"),H0.forEach(t),ny=n(Yd," special method."),Yd.forEach(t),sy=p(wo),T(ns.$$.fragment,wo),ay=p(wo),T(ss.$$.fragment,wo),ry=p(wo),T(as.$$.fragment,wo),wo.forEach(t),Xt.forEach(t),qu=p(i),Ho=a(i,"H2",{class:!0});var Sm=r(Ho);rs=a(Sm,"A",{id:!0,class:!0,href:!0});var K0=r(rs);lp=a(K0,"SPAN",{});var V0=r(lp);T(jr.$$.fragment,V0),V0.forEach(t),K0.forEach(t),iy=p(Sm),dp=a(Sm,"SPAN",{});var J0=r(dp);ly=n(J0,"TFXLMRobertaForSequenceClassification"),J0.forEach(t),Sm.forEach(t),Cu=p(i),rt=a(i,"DIV",{class:!0});var Pt=r(rt);T(Xr.$$.fragment,Pt),dy=p(Pt),cp=a(Pt,"P",{});var G0=r(cp);cy=n(G0,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),G0.forEach(t),py=p(Pt),Pr=a(Pt,"P",{});var Bm=r(Pr);hy=n(Bm,"This model inherits from "),_d=a(Bm,"A",{href:!0});var Y0=r(_d);uy=n(Y0,"TFPreTrainedModel"),Y0.forEach(t),my=n(Bm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bm.forEach(t),fy=p(Pt),Ar=a(Pt,"P",{});var Wm=r(Ar);gy=n(Wm,"This model is also a "),Or=a(Wm,"A",{href:!0,rel:!0});var Z0=r(Or);_y=n(Z0,"tf.keras.Model"),Z0.forEach(t),by=n(Wm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wm.forEach(t),ky=p(Pt),T(is.$$.fragment,Pt),vy=p(Pt),Nr=a(Pt,"P",{});var Um=r(Nr);yy=n(Um,"This class overrides "),bd=a(Um,"A",{href:!0});var eF=r(bd);Ty=n(eF,"TFRobertaForSequenceClassification"),eF.forEach(t),wy=n(Um,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Um.forEach(t),$y=p(Pt),Et=a(Pt,"DIV",{class:!0});var $o=r(Et);T(Ir.$$.fragment,$o),My=p($o),Ko=a($o,"P",{});var Zd=r(Ko);Fy=n(Zd,"The "),kd=a(Zd,"A",{href:!0});var tF=r(kd);xy=n(tF,"TFRobertaForSequenceClassification"),tF.forEach(t),Ry=n(Zd," forward method, overrides the "),pp=a(Zd,"CODE",{});var oF=r(pp);Ly=n(oF,"__call__"),oF.forEach(t),Ey=n(Zd," special method."),Zd.forEach(t),zy=p($o),T(ls.$$.fragment,$o),qy=p($o),T(ds.$$.fragment,$o),Cy=p($o),T(cs.$$.fragment,$o),$o.forEach(t),Pt.forEach(t),ju=p(i),Vo=a(i,"H2",{class:!0});var Qm=r(Vo);ps=a(Qm,"A",{id:!0,class:!0,href:!0});var nF=r(ps);hp=a(nF,"SPAN",{});var sF=r(hp);T(Dr.$$.fragment,sF),sF.forEach(t),nF.forEach(t),jy=p(Qm),up=a(Qm,"SPAN",{});var aF=r(up);Xy=n(aF,"TFXLMRobertaForMultipleChoice"),aF.forEach(t),Qm.forEach(t),Xu=p(i),it=a(i,"DIV",{class:!0});var At=r(it);T(Sr.$$.fragment,At),Py=p(At),mp=a(At,"P",{});var rF=r(mp);Ay=n(rF,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),rF.forEach(t),Oy=p(At),Br=a(At,"P",{});var Hm=r(Br);Ny=n(Hm,"This model inherits from "),vd=a(Hm,"A",{href:!0});var iF=r(vd);Iy=n(iF,"TFPreTrainedModel"),iF.forEach(t),Dy=n(Hm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hm.forEach(t),Sy=p(At),Wr=a(At,"P",{});var Km=r(Wr);By=n(Km,"This model is also a "),Ur=a(Km,"A",{href:!0,rel:!0});var lF=r(Ur);Wy=n(lF,"tf.keras.Model"),lF.forEach(t),Uy=n(Km,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Km.forEach(t),Qy=p(At),T(hs.$$.fragment,At),Hy=p(At),Qr=a(At,"P",{});var Vm=r(Qr);Ky=n(Vm,"This class overrides "),yd=a(Vm,"A",{href:!0});var dF=r(yd);Vy=n(dF,"TFRobertaForMultipleChoice"),dF.forEach(t),Jy=n(Vm,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Vm.forEach(t),Gy=p(At),Ht=a(At,"DIV",{class:!0});var Hs=r(Ht);T(Hr.$$.fragment,Hs),Yy=p(Hs),Jo=a(Hs,"P",{});var ec=r(Jo);Zy=n(ec,"The "),Td=a(ec,"A",{href:!0});var cF=r(Td);eT=n(cF,"TFRobertaForMultipleChoice"),cF.forEach(t),tT=n(ec," forward method, overrides the "),fp=a(ec,"CODE",{});var pF=r(fp);oT=n(pF,"__call__"),pF.forEach(t),nT=n(ec," special method."),ec.forEach(t),sT=p(Hs),T(us.$$.fragment,Hs),aT=p(Hs),T(ms.$$.fragment,Hs),Hs.forEach(t),At.forEach(t),Pu=p(i),Go=a(i,"H2",{class:!0});var Jm=r(Go);fs=a(Jm,"A",{id:!0,class:!0,href:!0});var hF=r(fs);gp=a(hF,"SPAN",{});var uF=r(gp);T(Kr.$$.fragment,uF),uF.forEach(t),hF.forEach(t),rT=p(Jm),_p=a(Jm,"SPAN",{});var mF=r(_p);iT=n(mF,"TFXLMRobertaForTokenClassification"),mF.forEach(t),Jm.forEach(t),Au=p(i),lt=a(i,"DIV",{class:!0});var Ot=r(lt);T(Vr.$$.fragment,Ot),lT=p(Ot),bp=a(Ot,"P",{});var fF=r(bp);dT=n(fF,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),fF.forEach(t),cT=p(Ot),Jr=a(Ot,"P",{});var Gm=r(Jr);pT=n(Gm,"This model inherits from "),wd=a(Gm,"A",{href:!0});var gF=r(wd);hT=n(gF,"TFPreTrainedModel"),gF.forEach(t),uT=n(Gm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gm.forEach(t),mT=p(Ot),Gr=a(Ot,"P",{});var Ym=r(Gr);fT=n(Ym,"This model is also a "),Yr=a(Ym,"A",{href:!0,rel:!0});var _F=r(Yr);gT=n(_F,"tf.keras.Model"),_F.forEach(t),_T=n(Ym,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ym.forEach(t),bT=p(Ot),T(gs.$$.fragment,Ot),kT=p(Ot),Zr=a(Ot,"P",{});var Zm=r(Zr);vT=n(Zm,"This class overrides "),$d=a(Zm,"A",{href:!0});var bF=r($d);yT=n(bF,"TFRobertaForTokenClassification"),bF.forEach(t),TT=n(Zm,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Zm.forEach(t),wT=p(Ot),zt=a(Ot,"DIV",{class:!0});var Mo=r(zt);T(ei.$$.fragment,Mo),$T=p(Mo),Yo=a(Mo,"P",{});var tc=r(Yo);MT=n(tc,"The "),Md=a(tc,"A",{href:!0});var kF=r(Md);FT=n(kF,"TFRobertaForTokenClassification"),kF.forEach(t),xT=n(tc," forward method, overrides the "),kp=a(tc,"CODE",{});var vF=r(kp);RT=n(vF,"__call__"),vF.forEach(t),LT=n(tc," special method."),tc.forEach(t),ET=p(Mo),T(_s.$$.fragment,Mo),zT=p(Mo),T(bs.$$.fragment,Mo),qT=p(Mo),T(ks.$$.fragment,Mo),Mo.forEach(t),Ot.forEach(t),Ou=p(i),Zo=a(i,"H2",{class:!0});var ef=r(Zo);vs=a(ef,"A",{id:!0,class:!0,href:!0});var yF=r(vs);vp=a(yF,"SPAN",{});var TF=r(vp);T(ti.$$.fragment,TF),TF.forEach(t),yF.forEach(t),CT=p(ef),yp=a(ef,"SPAN",{});var wF=r(yp);jT=n(wF,"TFXLMRobertaForQuestionAnswering"),wF.forEach(t),ef.forEach(t),Nu=p(i),dt=a(i,"DIV",{class:!0});var Nt=r(dt);T(oi.$$.fragment,Nt),XT=p(Nt),en=a(Nt,"P",{});var oc=r(en);PT=n(oc,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Tp=a(oc,"CODE",{});var $F=r(Tp);AT=n($F,"span start logits"),$F.forEach(t),OT=n(oc," and "),wp=a(oc,"CODE",{});var MF=r(wp);NT=n(MF,"span end logits"),MF.forEach(t),IT=n(oc,")."),oc.forEach(t),DT=p(Nt),ni=a(Nt,"P",{});var tf=r(ni);ST=n(tf,"This model inherits from "),Fd=a(tf,"A",{href:!0});var FF=r(Fd);BT=n(FF,"TFPreTrainedModel"),FF.forEach(t),WT=n(tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tf.forEach(t),UT=p(Nt),si=a(Nt,"P",{});var of=r(si);QT=n(of,"This model is also a "),ai=a(of,"A",{href:!0,rel:!0});var xF=r(ai);HT=n(xF,"tf.keras.Model"),xF.forEach(t),KT=n(of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),of.forEach(t),VT=p(Nt),T(ys.$$.fragment,Nt),JT=p(Nt),ri=a(Nt,"P",{});var nf=r(ri);GT=n(nf,"This class overrides "),$p=a(nf,"CODE",{});var RF=r($p);YT=n(RF,"TFRobertaForQuestionAnsweringSimple"),RF.forEach(t),ZT=n(nf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),nf.forEach(t),ew=p(Nt),qt=a(Nt,"DIV",{class:!0});var Fo=r(qt);T(ii.$$.fragment,Fo),tw=p(Fo),tn=a(Fo,"P",{});var nc=r(tn);ow=n(nc,"The "),xd=a(nc,"A",{href:!0});var LF=r(xd);nw=n(LF,"TFRobertaForQuestionAnswering"),LF.forEach(t),sw=n(nc," forward method, overrides the "),Mp=a(nc,"CODE",{});var EF=r(Mp);aw=n(EF,"__call__"),EF.forEach(t),rw=n(nc," special method."),nc.forEach(t),iw=p(Fo),T(Ts.$$.fragment,Fo),lw=p(Fo),T(ws.$$.fragment,Fo),dw=p(Fo),T($s.$$.fragment,Fo),Fo.forEach(t),Nt.forEach(t),Iu=p(i),on=a(i,"H2",{class:!0});var sf=r(on);Ms=a(sf,"A",{id:!0,class:!0,href:!0});var zF=r(Ms);Fp=a(zF,"SPAN",{});var qF=r(Fp);T(li.$$.fragment,qF),qF.forEach(t),zF.forEach(t),cw=p(sf),xp=a(sf,"SPAN",{});var CF=r(xp);pw=n(CF,"FlaxXLMRobertaModel"),CF.forEach(t),sf.forEach(t),Du=p(i),ct=a(i,"DIV",{class:!0});var It=r(ct);T(di.$$.fragment,It),hw=p(It),ci=a(It,"P",{});var af=r(ci);uw=n(af,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Rd=a(af,"A",{href:!0});var jF=r(Rd);mw=n(jF,"FlaxPreTrainedModel"),jF.forEach(t),fw=n(af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),af.forEach(t),gw=p(It),pi=a(It,"P",{});var rf=r(pi);_w=n(rf,"This model is also a Flax Linen "),hi=a(rf,"A",{href:!0,rel:!0});var XF=r(hi);bw=n(XF,"flax.linen.Module"),XF.forEach(t),kw=n(rf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),rf.forEach(t),vw=p(It),Rp=a(It,"P",{});var PF=r(Rp);yw=n(PF,"Finally, this model supports inherent JAX features such as:"),PF.forEach(t),Tw=p(It),lo=a(It,"UL",{});var Ks=r(lo);Lp=a(Ks,"LI",{});var AF=r(Lp);ui=a(AF,"A",{href:!0,rel:!0});var OF=r(ui);ww=n(OF,"Just-In-Time (JIT) compilation"),OF.forEach(t),AF.forEach(t),$w=p(Ks),Ep=a(Ks,"LI",{});var NF=r(Ep);mi=a(NF,"A",{href:!0,rel:!0});var IF=r(mi);Mw=n(IF,"Automatic Differentiation"),IF.forEach(t),NF.forEach(t),Fw=p(Ks),zp=a(Ks,"LI",{});var DF=r(zp);fi=a(DF,"A",{href:!0,rel:!0});var SF=r(fi);xw=n(SF,"Vectorization"),SF.forEach(t),DF.forEach(t),Rw=p(Ks),qp=a(Ks,"LI",{});var BF=r(qp);gi=a(BF,"A",{href:!0,rel:!0});var WF=r(gi);Lw=n(WF,"Parallelization"),WF.forEach(t),BF.forEach(t),Ks.forEach(t),Ew=p(It),_i=a(It,"P",{});var lf=r(_i);zw=n(lf,"This class overrides "),Ld=a(lf,"A",{href:!0});var UF=r(Ld);qw=n(UF,"FlaxRobertaModel"),UF.forEach(t),Cw=n(lf,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),lf.forEach(t),jw=p(It),Kt=a(It,"DIV",{class:!0});var Vs=r(Kt);T(bi.$$.fragment,Vs),Xw=p(Vs),nn=a(Vs,"P",{});var sc=r(nn);Pw=n(sc,"The "),Cp=a(sc,"CODE",{});var QF=r(Cp);Aw=n(QF,"FlaxRobertaPreTrainedModel"),QF.forEach(t),Ow=n(sc," forward method, overrides the "),jp=a(sc,"CODE",{});var HF=r(jp);Nw=n(HF,"__call__"),HF.forEach(t),Iw=n(sc," special method."),sc.forEach(t),Dw=p(Vs),T(Fs.$$.fragment,Vs),Sw=p(Vs),T(xs.$$.fragment,Vs),Vs.forEach(t),It.forEach(t),Su=p(i),sn=a(i,"H2",{class:!0});var df=r(sn);Rs=a(df,"A",{id:!0,class:!0,href:!0});var KF=r(Rs);Xp=a(KF,"SPAN",{});var VF=r(Xp);T(ki.$$.fragment,VF),VF.forEach(t),KF.forEach(t),Bw=p(df),Pp=a(df,"SPAN",{});var JF=r(Pp);Ww=n(JF,"FlaxXLMRobertaForMaskedLM"),JF.forEach(t),df.forEach(t),Bu=p(i),pt=a(i,"DIV",{class:!0});var Dt=r(pt);T(vi.$$.fragment,Dt),Uw=p(Dt),an=a(Dt,"P",{});var ac=r(an);Qw=n(ac,"XLM-RoBERTa Model with a "),Ap=a(ac,"CODE",{});var GF=r(Ap);Hw=n(GF,"language modeling"),GF.forEach(t),Kw=n(ac,` head on top.
This model inherits from `),Ed=a(ac,"A",{href:!0});var YF=r(Ed);Vw=n(YF,"FlaxPreTrainedModel"),YF.forEach(t),Jw=n(ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ac.forEach(t),Gw=p(Dt),yi=a(Dt,"P",{});var cf=r(yi);Yw=n(cf,"This model is also a Flax Linen "),Ti=a(cf,"A",{href:!0,rel:!0});var ZF=r(Ti);Zw=n(ZF,"flax.linen.Module"),ZF.forEach(t),e2=n(cf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cf.forEach(t),t2=p(Dt),Op=a(Dt,"P",{});var ex=r(Op);o2=n(ex,"Finally, this model supports inherent JAX features such as:"),ex.forEach(t),n2=p(Dt),co=a(Dt,"UL",{});var Js=r(co);Np=a(Js,"LI",{});var tx=r(Np);wi=a(tx,"A",{href:!0,rel:!0});var ox=r(wi);s2=n(ox,"Just-In-Time (JIT) compilation"),ox.forEach(t),tx.forEach(t),a2=p(Js),Ip=a(Js,"LI",{});var nx=r(Ip);$i=a(nx,"A",{href:!0,rel:!0});var sx=r($i);r2=n(sx,"Automatic Differentiation"),sx.forEach(t),nx.forEach(t),i2=p(Js),Dp=a(Js,"LI",{});var ax=r(Dp);Mi=a(ax,"A",{href:!0,rel:!0});var rx=r(Mi);l2=n(rx,"Vectorization"),rx.forEach(t),ax.forEach(t),d2=p(Js),Sp=a(Js,"LI",{});var ix=r(Sp);Fi=a(ix,"A",{href:!0,rel:!0});var lx=r(Fi);c2=n(lx,"Parallelization"),lx.forEach(t),ix.forEach(t),Js.forEach(t),p2=p(Dt),xi=a(Dt,"P",{});var pf=r(xi);h2=n(pf,"This class overrides "),zd=a(pf,"A",{href:!0});var dx=r(zd);u2=n(dx,"FlaxRobertaForMaskedLM"),dx.forEach(t),m2=n(pf,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),pf.forEach(t),f2=p(Dt),Vt=a(Dt,"DIV",{class:!0});var Gs=r(Vt);T(Ri.$$.fragment,Gs),g2=p(Gs),rn=a(Gs,"P",{});var rc=r(rn);_2=n(rc,"The "),Bp=a(rc,"CODE",{});var cx=r(Bp);b2=n(cx,"FlaxRobertaPreTrainedModel"),cx.forEach(t),k2=n(rc," forward method, overrides the "),Wp=a(rc,"CODE",{});var px=r(Wp);v2=n(px,"__call__"),px.forEach(t),y2=n(rc," special method."),rc.forEach(t),T2=p(Gs),T(Ls.$$.fragment,Gs),w2=p(Gs),T(Es.$$.fragment,Gs),Gs.forEach(t),Dt.forEach(t),Wu=p(i),ln=a(i,"H2",{class:!0});var hf=r(ln);zs=a(hf,"A",{id:!0,class:!0,href:!0});var hx=r(zs);Up=a(hx,"SPAN",{});var ux=r(Up);T(Li.$$.fragment,ux),ux.forEach(t),hx.forEach(t),$2=p(hf),Qp=a(hf,"SPAN",{});var mx=r(Qp);M2=n(mx,"FlaxXLMRobertaForSequenceClassification"),mx.forEach(t),hf.forEach(t),Uu=p(i),Ze=a(i,"DIV",{class:!0});var yt=r(Ze);T(Ei.$$.fragment,yt),F2=p(yt),Hp=a(yt,"P",{});var fx=r(Hp);x2=n(fx,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),fx.forEach(t),R2=p(yt),zi=a(yt,"P",{});var uf=r(zi);L2=n(uf,"This model inherits from "),qd=a(uf,"A",{href:!0});var gx=r(qd);E2=n(gx,"FlaxPreTrainedModel"),gx.forEach(t),z2=n(uf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),uf.forEach(t),q2=p(yt),qi=a(yt,"P",{});var mf=r(qi);C2=n(mf,"This model is also a Flax Linen "),Ci=a(mf,"A",{href:!0,rel:!0});var _x=r(Ci);j2=n(_x,"flax.linen.Module"),_x.forEach(t),X2=n(mf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),mf.forEach(t),P2=p(yt),Kp=a(yt,"P",{});var bx=r(Kp);A2=n(bx,"Finally, this model supports inherent JAX features such as:"),bx.forEach(t),O2=p(yt),po=a(yt,"UL",{});var Ys=r(po);Vp=a(Ys,"LI",{});var kx=r(Vp);ji=a(kx,"A",{href:!0,rel:!0});var vx=r(ji);N2=n(vx,"Just-In-Time (JIT) compilation"),vx.forEach(t),kx.forEach(t),I2=p(Ys),Jp=a(Ys,"LI",{});var yx=r(Jp);Xi=a(yx,"A",{href:!0,rel:!0});var Tx=r(Xi);D2=n(Tx,"Automatic Differentiation"),Tx.forEach(t),yx.forEach(t),S2=p(Ys),Gp=a(Ys,"LI",{});var wx=r(Gp);Pi=a(wx,"A",{href:!0,rel:!0});var $x=r(Pi);B2=n($x,"Vectorization"),$x.forEach(t),wx.forEach(t),W2=p(Ys),Yp=a(Ys,"LI",{});var Mx=r(Yp);Ai=a(Mx,"A",{href:!0,rel:!0});var Fx=r(Ai);U2=n(Fx,"Parallelization"),Fx.forEach(t),Mx.forEach(t),Ys.forEach(t),Q2=p(yt),Oi=a(yt,"P",{});var ff=r(Oi);H2=n(ff,"This class overrides "),Cd=a(ff,"A",{href:!0});var xx=r(Cd);K2=n(xx,"FlaxRobertaForSequenceClassification"),xx.forEach(t),V2=n(ff,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),ff.forEach(t),J2=p(yt),Jt=a(yt,"DIV",{class:!0});var Zs=r(Jt);T(Ni.$$.fragment,Zs),G2=p(Zs),dn=a(Zs,"P",{});var ic=r(dn);Y2=n(ic,"The "),Zp=a(ic,"CODE",{});var Rx=r(Zp);Z2=n(Rx,"FlaxRobertaPreTrainedModel"),Rx.forEach(t),e$=n(ic," forward method, overrides the "),eh=a(ic,"CODE",{});var Lx=r(eh);t$=n(Lx,"__call__"),Lx.forEach(t),o$=n(ic," special method."),ic.forEach(t),n$=p(Zs),T(qs.$$.fragment,Zs),s$=p(Zs),T(Cs.$$.fragment,Zs),Zs.forEach(t),yt.forEach(t),Qu=p(i),cn=a(i,"H2",{class:!0});var gf=r(cn);js=a(gf,"A",{id:!0,class:!0,href:!0});var Ex=r(js);th=a(Ex,"SPAN",{});var zx=r(th);T(Ii.$$.fragment,zx),zx.forEach(t),Ex.forEach(t),a$=p(gf),oh=a(gf,"SPAN",{});var qx=r(oh);r$=n(qx,"FlaxXLMRobertaForMultipleChoice"),qx.forEach(t),gf.forEach(t),Hu=p(i),et=a(i,"DIV",{class:!0});var Tt=r(et);T(Di.$$.fragment,Tt),i$=p(Tt),nh=a(Tt,"P",{});var Cx=r(nh);l$=n(Cx,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
