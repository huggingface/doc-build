...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){d=a("p"),g=n("Example:"),c=h(),y(f.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Example:"),p.forEach(t),c=u(l),w(f.$$.fragment,l)},m(l,p){k(l,d,p),e(d,g),k(l,c,p),T(f,l,p),_=!0},p:re,i(l){_||($(f.$$.fragment,l),_=!0)},o(l){F(f.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(c),x(f,l)}}}function VM(R){let d,g,c,f,_,l,p,E,le,Z,N,te,oe,M,we,K,Te,ge,B,$e,pe,J,Fe,_e,U,xe,be,H,Re,ke,ee,C,P,ve,Q,Ee,ye,I,he,Me,q,ze,V,je,ue,G,Ce,ne,D,fe,X,qe,se,L,Pe,A,Le,Ae,v,z,He,de,Xe,Je,j,Ye,Se,Ze,et,Be,S,Y,Ve,Oe,W,Qe,We,Ne,Ke,ce,Ge,vt,Oa,fg,co,mg,id,gg,_g,ld,bg,kg,Na,vg,yg,wg,Lo,Tg,dd,$g,Fg,cd,xg,Rg,Eg,Ao,Mg,pd,zg,jg,hd,Cg,qg,Pg,An,of,Oo,On,xc,Ia,Lg,Rc,Ag,nf,Ie,Da,Og,Ec,Ng,Ig,Mc,Dg,Sg,Nn,Bg,Sa,Wg,zc,Ug,Hg,Qg,In,Kg,Ba,Jg,ud,Vg,Gg,Xg,yo,Wa,Yg,jc,Zg,e_,Ua,fd,t_,Cc,o_,n_,md,s_,qc,a_,r_,Dn,Ha,i_,Qa,l_,Pc,d_,c_,p_,Sn,Ka,h_,Lc,u_,f_,gd,Ja,sf,No,Bn,Ac,Va,m_,Oc,g_,af,tt,Ga,__,Xa,b_,Nc,k_,v_,y_,Ic,w_,T_,Wn,$_,Ya,F_,Dc,x_,R_,E_,Un,M_,Za,z_,_d,j_,C_,q_,bd,er,rf,Io,Hn,Sc,tr,P_,Bc,L_,lf,ot,or,A_,Wc,O_,N_,nr,I_,kd,D_,S_,B_,sr,W_,ar,U_,H_,Q_,rr,K_,Uc,J_,V_,G_,pt,X_,Hc,Y_,Z_,Qc,eb,tb,Kc,ob,nb,Jc,sb,ab,Vc,rb,ib,Gc,lb,db,cb,Qn,pb,Xc,hb,ub,ir,fb,mb,Ut,lr,gb,Do,_b,vd,bb,kb,Yc,vb,yb,wb,Kn,Tb,Jn,df,So,Vn,Zc,dr,$b,ep,Fb,cf,yt,cr,xb,pr,Rb,tp,Eb,Mb,zb,hr,jb,yd,Cb,qb,Pb,ur,Lb,fr,Ab,Ob,Nb,Ht,mr,Ib,Bo,Db,wd,Sb,Bb,op,Wb,Ub,Hb,Gn,Qb,Xn,pf,Wo,Yn,np,gr,Kb,sp,Jb,hf,wt,_r,Vb,br,Gb,ap,Xb,Yb,Zb,kr,ek,Td,tk,ok,nk,vr,sk,yr,ak,rk,ik,Rt,wr,lk,Uo,dk,$d,ck,pk,rp,hk,uk,fk,Zn,mk,es,gk,ts,uf,Ho,os,ip,Tr,_k,lp,bk,ff,Tt,$r,kk,dp,vk,yk,Fr,wk,Fd,Tk,$k,Fk,xr,xk,Rr,Rk,Ek,Mk,ct,Er,zk,Qo,jk,xd,Ck,qk,cp,Pk,Lk,Ak,ns,Ok,ss,Nk,as,Ik,rs,Dk,is,mf,Ko,ls,pp,Mr,Sk,hp,Bk,gf,$t,zr,Wk,up,Uk,Hk,jr,Qk,Rd,Kk,Jk,Vk,Cr,Gk,qr,Xk,Yk,Zk,Qt,Pr,ev,Jo,tv,Ed,ov,nv,fp,sv,av,rv,ds,iv,cs,_f,Vo,ps,mp,Lr,lv,gp,dv,bf,Ft,Ar,cv,_p,pv,hv,Or,uv,Md,fv,mv,gv,Nr,_v,Ir,bv,kv,vv,Et,Dr,yv,Go,wv,zd,Tv,$v,bp,Fv,xv,Rv,hs,Ev,us,Mv,fs,kf,Xo,ms,kp,Sr,zv,vp,jv,vf,xt,Br,Cv,Yo,qv,yp,Pv,Lv,wp,Av,Ov,Nv,Wr,Iv,jd,Dv,Sv,Bv,Ur,Wv,Hr,Uv,Hv,Qv,Mt,Qr,Kv,Zo,Jv,Cd,Vv,Gv,Tp,Xv,Yv,Zv,gs,ey,_s,ty,bs,yf,en,ks,$p,Kr,oy,Fp,ny,wf,ht,Jr,sy,xp,ay,ry,Vr,iy,qd,ly,dy,cy,Gr,py,Xr,hy,uy,fy,vs,my,Kt,Yr,gy,tn,_y,Pd,by,ky,Rp,vy,yy,wy,ys,Ty,ws,Tf,on,Ts,Ep,Zr,$y,Mp,Fy,$f,nn,ei,xy,Jt,ti,Ry,sn,Ey,Ld,My,zy,zp,jy,Cy,qy,$s,Py,Fs,Ff,an,xs,jp,oi,Ly,Cp,Ay,xf,ut,ni,Oy,si,Ny,qp,Iy,Dy,Sy,ai,By,Ad,Wy,Uy,Hy,ri,Qy,ii,Ky,Jy,Vy,Rs,Gy,zt,li,Xy,rn,Yy,Od,Zy,ew,Pp,tw,ow,nw,Es,sw,Ms,aw,zs,Rf,ln,js,Lp,di,rw,Ap,iw,Ef,ft,ci,lw,Op,dw,cw,pi,pw,Nd,hw,uw,fw,hi,mw,ui,gw,_w,bw,Cs,kw,jt,fi,vw,dn,yw,Id,ww,Tw,Np,$w,Fw,xw,qs,Rw,Ps,Ew,Ls,Mf,cn,As,Ip,mi,Mw,Dp,zw,zf,mt,gi,jw,Sp,Cw,qw,_i,Pw,Dd,Lw,Aw,Ow,bi,Nw,ki,Iw,Dw,Sw,Os,Bw,Vt,vi,Ww,pn,Uw,Sd,Hw,Qw,Bp,Kw,Jw,Vw,Ns,Gw,Is,jf,hn,Ds,Wp,yi,Xw,Up,Yw,Cf,gt,wi,Zw,Hp,eT,tT,Ti,oT,Bd,nT,sT,aT,$i,rT,Fi,iT,lT,dT,Ss,cT,Ct,xi,pT,un,hT,Wd,uT,fT,Qp,mT,gT,_T,Bs,bT,Ws,kT,Us,qf,fn,Hs,Kp,Ri,vT,Jp,yT,Pf,_t,Ei,wT,mn,TT,Vp,$T,FT,Gp,xT,RT,ET,Mi,MT,Ud,zT,jT,CT,zi,qT,ji,PT,LT,AT,Qs,OT,qt,Ci,NT,gn,IT,Hd,DT,ST,Xp,BT,WT,UT,Ks,HT,Js,QT,Vs,Lf,_n,Gs,Yp,qi,KT,Zp,JT,Af,nt,Pi,VT,eh,GT,XT,Li,YT,Qd,ZT,e$,t$,Ai,o$,Oi,n$,s$,a$,th,r$,i$,po,oh,Ni,l$,d$,nh,Ii,c$,p$,sh,Di,h$,u$,ah,Si,f$,m$,Gt,Bi,g$,bn,_$,rh,b$,k$,ih,v$,y$,w$,Xs,T$,Ys,Of,kn,Zs,lh,Wi,$$,dh,F$,Nf,st,Ui,x$,ch,R$,E$,Hi,M$,Kd,z$,j$,C$,Qi,q$,Ki,P$,L$,A$,ph,O$,N$,ho,hh,Ji,I$,D$,uh,Vi,S$,B$,fh,Gi,W$,U$,mh,Xi,H$,Q$,Xt,Yi,K$,vn,J$,gh,V$,G$,_h,X$,Y$,Z$,ea,e2,ta,If,yn,oa,bh,Zi,t2,kh,o2,Df,at,el,n2,tl,s2,vh,a2,r2,i2,ol,l2,Jd,d2,c2,p2,nl,h2,sl,u2,f2,m2,yh,g2,_2,uo,wh,al,b2,k2,Th,rl,v2,y2,$h,il,w2,T2,Fh,ll,$2,F2,Yt,dl,x2,wn,R2,xh,E2,M2,Rh,z2,j2,C2,na,q2,sa,Sf,Tn,aa,Eh,cl,P2,Mh,L2,Bf,rt,pl,A2,zh,O2,N2,hl,I2,Vd,D2,S2,B2,ul,W2,fl,U2,H2,Q2,jh,K2,J2,fo,Ch,ml,V2,G2,qh,gl,X2,Y2,Ph,_l,Z2,e1,Lh,bl,t1,o1,Zt,kl,n1,$n,s1,Ah,a1,r1,Oh,i1,l1,d1,ra,c1,ia,Wf,Fn,la,Nh,vl,p1,Ih,h1,Uf,it,yl,u1,Dh,f1,m1,wl,g1,Gd,_1,b1,k1,Tl,v1,$l,y1,w1,T1,Sh,$1,F1,mo,Bh,Fl,x1,R1,Wh,xl,E1,M1,Uh,Rl,z1,j1,Hh,El,C1,q1,eo,Ml,P1,xn,L1,Qh,A1,O1,Kh,N1,I1,D1,da,S1,ca,Hf,Rn,pa,Jh,zl,B1,Vh,W1,Qf,lt,jl,U1,Gh,H1,Q1,Cl,K1,Xd,J1,V1,G1,ql,X1,Pl,Y1,Z1,e0,Xh,t0,o0,go,Yh,Ll,n0,s0,Zh,Al,a0,r0,eu,Ol,i0,l0,tu,Nl,d0,c0,to,Il,p0,En,h0,ou,u0,f0,nu,m0,g0,_0,ha,b0,ua,Kf,Mn,fa,su,Dl,k0,au,v0,Jf,dt,Sl,y0,zn,w0,ru,T0,$0,iu,F0,x0,R0,Bl,E0,Yd,M0,z0,j0,Wl,C0,Ul,q0,P0,L0,lu,A0,O0,_o,du,Hl,N0,I0,cu,Ql,D0,S0,pu,Kl,B0,W0,hu,Jl,U0,H0,oo,Vl,Q0,jn,K0,uu,J0,V0,fu,G0,X0,Y0,ma,Z0,ga,Vf;return l=new De({}),M=new De({}),We=new De({}),Oa=new O({props:{name:"class transformers.RobertaConfig",anchor:"transformers.RobertaConfig",parameters:[{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/configuration_roberta.py#L37"}}),An=new ae({props:{anchor:"transformers.RobertaConfig.example",$$slots:{default:[DE]},$$scope:{ctx:R}}}),Ia=new De({}),Da=new O({props:{name:"class transformers.RobertaTokenizer",anchor:"transformers.RobertaTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RobertaTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L734",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/roberta#transformers.RobertaConfig"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L875"}}),mr=new O({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L901",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L1056",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L1158"}}),Er=new O({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L1172",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L1271",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L1351"}}),Dr=new O({props:{name:"forward",anchor:"transformers.RobertaForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L1369",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_roberta.py#L1474",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_tf_roberta.py#L929",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_tf_roberta.py#L1186",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_tf_roberta.py#L1085",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_tf_roberta.py#L1344",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_tf_roberta.py#L1441",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_tf_roberta.py#L1556",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_tf_roberta.py#L1642",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_flax_roberta.py#L1057"}}),dl=new O({props:{name:"__call__",anchor:"transformers.FlaxRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_flax_roberta.py#L1130"}}),kl=new O({props:{name:"__call__",anchor:"transformers.FlaxRobertaForSequenceClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxRobertaForSequenceClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_flax_roberta.py#L1212"}}),Ml=new O({props:{name:"__call__",anchor:"transformers.FlaxRobertaForMultipleChoice.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxRobertaForMultipleChoice.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/roberta/modeling_flax_roberta.py#L1373"}}),Vl=new O({props:{name:"__call__",anchor:"transformers.FlaxRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qv=h(),Mt=a("div"),y(Qr.$$.fragment),Kv=h(),Zo=a("p"),Jv=n("The "),Cd=a("a"),Vv=n("RobertaForQuestionAnswering"),Gv=n(" forward method, overrides the "),Tp=a("code"),Xv=n("__call__"),Yv=n(" special method."),Zv=h(),y(gs.$$.fragment),ey=h(),y(_s.$$.fragment),ty=h(),y(bs.$$.fragment),yf=h(),en=a("h2"),ks=a("a"),$p=a("span"),y(Kr.$$.fragment),oy=h(),Fp=a("span"),ny=n("TFRobertaModel"),wf=h(),ht=a("div"),y(Jr.$$.fragment),sy=h(),xp=a("p"),ay=n("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),ry=h(),Vr=a("p"),iy=n("This model inherits from "),qd=a("a"),ly=n("TFPreTrainedModel"),dy=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cy=h(),Gr=a("p"),py=n("This model is also a "),Xr=a("a"),hy=n("tf.keras.Model"),uy=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fy=h(),y(vs.$$.fragment),my=h(),Kt=a("div"),y(Yr.$$.fragment),gy=h(),tn=a("p"),_y=n("The "),Pd=a("a"),by=n("TFRobertaModel"),ky=n(" forward method, overrides the "),Rp=a("code"),vy=n("__call__"),yy=n(" special method."),wy=h(),y(ys.$$.fragment),Ty=h(),y(ws.$$.fragment),Tf=h(),on=a("h2"),Ts=a("a"),Ep=a("span"),y(Zr.$$.fragment),$y=h(),Mp=a("span"),Fy=n("TFRobertaForCausalLM"),$f=h(),nn=a("div"),y(ei.$$.fragment),xy=h(),Jt=a("div"),y(ti.$$.fragment),Ry=h(),sn=a("p"),Ey=n("The "),Ld=a("a"),My=n("TFRobertaForCausalLM"),zy=n(" forward method, overrides the "),zp=a("code"),jy=n("__call__"),Cy=n(" special method."),qy=h(),y($s.$$.fragment),Py=h(),y(Fs.$$.fragment),Ff=h(),an=a("h2"),xs=a("a"),jp=a("span"),y(oi.$$.fragment),Ly=h(),Cp=a("span"),Ay=n("TFRobertaForMaskedLM"),xf=h(),ut=a("div"),y(ni.$$.fragment),Oy=h(),si=a("p"),Ny=n("RoBERTa Model with a "),qp=a("code"),Iy=n("language modeling"),Dy=n(" head on top."),Sy=h(),ai=a("p"),By=n("This model inherits from "),Ad=a("a"),Wy=n("TFPreTrainedModel"),Uy=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hy=h(),ri=a("p"),Qy=n("This model is also a "),ii=a("a"),Ky=n("tf.keras.Model"),Jy=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vy=h(),y(Rs.$$.fragment),Gy=h(),zt=a("div"),y(li.$$.fragment),Xy=h(),rn=a("p"),Yy=n("The "),Od=a("a"),Zy=n("TFRobertaForMaskedLM"),ew=n(" forward method, overrides the "),Pp=a("code"),tw=n("__call__"),ow=n(" special method."),nw=h(),y(Es.$$.fragment),sw=h(),y(Ms.$$.fragment),aw=h(),y(zs.$$.fragment),Rf=h(),ln=a("h2"),js=a("a"),Lp=a("span"),y(di.$$.fragment),rw=h(),Ap=a("span"),iw=n("TFRobertaForSequenceClassification"),Ef=h(),ft=a("div"),y(ci.$$.fragment),lw=h(),Op=a("p"),dw=n(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),cw=h(),pi=a("p"),pw=n("This model inherits from "),Nd=a("a"),hw=n("TFPreTrainedModel"),uw=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fw=h(),hi=a("p"),mw=n("This model is also a "),ui=a("a"),gw=n("tf.keras.Model"),_w=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bw=h(),y(Cs.$$.fragment),kw=h(),jt=a("div"),y(fi.$$.fragment),vw=h(),dn=a("p"),yw=n("The "),Id=a("a"),ww=n("TFRobertaForSequenceClassification"),Tw=n(" forward method, overrides the "),Np=a("code"),$w=n("__call__"),Fw=n(" special method."),xw=h(),y(qs.$$.fragment),Rw=h(),y(Ps.$$.fragment),Ew=h(),y(Ls.$$.fragment),Mf=h(),cn=a("h2"),As=a("a"),Ip=a("span"),y(mi.$$.fragment),Mw=h(),Dp=a("span"),zw=n("TFRobertaForMultipleChoice"),zf=h(),mt=a("div"),y(gi.$$.fragment),jw=h(),Sp=a("p"),Cw=n(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sw=h(),y(Os.$$.fragment),Bw=h(),Vt=a("div"),y(vi.$$.fragment),Ww=h(),pn=a("p"),Uw=n("The "),Sd=a("a"),Hw=n("TFRobertaForMultipleChoice"),Qw=n(" forward method, overrides the "),Bp=a("code"),Kw=n("__call__"),Jw=n(" special method."),Vw=h(),y(Ns.$$.fragment),Gw=h(),y(Is.$$.fragment),jf=h(),hn=a("h2"),Ds=a("a"),Wp=a("span"),y(yi.$$.fragment),Xw=h(),Up=a("span"),Yw=n("TFRobertaForTokenClassification"),Cf=h(),gt=a("div"),y(wi.$$.fragment),Zw=h(),Hp=a("p"),eT=n(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dT=h(),y(Ss.$$.fragment),cT=h(),Ct=a("div"),y(xi.$$.fragment),pT=h(),un=a("p"),hT=n("The "),Wd=a("a"),uT=n("TFRobertaForTokenClassification"),fT=n(" forward method, overrides the "),Qp=a("code"),mT=n("__call__"),gT=n(" special method."),_T=h(),y(Bs.$$.fragment),bT=h(),y(Ws.$$.fragment),kT=h(),y(Us.$$.fragment),qf=h(),fn=a("h2"),Hs=a("a"),Kp=a("span"),y(Ri.$$.fragment),vT=h(),Jp=a("span"),yT=n("TFRobertaForQuestionAnswering"),Pf=h(),_t=a("div"),y(Ei.$$.fragment),wT=h(),mn=a("p"),TT=n(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),AT=h(),y(Qs.$$.fragment),OT=h(),qt=a("div"),y(Ci.$$.fragment),NT=h(),gn=a("p"),IT=n("The "),Hd=a("a"),DT=n("TFRobertaForQuestionAnswering"),ST=n(" forward method, overrides the "),Xp=a("code"),BT=n("__call__"),WT=n(" special method."),UT=h(),y(Ks.$$.fragment),HT=h(),y(Js.$$.fragment),QT=h(),y(Vs.$$.fragment),Lf=h(),_n=a("h2"),Gs=a("a"),Yp=a("span"),y(qi.$$.fragment),KT=h(),Zp=a("span"),JT=n("FlaxRobertaModel"),Af=h(),nt=a("div"),y(Pi.$$.fragment),VT=h(),eh=a("p"),GT=n("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),XT=h(),Li=a("p"),YT=n("This model inherits from "),Qd=a("a"),ZT=n("FlaxPreTrainedModel"),e$=n(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),a$=h(),th=a("p"),r$=n("Finally, this model supports inherent JAX features such as:"),i$=h(),po=a("ul"),oh=a("li"),Ni=a("a"),l$=n("Just-In-Time (JIT) compilation"),d$=h(),nh=a("li"),Ii=a("a"),c$=n("Automatic Differentiation"),p$=h(),sh=a("li"),Di=a("a"),h$=n("Vectorization"),u$=h(),ah=a("li"),Si=a("a"),f$=n("Parallelization"),m$=h(),Gt=a("div"),y(Bi.$$.fragment),g$=h(),bn=a("p"),_$=n("The "),rh=a("code"),b$=n("FlaxRobertaPreTrainedModel"),k$=n(" forward method, overrides the "),ih=a("code"),v$=n("__call__"),y$=n(" special method."),w$=h(),y(Xs.$$.fragment),T$=h(),y(Ys.$$.fragment),Of=h(),kn=a("h2"),Zs=a("a"),lh=a("span"),y(Wi.$$.fragment),$$=h(),dh=a("span"),F$=n("FlaxRobertaForCausalLM"),Nf=h(),st=a("div"),y(Ui.$$.fragment),x$=h(),ch=a("p"),R$=n(`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=h(),ph=a("p"),O$=n("Finally, this model supports inherent JAX features such as:"),N$=h(),ho=a("ul"),hh=a("li"),Ji=a("a"),I$=n("Just-In-Time (JIT) compilation"),D$=h(),uh=a("li"),Vi=a("a"),S$=n("Automatic Differentiation"),B$=h(),fh=a("li"),Gi=a("a"),W$=n("Vectorization"),U$=h(),mh=a("li"),Xi=a("a"),H$=n("Parallelization"),Q$=h(),Xt=a("div"),y(Yi.$$.fragment),K$=h(),vn=a("p"),J$=n("The "),gh=a("code"),V$=n("FlaxRobertaPreTrainedModel"),G$=n(" forward method, overrides the "),_h=a("code"),X$=n("__call__"),Y$=n(" special method."),Z$=h(),y(ea.$$.fragment),e2=h(),y(ta.$$.fragment),If=h(),yn=a("h2"),oa=a("a"),bh=a("span"),y(Zi.$$.fragment),t2=h(),kh=a("span"),o2=n("FlaxRobertaForMaskedLM"),Df=h(),at=a("div"),y(el.$$.fragment),n2=h(),tl=a("p"),s2=n("RoBERTa Model with a "),vh=a("code"),a2=n("language modeling"),r2=n(" head on top."),i2=h(),ol=a("p"),l2=n("This model inherits from "),Jd=a("a"),d2=n("FlaxPreTrainedModel"),c2=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),p2=h(),nl=a("p"),h2=n("This model is also a Flax Linen "),sl=a("a"),u2=n("flax.linen.Module"),f2=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),m2=h(),yh=a("p"),g2=n("Finally, this model supports inherent JAX features such as:"),_2=h(),uo=a("ul"),wh=a("li"),al=a("a"),b2=n("Just-In-Time (JIT) compilation"),k2=h(),Th=a("li"),rl=a("a"),v2=n("Automatic Differentiation"),y2=h(),$h=a("li"),il=a("a"),w2=n("Vectorization"),T2=h(),Fh=a("li"),ll=a("a"),$2=n("Parallelization"),F2=h(),Yt=a("div"),y(dl.$$.fragment),x2=h(),wn=a("p"),R2=n("The "),xh=a("code"),E2=n("FlaxRobertaPreTrainedModel"),M2=n(" forward method, overrides the "),Rh=a("code"),z2=n("__call__"),j2=n(" special method."),C2=h(),y(na.$$.fragment),q2=h(),y(sa.$$.fragment),Sf=h(),Tn=a("h2"),aa=a("a"),Eh=a("span"),y(cl.$$.fragment),P2=h(),Mh=a("span"),L2=n("FlaxRobertaForSequenceClassification"),Bf=h(),rt=a("div"),y(pl.$$.fragment),A2=h(),zh=a("p"),O2=n(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),N2=h(),hl=a("p"),I2=n("This model inherits from "),Vd=a("a"),D2=n("FlaxPreTrainedModel"),S2=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),B2=h(),ul=a("p"),W2=n("This model is also a Flax Linen "),fl=a("a"),U2=n("flax.linen.Module"),H2=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q2=h(),jh=a("p"),K2=n("Finally, this model supports inherent JAX features such as:"),J2=h(),fo=a("ul"),Ch=a("li"),ml=a("a"),V2=n("Just-In-Time (JIT) compilation"),G2=h(),qh=a("li"),gl=a("a"),X2=n("Automatic Differentiation"),Y2=h(),Ph=a("li"),_l=a("a"),Z2=n("Vectorization"),e1=h(),Lh=a("li"),bl=a("a"),t1=n("Parallelization"),o1=h(),Zt=a("div"),y(kl.$$.fragment),n1=h(),$n=a("p"),s1=n("The "),Ah=a("code"),a1=n("FlaxRobertaPreTrainedModel"),r1=n(" forward method, overrides the "),Oh=a("code"),i1=n("__call__"),l1=n(" special method."),d1=h(),y(ra.$$.fragment),c1=h(),y(ia.$$.fragment),Wf=h(),Fn=a("h2"),la=a("a"),Nh=a("span"),y(vl.$$.fragment),p1=h(),Ih=a("span"),h1=n("FlaxRobertaForMultipleChoice"),Uf=h(),it=a("div"),y(yl.$$.fragment),u1=h(),Dh=a("p"),f1=n(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),e0=h(),Xh=a("p"),t0=n("Finally, this model supports inherent JAX features such as:"),o0=h(),go=a("ul"),Yh=a("li"),Ll=a("a"),n0=n("Just-In-Time (JIT) compilation"),s0=h(),Zh=a("li"),Al=a("a"),a0=n("Automatic Differentiation"),r0=h(),eu=a("li"),Ol=a("a"),i0=n("Vectorization"),l0=h(),tu=a("li"),Nl=a("a"),d0=n("Parallelization"),c0=h(),to=a("div"),y(Il.$$.fragment),p0=h(),En=a("p"),h0=n("The "),ou=a("code"),u0=n("FlaxRobertaPreTrainedModel"),f0=n(" forward method, overrides the "),nu=a("code"),m0=n("__call__"),g0=n(" special method."),_0=h(),y(ha.$$.fragment),b0=h(),y(ua.$$.fragment),Kf=h(),Mn=a("h2"),fa=a("a"),su=a("span"),y(Dl.$$.fragment),k0=h(),au=a("span"),v0=n("FlaxRobertaForQuestionAnswering"),Jf=h(),dt=a("div"),y(Sl.$$.fragment),y0=h(),zn=a("p"),w0=n(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),ru=a("code"),T0=n("span start logits"),$0=n(" and "),iu=a("code"),F0=n("span end logits"),x0=n(")."),R0=h(),Bl=a("p"),E0=n("This model inherits from "),Yd=a("a"),M0=n("FlaxPreTrainedModel"),z0=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),j0=h(),Wl=a("p"),C0=n("This model is also a Flax Linen "),Ul=a("a"),q0=n("flax.linen.Module"),P0=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),L0=h(),lu=a("p"),A0=n("Finally, this model supports inherent JAX features such as:"),O0=h(),_o=a("ul"),du=a("li"),Hl=a("a"),N0=n("Just-In-Time (JIT) compilation"),I0=h(),cu=a("li"),Ql=a("a"),D0=n("Automatic Differentiation"),S0=h(),pu=a("li"),Kl=a("a"),B0=n("Vectorization"),W0=h(),hu=a("li"),Jl=a("a"),U0=n("Parallelization"),H0=h(),oo=a("div"),y(Vl.$$.fragment),Q0=h(),jn=a("p"),K0=n("The "),uu=a("code"),J0=n("FlaxRobertaPreTrainedModel"),V0=n(" forward method, overrides the "),fu=a("code"),G0=n("__call__"),X0=n(" special method."),Y0=h(),y(ma.$$.fragment),Z0=h(),y(ga.$$.fragment),this.h()},l(o){const b=NE('[data-svelte="svelte-1phssyn"]',document.head);d=r(b,"META",{name:!0,content:!0}),b.forEach(t),g=u(o),c=r(o,"H1",{class:!0});var Gl=i(c);f=r(Gl,"A",{id:!0,class:!0,href:!0});var mu=i(f);_=r(mu,"SPAN",{});var gu=i(_);w(l.$$.fragment,gu),gu.forEach(t),mu.forEach(t),p=u(Gl),E=r(Gl,"SPAN",{});var _u=i(E);le=s(_u,"RoBERTa"),_u.forEach(t),Gl.forEach(t),Z=u(o),N=r(o,"H2",{class:!0});var Xl=i(N);te=r(Xl,"A",{id:!0,class:!0,href:!0});var bu=i(te);oe=r(bu,"SPAN",{});var ku=i(oe);w(M.$$.fragment,ku),ku.forEach(t),bu.forEach(t),we=u(Xl),K=r(Xl,"SPAN",{});var vu=i(K);Te=s(vu,"Overview"),vu.forEach(t),Xl.forEach(t),ge=u(o),B=r(o,"P",{});var Yl=i(B);$e=s(Yl,"The RoBERTa model was proposed in "),pe=r(Yl,"A",{href:!0,rel:!0});var yu=i(pe);J=s(yu,"RoBERTa: A Robustly Optimized BERT Pretraining Approach"),yu.forEach(t),Fe=s(Yl,` by Yinhan Liu, Myle Ott, Naman Goyal, Jingfei Du, Mandar Joshi, Danqi Chen, Omer
...
special tokens using the tokenizer `),Pc=r(rd,"CODE",{});var eF=i(Pc);d_=s(eF,"prepare_for_model"),eF.forEach(t),c_=s(rd," method."),rd.forEach(t),ad.forEach(t),p_=u(Ue),Sn=r(Ue,"DIV",{class:!0});var Gf=i(Sn);w(Ka.$$.fragment,Gf),h_=u(Gf),Lc=r(Gf,"P",{});var tF=i(Lc);u_=s(tF,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),tF.forEach(t),Gf.forEach(t),f_=u(Ue),gd=r(Ue,"DIV",{class:!0});var oF=i(gd);w(Ja.$$.fragment,oF),oF.forEach(t),Ue.forEach(t),sf=u(o),No=r(o,"H2",{class:!0});var Xf=i(No);Bn=r(Xf,"A",{id:!0,class:!0,href:!0});var nF=i(Bn);Ac=r(nF,"SPAN",{});var sF=i(Ac);w(Va.$$.fragment,sF),sF.forEach(t),nF.forEach(t),m_=u(Xf),Oc=r(Xf,"SPAN",{});var aF=i(Oc);g_=s(aF,"RobertaTokenizerFast"),aF.forEach(t),Xf.forEach(t),af=u(o),tt=r(o,"DIV",{class:!0});var bt=i(tt);w(Ga.$$.fragment,bt),__=u(bt),Xa=r(bt,"P",{});var Yf=i(Xa);b_=s(Yf,"Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),Nc=r(Yf,"EM",{});var rF=i(Nc);k_=s(rF,"tokenizers"),rF.forEach(t),v_=s(Yf,` library), derived from the GPT-2
tokenizer, using byte-level Byte-Pair-Encoding.`),Yf.forEach(t),y_=u(bt),Ic=r(bt,"P",{});var iF=i(Ic);w_=s(iF,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),iF.forEach(t),T_=u(bt),w(Wn.$$.fragment,bt),$_=u(bt),Ya=r(bt,"P",{});var Zf=i(Ya);F_=s(Zf,"You can get around that behavior by passing "),Dc=r(Zf,"CODE",{});var lF=i(Dc);x_=s(lF,"add_prefix_space=True"),lF.forEach(t),R_=s(Zf,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Zf.forEach(t),E_=u(bt),w(Un.$$.fragment,bt),M_=u(bt),Za=r(bt,"P",{});var em=i(Za);z_=s(em,"This tokenizer inherits from "),_d=r(em,"A",{href:!0});var dF=i(_d);j_=s(dF,"PreTrainedTokenizerFast"),dF.forEach(t),C_=s(em,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),em.forEach(t),q_=u(bt),bd=r(bt,"DIV",{class:!0});var cF=i(bd);w(er.$$.fragment,cF),cF.forEach(t),bt.forEach(t),rf=u(o),Io=r(o,"H2",{class:!0});var tm=i(Io);Hn=r(tm,"A",{id:!0,class:!0,href:!0});var pF=i(Hn);Sc=r(pF,"SPAN",{});var hF=i(Sc);w(tr.$$.fragment,hF),hF.forEach(t),pF.forEach(t),P_=u(tm),Bc=r(tm,"SPAN",{});var uF=i(Bc);L_=s(uF,"RobertaModel"),uF.forEach(t),tm.forEach(t),lf=u(o),ot=r(o,"DIV",{class:!0});var kt=i(ot);w(or.$$.fragment,kt),A_=u(kt),Wc=r(kt,"P",{});var fF=i(Wc);O_=s(fF,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),fF.forEach(t),N_=u(kt),nr=r(kt,"P",{});var om=i(nr);I_=s(om,"This model inherits from "),kd=r(om,"A",{href:!0});var mF=i(kd);D_=s(mF,"PreTrainedModel"),mF.forEach(t),S_=s(om,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),om.forEach(t),B_=u(kt),sr=r(kt,"P",{});var nm=i(sr);W_=s(nm,"This model is also a PyTorch "),ar=r(nm,"A",{href:!0,rel:!0});var gF=i(ar);U_=s(gF,"torch.nn.Module"),gF.forEach(t),H_=s(nm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),Uc=r(sm,"EM",{});var _F=i(Uc);J_=s(_F,`Attention is
all you need`),_F.forEach(t),V_=s(sm,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),sm.forEach(t),G_=u(kt),pt=r(kt,"P",{});var Pt=i(pt);X_=s(Pt,"To behave as an decoder the model needs to be initialized with the "),Hc=r(Pt,"CODE",{});var bF=i(Hc);Y_=s(bF,"is_decoder"),bF.forEach(t),Z_=s(Pt,` argument of the configuration set
to `),Qc=r(Pt,"CODE",{});var kF=i(Qc);eb=s(kF,"True"),kF.forEach(t),tb=s(Pt,". To be used in a Seq2Seq model, the model needs to initialized with both "),Kc=r(Pt,"CODE",{});var vF=i(Kc);ob=s(vF,"is_decoder"),vF.forEach(t),nb=s(Pt,` argument and
`),Jc=r(Pt,"CODE",{});var yF=i(Jc);sb=s(yF,"add_cross_attention"),yF.forEach(t),ab=s(Pt," set to "),Vc=r(Pt,"CODE",{});var wF=i(Vc);rb=s(wF,"True"),wF.forEach(t),ib=s(Pt,"; an "),Gc=r(Pt,"CODE",{});var TF=i(Gc);lb=s(TF,"encoder_hidden_states"),TF.forEach(t),db=s(Pt," is then expected as an input to the forward pass."),Pt.forEach(t),cb=u(kt),Qn=r(kt,"P",{});var tf=i(Qn);pb=s(tf,".. _"),Xc=r(tf,"EM",{});var $F=i(Xc);hb=s($F,"Attention is all you need"),$F.forEach(t),ub=s(tf,": "),ir=r(tf,"A",{href:!0,rel:!0});var FF=i(ir);fb=s(FF,"https://arxiv.org/abs/1706.03762"),FF.forEach(t),tf.forEach(t),mb=u(kt),Ut=r(kt,"DIV",{class:!0});var _a=i(Ut);w(lr.$$.fragment,_a),gb=u(_a),Do=r(_a,"P",{});var oc=i(Do);_b=s(oc,"The "),vd=r(oc,"A",{href:!0});var xF=i(vd);bb=s(xF,"RobertaModel"),xF.forEach(t),kb=s(oc," forward method, overrides the "),Yc=r(oc,"CODE",{});var RF=i(Yc);vb=s(RF,"__call__"),RF.forEach(t),yb=s(oc," special method."),oc.forEach(t),wb=u(_a),w(Kn.$$.fragment,_a),Tb=u(_a),w(Jn.$$.fragment,_a),_a.forEach(t),kt.forEach(t),df=u(o),So=r(o,"H2",{class:!0});var am=i(So);Vn=r(am,"A",{id:!0,class:!0,href:!0});var EF=i(Vn);Zc=r(EF,"SPAN",{});var MF=i(Zc);w(dr.$$.fragment,MF),MF.forEach(t),EF.forEach(t),$b=u(am),ep=r(am,"SPAN",{});var zF=i(ep);Fb=s(zF,"RobertaForCausalLM"),zF.forEach(t),am.forEach(t),cf=u(o),yt=r(o,"DIV",{class:!0});var wo=i(yt);w(cr.$$.fragment,wo),xb=u(wo),pr=r(wo,"P",{});var rm=i(pr);Rb=s(rm,"RoBERTa Model with a "),tp=r(rm,"CODE",{});var jF=i(tp);Eb=s(jF,"language modeling"),jF.forEach(t),Mb=s(rm," head on top for CLM fine-tuning."),rm.forEach(t),zb=u(wo),hr=r(wo,"P",{});var im=i(hr);jb=s(im,"This model inherits from "),yd=r(im,"A",{href:!0});var CF=i(yd);Cb=s(CF,"PreTrainedModel"),CF.forEach(t),qb=s(im,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),im.forEach(t),Pb=u(wo),ur=r(wo,"P",{});var lm=i(ur);Lb=s(lm,"This model is also a PyTorch "),fr=r(lm,"A",{href:!0,rel:!0});var qF=i(fr);Ab=s(qF,"torch.nn.Module"),qF.forEach(t),Ob=s(lm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lm.forEach(t),Nb=u(wo),Ht=r(wo,"DIV",{class:!0});var ba=i(Ht);w(mr.$$.fragment,ba),Ib=u(ba),Bo=r(ba,"P",{});var nc=i(Bo);Db=s(nc,"The "),wd=r(nc,"A",{href:!0});var PF=i(wd);Sb=s(PF,"RobertaForCausalLM"),PF.forEach(t),Bb=s(nc," forward method, overrides the "),op=r(nc,"CODE",{});var LF=i(op);Wb=s(LF,"__call__"),LF.forEach(t),Ub=s(nc," special method."),nc.forEach(t),Hb=u(ba),w(Gn.$$.fragment,ba),Qb=u(ba),w(Xn.$$.fragment,ba),ba.forEach(t),wo.forEach(t),pf=u(o),Wo=r(o,"H2",{class:!0});var dm=i(Wo);Yn=r(dm,"A",{id:!0,class:!0,href:!0});var AF=i(Yn);np=r(AF,"SPAN",{});var OF=i(np);w(gr.$$.fragment,OF),OF.forEach(t),AF.forEach(t),Kb=u(dm),sp=r(dm,"SPAN",{});var NF=i(sp);Jb=s(NF,"RobertaForMaskedLM"),NF.forEach(t),dm.forEach(t),hf=u(o),wt=r(o,"DIV",{class:!0});var To=i(wt);w(_r.$$.fragment,To),Vb=u(To),br=r(To,"P",{});var cm=i(br);Gb=s(cm,"RoBERTa Model with a "),ap=r(cm,"CODE",{});var IF=i(ap);Xb=s(IF,"language modeling"),IF.forEach(t),Yb=s(cm," head on top."),cm.forEach(t),Zb=u(To),kr=r(To,"P",{});var pm=i(kr);ek=s(pm,"This model inherits from "),Td=r(pm,"A",{href:!0});var DF=i(Td);tk=s(DF,"PreTrainedModel"),DF.forEach(t),ok=s(pm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pm.forEach(t),nk=u(To),vr=r(To,"P",{});var hm=i(vr);sk=s(hm,"This model is also a PyTorch "),yr=r(hm,"A",{href:!0,rel:!0});var SF=i(yr);ak=s(SF,"torch.nn.Module"),SF.forEach(t),rk=s(hm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(t),ik=u(To),Rt=r(To,"DIV",{class:!0});var $o=i(Rt);w(wr.$$.fragment,$o),lk=u($o),Uo=r($o,"P",{});var sc=i(Uo);dk=s(sc,"The "),$d=r(sc,"A",{href:!0});var BF=i($d);ck=s(BF,"RobertaForMaskedLM"),BF.forEach(t),pk=s(sc," forward method, overrides the "),rp=r(sc,"CODE",{});var WF=i(rp);hk=s(WF,"__call__"),WF.forEach(t),uk=s(sc," special method."),sc.forEach(t),fk=u($o),w(Zn.$$.fragment,$o),mk=u($o),w(es.$$.fragment,$o),gk=u($o),w(ts.$$.fragment,$o),$o.forEach(t),To.forEach(t),uf=u(o),Ho=r(o,"H2",{class:!0});var um=i(Ho);os=r(um,"A",{id:!0,class:!0,href:!0});var UF=i(os);ip=r(UF,"SPAN",{});var HF=i(ip);w(Tr.$$.fragment,HF),HF.forEach(t),UF.forEach(t),_k=u(um),lp=r(um,"SPAN",{});var QF=i(lp);bk=s(QF,"RobertaForSequenceClassification"),QF.forEach(t),um.forEach(t),ff=u(o),Tt=r(o,"DIV",{class:!0});var Fo=i(Tt);w($r.$$.fragment,Fo),kk=u(Fo),dp=r(Fo,"P",{});var KF=i(dp);vk=s(KF,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),KF.forEach(t),yk=u(Fo),Fr=r(Fo,"P",{});var fm=i(Fr);wk=s(fm,"This model inherits from "),Fd=r(fm,"A",{href:!0});var JF=i(Fd);Tk=s(JF,"PreTrainedModel"),JF.forEach(t),$k=s(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fm.forEach(t),Fk=u(Fo),xr=r(Fo,"P",{});var mm=i(xr);xk=s(mm,"This model is also a PyTorch "),Rr=r(mm,"A",{href:!0,rel:!0});var VF=i(Rr);Rk=s(VF,"torch.nn.Module"),VF.forEach(t),Ek=s(mm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mm.forEach(t),Mk=u(Fo),ct=r(Fo,"DIV",{class:!0});var Lt=i(ct);w(Er.$$.fragment,Lt),zk=u(Lt),Qo=r(Lt,"P",{});var ac=i(Qo);jk=s(ac,"The "),xd=r(ac,"A",{href:!0});var GF=i(xd);Ck=s(GF,"RobertaForSequenceClassification"),GF.forEach(t),qk=s(ac," forward method, overrides the "),cp=r(ac,"CODE",{});var XF=i(cp);Pk=s(XF,"__call__"),XF.forEach(t),Lk=s(ac," special method."),ac.forEach(t),Ak=u(Lt),w(ns.$$.fragment,Lt),Ok=u(Lt),w(ss.$$.fragment,Lt),Nk=u(Lt),w(as.$$.fragment,Lt),Ik=u(Lt),w(rs.$$.fragment,Lt),Dk=u(Lt),w(is.$$.fragment,Lt),Lt.forEach(t),Fo.forEach(t),mf=u(o),Ko=r(o,"H2",{class:!0});var gm=i(Ko);ls=r(gm,"A",{id:!0,class:!0,href:!0});var YF=i(ls);pp=r(YF,"SPAN",{});var ZF=i(pp);w(Mr.$$.fragment,ZF),ZF.forEach(t),YF.forEach(t),Sk=u(gm),hp=r(gm,"SPAN",{});var ex=i(hp);Bk=s(ex,"RobertaForMultipleChoice"),ex.forEach(t),gm.forEach(t),gf=u(o),$t=r(o,"DIV",{class:!0});var xo=i($t);w(zr.$$.fragment,xo),Wk=u(xo),up=r(xo,"P",{});var tx=i(up);Uk=s(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$m.forEach(t),Qv=u(Mo),Mt=r(Mo,"DIV",{class:!0});var zo=i(Mt);w(Qr.$$.fragment,zo),Kv=u(zo),Zo=r(zo,"P",{});var dc=i(Zo);Jv=s(dc,"The "),Cd=r(dc,"A",{href:!0});var yx=i(Cd);Vv=s(yx,"RobertaForQuestionAnswering"),yx.forEach(t),Gv=s(dc," forward method, overrides the "),Tp=r(dc,"CODE",{});var wx=i(Tp);Xv=s(wx,"__call__"),wx.forEach(t),Yv=s(dc," special method."),dc.forEach(t),Zv=u(zo),w(gs.$$.fragment,zo),ey=u(zo),w(_s.$$.fragment,zo),ty=u(zo),w(bs.$$.fragment,zo),zo.forEach(t),Mo.forEach(t),yf=u(o),en=r(o,"H2",{class:!0});var Fm=i(en);ks=r(Fm,"A",{id:!0,class:!0,href:!0});var Tx=i(ks);$p=r(Tx,"SPAN",{});var $x=i($p);w(Kr.$$.fragment,$x),$x.forEach(t),Tx.forEach(t),oy=u(Fm),Fp=r(Fm,"SPAN",{});var Fx=i(Fp);ny=s(Fx,"TFRobertaModel"),Fx.forEach(t),Fm.forEach(t),wf=u(o),ht=r(o,"DIV",{class:!0});var no=i(ht);w(Jr.$$.fragment,no),sy=u(no),xp=r(no,"P",{});var xx=i(xp);ay=s(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),ry=u(no),Vr=r(no,"P",{});var xm=i(Vr);iy=s(xm,"This model inherits from "),qd=r(xm,"A",{href:!0});var Rx=i(qd);ly=s(Rx,"TFPreTrainedModel"),Rx.forEach(t),dy=s(xm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xm.forEach(t),cy=u(no),Gr=r(no,"P",{});var Rm=i(Gr);py=s(Rm,"This model is also a "),Xr=r(Rm,"A",{href:!0,rel:!0});var Ex=i(Xr);hy=s(Ex,"tf.keras.Model"),Ex.forEach(t),uy=s(Rm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rm.forEach(t),fy=u(no),w(vs.$$.fragment,no),my=u(no),Kt=r(no,"DIV",{class:!0});var va=i(Kt);w(Yr.$$.fragment,va),gy=u(va),tn=r(va,"P",{});var cc=i(tn);_y=s(cc,"The "),Pd=r(cc,"A",{href:!0});var Mx=i(Pd);by=s(Mx,"TFRobertaModel"),Mx.forEach(t),ky=s(cc," forward method, overrides the "),Rp=r(cc,"CODE",{});var zx=i(Rp);vy=s(zx,"__call__"),zx.forEach(t),yy=s(cc," special method."),cc.forEach(t),wy=u(va),w(ys.$$.fragment,va),Ty=u(va),w(ws.$$.fragment,va),va.forEach(t),no.forEach(t),Tf=u(o),on=r(o,"H2",{class:!0});var Em=i(on);Ts=r(Em,"A",{id:!0,class:!0,href:!0});var jx=i(Ts);Ep=r(jx,"SPAN",{});var Cx=i(Ep);w(Zr.$$.fragment,Cx),Cx.forEach(t),jx.forEach(t),$y=u(Em),Mp=r(Em,"SPAN",{});var qx=i(Mp);Fy=s(qx,"TFRobertaForCausalLM"),qx.forEach(t),Em.forEach(t),$f=u(o),nn=r(o,"DIV",{class:!0});var Mm=i(nn);w(ei.$$.fragment,Mm),xy=u(Mm),Jt=r(Mm,"DIV",{class:!0});var ya=i(Jt);w(ti.$$.fragment,ya),Ry=u(ya),sn=r(ya,"P",{});var pc=i(sn);Ey=s(pc,"The "),Ld=r(pc,"A",{href:!0});var Px=i(Ld);My=s(Px,"TFRobertaForCausalLM"),Px.forEach(t),zy=s(pc," forward method, overrides the "),zp=r(pc,"CODE",{});var Lx=i(zp);jy=s(Lx,"__call__"),Lx.forEach(t),Cy=s(pc," special method."),pc.forEach(t),qy=u(ya),w($s.$$.fragment,ya),Py=u(ya),w(Fs.$$.fragment,ya),ya.forEach(t),Mm.forEach(t),Ff=u(o),an=r(o,"H2",{class:!0});var zm=i(an);xs=r(zm,"A",{id:!0,class:!0,href:!0});var Ax=i(xs);jp=r(Ax,"SPAN",{});var Ox=i(jp);w(oi.$$.fragment,Ox),Ox.forEach(t),Ax.forEach(t),Ly=u(zm),Cp=r(zm,"SPAN",{});var Nx=i(Cp);Ay=s(Nx,"TFRobertaForMaskedLM"),Nx.forEach(t),zm.forEach(t),xf=u(o),ut=r(o,"DIV",{class:!0});var so=i(ut);w(ni.$$.fragment,so),Oy=u(so),si=r(so,"P",{});var jm=i(si);Ny=s(jm,"RoBERTa Model with a "),qp=r(jm,"CODE",{});var Ix=i(qp);Iy=s(Ix,"language modeling"),Ix.forEach(t),Dy=s(jm," head on top."),jm.forEach(t),Sy=u(so),ai=r(so,"P",{});var Cm=i(ai);By=s(Cm,"This model inherits from "),Ad=r(Cm,"A",{href:!0});var Dx=i(Ad);Wy=s(Dx,"TFPreTrainedModel"),Dx.forEach(t),Uy=s(Cm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cm.forEach(t),Hy=u(so),ri=r(so,"P",{});var qm=i(ri);Qy=s(qm,"This model is also a "),ii=r(qm,"A",{href:!0,rel:!0});var Sx=i(ii);Ky=s(Sx,"tf.keras.Model"),Sx.forEach(t),Jy=s(qm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qm.forEach(t),Vy=u(so),w(Rs.$$.fragment,so),Gy=u(so),zt=r(so,"DIV",{class:!0});var jo=i(zt);w(li.$$.fragment,jo),Xy=u(jo),rn=r(jo,"P",{});var hc=i(rn);Yy=s(hc,"The "),Od=r(hc,"A",{href:!0});var Bx=i(Od);Zy=s(Bx,"TFRobertaForMaskedLM"),Bx.forEach(t),ew=s(hc," forward method, overrides the "),Pp=r(hc,"CODE",{});var Wx=i(Pp);tw=s(Wx,"__call__"),Wx.forEach(t),ow=s(hc," special method."),hc.forEach(t),nw=u(jo),w(Es.$$.fragment,jo),sw=u(jo),w(Ms.$$.fragment,jo),aw=u(jo),w(zs.$$.fragment,jo),jo.forEach(t),so.forEach(t),Rf=u(o),ln=r(o,"H2",{class:!0});var Pm=i(ln);js=r(Pm,"A",{id:!0,class:!0,href:!0});var Ux=i(js);Lp=r(Ux,"SPAN",{});var Hx=i(Lp);w(di.$$.fragment,Hx),Hx.forEach(t),Ux.forEach(t),rw=u(Pm),Ap=r(Pm,"SPAN",{});var Qx=i(Ap);iw=s(Qx,"TFRobertaForSequenceClassification"),Qx.forEach(t),Pm.forEach(t),Ef=u(o),ft=r(o,"DIV",{class:!0});var ao=i(ft);w(ci.$$.fragment,ao),lw=u(ao),Op=r(ao,"P",{});var Kx=i(Op);dw=s(Kx,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Kx.forEach(t),cw=u(ao),pi=r(ao,"P",{});var Lm=i(pi);pw=s(Lm,"This model inherits from "),Nd=r(Lm,"A",{href:!0});var Jx=i(Nd);hw=s(Jx,"TFPreTrainedModel"),Jx.forEach(t),uw=s(Lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lm.forEach(t),fw=u(ao),hi=r(ao,"P",{});var Am=i(hi);mw=s(Am,"This model is also a "),ui=r(Am,"A",{href:!0,rel:!0});var Vx=i(ui);gw=s(Vx,"tf.keras.Model"),Vx.forEach(t),_w=s(Am,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Am.forEach(t),bw=u(ao),w(Cs.$$.fragment,ao),kw=u(ao),jt=r(ao,"DIV",{class:!0});var Co=i(jt);w(fi.$$.fragment,Co),vw=u(Co),dn=r(Co,"P",{});var uc=i(dn);yw=s(uc,"The "),Id=r(uc,"A",{href:!0});var Gx=i(Id);ww=s(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),Tw=s(uc," forward method, overrides the "),Np=r(uc,"CODE",{});var Xx=i(Np);$w=s(Xx,"__call__"),Xx.forEach(t),Fw=s(uc," special method."),uc.forEach(t),xw=u(Co),w(qs.$$.fragment,Co),Rw=u(Co),w(Ps.$$.fragment,Co),Ew=u(Co),w(Ls.$$.fragment,Co),Co.forEach(t),ao.forEach(t),Mf=u(o),cn=r(o,"H2",{class:!0});var Om=i(cn);As=r(Om,"A",{id:!0,class:!0,href:!0});var Yx=i(As);Ip=r(Yx,"SPAN",{});var Zx=i(Ip);w(mi.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),Mw=u(Om),Dp=r(Om,"SPAN",{});var e4=i(Dp);zw=s(e4,"TFRobertaForMultipleChoice"),e4.forEach(t),Om.forEach(t),zf=u(o),mt=r(o,"DIV",{class:!0});var ro=i(mt);w(gi.$$.fragment,ro),jw=u(ro),Sp=r(ro,"P",{});var t4=i(Sp);Cw=s(t4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t4.forEach(t),qw=u(ro),_i=r(ro,"P",{});var Nm=i(_i);Pw=s(Nm,"This model inherits from "),Dd=r(Nm,"A",{href:!0});var o4=i(Dd);Lw=s(o4,"TFPreTrainedModel"),o4.forEach(t),Aw=s(Nm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nm.forEach(t),Ow=u(ro),bi=r(ro,"P",{});var Im=i(bi);Nw=s(Im,"This model is also a "),ki=r(Im,"A",{href:!0,rel:!0});var n4=i(ki);Iw=s(n4,"tf.keras.Model"),n4.forEach(t),Dw=s(Im,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Im.forEach(t),Sw=u(ro),w(Os.$$.fragment,ro),Bw=u(ro),Vt=r(ro,"DIV",{class:!0});var wa=i(Vt);w(vi.$$.fragment,wa),Ww=u(wa),pn=r(wa,"P",{});var fc=i(pn);Uw=s(fc,"The "),Sd=r(fc,"A",{href:!0});var s4=i(Sd);Hw=s(s4,"TFRobertaForMultipleChoice"),s4.forEach(t),Qw=s(fc," forward method, overrides the "),Bp=r(fc,"CODE",{});var a4=i(Bp);Kw=s(a4,"__call__"),a4.forEach(t),Jw=s(fc," special method."),fc.forEach(t),Vw=u(wa),w(Ns.$$.fragment,wa),Gw=u(wa),w(Is.$$.fragment,wa),wa.forEach(t),ro.forEach(t),jf=u(o),hn=r(o,"H2",{class:!0});var Dm=i(hn);Ds=r(Dm,"A",{id:!0,class:!0,href:!0});var r4=i(Ds);Wp=r(r4,"SPAN",{});var i4=i(Wp);w(yi.$$.fragment,i4),i4.forEach(t),r4.forEach(t),Xw=u(Dm),Up=r(Dm,"SPAN",{});var l4=i(Up);Yw=s(l4,"TFRobertaForTokenClassification"),l4.forEach(t),Dm.forEach(t),Cf=u(o),gt=r(o,"DIV",{class:!0});var io=i(gt);w(wi.$$.fragment,io),Zw=u(io),Hp=r(io,"P",{});var d4=i(Hp);eT=s(d4,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d4.forEach(t),tT=u(io),Ti=r(io,"P",{});var Sm=i(Ti);oT=s(Sm,"This model inherits from "),Bd=r(Sm,"A",{href:!0});var c4=i(Bd);nT=s(c4,"TFPreTrainedModel"),c4.forEach(t),sT=s(Sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sm.forEach(t),aT=u(io),$i=r(io,"P",{});var Bm=i($i);rT=s(Bm,"This model is also a "),Fi=r(Bm,"A",{href:!0,rel:!0});var p4=i(Fi);iT=s(p4,"tf.keras.Model"),p4.forEach(t),lT=s(Bm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bm.forEach(t),dT=u(io),w(Ss.$$.fragment,io),cT=u(io),Ct=r(io,"DIV",{class:!0});var qo=i(Ct);w(xi.$$.fragment,qo),pT=u(qo),un=r(qo,"P",{});var mc=i(un);hT=s(mc,"The "),Wd=r(mc,"A",{href:!0});var h4=i(Wd);uT=s(h4,"TFRobertaForTokenClassification"),h4.forEach(t),fT=s(mc," forward method, overrides the "),Qp=r(mc,"CODE",{});var u4=i(Qp);mT=s(u4,"__call__"),u4.forEach(t),gT=s(mc," special method."),mc.forEach(t),_T=u(qo),w(Bs.$$.fragment,qo),bT=u(qo),w(Ws.$$.fragment,qo),kT=u(qo),w(Us.$$.fragment,qo),qo.forEach(t),io.forEach(t),qf=u(o),fn=r(o,"H2",{class:!0});var Wm=i(fn);Hs=r(Wm,"A",{id:!0,class:!0,href:!0});var f4=i(Hs);Kp=r(f4,"SPAN",{});var m4=i(Kp);w(Ri.$$.fragment,m4),m4.forEach(t),f4.forEach(t),vT=u(Wm),Jp=r(Wm,"SPAN",{});var g4=i(Jp);yT=s(g4,"TFRobertaForQuestionAnswering"),g4.forEach(t),Wm.forEach(t),Pf=u(o),_t=r(o,"DIV",{class:!0});var lo=i(_t);w(Ei.$$.fragment,lo),wT=u(lo),mn=r(lo,"P",{});var gc=i(mn);TT=s(gc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Vp=r(gc,"CODE",{});var _4=i(Vp);$T=s(_4,"span start logits"),_4.forEach(t),FT=s(gc," and "),Gp=r(gc,"CODE",{});var b4=i(Gp);xT=s(b4,"span end logits"),b4.forEach(t),RT=s(gc,")."),gc.forEach(t),ET=u(lo),Mi=r(lo,"P",{});var Um=i(Mi);MT=s(Um,"This model inherits from "),Ud=r(Um,"A",{href:!0});var k4=i(Ud);zT=s(k4,"TFPreTrainedModel"),k4.forEach(t),jT=s(Um,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Um.forEach(t),CT=u(lo),zi=r(lo,"P",{});var Hm=i(zi);qT=s(Hm,"This model is also a "),ji=r(Hm,"A",{href:!0,rel:!0});var v4=i(ji);PT=s(v4,"tf.keras.Model"),v4.forEach(t),LT=s(Hm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hm.forEach(t),AT=u(lo),w(Qs.$$.fragment,lo),OT=u(lo),qt=r(lo,"DIV",{class:!0});var Po=i(qt);w(Ci.$$.fragment,Po),NT=u(Po),gn=r(Po,"P",{});var _c=i(gn);IT=s(_c,"The "),Hd=r(_c,"A",{href:!0});var y4=i(Hd);DT=s(y4,"TFRobertaForQuestionAnswering"),y4.forEach(t),ST=s(_c," forward method, overrides the "),Xp=r(_c,"CODE",{});var w4=i(Xp);BT=s(w4,"__call__"),w4.forEach(t),WT=s(_c," special method."),_c.forEach(t),UT=u(Po),w(Ks.$$.fragment,Po),HT=u(Po),w(Js.$$.fragment,Po),QT=u(Po),w(Vs.$$.fragment,Po),Po.forEach(t),lo.forEach(t),Lf=u(o),_n=r(o,"H2",{class:!0});var Qm=i(_n);Gs=r(Qm,"A",{id:!0,class:!0,href:!0});var T4=i(Gs);Yp=r(T4,"SPAN",{});var $4=i(Yp);w(qi.$$.fragment,$4),$4.forEach(t),T4.forEach(t),KT=u(Qm),Zp=r(Qm,"SPAN",{});var F4=i(Zp);JT=s(F4,"FlaxRobertaModel"),F4.forEach(t),Qm.forEach(t),Af=u(o),nt=r(o,"DIV",{class:!0});var At=i(nt);w(Pi.$$.fragment,At),VT=u(At),eh=r(At,"P",{});var x4=i(eh);GT=s(x4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x4.forEach(t),XT=u(At),Li=r(At,"P",{});var Km=i(Li);YT=s(Km,"This model inherits from "),Qd=r(Km,"A",{href:!0});var R4=i(Qd);ZT=s(R4,"FlaxPreTrainedModel"),R4.forEach(t),e$=s(Km,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Km.forEach(t),t$=u(At),Ai=r(At,"P",{});var Jm=i(Ai);o$=s(Jm,"This model is also a Flax Linen "),Oi=r(Jm,"A",{href:!0,rel:!0});var E4=i(Oi);n$=s(E4,"flax.linen.Module"),E4.forEach(t),s$=s(Jm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Jm.forEach(t),a$=u(At),th=r(At,"P",{});var M4=i(th);r$=s(M4,"Finally, this model supports inherent JAX features such as:"),M4.forEach(t),i$=u(At),po=r(At,"UL",{});var Ta=i(po);oh=r(Ta,"LI",{});var z4=i(oh);Ni=r(z4,"A",{href:!0,rel:!0});var j4=i(Ni);l$=s(j4,"Just-In-Time (JIT) compilation"),j4.forEach(t),z4.forEach(t),d$=u(Ta),nh=r(Ta,"LI",{});var C4=i(nh);Ii=r(C4,"A",{href:!0,rel:!0});var q4=i(Ii);c$=s(q4,"Automatic Differentiation"),q4.forEach(t),C4.forEach(t),p$=u(Ta),sh=r(Ta,"LI",{});var P4=i(sh);Di=r(P4,"A",{href:!0,rel:!0});var L4=i(Di);h$=s(L4,"Vectorization"),L4.forEach(t),P4.forEach(t),u$=u(Ta),ah=r(Ta,"LI",{});var A4=i(ah);Si=r(A4,"A",{href:!0,rel:!0});var O4=i(Si);f$=s(O4,"Parallelization"),O4.forEach(t),A4.forEach(t),Ta.forEach(t),m$=u(At),Gt=r(At,"DIV",{class:!0});var $a=i(Gt);w(Bi.$$.fragment,$a),g$=u($a),bn=r($a,"P",{});var bc=i(bn);_$=s(bc,"The "),rh=r(bc,"CODE",{});var N4=i(rh);b$=s(N4,"FlaxRobertaPreTrainedModel"),N4.forEach(t),k$=s(bc," forward method, overrides the "),ih=r(bc,"CODE",{});var I4=i(ih);v$=s(I4,"__call__"),I4.forEach(t),y$=s(bc," special method."),bc.forEach(t),w$=u($a),w(Xs.$$.fragment,$a),T$=u($a),w(Ys.$$.fragment,$a),$a.forEach(t),At.forEach(t),Of=u(o),kn=r(o,"H2",{class:!0});var Vm=i(kn);Zs=r(Vm,"A",{id:!0,class:!0,href:!0});var D4=i(Zs);lh=r(D4,"SPAN",{});var S4=i(lh);w(Wi.$$.fragment,S4),S4.forEach(t),D4.forEach(t),$$=u(Vm),dh=r(Vm,"SPAN",{});var B4=i(dh);F$=s(B4,"FlaxRobertaForCausalLM"),B4.forEach(t),Vm.forEach(t),Nf=u(o),st=r(o,"DIV",{class:!0});var Ot=i(st);w(Ui.$$.fragment,Ot),x$=u(Ot),ch=r(Ot,"P",{});var W4=i(ch);R$=s(W4,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),W4.forEach(t),E$=u(Ot),Hi=r(Ot,"P",{});var Gm=i(Hi);M$=s(Gm,"This model inherits from "),Kd=r(Gm,"A",{href:!0});var U4=i(Kd);z$=s(U4,"FlaxPreTrainedModel"),U4.forEach(t),j$=s(Gm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gm.forEach(t),C$=u(Ot),Qi=r(Ot,"P",{});var Xm=i(Qi);q$=s(Xm,"This model is also a Flax Linen "),Ki=r(Xm,"A",{href:!0,rel:!0});var H4=i(Ki);P$=s(H4,"flax.linen.Module"),H4.forEach(t),L$=s(Xm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Xm.forEach(t),A$=u(Ot),ph=r(Ot,"P",{});var Q4=i(ph);O$=s(Q4,"Finally, this model supports inherent JAX features such as:"),Q4.forEach(t),N$=u(Ot),ho=r(Ot,"UL",{});var Fa=i(ho);hh=r(Fa,"LI",{});var K4=i(hh);Ji=r(K4,"A",{href:!0,rel:!0});var J4=i(Ji);I$=s(J4,"Just-In-Time (JIT) compilation"),J4.forEach(t),K4.forEach(t),D$=u(Fa),uh=r(Fa,"LI",{});var V4=i(uh);Vi=r(V4,"A",{href:!0,rel:!0});var G4=i(Vi);S$=s(G4,"Automatic Differentiation"),G4.forEach(t),V4.forEach(t),B$=u(Fa),fh=r(Fa,"LI",{});var X4=i(fh);Gi=r(X4,"A",{href:!0,rel:!0});var Y4=i(Gi);W$=s(Y4,"Vectorization"),Y4.forEach(t),X4.forEach(t),U$=u(Fa),mh=r(Fa,"LI",{});var Z4=i(mh);Xi=r(Z4,"A",{href:!0,rel:!0});var eR=i(Xi);H$=s(eR,"Parallelization"),eR.forEach(t),Z4.forEach(t),Fa.forEach(t),Q$=u(Ot),Xt=r(Ot,"DIV",{class:!0});var xa=i(Xt);w(Yi.$$.fragment,xa),K$=u(xa),vn=r(xa,"P",{});var kc=i(vn);J$=s(kc,"The "),gh=r(kc,"CODE",{});var tR=i(gh);V$=s(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),G$=s(kc," forward method, overrides the "),_h=r(kc,"CODE",{});var oR=i(_h);X$=s(oR,"__call__"),oR.forEach(t),Y$=s(kc," special method."),kc.forEach(t),Z$=u(xa),w(ea.$$.fragment,xa),e2=u(xa),w(ta.$$.fragment,xa),xa.forEach(t),Ot.forEach(t),If=u(o),yn=r(o,"H2",{class:!0});var Ym=i(yn);oa=r(Ym,"A",{id:!0,class:!0,href:!0});var nR=i(oa);bh=r(nR,"SPAN",{});var sR=i(bh);w(Zi.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t2=u(Ym),kh=r(Ym,"SPAN",{});var aR=i(kh);o2=s(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Ym.forEach(t),Df=u(o),at=r(o,"DIV",{class:!0});var Nt=i(at);w(el.$$.fragment,Nt),n2=u(Nt),tl=r(Nt,"P",{});var Zm=i(tl);s2=s(Zm,"RoBERTa Model with a "),vh=r(Zm,"CODE",{});var rR=i(vh);a2=s(rR,"language modeling"),rR.forEach(t),r2=s(Zm," head on top."),Zm.forEach(t),i2=u(Nt),ol=r(Nt,"P",{});var eg=i(ol);l2=s(eg,"This model inherits from "),Jd=r(eg,"A",{href:!0});var iR=i(Jd);d2=s(iR,"FlaxPreTrainedModel"),iR.forEach(t),c2=s(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),p2=u(Nt),nl=r(Nt,"P",{});var tg=i(nl);h2=s(tg,"This model is also a Flax Linen "),sl=r(tg,"A",{href:!0,rel:!0});var lR=i(sl);u2=s(lR,"flax.linen.Module"),lR.forEach(t),f2=s(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tg.forEach(t),m2=u(Nt),yh=r(Nt,"P",{});var dR=i(yh);g2=s(dR,"Finally, this model supports inherent JAX features such as:"),dR.forEach(t),_2=u(Nt),uo=r(Nt,"UL",{});var Ra=i(uo);wh=r(Ra,"LI",{});var cR=i(wh);al=r(cR,"A",{href:!0,rel:!0});var pR=i(al);b2=s(pR,"Just-In-Time (JIT) compilation"),pR.forEach(t),cR.forEach(t),k2=u(Ra),Th=r(Ra,"LI",{});var hR=i(Th);rl=r(hR,"A",{href:!0,rel:!0});var uR=i(rl);v2=s(uR,"Automatic Differentiation"),uR.forEach(t),hR.forEach(t),y2=u(Ra),$h=r(Ra,"LI",{});var fR=i($h);il=r(fR,"A",{href:!0,rel:!0});var mR=i(il);w2=s(mR,"Vectorization"),mR.forEach(t),fR.forEach(t),T2=u(Ra),Fh=r(Ra,"LI",{});var gR=i(Fh);ll=r(gR,"A",{href:!0,rel:!0});var _R=i(ll);$2=s(_R,"Parallelization"),_R.forEach(t),gR.forEach(t),Ra.forEach(t),F2=u(Nt),Yt=r(Nt,"DIV",{class:!0});var Ea=i(Yt);w(dl.$$.fragment,Ea),x2=u(Ea),wn=r(Ea,"P",{});var vc=i(wn);R2=s(vc,"The "),xh=r(vc,"CODE",{});var bR=i(xh);E2=s(bR,"FlaxRobertaPreTrainedModel"),bR.forEach(t),M2=s(vc," forward method, overrides the "),Rh=r(vc,"CODE",{});var kR=i(Rh);z2=s(kR,"__call__"),kR.forEach(t),j2=s(vc," special method."),vc.forEach(t),C2=u(Ea),w(na.$$.fragment,Ea),q2=u(Ea),w(sa.$$.fragment,Ea),Ea.forEach(t),Nt.forEach(t),Sf=u(o),Tn=r(o,"H2",{class:!0});var og=i(Tn);aa=r(og,"A",{id:!0,class:!0,href:!0});var vR=i(aa);Eh=r(vR,"SPAN",{});var yR=i(Eh);w(cl.$$.fragment,yR),yR.forEach(t),vR.forEach(t),P2=u(og),Mh=r(og,"SPAN",{});var wR=i(Mh);L2=s(wR,"FlaxRobertaForSequenceClassification"),wR.forEach(t),og.forEach(t),Bf=u(o),rt=r(o,"DIV",{class:!0});var It=i(rt);w(pl.$$.fragment,It),A2=u(It),zh=r(It,"P",{});var TR=i(zh);O2=s(TR,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),TR.forEach(t),N2=u(It),hl=r(It,"P",{});var ng=i(hl);I2=s(ng,"This model inherits from "),Vd=r(ng,"A",{href:!0});var $R=i(Vd);D2=s($R,"FlaxPreTrainedModel"),$R.forEach(t),S2=s(ng,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ng.forEach(t),B2=u(It),ul=r(It,"P",{});var sg=i(ul);W2=s(sg,"This model is also a Flax Linen "),fl=r(sg,"A",{href:!0,rel:!0});var FR=i(fl);U2=s(FR,"flax.linen.Module"),FR.forEach(t),H2=s(sg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),sg.forEach(t),Q2=u(It),jh=r(It,"P",{});var xR=i(jh);K2=s(xR,"Finally, this model supports inherent JAX features such as:"),xR.forEach(t),J2=u(It),fo=r(It,"UL",{});var Ma=i(fo);Ch=r(Ma,"LI",{});var RR=i(Ch);ml=r(RR,"A",{href:!0,rel:!0});var ER=i(ml);V2=s(ER,"Just-In-Time (JIT) compilation"),ER.forEach(t),RR.forEach(t),G2=u(Ma),qh=r(Ma,"LI",{});var MR=i(qh);gl=r(MR,"A",{href:!0,rel:!0});var zR=i(gl);X2=s(zR,"Automatic Differentiation"),zR.forEach(t),MR.forEach(t),Y2=u(Ma),Ph=r(Ma,"LI",{});var jR=i(Ph);_l=r(jR,"A",{href:!0,rel:!0});var CR=i(_l);Z2=s(CR,"Vectorization"),CR.forEach(t),jR.forEach(t),e1=u(Ma),Lh=r(Ma,"LI",{});var qR=i(Lh);bl=r(qR,"A",{href:!0,rel:!0});var PR=i(bl);t1=s(PR,"Parallelization"),PR.forEach(t),qR.forEach(t),Ma.forEach(t),o1=u(It),Zt=r(It,"DIV",{class:!0});var za=i(Zt);w(kl.$$.fragment,za),n1=u(za),$n=r(za,"P",{});var yc=i($n);s1=s(yc,"The "),Ah=r(yc,"CODE",{});var LR=i(Ah);a1=s(LR,"FlaxRobertaPreTrainedModel"),LR.forEach(t),r1=s(yc," forward method, overrides the "),Oh=r(yc,"CODE",{});var AR=i(Oh);i1=s(AR,"__call__"),AR.forEach(t),l1=s(yc," special method."),yc.forEach(t),d1=u(za),w(ra.$$.fragment,za),c1=u(za),w(ia.$$.fragment,za),za.forEach(t),It.forEach(t),Wf=u(o),Fn=r(o,"H2",{class:!0});var ag=i(Fn);la=r(ag,"A",{id:!0,class:!0,href:!0});var OR=i(la);Nh=r(OR,"SPAN",{});var NR=i(Nh);w(vl.$$.fragment,NR),NR.forEach(t),OR.forEach(t),p1=u(ag),Ih=r(ag,"SPAN",{});var IR=i(Ih);h1=s(IR,"FlaxRobertaForMultipleChoice"),IR.forEach(t),ag.forEach(t),Uf=u(o),it=r(o,"DIV",{class:!0});var Dt=i(it);w(yl.$$.fragment,Dt),u1=u(Dt),Dh=r(Dt,"P",{});var DR=i(Dh);f1=s(DR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
