...
<span class="hljs-literal">True</span>`}}),{c(){l=n("p"),b=i("Example:"),p=m(),v(u.$$.fragment)},l(r){l=a(r,"P",{});var g=s(l);b=d(g,"Example:"),g.forEach(o),p=f(r),y(u.$$.fragment,r)},m(r,g){_(r,l,g),e(l,b),_(r,p,g),T(u,r,g),k=!0},p:me,i(r){k||(w(u.$$.fragment,r),k=!0)},o(r){P(u.$$.fragment,r),k=!1},d(r){r&&o(l),r&&o(p),L(u,r)}}}function Dd($){let l,b,p,u,k,r,g,x,ta,rn,D,io,oa,na,We,aa,sa,He,ra,ia,dn,K,fe,lo,Ue,da,co,la,ln,W,ca,Ve,pa,ha,po,ua,ma,cn,At,fa,pn,Nt,ho,ga,hn,H,_a,Je,ba,ka,Ke,va,ya,un,Q,ge,uo,Qe,Ta,mo,wa,mn,C,Pa,fo,La,$a,go,Ba,qa,_o,za,xa,bo,Ca,Fa,fn,_e,Ea,Ye,ja,Ma,gn,S,Sa,Ze,ko,Aa,Na,Oa,vo,Ia,Da,yo,Xa,Ga,_n,Ot,To,Ra,bn,et,kn,It,tt,wo,Wa,Ha,Y,Ua,Po,Va,Ja,Lo,Ka,Qa,vn,ot,yn,Z,be,$o,nt,Ya,Bo,Za,Tn,E,at,es,ee,ts,Dt,os,ns,st,as,ss,rs,te,is,Xt,ds,ls,Gt,cs,ps,hs,ke,wn,oe,ve,qo,rt,us,zo,ms,Pn,q,it,fs,xo,gs,_s,X,bs,Rt,ks,vs,Wt,ys,Ts,dt,ws,Ps,Ls,ne,$s,Co,Bs,qs,Fo,zs,xs,Cs,ye,Fs,A,lt,Es,ct,js,Eo,Ms,Ss,As,pt,ht,jo,Ns,Os,Mo,Is,Ds,ut,So,Xs,Gs,Ao,Rs,Ws,No,Hs,Ln,ae,Te,Oo,mt,Us,Io,Vs,$n,j,ft,Js,gt,Ks,Ht,Qs,Ys,Zs,_t,er,bt,tr,or,nr,N,kt,ar,se,sr,Ut,rr,ir,Do,dr,lr,cr,we,pr,Pe,Bn,re,Le,Xo,vt,hr,Go,ur,qn,M,yt,mr,Tt,fr,Vt,gr,_r,br,wt,kr,Pt,vr,yr,Tr,O,Lt,wr,ie,Pr,Jt,Lr,$r,Ro,Br,qr,zr,$e,xr,Be,zn,de,qe,Wo,$t,Cr,Ho,Fr,xn,z,Bt,Er,Uo,jr,Mr,qt,Sr,Kt,Ar,Nr,Or,zt,Ir,xt,Dr,Xr,Gr,B,Ct,Rr,le,Wr,Qt,Hr,Ur,Vo,Vr,Jr,Kr,ze,Qr,xe,Yr,Ce,Zr,Fe,ei,Ee,Cn,ce,je,Jo,Ft,ti,Ko,oi,Fn,pe,Et,ni,Me,jt,ai,Se,En;return r=new he({}),Ue=new he({}),Qe=new he({}),et=new R({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.23.0/en/model_doc/plbart#transformers.PLBartModel">PLBartModel</a>.`,name:"vocab_size"},{anchor:"transformers.PLBartConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/plbart/tokenization_plbart.py#L320",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/plbart#transformers.PLBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/plbart/modeling_plbart.py#L1283",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/plbart/modeling_plbart.py#L1422",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/plbart/modeling_plbart.py#L1577",returnDescription:`
<p>A <a
...
source and target text. The source text format is `),fo=n("code"),La=i("X [eos, src_lang_code]"),$a=i(" where "),go=n("code"),Ba=i("X"),qa=i(` is the source text. The
...
example shows how to translate Python to English using the `),Lo=n("code"),Ka=i("uclanlp/plbart-python-en_XX"),Qa=i(" model."),vn=m(),v(ot.$$.fragment),yn=m(),Z=n("h2"),be=n("a"),$o=n("span"),v(nt.$$.fragment),Ya=m(),Bo=n("span"),Za=i("PLBartConfig"),Tn=m(),E=n("div"),v(at.$$.fragment),es=m(),ee=n("p"),ts=i("This is the configuration class to store the configuration of a "),Dt=n("a"),os=i("PLBartModel"),ns=i(`. It is used to instantiate an
...
documentation from `),Gt=n("a"),cs=i("PretrainedConfig"),ps=i(" for more information."),hs=m(),v(ke.$$.fragment),wn=m(),oe=n("h2"),ve=n("a"),qo=n("span"),v(rt.$$.fragment),us=m(),zo=n("span"),ms=i("PLBartTokenizer"),Pn=m(),q=n("div"),v(it.$$.fragment),fs=m(),xo=n("p"),gs=i("Construct an PLBART tokenizer."),_s=m(),X=n("p"),bs=i("Adapted from "),Rt=n("a"),ks=i("RobertaTokenizer"),vs=i(" and "),Wt=n("a"),ys=i("XLNetTokenizer"),Ts=i(`. Based on
`),dt=n("a"),ws=i("SentencePiece"),Ps=i("."),Ls=m(),ne=n("p"),$s=i("The tokenization method is "),Co=n("code"),Bs=i("<tokens> <eos> <language code>"),qs=i(" for source language documents, and "),Fo=n("code"),zs=i("<language code> <tokens> <eos>"),xs=i(" for target language documents."),Cs=m(),v(ye.$$.fragment),Fs=m(),A=n("div"),v(lt.$$.fragment),Es=m(),ct=n("p"),js=i(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tr=m(),O=n("div"),v(Lt.$$.fragment),wr=m(),ie=n("p"),Pr=i("The "),Jt=n("a"),Lr=i("PLBartForConditionalGeneration"),$r=i(" forward method, overrides the "),Ro=n("code"),Br=i("__call__"),qr=i(" special method."),zr=m(),v($e.$$.fragment),xr=m(),v(Be.$$.fragment),zn=m(),de=n("h2"),qe=n("a"),Wo=n("span"),v($t.$$.fragment),Cr=m(),Ho=n("span"),Fr=i("PLBartForSequenceClassification"),xn=m(),z=n("div"),v(Bt.$$.fragment),Er=m(),Uo=n("p"),jr=i(`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Mr=m(),qt=n("p"),Sr=i("This model inherits from "),Kt=n("a"),Ar=i("PreTrainedModel"),Nr=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Or=m(),zt=n("p"),Ir=i("This model is also a PyTorch "),xt=n("a"),Dr=i("torch.nn.Module"),Xr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gr=m(),B=n("div"),v(Ct.$$.fragment),Rr=m(),le=n("p"),Wr=i("The "),Qt=n("a"),Hr=i("PLBartForSequenceClassification"),Ur=i(" forward method, overrides the "),Vo=n("code"),Vr=i("__call__"),Jr=i(" special method."),Kr=m(),v(ze.$$.fragment),Qr=m(),v(xe.$$.fragment),Yr=m(),v(Ce.$$.fragment),Zr=m(),v(Fe.$$.fragment),ei=m(),v(Ee.$$.fragment),Cn=m(),ce=n("h2"),je=n("a"),Jo=n("span"),v(Ft.$$.fragment),ti=m(),Ko=n("span"),oi=i("PLBartForCausalLM"),Fn=m(),pe=n("div"),v(Et.$$.fragment),ni=m(),Me=n("div"),v(jt.$$.fragment),ai=m(),v(Se.$$.fragment),this.h()},l(t){const h=Bd('[data-svelte="svelte-1phssyn"]',document.head);l=a(h,"META",{name:!0,content:!0}),h.forEach(o),b=f(t),p=a(t,"H1",{class:!0});var Mt=s(p);u=a(Mt,"A",{id:!0,class:!0,href:!0});var Qo=s(u);k=a(Qo,"SPAN",{});var Yo=s(k);y(r.$$.fragment,Yo),Yo.forEach(o),Qo.forEach(o),g=f(Mt),x=a(Mt,"SPAN",{});var Zo=s(x);ta=d(Zo,"PLBart"),Zo.forEach(o),Mt.forEach(o),rn=f(t),D=a(t,"P",{});var U=s(D);io=a(U,"STRONG",{});var en=s(io);oa=d(en,"DISCLAIMER:"),en.forEach(o),na=d(U," If you see something strange, file a "),We=a(U,"A",{href:!0,rel:!0});var tn=s(We);aa=d(tn,"Github Issue"),tn.forEach(o),sa=d(U,` and assign
...
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
source and target text. The source text format is `),fo=a(V,"CODE",{});var _i=s(fo);La=d(_i,"X [eos, src_lang_code]"),_i.forEach(o),$a=d(V," where "),go=a(V,"CODE",{});var bi=s(go);Ba=d(bi,"X"),bi.forEach(o),qa=d(V,` is the source text. The
...
it\u2019s passed with the `),yo=a(Ae,"CODE",{});var Pi=s(yo);Xa=d(Pi,"text_target"),Pi.forEach(o),Ga=d(Ae," keyword argument."),Ae.forEach(o),_n=f(t),Ot=a(t,"UL",{});var Li=s(Ot);To=a(Li,"LI",{});var $i=s(To);Ra=d($i,"Supervised training"),$i.forEach(o),Li.forEach(o),bn=f(t),y(et.$$.fragment,t),kn=f(t),It=a(t,"UL",{});var Bi=s(It);tt=a(Bi,"LI",{});var Sn=s(tt);wo=a(Sn,"P",{});var qi=s(wo);Wa=d(qi,"Generation"),qi.forEach(o),Ha=f(Sn),Y=a(Sn,"P",{});var eo=s(Y);Ua=d(eo,"While generating the target text set the "),Po=a(eo,"CODE",{});var zi=s(Po);Va=d(zi,"decoder_start_token_id"),zi.forEach(o),Ja=d(eo,` to the target language id. The following
example shows how to translate Python to English using the `),Lo=a(eo,"CODE",{});var xi=s(Lo);Ka=d(xi,"uclanlp/plbart-python-en_XX"),xi.forEach(o),Qa=d(eo," model."),eo.forEach(o),Sn.forEach(o),Bi.forEach(o),vn=f(t),y(ot.$$.fragment,t),yn=f(t),Z=a(t,"H2",{class:!0});var An=s(Z);be=a(An,"A",{id:!0,class:!0,href:!0});var Ci=s(be);$o=a(Ci,"SPAN",{});var Fi=s($o);y(nt.$$.fragment,Fi),Fi.forEach(o),Ci.forEach(o),Ya=f(An),Bo=a(An,"SPAN",{});var Ei=s(Bo);Za=d(Ei,"PLBartConfig"),Ei.forEach(o),An.forEach(o),Tn=f(t),E=a(t,"DIV",{class:!0});var Ne=s(E);y(at.$$.fragment,Ne),es=f(Ne),ee=a(Ne,"P",{});var to=s(ee);ts=d(to,"This is the configuration class to store the configuration of a "),Dt=a(to,"A",{href:!0});var ji=s(Dt);os=d(ji,"PLBartModel"),ji.forEach(o),ns=d(to,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
...
documentation from `),Gt=a(oo,"A",{href:!0});var Ai=s(Gt);cs=d(Ai,"PretrainedConfig"),Ai.forEach(o),ps=d(oo," for more information."),oo.forEach(o),hs=f(Ne),y(ke.$$.fragment,Ne),Ne.forEach(o),wn=f(t),oe=a(t,"H2",{class:!0});var Nn=s(oe);ve=a(Nn,"A",{id:!0,class:!0,href:!0});var Ni=s(ve);qo=a(Ni,"SPAN",{});var Oi=s(qo);y(rt.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),us=f(Nn),zo=a(Nn,"SPAN",{});var Ii=s(zo);ms=d(Ii,"PLBartTokenizer"),Ii.forEach(o),Nn.forEach(o),Pn=f(t),q=a(t,"DIV",{class:!0});var I=s(q);y(it.$$.fragment,I),fs=f(I),xo=a(I,"P",{});var Di=s(xo);gs=d(Di,"Construct an PLBART tokenizer."),Di.forEach(o),_s=f(I),X=a(I,"P",{});var Oe=s(X);bs=d(Oe,"Adapted from "),Rt=a(Oe,"A",{href:!0});var Xi=s(Rt);ks=d(Xi,"RobertaTokenizer"),Xi.forEach(o),vs=d(Oe," and "),Wt=a(Oe,"A",{href:!0});var Gi=s(Wt);ys=d(Gi,"XLNetTokenizer"),Gi.forEach(o),Ts=d(Oe,`. Based on
`),dt=a(Oe,"A",{href:!0,rel:!0});var Ri=s(dt);ws=d(Ri,"SentencePiece"),Ri.forEach(o),Ps=d(Oe,"."),Oe.forEach(o),Ls=f(I),ne=a(I,"P",{});var no=s(ne);$s=d(no,"The tokenization method is "),Co=a(no,"CODE",{});var Wi=s(Co);Bs=d(Wi,"<tokens> <eos> <language code>"),Wi.forEach(o),qs=d(no," for source language documents, and "),Fo=a(no,"CODE",{});var Hi=s(Fo);zs=d(Hi,"<language code> <tokens> <eos>"),Hi.forEach(o),xs=d(no," for target language documents."),no.forEach(o),Cs=f(I),y(ye.$$.fragment,I),Fs=f(I),A=a(I,"DIV",{class:!0});var Ie=s(A);y(lt.$$.fragment,Ie),Es=f(Ie),ct=a(Ie,"P",{});var On=s(ct);js=d(On,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vn.forEach(o),Tr=f(Ge),O=a(Ge,"DIV",{class:!0});var Re=s(O);y(Lt.$$.fragment,Re),wr=f(Re),ie=a(Re,"P",{});var so=s(ie);Pr=d(so,"The "),Jt=a(so,"A",{href:!0});var pd=s(Jt);Lr=d(pd,"PLBartForConditionalGeneration"),pd.forEach(o),$r=d(so," forward method, overrides the "),Ro=a(so,"CODE",{});var hd=s(Ro);Br=d(hd,"__call__"),hd.forEach(o),qr=d(so," special method."),so.forEach(o),zr=f(Re),y($e.$$.fragment,Re),xr=f(Re),y(Be.$$.fragment,Re),Re.forEach(o),Ge.forEach(o),zn=f(t),de=a(t,"H2",{class:!0});var Jn=s(de);qe=a(Jn,"A",{id:!0,class:!0,href:!0});var ud=s(qe);Wo=a(ud,"SPAN",{});var md=s(Wo);y($t.$$.fragment,md),md.forEach(o),ud.forEach(o),Cr=f(Jn),Ho=a(Jn,"SPAN",{});var fd=s(Ho);Fr=d(fd,"PLBartForSequenceClassification"),fd.forEach(o),Jn.forEach(o),xn=f(t),z=a(t,"DIV",{class:!0});var J=s(z);y(Bt.$$.fragment,J),Er=f(J),Uo=a(J,"P",{});var gd=s(Uo);jr=d(gd,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),gd.forEach(o),Mr=f(J),qt=a(J,"P",{});var Kn=s(qt);Sr=d(Kn,"This model inherits from "),Kt=a(Kn,"A",{href:!0});var _d=s(Kt);Ar=d(_d,"PreTrainedModel"),_d.forEach(o),Nr=d(Kn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
