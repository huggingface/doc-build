...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){d=n("p"),T=i("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),p=u(),b(f.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),_.forEach(o),p=m(r),k(f.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(f,r,_),v=!0},p:oo,i(r){v||(P(f.$$.fragment,r),v=!0)},o(r){y(f.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(p),$(f,r)}}}function ks(G){let d,T,p,f,v,r,_,X;return{c(){d=n("p"),T=i("When used with "),p=n("code"),f=i("is_split_into_words=True"),v=i(", this tokenizer needs to be instantiated with "),r=n("code"),_=i("add_prefix_space=True"),X=i(".")},l(I){d=s(I,"P",{});var z=a(d);T=l(z,"When used with "),p=s(z,"CODE",{});var M=a(p);f=l(M,"is_split_into_words=True"),M.forEach(o),v=l(z,", this tokenizer needs to be instantiated with "),r=s(z,"CODE",{});var q=a(r);_=l(q,"add_prefix_space=True"),q.forEach(o),X=l(z,"."),z.forEach(o)},m(I,z){g(I,d,z),t(d,T),t(d,p),t(p,f),t(d,v),t(d,r),t(r,_),t(d,X)},d(I){I&&o(d)}}}function ws(G){let d,T,p,f,v;return{c(){d=n("p"),T=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),f=i("Module"),v=i(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=i("Example:"),p=u(),b(f.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=m(r),k(f.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(f,r,_),v=!0},p:oo,i(r){v||(P(f.$$.fragment,r),v=!0)},o(r){y(f.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(p),$(f,r)}}}function ys(G){let d,T,p,f,v;return{c(){d=n("p"),T=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),f=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(_,"CODE",{});var X=a(p);f=l(X,"Module"),X.forEach(o),v=l(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(r,_){g(r,d,_),t(d,T),t(d,p),t(p,f),t(d,v)},d(r){r&&o(d)}}}function $s(G){let d,T,p,f,v;return f=new tt({props:{code:`from transformers import GPTNeoXTokenizerFast, GPTNeoXForCausalLM, GPTNeoXConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=u(),b(f.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=m(r),k(f.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(f,r,_),v=!0},p:oo,i(r){v||(P(f.$$.fragment,r),v=!0)},o(r){y(f.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(p),$(f,r)}}}function Ns(G){let d,T,p,f,v,r,_,X,I,z,M,q,ot,ue,no,nt,so,Nt,R,ao,me,ro,io,Gt,Y,lo,fe,co,po,Xt,Le,ho,xt,ge,zt,Oe,uo,Ft,L,K,st,_e,mo,at,fo,Mt,Q,go,rt,_o,To,Et,Te,Ct,O,Z,it,ve,vo,lt,bo,qt,F,be,ko,B,wo,Be,Po,yo,ke,$o,No,Go,D,Xo,De,xo,zo,Se,Fo,Mo,Eo,ee,jt,S,te,dt,we,Co,ct,qo,At,N,Pe,jo,ye,Ao,pt,Io,Lo,Oo,ht,Bo,Do,oe,So,$e,Wo,ut,Ho,Uo,Vo,ne,Jo,Ne,Ro,We,Yo,Ko,It,W,se,mt,Ge,Qo,ft,Zo,Lt,j,Xe,en,xe,tn,ze,on,nn,sn,E,Fe,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,un,re,Ot,U,ie,_t,Me,mn,Tt,fn,Bt,A,Ee,gn,V,_n,vt,Tn,vn,Ce,bn,kn,wn,C,qe,Pn,J,yn,Ue,$n,Nn,bt,Gn,Xn,xn,le,zn,de,Dt;return r=new Ie({}),ue=new Ie({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Ie({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
<span class="hljs-meta">&gt;&gt;&gt; </span>gen_text = tokenizer.batch_decode(gen_tokens)[<span class="hljs-number">0</span>]`}}),ve=new Ie({}),be=new et({props:{name:"class transformers.GPTNeoXConfig",anchor:"transformers.GPTNeoXConfig",parameters:[{name:"vocab_size",val:" = 50432"},{name:"hidden_size",val:" = 6144"},{name:"num_hidden_layers",val:" = 44"},{name:"num_attention_heads",val:" = 64"},{name:"intermediate_size",val:" = 24576"},{name:"hidden_act",val:" = 'gelu'"},{name:"rotary_pct",val:" = 0.25"},{name:"rotary_emb_base",val:" = 10000"},{name:"max_position_embeddings",val:" = 2048"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"tie_word_embeddings",val:" = False"},{name:"use_parallel_residual",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50432) &#x2014;
Vocabulary size of the GPTNeoX model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.23.0/en/model_doc/gpt_neox#transformers.GPTNeoXModel">GPTNeoXModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTNeoXConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 6144) &#x2014;
...
Example &#x2014;`,name:"use_parallel_residual"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/gpt_neox/configuration_gpt_neox.py#L29"}}),ee=new to({props:{anchor:"transformers.GPTNeoXConfig.example",$$slots:{default:[vs]},$$scope:{ctx:G}}}),we=new Ie({}),Pe=new et({props:{name:"class transformers.GPTNeoXTokenizerFast",anchor:"transformers.GPTNeoXTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"unk_token",val:" = '<|endoftext|>'"},{name:"bos_token",val:" = '<|endoftext|>'"},{name:"eos_token",val:" = '<|endoftext|>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/gpt_neox/tokenization_gpt_neox_fast.py#L44"}}),oe=new to({props:{anchor:"transformers.GPTNeoXTokenizerFast.example",$$slots:{default:[bs]},$$scope:{ctx:G}}}),ne=new Fn({props:{$$slots:{default:[ks]},$$scope:{ctx:G}}}),Ge=new Ie({}),Xe=new et({props:{name:"class transformers.GPTNeoXModel",anchor:"transformers.GPTNeoXModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.0/en/model_doc/gpt_neox#transformers.GPTNeoXConfig">~GPTNeoXConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L416"}}),Fe=new et({props:{name:"forward",anchor:"transformers.GPTNeoXModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/gpt_neox#transformers.GPTNeoXTokenizerFast">GPTNeoXTokenizerFast</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L434",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/gpt_neox#transformers.GPTNeoXConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L554"}}),qe=new et({props:{name:"forward",anchor:"transformers.GPTNeoXForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/gpt_neox#transformers.GPTNeoXTokenizerFast">GPTNeoXTokenizerFast</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L573",returnDescription:`
<p>A <a
...
`}}),le=new Fn({props:{$$slots:{default:[ys]},$$scope:{ctx:G}}}),de=new to({props:{anchor:"transformers.GPTNeoXForCausalLM.forward.example",$$slots:{default:[$s]},$$scope:{ctx:G}}}),{c(){d=n("meta"),T=u(),p=n("h1"),f=n("a"),v=n("span"),b(r.$$.fragment),_=u(),X=n("span"),I=i("GPT-NeoX"),z=u(),M=n("h2"),q=n("a"),ot=n("span"),b(ue.$$.fragment),no=u(),nt=n("span"),so=i("Overview"),Nt=u(),R=n("p"),ao=i(`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
...
the training and evaluation code, as well as the model weights, at `),me=n("a"),ro=i("https://github.com/EleutherAI/gpt-neox"),io=i("."),Gt=u(),Y=n("p"),lo=i(`Development of the model was led by Sid Black, Stella Biderman and Eric Hallahan, and the model was trained with
generous the support of `),fe=n("a"),co=i("CoreWeave"),po=i("."),Xt=u(),Le=n("p"),ho=i("GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),xt=u(),b(ge.$$.fragment),zt=u(),Oe=n("p"),uo=i(`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),Ft=u(),L=n("h3"),K=n("a"),st=n("span"),b(_e.$$.fragment),mo=u(),at=n("span"),fo=i("Generation"),Mt=u(),Q=n("p"),go=i("The "),rt=n("code"),_o=i("generate()"),To=i(" method can be used to generate text using GPT Neo model."),Et=u(),b(Te.$$.fragment),Ct=u(),O=n("h2"),Z=n("a"),it=n("span"),b(ve.$$.fragment),vo=u(),lt=n("span"),bo=i("GPTNeoXConfig"),qt=u(),F=n("div"),b(be.$$.fragment),ko=u(),B=n("p"),wo=i("This is the configuration class to store the configuration of a "),Be=n("a"),Po=i("GPTNeoXModel"),yo=i(`. It is used to instantiate an
GPTNeoX model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the GPTNeoX
`),ke=n("a"),$o=i("EleutherAI/gpt-neox-20b"),No=i(" architecture."),Go=u(),D=n("p"),Xo=i("Configuration objects inherit from "),De=n("a"),xo=i("PretrainedConfig"),zo=i(` and can be used to control the model outputs. Read the
documentation from `),Se=n("a"),Fo=i("PretrainedConfig"),Mo=i(" for more information."),Eo=u(),b(ee.$$.fragment),jt=u(),S=n("h2"),te=n("a"),dt=n("span"),b(we.$$.fragment),Co=u(),ct=n("span"),qo=i("GPTNeoXTokenizerFast"),At=u(),N=n("div"),b(Pe.$$.fragment),jo=u(),ye=n("p"),Ao=i("Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=n("em"),Io=i("tokenizers"),Lo=i(` library). Based on byte-level
Byte-Pair-Encoding.`),Oo=u(),ht=n("p"),Bo=i("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Do=u(),b(oe.$$.fragment),So=u(),$e=n("p"),Wo=i("You can get around that behavior by passing "),ut=n("code"),Ho=i("add_prefix_space=True"),Uo=i(` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),Vo=u(),b(ne.$$.fragment),Jo=u(),Ne=n("p"),Ro=i("This tokenizer inherits from "),We=n("a"),Yo=i("PreTrainedTokenizerFast"),Ko=i(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),It=u(),W=n("h2"),se=n("a"),mt=n("span"),b(Ge.$$.fragment),Qo=u(),ft=n("span"),Zo=i("GPTNeoXModel"),Lt=u(),j=n("div"),b(Xe.$$.fragment),en=u(),xe=n("p"),tn=i(`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=n("a"),on=i("torch.nn.Module"),nn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn=u(),E=n("div"),b(Fe.$$.fragment),an=u(),H=n("p"),rn=i("The "),He=n("a"),ln=i("GPTNeoXModel"),dn=i(" forward method, overrides the "),gt=n("code"),cn=i("__call__"),pn=i(" special method."),hn=u(),b(ae.$$.fragment),un=u(),b(re.$$.fragment),Ot=u(),U=n("h2"),ie=n("a"),_t=n("span"),b(Me.$$.fragment),mn=u(),Tt=n("span"),fn=i("GPTNeoXForCausalLM"),Bt=u(),A=n("div"),b(Ee.$$.fragment),gn=u(),V=n("p"),_n=i("GPTNeoX Model with a "),vt=n("code"),Tn=i("language modeling"),vn=i(` head on top for CLM fine-tuning.
This model is a PyTorch `),Ce=n("a"),bn=i("torch.nn.Module"),kn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wn=u(),C=n("div"),b(qe.$$.fragment),Pn=u(),J=n("p"),yn=i("The "),Ue=n("a"),$n=i("GPTNeoXForCausalLM"),Nn=i(" forward method, overrides the "),bt=n("code"),Gn=i("__call__"),Xn=i(" special method."),xn=u(),b(le.$$.fragment),zn=u(),b(de.$$.fragment),this.h()},l(e){const c=_s('[data-svelte="svelte-1phssyn"]',document.head);d=s(c,"META",{name:!0,content:!0}),c.forEach(o),T=m(e),p=s(e,"H1",{class:!0});var je=a(p);f=s(je,"A",{id:!0,class:!0,href:!0});var kt=a(f);v=s(kt,"SPAN",{});var wt=a(v);k(r.$$.fragment,wt),wt.forEach(o),kt.forEach(o),_=m(je),X=s(je,"SPAN",{});var Pt=a(X);I=l(Pt,"GPT-NeoX"),Pt.forEach(o),je.forEach(o),z=m(e),M=s(e,"H2",{class:!0});var Ae=a(M);q=s(Ae,"A",{id:!0,class:!0,href:!0});var yt=a(q);ot=s(yt,"SPAN",{});var $t=a(ot);k(ue.$$.fragment,$t),$t.forEach(o),yt.forEach(o),no=m(Ae),nt=s(Ae,"SPAN",{});var Mn=a(nt);so=l(Mn,"Overview"),Mn.forEach(o),Ae.forEach(o),Nt=m(e),R=s(e,"P",{});var St=a(R);ao=l(St,`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
be made freely and openly available to the public through a permissive license. It is, to the best of our knowledge,
the largest dense autoregressive model that has publicly available weights at the time of submission. In this work,
we describe GPT-NeoX-20B\u2019s architecture and training and evaluate its performance on a range of language-understanding,
mathematics, and knowledge-based tasks. We find that GPT-NeoX-20B is a particularly powerful few-shot reasoner and
gains far more in performance when evaluated five-shot than similarly sized GPT-3 and FairSeq models. We open-source
the training and evaluation code, as well as the model weights, at `),me=s(St,"A",{href:!0,rel:!0});var En=a(me);ro=l(En,"https://github.com/EleutherAI/gpt-neox"),En.forEach(o),io=l(St,"."),St.forEach(o),Gt=m(e),Y=s(e,"P",{});var Wt=a(Y);lo=l(Wt,`Development of the model was led by Sid Black, Stella Biderman and Eric Hallahan, and the model was trained with
generous the support of `),fe=s(Wt,"A",{href:!0,rel:!0});var Cn=a(fe);co=l(Cn,"CoreWeave"),Cn.forEach(o),po=l(Wt,"."),Wt.forEach(o),Xt=m(e),Le=s(e,"P",{});var qn=a(Le);ho=l(qn,"GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),qn.forEach(o),xt=m(e),k(ge.$$.fragment,e),zt=m(e),Oe=s(e,"P",{});var jn=a(Oe);uo=l(jn,`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),jn.forEach(o),Ft=m(e),L=s(e,"H3",{class:!0});var Ht=a(L);K=s(Ht,"A",{id:!0,class:!0,href:!0});var An=a(K);st=s(An,"SPAN",{});var In=a(st);k(_e.$$.fragment,In),In.forEach(o),An.forEach(o),mo=m(Ht),at=s(Ht,"SPAN",{});var Ln=a(at);fo=l(Ln,"Generation"),Ln.forEach(o),Ht.forEach(o),Mt=m(e),Q=s(e,"P",{});var Ut=a(Q);go=l(Ut,"The "),rt=s(Ut,"CODE",{});var On=a(rt);_o=l(On,"generate()"),On.forEach(o),To=l(Ut," method can be used to generate text using GPT Neo model."),Ut.forEach(o),Et=m(e),k(Te.$$.fragment,e),Ct=m(e),O=s(e,"H2",{class:!0});var Vt=a(O);Z=s(Vt,"A",{id:!0,class:!0,href:!0});var Bn=a(Z);it=s(Bn,"SPAN",{});var Dn=a(it);k(ve.$$.fragment,Dn),Dn.forEach(o),Bn.forEach(o),vo=m(Vt),lt=s(Vt,"SPAN",{});var Sn=a(lt);bo=l(Sn,"GPTNeoXConfig"),Sn.forEach(o),Vt.forEach(o),qt=m(e),F=s(e,"DIV",{class:!0});var ce=a(F);k(be.$$.fragment,ce),ko=m(ce),B=s(ce,"P",{});var Ve=a(B);wo=l(Ve,"This is the configuration class to store the configuration of a "),Be=s(Ve,"A",{href:!0});var Wn=a(Be);Po=l(Wn,"GPTNeoXModel"),Wn.forEach(o),yo=l(Ve,`. It is used to instantiate an
GPTNeoX model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the GPTNeoX
`),ke=s(Ve,"A",{href:!0,rel:!0});var Hn=a(ke);$o=l(Hn,"EleutherAI/gpt-neox-20b"),Hn.forEach(o),No=l(Ve," architecture."),Ve.forEach(o),Go=m(ce),D=s(ce,"P",{});var Je=a(D);Xo=l(Je,"Configuration objects inherit from "),De=s(Je,"A",{href:!0});var Un=a(De);xo=l(Un,"PretrainedConfig"),Un.forEach(o),zo=l(Je,` and can be used to control the model outputs. Read the
documentation from `),Se=s(Je,"A",{href:!0});var Vn=a(Se);Fo=l(Vn,"PretrainedConfig"),Vn.forEach(o),Mo=l(Je," for more information."),Je.forEach(o),Eo=m(ce),k(ee.$$.fragment,ce),ce.forEach(o),jt=m(e),S=s(e,"H2",{class:!0});var Jt=a(S);te=s(Jt,"A",{id:!0,class:!0,href:!0});var Jn=a(te);dt=s(Jn,"SPAN",{});var Rn=a(dt);k(we.$$.fragment,Rn),Rn.forEach(o),Jn.forEach(o),Co=m(Jt),ct=s(Jt,"SPAN",{});var Yn=a(ct);qo=l(Yn,"GPTNeoXTokenizerFast"),Yn.forEach(o),Jt.forEach(o),At=m(e),N=s(e,"DIV",{class:!0});var x=a(N);k(Pe.$$.fragment,x),jo=m(x),ye=s(x,"P",{});var Rt=a(ye);Ao=l(Rt,"Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=s(Rt,"EM",{});var Kn=a(pt);Io=l(Kn,"tokenizers"),Kn.forEach(o),Lo=l(Rt,` library). Based on byte-level
Byte-Pair-Encoding.`),Rt.forEach(o),Oo=m(x),ht=s(x,"P",{});var Qn=a(ht);Bo=l(Qn,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Qn.forEach(o),Do=m(x),k(oe.$$.fragment,x),So=m(x),$e=s(x,"P",{});var Yt=a($e);Wo=l(Yt,"You can get around that behavior by passing "),ut=s(Yt,"CODE",{});var Zn=a(ut);Ho=l(Zn,"add_prefix_space=True"),Zn.forEach(o),Uo=l(Yt,` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),Yt.forEach(o),Vo=m(x),k(ne.$$.fragment,x),Jo=m(x),Ne=s(x,"P",{});var Kt=a(Ne);Ro=l(Kt,"This tokenizer inherits from "),We=s(Kt,"A",{href:!0});var es=a(We);Yo=l(es,"PreTrainedTokenizerFast"),es.forEach(o),Ko=l(Kt,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Kt.forEach(o),x.forEach(o),It=m(e),W=s(e,"H2",{class:!0});var Qt=a(W);se=s(Qt,"A",{id:!0,class:!0,href:!0});var ts=a(se);mt=s(ts,"SPAN",{});var os=a(mt);k(Ge.$$.fragment,os),os.forEach(o),ts.forEach(o),Qo=m(Qt),ft=s(Qt,"SPAN",{});var ns=a(ft);Zo=l(ns,"GPTNeoXModel"),ns.forEach(o),Qt.forEach(o),Lt=m(e),j=s(e,"DIV",{class:!0});var Re=a(j);k(Xe.$$.fragment,Re),en=m(Re),xe=s(Re,"P",{});var Zt=a(xe);tn=l(Zt,`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=s(Zt,"A",{href:!0,rel:!0});var ss=a(ze);on=l(ss,"torch.nn.Module"),ss.forEach(o),nn=l(Zt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Zt.forEach(o),sn=m(Re),E=s(Re,"DIV",{class:!0});var pe=a(E);k(Fe.$$.fragment,pe),an=m(pe),H=s(pe,"P",{});var Ye=a(H);rn=l(Ye,"The "),He=s(Ye,"A",{href:!0});var as=a(He);ln=l(as,"GPTNeoXModel"),as.forEach(o),dn=l(Ye," forward method, overrides the "),gt=s(Ye,"CODE",{});var rs=a(gt);cn=l(rs,"__call__"),rs.forEach(o),pn=l(Ye," special method."),Ye.forEach(o),hn=m(pe),k(ae.$$.fragment,pe),un=m(pe),k(re.$$.fragment,pe),pe.forEach(o),Re.forEach(o),Ot=m(e),U=s(e,"H2",{class:!0});var eo=a(U);ie=s(eo,"A",{id:!0,class:!0,href:!0});var is=a(ie);_t=s(is,"SPAN",{});var ls=a(_t);k(Me.$$.fragment,ls),ls.forEach(o),is.forEach(o),mn=m(eo),Tt=s(eo,"SPAN",{});var ds=a(Tt);fn=l(ds,"GPTNeoXForCausalLM"),ds.forEach(o),eo.forEach(o),Bt=m(e),A=s(e,"DIV",{class:!0});var Ke=a(A);k(Ee.$$.fragment,Ke),gn=m(Ke),V=s(Ke,"P",{});var Qe=a(V);_n=l(Qe,"GPTNeoX Model with a "),vt=s(Qe,"CODE",{});var cs=a(vt);Tn=l(cs,"language modeling"),cs.forEach(o),vn=l(Qe,` head on top for CLM fine-tuning.
This model is a PyTorch `),Ce=s(Qe,"A",{href:!0,rel:!0});var ps=a(Ce);bn=l(ps,"torch.nn.Module"),ps.forEach(o),kn=l(Qe,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Qe.forEach(o),wn=m(Ke),C=s(Ke,"DIV",{class:!0});var he=a(C);k(qe.$$.fragment,he),Pn=m(he),J=s(he,"P",{});var Ze=a(J);yn=l(Ze,"The "),Ue=s(Ze,"A",{href:!0});var hs=a(Ue);$n=l(hs,"GPTNeoXForCausalLM"),hs.forEach(o),Nn=l(Ze," forward method, overrides the "),bt=s(Ze,"CODE",{});var us=a(bt);Gn=l(us,"__call__"),us.forEach(o),Xn=l(Ze," special method."),Ze.forEach(o),xn=m(he),k(le.$$.fragment,he),zn=m(he),k(de.$$.fragment,he),he.forEach(o),Ke.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(Gs)),h(f,"id","gptneox"),h(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(f,"href","#gptneox"),h(p,"class","relative group"),h(q,"id","overview"),h(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(q,"href","#overview"),h(M,"class","relative group"),h(me,"href","https://github.com/EleutherAI/gpt-neox"),h(me,"rel","nofollow"),h(fe,"href","https://www.coreweave.com/"),h(fe,"rel","nofollow"),h(K,"id","generation"),h(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(K,"href","#generation"),h(L,"class","relative group"),h(Z,"id","transformers.GPTNeoXConfig"),h(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Z,"href","#transformers.GPTNeoXConfig"),h(O,"class","relative group"),h(Be,"href","/docs/transformers/v4.23.0/en/model_doc/gpt_neox#transformers.GPTNeoXModel"),h(ke,"href","https://huggingface.co/EleutherAI/gpt-neox-20b"),h(ke,"rel","nofollow"),h(De,"href","/docs/transformers/v4.23.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(Se,"href","/docs/transformers/v4.23.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(te,"id","transformers.GPTNeoXTokenizerFast"),h(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(te,"href","#transformers.GPTNeoXTokenizerFast"),h(S,"class","relative group"),h(We,"href","/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(se,"id","transformers.GPTNeoXModel"),h(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(se,"href","#transformers.GPTNeoXModel"),h(W,"class","relative group"),h(ze,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(ze,"rel","nofollow"),h(He,"href","/docs/transformers/v4.23.0/en/model_doc/gpt_neox#transformers.GPTNeoXModel"),h(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ie,"id","transformers.GPTNeoXForCausalLM"),h(ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ie,"href","#transformers.GPTNeoXForCausalLM"),h(U,"class","relative group"),h(Ce,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Ce,"rel","nofollow"),h(Ue,"href","/docs/transformers/v4.23.0/en/model_doc/gpt_neox#transformers.GPTNeoXForCausalLM"),h(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,c){t(document.head,d),g(e,T,c),g(e,p,c),t(p,f),t(f,v),w(r,v,null),t(p,_),t(p,X),t(X,I),g(e,z,c),g(e,M,c),t(M,q),t(q,ot),w(ue,ot,null),t(M,no),t(M,nt),t(nt,so),g(e,Nt,c),g(e,R,c),t(R,ao),t(R,me),t(me,ro),t(R,io),g(e,Gt,c),g(e,Y,c),t(Y,lo),t(Y,fe),t(fe,co),t(Y,po),g(e,Xt,c),g(e,Le,c),t(Le,ho),g(e,xt,c),w(ge,e,c),g(e,zt,c),g(e,Oe,c),t(Oe,uo),g(e,Ft,c),g(e,L,c),t(L,K),t(K,st),w(_e,st,null),t(L,mo),t(L,at),t(at,fo),g(e,Mt,c),g(e,Q,c),t(Q,go),t(Q,rt),t(rt,_o),t(Q,To),g(e,Et,c),w(Te,e,c),g(e,Ct,c),g(e,O,c),t(O,Z),t(Z,it),w(ve,it,null),t(O,vo),t(O,lt),t(lt,bo),g(e,qt,c),g(e,F,c),w(be,F,null),t(F,ko),t(F,B),t(B,wo),t(B,Be),t(Be,Po),t(B,yo),t(B,ke),t(ke,$o),t(B,No),t(F,Go),t(F,D),t(D,Xo),t(D,De),t(De,xo),t(D,zo),t(D,Se),t(Se,Fo),t(D,Mo),t(F,Eo),w(ee,F,null),g(e,jt,c),g(e,S,c),t(S,te),t(te,dt),w(we,dt,null),t(S,Co),t(S,ct),t(ct,qo),g(e,At,c),g(e,N,c),w(Pe,N,null),t(N,jo),t(N,ye),t(ye,Ao),t(ye,pt),t(pt,Io),t(ye,Lo),t(N,Oo),t(N,ht),t(ht,Bo),t(N,Do),w(oe,N,null),t(N,So),t(N,$e),t($e,Wo),t($e,ut),t(ut,Ho),t($e,Uo),t(N,Vo),w(ne,N,null),t(N,Jo),t(N,Ne),t(Ne,Ro),t(Ne,We),t(We,Yo),t(Ne,Ko),g(e,It,c),g(e,W,c),t(W,se),t(se,mt),w(Ge,mt,null),t(W,Qo),t(W,ft),t(ft,Zo),g(e,Lt,c),g(e,j,c),w(Xe,j,null),t(j,en),t(j,xe),t(xe,tn),t(xe,ze),t(ze,on),t(xe,nn),t(j,sn),t(j,E),w(Fe,E,null),t(E,an),t(E,H),t(H,rn),t(H,He),t(He,ln),t(H,dn),t(H,gt),t(gt,cn),t(H,pn),t(E,hn),w(ae,E,null),t(E,un),w(re,E,null),g(e,Ot,c),g(e,U,c),t(U,ie),t(ie,_t),w(Me,_t,null),t(U,mn),t(U,Tt),t(Tt,fn),g(e,Bt,c),g(e,A,c),w(Ee,A,null),t(A,gn),t(A,V),t(V,_n),t(V,vt),t(vt,Tn),t(V,vn),t(V,Ce),t(Ce,bn),t(V,kn),t(A,wn),t(A,C),w(qe,C,null),t(C,Pn),t(C,J),t(J,yn),t(J,Ue),t(Ue,$n),t(J,Nn),t(J,bt),t(bt,Gn),t(J,Xn),t(C,xn),w(le,C,null),t(C,zn),w(de,C,null),Dt=!0},p(e,[c]){const je={};c&2&&(je.$$scope={dirty:c,ctx:e}),ee.$set(je);const kt={};c&2&&(kt.$$scope={dirty:c,ctx:e}),oe.$set(kt);const wt={};c&2&&(wt.$$scope={dirty:c,ctx:e}),ne.$set(wt);const Pt={};c&2&&(Pt.$$scope={dirty:c,ctx:e}),ae.$set(Pt);const Ae={};c&2&&(Ae.$$scope={dirty:c,ctx:e}),re.$set(Ae);const yt={};c&2&&(yt.$$scope={dirty:c,ctx:e}),le.$set(yt);const $t={};c&2&&($t.$$scope={dirty:c,ctx:e}),de.$set($t)},i(e){Dt||(P(r.$$.fragment,e),P(ue.$$.fragment,e),P(ge.$$.fragment,e),P(_e.$$.fragment,e),P(Te.$$.fragment,e),P(ve.$$.fragment,e),P(be.$$.fragment,e),P(ee.$$.fragment,e),P(we.$$.fragment,e),P(Pe.$$.fragment,e),P(oe.$$.fragment,e),P(ne.$$.fragment,e),P(Ge.$$.fragment,e),P(Xe.$$.fragment,e),P(Fe.$$.fragment,e),P(ae.$$.fragment,e),P(re.$$.fragment,e),P(Me.$$.fragment,e),P(Ee.$$.fragment,e),P(qe.$$.fragment,e),P(le.$$.fragment,e),P(de.$$.fragment,e),Dt=!0)},o(e){y(r.$$.fragment,e),y(ue.$$.fragment,e),y(ge.$$.fragment,e),y(_e.$$.fragment,e),y(Te.$$.fragment,e),y(ve.$$.fragment,e),y(be.$$.fragment,e),y(ee.$$.fragment,e),y(we.$$.fragment,e),y(Pe.$$.fragment,e),y(oe.$$.fragment,e),y(ne.$$.fragment,e),y(Ge.$$.fragment,e),y(Xe.$$.fragment,e),y(Fe.$$.fragment,e),y(ae.$$.fragment,e),y(re.$$.fragment,e),y(Me.$$.fragment,e),y(Ee.$$.fragment,e),y(qe.$$.fragment,e),y(le.$$.fragment,e),y(de.$$.fragment,e),Dt=!1},d(e){o(d),e&&o(T),e&&o(p),$(r),e&&o(z),e&&o(M),$(ue),e&&o(Nt),e&&o(R),e&&o(Gt),e&&o(Y),e&&o(Xt),e&&o(Le),e&&o(xt),$(ge,e),e&&o(zt),e&&o(Oe),e&&o(Ft),e&&o(L),$(_e),e&&o(Mt),e&&o(Q),e&&o(Et),$(Te,e),e&&o(Ct),e&&o(O),$(ve),e&&o(qt),e&&o(F),$(be),$(ee),e&&o(jt),e&&o(S),$(we),e&&o(At),e&&o(N),$(Pe),$(oe),$(ne),e&&o(It),e&&o(W),$(Ge),e&&o(Lt),e&&o(j),$(Xe),$(Fe),$(ae),$(re),e&&o(Ot),e&&o(U),$(Me),e&&o(Bt),e&&o(A),$(Ee),$(qe),$(le),$(de)}}}const Gs={local:"gptneox",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTNeoXConfig",title:"GPTNeoXConfig"},{local:"transformers.GPTNeoXTokenizerFast",title:"GPTNeoXTokenizerFast"},{local:"transformers.GPTNeoXModel",title:"GPTNeoXModel"},{local:"transformers.GPTNeoXForCausalLM",title:"GPTNeoXForCausalLM"}],title:"GPT-NeoX"};function Xs(G){return Ts(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class qs extends ms{constructor(d){super();fs(this,d,Xs,Ns,gs,{})}}export{qs as default,Gs as metadata};
