...
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/v4.23.0/en/model_doc/markuplm#transformers.MarkupLMModel">MarkupLMModel</a>.`,name:"vocab_size"},{anchor:"transformers.MarkupLMConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
The maximum depth in xpath.`,name:"max_depth"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/configuration_markuplm.py#L30"}}),ft=new Vs({props:{anchor:"transformers.MarkupLMConfig.example",$$slots:{default:[Hy]},$$scope:{ctx:P}}}),qo=new xe({}),$o=new z({props:{name:"class transformers.MarkupLMFeatureExtractor",anchor:"transformers.MarkupLMFeatureExtractor",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/feature_extraction_markuplm.py#L33"}}),zo=new z({props:{name:"__call__",anchor:"transformers.MarkupLMFeatureExtractor.__call__",parameters:[{name:"html_strings",val:""}],parametersDescription:[{anchor:"transformers.MarkupLMFeatureExtractor.__call__.html_strings",description:`<strong>html_strings</strong> (<code>str</code>, <code>List[str]</code>) &#x2014;
The HTML string or batch of HTML strings from which to extract nodes and corresponding xpaths.`,name:"html_strings"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/feature_extraction_markuplm.py#L99",returnDescription:`
<p>A <a
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/tokenization_markuplm.py#L423",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"special"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/tokenization_markuplm.py#L461",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/tokenization_markuplm.py#L486",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/tokenization_markuplm_fast.py#L878",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/tokenization_markuplm_fast.py#L900",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to use <code>MarkupLMFeatureExtractor</code> to parse HTML strings into nodes and corresponding xpaths.`,name:"parse_html"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/processing_markuplm.py#L25"}}),Ko=new z({props:{name:"__call__",anchor:"transformers.MarkupLMProcessor.__call__",parameters:[{name:"html_strings",val:" = None"},{name:"nodes",val:" = None"},{name:"xpaths",val:" = None"},{name:"node_labels",val:" = None"},{name:"questions",val:" = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/processing_markuplm.py#L48"}}),Zo=new xe({}),en=new z({props:{name:"class transformers.MarkupLMModel",anchor:"transformers.MarkupLMModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.MarkupLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.0/en/model_doc/markuplm#transformers.MarkupLMConfig">MarkupLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/modeling_markuplm.py#L800"}}),nn=new z({props:{name:"forward",anchor:"transformers.MarkupLMModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/markuplm#transformers.MarkupLMConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/modeling_markuplm.py#L1188"}}),dn=new z({props:{name:"forward",anchor:"transformers.MarkupLMForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/modeling_markuplm.py#L1205",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/modeling_markuplm.py#L1082"}}),un=new z({props:{name:"forward",anchor:"transformers.MarkupLMForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/modeling_markuplm.py#L1098",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/modeling_markuplm.py#L960"}}),kn=new z({props:{name:"forward",anchor:"transformers.MarkupLMForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/markuplm/modeling_markuplm.py#L974",returnDescription:`
<p>A <a
...
documentation from `),ts=r(Cs,"A",{href:!0});var ZM=i(ts);Oh=n(ZM,"BertConfig"),ZM.forEach(t),Nh=n(Cs," for more information."),Cs.forEach(t),Sh=d(Yt),v(ft.$$.fragment,Yt),Yt.forEach(t),jd=d(s),Ve=r(s,"H2",{class:!0});var Zd=i(Ve);gt=r(Zd,"A",{id:!0,class:!0,href:!0});var e2=i(gt);xa=r(e2,"SPAN",{});var t2=i(xa);v(qo.$$.fragment,t2),t2.forEach(t),e2.forEach(t),Bh=d(Zd),Ta=r(Zd,"SPAN",{});var o2=i(Ta);Rh=n(o2,"MarkupLMFeatureExtractor"),o2.forEach(t),Zd.forEach(t),Cd=d(s),pe=r(s,"DIV",{class:!0});var Jt=i(pe);v($o.$$.fragment,Jt),Wh=d(Jt),Ea=r(Jt,"P",{});var n2=i(Ea);Uh=n(n2,`Constructs a MarkupLM feature extractor. This can be used to get a list of nodes and corresponding xpaths from HTML
...
Users should refer to this superclass for more information regarding those methods.`),ee.forEach(t),_u=d(we),Pe=r(we,"DIV",{class:!0});var Ds=i(Pe);v(Po.$$.fragment,Ds),ku=d(Ds),Aa=r(Ds,"P",{});var g2=i(Aa);vu=n(g2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),g2.forEach(t),bu=d(Ds),Do=r(Ds,"UL",{});var oc=i(Do);ss=r(oc,"LI",{});var jb=i(ss);Mu=n(jb,"single sequence: "),Ia=r(jb,"CODE",{});var _2=i(Ia);wu=n(_2,"<s> X </s>"),_2.forEach(t),jb.forEach(t),yu=d(oc),as=r(oc,"LI",{});var Cb=i(as);xu=n(Cb,"pair of sequences: "),Oa=r(Cb,"CODE",{});var k2=i(Oa);Tu=n(k2,"<s> A </s></s> B </s>"),k2.forEach(t),Cb.forEach(t),oc.forEach(t),Ds.forEach(t),Eu=d(we),rs=r(we,"DIV",{class:!0});var v2=i(rs);v(Ao.$$.fragment,v2),v2.forEach(t),Lu=d(we),vt=r(we,"DIV",{class:!0});var nc=i(vt);v(Io.$$.fragment,nc),qu=d(nc),Na=r(nc,"P",{});var b2=i(Na);$u=n(b2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),b2.forEach(t),nc.forEach(t),Fu=d(we),is=r(we,"DIV",{class:!0});var M2=i(is);v(Oo.$$.fragment,M2),M2.forEach(t),we.forEach(t),Ad=d(s),Xe=r(s,"H2",{class:!0});var sc=i(Xe);bt=r(sc,"A",{id:!0,class:!0,href:!0});var w2=i(bt);Sa=r(w2,"SPAN",{});var y2=i(Sa);v(No.$$.fragment,y2),y2.forEach(t),w2.forEach(t),zu=d(sc),Ba=r(sc,"SPAN",{});var x2=i(Ba);ju=n(x2,"MarkupLMTokenizerFast"),x2.forEach(t),sc.forEach(t),Id=d(s),j=r(s,"DIV",{class:!0});var H=i(j);v(So.$$.fragment,H),Cu=d(H),Ra=r(H,"P",{});var T2=i(Ra);Pu=n(T2,"Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE)."),T2.forEach(t),Du=d(H),B=r(H,"P",{});var ne=i(B);ls=r(ne,"A",{href:!0});var E2=i(ls);Au=n(E2,"MarkupLMTokenizerFast"),E2.forEach(t),Iu=n(ne," can be used to turn HTML strings into to token-level "),Wa=r(ne,"CODE",{});var L2=i(Wa);Ou=n(L2,"input_ids"),L2.forEach(t),Nu=n(ne,", "),Ua=r(ne,"CODE",{});var q2=i(Ua);Su=n(q2,"attention_mask"),q2.forEach(t),Bu=n(ne,`,
...
contains most of the main methods.`),ne.forEach(t),Ku=d(H),Xa=r(H,"P",{});var C2=i(Xa);Yu=n(C2,"Users should refer to this superclass for more information regarding those methods."),C2.forEach(t),Ju=d(H),R=r(H,"DIV",{class:!0});var re=i(R);v(Bo.$$.fragment,re),Zu=d(re),A=r(re,"P",{});var V=i(A);em=n(V,"add_special_tokens ("),Ga=r(V,"CODE",{});var P2=i(Ga);tm=n(P2,"bool"),P2.forEach(t),om=n(V,", "),Ka=r(V,"EM",{});var D2=i(Ka);nm=n(D2,"optional"),D2.forEach(t),sm=n(V,", defaults to "),Ya=r(V,"CODE",{});var A2=i(Ya);am=n(A2,"True"),A2.forEach(t),rm=n(V,`):
Whether or not to encode the sequences with the special tokens relative to their model.
padding (`),Ja=r(V,"CODE",{});var I2=i(Ja);im=n(I2,"bool"),I2.forEach(t),lm=n(V,", "),Za=r(V,"CODE",{});var O2=i(Za);dm=n(O2,"str"),O2.forEach(t),cm=n(V," or "),cs=r(V,"A",{href:!0});var N2=i(cs);pm=n(N2,"PaddingStrategy"),N2.forEach(t),hm=n(V,", "),er=r(V,"EM",{});var S2=i(er);um=n(S2,"optional"),S2.forEach(t),mm=n(V,", defaults to "),tr=r(V,"CODE",{});var B2=i(tr);fm=n(B2,"False"),B2.forEach(t),gm=n(V,`):
Activates and controls padding. Accepts the following values:`),V.forEach(t),_m=d(re),Y=r(re,"UL",{});var ie=i(Y);or=r(ie,"LI",{});var R2=i(or);Mt=r(R2,"P",{});var Ol=i(Mt);nr=r(Ol,"CODE",{});var W2=i(nr);km=n(W2,"True"),W2.forEach(t),vm=n(Ol," or "),sr=r(Ol,"CODE",{});var U2=i(sr);bm=n(U2,"'longest'"),U2.forEach(t),Mm=n(Ol,`: Pad to the longest sequence in the batch (or no padding if only a single
sequence if provided).`),Ol.forEach(t),R2.forEach(t),wm=d(ie),ar=r(ie,"LI",{});var H2=i(ar);wt=r(H2,"P",{});var Nl=i(wt);rr=r(Nl,"CODE",{});var V2=i(rr);ym=n(V2,"'max_length'"),V2.forEach(t),xm=n(Nl,": Pad to a maximum length specified with the argument "),ir=r(Nl,"CODE",{});var Q2=i(ir);Tm=n(Q2,"max_length"),Q2.forEach(t),Em=n(Nl,` or to the maximum
...
lengths).
truncation (`),pr=r(se,"CODE",{});var Y2=i(pr);jm=n(Y2,"bool"),Y2.forEach(t),Cm=n(se,", "),hr=r(se,"CODE",{});var J2=i(hr);Pm=n(J2,"str"),J2.forEach(t),Dm=n(se," or "),ps=r(se,"A",{href:!0});var Z2=i(ps);Am=n(Z2,"TruncationStrategy"),Z2.forEach(t),Im=n(se,", "),ur=r(se,"EM",{});var e1=i(ur);Om=n(e1,"optional"),e1.forEach(t),Nm=n(se,", defaults to "),mr=r(se,"CODE",{});var t1=i(mr);Sm=n(t1,"False"),t1.forEach(t),Bm=n(se,`):
...
returned to provide some overlap between truncated and overflowing sequences. The value of this
argument defines the number of overlapping tokens.
is_split_into_words (`),Dr=r(q,"CODE",{});var w1=i(Dr);Lf=n(w1,"bool"),w1.forEach(t),qf=n(q,", "),Ar=r(q,"EM",{});var y1=i(Ar);$f=n(y1,"optional"),y1.forEach(t),Ff=n(q,", defaults to "),Ir=r(q,"CODE",{});var x1=i(Ir);zf=n(x1,"False"),x1.forEach(t),jf=n(q,`):
Whether or not the input is already pre-tokenized (e.g., split into words). If set to `),Or=r(q,"CODE",{});var T1=i(Or);Cf=n(T1,"True"),T1.forEach(t),Pf=n(q,`, the
tokenizer assumes the input is already split into words (for instance, by splitting it on whitespace)
which it will tokenize. This is useful for NER or token classification.
pad_to_multiple_of (`),Nr=r(q,"CODE",{});var E1=i(Nr);Df=n(E1,"int"),E1.forEach(t),Af=n(q,", "),Sr=r(q,"EM",{});var L1=i(Sr);If=n(L1,"optional"),L1.forEach(t),Of=n(q,`):
If set will pad the sequence to a multiple of the provided value. This is especially useful to enable
the use of Tensor Cores on NVIDIA hardware with compute capability >= 7.5 (Volta).
...
returned to provide some overlap between truncated and overflowing sequences. The value of this
argument defines the number of overlapping tokens.
pad_to_multiple_of (`),Di=r($,"CODE",{});var Tw=i(Di);z_=n(Tw,"int"),Tw.forEach(t),j_=n($,", "),Ai=r($,"EM",{});var Ew=i(Ai);C_=n(Ew,"optional"),Ew.forEach(t),P_=n($,`):
If set will pad the sequence to a multiple of the provided value. This is especially useful to enable
the use of Tensor Cores on NVIDIA hardware with compute capability >= 7.5 (Volta).
return_tensors (`),Ii=r($,"CODE",{});var Lw=i(Ii);D_=n(Lw,"str"),Lw.forEach(t),A_=n($," or "),fs=r($,"A",{href:!0});var qw=i(fs);I_=n(qw,"TensorType"),qw.forEach(t),O_=n($,", "),Oi=r($,"EM",{});var $w=i(Oi);N_=n($w,"optional"),$w.forEach(t),S_=n($,`):
If set, will return tensors instead of list of python integers. Acceptable values are:`),$.forEach(t),fw.forEach(t),B_=d(N),Ni=r(N,"LI",{});var Fw=i(Ni);jt=r(Fw,"P",{});var Gl=i(jt);Si=r(Gl,"CODE",{});var zw=i(Si);R_=n(zw,"'tf'"),zw.forEach(t),W_=n(Gl,": Return TensorFlow "),Bi=r(Gl,"CODE",{});var jw=i(Bi);U_=n(jw,"tf.constant"),jw.forEach(t),H_=n(Gl," objects."),Gl.forEach(t),Fw.forEach(t),V_=d(N),Ri=r(N,"LI",{});var Cw=i(Ri);Ct=r(Cw,"P",{});var Kl=i(Ct);Wi=r(Kl,"CODE",{});var Pw=i(Wi);Q_=n(Pw,"'pt'"),Pw.forEach(t),X_=n(Kl,": Return PyTorch "),Ui=r(Kl,"CODE",{});var Dw=i(Ui);G_=n(Dw,"torch.Tensor"),Dw.forEach(t),K_=n(Kl," objects."),Kl.forEach(t),Cw.forEach(t),Y_=d(N),Hi=r(N,"LI",{});var Aw=i(Hi);Pt=r(Aw,"P",{});var Yl=i(Pt);Vi=r(Yl,"CODE",{});var Iw=i(Vi);J_=n(Iw,"'np'"),Iw.forEach(t),Z_=n(Yl,": Return Numpy "),Qi=r(Yl,"CODE",{});var Ow=i(Qi);ek=n(Ow,"np.ndarray"),Ow.forEach(t),tk=n(Yl," objects."),Yl.forEach(t),Aw.forEach(t),N.forEach(t),re.forEach(t),ok=d(H),Ie=r(H,"DIV",{class:!0});var Is=i(Ie);v(Ro.$$.fragment,Is),nk=d(Is),Xi=r(Is,"P",{});var Nw=i(Xi);sk=n(Nw,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),Nw.forEach(t),ak=d(Is),Wo=r(Is,"UL",{});var ac=i(Wo);gs=r(ac,"LI",{});var Pb=i(gs);rk=n(Pb,"single sequence: "),Gi=r(Pb,"CODE",{});var Sw=i(Gi);ik=n(Sw,"<s> X </s>"),Sw.forEach(t),Pb.forEach(t),lk=d(ac),_s=r(ac,"LI",{});var Db=i(_s);dk=n(Db,"pair of sequences: "),Ki=r(Db,"CODE",{});var Bw=i(Ki);ck=n(Bw,"<s> A </s></s> B </s>"),Bw.forEach(t),Db.forEach(t),ac.forEach(t),Is.forEach(t),pk=d(H),Dt=r(H,"DIV",{class:!0});var rc=i(Dt);v(Uo.$$.fragment,rc),hk=d(rc),Yi=r(rc,"P",{});var Rw=i(Yi);uk=n(Rw,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),Rw.forEach(t),rc.forEach(t),mk=d(H),At=r(H,"DIV",{class:!0});var ic=i(At);v(Ho.$$.fragment,ic),fk=d(ic),Vo=r(ic,"P",{});var lc=i(Vo);gk=n(lc,`Tokenize and prepare for the model a sequence or a pair of sequences. .. warning:: This method is deprecated,
`),Ji=r(lc,"CODE",{});var Ww=i(Ji);_k=n(Ww,"__call__"),Ww.forEach(t),kk=n(lc," should be used instead."),lc.forEach(t),ic.forEach(t),vk=d(H),It=r(H,"DIV",{class:!0});var dc=i(It);v(Qo.$$.fragment,dc),bk=d(dc),Zi=r(dc,"P",{});var Uw=i(Zi);Mk=n(Uw,`Given the xpath expression of one particular node (like \u201C/html/body/div/li[1]/div/span[2]\u201D), return a list of
tag IDs and corresponding subscripts, taking into account max depth.`),Uw.forEach(t),dc.forEach(t),H.forEach(t),Od=d(s),Ke=r(s,"H2",{class:!0});var cc=i(Ke);Ot=r(cc,"A",{id:!0,class:!0,href:!0});var Hw=i(Ot);el=r(Hw,"SPAN",{});var Vw=i(el);v(Xo.$$.fragment,Vw),Vw.forEach(t),Hw.forEach(t),wk=d(cc),tl=r(cc,"SPAN",{});var Qw=i(tl);yk=n(Qw,"MarkupLMProcessor"),Qw.forEach(t),cc.forEach(t),Nd=d(s),te=r(s,"DIV",{class:!0});var Ne=i(te);v(Go.$$.fragment,Ne),xk=d(Ne),ol=r(Ne,"P",{});var Xw=i(ol);Tk=n(Xw,`Constructs a MarkupLM processor which combines a MarkupLM feature extractor and a MarkupLM tokenizer into a single
processor.`),Xw.forEach(t),Ek=d(Ne),ks=r(Ne,"P",{});var Ab=i(ks);vs=r(Ab,"A",{href:!0});var Gw=i(vs);Lk=n(Gw,"MarkupLMProcessor"),Gw.forEach(t),qk=n(Ab," offers all the functionalities you need to prepare data for the model."),Ab.forEach(t),$k=d(Ne),O=r(Ne,"P",{});var X=i(O);Fk=n(X,"It first uses "),bs=r(X,"A",{href:!0});var Kw=i(bs);zk=n(Kw,"MarkupLMFeatureExtractor"),Kw.forEach(t),jk=n(X,` to extract nodes and corresponding xpaths from one or more HTML strings.
Next, these are provided to `),Ms=r(X,"A",{href:!0});var Yw=i(Ms);Ck=n(Yw,"MarkupLMTokenizer"),Yw.forEach(t),Pk=n(X," or "),ws=r(X,"A",{href:!0});var Jw=i(ws);Dk=n(Jw,"MarkupLMTokenizerFast"),Jw.forEach(t),Ak=n(X,`, which turns them into token-level
`),nl=r(X,"CODE",{});var Zw=i(nl);Ik=n(Zw,"input_ids"),Zw.forEach(t),Ok=n(X,", "),sl=r(X,"CODE",{});var ey=i(sl);Nk=n(ey,"attention_mask"),ey.forEach(t),Sk=n(X,", "),al=r(X,"CODE",{});var ty=i(al);Bk=n(ty,"token_type_ids"),ty.forEach(t),Rk=n(X,", "),rl=r(X,"CODE",{});var oy=i(rl);Wk=n(oy,"xpath_tags_seq"),oy.forEach(t),Uk=n(X," and "),il=r(X,"CODE",{});var ny=i(il);Hk=n(ny,"xpath_subs_seq"),ny.forEach(t),Vk=n(X,"."),X.forEach(t),Qk=d(Ne),fe=r(Ne,"DIV",{class:!0});var Zt=i(fe);v(Ko.$$.fragment,Zt),Xk=d(Zt),oe=r(Zt,"P",{});var ye=i(oe);Gk=n(ye,"This method first forwards the "),ll=r(ye,"CODE",{});var sy=i(ll);Kk=n(sy,"html_strings"),sy.forEach(t),Yk=n(ye," argument to "),Yo=r(ye,"A",{href:!0});var Ib=i(Yo);dl=r(Ib,"STRONG",{});var ay=i(dl);Jk=n(ay,"call"),ay.forEach(t),Zk=n(Ib,"()"),Ib.forEach(t),ev=n(ye,`. Next, it
