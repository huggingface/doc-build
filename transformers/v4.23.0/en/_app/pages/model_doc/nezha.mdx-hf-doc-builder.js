...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,h){$(s,c,h),g=!0},p:D,i(c){g||(w(s.$$.fragment,c),g=!0)},o(c){T(s.$$.fragment,c),g=!1},d(c){y(s,c)}}}function Nh(N){let s,g,c,h,b,n,p,M,ua,_s,pe,Oe,cn,vt,fa,hn,ga,bs,Se,_a,$t,ba,za,zs,Po,ka,ks,qo,pn,va,vs,te,$a,wt,wa,Ta,Tt,ya,Na,$s,me,Le,mn,yt,Ma,un,xa,ws,Z,Nt,Fa,ue,ja,Co,Pa,qa,Mt,Ca,Ea,Aa,fe,Oa,Eo,Sa,La,Ao,Ia,Da,Ba,Ie,Ts,ge,De,fn,xt,Wa,gn,Ha,ys,x,Ft,Qa,_n,Ua,Va,jt,Ra,Oo,Za,Ja,Ka,Pt,Ga,qt,Xa,Ya,er,Ct,tr,Et,or,nr,sr,j,ar,bn,rr,ir,zn,lr,dr,kn,cr,hr,vn,pr,mr,$n,ur,fr,wn,gr,_r,br,J,At,zr,_e,kr,So,vr,$r,Tn,wr,Tr,yr,Be,Nr,We,Ns,be,He,yn,Ot,Mr,Nn,xr,Ms,q,St,Fr,ze,jr,Mn,Pr,qr,xn,Cr,Er,Ar,Lt,Or,Lo,Sr,Lr,Ir,It,Dr,Dt,Br,Wr,Hr,K,Bt,Qr,ke,Ur,Io,Vr,Rr,Fn,Zr,Jr,Kr,Qe,Gr,Ue,xs,ve,Ve,jn,Wt,Xr,Pn,Yr,Fs,C,Ht,ei,Qt,ti,qn,oi,ni,si,Ut,ai,Do,ri,ii,li,Vt,di,Rt,ci,hi,pi,W,Zt,mi,$e,ui,Bo,fi,gi,Cn,_i,bi,zi,Re,ki,Ze,vi,Je,js,we,Ke,En,Jt,$i,An,wi,Ps,E,Kt,Ti,Gt,yi,On,Ni,Mi,xi,Xt,Fi,Wo,ji,Pi,qi,Yt,Ci,eo,Ei,Ai,Oi,G,to,Si,Te,Li,Ho,Ii,Di,Sn,Bi,Wi,Hi,Ge,Qi,Xe,qs,ye,Ye,Ln,oo,Ui,In,Vi,Cs,A,no,Ri,Dn,Zi,Ji,so,Ki,Qo,Gi,Xi,Yi,ao,el,ro,tl,ol,nl,F,io,sl,Ne,al,Uo,rl,il,Bn,ll,dl,cl,et,hl,tt,pl,ot,ml,nt,ul,st,Es,Me,at,Wn,lo,fl,Hn,gl,As,O,co,_l,Qn,bl,zl,ho,kl,Vo,vl,$l,wl,po,Tl,mo,yl,Nl,Ml,X,uo,xl,xe,Fl,Ro,jl,Pl,Un,ql,Cl,El,rt,Al,it,Os,Fe,lt,Vn,fo,Ol,Rn,Sl,Ss,S,go,Ll,Zn,Il,Dl,_o,Bl,Zo,Wl,Hl,Ql,bo,Ul,zo,Vl,Rl,Zl,H,ko,Jl,je,Kl,Jo,Gl,Xl,Jn,Yl,ed,td,dt,od,ct,nd,ht,Ls,Pe,pt,Kn,vo,sd,Gn,ad,Is,L,$o,rd,qe,id,Xn,ld,dd,Yn,cd,hd,pd,wo,md,Ko,ud,fd,gd,To,_d,yo,bd,zd,kd,Q,No,vd,Ce,$d,Go,wd,Td,es,yd,Nd,Md,mt,xd,ut,Fd,ft,Ds;return n=new ee({}),vt=new ee({}),yt=new ee({}),Nt=new P({props:{name:"class transformers.NezhaConfig",anchor:"transformers.NezhaConfig",parameters:[{name:"vocab_size",val:" = 21128"},{name:"embedding_size",val:" = 128"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"max_relative_position",val:" = 64"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"classifier_dropout",val:" = 0.1"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 3"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.NezhaConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, optional, defaults to 21128) &#x2014;
Vocabulary size of the NEZHA model. Defines the different tokens that can be represented by the
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/v4.23.0/en/model_doc/nezha#transformers.NezhaModel">NezhaModel</a>.`,name:"vocab_size"},{anchor:"transformers.NezhaConfig.embedding_size",description:`<strong>embedding_size</strong> (<code>int</code>, optional, defaults to 128) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/nezha/modeling_nezha.py#L899",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/nezha#transformers.NezhaConfig"
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/nezha/modeling_nezha.py#L1056",returnDescription:`
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/nezha/modeling_nezha.py#L1166",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/nezha/modeling_nezha.py#L1259",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/nezha/modeling_nezha.py#L1368",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/nezha/modeling_nezha.py#L1466",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/nezha/modeling_nezha.py#L1563",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/nezha/modeling_nezha.py#L1642",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kd=m(),Q=i("div"),k(No.$$.fragment),vd=m(),Ce=i("p"),$d=a("The "),Go=i("a"),wd=a("NezhaForQuestionAnswering"),Td=a(" forward method, overrides the "),es=i("code"),yd=a("__call__"),Nd=a(" special method."),Md=m(),k(mt.$$.fragment),xd=m(),k(ut.$$.fragment),Fd=m(),k(ft.$$.fragment),this.h()},l(t){const _=th('[data-svelte="svelte-1phssyn"]',document.head);s=l(_,"META",{name:!0,content:!0}),_.forEach(o),g=u(t),c=l(t,"H1",{class:!0});var Mo=d(c);h=l(Mo,"A",{id:!0,class:!0,href:!0});var ts=d(h);b=l(ts,"SPAN",{});var os=d(b);v(n.$$.fragment,os),os.forEach(o),ts.forEach(o),p=u(Mo),M=l(Mo,"SPAN",{});var ns=d(M);ua=r(ns,"Nezha"),ns.forEach(o),Mo.forEach(o),_s=u(t),pe=l(t,"H2",{class:!0});var xo=d(pe);Oe=l(xo,"A",{id:!0,class:!0,href:!0});var ss=d(Oe);cn=l(ss,"SPAN",{});var as=d(cn);v(vt.$$.fragment,as),as.forEach(o),ss.forEach(o),fa=u(xo),hn=l(xo,"SPAN",{});var rs=d(hn);ga=r(rs,"Overview"),rs.forEach(o),xo.forEach(o),bs=u(t),Se=l(t,"P",{});var Fo=d(Se);_a=r(Fo,"The Nezha model was proposed in "),$t=l(Fo,"A",{href:!0,rel:!0});var is=d($t);ba=r(is,"NEZHA: Neural Contextualized Representation for Chinese Language Understanding"),is.forEach(o),za=r(Fo," by Junqiu Wei et al."),Fo.forEach(o),zs=u(t),Po=l(t,"P",{});var ls=d(Po);ka=r(ls,"The abstract from the paper is the following:"),ls.forEach(o),ks=u(t),qo=l(t,"P",{});var ds=d(qo);pn=l(ds,"EM",{});var cs=d(pn);va=r(cs,`The pre-trained language models have achieved great successes in various natural language understanding (NLU) tasks
due to its capacity to capture the deep contextualized information in text by pre-training on large-scale corpora.
In this technical report, we present our practice of pre-training language models named NEZHA (NEural contextualiZed
representation for CHinese lAnguage understanding) on Chinese corpora and finetuning for the Chinese NLU tasks.
The current version of NEZHA is based on BERT with a collection of proven improvements, which include Functional
...
documentation from `),Ao=l(Xo,"A",{href:!0});var qd=d(Ao);Ia=r(qd,"PretrainedConfig"),qd.forEach(o),Da=r(Xo," for more information."),Xo.forEach(o),Ba=u(Y),v(Ie.$$.fragment,Y),Y.forEach(o),Ts=u(t),ge=l(t,"H2",{class:!0});var Bs=d(ge);De=l(Bs,"A",{id:!0,class:!0,href:!0});var Cd=d(De);fn=l(Cd,"SPAN",{});var Ed=d(fn);v(xt.$$.fragment,Ed),Ed.forEach(o),Cd.forEach(o),Wa=u(Bs),gn=l(Bs,"SPAN",{});var Ad=d(gn);Ha=r(Ad,"NezhaModel"),Ad.forEach(o),Bs.forEach(o),ys=u(t),x=l(t,"DIV",{class:!0});var U=d(x);v(Ft.$$.fragment,U),Qa=u(U),_n=l(U,"P",{});var Od=d(_n);Ua=r(Od,"The bare Nezha Model transformer outputting raw hidden-states without any specific head on top."),Od.forEach(o),Va=u(U),jt=l(U,"P",{});var Ws=d(jt);Ra=r(Ws,"This model inherits from "),Oo=l(Ws,"A",{href:!0});var Sd=d(Oo);Za=r(Sd,"PreTrainedModel"),Sd.forEach(o),Ja=r(Ws,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa.forEach(o),nl=u(re),F=l(re,"DIV",{class:!0});var R=d(F);v(io.$$.fragment,R),sl=u(R),Ne=l(R,"P",{});var sn=d(Ne);al=r(sn,"The "),Uo=l(sn,"A",{href:!0});var yc=d(Uo);rl=r(yc,"NezhaForSequenceClassification"),yc.forEach(o),il=r(sn," forward method, overrides the "),Bn=l(sn,"CODE",{});var Nc=d(Bn);ll=r(Nc,"__call__"),Nc.forEach(o),dl=r(sn," special method."),sn.forEach(o),cl=u(R),v(et.$$.fragment,R),hl=u(R),v(tt.$$.fragment,R),pl=u(R),v(ot.$$.fragment,R),ml=u(R),v(nt.$$.fragment,R),ul=u(R),v(st.$$.fragment,R),R.forEach(o),re.forEach(o),Es=u(t),Me=l(t,"H2",{class:!0});var aa=d(Me);at=l(aa,"A",{id:!0,class:!0,href:!0});var Mc=d(at);Wn=l(Mc,"SPAN",{});var xc=d(Wn);v(lo.$$.fragment,xc),xc.forEach(o),Mc.forEach(o),fl=u(aa),Hn=l(aa,"SPAN",{});var Fc=d(Hn);gl=r(Fc,"NezhaForMultipleChoice"),Fc.forEach(o),aa.forEach(o),As=u(t),O=l(t,"DIV",{class:!0});var ie=d(O);v(co.$$.fragment,ie),_l=u(ie),Qn=l(ie,"P",{});var jc=d(Qn);bl=r(jc,`Nezha Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
