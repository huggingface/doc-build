...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){h=a("p"),$=n("Example:"),_=l(),v(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);$=r(g,"Example:"),g.forEach(t),_=p(i),y(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,$),u(i,_,g),k(f,i,g),b=!0},p:ct,i(i){b||(w(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),T(f,i)}}}function am(q){let h,$,_,f,b,i,g,S,ga,cr,te,we,en,to,_a,on,ba,lr,Ee,va,lt,ya,ka,pr,Te,wa,no,Ea,Ta,mr,$e,$a,pt,Ma,Da,hr,Z,ja,mt,xa,qa,ro,za,Pa,fr,ne,Me,tn,ao,Fa,so,Aa,nn,Ca,Sa,ur,U,ht,Na,Ia,ft,Ba,La,rn,Oa,Ra,gr,io,_r,re,De,an,co,Wa,lo,Va,sn,Ga,Ua,br,M,ut,Ha,Za,dn,Ya,Ja,cn,Ka,Qa,ln,Xa,es,pn,os,ts,gt,ns,rs,je,as,mn,ss,ds,hn,is,cs,_t,ls,ps,vr,po,yr,ae,xe,fn,mo,ms,ho,hs,un,fs,us,kr,I,gs,gn,_s,bs,bt,vs,ys,_n,ks,ws,wr,qe,Es,bn,Ts,$s,Er,fo,Tr,se,ze,vn,uo,Ms,go,Ds,yn,js,xs,$r,de,kn,qs,zs,wn,Ps,Fs,Mr,_o,Dr,ie,Pe,En,bo,As,Tn,Cs,jr,N,Ss,$n,Ns,Is,Mn,Bs,Ls,Dn,Os,Rs,jn,Ws,Vs,xr,vo,qr,Fe,Gs,yo,Us,Hs,zr,Y,Zs,ko,Ys,Js,wo,Ks,Qs,Pr,ce,Ae,xn,Eo,Xs,qn,ed,Fr,C,To,od,Ce,vt,td,nd,yt,rd,ad,sd,le,dd,kt,id,cd,wt,ld,pd,md,Se,hd,Ne,$o,fd,Mo,ud,Et,gd,_d,bd,Ie,Do,vd,pe,yd,zn,kd,wd,Pn,Ed,Td,Ar,me,Be,Fn,jo,$d,An,Md,Cr,D,xo,Dd,he,jd,Tt,xd,qd,$t,zd,Pd,Fd,qo,Ad,zo,Cd,Sd,Nd,Cn,Id,Bd,Po,Ld,Mt,Od,Rd,Wd,Fo,Vd,Ao,Gd,Ud,Hd,J,Dt,Zd,Yd,Sn,Jd,Kd,Nn,Qd,Xd,ei,B,Co,oi,fe,ti,jt,ni,ri,In,ai,si,di,Le,ii,Oe,ci,L,So,li,Bn,pi,mi,ue,hi,Ln,fi,ui,On,gi,_i,bi,Re,Sr,ge,We,Rn,No,vi,Wn,yi,Nr,j,Io,ki,_e,wi,xt,Ei,Ti,qt,$i,Mi,Di,Bo,ji,Lo,xi,qi,zi,Vn,Pi,Fi,Oo,Ai,zt,Ci,Si,Ni,Ro,Ii,Wo,Bi,Li,Oi,K,Pt,Ri,Wi,Ft,Vi,Gi,At,Ui,Hi,Zi,O,Vo,Yi,be,Ji,Ct,Ki,Qi,Gn,Xi,ec,oc,Ve,tc,Ge,nc,Q,Go,rc,Un,ac,sc,Ue,Ir,ve,He,Hn,Uo,dc,Zn,ic,Br,x,Ho,cc,ye,lc,St,pc,mc,Nt,hc,fc,uc,Zo,gc,Yo,_c,bc,vc,Yn,yc,kc,Jo,wc,It,Ec,Tc,$c,Ko,Mc,Qo,Dc,jc,xc,X,Bt,qc,zc,Jn,Pc,Fc,Kn,Ac,Cc,Sc,R,Xo,Nc,ke,Ic,Lt,Bc,Lc,Qn,Oc,Rc,Wc,Ze,Vc,Ye,Gc,ee,et,Uc,Xn,Hc,Zc,Je,Lr;return i=new H({}),to=new H({}),ao=new H({}),io=new G({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/v4.23.0/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/v4.23.0/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),Se=new it({props:{anchor:"transformers.EncoderDecoderConfig.example",$$slots:{default:[Yp]},$$scope:{ctx:q}}}),$o=new V({props:{name:"from_encoder_decoder_configs",anchor:"transformers.EncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L91",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.23.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),Do=new V({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
If set to <code>True</code>, the model will return a <code>~utils.Seq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"},{anchor:"transformers.EncoderDecoderModel.forward.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014; Remaining dictionary of keyword arguments. Keyword arguments come in two flavors:</p>
<ul>
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L430",returnDescription:`
<p>A <a
...
`}}),Le=new Jc({props:{$$slots:{default:[Jp]},$$scope:{ctx:q}}}),Oe=new it({props:{anchor:"transformers.EncoderDecoderModel.forward.example",$$slots:{default:[Kp]},$$scope:{ctx:q}}}),So=new V({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
If set to <code>True</code>, the model will return a <code>~utils.Seq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"},{anchor:"transformers.TFEncoderDecoderModel.call.training",description:`<strong>training</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L494",returnDescription:`
<p>A <a
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
If set to <code>True</code>, the model will return a <code>~utils.FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L628",returnDescription:`
<p>A <a
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
and decoder for a summarization model as was shown in: `),ro=a("a"),za=n("Text Summarization with Pretrained Encoders"),Pa=n(" by Yang Liu and Mirella Lapata."),fr=l(),ne=a("h2"),Me=a("a"),tn=a("span"),v(ao.$$.fragment),Fa=l(),so=a("span"),Aa=n("Randomly initializing "),nn=a("code"),Ca=n("EncoderDecoderModel"),Sa=n(" from model configurations."),ur=l(),U=a("p"),ht=a("a"),Na=n("EncoderDecoderModel"),Ia=n(" can be randomly initialized from an encoder and a decoder config. In the following example, we show how to do this using the default "),ft=a("a"),Ba=n("BertModel"),La=n(" configuration for the encoder and the default "),rn=a("code"),Oa=n("BertForCausalLM"),Ra=n(" configuration for the decoder."),gr=l(),v(io.$$.fragment),_r=l(),re=a("h2"),De=a("a"),an=a("span"),v(co.$$.fragment),Wa=l(),lo=a("span"),Va=n("Initialising "),sn=a("code"),Ga=n("EncoderDecoderModel"),Ua=n(" from a pretrained encoder and a pretrained decoder."),br=l(),M=a("p"),ut=a("a"),Ha=n("EncoderDecoderModel"),Za=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained auto-encoding model, "),dn=a("em"),Ya=n("e.g."),Ja=n(" BERT, can serve as the encoder and both pretrained auto-encoding models, "),cn=a("em"),Ka=n("e.g."),Qa=n(" BERT, pretrained causal language models, "),ln=a("em"),Xa=n("e.g."),es=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),pn=a("em"),os=n("e.g."),ts=n(` decoder of BART, can be used as the decoder.
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Mr=l(),v(_o.$$.fragment),Dr=l(),ie=a("h2"),Pe=a("a"),En=a("span"),v(bo.$$.fragment),As=l(),Tn=a("span"),Cs=n("Training"),jr=l(),N=a("p"),Ss=n(`Once the model is created, it can be fine-tuned similar to BART, T5 or any other encoder-decoder model.
...
`),Mn=a("code"),Bs=n("input_ids"),Ls=n(" of the encoded input sequence) and "),Dn=a("code"),Os=n("labels"),Rs=n(" (which are the "),jn=a("code"),Ws=n("input_ids"),Vs=n(` of the encoded
target sequence).`),xr=l(),v(vo.$$.fragment),qr=l(),Fe=a("p"),Gs=n("Detailed "),yo=a("a"),Us=n("colab"),Hs=n(" for training."),zr=l(),Y=a("p"),Zs=n("This model was contributed by "),ko=a("a"),Ys=n("thomwolf"),Js=n(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=a("a"),Ks=n("ydshieh"),Qs=n("."),Pr=l(),ce=a("h2"),Ae=a("a"),xn=a("span"),v(Eo.$$.fragment),Xs=l(),qn=a("span"),ed=n("EncoderDecoderConfig"),Fr=l(),C=a("div"),v(To.$$.fragment),od=l(),Ce=a("p"),vt=a("a"),td=n("EncoderDecoderConfig"),nd=n(" is the configuration class to store the configuration of a "),yt=a("a"),rd=n("EncoderDecoderModel"),ad=n(`. It is
...
(see the examples for more information).`),Bd=l(),Po=a("p"),Ld=n("This model inherits from "),Mt=a("a"),Od=n("PreTrainedModel"),Rd=n(`. Check the superclass documentation for the generic methods the
...
:meth`),Nn=a("em"),Qd=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xd=n(" class method for the decoder."),ei=l(),B=a("div"),v(Co.$$.fragment),oi=l(),fe=a("p"),ti=n("The "),jt=a("a"),ni=n("EncoderDecoderModel"),ri=n(" forward method, overrides the "),In=a("code"),ai=n("__call__"),si=n(" special method."),di=l(),v(Le.$$.fragment),ii=l(),v(Oe.$$.fragment),ci=l(),L=a("div"),v(So.$$.fragment),li=l(),Bn=a("p"),pi=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),mi=l(),ue=a("p"),hi=n("The model is set in evaluation mode by default using "),Ln=a("code"),fi=n("model.eval()"),ui=n(` (Dropout modules are deactivated). To train
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Di=l(),Bo=a("p"),ji=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Lo=a("a"),xi=n(`Leveraging Pre-trained Checkpoints for Sequence Generation
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ni=l(),Ro=a("p"),Ii=n("This model is also a "),Wo=a("a"),Bi=n("tf.keras.Model"),Li=n(` subclass. Use it
...
checkpoints.`),sc=l(),v(Ue.$$.fragment),Ir=l(),ve=a("h2"),He=a("a"),Hn=a("span"),v(Uo.$$.fragment),dc=l(),Zn=a("span"),ic=n("FlaxEncoderDecoderModel"),Br=l(),x=a("div"),v(Ho.$$.fragment),cc=l(),ye=a("p"),lc=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xc=l(),X=a("p"),Bt=a("a"),qc=n("FlaxEncoderDecoderModel"),zc=n(` is a generic model class that will be instantiated as a transformer architecture with
...
`),Mn=s(oe,"CODE",{});var Cl=d(Mn);Bs=r(Cl,"input_ids"),Cl.forEach(t),Ls=r(oe," of the encoded input sequence) and "),Dn=s(oe,"CODE",{});var Sl=d(Dn);Os=r(Sl,"labels"),Sl.forEach(t),Rs=r(oe," (which are the "),jn=s(oe,"CODE",{});var Nl=d(jn);Ws=r(Nl,"input_ids"),Nl.forEach(t),Vs=r(oe,` of the encoded
target sequence).`),oe.forEach(t),xr=p(o),y(vo.$$.fragment,o),qr=p(o),Fe=s(o,"P",{});var Xr=d(Fe);Gs=r(Xr,"Detailed "),yo=s(Xr,"A",{href:!0,rel:!0});var Il=d(yo);Us=r(Il,"colab"),Il.forEach(t),Hs=r(Xr," for training."),Xr.forEach(t),zr=p(o),Y=s(o,"P",{});var Rt=d(Y);Zs=r(Rt,"This model was contributed by "),ko=s(Rt,"A",{href:!0,rel:!0});var Bl=d(ko);Ys=r(Bl,"thomwolf"),Bl.forEach(t),Js=r(Rt,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=s(Rt,"A",{href:!0,rel:!0});var Ll=d(wo);Ks=r(Ll,"ydshieh"),Ll.forEach(t),Qs=r(Rt,"."),Rt.forEach(t),Pr=p(o),ce=s(o,"H2",{class:!0});var ea=d(ce);Ae=s(ea,"A",{id:!0,class:!0,href:!0});var Ol=d(Ae);xn=s(Ol,"SPAN",{});var Rl=d(xn);y(Eo.$$.fragment,Rl),Rl.forEach(t),Ol.forEach(t),Xs=p(ea),qn=s(ea,"SPAN",{});var Wl=d(qn);ed=r(Wl,"EncoderDecoderConfig"),Wl.forEach(t),ea.forEach(t),Fr=p(o),C=s(o,"DIV",{class:!0});var W=d(C);y(To.$$.fragment,W),od=p(W),Ce=s(W,"P",{});var ir=d(Ce);vt=s(ir,"A",{href:!0});var Vl=d(vt);td=r(Vl,"EncoderDecoderConfig"),Vl.forEach(t),nd=r(ir," is the configuration class to store the configuration of a "),yt=s(ir,"A",{href:!0});var Gl=d(yt);rd=r(Gl,"EncoderDecoderModel"),Gl.forEach(t),ad=r(ir,`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
...
(see the examples for more information).`),np.forEach(t),Bd=p(P),Po=s(P,"P",{});var sa=d(Po);Ld=r(sa,"This model inherits from "),Mt=s(sa,"A",{href:!0});var rp=d(Mt);Od=r(rp,"PreTrainedModel"),rp.forEach(t),Rd=r(sa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
:meth`),Nn=s(at,"EM",{});var ip=d(Nn);Qd=r(ip,"~transformers.AutoModelForCausalLM.from_pretrained"),ip.forEach(t),Xd=r(at," class method for the decoder."),at.forEach(t),ei=p(P),B=s(P,"DIV",{class:!0});var Qe=d(B);y(Co.$$.fragment,Qe),oi=p(Qe),fe=s(Qe,"P",{});var Ut=d(fe);ti=r(Ut,"The "),jt=s(Ut,"A",{href:!0});var cp=d(jt);ni=r(cp,"EncoderDecoderModel"),cp.forEach(t),ri=r(Ut," forward method, overrides the "),In=s(Ut,"CODE",{});var lp=d(In);ai=r(lp,"__call__"),lp.forEach(t),si=r(Ut," special method."),Ut.forEach(t),di=p(Qe),y(Le.$$.fragment,Qe),ii=p(Qe),y(Oe.$$.fragment,Qe),Qe.forEach(t),ci=p(P),L=s(P,"DIV",{class:!0});var Xe=d(L);y(So.$$.fragment,Xe),li=p(Xe),Bn=s(Xe,"P",{});var pp=d(Bn);pi=r(pp,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),pp.forEach(t),mi=p(Xe),ue=s(Xe,"P",{});var Ht=d(ue);hi=r(Ht,"The model is set in evaluation mode by default using "),Ln=s(Ht,"CODE",{});var mp=d(Ln);fi=r(mp,"model.eval()"),mp.forEach(t),ui=r(Ht,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),On=s(Ht,"CODE",{});var hp=d(On);gi=r(hp,"model.train()"),hp.forEach(t),_i=r(Ht,"."),Ht.forEach(t),bi=p(Xe),y(Re.$$.fragment,Xe),Xe.forEach(t),P.forEach(t),Sr=p(o),ge=s(o,"H2",{class:!0});var ia=d(ge);We=s(ia,"A",{id:!0,class:!0,href:!0});var fp=d(We);Rn=s(fp,"SPAN",{});var up=d(Rn);y(No.$$.fragment,up),up.forEach(t),fp.forEach(t),vi=p(ia),Wn=s(ia,"SPAN",{});var gp=d(Wn);yi=r(gp,"TFEncoderDecoderModel"),gp.forEach(t),ia.forEach(t),Nr=p(o),j=s(o,"DIV",{class:!0});var F=d(j);y(Io.$$.fragment,F),ki=p(F),_e=s(F,"P",{});var Zt=d(_e);wi=r(Zt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Zt.forEach(t),Di=p(F),Bo=s(F,"P",{});var ca=d(Bo);ji=r(ca,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Lo=s(ca,"A",{href:!0,rel:!0});var vp=d(Lo);xi=r(vp,`Leveraging Pre-trained Checkpoints for Sequence Generation
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),la.forEach(t),Ni=p(F),Ro=s(F,"P",{});var pa=d(Ro);Ii=r(pa,"This model is also a "),Wo=s(pa,"A",{href:!0,rel:!0});var wp=d(Wo);Bi=r(wp,"tf.keras.Model"),wp.forEach(t),Li=r(pa,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
method for the decoder.`),st.forEach(t),Zi=p(F),O=s(F,"DIV",{class:!0});var eo=d(O);y(Vo.$$.fragment,eo),Yi=p(eo),be=s(eo,"P",{});var Yt=d(be);Ji=r(Yt,"The "),Ct=s(Yt,"A",{href:!0});var Mp=d(Ct);Ki=r(Mp,"TFEncoderDecoderModel"),Mp.forEach(t),Qi=r(Yt," forward method, overrides the "),Gn=s(Yt,"CODE",{});var Dp=d(Gn);Xi=r(Dp,"__call__"),Dp.forEach(t),ec=r(Yt," special method."),Yt.forEach(t),oc=p(eo),y(Ve.$$.fragment,eo),tc=p(eo),y(Ge.$$.fragment,eo),eo.forEach(t),nc=p(F),Q=s(F,"DIV",{class:!0});var Jt=d(Q);y(Go.$$.fragment,Jt),rc=p(Jt),Un=s(Jt,"P",{});var jp=d(Un);ac=r(jp,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),jp.forEach(t),sc=p(Jt),y(Ue.$$.fragment,Jt),Jt.forEach(t),F.forEach(t),Ir=p(o),ve=s(o,"H2",{class:!0});var ma=d(ve);He=s(ma,"A",{id:!0,class:!0,href:!0});var xp=d(He);Hn=s(xp,"SPAN",{});var qp=d(Hn);y(Uo.$$.fragment,qp),qp.forEach(t),xp.forEach(t),dc=p(ma),Zn=s(ma,"SPAN",{});var zp=d(Zn);ic=r(zp,"FlaxEncoderDecoderModel"),zp.forEach(t),ma.forEach(t),Br=p(o),x=s(o,"DIV",{class:!0});var A=d(x);y(Ho.$$.fragment,A),cc=p(A),ye=s(A,"P",{});var Kt=d(ye);lc=r(Kt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
