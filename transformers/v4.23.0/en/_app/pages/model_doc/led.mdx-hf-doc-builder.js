import{S as im,i as dm,s as lm,e as a,k as c,w as T,t as n,M as cm,c as r,d as t,m as h,a as i,x as v,h as s,b as f,G as e,g as _,y as w,q as y,o as E,B as q,v as hm,L as De}from"../../chunks/vendor-hf-doc-builder.js";import{T as wt}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ze}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as We}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Le}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function pm(L){let l,b,p,m,k;return m=new ze({props:{code:`from transformers import LEDModel, LEDConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=a("p"),b=n("Example:"),p=c(),T(m.$$.fragment)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Example:"),u.forEach(t),p=h(d),v(m.$$.fragment,d)},m(d,u){_(d,l,u),e(l,b),_(d,p,u),w(m,d,u),k=!0},p:De,i(d){k||(y(m.$$.fragment,d),k=!0)},o(d){E(m.$$.fragment,d),k=!1},d(d){d&&t(l),d&&t(p),q(m,d)}}}function um(L){let l,b,p,m,k;return m=new ze({props:{code:`from transformers import LEDTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),T(m.$$.fragment)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Example:"),u.forEach(t),p=h(d),v(m.$$.fragment,d)},m(d,u){_(d,l,u),e(l,b),_(d,p,u),w(m,d,u),k=!0},p:De,i(d){k||(y(m.$$.fragment,d),k=!0)},o(d){E(m.$$.fragment,d),k=!1},d(d){d&&t(l),d&&t(p),q(m,d)}}}function km(L){let l,b,p,m,k;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(u,"CODE",{});var D=i(p);m=s(D,"Module"),D.forEach(t),k=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(prediction, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Conditional generation example:"),p=c(),T(m.$$.fragment)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Conditional generation example:"),u.forEach(t),p=h(d),v(m.$$.fragment,d)},m(d,u){_(d,l,u),e(l,b),_(d,p,u),w(m,d,u),k=!0},p:De,i(d){k||(y(m.$$.fragment,d),k=!0)},o(d){E(m.$$.fragment,d),k=!1},d(d){d&&t(l),d&&t(p),q(m,d)}}}function vm(L){let l,b,p,m,k;return m=new ze({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Summarization example:"),p=c(),T(m.$$.fragment)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Summarization example:"),u.forEach(t),p=h(d),v(m.$$.fragment,d)},m(d,u){_(d,l,u),e(l,b),_(d,p,u),w(m,d,u),k=!0},p:De,i(d){k||(y(m.$$.fragment,d),k=!0)},o(d){E(m.$$.fragment,d),k=!1},d(d){d&&t(l),d&&t(p),q(m,d)}}}function wm(L){let l,b,p,m,k;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(u,"CODE",{});var D=i(p);m=s(D,"Module"),D.forEach(t),k=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){_(d,l,u),e(l,b),e(l,p),e(p,m),e(l,k)},d(d){d&&t(l)}}}function ym(L){let l,b,p,m,k;return m=new ze({props:{code:`import torch
...
`}}),{c(){l=a("p"),b=n("Example of single-label classification:"),p=c(),T(m.$$.fragment)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Example of single-label classification:"),u.forEach(t),p=h(d),v(m.$$.fragment,d)},m(d,u){_(d,l,u),e(l,b),_(d,p,u),w(m,d,u),k=!0},p:De,i(d){k||(y(m.$$.fragment,d),k=!0)},o(d){E(m.$$.fragment,d),k=!1},d(d){d&&t(l),d&&t(p),q(m,d)}}}function Em(L){let l,b;return l=new ze({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){T(l.$$.fragment)},l(p){v(l.$$.fragment,p)},m(p,m){w(l,p,m),b=!0},p:De,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){q(l,p)}}}function qm(L){let l,b,p,m,k;return m=new ze({props:{code:`import torch
from transformers import LEDTokenizer, LEDForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){l=a("p"),b=n("Example of multi-label classification:"),p=c(),T(m.$$.fragment)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Example of multi-label classification:"),u.forEach(t),p=h(d),v(m.$$.fragment,d)},m(d,u){_(d,l,u),e(l,b),_(d,p,u),w(m,d,u),k=!0},p:De,i(d){k||(y(m.$$.fragment,d),k=!0)},o(d){E(m.$$.fragment,d),k=!1},d(d){d&&t(l),d&&t(p),q(m,d)}}}function $m(L){let l,b;return l=new ze({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){T(l.$$.fragment)},l(p){v(l.$$.fragment,p)},m(p,m){w(l,p,m),b=!0},p:De,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){q(l,p)}}}function Lm(L){let l,b,p,m,k;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(u,"CODE",{});var D=i(p);m=s(D,"Module"),D.forEach(t),k=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){l=a("p"),b=n("Example:"),p=c(),T(m.$$.fragment)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Example:"),u.forEach(t),p=h(d),v(m.$$.fragment,d)},m(d,u){_(d,l,u),e(l,b),_(d,p,u),w(m,d,u),k=!0},p:De,i(d){k||(y(m.$$.fragment,d),k=!0)},o(d){E(m.$$.fragment,d),k=!1},d(d){d&&t(l),d&&t(p),q(m,d)}}}function zm(L){let l,b;return l=new ze({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(p){v(l.$$.fragment,p)},m(p,m){w(l,p,m),b=!0},p:De,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){q(l,p)}}}function Fm(L){let l,b,p,m,k,d,u,D,Y,A,P,W,ie,z,Ue,ee,Re,Pe,Q,Ve,de,le,Ke,Ne,K,Xe,Ae,X,Fe,Je,be,M,I,Ie,x,j,ke,ce,Ze,Te,G,Ye,te,et,tt,oe,ot,nt,U,st,he,ve,xe,B,we,R,at,rt;return{c(){l=a("p"),b=n("TensorFlow models and layers in "),p=a("code"),m=n("transformers"),k=n(" accept two formats as input:"),d=c(),u=a("ul"),D=a("li"),Y=n("having all inputs as keyword arguments (like PyTorch models), or"),A=c(),P=a("li"),W=n("having all inputs as a list, tuple or dict in the first positional argument."),ie=c(),z=a("p"),Ue=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
`),he=r(ht,"CODE",{});var pt=i(he);ve=s(pt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),pt.forEach(t),ht.forEach(t),ne.forEach(t),xe=h($),B=r($,"P",{});var Me=i(B);we=s(Me,`Note that when creating models and layers with
`),R=r(Me,"A",{href:!0,rel:!0});var zt=i(R);at=s(zt,"subclassing"),zt.forEach(t),rt=s(Me,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Me.forEach(t),this.h()},h(){f(R,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(R,"rel","nofollow")},m($,F){_($,l,F),e(l,b),e(l,p),e(p,m),e(l,k),_($,d,F),_($,u,F),e(u,D),e(D,Y),e(u,A),e(u,P),e(P,W),_($,ie,F),_($,z,F),e(z,Ue),e(z,ee),e(ee,Re),e(z,Pe),e(z,Q),e(Q,Ve),e(z,de),e(z,le),e(le,Ke),e(z,Ne),e(z,K),e(K,Xe),e(z,Ae),e(z,X),e(X,Fe),e(z,Je),_($,be,F),_($,M,F),e(M,I),e(I,Ie),e(I,x),e(x,j),e(I,ke),e(I,ce),e(ce,Ze),e(M,Te),e(M,G),e(G,Ye),e(G,te),e(te,et),e(G,tt),e(G,oe),e(oe,ot),e(M,nt),e(M,U),e(U,st),e(U,he),e(he,ve),_($,xe,F),_($,B,F),e(B,we),e(B,R),e(R,at),e(B,rt)},d($){$&&t(l),$&&t(d),$&&t(u),$&&t(ie),$&&t(z),$&&t(be),$&&t(M),$&&t(xe),$&&t(B)}}}function xm(L){let l,b,p,m,k;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(u,"CODE",{});var D=i(p);m=s(D,"Module"),D.forEach(t),k=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),T(m.$$.fragment)},l(d){l=r(d,"P",{});var u=i(l);b=s(u,"Examples:"),u.forEach(t),p=h(d),v(m.$$.fragment,d)},m(d,u){_(d,l,u),e(l,b),_(d,p,u),w(m,d,u),k=!0},p:De,i(d){k||(y(m.$$.fragment,d),k=!0)},o(d){E(m.$$.fragment,d),k=!1},d(d){d&&t(l),d&&t(p),q(m,d)}}}function jm(L){let l,b,p,m,k,d,u,D,Y,A,P,W,ie,z,Ue,ee,Re,Pe,Q,Ve,de,le,Ke,Ne,K,Xe,Ae,X,Fe,Je,be,M,I,Ie,x,j,ke,ce,Ze,Te,G,Ye,te,et,tt,oe,ot,nt,U,st,he,ve,xe,B,we,R,at,rt,$,F,it,Se,yt,dt,S,Et,qt,V,$t,lt,ne,pe,ct,Lt,ue,Ge,Dt,ht,pt,Me,zt,xi,se,Si,Us,Mi,Oi,Rs,Ci,ji,fs,Pi,Ni,Vs,Ai,Ii,Ks,Gi,Bi,Xs,Hi,Qi,Wi,ut,Ui,Js,Ri,Vi,Zs,Ki,Xi,Ys,Ji,Zi,Yi,Xo,ed,Jo,td,od,nd,Zo,sd,Yo,ad,rd,ur,so,id,en,dd,ld,mr,Ft,ao,ea,tn,cd,ta,hd,fr,Oe,on,pd,xt,ud,gs,md,fd,nn,gd,_d,bd,St,kd,_s,Td,vd,bs,wd,yd,Ed,ro,gr,Mt,io,oa,sn,qd,na,$d,_r,C,an,Ld,sa,Dd,zd,aa,Fd,xd,lo,Sd,rn,Md,ra,Od,Cd,jd,co,Pd,dn,Nd,ks,Ad,Id,Gd,mt,ln,Bd,ia,Hd,Qd,cn,Ts,Wd,da,Ud,Rd,vs,Vd,la,Kd,Xd,ho,hn,Jd,pn,Zd,ca,Yd,el,tl,po,un,ol,ha,nl,sl,ws,mn,br,Ot,uo,pa,fn,al,ua,rl,kr,H,gn,il,_n,dl,ma,ll,cl,hl,fa,pl,ul,mo,ml,bn,fl,ga,gl,_l,bl,fo,kl,kn,Tl,ys,vl,wl,yl,go,Tn,El,_a,ql,Tr,Ct,_o,ba,vn,$l,ka,Ll,vr,jt,wn,Dl,Ta,zl,wr,Pt,yn,Fl,va,xl,yr,Nt,En,Sl,wa,Ml,Er,At,qn,Ol,ya,Cl,qr,It,$n,jl,Ea,Pl,$r,Gt,Ln,Nl,qa,Al,Lr,Bt,Dn,Il,$a,Gl,Dr,Ht,zn,Bl,La,Hl,zr,Qt,bo,Da,Fn,Ql,za,Wl,Fr,Ce,xn,Ul,Sn,Rl,Es,Vl,Kl,Xl,Mn,Jl,On,Zl,Yl,ec,Be,Cn,tc,Wt,oc,qs,nc,sc,Fa,ac,rc,ic,ko,dc,To,xr,Ut,vo,xa,jn,lc,Sa,cc,Sr,je,Pn,hc,Nn,pc,$s,uc,mc,fc,An,gc,In,_c,bc,kc,ye,Gn,Tc,Rt,vc,Ls,wc,yc,Ma,Ec,qc,$c,wo,Lc,yo,Dc,Eo,Mr,Vt,qo,Oa,Bn,zc,Ca,Fc,Or,me,Hn,xc,ja,Sc,Mc,Qn,Oc,Ds,Cc,jc,Pc,Wn,Nc,Un,Ac,Ic,Gc,J,Rn,Bc,Kt,Hc,zs,Qc,Wc,Pa,Uc,Rc,Vc,$o,Kc,Lo,Xc,Do,Jc,zo,Zc,Fo,Cr,Xt,xo,Na,Vn,Yc,Aa,eh,jr,fe,Kn,th,Jt,oh,Ia,nh,sh,Ga,ah,rh,ih,Xn,dh,Fs,lh,ch,hh,Jn,ph,Zn,uh,mh,fh,Ee,Yn,gh,Zt,_h,xs,bh,kh,Ba,Th,vh,wh,So,yh,Mo,Eh,Oo,Pr,Yt,Co,Ha,es,qh,Qa,$h,Nr,ge,ts,Lh,os,Dh,Ss,zh,Fh,xh,ns,Sh,ss,Mh,Oh,Ch,jo,jh,He,as,Ph,eo,Nh,Ms,Ah,Ih,Wa,Gh,Bh,Hh,Po,Qh,No,Ar,to,Ao,Ua,rs,Wh,Ra,Uh,Ir,_e,is,Rh,ds,Vh,Os,Kh,Xh,Jh,ls,Zh,cs,Yh,ep,tp,Io,op,Qe,hs,np,oo,sp,Cs,ap,rp,Va,ip,dp,lp,Go,cp,Bo,Gr;return d=new We({}),z=new We({}),tn=new We({}),on=new O({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/configuration_led.py#L31"}}),ro=new Le({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[pm]},$$scope:{ctx:L}}}),sn=new We({}),an=new O({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/tokenization_led.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/tokenization_led.py#L366",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/tokenization_led.py#L394",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/modeling_led.py#L2240",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDConfig"
...
`}}),ko=new wt({props:{$$slots:{default:[_m]},$$scope:{ctx:L}}}),To=new Le({props:{anchor:"transformers.LEDModel.forward.example",$$slots:{default:[bm]},$$scope:{ctx:L}}}),jn=new We({}),Pn=new O({props:{name:"class transformers.LEDForConditionalGeneration",anchor:"transformers.LEDForConditionalGeneration",parameters:[{name:"config",val:": LEDConfig"}],parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/modeling_led.py#L2336"}}),Gn=new O({props:{name:"forward",anchor:"transformers.LEDForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/modeling_led.py#L2380",returnDescription:`
<p>A <a
...
`}}),wo=new wt({props:{$$slots:{default:[km]},$$scope:{ctx:L}}}),yo=new Le({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example",$$slots:{default:[Tm]},$$scope:{ctx:L}}}),Eo=new Le({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example-2",$$slots:{default:[vm]},$$scope:{ctx:L}}}),Bn=new We({}),Hn=new O({props:{name:"class transformers.LEDForSequenceClassification",anchor:"transformers.LEDForSequenceClassification",parameters:[{name:"config",val:": LEDConfig"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/modeling_led.py#L2529"}}),Rn=new O({props:{name:"forward",anchor:"transformers.LEDForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/modeling_led.py#L2542",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/modeling_led.py#L2669",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/modeling_tf_led.py#L2260",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/led/modeling_tf_led.py#L2390",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
`}}),Go=new wt({props:{$$slots:{default:[Om]},$$scope:{ctx:L}}}),Bo=new Le({props:{anchor:"transformers.TFLEDForConditionalGeneration.call.example",$$slots:{default:[Cm]},$$scope:{ctx:L}}}),{c(){l=a("meta"),b=c(),p=a("h1"),m=a("a"),k=a("span"),T(d.$$.fragment),u=c(),D=a("span"),Y=n("LED"),A=c(),P=a("h2"),W=a("a"),ie=a("span"),T(z.$$.fragment),Ue=c(),ee=a("span"),Re=n("Overview"),Pe=c(),Q=a("p"),Ve=n("The LED model was proposed in "),de=a("a"),le=n("Longformer: The Long-Document Transformer"),Ke=n(` by Iz
...
`),oe=a("em"),ot=n("Longformer"),nt=n("\u2019s "),U=a("em"),st=n("chunked self-attention"),he=n(" layer. "),ve=a("a"),xe=n("LEDTokenizer"),B=n(` is an alias of
`),we=a("a"),R=n("BartTokenizer"),at=n("."),rt=c(),$=a("li"),F=n("LED works very well on long-range "),it=a("em"),Se=n("sequence-to-sequence"),yt=n(" tasks where the "),dt=a("code"),S=n("input_ids"),Et=n(` largely exceed a length of
...
`),nn=a("a"),gd=n("allenai/led-base-16384"),_d=n(" architecture."),bd=c(),St=a("p"),kd=n("Configuration objects inherit from "),_s=a("a"),Td=n("PretrainedConfig"),vd=n(` and can be used to control the model outputs. Read the
documentation from `),bs=a("a"),wd=n("PretrainedConfig"),yd=n(" for more information."),Ed=c(),T(ro.$$.fragment),gr=c(),Mt=a("h2"),io=a("a"),oa=a("span"),T(sn.$$.fragment),qd=c(),na=a("span"),$d=n("LEDTokenizer"),_r=c(),C=a("div"),T(an.$$.fragment),Ld=c(),sa=a("p"),Dd=n("Constructs a LED tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),zd=c(),aa=a("p"),Fd=n("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),xd=c(),T(lo.$$.fragment),Sd=c(),rn=a("p"),Md=n("You can get around that behavior by passing "),ra=a("code"),Od=n("add_prefix_space=True"),Cd=n(` when instantiating this tokenizer or when you
...
adding special tokens. A LED sequence has the following format:`),Qd=c(),cn=a("ul"),Ts=a("li"),Wd=n("single sequence: "),da=a("code"),Ud=n("<s> X </s>"),Rd=c(),vs=a("li"),Vd=n("pair of sequences: "),la=a("code"),Kd=n("<s> A </s></s> B </s>"),Xd=c(),ho=a("div"),T(hn.$$.fragment),Jd=c(),pn=a("p"),Zd=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned.`),sl=c(),ws=a("div"),T(mn.$$.fragment),br=c(),Ot=a("h2"),uo=a("a"),pa=a("span"),T(fn.$$.fragment),al=c(),ua=a("span"),rl=n("LEDTokenizerFast"),kr=c(),H=a("div"),T(gn.$$.fragment),il=c(),_n=a("p"),dl=n("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),ma=a("em"),ll=n("tokenizers"),cl=n(` library), derived from the GPT-2 tokenizer,
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),bl=c(),T(fo.$$.fragment),kl=c(),kn=a("p"),Tl=n("This tokenizer inherits from "),ys=a("a"),vl=n("PreTrainedTokenizerFast"),wl=n(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),yl=c(),go=a("div"),T(Tn.$$.fragment),El=c(),_a=a("p"),ql=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. LED does not
make use of token type ids, therefore a list of zeros is returned.`),Tr=c(),Ct=a("h2"),_o=a("a"),ba=a("span"),T(vn.$$.fragment),$l=c(),ka=a("span"),Ll=n("LED specific outputs"),vr=c(),jt=a("div"),T(wn.$$.fragment),Dl=c(),Ta=a("p"),zl=n("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),wr=c(),Pt=a("div"),T(yn.$$.fragment),Fl=c(),va=a("p"),xl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),yr=c(),Nt=a("div"),T(En.$$.fragment),Sl=c(),wa=a("p"),Ml=n("Base class for sequence-to-sequence language models outputs."),Er=c(),At=a("div"),T(qn.$$.fragment),Ol=c(),ya=a("p"),Cl=n("Base class for outputs of sequence-to-sequence sentence classification models."),qr=c(),It=a("div"),T($n.$$.fragment),jl=c(),Ea=a("p"),Pl=n("Base class for outputs of sequence-to-sequence question answering models."),$r=c(),Gt=a("div"),T(Ln.$$.fragment),Nl=c(),qa=a("p"),Al=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Lr=c(),Bt=a("div"),T(Dn.$$.fragment),Il=c(),$a=a("p"),Gl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),ec=c(),Be=a("div"),T(Cn.$$.fragment),tc=c(),Wt=a("p"),oc=n("The "),qs=a("a"),nc=n("LEDModel"),sc=n(" forward method, overrides the "),Fa=a("code"),ac=n("__call__"),rc=n(" special method."),ic=c(),T(ko.$$.fragment),dc=c(),T(To.$$.fragment),xr=c(),Ut=a("h2"),vo=a("a"),xa=a("span"),T(jn.$$.fragment),lc=c(),Sa=a("span"),cc=n("LEDForConditionalGeneration"),Sr=c(),je=a("div"),T(Pn.$$.fragment),hc=c(),Nn=a("p"),pc=n(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),kc=c(),ye=a("div"),T(Gn.$$.fragment),Tc=c(),Rt=a("p"),vc=n("The "),Ls=a("a"),wc=n("LEDForConditionalGeneration"),yc=n(" forward method, overrides the "),Ma=a("code"),Ec=n("__call__"),qc=n(" special method."),$c=c(),T(wo.$$.fragment),Lc=c(),T(yo.$$.fragment),Dc=c(),T(Eo.$$.fragment),Mr=c(),Vt=a("h2"),qo=a("a"),Oa=a("span"),T(Bn.$$.fragment),zc=c(),Ca=a("span"),Fc=n("LEDForSequenceClassification"),Or=c(),me=a("div"),T(Hn.$$.fragment),xc=c(),ja=a("p"),Sc=n(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),fh=c(),Ee=a("div"),T(Yn.$$.fragment),gh=c(),Zt=a("p"),_h=n("The "),xs=a("a"),bh=n("LEDForQuestionAnswering"),kh=n(" forward method, overrides the "),Ba=a("code"),Th=n("__call__"),vh=n(" special method."),wh=c(),T(So.$$.fragment),yh=c(),T(Mo.$$.fragment),Eh=c(),T(Oo.$$.fragment),Pr=c(),Yt=a("h2"),Co=a("a"),Ha=a("span"),T(es.$$.fragment),qh=c(),Qa=a("span"),$h=n("TFLEDModel"),Nr=c(),ge=a("div"),T(ts.$$.fragment),Lh=c(),os=a("p"),Dh=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
`),oe=r(Z,"EM",{});var lr=i(oe);ot=s(lr,"Longformer"),lr.forEach(t),nt=s(Z,"\u2019s "),U=r(Z,"EM",{});var cr=i(U);st=s(cr,"chunked self-attention"),cr.forEach(t),he=s(Z," layer. "),ve=r(Z,"A",{href:!0});var hr=i(ve);xe=s(hr,"LEDTokenizer"),hr.forEach(t),B=s(Z,` is an alias of
`),we=r(Z,"A",{href:!0});var pr=i(we);R=s(pr,"BartTokenizer"),pr.forEach(t),at=s(Z,"."),Z.forEach(t),rt=h(ae),$=r(ae,"LI",{});var no=i($);F=s(no,"LED works very well on long-range "),it=r(no,"EM",{});var up=i(it);Se=s(up,"sequence-to-sequence"),up.forEach(t),yt=s(no," tasks where the "),dt=r(no,"CODE",{});var mp=i(dt);S=s(mp,"input_ids"),mp.forEach(t),Et=s(no,` largely exceed a length of
...
`),fs=r(qe,"A",{href:!0});var vp=i(fs);Pi=s(vp,"LongformerModel"),vp.forEach(t),Ni=s(qe,"). For summarization, it is advised to put "),Vs=r(qe,"EM",{});var wp=i(Vs);Ai=s(wp,"global attention"),wp.forEach(t),Ii=s(qe,` only on the first
`),Ks=r(qe,"CODE",{});var yp=i(Ks);Gi=s(yp,"<s>"),yp.forEach(t),Bi=s(qe," token. For question answering, it is advised to put "),Xs=r(qe,"EM",{});var Ep=i(Xs);Hi=s(Ep,"global attention"),Ep.forEach(t),Qi=s(qe," on all tokens of the question."),qe.forEach(t),Wi=h(ae),ut=r(ae,"LI",{});var Ho=i(ut);Ui=s(Ho,"To fine-tune LED on all 16384, "),Js=r(Ho,"EM",{});var qp=i(Js);Ri=s(qp,"gradient checkpointing"),qp.forEach(t),Vi=s(Ho,` can be enabled in case training leads to out-of-memory (OOM)
...
flag can be used to disable the caching mechanism to save memory.`),Ho.forEach(t),Yi=h(ae),Xo=r(ae,"LI",{});var Br=i(Xo);ed=s(Br,"A notebook showing how to evaluate LED, can be accessed "),Jo=r(Br,"A",{href:!0,rel:!0});var Dp=i(Jo);td=s(Dp,"here"),Dp.forEach(t),od=s(Br,"."),Br.forEach(t),nd=h(ae),Zo=r(ae,"LI",{});var Hr=i(Zo);sd=s(Hr,"A notebook showing how to fine-tune LED, can be accessed "),Yo=r(Hr,"A",{href:!0,rel:!0});var zp=i(Yo);ad=s(zp,"here"),zp.forEach(t),rd=s(Hr,"."),Hr.forEach(t),ae.forEach(t),ur=h(o),so=r(o,"P",{});var Qr=i(so);id=s(Qr,"This model was contributed by "),en=r(Qr,"A",{href:!0,rel:!0});var Fp=i(en);dd=s(Fp,"patrickvonplaten"),Fp.forEach(t),ld=s(Qr,"."),Qr.forEach(t),mr=h(o),Ft=r(o,"H2",{class:!0});var Wr=i(Ft);ao=r(Wr,"A",{id:!0,class:!0,href:!0});var xp=i(ao);ea=r(xp,"SPAN",{});var Sp=i(ea);v(tn.$$.fragment,Sp),Sp.forEach(t),xp.forEach(t),cd=h(Wr),ta=r(Wr,"SPAN",{});var Mp=i(ta);hd=s(Mp,"LEDConfig"),Mp.forEach(t),Wr.forEach(t),fr=h(o),Oe=r(o,"DIV",{class:!0});var Qo=i(Oe);v(on.$$.fragment,Qo),pd=h(Qo),xt=r(Qo,"P",{});var js=i(xt);ud=s(js,"This is the configuration class to store the configuration of a "),gs=r(js,"A",{href:!0});var Op=i(gs);md=s(Op,"LEDModel"),Op.forEach(t),fd=s(js,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),nn=r(js,"A",{href:!0,rel:!0});var Cp=i(nn);gd=s(Cp,"allenai/led-base-16384"),Cp.forEach(t),_d=s(js," architecture."),js.forEach(t),bd=h(Qo),St=r(Qo,"P",{});var Ps=i(St);kd=s(Ps,"Configuration objects inherit from "),_s=r(Ps,"A",{href:!0});var jp=i(_s);Td=s(jp,"PretrainedConfig"),jp.forEach(t),vd=s(Ps,` and can be used to control the model outputs. Read the
documentation from `),bs=r(Ps,"A",{href:!0});var Pp=i(bs);wd=s(Pp,"PretrainedConfig"),Pp.forEach(t),yd=s(Ps," for more information."),Ps.forEach(t),Ed=h(Qo),v(ro.$$.fragment,Qo),Qo.forEach(t),gr=h(o),Mt=r(o,"H2",{class:!0});var Ur=i(Mt);io=r(Ur,"A",{id:!0,class:!0,href:!0});var Np=i(io);oa=r(Np,"SPAN",{});var Ap=i(oa);v(sn.$$.fragment,Ap),Ap.forEach(t),Np.forEach(t),qd=h(Ur),na=r(Ur,"SPAN",{});var Ip=i(na);$d=s(Ip,"LEDTokenizer"),Ip.forEach(t),Ur.forEach(t),_r=h(o),C=r(o,"DIV",{class:!0});var N=i(C);v(an.$$.fragment,N),Ld=h(N),sa=r(N,"P",{});var Gp=i(sa);Dd=s(Gp,"Constructs a LED tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),Gp.forEach(t),zd=h(N),aa=r(N,"P",{});var Bp=i(aa);Fd=s(Bp,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Bp.forEach(t),xd=h(N),v(lo.$$.fragment,N),Sd=h(N),rn=r(N,"P",{});var Rr=i(rn);Md=s(Rr,"You can get around that behavior by passing "),ra=r(Rr,"CODE",{});var Hp=i(ra);Od=s(Hp,"add_prefix_space=True"),Hp.forEach(t),Cd=s(Rr,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Rr.forEach(t),jd=h(N),v(co.$$.fragment,N),Pd=h(N),dn=r(N,"P",{});var Vr=i(dn);Nd=s(Vr,"This tokenizer inherits from "),ks=r(Vr,"A",{href:!0});var Qp=i(ks);Ad=s(Qp,"PreTrainedTokenizer"),Qp.forEach(t),Id=s(Vr,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Vr.forEach(t),Gd=h(N),mt=r(N,"DIV",{class:!0});var Ns=i(mt);v(ln.$$.fragment,Ns),Bd=h(Ns),ia=r(Ns,"P",{});var Wp=i(ia);Hd=s(Wp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A LED sequence has the following format:`),Wp.forEach(t),Qd=h(Ns),cn=r(Ns,"UL",{});var Kr=i(cn);Ts=r(Kr,"LI",{});var hp=i(Ts);Wd=s(hp,"single sequence: "),da=r(hp,"CODE",{});var Up=i(da);Ud=s(Up,"<s> X </s>"),Up.forEach(t),hp.forEach(t),Rd=h(Kr),vs=r(Kr,"LI",{});var pp=i(vs);Vd=s(pp,"pair of sequences: "),la=r(pp,"CODE",{});var Rp=i(la);Kd=s(Rp,"<s> A </s></s> B </s>"),Rp.forEach(t),pp.forEach(t),Kr.forEach(t),Ns.forEach(t),Xd=h(N),ho=r(N,"DIV",{class:!0});var Xr=i(ho);v(hn.$$.fragment,Xr),Jd=h(Xr),pn=r(Xr,"P",{});var Jr=i(pn);Zd=s(Jr,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ca=r(Jr,"CODE",{});var Vp=i(ca);Yd=s(Vp,"prepare_for_model"),Vp.forEach(t),el=s(Jr," method."),Jr.forEach(t),Xr.forEach(t),tl=h(N),po=r(N,"DIV",{class:!0});var Zr=i(po);v(un.$$.fragment,Zr),ol=h(Zr),ha=r(Zr,"P",{});var Kp=i(ha);nl=s(Kp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. LED does not
make use of token type ids, therefore a list of zeros is returned.`),Kp.forEach(t),Zr.forEach(t),sl=h(N),ws=r(N,"DIV",{class:!0});var Xp=i(ws);v(mn.$$.fragment,Xp),Xp.forEach(t),N.forEach(t),br=h(o),Ot=r(o,"H2",{class:!0});var Yr=i(Ot);uo=r(Yr,"A",{id:!0,class:!0,href:!0});var Jp=i(uo);pa=r(Jp,"SPAN",{});var Zp=i(pa);v(fn.$$.fragment,Zp),Zp.forEach(t),Jp.forEach(t),al=h(Yr),ua=r(Yr,"SPAN",{});var Yp=i(ua);rl=s(Yp,"LEDTokenizerFast"),Yp.forEach(t),Yr.forEach(t),kr=h(o),H=r(o,"DIV",{class:!0});var re=i(H);v(gn.$$.fragment,re),il=h(re),_n=r(re,"P",{});var ei=i(_n);dl=s(ei,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),ma=r(ei,"EM",{});var eu=i(ma);ll=s(eu,"tokenizers"),eu.forEach(t),cl=s(ei,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),ei.forEach(t),hl=h(re),fa=r(re,"P",{});var tu=i(fa);pl=s(tu,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),tu.forEach(t),ul=h(re),v(mo.$$.fragment,re),ml=h(re),bn=r(re,"P",{});var ti=i(bn);fl=s(ti,"You can get around that behavior by passing "),ga=r(ti,"CODE",{});var ou=i(ga);gl=s(ou,"add_prefix_space=True"),ou.forEach(t),_l=s(ti,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),ti.forEach(t),bl=h(re),v(fo.$$.fragment,re),kl=h(re),kn=r(re,"P",{});var oi=i(kn);Tl=s(oi,"This tokenizer inherits from "),ys=r(oi,"A",{href:!0});var nu=i(ys);vl=s(nu,"PreTrainedTokenizerFast"),nu.forEach(t),wl=s(oi,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),oi.forEach(t),yl=h(re),go=r(re,"DIV",{class:!0});var ni=i(go);v(Tn.$$.fragment,ni),El=h(ni),_a=r(ni,"P",{});var su=i(_a);ql=s(su,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. LED does not
make use of token type ids, therefore a list of zeros is returned.`),su.forEach(t),ni.forEach(t),re.forEach(t),Tr=h(o),Ct=r(o,"H2",{class:!0});var si=i(Ct);_o=r(si,"A",{id:!0,class:!0,href:!0});var au=i(_o);ba=r(au,"SPAN",{});var ru=i(ba);v(vn.$$.fragment,ru),ru.forEach(t),au.forEach(t),$l=h(si),ka=r(si,"SPAN",{});var iu=i(ka);Ll=s(iu,"LED specific outputs"),iu.forEach(t),si.forEach(t),vr=h(o),jt=r(o,"DIV",{class:!0});var ai=i(jt);v(wn.$$.fragment,ai),Dl=h(ai),Ta=r(ai,"P",{});var du=i(Ta);zl=s(du,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),du.forEach(t),ai.forEach(t),wr=h(o),Pt=r(o,"DIV",{class:!0});var ri=i(Pt);v(yn.$$.fragment,ri),Fl=h(ri),va=r(ri,"P",{});var lu=i(va);xl=s(lu,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),lu.forEach(t),ri.forEach(t),yr=h(o),Nt=r(o,"DIV",{class:!0});var ii=i(Nt);v(En.$$.fragment,ii),Sl=h(ii),wa=r(ii,"P",{});var cu=i(wa);Ml=s(cu,"Base class for sequence-to-sequence language models outputs."),cu.forEach(t),ii.forEach(t),Er=h(o),At=r(o,"DIV",{class:!0});var di=i(At);v(qn.$$.fragment,di),Ol=h(di),ya=r(di,"P",{});var hu=i(ya);Cl=s(hu,"Base class for outputs of sequence-to-sequence sentence classification models."),hu.forEach(t),di.forEach(t),qr=h(o),It=r(o,"DIV",{class:!0});var li=i(It);v($n.$$.fragment,li),jl=h(li),Ea=r(li,"P",{});var pu=i(Ea);Pl=s(pu,"Base class for outputs of sequence-to-sequence question answering models."),pu.forEach(t),li.forEach(t),$r=h(o),Gt=r(o,"DIV",{class:!0});var ci=i(Gt);v(Ln.$$.fragment,ci),Nl=h(ci),qa=r(ci,"P",{});var uu=i(qa);Al=s(uu,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),uu.forEach(t),ci.forEach(t),Lr=h(o),Bt=r(o,"DIV",{class:!0});var hi=i(Bt);v(Dn.$$.fragment,hi),Il=h(hi),$a=r(hi,"P",{});var mu=i($a);Gl=s(mu,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),mu.forEach(t),hi.forEach(t),Dr=h(o),Ht=r(o,"DIV",{class:!0});var pi=i(Ht);v(zn.$$.fragment,pi),Bl=h(pi),La=r(pi,"P",{});var fu=i(La);Hl=s(fu,"Base class for sequence-to-sequence language models outputs."),fu.forEach(t),pi.forEach(t),zr=h(o),Qt=r(o,"H2",{class:!0});var ui=i(Qt);bo=r(ui,"A",{id:!0,class:!0,href:!0});var gu=i(bo);Da=r(gu,"SPAN",{});var _u=i(Da);v(Fn.$$.fragment,_u),_u.forEach(t),gu.forEach(t),Ql=h(ui),za=r(ui,"SPAN",{});var bu=i(za);Wl=s(bu,"LEDModel"),bu.forEach(t),ui.forEach(t),Fr=h(o),Ce=r(o,"DIV",{class:!0});var Wo=i(Ce);v(xn.$$.fragment,Wo),Ul=h(Wo),Sn=r(Wo,"P",{});var mi=i(Sn);Rl=s(mi,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),fi.forEach(t),ec=h(Wo),Be=r(Wo,"DIV",{class:!0});var Uo=i(Be);v(Cn.$$.fragment,Uo),tc=h(Uo),Wt=r(Uo,"P",{});var As=i(Wt);oc=s(As,"The "),qs=r(As,"A",{href:!0});var vu=i(qs);nc=s(vu,"LEDModel"),vu.forEach(t),sc=s(As," forward method, overrides the "),Fa=r(As,"CODE",{});var wu=i(Fa);ac=s(wu,"__call__"),wu.forEach(t),rc=s(As," special method."),As.forEach(t),ic=h(Uo),v(ko.$$.fragment,Uo),dc=h(Uo),v(To.$$.fragment,Uo),Uo.forEach(t),Wo.forEach(t),xr=h(o),Ut=r(o,"H2",{class:!0});var gi=i(Ut);vo=r(gi,"A",{id:!0,class:!0,href:!0});var yu=i(vo);xa=r(yu,"SPAN",{});var Eu=i(xa);v(jn.$$.fragment,Eu),Eu.forEach(t),yu.forEach(t),lc=h(gi),Sa=r(gi,"SPAN",{});var qu=i(Sa);cc=s(qu,"LEDForConditionalGeneration"),qu.forEach(t),gi.forEach(t),Sr=h(o),je=r(o,"DIV",{class:!0});var Ro=i(je);v(Pn.$$.fragment,Ro),hc=h(Ro),Nn=r(Ro,"P",{});var _i=i(Nn);pc=s(_i,`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),bi.forEach(t),kc=h(Ro),ye=r(Ro,"DIV",{class:!0});var gt=i(ye);v(Gn.$$.fragment,gt),Tc=h(gt),Rt=r(gt,"P",{});var Is=i(Rt);vc=s(Is,"The "),Ls=r(Is,"A",{href:!0});var Du=i(Ls);wc=s(Du,"LEDForConditionalGeneration"),Du.forEach(t),yc=s(Is," forward method, overrides the "),Ma=r(Is,"CODE",{});var zu=i(Ma);Ec=s(zu,"__call__"),zu.forEach(t),qc=s(Is," special method."),Is.forEach(t),$c=h(gt),v(wo.$$.fragment,gt),Lc=h(gt),v(yo.$$.fragment,gt),Dc=h(gt),v(Eo.$$.fragment,gt),gt.forEach(t),Ro.forEach(t),Mr=h(o),Vt=r(o,"H2",{class:!0});var ki=i(Vt);qo=r(ki,"A",{id:!0,class:!0,href:!0});var Fu=i(qo);Oa=r(Fu,"SPAN",{});var xu=i(Oa);v(Bn.$$.fragment,xu),xu.forEach(t),Fu.forEach(t),zc=h(ki),Ca=r(ki,"SPAN",{});var Su=i(Ca);Fc=s(Su,"LEDForSequenceClassification"),Su.forEach(t),ki.forEach(t),Or=h(o),me=r(o,"DIV",{class:!0});var _t=i(me);v(Hn.$$.fragment,_t),xc=h(_t),ja=r(_t,"P",{});var Mu=i(ja);Sc=s(Mu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Ti.forEach(t),Pc=h(_t),Wn=r(_t,"P",{});var vi=i(Wn);Nc=s(vi,"This model is also a PyTorch "),Un=r(vi,"A",{href:!0,rel:!0});var Cu=i(Un);Ac=s(Cu,"torch.nn.Module"),Cu.forEach(t),Ic=s(vi,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),vi.forEach(t),Gc=h(_t),J=r(_t,"DIV",{class:!0});var $e=i(J);v(Rn.$$.fragment,$e),Bc=h($e),Kt=r($e,"P",{});var Gs=i(Kt);Hc=s(Gs,"The "),zs=r(Gs,"A",{href:!0});var ju=i(zs);Qc=s(ju,"LEDForSequenceClassification"),ju.forEach(t),Wc=s(Gs," forward method, overrides the "),Pa=r(Gs,"CODE",{});var Pu=i(Pa);Uc=s(Pu,"__call__"),Pu.forEach(t),Rc=s(Gs," special method."),Gs.forEach(t),Vc=h($e),v($o.$$.fragment,$e),Kc=h($e),v(Lo.$$.fragment,$e),Xc=h($e),v(Do.$$.fragment,$e),Jc=h($e),v(zo.$$.fragment,$e),Zc=h($e),v(Fo.$$.fragment,$e),$e.forEach(t),_t.forEach(t),Cr=h(o),Xt=r(o,"H2",{class:!0});var wi=i(Xt);xo=r(wi,"A",{id:!0,class:!0,href:!0});var Nu=i(xo);Na=r(Nu,"SPAN",{});var Au=i(Na);v(Vn.$$.fragment,Au),Au.forEach(t),Nu.forEach(t),Yc=h(wi),Aa=r(wi,"SPAN",{});var Iu=i(Aa);eh=s(Iu,"LEDForQuestionAnswering"),Iu.forEach(t),wi.forEach(t),jr=h(o),fe=r(o,"DIV",{class:!0});var bt=i(fe);v(Kn.$$.fragment,bt),th=h(bt),Jt=r(bt,"P",{});var Bs=i(Jt);oh=s(Bs,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ia=r(Bs,"CODE",{});var Gu=i(Ia);nh=s(Gu,"span start logits"),Gu.forEach(t),sh=s(Bs," and "),Ga=r(Bs,"CODE",{});var Bu=i(Ga);ah=s(Bu,"span end logits"),Bu.forEach(t),rh=s(Bs,")."),Bs.forEach(t),ih=h(bt),Xn=r(bt,"P",{});var yi=i(Xn);dh=s(yi,"This model inherits from "),Fs=r(yi,"A",{href:!0});var Hu=i(Fs);lh=s(Hu,"PreTrainedModel"),Hu.forEach(t),ch=s(yi,`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),yi.forEach(t),hh=h(bt),Jn=r(bt,"P",{});var Ei=i(Jn);ph=s(Ei,"This model is also a PyTorch "),Zn=r(Ei,"A",{href:!0,rel:!0});var Qu=i(Zn);uh=s(Qu,"torch.nn.Module"),Qu.forEach(t),mh=s(Ei,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ei.forEach(t),fh=h(bt),Ee=r(bt,"DIV",{class:!0});var kt=i(Ee);v(Yn.$$.fragment,kt),gh=h(kt),Zt=r(kt,"P",{});var Hs=i(Zt);_h=s(Hs,"The "),xs=r(Hs,"A",{href:!0});var Wu=i(xs);bh=s(Wu,"LEDForQuestionAnswering"),Wu.forEach(t),kh=s(Hs," forward method, overrides the "),Ba=r(Hs,"CODE",{});var Uu=i(Ba);Th=s(Uu,"__call__"),Uu.forEach(t),vh=s(Hs," special method."),Hs.forEach(t),wh=h(kt),v(So.$$.fragment,kt),yh=h(kt),v(Mo.$$.fragment,kt),Eh=h(kt),v(Oo.$$.fragment,kt),kt.forEach(t),bt.forEach(t),Pr=h(o),Yt=r(o,"H2",{class:!0});var qi=i(Yt);Co=r(qi,"A",{id:!0,class:!0,href:!0});var Ru=i(Co);Ha=r(Ru,"SPAN",{});var Vu=i(Ha);v(es.$$.fragment,Vu),Vu.forEach(t),Ru.forEach(t),qh=h(qi),Qa=r(qi,"SPAN",{});var Ku=i(Qa);$h=s(Ku,"TFLEDModel"),Ku.forEach(t),qi.forEach(t),Nr=h(o),ge=r(o,"DIV",{class:!0});var Tt=i(ge);v(ts.$$.fragment,Tt),Lh=h(Tt),os=r(Tt,"P",{});var $i=i(os);Dh=s($i,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Li.forEach(t),Ch=h(Tt),v(jo.$$.fragment,Tt),jh=h(Tt),He=r(Tt,"DIV",{class:!0});var Vo=i(He);v(as.$$.fragment,Vo),Ph=h(Vo),eo=r(Vo,"P",{});var Qs=i(eo);Nh=s(Qs,"The "),Ms=r(Qs,"A",{href:!0});var Zu=i(Ms);Ah=s(Zu,"TFLEDModel"),Zu.forEach(t),Ih=s(Qs," forward method, overrides the "),Wa=r(Qs,"CODE",{});var Yu=i(Wa);Gh=s(Yu,"__call__"),Yu.forEach(t),Bh=s(Qs," special method."),Qs.forEach(t),Hh=h(Vo),v(Po.$$.fragment,Vo),Qh=h(Vo),v(No.$$.fragment,Vo),Vo.forEach(t),Tt.forEach(t),Ar=h(o),to=r(o,"H2",{class:!0});var Di=i(to);Ao=r(Di,"A",{id:!0,class:!0,href:!0});var em=i(Ao);Ua=r(em,"SPAN",{});var tm=i(Ua);v(rs.$$.fragment,tm),tm.forEach(t),em.forEach(t),Wh=h(Di),Ra=r(Di,"SPAN",{});var om=i(Ra);Uh=s(om,"TFLEDForConditionalGeneration"),om.forEach(t),Di.forEach(t),Ir=h(o),_e=r(o,"DIV",{class:!0});var vt=i(_e);v(is.$$.fragment,vt),Rh=h(vt),ds=r(vt,"P",{});var zi=i(ds);Vh=s(zi,`The LED Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zi.forEach(t),Jh=h(vt),ls=r(vt,"P",{});var Fi=i(ls);Zh=s(Fi,"This model is also a "),cs=r(Fi,"A",{href:!0,rel:!0});var sm=i(cs);Yh=s(sm,"tf.keras.Model"),sm.forEach(t),ep=s(Fi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),tp=h(vt),v(Io.$$.fragment,vt),op=h(vt),Qe=r(vt,"DIV",{class:!0});var Ko=i(Qe);v(hs.$$.fragment,Ko),np=h(Ko),oo=r(Ko,"P",{});var Ws=i(oo);sp=s(Ws,"The "),Cs=r(Ws,"A",{href:!0});var am=i(Cs);ap=s(am,"TFLEDForConditionalGeneration"),am.forEach(t),rp=s(Ws," forward method, overrides the "),Va=r(Ws,"CODE",{});var rm=i(Va);ip=s(rm,"__call__"),rm.forEach(t),dp=s(Ws," special method."),Ws.forEach(t),lp=h(Ko),v(Go.$$.fragment,Ko),cp=h(Ko),v(Bo.$$.fragment,Ko),Ko.forEach(t),vt.forEach(t),this.h()},h(){f(l,"name","hf:doc:metadata"),f(l,"content",JSON.stringify(Pm)),f(m,"id","led"),f(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(m,"href","#led"),f(p,"class","relative group"),f(W,"id","overview"),f(W,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(W,"href","#overview"),f(P,"class","relative group"),f(de,"href","https://arxiv.org/abs/2004.05150"),f(de,"rel","nofollow"),f(ke,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDForConditionalGeneration"),f(Te,"href","/docs/transformers/v4.23.0/en/model_doc/bart#transformers.BartForConditionalGeneration"),f(ve,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDTokenizer"),f(we,"href","/docs/transformers/v4.23.0/en/model_doc/bart#transformers.BartTokenizer"),f(Ge,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDTokenizer"),f(fs,"href","/docs/transformers/v4.23.0/en/model_doc/longformer#transformers.LongformerModel"),f(Jo,"href","https://colab.research.google.com/drive/12INTTR6n64TzS4RrXZxMSXfrOd9Xzamo?usp=sharing"),f(Jo,"rel","nofollow"),f(Yo,"href","https://colab.research.google.com/drive/12LjJazBl7Gam0XBPy_y0CTOJZeZ34c2v?usp=sharing"),f(Yo,"rel","nofollow"),f(en,"href","https://huggingface.co/patrickvonplaten"),f(en,"rel","nofollow"),f(ao,"id","transformers.LEDConfig"),f(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(ao,"href","#transformers.LEDConfig"),f(Ft,"class","relative group"),f(gs,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDModel"),f(nn,"href","https://huggingface.co/allenai/led-base-16384"),f(nn,"rel","nofollow"),f(_s,"href","/docs/transformers/v4.23.0/en/main_classes/configuration#transformers.PretrainedConfig"),f(bs,"href","/docs/transformers/v4.23.0/en/main_classes/configuration#transformers.PretrainedConfig"),f(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(io,"id","transformers.LEDTokenizer"),f(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(io,"href","#transformers.LEDTokenizer"),f(Mt,"class","relative group"),f(ks,"href","/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),f(mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ho,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(po,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ws,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(uo,"id","transformers.LEDTokenizerFast"),f(uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(uo,"href","#transformers.LEDTokenizerFast"),f(Ot,"class","relative group"),f(ys,"href","/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),f(go,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(_o,"id","transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),f(_o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(_o,"href","#transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),f(Ct,"class","relative group"),f(jt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(At,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(It,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(bo,"id","transformers.LEDModel"),f(bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(bo,"href","#transformers.LEDModel"),f(Qt,"class","relative group"),f(Es,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel"),f(On,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(On,"rel","nofollow"),f(qs,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDModel"),f(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(vo,"id","transformers.LEDForConditionalGeneration"),f(vo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(vo,"href","#transformers.LEDForConditionalGeneration"),f(Ut,"class","relative group"),f($s,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel"),f(In,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(In,"rel","nofollow"),f(Ls,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDForConditionalGeneration"),f(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(qo,"id","transformers.LEDForSequenceClassification"),f(qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(qo,"href","#transformers.LEDForSequenceClassification"),f(Vt,"class","relative group"),f(Ds,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel"),f(Un,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Un,"rel","nofollow"),f(zs,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDForSequenceClassification"),f(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(xo,"id","transformers.LEDForQuestionAnswering"),f(xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(xo,"href","#transformers.LEDForQuestionAnswering"),f(Xt,"class","relative group"),f(Fs,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel"),f(Zn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Zn,"rel","nofollow"),f(xs,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.LEDForQuestionAnswering"),f(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Co,"id","transformers.TFLEDModel"),f(Co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Co,"href","#transformers.TFLEDModel"),f(Yt,"class","relative group"),f(Ss,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.TFPreTrainedModel"),f(ss,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(ss,"rel","nofollow"),f(Ms,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.TFLEDModel"),f(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ao,"id","transformers.TFLEDForConditionalGeneration"),f(Ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Ao,"href","#transformers.TFLEDForConditionalGeneration"),f(to,"class","relative group"),f(Os,"href","/docs/transformers/v4.23.0/en/main_classes/model#transformers.TFPreTrainedModel"),f(cs,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(cs,"rel","nofollow"),f(Cs,"href","/docs/transformers/v4.23.0/en/model_doc/led#transformers.TFLEDForConditionalGeneration"),f(Qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(_e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,g){e(document.head,l),_(o,b,g),_(o,p,g),e(p,m),e(m,k),w(d,k,null),e(p,u),e(p,D),e(D,Y),_(o,A,g),_(o,P,g),e(P,W),e(W,ie),w(z,ie,null),e(P,Ue),e(P,ee),e(ee,Re),_(o,Pe,g),_(o,Q,g),e(Q,Ve),e(Q,de),e(de,le),e(Q,Ke),_(o,Ne,g),_(o,K,g),e(K,Xe),_(o,Ae,g),_(o,X,g),e(X,Fe),e(Fe,Je),_(o,be,g),_(o,M,g),e(M,I),_(o,Ie,g),_(o,x,g),e(x,j),e(j,ke),e(ke,ce),e(j,Ze),e(j,Te),e(Te,G),e(j,Ye),e(j,te),e(te,et),e(j,tt),e(j,oe),e(oe,ot),e(j,nt),e(j,U),e(U,st),e(j,he),e(j,ve),e(ve,xe),e(j,B),e(j,we),e(we,R),e(j,at),e(x,rt),e(x,$),e($,F),e($,it),e(it,Se),e($,yt),e($,dt),e(dt,S),e($,Et),e(x,qt),e(x,V),e(V,$t),e(V,lt),e(lt,ne),e(V,pe),e(V,ct),e(ct,Lt),e(V,ue),e(V,Ge),e(Ge,Dt),e(V,ht),e(V,pt),e(pt,Me),e(V,zt),e(x,xi),e(x,se),e(se,Si),e(se,Us),e(Us,Mi),e(se,Oi),e(se,Rs),e(Rs,Ci),e(se,ji),e(se,fs),e(fs,Pi),e(se,Ni),e(se,Vs),e(Vs,Ai),e(se,Ii),e(se,Ks),e(Ks,Gi),e(se,Bi),e(se,Xs),e(Xs,Hi),e(se,Qi),e(x,Wi),e(x,ut),e(ut,Ui),e(ut,Js),e(Js,Ri),e(ut,Vi),e(ut,Zs),e(Zs,Ki),e(ut,Xi),e(ut,Ys),e(Ys,Ji),e(ut,Zi),e(x,Yi),e(x,Xo),e(Xo,ed),e(Xo,Jo),e(Jo,td),e(Xo,od),e(x,nd),e(x,Zo),e(Zo,sd),e(Zo,Yo),e(Yo,ad),e(Zo,rd),_(o,ur,g),_(o,so,g),e(so,id),e(so,en),e(en,dd),e(so,ld),_(o,mr,g),_(o,Ft,g),e(Ft,ao),e(ao,ea),w(tn,ea,null),e(Ft,cd),e(Ft,ta),e(ta,hd),_(o,fr,g),_(o,Oe,g),w(on,Oe,null),e(Oe,pd),e(Oe,xt),e(xt,ud),e(xt,gs),e(gs,md),e(xt,fd),e(xt,nn),e(nn,gd),e(xt,_d),e(Oe,bd),e(Oe,St),e(St,kd),e(St,_s),e(_s,Td),e(St,vd),e(St,bs),e(bs,wd),e(St,yd),e(Oe,Ed),w(ro,Oe,null),_(o,gr,g),_(o,Mt,g),e(Mt,io),e(io,oa),w(sn,oa,null),e(Mt,qd),e(Mt,na),e(na,$d),_(o,_r,g),_(o,C,g),w(an,C,null),e(C,Ld),e(C,sa),e(sa,Dd),e(C,zd),e(C,aa),e(aa,Fd),e(C,xd),w(lo,C,null),e(C,Sd),e(C,rn),e(rn,Md),e(rn,ra),e(ra,Od),e(rn,Cd),e(C,jd),w(co,C,null),e(C,Pd),e(C,dn),e(dn,Nd),e(dn,ks),e(ks,Ad),e(dn,Id),e(C,Gd),e(C,mt),w(ln,mt,null),e(mt,Bd),e(mt,ia),e(ia,Hd),e(mt,Qd),e(mt,cn),e(cn,Ts),e(Ts,Wd),e(Ts,da),e(da,Ud),e(cn,Rd),e(cn,vs),e(vs,Vd),e(vs,la),e(la,Kd),e(C,Xd),e(C,ho),w(hn,ho,null),e(ho,Jd),e(ho,pn),e(pn,Zd),e(pn,ca),e(ca,Yd),e(pn,el),e(C,tl),e(C,po),w(un,po,null),e(po,ol),e(po,ha),e(ha,nl),e(C,sl),e(C,ws),w(mn,ws,null),_(o,br,g),_(o,Ot,g),e(Ot,uo),e(uo,pa),w(fn,pa,null),e(Ot,al),e(Ot,ua),e(ua,rl),_(o,kr,g),_(o,H,g),w(gn,H,null),e(H,il),e(H,_n),e(_n,dl),e(_n,ma),e(ma,ll),e(_n,cl),e(H,hl),e(H,fa),e(fa,pl),e(H,ul),w(mo,H,null),e(H,ml),e(H,bn),e(bn,fl),e(bn,ga),e(ga,gl),e(bn,_l),e(H,bl),w(fo,H,null),e(H,kl),e(H,kn),e(kn,Tl),e(kn,ys),e(ys,vl),e(kn,wl),e(H,yl),e(H,go),w(Tn,go,null),e(go,El),e(go,_a),e(_a,ql),_(o,Tr,g),_(o,Ct,g),e(Ct,_o),e(_o,ba),w(vn,ba,null),e(Ct,$l),e(Ct,ka),e(ka,Ll),_(o,vr,g),_(o,jt,g),w(wn,jt,null),e(jt,Dl),e(jt,Ta),e(Ta,zl),_(o,wr,g),_(o,Pt,g),w(yn,Pt,null),e(Pt,Fl),e(Pt,va),e(va,xl),_(o,yr,g),_(o,Nt,g),w(En,Nt,null),e(Nt,Sl),e(Nt,wa),e(wa,Ml),_(o,Er,g),_(o,At,g),w(qn,At,null),e(At,Ol),e(At,ya),e(ya,Cl),_(o,qr,g),_(o,It,g),w($n,It,null),e(It,jl),e(It,Ea),e(Ea,Pl),_(o,$r,g),_(o,Gt,g),w(Ln,Gt,null),e(Gt,Nl),e(Gt,qa),e(qa,Al),_(o,Lr,g),_(o,Bt,g),w(Dn,Bt,null),e(Bt,Il),e(Bt,$a),e($a,Gl),_(o,Dr,g),_(o,Ht,g),w(zn,Ht,null),e(Ht,Bl),e(Ht,La),e(La,Hl),_(o,zr,g),_(o,Qt,g),e(Qt,bo),e(bo,Da),w(Fn,Da,null),e(Qt,Ql),e(Qt,za),e(za,Wl),_(o,Fr,g),_(o,Ce,g),w(xn,Ce,null),e(Ce,Ul),e(Ce,Sn),e(Sn,Rl),e(Sn,Es),e(Es,Vl),e(Sn,Kl),e(Ce,Xl),e(Ce,Mn),e(Mn,Jl),e(Mn,On),e(On,Zl),e(Mn,Yl),e(Ce,ec),e(Ce,Be),w(Cn,Be,null),e(Be,tc),e(Be,Wt),e(Wt,oc),e(Wt,qs),e(qs,nc),e(Wt,sc),e(Wt,Fa),e(Fa,ac),e(Wt,rc),e(Be,ic),w(ko,Be,null),e(Be,dc),w(To,Be,null),_(o,xr,g),_(o,Ut,g),e(Ut,vo),e(vo,xa),w(jn,xa,null),e(Ut,lc),e(Ut,Sa),e(Sa,cc),_(o,Sr,g),_(o,je,g),w(Pn,je,null),e(je,hc),e(je,Nn),e(Nn,pc),e(Nn,$s),e($s,uc),e(Nn,mc),e(je,fc),e(je,An),e(An,gc),e(An,In),e(In,_c),e(An,bc),e(je,kc),e(je,ye),w(Gn,ye,null),e(ye,Tc),e(ye,Rt),e(Rt,vc),e(Rt,Ls),e(Ls,wc),e(Rt,yc),e(Rt,Ma),e(Ma,Ec),e(Rt,qc),e(ye,$c),w(wo,ye,null),e(ye,Lc),w(yo,ye,null),e(ye,Dc),w(Eo,ye,null),_(o,Mr,g),_(o,Vt,g),e(Vt,qo),e(qo,Oa),w(Bn,Oa,null),e(Vt,zc),e(Vt,Ca),e(Ca,Fc),_(o,Or,g),_(o,me,g),w(Hn,me,null),e(me,xc),e(me,ja),e(ja,Sc),e(me,Mc),e(me,Qn),e(Qn,Oc),e(Qn,Ds),e(Ds,Cc),e(Qn,jc),e(me,Pc),e(me,Wn),e(Wn,Nc),e(Wn,Un),e(Un,Ac),e(Wn,Ic),e(me,Gc),e(me,J),w(Rn,J,null),e(J,Bc),e(J,Kt),e(Kt,Hc),e(Kt,zs),e(zs,Qc),e(Kt,Wc),e(Kt,Pa),e(Pa,Uc),e(Kt,Rc),e(J,Vc),w($o,J,null),e(J,Kc),w(Lo,J,null),e(J,Xc),w(Do,J,null),e(J,Jc),w(zo,J,null),e(J,Zc),w(Fo,J,null),_(o,Cr,g),_(o,Xt,g),e(Xt,xo),e(xo,Na),w(Vn,Na,null),e(Xt,Yc),e(Xt,Aa),e(Aa,eh),_(o,jr,g),_(o,fe,g),w(Kn,fe,null),e(fe,th),e(fe,Jt),e(Jt,oh),e(Jt,Ia),e(Ia,nh),e(Jt,sh),e(Jt,Ga),e(Ga,ah),e(Jt,rh),e(fe,ih),e(fe,Xn),e(Xn,dh),e(Xn,Fs),e(Fs,lh),e(Xn,ch),e(fe,hh),e(fe,Jn),e(Jn,ph),e(Jn,Zn),e(Zn,uh),e(Jn,mh),e(fe,fh),e(fe,Ee),w(Yn,Ee,null),e(Ee,gh),e(Ee,Zt),e(Zt,_h),e(Zt,xs),e(xs,bh),e(Zt,kh),e(Zt,Ba),e(Ba,Th),e(Zt,vh),e(Ee,wh),w(So,Ee,null),e(Ee,yh),w(Mo,Ee,null),e(Ee,Eh),w(Oo,Ee,null),_(o,Pr,g),_(o,Yt,g),e(Yt,Co),e(Co,Ha),w(es,Ha,null),e(Yt,qh),e(Yt,Qa),e(Qa,$h),_(o,Nr,g),_(o,ge,g),w(ts,ge,null),e(ge,Lh),e(ge,os),e(os,Dh),e(os,Ss),e(Ss,zh),e(os,Fh),e(ge,xh),e(ge,ns),e(ns,Sh),e(ns,ss),e(ss,Mh),e(ns,Oh),e(ge,Ch),w(jo,ge,null),e(ge,jh),e(ge,He),w(as,He,null),e(He,Ph),e(He,eo),e(eo,Nh),e(eo,Ms),e(Ms,Ah),e(eo,Ih),e(eo,Wa),e(Wa,Gh),e(eo,Bh),e(He,Hh),w(Po,He,null),e(He,Qh),w(No,He,null),_(o,Ar,g),_(o,to,g),e(to,Ao),e(Ao,Ua),w(rs,Ua,null),e(to,Wh),e(to,Ra),e(Ra,Uh),_(o,Ir,g),_(o,_e,g),w(is,_e,null),e(_e,Rh),e(_e,ds),e(ds,Vh),e(ds,Os),e(Os,Kh),e(ds,Xh),e(_e,Jh),e(_e,ls),e(ls,Zh),e(ls,cs),e(cs,Yh),e(ls,ep),e(_e,tp),w(Io,_e,null),e(_e,op),e(_e,Qe),w(hs,Qe,null),e(Qe,np),e(Qe,oo),e(oo,sp),e(oo,Cs),e(Cs,ap),e(oo,rp),e(oo,Va),e(Va,ip),e(oo,dp),e(Qe,lp),w(Go,Qe,null),e(Qe,cp),w(Bo,Qe,null),Gr=!0},p(o,[g]){const ps={};g&2&&(ps.$$scope={dirty:g,ctx:o}),ro.$set(ps);const Ka={};g&2&&(Ka.$$scope={dirty:g,ctx:o}),lo.$set(Ka);const Xa={};g&2&&(Xa.$$scope={dirty:g,ctx:o}),co.$set(Xa);const Ja={};g&2&&(Ja.$$scope={dirty:g,ctx:o}),mo.$set(Ja);const us={};g&2&&(us.$$scope={dirty:g,ctx:o}),fo.$set(us);const Za={};g&2&&(Za.$$scope={dirty:g,ctx:o}),ko.$set(Za);const Ya={};g&2&&(Ya.$$scope={dirty:g,ctx:o}),To.$set(Ya);const er={};g&2&&(er.$$scope={dirty:g,ctx:o}),wo.$set(er);const ms={};g&2&&(ms.$$scope={dirty:g,ctx:o}),yo.$set(ms);const tr={};g&2&&(tr.$$scope={dirty:g,ctx:o}),Eo.$set(tr);const or={};g&2&&(or.$$scope={dirty:g,ctx:o}),$o.$set(or);const nr={};g&2&&(nr.$$scope={dirty:g,ctx:o}),Lo.$set(nr);const sr={};g&2&&(sr.$$scope={dirty:g,ctx:o}),Do.$set(sr);const ar={};g&2&&(ar.$$scope={dirty:g,ctx:o}),zo.$set(ar);const ae={};g&2&&(ae.$$scope={dirty:g,ctx:o}),Fo.$set(ae);const Z={};g&2&&(Z.$$scope={dirty:g,ctx:o}),So.$set(Z);const rr={};g&2&&(rr.$$scope={dirty:g,ctx:o}),Mo.$set(rr);const ir={};g&2&&(ir.$$scope={dirty:g,ctx:o}),Oo.$set(ir);const dr={};g&2&&(dr.$$scope={dirty:g,ctx:o}),jo.$set(dr);const lr={};g&2&&(lr.$$scope={dirty:g,ctx:o}),Po.$set(lr);const cr={};g&2&&(cr.$$scope={dirty:g,ctx:o}),No.$set(cr);const hr={};g&2&&(hr.$$scope={dirty:g,ctx:o}),Io.$set(hr);const pr={};g&2&&(pr.$$scope={dirty:g,ctx:o}),Go.$set(pr);const no={};g&2&&(no.$$scope={dirty:g,ctx:o}),Bo.$set(no)},i(o){Gr||(y(d.$$.fragment,o),y(z.$$.fragment,o),y(tn.$$.fragment,o),y(on.$$.fragment,o),y(ro.$$.fragment,o),y(sn.$$.fragment,o),y(an.$$.fragment,o),y(lo.$$.fragment,o),y(co.$$.fragment,o),y(ln.$$.fragment,o),y(hn.$$.fragment,o),y(un.$$.fragment,o),y(mn.$$.fragment,o),y(fn.$$.fragment,o),y(gn.$$.fragment,o),y(mo.$$.fragment,o),y(fo.$$.fragment,o),y(Tn.$$.fragment,o),y(vn.$$.fragment,o),y(wn.$$.fragment,o),y(yn.$$.fragment,o),y(En.$$.fragment,o),y(qn.$$.fragment,o),y($n.$$.fragment,o),y(Ln.$$.fragment,o),y(Dn.$$.fragment,o),y(zn.$$.fragment,o),y(Fn.$$.fragment,o),y(xn.$$.fragment,o),y(Cn.$$.fragment,o),y(ko.$$.fragment,o),y(To.$$.fragment,o),y(jn.$$.fragment,o),y(Pn.$$.fragment,o),y(Gn.$$.fragment,o),y(wo.$$.fragment,o),y(yo.$$.fragment,o),y(Eo.$$.fragment,o),y(Bn.$$.fragment,o),y(Hn.$$.fragment,o),y(Rn.$$.fragment,o),y($o.$$.fragment,o),y(Lo.$$.fragment,o),y(Do.$$.fragment,o),y(zo.$$.fragment,o),y(Fo.$$.fragment,o),y(Vn.$$.fragment,o),y(Kn.$$.fragment,o),y(Yn.$$.fragment,o),y(So.$$.fragment,o),y(Mo.$$.fragment,o),y(Oo.$$.fragment,o),y(es.$$.fragment,o),y(ts.$$.fragment,o),y(jo.$$.fragment,o),y(as.$$.fragment,o),y(Po.$$.fragment,o),y(No.$$.fragment,o),y(rs.$$.fragment,o),y(is.$$.fragment,o),y(Io.$$.fragment,o),y(hs.$$.fragment,o),y(Go.$$.fragment,o),y(Bo.$$.fragment,o),Gr=!0)},o(o){E(d.$$.fragment,o),E(z.$$.fragment,o),E(tn.$$.fragment,o),E(on.$$.fragment,o),E(ro.$$.fragment,o),E(sn.$$.fragment,o),E(an.$$.fragment,o),E(lo.$$.fragment,o),E(co.$$.fragment,o),E(ln.$$.fragment,o),E(hn.$$.fragment,o),E(un.$$.fragment,o),E(mn.$$.fragment,o),E(fn.$$.fragment,o),E(gn.$$.fragment,o),E(mo.$$.fragment,o),E(fo.$$.fragment,o),E(Tn.$$.fragment,o),E(vn.$$.fragment,o),E(wn.$$.fragment,o),E(yn.$$.fragment,o),E(En.$$.fragment,o),E(qn.$$.fragment,o),E($n.$$.fragment,o),E(Ln.$$.fragment,o),E(Dn.$$.fragment,o),E(zn.$$.fragment,o),E(Fn.$$.fragment,o),E(xn.$$.fragment,o),E(Cn.$$.fragment,o),E(ko.$$.fragment,o),E(To.$$.fragment,o),E(jn.$$.fragment,o),E(Pn.$$.fragment,o),E(Gn.$$.fragment,o),E(wo.$$.fragment,o),E(yo.$$.fragment,o),E(Eo.$$.fragment,o),E(Bn.$$.fragment,o),E(Hn.$$.fragment,o),E(Rn.$$.fragment,o),E($o.$$.fragment,o),E(Lo.$$.fragment,o),E(Do.$$.fragment,o),E(zo.$$.fragment,o),E(Fo.$$.fragment,o),E(Vn.$$.fragment,o),E(Kn.$$.fragment,o),E(Yn.$$.fragment,o),E(So.$$.fragment,o),E(Mo.$$.fragment,o),E(Oo.$$.fragment,o),E(es.$$.fragment,o),E(ts.$$.fragment,o),E(jo.$$.fragment,o),E(as.$$.fragment,o),E(Po.$$.fragment,o),E(No.$$.fragment,o),E(rs.$$.fragment,o),E(is.$$.fragment,o),E(Io.$$.fragment,o),E(hs.$$.fragment,o),E(Go.$$.fragment,o),E(Bo.$$.fragment,o),Gr=!1},d(o){t(l),o&&t(b),o&&t(p),q(d),o&&t(A),o&&t(P),q(z),o&&t(Pe),o&&t(Q),o&&t(Ne),o&&t(K),o&&t(Ae),o&&t(X),o&&t(be),o&&t(M),o&&t(Ie),o&&t(x),o&&t(ur),o&&t(so),o&&t(mr),o&&t(Ft),q(tn),o&&t(fr),o&&t(Oe),q(on),q(ro),o&&t(gr),o&&t(Mt),q(sn),o&&t(_r),o&&t(C),q(an),q(lo),q(co),q(ln),q(hn),q(un),q(mn),o&&t(br),o&&t(Ot),q(fn),o&&t(kr),o&&t(H),q(gn),q(mo),q(fo),q(Tn),o&&t(Tr),o&&t(Ct),q(vn),o&&t(vr),o&&t(jt),q(wn),o&&t(wr),o&&t(Pt),q(yn),o&&t(yr),o&&t(Nt),q(En),o&&t(Er),o&&t(At),q(qn),o&&t(qr),o&&t(It),q($n),o&&t($r),o&&t(Gt),q(Ln),o&&t(Lr),o&&t(Bt),q(Dn),o&&t(Dr),o&&t(Ht),q(zn),o&&t(zr),o&&t(Qt),q(Fn),o&&t(Fr),o&&t(Ce),q(xn),q(Cn),q(ko),q(To),o&&t(xr),o&&t(Ut),q(jn),o&&t(Sr),o&&t(je),q(Pn),q(Gn),q(wo),q(yo),q(Eo),o&&t(Mr),o&&t(Vt),q(Bn),o&&t(Or),o&&t(me),q(Hn),q(Rn),q($o),q(Lo),q(Do),q(zo),q(Fo),o&&t(Cr),o&&t(Xt),q(Vn),o&&t(jr),o&&t(fe),q(Kn),q(Yn),q(So),q(Mo),q(Oo),o&&t(Pr),o&&t(Yt),q(es),o&&t(Nr),o&&t(ge),q(ts),q(jo),q(as),q(Po),q(No),o&&t(Ar),o&&t(to),q(rs),o&&t(Ir),o&&t(_e),q(is),q(Io),q(hs),q(Go),q(Bo)}}}const Pm={local:"led",sections:[{local:"overview",title:"Overview"},{local:"transformers.LEDConfig",title:"LEDConfig"},{local:"transformers.LEDTokenizer",title:"LEDTokenizer"},{local:"transformers.LEDTokenizerFast",title:"LEDTokenizerFast"},{local:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",title:"LED specific outputs"},{local:"transformers.LEDModel",title:"LEDModel"},{local:"transformers.LEDForConditionalGeneration",title:"LEDForConditionalGeneration"},{local:"transformers.LEDForSequenceClassification",title:"LEDForSequenceClassification"},{local:"transformers.LEDForQuestionAnswering",title:"LEDForQuestionAnswering"},{local:"transformers.TFLEDModel",title:"TFLEDModel"},{local:"transformers.TFLEDForConditionalGeneration",title:"TFLEDForConditionalGeneration"}],title:"LED"};function Nm(L){return hm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Wm extends im{constructor(l){super();dm(this,l,Nm,jm,lm,{})}}export{Wm as default,Pm as metadata};
