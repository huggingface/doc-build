...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a> or <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.TFWav2Vec2Model">TFWav2Vec2Model</a>. Vocabulary size of the
model. Defines the different tokens that can be represented by the <em>inputs_ids</em> passed to the forward
method of <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a>.`,name:"vocab_size"},{anchor:"transformers.Wav2Vec2Config.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
instance of <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.Wav2Vec2CTCTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/v4.23.0/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/tokenization_utils_base.py#L2410",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L490",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L420",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/v4.23.0/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),ys=new oe({}),ks=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),$s=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/processing_wav2vec2.py#L67"}}),js=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/processing_wav2vec2.py#L104"}}),Vs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/processing_wav2vec2.py#L48"}}),Fs=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/v4.23.0/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/v4.23.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L280",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L397",returnDescription:`
<p><code>~models.wav2vec2.Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1649",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1783",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1905",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2023"}}),Bn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2085",returnDescription:`
<p>A <a
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1397",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1467",returnDescription:`
<p>A <a
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1591",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
<a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1058"}}),yr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.23.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322"}}),Br=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/v4.23.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.0/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1325",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.23.0/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jp.forEach(t),kv=p(_t),y(qa.$$.fragment,_t),Tv=p(_t),ct=s(_t,"DIV",{class:!0});var os=n(ct);y(cr.$$.fragment,os),$v=p(os),Co=s(os,"P",{});var Zi=n(Co);xv=i(Zi,"The "),Ei=s(Zi,"A",{href:!0});var Jy=n(Ei);Wv=i(Jy,"TFWav2Vec2ForCTC"),Jy.forEach(t),jv=i(Zi," forward method, overrides the "),uc=s(Zi,"CODE",{});var Zy=n(uc);Vv=i(Zy,"__call__"),Zy.forEach(t),Fv=i(Zi," special method."),Zi.forEach(t),Cv=p(os),y(za.$$.fragment,os),Ev=p(os),y(Ma.$$.fragment,os),os.forEach(t),_t.forEach(t),Sd=p(o),Eo=s(o,"H2",{class:!0});var Zp=n(Eo);Aa=s(Zp,"A",{id:!0,class:!0,href:!0});var Qy=n(Aa);gc=s(Qy,"SPAN",{});var Yy=n(gc);y(dr.$$.fragment,Yy),Yy.forEach(t),Qy.forEach(t),Pv=p(Zp),_c=s(Zp,"SPAN",{});var e0=n(_c);qv=i(e0,"FlaxWav2Vec2Model"),e0.forEach(t),Zp.forEach(t),Nd=p(o),Y=s(o,"DIV",{class:!0});var Ne=n(Y);y(pr.$$.fragment,Ne),zv=p(Ne),mr=s(Ne,"P",{});var Qp=n(mr);Mv=i(Qp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),hr=s(Qp,"A",{href:!0,rel:!0});var t0=n(hr);Av=i(t0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),t0.forEach(t),Ov=i(Qp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Qp.forEach(t),Lv=p(Ne),fr=s(Ne,"P",{});var Yp=n(fr);Dv=i(Yp,"This model inherits from "),Pi=s(Yp,"A",{href:!0});var o0=n(Pi);Sv=i(o0,"FlaxPreTrainedModel"),o0.forEach(t),Nv=i(Yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yp.forEach(t),Iv=p(Ne),ur=s(Ne,"P",{});var em=n(ur);Bv=i(em,`This model is also a Flax Linen
`),gr=s(em,"A",{href:!0,rel:!0});var a0=n(gr);Uv=i(a0,"flax.nn.Module"),a0.forEach(t),Rv=i(em,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),em.forEach(t),Hv=p(Ne),vc=s(Ne,"P",{});var s0=n(vc);Xv=i(s0,"Finally, this model supports inherent JAX features such as:"),s0.forEach(t),Kv=p(Ne),zt=s(Ne,"UL",{});var as=n(zt);bc=s(as,"LI",{});var n0=n(bc);_r=s(n0,"A",{href:!0,rel:!0});var r0=n(_r);Gv=i(r0,"Just-In-Time (JIT) compilation"),r0.forEach(t),n0.forEach(t),Jv=p(as),wc=s(as,"LI",{});var i0=n(wc);vr=s(i0,"A",{href:!0,rel:!0});var l0=n(vr);Zv=i(l0,"Automatic Differentiation"),l0.forEach(t),i0.forEach(t),Qv=p(as),yc=s(as,"LI",{});var c0=n(yc);br=s(c0,"A",{href:!0,rel:!0});var d0=n(br);Yv=i(d0,"Vectorization"),d0.forEach(t),c0.forEach(t),e2=p(as),kc=s(as,"LI",{});var p0=n(kc);wr=s(p0,"A",{href:!0,rel:!0});var m0=n(wr);t2=i(m0,"Parallelization"),m0.forEach(t),p0.forEach(t),as.forEach(t),o2=p(Ne),dt=s(Ne,"DIV",{class:!0});var ss=n(dt);y(yr.$$.fragment,ss),a2=p(ss),Po=s(ss,"P",{});var Qi=n(Po);s2=i(Qi,"The "),Tc=s(Qi,"CODE",{});var h0=n(Tc);n2=i(h0,"FlaxWav2Vec2PreTrainedModel"),h0.forEach(t),r2=i(Qi," forward method, overrides the "),$c=s(Qi,"CODE",{});var f0=n($c);i2=i(f0,"__call__"),f0.forEach(t),l2=i(Qi," special method."),Qi.forEach(t),c2=p(ss),y(Oa.$$.fragment,ss),d2=p(ss),y(La.$$.fragment,ss),ss.forEach(t),Ne.forEach(t),Id=p(o),qo=s(o,"H2",{class:!0});var tm=n(qo);Da=s(tm,"A",{id:!0,class:!0,href:!0});var u0=n(Da);xc=s(u0,"SPAN",{});var g0=n(xc);y(kr.$$.fragment,g0),g0.forEach(t),u0.forEach(t),p2=p(tm),Wc=s(tm,"SPAN",{});var _0=n(Wc);m2=i(_0,"FlaxWav2Vec2ForCTC"),_0.forEach(t),tm.forEach(t),Bd=p(o),ee=s(o,"DIV",{class:!0});var Ie=n(ee);y(Tr.$$.fragment,Ie),h2=p(Ie),zo=s(Ie,"P",{});var Yi=n(zo);f2=i(Yi,"Wav2Vec2 Model with a "),jc=s(Yi,"CODE",{});var v0=n(jc);u2=i(v0,"language modeling"),v0.forEach(t),g2=i(Yi,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),$r=s(Yi,"A",{href:!0,rel:!0});var b0=n($r);_2=i(b0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),b0.forEach(t),v2=i(Yi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Yi.forEach(t),b2=p(Ie),xr=s(Ie,"P",{});var om=n(xr);w2=i(om,"This model inherits from "),qi=s(om,"A",{href:!0});var w0=n(qi);y2=i(w0,"FlaxPreTrainedModel"),w0.forEach(t),k2=i(om,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),om.forEach(t),T2=p(Ie),Wr=s(Ie,"P",{});var am=n(Wr);$2=i(am,`This model is also a Flax Linen
`),jr=s(am,"A",{href:!0,rel:!0});var y0=n(jr);x2=i(y0,"flax.nn.Module"),y0.forEach(t),W2=i(am,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),am.forEach(t),j2=p(Ie),Vc=s(Ie,"P",{});var k0=n(Vc);V2=i(k0,"Finally, this model supports inherent JAX features such as:"),k0.forEach(t),F2=p(Ie),Mt=s(Ie,"UL",{});var ns=n(Mt);Fc=s(ns,"LI",{});var T0=n(Fc);Vr=s(T0,"A",{href:!0,rel:!0});var $0=n(Vr);C2=i($0,"Just-In-Time (JIT) compilation"),$0.forEach(t),T0.forEach(t),E2=p(ns),Cc=s(ns,"LI",{});var x0=n(Cc);Fr=s(x0,"A",{href:!0,rel:!0});var W0=n(Fr);P2=i(W0,"Automatic Differentiation"),W0.forEach(t),x0.forEach(t),q2=p(ns),Ec=s(ns,"LI",{});var j0=n(Ec);Cr=s(j0,"A",{href:!0,rel:!0});var V0=n(Cr);z2=i(V0,"Vectorization"),V0.forEach(t),j0.forEach(t),M2=p(ns),Pc=s(ns,"LI",{});var F0=n(Pc);Er=s(F0,"A",{href:!0,rel:!0});var C0=n(Er);A2=i(C0,"Parallelization"),C0.forEach(t),F0.forEach(t),ns.forEach(t),O2=p(Ie),pt=s(Ie,"DIV",{class:!0});var rs=n(pt);y(Pr.$$.fragment,rs),L2=p(rs),Mo=s(rs,"P",{});var el=n(Mo);D2=i(el,"The "),qc=s(el,"CODE",{});var E0=n(qc);S2=i(E0,"FlaxWav2Vec2PreTrainedModel"),E0.forEach(t),N2=i(el," forward method, overrides the "),zc=s(el,"CODE",{});var P0=n(zc);I2=i(P0,"__call__"),P0.forEach(t),B2=i(el," special method."),el.forEach(t),U2=p(rs),y(Sa.$$.fragment,rs),R2=p(rs),y(Na.$$.fragment,rs),rs.forEach(t),Ie.forEach(t),Ud=p(o),Ao=s(o,"H2",{class:!0});var sm=n(Ao);Ia=s(sm,"A",{id:!0,class:!0,href:!0});var q0=n(Ia);Mc=s(q0,"SPAN",{});var z0=n(Mc);y(qr.$$.fragment,z0),z0.forEach(t),q0.forEach(t),H2=p(sm),Ac=s(sm,"SPAN",{});var M0=n(Ac);X2=i(M0,"FlaxWav2Vec2ForPreTraining"),M0.forEach(t),sm.forEach(t),Rd=p(o),te=s(o,"DIV",{class:!0});var Be=n(te);y(zr.$$.fragment,Be),K2=p(Be),Oo=s(Be,"P",{});var tl=n(Oo);G2=i(tl,"Wav2Vec2 Model with a quantizer and "),Oc=s(tl,"CODE",{});var A0=n(Oc);J2=i(A0,"VQ"),A0.forEach(t),Z2=i(tl,` head on top.
Wav2Vec2 was proposed in `),Mr=s(tl,"A",{href:!0,rel:!0});var O0=n(Mr);Q2=i(O0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),O0.forEach(t),Y2=i(tl,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
