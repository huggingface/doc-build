...
pricing`),Ue=$(" for details."),de=m(),D=i("p"),Ce=$("You can set pinned models to your API Token in the API Usage dashboard."),he=m(),Y=i("p"),C=i("a"),Me=$("Pinned models"),fe=m(),F=i("p"),Xe=$(`Model pinning is also accessible directly from the API. Here is how you
see what your current pinned models are :`),me=m(),w(O.$$.fragment),ge=m(),G=i("p"),Je=$("Pinning models is done that way."),$e=m(),w(N.$$.fragment),_e=m(),w(z.$$.fragment),this.h()},l(n){const l=hs('[data-svelte="svelte-1phssyn"]',document.head);s=c(l,"META",{name:!0,content:!0}),l.forEach(o),t=g(n),e=c(n,"H1",{class:!0});var M=u(e);a=c(M,"A",{id:!0,class:!0,href:!0});var te=u(a);h=c(te,"SPAN",{});var ae=u(h);j(S.$$.fragment,ae),ae.forEach(o),te.forEach(o),ke=g(M),W=c(M,"SPAN",{});var Fe=u(W);Ae=_(Fe,"Detailed usage and pinned models"),Fe.forEach(o),M.forEach(o),oe=g(n),k=c(n,"H2",{class:!0});var je=u(k);b=c(je,"A",{id:!0,class:!0,href:!0});var Ge=u(b);Z=c(Ge,"SPAN",{});var Re=u(Z);j(B.$$.fragment,Re),Re.forEach(o),Ge.forEach(o),be=g(je),ee=c(je,"SPAN",{});var Qe=u(ee);Ee=_(Qe,"API Usage dashboard"),Qe.forEach(o),je.forEach(o),le=g(n),E=c(n,"P",{});var qe=u(E);Ie=_(qe,"The "),L=c(qe,"A",{href:!0,rel:!0});var Ve=u(L);Te=_(Ve,"API Usage Dashboard"),Ve.forEach(o),xe=_(qe,` (beta) shows
