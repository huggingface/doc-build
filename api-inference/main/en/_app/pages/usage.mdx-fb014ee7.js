...
# {"ok":"Pinned 1 models, please wait while we load them."}'`,highlighted:`curl https://api-inference.huggingface.co/usage/pinned_models \\
        ...
        -H <span class="hljs-string">&quot;Authorization: Bearer <span class="hljs-variable">\${API_TOKEN}</span>&quot;</span>
<span class="hljs-comment"># {&quot;ok&quot;:&quot;Pinned 1 models, please wait while we load them.&quot;}&#x27;</span>`}}),{c(){w(s.$$.fragment)},l(e){j(s.$$.fragment,e)},m(e,a){q(s,e,a),t=!0},p:R,i(e){t||(y(s.$$.fragment,e),t=!0)},o(e){v(s.$$.fragment,e),t=!1},d(e){P(s,e)}}}function Is(d){let s,t;return s=new Q({props:{$$slots:{default:[Es]},$$scope:{ctx:d}}}),{c(){w(s.$$.fragment)},l(e){j(s.$$.fragment,e)},m(e,a){q(s,e,a),t=!0},p(e,a){const h={};a&2&&(h.$$scope={dirty:a,ctx:e}),s.$set(h)},i(e){t||(y(s.$$.fragment,e),t=!0)},o(e){v(s.$$.fragment,e),t=!1},d(e){P(s,e)}}}function Ts(d){let s,t,e,a,h,z,ke,W,Ae,oe,k,b,Z,B,be,ee,Ee,le,E,Ie,L,Te,xe,re,I,Ne,J,Se,Oe,pe,K,Ye,ie,A,T,se,H,ze,ne,Be,ce,D,Le,ue,x,Ke,U,He,Ue,de,C,Me,he,Y,M,Xe,fe,F,Je,me,N,ge,G,De,$e,S,_e,O,we;return z=new Ce({}),B=new Ce({}),H=new Ce({}),N=new is({props:{python:!0,js:!0,curl:!0,$$slots:{curl:[ys],js:[js],python:[_s]},$$scope:{ctx:d}}}),S=new gs({props:{warning:!0,$$slots:{default:[vs]},$$scope:{ctx:d}}}),O=new is({props:{python:!0,js:!0,curl:!0,$$slots:{curl:[Is],js:[bs],python:[ks]},$$scope:{ctx:d}}}),{c(){s=i("meta"),t=m(),e=i("h1"),a=i("a"),h=i("span"),w(z.$$.fragment),ke=m(),W=i("span"),Ae=$("Detailed usage and pinned models"),oe=m(),k=i("h2"),b=i("a"),Z=i("span"),w(B.$$.fragment),be=m(),ee=i("span"),Ee=$("API Usage dashboard"),le=m(),E=i("p"),Ie=$("The "),L=i("a"),Te=$("API Usage Dashboard"),xe=$(` (beta) shows
...
see what your current pinned models are :`),me=m(),w(N.$$.fragment),ge=m(),G=i("p"),De=$("Pinning models is done that way."),$e=m(),w(S.$$.fragment),_e=m(),w(O.$$.fragment),this.h()},l(n){const l=hs('[data-svelte="svelte-1phssyn"]',document.head);s=c(l,"META",{name:!0,content:!0}),l.forEach(o),t=g(n),e=c(n,"H1",{class:!0});var X=u(e);a=c(X,"A",{id:!0,class:!0,href:!0});var te=u(a);h=c(te,"SPAN",{});var ae=u(h);j(z.$$.fragment,ae),ae.forEach(o),te.forEach(o),ke=g(X),W=c(X,"SPAN",{});var Fe=u(W);Ae=_(Fe,"Detailed usage and pinned models"),Fe.forEach(o),X.forEach(o),oe=g(n),k=c(n,"H2",{class:!0});var je=u(k);b=c(je,"A",{id:!0,class:!0,href:!0});var Ge=u(b);Z=c(Ge,"SPAN",{});var Re=u(Z);j(B.$$.fragment,Re),Re.forEach(o),Ge.forEach(o),be=g(je),ee=c(je,"SPAN",{});var Qe=u(ee);Ee=_(Qe,"API Usage dashboard"),Qe.forEach(o),je.forEach(o),le=g(n),E=c(n,"P",{});var qe=u(E);Ie=_(qe,"The "),L=c(qe,"A",{href:!0,rel:!0});var Ve=u(L);Te=_(Ve,"API Usage Dashboard"),Ve.forEach(o),xe=_(qe,` (beta) shows
...
available for requests authenticated with an API Token.`),ns.forEach(o),ue=g(n),x=c(n,"P",{});var Pe=u(x);Ke=_(Pe,`Lab, Startup and Enterprise organization subscriptions can have a number
of models pinned to their organization API Token - `),U=c(Pe,"A",{href:!0,rel:!0});var ts=u(U);He=_(ts,`see
pricing`),ts.forEach(o),Ue=_(Pe," for details."),Pe.forEach(o),de=g(n),C=c(n,"P",{});var as=u(C);Me=_(as,"You can set pinned models to your API Token in the API Usage dashboard."),as.forEach(o),he=g(n),Y=c(n,"P",{});var os=u(Y);M=c(os,"A",{href:!0,rel:!0});var ls=u(M);Xe=_(ls,"Pinned models"),ls.forEach(o),os.forEach(o),fe=g(n),F=c(n,"P",{});var rs=u(F);Je=_(rs,`Model pinning is also accessible directly from the API. Here is how you
see what your current pinned models are :`),rs.forEach(o),me=g(n),j(N.$$.fragment,n),ge=g(n),G=c(n,"P",{});var ps=u(G);De=_(ps,"Pinning models is done that way."),ps.forEach(o),$e=g(n),j(S.$$.fragment,n),_e=g(n),j(O.$$.fragment,n),this.h()},h(){f(s,"name","hf:doc:metadata"),f(s,"content",JSON.stringify(xs)),f(a,"id","detailed-usage-and-pinned-models"),f(a,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(a,"href","#detailed-usage-and-pinned-models"),f(e,"class","relative group"),f(b,"id","api-usage-dashboard"),f(b,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(b,"href","#api-usage-dashboard"),f(k,"class","relative group"),f(L,"href","https://api-inference.huggingface.co/dashboard/"),f(L,"rel","nofollow"),f(J,"href","mailto:api-entreprise@hugginface.co"),fs(K.src,Ye="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/inference-api/dashboard_example.png")||f(K,"src",Ye),f(K,"width","600"),f(T,"id","pinned-models"),f(T,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(T,"href","#pinned-models"),f(A,"class","relative group"),f(U,"href","https://huggingface.co/pricing"),f(U,"rel","nofollow"),f(M,"href","https://api-inference.huggingface.co/dashboard/pinned_models"),f(M,"rel","nofollow")},m(n,l){r(document.head,s),p(n,t,l),p(n,e,l),r(e,a),r(a,h),q(z,h,null),r(e,ke),r(e,W),r(W,Ae),p(n,oe,l),p(n,k,l),r(k,b),r(b,Z),q(B,Z,null),r(k,be),r(k,ee),r(ee,Ee),p(n,le,l),p(n,E,l),r(E,Ie),r(E,L),r(L,Te),r(E,xe),p(n,re,l),p(n,I,l),r(I,Ne),r(I,J),r(J,Se),r(I,Oe),p(n,pe,l),p(n,K,l),p(n,ie,l),p(n,A,l),r(A,T),r(T,se),q(H,se,null),r(A,ze),r(A,ne),r(ne,Be),p(n,ce,l),p(n,D,l),r(D,Le),p(n,ue,l),p(n,x,l),r(x,Ke),r(x,U),r(U,He),r(x,Ue),p(n,de,l),p(n,C,l),r(C,Me),p(n,he,l),p(n,Y,l),r(Y,M),r(M,Xe),p(n,fe,l),p(n,F,l),r(F,Je),p(n,me,l),q(N,n,l),p(n,ge,l),p(n,G,l),r(G,De),p(n,$e,l),q(S,n,l),p(n,_e,l),q(O,n,l),we=!0},p(n,[l]){const X={};l&2&&(X.$$scope={dirty:l,ctx:n}),N.$set(X);const te={};l&2&&(te.$$scope={dirty:l,ctx:n}),S.$set(te);const ae={};l&2&&(ae.$$scope={dirty:l,ctx:n}),O.$set(ae)},i(n){we||(y(z.$$.fragment,n),y(B.$$.fragment,n),y(H.$$.fragment,n),y(N.$$.fragment,n),y(S.$$.fragment,n),y(O.$$.fragment,n),we=!0)},o(n){v(z.$$.fragment,n),v(B.$$.fragment,n),v(H.$$.fragment,n),v(N.$$.fragment,n),v(S.$$.fragment,n),v(O.$$.fragment,n),we=!1},d(n){o(s),n&&o(t),n&&o(e),P(z),n&&o(oe),n&&o(k),P(B),n&&o(le),n&&o(E),n&&o(re),n&&o(I),n&&o(pe),n&&o(K),n&&o(ie),n&&o(A),P(H),n&&o(ce),n&&o(D),n&&o(ue),n&&o(x),n&&o(de),n&&o(C),n&&o(he),n&&o(Y),n&&o(fe),n&&o(F),n&&o(me),P(N,n),n&&o(ge),n&&o(G),n&&o($e),P(S,n),n&&o(_e),P(O,n)}}}const xs={local:"detailed-usage-and-pinned-models",sections:[{local:"api-usage-dashboard",title:"API Usage dashboard"},{local:"pinned-models",title:"Pinned models"}],title:"Detailed usage and pinned models"};function Ns(d){return ms(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ls extends cs{constructor(s){super();us(this,s,Ns,Ts,ds,{})}}export{Ls as default,xs as metadata};
