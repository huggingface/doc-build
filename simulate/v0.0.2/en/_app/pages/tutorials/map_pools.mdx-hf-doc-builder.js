...
initial communication port for spawned executables.`,name:"starting_port"}],source:"https://github.com/huggingface/simulate/blob/v0.0.2/src/simulate/rl/parallel_rl_env.py#L52"}}),q=new O({props:{name:"close",anchor:"simulate.ParallelRLEnv.close",parameters:[],source:"https://github.com/huggingface/simulate/blob/v0.0.2/src/simulate/rl/parallel_rl_env.py#L300"}}),B=new O({props:{name:"env_is_wrapped",anchor:"simulate.ParallelRLEnv.env_is_wrapped",parameters:[{name:"wrapper_class",val:": typing.Type[gym.core.Wrapper]"},{name:"indices",val:": typing.Union[NoneType, int, typing.Iterable[int]] = None"}],source:"https://github.com/huggingface/simulate/blob/v0.0.2/src/simulate/rl/parallel_rl_env.py#L317"}}),V=new O({props:{name:"reset",anchor:"simulate.ParallelRLEnv.reset",parameters:[],source:"https://github.com/huggingface/simulate/blob/v0.0.2/src/simulate/rl/parallel_rl_env.py#L227",returnDescription:`
<p>the observation of the environment after reset.</p>
`,returnType:`
<p>obs (<code>Dict</code>)</p>
`}}),U=new O({props:{name:"sample_action",anchor:"simulate.ParallelRLEnv.sample_action",parameters:[],source:"https://github.com/huggingface/simulate/blob/v0.0.2/src/simulate/rl/parallel_rl_env.py#L304",returnDescription:`
<p>TODO</p>
`,returnType:`
<p>action</p>
...
a dict or list of actions for each actuator.`,name:"action"}],source:"https://github.com/huggingface/simulate/blob/v0.0.2/src/simulate/rl/parallel_rl_env.py#L126",returnDescription:`
...
`}}),Y=new O({props:{name:"step_recv_async",anchor:"simulate.ParallelRLEnv.step_recv_async",parameters:[],source:"https://github.com/huggingface/simulate/blob/v0.0.2/src/simulate/rl/parallel_rl_env.py#L196",returnDescription:`
