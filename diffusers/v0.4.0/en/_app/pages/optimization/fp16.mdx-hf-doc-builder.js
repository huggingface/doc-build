import{S as Ao,i as Po,s as qo,e as a,k as p,w as f,t as i,M as No,c as n,d as s,m as c,a as o,x as d,h as l,b as h,G as t,g as u,y as m,q as _,o as v,B as y,v as So}from"../../chunks/vendor-hf-doc-builder.js";import{T as Co}from"../../chunks/Tip-hf-doc-builder.js";import{I as ae}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{C as ne}from"../../chunks/CodeBlock-hf-doc-builder.js";function Uo(St){let w;return{c(){w=i("Attention slicing is useful even if a batch size of just 1 is used - as long as the model uses more than one attention head. If there is more than one attention head the *QK^T* attention matrix can be computed sequentially for each head which can save a significant amount of memory.")},l($){w=l($,"Attention slicing is useful even if a batch size of just 1 is used - as long as the model uses more than one attention head. If there is more than one attention head the *QK^T* attention matrix can be computed sequentially for each head which can save a significant amount of memory.")},m($,j){u($,w,j)},d($){$&&s(w)}}}function Fo(St){let w,$,j,M,Oe,oe,Ps,Ve,qs,Ct,O,Ns,Re,Ss,Cs,Ut,V,Be,D,Ft,Us,Ge,Fs,zs,Le,Is,Hs,g,T,We,Ms,Os,Ye,Vs,Rs,Ke,Bs,Gs,x,Qe,Ls,Ws,Xe,Ys,Ks,Je,Qs,Xs,A,Ze,Js,Zs,et,ea,ta,tt,sa,aa,P,st,na,oa,at,ra,ia,nt,la,pa,q,ot,ca,ua,rt,ha,fa,it,da,ma,N,lt,_a,va,pt,ya,ga,ct,wa,zt,Ee,ba,It,S,R,ut,re,ja,ht,$a,Ht,ie,le,ka,Ea,Mt,B,Da,ft,Ta,xa,Ot,pe,Vt,C,G,dt,ce,Aa,mt,Pa,Rt,L,qa,ue,Na,Sa,Bt,he,Gt,U,W,_t,fe,Ca,vt,Ua,Lt,k,Fa,yt,za,Ia,gt,Ha,Ma,Wt,de,Yt,Y,Oa,wt,Va,Ra,Kt,F,K,bt,me,Ba,jt,Ga,Qt,E,La,$t,Wa,Ya,kt,Ka,Qa,Xt,_e,Jt,z,Q,Et,ve,Xa,Dt,Ja,Zt,De,Za,es,X,ts,J,en,Te,tn,sn,ss,ye,as,xe,an,ns,I,Z,Tt,ge,nn,xt,on,os,Ae,rn,rs,Pe,ln,is,we,ls,H,ee,At,be,pn,Pt,cn,ps,te,un,qt,hn,fn,cs,qe,dn,us,je,hs,se,mn,Nt,_n,vn,fs,$e,ds;return oe=new ae({}),re=new ae({}),pe=new ne({props:{code:`import torch
...
prompt = <span class="hljs-string">&quot;a photo of an astronaut riding a horse on mars&quot;</span>
image = pipe(prompt).images[<span class="hljs-number">0</span>]  `}}),ve=new ae({}),X=new Co({props:{$$slots:{default:[Uo]},$$scope:{ctx:St}}}),ye=new ne({props:{code:`import torch
from diffusers import StableDiffusionPipeline
...
prompt = <span class="hljs-string">&quot;a photo of an astronaut riding a horse on mars&quot;</span>
pipe.enable_attention_slicing()
image = pipe(prompt).images[<span class="hljs-number">0</span>]  `}}),ge=new ae({}),we=new ne({props:{code:`print(pipe.unet.conv_out.state_dict()["weight"].stride())  # (2880, 9, 3, 1)
