...
is safe \u{1F512}. Make sure to check out the code online before loading & running it automatically.`),v.forEach(s)},m(g,v){r(g,h,v),i(h,L)},d(g){g&&s(h)}}}function pt(Le){let h,L,g,v,pe,N,oi,re,ai,qe,b,pi,T,ri,fi,te,ui,mi,Se,E,q,fe,K,di,ue,ci,Me,$,hi,me,_i,gi,U,yi,vi,Fe,S,wi,de,bi,$i,Oe,V,Ie,M,Ei,G,Pi,ji,ze,F,Be,P,O,ce,J,ki,he,xi,Ne,R,Di,Z,Ci,Te,c,Ai,_e,Hi,Li,ge,qi,Si,ye,Mi,Fi,ve,Oi,Ii,we,zi,Bi,be,Ni,Ti,Ke,I,Ki,$e,Ui,Vi,Ue,Q,Ve,j,z,Ee,W,Gi,Pe,Ji,Ge,w,Ri,le,Zi,Qi,je,Wi,Xi,ke,Yi,es,Je,ne,is,Re,X,Ze,d,ss,xe,ts,ls,Y,ns,os,ee,as,ps,De,rs,fs,Ce,us,ms,Ae,ds,cs,He,hs,_s,Qe,ie,We;return N=new li({}),K=new li({}),V=new ni({props:{code:`from diffusers import DiffusionPipeline
...
)`}}),{c(){h=n("meta"),L=u(),g=n("h1"),v=n("a"),pe=n("span"),k(N.$$.fragment),oi=u(),re=n("span"),ai=t("Loading and Adding Custom Pipelines"),qe=u(),b=n("p"),pi=t("Diffusers allows you to conveniently load any custom pipeline from the Hugging Face Hub as well as any "),T=n("a"),ri=t("official community pipeline"),fi=t(`
via the `),te=n("a"),ui=t("DiffusionPipeline"),mi=t(" class."),Se=u(),E=n("h2"),q=n("a"),fe=n("span"),k(K.$$.fragment),di=u(),ue=n("span"),ci=t("Loading custom pipelines from the Hub"),Me=u(),$=n("p"),hi=t("Custom pipelines can be easily loaded from any model repository on the Hub that defines a diffusion pipeline in a "),me=n("code"),_i=t("pipeline.py"),gi=t(` file.
Let\u2019s load a dummy pipeline from `),U=n("a"),yi=t("hf-internal-testing/diffusers-dummy-pipeline"),vi=t("."),Fe=u(),S=n("p"),wi=t("All you need to do is pass the custom pipeline repo id with the "),de=n("code"),bi=t("custom_pipeline"),$i=t(" argument alongside the repo from where you wish to load the pipeline modules."),Oe=u(),k(V.$$.fragment),Ie=u(),M=n("p"),Ei=t("This will load the custom pipeline as defined in the "),G=n("a"),Pi=t("model repository"),ji=t("."),ze=u(),k(F.$$.fragment),Be=u(),P=n("h2"),O=n("a"),ce=n("span"),k(J.$$.fragment),ki=u(),he=n("span"),xi=t("Loading official community pipelines"),Ne=u(),R=n("p"),Di=t("Community pipelines are summarized in the "),Z=n("a"),Ci=t("community examples folder"),Te=u(),c=n("p"),Ai=t("Similarly, you need to pass both the "),_e=n("em"),Hi=t("repo id"),Li=t(" from where you wish to load the weights as well as the "),ge=n("code"),qi=t("custom_pipeline"),Si=t(" argument. Here the "),ye=n("code"),Mi=t("custom_pipeline"),Fi=t(" argument should consist simply of the filename of the community pipeline excluding the "),ve=n("code"),Oi=t(".py"),Ii=t(" suffix, "),we=n("em"),zi=t("e.g."),Bi=u(),be=n("code"),Ni=t("clip_guided_stable_diffusion"),Ti=t("."),Ke=u(),I=n("p"),Ki=t("Since community pipelines are often more complex, one can mix loading weights from an official "),$e=n("em"),Ui=t("repo id"),Vi=t(`
