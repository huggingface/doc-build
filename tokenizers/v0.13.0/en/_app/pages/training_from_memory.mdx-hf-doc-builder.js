...
following:`),Ee=f(),c(C.$$.fragment),qe=f(),v=i("p"),ct=l("This tokenizer is based on the "),J=i("a"),dt=l("Unigram"),yt=l(` model. It
...
`),X=i("a"),gt=l("here"),Ae=f(),$=i("h2"),A=i("a"),me=i("span"),c(F.$$.fragment),vt=f(),ce=i("span"),kt=l("The most basic way"),Pe=f(),P=i("p"),zt=l(`As you probably guessed already, the easiest way to train our tokenizer
...
following:`),le.forEach(t),Ee=h(e),d(C.$$.fragment,e),qe=h(e),v=n(e,"P",{});var pe=o(v);ct=p(pe,"This tokenizer is based on the "),J=n(pe,"A",{href:!0});var ss=o(J);dt=p(ss,"Unigram"),ss.forEach(t),yt=p(pe,` model. It
takes care of normalizing the input using the NFKC Unicode normalization
...
`),X=n(Yt,"A",{href:!0});var rs=o(X);gt=p(rs,"here"),rs.forEach(t),Yt.forEach(t),Ae=h(e),$=n(e,"H2",{class:!0});var Ve=o($);A=n(Ve,"A",{id:!0,class:!0,href:!0});var is=o(A);me=n(is,"SPAN",{});var ns=o(me);d(F.$$.fragment,ns),ns.forEach(t),is.forEach(t),vt=h(Ve),ce=n(Ve,"SPAN",{});var os=o(ce);kt=p(os,"The most basic way"),os.forEach(t),Ve.forEach(t),Pe=h(e),P=n(e,"P",{});var Xe=o(P);zt=p(Xe,`As you probably guessed already, the easiest way to train our tokenizer
