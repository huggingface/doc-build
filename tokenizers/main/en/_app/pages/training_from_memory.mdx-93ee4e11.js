import{S as qs,i as xs,s as As,e as i,k as f,w as c,t as l,M as Ps,c as n,d as t,m as h,a as o,x as d,h as p,b as m,F as s,g as r,y,L as Ts,q as w,o as b,B as _,v as Ss}from"../chunks/vendor-0d3f0756.js";import{I as at}from"../chunks/IconCopyLink-9193371d.js";import{C as Y}from"../chunks/CodeBlock-7b0cb15c.js";function Ls(Zt){let v,ze,z,q,fe,U,rt,he,it,$e,x,nt,Z,ot,lt,je,g,pt,J,ft,ht,me,mt,ut,Ee,C,qe,k,ct,G,dt,yt,V,wt,bt,xe,F,_t,X,gt,Ae,$,A,ue,N,kt,ce,vt,Pe,P,zt,de,$t,jt,Te,D,Se,u,Et,ye,qt,xt,we,At,Pt,be,Tt,St,Le,j,T,_e,I,Lt,ge,Bt,Be,S,Ut,O,Ct,Ft,Ue,ee,Nt,Ce,H,Fe,te,Dt,Ne,K,De,se,It,Ie,ae,Ot,Oe,M,He,re,Ht,Ke,E,L,ke,R,Kt,ve,Mt,Me,ie,Rt,Re,Q,Qe,ne,Qt,We,W,Ye,oe,Wt,Ze;return U=new at({}),C=new Y({props:{code:`from tokenizers import Tokenizer, models, normalizers, pre_tokenizers, decoders, trainers
...
`),X=i("a"),gt=l("here"),Ae=f(),$=i("h2"),A=i("a"),ue=i("span"),c(N.$$.fragment),kt=f(),ce=i("span"),vt=l("The most basic way"),Pe=f(),P=i("p"),zt=l(`As you probably guessed already, the easiest way to train our tokenizer
...
`),X=n(Yt,"A",{href:!0});var rs=o(X);gt=p(rs,"here"),rs.forEach(t),Yt.forEach(t),Ae=h(e),$=n(e,"H2",{class:!0});var Ve=o($);A=n(Ve,"A",{id:!0,class:!0,href:!0});var is=o(A);ue=n(is,"SPAN",{});var ns=o(ue);d(N.$$.fragment,ns),ns.forEach(t),is.forEach(t),kt=h(Ve),ce=n(Ve,"SPAN",{});var os=o(ce);vt=p(os,"The most basic way"),os.forEach(t),Ve.forEach(t),Pe=h(e),P=n(e,"P",{});var Xe=o(P);zt=p(Xe,`As you probably guessed already, the easiest way to train our tokenizer
